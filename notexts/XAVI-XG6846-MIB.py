...
# Produced by pysmi-1.1.3 at Tue Nov 30 03:01:15 2021
...
ModuleIdentity, TimeTicks, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, NotificationType, Counter64, Integer32, enterprises, MibIdentifier, snmpModules, Gauge32, iso, Bits, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "NotificationType", "Counter64", "Integer32", "enterprises", "MibIdentifier", "snmpModules", "Gauge32", "iso", "Bits", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", rebootEnable=rebootEnable, txPower=txPower, portPower=portPower, fcsErrorTransmitted=fcsErrorTransmitted, adminStatus=adminStatus, lanportIndex=lanportIndex, wan=wan, lanportspeed=lanportspeed, secondaryDns=secondaryDns, speed=speed, port3=port3, groupIndex=groupIndex, deviceinfo=deviceinfo, vlangroupTable=vlangroupTable, qos=qos, statIndex=statIndex, bias=bias, priority=priority, jumblan3=jumblan3, qosIndex=qosIndex, vendorOui=vendorOui, operStatus=operStatus, portIndex=portIndex, staticIpPrimaryDns=staticIpPrimaryDns, staticIpDomainName=staticIpDomainName, staticIpAddr=staticIpAddr, temperature=temperature, broadcastsReceived=broadcastsReceived, jumblan1=jumblan1, multicastsTransmitted=multicastsTransmitted, lan2=lan2, serialnum=serialnum, statisticTable=statisticTable, qosTable=qosTable, staticDns=staticDns, pauseReceived=pauseReceived, groupid=groupid, tftp=tftp, lan1=lan1, jumbwan=jumbwan, rxPower=rxPower, broadcastsTransmitted=broadcastsTransmitted, internetPort=internetPort, domainame=domainame, qmode=qmode, action=action, unicastsReceived=unicastsReceived, wanType=wanType, qosEntry=qosEntry, reboot=reboot, catvEnable=catvEnable, vendorRev=vendorRev, portName=portName, jumb=jumb, portmode=portmode, lanportpause=lanportpause, vendorName=vendorName, vendorPn=vendorPn, catv=catv, staticIpSubMask=staticIpSubMask, port2=port2, qmapping=qmapping, tftpSevIp=tftpSevIp, modeEntry=modeEntry, voltage=voltage, unicastsTransmitted=unicastsTransmitted, lanportName=lanportName, hostname=hostname, dscpEnable=dscpEnable, pauseTransmitted=pauseTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, port1=port1, fileType=fileType, port4=port4, jumblan4=jumblan4, ddminfo=ddminfo, primaryDns=primaryDns, staticIpGateway=staticIpGateway, fileName=fileName, portEntry=portEntry, xg6846=xg6846, fcsErrorReceived=fcsErrorReceived, portTable=portTable, multicastsReceived=multicastsReceived, lan4=lan4, groupEntry=groupEntry, jumblan2=jumblan2, staticIpHostName=staticIpHostName, lanportTable=lanportTable, portStatistic=portStatistic, portStatEntry=portStatEntry, lan3=lan3, vlan=vlan, vlanid=vlanid)
