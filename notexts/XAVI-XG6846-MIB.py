...
# Produced by pysmi-1.1.8 at Wed Feb  2 18:26:24 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, enterprises, NotificationType, iso, Counter64, snmpModules, Integer32, Gauge32, MibIdentifier, TimeTicks, ObjectIdentity, mib_2, Unsigned32, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "enterprises", "NotificationType", "iso", "Counter64", "snmpModules", "Integer32", "Gauge32", "MibIdentifier", "TimeTicks", "ObjectIdentity", "mib-2", "Unsigned32", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticDns=staticDns, operStatus=operStatus, wan=wan, speed=speed, portTable=portTable, fileName=fileName, jumbwan=jumbwan, multicastsTransmitted=multicastsTransmitted, staticIpHostName=staticIpHostName, port1=port1, txPower=txPower, internetPort=internetPort, secondaryDns=secondaryDns, staticIpPrimaryDns=staticIpPrimaryDns, jumb=jumb, port4=port4, statisticTable=statisticTable, broadcastsReceived=broadcastsReceived, lan4=lan4, portStatEntry=portStatEntry, staticIpSecondaryDns=staticIpSecondaryDns, tftp=tftp, lanportpause=lanportpause, jumblan4=jumblan4, unicastsReceived=unicastsReceived, tftpSevIp=tftpSevIp, qosEntry=qosEntry, hostname=hostname, lanportName=lanportName, pauseReceived=pauseReceived, rebootEnable=rebootEnable, action=action, lan2=lan2, qmapping=qmapping, domainame=domainame, qos=qos, lan1=lan1, lanportTable=lanportTable, fcsErrorReceived=fcsErrorReceived, rxPower=rxPower, port3=port3, staticIpSubMask=staticIpSubMask, dscpEnable=dscpEnable, bias=bias, jumblan1=jumblan1, statIndex=statIndex, vendorName=vendorName, groupEntry=groupEntry, groupIndex=groupIndex, catv=catv, qosIndex=qosIndex, adminStatus=adminStatus, jumblan2=jumblan2, fcsErrorTransmitted=fcsErrorTransmitted, vlangroupTable=vlangroupTable, qmode=qmode, fileType=fileType, voltage=voltage, lanportIndex=lanportIndex, multicastsReceived=multicastsReceived, vlan=vlan, reboot=reboot, temperature=temperature, xg6846=xg6846, portPower=portPower, port2=port2, ddminfo=ddminfo, portmode=portmode, vlanid=vlanid, lanportspeed=lanportspeed, portIndex=portIndex, primaryDns=primaryDns, modeEntry=modeEntry, unicastsTransmitted=unicastsTransmitted, staticIpDomainName=staticIpDomainName, staticIpAddr=staticIpAddr, jumblan3=jumblan3, serialnum=serialnum, qosTable=qosTable, wanType=wanType, priority=priority, deviceinfo=deviceinfo, lan3=lan3, vendorRev=vendorRev, broadcastsTransmitted=broadcastsTransmitted, portName=portName, pauseTransmitted=pauseTransmitted, vendorPn=vendorPn, catvEnable=catvEnable, vendorOui=vendorOui, portEntry=portEntry, portStatistic=portStatistic, groupid=groupid, staticIpGateway=staticIpGateway)
