...
iso, ModuleIdentity, MibIdentifier, Integer32, ObjectIdentity, Counter64, NotificationType, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, Gauge32, mib_2, TimeTicks, Counter32, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "MibIdentifier", "Integer32", "ObjectIdentity", "Counter64", "NotificationType", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "Gauge32", "mib-2", "TimeTicks", "Counter32", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fcsErrorReceived=fcsErrorReceived, lanportpause=lanportpause, internetPort=internetPort, staticIpSubMask=staticIpSubMask, tftp=tftp, jumb=jumb, lan1=lan1, qmode=qmode, hostname=hostname, serialnum=serialnum, operStatus=operStatus, jumblan2=jumblan2, modeEntry=modeEntry, vendorPn=vendorPn, jumblan3=jumblan3, portTable=portTable, unicastsReceived=unicastsReceived, reboot=reboot, xg6846=xg6846, groupIndex=groupIndex, groupid=groupid, port4=port4, fcsErrorTransmitted=fcsErrorTransmitted, vlanid=vlanid, multicastsReceived=multicastsReceived, jumblan1=jumblan1, pauseTransmitted=pauseTransmitted, portIndex=portIndex, staticIpSecondaryDns=staticIpSecondaryDns, broadcastsReceived=broadcastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, lan2=lan2, ddminfo=ddminfo, rxPower=rxPower, deviceinfo=deviceinfo, temperature=temperature, qosEntry=qosEntry, wan=wan, portEntry=portEntry, statIndex=statIndex, bias=bias, fileName=fileName, dscpEnable=dscpEnable, multicastsTransmitted=multicastsTransmitted, lanportspeed=lanportspeed, speed=speed, port2=port2, lan4=lan4, staticIpDomainName=staticIpDomainName, lanportName=lanportName, qosIndex=qosIndex, qos=qos, pauseReceived=pauseReceived, wanType=wanType, jumbwan=jumbwan, jumblan4=jumblan4, vlan=vlan, primaryDns=primaryDns, port3=port3, vendorRev=vendorRev, catv=catv, staticDns=staticDns, tftpSevIp=tftpSevIp, adminStatus=adminStatus, priority=priority, groupEntry=groupEntry, txPower=txPower, port1=port1, lanportIndex=lanportIndex, portmode=portmode, fileType=fileType, staticIpHostName=staticIpHostName, qosTable=qosTable, vendorOui=vendorOui, rebootEnable=rebootEnable, portName=portName, staticIpAddr=staticIpAddr, staticIpGateway=staticIpGateway, lanportTable=lanportTable, domainame=domainame, action=action, lan3=lan3, portStatEntry=portStatEntry, portStatistic=portStatistic, catvEnable=catvEnable, broadcastsTransmitted=broadcastsTransmitted, secondaryDns=secondaryDns, unicastsTransmitted=unicastsTransmitted, voltage=voltage, vlangroupTable=vlangroupTable, vendorName=vendorName, qmapping=qmapping, statisticTable=statisticTable, portPower=portPower)
