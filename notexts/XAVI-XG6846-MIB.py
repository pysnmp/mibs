...
iso, NotificationType, Counter64, TimeTicks, enterprises, IpAddress, ModuleIdentity, Counter32, mib_2, Bits, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, snmpModules, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Counter64", "TimeTicks", "enterprises", "IpAddress", "ModuleIdentity", "Counter32", "mib-2", "Bits", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "snmpModules", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", txPower=txPower, staticIpDomainName=staticIpDomainName, fileType=fileType, modeEntry=modeEntry, vendorPn=vendorPn, bias=bias, hostname=hostname, portEntry=portEntry, primaryDns=primaryDns, lanportpause=lanportpause, reboot=reboot, port4=port4, rxPower=rxPower, internetPort=internetPort, vendorOui=vendorOui, vendorRev=vendorRev, staticIpSubMask=staticIpSubMask, qmapping=qmapping, qos=qos, staticIpGateway=staticIpGateway, vlanid=vlanid, qosIndex=qosIndex, statisticTable=statisticTable, priority=priority, speed=speed, jumblan1=jumblan1, lanportName=lanportName, multicastsReceived=multicastsReceived, broadcastsTransmitted=broadcastsTransmitted, staticIpAddr=staticIpAddr, lanportspeed=lanportspeed, wanType=wanType, port1=port1, action=action, lan3=lan3, unicastsReceived=unicastsReceived, secondaryDns=secondaryDns, lanportTable=lanportTable, adminStatus=adminStatus, broadcastsReceived=broadcastsReceived, vlan=vlan, pauseReceived=pauseReceived, lan2=lan2, groupid=groupid, portName=portName, jumbwan=jumbwan, lan1=lan1, portStatistic=portStatistic, groupEntry=groupEntry, qosTable=qosTable, xg6846=xg6846, vlangroupTable=vlangroupTable, deviceinfo=deviceinfo, fcsErrorTransmitted=fcsErrorTransmitted, qmode=qmode, fcsErrorReceived=fcsErrorReceived, staticDns=staticDns, port2=port2, portPower=portPower, jumblan2=jumblan2, ddminfo=ddminfo, staticIpHostName=staticIpHostName, multicastsTransmitted=multicastsTransmitted, lan4=lan4, tftp=tftp, wan=wan, qosEntry=qosEntry, catvEnable=catvEnable, statIndex=statIndex, serialnum=serialnum, staticIpSecondaryDns=staticIpSecondaryDns, tftpSevIp=tftpSevIp, portTable=portTable, port3=port3, catv=catv, voltage=voltage, unicastsTransmitted=unicastsTransmitted, lanportIndex=lanportIndex, temperature=temperature, portIndex=portIndex, vendorName=vendorName, fileName=fileName, jumblan4=jumblan4, pauseTransmitted=pauseTransmitted, jumblan3=jumblan3, groupIndex=groupIndex, domainame=domainame, staticIpPrimaryDns=staticIpPrimaryDns, operStatus=operStatus, rebootEnable=rebootEnable, portmode=portmode, dscpEnable=dscpEnable, portStatEntry=portStatEntry, jumb=jumb)
