...
# Produced by pysmi-1.1.3 at Wed Dec  8 17:56:39 2021
...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, Counter32, Integer32, Gauge32, MibIdentifier, Counter64, ObjectIdentity, snmpModules, mib_2, NotificationType, Bits, ModuleIdentity, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "Counter32", "Integer32", "Gauge32", "MibIdentifier", "Counter64", "ObjectIdentity", "snmpModules", "mib-2", "NotificationType", "Bits", "ModuleIdentity", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", wan=wan, serialnum=serialnum, ddminfo=ddminfo, voltage=voltage, portStatEntry=portStatEntry, action=action, rxPower=rxPower, vendorRev=vendorRev, qmode=qmode, staticIpHostName=staticIpHostName, fcsErrorTransmitted=fcsErrorTransmitted, groupIndex=groupIndex, deviceinfo=deviceinfo, domainame=domainame, lan1=lan1, portEntry=portEntry, portPower=portPower, priority=priority, fcsErrorReceived=fcsErrorReceived, qos=qos, vlan=vlan, portStatistic=portStatistic, pauseReceived=pauseReceived, rebootEnable=rebootEnable, jumb=jumb, vlangroupTable=vlangroupTable, staticDns=staticDns, staticIpGateway=staticIpGateway, statIndex=statIndex, portTable=portTable, staticIpSecondaryDns=staticIpSecondaryDns, staticIpPrimaryDns=staticIpPrimaryDns, lanportpause=lanportpause, jumbwan=jumbwan, qosIndex=qosIndex, adminStatus=adminStatus, unicastsReceived=unicastsReceived, portIndex=portIndex, hostname=hostname, staticIpAddr=staticIpAddr, staticIpSubMask=staticIpSubMask, qosTable=qosTable, lan2=lan2, port3=port3, xg6846=xg6846, groupid=groupid, tftpSevIp=tftpSevIp, broadcastsReceived=broadcastsReceived, lan3=lan3, lanportTable=lanportTable, fileType=fileType, port1=port1, port2=port2, secondaryDns=secondaryDns, portName=portName, fileName=fileName, multicastsReceived=multicastsReceived, groupEntry=groupEntry, internetPort=internetPort, lanportName=lanportName, multicastsTransmitted=multicastsTransmitted, dscpEnable=dscpEnable, broadcastsTransmitted=broadcastsTransmitted, lan4=lan4, vendorPn=vendorPn, jumblan4=jumblan4, catv=catv, pauseTransmitted=pauseTransmitted, temperature=temperature, port4=port4, qmapping=qmapping, modeEntry=modeEntry, statisticTable=statisticTable, wanType=wanType, portmode=portmode, lanportIndex=lanportIndex, jumblan3=jumblan3, catvEnable=catvEnable, staticIpDomainName=staticIpDomainName, primaryDns=primaryDns, jumblan2=jumblan2, txPower=txPower, bias=bias, reboot=reboot, vendorName=vendorName, unicastsTransmitted=unicastsTransmitted, speed=speed, lanportspeed=lanportspeed, operStatus=operStatus, vlanid=vlanid, jumblan1=jumblan1, qosEntry=qosEntry, vendorOui=vendorOui, tftp=tftp)
