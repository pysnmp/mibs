...
# Produced by pysmi-1.1.8 at Tue Jul 26 15:30:22 2022
...
MibIdentifier, ModuleIdentity, Counter32, iso, Counter64, Unsigned32, IpAddress, NotificationType, Gauge32, enterprises, ObjectIdentity, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Integer32, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "Counter32", "iso", "Counter64", "Unsigned32", "IpAddress", "NotificationType", "Gauge32", "enterprises", "ObjectIdentity", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Integer32", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vlan=vlan, qmode=qmode, lan1=lan1, temperature=temperature, tftpSevIp=tftpSevIp, portName=portName, fileName=fileName, portPower=portPower, qos=qos, catv=catv, vlangroupTable=vlangroupTable, vendorPn=vendorPn, broadcastsTransmitted=broadcastsTransmitted, rxPower=rxPower, voltage=voltage, portStatEntry=portStatEntry, unicastsReceived=unicastsReceived, pauseReceived=pauseReceived, lanportIndex=lanportIndex, jumbwan=jumbwan, qosIndex=qosIndex, jumblan4=jumblan4, lan3=lan3, port4=port4, wan=wan, xg6846=xg6846, secondaryDns=secondaryDns, broadcastsReceived=broadcastsReceived, staticIpSubMask=staticIpSubMask, groupid=groupid, portTable=portTable, staticIpGateway=staticIpGateway, bias=bias, portStatistic=portStatistic, lanportName=lanportName, serialnum=serialnum, portEntry=portEntry, catvEnable=catvEnable, adminStatus=adminStatus, pauseTransmitted=pauseTransmitted, operStatus=operStatus, qosTable=qosTable, jumblan3=jumblan3, speed=speed, staticIpDomainName=staticIpDomainName, fcsErrorReceived=fcsErrorReceived, dscpEnable=dscpEnable, wanType=wanType, internetPort=internetPort, portIndex=portIndex, lanportpause=lanportpause, vlanid=vlanid, unicastsTransmitted=unicastsTransmitted, modeEntry=modeEntry, lanportTable=lanportTable, qmapping=qmapping, action=action, priority=priority, jumblan2=jumblan2, lan4=lan4, domainame=domainame, port2=port2, multicastsTransmitted=multicastsTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, ddminfo=ddminfo, jumb=jumb, staticIpHostName=staticIpHostName, groupIndex=groupIndex, staticIpAddr=staticIpAddr, groupEntry=groupEntry, vendorName=vendorName, multicastsReceived=multicastsReceived, vendorRev=vendorRev, statisticTable=statisticTable, fileType=fileType, port3=port3, lanportspeed=lanportspeed, staticIpPrimaryDns=staticIpPrimaryDns, statIndex=statIndex, portmode=portmode, tftp=tftp, primaryDns=primaryDns, rebootEnable=rebootEnable, vendorOui=vendorOui, txPower=txPower, hostname=hostname, port1=port1, deviceinfo=deviceinfo, fcsErrorTransmitted=fcsErrorTransmitted, staticDns=staticDns, lan2=lan2, jumblan1=jumblan1, qosEntry=qosEntry, reboot=reboot)
