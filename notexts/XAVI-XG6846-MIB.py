...
# Produced by pysmi-1.1.3 at Mon Nov 22 12:30:26 2021
...
mib_2, Bits, MibIdentifier, IpAddress, enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, NotificationType, snmpModules, TimeTicks, Gauge32, ModuleIdentity, Counter64, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Bits", "MibIdentifier", "IpAddress", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "NotificationType", "snmpModules", "TimeTicks", "Gauge32", "ModuleIdentity", "Counter64", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupid=groupid, operStatus=operStatus, staticIpPrimaryDns=staticIpPrimaryDns, fileName=fileName, lanportName=lanportName, multicastsReceived=multicastsReceived, tftp=tftp, portPower=portPower, groupEntry=groupEntry, tftpSevIp=tftpSevIp, portStatistic=portStatistic, deviceinfo=deviceinfo, vendorRev=vendorRev, groupIndex=groupIndex, vlanid=vlanid, staticDns=staticDns, unicastsReceived=unicastsReceived, lanportTable=lanportTable, broadcastsTransmitted=broadcastsTransmitted, lanportpause=lanportpause, serialnum=serialnum, speed=speed, statIndex=statIndex, staticIpAddr=staticIpAddr, portTable=portTable, portIndex=portIndex, jumblan3=jumblan3, fcsErrorTransmitted=fcsErrorTransmitted, qos=qos, priority=priority, lan4=lan4, wan=wan, internetPort=internetPort, jumblan1=jumblan1, pauseTransmitted=pauseTransmitted, secondaryDns=secondaryDns, portEntry=portEntry, jumb=jumb, unicastsTransmitted=unicastsTransmitted, action=action, qmapping=qmapping, wanType=wanType, qmode=qmode, vlan=vlan, vendorOui=vendorOui, port4=port4, portmode=portmode, portName=portName, lan2=lan2, qosTable=qosTable, txPower=txPower, port2=port2, jumblan4=jumblan4, broadcastsReceived=broadcastsReceived, fcsErrorReceived=fcsErrorReceived, lanportspeed=lanportspeed, lan1=lan1, fileType=fileType, modeEntry=modeEntry, reboot=reboot, vendorName=vendorName, temperature=temperature, rxPower=rxPower, staticIpDomainName=staticIpDomainName, pauseReceived=pauseReceived, qosIndex=qosIndex, jumblan2=jumblan2, qosEntry=qosEntry, port1=port1, hostname=hostname, jumbwan=jumbwan, vlangroupTable=vlangroupTable, staticIpHostName=staticIpHostName, staticIpGateway=staticIpGateway, vendorPn=vendorPn, lanportIndex=lanportIndex, lan3=lan3, dscpEnable=dscpEnable, catv=catv, catvEnable=catvEnable, bias=bias, voltage=voltage, staticIpSecondaryDns=staticIpSecondaryDns, ddminfo=ddminfo, adminStatus=adminStatus, rebootEnable=rebootEnable, port3=port3, primaryDns=primaryDns, xg6846=xg6846, domainame=domainame, portStatEntry=portStatEntry, statisticTable=statisticTable, staticIpSubMask=staticIpSubMask, multicastsTransmitted=multicastsTransmitted)
