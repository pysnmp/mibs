...
iso, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, enterprises, snmpModules, NotificationType, IpAddress, Counter32, Integer32, MibIdentifier, Bits, Gauge32, ModuleIdentity, mib_2, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "enterprises", "snmpModules", "NotificationType", "IpAddress", "Counter32", "Integer32", "MibIdentifier", "Bits", "Gauge32", "ModuleIdentity", "mib-2", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpPrimaryDns=staticIpPrimaryDns, operStatus=operStatus, vlangroupTable=vlangroupTable, portName=portName, bias=bias, secondaryDns=secondaryDns, lanportspeed=lanportspeed, qosTable=qosTable, portPower=portPower, qos=qos, rebootEnable=rebootEnable, jumblan4=jumblan4, vlanid=vlanid, groupEntry=groupEntry, reboot=reboot, lan3=lan3, qmapping=qmapping, portStatistic=portStatistic, vendorPn=vendorPn, groupid=groupid, port3=port3, wanType=wanType, tftpSevIp=tftpSevIp, internetPort=internetPort, lanportIndex=lanportIndex, temperature=temperature, wan=wan, vlan=vlan, speed=speed, vendorOui=vendorOui, fcsErrorTransmitted=fcsErrorTransmitted, staticDns=staticDns, modeEntry=modeEntry, deviceinfo=deviceinfo, txPower=txPower, statIndex=statIndex, domainame=domainame, broadcastsTransmitted=broadcastsTransmitted, statisticTable=statisticTable, portEntry=portEntry, pauseTransmitted=pauseTransmitted, staticIpSubMask=staticIpSubMask, voltage=voltage, rxPower=rxPower, lan2=lan2, action=action, jumblan3=jumblan3, portStatEntry=portStatEntry, unicastsReceived=unicastsReceived, portIndex=portIndex, serialnum=serialnum, staticIpAddr=staticIpAddr, multicastsTransmitted=multicastsTransmitted, primaryDns=primaryDns, staticIpDomainName=staticIpDomainName, lan1=lan1, fileType=fileType, priority=priority, fcsErrorReceived=fcsErrorReceived, groupIndex=groupIndex, staticIpGateway=staticIpGateway, lanportName=lanportName, lan4=lan4, jumblan1=jumblan1, port2=port2, jumb=jumb, hostname=hostname, jumbwan=jumbwan, broadcastsReceived=broadcastsReceived, jumblan2=jumblan2, portTable=portTable, vendorRev=vendorRev, portmode=portmode, adminStatus=adminStatus, staticIpSecondaryDns=staticIpSecondaryDns, lanportpause=lanportpause, xg6846=xg6846, qosIndex=qosIndex, staticIpHostName=staticIpHostName, port1=port1, multicastsReceived=multicastsReceived, fileName=fileName, tftp=tftp, ddminfo=ddminfo, vendorName=vendorName, port4=port4, qosEntry=qosEntry, lanportTable=lanportTable, catv=catv, dscpEnable=dscpEnable, pauseReceived=pauseReceived, unicastsTransmitted=unicastsTransmitted, qmode=qmode, catvEnable=catvEnable)
