...
enterprises, ModuleIdentity, Gauge32, MibIdentifier, Unsigned32, iso, NotificationType, IpAddress, Counter64, Integer32, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Counter32, snmpModules, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "Gauge32", "MibIdentifier", "Unsigned32", "iso", "NotificationType", "IpAddress", "Counter64", "Integer32", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Counter32", "snmpModules", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticDns=staticDns, staticIpSubMask=staticIpSubMask, wanType=wanType, catvEnable=catvEnable, lanportpause=lanportpause, rebootEnable=rebootEnable, portPower=portPower, port4=port4, qosTable=qosTable, lan4=lan4, groupid=groupid, unicastsReceived=unicastsReceived, lan2=lan2, deviceinfo=deviceinfo, staticIpPrimaryDns=staticIpPrimaryDns, pauseTransmitted=pauseTransmitted, xg6846=xg6846, catv=catv, statIndex=statIndex, staticIpHostName=staticIpHostName, portStatEntry=portStatEntry, portName=portName, broadcastsTransmitted=broadcastsTransmitted, operStatus=operStatus, groupEntry=groupEntry, jumbwan=jumbwan, multicastsTransmitted=multicastsTransmitted, qos=qos, qmode=qmode, fcsErrorTransmitted=fcsErrorTransmitted, tftpSevIp=tftpSevIp, modeEntry=modeEntry, port1=port1, staticIpDomainName=staticIpDomainName, jumb=jumb, action=action, qmapping=qmapping, vendorPn=vendorPn, vlangroupTable=vlangroupTable, vendorName=vendorName, staticIpSecondaryDns=staticIpSecondaryDns, speed=speed, fcsErrorReceived=fcsErrorReceived, staticIpAddr=staticIpAddr, fileType=fileType, adminStatus=adminStatus, reboot=reboot, qosIndex=qosIndex, multicastsReceived=multicastsReceived, groupIndex=groupIndex, pauseReceived=pauseReceived, serialnum=serialnum, vendorOui=vendorOui, lanportspeed=lanportspeed, vlanid=vlanid, domainame=domainame, ddminfo=ddminfo, port2=port2, statisticTable=statisticTable, voltage=voltage, portmode=portmode, internetPort=internetPort, broadcastsReceived=broadcastsReceived, primaryDns=primaryDns, temperature=temperature, lan3=lan3, lanportIndex=lanportIndex, dscpEnable=dscpEnable, portEntry=portEntry, rxPower=rxPower, portTable=portTable, jumblan3=jumblan3, lanportTable=lanportTable, wan=wan, txPower=txPower, fileName=fileName, hostname=hostname, unicastsTransmitted=unicastsTransmitted, portIndex=portIndex, jumblan4=jumblan4, staticIpGateway=staticIpGateway, vlan=vlan, vendorRev=vendorRev, priority=priority, tftp=tftp, lan1=lan1, bias=bias, jumblan2=jumblan2, lanportName=lanportName, secondaryDns=secondaryDns, port3=port3, jumblan1=jumblan1, qosEntry=qosEntry, portStatistic=portStatistic)
