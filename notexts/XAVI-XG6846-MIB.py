...
NotificationType, Counter64, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, snmpModules, TimeTicks, ModuleIdentity, enterprises, mib_2, Counter32, iso, Integer32, ObjectIdentity, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "snmpModules", "TimeTicks", "ModuleIdentity", "enterprises", "mib-2", "Counter32", "iso", "Integer32", "ObjectIdentity", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", hostname=hostname, staticDns=staticDns, portTable=portTable, xg6846=xg6846, ddminfo=ddminfo, vlan=vlan, jumblan1=jumblan1, staticIpDomainName=staticIpDomainName, operStatus=operStatus, groupEntry=groupEntry, adminStatus=adminStatus, vlanid=vlanid, jumblan2=jumblan2, multicastsTransmitted=multicastsTransmitted, deviceinfo=deviceinfo, qos=qos, modeEntry=modeEntry, speed=speed, portPower=portPower, wanType=wanType, tftp=tftp, portStatEntry=portStatEntry, broadcastsReceived=broadcastsReceived, dscpEnable=dscpEnable, txPower=txPower, lanportTable=lanportTable, vendorName=vendorName, qosEntry=qosEntry, unicastsTransmitted=unicastsTransmitted, port4=port4, secondaryDns=secondaryDns, unicastsReceived=unicastsReceived, lanportpause=lanportpause, statIndex=statIndex, vendorPn=vendorPn, staticIpSubMask=staticIpSubMask, qosIndex=qosIndex, portIndex=portIndex, staticIpPrimaryDns=staticIpPrimaryDns, groupid=groupid, reboot=reboot, wan=wan, qmode=qmode, jumb=jumb, staticIpSecondaryDns=staticIpSecondaryDns, jumblan3=jumblan3, staticIpHostName=staticIpHostName, action=action, fileName=fileName, vlangroupTable=vlangroupTable, rxPower=rxPower, vendorOui=vendorOui, lanportIndex=lanportIndex, qosTable=qosTable, domainame=domainame, fileType=fileType, broadcastsTransmitted=broadcastsTransmitted, lanportName=lanportName, jumblan4=jumblan4, vendorRev=vendorRev, groupIndex=groupIndex, fcsErrorTransmitted=fcsErrorTransmitted, pauseTransmitted=pauseTransmitted, portEntry=portEntry, statisticTable=statisticTable, lan3=lan3, internetPort=internetPort, fcsErrorReceived=fcsErrorReceived, voltage=voltage, jumbwan=jumbwan, port2=port2, portStatistic=portStatistic, port1=port1, qmapping=qmapping, catvEnable=catvEnable, primaryDns=primaryDns, catv=catv, multicastsReceived=multicastsReceived, lan1=lan1, temperature=temperature, bias=bias, rebootEnable=rebootEnable, priority=priority, lan4=lan4, port3=port3, portName=portName, portmode=portmode, pauseReceived=pauseReceived, lanportspeed=lanportspeed, staticIpGateway=staticIpGateway, staticIpAddr=staticIpAddr, lan2=lan2, tftpSevIp=tftpSevIp, serialnum=serialnum)
