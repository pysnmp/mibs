...
# Produced by pysmi-1.1.8 at Tue Aug  9 15:46:30 2022
...
Counter32, enterprises, Integer32, ObjectIdentity, iso, Unsigned32, NotificationType, mib_2, Gauge32, TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, MibIdentifier, Bits, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "enterprises", "Integer32", "ObjectIdentity", "iso", "Unsigned32", "NotificationType", "mib-2", "Gauge32", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "MibIdentifier", "Bits", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fcsErrorTransmitted=fcsErrorTransmitted, qmapping=qmapping, qosEntry=qosEntry, staticIpDomainName=staticIpDomainName, staticIpSecondaryDns=staticIpSecondaryDns, hostname=hostname, lanportName=lanportName, bias=bias, lanportspeed=lanportspeed, deviceinfo=deviceinfo, jumblan3=jumblan3, fileName=fileName, vlanid=vlanid, portName=portName, groupIndex=groupIndex, adminStatus=adminStatus, jumblan2=jumblan2, priority=priority, lanportpause=lanportpause, operStatus=operStatus, vlan=vlan, portStatistic=portStatistic, staticIpAddr=staticIpAddr, ddminfo=ddminfo, catvEnable=catvEnable, reboot=reboot, staticIpHostName=staticIpHostName, tftpSevIp=tftpSevIp, rxPower=rxPower, domainame=domainame, fcsErrorReceived=fcsErrorReceived, vendorName=vendorName, groupEntry=groupEntry, catv=catv, groupid=groupid, vendorOui=vendorOui, temperature=temperature, jumbwan=jumbwan, secondaryDns=secondaryDns, lan4=lan4, multicastsReceived=multicastsReceived, vendorPn=vendorPn, unicastsTransmitted=unicastsTransmitted, internetPort=internetPort, wan=wan, staticIpSubMask=staticIpSubMask, modeEntry=modeEntry, port1=port1, qosIndex=qosIndex, lan3=lan3, rebootEnable=rebootEnable, pauseReceived=pauseReceived, portmode=portmode, fileType=fileType, primaryDns=primaryDns, portStatEntry=portStatEntry, port4=port4, jumb=jumb, portPower=portPower, lanportIndex=lanportIndex, qosTable=qosTable, dscpEnable=dscpEnable, vlangroupTable=vlangroupTable, voltage=voltage, xg6846=xg6846, qmode=qmode, action=action, jumblan4=jumblan4, unicastsReceived=unicastsReceived, wanType=wanType, lan1=lan1, vendorRev=vendorRev, txPower=txPower, broadcastsTransmitted=broadcastsTransmitted, staticIpGateway=staticIpGateway, staticIpPrimaryDns=staticIpPrimaryDns, portEntry=portEntry, broadcastsReceived=broadcastsReceived, tftp=tftp, statIndex=statIndex, jumblan1=jumblan1, port2=port2, qos=qos, pauseTransmitted=pauseTransmitted, lanportTable=lanportTable, multicastsTransmitted=multicastsTransmitted, statisticTable=statisticTable, port3=port3, portIndex=portIndex, lan2=lan2, portTable=portTable, speed=speed, staticDns=staticDns, serialnum=serialnum)
