...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:20:34 2022
...
snmpModules, enterprises, TimeTicks, mib_2, Bits, MibIdentifier, iso, ObjectIdentity, Unsigned32, Counter32, ModuleIdentity, NotificationType, Counter64, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "enterprises", "TimeTicks", "mib-2", "Bits", "MibIdentifier", "iso", "ObjectIdentity", "Unsigned32", "Counter32", "ModuleIdentity", "NotificationType", "Counter64", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fcsErrorTransmitted=fcsErrorTransmitted, jumblan3=jumblan3, qosIndex=qosIndex, vlan=vlan, secondaryDns=secondaryDns, port3=port3, bias=bias, port2=port2, deviceinfo=deviceinfo, tftpSevIp=tftpSevIp, qos=qos, pauseReceived=pauseReceived, jumblan1=jumblan1, action=action, operStatus=operStatus, jumblan4=jumblan4, groupIndex=groupIndex, speed=speed, groupEntry=groupEntry, portIndex=portIndex, portmode=portmode, staticDns=staticDns, lanportpause=lanportpause, portStatistic=portStatistic, vendorRev=vendorRev, portName=portName, primaryDns=primaryDns, internetPort=internetPort, wanType=wanType, rebootEnable=rebootEnable, unicastsTransmitted=unicastsTransmitted, port4=port4, unicastsReceived=unicastsReceived, broadcastsReceived=broadcastsReceived, lan1=lan1, statIndex=statIndex, portPower=portPower, vendorOui=vendorOui, domainame=domainame, modeEntry=modeEntry, staticIpGateway=staticIpGateway, staticIpHostName=staticIpHostName, port1=port1, portTable=portTable, qmapping=qmapping, vendorPn=vendorPn, catv=catv, fileType=fileType, vendorName=vendorName, pauseTransmitted=pauseTransmitted, serialnum=serialnum, lanportName=lanportName, lanportTable=lanportTable, catvEnable=catvEnable, wan=wan, staticIpDomainName=staticIpDomainName, jumbwan=jumbwan, multicastsTransmitted=multicastsTransmitted, fileName=fileName, jumb=jumb, vlanid=vlanid, temperature=temperature, groupid=groupid, staticIpSubMask=staticIpSubMask, priority=priority, lan2=lan2, statisticTable=statisticTable, adminStatus=adminStatus, fcsErrorReceived=fcsErrorReceived, qosTable=qosTable, portEntry=portEntry, portStatEntry=portStatEntry, reboot=reboot, tftp=tftp, lan4=lan4, lanportspeed=lanportspeed, staticIpSecondaryDns=staticIpSecondaryDns, vlangroupTable=vlangroupTable, qosEntry=qosEntry, staticIpAddr=staticIpAddr, jumblan2=jumblan2, rxPower=rxPower, lan3=lan3, broadcastsTransmitted=broadcastsTransmitted, xg6846=xg6846, hostname=hostname, staticIpPrimaryDns=staticIpPrimaryDns, txPower=txPower, qmode=qmode, voltage=voltage, ddminfo=ddminfo, lanportIndex=lanportIndex, dscpEnable=dscpEnable, multicastsReceived=multicastsReceived)
