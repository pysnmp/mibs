...
# Produced by pysmi-1.1.10 at Thu Oct 26 13:10:26 2023
...
Gauge32, Integer32, Bits, ObjectIdentity, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, Unsigned32, snmpModules, NotificationType, IpAddress, ModuleIdentity, enterprises, mib_2, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "Bits", "ObjectIdentity", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "Unsigned32", "snmpModules", "NotificationType", "IpAddress", "ModuleIdentity", "enterprises", "mib-2", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", reboot=reboot, secondaryDns=secondaryDns, staticIpSecondaryDns=staticIpSecondaryDns, fileType=fileType, broadcastsReceived=broadcastsReceived, pauseTransmitted=pauseTransmitted, unicastsReceived=unicastsReceived, multicastsTransmitted=multicastsTransmitted, staticIpSubMask=staticIpSubMask, deviceinfo=deviceinfo, groupIndex=groupIndex, tftp=tftp, port4=port4, temperature=temperature, speed=speed, catv=catv, lan1=lan1, qosTable=qosTable, bias=bias, unicastsTransmitted=unicastsTransmitted, operStatus=operStatus, portTable=portTable, qmode=qmode, staticIpHostName=staticIpHostName, lan4=lan4, statIndex=statIndex, lanportName=lanportName, staticIpGateway=staticIpGateway, qosIndex=qosIndex, staticIpDomainName=staticIpDomainName, jumb=jumb, groupEntry=groupEntry, vendorName=vendorName, portName=portName, domainame=domainame, portStatEntry=portStatEntry, port2=port2, qmapping=qmapping, statisticTable=statisticTable, ddminfo=ddminfo, jumblan1=jumblan1, jumblan3=jumblan3, voltage=voltage, serialnum=serialnum, broadcastsTransmitted=broadcastsTransmitted, rxPower=rxPower, portIndex=portIndex, lanportspeed=lanportspeed, portPower=portPower, qosEntry=qosEntry, fcsErrorReceived=fcsErrorReceived, pauseReceived=pauseReceived, txPower=txPower, jumblan4=jumblan4, lanportpause=lanportpause, lan3=lan3, groupid=groupid, staticIpPrimaryDns=staticIpPrimaryDns, staticDns=staticDns, portEntry=portEntry, vendorRev=vendorRev, primaryDns=primaryDns, adminStatus=adminStatus, rebootEnable=rebootEnable, qos=qos, port1=port1, jumblan2=jumblan2, vlangroupTable=vlangroupTable, lan2=lan2, wanType=wanType, staticIpAddr=staticIpAddr, modeEntry=modeEntry, hostname=hostname, dscpEnable=dscpEnable, catvEnable=catvEnable, fcsErrorTransmitted=fcsErrorTransmitted, multicastsReceived=multicastsReceived, action=action, port3=port3, lanportIndex=lanportIndex, vlan=vlan, tftpSevIp=tftpSevIp, fileName=fileName, vendorOui=vendorOui, portStatistic=portStatistic, portmode=portmode, internetPort=internetPort, xg6846=xg6846, vlanid=vlanid, jumbwan=jumbwan, priority=priority, lanportTable=lanportTable, vendorPn=vendorPn, wan=wan)
