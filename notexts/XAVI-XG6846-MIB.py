...
# Produced by pysmi-1.1.8 at Tue Sep 12 09:43:23 2023
...
TimeTicks, Counter64, NotificationType, MibIdentifier, mib_2, enterprises, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Integer32, iso, Bits, Gauge32, Unsigned32, ObjectIdentity, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "NotificationType", "MibIdentifier", "mib-2", "enterprises", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Integer32", "iso", "Bits", "Gauge32", "Unsigned32", "ObjectIdentity", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", txPower=txPower, vendorRev=vendorRev, lan2=lan2, lanportTable=lanportTable, vendorName=vendorName, staticIpDomainName=staticIpDomainName, unicastsTransmitted=unicastsTransmitted, adminStatus=adminStatus, vendorOui=vendorOui, priority=priority, domainame=domainame, voltage=voltage, deviceinfo=deviceinfo, pauseTransmitted=pauseTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, qosTable=qosTable, port3=port3, port2=port2, multicastsTransmitted=multicastsTransmitted, jumblan1=jumblan1, catvEnable=catvEnable, xg6846=xg6846, groupEntry=groupEntry, vendorPn=vendorPn, fcsErrorReceived=fcsErrorReceived, operStatus=operStatus, port4=port4, internetPort=internetPort, multicastsReceived=multicastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, temperature=temperature, portIndex=portIndex, action=action, port1=port1, portTable=portTable, vlanid=vlanid, vlangroupTable=vlangroupTable, speed=speed, staticIpGateway=staticIpGateway, vlan=vlan, groupIndex=groupIndex, jumb=jumb, statIndex=statIndex, qos=qos, wanType=wanType, modeEntry=modeEntry, lanportspeed=lanportspeed, jumbwan=jumbwan, qmapping=qmapping, portStatEntry=portStatEntry, qosIndex=qosIndex, serialnum=serialnum, lan1=lan1, tftp=tftp, catv=catv, broadcastsReceived=broadcastsReceived, lanportName=lanportName, dscpEnable=dscpEnable, portName=portName, lanportIndex=lanportIndex, reboot=reboot, rxPower=rxPower, statisticTable=statisticTable, staticIpAddr=staticIpAddr, portPower=portPower, fileName=fileName, rebootEnable=rebootEnable, jumblan3=jumblan3, unicastsReceived=unicastsReceived, qosEntry=qosEntry, broadcastsTransmitted=broadcastsTransmitted, staticIpSubMask=staticIpSubMask, tftpSevIp=tftpSevIp, pauseReceived=pauseReceived, hostname=hostname, portStatistic=portStatistic, jumblan2=jumblan2, lan3=lan3, staticIpHostName=staticIpHostName, jumblan4=jumblan4, portEntry=portEntry, fcsErrorTransmitted=fcsErrorTransmitted, fileType=fileType, wan=wan, bias=bias, staticDns=staticDns, ddminfo=ddminfo, primaryDns=primaryDns, lan4=lan4, qmode=qmode, portmode=portmode, groupid=groupid, lanportpause=lanportpause, secondaryDns=secondaryDns)
