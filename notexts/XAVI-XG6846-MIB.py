...
# Produced by pysmi-1.1.3 at Thu Dec  9 14:28:58 2021
...
Bits, Counter32, Gauge32, Unsigned32, MibIdentifier, NotificationType, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, mib_2, IpAddress, Integer32, Counter64, ObjectIdentity, iso, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "Gauge32", "Unsigned32", "MibIdentifier", "NotificationType", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "mib-2", "IpAddress", "Integer32", "Counter64", "ObjectIdentity", "iso", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumb=jumb, qosEntry=qosEntry, groupid=groupid, staticIpGateway=staticIpGateway, qos=qos, serialnum=serialnum, portPower=portPower, lanportName=lanportName, primaryDns=primaryDns, groupEntry=groupEntry, statisticTable=statisticTable, port1=port1, wan=wan, vendorPn=vendorPn, catvEnable=catvEnable, ddminfo=ddminfo, staticIpSecondaryDns=staticIpSecondaryDns, groupIndex=groupIndex, staticIpDomainName=staticIpDomainName, statIndex=statIndex, unicastsTransmitted=unicastsTransmitted, port3=port3, portIndex=portIndex, lanportpause=lanportpause, multicastsReceived=multicastsReceived, lan1=lan1, vendorOui=vendorOui, tftp=tftp, domainame=domainame, port4=port4, portName=portName, staticIpSubMask=staticIpSubMask, vlanid=vlanid, reboot=reboot, lanportIndex=lanportIndex, vlan=vlan, xg6846=xg6846, lanportTable=lanportTable, portTable=portTable, catv=catv, rxPower=rxPower, qosTable=qosTable, broadcastsTransmitted=broadcastsTransmitted, broadcastsReceived=broadcastsReceived, staticIpHostName=staticIpHostName, tftpSevIp=tftpSevIp, fcsErrorReceived=fcsErrorReceived, lan3=lan3, vendorRev=vendorRev, pauseTransmitted=pauseTransmitted, portEntry=portEntry, adminStatus=adminStatus, portStatistic=portStatistic, qmode=qmode, priority=priority, jumbwan=jumbwan, portmode=portmode, voltage=voltage, portStatEntry=portStatEntry, fileName=fileName, deviceinfo=deviceinfo, port2=port2, secondaryDns=secondaryDns, speed=speed, internetPort=internetPort, bias=bias, unicastsReceived=unicastsReceived, lan2=lan2, lanportspeed=lanportspeed, jumblan4=jumblan4, action=action, vendorName=vendorName, staticIpPrimaryDns=staticIpPrimaryDns, dscpEnable=dscpEnable, pauseReceived=pauseReceived, jumblan1=jumblan1, fileType=fileType, jumblan2=jumblan2, fcsErrorTransmitted=fcsErrorTransmitted, lan4=lan4, qmapping=qmapping, staticIpAddr=staticIpAddr, temperature=temperature, operStatus=operStatus, modeEntry=modeEntry, staticDns=staticDns, qosIndex=qosIndex, vlangroupTable=vlangroupTable, rebootEnable=rebootEnable, txPower=txPower, jumblan3=jumblan3, wanType=wanType, hostname=hostname, multicastsTransmitted=multicastsTransmitted)
