...
# Produced by pysmi-1.1.0 at Fri Nov 19 14:53:20 2021
...
TimeTicks, enterprises, Integer32, iso, NotificationType, Unsigned32, ModuleIdentity, Gauge32, IpAddress, ObjectIdentity, mib_2, Counter64, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "Integer32", "iso", "NotificationType", "Unsigned32", "ModuleIdentity", "Gauge32", "IpAddress", "ObjectIdentity", "mib-2", "Counter64", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", rebootEnable=rebootEnable, fileName=fileName, broadcastsTransmitted=broadcastsTransmitted, qmapping=qmapping, lan2=lan2, jumblan3=jumblan3, lanportpause=lanportpause, vendorRev=vendorRev, staticIpSecondaryDns=staticIpSecondaryDns, staticIpDomainName=staticIpDomainName, ddminfo=ddminfo, groupIndex=groupIndex, voltage=voltage, jumblan4=jumblan4, jumbwan=jumbwan, serialnum=serialnum, bias=bias, action=action, catvEnable=catvEnable, groupEntry=groupEntry, jumblan1=jumblan1, pauseTransmitted=pauseTransmitted, jumblan2=jumblan2, priority=priority, temperature=temperature, tftp=tftp, portStatistic=portStatistic, wanType=wanType, modeEntry=modeEntry, statisticTable=statisticTable, lan4=lan4, port3=port3, port4=port4, lanportIndex=lanportIndex, wan=wan, vlanid=vlanid, qosIndex=qosIndex, unicastsTransmitted=unicastsTransmitted, multicastsTransmitted=multicastsTransmitted, rxPower=rxPower, lan3=lan3, lanportspeed=lanportspeed, groupid=groupid, catv=catv, tftpSevIp=tftpSevIp, broadcastsReceived=broadcastsReceived, primaryDns=primaryDns, vlangroupTable=vlangroupTable, operStatus=operStatus, vendorPn=vendorPn, speed=speed, qosEntry=qosEntry, portIndex=portIndex, lanportName=lanportName, adminStatus=adminStatus, fcsErrorTransmitted=fcsErrorTransmitted, portPower=portPower, portmode=portmode, txPower=txPower, portStatEntry=portStatEntry, vendorOui=vendorOui, hostname=hostname, domainame=domainame, qosTable=qosTable, staticIpSubMask=staticIpSubMask, staticDns=staticDns, portTable=portTable, multicastsReceived=multicastsReceived, staticIpAddr=staticIpAddr, staticIpPrimaryDns=staticIpPrimaryDns, lan1=lan1, secondaryDns=secondaryDns, fileType=fileType, reboot=reboot, dscpEnable=dscpEnable, portEntry=portEntry, pauseReceived=pauseReceived, staticIpGateway=staticIpGateway, unicastsReceived=unicastsReceived, qos=qos, port1=port1, jumb=jumb, lanportTable=lanportTable, xg6846=xg6846, statIndex=statIndex, vlan=vlan, port2=port2, fcsErrorReceived=fcsErrorReceived, portName=portName, staticIpHostName=staticIpHostName, deviceinfo=deviceinfo, qmode=qmode, vendorName=vendorName, internetPort=internetPort)
