...
# Produced by pysmi-1.1.12 at Wed May 29 06:47:15 2024
...
iso, NotificationType, MibIdentifier, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, Counter32, ObjectIdentity, IpAddress, Counter64, Unsigned32, enterprises, mib_2, snmpModules, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "MibIdentifier", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "Counter32", "ObjectIdentity", "IpAddress", "Counter64", "Unsigned32", "enterprises", "mib-2", "snmpModules", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumb=jumb, tftp=tftp, staticIpSecondaryDns=staticIpSecondaryDns, port1=port1, unicastsReceived=unicastsReceived, internetPort=internetPort, rebootEnable=rebootEnable, portTable=portTable, unicastsTransmitted=unicastsTransmitted, voltage=voltage, lanportspeed=lanportspeed, lan1=lan1, operStatus=operStatus, qmode=qmode, multicastsReceived=multicastsReceived, fcsErrorReceived=fcsErrorReceived, qos=qos, jumblan1=jumblan1, lan2=lan2, portName=portName, rxPower=rxPower, jumblan4=jumblan4, broadcastsReceived=broadcastsReceived, groupIndex=groupIndex, qmapping=qmapping, portStatistic=portStatistic, vendorPn=vendorPn, priority=priority, qosEntry=qosEntry, portmode=portmode, adminStatus=adminStatus, qosIndex=qosIndex, domainame=domainame, statisticTable=statisticTable, secondaryDns=secondaryDns, groupid=groupid, multicastsTransmitted=multicastsTransmitted, vlanid=vlanid, speed=speed, pauseReceived=pauseReceived, qosTable=qosTable, fileType=fileType, groupEntry=groupEntry, portStatEntry=portStatEntry, ddminfo=ddminfo, xg6846=xg6846, lanportTable=lanportTable, lan4=lan4, jumbwan=jumbwan, jumblan2=jumblan2, serialnum=serialnum, deviceinfo=deviceinfo, staticIpSubMask=staticIpSubMask, staticIpGateway=staticIpGateway, primaryDns=primaryDns, port4=port4, vendorName=vendorName, staticIpAddr=staticIpAddr, txPower=txPower, modeEntry=modeEntry, lanportName=lanportName, lan3=lan3, hostname=hostname, fcsErrorTransmitted=fcsErrorTransmitted, portIndex=portIndex, lanportpause=lanportpause, statIndex=statIndex, fileName=fileName, tftpSevIp=tftpSevIp, port2=port2, vendorOui=vendorOui, catvEnable=catvEnable, catv=catv, wan=wan, staticIpPrimaryDns=staticIpPrimaryDns, portEntry=portEntry, lanportIndex=lanportIndex, staticDns=staticDns, broadcastsTransmitted=broadcastsTransmitted, staticIpDomainName=staticIpDomainName, temperature=temperature, portPower=portPower, dscpEnable=dscpEnable, staticIpHostName=staticIpHostName, wanType=wanType, bias=bias, port3=port3, vlan=vlan, vendorRev=vendorRev, jumblan3=jumblan3, pauseTransmitted=pauseTransmitted, action=action, vlangroupTable=vlangroupTable, reboot=reboot)
