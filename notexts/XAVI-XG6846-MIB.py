...
mib_2, TimeTicks, NotificationType, ModuleIdentity, Counter64, MibIdentifier, IpAddress, Unsigned32, iso, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, snmpModules, Gauge32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "TimeTicks", "NotificationType", "ModuleIdentity", "Counter64", "MibIdentifier", "IpAddress", "Unsigned32", "iso", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "snmpModules", "Gauge32", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumbwan=jumbwan, unicastsTransmitted=unicastsTransmitted, portName=portName, rebootEnable=rebootEnable, vendorPn=vendorPn, staticIpPrimaryDns=staticIpPrimaryDns, tftpSevIp=tftpSevIp, port1=port1, secondaryDns=secondaryDns, staticIpAddr=staticIpAddr, vendorRev=vendorRev, jumblan4=jumblan4, portStatEntry=portStatEntry, xg6846=xg6846, reboot=reboot, broadcastsReceived=broadcastsReceived, vlan=vlan, multicastsTransmitted=multicastsTransmitted, groupid=groupid, qosEntry=qosEntry, staticIpSubMask=staticIpSubMask, unicastsReceived=unicastsReceived, staticIpHostName=staticIpHostName, modeEntry=modeEntry, portEntry=portEntry, internetPort=internetPort, catv=catv, deviceinfo=deviceinfo, port4=port4, jumblan3=jumblan3, tftp=tftp, voltage=voltage, portTable=portTable, action=action, lan2=lan2, fileType=fileType, catvEnable=catvEnable, statIndex=statIndex, groupIndex=groupIndex, vlanid=vlanid, portIndex=portIndex, lanportName=lanportName, operStatus=operStatus, priority=priority, fileName=fileName, rxPower=rxPower, staticDns=staticDns, qmapping=qmapping, primaryDns=primaryDns, txPower=txPower, temperature=temperature, vlangroupTable=vlangroupTable, pauseReceived=pauseReceived, port2=port2, lan3=lan3, qos=qos, jumblan2=jumblan2, fcsErrorReceived=fcsErrorReceived, lanportspeed=lanportspeed, pauseTransmitted=pauseTransmitted, port3=port3, hostname=hostname, vendorName=vendorName, adminStatus=adminStatus, fcsErrorTransmitted=fcsErrorTransmitted, qosTable=qosTable, wan=wan, jumb=jumb, lan1=lan1, ddminfo=ddminfo, domainame=domainame, wanType=wanType, dscpEnable=dscpEnable, staticIpDomainName=staticIpDomainName, lanportTable=lanportTable, staticIpSecondaryDns=staticIpSecondaryDns, groupEntry=groupEntry, vendorOui=vendorOui, portPower=portPower, qosIndex=qosIndex, statisticTable=statisticTable, broadcastsTransmitted=broadcastsTransmitted, serialnum=serialnum, speed=speed, bias=bias, qmode=qmode, portStatistic=portStatistic, lanportpause=lanportpause, lan4=lan4, portmode=portmode, multicastsReceived=multicastsReceived, jumblan1=jumblan1, lanportIndex=lanportIndex, staticIpGateway=staticIpGateway)
