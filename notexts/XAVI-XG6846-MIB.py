...
NotificationType, ModuleIdentity, Integer32, TimeTicks, snmpModules, MibIdentifier, iso, Gauge32, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, Unsigned32, mib_2, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Integer32", "TimeTicks", "snmpModules", "MibIdentifier", "iso", "Gauge32", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "Unsigned32", "mib-2", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpHostName=staticIpHostName, catvEnable=catvEnable, vendorPn=vendorPn, secondaryDns=secondaryDns, lanportpause=lanportpause, temperature=temperature, groupIndex=groupIndex, fileName=fileName, lan1=lan1, ddminfo=ddminfo, wanType=wanType, portEntry=portEntry, portStatEntry=portStatEntry, staticIpGateway=staticIpGateway, portStatistic=portStatistic, operStatus=operStatus, staticIpSubMask=staticIpSubMask, priority=priority, jumblan4=jumblan4, primaryDns=primaryDns, broadcastsTransmitted=broadcastsTransmitted, jumblan1=jumblan1, bias=bias, portTable=portTable, multicastsReceived=multicastsReceived, qosIndex=qosIndex, modeEntry=modeEntry, dscpEnable=dscpEnable, lan3=lan3, fileType=fileType, vendorOui=vendorOui, qosEntry=qosEntry, portIndex=portIndex, speed=speed, qmode=qmode, qosTable=qosTable, staticDns=staticDns, jumbwan=jumbwan, lanportName=lanportName, qmapping=qmapping, hostname=hostname, port1=port1, reboot=reboot, deviceinfo=deviceinfo, groupid=groupid, port3=port3, lanportTable=lanportTable, staticIpPrimaryDns=staticIpPrimaryDns, fcsErrorReceived=fcsErrorReceived, vendorRev=vendorRev, tftp=tftp, staticIpAddr=staticIpAddr, rxPower=rxPower, port4=port4, lanportspeed=lanportspeed, portName=portName, staticIpDomainName=staticIpDomainName, lanportIndex=lanportIndex, vendorName=vendorName, internetPort=internetPort, lan4=lan4, vlangroupTable=vlangroupTable, multicastsTransmitted=multicastsTransmitted, portmode=portmode, tftpSevIp=tftpSevIp, pauseTransmitted=pauseTransmitted, action=action, voltage=voltage, wan=wan, vlanid=vlanid, unicastsTransmitted=unicastsTransmitted, serialnum=serialnum, rebootEnable=rebootEnable, jumblan3=jumblan3, unicastsReceived=unicastsReceived, xg6846=xg6846, domainame=domainame, jumblan2=jumblan2, qos=qos, broadcastsReceived=broadcastsReceived, adminStatus=adminStatus, fcsErrorTransmitted=fcsErrorTransmitted, portPower=portPower, catv=catv, port2=port2, groupEntry=groupEntry, lan2=lan2, statisticTable=statisticTable, txPower=txPower, pauseReceived=pauseReceived, jumb=jumb, vlan=vlan, statIndex=statIndex, staticIpSecondaryDns=staticIpSecondaryDns)
