...
# Produced by pysmi-1.1.3 at Wed Dec  1 14:54:48 2021
...
Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, iso, NotificationType, TimeTicks, enterprises, Bits, Counter64, Gauge32, Integer32, ObjectIdentity, MibIdentifier, ModuleIdentity, mib_2, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "iso", "NotificationType", "TimeTicks", "enterprises", "Bits", "Counter64", "Gauge32", "Integer32", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "mib-2", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", unicastsTransmitted=unicastsTransmitted, fileName=fileName, vendorName=vendorName, wan=wan, staticIpSubMask=staticIpSubMask, portStatistic=portStatistic, catv=catv, jumblan3=jumblan3, lan4=lan4, jumbwan=jumbwan, vlangroupTable=vlangroupTable, dscpEnable=dscpEnable, multicastsTransmitted=multicastsTransmitted, portName=portName, modeEntry=modeEntry, jumb=jumb, port2=port2, speed=speed, operStatus=operStatus, statisticTable=statisticTable, lanportpause=lanportpause, qos=qos, vendorOui=vendorOui, staticIpHostName=staticIpHostName, jumblan4=jumblan4, primaryDns=primaryDns, vlan=vlan, lan3=lan3, port4=port4, unicastsReceived=unicastsReceived, ddminfo=ddminfo, port1=port1, adminStatus=adminStatus, jumblan2=jumblan2, rebootEnable=rebootEnable, staticIpPrimaryDns=staticIpPrimaryDns, jumblan1=jumblan1, deviceinfo=deviceinfo, lanportTable=lanportTable, lanportName=lanportName, staticIpGateway=staticIpGateway, xg6846=xg6846, domainame=domainame, port3=port3, groupid=groupid, priority=priority, tftp=tftp, portmode=portmode, reboot=reboot, secondaryDns=secondaryDns, groupEntry=groupEntry, vlanid=vlanid, lanportspeed=lanportspeed, tftpSevIp=tftpSevIp, staticIpDomainName=staticIpDomainName, internetPort=internetPort, pauseTransmitted=pauseTransmitted, portPower=portPower, fcsErrorReceived=fcsErrorReceived, portEntry=portEntry, vendorPn=vendorPn, voltage=voltage, multicastsReceived=multicastsReceived, pauseReceived=pauseReceived, temperature=temperature, qmapping=qmapping, wanType=wanType, qmode=qmode, broadcastsReceived=broadcastsReceived, serialnum=serialnum, groupIndex=groupIndex, hostname=hostname, rxPower=rxPower, qosTable=qosTable, portStatEntry=portStatEntry, fileType=fileType, staticIpAddr=staticIpAddr, vendorRev=vendorRev, lan1=lan1, staticIpSecondaryDns=staticIpSecondaryDns, txPower=txPower, staticDns=staticDns, statIndex=statIndex, bias=bias, lanportIndex=lanportIndex, fcsErrorTransmitted=fcsErrorTransmitted, lan2=lan2, portTable=portTable, broadcastsTransmitted=broadcastsTransmitted, qosIndex=qosIndex, action=action, catvEnable=catvEnable, portIndex=portIndex, qosEntry=qosEntry)
