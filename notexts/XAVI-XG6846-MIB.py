...
mib_2, TimeTicks, NotificationType, ModuleIdentity, enterprises, ObjectIdentity, Gauge32, IpAddress, Unsigned32, Bits, Counter32, Counter64, iso, Integer32, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "TimeTicks", "NotificationType", "ModuleIdentity", "enterprises", "ObjectIdentity", "Gauge32", "IpAddress", "Unsigned32", "Bits", "Counter32", "Counter64", "iso", "Integer32", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", rxPower=rxPower, catv=catv, staticDns=staticDns, qmapping=qmapping, staticIpDomainName=staticIpDomainName, tftpSevIp=tftpSevIp, broadcastsReceived=broadcastsReceived, pauseReceived=pauseReceived, jumblan4=jumblan4, lanportTable=lanportTable, lanportspeed=lanportspeed, vendorPn=vendorPn, txPower=txPower, groupEntry=groupEntry, portStatistic=portStatistic, portStatEntry=portStatEntry, tftp=tftp, primaryDns=primaryDns, lan4=lan4, staticIpHostName=staticIpHostName, port1=port1, qosEntry=qosEntry, lan1=lan1, fcsErrorReceived=fcsErrorReceived, vlan=vlan, fileName=fileName, pauseTransmitted=pauseTransmitted, lanportIndex=lanportIndex, deviceinfo=deviceinfo, lanportName=lanportName, portPower=portPower, statIndex=statIndex, multicastsReceived=multicastsReceived, speed=speed, jumblan3=jumblan3, qos=qos, groupIndex=groupIndex, staticIpSubMask=staticIpSubMask, adminStatus=adminStatus, staticIpPrimaryDns=staticIpPrimaryDns, hostname=hostname, qosTable=qosTable, lan3=lan3, temperature=temperature, portEntry=portEntry, qosIndex=qosIndex, port4=port4, action=action, xg6846=xg6846, dscpEnable=dscpEnable, portIndex=portIndex, operStatus=operStatus, staticIpSecondaryDns=staticIpSecondaryDns, portTable=portTable, portName=portName, jumb=jumb, domainame=domainame, fileType=fileType, jumblan1=jumblan1, unicastsTransmitted=unicastsTransmitted, broadcastsTransmitted=broadcastsTransmitted, vendorName=vendorName, staticIpAddr=staticIpAddr, statisticTable=statisticTable, modeEntry=modeEntry, unicastsReceived=unicastsReceived, jumbwan=jumbwan, portmode=portmode, lanportpause=lanportpause, vendorOui=vendorOui, reboot=reboot, qmode=qmode, vendorRev=vendorRev, internetPort=internetPort, multicastsTransmitted=multicastsTransmitted, secondaryDns=secondaryDns, staticIpGateway=staticIpGateway, ddminfo=ddminfo, fcsErrorTransmitted=fcsErrorTransmitted, rebootEnable=rebootEnable, bias=bias, serialnum=serialnum, port2=port2, voltage=voltage, port3=port3, vlanid=vlanid, wanType=wanType, lan2=lan2, catvEnable=catvEnable, groupid=groupid, wan=wan, priority=priority, vlangroupTable=vlangroupTable, jumblan2=jumblan2)
