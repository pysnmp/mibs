...
# Produced by pysmi-1.1.3 at Sun Nov 28 15:03:46 2021
...
Gauge32, Bits, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, Unsigned32, Counter64, ObjectIdentity, MibIdentifier, TimeTicks, enterprises, mib_2, Counter32, NotificationType, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "Unsigned32", "Counter64", "ObjectIdentity", "MibIdentifier", "TimeTicks", "enterprises", "mib-2", "Counter32", "NotificationType", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", reboot=reboot, lan3=lan3, txPower=txPower, lanportName=lanportName, vlangroupTable=vlangroupTable, priority=priority, staticIpSecondaryDns=staticIpSecondaryDns, port3=port3, fcsErrorTransmitted=fcsErrorTransmitted, port1=port1, jumblan1=jumblan1, lan2=lan2, pauseReceived=pauseReceived, pauseTransmitted=pauseTransmitted, domainame=domainame, portPower=portPower, broadcastsTransmitted=broadcastsTransmitted, lanportTable=lanportTable, temperature=temperature, fileType=fileType, ddminfo=ddminfo, rebootEnable=rebootEnable, port2=port2, speed=speed, voltage=voltage, tftpSevIp=tftpSevIp, tftp=tftp, primaryDns=primaryDns, xg6846=xg6846, qmode=qmode, internetPort=internetPort, jumblan3=jumblan3, unicastsReceived=unicastsReceived, deviceinfo=deviceinfo, staticIpGateway=staticIpGateway, adminStatus=adminStatus, portmode=portmode, portIndex=portIndex, secondaryDns=secondaryDns, qosEntry=qosEntry, qosIndex=qosIndex, jumblan4=jumblan4, qos=qos, jumb=jumb, lanportpause=lanportpause, operStatus=operStatus, jumblan2=jumblan2, bias=bias, groupid=groupid, portName=portName, staticIpSubMask=staticIpSubMask, jumbwan=jumbwan, wanType=wanType, qmapping=qmapping, vendorRev=vendorRev, lanportIndex=lanportIndex, lan4=lan4, portTable=portTable, broadcastsReceived=broadcastsReceived, catv=catv, action=action, groupEntry=groupEntry, wan=wan, fileName=fileName, catvEnable=catvEnable, portStatistic=portStatistic, fcsErrorReceived=fcsErrorReceived, vendorName=vendorName, multicastsReceived=multicastsReceived, dscpEnable=dscpEnable, statisticTable=statisticTable, lan1=lan1, vendorOui=vendorOui, vlan=vlan, staticIpAddr=staticIpAddr, lanportspeed=lanportspeed, port4=port4, rxPower=rxPower, staticDns=staticDns, vendorPn=vendorPn, hostname=hostname, statIndex=statIndex, modeEntry=modeEntry, staticIpHostName=staticIpHostName, portEntry=portEntry, vlanid=vlanid, portStatEntry=portStatEntry, staticIpPrimaryDns=staticIpPrimaryDns, qosTable=qosTable, multicastsTransmitted=multicastsTransmitted, unicastsTransmitted=unicastsTransmitted, staticIpDomainName=staticIpDomainName, groupIndex=groupIndex, serialnum=serialnum)
