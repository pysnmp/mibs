...
iso, TimeTicks, IpAddress, Counter64, ObjectIdentity, mib_2, MibIdentifier, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Unsigned32, Bits, enterprises, Integer32, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "IpAddress", "Counter64", "ObjectIdentity", "mib-2", "MibIdentifier", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Unsigned32", "Bits", "enterprises", "Integer32", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", tftp=tftp, vlangroupTable=vlangroupTable, catv=catv, reboot=reboot, txPower=txPower, catvEnable=catvEnable, modeEntry=modeEntry, groupid=groupid, vendorPn=vendorPn, serialnum=serialnum, pauseReceived=pauseReceived, lan4=lan4, action=action, unicastsTransmitted=unicastsTransmitted, statIndex=statIndex, pauseTransmitted=pauseTransmitted, temperature=temperature, fileType=fileType, fileName=fileName, portIndex=portIndex, priority=priority, xg6846=xg6846, speed=speed, groupIndex=groupIndex, statisticTable=statisticTable, jumblan1=jumblan1, port3=port3, qosTable=qosTable, unicastsReceived=unicastsReceived, lanportspeed=lanportspeed, lanportName=lanportName, qosEntry=qosEntry, qmapping=qmapping, deviceinfo=deviceinfo, staticIpSecondaryDns=staticIpSecondaryDns, jumb=jumb, vendorRev=vendorRev, broadcastsReceived=broadcastsReceived, broadcastsTransmitted=broadcastsTransmitted, staticIpAddr=staticIpAddr, rxPower=rxPower, qmode=qmode, multicastsReceived=multicastsReceived, staticIpGateway=staticIpGateway, ddminfo=ddminfo, lan1=lan1, portStatEntry=portStatEntry, operStatus=operStatus, staticIpHostName=staticIpHostName, jumblan4=jumblan4, fcsErrorTransmitted=fcsErrorTransmitted, wanType=wanType, vendorName=vendorName, rebootEnable=rebootEnable, groupEntry=groupEntry, hostname=hostname, portmode=portmode, primaryDns=primaryDns, multicastsTransmitted=multicastsTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, lan3=lan3, lanportIndex=lanportIndex, staticIpSubMask=staticIpSubMask, portEntry=portEntry, domainame=domainame, staticDns=staticDns, internetPort=internetPort, bias=bias, tftpSevIp=tftpSevIp, port4=port4, qosIndex=qosIndex, port2=port2, lanportpause=lanportpause, voltage=voltage, portPower=portPower, portStatistic=portStatistic, port1=port1, portTable=portTable, vendorOui=vendorOui, vlan=vlan, lan2=lan2, staticIpDomainName=staticIpDomainName, fcsErrorReceived=fcsErrorReceived, wan=wan, secondaryDns=secondaryDns, vlanid=vlanid, jumbwan=jumbwan, dscpEnable=dscpEnable, portName=portName, jumblan3=jumblan3, jumblan2=jumblan2, lanportTable=lanportTable, qos=qos, adminStatus=adminStatus)
