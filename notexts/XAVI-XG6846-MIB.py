...
# Produced by pysmi-1.1.8 at Tue Feb  1 21:06:55 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, enterprises, mib_2, Gauge32, Bits, Counter32, iso, NotificationType, MibIdentifier, snmpModules, Counter64, ObjectIdentity, Unsigned32, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "enterprises", "mib-2", "Gauge32", "Bits", "Counter32", "iso", "NotificationType", "MibIdentifier", "snmpModules", "Counter64", "ObjectIdentity", "Unsigned32", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupEntry=groupEntry, lan1=lan1, txPower=txPower, secondaryDns=secondaryDns, port4=port4, port3=port3, dscpEnable=dscpEnable, bias=bias, portmode=portmode, internetPort=internetPort, staticIpGateway=staticIpGateway, fcsErrorTransmitted=fcsErrorTransmitted, unicastsTransmitted=unicastsTransmitted, speed=speed, qmapping=qmapping, jumblan1=jumblan1, wan=wan, deviceinfo=deviceinfo, portStatEntry=portStatEntry, xg6846=xg6846, fileType=fileType, operStatus=operStatus, qosTable=qosTable, qos=qos, port1=port1, serialnum=serialnum, portPower=portPower, pauseReceived=pauseReceived, multicastsReceived=multicastsReceived, action=action, tftp=tftp, adminStatus=adminStatus, primaryDns=primaryDns, portEntry=portEntry, jumblan2=jumblan2, temperature=temperature, staticIpDomainName=staticIpDomainName, vlan=vlan, lan4=lan4, vendorName=vendorName, statIndex=statIndex, groupIndex=groupIndex, hostname=hostname, portStatistic=portStatistic, qosEntry=qosEntry, jumb=jumb, qosIndex=qosIndex, vlangroupTable=vlangroupTable, lanportpause=lanportpause, portName=portName, portIndex=portIndex, catvEnable=catvEnable, vendorPn=vendorPn, pauseTransmitted=pauseTransmitted, staticIpSubMask=staticIpSubMask, broadcastsReceived=broadcastsReceived, staticIpHostName=staticIpHostName, fcsErrorReceived=fcsErrorReceived, voltage=voltage, port2=port2, lanportTable=lanportTable, reboot=reboot, staticDns=staticDns, statisticTable=statisticTable, multicastsTransmitted=multicastsTransmitted, jumbwan=jumbwan, broadcastsTransmitted=broadcastsTransmitted, catv=catv, staticIpSecondaryDns=staticIpSecondaryDns, unicastsReceived=unicastsReceived, vendorRev=vendorRev, lanportName=lanportName, lanportspeed=lanportspeed, wanType=wanType, lanportIndex=lanportIndex, domainame=domainame, lan2=lan2, portTable=portTable, vendorOui=vendorOui, staticIpAddr=staticIpAddr, fileName=fileName, groupid=groupid, rebootEnable=rebootEnable, priority=priority, modeEntry=modeEntry, rxPower=rxPower, lan3=lan3, jumblan3=jumblan3, vlanid=vlanid, ddminfo=ddminfo, qmode=qmode, jumblan4=jumblan4, tftpSevIp=tftpSevIp, staticIpPrimaryDns=staticIpPrimaryDns)
