...
# Produced by pysmi-1.1.12 at Tue Jun  4 13:05:04 2024
...
mib_2, Bits, Integer32, Unsigned32, Counter32, NotificationType, MibIdentifier, ModuleIdentity, ObjectIdentity, snmpModules, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Bits", "Integer32", "Unsigned32", "Counter32", "NotificationType", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "snmpModules", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", deviceinfo=deviceinfo, qosIndex=qosIndex, lan3=lan3, portmode=portmode, staticIpGateway=staticIpGateway, lanportpause=lanportpause, qos=qos, priority=priority, wan=wan, qmode=qmode, jumbwan=jumbwan, multicastsReceived=multicastsReceived, txPower=txPower, broadcastsTransmitted=broadcastsTransmitted, internetPort=internetPort, wanType=wanType, statisticTable=statisticTable, fcsErrorTransmitted=fcsErrorTransmitted, qosEntry=qosEntry, staticIpSubMask=staticIpSubMask, portTable=portTable, portStatEntry=portStatEntry, vlanid=vlanid, staticIpPrimaryDns=staticIpPrimaryDns, broadcastsReceived=broadcastsReceived, pauseReceived=pauseReceived, secondaryDns=secondaryDns, action=action, jumblan3=jumblan3, tftp=tftp, jumb=jumb, serialnum=serialnum, portName=portName, port4=port4, vendorPn=vendorPn, staticIpDomainName=staticIpDomainName, vendorOui=vendorOui, groupIndex=groupIndex, jumblan1=jumblan1, bias=bias, temperature=temperature, jumblan2=jumblan2, ddminfo=ddminfo, multicastsTransmitted=multicastsTransmitted, fcsErrorReceived=fcsErrorReceived, port2=port2, xg6846=xg6846, qmapping=qmapping, fileName=fileName, staticIpAddr=staticIpAddr, modeEntry=modeEntry, speed=speed, staticIpHostName=staticIpHostName, portPower=portPower, groupEntry=groupEntry, catvEnable=catvEnable, unicastsTransmitted=unicastsTransmitted, lanportspeed=lanportspeed, portEntry=portEntry, vlan=vlan, rxPower=rxPower, vlangroupTable=vlangroupTable, hostname=hostname, domainame=domainame, lan1=lan1, lan2=lan2, portStatistic=portStatistic, qosTable=qosTable, jumblan4=jumblan4, voltage=voltage, dscpEnable=dscpEnable, pauseTransmitted=pauseTransmitted, adminStatus=adminStatus, tftpSevIp=tftpSevIp, staticDns=staticDns, port3=port3, reboot=reboot, staticIpSecondaryDns=staticIpSecondaryDns, groupid=groupid, statIndex=statIndex, unicastsReceived=unicastsReceived, vendorRev=vendorRev, fileType=fileType, lanportName=lanportName, rebootEnable=rebootEnable, operStatus=operStatus, lanportIndex=lanportIndex, catv=catv, lan4=lan4, lanportTable=lanportTable, primaryDns=primaryDns, vendorName=vendorName, port1=port1, portIndex=portIndex)
