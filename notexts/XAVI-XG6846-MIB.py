...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, Counter64, Gauge32, MibIdentifier, Bits, IpAddress, ObjectIdentity, snmpModules, Integer32, ModuleIdentity, Unsigned32, enterprises, Counter32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "Counter64", "Gauge32", "MibIdentifier", "Bits", "IpAddress", "ObjectIdentity", "snmpModules", "Integer32", "ModuleIdentity", "Unsigned32", "enterprises", "Counter32", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fcsErrorReceived=fcsErrorReceived, groupEntry=groupEntry, jumbwan=jumbwan, lanportpause=lanportpause, jumblan3=jumblan3, portStatEntry=portStatEntry, tftp=tftp, tftpSevIp=tftpSevIp, multicastsReceived=multicastsReceived, portIndex=portIndex, lanportspeed=lanportspeed, lanportTable=lanportTable, txPower=txPower, jumblan4=jumblan4, dscpEnable=dscpEnable, broadcastsTransmitted=broadcastsTransmitted, vlan=vlan, bias=bias, portmode=portmode, vlanid=vlanid, vlangroupTable=vlangroupTable, fcsErrorTransmitted=fcsErrorTransmitted, rebootEnable=rebootEnable, action=action, adminStatus=adminStatus, lanportIndex=lanportIndex, priority=priority, lanportName=lanportName, pauseReceived=pauseReceived, speed=speed, internetPort=internetPort, vendorName=vendorName, modeEntry=modeEntry, vendorPn=vendorPn, broadcastsReceived=broadcastsReceived, wanType=wanType, jumblan1=jumblan1, qosIndex=qosIndex, lan3=lan3, wan=wan, portTable=portTable, staticIpHostName=staticIpHostName, reboot=reboot, operStatus=operStatus, serialnum=serialnum, port3=port3, fileName=fileName, lan4=lan4, xg6846=xg6846, primaryDns=primaryDns, qmapping=qmapping, port1=port1, rxPower=rxPower, port2=port2, portStatistic=portStatistic, deviceinfo=deviceinfo, staticIpAddr=staticIpAddr, groupid=groupid, portName=portName, unicastsReceived=unicastsReceived, staticIpGateway=staticIpGateway, qosTable=qosTable, portPower=portPower, voltage=voltage, vendorOui=vendorOui, statIndex=statIndex, temperature=temperature, lan2=lan2, jumblan2=jumblan2, ddminfo=ddminfo, staticIpPrimaryDns=staticIpPrimaryDns, staticIpDomainName=staticIpDomainName, staticIpSubMask=staticIpSubMask, staticIpSecondaryDns=staticIpSecondaryDns, domainame=domainame, vendorRev=vendorRev, hostname=hostname, pauseTransmitted=pauseTransmitted, qos=qos, jumb=jumb, fileType=fileType, statisticTable=statisticTable, port4=port4, catv=catv, qmode=qmode, staticDns=staticDns, portEntry=portEntry, catvEnable=catvEnable, groupIndex=groupIndex, qosEntry=qosEntry, unicastsTransmitted=unicastsTransmitted, lan1=lan1, multicastsTransmitted=multicastsTransmitted, secondaryDns=secondaryDns)
