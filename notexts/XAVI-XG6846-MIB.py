...
# Produced by pysmi-1.1.8 at Thu Feb  9 12:03:51 2023
...
TimeTicks, NotificationType, snmpModules, Counter64, MibIdentifier, mib_2, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, ObjectIdentity, Unsigned32, IpAddress, Counter32, Integer32, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "snmpModules", "Counter64", "MibIdentifier", "mib-2", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "ObjectIdentity", "Unsigned32", "IpAddress", "Counter32", "Integer32", "iso", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorOui=vendorOui, jumbwan=jumbwan, jumb=jumb, multicastsReceived=multicastsReceived, portIndex=portIndex, modeEntry=modeEntry, jumblan4=jumblan4, broadcastsReceived=broadcastsReceived, qos=qos, portName=portName, txPower=txPower, bias=bias, lanportIndex=lanportIndex, groupIndex=groupIndex, domainame=domainame, unicastsReceived=unicastsReceived, vendorName=vendorName, internetPort=internetPort, speed=speed, portStatEntry=portStatEntry, xg6846=xg6846, tftp=tftp, lan1=lan1, reboot=reboot, statisticTable=statisticTable, jumblan2=jumblan2, lanportTable=lanportTable, qmapping=qmapping, wanType=wanType, priority=priority, portmode=portmode, serialnum=serialnum, fileName=fileName, fcsErrorReceived=fcsErrorReceived, fcsErrorTransmitted=fcsErrorTransmitted, qosIndex=qosIndex, staticIpHostName=staticIpHostName, deviceinfo=deviceinfo, lanportpause=lanportpause, staticIpSecondaryDns=staticIpSecondaryDns, staticIpAddr=staticIpAddr, portTable=portTable, statIndex=statIndex, voltage=voltage, qmode=qmode, tftpSevIp=tftpSevIp, fileType=fileType, rebootEnable=rebootEnable, lan2=lan2, wan=wan, multicastsTransmitted=multicastsTransmitted, catvEnable=catvEnable, qosTable=qosTable, port4=port4, lan4=lan4, portEntry=portEntry, vendorPn=vendorPn, staticDns=staticDns, secondaryDns=secondaryDns, staticIpPrimaryDns=staticIpPrimaryDns, portPower=portPower, vlanid=vlanid, staticIpGateway=staticIpGateway, primaryDns=primaryDns, jumblan1=jumblan1, temperature=temperature, lanportspeed=lanportspeed, unicastsTransmitted=unicastsTransmitted, rxPower=rxPower, port1=port1, vlan=vlan, vlangroupTable=vlangroupTable, adminStatus=adminStatus, lan3=lan3, groupEntry=groupEntry, dscpEnable=dscpEnable, pauseReceived=pauseReceived, qosEntry=qosEntry, groupid=groupid, jumblan3=jumblan3, portStatistic=portStatistic, ddminfo=ddminfo, operStatus=operStatus, catv=catv, port2=port2, staticIpSubMask=staticIpSubMask, action=action, pauseTransmitted=pauseTransmitted, staticIpDomainName=staticIpDomainName, hostname=hostname, port3=port3, lanportName=lanportName, vendorRev=vendorRev, broadcastsTransmitted=broadcastsTransmitted)
