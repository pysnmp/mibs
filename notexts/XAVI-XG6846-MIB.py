...
# Produced by pysmi-1.1.8 at Thu Feb  9 14:01:37 2023
...
Counter64, Integer32, ModuleIdentity, mib_2, Counter32, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, snmpModules, Gauge32, ObjectIdentity, IpAddress, Unsigned32, iso, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "ModuleIdentity", "mib-2", "Counter32", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "snmpModules", "Gauge32", "ObjectIdentity", "IpAddress", "Unsigned32", "iso", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catvEnable=catvEnable, bias=bias, domainame=domainame, port2=port2, qmode=qmode, priority=priority, secondaryDns=secondaryDns, vendorPn=vendorPn, port4=port4, portStatistic=portStatistic, operStatus=operStatus, vlan=vlan, txPower=txPower, modeEntry=modeEntry, tftpSevIp=tftpSevIp, portTable=portTable, ddminfo=ddminfo, internetPort=internetPort, serialnum=serialnum, port3=port3, pauseTransmitted=pauseTransmitted, jumbwan=jumbwan, lanportspeed=lanportspeed, reboot=reboot, vendorRev=vendorRev, vendorName=vendorName, staticIpHostName=staticIpHostName, broadcastsReceived=broadcastsReceived, primaryDns=primaryDns, vlangroupTable=vlangroupTable, fileType=fileType, tftp=tftp, lan1=lan1, lanportpause=lanportpause, staticIpSubMask=staticIpSubMask, speed=speed, lan3=lan3, portIndex=portIndex, qos=qos, voltage=voltage, staticIpPrimaryDns=staticIpPrimaryDns, action=action, unicastsTransmitted=unicastsTransmitted, portPower=portPower, vendorOui=vendorOui, groupid=groupid, fcsErrorTransmitted=fcsErrorTransmitted, broadcastsTransmitted=broadcastsTransmitted, multicastsReceived=multicastsReceived, fcsErrorReceived=fcsErrorReceived, qosEntry=qosEntry, hostname=hostname, groupIndex=groupIndex, lan2=lan2, rxPower=rxPower, portEntry=portEntry, groupEntry=groupEntry, staticIpAddr=staticIpAddr, deviceinfo=deviceinfo, lanportTable=lanportTable, portmode=portmode, statisticTable=statisticTable, xg6846=xg6846, wan=wan, temperature=temperature, jumblan4=jumblan4, lanportIndex=lanportIndex, pauseReceived=pauseReceived, adminStatus=adminStatus, vlanid=vlanid, dscpEnable=dscpEnable, portName=portName, unicastsReceived=unicastsReceived, rebootEnable=rebootEnable, multicastsTransmitted=multicastsTransmitted, wanType=wanType, fileName=fileName, jumblan2=jumblan2, qosTable=qosTable, staticIpGateway=staticIpGateway, lanportName=lanportName, port1=port1, jumb=jumb, staticIpSecondaryDns=staticIpSecondaryDns, staticIpDomainName=staticIpDomainName, qosIndex=qosIndex, jumblan1=jumblan1, qmapping=qmapping, lan4=lan4, statIndex=statIndex, staticDns=staticDns, portStatEntry=portStatEntry, jumblan3=jumblan3, catv=catv)
