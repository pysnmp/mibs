...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:39:50 2023
...
TimeTicks, snmpModules, Unsigned32, IpAddress, NotificationType, iso, MibIdentifier, enterprises, ObjectIdentity, mib_2, Bits, Counter64, Counter32, ModuleIdentity, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "snmpModules", "Unsigned32", "IpAddress", "NotificationType", "iso", "MibIdentifier", "enterprises", "ObjectIdentity", "mib-2", "Bits", "Counter64", "Counter32", "ModuleIdentity", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan1=lan1, portName=portName, jumblan3=jumblan3, wan=wan, pauseTransmitted=pauseTransmitted, staticIpHostName=staticIpHostName, qosEntry=qosEntry, portIndex=portIndex, catv=catv, tftpSevIp=tftpSevIp, statIndex=statIndex, qosIndex=qosIndex, dscpEnable=dscpEnable, action=action, reboot=reboot, voltage=voltage, lan3=lan3, qosTable=qosTable, port2=port2, lanportIndex=lanportIndex, secondaryDns=secondaryDns, hostname=hostname, modeEntry=modeEntry, multicastsReceived=multicastsReceived, xg6846=xg6846, vendorRev=vendorRev, lanportTable=lanportTable, primaryDns=primaryDns, txPower=txPower, vendorName=vendorName, portPower=portPower, priority=priority, unicastsReceived=unicastsReceived, catvEnable=catvEnable, groupEntry=groupEntry, vlanid=vlanid, jumblan1=jumblan1, multicastsTransmitted=multicastsTransmitted, fileType=fileType, fcsErrorTransmitted=fcsErrorTransmitted, wanType=wanType, operStatus=operStatus, port3=port3, vlangroupTable=vlangroupTable, tftp=tftp, portStatistic=portStatistic, speed=speed, portStatEntry=portStatEntry, jumb=jumb, lanportpause=lanportpause, unicastsTransmitted=unicastsTransmitted, rxPower=rxPower, broadcastsTransmitted=broadcastsTransmitted, fileName=fileName, portmode=portmode, domainame=domainame, portEntry=portEntry, lan2=lan2, adminStatus=adminStatus, fcsErrorReceived=fcsErrorReceived, lan4=lan4, jumblan4=jumblan4, port4=port4, jumblan2=jumblan2, qmode=qmode, broadcastsReceived=broadcastsReceived, bias=bias, vendorOui=vendorOui, vlan=vlan, lanportName=lanportName, rebootEnable=rebootEnable, temperature=temperature, groupid=groupid, lanportspeed=lanportspeed, port1=port1, staticIpSecondaryDns=staticIpSecondaryDns, staticIpDomainName=staticIpDomainName, staticDns=staticDns, staticIpPrimaryDns=staticIpPrimaryDns, staticIpAddr=staticIpAddr, staticIpGateway=staticIpGateway, pauseReceived=pauseReceived, statisticTable=statisticTable, staticIpSubMask=staticIpSubMask, qmapping=qmapping, ddminfo=ddminfo, portTable=portTable, jumbwan=jumbwan, deviceinfo=deviceinfo, groupIndex=groupIndex, internetPort=internetPort, serialnum=serialnum, qos=qos, vendorPn=vendorPn)
