...
Gauge32, snmpModules, enterprises, IpAddress, Counter64, iso, ModuleIdentity, TimeTicks, Integer32, MibIdentifier, Unsigned32, ObjectIdentity, mib_2, Counter32, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "snmpModules", "enterprises", "IpAddress", "Counter64", "iso", "ModuleIdentity", "TimeTicks", "Integer32", "MibIdentifier", "Unsigned32", "ObjectIdentity", "mib-2", "Counter32", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan4=lan4, speed=speed, internetPort=internetPort, staticIpAddr=staticIpAddr, staticIpGateway=staticIpGateway, jumblan3=jumblan3, qosEntry=qosEntry, vendorName=vendorName, portEntry=portEntry, vlangroupTable=vlangroupTable, ddminfo=ddminfo, vlanid=vlanid, qos=qos, portmode=portmode, dscpEnable=dscpEnable, lanportspeed=lanportspeed, lanportpause=lanportpause, portName=portName, secondaryDns=secondaryDns, staticDns=staticDns, jumblan1=jumblan1, qmapping=qmapping, fileName=fileName, multicastsTransmitted=multicastsTransmitted, wan=wan, vendorOui=vendorOui, qmode=qmode, portStatistic=portStatistic, serialnum=serialnum, multicastsReceived=multicastsReceived, deviceinfo=deviceinfo, groupIndex=groupIndex, lan2=lan2, operStatus=operStatus, priority=priority, port3=port3, qosIndex=qosIndex, staticIpSubMask=staticIpSubMask, broadcastsReceived=broadcastsReceived, port4=port4, broadcastsTransmitted=broadcastsTransmitted, adminStatus=adminStatus, catv=catv, modeEntry=modeEntry, qosTable=qosTable, vendorRev=vendorRev, action=action, port2=port2, tftp=tftp, jumblan4=jumblan4, port1=port1, tftpSevIp=tftpSevIp, fcsErrorReceived=fcsErrorReceived, jumbwan=jumbwan, portTable=portTable, pauseReceived=pauseReceived, jumblan2=jumblan2, portStatEntry=portStatEntry, statIndex=statIndex, vendorPn=vendorPn, unicastsTransmitted=unicastsTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, hostname=hostname, lan1=lan1, pauseTransmitted=pauseTransmitted, lanportName=lanportName, unicastsReceived=unicastsReceived, portIndex=portIndex, catvEnable=catvEnable, lanportTable=lanportTable, reboot=reboot, portPower=portPower, groupid=groupid, wanType=wanType, txPower=txPower, primaryDns=primaryDns, staticIpHostName=staticIpHostName, fileType=fileType, temperature=temperature, vlan=vlan, domainame=domainame, groupEntry=groupEntry, bias=bias, xg6846=xg6846, lanportIndex=lanportIndex, rxPower=rxPower, staticIpPrimaryDns=staticIpPrimaryDns, lan3=lan3, fcsErrorTransmitted=fcsErrorTransmitted, jumb=jumb, rebootEnable=rebootEnable, voltage=voltage, statisticTable=statisticTable, staticIpDomainName=staticIpDomainName)
