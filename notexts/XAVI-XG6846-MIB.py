...
enterprises, Unsigned32, snmpModules, Counter64, NotificationType, mib_2, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, Gauge32, MibIdentifier, ModuleIdentity, ObjectIdentity, iso, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Unsigned32", "snmpModules", "Counter64", "NotificationType", "mib-2", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "Gauge32", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "iso", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fileName=fileName, lanportpause=lanportpause, groupid=groupid, temperature=temperature, secondaryDns=secondaryDns, lanportName=lanportName, txPower=txPower, deviceinfo=deviceinfo, jumblan3=jumblan3, jumblan2=jumblan2, bias=bias, lan2=lan2, jumblan1=jumblan1, fcsErrorReceived=fcsErrorReceived, adminStatus=adminStatus, staticIpSecondaryDns=staticIpSecondaryDns, statIndex=statIndex, lan4=lan4, qosTable=qosTable, dscpEnable=dscpEnable, catv=catv, lanportIndex=lanportIndex, vendorPn=vendorPn, qosEntry=qosEntry, broadcastsReceived=broadcastsReceived, vlanid=vlanid, vendorOui=vendorOui, operStatus=operStatus, vlangroupTable=vlangroupTable, wanType=wanType, jumb=jumb, voltage=voltage, lan1=lan1, jumbwan=jumbwan, fcsErrorTransmitted=fcsErrorTransmitted, speed=speed, broadcastsTransmitted=broadcastsTransmitted, pauseTransmitted=pauseTransmitted, priority=priority, portmode=portmode, qmode=qmode, catvEnable=catvEnable, unicastsReceived=unicastsReceived, groupIndex=groupIndex, staticIpSubMask=staticIpSubMask, rxPower=rxPower, portIndex=portIndex, multicastsReceived=multicastsReceived, vendorName=vendorName, staticIpPrimaryDns=staticIpPrimaryDns, pauseReceived=pauseReceived, qmapping=qmapping, jumblan4=jumblan4, lanportspeed=lanportspeed, multicastsTransmitted=multicastsTransmitted, statisticTable=statisticTable, lanportTable=lanportTable, staticIpHostName=staticIpHostName, domainame=domainame, qos=qos, vlan=vlan, internetPort=internetPort, action=action, xg6846=xg6846, staticIpGateway=staticIpGateway, fileType=fileType, primaryDns=primaryDns, qosIndex=qosIndex, lan3=lan3, serialnum=serialnum, portEntry=portEntry, unicastsTransmitted=unicastsTransmitted, vendorRev=vendorRev, port4=port4, port1=port1, groupEntry=groupEntry, portTable=portTable, port3=port3, tftpSevIp=tftpSevIp, portPower=portPower, rebootEnable=rebootEnable, reboot=reboot, ddminfo=ddminfo, staticIpAddr=staticIpAddr, portStatEntry=portStatEntry, tftp=tftp, modeEntry=modeEntry, wan=wan, portName=portName, hostname=hostname, portStatistic=portStatistic, port2=port2, staticIpDomainName=staticIpDomainName, staticDns=staticDns)
