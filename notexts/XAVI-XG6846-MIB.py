...
Integer32, snmpModules, mib_2, ObjectIdentity, TimeTicks, Bits, NotificationType, iso, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, ModuleIdentity, Gauge32, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "snmpModules", "mib-2", "ObjectIdentity", "TimeTicks", "Bits", "NotificationType", "iso", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "ModuleIdentity", "Gauge32", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portStatEntry=portStatEntry, pauseTransmitted=pauseTransmitted, qosTable=qosTable, operStatus=operStatus, serialnum=serialnum, portEntry=portEntry, internetPort=internetPort, groupIndex=groupIndex, portTable=portTable, lanportTable=lanportTable, priority=priority, jumb=jumb, jumbwan=jumbwan, vendorName=vendorName, staticIpDomainName=staticIpDomainName, qmode=qmode, lan2=lan2, pauseReceived=pauseReceived, adminStatus=adminStatus, xg6846=xg6846, staticIpSubMask=staticIpSubMask, tftp=tftp, qmapping=qmapping, groupEntry=groupEntry, staticIpAddr=staticIpAddr, lan1=lan1, staticIpSecondaryDns=staticIpSecondaryDns, broadcastsReceived=broadcastsReceived, rxPower=rxPower, ddminfo=ddminfo, deviceinfo=deviceinfo, lanportIndex=lanportIndex, port2=port2, jumblan4=jumblan4, modeEntry=modeEntry, jumblan3=jumblan3, portmode=portmode, staticIpGateway=staticIpGateway, vendorOui=vendorOui, primaryDns=primaryDns, lan3=lan3, qos=qos, unicastsTransmitted=unicastsTransmitted, vlan=vlan, multicastsReceived=multicastsReceived, hostname=hostname, lanportName=lanportName, portPower=portPower, vendorPn=vendorPn, secondaryDns=secondaryDns, port3=port3, port4=port4, temperature=temperature, unicastsReceived=unicastsReceived, broadcastsTransmitted=broadcastsTransmitted, lan4=lan4, tftpSevIp=tftpSevIp, fileName=fileName, action=action, portName=portName, bias=bias, lanportspeed=lanportspeed, voltage=voltage, reboot=reboot, dscpEnable=dscpEnable, vlangroupTable=vlangroupTable, jumblan2=jumblan2, vendorRev=vendorRev, lanportpause=lanportpause, statisticTable=statisticTable, jumblan1=jumblan1, staticDns=staticDns, catvEnable=catvEnable, speed=speed, qosEntry=qosEntry, rebootEnable=rebootEnable, wan=wan, portStatistic=portStatistic, catv=catv, txPower=txPower, multicastsTransmitted=multicastsTransmitted, vlanid=vlanid, groupid=groupid, fcsErrorReceived=fcsErrorReceived, fcsErrorTransmitted=fcsErrorTransmitted, domainame=domainame, fileType=fileType, staticIpPrimaryDns=staticIpPrimaryDns, port1=port1, statIndex=statIndex, wanType=wanType, staticIpHostName=staticIpHostName, qosIndex=qosIndex, portIndex=portIndex)
