...
NotificationType, mib_2, Bits, Counter32, Unsigned32, ModuleIdentity, Counter64, iso, snmpModules, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, MibIdentifier, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "mib-2", "Bits", "Counter32", "Unsigned32", "ModuleIdentity", "Counter64", "iso", "snmpModules", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "MibIdentifier", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", pauseTransmitted=pauseTransmitted, hostname=hostname, fileType=fileType, broadcastsReceived=broadcastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, catvEnable=catvEnable, lan4=lan4, vlanid=vlanid, portIndex=portIndex, tftp=tftp, tftpSevIp=tftpSevIp, port1=port1, groupIndex=groupIndex, action=action, adminStatus=adminStatus, lanportIndex=lanportIndex, vlangroupTable=vlangroupTable, pauseReceived=pauseReceived, vendorOui=vendorOui, staticIpHostName=staticIpHostName, ddminfo=ddminfo, portStatEntry=portStatEntry, wan=wan, port3=port3, wanType=wanType, dscpEnable=dscpEnable, lanportName=lanportName, vendorName=vendorName, speed=speed, portEntry=portEntry, staticIpSubMask=staticIpSubMask, vlan=vlan, port4=port4, staticIpDomainName=staticIpDomainName, catv=catv, fcsErrorReceived=fcsErrorReceived, multicastsTransmitted=multicastsTransmitted, multicastsReceived=multicastsReceived, jumblan4=jumblan4, rebootEnable=rebootEnable, deviceinfo=deviceinfo, priority=priority, staticDns=staticDns, qos=qos, jumb=jumb, voltage=voltage, jumblan2=jumblan2, portTable=portTable, modeEntry=modeEntry, lanportTable=lanportTable, lan1=lan1, vendorPn=vendorPn, statIndex=statIndex, reboot=reboot, temperature=temperature, unicastsTransmitted=unicastsTransmitted, fileName=fileName, broadcastsTransmitted=broadcastsTransmitted, port2=port2, serialnum=serialnum, statisticTable=statisticTable, groupid=groupid, internetPort=internetPort, portPower=portPower, operStatus=operStatus, lanportpause=lanportpause, lan2=lan2, vendorRev=vendorRev, lan3=lan3, unicastsReceived=unicastsReceived, jumblan1=jumblan1, staticIpGateway=staticIpGateway, lanportspeed=lanportspeed, portStatistic=portStatistic, bias=bias, qosEntry=qosEntry, jumbwan=jumbwan, xg6846=xg6846, staticIpSecondaryDns=staticIpSecondaryDns, qosIndex=qosIndex, qmode=qmode, secondaryDns=secondaryDns, portmode=portmode, fcsErrorTransmitted=fcsErrorTransmitted, groupEntry=groupEntry, portName=portName, staticIpAddr=staticIpAddr, qosTable=qosTable, qmapping=qmapping, rxPower=rxPower, primaryDns=primaryDns, jumblan3=jumblan3, domainame=domainame, txPower=txPower)
