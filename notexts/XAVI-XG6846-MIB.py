...
# Produced by pysmi-1.1.8 at Fri Jan 13 12:08:28 2023
...
Bits, iso, NotificationType, Integer32, MibIdentifier, Counter64, Gauge32, ModuleIdentity, Counter32, mib_2, Unsigned32, snmpModules, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "NotificationType", "Integer32", "MibIdentifier", "Counter64", "Gauge32", "ModuleIdentity", "Counter32", "mib-2", "Unsigned32", "snmpModules", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", reboot=reboot, priority=priority, jumblan2=jumblan2, modeEntry=modeEntry, lanportName=lanportName, port2=port2, staticIpSubMask=staticIpSubMask, txPower=txPower, serialnum=serialnum, lanportspeed=lanportspeed, bias=bias, lanportpause=lanportpause, portmode=portmode, temperature=temperature, lan3=lan3, unicastsTransmitted=unicastsTransmitted, rxPower=rxPower, fcsErrorReceived=fcsErrorReceived, lan1=lan1, pauseReceived=pauseReceived, portIndex=portIndex, staticIpPrimaryDns=staticIpPrimaryDns, secondaryDns=secondaryDns, jumblan4=jumblan4, vendorOui=vendorOui, tftpSevIp=tftpSevIp, broadcastsReceived=broadcastsReceived, qmode=qmode, rebootEnable=rebootEnable, vendorName=vendorName, fileName=fileName, lanportTable=lanportTable, port4=port4, unicastsReceived=unicastsReceived, xg6846=xg6846, portPower=portPower, ddminfo=ddminfo, port3=port3, lanportIndex=lanportIndex, adminStatus=adminStatus, groupid=groupid, vendorRev=vendorRev, pauseTransmitted=pauseTransmitted, staticIpHostName=staticIpHostName, staticDns=staticDns, port1=port1, speed=speed, jumb=jumb, qosIndex=qosIndex, fcsErrorTransmitted=fcsErrorTransmitted, catv=catv, internetPort=internetPort, groupIndex=groupIndex, groupEntry=groupEntry, tftp=tftp, qosTable=qosTable, statisticTable=statisticTable, vlangroupTable=vlangroupTable, primaryDns=primaryDns, deviceinfo=deviceinfo, statIndex=statIndex, action=action, lan4=lan4, wan=wan, operStatus=operStatus, portStatistic=portStatistic, jumbwan=jumbwan, portStatEntry=portStatEntry, staticIpSecondaryDns=staticIpSecondaryDns, staticIpDomainName=staticIpDomainName, multicastsReceived=multicastsReceived, staticIpAddr=staticIpAddr, qosEntry=qosEntry, vendorPn=vendorPn, hostname=hostname, voltage=voltage, portTable=portTable, jumblan1=jumblan1, dscpEnable=dscpEnable, lan2=lan2, vlanid=vlanid, fileType=fileType, wanType=wanType, catvEnable=catvEnable, broadcastsTransmitted=broadcastsTransmitted, portName=portName, qmapping=qmapping, jumblan3=jumblan3, portEntry=portEntry, qos=qos, domainame=domainame, staticIpGateway=staticIpGateway, multicastsTransmitted=multicastsTransmitted, vlan=vlan)
