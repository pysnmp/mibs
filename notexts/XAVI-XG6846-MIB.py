...
# Produced by pysmi-1.1.8 at Wed Jun 29 13:37:04 2022
...
ObjectIdentity, Gauge32, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Integer32, Counter64, NotificationType, iso, enterprises, IpAddress, Counter32, MibIdentifier, ModuleIdentity, mib_2, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Integer32", "Counter64", "NotificationType", "iso", "enterprises", "IpAddress", "Counter32", "MibIdentifier", "ModuleIdentity", "mib-2", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portStatEntry=portStatEntry, bias=bias, internetPort=internetPort, staticIpPrimaryDns=staticIpPrimaryDns, portName=portName, statisticTable=statisticTable, reboot=reboot, primaryDns=primaryDns, groupid=groupid, broadcastsReceived=broadcastsReceived, port2=port2, fcsErrorReceived=fcsErrorReceived, jumblan4=jumblan4, secondaryDns=secondaryDns, portStatistic=portStatistic, staticIpSecondaryDns=staticIpSecondaryDns, vendorOui=vendorOui, lan4=lan4, jumblan2=jumblan2, lan2=lan2, lanportName=lanportName, speed=speed, broadcastsTransmitted=broadcastsTransmitted, qosIndex=qosIndex, port1=port1, staticIpHostName=staticIpHostName, vendorPn=vendorPn, portEntry=portEntry, port4=port4, unicastsReceived=unicastsReceived, catv=catv, staticIpGateway=staticIpGateway, jumbwan=jumbwan, tftpSevIp=tftpSevIp, lanportspeed=lanportspeed, adminStatus=adminStatus, staticIpSubMask=staticIpSubMask, pauseTransmitted=pauseTransmitted, qosTable=qosTable, vlangroupTable=vlangroupTable, fcsErrorTransmitted=fcsErrorTransmitted, tftp=tftp, qosEntry=qosEntry, groupEntry=groupEntry, fileType=fileType, serialnum=serialnum, txPower=txPower, portPower=portPower, lan1=lan1, dscpEnable=dscpEnable, wanType=wanType, hostname=hostname, rebootEnable=rebootEnable, jumblan3=jumblan3, modeEntry=modeEntry, rxPower=rxPower, portmode=portmode, pauseReceived=pauseReceived, voltage=voltage, staticDns=staticDns, operStatus=operStatus, multicastsReceived=multicastsReceived, portIndex=portIndex, staticIpAddr=staticIpAddr, lanportIndex=lanportIndex, xg6846=xg6846, unicastsTransmitted=unicastsTransmitted, qos=qos, portTable=portTable, priority=priority, vlanid=vlanid, qmode=qmode, jumblan1=jumblan1, domainame=domainame, multicastsTransmitted=multicastsTransmitted, deviceinfo=deviceinfo, vendorName=vendorName, vlan=vlan, lan3=lan3, fileName=fileName, temperature=temperature, wan=wan, lanportpause=lanportpause, qmapping=qmapping, staticIpDomainName=staticIpDomainName, catvEnable=catvEnable, vendorRev=vendorRev, groupIndex=groupIndex, ddminfo=ddminfo, action=action, port3=port3, jumb=jumb, statIndex=statIndex, lanportTable=lanportTable)
