...
IpAddress, snmpModules, ModuleIdentity, Counter32, Integer32, iso, Counter64, NotificationType, Gauge32, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, TimeTicks, mib_2, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "snmpModules", "ModuleIdentity", "Counter32", "Integer32", "iso", "Counter64", "NotificationType", "Gauge32", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "TimeTicks", "mib-2", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", serialnum=serialnum, groupEntry=groupEntry, tftp=tftp, vlan=vlan, secondaryDns=secondaryDns, vendorPn=vendorPn, rebootEnable=rebootEnable, lan2=lan2, portStatistic=portStatistic, lanportIndex=lanportIndex, portStatEntry=portStatEntry, staticIpAddr=staticIpAddr, primaryDns=primaryDns, staticIpDomainName=staticIpDomainName, qosEntry=qosEntry, unicastsTransmitted=unicastsTransmitted, jumblan2=jumblan2, pauseTransmitted=pauseTransmitted, qos=qos, catv=catv, tftpSevIp=tftpSevIp, vendorOui=vendorOui, temperature=temperature, catvEnable=catvEnable, modeEntry=modeEntry, vlanid=vlanid, groupIndex=groupIndex, rxPower=rxPower, broadcastsReceived=broadcastsReceived, fileName=fileName, jumb=jumb, lanportTable=lanportTable, jumbwan=jumbwan, staticIpGateway=staticIpGateway, portPower=portPower, fcsErrorTransmitted=fcsErrorTransmitted, portIndex=portIndex, adminStatus=adminStatus, xg6846=xg6846, port4=port4, multicastsTransmitted=multicastsTransmitted, operStatus=operStatus, port3=port3, port2=port2, portEntry=portEntry, reboot=reboot, jumblan4=jumblan4, staticIpSubMask=staticIpSubMask, deviceinfo=deviceinfo, jumblan1=jumblan1, staticIpPrimaryDns=staticIpPrimaryDns, fcsErrorReceived=fcsErrorReceived, domainame=domainame, lan1=lan1, bias=bias, ddminfo=ddminfo, internetPort=internetPort, statIndex=statIndex, statisticTable=statisticTable, wanType=wanType, txPower=txPower, qmode=qmode, vendorRev=vendorRev, portTable=portTable, multicastsReceived=multicastsReceived, lanportspeed=lanportspeed, qosTable=qosTable, dscpEnable=dscpEnable, port1=port1, lan3=lan3, vlangroupTable=vlangroupTable, portName=portName, unicastsReceived=unicastsReceived, speed=speed, lanportpause=lanportpause, staticIpHostName=staticIpHostName, lan4=lan4, hostname=hostname, qmapping=qmapping, pauseReceived=pauseReceived, staticIpSecondaryDns=staticIpSecondaryDns, wan=wan, jumblan3=jumblan3, staticDns=staticDns, lanportName=lanportName, action=action, priority=priority, broadcastsTransmitted=broadcastsTransmitted, vendorName=vendorName, portmode=portmode, groupid=groupid, voltage=voltage, fileType=fileType, qosIndex=qosIndex)
