...
# Produced by pysmi-1.1.8 at Tue Aug  9 15:17:43 2022
...
snmpModules, Counter64, ModuleIdentity, mib_2, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity, Gauge32, Bits, TimeTicks, Counter32, enterprises, IpAddress, MibIdentifier, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "Counter64", "ModuleIdentity", "mib-2", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity", "Gauge32", "Bits", "TimeTicks", "Counter32", "enterprises", "IpAddress", "MibIdentifier", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", wan=wan, qmode=qmode, fcsErrorTransmitted=fcsErrorTransmitted, qmapping=qmapping, portEntry=portEntry, secondaryDns=secondaryDns, primaryDns=primaryDns, staticIpGateway=staticIpGateway, port3=port3, jumb=jumb, wanType=wanType, statIndex=statIndex, staticIpAddr=staticIpAddr, lanportIndex=lanportIndex, multicastsTransmitted=multicastsTransmitted, lan2=lan2, port2=port2, vlanid=vlanid, jumblan4=jumblan4, temperature=temperature, portPower=portPower, unicastsTransmitted=unicastsTransmitted, jumblan1=jumblan1, groupid=groupid, portStatistic=portStatistic, staticIpSubMask=staticIpSubMask, port4=port4, internetPort=internetPort, qosEntry=qosEntry, rxPower=rxPower, vendorRev=vendorRev, portmode=portmode, pauseReceived=pauseReceived, staticDns=staticDns, unicastsReceived=unicastsReceived, catvEnable=catvEnable, lanportTable=lanportTable, qos=qos, fileType=fileType, portName=portName, hostname=hostname, tftp=tftp, fcsErrorReceived=fcsErrorReceived, jumblan2=jumblan2, xg6846=xg6846, vlangroupTable=vlangroupTable, priority=priority, speed=speed, groupIndex=groupIndex, lan3=lan3, qosTable=qosTable, modeEntry=modeEntry, broadcastsTransmitted=broadcastsTransmitted, fileName=fileName, voltage=voltage, staticIpPrimaryDns=staticIpPrimaryDns, qosIndex=qosIndex, vlan=vlan, pauseTransmitted=pauseTransmitted, port1=port1, dscpEnable=dscpEnable, vendorName=vendorName, lanportName=lanportName, lan4=lan4, multicastsReceived=multicastsReceived, catv=catv, rebootEnable=rebootEnable, ddminfo=ddminfo, staticIpHostName=staticIpHostName, lanportspeed=lanportspeed, txPower=txPower, domainame=domainame, reboot=reboot, operStatus=operStatus, portStatEntry=portStatEntry, portTable=portTable, portIndex=portIndex, jumbwan=jumbwan, tftpSevIp=tftpSevIp, lanportpause=lanportpause, action=action, deviceinfo=deviceinfo, vendorOui=vendorOui, lan1=lan1, bias=bias, staticIpDomainName=staticIpDomainName, serialnum=serialnum, vendorPn=vendorPn, adminStatus=adminStatus, jumblan3=jumblan3, broadcastsReceived=broadcastsReceived, statisticTable=statisticTable, groupEntry=groupEntry, staticIpSecondaryDns=staticIpSecondaryDns)
