...
# Produced by pysmi-1.1.8 at Sat Jan 15 05:29:11 2022
...
NotificationType, Counter32, iso, Bits, mib_2, TimeTicks, Gauge32, ObjectIdentity, Integer32, ModuleIdentity, snmpModules, Unsigned32, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "iso", "Bits", "mib-2", "TimeTicks", "Gauge32", "ObjectIdentity", "Integer32", "ModuleIdentity", "snmpModules", "Unsigned32", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", speed=speed, statisticTable=statisticTable, portName=portName, vlan=vlan, jumblan2=jumblan2, vlangroupTable=vlangroupTable, voltage=voltage, operStatus=operStatus, lan1=lan1, temperature=temperature, action=action, qosTable=qosTable, lan2=lan2, wanType=wanType, lanportpause=lanportpause, vendorOui=vendorOui, internetPort=internetPort, catvEnable=catvEnable, portIndex=portIndex, qmapping=qmapping, portEntry=portEntry, groupIndex=groupIndex, unicastsTransmitted=unicastsTransmitted, jumb=jumb, vendorRev=vendorRev, modeEntry=modeEntry, priority=priority, hostname=hostname, deviceinfo=deviceinfo, wan=wan, txPower=txPower, jumblan1=jumblan1, adminStatus=adminStatus, serialnum=serialnum, rxPower=rxPower, lan3=lan3, jumbwan=jumbwan, broadcastsReceived=broadcastsReceived, qmode=qmode, lanportName=lanportName, fcsErrorTransmitted=fcsErrorTransmitted, pauseTransmitted=pauseTransmitted, multicastsReceived=multicastsReceived, fcsErrorReceived=fcsErrorReceived, port4=port4, vendorPn=vendorPn, qosIndex=qosIndex, tftpSevIp=tftpSevIp, portTable=portTable, lanportIndex=lanportIndex, staticDns=staticDns, portPower=portPower, qosEntry=qosEntry, catv=catv, multicastsTransmitted=multicastsTransmitted, dscpEnable=dscpEnable, domainame=domainame, fileType=fileType, jumblan3=jumblan3, rebootEnable=rebootEnable, groupEntry=groupEntry, port1=port1, pauseReceived=pauseReceived, unicastsReceived=unicastsReceived, staticIpSubMask=staticIpSubMask, port3=port3, lanportspeed=lanportspeed, portStatistic=portStatistic, jumblan4=jumblan4, qos=qos, staticIpSecondaryDns=staticIpSecondaryDns, xg6846=xg6846, lanportTable=lanportTable, portmode=portmode, staticIpAddr=staticIpAddr, port2=port2, staticIpPrimaryDns=staticIpPrimaryDns, staticIpDomainName=staticIpDomainName, tftp=tftp, vlanid=vlanid, secondaryDns=secondaryDns, vendorName=vendorName, statIndex=statIndex, ddminfo=ddminfo, fileName=fileName, bias=bias, lan4=lan4, primaryDns=primaryDns, groupid=groupid, staticIpGateway=staticIpGateway, portStatEntry=portStatEntry, reboot=reboot, staticIpHostName=staticIpHostName, broadcastsTransmitted=broadcastsTransmitted)
