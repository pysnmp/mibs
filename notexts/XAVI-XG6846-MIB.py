...
ObjectIdentity, IpAddress, NotificationType, mib_2, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, snmpModules, MibIdentifier, enterprises, TimeTicks, Gauge32, Counter32, Unsigned32, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "NotificationType", "mib-2", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "snmpModules", "MibIdentifier", "enterprises", "TimeTicks", "Gauge32", "Counter32", "Unsigned32", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", tftpSevIp=tftpSevIp, jumblan2=jumblan2, pauseTransmitted=pauseTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, fcsErrorTransmitted=fcsErrorTransmitted, catvEnable=catvEnable, statisticTable=statisticTable, internetPort=internetPort, action=action, jumblan3=jumblan3, adminStatus=adminStatus, fileName=fileName, secondaryDns=secondaryDns, primaryDns=primaryDns, multicastsTransmitted=multicastsTransmitted, qmapping=qmapping, portStatEntry=portStatEntry, vendorPn=vendorPn, lan2=lan2, txPower=txPower, bias=bias, lan3=lan3, portmode=portmode, unicastsReceived=unicastsReceived, staticIpDomainName=staticIpDomainName, lan4=lan4, pauseReceived=pauseReceived, portIndex=portIndex, staticIpSubMask=staticIpSubMask, staticDns=staticDns, qosEntry=qosEntry, jumblan4=jumblan4, port2=port2, wan=wan, port1=port1, wanType=wanType, port3=port3, statIndex=statIndex, portEntry=portEntry, qmode=qmode, jumb=jumb, lanportspeed=lanportspeed, multicastsReceived=multicastsReceived, groupid=groupid, broadcastsTransmitted=broadcastsTransmitted, portStatistic=portStatistic, lanportIndex=lanportIndex, qosIndex=qosIndex, vendorRev=vendorRev, staticIpHostName=staticIpHostName, xg6846=xg6846, rebootEnable=rebootEnable, rxPower=rxPower, port4=port4, reboot=reboot, vlanid=vlanid, vendorOui=vendorOui, staticIpPrimaryDns=staticIpPrimaryDns, serialnum=serialnum, operStatus=operStatus, qosTable=qosTable, broadcastsReceived=broadcastsReceived, lanportName=lanportName, jumbwan=jumbwan, staticIpGateway=staticIpGateway, tftp=tftp, catv=catv, modeEntry=modeEntry, domainame=domainame, ddminfo=ddminfo, dscpEnable=dscpEnable, fcsErrorReceived=fcsErrorReceived, unicastsTransmitted=unicastsTransmitted, deviceinfo=deviceinfo, portPower=portPower, portName=portName, priority=priority, lanportpause=lanportpause, jumblan1=jumblan1, temperature=temperature, hostname=hostname, groupIndex=groupIndex, fileType=fileType, vendorName=vendorName, groupEntry=groupEntry, speed=speed, vlan=vlan, qos=qos, vlangroupTable=vlangroupTable, voltage=voltage, staticIpAddr=staticIpAddr, lan1=lan1, portTable=portTable, lanportTable=lanportTable)
