...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, NotificationType, ModuleIdentity, TimeTicks, Integer32, Bits, Counter64, iso, Unsigned32, mib_2, Counter32, Gauge32, snmpModules, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "NotificationType", "ModuleIdentity", "TimeTicks", "Integer32", "Bits", "Counter64", "iso", "Unsigned32", "mib-2", "Counter32", "Gauge32", "snmpModules", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupEntry=groupEntry, statIndex=statIndex, groupIndex=groupIndex, jumblan1=jumblan1, unicastsTransmitted=unicastsTransmitted, lanportTable=lanportTable, jumbwan=jumbwan, deviceinfo=deviceinfo, staticIpSecondaryDns=staticIpSecondaryDns, reboot=reboot, portPower=portPower, port1=port1, staticIpPrimaryDns=staticIpPrimaryDns, lan2=lan2, adminStatus=adminStatus, lanportspeed=lanportspeed, lanportIndex=lanportIndex, vendorName=vendorName, qosEntry=qosEntry, multicastsTransmitted=multicastsTransmitted, lan1=lan1, tftpSevIp=tftpSevIp, lanportpause=lanportpause, txPower=txPower, staticIpAddr=staticIpAddr, qosIndex=qosIndex, bias=bias, speed=speed, jumblan4=jumblan4, vendorRev=vendorRev, serialnum=serialnum, vendorPn=vendorPn, catv=catv, rxPower=rxPower, primaryDns=primaryDns, internetPort=internetPort, operStatus=operStatus, fcsErrorTransmitted=fcsErrorTransmitted, broadcastsReceived=broadcastsReceived, tftp=tftp, port3=port3, vlangroupTable=vlangroupTable, qmode=qmode, portIndex=portIndex, vendorOui=vendorOui, port2=port2, portStatEntry=portStatEntry, statisticTable=statisticTable, portTable=portTable, port4=port4, lan3=lan3, staticIpHostName=staticIpHostName, unicastsReceived=unicastsReceived, pauseTransmitted=pauseTransmitted, catvEnable=catvEnable, voltage=voltage, staticIpDomainName=staticIpDomainName, multicastsReceived=multicastsReceived, secondaryDns=secondaryDns, pauseReceived=pauseReceived, jumblan2=jumblan2, priority=priority, qos=qos, vlan=vlan, ddminfo=ddminfo, portmode=portmode, xg6846=xg6846, portName=portName, rebootEnable=rebootEnable, vlanid=vlanid, broadcastsTransmitted=broadcastsTransmitted, hostname=hostname, staticDns=staticDns, modeEntry=modeEntry, fileType=fileType, lanportName=lanportName, wanType=wanType, dscpEnable=dscpEnable, qmapping=qmapping, staticIpGateway=staticIpGateway, domainame=domainame, staticIpSubMask=staticIpSubMask, fileName=fileName, temperature=temperature, portEntry=portEntry, qosTable=qosTable, jumblan3=jumblan3, fcsErrorReceived=fcsErrorReceived, lan4=lan4, groupid=groupid, wan=wan, jumb=jumb, action=action, portStatistic=portStatistic)
