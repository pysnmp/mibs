...
# Produced by pysmi-1.1.12 at Wed May 29 10:57:08 2024
...
Integer32, Counter32, iso, ModuleIdentity, mib_2, TimeTicks, enterprises, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, Gauge32, ObjectIdentity, NotificationType, MibIdentifier, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "iso", "ModuleIdentity", "mib-2", "TimeTicks", "enterprises", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "Gauge32", "ObjectIdentity", "NotificationType", "MibIdentifier", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", priority=priority, deviceinfo=deviceinfo, rxPower=rxPower, jumblan4=jumblan4, fcsErrorReceived=fcsErrorReceived, jumblan1=jumblan1, broadcastsReceived=broadcastsReceived, lan2=lan2, staticIpDomainName=staticIpDomainName, lan3=lan3, wanType=wanType, primaryDns=primaryDns, staticIpPrimaryDns=staticIpPrimaryDns, port3=port3, staticIpAddr=staticIpAddr, portStatEntry=portStatEntry, jumblan3=jumblan3, portEntry=portEntry, unicastsReceived=unicastsReceived, groupIndex=groupIndex, qos=qos, catv=catv, portIndex=portIndex, vendorPn=vendorPn, catvEnable=catvEnable, lanportTable=lanportTable, vlan=vlan, pauseTransmitted=pauseTransmitted, lanportIndex=lanportIndex, fcsErrorTransmitted=fcsErrorTransmitted, jumblan2=jumblan2, broadcastsTransmitted=broadcastsTransmitted, staticIpGateway=staticIpGateway, adminStatus=adminStatus, voltage=voltage, rebootEnable=rebootEnable, portTable=portTable, jumbwan=jumbwan, hostname=hostname, vendorName=vendorName, pauseReceived=pauseReceived, qosEntry=qosEntry, statisticTable=statisticTable, statIndex=statIndex, tftpSevIp=tftpSevIp, bias=bias, domainame=domainame, portPower=portPower, lanportpause=lanportpause, dscpEnable=dscpEnable, fileName=fileName, temperature=temperature, vendorRev=vendorRev, internetPort=internetPort, qmode=qmode, portmode=portmode, staticDns=staticDns, port1=port1, reboot=reboot, txPower=txPower, staticIpHostName=staticIpHostName, modeEntry=modeEntry, ddminfo=ddminfo, lan4=lan4, portStatistic=portStatistic, lan1=lan1, xg6846=xg6846, multicastsReceived=multicastsReceived, tftp=tftp, qosTable=qosTable, groupid=groupid, qmapping=qmapping, unicastsTransmitted=unicastsTransmitted, lanportName=lanportName, port2=port2, multicastsTransmitted=multicastsTransmitted, jumb=jumb, serialnum=serialnum, wan=wan, fileType=fileType, vlanid=vlanid, qosIndex=qosIndex, portName=portName, vlangroupTable=vlangroupTable, lanportspeed=lanportspeed, port4=port4, secondaryDns=secondaryDns, vendorOui=vendorOui, operStatus=operStatus, action=action, speed=speed, groupEntry=groupEntry, staticIpSubMask=staticIpSubMask, staticIpSecondaryDns=staticIpSecondaryDns)
