...
TimeTicks, Bits, ObjectIdentity, mib_2, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, enterprises, Unsigned32, Gauge32, MibIdentifier, IpAddress, snmpModules, iso, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "ObjectIdentity", "mib-2", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "enterprises", "Unsigned32", "Gauge32", "MibIdentifier", "IpAddress", "snmpModules", "iso", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan3=lan3, action=action, staticIpGateway=staticIpGateway, staticIpAddr=staticIpAddr, staticIpSecondaryDns=staticIpSecondaryDns, qmode=qmode, groupEntry=groupEntry, ddminfo=ddminfo, lan4=lan4, portName=portName, vendorName=vendorName, jumblan4=jumblan4, port2=port2, wanType=wanType, dscpEnable=dscpEnable, bias=bias, staticIpSubMask=staticIpSubMask, jumbwan=jumbwan, staticIpDomainName=staticIpDomainName, fcsErrorReceived=fcsErrorReceived, temperature=temperature, primaryDns=primaryDns, portTable=portTable, xg6846=xg6846, priority=priority, jumblan3=jumblan3, vlangroupTable=vlangroupTable, pauseTransmitted=pauseTransmitted, portStatEntry=portStatEntry, qmapping=qmapping, portmode=portmode, lan1=lan1, qosEntry=qosEntry, portEntry=portEntry, qosTable=qosTable, fcsErrorTransmitted=fcsErrorTransmitted, portIndex=portIndex, vendorPn=vendorPn, tftp=tftp, statisticTable=statisticTable, reboot=reboot, lanportspeed=lanportspeed, qos=qos, groupid=groupid, staticDns=staticDns, rebootEnable=rebootEnable, unicastsReceived=unicastsReceived, portPower=portPower, domainame=domainame, vlan=vlan, wan=wan, pauseReceived=pauseReceived, jumb=jumb, hostname=hostname, modeEntry=modeEntry, voltage=voltage, fileName=fileName, catvEnable=catvEnable, secondaryDns=secondaryDns, rxPower=rxPower, adminStatus=adminStatus, vendorOui=vendorOui, deviceinfo=deviceinfo, speed=speed, port4=port4, unicastsTransmitted=unicastsTransmitted, broadcastsReceived=broadcastsReceived, serialnum=serialnum, txPower=txPower, lanportName=lanportName, staticIpHostName=staticIpHostName, fileType=fileType, lan2=lan2, tftpSevIp=tftpSevIp, internetPort=internetPort, lanportIndex=lanportIndex, qosIndex=qosIndex, catv=catv, multicastsTransmitted=multicastsTransmitted, lanportTable=lanportTable, vlanid=vlanid, port3=port3, statIndex=statIndex, lanportpause=lanportpause, vendorRev=vendorRev, portStatistic=portStatistic, staticIpPrimaryDns=staticIpPrimaryDns, operStatus=operStatus, groupIndex=groupIndex, multicastsReceived=multicastsReceived, port1=port1, broadcastsTransmitted=broadcastsTransmitted, jumblan1=jumblan1, jumblan2=jumblan2)
