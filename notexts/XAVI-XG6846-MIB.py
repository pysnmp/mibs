...
# Produced by pysmi-1.1.8 at Tue Sep 12 07:01:44 2023
...
IpAddress, Gauge32, mib_2, Bits, Counter32, Integer32, Counter64, ModuleIdentity, enterprises, Unsigned32, iso, NotificationType, MibIdentifier, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "mib-2", "Bits", "Counter32", "Integer32", "Counter64", "ModuleIdentity", "enterprises", "Unsigned32", "iso", "NotificationType", "MibIdentifier", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumb=jumb, statIndex=statIndex, catv=catv, lanportspeed=lanportspeed, txPower=txPower, staticIpSubMask=staticIpSubMask, dscpEnable=dscpEnable, qos=qos, tftp=tftp, primaryDns=primaryDns, staticDns=staticDns, jumbwan=jumbwan, portName=portName, lanportTable=lanportTable, lan2=lan2, lan3=lan3, portmode=portmode, secondaryDns=secondaryDns, adminStatus=adminStatus, portIndex=portIndex, lan1=lan1, wan=wan, jumblan3=jumblan3, broadcastsReceived=broadcastsReceived, qosEntry=qosEntry, vlangroupTable=vlangroupTable, wanType=wanType, rxPower=rxPower, statisticTable=statisticTable, jumblan2=jumblan2, hostname=hostname, domainame=domainame, staticIpPrimaryDns=staticIpPrimaryDns, serialnum=serialnum, lanportpause=lanportpause, vendorRev=vendorRev, vlanid=vlanid, portStatistic=portStatistic, ddminfo=ddminfo, operStatus=operStatus, multicastsReceived=multicastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, temperature=temperature, vendorPn=vendorPn, tftpSevIp=tftpSevIp, internetPort=internetPort, jumblan4=jumblan4, modeEntry=modeEntry, staticIpDomainName=staticIpDomainName, fileType=fileType, lan4=lan4, bias=bias, priority=priority, broadcastsTransmitted=broadcastsTransmitted, vendorName=vendorName, lanportName=lanportName, qosIndex=qosIndex, pauseReceived=pauseReceived, groupEntry=groupEntry, qosTable=qosTable, port1=port1, voltage=voltage, unicastsTransmitted=unicastsTransmitted, rebootEnable=rebootEnable, unicastsReceived=unicastsReceived, pauseTransmitted=pauseTransmitted, fcsErrorReceived=fcsErrorReceived, portTable=portTable, fileName=fileName, portPower=portPower, catvEnable=catvEnable, action=action, vendorOui=vendorOui, lanportIndex=lanportIndex, multicastsTransmitted=multicastsTransmitted, jumblan1=jumblan1, qmapping=qmapping, reboot=reboot, groupIndex=groupIndex, speed=speed, groupid=groupid, port2=port2, staticIpGateway=staticIpGateway, portStatEntry=portStatEntry, portEntry=portEntry, deviceinfo=deviceinfo, staticIpAddr=staticIpAddr, xg6846=xg6846, fcsErrorTransmitted=fcsErrorTransmitted, port3=port3, vlan=vlan, qmode=qmode, staticIpHostName=staticIpHostName, port4=port4)
