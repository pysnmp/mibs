...
ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Bits, IpAddress, ObjectIdentity, Integer32, Unsigned32, MibIdentifier, TimeTicks, Counter64, mib_2, Counter32, iso, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Bits", "IpAddress", "ObjectIdentity", "Integer32", "Unsigned32", "MibIdentifier", "TimeTicks", "Counter64", "mib-2", "Counter32", "iso", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", broadcastsTransmitted=broadcastsTransmitted, pauseTransmitted=pauseTransmitted, txPower=txPower, lanportpause=lanportpause, staticIpDomainName=staticIpDomainName, serialnum=serialnum, multicastsReceived=multicastsReceived, multicastsTransmitted=multicastsTransmitted, statisticTable=statisticTable, rebootEnable=rebootEnable, vendorPn=vendorPn, reboot=reboot, pauseReceived=pauseReceived, jumblan2=jumblan2, jumblan3=jumblan3, fcsErrorReceived=fcsErrorReceived, action=action, wan=wan, qosTable=qosTable, bias=bias, xg6846=xg6846, port1=port1, groupEntry=groupEntry, vendorRev=vendorRev, internetPort=internetPort, staticIpSubMask=staticIpSubMask, portIndex=portIndex, qosEntry=qosEntry, staticIpHostName=staticIpHostName, qmapping=qmapping, portEntry=portEntry, domainame=domainame, modeEntry=modeEntry, fileType=fileType, portStatistic=portStatistic, lanportName=lanportName, qmode=qmode, lan1=lan1, jumbwan=jumbwan, dscpEnable=dscpEnable, vendorOui=vendorOui, tftp=tftp, temperature=temperature, portPower=portPower, broadcastsReceived=broadcastsReceived, catv=catv, port4=port4, rxPower=rxPower, port2=port2, lanportTable=lanportTable, hostname=hostname, adminStatus=adminStatus, statIndex=statIndex, operStatus=operStatus, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSecondaryDns=staticIpSecondaryDns, lan4=lan4, speed=speed, portmode=portmode, portTable=portTable, wanType=wanType, deviceinfo=deviceinfo, voltage=voltage, secondaryDns=secondaryDns, lan3=lan3, fcsErrorTransmitted=fcsErrorTransmitted, tftpSevIp=tftpSevIp, groupIndex=groupIndex, fileName=fileName, priority=priority, vlanid=vlanid, qos=qos, groupid=groupid, unicastsReceived=unicastsReceived, staticDns=staticDns, qosIndex=qosIndex, ddminfo=ddminfo, vendorName=vendorName, vlan=vlan, staticIpAddr=staticIpAddr, vlangroupTable=vlangroupTable, staticIpGateway=staticIpGateway, port3=port3, unicastsTransmitted=unicastsTransmitted, primaryDns=primaryDns, jumblan4=jumblan4, lan2=lan2, lanportspeed=lanportspeed, lanportIndex=lanportIndex, jumb=jumb, catvEnable=catvEnable, portName=portName, jumblan1=jumblan1, portStatEntry=portStatEntry)
