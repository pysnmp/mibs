...
# Produced by pysmi-1.1.12 at Tue Jun  4 08:08:22 2024
...
snmpModules, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, enterprises, Counter32, Gauge32, Integer32, Counter64, NotificationType, mib_2, Unsigned32, iso, MibIdentifier, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "enterprises", "Counter32", "Gauge32", "Integer32", "Counter64", "NotificationType", "mib-2", "Unsigned32", "iso", "MibIdentifier", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", xg6846=xg6846, portStatEntry=portStatEntry, internetPort=internetPort, lanportName=lanportName, unicastsReceived=unicastsReceived, deviceinfo=deviceinfo, hostname=hostname, lanportspeed=lanportspeed, multicastsTransmitted=multicastsTransmitted, fileName=fileName, portStatistic=portStatistic, staticIpDomainName=staticIpDomainName, statisticTable=statisticTable, serialnum=serialnum, staticIpHostName=staticIpHostName, staticIpSecondaryDns=staticIpSecondaryDns, operStatus=operStatus, jumblan3=jumblan3, lan1=lan1, portEntry=portEntry, port1=port1, lanportTable=lanportTable, vlangroupTable=vlangroupTable, portIndex=portIndex, vendorOui=vendorOui, qosTable=qosTable, port4=port4, broadcastsTransmitted=broadcastsTransmitted, jumblan4=jumblan4, temperature=temperature, lan3=lan3, lan2=lan2, fcsErrorReceived=fcsErrorReceived, bias=bias, rxPower=rxPower, modeEntry=modeEntry, broadcastsReceived=broadcastsReceived, pauseReceived=pauseReceived, qosIndex=qosIndex, qmode=qmode, catv=catv, catvEnable=catvEnable, port3=port3, wanType=wanType, ddminfo=ddminfo, domainame=domainame, qos=qos, tftpSevIp=tftpSevIp, groupid=groupid, portmode=portmode, fcsErrorTransmitted=fcsErrorTransmitted, rebootEnable=rebootEnable, jumbwan=jumbwan, priority=priority, staticDns=staticDns, groupIndex=groupIndex, unicastsTransmitted=unicastsTransmitted, dscpEnable=dscpEnable, qmapping=qmapping, lan4=lan4, voltage=voltage, action=action, lanportpause=lanportpause, lanportIndex=lanportIndex, tftp=tftp, adminStatus=adminStatus, vendorPn=vendorPn, port2=port2, qosEntry=qosEntry, speed=speed, secondaryDns=secondaryDns, jumblan1=jumblan1, wan=wan, staticIpPrimaryDns=staticIpPrimaryDns, primaryDns=primaryDns, portPower=portPower, jumblan2=jumblan2, vendorRev=vendorRev, reboot=reboot, staticIpGateway=staticIpGateway, vendorName=vendorName, fileType=fileType, vlan=vlan, portName=portName, pauseTransmitted=pauseTransmitted, groupEntry=groupEntry, txPower=txPower, staticIpSubMask=staticIpSubMask, portTable=portTable, staticIpAddr=staticIpAddr, jumb=jumb, vlanid=vlanid, statIndex=statIndex, multicastsReceived=multicastsReceived)
