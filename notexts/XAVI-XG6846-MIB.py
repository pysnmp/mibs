...
Counter64, MibIdentifier, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, snmpModules, enterprises, IpAddress, Bits, Gauge32, ObjectIdentity, Unsigned32, iso, mib_2, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "snmpModules", "enterprises", "IpAddress", "Bits", "Gauge32", "ObjectIdentity", "Unsigned32", "iso", "mib-2", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumblan2=jumblan2, groupid=groupid, statisticTable=statisticTable, qosIndex=qosIndex, hostname=hostname, jumblan3=jumblan3, fcsErrorTransmitted=fcsErrorTransmitted, staticIpDomainName=staticIpDomainName, lanportName=lanportName, lan4=lan4, portName=portName, secondaryDns=secondaryDns, groupEntry=groupEntry, lanportIndex=lanportIndex, jumblan1=jumblan1, ddminfo=ddminfo, qosEntry=qosEntry, jumb=jumb, staticIpAddr=staticIpAddr, vlangroupTable=vlangroupTable, reboot=reboot, statIndex=statIndex, domainame=domainame, broadcastsTransmitted=broadcastsTransmitted, multicastsReceived=multicastsReceived, portmode=portmode, unicastsReceived=unicastsReceived, vendorRev=vendorRev, serialnum=serialnum, staticIpPrimaryDns=staticIpPrimaryDns, portEntry=portEntry, portIndex=portIndex, staticIpSecondaryDns=staticIpSecondaryDns, port4=port4, portTable=portTable, dscpEnable=dscpEnable, xg6846=xg6846, pauseReceived=pauseReceived, port1=port1, modeEntry=modeEntry, lan1=lan1, deviceinfo=deviceinfo, wan=wan, temperature=temperature, bias=bias, vlanid=vlanid, fileType=fileType, tftp=tftp, staticDns=staticDns, primaryDns=primaryDns, groupIndex=groupIndex, unicastsTransmitted=unicastsTransmitted, pauseTransmitted=pauseTransmitted, port3=port3, rebootEnable=rebootEnable, fileName=fileName, priority=priority, operStatus=operStatus, portPower=portPower, multicastsTransmitted=multicastsTransmitted, qmode=qmode, jumbwan=jumbwan, lan2=lan2, speed=speed, tftpSevIp=tftpSevIp, staticIpGateway=staticIpGateway, qos=qos, vendorOui=vendorOui, wanType=wanType, txPower=txPower, adminStatus=adminStatus, vlan=vlan, vendorPn=vendorPn, qosTable=qosTable, vendorName=vendorName, lanportspeed=lanportspeed, broadcastsReceived=broadcastsReceived, portStatistic=portStatistic, fcsErrorReceived=fcsErrorReceived, lanportpause=lanportpause, catv=catv, rxPower=rxPower, staticIpHostName=staticIpHostName, portStatEntry=portStatEntry, port2=port2, catvEnable=catvEnable, voltage=voltage, action=action, qmapping=qmapping, lan3=lan3, lanportTable=lanportTable, staticIpSubMask=staticIpSubMask, internetPort=internetPort, jumblan4=jumblan4)
