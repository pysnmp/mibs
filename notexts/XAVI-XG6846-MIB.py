...
# Produced by pysmi-1.1.11 at Wed Apr  3 15:17:10 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, mib_2, ObjectIdentity, Gauge32, NotificationType, enterprises, ModuleIdentity, IpAddress, iso, Bits, Integer32, snmpModules, Unsigned32, Counter32, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "mib-2", "ObjectIdentity", "Gauge32", "NotificationType", "enterprises", "ModuleIdentity", "IpAddress", "iso", "Bits", "Integer32", "snmpModules", "Unsigned32", "Counter32", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportIndex=lanportIndex, fcsErrorTransmitted=fcsErrorTransmitted, pauseTransmitted=pauseTransmitted, staticIpGateway=staticIpGateway, port2=port2, action=action, groupid=groupid, portIndex=portIndex, tftpSevIp=tftpSevIp, multicastsTransmitted=multicastsTransmitted, lan2=lan2, deviceinfo=deviceinfo, portStatEntry=portStatEntry, unicastsReceived=unicastsReceived, vlan=vlan, broadcastsReceived=broadcastsReceived, jumblan3=jumblan3, qmapping=qmapping, lan1=lan1, statisticTable=statisticTable, lan4=lan4, operStatus=operStatus, portEntry=portEntry, secondaryDns=secondaryDns, unicastsTransmitted=unicastsTransmitted, lanportspeed=lanportspeed, portmode=portmode, fileType=fileType, portPower=portPower, bias=bias, catvEnable=catvEnable, rebootEnable=rebootEnable, vendorRev=vendorRev, jumbwan=jumbwan, groupEntry=groupEntry, xg6846=xg6846, domainame=domainame, vendorName=vendorName, hostname=hostname, staticIpDomainName=staticIpDomainName, tftp=tftp, primaryDns=primaryDns, jumblan4=jumblan4, wan=wan, staticIpSecondaryDns=staticIpSecondaryDns, qosEntry=qosEntry, statIndex=statIndex, lanportpause=lanportpause, portStatistic=portStatistic, speed=speed, jumblan2=jumblan2, port1=port1, staticIpPrimaryDns=staticIpPrimaryDns, qosIndex=qosIndex, broadcastsTransmitted=broadcastsTransmitted, lanportTable=lanportTable, internetPort=internetPort, pauseReceived=pauseReceived, dscpEnable=dscpEnable, voltage=voltage, vlangroupTable=vlangroupTable, staticDns=staticDns, portTable=portTable, vendorOui=vendorOui, staticIpAddr=staticIpAddr, ddminfo=ddminfo, rxPower=rxPower, lanportName=lanportName, qos=qos, vlanid=vlanid, fcsErrorReceived=fcsErrorReceived, serialnum=serialnum, staticIpSubMask=staticIpSubMask, port3=port3, fileName=fileName, adminStatus=adminStatus, jumb=jumb, modeEntry=modeEntry, qmode=qmode, catv=catv, groupIndex=groupIndex, temperature=temperature, multicastsReceived=multicastsReceived, vendorPn=vendorPn, reboot=reboot, txPower=txPower, lan3=lan3, priority=priority, portName=portName, port4=port4, qosTable=qosTable, wanType=wanType, jumblan1=jumblan1, staticIpHostName=staticIpHostName)
