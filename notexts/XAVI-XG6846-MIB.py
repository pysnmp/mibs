...
MibIdentifier, IpAddress, Bits, Counter32, snmpModules, enterprises, iso, Integer32, Counter64, ObjectIdentity, ModuleIdentity, Gauge32, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "Bits", "Counter32", "snmpModules", "enterprises", "iso", "Integer32", "Counter64", "ObjectIdentity", "ModuleIdentity", "Gauge32", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qosIndex=qosIndex, lanportIndex=lanportIndex, jumbwan=jumbwan, domainame=domainame, port4=port4, ddminfo=ddminfo, qmapping=qmapping, jumblan4=jumblan4, secondaryDns=secondaryDns, staticIpAddr=staticIpAddr, jumblan2=jumblan2, modeEntry=modeEntry, tftpSevIp=tftpSevIp, groupid=groupid, statIndex=statIndex, multicastsTransmitted=multicastsTransmitted, portEntry=portEntry, deviceinfo=deviceinfo, portPower=portPower, portStatistic=portStatistic, jumb=jumb, action=action, xg6846=xg6846, serialnum=serialnum, primaryDns=primaryDns, portmode=portmode, qos=qos, staticIpHostName=staticIpHostName, pauseTransmitted=pauseTransmitted, rebootEnable=rebootEnable, broadcastsTransmitted=broadcastsTransmitted, groupEntry=groupEntry, speed=speed, voltage=voltage, port3=port3, reboot=reboot, adminStatus=adminStatus, pauseReceived=pauseReceived, portStatEntry=portStatEntry, fileType=fileType, bias=bias, staticIpGateway=staticIpGateway, vendorName=vendorName, jumblan1=jumblan1, hostname=hostname, txPower=txPower, tftp=tftp, vendorPn=vendorPn, vendorRev=vendorRev, jumblan3=jumblan3, multicastsReceived=multicastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, vlangroupTable=vlangroupTable, lanportpause=lanportpause, vendorOui=vendorOui, temperature=temperature, groupIndex=groupIndex, portIndex=portIndex, fileName=fileName, qmode=qmode, qosTable=qosTable, lan3=lan3, lan4=lan4, fcsErrorReceived=fcsErrorReceived, lan1=lan1, staticIpSecondaryDns=staticIpSecondaryDns, priority=priority, portTable=portTable, port2=port2, statisticTable=statisticTable, lanportspeed=lanportspeed, vlanid=vlanid, staticIpSubMask=staticIpSubMask, internetPort=internetPort, wan=wan, lanportName=lanportName, port1=port1, staticDns=staticDns, broadcastsReceived=broadcastsReceived, staticIpDomainName=staticIpDomainName, qosEntry=qosEntry, lan2=lan2, rxPower=rxPower, wanType=wanType, unicastsTransmitted=unicastsTransmitted, unicastsReceived=unicastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, dscpEnable=dscpEnable, operStatus=operStatus, catv=catv, lanportTable=lanportTable, catvEnable=catvEnable, portName=portName, vlan=vlan)
