...
# Produced by pysmi-1.1.8 at Fri Jan 13 13:59:53 2023
...
ModuleIdentity, Unsigned32, iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, mib_2, Integer32, enterprises, Bits, Gauge32, snmpModules, ObjectIdentity, MibIdentifier, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "mib-2", "Integer32", "enterprises", "Bits", "Gauge32", "snmpModules", "ObjectIdentity", "MibIdentifier", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", ddminfo=ddminfo, jumblan1=jumblan1, groupIndex=groupIndex, port4=port4, qosTable=qosTable, statisticTable=statisticTable, catvEnable=catvEnable, vlangroupTable=vlangroupTable, tftp=tftp, priority=priority, vendorPn=vendorPn, voltage=voltage, hostname=hostname, lanportspeed=lanportspeed, vendorRev=vendorRev, multicastsTransmitted=multicastsTransmitted, jumblan2=jumblan2, portPower=portPower, rxPower=rxPower, portStatEntry=portStatEntry, lan2=lan2, staticIpGateway=staticIpGateway, portTable=portTable, temperature=temperature, reboot=reboot, fcsErrorTransmitted=fcsErrorTransmitted, bias=bias, port2=port2, lanportName=lanportName, catv=catv, pauseTransmitted=pauseTransmitted, broadcastsReceived=broadcastsReceived, txPower=txPower, jumbwan=jumbwan, lanportIndex=lanportIndex, pauseReceived=pauseReceived, vendorName=vendorName, multicastsReceived=multicastsReceived, port1=port1, action=action, xg6846=xg6846, domainame=domainame, fileName=fileName, qmapping=qmapping, staticIpSecondaryDns=staticIpSecondaryDns, lan4=lan4, port3=port3, adminStatus=adminStatus, internetPort=internetPort, vlan=vlan, primaryDns=primaryDns, portEntry=portEntry, portStatistic=portStatistic, wanType=wanType, lan3=lan3, portmode=portmode, wan=wan, qos=qos, statIndex=statIndex, unicastsReceived=unicastsReceived, staticIpHostName=staticIpHostName, dscpEnable=dscpEnable, lanportpause=lanportpause, fileType=fileType, portIndex=portIndex, staticDns=staticDns, jumblan3=jumblan3, groupid=groupid, rebootEnable=rebootEnable, speed=speed, fcsErrorReceived=fcsErrorReceived, portName=portName, jumb=jumb, qmode=qmode, broadcastsTransmitted=broadcastsTransmitted, groupEntry=groupEntry, vendorOui=vendorOui, unicastsTransmitted=unicastsTransmitted, lanportTable=lanportTable, staticIpDomainName=staticIpDomainName, modeEntry=modeEntry, operStatus=operStatus, qosEntry=qosEntry, qosIndex=qosIndex, lan1=lan1, serialnum=serialnum, vlanid=vlanid, secondaryDns=secondaryDns, jumblan4=jumblan4, staticIpSubMask=staticIpSubMask, deviceinfo=deviceinfo, staticIpAddr=staticIpAddr, tftpSevIp=tftpSevIp, staticIpPrimaryDns=staticIpPrimaryDns)
