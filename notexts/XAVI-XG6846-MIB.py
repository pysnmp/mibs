...
# Produced by pysmi-1.1.3 at Sun Nov 28 21:17:26 2021
...
ModuleIdentity, Unsigned32, enterprises, ObjectIdentity, MibIdentifier, snmpModules, Counter64, IpAddress, Counter32, iso, Integer32, mib_2, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "enterprises", "ObjectIdentity", "MibIdentifier", "snmpModules", "Counter64", "IpAddress", "Counter32", "iso", "Integer32", "mib-2", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan3=lan3, statisticTable=statisticTable, vendorOui=vendorOui, lan1=lan1, adminStatus=adminStatus, staticIpAddr=staticIpAddr, temperature=temperature, jumblan2=jumblan2, lanportTable=lanportTable, rxPower=rxPower, staticIpHostName=staticIpHostName, qosIndex=qosIndex, xg6846=xg6846, unicastsReceived=unicastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, port3=port3, jumb=jumb, groupEntry=groupEntry, groupid=groupid, multicastsReceived=multicastsReceived, lanportName=lanportName, staticIpSubMask=staticIpSubMask, port2=port2, multicastsTransmitted=multicastsTransmitted, catvEnable=catvEnable, wan=wan, speed=speed, bias=bias, hostname=hostname, portPower=portPower, vlangroupTable=vlangroupTable, pauseTransmitted=pauseTransmitted, pauseReceived=pauseReceived, deviceinfo=deviceinfo, dscpEnable=dscpEnable, lan2=lan2, portStatistic=portStatistic, staticIpSecondaryDns=staticIpSecondaryDns, staticIpDomainName=staticIpDomainName, lanportIndex=lanportIndex, vlan=vlan, qosEntry=qosEntry, portStatEntry=portStatEntry, qmapping=qmapping, fileName=fileName, portmode=portmode, qosTable=qosTable, broadcastsReceived=broadcastsReceived, portName=portName, jumbwan=jumbwan, qmode=qmode, vendorPn=vendorPn, groupIndex=groupIndex, port4=port4, staticIpPrimaryDns=staticIpPrimaryDns, lanportpause=lanportpause, primaryDns=primaryDns, operStatus=operStatus, portTable=portTable, portEntry=portEntry, serialnum=serialnum, tftpSevIp=tftpSevIp, secondaryDns=secondaryDns, priority=priority, lanportspeed=lanportspeed, txPower=txPower, tftp=tftp, qos=qos, domainame=domainame, staticIpGateway=staticIpGateway, port1=port1, broadcastsTransmitted=broadcastsTransmitted, action=action, wanType=wanType, vlanid=vlanid, ddminfo=ddminfo, vendorRev=vendorRev, voltage=voltage, lan4=lan4, statIndex=statIndex, catv=catv, jumblan4=jumblan4, vendorName=vendorName, rebootEnable=rebootEnable, unicastsTransmitted=unicastsTransmitted, portIndex=portIndex, jumblan3=jumblan3, modeEntry=modeEntry, reboot=reboot, fileType=fileType, jumblan1=jumblan1, internetPort=internetPort, fcsErrorReceived=fcsErrorReceived, staticDns=staticDns)
