...
# Produced by pysmi-1.1.8 at Mon Jan 17 19:48:46 2022
...
Integer32, Gauge32, iso, NotificationType, snmpModules, Unsigned32, ModuleIdentity, Counter32, mib_2, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, Bits, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "iso", "NotificationType", "snmpModules", "Unsigned32", "ModuleIdentity", "Counter32", "mib-2", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "Bits", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qosIndex=qosIndex, jumbwan=jumbwan, port2=port2, lan2=lan2, staticIpPrimaryDns=staticIpPrimaryDns, modeEntry=modeEntry, groupid=groupid, xg6846=xg6846, tftpSevIp=tftpSevIp, multicastsReceived=multicastsReceived, secondaryDns=secondaryDns, staticIpHostName=staticIpHostName, reboot=reboot, lan3=lan3, broadcastsTransmitted=broadcastsTransmitted, adminStatus=adminStatus, deviceinfo=deviceinfo, port4=port4, vendorRev=vendorRev, rebootEnable=rebootEnable, fcsErrorReceived=fcsErrorReceived, wanType=wanType, qosTable=qosTable, lanportName=lanportName, rxPower=rxPower, pauseTransmitted=pauseTransmitted, qosEntry=qosEntry, qos=qos, fileType=fileType, portEntry=portEntry, port1=port1, lanportIndex=lanportIndex, groupEntry=groupEntry, groupIndex=groupIndex, primaryDns=primaryDns, lan1=lan1, voltage=voltage, multicastsTransmitted=multicastsTransmitted, serialnum=serialnum, vendorPn=vendorPn, vlangroupTable=vlangroupTable, priority=priority, catvEnable=catvEnable, portTable=portTable, portPower=portPower, fileName=fileName, fcsErrorTransmitted=fcsErrorTransmitted, qmapping=qmapping, port3=port3, action=action, qmode=qmode, speed=speed, statisticTable=statisticTable, vendorName=vendorName, hostname=hostname, staticIpDomainName=staticIpDomainName, statIndex=statIndex, lanportpause=lanportpause, txPower=txPower, jumblan3=jumblan3, vendorOui=vendorOui, vlan=vlan, jumblan1=jumblan1, staticIpAddr=staticIpAddr, broadcastsReceived=broadcastsReceived, staticIpSubMask=staticIpSubMask, portStatistic=portStatistic, dscpEnable=dscpEnable, jumblan4=jumblan4, temperature=temperature, vlanid=vlanid, domainame=domainame, internetPort=internetPort, bias=bias, tftp=tftp, portStatEntry=portStatEntry, operStatus=operStatus, portName=portName, staticIpGateway=staticIpGateway, catv=catv, lanportTable=lanportTable, portmode=portmode, wan=wan, lan4=lan4, staticIpSecondaryDns=staticIpSecondaryDns, unicastsReceived=unicastsReceived, jumb=jumb, jumblan2=jumblan2, unicastsTransmitted=unicastsTransmitted, ddminfo=ddminfo, portIndex=portIndex, staticDns=staticDns, lanportspeed=lanportspeed, pauseReceived=pauseReceived)
