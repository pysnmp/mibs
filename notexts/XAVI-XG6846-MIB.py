...
# Produced by pysmi-1.1.8 at Thu Jan  5 11:32:48 2023
...
enterprises, Counter32, Integer32, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, NotificationType, Gauge32, ObjectIdentity, Unsigned32, MibIdentifier, TimeTicks, snmpModules, IpAddress, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "Integer32", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "NotificationType", "Gauge32", "ObjectIdentity", "Unsigned32", "MibIdentifier", "TimeTicks", "snmpModules", "IpAddress", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qmapping=qmapping, lan3=lan3, qmode=qmode, port2=port2, statisticTable=statisticTable, adminStatus=adminStatus, portmode=portmode, lanportspeed=lanportspeed, voltage=voltage, statIndex=statIndex, pauseReceived=pauseReceived, groupIndex=groupIndex, portName=portName, vlan=vlan, qosEntry=qosEntry, lan2=lan2, operStatus=operStatus, jumblan1=jumblan1, fcsErrorTransmitted=fcsErrorTransmitted, reboot=reboot, groupid=groupid, rxPower=rxPower, lan1=lan1, staticIpSubMask=staticIpSubMask, fcsErrorReceived=fcsErrorReceived, lanportpause=lanportpause, internetPort=internetPort, speed=speed, xg6846=xg6846, fileName=fileName, tftpSevIp=tftpSevIp, serialnum=serialnum, qosIndex=qosIndex, portTable=portTable, hostname=hostname, lanportName=lanportName, vlanid=vlanid, vendorPn=vendorPn, vlangroupTable=vlangroupTable, tftp=tftp, wan=wan, jumblan2=jumblan2, staticIpAddr=staticIpAddr, jumbwan=jumbwan, dscpEnable=dscpEnable, portStatistic=portStatistic, groupEntry=groupEntry, priority=priority, staticIpGateway=staticIpGateway, domainame=domainame, rebootEnable=rebootEnable, portPower=portPower, catvEnable=catvEnable, broadcastsTransmitted=broadcastsTransmitted, wanType=wanType, primaryDns=primaryDns, unicastsReceived=unicastsReceived, portStatEntry=portStatEntry, multicastsTransmitted=multicastsTransmitted, action=action, multicastsReceived=multicastsReceived, ddminfo=ddminfo, pauseTransmitted=pauseTransmitted, port3=port3, secondaryDns=secondaryDns, txPower=txPower, port4=port4, vendorRev=vendorRev, fileType=fileType, jumblan3=jumblan3, broadcastsReceived=broadcastsReceived, port1=port1, lanportIndex=lanportIndex, staticIpSecondaryDns=staticIpSecondaryDns, qosTable=qosTable, portIndex=portIndex, jumb=jumb, modeEntry=modeEntry, staticIpDomainName=staticIpDomainName, vendorOui=vendorOui, bias=bias, staticIpHostName=staticIpHostName, qos=qos, portEntry=portEntry, lan4=lan4, catv=catv, staticIpPrimaryDns=staticIpPrimaryDns, deviceinfo=deviceinfo, jumblan4=jumblan4, lanportTable=lanportTable, temperature=temperature, unicastsTransmitted=unicastsTransmitted, vendorName=vendorName, staticDns=staticDns)
