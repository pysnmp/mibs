...
# Produced by pysmi-1.1.3 at Tue Dec  7 13:47:30 2021
...
IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, MibIdentifier, Gauge32, Counter32, ObjectIdentity, enterprises, Unsigned32, TimeTicks, NotificationType, snmpModules, ModuleIdentity, Bits, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "MibIdentifier", "Gauge32", "Counter32", "ObjectIdentity", "enterprises", "Unsigned32", "TimeTicks", "NotificationType", "snmpModules", "ModuleIdentity", "Bits", "Integer32", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port1=port1, staticDns=staticDns, tftp=tftp, speed=speed, txPower=txPower, lanportpause=lanportpause, vendorName=vendorName, staticIpGateway=staticIpGateway, ddminfo=ddminfo, staticIpAddr=staticIpAddr, serialnum=serialnum, fcsErrorReceived=fcsErrorReceived, jumb=jumb, port3=port3, dscpEnable=dscpEnable, unicastsTransmitted=unicastsTransmitted, portEntry=portEntry, broadcastsReceived=broadcastsReceived, jumblan3=jumblan3, portIndex=portIndex, groupIndex=groupIndex, statIndex=statIndex, bias=bias, tftpSevIp=tftpSevIp, staticIpPrimaryDns=staticIpPrimaryDns, jumblan1=jumblan1, deviceinfo=deviceinfo, lanportName=lanportName, portTable=portTable, pauseTransmitted=pauseTransmitted, catvEnable=catvEnable, vendorOui=vendorOui, internetPort=internetPort, qosEntry=qosEntry, portStatEntry=portStatEntry, portPower=portPower, qmapping=qmapping, vendorRev=vendorRev, domainame=domainame, port4=port4, lan1=lan1, staticIpSubMask=staticIpSubMask, broadcastsTransmitted=broadcastsTransmitted, qosIndex=qosIndex, catv=catv, jumbwan=jumbwan, staticIpDomainName=staticIpDomainName, operStatus=operStatus, qmode=qmode, staticIpSecondaryDns=staticIpSecondaryDns, adminStatus=adminStatus, jumblan2=jumblan2, lanportTable=lanportTable, priority=priority, jumblan4=jumblan4, multicastsTransmitted=multicastsTransmitted, groupid=groupid, wan=wan, primaryDns=primaryDns, pauseReceived=pauseReceived, rebootEnable=rebootEnable, vendorPn=vendorPn, modeEntry=modeEntry, fileType=fileType, wanType=wanType, groupEntry=groupEntry, vlanid=vlanid, xg6846=xg6846, rxPower=rxPower, lan3=lan3, reboot=reboot, multicastsReceived=multicastsReceived, hostname=hostname, lan4=lan4, voltage=voltage, port2=port2, unicastsReceived=unicastsReceived, qos=qos, statisticTable=statisticTable, qosTable=qosTable, temperature=temperature, fileName=fileName, portmode=portmode, lanportIndex=lanportIndex, secondaryDns=secondaryDns, portName=portName, lanportspeed=lanportspeed, portStatistic=portStatistic, staticIpHostName=staticIpHostName, vlangroupTable=vlangroupTable, vlan=vlan, action=action, fcsErrorTransmitted=fcsErrorTransmitted, lan2=lan2)
