...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:09:00 2023
...
TimeTicks, IpAddress, Counter64, Integer32, Gauge32, iso, MibIdentifier, Bits, NotificationType, mib_2, Counter32, snmpModules, Unsigned32, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Counter64", "Integer32", "Gauge32", "iso", "MibIdentifier", "Bits", "NotificationType", "mib-2", "Counter32", "snmpModules", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", statIndex=statIndex, speed=speed, hostname=hostname, adminStatus=adminStatus, lanportName=lanportName, priority=priority, jumb=jumb, lanportTable=lanportTable, qmode=qmode, staticIpDomainName=staticIpDomainName, portIndex=portIndex, serialnum=serialnum, lan3=lan3, groupIndex=groupIndex, unicastsTransmitted=unicastsTransmitted, portPower=portPower, staticIpSubMask=staticIpSubMask, jumbwan=jumbwan, staticIpGateway=staticIpGateway, qosTable=qosTable, wan=wan, vendorPn=vendorPn, portStatistic=portStatistic, multicastsTransmitted=multicastsTransmitted, secondaryDns=secondaryDns, rebootEnable=rebootEnable, lanportIndex=lanportIndex, modeEntry=modeEntry, pauseTransmitted=pauseTransmitted, staticIpHostName=staticIpHostName, staticIpSecondaryDns=staticIpSecondaryDns, tftpSevIp=tftpSevIp, operStatus=operStatus, primaryDns=primaryDns, groupid=groupid, jumblan1=jumblan1, qosEntry=qosEntry, dscpEnable=dscpEnable, voltage=voltage, pauseReceived=pauseReceived, bias=bias, broadcastsReceived=broadcastsReceived, portmode=portmode, lanportspeed=lanportspeed, vendorOui=vendorOui, ddminfo=ddminfo, multicastsReceived=multicastsReceived, broadcastsTransmitted=broadcastsTransmitted, wanType=wanType, port4=port4, qos=qos, domainame=domainame, unicastsReceived=unicastsReceived, catvEnable=catvEnable, portName=portName, jumblan3=jumblan3, portStatEntry=portStatEntry, internetPort=internetPort, deviceinfo=deviceinfo, jumblan4=jumblan4, lan4=lan4, portTable=portTable, port3=port3, lan2=lan2, staticIpAddr=staticIpAddr, lanportpause=lanportpause, fcsErrorTransmitted=fcsErrorTransmitted, action=action, vlanid=vlanid, temperature=temperature, port1=port1, fcsErrorReceived=fcsErrorReceived, tftp=tftp, fileType=fileType, staticIpPrimaryDns=staticIpPrimaryDns, catv=catv, vlangroupTable=vlangroupTable, lan1=lan1, groupEntry=groupEntry, vendorName=vendorName, vlan=vlan, fileName=fileName, reboot=reboot, portEntry=portEntry, statisticTable=statisticTable, rxPower=rxPower, txPower=txPower, staticDns=staticDns, jumblan2=jumblan2, vendorRev=vendorRev, qosIndex=qosIndex, qmapping=qmapping, port2=port2, xg6846=xg6846)
