...
# Produced by pysmi-1.1.8 at Sun Jan 16 00:39:49 2022
...
Counter64, Unsigned32, ObjectIdentity, Integer32, Bits, enterprises, IpAddress, NotificationType, Counter32, ModuleIdentity, snmpModules, mib_2, Gauge32, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "ObjectIdentity", "Integer32", "Bits", "enterprises", "IpAddress", "NotificationType", "Counter32", "ModuleIdentity", "snmpModules", "mib-2", "Gauge32", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qosEntry=qosEntry, qos=qos, fileName=fileName, port4=port4, jumblan2=jumblan2, portStatEntry=portStatEntry, lanportspeed=lanportspeed, qmapping=qmapping, rxPower=rxPower, domainame=domainame, vendorRev=vendorRev, adminStatus=adminStatus, priority=priority, tftp=tftp, dscpEnable=dscpEnable, portIndex=portIndex, unicastsReceived=unicastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, vlanid=vlanid, lan4=lan4, lan2=lan2, bias=bias, broadcastsReceived=broadcastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, jumblan4=jumblan4, jumblan1=jumblan1, vendorOui=vendorOui, portTable=portTable, staticIpGateway=staticIpGateway, unicastsTransmitted=unicastsTransmitted, ddminfo=ddminfo, operStatus=operStatus, broadcastsTransmitted=broadcastsTransmitted, lanportName=lanportName, lan3=lan3, lanportIndex=lanportIndex, xg6846=xg6846, statisticTable=statisticTable, fileType=fileType, hostname=hostname, vendorPn=vendorPn, action=action, vlangroupTable=vlangroupTable, secondaryDns=secondaryDns, wan=wan, groupIndex=groupIndex, portName=portName, port2=port2, qosIndex=qosIndex, tftpSevIp=tftpSevIp, staticIpSubMask=staticIpSubMask, rebootEnable=rebootEnable, lan1=lan1, jumblan3=jumblan3, portPower=portPower, speed=speed, qmode=qmode, multicastsTransmitted=multicastsTransmitted, catv=catv, staticIpPrimaryDns=staticIpPrimaryDns, primaryDns=primaryDns, staticIpDomainName=staticIpDomainName, jumbwan=jumbwan, temperature=temperature, groupEntry=groupEntry, portStatistic=portStatistic, portmode=portmode, internetPort=internetPort, staticIpHostName=staticIpHostName, pauseTransmitted=pauseTransmitted, wanType=wanType, port1=port1, reboot=reboot, deviceinfo=deviceinfo, groupid=groupid, qosTable=qosTable, voltage=voltage, vlan=vlan, vendorName=vendorName, txPower=txPower, staticDns=staticDns, modeEntry=modeEntry, fcsErrorReceived=fcsErrorReceived, jumb=jumb, port3=port3, lanportpause=lanportpause, portEntry=portEntry, lanportTable=lanportTable, pauseReceived=pauseReceived, staticIpAddr=staticIpAddr, catvEnable=catvEnable, statIndex=statIndex, serialnum=serialnum, multicastsReceived=multicastsReceived)
