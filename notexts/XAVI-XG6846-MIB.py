...
iso, Gauge32, enterprises, NotificationType, mib_2, Integer32, Counter32, ModuleIdentity, Unsigned32, MibIdentifier, TimeTicks, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "enterprises", "NotificationType", "mib-2", "Integer32", "Counter32", "ModuleIdentity", "Unsigned32", "MibIdentifier", "TimeTicks", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qosIndex=qosIndex, internetPort=internetPort, vendorName=vendorName, modeEntry=modeEntry, bias=bias, portPower=portPower, speed=speed, portName=portName, vlan=vlan, wan=wan, secondaryDns=secondaryDns, staticIpPrimaryDns=staticIpPrimaryDns, tftpSevIp=tftpSevIp, voltage=voltage, domainame=domainame, qosEntry=qosEntry, portEntry=portEntry, groupIndex=groupIndex, pauseTransmitted=pauseTransmitted, deviceinfo=deviceinfo, txPower=txPower, rebootEnable=rebootEnable, multicastsReceived=multicastsReceived, pauseReceived=pauseReceived, rxPower=rxPower, fcsErrorTransmitted=fcsErrorTransmitted, wanType=wanType, staticIpSecondaryDns=staticIpSecondaryDns, temperature=temperature, primaryDns=primaryDns, portStatistic=portStatistic, dscpEnable=dscpEnable, lan4=lan4, fcsErrorReceived=fcsErrorReceived, statisticTable=statisticTable, operStatus=operStatus, portmode=portmode, unicastsReceived=unicastsReceived, port1=port1, ddminfo=ddminfo, serialnum=serialnum, hostname=hostname, jumblan1=jumblan1, vendorRev=vendorRev, port3=port3, qosTable=qosTable, port2=port2, qmapping=qmapping, tftp=tftp, action=action, vendorOui=vendorOui, lanportName=lanportName, lan1=lan1, priority=priority, statIndex=statIndex, staticIpGateway=staticIpGateway, broadcastsReceived=broadcastsReceived, broadcastsTransmitted=broadcastsTransmitted, lanportspeed=lanportspeed, jumblan3=jumblan3, unicastsTransmitted=unicastsTransmitted, lan2=lan2, jumbwan=jumbwan, qmode=qmode, catvEnable=catvEnable, jumblan2=jumblan2, fileName=fileName, portIndex=portIndex, lanportTable=lanportTable, portStatEntry=portStatEntry, portTable=portTable, lan3=lan3, qos=qos, jumb=jumb, vlangroupTable=vlangroupTable, catv=catv, lanportIndex=lanportIndex, reboot=reboot, multicastsTransmitted=multicastsTransmitted, fileType=fileType, adminStatus=adminStatus, xg6846=xg6846, lanportpause=lanportpause, staticIpDomainName=staticIpDomainName, staticIpHostName=staticIpHostName, groupid=groupid, staticDns=staticDns, groupEntry=groupEntry, staticIpSubMask=staticIpSubMask, port4=port4, vlanid=vlanid, staticIpAddr=staticIpAddr, jumblan4=jumblan4, vendorPn=vendorPn)
