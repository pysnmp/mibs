...
TimeTicks, MibIdentifier, Integer32, IpAddress, ModuleIdentity, Counter32, Bits, Counter64, mib_2, snmpModules, enterprises, NotificationType, Unsigned32, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "Integer32", "IpAddress", "ModuleIdentity", "Counter32", "Bits", "Counter64", "mib-2", "snmpModules", "enterprises", "NotificationType", "Unsigned32", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fileName=fileName, tftpSevIp=tftpSevIp, staticIpGateway=staticIpGateway, jumb=jumb, txPower=txPower, jumblan2=jumblan2, staticIpPrimaryDns=staticIpPrimaryDns, lan2=lan2, hostname=hostname, port4=port4, rxPower=rxPower, portStatistic=portStatistic, portPower=portPower, staticIpSubMask=staticIpSubMask, port2=port2, modeEntry=modeEntry, reboot=reboot, lan3=lan3, qosEntry=qosEntry, jumblan3=jumblan3, multicastsReceived=multicastsReceived, port1=port1, speed=speed, primaryDns=primaryDns, staticIpHostName=staticIpHostName, rebootEnable=rebootEnable, portIndex=portIndex, qosIndex=qosIndex, catv=catv, lan1=lan1, priority=priority, secondaryDns=secondaryDns, statIndex=statIndex, broadcastsReceived=broadcastsReceived, domainame=domainame, wan=wan, groupIndex=groupIndex, staticIpSecondaryDns=staticIpSecondaryDns, adminStatus=adminStatus, vendorOui=vendorOui, serialnum=serialnum, qmode=qmode, internetPort=internetPort, jumbwan=jumbwan, vlanid=vlanid, qos=qos, vendorPn=vendorPn, lanportIndex=lanportIndex, action=action, vendorRev=vendorRev, tftp=tftp, portTable=portTable, portName=portName, qmapping=qmapping, fcsErrorTransmitted=fcsErrorTransmitted, unicastsTransmitted=unicastsTransmitted, staticIpDomainName=staticIpDomainName, staticIpAddr=staticIpAddr, port3=port3, pauseReceived=pauseReceived, catvEnable=catvEnable, groupEntry=groupEntry, portStatEntry=portStatEntry, voltage=voltage, portmode=portmode, broadcastsTransmitted=broadcastsTransmitted, vlan=vlan, multicastsTransmitted=multicastsTransmitted, fcsErrorReceived=fcsErrorReceived, ddminfo=ddminfo, portEntry=portEntry, xg6846=xg6846, temperature=temperature, staticDns=staticDns, dscpEnable=dscpEnable, unicastsReceived=unicastsReceived, groupid=groupid, wanType=wanType, fileType=fileType, bias=bias, lan4=lan4, lanportName=lanportName, lanportpause=lanportpause, deviceinfo=deviceinfo, pauseTransmitted=pauseTransmitted, qosTable=qosTable, vendorName=vendorName, jumblan1=jumblan1, vlangroupTable=vlangroupTable, lanportTable=lanportTable, statisticTable=statisticTable, jumblan4=jumblan4, lanportspeed=lanportspeed, operStatus=operStatus)
