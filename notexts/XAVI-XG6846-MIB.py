...
ObjectIdentity, NotificationType, Integer32, Counter32, TimeTicks, mib_2, Counter64, Gauge32, Bits, iso, ModuleIdentity, Unsigned32, IpAddress, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Integer32", "Counter32", "TimeTicks", "mib-2", "Counter64", "Gauge32", "Bits", "iso", "ModuleIdentity", "Unsigned32", "IpAddress", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catvEnable=catvEnable, xg6846=xg6846, vendorName=vendorName, port3=port3, port2=port2, fileType=fileType, jumb=jumb, reboot=reboot, broadcastsReceived=broadcastsReceived, adminStatus=adminStatus, statisticTable=statisticTable, portStatEntry=portStatEntry, fcsErrorReceived=fcsErrorReceived, txPower=txPower, portStatistic=portStatistic, speed=speed, statIndex=statIndex, pauseTransmitted=pauseTransmitted, tftp=tftp, rebootEnable=rebootEnable, serialnum=serialnum, vlan=vlan, lanportName=lanportName, staticIpGateway=staticIpGateway, jumblan1=jumblan1, lanportspeed=lanportspeed, groupid=groupid, staticIpSubMask=staticIpSubMask, wanType=wanType, jumblan3=jumblan3, catv=catv, hostname=hostname, port4=port4, fcsErrorTransmitted=fcsErrorTransmitted, ddminfo=ddminfo, lan1=lan1, jumblan2=jumblan2, portEntry=portEntry, fileName=fileName, portIndex=portIndex, portPower=portPower, vendorPn=vendorPn, qos=qos, primaryDns=primaryDns, qosIndex=qosIndex, staticIpPrimaryDns=staticIpPrimaryDns, secondaryDns=secondaryDns, groupIndex=groupIndex, staticIpAddr=staticIpAddr, priority=priority, tftpSevIp=tftpSevIp, voltage=voltage, unicastsTransmitted=unicastsTransmitted, vendorOui=vendorOui, internetPort=internetPort, staticIpHostName=staticIpHostName, qmode=qmode, jumbwan=jumbwan, qmapping=qmapping, unicastsReceived=unicastsReceived, wan=wan, port1=port1, portTable=portTable, portmode=portmode, action=action, modeEntry=modeEntry, rxPower=rxPower, temperature=temperature, lan3=lan3, lanportIndex=lanportIndex, groupEntry=groupEntry, lan2=lan2, multicastsReceived=multicastsReceived, multicastsTransmitted=multicastsTransmitted, staticIpDomainName=staticIpDomainName, lan4=lan4, deviceinfo=deviceinfo, domainame=domainame, staticIpSecondaryDns=staticIpSecondaryDns, vlanid=vlanid, jumblan4=jumblan4, qosTable=qosTable, portName=portName, broadcastsTransmitted=broadcastsTransmitted, lanportTable=lanportTable, qosEntry=qosEntry, pauseReceived=pauseReceived, vlangroupTable=vlangroupTable, dscpEnable=dscpEnable, bias=bias, operStatus=operStatus, vendorRev=vendorRev, lanportpause=lanportpause, staticDns=staticDns)
