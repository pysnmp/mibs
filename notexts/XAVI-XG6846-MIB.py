...
IpAddress, Counter64, TimeTicks, Unsigned32, Integer32, iso, enterprises, ObjectIdentity, NotificationType, MibIdentifier, Bits, Gauge32, ModuleIdentity, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "TimeTicks", "Unsigned32", "Integer32", "iso", "enterprises", "ObjectIdentity", "NotificationType", "MibIdentifier", "Bits", "Gauge32", "ModuleIdentity", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportTable=lanportTable, staticIpDomainName=staticIpDomainName, statIndex=statIndex, staticIpSecondaryDns=staticIpSecondaryDns, staticIpPrimaryDns=staticIpPrimaryDns, rxPower=rxPower, port3=port3, jumblan2=jumblan2, fileType=fileType, vendorPn=vendorPn, lanportpause=lanportpause, pauseReceived=pauseReceived, ddminfo=ddminfo, lan3=lan3, vlangroupTable=vlangroupTable, catv=catv, qmode=qmode, multicastsTransmitted=multicastsTransmitted, vendorOui=vendorOui, broadcastsReceived=broadcastsReceived, statisticTable=statisticTable, vlan=vlan, portStatistic=portStatistic, jumblan1=jumblan1, lanportName=lanportName, tftp=tftp, vendorName=vendorName, qos=qos, groupEntry=groupEntry, groupIndex=groupIndex, portName=portName, priority=priority, voltage=voltage, fcsErrorTransmitted=fcsErrorTransmitted, broadcastsTransmitted=broadcastsTransmitted, qosTable=qosTable, jumbwan=jumbwan, vlanid=vlanid, jumblan3=jumblan3, vendorRev=vendorRev, internetPort=internetPort, temperature=temperature, serialnum=serialnum, staticDns=staticDns, portStatEntry=portStatEntry, portEntry=portEntry, fileName=fileName, multicastsReceived=multicastsReceived, fcsErrorReceived=fcsErrorReceived, port2=port2, wanType=wanType, portIndex=portIndex, primaryDns=primaryDns, deviceinfo=deviceinfo, staticIpSubMask=staticIpSubMask, hostname=hostname, lan1=lan1, staticIpHostName=staticIpHostName, lanportIndex=lanportIndex, txPower=txPower, wan=wan, port1=port1, unicastsReceived=unicastsReceived, unicastsTransmitted=unicastsTransmitted, qosIndex=qosIndex, jumblan4=jumblan4, portTable=portTable, lan4=lan4, adminStatus=adminStatus, speed=speed, reboot=reboot, portmode=portmode, qmapping=qmapping, jumb=jumb, groupid=groupid, operStatus=operStatus, secondaryDns=secondaryDns, domainame=domainame, lan2=lan2, modeEntry=modeEntry, dscpEnable=dscpEnable, staticIpGateway=staticIpGateway, qosEntry=qosEntry, port4=port4, lanportspeed=lanportspeed, portPower=portPower, xg6846=xg6846, bias=bias, pauseTransmitted=pauseTransmitted, staticIpAddr=staticIpAddr, catvEnable=catvEnable, rebootEnable=rebootEnable, tftpSevIp=tftpSevIp, action=action)
