...
# Produced by pysmi-1.1.8 at Tue Feb  8 22:10:39 2022
...
Integer32, Gauge32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, ModuleIdentity, Bits, Counter32, NotificationType, ObjectIdentity, enterprises, iso, Unsigned32, TimeTicks, snmpModules, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "ModuleIdentity", "Bits", "Counter32", "NotificationType", "ObjectIdentity", "enterprises", "iso", "Unsigned32", "TimeTicks", "snmpModules", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumblan4=jumblan4, broadcastsReceived=broadcastsReceived, port4=port4, qosEntry=qosEntry, portIndex=portIndex, unicastsTransmitted=unicastsTransmitted, vendorOui=vendorOui, lan4=lan4, dscpEnable=dscpEnable, portStatistic=portStatistic, vendorPn=vendorPn, catv=catv, portmode=portmode, ddminfo=ddminfo, jumblan1=jumblan1, lan1=lan1, operStatus=operStatus, statisticTable=statisticTable, multicastsTransmitted=multicastsTransmitted, primaryDns=primaryDns, portTable=portTable, lanportTable=lanportTable, broadcastsTransmitted=broadcastsTransmitted, qmapping=qmapping, jumbwan=jumbwan, priority=priority, port1=port1, catvEnable=catvEnable, speed=speed, lanportpause=lanportpause, lanportName=lanportName, groupid=groupid, voltage=voltage, jumblan3=jumblan3, jumblan2=jumblan2, staticDns=staticDns, tftpSevIp=tftpSevIp, bias=bias, modeEntry=modeEntry, qosIndex=qosIndex, fcsErrorTransmitted=fcsErrorTransmitted, unicastsReceived=unicastsReceived, domainame=domainame, staticIpAddr=staticIpAddr, rebootEnable=rebootEnable, port3=port3, pauseTransmitted=pauseTransmitted, adminStatus=adminStatus, vlangroupTable=vlangroupTable, serialnum=serialnum, txPower=txPower, wanType=wanType, deviceinfo=deviceinfo, vlan=vlan, staticIpHostName=staticIpHostName, lanportIndex=lanportIndex, staticIpSubMask=staticIpSubMask, qos=qos, groupEntry=groupEntry, portName=portName, xg6846=xg6846, vendorRev=vendorRev, multicastsReceived=multicastsReceived, portStatEntry=portStatEntry, staticIpDomainName=staticIpDomainName, lan2=lan2, rxPower=rxPower, vlanid=vlanid, qosTable=qosTable, groupIndex=groupIndex, lan3=lan3, tftp=tftp, vendorName=vendorName, reboot=reboot, statIndex=statIndex, lanportspeed=lanportspeed, qmode=qmode, internetPort=internetPort, staticIpGateway=staticIpGateway, port2=port2, wan=wan, portPower=portPower, fcsErrorReceived=fcsErrorReceived, pauseReceived=pauseReceived, hostname=hostname, secondaryDns=secondaryDns, action=action, staticIpSecondaryDns=staticIpSecondaryDns, jumb=jumb, fileType=fileType, temperature=temperature, staticIpPrimaryDns=staticIpPrimaryDns, fileName=fileName, portEntry=portEntry)
