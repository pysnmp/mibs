...
TimeTicks, NotificationType, ModuleIdentity, Counter32, ObjectIdentity, MibIdentifier, snmpModules, mib_2, Bits, Counter64, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "ModuleIdentity", "Counter32", "ObjectIdentity", "MibIdentifier", "snmpModules", "mib-2", "Bits", "Counter64", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "iso", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", internetPort=internetPort, deviceinfo=deviceinfo, qos=qos, port2=port2, portIndex=portIndex, lanportspeed=lanportspeed, secondaryDns=secondaryDns, qmapping=qmapping, statIndex=statIndex, lanportName=lanportName, rxPower=rxPower, hostname=hostname, action=action, pauseTransmitted=pauseTransmitted, primaryDns=primaryDns, lanportIndex=lanportIndex, rebootEnable=rebootEnable, vlanid=vlanid, catvEnable=catvEnable, staticIpSecondaryDns=staticIpSecondaryDns, portName=portName, serialnum=serialnum, ddminfo=ddminfo, staticIpGateway=staticIpGateway, jumb=jumb, tftp=tftp, vlan=vlan, fcsErrorReceived=fcsErrorReceived, lanportTable=lanportTable, qosIndex=qosIndex, fileType=fileType, modeEntry=modeEntry, vendorName=vendorName, staticIpAddr=staticIpAddr, groupid=groupid, staticIpSubMask=staticIpSubMask, priority=priority, fileName=fileName, wan=wan, jumblan2=jumblan2, catv=catv, staticDns=staticDns, vendorPn=vendorPn, multicastsReceived=multicastsReceived, multicastsTransmitted=multicastsTransmitted, jumbwan=jumbwan, staticIpDomainName=staticIpDomainName, lan4=lan4, txPower=txPower, jumblan1=jumblan1, vendorRev=vendorRev, dscpEnable=dscpEnable, jumblan3=jumblan3, reboot=reboot, groupIndex=groupIndex, lanportpause=lanportpause, qosTable=qosTable, lan2=lan2, portTable=portTable, statisticTable=statisticTable, tftpSevIp=tftpSevIp, operStatus=operStatus, vlangroupTable=vlangroupTable, portStatEntry=portStatEntry, domainame=domainame, jumblan4=jumblan4, portEntry=portEntry, voltage=voltage, unicastsTransmitted=unicastsTransmitted, qmode=qmode, speed=speed, staticIpPrimaryDns=staticIpPrimaryDns, fcsErrorTransmitted=fcsErrorTransmitted, portStatistic=portStatistic, broadcastsReceived=broadcastsReceived, qosEntry=qosEntry, wanType=wanType, lan1=lan1, staticIpHostName=staticIpHostName, port3=port3, port1=port1, pauseReceived=pauseReceived, broadcastsTransmitted=broadcastsTransmitted, temperature=temperature, lan3=lan3, groupEntry=groupEntry, xg6846=xg6846, adminStatus=adminStatus, port4=port4, vendorOui=vendorOui, portPower=portPower, portmode=portmode, bias=bias, unicastsReceived=unicastsReceived)
