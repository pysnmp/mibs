...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, Unsigned32, iso, ModuleIdentity, TimeTicks, snmpModules, enterprises, Counter32, Integer32, MibIdentifier, Bits, mib_2, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "Unsigned32", "iso", "ModuleIdentity", "TimeTicks", "snmpModules", "enterprises", "Counter32", "Integer32", "MibIdentifier", "Bits", "mib-2", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpGateway=staticIpGateway, jumbwan=jumbwan, lan3=lan3, qosTable=qosTable, jumb=jumb, lan1=lan1, jumblan2=jumblan2, lanportName=lanportName, vendorRev=vendorRev, staticDns=staticDns, port2=port2, groupEntry=groupEntry, action=action, broadcastsTransmitted=broadcastsTransmitted, voltage=voltage, lanportspeed=lanportspeed, staticIpSecondaryDns=staticIpSecondaryDns, domainame=domainame, vlangroupTable=vlangroupTable, primaryDns=primaryDns, xg6846=xg6846, qosEntry=qosEntry, bias=bias, lanportIndex=lanportIndex, reboot=reboot, qos=qos, modeEntry=modeEntry, portName=portName, vendorPn=vendorPn, multicastsTransmitted=multicastsTransmitted, portmode=portmode, vlanid=vlanid, rebootEnable=rebootEnable, pauseTransmitted=pauseTransmitted, vendorOui=vendorOui, staticIpHostName=staticIpHostName, priority=priority, statIndex=statIndex, deviceinfo=deviceinfo, portEntry=portEntry, groupid=groupid, qosIndex=qosIndex, ddminfo=ddminfo, jumblan1=jumblan1, txPower=txPower, fcsErrorReceived=fcsErrorReceived, secondaryDns=secondaryDns, unicastsReceived=unicastsReceived, internetPort=internetPort, wan=wan, fileName=fileName, jumblan3=jumblan3, wanType=wanType, portStatistic=portStatistic, staticIpAddr=staticIpAddr, lanportTable=lanportTable, lan4=lan4, tftpSevIp=tftpSevIp, adminStatus=adminStatus, qmode=qmode, hostname=hostname, staticIpDomainName=staticIpDomainName, serialnum=serialnum, temperature=temperature, rxPower=rxPower, lanportpause=lanportpause, vendorName=vendorName, staticIpSubMask=staticIpSubMask, port3=port3, dscpEnable=dscpEnable, portIndex=portIndex, jumblan4=jumblan4, vlan=vlan, qmapping=qmapping, pauseReceived=pauseReceived, port1=port1, multicastsReceived=multicastsReceived, lan2=lan2, groupIndex=groupIndex, portStatEntry=portStatEntry, operStatus=operStatus, port4=port4, catv=catv, portPower=portPower, broadcastsReceived=broadcastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, fcsErrorTransmitted=fcsErrorTransmitted, unicastsTransmitted=unicastsTransmitted, speed=speed, tftp=tftp, statisticTable=statisticTable, fileType=fileType, portTable=portTable, catvEnable=catvEnable)
