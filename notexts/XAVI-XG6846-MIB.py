...
Counter32, enterprises, snmpModules, iso, Gauge32, Bits, NotificationType, IpAddress, MibIdentifier, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, ObjectIdentity, ModuleIdentity, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "enterprises", "snmpModules", "iso", "Gauge32", "Bits", "NotificationType", "IpAddress", "MibIdentifier", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", unicastsTransmitted=unicastsTransmitted, vlangroupTable=vlangroupTable, staticIpHostName=staticIpHostName, lan4=lan4, tftpSevIp=tftpSevIp, port1=port1, ddminfo=ddminfo, portStatistic=portStatistic, reboot=reboot, broadcastsTransmitted=broadcastsTransmitted, staticIpSubMask=staticIpSubMask, staticIpSecondaryDns=staticIpSecondaryDns, staticIpDomainName=staticIpDomainName, qos=qos, pauseTransmitted=pauseTransmitted, lanportspeed=lanportspeed, portIndex=portIndex, xg6846=xg6846, txPower=txPower, lanportTable=lanportTable, catvEnable=catvEnable, qosEntry=qosEntry, lanportpause=lanportpause, fcsErrorTransmitted=fcsErrorTransmitted, portPower=portPower, secondaryDns=secondaryDns, fileName=fileName, lanportName=lanportName, qmode=qmode, multicastsReceived=multicastsReceived, statIndex=statIndex, portEntry=portEntry, jumblan4=jumblan4, statisticTable=statisticTable, vlanid=vlanid, modeEntry=modeEntry, internetPort=internetPort, unicastsReceived=unicastsReceived, bias=bias, vendorName=vendorName, temperature=temperature, staticDns=staticDns, action=action, deviceinfo=deviceinfo, hostname=hostname, multicastsTransmitted=multicastsTransmitted, pauseReceived=pauseReceived, portTable=portTable, fcsErrorReceived=fcsErrorReceived, adminStatus=adminStatus, groupEntry=groupEntry, priority=priority, rebootEnable=rebootEnable, jumb=jumb, domainame=domainame, jumbwan=jumbwan, jumblan2=jumblan2, groupid=groupid, jumblan3=jumblan3, port2=port2, staticIpGateway=staticIpGateway, wan=wan, wanType=wanType, qmapping=qmapping, vendorRev=vendorRev, dscpEnable=dscpEnable, voltage=voltage, port4=port4, portName=portName, rxPower=rxPower, lanportIndex=lanportIndex, broadcastsReceived=broadcastsReceived, vlan=vlan, fileType=fileType, catv=catv, staticIpAddr=staticIpAddr, portStatEntry=portStatEntry, jumblan1=jumblan1, speed=speed, portmode=portmode, vendorPn=vendorPn, lan1=lan1, qosTable=qosTable, qosIndex=qosIndex, lan3=lan3, serialnum=serialnum, tftp=tftp, lan2=lan2, port3=port3, vendorOui=vendorOui, staticIpPrimaryDns=staticIpPrimaryDns, operStatus=operStatus, groupIndex=groupIndex, primaryDns=primaryDns)
