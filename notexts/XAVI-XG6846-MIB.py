...
# Produced by pysmi-1.1.8 at Thu Sep 15 09:43:27 2022
...
IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, Bits, TimeTicks, enterprises, Gauge32, ModuleIdentity, snmpModules, Counter64, Counter32, NotificationType, Integer32, mib_2, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "Bits", "TimeTicks", "enterprises", "Gauge32", "ModuleIdentity", "snmpModules", "Counter64", "Counter32", "NotificationType", "Integer32", "mib-2", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupid=groupid, dscpEnable=dscpEnable, deviceinfo=deviceinfo, secondaryDns=secondaryDns, lanportTable=lanportTable, fcsErrorReceived=fcsErrorReceived, multicastsReceived=multicastsReceived, vendorOui=vendorOui, fileName=fileName, portName=portName, staticIpAddr=staticIpAddr, port3=port3, vendorPn=vendorPn, portIndex=portIndex, lanportName=lanportName, portStatEntry=portStatEntry, unicastsTransmitted=unicastsTransmitted, portTable=portTable, jumblan1=jumblan1, staticIpSubMask=staticIpSubMask, statisticTable=statisticTable, fileType=fileType, serialnum=serialnum, qos=qos, xg6846=xg6846, staticIpGateway=staticIpGateway, qosTable=qosTable, port4=port4, primaryDns=primaryDns, qosIndex=qosIndex, vendorName=vendorName, rxPower=rxPower, priority=priority, bias=bias, operStatus=operStatus, ddminfo=ddminfo, vendorRev=vendorRev, txPower=txPower, port1=port1, qmode=qmode, adminStatus=adminStatus, lan4=lan4, unicastsReceived=unicastsReceived, port2=port2, lan2=lan2, speed=speed, wan=wan, tftp=tftp, jumb=jumb, temperature=temperature, modeEntry=modeEntry, groupIndex=groupIndex, vlanid=vlanid, wanType=wanType, lan1=lan1, staticIpPrimaryDns=staticIpPrimaryDns, jumblan2=jumblan2, reboot=reboot, portPower=portPower, hostname=hostname, voltage=voltage, catv=catv, internetPort=internetPort, domainame=domainame, catvEnable=catvEnable, qmapping=qmapping, lanportpause=lanportpause, broadcastsReceived=broadcastsReceived, pauseReceived=pauseReceived, multicastsTransmitted=multicastsTransmitted, staticDns=staticDns, groupEntry=groupEntry, lanportIndex=lanportIndex, jumbwan=jumbwan, vlan=vlan, tftpSevIp=tftpSevIp, qosEntry=qosEntry, lanportspeed=lanportspeed, portmode=portmode, jumblan4=jumblan4, pauseTransmitted=pauseTransmitted, rebootEnable=rebootEnable, vlangroupTable=vlangroupTable, staticIpHostName=staticIpHostName, jumblan3=jumblan3, portEntry=portEntry, broadcastsTransmitted=broadcastsTransmitted, fcsErrorTransmitted=fcsErrorTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, statIndex=statIndex, lan3=lan3, action=action, staticIpDomainName=staticIpDomainName, portStatistic=portStatistic)
