...
Bits, Counter32, iso, NotificationType, mib_2, ObjectIdentity, Unsigned32, Counter64, ModuleIdentity, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, snmpModules, enterprises, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "iso", "NotificationType", "mib-2", "ObjectIdentity", "Unsigned32", "Counter64", "ModuleIdentity", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "snmpModules", "enterprises", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vlanid=vlanid, vlan=vlan, vendorName=vendorName, wanType=wanType, catvEnable=catvEnable, lan3=lan3, pauseTransmitted=pauseTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, lanportpause=lanportpause, groupIndex=groupIndex, broadcastsTransmitted=broadcastsTransmitted, jumblan4=jumblan4, qmode=qmode, catv=catv, portStatistic=portStatistic, vendorPn=vendorPn, lan1=lan1, unicastsTransmitted=unicastsTransmitted, fcsErrorTransmitted=fcsErrorTransmitted, portTable=portTable, hostname=hostname, action=action, bias=bias, xg6846=xg6846, staticIpDomainName=staticIpDomainName, portEntry=portEntry, port4=port4, broadcastsReceived=broadcastsReceived, multicastsReceived=multicastsReceived, staticIpHostName=staticIpHostName, modeEntry=modeEntry, rebootEnable=rebootEnable, portmode=portmode, qos=qos, jumblan2=jumblan2, serialnum=serialnum, vendorRev=vendorRev, port1=port1, multicastsTransmitted=multicastsTransmitted, lanportName=lanportName, portName=portName, secondaryDns=secondaryDns, lanportspeed=lanportspeed, voltage=voltage, txPower=txPower, unicastsReceived=unicastsReceived, vendorOui=vendorOui, lanportIndex=lanportIndex, statisticTable=statisticTable, speed=speed, qmapping=qmapping, primaryDns=primaryDns, jumblan1=jumblan1, ddminfo=ddminfo, tftpSevIp=tftpSevIp, priority=priority, staticIpSecondaryDns=staticIpSecondaryDns, staticIpSubMask=staticIpSubMask, qosTable=qosTable, operStatus=operStatus, lan2=lan2, jumb=jumb, deviceinfo=deviceinfo, fcsErrorReceived=fcsErrorReceived, groupEntry=groupEntry, fileName=fileName, groupid=groupid, jumbwan=jumbwan, staticIpAddr=staticIpAddr, qosIndex=qosIndex, statIndex=statIndex, staticIpGateway=staticIpGateway, domainame=domainame, adminStatus=adminStatus, pauseReceived=pauseReceived, jumblan3=jumblan3, portPower=portPower, reboot=reboot, port3=port3, port2=port2, staticDns=staticDns, portIndex=portIndex, rxPower=rxPower, lanportTable=lanportTable, fileType=fileType, tftp=tftp, qosEntry=qosEntry, dscpEnable=dscpEnable, temperature=temperature, wan=wan, internetPort=internetPort, portStatEntry=portStatEntry, lan4=lan4, vlangroupTable=vlangroupTable)
