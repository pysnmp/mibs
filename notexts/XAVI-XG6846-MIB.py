...
# Produced by pysmi-1.1.12 at Fri Jul 19 10:04:23 2024
...
IpAddress, Counter64, Unsigned32, NotificationType, Gauge32, ModuleIdentity, snmpModules, ObjectIdentity, MibIdentifier, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, enterprises, mib_2, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "Unsigned32", "NotificationType", "Gauge32", "ModuleIdentity", "snmpModules", "ObjectIdentity", "MibIdentifier", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "enterprises", "mib-2", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vlangroupTable=vlangroupTable, groupIndex=groupIndex, broadcastsReceived=broadcastsReceived, vendorPn=vendorPn, fileType=fileType, jumblan1=jumblan1, ddminfo=ddminfo, multicastsTransmitted=multicastsTransmitted, staticIpDomainName=staticIpDomainName, catv=catv, hostname=hostname, operStatus=operStatus, qos=qos, port3=port3, lan3=lan3, unicastsTransmitted=unicastsTransmitted, jumblan3=jumblan3, staticIpPrimaryDns=staticIpPrimaryDns, domainame=domainame, fcsErrorTransmitted=fcsErrorTransmitted, portTable=portTable, lanportIndex=lanportIndex, catvEnable=catvEnable, vlanid=vlanid, qmapping=qmapping, lanportpause=lanportpause, multicastsReceived=multicastsReceived, tftpSevIp=tftpSevIp, port4=port4, portPower=portPower, portIndex=portIndex, dscpEnable=dscpEnable, deviceinfo=deviceinfo, vlan=vlan, lan1=lan1, portmode=portmode, serialnum=serialnum, port2=port2, lanportTable=lanportTable, staticIpGateway=staticIpGateway, qosIndex=qosIndex, priority=priority, action=action, qosTable=qosTable, pauseReceived=pauseReceived, statIndex=statIndex, staticIpAddr=staticIpAddr, adminStatus=adminStatus, portEntry=portEntry, unicastsReceived=unicastsReceived, lan2=lan2, staticIpHostName=staticIpHostName, qosEntry=qosEntry, jumblan2=jumblan2, statisticTable=statisticTable, port1=port1, voltage=voltage, jumb=jumb, groupid=groupid, wan=wan, jumblan4=jumblan4, modeEntry=modeEntry, primaryDns=primaryDns, fcsErrorReceived=fcsErrorReceived, staticIpSubMask=staticIpSubMask, fileName=fileName, lanportName=lanportName, lan4=lan4, txPower=txPower, secondaryDns=secondaryDns, portName=portName, portStatistic=portStatistic, pauseTransmitted=pauseTransmitted, temperature=temperature, tftp=tftp, rebootEnable=rebootEnable, portStatEntry=portStatEntry, speed=speed, wanType=wanType, staticDns=staticDns, lanportspeed=lanportspeed, vendorOui=vendorOui, internetPort=internetPort, broadcastsTransmitted=broadcastsTransmitted, vendorRev=vendorRev, bias=bias, reboot=reboot, xg6846=xg6846, vendorName=vendorName, groupEntry=groupEntry, rxPower=rxPower, staticIpSecondaryDns=staticIpSecondaryDns, jumbwan=jumbwan, qmode=qmode)
