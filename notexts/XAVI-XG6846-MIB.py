...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, mib_2, Unsigned32, IpAddress, iso, Bits, Counter64, ObjectIdentity, Gauge32, snmpModules, TimeTicks, ModuleIdentity, enterprises, Counter32, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "mib-2", "Unsigned32", "IpAddress", "iso", "Bits", "Counter64", "ObjectIdentity", "Gauge32", "snmpModules", "TimeTicks", "ModuleIdentity", "enterprises", "Counter32", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", pauseReceived=pauseReceived, qosEntry=qosEntry, jumblan2=jumblan2, deviceinfo=deviceinfo, qmapping=qmapping, jumbwan=jumbwan, groupid=groupid, jumblan1=jumblan1, tftp=tftp, portEntry=portEntry, modeEntry=modeEntry, jumb=jumb, staticIpAddr=staticIpAddr, xg6846=xg6846, secondaryDns=secondaryDns, catvEnable=catvEnable, statisticTable=statisticTable, qmode=qmode, fcsErrorReceived=fcsErrorReceived, qos=qos, internetPort=internetPort, groupIndex=groupIndex, lan3=lan3, broadcastsTransmitted=broadcastsTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, portName=portName, staticIpGateway=staticIpGateway, lan4=lan4, unicastsReceived=unicastsReceived, port1=port1, port4=port4, wan=wan, vendorName=vendorName, operStatus=operStatus, ddminfo=ddminfo, lanportspeed=lanportspeed, portmode=portmode, vlangroupTable=vlangroupTable, vendorRev=vendorRev, vendorOui=vendorOui, jumblan3=jumblan3, adminStatus=adminStatus, portIndex=portIndex, serialnum=serialnum, action=action, staticIpPrimaryDns=staticIpPrimaryDns, tftpSevIp=tftpSevIp, priority=priority, multicastsTransmitted=multicastsTransmitted, staticIpSubMask=staticIpSubMask, lanportName=lanportName, rebootEnable=rebootEnable, groupEntry=groupEntry, vlanid=vlanid, lanportIndex=lanportIndex, portTable=portTable, multicastsReceived=multicastsReceived, portStatEntry=portStatEntry, lan2=lan2, hostname=hostname, staticIpDomainName=staticIpDomainName, fileName=fileName, temperature=temperature, fileType=fileType, statIndex=statIndex, staticDns=staticDns, jumblan4=jumblan4, primaryDns=primaryDns, broadcastsReceived=broadcastsReceived, bias=bias, txPower=txPower, lanportTable=lanportTable, qosIndex=qosIndex, lan1=lan1, port2=port2, domainame=domainame, port3=port3, catv=catv, staticIpHostName=staticIpHostName, dscpEnable=dscpEnable, reboot=reboot, speed=speed, portStatistic=portStatistic, rxPower=rxPower, lanportpause=lanportpause, unicastsTransmitted=unicastsTransmitted, voltage=voltage, qosTable=qosTable, portPower=portPower, pauseTransmitted=pauseTransmitted, wanType=wanType, vlan=vlan, fcsErrorTransmitted=fcsErrorTransmitted, vendorPn=vendorPn)
