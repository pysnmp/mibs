...
# Produced by pysmi-1.1.10 at Thu Apr  4 03:08:58 2024
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port4=port4, staticIpAddr=staticIpAddr, bias=bias, vlangroupTable=vlangroupTable, tftp=tftp, portTable=portTable, rxPower=rxPower, qmode=qmode, jumblan1=jumblan1, vendorRev=vendorRev, port3=port3, multicastsTransmitted=multicastsTransmitted, qosTable=qosTable, internetPort=internetPort, groupid=groupid, wan=wan, fcsErrorReceived=fcsErrorReceived, domainame=domainame, broadcastsTransmitted=broadcastsTransmitted, secondaryDns=secondaryDns, qos=qos, vlanid=vlanid, staticIpGateway=staticIpGateway, txPower=txPower, multicastsReceived=multicastsReceived, broadcastsReceived=broadcastsReceived, vendorOui=vendorOui, primaryDns=primaryDns, portPower=portPower, portStatistic=portStatistic, adminStatus=adminStatus, rebootEnable=rebootEnable, portEntry=portEntry, reboot=reboot, fileType=fileType, tftpSevIp=tftpSevIp, xg6846=xg6846, fcsErrorTransmitted=fcsErrorTransmitted, catv=catv, qmapping=qmapping, portIndex=portIndex, portmode=portmode, staticIpHostName=staticIpHostName, portName=portName, staticIpSubMask=staticIpSubMask, lan1=lan1, pauseReceived=pauseReceived, jumblan4=jumblan4, lanportName=lanportName, pauseTransmitted=pauseTransmitted, qosEntry=qosEntry, qosIndex=qosIndex, lanportspeed=lanportspeed, lanportIndex=lanportIndex, priority=priority, vendorPn=vendorPn, speed=speed, lanportTable=lanportTable, vlan=vlan, serialnum=serialnum, staticIpSecondaryDns=staticIpSecondaryDns, catvEnable=catvEnable, ddminfo=ddminfo, lan4=lan4, jumbwan=jumbwan, jumblan3=jumblan3, staticIpDomainName=staticIpDomainName, jumblan2=jumblan2, hostname=hostname, unicastsReceived=unicastsReceived, vendorName=vendorName, temperature=temperature, staticIpPrimaryDns=staticIpPrimaryDns, dscpEnable=dscpEnable, wanType=wanType, portStatEntry=portStatEntry, lanportpause=lanportpause, unicastsTransmitted=unicastsTransmitted, fileName=fileName, deviceinfo=deviceinfo, voltage=voltage, staticDns=staticDns, modeEntry=modeEntry, lan2=lan2, action=action, statisticTable=statisticTable, port1=port1, groupEntry=groupEntry, groupIndex=groupIndex, operStatus=operStatus, port2=port2, jumb=jumb, statIndex=statIndex, lan3=lan3)
