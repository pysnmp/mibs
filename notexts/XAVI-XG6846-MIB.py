...
Integer32, Bits, Gauge32, enterprises, iso, ModuleIdentity, NotificationType, ObjectIdentity, Counter64, Unsigned32, TimeTicks, mib_2, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "Gauge32", "enterprises", "iso", "ModuleIdentity", "NotificationType", "ObjectIdentity", "Counter64", "Unsigned32", "TimeTicks", "mib-2", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", rebootEnable=rebootEnable, vendorName=vendorName, staticIpAddr=staticIpAddr, dscpEnable=dscpEnable, jumblan3=jumblan3, bias=bias, internetPort=internetPort, qos=qos, deviceinfo=deviceinfo, multicastsReceived=multicastsReceived, tftp=tftp, port4=port4, hostname=hostname, ddminfo=ddminfo, lan2=lan2, jumbwan=jumbwan, lanportIndex=lanportIndex, domainame=domainame, staticIpHostName=staticIpHostName, fileType=fileType, lan4=lan4, lanportspeed=lanportspeed, portStatEntry=portStatEntry, lanportName=lanportName, priority=priority, voltage=voltage, catv=catv, broadcastsTransmitted=broadcastsTransmitted, jumblan4=jumblan4, pauseTransmitted=pauseTransmitted, lan3=lan3, txPower=txPower, staticDns=staticDns, secondaryDns=secondaryDns, lanportTable=lanportTable, portTable=portTable, portIndex=portIndex, unicastsTransmitted=unicastsTransmitted, staticIpDomainName=staticIpDomainName, groupIndex=groupIndex, vlangroupTable=vlangroupTable, vlan=vlan, portName=portName, statisticTable=statisticTable, jumblan2=jumblan2, speed=speed, portEntry=portEntry, fcsErrorReceived=fcsErrorReceived, qmapping=qmapping, unicastsReceived=unicastsReceived, staticIpGateway=staticIpGateway, vendorOui=vendorOui, lanportpause=lanportpause, action=action, qosIndex=qosIndex, statIndex=statIndex, qosTable=qosTable, adminStatus=adminStatus, multicastsTransmitted=multicastsTransmitted, temperature=temperature, staticIpPrimaryDns=staticIpPrimaryDns, primaryDns=primaryDns, xg6846=xg6846, rxPower=rxPower, operStatus=operStatus, vlanid=vlanid, jumblan1=jumblan1, groupid=groupid, port2=port2, tftpSevIp=tftpSevIp, portStatistic=portStatistic, port3=port3, broadcastsReceived=broadcastsReceived, jumb=jumb, fileName=fileName, staticIpSubMask=staticIpSubMask, pauseReceived=pauseReceived, catvEnable=catvEnable, modeEntry=modeEntry, groupEntry=groupEntry, wanType=wanType, qmode=qmode, reboot=reboot, lan1=lan1, wan=wan, serialnum=serialnum, portmode=portmode, fcsErrorTransmitted=fcsErrorTransmitted, vendorRev=vendorRev, port1=port1, vendorPn=vendorPn, portPower=portPower, qosEntry=qosEntry, staticIpSecondaryDns=staticIpSecondaryDns)
