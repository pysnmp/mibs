...
# Produced by pysmi-1.1.8 at Mon Sep 19 07:31:14 2022
...
NotificationType, TimeTicks, Integer32, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, mib_2, IpAddress, ObjectIdentity, iso, snmpModules, enterprises, Bits, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Integer32", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "mib-2", "IpAddress", "ObjectIdentity", "iso", "snmpModules", "enterprises", "Bits", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupIndex=groupIndex, portName=portName, staticIpPrimaryDns=staticIpPrimaryDns, bias=bias, port4=port4, vlanid=vlanid, vendorPn=vendorPn, vlangroupTable=vlangroupTable, portTable=portTable, lan1=lan1, port3=port3, temperature=temperature, staticIpGateway=staticIpGateway, staticIpAddr=staticIpAddr, rebootEnable=rebootEnable, wan=wan, txPower=txPower, xg6846=xg6846, internetPort=internetPort, tftpSevIp=tftpSevIp, lan3=lan3, lanportpause=lanportpause, staticIpHostName=staticIpHostName, serialnum=serialnum, broadcastsTransmitted=broadcastsTransmitted, catvEnable=catvEnable, lanportIndex=lanportIndex, wanType=wanType, qmapping=qmapping, jumblan3=jumblan3, portIndex=portIndex, fcsErrorReceived=fcsErrorReceived, domainame=domainame, jumblan2=jumblan2, jumbwan=jumbwan, statIndex=statIndex, secondaryDns=secondaryDns, fcsErrorTransmitted=fcsErrorTransmitted, rxPower=rxPower, lanportName=lanportName, lanportspeed=lanportspeed, staticDns=staticDns, speed=speed, primaryDns=primaryDns, qosIndex=qosIndex, statisticTable=statisticTable, reboot=reboot, vendorName=vendorName, groupEntry=groupEntry, voltage=voltage, staticIpSecondaryDns=staticIpSecondaryDns, lanportTable=lanportTable, multicastsReceived=multicastsReceived, pauseTransmitted=pauseTransmitted, fileType=fileType, staticIpDomainName=staticIpDomainName, lan2=lan2, action=action, vlan=vlan, vendorOui=vendorOui, qosTable=qosTable, qmode=qmode, port2=port2, portStatEntry=portStatEntry, vendorRev=vendorRev, qosEntry=qosEntry, unicastsTransmitted=unicastsTransmitted, staticIpSubMask=staticIpSubMask, portmode=portmode, jumblan1=jumblan1, lan4=lan4, priority=priority, broadcastsReceived=broadcastsReceived, port1=port1, groupid=groupid, jumb=jumb, portPower=portPower, multicastsTransmitted=multicastsTransmitted, fileName=fileName, hostname=hostname, adminStatus=adminStatus, jumblan4=jumblan4, dscpEnable=dscpEnable, operStatus=operStatus, qos=qos, catv=catv, unicastsReceived=unicastsReceived, tftp=tftp, portEntry=portEntry, ddminfo=ddminfo, portStatistic=portStatistic, modeEntry=modeEntry, deviceinfo=deviceinfo, pauseReceived=pauseReceived)
