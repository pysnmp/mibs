...
# Produced by pysmi-1.1.8 at Thu Jan  5 14:48:52 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, ModuleIdentity, IpAddress, Counter32, enterprises, Unsigned32, TimeTicks, MibIdentifier, ObjectIdentity, snmpModules, Integer32, mib_2, iso, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "ModuleIdentity", "IpAddress", "Counter32", "enterprises", "Unsigned32", "TimeTicks", "MibIdentifier", "ObjectIdentity", "snmpModules", "Integer32", "mib-2", "iso", "Counter64", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", xg6846=xg6846, wanType=wanType, deviceinfo=deviceinfo, statIndex=statIndex, port4=port4, ddminfo=ddminfo, jumb=jumb, jumblan3=jumblan3, qos=qos, operStatus=operStatus, statisticTable=statisticTable, staticIpHostName=staticIpHostName, secondaryDns=secondaryDns, fcsErrorReceived=fcsErrorReceived, staticIpGateway=staticIpGateway, multicastsTransmitted=multicastsTransmitted, txPower=txPower, vendorPn=vendorPn, port2=port2, lanportTable=lanportTable, staticIpPrimaryDns=staticIpPrimaryDns, voltage=voltage, qmapping=qmapping, lan1=lan1, primaryDns=primaryDns, unicastsTransmitted=unicastsTransmitted, unicastsReceived=unicastsReceived, lanportspeed=lanportspeed, port1=port1, groupIndex=groupIndex, speed=speed, bias=bias, catvEnable=catvEnable, qmode=qmode, vlanid=vlanid, portStatEntry=portStatEntry, rebootEnable=rebootEnable, action=action, qosTable=qosTable, lanportName=lanportName, jumbwan=jumbwan, internetPort=internetPort, rxPower=rxPower, lanportIndex=lanportIndex, adminStatus=adminStatus, multicastsReceived=multicastsReceived, priority=priority, broadcastsReceived=broadcastsReceived, staticIpSubMask=staticIpSubMask, portmode=portmode, pauseReceived=pauseReceived, vendorOui=vendorOui, catv=catv, vlangroupTable=vlangroupTable, domainame=domainame, temperature=temperature, staticIpSecondaryDns=staticIpSecondaryDns, fcsErrorTransmitted=fcsErrorTransmitted, lan4=lan4, vlan=vlan, portTable=portTable, groupEntry=groupEntry, reboot=reboot, broadcastsTransmitted=broadcastsTransmitted, portStatistic=portStatistic, dscpEnable=dscpEnable, portName=portName, portPower=portPower, groupid=groupid, jumblan4=jumblan4, lan3=lan3, serialnum=serialnum, staticIpAddr=staticIpAddr, jumblan1=jumblan1, staticDns=staticDns, vendorName=vendorName, port3=port3, tftp=tftp, jumblan2=jumblan2, wan=wan, portIndex=portIndex, vendorRev=vendorRev, tftpSevIp=tftpSevIp, pauseTransmitted=pauseTransmitted, staticIpDomainName=staticIpDomainName, modeEntry=modeEntry, hostname=hostname, qosEntry=qosEntry, qosIndex=qosIndex, fileName=fileName, fileType=fileType, portEntry=portEntry, lanportpause=lanportpause, lan2=lan2)
