...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:03:33 2021
...
MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, ModuleIdentity, snmpModules, Gauge32, TimeTicks, Unsigned32, enterprises, Counter32, NotificationType, Bits, ObjectIdentity, mib_2, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "ModuleIdentity", "snmpModules", "Gauge32", "TimeTicks", "Unsigned32", "enterprises", "Counter32", "NotificationType", "Bits", "ObjectIdentity", "mib-2", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", statIndex=statIndex, port2=port2, txPower=txPower, bias=bias, lanportName=lanportName, tftpSevIp=tftpSevIp, voltage=voltage, lanportpause=lanportpause, wanType=wanType, lanportIndex=lanportIndex, fcsErrorTransmitted=fcsErrorTransmitted, staticIpHostName=staticIpHostName, serialnum=serialnum, broadcastsReceived=broadcastsReceived, lan1=lan1, secondaryDns=secondaryDns, portTable=portTable, lan4=lan4, broadcastsTransmitted=broadcastsTransmitted, pauseReceived=pauseReceived, fcsErrorReceived=fcsErrorReceived, portStatEntry=portStatEntry, vendorOui=vendorOui, vlanid=vlanid, temperature=temperature, jumb=jumb, groupIndex=groupIndex, vlangroupTable=vlangroupTable, fileName=fileName, jumblan3=jumblan3, unicastsReceived=unicastsReceived, modeEntry=modeEntry, priority=priority, reboot=reboot, internetPort=internetPort, wan=wan, qosTable=qosTable, xg6846=xg6846, vendorName=vendorName, domainame=domainame, action=action, qosIndex=qosIndex, jumblan4=jumblan4, portmode=portmode, qmapping=qmapping, operStatus=operStatus, staticIpGateway=staticIpGateway, unicastsTransmitted=unicastsTransmitted, pauseTransmitted=pauseTransmitted, multicastsReceived=multicastsReceived, statisticTable=statisticTable, port1=port1, jumbwan=jumbwan, port4=port4, fileType=fileType, adminStatus=adminStatus, vlan=vlan, portName=portName, rebootEnable=rebootEnable, portIndex=portIndex, staticDns=staticDns, qos=qos, primaryDns=primaryDns, portEntry=portEntry, speed=speed, catv=catv, lan2=lan2, vendorRev=vendorRev, hostname=hostname, groupEntry=groupEntry, portStatistic=portStatistic, rxPower=rxPower, staticIpAddr=staticIpAddr, dscpEnable=dscpEnable, lanportTable=lanportTable, multicastsTransmitted=multicastsTransmitted, vendorPn=vendorPn, tftp=tftp, deviceinfo=deviceinfo, lanportspeed=lanportspeed, port3=port3, catvEnable=catvEnable, lan3=lan3, jumblan1=jumblan1, jumblan2=jumblan2, qmode=qmode, staticIpSecondaryDns=staticIpSecondaryDns, staticIpSubMask=staticIpSubMask, ddminfo=ddminfo, portPower=portPower, staticIpDomainName=staticIpDomainName, staticIpPrimaryDns=staticIpPrimaryDns, qosEntry=qosEntry, groupid=groupid)
