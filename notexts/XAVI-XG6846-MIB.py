...
Bits, Counter64, iso, ObjectIdentity, Integer32, Counter32, enterprises, snmpModules, NotificationType, mib_2, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "iso", "ObjectIdentity", "Integer32", "Counter32", "enterprises", "snmpModules", "NotificationType", "mib-2", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", txPower=txPower, internetPort=internetPort, fileName=fileName, portTable=portTable, bias=bias, portIndex=portIndex, domainame=domainame, portName=portName, rebootEnable=rebootEnable, jumblan2=jumblan2, pauseTransmitted=pauseTransmitted, port1=port1, qosEntry=qosEntry, vendorRev=vendorRev, lanportName=lanportName, portEntry=portEntry, port4=port4, jumblan1=jumblan1, lan2=lan2, catvEnable=catvEnable, vlanid=vlanid, deviceinfo=deviceinfo, ddminfo=ddminfo, vendorPn=vendorPn, staticDns=staticDns, broadcastsReceived=broadcastsReceived, staticIpDomainName=staticIpDomainName, wan=wan, multicastsReceived=multicastsReceived, qmode=qmode, reboot=reboot, statisticTable=statisticTable, serialnum=serialnum, vendorName=vendorName, staticIpSubMask=staticIpSubMask, operStatus=operStatus, jumblan4=jumblan4, voltage=voltage, unicastsTransmitted=unicastsTransmitted, groupEntry=groupEntry, qosTable=qosTable, staticIpAddr=staticIpAddr, temperature=temperature, hostname=hostname, lanportIndex=lanportIndex, qos=qos, portStatistic=portStatistic, fileType=fileType, catv=catv, vlan=vlan, lan1=lan1, modeEntry=modeEntry, portmode=portmode, primaryDns=primaryDns, fcsErrorReceived=fcsErrorReceived, lanportspeed=lanportspeed, statIndex=statIndex, action=action, pauseReceived=pauseReceived, staticIpGateway=staticIpGateway, adminStatus=adminStatus, multicastsTransmitted=multicastsTransmitted, priority=priority, groupid=groupid, lan3=lan3, jumblan3=jumblan3, portStatEntry=portStatEntry, vendorOui=vendorOui, secondaryDns=secondaryDns, broadcastsTransmitted=broadcastsTransmitted, fcsErrorTransmitted=fcsErrorTransmitted, lanportTable=lanportTable, port2=port2, speed=speed, staticIpPrimaryDns=staticIpPrimaryDns, tftp=tftp, staticIpSecondaryDns=staticIpSecondaryDns, vlangroupTable=vlangroupTable, lan4=lan4, dscpEnable=dscpEnable, port3=port3, jumbwan=jumbwan, rxPower=rxPower, portPower=portPower, staticIpHostName=staticIpHostName, unicastsReceived=unicastsReceived, qmapping=qmapping, tftpSevIp=tftpSevIp, jumb=jumb, groupIndex=groupIndex, qosIndex=qosIndex, xg6846=xg6846, lanportpause=lanportpause, wanType=wanType)
