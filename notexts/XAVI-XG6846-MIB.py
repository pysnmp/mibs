...
# Produced by pysmi-1.1.8 at Thu Sep  7 14:00:29 2023
...
snmpModules, mib_2, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, NotificationType, TimeTicks, enterprises, iso, Bits, Gauge32, Unsigned32, Counter32, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "mib-2", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "NotificationType", "TimeTicks", "enterprises", "iso", "Bits", "Gauge32", "Unsigned32", "Counter32", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portPower=portPower, tftpSevIp=tftpSevIp, adminStatus=adminStatus, jumblan4=jumblan4, broadcastsReceived=broadcastsReceived, portEntry=portEntry, unicastsReceived=unicastsReceived, jumbwan=jumbwan, port1=port1, catv=catv, jumblan2=jumblan2, lanportpause=lanportpause, wanType=wanType, lan3=lan3, port4=port4, staticIpAddr=staticIpAddr, vlangroupTable=vlangroupTable, fcsErrorTransmitted=fcsErrorTransmitted, tftp=tftp, vendorOui=vendorOui, qmapping=qmapping, temperature=temperature, action=action, staticDns=staticDns, internetPort=internetPort, portStatEntry=portStatEntry, vlan=vlan, fileName=fileName, speed=speed, pauseReceived=pauseReceived, serialnum=serialnum, jumb=jumb, vendorName=vendorName, statIndex=statIndex, primaryDns=primaryDns, dscpEnable=dscpEnable, modeEntry=modeEntry, lanportIndex=lanportIndex, xg6846=xg6846, lanportspeed=lanportspeed, ddminfo=ddminfo, groupIndex=groupIndex, staticIpSecondaryDns=staticIpSecondaryDns, staticIpSubMask=staticIpSubMask, portStatistic=portStatistic, staticIpGateway=staticIpGateway, unicastsTransmitted=unicastsTransmitted, portName=portName, operStatus=operStatus, staticIpHostName=staticIpHostName, vendorRev=vendorRev, secondaryDns=secondaryDns, statisticTable=statisticTable, domainame=domainame, rxPower=rxPower, vendorPn=vendorPn, qmode=qmode, multicastsReceived=multicastsReceived, qos=qos, portTable=portTable, priority=priority, lan1=lan1, groupEntry=groupEntry, jumblan3=jumblan3, lan2=lan2, broadcastsTransmitted=broadcastsTransmitted, vlanid=vlanid, multicastsTransmitted=multicastsTransmitted, qosIndex=qosIndex, deviceinfo=deviceinfo, jumblan1=jumblan1, portmode=portmode, fcsErrorReceived=fcsErrorReceived, fileType=fileType, reboot=reboot, staticIpPrimaryDns=staticIpPrimaryDns, voltage=voltage, pauseTransmitted=pauseTransmitted, staticIpDomainName=staticIpDomainName, port3=port3, groupid=groupid, rebootEnable=rebootEnable, lanportTable=lanportTable, lanportName=lanportName, port2=port2, bias=bias, txPower=txPower, lan4=lan4, wan=wan, qosEntry=qosEntry, hostname=hostname, qosTable=qosTable, catvEnable=catvEnable, portIndex=portIndex)
