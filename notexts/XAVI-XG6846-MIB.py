...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:28:30 2023
...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, Counter32, ObjectIdentity, mib_2, enterprises, iso, Bits, MibIdentifier, Counter64, snmpModules, Integer32, Unsigned32, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "Counter32", "ObjectIdentity", "mib-2", "enterprises", "iso", "Bits", "MibIdentifier", "Counter64", "snmpModules", "Integer32", "Unsigned32", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan1=lan1, fileType=fileType, tftp=tftp, staticIpSecondaryDns=staticIpSecondaryDns, serialnum=serialnum, fileName=fileName, staticIpAddr=staticIpAddr, vlangroupTable=vlangroupTable, unicastsReceived=unicastsReceived, rxPower=rxPower, jumb=jumb, xg6846=xg6846, port1=port1, broadcastsReceived=broadcastsReceived, vlanid=vlanid, bias=bias, vendorName=vendorName, lan3=lan3, reboot=reboot, dscpEnable=dscpEnable, lan4=lan4, unicastsTransmitted=unicastsTransmitted, adminStatus=adminStatus, staticIpPrimaryDns=staticIpPrimaryDns, vendorOui=vendorOui, groupEntry=groupEntry, portName=portName, staticIpHostName=staticIpHostName, qosEntry=qosEntry, wanType=wanType, operStatus=operStatus, qmode=qmode, multicastsReceived=multicastsReceived, vendorRev=vendorRev, primaryDns=primaryDns, jumbwan=jumbwan, jumblan2=jumblan2, domainame=domainame, staticIpSubMask=staticIpSubMask, portIndex=portIndex, hostname=hostname, tftpSevIp=tftpSevIp, lanportTable=lanportTable, pauseReceived=pauseReceived, portEntry=portEntry, portPower=portPower, lan2=lan2, lanportIndex=lanportIndex, qosIndex=qosIndex, portmode=portmode, rebootEnable=rebootEnable, portStatEntry=portStatEntry, lanportpause=lanportpause, wan=wan, groupIndex=groupIndex, lanportName=lanportName, staticIpDomainName=staticIpDomainName, portTable=portTable, action=action, port2=port2, vendorPn=vendorPn, vlan=vlan, secondaryDns=secondaryDns, lanportspeed=lanportspeed, voltage=voltage, port3=port3, fcsErrorReceived=fcsErrorReceived, priority=priority, modeEntry=modeEntry, jumblan4=jumblan4, deviceinfo=deviceinfo, fcsErrorTransmitted=fcsErrorTransmitted, internetPort=internetPort, txPower=txPower, ddminfo=ddminfo, broadcastsTransmitted=broadcastsTransmitted, catvEnable=catvEnable, temperature=temperature, multicastsTransmitted=multicastsTransmitted, staticDns=staticDns, jumblan1=jumblan1, qosTable=qosTable, qmapping=qmapping, statisticTable=statisticTable, statIndex=statIndex, portStatistic=portStatistic, staticIpGateway=staticIpGateway, speed=speed, pauseTransmitted=pauseTransmitted, port4=port4, catv=catv, qos=qos, groupid=groupid, jumblan3=jumblan3)
