...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:27:19 2022
...
mib_2, Unsigned32, Counter32, snmpModules, ModuleIdentity, iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, TimeTicks, NotificationType, Gauge32, MibIdentifier, Bits, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Unsigned32", "Counter32", "snmpModules", "ModuleIdentity", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "TimeTicks", "NotificationType", "Gauge32", "MibIdentifier", "Bits", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", priority=priority, qosTable=qosTable, lan4=lan4, broadcastsTransmitted=broadcastsTransmitted, unicastsReceived=unicastsReceived, lanportspeed=lanportspeed, reboot=reboot, jumblan1=jumblan1, vlan=vlan, portName=portName, staticIpAddr=staticIpAddr, jumb=jumb, tftp=tftp, multicastsReceived=multicastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, portStatistic=portStatistic, staticIpSecondaryDns=staticIpSecondaryDns, xg6846=xg6846, hostname=hostname, serialnum=serialnum, tftpSevIp=tftpSevIp, portmode=portmode, qos=qos, portIndex=portIndex, port4=port4, secondaryDns=secondaryDns, jumblan2=jumblan2, lanportTable=lanportTable, vendorName=vendorName, lan1=lan1, qmode=qmode, vendorRev=vendorRev, staticDns=staticDns, adminStatus=adminStatus, groupIndex=groupIndex, lanportIndex=lanportIndex, fcsErrorReceived=fcsErrorReceived, lanportpause=lanportpause, jumblan4=jumblan4, port2=port2, vlanid=vlanid, wanType=wanType, staticIpHostName=staticIpHostName, statisticTable=statisticTable, staticIpDomainName=staticIpDomainName, rxPower=rxPower, internetPort=internetPort, vlangroupTable=vlangroupTable, multicastsTransmitted=multicastsTransmitted, broadcastsReceived=broadcastsReceived, txPower=txPower, ddminfo=ddminfo, rebootEnable=rebootEnable, bias=bias, fileName=fileName, jumblan3=jumblan3, portTable=portTable, groupEntry=groupEntry, catvEnable=catvEnable, lanportName=lanportName, portEntry=portEntry, domainame=domainame, catv=catv, fileType=fileType, portStatEntry=portStatEntry, deviceinfo=deviceinfo, staticIpSubMask=staticIpSubMask, qosEntry=qosEntry, staticIpGateway=staticIpGateway, staticIpPrimaryDns=staticIpPrimaryDns, jumbwan=jumbwan, voltage=voltage, port3=port3, vendorOui=vendorOui, qmapping=qmapping, portPower=portPower, wan=wan, lan3=lan3, dscpEnable=dscpEnable, action=action, temperature=temperature, qosIndex=qosIndex, lan2=lan2, pauseReceived=pauseReceived, modeEntry=modeEntry, statIndex=statIndex, unicastsTransmitted=unicastsTransmitted, speed=speed, operStatus=operStatus, primaryDns=primaryDns, groupid=groupid, port1=port1, pauseTransmitted=pauseTransmitted, vendorPn=vendorPn)
