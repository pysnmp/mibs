...
# Produced by pysmi-1.1.12 at Tue Jun  4 13:53:49 2024
...
TimeTicks, mib_2, IpAddress, snmpModules, iso, MibIdentifier, ModuleIdentity, Counter64, Unsigned32, ObjectIdentity, Gauge32, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "mib-2", "IpAddress", "snmpModules", "iso", "MibIdentifier", "ModuleIdentity", "Counter64", "Unsigned32", "ObjectIdentity", "Gauge32", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", adminStatus=adminStatus, vendorOui=vendorOui, xg6846=xg6846, primaryDns=primaryDns, staticDns=staticDns, ddminfo=ddminfo, catvEnable=catvEnable, staticIpHostName=staticIpHostName, jumblan1=jumblan1, portName=portName, temperature=temperature, statisticTable=statisticTable, wan=wan, lanportTable=lanportTable, fcsErrorTransmitted=fcsErrorTransmitted, unicastsTransmitted=unicastsTransmitted, portStatistic=portStatistic, groupIndex=groupIndex, portIndex=portIndex, groupid=groupid, statIndex=statIndex, unicastsReceived=unicastsReceived, wanType=wanType, broadcastsTransmitted=broadcastsTransmitted, fileType=fileType, fileName=fileName, modeEntry=modeEntry, portPower=portPower, jumbwan=jumbwan, vendorPn=vendorPn, staticIpGateway=staticIpGateway, lan1=lan1, bias=bias, lanportIndex=lanportIndex, portTable=portTable, internetPort=internetPort, rxPower=rxPower, rebootEnable=rebootEnable, jumblan3=jumblan3, action=action, groupEntry=groupEntry, port3=port3, txPower=txPower, dscpEnable=dscpEnable, tftp=tftp, qos=qos, fcsErrorReceived=fcsErrorReceived, operStatus=operStatus, qosTable=qosTable, lanportspeed=lanportspeed, jumblan2=jumblan2, lanportpause=lanportpause, staticIpAddr=staticIpAddr, portmode=portmode, portStatEntry=portStatEntry, staticIpDomainName=staticIpDomainName, pauseReceived=pauseReceived, qosEntry=qosEntry, jumblan4=jumblan4, staticIpSubMask=staticIpSubMask, priority=priority, speed=speed, vlangroupTable=vlangroupTable, catv=catv, hostname=hostname, staticIpPrimaryDns=staticIpPrimaryDns, secondaryDns=secondaryDns, jumb=jumb, serialnum=serialnum, pauseTransmitted=pauseTransmitted, lan3=lan3, deviceinfo=deviceinfo, qmapping=qmapping, multicastsReceived=multicastsReceived, reboot=reboot, qosIndex=qosIndex, domainame=domainame, lan4=lan4, lanportName=lanportName, broadcastsReceived=broadcastsReceived, voltage=voltage, portEntry=portEntry, vendorName=vendorName, lan2=lan2, port2=port2, vendorRev=vendorRev, qmode=qmode, staticIpSecondaryDns=staticIpSecondaryDns, multicastsTransmitted=multicastsTransmitted, port4=port4, tftpSevIp=tftpSevIp, port1=port1, vlan=vlan, vlanid=vlanid)
