...
TimeTicks, enterprises, Bits, snmpModules, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, mib_2, iso, ObjectIdentity, NotificationType, ModuleIdentity, Unsigned32, IpAddress, MibIdentifier, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "Bits", "snmpModules", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "mib-2", "iso", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Unsigned32", "IpAddress", "MibIdentifier", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", tftpSevIp=tftpSevIp, fileName=fileName, port4=port4, fcsErrorTransmitted=fcsErrorTransmitted, rebootEnable=rebootEnable, operStatus=operStatus, port1=port1, bias=bias, staticIpGateway=staticIpGateway, qmapping=qmapping, multicastsReceived=multicastsReceived, vlangroupTable=vlangroupTable, hostname=hostname, txPower=txPower, portPower=portPower, staticDns=staticDns, portTable=portTable, lanportTable=lanportTable, deviceinfo=deviceinfo, qos=qos, unicastsTransmitted=unicastsTransmitted, portName=portName, vendorOui=vendorOui, vlanid=vlanid, lan4=lan4, portStatEntry=portStatEntry, wan=wan, fcsErrorReceived=fcsErrorReceived, qosTable=qosTable, lan3=lan3, staticIpSecondaryDns=staticIpSecondaryDns, staticIpAddr=staticIpAddr, speed=speed, jumblan4=jumblan4, staticIpHostName=staticIpHostName, priority=priority, vlan=vlan, multicastsTransmitted=multicastsTransmitted, wanType=wanType, tftp=tftp, jumbwan=jumbwan, portStatistic=portStatistic, vendorName=vendorName, lanportspeed=lanportspeed, ddminfo=ddminfo, action=action, vendorPn=vendorPn, staticIpDomainName=staticIpDomainName, pauseTransmitted=pauseTransmitted, internetPort=internetPort, lan2=lan2, secondaryDns=secondaryDns, reboot=reboot, modeEntry=modeEntry, qosIndex=qosIndex, unicastsReceived=unicastsReceived, lanportName=lanportName, port3=port3, portmode=portmode, primaryDns=primaryDns, dscpEnable=dscpEnable, domainame=domainame, staticIpPrimaryDns=staticIpPrimaryDns, broadcastsTransmitted=broadcastsTransmitted, jumblan1=jumblan1, catvEnable=catvEnable, qmode=qmode, jumblan3=jumblan3, jumb=jumb, pauseReceived=pauseReceived, groupIndex=groupIndex, lanportpause=lanportpause, broadcastsReceived=broadcastsReceived, voltage=voltage, adminStatus=adminStatus, catv=catv, portEntry=portEntry, groupid=groupid, rxPower=rxPower, fileType=fileType, port2=port2, xg6846=xg6846, groupEntry=groupEntry, lanportIndex=lanportIndex, statisticTable=statisticTable, statIndex=statIndex, temperature=temperature, jumblan2=jumblan2, portIndex=portIndex, vendorRev=vendorRev, serialnum=serialnum, qosEntry=qosEntry, staticIpSubMask=staticIpSubMask, lan1=lan1)
