...
iso, mib_2, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, snmpModules, Counter64, Bits, Gauge32, ModuleIdentity, TimeTicks, ObjectIdentity, NotificationType, MibIdentifier, enterprises, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "mib-2", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "snmpModules", "Counter64", "Bits", "Gauge32", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "NotificationType", "MibIdentifier", "enterprises", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", txPower=txPower, fcsErrorReceived=fcsErrorReceived, unicastsReceived=unicastsReceived, lan1=lan1, modeEntry=modeEntry, jumblan1=jumblan1, statIndex=statIndex, portName=portName, groupid=groupid, wanType=wanType, broadcastsReceived=broadcastsReceived, qosEntry=qosEntry, serialnum=serialnum, qosTable=qosTable, portmode=portmode, voltage=voltage, fileType=fileType, lanportName=lanportName, qosIndex=qosIndex, lanportIndex=lanportIndex, rxPower=rxPower, pauseReceived=pauseReceived, fcsErrorTransmitted=fcsErrorTransmitted, vendorRev=vendorRev, secondaryDns=secondaryDns, vendorName=vendorName, staticIpHostName=staticIpHostName, pauseTransmitted=pauseTransmitted, dscpEnable=dscpEnable, portPower=portPower, bias=bias, port2=port2, tftpSevIp=tftpSevIp, staticIpGateway=staticIpGateway, vlanid=vlanid, deviceinfo=deviceinfo, groupIndex=groupIndex, qmode=qmode, hostname=hostname, staticIpDomainName=staticIpDomainName, fileName=fileName, portStatEntry=portStatEntry, statisticTable=statisticTable, jumb=jumb, priority=priority, catv=catv, broadcastsTransmitted=broadcastsTransmitted, multicastsReceived=multicastsReceived, qmapping=qmapping, vlangroupTable=vlangroupTable, xg6846=xg6846, lanportspeed=lanportspeed, port3=port3, lanportTable=lanportTable, portEntry=portEntry, temperature=temperature, jumblan4=jumblan4, operStatus=operStatus, groupEntry=groupEntry, jumblan3=jumblan3, vendorPn=vendorPn, vendorOui=vendorOui, tftp=tftp, internetPort=internetPort, lan3=lan3, rebootEnable=rebootEnable, portStatistic=portStatistic, domainame=domainame, port1=port1, staticDns=staticDns, staticIpSubMask=staticIpSubMask, reboot=reboot, staticIpAddr=staticIpAddr, unicastsTransmitted=unicastsTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, primaryDns=primaryDns, action=action, lan4=lan4, adminStatus=adminStatus, lan2=lan2, vlan=vlan, ddminfo=ddminfo, lanportpause=lanportpause, jumbwan=jumbwan, multicastsTransmitted=multicastsTransmitted, catvEnable=catvEnable, wan=wan, portTable=portTable, jumblan2=jumblan2, portIndex=portIndex, qos=qos, speed=speed, staticIpPrimaryDns=staticIpPrimaryDns, port4=port4)
