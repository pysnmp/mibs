...
# Produced by pysmi-1.1.8 at Wed Oct 11 07:57:29 2023
...
Gauge32, ObjectIdentity, Counter32, snmpModules, TimeTicks, MibIdentifier, Bits, mib_2, IpAddress, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, enterprises, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Counter32", "snmpModules", "TimeTicks", "MibIdentifier", "Bits", "mib-2", "IpAddress", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "enterprises", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portName=portName, groupEntry=groupEntry, wanType=wanType, unicastsTransmitted=unicastsTransmitted, wan=wan, fcsErrorReceived=fcsErrorReceived, qosEntry=qosEntry, serialnum=serialnum, qos=qos, speed=speed, temperature=temperature, portPower=portPower, tftp=tftp, fileName=fileName, staticIpGateway=staticIpGateway, staticIpPrimaryDns=staticIpPrimaryDns, xg6846=xg6846, unicastsReceived=unicastsReceived, secondaryDns=secondaryDns, portStatistic=portStatistic, catvEnable=catvEnable, statIndex=statIndex, broadcastsTransmitted=broadcastsTransmitted, fcsErrorTransmitted=fcsErrorTransmitted, jumblan2=jumblan2, groupIndex=groupIndex, vlan=vlan, priority=priority, ddminfo=ddminfo, reboot=reboot, adminStatus=adminStatus, rebootEnable=rebootEnable, internetPort=internetPort, jumblan1=jumblan1, domainame=domainame, vendorRev=vendorRev, jumb=jumb, catv=catv, multicastsTransmitted=multicastsTransmitted, vendorPn=vendorPn, jumbwan=jumbwan, staticDns=staticDns, vlangroupTable=vlangroupTable, port1=port1, portStatEntry=portStatEntry, lan2=lan2, hostname=hostname, qmode=qmode, deviceinfo=deviceinfo, voltage=voltage, staticIpSubMask=staticIpSubMask, staticIpHostName=staticIpHostName, jumblan4=jumblan4, port4=port4, broadcastsReceived=broadcastsReceived, qosTable=qosTable, modeEntry=modeEntry, portTable=portTable, qmapping=qmapping, pauseTransmitted=pauseTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, statisticTable=statisticTable, portEntry=portEntry, staticIpDomainName=staticIpDomainName, primaryDns=primaryDns, tftpSevIp=tftpSevIp, lan3=lan3, port3=port3, multicastsReceived=multicastsReceived, lanportIndex=lanportIndex, portmode=portmode, lanportpause=lanportpause, operStatus=operStatus, lan4=lan4, lan1=lan1, vendorName=vendorName, staticIpAddr=staticIpAddr, vlanid=vlanid, port2=port2, pauseReceived=pauseReceived, qosIndex=qosIndex, rxPower=rxPower, lanportspeed=lanportspeed, groupid=groupid, jumblan3=jumblan3, bias=bias, portIndex=portIndex, fileType=fileType, lanportTable=lanportTable, lanportName=lanportName, txPower=txPower, vendorOui=vendorOui, dscpEnable=dscpEnable, action=action)
