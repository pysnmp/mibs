...
# Produced by pysmi-1.1.10 at Mon Oct 30 02:20:31 2023
...
Integer32, ModuleIdentity, IpAddress, Gauge32, enterprises, snmpModules, Counter32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, MibIdentifier, Unsigned32, Counter64, NotificationType, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "IpAddress", "Gauge32", "enterprises", "snmpModules", "Counter32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "MibIdentifier", "Unsigned32", "Counter64", "NotificationType", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", dscpEnable=dscpEnable, pauseReceived=pauseReceived, wan=wan, qosEntry=qosEntry, domainame=domainame, rxPower=rxPower, staticIpDomainName=staticIpDomainName, deviceinfo=deviceinfo, internetPort=internetPort, portEntry=portEntry, jumbwan=jumbwan, fileName=fileName, jumblan4=jumblan4, secondaryDns=secondaryDns, port2=port2, fcsErrorTransmitted=fcsErrorTransmitted, statIndex=statIndex, speed=speed, portStatistic=portStatistic, jumb=jumb, staticIpPrimaryDns=staticIpPrimaryDns, statisticTable=statisticTable, reboot=reboot, xg6846=xg6846, jumblan3=jumblan3, staticIpHostName=staticIpHostName, portName=portName, port3=port3, jumblan1=jumblan1, qmapping=qmapping, qosIndex=qosIndex, staticDns=staticDns, qos=qos, staticIpAddr=staticIpAddr, bias=bias, portStatEntry=portStatEntry, voltage=voltage, catv=catv, txPower=txPower, groupEntry=groupEntry, lanportspeed=lanportspeed, pauseTransmitted=pauseTransmitted, broadcastsReceived=broadcastsReceived, portTable=portTable, multicastsReceived=multicastsReceived, lanportIndex=lanportIndex, lanportName=lanportName, tftp=tftp, wanType=wanType, portPower=portPower, groupIndex=groupIndex, vendorOui=vendorOui, serialnum=serialnum, multicastsTransmitted=multicastsTransmitted, lanportpause=lanportpause, staticIpGateway=staticIpGateway, adminStatus=adminStatus, priority=priority, portmode=portmode, primaryDns=primaryDns, qmode=qmode, vendorName=vendorName, broadcastsTransmitted=broadcastsTransmitted, vendorRev=vendorRev, rebootEnable=rebootEnable, action=action, vlanid=vlanid, modeEntry=modeEntry, hostname=hostname, ddminfo=ddminfo, fileType=fileType, jumblan2=jumblan2, lan3=lan3, catvEnable=catvEnable, unicastsReceived=unicastsReceived, portIndex=portIndex, port4=port4, operStatus=operStatus, lan1=lan1, port1=port1, tftpSevIp=tftpSevIp, temperature=temperature, lanportTable=lanportTable, staticIpSecondaryDns=staticIpSecondaryDns, staticIpSubMask=staticIpSubMask, fcsErrorReceived=fcsErrorReceived, qosTable=qosTable, groupid=groupid, unicastsTransmitted=unicastsTransmitted, lan2=lan2, lan4=lan4, vlangroupTable=vlangroupTable, vlan=vlan, vendorPn=vendorPn)
