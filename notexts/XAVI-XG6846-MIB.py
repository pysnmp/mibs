...
# Produced by pysmi-1.1.3 at Sun Nov 21 01:07:54 2021
...
Unsigned32, ObjectIdentity, ModuleIdentity, iso, NotificationType, mib_2, Bits, Counter64, IpAddress, enterprises, Counter32, snmpModules, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "ModuleIdentity", "iso", "NotificationType", "mib-2", "Bits", "Counter64", "IpAddress", "enterprises", "Counter32", "snmpModules", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", tftpSevIp=tftpSevIp, lanportIndex=lanportIndex, deviceinfo=deviceinfo, lanportTable=lanportTable, portStatEntry=portStatEntry, dscpEnable=dscpEnable, jumblan2=jumblan2, wanType=wanType, serialnum=serialnum, wan=wan, port4=port4, jumblan1=jumblan1, qos=qos, staticIpGateway=staticIpGateway, port1=port1, ddminfo=ddminfo, groupid=groupid, jumbwan=jumbwan, pauseReceived=pauseReceived, voltage=voltage, domainame=domainame, portTable=portTable, port2=port2, staticIpSubMask=staticIpSubMask, qosIndex=qosIndex, rxPower=rxPower, speed=speed, staticIpDomainName=staticIpDomainName, action=action, broadcastsTransmitted=broadcastsTransmitted, fcsErrorReceived=fcsErrorReceived, vendorName=vendorName, staticIpSecondaryDns=staticIpSecondaryDns, unicastsTransmitted=unicastsTransmitted, hostname=hostname, jumblan3=jumblan3, vlan=vlan, modeEntry=modeEntry, staticIpPrimaryDns=staticIpPrimaryDns, bias=bias, qmode=qmode, priority=priority, primaryDns=primaryDns, statisticTable=statisticTable, multicastsReceived=multicastsReceived, portmode=portmode, secondaryDns=secondaryDns, qosTable=qosTable, qmapping=qmapping, groupIndex=groupIndex, groupEntry=groupEntry, vendorRev=vendorRev, operStatus=operStatus, staticIpAddr=staticIpAddr, portStatistic=portStatistic, portPower=portPower, internetPort=internetPort, lanportpause=lanportpause, unicastsReceived=unicastsReceived, lan2=lan2, portName=portName, fcsErrorTransmitted=fcsErrorTransmitted, lanportspeed=lanportspeed, catvEnable=catvEnable, qosEntry=qosEntry, temperature=temperature, lanportName=lanportName, txPower=txPower, reboot=reboot, broadcastsReceived=broadcastsReceived, catv=catv, statIndex=statIndex, staticDns=staticDns, tftp=tftp, vendorPn=vendorPn, jumb=jumb, fileType=fileType, fileName=fileName, staticIpHostName=staticIpHostName, xg6846=xg6846, rebootEnable=rebootEnable, vendorOui=vendorOui, portIndex=portIndex, adminStatus=adminStatus, lan3=lan3, vlanid=vlanid, vlangroupTable=vlangroupTable, pauseTransmitted=pauseTransmitted, port3=port3, multicastsTransmitted=multicastsTransmitted, lan1=lan1, jumblan4=jumblan4, lan4=lan4, portEntry=portEntry)
