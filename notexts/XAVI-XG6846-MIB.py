...
# Produced by pysmi-1.1.8 at Fri Sep  8 11:10:04 2023
...
TimeTicks, Unsigned32, Counter32, mib_2, MibIdentifier, Integer32, Gauge32, ModuleIdentity, ObjectIdentity, snmpModules, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, IpAddress, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "Counter32", "mib-2", "MibIdentifier", "Integer32", "Gauge32", "ModuleIdentity", "ObjectIdentity", "snmpModules", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "IpAddress", "iso", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portEntry=portEntry, pauseReceived=pauseReceived, vendorOui=vendorOui, serialnum=serialnum, qosIndex=qosIndex, groupEntry=groupEntry, fileType=fileType, speed=speed, vendorName=vendorName, hostname=hostname, portStatEntry=portStatEntry, qosEntry=qosEntry, fcsErrorReceived=fcsErrorReceived, unicastsTransmitted=unicastsTransmitted, operStatus=operStatus, lan4=lan4, xg6846=xg6846, lan3=lan3, rebootEnable=rebootEnable, deviceinfo=deviceinfo, jumblan2=jumblan2, internetPort=internetPort, secondaryDns=secondaryDns, portIndex=portIndex, staticIpPrimaryDns=staticIpPrimaryDns, unicastsReceived=unicastsReceived, pauseTransmitted=pauseTransmitted, qos=qos, vlanid=vlanid, catv=catv, portmode=portmode, lanportspeed=lanportspeed, jumbwan=jumbwan, vlangroupTable=vlangroupTable, qmode=qmode, staticIpSecondaryDns=staticIpSecondaryDns, catvEnable=catvEnable, temperature=temperature, staticIpDomainName=staticIpDomainName, jumblan4=jumblan4, port2=port2, port3=port3, lan2=lan2, bias=bias, broadcastsTransmitted=broadcastsTransmitted, multicastsReceived=multicastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, vendorPn=vendorPn, jumb=jumb, priority=priority, staticIpHostName=staticIpHostName, lan1=lan1, portName=portName, port4=port4, reboot=reboot, groupid=groupid, vendorRev=vendorRev, fileName=fileName, lanportIndex=lanportIndex, tftpSevIp=tftpSevIp, qosTable=qosTable, staticIpSubMask=staticIpSubMask, dscpEnable=dscpEnable, groupIndex=groupIndex, wanType=wanType, tftp=tftp, action=action, qmapping=qmapping, primaryDns=primaryDns, jumblan1=jumblan1, ddminfo=ddminfo, lanportTable=lanportTable, lanportpause=lanportpause, txPower=txPower, jumblan3=jumblan3, portPower=portPower, broadcastsReceived=broadcastsReceived, voltage=voltage, adminStatus=adminStatus, statisticTable=statisticTable, rxPower=rxPower, port1=port1, modeEntry=modeEntry, domainame=domainame, vlan=vlan, portStatistic=portStatistic, multicastsTransmitted=multicastsTransmitted, staticDns=staticDns, portTable=portTable, staticIpGateway=staticIpGateway, wan=wan, statIndex=statIndex, staticIpAddr=staticIpAddr, lanportName=lanportName)
