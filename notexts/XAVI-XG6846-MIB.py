...
# Produced by pysmi-1.1.8 at Tue Jul 26 16:45:24 2022
...
snmpModules, Integer32, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, mib_2, enterprises, iso, Counter64, Gauge32, Unsigned32, ModuleIdentity, MibIdentifier, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "Integer32", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "mib-2", "enterprises", "iso", "Counter64", "Gauge32", "Unsigned32", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan1=lan1, jumblan2=jumblan2, primaryDns=primaryDns, broadcastsTransmitted=broadcastsTransmitted, tftpSevIp=tftpSevIp, fileName=fileName, lanportIndex=lanportIndex, lanportName=lanportName, qmapping=qmapping, unicastsTransmitted=unicastsTransmitted, staticIpSubMask=staticIpSubMask, groupid=groupid, reboot=reboot, jumb=jumb, vendorRev=vendorRev, vlanid=vlanid, wan=wan, catv=catv, portIndex=portIndex, vendorName=vendorName, ddminfo=ddminfo, pauseTransmitted=pauseTransmitted, qos=qos, vlangroupTable=vlangroupTable, broadcastsReceived=broadcastsReceived, adminStatus=adminStatus, statIndex=statIndex, bias=bias, portStatistic=portStatistic, staticIpSecondaryDns=staticIpSecondaryDns, staticIpAddr=staticIpAddr, jumbwan=jumbwan, vendorOui=vendorOui, port3=port3, modeEntry=modeEntry, fcsErrorTransmitted=fcsErrorTransmitted, qosIndex=qosIndex, qmode=qmode, dscpEnable=dscpEnable, multicastsTransmitted=multicastsTransmitted, tftp=tftp, qosTable=qosTable, port2=port2, statisticTable=statisticTable, rebootEnable=rebootEnable, rxPower=rxPower, lanportspeed=lanportspeed, staticIpDomainName=staticIpDomainName, domainame=domainame, speed=speed, pauseReceived=pauseReceived, temperature=temperature, xg6846=xg6846, portName=portName, lan2=lan2, fileType=fileType, port1=port1, vlan=vlan, unicastsReceived=unicastsReceived, staticIpHostName=staticIpHostName, lan3=lan3, jumblan4=jumblan4, portTable=portTable, fcsErrorReceived=fcsErrorReceived, port4=port4, staticDns=staticDns, groupEntry=groupEntry, voltage=voltage, staticIpGateway=staticIpGateway, lanportTable=lanportTable, portStatEntry=portStatEntry, serialnum=serialnum, portmode=portmode, txPower=txPower, jumblan1=jumblan1, portPower=portPower, qosEntry=qosEntry, lanportpause=lanportpause, internetPort=internetPort, secondaryDns=secondaryDns, hostname=hostname, catvEnable=catvEnable, deviceinfo=deviceinfo, portEntry=portEntry, groupIndex=groupIndex, vendorPn=vendorPn, lan4=lan4, wanType=wanType, jumblan3=jumblan3, operStatus=operStatus, action=action, multicastsReceived=multicastsReceived, priority=priority, staticIpPrimaryDns=staticIpPrimaryDns)
