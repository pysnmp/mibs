...
# Produced by pysmi-1.1.3 at Wed Dec  1 15:44:21 2021
...
Unsigned32, Counter32, NotificationType, IpAddress, Gauge32, MibIdentifier, ObjectIdentity, enterprises, Counter64, Integer32, TimeTicks, mib_2, iso, snmpModules, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "NotificationType", "IpAddress", "Gauge32", "MibIdentifier", "ObjectIdentity", "enterprises", "Counter64", "Integer32", "TimeTicks", "mib-2", "iso", "snmpModules", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portEntry=portEntry, port1=port1, staticIpGateway=staticIpGateway, action=action, groupEntry=groupEntry, secondaryDns=secondaryDns, vendorRev=vendorRev, lan2=lan2, ddminfo=ddminfo, bias=bias, portStatistic=portStatistic, staticIpAddr=staticIpAddr, portName=portName, staticIpSecondaryDns=staticIpSecondaryDns, qos=qos, fileType=fileType, port4=port4, staticIpHostName=staticIpHostName, staticIpSubMask=staticIpSubMask, serialnum=serialnum, staticDns=staticDns, multicastsTransmitted=multicastsTransmitted, txPower=txPower, port3=port3, jumblan4=jumblan4, catvEnable=catvEnable, lanportspeed=lanportspeed, temperature=temperature, rxPower=rxPower, rebootEnable=rebootEnable, jumblan2=jumblan2, lanportIndex=lanportIndex, lan3=lan3, internetPort=internetPort, fcsErrorTransmitted=fcsErrorTransmitted, groupIndex=groupIndex, staticIpPrimaryDns=staticIpPrimaryDns, qosIndex=qosIndex, portmode=portmode, qosEntry=qosEntry, qmode=qmode, speed=speed, lanportpause=lanportpause, vlan=vlan, qmapping=qmapping, portTable=portTable, hostname=hostname, vendorPn=vendorPn, modeEntry=modeEntry, tftpSevIp=tftpSevIp, port2=port2, fileName=fileName, vlanid=vlanid, primaryDns=primaryDns, xg6846=xg6846, statIndex=statIndex, vendorOui=vendorOui, portIndex=portIndex, jumbwan=jumbwan, jumblan1=jumblan1, statisticTable=statisticTable, vendorName=vendorName, wanType=wanType, lan1=lan1, jumblan3=jumblan3, pauseReceived=pauseReceived, adminStatus=adminStatus, dscpEnable=dscpEnable, unicastsReceived=unicastsReceived, multicastsReceived=multicastsReceived, catv=catv, portStatEntry=portStatEntry, voltage=voltage, qosTable=qosTable, groupid=groupid, broadcastsReceived=broadcastsReceived, fcsErrorReceived=fcsErrorReceived, deviceinfo=deviceinfo, broadcastsTransmitted=broadcastsTransmitted, wan=wan, tftp=tftp, operStatus=operStatus, portPower=portPower, staticIpDomainName=staticIpDomainName, unicastsTransmitted=unicastsTransmitted, reboot=reboot, jumb=jumb, priority=priority, lan4=lan4, domainame=domainame, lanportName=lanportName, vlangroupTable=vlangroupTable, lanportTable=lanportTable, pauseTransmitted=pauseTransmitted)
