...
NotificationType, enterprises, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, TimeTicks, Integer32, Bits, Counter32, iso, ModuleIdentity, ObjectIdentity, snmpModules, Unsigned32, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "TimeTicks", "Integer32", "Bits", "Counter32", "iso", "ModuleIdentity", "ObjectIdentity", "snmpModules", "Unsigned32", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan4=lan4, xg6846=xg6846, portTable=portTable, voltage=voltage, statisticTable=statisticTable, fileName=fileName, dscpEnable=dscpEnable, broadcastsReceived=broadcastsReceived, fileType=fileType, tftpSevIp=tftpSevIp, vendorPn=vendorPn, jumblan3=jumblan3, wan=wan, operStatus=operStatus, multicastsReceived=multicastsReceived, qosEntry=qosEntry, statIndex=statIndex, groupEntry=groupEntry, portEntry=portEntry, vlanid=vlanid, portIndex=portIndex, primaryDns=primaryDns, lan2=lan2, action=action, wanType=wanType, staticIpAddr=staticIpAddr, priority=priority, staticDns=staticDns, internetPort=internetPort, rxPower=rxPower, portmode=portmode, tftp=tftp, groupid=groupid, fcsErrorReceived=fcsErrorReceived, lanportspeed=lanportspeed, temperature=temperature, jumb=jumb, jumbwan=jumbwan, rebootEnable=rebootEnable, port2=port2, qos=qos, vendorRev=vendorRev, txPower=txPower, broadcastsTransmitted=broadcastsTransmitted, pauseTransmitted=pauseTransmitted, speed=speed, vendorOui=vendorOui, jumblan1=jumblan1, jumblan2=jumblan2, portStatEntry=portStatEntry, bias=bias, fcsErrorTransmitted=fcsErrorTransmitted, staticIpSubMask=staticIpSubMask, serialnum=serialnum, port4=port4, modeEntry=modeEntry, staticIpGateway=staticIpGateway, secondaryDns=secondaryDns, unicastsTransmitted=unicastsTransmitted, portName=portName, hostname=hostname, multicastsTransmitted=multicastsTransmitted, portStatistic=portStatistic, jumblan4=jumblan4, catvEnable=catvEnable, lan3=lan3, port1=port1, domainame=domainame, vendorName=vendorName, staticIpSecondaryDns=staticIpSecondaryDns, staticIpDomainName=staticIpDomainName, vlangroupTable=vlangroupTable, qosIndex=qosIndex, adminStatus=adminStatus, portPower=portPower, qosTable=qosTable, vlan=vlan, lanportName=lanportName, groupIndex=groupIndex, unicastsReceived=unicastsReceived, reboot=reboot, pauseReceived=pauseReceived, ddminfo=ddminfo, lanportpause=lanportpause, lanportIndex=lanportIndex, lan1=lan1, qmode=qmode, qmapping=qmapping, deviceinfo=deviceinfo, port3=port3, staticIpHostName=staticIpHostName, catv=catv, staticIpPrimaryDns=staticIpPrimaryDns, lanportTable=lanportTable)
