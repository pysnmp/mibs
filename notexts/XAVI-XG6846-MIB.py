...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:05:24 2021
...
iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, NotificationType, Bits, Counter64, enterprises, ObjectIdentity, Unsigned32, Gauge32, Counter32, Integer32, mib_2, snmpModules, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "NotificationType", "Bits", "Counter64", "enterprises", "ObjectIdentity", "Unsigned32", "Gauge32", "Counter32", "Integer32", "mib-2", "snmpModules", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupIndex=groupIndex, speed=speed, portStatEntry=portStatEntry, statisticTable=statisticTable, wan=wan, groupid=groupid, staticIpSecondaryDns=staticIpSecondaryDns, lanportpause=lanportpause, vendorRev=vendorRev, rxPower=rxPower, voltage=voltage, broadcastsReceived=broadcastsReceived, qmode=qmode, jumblan3=jumblan3, lan2=lan2, vendorPn=vendorPn, dscpEnable=dscpEnable, lanportspeed=lanportspeed, staticIpPrimaryDns=staticIpPrimaryDns, unicastsReceived=unicastsReceived, hostname=hostname, fcsErrorReceived=fcsErrorReceived, portEntry=portEntry, deviceinfo=deviceinfo, port4=port4, domainame=domainame, portmode=portmode, portTable=portTable, lanportName=lanportName, internetPort=internetPort, rebootEnable=rebootEnable, staticIpAddr=staticIpAddr, staticIpSubMask=staticIpSubMask, staticDns=staticDns, bias=bias, lan1=lan1, primaryDns=primaryDns, groupEntry=groupEntry, staticIpGateway=staticIpGateway, lanportIndex=lanportIndex, fileName=fileName, port3=port3, jumbwan=jumbwan, lanportTable=lanportTable, qosEntry=qosEntry, jumblan1=jumblan1, portStatistic=portStatistic, adminStatus=adminStatus, xg6846=xg6846, modeEntry=modeEntry, qmapping=qmapping, reboot=reboot, qos=qos, priority=priority, multicastsTransmitted=multicastsTransmitted, port1=port1, multicastsReceived=multicastsReceived, tftp=tftp, unicastsTransmitted=unicastsTransmitted, jumb=jumb, broadcastsTransmitted=broadcastsTransmitted, port2=port2, txPower=txPower, statIndex=statIndex, temperature=temperature, portPower=portPower, portIndex=portIndex, qosTable=qosTable, portName=portName, vendorName=vendorName, catv=catv, staticIpDomainName=staticIpDomainName, lan3=lan3, staticIpHostName=staticIpHostName, pauseTransmitted=pauseTransmitted, serialnum=serialnum, pauseReceived=pauseReceived, operStatus=operStatus, tftpSevIp=tftpSevIp, jumblan4=jumblan4, lan4=lan4, qosIndex=qosIndex, jumblan2=jumblan2, vlangroupTable=vlangroupTable, catvEnable=catvEnable, fileType=fileType, fcsErrorTransmitted=fcsErrorTransmitted, ddminfo=ddminfo, vendorOui=vendorOui, wanType=wanType, secondaryDns=secondaryDns, vlanid=vlanid, vlan=vlan, action=action)
