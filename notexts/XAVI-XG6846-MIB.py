...
# Produced by pysmi-1.1.8 at Thu Jan  6 20:20:31 2022
...
mib_2, enterprises, iso, Bits, ObjectIdentity, Counter64, NotificationType, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, Unsigned32, Gauge32, snmpModules, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "enterprises", "iso", "Bits", "ObjectIdentity", "Counter64", "NotificationType", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "Unsigned32", "Gauge32", "snmpModules", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportspeed=lanportspeed, vendorOui=vendorOui, portEntry=portEntry, dscpEnable=dscpEnable, groupEntry=groupEntry, portStatistic=portStatistic, lan1=lan1, vendorPn=vendorPn, txPower=txPower, port4=port4, multicastsReceived=multicastsReceived, tftp=tftp, staticIpAddr=staticIpAddr, domainame=domainame, catv=catv, hostname=hostname, lanportTable=lanportTable, staticIpSubMask=staticIpSubMask, temperature=temperature, groupid=groupid, qosIndex=qosIndex, statisticTable=statisticTable, portmode=portmode, vlangroupTable=vlangroupTable, port1=port1, fileType=fileType, vendorName=vendorName, voltage=voltage, vlanid=vlanid, jumbwan=jumbwan, lanportIndex=lanportIndex, broadcastsTransmitted=broadcastsTransmitted, ddminfo=ddminfo, portPower=portPower, pauseReceived=pauseReceived, deviceinfo=deviceinfo, xg6846=xg6846, portIndex=portIndex, wanType=wanType, jumblan1=jumblan1, pauseTransmitted=pauseTransmitted, rebootEnable=rebootEnable, operStatus=operStatus, portName=portName, broadcastsReceived=broadcastsReceived, wan=wan, fcsErrorTransmitted=fcsErrorTransmitted, reboot=reboot, fileName=fileName, fcsErrorReceived=fcsErrorReceived, lan2=lan2, statIndex=statIndex, staticIpPrimaryDns=staticIpPrimaryDns, qos=qos, jumb=jumb, serialnum=serialnum, vlan=vlan, lan4=lan4, priority=priority, port2=port2, staticDns=staticDns, qmapping=qmapping, unicastsTransmitted=unicastsTransmitted, tftpSevIp=tftpSevIp, qosTable=qosTable, adminStatus=adminStatus, unicastsReceived=unicastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, portTable=portTable, modeEntry=modeEntry, catvEnable=catvEnable, lan3=lan3, staticIpHostName=staticIpHostName, qmode=qmode, secondaryDns=secondaryDns, multicastsTransmitted=multicastsTransmitted, port3=port3, lanportName=lanportName, rxPower=rxPower, portStatEntry=portStatEntry, groupIndex=groupIndex, primaryDns=primaryDns, lanportpause=lanportpause, staticIpGateway=staticIpGateway, action=action, internetPort=internetPort, qosEntry=qosEntry, vendorRev=vendorRev, staticIpDomainName=staticIpDomainName, speed=speed, jumblan4=jumblan4, jumblan2=jumblan2, bias=bias, jumblan3=jumblan3)
