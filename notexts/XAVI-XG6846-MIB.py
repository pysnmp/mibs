...
NotificationType, iso, TimeTicks, snmpModules, mib_2, enterprises, IpAddress, MibIdentifier, ObjectIdentity, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, ModuleIdentity, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "TimeTicks", "snmpModules", "mib-2", "enterprises", "IpAddress", "MibIdentifier", "ObjectIdentity", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "ModuleIdentity", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", dscpEnable=dscpEnable, lanportName=lanportName, modeEntry=modeEntry, portmode=portmode, vendorName=vendorName, jumblan4=jumblan4, lan2=lan2, lanportspeed=lanportspeed, hostname=hostname, qosIndex=qosIndex, port2=port2, ddminfo=ddminfo, staticIpPrimaryDns=staticIpPrimaryDns, portStatEntry=portStatEntry, broadcastsReceived=broadcastsReceived, statisticTable=statisticTable, portEntry=portEntry, portTable=portTable, qosTable=qosTable, vendorPn=vendorPn, qos=qos, wan=wan, port3=port3, temperature=temperature, staticIpSecondaryDns=staticIpSecondaryDns, staticIpDomainName=staticIpDomainName, staticIpGateway=staticIpGateway, jumblan3=jumblan3, lan1=lan1, serialnum=serialnum, xg6846=xg6846, fileName=fileName, rxPower=rxPower, vendorOui=vendorOui, tftp=tftp, portStatistic=portStatistic, vendorRev=vendorRev, jumbwan=jumbwan, operStatus=operStatus, catvEnable=catvEnable, rebootEnable=rebootEnable, port4=port4, primaryDns=primaryDns, lan4=lan4, bias=bias, statIndex=statIndex, lan3=lan3, multicastsTransmitted=multicastsTransmitted, jumblan2=jumblan2, qosEntry=qosEntry, vlanid=vlanid, qmapping=qmapping, wanType=wanType, txPower=txPower, secondaryDns=secondaryDns, vlan=vlan, pauseTransmitted=pauseTransmitted, unicastsReceived=unicastsReceived, domainame=domainame, groupIndex=groupIndex, catv=catv, action=action, groupEntry=groupEntry, deviceinfo=deviceinfo, port1=port1, adminStatus=adminStatus, lanportpause=lanportpause, portPower=portPower, priority=priority, multicastsReceived=multicastsReceived, staticIpSubMask=staticIpSubMask, lanportTable=lanportTable, portIndex=portIndex, pauseReceived=pauseReceived, fcsErrorReceived=fcsErrorReceived, fcsErrorTransmitted=fcsErrorTransmitted, lanportIndex=lanportIndex, staticIpAddr=staticIpAddr, jumblan1=jumblan1, tftpSevIp=tftpSevIp, speed=speed, portName=portName, unicastsTransmitted=unicastsTransmitted, vlangroupTable=vlangroupTable, fileType=fileType, reboot=reboot, qmode=qmode, broadcastsTransmitted=broadcastsTransmitted, jumb=jumb, voltage=voltage, staticDns=staticDns, staticIpHostName=staticIpHostName, groupid=groupid, internetPort=internetPort)
