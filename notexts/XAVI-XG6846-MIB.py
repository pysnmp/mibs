...
# Produced by pysmi-1.1.8 at Thu Jan 13 23:55:42 2022
...
TimeTicks, Unsigned32, snmpModules, mib_2, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso, Counter32, Bits, NotificationType, MibIdentifier, Counter64, enterprises, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "snmpModules", "mib-2", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso", "Counter32", "Bits", "NotificationType", "MibIdentifier", "Counter64", "enterprises", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", deviceinfo=deviceinfo, staticIpHostName=staticIpHostName, serialnum=serialnum, modeEntry=modeEntry, qosEntry=qosEntry, unicastsTransmitted=unicastsTransmitted, broadcastsTransmitted=broadcastsTransmitted, broadcastsReceived=broadcastsReceived, action=action, bias=bias, fileType=fileType, lanportName=lanportName, fileName=fileName, lan2=lan2, staticIpPrimaryDns=staticIpPrimaryDns, fcsErrorTransmitted=fcsErrorTransmitted, adminStatus=adminStatus, staticIpGateway=staticIpGateway, qmapping=qmapping, lan3=lan3, port2=port2, wan=wan, dscpEnable=dscpEnable, pauseReceived=pauseReceived, vendorPn=vendorPn, staticIpDomainName=staticIpDomainName, primaryDns=primaryDns, groupid=groupid, vlanid=vlanid, temperature=temperature, staticDns=staticDns, portStatistic=portStatistic, internetPort=internetPort, groupEntry=groupEntry, unicastsReceived=unicastsReceived, portEntry=portEntry, jumblan4=jumblan4, vendorRev=vendorRev, portIndex=portIndex, vlangroupTable=vlangroupTable, jumbwan=jumbwan, vendorOui=vendorOui, lanportTable=lanportTable, multicastsTransmitted=multicastsTransmitted, wanType=wanType, lanportpause=lanportpause, domainame=domainame, qmode=qmode, tftpSevIp=tftpSevIp, lanportspeed=lanportspeed, pauseTransmitted=pauseTransmitted, fcsErrorReceived=fcsErrorReceived, staticIpAddr=staticIpAddr, ddminfo=ddminfo, lan1=lan1, portPower=portPower, priority=priority, qosTable=qosTable, port4=port4, secondaryDns=secondaryDns, lanportIndex=lanportIndex, jumblan1=jumblan1, qosIndex=qosIndex, port3=port3, voltage=voltage, rebootEnable=rebootEnable, rxPower=rxPower, txPower=txPower, operStatus=operStatus, statisticTable=statisticTable, portmode=portmode, jumb=jumb, staticIpSecondaryDns=staticIpSecondaryDns, xg6846=xg6846, jumblan2=jumblan2, statIndex=statIndex, portName=portName, lan4=lan4, staticIpSubMask=staticIpSubMask, tftp=tftp, catvEnable=catvEnable, catv=catv, port1=port1, multicastsReceived=multicastsReceived, groupIndex=groupIndex, jumblan3=jumblan3, reboot=reboot, qos=qos, speed=speed, portTable=portTable, vendorName=vendorName, portStatEntry=portStatEntry, vlan=vlan, hostname=hostname)
