...
# Produced by pysmi-1.1.8 at Tue Aug  9 16:11:15 2022
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, Counter32, ObjectIdentity, Bits, Counter64, IpAddress, snmpModules, enterprises, mib_2, Unsigned32, ModuleIdentity, Integer32, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "Counter32", "ObjectIdentity", "Bits", "Counter64", "IpAddress", "snmpModules", "enterprises", "mib-2", "Unsigned32", "ModuleIdentity", "Integer32", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpDomainName=staticIpDomainName, lanportName=lanportName, fcsErrorTransmitted=fcsErrorTransmitted, broadcastsTransmitted=broadcastsTransmitted, lanportspeed=lanportspeed, multicastsReceived=multicastsReceived, statisticTable=statisticTable, hostname=hostname, jumb=jumb, qmapping=qmapping, qosEntry=qosEntry, fcsErrorReceived=fcsErrorReceived, staticIpSecondaryDns=staticIpSecondaryDns, qmode=qmode, groupIndex=groupIndex, wan=wan, internetPort=internetPort, rebootEnable=rebootEnable, action=action, bias=bias, unicastsTransmitted=unicastsTransmitted, vendorName=vendorName, txPower=txPower, catvEnable=catvEnable, jumblan4=jumblan4, groupid=groupid, wanType=wanType, portmode=portmode, portStatEntry=portStatEntry, statIndex=statIndex, port1=port1, staticIpHostName=staticIpHostName, temperature=temperature, multicastsTransmitted=multicastsTransmitted, dscpEnable=dscpEnable, jumblan1=jumblan1, reboot=reboot, portEntry=portEntry, staticIpAddr=staticIpAddr, speed=speed, qosIndex=qosIndex, fileType=fileType, voltage=voltage, rxPower=rxPower, fileName=fileName, modeEntry=modeEntry, xg6846=xg6846, port2=port2, qosTable=qosTable, qos=qos, groupEntry=groupEntry, broadcastsReceived=broadcastsReceived, lan1=lan1, serialnum=serialnum, vlangroupTable=vlangroupTable, tftp=tftp, ddminfo=ddminfo, primaryDns=primaryDns, portStatistic=portStatistic, jumblan2=jumblan2, lan2=lan2, priority=priority, unicastsReceived=unicastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, vendorOui=vendorOui, port3=port3, staticIpSubMask=staticIpSubMask, lanportpause=lanportpause, deviceinfo=deviceinfo, vlan=vlan, lan4=lan4, port4=port4, portPower=portPower, jumblan3=jumblan3, vendorPn=vendorPn, tftpSevIp=tftpSevIp, lan3=lan3, vlanid=vlanid, secondaryDns=secondaryDns, vendorRev=vendorRev, jumbwan=jumbwan, staticDns=staticDns, pauseTransmitted=pauseTransmitted, operStatus=operStatus, portIndex=portIndex, domainame=domainame, pauseReceived=pauseReceived, portName=portName, catv=catv, lanportIndex=lanportIndex, lanportTable=lanportTable, portTable=portTable, adminStatus=adminStatus, staticIpGateway=staticIpGateway)
