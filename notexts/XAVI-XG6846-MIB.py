...
# Produced by pysmi-1.1.8 at Mon Feb  7 16:17:11 2022
...
Unsigned32, ModuleIdentity, ObjectIdentity, NotificationType, TimeTicks, Bits, mib_2, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, Integer32, iso, Counter64, snmpModules, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "NotificationType", "TimeTicks", "Bits", "mib-2", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "Integer32", "iso", "Counter64", "snmpModules", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", dscpEnable=dscpEnable, lanportIndex=lanportIndex, qosIndex=qosIndex, deviceinfo=deviceinfo, groupid=groupid, fileType=fileType, adminStatus=adminStatus, port1=port1, action=action, fileName=fileName, wanType=wanType, tftp=tftp, portmode=portmode, port2=port2, jumbwan=jumbwan, pauseReceived=pauseReceived, statIndex=statIndex, staticIpHostName=staticIpHostName, staticIpSecondaryDns=staticIpSecondaryDns, portTable=portTable, temperature=temperature, jumb=jumb, domainame=domainame, jumblan3=jumblan3, lan4=lan4, lanportTable=lanportTable, vlanid=vlanid, catv=catv, lan2=lan2, modeEntry=modeEntry, primaryDns=primaryDns, multicastsTransmitted=multicastsTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, broadcastsReceived=broadcastsReceived, vendorName=vendorName, vlangroupTable=vlangroupTable, internetPort=internetPort, priority=priority, portStatEntry=portStatEntry, jumblan2=jumblan2, staticIpSubMask=staticIpSubMask, rebootEnable=rebootEnable, groupEntry=groupEntry, vendorRev=vendorRev, portStatistic=portStatistic, tftpSevIp=tftpSevIp, staticDns=staticDns, statisticTable=statisticTable, speed=speed, staticIpGateway=staticIpGateway, operStatus=operStatus, lan3=lan3, unicastsReceived=unicastsReceived, serialnum=serialnum, groupIndex=groupIndex, port4=port4, broadcastsTransmitted=broadcastsTransmitted, lan1=lan1, lanportspeed=lanportspeed, qmapping=qmapping, secondaryDns=secondaryDns, portEntry=portEntry, fcsErrorReceived=fcsErrorReceived, jumblan4=jumblan4, qmode=qmode, port3=port3, rxPower=rxPower, vendorOui=vendorOui, jumblan1=jumblan1, wan=wan, qos=qos, lanportName=lanportName, voltage=voltage, ddminfo=ddminfo, qosTable=qosTable, pauseTransmitted=pauseTransmitted, catvEnable=catvEnable, hostname=hostname, portIndex=portIndex, unicastsTransmitted=unicastsTransmitted, xg6846=xg6846, bias=bias, lanportpause=lanportpause, qosEntry=qosEntry, staticIpDomainName=staticIpDomainName, txPower=txPower, staticIpAddr=staticIpAddr, vlan=vlan, multicastsReceived=multicastsReceived, vendorPn=vendorPn, portPower=portPower, reboot=reboot, portName=portName, fcsErrorTransmitted=fcsErrorTransmitted)
