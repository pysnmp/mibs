...
Counter64, IpAddress, TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, mib_2, iso, enterprises, ObjectIdentity, Unsigned32, snmpModules, NotificationType, Counter32, ModuleIdentity, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "mib-2", "iso", "enterprises", "ObjectIdentity", "Unsigned32", "snmpModules", "NotificationType", "Counter32", "ModuleIdentity", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpHostName=staticIpHostName, catvEnable=catvEnable, operStatus=operStatus, staticDns=staticDns, jumblan4=jumblan4, staticIpAddr=staticIpAddr, groupIndex=groupIndex, port3=port3, vendorName=vendorName, speed=speed, lan4=lan4, multicastsTransmitted=multicastsTransmitted, staticIpGateway=staticIpGateway, qosTable=qosTable, portPower=portPower, wan=wan, rxPower=rxPower, catv=catv, jumblan3=jumblan3, vendorRev=vendorRev, dscpEnable=dscpEnable, hostname=hostname, lanportpause=lanportpause, port4=port4, groupEntry=groupEntry, voltage=voltage, staticIpSubMask=staticIpSubMask, vlangroupTable=vlangroupTable, priority=priority, action=action, unicastsReceived=unicastsReceived, rebootEnable=rebootEnable, jumblan1=jumblan1, primaryDns=primaryDns, staticIpDomainName=staticIpDomainName, broadcastsReceived=broadcastsReceived, lanportTable=lanportTable, tftp=tftp, multicastsReceived=multicastsReceived, serialnum=serialnum, txPower=txPower, qmode=qmode, wanType=wanType, staticIpSecondaryDns=staticIpSecondaryDns, lan3=lan3, fileType=fileType, vendorPn=vendorPn, qosIndex=qosIndex, tftpSevIp=tftpSevIp, fileName=fileName, lan2=lan2, ddminfo=ddminfo, modeEntry=modeEntry, broadcastsTransmitted=broadcastsTransmitted, vendorOui=vendorOui, reboot=reboot, lanportIndex=lanportIndex, portName=portName, qmapping=qmapping, portStatEntry=portStatEntry, jumb=jumb, secondaryDns=secondaryDns, bias=bias, staticIpPrimaryDns=staticIpPrimaryDns, port1=port1, fcsErrorReceived=fcsErrorReceived, lanportName=lanportName, deviceinfo=deviceinfo, statIndex=statIndex, portmode=portmode, groupid=groupid, portEntry=portEntry, port2=port2, vlan=vlan, fcsErrorTransmitted=fcsErrorTransmitted, portIndex=portIndex, lan1=lan1, portStatistic=portStatistic, jumbwan=jumbwan, adminStatus=adminStatus, pauseTransmitted=pauseTransmitted, unicastsTransmitted=unicastsTransmitted, pauseReceived=pauseReceived, qosEntry=qosEntry, lanportspeed=lanportspeed, domainame=domainame, internetPort=internetPort, qos=qos, temperature=temperature, jumblan2=jumblan2, xg6846=xg6846, portTable=portTable, vlanid=vlanid, statisticTable=statisticTable)
