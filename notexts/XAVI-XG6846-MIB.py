...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, snmpModules, TimeTicks, Counter32, MibIdentifier, Bits, Unsigned32, ObjectIdentity, iso, ModuleIdentity, NotificationType, Counter64, mib_2, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "snmpModules", "TimeTicks", "Counter32", "MibIdentifier", "Bits", "Unsigned32", "ObjectIdentity", "iso", "ModuleIdentity", "NotificationType", "Counter64", "mib-2", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", xg6846=xg6846, lanportpause=lanportpause, staticIpGateway=staticIpGateway, portStatEntry=portStatEntry, port1=port1, portTable=portTable, lanportIndex=lanportIndex, staticIpPrimaryDns=staticIpPrimaryDns, lan4=lan4, tftp=tftp, rebootEnable=rebootEnable, pauseTransmitted=pauseTransmitted, vendorPn=vendorPn, qmode=qmode, lan3=lan3, fileName=fileName, fileType=fileType, qosEntry=qosEntry, port4=port4, wanType=wanType, jumblan2=jumblan2, hostname=hostname, dscpEnable=dscpEnable, lanportspeed=lanportspeed, qosIndex=qosIndex, portStatistic=portStatistic, ddminfo=ddminfo, fcsErrorReceived=fcsErrorReceived, priority=priority, staticIpDomainName=staticIpDomainName, action=action, broadcastsTransmitted=broadcastsTransmitted, operStatus=operStatus, portName=portName, speed=speed, statisticTable=statisticTable, portmode=portmode, statIndex=statIndex, pauseReceived=pauseReceived, fcsErrorTransmitted=fcsErrorTransmitted, jumbwan=jumbwan, lan1=lan1, txPower=txPower, deviceinfo=deviceinfo, catv=catv, port3=port3, portEntry=portEntry, lan2=lan2, domainame=domainame, vendorRev=vendorRev, lanportTable=lanportTable, reboot=reboot, qos=qos, jumb=jumb, vlangroupTable=vlangroupTable, staticIpSubMask=staticIpSubMask, temperature=temperature, staticDns=staticDns, catvEnable=catvEnable, modeEntry=modeEntry, vendorName=vendorName, staticIpHostName=staticIpHostName, groupEntry=groupEntry, staticIpAddr=staticIpAddr, unicastsReceived=unicastsReceived, portIndex=portIndex, portPower=portPower, rxPower=rxPower, broadcastsReceived=broadcastsReceived, qosTable=qosTable, tftpSevIp=tftpSevIp, vendorOui=vendorOui, serialnum=serialnum, jumblan3=jumblan3, multicastsReceived=multicastsReceived, port2=port2, jumblan4=jumblan4, voltage=voltage, secondaryDns=secondaryDns, vlanid=vlanid, staticIpSecondaryDns=staticIpSecondaryDns, vlan=vlan, unicastsTransmitted=unicastsTransmitted, wan=wan, qmapping=qmapping, bias=bias, multicastsTransmitted=multicastsTransmitted, groupIndex=groupIndex, primaryDns=primaryDns, internetPort=internetPort, adminStatus=adminStatus, lanportName=lanportName, jumblan1=jumblan1, groupid=groupid)
