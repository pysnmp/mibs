...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, enterprises, Bits, snmpModules, IpAddress, NotificationType, iso, ObjectIdentity, MibIdentifier, Gauge32, Unsigned32, mib_2, Counter64, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "enterprises", "Bits", "snmpModules", "IpAddress", "NotificationType", "iso", "ObjectIdentity", "MibIdentifier", "Gauge32", "Unsigned32", "mib-2", "Counter64", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qmode=qmode, multicastsTransmitted=multicastsTransmitted, port1=port1, vendorRev=vendorRev, fileType=fileType, jumblan2=jumblan2, statisticTable=statisticTable, lanportspeed=lanportspeed, lan4=lan4, unicastsTransmitted=unicastsTransmitted, staticIpSubMask=staticIpSubMask, staticIpPrimaryDns=staticIpPrimaryDns, serialnum=serialnum, jumbwan=jumbwan, bias=bias, catv=catv, portName=portName, qosTable=qosTable, vendorOui=vendorOui, portTable=portTable, lan1=lan1, rxPower=rxPower, portPower=portPower, vendorName=vendorName, fileName=fileName, lan2=lan2, qosEntry=qosEntry, statIndex=statIndex, modeEntry=modeEntry, broadcastsTransmitted=broadcastsTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, port2=port2, portStatEntry=portStatEntry, portStatistic=portStatistic, lanportName=lanportName, fcsErrorTransmitted=fcsErrorTransmitted, fcsErrorReceived=fcsErrorReceived, rebootEnable=rebootEnable, jumblan1=jumblan1, staticIpHostName=staticIpHostName, speed=speed, staticIpDomainName=staticIpDomainName, vlan=vlan, jumblan3=jumblan3, adminStatus=adminStatus, ddminfo=ddminfo, priority=priority, port4=port4, qos=qos, primaryDns=primaryDns, pauseReceived=pauseReceived, lan3=lan3, jumb=jumb, port3=port3, deviceinfo=deviceinfo, domainame=domainame, tftpSevIp=tftpSevIp, jumblan4=jumblan4, hostname=hostname, action=action, xg6846=xg6846, staticIpAddr=staticIpAddr, secondaryDns=secondaryDns, broadcastsReceived=broadcastsReceived, portmode=portmode, portEntry=portEntry, groupEntry=groupEntry, staticIpGateway=staticIpGateway, dscpEnable=dscpEnable, lanportpause=lanportpause, qosIndex=qosIndex, qmapping=qmapping, pauseTransmitted=pauseTransmitted, wanType=wanType, portIndex=portIndex, vendorPn=vendorPn, operStatus=operStatus, catvEnable=catvEnable, reboot=reboot, lanportIndex=lanportIndex, tftp=tftp, lanportTable=lanportTable, txPower=txPower, unicastsReceived=unicastsReceived, vlangroupTable=vlangroupTable, internetPort=internetPort, multicastsReceived=multicastsReceived, temperature=temperature, voltage=voltage, groupIndex=groupIndex, groupid=groupid, wan=wan, staticDns=staticDns, vlanid=vlanid)
