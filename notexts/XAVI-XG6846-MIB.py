...
Bits, snmpModules, Unsigned32, IpAddress, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, mib_2, Integer32, Counter64, MibIdentifier, TimeTicks, enterprises, Gauge32, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "snmpModules", "Unsigned32", "IpAddress", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "mib-2", "Integer32", "Counter64", "MibIdentifier", "TimeTicks", "enterprises", "Gauge32", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorPn=vendorPn, groupIndex=groupIndex, bias=bias, tftp=tftp, lan2=lan2, jumblan3=jumblan3, unicastsTransmitted=unicastsTransmitted, jumbwan=jumbwan, vendorRev=vendorRev, modeEntry=modeEntry, ddminfo=ddminfo, portStatistic=portStatistic, lanportIndex=lanportIndex, multicastsTransmitted=multicastsTransmitted, fileType=fileType, catvEnable=catvEnable, statIndex=statIndex, wanType=wanType, domainame=domainame, operStatus=operStatus, lanportspeed=lanportspeed, vlan=vlan, port4=port4, reboot=reboot, portStatEntry=portStatEntry, qosIndex=qosIndex, unicastsReceived=unicastsReceived, staticIpAddr=staticIpAddr, speed=speed, pauseTransmitted=pauseTransmitted, qos=qos, staticDns=staticDns, txPower=txPower, lanportpause=lanportpause, portName=portName, vlangroupTable=vlangroupTable, broadcastsTransmitted=broadcastsTransmitted, adminStatus=adminStatus, port2=port2, groupid=groupid, vendorOui=vendorOui, vlanid=vlanid, staticIpSubMask=staticIpSubMask, staticIpGateway=staticIpGateway, catv=catv, hostname=hostname, jumblan2=jumblan2, portEntry=portEntry, lan3=lan3, action=action, internetPort=internetPort, port3=port3, lan1=lan1, wan=wan, broadcastsReceived=broadcastsReceived, portmode=portmode, qosTable=qosTable, multicastsReceived=multicastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, portTable=portTable, vendorName=vendorName, pauseReceived=pauseReceived, portPower=portPower, staticIpDomainName=staticIpDomainName, staticIpHostName=staticIpHostName, lanportName=lanportName, lanportTable=lanportTable, rxPower=rxPower, statisticTable=statisticTable, port1=port1, jumblan4=jumblan4, jumblan1=jumblan1, qmode=qmode, priority=priority, dscpEnable=dscpEnable, qosEntry=qosEntry, serialnum=serialnum, jumb=jumb, groupEntry=groupEntry, qmapping=qmapping, lan4=lan4, voltage=voltage, deviceinfo=deviceinfo, primaryDns=primaryDns, secondaryDns=secondaryDns, fileName=fileName, portIndex=portIndex, fcsErrorTransmitted=fcsErrorTransmitted, rebootEnable=rebootEnable, fcsErrorReceived=fcsErrorReceived, temperature=temperature, staticIpPrimaryDns=staticIpPrimaryDns, tftpSevIp=tftpSevIp, xg6846=xg6846)
