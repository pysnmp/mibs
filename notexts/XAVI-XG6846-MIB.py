...
# Produced by pysmi-1.1.8 at Thu Jan  6 19:39:23 2022
...
snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, ModuleIdentity, mib_2, Unsigned32, enterprises, IpAddress, Gauge32, MibIdentifier, TimeTicks, Integer32, Counter64, NotificationType, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "ModuleIdentity", "mib-2", "Unsigned32", "enterprises", "IpAddress", "Gauge32", "MibIdentifier", "TimeTicks", "Integer32", "Counter64", "NotificationType", "iso", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpGateway=staticIpGateway, groupid=groupid, action=action, portEntry=portEntry, ddminfo=ddminfo, voltage=voltage, lan2=lan2, vlanid=vlanid, vendorPn=vendorPn, port2=port2, lanportIndex=lanportIndex, groupEntry=groupEntry, bias=bias, staticDns=staticDns, jumblan2=jumblan2, lanportspeed=lanportspeed, wan=wan, multicastsReceived=multicastsReceived, port4=port4, catv=catv, operStatus=operStatus, primaryDns=primaryDns, catvEnable=catvEnable, temperature=temperature, pauseTransmitted=pauseTransmitted, staticIpAddr=staticIpAddr, qos=qos, speed=speed, multicastsTransmitted=multicastsTransmitted, lanportpause=lanportpause, staticIpSecondaryDns=staticIpSecondaryDns, qosEntry=qosEntry, jumbwan=jumbwan, serialnum=serialnum, portmode=portmode, lanportName=lanportName, fileType=fileType, broadcastsReceived=broadcastsReceived, portTable=portTable, jumblan4=jumblan4, lan1=lan1, qmapping=qmapping, lan3=lan3, qosTable=qosTable, lanportTable=lanportTable, lan4=lan4, hostname=hostname, priority=priority, vlangroupTable=vlangroupTable, pauseReceived=pauseReceived, tftp=tftp, jumblan1=jumblan1, wanType=wanType, unicastsReceived=unicastsReceived, staticIpSubMask=staticIpSubMask, staticIpPrimaryDns=staticIpPrimaryDns, reboot=reboot, xg6846=xg6846, txPower=txPower, groupIndex=groupIndex, staticIpHostName=staticIpHostName, qmode=qmode, deviceinfo=deviceinfo, dscpEnable=dscpEnable, jumblan3=jumblan3, internetPort=internetPort, jumb=jumb, adminStatus=adminStatus, vendorRev=vendorRev, fcsErrorReceived=fcsErrorReceived, port1=port1, unicastsTransmitted=unicastsTransmitted, port3=port3, vendorOui=vendorOui, portName=portName, broadcastsTransmitted=broadcastsTransmitted, qosIndex=qosIndex, vendorName=vendorName, staticIpDomainName=staticIpDomainName, tftpSevIp=tftpSevIp, portPower=portPower, vlan=vlan, portStatEntry=portStatEntry, statisticTable=statisticTable, domainame=domainame, statIndex=statIndex, portIndex=portIndex, secondaryDns=secondaryDns, fcsErrorTransmitted=fcsErrorTransmitted, modeEntry=modeEntry, fileName=fileName, portStatistic=portStatistic, rebootEnable=rebootEnable, rxPower=rxPower)
