...
TimeTicks, iso, ModuleIdentity, NotificationType, enterprises, Unsigned32, IpAddress, Integer32, Counter64, Gauge32, Counter32, snmpModules, MibIdentifier, mib_2, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "ModuleIdentity", "NotificationType", "enterprises", "Unsigned32", "IpAddress", "Integer32", "Counter64", "Gauge32", "Counter32", "snmpModules", "MibIdentifier", "mib-2", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", speed=speed, vendorName=vendorName, tftp=tftp, operStatus=operStatus, portIndex=portIndex, statIndex=statIndex, multicastsTransmitted=multicastsTransmitted, modeEntry=modeEntry, portTable=portTable, secondaryDns=secondaryDns, groupIndex=groupIndex, staticIpSecondaryDns=staticIpSecondaryDns, multicastsReceived=multicastsReceived, statisticTable=statisticTable, catv=catv, jumblan4=jumblan4, domainame=domainame, portmode=portmode, bias=bias, fileType=fileType, pauseTransmitted=pauseTransmitted, qos=qos, voltage=voltage, qosEntry=qosEntry, qmode=qmode, staticIpHostName=staticIpHostName, qosTable=qosTable, wanType=wanType, deviceinfo=deviceinfo, lan3=lan3, fileName=fileName, wan=wan, jumblan3=jumblan3, fcsErrorReceived=fcsErrorReceived, jumb=jumb, vlangroupTable=vlangroupTable, vlan=vlan, portName=portName, vlanid=vlanid, serialnum=serialnum, groupid=groupid, port2=port2, vendorOui=vendorOui, portPower=portPower, port4=port4, qosIndex=qosIndex, port1=port1, jumblan2=jumblan2, lan1=lan1, dscpEnable=dscpEnable, qmapping=qmapping, broadcastsTransmitted=broadcastsTransmitted, pauseReceived=pauseReceived, staticIpDomainName=staticIpDomainName, lan4=lan4, port3=port3, lanportpause=lanportpause, unicastsTransmitted=unicastsTransmitted, ddminfo=ddminfo, lan2=lan2, portEntry=portEntry, priority=priority, fcsErrorTransmitted=fcsErrorTransmitted, portStatistic=portStatistic, temperature=temperature, staticIpAddr=staticIpAddr, jumblan1=jumblan1, reboot=reboot, tftpSevIp=tftpSevIp, xg6846=xg6846, unicastsReceived=unicastsReceived, primaryDns=primaryDns, lanportName=lanportName, staticDns=staticDns, lanportspeed=lanportspeed, staticIpSubMask=staticIpSubMask, staticIpGateway=staticIpGateway, groupEntry=groupEntry, portStatEntry=portStatEntry, action=action, vendorRev=vendorRev, rebootEnable=rebootEnable, jumbwan=jumbwan, catvEnable=catvEnable, internetPort=internetPort, adminStatus=adminStatus, txPower=txPower, hostname=hostname, lanportIndex=lanportIndex, lanportTable=lanportTable, broadcastsReceived=broadcastsReceived, vendorPn=vendorPn, staticIpPrimaryDns=staticIpPrimaryDns, rxPower=rxPower)
