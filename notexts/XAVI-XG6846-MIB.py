...
Bits, Unsigned32, mib_2, Counter64, TimeTicks, snmpModules, enterprises, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, Gauge32, ModuleIdentity, MibIdentifier, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "mib-2", "Counter64", "TimeTicks", "snmpModules", "enterprises", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "Gauge32", "ModuleIdentity", "MibIdentifier", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vlangroupTable=vlangroupTable, action=action, vlan=vlan, qosEntry=qosEntry, qosIndex=qosIndex, lan1=lan1, xg6846=xg6846, lan2=lan2, unicastsReceived=unicastsReceived, catv=catv, qmapping=qmapping, jumblan1=jumblan1, fcsErrorReceived=fcsErrorReceived, modeEntry=modeEntry, groupEntry=groupEntry, priority=priority, statIndex=statIndex, lanportpause=lanportpause, wanType=wanType, port4=port4, port2=port2, voltage=voltage, portmode=portmode, lanportIndex=lanportIndex, staticIpHostName=staticIpHostName, lanportspeed=lanportspeed, lan4=lan4, rebootEnable=rebootEnable, portName=portName, qmode=qmode, staticDns=staticDns, groupIndex=groupIndex, fcsErrorTransmitted=fcsErrorTransmitted, jumblan4=jumblan4, domainame=domainame, portEntry=portEntry, vendorOui=vendorOui, txPower=txPower, lanportName=lanportName, vlanid=vlanid, pauseReceived=pauseReceived, fileName=fileName, temperature=temperature, broadcastsTransmitted=broadcastsTransmitted, jumb=jumb, staticIpSubMask=staticIpSubMask, bias=bias, reboot=reboot, rxPower=rxPower, port3=port3, port1=port1, portTable=portTable, portStatistic=portStatistic, portStatEntry=portStatEntry, jumbwan=jumbwan, tftp=tftp, staticIpDomainName=staticIpDomainName, internetPort=internetPort, adminStatus=adminStatus, ddminfo=ddminfo, jumblan3=jumblan3, speed=speed, vendorRev=vendorRev, tftpSevIp=tftpSevIp, primaryDns=primaryDns, qosTable=qosTable, qos=qos, jumblan2=jumblan2, staticIpGateway=staticIpGateway, staticIpAddr=staticIpAddr, secondaryDns=secondaryDns, hostname=hostname, portPower=portPower, statisticTable=statisticTable, pauseTransmitted=pauseTransmitted, catvEnable=catvEnable, vendorName=vendorName, fileType=fileType, vendorPn=vendorPn, lan3=lan3, lanportTable=lanportTable, staticIpPrimaryDns=staticIpPrimaryDns, operStatus=operStatus, broadcastsReceived=broadcastsReceived, wan=wan, staticIpSecondaryDns=staticIpSecondaryDns, multicastsTransmitted=multicastsTransmitted, portIndex=portIndex, groupid=groupid, serialnum=serialnum, deviceinfo=deviceinfo, multicastsReceived=multicastsReceived, dscpEnable=dscpEnable, unicastsTransmitted=unicastsTransmitted)
