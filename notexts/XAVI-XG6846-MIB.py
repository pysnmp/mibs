...
# Produced by pysmi-1.1.8 at Sat Jan 15 04:29:22 2022
...
Integer32, NotificationType, snmpModules, MibIdentifier, Bits, mib_2, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, enterprises, Counter32, iso, Unsigned32, TimeTicks, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "snmpModules", "MibIdentifier", "Bits", "mib-2", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "enterprises", "Counter32", "iso", "Unsigned32", "TimeTicks", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fileName=fileName, groupid=groupid, priority=priority, serialnum=serialnum, lan3=lan3, voltage=voltage, qmapping=qmapping, xg6846=xg6846, tftpSevIp=tftpSevIp, portStatEntry=portStatEntry, staticDns=staticDns, jumblan4=jumblan4, vendorName=vendorName, fcsErrorReceived=fcsErrorReceived, rxPower=rxPower, catv=catv, staticIpHostName=staticIpHostName, jumb=jumb, adminStatus=adminStatus, portPower=portPower, unicastsTransmitted=unicastsTransmitted, tftp=tftp, staticIpSecondaryDns=staticIpSecondaryDns, hostname=hostname, deviceinfo=deviceinfo, portEntry=portEntry, ddminfo=ddminfo, bias=bias, qosTable=qosTable, fcsErrorTransmitted=fcsErrorTransmitted, statIndex=statIndex, primaryDns=primaryDns, lanportspeed=lanportspeed, dscpEnable=dscpEnable, wan=wan, jumblan1=jumblan1, lan4=lan4, lanportIndex=lanportIndex, qosIndex=qosIndex, rebootEnable=rebootEnable, staticIpSubMask=staticIpSubMask, jumbwan=jumbwan, qosEntry=qosEntry, staticIpAddr=staticIpAddr, action=action, statisticTable=statisticTable, vlanid=vlanid, staticIpDomainName=staticIpDomainName, jumblan2=jumblan2, portTable=portTable, port2=port2, temperature=temperature, unicastsReceived=unicastsReceived, secondaryDns=secondaryDns, vendorOui=vendorOui, lan2=lan2, catvEnable=catvEnable, vlangroupTable=vlangroupTable, vendorRev=vendorRev, operStatus=operStatus, port4=port4, multicastsReceived=multicastsReceived, lan1=lan1, port3=port3, lanportName=lanportName, portStatistic=portStatistic, modeEntry=modeEntry, portmode=portmode, qos=qos, lanportTable=lanportTable, pauseTransmitted=pauseTransmitted, portName=portName, internetPort=internetPort, txPower=txPower, portIndex=portIndex, reboot=reboot, vendorPn=vendorPn, pauseReceived=pauseReceived, groupEntry=groupEntry, groupIndex=groupIndex, jumblan3=jumblan3, multicastsTransmitted=multicastsTransmitted, vlan=vlan, qmode=qmode, fileType=fileType, speed=speed, broadcastsTransmitted=broadcastsTransmitted, wanType=wanType, port1=port1, lanportpause=lanportpause, broadcastsReceived=broadcastsReceived, domainame=domainame, staticIpPrimaryDns=staticIpPrimaryDns, staticIpGateway=staticIpGateway)
