...
NotificationType, ModuleIdentity, snmpModules, iso, Bits, Counter64, mib_2, Counter32, enterprises, IpAddress, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "snmpModules", "iso", "Bits", "Counter64", "mib-2", "Counter32", "enterprises", "IpAddress", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumblan2=jumblan2, portStatEntry=portStatEntry, portmode=portmode, lan4=lan4, staticIpHostName=staticIpHostName, jumbwan=jumbwan, catvEnable=catvEnable, jumb=jumb, staticIpDomainName=staticIpDomainName, lan2=lan2, jumblan1=jumblan1, portEntry=portEntry, portPower=portPower, portIndex=portIndex, portTable=portTable, temperature=temperature, txPower=txPower, statisticTable=statisticTable, staticIpSecondaryDns=staticIpSecondaryDns, ddminfo=ddminfo, deviceinfo=deviceinfo, multicastsTransmitted=multicastsTransmitted, operStatus=operStatus, priority=priority, lanportIndex=lanportIndex, adminStatus=adminStatus, fileName=fileName, groupid=groupid, rxPower=rxPower, port1=port1, vlanid=vlanid, broadcastsReceived=broadcastsReceived, vendorPn=vendorPn, jumblan4=jumblan4, dscpEnable=dscpEnable, vendorOui=vendorOui, pauseTransmitted=pauseTransmitted, vlangroupTable=vlangroupTable, hostname=hostname, tftpSevIp=tftpSevIp, lanportpause=lanportpause, speed=speed, lanportName=lanportName, qosIndex=qosIndex, fcsErrorReceived=fcsErrorReceived, qosEntry=qosEntry, port3=port3, staticDns=staticDns, catv=catv, wan=wan, modeEntry=modeEntry, qos=qos, broadcastsTransmitted=broadcastsTransmitted, action=action, domainame=domainame, pauseReceived=pauseReceived, lan3=lan3, portName=portName, xg6846=xg6846, multicastsReceived=multicastsReceived, secondaryDns=secondaryDns, staticIpAddr=staticIpAddr, rebootEnable=rebootEnable, serialnum=serialnum, lan1=lan1, groupEntry=groupEntry, unicastsReceived=unicastsReceived, tftp=tftp, voltage=voltage, staticIpSubMask=staticIpSubMask, reboot=reboot, port4=port4, jumblan3=jumblan3, lanportTable=lanportTable, port2=port2, staticIpGateway=staticIpGateway, vendorRev=vendorRev, groupIndex=groupIndex, statIndex=statIndex, vendorName=vendorName, bias=bias, primaryDns=primaryDns, qosTable=qosTable, internetPort=internetPort, qmapping=qmapping, vlan=vlan, qmode=qmode, staticIpPrimaryDns=staticIpPrimaryDns, lanportspeed=lanportspeed, portStatistic=portStatistic, wanType=wanType, fcsErrorTransmitted=fcsErrorTransmitted, fileType=fileType, unicastsTransmitted=unicastsTransmitted)
