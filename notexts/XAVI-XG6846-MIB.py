...
enterprises, Counter32, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, ObjectIdentity, mib_2, Gauge32, MibIdentifier, TimeTicks, snmpModules, IpAddress, iso, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "ObjectIdentity", "mib-2", "Gauge32", "MibIdentifier", "TimeTicks", "snmpModules", "IpAddress", "iso", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", action=action, wanType=wanType, vendorName=vendorName, vlangroupTable=vlangroupTable, txPower=txPower, rebootEnable=rebootEnable, vlan=vlan, speed=speed, jumblan4=jumblan4, staticIpDomainName=staticIpDomainName, staticIpGateway=staticIpGateway, domainame=domainame, multicastsTransmitted=multicastsTransmitted, adminStatus=adminStatus, portName=portName, modeEntry=modeEntry, catv=catv, hostname=hostname, portTable=portTable, tftp=tftp, dscpEnable=dscpEnable, rxPower=rxPower, qmode=qmode, bias=bias, tftpSevIp=tftpSevIp, jumb=jumb, internetPort=internetPort, ddminfo=ddminfo, lanportspeed=lanportspeed, catvEnable=catvEnable, xg6846=xg6846, port2=port2, qosTable=qosTable, portEntry=portEntry, portmode=portmode, portStatEntry=portStatEntry, staticIpSubMask=staticIpSubMask, unicastsReceived=unicastsReceived, jumblan3=jumblan3, serialnum=serialnum, lanportName=lanportName, portPower=portPower, secondaryDns=secondaryDns, fcsErrorTransmitted=fcsErrorTransmitted, lan4=lan4, lanportpause=lanportpause, fileName=fileName, priority=priority, lan1=lan1, qmapping=qmapping, staticIpPrimaryDns=staticIpPrimaryDns, wan=wan, staticIpHostName=staticIpHostName, vendorOui=vendorOui, groupid=groupid, unicastsTransmitted=unicastsTransmitted, pauseReceived=pauseReceived, staticIpSecondaryDns=staticIpSecondaryDns, jumblan1=jumblan1, jumblan2=jumblan2, vlanid=vlanid, lanportTable=lanportTable, fcsErrorReceived=fcsErrorReceived, multicastsReceived=multicastsReceived, pauseTransmitted=pauseTransmitted, reboot=reboot, groupEntry=groupEntry, fileType=fileType, staticIpAddr=staticIpAddr, jumbwan=jumbwan, port3=port3, lan3=lan3, operStatus=operStatus, qosEntry=qosEntry, primaryDns=primaryDns, vendorRev=vendorRev, groupIndex=groupIndex, port1=port1, lanportIndex=lanportIndex, statisticTable=statisticTable, broadcastsReceived=broadcastsReceived, qosIndex=qosIndex, temperature=temperature, staticDns=staticDns, qos=qos, portStatistic=portStatistic, portIndex=portIndex, deviceinfo=deviceinfo, lan2=lan2, voltage=voltage, broadcastsTransmitted=broadcastsTransmitted, vendorPn=vendorPn, port4=port4, statIndex=statIndex)
