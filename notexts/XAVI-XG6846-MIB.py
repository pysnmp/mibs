...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, Counter64, ObjectIdentity, snmpModules, TimeTicks, Integer32, enterprises, Gauge32, Bits, ModuleIdentity, NotificationType, iso, Unsigned32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "Counter64", "ObjectIdentity", "snmpModules", "TimeTicks", "Integer32", "enterprises", "Gauge32", "Bits", "ModuleIdentity", "NotificationType", "iso", "Unsigned32", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qosEntry=qosEntry, staticIpDomainName=staticIpDomainName, statisticTable=statisticTable, portStatistic=portStatistic, jumblan2=jumblan2, groupid=groupid, wan=wan, groupEntry=groupEntry, vendorName=vendorName, vlan=vlan, jumblan1=jumblan1, lanportIndex=lanportIndex, hostname=hostname, deviceinfo=deviceinfo, staticDns=staticDns, multicastsTransmitted=multicastsTransmitted, action=action, portIndex=portIndex, staticIpSecondaryDns=staticIpSecondaryDns, temperature=temperature, fileType=fileType, wanType=wanType, port1=port1, portPower=portPower, staticIpGateway=staticIpGateway, port2=port2, catvEnable=catvEnable, dscpEnable=dscpEnable, qos=qos, catv=catv, port3=port3, vlanid=vlanid, tftp=tftp, qosIndex=qosIndex, fcsErrorTransmitted=fcsErrorTransmitted, vendorOui=vendorOui, portTable=portTable, bias=bias, xg6846=xg6846, primaryDns=primaryDns, lanportspeed=lanportspeed, tftpSevIp=tftpSevIp, lanportName=lanportName, staticIpHostName=staticIpHostName, lan4=lan4, broadcastsReceived=broadcastsReceived, vlangroupTable=vlangroupTable, port4=port4, staticIpAddr=staticIpAddr, portStatEntry=portStatEntry, lan1=lan1, lan3=lan3, statIndex=statIndex, portmode=portmode, qmode=qmode, lan2=lan2, staticIpPrimaryDns=staticIpPrimaryDns, rebootEnable=rebootEnable, secondaryDns=secondaryDns, domainame=domainame, ddminfo=ddminfo, voltage=voltage, operStatus=operStatus, multicastsReceived=multicastsReceived, lanportpause=lanportpause, vendorRev=vendorRev, jumblan3=jumblan3, internetPort=internetPort, portName=portName, unicastsTransmitted=unicastsTransmitted, speed=speed, priority=priority, portEntry=portEntry, modeEntry=modeEntry, unicastsReceived=unicastsReceived, vendorPn=vendorPn, rxPower=rxPower, pauseTransmitted=pauseTransmitted, lanportTable=lanportTable, pauseReceived=pauseReceived, qmapping=qmapping, fileName=fileName, reboot=reboot, qosTable=qosTable, serialnum=serialnum, jumblan4=jumblan4, txPower=txPower, jumbwan=jumbwan, adminStatus=adminStatus, jumb=jumb, broadcastsTransmitted=broadcastsTransmitted, groupIndex=groupIndex, staticIpSubMask=staticIpSubMask, fcsErrorReceived=fcsErrorReceived)
