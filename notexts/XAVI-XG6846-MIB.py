...
# Produced by pysmi-1.1.3 at Sat Nov 20 17:19:18 2021
...
Bits, NotificationType, ModuleIdentity, mib_2, Counter32, Unsigned32, enterprises, iso, IpAddress, TimeTicks, Gauge32, Integer32, ObjectIdentity, Counter64, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "ModuleIdentity", "mib-2", "Counter32", "Unsigned32", "enterprises", "iso", "IpAddress", "TimeTicks", "Gauge32", "Integer32", "ObjectIdentity", "Counter64", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catvEnable=catvEnable, temperature=temperature, staticDns=staticDns, jumblan1=jumblan1, groupEntry=groupEntry, action=action, vlanid=vlanid, broadcastsTransmitted=broadcastsTransmitted, portPower=portPower, priority=priority, fcsErrorTransmitted=fcsErrorTransmitted, fcsErrorReceived=fcsErrorReceived, rebootEnable=rebootEnable, qos=qos, lanportIndex=lanportIndex, internetPort=internetPort, unicastsTransmitted=unicastsTransmitted, jumb=jumb, jumblan2=jumblan2, port3=port3, vendorPn=vendorPn, port4=port4, lanportName=lanportName, staticIpSecondaryDns=staticIpSecondaryDns, staticIpAddr=staticIpAddr, hostname=hostname, lanportspeed=lanportspeed, statisticTable=statisticTable, portName=portName, vendorName=vendorName, rxPower=rxPower, wanType=wanType, domainame=domainame, qmapping=qmapping, jumblan4=jumblan4, portEntry=portEntry, lan4=lan4, lan2=lan2, lanportTable=lanportTable, vlangroupTable=vlangroupTable, staticIpPrimaryDns=staticIpPrimaryDns, qosTable=qosTable, groupid=groupid, fileName=fileName, broadcastsReceived=broadcastsReceived, xg6846=xg6846, staticIpSubMask=staticIpSubMask, port1=port1, operStatus=operStatus, txPower=txPower, lanportpause=lanportpause, secondaryDns=secondaryDns, deviceinfo=deviceinfo, qosEntry=qosEntry, qosIndex=qosIndex, voltage=voltage, jumbwan=jumbwan, port2=port2, primaryDns=primaryDns, portTable=portTable, pauseTransmitted=pauseTransmitted, vendorOui=vendorOui, groupIndex=groupIndex, ddminfo=ddminfo, staticIpDomainName=staticIpDomainName, dscpEnable=dscpEnable, multicastsTransmitted=multicastsTransmitted, statIndex=statIndex, pauseReceived=pauseReceived, staticIpHostName=staticIpHostName, portStatistic=portStatistic, fileType=fileType, vlan=vlan, wan=wan, staticIpGateway=staticIpGateway, portStatEntry=portStatEntry, tftpSevIp=tftpSevIp, serialnum=serialnum, portIndex=portIndex, speed=speed, modeEntry=modeEntry, bias=bias, lan3=lan3, jumblan3=jumblan3, vendorRev=vendorRev, reboot=reboot, lan1=lan1, unicastsReceived=unicastsReceived, adminStatus=adminStatus, qmode=qmode, multicastsReceived=multicastsReceived, catv=catv, tftp=tftp, portmode=portmode)
