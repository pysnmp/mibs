...
iso, enterprises, TimeTicks, ModuleIdentity, Gauge32, mib_2, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, Counter64, MibIdentifier, snmpModules, Integer32, Bits, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "enterprises", "TimeTicks", "ModuleIdentity", "Gauge32", "mib-2", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "Counter64", "MibIdentifier", "snmpModules", "Integer32", "Bits", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fileType=fileType, statisticTable=statisticTable, lan3=lan3, jumb=jumb, jumblan4=jumblan4, lanportpause=lanportpause, vendorPn=vendorPn, txPower=txPower, unicastsReceived=unicastsReceived, pauseTransmitted=pauseTransmitted, portmode=portmode, primaryDns=primaryDns, tftpSevIp=tftpSevIp, qos=qos, qosTable=qosTable, rxPower=rxPower, reboot=reboot, lanportIndex=lanportIndex, qmode=qmode, voltage=voltage, broadcastsReceived=broadcastsReceived, deviceinfo=deviceinfo, port3=port3, statIndex=statIndex, staticIpPrimaryDns=staticIpPrimaryDns, staticIpGateway=staticIpGateway, jumblan3=jumblan3, hostname=hostname, staticIpSecondaryDns=staticIpSecondaryDns, priority=priority, action=action, portIndex=portIndex, jumblan2=jumblan2, fcsErrorTransmitted=fcsErrorTransmitted, portEntry=portEntry, broadcastsTransmitted=broadcastsTransmitted, qosIndex=qosIndex, portStatistic=portStatistic, dscpEnable=dscpEnable, port4=port4, qosEntry=qosEntry, groupEntry=groupEntry, speed=speed, ddminfo=ddminfo, lan1=lan1, multicastsTransmitted=multicastsTransmitted, vendorOui=vendorOui, catv=catv, portPower=portPower, catvEnable=catvEnable, vlanid=vlanid, portTable=portTable, groupid=groupid, fileName=fileName, temperature=temperature, jumblan1=jumblan1, serialnum=serialnum, staticIpDomainName=staticIpDomainName, xg6846=xg6846, lanportTable=lanportTable, fcsErrorReceived=fcsErrorReceived, tftp=tftp, lanportName=lanportName, vendorRev=vendorRev, port1=port1, vendorName=vendorName, groupIndex=groupIndex, wan=wan, staticIpAddr=staticIpAddr, pauseReceived=pauseReceived, portStatEntry=portStatEntry, multicastsReceived=multicastsReceived, staticIpHostName=staticIpHostName, adminStatus=adminStatus, secondaryDns=secondaryDns, internetPort=internetPort, qmapping=qmapping, staticIpSubMask=staticIpSubMask, wanType=wanType, modeEntry=modeEntry, domainame=domainame, lan4=lan4, staticDns=staticDns, unicastsTransmitted=unicastsTransmitted, port2=port2, vlangroupTable=vlangroupTable, bias=bias, lanportspeed=lanportspeed, rebootEnable=rebootEnable, jumbwan=jumbwan, portName=portName, lan2=lan2, vlan=vlan, operStatus=operStatus)
