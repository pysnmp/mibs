...
# Produced by pysmi-1.1.8 at Wed Jun 29 13:11:22 2022
...
snmpModules, ObjectIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, IpAddress, mib_2, iso, Integer32, NotificationType, Gauge32, Counter64, ModuleIdentity, Bits, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "ObjectIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "IpAddress", "mib-2", "iso", "Integer32", "NotificationType", "Gauge32", "Counter64", "ModuleIdentity", "Bits", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", txPower=txPower, broadcastsTransmitted=broadcastsTransmitted, groupid=groupid, modeEntry=modeEntry, staticIpSubMask=staticIpSubMask, deviceinfo=deviceinfo, vlangroupTable=vlangroupTable, pauseTransmitted=pauseTransmitted, staticIpGateway=staticIpGateway, serialnum=serialnum, fcsErrorReceived=fcsErrorReceived, xg6846=xg6846, portEntry=portEntry, jumblan3=jumblan3, wanType=wanType, vlan=vlan, staticIpDomainName=staticIpDomainName, multicastsReceived=multicastsReceived, qosEntry=qosEntry, temperature=temperature, speed=speed, rebootEnable=rebootEnable, lan2=lan2, jumblan2=jumblan2, portmode=portmode, qosIndex=qosIndex, lanportIndex=lanportIndex, fileType=fileType, unicastsTransmitted=unicastsTransmitted, dscpEnable=dscpEnable, port3=port3, lan1=lan1, adminStatus=adminStatus, action=action, groupIndex=groupIndex, lanportpause=lanportpause, portName=portName, jumblan1=jumblan1, priority=priority, statIndex=statIndex, secondaryDns=secondaryDns, wan=wan, lan3=lan3, catvEnable=catvEnable, port1=port1, jumbwan=jumbwan, broadcastsReceived=broadcastsReceived, fileName=fileName, lanportspeed=lanportspeed, portTable=portTable, portStatistic=portStatistic, ddminfo=ddminfo, voltage=voltage, staticIpHostName=staticIpHostName, statisticTable=statisticTable, portStatEntry=portStatEntry, groupEntry=groupEntry, domainame=domainame, vendorRev=vendorRev, portPower=portPower, vendorOui=vendorOui, reboot=reboot, catv=catv, lanportTable=lanportTable, portIndex=portIndex, jumblan4=jumblan4, vendorName=vendorName, vlanid=vlanid, port4=port4, internetPort=internetPort, pauseReceived=pauseReceived, port2=port2, tftp=tftp, lanportName=lanportName, staticIpAddr=staticIpAddr, qmode=qmode, multicastsTransmitted=multicastsTransmitted, qmapping=qmapping, lan4=lan4, primaryDns=primaryDns, tftpSevIp=tftpSevIp, qosTable=qosTable, staticIpPrimaryDns=staticIpPrimaryDns, vendorPn=vendorPn, qos=qos, jumb=jumb, bias=bias, unicastsReceived=unicastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, hostname=hostname, fcsErrorTransmitted=fcsErrorTransmitted, staticDns=staticDns, operStatus=operStatus, rxPower=rxPower)
