...
# Produced by pysmi-1.1.8 at Mon Feb  6 15:02:48 2023
...
IpAddress, snmpModules, TimeTicks, ObjectIdentity, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, Counter64, ModuleIdentity, Counter32, enterprises, NotificationType, Bits, mib_2, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "snmpModules", "TimeTicks", "ObjectIdentity", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "Counter64", "ModuleIdentity", "Counter32", "enterprises", "NotificationType", "Bits", "mib-2", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumb=jumb, modeEntry=modeEntry, portTable=portTable, lan4=lan4, internetPort=internetPort, wanType=wanType, portStatEntry=portStatEntry, qmapping=qmapping, jumblan1=jumblan1, xg6846=xg6846, tftp=tftp, staticIpAddr=staticIpAddr, vendorRev=vendorRev, qosIndex=qosIndex, statIndex=statIndex, port3=port3, portName=portName, reboot=reboot, fcsErrorReceived=fcsErrorReceived, groupEntry=groupEntry, secondaryDns=secondaryDns, hostname=hostname, portEntry=portEntry, lan3=lan3, vendorPn=vendorPn, staticDns=staticDns, action=action, catvEnable=catvEnable, staticIpPrimaryDns=staticIpPrimaryDns, primaryDns=primaryDns, vlan=vlan, rebootEnable=rebootEnable, lanportspeed=lanportspeed, portStatistic=portStatistic, temperature=temperature, staticIpHostName=staticIpHostName, staticIpDomainName=staticIpDomainName, bias=bias, unicastsTransmitted=unicastsTransmitted, priority=priority, catv=catv, portIndex=portIndex, fileName=fileName, fileType=fileType, wan=wan, multicastsReceived=multicastsReceived, voltage=voltage, groupIndex=groupIndex, qosEntry=qosEntry, dscpEnable=dscpEnable, speed=speed, deviceinfo=deviceinfo, vendorName=vendorName, staticIpSubMask=staticIpSubMask, domainame=domainame, rxPower=rxPower, txPower=txPower, adminStatus=adminStatus, vendorOui=vendorOui, qos=qos, fcsErrorTransmitted=fcsErrorTransmitted, lanportpause=lanportpause, lan1=lan1, statisticTable=statisticTable, multicastsTransmitted=multicastsTransmitted, tftpSevIp=tftpSevIp, port2=port2, broadcastsReceived=broadcastsReceived, broadcastsTransmitted=broadcastsTransmitted, jumbwan=jumbwan, groupid=groupid, lanportTable=lanportTable, vlanid=vlanid, serialnum=serialnum, port4=port4, ddminfo=ddminfo, portPower=portPower, lanportName=lanportName, staticIpGateway=staticIpGateway, staticIpSecondaryDns=staticIpSecondaryDns, lanportIndex=lanportIndex, pauseReceived=pauseReceived, qosTable=qosTable, jumblan4=jumblan4, unicastsReceived=unicastsReceived, vlangroupTable=vlangroupTable, pauseTransmitted=pauseTransmitted, portmode=portmode, qmode=qmode, jumblan3=jumblan3, port1=port1, lan2=lan2, operStatus=operStatus, jumblan2=jumblan2)
