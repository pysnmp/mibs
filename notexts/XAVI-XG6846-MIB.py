...
Counter64, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, IpAddress, ModuleIdentity, MibIdentifier, Integer32, snmpModules, mib_2, ObjectIdentity, Counter32, Unsigned32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "IpAddress", "ModuleIdentity", "MibIdentifier", "Integer32", "snmpModules", "mib-2", "ObjectIdentity", "Counter32", "Unsigned32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", multicastsReceived=multicastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, catv=catv, qmode=qmode, portStatEntry=portStatEntry, statIndex=statIndex, adminStatus=adminStatus, tftp=tftp, vlan=vlan, unicastsReceived=unicastsReceived, bias=bias, qosTable=qosTable, lan2=lan2, portEntry=portEntry, modeEntry=modeEntry, internetPort=internetPort, catvEnable=catvEnable, port4=port4, lanportTable=lanportTable, groupIndex=groupIndex, portmode=portmode, staticIpSubMask=staticIpSubMask, action=action, qosEntry=qosEntry, jumblan1=jumblan1, pauseReceived=pauseReceived, wan=wan, domainame=domainame, voltage=voltage, operStatus=operStatus, qosIndex=qosIndex, staticIpSecondaryDns=staticIpSecondaryDns, vlangroupTable=vlangroupTable, port2=port2, vendorOui=vendorOui, broadcastsTransmitted=broadcastsTransmitted, statisticTable=statisticTable, lanportpause=lanportpause, ddminfo=ddminfo, txPower=txPower, qos=qos, portIndex=portIndex, vendorPn=vendorPn, vendorRev=vendorRev, lanportIndex=lanportIndex, lan4=lan4, portName=portName, staticDns=staticDns, port1=port1, fileType=fileType, jumblan3=jumblan3, jumb=jumb, xg6846=xg6846, jumblan2=jumblan2, lan3=lan3, dscpEnable=dscpEnable, primaryDns=primaryDns, lanportName=lanportName, hostname=hostname, jumblan4=jumblan4, staticIpAddr=staticIpAddr, portStatistic=portStatistic, reboot=reboot, unicastsTransmitted=unicastsTransmitted, lanportspeed=lanportspeed, vlanid=vlanid, multicastsTransmitted=multicastsTransmitted, staticIpHostName=staticIpHostName, rebootEnable=rebootEnable, lan1=lan1, temperature=temperature, speed=speed, deviceinfo=deviceinfo, pauseTransmitted=pauseTransmitted, qmapping=qmapping, port3=port3, fileName=fileName, jumbwan=jumbwan, fcsErrorReceived=fcsErrorReceived, vendorName=vendorName, groupEntry=groupEntry, staticIpPrimaryDns=staticIpPrimaryDns, staticIpDomainName=staticIpDomainName, serialnum=serialnum, portPower=portPower, priority=priority, staticIpGateway=staticIpGateway, secondaryDns=secondaryDns, portTable=portTable, broadcastsReceived=broadcastsReceived, tftpSevIp=tftpSevIp, wanType=wanType, groupid=groupid, rxPower=rxPower)
