...
# Produced by pysmi-1.1.8 at Thu Jan 13 23:05:54 2022
...
Integer32, ObjectIdentity, iso, TimeTicks, NotificationType, IpAddress, mib_2, ModuleIdentity, MibIdentifier, enterprises, Counter32, snmpModules, Gauge32, Bits, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "iso", "TimeTicks", "NotificationType", "IpAddress", "mib-2", "ModuleIdentity", "MibIdentifier", "enterprises", "Counter32", "snmpModules", "Gauge32", "Bits", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", deviceinfo=deviceinfo, vlan=vlan, portmode=portmode, vendorOui=vendorOui, lanportName=lanportName, lanportpause=lanportpause, broadcastsReceived=broadcastsReceived, priority=priority, modeEntry=modeEntry, tftp=tftp, lan1=lan1, ddminfo=ddminfo, operStatus=operStatus, fcsErrorReceived=fcsErrorReceived, adminStatus=adminStatus, primaryDns=primaryDns, jumblan3=jumblan3, multicastsTransmitted=multicastsTransmitted, speed=speed, groupIndex=groupIndex, fileType=fileType, qmapping=qmapping, action=action, lanportTable=lanportTable, jumblan2=jumblan2, reboot=reboot, groupEntry=groupEntry, wan=wan, rxPower=rxPower, internetPort=internetPort, vlanid=vlanid, staticIpSecondaryDns=staticIpSecondaryDns, fcsErrorTransmitted=fcsErrorTransmitted, lan4=lan4, secondaryDns=secondaryDns, staticIpDomainName=staticIpDomainName, jumb=jumb, fileName=fileName, staticIpHostName=staticIpHostName, temperature=temperature, qos=qos, serialnum=serialnum, bias=bias, jumblan4=jumblan4, port4=port4, qosTable=qosTable, hostname=hostname, staticIpAddr=staticIpAddr, xg6846=xg6846, portName=portName, vendorName=vendorName, lanportspeed=lanportspeed, unicastsTransmitted=unicastsTransmitted, portStatistic=portStatistic, catv=catv, staticIpSubMask=staticIpSubMask, staticIpGateway=staticIpGateway, catvEnable=catvEnable, portEntry=portEntry, statIndex=statIndex, txPower=txPower, wanType=wanType, qosEntry=qosEntry, port1=port1, port2=port2, portStatEntry=portStatEntry, dscpEnable=dscpEnable, pauseTransmitted=pauseTransmitted, voltage=voltage, broadcastsTransmitted=broadcastsTransmitted, portIndex=portIndex, port3=port3, portTable=portTable, pauseReceived=pauseReceived, lan3=lan3, portPower=portPower, vendorRev=vendorRev, rebootEnable=rebootEnable, tftpSevIp=tftpSevIp, qosIndex=qosIndex, multicastsReceived=multicastsReceived, jumblan1=jumblan1, vlangroupTable=vlangroupTable, vendorPn=vendorPn, lan2=lan2, groupid=groupid, staticIpPrimaryDns=staticIpPrimaryDns, jumbwan=jumbwan, domainame=domainame, qmode=qmode, statisticTable=statisticTable, lanportIndex=lanportIndex, unicastsReceived=unicastsReceived, staticDns=staticDns)
