...
# Produced by pysmi-1.1.8 at Fri Jan  7 01:13:25 2022
...
TimeTicks, enterprises, Counter64, Unsigned32, Counter32, NotificationType, Integer32, IpAddress, iso, Gauge32, ObjectIdentity, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, mib_2, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "Counter64", "Unsigned32", "Counter32", "NotificationType", "Integer32", "IpAddress", "iso", "Gauge32", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "mib-2", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catv=catv, secondaryDns=secondaryDns, serialnum=serialnum, internetPort=internetPort, portEntry=portEntry, qos=qos, qosIndex=qosIndex, pauseReceived=pauseReceived, lan3=lan3, staticIpPrimaryDns=staticIpPrimaryDns, lan1=lan1, reboot=reboot, fileType=fileType, jumblan4=jumblan4, portmode=portmode, domainame=domainame, wanType=wanType, portTable=portTable, priority=priority, bias=bias, statisticTable=statisticTable, groupIndex=groupIndex, unicastsTransmitted=unicastsTransmitted, portStatistic=portStatistic, wan=wan, lan2=lan2, portStatEntry=portStatEntry, vlangroupTable=vlangroupTable, broadcastsTransmitted=broadcastsTransmitted, primaryDns=primaryDns, groupEntry=groupEntry, vlanid=vlanid, fcsErrorTransmitted=fcsErrorTransmitted, jumb=jumb, operStatus=operStatus, qosTable=qosTable, qosEntry=qosEntry, vendorRev=vendorRev, speed=speed, staticIpSecondaryDns=staticIpSecondaryDns, port1=port1, portIndex=portIndex, lanportpause=lanportpause, port4=port4, jumblan2=jumblan2, unicastsReceived=unicastsReceived, staticIpGateway=staticIpGateway, lanportName=lanportName, lanportspeed=lanportspeed, hostname=hostname, staticIpDomainName=staticIpDomainName, modeEntry=modeEntry, adminStatus=adminStatus, broadcastsReceived=broadcastsReceived, staticDns=staticDns, jumblan1=jumblan1, tftpSevIp=tftpSevIp, lanportIndex=lanportIndex, lan4=lan4, fcsErrorReceived=fcsErrorReceived, vendorName=vendorName, action=action, jumblan3=jumblan3, staticIpHostName=staticIpHostName, tftp=tftp, jumbwan=jumbwan, portPower=portPower, temperature=temperature, qmode=qmode, vendorPn=vendorPn, fileName=fileName, ddminfo=ddminfo, vendorOui=vendorOui, voltage=voltage, port3=port3, dscpEnable=dscpEnable, rxPower=rxPower, groupid=groupid, portName=portName, multicastsTransmitted=multicastsTransmitted, port2=port2, staticIpAddr=staticIpAddr, qmapping=qmapping, rebootEnable=rebootEnable, statIndex=statIndex, staticIpSubMask=staticIpSubMask, pauseTransmitted=pauseTransmitted, vlan=vlan, catvEnable=catvEnable, txPower=txPower, xg6846=xg6846, deviceinfo=deviceinfo, multicastsReceived=multicastsReceived, lanportTable=lanportTable)
