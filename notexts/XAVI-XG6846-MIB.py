...
# Produced by pysmi-1.1.8 at Tue Jan 11 20:43:23 2022
...
enterprises, mib_2, IpAddress, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Gauge32, MibIdentifier, NotificationType, iso, Bits, Counter32, Integer32, snmpModules, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "mib-2", "IpAddress", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Gauge32", "MibIdentifier", "NotificationType", "iso", "Bits", "Counter32", "Integer32", "snmpModules", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", broadcastsReceived=broadcastsReceived, vlan=vlan, jumblan1=jumblan1, modeEntry=modeEntry, jumblan4=jumblan4, fileType=fileType, portmode=portmode, portStatistic=portStatistic, hostname=hostname, voltage=voltage, jumbwan=jumbwan, internetPort=internetPort, action=action, groupid=groupid, portPower=portPower, xg6846=xg6846, lan2=lan2, vendorOui=vendorOui, vlanid=vlanid, vlangroupTable=vlangroupTable, portEntry=portEntry, fcsErrorTransmitted=fcsErrorTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, port1=port1, portStatEntry=portStatEntry, lanportpause=lanportpause, serialnum=serialnum, lanportIndex=lanportIndex, vendorPn=vendorPn, broadcastsTransmitted=broadcastsTransmitted, jumb=jumb, portTable=portTable, vendorRev=vendorRev, rxPower=rxPower, operStatus=operStatus, staticIpGateway=staticIpGateway, pauseTransmitted=pauseTransmitted, wan=wan, staticDns=staticDns, vendorName=vendorName, pauseReceived=pauseReceived, temperature=temperature, qmode=qmode, lan1=lan1, groupIndex=groupIndex, wanType=wanType, fileName=fileName, jumblan3=jumblan3, statIndex=statIndex, groupEntry=groupEntry, portIndex=portIndex, tftpSevIp=tftpSevIp, port4=port4, txPower=txPower, unicastsReceived=unicastsReceived, catvEnable=catvEnable, deviceinfo=deviceinfo, fcsErrorReceived=fcsErrorReceived, staticIpPrimaryDns=staticIpPrimaryDns, qosEntry=qosEntry, multicastsTransmitted=multicastsTransmitted, staticIpHostName=staticIpHostName, staticIpAddr=staticIpAddr, adminStatus=adminStatus, dscpEnable=dscpEnable, priority=priority, unicastsTransmitted=unicastsTransmitted, ddminfo=ddminfo, jumblan2=jumblan2, qosTable=qosTable, domainame=domainame, lanportName=lanportName, lanportTable=lanportTable, staticIpDomainName=staticIpDomainName, port3=port3, secondaryDns=secondaryDns, statisticTable=statisticTable, reboot=reboot, lanportspeed=lanportspeed, portName=portName, rebootEnable=rebootEnable, lan3=lan3, qosIndex=qosIndex, lan4=lan4, qos=qos, port2=port2, qmapping=qmapping, tftp=tftp, primaryDns=primaryDns, catv=catv, staticIpSubMask=staticIpSubMask, multicastsReceived=multicastsReceived, bias=bias, speed=speed)
