...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, mib_2, Gauge32, IpAddress, Counter32, TimeTicks, iso, Bits, Unsigned32, ModuleIdentity, snmpModules, MibIdentifier, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "mib-2", "Gauge32", "IpAddress", "Counter32", "TimeTicks", "iso", "Bits", "Unsigned32", "ModuleIdentity", "snmpModules", "MibIdentifier", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", secondaryDns=secondaryDns, port2=port2, ddminfo=ddminfo, lanportIndex=lanportIndex, hostname=hostname, lanportpause=lanportpause, broadcastsReceived=broadcastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, vlan=vlan, txPower=txPower, priority=priority, lanportTable=lanportTable, portTable=portTable, temperature=temperature, vendorPn=vendorPn, lan1=lan1, port3=port3, vlangroupTable=vlangroupTable, statisticTable=statisticTable, groupEntry=groupEntry, jumblan2=jumblan2, jumblan1=jumblan1, fileType=fileType, portPower=portPower, portmode=portmode, operStatus=operStatus, tftp=tftp, domainame=domainame, staticIpDomainName=staticIpDomainName, jumb=jumb, portStatEntry=portStatEntry, jumblan4=jumblan4, staticDns=staticDns, qmode=qmode, qosIndex=qosIndex, groupIndex=groupIndex, speed=speed, portStatistic=portStatistic, qos=qos, vendorOui=vendorOui, vendorName=vendorName, portName=portName, rebootEnable=rebootEnable, vlanid=vlanid, qosTable=qosTable, wan=wan, qmapping=qmapping, lan2=lan2, portIndex=portIndex, staticIpSubMask=staticIpSubMask, fcsErrorReceived=fcsErrorReceived, fileName=fileName, bias=bias, tftpSevIp=tftpSevIp, jumblan3=jumblan3, port4=port4, lan4=lan4, groupid=groupid, vendorRev=vendorRev, pauseReceived=pauseReceived, internetPort=internetPort, broadcastsTransmitted=broadcastsTransmitted, staticIpGateway=staticIpGateway, dscpEnable=dscpEnable, unicastsReceived=unicastsReceived, lan3=lan3, modeEntry=modeEntry, rxPower=rxPower, catv=catv, reboot=reboot, statIndex=statIndex, staticIpSecondaryDns=staticIpSecondaryDns, pauseTransmitted=pauseTransmitted, voltage=voltage, adminStatus=adminStatus, action=action, jumbwan=jumbwan, wanType=wanType, fcsErrorTransmitted=fcsErrorTransmitted, primaryDns=primaryDns, multicastsTransmitted=multicastsTransmitted, staticIpAddr=staticIpAddr, multicastsReceived=multicastsReceived, unicastsTransmitted=unicastsTransmitted, portEntry=portEntry, lanportName=lanportName, serialnum=serialnum, staticIpHostName=staticIpHostName, lanportspeed=lanportspeed, qosEntry=qosEntry, port1=port1, deviceinfo=deviceinfo, catvEnable=catvEnable, xg6846=xg6846)
