...
# Produced by pysmi-1.1.8 at Thu Jan 27 21:40:12 2022
...
ModuleIdentity, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, mib_2, Bits, Integer32, Gauge32, Counter64, MibIdentifier, IpAddress, snmpModules, Unsigned32, NotificationType, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "mib-2", "Bits", "Integer32", "Gauge32", "Counter64", "MibIdentifier", "IpAddress", "snmpModules", "Unsigned32", "NotificationType", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", pauseTransmitted=pauseTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, fileType=fileType, pauseReceived=pauseReceived, staticIpDomainName=staticIpDomainName, ddminfo=ddminfo, primaryDns=primaryDns, vlanid=vlanid, lanportspeed=lanportspeed, lan2=lan2, modeEntry=modeEntry, lan1=lan1, serialnum=serialnum, temperature=temperature, tftp=tftp, portStatEntry=portStatEntry, rebootEnable=rebootEnable, action=action, groupIndex=groupIndex, portPower=portPower, jumblan4=jumblan4, domainame=domainame, qmode=qmode, lan3=lan3, wanType=wanType, portStatistic=portStatistic, jumblan1=jumblan1, statisticTable=statisticTable, fcsErrorReceived=fcsErrorReceived, xg6846=xg6846, jumblan3=jumblan3, catvEnable=catvEnable, statIndex=statIndex, staticIpHostName=staticIpHostName, tftpSevIp=tftpSevIp, port4=port4, wan=wan, bias=bias, reboot=reboot, port2=port2, qmapping=qmapping, multicastsTransmitted=multicastsTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, groupid=groupid, fileName=fileName, jumb=jumb, port1=port1, lanportIndex=lanportIndex, lanportTable=lanportTable, voltage=voltage, staticIpSubMask=staticIpSubMask, broadcastsTransmitted=broadcastsTransmitted, vendorPn=vendorPn, vendorOui=vendorOui, vlan=vlan, secondaryDns=secondaryDns, staticIpAddr=staticIpAddr, unicastsReceived=unicastsReceived, vendorRev=vendorRev, broadcastsReceived=broadcastsReceived, portEntry=portEntry, vendorName=vendorName, catv=catv, qosIndex=qosIndex, vlangroupTable=vlangroupTable, deviceinfo=deviceinfo, fcsErrorTransmitted=fcsErrorTransmitted, lanportpause=lanportpause, priority=priority, staticDns=staticDns, internetPort=internetPort, dscpEnable=dscpEnable, groupEntry=groupEntry, qosTable=qosTable, operStatus=operStatus, qos=qos, speed=speed, adminStatus=adminStatus, hostname=hostname, unicastsTransmitted=unicastsTransmitted, port3=port3, txPower=txPower, portTable=portTable, portIndex=portIndex, jumblan2=jumblan2, portName=portName, lan4=lan4, rxPower=rxPower, multicastsReceived=multicastsReceived, jumbwan=jumbwan, staticIpGateway=staticIpGateway, lanportName=lanportName, qosEntry=qosEntry, portmode=portmode)
