...
# Produced by pysmi-1.1.3 at Sun Nov 28 13:54:52 2021
...
mib_2, Bits, Gauge32, ModuleIdentity, Counter32, IpAddress, iso, MibIdentifier, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, TimeTicks, ObjectIdentity, enterprises, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Bits", "Gauge32", "ModuleIdentity", "Counter32", "IpAddress", "iso", "MibIdentifier", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "TimeTicks", "ObjectIdentity", "enterprises", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", speed=speed, staticIpGateway=staticIpGateway, lanportTable=lanportTable, domainame=domainame, staticIpAddr=staticIpAddr, rebootEnable=rebootEnable, txPower=txPower, temperature=temperature, jumblan2=jumblan2, qmapping=qmapping, wanType=wanType, lanportspeed=lanportspeed, internetPort=internetPort, qosEntry=qosEntry, deviceinfo=deviceinfo, secondaryDns=secondaryDns, vlanid=vlanid, vendorPn=vendorPn, primaryDns=primaryDns, rxPower=rxPower, lan4=lan4, lanportName=lanportName, wan=wan, fcsErrorTransmitted=fcsErrorTransmitted, xg6846=xg6846, groupIndex=groupIndex, portStatEntry=portStatEntry, unicastsTransmitted=unicastsTransmitted, qos=qos, reboot=reboot, statisticTable=statisticTable, portEntry=portEntry, vlan=vlan, serialnum=serialnum, port4=port4, pauseTransmitted=pauseTransmitted, qosIndex=qosIndex, staticIpHostName=staticIpHostName, ddminfo=ddminfo, lanportIndex=lanportIndex, qmode=qmode, jumblan4=jumblan4, tftpSevIp=tftpSevIp, portName=portName, lanportpause=lanportpause, port2=port2, bias=bias, jumblan3=jumblan3, jumb=jumb, lan2=lan2, action=action, port3=port3, staticIpDomainName=staticIpDomainName, portIndex=portIndex, portPower=portPower, catv=catv, broadcastsReceived=broadcastsReceived, fileName=fileName, multicastsTransmitted=multicastsTransmitted, vendorName=vendorName, vlangroupTable=vlangroupTable, staticIpPrimaryDns=staticIpPrimaryDns, modeEntry=modeEntry, staticIpSecondaryDns=staticIpSecondaryDns, fileType=fileType, jumbwan=jumbwan, statIndex=statIndex, hostname=hostname, groupid=groupid, pauseReceived=pauseReceived, qosTable=qosTable, lan3=lan3, dscpEnable=dscpEnable, vendorOui=vendorOui, unicastsReceived=unicastsReceived, vendorRev=vendorRev, voltage=voltage, lan1=lan1, adminStatus=adminStatus, portStatistic=portStatistic, catvEnable=catvEnable, fcsErrorReceived=fcsErrorReceived, portmode=portmode, portTable=portTable, operStatus=operStatus, tftp=tftp, multicastsReceived=multicastsReceived, jumblan1=jumblan1, groupEntry=groupEntry, staticIpSubMask=staticIpSubMask, priority=priority, staticDns=staticDns, broadcastsTransmitted=broadcastsTransmitted, port1=port1)
