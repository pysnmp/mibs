...
# Produced by pysmi-1.1.12 at Fri Jul 19 09:38:05 2024
...
iso, NotificationType, Counter64, MibIdentifier, ObjectIdentity, ModuleIdentity, IpAddress, mib_2, TimeTicks, Integer32, snmpModules, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Counter64", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "IpAddress", "mib-2", "TimeTicks", "Integer32", "snmpModules", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portStatEntry=portStatEntry, broadcastsTransmitted=broadcastsTransmitted, qmode=qmode, wanType=wanType, pauseTransmitted=pauseTransmitted, dscpEnable=dscpEnable, rebootEnable=rebootEnable, portPower=portPower, statIndex=statIndex, rxPower=rxPower, portIndex=portIndex, fileName=fileName, serialnum=serialnum, vendorRev=vendorRev, staticIpPrimaryDns=staticIpPrimaryDns, fcsErrorReceived=fcsErrorReceived, unicastsReceived=unicastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, lanportIndex=lanportIndex, temperature=temperature, portStatistic=portStatistic, lanportspeed=lanportspeed, unicastsTransmitted=unicastsTransmitted, domainame=domainame, vlangroupTable=vlangroupTable, operStatus=operStatus, lanportName=lanportName, wan=wan, xg6846=xg6846, lan1=lan1, lanportTable=lanportTable, staticIpDomainName=staticIpDomainName, speed=speed, jumblan2=jumblan2, voltage=voltage, qmapping=qmapping, action=action, multicastsReceived=multicastsReceived, jumb=jumb, groupid=groupid, secondaryDns=secondaryDns, staticIpSubMask=staticIpSubMask, qosTable=qosTable, txPower=txPower, pauseReceived=pauseReceived, lan2=lan2, port3=port3, hostname=hostname, tftpSevIp=tftpSevIp, portName=portName, qos=qos, vendorOui=vendorOui, staticIpHostName=staticIpHostName, multicastsTransmitted=multicastsTransmitted, reboot=reboot, staticDns=staticDns, port1=port1, bias=bias, catvEnable=catvEnable, groupEntry=groupEntry, vendorPn=vendorPn, jumblan3=jumblan3, adminStatus=adminStatus, broadcastsReceived=broadcastsReceived, qosIndex=qosIndex, ddminfo=ddminfo, modeEntry=modeEntry, vlanid=vlanid, port2=port2, catv=catv, qosEntry=qosEntry, portEntry=portEntry, vendorName=vendorName, priority=priority, portTable=portTable, staticIpSecondaryDns=staticIpSecondaryDns, lan3=lan3, tftp=tftp, jumblan1=jumblan1, staticIpAddr=staticIpAddr, deviceinfo=deviceinfo, jumbwan=jumbwan, statisticTable=statisticTable, lanportpause=lanportpause, port4=port4, portmode=portmode, staticIpGateway=staticIpGateway, vlan=vlan, jumblan4=jumblan4, groupIndex=groupIndex, primaryDns=primaryDns, lan4=lan4, fileType=fileType, internetPort=internetPort)
