...
# Produced by pysmi-1.1.12 at Wed May 29 08:12:29 2024
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", action=action, fcsErrorTransmitted=fcsErrorTransmitted, lanportpause=lanportpause, tftpSevIp=tftpSevIp, qosEntry=qosEntry, serialnum=serialnum, ddminfo=ddminfo, lan1=lan1, qmode=qmode, multicastsReceived=multicastsReceived, portStatistic=portStatistic, portTable=portTable, staticIpAddr=staticIpAddr, tftp=tftp, rebootEnable=rebootEnable, temperature=temperature, lan4=lan4, statisticTable=statisticTable, lanportName=lanportName, bias=bias, voltage=voltage, staticIpGateway=staticIpGateway, lanportspeed=lanportspeed, reboot=reboot, wan=wan, vendorRev=vendorRev, portPower=portPower, staticIpSecondaryDns=staticIpSecondaryDns, vendorName=vendorName, txPower=txPower, statIndex=statIndex, groupid=groupid, hostname=hostname, staticIpDomainName=staticIpDomainName, staticIpPrimaryDns=staticIpPrimaryDns, qosTable=qosTable, staticDns=staticDns, groupEntry=groupEntry, portEntry=portEntry, groupIndex=groupIndex, staticIpHostName=staticIpHostName, broadcastsTransmitted=broadcastsTransmitted, multicastsTransmitted=multicastsTransmitted, portmode=portmode, jumblan3=jumblan3, xg6846=xg6846, jumbwan=jumbwan, lan2=lan2, modeEntry=modeEntry, wanType=wanType, port3=port3, fileType=fileType, portName=portName, staticIpSubMask=staticIpSubMask, speed=speed, qmapping=qmapping, jumb=jumb, broadcastsReceived=broadcastsReceived, jumblan4=jumblan4, lanportIndex=lanportIndex, deviceinfo=deviceinfo, fcsErrorReceived=fcsErrorReceived, primaryDns=primaryDns, jumblan1=jumblan1, portStatEntry=portStatEntry, vendorOui=vendorOui, vlangroupTable=vlangroupTable, jumblan2=jumblan2, vlanid=vlanid, rxPower=rxPower, qos=qos, pauseTransmitted=pauseTransmitted, pauseReceived=pauseReceived, portIndex=portIndex, secondaryDns=secondaryDns, qosIndex=qosIndex, port4=port4, priority=priority, domainame=domainame, catvEnable=catvEnable, port1=port1, internetPort=internetPort, adminStatus=adminStatus, dscpEnable=dscpEnable, catv=catv, operStatus=operStatus, lan3=lan3, vlan=vlan, port2=port2, vendorPn=vendorPn, lanportTable=lanportTable, fileName=fileName, unicastsReceived=unicastsReceived, unicastsTransmitted=unicastsTransmitted)
