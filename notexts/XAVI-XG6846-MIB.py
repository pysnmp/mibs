...
# Produced by pysmi-1.1.8 at Wed Sep  6 13:52:43 2023
...
Integer32, enterprises, MibIdentifier, ModuleIdentity, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, TimeTicks, iso, Gauge32, ObjectIdentity, Unsigned32, Counter32, mib_2, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "MibIdentifier", "ModuleIdentity", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "TimeTicks", "iso", "Gauge32", "ObjectIdentity", "Unsigned32", "Counter32", "mib-2", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan3=lan3, rebootEnable=rebootEnable, jumblan3=jumblan3, portTable=portTable, lanportTable=lanportTable, port4=port4, adminStatus=adminStatus, staticIpSecondaryDns=staticIpSecondaryDns, portStatistic=portStatistic, jumb=jumb, jumblan1=jumblan1, pauseReceived=pauseReceived, vendorOui=vendorOui, staticIpAddr=staticIpAddr, operStatus=operStatus, lanportpause=lanportpause, primaryDns=primaryDns, groupIndex=groupIndex, staticIpHostName=staticIpHostName, lan2=lan2, serialnum=serialnum, portPower=portPower, fileName=fileName, portmode=portmode, pauseTransmitted=pauseTransmitted, qmapping=qmapping, lan1=lan1, dscpEnable=dscpEnable, wan=wan, broadcastsTransmitted=broadcastsTransmitted, port2=port2, fcsErrorReceived=fcsErrorReceived, jumblan4=jumblan4, hostname=hostname, jumblan2=jumblan2, fcsErrorTransmitted=fcsErrorTransmitted, portEntry=portEntry, port3=port3, ddminfo=ddminfo, deviceinfo=deviceinfo, bias=bias, portName=portName, qmode=qmode, staticIpDomainName=staticIpDomainName, lanportIndex=lanportIndex, port1=port1, statisticTable=statisticTable, qosEntry=qosEntry, temperature=temperature, priority=priority, txPower=txPower, jumbwan=jumbwan, catvEnable=catvEnable, domainame=domainame, lanportName=lanportName, internetPort=internetPort, portIndex=portIndex, speed=speed, vendorRev=vendorRev, lan4=lan4, qos=qos, wanType=wanType, vendorPn=vendorPn, multicastsReceived=multicastsReceived, vlan=vlan, vendorName=vendorName, unicastsTransmitted=unicastsTransmitted, qosIndex=qosIndex, groupid=groupid, modeEntry=modeEntry, staticIpSubMask=staticIpSubMask, action=action, vlangroupTable=vlangroupTable, multicastsTransmitted=multicastsTransmitted, catv=catv, staticDns=staticDns, broadcastsReceived=broadcastsReceived, tftpSevIp=tftpSevIp, xg6846=xg6846, rxPower=rxPower, secondaryDns=secondaryDns, vlanid=vlanid, groupEntry=groupEntry, fileType=fileType, reboot=reboot, staticIpPrimaryDns=staticIpPrimaryDns, staticIpGateway=staticIpGateway, lanportspeed=lanportspeed, portStatEntry=portStatEntry, unicastsReceived=unicastsReceived, qosTable=qosTable, voltage=voltage, statIndex=statIndex, tftp=tftp)
