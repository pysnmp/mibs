...
# Produced by pysmi-1.1.8 at Thu Oct 26 11:24:39 2023
...
ObjectIdentity, ModuleIdentity, MibIdentifier, IpAddress, Integer32, NotificationType, iso, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, snmpModules, Bits, Counter64, Unsigned32, Counter32, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "IpAddress", "Integer32", "NotificationType", "iso", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "snmpModules", "Bits", "Counter64", "Unsigned32", "Counter32", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumblan4=jumblan4, jumblan1=jumblan1, wanType=wanType, lanportspeed=lanportspeed, vendorRev=vendorRev, tftpSevIp=tftpSevIp, port3=port3, lanportTable=lanportTable, port4=port4, lan4=lan4, broadcastsReceived=broadcastsReceived, bias=bias, multicastsTransmitted=multicastsTransmitted, qosIndex=qosIndex, jumblan2=jumblan2, qosTable=qosTable, pauseReceived=pauseReceived, portStatEntry=portStatEntry, groupIndex=groupIndex, multicastsReceived=multicastsReceived, fcsErrorReceived=fcsErrorReceived, port2=port2, lan1=lan1, qmapping=qmapping, action=action, fileType=fileType, lan2=lan2, voltage=voltage, staticIpAddr=staticIpAddr, fileName=fileName, portTable=portTable, staticIpDomainName=staticIpDomainName, vendorPn=vendorPn, staticIpSecondaryDns=staticIpSecondaryDns, rxPower=rxPower, portmode=portmode, qos=qos, statIndex=statIndex, internetPort=internetPort, modeEntry=modeEntry, temperature=temperature, hostname=hostname, vendorOui=vendorOui, portStatistic=portStatistic, broadcastsTransmitted=broadcastsTransmitted, tftp=tftp, portEntry=portEntry, staticIpGateway=staticIpGateway, qmode=qmode, deviceinfo=deviceinfo, txPower=txPower, secondaryDns=secondaryDns, lanportpause=lanportpause, wan=wan, portIndex=portIndex, groupEntry=groupEntry, vendorName=vendorName, lan3=lan3, staticDns=staticDns, unicastsReceived=unicastsReceived, pauseTransmitted=pauseTransmitted, priority=priority, fcsErrorTransmitted=fcsErrorTransmitted, dscpEnable=dscpEnable, portPower=portPower, staticIpPrimaryDns=staticIpPrimaryDns, jumblan3=jumblan3, reboot=reboot, unicastsTransmitted=unicastsTransmitted, rebootEnable=rebootEnable, speed=speed, domainame=domainame, vlangroupTable=vlangroupTable, catvEnable=catvEnable, adminStatus=adminStatus, portName=portName, vlanid=vlanid, xg6846=xg6846, statisticTable=statisticTable, qosEntry=qosEntry, serialnum=serialnum, port1=port1, vlan=vlan, groupid=groupid, lanportIndex=lanportIndex, operStatus=operStatus, ddminfo=ddminfo, staticIpSubMask=staticIpSubMask, jumbwan=jumbwan, staticIpHostName=staticIpHostName, catv=catv, lanportName=lanportName, primaryDns=primaryDns, jumb=jumb)
