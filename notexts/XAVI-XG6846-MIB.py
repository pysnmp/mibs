...
Bits, TimeTicks, IpAddress, Gauge32, snmpModules, NotificationType, enterprises, ModuleIdentity, ObjectIdentity, Counter64, MibIdentifier, Unsigned32, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "IpAddress", "Gauge32", "snmpModules", "NotificationType", "enterprises", "ModuleIdentity", "ObjectIdentity", "Counter64", "MibIdentifier", "Unsigned32", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", unicastsTransmitted=unicastsTransmitted, voltage=voltage, groupid=groupid, speed=speed, portTable=portTable, wan=wan, jumbwan=jumbwan, groupIndex=groupIndex, portName=portName, fileType=fileType, vendorName=vendorName, jumblan3=jumblan3, staticIpSubMask=staticIpSubMask, multicastsTransmitted=multicastsTransmitted, staticIpAddr=staticIpAddr, jumblan2=jumblan2, vlangroupTable=vlangroupTable, statisticTable=statisticTable, internetPort=internetPort, priority=priority, staticIpPrimaryDns=staticIpPrimaryDns, pauseReceived=pauseReceived, broadcastsReceived=broadcastsReceived, operStatus=operStatus, pauseTransmitted=pauseTransmitted, fcsErrorTransmitted=fcsErrorTransmitted, portmode=portmode, lanportIndex=lanportIndex, groupEntry=groupEntry, txPower=txPower, wanType=wanType, action=action, lanportTable=lanportTable, portPower=portPower, portEntry=portEntry, lanportpause=lanportpause, lanportName=lanportName, secondaryDns=secondaryDns, temperature=temperature, staticDns=staticDns, catvEnable=catvEnable, qmapping=qmapping, catv=catv, port4=port4, jumb=jumb, broadcastsTransmitted=broadcastsTransmitted, reboot=reboot, portIndex=portIndex, statIndex=statIndex, deviceinfo=deviceinfo, qosIndex=qosIndex, lan3=lan3, dscpEnable=dscpEnable, staticIpGateway=staticIpGateway, fileName=fileName, bias=bias, vendorRev=vendorRev, staticIpDomainName=staticIpDomainName, lan2=lan2, portStatistic=portStatistic, rxPower=rxPower, primaryDns=primaryDns, hostname=hostname, port2=port2, qosEntry=qosEntry, qmode=qmode, jumblan4=jumblan4, qos=qos, vlan=vlan, lanportspeed=lanportspeed, portStatEntry=portStatEntry, qosTable=qosTable, domainame=domainame, fcsErrorReceived=fcsErrorReceived, tftpSevIp=tftpSevIp, port1=port1, port3=port3, ddminfo=ddminfo, adminStatus=adminStatus, rebootEnable=rebootEnable, vendorPn=vendorPn, staticIpSecondaryDns=staticIpSecondaryDns, modeEntry=modeEntry, staticIpHostName=staticIpHostName, lan1=lan1, multicastsReceived=multicastsReceived, xg6846=xg6846, vendorOui=vendorOui, jumblan1=jumblan1, serialnum=serialnum, unicastsReceived=unicastsReceived, vlanid=vlanid, tftp=tftp, lan4=lan4)
