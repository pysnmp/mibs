...
MibIdentifier, IpAddress, Counter64, ModuleIdentity, Gauge32, ObjectIdentity, Unsigned32, Counter32, enterprises, Bits, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, TimeTicks, mib_2, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "Counter64", "ModuleIdentity", "Gauge32", "ObjectIdentity", "Unsigned32", "Counter32", "enterprises", "Bits", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "TimeTicks", "mib-2", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", adminStatus=adminStatus, staticIpPrimaryDns=staticIpPrimaryDns, qmapping=qmapping, vlanid=vlanid, staticIpGateway=staticIpGateway, staticIpSubMask=staticIpSubMask, port3=port3, portStatistic=portStatistic, port4=port4, portEntry=portEntry, qos=qos, portPower=portPower, staticIpSecondaryDns=staticIpSecondaryDns, jumblan3=jumblan3, tftpSevIp=tftpSevIp, unicastsReceived=unicastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, staticIpHostName=staticIpHostName, qosIndex=qosIndex, rxPower=rxPower, lanportTable=lanportTable, lan4=lan4, priority=priority, domainame=domainame, speed=speed, internetPort=internetPort, lanportpause=lanportpause, port1=port1, action=action, portName=portName, pauseReceived=pauseReceived, catvEnable=catvEnable, secondaryDns=secondaryDns, vendorPn=vendorPn, multicastsTransmitted=multicastsTransmitted, bias=bias, fileType=fileType, groupid=groupid, staticDns=staticDns, catv=catv, statIndex=statIndex, lanportIndex=lanportIndex, wan=wan, multicastsReceived=multicastsReceived, voltage=voltage, hostname=hostname, broadcastsReceived=broadcastsReceived, jumbwan=jumbwan, serialnum=serialnum, lanportName=lanportName, vendorName=vendorName, groupIndex=groupIndex, statisticTable=statisticTable, rebootEnable=rebootEnable, dscpEnable=dscpEnable, tftp=tftp, pauseTransmitted=pauseTransmitted, staticIpAddr=staticIpAddr, fileName=fileName, vlan=vlan, vlangroupTable=vlangroupTable, port2=port2, ddminfo=ddminfo, broadcastsTransmitted=broadcastsTransmitted, vendorOui=vendorOui, qmode=qmode, modeEntry=modeEntry, operStatus=operStatus, portIndex=portIndex, wanType=wanType, qosEntry=qosEntry, deviceinfo=deviceinfo, reboot=reboot, fcsErrorReceived=fcsErrorReceived, jumblan4=jumblan4, lan3=lan3, lanportspeed=lanportspeed, unicastsTransmitted=unicastsTransmitted, staticIpDomainName=staticIpDomainName, vendorRev=vendorRev, qosTable=qosTable, jumb=jumb, portStatEntry=portStatEntry, txPower=txPower, primaryDns=primaryDns, jumblan2=jumblan2, lan2=lan2, groupEntry=groupEntry, lan1=lan1, portTable=portTable, temperature=temperature, jumblan1=jumblan1, portmode=portmode, xg6846=xg6846)
