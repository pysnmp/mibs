...
# Produced by pysmi-1.1.3 at Sat Nov 20 22:35:43 2021
...
NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, snmpModules, IpAddress, Counter64, enterprises, iso, Bits, TimeTicks, ModuleIdentity, Counter32, Gauge32, MibIdentifier, Unsigned32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "snmpModules", "IpAddress", "Counter64", "enterprises", "iso", "Bits", "TimeTicks", "ModuleIdentity", "Counter32", "Gauge32", "MibIdentifier", "Unsigned32", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", speed=speed, qmode=qmode, staticIpAddr=staticIpAddr, tftp=tftp, portmode=portmode, vendorPn=vendorPn, ddminfo=ddminfo, rxPower=rxPower, temperature=temperature, internetPort=internetPort, fcsErrorTransmitted=fcsErrorTransmitted, voltage=voltage, lanportIndex=lanportIndex, lan4=lan4, lanportName=lanportName, operStatus=operStatus, reboot=reboot, pauseReceived=pauseReceived, unicastsReceived=unicastsReceived, multicastsReceived=multicastsReceived, tftpSevIp=tftpSevIp, dscpEnable=dscpEnable, priority=priority, catvEnable=catvEnable, multicastsTransmitted=multicastsTransmitted, xg6846=xg6846, bias=bias, staticIpGateway=staticIpGateway, qosEntry=qosEntry, fileType=fileType, port3=port3, staticIpHostName=staticIpHostName, qos=qos, portStatistic=portStatistic, lanportspeed=lanportspeed, broadcastsTransmitted=broadcastsTransmitted, adminStatus=adminStatus, statIndex=statIndex, jumblan4=jumblan4, domainame=domainame, jumb=jumb, staticIpSubMask=staticIpSubMask, pauseTransmitted=pauseTransmitted, catv=catv, qmapping=qmapping, vendorName=vendorName, vlanid=vlanid, modeEntry=modeEntry, statisticTable=statisticTable, jumblan3=jumblan3, port2=port2, fcsErrorReceived=fcsErrorReceived, jumbwan=jumbwan, portName=portName, wanType=wanType, staticDns=staticDns, txPower=txPower, hostname=hostname, lanportpause=lanportpause, jumblan2=jumblan2, port4=port4, jumblan1=jumblan1, lanportTable=lanportTable, fileName=fileName, groupid=groupid, vendorOui=vendorOui, portPower=portPower, wan=wan, port1=port1, action=action, staticIpPrimaryDns=staticIpPrimaryDns, groupEntry=groupEntry, qosTable=qosTable, lan2=lan2, vendorRev=vendorRev, vlan=vlan, vlangroupTable=vlangroupTable, portEntry=portEntry, qosIndex=qosIndex, staticIpSecondaryDns=staticIpSecondaryDns, primaryDns=primaryDns, staticIpDomainName=staticIpDomainName, lan3=lan3, portIndex=portIndex, lan1=lan1, deviceinfo=deviceinfo, broadcastsReceived=broadcastsReceived, unicastsTransmitted=unicastsTransmitted, portTable=portTable, rebootEnable=rebootEnable, portStatEntry=portStatEntry, serialnum=serialnum, groupIndex=groupIndex, secondaryDns=secondaryDns)
