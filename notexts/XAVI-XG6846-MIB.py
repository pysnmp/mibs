...
Counter64, NotificationType, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32, IpAddress, Unsigned32, iso, ObjectIdentity, ModuleIdentity, Gauge32, Bits, MibIdentifier, snmpModules, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32", "IpAddress", "Unsigned32", "iso", "ObjectIdentity", "ModuleIdentity", "Gauge32", "Bits", "MibIdentifier", "snmpModules", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumblan1=jumblan1, vlanid=vlanid, fileName=fileName, wan=wan, xg6846=xg6846, staticIpPrimaryDns=staticIpPrimaryDns, lan2=lan2, portName=portName, multicastsReceived=multicastsReceived, modeEntry=modeEntry, portmode=portmode, bias=bias, portPower=portPower, secondaryDns=secondaryDns, action=action, pauseTransmitted=pauseTransmitted, primaryDns=primaryDns, domainame=domainame, qos=qos, staticIpSecondaryDns=staticIpSecondaryDns, vendorName=vendorName, lanportIndex=lanportIndex, lan4=lan4, pauseReceived=pauseReceived, multicastsTransmitted=multicastsTransmitted, lanportpause=lanportpause, groupEntry=groupEntry, vendorOui=vendorOui, lanportTable=lanportTable, broadcastsReceived=broadcastsReceived, staticDns=staticDns, staticIpHostName=staticIpHostName, lan3=lan3, fcsErrorReceived=fcsErrorReceived, tftp=tftp, lanportspeed=lanportspeed, port2=port2, staticIpAddr=staticIpAddr, catv=catv, adminStatus=adminStatus, qmapping=qmapping, ddminfo=ddminfo, vlangroupTable=vlangroupTable, vendorPn=vendorPn, portTable=portTable, rxPower=rxPower, jumblan3=jumblan3, tftpSevIp=tftpSevIp, qosEntry=qosEntry, groupIndex=groupIndex, temperature=temperature, qosIndex=qosIndex, reboot=reboot, catvEnable=catvEnable, txPower=txPower, speed=speed, jumblan2=jumblan2, wanType=wanType, jumbwan=jumbwan, qmode=qmode, lanportName=lanportName, staticIpGateway=staticIpGateway, hostname=hostname, staticIpDomainName=staticIpDomainName, fileType=fileType, portStatEntry=portStatEntry, jumb=jumb, dscpEnable=dscpEnable, priority=priority, staticIpSubMask=staticIpSubMask, statIndex=statIndex, vlan=vlan, lan1=lan1, unicastsReceived=unicastsReceived, rebootEnable=rebootEnable, jumblan4=jumblan4, portIndex=portIndex, internetPort=internetPort, unicastsTransmitted=unicastsTransmitted, voltage=voltage, operStatus=operStatus, serialnum=serialnum, port3=port3, port4=port4, groupid=groupid, vendorRev=vendorRev, deviceinfo=deviceinfo, port1=port1, broadcastsTransmitted=broadcastsTransmitted, fcsErrorTransmitted=fcsErrorTransmitted, portStatistic=portStatistic, qosTable=qosTable, portEntry=portEntry, statisticTable=statisticTable)
