...
Unsigned32, Counter64, IpAddress, Integer32, iso, mib_2, ModuleIdentity, MibIdentifier, Gauge32, Counter32, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Bits, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter64", "IpAddress", "Integer32", "iso", "mib-2", "ModuleIdentity", "MibIdentifier", "Gauge32", "Counter32", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Bits", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorOui=vendorOui, lanportpause=lanportpause, txPower=txPower, lanportTable=lanportTable, jumblan1=jumblan1, qmode=qmode, staticIpSecondaryDns=staticIpSecondaryDns, lan4=lan4, serialnum=serialnum, pauseReceived=pauseReceived, unicastsReceived=unicastsReceived, port1=port1, wan=wan, vlan=vlan, multicastsReceived=multicastsReceived, priority=priority, fileType=fileType, tftp=tftp, catvEnable=catvEnable, voltage=voltage, dscpEnable=dscpEnable, jumbwan=jumbwan, portPower=portPower, lanportspeed=lanportspeed, vendorName=vendorName, lanportIndex=lanportIndex, portStatistic=portStatistic, jumb=jumb, portName=portName, hostname=hostname, portStatEntry=portStatEntry, lan3=lan3, lan2=lan2, lanportName=lanportName, adminStatus=adminStatus, reboot=reboot, fcsErrorReceived=fcsErrorReceived, wanType=wanType, groupEntry=groupEntry, action=action, port4=port4, statIndex=statIndex, portIndex=portIndex, vendorRev=vendorRev, primaryDns=primaryDns, portTable=portTable, vendorPn=vendorPn, rxPower=rxPower, unicastsTransmitted=unicastsTransmitted, vlanid=vlanid, groupIndex=groupIndex, speed=speed, staticIpAddr=staticIpAddr, qmapping=qmapping, portmode=portmode, qosEntry=qosEntry, qosIndex=qosIndex, catv=catv, groupid=groupid, lan1=lan1, statisticTable=statisticTable, domainame=domainame, qosTable=qosTable, fcsErrorTransmitted=fcsErrorTransmitted, jumblan4=jumblan4, ddminfo=ddminfo, staticIpSubMask=staticIpSubMask, port2=port2, multicastsTransmitted=multicastsTransmitted, staticDns=staticDns, staticIpHostName=staticIpHostName, staticIpPrimaryDns=staticIpPrimaryDns, modeEntry=modeEntry, portEntry=portEntry, rebootEnable=rebootEnable, operStatus=operStatus, vlangroupTable=vlangroupTable, temperature=temperature, pauseTransmitted=pauseTransmitted, fileName=fileName, broadcastsTransmitted=broadcastsTransmitted, xg6846=xg6846, internetPort=internetPort, staticIpDomainName=staticIpDomainName, tftpSevIp=tftpSevIp, port3=port3, deviceinfo=deviceinfo, jumblan2=jumblan2, broadcastsReceived=broadcastsReceived, staticIpGateway=staticIpGateway, qos=qos, bias=bias, jumblan3=jumblan3, secondaryDns=secondaryDns)
