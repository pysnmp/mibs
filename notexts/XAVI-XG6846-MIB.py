...
# Produced by pysmi-1.1.8 at Tue Jan 11 21:31:13 2022
...
ObjectIdentity, snmpModules, NotificationType, IpAddress, MibIdentifier, Bits, Counter64, Unsigned32, Integer32, enterprises, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, mib_2, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "snmpModules", "NotificationType", "IpAddress", "MibIdentifier", "Bits", "Counter64", "Unsigned32", "Integer32", "enterprises", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "mib-2", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catv=catv, staticIpPrimaryDns=staticIpPrimaryDns, dscpEnable=dscpEnable, modeEntry=modeEntry, fileType=fileType, lan1=lan1, jumblan3=jumblan3, vlan=vlan, adminStatus=adminStatus, secondaryDns=secondaryDns, port3=port3, txPower=txPower, tftpSevIp=tftpSevIp, staticIpGateway=staticIpGateway, vendorPn=vendorPn, pauseReceived=pauseReceived, rebootEnable=rebootEnable, portmode=portmode, lan2=lan2, staticIpSecondaryDns=staticIpSecondaryDns, domainame=domainame, lanportpause=lanportpause, rxPower=rxPower, lan3=lan3, internetPort=internetPort, catvEnable=catvEnable, port4=port4, statIndex=statIndex, jumb=jumb, port2=port2, port1=port1, vendorName=vendorName, vlanid=vlanid, bias=bias, qosTable=qosTable, lanportTable=lanportTable, ddminfo=ddminfo, multicastsTransmitted=multicastsTransmitted, pauseTransmitted=pauseTransmitted, tftp=tftp, portTable=portTable, fcsErrorReceived=fcsErrorReceived, qos=qos, fileName=fileName, action=action, portStatEntry=portStatEntry, jumblan4=jumblan4, broadcastsTransmitted=broadcastsTransmitted, serialnum=serialnum, portStatistic=portStatistic, qosIndex=qosIndex, speed=speed, qosEntry=qosEntry, vendorOui=vendorOui, temperature=temperature, unicastsTransmitted=unicastsTransmitted, hostname=hostname, jumbwan=jumbwan, lanportName=lanportName, portPower=portPower, multicastsReceived=multicastsReceived, staticIpAddr=staticIpAddr, vendorRev=vendorRev, staticIpDomainName=staticIpDomainName, priority=priority, jumblan1=jumblan1, reboot=reboot, portEntry=portEntry, xg6846=xg6846, operStatus=operStatus, groupid=groupid, staticIpSubMask=staticIpSubMask, qmapping=qmapping, statisticTable=statisticTable, unicastsReceived=unicastsReceived, groupIndex=groupIndex, primaryDns=primaryDns, voltage=voltage, staticDns=staticDns, staticIpHostName=staticIpHostName, fcsErrorTransmitted=fcsErrorTransmitted, portIndex=portIndex, vlangroupTable=vlangroupTable, jumblan2=jumblan2, wan=wan, portName=portName, broadcastsReceived=broadcastsReceived, deviceinfo=deviceinfo, lanportspeed=lanportspeed, lanportIndex=lanportIndex, wanType=wanType, qmode=qmode, groupEntry=groupEntry, lan4=lan4)
