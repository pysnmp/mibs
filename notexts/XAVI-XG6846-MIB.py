...
# Produced by pysmi-1.1.3 at Tue Nov 30 02:29:30 2021
...
enterprises, mib_2, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, Counter64, MibIdentifier, NotificationType, Integer32, Bits, ModuleIdentity, ObjectIdentity, Counter32, IpAddress, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "mib-2", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "Counter64", "MibIdentifier", "NotificationType", "Integer32", "Bits", "ModuleIdentity", "ObjectIdentity", "Counter32", "IpAddress", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", tftpSevIp=tftpSevIp, pauseTransmitted=pauseTransmitted, port3=port3, portPower=portPower, lanportpause=lanportpause, fileType=fileType, voltage=voltage, jumblan4=jumblan4, vendorRev=vendorRev, vendorName=vendorName, staticIpHostName=staticIpHostName, jumblan2=jumblan2, lanportTable=lanportTable, vendorOui=vendorOui, port1=port1, jumbwan=jumbwan, lan3=lan3, vlanid=vlanid, pauseReceived=pauseReceived, ddminfo=ddminfo, staticIpSecondaryDns=staticIpSecondaryDns, jumblan1=jumblan1, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSubMask=staticIpSubMask, internetPort=internetPort, port4=port4, temperature=temperature, fcsErrorTransmitted=fcsErrorTransmitted, xg6846=xg6846, fileName=fileName, staticIpAddr=staticIpAddr, port2=port2, lan2=lan2, qosEntry=qosEntry, multicastsTransmitted=multicastsTransmitted, broadcastsReceived=broadcastsReceived, qosTable=qosTable, hostname=hostname, unicastsTransmitted=unicastsTransmitted, deviceinfo=deviceinfo, portEntry=portEntry, staticIpGateway=staticIpGateway, jumb=jumb, lanportName=lanportName, vlan=vlan, qos=qos, tftp=tftp, vlangroupTable=vlangroupTable, jumblan3=jumblan3, groupIndex=groupIndex, groupid=groupid, lan1=lan1, serialnum=serialnum, adminStatus=adminStatus, vendorPn=vendorPn, lanportspeed=lanportspeed, speed=speed, qmapping=qmapping, wanType=wanType, action=action, rxPower=rxPower, unicastsReceived=unicastsReceived, staticIpDomainName=staticIpDomainName, catvEnable=catvEnable, modeEntry=modeEntry, staticDns=staticDns, operStatus=operStatus, portmode=portmode, lan4=lan4, statisticTable=statisticTable, catv=catv, groupEntry=groupEntry, rebootEnable=rebootEnable, domainame=domainame, qosIndex=qosIndex, portName=portName, multicastsReceived=multicastsReceived, wan=wan, portStatEntry=portStatEntry, broadcastsTransmitted=broadcastsTransmitted, bias=bias, priority=priority, lanportIndex=lanportIndex, secondaryDns=secondaryDns, dscpEnable=dscpEnable, reboot=reboot, qmode=qmode, portIndex=portIndex, portTable=portTable, portStatistic=portStatistic, fcsErrorReceived=fcsErrorReceived, txPower=txPower, primaryDns=primaryDns, statIndex=statIndex)
