...
# Produced by pysmi-1.1.12 at Fri Jul 19 08:57:12 2024
...
Counter32, Gauge32, snmpModules, iso, ModuleIdentity, TimeTicks, enterprises, IpAddress, Unsigned32, NotificationType, ObjectIdentity, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, mib_2, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "snmpModules", "iso", "ModuleIdentity", "TimeTicks", "enterprises", "IpAddress", "Unsigned32", "NotificationType", "ObjectIdentity", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "mib-2", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", speed=speed, ddminfo=ddminfo, vlangroupTable=vlangroupTable, vendorName=vendorName, catvEnable=catvEnable, staticIpGateway=staticIpGateway, catv=catv, portIndex=portIndex, bias=bias, jumb=jumb, groupid=groupid, wanType=wanType, port3=port3, lanportIndex=lanportIndex, priority=priority, staticIpPrimaryDns=staticIpPrimaryDns, secondaryDns=secondaryDns, modeEntry=modeEntry, lan2=lan2, portName=portName, fcsErrorReceived=fcsErrorReceived, groupIndex=groupIndex, staticIpDomainName=staticIpDomainName, staticIpSubMask=staticIpSubMask, pauseReceived=pauseReceived, vendorPn=vendorPn, staticIpSecondaryDns=staticIpSecondaryDns, operStatus=operStatus, tftp=tftp, qosTable=qosTable, lanportName=lanportName, adminStatus=adminStatus, vendorRev=vendorRev, pauseTransmitted=pauseTransmitted, statisticTable=statisticTable, port2=port2, action=action, dscpEnable=dscpEnable, jumblan1=jumblan1, lanportspeed=lanportspeed, domainame=domainame, portPower=portPower, vlanid=vlanid, hostname=hostname, portmode=portmode, statIndex=statIndex, portTable=portTable, multicastsReceived=multicastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, broadcastsTransmitted=broadcastsTransmitted, portEntry=portEntry, tftpSevIp=tftpSevIp, lanportpause=lanportpause, temperature=temperature, rebootEnable=rebootEnable, qosIndex=qosIndex, txPower=txPower, portStatistic=portStatistic, jumbwan=jumbwan, serialnum=serialnum, broadcastsReceived=broadcastsReceived, jumblan3=jumblan3, multicastsTransmitted=multicastsTransmitted, lan3=lan3, qmapping=qmapping, primaryDns=primaryDns, rxPower=rxPower, deviceinfo=deviceinfo, vendorOui=vendorOui, groupEntry=groupEntry, unicastsTransmitted=unicastsTransmitted, fileName=fileName, unicastsReceived=unicastsReceived, lan4=lan4, qmode=qmode, reboot=reboot, voltage=voltage, fileType=fileType, jumblan2=jumblan2, lan1=lan1, lanportTable=lanportTable, staticDns=staticDns, port1=port1, port4=port4, qos=qos, staticIpHostName=staticIpHostName, xg6846=xg6846, qosEntry=qosEntry, internetPort=internetPort, wan=wan, jumblan4=jumblan4, vlan=vlan, portStatEntry=portStatEntry, staticIpAddr=staticIpAddr)
