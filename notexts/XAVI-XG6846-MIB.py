...
ModuleIdentity, enterprises, Gauge32, NotificationType, snmpModules, TimeTicks, mib_2, ObjectIdentity, MibIdentifier, Counter64, iso, Unsigned32, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "Gauge32", "NotificationType", "snmpModules", "TimeTicks", "mib-2", "ObjectIdentity", "MibIdentifier", "Counter64", "iso", "Unsigned32", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", serialnum=serialnum, txPower=txPower, jumblan1=jumblan1, bias=bias, hostname=hostname, dscpEnable=dscpEnable, vlangroupTable=vlangroupTable, multicastsTransmitted=multicastsTransmitted, modeEntry=modeEntry, portPower=portPower, staticIpGateway=staticIpGateway, primaryDns=primaryDns, portmode=portmode, broadcastsTransmitted=broadcastsTransmitted, qmode=qmode, tftp=tftp, staticIpDomainName=staticIpDomainName, pauseReceived=pauseReceived, staticIpAddr=staticIpAddr, adminStatus=adminStatus, portIndex=portIndex, rxPower=rxPower, lan1=lan1, unicastsTransmitted=unicastsTransmitted, rebootEnable=rebootEnable, staticIpHostName=staticIpHostName, lanportIndex=lanportIndex, vendorRev=vendorRev, groupid=groupid, lanportspeed=lanportspeed, staticDns=staticDns, qosTable=qosTable, groupEntry=groupEntry, lan2=lan2, tftpSevIp=tftpSevIp, action=action, qmapping=qmapping, vlanid=vlanid, vendorOui=vendorOui, domainame=domainame, jumbwan=jumbwan, vlan=vlan, secondaryDns=secondaryDns, lanportName=lanportName, portEntry=portEntry, jumblan3=jumblan3, internetPort=internetPort, fcsErrorTransmitted=fcsErrorTransmitted, port4=port4, port1=port1, pauseTransmitted=pauseTransmitted, portStatistic=portStatistic, staticIpSecondaryDns=staticIpSecondaryDns, qosIndex=qosIndex, lanportpause=lanportpause, temperature=temperature, port3=port3, fileName=fileName, priority=priority, statIndex=statIndex, fileType=fileType, multicastsReceived=multicastsReceived, vendorName=vendorName, lan3=lan3, catvEnable=catvEnable, qos=qos, wanType=wanType, statisticTable=statisticTable, ddminfo=ddminfo, catv=catv, groupIndex=groupIndex, lanportTable=lanportTable, jumblan2=jumblan2, jumb=jumb, speed=speed, wan=wan, staticIpSubMask=staticIpSubMask, port2=port2, voltage=voltage, reboot=reboot, unicastsReceived=unicastsReceived, portStatEntry=portStatEntry, staticIpPrimaryDns=staticIpPrimaryDns, fcsErrorReceived=fcsErrorReceived, operStatus=operStatus, broadcastsReceived=broadcastsReceived, xg6846=xg6846, qosEntry=qosEntry, portName=portName, vendorPn=vendorPn, lan4=lan4, portTable=portTable, deviceinfo=deviceinfo, jumblan4=jumblan4)
