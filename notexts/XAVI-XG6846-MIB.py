...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:21:44 2022
...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, snmpModules, ModuleIdentity, enterprises, iso, MibIdentifier, ObjectIdentity, mib_2, Gauge32, TimeTicks, Bits, Counter32, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "snmpModules", "ModuleIdentity", "enterprises", "iso", "MibIdentifier", "ObjectIdentity", "mib-2", "Gauge32", "TimeTicks", "Bits", "Counter32", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", domainame=domainame, staticIpSecondaryDns=staticIpSecondaryDns, lanportIndex=lanportIndex, fileType=fileType, lan3=lan3, wan=wan, staticIpHostName=staticIpHostName, portStatistic=portStatistic, lanportspeed=lanportspeed, temperature=temperature, lan4=lan4, jumb=jumb, lan1=lan1, vendorName=vendorName, hostname=hostname, multicastsTransmitted=multicastsTransmitted, tftp=tftp, rxPower=rxPower, staticDns=staticDns, primaryDns=primaryDns, staticIpAddr=staticIpAddr, groupEntry=groupEntry, lanportName=lanportName, dscpEnable=dscpEnable, fcsErrorReceived=fcsErrorReceived, portTable=portTable, qos=qos, ddminfo=ddminfo, speed=speed, jumblan3=jumblan3, unicastsTransmitted=unicastsTransmitted, wanType=wanType, qosTable=qosTable, modeEntry=modeEntry, jumbwan=jumbwan, groupIndex=groupIndex, catv=catv, portmode=portmode, txPower=txPower, internetPort=internetPort, portPower=portPower, broadcastsReceived=broadcastsReceived, priority=priority, portEntry=portEntry, staticIpDomainName=staticIpDomainName, vendorOui=vendorOui, staticIpPrimaryDns=staticIpPrimaryDns, fileName=fileName, port4=port4, multicastsReceived=multicastsReceived, qmapping=qmapping, statisticTable=statisticTable, xg6846=xg6846, pauseTransmitted=pauseTransmitted, port1=port1, jumblan1=jumblan1, portName=portName, portIndex=portIndex, reboot=reboot, catvEnable=catvEnable, portStatEntry=portStatEntry, unicastsReceived=unicastsReceived, vlanid=vlanid, port2=port2, qosIndex=qosIndex, statIndex=statIndex, vlangroupTable=vlangroupTable, staticIpGateway=staticIpGateway, tftpSevIp=tftpSevIp, secondaryDns=secondaryDns, vlan=vlan, action=action, groupid=groupid, pauseReceived=pauseReceived, qosEntry=qosEntry, serialnum=serialnum, operStatus=operStatus, lanportpause=lanportpause, lan2=lan2, port3=port3, lanportTable=lanportTable, jumblan4=jumblan4, voltage=voltage, rebootEnable=rebootEnable, vendorRev=vendorRev, jumblan2=jumblan2, broadcastsTransmitted=broadcastsTransmitted, qmode=qmode, deviceinfo=deviceinfo, adminStatus=adminStatus, bias=bias, staticIpSubMask=staticIpSubMask, vendorPn=vendorPn, fcsErrorTransmitted=fcsErrorTransmitted)
