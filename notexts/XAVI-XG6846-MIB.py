...
# Produced by pysmi-1.1.11 at Wed Apr  3 14:00:59 2024
...
Integer32, Bits, enterprises, mib_2, ObjectIdentity, Counter64, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, MibIdentifier, NotificationType, Gauge32, TimeTicks, iso, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "enterprises", "mib-2", "ObjectIdentity", "Counter64", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "MibIdentifier", "NotificationType", "Gauge32", "TimeTicks", "iso", "ModuleIdentity", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorPn=vendorPn, lanportName=lanportName, rebootEnable=rebootEnable, hostname=hostname, lanportTable=lanportTable, groupid=groupid, port2=port2, speed=speed, staticIpPrimaryDns=staticIpPrimaryDns, adminStatus=adminStatus, port3=port3, primaryDns=primaryDns, operStatus=operStatus, vlanid=vlanid, portStatEntry=portStatEntry, multicastsTransmitted=multicastsTransmitted, action=action, fileType=fileType, jumbwan=jumbwan, wanType=wanType, catvEnable=catvEnable, port1=port1, wan=wan, portIndex=portIndex, portName=portName, portmode=portmode, dscpEnable=dscpEnable, lanportIndex=lanportIndex, portEntry=portEntry, portStatistic=portStatistic, lan1=lan1, rxPower=rxPower, jumb=jumb, statIndex=statIndex, staticIpDomainName=staticIpDomainName, lan4=lan4, fcsErrorReceived=fcsErrorReceived, unicastsTransmitted=unicastsTransmitted, vendorOui=vendorOui, tftpSevIp=tftpSevIp, staticIpSecondaryDns=staticIpSecondaryDns, temperature=temperature, broadcastsReceived=broadcastsReceived, statisticTable=statisticTable, pauseReceived=pauseReceived, pauseTransmitted=pauseTransmitted, vlan=vlan, broadcastsTransmitted=broadcastsTransmitted, fileName=fileName, qosEntry=qosEntry, staticIpSubMask=staticIpSubMask, lanportpause=lanportpause, xg6846=xg6846, bias=bias, portTable=portTable, lanportspeed=lanportspeed, catv=catv, vlangroupTable=vlangroupTable, lan3=lan3, fcsErrorTransmitted=fcsErrorTransmitted, vendorRev=vendorRev, internetPort=internetPort, port4=port4, qmapping=qmapping, unicastsReceived=unicastsReceived, serialnum=serialnum, staticDns=staticDns, staticIpGateway=staticIpGateway, jumblan1=jumblan1, tftp=tftp, staticIpAddr=staticIpAddr, lan2=lan2, voltage=voltage, qosIndex=qosIndex, jumblan2=jumblan2, reboot=reboot, secondaryDns=secondaryDns, portPower=portPower, groupEntry=groupEntry, ddminfo=ddminfo, priority=priority, qos=qos, multicastsReceived=multicastsReceived, deviceinfo=deviceinfo, jumblan3=jumblan3, vendorName=vendorName, txPower=txPower, jumblan4=jumblan4, groupIndex=groupIndex, qosTable=qosTable, staticIpHostName=staticIpHostName, modeEntry=modeEntry, qmode=qmode, domainame=domainame)
