...
# Produced by pysmi-1.1.10 at Wed Nov 15 02:39:46 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, Gauge32, enterprises, ObjectIdentity, MibIdentifier, IpAddress, iso, ModuleIdentity, snmpModules, Counter32, TimeTicks, Bits, Unsigned32, mib_2, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "Gauge32", "enterprises", "ObjectIdentity", "MibIdentifier", "IpAddress", "iso", "ModuleIdentity", "snmpModules", "Counter32", "TimeTicks", "Bits", "Unsigned32", "mib-2", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpSecondaryDns=staticIpSecondaryDns, vlanid=vlanid, fileName=fileName, broadcastsTransmitted=broadcastsTransmitted, unicastsReceived=unicastsReceived, primaryDns=primaryDns, tftp=tftp, portTable=portTable, portName=portName, port1=port1, qmapping=qmapping, action=action, ddminfo=ddminfo, lanportpause=lanportpause, fcsErrorTransmitted=fcsErrorTransmitted, rebootEnable=rebootEnable, jumblan1=jumblan1, portmode=portmode, lan3=lan3, staticIpSubMask=staticIpSubMask, multicastsTransmitted=multicastsTransmitted, modeEntry=modeEntry, vendorRev=vendorRev, broadcastsReceived=broadcastsReceived, speed=speed, staticIpHostName=staticIpHostName, port3=port3, staticIpPrimaryDns=staticIpPrimaryDns, jumblan3=jumblan3, secondaryDns=secondaryDns, vendorName=vendorName, portIndex=portIndex, vendorOui=vendorOui, pauseTransmitted=pauseTransmitted, wan=wan, port4=port4, pauseReceived=pauseReceived, serialnum=serialnum, lanportTable=lanportTable, lan4=lan4, jumblan4=jumblan4, fileType=fileType, reboot=reboot, groupid=groupid, jumbwan=jumbwan, vendorPn=vendorPn, fcsErrorReceived=fcsErrorReceived, catv=catv, xg6846=xg6846, voltage=voltage, portStatEntry=portStatEntry, lanportName=lanportName, internetPort=internetPort, staticIpGateway=staticIpGateway, unicastsTransmitted=unicastsTransmitted, hostname=hostname, groupIndex=groupIndex, lanportIndex=lanportIndex, catvEnable=catvEnable, lan2=lan2, multicastsReceived=multicastsReceived, qos=qos, jumblan2=jumblan2, dscpEnable=dscpEnable, lanportspeed=lanportspeed, staticDns=staticDns, vlangroupTable=vlangroupTable, port2=port2, txPower=txPower, qosEntry=qosEntry, deviceinfo=deviceinfo, portStatistic=portStatistic, domainame=domainame, groupEntry=groupEntry, rxPower=rxPower, staticIpDomainName=staticIpDomainName, statisticTable=statisticTable, portEntry=portEntry, vlan=vlan, jumb=jumb, temperature=temperature, operStatus=operStatus, qosTable=qosTable, priority=priority, portPower=portPower, qosIndex=qosIndex, qmode=qmode, lan1=lan1, statIndex=statIndex, bias=bias, tftpSevIp=tftpSevIp, wanType=wanType, staticIpAddr=staticIpAddr, adminStatus=adminStatus)
