...
# Produced by pysmi-1.1.8 at Tue Sep 12 12:16:31 2023
...
ModuleIdentity, TimeTicks, Integer32, snmpModules, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ObjectIdentity, MibIdentifier, Gauge32, iso, Counter64, IpAddress, NotificationType, Counter32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Integer32", "snmpModules", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ObjectIdentity", "MibIdentifier", "Gauge32", "iso", "Counter64", "IpAddress", "NotificationType", "Counter32", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", secondaryDns=secondaryDns, vendorPn=vendorPn, wanType=wanType, portTable=portTable, broadcastsTransmitted=broadcastsTransmitted, staticIpSubMask=staticIpSubMask, statIndex=statIndex, rxPower=rxPower, primaryDns=primaryDns, qmapping=qmapping, speed=speed, internetPort=internetPort, staticIpGateway=staticIpGateway, lan3=lan3, lanportpause=lanportpause, lanportTable=lanportTable, fileName=fileName, serialnum=serialnum, port2=port2, port3=port3, staticIpPrimaryDns=staticIpPrimaryDns, vlanid=vlanid, unicastsReceived=unicastsReceived, vendorRev=vendorRev, modeEntry=modeEntry, fcsErrorTransmitted=fcsErrorTransmitted, wan=wan, domainame=domainame, vendorName=vendorName, port4=port4, tftp=tftp, qos=qos, lanportIndex=lanportIndex, vlangroupTable=vlangroupTable, reboot=reboot, staticDns=staticDns, portName=portName, unicastsTransmitted=unicastsTransmitted, staticIpAddr=staticIpAddr, qosTable=qosTable, catv=catv, statisticTable=statisticTable, qmode=qmode, lan2=lan2, dscpEnable=dscpEnable, jumblan1=jumblan1, broadcastsReceived=broadcastsReceived, priority=priority, txPower=txPower, portIndex=portIndex, lan4=lan4, multicastsTransmitted=multicastsTransmitted, operStatus=operStatus, deviceinfo=deviceinfo, portPower=portPower, rebootEnable=rebootEnable, staticIpSecondaryDns=staticIpSecondaryDns, vendorOui=vendorOui, staticIpHostName=staticIpHostName, qosIndex=qosIndex, portStatEntry=portStatEntry, xg6846=xg6846, groupEntry=groupEntry, port1=port1, jumblan3=jumblan3, lanportspeed=lanportspeed, multicastsReceived=multicastsReceived, voltage=voltage, lan1=lan1, fcsErrorReceived=fcsErrorReceived, staticIpDomainName=staticIpDomainName, groupIndex=groupIndex, ddminfo=ddminfo, portEntry=portEntry, vlan=vlan, portmode=portmode, bias=bias, pauseTransmitted=pauseTransmitted, jumbwan=jumbwan, pauseReceived=pauseReceived, fileType=fileType, temperature=temperature, lanportName=lanportName, portStatistic=portStatistic, catvEnable=catvEnable, jumb=jumb, groupid=groupid, hostname=hostname, qosEntry=qosEntry, jumblan4=jumblan4, adminStatus=adminStatus, action=action, jumblan2=jumblan2, tftpSevIp=tftpSevIp)
