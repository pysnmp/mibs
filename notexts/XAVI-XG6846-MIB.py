...
Counter32, Gauge32, mib_2, TimeTicks, ModuleIdentity, MibIdentifier, Bits, Unsigned32, iso, ObjectIdentity, Counter64, Integer32, enterprises, snmpModules, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "mib-2", "TimeTicks", "ModuleIdentity", "MibIdentifier", "Bits", "Unsigned32", "iso", "ObjectIdentity", "Counter64", "Integer32", "enterprises", "snmpModules", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", unicastsTransmitted=unicastsTransmitted, lanportTable=lanportTable, pauseTransmitted=pauseTransmitted, lan1=lan1, fcsErrorTransmitted=fcsErrorTransmitted, portmode=portmode, jumb=jumb, portStatistic=portStatistic, reboot=reboot, groupEntry=groupEntry, qmode=qmode, staticIpSubMask=staticIpSubMask, catvEnable=catvEnable, tftp=tftp, primaryDns=primaryDns, portIndex=portIndex, lanportName=lanportName, portStatEntry=portStatEntry, lanportIndex=lanportIndex, fileName=fileName, priority=priority, secondaryDns=secondaryDns, modeEntry=modeEntry, qos=qos, port1=port1, portTable=portTable, vlanid=vlanid, vlan=vlan, statisticTable=statisticTable, staticDns=staticDns, vendorOui=vendorOui, portEntry=portEntry, rebootEnable=rebootEnable, operStatus=operStatus, temperature=temperature, bias=bias, hostname=hostname, staticIpSecondaryDns=staticIpSecondaryDns, port4=port4, deviceinfo=deviceinfo, vlangroupTable=vlangroupTable, tftpSevIp=tftpSevIp, fcsErrorReceived=fcsErrorReceived, serialnum=serialnum, jumblan3=jumblan3, port2=port2, multicastsTransmitted=multicastsTransmitted, port3=port3, staticIpPrimaryDns=staticIpPrimaryDns, qosEntry=qosEntry, vendorRev=vendorRev, ddminfo=ddminfo, lan2=lan2, jumblan1=jumblan1, jumblan2=jumblan2, wan=wan, vendorPn=vendorPn, qosTable=qosTable, portName=portName, catv=catv, lanportspeed=lanportspeed, action=action, pauseReceived=pauseReceived, unicastsReceived=unicastsReceived, xg6846=xg6846, portPower=portPower, domainame=domainame, jumblan4=jumblan4, multicastsReceived=multicastsReceived, lan3=lan3, staticIpDomainName=staticIpDomainName, adminStatus=adminStatus, staticIpGateway=staticIpGateway, broadcastsTransmitted=broadcastsTransmitted, staticIpAddr=staticIpAddr, voltage=voltage, statIndex=statIndex, qmapping=qmapping, wanType=wanType, lan4=lan4, speed=speed, dscpEnable=dscpEnable, txPower=txPower, groupIndex=groupIndex, groupid=groupid, rxPower=rxPower, fileType=fileType, lanportpause=lanportpause, jumbwan=jumbwan, staticIpHostName=staticIpHostName, internetPort=internetPort, qosIndex=qosIndex, vendorName=vendorName, broadcastsReceived=broadcastsReceived)
