...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ModuleIdentity, Counter64, Gauge32, IpAddress, iso, mib_2, Counter32, Integer32, Bits, TimeTicks, Unsigned32, MibIdentifier, snmpModules, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ModuleIdentity", "Counter64", "Gauge32", "IpAddress", "iso", "mib-2", "Counter32", "Integer32", "Bits", "TimeTicks", "Unsigned32", "MibIdentifier", "snmpModules", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", dscpEnable=dscpEnable, multicastsTransmitted=multicastsTransmitted, staticIpGateway=staticIpGateway, statisticTable=statisticTable, wan=wan, fileType=fileType, jumblan2=jumblan2, groupEntry=groupEntry, port2=port2, voltage=voltage, lanportIndex=lanportIndex, pauseTransmitted=pauseTransmitted, operStatus=operStatus, hostname=hostname, modeEntry=modeEntry, portStatEntry=portStatEntry, port1=port1, groupIndex=groupIndex, portEntry=portEntry, unicastsReceived=unicastsReceived, vendorRev=vendorRev, qosIndex=qosIndex, multicastsReceived=multicastsReceived, jumblan3=jumblan3, lan4=lan4, vlanid=vlanid, staticIpSubMask=staticIpSubMask, vlangroupTable=vlangroupTable, vlan=vlan, priority=priority, port4=port4, jumblan4=jumblan4, broadcastsTransmitted=broadcastsTransmitted, qos=qos, tftpSevIp=tftpSevIp, tftp=tftp, lanportTable=lanportTable, temperature=temperature, lanportName=lanportName, qmode=qmode, unicastsTransmitted=unicastsTransmitted, speed=speed, lan1=lan1, action=action, domainame=domainame, fileName=fileName, portPower=portPower, fcsErrorTransmitted=fcsErrorTransmitted, staticIpAddr=staticIpAddr, adminStatus=adminStatus, ddminfo=ddminfo, reboot=reboot, vendorPn=vendorPn, vendorName=vendorName, staticIpHostName=staticIpHostName, groupid=groupid, wanType=wanType, lan2=lan2, serialnum=serialnum, qmapping=qmapping, lanportpause=lanportpause, jumblan1=jumblan1, deviceinfo=deviceinfo, internetPort=internetPort, qosEntry=qosEntry, portName=portName, broadcastsReceived=broadcastsReceived, rebootEnable=rebootEnable, fcsErrorReceived=fcsErrorReceived, secondaryDns=secondaryDns, lanportspeed=lanportspeed, staticIpPrimaryDns=staticIpPrimaryDns, jumbwan=jumbwan, port3=port3, bias=bias, statIndex=statIndex, portIndex=portIndex, vendorOui=vendorOui, catv=catv, portStatistic=portStatistic, primaryDns=primaryDns, jumb=jumb, lan3=lan3, rxPower=rxPower, catvEnable=catvEnable, staticIpSecondaryDns=staticIpSecondaryDns, xg6846=xg6846, portTable=portTable, pauseReceived=pauseReceived, qosTable=qosTable, portmode=portmode, staticIpDomainName=staticIpDomainName, staticDns=staticDns, txPower=txPower)
