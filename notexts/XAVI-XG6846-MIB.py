...
# Produced by pysmi-1.1.8 at Wed Feb  2 18:01:38 2022
...
mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, ObjectIdentity, Counter64, Unsigned32, ModuleIdentity, iso, NotificationType, enterprises, Integer32, TimeTicks, Counter32, snmpModules, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "ObjectIdentity", "Counter64", "Unsigned32", "ModuleIdentity", "iso", "NotificationType", "enterprises", "Integer32", "TimeTicks", "Counter32", "snmpModules", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", secondaryDns=secondaryDns, staticIpPrimaryDns=staticIpPrimaryDns, staticIpGateway=staticIpGateway, statisticTable=statisticTable, hostname=hostname, portPower=portPower, pauseReceived=pauseReceived, adminStatus=adminStatus, vendorName=vendorName, statIndex=statIndex, vlan=vlan, qos=qos, modeEntry=modeEntry, staticIpSubMask=staticIpSubMask, vlanid=vlanid, jumblan1=jumblan1, voltage=voltage, unicastsTransmitted=unicastsTransmitted, dscpEnable=dscpEnable, port2=port2, broadcastsTransmitted=broadcastsTransmitted, jumbwan=jumbwan, ddminfo=ddminfo, operStatus=operStatus, lan2=lan2, fcsErrorTransmitted=fcsErrorTransmitted, unicastsReceived=unicastsReceived, xg6846=xg6846, fileName=fileName, rebootEnable=rebootEnable, qosIndex=qosIndex, port1=port1, wanType=wanType, priority=priority, staticIpHostName=staticIpHostName, port4=port4, portStatEntry=portStatEntry, multicastsReceived=multicastsReceived, staticIpAddr=staticIpAddr, lan1=lan1, portIndex=portIndex, qmode=qmode, vendorPn=vendorPn, qosTable=qosTable, portTable=portTable, bias=bias, staticIpDomainName=staticIpDomainName, temperature=temperature, internetPort=internetPort, port3=port3, jumblan4=jumblan4, jumb=jumb, portName=portName, txPower=txPower, groupIndex=groupIndex, domainame=domainame, portEntry=portEntry, groupEntry=groupEntry, catv=catv, vlangroupTable=vlangroupTable, pauseTransmitted=pauseTransmitted, fileType=fileType, rxPower=rxPower, serialnum=serialnum, portStatistic=portStatistic, lan3=lan3, vendorRev=vendorRev, staticIpSecondaryDns=staticIpSecondaryDns, qmapping=qmapping, deviceinfo=deviceinfo, action=action, tftpSevIp=tftpSevIp, groupid=groupid, staticDns=staticDns, qosEntry=qosEntry, vendorOui=vendorOui, lanportIndex=lanportIndex, multicastsTransmitted=multicastsTransmitted, jumblan3=jumblan3, lanportspeed=lanportspeed, wan=wan, tftp=tftp, lanportName=lanportName, speed=speed, jumblan2=jumblan2, lan4=lan4, primaryDns=primaryDns, lanportpause=lanportpause, reboot=reboot, portmode=portmode, broadcastsReceived=broadcastsReceived, catvEnable=catvEnable, fcsErrorReceived=fcsErrorReceived, lanportTable=lanportTable)
