...
# Produced by pysmi-1.1.8 at Thu Sep 29 12:20:36 2022
...
Counter32, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, mib_2, IpAddress, Unsigned32, MibIdentifier, snmpModules, iso, Bits, Gauge32, ObjectIdentity, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "mib-2", "IpAddress", "Unsigned32", "MibIdentifier", "snmpModules", "iso", "Bits", "Gauge32", "ObjectIdentity", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", deviceinfo=deviceinfo, catv=catv, fileName=fileName, statisticTable=statisticTable, pauseTransmitted=pauseTransmitted, adminStatus=adminStatus, groupEntry=groupEntry, groupid=groupid, jumblan1=jumblan1, action=action, lanportspeed=lanportspeed, operStatus=operStatus, serialnum=serialnum, secondaryDns=secondaryDns, tftp=tftp, qmapping=qmapping, txPower=txPower, catvEnable=catvEnable, jumblan3=jumblan3, speed=speed, ddminfo=ddminfo, modeEntry=modeEntry, staticIpHostName=staticIpHostName, staticDns=staticDns, broadcastsReceived=broadcastsReceived, qosEntry=qosEntry, portmode=portmode, tftpSevIp=tftpSevIp, rxPower=rxPower, unicastsTransmitted=unicastsTransmitted, statIndex=statIndex, xg6846=xg6846, lan4=lan4, qosIndex=qosIndex, jumblan4=jumblan4, vlanid=vlanid, reboot=reboot, portStatistic=portStatistic, port4=port4, primaryDns=primaryDns, jumblan2=jumblan2, portName=portName, unicastsReceived=unicastsReceived, broadcastsTransmitted=broadcastsTransmitted, hostname=hostname, port3=port3, fcsErrorTransmitted=fcsErrorTransmitted, portEntry=portEntry, priority=priority, temperature=temperature, portStatEntry=portStatEntry, voltage=voltage, pauseReceived=pauseReceived, staticIpSecondaryDns=staticIpSecondaryDns, portIndex=portIndex, lanportName=lanportName, vlan=vlan, vendorOui=vendorOui, lan3=lan3, portTable=portTable, vendorRev=vendorRev, lanportpause=lanportpause, staticIpGateway=staticIpGateway, portPower=portPower, wanType=wanType, jumb=jumb, staticIpPrimaryDns=staticIpPrimaryDns, rebootEnable=rebootEnable, staticIpDomainName=staticIpDomainName, port2=port2, vendorName=vendorName, qmode=qmode, vlangroupTable=vlangroupTable, jumbwan=jumbwan, fileType=fileType, staticIpAddr=staticIpAddr, dscpEnable=dscpEnable, wan=wan, bias=bias, vendorPn=vendorPn, fcsErrorReceived=fcsErrorReceived, lan2=lan2, qosTable=qosTable, qos=qos, lan1=lan1, domainame=domainame, internetPort=internetPort, groupIndex=groupIndex, staticIpSubMask=staticIpSubMask, port1=port1, lanportIndex=lanportIndex, multicastsTransmitted=multicastsTransmitted, lanportTable=lanportTable, multicastsReceived=multicastsReceived)
