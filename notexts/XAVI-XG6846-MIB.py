...
snmpModules, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, Counter32, iso, Gauge32, Bits, MibIdentifier, enterprises, Unsigned32, Counter64, IpAddress, ModuleIdentity, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "Counter32", "iso", "Gauge32", "Bits", "MibIdentifier", "enterprises", "Unsigned32", "Counter64", "IpAddress", "ModuleIdentity", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qosIndex=qosIndex, qmode=qmode, fcsErrorReceived=fcsErrorReceived, broadcastsReceived=broadcastsReceived, wan=wan, internetPort=internetPort, pauseTransmitted=pauseTransmitted, qos=qos, pauseReceived=pauseReceived, port2=port2, serialnum=serialnum, statIndex=statIndex, portIndex=portIndex, hostname=hostname, unicastsReceived=unicastsReceived, vendorName=vendorName, jumb=jumb, staticIpSubMask=staticIpSubMask, vlan=vlan, portTable=portTable, staticIpPrimaryDns=staticIpPrimaryDns, deviceinfo=deviceinfo, port1=port1, rxPower=rxPower, jumblan1=jumblan1, portmode=portmode, lanportIndex=lanportIndex, vlanid=vlanid, staticIpDomainName=staticIpDomainName, staticIpHostName=staticIpHostName, tftp=tftp, jumbwan=jumbwan, lanportTable=lanportTable, temperature=temperature, primaryDns=primaryDns, secondaryDns=secondaryDns, qosTable=qosTable, qosEntry=qosEntry, vendorPn=vendorPn, lan2=lan2, operStatus=operStatus, portName=portName, staticDns=staticDns, port4=port4, vlangroupTable=vlangroupTable, portPower=portPower, tftpSevIp=tftpSevIp, portEntry=portEntry, fcsErrorTransmitted=fcsErrorTransmitted, reboot=reboot, staticIpSecondaryDns=staticIpSecondaryDns, xg6846=xg6846, portStatEntry=portStatEntry, rebootEnable=rebootEnable, wanType=wanType, lanportName=lanportName, action=action, qmapping=qmapping, domainame=domainame, bias=bias, groupIndex=groupIndex, speed=speed, groupEntry=groupEntry, statisticTable=statisticTable, multicastsReceived=multicastsReceived, unicastsTransmitted=unicastsTransmitted, voltage=voltage, jumblan2=jumblan2, fileType=fileType, lan3=lan3, txPower=txPower, vendorOui=vendorOui, staticIpAddr=staticIpAddr, portStatistic=portStatistic, staticIpGateway=staticIpGateway, lanportspeed=lanportspeed, port3=port3, ddminfo=ddminfo, catvEnable=catvEnable, lan1=lan1, jumblan4=jumblan4, adminStatus=adminStatus, multicastsTransmitted=multicastsTransmitted, priority=priority, vendorRev=vendorRev, fileName=fileName, lan4=lan4, groupid=groupid, lanportpause=lanportpause, modeEntry=modeEntry, dscpEnable=dscpEnable, broadcastsTransmitted=broadcastsTransmitted, jumblan3=jumblan3, catv=catv)
