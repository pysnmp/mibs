...
# Produced by pysmi-1.1.8 at Mon Jan  9 10:18:43 2023
...
MibIdentifier, ObjectIdentity, mib_2, Integer32, iso, Bits, Counter32, TimeTicks, Gauge32, Unsigned32, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, snmpModules, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "mib-2", "Integer32", "iso", "Bits", "Counter32", "TimeTicks", "Gauge32", "Unsigned32", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "snmpModules", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpSubMask=staticIpSubMask, portEntry=portEntry, fcsErrorReceived=fcsErrorReceived, lanportspeed=lanportspeed, portStatistic=portStatistic, deviceinfo=deviceinfo, hostname=hostname, rebootEnable=rebootEnable, unicastsReceived=unicastsReceived, jumb=jumb, modeEntry=modeEntry, port4=port4, broadcastsTransmitted=broadcastsTransmitted, qosTable=qosTable, jumbwan=jumbwan, qmapping=qmapping, pauseTransmitted=pauseTransmitted, fileName=fileName, portTable=portTable, port3=port3, staticDns=staticDns, catvEnable=catvEnable, vlanid=vlanid, txPower=txPower, domainame=domainame, vendorOui=vendorOui, xg6846=xg6846, staticIpPrimaryDns=staticIpPrimaryDns, groupEntry=groupEntry, secondaryDns=secondaryDns, portmode=portmode, wan=wan, qos=qos, fileType=fileType, qosEntry=qosEntry, portStatEntry=portStatEntry, qmode=qmode, portIndex=portIndex, tftp=tftp, catv=catv, staticIpDomainName=staticIpDomainName, staticIpGateway=staticIpGateway, wanType=wanType, unicastsTransmitted=unicastsTransmitted, ddminfo=ddminfo, vendorName=vendorName, staticIpSecondaryDns=staticIpSecondaryDns, jumblan4=jumblan4, jumblan3=jumblan3, groupIndex=groupIndex, port1=port1, internetPort=internetPort, jumblan2=jumblan2, vlangroupTable=vlangroupTable, vendorRev=vendorRev, temperature=temperature, action=action, dscpEnable=dscpEnable, lanportTable=lanportTable, tftpSevIp=tftpSevIp, rxPower=rxPower, operStatus=operStatus, pauseReceived=pauseReceived, adminStatus=adminStatus, portPower=portPower, lan4=lan4, statisticTable=statisticTable, lan1=lan1, jumblan1=jumblan1, primaryDns=primaryDns, reboot=reboot, lanportIndex=lanportIndex, statIndex=statIndex, multicastsReceived=multicastsReceived, lan3=lan3, broadcastsReceived=broadcastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, staticIpHostName=staticIpHostName, qosIndex=qosIndex, speed=speed, lanportName=lanportName, vlan=vlan, multicastsTransmitted=multicastsTransmitted, portName=portName, priority=priority, lan2=lan2, groupid=groupid, voltage=voltage, lanportpause=lanportpause, port2=port2, serialnum=serialnum, staticIpAddr=staticIpAddr, bias=bias, vendorPn=vendorPn)
