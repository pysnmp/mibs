...
# Produced by pysmi-1.1.8 at Sat Jan 15 19:45:44 2022
...
Bits, MibIdentifier, snmpModules, mib_2, iso, Gauge32, NotificationType, IpAddress, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, TimeTicks, Counter64, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "snmpModules", "mib-2", "iso", "Gauge32", "NotificationType", "IpAddress", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "TimeTicks", "Counter64", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", pauseTransmitted=pauseTransmitted, rebootEnable=rebootEnable, portStatEntry=portStatEntry, port1=port1, tftp=tftp, statisticTable=statisticTable, vlangroupTable=vlangroupTable, speed=speed, portName=portName, staticIpSubMask=staticIpSubMask, qosIndex=qosIndex, jumb=jumb, portEntry=portEntry, secondaryDns=secondaryDns, portPower=portPower, vlan=vlan, groupid=groupid, jumblan1=jumblan1, staticIpAddr=staticIpAddr, qmode=qmode, rxPower=rxPower, tftpSevIp=tftpSevIp, domainame=domainame, catvEnable=catvEnable, temperature=temperature, ddminfo=ddminfo, lanportTable=lanportTable, jumblan3=jumblan3, bias=bias, port4=port4, qosEntry=qosEntry, lan1=lan1, portTable=portTable, lanportspeed=lanportspeed, multicastsTransmitted=multicastsTransmitted, lan3=lan3, fileType=fileType, action=action, vendorName=vendorName, statIndex=statIndex, unicastsTransmitted=unicastsTransmitted, modeEntry=modeEntry, portmode=portmode, reboot=reboot, catv=catv, internetPort=internetPort, xg6846=xg6846, jumblan4=jumblan4, unicastsReceived=unicastsReceived, port2=port2, voltage=voltage, vendorPn=vendorPn, portStatistic=portStatistic, qosTable=qosTable, staticIpHostName=staticIpHostName, staticIpGateway=staticIpGateway, staticIpSecondaryDns=staticIpSecondaryDns, staticDns=staticDns, broadcastsTransmitted=broadcastsTransmitted, portIndex=portIndex, primaryDns=primaryDns, groupIndex=groupIndex, serialnum=serialnum, qmapping=qmapping, lan4=lan4, deviceinfo=deviceinfo, fileName=fileName, jumbwan=jumbwan, lanportIndex=lanportIndex, multicastsReceived=multicastsReceived, vendorRev=vendorRev, jumblan2=jumblan2, staticIpPrimaryDns=staticIpPrimaryDns, lan2=lan2, txPower=txPower, qos=qos, vlanid=vlanid, lanportpause=lanportpause, wanType=wanType, port3=port3, fcsErrorReceived=fcsErrorReceived, groupEntry=groupEntry, adminStatus=adminStatus, broadcastsReceived=broadcastsReceived, priority=priority, pauseReceived=pauseReceived, fcsErrorTransmitted=fcsErrorTransmitted, wan=wan, dscpEnable=dscpEnable, vendorOui=vendorOui, staticIpDomainName=staticIpDomainName, operStatus=operStatus, lanportName=lanportName, hostname=hostname)
