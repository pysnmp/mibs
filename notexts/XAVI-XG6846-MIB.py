...
# Produced by pysmi-1.1.8 at Thu Sep  8 09:22:48 2022
...
Bits, mib_2, Unsigned32, Counter32, TimeTicks, Integer32, iso, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Gauge32, IpAddress, Counter64, NotificationType, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "mib-2", "Unsigned32", "Counter32", "TimeTicks", "Integer32", "iso", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Gauge32", "IpAddress", "Counter64", "NotificationType", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumbwan=jumbwan, secondaryDns=secondaryDns, lan4=lan4, voltage=voltage, lan2=lan2, vendorName=vendorName, broadcastsTransmitted=broadcastsTransmitted, vendorPn=vendorPn, portPower=portPower, pauseTransmitted=pauseTransmitted, pauseReceived=pauseReceived, portTable=portTable, staticIpGateway=staticIpGateway, groupid=groupid, qmapping=qmapping, serialnum=serialnum, wanType=wanType, lanportpause=lanportpause, fcsErrorTransmitted=fcsErrorTransmitted, deviceinfo=deviceinfo, staticIpDomainName=staticIpDomainName, jumblan3=jumblan3, lanportName=lanportName, jumblan2=jumblan2, broadcastsReceived=broadcastsReceived, staticIpHostName=staticIpHostName, fileName=fileName, groupIndex=groupIndex, portName=portName, groupEntry=groupEntry, ddminfo=ddminfo, catv=catv, vlanid=vlanid, adminStatus=adminStatus, multicastsReceived=multicastsReceived, qosTable=qosTable, qos=qos, vendorRev=vendorRev, fcsErrorReceived=fcsErrorReceived, portIndex=portIndex, action=action, lan3=lan3, lanportTable=lanportTable, qmode=qmode, portStatistic=portStatistic, vendorOui=vendorOui, lan1=lan1, jumblan4=jumblan4, modeEntry=modeEntry, qosIndex=qosIndex, jumblan1=jumblan1, port2=port2, port3=port3, fileType=fileType, lanportspeed=lanportspeed, wan=wan, port4=port4, tftp=tftp, rxPower=rxPower, portStatEntry=portStatEntry, portmode=portmode, operStatus=operStatus, statisticTable=statisticTable, staticIpAddr=staticIpAddr, dscpEnable=dscpEnable, staticDns=staticDns, staticIpSecondaryDns=staticIpSecondaryDns, staticIpSubMask=staticIpSubMask, portEntry=portEntry, primaryDns=primaryDns, jumb=jumb, xg6846=xg6846, qosEntry=qosEntry, speed=speed, temperature=temperature, priority=priority, hostname=hostname, statIndex=statIndex, bias=bias, internetPort=internetPort, reboot=reboot, domainame=domainame, lanportIndex=lanportIndex, vlan=vlan, port1=port1, vlangroupTable=vlangroupTable, tftpSevIp=tftpSevIp, staticIpPrimaryDns=staticIpPrimaryDns, txPower=txPower, unicastsReceived=unicastsReceived, unicastsTransmitted=unicastsTransmitted, rebootEnable=rebootEnable, catvEnable=catvEnable, multicastsTransmitted=multicastsTransmitted)
