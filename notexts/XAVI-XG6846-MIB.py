...
# Produced by pysmi-1.1.8 at Mon Sep 19 08:31:55 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, snmpModules, iso, Gauge32, ObjectIdentity, enterprises, Unsigned32, MibIdentifier, ModuleIdentity, IpAddress, NotificationType, Counter64, TimeTicks, Bits, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "snmpModules", "iso", "Gauge32", "ObjectIdentity", "enterprises", "Unsigned32", "MibIdentifier", "ModuleIdentity", "IpAddress", "NotificationType", "Counter64", "TimeTicks", "Bits", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorRev=vendorRev, port3=port3, vlangroupTable=vlangroupTable, port1=port1, lanportpause=lanportpause, fileType=fileType, lan2=lan2, jumbwan=jumbwan, lanportTable=lanportTable, statisticTable=statisticTable, priority=priority, ddminfo=ddminfo, secondaryDns=secondaryDns, wanType=wanType, portIndex=portIndex, qosTable=qosTable, staticIpSecondaryDns=staticIpSecondaryDns, staticIpAddr=staticIpAddr, staticIpDomainName=staticIpDomainName, fcsErrorReceived=fcsErrorReceived, bias=bias, portPower=portPower, fileName=fileName, staticIpGateway=staticIpGateway, speed=speed, deviceinfo=deviceinfo, lan3=lan3, portStatEntry=portStatEntry, voltage=voltage, unicastsTransmitted=unicastsTransmitted, portStatistic=portStatistic, adminStatus=adminStatus, staticIpHostName=staticIpHostName, pauseReceived=pauseReceived, catvEnable=catvEnable, tftp=tftp, qosIndex=qosIndex, modeEntry=modeEntry, catv=catv, fcsErrorTransmitted=fcsErrorTransmitted, temperature=temperature, vlan=vlan, groupIndex=groupIndex, port4=port4, staticDns=staticDns, lan4=lan4, qmode=qmode, domainame=domainame, statIndex=statIndex, vendorPn=vendorPn, jumblan1=jumblan1, action=action, multicastsTransmitted=multicastsTransmitted, staticIpSubMask=staticIpSubMask, vendorOui=vendorOui, unicastsReceived=unicastsReceived, primaryDns=primaryDns, jumblan3=jumblan3, rxPower=rxPower, qos=qos, lanportName=lanportName, wan=wan, tftpSevIp=tftpSevIp, rebootEnable=rebootEnable, dscpEnable=dscpEnable, jumb=jumb, internetPort=internetPort, lanportIndex=lanportIndex, serialnum=serialnum, portEntry=portEntry, groupEntry=groupEntry, reboot=reboot, pauseTransmitted=pauseTransmitted, groupid=groupid, txPower=txPower, port2=port2, lan1=lan1, hostname=hostname, xg6846=xg6846, lanportspeed=lanportspeed, broadcastsTransmitted=broadcastsTransmitted, multicastsReceived=multicastsReceived, broadcastsReceived=broadcastsReceived, vendorName=vendorName, jumblan2=jumblan2, qmapping=qmapping, portmode=portmode, operStatus=operStatus, portTable=portTable, portName=portName, qosEntry=qosEntry, vlanid=vlanid, jumblan4=jumblan4, staticIpPrimaryDns=staticIpPrimaryDns)
