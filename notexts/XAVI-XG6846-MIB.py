...
# Produced by pysmi-1.1.8 at Wed Sep 13 14:30:12 2023
...
Bits, mib_2, MibIdentifier, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, NotificationType, IpAddress, Counter64, ModuleIdentity, Integer32, Gauge32, TimeTicks, ObjectIdentity, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "mib-2", "MibIdentifier", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "NotificationType", "IpAddress", "Counter64", "ModuleIdentity", "Integer32", "Gauge32", "TimeTicks", "ObjectIdentity", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portStatEntry=portStatEntry, wanType=wanType, lanportTable=lanportTable, txPower=txPower, portName=portName, voltage=voltage, port4=port4, pauseTransmitted=pauseTransmitted, operStatus=operStatus, lanportspeed=lanportspeed, pauseReceived=pauseReceived, statisticTable=statisticTable, jumblan1=jumblan1, qosIndex=qosIndex, multicastsTransmitted=multicastsTransmitted, broadcastsTransmitted=broadcastsTransmitted, catvEnable=catvEnable, priority=priority, secondaryDns=secondaryDns, lan3=lan3, staticIpSubMask=staticIpSubMask, vlan=vlan, qmapping=qmapping, port3=port3, adminStatus=adminStatus, groupEntry=groupEntry, jumb=jumb, multicastsReceived=multicastsReceived, qos=qos, vendorPn=vendorPn, vlangroupTable=vlangroupTable, staticIpPrimaryDns=staticIpPrimaryDns, vendorRev=vendorRev, groupid=groupid, bias=bias, staticDns=staticDns, qmode=qmode, rxPower=rxPower, staticIpHostName=staticIpHostName, lanportIndex=lanportIndex, staticIpDomainName=staticIpDomainName, ddminfo=ddminfo, speed=speed, qosTable=qosTable, portStatistic=portStatistic, vendorOui=vendorOui, tftpSevIp=tftpSevIp, unicastsTransmitted=unicastsTransmitted, hostname=hostname, reboot=reboot, portEntry=portEntry, portmode=portmode, vendorName=vendorName, lan4=lan4, fcsErrorReceived=fcsErrorReceived, fileType=fileType, unicastsReceived=unicastsReceived, staticIpGateway=staticIpGateway, dscpEnable=dscpEnable, xg6846=xg6846, lan1=lan1, lanportpause=lanportpause, wan=wan, staticIpAddr=staticIpAddr, primaryDns=primaryDns, port1=port1, portTable=portTable, fcsErrorTransmitted=fcsErrorTransmitted, catv=catv, action=action, broadcastsReceived=broadcastsReceived, serialnum=serialnum, deviceinfo=deviceinfo, groupIndex=groupIndex, temperature=temperature, jumblan4=jumblan4, portIndex=portIndex, lan2=lan2, domainame=domainame, jumbwan=jumbwan, rebootEnable=rebootEnable, jumblan3=jumblan3, fileName=fileName, jumblan2=jumblan2, portPower=portPower, modeEntry=modeEntry, qosEntry=qosEntry, staticIpSecondaryDns=staticIpSecondaryDns, vlanid=vlanid, statIndex=statIndex, internetPort=internetPort, tftp=tftp, lanportName=lanportName, port2=port2)
