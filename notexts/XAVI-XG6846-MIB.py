...
# Produced by pysmi-1.1.8 at Thu Sep  7 14:27:31 2023
...
enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, IpAddress, snmpModules, Integer32, Gauge32, NotificationType, MibIdentifier, iso, Unsigned32, Bits, ObjectIdentity, mib_2, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "IpAddress", "snmpModules", "Integer32", "Gauge32", "NotificationType", "MibIdentifier", "iso", "Unsigned32", "Bits", "ObjectIdentity", "mib-2", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", hostname=hostname, lanportpause=lanportpause, groupEntry=groupEntry, domainame=domainame, secondaryDns=secondaryDns, portEntry=portEntry, jumblan4=jumblan4, fcsErrorTransmitted=fcsErrorTransmitted, portStatistic=portStatistic, jumb=jumb, portStatEntry=portStatEntry, staticIpSecondaryDns=staticIpSecondaryDns, catvEnable=catvEnable, groupid=groupid, ddminfo=ddminfo, staticIpGateway=staticIpGateway, jumblan2=jumblan2, jumblan1=jumblan1, dscpEnable=dscpEnable, groupIndex=groupIndex, port2=port2, statIndex=statIndex, qmapping=qmapping, rebootEnable=rebootEnable, tftpSevIp=tftpSevIp, modeEntry=modeEntry, vlanid=vlanid, primaryDns=primaryDns, unicastsTransmitted=unicastsTransmitted, vlan=vlan, multicastsTransmitted=multicastsTransmitted, wan=wan, xg6846=xg6846, reboot=reboot, catv=catv, unicastsReceived=unicastsReceived, temperature=temperature, vendorRev=vendorRev, staticIpAddr=staticIpAddr, portTable=portTable, qos=qos, rxPower=rxPower, port4=port4, lanportTable=lanportTable, qmode=qmode, fcsErrorReceived=fcsErrorReceived, pauseReceived=pauseReceived, speed=speed, fileName=fileName, staticIpSubMask=staticIpSubMask, port3=port3, adminStatus=adminStatus, jumblan3=jumblan3, statisticTable=statisticTable, tftp=tftp, portmode=portmode, lanportspeed=lanportspeed, qosTable=qosTable, pauseTransmitted=pauseTransmitted, wanType=wanType, serialnum=serialnum, internetPort=internetPort, lan3=lan3, vendorOui=vendorOui, vendorPn=vendorPn, operStatus=operStatus, priority=priority, qosEntry=qosEntry, txPower=txPower, lan1=lan1, qosIndex=qosIndex, lan4=lan4, vlangroupTable=vlangroupTable, voltage=voltage, multicastsReceived=multicastsReceived, lanportName=lanportName, lan2=lan2, vendorName=vendorName, staticDns=staticDns, fileType=fileType, bias=bias, broadcastsReceived=broadcastsReceived, portName=portName, portIndex=portIndex, broadcastsTransmitted=broadcastsTransmitted, deviceinfo=deviceinfo, staticIpDomainName=staticIpDomainName, portPower=portPower, port1=port1, lanportIndex=lanportIndex, staticIpPrimaryDns=staticIpPrimaryDns, jumbwan=jumbwan, staticIpHostName=staticIpHostName, action=action)
