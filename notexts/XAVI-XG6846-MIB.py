...
# Produced by pysmi-1.1.0 at Fri Nov 19 15:18:29 2021
...
Integer32, Bits, Unsigned32, NotificationType, snmpModules, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, MibIdentifier, mib_2, IpAddress, ModuleIdentity, TimeTicks, iso, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "Unsigned32", "NotificationType", "snmpModules", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "MibIdentifier", "mib-2", "IpAddress", "ModuleIdentity", "TimeTicks", "iso", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", statisticTable=statisticTable, staticIpSecondaryDns=staticIpSecondaryDns, lan3=lan3, unicastsReceived=unicastsReceived, port3=port3, portStatistic=portStatistic, qos=qos, action=action, multicastsReceived=multicastsReceived, dscpEnable=dscpEnable, secondaryDns=secondaryDns, unicastsTransmitted=unicastsTransmitted, portPower=portPower, lanportspeed=lanportspeed, broadcastsTransmitted=broadcastsTransmitted, fileName=fileName, rxPower=rxPower, internetPort=internetPort, portStatEntry=portStatEntry, pauseReceived=pauseReceived, portIndex=portIndex, vendorPn=vendorPn, tftpSevIp=tftpSevIp, staticIpGateway=staticIpGateway, statIndex=statIndex, vlanid=vlanid, jumb=jumb, reboot=reboot, jumblan4=jumblan4, groupIndex=groupIndex, fcsErrorReceived=fcsErrorReceived, groupEntry=groupEntry, rebootEnable=rebootEnable, txPower=txPower, hostname=hostname, xg6846=xg6846, qosTable=qosTable, staticIpDomainName=staticIpDomainName, qmapping=qmapping, tftp=tftp, jumblan3=jumblan3, lan1=lan1, qmode=qmode, speed=speed, primaryDns=primaryDns, lan2=lan2, staticDns=staticDns, operStatus=operStatus, lan4=lan4, adminStatus=adminStatus, catvEnable=catvEnable, fcsErrorTransmitted=fcsErrorTransmitted, pauseTransmitted=pauseTransmitted, lanportIndex=lanportIndex, portmode=portmode, vlan=vlan, bias=bias, wan=wan, modeEntry=modeEntry, vendorName=vendorName, staticIpAddr=staticIpAddr, ddminfo=ddminfo, catv=catv, qosIndex=qosIndex, vendorOui=vendorOui, jumblan2=jumblan2, qosEntry=qosEntry, staticIpPrimaryDns=staticIpPrimaryDns, vendorRev=vendorRev, fileType=fileType, multicastsTransmitted=multicastsTransmitted, voltage=voltage, deviceinfo=deviceinfo, port1=port1, portTable=portTable, priority=priority, jumbwan=jumbwan, broadcastsReceived=broadcastsReceived, port2=port2, domainame=domainame, vlangroupTable=vlangroupTable, serialnum=serialnum, port4=port4, staticIpHostName=staticIpHostName, lanportTable=lanportTable, lanportpause=lanportpause, wanType=wanType, portName=portName, portEntry=portEntry, lanportName=lanportName, temperature=temperature, staticIpSubMask=staticIpSubMask, jumblan1=jumblan1, groupid=groupid)
