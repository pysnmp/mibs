...
# Produced by pysmi-1.1.8 at Mon Jan  9 13:41:09 2023
...
Counter64, MibIdentifier, Gauge32, NotificationType, Counter32, ObjectIdentity, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, TimeTicks, snmpModules, iso, enterprises, IpAddress, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "Gauge32", "NotificationType", "Counter32", "ObjectIdentity", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "TimeTicks", "snmpModules", "iso", "enterprises", "IpAddress", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qos=qos, vendorPn=vendorPn, lan1=lan1, pauseReceived=pauseReceived, jumbwan=jumbwan, groupid=groupid, jumblan2=jumblan2, jumblan1=jumblan1, tftpSevIp=tftpSevIp, tftp=tftp, portPower=portPower, qmode=qmode, lan4=lan4, domainame=domainame, jumb=jumb, port2=port2, portEntry=portEntry, staticIpHostName=staticIpHostName, port3=port3, unicastsReceived=unicastsReceived, ddminfo=ddminfo, pauseTransmitted=pauseTransmitted, wanType=wanType, fileName=fileName, portmode=portmode, statisticTable=statisticTable, rxPower=rxPower, vendorName=vendorName, lanportIndex=lanportIndex, lanportTable=lanportTable, vendorRev=vendorRev, staticIpSecondaryDns=staticIpSecondaryDns, portStatEntry=portStatEntry, portName=portName, groupIndex=groupIndex, staticIpPrimaryDns=staticIpPrimaryDns, hostname=hostname, catv=catv, port4=port4, port1=port1, vendorOui=vendorOui, qosIndex=qosIndex, vlanid=vlanid, broadcastsReceived=broadcastsReceived, lan2=lan2, multicastsTransmitted=multicastsTransmitted, reboot=reboot, lan3=lan3, staticIpGateway=staticIpGateway, internetPort=internetPort, lanportpause=lanportpause, fcsErrorReceived=fcsErrorReceived, portTable=portTable, multicastsReceived=multicastsReceived, staticIpAddr=staticIpAddr, rebootEnable=rebootEnable, bias=bias, operStatus=operStatus, portIndex=portIndex, lanportName=lanportName, adminStatus=adminStatus, speed=speed, voltage=voltage, qmapping=qmapping, priority=priority, secondaryDns=secondaryDns, jumblan4=jumblan4, fcsErrorTransmitted=fcsErrorTransmitted, dscpEnable=dscpEnable, deviceinfo=deviceinfo, action=action, qosEntry=qosEntry, catvEnable=catvEnable, statIndex=statIndex, jumblan3=jumblan3, modeEntry=modeEntry, primaryDns=primaryDns, unicastsTransmitted=unicastsTransmitted, qosTable=qosTable, staticDns=staticDns, vlangroupTable=vlangroupTable, broadcastsTransmitted=broadcastsTransmitted, temperature=temperature, xg6846=xg6846, lanportspeed=lanportspeed, txPower=txPower, staticIpDomainName=staticIpDomainName, portStatistic=portStatistic, wan=wan, groupEntry=groupEntry, vlan=vlan, serialnum=serialnum, staticIpSubMask=staticIpSubMask, fileType=fileType)
