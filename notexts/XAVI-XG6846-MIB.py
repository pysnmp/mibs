...
Bits, iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, ModuleIdentity, NotificationType, MibIdentifier, Counter64, Gauge32, ObjectIdentity, Counter32, snmpModules, IpAddress, mib_2, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "ModuleIdentity", "NotificationType", "MibIdentifier", "Counter64", "Gauge32", "ObjectIdentity", "Counter32", "snmpModules", "IpAddress", "mib-2", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", domainame=domainame, multicastsTransmitted=multicastsTransmitted, vendorOui=vendorOui, jumblan2=jumblan2, vendorName=vendorName, portmode=portmode, jumblan3=jumblan3, operStatus=operStatus, lanportTable=lanportTable, statisticTable=statisticTable, lanportspeed=lanportspeed, staticIpAddr=staticIpAddr, staticIpSecondaryDns=staticIpSecondaryDns, action=action, fcsErrorTransmitted=fcsErrorTransmitted, staticDns=staticDns, staticIpPrimaryDns=staticIpPrimaryDns, staticIpGateway=staticIpGateway, internetPort=internetPort, ddminfo=ddminfo, port3=port3, lanportName=lanportName, jumb=jumb, qmode=qmode, groupEntry=groupEntry, rxPower=rxPower, portIndex=portIndex, qosEntry=qosEntry, deviceinfo=deviceinfo, jumblan1=jumblan1, qosTable=qosTable, portEntry=portEntry, priority=priority, unicastsTransmitted=unicastsTransmitted, lanportIndex=lanportIndex, portStatEntry=portStatEntry, temperature=temperature, rebootEnable=rebootEnable, broadcastsReceived=broadcastsReceived, wan=wan, portPower=portPower, primaryDns=primaryDns, pauseReceived=pauseReceived, reboot=reboot, speed=speed, dscpEnable=dscpEnable, vendorRev=vendorRev, groupid=groupid, portTable=portTable, portStatistic=portStatistic, fileName=fileName, vlanid=vlanid, hostname=hostname, xg6846=xg6846, wanType=wanType, jumblan4=jumblan4, portName=portName, unicastsReceived=unicastsReceived, staticIpHostName=staticIpHostName, lan1=lan1, statIndex=statIndex, serialnum=serialnum, tftpSevIp=tftpSevIp, groupIndex=groupIndex, port4=port4, staticIpDomainName=staticIpDomainName, lan2=lan2, port1=port1, broadcastsTransmitted=broadcastsTransmitted, catv=catv, vlan=vlan, vlangroupTable=vlangroupTable, modeEntry=modeEntry, fcsErrorReceived=fcsErrorReceived, pauseTransmitted=pauseTransmitted, multicastsReceived=multicastsReceived, port2=port2, catvEnable=catvEnable, jumbwan=jumbwan, voltage=voltage, lan4=lan4, vendorPn=vendorPn, fileType=fileType, bias=bias, txPower=txPower, qmapping=qmapping, lan3=lan3, staticIpSubMask=staticIpSubMask, adminStatus=adminStatus, qosIndex=qosIndex, qos=qos, secondaryDns=secondaryDns, lanportpause=lanportpause, tftp=tftp)
