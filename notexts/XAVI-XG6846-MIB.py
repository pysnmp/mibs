...
Integer32, Bits, Counter64, Unsigned32, Gauge32, snmpModules, Counter32, ModuleIdentity, IpAddress, TimeTicks, iso, MibIdentifier, ObjectIdentity, mib_2, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "Counter64", "Unsigned32", "Gauge32", "snmpModules", "Counter32", "ModuleIdentity", "IpAddress", "TimeTicks", "iso", "MibIdentifier", "ObjectIdentity", "mib-2", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", modeEntry=modeEntry, unicastsTransmitted=unicastsTransmitted, qmode=qmode, lanportTable=lanportTable, vlangroupTable=vlangroupTable, portmode=portmode, staticIpPrimaryDns=staticIpPrimaryDns, staticIpDomainName=staticIpDomainName, ddminfo=ddminfo, multicastsTransmitted=multicastsTransmitted, secondaryDns=secondaryDns, domainame=domainame, lan2=lan2, groupEntry=groupEntry, jumblan1=jumblan1, vendorOui=vendorOui, statIndex=statIndex, broadcastsReceived=broadcastsReceived, fileType=fileType, qosIndex=qosIndex, portEntry=portEntry, jumbwan=jumbwan, pauseReceived=pauseReceived, txPower=txPower, qmapping=qmapping, serialnum=serialnum, port2=port2, qos=qos, port4=port4, lan3=lan3, qosEntry=qosEntry, speed=speed, internetPort=internetPort, groupid=groupid, deviceinfo=deviceinfo, vlanid=vlanid, vendorPn=vendorPn, port1=port1, jumblan3=jumblan3, adminStatus=adminStatus, operStatus=operStatus, unicastsReceived=unicastsReceived, fileName=fileName, jumblan2=jumblan2, groupIndex=groupIndex, portIndex=portIndex, statisticTable=statisticTable, vendorName=vendorName, staticIpSecondaryDns=staticIpSecondaryDns, dscpEnable=dscpEnable, jumb=jumb, lanportspeed=lanportspeed, tftp=tftp, lan4=lan4, staticIpSubMask=staticIpSubMask, portPower=portPower, hostname=hostname, rxPower=rxPower, staticDns=staticDns, jumblan4=jumblan4, vlan=vlan, reboot=reboot, lanportIndex=lanportIndex, pauseTransmitted=pauseTransmitted, portStatEntry=portStatEntry, staticIpGateway=staticIpGateway, staticIpAddr=staticIpAddr, bias=bias, xg6846=xg6846, fcsErrorReceived=fcsErrorReceived, portName=portName, temperature=temperature, qosTable=qosTable, priority=priority, voltage=voltage, broadcastsTransmitted=broadcastsTransmitted, port3=port3, lanportpause=lanportpause, staticIpHostName=staticIpHostName, rebootEnable=rebootEnable, primaryDns=primaryDns, wanType=wanType, lanportName=lanportName, action=action, catvEnable=catvEnable, wan=wan, fcsErrorTransmitted=fcsErrorTransmitted, lan1=lan1, tftpSevIp=tftpSevIp, vendorRev=vendorRev, catv=catv, portTable=portTable, multicastsReceived=multicastsReceived, portStatistic=portStatistic)
