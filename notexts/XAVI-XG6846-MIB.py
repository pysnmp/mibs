...
enterprises, NotificationType, mib_2, iso, Gauge32, Bits, ObjectIdentity, Unsigned32, snmpModules, MibIdentifier, Integer32, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "mib-2", "iso", "Gauge32", "Bits", "ObjectIdentity", "Unsigned32", "snmpModules", "MibIdentifier", "Integer32", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", primaryDns=primaryDns, statIndex=statIndex, jumb=jumb, speed=speed, groupIndex=groupIndex, lanportpause=lanportpause, unicastsTransmitted=unicastsTransmitted, vendorName=vendorName, staticDns=staticDns, vlangroupTable=vlangroupTable, fcsErrorReceived=fcsErrorReceived, staticIpHostName=staticIpHostName, adminStatus=adminStatus, broadcastsTransmitted=broadcastsTransmitted, staticIpAddr=staticIpAddr, staticIpSecondaryDns=staticIpSecondaryDns, lanportName=lanportName, lan4=lan4, catvEnable=catvEnable, action=action, jumblan4=jumblan4, xg6846=xg6846, statisticTable=statisticTable, vendorPn=vendorPn, portIndex=portIndex, vlanid=vlanid, operStatus=operStatus, broadcastsReceived=broadcastsReceived, modeEntry=modeEntry, port4=port4, lan1=lan1, voltage=voltage, ddminfo=ddminfo, jumbwan=jumbwan, port1=port1, portPower=portPower, dscpEnable=dscpEnable, qosEntry=qosEntry, qosTable=qosTable, vendorOui=vendorOui, tftp=tftp, qosIndex=qosIndex, domainame=domainame, groupEntry=groupEntry, pauseReceived=pauseReceived, wanType=wanType, portmode=portmode, txPower=txPower, temperature=temperature, multicastsReceived=multicastsReceived, qmapping=qmapping, staticIpGateway=staticIpGateway, qmode=qmode, portStatEntry=portStatEntry, hostname=hostname, lanportTable=lanportTable, qos=qos, groupid=groupid, reboot=reboot, lanportIndex=lanportIndex, jumblan3=jumblan3, portTable=portTable, multicastsTransmitted=multicastsTransmitted, tftpSevIp=tftpSevIp, vendorRev=vendorRev, lan2=lan2, jumblan1=jumblan1, deviceinfo=deviceinfo, unicastsReceived=unicastsReceived, lan3=lan3, portStatistic=portStatistic, staticIpDomainName=staticIpDomainName, portEntry=portEntry, lanportspeed=lanportspeed, secondaryDns=secondaryDns, staticIpPrimaryDns=staticIpPrimaryDns, rxPower=rxPower, portName=portName, wan=wan, staticIpSubMask=staticIpSubMask, port2=port2, fcsErrorTransmitted=fcsErrorTransmitted, fileName=fileName, internetPort=internetPort, rebootEnable=rebootEnable, priority=priority, port3=port3, fileType=fileType, serialnum=serialnum, jumblan2=jumblan2, catv=catv, vlan=vlan, pauseTransmitted=pauseTransmitted, bias=bias)
