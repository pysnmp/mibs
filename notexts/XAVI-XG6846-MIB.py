...
# Produced by pysmi-1.1.12 at Fri Nov 22 15:12:41 2024
...
TimeTicks, Integer32, Gauge32, Counter64, Unsigned32, ModuleIdentity, iso, ObjectIdentity, mib_2, MibIdentifier, snmpModules, enterprises, Counter32, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "Gauge32", "Counter64", "Unsigned32", "ModuleIdentity", "iso", "ObjectIdentity", "mib-2", "MibIdentifier", "snmpModules", "enterprises", "Counter32", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vlangroupTable=vlangroupTable, unicastsTransmitted=unicastsTransmitted, jumblan2=jumblan2, staticIpGateway=staticIpGateway, jumblan1=jumblan1, portStatistic=portStatistic, jumblan3=jumblan3, multicastsReceived=multicastsReceived, wanType=wanType, lan3=lan3, rxPower=rxPower, catv=catv, vlan=vlan, port1=port1, secondaryDns=secondaryDns, rebootEnable=rebootEnable, lan4=lan4, catvEnable=catvEnable, multicastsTransmitted=multicastsTransmitted, pauseReceived=pauseReceived, staticIpSubMask=staticIpSubMask, jumblan4=jumblan4, jumb=jumb, lanportTable=lanportTable, dscpEnable=dscpEnable, qmode=qmode, portIndex=portIndex, port2=port2, portName=portName, operStatus=operStatus, groupIndex=groupIndex, portStatEntry=portStatEntry, pauseTransmitted=pauseTransmitted, speed=speed, bias=bias, reboot=reboot, lanportpause=lanportpause, ddminfo=ddminfo, groupEntry=groupEntry, lan2=lan2, fcsErrorTransmitted=fcsErrorTransmitted, voltage=voltage, broadcastsReceived=broadcastsReceived, action=action, txPower=txPower, serialnum=serialnum, tftpSevIp=tftpSevIp, wan=wan, portPower=portPower, broadcastsTransmitted=broadcastsTransmitted, port4=port4, vendorOui=vendorOui, vendorName=vendorName, internetPort=internetPort, lan1=lan1, staticIpHostName=staticIpHostName, jumbwan=jumbwan, qosIndex=qosIndex, xg6846=xg6846, vendorPn=vendorPn, lanportspeed=lanportspeed, staticIpDomainName=staticIpDomainName, hostname=hostname, port3=port3, vlanid=vlanid, statisticTable=statisticTable, portTable=portTable, qosTable=qosTable, statIndex=statIndex, primaryDns=primaryDns, tftp=tftp, lanportName=lanportName, domainame=domainame, deviceinfo=deviceinfo, portEntry=portEntry, fileName=fileName, groupid=groupid, unicastsReceived=unicastsReceived, qos=qos, lanportIndex=lanportIndex, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSecondaryDns=staticIpSecondaryDns, fcsErrorReceived=fcsErrorReceived, staticIpAddr=staticIpAddr, portmode=portmode, vendorRev=vendorRev, adminStatus=adminStatus, modeEntry=modeEntry, priority=priority, fileType=fileType, qosEntry=qosEntry, staticDns=staticDns, qmapping=qmapping, temperature=temperature)
