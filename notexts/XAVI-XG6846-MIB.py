...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:27:45 2023
...
snmpModules, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, Integer32, ModuleIdentity, Unsigned32, IpAddress, mib_2, ObjectIdentity, Bits, Counter32, enterprises, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "Integer32", "ModuleIdentity", "Unsigned32", "IpAddress", "mib-2", "ObjectIdentity", "Bits", "Counter32", "enterprises", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", multicastsReceived=multicastsReceived, groupid=groupid, wanType=wanType, portPower=portPower, groupEntry=groupEntry, secondaryDns=secondaryDns, portIndex=portIndex, staticIpGateway=staticIpGateway, txPower=txPower, lanportspeed=lanportspeed, broadcastsReceived=broadcastsReceived, lan1=lan1, pauseTransmitted=pauseTransmitted, adminStatus=adminStatus, modeEntry=modeEntry, vendorRev=vendorRev, qos=qos, portStatEntry=portStatEntry, pauseReceived=pauseReceived, qosEntry=qosEntry, speed=speed, lan2=lan2, qosTable=qosTable, primaryDns=primaryDns, portStatistic=portStatistic, staticIpDomainName=staticIpDomainName, tftp=tftp, dscpEnable=dscpEnable, catv=catv, portEntry=portEntry, priority=priority, ddminfo=ddminfo, internetPort=internetPort, vendorName=vendorName, port1=port1, jumblan2=jumblan2, lanportName=lanportName, qosIndex=qosIndex, fcsErrorTransmitted=fcsErrorTransmitted, reboot=reboot, action=action, lanportpause=lanportpause, staticIpHostName=staticIpHostName, portmode=portmode, portName=portName, operStatus=operStatus, temperature=temperature, voltage=voltage, staticIpSecondaryDns=staticIpSecondaryDns, jumblan4=jumblan4, jumblan1=jumblan1, portTable=portTable, catvEnable=catvEnable, qmode=qmode, port4=port4, wan=wan, lanportIndex=lanportIndex, fileType=fileType, vendorPn=vendorPn, statisticTable=statisticTable, vlangroupTable=vlangroupTable, unicastsTransmitted=unicastsTransmitted, serialnum=serialnum, qmapping=qmapping, bias=bias, vlan=vlan, jumblan3=jumblan3, jumbwan=jumbwan, staticIpAddr=staticIpAddr, multicastsTransmitted=multicastsTransmitted, statIndex=statIndex, groupIndex=groupIndex, vlanid=vlanid, domainame=domainame, fileName=fileName, xg6846=xg6846, vendorOui=vendorOui, fcsErrorReceived=fcsErrorReceived, staticIpPrimaryDns=staticIpPrimaryDns, broadcastsTransmitted=broadcastsTransmitted, jumb=jumb, port2=port2, unicastsReceived=unicastsReceived, rebootEnable=rebootEnable, rxPower=rxPower, deviceinfo=deviceinfo, hostname=hostname, lan4=lan4, staticIpSubMask=staticIpSubMask, staticDns=staticDns, lanportTable=lanportTable, tftpSevIp=tftpSevIp, port3=port3, lan3=lan3)
