...
# Produced by pysmi-1.1.8 at Tue Jul 26 15:44:22 2022
...
Counter64, IpAddress, Gauge32, iso, Unsigned32, ObjectIdentity, NotificationType, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, enterprises, snmpModules, Bits, mib_2, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "Gauge32", "iso", "Unsigned32", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "enterprises", "snmpModules", "Bits", "mib-2", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpAddr=staticIpAddr, lan4=lan4, vendorPn=vendorPn, qos=qos, staticIpPrimaryDns=staticIpPrimaryDns, serialnum=serialnum, domainame=domainame, port3=port3, deviceinfo=deviceinfo, wan=wan, pauseTransmitted=pauseTransmitted, jumblan2=jumblan2, qosIndex=qosIndex, dscpEnable=dscpEnable, multicastsReceived=multicastsReceived, port2=port2, modeEntry=modeEntry, xg6846=xg6846, fcsErrorReceived=fcsErrorReceived, broadcastsReceived=broadcastsReceived, lan3=lan3, lan2=lan2, tftp=tftp, ddminfo=ddminfo, staticIpDomainName=staticIpDomainName, port1=port1, qosEntry=qosEntry, lanportpause=lanportpause, staticDns=staticDns, vlanid=vlanid, jumblan1=jumblan1, multicastsTransmitted=multicastsTransmitted, lanportTable=lanportTable, unicastsTransmitted=unicastsTransmitted, tftpSevIp=tftpSevIp, vendorOui=vendorOui, groupid=groupid, rebootEnable=rebootEnable, fileName=fileName, action=action, lanportspeed=lanportspeed, hostname=hostname, portStatEntry=portStatEntry, broadcastsTransmitted=broadcastsTransmitted, internetPort=internetPort, operStatus=operStatus, qmode=qmode, portEntry=portEntry, lanportName=lanportName, temperature=temperature, secondaryDns=secondaryDns, primaryDns=primaryDns, staticIpSubMask=staticIpSubMask, staticIpGateway=staticIpGateway, priority=priority, portIndex=portIndex, statisticTable=statisticTable, vendorRev=vendorRev, speed=speed, vlangroupTable=vlangroupTable, jumbwan=jumbwan, staticIpSecondaryDns=staticIpSecondaryDns, fcsErrorTransmitted=fcsErrorTransmitted, voltage=voltage, catv=catv, adminStatus=adminStatus, unicastsReceived=unicastsReceived, qosTable=qosTable, jumb=jumb, jumblan4=jumblan4, portStatistic=portStatistic, portTable=portTable, staticIpHostName=staticIpHostName, wanType=wanType, lan1=lan1, txPower=txPower, vlan=vlan, reboot=reboot, port4=port4, fileType=fileType, rxPower=rxPower, groupEntry=groupEntry, catvEnable=catvEnable, portPower=portPower, portmode=portmode, statIndex=statIndex, pauseReceived=pauseReceived, qmapping=qmapping, portName=portName, vendorName=vendorName, jumblan3=jumblan3, lanportIndex=lanportIndex, bias=bias, groupIndex=groupIndex)
