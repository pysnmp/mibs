...
ObjectIdentity, Integer32, TimeTicks, enterprises, iso, NotificationType, snmpModules, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity, Counter64, IpAddress, mib_2, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "TimeTicks", "enterprises", "iso", "NotificationType", "snmpModules", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity", "Counter64", "IpAddress", "mib-2", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vlanid=vlanid, multicastsReceived=multicastsReceived, wanType=wanType, lan3=lan3, lanportpause=lanportpause, adminStatus=adminStatus, staticIpDomainName=staticIpDomainName, broadcastsReceived=broadcastsReceived, serialnum=serialnum, portStatEntry=portStatEntry, statisticTable=statisticTable, port4=port4, modeEntry=modeEntry, vlan=vlan, wan=wan, staticIpAddr=staticIpAddr, secondaryDns=secondaryDns, statIndex=statIndex, rxPower=rxPower, tftp=tftp, lanportspeed=lanportspeed, qmode=qmode, broadcastsTransmitted=broadcastsTransmitted, portPower=portPower, qosIndex=qosIndex, qosTable=qosTable, port2=port2, vendorOui=vendorOui, hostname=hostname, xg6846=xg6846, qosEntry=qosEntry, rebootEnable=rebootEnable, vlangroupTable=vlangroupTable, operStatus=operStatus, portTable=portTable, fcsErrorTransmitted=fcsErrorTransmitted, lan2=lan2, groupid=groupid, vendorRev=vendorRev, action=action, groupEntry=groupEntry, fcsErrorReceived=fcsErrorReceived, primaryDns=primaryDns, port1=port1, staticIpHostName=staticIpHostName, lanportTable=lanportTable, vendorName=vendorName, speed=speed, bias=bias, staticDns=staticDns, lan4=lan4, lan1=lan1, staticIpPrimaryDns=staticIpPrimaryDns, dscpEnable=dscpEnable, port3=port3, pauseTransmitted=pauseTransmitted, portStatistic=portStatistic, internetPort=internetPort, jumb=jumb, groupIndex=groupIndex, fileName=fileName, portName=portName, jumblan4=jumblan4, domainame=domainame, catv=catv, staticIpGateway=staticIpGateway, catvEnable=catvEnable, tftpSevIp=tftpSevIp, deviceinfo=deviceinfo, temperature=temperature, lanportName=lanportName, staticIpSecondaryDns=staticIpSecondaryDns, fileType=fileType, jumblan2=jumblan2, unicastsTransmitted=unicastsTransmitted, jumbwan=jumbwan, qmapping=qmapping, jumblan3=jumblan3, staticIpSubMask=staticIpSubMask, reboot=reboot, vendorPn=vendorPn, unicastsReceived=unicastsReceived, portEntry=portEntry, ddminfo=ddminfo, txPower=txPower, multicastsTransmitted=multicastsTransmitted, pauseReceived=pauseReceived, portIndex=portIndex, portmode=portmode, priority=priority, jumblan1=jumblan1, qos=qos, lanportIndex=lanportIndex, voltage=voltage)
