...
# Produced by pysmi-1.1.8 at Wed Sep 13 08:04:09 2023
...
Unsigned32, TimeTicks, ModuleIdentity, enterprises, Gauge32, iso, Bits, Counter64, ObjectIdentity, mib_2, Counter32, IpAddress, MibIdentifier, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "ModuleIdentity", "enterprises", "Gauge32", "iso", "Bits", "Counter64", "ObjectIdentity", "mib-2", "Counter32", "IpAddress", "MibIdentifier", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fcsErrorReceived=fcsErrorReceived, groupEntry=groupEntry, xg6846=xg6846, groupid=groupid, lan1=lan1, vendorRev=vendorRev, temperature=temperature, lan2=lan2, lan4=lan4, adminStatus=adminStatus, jumblan1=jumblan1, portPower=portPower, dscpEnable=dscpEnable, statisticTable=statisticTable, unicastsTransmitted=unicastsTransmitted, action=action, lanportspeed=lanportspeed, port3=port3, port1=port1, secondaryDns=secondaryDns, lan3=lan3, staticIpDomainName=staticIpDomainName, lanportIndex=lanportIndex, vlangroupTable=vlangroupTable, fileType=fileType, deviceinfo=deviceinfo, statIndex=statIndex, pauseTransmitted=pauseTransmitted, priority=priority, lanportpause=lanportpause, portEntry=portEntry, hostname=hostname, vlan=vlan, staticIpAddr=staticIpAddr, vendorPn=vendorPn, jumblan4=jumblan4, staticIpGateway=staticIpGateway, qos=qos, staticDns=staticDns, primaryDns=primaryDns, catv=catv, serialnum=serialnum, staticIpPrimaryDns=staticIpPrimaryDns, portIndex=portIndex, jumblan2=jumblan2, vendorOui=vendorOui, domainame=domainame, reboot=reboot, qmapping=qmapping, ddminfo=ddminfo, qosTable=qosTable, qmode=qmode, qosIndex=qosIndex, portStatEntry=portStatEntry, portName=portName, fileName=fileName, broadcastsReceived=broadcastsReceived, tftpSevIp=tftpSevIp, wan=wan, speed=speed, lanportName=lanportName, staticIpSubMask=staticIpSubMask, operStatus=operStatus, lanportTable=lanportTable, fcsErrorTransmitted=fcsErrorTransmitted, port2=port2, portmode=portmode, vlanid=vlanid, groupIndex=groupIndex, portStatistic=portStatistic, modeEntry=modeEntry, catvEnable=catvEnable, staticIpHostName=staticIpHostName, rxPower=rxPower, bias=bias, unicastsReceived=unicastsReceived, jumb=jumb, rebootEnable=rebootEnable, port4=port4, vendorName=vendorName, multicastsReceived=multicastsReceived, jumbwan=jumbwan, multicastsTransmitted=multicastsTransmitted, jumblan3=jumblan3, pauseReceived=pauseReceived, tftp=tftp, staticIpSecondaryDns=staticIpSecondaryDns, voltage=voltage, portTable=portTable, qosEntry=qosEntry, internetPort=internetPort, wanType=wanType, broadcastsTransmitted=broadcastsTransmitted, txPower=txPower)
