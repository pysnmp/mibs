...
IpAddress, Counter32, Integer32, enterprises, mib_2, NotificationType, Counter64, iso, Unsigned32, TimeTicks, snmpModules, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter32", "Integer32", "enterprises", "mib-2", "NotificationType", "Counter64", "iso", "Unsigned32", "TimeTicks", "snmpModules", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portStatistic=portStatistic, multicastsTransmitted=multicastsTransmitted, action=action, rxPower=rxPower, lan3=lan3, groupid=groupid, staticIpPrimaryDns=staticIpPrimaryDns, lanportIndex=lanportIndex, lan2=lan2, fileType=fileType, jumblan3=jumblan3, unicastsTransmitted=unicastsTransmitted, hostname=hostname, operStatus=operStatus, port1=port1, pauseReceived=pauseReceived, tftpSevIp=tftpSevIp, portPower=portPower, qmapping=qmapping, portEntry=portEntry, dscpEnable=dscpEnable, fcsErrorReceived=fcsErrorReceived, bias=bias, tftp=tftp, voltage=voltage, statisticTable=statisticTable, jumbwan=jumbwan, wanType=wanType, statIndex=statIndex, secondaryDns=secondaryDns, unicastsReceived=unicastsReceived, staticIpAddr=staticIpAddr, port3=port3, jumblan2=jumblan2, qos=qos, catvEnable=catvEnable, primaryDns=primaryDns, rebootEnable=rebootEnable, jumblan4=jumblan4, vendorPn=vendorPn, lan1=lan1, staticIpSubMask=staticIpSubMask, wan=wan, lanportspeed=lanportspeed, temperature=temperature, vendorOui=vendorOui, lanportpause=lanportpause, adminStatus=adminStatus, qosIndex=qosIndex, priority=priority, jumblan1=jumblan1, modeEntry=modeEntry, port2=port2, catv=catv, broadcastsTransmitted=broadcastsTransmitted, staticIpHostName=staticIpHostName, txPower=txPower, serialnum=serialnum, staticIpGateway=staticIpGateway, deviceinfo=deviceinfo, pauseTransmitted=pauseTransmitted, portmode=portmode, fileName=fileName, lan4=lan4, groupIndex=groupIndex, domainame=domainame, reboot=reboot, staticIpSecondaryDns=staticIpSecondaryDns, lanportTable=lanportTable, internetPort=internetPort, port4=port4, jumb=jumb, portStatEntry=portStatEntry, vendorName=vendorName, staticIpDomainName=staticIpDomainName, portTable=portTable, vlangroupTable=vlangroupTable, portIndex=portIndex, fcsErrorTransmitted=fcsErrorTransmitted, qmode=qmode, lanportName=lanportName, xg6846=xg6846, qosEntry=qosEntry, speed=speed, vendorRev=vendorRev, broadcastsReceived=broadcastsReceived, ddminfo=ddminfo, vlan=vlan, groupEntry=groupEntry, vlanid=vlanid, qosTable=qosTable, multicastsReceived=multicastsReceived, staticDns=staticDns, portName=portName)
