...
Counter32, Bits, ModuleIdentity, MibIdentifier, enterprises, Integer32, TimeTicks, Unsigned32, Counter64, snmpModules, Gauge32, ObjectIdentity, IpAddress, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "ModuleIdentity", "MibIdentifier", "enterprises", "Integer32", "TimeTicks", "Unsigned32", "Counter64", "snmpModules", "Gauge32", "ObjectIdentity", "IpAddress", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupIndex=groupIndex, fcsErrorTransmitted=fcsErrorTransmitted, multicastsReceived=multicastsReceived, port2=port2, hostname=hostname, secondaryDns=secondaryDns, wan=wan, vlanid=vlanid, lanportIndex=lanportIndex, qmode=qmode, qosIndex=qosIndex, jumblan4=jumblan4, broadcastsTransmitted=broadcastsTransmitted, qmapping=qmapping, staticIpDomainName=staticIpDomainName, priority=priority, staticIpGateway=staticIpGateway, groupid=groupid, jumblan2=jumblan2, lan3=lan3, portStatistic=portStatistic, groupEntry=groupEntry, port3=port3, rebootEnable=rebootEnable, portIndex=portIndex, speed=speed, lanportpause=lanportpause, portStatEntry=portStatEntry, unicastsReceived=unicastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, jumb=jumb, dscpEnable=dscpEnable, portName=portName, fileType=fileType, jumblan1=jumblan1, ddminfo=ddminfo, fileName=fileName, bias=bias, temperature=temperature, deviceinfo=deviceinfo, pauseTransmitted=pauseTransmitted, lanportspeed=lanportspeed, lanportTable=lanportTable, lan4=lan4, statIndex=statIndex, qosEntry=qosEntry, action=action, fcsErrorReceived=fcsErrorReceived, lan1=lan1, reboot=reboot, staticIpHostName=staticIpHostName, jumblan3=jumblan3, qos=qos, xg6846=xg6846, vendorPn=vendorPn, vendorRev=vendorRev, lan2=lan2, adminStatus=adminStatus, pauseReceived=pauseReceived, port4=port4, txPower=txPower, modeEntry=modeEntry, serialnum=serialnum, qosTable=qosTable, jumbwan=jumbwan, multicastsTransmitted=multicastsTransmitted, rxPower=rxPower, portEntry=portEntry, primaryDns=primaryDns, staticIpAddr=staticIpAddr, staticIpPrimaryDns=staticIpPrimaryDns, vendorName=vendorName, portmode=portmode, vlan=vlan, unicastsTransmitted=unicastsTransmitted, domainame=domainame, tftp=tftp, internetPort=internetPort, vendorOui=vendorOui, lanportName=lanportName, catv=catv, portPower=portPower, voltage=voltage, vlangroupTable=vlangroupTable, wanType=wanType, staticDns=staticDns, portTable=portTable, port1=port1, staticIpSubMask=staticIpSubMask, operStatus=operStatus, catvEnable=catvEnable, broadcastsReceived=broadcastsReceived, statisticTable=statisticTable, tftpSevIp=tftpSevIp)
