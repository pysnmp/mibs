...
# Produced by pysmi-1.1.0 at Tue Nov 16 11:28:03 2021
...
TimeTicks, mib_2, Bits, IpAddress, NotificationType, Integer32, iso, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, snmpModules, Gauge32, Unsigned32, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "mib-2", "Bits", "IpAddress", "NotificationType", "Integer32", "iso", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "snmpModules", "Gauge32", "Unsigned32", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catvEnable=catvEnable, lan2=lan2, portStatistic=portStatistic, operStatus=operStatus, groupEntry=groupEntry, domainame=domainame, action=action, groupIndex=groupIndex, rxPower=rxPower, portEntry=portEntry, internetPort=internetPort, voltage=voltage, vlan=vlan, groupid=groupid, qmapping=qmapping, lanportTable=lanportTable, port2=port2, portmode=portmode, qosTable=qosTable, qos=qos, fileName=fileName, bias=bias, port3=port3, qmode=qmode, hostname=hostname, qosEntry=qosEntry, staticIpSecondaryDns=staticIpSecondaryDns, vlanid=vlanid, jumbwan=jumbwan, broadcastsReceived=broadcastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSubMask=staticIpSubMask, staticDns=staticDns, pauseReceived=pauseReceived, portIndex=portIndex, jumblan4=jumblan4, txPower=txPower, port1=port1, lan1=lan1, vendorRev=vendorRev, lan4=lan4, speed=speed, vendorOui=vendorOui, priority=priority, vlangroupTable=vlangroupTable, portName=portName, pauseTransmitted=pauseTransmitted, lanportspeed=lanportspeed, statisticTable=statisticTable, lanportIndex=lanportIndex, wanType=wanType, ddminfo=ddminfo, adminStatus=adminStatus, modeEntry=modeEntry, qosIndex=qosIndex, portPower=portPower, lanportName=lanportName, fileType=fileType, temperature=temperature, lanportpause=lanportpause, jumb=jumb, multicastsTransmitted=multicastsTransmitted, jumblan2=jumblan2, vendorName=vendorName, multicastsReceived=multicastsReceived, staticIpGateway=staticIpGateway, tftpSevIp=tftpSevIp, serialnum=serialnum, jumblan1=jumblan1, broadcastsTransmitted=broadcastsTransmitted, secondaryDns=secondaryDns, reboot=reboot, tftp=tftp, xg6846=xg6846, unicastsTransmitted=unicastsTransmitted, jumblan3=jumblan3, portStatEntry=portStatEntry, statIndex=statIndex, unicastsReceived=unicastsReceived, fcsErrorReceived=fcsErrorReceived, lan3=lan3, catv=catv, primaryDns=primaryDns, staticIpAddr=staticIpAddr, staticIpDomainName=staticIpDomainName, port4=port4, deviceinfo=deviceinfo, dscpEnable=dscpEnable, vendorPn=vendorPn, fcsErrorTransmitted=fcsErrorTransmitted, portTable=portTable, staticIpHostName=staticIpHostName, rebootEnable=rebootEnable, wan=wan)
