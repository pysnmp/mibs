...
Gauge32, enterprises, NotificationType, IpAddress, Bits, Counter64, Unsigned32, snmpModules, ObjectIdentity, TimeTicks, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, mib_2, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "NotificationType", "IpAddress", "Bits", "Counter64", "Unsigned32", "snmpModules", "ObjectIdentity", "TimeTicks", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "mib-2", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", txPower=txPower, staticIpHostName=staticIpHostName, xg6846=xg6846, groupid=groupid, port1=port1, vendorPn=vendorPn, portStatEntry=portStatEntry, voltage=voltage, unicastsTransmitted=unicastsTransmitted, fileName=fileName, lanportTable=lanportTable, staticIpAddr=staticIpAddr, lanportspeed=lanportspeed, port4=port4, operStatus=operStatus, vendorOui=vendorOui, lanportIndex=lanportIndex, lanportpause=lanportpause, modeEntry=modeEntry, vendorName=vendorName, portEntry=portEntry, vlan=vlan, fcsErrorTransmitted=fcsErrorTransmitted, portPower=portPower, staticDns=staticDns, serialnum=serialnum, port3=port3, qosEntry=qosEntry, broadcastsReceived=broadcastsReceived, wan=wan, qosIndex=qosIndex, statisticTable=statisticTable, bias=bias, qmapping=qmapping, qmode=qmode, speed=speed, temperature=temperature, jumb=jumb, hostname=hostname, multicastsReceived=multicastsReceived, action=action, reboot=reboot, jumblan1=jumblan1, qosTable=qosTable, pauseTransmitted=pauseTransmitted, tftpSevIp=tftpSevIp, jumblan2=jumblan2, unicastsReceived=unicastsReceived, statIndex=statIndex, jumblan3=jumblan3, broadcastsTransmitted=broadcastsTransmitted, lan2=lan2, jumbwan=jumbwan, jumblan4=jumblan4, rxPower=rxPower, portName=portName, portStatistic=portStatistic, primaryDns=primaryDns, multicastsTransmitted=multicastsTransmitted, rebootEnable=rebootEnable, secondaryDns=secondaryDns, qos=qos, vlangroupTable=vlangroupTable, staticIpSubMask=staticIpSubMask, lan4=lan4, fileType=fileType, priority=priority, pauseReceived=pauseReceived, lan3=lan3, deviceinfo=deviceinfo, catvEnable=catvEnable, portmode=portmode, groupIndex=groupIndex, lanportName=lanportName, lan1=lan1, staticIpDomainName=staticIpDomainName, vendorRev=vendorRev, tftp=tftp, wanType=wanType, vlanid=vlanid, portIndex=portIndex, staticIpSecondaryDns=staticIpSecondaryDns, portTable=portTable, catv=catv, groupEntry=groupEntry, ddminfo=ddminfo, fcsErrorReceived=fcsErrorReceived, internetPort=internetPort, staticIpPrimaryDns=staticIpPrimaryDns, staticIpGateway=staticIpGateway, adminStatus=adminStatus, domainame=domainame, dscpEnable=dscpEnable, port2=port2)
