...
# Produced by pysmi-1.1.8 at Mon Jan 16 15:37:20 2023
...
Bits, Unsigned32, ModuleIdentity, MibIdentifier, iso, Integer32, IpAddress, Gauge32, NotificationType, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, enterprises, TimeTicks, Counter64, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "ModuleIdentity", "MibIdentifier", "iso", "Integer32", "IpAddress", "Gauge32", "NotificationType", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "enterprises", "TimeTicks", "Counter64", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port4=port4, operStatus=operStatus, fileName=fileName, lan3=lan3, priority=priority, rxPower=rxPower, broadcastsTransmitted=broadcastsTransmitted, groupIndex=groupIndex, jumblan3=jumblan3, vlanid=vlanid, jumblan4=jumblan4, vlan=vlan, portmode=portmode, staticIpAddr=staticIpAddr, staticIpHostName=staticIpHostName, qosEntry=qosEntry, vendorRev=vendorRev, jumbwan=jumbwan, staticIpSubMask=staticIpSubMask, speed=speed, portIndex=portIndex, tftpSevIp=tftpSevIp, lan2=lan2, fcsErrorReceived=fcsErrorReceived, lanportIndex=lanportIndex, multicastsTransmitted=multicastsTransmitted, groupEntry=groupEntry, bias=bias, secondaryDns=secondaryDns, vendorOui=vendorOui, portStatEntry=portStatEntry, qos=qos, modeEntry=modeEntry, voltage=voltage, portEntry=portEntry, groupid=groupid, portName=portName, portPower=portPower, fileType=fileType, port2=port2, lanportspeed=lanportspeed, dscpEnable=dscpEnable, statIndex=statIndex, portTable=portTable, pauseReceived=pauseReceived, multicastsReceived=multicastsReceived, broadcastsReceived=broadcastsReceived, catvEnable=catvEnable, catv=catv, xg6846=xg6846, jumblan1=jumblan1, vendorPn=vendorPn, domainame=domainame, deviceinfo=deviceinfo, qosIndex=qosIndex, action=action, temperature=temperature, fcsErrorTransmitted=fcsErrorTransmitted, port1=port1, reboot=reboot, vendorName=vendorName, serialnum=serialnum, unicastsTransmitted=unicastsTransmitted, qosTable=qosTable, staticIpDomainName=staticIpDomainName, lanportName=lanportName, wanType=wanType, txPower=txPower, qmapping=qmapping, portStatistic=portStatistic, pauseTransmitted=pauseTransmitted, unicastsReceived=unicastsReceived, tftp=tftp, jumb=jumb, staticIpPrimaryDns=staticIpPrimaryDns, lan4=lan4, primaryDns=primaryDns, staticDns=staticDns, staticIpGateway=staticIpGateway, lanportpause=lanportpause, wan=wan, internetPort=internetPort, adminStatus=adminStatus, staticIpSecondaryDns=staticIpSecondaryDns, ddminfo=ddminfo, rebootEnable=rebootEnable, jumblan2=jumblan2, qmode=qmode, lan1=lan1, lanportTable=lanportTable, statisticTable=statisticTable, port3=port3, hostname=hostname, vlangroupTable=vlangroupTable)
