...
# Produced by pysmi-1.1.8 at Tue Sep 12 08:08:13 2023
...
Integer32, Gauge32, Unsigned32, mib_2, snmpModules, Counter32, enterprises, ObjectIdentity, TimeTicks, MibIdentifier, NotificationType, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "Unsigned32", "mib-2", "snmpModules", "Counter32", "enterprises", "ObjectIdentity", "TimeTicks", "MibIdentifier", "NotificationType", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan4=lan4, portStatistic=portStatistic, qos=qos, lanportName=lanportName, jumb=jumb, catv=catv, action=action, internetPort=internetPort, lanportpause=lanportpause, qmode=qmode, unicastsTransmitted=unicastsTransmitted, hostname=hostname, lanportspeed=lanportspeed, jumblan4=jumblan4, portEntry=portEntry, unicastsReceived=unicastsReceived, qosEntry=qosEntry, jumblan3=jumblan3, temperature=temperature, vendorName=vendorName, staticIpGateway=staticIpGateway, fileType=fileType, modeEntry=modeEntry, vlanid=vlanid, multicastsTransmitted=multicastsTransmitted, port1=port1, fcsErrorTransmitted=fcsErrorTransmitted, broadcastsReceived=broadcastsReceived, portName=portName, lanportTable=lanportTable, portStatEntry=portStatEntry, portIndex=portIndex, staticDns=staticDns, rxPower=rxPower, vendorOui=vendorOui, staticIpDomainName=staticIpDomainName, tftp=tftp, groupEntry=groupEntry, groupIndex=groupIndex, txPower=txPower, broadcastsTransmitted=broadcastsTransmitted, lanportIndex=lanportIndex, jumblan2=jumblan2, dscpEnable=dscpEnable, xg6846=xg6846, catvEnable=catvEnable, bias=bias, fileName=fileName, qosIndex=qosIndex, adminStatus=adminStatus, port2=port2, portmode=portmode, lan3=lan3, portPower=portPower, vlan=vlan, vlangroupTable=vlangroupTable, qmapping=qmapping, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSecondaryDns=staticIpSecondaryDns, wanType=wanType, portTable=portTable, reboot=reboot, statisticTable=statisticTable, jumblan1=jumblan1, deviceinfo=deviceinfo, speed=speed, ddminfo=ddminfo, secondaryDns=secondaryDns, port4=port4, lan2=lan2, staticIpHostName=staticIpHostName, pauseReceived=pauseReceived, staticIpSubMask=staticIpSubMask, statIndex=statIndex, lan1=lan1, wan=wan, voltage=voltage, primaryDns=primaryDns, operStatus=operStatus, domainame=domainame, port3=port3, serialnum=serialnum, vendorPn=vendorPn, fcsErrorReceived=fcsErrorReceived, rebootEnable=rebootEnable, pauseTransmitted=pauseTransmitted, groupid=groupid, staticIpAddr=staticIpAddr, jumbwan=jumbwan, priority=priority, vendorRev=vendorRev, multicastsReceived=multicastsReceived, tftpSevIp=tftpSevIp, qosTable=qosTable)
