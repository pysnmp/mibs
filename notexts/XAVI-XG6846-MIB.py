...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, enterprises, Bits, Integer32, NotificationType, Counter64, Gauge32, MibIdentifier, Counter32, TimeTicks, mib_2, ModuleIdentity, IpAddress, snmpModules, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "enterprises", "Bits", "Integer32", "NotificationType", "Counter64", "Gauge32", "MibIdentifier", "Counter32", "TimeTicks", "mib-2", "ModuleIdentity", "IpAddress", "snmpModules", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", hostname=hostname, serialnum=serialnum, staticIpSubMask=staticIpSubMask, groupIndex=groupIndex, broadcastsTransmitted=broadcastsTransmitted, staticIpAddr=staticIpAddr, secondaryDns=secondaryDns, portmode=portmode, xg6846=xg6846, priority=priority, jumb=jumb, bias=bias, domainame=domainame, speed=speed, deviceinfo=deviceinfo, catvEnable=catvEnable, fcsErrorTransmitted=fcsErrorTransmitted, portPower=portPower, tftp=tftp, txPower=txPower, groupid=groupid, lanportTable=lanportTable, vendorOui=vendorOui, vlanid=vlanid, lanportName=lanportName, lan2=lan2, lanportpause=lanportpause, fileType=fileType, groupEntry=groupEntry, vendorPn=vendorPn, statIndex=statIndex, portTable=portTable, multicastsReceived=multicastsReceived, unicastsReceived=unicastsReceived, wanType=wanType, port1=port1, operStatus=operStatus, staticIpPrimaryDns=staticIpPrimaryDns, lanportIndex=lanportIndex, vlan=vlan, qos=qos, statisticTable=statisticTable, jumblan1=jumblan1, internetPort=internetPort, vendorName=vendorName, ddminfo=ddminfo, lan4=lan4, jumblan3=jumblan3, portEntry=portEntry, staticIpDomainName=staticIpDomainName, lan3=lan3, unicastsTransmitted=unicastsTransmitted, adminStatus=adminStatus, lanportspeed=lanportspeed, qosTable=qosTable, portStatistic=portStatistic, portStatEntry=portStatEntry, fileName=fileName, modeEntry=modeEntry, dscpEnable=dscpEnable, jumblan4=jumblan4, vlangroupTable=vlangroupTable, vendorRev=vendorRev, port4=port4, rebootEnable=rebootEnable, fcsErrorReceived=fcsErrorReceived, jumbwan=jumbwan, primaryDns=primaryDns, lan1=lan1, multicastsTransmitted=multicastsTransmitted, portName=portName, qosEntry=qosEntry, port3=port3, staticDns=staticDns, tftpSevIp=tftpSevIp, reboot=reboot, portIndex=portIndex, qmode=qmode, rxPower=rxPower, action=action, temperature=temperature, staticIpSecondaryDns=staticIpSecondaryDns, pauseReceived=pauseReceived, broadcastsReceived=broadcastsReceived, port2=port2, staticIpHostName=staticIpHostName, staticIpGateway=staticIpGateway, qosIndex=qosIndex, pauseTransmitted=pauseTransmitted, catv=catv, qmapping=qmapping, wan=wan, voltage=voltage, jumblan2=jumblan2)
