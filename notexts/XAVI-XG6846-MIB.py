...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:38:46 2023
...
snmpModules, Gauge32, TimeTicks, NotificationType, enterprises, Counter32, Counter64, Unsigned32, iso, mib_2, MibIdentifier, Integer32, ModuleIdentity, IpAddress, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "Gauge32", "TimeTicks", "NotificationType", "enterprises", "Counter32", "Counter64", "Unsigned32", "iso", "mib-2", "MibIdentifier", "Integer32", "ModuleIdentity", "IpAddress", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port3=port3, portIndex=portIndex, fileName=fileName, portEntry=portEntry, rxPower=rxPower, broadcastsReceived=broadcastsReceived, txPower=txPower, groupIndex=groupIndex, port4=port4, lan4=lan4, staticIpPrimaryDns=staticIpPrimaryDns, fcsErrorTransmitted=fcsErrorTransmitted, unicastsReceived=unicastsReceived, lan1=lan1, qos=qos, action=action, qosTable=qosTable, jumblan2=jumblan2, lanportTable=lanportTable, staticIpSecondaryDns=staticIpSecondaryDns, unicastsTransmitted=unicastsTransmitted, deviceinfo=deviceinfo, dscpEnable=dscpEnable, port2=port2, catv=catv, lan3=lan3, vlangroupTable=vlangroupTable, priority=priority, groupid=groupid, lan2=lan2, pauseReceived=pauseReceived, temperature=temperature, voltage=voltage, internetPort=internetPort, ddminfo=ddminfo, secondaryDns=secondaryDns, vendorOui=vendorOui, portTable=portTable, port1=port1, jumblan1=jumblan1, lanportIndex=lanportIndex, xg6846=xg6846, jumb=jumb, hostname=hostname, reboot=reboot, tftpSevIp=tftpSevIp, primaryDns=primaryDns, modeEntry=modeEntry, wanType=wanType, staticIpSubMask=staticIpSubMask, adminStatus=adminStatus, fileType=fileType, staticDns=staticDns, staticIpGateway=staticIpGateway, jumblan4=jumblan4, vendorRev=vendorRev, operStatus=operStatus, speed=speed, staticIpAddr=staticIpAddr, broadcastsTransmitted=broadcastsTransmitted, wan=wan, bias=bias, portStatistic=portStatistic, portmode=portmode, jumbwan=jumbwan, qosIndex=qosIndex, vendorName=vendorName, multicastsTransmitted=multicastsTransmitted, rebootEnable=rebootEnable, qosEntry=qosEntry, qmapping=qmapping, jumblan3=jumblan3, multicastsReceived=multicastsReceived, groupEntry=groupEntry, staticIpHostName=staticIpHostName, staticIpDomainName=staticIpDomainName, vlan=vlan, tftp=tftp, domainame=domainame, catvEnable=catvEnable, lanportName=lanportName, statisticTable=statisticTable, qmode=qmode, pauseTransmitted=pauseTransmitted, vlanid=vlanid, portStatEntry=portStatEntry, serialnum=serialnum, lanportspeed=lanportspeed, lanportpause=lanportpause, vendorPn=vendorPn, statIndex=statIndex, portPower=portPower, fcsErrorReceived=fcsErrorReceived, portName=portName)
