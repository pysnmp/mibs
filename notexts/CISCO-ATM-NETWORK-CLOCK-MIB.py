...
# ASN.1 source CISCO-ATM-NETWORK-CLOCK-MIB
# Source digest sha256:b53623eb5d5dd32b176e86a52ae86793e33f54ba9b234d8bb839a56974f78764
...
if mibBuilder.loadTexts: ciscoAtmNetworkClockMIB.setLastUpdated('2008-02-18 00:00')
...
cncSourceChangeTimeStamp = MibScalar((1, 3, 6, 1, 4, 1, 9, 9, 121, 1, 1, 8), TimeStamp().clone(0)).setMaxAccess("readonly")
...
cncManualSourceTable = MibTable((1, 3, 6, 1, 4, 1, 9, 9, 121, 1, 2, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: cncManualSourceTable.setStatus('current')
cncManualSourceEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 9, 121, 1, 2, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CISCO-ATM-NETWORK-CLOCK-MIB", "cncManualSourcePriority"))
if mibBuilder.loadTexts: cncManualSourceEntry.setStatus('current')
cncManualSourcePriority = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 121, 1, 2, 1, 1, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("primary", 1), ("secondary", 2), ("default", 3)))).setMaxAccess("notaccessible")
...
cncNcdpSourceTable = MibTable((1, 3, 6, 1, 4, 1, 9, 9, 121, 1, 3, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: cncNcdpSourceTable.setStatus('current')
cncNcdpSourceEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 9, 121, 1, 3, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "ENTITY-MIB", "entPhysicalIndex"))
...
cncNcdpAtmTable = MibTable((1, 3, 6, 1, 4, 1, 9, 9, 121, 1, 4, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: cncNcdpAtmTable.setStatus('current')
cncNcdpAtmEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 9, 121, 1, 4, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "ENTITY-MIB", "entPhysicalIndex"))
...
cncNcdpVpi = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 121, 1, 4, 1, 1, 3), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 4095)).clone(0)).setMaxAccess("readwrite")
...
mibBuilder.exportSymbols("CISCO-ATM-NETWORK-CLOCK-MIB", CncHealth=CncHealth, CncStratum=CncStratum, PYSNMP_MODULE_ID=ciscoAtmNetworkClockMIB, ciscoAtmNetworkClockConformance=ciscoAtmNetworkClockConformance, ciscoAtmNetworkClockMIB=ciscoAtmNetworkClockMIB, ciscoAtmNetworkClockMIBCompliances=ciscoAtmNetworkClockMIBCompliances, ciscoAtmNetworkClockMIBGroups=ciscoAtmNetworkClockMIBGroups, ciscoAtmNetworkClockMIBNotifications=ciscoAtmNetworkClockMIBNotifications, ciscoAtmNetworkClockMIBObjects=ciscoAtmNetworkClockMIBObjects, ciscoAtmNetworkClockNotificationPrefix=ciscoAtmNetworkClockNotificationPrefix, cncDistributionMethod=cncDistributionMethod, cncGlobal=cncGlobal, cncGroup=cncGroup, cncMIBCompliance=cncMIBCompliance, cncManualRowStatus=cncManualRowStatus, cncManualSource=cncManualSource, cncManualSourceEntry=cncManualSourceEntry, cncManualSourceHealth=cncManualSourceHealth, cncManualSourceId=cncManualSourceId, cncManualSourcePriority=cncManualSourcePriority, cncManualSourceTable=cncManualSourceTable, cncNcdp=cncNcdp, cncNcdpAdminWeight=cncNcdpAdminWeight, cncNcdpAtmEntry=cncNcdpAtmEntry, cncNcdpAtmTable=cncNcdpAtmTable, cncNcdpBestClockSource=cncNcdpBestClockSource, cncNcdpEnable=cncNcdpEnable, cncNcdpHealth=cncNcdpHealth, cncNcdpHoldTime=cncNcdpHoldTime, cncNcdpMaxDiameter=cncNcdpMaxDiameter, cncNcdpMessageInterval=cncNcdpMessageInterval, cncNcdpPRSReference=cncNcdpPRSReference, cncNcdpPriority=cncNcdpPriority, cncNcdpRowStatus=cncNcdpRowStatus, cncNcdpSource=cncNcdpSource, cncNcdpSourceEntry=cncNcdpSourceEntry, cncNcdpSourceHealth=cncNcdpSourceHealth, cncNcdpSourceTable=cncNcdpSourceTable, cncNcdpStratum=cncNcdpStratum, cncNcdpVci=cncNcdpVci, cncNcdpVpi=cncNcdpVpi, cncNodeStratum=cncNodeStratum, cncNotificationGroup=cncNotificationGroup, cncNotificationOnChange=cncNotificationOnChange, cncNotifySourceChange=cncNotifySourceChange, cncRootClockSource=cncRootClockSource, cncSourceChangeReason=cncSourceChangeReason, cncSourceChangeTimeStamp=cncSourceChangeTimeStamp)
