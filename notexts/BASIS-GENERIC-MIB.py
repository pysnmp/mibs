...
# ASN.1 source BASIS-GENERIC-MIB
# Source digest sha256:4fd55e514d5641cc8e1a25e361bc60bf40397d81a699b793726f60bcadfe2e3e
...
configChangeTypeBitMap = MibScalar((1, 3, 6, 1, 4, 1, 351, 110, 2, 1, 17), Integer32().clone(0)).setMaxAccess("readonly")
...
configChangeStatus = MibScalar((1, 3, 6, 1, 4, 1, 351, 110, 2, 1, 19), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 3)).clone(0)).setMaxAccess("readonly")
if mibBuilder.loadTexts: configChangeStatus.setStatus('mandatory')
cardIntegratedAlarmBitMap = MibScalar((1, 3, 6, 1, 4, 1, 351, 110, 2, 1, 20), Integer32().clone(0)).setMaxAccess("readonly")
...
interfaceLineTable = MibTable((1, 3, 6, 1, 4, 1, 351, 110, 2, 2, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: interfaceLineTable.setStatus('mandatory')
interfaceLineEntry = MibTableRow((1, 3, 6, 1, 4, 1, 351, 110, 2, 2, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "BASIS-GENERIC-MIB", "interfaceLineNum"))
...
sarChannelCounterTable = MibTable((1, 3, 6, 1, 4, 1, 351, 110, 2, 5, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: sarChannelCounterTable.setStatus('mandatory')
sarChannelCounterEntry = MibTableRow((1, 3, 6, 1, 4, 1, 351, 110, 2, 5, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "BASIS-GENERIC-MIB", "sarShelfNum"), (0, "BASIS-GENERIC-MIB", "sarSlotNum"), (0, "BASIS-GENERIC-MIB", "sarChanNum"))
...
mibBuilder.exportSymbols("BASIS-GENERIC-MIB", cardInformation=cardInformation, cardIntegratedAlarmBitMap=cardIntegratedAlarmBitMap, cardInterface=cardInterface, cardSelfTest=cardSelfTest, chanNumOfValidEntries=chanNumOfValidEntries, cleiCode=cleiCode, configChangeGrandParentObjectIndex=configChangeGrandParentObjectIndex, configChangeObjectIndex=configChangeObjectIndex, configChangeParentObjectIndex=configChangeParentObjectIndex, configChangeSMSpecificObject=configChangeSMSpecificObject, configChangeStatus=configChangeStatus, configChangeTypeBitMap=configChangeTypeBitMap, controlMsgCounter=controlMsgCounter, ctrlMsgClrButton=ctrlMsgClrButton, finalTestTechnician=finalTestTechnician, functionModuleDescription=functionModuleDescription, functionModuleFWRev=functionModuleFWRev, functionModuleHWRev=functionModuleHWRev, functionModuleResetReason=functionModuleResetReason, functionModuleSerialNum=functionModuleSerialNum, functionModuleState=functionModuleState, functionModuleType=functionModuleType, hwFailures=hwFailures, hwHistory=hwHistory, interfaceLineEntry=interfaceLineEntry, interfaceLineNum=interfaceLineNum, interfaceLineTable=interfaceLineTable, interfaceLineType=interfaceLineType, interfaceNumOfEgressQueue=interfaceNumOfEgressQueue, interfaceNumOfPVC=interfaceNumOfPVC, interfaceNumOfPortsPerLine=interfaceNumOfPortsPerLine, interfaceNumOfValidEntries=interfaceNumOfValidEntries, interfaceServiceType=interfaceServiceType, lineModuleDescription=lineModuleDescription, lineModuleFWRev=lineModuleFWRev, lineModuleHWRev=lineModuleHWRev, lineModuleSerialNum=lineModuleSerialNum, lineModuleState=lineModuleState, lineModuleType=lineModuleType, macAddrBlkSize=macAddrBlkSize, macAddress=macAddress, mibVersionNumber=mibVersionNumber, moduleSlotNumber=moduleSlotNumber, moduleTrapAlarmSeverity=moduleTrapAlarmSeverity, rcvCells=rcvCells, rcvCellsAIS=rcvCellsAIS, rcvCellsBCM=rcvCellsBCM, rcvCellsCLP=rcvCellsCLP, rcvCellsDiscOAM=rcvCellsDiscOAM, rcvCellsEnd2EndLpBk=rcvCellsEnd2EndLpBk, rcvCellsFERF=rcvCellsFERF, rcvCellsSegmentLpBk=rcvCellsSegmentLpBk, riscRcvCtrlMsg=riscRcvCtrlMsg, riscXmtCtrlMsg=riscXmtCtrlMsg, sarChanNum=sarChanNum, sarChannelCounter=sarChannelCounter, sarChannelCounterEntry=sarChannelCounterEntry, sarChannelCounterTable=sarChannelCounterTable, sarClrButton=sarClrButton, sarCtrlMsgDiscCRCErr=sarCtrlMsgDiscCRCErr, sarCtrlMsgDiscLenErr=sarCtrlMsgDiscLenErr, sarCtrlMsgDiscUnknownChan=sarCtrlMsgDiscUnknownChan, sarCtrlMsgLastUnkownChan=sarCtrlMsgLastUnkownChan, sarRcvCtrlMsg=sarRcvCtrlMsg, sarShelfNum=sarShelfNum, sarSlotNum=sarSlotNum, sarXmtCtrlMsg=sarXmtCtrlMsg, secLineModuleDescription=secLineModuleDescription, secLineModuleFWRev=secLineModuleFWRev, secLineModuleHWRev=secLineModuleHWRev, secLineModuleSerialNum=secLineModuleSerialNum, secLineModuleState=secLineModuleState, secLineModuleType=secLineModuleType, selfTestClrResultButton=selfTestClrResultButton, selfTestEnable=selfTestEnable, selfTestPeriod=selfTestPeriod, selfTestResultDescription=selfTestResultDescription, selfTestState=selfTestState, transId=transId, xmtCells=xmtCells, xmtCellsAIS=xmtCellsAIS, xmtCellsBCM=xmtCellsBCM, xmtCellsCLP=xmtCellsCLP, xmtCellsDiscShelfAlarm=xmtCellsDiscShelfAlarm, xmtCellsEnd2EndLpBk=xmtCellsEnd2EndLpBk, xmtCellsFERF=xmtCellsFERF, xmtCellsSegmentLpBk=xmtCellsSegmentLpBk)
