...
# ASN.1 source SIAE-ALARM-MIB
# Source digest sha256:9e119258f72aad311b2b8bb7cdae315182fc0a5d24c24cb29eee89fb9760149e
...
if mibBuilder.loadTexts: smalarm.setLastUpdated('2016-10-04 00:00')
...
alarmLogTable = MibTable((1, 3, 6, 1, 4, 1, 3373, 1103, 4, 3), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: alarmLogTable.setStatus('current')
alarmLogRecord = MibTableRow((1, 3, 6, 1, 4, 1, 3373, 1103, 4, 3, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "SIAE-ALARM-MIB", "alarmLogRecordId"))
...
alarmActiveTable = MibTable((1, 3, 6, 1, 4, 1, 3373, 1103, 4, 17), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: alarmActiveTable.setStatus('current')
alarmActiveRecord = MibTableRow((1, 3, 6, 1, 4, 1, 3373, 1103, 4, 17, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "SIAE-ALARM-MIB", "alarmActiveObjectId"))
...
alarmItemTable = MibTable((1, 3, 6, 1, 4, 1, 3373, 1103, 4, 32), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: alarmItemTable.setStatus('current')
alarmRecord = MibTableRow((1, 3, 6, 1, 4, 1, 3373, 1103, 4, 32, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "SIAE-ALARM-MIB", "alarmOid"))
...
mibBuilder.exportSymbols("SIAE-ALARM-MIB", AlarmSeverityCode=AlarmSeverityCode, AlarmStatus=AlarmStatus, PYSNMP_MODULE_ID=smalarm, alarmActiveDescription=alarmActiveDescription, alarmActiveEventTime=alarmActiveEventTime, alarmActiveFloodingStatus=alarmActiveFloodingStatus, alarmActiveObjectId=alarmActiveObjectId, alarmActiveObjectVal=alarmActiveObjectVal, alarmActiveRecord=alarmActiveRecord, alarmActiveTable=alarmActiveTable, alarmAntiFlooding=alarmAntiFlooding, alarmAntiFloodingHighWater=alarmAntiFloodingHighWater, alarmAntiFloodingLowWater=alarmAntiFloodingLowWater, alarmAntiFloodingWindow=alarmAntiFloodingWindow, alarmDescription=alarmDescription, alarmIpSnmpAgentAddress=alarmIpSnmpAgentAddress, alarmItemTable=alarmItemTable, alarmLogActionRequest=alarmLogActionRequest, alarmLogAlarmSeverityEnable=alarmLogAlarmSeverityEnable, alarmLogAlarmSeverityFilter=alarmLogAlarmSeverityFilter, alarmLogDescription=alarmLogDescription, alarmLogEndHourEnable=alarmLogEndHourEnable, alarmLogEndTimeFilter=alarmLogEndTimeFilter, alarmLogEventTime=alarmLogEventTime, alarmLogFTPStatus=alarmLogFTPStatus, alarmLogFTPStatusTrap=alarmLogFTPStatusTrap, alarmLogFTPStatusTrapNotification=alarmLogFTPStatusTrapNotification, alarmLogFTPfile=alarmLogFTPfile, alarmLogLastEventTime=alarmLogLastEventTime, alarmLogManagedObjectFilter=alarmLogManagedObjectFilter, alarmLogObjectId=alarmLogObjectId, alarmLogObjectSev=alarmLogObjectSev, alarmLogObjectVal=alarmLogObjectVal, alarmLogRecord=alarmLogRecord, alarmLogRecordId=alarmLogRecordId, alarmLogStartHourEnable=alarmLogStartHourEnable, alarmLogStartTimeFilter=alarmLogStartTimeFilter, alarmLogTable=alarmLogTable, alarmMibVersion=alarmMibVersion, alarmObjectId=alarmObjectId, alarmObjectVal=alarmObjectVal, alarmOid=alarmOid, alarmRecord=alarmRecord, alarmSyntesysCritical=alarmSyntesysCritical, alarmSyntesysCriticalSeverityCode=alarmSyntesysCriticalSeverityCode, alarmSyntesysMajor=alarmSyntesysMajor, alarmSyntesysMajorSeverityCode=alarmSyntesysMajorSeverityCode, alarmSyntesysMinor=alarmSyntesysMinor, alarmSyntesysMinorSeverityCode=alarmSyntesysMinorSeverityCode, alarmSyntesysStatus=alarmSyntesysStatus, alarmSyntesysStatusSeverityCode=alarmSyntesysStatusSeverityCode, alarmSyntesysWarning=alarmSyntesysWarning, alarmSyntesysWarningSeverityCode=alarmSyntesysWarningSeverityCode, alarmTrap=alarmTrap, alarmTrapDescription=alarmTrapDescription, alarmTrapNumber=alarmTrapNumber, alarmTrapObject=alarmTrapObject, siaeNotificationEntry=siaeNotificationEntry, smalarm=smalarm)
