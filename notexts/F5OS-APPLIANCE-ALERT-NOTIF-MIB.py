...
alertSeverity, alertTimeStamp, alertEffect, f5Alerts, alertSource, alertDescription, f5AlertNotificationGroup = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSeverity", "alertTimeStamp", "alertEffect", "f5Alerts", "alertSource", "alertDescription", "f5AlertNotificationGroup")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", firmware_fault=firmware_fault, txPwrLoAlarm=txPwrLoAlarm, txPwrHiAlarm=txPwrHiAlarm, txBiasLoWarn=txBiasLoWarn, ddmVccLoAlarm=ddmVccLoAlarm, f5AlertNotification=f5AlertNotification, rxPwrLoWarn=rxPwrLoWarn, thermal_fault=thermal_fault, core_dump=core_dump, drive_capacity_fault=drive_capacity_fault, ddmTempHiAlarm=ddmTempHiAlarm, service_health=service_health, raidEvent=raidEvent, drive_fault=drive_fault, firmware_update_status=firmware_update_status, rxPwrLoAlarm=rxPwrLoAlarm, rxPwrHiWarn=rxPwrHiWarn, txBiasHiWarn=txBiasHiWarn, txBiasLoAlarm=txBiasLoAlarm, drive_utilization=drive_utilization, module_communication_error=module_communication_error, txBiasHiAlarm=txBiasHiAlarm, module_present=module_present, hardware_device_fault=hardware_device_fault, blade_hardware_fault=blade_hardware_fault, psu_fault=psu_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, rxPwrHiAlarm=rxPwrHiAlarm, drive_thermal_throttle=drive_thermal_throttle, power_fault=power_fault, ddmVccHiWarn=ddmVccHiWarn, fipsError=fipsError, aom_fault=aom_fault, ddmVccLoWarn=ddmVccLoWarn, txPwrLoWarn=txPwrLoWarn, ddmTempHiWarn=ddmTempHiWarn, backplane=backplane, ddmTempLoAlarm=ddmTempLoAlarm, unknown_alarm=unknown_alarm, txPwrHiWarn=txPwrHiWarn, ddmVccHiAlarm=ddmVccHiAlarm, memory_fault=memory_fault, pcie_fault=pcie_fault, cpu_fault=cpu_fault, PYSNMP_MODULE_ID=f5AlertNotification, ddmTempLoWarn=ddmTempLoWarn, blade_thermal_fault=blade_thermal_fault, lcd_fault=lcd_fault)
