...
alertSource, alertTimeStamp, alertSeverity, f5AlertNotificationGroup, alertEffect, alertDescription, f5Alerts = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSource", "alertTimeStamp", "alertSeverity", "f5AlertNotificationGroup", "alertEffect", "alertDescription", "f5Alerts")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txPwrLoWarn=txPwrLoWarn, blade_thermal_fault=blade_thermal_fault, txPwrLoAlarm=txPwrLoAlarm, blade_hardware_fault=blade_hardware_fault, rxPwrLoAlarm=rxPwrLoAlarm, lcd_fault=lcd_fault, aom_fault=aom_fault, drive_utilization=drive_utilization, unknown_alarm=unknown_alarm, txPwrHiAlarm=txPwrHiAlarm, ddmVccHiAlarm=ddmVccHiAlarm, module_communication_error=module_communication_error, ddmVccLoAlarm=ddmVccLoAlarm, thermal_fault=thermal_fault, firmware_update_status=firmware_update_status, drive_thermal_throttle=drive_thermal_throttle, psu_fault=psu_fault, ddmTempLoAlarm=ddmTempLoAlarm, ddmTempLoWarn=ddmTempLoWarn, service_health=service_health, power_fault=power_fault, ddmTempHiWarn=ddmTempHiWarn, drive_capacity_fault=drive_capacity_fault, backplane=backplane, f5AlertsNotifyGroup=f5AlertsNotifyGroup, f5AlertNotification=f5AlertNotification, module_present=module_present, ddmVccHiWarn=ddmVccHiWarn, memory_fault=memory_fault, fipsError=fipsError, txPwrHiWarn=txPwrHiWarn, rxPwrLoWarn=rxPwrLoWarn, txBiasLoWarn=txBiasLoWarn, hardware_device_fault=hardware_device_fault, cpu_fault=cpu_fault, PYSNMP_MODULE_ID=f5AlertNotification, rxPwrHiAlarm=rxPwrHiAlarm, txBiasLoAlarm=txBiasLoAlarm, txBiasHiWarn=txBiasHiWarn, core_dump=core_dump, drive_fault=drive_fault, ddmVccLoWarn=ddmVccLoWarn, txBiasHiAlarm=txBiasHiAlarm, pcie_fault=pcie_fault, raidEvent=raidEvent, rxPwrHiWarn=rxPwrHiWarn, firmware_fault=firmware_fault, ddmTempHiAlarm=ddmTempHiAlarm)
