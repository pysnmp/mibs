...
alertSource, alertDescription, f5Alerts, alertTimeStamp, alertEffect, alertSeverity, f5AlertNotificationGroup = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSource", "alertDescription", "f5Alerts", "alertTimeStamp", "alertEffect", "alertSeverity", "f5AlertNotificationGroup")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", rxPwrHiWarn=rxPwrHiWarn, lcd_fault=lcd_fault, ddmVccHiAlarm=ddmVccHiAlarm, hardware_device_fault=hardware_device_fault, rxPwrLoWarn=rxPwrLoWarn, txBiasHiWarn=txBiasHiWarn, fipsError=fipsError, ddmTempLoAlarm=ddmTempLoAlarm, drive_fault=drive_fault, ddmTempLoWarn=ddmTempLoWarn, aom_fault=aom_fault, blade_hardware_fault=blade_hardware_fault, thermal_fault=thermal_fault, f5AlertNotification=f5AlertNotification, f5AlertsNotifyGroup=f5AlertsNotifyGroup, txPwrHiAlarm=txPwrHiAlarm, core_dump=core_dump, raidEvent=raidEvent, rxPwrHiAlarm=rxPwrHiAlarm, rxPwrLoAlarm=rxPwrLoAlarm, ddmTempHiWarn=ddmTempHiWarn, drive_utilization=drive_utilization, blade_thermal_fault=blade_thermal_fault, txPwrHiWarn=txPwrHiWarn, service_health=service_health, ddmVccHiWarn=ddmVccHiWarn, module_communication_error=module_communication_error, firmware_fault=firmware_fault, unknown_alarm=unknown_alarm, txBiasLoWarn=txBiasLoWarn, cpu_fault=cpu_fault, txPwrLoWarn=txPwrLoWarn, ddmVccLoAlarm=ddmVccLoAlarm, pcie_fault=pcie_fault, module_present=module_present, psu_fault=psu_fault, drive_capacity_fault=drive_capacity_fault, txPwrLoAlarm=txPwrLoAlarm, ddmVccLoWarn=ddmVccLoWarn, power_fault=power_fault, txBiasLoAlarm=txBiasLoAlarm, backplane=backplane, memory_fault=memory_fault, drive_thermal_throttle=drive_thermal_throttle, firmware_update_status=firmware_update_status, PYSNMP_MODULE_ID=f5AlertNotification, ddmTempHiAlarm=ddmTempHiAlarm, txBiasHiAlarm=txBiasHiAlarm)
