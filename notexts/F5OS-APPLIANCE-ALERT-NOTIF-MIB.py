...
f5AlertNotificationGroup, alertSeverity, alertDescription, alertEffect, alertSource, f5Alerts, alertTimeStamp = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5AlertNotificationGroup", "alertSeverity", "alertDescription", "alertEffect", "alertSource", "f5Alerts", "alertTimeStamp")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", ddmTempLoAlarm=ddmTempLoAlarm, lcd_fault=lcd_fault, drive_fault=drive_fault, txPwrLoAlarm=txPwrLoAlarm, ddmTempLoWarn=ddmTempLoWarn, firmware_fault=firmware_fault, pcie_fault=pcie_fault, rxPwrHiAlarm=rxPwrHiAlarm, ddmTempHiAlarm=ddmTempHiAlarm, firmware_update_status=firmware_update_status, core_dump=core_dump, txPwrLoWarn=txPwrLoWarn, raidEvent=raidEvent, hardware_device_fault=hardware_device_fault, module_communication_error=module_communication_error, ddmVccLoWarn=ddmVccLoWarn, thermal_fault=thermal_fault, rxPwrLoAlarm=rxPwrLoAlarm, power_fault=power_fault, backplane=backplane, txPwrHiWarn=txPwrHiWarn, blade_thermal_fault=blade_thermal_fault, drive_utilization=drive_utilization, rxPwrHiWarn=rxPwrHiWarn, txBiasHiWarn=txBiasHiWarn, memory_fault=memory_fault, txBiasLoAlarm=txBiasLoAlarm, cpu_fault=cpu_fault, blade_hardware_fault=blade_hardware_fault, psu_fault=psu_fault, ddmVccHiAlarm=ddmVccHiAlarm, ddmVccHiWarn=ddmVccHiWarn, fipsError=fipsError, unknown_alarm=unknown_alarm, module_present=module_present, ddmVccLoAlarm=ddmVccLoAlarm, drive_thermal_throttle=drive_thermal_throttle, txBiasLoWarn=txBiasLoWarn, rxPwrLoWarn=rxPwrLoWarn, aom_fault=aom_fault, service_health=service_health, txBiasHiAlarm=txBiasHiAlarm, PYSNMP_MODULE_ID=f5AlertNotification, txPwrHiAlarm=txPwrHiAlarm, f5AlertNotification=f5AlertNotification, f5AlertsNotifyGroup=f5AlertsNotifyGroup, drive_capacity_fault=drive_capacity_fault, ddmTempHiWarn=ddmTempHiWarn)
