...
alertEffect, alertSource, alertDescription, f5Alerts, alertSeverity, alertTimeStamp, f5AlertNotificationGroup = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertEffect", "alertSource", "alertDescription", "f5Alerts", "alertSeverity", "alertTimeStamp", "f5AlertNotificationGroup")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", cpu_fault=cpu_fault, power_fault=power_fault, ddmVccHiWarn=ddmVccHiWarn, ddmVccLoAlarm=ddmVccLoAlarm, memory_fault=memory_fault, firmware_update_status=firmware_update_status, rxPwrHiWarn=rxPwrHiWarn, ddmTempLoWarn=ddmTempLoWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, aom_fault=aom_fault, ddmTempHiAlarm=ddmTempHiAlarm, rxPwrLoWarn=rxPwrLoWarn, ddmVccHiAlarm=ddmVccHiAlarm, txBiasHiAlarm=txBiasHiAlarm, blade_hardware_fault=blade_hardware_fault, hardware_device_fault=hardware_device_fault, module_communication_error=module_communication_error, txPwrHiWarn=txPwrHiWarn, service_health=service_health, ddmTempHiWarn=ddmTempHiWarn, txPwrLoWarn=txPwrLoWarn, f5AlertNotification=f5AlertNotification, lcd_fault=lcd_fault, backplane=backplane, unknown_alarm=unknown_alarm, txPwrLoAlarm=txPwrLoAlarm, module_present=module_present, core_dump=core_dump, drive_fault=drive_fault, txBiasHiWarn=txBiasHiWarn, txPwrHiAlarm=txPwrHiAlarm, PYSNMP_MODULE_ID=f5AlertNotification, firmware_fault=firmware_fault, drive_utilization=drive_utilization, drive_capacity_fault=drive_capacity_fault, thermal_fault=thermal_fault, rxPwrLoAlarm=rxPwrLoAlarm, fipsError=fipsError, ddmVccLoWarn=ddmVccLoWarn, raidEvent=raidEvent, txBiasLoWarn=txBiasLoWarn, ddmTempLoAlarm=ddmTempLoAlarm, txBiasLoAlarm=txBiasLoAlarm, psu_fault=psu_fault, blade_thermal_fault=blade_thermal_fault, pcie_fault=pcie_fault, drive_thermal_throttle=drive_thermal_throttle, rxPwrHiAlarm=rxPwrHiAlarm)
