...
alertSeverity, alertDescription, alertTimeStamp, f5Alerts, f5AlertNotificationGroup, alertEffect, alertSource = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSeverity", "alertDescription", "alertTimeStamp", "f5Alerts", "f5AlertNotificationGroup", "alertEffect", "alertSource")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", drive_capacity_fault=drive_capacity_fault, fipsError=fipsError, lcd_fault=lcd_fault, ddmTempHiWarn=ddmTempHiWarn, ddmTempLoAlarm=ddmTempLoAlarm, firmware_fault=firmware_fault, backplane=backplane, hardware_device_fault=hardware_device_fault, ddmTempHiAlarm=ddmTempHiAlarm, drive_fault=drive_fault, rxPwrLoAlarm=rxPwrLoAlarm, rxPwrHiWarn=rxPwrHiWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, drive_utilization=drive_utilization, ddmVccLoAlarm=ddmVccLoAlarm, psu_fault=psu_fault, drive_thermal_throttle=drive_thermal_throttle, txBiasLoAlarm=txBiasLoAlarm, ddmTempLoWarn=ddmTempLoWarn, blade_thermal_fault=blade_thermal_fault, aom_fault=aom_fault, cpu_fault=cpu_fault, txPwrHiWarn=txPwrHiWarn, txBiasHiAlarm=txBiasHiAlarm, PYSNMP_MODULE_ID=f5AlertNotification, txPwrLoWarn=txPwrLoWarn, txPwrHiAlarm=txPwrHiAlarm, module_present=module_present, raidEvent=raidEvent, txBiasHiWarn=txBiasHiWarn, ddmVccLoWarn=ddmVccLoWarn, core_dump=core_dump, txBiasLoWarn=txBiasLoWarn, rxPwrHiAlarm=rxPwrHiAlarm, unknown_alarm=unknown_alarm, thermal_fault=thermal_fault, service_health=service_health, module_communication_error=module_communication_error, txPwrLoAlarm=txPwrLoAlarm, blade_hardware_fault=blade_hardware_fault, f5AlertNotification=f5AlertNotification, ddmVccHiWarn=ddmVccHiWarn, rxPwrLoWarn=rxPwrLoWarn, firmware_update_status=firmware_update_status, pcie_fault=pcie_fault, memory_fault=memory_fault, ddmVccHiAlarm=ddmVccHiAlarm, power_fault=power_fault)
