...
f5AlertNotificationGroup, alertSeverity, alertDescription, alertEffect, f5Alerts, alertSource, alertTimeStamp = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5AlertNotificationGroup", "alertSeverity", "alertDescription", "alertEffect", "f5Alerts", "alertSource", "alertTimeStamp")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", pcie_fault=pcie_fault, ddmTempLoWarn=ddmTempLoWarn, firmware_fault=firmware_fault, thermal_fault=thermal_fault, txBiasHiWarn=txBiasHiWarn, ddmTempLoAlarm=ddmTempLoAlarm, PYSNMP_MODULE_ID=f5AlertNotification, firmware_update_status=firmware_update_status, txPwrHiWarn=txPwrHiWarn, txBiasHiAlarm=txBiasHiAlarm, ddmVccHiAlarm=ddmVccHiAlarm, ddmVccLoWarn=ddmVccLoWarn, module_present=module_present, module_communication_error=module_communication_error, txBiasLoAlarm=txBiasLoAlarm, lcd_fault=lcd_fault, ddmTempHiWarn=ddmTempHiWarn, hardware_device_fault=hardware_device_fault, rxPwrHiAlarm=rxPwrHiAlarm, memory_fault=memory_fault, fipsError=fipsError, power_fault=power_fault, psu_fault=psu_fault, rxPwrHiWarn=rxPwrHiWarn, cpu_fault=cpu_fault, f5AlertNotification=f5AlertNotification, raidEvent=raidEvent, blade_thermal_fault=blade_thermal_fault, core_dump=core_dump, drive_capacity_fault=drive_capacity_fault, drive_thermal_throttle=drive_thermal_throttle, txPwrLoWarn=txPwrLoWarn, rxPwrLoAlarm=rxPwrLoAlarm, ddmVccHiWarn=ddmVccHiWarn, txPwrLoAlarm=txPwrLoAlarm, aom_fault=aom_fault, txPwrHiAlarm=txPwrHiAlarm, unknown_alarm=unknown_alarm, txBiasLoWarn=txBiasLoWarn, blade_hardware_fault=blade_hardware_fault, drive_fault=drive_fault, ddmTempHiAlarm=ddmTempHiAlarm, ddmVccLoAlarm=ddmVccLoAlarm, drive_utilization=drive_utilization, rxPwrLoWarn=rxPwrLoWarn, backplane=backplane, f5AlertsNotifyGroup=f5AlertsNotifyGroup, service_health=service_health)
