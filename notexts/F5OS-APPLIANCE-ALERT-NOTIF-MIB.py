...
alertEffect, f5Alerts, f5AlertNotificationGroup, alertTimeStamp, alertSeverity, alertSource, alertDescription = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertEffect", "f5Alerts", "f5AlertNotificationGroup", "alertTimeStamp", "alertSeverity", "alertSource", "alertDescription")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", ddmTempLoWarn=ddmTempLoWarn, thermal_fault=thermal_fault, firmware_update_status=firmware_update_status, drive_fault=drive_fault, raidEvent=raidEvent, blade_thermal_fault=blade_thermal_fault, ddmVccHiAlarm=ddmVccHiAlarm, hardware_device_fault=hardware_device_fault, ddmVccLoWarn=ddmVccLoWarn, ddmVccHiWarn=ddmVccHiWarn, PYSNMP_MODULE_ID=f5AlertNotification, rxPwrLoWarn=rxPwrLoWarn, memory_fault=memory_fault, txBiasLoAlarm=txBiasLoAlarm, drive_capacity_fault=drive_capacity_fault, txPwrHiAlarm=txPwrHiAlarm, firmware_fault=firmware_fault, aom_fault=aom_fault, ddmVccLoAlarm=ddmVccLoAlarm, cpu_fault=cpu_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, txBiasHiAlarm=txBiasHiAlarm, power_fault=power_fault, txPwrLoAlarm=txPwrLoAlarm, drive_thermal_throttle=drive_thermal_throttle, ddmTempHiAlarm=ddmTempHiAlarm, ddmTempHiWarn=ddmTempHiWarn, service_health=service_health, unknown_alarm=unknown_alarm, fipsError=fipsError, rxPwrHiWarn=rxPwrHiWarn, backplane=backplane, txBiasLoWarn=txBiasLoWarn, blade_hardware_fault=blade_hardware_fault, txPwrLoWarn=txPwrLoWarn, lcd_fault=lcd_fault, module_communication_error=module_communication_error, psu_fault=psu_fault, txPwrHiWarn=txPwrHiWarn, f5AlertNotification=f5AlertNotification, drive_utilization=drive_utilization, txBiasHiWarn=txBiasHiWarn, pcie_fault=pcie_fault, ddmTempLoAlarm=ddmTempLoAlarm, module_present=module_present, rxPwrHiAlarm=rxPwrHiAlarm, rxPwrLoAlarm=rxPwrLoAlarm, core_dump=core_dump)
