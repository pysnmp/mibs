...
alertDescription, alertEffect, alertSeverity, f5Alerts, f5AlertNotificationGroup, alertTimeStamp, alertSource = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertDescription", "alertEffect", "alertSeverity", "f5Alerts", "f5AlertNotificationGroup", "alertTimeStamp", "alertSource")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", ddmVccLoAlarm=ddmVccLoAlarm, f5AlertNotification=f5AlertNotification, memory_fault=memory_fault, txBiasHiAlarm=txBiasHiAlarm, txPwrLoAlarm=txPwrLoAlarm, ddmVccHiWarn=ddmVccHiWarn, core_dump=core_dump, ddmTempHiAlarm=ddmTempHiAlarm, rxPwrLoAlarm=rxPwrLoAlarm, service_health=service_health, txPwrHiWarn=txPwrHiWarn, firmware_fault=firmware_fault, power_fault=power_fault, drive_capacity_fault=drive_capacity_fault, txBiasLoAlarm=txBiasLoAlarm, drive_thermal_throttle=drive_thermal_throttle, backplane=backplane, ddmTempHiWarn=ddmTempHiWarn, drive_utilization=drive_utilization, thermal_fault=thermal_fault, unknown_alarm=unknown_alarm, txPwrHiAlarm=txPwrHiAlarm, ddmVccHiAlarm=ddmVccHiAlarm, f5AlertsNotifyGroup=f5AlertsNotifyGroup, ddmVccLoWarn=ddmVccLoWarn, rxPwrHiWarn=rxPwrHiWarn, drive_fault=drive_fault, module_present=module_present, hardware_device_fault=hardware_device_fault, pcie_fault=pcie_fault, PYSNMP_MODULE_ID=f5AlertNotification, aom_fault=aom_fault, rxPwrHiAlarm=rxPwrHiAlarm, firmware_update_status=firmware_update_status, psu_fault=psu_fault, lcd_fault=lcd_fault, txBiasHiWarn=txBiasHiWarn, txPwrLoWarn=txPwrLoWarn, txBiasLoWarn=txBiasLoWarn, cpu_fault=cpu_fault, fipsError=fipsError, ddmTempLoWarn=ddmTempLoWarn, ddmTempLoAlarm=ddmTempLoAlarm, blade_thermal_fault=blade_thermal_fault, module_communication_error=module_communication_error, raidEvent=raidEvent, rxPwrLoWarn=rxPwrLoWarn, blade_hardware_fault=blade_hardware_fault)
