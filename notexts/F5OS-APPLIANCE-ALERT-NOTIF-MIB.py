...
alertTimeStamp, f5AlertNotificationGroup, f5Alerts, alertDescription, alertSource, alertEffect, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertTimeStamp", "f5AlertNotificationGroup", "f5Alerts", "alertDescription", "alertSource", "alertEffect", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", power_fault=power_fault, firmware_fault=firmware_fault, ddmTempHiWarn=ddmTempHiWarn, ddmTempLoWarn=ddmTempLoWarn, rxPwrHiAlarm=rxPwrHiAlarm, rxPwrHiWarn=rxPwrHiWarn, rxPwrLoWarn=rxPwrLoWarn, pcie_fault=pcie_fault, PYSNMP_MODULE_ID=f5AlertNotification, blade_thermal_fault=blade_thermal_fault, drive_fault=drive_fault, service_health=service_health, txPwrLoAlarm=txPwrLoAlarm, raidEvent=raidEvent, blade_hardware_fault=blade_hardware_fault, lcd_fault=lcd_fault, txBiasLoWarn=txBiasLoWarn, aom_fault=aom_fault, fipsError=fipsError, memory_fault=memory_fault, thermal_fault=thermal_fault, rxPwrLoAlarm=rxPwrLoAlarm, ddmVccLoWarn=ddmVccLoWarn, ddmTempLoAlarm=ddmTempLoAlarm, ddmVccHiAlarm=ddmVccHiAlarm, txPwrHiWarn=txPwrHiWarn, drive_thermal_throttle=drive_thermal_throttle, ddmTempHiAlarm=ddmTempHiAlarm, drive_utilization=drive_utilization, unknown_alarm=unknown_alarm, firmware_update_status=firmware_update_status, backplane=backplane, drive_capacity_fault=drive_capacity_fault, txBiasHiWarn=txBiasHiWarn, txPwrHiAlarm=txPwrHiAlarm, core_dump=core_dump, f5AlertNotification=f5AlertNotification, txPwrLoWarn=txPwrLoWarn, psu_fault=psu_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, ddmVccHiWarn=ddmVccHiWarn, txBiasHiAlarm=txBiasHiAlarm, txBiasLoAlarm=txBiasLoAlarm, cpu_fault=cpu_fault, hardware_device_fault=hardware_device_fault, ddmVccLoAlarm=ddmVccLoAlarm, module_present=module_present, module_communication_error=module_communication_error)
