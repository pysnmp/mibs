...
alertTimeStamp, alertSource, f5AlertNotificationGroup, alertSeverity, f5Alerts, alertEffect, alertDescription = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertTimeStamp", "alertSource", "f5AlertNotificationGroup", "alertSeverity", "f5Alerts", "alertEffect", "alertDescription")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", module_present=module_present, ddmVccHiAlarm=ddmVccHiAlarm, ddmTempLoWarn=ddmTempLoWarn, power_fault=power_fault, blade_hardware_fault=blade_hardware_fault, ddmTempHiWarn=ddmTempHiWarn, module_communication_error=module_communication_error, f5AlertsNotifyGroup=f5AlertsNotifyGroup, lcd_fault=lcd_fault, txBiasLoWarn=txBiasLoWarn, ddmVccLoWarn=ddmVccLoWarn, rxPwrLoWarn=rxPwrLoWarn, rxPwrHiAlarm=rxPwrHiAlarm, drive_utilization=drive_utilization, ddmTempLoAlarm=ddmTempLoAlarm, core_dump=core_dump, ddmVccHiWarn=ddmVccHiWarn, hardware_device_fault=hardware_device_fault, txPwrLoWarn=txPwrLoWarn, drive_thermal_throttle=drive_thermal_throttle, thermal_fault=thermal_fault, txBiasHiWarn=txBiasHiWarn, backplane=backplane, txPwrHiAlarm=txPwrHiAlarm, fipsError=fipsError, txBiasLoAlarm=txBiasLoAlarm, drive_capacity_fault=drive_capacity_fault, blade_thermal_fault=blade_thermal_fault, firmware_update_status=firmware_update_status, drive_fault=drive_fault, txPwrLoAlarm=txPwrLoAlarm, unknown_alarm=unknown_alarm, rxPwrLoAlarm=rxPwrLoAlarm, txBiasHiAlarm=txBiasHiAlarm, firmware_fault=firmware_fault, cpu_fault=cpu_fault, ddmVccLoAlarm=ddmVccLoAlarm, PYSNMP_MODULE_ID=f5AlertNotification, raidEvent=raidEvent, service_health=service_health, rxPwrHiWarn=rxPwrHiWarn, psu_fault=psu_fault, txPwrHiWarn=txPwrHiWarn, aom_fault=aom_fault, memory_fault=memory_fault, f5AlertNotification=f5AlertNotification, pcie_fault=pcie_fault, ddmTempHiAlarm=ddmTempHiAlarm)
