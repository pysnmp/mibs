...
f5AlertNotificationGroup, alertSeverity, alertDescription, alertSource, alertEffect, f5Alerts, alertTimeStamp = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5AlertNotificationGroup", "alertSeverity", "alertDescription", "alertSource", "alertEffect", "f5Alerts", "alertTimeStamp")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", rxPwrHiWarn=rxPwrHiWarn, unknown_alarm=unknown_alarm, raidEvent=raidEvent, drive_capacity_fault=drive_capacity_fault, ddmVccLoAlarm=ddmVccLoAlarm, drive_fault=drive_fault, txPwrLoAlarm=txPwrLoAlarm, txBiasHiAlarm=txBiasHiAlarm, rxPwrLoWarn=rxPwrLoWarn, ddmTempHiAlarm=ddmTempHiAlarm, memory_fault=memory_fault, txPwrLoWarn=txPwrLoWarn, aom_fault=aom_fault, pcie_fault=pcie_fault, txPwrHiWarn=txPwrHiWarn, txBiasHiWarn=txBiasHiWarn, ddmVccHiAlarm=ddmVccHiAlarm, drive_utilization=drive_utilization, cpu_fault=cpu_fault, psu_fault=psu_fault, hardware_device_fault=hardware_device_fault, fipsError=fipsError, f5AlertsNotifyGroup=f5AlertsNotifyGroup, backplane=backplane, f5AlertNotification=f5AlertNotification, firmware_fault=firmware_fault, blade_hardware_fault=blade_hardware_fault, rxPwrLoAlarm=rxPwrLoAlarm, firmware_update_status=firmware_update_status, ddmTempLoWarn=ddmTempLoWarn, power_fault=power_fault, txBiasLoAlarm=txBiasLoAlarm, ddmVccHiWarn=ddmVccHiWarn, module_present=module_present, drive_thermal_throttle=drive_thermal_throttle, PYSNMP_MODULE_ID=f5AlertNotification, txBiasLoWarn=txBiasLoWarn, ddmTempLoAlarm=ddmTempLoAlarm, txPwrHiAlarm=txPwrHiAlarm, blade_thermal_fault=blade_thermal_fault, ddmTempHiWarn=ddmTempHiWarn, service_health=service_health, lcd_fault=lcd_fault, module_communication_error=module_communication_error, ddmVccLoWarn=ddmVccLoWarn, rxPwrHiAlarm=rxPwrHiAlarm, core_dump=core_dump, thermal_fault=thermal_fault)
