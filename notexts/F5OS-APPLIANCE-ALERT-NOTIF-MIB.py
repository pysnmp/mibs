...
alertEffect, alertSeverity, alertDescription, alertSource, alertTimeStamp, f5Alerts, f5AlertNotificationGroup = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertEffect", "alertSeverity", "alertDescription", "alertSource", "alertTimeStamp", "f5Alerts", "f5AlertNotificationGroup")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", service_health=service_health, ddmTempLoWarn=ddmTempLoWarn, ddmVccHiWarn=ddmVccHiWarn, power_fault=power_fault, blade_hardware_fault=blade_hardware_fault, hardware_device_fault=hardware_device_fault, PYSNMP_MODULE_ID=f5AlertNotification, aom_fault=aom_fault, rxPwrHiAlarm=rxPwrHiAlarm, module_present=module_present, ddmVccLoAlarm=ddmVccLoAlarm, drive_capacity_fault=drive_capacity_fault, unknown_alarm=unknown_alarm, drive_utilization=drive_utilization, thermal_fault=thermal_fault, txBiasHiWarn=txBiasHiWarn, firmware_update_status=firmware_update_status, rxPwrLoAlarm=rxPwrLoAlarm, pcie_fault=pcie_fault, memory_fault=memory_fault, drive_fault=drive_fault, ddmVccLoWarn=ddmVccLoWarn, txBiasHiAlarm=txBiasHiAlarm, psu_fault=psu_fault, txPwrHiWarn=txPwrHiWarn, txBiasLoWarn=txBiasLoWarn, txBiasLoAlarm=txBiasLoAlarm, fipsError=fipsError, cpu_fault=cpu_fault, firmware_fault=firmware_fault, ddmTempHiWarn=ddmTempHiWarn, rxPwrHiWarn=rxPwrHiWarn, raidEvent=raidEvent, drive_thermal_throttle=drive_thermal_throttle, lcd_fault=lcd_fault, f5AlertNotification=f5AlertNotification, core_dump=core_dump, txPwrHiAlarm=txPwrHiAlarm, module_communication_error=module_communication_error, f5AlertsNotifyGroup=f5AlertsNotifyGroup, txPwrLoAlarm=txPwrLoAlarm, txPwrLoWarn=txPwrLoWarn, rxPwrLoWarn=rxPwrLoWarn, ddmTempHiAlarm=ddmTempHiAlarm, ddmTempLoAlarm=ddmTempLoAlarm, ddmVccHiAlarm=ddmVccHiAlarm, backplane=backplane, blade_thermal_fault=blade_thermal_fault)
