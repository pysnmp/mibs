...
alertTimeStamp, alertEffect, alertDescription, f5Alerts, f5AlertNotificationGroup, alertSeverity, alertSource = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertTimeStamp", "alertEffect", "alertDescription", "f5Alerts", "f5AlertNotificationGroup", "alertSeverity", "alertSource")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", power_fault=power_fault, drive_utilization=drive_utilization, drive_fault=drive_fault, cpu_fault=cpu_fault, ddmVccLoWarn=ddmVccLoWarn, blade_hardware_fault=blade_hardware_fault, psu_fault=psu_fault, txPwrHiAlarm=txPwrHiAlarm, firmware_update_status=firmware_update_status, ddmVccHiAlarm=ddmVccHiAlarm, txBiasHiAlarm=txBiasHiAlarm, module_communication_error=module_communication_error, txPwrLoWarn=txPwrLoWarn, memory_fault=memory_fault, txPwrLoAlarm=txPwrLoAlarm, backplane=backplane, pcie_fault=pcie_fault, PYSNMP_MODULE_ID=f5AlertNotification, txPwrHiWarn=txPwrHiWarn, rxPwrLoWarn=rxPwrLoWarn, rxPwrLoAlarm=rxPwrLoAlarm, blade_thermal_fault=blade_thermal_fault, ddmVccLoAlarm=ddmVccLoAlarm, service_health=service_health, drive_capacity_fault=drive_capacity_fault, raidEvent=raidEvent, f5AlertsNotifyGroup=f5AlertsNotifyGroup, ddmVccHiWarn=ddmVccHiWarn, lcd_fault=lcd_fault, rxPwrHiAlarm=rxPwrHiAlarm, txBiasLoAlarm=txBiasLoAlarm, ddmTempHiWarn=ddmTempHiWarn, txBiasLoWarn=txBiasLoWarn, core_dump=core_dump, rxPwrHiWarn=rxPwrHiWarn, thermal_fault=thermal_fault, f5AlertNotification=f5AlertNotification, txBiasHiWarn=txBiasHiWarn, ddmTempHiAlarm=ddmTempHiAlarm, aom_fault=aom_fault, unknown_alarm=unknown_alarm, hardware_device_fault=hardware_device_fault, ddmTempLoWarn=ddmTempLoWarn, firmware_fault=firmware_fault, drive_thermal_throttle=drive_thermal_throttle, module_present=module_present, ddmTempLoAlarm=ddmTempLoAlarm, fipsError=fipsError)
