...
alertSeverity, f5Alerts, f5AlertNotificationGroup, alertSource, alertEffect, alertDescription, alertTimeStamp = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSeverity", "f5Alerts", "f5AlertNotificationGroup", "alertSource", "alertEffect", "alertDescription", "alertTimeStamp")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", psu_fault=psu_fault, ddmTempLoWarn=ddmTempLoWarn, txPwrLoWarn=txPwrLoWarn, rxPwrLoWarn=rxPwrLoWarn, module_present=module_present, ddmVccHiAlarm=ddmVccHiAlarm, memory_fault=memory_fault, ddmTempLoAlarm=ddmTempLoAlarm, power_fault=power_fault, firmware_update_status=firmware_update_status, txPwrLoAlarm=txPwrLoAlarm, lcd_fault=lcd_fault, rxPwrLoAlarm=rxPwrLoAlarm, txBiasHiAlarm=txBiasHiAlarm, ddmVccLoWarn=ddmVccLoWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, raidEvent=raidEvent, drive_thermal_throttle=drive_thermal_throttle, firmware_fault=firmware_fault, thermal_fault=thermal_fault, ddmVccHiWarn=ddmVccHiWarn, drive_utilization=drive_utilization, txBiasLoAlarm=txBiasLoAlarm, drive_capacity_fault=drive_capacity_fault, ddmVccLoAlarm=ddmVccLoAlarm, rxPwrHiAlarm=rxPwrHiAlarm, blade_hardware_fault=blade_hardware_fault, f5AlertNotification=f5AlertNotification, txBiasHiWarn=txBiasHiWarn, drive_fault=drive_fault, txBiasLoWarn=txBiasLoWarn, txPwrHiAlarm=txPwrHiAlarm, txPwrHiWarn=txPwrHiWarn, service_health=service_health, pcie_fault=pcie_fault, fipsError=fipsError, backplane=backplane, hardware_device_fault=hardware_device_fault, aom_fault=aom_fault, module_communication_error=module_communication_error, rxPwrHiWarn=rxPwrHiWarn, core_dump=core_dump, blade_thermal_fault=blade_thermal_fault, ddmTempHiWarn=ddmTempHiWarn, unknown_alarm=unknown_alarm, ddmTempHiAlarm=ddmTempHiAlarm, cpu_fault=cpu_fault, PYSNMP_MODULE_ID=f5AlertNotification)
