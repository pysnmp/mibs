...
alertSeverity, alertEffect, f5AlertNotificationGroup, f5Alerts, alertSource, alertDescription, alertTimeStamp = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSeverity", "alertEffect", "f5AlertNotificationGroup", "f5Alerts", "alertSource", "alertDescription", "alertTimeStamp")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", drive_capacity_fault=drive_capacity_fault, drive_utilization=drive_utilization, txPwrLoAlarm=txPwrLoAlarm, drive_fault=drive_fault, ddmVccLoAlarm=ddmVccLoAlarm, module_communication_error=module_communication_error, ddmVccHiAlarm=ddmVccHiAlarm, blade_hardware_fault=blade_hardware_fault, ddmTempHiWarn=ddmTempHiWarn, memory_fault=memory_fault, rxPwrLoAlarm=rxPwrLoAlarm, txBiasLoWarn=txBiasLoWarn, ddmTempHiAlarm=ddmTempHiAlarm, ddmVccLoWarn=ddmVccLoWarn, cpu_fault=cpu_fault, power_fault=power_fault, unknown_alarm=unknown_alarm, thermal_fault=thermal_fault, firmware_fault=firmware_fault, ddmTempLoWarn=ddmTempLoWarn, module_present=module_present, f5AlertNotification=f5AlertNotification, txBiasHiAlarm=txBiasHiAlarm, txPwrHiWarn=txPwrHiWarn, blade_thermal_fault=blade_thermal_fault, txPwrLoWarn=txPwrLoWarn, txBiasHiWarn=txBiasHiWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, raidEvent=raidEvent, txBiasLoAlarm=txBiasLoAlarm, lcd_fault=lcd_fault, ddmTempLoAlarm=ddmTempLoAlarm, backplane=backplane, ddmVccHiWarn=ddmVccHiWarn, aom_fault=aom_fault, firmware_update_status=firmware_update_status, pcie_fault=pcie_fault, fipsError=fipsError, rxPwrHiAlarm=rxPwrHiAlarm, rxPwrLoWarn=rxPwrLoWarn, txPwrHiAlarm=txPwrHiAlarm, drive_thermal_throttle=drive_thermal_throttle, rxPwrHiWarn=rxPwrHiWarn, service_health=service_health, PYSNMP_MODULE_ID=f5AlertNotification, core_dump=core_dump, psu_fault=psu_fault, hardware_device_fault=hardware_device_fault)
