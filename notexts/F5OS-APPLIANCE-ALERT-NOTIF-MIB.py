...
alertEffect, alertTimeStamp, f5Alerts, alertSource, f5AlertNotificationGroup, alertDescription, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertEffect", "alertTimeStamp", "f5Alerts", "alertSource", "f5AlertNotificationGroup", "alertDescription", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txPwrHiWarn=txPwrHiWarn, blade_thermal_fault=blade_thermal_fault, module_communication_error=module_communication_error, firmware_update_status=firmware_update_status, f5AlertNotification=f5AlertNotification, drive_capacity_fault=drive_capacity_fault, txPwrHiAlarm=txPwrHiAlarm, rxPwrLoAlarm=rxPwrLoAlarm, txBiasHiAlarm=txBiasHiAlarm, txBiasLoAlarm=txBiasLoAlarm, raidEvent=raidEvent, ddmVccHiWarn=ddmVccHiWarn, aom_fault=aom_fault, rxPwrLoWarn=rxPwrLoWarn, core_dump=core_dump, txPwrLoAlarm=txPwrLoAlarm, txBiasHiWarn=txBiasHiWarn, ddmTempHiWarn=ddmTempHiWarn, rxPwrHiAlarm=rxPwrHiAlarm, txBiasLoWarn=txBiasLoWarn, firmware_fault=firmware_fault, drive_thermal_throttle=drive_thermal_throttle, blade_hardware_fault=blade_hardware_fault, module_present=module_present, f5AlertsNotifyGroup=f5AlertsNotifyGroup, drive_fault=drive_fault, txPwrLoWarn=txPwrLoWarn, psu_fault=psu_fault, ddmTempHiAlarm=ddmTempHiAlarm, PYSNMP_MODULE_ID=f5AlertNotification, pcie_fault=pcie_fault, thermal_fault=thermal_fault, drive_utilization=drive_utilization, lcd_fault=lcd_fault, rxPwrHiWarn=rxPwrHiWarn, memory_fault=memory_fault, unknown_alarm=unknown_alarm, cpu_fault=cpu_fault, ddmTempLoAlarm=ddmTempLoAlarm, hardware_device_fault=hardware_device_fault, fipsError=fipsError, power_fault=power_fault, service_health=service_health, ddmVccLoAlarm=ddmVccLoAlarm, ddmVccHiAlarm=ddmVccHiAlarm, backplane=backplane, ddmTempLoWarn=ddmTempLoWarn, ddmVccLoWarn=ddmVccLoWarn)
