...
alertTimeStamp, alertSeverity, alertSource, f5Alerts, f5AlertNotificationGroup, alertDescription, alertEffect = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertTimeStamp", "alertSeverity", "alertSource", "f5Alerts", "f5AlertNotificationGroup", "alertDescription", "alertEffect")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", drive_thermal_throttle=drive_thermal_throttle, firmware_update_status=firmware_update_status, ddmVccHiWarn=ddmVccHiWarn, PYSNMP_MODULE_ID=f5AlertNotification, core_dump=core_dump, drive_capacity_fault=drive_capacity_fault, drive_utilization=drive_utilization, firmware_fault=firmware_fault, rxPwrLoWarn=rxPwrLoWarn, txBiasLoWarn=txBiasLoWarn, rxPwrHiWarn=rxPwrHiWarn, ddmTempHiAlarm=ddmTempHiAlarm, power_fault=power_fault, drive_fault=drive_fault, pcie_fault=pcie_fault, lcd_fault=lcd_fault, hardware_device_fault=hardware_device_fault, ddmTempLoWarn=ddmTempLoWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, rxPwrLoAlarm=rxPwrLoAlarm, ddmVccLoWarn=ddmVccLoWarn, ddmVccHiAlarm=ddmVccHiAlarm, aom_fault=aom_fault, txPwrHiWarn=txPwrHiWarn, txPwrLoAlarm=txPwrLoAlarm, txPwrHiAlarm=txPwrHiAlarm, txPwrLoWarn=txPwrLoWarn, ddmVccLoAlarm=ddmVccLoAlarm, ddmTempLoAlarm=ddmTempLoAlarm, module_communication_error=module_communication_error, unknown_alarm=unknown_alarm, rxPwrHiAlarm=rxPwrHiAlarm, txBiasHiWarn=txBiasHiWarn, blade_thermal_fault=blade_thermal_fault, fipsError=fipsError, thermal_fault=thermal_fault, module_present=module_present, f5AlertNotification=f5AlertNotification, raidEvent=raidEvent, psu_fault=psu_fault, blade_hardware_fault=blade_hardware_fault, txBiasLoAlarm=txBiasLoAlarm, ddmTempHiWarn=ddmTempHiWarn, txBiasHiAlarm=txBiasHiAlarm, memory_fault=memory_fault, cpu_fault=cpu_fault, backplane=backplane, service_health=service_health)
