...
f5Alerts, alertSource, alertDescription, alertTimeStamp, alertEffect, f5AlertNotificationGroup, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5Alerts", "alertSource", "alertDescription", "alertTimeStamp", "alertEffect", "f5AlertNotificationGroup", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", blade_hardware_fault=blade_hardware_fault, firmware_update_status=firmware_update_status, ddmVccHiWarn=ddmVccHiWarn, PYSNMP_MODULE_ID=f5AlertNotification, ddmVccLoAlarm=ddmVccLoAlarm, drive_utilization=drive_utilization, fipsError=fipsError, rxPwrLoAlarm=rxPwrLoAlarm, backplane=backplane, txBiasHiAlarm=txBiasHiAlarm, ddmTempHiAlarm=ddmTempHiAlarm, txBiasHiWarn=txBiasHiWarn, ddmVccHiAlarm=ddmVccHiAlarm, rxPwrHiAlarm=rxPwrHiAlarm, service_health=service_health, thermal_fault=thermal_fault, ddmTempHiWarn=ddmTempHiWarn, power_fault=power_fault, ddmTempLoWarn=ddmTempLoWarn, f5AlertNotification=f5AlertNotification, txBiasLoWarn=txBiasLoWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, aom_fault=aom_fault, ddmTempLoAlarm=ddmTempLoAlarm, memory_fault=memory_fault, txPwrLoWarn=txPwrLoWarn, psu_fault=psu_fault, module_present=module_present, rxPwrHiWarn=rxPwrHiWarn, txBiasLoAlarm=txBiasLoAlarm, drive_thermal_throttle=drive_thermal_throttle, raidEvent=raidEvent, txPwrHiAlarm=txPwrHiAlarm, rxPwrLoWarn=rxPwrLoWarn, core_dump=core_dump, firmware_fault=firmware_fault, blade_thermal_fault=blade_thermal_fault, hardware_device_fault=hardware_device_fault, module_communication_error=module_communication_error, cpu_fault=cpu_fault, ddmVccLoWarn=ddmVccLoWarn, pcie_fault=pcie_fault, drive_capacity_fault=drive_capacity_fault, txPwrHiWarn=txPwrHiWarn, drive_fault=drive_fault, txPwrLoAlarm=txPwrLoAlarm, unknown_alarm=unknown_alarm, lcd_fault=lcd_fault)
