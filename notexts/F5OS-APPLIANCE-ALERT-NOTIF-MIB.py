...
alertSeverity, f5AlertNotificationGroup, alertEffect, alertDescription, alertTimeStamp, alertSource, f5Alerts = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSeverity", "f5AlertNotificationGroup", "alertEffect", "alertDescription", "alertTimeStamp", "alertSource", "f5Alerts")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", ddmTempHiAlarm=ddmTempHiAlarm, aom_fault=aom_fault, unknown_alarm=unknown_alarm, blade_thermal_fault=blade_thermal_fault, txBiasLoAlarm=txBiasLoAlarm, cpu_fault=cpu_fault, txBiasHiWarn=txBiasHiWarn, ddmVccLoWarn=ddmVccLoWarn, blade_hardware_fault=blade_hardware_fault, lcd_fault=lcd_fault, txPwrHiWarn=txPwrHiWarn, drive_utilization=drive_utilization, module_communication_error=module_communication_error, hardware_device_fault=hardware_device_fault, txPwrHiAlarm=txPwrHiAlarm, rxPwrLoAlarm=rxPwrLoAlarm, module_present=module_present, drive_capacity_fault=drive_capacity_fault, rxPwrLoWarn=rxPwrLoWarn, ddmVccLoAlarm=ddmVccLoAlarm, f5AlertNotification=f5AlertNotification, txBiasHiAlarm=txBiasHiAlarm, PYSNMP_MODULE_ID=f5AlertNotification, f5AlertsNotifyGroup=f5AlertsNotifyGroup, firmware_fault=firmware_fault, thermal_fault=thermal_fault, raidEvent=raidEvent, fipsError=fipsError, drive_thermal_throttle=drive_thermal_throttle, pcie_fault=pcie_fault, ddmTempLoWarn=ddmTempLoWarn, rxPwrHiWarn=rxPwrHiWarn, ddmVccHiWarn=ddmVccHiWarn, psu_fault=psu_fault, service_health=service_health, ddmTempLoAlarm=ddmTempLoAlarm, backplane=backplane, drive_fault=drive_fault, ddmTempHiWarn=ddmTempHiWarn, ddmVccHiAlarm=ddmVccHiAlarm, memory_fault=memory_fault, txPwrLoWarn=txPwrLoWarn, rxPwrHiAlarm=rxPwrHiAlarm, core_dump=core_dump, power_fault=power_fault, txPwrLoAlarm=txPwrLoAlarm, txBiasLoWarn=txBiasLoWarn, firmware_update_status=firmware_update_status)
