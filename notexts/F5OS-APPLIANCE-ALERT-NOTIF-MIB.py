...
iso, Counter32, ModuleIdentity, Integer32, IpAddress, ObjectIdentity, Bits, Gauge32, NotificationType, Counter64, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "ModuleIdentity", "Integer32", "IpAddress", "ObjectIdentity", "Bits", "Gauge32", "NotificationType", "Counter64", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", cpu_fault=cpu_fault, drive_capacity_fault=drive_capacity_fault, blade_hardware_fault=blade_hardware_fault, ddmTempLoWarn=ddmTempLoWarn, fipsError=fipsError, ddmVccLoAlarm=ddmVccLoAlarm, power_fault=power_fault, txPwrHiWarn=txPwrHiWarn, txPwrLoWarn=txPwrLoWarn, txBiasHiWarn=txBiasHiWarn, hardware_device_fault=hardware_device_fault, drive_thermal_throttle=drive_thermal_throttle, PYSNMP_MODULE_ID=f5AlertNotification, lcd_fault=lcd_fault, txPwrLoAlarm=txPwrLoAlarm, rxPwrHiWarn=rxPwrHiWarn, txBiasLoWarn=txBiasLoWarn, core_dump=core_dump, ddmTempHiAlarm=ddmTempHiAlarm, txBiasHiAlarm=txBiasHiAlarm, firmware_fault=firmware_fault, ddmVccHiAlarm=ddmVccHiAlarm, service_health=service_health, unknown_alarm=unknown_alarm, ddmVccHiWarn=ddmVccHiWarn, ddmTempHiWarn=ddmTempHiWarn, rxPwrHiAlarm=rxPwrHiAlarm, blade_thermal_fault=blade_thermal_fault, rxPwrLoAlarm=rxPwrLoAlarm, pcie_fault=pcie_fault, f5AlertsNotifyGroup=f5AlertsNotifyGroup, psu_fault=psu_fault, raidEvent=raidEvent, txBiasLoAlarm=txBiasLoAlarm, firmware_update_status=firmware_update_status, f5AlertNotification=f5AlertNotification, module_communication_error=module_communication_error, module_present=module_present, memory_fault=memory_fault, aom_fault=aom_fault, thermal_fault=thermal_fault, drive_fault=drive_fault, txPwrHiAlarm=txPwrHiAlarm, backplane=backplane, rxPwrLoWarn=rxPwrLoWarn, ddmVccLoWarn=ddmVccLoWarn, ddmTempLoAlarm=ddmTempLoAlarm, drive_utilization=drive_utilization)
