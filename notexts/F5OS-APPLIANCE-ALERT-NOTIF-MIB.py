...
f5AlertNotificationGroup, alertSeverity, f5Alerts, alertSource, alertDescription, alertTimeStamp, alertEffect = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5AlertNotificationGroup", "alertSeverity", "f5Alerts", "alertSource", "alertDescription", "alertTimeStamp", "alertEffect")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txBiasLoAlarm=txBiasLoAlarm, txBiasHiAlarm=txBiasHiAlarm, blade_thermal_fault=blade_thermal_fault, txPwrHiWarn=txPwrHiWarn, txPwrLoAlarm=txPwrLoAlarm, module_present=module_present, txBiasHiWarn=txBiasHiWarn, cpu_fault=cpu_fault, drive_thermal_throttle=drive_thermal_throttle, ddmTempHiWarn=ddmTempHiWarn, ddmVccHiAlarm=ddmVccHiAlarm, rxPwrHiAlarm=rxPwrHiAlarm, core_dump=core_dump, drive_capacity_fault=drive_capacity_fault, pcie_fault=pcie_fault, drive_utilization=drive_utilization, ddmTempLoWarn=ddmTempLoWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, psu_fault=psu_fault, module_communication_error=module_communication_error, aom_fault=aom_fault, lcd_fault=lcd_fault, ddmTempLoAlarm=ddmTempLoAlarm, power_fault=power_fault, service_health=service_health, txPwrLoWarn=txPwrLoWarn, rxPwrHiWarn=rxPwrHiWarn, firmware_update_status=firmware_update_status, rxPwrLoAlarm=rxPwrLoAlarm, ddmVccLoWarn=ddmVccLoWarn, drive_fault=drive_fault, rxPwrLoWarn=rxPwrLoWarn, f5AlertNotification=f5AlertNotification, unknown_alarm=unknown_alarm, ddmVccHiWarn=ddmVccHiWarn, txBiasLoWarn=txBiasLoWarn, thermal_fault=thermal_fault, ddmTempHiAlarm=ddmTempHiAlarm, ddmVccLoAlarm=ddmVccLoAlarm, raidEvent=raidEvent, fipsError=fipsError, PYSNMP_MODULE_ID=f5AlertNotification, firmware_fault=firmware_fault, backplane=backplane, hardware_device_fault=hardware_device_fault, blade_hardware_fault=blade_hardware_fault, memory_fault=memory_fault, txPwrHiAlarm=txPwrHiAlarm)
