...
f5AlertNotificationGroup, f5Alerts, alertDescription, alertSource, alertTimeStamp, alertSeverity, alertEffect = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "f5AlertNotificationGroup", "f5Alerts", "alertDescription", "alertSource", "alertTimeStamp", "alertSeverity", "alertEffect")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", txBiasLoAlarm=txBiasLoAlarm, drive_capacity_fault=drive_capacity_fault, ddmTempLoAlarm=ddmTempLoAlarm, cpu_fault=cpu_fault, rxPwrLoAlarm=rxPwrLoAlarm, pcie_fault=pcie_fault, module_communication_error=module_communication_error, memory_fault=memory_fault, raidEvent=raidEvent, f5AlertsNotifyGroup=f5AlertsNotifyGroup, rxPwrHiWarn=rxPwrHiWarn, rxPwrLoWarn=rxPwrLoWarn, power_fault=power_fault, fipsError=fipsError, txPwrHiWarn=txPwrHiWarn, hardware_device_fault=hardware_device_fault, drive_thermal_throttle=drive_thermal_throttle, service_health=service_health, ddmVccHiWarn=ddmVccHiWarn, psu_fault=psu_fault, ddmVccLoAlarm=ddmVccLoAlarm, blade_hardware_fault=blade_hardware_fault, thermal_fault=thermal_fault, rxPwrHiAlarm=rxPwrHiAlarm, txBiasHiAlarm=txBiasHiAlarm, core_dump=core_dump, aom_fault=aom_fault, backplane=backplane, firmware_fault=firmware_fault, txPwrHiAlarm=txPwrHiAlarm, lcd_fault=lcd_fault, txBiasHiWarn=txBiasHiWarn, blade_thermal_fault=blade_thermal_fault, txPwrLoWarn=txPwrLoWarn, f5AlertNotification=f5AlertNotification, module_present=module_present, ddmVccLoWarn=ddmVccLoWarn, ddmTempHiWarn=ddmTempHiWarn, drive_fault=drive_fault, ddmTempHiAlarm=ddmTempHiAlarm, ddmTempLoWarn=ddmTempLoWarn, firmware_update_status=firmware_update_status, txPwrLoAlarm=txPwrLoAlarm, txBiasLoWarn=txBiasLoWarn, unknown_alarm=unknown_alarm, ddmVccHiAlarm=ddmVccHiAlarm, drive_utilization=drive_utilization, PYSNMP_MODULE_ID=f5AlertNotification)
