...
alertSeverity, alertDescription, alertTimeStamp, alertSource, f5AlertNotificationGroup, alertEffect, f5Alerts = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSeverity", "alertDescription", "alertTimeStamp", "alertSource", "f5AlertNotificationGroup", "alertEffect", "f5Alerts")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", thermal_fault=thermal_fault, ddmTempLoWarn=ddmTempLoWarn, cpu_fault=cpu_fault, ddmTempHiAlarm=ddmTempHiAlarm, core_dump=core_dump, module_communication_error=module_communication_error, txPwrHiAlarm=txPwrHiAlarm, txPwrLoWarn=txPwrLoWarn, power_fault=power_fault, backplane=backplane, txBiasHiWarn=txBiasHiWarn, rxPwrLoWarn=rxPwrLoWarn, lcd_fault=lcd_fault, drive_utilization=drive_utilization, rxPwrHiAlarm=rxPwrHiAlarm, ddmVccHiAlarm=ddmVccHiAlarm, unknown_alarm=unknown_alarm, txPwrLoAlarm=txPwrLoAlarm, ddmVccLoWarn=ddmVccLoWarn, ddmTempLoAlarm=ddmTempLoAlarm, f5AlertNotification=f5AlertNotification, blade_hardware_fault=blade_hardware_fault, drive_capacity_fault=drive_capacity_fault, hardware_device_fault=hardware_device_fault, txBiasLoAlarm=txBiasLoAlarm, rxPwrHiWarn=rxPwrHiWarn, PYSNMP_MODULE_ID=f5AlertNotification, firmware_update_status=firmware_update_status, pcie_fault=pcie_fault, txBiasLoWarn=txBiasLoWarn, ddmVccHiWarn=ddmVccHiWarn, txBiasHiAlarm=txBiasHiAlarm, rxPwrLoAlarm=rxPwrLoAlarm, service_health=service_health, module_present=module_present, ddmVccLoAlarm=ddmVccLoAlarm, firmware_fault=firmware_fault, drive_thermal_throttle=drive_thermal_throttle, raidEvent=raidEvent, txPwrHiWarn=txPwrHiWarn, psu_fault=psu_fault, memory_fault=memory_fault, drive_fault=drive_fault, aom_fault=aom_fault, fipsError=fipsError, ddmTempHiWarn=ddmTempHiWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, blade_thermal_fault=blade_thermal_fault)
