...
alertEffect, f5Alerts, alertTimeStamp, alertDescription, alertSource, f5AlertNotificationGroup, alertSeverity = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertEffect", "f5Alerts", "alertTimeStamp", "alertDescription", "alertSource", "f5AlertNotificationGroup", "alertSeverity")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", backplane=backplane, f5AlertNotification=f5AlertNotification, thermal_fault=thermal_fault, firmware_update_status=firmware_update_status, core_dump=core_dump, pcie_fault=pcie_fault, txPwrHiWarn=txPwrHiWarn, rxPwrHiWarn=rxPwrHiWarn, rxPwrLoAlarm=rxPwrLoAlarm, rxPwrHiAlarm=rxPwrHiAlarm, ddmTempHiWarn=ddmTempHiWarn, txPwrHiAlarm=txPwrHiAlarm, ddmVccLoAlarm=ddmVccLoAlarm, drive_utilization=drive_utilization, aom_fault=aom_fault, rxPwrLoWarn=rxPwrLoWarn, ddmTempLoWarn=ddmTempLoWarn, raidEvent=raidEvent, txBiasLoAlarm=txBiasLoAlarm, txBiasHiWarn=txBiasHiWarn, fipsError=fipsError, unknown_alarm=unknown_alarm, psu_fault=psu_fault, module_communication_error=module_communication_error, drive_capacity_fault=drive_capacity_fault, hardware_device_fault=hardware_device_fault, power_fault=power_fault, txPwrLoWarn=txPwrLoWarn, ddmTempHiAlarm=ddmTempHiAlarm, cpu_fault=cpu_fault, ddmTempLoAlarm=ddmTempLoAlarm, firmware_fault=firmware_fault, module_present=module_present, ddmVccLoWarn=ddmVccLoWarn, lcd_fault=lcd_fault, txBiasHiAlarm=txBiasHiAlarm, drive_fault=drive_fault, blade_thermal_fault=blade_thermal_fault, txBiasLoWarn=txBiasLoWarn, ddmVccHiWarn=ddmVccHiWarn, drive_thermal_throttle=drive_thermal_throttle, f5AlertsNotifyGroup=f5AlertsNotifyGroup, txPwrLoAlarm=txPwrLoAlarm, memory_fault=memory_fault, ddmVccHiAlarm=ddmVccHiAlarm, PYSNMP_MODULE_ID=f5AlertNotification, service_health=service_health, blade_hardware_fault=blade_hardware_fault)
