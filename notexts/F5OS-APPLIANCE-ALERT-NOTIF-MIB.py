...
alertSource, alertSeverity, alertTimeStamp, alertDescription, f5AlertNotificationGroup, alertEffect, f5Alerts = mibBuilder.importSymbols("F5-ALERT-DEF-MIB", "alertSource", "alertSeverity", "alertTimeStamp", "alertDescription", "f5AlertNotificationGroup", "alertEffect", "f5Alerts")
...
mibBuilder.exportSymbols("F5OS-APPLIANCE-ALERT-NOTIF-MIB", rxPwrHiWarn=rxPwrHiWarn, f5AlertsNotifyGroup=f5AlertsNotifyGroup, txPwrLoAlarm=txPwrLoAlarm, ddmVccLoAlarm=ddmVccLoAlarm, firmware_update_status=firmware_update_status, lcd_fault=lcd_fault, firmware_fault=firmware_fault, thermal_fault=thermal_fault, drive_utilization=drive_utilization, blade_thermal_fault=blade_thermal_fault, txPwrHiWarn=txPwrHiWarn, PYSNMP_MODULE_ID=f5AlertNotification, ddmVccHiAlarm=ddmVccHiAlarm, memory_fault=memory_fault, fipsError=fipsError, rxPwrHiAlarm=rxPwrHiAlarm, cpu_fault=cpu_fault, rxPwrLoAlarm=rxPwrLoAlarm, txBiasHiWarn=txBiasHiWarn, drive_fault=drive_fault, raidEvent=raidEvent, txPwrLoWarn=txPwrLoWarn, txBiasLoAlarm=txBiasLoAlarm, ddmTempHiWarn=ddmTempHiWarn, ddmVccLoWarn=ddmVccLoWarn, unknown_alarm=unknown_alarm, ddmTempLoWarn=ddmTempLoWarn, core_dump=core_dump, ddmTempLoAlarm=ddmTempLoAlarm, pcie_fault=pcie_fault, f5AlertNotification=f5AlertNotification, hardware_device_fault=hardware_device_fault, psu_fault=psu_fault, drive_capacity_fault=drive_capacity_fault, ddmTempHiAlarm=ddmTempHiAlarm, module_present=module_present, service_health=service_health, power_fault=power_fault, txBiasHiAlarm=txBiasHiAlarm, drive_thermal_throttle=drive_thermal_throttle, txBiasLoWarn=txBiasLoWarn, ddmVccHiWarn=ddmVccHiWarn, aom_fault=aom_fault, blade_hardware_fault=blade_hardware_fault, module_communication_error=module_communication_error, txPwrHiAlarm=txPwrHiAlarm, rxPwrLoWarn=rxPwrLoWarn, backplane=backplane)
