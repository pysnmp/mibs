...
iso, ModuleIdentity, Integer32, Counter64, Unsigned32, TimeTicks, MibIdentifier, IpAddress, ObjectIdentity, Gauge32, Counter32, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "Integer32", "Counter64", "Unsigned32", "TimeTicks", "MibIdentifier", "IpAddress", "ObjectIdentity", "Gauge32", "Counter32", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MPIOS-MIB", rtrEntityName=rtrEntityName, rtrScheduleLifeTime=rtrScheduleLifeTime, sysCpuStatus=sysCpuStatus, maxBlockSizeFree=maxBlockSizeFree, rtrScheduleAfterTime=rtrScheduleAfterTime, taskDescr=taskDescr, rtrEntityId=rtrEntityId, rtrFlStaTmOutputMaxPkts=rtrFlStaTmOutputMaxPkts, cpuTaskEntry=cpuTaskEntry, rtrJitterCodec=rtrJitterCodec, rtrJitterTargetPort=rtrJitterTargetPort, rtrJitterPktLossSd=rtrJitterPktLossSd, rtrJitterTargetIp=rtrJitterTargetIp, sysRtrJitterTable=sysRtrJitterTable, sysRtrResponder=sysRtrResponder, sysRtrEntityTable=sysRtrEntityTable, rtrFlStaInputMaxPkts=rtrFlStaInputMaxPkts, rtrFlStaTmOutputMinPkts=rtrFlStaTmOutputMinPkts, taskErrorStatus=taskErrorStatus, rtrFlStaOutputMaxFlow=rtrFlStaOutputMaxFlow, sysRtrEntityEntry=sysRtrEntityEntry, rtrJitterSourceIp=rtrJitterSourceIp, sysRtrFlowStatisticsTable=sysRtrFlowStatisticsTable, sysIfPktPriStatistics=sysIfPktPriStatistics, rtrFlStatisticsIfName=rtrFlStatisticsIfName, cpuTaskAverageUtil=cpuTaskAverageUtil, cpuUtilCpuId=cpuUtilCpuId, rtrJitterSchInterval=rtrJitterSchInterval, rtrJitterDelayDsMax=rtrJitterDelayDsMax, rtrScheduleLifeFlag=rtrScheduleLifeFlag, cpuTaskTable=cpuTaskTable, cpuUtilAverageUtil=cpuUtilAverageUtil, rtrIcmpEchoRowStatus=rtrIcmpEchoRowStatus, sysRtrEntityMgt=sysRtrEntityMgt, rtrJitterIcpifMin=rtrJitterIcpifMin, rtrGroupRowStatus=rtrGroupRowStatus, sysRtrGbl=sysRtrGbl, rtrJitterDelayDsMin=rtrJitterDelayDsMin, rtrFlStatisticsEntityId=rtrFlStatisticsEntityId, rtrFlStaTmInputMinFlow=rtrFlStaTmInputMinFlow, rtrScheduleInterval=rtrScheduleInterval, rtrJitterSdMax=rtrJitterSdMax, cpuUtilCurrentUtil=cpuUtilCurrentUtil, sysCpuTemper=sysCpuTemper, sysRtrGroupMgt=sysRtrGroupMgt, rtrScheduleId=rtrScheduleId, taskId=taskId, rtrFlStaTmOutputMinFlow=rtrFlStaTmOutputMinFlow, taskStackPos=taskStackPos, rtrEntityLogMaxSize=rtrEntityLogMaxSize, sysRtrIcmpEchoEntry=sysRtrIcmpEchoEntry, rtrScheduleRowStatus=rtrScheduleRowStatus, rtrJitterRowStatus=rtrJitterRowStatus, sysIfInDiscards=sysIfInDiscards, numBytesFree=numBytesFree, numBlocksAlloc=numBlocksAlloc, rtrJitterTos=rtrJitterTos, allocBytesPercent=allocBytesPercent, EnabledStatus=EnabledStatus, cpuTaskPri=cpuTaskPri, sysIfInUnkownProtos=sysIfInUnkownProtos, rtrEntityLogFilter=rtrEntityLogFilter, rtrScheduleAgeOut=rtrScheduleAgeOut, sysRtrJitterEntry=sysRtrJitterEntry, sysMemory=sysMemory, rtrEntityLogType=rtrEntityLogType, rtrScheduleObjId=rtrScheduleObjId, rtrUdpechoDelay=rtrUdpechoDelay, sysCpuTaskTabView=sysCpuTaskTabView, sysIfPktPriority=sysIfPktPriority, taskTable=taskTable, rtrFlowStatisticsRowStatus=rtrFlowStatisticsRowStatus, cpuUtilEntry=cpuUtilEntry, sysIfInUcastPkts=sysIfInUcastPkts, rtrUdpechoPktSucc=rtrUdpechoPktSucc, rtrIcmpEchoVerifyData=rtrIcmpEchoVerifyData, rtrGroupEntityMembers=rtrGroupEntityMembers, rtrJitterDelaySdMin=rtrJitterDelaySdMin, cpuUtilTotalUsedTicks=cpuUtilTotalUsedTicks, rtrFlStaInputMinPkts=rtrFlStaInputMinPkts, sysRtrScheduleEntry=sysRtrScheduleEntry, sysRtrGroupEntry=sysRtrGroupEntry, sysIfPktPriStaTable=sysIfPktPriStaTable, cpuTaskName=cpuTaskName, PYSNMP_MODULE_ID=mpios, taskEntry=taskEntry, rtrIcmpEchoSchInterval=rtrIcmpEchoSchInterval, taskStackEnd=taskStackEnd, sysRtrScheduleTable=sysRtrScheduleTable, rtrFlStaTmInputMaxFlow=rtrFlStaTmInputMaxFlow, cpuUtilDeltaUsedTicks=cpuUtilDeltaUsedTicks, rtrScheduleType=rtrScheduleType, taskOptions=taskOptions, sysRtrUdpechoEntry=sysRtrUdpechoEntry, sysRtrFlowStatisticsEntry=sysRtrFlowStatisticsEntry, iosSystem=iosSystem, rtrIcmpEchoVrfName=rtrIcmpEchoVrfName, taskPriority=taskPriority, sysMainBoardTemper=sysMainBoardTemper, rtrIcmpEchoPktNum=rtrIcmpEchoPktNum, rtrUdpechoDelayMin=rtrUdpechoDelayMin, sysIfOutNUcastPkts=sysIfOutNUcastPkts, iosObjects=iosObjects, sysCpuAlertTemper=sysCpuAlertTemper, rtrGroupName=rtrGroupName, sysNFI=sysNFI, rtrFlStaOutputMaxPkts=rtrFlStaOutputMaxPkts, numBytesAlloc=numBytesAlloc, sysIfOutUcastPkts=sysIfOutUcastPkts, rtrJitterMinRtt=rtrJitterMinRtt, cpuUtilDeltaTimes=cpuUtilDeltaTimes, rtrUdpechoTargetPort=rtrUdpechoTargetPort, rtrEntityThreshold=rtrEntityThreshold, rtrFlStaOutputMinPkts=rtrFlStaOutputMinPkts, sysRtrFlowStatisticsMgt=sysRtrFlowStatisticsMgt, sysRtrIcmpEchoTable=sysRtrIcmpEchoTable, sysIfOutErrors=sysIfOutErrors, rtrIcmpEchoTos=rtrIcmpEchoTos, rtrFlStaTmOutputMaxFlow=rtrFlStaTmOutputMaxFlow, rtrIcmpEchoEntityId=rtrIcmpEchoEntityId, mpios=mpios, cpuTaskDeltaTicks=cpuTaskDeltaTicks, sysIfInErrors=sysIfInErrors, sysAlertTrapInt=sysAlertTrapInt, taskStackPtr=taskStackPtr, taskStackBase=taskStackBase, sysIfInNUcastPkts=sysIfInNUcastPkts, rtrUdpechoTargetIp=rtrUdpechoTargetIp, rtrGroupInterval=rtrGroupInterval, rtrFlStatisticsInterval=rtrFlStatisticsInterval, rtrIcmpEchoSuccessRate=rtrIcmpEchoSuccessRate, memoryTotalBytes=memoryTotalBytes, cpuUtilDeltaTicks=cpuUtilDeltaTicks, sysMainBoardAlertTemper=sysMainBoardAlertTemper, cpuUtilTable=cpuUtilTable, rtrJitterEntityId=rtrJitterEntityId, rtrIcmpEchoTimeout=rtrIcmpEchoTimeout, cpuTaskId=cpuTaskId, rtrUdpechoSchInterval=rtrUdpechoSchInterval, rtrScheduleStartTime=rtrScheduleStartTime, rtrJitterDsMax=rtrJitterDsMax, rtrJitterPktLossDs=rtrJitterPktLossDs, rtrUdpechoTimeout=rtrUdpechoTimeout, taskStackMaxUsed=taskStackMaxUsed, rtrJitterDsMin=rtrJitterDsMin, taskStackFree=taskStackFree, sysTemperature=sysTemperature, rtrJitterState=rtrJitterState, taskMain=taskMain, rtrIcmpEchoSourceIp=rtrIcmpEchoSourceIp, rtrUdpechoSourceIp=rtrUdpechoSourceIp, rtrJitterSdMin=rtrJitterSdMin, rtrJitterMosMax=rtrJitterMosMax, rtrFlStaTmInputMinPkts=rtrFlStaTmInputMinPkts, cpuUtilTotalTimes=cpuUtilTotalTimes, sysRtrScheduleMgt=sysRtrScheduleMgt, sysRtrIcmpEchoMgt=sysRtrIcmpEchoMgt, rtrJitterIcpifMax=rtrJitterIcpifMax, rtrUdpechoSourcePort=rtrUdpechoSourcePort, rtrUdpechoPktLoss=rtrUdpechoPktLoss, rtrJitterTimeout=rtrJitterTimeout, rtrJitterVrfName=rtrJitterVrfName, rtrFlStaTmInputMaxPkts=rtrFlStaTmInputMaxPkts, rtrUdpechoState=rtrUdpechoState, rtrGroupId=rtrGroupId, cpuUtilTotalTicks=cpuUtilTotalTicks, rtrIcmpEchoPktLen=rtrIcmpEchoPktLen, rtrIcmpEchoExtendFlag=rtrIcmpEchoExtendFlag, sysRtrJitterMgt=sysRtrJitterMgt, rtrIcmpEchoIsScheduling=rtrIcmpEchoIsScheduling, rtrFlStaInputMaxFlow=rtrFlStaInputMaxFlow, sysIfInOctets=sysIfInOctets, sysIfOutOctets=sysIfOutOctets, taskName=taskName, taskStackSizeUsage=taskStackSizeUsage, rtrJitterDelaySdMax=rtrJitterDelaySdMax, rtrJitterMosMin=rtrJitterMosMin, rtrScheduleStartTimeFlag=rtrScheduleStartTimeFlag, checkCpuTimeInterval=checkCpuTimeInterval, rtrFlStaInputMinFlow=rtrFlStaInputMinFlow, cpuTaskCurrentUtil=cpuTaskCurrentUtil, rtrScheduleRepeat=rtrScheduleRepeat, rtrEntityRowStatus=rtrEntityRowStatus, rtrJitterPktLen=rtrJitterPktLen, rtrUdpechoDelayMax=rtrUdpechoDelayMax, sysRtrCtrl=sysRtrCtrl, rtrIcmpEchoPktTotalSend=rtrIcmpEchoPktTotalSend, rtrIcmpEchoSetDf=rtrIcmpEchoSetDf, sysRtrUdpechoMgt=sysRtrUdpechoMgt, rtrUdpechoPktLen=rtrUdpechoPktLen, rtrUdpechoVrfName=rtrUdpechoVrfName, cpuUtilDeltaUtil=cpuUtilDeltaUtil, rtrUdpechoTos=rtrUdpechoTos, sysTask=sysTask, sysIfIndex=sysIfIndex, avgBlockSizeFree=avgBlockSizeFree, taskStackSize=taskStackSize, cpuTaskTotalTicks=cpuTaskTotalTicks, rtrUdpechoRowStatus=rtrUdpechoRowStatus, rtrJitterMaxRtt=rtrJitterMaxRtt, sysIfDesc=sysIfDesc, rtrIcmpEchoTargetIp=rtrIcmpEchoTargetIp, sysIfStatistic=sysIfStatistic, numBlocksFree=numBlocksFree, sysIfPktPriStaEntry=sysIfPktPriStaEntry, cpuTaskDeltaUtil=cpuTaskDeltaUtil, avgBlockSizeAlloc=avgBlockSizeAlloc, sysIfOutDiscards=sysIfOutDiscards, sysCpu=sysCpu, rtrJitterPktInterval=rtrJitterPktInterval, rtrJitterSourcePort=rtrJitterSourcePort, rtrFlStaOutputMinFlow=rtrFlStaOutputMinFlow, sysRtrUdpechoTable=sysRtrUdpechoTable, sysRtrGroupTable=sysRtrGroupTable, rtrJitterPktNum=rtrJitterPktNum, taskStatus=taskStatus, rtrEntityType=rtrEntityType, rtrUdpechoEntityId=rtrUdpechoEntityId, rtrIcmpEchoPktTotalRcvd=rtrIcmpEchoPktTotalRcvd)
