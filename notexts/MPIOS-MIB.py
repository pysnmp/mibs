...
TimeTicks, IpAddress, Gauge32, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, MibIdentifier, Counter64, ModuleIdentity, Unsigned32, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Gauge32", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "MibIdentifier", "Counter64", "ModuleIdentity", "Unsigned32", "iso", "Bits")
...
mibBuilder.exportSymbols("MPIOS-MIB", rtrJitterState=rtrJitterState, mpios=mpios, sysIfInDiscards=sysIfInDiscards, sysRtrScheduleMgt=sysRtrScheduleMgt, sysAlertTrapInt=sysAlertTrapInt, cpuUtilDeltaTicks=cpuUtilDeltaTicks, rtrJitterSourcePort=rtrJitterSourcePort, cpuUtilEntry=cpuUtilEntry, sysRtrFlowStatisticsMgt=sysRtrFlowStatisticsMgt, rtrFlStaOutputMinPkts=rtrFlStaOutputMinPkts, sysIfPktPriStaTable=sysIfPktPriStaTable, cpuUtilAverageUtil=cpuUtilAverageUtil, iosObjects=iosObjects, rtrUdpechoTargetPort=rtrUdpechoTargetPort, rtrJitterSdMax=rtrJitterSdMax, cpuTaskDeltaTicks=cpuTaskDeltaTicks, rtrGroupRowStatus=rtrGroupRowStatus, rtrIcmpEchoEntityId=rtrIcmpEchoEntityId, rtrFlStaInputMaxFlow=rtrFlStaInputMaxFlow, taskStackMaxUsed=taskStackMaxUsed, rtrJitterMosMin=rtrJitterMosMin, rtrScheduleRepeat=rtrScheduleRepeat, rtrIcmpEchoPktTotalRcvd=rtrIcmpEchoPktTotalRcvd, rtrFlStaOutputMaxPkts=rtrFlStaOutputMaxPkts, rtrScheduleStartTimeFlag=rtrScheduleStartTimeFlag, sysCpu=sysCpu, rtrIcmpEchoSourceIp=rtrIcmpEchoSourceIp, allocBytesPercent=allocBytesPercent, rtrEntityRowStatus=rtrEntityRowStatus, rtrIcmpEchoVrfName=rtrIcmpEchoVrfName, cpuTaskAverageUtil=cpuTaskAverageUtil, rtrJitterIcpifMin=rtrJitterIcpifMin, rtrScheduleObjId=rtrScheduleObjId, taskStackPtr=taskStackPtr, sysIfOutUcastPkts=sysIfOutUcastPkts, sysMainBoardTemper=sysMainBoardTemper, rtrJitterDelaySdMin=rtrJitterDelaySdMin, sysRtrCtrl=sysRtrCtrl, sysIfPktPriStaEntry=sysIfPktPriStaEntry, maxBlockSizeFree=maxBlockSizeFree, avgBlockSizeAlloc=avgBlockSizeAlloc, rtrJitterTos=rtrJitterTos, rtrUdpechoDelay=rtrUdpechoDelay, rtrIcmpEchoTargetIp=rtrIcmpEchoTargetIp, EnabledStatus=EnabledStatus, cpuTaskName=cpuTaskName, rtrFlStaTmInputMinFlow=rtrFlStaTmInputMinFlow, rtrUdpechoState=rtrUdpechoState, sysRtrJitterTable=sysRtrJitterTable, sysRtrFlowStatisticsEntry=sysRtrFlowStatisticsEntry, sysIfInUnkownProtos=sysIfInUnkownProtos, taskPriority=taskPriority, rtrIcmpEchoSchInterval=rtrIcmpEchoSchInterval, rtrJitterMinRtt=rtrJitterMinRtt, sysTask=sysTask, taskStackEnd=taskStackEnd, rtrFlStaTmOutputMaxFlow=rtrFlStaTmOutputMaxFlow, rtrJitterPktLossSd=rtrJitterPktLossSd, rtrUdpechoPktLoss=rtrUdpechoPktLoss, rtrJitterTargetIp=rtrJitterTargetIp, taskTable=taskTable, rtrIcmpEchoRowStatus=rtrIcmpEchoRowStatus, sysIfOutNUcastPkts=sysIfOutNUcastPkts, rtrUdpechoSourcePort=rtrUdpechoSourcePort, rtrEntityLogMaxSize=rtrEntityLogMaxSize, rtrScheduleLifeTime=rtrScheduleLifeTime, rtrEntityName=rtrEntityName, rtrUdpechoPktLen=rtrUdpechoPktLen, rtrIcmpEchoPktNum=rtrIcmpEchoPktNum, cpuTaskEntry=cpuTaskEntry, rtrScheduleType=rtrScheduleType, rtrJitterDelayDsMax=rtrJitterDelayDsMax, rtrFlStatisticsInterval=rtrFlStatisticsInterval, rtrGroupName=rtrGroupName, rtrGroupInterval=rtrGroupInterval, taskDescr=taskDescr, sysRtrIcmpEchoMgt=sysRtrIcmpEchoMgt, cpuUtilTotalTimes=cpuUtilTotalTimes, sysIfOutDiscards=sysIfOutDiscards, rtrJitterEntityId=rtrJitterEntityId, cpuUtilTotalUsedTicks=cpuUtilTotalUsedTicks, rtrEntityLogType=rtrEntityLogType, rtrFlStaTmInputMaxFlow=rtrFlStaTmInputMaxFlow, sysIfDesc=sysIfDesc, rtrIcmpEchoExtendFlag=rtrIcmpEchoExtendFlag, numBytesAlloc=numBytesAlloc, rtrIcmpEchoTos=rtrIcmpEchoTos, taskStackFree=taskStackFree, sysRtrEntityEntry=sysRtrEntityEntry, sysIfPktPriority=sysIfPktPriority, rtrUdpechoDelayMin=rtrUdpechoDelayMin, sysRtrEntityMgt=sysRtrEntityMgt, cpuUtilCurrentUtil=cpuUtilCurrentUtil, sysRtrIcmpEchoTable=sysRtrIcmpEchoTable, cpuUtilCpuId=cpuUtilCpuId, sysRtrUdpechoTable=sysRtrUdpechoTable, sysRtrGroupMgt=sysRtrGroupMgt, rtrScheduleId=rtrScheduleId, rtrJitterDsMin=rtrJitterDsMin, sysCpuTemper=sysCpuTemper, sysNFI=sysNFI, numBlocksAlloc=numBlocksAlloc, checkCpuTimeInterval=checkCpuTimeInterval, rtrUdpechoEntityId=rtrUdpechoEntityId, rtrScheduleRowStatus=rtrScheduleRowStatus, rtrIcmpEchoPktLen=rtrIcmpEchoPktLen, sysIfInOctets=sysIfInOctets, rtrJitterIcpifMax=rtrJitterIcpifMax, sysIfInUcastPkts=sysIfInUcastPkts, rtrJitterCodec=rtrJitterCodec, cpuUtilDeltaTimes=cpuUtilDeltaTimes, rtrUdpechoSchInterval=rtrUdpechoSchInterval, rtrUdpechoDelayMax=rtrUdpechoDelayMax, cpuTaskPri=cpuTaskPri, rtrJitterTimeout=rtrJitterTimeout, sysIfInNUcastPkts=sysIfInNUcastPkts, rtrJitterPktLossDs=rtrJitterPktLossDs, rtrJitterPktInterval=rtrJitterPktInterval, rtrJitterDelayDsMin=rtrJitterDelayDsMin, rtrIcmpEchoIsScheduling=rtrIcmpEchoIsScheduling, sysRtrScheduleEntry=sysRtrScheduleEntry, sysCpuStatus=sysCpuStatus, sysMainBoardAlertTemper=sysMainBoardAlertTemper, sysTemperature=sysTemperature, sysCpuAlertTemper=sysCpuAlertTemper, rtrFlStaTmInputMinPkts=rtrFlStaTmInputMinPkts, sysIfInErrors=sysIfInErrors, cpuTaskCurrentUtil=cpuTaskCurrentUtil, sysRtrFlowStatisticsTable=sysRtrFlowStatisticsTable, cpuTaskId=cpuTaskId, rtrJitterRowStatus=rtrJitterRowStatus, rtrFlStaTmInputMaxPkts=rtrFlStaTmInputMaxPkts, taskMain=taskMain, sysIfOutOctets=sysIfOutOctets, rtrJitterVrfName=rtrJitterVrfName, cpuUtilTotalTicks=cpuUtilTotalTicks, sysIfPktPriStatistics=sysIfPktPriStatistics, PYSNMP_MODULE_ID=mpios, rtrJitterSdMin=rtrJitterSdMin, sysRtrJitterEntry=sysRtrJitterEntry, sysRtrScheduleTable=sysRtrScheduleTable, sysRtrResponder=sysRtrResponder, sysIfIndex=sysIfIndex, sysRtrJitterMgt=sysRtrJitterMgt, rtrIcmpEchoPktTotalSend=rtrIcmpEchoPktTotalSend, rtrFlStaTmOutputMinPkts=rtrFlStaTmOutputMinPkts, sysIfStatistic=sysIfStatistic, rtrEntityThreshold=rtrEntityThreshold, rtrEntityType=rtrEntityType, rtrFlowStatisticsRowStatus=rtrFlowStatisticsRowStatus, rtrUdpechoSourceIp=rtrUdpechoSourceIp, iosSystem=iosSystem, taskStackSize=taskStackSize, rtrScheduleLifeFlag=rtrScheduleLifeFlag, numBlocksFree=numBlocksFree, rtrScheduleAfterTime=rtrScheduleAfterTime, taskStackSizeUsage=taskStackSizeUsage, sysRtrGbl=sysRtrGbl, rtrJitterDelaySdMax=rtrJitterDelaySdMax, taskStatus=taskStatus, rtrFlStaInputMinPkts=rtrFlStaInputMinPkts, taskEntry=taskEntry, rtrIcmpEchoVerifyData=rtrIcmpEchoVerifyData, sysRtrUdpechoEntry=sysRtrUdpechoEntry, rtrJitterPktNum=rtrJitterPktNum, rtrFlStaOutputMaxFlow=rtrFlStaOutputMaxFlow, rtrFlStaInputMaxPkts=rtrFlStaInputMaxPkts, rtrUdpechoTargetIp=rtrUdpechoTargetIp, rtrFlStatisticsEntityId=rtrFlStatisticsEntityId, sysIfOutErrors=sysIfOutErrors, taskStackBase=taskStackBase, sysRtrEntityTable=sysRtrEntityTable, rtrJitterDsMax=rtrJitterDsMax, rtrUdpechoTos=rtrUdpechoTos, rtrFlStatisticsIfName=rtrFlStatisticsIfName, taskId=taskId, rtrUdpechoRowStatus=rtrUdpechoRowStatus, cpuUtilTable=cpuUtilTable, rtrGroupEntityMembers=rtrGroupEntityMembers, sysCpuTaskTabView=sysCpuTaskTabView, cpuTaskTotalTicks=cpuTaskTotalTicks, rtrJitterSourceIp=rtrJitterSourceIp, rtrFlStaTmOutputMinFlow=rtrFlStaTmOutputMinFlow, sysRtrIcmpEchoEntry=sysRtrIcmpEchoEntry, rtrIcmpEchoTimeout=rtrIcmpEchoTimeout, rtrJitterMosMax=rtrJitterMosMax, rtrFlStaTmOutputMaxPkts=rtrFlStaTmOutputMaxPkts, rtrUdpechoTimeout=rtrUdpechoTimeout, rtrIcmpEchoSuccessRate=rtrIcmpEchoSuccessRate, rtrJitterMaxRtt=rtrJitterMaxRtt, sysRtrUdpechoMgt=sysRtrUdpechoMgt, rtrUdpechoVrfName=rtrUdpechoVrfName, sysRtrGroupTable=sysRtrGroupTable, avgBlockSizeFree=avgBlockSizeFree, cpuUtilDeltaUtil=cpuUtilDeltaUtil, rtrScheduleAgeOut=rtrScheduleAgeOut, rtrGroupId=rtrGroupId, rtrJitterTargetPort=rtrJitterTargetPort, rtrIcmpEchoSetDf=rtrIcmpEchoSetDf, taskStackPos=taskStackPos, rtrScheduleStartTime=rtrScheduleStartTime, rtrJitterSchInterval=rtrJitterSchInterval, rtrEntityId=rtrEntityId, numBytesFree=numBytesFree, cpuTaskTable=cpuTaskTable, cpuTaskDeltaUtil=cpuTaskDeltaUtil, rtrJitterPktLen=rtrJitterPktLen, rtrFlStaInputMinFlow=rtrFlStaInputMinFlow, rtrFlStaOutputMinFlow=rtrFlStaOutputMinFlow, sysMemory=sysMemory, rtrScheduleInterval=rtrScheduleInterval, rtrUdpechoPktSucc=rtrUdpechoPktSucc, taskErrorStatus=taskErrorStatus, sysRtrGroupEntry=sysRtrGroupEntry, cpuUtilDeltaUsedTicks=cpuUtilDeltaUsedTicks, taskOptions=taskOptions, taskName=taskName, rtrEntityLogFilter=rtrEntityLogFilter, memoryTotalBytes=memoryTotalBytes)
