...
IpAddress, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, Bits, NotificationType, Counter64, ModuleIdentity, Counter32, Integer32, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "Bits", "NotificationType", "Counter64", "ModuleIdentity", "Counter32", "Integer32", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("MPIOS-MIB", sysMainBoardAlertTemper=sysMainBoardAlertTemper, rtrFlStaTmInputMaxPkts=rtrFlStaTmInputMaxPkts, cpuUtilCpuId=cpuUtilCpuId, rtrFlStaTmInputMinFlow=rtrFlStaTmInputMinFlow, rtrJitterPktLossSd=rtrJitterPktLossSd, rtrIcmpEchoPktNum=rtrIcmpEchoPktNum, rtrScheduleLifeFlag=rtrScheduleLifeFlag, rtrIcmpEchoSuccessRate=rtrIcmpEchoSuccessRate, sysIfOutDiscards=sysIfOutDiscards, cpuTaskAverageUtil=cpuTaskAverageUtil, rtrJitterSdMin=rtrJitterSdMin, sysRtrIcmpEchoMgt=sysRtrIcmpEchoMgt, taskStackBase=taskStackBase, taskOptions=taskOptions, rtrFlStaOutputMinPkts=rtrFlStaOutputMinPkts, sysRtrScheduleTable=sysRtrScheduleTable, rtrScheduleLifeTime=rtrScheduleLifeTime, rtrJitterMinRtt=rtrJitterMinRtt, rtrUdpechoTimeout=rtrUdpechoTimeout, rtrUdpechoSchInterval=rtrUdpechoSchInterval, avgBlockSizeFree=avgBlockSizeFree, rtrFlStatisticsInterval=rtrFlStatisticsInterval, cpuTaskTotalTicks=cpuTaskTotalTicks, rtrUdpechoPktSucc=rtrUdpechoPktSucc, rtrUdpechoTargetIp=rtrUdpechoTargetIp, rtrFlStaInputMaxPkts=rtrFlStaInputMaxPkts, taskStackSize=taskStackSize, cpuUtilTotalUsedTicks=cpuUtilTotalUsedTicks, rtrIcmpEchoVrfName=rtrIcmpEchoVrfName, sysIfPktPriStaEntry=sysIfPktPriStaEntry, cpuTaskEntry=cpuTaskEntry, sysCpu=sysCpu, sysCpuAlertTemper=sysCpuAlertTemper, rtrIcmpEchoPktTotalSend=rtrIcmpEchoPktTotalSend, sysRtrUdpechoTable=sysRtrUdpechoTable, rtrIcmpEchoSourceIp=rtrIcmpEchoSourceIp, rtrFlStaOutputMinFlow=rtrFlStaOutputMinFlow, rtrIcmpEchoEntityId=rtrIcmpEchoEntityId, rtrUdpechoVrfName=rtrUdpechoVrfName, rtrGroupEntityMembers=rtrGroupEntityMembers, taskEntry=taskEntry, maxBlockSizeFree=maxBlockSizeFree, taskStackEnd=taskStackEnd, rtrJitterPktInterval=rtrJitterPktInterval, taskId=taskId, taskPriority=taskPriority, cpuUtilTable=cpuUtilTable, rtrJitterIcpifMin=rtrJitterIcpifMin, rtrJitterMosMin=rtrJitterMosMin, rtrIcmpEchoVerifyData=rtrIcmpEchoVerifyData, rtrFlStaInputMinFlow=rtrFlStaInputMinFlow, rtrFlStatisticsEntityId=rtrFlStatisticsEntityId, rtrJitterSourcePort=rtrJitterSourcePort, cpuTaskPri=cpuTaskPri, PYSNMP_MODULE_ID=mpios, rtrJitterRowStatus=rtrJitterRowStatus, rtrJitterDsMin=rtrJitterDsMin, rtrScheduleStartTime=rtrScheduleStartTime, rtrScheduleAgeOut=rtrScheduleAgeOut, EnabledStatus=EnabledStatus, sysTemperature=sysTemperature, rtrFlStaOutputMaxFlow=rtrFlStaOutputMaxFlow, sysIfDesc=sysIfDesc, rtrIcmpEchoIsScheduling=rtrIcmpEchoIsScheduling, cpuTaskCurrentUtil=cpuTaskCurrentUtil, rtrEntityThreshold=rtrEntityThreshold, rtrEntityLogMaxSize=rtrEntityLogMaxSize, sysRtrResponder=sysRtrResponder, rtrJitterDelaySdMax=rtrJitterDelaySdMax, sysIfInNUcastPkts=sysIfInNUcastPkts, numBlocksAlloc=numBlocksAlloc, cpuUtilDeltaTicks=cpuUtilDeltaTicks, sysRtrEntityTable=sysRtrEntityTable, rtrEntityName=rtrEntityName, rtrFlStatisticsIfName=rtrFlStatisticsIfName, rtrScheduleType=rtrScheduleType, rtrJitterDelayDsMax=rtrJitterDelayDsMax, sysMainBoardTemper=sysMainBoardTemper, sysRtrGbl=sysRtrGbl, rtrUdpechoEntityId=rtrUdpechoEntityId, rtrUdpechoState=rtrUdpechoState, sysRtrJitterEntry=sysRtrJitterEntry, numBytesAlloc=numBytesAlloc, rtrFlStaTmInputMinPkts=rtrFlStaTmInputMinPkts, rtrScheduleRepeat=rtrScheduleRepeat, sysRtrIcmpEchoTable=sysRtrIcmpEchoTable, sysIfPktPriStaTable=sysIfPktPriStaTable, taskStackPtr=taskStackPtr, sysIfOutOctets=sysIfOutOctets, rtrFlStaTmOutputMaxFlow=rtrFlStaTmOutputMaxFlow, cpuTaskId=cpuTaskId, rtrEntityLogFilter=rtrEntityLogFilter, rtrFlStaTmOutputMinPkts=rtrFlStaTmOutputMinPkts, sysIfInOctets=sysIfInOctets, rtrScheduleInterval=rtrScheduleInterval, sysRtrFlowStatisticsEntry=sysRtrFlowStatisticsEntry, rtrFlStaInputMaxFlow=rtrFlStaInputMaxFlow, cpuUtilDeltaTimes=cpuUtilDeltaTimes, sysIfInUcastPkts=sysIfInUcastPkts, rtrEntityType=rtrEntityType, avgBlockSizeAlloc=avgBlockSizeAlloc, checkCpuTimeInterval=checkCpuTimeInterval, rtrIcmpEchoExtendFlag=rtrIcmpEchoExtendFlag, rtrJitterPktLen=rtrJitterPktLen, rtrJitterTargetPort=rtrJitterTargetPort, sysRtrFlowStatisticsTable=sysRtrFlowStatisticsTable, rtrUdpechoDelayMax=rtrUdpechoDelayMax, mpios=mpios, taskStatus=taskStatus, sysCpuTaskTabView=sysCpuTaskTabView, rtrJitterTimeout=rtrJitterTimeout, sysRtrJitterTable=sysRtrJitterTable, sysCpuTemper=sysCpuTemper, sysIfPktPriStatistics=sysIfPktPriStatistics, rtrJitterMaxRtt=rtrJitterMaxRtt, rtrUdpechoDelay=rtrUdpechoDelay, rtrUdpechoTos=rtrUdpechoTos, rtrUdpechoSourcePort=rtrUdpechoSourcePort, rtrJitterSdMax=rtrJitterSdMax, cpuUtilAverageUtil=cpuUtilAverageUtil, rtrJitterTos=rtrJitterTos, rtrJitterIcpifMax=rtrJitterIcpifMax, rtrScheduleId=rtrScheduleId, sysIfOutNUcastPkts=sysIfOutNUcastPkts, rtrIcmpEchoSetDf=rtrIcmpEchoSetDf, cpuUtilDeltaUtil=cpuUtilDeltaUtil, sysRtrJitterMgt=sysRtrJitterMgt, rtrEntityRowStatus=rtrEntityRowStatus, rtrJitterSchInterval=rtrJitterSchInterval, rtrUdpechoSourceIp=rtrUdpechoSourceIp, rtrJitterState=rtrJitterState, sysRtrEntityMgt=sysRtrEntityMgt, rtrJitterPktNum=rtrJitterPktNum, rtrJitterPktLossDs=rtrJitterPktLossDs, rtrJitterDsMax=rtrJitterDsMax, taskDescr=taskDescr, rtrFlStaInputMinPkts=rtrFlStaInputMinPkts, sysCpuStatus=sysCpuStatus, cpuTaskName=cpuTaskName, rtrEntityId=rtrEntityId, rtrJitterTargetIp=rtrJitterTargetIp, rtrJitterMosMax=rtrJitterMosMax, rtrGroupId=rtrGroupId, sysNFI=sysNFI, cpuTaskDeltaTicks=cpuTaskDeltaTicks, numBlocksFree=numBlocksFree, cpuUtilTotalTimes=cpuUtilTotalTimes, rtrIcmpEchoTos=rtrIcmpEchoTos, sysRtrGroupMgt=sysRtrGroupMgt, sysRtrFlowStatisticsMgt=sysRtrFlowStatisticsMgt, taskName=taskName, rtrIcmpEchoRowStatus=rtrIcmpEchoRowStatus, rtrIcmpEchoPktTotalRcvd=rtrIcmpEchoPktTotalRcvd, sysRtrEntityEntry=sysRtrEntityEntry, sysTask=sysTask, sysRtrGroupTable=sysRtrGroupTable, iosObjects=iosObjects, rtrFlStaTmOutputMinFlow=rtrFlStaTmOutputMinFlow, rtrIcmpEchoPktLen=rtrIcmpEchoPktLen, sysRtrGroupEntry=sysRtrGroupEntry, taskTable=taskTable, sysAlertTrapInt=sysAlertTrapInt, rtrEntityLogType=rtrEntityLogType, rtrFlStaOutputMaxPkts=rtrFlStaOutputMaxPkts, rtrScheduleStartTimeFlag=rtrScheduleStartTimeFlag, rtrIcmpEchoTargetIp=rtrIcmpEchoTargetIp, rtrJitterDelayDsMin=rtrJitterDelayDsMin, rtrUdpechoTargetPort=rtrUdpechoTargetPort, allocBytesPercent=allocBytesPercent, taskMain=taskMain, rtrJitterCodec=rtrJitterCodec, sysRtrCtrl=sysRtrCtrl, sysIfOutUcastPkts=sysIfOutUcastPkts, rtrUdpechoDelayMin=rtrUdpechoDelayMin, rtrGroupName=rtrGroupName, sysIfInErrors=sysIfInErrors, sysRtrScheduleMgt=sysRtrScheduleMgt, sysIfPktPriority=sysIfPktPriority, sysRtrUdpechoMgt=sysRtrUdpechoMgt, cpuUtilEntry=cpuUtilEntry, taskStackPos=taskStackPos, rtrJitterDelaySdMin=rtrJitterDelaySdMin, rtrUdpechoPktLoss=rtrUdpechoPktLoss, rtrGroupRowStatus=rtrGroupRowStatus, taskStackFree=taskStackFree, sysIfInDiscards=sysIfInDiscards, taskErrorStatus=taskErrorStatus, sysRtrIcmpEchoEntry=sysRtrIcmpEchoEntry, rtrFlowStatisticsRowStatus=rtrFlowStatisticsRowStatus, sysIfOutErrors=sysIfOutErrors, numBytesFree=numBytesFree, rtrUdpechoRowStatus=rtrUdpechoRowStatus, cpuUtilTotalTicks=cpuUtilTotalTicks, sysIfStatistic=sysIfStatistic, rtrIcmpEchoTimeout=rtrIcmpEchoTimeout, rtrJitterSourceIp=rtrJitterSourceIp, sysRtrUdpechoEntry=sysRtrUdpechoEntry, rtrGroupInterval=rtrGroupInterval, sysIfInUnkownProtos=sysIfInUnkownProtos, cpuTaskTable=cpuTaskTable, cpuTaskDeltaUtil=cpuTaskDeltaUtil, rtrFlStaTmOutputMaxPkts=rtrFlStaTmOutputMaxPkts, taskStackMaxUsed=taskStackMaxUsed, rtrIcmpEchoSchInterval=rtrIcmpEchoSchInterval, rtrJitterEntityId=rtrJitterEntityId, rtrJitterVrfName=rtrJitterVrfName, rtrScheduleRowStatus=rtrScheduleRowStatus, memoryTotalBytes=memoryTotalBytes, sysRtrScheduleEntry=sysRtrScheduleEntry, rtrFlStaTmInputMaxFlow=rtrFlStaTmInputMaxFlow, rtrUdpechoPktLen=rtrUdpechoPktLen, sysMemory=sysMemory, taskStackSizeUsage=taskStackSizeUsage, rtrScheduleObjId=rtrScheduleObjId, cpuUtilCurrentUtil=cpuUtilCurrentUtil, sysIfIndex=sysIfIndex, iosSystem=iosSystem, cpuUtilDeltaUsedTicks=cpuUtilDeltaUsedTicks, rtrScheduleAfterTime=rtrScheduleAfterTime)
