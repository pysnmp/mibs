...
# ASN.1 source CISCO-WAN-FR-CONN-MIB
# Source digest sha256:7fe6ef5a6d520679baffa409cc4b931391ad5e463e4453f39abd273a6d677aa9
...
if mibBuilder.loadTexts: ciscoWanFrConnMIB.setLastUpdated('2002-09-18 00:00')
...
frChanCnfGrpTable = MibTable((1, 3, 6, 1, 4, 1, 351, 110, 5, 1, 2, 1, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: frChanCnfGrpTable.setStatus('current')
frChanCnfGrpEntry = MibTableRow((1, 3, 6, 1, 4, 1, 351, 110, 5, 1, 2, 1, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CISCO-WAN-FR-CONN-MIB", "chanNum"))
...
zeroCirConEir = MibTableColumn((1, 3, 6, 1, 4, 1, 351, 110, 5, 1, 2, 1, 1, 1, 58), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 52000000)).clone(0)).setMaxAccess("readwrite")
...
frChanPrefRouteId = MibTableColumn((1, 3, 6, 1, 4, 1, 351, 110, 5, 1, 2, 1, 1, 1, 72), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535)).clone(0)).setMaxAccess("readwrite")
...
frstdABRCnfGrpTable = MibTable((1, 3, 6, 1, 4, 1, 351, 110, 5, 1, 2, 1, 3), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: frstdABRCnfGrpTable.setStatus('current')
frstdABRCnfGrpEntry = MibTableRow((1, 3, 6, 1, 4, 1, 351, 110, 5, 1, 2, 1, 3, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CISCO-WAN-FR-CONN-MIB", "frstdABRcnfChanNum"))
...
frstdABRFRTT = MibTableColumn((1, 3, 6, 1, 4, 1, 351, 110, 5, 1, 2, 1, 3, 1, 3), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 16700)).clone(0)).setUnits('milli-seconds').setMaxAccess("readwrite")
...
frChanStateGrpTable = MibTable((1, 3, 6, 1, 4, 1, 351, 110, 5, 1, 2, 2, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: frChanStateGrpTable.setStatus('current')
frChanStateGrpEntry = MibTableRow((1, 3, 6, 1, 4, 1, 351, 110, 5, 1, 2, 2, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CISCO-WAN-FR-CONN-MIB", "stateChanNum"))
...
frEndPtMapGrpTable = MibTable((1, 3, 6, 1, 4, 1, 351, 110, 5, 1, 3, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: frEndPtMapGrpTable.setStatus('current')
frEndPtMapGrpEntry = MibTableRow((1, 3, 6, 1, 4, 1, 351, 110, 5, 1, 3, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CISCO-WAN-FR-CONN-MIB", "endPortNum"), (0, "CISCO-WAN-FR-CONN-MIB", "endDLCI"))
...
mibBuilder.exportSymbols("CISCO-WAN-FR-CONN-MIB", PYSNMP_MODULE_ID=ciscoWanFrConnMIB, bc=bc, be=be, chanCLPtoDEmap=chanCLPtoDEmap, chanDEtoCLPmap=chanDEtoCLPmap, chanEgrPercentUtil=chanEgrPercentUtil, chanEgrSrvRate=chanEgrSrvRate, chanFECNconfig=chanFECNconfig, chanFrConnType=chanFrConnType, chanIngrPercentUtil=chanIngrPercentUtil, chanLocRmtLpbkState=chanLocRmtLpbkState, chanNum=chanNum, chanNumNextAvailable=chanNumNextAvailable, chanOvrSubOvrRide=chanOvrSubOvrRide, chanPortNum=chanPortNum, chanRTDResult=chanRTDResult, chanReroute=chanReroute, chanRowStatus=chanRowStatus, chanServType=chanServType, chanServiceRate=chanServiceRate, chanServiceRateOverride=chanServiceRateOverride, chanState=chanState, chanStatusBitMap=chanStatusBitMap, chanTestState=chanTestState, chanTestType=chanTestType, chanType=chanType, cir=cir, ciscoWanFrConnABRGroup=ciscoWanFrConnABRGroup, ciscoWanFrConnCompliance=ciscoWanFrConnCompliance, ciscoWanFrConnEndptGroup=ciscoWanFrConnEndptGroup, ciscoWanFrConnForesightGroup=ciscoWanFrConnForesightGroup, ciscoWanFrConnGroup=ciscoWanFrConnGroup, ciscoWanFrConnMIB=ciscoWanFrConnMIB, ciscoWanFrConnMIBCompliances=ciscoWanFrConnMIBCompliances, ciscoWanFrConnMIBConformance=ciscoWanFrConnMIBConformance, ciscoWanFrConnMIBGroups=ciscoWanFrConnMIBGroups, ciscoWanFrConnQueueGroup=ciscoWanFrConnQueueGroup, ciscoWanFrConnStateGroup=ciscoWanFrConnStateGroup, ciscoWanFrConnTestGroup=ciscoWanFrConnTestGroup, dLCI=dLCI, deTaggingEnable=deTaggingEnable, egressQDEThresh=egressQDEThresh, egressQDepth=egressQDepth, egressQECNThresh=egressQECNThresh, egressQSelect=egressQSelect, endChanNum=endChanNum, endDLCI=endDLCI, endLineNum=endLineNum, endPortNum=endPortNum, foreSightEnable=foreSightEnable, frCDRNumber=frCDRNumber, frChanCnfChangeCount=frChanCnfChangeCount, frChanCnfGrp=frChanCnfGrp, frChanCnfGrpEntry=frChanCnfGrpEntry, frChanCnfGrpTable=frChanCnfGrpTable, frChanCnfIgnoreIncomingDE=frChanCnfIgnoreIncomingDE, frChanDirectRoute=frChanDirectRoute, frChanLocalLpbkEnable=frChanLocalLpbkEnable, frChanOamCCEnable=frChanOamCCEnable, frChanPrefRouteId=frChanPrefRouteId, frChanSlaveType=frChanSlaveType, frChanStateGrp=frChanStateGrp, frChanStateGrpEntry=frChanStateGrpEntry, frChanStateGrpTable=frChanStateGrpTable, frChanStatsEnable=frChanStatsEnable, frChanUpcEnable=frChanUpcEnable, frConnAdminStatus=frConnAdminStatus, frConnFGCRAEnable=frConnFGCRAEnable, frConnForeSightEnable=frConnForeSightEnable, frConnMCR=frConnMCR, frConnPCR=frConnPCR, frConnPercentUtil=frConnPercentUtil, frConnRemoteMBS=frConnRemoteMBS, frConnRemoteMCR=frConnRemoteMCR, frConnRemotePCR=frConnRemotePCR, frConnRemotePercentUtil=frConnRemotePercentUtil, frConnRemoteSCR=frConnRemoteSCR, frConnSCR=frConnSCR, frConnServiceType=frConnServiceType, frConnTemplateId=frConnTemplateId, frEndPtMapGrp=frEndPtMapGrp, frEndPtMapGrpEntry=frEndPtMapGrpEntry, frEndPtMapGrpTable=frEndPtMapGrpTable, frLocalNSAP=frLocalNSAP, frLocalVci=frLocalVci, frLocalVpi=frLocalVpi, frMastership=frMastership, frMaxCost=frMaxCost, frRemoteNSAP=frRemoteNSAP, frRemoteVci=frRemoteVci, frRemoteVpi=frRemoteVpi, frRestrictTrunkType=frRestrictTrunkType, frRoutingPriority=frRoutingPriority, frVpcFlag=frVpcFlag, frstdABRADTF=frstdABRADTF, frstdABRCDF=frstdABRCDF, frstdABRCnfGrpEntry=frstdABRCnfGrpEntry, frstdABRCnfGrpTable=frstdABRCnfGrpTable, frstdABRFRTT=frstdABRFRTT, frstdABRICR=frstdABRICR, frstdABRMCR=frstdABRMCR, frstdABRNrm=frstdABRNrm, frstdABRPCR=frstdABRPCR, frstdABRRDF=frstdABRRDF, frstdABRRIF=frstdABRRIF, frstdABRTBE=frstdABRTBE, frstdABRTrm=frstdABRTrm, frstdABRcnfChanNum=frstdABRcnfChanNum, ibs=ibs, ingressQDEThresh=ingressQDEThresh, ingressQDepth=ingressQDepth, ingressQECNThresh=ingressQECNThresh, mir=mir, pir=pir, qir=qir, rcvATMState=rcvATMState, rcvAbitState=rcvAbitState, stateChanNum=stateChanNum, xmtATMState=xmtATMState, xmtAbitState=xmtAbitState, zeroCirConEir=zeroCirConEir)
