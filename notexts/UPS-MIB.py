...
mibBuilder.exportSymbols("UPS-MIB", upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsShutdownType=upsShutdownType, upsBasicOutputGroup=upsBasicOutputGroup, upsInputTable=upsInputTable, upsCompliances=upsCompliances, upsFullAlarmGroup=upsFullAlarmGroup, upsBypass=upsBypass, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBasicBypassGroup=upsBasicBypassGroup, upsInput=upsInput, upsSubsetGroups=upsSubsetGroups, upsAlarmEntry=upsAlarmEntry, upsInputVoltage=upsInputVoltage, upsBatteryTemperature=upsBatteryTemperature, upsAlarmShutdownPending=upsAlarmShutdownPending, upsTrapOnBattery=upsTrapOnBattery, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmTestInProgress=upsAlarmTestInProgress, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsInputLineIndex=upsInputLineIndex, upsTest=upsTest, upsConformance=upsConformance, upsOutputLineIndex=upsOutputLineIndex, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmTable=upsAlarmTable, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsSubsetCompliance=upsSubsetCompliance, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBattery=upsBattery, upsFullControlGroup=upsFullControlGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBatteryCurrent=upsBatteryCurrent, upsInputEntry=upsInputEntry, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmChargerFailed=upsAlarmChargerFailed, upsFullCompliance=upsFullCompliance, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmDescr=upsAlarmDescr, upsBasicCompliance=upsBasicCompliance, upsBypassLineIndex=upsBypassLineIndex, upsTestResultsDetail=upsTestResultsDetail, upsAlarmId=upsAlarmId, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBasicControlGroup=upsBasicControlGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsInputTruePower=upsInputTruePower, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsInputCurrent=upsInputCurrent, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsSubsetConfigGroup=upsSubsetConfigGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsBatteryVoltage=upsBatteryVoltage, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsIdent=upsIdent, upsConfigInputVoltage=upsConfigInputVoltage, upsIdentName=upsIdentName, upsInputLineBads=upsInputLineBads, upsAlarmOutputOverload=upsAlarmOutputOverload, upsGroups=upsGroups, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, PositiveInteger=PositiveInteger, upsAlarmLowBattery=upsAlarmLowBattery, upsInputNumLines=upsInputNumLines, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsFullOutputGroup=upsFullOutputGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBasicInputGroup=upsBasicInputGroup, upsMIB=upsMIB, upsSubsetOutputGroup=upsSubsetOutputGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsConfig=upsConfig, upsTestSpinLock=upsTestSpinLock, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsFullGroups=upsFullGroups, upsBasicBatteryGroup=upsBasicBatteryGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, PYSNMP_MODULE_ID=upsMIB, upsBypassNumLines=upsBypassNumLines, upsOutputEntry=upsOutputEntry, upsConfigOutputVoltage=upsConfigOutputVoltage, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestElapsedTime=upsTestElapsedTime, upsFullTestGroup=upsFullTestGroup, upsTestResultsSummary=upsTestResultsSummary, upsFullConfigGroup=upsFullConfigGroup, upsOutputFrequency=upsOutputFrequency, upsConfigAudibleStatus=upsConfigAudibleStatus, upsObjects=upsObjects, upsBasicTestGroup=upsBasicTestGroup, upsAutoRestart=upsAutoRestart, upsOutputPower=upsOutputPower, NonNegativeInteger=NonNegativeInteger, upsFullBypassGroup=upsFullBypassGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsTestStartTime=upsTestStartTime, upsSubsetIdentGroup=upsSubsetIdentGroup, upsOutputCurrent=upsOutputCurrent, upsAlarm=upsAlarm, upsIdentManufacturer=upsIdentManufacturer, upsSubsetControlGroup=upsSubsetControlGroup, upsOutputSource=upsOutputSource, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmInputBad=upsAlarmInputBad, upsBypassPower=upsBypassPower, upsFullInputGroup=upsFullInputGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBypassVoltage=upsBypassVoltage, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsOutputTable=upsOutputTable, upsTrapTestCompleted=upsTrapTestCompleted, upsBypassCurrent=upsBypassCurrent, upsOutputVoltage=upsOutputVoltage, upsRebootWithDuration=upsRebootWithDuration, upsWellKnownTests=upsWellKnownTests, upsAlarmTempBad=upsAlarmTempBad, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmOnBypass=upsAlarmOnBypass, upsTraps=upsTraps, upsIdentModel=upsIdentModel, upsBatteryStatus=upsBatteryStatus, upsConfigOutputPower=upsConfigOutputPower, upsBypassTable=upsBypassTable, upsOutput=upsOutput, upsControl=upsControl, upsAlarmOutputBad=upsAlarmOutputBad, upsBasicAlarmGroup=upsBasicAlarmGroup, upsConfigOutputVA=upsConfigOutputVA, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsConfigInputFreq=upsConfigInputFreq, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsInputFrequency=upsInputFrequency, upsOutputNumLines=upsOutputNumLines, upsAlarmFanFailure=upsAlarmFanFailure, upsTestId=upsTestId, upsBypassEntry=upsBypassEntry, upsBypassFrequency=upsBypassFrequency, upsBasicGroups=upsBasicGroups, upsAlarmsPresent=upsAlarmsPresent, upsAlarmTime=upsAlarmTime, upsFullIdentGroup=upsFullIdentGroup, upsFullBatteryGroup=upsFullBatteryGroup)
