...
mibBuilder.exportSymbols("UPS-MIB", upsOutputPercentLoad=upsOutputPercentLoad, upsTestStartTime=upsTestStartTime, upsBypassTable=upsBypassTable, upsAlarm=upsAlarm, upsIdentModel=upsIdentModel, upsInputLineBads=upsInputLineBads, upsOutputVoltage=upsOutputVoltage, upsControl=upsControl, upsSubsetConfigGroup=upsSubsetConfigGroup, upsInputVoltage=upsInputVoltage, upsConfig=upsConfig, upsBatteryTemperature=upsBatteryTemperature, upsFullOutputGroup=upsFullOutputGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmShutdownPending=upsAlarmShutdownPending, upsFullBatteryGroup=upsFullBatteryGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsConfigOutputVA=upsConfigOutputVA, upsConfigAudibleStatus=upsConfigAudibleStatus, upsFullConfigGroup=upsFullConfigGroup, upsRebootWithDuration=upsRebootWithDuration, upsShutdownType=upsShutdownType, upsConfigOutputFreq=upsConfigOutputFreq, upsSubsetIdentGroup=upsSubsetIdentGroup, upsFullInputGroup=upsFullInputGroup, upsConformance=upsConformance, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmInputBad=upsAlarmInputBad, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsOutputLineIndex=upsOutputLineIndex, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmBatteryBad=upsAlarmBatteryBad, upsInputFrequency=upsInputFrequency, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsStartupAfterDelay=upsStartupAfterDelay, upsInputTable=upsInputTable, upsBypassVoltage=upsBypassVoltage, upsAlarmId=upsAlarmId, upsTestResultsDetail=upsTestResultsDetail, upsBypassLineIndex=upsBypassLineIndex, upsTestSpinLock=upsTestSpinLock, upsTestElapsedTime=upsTestElapsedTime, upsTraps=upsTraps, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmTime=upsAlarmTime, upsOutputEntry=upsOutputEntry, upsBypassFrequency=upsBypassFrequency, upsAlarmEntry=upsAlarmEntry, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmTestInProgress=upsAlarmTestInProgress, upsIdentName=upsIdentName, upsBasicGroups=upsBasicGroups, upsInputTruePower=upsInputTruePower, upsGroups=upsGroups, upsBasicAlarmGroup=upsBasicAlarmGroup, upsOutput=upsOutput, upsWellKnownTests=upsWellKnownTests, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsConfigLowBattTime=upsConfigLowBattTime, upsOutputNumLines=upsOutputNumLines, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsIdentAttachedDevices=upsIdentAttachedDevices, upsSubsetInputGroup=upsSubsetInputGroup, upsIdent=upsIdent, upsTest=upsTest, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsFullBypassGroup=upsFullBypassGroup, upsAlarmDescr=upsAlarmDescr, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsInputNumLines=upsInputNumLines, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsOutputSource=upsOutputSource, upsTestResultsSummary=upsTestResultsSummary, upsAutoRestart=upsAutoRestart, upsAlarmsPresent=upsAlarmsPresent, upsAlarmFanFailure=upsAlarmFanFailure, upsBattery=upsBattery, upsFullAlarmGroup=upsFullAlarmGroup, upsOutputPower=upsOutputPower, upsAlarmOnBypass=upsAlarmOnBypass, upsInputCurrent=upsInputCurrent, upsBypassEntry=upsBypassEntry, upsBatteryCurrent=upsBatteryCurrent, NonNegativeInteger=NonNegativeInteger, upsConfigOutputPower=upsConfigOutputPower, upsFullGroups=upsFullGroups, upsCompliances=upsCompliances, upsWellKnownAlarms=upsWellKnownAlarms, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmOutputBad=upsAlarmOutputBad, upsBasicInputGroup=upsBasicInputGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsBypassPower=upsBypassPower, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTrapOnBattery=upsTrapOnBattery, upsAlarmTempBad=upsAlarmTempBad, upsBatteryStatus=upsBatteryStatus, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullCompliance=upsFullCompliance, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmBypassBad=upsAlarmBypassBad, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTestId=upsTestId, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBypass=upsBypass, upsMIB=upsMIB, upsBypassNumLines=upsBypassNumLines, upsBasicIdentGroup=upsBasicIdentGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsBasicCompliance=upsBasicCompliance, upsSubsetCompliance=upsSubsetCompliance, upsInputLineIndex=upsInputLineIndex, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBatteryVoltage=upsBatteryVoltage, upsBasicTestGroup=upsBasicTestGroup, upsOutputTable=upsOutputTable, upsAlarmTable=upsAlarmTable, upsBypassCurrent=upsBypassCurrent, upsInputEntry=upsInputEntry, upsTrapTestCompleted=upsTrapTestCompleted, PositiveInteger=PositiveInteger, upsTestNoTestsInitiated=upsTestNoTestsInitiated, PYSNMP_MODULE_ID=upsMIB, upsObjects=upsObjects, upsAlarmOnBattery=upsAlarmOnBattery, upsConfigInputFreq=upsConfigInputFreq, upsBasicBatteryGroup=upsBasicBatteryGroup, upsFullIdentGroup=upsFullIdentGroup, upsBasicControlGroup=upsBasicControlGroup, upsFullTestGroup=upsFullTestGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsOutputFrequency=upsOutputFrequency, upsSubsetOutputGroup=upsSubsetOutputGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsIdentManufacturer=upsIdentManufacturer, upsFullControlGroup=upsFullControlGroup, upsInput=upsInput, upsOutputCurrent=upsOutputCurrent, upsSubsetGroups=upsSubsetGroups)
