...
mibBuilder.exportSymbols("UPS-MIB", upsBasicTestGroup=upsBasicTestGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsObjects=upsObjects, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBatteryTemperature=upsBatteryTemperature, upsSecondsOnBattery=upsSecondsOnBattery, upsBypass=upsBypass, upsConfigOutputVA=upsConfigOutputVA, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsOutputCurrent=upsOutputCurrent, upsAlarmTable=upsAlarmTable, upsFullOutputGroup=upsFullOutputGroup, upsAlarmTime=upsAlarmTime, upsAlarm=upsAlarm, upsTraps=upsTraps, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBasicGroups=upsBasicGroups, upsInputNumLines=upsInputNumLines, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullGroups=upsFullGroups, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsOutput=upsOutput, upsShutdownType=upsShutdownType, upsShutdownAfterDelay=upsShutdownAfterDelay, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsControl=upsControl, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTestSpinLock=upsTestSpinLock, upsInputVoltage=upsInputVoltage, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBypassVoltage=upsBypassVoltage, upsBatteryCurrent=upsBatteryCurrent, upsBatteryVoltage=upsBatteryVoltage, upsBasicInputGroup=upsBasicInputGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsTestId=upsTestId, upsFullTestGroup=upsFullTestGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsOutputLineIndex=upsOutputLineIndex, upsRebootWithDuration=upsRebootWithDuration, upsConfigOutputPower=upsConfigOutputPower, upsWellKnownAlarms=upsWellKnownAlarms, upsConfigLowBattTime=upsConfigLowBattTime, upsConfigOutputVoltage=upsConfigOutputVoltage, upsOutputPercentLoad=upsOutputPercentLoad, PYSNMP_MODULE_ID=upsMIB, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBypassEntry=upsBypassEntry, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConfigInputFreq=upsConfigInputFreq, upsTrapTestCompleted=upsTrapTestCompleted, upsBasicControlGroup=upsBasicControlGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmsPresent=upsAlarmsPresent, upsOutputTable=upsOutputTable, upsTestResultsDetail=upsTestResultsDetail, upsSubsetGroups=upsSubsetGroups, upsInputTable=upsInputTable, upsFullControlGroup=upsFullControlGroup, upsInputLineBads=upsInputLineBads, upsTestElapsedTime=upsTestElapsedTime, upsAlarmInputBad=upsAlarmInputBad, upsBypassNumLines=upsBypassNumLines, upsInputLineIndex=upsInputLineIndex, upsFullConfigGroup=upsFullConfigGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsFullBatteryGroup=upsFullBatteryGroup, upsInput=upsInput, upsConfigOutputFreq=upsConfigOutputFreq, upsGroups=upsGroups, upsBasicCompliance=upsBasicCompliance, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsFullBypassGroup=upsFullBypassGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmOutputBad=upsAlarmOutputBad, upsFullInputGroup=upsFullInputGroup, upsOutputPower=upsOutputPower, upsBypassCurrent=upsBypassCurrent, upsAutoRestart=upsAutoRestart, upsMIB=upsMIB, upsInputTruePower=upsInputTruePower, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsOutputNumLines=upsOutputNumLines, upsOutputFrequency=upsOutputFrequency, upsTestResultsSummary=upsTestResultsSummary, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmTempBad=upsAlarmTempBad, upsFullCompliance=upsFullCompliance, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBypassPower=upsBypassPower, upsAlarmFuseFailure=upsAlarmFuseFailure, upsWellKnownTests=upsWellKnownTests, upsAlarmBatteryBad=upsAlarmBatteryBad, upsIdentName=upsIdentName, upsBasicIdentGroup=upsBasicIdentGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsIdentModel=upsIdentModel, upsBypassFrequency=upsBypassFrequency, upsBasicConfigGroup=upsBasicConfigGroup, upsBypassTable=upsBypassTable, upsBypassLineIndex=upsBypassLineIndex, upsInputCurrent=upsInputCurrent, PositiveInteger=PositiveInteger, upsInputEntry=upsInputEntry, upsOutputVoltage=upsOutputVoltage, NonNegativeInteger=NonNegativeInteger, upsTest=upsTest, upsInputFrequency=upsInputFrequency, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmId=upsAlarmId, upsSubsetInputGroup=upsSubsetInputGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsIdentManufacturer=upsIdentManufacturer, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsOutputEntry=upsOutputEntry, upsOutputSource=upsOutputSource, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsConformance=upsConformance, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsTestStartTime=upsTestStartTime, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsCompliances=upsCompliances, upsSubsetCompliance=upsSubsetCompliance, upsAlarmDescr=upsAlarmDescr, upsBattery=upsBattery, upsAlarmBypassBad=upsAlarmBypassBad, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBatteryStatus=upsBatteryStatus, upsStartupAfterDelay=upsStartupAfterDelay, upsTrapOnBattery=upsTrapOnBattery, upsFullIdentGroup=upsFullIdentGroup, upsIdent=upsIdent, upsAlarmEntry=upsAlarmEntry, upsBasicOutputGroup=upsBasicOutputGroup, upsConfig=upsConfig)
