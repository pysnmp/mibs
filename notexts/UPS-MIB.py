...
mibBuilder.exportSymbols("UPS-MIB", upsBypassTable=upsBypassTable, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBypassCurrent=upsBypassCurrent, upsTestStartTime=upsTestStartTime, NonNegativeInteger=NonNegativeInteger, upsAlarmInputBad=upsAlarmInputBad, upsRebootWithDuration=upsRebootWithDuration, upsMIB=upsMIB, upsAlarmShutdownPending=upsAlarmShutdownPending, upsOutputEntry=upsOutputEntry, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsInputVoltage=upsInputVoltage, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmChargerFailed=upsAlarmChargerFailed, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBatteryVoltage=upsBatteryVoltage, upsBypass=upsBypass, upsControl=upsControl, upsConfig=upsConfig, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBypassNumLines=upsBypassNumLines, upsBypassFrequency=upsBypassFrequency, upsFullInputGroup=upsFullInputGroup, upsOutputTable=upsOutputTable, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmTestInProgress=upsAlarmTestInProgress, upsFullCompliance=upsFullCompliance, upsFullControlGroup=upsFullControlGroup, upsBattery=upsBattery, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsInputTable=upsInputTable, upsAlarmTime=upsAlarmTime, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBypassPower=upsBypassPower, upsAlarmDescr=upsAlarmDescr, upsAlarmBypassBad=upsAlarmBypassBad, upsSubsetCompliance=upsSubsetCompliance, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTraps=upsTraps, upsTestId=upsTestId, upsBatteryStatus=upsBatteryStatus, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmTable=upsAlarmTable, upsTestElapsedTime=upsTestElapsedTime, upsTrapTestCompleted=upsTrapTestCompleted, upsGroups=upsGroups, upsAlarmEntry=upsAlarmEntry, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsSubsetInputGroup=upsSubsetInputGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsOutputSource=upsOutputSource, upsBasicConfigGroup=upsBasicConfigGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsIdentManufacturer=upsIdentManufacturer, upsConformance=upsConformance, upsAlarmOutputOverload=upsAlarmOutputOverload, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmsPresent=upsAlarmsPresent, upsBasicGroups=upsBasicGroups, upsOutputPower=upsOutputPower, upsAlarmLowBattery=upsAlarmLowBattery, upsTestResultsSummary=upsTestResultsSummary, upsSubsetOutputGroup=upsSubsetOutputGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBasicIdentGroup=upsBasicIdentGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBatteryTemperature=upsBatteryTemperature, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBasicCompliance=upsBasicCompliance, upsWellKnownTests=upsWellKnownTests, upsOutputNumLines=upsOutputNumLines, PositiveInteger=PositiveInteger, upsOutputPercentLoad=upsOutputPercentLoad, upsInputEntry=upsInputEntry, upsBasicTestGroup=upsBasicTestGroup, upsInputCurrent=upsInputCurrent, upsShutdownType=upsShutdownType, upsInputFrequency=upsInputFrequency, upsAlarmTempBad=upsAlarmTempBad, upsOutputCurrent=upsOutputCurrent, upsFullTestGroup=upsFullTestGroup, upsBypassEntry=upsBypassEntry, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsInputLineIndex=upsInputLineIndex, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsFullConfigGroup=upsFullConfigGroup, upsSubsetGroups=upsSubsetGroups, upsTrapOnBattery=upsTrapOnBattery, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTestSpinLock=upsTestSpinLock, upsTest=upsTest, upsIdentName=upsIdentName, upsAlarmOutputBad=upsAlarmOutputBad, upsConfigInputVoltage=upsConfigInputVoltage, upsBypassVoltage=upsBypassVoltage, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsIdentModel=upsIdentModel, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsConfigLowBattTime=upsConfigLowBattTime, upsShutdownAfterDelay=upsShutdownAfterDelay, upsConfigOutputPower=upsConfigOutputPower, PYSNMP_MODULE_ID=upsMIB, upsAlarmFanFailure=upsAlarmFanFailure, upsConfigOutputVA=upsConfigOutputVA, upsObjects=upsObjects, upsAlarm=upsAlarm, upsBasicInputGroup=upsBasicInputGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmId=upsAlarmId, upsBypassLineIndex=upsBypassLineIndex, upsConfigOutputVoltage=upsConfigOutputVoltage, upsCompliances=upsCompliances, upsBasicControlGroup=upsBasicControlGroup, upsIdent=upsIdent, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsFullAlarmGroup=upsFullAlarmGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsTestResultsDetail=upsTestResultsDetail, upsFullGroups=upsFullGroups, upsConfigInputFreq=upsConfigInputFreq, upsInputNumLines=upsInputNumLines, upsAlarmGeneralFault=upsAlarmGeneralFault, upsInput=upsInput, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmBatteryBad=upsAlarmBatteryBad, upsOutputVoltage=upsOutputVoltage, upsFullIdentGroup=upsFullIdentGroup, upsFullBypassGroup=upsFullBypassGroup, upsInputTruePower=upsInputTruePower, upsBatteryCurrent=upsBatteryCurrent, upsInputLineBads=upsInputLineBads, upsFullOutputGroup=upsFullOutputGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsOutputLineIndex=upsOutputLineIndex, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsOutputFrequency=upsOutputFrequency, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsOutput=upsOutput, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsConfigOutputFreq=upsConfigOutputFreq, upsFullBatteryGroup=upsFullBatteryGroup, upsAutoRestart=upsAutoRestart)
