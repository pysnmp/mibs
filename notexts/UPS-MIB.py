...
mibBuilder.exportSymbols("UPS-MIB", upsConfigLowBattTime=upsConfigLowBattTime, upsTestResultsSummary=upsTestResultsSummary, upsBypassTable=upsBypassTable, upsAutoRestart=upsAutoRestart, upsAlarmShutdownPending=upsAlarmShutdownPending, upsOutputTable=upsOutputTable, upsFullControlGroup=upsFullControlGroup, upsBatteryVoltage=upsBatteryVoltage, upsInput=upsInput, upsWellKnownAlarms=upsWellKnownAlarms, upsFullInputGroup=upsFullInputGroup, upsAlarmDescr=upsAlarmDescr, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmEntry=upsAlarmEntry, upsAlarmTime=upsAlarmTime, upsTraps=upsTraps, upsAlarmTempBad=upsAlarmTempBad, upsGroups=upsGroups, upsBasicControlGroup=upsBasicControlGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsShutdownType=upsShutdownType, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmFanFailure=upsAlarmFanFailure, upsIdentManufacturer=upsIdentManufacturer, upsMIB=upsMIB, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsInputLineBads=upsInputLineBads, upsOutputNumLines=upsOutputNumLines, upsBypassLineIndex=upsBypassLineIndex, upsBasicCompliance=upsBasicCompliance, upsAlarmGeneralFault=upsAlarmGeneralFault, upsConfig=upsConfig, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsFullTestGroup=upsFullTestGroup, upsBypassNumLines=upsBypassNumLines, NonNegativeInteger=NonNegativeInteger, upsBypassPower=upsBypassPower, upsTestSpinLock=upsTestSpinLock, upsTrapOnBattery=upsTrapOnBattery, upsFullBatteryGroup=upsFullBatteryGroup, upsBypassVoltage=upsBypassVoltage, upsTestId=upsTestId, upsTestStartTime=upsTestStartTime, upsBatteryCurrent=upsBatteryCurrent, upsOutputEntry=upsOutputEntry, upsAlarmTable=upsAlarmTable, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsConfigInputFreq=upsConfigInputFreq, upsConfigOutputPower=upsConfigOutputPower, PositiveInteger=PositiveInteger, upsInputLineIndex=upsInputLineIndex, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullCompliance=upsFullCompliance, upsFullConfigGroup=upsFullConfigGroup, upsBattery=upsBattery, upsTestElapsedTime=upsTestElapsedTime, upsAlarm=upsAlarm, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicInputGroup=upsBasicInputGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsBasicTestGroup=upsBasicTestGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsConfigInputVoltage=upsConfigInputVoltage, upsSecondsOnBattery=upsSecondsOnBattery, upsBasicIdentGroup=upsBasicIdentGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmOnBypass=upsAlarmOnBypass, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmsPresent=upsAlarmsPresent, upsSubsetCompliance=upsSubsetCompliance, upsControl=upsControl, upsWellKnownTests=upsWellKnownTests, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsConfigOutputVA=upsConfigOutputVA, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsInputFrequency=upsInputFrequency, upsSubsetGroups=upsSubsetGroups, upsTest=upsTest, upsOutput=upsOutput, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBatteryTemperature=upsBatteryTemperature, upsInputCurrent=upsInputCurrent, upsInputTable=upsInputTable, upsTrapTestCompleted=upsTrapTestCompleted, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsInputNumLines=upsInputNumLines, upsBypassEntry=upsBypassEntry, upsInputVoltage=upsInputVoltage, PYSNMP_MODULE_ID=upsMIB, upsAlarmInputBad=upsAlarmInputBad, upsRebootWithDuration=upsRebootWithDuration, upsShutdownAfterDelay=upsShutdownAfterDelay, upsFullBypassGroup=upsFullBypassGroup, upsInputEntry=upsInputEntry, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullIdentGroup=upsFullIdentGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmOutputOverload=upsAlarmOutputOverload, upsObjects=upsObjects, upsOutputCurrent=upsOutputCurrent, upsBypassCurrent=upsBypassCurrent, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypass=upsBypass, upsFullOutputGroup=upsFullOutputGroup, upsAlarmId=upsAlarmId, upsBypassFrequency=upsBypassFrequency, upsCompliances=upsCompliances, upsConfigAudibleStatus=upsConfigAudibleStatus, upsOutputSource=upsOutputSource, upsBasicOutputGroup=upsBasicOutputGroup, upsTestResultsDetail=upsTestResultsDetail, upsOutputLineIndex=upsOutputLineIndex, upsOutputVoltage=upsOutputVoltage, upsInputTruePower=upsInputTruePower, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsIdent=upsIdent, upsIdentModel=upsIdentModel, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmBypassBad=upsAlarmBypassBad, upsOutputFrequency=upsOutputFrequency, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBatteryStatus=upsBatteryStatus, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsConformance=upsConformance, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConfigOutputFreq=upsConfigOutputFreq, upsIdentName=upsIdentName, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsFullGroups=upsFullGroups, upsFullAlarmGroup=upsFullAlarmGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsIdentAttachedDevices=upsIdentAttachedDevices, upsOutputPower=upsOutputPower, upsBasicGroups=upsBasicGroups)
