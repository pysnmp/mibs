...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmOutputBad=upsAlarmOutputBad, upsInput=upsInput, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmFanFailure=upsAlarmFanFailure, upsInputEntry=upsInputEntry, upsBypassLineIndex=upsBypassLineIndex, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmShutdownPending=upsAlarmShutdownPending, upsFullTestGroup=upsFullTestGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsOutputNumLines=upsOutputNumLines, upsAlarmId=upsAlarmId, upsAlarmEntry=upsAlarmEntry, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsConfigOutputFreq=upsConfigOutputFreq, upsBasicConfigGroup=upsBasicConfigGroup, PositiveInteger=PositiveInteger, upsGroups=upsGroups, upsFullConfigGroup=upsFullConfigGroup, upsShutdownType=upsShutdownType, PYSNMP_MODULE_ID=upsMIB, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmOnBypass=upsAlarmOnBypass, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsSubsetGroups=upsSubsetGroups, upsTestStartTime=upsTestStartTime, upsTrapOnBattery=upsTrapOnBattery, upsObjects=upsObjects, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsConfig=upsConfig, upsBypassPower=upsBypassPower, upsOutputPower=upsOutputPower, upsIdentManufacturer=upsIdentManufacturer, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsWellKnownTests=upsWellKnownTests, upsOutputSource=upsOutputSource, upsBypass=upsBypass, upsAlarmTempBad=upsAlarmTempBad, upsAlarmsPresent=upsAlarmsPresent, upsBypassNumLines=upsBypassNumLines, upsFullBatteryGroup=upsFullBatteryGroup, upsBasicGroups=upsBasicGroups, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsInputTable=upsInputTable, upsAlarmTestInProgress=upsAlarmTestInProgress, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsConfigOutputPower=upsConfigOutputPower, upsSubsetOutputGroup=upsSubsetOutputGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTestSpinLock=upsTestSpinLock, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmOutputOverload=upsAlarmOutputOverload, upsConformance=upsConformance, upsAutoRestart=upsAutoRestart, upsBypassVoltage=upsBypassVoltage, upsBasicTestGroup=upsBasicTestGroup, upsOutputLineIndex=upsOutputLineIndex, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsOutputCurrent=upsOutputCurrent, upsAlarmBatteryBad=upsAlarmBatteryBad, upsSubsetIdentGroup=upsSubsetIdentGroup, upsFullIdentGroup=upsFullIdentGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsFullGroups=upsFullGroups, NonNegativeInteger=NonNegativeInteger, upsStartupAfterDelay=upsStartupAfterDelay, upsFullCompliance=upsFullCompliance, upsControl=upsControl, upsOutput=upsOutput, upsInputLineIndex=upsInputLineIndex, upsSecondsOnBattery=upsSecondsOnBattery, upsBasicCompliance=upsBasicCompliance, upsConfigOutputVA=upsConfigOutputVA, upsInputFrequency=upsInputFrequency, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsWellKnownAlarms=upsWellKnownAlarms, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsConfigOutputVoltage=upsConfigOutputVoltage, upsIdentModel=upsIdentModel, upsFullOutputGroup=upsFullOutputGroup, upsFullInputGroup=upsFullInputGroup, upsBatteryCurrent=upsBatteryCurrent, upsFullControlGroup=upsFullControlGroup, upsAlarmDescr=upsAlarmDescr, upsAlarm=upsAlarm, upsTestId=upsTestId, upsAlarmInputBad=upsAlarmInputBad, upsSubsetInputGroup=upsSubsetInputGroup, upsIdentName=upsIdentName, upsTestResultsSummary=upsTestResultsSummary, upsTestElapsedTime=upsTestElapsedTime, upsBypassTable=upsBypassTable, upsOutputVoltage=upsOutputVoltage, upsInputNumLines=upsInputNumLines, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmTime=upsAlarmTime, upsTraps=upsTraps, upsInputTruePower=upsInputTruePower, upsConfigInputFreq=upsConfigInputFreq, upsOutputEntry=upsOutputEntry, upsBatteryTemperature=upsBatteryTemperature, upsTest=upsTest, upsBattery=upsBattery, upsShutdownAfterDelay=upsShutdownAfterDelay, upsRebootWithDuration=upsRebootWithDuration, upsBatteryStatus=upsBatteryStatus, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsOutputPercentLoad=upsOutputPercentLoad, upsTestResultsDetail=upsTestResultsDetail, upsBypassEntry=upsBypassEntry, upsOutputFrequency=upsOutputFrequency, upsInputLineBads=upsInputLineBads, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBasicControlGroup=upsBasicControlGroup, upsInputCurrent=upsInputCurrent, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBypassFrequency=upsBypassFrequency, upsBasicBypassGroup=upsBasicBypassGroup, upsSubsetCompliance=upsSubsetCompliance, upsBasicOutputGroup=upsBasicOutputGroup, upsBypassCurrent=upsBypassCurrent, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmFuseFailure=upsAlarmFuseFailure, upsIdent=upsIdent, upsAlarmTable=upsAlarmTable, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBasicIdentGroup=upsBasicIdentGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsFullBypassGroup=upsFullBypassGroup, upsInputVoltage=upsInputVoltage, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmOnBattery=upsAlarmOnBattery, upsBatteryVoltage=upsBatteryVoltage, upsBasicInputGroup=upsBasicInputGroup, upsMIB=upsMIB, upsSubsetConfigGroup=upsSubsetConfigGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsOutputTable=upsOutputTable, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsCompliances=upsCompliances)
