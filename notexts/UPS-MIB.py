...
mibBuilder.exportSymbols("UPS-MIB", upsTestSpinLock=upsTestSpinLock, upsShutdownType=upsShutdownType, upsIdentManufacturer=upsIdentManufacturer, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTrapOnBattery=upsTrapOnBattery, upsBatteryStatus=upsBatteryStatus, upsInputCurrent=upsInputCurrent, upsOutputCurrent=upsOutputCurrent, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsOutputPower=upsOutputPower, upsSecondsOnBattery=upsSecondsOnBattery, upsBasicGroups=upsBasicGroups, upsInputVoltage=upsInputVoltage, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsFullTestGroup=upsFullTestGroup, upsInputEntry=upsInputEntry, upsWellKnownTests=upsWellKnownTests, upsBasicControlGroup=upsBasicControlGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsOutputPercentLoad=upsOutputPercentLoad, upsConfigOutputPower=upsConfigOutputPower, upsBasicOutputGroup=upsBasicOutputGroup, upsSubsetGroups=upsSubsetGroups, upsBatteryVoltage=upsBatteryVoltage, upsOutputLineIndex=upsOutputLineIndex, upsAlarmTime=upsAlarmTime, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetCompliance=upsSubsetCompliance, upsBasicBypassGroup=upsBasicBypassGroup, upsOutputFrequency=upsOutputFrequency, upsBasicIdentGroup=upsBasicIdentGroup, upsBasicInputGroup=upsBasicInputGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTestElapsedTime=upsTestElapsedTime, upsBypassCurrent=upsBypassCurrent, upsConfig=upsConfig, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsShutdownAfterDelay=upsShutdownAfterDelay, upsSubsetConfigGroup=upsSubsetConfigGroup, upsRebootWithDuration=upsRebootWithDuration, upsOutputNumLines=upsOutputNumLines, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBypassPower=upsBypassPower, upsAlarmsPresent=upsAlarmsPresent, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsSubsetControlGroup=upsSubsetControlGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsInputFrequency=upsInputFrequency, upsConfigOutputVA=upsConfigOutputVA, upsBypassLineIndex=upsBypassLineIndex, upsCompliances=upsCompliances, upsIdentModel=upsIdentModel, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBypassVoltage=upsBypassVoltage, upsBypass=upsBypass, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsTrapTestCompleted=upsTrapTestCompleted, upsMIB=upsMIB, upsIdentName=upsIdentName, upsBypassNumLines=upsBypassNumLines, upsBasicAlarmGroup=upsBasicAlarmGroup, upsFullGroups=upsFullGroups, upsAlarmTempBad=upsAlarmTempBad, upsTestResultsDetail=upsTestResultsDetail, upsSubsetOutputGroup=upsSubsetOutputGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmLowBattery=upsAlarmLowBattery, upsObjects=upsObjects, upsAlarmInputBad=upsAlarmInputBad, upsBattery=upsBattery, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsConfigAudibleStatus=upsConfigAudibleStatus, upsGroups=upsGroups, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmOnBypass=upsAlarmOnBypass, upsFullIdentGroup=upsFullIdentGroup, upsTest=upsTest, NonNegativeInteger=NonNegativeInteger, upsAlarmEntry=upsAlarmEntry, upsBypassTable=upsBypassTable, upsBasicCompliance=upsBasicCompliance, upsStartupAfterDelay=upsStartupAfterDelay, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigInputFreq=upsConfigInputFreq, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsFullBypassGroup=upsFullBypassGroup, upsAutoRestart=upsAutoRestart, upsFullOutputGroup=upsFullOutputGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsInputLineIndex=upsInputLineIndex, upsFullCompliance=upsFullCompliance, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBatteryTemperature=upsBatteryTemperature, upsAlarmOutputBad=upsAlarmOutputBad, upsBasicTestGroup=upsBasicTestGroup, upsInputLineBads=upsInputLineBads, upsFullAlarmGroup=upsFullAlarmGroup, upsTestStartTime=upsTestStartTime, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBypassEntry=upsBypassEntry, upsConformance=upsConformance, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsFullConfigGroup=upsFullConfigGroup, upsOutputVoltage=upsOutputVoltage, upsInputTable=upsInputTable, upsAlarmId=upsAlarmId, upsAlarmDescr=upsAlarmDescr, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmBypassBad=upsAlarmBypassBad, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsConfigInputVoltage=upsConfigInputVoltage, PYSNMP_MODULE_ID=upsMIB, upsOutputEntry=upsOutputEntry, upsControl=upsControl, upsInput=upsInput, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsInputNumLines=upsInputNumLines, upsOutput=upsOutput, upsOutputSource=upsOutputSource, upsTestId=upsTestId, upsIdent=upsIdent, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsInputTruePower=upsInputTruePower, upsAlarm=upsAlarm, upsFullInputGroup=upsFullInputGroup, upsAlarmTable=upsAlarmTable, upsAlarmChargerFailed=upsAlarmChargerFailed, upsSubsetInputGroup=upsSubsetInputGroup, upsTestResultsSummary=upsTestResultsSummary, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBatteryCurrent=upsBatteryCurrent, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsFullControlGroup=upsFullControlGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsTraps=upsTraps, PositiveInteger=PositiveInteger, upsOutputTable=upsOutputTable, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBypassFrequency=upsBypassFrequency)
