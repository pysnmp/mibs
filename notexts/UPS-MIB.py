...
mibBuilder.exportSymbols("UPS-MIB", upsFullIdentGroup=upsFullIdentGroup, upsBypass=upsBypass, upsFullBatteryGroup=upsFullBatteryGroup, upsTestResultsDetail=upsTestResultsDetail, upsBypassPower=upsBypassPower, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBatteryVoltage=upsBatteryVoltage, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsInputTruePower=upsInputTruePower, upsAlarmOnBypass=upsAlarmOnBypass, upsShutdownAfterDelay=upsShutdownAfterDelay, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBattery=upsBattery, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTraps=upsTraps, upsBasicConfigGroup=upsBasicConfigGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, PYSNMP_MODULE_ID=upsMIB, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsSubsetGroups=upsSubsetGroups, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsFullTestGroup=upsFullTestGroup, upsTrapOnBattery=upsTrapOnBattery, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsOutputVoltage=upsOutputVoltage, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsWellKnownAlarms=upsWellKnownAlarms, upsBasicGroups=upsBasicGroups, upsAlarmOnBattery=upsAlarmOnBattery, upsConfigLowBattTime=upsConfigLowBattTime, upsFullCompliance=upsFullCompliance, upsShutdownType=upsShutdownType, upsConfigInputVoltage=upsConfigInputVoltage, upsBypassNumLines=upsBypassNumLines, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTestResultsSummary=upsTestResultsSummary, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmFanFailure=upsAlarmFanFailure, NonNegativeInteger=NonNegativeInteger, upsIdentName=upsIdentName, upsBasicInputGroup=upsBasicInputGroup, upsOutputPower=upsOutputPower, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBatteryCurrent=upsBatteryCurrent, upsInputLineIndex=upsInputLineIndex, upsFullBypassGroup=upsFullBypassGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmBypassBad=upsAlarmBypassBad, upsConfigOutputPower=upsConfigOutputPower, upsInputVoltage=upsInputVoltage, upsAlarmLowBattery=upsAlarmLowBattery, upsBasicTestGroup=upsBasicTestGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsBatteryStatus=upsBatteryStatus, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsFullOutputGroup=upsFullOutputGroup, upsOutputFrequency=upsOutputFrequency, upsAlarmId=upsAlarmId, upsAlarmTime=upsAlarmTime, upsIdent=upsIdent, upsInputTable=upsInputTable, upsAlarmTempBad=upsAlarmTempBad, upsBypassTable=upsBypassTable, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmTable=upsAlarmTable, upsBasicIdentGroup=upsBasicIdentGroup, upsBypassVoltage=upsBypassVoltage, upsSubsetCompliance=upsSubsetCompliance, upsTestStartTime=upsTestStartTime, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmDescr=upsAlarmDescr, upsBypassCurrent=upsBypassCurrent, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTrapTestCompleted=upsTrapTestCompleted, upsSubsetConfigGroup=upsSubsetConfigGroup, upsConformance=upsConformance, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsTest=upsTest, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsConfigOutputFreq=upsConfigOutputFreq, upsTestSpinLock=upsTestSpinLock, upsIdentManufacturer=upsIdentManufacturer, upsAlarm=upsAlarm, upsBasicControlGroup=upsBasicControlGroup, PositiveInteger=PositiveInteger, upsFullControlGroup=upsFullControlGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsInputFrequency=upsInputFrequency, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestId=upsTestId, upsInputNumLines=upsInputNumLines, upsStartupAfterDelay=upsStartupAfterDelay, upsConfigAudibleStatus=upsConfigAudibleStatus, upsOutputPercentLoad=upsOutputPercentLoad, upsBypassFrequency=upsBypassFrequency, upsAlarmGeneralFault=upsAlarmGeneralFault, upsConfigOutputVA=upsConfigOutputVA, upsSubsetInputGroup=upsSubsetInputGroup, upsMIB=upsMIB, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBypassEntry=upsBypassEntry, upsBasicBypassGroup=upsBasicBypassGroup, upsFullInputGroup=upsFullInputGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsInputCurrent=upsInputCurrent, upsConfigInputFreq=upsConfigInputFreq, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsWellKnownTests=upsWellKnownTests, upsAutoRestart=upsAutoRestart, upsSecondsOnBattery=upsSecondsOnBattery, upsInput=upsInput, upsSubsetIdentGroup=upsSubsetIdentGroup, upsInputEntry=upsInputEntry, upsAlarmsPresent=upsAlarmsPresent, upsTestElapsedTime=upsTestElapsedTime, upsIdentModel=upsIdentModel, upsCompliances=upsCompliances, upsOutput=upsOutput, upsBasicOutputGroup=upsBasicOutputGroup, upsBatteryTemperature=upsBatteryTemperature, upsAlarmChargerFailed=upsAlarmChargerFailed, upsFullConfigGroup=upsFullConfigGroup, upsAlarmEntry=upsAlarmEntry, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsRebootWithDuration=upsRebootWithDuration, upsBasicCompliance=upsBasicCompliance, upsInputLineBads=upsInputLineBads, upsOutputLineIndex=upsOutputLineIndex, upsBypassLineIndex=upsBypassLineIndex, upsOutputCurrent=upsOutputCurrent, upsGroups=upsGroups, upsOutputTable=upsOutputTable, upsConfig=upsConfig, upsAlarmInputBad=upsAlarmInputBad, upsBasicBatteryGroup=upsBasicBatteryGroup, upsControl=upsControl, upsOutputNumLines=upsOutputNumLines, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsObjects=upsObjects, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsOutputSource=upsOutputSource, upsFullGroups=upsFullGroups, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsOutputEntry=upsOutputEntry, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration)
