...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:36:19 2024
...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmOutputBad=upsAlarmOutputBad, upsFullGroups=upsFullGroups, upsTestResultsDetail=upsTestResultsDetail, upsTestId=upsTestId, upsBatteryTemperature=upsBatteryTemperature, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutputCurrent=upsOutputCurrent, upsBasicOutputGroup=upsBasicOutputGroup, upsFullConfigGroup=upsFullConfigGroup, upsBypassNumLines=upsBypassNumLines, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmsPresent=upsAlarmsPresent, upsOutputPower=upsOutputPower, upsTestElapsedTime=upsTestElapsedTime, upsTest=upsTest, upsIdentManufacturer=upsIdentManufacturer, upsAlarmBypassBad=upsAlarmBypassBad, upsConfigInputFreq=upsConfigInputFreq, upsFullInputGroup=upsFullInputGroup, upsConfig=upsConfig, upsInputVoltage=upsInputVoltage, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmBatteryBad=upsAlarmBatteryBad, PositiveInteger=PositiveInteger, upsTestResultsSummary=upsTestResultsSummary, upsInputTable=upsInputTable, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmOutputOverload=upsAlarmOutputOverload, upsMIB=upsMIB, upsShutdownAfterDelay=upsShutdownAfterDelay, upsFullControlGroup=upsFullControlGroup, upsAlarmDescr=upsAlarmDescr, upsOutputNumLines=upsOutputNumLines, upsConformance=upsConformance, upsTestSpinLock=upsTestSpinLock, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmFanFailure=upsAlarmFanFailure, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmInputBad=upsAlarmInputBad, upsOutputEntry=upsOutputEntry, upsOutputSource=upsOutputSource, upsBasicControlGroup=upsBasicControlGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAutoRestart=upsAutoRestart, upsSecondsOnBattery=upsSecondsOnBattery, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarm=upsAlarm, upsBatteryCurrent=upsBatteryCurrent, upsFullAlarmGroup=upsFullAlarmGroup, upsTrapOnBattery=upsTrapOnBattery, upsBypassCurrent=upsBypassCurrent, upsIdent=upsIdent, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsOutput=upsOutput, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigOutputVA=upsConfigOutputVA, upsSubsetConfigGroup=upsSubsetConfigGroup, upsOutputLineIndex=upsOutputLineIndex, upsFullTestGroup=upsFullTestGroup, upsFullBypassGroup=upsFullBypassGroup, upsInput=upsInput, upsBypassEntry=upsBypassEntry, upsAlarmFuseFailure=upsAlarmFuseFailure, upsFullCompliance=upsFullCompliance, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBypass=upsBypass, upsBasicGroups=upsBasicGroups, upsGroups=upsGroups, upsTrapTestCompleted=upsTrapTestCompleted, upsBatteryVoltage=upsBatteryVoltage, upsInputTruePower=upsInputTruePower, upsAlarmTable=upsAlarmTable, upsAlarmTime=upsAlarmTime, upsInputLineIndex=upsInputLineIndex, upsStartupAfterDelay=upsStartupAfterDelay, upsInputCurrent=upsInputCurrent, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTraps=upsTraps, upsBypassLineIndex=upsBypassLineIndex, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBattery=upsBattery, upsObjects=upsObjects, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBasicInputGroup=upsBasicInputGroup, upsFullIdentGroup=upsFullIdentGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBasicCompliance=upsBasicCompliance, upsOutputVoltage=upsOutputVoltage, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmLowBattery=upsAlarmLowBattery, upsInputEntry=upsInputEntry, upsOutputTable=upsOutputTable, upsConfigOutputPower=upsConfigOutputPower, upsTestStartTime=upsTestStartTime, upsRebootWithDuration=upsRebootWithDuration, upsInputNumLines=upsInputNumLines, upsBasicTestGroup=upsBasicTestGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsIdentModel=upsIdentModel, upsBypassPower=upsBypassPower, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, NonNegativeInteger=NonNegativeInteger, upsAlarmTempBad=upsAlarmTempBad, PYSNMP_MODULE_ID=upsMIB, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBypassTable=upsBypassTable, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmOnBypass=upsAlarmOnBypass, upsSubsetCompliance=upsSubsetCompliance, upsControl=upsControl, upsCompliances=upsCompliances, upsBypassVoltage=upsBypassVoltage, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsWellKnownTests=upsWellKnownTests, upsSubsetControlGroup=upsSubsetControlGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsInputFrequency=upsInputFrequency, upsOutputFrequency=upsOutputFrequency, upsInputLineBads=upsInputLineBads, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmId=upsAlarmId, upsConfigLowBattTime=upsConfigLowBattTime, upsSubsetGroups=upsSubsetGroups, upsBasicConfigGroup=upsBasicConfigGroup, upsFullOutputGroup=upsFullOutputGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmShutdownPending=upsAlarmShutdownPending, upsFullBatteryGroup=upsFullBatteryGroup, upsBatteryStatus=upsBatteryStatus, upsAlarmEntry=upsAlarmEntry, upsShutdownType=upsShutdownType, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsConfigInputVoltage=upsConfigInputVoltage, upsBypassFrequency=upsBypassFrequency, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsIdentName=upsIdentName, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsIdentAttachedDevices=upsIdentAttachedDevices)
