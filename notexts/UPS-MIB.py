...
mibBuilder.exportSymbols("UPS-MIB", PYSNMP_MODULE_ID=upsMIB, upsObjects=upsObjects, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsBasicControlGroup=upsBasicControlGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsInputVoltage=upsInputVoltage, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBatteryTemperature=upsBatteryTemperature, upsAutoRestart=upsAutoRestart, upsFullAlarmGroup=upsFullAlarmGroup, upsIdentManufacturer=upsIdentManufacturer, upsConfigOutputPower=upsConfigOutputPower, upsFullBypassGroup=upsFullBypassGroup, upsAlarm=upsAlarm, upsBypassEntry=upsBypassEntry, upsBasicGroups=upsBasicGroups, upsBypassPower=upsBypassPower, upsFullInputGroup=upsFullInputGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBypassFrequency=upsBypassFrequency, upsBattery=upsBattery, upsConfig=upsConfig, upsBypass=upsBypass, upsInputLineIndex=upsInputLineIndex, upsOutputCurrent=upsOutputCurrent, upsIdent=upsIdent, upsBypassTable=upsBypassTable, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmFanFailure=upsAlarmFanFailure, upsGroups=upsGroups, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTestResultsSummary=upsTestResultsSummary, upsInputLineBads=upsInputLineBads, upsAlarmOnBypass=upsAlarmOnBypass, upsWellKnownAlarms=upsWellKnownAlarms, upsTrapTestCompleted=upsTrapTestCompleted, upsOutputNumLines=upsOutputNumLines, upsBypassLineIndex=upsBypassLineIndex, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmTable=upsAlarmTable, upsConfigLowBattTime=upsConfigLowBattTime, PositiveInteger=PositiveInteger, NonNegativeInteger=NonNegativeInteger, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmEntry=upsAlarmEntry, upsAlarmFuseFailure=upsAlarmFuseFailure, upsCompliances=upsCompliances, upsBatteryVoltage=upsBatteryVoltage, upsInputFrequency=upsInputFrequency, upsSubsetGroups=upsSubsetGroups, upsSubsetInputGroup=upsSubsetInputGroup, upsBypassNumLines=upsBypassNumLines, upsBasicBypassGroup=upsBasicBypassGroup, upsFullControlGroup=upsFullControlGroup, upsTestSpinLock=upsTestSpinLock, upsBasicOutputGroup=upsBasicOutputGroup, upsInputNumLines=upsInputNumLines, upsFullCompliance=upsFullCompliance, upsOutputSource=upsOutputSource, upsBasicCompliance=upsBasicCompliance, upsFullTestGroup=upsFullTestGroup, upsAlarmTempBad=upsAlarmTempBad, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmTestInProgress=upsAlarmTestInProgress, upsShutdownType=upsShutdownType, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmTime=upsAlarmTime, upsAlarmBatteryBad=upsAlarmBatteryBad, upsInputTable=upsInputTable, upsOutputPower=upsOutputPower, upsTestElapsedTime=upsTestElapsedTime, upsInputTruePower=upsInputTruePower, upsRebootWithDuration=upsRebootWithDuration, upsConfigInputVoltage=upsConfigInputVoltage, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsOutputEntry=upsOutputEntry, upsBasicInputGroup=upsBasicInputGroup, upsFullOutputGroup=upsFullOutputGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutputLineIndex=upsOutputLineIndex, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBasicAlarmGroup=upsBasicAlarmGroup, upsIdentModel=upsIdentModel, upsConformance=upsConformance, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmsPresent=upsAlarmsPresent, upsTestResultsDetail=upsTestResultsDetail, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsOutputFrequency=upsOutputFrequency, upsMIB=upsMIB, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsSecondsOnBattery=upsSecondsOnBattery, upsControl=upsControl, upsBatteryCurrent=upsBatteryCurrent, upsConfigOutputVA=upsConfigOutputVA, upsBasicTestGroup=upsBasicTestGroup, upsOutput=upsOutput, upsFullIdentGroup=upsFullIdentGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsTraps=upsTraps, upsTestStartTime=upsTestStartTime, upsWellKnownTests=upsWellKnownTests, upsConfigInputFreq=upsConfigInputFreq, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsOutputTable=upsOutputTable, upsFullGroups=upsFullGroups, upsBatteryStatus=upsBatteryStatus, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBypassVoltage=upsBypassVoltage, upsOutputVoltage=upsOutputVoltage, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsFullConfigGroup=upsFullConfigGroup, upsAlarmInputBad=upsAlarmInputBad, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsInputCurrent=upsInputCurrent, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmId=upsAlarmId, upsTestId=upsTestId, upsBypassCurrent=upsBypassCurrent, upsIdentName=upsIdentName, upsTrapOnBattery=upsTrapOnBattery, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsInputEntry=upsInputEntry, upsInput=upsInput, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsSubsetCompliance=upsSubsetCompliance, upsAlarmDescr=upsAlarmDescr, upsTest=upsTest, upsConfigOutputVoltage=upsConfigOutputVoltage, upsSubsetOutputGroup=upsSubsetOutputGroup)
