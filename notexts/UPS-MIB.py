...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmOnBypass=upsAlarmOnBypass, upsTestElapsedTime=upsTestElapsedTime, upsAlarmBypassBad=upsAlarmBypassBad, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsOutputSource=upsOutputSource, upsAlarmsPresent=upsAlarmsPresent, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsSubsetControlGroup=upsSubsetControlGroup, upsOutputPower=upsOutputPower, upsInput=upsInput, upsAlarmEntry=upsAlarmEntry, upsConfigOutputVoltage=upsConfigOutputVoltage, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmTime=upsAlarmTime, upsBypass=upsBypass, upsWellKnownTests=upsWellKnownTests, upsBasicCompliance=upsBasicCompliance, upsTestResultsDetail=upsTestResultsDetail, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBasicBatteryGroup=upsBasicBatteryGroup, upsFullCompliance=upsFullCompliance, upsInputVoltage=upsInputVoltage, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsInputNumLines=upsInputNumLines, upsInputTable=upsInputTable, upsConfigOutputPower=upsConfigOutputPower, upsAlarmTable=upsAlarmTable, upsSubsetCompliance=upsSubsetCompliance, upsBypassPower=upsBypassPower, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfigOutputVA=upsConfigOutputVA, upsObjects=upsObjects, upsSubsetGroups=upsSubsetGroups, upsTestSpinLock=upsTestSpinLock, upsGroups=upsGroups, upsFullBatteryGroup=upsFullBatteryGroup, upsBypassFrequency=upsBypassFrequency, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBypassLineIndex=upsBypassLineIndex, upsBattery=upsBattery, upsInputLineBads=upsInputLineBads, upsConfigInputFreq=upsConfigInputFreq, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBasicConfigGroup=upsBasicConfigGroup, upsTest=upsTest, upsWellKnownAlarms=upsWellKnownAlarms, upsShutdownType=upsShutdownType, upsAutoRestart=upsAutoRestart, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsOutputTable=upsOutputTable, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBatteryCurrent=upsBatteryCurrent, upsFullOutputGroup=upsFullOutputGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmOnBattery=upsAlarmOnBattery, upsOutputPercentLoad=upsOutputPercentLoad, upsBypassNumLines=upsBypassNumLines, upsBatteryVoltage=upsBatteryVoltage, upsAlarmLowBattery=upsAlarmLowBattery, upsOutputFrequency=upsOutputFrequency, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsSubsetBatteryGroup=upsSubsetBatteryGroup, PositiveInteger=PositiveInteger, upsInputCurrent=upsInputCurrent, upsConfigOutputFreq=upsConfigOutputFreq, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsIdentModel=upsIdentModel, upsCompliances=upsCompliances, upsAlarmInputBad=upsAlarmInputBad, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsFullControlGroup=upsFullControlGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTraps=upsTraps, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsIdentName=upsIdentName, upsInputFrequency=upsInputFrequency, upsAlarm=upsAlarm, upsBasicControlGroup=upsBasicControlGroup, upsInputTruePower=upsInputTruePower, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBypassVoltage=upsBypassVoltage, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, PYSNMP_MODULE_ID=upsMIB, upsOutputLineIndex=upsOutputLineIndex, upsInputEntry=upsInputEntry, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBatteryTemperature=upsBatteryTemperature, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBatteryStatus=upsBatteryStatus, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsOutputVoltage=upsOutputVoltage, upsBypassTable=upsBypassTable, NonNegativeInteger=NonNegativeInteger, upsIdentManufacturer=upsIdentManufacturer, upsOutputCurrent=upsOutputCurrent, upsTrapTestCompleted=upsTrapTestCompleted, upsOutput=upsOutput, upsConfigLowBattTime=upsConfigLowBattTime, upsBasicIdentGroup=upsBasicIdentGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsControl=upsControl, upsFullIdentGroup=upsFullIdentGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBasicOutputGroup=upsBasicOutputGroup, upsInputLineIndex=upsInputLineIndex, upsAlarmId=upsAlarmId, upsMIB=upsMIB, upsConfig=upsConfig, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTestStartTime=upsTestStartTime, upsBasicGroups=upsBasicGroups, upsAlarmShutdownPending=upsAlarmShutdownPending, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsRebootWithDuration=upsRebootWithDuration, upsBypassCurrent=upsBypassCurrent, upsFullConfigGroup=upsFullConfigGroup, upsTestResultsSummary=upsTestResultsSummary, upsTestId=upsTestId, upsBasicInputGroup=upsBasicInputGroup, upsAlarmTempBad=upsAlarmTempBad, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmFuseFailure=upsAlarmFuseFailure, upsFullBypassGroup=upsFullBypassGroup, upsFullTestGroup=upsFullTestGroup, upsOutputNumLines=upsOutputNumLines, upsBasicBypassGroup=upsBasicBypassGroup, upsTrapOnBattery=upsTrapOnBattery, upsIdent=upsIdent, upsSubsetOutputGroup=upsSubsetOutputGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsFullInputGroup=upsFullInputGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmDescr=upsAlarmDescr, upsBasicTestGroup=upsBasicTestGroup, upsOutputEntry=upsOutputEntry, upsFullGroups=upsFullGroups, upsAlarmFanFailure=upsAlarmFanFailure, upsBypassEntry=upsBypassEntry, upsConformance=upsConformance)
