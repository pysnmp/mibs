...
# Produced by pysmi-1.1.8 at Thu Sep 15 09:34:54 2022
...
mibBuilder.exportSymbols("UPS-MIB", upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBasicConfigGroup=upsBasicConfigGroup, upsBasicGroups=upsBasicGroups, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBatteryStatus=upsBatteryStatus, upsSubsetIdentGroup=upsSubsetIdentGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBasicAlarmGroup=upsBasicAlarmGroup, upsConfig=upsConfig, upsSubsetGroups=upsSubsetGroups, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmDescr=upsAlarmDescr, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBypassEntry=upsBypassEntry, upsFullControlGroup=upsFullControlGroup, upsAlarmTable=upsAlarmTable, upsAlarmOutputBad=upsAlarmOutputBad, upsIdentModel=upsIdentModel, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsCompliances=upsCompliances, upsInputTruePower=upsInputTruePower, upsOutputSource=upsOutputSource, upsBatteryTemperature=upsBatteryTemperature, upsFullInputGroup=upsFullInputGroup, upsAlarm=upsAlarm, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsBasicBypassGroup=upsBasicBypassGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsConfigLowBattTime=upsConfigLowBattTime, upsFullCompliance=upsFullCompliance, upsTestSpinLock=upsTestSpinLock, upsAlarmInputBad=upsAlarmInputBad, upsAlarmId=upsAlarmId, upsBattery=upsBattery, upsConfigInputFreq=upsConfigInputFreq, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConfigOutputPower=upsConfigOutputPower, upsBasicControlGroup=upsBasicControlGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBypassVoltage=upsBypassVoltage, upsShutdownAfterDelay=upsShutdownAfterDelay, upsOutput=upsOutput, upsTestResultsSummary=upsTestResultsSummary, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsConfigOutputFreq=upsConfigOutputFreq, upsSubsetOutputGroup=upsSubsetOutputGroup, upsInputTable=upsInputTable, upsAlarmGeneralFault=upsAlarmGeneralFault, upsFullBypassGroup=upsFullBypassGroup, upsInputNumLines=upsInputNumLines, upsOutputFrequency=upsOutputFrequency, upsBypassNumLines=upsBypassNumLines, upsInput=upsInput, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmShutdownPending=upsAlarmShutdownPending, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsSecondsOnBattery=upsSecondsOnBattery, upsBatteryVoltage=upsBatteryVoltage, upsConformance=upsConformance, upsBasicTestGroup=upsBasicTestGroup, upsIdent=upsIdent, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmTime=upsAlarmTime, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsOutputTable=upsOutputTable, PYSNMP_MODULE_ID=upsMIB, upsShutdownType=upsShutdownType, upsBypassFrequency=upsBypassFrequency, upsAlarmBypassBad=upsAlarmBypassBad, upsInputFrequency=upsInputFrequency, upsOutputVoltage=upsOutputVoltage, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBypassLineIndex=upsBypassLineIndex, upsFullAlarmGroup=upsFullAlarmGroup, upsGroups=upsGroups, upsFullGroups=upsFullGroups, upsBasicIdentGroup=upsBasicIdentGroup, upsIdentName=upsIdentName, upsOutputPower=upsOutputPower, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsInputVoltage=upsInputVoltage, upsBatteryCurrent=upsBatteryCurrent, upsAlarmsPresent=upsAlarmsPresent, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsConfigOutputVA=upsConfigOutputVA, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTestElapsedTime=upsTestElapsedTime, upsObjects=upsObjects, upsOutputCurrent=upsOutputCurrent, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTest=upsTest, upsTraps=upsTraps, upsBypassPower=upsBypassPower, upsAlarmOnBypass=upsAlarmOnBypass, upsSubsetInputGroup=upsSubsetInputGroup, upsInputEntry=upsInputEntry, upsAlarmTempBad=upsAlarmTempBad, upsTrapTestCompleted=upsTrapTestCompleted, upsInputLineIndex=upsInputLineIndex, upsMIB=upsMIB, upsIdentManufacturer=upsIdentManufacturer, upsBypass=upsBypass, upsOutputPercentLoad=upsOutputPercentLoad, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsControl=upsControl, upsBypassTable=upsBypassTable, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBasicInputGroup=upsBasicInputGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, PositiveInteger=PositiveInteger, upsOutputNumLines=upsOutputNumLines, upsAutoRestart=upsAutoRestart, upsInputCurrent=upsInputCurrent, upsAlarmTestInProgress=upsAlarmTestInProgress, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTestResultsDetail=upsTestResultsDetail, upsAlarmEntry=upsAlarmEntry, upsWellKnownTests=upsWellKnownTests, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsOutputEntry=upsOutputEntry, upsTestStartTime=upsTestStartTime, upsInputLineBads=upsInputLineBads, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsFullConfigGroup=upsFullConfigGroup, upsTestId=upsTestId, upsBypassCurrent=upsBypassCurrent, upsFullTestGroup=upsFullTestGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsSubsetCompliance=upsSubsetCompliance, upsOutputLineIndex=upsOutputLineIndex, NonNegativeInteger=NonNegativeInteger, upsFullIdentGroup=upsFullIdentGroup, upsTrapOnBattery=upsTrapOnBattery, upsBasicOutputGroup=upsBasicOutputGroup, upsBasicCompliance=upsBasicCompliance, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmFanFailure=upsAlarmFanFailure, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsRebootWithDuration=upsRebootWithDuration, upsFullOutputGroup=upsFullOutputGroup)
