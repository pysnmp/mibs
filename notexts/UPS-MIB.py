...
mibBuilder.exportSymbols("UPS-MIB", upsIdentAttachedDevices=upsIdentAttachedDevices, NonNegativeInteger=NonNegativeInteger, upsInputFrequency=upsInputFrequency, upsAlarmGeneralFault=upsAlarmGeneralFault, upsFullConfigGroup=upsFullConfigGroup, upsConfigOutputPower=upsConfigOutputPower, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsSubsetCompliance=upsSubsetCompliance, upsFullIdentGroup=upsFullIdentGroup, upsInputLineBads=upsInputLineBads, upsOutputCurrent=upsOutputCurrent, upsShutdownAfterDelay=upsShutdownAfterDelay, upsInputVoltage=upsInputVoltage, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmInputBad=upsAlarmInputBad, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTestResultsDetail=upsTestResultsDetail, upsOutputLineIndex=upsOutputLineIndex, upsBasicAlarmGroup=upsBasicAlarmGroup, upsTest=upsTest, PYSNMP_MODULE_ID=upsMIB, upsBypassNumLines=upsBypassNumLines, upsFullCompliance=upsFullCompliance, upsBypassVoltage=upsBypassVoltage, upsAlarmEntry=upsAlarmEntry, upsBypassCurrent=upsBypassCurrent, upsOutputTable=upsOutputTable, upsSecondsOnBattery=upsSecondsOnBattery, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBypassEntry=upsBypassEntry, upsTestElapsedTime=upsTestElapsedTime, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBypassTable=upsBypassTable, upsConfigOutputVA=upsConfigOutputVA, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmOnBypass=upsAlarmOnBypass, upsMIB=upsMIB, upsIdentModel=upsIdentModel, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsInputCurrent=upsInputCurrent, upsAlarmDescr=upsAlarmDescr, upsInputNumLines=upsInputNumLines, upsTestStartTime=upsTestStartTime, upsTestResultsSummary=upsTestResultsSummary, upsFullTestGroup=upsFullTestGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsBatteryVoltage=upsBatteryVoltage, upsConfig=upsConfig, upsBatteryStatus=upsBatteryStatus, upsTraps=upsTraps, upsBasicConfigGroup=upsBasicConfigGroup, upsInputTruePower=upsInputTruePower, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsInputEntry=upsInputEntry, upsBasicGroups=upsBasicGroups, upsAlarmTestInProgress=upsAlarmTestInProgress, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBasicCompliance=upsBasicCompliance, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmTable=upsAlarmTable, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsIdentName=upsIdentName, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsStartupAfterDelay=upsStartupAfterDelay, upsOutput=upsOutput, upsAlarmFanFailure=upsAlarmFanFailure, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConfigInputFreq=upsConfigInputFreq, upsTrapTestCompleted=upsTrapTestCompleted, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestId=upsTestId, upsInput=upsInput, PositiveInteger=PositiveInteger, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmsPresent=upsAlarmsPresent, upsBypassPower=upsBypassPower, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsIdent=upsIdent, upsFullGroups=upsFullGroups, upsAlarm=upsAlarm, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsShutdownType=upsShutdownType, upsBypassLineIndex=upsBypassLineIndex, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBasicBypassGroup=upsBasicBypassGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsInputLineIndex=upsInputLineIndex, upsOutputSource=upsOutputSource, upsAlarmTempBad=upsAlarmTempBad, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmOnBattery=upsAlarmOnBattery, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicTestGroup=upsBasicTestGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsFullInputGroup=upsFullInputGroup, upsCompliances=upsCompliances, upsConformance=upsConformance, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsFullControlGroup=upsFullControlGroup, upsOutputEntry=upsOutputEntry, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsOutputNumLines=upsOutputNumLines, upsAlarmTime=upsAlarmTime, upsBasicControlGroup=upsBasicControlGroup, upsBatteryCurrent=upsBatteryCurrent, upsConfigOutputFreq=upsConfigOutputFreq, upsBypass=upsBypass, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmOutputOverload=upsAlarmOutputOverload, upsControl=upsControl, upsBypassFrequency=upsBypassFrequency, upsWellKnownAlarms=upsWellKnownAlarms, upsBattery=upsBattery, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsInputTable=upsInputTable, upsAlarmId=upsAlarmId, upsIdentManufacturer=upsIdentManufacturer, upsAlarmChargerFailed=upsAlarmChargerFailed, upsWellKnownTests=upsWellKnownTests, upsGroups=upsGroups, upsTestSpinLock=upsTestSpinLock, upsAlarmOutputBad=upsAlarmOutputBad, upsOutputVoltage=upsOutputVoltage, upsFullAlarmGroup=upsFullAlarmGroup, upsObjects=upsObjects, upsSubsetGroups=upsSubsetGroups, upsFullOutputGroup=upsFullOutputGroup, upsTrapOnBattery=upsTrapOnBattery, upsAutoRestart=upsAutoRestart, upsRebootWithDuration=upsRebootWithDuration, upsBasicInputGroup=upsBasicInputGroup, upsOutputFrequency=upsOutputFrequency, upsBatteryTemperature=upsBatteryTemperature, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsOutputPower=upsOutputPower, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsFullBypassGroup=upsFullBypassGroup)
