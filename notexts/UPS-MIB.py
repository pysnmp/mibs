...
mibBuilder.exportSymbols("UPS-MIB", upsInputLineIndex=upsInputLineIndex, upsAutoRestart=upsAutoRestart, upsFullControlGroup=upsFullControlGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsConfigInputVoltage=upsConfigInputVoltage, upsSubsetIdentGroup=upsSubsetIdentGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmGeneralFault=upsAlarmGeneralFault, upsOutputFrequency=upsOutputFrequency, upsIdent=upsIdent, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsInputTable=upsInputTable, upsBasicCompliance=upsBasicCompliance, upsObjects=upsObjects, upsTestElapsedTime=upsTestElapsedTime, upsAlarmShutdownPending=upsAlarmShutdownPending, upsSubsetCompliance=upsSubsetCompliance, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsInputCurrent=upsInputCurrent, upsBypass=upsBypass, upsBasicInputGroup=upsBasicInputGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsBatteryStatus=upsBatteryStatus, upsOutputLineIndex=upsOutputLineIndex, upsInputNumLines=upsInputNumLines, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBasicControlGroup=upsBasicControlGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsFullGroups=upsFullGroups, upsIdentManufacturer=upsIdentManufacturer, upsInputLineBads=upsInputLineBads, upsOutputPercentLoad=upsOutputPercentLoad, upsSubsetControlGroup=upsSubsetControlGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsOutputTable=upsOutputTable, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsFullIdentGroup=upsFullIdentGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsBypassTable=upsBypassTable, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsOutputNumLines=upsOutputNumLines, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmBypassBad=upsAlarmBypassBad, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBypassCurrent=upsBypassCurrent, upsBasicAlarmGroup=upsBasicAlarmGroup, upsIdentModel=upsIdentModel, upsOutput=upsOutput, upsRebootWithDuration=upsRebootWithDuration, upsConfigAudibleStatus=upsConfigAudibleStatus, upsShutdownType=upsShutdownType, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmOnBattery=upsAlarmOnBattery, PYSNMP_MODULE_ID=upsMIB, upsConfigOutputVoltage=upsConfigOutputVoltage, upsOutputEntry=upsOutputEntry, upsWellKnownAlarms=upsWellKnownAlarms, upsIdentAttachedDevices=upsIdentAttachedDevices, upsSecondsOnBattery=upsSecondsOnBattery, upsBasicGroups=upsBasicGroups, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsConfigInputFreq=upsConfigInputFreq, upsInputFrequency=upsInputFrequency, upsAlarmFanFailure=upsAlarmFanFailure, upsTrapOnBattery=upsTrapOnBattery, upsOutputPower=upsOutputPower, upsConfigOutputPower=upsConfigOutputPower, upsBatteryVoltage=upsBatteryVoltage, upsTestId=upsTestId, upsInputVoltage=upsInputVoltage, upsBypassLineIndex=upsBypassLineIndex, upsTestResultsSummary=upsTestResultsSummary, upsBasicConfigGroup=upsBasicConfigGroup, upsWellKnownTests=upsWellKnownTests, upsControl=upsControl, upsInput=upsInput, upsTraps=upsTraps, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsOutputVoltage=upsOutputVoltage, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsInputTruePower=upsInputTruePower, upsFullOutputGroup=upsFullOutputGroup, upsFullConfigGroup=upsFullConfigGroup, upsTestResultsDetail=upsTestResultsDetail, upsAlarmEntry=upsAlarmEntry, upsAlarmId=upsAlarmId, upsTest=upsTest, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfig=upsConfig, upsAlarmInputBad=upsAlarmInputBad, upsBypassEntry=upsBypassEntry, upsBypassVoltage=upsBypassVoltage, upsInputEntry=upsInputEntry, upsConformance=upsConformance, upsAlarmDescr=upsAlarmDescr, upsBasicTestGroup=upsBasicTestGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBatteryCurrent=upsBatteryCurrent, upsAlarmTime=upsAlarmTime, upsOutputSource=upsOutputSource, upsConfigOutputVA=upsConfigOutputVA, upsBatteryTemperature=upsBatteryTemperature, upsTestSpinLock=upsTestSpinLock, upsCompliances=upsCompliances, PositiveInteger=PositiveInteger, upsFullCompliance=upsFullCompliance, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsFullInputGroup=upsFullInputGroup, NonNegativeInteger=NonNegativeInteger, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBasicIdentGroup=upsBasicIdentGroup, upsBypassPower=upsBypassPower, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsOutputCurrent=upsOutputCurrent, upsTestStartTime=upsTestStartTime, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsFullBypassGroup=upsFullBypassGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarm=upsAlarm, upsSubsetInputGroup=upsSubsetInputGroup, upsSubsetGroups=upsSubsetGroups, upsSubsetOutputGroup=upsSubsetOutputGroup, upsIdentName=upsIdentName, upsAlarmTable=upsAlarmTable, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBypassNumLines=upsBypassNumLines, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBypassFrequency=upsBypassFrequency, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmTempBad=upsAlarmTempBad, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBattery=upsBattery, upsAlarmTestInProgress=upsAlarmTestInProgress, upsGroups=upsGroups, upsFullTestGroup=upsFullTestGroup, upsAlarmsPresent=upsAlarmsPresent, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConfigLowBattTime=upsConfigLowBattTime, upsMIB=upsMIB)
