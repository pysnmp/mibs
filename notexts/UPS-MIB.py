...
mibBuilder.exportSymbols("UPS-MIB", PositiveInteger=PositiveInteger, upsIdent=upsIdent, upsAlarmEntry=upsAlarmEntry, upsSubsetInputGroup=upsSubsetInputGroup, upsTestId=upsTestId, upsFullAlarmGroup=upsFullAlarmGroup, upsBypassPower=upsBypassPower, upsAlarmTime=upsAlarmTime, upsOutputNumLines=upsOutputNumLines, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBatteryVoltage=upsBatteryVoltage, upsFullBypassGroup=upsFullBypassGroup, upsObjects=upsObjects, upsTestSpinLock=upsTestSpinLock, upsTrapTestCompleted=upsTrapTestCompleted, upsInputFrequency=upsInputFrequency, upsOutputLineIndex=upsOutputLineIndex, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsShutdownType=upsShutdownType, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, PYSNMP_MODULE_ID=upsMIB, upsBypassEntry=upsBypassEntry, upsBatteryCurrent=upsBatteryCurrent, upsBasicOutputGroup=upsBasicOutputGroup, upsRebootWithDuration=upsRebootWithDuration, upsWellKnownTests=upsWellKnownTests, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTrapOnBattery=upsTrapOnBattery, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullGroups=upsFullGroups, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsConfigInputFreq=upsConfigInputFreq, upsAlarmOnBypass=upsAlarmOnBypass, upsBasicControlGroup=upsBasicControlGroup, upsFullInputGroup=upsFullInputGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsFullConfigGroup=upsFullConfigGroup, upsAlarmsPresent=upsAlarmsPresent, upsConformance=upsConformance, upsAlarmId=upsAlarmId, upsOutputTable=upsOutputTable, upsBypassTable=upsBypassTable, upsBasicIdentGroup=upsBasicIdentGroup, upsTraps=upsTraps, upsSubsetGroups=upsSubsetGroups, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigLowBattTime=upsConfigLowBattTime, upsSubsetCompliance=upsSubsetCompliance, upsInputCurrent=upsInputCurrent, upsBypassCurrent=upsBypassCurrent, upsConfigInputVoltage=upsConfigInputVoltage, upsFullControlGroup=upsFullControlGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsWellKnownAlarms=upsWellKnownAlarms, upsInputEntry=upsInputEntry, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsSecondsOnBattery=upsSecondsOnBattery, upsInputVoltage=upsInputVoltage, upsAlarmTable=upsAlarmTable, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsMIB=upsMIB, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsShutdownAfterDelay=upsShutdownAfterDelay, upsCompliances=upsCompliances, upsInputNumLines=upsInputNumLines, upsBasicBatteryGroup=upsBasicBatteryGroup, upsGroups=upsGroups, upsBasicBypassGroup=upsBasicBypassGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsOutputCurrent=upsOutputCurrent, upsOutputPercentLoad=upsOutputPercentLoad, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBypass=upsBypass, upsTestElapsedTime=upsTestElapsedTime, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBattery=upsBattery, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsTest=upsTest, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAutoRestart=upsAutoRestart, upsAlarmInputBad=upsAlarmInputBad, upsAlarmDescr=upsAlarmDescr, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConfigAudibleStatus=upsConfigAudibleStatus, upsConfig=upsConfig, upsTestResultsSummary=upsTestResultsSummary, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmTestInProgress=upsAlarmTestInProgress, upsIdentName=upsIdentName, upsOutputVoltage=upsOutputVoltage, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsControl=upsControl, upsBasicTestGroup=upsBasicTestGroup, upsFullTestGroup=upsFullTestGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsFullCompliance=upsFullCompliance, upsBypassFrequency=upsBypassFrequency, upsInputTable=upsInputTable, upsInputLineIndex=upsInputLineIndex, upsStartupAfterDelay=upsStartupAfterDelay, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicInputGroup=upsBasicInputGroup, upsFullOutputGroup=upsFullOutputGroup, upsAlarmTempBad=upsAlarmTempBad, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBypassNumLines=upsBypassNumLines, upsTestResultsDetail=upsTestResultsDetail, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsOutputFrequency=upsOutputFrequency, upsConfigOutputVA=upsConfigOutputVA, upsBypassLineIndex=upsBypassLineIndex, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBasicCompliance=upsBasicCompliance, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmOnBattery=upsAlarmOnBattery, NonNegativeInteger=NonNegativeInteger, upsOutputSource=upsOutputSource, upsFullIdentGroup=upsFullIdentGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsIdentManufacturer=upsIdentManufacturer, upsBatteryTemperature=upsBatteryTemperature, upsInputLineBads=upsInputLineBads, upsBypassVoltage=upsBypassVoltage, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfigOutputPower=upsConfigOutputPower, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsInputTruePower=upsInputTruePower, upsOutput=upsOutput, upsOutputPower=upsOutputPower, upsAlarm=upsAlarm, upsAlarmLowBattery=upsAlarmLowBattery, upsTestStartTime=upsTestStartTime, upsIdentAttachedDevices=upsIdentAttachedDevices, upsOutputEntry=upsOutputEntry, upsBatteryStatus=upsBatteryStatus, upsIdentModel=upsIdentModel, upsBasicGroups=upsBasicGroups, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsInput=upsInput)
