...
TimeStamp, AutonomousType, TimeInterval, DisplayString, TestAndIncr, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "TimeInterval", "DisplayString", "TestAndIncr", "TextualConvention")
...
mibBuilder.exportSymbols("UPS-MIB", PYSNMP_MODULE_ID=upsMIB, upsInputCurrent=upsInputCurrent, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsConfig=upsConfig, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsGroups=upsGroups, upsConfigAudibleStatus=upsConfigAudibleStatus, upsFullCompliance=upsFullCompliance, upsSubsetCompliance=upsSubsetCompliance, upsFullGroups=upsFullGroups, upsBasicGroups=upsBasicGroups, upsConfigInputFreq=upsConfigInputFreq, upsSubsetControlGroup=upsSubsetControlGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsIdentName=upsIdentName, upsBasicAlarmGroup=upsBasicAlarmGroup, upsSubsetGroups=upsSubsetGroups, upsSubsetInputGroup=upsSubsetInputGroup, upsOutputTable=upsOutputTable, upsFullInputGroup=upsFullInputGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBatteryStatus=upsBatteryStatus, upsInputNumLines=upsInputNumLines, upsTrapOnBattery=upsTrapOnBattery, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmGeneralFault=upsAlarmGeneralFault, upsInputFrequency=upsInputFrequency, upsAlarmId=upsAlarmId, upsAlarm=upsAlarm, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsInput=upsInput, upsIdentManufacturer=upsIdentManufacturer, upsIdent=upsIdent, upsInputVoltage=upsInputVoltage, upsAlarmOnBypass=upsAlarmOnBypass, upsBypassNumLines=upsBypassNumLines, upsBattery=upsBattery, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmTime=upsAlarmTime, upsOutputPercentLoad=upsOutputPercentLoad, upsConfigOutputFreq=upsConfigOutputFreq, upsFullIdentGroup=upsFullIdentGroup, upsTestSpinLock=upsTestSpinLock, upsAlarmsPresent=upsAlarmsPresent, upsTestId=upsTestId, upsOutputCurrent=upsOutputCurrent, upsConfigLowBattTime=upsConfigLowBattTime, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsInputEntry=upsInputEntry, upsBatteryCurrent=upsBatteryCurrent, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBatteryVoltage=upsBatteryVoltage, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBasicControlGroup=upsBasicControlGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBypassLineIndex=upsBypassLineIndex, upsAlarmTempBad=upsAlarmTempBad, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsRebootWithDuration=upsRebootWithDuration, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmInputBad=upsAlarmInputBad, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmOnBattery=upsAlarmOnBattery, upsOutputEntry=upsOutputEntry, upsOutputLineIndex=upsOutputLineIndex, upsTestStartTime=upsTestStartTime, upsTraps=upsTraps, upsAlarmTable=upsAlarmTable, upsInputTruePower=upsInputTruePower, upsOutput=upsOutput, upsConfigOutputPower=upsConfigOutputPower, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmBypassBad=upsAlarmBypassBad, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmFanFailure=upsAlarmFanFailure, upsInputLineIndex=upsInputLineIndex, upsBypassEntry=upsBypassEntry, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTestResultsSummary=upsTestResultsSummary, upsBasicBatteryGroup=upsBasicBatteryGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsInputLineBads=upsInputLineBads, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAutoRestart=upsAutoRestart, upsBasicInputGroup=upsBasicInputGroup, upsMIB=upsMIB, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsConfigInputVoltage=upsConfigInputVoltage, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicOutputGroup=upsBasicOutputGroup, upsShutdownType=upsShutdownType, upsInputTable=upsInputTable, upsBasicBypassGroup=upsBasicBypassGroup, upsIdentModel=upsIdentModel, upsTestElapsedTime=upsTestElapsedTime, upsFullBypassGroup=upsFullBypassGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsConformance=upsConformance, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsOutputPower=upsOutputPower, upsTestResultsDetail=upsTestResultsDetail, upsWellKnownTests=upsWellKnownTests, upsIdentAttachedDevices=upsIdentAttachedDevices, upsCompliances=upsCompliances, upsBypassCurrent=upsBypassCurrent, NonNegativeInteger=NonNegativeInteger, upsBasicTestGroup=upsBasicTestGroup, upsAlarmEntry=upsAlarmEntry, upsOutputFrequency=upsOutputFrequency, upsBypassFrequency=upsBypassFrequency, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutputVoltage=upsOutputVoltage, upsControl=upsControl, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsStartupAfterDelay=upsStartupAfterDelay, upsConfigOutputVA=upsConfigOutputVA, upsWellKnownAlarms=upsWellKnownAlarms, upsFullConfigGroup=upsFullConfigGroup, upsObjects=upsObjects, upsAlarmDescr=upsAlarmDescr, upsOutputNumLines=upsOutputNumLines, PositiveInteger=PositiveInteger, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsFullTestGroup=upsFullTestGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsFullControlGroup=upsFullControlGroup, upsBasicCompliance=upsBasicCompliance, upsBatteryTemperature=upsBatteryTemperature, upsTrapTestCompleted=upsTrapTestCompleted, upsBypassTable=upsBypassTable, upsAlarmBatteryBad=upsAlarmBatteryBad, upsSecondsOnBattery=upsSecondsOnBattery, upsOutputSource=upsOutputSource, upsBypassPower=upsBypassPower, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTest=upsTest, upsBypass=upsBypass, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullOutputGroup=upsFullOutputGroup, upsBypassVoltage=upsBypassVoltage)
