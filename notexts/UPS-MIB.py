...
mibBuilder.exportSymbols("UPS-MIB", upsIdent=upsIdent, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsInputCurrent=upsInputCurrent, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfig=upsConfig, upsAlarmFuseFailure=upsAlarmFuseFailure, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmId=upsAlarmId, upsBasicInputGroup=upsBasicInputGroup, upsBypassCurrent=upsBypassCurrent, upsBypassFrequency=upsBypassFrequency, upsBasicConfigGroup=upsBasicConfigGroup, upsConfigInputFreq=upsConfigInputFreq, upsBypassNumLines=upsBypassNumLines, upsSubsetControlGroup=upsSubsetControlGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsFullControlGroup=upsFullControlGroup, upsOutputVoltage=upsOutputVoltage, upsSubsetIdentGroup=upsSubsetIdentGroup, upsSubsetCompliance=upsSubsetCompliance, upsIdentModel=upsIdentModel, upsInputEntry=upsInputEntry, upsBatteryCurrent=upsBatteryCurrent, upsFullIdentGroup=upsFullIdentGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTrapTestCompleted=upsTrapTestCompleted, upsMIB=upsMIB, upsTestElapsedTime=upsTestElapsedTime, upsBypass=upsBypass, upsFullBatteryGroup=upsFullBatteryGroup, upsBypassPower=upsBypassPower, upsOutputSource=upsOutputSource, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmBypassBad=upsAlarmBypassBad, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsCompliances=upsCompliances, upsFullGroups=upsFullGroups, upsTest=upsTest, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBasicCompliance=upsBasicCompliance, upsOutputTable=upsOutputTable, upsInputTable=upsInputTable, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicTestGroup=upsBasicTestGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBasicControlGroup=upsBasicControlGroup, upsOutput=upsOutput, upsBypassEntry=upsBypassEntry, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsInputLineBads=upsInputLineBads, upsBatteryVoltage=upsBatteryVoltage, upsBatteryTemperature=upsBatteryTemperature, upsBypassVoltage=upsBypassVoltage, upsRebootWithDuration=upsRebootWithDuration, upsAlarmOnBattery=upsAlarmOnBattery, upsSubsetGroups=upsSubsetGroups, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmChargerFailed=upsAlarmChargerFailed, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmDescr=upsAlarmDescr, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBasicBypassGroup=upsBasicBypassGroup, upsBypassTable=upsBypassTable, upsConfigOutputPower=upsConfigOutputPower, upsTestSpinLock=upsTestSpinLock, upsBypassLineIndex=upsBypassLineIndex, upsControl=upsControl, upsAlarmEntry=upsAlarmEntry, upsInputLineIndex=upsInputLineIndex, upsTrapOnBattery=upsTrapOnBattery, PositiveInteger=PositiveInteger, upsConfigOutputFreq=upsConfigOutputFreq, upsIdentManufacturer=upsIdentManufacturer, upsOutputLineIndex=upsOutputLineIndex, upsSubsetOutputGroup=upsSubsetOutputGroup, upsTestStartTime=upsTestStartTime, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmTable=upsAlarmTable, upsTestResultsSummary=upsTestResultsSummary, upsAlarmTempBad=upsAlarmTempBad, upsConfigOutputVoltage=upsConfigOutputVoltage, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsObjects=upsObjects, upsAlarmInputBad=upsAlarmInputBad, upsShutdownType=upsShutdownType, upsAlarmFanFailure=upsAlarmFanFailure, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBattery=upsBattery, upsOutputFrequency=upsOutputFrequency, upsAlarmLowBattery=upsAlarmLowBattery, upsBasicGroups=upsBasicGroups, upsConfigAudibleStatus=upsConfigAudibleStatus, upsFullConfigGroup=upsFullConfigGroup, upsConfigOutputVA=upsConfigOutputVA, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBasicBatteryGroup=upsBasicBatteryGroup, upsInputVoltage=upsInputVoltage, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmTime=upsAlarmTime, upsFullOutputGroup=upsFullOutputGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsFullAlarmGroup=upsFullAlarmGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsOutputCurrent=upsOutputCurrent, upsShutdownAfterDelay=upsShutdownAfterDelay, upsFullCompliance=upsFullCompliance, upsGroups=upsGroups, PYSNMP_MODULE_ID=upsMIB, upsAutoRestart=upsAutoRestart, upsOutputNumLines=upsOutputNumLines, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsConfigInputVoltage=upsConfigInputVoltage, upsTestResultsDetail=upsTestResultsDetail, upsConformance=upsConformance, upsOutputPower=upsOutputPower, upsInputTruePower=upsInputTruePower, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmOutputBad=upsAlarmOutputBad, upsBasicOutputGroup=upsBasicOutputGroup, upsFullInputGroup=upsFullInputGroup, upsFullTestGroup=upsFullTestGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsBatteryStatus=upsBatteryStatus, upsTraps=upsTraps, upsWellKnownTests=upsWellKnownTests, upsAlarm=upsAlarm, upsInputNumLines=upsInputNumLines, upsAlarmGeneralFault=upsAlarmGeneralFault, upsOutputEntry=upsOutputEntry, upsFullBypassGroup=upsFullBypassGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsIdentName=upsIdentName, upsWellKnownAlarms=upsWellKnownAlarms, upsTestId=upsTestId, upsInputFrequency=upsInputFrequency, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, NonNegativeInteger=NonNegativeInteger, upsInput=upsInput, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmsPresent=upsAlarmsPresent, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested)
