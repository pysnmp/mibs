...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmShutdownPending=upsAlarmShutdownPending, upsTestElapsedTime=upsTestElapsedTime, upsSubsetOutputGroup=upsSubsetOutputGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsStartupAfterDelay=upsStartupAfterDelay, upsOutput=upsOutput, upsConfigInputFreq=upsConfigInputFreq, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmsPresent=upsAlarmsPresent, upsOutputEntry=upsOutputEntry, upsAlarmOutputOverload=upsAlarmOutputOverload, upsInputTruePower=upsInputTruePower, upsBasicOutputGroup=upsBasicOutputGroup, upsTest=upsTest, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsConformance=upsConformance, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBypassVoltage=upsBypassVoltage, upsAlarmTable=upsAlarmTable, upsTraps=upsTraps, upsFullOutputGroup=upsFullOutputGroup, upsBasicCompliance=upsBasicCompliance, upsBasicGroups=upsBasicGroups, upsConfigOutputVA=upsConfigOutputVA, upsAlarmDescr=upsAlarmDescr, upsInput=upsInput, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutputSource=upsOutputSource, upsConfigOutputPower=upsConfigOutputPower, upsAlarmLowBattery=upsAlarmLowBattery, upsFullConfigGroup=upsFullConfigGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarm=upsAlarm, upsFullInputGroup=upsFullInputGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsSubsetCompliance=upsSubsetCompliance, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmInputBad=upsAlarmInputBad, upsSubsetInputGroup=upsSubsetInputGroup, upsBypassFrequency=upsBypassFrequency, upsGroups=upsGroups, upsWellKnownAlarms=upsWellKnownAlarms, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmId=upsAlarmId, upsInputVoltage=upsInputVoltage, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBatteryTemperature=upsBatteryTemperature, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBypassLineIndex=upsBypassLineIndex, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmTempBad=upsAlarmTempBad, upsAlarmOutputBad=upsAlarmOutputBad, PYSNMP_MODULE_ID=upsMIB, upsFullBypassGroup=upsFullBypassGroup, upsBasicInputGroup=upsBasicInputGroup, upsSubsetGroups=upsSubsetGroups, upsOutputNumLines=upsOutputNumLines, upsBypassCurrent=upsBypassCurrent, upsInputEntry=upsInputEntry, upsOutputTable=upsOutputTable, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsTrapOnBattery=upsTrapOnBattery, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTestId=upsTestId, upsFullAlarmGroup=upsFullAlarmGroup, upsConfig=upsConfig, upsFullCompliance=upsFullCompliance, upsBasicIdentGroup=upsBasicIdentGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBypassPower=upsBypassPower, upsConfigAudibleStatus=upsConfigAudibleStatus, upsOutputVoltage=upsOutputVoltage, upsInputCurrent=upsInputCurrent, upsBatteryStatus=upsBatteryStatus, upsInputTable=upsInputTable, upsFullTestGroup=upsFullTestGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsIdentModel=upsIdentModel, upsInputLineIndex=upsInputLineIndex, upsInputNumLines=upsInputNumLines, upsControl=upsControl, upsBasicBatteryGroup=upsBasicBatteryGroup, upsInputLineBads=upsInputLineBads, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBatteryCurrent=upsBatteryCurrent, PositiveInteger=PositiveInteger, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBasicTestGroup=upsBasicTestGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsObjects=upsObjects, upsMIB=upsMIB, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmOnBypass=upsAlarmOnBypass, upsConfigLowBattTime=upsConfigLowBattTime, upsBattery=upsBattery, upsWellKnownTests=upsWellKnownTests, upsInputFrequency=upsInputFrequency, upsBasicControlGroup=upsBasicControlGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsSubsetConfigGroup=upsSubsetConfigGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsOutputPercentLoad=upsOutputPercentLoad, upsIdentName=upsIdentName, upsTestStartTime=upsTestStartTime, upsFullControlGroup=upsFullControlGroup, upsCompliances=upsCompliances, upsFullIdentGroup=upsFullIdentGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBypass=upsBypass, upsTrapTestCompleted=upsTrapTestCompleted, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsIdent=upsIdent, upsTestResultsDetail=upsTestResultsDetail, upsTestResultsSummary=upsTestResultsSummary, upsAlarmTime=upsAlarmTime, upsConfigInputVoltage=upsConfigInputVoltage, upsOutputPower=upsOutputPower, upsAlarmBatteryBad=upsAlarmBatteryBad, upsOutputCurrent=upsOutputCurrent, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBasicConfigGroup=upsBasicConfigGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsBatteryVoltage=upsBatteryVoltage, upsBypassTable=upsBypassTable, upsBypassNumLines=upsBypassNumLines, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsFullGroups=upsFullGroups, upsAlarmBypassBad=upsAlarmBypassBad, upsAutoRestart=upsAutoRestart, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsBypassEntry=upsBypassEntry, upsOutputFrequency=upsOutputFrequency, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmEntry=upsAlarmEntry, upsTestSpinLock=upsTestSpinLock, upsRebootWithDuration=upsRebootWithDuration, upsOutputLineIndex=upsOutputLineIndex, upsShutdownAfterDelay=upsShutdownAfterDelay, NonNegativeInteger=NonNegativeInteger, upsIdentManufacturer=upsIdentManufacturer, upsShutdownType=upsShutdownType)
