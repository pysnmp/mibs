...
mibBuilder.exportSymbols("UPS-MIB", upsInputCurrent=upsInputCurrent, upsOutputEntry=upsOutputEntry, upsRebootWithDuration=upsRebootWithDuration, upsFullBypassGroup=upsFullBypassGroup, upsInputVoltage=upsInputVoltage, upsBypass=upsBypass, upsAlarmDescr=upsAlarmDescr, upsInputFrequency=upsInputFrequency, upsBattery=upsBattery, NonNegativeInteger=NonNegativeInteger, upsTrapOnBattery=upsTrapOnBattery, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTestId=upsTestId, upsSubsetGroups=upsSubsetGroups, upsOutputFrequency=upsOutputFrequency, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAutoRestart=upsAutoRestart, upsControl=upsControl, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTestResultsSummary=upsTestResultsSummary, upsOutputLineIndex=upsOutputLineIndex, upsIdentName=upsIdentName, upsInputLineIndex=upsInputLineIndex, upsAlarmChargerFailed=upsAlarmChargerFailed, upsInputEntry=upsInputEntry, upsAlarmOnBattery=upsAlarmOnBattery, upsShutdownType=upsShutdownType, upsBatteryVoltage=upsBatteryVoltage, upsTestResultsDetail=upsTestResultsDetail, upsIdentManufacturer=upsIdentManufacturer, upsBypassVoltage=upsBypassVoltage, upsBasicInputGroup=upsBasicInputGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmEntry=upsAlarmEntry, upsOutputVoltage=upsOutputVoltage, upsAlarmTempBad=upsAlarmTempBad, upsFullControlGroup=upsFullControlGroup, upsFullTestGroup=upsFullTestGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsWellKnownTests=upsWellKnownTests, upsBypassCurrent=upsBypassCurrent, upsConfigOutputFreq=upsConfigOutputFreq, upsObjects=upsObjects, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsIdentAttachedDevices=upsIdentAttachedDevices, upsFullIdentGroup=upsFullIdentGroup, upsIdent=upsIdent, PYSNMP_MODULE_ID=upsMIB, upsOutputPower=upsOutputPower, upsConfig=upsConfig, upsMIB=upsMIB, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarm=upsAlarm, upsOutputTable=upsOutputTable, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBasicConfigGroup=upsBasicConfigGroup, upsBypassFrequency=upsBypassFrequency, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBasicIdentGroup=upsBasicIdentGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsGroups=upsGroups, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBypassLineIndex=upsBypassLineIndex, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmTime=upsAlarmTime, upsInputTable=upsInputTable, upsBasicBypassGroup=upsBasicBypassGroup, upsTraps=upsTraps, upsConfigInputVoltage=upsConfigInputVoltage, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsOutputSource=upsOutputSource, upsAlarmFanFailure=upsAlarmFanFailure, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsCompliances=upsCompliances, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBasicControlGroup=upsBasicControlGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsBasicCompliance=upsBasicCompliance, upsInputNumLines=upsInputNumLines, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmOutputBad=upsAlarmOutputBad, upsBypassTable=upsBypassTable, upsAlarmsPresent=upsAlarmsPresent, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsOutputPercentLoad=upsOutputPercentLoad, upsTestSpinLock=upsTestSpinLock, upsFullGroups=upsFullGroups, upsOutputNumLines=upsOutputNumLines, upsTestStartTime=upsTestStartTime, upsTestElapsedTime=upsTestElapsedTime, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsFullAlarmGroup=upsFullAlarmGroup, upsFullConfigGroup=upsFullConfigGroup, upsInput=upsInput, upsOutput=upsOutput, upsAlarmInputBad=upsAlarmInputBad, upsBasicGroups=upsBasicGroups, upsBypassEntry=upsBypassEntry, upsAlarmTable=upsAlarmTable, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmOnBypass=upsAlarmOnBypass, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsInputLineBads=upsInputLineBads, upsIdentModel=upsIdentModel, upsConfigLowBattTime=upsConfigLowBattTime, upsSubsetCompliance=upsSubsetCompliance, upsOutputCurrent=upsOutputCurrent, PositiveInteger=PositiveInteger, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullOutputGroup=upsFullOutputGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTrapTestCompleted=upsTrapTestCompleted, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBypassPower=upsBypassPower, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTest=upsTest, upsBatteryStatus=upsBatteryStatus, upsAlarmId=upsAlarmId, upsWellKnownAlarms=upsWellKnownAlarms, upsInputTruePower=upsInputTruePower, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConformance=upsConformance, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsConfigOutputVA=upsConfigOutputVA, upsBatteryTemperature=upsBatteryTemperature, upsConfigOutputPower=upsConfigOutputPower, upsConfigInputFreq=upsConfigInputFreq, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBasicTestGroup=upsBasicTestGroup, upsFullInputGroup=upsFullInputGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBatteryCurrent=upsBatteryCurrent, upsSecondsOnBattery=upsSecondsOnBattery, upsStartupAfterDelay=upsStartupAfterDelay, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBypassNumLines=upsBypassNumLines, upsFullCompliance=upsFullCompliance)
