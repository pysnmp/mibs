...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmDescr=upsAlarmDescr, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmInputBad=upsAlarmInputBad, upsInputVoltage=upsInputVoltage, upsConfigOutputVA=upsConfigOutputVA, upsAlarm=upsAlarm, upsOutputPower=upsOutputPower, upsBypassTable=upsBypassTable, upsSubsetOutputGroup=upsSubsetOutputGroup, upsConfigInputFreq=upsConfigInputFreq, upsBasicTestGroup=upsBasicTestGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsInputLineIndex=upsInputLineIndex, upsBatteryVoltage=upsBatteryVoltage, upsFullInputGroup=upsFullInputGroup, upsOutputTable=upsOutputTable, upsAlarmBypassBad=upsAlarmBypassBad, upsFullControlGroup=upsFullControlGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsCompliances=upsCompliances, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBasicBypassGroup=upsBasicBypassGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBatteryTemperature=upsBatteryTemperature, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsConfigLowBattTime=upsConfigLowBattTime, upsInputEntry=upsInputEntry, upsConformance=upsConformance, upsAlarmFanFailure=upsAlarmFanFailure, upsBasicOutputGroup=upsBasicOutputGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmOutputOverload=upsAlarmOutputOverload, upsFullBatteryGroup=upsFullBatteryGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmTime=upsAlarmTime, upsBattery=upsBattery, upsTrapTestCompleted=upsTrapTestCompleted, upsSubsetConfigGroup=upsSubsetConfigGroup, upsOutputSource=upsOutputSource, upsIdentModel=upsIdentModel, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmTable=upsAlarmTable, upsConfig=upsConfig, upsTrapOnBattery=upsTrapOnBattery, upsObjects=upsObjects, upsInputCurrent=upsInputCurrent, upsOutput=upsOutput, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTraps=upsTraps, upsBasicIdentGroup=upsBasicIdentGroup, upsShutdownType=upsShutdownType, upsConfigOutputVoltage=upsConfigOutputVoltage, upsTest=upsTest, upsTestResultsSummary=upsTestResultsSummary, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsSubsetIdentGroup=upsSubsetIdentGroup, upsOutputFrequency=upsOutputFrequency, upsAlarmEntry=upsAlarmEntry, upsConfigInputVoltage=upsConfigInputVoltage, upsTestSpinLock=upsTestSpinLock, upsInputNumLines=upsInputNumLines, upsIdentAttachedDevices=upsIdentAttachedDevices, upsControl=upsControl, upsBypass=upsBypass, upsFullTestGroup=upsFullTestGroup, upsOutputLineIndex=upsOutputLineIndex, upsFullAlarmGroup=upsFullAlarmGroup, upsFullBypassGroup=upsFullBypassGroup, upsTestStartTime=upsTestStartTime, upsFullOutputGroup=upsFullOutputGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmTempBad=upsAlarmTempBad, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsOutputNumLines=upsOutputNumLines, upsSubsetGroups=upsSubsetGroups, upsAlarmLowBattery=upsAlarmLowBattery, upsIdent=upsIdent, upsTestElapsedTime=upsTestElapsedTime, upsFullCompliance=upsFullCompliance, upsGroups=upsGroups, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsWellKnownAlarms=upsWellKnownAlarms, PYSNMP_MODULE_ID=upsMIB, upsBasicConfigGroup=upsBasicConfigGroup, upsTestId=upsTestId, upsTestResultsDetail=upsTestResultsDetail, upsOutputVoltage=upsOutputVoltage, upsBypassLineIndex=upsBypassLineIndex, upsIdentName=upsIdentName, PositiveInteger=PositiveInteger, upsBasicCompliance=upsBasicCompliance, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBasicInputGroup=upsBasicInputGroup, upsBatteryCurrent=upsBatteryCurrent, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBasicAlarmGroup=upsBasicAlarmGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullIdentGroup=upsFullIdentGroup, upsOutputEntry=upsOutputEntry, upsAlarmsPresent=upsAlarmsPresent, upsInput=upsInput, upsInputLineBads=upsInputLineBads, upsBypassCurrent=upsBypassCurrent, upsAlarmBatteryBad=upsAlarmBatteryBad, upsOutputPercentLoad=upsOutputPercentLoad, upsOutputCurrent=upsOutputCurrent, upsAlarmId=upsAlarmId, upsBatteryStatus=upsBatteryStatus, upsBypassPower=upsBypassPower, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsSecondsOnBattery=upsSecondsOnBattery, upsBasicGroups=upsBasicGroups, upsSubsetControlGroup=upsSubsetControlGroup, upsInputTable=upsInputTable, upsSubsetCompliance=upsSubsetCompliance, upsBypassNumLines=upsBypassNumLines, upsBypassVoltage=upsBypassVoltage, upsAutoRestart=upsAutoRestart, upsConfigOutputPower=upsConfigOutputPower, upsBasicControlGroup=upsBasicControlGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmOnBypass=upsAlarmOnBypass, upsBypassFrequency=upsBypassFrequency, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsBypassEntry=upsBypassEntry, upsWellKnownTests=upsWellKnownTests, NonNegativeInteger=NonNegativeInteger, upsIdentManufacturer=upsIdentManufacturer, upsFullConfigGroup=upsFullConfigGroup, upsRebootWithDuration=upsRebootWithDuration, upsMIB=upsMIB, upsFullGroups=upsFullGroups, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsInputTruePower=upsInputTruePower, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsInputFrequency=upsInputFrequency, upsAlarmChargerFailed=upsAlarmChargerFailed)
