...
mibBuilder.exportSymbols("UPS-MIB", upsBypassVoltage=upsBypassVoltage, upsInputLineIndex=upsInputLineIndex, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmInputBad=upsAlarmInputBad, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConfigLowBattTime=upsConfigLowBattTime, upsBasicConfigGroup=upsBasicConfigGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsMIB=upsMIB, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTestSpinLock=upsTestSpinLock, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBypassNumLines=upsBypassNumLines, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAutoRestart=upsAutoRestart, upsConfigOutputVoltage=upsConfigOutputVoltage, upsWellKnownAlarms=upsWellKnownAlarms, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsSubsetCompliance=upsSubsetCompliance, upsOutputNumLines=upsOutputNumLines, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsIdentManufacturer=upsIdentManufacturer, upsBypassEntry=upsBypassEntry, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTestElapsedTime=upsTestElapsedTime, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsFullOutputGroup=upsFullOutputGroup, upsBasicCompliance=upsBasicCompliance, upsAlarmDescr=upsAlarmDescr, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsConfigOutputFreq=upsConfigOutputFreq, upsBypassLineIndex=upsBypassLineIndex, upsAlarmOutputBad=upsAlarmOutputBad, upsBasicAlarmGroup=upsBasicAlarmGroup, upsOutputVoltage=upsOutputVoltage, upsFullGroups=upsFullGroups, upsFullControlGroup=upsFullControlGroup, upsIdent=upsIdent, upsOutputFrequency=upsOutputFrequency, upsAlarmsPresent=upsAlarmsPresent, upsAlarmEntry=upsAlarmEntry, upsStartupAfterDelay=upsStartupAfterDelay, upsTraps=upsTraps, upsBatteryVoltage=upsBatteryVoltage, upsConfig=upsConfig, upsShutdownType=upsShutdownType, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsOutputSource=upsOutputSource, upsControl=upsControl, upsConformance=upsConformance, upsAlarmTempBad=upsAlarmTempBad, upsIdentAttachedDevices=upsIdentAttachedDevices, upsInputLineBads=upsInputLineBads, upsBypassTable=upsBypassTable, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsIdentModel=upsIdentModel, PYSNMP_MODULE_ID=upsMIB, upsInputTable=upsInputTable, upsConfigInputFreq=upsConfigInputFreq, upsAlarmTable=upsAlarmTable, upsFullCompliance=upsFullCompliance, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBasicInputGroup=upsBasicInputGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsCompliances=upsCompliances, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBasicTestGroup=upsBasicTestGroup, upsFullIdentGroup=upsFullIdentGroup, PositiveInteger=PositiveInteger, upsFullInputGroup=upsFullInputGroup, upsTestStartTime=upsTestStartTime, upsAlarmOnBypass=upsAlarmOnBypass, upsConfigOutputVA=upsConfigOutputVA, upsInputFrequency=upsInputFrequency, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsInputTruePower=upsInputTruePower, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsInputVoltage=upsInputVoltage, upsWellKnownTests=upsWellKnownTests, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmChargerFailed=upsAlarmChargerFailed, upsOutput=upsOutput, upsTestResultsDetail=upsTestResultsDetail, upsFullBypassGroup=upsFullBypassGroup, upsIdentName=upsIdentName, upsBattery=upsBattery, upsOutputEntry=upsOutputEntry, upsInputCurrent=upsInputCurrent, upsSecondsOnBattery=upsSecondsOnBattery, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsGroups=upsGroups, upsBypassCurrent=upsBypassCurrent, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBatteryStatus=upsBatteryStatus, upsAlarmBypassBad=upsAlarmBypassBad, upsOutputTable=upsOutputTable, upsOutputPercentLoad=upsOutputPercentLoad, upsTestId=upsTestId, upsTrapOnBattery=upsTrapOnBattery, upsRebootWithDuration=upsRebootWithDuration, upsBasicOutputGroup=upsBasicOutputGroup, upsBatteryTemperature=upsBatteryTemperature, upsTestResultsSummary=upsTestResultsSummary, upsFullConfigGroup=upsFullConfigGroup, upsInput=upsInput, upsAlarmOnBattery=upsAlarmOnBattery, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBasicControlGroup=upsBasicControlGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsConfigOutputPower=upsConfigOutputPower, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBypass=upsBypass, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBasicBypassGroup=upsBasicBypassGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsBypassPower=upsBypassPower, upsInputEntry=upsInputEntry, upsObjects=upsObjects, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsConfigAudibleStatus=upsConfigAudibleStatus, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmTime=upsAlarmTime, upsFullTestGroup=upsFullTestGroup, upsTest=upsTest, upsAlarm=upsAlarm, upsFullBatteryGroup=upsFullBatteryGroup, upsOutputLineIndex=upsOutputLineIndex, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBypassFrequency=upsBypassFrequency, upsConfigInputVoltage=upsConfigInputVoltage, upsOutputCurrent=upsOutputCurrent, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmId=upsAlarmId, upsSubsetGroups=upsSubsetGroups, upsBasicGroups=upsBasicGroups, upsBatteryCurrent=upsBatteryCurrent, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, NonNegativeInteger=NonNegativeInteger, upsAlarmShutdownPending=upsAlarmShutdownPending, upsOutputPower=upsOutputPower, upsInputNumLines=upsInputNumLines)
