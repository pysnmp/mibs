...
# Produced by pysmi-1.1.8 at Mon Jan  9 09:46:55 2023
...
mibBuilder.exportSymbols("UPS-MIB", upsBypassLineIndex=upsBypassLineIndex, upsOutputLineIndex=upsOutputLineIndex, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBatteryCurrent=upsBatteryCurrent, upsInputCurrent=upsInputCurrent, upsOutputSource=upsOutputSource, upsBasicBypassGroup=upsBasicBypassGroup, upsInput=upsInput, upsBypassNumLines=upsBypassNumLines, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBasicInputGroup=upsBasicInputGroup, upsFullIdentGroup=upsFullIdentGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTestId=upsTestId, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsInputTable=upsInputTable, upsConfigAudibleStatus=upsConfigAudibleStatus, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmFuseFailure=upsAlarmFuseFailure, upsControl=upsControl, upsAlarmId=upsAlarmId, upsInputEntry=upsInputEntry, upsBasicIdentGroup=upsBasicIdentGroup, upsConfigOutputVA=upsConfigOutputVA, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsOutputVoltage=upsOutputVoltage, upsAlarmDescr=upsAlarmDescr, upsSubsetGroups=upsSubsetGroups, upsInputNumLines=upsInputNumLines, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsInputLineIndex=upsInputLineIndex, upsSecondsOnBattery=upsSecondsOnBattery, upsSubsetCompliance=upsSubsetCompliance, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBatteryStatus=upsBatteryStatus, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsFullCompliance=upsFullCompliance, upsTestResultsDetail=upsTestResultsDetail, upsFullBypassGroup=upsFullBypassGroup, upsBasicControlGroup=upsBasicControlGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmBypassBad=upsAlarmBypassBad, upsBasicGroups=upsBasicGroups, upsAlarmChargerFailed=upsAlarmChargerFailed, upsOutputEntry=upsOutputEntry, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBatteryTemperature=upsBatteryTemperature, upsBasicBatteryGroup=upsBasicBatteryGroup, upsIdentModel=upsIdentModel, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsInputVoltage=upsInputVoltage, upsIdentManufacturer=upsIdentManufacturer, upsOutputFrequency=upsOutputFrequency, upsBypassFrequency=upsBypassFrequency, upsTestElapsedTime=upsTestElapsedTime, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsFullBatteryGroup=upsFullBatteryGroup, upsBattery=upsBattery, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTest=upsTest, upsTraps=upsTraps, upsAlarmsPresent=upsAlarmsPresent, upsGroups=upsGroups, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAutoRestart=upsAutoRestart, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBypass=upsBypass, upsBasicTestGroup=upsBasicTestGroup, upsOutputNumLines=upsOutputNumLines, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, PYSNMP_MODULE_ID=upsMIB, upsFullGroups=upsFullGroups, upsTestSpinLock=upsTestSpinLock, upsAlarmOutputBad=upsAlarmOutputBad, upsConfigOutputPower=upsConfigOutputPower, upsOutputPower=upsOutputPower, upsIdentName=upsIdentName, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsFullTestGroup=upsFullTestGroup, upsBasicCompliance=upsBasicCompliance, upsOutputCurrent=upsOutputCurrent, upsCompliances=upsCompliances, NonNegativeInteger=NonNegativeInteger, upsBypassPower=upsBypassPower, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmOnBypass=upsAlarmOnBypass, upsConfigInputFreq=upsConfigInputFreq, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmTable=upsAlarmTable, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConfig=upsConfig, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsFullOutputGroup=upsFullOutputGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsBypassEntry=upsBypassEntry, upsAlarmOnBattery=upsAlarmOnBattery, upsConformance=upsConformance, upsInputLineBads=upsInputLineBads, upsInputFrequency=upsInputFrequency, upsOutput=upsOutput, upsStartupAfterDelay=upsStartupAfterDelay, upsSubsetInputGroup=upsSubsetInputGroup, upsIdent=upsIdent, upsWellKnownTests=upsWellKnownTests, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBasicConfigGroup=upsBasicConfigGroup, upsBypassCurrent=upsBypassCurrent, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarm=upsAlarm, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsFullInputGroup=upsFullInputGroup, upsTrapOnBattery=upsTrapOnBattery, upsBatteryVoltage=upsBatteryVoltage, upsAlarmTime=upsAlarmTime, upsMIB=upsMIB, upsBypassVoltage=upsBypassVoltage, PositiveInteger=PositiveInteger, upsObjects=upsObjects, upsWellKnownAlarms=upsWellKnownAlarms, upsTestResultsSummary=upsTestResultsSummary, upsTrapTestCompleted=upsTrapTestCompleted, upsRebootWithDuration=upsRebootWithDuration, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBypassTable=upsBypassTable, upsAlarmEntry=upsAlarmEntry, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsFullControlGroup=upsFullControlGroup, upsTestStartTime=upsTestStartTime, upsOutputTable=upsOutputTable, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmInputBad=upsAlarmInputBad, upsShutdownType=upsShutdownType, upsFullConfigGroup=upsFullConfigGroup, upsInputTruePower=upsInputTruePower, upsAlarmTempBad=upsAlarmTempBad)
