...
mibBuilder.exportSymbols("UPS-MIB", upsInput=upsInput, upsBasicBypassGroup=upsBasicBypassGroup, upsOutputTable=upsOutputTable, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsFullGroups=upsFullGroups, upsSubsetControlGroup=upsSubsetControlGroup, upsTestStartTime=upsTestStartTime, upsInputTable=upsInputTable, upsStartupAfterDelay=upsStartupAfterDelay, upsConfigLowBattTime=upsConfigLowBattTime, PositiveInteger=PositiveInteger, upsOutputEntry=upsOutputEntry, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBatteryTemperature=upsBatteryTemperature, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsInputTruePower=upsInputTruePower, upsIdentName=upsIdentName, upsInputNumLines=upsInputNumLines, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsInputLineIndex=upsInputLineIndex, upsBypass=upsBypass, upsBattery=upsBattery, upsBypassFrequency=upsBypassFrequency, upsTestId=upsTestId, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmTempBad=upsAlarmTempBad, upsOutputLineIndex=upsOutputLineIndex, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsOutputPower=upsOutputPower, upsAlarmTable=upsAlarmTable, upsTestResultsSummary=upsTestResultsSummary, upsShutdownAfterDelay=upsShutdownAfterDelay, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsFullOutputGroup=upsFullOutputGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBatteryVoltage=upsBatteryVoltage, upsInputVoltage=upsInputVoltage, upsObjects=upsObjects, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmOutputBad=upsAlarmOutputBad, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmInputBad=upsAlarmInputBad, upsTestResultsDetail=upsTestResultsDetail, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBypassTable=upsBypassTable, upsBypassCurrent=upsBypassCurrent, upsAlarmOnBattery=upsAlarmOnBattery, upsBasicControlGroup=upsBasicControlGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsShutdownType=upsShutdownType, upsAutoRestart=upsAutoRestart, upsSubsetIdentGroup=upsSubsetIdentGroup, PYSNMP_MODULE_ID=upsMIB, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmId=upsAlarmId, upsIdentManufacturer=upsIdentManufacturer, upsOutputFrequency=upsOutputFrequency, upsBypassNumLines=upsBypassNumLines, NonNegativeInteger=NonNegativeInteger, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsIdentModel=upsIdentModel, upsGroups=upsGroups, upsTestSpinLock=upsTestSpinLock, upsAlarmsPresent=upsAlarmsPresent, upsInputFrequency=upsInputFrequency, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsSubsetInputGroup=upsSubsetInputGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsOutputVoltage=upsOutputVoltage, upsBypassPower=upsBypassPower, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBasicInputGroup=upsBasicInputGroup, upsControl=upsControl, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsInputCurrent=upsInputCurrent, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypassEntry=upsBypassEntry, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsFullInputGroup=upsFullInputGroup, upsAlarmTime=upsAlarmTime, upsConfig=upsConfig, upsWellKnownAlarms=upsWellKnownAlarms, upsIdent=upsIdent, upsAlarmFuseFailure=upsAlarmFuseFailure, upsFullBypassGroup=upsFullBypassGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBypassLineIndex=upsBypassLineIndex, upsBasicIdentGroup=upsBasicIdentGroup, upsBasicTestGroup=upsBasicTestGroup, upsBatteryCurrent=upsBatteryCurrent, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBasicOutputGroup=upsBasicOutputGroup, upsTest=upsTest, upsBasicGroups=upsBasicGroups, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBypassVoltage=upsBypassVoltage, upsAlarmEntry=upsAlarmEntry, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigInputVoltage=upsConfigInputVoltage, upsInputLineBads=upsInputLineBads, upsTrapOnBattery=upsTrapOnBattery, upsCompliances=upsCompliances, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTrapTestCompleted=upsTrapTestCompleted, upsOutputCurrent=upsOutputCurrent, upsBasicCompliance=upsBasicCompliance, upsInputEntry=upsInputEntry, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarm=upsAlarm, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsOutputSource=upsOutputSource, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsSecondsOnBattery=upsSecondsOnBattery, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsSubsetGroups=upsSubsetGroups, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutput=upsOutput, upsOutputPercentLoad=upsOutputPercentLoad, upsTestElapsedTime=upsTestElapsedTime, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmDescr=upsAlarmDescr, upsRebootWithDuration=upsRebootWithDuration, upsConfigOutputVA=upsConfigOutputVA, upsSubsetCompliance=upsSubsetCompliance, upsConfigOutputVoltage=upsConfigOutputVoltage, upsFullTestGroup=upsFullTestGroup, upsFullControlGroup=upsFullControlGroup, upsFullCompliance=upsFullCompliance, upsMIB=upsMIB, upsConformance=upsConformance, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsWellKnownTests=upsWellKnownTests, upsFullIdentGroup=upsFullIdentGroup, upsConfigOutputPower=upsConfigOutputPower, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsFullConfigGroup=upsFullConfigGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmGeneralFault=upsAlarmGeneralFault, upsConfigInputFreq=upsConfigInputFreq, upsTraps=upsTraps, upsAlarmOutputOverload=upsAlarmOutputOverload, upsOutputNumLines=upsOutputNumLines, upsBatteryStatus=upsBatteryStatus)
