...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmFuseFailure=upsAlarmFuseFailure, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutputTable=upsOutputTable, upsSubsetConfigGroup=upsSubsetConfigGroup, upsConformance=upsConformance, upsBypassNumLines=upsBypassNumLines, upsControl=upsControl, upsOutputFrequency=upsOutputFrequency, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmsPresent=upsAlarmsPresent, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsFullOutputGroup=upsFullOutputGroup, upsIdentName=upsIdentName, upsBasicConfigGroup=upsBasicConfigGroup, PYSNMP_MODULE_ID=upsMIB, upsAlarmTempBad=upsAlarmTempBad, upsInputCurrent=upsInputCurrent, upsRebootWithDuration=upsRebootWithDuration, upsWellKnownTests=upsWellKnownTests, upsAlarmTable=upsAlarmTable, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestSpinLock=upsTestSpinLock, upsFullInputGroup=upsFullInputGroup, upsSubsetGroups=upsSubsetGroups, upsAlarmId=upsAlarmId, upsInputTruePower=upsInputTruePower, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBasicIdentGroup=upsBasicIdentGroup, upsInputFrequency=upsInputFrequency, upsAlarmFanFailure=upsAlarmFanFailure, upsFullConfigGroup=upsFullConfigGroup, NonNegativeInteger=NonNegativeInteger, upsConfigInputVoltage=upsConfigInputVoltage, upsBypassEntry=upsBypassEntry, upsAlarmShutdownPending=upsAlarmShutdownPending, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsInputNumLines=upsInputNumLines, upsConfigLowBattTime=upsConfigLowBattTime, upsBypassTable=upsBypassTable, upsFullIdentGroup=upsFullIdentGroup, upsIdent=upsIdent, upsOutputSource=upsOutputSource, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmDescr=upsAlarmDescr, upsBasicInputGroup=upsBasicInputGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsTraps=upsTraps, upsTestResultsDetail=upsTestResultsDetail, upsSecondsOnBattery=upsSecondsOnBattery, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicGroups=upsBasicGroups, upsBatteryStatus=upsBatteryStatus, upsBypassVoltage=upsBypassVoltage, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsShutdownType=upsShutdownType, upsWellKnownAlarms=upsWellKnownAlarms, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsInput=upsInput, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmEntry=upsAlarmEntry, upsTestElapsedTime=upsTestElapsedTime, upsConfigOutputVA=upsConfigOutputVA, upsFullBypassGroup=upsFullBypassGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBatteryCurrent=upsBatteryCurrent, upsAlarmBypassBad=upsAlarmBypassBad, upsOutputEntry=upsOutputEntry, upsBatteryVoltage=upsBatteryVoltage, upsConfigOutputFreq=upsConfigOutputFreq, upsBatteryTemperature=upsBatteryTemperature, upsOutputLineIndex=upsOutputLineIndex, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsOutput=upsOutput, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsOutputPower=upsOutputPower, upsBasicTestGroup=upsBasicTestGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTrapOnBattery=upsTrapOnBattery, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullTestGroup=upsFullTestGroup, upsAutoRestart=upsAutoRestart, upsAlarmGeneralFault=upsAlarmGeneralFault, upsStartupAfterDelay=upsStartupAfterDelay, upsTestResultsSummary=upsTestResultsSummary, upsConfig=upsConfig, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmTime=upsAlarmTime, upsFullGroups=upsFullGroups, upsBasicAlarmGroup=upsBasicAlarmGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBypassLineIndex=upsBypassLineIndex, upsBasicControlGroup=upsBasicControlGroup, upsOutputVoltage=upsOutputVoltage, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsSubsetControlGroup=upsSubsetControlGroup, upsInputTable=upsInputTable, upsTestId=upsTestId, upsBasicCompliance=upsBasicCompliance, upsConfigInputFreq=upsConfigInputFreq, upsSubsetIdentGroup=upsSubsetIdentGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsBypassFrequency=upsBypassFrequency, upsFullControlGroup=upsFullControlGroup, upsInputLineIndex=upsInputLineIndex, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarm=upsAlarm, upsObjects=upsObjects, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsMIB=upsMIB, upsBypassCurrent=upsBypassCurrent, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsIdentModel=upsIdentModel, upsFullCompliance=upsFullCompliance, upsBypass=upsBypass, upsAlarmChargerFailed=upsAlarmChargerFailed, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsConfigOutputVoltage=upsConfigOutputVoltage, upsIdentAttachedDevices=upsIdentAttachedDevices, upsIdentManufacturer=upsIdentManufacturer, upsConfigOutputPower=upsConfigOutputPower, upsInputEntry=upsInputEntry, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmInputBad=upsAlarmInputBad, upsAlarmOnBypass=upsAlarmOnBypass, upsCompliances=upsCompliances, upsBypassPower=upsBypassPower, upsInputLineBads=upsInputLineBads, upsGroups=upsGroups, upsOutputNumLines=upsOutputNumLines, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsSubsetAlarmGroup=upsSubsetAlarmGroup, PositiveInteger=PositiveInteger, upsBattery=upsBattery, upsAlarmOutputBad=upsAlarmOutputBad, upsTest=upsTest, upsOutputCurrent=upsOutputCurrent, upsSubsetCompliance=upsSubsetCompliance, upsTestStartTime=upsTestStartTime, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsInputVoltage=upsInputVoltage)
