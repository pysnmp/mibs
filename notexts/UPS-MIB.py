...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmTempBad=upsAlarmTempBad, upsBypassNumLines=upsBypassNumLines, upsTestStartTime=upsTestStartTime, upsTrapTestCompleted=upsTrapTestCompleted, upsRebootWithDuration=upsRebootWithDuration, upsBasicGroups=upsBasicGroups, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsInput=upsInput, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBypassVoltage=upsBypassVoltage, upsConformance=upsConformance, upsOutputEntry=upsOutputEntry, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBasicOutputGroup=upsBasicOutputGroup, upsTestResultsDetail=upsTestResultsDetail, upsFullOutputGroup=upsFullOutputGroup, upsFullTestGroup=upsFullTestGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConfigOutputPower=upsConfigOutputPower, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsShutdownAfterDelay=upsShutdownAfterDelay, upsFullControlGroup=upsFullControlGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBatteryTemperature=upsBatteryTemperature, upsAlarmEntry=upsAlarmEntry, upsAlarmOnBypass=upsAlarmOnBypass, upsTest=upsTest, upsTestResultsSummary=upsTestResultsSummary, upsStartupAfterDelay=upsStartupAfterDelay, upsOutput=upsOutput, upsInputTruePower=upsInputTruePower, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsCompliances=upsCompliances, upsInputNumLines=upsInputNumLines, upsAlarmFanFailure=upsAlarmFanFailure, upsInputEntry=upsInputEntry, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypass=upsBypass, upsBasicTestGroup=upsBasicTestGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsInputTable=upsInputTable, upsFullAlarmGroup=upsFullAlarmGroup, upsBasicControlGroup=upsBasicControlGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsFullCompliance=upsFullCompliance, upsBypassCurrent=upsBypassCurrent, upsTraps=upsTraps, upsInputCurrent=upsInputCurrent, upsSecondsOnBattery=upsSecondsOnBattery, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmOutputOverload=upsAlarmOutputOverload, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsBatteryStatus=upsBatteryStatus, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBypassLineIndex=upsBypassLineIndex, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTestId=upsTestId, upsInputVoltage=upsInputVoltage, upsAlarmInputBad=upsAlarmInputBad, upsConfigOutputVA=upsConfigOutputVA, upsAlarmDescr=upsAlarmDescr, upsConfigLowBattTime=upsConfigLowBattTime, upsFullInputGroup=upsFullInputGroup, upsAlarmTime=upsAlarmTime, upsOutputFrequency=upsOutputFrequency, upsBypassPower=upsBypassPower, upsConfigInputFreq=upsConfigInputFreq, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsFullBypassGroup=upsFullBypassGroup, upsAlarm=upsAlarm, upsInputLineIndex=upsInputLineIndex, PYSNMP_MODULE_ID=upsMIB, upsSubsetConfigGroup=upsSubsetConfigGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsObjects=upsObjects, upsAlarmGeneralFault=upsAlarmGeneralFault, upsShutdownType=upsShutdownType, upsBypassTable=upsBypassTable, upsAlarmTable=upsAlarmTable, upsAlarmOutputBad=upsAlarmOutputBad, upsIdentManufacturer=upsIdentManufacturer, upsAlarmLowBattery=upsAlarmLowBattery, upsFullConfigGroup=upsFullConfigGroup, upsBatteryCurrent=upsBatteryCurrent, upsAlarmId=upsAlarmId, upsOutputNumLines=upsOutputNumLines, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAutoRestart=upsAutoRestart, upsBasicCompliance=upsBasicCompliance, upsSubsetInputGroup=upsSubsetInputGroup, upsFullIdentGroup=upsFullIdentGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicConfigGroup=upsBasicConfigGroup, upsOutputCurrent=upsOutputCurrent, upsAlarmsPresent=upsAlarmsPresent, upsBasicAlarmGroup=upsBasicAlarmGroup, upsInputFrequency=upsInputFrequency, upsTestElapsedTime=upsTestElapsedTime, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmBypassBad=upsAlarmBypassBad, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsWellKnownTests=upsWellKnownTests, upsAlarmBatteryBad=upsAlarmBatteryBad, upsInputLineBads=upsInputLineBads, upsFullBatteryGroup=upsFullBatteryGroup, upsBypassFrequency=upsBypassFrequency, upsOutputVoltage=upsOutputVoltage, upsIdentModel=upsIdentModel, NonNegativeInteger=NonNegativeInteger, upsBasicInputGroup=upsBasicInputGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsOutputPercentLoad=upsOutputPercentLoad, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsGroups=upsGroups, upsTrapOnBattery=upsTrapOnBattery, upsMIB=upsMIB, upsBattery=upsBattery, upsFullGroups=upsFullGroups, upsControl=upsControl, PositiveInteger=PositiveInteger, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConfigOutputFreq=upsConfigOutputFreq, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetCompliance=upsSubsetCompliance, upsTestSpinLock=upsTestSpinLock, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsOutputLineIndex=upsOutputLineIndex, upsConfig=upsConfig, upsOutputPower=upsOutputPower, upsSubsetGroups=upsSubsetGroups, upsBypassEntry=upsBypassEntry, upsIdentName=upsIdentName, upsOutputSource=upsOutputSource, upsBatteryVoltage=upsBatteryVoltage, upsOutputTable=upsOutputTable, upsIdent=upsIdent, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmChargerFailed=upsAlarmChargerFailed)
