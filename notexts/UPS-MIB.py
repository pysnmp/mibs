...
mibBuilder.exportSymbols("UPS-MIB", upsFullCompliance=upsFullCompliance, upsTestSpinLock=upsTestSpinLock, upsBatteryVoltage=upsBatteryVoltage, upsAlarmFuseFailure=upsAlarmFuseFailure, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsInput=upsInput, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBasicCompliance=upsBasicCompliance, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsInputTable=upsInputTable, upsAlarmOnBypass=upsAlarmOnBypass, upsConfigInputVoltage=upsConfigInputVoltage, upsBypass=upsBypass, upsFullControlGroup=upsFullControlGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmTestInProgress=upsAlarmTestInProgress, PositiveInteger=PositiveInteger, upsBasicConfigGroup=upsBasicConfigGroup, upsFullTestGroup=upsFullTestGroup, upsInputFrequency=upsInputFrequency, upsOutputVoltage=upsOutputVoltage, upsFullGroups=upsFullGroups, upsBasicBypassGroup=upsBasicBypassGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmTable=upsAlarmTable, upsConfigOutputVA=upsConfigOutputVA, upsBattery=upsBattery, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsSecondsOnBattery=upsSecondsOnBattery, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsConfig=upsConfig, upsFullBypassGroup=upsFullBypassGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsBatteryTemperature=upsBatteryTemperature, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBypassNumLines=upsBypassNumLines, upsInputTruePower=upsInputTruePower, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmFanFailure=upsAlarmFanFailure, upsStartupAfterDelay=upsStartupAfterDelay, upsBypassVoltage=upsBypassVoltage, upsConfigAudibleStatus=upsConfigAudibleStatus, upsWellKnownTests=upsWellKnownTests, upsAlarm=upsAlarm, upsIdentManufacturer=upsIdentManufacturer, upsBasicInputGroup=upsBasicInputGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsObjects=upsObjects, upsGroups=upsGroups, upsConfigInputFreq=upsConfigInputFreq, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsMIB=upsMIB, upsAlarmOutputOverload=upsAlarmOutputOverload, upsConfigOutputPower=upsConfigOutputPower, upsBasicAlarmGroup=upsBasicAlarmGroup, upsTestElapsedTime=upsTestElapsedTime, upsOutputSource=upsOutputSource, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsIdentName=upsIdentName, upsFullConfigGroup=upsFullConfigGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsFullInputGroup=upsFullInputGroup, upsInputNumLines=upsInputNumLines, upsBasicGroups=upsBasicGroups, upsTraps=upsTraps, upsAlarmLowBattery=upsAlarmLowBattery, upsTrapOnBattery=upsTrapOnBattery, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsConfigOutputFreq=upsConfigOutputFreq, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmTime=upsAlarmTime, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBasicIdentGroup=upsBasicIdentGroup, upsTestStartTime=upsTestStartTime, upsAlarmInputBad=upsAlarmInputBad, upsAlarmBypassBad=upsAlarmBypassBad, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBypassFrequency=upsBypassFrequency, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmEntry=upsAlarmEntry, upsAutoRestart=upsAutoRestart, upsOutputPercentLoad=upsOutputPercentLoad, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmChargerFailed=upsAlarmChargerFailed, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmsPresent=upsAlarmsPresent, upsInputLineBads=upsInputLineBads, upsTestId=upsTestId, upsOutputPower=upsOutputPower, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsOutputTable=upsOutputTable, upsCompliances=upsCompliances, upsSubsetGroups=upsSubsetGroups, upsInputCurrent=upsInputCurrent, upsBypassCurrent=upsBypassCurrent, upsBypassEntry=upsBypassEntry, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsConformance=upsConformance, upsBatteryStatus=upsBatteryStatus, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBypassLineIndex=upsBypassLineIndex, upsBypassTable=upsBypassTable, upsAlarmId=upsAlarmId, upsIdent=upsIdent, upsTestResultsDetail=upsTestResultsDetail, upsAlarmTempBad=upsAlarmTempBad, upsOutputCurrent=upsOutputCurrent, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsShutdownAfterDelay=upsShutdownAfterDelay, upsOutputEntry=upsOutputEntry, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullIdentGroup=upsFullIdentGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsRebootWithDuration=upsRebootWithDuration, upsOutputNumLines=upsOutputNumLines, upsInputLineIndex=upsInputLineIndex, upsAlarmShutdownPending=upsAlarmShutdownPending, upsOutputFrequency=upsOutputFrequency, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTestResultsSummary=upsTestResultsSummary, upsSubsetCompliance=upsSubsetCompliance, NonNegativeInteger=NonNegativeInteger, upsBasicBatteryGroup=upsBasicBatteryGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsInputVoltage=upsInputVoltage, upsControl=upsControl, upsTrapTestCompleted=upsTrapTestCompleted, upsFullOutputGroup=upsFullOutputGroup, upsShutdownType=upsShutdownType, upsBasicTestGroup=upsBasicTestGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicControlGroup=upsBasicControlGroup, upsBypassPower=upsBypassPower, upsBatteryCurrent=upsBatteryCurrent, upsAlarmOnBattery=upsAlarmOnBattery, upsBasicOutputGroup=upsBasicOutputGroup, upsOutput=upsOutput, upsTest=upsTest, upsInputEntry=upsInputEntry, PYSNMP_MODULE_ID=upsMIB, upsIdentModel=upsIdentModel, upsOutputLineIndex=upsOutputLineIndex, upsAlarmDescr=upsAlarmDescr, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTestAbortTestInProgress=upsTestAbortTestInProgress)
