...
mibBuilder.exportSymbols("UPS-MIB", upsSubsetIdentGroup=upsSubsetIdentGroup, upsOutputPower=upsOutputPower, upsConformance=upsConformance, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBasicTestGroup=upsBasicTestGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsOutputNumLines=upsOutputNumLines, upsSubsetInputGroup=upsSubsetInputGroup, upsTest=upsTest, upsIdentName=upsIdentName, upsTestElapsedTime=upsTestElapsedTime, upsAlarmFanFailure=upsAlarmFanFailure, upsSubsetGroups=upsSubsetGroups, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBattery=upsBattery, upsConfig=upsConfig, upsAlarmOutputBad=upsAlarmOutputBad, upsBasicCompliance=upsBasicCompliance, upsInputCurrent=upsInputCurrent, upsAlarmEntry=upsAlarmEntry, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBasicConfigGroup=upsBasicConfigGroup, NonNegativeInteger=NonNegativeInteger, upsBypassVoltage=upsBypassVoltage, upsAlarmTime=upsAlarmTime, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsOutputTable=upsOutputTable, upsFullIdentGroup=upsFullIdentGroup, upsAlarmId=upsAlarmId, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmTempBad=upsAlarmTempBad, upsConfigOutputVA=upsConfigOutputVA, upsAlarmGeneralFault=upsAlarmGeneralFault, upsIdent=upsIdent, upsOutputCurrent=upsOutputCurrent, upsMIB=upsMIB, upsFullInputGroup=upsFullInputGroup, PYSNMP_MODULE_ID=upsMIB, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsFullConfigGroup=upsFullConfigGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsGroups=upsGroups, upsInputTruePower=upsInputTruePower, upsConfigOutputFreq=upsConfigOutputFreq, upsBasicInputGroup=upsBasicInputGroup, upsInput=upsInput, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsInputLineBads=upsInputLineBads, upsInputFrequency=upsInputFrequency, upsBatteryCurrent=upsBatteryCurrent, upsBasicBypassGroup=upsBasicBypassGroup, upsOutputSource=upsOutputSource, upsOutputFrequency=upsOutputFrequency, upsFullTestGroup=upsFullTestGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsTraps=upsTraps, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmBatteryBad=upsAlarmBatteryBad, upsShutdownType=upsShutdownType, upsOutputPercentLoad=upsOutputPercentLoad, upsTestResultsSummary=upsTestResultsSummary, upsIdentModel=upsIdentModel, upsBasicBatteryGroup=upsBasicBatteryGroup, upsInputTable=upsInputTable, upsSubsetConfigGroup=upsSubsetConfigGroup, upsInputLineIndex=upsInputLineIndex, upsBypassPower=upsBypassPower, upsFullBypassGroup=upsFullBypassGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBatteryVoltage=upsBatteryVoltage, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmDescr=upsAlarmDescr, upsControl=upsControl, upsWellKnownAlarms=upsWellKnownAlarms, upsSecondsOnBattery=upsSecondsOnBattery, upsBatteryTemperature=upsBatteryTemperature, upsAlarmsPresent=upsAlarmsPresent, upsSubsetCompliance=upsSubsetCompliance, PositiveInteger=PositiveInteger, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBasicControlGroup=upsBasicControlGroup, upsOutput=upsOutput, upsBatteryStatus=upsBatteryStatus, upsStartupAfterDelay=upsStartupAfterDelay, upsConfigLowBattTime=upsConfigLowBattTime, upsObjects=upsObjects, upsAlarmLowBattery=upsAlarmLowBattery, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsConfigOutputPower=upsConfigOutputPower, upsBypassLineIndex=upsBypassLineIndex, upsFullCompliance=upsFullCompliance, upsSubsetControlGroup=upsSubsetControlGroup, upsBypassFrequency=upsBypassFrequency, upsFullGroups=upsFullGroups, upsRebootWithDuration=upsRebootWithDuration, upsInputNumLines=upsInputNumLines, upsAlarmBypassBad=upsAlarmBypassBad, upsBasicGroups=upsBasicGroups, upsAutoRestart=upsAutoRestart, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBasicAlarmGroup=upsBasicAlarmGroup, upsFullOutputGroup=upsFullOutputGroup, upsOutputEntry=upsOutputEntry, upsAlarmTable=upsAlarmTable, upsInputVoltage=upsInputVoltage, upsBasicOutputGroup=upsBasicOutputGroup, upsCompliances=upsCompliances, upsBypass=upsBypass, upsOutputLineIndex=upsOutputLineIndex, upsTestStartTime=upsTestStartTime, upsWellKnownTests=upsWellKnownTests, upsSubsetOutputGroup=upsSubsetOutputGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestId=upsTestId, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTestSpinLock=upsTestSpinLock, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBypassTable=upsBypassTable, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBypassEntry=upsBypassEntry, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsTrapOnBattery=upsTrapOnBattery, upsAlarm=upsAlarm, upsFullBatteryGroup=upsFullBatteryGroup, upsConfigInputFreq=upsConfigInputFreq, upsOutputVoltage=upsOutputVoltage, upsBypassCurrent=upsBypassCurrent, upsBypassNumLines=upsBypassNumLines, upsTrapTestCompleted=upsTrapTestCompleted, upsFullControlGroup=upsFullControlGroup, upsIdentManufacturer=upsIdentManufacturer, upsTestResultsDetail=upsTestResultsDetail, upsAlarmInputBad=upsAlarmInputBad, upsAlarmOnBypass=upsAlarmOnBypass, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsInputEntry=upsInputEntry, upsIdentAttachedDevices=upsIdentAttachedDevices, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestNoTestsInitiated=upsTestNoTestsInitiated)
