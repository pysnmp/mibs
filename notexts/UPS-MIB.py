...
mibBuilder.exportSymbols("UPS-MIB", upsRebootWithDuration=upsRebootWithDuration, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsInputVoltage=upsInputVoltage, upsShutdownAfterDelay=upsShutdownAfterDelay, upsOutputNumLines=upsOutputNumLines, upsAlarmsPresent=upsAlarmsPresent, upsControl=upsControl, upsSecondsOnBattery=upsSecondsOnBattery, upsOutputTable=upsOutputTable, upsBypassNumLines=upsBypassNumLines, upsBasicConfigGroup=upsBasicConfigGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmEntry=upsAlarmEntry, upsBattery=upsBattery, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBypassTable=upsBypassTable, upsBypassCurrent=upsBypassCurrent, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsCompliances=upsCompliances, upsFullTestGroup=upsFullTestGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsTrapOnBattery=upsTrapOnBattery, upsFullBypassGroup=upsFullBypassGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsIdentName=upsIdentName, upsAlarmInputBad=upsAlarmInputBad, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsFullGroups=upsFullGroups, upsFullControlGroup=upsFullControlGroup, upsBypassFrequency=upsBypassFrequency, upsConformance=upsConformance, upsAlarmOnBypass=upsAlarmOnBypass, upsTestSpinLock=upsTestSpinLock, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, NonNegativeInteger=NonNegativeInteger, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBasicBypassGroup=upsBasicBypassGroup, upsGroups=upsGroups, upsAlarmId=upsAlarmId, upsAlarmShutdownPending=upsAlarmShutdownPending, upsOutputSource=upsOutputSource, upsBypassEntry=upsBypassEntry, upsTest=upsTest, upsInputCurrent=upsInputCurrent, upsOutputLineIndex=upsOutputLineIndex, upsIdentModel=upsIdentModel, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBasicInputGroup=upsBasicInputGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsInputTable=upsInputTable, PositiveInteger=PositiveInteger, upsBatteryTemperature=upsBatteryTemperature, upsAlarmBatteryBad=upsAlarmBatteryBad, upsOutputPower=upsOutputPower, upsObjects=upsObjects, upsOutputFrequency=upsOutputFrequency, upsAlarmTime=upsAlarmTime, upsConfig=upsConfig, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicControlGroup=upsBasicControlGroup, upsMIB=upsMIB, upsTraps=upsTraps, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBypassPower=upsBypassPower, upsFullConfigGroup=upsFullConfigGroup, upsTestResultsSummary=upsTestResultsSummary, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsShutdownType=upsShutdownType, upsAlarmChargerFailed=upsAlarmChargerFailed, upsSubsetCompliance=upsSubsetCompliance, upsBatteryVoltage=upsBatteryVoltage, upsTestResultsDetail=upsTestResultsDetail, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmLowBattery=upsAlarmLowBattery, upsBatteryCurrent=upsBatteryCurrent, upsAlarm=upsAlarm, upsConfigLowBattTime=upsConfigLowBattTime, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsWellKnownTests=upsWellKnownTests, upsInput=upsInput, upsAlarmDescr=upsAlarmDescr, upsIdentManufacturer=upsIdentManufacturer, upsInputNumLines=upsInputNumLines, upsSubsetGroups=upsSubsetGroups, upsTestStartTime=upsTestStartTime, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBatteryStatus=upsBatteryStatus, upsFullCompliance=upsFullCompliance, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsConfigInputFreq=upsConfigInputFreq, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBasicOutputGroup=upsBasicOutputGroup, upsConfigOutputVA=upsConfigOutputVA, upsOutput=upsOutput, upsFullIdentGroup=upsFullIdentGroup, upsFullInputGroup=upsFullInputGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutputEntry=upsOutputEntry, upsBasicGroups=upsBasicGroups, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsConfigAudibleStatus=upsConfigAudibleStatus, upsInputEntry=upsInputEntry, upsAutoRestart=upsAutoRestart, upsBypassLineIndex=upsBypassLineIndex, upsConfigOutputVoltage=upsConfigOutputVoltage, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBasicTestGroup=upsBasicTestGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConfigOutputFreq=upsConfigOutputFreq, upsOutputCurrent=upsOutputCurrent, upsFullOutputGroup=upsFullOutputGroup, upsInputLineBads=upsInputLineBads, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsIdent=upsIdent, upsAlarmTempBad=upsAlarmTempBad, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsOutputPercentLoad=upsOutputPercentLoad, upsBypassVoltage=upsBypassVoltage, upsOutputVoltage=upsOutputVoltage, upsConfigInputVoltage=upsConfigInputVoltage, upsTestElapsedTime=upsTestElapsedTime, upsTestId=upsTestId, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsConfigOutputPower=upsConfigOutputPower, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmTable=upsAlarmTable, upsBasicCompliance=upsBasicCompliance, upsBypass=upsBypass, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsInputTruePower=upsInputTruePower, upsInputLineIndex=upsInputLineIndex, upsInputFrequency=upsInputFrequency, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, PYSNMP_MODULE_ID=upsMIB)
