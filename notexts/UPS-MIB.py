...
mibBuilder.exportSymbols("UPS-MIB", upsConfigInputFreq=upsConfigInputFreq, upsIdentAttachedDevices=upsIdentAttachedDevices, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsIdentModel=upsIdentModel, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsInputVoltage=upsInputVoltage, upsBasicBypassGroup=upsBasicBypassGroup, upsFullIdentGroup=upsFullIdentGroup, upsTestResultsSummary=upsTestResultsSummary, upsAlarmFanFailure=upsAlarmFanFailure, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsShutdownType=upsShutdownType, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsInputLineBads=upsInputLineBads, upsBypassVoltage=upsBypassVoltage, upsBatteryStatus=upsBatteryStatus, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicInputGroup=upsBasicInputGroup, NonNegativeInteger=NonNegativeInteger, upsConfigOutputFreq=upsConfigOutputFreq, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTestElapsedTime=upsTestElapsedTime, upsBattery=upsBattery, upsAlarmShutdownPending=upsAlarmShutdownPending, upsFullConfigGroup=upsFullConfigGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsTrapTestCompleted=upsTrapTestCompleted, upsFullCompliance=upsFullCompliance, upsBasicTestGroup=upsBasicTestGroup, upsFullBypassGroup=upsFullBypassGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsControl=upsControl, PositiveInteger=PositiveInteger, upsInputLineIndex=upsInputLineIndex, upsConfigAudibleStatus=upsConfigAudibleStatus, upsOutput=upsOutput, upsBatteryVoltage=upsBatteryVoltage, upsAlarmEntry=upsAlarmEntry, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBypassCurrent=upsBypassCurrent, upsOutputPower=upsOutputPower, upsSubsetGroups=upsSubsetGroups, upsStartupAfterDelay=upsStartupAfterDelay, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmOnBypass=upsAlarmOnBypass, upsGroups=upsGroups, upsBasicControlGroup=upsBasicControlGroup, upsConfigOutputVA=upsConfigOutputVA, upsBatteryTemperature=upsBatteryTemperature, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBasicConfigGroup=upsBasicConfigGroup, upsFullGroups=upsFullGroups, upsAlarmTime=upsAlarmTime, upsCompliances=upsCompliances, upsOutputVoltage=upsOutputVoltage, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetControlGroup=upsSubsetControlGroup, upsFullControlGroup=upsFullControlGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBatteryCurrent=upsBatteryCurrent, upsBypassEntry=upsBypassEntry, upsBasicGroups=upsBasicGroups, upsAlarmInputBad=upsAlarmInputBad, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsOutputEntry=upsOutputEntry, upsAlarmsPresent=upsAlarmsPresent, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsInputEntry=upsInputEntry, upsConfig=upsConfig, upsRebootWithDuration=upsRebootWithDuration, upsAlarmDescr=upsAlarmDescr, upsTrapOnBattery=upsTrapOnBattery, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsTraps=upsTraps, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTestStartTime=upsTestStartTime, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsIdentManufacturer=upsIdentManufacturer, upsBypassTable=upsBypassTable, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmBatteryBad=upsAlarmBatteryBad, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsConformance=upsConformance, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmGeneralFault=upsAlarmGeneralFault, upsOutputSource=upsOutputSource, upsBypassNumLines=upsBypassNumLines, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAutoRestart=upsAutoRestart, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmOutputBad=upsAlarmOutputBad, upsIdentName=upsIdentName, upsAlarmTable=upsAlarmTable, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypassLineIndex=upsBypassLineIndex, upsAlarmId=upsAlarmId, upsInputTable=upsInputTable, upsOutputCurrent=upsOutputCurrent, upsBasicAlarmGroup=upsBasicAlarmGroup, upsIdent=upsIdent, upsTestId=upsTestId, upsFullTestGroup=upsFullTestGroup, upsOutputLineIndex=upsOutputLineIndex, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmBypassBad=upsAlarmBypassBad, upsBypassFrequency=upsBypassFrequency, upsOutputFrequency=upsOutputFrequency, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarm=upsAlarm, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBasicCompliance=upsBasicCompliance, upsSubsetCompliance=upsSubsetCompliance, upsInputNumLines=upsInputNumLines, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBypassPower=upsBypassPower, upsAlarmTempBad=upsAlarmTempBad, upsBasicOutputGroup=upsBasicOutputGroup, upsBypass=upsBypass, upsTest=upsTest, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsMIB=upsMIB, upsTestResultsDetail=upsTestResultsDetail, upsFullBatteryGroup=upsFullBatteryGroup, upsTestSpinLock=upsTestSpinLock, upsInputFrequency=upsInputFrequency, upsFullInputGroup=upsFullInputGroup, upsInputCurrent=upsInputCurrent, upsOutputNumLines=upsOutputNumLines, upsWellKnownTests=upsWellKnownTests, upsAlarmChargerFailed=upsAlarmChargerFailed, upsFullOutputGroup=upsFullOutputGroup, upsConfigOutputPower=upsConfigOutputPower, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsInput=upsInput, upsInputTruePower=upsInputTruePower, upsOutputTable=upsOutputTable, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, PYSNMP_MODULE_ID=upsMIB, upsShutdownAfterDelay=upsShutdownAfterDelay, upsObjects=upsObjects, upsOutputPercentLoad=upsOutputPercentLoad)
