...
mibBuilder.exportSymbols("UPS-MIB", upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmTable=upsAlarmTable, upsAlarmTime=upsAlarmTime, upsFullIdentGroup=upsFullIdentGroup, upsOutputEntry=upsOutputEntry, upsOutput=upsOutput, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTraps=upsTraps, upsIdent=upsIdent, upsConfigInputFreq=upsConfigInputFreq, PYSNMP_MODULE_ID=upsMIB, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsSubsetCompliance=upsSubsetCompliance, upsWellKnownTests=upsWellKnownTests, upsBypassPower=upsBypassPower, upsBypassVoltage=upsBypassVoltage, upsBypassFrequency=upsBypassFrequency, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsInputVoltage=upsInputVoltage, upsAlarmOnBattery=upsAlarmOnBattery, upsFullControlGroup=upsFullControlGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsShutdownType=upsShutdownType, upsMIB=upsMIB, upsIdentName=upsIdentName, upsSubsetControlGroup=upsSubsetControlGroup, upsControl=upsControl, upsFullTestGroup=upsFullTestGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsIdentManufacturer=upsIdentManufacturer, upsBasicBypassGroup=upsBasicBypassGroup, NonNegativeInteger=NonNegativeInteger, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarm=upsAlarm, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBattery=upsBattery, upsIdentModel=upsIdentModel, upsInputNumLines=upsInputNumLines, upsInputLineIndex=upsInputLineIndex, upsOutputSource=upsOutputSource, upsOutputVoltage=upsOutputVoltage, upsBasicOutputGroup=upsBasicOutputGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmOutputBad=upsAlarmOutputBad, upsInputFrequency=upsInputFrequency, upsAlarmOutputOverload=upsAlarmOutputOverload, upsFullBypassGroup=upsFullBypassGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicTestGroup=upsBasicTestGroup, upsAlarmInputBad=upsAlarmInputBad, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBypassEntry=upsBypassEntry, upsAlarmOnBypass=upsAlarmOnBypass, upsInputLineBads=upsInputLineBads, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBasicCompliance=upsBasicCompliance, upsFullCompliance=upsFullCompliance, upsInput=upsInput, upsTestStartTime=upsTestStartTime, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBatteryTemperature=upsBatteryTemperature, upsBypassLineIndex=upsBypassLineIndex, upsAlarmLowBattery=upsAlarmLowBattery, upsFullConfigGroup=upsFullConfigGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsConfigOutputPower=upsConfigOutputPower, upsSecondsOnBattery=upsSecondsOnBattery, upsTestElapsedTime=upsTestElapsedTime, upsCompliances=upsCompliances, upsBasicConfigGroup=upsBasicConfigGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsBypassNumLines=upsBypassNumLines, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBatteryCurrent=upsBatteryCurrent, upsTestResultsSummary=upsTestResultsSummary, upsFullGroups=upsFullGroups, upsOutputCurrent=upsOutputCurrent, upsBasicIdentGroup=upsBasicIdentGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBypassTable=upsBypassTable, upsAlarmId=upsAlarmId, upsInputTruePower=upsInputTruePower, upsAlarmShutdownPending=upsAlarmShutdownPending, PositiveInteger=PositiveInteger, upsWellKnownAlarms=upsWellKnownAlarms, upsAutoRestart=upsAutoRestart, upsInputCurrent=upsInputCurrent, upsTrapOnBattery=upsTrapOnBattery, upsBasicBatteryGroup=upsBasicBatteryGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutputLineIndex=upsOutputLineIndex, upsConfigLowBattTime=upsConfigLowBattTime, upsFullInputGroup=upsFullInputGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsRebootWithDuration=upsRebootWithDuration, upsOutputPower=upsOutputPower, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBasicGroups=upsBasicGroups, upsFullBatteryGroup=upsFullBatteryGroup, upsBasicControlGroup=upsBasicControlGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBatteryStatus=upsBatteryStatus, upsAlarmFanFailure=upsAlarmFanFailure, upsGroups=upsGroups, upsTestResultsDetail=upsTestResultsDetail, upsAlarmsPresent=upsAlarmsPresent, upsObjects=upsObjects, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsTestId=upsTestId, upsSubsetInputGroup=upsSubsetInputGroup, upsBypass=upsBypass, upsOutputPercentLoad=upsOutputPercentLoad, upsOutputTable=upsOutputTable, upsAlarmEntry=upsAlarmEntry, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmDescr=upsAlarmDescr, upsShutdownAfterDelay=upsShutdownAfterDelay, upsConfigOutputVA=upsConfigOutputVA, upsConfigOutputVoltage=upsConfigOutputVoltage, upsConformance=upsConformance, upsTest=upsTest, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsInputEntry=upsInputEntry, upsBatteryVoltage=upsBatteryVoltage, upsBypassCurrent=upsBypassCurrent, upsInputTable=upsInputTable, upsConfig=upsConfig, upsAlarmTempBad=upsAlarmTempBad, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTestSpinLock=upsTestSpinLock, upsFullAlarmGroup=upsFullAlarmGroup, upsOutputFrequency=upsOutputFrequency, upsSubsetConfigGroup=upsSubsetConfigGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsSubsetGroups=upsSubsetGroups, upsOutputNumLines=upsOutputNumLines, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBasicInputGroup=upsBasicInputGroup, upsFullOutputGroup=upsFullOutputGroup)
