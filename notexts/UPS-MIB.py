...
mibBuilder.exportSymbols("UPS-MIB", upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsTrapOnBattery=upsTrapOnBattery, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsOutputPower=upsOutputPower, upsFullGroups=upsFullGroups, upsAlarmDescr=upsAlarmDescr, upsBatteryTemperature=upsBatteryTemperature, upsAlarmChargerFailed=upsAlarmChargerFailed, upsWellKnownAlarms=upsWellKnownAlarms, upsInputTable=upsInputTable, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsStartupAfterDelay=upsStartupAfterDelay, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBasicAlarmGroup=upsBasicAlarmGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsIdentManufacturer=upsIdentManufacturer, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBasicCompliance=upsBasicCompliance, upsSubsetIdentGroup=upsSubsetIdentGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsCompliances=upsCompliances, upsConfigInputVoltage=upsConfigInputVoltage, upsOutputFrequency=upsOutputFrequency, upsSecondsOnBattery=upsSecondsOnBattery, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTestSpinLock=upsTestSpinLock, PYSNMP_MODULE_ID=upsMIB, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBasicIdentGroup=upsBasicIdentGroup, upsBypassCurrent=upsBypassCurrent, upsAlarm=upsAlarm, upsInputTruePower=upsInputTruePower, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmShutdownPending=upsAlarmShutdownPending, upsInputEntry=upsInputEntry, NonNegativeInteger=NonNegativeInteger, upsBypassEntry=upsBypassEntry, upsConfig=upsConfig, upsConfigOutputVA=upsConfigOutputVA, upsControl=upsControl, upsBasicBatteryGroup=upsBasicBatteryGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsConfigOutputPower=upsConfigOutputPower, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestStartTime=upsTestStartTime, upsTrapTestCompleted=upsTrapTestCompleted, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullCompliance=upsFullCompliance, upsInput=upsInput, upsFullOutputGroup=upsFullOutputGroup, upsShutdownType=upsShutdownType, upsBypassTable=upsBypassTable, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsFullBatteryGroup=upsFullBatteryGroup, upsBypassLineIndex=upsBypassLineIndex, upsOutputPercentLoad=upsOutputPercentLoad, upsInputNumLines=upsInputNumLines, upsFullInputGroup=upsFullInputGroup, upsTestResultsDetail=upsTestResultsDetail, upsBasicControlGroup=upsBasicControlGroup, upsConformance=upsConformance, upsOutputCurrent=upsOutputCurrent, upsBypassNumLines=upsBypassNumLines, upsAlarmOutputBad=upsAlarmOutputBad, upsGroups=upsGroups, upsObjects=upsObjects, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicInputGroup=upsBasicInputGroup, upsOutputNumLines=upsOutputNumLines, upsBypassPower=upsBypassPower, upsBypass=upsBypass, upsAlarmTempBad=upsAlarmTempBad, upsBasicGroups=upsBasicGroups, upsAlarmTime=upsAlarmTime, upsBatteryCurrent=upsBatteryCurrent, upsOutputSource=upsOutputSource, upsFullControlGroup=upsFullControlGroup, upsWellKnownTests=upsWellKnownTests, upsAlarmGeneralFault=upsAlarmGeneralFault, upsInputVoltage=upsInputVoltage, upsTestResultsSummary=upsTestResultsSummary, upsRebootWithDuration=upsRebootWithDuration, upsFullBypassGroup=upsFullBypassGroup, upsIdent=upsIdent, upsIdentName=upsIdentName, upsSubsetConfigGroup=upsSubsetConfigGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmTable=upsAlarmTable, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsOutputTable=upsOutputTable, upsAlarmId=upsAlarmId, upsInputLineBads=upsInputLineBads, upsInputLineIndex=upsInputLineIndex, upsTestElapsedTime=upsTestElapsedTime, upsBypassVoltage=upsBypassVoltage, upsTraps=upsTraps, upsBattery=upsBattery, upsInputFrequency=upsInputFrequency, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmOnBypass=upsAlarmOnBypass, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTest=upsTest, upsAlarmInputBad=upsAlarmInputBad, upsConfigInputFreq=upsConfigInputFreq, upsBypassFrequency=upsBypassFrequency, upsInputCurrent=upsInputCurrent, upsConfigOutputFreq=upsConfigOutputFreq, upsOutputVoltage=upsOutputVoltage, upsSubsetCompliance=upsSubsetCompliance, upsFullTestGroup=upsFullTestGroup, upsSubsetGroups=upsSubsetGroups, upsOutputEntry=upsOutputEntry, upsBasicTestGroup=upsBasicTestGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmEntry=upsAlarmEntry, upsAutoRestart=upsAutoRestart, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConfigAudibleStatus=upsConfigAudibleStatus, upsFullConfigGroup=upsFullConfigGroup, upsBatteryVoltage=upsBatteryVoltage, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsIdentModel=upsIdentModel, upsOutput=upsOutput, PositiveInteger=PositiveInteger, upsAlarmsPresent=upsAlarmsPresent, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsMIB=upsMIB, upsOutputLineIndex=upsOutputLineIndex, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsTestId=upsTestId, upsAlarmFanFailure=upsAlarmFanFailure, upsConfigOutputVoltage=upsConfigOutputVoltage, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicOutputGroup=upsBasicOutputGroup, upsFullIdentGroup=upsFullIdentGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsBatteryStatus=upsBatteryStatus, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest)
