...
mibBuilder.exportSymbols("UPS-MIB", upsShutdownType=upsShutdownType, upsTrapTestCompleted=upsTrapTestCompleted, upsConfigLowBattTime=upsConfigLowBattTime, upsBasicTestGroup=upsBasicTestGroup, upsBasicControlGroup=upsBasicControlGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsOutput=upsOutput, NonNegativeInteger=NonNegativeInteger, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsFullBatteryGroup=upsFullBatteryGroup, upsSubsetGroups=upsSubsetGroups, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBypassTable=upsBypassTable, upsTestId=upsTestId, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBatteryVoltage=upsBatteryVoltage, upsBypassEntry=upsBypassEntry, upsSecondsOnBattery=upsSecondsOnBattery, upsInputCurrent=upsInputCurrent, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestStartTime=upsTestStartTime, upsSubsetControlGroup=upsSubsetControlGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBypassNumLines=upsBypassNumLines, upsWellKnownTests=upsWellKnownTests, upsInputTable=upsInputTable, upsTestElapsedTime=upsTestElapsedTime, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsIdentManufacturer=upsIdentManufacturer, upsOutputNumLines=upsOutputNumLines, upsCompliances=upsCompliances, upsInputFrequency=upsInputFrequency, upsBypassVoltage=upsBypassVoltage, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsIdentAttachedDevices=upsIdentAttachedDevices, upsIdent=upsIdent, upsFullBypassGroup=upsFullBypassGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsSubsetCompliance=upsSubsetCompliance, upsConformance=upsConformance, upsSubsetOutputGroup=upsSubsetOutputGroup, upsTest=upsTest, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsInputNumLines=upsInputNumLines, upsIdentModel=upsIdentModel, upsOutputFrequency=upsOutputFrequency, upsAlarmsPresent=upsAlarmsPresent, upsAlarmOnBattery=upsAlarmOnBattery, upsOutputPercentLoad=upsOutputPercentLoad, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsFullCompliance=upsFullCompliance, upsFullGroups=upsFullGroups, upsSubsetConfigGroup=upsSubsetConfigGroup, upsControl=upsControl, upsRebootWithDuration=upsRebootWithDuration, upsBatteryTemperature=upsBatteryTemperature, upsBattery=upsBattery, upsFullInputGroup=upsFullInputGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsWellKnownAlarms=upsWellKnownAlarms, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullOutputGroup=upsFullOutputGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmOutputBad=upsAlarmOutputBad, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsInputLineIndex=upsInputLineIndex, upsAlarmGeneralFault=upsAlarmGeneralFault, upsGroups=upsGroups, upsFullControlGroup=upsFullControlGroup, upsAlarm=upsAlarm, upsFullConfigGroup=upsFullConfigGroup, upsTestSpinLock=upsTestSpinLock, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBasicCompliance=upsBasicCompliance, upsBatteryCurrent=upsBatteryCurrent, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBypass=upsBypass, upsInputLineBads=upsInputLineBads, upsTestResultsDetail=upsTestResultsDetail, PositiveInteger=PositiveInteger, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBasicGroups=upsBasicGroups, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsConfigOutputVoltage=upsConfigOutputVoltage, upsConfigInputFreq=upsConfigInputFreq, upsBasicOutputGroup=upsBasicOutputGroup, upsConfig=upsConfig, upsInputVoltage=upsInputVoltage, upsOutputSource=upsOutputSource, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmBypassBad=upsAlarmBypassBad, upsFullIdentGroup=upsFullIdentGroup, upsFullTestGroup=upsFullTestGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsOutputPower=upsOutputPower, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmTempBad=upsAlarmTempBad, upsBasicBypassGroup=upsBasicBypassGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsInputTruePower=upsInputTruePower, upsTestResultsSummary=upsTestResultsSummary, PYSNMP_MODULE_ID=upsMIB, upsOutputVoltage=upsOutputVoltage, upsObjects=upsObjects, upsAlarmOnBypass=upsAlarmOnBypass, upsBypassPower=upsBypassPower, upsConfigOutputPower=upsConfigOutputPower, upsFullAlarmGroup=upsFullAlarmGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsBypassFrequency=upsBypassFrequency, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAutoRestart=upsAutoRestart, upsTrapOnBattery=upsTrapOnBattery, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmId=upsAlarmId, upsInput=upsInput, upsBypassCurrent=upsBypassCurrent, upsTraps=upsTraps, upsBasicInputGroup=upsBasicInputGroup, upsOutputTable=upsOutputTable, upsBatteryStatus=upsBatteryStatus, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsInputEntry=upsInputEntry, upsAlarmTable=upsAlarmTable, upsIdentName=upsIdentName, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBypassLineIndex=upsBypassLineIndex, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmTime=upsAlarmTime, upsAlarmEntry=upsAlarmEntry, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmInputBad=upsAlarmInputBad, upsMIB=upsMIB, upsBasicIdentGroup=upsBasicIdentGroup, upsConfigOutputVA=upsConfigOutputVA, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsOutputCurrent=upsOutputCurrent, upsAlarmDescr=upsAlarmDescr, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBasicConfigGroup=upsBasicConfigGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmFanFailure=upsAlarmFanFailure, upsOutputLineIndex=upsOutputLineIndex, upsOutputEntry=upsOutputEntry)
