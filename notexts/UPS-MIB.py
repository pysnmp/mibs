...
TestAndIncr, TextualConvention, AutonomousType, DisplayString, TimeStamp, TimeInterval = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TextualConvention", "AutonomousType", "DisplayString", "TimeStamp", "TimeInterval")
...
mibBuilder.exportSymbols("UPS-MIB", upsControl=upsControl, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigOutputPower=upsConfigOutputPower, upsTrapOnBattery=upsTrapOnBattery, upsAlarmShutdownPending=upsAlarmShutdownPending, upsSubsetGroups=upsSubsetGroups, upsIdentManufacturer=upsIdentManufacturer, PositiveInteger=PositiveInteger, upsSubsetIdentGroup=upsSubsetIdentGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsBypassVoltage=upsBypassVoltage, upsOutputTable=upsOutputTable, upsAutoRestart=upsAutoRestart, upsAlarm=upsAlarm, upsAlarmDescr=upsAlarmDescr, upsBasicOutputGroup=upsBasicOutputGroup, upsMIB=upsMIB, upsIdent=upsIdent, upsBypassFrequency=upsBypassFrequency, upsBasicBypassGroup=upsBasicBypassGroup, upsInputEntry=upsInputEntry, upsBattery=upsBattery, upsSecondsOnBattery=upsSecondsOnBattery, upsInputTruePower=upsInputTruePower, upsFullBatteryGroup=upsFullBatteryGroup, upsInputLineBads=upsInputLineBads, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmLowBattery=upsAlarmLowBattery, upsIdentModel=upsIdentModel, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBasicControlGroup=upsBasicControlGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsCompliances=upsCompliances, upsFullIdentGroup=upsFullIdentGroup, upsAlarmId=upsAlarmId, upsBypassEntry=upsBypassEntry, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBypassPower=upsBypassPower, upsBatteryStatus=upsBatteryStatus, upsTest=upsTest, upsOutputEntry=upsOutputEntry, upsOutputCurrent=upsOutputCurrent, upsInputTable=upsInputTable, upsInput=upsInput, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsFullControlGroup=upsFullControlGroup, PYSNMP_MODULE_ID=upsMIB, upsIdentName=upsIdentName, upsTestResultsSummary=upsTestResultsSummary, upsSubsetInputGroup=upsSubsetInputGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsSubsetCompliance=upsSubsetCompliance, upsAlarmOutputBad=upsAlarmOutputBad, upsOutputVoltage=upsOutputVoltage, upsBasicCompliance=upsBasicCompliance, upsAlarmOnBypass=upsAlarmOnBypass, upsBypassNumLines=upsBypassNumLines, upsTestId=upsTestId, upsBasicIdentGroup=upsBasicIdentGroup, upsBasicInputGroup=upsBasicInputGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmTable=upsAlarmTable, upsBypassCurrent=upsBypassCurrent, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsInputFrequency=upsInputFrequency, upsShutdownType=upsShutdownType, upsBasicConfigGroup=upsBasicConfigGroup, upsFullInputGroup=upsFullInputGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsConformance=upsConformance, upsTestStartTime=upsTestStartTime, upsFullCompliance=upsFullCompliance, upsTestSpinLock=upsTestSpinLock, upsConfigInputFreq=upsConfigInputFreq, upsOutputNumLines=upsOutputNumLines, upsAlarmsPresent=upsAlarmsPresent, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmFanFailure=upsAlarmFanFailure, upsBypass=upsBypass, upsBasicAlarmGroup=upsBasicAlarmGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsInputLineIndex=upsInputLineIndex, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBatteryVoltage=upsBatteryVoltage, upsAlarmOutputOverload=upsAlarmOutputOverload, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBypassLineIndex=upsBypassLineIndex, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmEntry=upsAlarmEntry, upsOutputLineIndex=upsOutputLineIndex, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigLowBattTime=upsConfigLowBattTime, upsWellKnownTests=upsWellKnownTests, upsOutput=upsOutput, NonNegativeInteger=NonNegativeInteger, upsWellKnownAlarms=upsWellKnownAlarms, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBasicGroups=upsBasicGroups, upsObjects=upsObjects, upsBasicTestGroup=upsBasicTestGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBypassTable=upsBypassTable, upsAlarmInputBad=upsAlarmInputBad, upsAlarmGeneralFault=upsAlarmGeneralFault, upsOutputFrequency=upsOutputFrequency, upsAlarmTime=upsAlarmTime, upsInputVoltage=upsInputVoltage, upsTestElapsedTime=upsTestElapsedTime, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTraps=upsTraps, upsFullTestGroup=upsFullTestGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsFullGroups=upsFullGroups, upsInputCurrent=upsInputCurrent, upsBatteryTemperature=upsBatteryTemperature, upsConfig=upsConfig, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmTempBad=upsAlarmTempBad, upsShutdownAfterDelay=upsShutdownAfterDelay, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTestResultsDetail=upsTestResultsDetail, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsFullConfigGroup=upsFullConfigGroup, upsRebootWithDuration=upsRebootWithDuration, upsFullOutputGroup=upsFullOutputGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConfigOutputVA=upsConfigOutputVA, upsOutputPower=upsOutputPower, upsGroups=upsGroups, upsBatteryCurrent=upsBatteryCurrent, upsInputNumLines=upsInputNumLines, upsOutputSource=upsOutputSource, upsFullBypassGroup=upsFullBypassGroup)
