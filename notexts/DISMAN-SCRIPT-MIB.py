...
DisplayString, DateAndTime, TimeInterval, TextualConvention, RowStatus, StorageType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "DateAndTime", "TimeInterval", "TextualConvention", "RowStatus", "StorageType")
...
mibBuilder.exportSymbols("DISMAN-SCRIPT-MIB", smExtsnExtension=smExtsnExtension, smLangDescr=smLangDescr, smExtsnIndex=smExtsnIndex, smLaunchAdminStatus=smLaunchAdminStatus, smLaunchName=smLaunchName, smLaunchScriptName=smLaunchScriptName, smScriptAbort=smScriptAbort, smRunResult=smRunResult, scriptMIB=scriptMIB, smLaunchLifeTime=smLaunchLifeTime, smRunExitCode=smRunExitCode, smExtsnDescr=smExtsnDescr, smCompliances=smCompliances, smLangIndex=smLangIndex, smLangVendor=smLangVendor, smExtsnTable=smExtsnTable, smLangRevision=smLangRevision, smScriptError=smScriptError, smExtsnEntry=smExtsnEntry, smCodeRowStatus=smCodeRowStatus, smRunControl=smRunControl, smScriptLastChange=smScriptLastChange, smScriptOwner=smScriptOwner, smGroups=smGroups, smCodeText=smCodeText, smRunResultTime=smRunResultTime, smLangLanguage=smLangLanguage, smCodeGroup=smCodeGroup, smExtsnRevision=smExtsnRevision, PYSNMP_MODULE_ID=scriptMIB, smCodeTable=smCodeTable, smScriptAdminStatus=smScriptAdminStatus, smRunEndTime=smRunEndTime, smLangTable=smLangTable, smLangVersion=smLangVersion, smCompliance=smCompliance, smScriptStorageType=smScriptStorageType, smLaunchRowStatus=smLaunchRowStatus, smLaunchRowExpireTime=smLaunchRowExpireTime, smScriptException=smScriptException, smScriptRowStatus=smScriptRowStatus, smLaunchExpireTime=smLaunchExpireTime, smConformance=smConformance, smScriptOperStatus=smScriptOperStatus, smScriptTable=smScriptTable, smRunEntry=smRunEntry, smLaunchControl=smLaunchControl, smRunTable=smRunTable, smRunError=smRunError, smScriptGroup=smScriptGroup, smNotifications=smNotifications, smRunArgument=smRunArgument, smRunGroup2=smRunGroup2, smScriptDescr=smScriptDescr, smScriptSource=smScriptSource, smScriptObjects=smScriptObjects, smLaunchGroup=smLaunchGroup, smCompliance2=smCompliance2, smScriptName=smScriptName, smCodeEntry=smCodeEntry, smLaunchScriptOwner=smLaunchScriptOwner, smLaunchStorageType=smLaunchStorageType, smLaunchGroup2=smLaunchGroup2, smScriptLanguage=smScriptLanguage, smLaunchLastChange=smLaunchLastChange, smLaunchError=smLaunchError, smRunGroup=smRunGroup, smObjects=smObjects, smExtsnVendor=smExtsnVendor, smRunStartTime=smRunStartTime, smLaunchOwner=smLaunchOwner, smLaunchEntry=smLaunchEntry, smLaunchOperStatus=smLaunchOperStatus, smRunErrorTime=smRunErrorTime, smNotificationsGroup2=smNotificationsGroup2, smLaunchArgument=smLaunchArgument, smExtsnVersion=smExtsnVersion, smLaunchRunIndexNext=smLaunchRunIndexNext, smLangEntry=smLangEntry, smScriptGroup2=smScriptGroup2, smRunState=smRunState, smLaunchMaxCompleted=smLaunchMaxCompleted, smLaunchStart=smLaunchStart, smLaunchTable=smLaunchTable, smRunObjects=smRunObjects, smCodeIndex=smCodeIndex, smScriptEntry=smScriptEntry, smRunExpireTime=smRunExpireTime, smTraps=smTraps, smRunLifeTime=smRunLifeTime, smLaunchMaxRunning=smLaunchMaxRunning, smNotificationsGroup=smNotificationsGroup, smRunIndex=smRunIndex, smScriptResult=smScriptResult, smLanguageGroup=smLanguageGroup)
