...
mibBuilder.exportSymbols("DISMAN-SCRIPT-MIB", smLangEntry=smLangEntry, smRunResult=smRunResult, smLaunchLastChange=smLaunchLastChange, smCodeEntry=smCodeEntry, smScriptGroup=smScriptGroup, smScriptSource=smScriptSource, smRunIndex=smRunIndex, smObjects=smObjects, smExtsnDescr=smExtsnDescr, smLangVersion=smLangVersion, smCodeGroup=smCodeGroup, smNotifications=smNotifications, smLaunchAdminStatus=smLaunchAdminStatus, smScriptOperStatus=smScriptOperStatus, smCodeText=smCodeText, smRunState=smRunState, smLaunchStart=smLaunchStart, smLaunchControl=smLaunchControl, smLangTable=smLangTable, smRunErrorTime=smRunErrorTime, smRunArgument=smRunArgument, smRunObjects=smRunObjects, smScriptAdminStatus=smScriptAdminStatus, smExtsnTable=smExtsnTable, smScriptObjects=smScriptObjects, smLaunchGroup2=smLaunchGroup2, smNotificationsGroup=smNotificationsGroup, smRunGroup2=smRunGroup2, smLaunchOwner=smLaunchOwner, smExtsnVendor=smExtsnVendor, smLaunchRowExpireTime=smLaunchRowExpireTime, smLaunchOperStatus=smLaunchOperStatus, smLaunchTable=smLaunchTable, smScriptError=smScriptError, smCodeIndex=smCodeIndex, smLaunchMaxCompleted=smLaunchMaxCompleted, smLangRevision=smLangRevision, smRunEndTime=smRunEndTime, smCompliance=smCompliance, smScriptOwner=smScriptOwner, smScriptDescr=smScriptDescr, smLangIndex=smLangIndex, smScriptException=smScriptException, smRunExpireTime=smRunExpireTime, smRunTable=smRunTable, smLaunchScriptName=smLaunchScriptName, PYSNMP_MODULE_ID=scriptMIB, smScriptLanguage=smScriptLanguage, smExtsnVersion=smExtsnVersion, smRunError=smRunError, smRunEntry=smRunEntry, smExtsnExtension=smExtsnExtension, smLaunchExpireTime=smLaunchExpireTime, smLaunchName=smLaunchName, smRunControl=smRunControl, smScriptResult=smScriptResult, smScriptGroup2=smScriptGroup2, smLaunchMaxRunning=smLaunchMaxRunning, smRunStartTime=smRunStartTime, smScriptLastChange=smScriptLastChange, smScriptAbort=smScriptAbort, smLanguageGroup=smLanguageGroup, smExtsnIndex=smExtsnIndex, smLaunchScriptOwner=smLaunchScriptOwner, smLaunchError=smLaunchError, smConformance=smConformance, smScriptStorageType=smScriptStorageType, smExtsnRevision=smExtsnRevision, smLaunchStorageType=smLaunchStorageType, smScriptTable=smScriptTable, smLaunchRunIndexNext=smLaunchRunIndexNext, smNotificationsGroup2=smNotificationsGroup2, smLangVendor=smLangVendor, smCompliance2=smCompliance2, smLangLanguage=smLangLanguage, smRunGroup=smRunGroup, smCompliances=smCompliances, smCodeTable=smCodeTable, smTraps=smTraps, scriptMIB=scriptMIB, smRunExitCode=smRunExitCode, smLaunchEntry=smLaunchEntry, smScriptRowStatus=smScriptRowStatus, smLaunchArgument=smLaunchArgument, smScriptName=smScriptName, smLaunchGroup=smLaunchGroup, smCodeRowStatus=smCodeRowStatus, smLaunchLifeTime=smLaunchLifeTime, smGroups=smGroups, smScriptEntry=smScriptEntry, smRunResultTime=smRunResultTime, smRunLifeTime=smRunLifeTime, smLangDescr=smLangDescr, smLaunchRowStatus=smLaunchRowStatus, smExtsnEntry=smExtsnEntry)
