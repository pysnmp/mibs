...
DateAndTime, DisplayString, TextualConvention, StorageType, RowStatus, TimeInterval = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "DisplayString", "TextualConvention", "StorageType", "RowStatus", "TimeInterval")
...
mibBuilder.exportSymbols("DISMAN-SCRIPT-MIB", smExtsnTable=smExtsnTable, smScriptAbort=smScriptAbort, smLaunchStart=smLaunchStart, smRunEndTime=smRunEndTime, smLaunchScriptOwner=smLaunchScriptOwner, smRunStartTime=smRunStartTime, smLaunchRunIndexNext=smLaunchRunIndexNext, smScriptLastChange=smScriptLastChange, smScriptTable=smScriptTable, smLangIndex=smLangIndex, smScriptGroup=smScriptGroup, smExtsnVersion=smExtsnVersion, smLanguageGroup=smLanguageGroup, smLangLanguage=smLangLanguage, scriptMIB=scriptMIB, smLangDescr=smLangDescr, smLaunchEntry=smLaunchEntry, smRunGroup2=smRunGroup2, smScriptOwner=smScriptOwner, smScriptStorageType=smScriptStorageType, smRunControl=smRunControl, smLaunchTable=smLaunchTable, smLaunchControl=smLaunchControl, smLaunchExpireTime=smLaunchExpireTime, smTraps=smTraps, PYSNMP_MODULE_ID=scriptMIB, smScriptError=smScriptError, smLaunchStorageType=smLaunchStorageType, smCodeText=smCodeText, smScriptException=smScriptException, smScriptOperStatus=smScriptOperStatus, smRunGroup=smRunGroup, smRunEntry=smRunEntry, smLaunchMaxRunning=smLaunchMaxRunning, smScriptResult=smScriptResult, smRunObjects=smRunObjects, smLaunchError=smLaunchError, smLangVersion=smLangVersion, smRunIndex=smRunIndex, smCodeRowStatus=smCodeRowStatus, smRunErrorTime=smRunErrorTime, smLangEntry=smLangEntry, smLangRevision=smLangRevision, smCodeGroup=smCodeGroup, smNotifications=smNotifications, smExtsnRevision=smExtsnRevision, smCompliance=smCompliance, smScriptName=smScriptName, smLaunchOperStatus=smLaunchOperStatus, smLaunchLifeTime=smLaunchLifeTime, smExtsnDescr=smExtsnDescr, smRunArgument=smRunArgument, smCodeTable=smCodeTable, smRunResult=smRunResult, smScriptObjects=smScriptObjects, smLaunchRowExpireTime=smLaunchRowExpireTime, smRunLifeTime=smRunLifeTime, smLaunchAdminStatus=smLaunchAdminStatus, smNotificationsGroup=smNotificationsGroup, smRunTable=smRunTable, smObjects=smObjects, smRunExitCode=smRunExitCode, smRunState=smRunState, smCodeEntry=smCodeEntry, smScriptDescr=smScriptDescr, smCodeIndex=smCodeIndex, smScriptEntry=smScriptEntry, smExtsnExtension=smExtsnExtension, smScriptLanguage=smScriptLanguage, smLaunchGroup2=smLaunchGroup2, smLaunchLastChange=smLaunchLastChange, smExtsnEntry=smExtsnEntry, smLaunchOwner=smLaunchOwner, smLaunchGroup=smLaunchGroup, smRunExpireTime=smRunExpireTime, smScriptGroup2=smScriptGroup2, smLaunchArgument=smLaunchArgument, smGroups=smGroups, smLangVendor=smLangVendor, smScriptSource=smScriptSource, smRunError=smRunError, smScriptRowStatus=smScriptRowStatus, smLaunchScriptName=smLaunchScriptName, smConformance=smConformance, smExtsnVendor=smExtsnVendor, smLaunchRowStatus=smLaunchRowStatus, smScriptAdminStatus=smScriptAdminStatus, smCompliances=smCompliances, smRunResultTime=smRunResultTime, smLaunchMaxCompleted=smLaunchMaxCompleted, smExtsnIndex=smExtsnIndex, smLaunchName=smLaunchName, smCompliance2=smCompliance2, smLangTable=smLangTable, smNotificationsGroup2=smNotificationsGroup2)
