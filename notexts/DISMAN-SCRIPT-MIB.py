...
TimeInterval, RowStatus, StorageType, DateAndTime, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeInterval", "RowStatus", "StorageType", "DateAndTime", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("DISMAN-SCRIPT-MIB", smExtsnTable=smExtsnTable, smLaunchScriptName=smLaunchScriptName, smLaunchGroup2=smLaunchGroup2, smRunStartTime=smRunStartTime, smScriptAdminStatus=smScriptAdminStatus, smCodeIndex=smCodeIndex, smLangLanguage=smLangLanguage, smRunControl=smRunControl, smScriptSource=smScriptSource, smLaunchExpireTime=smLaunchExpireTime, smExtsnIndex=smExtsnIndex, smLaunchStorageType=smLaunchStorageType, smScriptStorageType=smScriptStorageType, smLaunchRowExpireTime=smLaunchRowExpireTime, smLaunchControl=smLaunchControl, smLaunchEntry=smLaunchEntry, scriptMIB=scriptMIB, smLaunchArgument=smLaunchArgument, smScriptDescr=smScriptDescr, smLaunchLifeTime=smLaunchLifeTime, smScriptRowStatus=smScriptRowStatus, smRunErrorTime=smRunErrorTime, smCompliance2=smCompliance2, smLaunchLastChange=smLaunchLastChange, smLaunchStart=smLaunchStart, smLaunchMaxCompleted=smLaunchMaxCompleted, smScriptGroup2=smScriptGroup2, smCodeGroup=smCodeGroup, PYSNMP_MODULE_ID=scriptMIB, smScriptAbort=smScriptAbort, smLaunchRunIndexNext=smLaunchRunIndexNext, smCodeTable=smCodeTable, smExtsnEntry=smExtsnEntry, smRunExitCode=smRunExitCode, smRunGroup2=smRunGroup2, smScriptEntry=smScriptEntry, smScriptObjects=smScriptObjects, smLangVendor=smLangVendor, smLangDescr=smLangDescr, smLaunchName=smLaunchName, smScriptLastChange=smScriptLastChange, smExtsnDescr=smExtsnDescr, smScriptTable=smScriptTable, smLaunchRowStatus=smLaunchRowStatus, smNotificationsGroup2=smNotificationsGroup2, smExtsnExtension=smExtsnExtension, smGroups=smGroups, smScriptError=smScriptError, smScriptName=smScriptName, smCodeRowStatus=smCodeRowStatus, smRunResultTime=smRunResultTime, smLaunchScriptOwner=smLaunchScriptOwner, smScriptResult=smScriptResult, smLangEntry=smLangEntry, smLaunchError=smLaunchError, smRunArgument=smRunArgument, smCodeEntry=smCodeEntry, smExtsnRevision=smExtsnRevision, smLaunchOperStatus=smLaunchOperStatus, smRunGroup=smRunGroup, smScriptOperStatus=smScriptOperStatus, smScriptOwner=smScriptOwner, smRunObjects=smRunObjects, smLaunchOwner=smLaunchOwner, smRunEndTime=smRunEndTime, smRunLifeTime=smRunLifeTime, smLanguageGroup=smLanguageGroup, smLaunchTable=smLaunchTable, smExtsnVendor=smExtsnVendor, smLangTable=smLangTable, smRunTable=smRunTable, smRunState=smRunState, smCompliance=smCompliance, smLangIndex=smLangIndex, smLaunchAdminStatus=smLaunchAdminStatus, smNotifications=smNotifications, smObjects=smObjects, smTraps=smTraps, smExtsnVersion=smExtsnVersion, smLangVersion=smLangVersion, smConformance=smConformance, smScriptLanguage=smScriptLanguage, smLangRevision=smLangRevision, smLaunchMaxRunning=smLaunchMaxRunning, smCompliances=smCompliances, smRunIndex=smRunIndex, smScriptGroup=smScriptGroup, smCodeText=smCodeText, smRunEntry=smRunEntry, smRunExpireTime=smRunExpireTime, smNotificationsGroup=smNotificationsGroup, smLaunchGroup=smLaunchGroup, smRunError=smRunError, smScriptException=smScriptException, smRunResult=smRunResult)
