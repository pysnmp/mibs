...
TimeInterval, DateAndTime, RowStatus, DisplayString, StorageType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeInterval", "DateAndTime", "RowStatus", "DisplayString", "StorageType", "TextualConvention")
...
mibBuilder.exportSymbols("DISMAN-SCRIPT-MIB", smCompliance=smCompliance, smLaunchEntry=smLaunchEntry, smCodeGroup=smCodeGroup, smRunErrorTime=smRunErrorTime, smRunControl=smRunControl, smLaunchTable=smLaunchTable, smLaunchGroup=smLaunchGroup, smRunResult=smRunResult, smScriptError=smScriptError, smLangEntry=smLangEntry, smRunEndTime=smRunEndTime, smCodeIndex=smCodeIndex, smScriptAdminStatus=smScriptAdminStatus, smLanguageGroup=smLanguageGroup, smScriptException=smScriptException, smLaunchRowExpireTime=smLaunchRowExpireTime, smRunGroup=smRunGroup, smScriptOperStatus=smScriptOperStatus, smLaunchScriptOwner=smLaunchScriptOwner, smLaunchArgument=smLaunchArgument, smExtsnTable=smExtsnTable, smScriptRowStatus=smScriptRowStatus, smLangVendor=smLangVendor, smLangLanguage=smLangLanguage, smScriptOwner=smScriptOwner, smScriptStorageType=smScriptStorageType, smObjects=smObjects, smLangVersion=smLangVersion, smRunState=smRunState, smCodeRowStatus=smCodeRowStatus, smCodeEntry=smCodeEntry, smRunIndex=smRunIndex, smScriptEntry=smScriptEntry, smScriptGroup=smScriptGroup, smRunError=smRunError, smNotificationsGroup2=smNotificationsGroup2, smLaunchOperStatus=smLaunchOperStatus, smExtsnVersion=smExtsnVersion, smLaunchStart=smLaunchStart, smLaunchLastChange=smLaunchLastChange, smExtsnIndex=smExtsnIndex, smLangRevision=smLangRevision, smRunResultTime=smRunResultTime, smRunExitCode=smRunExitCode, smExtsnDescr=smExtsnDescr, smScriptName=smScriptName, smLaunchError=smLaunchError, smRunStartTime=smRunStartTime, smRunTable=smRunTable, smScriptAbort=smScriptAbort, smLaunchLifeTime=smLaunchLifeTime, smLangTable=smLangTable, smScriptLastChange=smScriptLastChange, smLaunchOwner=smLaunchOwner, smLaunchAdminStatus=smLaunchAdminStatus, smLangDescr=smLangDescr, smScriptResult=smScriptResult, smLaunchGroup2=smLaunchGroup2, smNotificationsGroup=smNotificationsGroup, smRunGroup2=smRunGroup2, smRunArgument=smRunArgument, smNotifications=smNotifications, smScriptObjects=smScriptObjects, PYSNMP_MODULE_ID=scriptMIB, smRunObjects=smRunObjects, smExtsnVendor=smExtsnVendor, smTraps=smTraps, smRunExpireTime=smRunExpireTime, smGroups=smGroups, smRunEntry=smRunEntry, smLaunchScriptName=smLaunchScriptName, smRunLifeTime=smRunLifeTime, smConformance=smConformance, smLaunchStorageType=smLaunchStorageType, smLaunchRunIndexNext=smLaunchRunIndexNext, smLangIndex=smLangIndex, smCodeTable=smCodeTable, smCompliances=smCompliances, smCodeText=smCodeText, smLaunchName=smLaunchName, smLaunchMaxCompleted=smLaunchMaxCompleted, smLaunchControl=smLaunchControl, scriptMIB=scriptMIB, smLaunchMaxRunning=smLaunchMaxRunning, smScriptGroup2=smScriptGroup2, smExtsnExtension=smExtsnExtension, smScriptDescr=smScriptDescr, smCompliance2=smCompliance2, smExtsnRevision=smExtsnRevision, smLaunchRowStatus=smLaunchRowStatus, smScriptTable=smScriptTable, smLaunchExpireTime=smLaunchExpireTime, smScriptSource=smScriptSource, smScriptLanguage=smScriptLanguage, smExtsnEntry=smExtsnEntry)
