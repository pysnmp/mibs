...
DisplayString, DateAndTime, RowStatus, TimeInterval, StorageType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "DateAndTime", "RowStatus", "TimeInterval", "StorageType", "TextualConvention")
...
mibBuilder.exportSymbols("DISMAN-SCRIPT-MIB", smLaunchLastChange=smLaunchLastChange, smScriptTable=smScriptTable, smScriptOperStatus=smScriptOperStatus, smLangLanguage=smLangLanguage, smRunArgument=smRunArgument, smLangTable=smLangTable, smRunGroup2=smRunGroup2, PYSNMP_MODULE_ID=scriptMIB, smLaunchControl=smLaunchControl, smScriptName=smScriptName, smScriptError=smScriptError, smScriptAdminStatus=smScriptAdminStatus, smLaunchName=smLaunchName, smNotificationsGroup2=smNotificationsGroup2, smRunControl=smRunControl, smRunState=smRunState, smScriptEntry=smScriptEntry, smLaunchEntry=smLaunchEntry, smScriptStorageType=smScriptStorageType, smLaunchRowStatus=smLaunchRowStatus, smLaunchLifeTime=smLaunchLifeTime, smScriptGroup=smScriptGroup, smExtsnRevision=smExtsnRevision, smExtsnDescr=smExtsnDescr, smLangRevision=smLangRevision, smCodeEntry=smCodeEntry, smLangIndex=smLangIndex, smScriptException=smScriptException, smRunError=smRunError, smLangDescr=smLangDescr, smRunStartTime=smRunStartTime, smCodeRowStatus=smCodeRowStatus, smLaunchOperStatus=smLaunchOperStatus, smScriptLastChange=smScriptLastChange, smScriptGroup2=smScriptGroup2, smRunObjects=smRunObjects, smLaunchGroup=smLaunchGroup, smLaunchTable=smLaunchTable, smLaunchGroup2=smLaunchGroup2, smExtsnIndex=smExtsnIndex, smRunEndTime=smRunEndTime, smScriptRowStatus=smScriptRowStatus, smTraps=smTraps, smGroups=smGroups, smLaunchMaxCompleted=smLaunchMaxCompleted, smRunLifeTime=smRunLifeTime, smExtsnVendor=smExtsnVendor, smCodeGroup=smCodeGroup, smLangEntry=smLangEntry, smLaunchRowExpireTime=smLaunchRowExpireTime, smLaunchArgument=smLaunchArgument, smExtsnEntry=smExtsnEntry, smCodeTable=smCodeTable, smLangVersion=smLangVersion, smScriptObjects=smScriptObjects, smRunResult=smRunResult, smRunExpireTime=smRunExpireTime, smNotificationsGroup=smNotificationsGroup, smLaunchError=smLaunchError, smLaunchExpireTime=smLaunchExpireTime, smRunEntry=smRunEntry, smLaunchStart=smLaunchStart, smExtsnExtension=smExtsnExtension, smCompliance2=smCompliance2, smScriptOwner=smScriptOwner, smConformance=smConformance, smLaunchStorageType=smLaunchStorageType, smLaunchOwner=smLaunchOwner, smRunExitCode=smRunExitCode, smRunTable=smRunTable, smScriptDescr=smScriptDescr, smCodeText=smCodeText, smRunErrorTime=smRunErrorTime, smRunGroup=smRunGroup, smExtsnTable=smExtsnTable, smLaunchAdminStatus=smLaunchAdminStatus, smLaunchRunIndexNext=smLaunchRunIndexNext, smScriptAbort=smScriptAbort, smNotifications=smNotifications, smLaunchScriptName=smLaunchScriptName, smLaunchMaxRunning=smLaunchMaxRunning, smLanguageGroup=smLanguageGroup, smExtsnVersion=smExtsnVersion, scriptMIB=scriptMIB, smCompliances=smCompliances, smRunIndex=smRunIndex, smRunResultTime=smRunResultTime, smCodeIndex=smCodeIndex, smScriptSource=smScriptSource, smScriptResult=smScriptResult, smLangVendor=smLangVendor, smObjects=smObjects, smLaunchScriptOwner=smLaunchScriptOwner, smScriptLanguage=smScriptLanguage, smCompliance=smCompliance)
