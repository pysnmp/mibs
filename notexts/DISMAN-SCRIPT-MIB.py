...
TimeInterval, DateAndTime, DisplayString, StorageType, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeInterval", "DateAndTime", "DisplayString", "StorageType", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("DISMAN-SCRIPT-MIB", smExtsnDescr=smExtsnDescr, smRunControl=smRunControl, smLaunchLastChange=smLaunchLastChange, smScriptOperStatus=smScriptOperStatus, smScriptGroup2=smScriptGroup2, smRunResult=smRunResult, smCodeText=smCodeText, smLaunchOperStatus=smLaunchOperStatus, smExtsnExtension=smExtsnExtension, smScriptObjects=smScriptObjects, smLangVendor=smLangVendor, smLaunchScriptOwner=smLaunchScriptOwner, smScriptLanguage=smScriptLanguage, smTraps=smTraps, smLaunchTable=smLaunchTable, smConformance=smConformance, smExtsnTable=smExtsnTable, smRunObjects=smRunObjects, smScriptLastChange=smScriptLastChange, smCodeRowStatus=smCodeRowStatus, smLaunchEntry=smLaunchEntry, smLaunchMaxCompleted=smLaunchMaxCompleted, smLangDescr=smLangDescr, smLaunchExpireTime=smLaunchExpireTime, smScriptResult=smScriptResult, smLaunchStart=smLaunchStart, smCompliance2=smCompliance2, smRunTable=smRunTable, smLangEntry=smLangEntry, smLaunchStorageType=smLaunchStorageType, smCodeIndex=smCodeIndex, smNotificationsGroup2=smNotificationsGroup2, smRunStartTime=smRunStartTime, smScriptAdminStatus=smScriptAdminStatus, smLaunchMaxRunning=smLaunchMaxRunning, smScriptRowStatus=smScriptRowStatus, smLaunchControl=smLaunchControl, smCompliance=smCompliance, smNotificationsGroup=smNotificationsGroup, smExtsnRevision=smExtsnRevision, smScriptStorageType=smScriptStorageType, smScriptSource=smScriptSource, smLangTable=smLangTable, smLaunchLifeTime=smLaunchLifeTime, smGroups=smGroups, smRunExpireTime=smRunExpireTime, smRunLifeTime=smRunLifeTime, smCodeEntry=smCodeEntry, smRunIndex=smRunIndex, smCompliances=smCompliances, smScriptDescr=smScriptDescr, smLaunchAdminStatus=smLaunchAdminStatus, smExtsnIndex=smExtsnIndex, smRunArgument=smRunArgument, smScriptGroup=smScriptGroup, smNotifications=smNotifications, smLaunchRunIndexNext=smLaunchRunIndexNext, smRunErrorTime=smRunErrorTime, smScriptName=smScriptName, smLaunchGroup2=smLaunchGroup2, smRunGroup2=smRunGroup2, smLaunchGroup=smLaunchGroup, smExtsnVendor=smExtsnVendor, smRunError=smRunError, smLaunchScriptName=smLaunchScriptName, smLaunchError=smLaunchError, smLangRevision=smLangRevision, smExtsnEntry=smExtsnEntry, smLaunchRowExpireTime=smLaunchRowExpireTime, smLangIndex=smLangIndex, smRunExitCode=smRunExitCode, smLanguageGroup=smLanguageGroup, smScriptOwner=smScriptOwner, smScriptException=smScriptException, smRunGroup=smRunGroup, smLangLanguage=smLangLanguage, smRunResultTime=smRunResultTime, smRunEntry=smRunEntry, smLaunchRowStatus=smLaunchRowStatus, PYSNMP_MODULE_ID=scriptMIB, smLangVersion=smLangVersion, smRunEndTime=smRunEndTime, smExtsnVersion=smExtsnVersion, smLaunchArgument=smLaunchArgument, smObjects=smObjects, smScriptAbort=smScriptAbort, smLaunchOwner=smLaunchOwner, smCodeTable=smCodeTable, scriptMIB=scriptMIB, smRunState=smRunState, smScriptEntry=smScriptEntry, smLaunchName=smLaunchName, smScriptTable=smScriptTable, smCodeGroup=smCodeGroup, smScriptError=smScriptError)
