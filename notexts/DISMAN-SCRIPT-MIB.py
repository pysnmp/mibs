...
DateAndTime, TimeInterval, RowStatus, DisplayString, StorageType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TimeInterval", "RowStatus", "DisplayString", "StorageType", "TextualConvention")
...
mibBuilder.exportSymbols("DISMAN-SCRIPT-MIB", smScriptRowStatus=smScriptRowStatus, smLaunchControl=smLaunchControl, smLaunchMaxCompleted=smLaunchMaxCompleted, smScriptLastChange=smScriptLastChange, smRunExitCode=smRunExitCode, smScriptOwner=smScriptOwner, smScriptEntry=smScriptEntry, smLaunchTable=smLaunchTable, smLaunchStorageType=smLaunchStorageType, smRunEndTime=smRunEndTime, smLanguageGroup=smLanguageGroup, smLaunchRowStatus=smLaunchRowStatus, smCompliance2=smCompliance2, smNotifications=smNotifications, smLangVersion=smLangVersion, smScriptSource=smScriptSource, smLaunchGroup=smLaunchGroup, smLaunchLifeTime=smLaunchLifeTime, smRunGroup=smRunGroup, smCompliances=smCompliances, smScriptAbort=smScriptAbort, smCodeIndex=smCodeIndex, PYSNMP_MODULE_ID=scriptMIB, smLangRevision=smLangRevision, smScriptGroup2=smScriptGroup2, smLaunchOperStatus=smLaunchOperStatus, smScriptLanguage=smScriptLanguage, smGroups=smGroups, smScriptOperStatus=smScriptOperStatus, smLaunchName=smLaunchName, smLaunchEntry=smLaunchEntry, smRunEntry=smRunEntry, smScriptTable=smScriptTable, smLangTable=smLangTable, smScriptStorageType=smScriptStorageType, smScriptGroup=smScriptGroup, smCodeText=smCodeText, smRunGroup2=smRunGroup2, smTraps=smTraps, smRunErrorTime=smRunErrorTime, smRunState=smRunState, smRunResult=smRunResult, smExtsnIndex=smExtsnIndex, smCodeRowStatus=smCodeRowStatus, smCodeGroup=smCodeGroup, smNotificationsGroup2=smNotificationsGroup2, smLaunchRowExpireTime=smLaunchRowExpireTime, smLaunchArgument=smLaunchArgument, smExtsnRevision=smExtsnRevision, smScriptName=smScriptName, smLaunchExpireTime=smLaunchExpireTime, smRunTable=smRunTable, smScriptException=smScriptException, smExtsnVendor=smExtsnVendor, smLaunchLastChange=smLaunchLastChange, smLaunchMaxRunning=smLaunchMaxRunning, smCompliance=smCompliance, smRunArgument=smRunArgument, smObjects=smObjects, smLangIndex=smLangIndex, smRunLifeTime=smRunLifeTime, smLangLanguage=smLangLanguage, smExtsnTable=smExtsnTable, smLaunchGroup2=smLaunchGroup2, smLaunchScriptName=smLaunchScriptName, smRunObjects=smRunObjects, smExtsnExtension=smExtsnExtension, smLaunchScriptOwner=smLaunchScriptOwner, smRunExpireTime=smRunExpireTime, smExtsnEntry=smExtsnEntry, smLangDescr=smLangDescr, smCodeTable=smCodeTable, smRunIndex=smRunIndex, smRunControl=smRunControl, smLaunchStart=smLaunchStart, smConformance=smConformance, smRunError=smRunError, smScriptResult=smScriptResult, smScriptDescr=smScriptDescr, smLaunchError=smLaunchError, smNotificationsGroup=smNotificationsGroup, smLaunchOwner=smLaunchOwner, scriptMIB=scriptMIB, smExtsnDescr=smExtsnDescr, smLangEntry=smLangEntry, smLangVendor=smLangVendor, smCodeEntry=smCodeEntry, smRunStartTime=smRunStartTime, smRunResultTime=smRunResultTime, smScriptAdminStatus=smScriptAdminStatus, smScriptObjects=smScriptObjects, smExtsnVersion=smExtsnVersion, smLaunchAdminStatus=smLaunchAdminStatus, smLaunchRunIndexNext=smLaunchRunIndexNext, smScriptError=smScriptError)
