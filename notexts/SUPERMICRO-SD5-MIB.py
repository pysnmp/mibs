...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", raidPDIndex=raidPDIndex, sd5Table=sd5Table, ceccLogEntry=ceccLogEntry, raidPDMediaType=raidPDMediaType, raidAdapterIndex=raidAdapterIndex, mbSerialNumber=mbSerialNumber, trapTemperatureNormal=trapTemperatureNormal, raidAdapterEntry=raidAdapterEntry, raidPDSpan=raidPDSpan, smSuperDoctor5MIB=smSuperDoctor5MIB, raidPDModel=raidPDModel, raidBBUTable=raidBBUTable, ueccLogInfo=ueccLogInfo, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, memPartNumber=memPartNumber, memSerialNumber=memSerialNumber, trapGenericWarning=trapGenericWarning, raidVDMirrorDataSize=raidVDMirrorDataSize, raidAdapterId_PD=raidAdapterId_PD, raidVDSupportsMaxPS=raidVDSupportsMaxPS, raidVDId=raidVDId, ceccLogIndex=ceccLogIndex, ueccLogIndex=ueccLogIndex, ceccLogInfo=ceccLogInfo, mbVersionName=mbVersionName, raidAdapterSubDeviceId=raidAdapterSubDeviceId, postLogTable=postLogTable, trapBatteryStatusWarning=trapBatteryStatusWarning, diskEntry=diskEntry, postLogIndex=postLogIndex, postLogEntry=postLogEntry, memDeviceStatus=memDeviceStatus, raidVDNumDrives=raidVDNumDrives, diskMediaType=diskMediaType, memDataWidth=memDataWidth, raidAdapterGroup=raidAdapterGroup, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, diskSmartStatus=diskSmartStatus, raidVDDiskCachePolicy=raidVDDiskCachePolicy, trapPowerSupplyNormal=trapPowerSupplyNormal, trapGenericCritical=trapGenericCritical, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, cpuSocketDesignation=cpuSocketDesignation, raidVDIndex=raidVDIndex, cpuDescription=cpuDescription, diskSlotID=diskSlotID, sd5Idx=sd5Idx, memDeviceLocator=memDeviceLocator, cpuIndex=cpuIndex, raidAdapterGroup_VD=raidAdapterGroup_VD, raidPDPort0Status=raidPDPort0Status, trapVoltageNormal=trapVoltageNormal, raidVDAllinoneStatus=raidVDAllinoneStatus, sysBIOSManufacturer=sysBIOSManufacturer, cpuLogEntry=cpuLogEntry, trapTemperatureWarning=trapTemperatureWarning, trapPowerSupplyWarning=trapPowerSupplyWarning, trapTemperatureCritical=trapTemperatureCritical, trapMemoryUeccWarning=trapMemoryUeccWarning, trapGenericNormal=trapGenericNormal, trapMemoryCeccNormal=trapMemoryCeccNormal, cpuLogInfo=cpuLogInfo, trapVoltageWarning=trapVoltageWarning, raidVDAllinoneMsg=raidVDAllinoneMsg, diskSize=diskSize, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidAdapterSerialNumber=raidAdapterSerialNumber, cpuCurrentSpeed=cpuCurrentSpeed, cpuLogTable=cpuLogTable, raidBBUIndex=raidBBUIndex, raidVDEncryptionType=raidVDEncryptionType, raidPDFirmwareRevision=raidPDFirmwareRevision, trapBbpStatusCritical=trapBbpStatusCritical, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, osEntry=osEntry, cpuCoreEnabled=cpuCoreEnabled, trapBbpStatusWarning=trapBbpStatusWarning, raidPDFirmwareState=raidPDFirmwareState, sysBIOSTable=sysBIOSTable, mbProductName=mbProductName, memCapacity=memCapacity, trapCpuFaultNormal=trapCpuFaultNormal, mbEntry=mbEntry, raidAdapterVendorId=raidAdapterVendorId, sd5MIBVersion=sd5MIBVersion, cpuID=cpuID, postLogInfo=postLogInfo, diskVendor=diskVendor, raidVDSize=raidVDSize, cpuLoadingPercentage=cpuLoadingPercentage, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, ueccLogTable=ueccLogTable, raidAdapterDeviceId=raidAdapterDeviceId, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidPDDeviceFwLevel=raidPDDeviceFwLevel, raidPDPort1Status=raidPDPort1Status, ceccLogDatetime=ceccLogDatetime, raidVDBadBlocksExist=raidVDBadBlocksExist, cpuLogDatetime=cpuLogDatetime, ceccLogTable=ceccLogTable, raidVDRaidLevel=raidVDRaidLevel, raidPDAllinoneStatus=raidPDAllinoneStatus, memECCErrorCount=memECCErrorCount, osVersion=osVersion, raidPDRawSize=raidPDRawSize, trapFanWarning=trapFanWarning, raidVDTable=raidVDTable, cpuCoreCount=cpuCoreCount, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, smSD5TrapMIB=smSD5TrapMIB, raidPDPort1Linkspeed=raidPDPort1Linkspeed, diskModel=diskModel, raidPDMediaErrorCount=raidPDMediaErrorCount, mbTable=mbTable, mbManufacturer=mbManufacturer, osIndex=osIndex, cpuThreadCount=cpuThreadCount, raidAdapterProductName=raidAdapterProductName, raidBBUEntry=raidBBUEntry, raidPDOpProgress=raidPDOpProgress, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, diskTable=diskTable, ueccLogEntry=ueccLogEntry, raidAdapterId_VD=raidAdapterId_VD, osCSDVersion=osCSDVersion, raidVDName=raidVDName, memLabeledBank=memLabeledBank, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, trapVoltageCritical=trapVoltageCritical, trapMemoryCeccWarning=trapMemoryCeccWarning, cpuMaxSpeed=cpuMaxSpeed, raidPDDeviceSpeed=raidPDDeviceSpeed, raidVDSupportT10Power=raidVDSupportT10Power, raidIsBBUAbsent=raidIsBBUAbsent, sd5Version=sd5Version, raidAdapterId=raidAdapterId, trapBatteryStatusNormal=trapBatteryStatusNormal, raidBBUStatus=raidBBUStatus, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, postLogDatetime=postLogDatetime, trapChassisIntrusion=trapChassisIntrusion, raidDiskGroupId=raidDiskGroupId, trapBbpStatusNormal=trapBbpStatusNormal, raidPDEntry=raidPDEntry, osTable=osTable, raidPDOtherErrorCount=raidPDOtherErrorCount, memEntry=memEntry, osSerialNumber=osSerialNumber, trapFanNormal=trapFanNormal, memModel=memModel, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, trapBatteryStatusCritical=trapBatteryStatusCritical, raidPDSerialNumber=raidPDSerialNumber, memTable=memTable, trapPowerSupplyCritical=trapPowerSupplyCritical, mbAssetTag=mbAssetTag, cpuManufacturer=cpuManufacturer, PYSNMP_MODULE_ID=smSuperDoctor5MIB, raidVDStripSize=raidVDStripSize, raidPDSlotNumber=raidPDSlotNumber, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidPDAllinoneMsg=raidPDAllinoneMsg, cpuTable=cpuTable, diskController=diskController, memUECCErrorCount=memUECCErrorCount, raidPDTable=raidPDTable, osName=osName, sysBIOSEntry=sysBIOSEntry, raidBBUAllinoneStatus=raidBBUAllinoneStatus, memManufacturer=memManufacturer, raidAdapterGroup_PD=raidAdapterGroup_PD, raidAdapterSubVendorId=raidAdapterSubVendorId, raidVDCached=raidVDCached, cpuLogIndex=cpuLogIndex, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidDiskGroupId_PD=raidDiskGroupId_PD, raidVDEntry=raidVDEntry, raidPDPort0Linkspeed=raidPDPort0Linkspeed, trapCpuFaultWarning=trapCpuFaultWarning, trapMemoryUeccCritical=trapMemoryUeccCritical, trapCpuFaultCritical=trapCpuFaultCritical, sysBIOSIndex=sysBIOSIndex, raidVDState=raidVDState, cpuDeviceStatus=cpuDeviceStatus, memErrorCount=memErrorCount, raidVDTargetId=raidVDTargetId, raidAdapterTable=raidAdapterTable, raidPDWriteCache=raidPDWriteCache, raidAdapterFWVersion=raidAdapterFWVersion, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, cpuDeviceID=cpuDeviceID, diskInterfaceType=diskInterfaceType, sysBIOSVersion=sysBIOSVersion, memDescription=memDescription, trapFanCritical=trapFanCritical, cpuName=cpuName, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, memTag=memTag, osManufacturer=osManufacturer, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, diskName=diskName, raidPDLinkSpeed=raidPDLinkSpeed, cpuDeviceVersion=cpuDeviceVersion, trapChassisIntrusionCleared=trapChassisIntrusionCleared, raidAdapterGroup_BBU=raidAdapterGroup_BBU, mbIndex=mbIndex, trapMemoryUeccNormal=trapMemoryUeccNormal, raidVDSpanDepth=raidVDSpanDepth, raidPDPredFailCount=raidPDPredFailCount, memTotalWidth=memTotalWidth, raidPDNCQSetting=raidPDNCQSetting, raidAdapterId_BBU=raidAdapterId_BBU, cpuEntry=cpuEntry, ueccLogDatetime=ueccLogDatetime, raidPDInquiryData=raidPDInquiryData, dmiLogTable=dmiLogTable, trapMemoryCeccCritical=trapMemoryCeccCritical, sysBIOSReleaseDate=sysBIOSReleaseDate, diskSerialNumber=diskSerialNumber, sd5Entry=sd5Entry, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo)
