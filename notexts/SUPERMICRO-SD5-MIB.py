...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", raidAdapterId_VD=raidAdapterId_VD, trapMemoryCeccNormal=trapMemoryCeccNormal, raidVDRaidLevel=raidVDRaidLevel, raidPDOpProgress=raidPDOpProgress, raidPDModel=raidPDModel, diskMediaType=diskMediaType, memDescription=memDescription, raidVDNumDrives=raidVDNumDrives, cpuLoadingPercentage=cpuLoadingPercentage, mbTable=mbTable, memTable=memTable, trapTemperatureWarning=trapTemperatureWarning, trapBatteryStatusCritical=trapBatteryStatusCritical, PYSNMP_MODULE_ID=smSuperDoctor5MIB, raidPDNCQSetting=raidPDNCQSetting, raidPDOtherErrorCount=raidPDOtherErrorCount, osVersion=osVersion, ceccLogEntry=ceccLogEntry, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidVDCached=raidVDCached, cpuDeviceStatus=cpuDeviceStatus, trapVoltageNormal=trapVoltageNormal, raidPDWriteCache=raidPDWriteCache, raidVDTable=raidVDTable, raidPDMediaErrorCount=raidPDMediaErrorCount, cpuManufacturer=cpuManufacturer, sysBIOSIndex=sysBIOSIndex, postLogDatetime=postLogDatetime, osEntry=osEntry, raidAdapterGroup_VD=raidAdapterGroup_VD, memUECCErrorCount=memUECCErrorCount, raidPDPredFailCount=raidPDPredFailCount, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, trapTemperatureNormal=trapTemperatureNormal, osName=osName, cpuMaxSpeed=cpuMaxSpeed, raidDiskGroupId=raidDiskGroupId, memDeviceLocator=memDeviceLocator, cpuDeviceVersion=cpuDeviceVersion, trapMemoryUeccCritical=trapMemoryUeccCritical, ueccLogInfo=ueccLogInfo, ueccLogEntry=ueccLogEntry, raidAdapterGroup_BBU=raidAdapterGroup_BBU, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, trapBbpStatusCritical=trapBbpStatusCritical, ceccLogIndex=ceccLogIndex, diskEntry=diskEntry, cpuCoreCount=cpuCoreCount, cpuLogTable=cpuLogTable, sysBIOSManufacturer=sysBIOSManufacturer, sysBIOSEntry=sysBIOSEntry, raidVDMirrorDataSize=raidVDMirrorDataSize, memECCErrorCount=memECCErrorCount, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidVDSupportT10Power=raidVDSupportT10Power, raidPDIndex=raidPDIndex, trapMemoryUeccNormal=trapMemoryUeccNormal, raidBBUStatus=raidBBUStatus, mbManufacturer=mbManufacturer, trapFanNormal=trapFanNormal, memTotalWidth=memTotalWidth, trapTemperatureCritical=trapTemperatureCritical, cpuIndex=cpuIndex, cpuDescription=cpuDescription, raidPDFirmwareRevision=raidPDFirmwareRevision, trapPowerSupplyCritical=trapPowerSupplyCritical, cpuCurrentSpeed=cpuCurrentSpeed, raidPDDeviceSpeed=raidPDDeviceSpeed, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, trapCpuFaultCritical=trapCpuFaultCritical, cpuLogInfo=cpuLogInfo, raidVDEntry=raidVDEntry, diskName=diskName, raidVDAllinoneStatus=raidVDAllinoneStatus, raidPDEntry=raidPDEntry, trapBbpStatusWarning=trapBbpStatusWarning, raidVDIndex=raidVDIndex, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, cpuLogEntry=cpuLogEntry, trapBbpStatusNormal=trapBbpStatusNormal, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidAdapterIndex=raidAdapterIndex, raidAdapterSerialNumber=raidAdapterSerialNumber, sd5Version=sd5Version, trapCpuFaultWarning=trapCpuFaultWarning, raidAdapterId=raidAdapterId, diskSerialNumber=diskSerialNumber, raidPDRawSize=raidPDRawSize, raidVDSupportsMaxPS=raidVDSupportsMaxPS, cpuEntry=cpuEntry, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, trapChassisIntrusion=trapChassisIntrusion, raidAdapterId_PD=raidAdapterId_PD, trapMemoryUeccWarning=trapMemoryUeccWarning, memCapacity=memCapacity, ceccLogDatetime=ceccLogDatetime, memDeviceStatus=memDeviceStatus, raidAdapterFWVersion=raidAdapterFWVersion, raidPDAllinoneMsg=raidPDAllinoneMsg, raidVDAllinoneMsg=raidVDAllinoneMsg, ueccLogDatetime=ueccLogDatetime, trapPowerSupplyWarning=trapPowerSupplyWarning, osCSDVersion=osCSDVersion, diskTable=diskTable, postLogTable=postLogTable, raidIsBBUAbsent=raidIsBBUAbsent, raidVDSpanDepth=raidVDSpanDepth, raidVDStripSize=raidVDStripSize, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, memErrorCount=memErrorCount, cpuDeviceID=cpuDeviceID, diskSmartStatus=diskSmartStatus, cpuID=cpuID, diskVendor=diskVendor, cpuLogIndex=cpuLogIndex, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, memTag=memTag, sysBIOSVersion=sysBIOSVersion, trapFanWarning=trapFanWarning, raidAdapterTable=raidAdapterTable, trapGenericWarning=trapGenericWarning, cpuTable=cpuTable, raidVDSize=raidVDSize, cpuThreadCount=cpuThreadCount, mbAssetTag=mbAssetTag, smSuperDoctor5MIB=smSuperDoctor5MIB, raidPDDeviceFwLevel=raidPDDeviceFwLevel, raidVDDiskCachePolicy=raidVDDiskCachePolicy, ueccLogTable=ueccLogTable, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidPDMediaType=raidPDMediaType, raidAdapterId_BBU=raidAdapterId_BBU, trapBatteryStatusWarning=trapBatteryStatusWarning, diskSlotID=diskSlotID, memSerialNumber=memSerialNumber, memPartNumber=memPartNumber, sysBIOSTable=sysBIOSTable, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidBBUIndex=raidBBUIndex, cpuCoreEnabled=cpuCoreEnabled, memDataWidth=memDataWidth, postLogInfo=postLogInfo, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, raidAdapterEntry=raidAdapterEntry, raidBBUTable=raidBBUTable, raidAdapterDeviceId=raidAdapterDeviceId, sysBIOSReleaseDate=sysBIOSReleaseDate, raidPDTable=raidPDTable, raidPDLinkSpeed=raidPDLinkSpeed, raidPDPort1Linkspeed=raidPDPort1Linkspeed, ceccLogInfo=ceccLogInfo, raidAdapterVendorId=raidAdapterVendorId, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, trapBatteryStatusNormal=trapBatteryStatusNormal, diskInterfaceType=diskInterfaceType, smSD5TrapMIB=smSD5TrapMIB, raidAdapterProductName=raidAdapterProductName, osSerialNumber=osSerialNumber, ueccLogIndex=ueccLogIndex, raidAdapterSubVendorId=raidAdapterSubVendorId, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidDiskGroupId_PD=raidDiskGroupId_PD, raidVDName=raidVDName, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, trapVoltageWarning=trapVoltageWarning, memLabeledBank=memLabeledBank, raidVDBadBlocksExist=raidVDBadBlocksExist, trapMemoryCeccWarning=trapMemoryCeccWarning, trapGenericCritical=trapGenericCritical, trapGenericNormal=trapGenericNormal, raidAdapterGroup_PD=raidAdapterGroup_PD, raidPDSlotNumber=raidPDSlotNumber, raidPDFirmwareState=raidPDFirmwareState, raidBBUEntry=raidBBUEntry, raidPDPort0Status=raidPDPort0Status, raidPDAllinoneStatus=raidPDAllinoneStatus, trapChassisIntrusionCleared=trapChassisIntrusionCleared, postLogEntry=postLogEntry, sd5Entry=sd5Entry, dmiLogTable=dmiLogTable, mbSerialNumber=mbSerialNumber, raidVDEncryptionType=raidVDEncryptionType, raidPDInquiryData=raidPDInquiryData, sd5Table=sd5Table, raidAdapterGroup=raidAdapterGroup, diskSize=diskSize, mbEntry=mbEntry, postLogIndex=postLogIndex, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidPDPort1Status=raidPDPort1Status, memManufacturer=memManufacturer, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidPDSerialNumber=raidPDSerialNumber, cpuSocketDesignation=cpuSocketDesignation, sd5Idx=sd5Idx, raidVDId=raidVDId, raidPDPort0Linkspeed=raidPDPort0Linkspeed, raidPDSpan=raidPDSpan, mbIndex=mbIndex, ceccLogTable=ceccLogTable, trapFanCritical=trapFanCritical, memModel=memModel, diskModel=diskModel, osManufacturer=osManufacturer, raidVDState=raidVDState, trapPowerSupplyNormal=trapPowerSupplyNormal, diskController=diskController, trapMemoryCeccCritical=trapMemoryCeccCritical, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, osTable=osTable, cpuName=cpuName, trapVoltageCritical=trapVoltageCritical, memEntry=memEntry, raidBBUAllinoneMsg=raidBBUAllinoneMsg, trapCpuFaultNormal=trapCpuFaultNormal, mbVersionName=mbVersionName, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, osIndex=osIndex, mbProductName=mbProductName, cpuLogDatetime=cpuLogDatetime, raidVDTargetId=raidVDTargetId, sd5MIBVersion=sd5MIBVersion)
