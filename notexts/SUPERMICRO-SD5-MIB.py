...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", ueccLogEntry=ueccLogEntry, trapMemoryUeccNormal=trapMemoryUeccNormal, raidVDRaidLevel=raidVDRaidLevel, cpuTable=cpuTable, raidAdapterGroup_VD=raidAdapterGroup_VD, raidVDState=raidVDState, raidPDPort1Status=raidPDPort1Status, cpuLogDatetime=cpuLogDatetime, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, memPartNumber=memPartNumber, mbIndex=mbIndex, cpuID=cpuID, raidPDIndex=raidPDIndex, trapCpuFaultWarning=trapCpuFaultWarning, sysBIOSIndex=sysBIOSIndex, raidAdapterFWVersion=raidAdapterFWVersion, raidVDAllinoneStatus=raidVDAllinoneStatus, diskSmartStatus=diskSmartStatus, cpuLogIndex=cpuLogIndex, trapVoltageCritical=trapVoltageCritical, trapPowerSupplyCritical=trapPowerSupplyCritical, raidAdapterGroup=raidAdapterGroup, trapMemoryCeccNormal=trapMemoryCeccNormal, cpuCoreCount=cpuCoreCount, ceccLogDatetime=ceccLogDatetime, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, raidAdapterVendorId=raidAdapterVendorId, smSuperDoctor5MIB=smSuperDoctor5MIB, raidAdapterProductName=raidAdapterProductName, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidVDSpanDepth=raidVDSpanDepth, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, ceccLogTable=ceccLogTable, raidPDOtherErrorCount=raidPDOtherErrorCount, sd5Entry=sd5Entry, trapChassisIntrusionCleared=trapChassisIntrusionCleared, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, memSerialNumber=memSerialNumber, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, PYSNMP_MODULE_ID=smSuperDoctor5MIB, diskController=diskController, trapFanNormal=trapFanNormal, postLogEntry=postLogEntry, memECCErrorCount=memECCErrorCount, raidVDId=raidVDId, raidBBUStatus=raidBBUStatus, raidVDAllinoneMsg=raidVDAllinoneMsg, ueccLogIndex=ueccLogIndex, cpuMaxSpeed=cpuMaxSpeed, diskSerialNumber=diskSerialNumber, cpuLogEntry=cpuLogEntry, sysBIOSManufacturer=sysBIOSManufacturer, postLogDatetime=postLogDatetime, raidVDNumDrives=raidVDNumDrives, raidPDDeviceSpeed=raidPDDeviceSpeed, trapPowerSupplyNormal=trapPowerSupplyNormal, memCapacity=memCapacity, sysBIOSTable=sysBIOSTable, raidPDWriteCache=raidPDWriteCache, sysBIOSReleaseDate=sysBIOSReleaseDate, raidPDFirmwareRevision=raidPDFirmwareRevision, memLabeledBank=memLabeledBank, trapCpuFaultNormal=trapCpuFaultNormal, trapPowerSupplyWarning=trapPowerSupplyWarning, raidVDName=raidVDName, raidVDTable=raidVDTable, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, osTable=osTable, raidAdapterId_PD=raidAdapterId_PD, raidVDSupportsMaxPS=raidVDSupportsMaxPS, memTag=memTag, diskInterfaceType=diskInterfaceType, raidVDDiskCachePolicy=raidVDDiskCachePolicy, memUECCErrorCount=memUECCErrorCount, raidAdapterGroup_PD=raidAdapterGroup_PD, trapGenericNormal=trapGenericNormal, postLogInfo=postLogInfo, trapMemoryCeccCritical=trapMemoryCeccCritical, osVersion=osVersion, sd5Idx=sd5Idx, cpuDescription=cpuDescription, cpuDeviceVersion=cpuDeviceVersion, raidVDStripSize=raidVDStripSize, ceccLogInfo=ceccLogInfo, raidVDEncryptionType=raidVDEncryptionType, raidVDSupportT10Power=raidVDSupportT10Power, trapTemperatureNormal=trapTemperatureNormal, trapGenericWarning=trapGenericWarning, trapBbpStatusCritical=trapBbpStatusCritical, raidVDTargetId=raidVDTargetId, raidIsBBUAbsent=raidIsBBUAbsent, memModel=memModel, trapFanWarning=trapFanWarning, memDeviceStatus=memDeviceStatus, raidPDAllinoneMsg=raidPDAllinoneMsg, memDeviceLocator=memDeviceLocator, mbSerialNumber=mbSerialNumber, ueccLogDatetime=ueccLogDatetime, raidAdapterIndex=raidAdapterIndex, diskName=diskName, diskModel=diskModel, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, mbTable=mbTable, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, trapTemperatureCritical=trapTemperatureCritical, raidAdapterSubVendorId=raidAdapterSubVendorId, cpuCurrentSpeed=cpuCurrentSpeed, osSerialNumber=osSerialNumber, cpuDeviceID=cpuDeviceID, raidPDPort1Linkspeed=raidPDPort1Linkspeed, mbProductName=mbProductName, raidAdapterSerialNumber=raidAdapterSerialNumber, raidAdapterBIOSVersion=raidAdapterBIOSVersion, memDescription=memDescription, trapGenericCritical=trapGenericCritical, trapBbpStatusNormal=trapBbpStatusNormal, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, osName=osName, raidPDMediaType=raidPDMediaType, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, diskMediaType=diskMediaType, raidPDLinkSpeed=raidPDLinkSpeed, cpuEntry=cpuEntry, raidBBUTable=raidBBUTable, raidDiskGroupId=raidDiskGroupId, postLogIndex=postLogIndex, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, raidPDMediaErrorCount=raidPDMediaErrorCount, raidPDPredFailCount=raidPDPredFailCount, raidPDPort0Linkspeed=raidPDPort0Linkspeed, raidVDSize=raidVDSize, sysBIOSVersion=sysBIOSVersion, raidPDRawSize=raidPDRawSize, raidBBUEntry=raidBBUEntry, trapBatteryStatusWarning=trapBatteryStatusWarning, trapBatteryStatusCritical=trapBatteryStatusCritical, sd5MIBVersion=sd5MIBVersion, raidVDIndex=raidVDIndex, raidVDBadBlocksExist=raidVDBadBlocksExist, raidAdapterId=raidAdapterId, cpuThreadCount=cpuThreadCount, memTotalWidth=memTotalWidth, trapMemoryUeccWarning=trapMemoryUeccWarning, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, raidAdapterDeviceId=raidAdapterDeviceId, raidVDCached=raidVDCached, ceccLogEntry=ceccLogEntry, osCSDVersion=osCSDVersion, raidBBUIndex=raidBBUIndex, diskSize=diskSize, mbVersionName=mbVersionName, osIndex=osIndex, raidPDAllinoneStatus=raidPDAllinoneStatus, cpuIndex=cpuIndex, diskTable=diskTable, trapCpuFaultCritical=trapCpuFaultCritical, cpuLogInfo=cpuLogInfo, raidPDPort0Status=raidPDPort0Status, raidPDDeviceFwLevel=raidPDDeviceFwLevel, trapBatteryStatusNormal=trapBatteryStatusNormal, raidAdapterEntry=raidAdapterEntry, memDataWidth=memDataWidth, osEntry=osEntry, raidPDModel=raidPDModel, raidPDSerialNumber=raidPDSerialNumber, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, trapTemperatureWarning=trapTemperatureWarning, cpuLoadingPercentage=cpuLoadingPercentage, osManufacturer=osManufacturer, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidPDEntry=raidPDEntry, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidPDOpProgress=raidPDOpProgress, trapVoltageWarning=trapVoltageWarning, memTable=memTable, raidAdapterId_BBU=raidAdapterId_BBU, cpuName=cpuName, mbManufacturer=mbManufacturer, ueccLogInfo=ueccLogInfo, raidPDInquiryData=raidPDInquiryData, raidPDSpan=raidPDSpan, memManufacturer=memManufacturer, diskSlotID=diskSlotID, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidPDSlotNumber=raidPDSlotNumber, diskVendor=diskVendor, raidPDFirmwareState=raidPDFirmwareState, diskEntry=diskEntry, cpuLogTable=cpuLogTable, raidAdapterId_VD=raidAdapterId_VD, cpuDeviceStatus=cpuDeviceStatus, trapMemoryUeccCritical=trapMemoryUeccCritical, ceccLogIndex=ceccLogIndex, ueccLogTable=ueccLogTable, smSD5TrapMIB=smSD5TrapMIB, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, trapMemoryCeccWarning=trapMemoryCeccWarning, mbAssetTag=mbAssetTag, memEntry=memEntry, memErrorCount=memErrorCount, cpuManufacturer=cpuManufacturer, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, trapVoltageNormal=trapVoltageNormal, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, raidVDEntry=raidVDEntry, raidPDNCQSetting=raidPDNCQSetting, postLogTable=postLogTable, cpuCoreEnabled=cpuCoreEnabled, sd5Version=sd5Version, raidAdapterTable=raidAdapterTable, trapBbpStatusWarning=trapBbpStatusWarning, sysBIOSEntry=sysBIOSEntry, raidPDTable=raidPDTable, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidVDMirrorDataSize=raidVDMirrorDataSize, trapChassisIntrusion=trapChassisIntrusion, raidDiskGroupId_PD=raidDiskGroupId_PD, mbEntry=mbEntry, trapFanCritical=trapFanCritical, dmiLogTable=dmiLogTable, sd5Table=sd5Table, raidBBUAllinoneStatus=raidBBUAllinoneStatus, cpuSocketDesignation=cpuSocketDesignation)
