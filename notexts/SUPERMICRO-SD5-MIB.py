...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", sd5MIBVersion=sd5MIBVersion, sysBIOSTable=sysBIOSTable, raidAdapterFWVersion=raidAdapterFWVersion, ueccLogTable=ueccLogTable, ueccLogEntry=ueccLogEntry, osManufacturer=osManufacturer, raidVDAllinoneStatus=raidVDAllinoneStatus, raidPDModel=raidPDModel, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, raidPDTable=raidPDTable, trapMemoryCeccWarning=trapMemoryCeccWarning, sysBIOSReleaseDate=sysBIOSReleaseDate, trapPowerSupplyWarning=trapPowerSupplyWarning, ceccLogDatetime=ceccLogDatetime, raidDiskGroupId_PD=raidDiskGroupId_PD, raidVDNumDrives=raidVDNumDrives, mbTable=mbTable, raidPDSpan=raidPDSpan, cpuName=cpuName, raidIsBBUAbsent=raidIsBBUAbsent, memErrorCount=memErrorCount, trapMemoryCeccCritical=trapMemoryCeccCritical, osVersion=osVersion, raidBBUTable=raidBBUTable, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, sysBIOSEntry=sysBIOSEntry, raidPDInquiryData=raidPDInquiryData, trapMemoryUeccCritical=trapMemoryUeccCritical, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidPDIndex=raidPDIndex, cpuEntry=cpuEntry, raidAdapterGroup_PD=raidAdapterGroup_PD, raidPDFirmwareState=raidPDFirmwareState, trapBatteryStatusWarning=trapBatteryStatusWarning, PYSNMP_MODULE_ID=smSuperDoctor5MIB, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, osSerialNumber=osSerialNumber, trapGenericCritical=trapGenericCritical, trapGenericNormal=trapGenericNormal, sd5Idx=sd5Idx, raidVDEntry=raidVDEntry, raidAdapterId_PD=raidAdapterId_PD, cpuDeviceStatus=cpuDeviceStatus, osIndex=osIndex, raidVDMirrorDataSize=raidVDMirrorDataSize, raidBBUEntry=raidBBUEntry, diskSerialNumber=diskSerialNumber, raidAdapterEntry=raidAdapterEntry, cpuDeviceVersion=cpuDeviceVersion, memPartNumber=memPartNumber, ceccLogTable=ceccLogTable, cpuManufacturer=cpuManufacturer, mbAssetTag=mbAssetTag, raidVDRaidLevel=raidVDRaidLevel, sd5Table=sd5Table, memTable=memTable, trapBatteryStatusNormal=trapBatteryStatusNormal, memManufacturer=memManufacturer, trapCpuFaultCritical=trapCpuFaultCritical, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, cpuLogEntry=cpuLogEntry, memLabeledBank=memLabeledBank, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, memCapacity=memCapacity, raidBBUAllinoneMsg=raidBBUAllinoneMsg, ceccLogIndex=ceccLogIndex, raidPDRawSize=raidPDRawSize, cpuCurrentSpeed=cpuCurrentSpeed, osName=osName, ceccLogEntry=ceccLogEntry, raidPDAllinoneMsg=raidPDAllinoneMsg, ueccLogInfo=ueccLogInfo, cpuLogInfo=cpuLogInfo, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, postLogTable=postLogTable, trapCpuFaultWarning=trapCpuFaultWarning, raidVDStripSize=raidVDStripSize, sd5Version=sd5Version, diskEntry=diskEntry, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, cpuLogDatetime=cpuLogDatetime, raidVDTable=raidVDTable, cpuDescription=cpuDescription, cpuSocketDesignation=cpuSocketDesignation, raidPDDeviceFwLevel=raidPDDeviceFwLevel, raidAdapterIndex=raidAdapterIndex, raidAdapterSubVendorId=raidAdapterSubVendorId, raidPDSerialNumber=raidPDSerialNumber, raidPDLinkSpeed=raidPDLinkSpeed, diskSmartStatus=diskSmartStatus, memDataWidth=memDataWidth, cpuLogTable=cpuLogTable, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, smSD5TrapMIB=smSD5TrapMIB, diskController=diskController, cpuThreadCount=cpuThreadCount, raidVDId=raidVDId, raidDiskGroupId=raidDiskGroupId, diskVendor=diskVendor, raidPDPredFailCount=raidPDPredFailCount, trapVoltageCritical=trapVoltageCritical, sysBIOSIndex=sysBIOSIndex, cpuMaxSpeed=cpuMaxSpeed, memDeviceLocator=memDeviceLocator, osTable=osTable, trapTemperatureNormal=trapTemperatureNormal, diskMediaType=diskMediaType, raidVDSupportsMaxPS=raidVDSupportsMaxPS, memModel=memModel, osEntry=osEntry, mbManufacturer=mbManufacturer, raidAdapterTable=raidAdapterTable, trapChassisIntrusionCleared=trapChassisIntrusionCleared, diskSize=diskSize, raidVDCached=raidVDCached, raidPDOtherErrorCount=raidPDOtherErrorCount, raidVDSpanDepth=raidVDSpanDepth, postLogDatetime=postLogDatetime, raidPDDeviceSpeed=raidPDDeviceSpeed, cpuIndex=cpuIndex, raidPDPort1Status=raidPDPort1Status, diskTable=diskTable, raidAdapterId=raidAdapterId, cpuLogIndex=cpuLogIndex, smSuperDoctor5MIB=smSuperDoctor5MIB, sysBIOSVersion=sysBIOSVersion, memUECCErrorCount=memUECCErrorCount, raidAdapterGroup_BBU=raidAdapterGroup_BBU, trapPowerSupplyNormal=trapPowerSupplyNormal, raidAdapterId_BBU=raidAdapterId_BBU, trapGenericWarning=trapGenericWarning, raidVDDiskCachePolicy=raidVDDiskCachePolicy, raidPDPort0Linkspeed=raidPDPort0Linkspeed, raidAdapterProductName=raidAdapterProductName, mbIndex=mbIndex, raidAdapterGroup=raidAdapterGroup, raidPDMediaErrorCount=raidPDMediaErrorCount, cpuDeviceID=cpuDeviceID, cpuCoreCount=cpuCoreCount, raidVDAllinoneMsg=raidVDAllinoneMsg, raidVDIndex=raidVDIndex, raidAdapterBIOSVersion=raidAdapterBIOSVersion, cpuLoadingPercentage=cpuLoadingPercentage, raidPDEntry=raidPDEntry, trapFanCritical=trapFanCritical, raidAdapterSubDeviceId=raidAdapterSubDeviceId, memTotalWidth=memTotalWidth, diskModel=diskModel, raidBBUAllinoneStatus=raidBBUAllinoneStatus, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, sd5Entry=sd5Entry, trapCpuFaultNormal=trapCpuFaultNormal, raidVDName=raidVDName, raidPDSlotNumber=raidPDSlotNumber, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, trapFanNormal=trapFanNormal, trapVoltageWarning=trapVoltageWarning, trapMemoryUeccWarning=trapMemoryUeccWarning, raidBBUStatus=raidBBUStatus, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, trapTemperatureCritical=trapTemperatureCritical, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, raidPDOpProgress=raidPDOpProgress, raidVDTargetId=raidVDTargetId, ueccLogIndex=ueccLogIndex, mbEntry=mbEntry, mbVersionName=mbVersionName, raidPDAllinoneStatus=raidPDAllinoneStatus, cpuTable=cpuTable, raidAdapterGroup_VD=raidAdapterGroup_VD, trapBbpStatusCritical=trapBbpStatusCritical, raidPDPort0Status=raidPDPort0Status, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, trapBatteryStatusCritical=trapBatteryStatusCritical, ueccLogDatetime=ueccLogDatetime, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, osCSDVersion=osCSDVersion, trapVoltageNormal=trapVoltageNormal, raidPDPort1Linkspeed=raidPDPort1Linkspeed, ceccLogInfo=ceccLogInfo, postLogEntry=postLogEntry, diskName=diskName, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidAdapterId_VD=raidAdapterId_VD, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, mbSerialNumber=mbSerialNumber, memEntry=memEntry, postLogIndex=postLogIndex, trapBbpStatusNormal=trapBbpStatusNormal, trapMemoryUeccNormal=trapMemoryUeccNormal, raidAdapterVendorId=raidAdapterVendorId, cpuCoreEnabled=cpuCoreEnabled, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, postLogInfo=postLogInfo, raidVDState=raidVDState, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidPDFirmwareRevision=raidPDFirmwareRevision, memSerialNumber=memSerialNumber, trapBbpStatusWarning=trapBbpStatusWarning, cpuID=cpuID, memTag=memTag, raidVDSize=raidVDSize, raidAdapterSerialNumber=raidAdapterSerialNumber, diskSlotID=diskSlotID, raidVDEncryptionType=raidVDEncryptionType, raidBBUIndex=raidBBUIndex, memDeviceStatus=memDeviceStatus, raidPDWriteCache=raidPDWriteCache, raidPDMediaType=raidPDMediaType, dmiLogTable=dmiLogTable, trapChassisIntrusion=trapChassisIntrusion, memECCErrorCount=memECCErrorCount, raidVDBadBlocksExist=raidVDBadBlocksExist, trapPowerSupplyCritical=trapPowerSupplyCritical, sysBIOSManufacturer=sysBIOSManufacturer, raidPDNCQSetting=raidPDNCQSetting, diskInterfaceType=diskInterfaceType, trapMemoryCeccNormal=trapMemoryCeccNormal, trapTemperatureWarning=trapTemperatureWarning, mbProductName=mbProductName, raidAdapterDeviceId=raidAdapterDeviceId, trapFanWarning=trapFanWarning, memDescription=memDescription, raidVDSupportT10Power=raidVDSupportT10Power)
