...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", ceccLogDatetime=ceccLogDatetime, raidVDNumDrives=raidVDNumDrives, ceccLogIndex=ceccLogIndex, trapFanWarning=trapFanWarning, memCapacity=memCapacity, trapTemperatureWarning=trapTemperatureWarning, memPartNumber=memPartNumber, raidPDPredFailCount=raidPDPredFailCount, raidDiskGroupId=raidDiskGroupId, cpuLogInfo=cpuLogInfo, diskInterfaceType=diskInterfaceType, osName=osName, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, cpuEntry=cpuEntry, memDeviceStatus=memDeviceStatus, sd5MIBVersion=sd5MIBVersion, raidPDIndex=raidPDIndex, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidAdapterGroup_VD=raidAdapterGroup_VD, raidAdapterSubVendorId=raidAdapterSubVendorId, osIndex=osIndex, raidDiskGroupId_PD=raidDiskGroupId_PD, raidPDSpan=raidPDSpan, raidPDTable=raidPDTable, postLogTable=postLogTable, raidVDAllinoneStatus=raidVDAllinoneStatus, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, cpuMaxSpeed=cpuMaxSpeed, cpuLogTable=cpuLogTable, raidVDSpanDepth=raidVDSpanDepth, raidVDState=raidVDState, memLabeledBank=memLabeledBank, raidVDAllinoneMsg=raidVDAllinoneMsg, raidPDOtherErrorCount=raidPDOtherErrorCount, trapBatteryStatusWarning=trapBatteryStatusWarning, raidVDId=raidVDId, ceccLogEntry=ceccLogEntry, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidPDRawSize=raidPDRawSize, osEntry=osEntry, raidVDSupportT10Power=raidVDSupportT10Power, cpuIndex=cpuIndex, raidBBUTable=raidBBUTable, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, diskMediaType=diskMediaType, diskSmartStatus=diskSmartStatus, cpuLogEntry=cpuLogEntry, raidPDModel=raidPDModel, trapGenericCritical=trapGenericCritical, trapPowerSupplyWarning=trapPowerSupplyWarning, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidPDLinkSpeed=raidPDLinkSpeed, raidPDPort0Status=raidPDPort0Status, PYSNMP_MODULE_ID=smSuperDoctor5MIB, trapTemperatureNormal=trapTemperatureNormal, cpuName=cpuName, trapMemoryUeccNormal=trapMemoryUeccNormal, cpuThreadCount=cpuThreadCount, sysBIOSTable=sysBIOSTable, trapFanNormal=trapFanNormal, mbAssetTag=mbAssetTag, cpuDeviceVersion=cpuDeviceVersion, trapVoltageWarning=trapVoltageWarning, raidAdapterId_PD=raidAdapterId_PD, raidAdapterVendorId=raidAdapterVendorId, cpuCoreEnabled=cpuCoreEnabled, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, mbVersionName=mbVersionName, cpuDescription=cpuDescription, raidPDFirmwareRevision=raidPDFirmwareRevision, ueccLogTable=ueccLogTable, raidPDOpProgress=raidPDOpProgress, diskVendor=diskVendor, diskSize=diskSize, smSuperDoctor5MIB=smSuperDoctor5MIB, sd5Version=sd5Version, mbManufacturer=mbManufacturer, cpuSocketDesignation=cpuSocketDesignation, trapBbpStatusNormal=trapBbpStatusNormal, raidBBUEntry=raidBBUEntry, mbProductName=mbProductName, diskName=diskName, ueccLogEntry=ueccLogEntry, memTag=memTag, trapCpuFaultWarning=trapCpuFaultWarning, raidAdapterTable=raidAdapterTable, sysBIOSReleaseDate=sysBIOSReleaseDate, osTable=osTable, memDescription=memDescription, diskSlotID=diskSlotID, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidPDAllinoneMsg=raidPDAllinoneMsg, raidPDEntry=raidPDEntry, diskModel=diskModel, raidAdapterIndex=raidAdapterIndex, trapPowerSupplyCritical=trapPowerSupplyCritical, osCSDVersion=osCSDVersion, postLogDatetime=postLogDatetime, memEntry=memEntry, raidVDSupportsMaxPS=raidVDSupportsMaxPS, trapBatteryStatusNormal=trapBatteryStatusNormal, cpuCoreCount=cpuCoreCount, sd5Idx=sd5Idx, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidVDMirrorDataSize=raidVDMirrorDataSize, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidBBUIndex=raidBBUIndex, raidAdapterSerialNumber=raidAdapterSerialNumber, osVersion=osVersion, sysBIOSVersion=sysBIOSVersion, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidVDDiskCachePolicy=raidVDDiskCachePolicy, trapPowerSupplyNormal=trapPowerSupplyNormal, raidVDCached=raidVDCached, raidAdapterBIOSVersion=raidAdapterBIOSVersion, trapFanCritical=trapFanCritical, cpuDeviceStatus=cpuDeviceStatus, trapCpuFaultNormal=trapCpuFaultNormal, memSerialNumber=memSerialNumber, raidPDNCQSetting=raidPDNCQSetting, cpuLoadingPercentage=cpuLoadingPercentage, trapChassisIntrusion=trapChassisIntrusion, raidVDStripSize=raidVDStripSize, osManufacturer=osManufacturer, memTable=memTable, ceccLogInfo=ceccLogInfo, sd5Table=sd5Table, memErrorCount=memErrorCount, postLogEntry=postLogEntry, cpuTable=cpuTable, raidVDTable=raidVDTable, raidPDMediaErrorCount=raidPDMediaErrorCount, trapGenericWarning=trapGenericWarning, trapBbpStatusCritical=trapBbpStatusCritical, ueccLogDatetime=ueccLogDatetime, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, ueccLogIndex=ueccLogIndex, sysBIOSIndex=sysBIOSIndex, mbEntry=mbEntry, trapGenericNormal=trapGenericNormal, mbTable=mbTable, cpuCurrentSpeed=cpuCurrentSpeed, trapVoltageCritical=trapVoltageCritical, osSerialNumber=osSerialNumber, memManufacturer=memManufacturer, memUECCErrorCount=memUECCErrorCount, raidPDDeviceFwLevel=raidPDDeviceFwLevel, raidPDInquiryData=raidPDInquiryData, raidPDPort1Status=raidPDPort1Status, raidVDEncryptionType=raidVDEncryptionType, raidVDEntry=raidVDEntry, ceccLogTable=ceccLogTable, raidAdapterId_VD=raidAdapterId_VD, trapCpuFaultCritical=trapCpuFaultCritical, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidPDAllinoneStatus=raidPDAllinoneStatus, raidVDSize=raidVDSize, diskSerialNumber=diskSerialNumber, mbSerialNumber=mbSerialNumber, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, trapMemoryCeccWarning=trapMemoryCeccWarning, raidPDDeviceSpeed=raidPDDeviceSpeed, diskTable=diskTable, raidPDWriteCache=raidPDWriteCache, cpuLogIndex=cpuLogIndex, raidAdapterGroup=raidAdapterGroup, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, trapMemoryCeccCritical=trapMemoryCeccCritical, trapBbpStatusWarning=trapBbpStatusWarning, raidPDMediaType=raidPDMediaType, sd5Entry=sd5Entry, sysBIOSManufacturer=sysBIOSManufacturer, raidBBUStatus=raidBBUStatus, raidVDIndex=raidVDIndex, raidAdapterFWVersion=raidAdapterFWVersion, raidAdapterId_BBU=raidAdapterId_BBU, raidAdapterGroup_PD=raidAdapterGroup_PD, raidAdapterId=raidAdapterId, raidAdapterDeviceId=raidAdapterDeviceId, postLogInfo=postLogInfo, trapMemoryUeccWarning=trapMemoryUeccWarning, memTotalWidth=memTotalWidth, memECCErrorCount=memECCErrorCount, trapMemoryUeccCritical=trapMemoryUeccCritical, raidAdapterProductName=raidAdapterProductName, ueccLogInfo=ueccLogInfo, trapTemperatureCritical=trapTemperatureCritical, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, memDataWidth=memDataWidth, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, trapBatteryStatusCritical=trapBatteryStatusCritical, dmiLogTable=dmiLogTable, raidPDPort0Linkspeed=raidPDPort0Linkspeed, cpuManufacturer=cpuManufacturer, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, raidVDBadBlocksExist=raidVDBadBlocksExist, cpuID=cpuID, memDeviceLocator=memDeviceLocator, raidAdapterEntry=raidAdapterEntry, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, diskController=diskController, trapVoltageNormal=trapVoltageNormal, trapChassisIntrusionCleared=trapChassisIntrusionCleared, mbIndex=mbIndex, raidIsBBUAbsent=raidIsBBUAbsent, raidAdapterSubDeviceId=raidAdapterSubDeviceId, sysBIOSEntry=sysBIOSEntry, raidVDRaidLevel=raidVDRaidLevel, postLogIndex=postLogIndex, diskEntry=diskEntry, raidVDTargetId=raidVDTargetId, smSD5TrapMIB=smSD5TrapMIB, cpuDeviceID=cpuDeviceID, trapMemoryCeccNormal=trapMemoryCeccNormal, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidPDSlotNumber=raidPDSlotNumber, raidVDName=raidVDName, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidPDSerialNumber=raidPDSerialNumber, cpuLogDatetime=cpuLogDatetime, memModel=memModel, raidPDFirmwareState=raidPDFirmwareState)
