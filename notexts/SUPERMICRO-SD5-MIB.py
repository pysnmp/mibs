...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", trapPowerSupplyCritical=trapPowerSupplyCritical, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, sysBIOSIndex=sysBIOSIndex, trapFanWarning=trapFanWarning, raidPDMediaType=raidPDMediaType, sd5Version=sd5Version, diskSlotID=diskSlotID, raidPDModel=raidPDModel, mbVersionName=mbVersionName, raidAdapterId_BBU=raidAdapterId_BBU, raidAdapterId_VD=raidAdapterId_VD, raidVDRaidLevel=raidVDRaidLevel, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, cpuDescription=cpuDescription, PYSNMP_MODULE_ID=smSuperDoctor5MIB, cpuCoreEnabled=cpuCoreEnabled, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidVDTargetId=raidVDTargetId, diskVendor=diskVendor, diskModel=diskModel, trapMemoryCeccWarning=trapMemoryCeccWarning, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, postLogEntry=postLogEntry, raidBBUEntry=raidBBUEntry, raidDiskGroupId_PD=raidDiskGroupId_PD, raidVDMirrorDataSize=raidVDMirrorDataSize, ueccLogEntry=ueccLogEntry, trapVoltageCritical=trapVoltageCritical, cpuTable=cpuTable, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, cpuLogEntry=cpuLogEntry, raidVDName=raidVDName, trapChassisIntrusion=trapChassisIntrusion, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, diskSize=diskSize, cpuLoadingPercentage=cpuLoadingPercentage, raidPDEntry=raidPDEntry, sysBIOSVersion=sysBIOSVersion, trapPowerSupplyNormal=trapPowerSupplyNormal, mbManufacturer=mbManufacturer, raidPDPort0Status=raidPDPort0Status, diskTable=diskTable, raidAdapterGroup=raidAdapterGroup, raidVDSize=raidVDSize, sd5Table=sd5Table, raidPDFirmwareRevision=raidPDFirmwareRevision, raidAdapterSerialNumber=raidAdapterSerialNumber, raidPDIndex=raidPDIndex, sysBIOSTable=sysBIOSTable, raidAdapterDeviceId=raidAdapterDeviceId, memUECCErrorCount=memUECCErrorCount, cpuLogTable=cpuLogTable, raidAdapterId_PD=raidAdapterId_PD, trapVoltageNormal=trapVoltageNormal, trapBbpStatusWarning=trapBbpStatusWarning, raidAdapterSubDeviceId=raidAdapterSubDeviceId, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, cpuIndex=cpuIndex, memTable=memTable, mbTable=mbTable, trapPowerSupplyWarning=trapPowerSupplyWarning, raidVDIndex=raidVDIndex, raidPDAllinoneStatus=raidPDAllinoneStatus, memModel=memModel, cpuName=cpuName, mbEntry=mbEntry, postLogIndex=postLogIndex, raidVDAllinoneStatus=raidVDAllinoneStatus, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidPDMediaErrorCount=raidPDMediaErrorCount, sysBIOSEntry=sysBIOSEntry, raidPDOpProgress=raidPDOpProgress, diskEntry=diskEntry, raidAdapterVendorId=raidAdapterVendorId, mbProductName=mbProductName, trapVoltageWarning=trapVoltageWarning, raidVDSupportT10Power=raidVDSupportT10Power, ceccLogEntry=ceccLogEntry, mbAssetTag=mbAssetTag, trapCpuFaultCritical=trapCpuFaultCritical, cpuDeviceVersion=cpuDeviceVersion, raidVDSpanDepth=raidVDSpanDepth, trapBatteryStatusWarning=trapBatteryStatusWarning, raidPDPort0Linkspeed=raidPDPort0Linkspeed, sysBIOSReleaseDate=sysBIOSReleaseDate, memErrorCount=memErrorCount, raidAdapterIndex=raidAdapterIndex, raidPDAllinoneMsg=raidPDAllinoneMsg, trapBatteryStatusCritical=trapBatteryStatusCritical, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, raidPDRawSize=raidPDRawSize, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, sd5MIBVersion=sd5MIBVersion, raidVDEntry=raidVDEntry, trapMemoryCeccNormal=trapMemoryCeccNormal, raidBBUIndex=raidBBUIndex, ceccLogTable=ceccLogTable, memTotalWidth=memTotalWidth, trapMemoryUeccWarning=trapMemoryUeccWarning, trapBatteryStatusNormal=trapBatteryStatusNormal, memDeviceStatus=memDeviceStatus, raidVDNumDrives=raidVDNumDrives, cpuLogDatetime=cpuLogDatetime, raidIsBBUAbsent=raidIsBBUAbsent, ueccLogInfo=ueccLogInfo, raidPDFirmwareState=raidPDFirmwareState, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, cpuID=cpuID, raidPDPort1Status=raidPDPort1Status, raidAdapterFWVersion=raidAdapterFWVersion, dmiLogTable=dmiLogTable, raidVDTable=raidVDTable, memDescription=memDescription, mbIndex=mbIndex, raidPDWriteCache=raidPDWriteCache, ueccLogIndex=ueccLogIndex, diskSmartStatus=diskSmartStatus, raidPDOtherErrorCount=raidPDOtherErrorCount, raidPDSlotNumber=raidPDSlotNumber, raidAdapterGroup_BBU=raidAdapterGroup_BBU, diskSerialNumber=diskSerialNumber, ueccLogTable=ueccLogTable, trapCpuFaultNormal=trapCpuFaultNormal, raidVDState=raidVDState, memPartNumber=memPartNumber, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidVDId=raidVDId, osCSDVersion=osCSDVersion, trapMemoryUeccNormal=trapMemoryUeccNormal, cpuCurrentSpeed=cpuCurrentSpeed, trapTemperatureCritical=trapTemperatureCritical, raidAdapterSubVendorId=raidAdapterSubVendorId, trapGenericWarning=trapGenericWarning, diskMediaType=diskMediaType, osIndex=osIndex, raidAdapterGroup_VD=raidAdapterGroup_VD, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, trapBbpStatusCritical=trapBbpStatusCritical, trapCpuFaultWarning=trapCpuFaultWarning, memDataWidth=memDataWidth, raidPDDeviceSpeed=raidPDDeviceSpeed, raidBBUStatus=raidBBUStatus, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, trapFanCritical=trapFanCritical, sd5Entry=sd5Entry, cpuManufacturer=cpuManufacturer, raidPDTable=raidPDTable, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, trapBbpStatusNormal=trapBbpStatusNormal, raidVDSupportsMaxPS=raidVDSupportsMaxPS, cpuDeviceStatus=cpuDeviceStatus, raidPDInquiryData=raidPDInquiryData, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, trapMemoryUeccCritical=trapMemoryUeccCritical, memSerialNumber=memSerialNumber, raidPDNCQSetting=raidPDNCQSetting, trapFanNormal=trapFanNormal, raidAdapterProductName=raidAdapterProductName, trapTemperatureWarning=trapTemperatureWarning, osVersion=osVersion, diskInterfaceType=diskInterfaceType, cpuEntry=cpuEntry, raidDiskGroupId=raidDiskGroupId, cpuDeviceID=cpuDeviceID, ceccLogInfo=ceccLogInfo, raidPDPredFailCount=raidPDPredFailCount, trapTemperatureNormal=trapTemperatureNormal, raidVDBadBlocksExist=raidVDBadBlocksExist, trapGenericCritical=trapGenericCritical, diskName=diskName, trapMemoryCeccCritical=trapMemoryCeccCritical, smSD5TrapMIB=smSD5TrapMIB, raidAdapterBIOSVersion=raidAdapterBIOSVersion, smSuperDoctor5MIB=smSuperDoctor5MIB, ceccLogDatetime=ceccLogDatetime, sd5Idx=sd5Idx, raidVDEncryptionType=raidVDEncryptionType, raidVDStripSize=raidVDStripSize, raidVDDiskCachePolicy=raidVDDiskCachePolicy, osSerialNumber=osSerialNumber, trapGenericNormal=trapGenericNormal, cpuThreadCount=cpuThreadCount, cpuMaxSpeed=cpuMaxSpeed, trapChassisIntrusionCleared=trapChassisIntrusionCleared, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, postLogTable=postLogTable, osTable=osTable, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, diskController=diskController, memEntry=memEntry, raidPDSerialNumber=raidPDSerialNumber, raidVDCached=raidVDCached, postLogDatetime=postLogDatetime, raidAdapterEntry=raidAdapterEntry, ceccLogIndex=ceccLogIndex, raidAdapterGroup_PD=raidAdapterGroup_PD, raidPDSpan=raidPDSpan, raidPDDeviceFwLevel=raidPDDeviceFwLevel, mbSerialNumber=mbSerialNumber, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, memDeviceLocator=memDeviceLocator, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, postLogInfo=postLogInfo, memTag=memTag, osName=osName, osManufacturer=osManufacturer, cpuLogIndex=cpuLogIndex, cpuLogInfo=cpuLogInfo, memLabeledBank=memLabeledBank, memCapacity=memCapacity, memECCErrorCount=memECCErrorCount, sysBIOSManufacturer=sysBIOSManufacturer, osEntry=osEntry, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidAdapterTable=raidAdapterTable, raidBBUTable=raidBBUTable, raidPDLinkSpeed=raidPDLinkSpeed, ueccLogDatetime=ueccLogDatetime, cpuSocketDesignation=cpuSocketDesignation, raidVDAllinoneMsg=raidVDAllinoneMsg, memManufacturer=memManufacturer, raidAdapterId=raidAdapterId, cpuCoreCount=cpuCoreCount, raidPDPort1Linkspeed=raidPDPort1Linkspeed)
