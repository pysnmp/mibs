...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", raidAdapterDeviceId=raidAdapterDeviceId, raidVDTable=raidVDTable, smSuperDoctor5MIB=smSuperDoctor5MIB, raidVDStripSize=raidVDStripSize, cpuCurrentSpeed=cpuCurrentSpeed, sysBIOSManufacturer=sysBIOSManufacturer, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidPDEntry=raidPDEntry, raidPDFirmwareState=raidPDFirmwareState, raidPDPort0Status=raidPDPort0Status, trapTemperatureCritical=trapTemperatureCritical, mbEntry=mbEntry, memUECCErrorCount=memUECCErrorCount, raidPDOpProgress=raidPDOpProgress, sysBIOSTable=sysBIOSTable, raidVDIndex=raidVDIndex, raidAdapterId_BBU=raidAdapterId_BBU, trapChassisIntrusionCleared=trapChassisIntrusionCleared, cpuDeviceVersion=cpuDeviceVersion, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, trapGenericNormal=trapGenericNormal, raidVDId=raidVDId, raidPDMediaType=raidPDMediaType, memSerialNumber=memSerialNumber, cpuLogInfo=cpuLogInfo, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidAdapterProductName=raidAdapterProductName, memModel=memModel, raidAdapterEntry=raidAdapterEntry, raidPDRawSize=raidPDRawSize, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, trapFanCritical=trapFanCritical, cpuCoreCount=cpuCoreCount, memTag=memTag, memCapacity=memCapacity, raidVDCached=raidVDCached, diskModel=diskModel, raidAdapterSubDeviceId=raidAdapterSubDeviceId, memECCErrorCount=memECCErrorCount, cpuIndex=cpuIndex, memDescription=memDescription, diskSmartStatus=diskSmartStatus, mbIndex=mbIndex, cpuMaxSpeed=cpuMaxSpeed, trapVoltageCritical=trapVoltageCritical, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, trapGenericWarning=trapGenericWarning, raidDiskGroupId=raidDiskGroupId, raidVDMirrorDataSize=raidVDMirrorDataSize, ceccLogIndex=ceccLogIndex, ueccLogInfo=ueccLogInfo, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, raidVDName=raidVDName, cpuEntry=cpuEntry, mbManufacturer=mbManufacturer, raidPDAllinoneStatus=raidPDAllinoneStatus, raidVDAllinoneStatus=raidVDAllinoneStatus, sysBIOSEntry=sysBIOSEntry, postLogDatetime=postLogDatetime, raidAdapterId=raidAdapterId, raidAdapterFWVersion=raidAdapterFWVersion, ceccLogTable=ceccLogTable, mbSerialNumber=mbSerialNumber, osSerialNumber=osSerialNumber, raidPDPort1Status=raidPDPort1Status, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, sd5Version=sd5Version, trapChassisIntrusion=trapChassisIntrusion, mbAssetTag=mbAssetTag, osName=osName, diskInterfaceType=diskInterfaceType, memEntry=memEntry, memPartNumber=memPartNumber, raidPDAllinoneMsg=raidPDAllinoneMsg, raidVDNumDrives=raidVDNumDrives, trapBbpStatusWarning=trapBbpStatusWarning, ceccLogInfo=ceccLogInfo, cpuLogIndex=cpuLogIndex, ceccLogDatetime=ceccLogDatetime, cpuLogDatetime=cpuLogDatetime, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, cpuLogEntry=cpuLogEntry, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, cpuLoadingPercentage=cpuLoadingPercentage, memDeviceLocator=memDeviceLocator, raidAdapterSerialNumber=raidAdapterSerialNumber, raidAdapterGroup_VD=raidAdapterGroup_VD, raidPDLinkSpeed=raidPDLinkSpeed, trapGenericCritical=trapGenericCritical, raidPDIndex=raidPDIndex, sd5Entry=sd5Entry, raidBBUAllinoneStatus=raidBBUAllinoneStatus, trapBbpStatusNormal=trapBbpStatusNormal, trapFanNormal=trapFanNormal, raidPDPort0Linkspeed=raidPDPort0Linkspeed, raidAdapterGroup=raidAdapterGroup, mbVersionName=mbVersionName, diskController=diskController, cpuSocketDesignation=cpuSocketDesignation, raidVDSupportT10Power=raidVDSupportT10Power, raidPDDeviceFwLevel=raidPDDeviceFwLevel, trapVoltageNormal=trapVoltageNormal, osIndex=osIndex, trapPowerSupplyNormal=trapPowerSupplyNormal, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, diskSlotID=diskSlotID, raidVDSize=raidVDSize, trapPowerSupplyCritical=trapPowerSupplyCritical, raidPDNCQSetting=raidPDNCQSetting, raidBBUIndex=raidBBUIndex, raidBBUEntry=raidBBUEntry, trapMemoryCeccNormal=trapMemoryCeccNormal, trapBatteryStatusNormal=trapBatteryStatusNormal, raidBBUAllinoneMsg=raidBBUAllinoneMsg, memErrorCount=memErrorCount, sd5Table=sd5Table, diskSize=diskSize, ceccLogEntry=ceccLogEntry, memManufacturer=memManufacturer, raidPDDeviceSpeed=raidPDDeviceSpeed, trapTemperatureWarning=trapTemperatureWarning, cpuDeviceID=cpuDeviceID, raidVDSpanDepth=raidVDSpanDepth, raidPDOtherErrorCount=raidPDOtherErrorCount, ueccLogIndex=ueccLogIndex, trapTemperatureNormal=trapTemperatureNormal, diskTable=diskTable, raidVDState=raidVDState, postLogIndex=postLogIndex, raidPDPredFailCount=raidPDPredFailCount, raidPDSerialNumber=raidPDSerialNumber, dmiLogTable=dmiLogTable, mbProductName=mbProductName, trapMemoryCeccCritical=trapMemoryCeccCritical, raidBBUTable=raidBBUTable, raidPDWriteCache=raidPDWriteCache, trapPowerSupplyWarning=trapPowerSupplyWarning, trapMemoryUeccCritical=trapMemoryUeccCritical, raidPDModel=raidPDModel, raidVDBadBlocksExist=raidVDBadBlocksExist, memTable=memTable, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidPDSlotNumber=raidPDSlotNumber, trapBatteryStatusWarning=trapBatteryStatusWarning, mbTable=mbTable, diskSerialNumber=diskSerialNumber, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, sd5Idx=sd5Idx, raidAdapterId_VD=raidAdapterId_VD, raidVDSupportsMaxPS=raidVDSupportsMaxPS, raidVDAllinoneMsg=raidVDAllinoneMsg, trapBatteryStatusCritical=trapBatteryStatusCritical, memDataWidth=memDataWidth, sysBIOSIndex=sysBIOSIndex, cpuID=cpuID, osTable=osTable, trapMemoryUeccWarning=trapMemoryUeccWarning, trapMemoryCeccWarning=trapMemoryCeccWarning, diskName=diskName, osEntry=osEntry, memTotalWidth=memTotalWidth, raidPDSpan=raidPDSpan, trapBbpStatusCritical=trapBbpStatusCritical, cpuTable=cpuTable, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidAdapterGroup_BBU=raidAdapterGroup_BBU, sysBIOSReleaseDate=sysBIOSReleaseDate, raidPDInquiryData=raidPDInquiryData, PYSNMP_MODULE_ID=smSuperDoctor5MIB, raidAdapterVendorId=raidAdapterVendorId, raidPDFirmwareRevision=raidPDFirmwareRevision, raidVDEntry=raidVDEntry, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, postLogEntry=postLogEntry, memLabeledBank=memLabeledBank, osManufacturer=osManufacturer, raidVDEncryptionType=raidVDEncryptionType, trapFanWarning=trapFanWarning, cpuLogTable=cpuLogTable, cpuName=cpuName, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, smSD5TrapMIB=smSD5TrapMIB, ueccLogTable=ueccLogTable, cpuThreadCount=cpuThreadCount, osVersion=osVersion, postLogInfo=postLogInfo, sd5MIBVersion=sd5MIBVersion, trapCpuFaultCritical=trapCpuFaultCritical, trapCpuFaultNormal=trapCpuFaultNormal, raidDiskGroupId_PD=raidDiskGroupId_PD, raidBBUStatus=raidBBUStatus, raidVDDiskCachePolicy=raidVDDiskCachePolicy, raidPDTable=raidPDTable, raidAdapterGroup_PD=raidAdapterGroup_PD, raidAdapterBIOSVersion=raidAdapterBIOSVersion, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, trapMemoryUeccNormal=trapMemoryUeccNormal, raidAdapterTable=raidAdapterTable, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, cpuManufacturer=cpuManufacturer, cpuCoreEnabled=cpuCoreEnabled, trapVoltageWarning=trapVoltageWarning, osCSDVersion=osCSDVersion, ueccLogDatetime=ueccLogDatetime, raidIsBBUAbsent=raidIsBBUAbsent, trapCpuFaultWarning=trapCpuFaultWarning, memDeviceStatus=memDeviceStatus, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, cpuDeviceStatus=cpuDeviceStatus, diskMediaType=diskMediaType, diskVendor=diskVendor, diskEntry=diskEntry, raidAdapterId_PD=raidAdapterId_PD, ueccLogEntry=ueccLogEntry, raidPDMediaErrorCount=raidPDMediaErrorCount, raidAdapterSubVendorId=raidAdapterSubVendorId, raidVDRaidLevel=raidVDRaidLevel, postLogTable=postLogTable, raidAdapterIndex=raidAdapterIndex, raidVDTargetId=raidVDTargetId, sysBIOSVersion=sysBIOSVersion, cpuDescription=cpuDescription)
