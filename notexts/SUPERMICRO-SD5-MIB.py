...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", raidBBUIndex=raidBBUIndex, memErrorCount=memErrorCount, postLogTable=postLogTable, cpuThreadCount=cpuThreadCount, dmiLogTable=dmiLogTable, cpuIndex=cpuIndex, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, trapGenericWarning=trapGenericWarning, sd5MIBVersion=sd5MIBVersion, raidAdapterGroup_VD=raidAdapterGroup_VD, raidPDEntry=raidPDEntry, trapTemperatureWarning=trapTemperatureWarning, sd5Entry=sd5Entry, trapMemoryUeccCritical=trapMemoryUeccCritical, raidBBUStatus=raidBBUStatus, raidAdapterId_VD=raidAdapterId_VD, memECCErrorCount=memECCErrorCount, trapTemperatureCritical=trapTemperatureCritical, cpuLoadingPercentage=cpuLoadingPercentage, raidPDPredFailCount=raidPDPredFailCount, raidAdapterId=raidAdapterId, cpuSocketDesignation=cpuSocketDesignation, raidAdapterFWVersion=raidAdapterFWVersion, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, raidVDDiskCachePolicy=raidVDDiskCachePolicy, trapMemoryCeccCritical=trapMemoryCeccCritical, memTag=memTag, trapMemoryCeccWarning=trapMemoryCeccWarning, postLogInfo=postLogInfo, memEntry=memEntry, raidPDSerialNumber=raidPDSerialNumber, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidBBUAllinoneStatus=raidBBUAllinoneStatus, sysBIOSIndex=sysBIOSIndex, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, trapBbpStatusCritical=trapBbpStatusCritical, raidAdapterBIOSVersion=raidAdapterBIOSVersion, trapTemperatureNormal=trapTemperatureNormal, trapBatteryStatusNormal=trapBatteryStatusNormal, raidPDInquiryData=raidPDInquiryData, sysBIOSEntry=sysBIOSEntry, ueccLogIndex=ueccLogIndex, mbAssetTag=mbAssetTag, trapMemoryUeccNormal=trapMemoryUeccNormal, raidPDAllinoneMsg=raidPDAllinoneMsg, ueccLogDatetime=ueccLogDatetime, raidVDIndex=raidVDIndex, raidDiskGroupId_PD=raidDiskGroupId_PD, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, trapCpuFaultNormal=trapCpuFaultNormal, raidPDModel=raidPDModel, raidVDTargetId=raidVDTargetId, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, trapFanCritical=trapFanCritical, raidDiskGroupId=raidDiskGroupId, sd5Version=sd5Version, memPartNumber=memPartNumber, raidPDPort1Status=raidPDPort1Status, cpuName=cpuName, postLogIndex=postLogIndex, diskEntry=diskEntry, raidPDWriteCache=raidPDWriteCache, memDataWidth=memDataWidth, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, cpuLogEntry=cpuLogEntry, raidAdapterGroup_PD=raidAdapterGroup_PD, raidVDRaidLevel=raidVDRaidLevel, osVersion=osVersion, cpuCoreCount=cpuCoreCount, sd5Idx=sd5Idx, cpuDescription=cpuDescription, ceccLogTable=ceccLogTable, ueccLogEntry=ueccLogEntry, cpuDeviceStatus=cpuDeviceStatus, mbSerialNumber=mbSerialNumber, raidVDNumDrives=raidVDNumDrives, raidIsBBUAbsent=raidIsBBUAbsent, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, diskController=diskController, trapVoltageCritical=trapVoltageCritical, raidVDAllinoneStatus=raidVDAllinoneStatus, trapBbpStatusWarning=trapBbpStatusWarning, trapFanWarning=trapFanWarning, osIndex=osIndex, cpuTable=cpuTable, cpuDeviceID=cpuDeviceID, memLabeledBank=memLabeledBank, raidVDAllinoneMsg=raidVDAllinoneMsg, cpuLogInfo=cpuLogInfo, raidPDMediaType=raidPDMediaType, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, mbManufacturer=mbManufacturer, raidAdapterSerialNumber=raidAdapterSerialNumber, memTable=memTable, raidVDSpanDepth=raidVDSpanDepth, cpuManufacturer=cpuManufacturer, cpuEntry=cpuEntry, sysBIOSReleaseDate=sysBIOSReleaseDate, mbVersionName=mbVersionName, raidAdapterVendorId=raidAdapterVendorId, osSerialNumber=osSerialNumber, raidAdapterDeviceId=raidAdapterDeviceId, smSuperDoctor5MIB=smSuperDoctor5MIB, raidVDName=raidVDName, diskVendor=diskVendor, sd5Table=sd5Table, raidPDSpan=raidPDSpan, trapGenericCritical=trapGenericCritical, raidPDLinkSpeed=raidPDLinkSpeed, memDeviceLocator=memDeviceLocator, raidAdapterGroup_BBU=raidAdapterGroup_BBU, osEntry=osEntry, raidAdapterId_PD=raidAdapterId_PD, trapVoltageNormal=trapVoltageNormal, trapMemoryUeccWarning=trapMemoryUeccWarning, memTotalWidth=memTotalWidth, raidBBUTable=raidBBUTable, raidVDSupportsMaxPS=raidVDSupportsMaxPS, diskSerialNumber=diskSerialNumber, diskInterfaceType=diskInterfaceType, ceccLogInfo=ceccLogInfo, trapCpuFaultCritical=trapCpuFaultCritical, memDeviceStatus=memDeviceStatus, trapBatteryStatusCritical=trapBatteryStatusCritical, raidVDStripSize=raidVDStripSize, trapPowerSupplyWarning=trapPowerSupplyWarning, trapCpuFaultWarning=trapCpuFaultWarning, diskMediaType=diskMediaType, raidVDSupportT10Power=raidVDSupportT10Power, raidPDAllinoneStatus=raidPDAllinoneStatus, raidPDIndex=raidPDIndex, raidVDTable=raidVDTable, sysBIOSTable=sysBIOSTable, smSD5TrapMIB=smSD5TrapMIB, raidVDCached=raidVDCached, memUECCErrorCount=memUECCErrorCount, sysBIOSVersion=sysBIOSVersion, diskName=diskName, cpuLogTable=cpuLogTable, raidAdapterEntry=raidAdapterEntry, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidVDSize=raidVDSize, trapChassisIntrusionCleared=trapChassisIntrusionCleared, raidPDFirmwareRevision=raidPDFirmwareRevision, trapVoltageWarning=trapVoltageWarning, diskSize=diskSize, raidAdapterId_BBU=raidAdapterId_BBU, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidVDId=raidVDId, raidVDMirrorDataSize=raidVDMirrorDataSize, raidVDEntry=raidVDEntry, diskSlotID=diskSlotID, raidVDEncryptionType=raidVDEncryptionType, raidVDState=raidVDState, trapPowerSupplyCritical=trapPowerSupplyCritical, PYSNMP_MODULE_ID=smSuperDoctor5MIB, raidAdapterSubDeviceId=raidAdapterSubDeviceId, sysBIOSManufacturer=sysBIOSManufacturer, memCapacity=memCapacity, mbIndex=mbIndex, osTable=osTable, raidVDBadBlocksExist=raidVDBadBlocksExist, trapGenericNormal=trapGenericNormal, cpuCoreEnabled=cpuCoreEnabled, raidPDDeviceSpeed=raidPDDeviceSpeed, raidPDOpProgress=raidPDOpProgress, cpuID=cpuID, raidAdapterSubVendorId=raidAdapterSubVendorId, raidAdapterTable=raidAdapterTable, ceccLogDatetime=ceccLogDatetime, trapBatteryStatusWarning=trapBatteryStatusWarning, raidAdapterProductName=raidAdapterProductName, mbTable=mbTable, raidPDDeviceFwLevel=raidPDDeviceFwLevel, ueccLogInfo=ueccLogInfo, cpuMaxSpeed=cpuMaxSpeed, postLogDatetime=postLogDatetime, trapChassisIntrusion=trapChassisIntrusion, ueccLogTable=ueccLogTable, memDescription=memDescription, memManufacturer=memManufacturer, raidAdapterGroup=raidAdapterGroup, raidPDRawSize=raidPDRawSize, osCSDVersion=osCSDVersion, raidPDTable=raidPDTable, osManufacturer=osManufacturer, trapBbpStatusNormal=trapBbpStatusNormal, mbEntry=mbEntry, ceccLogEntry=ceccLogEntry, raidAdapterIndex=raidAdapterIndex, diskTable=diskTable, osName=osName, cpuCurrentSpeed=cpuCurrentSpeed, raidBBUEntry=raidBBUEntry, raidPDPort0Linkspeed=raidPDPort0Linkspeed, diskSmartStatus=diskSmartStatus, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, trapFanNormal=trapFanNormal, raidPDNCQSetting=raidPDNCQSetting, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, cpuDeviceVersion=cpuDeviceVersion, trapPowerSupplyNormal=trapPowerSupplyNormal, cpuLogDatetime=cpuLogDatetime, memSerialNumber=memSerialNumber, raidPDPort0Status=raidPDPort0Status, mbProductName=mbProductName, cpuLogIndex=cpuLogIndex, raidPDSlotNumber=raidPDSlotNumber, raidPDOtherErrorCount=raidPDOtherErrorCount, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, memModel=memModel, postLogEntry=postLogEntry, ceccLogIndex=ceccLogIndex, raidPDFirmwareState=raidPDFirmwareState, raidPDMediaErrorCount=raidPDMediaErrorCount, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, diskModel=diskModel, trapMemoryCeccNormal=trapMemoryCeccNormal)
