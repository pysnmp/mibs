...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", cpuLogDatetime=cpuLogDatetime, raidPDPort0Linkspeed=raidPDPort0Linkspeed, raidAdapterSubDeviceId=raidAdapterSubDeviceId, smSD5TrapMIB=smSD5TrapMIB, raidAdapterGroup_BBU=raidAdapterGroup_BBU, mbVersionName=mbVersionName, raidBBUTable=raidBBUTable, memDataWidth=memDataWidth, raidAdapterFWVersion=raidAdapterFWVersion, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, trapGenericNormal=trapGenericNormal, trapCpuFaultWarning=trapCpuFaultWarning, cpuIndex=cpuIndex, raidVDEncryptionType=raidVDEncryptionType, cpuDeviceVersion=cpuDeviceVersion, diskSmartStatus=diskSmartStatus, trapTemperatureNormal=trapTemperatureNormal, cpuDeviceID=cpuDeviceID, raidPDMediaType=raidPDMediaType, trapTemperatureWarning=trapTemperatureWarning, trapMemoryCeccWarning=trapMemoryCeccWarning, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, memECCErrorCount=memECCErrorCount, raidAdapterId=raidAdapterId, cpuCoreEnabled=cpuCoreEnabled, raidVDState=raidVDState, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidPDIndex=raidPDIndex, ceccLogInfo=ceccLogInfo, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidAdapterGroup=raidAdapterGroup, trapVoltageWarning=trapVoltageWarning, raidVDTable=raidVDTable, raidVDStripSize=raidVDStripSize, raidPDOtherErrorCount=raidPDOtherErrorCount, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidAdapterTable=raidAdapterTable, raidVDName=raidVDName, cpuLoadingPercentage=cpuLoadingPercentage, ueccLogEntry=ueccLogEntry, diskSize=diskSize, raidPDInquiryData=raidPDInquiryData, cpuID=cpuID, sysBIOSEntry=sysBIOSEntry, ueccLogTable=ueccLogTable, cpuLogIndex=cpuLogIndex, trapFanWarning=trapFanWarning, diskController=diskController, trapFanNormal=trapFanNormal, diskMediaType=diskMediaType, raidVDMirrorDataSize=raidVDMirrorDataSize, raidPDSlotNumber=raidPDSlotNumber, cpuSocketDesignation=cpuSocketDesignation, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidBBUStatus=raidBBUStatus, raidPDLinkSpeed=raidPDLinkSpeed, mbManufacturer=mbManufacturer, raidBBUAllinoneMsg=raidBBUAllinoneMsg, raidAdapterGroup_PD=raidAdapterGroup_PD, raidVDSupportsMaxPS=raidVDSupportsMaxPS, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, mbEntry=mbEntry, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidPDTable=raidPDTable, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, cpuDeviceStatus=cpuDeviceStatus, diskSerialNumber=diskSerialNumber, raidDiskGroupId_PD=raidDiskGroupId_PD, cpuName=cpuName, raidIsBBUAbsent=raidIsBBUAbsent, raidPDEntry=raidPDEntry, trapMemoryUeccNormal=trapMemoryUeccNormal, cpuThreadCount=cpuThreadCount, osName=osName, trapGenericWarning=trapGenericWarning, diskSlotID=diskSlotID, raidPDPredFailCount=raidPDPredFailCount, trapChassisIntrusionCleared=trapChassisIntrusionCleared, ceccLogIndex=ceccLogIndex, raidAdapterIndex=raidAdapterIndex, cpuLogTable=cpuLogTable, postLogEntry=postLogEntry, trapMemoryCeccCritical=trapMemoryCeccCritical, diskModel=diskModel, raidBBUIndex=raidBBUIndex, raidPDPort1Status=raidPDPort1Status, mbSerialNumber=mbSerialNumber, memErrorCount=memErrorCount, osEntry=osEntry, sd5Version=sd5Version, osSerialNumber=osSerialNumber, sysBIOSTable=sysBIOSTable, raidPDAllinoneStatus=raidPDAllinoneStatus, trapPowerSupplyNormal=trapPowerSupplyNormal, memModel=memModel, raidPDNCQSetting=raidPDNCQSetting, dmiLogTable=dmiLogTable, trapBbpStatusWarning=trapBbpStatusWarning, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, diskName=diskName, diskVendor=diskVendor, postLogTable=postLogTable, raidVDBadBlocksExist=raidVDBadBlocksExist, raidVDEntry=raidVDEntry, trapPowerSupplyWarning=trapPowerSupplyWarning, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, memTotalWidth=memTotalWidth, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, trapBbpStatusCritical=trapBbpStatusCritical, trapChassisIntrusion=trapChassisIntrusion, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, sysBIOSManufacturer=sysBIOSManufacturer, mbIndex=mbIndex, raidPDSpan=raidPDSpan, osTable=osTable, raidPDAllinoneMsg=raidPDAllinoneMsg, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, trapBatteryStatusNormal=trapBatteryStatusNormal, memSerialNumber=memSerialNumber, trapMemoryCeccNormal=trapMemoryCeccNormal, sd5Table=sd5Table, raidPDSerialNumber=raidPDSerialNumber, trapVoltageNormal=trapVoltageNormal, postLogIndex=postLogIndex, memDeviceLocator=memDeviceLocator, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidVDAllinoneMsg=raidVDAllinoneMsg, memCapacity=memCapacity, raidVDTargetId=raidVDTargetId, trapBbpStatusNormal=trapBbpStatusNormal, memTable=memTable, osCSDVersion=osCSDVersion, ueccLogDatetime=ueccLogDatetime, raidPDDeviceFwLevel=raidPDDeviceFwLevel, memDeviceStatus=memDeviceStatus, sd5Entry=sd5Entry, postLogDatetime=postLogDatetime, raidAdapterEntry=raidAdapterEntry, raidVDRaidLevel=raidVDRaidLevel, osIndex=osIndex, memEntry=memEntry, raidPDMediaErrorCount=raidPDMediaErrorCount, raidVDNumDrives=raidVDNumDrives, raidPDModel=raidPDModel, memPartNumber=memPartNumber, raidVDId=raidVDId, osManufacturer=osManufacturer, raidPDRawSize=raidPDRawSize, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidVDSize=raidVDSize, sd5MIBVersion=sd5MIBVersion, mbAssetTag=mbAssetTag, raidAdapterId_PD=raidAdapterId_PD, trapBatteryStatusWarning=trapBatteryStatusWarning, osVersion=osVersion, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, trapPowerSupplyCritical=trapPowerSupplyCritical, ueccLogInfo=ueccLogInfo, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidVDDiskCachePolicy=raidVDDiskCachePolicy, raidVDIndex=raidVDIndex, raidVDSpanDepth=raidVDSpanDepth, memManufacturer=memManufacturer, raidAdapterSubVendorId=raidAdapterSubVendorId, raidPDDeviceSpeed=raidPDDeviceSpeed, memUECCErrorCount=memUECCErrorCount, raidAdapterDeviceId=raidAdapterDeviceId, raidPDPort0Status=raidPDPort0Status, raidAdapterVendorId=raidAdapterVendorId, raidAdapterId_BBU=raidAdapterId_BBU, cpuMaxSpeed=cpuMaxSpeed, memLabeledBank=memLabeledBank, trapGenericCritical=trapGenericCritical, raidVDAllinoneStatus=raidVDAllinoneStatus, sysBIOSReleaseDate=sysBIOSReleaseDate, raidPDOpProgress=raidPDOpProgress, postLogInfo=postLogInfo, raidBBUEntry=raidBBUEntry, raidVDSupportT10Power=raidVDSupportT10Power, cpuEntry=cpuEntry, sysBIOSIndex=sysBIOSIndex, trapTemperatureCritical=trapTemperatureCritical, ceccLogDatetime=ceccLogDatetime, trapMemoryUeccWarning=trapMemoryUeccWarning, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidPDFirmwareRevision=raidPDFirmwareRevision, trapCpuFaultNormal=trapCpuFaultNormal, sysBIOSVersion=sysBIOSVersion, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, cpuDescription=cpuDescription, trapBatteryStatusCritical=trapBatteryStatusCritical, mbTable=mbTable, raidDiskGroupId=raidDiskGroupId, cpuTable=cpuTable, cpuManufacturer=cpuManufacturer, raidAdapterSerialNumber=raidAdapterSerialNumber, ueccLogIndex=ueccLogIndex, diskInterfaceType=diskInterfaceType, ceccLogEntry=ceccLogEntry, PYSNMP_MODULE_ID=smSuperDoctor5MIB, memTag=memTag, raidPDFirmwareState=raidPDFirmwareState, raidPDWriteCache=raidPDWriteCache, trapFanCritical=trapFanCritical, trapCpuFaultCritical=trapCpuFaultCritical, trapMemoryUeccCritical=trapMemoryUeccCritical, sd5Idx=sd5Idx, memDescription=memDescription, ceccLogTable=ceccLogTable, raidAdapterProductName=raidAdapterProductName, mbProductName=mbProductName, smSuperDoctor5MIB=smSuperDoctor5MIB, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, diskEntry=diskEntry, raidAdapterGroup_VD=raidAdapterGroup_VD, cpuLogInfo=cpuLogInfo, cpuLogEntry=cpuLogEntry, diskTable=diskTable, raidVDCached=raidVDCached, cpuCurrentSpeed=cpuCurrentSpeed, cpuCoreCount=cpuCoreCount, raidAdapterId_VD=raidAdapterId_VD, trapVoltageCritical=trapVoltageCritical)
