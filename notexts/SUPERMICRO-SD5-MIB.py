...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", diskInterfaceType=diskInterfaceType, cpuDescription=cpuDescription, trapGenericNormal=trapGenericNormal, trapFanCritical=trapFanCritical, memDeviceLocator=memDeviceLocator, raidVDEntry=raidVDEntry, diskEntry=diskEntry, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, mbIndex=mbIndex, osIndex=osIndex, trapTemperatureCritical=trapTemperatureCritical, trapVoltageNormal=trapVoltageNormal, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, memUECCErrorCount=memUECCErrorCount, trapCpuFaultWarning=trapCpuFaultWarning, diskTable=diskTable, cpuLogIndex=cpuLogIndex, cpuLoadingPercentage=cpuLoadingPercentage, raidAdapterGroup_PD=raidAdapterGroup_PD, raidPDInquiryData=raidPDInquiryData, raidPDPort1Status=raidPDPort1Status, raidPDEntry=raidPDEntry, osManufacturer=osManufacturer, mbProductName=mbProductName, cpuThreadCount=cpuThreadCount, cpuDeviceVersion=cpuDeviceVersion, osTable=osTable, trapMemoryUeccCritical=trapMemoryUeccCritical, raidPDPort1Linkspeed=raidPDPort1Linkspeed, cpuMaxSpeed=cpuMaxSpeed, cpuSocketDesignation=cpuSocketDesignation, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, raidPDRawSize=raidPDRawSize, trapMemoryUeccNormal=trapMemoryUeccNormal, ueccLogDatetime=ueccLogDatetime, mbManufacturer=mbManufacturer, trapGenericCritical=trapGenericCritical, trapBatteryStatusWarning=trapBatteryStatusWarning, raidAdapterId=raidAdapterId, raidAdapterProductName=raidAdapterProductName, sysBIOSIndex=sysBIOSIndex, ueccLogEntry=ueccLogEntry, raidPDSerialNumber=raidPDSerialNumber, raidPDDeviceFwLevel=raidPDDeviceFwLevel, diskSlotID=diskSlotID, raidPDLinkSpeed=raidPDLinkSpeed, raidVDDiskCachePolicy=raidVDDiskCachePolicy, PYSNMP_MODULE_ID=smSuperDoctor5MIB, raidVDSupportT10Power=raidVDSupportT10Power, ceccLogTable=ceccLogTable, raidAdapterVendorId=raidAdapterVendorId, raidVDId=raidVDId, raidVDSupportsMaxPS=raidVDSupportsMaxPS, raidBBUAllinoneMsg=raidBBUAllinoneMsg, memPartNumber=memPartNumber, raidVDRaidLevel=raidVDRaidLevel, raidPDAllinoneStatus=raidPDAllinoneStatus, memDescription=memDescription, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidVDTargetId=raidVDTargetId, trapTemperatureNormal=trapTemperatureNormal, trapVoltageWarning=trapVoltageWarning, sd5Table=sd5Table, smSD5TrapMIB=smSD5TrapMIB, raidPDTable=raidPDTable, osName=osName, ceccLogEntry=ceccLogEntry, memLabeledBank=memLabeledBank, raidDiskGroupId_PD=raidDiskGroupId_PD, trapTemperatureWarning=trapTemperatureWarning, trapBatteryStatusCritical=trapBatteryStatusCritical, memDataWidth=memDataWidth, mbVersionName=mbVersionName, dmiLogTable=dmiLogTable, raidVDCached=raidVDCached, raidAdapterId_PD=raidAdapterId_PD, raidPDFirmwareRevision=raidPDFirmwareRevision, raidVDTable=raidVDTable, cpuLogInfo=cpuLogInfo, raidPDModel=raidPDModel, trapFanWarning=trapFanWarning, trapMemoryCeccWarning=trapMemoryCeccWarning, ueccLogIndex=ueccLogIndex, raidVDAllinoneMsg=raidVDAllinoneMsg, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, cpuTable=cpuTable, cpuDeviceStatus=cpuDeviceStatus, diskSize=diskSize, postLogDatetime=postLogDatetime, trapMemoryUeccWarning=trapMemoryUeccWarning, smSuperDoctor5MIB=smSuperDoctor5MIB, memDeviceStatus=memDeviceStatus, sysBIOSEntry=sysBIOSEntry, mbAssetTag=mbAssetTag, raidVDState=raidVDState, raidAdapterSerialNumber=raidAdapterSerialNumber, sysBIOSReleaseDate=sysBIOSReleaseDate, raidPDFirmwareState=raidPDFirmwareState, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, raidAdapterIndex=raidAdapterIndex, osSerialNumber=osSerialNumber, osCSDVersion=osCSDVersion, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, raidPDPort0Linkspeed=raidPDPort0Linkspeed, raidBBUIndex=raidBBUIndex, memCapacity=memCapacity, raidBBUEntry=raidBBUEntry, raidAdapterSubVendorId=raidAdapterSubVendorId, cpuIndex=cpuIndex, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, postLogIndex=postLogIndex, trapBbpStatusNormal=trapBbpStatusNormal, trapVoltageCritical=trapVoltageCritical, trapPowerSupplyWarning=trapPowerSupplyWarning, raidBBUStatus=raidBBUStatus, raidVDAllinoneStatus=raidVDAllinoneStatus, diskName=diskName, trapChassisIntrusion=trapChassisIntrusion, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, trapMemoryCeccCritical=trapMemoryCeccCritical, diskModel=diskModel, sd5Entry=sd5Entry, cpuEntry=cpuEntry, cpuCurrentSpeed=cpuCurrentSpeed, ueccLogInfo=ueccLogInfo, raidPDPredFailCount=raidPDPredFailCount, raidVDStripSize=raidVDStripSize, diskSmartStatus=diskSmartStatus, raidDiskGroupId=raidDiskGroupId, raidPDSpan=raidPDSpan, cpuCoreEnabled=cpuCoreEnabled, ceccLogInfo=ceccLogInfo, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidBBUTable=raidBBUTable, raidAdapterSubDeviceId=raidAdapterSubDeviceId, trapPowerSupplyCritical=trapPowerSupplyCritical, raidPDNCQSetting=raidPDNCQSetting, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, sd5Idx=sd5Idx, memManufacturer=memManufacturer, raidAdapterGroup_VD=raidAdapterGroup_VD, raidVDSize=raidVDSize, trapPowerSupplyNormal=trapPowerSupplyNormal, trapGenericWarning=trapGenericWarning, raidPDAllinoneMsg=raidPDAllinoneMsg, raidAdapterEntry=raidAdapterEntry, raidVDName=raidVDName, mbEntry=mbEntry, trapFanNormal=trapFanNormal, raidVDEncryptionType=raidVDEncryptionType, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, osVersion=osVersion, raidIsBBUAbsent=raidIsBBUAbsent, memTotalWidth=memTotalWidth, raidAdapterTable=raidAdapterTable, memEntry=memEntry, diskController=diskController, raidPDDeviceSpeed=raidPDDeviceSpeed, diskSerialNumber=diskSerialNumber, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidAdapterId_VD=raidAdapterId_VD, raidPDMediaErrorCount=raidPDMediaErrorCount, trapBbpStatusCritical=trapBbpStatusCritical, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, cpuDeviceID=cpuDeviceID, osEntry=osEntry, ceccLogIndex=ceccLogIndex, raidVDBadBlocksExist=raidVDBadBlocksExist, raidVDNumDrives=raidVDNumDrives, trapBbpStatusWarning=trapBbpStatusWarning, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, raidPDIndex=raidPDIndex, trapMemoryCeccNormal=trapMemoryCeccNormal, memTag=memTag, sysBIOSTable=sysBIOSTable, ueccLogTable=ueccLogTable, raidAdapterId_BBU=raidAdapterId_BBU, sd5Version=sd5Version, sd5MIBVersion=sd5MIBVersion, raidAdapterDeviceId=raidAdapterDeviceId, trapBatteryStatusNormal=trapBatteryStatusNormal, postLogInfo=postLogInfo, cpuLogEntry=cpuLogEntry, cpuLogDatetime=cpuLogDatetime, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidPDMediaType=raidPDMediaType, ceccLogDatetime=ceccLogDatetime, raidPDSlotNumber=raidPDSlotNumber, raidVDMirrorDataSize=raidVDMirrorDataSize, raidPDOpProgress=raidPDOpProgress, raidAdapterGroup=raidAdapterGroup, memErrorCount=memErrorCount, trapCpuFaultNormal=trapCpuFaultNormal, raidVDIndex=raidVDIndex, memModel=memModel, raidVDSpanDepth=raidVDSpanDepth, sysBIOSManufacturer=sysBIOSManufacturer, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, cpuCoreCount=cpuCoreCount, raidPDWriteCache=raidPDWriteCache, mbTable=mbTable, trapCpuFaultCritical=trapCpuFaultCritical, cpuManufacturer=cpuManufacturer, mbSerialNumber=mbSerialNumber, postLogTable=postLogTable, cpuID=cpuID, postLogEntry=postLogEntry, memSerialNumber=memSerialNumber, memTable=memTable, raidPDOtherErrorCount=raidPDOtherErrorCount, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, trapChassisIntrusionCleared=trapChassisIntrusionCleared, raidAdapterGroup_BBU=raidAdapterGroup_BBU, sysBIOSVersion=sysBIOSVersion, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidPDPort0Status=raidPDPort0Status, raidAdapterFWVersion=raidAdapterFWVersion, diskVendor=diskVendor, cpuName=cpuName, memECCErrorCount=memECCErrorCount, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, diskMediaType=diskMediaType, cpuLogTable=cpuLogTable)
