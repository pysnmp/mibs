...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", cpuEntry=cpuEntry, raidDiskGroupId=raidDiskGroupId, ceccLogTable=ceccLogTable, raidPDAllinoneMsg=raidPDAllinoneMsg, raidBBUIndex=raidBBUIndex, raidVDTargetId=raidVDTargetId, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, memCapacity=memCapacity, raidIsBBUAbsent=raidIsBBUAbsent, ueccLogIndex=ueccLogIndex, cpuThreadCount=cpuThreadCount, postLogTable=postLogTable, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, cpuManufacturer=cpuManufacturer, raidPDIndex=raidPDIndex, trapBbpStatusCritical=trapBbpStatusCritical, memUECCErrorCount=memUECCErrorCount, mbManufacturer=mbManufacturer, raidPDOtherErrorCount=raidPDOtherErrorCount, raidPDMediaErrorCount=raidPDMediaErrorCount, cpuDeviceID=cpuDeviceID, trapMemoryUeccWarning=trapMemoryUeccWarning, raidPDSerialNumber=raidPDSerialNumber, memEntry=memEntry, memDescription=memDescription, cpuTable=cpuTable, raidPDOpProgress=raidPDOpProgress, raidPDSlotNumber=raidPDSlotNumber, trapGenericCritical=trapGenericCritical, raidDiskGroupId_PD=raidDiskGroupId_PD, sysBIOSManufacturer=sysBIOSManufacturer, ceccLogIndex=ceccLogIndex, cpuMaxSpeed=cpuMaxSpeed, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, raidAdapterGroup_VD=raidAdapterGroup_VD, diskController=diskController, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, mbEntry=mbEntry, trapCpuFaultCritical=trapCpuFaultCritical, trapPowerSupplyWarning=trapPowerSupplyWarning, trapTemperatureNormal=trapTemperatureNormal, mbTable=mbTable, sd5MIBVersion=sd5MIBVersion, ueccLogEntry=ueccLogEntry, trapCpuFaultNormal=trapCpuFaultNormal, sd5Table=sd5Table, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, memPartNumber=memPartNumber, raidAdapterId=raidAdapterId, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidAdapterSubDeviceId=raidAdapterSubDeviceId, trapTemperatureWarning=trapTemperatureWarning, trapFanWarning=trapFanWarning, raidPDFirmwareRevision=raidPDFirmwareRevision, trapChassisIntrusion=trapChassisIntrusion, memErrorCount=memErrorCount, trapVoltageNormal=trapVoltageNormal, cpuDeviceStatus=cpuDeviceStatus, raidAdapterSerialNumber=raidAdapterSerialNumber, ueccLogInfo=ueccLogInfo, trapVoltageCritical=trapVoltageCritical, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, postLogEntry=postLogEntry, raidVDAllinoneStatus=raidVDAllinoneStatus, raidAdapterId_BBU=raidAdapterId_BBU, trapBatteryStatusCritical=trapBatteryStatusCritical, raidPDLinkSpeed=raidPDLinkSpeed, diskSlotID=diskSlotID, osVersion=osVersion, trapPowerSupplyNormal=trapPowerSupplyNormal, raidPDMediaType=raidPDMediaType, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, sd5Version=sd5Version, ueccLogTable=ueccLogTable, raidVDEncryptionType=raidVDEncryptionType, memModel=memModel, sysBIOSIndex=sysBIOSIndex, osName=osName, raidPDWriteCache=raidPDWriteCache, diskEntry=diskEntry, raidPDSpan=raidPDSpan, raidAdapterGroup=raidAdapterGroup, raidPDAllinoneStatus=raidPDAllinoneStatus, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidVDSupportsMaxPS=raidVDSupportsMaxPS, trapFanNormal=trapFanNormal, raidVDMirrorDataSize=raidVDMirrorDataSize, raidAdapterSubVendorId=raidAdapterSubVendorId, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidPDPort0Status=raidPDPort0Status, trapGenericWarning=trapGenericWarning, raidVDBadBlocksExist=raidVDBadBlocksExist, raidVDRaidLevel=raidVDRaidLevel, raidBBUStatus=raidBBUStatus, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, memDeviceLocator=memDeviceLocator, cpuLogInfo=cpuLogInfo, mbIndex=mbIndex, trapBbpStatusNormal=trapBbpStatusNormal, sd5Idx=sd5Idx, memSerialNumber=memSerialNumber, memTable=memTable, diskModel=diskModel, sysBIOSEntry=sysBIOSEntry, ceccLogEntry=ceccLogEntry, trapVoltageWarning=trapVoltageWarning, trapMemoryCeccCritical=trapMemoryCeccCritical, raidBBUEntry=raidBBUEntry, raidVDAllinoneMsg=raidVDAllinoneMsg, sysBIOSVersion=sysBIOSVersion, raidPDNCQSetting=raidPDNCQSetting, sysBIOSTable=sysBIOSTable, raidAdapterIndex=raidAdapterIndex, diskTable=diskTable, mbAssetTag=mbAssetTag, raidPDDeviceSpeed=raidPDDeviceSpeed, raidVDEntry=raidVDEntry, mbVersionName=mbVersionName, raidAdapterId_PD=raidAdapterId_PD, raidVDCached=raidVDCached, raidVDName=raidVDName, trapBbpStatusWarning=trapBbpStatusWarning, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, trapCpuFaultWarning=trapCpuFaultWarning, cpuName=cpuName, cpuCoreCount=cpuCoreCount, cpuIndex=cpuIndex, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidVDNumDrives=raidVDNumDrives, raidVDState=raidVDState, sysBIOSReleaseDate=sysBIOSReleaseDate, smSuperDoctor5MIB=smSuperDoctor5MIB, cpuLogTable=cpuLogTable, diskSize=diskSize, memTag=memTag, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, postLogIndex=postLogIndex, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, ceccLogDatetime=ceccLogDatetime, trapMemoryUeccCritical=trapMemoryUeccCritical, memManufacturer=memManufacturer, osSerialNumber=osSerialNumber, memTotalWidth=memTotalWidth, osIndex=osIndex, raidVDSpanDepth=raidVDSpanDepth, raidPDEntry=raidPDEntry, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidPDPort1Status=raidPDPort1Status, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, raidAdapterBIOSVersion=raidAdapterBIOSVersion, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidVDId=raidVDId, dmiLogTable=dmiLogTable, memLabeledBank=memLabeledBank, raidPDFirmwareState=raidPDFirmwareState, raidBBUAllinoneMsg=raidBBUAllinoneMsg, cpuID=cpuID, sd5Entry=sd5Entry, trapBatteryStatusWarning=trapBatteryStatusWarning, raidVDIndex=raidVDIndex, diskSmartStatus=diskSmartStatus, osCSDVersion=osCSDVersion, cpuLogEntry=cpuLogEntry, ceccLogInfo=ceccLogInfo, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, cpuSocketDesignation=cpuSocketDesignation, diskSerialNumber=diskSerialNumber, smSD5TrapMIB=smSD5TrapMIB, osEntry=osEntry, trapPowerSupplyCritical=trapPowerSupplyCritical, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, raidAdapterTable=raidAdapterTable, osManufacturer=osManufacturer, cpuDeviceVersion=cpuDeviceVersion, cpuDescription=cpuDescription, memECCErrorCount=memECCErrorCount, memDataWidth=memDataWidth, cpuLogIndex=cpuLogIndex, raidVDTable=raidVDTable, trapGenericNormal=trapGenericNormal, raidPDPort0Linkspeed=raidPDPort0Linkspeed, cpuCurrentSpeed=cpuCurrentSpeed, memDeviceStatus=memDeviceStatus, diskVendor=diskVendor, raidPDDeviceFwLevel=raidPDDeviceFwLevel, trapTemperatureCritical=trapTemperatureCritical, raidAdapterFWVersion=raidAdapterFWVersion, raidAdapterDeviceId=raidAdapterDeviceId, raidPDRawSize=raidPDRawSize, postLogDatetime=postLogDatetime, osTable=osTable, raidPDModel=raidPDModel, PYSNMP_MODULE_ID=smSuperDoctor5MIB, raidPDPredFailCount=raidPDPredFailCount, raidAdapterId_VD=raidAdapterId_VD, raidVDStripSize=raidVDStripSize, diskMediaType=diskMediaType, raidAdapterEntry=raidAdapterEntry, raidPDInquiryData=raidPDInquiryData, raidAdapterVendorId=raidAdapterVendorId, raidAdapterProductName=raidAdapterProductName, raidVDDiskCachePolicy=raidVDDiskCachePolicy, trapMemoryUeccNormal=trapMemoryUeccNormal, raidVDSize=raidVDSize, cpuLoadingPercentage=cpuLoadingPercentage, mbSerialNumber=mbSerialNumber, trapFanCritical=trapFanCritical, raidPDTable=raidPDTable, ueccLogDatetime=ueccLogDatetime, trapBatteryStatusNormal=trapBatteryStatusNormal, mbProductName=mbProductName, trapChassisIntrusionCleared=trapChassisIntrusionCleared, raidBBUTable=raidBBUTable, cpuCoreEnabled=cpuCoreEnabled, diskName=diskName, diskInterfaceType=diskInterfaceType, postLogInfo=postLogInfo, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, trapMemoryCeccNormal=trapMemoryCeccNormal, raidAdapterGroup_BBU=raidAdapterGroup_BBU, raidAdapterGroup_PD=raidAdapterGroup_PD, cpuLogDatetime=cpuLogDatetime, raidVDSupportT10Power=raidVDSupportT10Power, trapMemoryCeccWarning=trapMemoryCeccWarning)
