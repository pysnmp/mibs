...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", memErrorCount=memErrorCount, raidPDPredFailCount=raidPDPredFailCount, trapBbpStatusNormal=trapBbpStatusNormal, trapFanWarning=trapFanWarning, trapBbpStatusWarning=trapBbpStatusWarning, raidBBUAllinoneMsg=raidBBUAllinoneMsg, cpuDeviceID=cpuDeviceID, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, memDeviceStatus=memDeviceStatus, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, raidBBUEntry=raidBBUEntry, memCapacity=memCapacity, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidPDIndex=raidPDIndex, trapMemoryCeccWarning=trapMemoryCeccWarning, trapBatteryStatusNormal=trapBatteryStatusNormal, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, memModel=memModel, raidPDPort1Status=raidPDPort1Status, cpuSocketDesignation=cpuSocketDesignation, memECCErrorCount=memECCErrorCount, raidDiskGroupId=raidDiskGroupId, sd5MIBVersion=sd5MIBVersion, raidVDTable=raidVDTable, memPartNumber=memPartNumber, sysBIOSEntry=sysBIOSEntry, raidPDSlotNumber=raidPDSlotNumber, raidPDPort0Status=raidPDPort0Status, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, raidAdapterId_PD=raidAdapterId_PD, memDeviceLocator=memDeviceLocator, cpuTable=cpuTable, osCSDVersion=osCSDVersion, raidAdapterDeviceId=raidAdapterDeviceId, raidPDSpan=raidPDSpan, diskTable=diskTable, postLogInfo=postLogInfo, memManufacturer=memManufacturer, raidPDDeviceSpeed=raidPDDeviceSpeed, cpuDeviceStatus=cpuDeviceStatus, ueccLogIndex=ueccLogIndex, cpuLogIndex=cpuLogIndex, memTag=memTag, trapBatteryStatusWarning=trapBatteryStatusWarning, postLogTable=postLogTable, raidPDTable=raidPDTable, raidPDWriteCache=raidPDWriteCache, raidPDPort1Linkspeed=raidPDPort1Linkspeed, diskSlotID=diskSlotID, raidAdapterTable=raidAdapterTable, raidAdapterId=raidAdapterId, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidVDEntry=raidVDEntry, raidDiskGroupId_PD=raidDiskGroupId_PD, cpuMaxSpeed=cpuMaxSpeed, osManufacturer=osManufacturer, raidAdapterBIOSVersion=raidAdapterBIOSVersion, cpuName=cpuName, ueccLogDatetime=ueccLogDatetime, raidAdapterSubDeviceId=raidAdapterSubDeviceId, sd5Version=sd5Version, postLogDatetime=postLogDatetime, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, cpuLogEntry=cpuLogEntry, trapChassisIntrusion=trapChassisIntrusion, dmiLogTable=dmiLogTable, mbProductName=mbProductName, trapPowerSupplyNormal=trapPowerSupplyNormal, ceccLogInfo=ceccLogInfo, osTable=osTable, raidPDAllinoneStatus=raidPDAllinoneStatus, raidAdapterGroup_VD=raidAdapterGroup_VD, trapMemoryUeccCritical=trapMemoryUeccCritical, raidAdapterId_VD=raidAdapterId_VD, ceccLogIndex=ceccLogIndex, smSuperDoctor5MIB=smSuperDoctor5MIB, cpuIndex=cpuIndex, diskVendor=diskVendor, trapMemoryCeccNormal=trapMemoryCeccNormal, raidVDIndex=raidVDIndex, raidPDFirmwareState=raidPDFirmwareState, cpuCurrentSpeed=cpuCurrentSpeed, cpuEntry=cpuEntry, memTotalWidth=memTotalWidth, raidBBUStatus=raidBBUStatus, raidVDState=raidVDState, raidPDEntry=raidPDEntry, trapVoltageCritical=trapVoltageCritical, memUECCErrorCount=memUECCErrorCount, raidBBUAllinoneStatus=raidBBUAllinoneStatus, smSD5TrapMIB=smSD5TrapMIB, memLabeledBank=memLabeledBank, raidBBUTable=raidBBUTable, trapFanNormal=trapFanNormal, mbIndex=mbIndex, raidAdapterFWVersion=raidAdapterFWVersion, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidPDOtherErrorCount=raidPDOtherErrorCount, raidVDAllinoneMsg=raidVDAllinoneMsg, cpuCoreEnabled=cpuCoreEnabled, cpuDescription=cpuDescription, mbSerialNumber=mbSerialNumber, raidVDBadBlocksExist=raidVDBadBlocksExist, raidAdapterSerialNumber=raidAdapterSerialNumber, raidAdapterGroup_PD=raidAdapterGroup_PD, memTable=memTable, osEntry=osEntry, cpuLogInfo=cpuLogInfo, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, ueccLogInfo=ueccLogInfo, memSerialNumber=memSerialNumber, osVersion=osVersion, memEntry=memEntry, trapTemperatureWarning=trapTemperatureWarning, raidVDId=raidVDId, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, memDescription=memDescription, trapCpuFaultNormal=trapCpuFaultNormal, trapVoltageWarning=trapVoltageWarning, raidVDSize=raidVDSize, sysBIOSReleaseDate=sysBIOSReleaseDate, raidAdapterSubVendorId=raidAdapterSubVendorId, osIndex=osIndex, raidVDAllinoneStatus=raidVDAllinoneStatus, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, cpuLogTable=cpuLogTable, postLogEntry=postLogEntry, memDataWidth=memDataWidth, diskModel=diskModel, osName=osName, trapPowerSupplyCritical=trapPowerSupplyCritical, diskSize=diskSize, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, raidAdapterGroup=raidAdapterGroup, trapChassisIntrusionCleared=trapChassisIntrusionCleared, trapMemoryUeccNormal=trapMemoryUeccNormal, trapCpuFaultWarning=trapCpuFaultWarning, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, raidAdapterIndex=raidAdapterIndex, sysBIOSTable=sysBIOSTable, mbVersionName=mbVersionName, raidVDEncryptionType=raidVDEncryptionType, trapFanCritical=trapFanCritical, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, raidVDDiskCachePolicy=raidVDDiskCachePolicy, trapBatteryStatusCritical=trapBatteryStatusCritical, raidPDAllinoneMsg=raidPDAllinoneMsg, raidPDSerialNumber=raidPDSerialNumber, cpuDeviceVersion=cpuDeviceVersion, sd5Idx=sd5Idx, sysBIOSVersion=sysBIOSVersion, raidPDInquiryData=raidPDInquiryData, trapBbpStatusCritical=trapBbpStatusCritical, ceccLogTable=ceccLogTable, raidVDRaidLevel=raidVDRaidLevel, trapTemperatureNormal=trapTemperatureNormal, raidVDName=raidVDName, cpuCoreCount=cpuCoreCount, postLogIndex=postLogIndex, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, sysBIOSManufacturer=sysBIOSManufacturer, diskController=diskController, sysBIOSIndex=sysBIOSIndex, PYSNMP_MODULE_ID=smSuperDoctor5MIB, trapGenericCritical=trapGenericCritical, trapMemoryUeccWarning=trapMemoryUeccWarning, diskEntry=diskEntry, raidPDRawSize=raidPDRawSize, raidAdapterId_BBU=raidAdapterId_BBU, cpuManufacturer=cpuManufacturer, cpuThreadCount=cpuThreadCount, raidVDCached=raidVDCached, diskSerialNumber=diskSerialNumber, raidVDMirrorDataSize=raidVDMirrorDataSize, sd5Entry=sd5Entry, raidPDOpProgress=raidPDOpProgress, cpuLoadingPercentage=cpuLoadingPercentage, diskName=diskName, trapCpuFaultCritical=trapCpuFaultCritical, raidPDMediaErrorCount=raidPDMediaErrorCount, diskInterfaceType=diskInterfaceType, trapMemoryCeccCritical=trapMemoryCeccCritical, raidPDPort0Linkspeed=raidPDPort0Linkspeed, trapPowerSupplyWarning=trapPowerSupplyWarning, trapGenericNormal=trapGenericNormal, cpuID=cpuID, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidAdapterProductName=raidAdapterProductName, raidPDMediaType=raidPDMediaType, osSerialNumber=osSerialNumber, ceccLogEntry=ceccLogEntry, diskSmartStatus=diskSmartStatus, trapGenericWarning=trapGenericWarning, ceccLogDatetime=ceccLogDatetime, ueccLogTable=ueccLogTable, raidVDNumDrives=raidVDNumDrives, mbManufacturer=mbManufacturer, mbAssetTag=mbAssetTag, raidPDDeviceFwLevel=raidPDDeviceFwLevel, raidIsBBUAbsent=raidIsBBUAbsent, raidVDSupportT10Power=raidVDSupportT10Power, ueccLogEntry=ueccLogEntry, sd5Table=sd5Table, diskMediaType=diskMediaType, cpuLogDatetime=cpuLogDatetime, raidVDTargetId=raidVDTargetId, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, trapVoltageNormal=trapVoltageNormal, raidAdapterGroup_BBU=raidAdapterGroup_BBU, mbTable=mbTable, raidBBUIndex=raidBBUIndex, raidAdapterEntry=raidAdapterEntry, raidVDSpanDepth=raidVDSpanDepth, raidPDNCQSetting=raidPDNCQSetting, raidPDFirmwareRevision=raidPDFirmwareRevision, trapTemperatureCritical=trapTemperatureCritical, raidAdapterVendorId=raidAdapterVendorId, raidPDModel=raidPDModel, mbEntry=mbEntry, raidVDStripSize=raidVDStripSize, raidVDSupportsMaxPS=raidVDSupportsMaxPS, raidPDLinkSpeed=raidPDLinkSpeed)
