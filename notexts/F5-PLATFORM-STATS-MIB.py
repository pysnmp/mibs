...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", coreCurrent=coreCurrent, PlatformStatsIndex=PlatformStatsIndex, cpuTotal1minAvg=cpuTotal1minAvg, fan_8_speed=fan_8_speed, fan_4_speed=fan_4_speed, memPlatformUsed=memPlatformUsed, coreName=coreName, fan_3_speed=fan_3_speed, memFree=memFree, diskVendor=diskVendor, diskWriteIops=diskWriteIops, platformFpgaGroup=platformFpgaGroup, fan_10_speed=fan_10_speed, cpuModelName=cpuModelName, coreIndex=coreIndex, platformFantrayGroup=platformFantrayGroup, platformCpuStatsTable=platformCpuStatsTable, cpuCore=cpuCore, platformConformance=platformConformance, platformMemoryStatsTable=platformMemoryStatsTable, cpuCoreCnt=cpuCoreCnt, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, memPlatformTotal=memPlatformTotal, diskReadIops=diskReadIops, diskWriteMerged=diskWriteMerged, tempMaximum=tempMaximum, tempMinimum=tempMinimum, temperatureStatsTable=temperatureStatsTable, diskVersion=diskVersion, memoryStatsEntry=memoryStatsEntry, diskType=diskType, fan_9_speed=fan_9_speed, index=index, fpgaIndex=fpgaIndex, fwUpdateStatus=fwUpdateStatus, memAvailable=memAvailable, platformFwVersionGroup=platformFwVersionGroup, cpuUtilizationStatsTable=cpuUtilizationStatsTable, diskReadLatencyMs=diskReadLatencyMs, tempCurrent=tempCurrent, fan_7_speed=fan_7_speed, coreTotal5secAvg=coreTotal5secAvg, diskReadMerged=diskReadMerged, cpuProcessorStatsTable=cpuProcessorStatsTable, platformFantrayTable=platformFantrayTable, fwName=fwName, fpgaEntry=fpgaEntry, platformCompliances=platformCompliances, f5PlatformStats=f5PlatformStats, fan_11_speed=fan_11_speed, coreTotal5minAvg=coreTotal5minAvg, cpuCoreStatsTable=cpuCoreStatsTable, fwVersion=fwVersion, configurable=configurable, String=String, platformCPUGroup=platformCPUGroup, platformTemperatureTable=platformTemperatureTable, fwTable=fwTable, diskTotalIops=diskTotalIops, coreTotal1minAvg=coreTotal1minAvg, f5PlatformStatsObjects=f5PlatformStatsObjects, fan_2_speed=fan_2_speed, cpuFreq=cpuFreq, platformDiskStatsTable=platformDiskStatsTable, memoryStatsTable=memoryStatsTable, memPercentageUsed=memPercentageUsed, cpuThreadCnt=cpuThreadCnt, temperatureStatsEntry=temperatureStatsEntry, fan_1_speed=fan_1_speed, cpuTotal5minAvg=cpuTotal5minAvg, cpuCurrent=cpuCurrent, platformTempGroup=platformTempGroup, platformFwTable=platformFwTable, platformFpgaTable=platformFpgaTable, diskName=diskName, diskInfoEntry=diskInfoEntry, diskUtilizationStatsEntry=diskUtilizationStatsEntry, platformCompliance=platformCompliance, platformGroups=platformGroups, cpuTotal5secAvg=cpuTotal5secAvg, fpgaVersion=fpgaVersion, tempAverage=tempAverage, fpgaTable=fpgaTable, fan_12_speed=fan_12_speed, diskInfoTable=diskInfoTable, diskWriteBytes=diskWriteBytes, cpuStepping=cpuStepping, cpuIndex=cpuIndex, diskSerialNo=diskSerialNo, fantrayStatsEntry=fantrayStatsEntry, PYSNMP_MODULE_ID=f5PlatformStats, cpuCoreStatsEntry=cpuCoreStatsEntry, platformMemGroup=platformMemGroup, fantrayStatsTable=fantrayStatsTable, diskReadBytes=diskReadBytes, platformDiskGroup=platformDiskGroup, diskPercentageUsed=diskPercentageUsed, diskSize=diskSize, fan_6_speed=fan_6_speed, cpuProcessorStatsEntry=cpuProcessorStatsEntry, cpuCacheSize=cpuCacheSize, diskModel=diskModel, diskWriteLatencyMs=diskWriteLatencyMs, diskUtilizationStatsTable=diskUtilizationStatsTable, fan_5_speed=fan_5_speed, fwEntry=fwEntry)
