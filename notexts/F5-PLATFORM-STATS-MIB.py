...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", diskReadIops=diskReadIops, cpuTotal1minAvg=cpuTotal1minAvg, memPlatformTotal=memPlatformTotal, diskModel=diskModel, fan_12_speed=fan_12_speed, cpuCurrent=cpuCurrent, diskName=diskName, diskUtilizationStatsTable=diskUtilizationStatsTable, fwTable=fwTable, fan_5_speed=fan_5_speed, coreName=coreName, platformMemGroup=platformMemGroup, cpuCore=cpuCore, cpuCoreStatsEntry=cpuCoreStatsEntry, platformFantrayGroup=platformFantrayGroup, cpuCoreStatsTable=cpuCoreStatsTable, f5PlatformStats=f5PlatformStats, tempCurrent=tempCurrent, platformCompliances=platformCompliances, fan_6_speed=fan_6_speed, diskReadLatencyMs=diskReadLatencyMs, fan_8_speed=fan_8_speed, memoryStatsTable=memoryStatsTable, coreCurrent=coreCurrent, platformFpgaTable=platformFpgaTable, fwEntry=fwEntry, diskWriteLatencyMs=diskWriteLatencyMs, platformCPUGroup=platformCPUGroup, diskWriteMerged=diskWriteMerged, fan_7_speed=fan_7_speed, diskWriteBytes=diskWriteBytes, diskSize=diskSize, fan_2_speed=fan_2_speed, cpuIndex=cpuIndex, platformCpuStatsTable=platformCpuStatsTable, memoryStatsEntry=memoryStatsEntry, platformDiskGroup=platformDiskGroup, fan_9_speed=fan_9_speed, diskPercentageUsed=diskPercentageUsed, diskVersion=diskVersion, fwVersion=fwVersion, memPlatformUsed=memPlatformUsed, coreTotal1minAvg=coreTotal1minAvg, cpuModelName=cpuModelName, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, cpuTotal5secAvg=cpuTotal5secAvg, tempAverage=tempAverage, diskSerialNo=diskSerialNo, fpgaVersion=fpgaVersion, memPercentageUsed=memPercentageUsed, cpuTotal5minAvg=cpuTotal5minAvg, fwName=fwName, platformCompliance=platformCompliance, coreIndex=coreIndex, cpuFreq=cpuFreq, temperatureStatsTable=temperatureStatsTable, tempMaximum=tempMaximum, diskInfoEntry=diskInfoEntry, fpgaEntry=fpgaEntry, tempMinimum=tempMinimum, platformMemoryStatsTable=platformMemoryStatsTable, fpgaTable=fpgaTable, fan_3_speed=fan_3_speed, coreTotal5secAvg=coreTotal5secAvg, platformDiskStatsTable=platformDiskStatsTable, fan_4_speed=fan_4_speed, platformTempGroup=platformTempGroup, memAvailable=memAvailable, index=index, coreTotal5minAvg=coreTotal5minAvg, platformFantrayTable=platformFantrayTable, f5PlatformStatsObjects=f5PlatformStatsObjects, cpuStepping=cpuStepping, diskType=diskType, platformGroups=platformGroups, String=String, fwUpdateStatus=fwUpdateStatus, fantrayStatsTable=fantrayStatsTable, cpuCacheSize=cpuCacheSize, platformConformance=platformConformance, platformFwVersionGroup=platformFwVersionGroup, PYSNMP_MODULE_ID=f5PlatformStats, diskReadBytes=diskReadBytes, PlatformStatsIndex=PlatformStatsIndex, cpuThreadCnt=cpuThreadCnt, fpgaIndex=fpgaIndex, cpuCoreCnt=cpuCoreCnt, temperatureStatsEntry=temperatureStatsEntry, platformFwTable=platformFwTable, platformTemperatureTable=platformTemperatureTable, fan_11_speed=fan_11_speed, diskReadMerged=diskReadMerged, diskUtilizationStatsEntry=diskUtilizationStatsEntry, diskWriteIops=diskWriteIops, platformFpgaGroup=platformFpgaGroup, configurable=configurable, fan_1_speed=fan_1_speed, memFree=memFree, fantrayStatsEntry=fantrayStatsEntry, cpuUtilizationStatsTable=cpuUtilizationStatsTable, diskInfoTable=diskInfoTable, diskVendor=diskVendor, fan_10_speed=fan_10_speed, cpuProcessorStatsTable=cpuProcessorStatsTable, diskTotalIops=diskTotalIops, cpuProcessorStatsEntry=cpuProcessorStatsEntry)
