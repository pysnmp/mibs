...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", coreCurrent=coreCurrent, diskInfoTable=diskInfoTable, diskWriteIops=diskWriteIops, cpuCoreStatsTable=cpuCoreStatsTable, configurable=configurable, platformFantrayGroup=platformFantrayGroup, platformTemperatureTable=platformTemperatureTable, diskReadBytes=diskReadBytes, platformCompliance=platformCompliance, diskWriteMerged=diskWriteMerged, coreTotal1minAvg=coreTotal1minAvg, fan_9_speed=fan_9_speed, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, diskVendor=diskVendor, fpgaVersion=fpgaVersion, coreTotal5minAvg=coreTotal5minAvg, diskPercentageUsed=diskPercentageUsed, platformFantrayTable=platformFantrayTable, fan_2_speed=fan_2_speed, fwTable=fwTable, platformCompliances=platformCompliances, memFree=memFree, cpuFreq=cpuFreq, cpuTotal5minAvg=cpuTotal5minAvg, fantrayStatsEntry=fantrayStatsEntry, cpuModelName=cpuModelName, diskSerialNo=diskSerialNo, diskName=diskName, diskReadLatencyMs=diskReadLatencyMs, PYSNMP_MODULE_ID=f5PlatformStats, fan_1_speed=fan_1_speed, platformDiskStatsTable=platformDiskStatsTable, fwName=fwName, f5PlatformStats=f5PlatformStats, memPlatformUsed=memPlatformUsed, index=index, diskTotalIops=diskTotalIops, fwUpdateStatus=fwUpdateStatus, cpuProcessorStatsTable=cpuProcessorStatsTable, cpuThreadCnt=cpuThreadCnt, fantrayStatsTable=fantrayStatsTable, memAvailable=memAvailable, platformFpgaGroup=platformFpgaGroup, diskReadMerged=diskReadMerged, memoryStatsEntry=memoryStatsEntry, cpuUtilizationStatsTable=cpuUtilizationStatsTable, platformCPUGroup=platformCPUGroup, fpgaTable=fpgaTable, tempMaximum=tempMaximum, cpuStepping=cpuStepping, diskReadIops=diskReadIops, f5PlatformStatsObjects=f5PlatformStatsObjects, fwEntry=fwEntry, fan_10_speed=fan_10_speed, fan_3_speed=fan_3_speed, platformConformance=platformConformance, memoryStatsTable=memoryStatsTable, tempCurrent=tempCurrent, fan_8_speed=fan_8_speed, fan_5_speed=fan_5_speed, coreTotal5secAvg=coreTotal5secAvg, diskWriteLatencyMs=diskWriteLatencyMs, fan_11_speed=fan_11_speed, tempMinimum=tempMinimum, cpuTotal1minAvg=cpuTotal1minAvg, platformMemGroup=platformMemGroup, diskType=diskType, coreIndex=coreIndex, fan_6_speed=fan_6_speed, String=String, platformFpgaTable=platformFpgaTable, fan_12_speed=fan_12_speed, memPlatformTotal=memPlatformTotal, platformCpuStatsTable=platformCpuStatsTable, fwVersion=fwVersion, diskSize=diskSize, cpuProcessorStatsEntry=cpuProcessorStatsEntry, fpgaIndex=fpgaIndex, diskInfoEntry=diskInfoEntry, platformGroups=platformGroups, cpuCacheSize=cpuCacheSize, PlatformStatsIndex=PlatformStatsIndex, fpgaEntry=fpgaEntry, fan_4_speed=fan_4_speed, platformMemoryStatsTable=platformMemoryStatsTable, cpuCore=cpuCore, fan_7_speed=fan_7_speed, cpuCoreCnt=cpuCoreCnt, diskUtilizationStatsTable=diskUtilizationStatsTable, platformFwVersionGroup=platformFwVersionGroup, platformTempGroup=platformTempGroup, platformDiskGroup=platformDiskGroup, temperatureStatsTable=temperatureStatsTable, diskModel=diskModel, temperatureStatsEntry=temperatureStatsEntry, memPercentageUsed=memPercentageUsed, diskVersion=diskVersion, platformFwTable=platformFwTable, cpuIndex=cpuIndex, cpuCurrent=cpuCurrent, coreName=coreName, tempAverage=tempAverage, diskUtilizationStatsEntry=diskUtilizationStatsEntry, cpuTotal5secAvg=cpuTotal5secAvg, diskWriteBytes=diskWriteBytes, cpuCoreStatsEntry=cpuCoreStatsEntry)
