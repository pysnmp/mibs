...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", PYSNMP_MODULE_ID=f5PlatformStats, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, cpuProcessorStatsEntry=cpuProcessorStatsEntry, cpuFreq=cpuFreq, fwTable=fwTable, cpuTotal1minAvg=cpuTotal1minAvg, diskReadMerged=diskReadMerged, diskWriteMerged=diskWriteMerged, platformTempGroup=platformTempGroup, platformFwTable=platformFwTable, diskUtilizationStatsEntry=diskUtilizationStatsEntry, fan_5_speed=fan_5_speed, platformFpgaTable=platformFpgaTable, temperatureStatsTable=temperatureStatsTable, coreCurrent=coreCurrent, memoryStatsTable=memoryStatsTable, cpuCore=cpuCore, fan_4_speed=fan_4_speed, tempAverage=tempAverage, diskReadLatencyMs=diskReadLatencyMs, fwEntry=fwEntry, String=String, fpgaTable=fpgaTable, diskReadIops=diskReadIops, fan_8_speed=fan_8_speed, tempMinimum=tempMinimum, platformCompliances=platformCompliances, cpuCoreStatsEntry=cpuCoreStatsEntry, coreIndex=coreIndex, cpuCacheSize=cpuCacheSize, PlatformStatsIndex=PlatformStatsIndex, platformConformance=platformConformance, platformFantrayGroup=platformFantrayGroup, fantrayStatsTable=fantrayStatsTable, platformCpuStatsTable=platformCpuStatsTable, diskReadBytes=diskReadBytes, platformCPUGroup=platformCPUGroup, platformFwVersionGroup=platformFwVersionGroup, platformFpgaGroup=platformFpgaGroup, memoryStatsEntry=memoryStatsEntry, cpuModelName=cpuModelName, fwUpdateStatus=fwUpdateStatus, platformDiskGroup=platformDiskGroup, diskWriteLatencyMs=diskWriteLatencyMs, cpuTotal5secAvg=cpuTotal5secAvg, fan_1_speed=fan_1_speed, fantrayStatsEntry=fantrayStatsEntry, temperatureStatsEntry=temperatureStatsEntry, diskVersion=diskVersion, memPlatformUsed=memPlatformUsed, cpuCurrent=cpuCurrent, f5PlatformStatsObjects=f5PlatformStatsObjects, fan_6_speed=fan_6_speed, platformMemGroup=platformMemGroup, cpuStepping=cpuStepping, diskPercentageUsed=diskPercentageUsed, cpuCoreStatsTable=cpuCoreStatsTable, tempCurrent=tempCurrent, diskSerialNo=diskSerialNo, cpuThreadCnt=cpuThreadCnt, coreName=coreName, platformCompliance=platformCompliance, fan_11_speed=fan_11_speed, memPlatformTotal=memPlatformTotal, fpgaVersion=fpgaVersion, cpuTotal5minAvg=cpuTotal5minAvg, diskWriteBytes=diskWriteBytes, diskName=diskName, fan_3_speed=fan_3_speed, platformGroups=platformGroups, fwName=fwName, f5PlatformStats=f5PlatformStats, fan_9_speed=fan_9_speed, diskInfoTable=diskInfoTable, cpuCoreCnt=cpuCoreCnt, memFree=memFree, fpgaIndex=fpgaIndex, diskSize=diskSize, cpuUtilizationStatsTable=cpuUtilizationStatsTable, tempMaximum=tempMaximum, diskVendor=diskVendor, fpgaEntry=fpgaEntry, fan_10_speed=fan_10_speed, memAvailable=memAvailable, platformDiskStatsTable=platformDiskStatsTable, platformFantrayTable=platformFantrayTable, fwVersion=fwVersion, diskInfoEntry=diskInfoEntry, diskWriteIops=diskWriteIops, memPercentageUsed=memPercentageUsed, configurable=configurable, coreTotal1minAvg=coreTotal1minAvg, fan_2_speed=fan_2_speed, platformTemperatureTable=platformTemperatureTable, cpuIndex=cpuIndex, coreTotal5minAvg=coreTotal5minAvg, platformMemoryStatsTable=platformMemoryStatsTable, diskUtilizationStatsTable=diskUtilizationStatsTable, diskTotalIops=diskTotalIops, coreTotal5secAvg=coreTotal5secAvg, diskModel=diskModel, diskType=diskType, fan_7_speed=fan_7_speed, cpuProcessorStatsTable=cpuProcessorStatsTable, fan_12_speed=fan_12_speed, index=index)
