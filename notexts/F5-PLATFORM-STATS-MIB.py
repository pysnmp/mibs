...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", cpuFreq=cpuFreq, cpuTotal1minAvg=cpuTotal1minAvg, cpuCoreStatsEntry=cpuCoreStatsEntry, diskReadLatencyMs=diskReadLatencyMs, temperatureStatsEntry=temperatureStatsEntry, cpuCurrent=cpuCurrent, coreCurrent=coreCurrent, cpuTotal5minAvg=cpuTotal5minAvg, diskWriteIops=diskWriteIops, platformTemperatureTable=platformTemperatureTable, diskVendor=diskVendor, memPlatformUsed=memPlatformUsed, fan_6_speed=fan_6_speed, memoryStatsTable=memoryStatsTable, coreTotal5minAvg=coreTotal5minAvg, cpuProcessorStatsTable=cpuProcessorStatsTable, fan_7_speed=fan_7_speed, cpuStepping=cpuStepping, platformTempGroup=platformTempGroup, coreTotal5secAvg=coreTotal5secAvg, fan_4_speed=fan_4_speed, fpgaIndex=fpgaIndex, PYSNMP_MODULE_ID=f5PlatformStats, platformFpgaTable=platformFpgaTable, diskWriteMerged=diskWriteMerged, fpgaVersion=fpgaVersion, platformFpgaGroup=platformFpgaGroup, f5PlatformStats=f5PlatformStats, diskTotalIops=diskTotalIops, cpuModelName=cpuModelName, fan_2_speed=fan_2_speed, tempCurrent=tempCurrent, platformFantrayTable=platformFantrayTable, cpuProcessorStatsEntry=cpuProcessorStatsEntry, diskWriteLatencyMs=diskWriteLatencyMs, diskModel=diskModel, temperatureStatsTable=temperatureStatsTable, coreIndex=coreIndex, fan_10_speed=fan_10_speed, diskInfoTable=diskInfoTable, platformCompliances=platformCompliances, fpgaEntry=fpgaEntry, cpuCore=cpuCore, diskName=diskName, platformGroups=platformGroups, PlatformStatsIndex=PlatformStatsIndex, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, platformMemoryStatsTable=platformMemoryStatsTable, diskWriteBytes=diskWriteBytes, cpuUtilizationStatsTable=cpuUtilizationStatsTable, fan_5_speed=fan_5_speed, memPercentageUsed=memPercentageUsed, tempMaximum=tempMaximum, fan_9_speed=fan_9_speed, fan_8_speed=fan_8_speed, cpuCoreStatsTable=cpuCoreStatsTable, cpuCoreCnt=cpuCoreCnt, platformFwVersionGroup=platformFwVersionGroup, cpuCacheSize=cpuCacheSize, memoryStatsEntry=memoryStatsEntry, coreTotal1minAvg=coreTotal1minAvg, platformConformance=platformConformance, fantrayStatsTable=fantrayStatsTable, fan_11_speed=fan_11_speed, platformDiskStatsTable=platformDiskStatsTable, diskReadIops=diskReadIops, fwName=fwName, platformFwTable=platformFwTable, index=index, fan_12_speed=fan_12_speed, platformDiskGroup=platformDiskGroup, fan_3_speed=fan_3_speed, platformCPUGroup=platformCPUGroup, f5PlatformStatsObjects=f5PlatformStatsObjects, platformCompliance=platformCompliance, fwTable=fwTable, diskUtilizationStatsTable=diskUtilizationStatsTable, fan_1_speed=fan_1_speed, diskSerialNo=diskSerialNo, memPlatformTotal=memPlatformTotal, String=String, configurable=configurable, diskPercentageUsed=diskPercentageUsed, platformCpuStatsTable=platformCpuStatsTable, cpuTotal5secAvg=cpuTotal5secAvg, coreName=coreName, diskType=diskType, tempMinimum=tempMinimum, platformMemGroup=platformMemGroup, diskUtilizationStatsEntry=diskUtilizationStatsEntry, cpuThreadCnt=cpuThreadCnt, diskSize=diskSize, fantrayStatsEntry=fantrayStatsEntry, tempAverage=tempAverage, cpuIndex=cpuIndex, diskVersion=diskVersion, fwUpdateStatus=fwUpdateStatus, memFree=memFree, memAvailable=memAvailable, fwVersion=fwVersion, diskReadBytes=diskReadBytes, diskInfoEntry=diskInfoEntry, fwEntry=fwEntry, fpgaTable=fpgaTable, platformFantrayGroup=platformFantrayGroup, diskReadMerged=diskReadMerged)
