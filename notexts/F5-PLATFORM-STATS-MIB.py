...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", platformFantrayTable=platformFantrayTable, diskWriteIops=diskWriteIops, diskReadMerged=diskReadMerged, tempMinimum=tempMinimum, cpuProcessorStatsEntry=cpuProcessorStatsEntry, cpuFreq=cpuFreq, cpuTotal5minAvg=cpuTotal5minAvg, memPlatformUsed=memPlatformUsed, platformCPUGroup=platformCPUGroup, platformMemGroup=platformMemGroup, diskWriteBytes=diskWriteBytes, memPercentageUsed=memPercentageUsed, platformTemperatureTable=platformTemperatureTable, cpuCoreStatsEntry=cpuCoreStatsEntry, f5PlatformStats=f5PlatformStats, platformFantrayGroup=platformFantrayGroup, diskSerialNo=diskSerialNo, platformCpuStatsTable=platformCpuStatsTable, fwName=fwName, fan_3_speed=fan_3_speed, platformDiskStatsTable=platformDiskStatsTable, temperatureStatsEntry=temperatureStatsEntry, coreCurrent=coreCurrent, diskInfoEntry=diskInfoEntry, PlatformStatsIndex=PlatformStatsIndex, cpuIndex=cpuIndex, PYSNMP_MODULE_ID=f5PlatformStats, temperatureStatsTable=temperatureStatsTable, fwVersion=fwVersion, fan_4_speed=fan_4_speed, cpuModelName=cpuModelName, fan_12_speed=fan_12_speed, diskTotalIops=diskTotalIops, diskType=diskType, coreTotal1minAvg=coreTotal1minAvg, fan_11_speed=fan_11_speed, diskReadBytes=diskReadBytes, cpuStepping=cpuStepping, fpgaTable=fpgaTable, platformDiskGroup=platformDiskGroup, diskWriteLatencyMs=diskWriteLatencyMs, cpuCurrent=cpuCurrent, coreIndex=coreIndex, fan_8_speed=fan_8_speed, memAvailable=memAvailable, configurable=configurable, fpgaIndex=fpgaIndex, platformFwVersionGroup=platformFwVersionGroup, diskVersion=diskVersion, f5PlatformStatsObjects=f5PlatformStatsObjects, fpgaEntry=fpgaEntry, cpuThreadCnt=cpuThreadCnt, platformMemoryStatsTable=platformMemoryStatsTable, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, diskInfoTable=diskInfoTable, platformFwTable=platformFwTable, fan_1_speed=fan_1_speed, platformConformance=platformConformance, cpuCore=cpuCore, diskName=diskName, cpuCoreCnt=cpuCoreCnt, diskWriteMerged=diskWriteMerged, fwUpdateStatus=fwUpdateStatus, coreName=coreName, cpuProcessorStatsTable=cpuProcessorStatsTable, platformCompliance=platformCompliance, tempAverage=tempAverage, diskSize=diskSize, diskPercentageUsed=diskPercentageUsed, fantrayStatsTable=fantrayStatsTable, cpuCoreStatsTable=cpuCoreStatsTable, fan_6_speed=fan_6_speed, memPlatformTotal=memPlatformTotal, fwEntry=fwEntry, fan_5_speed=fan_5_speed, cpuTotal1minAvg=cpuTotal1minAvg, platformCompliances=platformCompliances, memFree=memFree, memoryStatsEntry=memoryStatsEntry, coreTotal5minAvg=coreTotal5minAvg, memoryStatsTable=memoryStatsTable, fan_10_speed=fan_10_speed, String=String, platformGroups=platformGroups, diskReadLatencyMs=diskReadLatencyMs, diskUtilizationStatsEntry=diskUtilizationStatsEntry, fwTable=fwTable, fan_7_speed=fan_7_speed, cpuUtilizationStatsTable=cpuUtilizationStatsTable, diskVendor=diskVendor, cpuCacheSize=cpuCacheSize, diskModel=diskModel, platformTempGroup=platformTempGroup, fantrayStatsEntry=fantrayStatsEntry, fan_9_speed=fan_9_speed, cpuTotal5secAvg=cpuTotal5secAvg, tempCurrent=tempCurrent, fan_2_speed=fan_2_speed, fpgaVersion=fpgaVersion, platformFpgaGroup=platformFpgaGroup, platformFpgaTable=platformFpgaTable, coreTotal5secAvg=coreTotal5secAvg, diskUtilizationStatsTable=diskUtilizationStatsTable, index=index, diskReadIops=diskReadIops, tempMaximum=tempMaximum)
