...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", platformTemperatureTable=platformTemperatureTable, platformTempGroup=platformTempGroup, coreName=coreName, PlatformStatsIndex=PlatformStatsIndex, diskPercentageUsed=diskPercentageUsed, platformDiskStatsTable=platformDiskStatsTable, diskUtilizationStatsTable=diskUtilizationStatsTable, diskReadBytes=diskReadBytes, fan_3_speed=fan_3_speed, diskInfoEntry=diskInfoEntry, platformConformance=platformConformance, cpuCurrent=cpuCurrent, platformFantrayGroup=platformFantrayGroup, tempAverage=tempAverage, index=index, fantrayStatsTable=fantrayStatsTable, fan_8_speed=fan_8_speed, fan_5_speed=fan_5_speed, fan_12_speed=fan_12_speed, fan_1_speed=fan_1_speed, fantrayStatsEntry=fantrayStatsEntry, cpuUtilizationStatsTable=cpuUtilizationStatsTable, fan_2_speed=fan_2_speed, cpuTotal5minAvg=cpuTotal5minAvg, memoryStatsTable=memoryStatsTable, diskName=diskName, coreTotal5minAvg=coreTotal5minAvg, coreTotal5secAvg=coreTotal5secAvg, fwVersion=fwVersion, cpuThreadCnt=cpuThreadCnt, cpuStepping=cpuStepping, diskModel=diskModel, fan_7_speed=fan_7_speed, diskReadLatencyMs=diskReadLatencyMs, fpgaVersion=fpgaVersion, fpgaTable=fpgaTable, tempCurrent=tempCurrent, platformMemoryStatsTable=platformMemoryStatsTable, memoryStatsEntry=memoryStatsEntry, platformFantrayTable=platformFantrayTable, tempMaximum=tempMaximum, cpuCacheSize=cpuCacheSize, fan_6_speed=fan_6_speed, diskSerialNo=diskSerialNo, f5PlatformStatsObjects=f5PlatformStatsObjects, platformFpgaTable=platformFpgaTable, memPlatformTotal=memPlatformTotal, fan_4_speed=fan_4_speed, platformFwVersionGroup=platformFwVersionGroup, diskWriteIops=diskWriteIops, platformFpgaGroup=platformFpgaGroup, platformMemGroup=platformMemGroup, cpuTotal1minAvg=cpuTotal1minAvg, cpuCoreCnt=cpuCoreCnt, diskWriteLatencyMs=diskWriteLatencyMs, platformCpuStatsTable=platformCpuStatsTable, fwEntry=fwEntry, diskTotalIops=diskTotalIops, cpuIndex=cpuIndex, fwName=fwName, diskVendor=diskVendor, platformCompliance=platformCompliance, f5PlatformStats=f5PlatformStats, diskWriteBytes=diskWriteBytes, diskReadMerged=diskReadMerged, fan_10_speed=fan_10_speed, String=String, coreCurrent=coreCurrent, diskVersion=diskVersion, coreIndex=coreIndex, cpuModelName=cpuModelName, fwTable=fwTable, cpuCore=cpuCore, temperatureStatsTable=temperatureStatsTable, configurable=configurable, memPlatformUsed=memPlatformUsed, fwUpdateStatus=fwUpdateStatus, platformCompliances=platformCompliances, fpgaIndex=fpgaIndex, cpuTotal5secAvg=cpuTotal5secAvg, temperatureStatsEntry=temperatureStatsEntry, cpuFreq=cpuFreq, fpgaEntry=fpgaEntry, diskType=diskType, platformGroups=platformGroups, fan_11_speed=fan_11_speed, tempMinimum=tempMinimum, cpuProcessorStatsEntry=cpuProcessorStatsEntry, cpuCoreStatsTable=cpuCoreStatsTable, platformDiskGroup=platformDiskGroup, diskUtilizationStatsEntry=diskUtilizationStatsEntry, PYSNMP_MODULE_ID=f5PlatformStats, coreTotal1minAvg=coreTotal1minAvg, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, fan_9_speed=fan_9_speed, diskInfoTable=diskInfoTable, platformCPUGroup=platformCPUGroup, platformFwTable=platformFwTable, diskWriteMerged=diskWriteMerged, memAvailable=memAvailable, diskSize=diskSize, memPercentageUsed=memPercentageUsed, memFree=memFree, cpuCoreStatsEntry=cpuCoreStatsEntry, cpuProcessorStatsTable=cpuProcessorStatsTable, diskReadIops=diskReadIops)
