...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", memPercentageUsed=memPercentageUsed, cpuIndex=cpuIndex, cpuUtilizationStatsTable=cpuUtilizationStatsTable, diskSerialNo=diskSerialNo, platformDiskGroup=platformDiskGroup, fwName=fwName, fwTable=fwTable, memAvailable=memAvailable, platformFpgaGroup=platformFpgaGroup, diskWriteBytes=diskWriteBytes, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, diskVersion=diskVersion, cpuTotal1minAvg=cpuTotal1minAvg, diskWriteLatencyMs=diskWriteLatencyMs, fantrayStatsEntry=fantrayStatsEntry, diskModel=diskModel, memFree=memFree, String=String, temperatureStatsTable=temperatureStatsTable, fan_12_speed=fan_12_speed, fan_4_speed=fan_4_speed, diskUtilizationStatsEntry=diskUtilizationStatsEntry, coreIndex=coreIndex, coreTotal5secAvg=coreTotal5secAvg, PYSNMP_MODULE_ID=f5PlatformStats, cpuThreadCnt=cpuThreadCnt, platformTemperatureTable=platformTemperatureTable, tempMaximum=tempMaximum, diskInfoEntry=diskInfoEntry, temperatureStatsEntry=temperatureStatsEntry, diskSize=diskSize, fan_8_speed=fan_8_speed, fan_3_speed=fan_3_speed, f5PlatformStatsObjects=f5PlatformStatsObjects, fan_1_speed=fan_1_speed, cpuCoreStatsEntry=cpuCoreStatsEntry, cpuProcessorStatsEntry=cpuProcessorStatsEntry, coreTotal1minAvg=coreTotal1minAvg, fpgaVersion=fpgaVersion, index=index, fpgaTable=fpgaTable, diskWriteIops=diskWriteIops, platformConformance=platformConformance, diskReadIops=diskReadIops, diskVendor=diskVendor, memoryStatsTable=memoryStatsTable, platformGroups=platformGroups, cpuFreq=cpuFreq, cpuCore=cpuCore, fwEntry=fwEntry, cpuProcessorStatsTable=cpuProcessorStatsTable, platformFantrayTable=platformFantrayTable, fantrayStatsTable=fantrayStatsTable, platformFpgaTable=platformFpgaTable, platformCompliance=platformCompliance, fan_11_speed=fan_11_speed, diskPercentageUsed=diskPercentageUsed, tempAverage=tempAverage, diskReadBytes=diskReadBytes, platformFwVersionGroup=platformFwVersionGroup, PlatformStatsIndex=PlatformStatsIndex, platformMemGroup=platformMemGroup, cpuCacheSize=cpuCacheSize, fan_10_speed=fan_10_speed, diskReadLatencyMs=diskReadLatencyMs, platformMemoryStatsTable=platformMemoryStatsTable, diskTotalIops=diskTotalIops, tempMinimum=tempMinimum, platformDiskStatsTable=platformDiskStatsTable, diskWriteMerged=diskWriteMerged, platformTempGroup=platformTempGroup, diskUtilizationStatsTable=diskUtilizationStatsTable, cpuTotal5minAvg=cpuTotal5minAvg, coreTotal5minAvg=coreTotal5minAvg, platformFwTable=platformFwTable, fan_5_speed=fan_5_speed, platformCPUGroup=platformCPUGroup, memPlatformTotal=memPlatformTotal, diskType=diskType, cpuTotal5secAvg=cpuTotal5secAvg, fan_6_speed=fan_6_speed, platformFantrayGroup=platformFantrayGroup, memoryStatsEntry=memoryStatsEntry, fan_7_speed=fan_7_speed, f5PlatformStats=f5PlatformStats, memPlatformUsed=memPlatformUsed, tempCurrent=tempCurrent, cpuStepping=cpuStepping, cpuModelName=cpuModelName, diskInfoTable=diskInfoTable, fpgaEntry=fpgaEntry, fwVersion=fwVersion, fan_2_speed=fan_2_speed, cpuCoreCnt=cpuCoreCnt, configurable=configurable, fan_9_speed=fan_9_speed, fpgaIndex=fpgaIndex, diskReadMerged=diskReadMerged, cpuCurrent=cpuCurrent, cpuCoreStatsTable=cpuCoreStatsTable, platformCpuStatsTable=platformCpuStatsTable, coreName=coreName, fwUpdateStatus=fwUpdateStatus, diskName=diskName, platformCompliances=platformCompliances, coreCurrent=coreCurrent)
