...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", cpuCacheSize=cpuCacheSize, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, diskVersion=diskVersion, fwTable=fwTable, memFree=memFree, diskUtilizationStatsTable=diskUtilizationStatsTable, memPlatformUsed=memPlatformUsed, fan_11_speed=fan_11_speed, coreName=coreName, platformCompliances=platformCompliances, platformDiskStatsTable=platformDiskStatsTable, diskReadBytes=diskReadBytes, platformCPUGroup=platformCPUGroup, platformConformance=platformConformance, diskWriteBytes=diskWriteBytes, fan_12_speed=fan_12_speed, fan_8_speed=fan_8_speed, fwVersion=fwVersion, platformFantrayTable=platformFantrayTable, tempCurrent=tempCurrent, String=String, diskModel=diskModel, platformFpgaTable=platformFpgaTable, cpuModelName=cpuModelName, platformFantrayGroup=platformFantrayGroup, fpgaVersion=fpgaVersion, temperatureStatsEntry=temperatureStatsEntry, cpuProcessorStatsEntry=cpuProcessorStatsEntry, cpuUtilizationStatsTable=cpuUtilizationStatsTable, memPercentageUsed=memPercentageUsed, temperatureStatsTable=temperatureStatsTable, fantrayStatsEntry=fantrayStatsEntry, diskTotalIops=diskTotalIops, cpuStepping=cpuStepping, diskPercentageUsed=diskPercentageUsed, platformCompliance=platformCompliance, coreIndex=coreIndex, coreCurrent=coreCurrent, diskWriteLatencyMs=diskWriteLatencyMs, tempMaximum=tempMaximum, cpuCoreStatsTable=cpuCoreStatsTable, diskSize=diskSize, fan_2_speed=fan_2_speed, platformFwVersionGroup=platformFwVersionGroup, cpuProcessorStatsTable=cpuProcessorStatsTable, memPlatformTotal=memPlatformTotal, fpgaIndex=fpgaIndex, cpuThreadCnt=cpuThreadCnt, memoryStatsTable=memoryStatsTable, fan_4_speed=fan_4_speed, platformGroups=platformGroups, platformMemoryStatsTable=platformMemoryStatsTable, f5PlatformStats=f5PlatformStats, configurable=configurable, index=index, fantrayStatsTable=fantrayStatsTable, diskSerialNo=diskSerialNo, cpuCore=cpuCore, fan_3_speed=fan_3_speed, diskReadLatencyMs=diskReadLatencyMs, diskWriteMerged=diskWriteMerged, cpuIndex=cpuIndex, PYSNMP_MODULE_ID=f5PlatformStats, diskType=diskType, platformCpuStatsTable=platformCpuStatsTable, f5PlatformStatsObjects=f5PlatformStatsObjects, cpuCurrent=cpuCurrent, fpgaTable=fpgaTable, diskWriteIops=diskWriteIops, platformTempGroup=platformTempGroup, platformFwTable=platformFwTable, diskName=diskName, diskReadIops=diskReadIops, cpuTotal5secAvg=cpuTotal5secAvg, PlatformStatsIndex=PlatformStatsIndex, diskVendor=diskVendor, coreTotal5minAvg=coreTotal5minAvg, cpuTotal5minAvg=cpuTotal5minAvg, fwUpdateStatus=fwUpdateStatus, fan_10_speed=fan_10_speed, memAvailable=memAvailable, cpuCoreCnt=cpuCoreCnt, cpuTotal1minAvg=cpuTotal1minAvg, platformTemperatureTable=platformTemperatureTable, fwName=fwName, fan_5_speed=fan_5_speed, platformMemGroup=platformMemGroup, diskInfoEntry=diskInfoEntry, fan_6_speed=fan_6_speed, diskReadMerged=diskReadMerged, fwEntry=fwEntry, fan_7_speed=fan_7_speed, cpuCoreStatsEntry=cpuCoreStatsEntry, coreTotal5secAvg=coreTotal5secAvg, fan_1_speed=fan_1_speed, memoryStatsEntry=memoryStatsEntry, platformFpgaGroup=platformFpgaGroup, diskUtilizationStatsEntry=diskUtilizationStatsEntry, coreTotal1minAvg=coreTotal1minAvg, platformDiskGroup=platformDiskGroup, cpuFreq=cpuFreq, diskInfoTable=diskInfoTable, fpgaEntry=fpgaEntry, tempMinimum=tempMinimum, fan_9_speed=fan_9_speed, tempAverage=tempAverage)
