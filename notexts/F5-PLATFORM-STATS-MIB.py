...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", platformFpgaGroup=platformFpgaGroup, diskReadBytes=diskReadBytes, platformCompliance=platformCompliance, diskWriteLatencyMs=diskWriteLatencyMs, PYSNMP_MODULE_ID=f5PlatformStats, f5PlatformStats=f5PlatformStats, fan_2_speed=fan_2_speed, coreTotal5secAvg=coreTotal5secAvg, fwTable=fwTable, platformConformance=platformConformance, cpuTotal5minAvg=cpuTotal5minAvg, tempCurrent=tempCurrent, fan_3_speed=fan_3_speed, fan_5_speed=fan_5_speed, diskReadLatencyMs=diskReadLatencyMs, platformCpuStatsTable=platformCpuStatsTable, diskPercentageUsed=diskPercentageUsed, cpuTotal5secAvg=cpuTotal5secAvg, coreTotal5minAvg=coreTotal5minAvg, cpuUtilizationStatsTable=cpuUtilizationStatsTable, diskName=diskName, fpgaIndex=fpgaIndex, fwEntry=fwEntry, diskType=diskType, memFree=memFree, diskWriteBytes=diskWriteBytes, platformTemperatureTable=platformTemperatureTable, cpuStepping=cpuStepping, platformTempGroup=platformTempGroup, memoryStatsEntry=memoryStatsEntry, cpuProcessorStatsTable=cpuProcessorStatsTable, coreIndex=coreIndex, memPlatformUsed=memPlatformUsed, cpuCacheSize=cpuCacheSize, platformFpgaTable=platformFpgaTable, platformGroups=platformGroups, cpuTotal1minAvg=cpuTotal1minAvg, platformCompliances=platformCompliances, fan_11_speed=fan_11_speed, platformDiskStatsTable=platformDiskStatsTable, cpuCoreStatsEntry=cpuCoreStatsEntry, fwName=fwName, diskTotalIops=diskTotalIops, cpuCoreCnt=cpuCoreCnt, diskModel=diskModel, cpuIndex=cpuIndex, cpuCore=cpuCore, memPlatformTotal=memPlatformTotal, cpuCoreStatsTable=cpuCoreStatsTable, fan_10_speed=fan_10_speed, memAvailable=memAvailable, platformCPUGroup=platformCPUGroup, platformFwVersionGroup=platformFwVersionGroup, diskWriteIops=diskWriteIops, diskVendor=diskVendor, fan_1_speed=fan_1_speed, f5PlatformStatsObjects=f5PlatformStatsObjects, diskUtilizationStatsEntry=diskUtilizationStatsEntry, platformFantrayTable=platformFantrayTable, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, cpuCurrent=cpuCurrent, tempAverage=tempAverage, index=index, platformFantrayGroup=platformFantrayGroup, fwUpdateStatus=fwUpdateStatus, configurable=configurable, diskVersion=diskVersion, fan_8_speed=fan_8_speed, diskInfoTable=diskInfoTable, platformMemGroup=platformMemGroup, temperatureStatsEntry=temperatureStatsEntry, cpuModelName=cpuModelName, temperatureStatsTable=temperatureStatsTable, fan_9_speed=fan_9_speed, platformDiskGroup=platformDiskGroup, fwVersion=fwVersion, PlatformStatsIndex=PlatformStatsIndex, platformFwTable=platformFwTable, coreCurrent=coreCurrent, platformMemoryStatsTable=platformMemoryStatsTable, diskWriteMerged=diskWriteMerged, memoryStatsTable=memoryStatsTable, coreName=coreName, fan_4_speed=fan_4_speed, diskUtilizationStatsTable=diskUtilizationStatsTable, diskInfoEntry=diskInfoEntry, cpuProcessorStatsEntry=cpuProcessorStatsEntry, tempMinimum=tempMinimum, fantrayStatsTable=fantrayStatsTable, diskSerialNo=diskSerialNo, diskReadIops=diskReadIops, coreTotal1minAvg=coreTotal1minAvg, cpuThreadCnt=cpuThreadCnt, memPercentageUsed=memPercentageUsed, fan_6_speed=fan_6_speed, fan_7_speed=fan_7_speed, diskReadMerged=diskReadMerged, cpuFreq=cpuFreq, fantrayStatsEntry=fantrayStatsEntry, fpgaEntry=fpgaEntry, tempMaximum=tempMaximum, fpgaTable=fpgaTable, fpgaVersion=fpgaVersion, fan_12_speed=fan_12_speed, diskSize=diskSize, String=String)
