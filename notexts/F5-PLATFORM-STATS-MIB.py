...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", fan_5_speed=fan_5_speed, tempAverage=tempAverage, fwName=fwName, memAvailable=memAvailable, tempMaximum=tempMaximum, coreCurrent=coreCurrent, memPlatformUsed=memPlatformUsed, platformCompliance=platformCompliance, platformGroups=platformGroups, platformDiskStatsTable=platformDiskStatsTable, cpuModelName=cpuModelName, memFree=memFree, memPercentageUsed=memPercentageUsed, diskWriteLatencyMs=diskWriteLatencyMs, fpgaEntry=fpgaEntry, cpuProcessorStatsEntry=cpuProcessorStatsEntry, cpuIndex=cpuIndex, platformCompliances=platformCompliances, platformDiskGroup=platformDiskGroup, fan_4_speed=fan_4_speed, index=index, cpuCurrent=cpuCurrent, diskModel=diskModel, PlatformStatsIndex=PlatformStatsIndex, fpgaTable=fpgaTable, diskReadIops=diskReadIops, f5PlatformStatsObjects=f5PlatformStatsObjects, diskReadLatencyMs=diskReadLatencyMs, cpuUtilizationStatsTable=cpuUtilizationStatsTable, cpuCoreCnt=cpuCoreCnt, coreTotal5secAvg=coreTotal5secAvg, fwTable=fwTable, cpuTotal5minAvg=cpuTotal5minAvg, cpuCoreStatsTable=cpuCoreStatsTable, platformMemoryStatsTable=platformMemoryStatsTable, platformTempGroup=platformTempGroup, diskVendor=diskVendor, cpuCore=cpuCore, platformFwTable=platformFwTable, fantrayStatsEntry=fantrayStatsEntry, fpgaIndex=fpgaIndex, platformFwVersionGroup=platformFwVersionGroup, diskName=diskName, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, diskPercentageUsed=diskPercentageUsed, memPlatformTotal=memPlatformTotal, diskReadMerged=diskReadMerged, fantrayStatsTable=fantrayStatsTable, fan_9_speed=fan_9_speed, diskSerialNo=diskSerialNo, coreTotal5minAvg=coreTotal5minAvg, diskInfoEntry=diskInfoEntry, configurable=configurable, fan_8_speed=fan_8_speed, fan_1_speed=fan_1_speed, diskWriteIops=diskWriteIops, diskWriteBytes=diskWriteBytes, diskVersion=diskVersion, platformFantrayTable=platformFantrayTable, diskUtilizationStatsTable=diskUtilizationStatsTable, tempMinimum=tempMinimum, cpuTotal1minAvg=cpuTotal1minAvg, temperatureStatsTable=temperatureStatsTable, diskTotalIops=diskTotalIops, diskWriteMerged=diskWriteMerged, platformFpgaGroup=platformFpgaGroup, f5PlatformStats=f5PlatformStats, PYSNMP_MODULE_ID=f5PlatformStats, memoryStatsEntry=memoryStatsEntry, diskType=diskType, memoryStatsTable=memoryStatsTable, fwVersion=fwVersion, cpuStepping=cpuStepping, platformFantrayGroup=platformFantrayGroup, fpgaVersion=fpgaVersion, cpuCacheSize=cpuCacheSize, fan_6_speed=fan_6_speed, fan_11_speed=fan_11_speed, platformCPUGroup=platformCPUGroup, diskInfoTable=diskInfoTable, cpuThreadCnt=cpuThreadCnt, cpuFreq=cpuFreq, cpuCoreStatsEntry=cpuCoreStatsEntry, coreName=coreName, coreIndex=coreIndex, temperatureStatsEntry=temperatureStatsEntry, cpuTotal5secAvg=cpuTotal5secAvg, platformMemGroup=platformMemGroup, platformCpuStatsTable=platformCpuStatsTable, platformConformance=platformConformance, fan_3_speed=fan_3_speed, fwEntry=fwEntry, coreTotal1minAvg=coreTotal1minAvg, String=String, platformTemperatureTable=platformTemperatureTable, tempCurrent=tempCurrent, diskSize=diskSize, diskUtilizationStatsEntry=diskUtilizationStatsEntry, diskReadBytes=diskReadBytes, fan_7_speed=fan_7_speed, fan_2_speed=fan_2_speed, cpuProcessorStatsTable=cpuProcessorStatsTable, fan_10_speed=fan_10_speed, fan_12_speed=fan_12_speed, platformFpgaTable=platformFpgaTable, fwUpdateStatus=fwUpdateStatus)
