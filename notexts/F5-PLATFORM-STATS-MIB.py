...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", fwTable=fwTable, diskModel=diskModel, fan_8_speed=fan_8_speed, platformDiskStatsTable=platformDiskStatsTable, PlatformStatsIndex=PlatformStatsIndex, String=String, diskVendor=diskVendor, fan_6_speed=fan_6_speed, platformTemperatureTable=platformTemperatureTable, cpuStepping=cpuStepping, platformMemGroup=platformMemGroup, platformFwTable=platformFwTable, fantrayStatsTable=fantrayStatsTable, platformCPUGroup=platformCPUGroup, coreTotal1minAvg=coreTotal1minAvg, coreTotal5minAvg=coreTotal5minAvg, platformFpgaGroup=platformFpgaGroup, diskType=diskType, memPlatformUsed=memPlatformUsed, cpuFreq=cpuFreq, fpgaEntry=fpgaEntry, platformConformance=platformConformance, diskSize=diskSize, configurable=configurable, tempMinimum=tempMinimum, platformCpuStatsTable=platformCpuStatsTable, fan_4_speed=fan_4_speed, fan_12_speed=fan_12_speed, diskName=diskName, diskUtilizationStatsEntry=diskUtilizationStatsEntry, memAvailable=memAvailable, fan_1_speed=fan_1_speed, diskWriteBytes=diskWriteBytes, platformMemoryStatsTable=platformMemoryStatsTable, fpgaTable=fpgaTable, coreTotal5secAvg=coreTotal5secAvg, cpuCoreStatsEntry=cpuCoreStatsEntry, f5PlatformStatsObjects=f5PlatformStatsObjects, fan_10_speed=fan_10_speed, platformFpgaTable=platformFpgaTable, diskReadIops=diskReadIops, cpuProcessorStatsEntry=cpuProcessorStatsEntry, cpuTotal5secAvg=cpuTotal5secAvg, fan_7_speed=fan_7_speed, diskVersion=diskVersion, temperatureStatsEntry=temperatureStatsEntry, cpuIndex=cpuIndex, platformDiskGroup=platformDiskGroup, platformFantrayGroup=platformFantrayGroup, coreCurrent=coreCurrent, index=index, diskReadLatencyMs=diskReadLatencyMs, diskInfoTable=diskInfoTable, fwUpdateStatus=fwUpdateStatus, diskReadBytes=diskReadBytes, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, cpuCurrent=cpuCurrent, memoryStatsTable=memoryStatsTable, diskWriteMerged=diskWriteMerged, tempMaximum=tempMaximum, platformTempGroup=platformTempGroup, memoryStatsEntry=memoryStatsEntry, fwName=fwName, platformGroups=platformGroups, temperatureStatsTable=temperatureStatsTable, diskWriteLatencyMs=diskWriteLatencyMs, cpuCoreStatsTable=cpuCoreStatsTable, f5PlatformStats=f5PlatformStats, fwVersion=fwVersion, diskPercentageUsed=diskPercentageUsed, diskWriteIops=diskWriteIops, diskTotalIops=diskTotalIops, fpgaIndex=fpgaIndex, fan_2_speed=fan_2_speed, cpuCore=cpuCore, diskInfoEntry=diskInfoEntry, memPercentageUsed=memPercentageUsed, diskSerialNo=diskSerialNo, platformFwVersionGroup=platformFwVersionGroup, fan_11_speed=fan_11_speed, platformCompliance=platformCompliance, fan_5_speed=fan_5_speed, coreIndex=coreIndex, tempCurrent=tempCurrent, fantrayStatsEntry=fantrayStatsEntry, cpuTotal1minAvg=cpuTotal1minAvg, tempAverage=tempAverage, platformCompliances=platformCompliances, memPlatformTotal=memPlatformTotal, cpuThreadCnt=cpuThreadCnt, cpuTotal5minAvg=cpuTotal5minAvg, PYSNMP_MODULE_ID=f5PlatformStats, cpuModelName=cpuModelName, fan_9_speed=fan_9_speed, cpuCacheSize=cpuCacheSize, cpuUtilizationStatsTable=cpuUtilizationStatsTable, fan_3_speed=fan_3_speed, diskUtilizationStatsTable=diskUtilizationStatsTable, cpuProcessorStatsTable=cpuProcessorStatsTable, coreName=coreName, diskReadMerged=diskReadMerged, platformFantrayTable=platformFantrayTable, fpgaVersion=fpgaVersion, cpuCoreCnt=cpuCoreCnt, memFree=memFree, fwEntry=fwEntry)
