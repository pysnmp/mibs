...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", fpgaVersion=fpgaVersion, fan_9_speed=fan_9_speed, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, fpgaTable=fpgaTable, platformGroups=platformGroups, platformFantrayGroup=platformFantrayGroup, platformTempGroup=platformTempGroup, diskTotalIops=diskTotalIops, platformConformance=platformConformance, cpuCacheSize=cpuCacheSize, platformMemGroup=platformMemGroup, coreIndex=coreIndex, platformFpgaTable=platformFpgaTable, fwEntry=fwEntry, coreCurrent=coreCurrent, fpgaEntry=fpgaEntry, cpuTotal1minAvg=cpuTotal1minAvg, f5PlatformStatsObjects=f5PlatformStatsObjects, memoryStatsTable=memoryStatsTable, diskUtilizationStatsEntry=diskUtilizationStatsEntry, tempMinimum=tempMinimum, fwUpdateStatus=fwUpdateStatus, tempAverage=tempAverage, memPlatformUsed=memPlatformUsed, cpuCoreStatsEntry=cpuCoreStatsEntry, fan_2_speed=fan_2_speed, diskSerialNo=diskSerialNo, memFree=memFree, memoryStatsEntry=memoryStatsEntry, coreName=coreName, diskPercentageUsed=diskPercentageUsed, platformCompliances=platformCompliances, diskVendor=diskVendor, platformFwVersionGroup=platformFwVersionGroup, cpuProcessorStatsEntry=cpuProcessorStatsEntry, platformMemoryStatsTable=platformMemoryStatsTable, diskModel=diskModel, cpuStepping=cpuStepping, f5PlatformStats=f5PlatformStats, configurable=configurable, platformDiskStatsTable=platformDiskStatsTable, cpuIndex=cpuIndex, platformTemperatureTable=platformTemperatureTable, fpgaIndex=fpgaIndex, platformFantrayTable=platformFantrayTable, cpuFreq=cpuFreq, diskName=diskName, fan_11_speed=fan_11_speed, coreTotal5minAvg=coreTotal5minAvg, diskInfoTable=diskInfoTable, diskReadMerged=diskReadMerged, diskUtilizationStatsTable=diskUtilizationStatsTable, PlatformStatsIndex=PlatformStatsIndex, platformFwTable=platformFwTable, tempMaximum=tempMaximum, temperatureStatsTable=temperatureStatsTable, fan_10_speed=fan_10_speed, tempCurrent=tempCurrent, temperatureStatsEntry=temperatureStatsEntry, coreTotal5secAvg=coreTotal5secAvg, fan_1_speed=fan_1_speed, fwName=fwName, platformCompliance=platformCompliance, diskType=diskType, memPlatformTotal=memPlatformTotal, cpuProcessorStatsTable=cpuProcessorStatsTable, platformCPUGroup=platformCPUGroup, fan_12_speed=fan_12_speed, cpuModelName=cpuModelName, diskReadBytes=diskReadBytes, diskVersion=diskVersion, fan_7_speed=fan_7_speed, cpuCurrent=cpuCurrent, fantrayStatsTable=fantrayStatsTable, cpuCoreCnt=cpuCoreCnt, fan_3_speed=fan_3_speed, fwVersion=fwVersion, fan_8_speed=fan_8_speed, fwTable=fwTable, cpuTotal5secAvg=cpuTotal5secAvg, diskWriteLatencyMs=diskWriteLatencyMs, platformCpuStatsTable=platformCpuStatsTable, fan_6_speed=fan_6_speed, diskWriteMerged=diskWriteMerged, cpuUtilizationStatsTable=cpuUtilizationStatsTable, memPercentageUsed=memPercentageUsed, index=index, diskWriteBytes=diskWriteBytes, coreTotal1minAvg=coreTotal1minAvg, diskWriteIops=diskWriteIops, platformFpgaGroup=platformFpgaGroup, fan_5_speed=fan_5_speed, diskSize=diskSize, cpuThreadCnt=cpuThreadCnt, diskReadIops=diskReadIops, fan_4_speed=fan_4_speed, cpuCoreStatsTable=cpuCoreStatsTable, PYSNMP_MODULE_ID=f5PlatformStats, diskInfoEntry=diskInfoEntry, fantrayStatsEntry=fantrayStatsEntry, diskReadLatencyMs=diskReadLatencyMs, String=String, platformDiskGroup=platformDiskGroup, cpuCore=cpuCore, cpuTotal5minAvg=cpuTotal5minAvg, memAvailable=memAvailable)
