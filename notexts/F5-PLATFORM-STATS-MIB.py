...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", cpuIndex=cpuIndex, cpuCoreStatsEntry=cpuCoreStatsEntry, diskWriteLatencyMs=diskWriteLatencyMs, platformFwTable=platformFwTable, cpuCoreCnt=cpuCoreCnt, diskReadLatencyMs=diskReadLatencyMs, fwName=fwName, cpuCoreStatsTable=cpuCoreStatsTable, diskWriteBytes=diskWriteBytes, fwTable=fwTable, platformCpuStatsTable=platformCpuStatsTable, diskModel=diskModel, diskName=diskName, platformTemperatureTable=platformTemperatureTable, platformFwVersionGroup=platformFwVersionGroup, temperatureStatsEntry=temperatureStatsEntry, platformDiskStatsTable=platformDiskStatsTable, fpgaTable=fpgaTable, memFree=memFree, fwUpdateStatus=fwUpdateStatus, memoryStatsEntry=memoryStatsEntry, fan_4_speed=fan_4_speed, cpuFreq=cpuFreq, platformFantrayGroup=platformFantrayGroup, platformTempGroup=platformTempGroup, tempMinimum=tempMinimum, fan_12_speed=fan_12_speed, platformCompliances=platformCompliances, String=String, cpuStepping=cpuStepping, f5PlatformStats=f5PlatformStats, cpuProcessorStatsEntry=cpuProcessorStatsEntry, tempMaximum=tempMaximum, memPlatformTotal=memPlatformTotal, diskUtilizationStatsEntry=diskUtilizationStatsEntry, diskWriteMerged=diskWriteMerged, coreTotal1minAvg=coreTotal1minAvg, fpgaVersion=fpgaVersion, platformCPUGroup=platformCPUGroup, PlatformStatsIndex=PlatformStatsIndex, coreIndex=coreIndex, cpuTotal5secAvg=cpuTotal5secAvg, fan_5_speed=fan_5_speed, memPercentageUsed=memPercentageUsed, platformMemGroup=platformMemGroup, coreTotal5minAvg=coreTotal5minAvg, temperatureStatsTable=temperatureStatsTable, diskVersion=diskVersion, diskSerialNo=diskSerialNo, fwEntry=fwEntry, fan_10_speed=fan_10_speed, diskTotalIops=diskTotalIops, diskReadIops=diskReadIops, cpuThreadCnt=cpuThreadCnt, cpuUtilizationStatsTable=cpuUtilizationStatsTable, cpuTotal1minAvg=cpuTotal1minAvg, diskReadBytes=diskReadBytes, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, diskPercentageUsed=diskPercentageUsed, tempCurrent=tempCurrent, f5PlatformStatsObjects=f5PlatformStatsObjects, cpuProcessorStatsTable=cpuProcessorStatsTable, diskType=diskType, cpuCacheSize=cpuCacheSize, memoryStatsTable=memoryStatsTable, fantrayStatsEntry=fantrayStatsEntry, fan_8_speed=fan_8_speed, platformFantrayTable=platformFantrayTable, memAvailable=memAvailable, fan_1_speed=fan_1_speed, fantrayStatsTable=fantrayStatsTable, fan_9_speed=fan_9_speed, cpuModelName=cpuModelName, diskUtilizationStatsTable=diskUtilizationStatsTable, fan_11_speed=fan_11_speed, diskInfoEntry=diskInfoEntry, fwVersion=fwVersion, diskReadMerged=diskReadMerged, diskInfoTable=diskInfoTable, fan_6_speed=fan_6_speed, index=index, memPlatformUsed=memPlatformUsed, diskSize=diskSize, platformCompliance=platformCompliance, diskWriteIops=diskWriteIops, cpuCurrent=cpuCurrent, platformFpgaGroup=platformFpgaGroup, platformFpgaTable=platformFpgaTable, fan_3_speed=fan_3_speed, platformDiskGroup=platformDiskGroup, platformConformance=platformConformance, coreName=coreName, cpuCore=cpuCore, platformMemoryStatsTable=platformMemoryStatsTable, fan_7_speed=fan_7_speed, PYSNMP_MODULE_ID=f5PlatformStats, cpuTotal5minAvg=cpuTotal5minAvg, configurable=configurable, tempAverage=tempAverage, diskVendor=diskVendor, fpgaEntry=fpgaEntry, platformGroups=platformGroups, coreTotal5secAvg=coreTotal5secAvg, fan_2_speed=fan_2_speed, fpgaIndex=fpgaIndex, coreCurrent=coreCurrent)
