...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", platformCpuStatsTable=platformCpuStatsTable, diskWriteBytes=diskWriteBytes, diskUtilizationStatsEntry=diskUtilizationStatsEntry, diskVersion=diskVersion, tempMaximum=tempMaximum, fantrayStatsEntry=fantrayStatsEntry, cpuCoreStatsEntry=cpuCoreStatsEntry, diskName=diskName, fan_1_speed=fan_1_speed, coreName=coreName, diskReadMerged=diskReadMerged, f5PlatformStats=f5PlatformStats, memoryStatsTable=memoryStatsTable, diskType=diskType, platformCompliance=platformCompliance, diskWriteMerged=diskWriteMerged, diskSize=diskSize, tempAverage=tempAverage, memPlatformUsed=memPlatformUsed, cpuUtilizationStatsTable=cpuUtilizationStatsTable, tempMinimum=tempMinimum, fan_7_speed=fan_7_speed, cpuTotal1minAvg=cpuTotal1minAvg, diskSerialNo=diskSerialNo, fan_12_speed=fan_12_speed, platformMemGroup=platformMemGroup, temperatureStatsTable=temperatureStatsTable, platformFantrayGroup=platformFantrayGroup, memPercentageUsed=memPercentageUsed, memoryStatsEntry=memoryStatsEntry, cpuProcessorStatsTable=cpuProcessorStatsTable, platformCompliances=platformCompliances, cpuCoreCnt=cpuCoreCnt, fpgaIndex=fpgaIndex, f5PlatformStatsObjects=f5PlatformStatsObjects, index=index, memAvailable=memAvailable, fwVersion=fwVersion, fwUpdateStatus=fwUpdateStatus, cpuCoreStatsTable=cpuCoreStatsTable, fantrayStatsTable=fantrayStatsTable, fan_10_speed=fan_10_speed, cpuModelName=cpuModelName, platformTempGroup=platformTempGroup, fan_9_speed=fan_9_speed, fpgaVersion=fpgaVersion, fwName=fwName, platformMemoryStatsTable=platformMemoryStatsTable, cpuProcessorStatsEntry=cpuProcessorStatsEntry, cpuIndex=cpuIndex, diskWriteIops=diskWriteIops, coreTotal5minAvg=coreTotal5minAvg, PYSNMP_MODULE_ID=f5PlatformStats, platformDiskStatsTable=platformDiskStatsTable, diskVendor=diskVendor, platformTemperatureTable=platformTemperatureTable, fpgaEntry=fpgaEntry, memFree=memFree, PlatformStatsIndex=PlatformStatsIndex, fan_4_speed=fan_4_speed, fan_11_speed=fan_11_speed, cpuTotal5minAvg=cpuTotal5minAvg, cpuFreq=cpuFreq, cpuCurrent=cpuCurrent, temperatureStatsEntry=temperatureStatsEntry, coreIndex=coreIndex, diskPercentageUsed=diskPercentageUsed, fwEntry=fwEntry, tempCurrent=tempCurrent, platformFwVersionGroup=platformFwVersionGroup, cpuCore=cpuCore, fan_6_speed=fan_6_speed, diskReadLatencyMs=diskReadLatencyMs, platformFpgaGroup=platformFpgaGroup, coreCurrent=coreCurrent, platformFpgaTable=platformFpgaTable, fan_5_speed=fan_5_speed, fpgaTable=fpgaTable, String=String, diskReadBytes=diskReadBytes, platformDiskGroup=platformDiskGroup, platformFantrayTable=platformFantrayTable, diskUtilizationStatsTable=diskUtilizationStatsTable, diskWriteLatencyMs=diskWriteLatencyMs, platformCPUGroup=platformCPUGroup, diskInfoEntry=diskInfoEntry, cpuTotal5secAvg=cpuTotal5secAvg, cpuThreadCnt=cpuThreadCnt, diskTotalIops=diskTotalIops, coreTotal5secAvg=coreTotal5secAvg, diskInfoTable=diskInfoTable, fwTable=fwTable, coreTotal1minAvg=coreTotal1minAvg, cpuStepping=cpuStepping, fan_2_speed=fan_2_speed, memPlatformTotal=memPlatformTotal, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, diskModel=diskModel, diskReadIops=diskReadIops, platformFwTable=platformFwTable, cpuCacheSize=cpuCacheSize, configurable=configurable, fan_8_speed=fan_8_speed, platformConformance=platformConformance, fan_3_speed=fan_3_speed, platformGroups=platformGroups)
