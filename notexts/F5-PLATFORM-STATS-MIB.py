...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", cpuCore=cpuCore, memAvailable=memAvailable, diskInfoTable=diskInfoTable, cpuFreq=cpuFreq, fan_8_speed=fan_8_speed, platformFantrayGroup=platformFantrayGroup, PlatformStatsIndex=PlatformStatsIndex, fantrayStatsTable=fantrayStatsTable, cpuTotal5minAvg=cpuTotal5minAvg, temperatureStatsEntry=temperatureStatsEntry, fan_6_speed=fan_6_speed, fan_11_speed=fan_11_speed, fan_9_speed=fan_9_speed, diskUtilizationStatsTable=diskUtilizationStatsTable, diskReadBytes=diskReadBytes, fwVersion=fwVersion, memoryStatsTable=memoryStatsTable, platformMemGroup=platformMemGroup, platformCompliance=platformCompliance, diskWriteMerged=diskWriteMerged, coreTotal1minAvg=coreTotal1minAvg, index=index, cpuTotal5secAvg=cpuTotal5secAvg, platformMemoryStatsTable=platformMemoryStatsTable, fpgaTable=fpgaTable, platformFwVersionGroup=platformFwVersionGroup, platformTempGroup=platformTempGroup, diskPercentageUsed=diskPercentageUsed, diskUtilizationStatsEntry=diskUtilizationStatsEntry, platformDiskGroup=platformDiskGroup, platformCpuStatsTable=platformCpuStatsTable, cpuCoreCnt=cpuCoreCnt, diskWriteLatencyMs=diskWriteLatencyMs, String=String, memoryStatsEntry=memoryStatsEntry, coreName=coreName, cpuCurrent=cpuCurrent, coreIndex=coreIndex, memPlatformUsed=memPlatformUsed, tempCurrent=tempCurrent, diskName=diskName, configurable=configurable, cpuUtilizationStatsTable=cpuUtilizationStatsTable, diskReadMerged=diskReadMerged, platformFantrayTable=platformFantrayTable, temperatureStatsTable=temperatureStatsTable, PYSNMP_MODULE_ID=f5PlatformStats, cpuModelName=cpuModelName, coreTotal5secAvg=coreTotal5secAvg, platformGroups=platformGroups, tempMinimum=tempMinimum, fpgaIndex=fpgaIndex, fan_2_speed=fan_2_speed, diskModel=diskModel, tempAverage=tempAverage, platformCPUGroup=platformCPUGroup, platformFpgaTable=platformFpgaTable, platformConformance=platformConformance, diskInfoEntry=diskInfoEntry, diskWriteIops=diskWriteIops, cpuIndex=cpuIndex, cpuProcessorStatsEntry=cpuProcessorStatsEntry, fwUpdateStatus=fwUpdateStatus, fantrayStatsEntry=fantrayStatsEntry, diskSize=diskSize, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, cpuTotal1minAvg=cpuTotal1minAvg, f5PlatformStatsObjects=f5PlatformStatsObjects, fpgaVersion=fpgaVersion, fwEntry=fwEntry, platformDiskStatsTable=platformDiskStatsTable, diskReadLatencyMs=diskReadLatencyMs, coreCurrent=coreCurrent, platformFwTable=platformFwTable, diskType=diskType, diskWriteBytes=diskWriteBytes, cpuCoreStatsTable=cpuCoreStatsTable, cpuCoreStatsEntry=cpuCoreStatsEntry, memPercentageUsed=memPercentageUsed, fan_7_speed=fan_7_speed, memFree=memFree, diskVendor=diskVendor, fpgaEntry=fpgaEntry, platformTemperatureTable=platformTemperatureTable, diskTotalIops=diskTotalIops, fan_10_speed=fan_10_speed, fan_4_speed=fan_4_speed, fwName=fwName, diskReadIops=diskReadIops, fan_3_speed=fan_3_speed, platformFpgaGroup=platformFpgaGroup, fan_12_speed=fan_12_speed, cpuCacheSize=cpuCacheSize, fan_1_speed=fan_1_speed, cpuProcessorStatsTable=cpuProcessorStatsTable, coreTotal5minAvg=coreTotal5minAvg, diskVersion=diskVersion, cpuThreadCnt=cpuThreadCnt, diskSerialNo=diskSerialNo, platformCompliances=platformCompliances, memPlatformTotal=memPlatformTotal, tempMaximum=tempMaximum, cpuStepping=cpuStepping, fan_5_speed=fan_5_speed, f5PlatformStats=f5PlatformStats, fwTable=fwTable)
