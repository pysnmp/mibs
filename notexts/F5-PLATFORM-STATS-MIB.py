...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", fan_11_speed=fan_11_speed, platformTempGroup=platformTempGroup, tempCurrent=tempCurrent, platformMemGroup=platformMemGroup, fpgaVersion=fpgaVersion, index=index, diskUtilizationStatsEntry=diskUtilizationStatsEntry, cpuCoreCnt=cpuCoreCnt, diskInfoEntry=diskInfoEntry, platformFantrayGroup=platformFantrayGroup, platformConformance=platformConformance, diskWriteMerged=diskWriteMerged, PYSNMP_MODULE_ID=f5PlatformStats, diskReadMerged=diskReadMerged, platformFwTable=platformFwTable, memoryStatsEntry=memoryStatsEntry, platformFantrayTable=platformFantrayTable, memPercentageUsed=memPercentageUsed, diskName=diskName, fan_12_speed=fan_12_speed, fantrayStatsTable=fantrayStatsTable, platformDiskGroup=platformDiskGroup, diskSize=diskSize, memPlatformTotal=memPlatformTotal, diskTotalIops=diskTotalIops, fan_2_speed=fan_2_speed, platformCompliance=platformCompliance, diskWriteBytes=diskWriteBytes, fwEntry=fwEntry, cpuFreq=cpuFreq, diskModel=diskModel, memFree=memFree, coreName=coreName, fpgaEntry=fpgaEntry, fan_3_speed=fan_3_speed, cpuTotal5minAvg=cpuTotal5minAvg, fwVersion=fwVersion, cpuProcessorStatsTable=cpuProcessorStatsTable, temperatureStatsTable=temperatureStatsTable, platformFwVersionGroup=platformFwVersionGroup, platformCpuStatsTable=platformCpuStatsTable, cpuCoreStatsEntry=cpuCoreStatsEntry, coreTotal1minAvg=coreTotal1minAvg, diskInfoTable=diskInfoTable, fan_7_speed=fan_7_speed, fan_10_speed=fan_10_speed, fan_5_speed=fan_5_speed, cpuCurrent=cpuCurrent, fwName=fwName, platformFpgaGroup=platformFpgaGroup, platformCPUGroup=platformCPUGroup, String=String, cpuTotal1minAvg=cpuTotal1minAvg, memoryStatsTable=memoryStatsTable, fwUpdateStatus=fwUpdateStatus, fan_1_speed=fan_1_speed, diskType=diskType, diskReadLatencyMs=diskReadLatencyMs, tempMinimum=tempMinimum, diskUtilizationStatsTable=diskUtilizationStatsTable, fantrayStatsEntry=fantrayStatsEntry, cpuThreadCnt=cpuThreadCnt, fpgaTable=fpgaTable, PlatformStatsIndex=PlatformStatsIndex, platformCompliances=platformCompliances, tempMaximum=tempMaximum, diskReadIops=diskReadIops, diskWriteLatencyMs=diskWriteLatencyMs, fan_6_speed=fan_6_speed, coreTotal5secAvg=coreTotal5secAvg, cpuCacheSize=cpuCacheSize, platformGroups=platformGroups, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, f5PlatformStats=f5PlatformStats, platformDiskStatsTable=platformDiskStatsTable, diskReadBytes=diskReadBytes, fan_8_speed=fan_8_speed, cpuProcessorStatsEntry=cpuProcessorStatsEntry, coreCurrent=coreCurrent, cpuUtilizationStatsTable=cpuUtilizationStatsTable, coreTotal5minAvg=coreTotal5minAvg, diskWriteIops=diskWriteIops, fpgaIndex=fpgaIndex, fan_4_speed=fan_4_speed, memAvailable=memAvailable, cpuCore=cpuCore, cpuCoreStatsTable=cpuCoreStatsTable, coreIndex=coreIndex, platformMemoryStatsTable=platformMemoryStatsTable, fan_9_speed=fan_9_speed, configurable=configurable, tempAverage=tempAverage, cpuStepping=cpuStepping, temperatureStatsEntry=temperatureStatsEntry, cpuIndex=cpuIndex, diskSerialNo=diskSerialNo, f5PlatformStatsObjects=f5PlatformStatsObjects, fwTable=fwTable, platformTemperatureTable=platformTemperatureTable, diskVersion=diskVersion, cpuModelName=cpuModelName, diskVendor=diskVendor, cpuTotal5secAvg=cpuTotal5secAvg, memPlatformUsed=memPlatformUsed, platformFpgaTable=platformFpgaTable, diskPercentageUsed=diskPercentageUsed)
