...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", diskReadLatencyMs=diskReadLatencyMs, diskModel=diskModel, String=String, fan_5_speed=fan_5_speed, tempCurrent=tempCurrent, diskWriteBytes=diskWriteBytes, platformCPUGroup=platformCPUGroup, memPlatformTotal=memPlatformTotal, memoryStatsTable=memoryStatsTable, fpgaIndex=fpgaIndex, diskSerialNo=diskSerialNo, diskInfoEntry=diskInfoEntry, diskName=diskName, fan_7_speed=fan_7_speed, platformDiskStatsTable=platformDiskStatsTable, coreName=coreName, platformMemGroup=platformMemGroup, coreCurrent=coreCurrent, diskType=diskType, cpuTotal5minAvg=cpuTotal5minAvg, fwEntry=fwEntry, platformCpuStatsTable=platformCpuStatsTable, fpgaEntry=fpgaEntry, fpgaTable=fpgaTable, platformFwVersionGroup=platformFwVersionGroup, fan_8_speed=fan_8_speed, memoryStatsEntry=memoryStatsEntry, f5PlatformStatsObjects=f5PlatformStatsObjects, memPercentageUsed=memPercentageUsed, cpuThreadCnt=cpuThreadCnt, cpuCurrent=cpuCurrent, diskWriteIops=diskWriteIops, diskReadIops=diskReadIops, cpuTotal5secAvg=cpuTotal5secAvg, diskUtilizationStatsTable=diskUtilizationStatsTable, diskReadBytes=diskReadBytes, platformFpgaGroup=platformFpgaGroup, coreTotal5minAvg=coreTotal5minAvg, PlatformStatsIndex=PlatformStatsIndex, fpgaVersion=fpgaVersion, fwVersion=fwVersion, fan_11_speed=fan_11_speed, platformTemperatureTable=platformTemperatureTable, PYSNMP_MODULE_ID=f5PlatformStats, cpuCoreStatsTable=cpuCoreStatsTable, fan_1_speed=fan_1_speed, index=index, memFree=memFree, fan_4_speed=fan_4_speed, configurable=configurable, fan_3_speed=fan_3_speed, fwUpdateStatus=fwUpdateStatus, cpuCacheSize=cpuCacheSize, coreTotal1minAvg=coreTotal1minAvg, fwTable=fwTable, fan_10_speed=fan_10_speed, platformFwTable=platformFwTable, cpuProcessorStatsTable=cpuProcessorStatsTable, fantrayStatsTable=fantrayStatsTable, fan_2_speed=fan_2_speed, memAvailable=memAvailable, diskVendor=diskVendor, diskTotalIops=diskTotalIops, coreIndex=coreIndex, tempMaximum=tempMaximum, memPlatformUsed=memPlatformUsed, fan_9_speed=fan_9_speed, platformConformance=platformConformance, platformFantrayTable=platformFantrayTable, diskPercentageUsed=diskPercentageUsed, cpuTotal1minAvg=cpuTotal1minAvg, platformCompliance=platformCompliance, tempMinimum=tempMinimum, fan_6_speed=fan_6_speed, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, diskInfoTable=diskInfoTable, cpuUtilizationStatsTable=cpuUtilizationStatsTable, cpuStepping=cpuStepping, temperatureStatsEntry=temperatureStatsEntry, platformFpgaTable=platformFpgaTable, platformFantrayGroup=platformFantrayGroup, diskUtilizationStatsEntry=diskUtilizationStatsEntry, diskSize=diskSize, cpuCoreCnt=cpuCoreCnt, temperatureStatsTable=temperatureStatsTable, diskReadMerged=diskReadMerged, platformDiskGroup=platformDiskGroup, platformGroups=platformGroups, diskWriteLatencyMs=diskWriteLatencyMs, cpuModelName=cpuModelName, diskVersion=diskVersion, tempAverage=tempAverage, fantrayStatsEntry=fantrayStatsEntry, cpuFreq=cpuFreq, coreTotal5secAvg=coreTotal5secAvg, cpuCoreStatsEntry=cpuCoreStatsEntry, fan_12_speed=fan_12_speed, cpuCore=cpuCore, platformTempGroup=platformTempGroup, cpuProcessorStatsEntry=cpuProcessorStatsEntry, diskWriteMerged=diskWriteMerged, platformMemoryStatsTable=platformMemoryStatsTable, platformCompliances=platformCompliances, fwName=fwName, cpuIndex=cpuIndex, f5PlatformStats=f5PlatformStats)
