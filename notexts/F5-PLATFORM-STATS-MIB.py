...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", tempCurrent=tempCurrent, platformConformance=platformConformance, fan_4_speed=fan_4_speed, cpuCore=cpuCore, platformFantrayGroup=platformFantrayGroup, fwUpdateStatus=fwUpdateStatus, cpuThreadCnt=cpuThreadCnt, diskName=diskName, cpuIndex=cpuIndex, platformFwVersionGroup=platformFwVersionGroup, platformCPUGroup=platformCPUGroup, cpuCoreStatsEntry=cpuCoreStatsEntry, diskReadMerged=diskReadMerged, coreTotal1minAvg=coreTotal1minAvg, cpuCurrent=cpuCurrent, platformMemoryStatsTable=platformMemoryStatsTable, diskTotalIops=diskTotalIops, memAvailable=memAvailable, memFree=memFree, platformGroups=platformGroups, configurable=configurable, fan_1_speed=fan_1_speed, fantrayStatsTable=fantrayStatsTable, platformFpgaGroup=platformFpgaGroup, diskModel=diskModel, platformFpgaTable=platformFpgaTable, platformCpuStatsTable=platformCpuStatsTable, fpgaEntry=fpgaEntry, diskInfoEntry=diskInfoEntry, fan_10_speed=fan_10_speed, diskReadBytes=diskReadBytes, temperatureStatsEntry=temperatureStatsEntry, cpuUtilizationStatsTable=cpuUtilizationStatsTable, cpuTotal5secAvg=cpuTotal5secAvg, cpuCoreCnt=cpuCoreCnt, fan_3_speed=fan_3_speed, platformCompliances=platformCompliances, coreTotal5minAvg=coreTotal5minAvg, cpuStepping=cpuStepping, f5PlatformStats=f5PlatformStats, platformFantrayTable=platformFantrayTable, diskSerialNo=diskSerialNo, diskVersion=diskVersion, diskInfoTable=diskInfoTable, fwName=fwName, diskWriteBytes=diskWriteBytes, coreIndex=coreIndex, platformTempGroup=platformTempGroup, memoryStatsTable=memoryStatsTable, cpuProcessorStatsTable=cpuProcessorStatsTable, coreTotal5secAvg=coreTotal5secAvg, fan_8_speed=fan_8_speed, cpuFreq=cpuFreq, index=index, platformCompliance=platformCompliance, fan_2_speed=fan_2_speed, fan_9_speed=fan_9_speed, fan_12_speed=fan_12_speed, fan_5_speed=fan_5_speed, diskWriteLatencyMs=diskWriteLatencyMs, memPlatformUsed=memPlatformUsed, f5PlatformStatsObjects=f5PlatformStatsObjects, platformTemperatureTable=platformTemperatureTable, coreName=coreName, platformDiskGroup=platformDiskGroup, platformMemGroup=platformMemGroup, cpuProcessorStatsEntry=cpuProcessorStatsEntry, fpgaIndex=fpgaIndex, fan_6_speed=fan_6_speed, fan_11_speed=fan_11_speed, fpgaVersion=fpgaVersion, memoryStatsEntry=memoryStatsEntry, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, diskSize=diskSize, diskUtilizationStatsTable=diskUtilizationStatsTable, memPlatformTotal=memPlatformTotal, diskReadLatencyMs=diskReadLatencyMs, tempAverage=tempAverage, memPercentageUsed=memPercentageUsed, cpuTotal5minAvg=cpuTotal5minAvg, cpuCacheSize=cpuCacheSize, PYSNMP_MODULE_ID=f5PlatformStats, diskVendor=diskVendor, PlatformStatsIndex=PlatformStatsIndex, diskType=diskType, diskWriteIops=diskWriteIops, cpuTotal1minAvg=cpuTotal1minAvg, String=String, fwVersion=fwVersion, tempMinimum=tempMinimum, cpuCoreStatsTable=cpuCoreStatsTable, platformFwTable=platformFwTable, diskUtilizationStatsEntry=diskUtilizationStatsEntry, fantrayStatsEntry=fantrayStatsEntry, fan_7_speed=fan_7_speed, platformDiskStatsTable=platformDiskStatsTable, tempMaximum=tempMaximum, fpgaTable=fpgaTable, fwTable=fwTable, diskReadIops=diskReadIops, fwEntry=fwEntry, cpuModelName=cpuModelName, diskWriteMerged=diskWriteMerged, diskPercentageUsed=diskPercentageUsed, temperatureStatsTable=temperatureStatsTable, coreCurrent=coreCurrent)
