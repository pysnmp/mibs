...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", diskSerialNo=diskSerialNo, memPlatformUsed=memPlatformUsed, coreName=coreName, f5PlatformStats=f5PlatformStats, fpgaIndex=fpgaIndex, tempCurrent=tempCurrent, diskPercentageUsed=diskPercentageUsed, f5PlatformStatsObjects=f5PlatformStatsObjects, cpuTotal1minAvg=cpuTotal1minAvg, platformTemperatureTable=platformTemperatureTable, fan_12_speed=fan_12_speed, platformFantrayTable=platformFantrayTable, cpuCore=cpuCore, cpuProcessorStatsEntry=cpuProcessorStatsEntry, diskReadLatencyMs=diskReadLatencyMs, diskTotalIops=diskTotalIops, diskWriteLatencyMs=diskWriteLatencyMs, cpuCoreStatsEntry=cpuCoreStatsEntry, fan_5_speed=fan_5_speed, coreTotal5minAvg=coreTotal5minAvg, platformMemoryStatsTable=platformMemoryStatsTable, platformCPUGroup=platformCPUGroup, index=index, diskUtilizationStatsEntry=diskUtilizationStatsEntry, fantrayStatsEntry=fantrayStatsEntry, tempMaximum=tempMaximum, platformCompliance=platformCompliance, fan_11_speed=fan_11_speed, tempAverage=tempAverage, cpuThreadCnt=cpuThreadCnt, temperatureStatsEntry=temperatureStatsEntry, diskInfoTable=diskInfoTable, diskWriteIops=diskWriteIops, diskModel=diskModel, fan_6_speed=fan_6_speed, platformFwVersionGroup=platformFwVersionGroup, diskWriteBytes=diskWriteBytes, PYSNMP_MODULE_ID=f5PlatformStats, coreCurrent=coreCurrent, fan_1_speed=fan_1_speed, cpuTotal5minAvg=cpuTotal5minAvg, memoryStatsTable=memoryStatsTable, cpuProcessorStatsTable=cpuProcessorStatsTable, cpuFreq=cpuFreq, memoryStatsEntry=memoryStatsEntry, cpuStepping=cpuStepping, fpgaVersion=fpgaVersion, platformCompliances=platformCompliances, memPlatformTotal=memPlatformTotal, platformFwTable=platformFwTable, platformCpuStatsTable=platformCpuStatsTable, fan_9_speed=fan_9_speed, platformFpgaGroup=platformFpgaGroup, diskVersion=diskVersion, cpuCoreStatsTable=cpuCoreStatsTable, diskReadBytes=diskReadBytes, fwName=fwName, platformDiskGroup=platformDiskGroup, memFree=memFree, cpuTotal5secAvg=cpuTotal5secAvg, diskInfoEntry=diskInfoEntry, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, diskType=diskType, platformFantrayGroup=platformFantrayGroup, platformTempGroup=platformTempGroup, cpuUtilizationStatsTable=cpuUtilizationStatsTable, diskSize=diskSize, diskReadIops=diskReadIops, coreIndex=coreIndex, cpuCurrent=cpuCurrent, diskName=diskName, cpuCoreCnt=cpuCoreCnt, cpuCacheSize=cpuCacheSize, cpuIndex=cpuIndex, temperatureStatsTable=temperatureStatsTable, PlatformStatsIndex=PlatformStatsIndex, platformDiskStatsTable=platformDiskStatsTable, fwTable=fwTable, diskWriteMerged=diskWriteMerged, coreTotal5secAvg=coreTotal5secAvg, fan_7_speed=fan_7_speed, platformConformance=platformConformance, platformFpgaTable=platformFpgaTable, fpgaEntry=fpgaEntry, fpgaTable=fpgaTable, platformGroups=platformGroups, fan_8_speed=fan_8_speed, coreTotal1minAvg=coreTotal1minAvg, fwUpdateStatus=fwUpdateStatus, fantrayStatsTable=fantrayStatsTable, tempMinimum=tempMinimum, diskReadMerged=diskReadMerged, fan_10_speed=fan_10_speed, String=String, diskVendor=diskVendor, memPercentageUsed=memPercentageUsed, configurable=configurable, fwEntry=fwEntry, fwVersion=fwVersion, cpuModelName=cpuModelName, fan_3_speed=fan_3_speed, fan_4_speed=fan_4_speed, platformMemGroup=platformMemGroup, memAvailable=memAvailable, fan_2_speed=fan_2_speed, diskUtilizationStatsTable=diskUtilizationStatsTable)
