...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", cpuStepping=cpuStepping, diskInfoEntry=diskInfoEntry, diskSize=diskSize, memFree=memFree, diskVendor=diskVendor, fan_12_speed=fan_12_speed, fwTable=fwTable, platformCompliances=platformCompliances, fpgaTable=fpgaTable, diskSerialNo=diskSerialNo, diskModel=diskModel, diskUtilizationStatsTable=diskUtilizationStatsTable, fwEntry=fwEntry, diskReadMerged=diskReadMerged, coreName=coreName, memPlatformTotal=memPlatformTotal, diskTotalIops=diskTotalIops, fan_2_speed=fan_2_speed, diskWriteLatencyMs=diskWriteLatencyMs, diskInfoTable=diskInfoTable, fan_8_speed=fan_8_speed, diskType=diskType, fantrayStatsEntry=fantrayStatsEntry, fan_5_speed=fan_5_speed, platformGroups=platformGroups, cpuProcessorStatsTable=cpuProcessorStatsTable, platformFantrayTable=platformFantrayTable, fwName=fwName, memAvailable=memAvailable, diskPercentageUsed=diskPercentageUsed, fpgaVersion=fpgaVersion, fan_4_speed=fan_4_speed, fantrayStatsTable=fantrayStatsTable, fan_11_speed=fan_11_speed, platformFpgaGroup=platformFpgaGroup, cpuTotal5secAvg=cpuTotal5secAvg, diskWriteBytes=diskWriteBytes, diskReadBytes=diskReadBytes, PYSNMP_MODULE_ID=f5PlatformStats, cpuCore=cpuCore, temperatureStatsTable=temperatureStatsTable, cpuCoreCnt=cpuCoreCnt, fwVersion=fwVersion, tempMaximum=tempMaximum, fan_1_speed=fan_1_speed, diskVersion=diskVersion, cpuThreadCnt=cpuThreadCnt, diskUtilizationStatsEntry=diskUtilizationStatsEntry, coreTotal1minAvg=coreTotal1minAvg, cpuCoreStatsTable=cpuCoreStatsTable, platformCompliance=platformCompliance, memPlatformUsed=memPlatformUsed, fpgaIndex=fpgaIndex, platformCpuStatsTable=platformCpuStatsTable, cpuProcessorStatsEntry=cpuProcessorStatsEntry, diskWriteIops=diskWriteIops, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, cpuUtilizationStatsTable=cpuUtilizationStatsTable, cpuTotal1minAvg=cpuTotal1minAvg, configurable=configurable, coreTotal5minAvg=coreTotal5minAvg, coreIndex=coreIndex, platformFwTable=platformFwTable, platformMemGroup=platformMemGroup, platformTemperatureTable=platformTemperatureTable, cpuCoreStatsEntry=cpuCoreStatsEntry, platformDiskStatsTable=platformDiskStatsTable, index=index, memPercentageUsed=memPercentageUsed, f5PlatformStats=f5PlatformStats, platformFpgaTable=platformFpgaTable, cpuIndex=cpuIndex, diskName=diskName, platformTempGroup=platformTempGroup, diskReadLatencyMs=diskReadLatencyMs, platformFantrayGroup=platformFantrayGroup, cpuCurrent=cpuCurrent, cpuFreq=cpuFreq, coreTotal5secAvg=coreTotal5secAvg, cpuCacheSize=cpuCacheSize, fan_7_speed=fan_7_speed, memoryStatsEntry=memoryStatsEntry, fan_3_speed=fan_3_speed, String=String, tempMinimum=tempMinimum, fan_6_speed=fan_6_speed, cpuTotal5minAvg=cpuTotal5minAvg, cpuModelName=cpuModelName, fpgaEntry=fpgaEntry, platformFwVersionGroup=platformFwVersionGroup, fwUpdateStatus=fwUpdateStatus, temperatureStatsEntry=temperatureStatsEntry, platformCPUGroup=platformCPUGroup, coreCurrent=coreCurrent, platformDiskGroup=platformDiskGroup, f5PlatformStatsObjects=f5PlatformStatsObjects, diskWriteMerged=diskWriteMerged, PlatformStatsIndex=PlatformStatsIndex, tempCurrent=tempCurrent, tempAverage=tempAverage, fan_10_speed=fan_10_speed, memoryStatsTable=memoryStatsTable, platformMemoryStatsTable=platformMemoryStatsTable, fan_9_speed=fan_9_speed, diskReadIops=diskReadIops, platformConformance=platformConformance)
