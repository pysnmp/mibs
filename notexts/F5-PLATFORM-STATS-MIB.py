...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", tempAverage=tempAverage, fan_12_speed=fan_12_speed, diskReadIops=diskReadIops, memoryStatsEntry=memoryStatsEntry, platformDiskGroup=platformDiskGroup, platformGroups=platformGroups, index=index, diskTotalIops=diskTotalIops, platformMemGroup=platformMemGroup, platformFwVersionGroup=platformFwVersionGroup, diskSerialNo=diskSerialNo, diskUtilizationStatsEntry=diskUtilizationStatsEntry, fan_9_speed=fan_9_speed, cpuTotal1minAvg=cpuTotal1minAvg, fwVersion=fwVersion, cpuStepping=cpuStepping, diskType=diskType, memPlatformTotal=memPlatformTotal, memPlatformUsed=memPlatformUsed, PYSNMP_MODULE_ID=f5PlatformStats, PlatformStatsIndex=PlatformStatsIndex, cpuCacheSize=cpuCacheSize, platformCPUGroup=platformCPUGroup, platformTemperatureTable=platformTemperatureTable, temperatureStatsTable=temperatureStatsTable, diskWriteBytes=diskWriteBytes, fan_11_speed=fan_11_speed, platformFantrayGroup=platformFantrayGroup, diskVendor=diskVendor, coreTotal5minAvg=coreTotal5minAvg, cpuThreadCnt=cpuThreadCnt, cpuCore=cpuCore, diskWriteLatencyMs=diskWriteLatencyMs, fwUpdateStatus=fwUpdateStatus, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, fan_1_speed=fan_1_speed, cpuTotal5secAvg=cpuTotal5secAvg, coreName=coreName, fan_5_speed=fan_5_speed, cpuCoreCnt=cpuCoreCnt, diskVersion=diskVersion, configurable=configurable, fpgaTable=fpgaTable, cpuFreq=cpuFreq, fwEntry=fwEntry, diskReadBytes=diskReadBytes, coreIndex=coreIndex, coreTotal5secAvg=coreTotal5secAvg, coreCurrent=coreCurrent, fan_7_speed=fan_7_speed, fwTable=fwTable, platformTempGroup=platformTempGroup, memoryStatsTable=memoryStatsTable, platformFantrayTable=platformFantrayTable, platformMemoryStatsTable=platformMemoryStatsTable, memFree=memFree, platformCpuStatsTable=platformCpuStatsTable, coreTotal1minAvg=coreTotal1minAvg, String=String, cpuIndex=cpuIndex, diskInfoTable=diskInfoTable, fantrayStatsTable=fantrayStatsTable, platformCompliance=platformCompliance, platformDiskStatsTable=platformDiskStatsTable, fpgaIndex=fpgaIndex, platformCompliances=platformCompliances, platformConformance=platformConformance, fan_10_speed=fan_10_speed, platformFpgaGroup=platformFpgaGroup, diskReadMerged=diskReadMerged, platformFwTable=platformFwTable, tempCurrent=tempCurrent, f5PlatformStats=f5PlatformStats, fan_4_speed=fan_4_speed, fpgaEntry=fpgaEntry, fpgaVersion=fpgaVersion, diskModel=diskModel, fan_8_speed=fan_8_speed, fwName=fwName, diskInfoEntry=diskInfoEntry, tempMinimum=tempMinimum, tempMaximum=tempMaximum, diskWriteIops=diskWriteIops, fan_3_speed=fan_3_speed, diskWriteMerged=diskWriteMerged, diskName=diskName, memAvailable=memAvailable, fantrayStatsEntry=fantrayStatsEntry, memPercentageUsed=memPercentageUsed, temperatureStatsEntry=temperatureStatsEntry, f5PlatformStatsObjects=f5PlatformStatsObjects, diskUtilizationStatsTable=diskUtilizationStatsTable, cpuProcessorStatsTable=cpuProcessorStatsTable, diskReadLatencyMs=diskReadLatencyMs, cpuModelName=cpuModelName, cpuTotal5minAvg=cpuTotal5minAvg, cpuCurrent=cpuCurrent, cpuProcessorStatsEntry=cpuProcessorStatsEntry, cpuCoreStatsEntry=cpuCoreStatsEntry, diskPercentageUsed=diskPercentageUsed, cpuCoreStatsTable=cpuCoreStatsTable, cpuUtilizationStatsTable=cpuUtilizationStatsTable, platformFpgaTable=platformFpgaTable, fan_2_speed=fan_2_speed, diskSize=diskSize, fan_6_speed=fan_6_speed)
