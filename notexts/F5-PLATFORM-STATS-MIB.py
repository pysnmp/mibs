...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", fantrayStatsEntry=fantrayStatsEntry, cpuTotal5secAvg=cpuTotal5secAvg, memFree=memFree, platformMemGroup=platformMemGroup, platformTempGroup=platformTempGroup, diskWriteLatencyMs=diskWriteLatencyMs, platformFantrayGroup=platformFantrayGroup, platformFpgaTable=platformFpgaTable, diskVendor=diskVendor, memPlatformUsed=memPlatformUsed, coreIndex=coreIndex, fwTable=fwTable, memPlatformTotal=memPlatformTotal, diskWriteMerged=diskWriteMerged, diskWriteIops=diskWriteIops, fantrayStatsTable=fantrayStatsTable, diskName=diskName, cpuProcessorStatsTable=cpuProcessorStatsTable, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, f5PlatformStatsObjects=f5PlatformStatsObjects, fan_12_speed=fan_12_speed, fpgaTable=fpgaTable, cpuModelName=cpuModelName, diskType=diskType, fan_4_speed=fan_4_speed, cpuCore=cpuCore, diskInfoEntry=diskInfoEntry, diskInfoTable=diskInfoTable, diskWriteBytes=diskWriteBytes, tempMinimum=tempMinimum, memAvailable=memAvailable, memoryStatsTable=memoryStatsTable, coreCurrent=coreCurrent, diskModel=diskModel, platformConformance=platformConformance, platformFpgaGroup=platformFpgaGroup, temperatureStatsTable=temperatureStatsTable, diskSize=diskSize, cpuIndex=cpuIndex, fan_7_speed=fan_7_speed, cpuProcessorStatsEntry=cpuProcessorStatsEntry, platformFwVersionGroup=platformFwVersionGroup, diskTotalIops=diskTotalIops, platformFantrayTable=platformFantrayTable, tempAverage=tempAverage, coreTotal5minAvg=coreTotal5minAvg, fpgaIndex=fpgaIndex, diskVersion=diskVersion, platformFwTable=platformFwTable, f5PlatformStats=f5PlatformStats, platformTemperatureTable=platformTemperatureTable, cpuTotal5minAvg=cpuTotal5minAvg, coreName=coreName, tempMaximum=tempMaximum, fwName=fwName, diskReadBytes=diskReadBytes, temperatureStatsEntry=temperatureStatsEntry, fwVersion=fwVersion, String=String, platformDiskStatsTable=platformDiskStatsTable, cpuFreq=cpuFreq, fan_1_speed=fan_1_speed, fpgaVersion=fpgaVersion, fan_6_speed=fan_6_speed, fan_2_speed=fan_2_speed, diskReadMerged=diskReadMerged, cpuCoreStatsEntry=cpuCoreStatsEntry, memPercentageUsed=memPercentageUsed, platformCPUGroup=platformCPUGroup, diskUtilizationStatsEntry=diskUtilizationStatsEntry, platformGroups=platformGroups, diskReadIops=diskReadIops, diskReadLatencyMs=diskReadLatencyMs, fwEntry=fwEntry, platformCompliance=platformCompliance, fwUpdateStatus=fwUpdateStatus, fan_5_speed=fan_5_speed, index=index, cpuCacheSize=cpuCacheSize, platformMemoryStatsTable=platformMemoryStatsTable, fan_3_speed=fan_3_speed, fan_8_speed=fan_8_speed, coreTotal1minAvg=coreTotal1minAvg, cpuCurrent=cpuCurrent, fpgaEntry=fpgaEntry, coreTotal5secAvg=coreTotal5secAvg, fan_11_speed=fan_11_speed, tempCurrent=tempCurrent, cpuTotal1minAvg=cpuTotal1minAvg, platformCompliances=platformCompliances, fan_10_speed=fan_10_speed, cpuUtilizationStatsTable=cpuUtilizationStatsTable, PlatformStatsIndex=PlatformStatsIndex, platformCpuStatsTable=platformCpuStatsTable, cpuStepping=cpuStepping, configurable=configurable, platformDiskGroup=platformDiskGroup, cpuCoreCnt=cpuCoreCnt, fan_9_speed=fan_9_speed, diskPercentageUsed=diskPercentageUsed, cpuCoreStatsTable=cpuCoreStatsTable, diskSerialNo=diskSerialNo, PYSNMP_MODULE_ID=f5PlatformStats, cpuThreadCnt=cpuThreadCnt, memoryStatsEntry=memoryStatsEntry, diskUtilizationStatsTable=diskUtilizationStatsTable)
