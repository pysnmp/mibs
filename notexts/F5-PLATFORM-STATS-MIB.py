...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", memFree=memFree, coreIndex=coreIndex, diskSerialNo=diskSerialNo, platformCompliances=platformCompliances, diskUtilizationStatsTable=diskUtilizationStatsTable, memoryStatsEntry=memoryStatsEntry, platformCompliance=platformCompliance, fantrayStatsTable=fantrayStatsTable, diskModel=diskModel, platformDiskStatsTable=platformDiskStatsTable, cpuStepping=cpuStepping, fan_2_speed=fan_2_speed, diskReadBytes=diskReadBytes, diskWriteIops=diskWriteIops, fpgaTable=fpgaTable, fan_3_speed=fan_3_speed, fwTable=fwTable, diskWriteLatencyMs=diskWriteLatencyMs, fan_9_speed=fan_9_speed, cpuCacheSize=cpuCacheSize, cpuCurrent=cpuCurrent, coreName=coreName, temperatureStatsTable=temperatureStatsTable, cpuFreq=cpuFreq, fan_4_speed=fan_4_speed, cpuTotal5minAvg=cpuTotal5minAvg, cpuIndex=cpuIndex, f5PlatformStats=f5PlatformStats, cpuProcessorStatsEntry=cpuProcessorStatsEntry, diskInfoTable=diskInfoTable, diskName=diskName, fan_8_speed=fan_8_speed, coreTotal5minAvg=coreTotal5minAvg, memPlatformTotal=memPlatformTotal, diskWriteBytes=diskWriteBytes, PYSNMP_MODULE_ID=f5PlatformStats, diskReadLatencyMs=diskReadLatencyMs, fpgaEntry=fpgaEntry, fan_5_speed=fan_5_speed, platformFpgaGroup=platformFpgaGroup, diskReadIops=diskReadIops, platformFpgaTable=platformFpgaTable, configurable=configurable, platformFwTable=platformFwTable, memAvailable=memAvailable, diskReadMerged=diskReadMerged, fan_6_speed=fan_6_speed, fan_10_speed=fan_10_speed, platformMemoryStatsTable=platformMemoryStatsTable, fpgaVersion=fpgaVersion, tempAverage=tempAverage, platformMemGroup=platformMemGroup, fpgaIndex=fpgaIndex, f5PlatformStatsObjects=f5PlatformStatsObjects, cpuModelName=cpuModelName, cpuUtilizationStatsTable=cpuUtilizationStatsTable, platformFwVersionGroup=platformFwVersionGroup, coreCurrent=coreCurrent, fwEntry=fwEntry, fantrayStatsEntry=fantrayStatsEntry, coreTotal5secAvg=coreTotal5secAvg, PlatformStatsIndex=PlatformStatsIndex, coreTotal1minAvg=coreTotal1minAvg, memoryStatsTable=memoryStatsTable, tempCurrent=tempCurrent, temperatureStatsEntry=temperatureStatsEntry, fan_1_speed=fan_1_speed, cpuCoreCnt=cpuCoreCnt, diskInfoEntry=diskInfoEntry, platformCPUGroup=platformCPUGroup, memPlatformUsed=memPlatformUsed, cpuTotal5secAvg=cpuTotal5secAvg, platformTempGroup=platformTempGroup, cpuTotal1minAvg=cpuTotal1minAvg, platformFantrayTable=platformFantrayTable, cpuProcessorStatsTable=cpuProcessorStatsTable, tempMinimum=tempMinimum, cpuCoreStatsTable=cpuCoreStatsTable, cpuThreadCnt=cpuThreadCnt, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, platformTemperatureTable=platformTemperatureTable, diskWriteMerged=diskWriteMerged, cpuCore=cpuCore, platformFantrayGroup=platformFantrayGroup, fwVersion=fwVersion, cpuCoreStatsEntry=cpuCoreStatsEntry, platformGroups=platformGroups, index=index, platformDiskGroup=platformDiskGroup, tempMaximum=tempMaximum, memPercentageUsed=memPercentageUsed, diskSize=diskSize, diskVendor=diskVendor, platformConformance=platformConformance, diskPercentageUsed=diskPercentageUsed, fwUpdateStatus=fwUpdateStatus, fan_12_speed=fan_12_speed, fan_7_speed=fan_7_speed, String=String, fwName=fwName, fan_11_speed=fan_11_speed, diskType=diskType, diskUtilizationStatsEntry=diskUtilizationStatsEntry, diskTotalIops=diskTotalIops, diskVersion=diskVersion, platformCpuStatsTable=platformCpuStatsTable)
