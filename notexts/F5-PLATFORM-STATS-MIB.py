...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", diskPercentageUsed=diskPercentageUsed, index=index, memoryStatsEntry=memoryStatsEntry, platformFantrayTable=platformFantrayTable, fpgaEntry=fpgaEntry, fpgaTable=fpgaTable, diskReadIops=diskReadIops, platformGroups=platformGroups, coreTotal5minAvg=coreTotal5minAvg, platformCPUGroup=platformCPUGroup, memPlatformTotal=memPlatformTotal, cpuTotal1minAvg=cpuTotal1minAvg, coreIndex=coreIndex, fan_2_speed=fan_2_speed, fantrayStatsEntry=fantrayStatsEntry, memFree=memFree, fan_1_speed=fan_1_speed, diskReadLatencyMs=diskReadLatencyMs, cpuCoreStatsEntry=cpuCoreStatsEntry, platformDiskGroup=platformDiskGroup, platformFantrayGroup=platformFantrayGroup, diskSerialNo=diskSerialNo, memPlatformUsed=memPlatformUsed, diskWriteMerged=diskWriteMerged, fan_3_speed=fan_3_speed, diskUtilizationStatsTable=diskUtilizationStatsTable, platformCpuStatsTable=platformCpuStatsTable, PlatformStatsIndex=PlatformStatsIndex, diskVendor=diskVendor, cpuTotal5minAvg=cpuTotal5minAvg, diskReadBytes=diskReadBytes, fwTable=fwTable, tempAverage=tempAverage, cpuCore=cpuCore, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, fwVersion=fwVersion, coreTotal1minAvg=coreTotal1minAvg, diskType=diskType, memPercentageUsed=memPercentageUsed, platformMemoryStatsTable=platformMemoryStatsTable, fan_6_speed=fan_6_speed, fan_9_speed=fan_9_speed, platformConformance=platformConformance, cpuCoreStatsTable=cpuCoreStatsTable, PYSNMP_MODULE_ID=f5PlatformStats, diskTotalIops=diskTotalIops, fwEntry=fwEntry, cpuCoreCnt=cpuCoreCnt, temperatureStatsTable=temperatureStatsTable, platformFwVersionGroup=platformFwVersionGroup, fan_8_speed=fan_8_speed, cpuUtilizationStatsTable=cpuUtilizationStatsTable, cpuStepping=cpuStepping, fpgaIndex=fpgaIndex, tempMaximum=tempMaximum, platformFpgaGroup=platformFpgaGroup, platformTempGroup=platformTempGroup, diskWriteBytes=diskWriteBytes, cpuFreq=cpuFreq, coreName=coreName, cpuCurrent=cpuCurrent, fan_5_speed=fan_5_speed, coreTotal5secAvg=coreTotal5secAvg, diskVersion=diskVersion, platformTemperatureTable=platformTemperatureTable, tempMinimum=tempMinimum, fwName=fwName, diskReadMerged=diskReadMerged, platformCompliance=platformCompliance, temperatureStatsEntry=temperatureStatsEntry, fan_7_speed=fan_7_speed, platformDiskStatsTable=platformDiskStatsTable, f5PlatformStats=f5PlatformStats, cpuIndex=cpuIndex, memAvailable=memAvailable, diskUtilizationStatsEntry=diskUtilizationStatsEntry, fan_11_speed=fan_11_speed, fan_12_speed=fan_12_speed, diskWriteIops=diskWriteIops, memoryStatsTable=memoryStatsTable, platformCompliances=platformCompliances, diskModel=diskModel, diskInfoEntry=diskInfoEntry, diskInfoTable=diskInfoTable, fan_10_speed=fan_10_speed, cpuProcessorStatsEntry=cpuProcessorStatsEntry, fwUpdateStatus=fwUpdateStatus, configurable=configurable, platformMemGroup=platformMemGroup, tempCurrent=tempCurrent, diskWriteLatencyMs=diskWriteLatencyMs, fpgaVersion=fpgaVersion, cpuCacheSize=cpuCacheSize, platformFwTable=platformFwTable, coreCurrent=coreCurrent, f5PlatformStatsObjects=f5PlatformStatsObjects, String=String, cpuTotal5secAvg=cpuTotal5secAvg, fantrayStatsTable=fantrayStatsTable, diskName=diskName, cpuModelName=cpuModelName, cpuThreadCnt=cpuThreadCnt, platformFpgaTable=platformFpgaTable, diskSize=diskSize, fan_4_speed=fan_4_speed, cpuProcessorStatsTable=cpuProcessorStatsTable)
