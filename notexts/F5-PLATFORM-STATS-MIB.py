...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", diskReadIops=diskReadIops, fwName=fwName, temperatureStatsTable=temperatureStatsTable, memoryStatsTable=memoryStatsTable, coreTotal5minAvg=coreTotal5minAvg, diskReadMerged=diskReadMerged, platformFwTable=platformFwTable, diskVersion=diskVersion, tempMaximum=tempMaximum, fan_11_speed=fan_11_speed, fan_2_speed=fan_2_speed, fan_12_speed=fan_12_speed, fan_4_speed=fan_4_speed, cpuProcessorStatsEntry=cpuProcessorStatsEntry, diskSerialNo=diskSerialNo, platformCpuStatsTable=platformCpuStatsTable, cpuFreq=cpuFreq, platformFwVersionGroup=platformFwVersionGroup, fpgaVersion=fpgaVersion, cpuThreadCnt=cpuThreadCnt, diskInfoEntry=diskInfoEntry, fwUpdateStatus=fwUpdateStatus, fantrayStatsEntry=fantrayStatsEntry, memPercentageUsed=memPercentageUsed, coreCurrent=coreCurrent, fwVersion=fwVersion, cpuTotal1minAvg=cpuTotal1minAvg, memoryStatsEntry=memoryStatsEntry, coreTotal5secAvg=coreTotal5secAvg, diskVendor=diskVendor, fpgaEntry=fpgaEntry, cpuIndex=cpuIndex, PlatformStatsIndex=PlatformStatsIndex, diskSize=diskSize, tempMinimum=tempMinimum, cpuCoreCnt=cpuCoreCnt, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, diskWriteMerged=diskWriteMerged, cpuModelName=cpuModelName, fwTable=fwTable, diskWriteIops=diskWriteIops, tempAverage=tempAverage, cpuCore=cpuCore, platformDiskGroup=platformDiskGroup, platformTemperatureTable=platformTemperatureTable, cpuTotal5secAvg=cpuTotal5secAvg, cpuStepping=cpuStepping, diskModel=diskModel, cpuCurrent=cpuCurrent, fan_6_speed=fan_6_speed, cpuProcessorStatsTable=cpuProcessorStatsTable, fan_10_speed=fan_10_speed, diskName=diskName, fan_8_speed=fan_8_speed, tempCurrent=tempCurrent, cpuCoreStatsEntry=cpuCoreStatsEntry, platformCompliances=platformCompliances, diskWriteLatencyMs=diskWriteLatencyMs, platformConformance=platformConformance, memAvailable=memAvailable, memFree=memFree, fpgaIndex=fpgaIndex, PYSNMP_MODULE_ID=f5PlatformStats, platformDiskStatsTable=platformDiskStatsTable, String=String, fan_3_speed=fan_3_speed, cpuCacheSize=cpuCacheSize, diskWriteBytes=diskWriteBytes, diskInfoTable=diskInfoTable, platformMemoryStatsTable=platformMemoryStatsTable, fantrayStatsTable=fantrayStatsTable, temperatureStatsEntry=temperatureStatsEntry, diskTotalIops=diskTotalIops, fan_1_speed=fan_1_speed, fan_9_speed=fan_9_speed, platformFpgaTable=platformFpgaTable, fwEntry=fwEntry, f5PlatformStats=f5PlatformStats, fan_7_speed=fan_7_speed, index=index, platformCPUGroup=platformCPUGroup, platformCompliance=platformCompliance, diskType=diskType, fan_5_speed=fan_5_speed, platformFantrayGroup=platformFantrayGroup, platformFpgaGroup=platformFpgaGroup, cpuUtilizationStatsTable=cpuUtilizationStatsTable, memPlatformTotal=memPlatformTotal, memPlatformUsed=memPlatformUsed, platformMemGroup=platformMemGroup, coreIndex=coreIndex, f5PlatformStatsObjects=f5PlatformStatsObjects, diskUtilizationStatsTable=diskUtilizationStatsTable, platformFantrayTable=platformFantrayTable, cpuCoreStatsTable=cpuCoreStatsTable, diskUtilizationStatsEntry=diskUtilizationStatsEntry, configurable=configurable, diskReadBytes=diskReadBytes, platformTempGroup=platformTempGroup, platformGroups=platformGroups, coreName=coreName, diskReadLatencyMs=diskReadLatencyMs, diskPercentageUsed=diskPercentageUsed, fpgaTable=fpgaTable, coreTotal1minAvg=coreTotal1minAvg, cpuTotal5minAvg=cpuTotal5minAvg)
