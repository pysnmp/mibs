...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", cpuIndex=cpuIndex, coreName=coreName, tempMinimum=tempMinimum, platformFantrayGroup=platformFantrayGroup, f5PlatformStatsObjects=f5PlatformStatsObjects, cpuCacheSize=cpuCacheSize, platformCpuStatsTable=platformCpuStatsTable, diskWriteMerged=diskWriteMerged, temperatureStatsEntry=temperatureStatsEntry, memoryStatsTable=memoryStatsTable, memPercentageUsed=memPercentageUsed, diskTotalIops=diskTotalIops, fan_8_speed=fan_8_speed, platformDiskGroup=platformDiskGroup, coreTotal5minAvg=coreTotal5minAvg, cpuTotal1minAvg=cpuTotal1minAvg, cpuTotal5minAvg=cpuTotal5minAvg, platformMemGroup=platformMemGroup, memoryStatsEntry=memoryStatsEntry, platformGroups=platformGroups, diskUtilizationStatsTable=diskUtilizationStatsTable, fan_4_speed=fan_4_speed, diskSerialNo=diskSerialNo, PYSNMP_MODULE_ID=f5PlatformStats, fpgaEntry=fpgaEntry, platformDiskStatsTable=platformDiskStatsTable, fwUpdateStatus=fwUpdateStatus, diskUtilizationStatsEntry=diskUtilizationStatsEntry, platformTempGroup=platformTempGroup, memPlatformTotal=memPlatformTotal, platformCPUGroup=platformCPUGroup, platformMemoryStatsTable=platformMemoryStatsTable, platformFwVersionGroup=platformFwVersionGroup, cpuProcessorStatsEntry=cpuProcessorStatsEntry, cpuTotal5secAvg=cpuTotal5secAvg, cpuCore=cpuCore, temperatureStatsTable=temperatureStatsTable, memFree=memFree, coreCurrent=coreCurrent, cpuStepping=cpuStepping, fan_1_speed=fan_1_speed, tempCurrent=tempCurrent, fan_2_speed=fan_2_speed, cpuUtilizationStatsTable=cpuUtilizationStatsTable, fpgaTable=fpgaTable, diskVersion=diskVersion, f5PlatformStats=f5PlatformStats, fan_5_speed=fan_5_speed, fpgaVersion=fpgaVersion, diskReadIops=diskReadIops, platformFwTable=platformFwTable, coreTotal1minAvg=coreTotal1minAvg, fan_11_speed=fan_11_speed, fan_9_speed=fan_9_speed, fan_10_speed=fan_10_speed, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, fpgaIndex=fpgaIndex, platformTemperatureTable=platformTemperatureTable, diskWriteIops=diskWriteIops, cpuCoreStatsTable=cpuCoreStatsTable, PlatformStatsIndex=PlatformStatsIndex, diskWriteBytes=diskWriteBytes, fantrayStatsTable=fantrayStatsTable, memPlatformUsed=memPlatformUsed, fwTable=fwTable, fwVersion=fwVersion, platformCompliance=platformCompliance, fan_3_speed=fan_3_speed, diskReadMerged=diskReadMerged, tempMaximum=tempMaximum, diskVendor=diskVendor, platformCompliances=platformCompliances, memAvailable=memAvailable, coreIndex=coreIndex, fan_6_speed=fan_6_speed, platformConformance=platformConformance, fwEntry=fwEntry, diskModel=diskModel, fan_12_speed=fan_12_speed, cpuCurrent=cpuCurrent, diskReadLatencyMs=diskReadLatencyMs, configurable=configurable, cpuThreadCnt=cpuThreadCnt, cpuCoreCnt=cpuCoreCnt, platformFpgaGroup=platformFpgaGroup, platformFpgaTable=platformFpgaTable, cpuFreq=cpuFreq, String=String, diskSize=diskSize, diskReadBytes=diskReadBytes, diskType=diskType, fwName=fwName, fantrayStatsEntry=fantrayStatsEntry, diskName=diskName, coreTotal5secAvg=coreTotal5secAvg, platformFantrayTable=platformFantrayTable, cpuModelName=cpuModelName, cpuProcessorStatsTable=cpuProcessorStatsTable, fan_7_speed=fan_7_speed, diskInfoEntry=diskInfoEntry, diskInfoTable=diskInfoTable, cpuCoreStatsEntry=cpuCoreStatsEntry, diskWriteLatencyMs=diskWriteLatencyMs, diskPercentageUsed=diskPercentageUsed, tempAverage=tempAverage, index=index)
