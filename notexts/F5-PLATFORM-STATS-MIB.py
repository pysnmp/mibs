...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", diskWriteMerged=diskWriteMerged, String=String, coreCurrent=coreCurrent, diskReadIops=diskReadIops, platformTempGroup=platformTempGroup, fan_8_speed=fan_8_speed, diskWriteLatencyMs=diskWriteLatencyMs, diskPercentageUsed=diskPercentageUsed, tempMaximum=tempMaximum, diskInfoTable=diskInfoTable, coreTotal5minAvg=coreTotal5minAvg, f5PlatformStatsObjects=f5PlatformStatsObjects, platformDiskStatsTable=platformDiskStatsTable, diskInfoEntry=diskInfoEntry, diskVersion=diskVersion, temperatureStatsTable=temperatureStatsTable, tempAverage=tempAverage, coreIndex=coreIndex, platformDiskGroup=platformDiskGroup, diskTotalIops=diskTotalIops, cpuCoreStatsEntry=cpuCoreStatsEntry, diskSize=diskSize, fpgaVersion=fpgaVersion, platformCpuStatsTable=platformCpuStatsTable, platformGroups=platformGroups, platformFantrayGroup=platformFantrayGroup, platformCompliance=platformCompliance, memoryStatsTable=memoryStatsTable, diskVendor=diskVendor, coreName=coreName, cpuCurrent=cpuCurrent, fan_11_speed=fan_11_speed, cpuThreadCnt=cpuThreadCnt, diskReadMerged=diskReadMerged, memAvailable=memAvailable, coreTotal5secAvg=coreTotal5secAvg, cpuProcessorStatsTable=cpuProcessorStatsTable, fwTable=fwTable, coreTotal1minAvg=coreTotal1minAvg, cpuUtilizationStatsTable=cpuUtilizationStatsTable, fan_9_speed=fan_9_speed, platformTemperatureTable=platformTemperatureTable, fwName=fwName, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, fwUpdateStatus=fwUpdateStatus, memFree=memFree, fan_2_speed=fan_2_speed, fpgaIndex=fpgaIndex, platformCompliances=platformCompliances, fantrayStatsTable=fantrayStatsTable, platformFwVersionGroup=platformFwVersionGroup, PYSNMP_MODULE_ID=f5PlatformStats, cpuModelName=cpuModelName, cpuCoreStatsTable=cpuCoreStatsTable, diskModel=diskModel, cpuCoreCnt=cpuCoreCnt, diskWriteIops=diskWriteIops, f5PlatformStats=f5PlatformStats, platformFpgaGroup=platformFpgaGroup, fan_1_speed=fan_1_speed, fan_5_speed=fan_5_speed, diskSerialNo=diskSerialNo, fwVersion=fwVersion, fan_6_speed=fan_6_speed, platformFwTable=platformFwTable, cpuFreq=cpuFreq, fan_3_speed=fan_3_speed, platformFpgaTable=platformFpgaTable, platformMemGroup=platformMemGroup, diskReadLatencyMs=diskReadLatencyMs, diskType=diskType, platformFantrayTable=platformFantrayTable, cpuCacheSize=cpuCacheSize, diskWriteBytes=diskWriteBytes, index=index, tempMinimum=tempMinimum, platformCPUGroup=platformCPUGroup, fan_12_speed=fan_12_speed, fan_7_speed=fan_7_speed, fan_4_speed=fan_4_speed, fwEntry=fwEntry, cpuTotal5secAvg=cpuTotal5secAvg, fantrayStatsEntry=fantrayStatsEntry, diskReadBytes=diskReadBytes, cpuCore=cpuCore, diskName=diskName, platformMemoryStatsTable=platformMemoryStatsTable, temperatureStatsEntry=temperatureStatsEntry, cpuTotal5minAvg=cpuTotal5minAvg, memPlatformUsed=memPlatformUsed, fpgaTable=fpgaTable, memPlatformTotal=memPlatformTotal, diskUtilizationStatsEntry=diskUtilizationStatsEntry, cpuStepping=cpuStepping, memoryStatsEntry=memoryStatsEntry, cpuProcessorStatsEntry=cpuProcessorStatsEntry, PlatformStatsIndex=PlatformStatsIndex, configurable=configurable, fpgaEntry=fpgaEntry, memPercentageUsed=memPercentageUsed, tempCurrent=tempCurrent, fan_10_speed=fan_10_speed, cpuTotal1minAvg=cpuTotal1minAvg, diskUtilizationStatsTable=diskUtilizationStatsTable, cpuIndex=cpuIndex, platformConformance=platformConformance)
