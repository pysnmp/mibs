...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", diskVendor=diskVendor, platformTempGroup=platformTempGroup, cpuModelName=cpuModelName, index=index, diskWriteLatencyMs=diskWriteLatencyMs, coreName=coreName, cpuCoreStatsTable=cpuCoreStatsTable, fwName=fwName, fan_4_speed=fan_4_speed, cpuUtilizationStatsTable=cpuUtilizationStatsTable, fan_9_speed=fan_9_speed, platformMemGroup=platformMemGroup, coreTotal5secAvg=coreTotal5secAvg, platformFantrayGroup=platformFantrayGroup, diskSerialNo=diskSerialNo, cpuCacheSize=cpuCacheSize, diskPercentageUsed=diskPercentageUsed, cpuProcessorStatsEntry=cpuProcessorStatsEntry, f5PlatformStatsObjects=f5PlatformStatsObjects, platformCompliance=platformCompliance, diskUtilizationStatsTable=diskUtilizationStatsTable, cpuCore=cpuCore, f5PlatformStats=f5PlatformStats, cpuCoreCnt=cpuCoreCnt, diskSize=diskSize, cpuFreq=cpuFreq, diskReadLatencyMs=diskReadLatencyMs, cpuTotal5secAvg=cpuTotal5secAvg, fan_6_speed=fan_6_speed, fan_8_speed=fan_8_speed, cpuTotal1minAvg=cpuTotal1minAvg, platformFpgaGroup=platformFpgaGroup, platformConformance=platformConformance, platformFwVersionGroup=platformFwVersionGroup, memPlatformTotal=memPlatformTotal, diskVersion=diskVersion, diskInfoTable=diskInfoTable, platformMemoryStatsTable=platformMemoryStatsTable, platformFantrayTable=platformFantrayTable, fpgaIndex=fpgaIndex, cpuThreadCnt=cpuThreadCnt, tempCurrent=tempCurrent, memAvailable=memAvailable, memFree=memFree, diskType=diskType, platformDiskGroup=platformDiskGroup, cpuCoreStatsEntry=cpuCoreStatsEntry, memPlatformUsed=memPlatformUsed, temperatureStatsEntry=temperatureStatsEntry, fwVersion=fwVersion, coreTotal1minAvg=coreTotal1minAvg, fwUpdateStatus=fwUpdateStatus, fan_7_speed=fan_7_speed, diskWriteIops=diskWriteIops, fantrayStatsTable=fantrayStatsTable, fpgaEntry=fpgaEntry, fwTable=fwTable, tempMinimum=tempMinimum, platformCompliances=platformCompliances, temperatureStatsTable=temperatureStatsTable, fan_12_speed=fan_12_speed, diskInfoEntry=diskInfoEntry, platformTemperatureTable=platformTemperatureTable, configurable=configurable, fpgaTable=fpgaTable, memoryStatsTable=memoryStatsTable, memPercentageUsed=memPercentageUsed, cpuIndex=cpuIndex, diskWriteBytes=diskWriteBytes, fan_11_speed=fan_11_speed, cpuTotal5minAvg=cpuTotal5minAvg, platformDiskStatsTable=platformDiskStatsTable, platformCPUGroup=platformCPUGroup, fan_3_speed=fan_3_speed, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, diskReadMerged=diskReadMerged, tempMaximum=tempMaximum, diskModel=diskModel, PYSNMP_MODULE_ID=f5PlatformStats, String=String, memoryStatsEntry=memoryStatsEntry, diskName=diskName, diskUtilizationStatsEntry=diskUtilizationStatsEntry, coreIndex=coreIndex, cpuProcessorStatsTable=cpuProcessorStatsTable, cpuCurrent=cpuCurrent, coreCurrent=coreCurrent, fan_1_speed=fan_1_speed, diskTotalIops=diskTotalIops, fan_5_speed=fan_5_speed, platformFpgaTable=platformFpgaTable, diskReadBytes=diskReadBytes, platformGroups=platformGroups, PlatformStatsIndex=PlatformStatsIndex, fpgaVersion=fpgaVersion, fwEntry=fwEntry, coreTotal5minAvg=coreTotal5minAvg, cpuStepping=cpuStepping, tempAverage=tempAverage, fan_2_speed=fan_2_speed, fan_10_speed=fan_10_speed, fantrayStatsEntry=fantrayStatsEntry, platformCpuStatsTable=platformCpuStatsTable, platformFwTable=platformFwTable, diskReadIops=diskReadIops, diskWriteMerged=diskWriteMerged)
