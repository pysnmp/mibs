...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", cpuCoreStatsEntry=cpuCoreStatsEntry, coreTotal1minAvg=coreTotal1minAvg, platformCompliances=platformCompliances, diskType=diskType, temperatureStatsEntry=temperatureStatsEntry, diskVendor=diskVendor, tempMinimum=tempMinimum, diskWriteBytes=diskWriteBytes, platformDiskGroup=platformDiskGroup, diskTotalIops=diskTotalIops, cpuStepping=cpuStepping, cpuCoreCnt=cpuCoreCnt, f5PlatformStatsObjects=f5PlatformStatsObjects, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, cpuCore=cpuCore, diskReadBytes=diskReadBytes, tempMaximum=tempMaximum, fan_12_speed=fan_12_speed, cpuFreq=cpuFreq, coreTotal5secAvg=coreTotal5secAvg, fantrayStatsTable=fantrayStatsTable, fwUpdateStatus=fwUpdateStatus, memFree=memFree, diskWriteLatencyMs=diskWriteLatencyMs, cpuCoreStatsTable=cpuCoreStatsTable, fwName=fwName, index=index, f5PlatformStats=f5PlatformStats, tempCurrent=tempCurrent, platformTempGroup=platformTempGroup, fwTable=fwTable, diskReadLatencyMs=diskReadLatencyMs, memPlatformTotal=memPlatformTotal, fan_8_speed=fan_8_speed, fan_6_speed=fan_6_speed, diskUtilizationStatsTable=diskUtilizationStatsTable, memoryStatsTable=memoryStatsTable, platformTemperatureTable=platformTemperatureTable, diskSize=diskSize, memPercentageUsed=memPercentageUsed, fpgaVersion=fpgaVersion, fpgaEntry=fpgaEntry, fan_3_speed=fan_3_speed, fan_1_speed=fan_1_speed, fan_2_speed=fan_2_speed, platformConformance=platformConformance, fan_11_speed=fan_11_speed, cpuIndex=cpuIndex, fan_9_speed=fan_9_speed, cpuCacheSize=cpuCacheSize, diskWriteMerged=diskWriteMerged, fan_7_speed=fan_7_speed, diskPercentageUsed=diskPercentageUsed, fpgaTable=fpgaTable, cpuTotal1minAvg=cpuTotal1minAvg, diskInfoEntry=diskInfoEntry, fan_5_speed=fan_5_speed, coreName=coreName, cpuModelName=cpuModelName, cpuUtilizationStatsTable=cpuUtilizationStatsTable, platformFwTable=platformFwTable, cpuCurrent=cpuCurrent, coreIndex=coreIndex, coreCurrent=coreCurrent, tempAverage=tempAverage, diskReadMerged=diskReadMerged, diskName=diskName, memoryStatsEntry=memoryStatsEntry, platformFpgaTable=platformFpgaTable, diskInfoTable=diskInfoTable, platformCPUGroup=platformCPUGroup, fan_4_speed=fan_4_speed, cpuTotal5secAvg=cpuTotal5secAvg, platformDiskStatsTable=platformDiskStatsTable, fwVersion=fwVersion, platformCompliance=platformCompliance, configurable=configurable, diskUtilizationStatsEntry=diskUtilizationStatsEntry, cpuProcessorStatsTable=cpuProcessorStatsTable, memPlatformUsed=memPlatformUsed, diskSerialNo=diskSerialNo, fpgaIndex=fpgaIndex, coreTotal5minAvg=coreTotal5minAvg, platformMemoryStatsTable=platformMemoryStatsTable, String=String, cpuProcessorStatsEntry=cpuProcessorStatsEntry, PYSNMP_MODULE_ID=f5PlatformStats, platformCpuStatsTable=platformCpuStatsTable, cpuTotal5minAvg=cpuTotal5minAvg, fantrayStatsEntry=fantrayStatsEntry, platformGroups=platformGroups, platformFpgaGroup=platformFpgaGroup, diskReadIops=diskReadIops, diskWriteIops=diskWriteIops, diskModel=diskModel, diskVersion=diskVersion, memAvailable=memAvailable, PlatformStatsIndex=PlatformStatsIndex, fan_10_speed=fan_10_speed, cpuThreadCnt=cpuThreadCnt, platformMemGroup=platformMemGroup, temperatureStatsTable=temperatureStatsTable, fwEntry=fwEntry, platformFantrayTable=platformFantrayTable, platformFantrayGroup=platformFantrayGroup, platformFwVersionGroup=platformFwVersionGroup)
