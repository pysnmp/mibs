...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", diskUtilizationStatsEntry=diskUtilizationStatsEntry, fwEntry=fwEntry, coreTotal1minAvg=coreTotal1minAvg, cpuCurrent=cpuCurrent, tempAverage=tempAverage, cpuCoreStatsTable=cpuCoreStatsTable, fantrayStatsEntry=fantrayStatsEntry, fan_6_speed=fan_6_speed, fwUpdateStatus=fwUpdateStatus, platformTempGroup=platformTempGroup, cpuFreq=cpuFreq, fwName=fwName, temperatureStatsTable=temperatureStatsTable, fan_4_speed=fan_4_speed, diskType=diskType, diskVersion=diskVersion, platformFantrayTable=platformFantrayTable, cpuStepping=cpuStepping, cpuTotal5secAvg=cpuTotal5secAvg, coreTotal5secAvg=coreTotal5secAvg, platformDiskGroup=platformDiskGroup, diskSize=diskSize, fantrayStatsTable=fantrayStatsTable, diskName=diskName, platformCompliances=platformCompliances, fan_2_speed=fan_2_speed, fan_11_speed=fan_11_speed, PYSNMP_MODULE_ID=f5PlatformStats, platformCPUGroup=platformCPUGroup, cpuThreadCnt=cpuThreadCnt, diskVendor=diskVendor, coreName=coreName, cpuTotal5minAvg=cpuTotal5minAvg, fan_5_speed=fan_5_speed, diskTotalIops=diskTotalIops, diskReadMerged=diskReadMerged, fan_1_speed=fan_1_speed, String=String, platformFantrayGroup=platformFantrayGroup, diskSerialNo=diskSerialNo, coreCurrent=coreCurrent, diskReadIops=diskReadIops, platformFwTable=platformFwTable, f5PlatformStats=f5PlatformStats, fpgaIndex=fpgaIndex, diskInfoEntry=diskInfoEntry, tempMinimum=tempMinimum, fpgaEntry=fpgaEntry, cpuUtilizationStatsTable=cpuUtilizationStatsTable, tempMaximum=tempMaximum, platformFwVersionGroup=platformFwVersionGroup, tempCurrent=tempCurrent, index=index, fan_8_speed=fan_8_speed, cpuCoreCnt=cpuCoreCnt, coreIndex=coreIndex, memPlatformUsed=memPlatformUsed, platformGroups=platformGroups, diskWriteLatencyMs=diskWriteLatencyMs, memPlatformTotal=memPlatformTotal, diskModel=diskModel, configurable=configurable, platformCpuStatsTable=platformCpuStatsTable, cpuProcessorStatsTable=cpuProcessorStatsTable, platformMemGroup=platformMemGroup, diskReadLatencyMs=diskReadLatencyMs, platformTemperatureTable=platformTemperatureTable, fan_10_speed=fan_10_speed, diskInfoTable=diskInfoTable, memFree=memFree, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, platformCompliance=platformCompliance, cpuCoreStatsEntry=cpuCoreStatsEntry, fan_7_speed=fan_7_speed, cpuCacheSize=cpuCacheSize, diskUtilizationStatsTable=diskUtilizationStatsTable, diskReadBytes=diskReadBytes, fwTable=fwTable, fan_9_speed=fan_9_speed, platformFpgaGroup=platformFpgaGroup, fpgaVersion=fpgaVersion, platformConformance=platformConformance, cpuModelName=cpuModelName, temperatureStatsEntry=temperatureStatsEntry, platformFpgaTable=platformFpgaTable, coreTotal5minAvg=coreTotal5minAvg, f5PlatformStatsObjects=f5PlatformStatsObjects, cpuProcessorStatsEntry=cpuProcessorStatsEntry, fan_3_speed=fan_3_speed, fan_12_speed=fan_12_speed, cpuTotal1minAvg=cpuTotal1minAvg, platformMemoryStatsTable=platformMemoryStatsTable, memoryStatsEntry=memoryStatsEntry, fwVersion=fwVersion, diskPercentageUsed=diskPercentageUsed, diskWriteIops=diskWriteIops, cpuIndex=cpuIndex, memPercentageUsed=memPercentageUsed, diskWriteMerged=diskWriteMerged, PlatformStatsIndex=PlatformStatsIndex, cpuCore=cpuCore, memAvailable=memAvailable, fpgaTable=fpgaTable, platformDiskStatsTable=platformDiskStatsTable, diskWriteBytes=diskWriteBytes, memoryStatsTable=memoryStatsTable)
