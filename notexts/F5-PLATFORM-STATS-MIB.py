...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", platformTemperatureTable=platformTemperatureTable, cpuCoreStatsEntry=cpuCoreStatsEntry, diskSize=diskSize, diskPercentageUsed=diskPercentageUsed, platformCpuStatsTable=platformCpuStatsTable, fwVersion=fwVersion, fwTable=fwTable, fpgaIndex=fpgaIndex, platformGroups=platformGroups, memPlatformUsed=memPlatformUsed, fantrayStatsTable=fantrayStatsTable, diskTotalIops=diskTotalIops, cpuStepping=cpuStepping, platformFwVersionGroup=platformFwVersionGroup, temperatureStatsTable=temperatureStatsTable, diskModel=diskModel, diskReadBytes=diskReadBytes, diskReadIops=diskReadIops, platformCPUGroup=platformCPUGroup, cpuProcessorStatsTable=cpuProcessorStatsTable, f5PlatformStatsObjects=f5PlatformStatsObjects, memFree=memFree, fan_12_speed=fan_12_speed, configurable=configurable, tempAverage=tempAverage, platformDiskGroup=platformDiskGroup, fwEntry=fwEntry, fan_3_speed=fan_3_speed, index=index, platformFantrayTable=platformFantrayTable, fwName=fwName, PYSNMP_MODULE_ID=f5PlatformStats, coreIndex=coreIndex, diskVendor=diskVendor, diskUtilizationStatsTable=diskUtilizationStatsTable, diskUtilizationStatsEntry=diskUtilizationStatsEntry, diskReadMerged=diskReadMerged, cpuTotal1minAvg=cpuTotal1minAvg, fan_5_speed=fan_5_speed, platformCompliances=platformCompliances, cpuCore=cpuCore, diskSerialNo=diskSerialNo, coreTotal5minAvg=coreTotal5minAvg, tempMaximum=tempMaximum, fan_11_speed=fan_11_speed, platformFantrayGroup=platformFantrayGroup, platformMemGroup=platformMemGroup, memoryStatsTable=memoryStatsTable, platformTempGroup=platformTempGroup, cpuModelName=cpuModelName, diskVersion=diskVersion, tempMinimum=tempMinimum, String=String, fan_9_speed=fan_9_speed, cpuCoreCnt=cpuCoreCnt, diskInfoEntry=diskInfoEntry, cpuCurrent=cpuCurrent, diskWriteLatencyMs=diskWriteLatencyMs, cpuUtilizationStatsTable=cpuUtilizationStatsTable, diskInfoTable=diskInfoTable, fpgaVersion=fpgaVersion, fpgaEntry=fpgaEntry, memoryStatsEntry=memoryStatsEntry, coreTotal1minAvg=coreTotal1minAvg, fan_4_speed=fan_4_speed, fan_2_speed=fan_2_speed, coreCurrent=coreCurrent, fpgaTable=fpgaTable, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, tempCurrent=tempCurrent, diskWriteBytes=diskWriteBytes, cpuThreadCnt=cpuThreadCnt, cpuCacheSize=cpuCacheSize, fwUpdateStatus=fwUpdateStatus, coreTotal5secAvg=coreTotal5secAvg, memPercentageUsed=memPercentageUsed, diskType=diskType, platformDiskStatsTable=platformDiskStatsTable, PlatformStatsIndex=PlatformStatsIndex, fan_8_speed=fan_8_speed, platformMemoryStatsTable=platformMemoryStatsTable, fantrayStatsEntry=fantrayStatsEntry, diskWriteIops=diskWriteIops, platformCompliance=platformCompliance, temperatureStatsEntry=temperatureStatsEntry, diskReadLatencyMs=diskReadLatencyMs, cpuCoreStatsTable=cpuCoreStatsTable, diskName=diskName, memAvailable=memAvailable, platformFpgaTable=platformFpgaTable, fan_10_speed=fan_10_speed, cpuIndex=cpuIndex, fan_1_speed=fan_1_speed, platformFwTable=platformFwTable, fan_6_speed=fan_6_speed, fan_7_speed=fan_7_speed, platformFpgaGroup=platformFpgaGroup, diskWriteMerged=diskWriteMerged, platformConformance=platformConformance, cpuProcessorStatsEntry=cpuProcessorStatsEntry, cpuTotal5secAvg=cpuTotal5secAvg, cpuTotal5minAvg=cpuTotal5minAvg, coreName=coreName, f5PlatformStats=f5PlatformStats, cpuFreq=cpuFreq, memPlatformTotal=memPlatformTotal)
