...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", memPercentageUsed=memPercentageUsed, fantrayStatsEntry=fantrayStatsEntry, platformFantrayGroup=platformFantrayGroup, diskVendor=diskVendor, tempMinimum=tempMinimum, fpgaTable=fpgaTable, platformCpuStatsTable=platformCpuStatsTable, memoryStatsEntry=memoryStatsEntry, cpuStepping=cpuStepping, fantrayStatsTable=fantrayStatsTable, cpuCacheSize=cpuCacheSize, fan_8_speed=fan_8_speed, fpgaVersion=fpgaVersion, platformFwTable=platformFwTable, coreCurrent=coreCurrent, diskReadLatencyMs=diskReadLatencyMs, fwUpdateStatus=fwUpdateStatus, f5PlatformStats=f5PlatformStats, fpgaEntry=fpgaEntry, platformConformance=platformConformance, memAvailable=memAvailable, cpuUtilizationStatsTable=cpuUtilizationStatsTable, coreTotal5minAvg=coreTotal5minAvg, cpuThreadCnt=cpuThreadCnt, diskTotalIops=diskTotalIops, diskReadIops=diskReadIops, platformTempGroup=platformTempGroup, f5PlatformStatsObjects=f5PlatformStatsObjects, diskVersion=diskVersion, String=String, cpuFreq=cpuFreq, coreIndex=coreIndex, memFree=memFree, coreTotal1minAvg=coreTotal1minAvg, diskReadMerged=diskReadMerged, fan_10_speed=fan_10_speed, configurable=configurable, fan_1_speed=fan_1_speed, coreName=coreName, fan_2_speed=fan_2_speed, platformCompliances=platformCompliances, memPlatformTotal=memPlatformTotal, diskInfoTable=diskInfoTable, platformDiskStatsTable=platformDiskStatsTable, platformTemperatureTable=platformTemperatureTable, diskWriteLatencyMs=diskWriteLatencyMs, PYSNMP_MODULE_ID=f5PlatformStats, diskSerialNo=diskSerialNo, fan_11_speed=fan_11_speed, memPlatformUsed=memPlatformUsed, fwEntry=fwEntry, platformFantrayTable=platformFantrayTable, cpuTotal5secAvg=cpuTotal5secAvg, diskUtilizationStatsTable=diskUtilizationStatsTable, diskWriteIops=diskWriteIops, diskWriteMerged=diskWriteMerged, fan_4_speed=fan_4_speed, fwVersion=fwVersion, temperatureStatsTable=temperatureStatsTable, platformMemGroup=platformMemGroup, memoryStatsTable=memoryStatsTable, cpuCore=cpuCore, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, diskWriteBytes=diskWriteBytes, cpuProcessorStatsTable=cpuProcessorStatsTable, tempMaximum=tempMaximum, cpuProcessorStatsEntry=cpuProcessorStatsEntry, cpuIndex=cpuIndex, platformCPUGroup=platformCPUGroup, diskName=diskName, platformFwVersionGroup=platformFwVersionGroup, fwTable=fwTable, cpuCurrent=cpuCurrent, diskSize=diskSize, fan_9_speed=fan_9_speed, platformMemoryStatsTable=platformMemoryStatsTable, cpuTotal5minAvg=cpuTotal5minAvg, diskUtilizationStatsEntry=diskUtilizationStatsEntry, cpuCoreCnt=cpuCoreCnt, cpuCoreStatsEntry=cpuCoreStatsEntry, fan_6_speed=fan_6_speed, platformDiskGroup=platformDiskGroup, platformGroups=platformGroups, tempCurrent=tempCurrent, tempAverage=tempAverage, platformFpgaTable=platformFpgaTable, fwName=fwName, platformCompliance=platformCompliance, platformFpgaGroup=platformFpgaGroup, cpuTotal1minAvg=cpuTotal1minAvg, PlatformStatsIndex=PlatformStatsIndex, fan_5_speed=fan_5_speed, diskReadBytes=diskReadBytes, cpuCoreStatsTable=cpuCoreStatsTable, fan_7_speed=fan_7_speed, fpgaIndex=fpgaIndex, diskInfoEntry=diskInfoEntry, fan_12_speed=fan_12_speed, cpuModelName=cpuModelName, coreTotal5secAvg=coreTotal5secAvg, diskType=diskType, diskPercentageUsed=diskPercentageUsed, diskModel=diskModel, index=index, fan_3_speed=fan_3_speed, temperatureStatsEntry=temperatureStatsEntry)
