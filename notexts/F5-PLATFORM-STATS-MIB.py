...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", coreName=coreName, PYSNMP_MODULE_ID=f5PlatformStats, platformMemGroup=platformMemGroup, diskSerialNo=diskSerialNo, diskWriteBytes=diskWriteBytes, diskUtilizationStatsEntry=diskUtilizationStatsEntry, memPercentageUsed=memPercentageUsed, fan_10_speed=fan_10_speed, diskWriteMerged=diskWriteMerged, platformFantrayGroup=platformFantrayGroup, diskReadIops=diskReadIops, platformConformance=platformConformance, platformTemperatureTable=platformTemperatureTable, fan_5_speed=fan_5_speed, String=String, diskModel=diskModel, fpgaTable=fpgaTable, diskReadMerged=diskReadMerged, fwTable=fwTable, platformCPUGroup=platformCPUGroup, memPlatformUsed=memPlatformUsed, fan_12_speed=fan_12_speed, platformCpuStatsTable=platformCpuStatsTable, platformMemoryStatsTable=platformMemoryStatsTable, f5PlatformStatsObjects=f5PlatformStatsObjects, tempCurrent=tempCurrent, fan_3_speed=fan_3_speed, diskUtilizationStatsTable=diskUtilizationStatsTable, cpuStepping=cpuStepping, cpuTotal5minAvg=cpuTotal5minAvg, cpuCoreStatsTable=cpuCoreStatsTable, fpgaVersion=fpgaVersion, memoryStatsEntry=memoryStatsEntry, cpuThreadCnt=cpuThreadCnt, coreTotal5secAvg=coreTotal5secAvg, tempAverage=tempAverage, memFree=memFree, platformFantrayTable=platformFantrayTable, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, fantrayStatsTable=fantrayStatsTable, fan_7_speed=fan_7_speed, cpuFreq=cpuFreq, fan_9_speed=fan_9_speed, configurable=configurable, fantrayStatsEntry=fantrayStatsEntry, cpuProcessorStatsEntry=cpuProcessorStatsEntry, index=index, diskReadLatencyMs=diskReadLatencyMs, platformTempGroup=platformTempGroup, diskVersion=diskVersion, platformGroups=platformGroups, platformCompliances=platformCompliances, diskVendor=diskVendor, fan_8_speed=fan_8_speed, platformDiskStatsTable=platformDiskStatsTable, cpuTotal5secAvg=cpuTotal5secAvg, cpuCoreStatsEntry=cpuCoreStatsEntry, memPlatformTotal=memPlatformTotal, diskWriteLatencyMs=diskWriteLatencyMs, tempMinimum=tempMinimum, f5PlatformStats=f5PlatformStats, diskWriteIops=diskWriteIops, platformCompliance=platformCompliance, diskType=diskType, fpgaIndex=fpgaIndex, platformFwVersionGroup=platformFwVersionGroup, platformFpgaTable=platformFpgaTable, fwUpdateStatus=fwUpdateStatus, PlatformStatsIndex=PlatformStatsIndex, platformFpgaGroup=platformFpgaGroup, coreTotal1minAvg=coreTotal1minAvg, fan_6_speed=fan_6_speed, platformFwTable=platformFwTable, platformDiskGroup=platformDiskGroup, fan_2_speed=fan_2_speed, diskTotalIops=diskTotalIops, diskInfoTable=diskInfoTable, cpuCoreCnt=cpuCoreCnt, diskName=diskName, temperatureStatsTable=temperatureStatsTable, temperatureStatsEntry=temperatureStatsEntry, coreCurrent=coreCurrent, diskSize=diskSize, coreTotal5minAvg=coreTotal5minAvg, cpuProcessorStatsTable=cpuProcessorStatsTable, cpuCacheSize=cpuCacheSize, memAvailable=memAvailable, fpgaEntry=fpgaEntry, fwName=fwName, cpuCore=cpuCore, cpuIndex=cpuIndex, cpuModelName=cpuModelName, coreIndex=coreIndex, diskReadBytes=diskReadBytes, diskPercentageUsed=diskPercentageUsed, fan_4_speed=fan_4_speed, fwEntry=fwEntry, diskInfoEntry=diskInfoEntry, fan_11_speed=fan_11_speed, tempMaximum=tempMaximum, fwVersion=fwVersion, cpuUtilizationStatsTable=cpuUtilizationStatsTable, cpuCurrent=cpuCurrent, memoryStatsTable=memoryStatsTable, cpuTotal1minAvg=cpuTotal1minAvg, fan_1_speed=fan_1_speed)
