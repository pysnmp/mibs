...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", diskUtilizationStatsTable=diskUtilizationStatsTable, cpuModelName=cpuModelName, diskWriteMerged=diskWriteMerged, fan_11_speed=fan_11_speed, String=String, cpuCacheSize=cpuCacheSize, diskReadLatencyMs=diskReadLatencyMs, fantrayStatsTable=fantrayStatsTable, fan_10_speed=fan_10_speed, diskInfoTable=diskInfoTable, platformConformance=platformConformance, diskReadMerged=diskReadMerged, cpuStepping=cpuStepping, fan_9_speed=fan_9_speed, fwVersion=fwVersion, platformMemoryStatsTable=platformMemoryStatsTable, memoryStatsEntry=memoryStatsEntry, platformCpuStatsTable=platformCpuStatsTable, diskWriteLatencyMs=diskWriteLatencyMs, PlatformStatsIndex=PlatformStatsIndex, platformCPUGroup=platformCPUGroup, platformFwTable=platformFwTable, fan_5_speed=fan_5_speed, fpgaEntry=fpgaEntry, platformDiskGroup=platformDiskGroup, cpuFreq=cpuFreq, cpuCore=cpuCore, fpgaVersion=fpgaVersion, f5PlatformStatsObjects=f5PlatformStatsObjects, temperatureStatsTable=temperatureStatsTable, fan_6_speed=fan_6_speed, tempAverage=tempAverage, diskTotalIops=diskTotalIops, diskReadIops=diskReadIops, platformFpgaGroup=platformFpgaGroup, cpuCoreStatsTable=cpuCoreStatsTable, diskVersion=diskVersion, platformCompliances=platformCompliances, cpuCurrent=cpuCurrent, memPlatformTotal=memPlatformTotal, fpgaTable=fpgaTable, cpuTotal5secAvg=cpuTotal5secAvg, fan_7_speed=fan_7_speed, diskWriteIops=diskWriteIops, platformCompliance=platformCompliance, fantrayStatsEntry=fantrayStatsEntry, diskReadBytes=diskReadBytes, coreIndex=coreIndex, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, diskInfoEntry=diskInfoEntry, memPlatformUsed=memPlatformUsed, PYSNMP_MODULE_ID=f5PlatformStats, diskSerialNo=diskSerialNo, cpuProcessorStatsTable=cpuProcessorStatsTable, diskVendor=diskVendor, diskType=diskType, fwTable=fwTable, diskModel=diskModel, fan_12_speed=fan_12_speed, cpuThreadCnt=cpuThreadCnt, cpuCoreStatsEntry=cpuCoreStatsEntry, platformFantrayTable=platformFantrayTable, fpgaIndex=fpgaIndex, cpuTotal1minAvg=cpuTotal1minAvg, f5PlatformStats=f5PlatformStats, coreTotal5secAvg=coreTotal5secAvg, cpuUtilizationStatsTable=cpuUtilizationStatsTable, coreName=coreName, fwUpdateStatus=fwUpdateStatus, platformDiskStatsTable=platformDiskStatsTable, cpuIndex=cpuIndex, cpuTotal5minAvg=cpuTotal5minAvg, platformTempGroup=platformTempGroup, memoryStatsTable=memoryStatsTable, configurable=configurable, platformFantrayGroup=platformFantrayGroup, index=index, diskSize=diskSize, fan_8_speed=fan_8_speed, coreTotal5minAvg=coreTotal5minAvg, memPercentageUsed=memPercentageUsed, diskUtilizationStatsEntry=diskUtilizationStatsEntry, fwEntry=fwEntry, tempCurrent=tempCurrent, fan_4_speed=fan_4_speed, diskName=diskName, memAvailable=memAvailable, diskPercentageUsed=diskPercentageUsed, fan_2_speed=fan_2_speed, fan_3_speed=fan_3_speed, temperatureStatsEntry=temperatureStatsEntry, tempMaximum=tempMaximum, fan_1_speed=fan_1_speed, platformTemperatureTable=platformTemperatureTable, platformGroups=platformGroups, memFree=memFree, fwName=fwName, platformMemGroup=platformMemGroup, diskWriteBytes=diskWriteBytes, coreCurrent=coreCurrent, tempMinimum=tempMinimum, cpuProcessorStatsEntry=cpuProcessorStatsEntry, cpuCoreCnt=cpuCoreCnt, platformFwVersionGroup=platformFwVersionGroup, coreTotal1minAvg=coreTotal1minAvg, platformFpgaTable=platformFpgaTable)
