...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", diskReadMerged=diskReadMerged, diskUtilizationStatsTable=diskUtilizationStatsTable, platformFpgaGroup=platformFpgaGroup, fan_10_speed=fan_10_speed, cpuCoreStatsTable=cpuCoreStatsTable, fpgaTable=fpgaTable, memAvailable=memAvailable, memFree=memFree, PlatformStatsIndex=PlatformStatsIndex, cpuTotal5secAvg=cpuTotal5secAvg, cpuIndex=cpuIndex, cpuModelName=cpuModelName, tempMaximum=tempMaximum, fan_5_speed=fan_5_speed, fan_7_speed=fan_7_speed, coreName=coreName, diskWriteIops=diskWriteIops, tempCurrent=tempCurrent, platformCompliance=platformCompliance, memoryStatsTable=memoryStatsTable, fpgaIndex=fpgaIndex, diskVendor=diskVendor, diskModel=diskModel, coreCurrent=coreCurrent, diskType=diskType, diskReadLatencyMs=diskReadLatencyMs, f5PlatformStats=f5PlatformStats, fan_8_speed=fan_8_speed, coreTotal5secAvg=coreTotal5secAvg, diskInfoEntry=diskInfoEntry, platformFwVersionGroup=platformFwVersionGroup, f5PlatformStatsObjects=f5PlatformStatsObjects, platformFwTable=platformFwTable, platformDiskStatsTable=platformDiskStatsTable, platformTempGroup=platformTempGroup, platformCPUGroup=platformCPUGroup, cpuCoreStatsEntry=cpuCoreStatsEntry, PYSNMP_MODULE_ID=f5PlatformStats, platformFpgaTable=platformFpgaTable, String=String, fan_3_speed=fan_3_speed, diskPercentageUsed=diskPercentageUsed, cpuTotal1minAvg=cpuTotal1minAvg, platformMemoryStatsTable=platformMemoryStatsTable, diskSerialNo=diskSerialNo, memPercentageUsed=memPercentageUsed, temperatureStatsEntry=temperatureStatsEntry, platformConformance=platformConformance, fwTable=fwTable, fan_12_speed=fan_12_speed, diskWriteLatencyMs=diskWriteLatencyMs, fwName=fwName, cpuTotal5minAvg=cpuTotal5minAvg, cpuThreadCnt=cpuThreadCnt, cpuCurrent=cpuCurrent, diskUtilizationStatsEntry=diskUtilizationStatsEntry, coreTotal1minAvg=coreTotal1minAvg, fan_9_speed=fan_9_speed, diskVersion=diskVersion, fan_4_speed=fan_4_speed, platformCpuStatsTable=platformCpuStatsTable, cpuStepping=cpuStepping, cpuProcessorStatsEntry=cpuProcessorStatsEntry, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, platformGroups=platformGroups, diskReadBytes=diskReadBytes, cpuCacheSize=cpuCacheSize, fan_6_speed=fan_6_speed, temperatureStatsTable=temperatureStatsTable, fpgaEntry=fpgaEntry, platformDiskGroup=platformDiskGroup, diskSize=diskSize, platformTemperatureTable=platformTemperatureTable, coreTotal5minAvg=coreTotal5minAvg, fan_1_speed=fan_1_speed, diskWriteBytes=diskWriteBytes, platformFantrayTable=platformFantrayTable, fan_11_speed=fan_11_speed, coreIndex=coreIndex, memoryStatsEntry=memoryStatsEntry, configurable=configurable, platformMemGroup=platformMemGroup, diskName=diskName, fwEntry=fwEntry, fpgaVersion=fpgaVersion, platformFantrayGroup=platformFantrayGroup, diskReadIops=diskReadIops, cpuCoreCnt=cpuCoreCnt, tempAverage=tempAverage, fantrayStatsTable=fantrayStatsTable, tempMinimum=tempMinimum, fwVersion=fwVersion, diskWriteMerged=diskWriteMerged, cpuFreq=cpuFreq, memPlatformUsed=memPlatformUsed, diskInfoTable=diskInfoTable, cpuCore=cpuCore, index=index, fan_2_speed=fan_2_speed, cpuUtilizationStatsTable=cpuUtilizationStatsTable, cpuProcessorStatsTable=cpuProcessorStatsTable, fantrayStatsEntry=fantrayStatsEntry, diskTotalIops=diskTotalIops, fwUpdateStatus=fwUpdateStatus, memPlatformTotal=memPlatformTotal, platformCompliances=platformCompliances)
