...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", fan_3_speed=fan_3_speed, coreTotal1minAvg=coreTotal1minAvg, cpuCoreStatsTable=cpuCoreStatsTable, fwName=fwName, diskReadLatencyMs=diskReadLatencyMs, platformFpgaGroup=platformFpgaGroup, memPlatformTotal=memPlatformTotal, cpuStepping=cpuStepping, fantrayStatsTable=fantrayStatsTable, cpuCurrent=cpuCurrent, diskType=diskType, diskSerialNo=diskSerialNo, tempMaximum=tempMaximum, platformDiskGroup=platformDiskGroup, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, memFree=memFree, diskTotalIops=diskTotalIops, fan_4_speed=fan_4_speed, memAvailable=memAvailable, fpgaIndex=fpgaIndex, fwTable=fwTable, String=String, fan_9_speed=fan_9_speed, diskPercentageUsed=diskPercentageUsed, temperatureStatsTable=temperatureStatsTable, platformTemperatureTable=platformTemperatureTable, coreTotal5secAvg=coreTotal5secAvg, fan_11_speed=fan_11_speed, diskSize=diskSize, platformGroups=platformGroups, cpuProcessorStatsEntry=cpuProcessorStatsEntry, memoryStatsEntry=memoryStatsEntry, cpuCoreStatsEntry=cpuCoreStatsEntry, diskVersion=diskVersion, diskWriteIops=diskWriteIops, configurable=configurable, temperatureStatsEntry=temperatureStatsEntry, diskInfoTable=diskInfoTable, platformConformance=platformConformance, fpgaEntry=fpgaEntry, cpuIndex=cpuIndex, diskReadIops=diskReadIops, diskInfoEntry=diskInfoEntry, platformTempGroup=platformTempGroup, fan_1_speed=fan_1_speed, diskWriteLatencyMs=diskWriteLatencyMs, platformMemoryStatsTable=platformMemoryStatsTable, coreIndex=coreIndex, diskUtilizationStatsEntry=diskUtilizationStatsEntry, fwUpdateStatus=fwUpdateStatus, platformDiskStatsTable=platformDiskStatsTable, fpgaVersion=fpgaVersion, tempAverage=tempAverage, diskReadBytes=diskReadBytes, platformCPUGroup=platformCPUGroup, platformFpgaTable=platformFpgaTable, f5PlatformStatsObjects=f5PlatformStatsObjects, cpuCacheSize=cpuCacheSize, platformCompliances=platformCompliances, fan_6_speed=fan_6_speed, fan_5_speed=fan_5_speed, fan_10_speed=fan_10_speed, diskVendor=diskVendor, fan_2_speed=fan_2_speed, diskReadMerged=diskReadMerged, memPercentageUsed=memPercentageUsed, cpuThreadCnt=cpuThreadCnt, diskUtilizationStatsTable=diskUtilizationStatsTable, platformFantrayGroup=platformFantrayGroup, PlatformStatsIndex=PlatformStatsIndex, cpuModelName=cpuModelName, cpuUtilizationStatsTable=cpuUtilizationStatsTable, coreName=coreName, diskName=diskName, cpuCoreCnt=cpuCoreCnt, fan_12_speed=fan_12_speed, fan_7_speed=fan_7_speed, memoryStatsTable=memoryStatsTable, platformCompliance=platformCompliance, index=index, tempMinimum=tempMinimum, platformFwVersionGroup=platformFwVersionGroup, fantrayStatsEntry=fantrayStatsEntry, coreCurrent=coreCurrent, platformCpuStatsTable=platformCpuStatsTable, cpuTotal1minAvg=cpuTotal1minAvg, cpuTotal5minAvg=cpuTotal5minAvg, memPlatformUsed=memPlatformUsed, diskModel=diskModel, cpuProcessorStatsTable=cpuProcessorStatsTable, f5PlatformStats=f5PlatformStats, platformFwTable=platformFwTable, diskWriteBytes=diskWriteBytes, platformMemGroup=platformMemGroup, cpuFreq=cpuFreq, PYSNMP_MODULE_ID=f5PlatformStats, fan_8_speed=fan_8_speed, fpgaTable=fpgaTable, coreTotal5minAvg=coreTotal5minAvg, diskWriteMerged=diskWriteMerged, platformFantrayTable=platformFantrayTable, fwVersion=fwVersion, cpuTotal5secAvg=cpuTotal5secAvg, fwEntry=fwEntry, tempCurrent=tempCurrent, cpuCore=cpuCore)
