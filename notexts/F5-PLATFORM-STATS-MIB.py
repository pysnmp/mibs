...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", coreIndex=coreIndex, diskTotalIops=diskTotalIops, fan_2_speed=fan_2_speed, diskReadLatencyMs=diskReadLatencyMs, cpuStepping=cpuStepping, diskSize=diskSize, cpuCore=cpuCore, fan_4_speed=fan_4_speed, cpuCoreStatsTable=cpuCoreStatsTable, diskReadMerged=diskReadMerged, platformFpgaGroup=platformFpgaGroup, fpgaIndex=fpgaIndex, fwName=fwName, tempMaximum=tempMaximum, memPercentageUsed=memPercentageUsed, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, cpuCacheSize=cpuCacheSize, fan_5_speed=fan_5_speed, platformGroups=platformGroups, platformDiskGroup=platformDiskGroup, fan_1_speed=fan_1_speed, coreTotal5minAvg=coreTotal5minAvg, cpuProcessorStatsTable=cpuProcessorStatsTable, fwUpdateStatus=fwUpdateStatus, diskModel=diskModel, platformCPUGroup=platformCPUGroup, String=String, fpgaVersion=fpgaVersion, fan_3_speed=fan_3_speed, cpuIndex=cpuIndex, tempMinimum=tempMinimum, diskUtilizationStatsTable=diskUtilizationStatsTable, diskWriteIops=diskWriteIops, cpuCoreCnt=cpuCoreCnt, platformFantrayGroup=platformFantrayGroup, diskType=diskType, platformFwTable=platformFwTable, fan_9_speed=fan_9_speed, platformTemperatureTable=platformTemperatureTable, fwTable=fwTable, fantrayStatsTable=fantrayStatsTable, platformCpuStatsTable=platformCpuStatsTable, diskWriteBytes=diskWriteBytes, platformTempGroup=platformTempGroup, coreCurrent=coreCurrent, temperatureStatsTable=temperatureStatsTable, cpuProcessorStatsEntry=cpuProcessorStatsEntry, diskName=diskName, PlatformStatsIndex=PlatformStatsIndex, cpuThreadCnt=cpuThreadCnt, platformFwVersionGroup=platformFwVersionGroup, fan_11_speed=fan_11_speed, diskUtilizationStatsEntry=diskUtilizationStatsEntry, coreTotal5secAvg=coreTotal5secAvg, memoryStatsEntry=memoryStatsEntry, fpgaTable=fpgaTable, f5PlatformStats=f5PlatformStats, coreTotal1minAvg=coreTotal1minAvg, platformCompliances=platformCompliances, diskVendor=diskVendor, cpuModelName=cpuModelName, fwEntry=fwEntry, f5PlatformStatsObjects=f5PlatformStatsObjects, temperatureStatsEntry=temperatureStatsEntry, diskVersion=diskVersion, platformMemGroup=platformMemGroup, diskInfoTable=diskInfoTable, memoryStatsTable=memoryStatsTable, cpuTotal5secAvg=cpuTotal5secAvg, fan_6_speed=fan_6_speed, fan_12_speed=fan_12_speed, diskWriteLatencyMs=diskWriteLatencyMs, fan_8_speed=fan_8_speed, diskPercentageUsed=diskPercentageUsed, fwVersion=fwVersion, platformFantrayTable=platformFantrayTable, cpuTotal1minAvg=cpuTotal1minAvg, cpuCurrent=cpuCurrent, coreName=coreName, fantrayStatsEntry=fantrayStatsEntry, platformDiskStatsTable=platformDiskStatsTable, diskSerialNo=diskSerialNo, fan_7_speed=fan_7_speed, diskInfoEntry=diskInfoEntry, cpuTotal5minAvg=cpuTotal5minAvg, fpgaEntry=fpgaEntry, diskReadIops=diskReadIops, memPlatformTotal=memPlatformTotal, fan_10_speed=fan_10_speed, platformCompliance=platformCompliance, configurable=configurable, diskReadBytes=diskReadBytes, cpuUtilizationStatsTable=cpuUtilizationStatsTable, tempAverage=tempAverage, PYSNMP_MODULE_ID=f5PlatformStats, platformFpgaTable=platformFpgaTable, cpuCoreStatsEntry=cpuCoreStatsEntry, tempCurrent=tempCurrent, index=index, cpuFreq=cpuFreq, platformMemoryStatsTable=platformMemoryStatsTable, memFree=memFree, memPlatformUsed=memPlatformUsed, memAvailable=memAvailable, platformConformance=platformConformance, diskWriteMerged=diskWriteMerged)
