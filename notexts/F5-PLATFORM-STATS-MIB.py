...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", diskSize=diskSize, fwUpdateStatus=fwUpdateStatus, diskUtilizationStatsEntry=diskUtilizationStatsEntry, cpuCoreStatsEntry=cpuCoreStatsEntry, cpuIndex=cpuIndex, diskInfoTable=diskInfoTable, fan_2_speed=fan_2_speed, fan_12_speed=fan_12_speed, PlatformStatsIndex=PlatformStatsIndex, fantrayStatsEntry=fantrayStatsEntry, fwEntry=fwEntry, diskPercentageUsed=diskPercentageUsed, diskReadIops=diskReadIops, cpuCoreCnt=cpuCoreCnt, platformTempGroup=platformTempGroup, platformFpgaGroup=platformFpgaGroup, diskVersion=diskVersion, cpuUtilizationStatsTable=cpuUtilizationStatsTable, memAvailable=memAvailable, diskWriteMerged=diskWriteMerged, tempMinimum=tempMinimum, fan_11_speed=fan_11_speed, fwVersion=fwVersion, cpuCacheSize=cpuCacheSize, cpuTotal5secAvg=cpuTotal5secAvg, cpuModelName=cpuModelName, coreName=coreName, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, diskWriteLatencyMs=diskWriteLatencyMs, String=String, fan_3_speed=fan_3_speed, fan_5_speed=fan_5_speed, fan_6_speed=fan_6_speed, diskVendor=diskVendor, diskReadLatencyMs=diskReadLatencyMs, cpuCurrent=cpuCurrent, configurable=configurable, tempAverage=tempAverage, fan_9_speed=fan_9_speed, cpuProcessorStatsTable=cpuProcessorStatsTable, cpuThreadCnt=cpuThreadCnt, fwTable=fwTable, platformMemoryStatsTable=platformMemoryStatsTable, cpuTotal1minAvg=cpuTotal1minAvg, temperatureStatsEntry=temperatureStatsEntry, fpgaVersion=fpgaVersion, platformFwVersionGroup=platformFwVersionGroup, platformDiskStatsTable=platformDiskStatsTable, f5PlatformStatsObjects=f5PlatformStatsObjects, memoryStatsEntry=memoryStatsEntry, PYSNMP_MODULE_ID=f5PlatformStats, fpgaTable=fpgaTable, platformFwTable=platformFwTable, fwName=fwName, diskWriteBytes=diskWriteBytes, platformDiskGroup=platformDiskGroup, fpgaIndex=fpgaIndex, platformGroups=platformGroups, cpuCore=cpuCore, diskType=diskType, diskTotalIops=diskTotalIops, coreTotal5secAvg=coreTotal5secAvg, cpuCoreStatsTable=cpuCoreStatsTable, platformFpgaTable=platformFpgaTable, fantrayStatsTable=fantrayStatsTable, fan_4_speed=fan_4_speed, memPlatformUsed=memPlatformUsed, platformFantrayGroup=platformFantrayGroup, coreTotal1minAvg=coreTotal1minAvg, coreCurrent=coreCurrent, diskReadMerged=diskReadMerged, fan_7_speed=fan_7_speed, diskInfoEntry=diskInfoEntry, platformFantrayTable=platformFantrayTable, memPercentageUsed=memPercentageUsed, coreIndex=coreIndex, fan_8_speed=fan_8_speed, diskUtilizationStatsTable=diskUtilizationStatsTable, memoryStatsTable=memoryStatsTable, diskModel=diskModel, diskReadBytes=diskReadBytes, memFree=memFree, memPlatformTotal=memPlatformTotal, cpuProcessorStatsEntry=cpuProcessorStatsEntry, tempCurrent=tempCurrent, diskWriteIops=diskWriteIops, platformCPUGroup=platformCPUGroup, cpuFreq=cpuFreq, diskSerialNo=diskSerialNo, temperatureStatsTable=temperatureStatsTable, platformCompliance=platformCompliance, fpgaEntry=fpgaEntry, cpuStepping=cpuStepping, platformCompliances=platformCompliances, coreTotal5minAvg=coreTotal5minAvg, tempMaximum=tempMaximum, fan_1_speed=fan_1_speed, cpuTotal5minAvg=cpuTotal5minAvg, platformCpuStatsTable=platformCpuStatsTable, platformTemperatureTable=platformTemperatureTable, fan_10_speed=fan_10_speed, platformMemGroup=platformMemGroup, f5PlatformStats=f5PlatformStats, index=index, diskName=diskName, platformConformance=platformConformance)
