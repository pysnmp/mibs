...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", cpuProcessorStatsEntry=cpuProcessorStatsEntry, diskWriteLatencyMs=diskWriteLatencyMs, platformDiskGroup=platformDiskGroup, platformFpgaTable=platformFpgaTable, tempMinimum=tempMinimum, configurable=configurable, tempMaximum=tempMaximum, temperatureStatsEntry=temperatureStatsEntry, cpuCacheSize=cpuCacheSize, f5PlatformStatsObjects=f5PlatformStatsObjects, cpuUtilizationStatsTable=cpuUtilizationStatsTable, cpuCore=cpuCore, coreTotal5secAvg=coreTotal5secAvg, diskSerialNo=diskSerialNo, diskUtilizationStatsEntry=diskUtilizationStatsEntry, fpgaIndex=fpgaIndex, platformCompliance=platformCompliance, cpuTotal5secAvg=cpuTotal5secAvg, fan_10_speed=fan_10_speed, memoryStatsEntry=memoryStatsEntry, platformCpuStatsTable=platformCpuStatsTable, diskWriteMerged=diskWriteMerged, cpuStepping=cpuStepping, fan_1_speed=fan_1_speed, platformFwVersionGroup=platformFwVersionGroup, platformTempGroup=platformTempGroup, tempCurrent=tempCurrent, cpuCoreStatsEntry=cpuCoreStatsEntry, diskVendor=diskVendor, String=String, diskTotalIops=diskTotalIops, cpuProcessorStatsTable=cpuProcessorStatsTable, memoryStatsTable=memoryStatsTable, memPlatformUsed=memPlatformUsed, diskVersion=diskVersion, fwName=fwName, fan_12_speed=fan_12_speed, cpuCoreStatsTable=cpuCoreStatsTable, fan_6_speed=fan_6_speed, fan_3_speed=fan_3_speed, fwUpdateStatus=fwUpdateStatus, diskModel=diskModel, temperatureStatsTable=temperatureStatsTable, fwTable=fwTable, f5PlatformStats=f5PlatformStats, platformMemGroup=platformMemGroup, platformDiskStatsTable=platformDiskStatsTable, coreName=coreName, platformConformance=platformConformance, cpuThreadCnt=cpuThreadCnt, fwEntry=fwEntry, cpuModelName=cpuModelName, platformFpgaGroup=platformFpgaGroup, PlatformStatsIndex=PlatformStatsIndex, diskWriteBytes=diskWriteBytes, cpuIndex=cpuIndex, coreCurrent=coreCurrent, diskSize=diskSize, memPercentageUsed=memPercentageUsed, platformCPUGroup=platformCPUGroup, platformFwTable=platformFwTable, memFree=memFree, cpuCurrent=cpuCurrent, platformMemoryStatsTable=platformMemoryStatsTable, diskInfoTable=diskInfoTable, fan_9_speed=fan_9_speed, fan_4_speed=fan_4_speed, platformFantrayTable=platformFantrayTable, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, cpuTotal5minAvg=cpuTotal5minAvg, PYSNMP_MODULE_ID=f5PlatformStats, tempAverage=tempAverage, memPlatformTotal=memPlatformTotal, fan_11_speed=fan_11_speed, fantrayStatsEntry=fantrayStatsEntry, diskReadMerged=diskReadMerged, platformFantrayGroup=platformFantrayGroup, fantrayStatsTable=fantrayStatsTable, diskInfoEntry=diskInfoEntry, diskName=diskName, cpuFreq=cpuFreq, platformTemperatureTable=platformTemperatureTable, fan_5_speed=fan_5_speed, fan_7_speed=fan_7_speed, cpuCoreCnt=cpuCoreCnt, diskUtilizationStatsTable=diskUtilizationStatsTable, diskReadBytes=diskReadBytes, diskPercentageUsed=diskPercentageUsed, fpgaEntry=fpgaEntry, diskWriteIops=diskWriteIops, platformGroups=platformGroups, coreIndex=coreIndex, coreTotal5minAvg=coreTotal5minAvg, fan_2_speed=fan_2_speed, cpuTotal1minAvg=cpuTotal1minAvg, memAvailable=memAvailable, platformCompliances=platformCompliances, diskReadIops=diskReadIops, fpgaVersion=fpgaVersion, diskType=diskType, fan_8_speed=fan_8_speed, index=index, coreTotal1minAvg=coreTotal1minAvg, diskReadLatencyMs=diskReadLatencyMs, fwVersion=fwVersion, fpgaTable=fpgaTable)
