...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", diskWriteMerged=diskWriteMerged, diskPercentageUsed=diskPercentageUsed, platformConformance=platformConformance, fan_12_speed=fan_12_speed, fan_4_speed=fan_4_speed, fwUpdateStatus=fwUpdateStatus, cpuIndex=cpuIndex, cpuFreq=cpuFreq, cpuCore=cpuCore, fan_8_speed=fan_8_speed, diskInfoEntry=diskInfoEntry, fan_1_speed=fan_1_speed, PYSNMP_MODULE_ID=f5PlatformStats, diskUtilizationStatsTable=diskUtilizationStatsTable, coreTotal5secAvg=coreTotal5secAvg, cpuUtilizationStatsTable=cpuUtilizationStatsTable, cpuCoreCnt=cpuCoreCnt, platformFwTable=platformFwTable, cpuCoreStatsEntry=cpuCoreStatsEntry, diskTotalIops=diskTotalIops, memPlatformTotal=memPlatformTotal, platformFantrayGroup=platformFantrayGroup, diskReadLatencyMs=diskReadLatencyMs, platformCpuStatsTable=platformCpuStatsTable, platformTempGroup=platformTempGroup, platformCompliance=platformCompliance, platformFpgaGroup=platformFpgaGroup, coreTotal5minAvg=coreTotal5minAvg, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, cpuProcessorStatsTable=cpuProcessorStatsTable, temperatureStatsTable=temperatureStatsTable, platformGroups=platformGroups, f5PlatformStatsObjects=f5PlatformStatsObjects, index=index, diskVendor=diskVendor, diskType=diskType, fan_5_speed=fan_5_speed, diskVersion=diskVersion, cpuCurrent=cpuCurrent, fan_2_speed=fan_2_speed, platformFantrayTable=platformFantrayTable, cpuTotal1minAvg=cpuTotal1minAvg, platformDiskGroup=platformDiskGroup, cpuTotal5minAvg=cpuTotal5minAvg, platformTemperatureTable=platformTemperatureTable, memPlatformUsed=memPlatformUsed, PlatformStatsIndex=PlatformStatsIndex, diskWriteLatencyMs=diskWriteLatencyMs, platformFpgaTable=platformFpgaTable, coreTotal1minAvg=coreTotal1minAvg, cpuProcessorStatsEntry=cpuProcessorStatsEntry, diskSerialNo=diskSerialNo, fwTable=fwTable, fan_7_speed=fan_7_speed, coreCurrent=coreCurrent, memPercentageUsed=memPercentageUsed, diskSize=diskSize, fan_10_speed=fan_10_speed, memoryStatsEntry=memoryStatsEntry, fan_9_speed=fan_9_speed, diskWriteIops=diskWriteIops, cpuTotal5secAvg=cpuTotal5secAvg, diskReadBytes=diskReadBytes, tempMaximum=tempMaximum, cpuModelName=cpuModelName, diskModel=diskModel, cpuThreadCnt=cpuThreadCnt, cpuCoreStatsTable=cpuCoreStatsTable, diskInfoTable=diskInfoTable, memoryStatsTable=memoryStatsTable, coreIndex=coreIndex, tempAverage=tempAverage, fpgaIndex=fpgaIndex, fan_6_speed=fan_6_speed, fan_3_speed=fan_3_speed, platformDiskStatsTable=platformDiskStatsTable, fwName=fwName, platformFwVersionGroup=platformFwVersionGroup, fwEntry=fwEntry, fpgaVersion=fpgaVersion, fan_11_speed=fan_11_speed, platformMemGroup=platformMemGroup, fwVersion=fwVersion, diskName=diskName, fantrayStatsTable=fantrayStatsTable, memFree=memFree, platformCompliances=platformCompliances, fantrayStatsEntry=fantrayStatsEntry, cpuStepping=cpuStepping, fpgaEntry=fpgaEntry, diskReadIops=diskReadIops, diskWriteBytes=diskWriteBytes, tempMinimum=tempMinimum, f5PlatformStats=f5PlatformStats, platformMemoryStatsTable=platformMemoryStatsTable, temperatureStatsEntry=temperatureStatsEntry, cpuCacheSize=cpuCacheSize, memAvailable=memAvailable, diskReadMerged=diskReadMerged, configurable=configurable, coreName=coreName, fpgaTable=fpgaTable, tempCurrent=tempCurrent, String=String, platformCPUGroup=platformCPUGroup, diskUtilizationStatsEntry=diskUtilizationStatsEntry)
