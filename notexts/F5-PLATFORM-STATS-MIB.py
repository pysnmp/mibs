...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", diskVendor=diskVendor, cpuProcessorStatsEntry=cpuProcessorStatsEntry, diskWriteIops=diskWriteIops, diskWriteMerged=diskWriteMerged, memPercentageUsed=memPercentageUsed, fan_5_speed=fan_5_speed, diskReadBytes=diskReadBytes, fan_2_speed=fan_2_speed, platformCpuStatsTable=platformCpuStatsTable, fantrayStatsEntry=fantrayStatsEntry, coreTotal1minAvg=coreTotal1minAvg, diskReadLatencyMs=diskReadLatencyMs, diskSerialNo=diskSerialNo, cpuUtilizationStatsTable=cpuUtilizationStatsTable, fan_1_speed=fan_1_speed, cpuCacheSize=cpuCacheSize, fantrayStatsTable=fantrayStatsTable, configurable=configurable, diskInfoTable=diskInfoTable, diskUtilizationStatsTable=diskUtilizationStatsTable, platformFantrayGroup=platformFantrayGroup, temperatureStatsTable=temperatureStatsTable, platformMemGroup=platformMemGroup, platformFwTable=platformFwTable, platformDiskGroup=platformDiskGroup, diskName=diskName, fan_9_speed=fan_9_speed, diskSize=diskSize, platformTempGroup=platformTempGroup, diskWriteBytes=diskWriteBytes, platformDiskStatsTable=platformDiskStatsTable, fpgaEntry=fpgaEntry, cpuCurrent=cpuCurrent, platformFpgaTable=platformFpgaTable, diskInfoEntry=diskInfoEntry, fwName=fwName, fan_3_speed=fan_3_speed, coreTotal5minAvg=coreTotal5minAvg, platformCompliances=platformCompliances, diskReadIops=diskReadIops, coreIndex=coreIndex, f5PlatformStats=f5PlatformStats, tempMaximum=tempMaximum, diskTotalIops=diskTotalIops, platformFantrayTable=platformFantrayTable, fpgaVersion=fpgaVersion, fwTable=fwTable, fan_11_speed=fan_11_speed, fwEntry=fwEntry, memPlatformTotal=memPlatformTotal, index=index, coreName=coreName, cpuCoreStatsEntry=cpuCoreStatsEntry, cpuCoreCnt=cpuCoreCnt, diskPercentageUsed=diskPercentageUsed, coreCurrent=coreCurrent, diskWriteLatencyMs=diskWriteLatencyMs, diskVersion=diskVersion, diskUtilizationStatsEntry=diskUtilizationStatsEntry, cpuIndex=cpuIndex, temperatureStatsEntry=temperatureStatsEntry, fan_4_speed=fan_4_speed, fan_6_speed=fan_6_speed, PlatformStatsIndex=PlatformStatsIndex, cpuCore=cpuCore, PYSNMP_MODULE_ID=f5PlatformStats, coreTotal5secAvg=coreTotal5secAvg, fwVersion=fwVersion, fan_12_speed=fan_12_speed, cpuThreadCnt=cpuThreadCnt, cpuTotal5minAvg=cpuTotal5minAvg, cpuTotal1minAvg=cpuTotal1minAvg, f5PlatformStatsObjects=f5PlatformStatsObjects, cpuTotal5secAvg=cpuTotal5secAvg, diskType=diskType, fan_8_speed=fan_8_speed, platformFpgaGroup=platformFpgaGroup, fan_10_speed=fan_10_speed, String=String, memFree=memFree, fpgaIndex=fpgaIndex, tempCurrent=tempCurrent, memAvailable=memAvailable, cpuFreq=cpuFreq, fpgaTable=fpgaTable, tempMinimum=tempMinimum, cpuStepping=cpuStepping, cpuCoreStatsTable=cpuCoreStatsTable, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, cpuModelName=cpuModelName, fwUpdateStatus=fwUpdateStatus, tempAverage=tempAverage, diskModel=diskModel, platformCPUGroup=platformCPUGroup, platformGroups=platformGroups, cpuProcessorStatsTable=cpuProcessorStatsTable, fan_7_speed=fan_7_speed, platformTemperatureTable=platformTemperatureTable, platformMemoryStatsTable=platformMemoryStatsTable, platformCompliance=platformCompliance, memPlatformUsed=memPlatformUsed, memoryStatsEntry=memoryStatsEntry, platformFwVersionGroup=platformFwVersionGroup, diskReadMerged=diskReadMerged, memoryStatsTable=memoryStatsTable, platformConformance=platformConformance)
