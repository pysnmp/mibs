...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", String=String, diskTotalIops=diskTotalIops, diskWriteIops=diskWriteIops, fwVersion=fwVersion, platformFantrayGroup=platformFantrayGroup, memPlatformTotal=memPlatformTotal, fantrayStatsTable=fantrayStatsTable, cpuCoreCnt=cpuCoreCnt, tempCurrent=tempCurrent, fan_4_speed=fan_4_speed, cpuCacheSize=cpuCacheSize, fantrayStatsEntry=fantrayStatsEntry, platformGroups=platformGroups, fan_6_speed=fan_6_speed, diskInfoEntry=diskInfoEntry, memPercentageUsed=memPercentageUsed, coreName=coreName, platformTemperatureTable=platformTemperatureTable, f5PlatformStatsObjects=f5PlatformStatsObjects, cpuIndex=cpuIndex, fwTable=fwTable, platformFwVersionGroup=platformFwVersionGroup, platformTempGroup=platformTempGroup, diskWriteMerged=diskWriteMerged, tempMinimum=tempMinimum, diskUtilizationStatsEntry=diskUtilizationStatsEntry, f5PlatformStats=f5PlatformStats, diskReadMerged=diskReadMerged, cpuThreadCnt=cpuThreadCnt, diskSerialNo=diskSerialNo, platformMemGroup=platformMemGroup, cpuProcessorStatsTable=cpuProcessorStatsTable, fan_7_speed=fan_7_speed, fan_9_speed=fan_9_speed, memoryStatsEntry=memoryStatsEntry, fan_11_speed=fan_11_speed, cpuFreq=cpuFreq, memoryStatsTable=memoryStatsTable, fwName=fwName, fan_5_speed=fan_5_speed, platformFwTable=platformFwTable, platformMemoryStatsTable=platformMemoryStatsTable, coreTotal1minAvg=coreTotal1minAvg, cpuModelName=cpuModelName, fpgaVersion=fpgaVersion, cpuTotal5minAvg=cpuTotal5minAvg, fan_1_speed=fan_1_speed, diskUtilizationStatsTable=diskUtilizationStatsTable, platformCpuStatsTable=platformCpuStatsTable, cpuStepping=cpuStepping, platformCompliances=platformCompliances, memPlatformUsed=memPlatformUsed, coreCurrent=coreCurrent, platformCPUGroup=platformCPUGroup, diskModel=diskModel, fpgaEntry=fpgaEntry, fan_12_speed=fan_12_speed, platformDiskGroup=platformDiskGroup, fan_10_speed=fan_10_speed, diskType=diskType, temperatureStatsTable=temperatureStatsTable, platformConformance=platformConformance, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, diskReadIops=diskReadIops, coreTotal5secAvg=coreTotal5secAvg, diskReadBytes=diskReadBytes, platformDiskStatsTable=platformDiskStatsTable, diskName=diskName, tempAverage=tempAverage, fwEntry=fwEntry, fan_8_speed=fan_8_speed, diskVersion=diskVersion, index=index, memAvailable=memAvailable, cpuUtilizationStatsTable=cpuUtilizationStatsTable, configurable=configurable, platformCompliance=platformCompliance, cpuCore=cpuCore, diskReadLatencyMs=diskReadLatencyMs, fpgaTable=fpgaTable, fan_3_speed=fan_3_speed, cpuCoreStatsTable=cpuCoreStatsTable, cpuTotal5secAvg=cpuTotal5secAvg, coreTotal5minAvg=coreTotal5minAvg, platformFpgaGroup=platformFpgaGroup, PYSNMP_MODULE_ID=f5PlatformStats, cpuCoreStatsEntry=cpuCoreStatsEntry, tempMaximum=tempMaximum, PlatformStatsIndex=PlatformStatsIndex, diskWriteLatencyMs=diskWriteLatencyMs, platformFpgaTable=platformFpgaTable, cpuProcessorStatsEntry=cpuProcessorStatsEntry, diskWriteBytes=diskWriteBytes, temperatureStatsEntry=temperatureStatsEntry, cpuTotal1minAvg=cpuTotal1minAvg, diskInfoTable=diskInfoTable, diskSize=diskSize, coreIndex=coreIndex, fwUpdateStatus=fwUpdateStatus, fan_2_speed=fan_2_speed, diskPercentageUsed=diskPercentageUsed, cpuCurrent=cpuCurrent, fpgaIndex=fpgaIndex, diskVendor=diskVendor, memFree=memFree, platformFantrayTable=platformFantrayTable)
