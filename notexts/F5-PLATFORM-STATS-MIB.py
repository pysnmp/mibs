...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", fan_10_speed=fan_10_speed, tempMinimum=tempMinimum, fan_9_speed=fan_9_speed, diskModel=diskModel, platformFwVersionGroup=platformFwVersionGroup, platformConformance=platformConformance, tempMaximum=tempMaximum, platformFantrayTable=platformFantrayTable, memPercentageUsed=memPercentageUsed, memPlatformUsed=memPlatformUsed, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, diskReadIops=diskReadIops, fpgaTable=fpgaTable, diskPercentageUsed=diskPercentageUsed, platformDiskStatsTable=platformDiskStatsTable, platformMemGroup=platformMemGroup, fwVersion=fwVersion, cpuTotal5secAvg=cpuTotal5secAvg, tempAverage=tempAverage, fantrayStatsTable=fantrayStatsTable, f5PlatformStatsObjects=f5PlatformStatsObjects, cpuCoreStatsEntry=cpuCoreStatsEntry, cpuFreq=cpuFreq, f5PlatformStats=f5PlatformStats, diskReadMerged=diskReadMerged, fan_2_speed=fan_2_speed, PlatformStatsIndex=PlatformStatsIndex, temperatureStatsEntry=temperatureStatsEntry, PYSNMP_MODULE_ID=f5PlatformStats, cpuProcessorStatsEntry=cpuProcessorStatsEntry, fan_12_speed=fan_12_speed, coreIndex=coreIndex, platformFantrayGroup=platformFantrayGroup, fan_1_speed=fan_1_speed, cpuTotal1minAvg=cpuTotal1minAvg, coreCurrent=coreCurrent, diskWriteLatencyMs=diskWriteLatencyMs, diskReadBytes=diskReadBytes, coreTotal1minAvg=coreTotal1minAvg, fantrayStatsEntry=fantrayStatsEntry, fan_8_speed=fan_8_speed, tempCurrent=tempCurrent, platformFwTable=platformFwTable, cpuCurrent=cpuCurrent, diskType=diskType, diskSerialNo=diskSerialNo, coreName=coreName, cpuTotal5minAvg=cpuTotal5minAvg, fpgaIndex=fpgaIndex, cpuIndex=cpuIndex, cpuModelName=cpuModelName, diskVendor=diskVendor, diskVersion=diskVersion, platformCompliance=platformCompliance, platformFpgaTable=platformFpgaTable, diskName=diskName, cpuProcessorStatsTable=cpuProcessorStatsTable, fwTable=fwTable, platformMemoryStatsTable=platformMemoryStatsTable, cpuThreadCnt=cpuThreadCnt, diskWriteBytes=diskWriteBytes, platformCompliances=platformCompliances, fan_11_speed=fan_11_speed, platformTempGroup=platformTempGroup, configurable=configurable, fan_5_speed=fan_5_speed, fwEntry=fwEntry, platformCPUGroup=platformCPUGroup, coreTotal5minAvg=coreTotal5minAvg, fan_7_speed=fan_7_speed, cpuCore=cpuCore, cpuStepping=cpuStepping, fan_3_speed=fan_3_speed, memoryStatsTable=memoryStatsTable, cpuUtilizationStatsTable=cpuUtilizationStatsTable, memFree=memFree, fan_4_speed=fan_4_speed, fwName=fwName, diskTotalIops=diskTotalIops, diskReadLatencyMs=diskReadLatencyMs, platformFpgaGroup=platformFpgaGroup, String=String, diskWriteMerged=diskWriteMerged, diskUtilizationStatsTable=diskUtilizationStatsTable, cpuCoreCnt=cpuCoreCnt, memPlatformTotal=memPlatformTotal, temperatureStatsTable=temperatureStatsTable, diskInfoTable=diskInfoTable, memoryStatsEntry=memoryStatsEntry, fpgaEntry=fpgaEntry, diskInfoEntry=diskInfoEntry, cpuCacheSize=cpuCacheSize, diskWriteIops=diskWriteIops, index=index, platformDiskGroup=platformDiskGroup, fwUpdateStatus=fwUpdateStatus, fpgaVersion=fpgaVersion, coreTotal5secAvg=coreTotal5secAvg, platformCpuStatsTable=platformCpuStatsTable, memAvailable=memAvailable, platformGroups=platformGroups, diskUtilizationStatsEntry=diskUtilizationStatsEntry, fan_6_speed=fan_6_speed, diskSize=diskSize, cpuCoreStatsTable=cpuCoreStatsTable, platformTemperatureTable=platformTemperatureTable)
