...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", diskReadMerged=diskReadMerged, String=String, diskInfoEntry=diskInfoEntry, platformDiskGroup=platformDiskGroup, platformMemoryStatsTable=platformMemoryStatsTable, index=index, coreName=coreName, diskSerialNo=diskSerialNo, cpuUtilizationStatsTable=cpuUtilizationStatsTable, fan_6_speed=fan_6_speed, diskVendor=diskVendor, fwUpdateStatus=fwUpdateStatus, memPlatformUsed=memPlatformUsed, fan_7_speed=fan_7_speed, diskReadBytes=diskReadBytes, fan_3_speed=fan_3_speed, temperatureStatsTable=temperatureStatsTable, temperatureStatsEntry=temperatureStatsEntry, cpuTotal5secAvg=cpuTotal5secAvg, platformFwVersionGroup=platformFwVersionGroup, diskReadIops=diskReadIops, fantrayStatsTable=fantrayStatsTable, fwEntry=fwEntry, f5PlatformStatsObjects=f5PlatformStatsObjects, cpuCoreStatsTable=cpuCoreStatsTable, PlatformStatsIndex=PlatformStatsIndex, cpuCoreStatsEntry=cpuCoreStatsEntry, platformFantrayTable=platformFantrayTable, cpuThreadCnt=cpuThreadCnt, platformFwTable=platformFwTable, diskName=diskName, fpgaEntry=fpgaEntry, fan_2_speed=fan_2_speed, cpuProcessorStatsEntry=cpuProcessorStatsEntry, tempAverage=tempAverage, coreCurrent=coreCurrent, diskPercentageUsed=diskPercentageUsed, fpgaIndex=fpgaIndex, memoryStatsEntry=memoryStatsEntry, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, tempMinimum=tempMinimum, fwVersion=fwVersion, fan_8_speed=fan_8_speed, cpuCore=cpuCore, fan_4_speed=fan_4_speed, tempCurrent=tempCurrent, diskModel=diskModel, fwTable=fwTable, platformDiskStatsTable=platformDiskStatsTable, platformCompliances=platformCompliances, platformFpgaGroup=platformFpgaGroup, platformConformance=platformConformance, cpuCacheSize=cpuCacheSize, platformTemperatureTable=platformTemperatureTable, diskReadLatencyMs=diskReadLatencyMs, platformTempGroup=platformTempGroup, platformFantrayGroup=platformFantrayGroup, cpuCurrent=cpuCurrent, memAvailable=memAvailable, cpuTotal1minAvg=cpuTotal1minAvg, fan_1_speed=fan_1_speed, diskWriteIops=diskWriteIops, fwName=fwName, platformCPUGroup=platformCPUGroup, diskUtilizationStatsEntry=diskUtilizationStatsEntry, cpuProcessorStatsTable=cpuProcessorStatsTable, cpuModelName=cpuModelName, tempMaximum=tempMaximum, memFree=memFree, f5PlatformStats=f5PlatformStats, memPercentageUsed=memPercentageUsed, fan_5_speed=fan_5_speed, coreTotal1minAvg=coreTotal1minAvg, fan_12_speed=fan_12_speed, platformFpgaTable=platformFpgaTable, fpgaVersion=fpgaVersion, diskSize=diskSize, fan_10_speed=fan_10_speed, platformMemGroup=platformMemGroup, coreIndex=coreIndex, cpuCoreCnt=cpuCoreCnt, fantrayStatsEntry=fantrayStatsEntry, diskWriteLatencyMs=diskWriteLatencyMs, diskWriteBytes=diskWriteBytes, PYSNMP_MODULE_ID=f5PlatformStats, configurable=configurable, fan_11_speed=fan_11_speed, platformCompliance=platformCompliance, diskType=diskType, platformCpuStatsTable=platformCpuStatsTable, diskUtilizationStatsTable=diskUtilizationStatsTable, diskInfoTable=diskInfoTable, diskVersion=diskVersion, coreTotal5minAvg=coreTotal5minAvg, cpuFreq=cpuFreq, platformGroups=platformGroups, coreTotal5secAvg=coreTotal5secAvg, cpuStepping=cpuStepping, memPlatformTotal=memPlatformTotal, diskTotalIops=diskTotalIops, memoryStatsTable=memoryStatsTable, fpgaTable=fpgaTable, cpuIndex=cpuIndex, cpuTotal5minAvg=cpuTotal5minAvg, fan_9_speed=fan_9_speed, diskWriteMerged=diskWriteMerged)
