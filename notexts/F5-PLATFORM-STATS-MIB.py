...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", fan_11_speed=fan_11_speed, platformFpgaGroup=platformFpgaGroup, diskUtilizationStatsEntry=diskUtilizationStatsEntry, coreIndex=coreIndex, fan_6_speed=fan_6_speed, cpuCoreStatsEntry=cpuCoreStatsEntry, cpuUtilizationStatsTable=cpuUtilizationStatsTable, fantrayStatsTable=fantrayStatsTable, f5PlatformStatsObjects=f5PlatformStatsObjects, diskVendor=diskVendor, platformTemperatureTable=platformTemperatureTable, fpgaTable=fpgaTable, cpuCore=cpuCore, memAvailable=memAvailable, memFree=memFree, fan_3_speed=fan_3_speed, fan_12_speed=fan_12_speed, diskWriteMerged=diskWriteMerged, platformCompliance=platformCompliance, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, diskReadIops=diskReadIops, platformCpuStatsTable=platformCpuStatsTable, cpuStepping=cpuStepping, cpuIndex=cpuIndex, memoryStatsTable=memoryStatsTable, diskSerialNo=diskSerialNo, temperatureStatsTable=temperatureStatsTable, platformFantrayTable=platformFantrayTable, tempCurrent=tempCurrent, fan_4_speed=fan_4_speed, fan_9_speed=fan_9_speed, diskModel=diskModel, fpgaIndex=fpgaIndex, diskReadLatencyMs=diskReadLatencyMs, platformDiskGroup=platformDiskGroup, cpuFreq=cpuFreq, tempMaximum=tempMaximum, platformFantrayGroup=platformFantrayGroup, diskWriteBytes=diskWriteBytes, cpuCacheSize=cpuCacheSize, platformGroups=platformGroups, diskName=diskName, fan_10_speed=fan_10_speed, diskInfoEntry=diskInfoEntry, diskReadBytes=diskReadBytes, String=String, PlatformStatsIndex=PlatformStatsIndex, cpuCurrent=cpuCurrent, memoryStatsEntry=memoryStatsEntry, temperatureStatsEntry=temperatureStatsEntry, coreTotal5secAvg=coreTotal5secAvg, cpuThreadCnt=cpuThreadCnt, fpgaEntry=fpgaEntry, memPlatformTotal=memPlatformTotal, fantrayStatsEntry=fantrayStatsEntry, cpuProcessorStatsEntry=cpuProcessorStatsEntry, index=index, diskInfoTable=diskInfoTable, configurable=configurable, cpuCoreStatsTable=cpuCoreStatsTable, fan_5_speed=fan_5_speed, diskPercentageUsed=diskPercentageUsed, fwName=fwName, platformFwTable=platformFwTable, cpuCoreCnt=cpuCoreCnt, platformMemGroup=platformMemGroup, platformCompliances=platformCompliances, diskType=diskType, diskUtilizationStatsTable=diskUtilizationStatsTable, fan_8_speed=fan_8_speed, platformCPUGroup=platformCPUGroup, platformFpgaTable=platformFpgaTable, platformDiskStatsTable=platformDiskStatsTable, platformMemoryStatsTable=platformMemoryStatsTable, memPlatformUsed=memPlatformUsed, diskSize=diskSize, fwEntry=fwEntry, diskWriteIops=diskWriteIops, fwVersion=fwVersion, tempMinimum=tempMinimum, platformFwVersionGroup=platformFwVersionGroup, memPercentageUsed=memPercentageUsed, coreCurrent=coreCurrent, diskTotalIops=diskTotalIops, cpuModelName=cpuModelName, coreName=coreName, fan_1_speed=fan_1_speed, coreTotal1minAvg=coreTotal1minAvg, diskVersion=diskVersion, fwTable=fwTable, f5PlatformStats=f5PlatformStats, cpuTotal1minAvg=cpuTotal1minAvg, cpuTotal5minAvg=cpuTotal5minAvg, fpgaVersion=fpgaVersion, platformTempGroup=platformTempGroup, platformConformance=platformConformance, tempAverage=tempAverage, PYSNMP_MODULE_ID=f5PlatformStats, cpuProcessorStatsTable=cpuProcessorStatsTable, diskReadMerged=diskReadMerged, cpuTotal5secAvg=cpuTotal5secAvg, diskWriteLatencyMs=diskWriteLatencyMs, fan_2_speed=fan_2_speed, fwUpdateStatus=fwUpdateStatus, coreTotal5minAvg=coreTotal5minAvg, fan_7_speed=fan_7_speed)
