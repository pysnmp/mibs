...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", platformFwVersionGroup=platformFwVersionGroup, fpgaIndex=fpgaIndex, tempMaximum=tempMaximum, diskReadBytes=diskReadBytes, diskPercentageUsed=diskPercentageUsed, platformMemGroup=platformMemGroup, diskReadLatencyMs=diskReadLatencyMs, fan_3_speed=fan_3_speed, diskUtilizationStatsTable=diskUtilizationStatsTable, fantrayStatsTable=fantrayStatsTable, PlatformStatsIndex=PlatformStatsIndex, coreTotal5secAvg=coreTotal5secAvg, temperatureStatsEntry=temperatureStatsEntry, fwVersion=fwVersion, cpuUtilizationStatsTable=cpuUtilizationStatsTable, cpuProcessorStatsEntry=cpuProcessorStatsEntry, diskInfoTable=diskInfoTable, diskName=diskName, platformCompliance=platformCompliance, memFree=memFree, fantrayStatsEntry=fantrayStatsEntry, fan_2_speed=fan_2_speed, configurable=configurable, memPlatformUsed=memPlatformUsed, diskWriteLatencyMs=diskWriteLatencyMs, fwEntry=fwEntry, tempCurrent=tempCurrent, fan_9_speed=fan_9_speed, diskInfoEntry=diskInfoEntry, fan_8_speed=fan_8_speed, f5PlatformStats=f5PlatformStats, fan_4_speed=fan_4_speed, cpuThreadCnt=cpuThreadCnt, fan_11_speed=fan_11_speed, platformConformance=platformConformance, tempMinimum=tempMinimum, platformCompliances=platformCompliances, platformFwTable=platformFwTable, fan_5_speed=fan_5_speed, fan_10_speed=fan_10_speed, cpuStepping=cpuStepping, cpuCore=cpuCore, diskSerialNo=diskSerialNo, temperatureStatsTable=temperatureStatsTable, cpuCoreCnt=cpuCoreCnt, fan_12_speed=fan_12_speed, coreIndex=coreIndex, fan_6_speed=fan_6_speed, fan_7_speed=fan_7_speed, platformDiskGroup=platformDiskGroup, platformCPUGroup=platformCPUGroup, platformFantrayTable=platformFantrayTable, memPlatformTotal=memPlatformTotal, coreCurrent=coreCurrent, cpuCacheSize=cpuCacheSize, platformFpgaGroup=platformFpgaGroup, PYSNMP_MODULE_ID=f5PlatformStats, cpuCoreStatsEntry=cpuCoreStatsEntry, memoryStatsEntry=memoryStatsEntry, platformFantrayGroup=platformFantrayGroup, diskWriteMerged=diskWriteMerged, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, coreName=coreName, fwTable=fwTable, platformGroups=platformGroups, cpuTotal5minAvg=cpuTotal5minAvg, String=String, diskWriteIops=diskWriteIops, f5PlatformStatsObjects=f5PlatformStatsObjects, fwName=fwName, memoryStatsTable=memoryStatsTable, cpuCurrent=cpuCurrent, diskModel=diskModel, tempAverage=tempAverage, cpuTotal1minAvg=cpuTotal1minAvg, diskType=diskType, diskWriteBytes=diskWriteBytes, platformTemperatureTable=platformTemperatureTable, coreTotal1minAvg=coreTotal1minAvg, fpgaVersion=fpgaVersion, cpuIndex=cpuIndex, fpgaTable=fpgaTable, platformFpgaTable=platformFpgaTable, diskSize=diskSize, cpuModelName=cpuModelName, diskVersion=diskVersion, platformMemoryStatsTable=platformMemoryStatsTable, index=index, memPercentageUsed=memPercentageUsed, cpuProcessorStatsTable=cpuProcessorStatsTable, diskReadIops=diskReadIops, platformTempGroup=platformTempGroup, memAvailable=memAvailable, fan_1_speed=fan_1_speed, platformCpuStatsTable=platformCpuStatsTable, fpgaEntry=fpgaEntry, coreTotal5minAvg=coreTotal5minAvg, cpuFreq=cpuFreq, diskReadMerged=diskReadMerged, cpuCoreStatsTable=cpuCoreStatsTable, platformDiskStatsTable=platformDiskStatsTable, fwUpdateStatus=fwUpdateStatus, diskVendor=diskVendor, cpuTotal5secAvg=cpuTotal5secAvg, diskUtilizationStatsEntry=diskUtilizationStatsEntry, diskTotalIops=diskTotalIops)
