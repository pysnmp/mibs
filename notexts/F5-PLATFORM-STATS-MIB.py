...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", fwVersion=fwVersion, cpuTotal5secAvg=cpuTotal5secAvg, fantrayStatsTable=fantrayStatsTable, tempAverage=tempAverage, platformFantrayGroup=platformFantrayGroup, PlatformStatsIndex=PlatformStatsIndex, fpgaTable=fpgaTable, cpuProcessorStatsEntry=cpuProcessorStatsEntry, cpuStepping=cpuStepping, memPlatformTotal=memPlatformTotal, cpuThreadCnt=cpuThreadCnt, platformGroups=platformGroups, fan_7_speed=fan_7_speed, cpuTotal5minAvg=cpuTotal5minAvg, platformDiskStatsTable=platformDiskStatsTable, coreTotal5secAvg=coreTotal5secAvg, diskInfoEntry=diskInfoEntry, diskUtilizationStatsTable=diskUtilizationStatsTable, fan_9_speed=fan_9_speed, diskReadMerged=diskReadMerged, diskReadLatencyMs=diskReadLatencyMs, platformCPUGroup=platformCPUGroup, memPercentageUsed=memPercentageUsed, tempMaximum=tempMaximum, platformDiskGroup=platformDiskGroup, cpuTotal1minAvg=cpuTotal1minAvg, platformTempGroup=platformTempGroup, diskUtilizationStatsEntry=diskUtilizationStatsEntry, platformFwTable=platformFwTable, coreName=coreName, temperatureStatsTable=temperatureStatsTable, memPlatformUsed=memPlatformUsed, temperatureStatsEntry=temperatureStatsEntry, diskWriteIops=diskWriteIops, coreTotal5minAvg=coreTotal5minAvg, cpuCore=cpuCore, memAvailable=memAvailable, platformCompliances=platformCompliances, platformFpgaGroup=platformFpgaGroup, memoryStatsTable=memoryStatsTable, tempMinimum=tempMinimum, diskName=diskName, fan_6_speed=fan_6_speed, diskReadBytes=diskReadBytes, diskWriteLatencyMs=diskWriteLatencyMs, cpuCoreStatsEntry=cpuCoreStatsEntry, platformFwVersionGroup=platformFwVersionGroup, platformCpuStatsTable=platformCpuStatsTable, fpgaEntry=fpgaEntry, coreTotal1minAvg=coreTotal1minAvg, fantrayStatsEntry=fantrayStatsEntry, cpuCoreStatsTable=cpuCoreStatsTable, fan_12_speed=fan_12_speed, cpuCurrent=cpuCurrent, fan_8_speed=fan_8_speed, cpuCacheSize=cpuCacheSize, diskModel=diskModel, index=index, fwUpdateStatus=fwUpdateStatus, cpuIndex=cpuIndex, diskVersion=diskVersion, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, cpuCoreCnt=cpuCoreCnt, diskSize=diskSize, diskVendor=diskVendor, platformCompliance=platformCompliance, platformMemGroup=platformMemGroup, cpuUtilizationStatsTable=cpuUtilizationStatsTable, platformTemperatureTable=platformTemperatureTable, platformFantrayTable=platformFantrayTable, cpuProcessorStatsTable=cpuProcessorStatsTable, memoryStatsEntry=memoryStatsEntry, coreCurrent=coreCurrent, fwName=fwName, diskTotalIops=diskTotalIops, fan_4_speed=fan_4_speed, fwTable=fwTable, PYSNMP_MODULE_ID=f5PlatformStats, diskInfoTable=diskInfoTable, cpuFreq=cpuFreq, platformFpgaTable=platformFpgaTable, diskType=diskType, fan_2_speed=fan_2_speed, coreIndex=coreIndex, fan_1_speed=fan_1_speed, f5PlatformStatsObjects=f5PlatformStatsObjects, memFree=memFree, fwEntry=fwEntry, diskWriteMerged=diskWriteMerged, diskReadIops=diskReadIops, fpgaIndex=fpgaIndex, platformConformance=platformConformance, tempCurrent=tempCurrent, platformMemoryStatsTable=platformMemoryStatsTable, fan_3_speed=fan_3_speed, diskWriteBytes=diskWriteBytes, diskSerialNo=diskSerialNo, fpgaVersion=fpgaVersion, cpuModelName=cpuModelName, configurable=configurable, String=String, fan_10_speed=fan_10_speed, f5PlatformStats=f5PlatformStats, fan_11_speed=fan_11_speed, fan_5_speed=fan_5_speed, diskPercentageUsed=diskPercentageUsed)
