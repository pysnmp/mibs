...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", cpuCoreCnt=cpuCoreCnt, fpgaVersion=fpgaVersion, diskInfoEntry=diskInfoEntry, diskModel=diskModel, memFree=memFree, diskPercentageUsed=diskPercentageUsed, cpuProcessorStatsTable=cpuProcessorStatsTable, fan_8_speed=fan_8_speed, String=String, cpuUtilizationStatsTable=cpuUtilizationStatsTable, platformCPUGroup=platformCPUGroup, configurable=configurable, platformFantrayTable=platformFantrayTable, fan_4_speed=fan_4_speed, cpuTotal5secAvg=cpuTotal5secAvg, diskReadIops=diskReadIops, cpuTotal5minAvg=cpuTotal5minAvg, tempAverage=tempAverage, fwTable=fwTable, platformFwVersionGroup=platformFwVersionGroup, fan_7_speed=fan_7_speed, platformFantrayGroup=platformFantrayGroup, memAvailable=memAvailable, platformDiskStatsTable=platformDiskStatsTable, fan_2_speed=fan_2_speed, coreCurrent=coreCurrent, platformFpgaGroup=platformFpgaGroup, memPlatformTotal=memPlatformTotal, diskSerialNo=diskSerialNo, fan_10_speed=fan_10_speed, fwEntry=fwEntry, coreIndex=coreIndex, f5PlatformStatsObjects=f5PlatformStatsObjects, platformTemperatureTable=platformTemperatureTable, temperatureStatsTable=temperatureStatsTable, platformFwTable=platformFwTable, diskWriteBytes=diskWriteBytes, tempCurrent=tempCurrent, tempMaximum=tempMaximum, coreTotal5secAvg=coreTotal5secAvg, PYSNMP_MODULE_ID=f5PlatformStats, platformMemGroup=platformMemGroup, temperatureStatsEntry=temperatureStatsEntry, fwUpdateStatus=fwUpdateStatus, fan_11_speed=fan_11_speed, diskWriteIops=diskWriteIops, diskUtilizationStatsTable=diskUtilizationStatsTable, cpuCoreStatsTable=cpuCoreStatsTable, fan_9_speed=fan_9_speed, diskSize=diskSize, platformDiskGroup=platformDiskGroup, diskType=diskType, diskInfoTable=diskInfoTable, platformGroups=platformGroups, fwVersion=fwVersion, fpgaEntry=fpgaEntry, coreTotal5minAvg=coreTotal5minAvg, fan_12_speed=fan_12_speed, cpuCoreStatsEntry=cpuCoreStatsEntry, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, fan_1_speed=fan_1_speed, platformCompliance=platformCompliance, diskReadMerged=diskReadMerged, f5PlatformStats=f5PlatformStats, cpuCore=cpuCore, fan_3_speed=fan_3_speed, cpuProcessorStatsEntry=cpuProcessorStatsEntry, cpuStepping=cpuStepping, platformCpuStatsTable=platformCpuStatsTable, platformFpgaTable=platformFpgaTable, platformConformance=platformConformance, diskVersion=diskVersion, PlatformStatsIndex=PlatformStatsIndex, platformMemoryStatsTable=platformMemoryStatsTable, diskReadLatencyMs=diskReadLatencyMs, fpgaTable=fpgaTable, cpuIndex=cpuIndex, diskVendor=diskVendor, memPlatformUsed=memPlatformUsed, diskWriteMerged=diskWriteMerged, diskUtilizationStatsEntry=diskUtilizationStatsEntry, fwName=fwName, memoryStatsEntry=memoryStatsEntry, memPercentageUsed=memPercentageUsed, memoryStatsTable=memoryStatsTable, fantrayStatsTable=fantrayStatsTable, coreTotal1minAvg=coreTotal1minAvg, fan_5_speed=fan_5_speed, platformCompliances=platformCompliances, diskTotalIops=diskTotalIops, index=index, cpuThreadCnt=cpuThreadCnt, fantrayStatsEntry=fantrayStatsEntry, diskWriteLatencyMs=diskWriteLatencyMs, platformTempGroup=platformTempGroup, diskReadBytes=diskReadBytes, cpuModelName=cpuModelName, coreName=coreName, fan_6_speed=fan_6_speed, diskName=diskName, cpuCacheSize=cpuCacheSize, cpuTotal1minAvg=cpuTotal1minAvg, tempMinimum=tempMinimum, fpgaIndex=fpgaIndex, cpuCurrent=cpuCurrent, cpuFreq=cpuFreq)
