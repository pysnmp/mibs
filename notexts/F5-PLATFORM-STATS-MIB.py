...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", platformFpgaGroup=platformFpgaGroup, memFree=memFree, diskWriteLatencyMs=diskWriteLatencyMs, fwVersion=fwVersion, fwEntry=fwEntry, diskSize=diskSize, fwUpdateStatus=fwUpdateStatus, coreTotal5secAvg=coreTotal5secAvg, diskUtilizationStatsTable=diskUtilizationStatsTable, cpuCoreCnt=cpuCoreCnt, cpuCacheSize=cpuCacheSize, fan_9_speed=fan_9_speed, fan_8_speed=fan_8_speed, platformGroups=platformGroups, diskTotalIops=diskTotalIops, fan_12_speed=fan_12_speed, platformDiskGroup=platformDiskGroup, fpgaEntry=fpgaEntry, cpuCoreStatsEntry=cpuCoreStatsEntry, cpuStepping=cpuStepping, memPlatformUsed=memPlatformUsed, coreTotal5minAvg=coreTotal5minAvg, cpuFreq=cpuFreq, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, platformCompliances=platformCompliances, cpuTotal5secAvg=cpuTotal5secAvg, memoryStatsEntry=memoryStatsEntry, fantrayStatsEntry=fantrayStatsEntry, coreName=coreName, diskReadMerged=diskReadMerged, PlatformStatsIndex=PlatformStatsIndex, cpuThreadCnt=cpuThreadCnt, f5PlatformStats=f5PlatformStats, coreTotal1minAvg=coreTotal1minAvg, cpuUtilizationStatsTable=cpuUtilizationStatsTable, diskModel=diskModel, platformCpuStatsTable=platformCpuStatsTable, String=String, diskName=diskName, platformCPUGroup=platformCPUGroup, cpuCoreStatsTable=cpuCoreStatsTable, coreIndex=coreIndex, diskWriteMerged=diskWriteMerged, diskWriteIops=diskWriteIops, fpgaVersion=fpgaVersion, diskReadBytes=diskReadBytes, cpuIndex=cpuIndex, fpgaIndex=fpgaIndex, platformConformance=platformConformance, diskType=diskType, fan_7_speed=fan_7_speed, f5PlatformStatsObjects=f5PlatformStatsObjects, fan_5_speed=fan_5_speed, diskVersion=diskVersion, fan_10_speed=fan_10_speed, temperatureStatsEntry=temperatureStatsEntry, diskVendor=diskVendor, diskReadIops=diskReadIops, diskWriteBytes=diskWriteBytes, fan_2_speed=fan_2_speed, diskSerialNo=diskSerialNo, platformFpgaTable=platformFpgaTable, fan_4_speed=fan_4_speed, cpuCore=cpuCore, fantrayStatsTable=fantrayStatsTable, platformCompliance=platformCompliance, index=index, platformTempGroup=platformTempGroup, platformFantrayGroup=platformFantrayGroup, platformDiskStatsTable=platformDiskStatsTable, fan_1_speed=fan_1_speed, platformMemGroup=platformMemGroup, fan_3_speed=fan_3_speed, memPlatformTotal=memPlatformTotal, cpuCurrent=cpuCurrent, platformFwVersionGroup=platformFwVersionGroup, memoryStatsTable=memoryStatsTable, temperatureStatsTable=temperatureStatsTable, diskInfoTable=diskInfoTable, platformFantrayTable=platformFantrayTable, memAvailable=memAvailable, cpuTotal1minAvg=cpuTotal1minAvg, cpuModelName=cpuModelName, fwTable=fwTable, platformTemperatureTable=platformTemperatureTable, memPercentageUsed=memPercentageUsed, coreCurrent=coreCurrent, tempAverage=tempAverage, platformMemoryStatsTable=platformMemoryStatsTable, tempMinimum=tempMinimum, diskUtilizationStatsEntry=diskUtilizationStatsEntry, fan_11_speed=fan_11_speed, cpuProcessorStatsEntry=cpuProcessorStatsEntry, PYSNMP_MODULE_ID=f5PlatformStats, platformFwTable=platformFwTable, diskInfoEntry=diskInfoEntry, cpuProcessorStatsTable=cpuProcessorStatsTable, fpgaTable=fpgaTable, diskPercentageUsed=diskPercentageUsed, diskReadLatencyMs=diskReadLatencyMs, fwName=fwName, configurable=configurable, cpuTotal5minAvg=cpuTotal5minAvg, tempCurrent=tempCurrent, tempMaximum=tempMaximum, fan_6_speed=fan_6_speed)
