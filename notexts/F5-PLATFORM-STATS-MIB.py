...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", cpuTotal1minAvg=cpuTotal1minAvg, platformConformance=platformConformance, fpgaTable=fpgaTable, coreTotal5secAvg=coreTotal5secAvg, fan_3_speed=fan_3_speed, fan_9_speed=fan_9_speed, cpuProcessorStatsEntry=cpuProcessorStatsEntry, configurable=configurable, temperatureStatsEntry=temperatureStatsEntry, coreName=coreName, fwUpdateStatus=fwUpdateStatus, fan_4_speed=fan_4_speed, platformTempGroup=platformTempGroup, fpgaVersion=fpgaVersion, diskVersion=diskVersion, coreTotal1minAvg=coreTotal1minAvg, fan_7_speed=fan_7_speed, index=index, memFree=memFree, platformFpgaGroup=platformFpgaGroup, fan_1_speed=fan_1_speed, String=String, platformFantrayTable=platformFantrayTable, diskModel=diskModel, diskReadMerged=diskReadMerged, cpuTotal5secAvg=cpuTotal5secAvg, temperatureStatsTable=temperatureStatsTable, diskReadIops=diskReadIops, cpuIndex=cpuIndex, coreCurrent=coreCurrent, tempMaximum=tempMaximum, cpuCoreStatsEntry=cpuCoreStatsEntry, platformCPUGroup=platformCPUGroup, memoryStatsEntry=memoryStatsEntry, fan_2_speed=fan_2_speed, fpgaIndex=fpgaIndex, platformFwVersionGroup=platformFwVersionGroup, tempAverage=tempAverage, fan_12_speed=fan_12_speed, diskPercentageUsed=diskPercentageUsed, diskWriteMerged=diskWriteMerged, fwName=fwName, cpuCoreStatsTable=cpuCoreStatsTable, platformTemperatureTable=platformTemperatureTable, memAvailable=memAvailable, fpgaEntry=fpgaEntry, diskUtilizationStatsTable=diskUtilizationStatsTable, fan_11_speed=fan_11_speed, platformDiskStatsTable=platformDiskStatsTable, platformFpgaTable=platformFpgaTable, cpuProcessorStatsTable=cpuProcessorStatsTable, fantrayStatsTable=fantrayStatsTable, platformFwTable=platformFwTable, coreIndex=coreIndex, fan_5_speed=fan_5_speed, cpuCore=cpuCore, memoryStatsTable=memoryStatsTable, fwEntry=fwEntry, f5PlatformStats=f5PlatformStats, diskReadBytes=diskReadBytes, cpuCoreCnt=cpuCoreCnt, diskWriteLatencyMs=diskWriteLatencyMs, platformCompliances=platformCompliances, cpuStepping=cpuStepping, diskWriteBytes=diskWriteBytes, platformMemoryStatsTable=platformMemoryStatsTable, cpuTotal5minAvg=cpuTotal5minAvg, cpuThreadCnt=cpuThreadCnt, memPercentageUsed=memPercentageUsed, diskSize=diskSize, platformMemGroup=platformMemGroup, fan_8_speed=fan_8_speed, memPlatformUsed=memPlatformUsed, coreTotal5minAvg=coreTotal5minAvg, PlatformStatsIndex=PlatformStatsIndex, diskInfoTable=diskInfoTable, f5PlatformStatsObjects=f5PlatformStatsObjects, diskSerialNo=diskSerialNo, PYSNMP_MODULE_ID=f5PlatformStats, diskVendor=diskVendor, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, diskWriteIops=diskWriteIops, fan_6_speed=fan_6_speed, platformCompliance=platformCompliance, platformFantrayGroup=platformFantrayGroup, diskUtilizationStatsEntry=diskUtilizationStatsEntry, tempMinimum=tempMinimum, cpuCurrent=cpuCurrent, fwTable=fwTable, platformCpuStatsTable=platformCpuStatsTable, diskType=diskType, platformGroups=platformGroups, tempCurrent=tempCurrent, platformDiskGroup=platformDiskGroup, diskReadLatencyMs=diskReadLatencyMs, fan_10_speed=fan_10_speed, cpuCacheSize=cpuCacheSize, cpuFreq=cpuFreq, diskInfoEntry=diskInfoEntry, diskTotalIops=diskTotalIops, cpuUtilizationStatsTable=cpuUtilizationStatsTable, diskName=diskName, cpuModelName=cpuModelName, memPlatformTotal=memPlatformTotal, fantrayStatsEntry=fantrayStatsEntry, fwVersion=fwVersion)
