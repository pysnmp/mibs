...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", cpuProcessorStatsEntry=cpuProcessorStatsEntry, memPlatformTotal=memPlatformTotal, memoryStatsEntry=memoryStatsEntry, fantrayStatsEntry=fantrayStatsEntry, temperatureStatsTable=temperatureStatsTable, f5PlatformStatsObjects=f5PlatformStatsObjects, fwVersion=fwVersion, cpuIndex=cpuIndex, coreTotal5secAvg=coreTotal5secAvg, diskVersion=diskVersion, cpuModelName=cpuModelName, diskInfoEntry=diskInfoEntry, diskUtilizationStatsTable=diskUtilizationStatsTable, cpuCore=cpuCore, diskVendor=diskVendor, tempCurrent=tempCurrent, platformFwVersionGroup=platformFwVersionGroup, diskWriteBytes=diskWriteBytes, platformCompliance=platformCompliance, PYSNMP_MODULE_ID=f5PlatformStats, fwEntry=fwEntry, platformFwTable=platformFwTable, diskTotalIops=diskTotalIops, cpuThreadCnt=cpuThreadCnt, memFree=memFree, platformFpgaGroup=platformFpgaGroup, fan_3_speed=fan_3_speed, cpuTotal1minAvg=cpuTotal1minAvg, cpuFreq=cpuFreq, fantrayStatsTable=fantrayStatsTable, PlatformStatsIndex=PlatformStatsIndex, platformFpgaTable=platformFpgaTable, cpuUtilizationStatsTable=cpuUtilizationStatsTable, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, diskPercentageUsed=diskPercentageUsed, memoryStatsTable=memoryStatsTable, platformDiskGroup=platformDiskGroup, String=String, configurable=configurable, cpuStepping=cpuStepping, fwName=fwName, fan_4_speed=fan_4_speed, coreTotal1minAvg=coreTotal1minAvg, platformConformance=platformConformance, cpuCoreCnt=cpuCoreCnt, cpuTotal5minAvg=cpuTotal5minAvg, fpgaTable=fpgaTable, platformFantrayGroup=platformFantrayGroup, platformCompliances=platformCompliances, cpuCacheSize=cpuCacheSize, fwUpdateStatus=fwUpdateStatus, fwTable=fwTable, coreCurrent=coreCurrent, diskUtilizationStatsEntry=diskUtilizationStatsEntry, memPercentageUsed=memPercentageUsed, diskModel=diskModel, index=index, tempMaximum=tempMaximum, tempAverage=tempAverage, fan_1_speed=fan_1_speed, cpuCurrent=cpuCurrent, tempMinimum=tempMinimum, memPlatformUsed=memPlatformUsed, coreTotal5minAvg=coreTotal5minAvg, cpuCoreStatsTable=cpuCoreStatsTable, diskSerialNo=diskSerialNo, platformCpuStatsTable=platformCpuStatsTable, coreIndex=coreIndex, fan_6_speed=fan_6_speed, fpgaVersion=fpgaVersion, diskReadIops=diskReadIops, coreName=coreName, f5PlatformStats=f5PlatformStats, fan_12_speed=fan_12_speed, diskReadBytes=diskReadBytes, platformTempGroup=platformTempGroup, fan_2_speed=fan_2_speed, platformFantrayTable=platformFantrayTable, platformMemoryStatsTable=platformMemoryStatsTable, cpuTotal5secAvg=cpuTotal5secAvg, cpuProcessorStatsTable=cpuProcessorStatsTable, platformDiskStatsTable=platformDiskStatsTable, fan_8_speed=fan_8_speed, diskType=diskType, fan_9_speed=fan_9_speed, temperatureStatsEntry=temperatureStatsEntry, diskSize=diskSize, diskWriteMerged=diskWriteMerged, platformTemperatureTable=platformTemperatureTable, diskReadMerged=diskReadMerged, diskWriteLatencyMs=diskWriteLatencyMs, platformCPUGroup=platformCPUGroup, fan_7_speed=fan_7_speed, fpgaEntry=fpgaEntry, platformGroups=platformGroups, fan_11_speed=fan_11_speed, diskInfoTable=diskInfoTable, fan_5_speed=fan_5_speed, fan_10_speed=fan_10_speed, diskWriteIops=diskWriteIops, fpgaIndex=fpgaIndex, diskReadLatencyMs=diskReadLatencyMs, memAvailable=memAvailable, platformMemGroup=platformMemGroup, cpuCoreStatsEntry=cpuCoreStatsEntry, diskName=diskName)
