...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", cpuCurrent=cpuCurrent, diskSerialNo=diskSerialNo, fantrayStatsEntry=fantrayStatsEntry, diskWriteBytes=diskWriteBytes, fpgaTable=fpgaTable, configurable=configurable, platformDiskStatsTable=platformDiskStatsTable, fpgaIndex=fpgaIndex, diskVendor=diskVendor, diskUtilizationStatsEntry=diskUtilizationStatsEntry, tempCurrent=tempCurrent, memFree=memFree, platformTempGroup=platformTempGroup, diskName=diskName, memoryStatsTable=memoryStatsTable, platformGroups=platformGroups, platformConformance=platformConformance, cpuUtilizationStatsTable=cpuUtilizationStatsTable, f5PlatformStats=f5PlatformStats, fwName=fwName, fan_11_speed=fan_11_speed, fan_12_speed=fan_12_speed, diskVersion=diskVersion, tempMinimum=tempMinimum, String=String, coreTotal5secAvg=coreTotal5secAvg, fan_1_speed=fan_1_speed, fan_8_speed=fan_8_speed, diskUtilizationStatsTable=diskUtilizationStatsTable, memPlatformUsed=memPlatformUsed, cpuFreq=cpuFreq, tempAverage=tempAverage, diskReadBytes=diskReadBytes, cpuTotal5secAvg=cpuTotal5secAvg, fan_2_speed=fan_2_speed, diskWriteIops=diskWriteIops, diskReadMerged=diskReadMerged, temperatureStatsTable=temperatureStatsTable, cpuProcessorStatsEntry=cpuProcessorStatsEntry, temperatureStatsEntry=temperatureStatsEntry, platformTemperatureTable=platformTemperatureTable, platformFantrayTable=platformFantrayTable, diskPercentageUsed=diskPercentageUsed, platformCompliances=platformCompliances, cpuIndex=cpuIndex, fwEntry=fwEntry, diskTotalIops=diskTotalIops, fan_4_speed=fan_4_speed, cpuCacheSize=cpuCacheSize, platformMemoryStatsTable=platformMemoryStatsTable, platformFwTable=platformFwTable, fan_10_speed=fan_10_speed, diskSize=diskSize, memoryStatsEntry=memoryStatsEntry, platformFpgaTable=platformFpgaTable, memPlatformTotal=memPlatformTotal, fwUpdateStatus=fwUpdateStatus, fantrayStatsTable=fantrayStatsTable, fan_3_speed=fan_3_speed, diskReadIops=diskReadIops, diskWriteLatencyMs=diskWriteLatencyMs, memPercentageUsed=memPercentageUsed, platformDiskGroup=platformDiskGroup, cpuStepping=cpuStepping, PlatformStatsIndex=PlatformStatsIndex, coreName=coreName, diskModel=diskModel, PYSNMP_MODULE_ID=f5PlatformStats, memAvailable=memAvailable, cpuProcessorStatsTable=cpuProcessorStatsTable, fan_5_speed=fan_5_speed, cpuCoreStatsTable=cpuCoreStatsTable, cpuThreadCnt=cpuThreadCnt, coreCurrent=coreCurrent, index=index, fpgaEntry=fpgaEntry, cpuTotal5minAvg=cpuTotal5minAvg, platformFantrayGroup=platformFantrayGroup, diskType=diskType, cpuCoreStatsEntry=cpuCoreStatsEntry, cpuCoreCnt=cpuCoreCnt, coreTotal5minAvg=coreTotal5minAvg, platformCompliance=platformCompliance, coreTotal1minAvg=coreTotal1minAvg, coreIndex=coreIndex, diskReadLatencyMs=diskReadLatencyMs, platformCPUGroup=platformCPUGroup, cpuModelName=cpuModelName, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, cpuCore=cpuCore, platformCpuStatsTable=platformCpuStatsTable, cpuTotal1minAvg=cpuTotal1minAvg, diskInfoTable=diskInfoTable, tempMaximum=tempMaximum, fpgaVersion=fpgaVersion, platformFwVersionGroup=platformFwVersionGroup, fwVersion=fwVersion, platformMemGroup=platformMemGroup, diskInfoEntry=diskInfoEntry, fan_7_speed=fan_7_speed, platformFpgaGroup=platformFpgaGroup, fan_9_speed=fan_9_speed, f5PlatformStatsObjects=f5PlatformStatsObjects, diskWriteMerged=diskWriteMerged, fwTable=fwTable, fan_6_speed=fan_6_speed)
