...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", memPlatformTotal=memPlatformTotal, coreCurrent=coreCurrent, f5PlatformStatsObjects=f5PlatformStatsObjects, diskWriteIops=diskWriteIops, temperatureStatsEntry=temperatureStatsEntry, diskType=diskType, fan_8_speed=fan_8_speed, fantrayStatsTable=fantrayStatsTable, index=index, cpuCoreCnt=cpuCoreCnt, fan_3_speed=fan_3_speed, platformConformance=platformConformance, cpuModelName=cpuModelName, diskWriteMerged=diskWriteMerged, fwName=fwName, fpgaIndex=fpgaIndex, platformFwVersionGroup=platformFwVersionGroup, diskTotalIops=diskTotalIops, coreName=coreName, platformTempGroup=platformTempGroup, cpuCurrent=cpuCurrent, platformCompliances=platformCompliances, fan_12_speed=fan_12_speed, diskReadLatencyMs=diskReadLatencyMs, fwUpdateStatus=fwUpdateStatus, diskSize=diskSize, coreIndex=coreIndex, cpuFreq=cpuFreq, fwEntry=fwEntry, cpuProcessorStatsEntry=cpuProcessorStatsEntry, fantrayStatsEntry=fantrayStatsEntry, fpgaTable=fpgaTable, fan_9_speed=fan_9_speed, coreTotal1minAvg=coreTotal1minAvg, cpuThreadCnt=cpuThreadCnt, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, coreTotal5minAvg=coreTotal5minAvg, platformFantrayTable=platformFantrayTable, platformMemGroup=platformMemGroup, platformCpuStatsTable=platformCpuStatsTable, platformGroups=platformGroups, diskUtilizationStatsEntry=diskUtilizationStatsEntry, platformDiskGroup=platformDiskGroup, diskReadIops=diskReadIops, diskReadMerged=diskReadMerged, platformMemoryStatsTable=platformMemoryStatsTable, platformDiskStatsTable=platformDiskStatsTable, fan_1_speed=fan_1_speed, cpuTotal1minAvg=cpuTotal1minAvg, f5PlatformStats=f5PlatformStats, PYSNMP_MODULE_ID=f5PlatformStats, memoryStatsTable=memoryStatsTable, cpuTotal5minAvg=cpuTotal5minAvg, cpuCore=cpuCore, memPlatformUsed=memPlatformUsed, diskWriteBytes=diskWriteBytes, configurable=configurable, diskModel=diskModel, tempMinimum=tempMinimum, fan_5_speed=fan_5_speed, cpuCoreStatsTable=cpuCoreStatsTable, cpuUtilizationStatsTable=cpuUtilizationStatsTable, platformCompliance=platformCompliance, diskVendor=diskVendor, tempCurrent=tempCurrent, diskInfoTable=diskInfoTable, platformTemperatureTable=platformTemperatureTable, fpgaVersion=fpgaVersion, memPercentageUsed=memPercentageUsed, fan_11_speed=fan_11_speed, fan_4_speed=fan_4_speed, cpuStepping=cpuStepping, diskName=diskName, tempMaximum=tempMaximum, platformFpgaGroup=platformFpgaGroup, platformFpgaTable=platformFpgaTable, platformFantrayGroup=platformFantrayGroup, fan_7_speed=fan_7_speed, tempAverage=tempAverage, fan_6_speed=fan_6_speed, cpuProcessorStatsTable=cpuProcessorStatsTable, cpuCoreStatsEntry=cpuCoreStatsEntry, String=String, cpuTotal5secAvg=cpuTotal5secAvg, fan_2_speed=fan_2_speed, diskWriteLatencyMs=diskWriteLatencyMs, cpuCacheSize=cpuCacheSize, diskReadBytes=diskReadBytes, fwVersion=fwVersion, diskSerialNo=diskSerialNo, PlatformStatsIndex=PlatformStatsIndex, memFree=memFree, platformCPUGroup=platformCPUGroup, memoryStatsEntry=memoryStatsEntry, diskInfoEntry=diskInfoEntry, diskPercentageUsed=diskPercentageUsed, coreTotal5secAvg=coreTotal5secAvg, diskUtilizationStatsTable=diskUtilizationStatsTable, fan_10_speed=fan_10_speed, cpuIndex=cpuIndex, temperatureStatsTable=temperatureStatsTable, platformFwTable=platformFwTable, fwTable=fwTable, diskVersion=diskVersion, memAvailable=memAvailable, fpgaEntry=fpgaEntry)
