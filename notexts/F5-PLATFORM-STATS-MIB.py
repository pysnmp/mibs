...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", platformCompliances=platformCompliances, memAvailable=memAvailable, platformFpgaGroup=platformFpgaGroup, platformFantrayGroup=platformFantrayGroup, fpgaTable=fpgaTable, cpuCurrent=cpuCurrent, PYSNMP_MODULE_ID=f5PlatformStats, coreTotal1minAvg=coreTotal1minAvg, fantrayStatsEntry=fantrayStatsEntry, fan_10_speed=fan_10_speed, platformMemoryStatsTable=platformMemoryStatsTable, fpgaVersion=fpgaVersion, fan_2_speed=fan_2_speed, platformFwTable=platformFwTable, platformCompliance=platformCompliance, memoryStatsEntry=memoryStatsEntry, platformCpuStatsTable=platformCpuStatsTable, memFree=memFree, memoryStatsTable=memoryStatsTable, coreCurrent=coreCurrent, platformTempGroup=platformTempGroup, diskPercentageUsed=diskPercentageUsed, cpuCoreStatsTable=cpuCoreStatsTable, fwTable=fwTable, cpuCoreStatsEntry=cpuCoreStatsEntry, coreIndex=coreIndex, platformDiskGroup=platformDiskGroup, diskType=diskType, diskUtilizationStatsTable=diskUtilizationStatsTable, diskTotalIops=diskTotalIops, cpuStepping=cpuStepping, diskReadBytes=diskReadBytes, fan_4_speed=fan_4_speed, platformGroups=platformGroups, cpuProcessorStatsEntry=cpuProcessorStatsEntry, PlatformStatsIndex=PlatformStatsIndex, fan_9_speed=fan_9_speed, platformFantrayTable=platformFantrayTable, platformTemperatureTable=platformTemperatureTable, diskWriteBytes=diskWriteBytes, tempCurrent=tempCurrent, temperatureStatsEntry=temperatureStatsEntry, fpgaEntry=fpgaEntry, coreTotal5minAvg=coreTotal5minAvg, fan_12_speed=fan_12_speed, cpuUtilizationStatsTable=cpuUtilizationStatsTable, cpuFreq=cpuFreq, diskSize=diskSize, diskWriteLatencyMs=diskWriteLatencyMs, cpuTotal5secAvg=cpuTotal5secAvg, memPlatformUsed=memPlatformUsed, platformDiskStatsTable=platformDiskStatsTable, tempAverage=tempAverage, fpgaIndex=fpgaIndex, cpuCore=cpuCore, fan_3_speed=fan_3_speed, platformConformance=platformConformance, fwVersion=fwVersion, coreTotal5secAvg=coreTotal5secAvg, diskInfoTable=diskInfoTable, cpuThreadCnt=cpuThreadCnt, diskModel=diskModel, diskReadLatencyMs=diskReadLatencyMs, fan_7_speed=fan_7_speed, platformFwVersionGroup=platformFwVersionGroup, cpuProcessorStatsTable=cpuProcessorStatsTable, f5PlatformStats=f5PlatformStats, fan_6_speed=fan_6_speed, diskSerialNo=diskSerialNo, temperatureStatsTable=temperatureStatsTable, fan_5_speed=fan_5_speed, fan_8_speed=fan_8_speed, fwName=fwName, diskWriteIops=diskWriteIops, diskWriteMerged=diskWriteMerged, cpuTotal5minAvg=cpuTotal5minAvg, cpuCacheSize=cpuCacheSize, coreName=coreName, diskInfoEntry=diskInfoEntry, cpuIndex=cpuIndex, diskUtilizationStatsEntry=diskUtilizationStatsEntry, f5PlatformStatsObjects=f5PlatformStatsObjects, platformMemGroup=platformMemGroup, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, tempMinimum=tempMinimum, fan_1_speed=fan_1_speed, memPercentageUsed=memPercentageUsed, diskReadIops=diskReadIops, index=index, fwEntry=fwEntry, fantrayStatsTable=fantrayStatsTable, platformFpgaTable=platformFpgaTable, memPlatformTotal=memPlatformTotal, diskName=diskName, cpuCoreCnt=cpuCoreCnt, cpuModelName=cpuModelName, String=String, platformCPUGroup=platformCPUGroup, diskReadMerged=diskReadMerged, configurable=configurable, diskVersion=diskVersion, fan_11_speed=fan_11_speed, tempMaximum=tempMaximum, fwUpdateStatus=fwUpdateStatus, diskVendor=diskVendor, cpuTotal1minAvg=cpuTotal1minAvg)
