...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", coreTotal5secAvg=coreTotal5secAvg, memPercentageUsed=memPercentageUsed, diskWriteMerged=diskWriteMerged, cpuFreq=cpuFreq, platformConformance=platformConformance, platformCompliance=platformCompliance, fan_11_speed=fan_11_speed, platformDiskStatsTable=platformDiskStatsTable, cpuUtilizationStatsTable=cpuUtilizationStatsTable, cpuTotal5minAvg=cpuTotal5minAvg, cpuCacheSize=cpuCacheSize, coreTotal5minAvg=coreTotal5minAvg, diskModel=diskModel, diskPercentageUsed=diskPercentageUsed, f5PlatformStats=f5PlatformStats, platformTemperatureTable=platformTemperatureTable, fan_2_speed=fan_2_speed, diskWriteBytes=diskWriteBytes, cpuCoreStatsTable=cpuCoreStatsTable, diskWriteIops=diskWriteIops, fantrayStatsEntry=fantrayStatsEntry, diskVendor=diskVendor, platformFwTable=platformFwTable, cpuIndex=cpuIndex, coreTotal1minAvg=coreTotal1minAvg, fantrayStatsTable=fantrayStatsTable, platformMemoryStatsTable=platformMemoryStatsTable, cpuTotal5secAvg=cpuTotal5secAvg, configurable=configurable, fwEntry=fwEntry, fan_6_speed=fan_6_speed, fan_4_speed=fan_4_speed, memFree=memFree, cpuCoreStatsEntry=cpuCoreStatsEntry, platformFantrayGroup=platformFantrayGroup, fan_8_speed=fan_8_speed, platformFpgaGroup=platformFpgaGroup, diskReadLatencyMs=diskReadLatencyMs, fan_12_speed=fan_12_speed, platformTempGroup=platformTempGroup, String=String, fpgaIndex=fpgaIndex, fan_10_speed=fan_10_speed, platformFpgaTable=platformFpgaTable, memPlatformTotal=memPlatformTotal, platformCpuStatsTable=platformCpuStatsTable, fan_1_speed=fan_1_speed, cpuModelName=cpuModelName, diskType=diskType, PlatformStatsIndex=PlatformStatsIndex, PYSNMP_MODULE_ID=f5PlatformStats, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, memoryStatsEntry=memoryStatsEntry, temperatureStatsEntry=temperatureStatsEntry, platformMemGroup=platformMemGroup, memPlatformUsed=memPlatformUsed, cpuTotal1minAvg=cpuTotal1minAvg, platformFantrayTable=platformFantrayTable, diskSerialNo=diskSerialNo, memoryStatsTable=memoryStatsTable, fwTable=fwTable, fan_3_speed=fan_3_speed, diskUtilizationStatsTable=diskUtilizationStatsTable, cpuProcessorStatsEntry=cpuProcessorStatsEntry, fan_7_speed=fan_7_speed, fpgaEntry=fpgaEntry, coreName=coreName, fwVersion=fwVersion, diskReadMerged=diskReadMerged, tempMinimum=tempMinimum, diskReadBytes=diskReadBytes, memAvailable=memAvailable, fwUpdateStatus=fwUpdateStatus, diskReadIops=diskReadIops, platformGroups=platformGroups, cpuCoreCnt=cpuCoreCnt, cpuCurrent=cpuCurrent, cpuProcessorStatsTable=cpuProcessorStatsTable, diskVersion=diskVersion, fpgaVersion=fpgaVersion, cpuCore=cpuCore, platformCPUGroup=platformCPUGroup, diskUtilizationStatsEntry=diskUtilizationStatsEntry, cpuStepping=cpuStepping, fwName=fwName, coreIndex=coreIndex, temperatureStatsTable=temperatureStatsTable, f5PlatformStatsObjects=f5PlatformStatsObjects, platformCompliances=platformCompliances, platformDiskGroup=platformDiskGroup, diskTotalIops=diskTotalIops, coreCurrent=coreCurrent, diskName=diskName, fan_5_speed=fan_5_speed, index=index, platformFwVersionGroup=platformFwVersionGroup, cpuThreadCnt=cpuThreadCnt, diskInfoTable=diskInfoTable, diskSize=diskSize, tempMaximum=tempMaximum, fan_9_speed=fan_9_speed, diskWriteLatencyMs=diskWriteLatencyMs, tempAverage=tempAverage, fpgaTable=fpgaTable, diskInfoEntry=diskInfoEntry, tempCurrent=tempCurrent)
