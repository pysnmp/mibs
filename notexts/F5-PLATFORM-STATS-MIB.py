...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", diskReadBytes=diskReadBytes, platformCompliances=platformCompliances, platformTempGroup=platformTempGroup, diskReadIops=diskReadIops, diskPercentageUsed=diskPercentageUsed, cpuIndex=cpuIndex, diskSerialNo=diskSerialNo, cpuCoreCnt=cpuCoreCnt, PlatformStatsIndex=PlatformStatsIndex, platformFpgaTable=platformFpgaTable, coreIndex=coreIndex, diskWriteIops=diskWriteIops, tempAverage=tempAverage, diskUtilizationStatsEntry=diskUtilizationStatsEntry, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, fwName=fwName, tempCurrent=tempCurrent, diskName=diskName, temperatureStatsTable=temperatureStatsTable, fpgaVersion=fpgaVersion, tempMaximum=tempMaximum, cpuTotal5minAvg=cpuTotal5minAvg, fan_3_speed=fan_3_speed, fan_9_speed=fan_9_speed, coreName=coreName, diskModel=diskModel, fwEntry=fwEntry, cpuCurrent=cpuCurrent, configurable=configurable, platformCompliance=platformCompliance, diskInfoEntry=diskInfoEntry, fan_6_speed=fan_6_speed, cpuTotal1minAvg=cpuTotal1minAvg, fan_5_speed=fan_5_speed, diskTotalIops=diskTotalIops, cpuTotal5secAvg=cpuTotal5secAvg, platformTemperatureTable=platformTemperatureTable, coreTotal1minAvg=coreTotal1minAvg, cpuUtilizationStatsTable=cpuUtilizationStatsTable, tempMinimum=tempMinimum, fan_1_speed=fan_1_speed, fan_2_speed=fan_2_speed, coreCurrent=coreCurrent, fan_12_speed=fan_12_speed, diskWriteLatencyMs=diskWriteLatencyMs, memFree=memFree, platformFwTable=platformFwTable, fan_11_speed=fan_11_speed, cpuModelName=cpuModelName, cpuCore=cpuCore, temperatureStatsEntry=temperatureStatsEntry, cpuCoreStatsTable=cpuCoreStatsTable, fwTable=fwTable, f5PlatformStatsObjects=f5PlatformStatsObjects, memPercentageUsed=memPercentageUsed, platformFantrayTable=platformFantrayTable, diskReadMerged=diskReadMerged, cpuProcessorStatsEntry=cpuProcessorStatsEntry, diskVersion=diskVersion, f5PlatformStats=f5PlatformStats, diskUtilizationStatsTable=diskUtilizationStatsTable, cpuFreq=cpuFreq, fan_4_speed=fan_4_speed, memoryStatsTable=memoryStatsTable, platformFantrayGroup=platformFantrayGroup, platformFpgaGroup=platformFpgaGroup, platformCpuStatsTable=platformCpuStatsTable, platformFwVersionGroup=platformFwVersionGroup, PYSNMP_MODULE_ID=f5PlatformStats, diskVendor=diskVendor, diskWriteBytes=diskWriteBytes, cpuCoreStatsEntry=cpuCoreStatsEntry, fan_7_speed=fan_7_speed, fpgaEntry=fpgaEntry, index=index, diskType=diskType, platformMemoryStatsTable=platformMemoryStatsTable, platformGroups=platformGroups, fan_10_speed=fan_10_speed, memAvailable=memAvailable, diskWriteMerged=diskWriteMerged, fpgaTable=fpgaTable, diskSize=diskSize, String=String, platformCPUGroup=platformCPUGroup, cpuProcessorStatsTable=cpuProcessorStatsTable, platformDiskStatsTable=platformDiskStatsTable, diskReadLatencyMs=diskReadLatencyMs, fwVersion=fwVersion, memPlatformTotal=memPlatformTotal, cpuCacheSize=cpuCacheSize, fwUpdateStatus=fwUpdateStatus, memoryStatsEntry=memoryStatsEntry, platformConformance=platformConformance, fan_8_speed=fan_8_speed, fpgaIndex=fpgaIndex, diskInfoTable=diskInfoTable, fantrayStatsTable=fantrayStatsTable, platformMemGroup=platformMemGroup, memPlatformUsed=memPlatformUsed, coreTotal5minAvg=coreTotal5minAvg, fantrayStatsEntry=fantrayStatsEntry, platformDiskGroup=platformDiskGroup, cpuStepping=cpuStepping, cpuThreadCnt=cpuThreadCnt, coreTotal5secAvg=coreTotal5secAvg)
