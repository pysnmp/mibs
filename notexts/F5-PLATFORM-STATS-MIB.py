...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", diskInfoTable=diskInfoTable, tempAverage=tempAverage, fan_9_speed=fan_9_speed, diskReadIops=diskReadIops, coreCurrent=coreCurrent, platformCpuStatsTable=platformCpuStatsTable, PlatformStatsIndex=PlatformStatsIndex, fpgaVersion=fpgaVersion, tempMaximum=tempMaximum, diskInfoEntry=diskInfoEntry, cpuModelName=cpuModelName, tempCurrent=tempCurrent, tempMinimum=tempMinimum, diskModel=diskModel, fan_4_speed=fan_4_speed, platformDiskGroup=platformDiskGroup, platformGroups=platformGroups, platformFpgaTable=platformFpgaTable, cpuStepping=cpuStepping, diskVersion=diskVersion, temperatureStatsEntry=temperatureStatsEntry, diskWriteMerged=diskWriteMerged, platformFantrayTable=platformFantrayTable, fan_3_speed=fan_3_speed, platformMemGroup=platformMemGroup, platformMemoryStatsTable=platformMemoryStatsTable, f5PlatformStatsObjects=f5PlatformStatsObjects, fan_8_speed=fan_8_speed, fwVersion=fwVersion, cpuCacheSize=cpuCacheSize, coreName=coreName, fantrayStatsTable=fantrayStatsTable, diskReadMerged=diskReadMerged, diskUtilizationStatsTable=diskUtilizationStatsTable, fpgaTable=fpgaTable, cpuTotal1minAvg=cpuTotal1minAvg, platformTemperatureTable=platformTemperatureTable, cpuTotal5minAvg=cpuTotal5minAvg, platformCompliances=platformCompliances, diskPercentageUsed=diskPercentageUsed, diskType=diskType, cpuUtilizationStatsTable=cpuUtilizationStatsTable, diskTotalIops=diskTotalIops, memPlatformTotal=memPlatformTotal, platformFpgaGroup=platformFpgaGroup, cpuThreadCnt=cpuThreadCnt, configurable=configurable, platformConformance=platformConformance, platformDiskStatsTable=platformDiskStatsTable, memFree=memFree, platformFwVersionGroup=platformFwVersionGroup, f5PlatformStats=f5PlatformStats, fwTable=fwTable, fan_12_speed=fan_12_speed, cpuTotal5secAvg=cpuTotal5secAvg, fwUpdateStatus=fwUpdateStatus, fan_2_speed=fan_2_speed, memPercentageUsed=memPercentageUsed, diskWriteIops=diskWriteIops, memoryStatsEntry=memoryStatsEntry, diskVendor=diskVendor, cpuProcessorStatsTable=cpuProcessorStatsTable, diskReadBytes=diskReadBytes, diskWriteLatencyMs=diskWriteLatencyMs, diskName=diskName, platformFwTable=platformFwTable, cpuCoreStatsEntry=cpuCoreStatsEntry, memoryStatsTable=memoryStatsTable, index=index, coreTotal5secAvg=coreTotal5secAvg, platformFantrayGroup=platformFantrayGroup, cpuCurrent=cpuCurrent, fan_10_speed=fan_10_speed, memPlatformUsed=memPlatformUsed, diskSize=diskSize, coreIndex=coreIndex, cpuFreq=cpuFreq, fan_5_speed=fan_5_speed, cpuIndex=cpuIndex, fan_6_speed=fan_6_speed, diskWriteBytes=diskWriteBytes, platformCompliance=platformCompliance, coreTotal5minAvg=coreTotal5minAvg, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, coreTotal1minAvg=coreTotal1minAvg, String=String, fan_11_speed=fan_11_speed, cpuProcessorStatsEntry=cpuProcessorStatsEntry, platformTempGroup=platformTempGroup, memAvailable=memAvailable, diskSerialNo=diskSerialNo, temperatureStatsTable=temperatureStatsTable, diskUtilizationStatsEntry=diskUtilizationStatsEntry, diskReadLatencyMs=diskReadLatencyMs, PYSNMP_MODULE_ID=f5PlatformStats, fpgaEntry=fpgaEntry, fantrayStatsEntry=fantrayStatsEntry, platformCPUGroup=platformCPUGroup, fwEntry=fwEntry, fan_7_speed=fan_7_speed, fwName=fwName, fan_1_speed=fan_1_speed, cpuCoreCnt=cpuCoreCnt, fpgaIndex=fpgaIndex, cpuCore=cpuCore, cpuCoreStatsTable=cpuCoreStatsTable)
