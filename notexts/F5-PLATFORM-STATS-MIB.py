...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", tempMinimum=tempMinimum, index=index, cpuStepping=cpuStepping, platformFantrayGroup=platformFantrayGroup, f5PlatformStatsObjects=f5PlatformStatsObjects, platformFpgaTable=platformFpgaTable, cpuProcessorStatsEntry=cpuProcessorStatsEntry, fan_11_speed=fan_11_speed, fantrayStatsTable=fantrayStatsTable, memoryStatsEntry=memoryStatsEntry, fantrayStatsEntry=fantrayStatsEntry, memPlatformUsed=memPlatformUsed, fpgaIndex=fpgaIndex, fan_10_speed=fan_10_speed, diskInfoEntry=diskInfoEntry, platformCompliance=platformCompliance, platformDiskStatsTable=platformDiskStatsTable, fan_5_speed=fan_5_speed, cpuCoreStatsTable=cpuCoreStatsTable, memPlatformTotal=memPlatformTotal, diskWriteBytes=diskWriteBytes, fan_3_speed=fan_3_speed, cpuCore=cpuCore, coreIndex=coreIndex, fwEntry=fwEntry, configurable=configurable, platformCPUGroup=platformCPUGroup, diskWriteMerged=diskWriteMerged, fwVersion=fwVersion, fan_4_speed=fan_4_speed, cpuCacheSize=cpuCacheSize, memFree=memFree, fpgaEntry=fpgaEntry, cpuFreq=cpuFreq, PlatformStatsIndex=PlatformStatsIndex, diskSerialNo=diskSerialNo, platformFwVersionGroup=platformFwVersionGroup, memAvailable=memAvailable, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, diskVendor=diskVendor, cpuUtilizationStatsTable=cpuUtilizationStatsTable, diskReadLatencyMs=diskReadLatencyMs, platformMemoryStatsTable=platformMemoryStatsTable, memPercentageUsed=memPercentageUsed, fan_8_speed=fan_8_speed, cpuModelName=cpuModelName, fpgaTable=fpgaTable, fan_6_speed=fan_6_speed, platformMemGroup=platformMemGroup, platformCompliances=platformCompliances, platformFwTable=platformFwTable, cpuProcessorStatsTable=cpuProcessorStatsTable, coreTotal5minAvg=coreTotal5minAvg, diskUtilizationStatsEntry=diskUtilizationStatsEntry, diskWriteLatencyMs=diskWriteLatencyMs, diskWriteIops=diskWriteIops, platformConformance=platformConformance, diskUtilizationStatsTable=diskUtilizationStatsTable, diskVersion=diskVersion, diskReadBytes=diskReadBytes, fwTable=fwTable, platformFpgaGroup=platformFpgaGroup, platformTemperatureTable=platformTemperatureTable, fan_7_speed=fan_7_speed, cpuCoreCnt=cpuCoreCnt, cpuCurrent=cpuCurrent, fan_9_speed=fan_9_speed, cpuTotal1minAvg=cpuTotal1minAvg, cpuThreadCnt=cpuThreadCnt, cpuCoreStatsEntry=cpuCoreStatsEntry, platformFantrayTable=platformFantrayTable, tempCurrent=tempCurrent, fan_12_speed=fan_12_speed, fan_2_speed=fan_2_speed, tempMaximum=tempMaximum, cpuIndex=cpuIndex, memoryStatsTable=memoryStatsTable, platformCpuStatsTable=platformCpuStatsTable, platformGroups=platformGroups, fan_1_speed=fan_1_speed, temperatureStatsEntry=temperatureStatsEntry, fpgaVersion=fpgaVersion, diskType=diskType, tempAverage=tempAverage, diskSize=diskSize, diskInfoTable=diskInfoTable, f5PlatformStats=f5PlatformStats, diskReadIops=diskReadIops, cpuTotal5secAvg=cpuTotal5secAvg, platformDiskGroup=platformDiskGroup, diskPercentageUsed=diskPercentageUsed, coreCurrent=coreCurrent, diskTotalIops=diskTotalIops, diskModel=diskModel, coreName=coreName, coreTotal1minAvg=coreTotal1minAvg, diskName=diskName, diskReadMerged=diskReadMerged, PYSNMP_MODULE_ID=f5PlatformStats, temperatureStatsTable=temperatureStatsTable, String=String, fwUpdateStatus=fwUpdateStatus, cpuTotal5minAvg=cpuTotal5minAvg, platformTempGroup=platformTempGroup, fwName=fwName, coreTotal5secAvg=coreTotal5secAvg)
