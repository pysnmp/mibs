...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", diskInfoEntry=diskInfoEntry, coreCurrent=coreCurrent, temperatureStatsTable=temperatureStatsTable, temperatureStatsEntry=temperatureStatsEntry, fwUpdateStatus=fwUpdateStatus, tempMaximum=tempMaximum, fpgaIndex=fpgaIndex, cpuProcessorStatsTable=cpuProcessorStatsTable, fan_1_speed=fan_1_speed, fwVersion=fwVersion, cpuCoreCnt=cpuCoreCnt, tempMinimum=tempMinimum, configurable=configurable, platformCompliance=platformCompliance, fan_12_speed=fan_12_speed, platformFantrayTable=platformFantrayTable, fan_6_speed=fan_6_speed, tempAverage=tempAverage, memFree=memFree, fwEntry=fwEntry, diskReadMerged=diskReadMerged, cpuCoreStatsEntry=cpuCoreStatsEntry, diskType=diskType, coreTotal5minAvg=coreTotal5minAvg, coreTotal5secAvg=coreTotal5secAvg, fan_8_speed=fan_8_speed, cpuTotal5minAvg=cpuTotal5minAvg, fwName=fwName, platformFwTable=platformFwTable, index=index, diskReadIops=diskReadIops, platformGroups=platformGroups, f5PlatformStatsObjects=f5PlatformStatsObjects, platformMemGroup=platformMemGroup, diskUtilizationStatsTable=diskUtilizationStatsTable, cpuProcessorStatsEntry=cpuProcessorStatsEntry, platformCPUGroup=platformCPUGroup, diskModel=diskModel, fan_9_speed=fan_9_speed, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, fpgaVersion=fpgaVersion, memPercentageUsed=memPercentageUsed, fwTable=fwTable, fantrayStatsEntry=fantrayStatsEntry, cpuCore=cpuCore, cpuCurrent=cpuCurrent, cpuUtilizationStatsTable=cpuUtilizationStatsTable, coreName=coreName, memoryStatsTable=memoryStatsTable, cpuCoreStatsTable=cpuCoreStatsTable, fan_2_speed=fan_2_speed, cpuThreadCnt=cpuThreadCnt, cpuCacheSize=cpuCacheSize, PlatformStatsIndex=PlatformStatsIndex, cpuModelName=cpuModelName, platformDiskGroup=platformDiskGroup, tempCurrent=tempCurrent, diskVendor=diskVendor, memPlatformTotal=memPlatformTotal, platformCpuStatsTable=platformCpuStatsTable, diskWriteMerged=diskWriteMerged, cpuIndex=cpuIndex, fan_11_speed=fan_11_speed, platformDiskStatsTable=platformDiskStatsTable, platformTempGroup=platformTempGroup, diskReadBytes=diskReadBytes, fan_10_speed=fan_10_speed, fan_4_speed=fan_4_speed, coreTotal1minAvg=coreTotal1minAvg, memoryStatsEntry=memoryStatsEntry, cpuTotal1minAvg=cpuTotal1minAvg, diskName=diskName, fan_5_speed=fan_5_speed, diskTotalIops=diskTotalIops, platformCompliances=platformCompliances, diskSize=diskSize, cpuStepping=cpuStepping, diskPercentageUsed=diskPercentageUsed, fantrayStatsTable=fantrayStatsTable, diskVersion=diskVersion, f5PlatformStats=f5PlatformStats, platformFwVersionGroup=platformFwVersionGroup, diskWriteLatencyMs=diskWriteLatencyMs, fpgaEntry=fpgaEntry, platformFpgaGroup=platformFpgaGroup, PYSNMP_MODULE_ID=f5PlatformStats, platformMemoryStatsTable=platformMemoryStatsTable, diskReadLatencyMs=diskReadLatencyMs, fpgaTable=fpgaTable, fan_3_speed=fan_3_speed, coreIndex=coreIndex, memAvailable=memAvailable, diskWriteIops=diskWriteIops, diskWriteBytes=diskWriteBytes, cpuFreq=cpuFreq, memPlatformUsed=memPlatformUsed, diskUtilizationStatsEntry=diskUtilizationStatsEntry, fan_7_speed=fan_7_speed, cpuTotal5secAvg=cpuTotal5secAvg, platformFantrayGroup=platformFantrayGroup, String=String, platformTemperatureTable=platformTemperatureTable, diskInfoTable=diskInfoTable, diskSerialNo=diskSerialNo, platformFpgaTable=platformFpgaTable, platformConformance=platformConformance)
