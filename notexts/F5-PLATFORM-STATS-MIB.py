...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", platformFantrayGroup=platformFantrayGroup, fan_7_speed=fan_7_speed, cpuCore=cpuCore, diskInfoEntry=diskInfoEntry, cpuTotal5minAvg=cpuTotal5minAvg, coreCurrent=coreCurrent, tempAverage=tempAverage, diskSerialNo=diskSerialNo, platformMemGroup=platformMemGroup, diskWriteIops=diskWriteIops, f5PlatformStats=f5PlatformStats, fwUpdateStatus=fwUpdateStatus, cpuThreadCnt=cpuThreadCnt, platformFwTable=platformFwTable, fwEntry=fwEntry, diskReadBytes=diskReadBytes, fan_3_speed=fan_3_speed, platformConformance=platformConformance, cpuProcessorStatsEntry=cpuProcessorStatsEntry, platformCompliances=platformCompliances, cpuTotal5secAvg=cpuTotal5secAvg, temperatureStatsTable=temperatureStatsTable, index=index, memoryStatsEntry=memoryStatsEntry, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, memPlatformTotal=memPlatformTotal, cpuCoreCnt=cpuCoreCnt, platformCpuStatsTable=platformCpuStatsTable, fan_8_speed=fan_8_speed, memAvailable=memAvailable, tempMinimum=tempMinimum, diskName=diskName, coreName=coreName, diskWriteMerged=diskWriteMerged, fan_1_speed=fan_1_speed, cpuModelName=cpuModelName, fan_6_speed=fan_6_speed, diskReadIops=diskReadIops, fan_2_speed=fan_2_speed, PlatformStatsIndex=PlatformStatsIndex, platformMemoryStatsTable=platformMemoryStatsTable, coreTotal5secAvg=coreTotal5secAvg, platformDiskStatsTable=platformDiskStatsTable, f5PlatformStatsObjects=f5PlatformStatsObjects, platformTemperatureTable=platformTemperatureTable, cpuCurrent=cpuCurrent, platformFpgaGroup=platformFpgaGroup, fan_11_speed=fan_11_speed, platformTempGroup=platformTempGroup, configurable=configurable, cpuCoreStatsEntry=cpuCoreStatsEntry, memoryStatsTable=memoryStatsTable, diskTotalIops=diskTotalIops, platformFantrayTable=platformFantrayTable, fan_4_speed=fan_4_speed, coreIndex=coreIndex, coreTotal5minAvg=coreTotal5minAvg, memFree=memFree, fwVersion=fwVersion, cpuFreq=cpuFreq, memPlatformUsed=memPlatformUsed, platformCPUGroup=platformCPUGroup, cpuIndex=cpuIndex, platformFpgaTable=platformFpgaTable, diskInfoTable=diskInfoTable, temperatureStatsEntry=temperatureStatsEntry, fwName=fwName, fwTable=fwTable, tempCurrent=tempCurrent, coreTotal1minAvg=coreTotal1minAvg, diskModel=diskModel, diskUtilizationStatsEntry=diskUtilizationStatsEntry, tempMaximum=tempMaximum, platformDiskGroup=platformDiskGroup, cpuUtilizationStatsTable=cpuUtilizationStatsTable, memPercentageUsed=memPercentageUsed, cpuStepping=cpuStepping, fantrayStatsEntry=fantrayStatsEntry, diskUtilizationStatsTable=diskUtilizationStatsTable, diskReadMerged=diskReadMerged, cpuProcessorStatsTable=cpuProcessorStatsTable, diskReadLatencyMs=diskReadLatencyMs, fpgaVersion=fpgaVersion, fantrayStatsTable=fantrayStatsTable, platformFwVersionGroup=platformFwVersionGroup, diskVersion=diskVersion, fan_9_speed=fan_9_speed, diskSize=diskSize, fpgaTable=fpgaTable, diskType=diskType, String=String, platformGroups=platformGroups, diskWriteLatencyMs=diskWriteLatencyMs, cpuTotal1minAvg=cpuTotal1minAvg, fan_12_speed=fan_12_speed, fan_10_speed=fan_10_speed, cpuCacheSize=cpuCacheSize, platformCompliance=platformCompliance, cpuCoreStatsTable=cpuCoreStatsTable, fan_5_speed=fan_5_speed, diskPercentageUsed=diskPercentageUsed, fpgaEntry=fpgaEntry, diskWriteBytes=diskWriteBytes, diskVendor=diskVendor, PYSNMP_MODULE_ID=f5PlatformStats, fpgaIndex=fpgaIndex)
