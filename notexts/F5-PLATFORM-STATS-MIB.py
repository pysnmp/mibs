...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", cpuCoreCnt=cpuCoreCnt, platformMemGroup=platformMemGroup, diskInfoEntry=diskInfoEntry, cpuIndex=cpuIndex, fan_9_speed=fan_9_speed, platformFpgaTable=platformFpgaTable, fpgaVersion=fpgaVersion, platformFantrayGroup=platformFantrayGroup, cpuThreadCnt=cpuThreadCnt, diskTotalIops=diskTotalIops, fpgaEntry=fpgaEntry, diskWriteMerged=diskWriteMerged, platformFantrayTable=platformFantrayTable, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, memPlatformUsed=memPlatformUsed, tempMaximum=tempMaximum, coreTotal5secAvg=coreTotal5secAvg, diskReadIops=diskReadIops, fan_7_speed=fan_7_speed, coreCurrent=coreCurrent, coreIndex=coreIndex, cpuCore=cpuCore, PYSNMP_MODULE_ID=f5PlatformStats, platformFwTable=platformFwTable, temperatureStatsTable=temperatureStatsTable, fwUpdateStatus=fwUpdateStatus, diskWriteIops=diskWriteIops, PlatformStatsIndex=PlatformStatsIndex, fan_6_speed=fan_6_speed, platformDiskStatsTable=platformDiskStatsTable, diskReadMerged=diskReadMerged, index=index, cpuProcessorStatsEntry=cpuProcessorStatsEntry, fan_10_speed=fan_10_speed, coreTotal5minAvg=coreTotal5minAvg, diskReadLatencyMs=diskReadLatencyMs, cpuStepping=cpuStepping, memoryStatsTable=memoryStatsTable, memPlatformTotal=memPlatformTotal, fan_8_speed=fan_8_speed, diskName=diskName, cpuFreq=cpuFreq, platformFpgaGroup=platformFpgaGroup, tempCurrent=tempCurrent, cpuCoreStatsTable=cpuCoreStatsTable, tempMinimum=tempMinimum, fpgaIndex=fpgaIndex, fan_5_speed=fan_5_speed, coreName=coreName, cpuProcessorStatsTable=cpuProcessorStatsTable, fan_3_speed=fan_3_speed, cpuCoreStatsEntry=cpuCoreStatsEntry, memoryStatsEntry=memoryStatsEntry, platformGroups=platformGroups, cpuModelName=cpuModelName, fan_1_speed=fan_1_speed, memPercentageUsed=memPercentageUsed, fwName=fwName, diskUtilizationStatsEntry=diskUtilizationStatsEntry, memFree=memFree, fan_4_speed=fan_4_speed, fwEntry=fwEntry, cpuCacheSize=cpuCacheSize, platformTempGroup=platformTempGroup, diskUtilizationStatsTable=diskUtilizationStatsTable, diskModel=diskModel, diskPercentageUsed=diskPercentageUsed, platformCPUGroup=platformCPUGroup, platformConformance=platformConformance, diskSerialNo=diskSerialNo, fwTable=fwTable, diskWriteBytes=diskWriteBytes, configurable=configurable, tempAverage=tempAverage, fan_12_speed=fan_12_speed, temperatureStatsEntry=temperatureStatsEntry, platformTemperatureTable=platformTemperatureTable, coreTotal1minAvg=coreTotal1minAvg, f5PlatformStats=f5PlatformStats, platformFwVersionGroup=platformFwVersionGroup, fantrayStatsEntry=fantrayStatsEntry, fwVersion=fwVersion, diskWriteLatencyMs=diskWriteLatencyMs, diskType=diskType, cpuTotal5minAvg=cpuTotal5minAvg, memAvailable=memAvailable, String=String, cpuTotal1minAvg=cpuTotal1minAvg, fan_11_speed=fan_11_speed, diskVendor=diskVendor, cpuUtilizationStatsTable=cpuUtilizationStatsTable, fantrayStatsTable=fantrayStatsTable, diskVersion=diskVersion, platformMemoryStatsTable=platformMemoryStatsTable, diskReadBytes=diskReadBytes, cpuCurrent=cpuCurrent, diskInfoTable=diskInfoTable, platformCompliances=platformCompliances, platformCpuStatsTable=platformCpuStatsTable, diskSize=diskSize, fpgaTable=fpgaTable, cpuTotal5secAvg=cpuTotal5secAvg, platformCompliance=platformCompliance, f5PlatformStatsObjects=f5PlatformStatsObjects, platformDiskGroup=platformDiskGroup, fan_2_speed=fan_2_speed)
