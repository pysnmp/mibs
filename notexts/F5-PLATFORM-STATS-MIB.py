...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", tempCurrent=tempCurrent, fpgaEntry=fpgaEntry, platformFpgaTable=platformFpgaTable, platformCPUGroup=platformCPUGroup, fan_1_speed=fan_1_speed, fan_2_speed=fan_2_speed, fan_9_speed=fan_9_speed, platformCompliance=platformCompliance, fan_7_speed=fan_7_speed, fan_12_speed=fan_12_speed, diskVendor=diskVendor, platformCpuStatsTable=platformCpuStatsTable, platformFantrayGroup=platformFantrayGroup, index=index, fan_11_speed=fan_11_speed, fpgaVersion=fpgaVersion, diskWriteIops=diskWriteIops, platformFpgaGroup=platformFpgaGroup, platformFantrayTable=platformFantrayTable, cpuThreadCnt=cpuThreadCnt, diskUtilizationStatsEntry=diskUtilizationStatsEntry, memFree=memFree, coreTotal5secAvg=coreTotal5secAvg, memPlatformUsed=memPlatformUsed, platformFwVersionGroup=platformFwVersionGroup, platformGroups=platformGroups, coreName=coreName, fan_5_speed=fan_5_speed, cpuTotal5secAvg=cpuTotal5secAvg, memoryStatsTable=memoryStatsTable, fpgaIndex=fpgaIndex, fantrayStatsEntry=fantrayStatsEntry, cpuProcessorStatsTable=cpuProcessorStatsTable, diskSerialNo=diskSerialNo, fantrayStatsTable=fantrayStatsTable, platformDiskStatsTable=platformDiskStatsTable, diskUtilizationStatsTable=diskUtilizationStatsTable, cpuFreq=cpuFreq, diskReadIops=diskReadIops, fwUpdateStatus=fwUpdateStatus, fwName=fwName, cpuCoreStatsTable=cpuCoreStatsTable, fan_10_speed=fan_10_speed, fan_8_speed=fan_8_speed, diskPercentageUsed=diskPercentageUsed, tempMinimum=tempMinimum, coreTotal5minAvg=coreTotal5minAvg, temperatureStatsEntry=temperatureStatsEntry, cpuProcessorStatsEntry=cpuProcessorStatsEntry, platformFwTable=platformFwTable, coreCurrent=coreCurrent, memPlatformTotal=memPlatformTotal, platformTemperatureTable=platformTemperatureTable, PlatformStatsIndex=PlatformStatsIndex, tempAverage=tempAverage, cpuCurrent=cpuCurrent, diskType=diskType, String=String, platformMemGroup=platformMemGroup, platformMemoryStatsTable=platformMemoryStatsTable, diskModel=diskModel, diskVersion=diskVersion, platformCompliances=platformCompliances, f5PlatformStatsObjects=f5PlatformStatsObjects, memPercentageUsed=memPercentageUsed, diskWriteLatencyMs=diskWriteLatencyMs, platformDiskGroup=platformDiskGroup, fan_4_speed=fan_4_speed, f5PlatformStats=f5PlatformStats, platformTempGroup=platformTempGroup, diskInfoEntry=diskInfoEntry, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, cpuStepping=cpuStepping, fwVersion=fwVersion, cpuCore=cpuCore, diskReadMerged=diskReadMerged, diskInfoTable=diskInfoTable, PYSNMP_MODULE_ID=f5PlatformStats, fpgaTable=fpgaTable, temperatureStatsTable=temperatureStatsTable, fwTable=fwTable, cpuTotal1minAvg=cpuTotal1minAvg, diskReadBytes=diskReadBytes, diskName=diskName, coreIndex=coreIndex, cpuTotal5minAvg=cpuTotal5minAvg, memoryStatsEntry=memoryStatsEntry, diskReadLatencyMs=diskReadLatencyMs, cpuCoreCnt=cpuCoreCnt, cpuCacheSize=cpuCacheSize, fwEntry=fwEntry, cpuCoreStatsEntry=cpuCoreStatsEntry, memAvailable=memAvailable, diskWriteBytes=diskWriteBytes, diskSize=diskSize, diskTotalIops=diskTotalIops, cpuIndex=cpuIndex, cpuModelName=cpuModelName, configurable=configurable, tempMaximum=tempMaximum, fan_6_speed=fan_6_speed, cpuUtilizationStatsTable=cpuUtilizationStatsTable, fan_3_speed=fan_3_speed, platformConformance=platformConformance, diskWriteMerged=diskWriteMerged, coreTotal1minAvg=coreTotal1minAvg)
