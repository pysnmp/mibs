...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", diskVendor=diskVendor, platformFpgaGroup=platformFpgaGroup, cpuThreadCnt=cpuThreadCnt, fpgaIndex=fpgaIndex, fan_8_speed=fan_8_speed, cpuCore=cpuCore, diskWriteLatencyMs=diskWriteLatencyMs, fan_3_speed=fan_3_speed, configurable=configurable, diskVersion=diskVersion, platformDiskGroup=platformDiskGroup, cpuCurrent=cpuCurrent, platformFwVersionGroup=platformFwVersionGroup, diskWriteMerged=diskWriteMerged, PlatformStatsIndex=PlatformStatsIndex, cpuCacheSize=cpuCacheSize, platformFpgaTable=platformFpgaTable, platformCpuStatsTable=platformCpuStatsTable, fan_4_speed=fan_4_speed, tempCurrent=tempCurrent, platformCPUGroup=platformCPUGroup, cpuProcessorStatsEntry=cpuProcessorStatsEntry, cpuTotal5minAvg=cpuTotal5minAvg, diskUtilizationStatsEntry=diskUtilizationStatsEntry, cpuTotal5secAvg=cpuTotal5secAvg, fpgaTable=fpgaTable, coreTotal5minAvg=coreTotal5minAvg, cpuProcessorStatsTable=cpuProcessorStatsTable, fpgaEntry=fpgaEntry, fpgaVersion=fpgaVersion, platformGroups=platformGroups, cpuCoreStatsTable=cpuCoreStatsTable, diskUtilizationStatsTable=diskUtilizationStatsTable, diskWriteBytes=diskWriteBytes, platformMemoryStatsTable=platformMemoryStatsTable, diskInfoTable=diskInfoTable, fan_12_speed=fan_12_speed, diskTotalIops=diskTotalIops, cpuTotal1minAvg=cpuTotal1minAvg, PYSNMP_MODULE_ID=f5PlatformStats, fan_7_speed=fan_7_speed, memoryStatsTable=memoryStatsTable, diskPercentageUsed=diskPercentageUsed, diskInfoEntry=diskInfoEntry, fwEntry=fwEntry, memPlatformUsed=memPlatformUsed, fwUpdateStatus=fwUpdateStatus, String=String, cpuCoreCnt=cpuCoreCnt, platformCompliance=platformCompliance, cpuFreq=cpuFreq, fan_2_speed=fan_2_speed, index=index, fan_10_speed=fan_10_speed, diskName=diskName, cpuModelName=cpuModelName, memPercentageUsed=memPercentageUsed, temperatureStatsEntry=temperatureStatsEntry, cpuStepping=cpuStepping, fwVersion=fwVersion, fan_9_speed=fan_9_speed, coreTotal5secAvg=coreTotal5secAvg, diskReadLatencyMs=diskReadLatencyMs, f5PlatformStatsObjects=f5PlatformStatsObjects, diskReadIops=diskReadIops, fan_5_speed=fan_5_speed, coreCurrent=coreCurrent, memoryStatsEntry=memoryStatsEntry, cpuCoreStatsEntry=cpuCoreStatsEntry, platformFantrayTable=platformFantrayTable, platformFantrayGroup=platformFantrayGroup, fan_1_speed=fan_1_speed, coreTotal1minAvg=coreTotal1minAvg, tempAverage=tempAverage, platformFwTable=platformFwTable, fan_6_speed=fan_6_speed, platformCompliances=platformCompliances, platformTempGroup=platformTempGroup, diskReadMerged=diskReadMerged, tempMaximum=tempMaximum, diskWriteIops=diskWriteIops, cpuUtilizationStatsTable=cpuUtilizationStatsTable, platformTemperatureTable=platformTemperatureTable, platformMemGroup=platformMemGroup, tempMinimum=tempMinimum, fantrayStatsTable=fantrayStatsTable, fantrayStatsEntry=fantrayStatsEntry, memAvailable=memAvailable, fwTable=fwTable, coreName=coreName, temperatureStatsTable=temperatureStatsTable, fwName=fwName, memFree=memFree, diskReadBytes=diskReadBytes, diskSize=diskSize, coreIndex=coreIndex, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, f5PlatformStats=f5PlatformStats, platformDiskStatsTable=platformDiskStatsTable, fan_11_speed=fan_11_speed, platformConformance=platformConformance, diskSerialNo=diskSerialNo, memPlatformTotal=memPlatformTotal, diskModel=diskModel, cpuIndex=cpuIndex, diskType=diskType)
