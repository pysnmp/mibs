...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", platformTemperatureTable=platformTemperatureTable, fwName=fwName, cpuStepping=cpuStepping, cpuCore=cpuCore, cpuCurrent=cpuCurrent, fan_9_speed=fan_9_speed, String=String, cpuUtilizationStatsTable=cpuUtilizationStatsTable, platformGroups=platformGroups, platformFantrayGroup=platformFantrayGroup, fan_10_speed=fan_10_speed, cpuProcessorStatsTable=cpuProcessorStatsTable, tempAverage=tempAverage, platformTempGroup=platformTempGroup, coreIndex=coreIndex, diskReadLatencyMs=diskReadLatencyMs, cpuTotal5minAvg=cpuTotal5minAvg, memoryStatsTable=memoryStatsTable, index=index, temperatureStatsTable=temperatureStatsTable, fan_6_speed=fan_6_speed, fan_8_speed=fan_8_speed, configurable=configurable, cpuCoreCnt=cpuCoreCnt, platformFwVersionGroup=platformFwVersionGroup, diskUtilizationStatsEntry=diskUtilizationStatsEntry, diskReadBytes=diskReadBytes, memPlatformTotal=memPlatformTotal, diskModel=diskModel, platformDiskGroup=platformDiskGroup, memAvailable=memAvailable, diskInfoTable=diskInfoTable, diskInfoEntry=diskInfoEntry, diskWriteBytes=diskWriteBytes, tempCurrent=tempCurrent, diskVendor=diskVendor, tempMinimum=tempMinimum, fan_2_speed=fan_2_speed, cpuCoreStatsTable=cpuCoreStatsTable, fan_12_speed=fan_12_speed, fan_11_speed=fan_11_speed, cpuCoreStatsEntry=cpuCoreStatsEntry, coreName=coreName, diskUtilizationStatsTable=diskUtilizationStatsTable, temperatureStatsEntry=temperatureStatsEntry, fwVersion=fwVersion, platformCompliances=platformCompliances, cpuCacheSize=cpuCacheSize, fwTable=fwTable, fan_3_speed=fan_3_speed, diskVersion=diskVersion, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, platformFpgaTable=platformFpgaTable, platformFwTable=platformFwTable, diskTotalIops=diskTotalIops, cpuTotal5secAvg=cpuTotal5secAvg, tempMaximum=tempMaximum, platformCPUGroup=platformCPUGroup, fantrayStatsEntry=fantrayStatsEntry, diskName=diskName, coreTotal1minAvg=coreTotal1minAvg, cpuFreq=cpuFreq, platformMemoryStatsTable=platformMemoryStatsTable, fpgaEntry=fpgaEntry, fan_4_speed=fan_4_speed, platformDiskStatsTable=platformDiskStatsTable, memPercentageUsed=memPercentageUsed, memPlatformUsed=memPlatformUsed, diskSize=diskSize, cpuIndex=cpuIndex, platformMemGroup=platformMemGroup, cpuModelName=cpuModelName, diskPercentageUsed=diskPercentageUsed, diskWriteIops=diskWriteIops, coreTotal5secAvg=coreTotal5secAvg, memFree=memFree, fpgaTable=fpgaTable, platformFpgaGroup=platformFpgaGroup, diskReadIops=diskReadIops, fan_1_speed=fan_1_speed, fwEntry=fwEntry, fan_5_speed=fan_5_speed, platformCpuStatsTable=platformCpuStatsTable, diskWriteMerged=diskWriteMerged, platformCompliance=platformCompliance, PYSNMP_MODULE_ID=f5PlatformStats, fantrayStatsTable=fantrayStatsTable, fwUpdateStatus=fwUpdateStatus, fpgaVersion=fpgaVersion, diskWriteLatencyMs=diskWriteLatencyMs, coreCurrent=coreCurrent, diskSerialNo=diskSerialNo, f5PlatformStatsObjects=f5PlatformStatsObjects, diskReadMerged=diskReadMerged, PlatformStatsIndex=PlatformStatsIndex, cpuProcessorStatsEntry=cpuProcessorStatsEntry, memoryStatsEntry=memoryStatsEntry, fan_7_speed=fan_7_speed, f5PlatformStats=f5PlatformStats, fpgaIndex=fpgaIndex, platformConformance=platformConformance, platformFantrayTable=platformFantrayTable, coreTotal5minAvg=coreTotal5minAvg, diskType=diskType, cpuThreadCnt=cpuThreadCnt, cpuTotal1minAvg=cpuTotal1minAvg)
