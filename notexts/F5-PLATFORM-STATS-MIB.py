...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", platformFwTable=platformFwTable, memoryStatsTable=memoryStatsTable, cpuCoreStatsEntry=cpuCoreStatsEntry, tempMinimum=tempMinimum, fpgaIndex=fpgaIndex, memPlatformUsed=memPlatformUsed, cpuTotal1minAvg=cpuTotal1minAvg, platformMemoryStatsTable=platformMemoryStatsTable, fan_6_speed=fan_6_speed, platformCPUGroup=platformCPUGroup, coreTotal5secAvg=coreTotal5secAvg, coreName=coreName, fantrayStatsTable=fantrayStatsTable, platformTemperatureTable=platformTemperatureTable, platformMemGroup=platformMemGroup, memoryStatsEntry=memoryStatsEntry, diskType=diskType, cpuCoreCnt=cpuCoreCnt, cpuModelName=cpuModelName, diskInfoEntry=diskInfoEntry, coreTotal1minAvg=coreTotal1minAvg, coreTotal5minAvg=coreTotal5minAvg, cpuCore=cpuCore, fan_4_speed=fan_4_speed, platformCpuStatsTable=platformCpuStatsTable, String=String, cpuCoreStatsTable=cpuCoreStatsTable, configurable=configurable, cpuTotal5minAvg=cpuTotal5minAvg, diskReadIops=diskReadIops, diskWriteBytes=diskWriteBytes, PYSNMP_MODULE_ID=f5PlatformStats, diskInfoTable=diskInfoTable, fan_2_speed=fan_2_speed, platformFwVersionGroup=platformFwVersionGroup, fwName=fwName, diskSerialNo=diskSerialNo, cpuThreadCnt=cpuThreadCnt, cpuFreq=cpuFreq, diskPercentageUsed=diskPercentageUsed, fan_12_speed=fan_12_speed, platformDiskStatsTable=platformDiskStatsTable, fan_11_speed=fan_11_speed, f5PlatformStatsObjects=f5PlatformStatsObjects, f5PlatformStats=f5PlatformStats, temperatureStatsTable=temperatureStatsTable, cpuStepping=cpuStepping, fpgaVersion=fpgaVersion, diskUtilizationStatsTable=diskUtilizationStatsTable, platformCompliances=platformCompliances, fan_10_speed=fan_10_speed, platformFantrayGroup=platformFantrayGroup, platformConformance=platformConformance, index=index, tempCurrent=tempCurrent, platformFpgaGroup=platformFpgaGroup, diskWriteMerged=diskWriteMerged, cpuUtilizationStatsTable=cpuUtilizationStatsTable, fan_8_speed=fan_8_speed, cpuCacheSize=cpuCacheSize, coreIndex=coreIndex, tempMaximum=tempMaximum, fantrayStatsEntry=fantrayStatsEntry, diskVendor=diskVendor, cpuProcessorStatsTable=cpuProcessorStatsTable, fwUpdateStatus=fwUpdateStatus, diskModel=diskModel, diskVersion=diskVersion, coreCurrent=coreCurrent, diskReadMerged=diskReadMerged, diskWriteIops=diskWriteIops, cpuCurrent=cpuCurrent, memPlatformTotal=memPlatformTotal, diskUtilizationStatsEntry=diskUtilizationStatsEntry, fwVersion=fwVersion, fan_9_speed=fan_9_speed, fan_3_speed=fan_3_speed, fwEntry=fwEntry, diskSize=diskSize, platformCompliance=platformCompliance, memAvailable=memAvailable, platformDiskGroup=platformDiskGroup, diskReadLatencyMs=diskReadLatencyMs, fpgaTable=fpgaTable, platformFpgaTable=platformFpgaTable, cpuTotal5secAvg=cpuTotal5secAvg, fan_5_speed=fan_5_speed, tempAverage=tempAverage, diskTotalIops=diskTotalIops, diskReadBytes=diskReadBytes, cpuProcessorStatsEntry=cpuProcessorStatsEntry, platformFantrayTable=platformFantrayTable, PlatformStatsIndex=PlatformStatsIndex, fpgaEntry=fpgaEntry, fwTable=fwTable, temperatureStatsEntry=temperatureStatsEntry, fan_7_speed=fan_7_speed, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, memPercentageUsed=memPercentageUsed, platformTempGroup=platformTempGroup, platformGroups=platformGroups, diskName=diskName, cpuIndex=cpuIndex, memFree=memFree, fan_1_speed=fan_1_speed, diskWriteLatencyMs=diskWriteLatencyMs)
