...
# ASN.1 source AT-RESOURCE-MIB
# Source digest sha256:5c036aba8c1eb8ce2a39bbec4558eabbcc9ea9a77938efe78e107710faa86f29
...
if mibBuilder.loadTexts: resource.setLastUpdated('2014-05-26 00:00')
if mibBuilder.loadTexts: resource.setOrganization('Allied Telesis, Inc.')
rscBoardTable = MibTable((1, 3, 6, 1, 4, 1, 207, 8, 4, 4, 3, 21, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: rscBoardTable.setStatus('current')
rscBoardEntry = MibTableRow((1, 3, 6, 1, 4, 1, 207, 8, 4, 4, 3, 21, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "AT-RESOURCE-MIB", "rscStkId"), (0, "AT-RESOURCE-MIB", "rscResourceId"))
if mibBuilder.loadTexts: rscBoardEntry.setStatus('current')
rscStkId = MibTableColumn((1, 3, 6, 1, 4, 1, 207, 8, 4, 4, 3, 21, 1, 1, 1), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(1, 24))).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: rscStkId.setStatus('current')
rscResourceId = MibTableColumn((1, 3, 6, 1, 4, 1, 207, 8, 4, 4, 3, 21, 1, 1, 2), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(1, 4294967294))).setMaxAccess("notaccessible")
...
hostInfoTable = MibTable((1, 3, 6, 1, 4, 1, 207, 8, 4, 4, 3, 21, 2), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: hostInfoTable.setStatus('current')
hostInfoEntry = MibTableRow((1, 3, 6, 1, 4, 1, 207, 8, 4, 4, 3, 21, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "AT-RESOURCE-MIB", "rscStkId"))
...
mibBuilder.exportSymbols("AT-RESOURCE-MIB", PYSNMP_MODULE_ID=resource, hostInfoBootloaderVersion=hostInfoBootloaderVersion, hostInfoDRAM=hostInfoDRAM, hostInfoEntry=hostInfoEntry, hostInfoFlash=hostInfoFlash, hostInfoTable=hostInfoTable, hostInfoUptime=hostInfoUptime, resource=resource, rscBoardBay=rscBoardBay, rscBoardEntry=rscBoardEntry, rscBoardID=rscBoardID, rscBoardName=rscBoardName, rscBoardRevision=rscBoardRevision, rscBoardSerialNumber=rscBoardSerialNumber, rscBoardTable=rscBoardTable, rscBoardType=rscBoardType, rscResourceId=rscResourceId, rscStkId=rscStkId)
