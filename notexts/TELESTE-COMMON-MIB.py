...
# Produced by pysmi-1.1.12 at Thu Apr  4 03:02:49 2024
...
NotificationType, MibIdentifier, Counter32, Counter64, iso, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, Unsigned32, IpAddress, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "Counter32", "Counter64", "iso", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "Unsigned32", "IpAddress", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", productKeyMask=productKeyMask, statusFan=statusFan, controlTrapInterval=controlTrapInterval, statusSettings=statusSettings, controlTempDeadBand=controlTempDeadBand, regValue=regValue, controlMarkState=controlMarkState, sWUpdateStatus=sWUpdateStatus, moduleSlotNo=moduleSlotNo, moduleNotebookTable=moduleNotebookTable, controlLedUsage=controlLedUsage, elementLatitude=elementLatitude, productKeyFeatureTable=productKeyFeatureTable, statusRestartCounter=statusRestartCounter, statusGeneral=statusGeneral, controlTrapDelay=controlTrapDelay, moduleId=moduleId, controlReset=controlReset, elementControl=elementControl, controlTrapReceiverTable=controlTrapReceiverTable, controlTrapLifeTime=controlTrapLifeTime, notebookLineText=notebookLineText, productKeyFeatureEntry=productKeyFeatureEntry, controlTrapSending=controlTrapSending, repairDate=repairDate, moduleTable=moduleTable, controlAlarmDetection=controlAlarmDetection, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleControl=moduleControl, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleSizeOfEntry=moduleSizeOfEntry, repairNameCode=repairNameCode, elementStatus=elementStatus, controlTempLimitLoLo=controlTempLimitLoLo, receiverAddress=receiverAddress, productKeyIndex=productKeyIndex, controlInternalAppAccess=controlInternalAppAccess, moduleRepairLogEntry=moduleRepairLogEntry, statusRunningSwImage=statusRunningSwImage, productKeyFeatureEnable=productKeyFeatureEnable, moduleRegistryEntry=moduleRegistryEntry, moduleStatusTable=moduleStatusTable, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleNotebookEntry=moduleNotebookEntry, statusSoftware=statusSoftware, elementStructure=elementStructure, controlTempLimitHiHi=controlTempLimitHiHi, moduleEntry=moduleEntry, moduleSizeOfTable=moduleSizeOfTable, statusLid=statusLid, repairReasonCode=repairReasonCode, module=module, moduleAppDate=moduleAppDate, moduleName=moduleName, productKeyValue=productKeyValue, moduleBiosDate=moduleBiosDate, receiverCommunity=receiverCommunity, sizeOfRepairlog=sizeOfRepairlog, elementResetCount=elementResetCount, productKeyFeatureIndex=productKeyFeatureIndex, elementLongitude=elementLongitude, sWUpdateFileName=sWUpdateFileName, elementTotalUpTime=elementTotalUpTime, productKeyNumberOfKeys=productKeyNumberOfKeys, swUpdateURL=swUpdateURL, statusResetCause=statusResetCause, controlAlarmOnDelay=controlAlarmOnDelay, moduleControlEntry=moduleControlEntry, moduleMacAddress=moduleMacAddress, moduleSWUpdateEntry=moduleSWUpdateEntry, notebookLineNumber=notebookLineNumber, elementInformation=elementInformation, productKeyStatus=productKeyStatus, repairComment=repairComment, regIndex=regIndex, receiverPort=receiverPort, productKeyEntry=productKeyEntry, productKeyTable=productKeyTable, moduleInformation=moduleInformation, moduleAppVersion=moduleAppVersion, controlBusMasterAdminState=controlBusMasterAdminState, elementConfigChangeCode=elementConfigChangeCode, elementName=elementName, productKeyFeatureName=productKeyFeatureName, statusInternalTemperature=statusInternalTemperature, controlLocalAccess=controlLocalAccess, moduleBiosVersion=moduleBiosVersion, moduleRackNo=moduleRackNo, controlTempLimitHi=controlTempLimitHi, moduleBusAddress=moduleBusAddress, statusHardware=statusHardware, moduleStatusEntry=moduleStatusEntry, controlAlarmOffDelay=controlAlarmOffDelay, sizeOfNotebook=sizeOfNotebook, regName=regName, moduleControlTable=moduleControlTable, statusBusMaster=statusBusMaster, moduleRegistry=moduleRegistry, moduleStatus=moduleStatus, sWUpdateControl=sWUpdateControl, moduleDetailTable=moduleDetailTable, controlResetElement=controlResetElement, sizeOfRegistry=sizeOfRegistry, moduleRepairLogTable=moduleRepairLogTable, statusLmt=statusLmt, moduleHwSerialNumber=moduleHwSerialNumber, moduleHwType=moduleHwType, controlTempLimitLo=controlTempLimitLo, moduleHwVersion=moduleHwVersion, moduleRegistryTable=moduleRegistryTable, repairIndex=repairIndex, productKeyCipher=productKeyCipher, receiverEntryId=receiverEntryId, statusLidStatus=statusLidStatus, element=element, elementAltitude=elementAltitude, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementProductKey=elementProductKey, moduleDetailEntry=moduleDetailEntry, statusTemperature=statusTemperature, moduleSWUpdateTable=moduleSWUpdateTable)
