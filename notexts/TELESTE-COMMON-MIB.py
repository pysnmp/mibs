...
Bits, IpAddress, ModuleIdentity, Counter64, Integer32, NotificationType, iso, Counter32, Unsigned32, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "ModuleIdentity", "Counter64", "Integer32", "NotificationType", "iso", "Counter32", "Unsigned32", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", statusTemperature=statusTemperature, sWUpdateStatus=sWUpdateStatus, controlTempDeadBand=controlTempDeadBand, controlTempLimitHiHi=controlTempLimitHiHi, controlTrapSending=controlTrapSending, repairReasonCode=repairReasonCode, moduleSizeOfEntry=moduleSizeOfEntry, moduleControlEntry=moduleControlEntry, regIndex=regIndex, regName=regName, statusRunningSwImage=statusRunningSwImage, statusFan=statusFan, element=element, statusInternalTemperature=statusInternalTemperature, moduleBiosVersion=moduleBiosVersion, productKeyCipher=productKeyCipher, moduleStatusEntry=moduleStatusEntry, controlAlarmOffDelay=controlAlarmOffDelay, elementLongitude=elementLongitude, moduleNotebookEntry=moduleNotebookEntry, receiverCommunity=receiverCommunity, receiverAddress=receiverAddress, notebookLineText=notebookLineText, moduleStatusTable=moduleStatusTable, moduleControl=moduleControl, controlResetElement=controlResetElement, moduleStatus=moduleStatus, moduleHwSerialNumber=moduleHwSerialNumber, statusSoftware=statusSoftware, sizeOfRepairlog=sizeOfRepairlog, sizeOfRegistry=sizeOfRegistry, elementResetCount=elementResetCount, controlTrapReceiverEntry=controlTrapReceiverEntry, statusLid=statusLid, productKeyStatus=productKeyStatus, statusRestartCounter=statusRestartCounter, moduleSlotNo=moduleSlotNo, controlAlarmDetection=controlAlarmDetection, elementLatitude=elementLatitude, productKeyNumberOfFeatures=productKeyNumberOfFeatures, elementConfigChangeCode=elementConfigChangeCode, moduleEntry=moduleEntry, moduleAppDate=moduleAppDate, productKeyEntry=productKeyEntry, moduleRegistryEntry=moduleRegistryEntry, elementProductKey=elementProductKey, productKeyFeatureEnable=productKeyFeatureEnable, controlTrapLifeTime=controlTrapLifeTime, moduleRepairLogEntry=moduleRepairLogEntry, moduleId=moduleId, sWUpdateControl=sWUpdateControl, receiverPort=receiverPort, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusSettings=statusSettings, statusLidStatus=statusLidStatus, controlTrapInterval=controlTrapInterval, elementInformation=elementInformation, moduleBusAddress=moduleBusAddress, notebookLineNumber=notebookLineNumber, elementStructure=elementStructure, productKeyFeatureEntry=productKeyFeatureEntry, productKeyNumberOfKeys=productKeyNumberOfKeys, regValue=regValue, controlTrapReceiverTable=controlTrapReceiverTable, sWUpdateFileName=sWUpdateFileName, statusBusMaster=statusBusMaster, controlLocalAccess=controlLocalAccess, moduleInformation=moduleInformation, controlInternalAppAccess=controlInternalAppAccess, repairNameCode=repairNameCode, moduleMacAddress=moduleMacAddress, sizeOfNotebook=sizeOfNotebook, moduleSWUpdateTable=moduleSWUpdateTable, statusLmt=statusLmt, repairDate=repairDate, controlTempLimitLo=controlTempLimitLo, statusResetCause=statusResetCause, repairComment=repairComment, controlTrapDelay=controlTrapDelay, productKeyFeatureIndex=productKeyFeatureIndex, moduleTable=moduleTable, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, productKeyMask=productKeyMask, moduleSWUpdateEntry=moduleSWUpdateEntry, controlReset=controlReset, productKeyFeatureTable=productKeyFeatureTable, productKeyFeatureName=productKeyFeatureName, statusGeneral=statusGeneral, statusHardware=statusHardware, moduleRegistryTable=moduleRegistryTable, controlAlarmOnDelay=controlAlarmOnDelay, controlBusMasterAdminState=controlBusMasterAdminState, module=module, elementAltitude=elementAltitude, repairIndex=repairIndex, controlTempLimitHi=controlTempLimitHi, moduleRegistry=moduleRegistry, moduleDetailEntry=moduleDetailEntry, moduleNotebookTable=moduleNotebookTable, elementName=elementName, moduleBiosDate=moduleBiosDate, controlLedUsage=controlLedUsage, moduleHwVersion=moduleHwVersion, swUpdateURL=swUpdateURL, moduleSizeOfTable=moduleSizeOfTable, receiverEntryId=receiverEntryId, moduleRepairLogTable=moduleRepairLogTable, moduleControlTable=moduleControlTable, moduleHwType=moduleHwType, controlTempLimitLoLo=controlTempLimitLoLo, productKeyTable=productKeyTable, moduleName=moduleName, moduleRackNo=moduleRackNo, productKeyIndex=productKeyIndex, controlMarkState=controlMarkState, elementTotalUpTime=elementTotalUpTime, productKeyValue=productKeyValue, elementStatus=elementStatus, elementControl=elementControl, moduleDetailTable=moduleDetailTable, moduleAppVersion=moduleAppVersion)
