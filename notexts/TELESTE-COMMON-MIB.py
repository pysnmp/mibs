...
iso, NotificationType, ObjectIdentity, IpAddress, Unsigned32, TimeTicks, Counter32, Bits, Gauge32, ModuleIdentity, MibIdentifier, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "ObjectIdentity", "IpAddress", "Unsigned32", "TimeTicks", "Counter32", "Bits", "Gauge32", "ModuleIdentity", "MibIdentifier", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleSWUpdateEntry=moduleSWUpdateEntry, elementProductKey=elementProductKey, elementControl=elementControl, controlBusMasterAdminState=controlBusMasterAdminState, moduleName=moduleName, moduleInformation=moduleInformation, repairDate=repairDate, controlTrapReceiverEntry=controlTrapReceiverEntry, statusLmt=statusLmt, productKeyNumberOfFeatures=productKeyNumberOfFeatures, receiverAddress=receiverAddress, moduleMacAddress=moduleMacAddress, statusInternalTemperature=statusInternalTemperature, controlTempLimitHiHi=controlTempLimitHiHi, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleHwType=moduleHwType, repairNameCode=repairNameCode, statusSettings=statusSettings, productKeyFeatureEntry=productKeyFeatureEntry, elementAltitude=elementAltitude, moduleSWUpdateTable=moduleSWUpdateTable, moduleAppDate=moduleAppDate, controlAlarmOnDelay=controlAlarmOnDelay, sizeOfNotebook=sizeOfNotebook, productKeyNumberOfKeys=productKeyNumberOfKeys, controlReset=controlReset, moduleRegistry=moduleRegistry, moduleStatusEntry=moduleStatusEntry, moduleTable=moduleTable, controlTrapInterval=controlTrapInterval, productKeyTable=productKeyTable, moduleId=moduleId, regIndex=regIndex, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, receiverEntryId=receiverEntryId, productKeyValue=productKeyValue, sizeOfRegistry=sizeOfRegistry, moduleHwVersion=moduleHwVersion, statusLid=statusLid, receiverCommunity=receiverCommunity, productKeyFeatureTable=productKeyFeatureTable, controlTrapDelay=controlTrapDelay, controlTrapSending=controlTrapSending, elementName=elementName, moduleSizeOfEntry=moduleSizeOfEntry, moduleBusAddress=moduleBusAddress, moduleControlTable=moduleControlTable, moduleRepairLogEntry=moduleRepairLogEntry, statusRunningSwImage=statusRunningSwImage, sizeOfRepairlog=sizeOfRepairlog, statusResetCause=statusResetCause, controlLocalAccess=controlLocalAccess, regName=regName, elementLongitude=elementLongitude, moduleControl=moduleControl, controlResetElement=controlResetElement, statusLidStatus=statusLidStatus, notebookLineText=notebookLineText, productKeyFeatureEnable=productKeyFeatureEnable, moduleRepairLogTable=moduleRepairLogTable, statusGeneral=statusGeneral, moduleHwSerialNumber=moduleHwSerialNumber, controlLedUsage=controlLedUsage, statusHardware=statusHardware, regValue=regValue, controlTrapReceiverTable=controlTrapReceiverTable, productKeyFeatureName=productKeyFeatureName, moduleRegistryTable=moduleRegistryTable, moduleDetailTable=moduleDetailTable, moduleRegistryEntry=moduleRegistryEntry, sWUpdateStatus=sWUpdateStatus, elementStatus=elementStatus, moduleBiosVersion=moduleBiosVersion, statusRestartCounter=statusRestartCounter, controlAlarmDetection=controlAlarmDetection, moduleStatus=moduleStatus, controlTrapLifeTime=controlTrapLifeTime, sWUpdateControl=sWUpdateControl, controlInternalAppAccess=controlInternalAppAccess, swUpdateURL=swUpdateURL, controlAlarmOffDelay=controlAlarmOffDelay, moduleAppVersion=moduleAppVersion, controlTempDeadBand=controlTempDeadBand, statusFan=statusFan, sWUpdateFileName=sWUpdateFileName, element=element, productKeyCipher=productKeyCipher, productKeyStatus=productKeyStatus, repairComment=repairComment, repairIndex=repairIndex, notebookLineNumber=notebookLineNumber, moduleRackNo=moduleRackNo, statusBusMaster=statusBusMaster, module=module, moduleBiosDate=moduleBiosDate, moduleDetailEntry=moduleDetailEntry, elementTotalUpTime=elementTotalUpTime, productKeyMask=productKeyMask, statusTemperature=statusTemperature, moduleControlEntry=moduleControlEntry, receiverPort=receiverPort, elementLatitude=elementLatitude, controlTempLimitHi=controlTempLimitHi, moduleSlotNo=moduleSlotNo, moduleNotebookTable=moduleNotebookTable, moduleNotebookEntry=moduleNotebookEntry, statusSoftware=statusSoftware, moduleStatusTable=moduleStatusTable, controlMarkState=controlMarkState, elementResetCount=elementResetCount, productKeyFeatureIndex=productKeyFeatureIndex, productKeyIndex=productKeyIndex, moduleSizeOfTable=moduleSizeOfTable, moduleEntry=moduleEntry, repairReasonCode=repairReasonCode, elementInformation=elementInformation, controlTempLimitLoLo=controlTempLimitLoLo, controlTempLimitLo=controlTempLimitLo, elementStructure=elementStructure, elementConfigChangeCode=elementConfigChangeCode, productKeyEntry=productKeyEntry)
