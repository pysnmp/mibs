...
# Produced by pysmi-1.1.8 at Tue Aug  9 16:15:58 2022
...
Counter32, Gauge32, Bits, Unsigned32, TimeTicks, Integer32, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, ModuleIdentity, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "Bits", "Unsigned32", "TimeTicks", "Integer32", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "ModuleIdentity", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", repairComment=repairComment, receiverCommunity=receiverCommunity, moduleStatus=moduleStatus, element=element, elementAltitude=elementAltitude, moduleInformation=moduleInformation, controlTrapReceiverEntry=controlTrapReceiverEntry, controlInternalAppAccess=controlInternalAppAccess, moduleSizeOfTable=moduleSizeOfTable, statusTemperature=statusTemperature, statusSettings=statusSettings, statusBusMaster=statusBusMaster, productKeyIndex=productKeyIndex, moduleNotebookEntry=moduleNotebookEntry, regName=regName, repairNameCode=repairNameCode, moduleRegistryTable=moduleRegistryTable, moduleId=moduleId, productKeyStatus=productKeyStatus, controlBusMasterAdminState=controlBusMasterAdminState, swUpdateURL=swUpdateURL, sizeOfRegistry=sizeOfRegistry, moduleEntry=moduleEntry, controlMarkState=controlMarkState, controlAlarmDetection=controlAlarmDetection, elementLongitude=elementLongitude, statusHardware=statusHardware, regIndex=regIndex, controlTrapDelay=controlTrapDelay, receiverAddress=receiverAddress, productKeyFeatureName=productKeyFeatureName, productKeyFeatureEnable=productKeyFeatureEnable, moduleHwSerialNumber=moduleHwSerialNumber, controlLocalAccess=controlLocalAccess, controlTrapSending=controlTrapSending, productKeyFeatureEntry=productKeyFeatureEntry, notebookLineNumber=notebookLineNumber, notebookLineText=notebookLineText, controlAlarmOffDelay=controlAlarmOffDelay, productKeyEntry=productKeyEntry, moduleRackNo=moduleRackNo, moduleAppVersion=moduleAppVersion, moduleName=moduleName, moduleControlTable=moduleControlTable, productKeyTable=productKeyTable, controlTrapLifeTime=controlTrapLifeTime, statusGeneral=statusGeneral, elementResetCount=elementResetCount, sWUpdateFileName=sWUpdateFileName, moduleSlotNo=moduleSlotNo, statusRestartCounter=statusRestartCounter, statusInternalTemperature=statusInternalTemperature, moduleDetailTable=moduleDetailTable, controlTrapInterval=controlTrapInterval, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlTempLimitLo=controlTempLimitLo, controlTrapReceiverTable=controlTrapReceiverTable, sizeOfRepairlog=sizeOfRepairlog, elementLatitude=elementLatitude, elementControl=elementControl, moduleControlEntry=moduleControlEntry, moduleBusAddress=moduleBusAddress, productKeyCipher=productKeyCipher, statusLidStatus=statusLidStatus, moduleHwType=moduleHwType, repairIndex=repairIndex, moduleHwVersion=moduleHwVersion, productKeyValue=productKeyValue, elementConfigChangeCode=elementConfigChangeCode, sWUpdateControl=sWUpdateControl, regValue=regValue, moduleAppDate=moduleAppDate, sizeOfNotebook=sizeOfNotebook, statusFan=statusFan, moduleMacAddress=moduleMacAddress, sWUpdateStatus=sWUpdateStatus, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, repairDate=repairDate, moduleRepairLogTable=moduleRepairLogTable, productKeyFeatureTable=productKeyFeatureTable, receiverPort=receiverPort, receiverEntryId=receiverEntryId, controlTempLimitHiHi=controlTempLimitHiHi, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleBiosDate=moduleBiosDate, statusRunningSwImage=statusRunningSwImage, statusLid=statusLid, productKeyFeatureIndex=productKeyFeatureIndex, moduleBiosVersion=moduleBiosVersion, moduleControl=moduleControl, moduleRegistry=moduleRegistry, moduleSizeOfEntry=moduleSizeOfEntry, moduleTable=moduleTable, moduleStatusEntry=moduleStatusEntry, controlLedUsage=controlLedUsage, controlReset=controlReset, elementStatus=elementStatus, controlAlarmOnDelay=controlAlarmOnDelay, elementStructure=elementStructure, moduleRegistryEntry=moduleRegistryEntry, module=module, productKeyNumberOfKeys=productKeyNumberOfKeys, elementName=elementName, controlTempDeadBand=controlTempDeadBand, moduleRepairLogEntry=moduleRepairLogEntry, elementInformation=elementInformation, repairReasonCode=repairReasonCode, productKeyMask=productKeyMask, controlResetElement=controlResetElement, controlTempLimitLoLo=controlTempLimitLoLo, statusLmt=statusLmt, elementProductKey=elementProductKey, statusResetCause=statusResetCause, statusSoftware=statusSoftware, moduleDetailEntry=moduleDetailEntry, moduleSWUpdateTable=moduleSWUpdateTable, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleNotebookTable=moduleNotebookTable, moduleStatusTable=moduleStatusTable, elementTotalUpTime=elementTotalUpTime, controlTempLimitHi=controlTempLimitHi)
