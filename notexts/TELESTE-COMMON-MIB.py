...
# Produced by pysmi-1.1.12 at Mon Jun  3 11:02:36 2024
...
ModuleIdentity, Bits, iso, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, MibIdentifier, NotificationType, TimeTicks, Counter32, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "iso", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "MibIdentifier", "NotificationType", "TimeTicks", "Counter32", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", regName=regName, repairComment=repairComment, moduleName=moduleName, productKeyFeatureEntry=productKeyFeatureEntry, moduleSizeOfEntry=moduleSizeOfEntry, module=module, moduleHwType=moduleHwType, receiverEntryId=receiverEntryId, statusTemperature=statusTemperature, elementLongitude=elementLongitude, moduleTable=moduleTable, productKeyFeatureEnable=productKeyFeatureEnable, statusRunningSwImage=statusRunningSwImage, sWUpdateFileName=sWUpdateFileName, controlTrapReceiverTable=controlTrapReceiverTable, controlTrapReceiverEntry=controlTrapReceiverEntry, repairDate=repairDate, productKeyIndex=productKeyIndex, elementName=elementName, moduleRegistryEntry=moduleRegistryEntry, controlAlarmOnDelay=controlAlarmOnDelay, controlTempLimitHiHi=controlTempLimitHiHi, statusGeneral=statusGeneral, statusLidStatus=statusLidStatus, elementStructure=elementStructure, statusLid=statusLid, controlTrapDelay=controlTrapDelay, receiverCommunity=receiverCommunity, sWUpdateControl=sWUpdateControl, moduleId=moduleId, elementStatus=elementStatus, sizeOfRepairlog=sizeOfRepairlog, moduleDetailEntry=moduleDetailEntry, moduleAppDate=moduleAppDate, sizeOfRegistry=sizeOfRegistry, controlTempLimitLo=controlTempLimitLo, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementInformation=elementInformation, moduleInformation=moduleInformation, regValue=regValue, statusRestartCounter=statusRestartCounter, controlReset=controlReset, element=element, controlTempLimitLoLo=controlTempLimitLoLo, moduleAppVersion=moduleAppVersion, sWUpdateStatus=sWUpdateStatus, controlResetElement=controlResetElement, notebookLineText=notebookLineText, moduleEntry=moduleEntry, statusBusMaster=statusBusMaster, statusFan=statusFan, repairNameCode=repairNameCode, elementResetCount=elementResetCount, sizeOfNotebook=sizeOfNotebook, productKeyTable=productKeyTable, statusResetCause=statusResetCause, controlMarkState=controlMarkState, notebookLineNumber=notebookLineNumber, moduleStatus=moduleStatus, regIndex=regIndex, productKeyMask=productKeyMask, moduleHwSerialNumber=moduleHwSerialNumber, productKeyCipher=productKeyCipher, moduleStatusTable=moduleStatusTable, controlInternalAppAccess=controlInternalAppAccess, controlTempDeadBand=controlTempDeadBand, repairReasonCode=repairReasonCode, statusSettings=statusSettings, moduleRegistry=moduleRegistry, controlAlarmDetection=controlAlarmDetection, moduleRackNo=moduleRackNo, moduleControlEntry=moduleControlEntry, statusHardware=statusHardware, moduleBiosDate=moduleBiosDate, moduleSWUpdateEntry=moduleSWUpdateEntry, productKeyEntry=productKeyEntry, productKeyFeatureTable=productKeyFeatureTable, moduleNotebookTable=moduleNotebookTable, controlLedUsage=controlLedUsage, swUpdateURL=swUpdateURL, controlAlarmOffDelay=controlAlarmOffDelay, elementProductKey=elementProductKey, productKeyNumberOfFeatures=productKeyNumberOfFeatures, receiverAddress=receiverAddress, controlTrapLifeTime=controlTrapLifeTime, moduleMacAddress=moduleMacAddress, elementConfigChangeCode=elementConfigChangeCode, elementLatitude=elementLatitude, moduleSWUpdateTable=moduleSWUpdateTable, elementAltitude=elementAltitude, moduleSizeOfTable=moduleSizeOfTable, moduleRepairLogTable=moduleRepairLogTable, elementTotalUpTime=elementTotalUpTime, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleHwVersion=moduleHwVersion, controlLocalAccess=controlLocalAccess, repairIndex=repairIndex, receiverPort=receiverPort, productKeyValue=productKeyValue, controlBusMasterAdminState=controlBusMasterAdminState, moduleControl=moduleControl, productKeyStatus=productKeyStatus, productKeyFeatureName=productKeyFeatureName, moduleControlTable=moduleControlTable, controlTrapSending=controlTrapSending, controlTrapInterval=controlTrapInterval, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusInternalTemperature=statusInternalTemperature, moduleNotebookEntry=moduleNotebookEntry, statusLmt=statusLmt, moduleRepairLogEntry=moduleRepairLogEntry, moduleSlotNo=moduleSlotNo, productKeyFeatureIndex=productKeyFeatureIndex, moduleRegistryTable=moduleRegistryTable, moduleBiosVersion=moduleBiosVersion, moduleDetailTable=moduleDetailTable, moduleStatusEntry=moduleStatusEntry, moduleBusAddress=moduleBusAddress, controlTempLimitHi=controlTempLimitHi, statusSoftware=statusSoftware, elementControl=elementControl)
