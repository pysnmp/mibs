...
ObjectIdentity, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, Unsigned32, MibIdentifier, Counter32, IpAddress, TimeTicks, NotificationType, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "Unsigned32", "MibIdentifier", "Counter32", "IpAddress", "TimeTicks", "NotificationType", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", sWUpdateStatus=sWUpdateStatus, productKeyFeatureName=productKeyFeatureName, repairIndex=repairIndex, notebookLineNumber=notebookLineNumber, moduleHwVersion=moduleHwVersion, moduleAppVersion=moduleAppVersion, notebookLineText=notebookLineText, moduleSlotNo=moduleSlotNo, regName=regName, moduleInformation=moduleInformation, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleStatusEntry=moduleStatusEntry, receiverAddress=receiverAddress, statusLmt=statusLmt, moduleNotebookEntry=moduleNotebookEntry, moduleBiosDate=moduleBiosDate, statusRestartCounter=statusRestartCounter, controlMarkState=controlMarkState, moduleSizeOfTable=moduleSizeOfTable, elementLongitude=elementLongitude, moduleSizeOfEntry=moduleSizeOfEntry, moduleBusAddress=moduleBusAddress, controlTrapSending=controlTrapSending, regIndex=regIndex, elementControl=elementControl, controlResetElement=controlResetElement, moduleEntry=moduleEntry, repairComment=repairComment, moduleControl=moduleControl, statusResetCause=statusResetCause, elementInformation=elementInformation, elementAltitude=elementAltitude, productKeyFeatureTable=productKeyFeatureTable, productKeyCipher=productKeyCipher, moduleRegistryEntry=moduleRegistryEntry, statusLid=statusLid, moduleRegistryTable=moduleRegistryTable, swUpdateURL=swUpdateURL, repairDate=repairDate, controlInternalAppAccess=controlInternalAppAccess, moduleBiosVersion=moduleBiosVersion, controlLocalAccess=controlLocalAccess, moduleControlEntry=moduleControlEntry, productKeyIndex=productKeyIndex, elementName=elementName, productKeyValue=productKeyValue, statusBusMaster=statusBusMaster, elementStructure=elementStructure, moduleName=moduleName, element=element, regValue=regValue, controlLedUsage=controlLedUsage, statusGeneral=statusGeneral, receiverEntryId=receiverEntryId, statusSettings=statusSettings, statusLidStatus=statusLidStatus, statusInternalTemperature=statusInternalTemperature, elementResetCount=elementResetCount, productKeyStatus=productKeyStatus, moduleRepairLogTable=moduleRepairLogTable, moduleSWUpdateEntry=moduleSWUpdateEntry, productKeyEntry=productKeyEntry, elementLatitude=elementLatitude, moduleRackNo=moduleRackNo, controlTrapInterval=controlTrapInterval, elementProductKey=elementProductKey, moduleHwSerialNumber=moduleHwSerialNumber, elementStatus=elementStatus, sizeOfRepairlog=sizeOfRepairlog, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlTrapLifeTime=controlTrapLifeTime, moduleId=moduleId, repairReasonCode=repairReasonCode, moduleSWUpdateTable=moduleSWUpdateTable, controlReset=controlReset, repairNameCode=repairNameCode, sizeOfRegistry=sizeOfRegistry, moduleAppDate=moduleAppDate, controlAlarmOffDelay=controlAlarmOffDelay, productKeyNumberOfKeys=productKeyNumberOfKeys, module=module, moduleStatus=moduleStatus, controlTrapDelay=controlTrapDelay, moduleControlTable=moduleControlTable, controlTempDeadBand=controlTempDeadBand, moduleStatusTable=moduleStatusTable, statusSoftware=statusSoftware, moduleMacAddress=moduleMacAddress, statusTemperature=statusTemperature, controlTrapReceiverTable=controlTrapReceiverTable, moduleRegistry=moduleRegistry, moduleHwType=moduleHwType, productKeyFeatureEnable=productKeyFeatureEnable, controlAlarmDetection=controlAlarmDetection, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementConfigChangeCode=elementConfigChangeCode, controlBusMasterAdminState=controlBusMasterAdminState, moduleDetailEntry=moduleDetailEntry, sizeOfNotebook=sizeOfNotebook, sWUpdateFileName=sWUpdateFileName, productKeyTable=productKeyTable, statusFan=statusFan, moduleNotebookTable=moduleNotebookTable, sWUpdateControl=sWUpdateControl, productKeyFeatureEntry=productKeyFeatureEntry, elementTotalUpTime=elementTotalUpTime, controlTempLimitLo=controlTempLimitLo, moduleRepairLogEntry=moduleRepairLogEntry, receiverCommunity=receiverCommunity, controlTempLimitHi=controlTempLimitHi, productKeyMask=productKeyMask, receiverPort=receiverPort, statusHardware=statusHardware, controlAlarmOnDelay=controlAlarmOnDelay, statusRunningSwImage=statusRunningSwImage, controlTempLimitLoLo=controlTempLimitLoLo, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleTable=moduleTable, controlTempLimitHiHi=controlTempLimitHiHi, moduleDetailTable=moduleDetailTable, productKeyFeatureIndex=productKeyFeatureIndex)
