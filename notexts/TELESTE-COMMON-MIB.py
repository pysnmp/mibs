...
# Produced by pysmi-1.1.12 at Tue Dec  3 11:01:14 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, Counter64, Gauge32, Counter32, Integer32, ObjectIdentity, Bits, NotificationType, iso, Unsigned32, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "Counter64", "Gauge32", "Counter32", "Integer32", "ObjectIdentity", "Bits", "NotificationType", "iso", "Unsigned32", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", statusRunningSwImage=statusRunningSwImage, repairIndex=repairIndex, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, sizeOfRegistry=sizeOfRegistry, controlTrapLifeTime=controlTrapLifeTime, moduleStatus=moduleStatus, statusRestartCounter=statusRestartCounter, moduleSlotNo=moduleSlotNo, controlLedUsage=controlLedUsage, sWUpdateFileName=sWUpdateFileName, statusSettings=statusSettings, controlAlarmOffDelay=controlAlarmOffDelay, moduleBusAddress=moduleBusAddress, moduleId=moduleId, controlTrapInterval=controlTrapInterval, moduleRackNo=moduleRackNo, productKeyCipher=productKeyCipher, moduleAppDate=moduleAppDate, controlTempLimitHi=controlTempLimitHi, controlInternalAppAccess=controlInternalAppAccess, elementResetCount=elementResetCount, moduleRegistryEntry=moduleRegistryEntry, moduleHwSerialNumber=moduleHwSerialNumber, elementName=elementName, moduleSizeOfTable=moduleSizeOfTable, statusInternalTemperature=statusInternalTemperature, moduleSWUpdateTable=moduleSWUpdateTable, moduleControlTable=moduleControlTable, sWUpdateControl=sWUpdateControl, controlAlarmDetection=controlAlarmDetection, statusBusMaster=statusBusMaster, moduleNotebookEntry=moduleNotebookEntry, sWUpdateStatus=sWUpdateStatus, productKeyEntry=productKeyEntry, notebookLineNumber=notebookLineNumber, controlTempLimitLo=controlTempLimitLo, moduleStatusEntry=moduleStatusEntry, elementLongitude=elementLongitude, moduleBiosDate=moduleBiosDate, regName=regName, elementStatus=elementStatus, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlTrapSending=controlTrapSending, productKeyStatus=productKeyStatus, productKeyFeatureIndex=productKeyFeatureIndex, moduleRepairLogTable=moduleRepairLogTable, moduleHwType=moduleHwType, moduleAppVersion=moduleAppVersion, controlResetElement=controlResetElement, elementControl=elementControl, controlTrapDelay=controlTrapDelay, receiverCommunity=receiverCommunity, productKeyFeatureTable=productKeyFeatureTable, controlTrapReceiverTable=controlTrapReceiverTable, controlMarkState=controlMarkState, sizeOfNotebook=sizeOfNotebook, statusLmt=statusLmt, swUpdateURL=swUpdateURL, receiverEntryId=receiverEntryId, controlReset=controlReset, productKeyMask=productKeyMask, productKeyValue=productKeyValue, productKeyNumberOfKeys=productKeyNumberOfKeys, statusHardware=statusHardware, productKeyFeatureEnable=productKeyFeatureEnable, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, productKeyFeatureName=productKeyFeatureName, repairComment=repairComment, statusTemperature=statusTemperature, statusResetCause=statusResetCause, statusSoftware=statusSoftware, elementAltitude=elementAltitude, moduleNotebookTable=moduleNotebookTable, notebookLineText=notebookLineText, moduleSWUpdateEntry=moduleSWUpdateEntry, controlBusMasterAdminState=controlBusMasterAdminState, statusGeneral=statusGeneral, moduleEntry=moduleEntry, moduleDetailEntry=moduleDetailEntry, productKeyFeatureEntry=productKeyFeatureEntry, moduleSizeOfEntry=moduleSizeOfEntry, moduleRegistry=moduleRegistry, moduleRepairLogEntry=moduleRepairLogEntry, moduleInformation=moduleInformation, moduleTable=moduleTable, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleControlEntry=moduleControlEntry, moduleStatusTable=moduleStatusTable, moduleRegistryTable=moduleRegistryTable, moduleControl=moduleControl, statusFan=statusFan, productKeyIndex=productKeyIndex, elementProductKey=elementProductKey, repairNameCode=repairNameCode, productKeyTable=productKeyTable, moduleBiosVersion=moduleBiosVersion, controlTempLimitHiHi=controlTempLimitHiHi, module=module, regIndex=regIndex, elementStructure=elementStructure, elementTotalUpTime=elementTotalUpTime, controlTempDeadBand=controlTempDeadBand, elementInformation=elementInformation, statusLidStatus=statusLidStatus, statusLid=statusLid, repairDate=repairDate, elementLatitude=elementLatitude, controlLocalAccess=controlLocalAccess, moduleDetailTable=moduleDetailTable, moduleHwVersion=moduleHwVersion, receiverAddress=receiverAddress, element=element, regValue=regValue, moduleName=moduleName, elementConfigChangeCode=elementConfigChangeCode, moduleMacAddress=moduleMacAddress, sizeOfRepairlog=sizeOfRepairlog, receiverPort=receiverPort, controlTempLimitLoLo=controlTempLimitLoLo, controlAlarmOnDelay=controlAlarmOnDelay, repairReasonCode=repairReasonCode)
