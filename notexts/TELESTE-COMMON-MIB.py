...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, Counter64, IpAddress, ObjectIdentity, Integer32, Unsigned32, MibIdentifier, ModuleIdentity, Bits, Counter32, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "Counter64", "IpAddress", "ObjectIdentity", "Integer32", "Unsigned32", "MibIdentifier", "ModuleIdentity", "Bits", "Counter32", "iso", "Gauge32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", elementControl=elementControl, repairReasonCode=repairReasonCode, moduleInformation=moduleInformation, moduleHwVersion=moduleHwVersion, controlInternalAppAccess=controlInternalAppAccess, moduleEntry=moduleEntry, statusLmt=statusLmt, moduleDetailTable=moduleDetailTable, controlResetElement=controlResetElement, productKeyIndex=productKeyIndex, moduleBusAddress=moduleBusAddress, controlTempLimitLo=controlTempLimitLo, controlLocalAccess=controlLocalAccess, controlReset=controlReset, productKeyCipher=productKeyCipher, sizeOfNotebook=sizeOfNotebook, controlAlarmOffDelay=controlAlarmOffDelay, notebookLineNumber=notebookLineNumber, elementTotalUpTime=elementTotalUpTime, elementStructure=elementStructure, elementName=elementName, elementConfigChangeCode=elementConfigChangeCode, productKeyStatus=productKeyStatus, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusLid=statusLid, elementAltitude=elementAltitude, moduleMacAddress=moduleMacAddress, statusSoftware=statusSoftware, moduleControlEntry=moduleControlEntry, productKeyTable=productKeyTable, controlTrapReceiverTable=controlTrapReceiverTable, moduleRegistryTable=moduleRegistryTable, moduleAppDate=moduleAppDate, moduleId=moduleId, moduleHwType=moduleHwType, notebookLineText=notebookLineText, moduleRepairLogTable=moduleRepairLogTable, controlTrapSending=controlTrapSending, sWUpdateControl=sWUpdateControl, statusResetCause=statusResetCause, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleStatus=moduleStatus, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleBiosVersion=moduleBiosVersion, moduleStatusEntry=moduleStatusEntry, moduleAppVersion=moduleAppVersion, repairIndex=repairIndex, moduleRegistryEntry=moduleRegistryEntry, repairNameCode=repairNameCode, statusFan=statusFan, moduleSizeOfTable=moduleSizeOfTable, controlTempDeadBand=controlTempDeadBand, moduleHwSerialNumber=moduleHwSerialNumber, productKeyFeatureEnable=productKeyFeatureEnable, moduleBiosDate=moduleBiosDate, moduleNotebookTable=moduleNotebookTable, sizeOfRepairlog=sizeOfRepairlog, elementLongitude=elementLongitude, repairComment=repairComment, statusRestartCounter=statusRestartCounter, moduleStatusTable=moduleStatusTable, productKeyMask=productKeyMask, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleSWUpdateTable=moduleSWUpdateTable, receiverAddress=receiverAddress, elementInformation=elementInformation, controlAlarmDetection=controlAlarmDetection, moduleControl=moduleControl, moduleSizeOfEntry=moduleSizeOfEntry, controlTrapDelay=controlTrapDelay, productKeyFeatureName=productKeyFeatureName, controlTempLimitLoLo=controlTempLimitLoLo, moduleSWUpdateEntry=moduleSWUpdateEntry, productKeyFeatureEntry=productKeyFeatureEntry, controlLedUsage=controlLedUsage, repairDate=repairDate, productKeyFeatureTable=productKeyFeatureTable, moduleTable=moduleTable, moduleRackNo=moduleRackNo, moduleDetailEntry=moduleDetailEntry, elementProductKey=elementProductKey, receiverPort=receiverPort, statusBusMaster=statusBusMaster, sWUpdateFileName=sWUpdateFileName, controlMarkState=controlMarkState, sWUpdateStatus=sWUpdateStatus, controlAlarmOnDelay=controlAlarmOnDelay, moduleRepairLogEntry=moduleRepairLogEntry, controlTempLimitHi=controlTempLimitHi, swUpdateURL=swUpdateURL, elementLatitude=elementLatitude, productKeyEntry=productKeyEntry, element=element, regValue=regValue, moduleSlotNo=moduleSlotNo, elementResetCount=elementResetCount, statusSettings=statusSettings, controlTrapLifeTime=controlTrapLifeTime, moduleRegistry=moduleRegistry, productKeyFeatureIndex=productKeyFeatureIndex, sizeOfRegistry=sizeOfRegistry, moduleNotebookEntry=moduleNotebookEntry, regIndex=regIndex, statusTemperature=statusTemperature, moduleControlTable=moduleControlTable, moduleName=moduleName, productKeyNumberOfFeatures=productKeyNumberOfFeatures, elementStatus=elementStatus, receiverCommunity=receiverCommunity, module=module, controlTempLimitHiHi=controlTempLimitHiHi, controlBusMasterAdminState=controlBusMasterAdminState, productKeyValue=productKeyValue, regName=regName, receiverEntryId=receiverEntryId, statusLidStatus=statusLidStatus, statusRunningSwImage=statusRunningSwImage, statusInternalTemperature=statusInternalTemperature, statusHardware=statusHardware, statusGeneral=statusGeneral, controlTrapInterval=controlTrapInterval)
