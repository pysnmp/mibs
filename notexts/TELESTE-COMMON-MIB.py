...
ObjectIdentity, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, Counter64, Unsigned32, ModuleIdentity, TimeTicks, IpAddress, NotificationType, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "Counter64", "Unsigned32", "ModuleIdentity", "TimeTicks", "IpAddress", "NotificationType", "iso", "Gauge32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", statusResetCause=statusResetCause, moduleControl=moduleControl, regValue=regValue, moduleSlotNo=moduleSlotNo, repairIndex=repairIndex, productKeyEntry=productKeyEntry, elementStatus=elementStatus, sizeOfRepairlog=sizeOfRepairlog, moduleEntry=moduleEntry, productKeyValue=productKeyValue, swUpdateURL=swUpdateURL, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, elementTotalUpTime=elementTotalUpTime, elementResetCount=elementResetCount, statusLmt=statusLmt, statusTemperature=statusTemperature, receiverAddress=receiverAddress, sWUpdateControl=sWUpdateControl, moduleInformation=moduleInformation, statusSoftware=statusSoftware, controlMarkState=controlMarkState, notebookLineText=notebookLineText, moduleRegistryEntry=moduleRegistryEntry, controlTrapDelay=controlTrapDelay, moduleHwType=moduleHwType, moduleBiosDate=moduleBiosDate, controlTrapReceiverTable=controlTrapReceiverTable, moduleMacAddress=moduleMacAddress, productKeyFeatureTable=productKeyFeatureTable, receiverPort=receiverPort, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleSWUpdateEntry=moduleSWUpdateEntry, controlInternalAppAccess=controlInternalAppAccess, moduleControlTable=moduleControlTable, statusHardware=statusHardware, moduleDetailTable=moduleDetailTable, moduleSizeOfTable=moduleSizeOfTable, statusRestartCounter=statusRestartCounter, moduleHwVersion=moduleHwVersion, repairNameCode=repairNameCode, moduleDetailEntry=moduleDetailEntry, statusRunningSwImage=statusRunningSwImage, productKeyFeatureEntry=productKeyFeatureEntry, controlReset=controlReset, moduleBusAddress=moduleBusAddress, module=module, statusInternalTemperature=statusInternalTemperature, productKeyNumberOfFeatures=productKeyNumberOfFeatures, statusSettings=statusSettings, statusLid=statusLid, controlTempLimitHiHi=controlTempLimitHiHi, sizeOfRegistry=sizeOfRegistry, moduleRegistryTable=moduleRegistryTable, elementLongitude=elementLongitude, sizeOfNotebook=sizeOfNotebook, receiverCommunity=receiverCommunity, controlTrapInterval=controlTrapInterval, elementAltitude=elementAltitude, moduleHwSerialNumber=moduleHwSerialNumber, controlTrapLifeTime=controlTrapLifeTime, moduleStatusEntry=moduleStatusEntry, sWUpdateStatus=sWUpdateStatus, moduleTable=moduleTable, controlBusMasterAdminState=controlBusMasterAdminState, elementProductKey=elementProductKey, statusBusMaster=statusBusMaster, element=element, controlTempDeadBand=controlTempDeadBand, controlAlarmOffDelay=controlAlarmOffDelay, elementStructure=elementStructure, moduleAppVersion=moduleAppVersion, moduleAppDate=moduleAppDate, moduleSizeOfEntry=moduleSizeOfEntry, sWUpdateFileName=sWUpdateFileName, moduleId=moduleId, repairReasonCode=repairReasonCode, controlTrapSending=controlTrapSending, statusLidStatus=statusLidStatus, controlTempLimitHi=controlTempLimitHi, repairDate=repairDate, receiverEntryId=receiverEntryId, moduleRackNo=moduleRackNo, statusFan=statusFan, moduleRegistry=moduleRegistry, elementControl=elementControl, moduleSWUpdateTable=moduleSWUpdateTable, productKeyFeatureIndex=productKeyFeatureIndex, moduleControlEntry=moduleControlEntry, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementInformation=elementInformation, productKeyFeatureEnable=productKeyFeatureEnable, moduleStatusTable=moduleStatusTable, elementName=elementName, productKeyMask=productKeyMask, moduleRepairLogEntry=moduleRepairLogEntry, moduleNotebookTable=moduleNotebookTable, elementLatitude=elementLatitude, moduleRepairLogTable=moduleRepairLogTable, regName=regName, controlTempLimitLo=controlTempLimitLo, controlResetElement=controlResetElement, elementConfigChangeCode=elementConfigChangeCode, repairComment=repairComment, controlTempLimitLoLo=controlTempLimitLoLo, moduleStatus=moduleStatus, productKeyFeatureName=productKeyFeatureName, moduleNotebookEntry=moduleNotebookEntry, regIndex=regIndex, controlLocalAccess=controlLocalAccess, productKeyTable=productKeyTable, controlAlarmOnDelay=controlAlarmOnDelay, moduleBiosVersion=moduleBiosVersion, productKeyStatus=productKeyStatus, controlAlarmDetection=controlAlarmDetection, statusGeneral=statusGeneral, productKeyIndex=productKeyIndex, notebookLineNumber=notebookLineNumber, moduleName=moduleName, controlLedUsage=controlLedUsage, productKeyCipher=productKeyCipher, controlTrapReceiverEntry=controlTrapReceiverEntry)
