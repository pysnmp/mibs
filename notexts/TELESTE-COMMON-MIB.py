...
# Produced by pysmi-1.1.10 at Thu Oct 26 13:17:01 2023
...
Integer32, NotificationType, Counter64, Gauge32, MibIdentifier, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, iso, TimeTicks, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Counter64", "Gauge32", "MibIdentifier", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "iso", "TimeTicks", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", statusSoftware=statusSoftware, moduleRegistryEntry=moduleRegistryEntry, controlTempDeadBand=controlTempDeadBand, moduleControlEntry=moduleControlEntry, productKeyMask=productKeyMask, moduleSizeOfEntry=moduleSizeOfEntry, controlTrapLifeTime=controlTrapLifeTime, elementConfigChangeCode=elementConfigChangeCode, regName=regName, repairDate=repairDate, sizeOfNotebook=sizeOfNotebook, moduleTable=moduleTable, elementControl=elementControl, controlAlarmDetection=controlAlarmDetection, moduleSWUpdateEntry=moduleSWUpdateEntry, productKeyStatus=productKeyStatus, productKeyNumberOfFeatures=productKeyNumberOfFeatures, statusBusMaster=statusBusMaster, repairReasonCode=repairReasonCode, moduleName=moduleName, moduleMacAddress=moduleMacAddress, productKeyFeatureEnable=productKeyFeatureEnable, sWUpdateStatus=sWUpdateStatus, productKeyEntry=productKeyEntry, moduleSlotNo=moduleSlotNo, moduleAppDate=moduleAppDate, elementLongitude=elementLongitude, moduleBiosVersion=moduleBiosVersion, repairNameCode=repairNameCode, moduleBiosDate=moduleBiosDate, controlBusMasterAdminState=controlBusMasterAdminState, controlAlarmOnDelay=controlAlarmOnDelay, moduleSizeOfTable=moduleSizeOfTable, statusFan=statusFan, statusGeneral=statusGeneral, productKeyTable=productKeyTable, controlTrapSending=controlTrapSending, moduleStatus=moduleStatus, sizeOfRegistry=sizeOfRegistry, elementInformation=elementInformation, moduleNotebookTable=moduleNotebookTable, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleEntry=moduleEntry, notebookLineNumber=notebookLineNumber, module=module, controlTempLimitHiHi=controlTempLimitHiHi, productKeyIndex=productKeyIndex, controlReset=controlReset, moduleStatusEntry=moduleStatusEntry, controlMarkState=controlMarkState, productKeyNumberOfKeys=productKeyNumberOfKeys, statusRunningSwImage=statusRunningSwImage, controlTempLimitLoLo=controlTempLimitLoLo, statusTemperature=statusTemperature, sWUpdateFileName=sWUpdateFileName, moduleDetailEntry=moduleDetailEntry, moduleDetailTable=moduleDetailTable, moduleStatusTable=moduleStatusTable, controlLocalAccess=controlLocalAccess, notebookLineText=notebookLineText, productKeyFeatureEntry=productKeyFeatureEntry, moduleAppVersion=moduleAppVersion, swUpdateURL=swUpdateURL, elementName=elementName, moduleBusAddress=moduleBusAddress, productKeyValue=productKeyValue, moduleHwType=moduleHwType, moduleHwSerialNumber=moduleHwSerialNumber, controlAlarmOffDelay=controlAlarmOffDelay, moduleControl=moduleControl, statusLidStatus=statusLidStatus, productKeyCipher=productKeyCipher, moduleRegistryTable=moduleRegistryTable, controlTrapReceiverEntry=controlTrapReceiverEntry, repairComment=repairComment, statusHardware=statusHardware, controlTrapDelay=controlTrapDelay, controlTrapReceiverTable=controlTrapReceiverTable, elementLatitude=elementLatitude, receiverCommunity=receiverCommunity, moduleNotebookEntry=moduleNotebookEntry, controlTrapInterval=controlTrapInterval, moduleSWUpdateTable=moduleSWUpdateTable, statusRestartCounter=statusRestartCounter, elementResetCount=elementResetCount, moduleRackNo=moduleRackNo, elementStatus=elementStatus, elementAltitude=elementAltitude, moduleControlTable=moduleControlTable, moduleHwVersion=moduleHwVersion, repairIndex=repairIndex, moduleInformation=moduleInformation, elementTotalUpTime=elementTotalUpTime, sizeOfRepairlog=sizeOfRepairlog, statusLid=statusLid, moduleRepairLogTable=moduleRepairLogTable, moduleRepairLogEntry=moduleRepairLogEntry, elementProductKey=elementProductKey, statusSettings=statusSettings, regValue=regValue, controlTempLimitHi=controlTempLimitHi, statusInternalTemperature=statusInternalTemperature, statusLmt=statusLmt, controlLedUsage=controlLedUsage, statusResetCause=statusResetCause, controlResetElement=controlResetElement, controlTempLimitLo=controlTempLimitLo, moduleId=moduleId, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, receiverAddress=receiverAddress, controlInternalAppAccess=controlInternalAppAccess, productKeyFeatureName=productKeyFeatureName, sWUpdateControl=sWUpdateControl, element=element, receiverPort=receiverPort, elementStructure=elementStructure, receiverEntryId=receiverEntryId, productKeyFeatureTable=productKeyFeatureTable, regIndex=regIndex, productKeyFeatureIndex=productKeyFeatureIndex, moduleRegistry=moduleRegistry)
