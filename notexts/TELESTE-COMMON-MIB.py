...
ObjectIdentity, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, TimeTicks, IpAddress, Integer32, Unsigned32, NotificationType, Counter64, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "TimeTicks", "IpAddress", "Integer32", "Unsigned32", "NotificationType", "Counter64", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleHwType=moduleHwType, moduleBusAddress=moduleBusAddress, elementLatitude=elementLatitude, moduleBiosDate=moduleBiosDate, elementName=elementName, controlTrapSending=controlTrapSending, moduleInformation=moduleInformation, elementStatus=elementStatus, statusRestartCounter=statusRestartCounter, moduleControlTable=moduleControlTable, statusSoftware=statusSoftware, elementTotalUpTime=elementTotalUpTime, moduleName=moduleName, sWUpdateStatus=sWUpdateStatus, moduleRegistry=moduleRegistry, statusLid=statusLid, productKeyFeatureTable=productKeyFeatureTable, moduleSWUpdateTable=moduleSWUpdateTable, moduleAppVersion=moduleAppVersion, element=element, moduleEntry=moduleEntry, productKeyCipher=productKeyCipher, moduleTable=moduleTable, productKeyFeatureName=productKeyFeatureName, elementAltitude=elementAltitude, controlLedUsage=controlLedUsage, moduleRegistryEntry=moduleRegistryEntry, controlTempDeadBand=controlTempDeadBand, controlResetElement=controlResetElement, moduleRepairLogTable=moduleRepairLogTable, regValue=regValue, productKeyFeatureEnable=productKeyFeatureEnable, repairReasonCode=repairReasonCode, productKeyTable=productKeyTable, productKeyFeatureEntry=productKeyFeatureEntry, controlInternalAppAccess=controlInternalAppAccess, controlAlarmOffDelay=controlAlarmOffDelay, statusRunningSwImage=statusRunningSwImage, elementLongitude=elementLongitude, receiverCommunity=receiverCommunity, productKeyStatus=productKeyStatus, controlReset=controlReset, notebookLineText=notebookLineText, moduleHwSerialNumber=moduleHwSerialNumber, elementInformation=elementInformation, receiverEntryId=receiverEntryId, controlTempLimitHiHi=controlTempLimitHiHi, moduleControlEntry=moduleControlEntry, moduleBiosVersion=moduleBiosVersion, elementStructure=elementStructure, moduleSizeOfEntry=moduleSizeOfEntry, moduleStatusEntry=moduleStatusEntry, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, productKeyNumberOfFeatures=productKeyNumberOfFeatures, statusHardware=statusHardware, controlTempLimitHi=controlTempLimitHi, productKeyEntry=productKeyEntry, controlTrapReceiverTable=controlTrapReceiverTable, statusFan=statusFan, moduleAppDate=moduleAppDate, controlTempLimitLo=controlTempLimitLo, controlTrapInterval=controlTrapInterval, controlTrapReceiverEntry=controlTrapReceiverEntry, statusInternalTemperature=statusInternalTemperature, sizeOfRepairlog=sizeOfRepairlog, controlAlarmDetection=controlAlarmDetection, moduleDetailEntry=moduleDetailEntry, productKeyMask=productKeyMask, moduleId=moduleId, sWUpdateFileName=sWUpdateFileName, moduleNotebookTable=moduleNotebookTable, notebookLineNumber=notebookLineNumber, statusResetCause=statusResetCause, moduleControl=moduleControl, sizeOfNotebook=sizeOfNotebook, moduleRackNo=moduleRackNo, swUpdateURL=swUpdateURL, elementResetCount=elementResetCount, controlMarkState=controlMarkState, moduleHwVersion=moduleHwVersion, controlTempLimitLoLo=controlTempLimitLoLo, receiverPort=receiverPort, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleRegistryTable=moduleRegistryTable, moduleSlotNo=moduleSlotNo, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleMacAddress=moduleMacAddress, moduleRepairLogEntry=moduleRepairLogEntry, moduleSizeOfTable=moduleSizeOfTable, moduleStatus=moduleStatus, repairNameCode=repairNameCode, repairComment=repairComment, elementProductKey=elementProductKey, statusTemperature=statusTemperature, moduleStatusTable=moduleStatusTable, statusSettings=statusSettings, regIndex=regIndex, productKeyValue=productKeyValue, controlBusMasterAdminState=controlBusMasterAdminState, productKeyIndex=productKeyIndex, sizeOfRegistry=sizeOfRegistry, module=module, repairDate=repairDate, controlAlarmOnDelay=controlAlarmOnDelay, controlLocalAccess=controlLocalAccess, statusBusMaster=statusBusMaster, statusLidStatus=statusLidStatus, moduleNotebookEntry=moduleNotebookEntry, productKeyNumberOfKeys=productKeyNumberOfKeys, statusLmt=statusLmt, productKeyFeatureIndex=productKeyFeatureIndex, elementControl=elementControl, receiverAddress=receiverAddress, controlTrapDelay=controlTrapDelay, regName=regName, moduleDetailTable=moduleDetailTable, elementConfigChangeCode=elementConfigChangeCode, controlTrapLifeTime=controlTrapLifeTime, statusGeneral=statusGeneral, repairIndex=repairIndex, sWUpdateControl=sWUpdateControl)
