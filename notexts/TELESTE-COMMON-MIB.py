...
# Produced by pysmi-1.1.8 at Mon Jan 17 18:29:29 2022
...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, Unsigned32, IpAddress, ModuleIdentity, Gauge32, Counter64, iso, Integer32, NotificationType, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "Unsigned32", "IpAddress", "ModuleIdentity", "Gauge32", "Counter64", "iso", "Integer32", "NotificationType", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", sWUpdateControl=sWUpdateControl, elementStatus=elementStatus, controlTrapSending=controlTrapSending, elementTotalUpTime=elementTotalUpTime, controlAlarmOffDelay=controlAlarmOffDelay, statusResetCause=statusResetCause, controlAlarmDetection=controlAlarmDetection, moduleRepairLogEntry=moduleRepairLogEntry, statusTemperature=statusTemperature, moduleAppVersion=moduleAppVersion, sizeOfNotebook=sizeOfNotebook, productKeyStatus=productKeyStatus, repairIndex=repairIndex, sizeOfRepairlog=sizeOfRepairlog, moduleControl=moduleControl, repairDate=repairDate, moduleStatus=moduleStatus, controlTempDeadBand=controlTempDeadBand, receiverAddress=receiverAddress, elementAltitude=elementAltitude, controlResetElement=controlResetElement, controlTrapReceiverEntry=controlTrapReceiverEntry, productKeyFeatureTable=productKeyFeatureTable, controlTempLimitHi=controlTempLimitHi, moduleRegistryTable=moduleRegistryTable, moduleDetailTable=moduleDetailTable, productKeyCipher=productKeyCipher, receiverEntryId=receiverEntryId, moduleInformation=moduleInformation, moduleSWUpdateEntry=moduleSWUpdateEntry, notebookLineText=notebookLineText, moduleNotebookTable=moduleNotebookTable, moduleHwType=moduleHwType, productKeyFeatureName=productKeyFeatureName, elementStructure=elementStructure, elementControl=elementControl, sWUpdateStatus=sWUpdateStatus, moduleBiosDate=moduleBiosDate, statusSettings=statusSettings, sizeOfRegistry=sizeOfRegistry, statusRunningSwImage=statusRunningSwImage, statusGeneral=statusGeneral, statusLid=statusLid, statusSoftware=statusSoftware, productKeyFeatureEnable=productKeyFeatureEnable, controlMarkState=controlMarkState, elementName=elementName, controlBusMasterAdminState=controlBusMasterAdminState, productKeyIndex=productKeyIndex, statusFan=statusFan, productKeyValue=productKeyValue, moduleDetailEntry=moduleDetailEntry, moduleTable=moduleTable, regValue=regValue, regName=regName, moduleRegistryEntry=moduleRegistryEntry, notebookLineNumber=notebookLineNumber, receiverPort=receiverPort, controlTrapInterval=controlTrapInterval, productKeyEntry=productKeyEntry, moduleSlotNo=moduleSlotNo, controlLedUsage=controlLedUsage, controlTrapLifeTime=controlTrapLifeTime, controlTempLimitHiHi=controlTempLimitHiHi, controlAlarmOnDelay=controlAlarmOnDelay, moduleControlEntry=moduleControlEntry, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleRackNo=moduleRackNo, moduleHwSerialNumber=moduleHwSerialNumber, controlTempLimitLo=controlTempLimitLo, productKeyTable=productKeyTable, controlInternalAppAccess=controlInternalAppAccess, moduleSizeOfTable=moduleSizeOfTable, productKeyMask=productKeyMask, moduleStatusTable=moduleStatusTable, controlTempLimitLoLo=controlTempLimitLoLo, moduleNotebookEntry=moduleNotebookEntry, moduleBusAddress=moduleBusAddress, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusInternalTemperature=statusInternalTemperature, sWUpdateFileName=sWUpdateFileName, receiverCommunity=receiverCommunity, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlTrapDelay=controlTrapDelay, elementResetCount=elementResetCount, elementProductKey=elementProductKey, moduleStatusEntry=moduleStatusEntry, controlLocalAccess=controlLocalAccess, elementInformation=elementInformation, productKeyFeatureIndex=productKeyFeatureIndex, swUpdateURL=swUpdateURL, moduleSizeOfEntry=moduleSizeOfEntry, moduleAppDate=moduleAppDate, moduleRepairLogTable=moduleRepairLogTable, element=element, repairComment=repairComment, repairReasonCode=repairReasonCode, moduleSWUpdateTable=moduleSWUpdateTable, elementConfigChangeCode=elementConfigChangeCode, statusRestartCounter=statusRestartCounter, moduleEntry=moduleEntry, module=module, statusLmt=statusLmt, moduleRegistry=moduleRegistry, controlReset=controlReset, statusBusMaster=statusBusMaster, elementLongitude=elementLongitude, moduleBiosVersion=moduleBiosVersion, statusHardware=statusHardware, controlTrapReceiverTable=controlTrapReceiverTable, statusLidStatus=statusLidStatus, moduleId=moduleId, moduleControlTable=moduleControlTable, elementLatitude=elementLatitude, moduleName=moduleName, moduleMacAddress=moduleMacAddress, repairNameCode=repairNameCode, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleHwVersion=moduleHwVersion, regIndex=regIndex, productKeyFeatureEntry=productKeyFeatureEntry)
