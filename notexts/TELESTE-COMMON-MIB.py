...
ModuleIdentity, iso, Integer32, Unsigned32, TimeTicks, IpAddress, ObjectIdentity, MibIdentifier, NotificationType, Counter32, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "Integer32", "Unsigned32", "TimeTicks", "IpAddress", "ObjectIdentity", "MibIdentifier", "NotificationType", "Counter32", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", elementResetCount=elementResetCount, productKeyFeatureName=productKeyFeatureName, moduleSizeOfEntry=moduleSizeOfEntry, moduleAppDate=moduleAppDate, controlTempLimitHiHi=controlTempLimitHiHi, elementConfigChangeCode=elementConfigChangeCode, controlAlarmOnDelay=controlAlarmOnDelay, moduleAppVersion=moduleAppVersion, statusGeneral=statusGeneral, productKeyFeatureEnable=productKeyFeatureEnable, moduleRepairLogEntry=moduleRepairLogEntry, statusLmt=statusLmt, elementInformation=elementInformation, moduleStatusTable=moduleStatusTable, repairDate=repairDate, moduleBusAddress=moduleBusAddress, moduleStatusEntry=moduleStatusEntry, productKeyFeatureEntry=productKeyFeatureEntry, moduleRegistry=moduleRegistry, moduleSlotNo=moduleSlotNo, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleHwType=moduleHwType, controlAlarmOffDelay=controlAlarmOffDelay, controlLedUsage=controlLedUsage, moduleRegistryTable=moduleRegistryTable, moduleDetailEntry=moduleDetailEntry, elementStatus=elementStatus, module=module, receiverEntryId=receiverEntryId, receiverCommunity=receiverCommunity, controlLocalAccess=controlLocalAccess, sWUpdateControl=sWUpdateControl, statusTemperature=statusTemperature, controlTrapLifeTime=controlTrapLifeTime, elementAltitude=elementAltitude, controlTrapReceiverTable=controlTrapReceiverTable, moduleSWUpdateTable=moduleSWUpdateTable, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleSizeOfTable=moduleSizeOfTable, elementLatitude=elementLatitude, repairNameCode=repairNameCode, elementTotalUpTime=elementTotalUpTime, productKeyCipher=productKeyCipher, regIndex=regIndex, controlTrapReceiverEntry=controlTrapReceiverEntry, controlTrapSending=controlTrapSending, sizeOfNotebook=sizeOfNotebook, productKeyEntry=productKeyEntry, sWUpdateStatus=sWUpdateStatus, moduleBiosDate=moduleBiosDate, moduleNotebookEntry=moduleNotebookEntry, elementControl=elementControl, productKeyNumberOfKeys=productKeyNumberOfKeys, controlInternalAppAccess=controlInternalAppAccess, statusResetCause=statusResetCause, controlTempLimitHi=controlTempLimitHi, productKeyMask=productKeyMask, productKeyTable=productKeyTable, moduleRackNo=moduleRackNo, controlTempLimitLo=controlTempLimitLo, moduleName=moduleName, controlAlarmDetection=controlAlarmDetection, moduleInformation=moduleInformation, controlReset=controlReset, moduleControl=moduleControl, productKeyValue=productKeyValue, moduleEntry=moduleEntry, repairComment=repairComment, controlTrapInterval=controlTrapInterval, regName=regName, controlTrapDelay=controlTrapDelay, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleControlEntry=moduleControlEntry, repairReasonCode=repairReasonCode, moduleDetailTable=moduleDetailTable, productKeyIndex=productKeyIndex, sizeOfRegistry=sizeOfRegistry, controlBusMasterAdminState=controlBusMasterAdminState, productKeyFeatureTable=productKeyFeatureTable, controlMarkState=controlMarkState, sWUpdateFileName=sWUpdateFileName, elementProductKey=elementProductKey, elementName=elementName, sizeOfRepairlog=sizeOfRepairlog, statusLidStatus=statusLidStatus, receiverAddress=receiverAddress, moduleRegistryEntry=moduleRegistryEntry, repairIndex=repairIndex, swUpdateURL=swUpdateURL, moduleTable=moduleTable, statusSoftware=statusSoftware, statusLid=statusLid, receiverPort=receiverPort, moduleBiosVersion=moduleBiosVersion, moduleId=moduleId, statusRestartCounter=statusRestartCounter, moduleStatus=moduleStatus, element=element, moduleHwVersion=moduleHwVersion, controlTempLimitLoLo=controlTempLimitLoLo, statusSettings=statusSettings, productKeyStatus=productKeyStatus, moduleControlTable=moduleControlTable, notebookLineText=notebookLineText, statusHardware=statusHardware, moduleHwSerialNumber=moduleHwSerialNumber, statusRunningSwImage=statusRunningSwImage, productKeyFeatureIndex=productKeyFeatureIndex, notebookLineNumber=notebookLineNumber, controlTempDeadBand=controlTempDeadBand, elementLongitude=elementLongitude, elementStructure=elementStructure, moduleNotebookTable=moduleNotebookTable, controlResetElement=controlResetElement, statusInternalTemperature=statusInternalTemperature, moduleRepairLogTable=moduleRepairLogTable, statusFan=statusFan, regValue=regValue, moduleSWUpdateEntry=moduleSWUpdateEntry, moduleMacAddress=moduleMacAddress, statusBusMaster=statusBusMaster)
