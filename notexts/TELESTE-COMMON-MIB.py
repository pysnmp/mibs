...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", statusInternalTemperature=statusInternalTemperature, controlInternalAppAccess=controlInternalAppAccess, moduleRackNo=moduleRackNo, elementLatitude=elementLatitude, controlTrapInterval=controlTrapInterval, moduleHwType=moduleHwType, moduleBiosDate=moduleBiosDate, moduleNotebookEntry=moduleNotebookEntry, elementControl=elementControl, moduleControl=moduleControl, controlMarkState=controlMarkState, notebookLineNumber=notebookLineNumber, statusSoftware=statusSoftware, productKeyEntry=productKeyEntry, moduleSWUpdateEntry=moduleSWUpdateEntry, controlTrapReceiverTable=controlTrapReceiverTable, productKeyFeatureTable=productKeyFeatureTable, statusGeneral=statusGeneral, elementName=elementName, moduleSizeOfTable=moduleSizeOfTable, statusTemperature=statusTemperature, moduleControlTable=moduleControlTable, moduleControlEntry=moduleControlEntry, statusRestartCounter=statusRestartCounter, repairReasonCode=repairReasonCode, productKeyValue=productKeyValue, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleMacAddress=moduleMacAddress, productKeyNumberOfKeys=productKeyNumberOfKeys, repairIndex=repairIndex, sizeOfRepairlog=sizeOfRepairlog, elementConfigChangeCode=elementConfigChangeCode, sizeOfRegistry=sizeOfRegistry, module=module, statusSettings=statusSettings, controlLocalAccess=controlLocalAccess, controlTempLimitHiHi=controlTempLimitHiHi, elementInformation=elementInformation, moduleName=moduleName, elementResetCount=elementResetCount, moduleRepairLogEntry=moduleRepairLogEntry, moduleStatusTable=moduleStatusTable, moduleEntry=moduleEntry, regIndex=regIndex, productKeyFeatureEntry=productKeyFeatureEntry, repairComment=repairComment, moduleId=moduleId, moduleStatus=moduleStatus, receiverCommunity=receiverCommunity, productKeyCipher=productKeyCipher, elementStatus=elementStatus, regValue=regValue, moduleSWUpdateTable=moduleSWUpdateTable, controlTrapReceiverEntry=controlTrapReceiverEntry, elementLongitude=elementLongitude, moduleStatusEntry=moduleStatusEntry, statusResetCause=statusResetCause, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleHwVersion=moduleHwVersion, controlTempLimitHi=controlTempLimitHi, moduleDetailEntry=moduleDetailEntry, statusRunningSwImage=statusRunningSwImage, controlTrapLifeTime=controlTrapLifeTime, elementProductKey=elementProductKey, swUpdateURL=swUpdateURL, controlTempDeadBand=controlTempDeadBand, moduleHwSerialNumber=moduleHwSerialNumber, moduleTable=moduleTable, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusFan=statusFan, controlLedUsage=controlLedUsage, controlTempLimitLo=controlTempLimitLo, element=element, moduleBiosVersion=moduleBiosVersion, moduleBusAddress=moduleBusAddress, regName=regName, statusLid=statusLid, productKeyFeatureName=productKeyFeatureName, repairDate=repairDate, sWUpdateStatus=sWUpdateStatus, productKeyIndex=productKeyIndex, controlTrapDelay=controlTrapDelay, controlBusMasterAdminState=controlBusMasterAdminState, moduleSizeOfEntry=moduleSizeOfEntry, repairNameCode=repairNameCode, moduleNotebookTable=moduleNotebookTable, moduleSlotNo=moduleSlotNo, receiverPort=receiverPort, moduleRegistryTable=moduleRegistryTable, statusLmt=statusLmt, notebookLineText=notebookLineText, moduleInformation=moduleInformation, moduleRepairLogTable=moduleRepairLogTable, productKeyMask=productKeyMask, statusBusMaster=statusBusMaster, productKeyStatus=productKeyStatus, moduleRegistry=moduleRegistry, moduleRegistryEntry=moduleRegistryEntry, controlAlarmOffDelay=controlAlarmOffDelay, elementAltitude=elementAltitude, moduleAppDate=moduleAppDate, receiverEntryId=receiverEntryId, elementTotalUpTime=elementTotalUpTime, statusLidStatus=statusLidStatus, controlAlarmDetection=controlAlarmDetection, moduleAppVersion=moduleAppVersion, sWUpdateControl=sWUpdateControl, controlTempLimitLoLo=controlTempLimitLoLo, receiverAddress=receiverAddress, controlAlarmOnDelay=controlAlarmOnDelay, productKeyFeatureEnable=productKeyFeatureEnable, elementStructure=elementStructure, productKeyFeatureIndex=productKeyFeatureIndex, sizeOfNotebook=sizeOfNotebook, statusHardware=statusHardware, sWUpdateFileName=sWUpdateFileName, controlReset=controlReset, productKeyTable=productKeyTable, moduleDetailTable=moduleDetailTable, controlResetElement=controlResetElement, controlTrapSending=controlTrapSending)
