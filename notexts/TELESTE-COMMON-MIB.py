...
TimeTicks, Counter32, Gauge32, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, Unsigned32, NotificationType, Bits, Counter64, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "Gauge32", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "Unsigned32", "NotificationType", "Bits", "Counter64", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", elementLatitude=elementLatitude, moduleControlTable=moduleControlTable, moduleRegistryTable=moduleRegistryTable, moduleSizeOfTable=moduleSizeOfTable, moduleSizeOfEntry=moduleSizeOfEntry, controlLocalAccess=controlLocalAccess, notebookLineText=notebookLineText, statusLmt=statusLmt, controlAlarmDetection=controlAlarmDetection, moduleAppVersion=moduleAppVersion, repairDate=repairDate, moduleHwVersion=moduleHwVersion, productKeyFeatureTable=productKeyFeatureTable, productKeyFeatureEnable=productKeyFeatureEnable, elementTotalUpTime=elementTotalUpTime, moduleStatusTable=moduleStatusTable, elementInformation=elementInformation, moduleControl=moduleControl, sWUpdateControl=sWUpdateControl, productKeyCipher=productKeyCipher, moduleRegistry=moduleRegistry, moduleHwType=moduleHwType, moduleAppDate=moduleAppDate, moduleStatusEntry=moduleStatusEntry, moduleSlotNo=moduleSlotNo, moduleBiosVersion=moduleBiosVersion, statusSettings=statusSettings, sizeOfNotebook=sizeOfNotebook, controlTrapDelay=controlTrapDelay, controlTrapReceiverTable=controlTrapReceiverTable, moduleDetailTable=moduleDetailTable, productKeyIndex=productKeyIndex, elementName=elementName, repairComment=repairComment, sizeOfRegistry=sizeOfRegistry, statusFan=statusFan, moduleInformation=moduleInformation, statusRunningSwImage=statusRunningSwImage, regValue=regValue, elementResetCount=elementResetCount, controlResetElement=controlResetElement, controlMarkState=controlMarkState, moduleName=moduleName, receiverEntryId=receiverEntryId, controlAlarmOffDelay=controlAlarmOffDelay, controlLedUsage=controlLedUsage, receiverCommunity=receiverCommunity, statusLidStatus=statusLidStatus, sizeOfRepairlog=sizeOfRepairlog, controlTrapLifeTime=controlTrapLifeTime, controlTempLimitHiHi=controlTempLimitHiHi, productKeyFeatureName=productKeyFeatureName, productKeyMask=productKeyMask, statusSoftware=statusSoftware, sWUpdateFileName=sWUpdateFileName, regIndex=regIndex, moduleEntry=moduleEntry, sWUpdateStatus=sWUpdateStatus, controlTrapInterval=controlTrapInterval, moduleNotebookTable=moduleNotebookTable, elementConfigChangeCode=elementConfigChangeCode, productKeyFeatureEntry=productKeyFeatureEntry, productKeyEntry=productKeyEntry, productKeyValue=productKeyValue, controlTempLimitHi=controlTempLimitHi, repairReasonCode=repairReasonCode, moduleId=moduleId, statusHardware=statusHardware, statusGeneral=statusGeneral, moduleNotebookEntry=moduleNotebookEntry, notebookLineNumber=notebookLineNumber, controlTempLimitLo=controlTempLimitLo, repairNameCode=repairNameCode, statusBusMaster=statusBusMaster, module=module, elementStructure=elementStructure, elementControl=elementControl, elementProductKey=elementProductKey, moduleControlEntry=moduleControlEntry, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleBiosDate=moduleBiosDate, moduleHwSerialNumber=moduleHwSerialNumber, moduleRepairLogTable=moduleRepairLogTable, receiverPort=receiverPort, productKeyStatus=productKeyStatus, moduleDetailEntry=moduleDetailEntry, productKeyTable=productKeyTable, statusInternalTemperature=statusInternalTemperature, moduleSWUpdateTable=moduleSWUpdateTable, elementStatus=elementStatus, controlInternalAppAccess=controlInternalAppAccess, moduleRegistryEntry=moduleRegistryEntry, statusRestartCounter=statusRestartCounter, controlTrapReceiverEntry=controlTrapReceiverEntry, elementAltitude=elementAltitude, elementLongitude=elementLongitude, controlReset=controlReset, receiverAddress=receiverAddress, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleRackNo=moduleRackNo, moduleMacAddress=moduleMacAddress, statusLid=statusLid, productKeyNumberOfFeatures=productKeyNumberOfFeatures, swUpdateURL=swUpdateURL, repairIndex=repairIndex, statusResetCause=statusResetCause, controlTempDeadBand=controlTempDeadBand, controlTempLimitLoLo=controlTempLimitLoLo, moduleTable=moduleTable, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, productKeyFeatureIndex=productKeyFeatureIndex, moduleBusAddress=moduleBusAddress, moduleStatus=moduleStatus, controlAlarmOnDelay=controlAlarmOnDelay, moduleRepairLogEntry=moduleRepairLogEntry, moduleSWUpdateEntry=moduleSWUpdateEntry, regName=regName, controlTrapSending=controlTrapSending, controlBusMasterAdminState=controlBusMasterAdminState, element=element, statusTemperature=statusTemperature)
