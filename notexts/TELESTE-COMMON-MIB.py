...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:45:00 2024
...
NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Counter64, TimeTicks, iso, Gauge32, ObjectIdentity, Integer32, Bits, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Counter64", "TimeTicks", "iso", "Gauge32", "ObjectIdentity", "Integer32", "Bits", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", controlReset=controlReset, moduleName=moduleName, controlMarkState=controlMarkState, moduleHwSerialNumber=moduleHwSerialNumber, moduleEntry=moduleEntry, moduleAppDate=moduleAppDate, controlTempLimitLoLo=controlTempLimitLoLo, moduleSizeOfEntry=moduleSizeOfEntry, moduleRepairLogTable=moduleRepairLogTable, regName=regName, statusRestartCounter=statusRestartCounter, moduleHwVersion=moduleHwVersion, receiverAddress=receiverAddress, moduleHwType=moduleHwType, controlTempLimitLo=controlTempLimitLo, elementProductKey=elementProductKey, statusResetCause=statusResetCause, moduleStatusEntry=moduleStatusEntry, receiverEntryId=receiverEntryId, sizeOfRepairlog=sizeOfRepairlog, repairDate=repairDate, moduleBusAddress=moduleBusAddress, statusLidStatus=statusLidStatus, repairReasonCode=repairReasonCode, controlTempDeadBand=controlTempDeadBand, controlTrapSending=controlTrapSending, productKeyStatus=productKeyStatus, statusRunningSwImage=statusRunningSwImage, controlTrapInterval=controlTrapInterval, controlTempLimitHiHi=controlTempLimitHiHi, controlLocalAccess=controlLocalAccess, repairComment=repairComment, elementControl=elementControl, receiverPort=receiverPort, notebookLineNumber=notebookLineNumber, productKeyFeatureTable=productKeyFeatureTable, moduleNotebookTable=moduleNotebookTable, module=module, moduleRackNo=moduleRackNo, moduleSlotNo=moduleSlotNo, controlTempLimitHi=controlTempLimitHi, elementLongitude=elementLongitude, controlAlarmOnDelay=controlAlarmOnDelay, sWUpdateFileName=sWUpdateFileName, controlResetElement=controlResetElement, elementStructure=elementStructure, moduleRegistryTable=moduleRegistryTable, moduleDetailEntry=moduleDetailEntry, regIndex=regIndex, sWUpdateControl=sWUpdateControl, moduleMacAddress=moduleMacAddress, moduleRepairLogEntry=moduleRepairLogEntry, regValue=regValue, productKeyTable=productKeyTable, statusInternalTemperature=statusInternalTemperature, elementStatus=elementStatus, statusSoftware=statusSoftware, statusBusMaster=statusBusMaster, controlLedUsage=controlLedUsage, controlTrapDelay=controlTrapDelay, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, statusLid=statusLid, sizeOfRegistry=sizeOfRegistry, controlAlarmOffDelay=controlAlarmOffDelay, moduleStatus=moduleStatus, elementLatitude=elementLatitude, notebookLineText=notebookLineText, productKeyFeatureIndex=productKeyFeatureIndex, moduleControlTable=moduleControlTable, moduleControl=moduleControl, moduleSWUpdateTable=moduleSWUpdateTable, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleId=moduleId, moduleBiosVersion=moduleBiosVersion, moduleBiosDate=moduleBiosDate, moduleNotebookEntry=moduleNotebookEntry, elementInformation=elementInformation, moduleAppVersion=moduleAppVersion, elementResetCount=elementResetCount, elementName=elementName, repairIndex=repairIndex, statusSettings=statusSettings, moduleTable=moduleTable, controlAlarmDetection=controlAlarmDetection, statusHardware=statusHardware, moduleControlEntry=moduleControlEntry, swUpdateURL=swUpdateURL, sWUpdateStatus=sWUpdateStatus, moduleInformation=moduleInformation, productKeyNumberOfFeatures=productKeyNumberOfFeatures, productKeyMask=productKeyMask, productKeyCipher=productKeyCipher, controlInternalAppAccess=controlInternalAppAccess, productKeyNumberOfKeys=productKeyNumberOfKeys, element=element, statusTemperature=statusTemperature, elementTotalUpTime=elementTotalUpTime, receiverCommunity=receiverCommunity, repairNameCode=repairNameCode, moduleSizeOfTable=moduleSizeOfTable, productKeyEntry=productKeyEntry, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, elementAltitude=elementAltitude, controlTrapLifeTime=controlTrapLifeTime, productKeyFeatureEnable=productKeyFeatureEnable, moduleRegistry=moduleRegistry, controlBusMasterAdminState=controlBusMasterAdminState, statusGeneral=statusGeneral, statusLmt=statusLmt, productKeyFeatureEntry=productKeyFeatureEntry, moduleSWUpdateEntry=moduleSWUpdateEntry, elementConfigChangeCode=elementConfigChangeCode, statusFan=statusFan, moduleDetailTable=moduleDetailTable, productKeyValue=productKeyValue, controlTrapReceiverTable=controlTrapReceiverTable, sizeOfNotebook=sizeOfNotebook, productKeyFeatureName=productKeyFeatureName, productKeyIndex=productKeyIndex, moduleRegistryEntry=moduleRegistryEntry, moduleStatusTable=moduleStatusTable)
