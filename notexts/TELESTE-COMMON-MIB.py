...
iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress, MibIdentifier, Counter64, Unsigned32, Gauge32, Bits, Counter32, NotificationType, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress", "MibIdentifier", "Counter64", "Unsigned32", "Gauge32", "Bits", "Counter32", "NotificationType", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", statusLidStatus=statusLidStatus, receiverCommunity=receiverCommunity, repairDate=repairDate, moduleStatusEntry=moduleStatusEntry, regValue=regValue, moduleId=moduleId, notebookLineText=notebookLineText, productKeyIndex=productKeyIndex, sizeOfRepairlog=sizeOfRepairlog, productKeyFeatureEntry=productKeyFeatureEntry, moduleSlotNo=moduleSlotNo, moduleHwVersion=moduleHwVersion, statusTemperature=statusTemperature, moduleControl=moduleControl, statusLid=statusLid, repairReasonCode=repairReasonCode, moduleNotebookTable=moduleNotebookTable, moduleStatusTable=moduleStatusTable, moduleControlEntry=moduleControlEntry, sizeOfRegistry=sizeOfRegistry, notebookLineNumber=notebookLineNumber, element=element, elementStatus=elementStatus, controlTrapSending=controlTrapSending, moduleAppVersion=moduleAppVersion, swUpdateURL=swUpdateURL, controlTempLimitLo=controlTempLimitLo, moduleMacAddress=moduleMacAddress, elementLongitude=elementLongitude, receiverEntryId=receiverEntryId, statusLmt=statusLmt, statusSettings=statusSettings, controlInternalAppAccess=controlInternalAppAccess, controlTrapDelay=controlTrapDelay, elementTotalUpTime=elementTotalUpTime, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, controlTrapLifeTime=controlTrapLifeTime, sWUpdateStatus=sWUpdateStatus, controlAlarmOnDelay=controlAlarmOnDelay, moduleInformation=moduleInformation, controlLedUsage=controlLedUsage, productKeyFeatureIndex=productKeyFeatureIndex, sizeOfNotebook=sizeOfNotebook, statusBusMaster=statusBusMaster, moduleRegistryEntry=moduleRegistryEntry, repairIndex=repairIndex, moduleHwSerialNumber=moduleHwSerialNumber, elementResetCount=elementResetCount, moduleRackNo=moduleRackNo, controlLocalAccess=controlLocalAccess, elementName=elementName, receiverPort=receiverPort, moduleRepairLogEntry=moduleRepairLogEntry, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlTrapReceiverTable=controlTrapReceiverTable, productKeyFeatureTable=productKeyFeatureTable, elementConfigChangeCode=elementConfigChangeCode, moduleControlTable=moduleControlTable, moduleEntry=moduleEntry, elementStructure=elementStructure, moduleStatus=moduleStatus, controlMarkState=controlMarkState, productKeyFeatureEnable=productKeyFeatureEnable, controlAlarmDetection=controlAlarmDetection, controlTempLimitLoLo=controlTempLimitLoLo, elementProductKey=elementProductKey, moduleRegistryTable=moduleRegistryTable, moduleBusAddress=moduleBusAddress, controlResetElement=controlResetElement, elementInformation=elementInformation, controlTrapReceiverEntry=controlTrapReceiverEntry, productKeyCipher=productKeyCipher, elementAltitude=elementAltitude, module=module, moduleAppDate=moduleAppDate, controlAlarmOffDelay=controlAlarmOffDelay, productKeyMask=productKeyMask, elementLatitude=elementLatitude, repairComment=repairComment, moduleName=moduleName, controlTempDeadBand=controlTempDeadBand, productKeyEntry=productKeyEntry, moduleSWUpdateEntry=moduleSWUpdateEntry, statusResetCause=statusResetCause, moduleHwType=moduleHwType, productKeyStatus=productKeyStatus, moduleNotebookEntry=moduleNotebookEntry, repairNameCode=repairNameCode, moduleSizeOfTable=moduleSizeOfTable, regName=regName, moduleDetailEntry=moduleDetailEntry, elementControl=elementControl, productKeyNumberOfKeys=productKeyNumberOfKeys, regIndex=regIndex, controlReset=controlReset, moduleTable=moduleTable, controlTempLimitHiHi=controlTempLimitHiHi, controlTrapInterval=controlTrapInterval, statusSoftware=statusSoftware, statusHardware=statusHardware, moduleSWUpdateTable=moduleSWUpdateTable, statusInternalTemperature=statusInternalTemperature, productKeyTable=productKeyTable, statusRunningSwImage=statusRunningSwImage, productKeyValue=productKeyValue, statusFan=statusFan, moduleDetailTable=moduleDetailTable, controlBusMasterAdminState=controlBusMasterAdminState, moduleRegistry=moduleRegistry, receiverAddress=receiverAddress, statusRestartCounter=statusRestartCounter, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleRepairLogTable=moduleRepairLogTable, sWUpdateControl=sWUpdateControl, sWUpdateFileName=sWUpdateFileName, moduleSizeOfEntry=moduleSizeOfEntry, statusGeneral=statusGeneral, productKeyFeatureName=productKeyFeatureName, moduleBiosDate=moduleBiosDate, moduleBiosVersion=moduleBiosVersion, controlTempLimitHi=controlTempLimitHi)
