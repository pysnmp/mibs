...
NotificationType, Integer32, Counter64, iso, MibIdentifier, ObjectIdentity, Counter32, IpAddress, Bits, ModuleIdentity, Gauge32, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "Counter64", "iso", "MibIdentifier", "ObjectIdentity", "Counter32", "IpAddress", "Bits", "ModuleIdentity", "Gauge32", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", moduleHwSerialNumber=moduleHwSerialNumber, controlTempLimitLo=controlTempLimitLo, controlTrapDelay=controlTrapDelay, controlLocalAccess=controlLocalAccess, elementLatitude=elementLatitude, elementControl=elementControl, moduleRegistry=moduleRegistry, moduleSWUpdateTable=moduleSWUpdateTable, controlAlarmOffDelay=controlAlarmOffDelay, productKeyFeatureEnable=productKeyFeatureEnable, moduleName=moduleName, elementStatus=elementStatus, moduleHwType=moduleHwType, controlTrapLifeTime=controlTrapLifeTime, moduleRepairLogEntry=moduleRepairLogEntry, moduleSizeOfTable=moduleSizeOfTable, productKeyFeatureIndex=productKeyFeatureIndex, moduleStatusEntry=moduleStatusEntry, controlInternalAppAccess=controlInternalAppAccess, productKeyCipher=productKeyCipher, moduleStatusTable=moduleStatusTable, statusBusMaster=statusBusMaster, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleSWUpdateEntry=moduleSWUpdateEntry, elementTotalUpTime=elementTotalUpTime, statusResetCause=statusResetCause, moduleSizeOfEntry=moduleSizeOfEntry, repairDate=repairDate, moduleSlotNo=moduleSlotNo, regName=regName, moduleTable=moduleTable, moduleBiosDate=moduleBiosDate, moduleId=moduleId, moduleDetailTable=moduleDetailTable, statusFan=statusFan, receiverEntryId=receiverEntryId, moduleHwVersion=moduleHwVersion, controlAlarmOnDelay=controlAlarmOnDelay, swUpdateURL=swUpdateURL, notebookLineNumber=notebookLineNumber, statusRunningSwImage=statusRunningSwImage, repairReasonCode=repairReasonCode, productKeyIndex=productKeyIndex, sizeOfNotebook=sizeOfNotebook, moduleNotebookTable=moduleNotebookTable, productKeyMask=productKeyMask, statusHardware=statusHardware, moduleRackNo=moduleRackNo, controlTrapSending=controlTrapSending, statusSettings=statusSettings, elementName=elementName, elementInformation=elementInformation, module=module, regValue=regValue, moduleBusAddress=moduleBusAddress, controlResetElement=controlResetElement, moduleBiosVersion=moduleBiosVersion, statusTemperature=statusTemperature, moduleRegistryEntry=moduleRegistryEntry, elementStructure=elementStructure, moduleRegistryTable=moduleRegistryTable, moduleControlEntry=moduleControlEntry, sizeOfRegistry=sizeOfRegistry, moduleControl=moduleControl, receiverCommunity=receiverCommunity, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleRepairLogTable=moduleRepairLogTable, receiverPort=receiverPort, productKeyEntry=productKeyEntry, elementResetCount=elementResetCount, notebookLineText=notebookLineText, statusLmt=statusLmt, sWUpdateFileName=sWUpdateFileName, controlBusMasterAdminState=controlBusMasterAdminState, productKeyFeatureTable=productKeyFeatureTable, sizeOfRepairlog=sizeOfRepairlog, statusInternalTemperature=statusInternalTemperature, productKeyFeatureEntry=productKeyFeatureEntry, controlTrapReceiverTable=controlTrapReceiverTable, moduleDetailEntry=moduleDetailEntry, repairIndex=repairIndex, controlTempLimitLoLo=controlTempLimitLoLo, moduleAppVersion=moduleAppVersion, controlTempDeadBand=controlTempDeadBand, productKeyStatus=productKeyStatus, regIndex=regIndex, productKeyTable=productKeyTable, repairComment=repairComment, statusSoftware=statusSoftware, moduleMacAddress=moduleMacAddress, statusLidStatus=statusLidStatus, sWUpdateControl=sWUpdateControl, elementConfigChangeCode=elementConfigChangeCode, controlTrapInterval=controlTrapInterval, repairNameCode=repairNameCode, moduleStatus=moduleStatus, moduleAppDate=moduleAppDate, controlTrapReceiverEntry=controlTrapReceiverEntry, productKeyValue=productKeyValue, controlMarkState=controlMarkState, sWUpdateStatus=sWUpdateStatus, statusGeneral=statusGeneral, controlReset=controlReset, element=element, moduleControlTable=moduleControlTable, elementAltitude=elementAltitude, controlTempLimitHi=controlTempLimitHi, productKeyNumberOfFeatures=productKeyNumberOfFeatures, controlAlarmDetection=controlAlarmDetection, statusLid=statusLid, moduleInformation=moduleInformation, receiverAddress=receiverAddress, statusRestartCounter=statusRestartCounter, elementProductKey=elementProductKey, controlLedUsage=controlLedUsage, controlTempLimitHiHi=controlTempLimitHiHi, moduleNotebookEntry=moduleNotebookEntry, moduleEntry=moduleEntry, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, elementLongitude=elementLongitude, productKeyFeatureName=productKeyFeatureName)
