...
TimeTicks, IpAddress, ObjectIdentity, MibIdentifier, Bits, ModuleIdentity, Gauge32, iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "ObjectIdentity", "MibIdentifier", "Bits", "ModuleIdentity", "Gauge32", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", repairReasonCode=repairReasonCode, moduleHwVersion=moduleHwVersion, elementProductKey=elementProductKey, regIndex=regIndex, moduleTable=moduleTable, moduleControlEntry=moduleControlEntry, receiverCommunity=receiverCommunity, repairIndex=repairIndex, controlAlarmDetection=controlAlarmDetection, moduleSlotNo=moduleSlotNo, receiverPort=receiverPort, productKeyEntry=productKeyEntry, moduleSizeOfEntry=moduleSizeOfEntry, productKeyFeatureName=productKeyFeatureName, sizeOfRegistry=sizeOfRegistry, element=element, moduleDetailEntry=moduleDetailEntry, statusBusMaster=statusBusMaster, moduleSWUpdateEntry=moduleSWUpdateEntry, controlLedUsage=controlLedUsage, controlBusMasterAdminState=controlBusMasterAdminState, productKeyFeatureTable=productKeyFeatureTable, controlAlarmOffDelay=controlAlarmOffDelay, receiverEntryId=receiverEntryId, elementLatitude=elementLatitude, productKeyMask=productKeyMask, productKeyIndex=productKeyIndex, controlTempLimitLo=controlTempLimitLo, controlReset=controlReset, regName=regName, elementStatus=elementStatus, statusRunningSwImage=statusRunningSwImage, moduleHwSerialNumber=moduleHwSerialNumber, productKeyFeatureEnable=productKeyFeatureEnable, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, controlTrapReceiverTable=controlTrapReceiverTable, moduleRegistryTable=moduleRegistryTable, sWUpdateFileName=sWUpdateFileName, sizeOfNotebook=sizeOfNotebook, productKeyCipher=productKeyCipher, moduleAppVersion=moduleAppVersion, productKeyTable=productKeyTable, moduleBiosVersion=moduleBiosVersion, controlTempLimitHi=controlTempLimitHi, elementStructure=elementStructure, moduleRackNo=moduleRackNo, repairDate=repairDate, statusGeneral=statusGeneral, productKeyStatus=productKeyStatus, controlTrapInterval=controlTrapInterval, swUpdateURL=swUpdateURL, sizeOfRepairlog=sizeOfRepairlog, statusHardware=statusHardware, elementResetCount=elementResetCount, moduleEntry=moduleEntry, statusSettings=statusSettings, moduleControlTable=moduleControlTable, notebookLineText=notebookLineText, notebookLineNumber=notebookLineNumber, statusResetCause=statusResetCause, repairNameCode=repairNameCode, moduleRegistry=moduleRegistry, controlTempLimitLoLo=controlTempLimitLoLo, moduleInformation=moduleInformation, moduleStatusTable=moduleStatusTable, controlAlarmOnDelay=controlAlarmOnDelay, moduleMacAddress=moduleMacAddress, elementControl=elementControl, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlTrapSending=controlTrapSending, statusSoftware=statusSoftware, elementTotalUpTime=elementTotalUpTime, module=module, sWUpdateControl=sWUpdateControl, moduleSWUpdateTable=moduleSWUpdateTable, controlTempDeadBand=controlTempDeadBand, moduleId=moduleId, statusTemperature=statusTemperature, statusInternalTemperature=statusInternalTemperature, productKeyFeatureEntry=productKeyFeatureEntry, statusLmt=statusLmt, productKeyNumberOfFeatures=productKeyNumberOfFeatures, productKeyValue=productKeyValue, repairComment=repairComment, moduleStatusEntry=moduleStatusEntry, elementInformation=elementInformation, controlMarkState=controlMarkState, elementConfigChangeCode=elementConfigChangeCode, moduleRepairLogEntry=moduleRepairLogEntry, controlTempLimitHiHi=controlTempLimitHiHi, moduleRepairLogTable=moduleRepairLogTable, statusLidStatus=statusLidStatus, elementName=elementName, controlTrapDelay=controlTrapDelay, statusFan=statusFan, elementLongitude=elementLongitude, moduleNotebookEntry=moduleNotebookEntry, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleRegistryEntry=moduleRegistryEntry, elementAltitude=elementAltitude, productKeyFeatureIndex=productKeyFeatureIndex, moduleDetailTable=moduleDetailTable, moduleNotebookTable=moduleNotebookTable, moduleHwType=moduleHwType, moduleAppDate=moduleAppDate, controlResetElement=controlResetElement, controlLocalAccess=controlLocalAccess, statusRestartCounter=statusRestartCounter, moduleSizeOfTable=moduleSizeOfTable, statusLid=statusLid, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleName=moduleName, controlTrapLifeTime=controlTrapLifeTime, moduleControl=moduleControl, moduleStatus=moduleStatus, receiverAddress=receiverAddress, sWUpdateStatus=sWUpdateStatus, controlInternalAppAccess=controlInternalAppAccess, regValue=regValue, moduleBiosDate=moduleBiosDate, moduleBusAddress=moduleBusAddress)
