...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:28:11 2022
...
MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, Counter64, Counter32, Unsigned32, TimeTicks, Bits, ModuleIdentity, Gauge32, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "Counter64", "Counter32", "Unsigned32", "TimeTicks", "Bits", "ModuleIdentity", "Gauge32", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", sWUpdateFileName=sWUpdateFileName, moduleBiosDate=moduleBiosDate, productKeyFeatureTable=productKeyFeatureTable, controlTempLimitHiHi=controlTempLimitHiHi, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleMacAddress=moduleMacAddress, statusLmt=statusLmt, module=module, productKeyTable=productKeyTable, statusHardware=statusHardware, elementResetCount=elementResetCount, moduleControlTable=moduleControlTable, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlMarkState=controlMarkState, moduleDetailEntry=moduleDetailEntry, controlTrapDelay=controlTrapDelay, elementProductKey=elementProductKey, receiverCommunity=receiverCommunity, repairIndex=repairIndex, moduleAppDate=moduleAppDate, moduleNotebookEntry=moduleNotebookEntry, controlBusMasterAdminState=controlBusMasterAdminState, statusSoftware=statusSoftware, moduleControl=moduleControl, statusGeneral=statusGeneral, moduleHwVersion=moduleHwVersion, repairDate=repairDate, statusInternalTemperature=statusInternalTemperature, statusFan=statusFan, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleName=moduleName, moduleRepairLogTable=moduleRepairLogTable, controlTempDeadBand=controlTempDeadBand, repairReasonCode=repairReasonCode, receiverPort=receiverPort, element=element, statusSettings=statusSettings, notebookLineText=notebookLineText, productKeyCipher=productKeyCipher, moduleSizeOfTable=moduleSizeOfTable, regIndex=regIndex, regValue=regValue, controlAlarmDetection=controlAlarmDetection, repairNameCode=repairNameCode, moduleRackNo=moduleRackNo, moduleStatus=moduleStatus, elementName=elementName, controlAlarmOnDelay=controlAlarmOnDelay, productKeyFeatureIndex=productKeyFeatureIndex, sWUpdateStatus=sWUpdateStatus, moduleBusAddress=moduleBusAddress, controlLocalAccess=controlLocalAccess, productKeyIndex=productKeyIndex, statusLidStatus=statusLidStatus, statusBusMaster=statusBusMaster, moduleRegistryEntry=moduleRegistryEntry, moduleHwSerialNumber=moduleHwSerialNumber, moduleStatusTable=moduleStatusTable, elementConfigChangeCode=elementConfigChangeCode, elementTotalUpTime=elementTotalUpTime, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleSWUpdateTable=moduleSWUpdateTable, controlReset=controlReset, productKeyStatus=productKeyStatus, moduleStatusEntry=moduleStatusEntry, controlTempLimitLoLo=controlTempLimitLoLo, statusTemperature=statusTemperature, moduleRegistry=moduleRegistry, swUpdateURL=swUpdateURL, controlTempLimitLo=controlTempLimitLo, moduleBiosVersion=moduleBiosVersion, moduleNotebookTable=moduleNotebookTable, controlAlarmOffDelay=controlAlarmOffDelay, moduleSlotNo=moduleSlotNo, productKeyFeatureEnable=productKeyFeatureEnable, moduleAppVersion=moduleAppVersion, moduleTable=moduleTable, elementAltitude=elementAltitude, sizeOfRepairlog=sizeOfRepairlog, repairComment=repairComment, productKeyEntry=productKeyEntry, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleHwType=moduleHwType, moduleDetailTable=moduleDetailTable, statusResetCause=statusResetCause, receiverAddress=receiverAddress, controlResetElement=controlResetElement, statusRestartCounter=statusRestartCounter, moduleSWUpdateEntry=moduleSWUpdateEntry, statusRunningSwImage=statusRunningSwImage, moduleId=moduleId, moduleRepairLogEntry=moduleRepairLogEntry, controlTrapLifeTime=controlTrapLifeTime, moduleEntry=moduleEntry, regName=regName, receiverEntryId=receiverEntryId, elementStructure=elementStructure, productKeyFeatureEntry=productKeyFeatureEntry, sWUpdateControl=sWUpdateControl, elementStatus=elementStatus, controlTempLimitHi=controlTempLimitHi, elementLatitude=elementLatitude, productKeyMask=productKeyMask, controlInternalAppAccess=controlInternalAppAccess, elementInformation=elementInformation, moduleSizeOfEntry=moduleSizeOfEntry, moduleRegistryTable=moduleRegistryTable, elementControl=elementControl, moduleControlEntry=moduleControlEntry, sizeOfRegistry=sizeOfRegistry, statusLid=statusLid, controlTrapReceiverTable=controlTrapReceiverTable, controlTrapInterval=controlTrapInterval, controlTrapSending=controlTrapSending, moduleInformation=moduleInformation, elementLongitude=elementLongitude, productKeyValue=productKeyValue, productKeyFeatureName=productKeyFeatureName, sizeOfNotebook=sizeOfNotebook, notebookLineNumber=notebookLineNumber, controlLedUsage=controlLedUsage)
