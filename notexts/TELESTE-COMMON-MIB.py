...
Bits, Integer32, NotificationType, ModuleIdentity, Counter32, TimeTicks, Gauge32, MibIdentifier, Counter64, iso, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "NotificationType", "ModuleIdentity", "Counter32", "TimeTicks", "Gauge32", "MibIdentifier", "Counter64", "iso", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", statusSoftware=statusSoftware, repairNameCode=repairNameCode, controlLedUsage=controlLedUsage, elementProductKey=elementProductKey, productKeyNumberOfKeys=productKeyNumberOfKeys, elementAltitude=elementAltitude, element=element, sizeOfNotebook=sizeOfNotebook, regValue=regValue, moduleTable=moduleTable, controlTempLimitHiHi=controlTempLimitHiHi, controlTrapLifeTime=controlTrapLifeTime, productKeyFeatureTable=productKeyFeatureTable, receiverEntryId=receiverEntryId, statusRunningSwImage=statusRunningSwImage, moduleHwVersion=moduleHwVersion, productKeyIndex=productKeyIndex, moduleInformation=moduleInformation, moduleDetailTable=moduleDetailTable, moduleMacAddress=moduleMacAddress, sWUpdateStatus=sWUpdateStatus, productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, moduleRackNo=moduleRackNo, moduleStatus=moduleStatus, statusSettings=statusSettings, moduleDetailEntry=moduleDetailEntry, receiverPort=receiverPort, moduleStatusTable=moduleStatusTable, controlTrapReceiverTable=controlTrapReceiverTable, moduleRepairLogEntry=moduleRepairLogEntry, sWUpdateFileName=sWUpdateFileName, moduleRegistryEntry=moduleRegistryEntry, controlTempLimitLo=controlTempLimitLo, productKeyStatus=productKeyStatus, receiverCommunity=receiverCommunity, statusLmt=statusLmt, moduleBusAddress=moduleBusAddress, elementLongitude=elementLongitude, statusBusMaster=statusBusMaster, controlTempLimitLoLo=controlTempLimitLoLo, repairReasonCode=repairReasonCode, controlTrapInterval=controlTrapInterval, statusLidStatus=statusLidStatus, moduleControl=moduleControl, sWUpdateControl=sWUpdateControl, swUpdateURL=swUpdateURL, controlLocalAccess=controlLocalAccess, productKeyNumberOfFeatures=productKeyNumberOfFeatures, moduleStatusEntry=moduleStatusEntry, productKeyEntry=productKeyEntry, controlTempLimitHi=controlTempLimitHi, productKeyFeatureEntry=productKeyFeatureEntry, moduleSlotNo=moduleSlotNo, moduleAppDate=moduleAppDate, controlTrapSending=controlTrapSending, elementTotalUpTime=elementTotalUpTime, statusResetCause=statusResetCause, repairDate=repairDate, statusLid=statusLid, moduleEntry=moduleEntry, module=module, moduleNotebookTable=moduleNotebookTable, elementControl=elementControl, productKeyFeatureName=productKeyFeatureName, notebookLineNumber=notebookLineNumber, elementStatus=elementStatus, moduleAppVersion=moduleAppVersion, moduleSWUpdateEntry=moduleSWUpdateEntry, productKeyMask=productKeyMask, repairComment=repairComment, statusInternalTemperature=statusInternalTemperature, moduleSizeOfEntry=moduleSizeOfEntry, productKeyCipher=productKeyCipher, controlAlarmOnDelay=controlAlarmOnDelay, productKeyFeatureIndex=productKeyFeatureIndex, controlAlarmOffDelay=controlAlarmOffDelay, moduleRegistryTable=moduleRegistryTable, moduleHwType=moduleHwType, productKeyTable=productKeyTable, statusFan=statusFan, moduleControlTable=moduleControlTable, moduleSWUpdateTable=moduleSWUpdateTable, controlMarkState=controlMarkState, moduleControlEntry=moduleControlEntry, moduleSizeOfTable=moduleSizeOfTable, statusTemperature=statusTemperature, elementInformation=elementInformation, notebookLineText=notebookLineText, controlTrapDelay=controlTrapDelay, sizeOfRepairlog=sizeOfRepairlog, moduleHwSerialNumber=moduleHwSerialNumber, productKeyValue=productKeyValue, regIndex=regIndex, elementResetCount=elementResetCount, controlResetElement=controlResetElement, sizeOfRegistry=sizeOfRegistry, controlInternalAppAccess=controlInternalAppAccess, controlReset=controlReset, elementConfigChangeCode=elementConfigChangeCode, controlBusMasterAdminState=controlBusMasterAdminState, regName=regName, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, moduleRegistry=moduleRegistry, controlTempDeadBand=controlTempDeadBand, controlAlarmDetection=controlAlarmDetection, statusGeneral=statusGeneral, moduleId=moduleId, moduleBiosVersion=moduleBiosVersion, controlTrapReceiverEntry=controlTrapReceiverEntry, elementName=elementName, moduleNotebookEntry=moduleNotebookEntry, statusRestartCounter=statusRestartCounter, moduleRepairLogTable=moduleRepairLogTable, receiverAddress=receiverAddress, repairIndex=repairIndex, productKeyFeatureEnable=productKeyFeatureEnable, elementStructure=elementStructure, moduleBiosDate=moduleBiosDate, statusHardware=statusHardware, moduleName=moduleName, elementLatitude=elementLatitude)
