...
Integer32, NotificationType, Unsigned32, Counter64, TimeTicks, iso, Bits, IpAddress, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Unsigned32", "Counter64", "TimeTicks", "iso", "Bits", "IpAddress", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("TELESTE-COMMON-MIB", productKeyFeatureExpirationTime=productKeyFeatureExpirationTime, controlTrapReceiverEntry=controlTrapReceiverEntry, moduleName=moduleName, elementConfigChangeCode=elementConfigChangeCode, element=element, controlAlarmDetection=controlAlarmDetection, statusRunningSwImage=statusRunningSwImage, statusInternalTemperature=statusInternalTemperature, sizeOfNotebook=sizeOfNotebook, moduleHwVersion=moduleHwVersion, controlResetElement=controlResetElement, elementTotalUpTime=elementTotalUpTime, controlBusMasterAdminState=controlBusMasterAdminState, moduleAppDate=moduleAppDate, productKeyValue=productKeyValue, controlReset=controlReset, elementName=elementName, productKeyCipher=productKeyCipher, sizeOfRepairlog=sizeOfRepairlog, swUpdateURL=swUpdateURL, controlAlarmOnDelay=controlAlarmOnDelay, productKeyFeatureIndex=productKeyFeatureIndex, controlTempLimitHiHi=controlTempLimitHiHi, controlTrapReceiverTable=controlTrapReceiverTable, moduleBiosVersion=moduleBiosVersion, statusBusMaster=statusBusMaster, statusLmt=statusLmt, statusGeneral=statusGeneral, controlTempDeadBand=controlTempDeadBand, moduleDetailEntry=moduleDetailEntry, moduleHwSerialNumber=moduleHwSerialNumber, notebookLineNumber=notebookLineNumber, productKeyEntry=productKeyEntry, regIndex=regIndex, moduleEntry=moduleEntry, moduleStatusTable=moduleStatusTable, moduleControl=moduleControl, moduleControlEntry=moduleControlEntry, moduleControlTable=moduleControlTable, statusRestartCounter=statusRestartCounter, elementProductKey=elementProductKey, repairReasonCode=repairReasonCode, productKeyMask=productKeyMask, moduleAppVersion=moduleAppVersion, productKeyIndex=productKeyIndex, moduleStatus=moduleStatus, moduleRepairLogTable=moduleRepairLogTable, moduleMacAddress=moduleMacAddress, moduleInformation=moduleInformation, moduleRegistryTable=moduleRegistryTable, moduleSizeOfTable=moduleSizeOfTable, controlTempLimitLoLo=controlTempLimitLoLo, productKeyFeatureTable=productKeyFeatureTable, statusResetCause=statusResetCause, sWUpdateControl=sWUpdateControl, receiverEntryId=receiverEntryId, productKeyTable=productKeyTable, elementLatitude=elementLatitude, productKeyNumberOfFeatures=productKeyNumberOfFeatures, statusSoftware=statusSoftware, repairDate=repairDate, controlTrapInterval=controlTrapInterval, controlTrapSending=controlTrapSending, sWUpdateStatus=sWUpdateStatus, controlTrapLifeTime=controlTrapLifeTime, moduleRepairLogEntry=moduleRepairLogEntry, regValue=regValue, receiverAddress=receiverAddress, elementInformation=elementInformation, module=module, elementResetCount=elementResetCount, statusLidStatus=statusLidStatus, receiverPort=receiverPort, sWUpdateFileName=sWUpdateFileName, productKeyNumberOfKeys=productKeyNumberOfKeys, moduleDetailTable=moduleDetailTable, statusTemperature=statusTemperature, controlTempLimitHi=controlTempLimitHi, moduleRackNo=moduleRackNo, moduleRegistry=moduleRegistry, moduleHwType=moduleHwType, moduleSWUpdateTable=moduleSWUpdateTable, controlMaxNumberTrapReceivers=controlMaxNumberTrapReceivers, controlMarkState=controlMarkState, sizeOfRegistry=sizeOfRegistry, moduleBiosDate=moduleBiosDate, receiverCommunity=receiverCommunity, regName=regName, repairIndex=repairIndex, repairComment=repairComment, moduleSlotNo=moduleSlotNo, productKeyFeatureEnable=productKeyFeatureEnable, moduleNotebookEntry=moduleNotebookEntry, controlLedUsage=controlLedUsage, moduleRegistryEntry=moduleRegistryEntry, elementControl=elementControl, elementLongitude=elementLongitude, repairNameCode=repairNameCode, productKeyFeatureEntry=productKeyFeatureEntry, controlTrapDelay=controlTrapDelay, moduleTable=moduleTable, controlInternalAppAccess=controlInternalAppAccess, productKeyStatus=productKeyStatus, moduleId=moduleId, elementStructure=elementStructure, moduleSWUpdateEntry=moduleSWUpdateEntry, statusLid=statusLid, controlLocalAccess=controlLocalAccess, notebookLineText=notebookLineText, moduleSizeOfEntry=moduleSizeOfEntry, statusFan=statusFan, statusSettings=statusSettings, elementAltitude=elementAltitude, elementStatus=elementStatus, moduleStatusEntry=moduleStatusEntry, controlTempLimitLo=controlTempLimitLo, controlAlarmOffDelay=controlAlarmOffDelay, moduleNotebookTable=moduleNotebookTable, productKeyFeatureName=productKeyFeatureName, moduleBusAddress=moduleBusAddress, statusHardware=statusHardware)
