...
mibBuilder.exportSymbols("AT-SETUP-MIB", nextBootConfig=nextBootConfig, restartDevice=restartDevice, backupVersion=backupVersion, bootCnfgSetStatus=bootCnfgSetStatus, nextBootSetStatus=nextBootSetStatus, runningConfig=runningConfig, guiAppletSysSwVer=guiAppletSysSwVer, backupCnfgSetStatus=backupCnfgSetStatus, backupCnfgPath=backupCnfgPath, restartStkMemberDevice=restartStkMemberDevice, defaultConfig=defaultConfig, bootCnfgExists=bootCnfgExists, runCnfgSaveAs=runCnfgSaveAs, srvcSshEnable=srvcSshEnable, nextBootPath=nextBootPath, currSoftSaveStatus=currSoftSaveStatus, runCnfgSaveAsStatus=runCnfgSaveAsStatus, currentFirmware=currentFirmware, setup=setup, currSoftName=currSoftName, currSoftSaveToFile=currSoftSaveToFile, deviceConfiguration=deviceConfiguration, currSoftSaveAs=currSoftSaveAs, runCnfgLastSaveResult=runCnfgLastSaveResult, dfltCnfgPath=dfltCnfgPath, backupCnfgLastSetResult=backupCnfgLastSetResult, bootCnfgPath=bootCnfgPath, backupSetStatus=backupSetStatus, guiConfig=guiConfig, backupConfig=backupConfig, nextBootLastSetResult=nextBootLastSetResult, guiAppletSwVer=guiAppletSwVer, PYSNMP_MODULE_ID=setup, backupFirmware=backupFirmware, backupPath=backupPath, nextBootFirmware=nextBootFirmware, firmware=firmware, backupLastSetResult=backupLastSetResult, srvcTelnetEnable=srvcTelnetEnable, currSoftLastSaveResult=currSoftLastSaveResult, currSoftVersion=currSoftVersion, dfltCnfgExists=dfltCnfgExists, guiAppletConfig=guiAppletConfig, nextBootVersion=nextBootVersion, serviceConfig=serviceConfig, bootCnfgLastSetResult=bootCnfgLastSetResult, backupCnfgExists=backupCnfgExists, SystemFileOperationType=SystemFileOperationType)
