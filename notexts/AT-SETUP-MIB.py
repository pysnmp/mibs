...
mibBuilder.exportSymbols("AT-SETUP-MIB", nextBootVersion=nextBootVersion, nextBootConfig=nextBootConfig, serviceConfig=serviceConfig, backupVersion=backupVersion, PYSNMP_MODULE_ID=setup, currSoftSaveStatus=currSoftSaveStatus, currSoftLastSaveResult=currSoftLastSaveResult, defaultConfig=defaultConfig, backupFirmware=backupFirmware, setup=setup, guiAppletSysSwVer=guiAppletSysSwVer, bootCnfgSetStatus=bootCnfgSetStatus, runCnfgSaveAs=runCnfgSaveAs, srvcSshEnable=srvcSshEnable, backupCnfgLastSetResult=backupCnfgLastSetResult, runCnfgSaveAsStatus=runCnfgSaveAsStatus, backupConfig=backupConfig, srvcTelnetEnable=srvcTelnetEnable, nextBootPath=nextBootPath, deviceConfiguration=deviceConfiguration, backupSetStatus=backupSetStatus, backupCnfgPath=backupCnfgPath, firmware=firmware, nextBootLastSetResult=nextBootLastSetResult, nextBootSetStatus=nextBootSetStatus, dfltCnfgExists=dfltCnfgExists, bootCnfgPath=bootCnfgPath, runCnfgLastSaveResult=runCnfgLastSaveResult, backupPath=backupPath, SystemFileOperationType=SystemFileOperationType, guiConfig=guiConfig, backupCnfgExists=backupCnfgExists, currentFirmware=currentFirmware, nextBootFirmware=nextBootFirmware, bootCnfgLastSetResult=bootCnfgLastSetResult, currSoftSaveToFile=currSoftSaveToFile, currSoftVersion=currSoftVersion, currSoftSaveAs=currSoftSaveAs, guiAppletConfig=guiAppletConfig, guiAppletSwVer=guiAppletSwVer, runningConfig=runningConfig, backupCnfgSetStatus=backupCnfgSetStatus, restartDevice=restartDevice, bootCnfgExists=bootCnfgExists, restartStkMemberDevice=restartStkMemberDevice, currSoftName=currSoftName, dfltCnfgPath=dfltCnfgPath, backupLastSetResult=backupLastSetResult)
