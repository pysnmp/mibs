...
mibBuilder.exportSymbols("AT-SETUP-MIB", PYSNMP_MODULE_ID=setup, backupSetStatus=backupSetStatus, bootCnfgExists=bootCnfgExists, backupConfig=backupConfig, srvcSshEnable=srvcSshEnable, currSoftName=currSoftName, currSoftLastSaveResult=currSoftLastSaveResult, currSoftSaveStatus=currSoftSaveStatus, SystemFileOperationType=SystemFileOperationType, serviceConfig=serviceConfig, backupCnfgSetStatus=backupCnfgSetStatus, guiAppletSysSwVer=guiAppletSysSwVer, backupFirmware=backupFirmware, currSoftSaveAs=currSoftSaveAs, backupVersion=backupVersion, deviceConfiguration=deviceConfiguration, runningConfig=runningConfig, defaultConfig=defaultConfig, runCnfgSaveAs=runCnfgSaveAs, bootCnfgSetStatus=bootCnfgSetStatus, nextBootConfig=nextBootConfig, restartDevice=restartDevice, guiAppletConfig=guiAppletConfig, runCnfgLastSaveResult=runCnfgLastSaveResult, currentFirmware=currentFirmware, currSoftVersion=currSoftVersion, nextBootSetStatus=nextBootSetStatus, nextBootPath=nextBootPath, nextBootLastSetResult=nextBootLastSetResult, firmware=firmware, nextBootFirmware=nextBootFirmware, runCnfgSaveAsStatus=runCnfgSaveAsStatus, bootCnfgLastSetResult=bootCnfgLastSetResult, dfltCnfgPath=dfltCnfgPath, srvcTelnetEnable=srvcTelnetEnable, backupCnfgLastSetResult=backupCnfgLastSetResult, backupPath=backupPath, setup=setup, backupLastSetResult=backupLastSetResult, restartStkMemberDevice=restartStkMemberDevice, backupCnfgExists=backupCnfgExists, dfltCnfgExists=dfltCnfgExists, guiAppletSwVer=guiAppletSwVer, backupCnfgPath=backupCnfgPath, nextBootVersion=nextBootVersion, currSoftSaveToFile=currSoftSaveToFile, guiConfig=guiConfig, bootCnfgPath=bootCnfgPath)
