...
mibBuilder.exportSymbols("AT-SETUP-MIB", currentFirmware=currentFirmware, nextBootPath=nextBootPath, nextBootSetStatus=nextBootSetStatus, runCnfgLastSaveResult=runCnfgLastSaveResult, nextBootFirmware=nextBootFirmware, SystemFileOperationType=SystemFileOperationType, bootCnfgSetStatus=bootCnfgSetStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, srvcTelnetEnable=srvcTelnetEnable, currSoftSaveToFile=currSoftSaveToFile, backupCnfgExists=backupCnfgExists, runCnfgSaveAs=runCnfgSaveAs, restartStkMemberDevice=restartStkMemberDevice, bootCnfgPath=bootCnfgPath, restartDevice=restartDevice, currSoftLastSaveResult=currSoftLastSaveResult, deviceConfiguration=deviceConfiguration, backupCnfgSetStatus=backupCnfgSetStatus, srvcSshEnable=srvcSshEnable, guiAppletConfig=guiAppletConfig, nextBootVersion=nextBootVersion, backupPath=backupPath, backupFirmware=backupFirmware, currSoftSaveAs=currSoftSaveAs, firmware=firmware, backupLastSetResult=backupLastSetResult, backupConfig=backupConfig, guiAppletSwVer=guiAppletSwVer, setup=setup, dfltCnfgPath=dfltCnfgPath, backupCnfgPath=backupCnfgPath, currSoftSaveStatus=currSoftSaveStatus, nextBootLastSetResult=nextBootLastSetResult, dfltCnfgExists=dfltCnfgExists, serviceConfig=serviceConfig, bootCnfgLastSetResult=bootCnfgLastSetResult, runningConfig=runningConfig, guiConfig=guiConfig, guiAppletSysSwVer=guiAppletSysSwVer, defaultConfig=defaultConfig, nextBootConfig=nextBootConfig, bootCnfgExists=bootCnfgExists, backupSetStatus=backupSetStatus, currSoftName=currSoftName, backupVersion=backupVersion, runCnfgSaveAsStatus=runCnfgSaveAsStatus, PYSNMP_MODULE_ID=setup, currSoftVersion=currSoftVersion)
