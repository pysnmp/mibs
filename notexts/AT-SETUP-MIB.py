...
mibBuilder.exportSymbols("AT-SETUP-MIB", currSoftSaveStatus=currSoftSaveStatus, nextBootLastSetResult=nextBootLastSetResult, guiAppletSwVer=guiAppletSwVer, backupCnfgSetStatus=backupCnfgSetStatus, backupSetStatus=backupSetStatus, backupCnfgExists=backupCnfgExists, srvcTelnetEnable=srvcTelnetEnable, currSoftSaveToFile=currSoftSaveToFile, currSoftVersion=currSoftVersion, runCnfgLastSaveResult=runCnfgLastSaveResult, backupCnfgPath=backupCnfgPath, bootCnfgExists=bootCnfgExists, restartStkMemberDevice=restartStkMemberDevice, firmware=firmware, runCnfgSaveAs=runCnfgSaveAs, guiAppletConfig=guiAppletConfig, backupFirmware=backupFirmware, currSoftLastSaveResult=currSoftLastSaveResult, nextBootSetStatus=nextBootSetStatus, guiConfig=guiConfig, dfltCnfgExists=dfltCnfgExists, defaultConfig=defaultConfig, backupLastSetResult=backupLastSetResult, guiAppletSysSwVer=guiAppletSysSwVer, currentFirmware=currentFirmware, nextBootPath=nextBootPath, backupCnfgLastSetResult=backupCnfgLastSetResult, runCnfgSaveAsStatus=runCnfgSaveAsStatus, srvcSshEnable=srvcSshEnable, backupConfig=backupConfig, nextBootFirmware=nextBootFirmware, bootCnfgPath=bootCnfgPath, serviceConfig=serviceConfig, currSoftName=currSoftName, deviceConfiguration=deviceConfiguration, nextBootVersion=nextBootVersion, backupVersion=backupVersion, currSoftSaveAs=currSoftSaveAs, dfltCnfgPath=dfltCnfgPath, bootCnfgLastSetResult=bootCnfgLastSetResult, backupPath=backupPath, runningConfig=runningConfig, PYSNMP_MODULE_ID=setup, SystemFileOperationType=SystemFileOperationType, setup=setup, restartDevice=restartDevice, bootCnfgSetStatus=bootCnfgSetStatus, nextBootConfig=nextBootConfig)
