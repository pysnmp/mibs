...
mibBuilder.exportSymbols("AT-SETUP-MIB", guiConfig=guiConfig, deviceConfiguration=deviceConfiguration, PYSNMP_MODULE_ID=setup, bootCnfgPath=bootCnfgPath, currentFirmware=currentFirmware, bootCnfgLastSetResult=bootCnfgLastSetResult, backupCnfgPath=backupCnfgPath, nextBootLastSetResult=nextBootLastSetResult, backupFirmware=backupFirmware, nextBootPath=nextBootPath, guiAppletSwVer=guiAppletSwVer, restartStkMemberDevice=restartStkMemberDevice, runCnfgLastSaveResult=runCnfgLastSaveResult, backupCnfgLastSetResult=backupCnfgLastSetResult, bootCnfgExists=bootCnfgExists, backupPath=backupPath, backupCnfgExists=backupCnfgExists, currSoftSaveStatus=currSoftSaveStatus, backupConfig=backupConfig, nextBootFirmware=nextBootFirmware, dfltCnfgExists=dfltCnfgExists, backupLastSetResult=backupLastSetResult, nextBootConfig=nextBootConfig, srvcTelnetEnable=srvcTelnetEnable, guiAppletConfig=guiAppletConfig, srvcSshEnable=srvcSshEnable, setup=setup, currSoftName=currSoftName, firmware=firmware, backupCnfgSetStatus=backupCnfgSetStatus, backupSetStatus=backupSetStatus, backupVersion=backupVersion, restartDevice=restartDevice, serviceConfig=serviceConfig, SystemFileOperationType=SystemFileOperationType, runningConfig=runningConfig, currSoftSaveAs=currSoftSaveAs, currSoftSaveToFile=currSoftSaveToFile, currSoftLastSaveResult=currSoftLastSaveResult, defaultConfig=defaultConfig, dfltCnfgPath=dfltCnfgPath, runCnfgSaveAsStatus=runCnfgSaveAsStatus, bootCnfgSetStatus=bootCnfgSetStatus, currSoftVersion=currSoftVersion, nextBootVersion=nextBootVersion, guiAppletSysSwVer=guiAppletSysSwVer, nextBootSetStatus=nextBootSetStatus, runCnfgSaveAs=runCnfgSaveAs)
