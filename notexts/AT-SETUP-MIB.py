...
mibBuilder.exportSymbols("AT-SETUP-MIB", setup=setup, bootCnfgExists=bootCnfgExists, runningConfig=runningConfig, srvcSshEnable=srvcSshEnable, nextBootPath=nextBootPath, backupCnfgPath=backupCnfgPath, currSoftName=currSoftName, backupSetStatus=backupSetStatus, PYSNMP_MODULE_ID=setup, nextBootSetStatus=nextBootSetStatus, bootCnfgPath=bootCnfgPath, backupCnfgSetStatus=backupCnfgSetStatus, guiAppletSwVer=guiAppletSwVer, currSoftLastSaveResult=currSoftLastSaveResult, firmware=firmware, currSoftSaveAs=currSoftSaveAs, nextBootConfig=nextBootConfig, deviceConfiguration=deviceConfiguration, currSoftSaveStatus=currSoftSaveStatus, srvcTelnetEnable=srvcTelnetEnable, nextBootVersion=nextBootVersion, restartStkMemberDevice=restartStkMemberDevice, SystemFileOperationType=SystemFileOperationType, backupFirmware=backupFirmware, dfltCnfgPath=dfltCnfgPath, dfltCnfgExists=dfltCnfgExists, runCnfgSaveAs=runCnfgSaveAs, backupLastSetResult=backupLastSetResult, defaultConfig=defaultConfig, nextBootFirmware=nextBootFirmware, backupConfig=backupConfig, backupCnfgLastSetResult=backupCnfgLastSetResult, bootCnfgLastSetResult=bootCnfgLastSetResult, guiConfig=guiConfig, bootCnfgSetStatus=bootCnfgSetStatus, currentFirmware=currentFirmware, guiAppletSysSwVer=guiAppletSysSwVer, nextBootLastSetResult=nextBootLastSetResult, guiAppletConfig=guiAppletConfig, currSoftSaveToFile=currSoftSaveToFile, runCnfgSaveAsStatus=runCnfgSaveAsStatus, currSoftVersion=currSoftVersion, backupVersion=backupVersion, runCnfgLastSaveResult=runCnfgLastSaveResult, backupPath=backupPath, restartDevice=restartDevice, serviceConfig=serviceConfig, backupCnfgExists=backupCnfgExists)
