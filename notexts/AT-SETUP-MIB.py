...
mibBuilder.exportSymbols("AT-SETUP-MIB", bootCnfgSetStatus=bootCnfgSetStatus, dfltCnfgPath=dfltCnfgPath, currentFirmware=currentFirmware, currSoftVersion=currSoftVersion, backupSetStatus=backupSetStatus, backupVersion=backupVersion, nextBootVersion=nextBootVersion, currSoftLastSaveResult=currSoftLastSaveResult, nextBootFirmware=nextBootFirmware, bootCnfgLastSetResult=bootCnfgLastSetResult, backupCnfgExists=backupCnfgExists, backupFirmware=backupFirmware, backupCnfgSetStatus=backupCnfgSetStatus, backupLastSetResult=backupLastSetResult, serviceConfig=serviceConfig, runCnfgSaveAs=runCnfgSaveAs, backupConfig=backupConfig, restartDevice=restartDevice, currSoftSaveAs=currSoftSaveAs, currSoftSaveStatus=currSoftSaveStatus, SystemFileOperationType=SystemFileOperationType, guiAppletSwVer=guiAppletSwVer, backupCnfgPath=backupCnfgPath, nextBootConfig=nextBootConfig, currSoftName=currSoftName, runCnfgLastSaveResult=runCnfgLastSaveResult, guiAppletConfig=guiAppletConfig, setup=setup, backupPath=backupPath, bootCnfgExists=bootCnfgExists, guiConfig=guiConfig, deviceConfiguration=deviceConfiguration, PYSNMP_MODULE_ID=setup, nextBootSetStatus=nextBootSetStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, guiAppletSysSwVer=guiAppletSysSwVer, srvcSshEnable=srvcSshEnable, nextBootLastSetResult=nextBootLastSetResult, currSoftSaveToFile=currSoftSaveToFile, defaultConfig=defaultConfig, runCnfgSaveAsStatus=runCnfgSaveAsStatus, dfltCnfgExists=dfltCnfgExists, srvcTelnetEnable=srvcTelnetEnable, runningConfig=runningConfig, bootCnfgPath=bootCnfgPath, nextBootPath=nextBootPath, firmware=firmware, restartStkMemberDevice=restartStkMemberDevice)
