...
mibBuilder.exportSymbols("AT-SETUP-MIB", backupCnfgSetStatus=backupCnfgSetStatus, restartDevice=restartDevice, nextBootConfig=nextBootConfig, currentFirmware=currentFirmware, guiAppletConfig=guiAppletConfig, guiAppletSwVer=guiAppletSwVer, bootCnfgPath=bootCnfgPath, setup=setup, nextBootFirmware=nextBootFirmware, bootCnfgLastSetResult=bootCnfgLastSetResult, serviceConfig=serviceConfig, runningConfig=runningConfig, runCnfgLastSaveResult=runCnfgLastSaveResult, backupFirmware=backupFirmware, guiAppletSysSwVer=guiAppletSysSwVer, deviceConfiguration=deviceConfiguration, currSoftSaveStatus=currSoftSaveStatus, bootCnfgSetStatus=bootCnfgSetStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, dfltCnfgExists=dfltCnfgExists, bootCnfgExists=bootCnfgExists, currSoftSaveToFile=currSoftSaveToFile, backupSetStatus=backupSetStatus, backupConfig=backupConfig, currSoftName=currSoftName, restartStkMemberDevice=restartStkMemberDevice, runCnfgSaveAs=runCnfgSaveAs, defaultConfig=defaultConfig, guiConfig=guiConfig, currSoftSaveAs=currSoftSaveAs, PYSNMP_MODULE_ID=setup, dfltCnfgPath=dfltCnfgPath, backupLastSetResult=backupLastSetResult, srvcSshEnable=srvcSshEnable, nextBootLastSetResult=nextBootLastSetResult, nextBootSetStatus=nextBootSetStatus, backupPath=backupPath, backupCnfgPath=backupCnfgPath, nextBootVersion=nextBootVersion, currSoftLastSaveResult=currSoftLastSaveResult, backupCnfgExists=backupCnfgExists, backupVersion=backupVersion, firmware=firmware, SystemFileOperationType=SystemFileOperationType, runCnfgSaveAsStatus=runCnfgSaveAsStatus, currSoftVersion=currSoftVersion, nextBootPath=nextBootPath, srvcTelnetEnable=srvcTelnetEnable)
