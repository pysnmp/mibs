...
mibBuilder.exportSymbols("AT-SETUP-MIB", backupConfig=backupConfig, currSoftSaveAs=currSoftSaveAs, currSoftName=currSoftName, bootCnfgPath=bootCnfgPath, currSoftSaveToFile=currSoftSaveToFile, backupLastSetResult=backupLastSetResult, runningConfig=runningConfig, srvcTelnetEnable=srvcTelnetEnable, currSoftSaveStatus=currSoftSaveStatus, runCnfgSaveAs=runCnfgSaveAs, PYSNMP_MODULE_ID=setup, serviceConfig=serviceConfig, guiConfig=guiConfig, nextBootLastSetResult=nextBootLastSetResult, backupCnfgExists=backupCnfgExists, nextBootPath=nextBootPath, nextBootFirmware=nextBootFirmware, bootCnfgExists=bootCnfgExists, restartStkMemberDevice=restartStkMemberDevice, dfltCnfgExists=dfltCnfgExists, backupCnfgPath=backupCnfgPath, runCnfgLastSaveResult=runCnfgLastSaveResult, nextBootVersion=nextBootVersion, runCnfgSaveAsStatus=runCnfgSaveAsStatus, guiAppletSysSwVer=guiAppletSysSwVer, restartDevice=restartDevice, nextBootConfig=nextBootConfig, backupCnfgLastSetResult=backupCnfgLastSetResult, currSoftLastSaveResult=currSoftLastSaveResult, backupCnfgSetStatus=backupCnfgSetStatus, dfltCnfgPath=dfltCnfgPath, backupVersion=backupVersion, SystemFileOperationType=SystemFileOperationType, guiAppletSwVer=guiAppletSwVer, guiAppletConfig=guiAppletConfig, backupPath=backupPath, deviceConfiguration=deviceConfiguration, defaultConfig=defaultConfig, srvcSshEnable=srvcSshEnable, bootCnfgLastSetResult=bootCnfgLastSetResult, firmware=firmware, backupFirmware=backupFirmware, setup=setup, backupSetStatus=backupSetStatus, nextBootSetStatus=nextBootSetStatus, bootCnfgSetStatus=bootCnfgSetStatus, currentFirmware=currentFirmware, currSoftVersion=currSoftVersion)
