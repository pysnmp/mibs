...
mibBuilder.exportSymbols("AT-SETUP-MIB", nextBootLastSetResult=nextBootLastSetResult, backupCnfgSetStatus=backupCnfgSetStatus, restartStkMemberDevice=restartStkMemberDevice, guiConfig=guiConfig, runCnfgSaveAs=runCnfgSaveAs, dfltCnfgPath=dfltCnfgPath, setup=setup, nextBootFirmware=nextBootFirmware, nextBootSetStatus=nextBootSetStatus, nextBootPath=nextBootPath, guiAppletSysSwVer=guiAppletSysSwVer, deviceConfiguration=deviceConfiguration, currSoftName=currSoftName, backupPath=backupPath, nextBootConfig=nextBootConfig, bootCnfgExists=bootCnfgExists, backupFirmware=backupFirmware, backupLastSetResult=backupLastSetResult, currentFirmware=currentFirmware, currSoftLastSaveResult=currSoftLastSaveResult, runCnfgLastSaveResult=runCnfgLastSaveResult, backupCnfgExists=backupCnfgExists, guiAppletSwVer=guiAppletSwVer, SystemFileOperationType=SystemFileOperationType, bootCnfgPath=bootCnfgPath, currSoftSaveAs=currSoftSaveAs, PYSNMP_MODULE_ID=setup, defaultConfig=defaultConfig, serviceConfig=serviceConfig, guiAppletConfig=guiAppletConfig, bootCnfgLastSetResult=bootCnfgLastSetResult, srvcSshEnable=srvcSshEnable, backupSetStatus=backupSetStatus, runningConfig=runningConfig, bootCnfgSetStatus=bootCnfgSetStatus, runCnfgSaveAsStatus=runCnfgSaveAsStatus, firmware=firmware, restartDevice=restartDevice, backupVersion=backupVersion, currSoftVersion=currSoftVersion, dfltCnfgExists=dfltCnfgExists, nextBootVersion=nextBootVersion, currSoftSaveStatus=currSoftSaveStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, backupCnfgPath=backupCnfgPath, srvcTelnetEnable=srvcTelnetEnable, currSoftSaveToFile=currSoftSaveToFile, backupConfig=backupConfig)
