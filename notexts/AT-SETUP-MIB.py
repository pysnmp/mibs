...
mibBuilder.exportSymbols("AT-SETUP-MIB", currSoftSaveStatus=currSoftSaveStatus, backupSetStatus=backupSetStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, PYSNMP_MODULE_ID=setup, backupFirmware=backupFirmware, runCnfgLastSaveResult=runCnfgLastSaveResult, currSoftVersion=currSoftVersion, backupCnfgSetStatus=backupCnfgSetStatus, deviceConfiguration=deviceConfiguration, guiAppletSwVer=guiAppletSwVer, runCnfgSaveAsStatus=runCnfgSaveAsStatus, bootCnfgLastSetResult=bootCnfgLastSetResult, srvcTelnetEnable=srvcTelnetEnable, currentFirmware=currentFirmware, nextBootLastSetResult=nextBootLastSetResult, nextBootPath=nextBootPath, backupLastSetResult=backupLastSetResult, runCnfgSaveAs=runCnfgSaveAs, bootCnfgExists=bootCnfgExists, setup=setup, nextBootConfig=nextBootConfig, restartStkMemberDevice=restartStkMemberDevice, guiAppletConfig=guiAppletConfig, bootCnfgSetStatus=bootCnfgSetStatus, guiAppletSysSwVer=guiAppletSysSwVer, dfltCnfgPath=dfltCnfgPath, restartDevice=restartDevice, currSoftLastSaveResult=currSoftLastSaveResult, nextBootVersion=nextBootVersion, backupPath=backupPath, dfltCnfgExists=dfltCnfgExists, firmware=firmware, srvcSshEnable=srvcSshEnable, SystemFileOperationType=SystemFileOperationType, nextBootSetStatus=nextBootSetStatus, guiConfig=guiConfig, defaultConfig=defaultConfig, currSoftSaveToFile=currSoftSaveToFile, backupConfig=backupConfig, currSoftName=currSoftName, backupCnfgPath=backupCnfgPath, backupVersion=backupVersion, bootCnfgPath=bootCnfgPath, backupCnfgExists=backupCnfgExists, runningConfig=runningConfig, serviceConfig=serviceConfig, nextBootFirmware=nextBootFirmware, currSoftSaveAs=currSoftSaveAs)
