...
mibBuilder.exportSymbols("AT-SETUP-MIB", currentFirmware=currentFirmware, restartStkMemberDevice=restartStkMemberDevice, guiAppletSysSwVer=guiAppletSysSwVer, backupVersion=backupVersion, guiAppletSwVer=guiAppletSwVer, bootCnfgSetStatus=bootCnfgSetStatus, nextBootVersion=nextBootVersion, setup=setup, firmware=firmware, bootCnfgExists=bootCnfgExists, backupCnfgLastSetResult=backupCnfgLastSetResult, backupSetStatus=backupSetStatus, runCnfgSaveAsStatus=runCnfgSaveAsStatus, backupCnfgExists=backupCnfgExists, guiAppletConfig=guiAppletConfig, serviceConfig=serviceConfig, SystemFileOperationType=SystemFileOperationType, guiConfig=guiConfig, bootCnfgLastSetResult=bootCnfgLastSetResult, restartDevice=restartDevice, backupPath=backupPath, nextBootPath=nextBootPath, backupConfig=backupConfig, PYSNMP_MODULE_ID=setup, backupCnfgPath=backupCnfgPath, currSoftName=currSoftName, runCnfgLastSaveResult=runCnfgLastSaveResult, srvcTelnetEnable=srvcTelnetEnable, deviceConfiguration=deviceConfiguration, nextBootConfig=nextBootConfig, nextBootLastSetResult=nextBootLastSetResult, runCnfgSaveAs=runCnfgSaveAs, currSoftSaveToFile=currSoftSaveToFile, nextBootFirmware=nextBootFirmware, currSoftLastSaveResult=currSoftLastSaveResult, runningConfig=runningConfig, dfltCnfgExists=dfltCnfgExists, defaultConfig=defaultConfig, currSoftSaveAs=currSoftSaveAs, dfltCnfgPath=dfltCnfgPath, currSoftVersion=currSoftVersion, srvcSshEnable=srvcSshEnable, currSoftSaveStatus=currSoftSaveStatus, nextBootSetStatus=nextBootSetStatus, bootCnfgPath=bootCnfgPath, backupLastSetResult=backupLastSetResult, backupFirmware=backupFirmware, backupCnfgSetStatus=backupCnfgSetStatus)
