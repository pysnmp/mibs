...
mibBuilder.exportSymbols("AT-SETUP-MIB", runningConfig=runningConfig, guiAppletSwVer=guiAppletSwVer, runCnfgLastSaveResult=runCnfgLastSaveResult, serviceConfig=serviceConfig, currSoftSaveStatus=currSoftSaveStatus, setup=setup, backupPath=backupPath, PYSNMP_MODULE_ID=setup, backupCnfgSetStatus=backupCnfgSetStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, dfltCnfgExists=dfltCnfgExists, bootCnfgExists=bootCnfgExists, bootCnfgPath=bootCnfgPath, srvcSshEnable=srvcSshEnable, backupVersion=backupVersion, currSoftName=currSoftName, guiAppletConfig=guiAppletConfig, defaultConfig=defaultConfig, guiConfig=guiConfig, guiAppletSysSwVer=guiAppletSysSwVer, bootCnfgLastSetResult=bootCnfgLastSetResult, nextBootFirmware=nextBootFirmware, backupCnfgPath=backupCnfgPath, currSoftSaveToFile=currSoftSaveToFile, currentFirmware=currentFirmware, currSoftLastSaveResult=currSoftLastSaveResult, nextBootConfig=nextBootConfig, currSoftVersion=currSoftVersion, restartStkMemberDevice=restartStkMemberDevice, currSoftSaveAs=currSoftSaveAs, firmware=firmware, SystemFileOperationType=SystemFileOperationType, bootCnfgSetStatus=bootCnfgSetStatus, runCnfgSaveAsStatus=runCnfgSaveAsStatus, backupConfig=backupConfig, nextBootSetStatus=nextBootSetStatus, backupCnfgExists=backupCnfgExists, srvcTelnetEnable=srvcTelnetEnable, nextBootPath=nextBootPath, dfltCnfgPath=dfltCnfgPath, nextBootLastSetResult=nextBootLastSetResult, backupSetStatus=backupSetStatus, deviceConfiguration=deviceConfiguration, backupLastSetResult=backupLastSetResult, backupFirmware=backupFirmware, runCnfgSaveAs=runCnfgSaveAs, nextBootVersion=nextBootVersion, restartDevice=restartDevice)
