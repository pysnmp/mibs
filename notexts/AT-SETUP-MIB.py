...
mibBuilder.exportSymbols("AT-SETUP-MIB", serviceConfig=serviceConfig, backupCnfgPath=backupCnfgPath, nextBootPath=nextBootPath, currSoftSaveAs=currSoftSaveAs, PYSNMP_MODULE_ID=setup, SystemFileOperationType=SystemFileOperationType, bootCnfgLastSetResult=bootCnfgLastSetResult, runningConfig=runningConfig, nextBootLastSetResult=nextBootLastSetResult, nextBootFirmware=nextBootFirmware, deviceConfiguration=deviceConfiguration, backupConfig=backupConfig, runCnfgSaveAsStatus=runCnfgSaveAsStatus, bootCnfgSetStatus=bootCnfgSetStatus, currSoftVersion=currSoftVersion, guiAppletSwVer=guiAppletSwVer, backupFirmware=backupFirmware, dfltCnfgExists=dfltCnfgExists, currentFirmware=currentFirmware, currSoftLastSaveResult=currSoftLastSaveResult, srvcSshEnable=srvcSshEnable, restartStkMemberDevice=restartStkMemberDevice, srvcTelnetEnable=srvcTelnetEnable, nextBootSetStatus=nextBootSetStatus, backupCnfgExists=backupCnfgExists, backupCnfgLastSetResult=backupCnfgLastSetResult, firmware=firmware, guiAppletConfig=guiAppletConfig, setup=setup, dfltCnfgPath=dfltCnfgPath, currSoftSaveToFile=currSoftSaveToFile, backupVersion=backupVersion, runCnfgLastSaveResult=runCnfgLastSaveResult, backupLastSetResult=backupLastSetResult, backupCnfgSetStatus=backupCnfgSetStatus, guiConfig=guiConfig, bootCnfgExists=bootCnfgExists, nextBootConfig=nextBootConfig, currSoftSaveStatus=currSoftSaveStatus, backupSetStatus=backupSetStatus, guiAppletSysSwVer=guiAppletSysSwVer, runCnfgSaveAs=runCnfgSaveAs, backupPath=backupPath, nextBootVersion=nextBootVersion, currSoftName=currSoftName, restartDevice=restartDevice, defaultConfig=defaultConfig, bootCnfgPath=bootCnfgPath)
