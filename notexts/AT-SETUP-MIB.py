...
mibBuilder.exportSymbols("AT-SETUP-MIB", currSoftVersion=currSoftVersion, nextBootLastSetResult=nextBootLastSetResult, guiAppletConfig=guiAppletConfig, backupCnfgExists=backupCnfgExists, setup=setup, SystemFileOperationType=SystemFileOperationType, backupConfig=backupConfig, runCnfgLastSaveResult=runCnfgLastSaveResult, currSoftSaveToFile=currSoftSaveToFile, backupVersion=backupVersion, backupSetStatus=backupSetStatus, PYSNMP_MODULE_ID=setup, runCnfgSaveAs=runCnfgSaveAs, serviceConfig=serviceConfig, bootCnfgPath=bootCnfgPath, currentFirmware=currentFirmware, currSoftSaveStatus=currSoftSaveStatus, bootCnfgSetStatus=bootCnfgSetStatus, guiConfig=guiConfig, restartDevice=restartDevice, dfltCnfgPath=dfltCnfgPath, bootCnfgExists=bootCnfgExists, dfltCnfgExists=dfltCnfgExists, bootCnfgLastSetResult=bootCnfgLastSetResult, guiAppletSwVer=guiAppletSwVer, currSoftName=currSoftName, srvcSshEnable=srvcSshEnable, runCnfgSaveAsStatus=runCnfgSaveAsStatus, nextBootVersion=nextBootVersion, nextBootPath=nextBootPath, deviceConfiguration=deviceConfiguration, currSoftSaveAs=currSoftSaveAs, nextBootFirmware=nextBootFirmware, srvcTelnetEnable=srvcTelnetEnable, backupLastSetResult=backupLastSetResult, guiAppletSysSwVer=guiAppletSysSwVer, backupPath=backupPath, backupCnfgSetStatus=backupCnfgSetStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, defaultConfig=defaultConfig, currSoftLastSaveResult=currSoftLastSaveResult, backupCnfgPath=backupCnfgPath, restartStkMemberDevice=restartStkMemberDevice, runningConfig=runningConfig, nextBootSetStatus=nextBootSetStatus, firmware=firmware, backupFirmware=backupFirmware, nextBootConfig=nextBootConfig)
