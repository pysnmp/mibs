...
mibBuilder.exportSymbols("AT-SETUP-MIB", firmware=firmware, currSoftVersion=currSoftVersion, backupCnfgSetStatus=backupCnfgSetStatus, nextBootFirmware=nextBootFirmware, backupVersion=backupVersion, setup=setup, SystemFileOperationType=SystemFileOperationType, currentFirmware=currentFirmware, nextBootPath=nextBootPath, bootCnfgLastSetResult=bootCnfgLastSetResult, srvcTelnetEnable=srvcTelnetEnable, runningConfig=runningConfig, nextBootLastSetResult=nextBootLastSetResult, serviceConfig=serviceConfig, currSoftSaveAs=currSoftSaveAs, currSoftName=currSoftName, restartDevice=restartDevice, currSoftSaveToFile=currSoftSaveToFile, srvcSshEnable=srvcSshEnable, runCnfgLastSaveResult=runCnfgLastSaveResult, restartStkMemberDevice=restartStkMemberDevice, bootCnfgPath=bootCnfgPath, backupCnfgPath=backupCnfgPath, backupLastSetResult=backupLastSetResult, guiAppletSysSwVer=guiAppletSysSwVer, backupSetStatus=backupSetStatus, bootCnfgSetStatus=bootCnfgSetStatus, nextBootVersion=nextBootVersion, defaultConfig=defaultConfig, backupFirmware=backupFirmware, dfltCnfgExists=dfltCnfgExists, backupCnfgLastSetResult=backupCnfgLastSetResult, backupCnfgExists=backupCnfgExists, currSoftLastSaveResult=currSoftLastSaveResult, runCnfgSaveAs=runCnfgSaveAs, guiConfig=guiConfig, nextBootConfig=nextBootConfig, nextBootSetStatus=nextBootSetStatus, runCnfgSaveAsStatus=runCnfgSaveAsStatus, bootCnfgExists=bootCnfgExists, guiAppletConfig=guiAppletConfig, PYSNMP_MODULE_ID=setup, dfltCnfgPath=dfltCnfgPath, backupPath=backupPath, backupConfig=backupConfig, guiAppletSwVer=guiAppletSwVer, currSoftSaveStatus=currSoftSaveStatus, deviceConfiguration=deviceConfiguration)
