...
mibBuilder.exportSymbols("AT-SETUP-MIB", bootCnfgPath=bootCnfgPath, bootCnfgSetStatus=bootCnfgSetStatus, bootCnfgLastSetResult=bootCnfgLastSetResult, guiConfig=guiConfig, firmware=firmware, backupLastSetResult=backupLastSetResult, runCnfgSaveAs=runCnfgSaveAs, backupConfig=backupConfig, currSoftSaveAs=currSoftSaveAs, nextBootSetStatus=nextBootSetStatus, backupCnfgPath=backupCnfgPath, runningConfig=runningConfig, backupCnfgSetStatus=backupCnfgSetStatus, dfltCnfgExists=dfltCnfgExists, currSoftName=currSoftName, dfltCnfgPath=dfltCnfgPath, bootCnfgExists=bootCnfgExists, currSoftSaveStatus=currSoftSaveStatus, SystemFileOperationType=SystemFileOperationType, nextBootFirmware=nextBootFirmware, runCnfgSaveAsStatus=runCnfgSaveAsStatus, srvcTelnetEnable=srvcTelnetEnable, currSoftLastSaveResult=currSoftLastSaveResult, nextBootConfig=nextBootConfig, backupPath=backupPath, currSoftVersion=currSoftVersion, nextBootVersion=nextBootVersion, PYSNMP_MODULE_ID=setup, restartDevice=restartDevice, nextBootLastSetResult=nextBootLastSetResult, nextBootPath=nextBootPath, defaultConfig=defaultConfig, deviceConfiguration=deviceConfiguration, backupCnfgExists=backupCnfgExists, setup=setup, guiAppletSwVer=guiAppletSwVer, currentFirmware=currentFirmware, runCnfgLastSaveResult=runCnfgLastSaveResult, backupVersion=backupVersion, backupSetStatus=backupSetStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, guiAppletConfig=guiAppletConfig, currSoftSaveToFile=currSoftSaveToFile, backupFirmware=backupFirmware, srvcSshEnable=srvcSshEnable, guiAppletSysSwVer=guiAppletSysSwVer, restartStkMemberDevice=restartStkMemberDevice, serviceConfig=serviceConfig)
