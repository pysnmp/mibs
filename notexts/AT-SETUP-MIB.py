...
mibBuilder.exportSymbols("AT-SETUP-MIB", guiConfig=guiConfig, backupLastSetResult=backupLastSetResult, SystemFileOperationType=SystemFileOperationType, runCnfgLastSaveResult=runCnfgLastSaveResult, guiAppletSwVer=guiAppletSwVer, backupCnfgPath=backupCnfgPath, backupConfig=backupConfig, nextBootVersion=nextBootVersion, firmware=firmware, currSoftSaveStatus=currSoftSaveStatus, backupCnfgSetStatus=backupCnfgSetStatus, srvcSshEnable=srvcSshEnable, nextBootLastSetResult=nextBootLastSetResult, restartStkMemberDevice=restartStkMemberDevice, bootCnfgLastSetResult=bootCnfgLastSetResult, runCnfgSaveAs=runCnfgSaveAs, bootCnfgPath=bootCnfgPath, currentFirmware=currentFirmware, defaultConfig=defaultConfig, nextBootConfig=nextBootConfig, guiAppletSysSwVer=guiAppletSysSwVer, currSoftSaveAs=currSoftSaveAs, bootCnfgExists=bootCnfgExists, restartDevice=restartDevice, dfltCnfgPath=dfltCnfgPath, serviceConfig=serviceConfig, srvcTelnetEnable=srvcTelnetEnable, setup=setup, backupFirmware=backupFirmware, backupCnfgLastSetResult=backupCnfgLastSetResult, backupVersion=backupVersion, nextBootPath=nextBootPath, nextBootFirmware=nextBootFirmware, deviceConfiguration=deviceConfiguration, currSoftSaveToFile=currSoftSaveToFile, runningConfig=runningConfig, backupCnfgExists=backupCnfgExists, backupSetStatus=backupSetStatus, runCnfgSaveAsStatus=runCnfgSaveAsStatus, currSoftName=currSoftName, currSoftVersion=currSoftVersion, backupPath=backupPath, bootCnfgSetStatus=bootCnfgSetStatus, guiAppletConfig=guiAppletConfig, PYSNMP_MODULE_ID=setup, nextBootSetStatus=nextBootSetStatus, currSoftLastSaveResult=currSoftLastSaveResult, dfltCnfgExists=dfltCnfgExists)
