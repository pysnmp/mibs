...
mibBuilder.exportSymbols("AT-SETUP-MIB", backupVersion=backupVersion, backupLastSetResult=backupLastSetResult, currSoftLastSaveResult=currSoftLastSaveResult, backupCnfgSetStatus=backupCnfgSetStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, restartStkMemberDevice=restartStkMemberDevice, backupSetStatus=backupSetStatus, runningConfig=runningConfig, srvcTelnetEnable=srvcTelnetEnable, currSoftSaveAs=currSoftSaveAs, runCnfgSaveAs=runCnfgSaveAs, guiAppletConfig=guiAppletConfig, currentFirmware=currentFirmware, setup=setup, serviceConfig=serviceConfig, nextBootFirmware=nextBootFirmware, backupPath=backupPath, nextBootConfig=nextBootConfig, guiAppletSwVer=guiAppletSwVer, defaultConfig=defaultConfig, bootCnfgLastSetResult=bootCnfgLastSetResult, backupFirmware=backupFirmware, bootCnfgSetStatus=bootCnfgSetStatus, currSoftSaveToFile=currSoftSaveToFile, restartDevice=restartDevice, firmware=firmware, currSoftVersion=currSoftVersion, bootCnfgPath=bootCnfgPath, deviceConfiguration=deviceConfiguration, nextBootVersion=nextBootVersion, dfltCnfgPath=dfltCnfgPath, dfltCnfgExists=dfltCnfgExists, backupCnfgPath=backupCnfgPath, currSoftSaveStatus=currSoftSaveStatus, guiConfig=guiConfig, nextBootLastSetResult=nextBootLastSetResult, runCnfgSaveAsStatus=runCnfgSaveAsStatus, backupConfig=backupConfig, nextBootPath=nextBootPath, bootCnfgExists=bootCnfgExists, nextBootSetStatus=nextBootSetStatus, PYSNMP_MODULE_ID=setup, currSoftName=currSoftName, backupCnfgExists=backupCnfgExists, guiAppletSysSwVer=guiAppletSysSwVer, runCnfgLastSaveResult=runCnfgLastSaveResult, SystemFileOperationType=SystemFileOperationType, srvcSshEnable=srvcSshEnable)
