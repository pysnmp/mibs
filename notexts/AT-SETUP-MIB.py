...
mibBuilder.exportSymbols("AT-SETUP-MIB", currSoftSaveToFile=currSoftSaveToFile, backupLastSetResult=backupLastSetResult, currSoftName=currSoftName, runCnfgSaveAs=runCnfgSaveAs, bootCnfgSetStatus=bootCnfgSetStatus, currentFirmware=currentFirmware, srvcTelnetEnable=srvcTelnetEnable, guiConfig=guiConfig, dfltCnfgExists=dfltCnfgExists, backupConfig=backupConfig, runCnfgSaveAsStatus=runCnfgSaveAsStatus, bootCnfgExists=bootCnfgExists, currSoftSaveStatus=currSoftSaveStatus, nextBootPath=nextBootPath, guiAppletSwVer=guiAppletSwVer, runCnfgLastSaveResult=runCnfgLastSaveResult, currSoftSaveAs=currSoftSaveAs, backupCnfgPath=backupCnfgPath, backupCnfgLastSetResult=backupCnfgLastSetResult, nextBootVersion=nextBootVersion, defaultConfig=defaultConfig, nextBootConfig=nextBootConfig, currSoftVersion=currSoftVersion, bootCnfgPath=bootCnfgPath, backupCnfgExists=backupCnfgExists, backupPath=backupPath, runningConfig=runningConfig, guiAppletSysSwVer=guiAppletSysSwVer, dfltCnfgPath=dfltCnfgPath, restartDevice=restartDevice, srvcSshEnable=srvcSshEnable, PYSNMP_MODULE_ID=setup, bootCnfgLastSetResult=bootCnfgLastSetResult, backupVersion=backupVersion, deviceConfiguration=deviceConfiguration, currSoftLastSaveResult=currSoftLastSaveResult, nextBootSetStatus=nextBootSetStatus, backupCnfgSetStatus=backupCnfgSetStatus, guiAppletConfig=guiAppletConfig, nextBootLastSetResult=nextBootLastSetResult, backupFirmware=backupFirmware, serviceConfig=serviceConfig, backupSetStatus=backupSetStatus, setup=setup, firmware=firmware, SystemFileOperationType=SystemFileOperationType, restartStkMemberDevice=restartStkMemberDevice, nextBootFirmware=nextBootFirmware)
