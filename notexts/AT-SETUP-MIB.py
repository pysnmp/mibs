...
mibBuilder.exportSymbols("AT-SETUP-MIB", currSoftVersion=currSoftVersion, backupSetStatus=backupSetStatus, runCnfgSaveAsStatus=runCnfgSaveAsStatus, guiAppletSysSwVer=guiAppletSysSwVer, currSoftSaveStatus=currSoftSaveStatus, nextBootLastSetResult=nextBootLastSetResult, nextBootPath=nextBootPath, dfltCnfgPath=dfltCnfgPath, serviceConfig=serviceConfig, guiConfig=guiConfig, bootCnfgSetStatus=bootCnfgSetStatus, bootCnfgExists=bootCnfgExists, backupCnfgLastSetResult=backupCnfgLastSetResult, currSoftSaveAs=currSoftSaveAs, nextBootFirmware=nextBootFirmware, currSoftLastSaveResult=currSoftLastSaveResult, restartDevice=restartDevice, backupVersion=backupVersion, dfltCnfgExists=dfltCnfgExists, backupLastSetResult=backupLastSetResult, srvcTelnetEnable=srvcTelnetEnable, PYSNMP_MODULE_ID=setup, backupCnfgPath=backupCnfgPath, deviceConfiguration=deviceConfiguration, runCnfgSaveAs=runCnfgSaveAs, runningConfig=runningConfig, SystemFileOperationType=SystemFileOperationType, nextBootConfig=nextBootConfig, runCnfgLastSaveResult=runCnfgLastSaveResult, guiAppletSwVer=guiAppletSwVer, srvcSshEnable=srvcSshEnable, setup=setup, restartStkMemberDevice=restartStkMemberDevice, nextBootVersion=nextBootVersion, bootCnfgPath=bootCnfgPath, currSoftName=currSoftName, nextBootSetStatus=nextBootSetStatus, backupConfig=backupConfig, firmware=firmware, defaultConfig=defaultConfig, currentFirmware=currentFirmware, bootCnfgLastSetResult=bootCnfgLastSetResult, backupPath=backupPath, currSoftSaveToFile=currSoftSaveToFile, backupCnfgExists=backupCnfgExists, backupCnfgSetStatus=backupCnfgSetStatus, guiAppletConfig=guiAppletConfig, backupFirmware=backupFirmware)
