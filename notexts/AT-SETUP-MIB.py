...
mibBuilder.exportSymbols("AT-SETUP-MIB", srvcSshEnable=srvcSshEnable, runCnfgLastSaveResult=runCnfgLastSaveResult, defaultConfig=defaultConfig, SystemFileOperationType=SystemFileOperationType, currSoftLastSaveResult=currSoftLastSaveResult, backupLastSetResult=backupLastSetResult, backupCnfgExists=backupCnfgExists, nextBootVersion=nextBootVersion, PYSNMP_MODULE_ID=setup, srvcTelnetEnable=srvcTelnetEnable, currSoftVersion=currSoftVersion, runCnfgSaveAs=runCnfgSaveAs, bootCnfgLastSetResult=bootCnfgLastSetResult, restartStkMemberDevice=restartStkMemberDevice, dfltCnfgPath=dfltCnfgPath, nextBootFirmware=nextBootFirmware, backupCnfgPath=backupCnfgPath, backupFirmware=backupFirmware, serviceConfig=serviceConfig, nextBootConfig=nextBootConfig, currentFirmware=currentFirmware, deviceConfiguration=deviceConfiguration, backupCnfgSetStatus=backupCnfgSetStatus, backupConfig=backupConfig, guiAppletSwVer=guiAppletSwVer, firmware=firmware, backupVersion=backupVersion, bootCnfgPath=bootCnfgPath, guiConfig=guiConfig, dfltCnfgExists=dfltCnfgExists, nextBootLastSetResult=nextBootLastSetResult, nextBootSetStatus=nextBootSetStatus, runCnfgSaveAsStatus=runCnfgSaveAsStatus, guiAppletConfig=guiAppletConfig, restartDevice=restartDevice, runningConfig=runningConfig, backupSetStatus=backupSetStatus, nextBootPath=nextBootPath, currSoftSaveAs=currSoftSaveAs, setup=setup, currSoftName=currSoftName, guiAppletSysSwVer=guiAppletSysSwVer, bootCnfgExists=bootCnfgExists, bootCnfgSetStatus=bootCnfgSetStatus, currSoftSaveToFile=currSoftSaveToFile, backupCnfgLastSetResult=backupCnfgLastSetResult, backupPath=backupPath, currSoftSaveStatus=currSoftSaveStatus)
