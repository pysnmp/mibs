...
mibBuilder.exportSymbols("AT-SETUP-MIB", SystemFileOperationType=SystemFileOperationType, firmware=firmware, backupCnfgExists=backupCnfgExists, currSoftSaveAs=currSoftSaveAs, backupCnfgPath=backupCnfgPath, restartStkMemberDevice=restartStkMemberDevice, runCnfgSaveAsStatus=runCnfgSaveAsStatus, bootCnfgPath=bootCnfgPath, runCnfgLastSaveResult=runCnfgLastSaveResult, dfltCnfgExists=dfltCnfgExists, runCnfgSaveAs=runCnfgSaveAs, guiAppletSwVer=guiAppletSwVer, backupCnfgLastSetResult=backupCnfgLastSetResult, serviceConfig=serviceConfig, backupFirmware=backupFirmware, nextBootLastSetResult=nextBootLastSetResult, backupCnfgSetStatus=backupCnfgSetStatus, currentFirmware=currentFirmware, deviceConfiguration=deviceConfiguration, guiAppletSysSwVer=guiAppletSysSwVer, nextBootPath=nextBootPath, backupVersion=backupVersion, bootCnfgLastSetResult=bootCnfgLastSetResult, nextBootVersion=nextBootVersion, currSoftLastSaveResult=currSoftLastSaveResult, restartDevice=restartDevice, currSoftSaveStatus=currSoftSaveStatus, dfltCnfgPath=dfltCnfgPath, bootCnfgSetStatus=bootCnfgSetStatus, nextBootConfig=nextBootConfig, currSoftSaveToFile=currSoftSaveToFile, backupPath=backupPath, defaultConfig=defaultConfig, srvcSshEnable=srvcSshEnable, currSoftName=currSoftName, nextBootSetStatus=nextBootSetStatus, guiConfig=guiConfig, bootCnfgExists=bootCnfgExists, backupConfig=backupConfig, nextBootFirmware=nextBootFirmware, backupLastSetResult=backupLastSetResult, srvcTelnetEnable=srvcTelnetEnable, PYSNMP_MODULE_ID=setup, currSoftVersion=currSoftVersion, guiAppletConfig=guiAppletConfig, runningConfig=runningConfig, backupSetStatus=backupSetStatus, setup=setup)
