...
mibBuilder.exportSymbols("AT-SETUP-MIB", srvcTelnetEnable=srvcTelnetEnable, nextBootLastSetResult=nextBootLastSetResult, backupPath=backupPath, backupCnfgPath=backupCnfgPath, srvcSshEnable=srvcSshEnable, currSoftSaveStatus=currSoftSaveStatus, dfltCnfgExists=dfltCnfgExists, backupConfig=backupConfig, backupLastSetResult=backupLastSetResult, runningConfig=runningConfig, bootCnfgPath=bootCnfgPath, bootCnfgExists=bootCnfgExists, runCnfgSaveAsStatus=runCnfgSaveAsStatus, nextBootSetStatus=nextBootSetStatus, currSoftVersion=currSoftVersion, bootCnfgSetStatus=bootCnfgSetStatus, dfltCnfgPath=dfltCnfgPath, setup=setup, backupCnfgSetStatus=backupCnfgSetStatus, backupCnfgExists=backupCnfgExists, backupSetStatus=backupSetStatus, currentFirmware=currentFirmware, backupFirmware=backupFirmware, guiConfig=guiConfig, SystemFileOperationType=SystemFileOperationType, nextBootFirmware=nextBootFirmware, firmware=firmware, bootCnfgLastSetResult=bootCnfgLastSetResult, currSoftSaveAs=currSoftSaveAs, backupVersion=backupVersion, runCnfgSaveAs=runCnfgSaveAs, runCnfgLastSaveResult=runCnfgLastSaveResult, backupCnfgLastSetResult=backupCnfgLastSetResult, currSoftLastSaveResult=currSoftLastSaveResult, currSoftSaveToFile=currSoftSaveToFile, restartStkMemberDevice=restartStkMemberDevice, guiAppletSysSwVer=guiAppletSysSwVer, restartDevice=restartDevice, serviceConfig=serviceConfig, defaultConfig=defaultConfig, guiAppletConfig=guiAppletConfig, nextBootVersion=nextBootVersion, deviceConfiguration=deviceConfiguration, PYSNMP_MODULE_ID=setup, currSoftName=currSoftName, guiAppletSwVer=guiAppletSwVer, nextBootPath=nextBootPath, nextBootConfig=nextBootConfig)
