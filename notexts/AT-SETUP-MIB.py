...
mibBuilder.exportSymbols("AT-SETUP-MIB", PYSNMP_MODULE_ID=setup, restartStkMemberDevice=restartStkMemberDevice, currentFirmware=currentFirmware, guiConfig=guiConfig, backupConfig=backupConfig, setup=setup, currSoftSaveToFile=currSoftSaveToFile, runningConfig=runningConfig, backupSetStatus=backupSetStatus, defaultConfig=defaultConfig, currSoftSaveAs=currSoftSaveAs, backupCnfgExists=backupCnfgExists, backupCnfgSetStatus=backupCnfgSetStatus, bootCnfgPath=bootCnfgPath, serviceConfig=serviceConfig, nextBootLastSetResult=nextBootLastSetResult, restartDevice=restartDevice, firmware=firmware, backupCnfgLastSetResult=backupCnfgLastSetResult, currSoftSaveStatus=currSoftSaveStatus, deviceConfiguration=deviceConfiguration, guiAppletConfig=guiAppletConfig, currSoftVersion=currSoftVersion, runCnfgSaveAs=runCnfgSaveAs, bootCnfgExists=bootCnfgExists, currSoftName=currSoftName, backupVersion=backupVersion, bootCnfgLastSetResult=bootCnfgLastSetResult, nextBootVersion=nextBootVersion, guiAppletSwVer=guiAppletSwVer, runCnfgSaveAsStatus=runCnfgSaveAsStatus, backupFirmware=backupFirmware, nextBootConfig=nextBootConfig, backupCnfgPath=backupCnfgPath, backupPath=backupPath, SystemFileOperationType=SystemFileOperationType, bootCnfgSetStatus=bootCnfgSetStatus, dfltCnfgPath=dfltCnfgPath, guiAppletSysSwVer=guiAppletSysSwVer, nextBootSetStatus=nextBootSetStatus, nextBootPath=nextBootPath, backupLastSetResult=backupLastSetResult, runCnfgLastSaveResult=runCnfgLastSaveResult, srvcTelnetEnable=srvcTelnetEnable, currSoftLastSaveResult=currSoftLastSaveResult, srvcSshEnable=srvcSshEnable, nextBootFirmware=nextBootFirmware, dfltCnfgExists=dfltCnfgExists)
