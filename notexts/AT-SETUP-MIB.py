...
mibBuilder.exportSymbols("AT-SETUP-MIB", currentFirmware=currentFirmware, backupPath=backupPath, srvcSshEnable=srvcSshEnable, backupLastSetResult=backupLastSetResult, nextBootLastSetResult=nextBootLastSetResult, backupVersion=backupVersion, dfltCnfgPath=dfltCnfgPath, nextBootVersion=nextBootVersion, firmware=firmware, guiConfig=guiConfig, serviceConfig=serviceConfig, backupFirmware=backupFirmware, backupCnfgLastSetResult=backupCnfgLastSetResult, guiAppletConfig=guiAppletConfig, currSoftName=currSoftName, currSoftSaveStatus=currSoftSaveStatus, deviceConfiguration=deviceConfiguration, dfltCnfgExists=dfltCnfgExists, restartStkMemberDevice=restartStkMemberDevice, currSoftLastSaveResult=currSoftLastSaveResult, nextBootConfig=nextBootConfig, bootCnfgPath=bootCnfgPath, SystemFileOperationType=SystemFileOperationType, bootCnfgSetStatus=bootCnfgSetStatus, setup=setup, backupCnfgPath=backupCnfgPath, runCnfgSaveAs=runCnfgSaveAs, currSoftVersion=currSoftVersion, nextBootFirmware=nextBootFirmware, nextBootPath=nextBootPath, backupSetStatus=backupSetStatus, nextBootSetStatus=nextBootSetStatus, runningConfig=runningConfig, restartDevice=restartDevice, guiAppletSysSwVer=guiAppletSysSwVer, backupCnfgSetStatus=backupCnfgSetStatus, backupConfig=backupConfig, defaultConfig=defaultConfig, backupCnfgExists=backupCnfgExists, srvcTelnetEnable=srvcTelnetEnable, PYSNMP_MODULE_ID=setup, currSoftSaveToFile=currSoftSaveToFile, guiAppletSwVer=guiAppletSwVer, bootCnfgExists=bootCnfgExists, runCnfgSaveAsStatus=runCnfgSaveAsStatus, currSoftSaveAs=currSoftSaveAs, bootCnfgLastSetResult=bootCnfgLastSetResult, runCnfgLastSaveResult=runCnfgLastSaveResult)
