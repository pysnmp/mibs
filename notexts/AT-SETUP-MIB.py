...
mibBuilder.exportSymbols("AT-SETUP-MIB", firmware=firmware, nextBootLastSetResult=nextBootLastSetResult, guiAppletSwVer=guiAppletSwVer, backupCnfgPath=backupCnfgPath, srvcSshEnable=srvcSshEnable, bootCnfgLastSetResult=bootCnfgLastSetResult, currSoftSaveToFile=currSoftSaveToFile, currentFirmware=currentFirmware, backupSetStatus=backupSetStatus, guiAppletSysSwVer=guiAppletSysSwVer, restartDevice=restartDevice, runCnfgSaveAsStatus=runCnfgSaveAsStatus, bootCnfgPath=bootCnfgPath, currSoftSaveAs=currSoftSaveAs, nextBootVersion=nextBootVersion, runningConfig=runningConfig, currSoftLastSaveResult=currSoftLastSaveResult, restartStkMemberDevice=restartStkMemberDevice, backupLastSetResult=backupLastSetResult, dfltCnfgPath=dfltCnfgPath, backupCnfgSetStatus=backupCnfgSetStatus, currSoftSaveStatus=currSoftSaveStatus, backupConfig=backupConfig, backupCnfgExists=backupCnfgExists, dfltCnfgExists=dfltCnfgExists, runCnfgSaveAs=runCnfgSaveAs, bootCnfgExists=bootCnfgExists, backupFirmware=backupFirmware, nextBootPath=nextBootPath, setup=setup, bootCnfgSetStatus=bootCnfgSetStatus, nextBootFirmware=nextBootFirmware, SystemFileOperationType=SystemFileOperationType, backupVersion=backupVersion, currSoftName=currSoftName, backupPath=backupPath, nextBootSetStatus=nextBootSetStatus, currSoftVersion=currSoftVersion, guiConfig=guiConfig, defaultConfig=defaultConfig, guiAppletConfig=guiAppletConfig, serviceConfig=serviceConfig, runCnfgLastSaveResult=runCnfgLastSaveResult, backupCnfgLastSetResult=backupCnfgLastSetResult, deviceConfiguration=deviceConfiguration, PYSNMP_MODULE_ID=setup, srvcTelnetEnable=srvcTelnetEnable, nextBootConfig=nextBootConfig)
