...
mibBuilder.exportSymbols("AT-SETUP-MIB", guiAppletConfig=guiAppletConfig, runningConfig=runningConfig, backupPath=backupPath, currSoftLastSaveResult=currSoftLastSaveResult, SystemFileOperationType=SystemFileOperationType, backupLastSetResult=backupLastSetResult, bootCnfgExists=bootCnfgExists, currentFirmware=currentFirmware, firmware=firmware, dfltCnfgPath=dfltCnfgPath, PYSNMP_MODULE_ID=setup, defaultConfig=defaultConfig, backupCnfgLastSetResult=backupCnfgLastSetResult, deviceConfiguration=deviceConfiguration, nextBootFirmware=nextBootFirmware, runCnfgSaveAs=runCnfgSaveAs, nextBootVersion=nextBootVersion, backupCnfgSetStatus=backupCnfgSetStatus, srvcTelnetEnable=srvcTelnetEnable, guiConfig=guiConfig, nextBootLastSetResult=nextBootLastSetResult, guiAppletSysSwVer=guiAppletSysSwVer, backupCnfgExists=backupCnfgExists, setup=setup, backupConfig=backupConfig, backupFirmware=backupFirmware, bootCnfgSetStatus=bootCnfgSetStatus, dfltCnfgExists=dfltCnfgExists, currSoftSaveToFile=currSoftSaveToFile, bootCnfgLastSetResult=bootCnfgLastSetResult, backupVersion=backupVersion, currSoftVersion=currSoftVersion, runCnfgLastSaveResult=runCnfgLastSaveResult, currSoftName=currSoftName, nextBootPath=nextBootPath, restartStkMemberDevice=restartStkMemberDevice, serviceConfig=serviceConfig, nextBootConfig=nextBootConfig, restartDevice=restartDevice, currSoftSaveAs=currSoftSaveAs, bootCnfgPath=bootCnfgPath, nextBootSetStatus=nextBootSetStatus, currSoftSaveStatus=currSoftSaveStatus, guiAppletSwVer=guiAppletSwVer, srvcSshEnable=srvcSshEnable, backupCnfgPath=backupCnfgPath, runCnfgSaveAsStatus=runCnfgSaveAsStatus, backupSetStatus=backupSetStatus)
