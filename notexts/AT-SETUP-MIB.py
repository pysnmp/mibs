...
mibBuilder.exportSymbols("AT-SETUP-MIB", deviceConfiguration=deviceConfiguration, currSoftLastSaveResult=currSoftLastSaveResult, runCnfgSaveAsStatus=runCnfgSaveAsStatus, nextBootSetStatus=nextBootSetStatus, backupSetStatus=backupSetStatus, nextBootFirmware=nextBootFirmware, bootCnfgExists=bootCnfgExists, runningConfig=runningConfig, backupLastSetResult=backupLastSetResult, setup=setup, nextBootLastSetResult=nextBootLastSetResult, nextBootVersion=nextBootVersion, runCnfgLastSaveResult=runCnfgLastSaveResult, nextBootPath=nextBootPath, backupPath=backupPath, dfltCnfgExists=dfltCnfgExists, guiAppletSysSwVer=guiAppletSysSwVer, dfltCnfgPath=dfltCnfgPath, restartStkMemberDevice=restartStkMemberDevice, currSoftSaveStatus=currSoftSaveStatus, defaultConfig=defaultConfig, srvcSshEnable=srvcSshEnable, currSoftVersion=currSoftVersion, srvcTelnetEnable=srvcTelnetEnable, backupVersion=backupVersion, bootCnfgSetStatus=bootCnfgSetStatus, bootCnfgPath=bootCnfgPath, guiAppletConfig=guiAppletConfig, guiAppletSwVer=guiAppletSwVer, runCnfgSaveAs=runCnfgSaveAs, serviceConfig=serviceConfig, backupConfig=backupConfig, PYSNMP_MODULE_ID=setup, restartDevice=restartDevice, firmware=firmware, backupCnfgPath=backupCnfgPath, backupCnfgSetStatus=backupCnfgSetStatus, currSoftName=currSoftName, bootCnfgLastSetResult=bootCnfgLastSetResult, backupFirmware=backupFirmware, backupCnfgExists=backupCnfgExists, guiConfig=guiConfig, nextBootConfig=nextBootConfig, SystemFileOperationType=SystemFileOperationType, currSoftSaveAs=currSoftSaveAs, backupCnfgLastSetResult=backupCnfgLastSetResult, currentFirmware=currentFirmware, currSoftSaveToFile=currSoftSaveToFile)
