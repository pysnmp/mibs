...
mibBuilder.exportSymbols("AT-SETUP-MIB", currSoftSaveStatus=currSoftSaveStatus, deviceConfiguration=deviceConfiguration, bootCnfgExists=bootCnfgExists, guiAppletSwVer=guiAppletSwVer, runCnfgSaveAs=runCnfgSaveAs, firmware=firmware, backupSetStatus=backupSetStatus, runCnfgLastSaveResult=runCnfgLastSaveResult, serviceConfig=serviceConfig, dfltCnfgExists=dfltCnfgExists, currentFirmware=currentFirmware, defaultConfig=defaultConfig, backupCnfgLastSetResult=backupCnfgLastSetResult, guiConfig=guiConfig, srvcTelnetEnable=srvcTelnetEnable, currSoftSaveToFile=currSoftSaveToFile, bootCnfgLastSetResult=bootCnfgLastSetResult, nextBootSetStatus=nextBootSetStatus, PYSNMP_MODULE_ID=setup, currSoftName=currSoftName, backupCnfgSetStatus=backupCnfgSetStatus, nextBootLastSetResult=nextBootLastSetResult, backupCnfgExists=backupCnfgExists, dfltCnfgPath=dfltCnfgPath, SystemFileOperationType=SystemFileOperationType, backupPath=backupPath, nextBootConfig=nextBootConfig, guiAppletSysSwVer=guiAppletSysSwVer, nextBootVersion=nextBootVersion, nextBootPath=nextBootPath, bootCnfgPath=bootCnfgPath, currSoftSaveAs=currSoftSaveAs, setup=setup, currSoftLastSaveResult=currSoftLastSaveResult, backupFirmware=backupFirmware, backupVersion=backupVersion, backupLastSetResult=backupLastSetResult, bootCnfgSetStatus=bootCnfgSetStatus, srvcSshEnable=srvcSshEnable, guiAppletConfig=guiAppletConfig, currSoftVersion=currSoftVersion, runCnfgSaveAsStatus=runCnfgSaveAsStatus, restartStkMemberDevice=restartStkMemberDevice, backupConfig=backupConfig, nextBootFirmware=nextBootFirmware, restartDevice=restartDevice, runningConfig=runningConfig, backupCnfgPath=backupCnfgPath)
