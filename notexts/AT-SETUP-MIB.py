...
mibBuilder.exportSymbols("AT-SETUP-MIB", currSoftVersion=currSoftVersion, backupConfig=backupConfig, srvcSshEnable=srvcSshEnable, srvcTelnetEnable=srvcTelnetEnable, serviceConfig=serviceConfig, runCnfgSaveAsStatus=runCnfgSaveAsStatus, runCnfgLastSaveResult=runCnfgLastSaveResult, bootCnfgExists=bootCnfgExists, backupCnfgLastSetResult=backupCnfgLastSetResult, currentFirmware=currentFirmware, nextBootSetStatus=nextBootSetStatus, backupFirmware=backupFirmware, currSoftSaveAs=currSoftSaveAs, dfltCnfgExists=dfltCnfgExists, backupCnfgPath=backupCnfgPath, runningConfig=runningConfig, guiConfig=guiConfig, nextBootLastSetResult=nextBootLastSetResult, nextBootConfig=nextBootConfig, backupLastSetResult=backupLastSetResult, bootCnfgPath=bootCnfgPath, guiAppletSysSwVer=guiAppletSysSwVer, guiAppletConfig=guiAppletConfig, nextBootFirmware=nextBootFirmware, restartStkMemberDevice=restartStkMemberDevice, guiAppletSwVer=guiAppletSwVer, nextBootVersion=nextBootVersion, nextBootPath=nextBootPath, defaultConfig=defaultConfig, dfltCnfgPath=dfltCnfgPath, backupCnfgExists=backupCnfgExists, firmware=firmware, restartDevice=restartDevice, currSoftLastSaveResult=currSoftLastSaveResult, currSoftName=currSoftName, currSoftSaveToFile=currSoftSaveToFile, PYSNMP_MODULE_ID=setup, SystemFileOperationType=SystemFileOperationType, deviceConfiguration=deviceConfiguration, bootCnfgLastSetResult=bootCnfgLastSetResult, currSoftSaveStatus=currSoftSaveStatus, backupVersion=backupVersion, backupPath=backupPath, runCnfgSaveAs=runCnfgSaveAs, backupSetStatus=backupSetStatus, bootCnfgSetStatus=bootCnfgSetStatus, backupCnfgSetStatus=backupCnfgSetStatus, setup=setup)
