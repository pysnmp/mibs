...
mibBuilder.exportSymbols("AT-SETUP-MIB", nextBootLastSetResult=nextBootLastSetResult, currSoftLastSaveResult=currSoftLastSaveResult, bootCnfgExists=bootCnfgExists, currSoftSaveStatus=currSoftSaveStatus, dfltCnfgPath=dfltCnfgPath, SystemFileOperationType=SystemFileOperationType, srvcSshEnable=srvcSshEnable, runCnfgSaveAsStatus=runCnfgSaveAsStatus, dfltCnfgExists=dfltCnfgExists, setup=setup, guiConfig=guiConfig, nextBootVersion=nextBootVersion, bootCnfgLastSetResult=bootCnfgLastSetResult, firmware=firmware, bootCnfgSetStatus=bootCnfgSetStatus, backupFirmware=backupFirmware, guiAppletConfig=guiAppletConfig, nextBootConfig=nextBootConfig, backupCnfgPath=backupCnfgPath, runningConfig=runningConfig, guiAppletSysSwVer=guiAppletSysSwVer, runCnfgSaveAs=runCnfgSaveAs, defaultConfig=defaultConfig, backupCnfgSetStatus=backupCnfgSetStatus, restartStkMemberDevice=restartStkMemberDevice, nextBootFirmware=nextBootFirmware, backupVersion=backupVersion, restartDevice=restartDevice, currSoftName=currSoftName, backupSetStatus=backupSetStatus, nextBootSetStatus=nextBootSetStatus, currentFirmware=currentFirmware, srvcTelnetEnable=srvcTelnetEnable, nextBootPath=nextBootPath, bootCnfgPath=bootCnfgPath, backupPath=backupPath, guiAppletSwVer=guiAppletSwVer, backupCnfgLastSetResult=backupCnfgLastSetResult, runCnfgLastSaveResult=runCnfgLastSaveResult, deviceConfiguration=deviceConfiguration, currSoftVersion=currSoftVersion, PYSNMP_MODULE_ID=setup, serviceConfig=serviceConfig, backupConfig=backupConfig, backupLastSetResult=backupLastSetResult, currSoftSaveToFile=currSoftSaveToFile, backupCnfgExists=backupCnfgExists, currSoftSaveAs=currSoftSaveAs)
