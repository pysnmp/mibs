...
mibBuilder.exportSymbols("AT-SETUP-MIB", backupSetStatus=backupSetStatus, srvcSshEnable=srvcSshEnable, runningConfig=runningConfig, backupPath=backupPath, guiAppletConfig=guiAppletConfig, currSoftSaveStatus=currSoftSaveStatus, restartStkMemberDevice=restartStkMemberDevice, nextBootConfig=nextBootConfig, dfltCnfgExists=dfltCnfgExists, srvcTelnetEnable=srvcTelnetEnable, restartDevice=restartDevice, bootCnfgSetStatus=bootCnfgSetStatus, currSoftVersion=currSoftVersion, firmware=firmware, backupCnfgPath=backupCnfgPath, currSoftLastSaveResult=currSoftLastSaveResult, defaultConfig=defaultConfig, nextBootSetStatus=nextBootSetStatus, backupLastSetResult=backupLastSetResult, runCnfgSaveAsStatus=runCnfgSaveAsStatus, guiAppletSwVer=guiAppletSwVer, nextBootPath=nextBootPath, currSoftSaveToFile=currSoftSaveToFile, currentFirmware=currentFirmware, bootCnfgLastSetResult=bootCnfgLastSetResult, currSoftName=currSoftName, bootCnfgExists=bootCnfgExists, serviceConfig=serviceConfig, runCnfgSaveAs=runCnfgSaveAs, nextBootFirmware=nextBootFirmware, backupCnfgExists=backupCnfgExists, guiConfig=guiConfig, backupVersion=backupVersion, dfltCnfgPath=dfltCnfgPath, guiAppletSysSwVer=guiAppletSysSwVer, nextBootVersion=nextBootVersion, bootCnfgPath=bootCnfgPath, backupFirmware=backupFirmware, deviceConfiguration=deviceConfiguration, runCnfgLastSaveResult=runCnfgLastSaveResult, currSoftSaveAs=currSoftSaveAs, backupCnfgSetStatus=backupCnfgSetStatus, setup=setup, backupCnfgLastSetResult=backupCnfgLastSetResult, SystemFileOperationType=SystemFileOperationType, PYSNMP_MODULE_ID=setup, backupConfig=backupConfig, nextBootLastSetResult=nextBootLastSetResult)
