...
mibBuilder.exportSymbols("AT-SETUP-MIB", firmware=firmware, bootCnfgPath=bootCnfgPath, SystemFileOperationType=SystemFileOperationType, backupCnfgSetStatus=backupCnfgSetStatus, srvcTelnetEnable=srvcTelnetEnable, guiAppletConfig=guiAppletConfig, setup=setup, currSoftSaveToFile=currSoftSaveToFile, nextBootConfig=nextBootConfig, nextBootPath=nextBootPath, backupCnfgExists=backupCnfgExists, currSoftSaveStatus=currSoftSaveStatus, defaultConfig=defaultConfig, serviceConfig=serviceConfig, restartStkMemberDevice=restartStkMemberDevice, guiAppletSysSwVer=guiAppletSysSwVer, restartDevice=restartDevice, runCnfgSaveAsStatus=runCnfgSaveAsStatus, nextBootVersion=nextBootVersion, runningConfig=runningConfig, backupCnfgPath=backupCnfgPath, backupPath=backupPath, currSoftName=currSoftName, deviceConfiguration=deviceConfiguration, backupFirmware=backupFirmware, backupCnfgLastSetResult=backupCnfgLastSetResult, runCnfgSaveAs=runCnfgSaveAs, backupConfig=backupConfig, dfltCnfgPath=dfltCnfgPath, srvcSshEnable=srvcSshEnable, currentFirmware=currentFirmware, runCnfgLastSaveResult=runCnfgLastSaveResult, bootCnfgLastSetResult=bootCnfgLastSetResult, PYSNMP_MODULE_ID=setup, currSoftSaveAs=currSoftSaveAs, currSoftLastSaveResult=currSoftLastSaveResult, bootCnfgSetStatus=bootCnfgSetStatus, guiConfig=guiConfig, backupVersion=backupVersion, backupLastSetResult=backupLastSetResult, bootCnfgExists=bootCnfgExists, nextBootFirmware=nextBootFirmware, guiAppletSwVer=guiAppletSwVer, dfltCnfgExists=dfltCnfgExists, currSoftVersion=currSoftVersion, nextBootSetStatus=nextBootSetStatus, nextBootLastSetResult=nextBootLastSetResult, backupSetStatus=backupSetStatus)
