...
mibBuilder.exportSymbols("AT-SETUP-MIB", currSoftSaveToFile=currSoftSaveToFile, dfltCnfgPath=dfltCnfgPath, dfltCnfgExists=dfltCnfgExists, backupConfig=backupConfig, backupVersion=backupVersion, runningConfig=runningConfig, currSoftVersion=currSoftVersion, backupCnfgExists=backupCnfgExists, restartDevice=restartDevice, srvcTelnetEnable=srvcTelnetEnable, firmware=firmware, runCnfgLastSaveResult=runCnfgLastSaveResult, guiAppletConfig=guiAppletConfig, setup=setup, currSoftSaveAs=currSoftSaveAs, currSoftSaveStatus=currSoftSaveStatus, bootCnfgPath=bootCnfgPath, backupFirmware=backupFirmware, runCnfgSaveAs=runCnfgSaveAs, nextBootConfig=nextBootConfig, runCnfgSaveAsStatus=runCnfgSaveAsStatus, nextBootLastSetResult=nextBootLastSetResult, serviceConfig=serviceConfig, guiAppletSwVer=guiAppletSwVer, nextBootVersion=nextBootVersion, bootCnfgLastSetResult=bootCnfgLastSetResult, srvcSshEnable=srvcSshEnable, bootCnfgExists=bootCnfgExists, defaultConfig=defaultConfig, currentFirmware=currentFirmware, backupCnfgLastSetResult=backupCnfgLastSetResult, backupPath=backupPath, deviceConfiguration=deviceConfiguration, backupCnfgPath=backupCnfgPath, nextBootPath=nextBootPath, guiAppletSysSwVer=guiAppletSysSwVer, restartStkMemberDevice=restartStkMemberDevice, bootCnfgSetStatus=bootCnfgSetStatus, SystemFileOperationType=SystemFileOperationType, nextBootFirmware=nextBootFirmware, backupCnfgSetStatus=backupCnfgSetStatus, guiConfig=guiConfig, currSoftLastSaveResult=currSoftLastSaveResult, nextBootSetStatus=nextBootSetStatus, currSoftName=currSoftName, backupLastSetResult=backupLastSetResult, backupSetStatus=backupSetStatus, PYSNMP_MODULE_ID=setup)
