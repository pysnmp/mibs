...
mibBuilder.exportSymbols("AT-SETUP-MIB", bootCnfgExists=bootCnfgExists, bootCnfgPath=bootCnfgPath, guiAppletConfig=guiAppletConfig, currentFirmware=currentFirmware, backupPath=backupPath, backupSetStatus=backupSetStatus, runningConfig=runningConfig, runCnfgSaveAs=runCnfgSaveAs, dfltCnfgPath=dfltCnfgPath, nextBootLastSetResult=nextBootLastSetResult, restartStkMemberDevice=restartStkMemberDevice, dfltCnfgExists=dfltCnfgExists, firmware=firmware, restartDevice=restartDevice, backupCnfgSetStatus=backupCnfgSetStatus, currSoftSaveStatus=currSoftSaveStatus, defaultConfig=defaultConfig, srvcSshEnable=srvcSshEnable, nextBootPath=nextBootPath, nextBootSetStatus=nextBootSetStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, guiAppletSysSwVer=guiAppletSysSwVer, currSoftSaveAs=currSoftSaveAs, currSoftVersion=currSoftVersion, backupLastSetResult=backupLastSetResult, currSoftSaveToFile=currSoftSaveToFile, currSoftLastSaveResult=currSoftLastSaveResult, bootCnfgSetStatus=bootCnfgSetStatus, backupConfig=backupConfig, guiConfig=guiConfig, nextBootVersion=nextBootVersion, SystemFileOperationType=SystemFileOperationType, backupCnfgExists=backupCnfgExists, backupVersion=backupVersion, runCnfgSaveAsStatus=runCnfgSaveAsStatus, serviceConfig=serviceConfig, guiAppletSwVer=guiAppletSwVer, srvcTelnetEnable=srvcTelnetEnable, backupCnfgPath=backupCnfgPath, deviceConfiguration=deviceConfiguration, nextBootConfig=nextBootConfig, nextBootFirmware=nextBootFirmware, backupFirmware=backupFirmware, bootCnfgLastSetResult=bootCnfgLastSetResult, runCnfgLastSaveResult=runCnfgLastSaveResult, currSoftName=currSoftName, PYSNMP_MODULE_ID=setup, setup=setup)
