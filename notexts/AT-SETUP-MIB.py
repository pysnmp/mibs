...
mibBuilder.exportSymbols("AT-SETUP-MIB", currSoftName=currSoftName, dfltCnfgPath=dfltCnfgPath, backupPath=backupPath, backupCnfgPath=backupCnfgPath, guiAppletSysSwVer=guiAppletSysSwVer, serviceConfig=serviceConfig, deviceConfiguration=deviceConfiguration, currSoftSaveAs=currSoftSaveAs, currentFirmware=currentFirmware, nextBootPath=nextBootPath, bootCnfgSetStatus=bootCnfgSetStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, srvcSshEnable=srvcSshEnable, bootCnfgExists=bootCnfgExists, restartDevice=restartDevice, currSoftLastSaveResult=currSoftLastSaveResult, srvcTelnetEnable=srvcTelnetEnable, nextBootSetStatus=nextBootSetStatus, nextBootConfig=nextBootConfig, currSoftVersion=currSoftVersion, nextBootLastSetResult=nextBootLastSetResult, nextBootFirmware=nextBootFirmware, runCnfgLastSaveResult=runCnfgLastSaveResult, guiAppletConfig=guiAppletConfig, backupFirmware=backupFirmware, guiConfig=guiConfig, setup=setup, defaultConfig=defaultConfig, backupCnfgSetStatus=backupCnfgSetStatus, currSoftSaveStatus=currSoftSaveStatus, bootCnfgPath=bootCnfgPath, backupCnfgExists=backupCnfgExists, backupVersion=backupVersion, backupSetStatus=backupSetStatus, PYSNMP_MODULE_ID=setup, SystemFileOperationType=SystemFileOperationType, dfltCnfgExists=dfltCnfgExists, runCnfgSaveAs=runCnfgSaveAs, bootCnfgLastSetResult=bootCnfgLastSetResult, currSoftSaveToFile=currSoftSaveToFile, backupConfig=backupConfig, backupLastSetResult=backupLastSetResult, runCnfgSaveAsStatus=runCnfgSaveAsStatus, nextBootVersion=nextBootVersion, guiAppletSwVer=guiAppletSwVer, restartStkMemberDevice=restartStkMemberDevice, runningConfig=runningConfig, firmware=firmware)
