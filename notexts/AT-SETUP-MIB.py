...
mibBuilder.exportSymbols("AT-SETUP-MIB", currSoftSaveToFile=currSoftSaveToFile, deviceConfiguration=deviceConfiguration, nextBootConfig=nextBootConfig, dfltCnfgExists=dfltCnfgExists, backupFirmware=backupFirmware, bootCnfgPath=bootCnfgPath, backupLastSetResult=backupLastSetResult, restartStkMemberDevice=restartStkMemberDevice, firmware=firmware, nextBootVersion=nextBootVersion, backupSetStatus=backupSetStatus, guiAppletSysSwVer=guiAppletSysSwVer, guiAppletSwVer=guiAppletSwVer, srvcTelnetEnable=srvcTelnetEnable, backupCnfgExists=backupCnfgExists, currentFirmware=currentFirmware, srvcSshEnable=srvcSshEnable, backupPath=backupPath, restartDevice=restartDevice, runCnfgLastSaveResult=runCnfgLastSaveResult, backupCnfgSetStatus=backupCnfgSetStatus, dfltCnfgPath=dfltCnfgPath, serviceConfig=serviceConfig, guiConfig=guiConfig, defaultConfig=defaultConfig, runCnfgSaveAs=runCnfgSaveAs, nextBootLastSetResult=nextBootLastSetResult, runningConfig=runningConfig, currSoftVersion=currSoftVersion, currSoftLastSaveResult=currSoftLastSaveResult, backupCnfgLastSetResult=backupCnfgLastSetResult, guiAppletConfig=guiAppletConfig, bootCnfgLastSetResult=bootCnfgLastSetResult, currSoftSaveStatus=currSoftSaveStatus, bootCnfgExists=bootCnfgExists, currSoftName=currSoftName, PYSNMP_MODULE_ID=setup, backupCnfgPath=backupCnfgPath, currSoftSaveAs=currSoftSaveAs, backupVersion=backupVersion, SystemFileOperationType=SystemFileOperationType, runCnfgSaveAsStatus=runCnfgSaveAsStatus, nextBootFirmware=nextBootFirmware, nextBootPath=nextBootPath, setup=setup, nextBootSetStatus=nextBootSetStatus, backupConfig=backupConfig, bootCnfgSetStatus=bootCnfgSetStatus)
