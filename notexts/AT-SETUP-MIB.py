...
mibBuilder.exportSymbols("AT-SETUP-MIB", setup=setup, currSoftSaveAs=currSoftSaveAs, defaultConfig=defaultConfig, guiAppletSysSwVer=guiAppletSysSwVer, dfltCnfgExists=dfltCnfgExists, bootCnfgExists=bootCnfgExists, currSoftSaveToFile=currSoftSaveToFile, bootCnfgPath=bootCnfgPath, backupCnfgPath=backupCnfgPath, nextBootConfig=nextBootConfig, runningConfig=runningConfig, SystemFileOperationType=SystemFileOperationType, currentFirmware=currentFirmware, runCnfgSaveAsStatus=runCnfgSaveAsStatus, bootCnfgLastSetResult=bootCnfgLastSetResult, srvcTelnetEnable=srvcTelnetEnable, restartStkMemberDevice=restartStkMemberDevice, backupConfig=backupConfig, backupCnfgExists=backupCnfgExists, nextBootSetStatus=nextBootSetStatus, currSoftName=currSoftName, nextBootPath=nextBootPath, restartDevice=restartDevice, currSoftSaveStatus=currSoftSaveStatus, PYSNMP_MODULE_ID=setup, bootCnfgSetStatus=bootCnfgSetStatus, nextBootFirmware=nextBootFirmware, backupLastSetResult=backupLastSetResult, dfltCnfgPath=dfltCnfgPath, backupFirmware=backupFirmware, currSoftLastSaveResult=currSoftLastSaveResult, nextBootVersion=nextBootVersion, backupCnfgLastSetResult=backupCnfgLastSetResult, guiConfig=guiConfig, firmware=firmware, currSoftVersion=currSoftVersion, deviceConfiguration=deviceConfiguration, backupVersion=backupVersion, backupPath=backupPath, backupSetStatus=backupSetStatus, srvcSshEnable=srvcSshEnable, guiAppletConfig=guiAppletConfig, nextBootLastSetResult=nextBootLastSetResult, backupCnfgSetStatus=backupCnfgSetStatus, runCnfgSaveAs=runCnfgSaveAs, serviceConfig=serviceConfig, runCnfgLastSaveResult=runCnfgLastSaveResult, guiAppletSwVer=guiAppletSwVer)
