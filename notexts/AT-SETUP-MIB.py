...
mibBuilder.exportSymbols("AT-SETUP-MIB", firmware=firmware, srvcTelnetEnable=srvcTelnetEnable, nextBootFirmware=nextBootFirmware, bootCnfgPath=bootCnfgPath, nextBootSetStatus=nextBootSetStatus, runningConfig=runningConfig, currSoftVersion=currSoftVersion, defaultConfig=defaultConfig, runCnfgSaveAsStatus=runCnfgSaveAsStatus, guiAppletSwVer=guiAppletSwVer, currentFirmware=currentFirmware, restartStkMemberDevice=restartStkMemberDevice, backupLastSetResult=backupLastSetResult, nextBootConfig=nextBootConfig, backupCnfgExists=backupCnfgExists, runCnfgSaveAs=runCnfgSaveAs, currSoftSaveStatus=currSoftSaveStatus, serviceConfig=serviceConfig, backupConfig=backupConfig, backupCnfgPath=backupCnfgPath, runCnfgLastSaveResult=runCnfgLastSaveResult, currSoftSaveAs=currSoftSaveAs, backupCnfgLastSetResult=backupCnfgLastSetResult, nextBootPath=nextBootPath, nextBootVersion=nextBootVersion, dfltCnfgPath=dfltCnfgPath, nextBootLastSetResult=nextBootLastSetResult, srvcSshEnable=srvcSshEnable, backupCnfgSetStatus=backupCnfgSetStatus, backupVersion=backupVersion, SystemFileOperationType=SystemFileOperationType, bootCnfgSetStatus=bootCnfgSetStatus, guiConfig=guiConfig, PYSNMP_MODULE_ID=setup, bootCnfgExists=bootCnfgExists, guiAppletSysSwVer=guiAppletSysSwVer, currSoftName=currSoftName, deviceConfiguration=deviceConfiguration, currSoftSaveToFile=currSoftSaveToFile, dfltCnfgExists=dfltCnfgExists, currSoftLastSaveResult=currSoftLastSaveResult, restartDevice=restartDevice, backupFirmware=backupFirmware, backupSetStatus=backupSetStatus, bootCnfgLastSetResult=bootCnfgLastSetResult, guiAppletConfig=guiAppletConfig, backupPath=backupPath, setup=setup)
