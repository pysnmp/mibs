...
mibBuilder.exportSymbols("AT-SETUP-MIB", guiAppletSwVer=guiAppletSwVer, backupCnfgLastSetResult=backupCnfgLastSetResult, currSoftSaveAs=currSoftSaveAs, currSoftSaveToFile=currSoftSaveToFile, setup=setup, backupCnfgPath=backupCnfgPath, guiAppletConfig=guiAppletConfig, currentFirmware=currentFirmware, bootCnfgExists=bootCnfgExists, runCnfgSaveAsStatus=runCnfgSaveAsStatus, nextBootLastSetResult=nextBootLastSetResult, currSoftLastSaveResult=currSoftLastSaveResult, dfltCnfgPath=dfltCnfgPath, srvcTelnetEnable=srvcTelnetEnable, nextBootFirmware=nextBootFirmware, bootCnfgPath=bootCnfgPath, runCnfgSaveAs=runCnfgSaveAs, guiAppletSysSwVer=guiAppletSysSwVer, dfltCnfgExists=dfltCnfgExists, currSoftName=currSoftName, runCnfgLastSaveResult=runCnfgLastSaveResult, backupPath=backupPath, bootCnfgSetStatus=bootCnfgSetStatus, defaultConfig=defaultConfig, restartDevice=restartDevice, backupVersion=backupVersion, currSoftVersion=currSoftVersion, PYSNMP_MODULE_ID=setup, bootCnfgLastSetResult=bootCnfgLastSetResult, runningConfig=runningConfig, backupConfig=backupConfig, backupCnfgExists=backupCnfgExists, currSoftSaveStatus=currSoftSaveStatus, nextBootPath=nextBootPath, nextBootConfig=nextBootConfig, SystemFileOperationType=SystemFileOperationType, nextBootSetStatus=nextBootSetStatus, deviceConfiguration=deviceConfiguration, backupCnfgSetStatus=backupCnfgSetStatus, srvcSshEnable=srvcSshEnable, backupLastSetResult=backupLastSetResult, guiConfig=guiConfig, restartStkMemberDevice=restartStkMemberDevice, firmware=firmware, nextBootVersion=nextBootVersion, serviceConfig=serviceConfig, backupFirmware=backupFirmware, backupSetStatus=backupSetStatus)
