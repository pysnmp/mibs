...
mibBuilder.exportSymbols("AT-SETUP-MIB", bootCnfgPath=bootCnfgPath, dfltCnfgPath=dfltCnfgPath, guiConfig=guiConfig, nextBootSetStatus=nextBootSetStatus, guiAppletConfig=guiAppletConfig, runCnfgSaveAsStatus=runCnfgSaveAsStatus, backupFirmware=backupFirmware, backupVersion=backupVersion, PYSNMP_MODULE_ID=setup, srvcTelnetEnable=srvcTelnetEnable, currSoftSaveAs=currSoftSaveAs, dfltCnfgExists=dfltCnfgExists, runCnfgLastSaveResult=runCnfgLastSaveResult, restartStkMemberDevice=restartStkMemberDevice, srvcSshEnable=srvcSshEnable, backupConfig=backupConfig, backupCnfgPath=backupCnfgPath, nextBootLastSetResult=nextBootLastSetResult, SystemFileOperationType=SystemFileOperationType, runningConfig=runningConfig, currSoftSaveStatus=currSoftSaveStatus, restartDevice=restartDevice, backupLastSetResult=backupLastSetResult, runCnfgSaveAs=runCnfgSaveAs, setup=setup, backupCnfgLastSetResult=backupCnfgLastSetResult, nextBootPath=nextBootPath, nextBootFirmware=nextBootFirmware, firmware=firmware, currSoftVersion=currSoftVersion, currSoftLastSaveResult=currSoftLastSaveResult, nextBootVersion=nextBootVersion, nextBootConfig=nextBootConfig, currentFirmware=currentFirmware, defaultConfig=defaultConfig, backupCnfgSetStatus=backupCnfgSetStatus, currSoftSaveToFile=currSoftSaveToFile, backupPath=backupPath, currSoftName=currSoftName, serviceConfig=serviceConfig, deviceConfiguration=deviceConfiguration, guiAppletSwVer=guiAppletSwVer, backupSetStatus=backupSetStatus, bootCnfgLastSetResult=bootCnfgLastSetResult, guiAppletSysSwVer=guiAppletSysSwVer, bootCnfgExists=bootCnfgExists, backupCnfgExists=backupCnfgExists, bootCnfgSetStatus=bootCnfgSetStatus)
