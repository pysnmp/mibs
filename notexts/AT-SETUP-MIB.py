...
mibBuilder.exportSymbols("AT-SETUP-MIB", SystemFileOperationType=SystemFileOperationType, bootCnfgLastSetResult=bootCnfgLastSetResult, restartDevice=restartDevice, currSoftName=currSoftName, currSoftSaveToFile=currSoftSaveToFile, backupSetStatus=backupSetStatus, backupConfig=backupConfig, guiAppletSysSwVer=guiAppletSysSwVer, nextBootSetStatus=nextBootSetStatus, runCnfgLastSaveResult=runCnfgLastSaveResult, defaultConfig=defaultConfig, nextBootLastSetResult=nextBootLastSetResult, deviceConfiguration=deviceConfiguration, dfltCnfgPath=dfltCnfgPath, currSoftVersion=currSoftVersion, bootCnfgExists=bootCnfgExists, guiConfig=guiConfig, runCnfgSaveAsStatus=runCnfgSaveAsStatus, srvcTelnetEnable=srvcTelnetEnable, setup=setup, backupCnfgExists=backupCnfgExists, runCnfgSaveAs=runCnfgSaveAs, backupCnfgSetStatus=backupCnfgSetStatus, dfltCnfgExists=dfltCnfgExists, nextBootFirmware=nextBootFirmware, PYSNMP_MODULE_ID=setup, restartStkMemberDevice=restartStkMemberDevice, backupVersion=backupVersion, backupCnfgLastSetResult=backupCnfgLastSetResult, runningConfig=runningConfig, srvcSshEnable=srvcSshEnable, guiAppletSwVer=guiAppletSwVer, firmware=firmware, bootCnfgPath=bootCnfgPath, nextBootConfig=nextBootConfig, backupCnfgPath=backupCnfgPath, bootCnfgSetStatus=bootCnfgSetStatus, currSoftSaveAs=currSoftSaveAs, serviceConfig=serviceConfig, backupLastSetResult=backupLastSetResult, nextBootVersion=nextBootVersion, currSoftSaveStatus=currSoftSaveStatus, nextBootPath=nextBootPath, currSoftLastSaveResult=currSoftLastSaveResult, guiAppletConfig=guiAppletConfig, backupFirmware=backupFirmware, currentFirmware=currentFirmware, backupPath=backupPath)
