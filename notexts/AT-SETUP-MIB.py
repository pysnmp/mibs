...
mibBuilder.exportSymbols("AT-SETUP-MIB", nextBootPath=nextBootPath, dfltCnfgPath=dfltCnfgPath, currSoftVersion=currSoftVersion, nextBootLastSetResult=nextBootLastSetResult, firmware=firmware, restartDevice=restartDevice, deviceConfiguration=deviceConfiguration, guiAppletSwVer=guiAppletSwVer, backupCnfgLastSetResult=backupCnfgLastSetResult, nextBootSetStatus=nextBootSetStatus, backupSetStatus=backupSetStatus, runCnfgLastSaveResult=runCnfgLastSaveResult, guiAppletConfig=guiAppletConfig, currSoftLastSaveResult=currSoftLastSaveResult, bootCnfgLastSetResult=bootCnfgLastSetResult, currSoftSaveStatus=currSoftSaveStatus, setup=setup, defaultConfig=defaultConfig, currSoftSaveToFile=currSoftSaveToFile, runCnfgSaveAsStatus=runCnfgSaveAsStatus, nextBootVersion=nextBootVersion, PYSNMP_MODULE_ID=setup, currSoftSaveAs=currSoftSaveAs, bootCnfgExists=bootCnfgExists, nextBootConfig=nextBootConfig, bootCnfgSetStatus=bootCnfgSetStatus, runningConfig=runningConfig, guiConfig=guiConfig, nextBootFirmware=nextBootFirmware, srvcSshEnable=srvcSshEnable, backupCnfgSetStatus=backupCnfgSetStatus, backupCnfgPath=backupCnfgPath, backupVersion=backupVersion, backupConfig=backupConfig, dfltCnfgExists=dfltCnfgExists, currentFirmware=currentFirmware, runCnfgSaveAs=runCnfgSaveAs, backupCnfgExists=backupCnfgExists, srvcTelnetEnable=srvcTelnetEnable, backupLastSetResult=backupLastSetResult, SystemFileOperationType=SystemFileOperationType, serviceConfig=serviceConfig, backupPath=backupPath, guiAppletSysSwVer=guiAppletSysSwVer, backupFirmware=backupFirmware, currSoftName=currSoftName, restartStkMemberDevice=restartStkMemberDevice, bootCnfgPath=bootCnfgPath)
