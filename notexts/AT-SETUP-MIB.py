...
mibBuilder.exportSymbols("AT-SETUP-MIB", currSoftSaveToFile=currSoftSaveToFile, bootCnfgSetStatus=bootCnfgSetStatus, nextBootConfig=nextBootConfig, backupCnfgSetStatus=backupCnfgSetStatus, nextBootFirmware=nextBootFirmware, nextBootPath=nextBootPath, backupSetStatus=backupSetStatus, currSoftVersion=currSoftVersion, PYSNMP_MODULE_ID=setup, runCnfgSaveAsStatus=runCnfgSaveAsStatus, dfltCnfgPath=dfltCnfgPath, guiConfig=guiConfig, currSoftSaveAs=currSoftSaveAs, backupConfig=backupConfig, runningConfig=runningConfig, runCnfgLastSaveResult=runCnfgLastSaveResult, backupCnfgPath=backupCnfgPath, defaultConfig=defaultConfig, dfltCnfgExists=dfltCnfgExists, backupFirmware=backupFirmware, backupCnfgExists=backupCnfgExists, bootCnfgLastSetResult=bootCnfgLastSetResult, SystemFileOperationType=SystemFileOperationType, nextBootLastSetResult=nextBootLastSetResult, nextBootVersion=nextBootVersion, firmware=firmware, runCnfgSaveAs=runCnfgSaveAs, guiAppletSysSwVer=guiAppletSysSwVer, guiAppletSwVer=guiAppletSwVer, currSoftName=currSoftName, currSoftSaveStatus=currSoftSaveStatus, backupPath=backupPath, srvcSshEnable=srvcSshEnable, currSoftLastSaveResult=currSoftLastSaveResult, currentFirmware=currentFirmware, restartStkMemberDevice=restartStkMemberDevice, deviceConfiguration=deviceConfiguration, nextBootSetStatus=nextBootSetStatus, backupLastSetResult=backupLastSetResult, bootCnfgPath=bootCnfgPath, setup=setup, guiAppletConfig=guiAppletConfig, backupVersion=backupVersion, backupCnfgLastSetResult=backupCnfgLastSetResult, bootCnfgExists=bootCnfgExists, restartDevice=restartDevice, srvcTelnetEnable=srvcTelnetEnable, serviceConfig=serviceConfig)
