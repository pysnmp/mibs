...
mibBuilder.exportSymbols("AT-SETUP-MIB", bootCnfgPath=bootCnfgPath, srvcSshEnable=srvcSshEnable, srvcTelnetEnable=srvcTelnetEnable, runCnfgLastSaveResult=runCnfgLastSaveResult, backupVersion=backupVersion, bootCnfgLastSetResult=bootCnfgLastSetResult, guiAppletSwVer=guiAppletSwVer, defaultConfig=defaultConfig, bootCnfgExists=bootCnfgExists, backupCnfgExists=backupCnfgExists, PYSNMP_MODULE_ID=setup, backupSetStatus=backupSetStatus, runCnfgSaveAs=runCnfgSaveAs, SystemFileOperationType=SystemFileOperationType, nextBootSetStatus=nextBootSetStatus, currSoftSaveStatus=currSoftSaveStatus, backupCnfgSetStatus=backupCnfgSetStatus, guiConfig=guiConfig, currentFirmware=currentFirmware, setup=setup, nextBootVersion=nextBootVersion, backupCnfgPath=backupCnfgPath, runCnfgSaveAsStatus=runCnfgSaveAsStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, guiAppletConfig=guiAppletConfig, serviceConfig=serviceConfig, backupLastSetResult=backupLastSetResult, currSoftLastSaveResult=currSoftLastSaveResult, dfltCnfgPath=dfltCnfgPath, restartDevice=restartDevice, nextBootFirmware=nextBootFirmware, bootCnfgSetStatus=bootCnfgSetStatus, backupConfig=backupConfig, runningConfig=runningConfig, currSoftSaveAs=currSoftSaveAs, deviceConfiguration=deviceConfiguration, currSoftName=currSoftName, nextBootConfig=nextBootConfig, nextBootLastSetResult=nextBootLastSetResult, guiAppletSysSwVer=guiAppletSysSwVer, currSoftVersion=currSoftVersion, restartStkMemberDevice=restartStkMemberDevice, backupFirmware=backupFirmware, dfltCnfgExists=dfltCnfgExists, nextBootPath=nextBootPath, firmware=firmware, backupPath=backupPath, currSoftSaveToFile=currSoftSaveToFile)
