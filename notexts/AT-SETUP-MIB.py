...
mibBuilder.exportSymbols("AT-SETUP-MIB", runningConfig=runningConfig, srvcTelnetEnable=srvcTelnetEnable, defaultConfig=defaultConfig, PYSNMP_MODULE_ID=setup, dfltCnfgPath=dfltCnfgPath, bootCnfgPath=bootCnfgPath, runCnfgLastSaveResult=runCnfgLastSaveResult, bootCnfgSetStatus=bootCnfgSetStatus, guiAppletSysSwVer=guiAppletSysSwVer, backupCnfgLastSetResult=backupCnfgLastSetResult, guiAppletSwVer=guiAppletSwVer, backupSetStatus=backupSetStatus, currSoftSaveStatus=currSoftSaveStatus, srvcSshEnable=srvcSshEnable, currSoftSaveToFile=currSoftSaveToFile, backupPath=backupPath, firmware=firmware, currSoftSaveAs=currSoftSaveAs, deviceConfiguration=deviceConfiguration, backupLastSetResult=backupLastSetResult, runCnfgSaveAsStatus=runCnfgSaveAsStatus, backupConfig=backupConfig, guiConfig=guiConfig, runCnfgSaveAs=runCnfgSaveAs, restartDevice=restartDevice, currSoftLastSaveResult=currSoftLastSaveResult, backupCnfgSetStatus=backupCnfgSetStatus, backupCnfgExists=backupCnfgExists, backupVersion=backupVersion, dfltCnfgExists=dfltCnfgExists, nextBootFirmware=nextBootFirmware, nextBootVersion=nextBootVersion, backupFirmware=backupFirmware, nextBootSetStatus=nextBootSetStatus, nextBootPath=nextBootPath, guiAppletConfig=guiAppletConfig, nextBootConfig=nextBootConfig, currentFirmware=currentFirmware, bootCnfgExists=bootCnfgExists, currSoftName=currSoftName, bootCnfgLastSetResult=bootCnfgLastSetResult, setup=setup, restartStkMemberDevice=restartStkMemberDevice, serviceConfig=serviceConfig, SystemFileOperationType=SystemFileOperationType, currSoftVersion=currSoftVersion, backupCnfgPath=backupCnfgPath, nextBootLastSetResult=nextBootLastSetResult)
