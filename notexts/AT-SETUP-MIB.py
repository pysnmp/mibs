...
mibBuilder.exportSymbols("AT-SETUP-MIB", guiConfig=guiConfig, restartDevice=restartDevice, backupCnfgExists=backupCnfgExists, firmware=firmware, guiAppletSysSwVer=guiAppletSysSwVer, runCnfgLastSaveResult=runCnfgLastSaveResult, dfltCnfgPath=dfltCnfgPath, backupSetStatus=backupSetStatus, currSoftName=currSoftName, currSoftSaveStatus=currSoftSaveStatus, setup=setup, srvcSshEnable=srvcSshEnable, nextBootPath=nextBootPath, backupCnfgSetStatus=backupCnfgSetStatus, nextBootSetStatus=nextBootSetStatus, SystemFileOperationType=SystemFileOperationType, runCnfgSaveAs=runCnfgSaveAs, backupPath=backupPath, nextBootFirmware=nextBootFirmware, defaultConfig=defaultConfig, nextBootVersion=nextBootVersion, serviceConfig=serviceConfig, bootCnfgSetStatus=bootCnfgSetStatus, runningConfig=runningConfig, bootCnfgExists=bootCnfgExists, currSoftVersion=currSoftVersion, nextBootLastSetResult=nextBootLastSetResult, bootCnfgLastSetResult=bootCnfgLastSetResult, srvcTelnetEnable=srvcTelnetEnable, backupCnfgLastSetResult=backupCnfgLastSetResult, bootCnfgPath=bootCnfgPath, currSoftLastSaveResult=currSoftLastSaveResult, runCnfgSaveAsStatus=runCnfgSaveAsStatus, currSoftSaveAs=currSoftSaveAs, currentFirmware=currentFirmware, guiAppletConfig=guiAppletConfig, currSoftSaveToFile=currSoftSaveToFile, backupCnfgPath=backupCnfgPath, nextBootConfig=nextBootConfig, guiAppletSwVer=guiAppletSwVer, deviceConfiguration=deviceConfiguration, backupFirmware=backupFirmware, backupLastSetResult=backupLastSetResult, PYSNMP_MODULE_ID=setup, restartStkMemberDevice=restartStkMemberDevice, backupVersion=backupVersion, dfltCnfgExists=dfltCnfgExists, backupConfig=backupConfig)
