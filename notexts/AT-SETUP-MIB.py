...
mibBuilder.exportSymbols("AT-SETUP-MIB", currSoftName=currSoftName, currSoftSaveAs=currSoftSaveAs, runCnfgSaveAs=runCnfgSaveAs, backupSetStatus=backupSetStatus, guiAppletConfig=guiAppletConfig, nextBootPath=nextBootPath, currSoftLastSaveResult=currSoftLastSaveResult, dfltCnfgExists=dfltCnfgExists, currSoftSaveStatus=currSoftSaveStatus, restartDevice=restartDevice, backupCnfgPath=backupCnfgPath, guiConfig=guiConfig, bootCnfgLastSetResult=bootCnfgLastSetResult, SystemFileOperationType=SystemFileOperationType, bootCnfgSetStatus=bootCnfgSetStatus, runningConfig=runningConfig, runCnfgSaveAsStatus=runCnfgSaveAsStatus, nextBootSetStatus=nextBootSetStatus, backupVersion=backupVersion, setup=setup, PYSNMP_MODULE_ID=setup, restartStkMemberDevice=restartStkMemberDevice, nextBootFirmware=nextBootFirmware, nextBootVersion=nextBootVersion, backupPath=backupPath, bootCnfgPath=bootCnfgPath, bootCnfgExists=bootCnfgExists, runCnfgLastSaveResult=runCnfgLastSaveResult, backupConfig=backupConfig, dfltCnfgPath=dfltCnfgPath, serviceConfig=serviceConfig, firmware=firmware, srvcSshEnable=srvcSshEnable, guiAppletSwVer=guiAppletSwVer, defaultConfig=defaultConfig, srvcTelnetEnable=srvcTelnetEnable, nextBootConfig=nextBootConfig, nextBootLastSetResult=nextBootLastSetResult, currentFirmware=currentFirmware, backupCnfgLastSetResult=backupCnfgLastSetResult, backupLastSetResult=backupLastSetResult, currSoftVersion=currSoftVersion, currSoftSaveToFile=currSoftSaveToFile, backupCnfgExists=backupCnfgExists, guiAppletSysSwVer=guiAppletSysSwVer, backupCnfgSetStatus=backupCnfgSetStatus, backupFirmware=backupFirmware, deviceConfiguration=deviceConfiguration)
