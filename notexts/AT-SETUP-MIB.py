...
mibBuilder.exportSymbols("AT-SETUP-MIB", srvcSshEnable=srvcSshEnable, backupSetStatus=backupSetStatus, runCnfgLastSaveResult=runCnfgLastSaveResult, dfltCnfgExists=dfltCnfgExists, bootCnfgLastSetResult=bootCnfgLastSetResult, backupFirmware=backupFirmware, nextBootVersion=nextBootVersion, currSoftSaveToFile=currSoftSaveToFile, bootCnfgExists=bootCnfgExists, defaultConfig=defaultConfig, guiAppletSwVer=guiAppletSwVer, currSoftSaveAs=currSoftSaveAs, runCnfgSaveAs=runCnfgSaveAs, nextBootLastSetResult=nextBootLastSetResult, runCnfgSaveAsStatus=runCnfgSaveAsStatus, backupVersion=backupVersion, SystemFileOperationType=SystemFileOperationType, setup=setup, backupPath=backupPath, currSoftLastSaveResult=currSoftLastSaveResult, backupCnfgSetStatus=backupCnfgSetStatus, restartStkMemberDevice=restartStkMemberDevice, nextBootPath=nextBootPath, srvcTelnetEnable=srvcTelnetEnable, guiConfig=guiConfig, currSoftName=currSoftName, restartDevice=restartDevice, PYSNMP_MODULE_ID=setup, backupLastSetResult=backupLastSetResult, runningConfig=runningConfig, currentFirmware=currentFirmware, guiAppletSysSwVer=guiAppletSysSwVer, backupConfig=backupConfig, nextBootFirmware=nextBootFirmware, deviceConfiguration=deviceConfiguration, backupCnfgPath=backupCnfgPath, bootCnfgSetStatus=bootCnfgSetStatus, serviceConfig=serviceConfig, firmware=firmware, guiAppletConfig=guiAppletConfig, currSoftVersion=currSoftVersion, backupCnfgLastSetResult=backupCnfgLastSetResult, bootCnfgPath=bootCnfgPath, backupCnfgExists=backupCnfgExists, currSoftSaveStatus=currSoftSaveStatus, dfltCnfgPath=dfltCnfgPath, nextBootConfig=nextBootConfig, nextBootSetStatus=nextBootSetStatus)
