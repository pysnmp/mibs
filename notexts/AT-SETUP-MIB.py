...
mibBuilder.exportSymbols("AT-SETUP-MIB", backupCnfgExists=backupCnfgExists, serviceConfig=serviceConfig, guiConfig=guiConfig, restartDevice=restartDevice, nextBootFirmware=nextBootFirmware, SystemFileOperationType=SystemFileOperationType, deviceConfiguration=deviceConfiguration, guiAppletSysSwVer=guiAppletSysSwVer, bootCnfgPath=bootCnfgPath, bootCnfgExists=bootCnfgExists, firmware=firmware, runCnfgSaveAsStatus=runCnfgSaveAsStatus, PYSNMP_MODULE_ID=setup, runningConfig=runningConfig, backupConfig=backupConfig, restartStkMemberDevice=restartStkMemberDevice, bootCnfgLastSetResult=bootCnfgLastSetResult, backupVersion=backupVersion, nextBootLastSetResult=nextBootLastSetResult, srvcSshEnable=srvcSshEnable, currSoftSaveToFile=currSoftSaveToFile, nextBootSetStatus=nextBootSetStatus, runCnfgSaveAs=runCnfgSaveAs, currSoftVersion=currSoftVersion, currSoftSaveStatus=currSoftSaveStatus, defaultConfig=defaultConfig, backupCnfgPath=backupCnfgPath, currentFirmware=currentFirmware, currSoftLastSaveResult=currSoftLastSaveResult, backupPath=backupPath, backupSetStatus=backupSetStatus, currSoftSaveAs=currSoftSaveAs, nextBootConfig=nextBootConfig, backupCnfgLastSetResult=backupCnfgLastSetResult, backupFirmware=backupFirmware, nextBootVersion=nextBootVersion, guiAppletConfig=guiAppletConfig, guiAppletSwVer=guiAppletSwVer, backupCnfgSetStatus=backupCnfgSetStatus, setup=setup, dfltCnfgExists=dfltCnfgExists, srvcTelnetEnable=srvcTelnetEnable, currSoftName=currSoftName, nextBootPath=nextBootPath, bootCnfgSetStatus=bootCnfgSetStatus, dfltCnfgPath=dfltCnfgPath, runCnfgLastSaveResult=runCnfgLastSaveResult, backupLastSetResult=backupLastSetResult)
