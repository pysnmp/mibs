...
mibBuilder.exportSymbols("AT-SETUP-MIB", restartDevice=restartDevice, guiAppletSysSwVer=guiAppletSysSwVer, currSoftSaveAs=currSoftSaveAs, nextBootVersion=nextBootVersion, backupLastSetResult=backupLastSetResult, firmware=firmware, SystemFileOperationType=SystemFileOperationType, currSoftName=currSoftName, runningConfig=runningConfig, backupConfig=backupConfig, dfltCnfgExists=dfltCnfgExists, currSoftSaveToFile=currSoftSaveToFile, bootCnfgSetStatus=bootCnfgSetStatus, PYSNMP_MODULE_ID=setup, defaultConfig=defaultConfig, nextBootConfig=nextBootConfig, runCnfgSaveAsStatus=runCnfgSaveAsStatus, nextBootLastSetResult=nextBootLastSetResult, backupPath=backupPath, runCnfgSaveAs=runCnfgSaveAs, srvcTelnetEnable=srvcTelnetEnable, backupSetStatus=backupSetStatus, guiAppletConfig=guiAppletConfig, backupVersion=backupVersion, dfltCnfgPath=dfltCnfgPath, nextBootPath=nextBootPath, bootCnfgLastSetResult=bootCnfgLastSetResult, currSoftSaveStatus=currSoftSaveStatus, runCnfgLastSaveResult=runCnfgLastSaveResult, bootCnfgPath=bootCnfgPath, backupFirmware=backupFirmware, backupCnfgPath=backupCnfgPath, backupCnfgSetStatus=backupCnfgSetStatus, srvcSshEnable=srvcSshEnable, guiConfig=guiConfig, serviceConfig=serviceConfig, currSoftLastSaveResult=currSoftLastSaveResult, nextBootFirmware=nextBootFirmware, bootCnfgExists=bootCnfgExists, deviceConfiguration=deviceConfiguration, currentFirmware=currentFirmware, nextBootSetStatus=nextBootSetStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, currSoftVersion=currSoftVersion, setup=setup, backupCnfgExists=backupCnfgExists, guiAppletSwVer=guiAppletSwVer, restartStkMemberDevice=restartStkMemberDevice)
