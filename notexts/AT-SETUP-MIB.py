...
mibBuilder.exportSymbols("AT-SETUP-MIB", currentFirmware=currentFirmware, currSoftVersion=currSoftVersion, runningConfig=runningConfig, nextBootConfig=nextBootConfig, backupCnfgSetStatus=backupCnfgSetStatus, backupCnfgExists=backupCnfgExists, SystemFileOperationType=SystemFileOperationType, restartDevice=restartDevice, currSoftSaveAs=currSoftSaveAs, runCnfgSaveAs=runCnfgSaveAs, currSoftName=currSoftName, dfltCnfgPath=dfltCnfgPath, dfltCnfgExists=dfltCnfgExists, backupVersion=backupVersion, backupCnfgPath=backupCnfgPath, runCnfgLastSaveResult=runCnfgLastSaveResult, backupCnfgLastSetResult=backupCnfgLastSetResult, PYSNMP_MODULE_ID=setup, nextBootLastSetResult=nextBootLastSetResult, backupFirmware=backupFirmware, currSoftSaveStatus=currSoftSaveStatus, guiAppletConfig=guiAppletConfig, backupConfig=backupConfig, guiConfig=guiConfig, restartStkMemberDevice=restartStkMemberDevice, serviceConfig=serviceConfig, guiAppletSysSwVer=guiAppletSysSwVer, currSoftLastSaveResult=currSoftLastSaveResult, nextBootFirmware=nextBootFirmware, bootCnfgLastSetResult=bootCnfgLastSetResult, deviceConfiguration=deviceConfiguration, srvcTelnetEnable=srvcTelnetEnable, bootCnfgPath=bootCnfgPath, bootCnfgSetStatus=bootCnfgSetStatus, firmware=firmware, runCnfgSaveAsStatus=runCnfgSaveAsStatus, nextBootPath=nextBootPath, nextBootSetStatus=nextBootSetStatus, backupSetStatus=backupSetStatus, srvcSshEnable=srvcSshEnable, guiAppletSwVer=guiAppletSwVer, backupPath=backupPath, bootCnfgExists=bootCnfgExists, backupLastSetResult=backupLastSetResult, currSoftSaveToFile=currSoftSaveToFile, defaultConfig=defaultConfig, setup=setup, nextBootVersion=nextBootVersion)
