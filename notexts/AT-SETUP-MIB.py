...
mibBuilder.exportSymbols("AT-SETUP-MIB", currSoftSaveToFile=currSoftSaveToFile, runCnfgLastSaveResult=runCnfgLastSaveResult, backupVersion=backupVersion, runCnfgSaveAs=runCnfgSaveAs, dfltCnfgExists=dfltCnfgExists, bootCnfgLastSetResult=bootCnfgLastSetResult, guiAppletSwVer=guiAppletSwVer, bootCnfgPath=bootCnfgPath, backupSetStatus=backupSetStatus, bootCnfgSetStatus=bootCnfgSetStatus, srvcTelnetEnable=srvcTelnetEnable, backupCnfgExists=backupCnfgExists, runningConfig=runningConfig, currSoftSaveStatus=currSoftSaveStatus, backupPath=backupPath, backupFirmware=backupFirmware, nextBootPath=nextBootPath, currSoftVersion=currSoftVersion, nextBootFirmware=nextBootFirmware, firmware=firmware, setup=setup, currSoftSaveAs=currSoftSaveAs, currSoftLastSaveResult=currSoftLastSaveResult, PYSNMP_MODULE_ID=setup, SystemFileOperationType=SystemFileOperationType, backupCnfgSetStatus=backupCnfgSetStatus, backupCnfgPath=backupCnfgPath, serviceConfig=serviceConfig, nextBootVersion=nextBootVersion, dfltCnfgPath=dfltCnfgPath, restartStkMemberDevice=restartStkMemberDevice, nextBootLastSetResult=nextBootLastSetResult, nextBootConfig=nextBootConfig, restartDevice=restartDevice, currentFirmware=currentFirmware, defaultConfig=defaultConfig, backupConfig=backupConfig, srvcSshEnable=srvcSshEnable, guiAppletConfig=guiAppletConfig, guiAppletSysSwVer=guiAppletSysSwVer, nextBootSetStatus=nextBootSetStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, currSoftName=currSoftName, backupLastSetResult=backupLastSetResult, bootCnfgExists=bootCnfgExists, deviceConfiguration=deviceConfiguration, runCnfgSaveAsStatus=runCnfgSaveAsStatus, guiConfig=guiConfig)
