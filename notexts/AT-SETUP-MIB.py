...
mibBuilder.exportSymbols("AT-SETUP-MIB", nextBootLastSetResult=nextBootLastSetResult, backupCnfgExists=backupCnfgExists, guiAppletSwVer=guiAppletSwVer, bootCnfgExists=bootCnfgExists, currentFirmware=currentFirmware, currSoftName=currSoftName, guiAppletSysSwVer=guiAppletSysSwVer, currSoftLastSaveResult=currSoftLastSaveResult, deviceConfiguration=deviceConfiguration, guiAppletConfig=guiAppletConfig, firmware=firmware, currSoftSaveToFile=currSoftSaveToFile, runCnfgSaveAs=runCnfgSaveAs, nextBootFirmware=nextBootFirmware, backupCnfgPath=backupCnfgPath, backupSetStatus=backupSetStatus, currSoftSaveStatus=currSoftSaveStatus, backupVersion=backupVersion, serviceConfig=serviceConfig, srvcSshEnable=srvcSshEnable, nextBootVersion=nextBootVersion, backupLastSetResult=backupLastSetResult, setup=setup, nextBootConfig=nextBootConfig, currSoftVersion=currSoftVersion, dfltCnfgExists=dfltCnfgExists, currSoftSaveAs=currSoftSaveAs, backupCnfgLastSetResult=backupCnfgLastSetResult, PYSNMP_MODULE_ID=setup, nextBootPath=nextBootPath, restartStkMemberDevice=restartStkMemberDevice, runCnfgSaveAsStatus=runCnfgSaveAsStatus, bootCnfgSetStatus=bootCnfgSetStatus, bootCnfgLastSetResult=bootCnfgLastSetResult, defaultConfig=defaultConfig, restartDevice=restartDevice, bootCnfgPath=bootCnfgPath, dfltCnfgPath=dfltCnfgPath, srvcTelnetEnable=srvcTelnetEnable, runCnfgLastSaveResult=runCnfgLastSaveResult, backupFirmware=backupFirmware, backupConfig=backupConfig, backupCnfgSetStatus=backupCnfgSetStatus, runningConfig=runningConfig, guiConfig=guiConfig, nextBootSetStatus=nextBootSetStatus, backupPath=backupPath, SystemFileOperationType=SystemFileOperationType)
