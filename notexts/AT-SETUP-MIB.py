...
mibBuilder.exportSymbols("AT-SETUP-MIB", nextBootSetStatus=nextBootSetStatus, backupConfig=backupConfig, currSoftVersion=currSoftVersion, backupFirmware=backupFirmware, runCnfgSaveAsStatus=runCnfgSaveAsStatus, backupCnfgSetStatus=backupCnfgSetStatus, guiAppletSwVer=guiAppletSwVer, currSoftSaveAs=currSoftSaveAs, dfltCnfgPath=dfltCnfgPath, firmware=firmware, runningConfig=runningConfig, currSoftSaveToFile=currSoftSaveToFile, defaultConfig=defaultConfig, dfltCnfgExists=dfltCnfgExists, backupCnfgPath=backupCnfgPath, deviceConfiguration=deviceConfiguration, guiAppletSysSwVer=guiAppletSysSwVer, SystemFileOperationType=SystemFileOperationType, nextBootConfig=nextBootConfig, restartDevice=restartDevice, bootCnfgPath=bootCnfgPath, bootCnfgLastSetResult=bootCnfgLastSetResult, currSoftLastSaveResult=currSoftLastSaveResult, PYSNMP_MODULE_ID=setup, backupVersion=backupVersion, setup=setup, nextBootPath=nextBootPath, bootCnfgExists=bootCnfgExists, srvcTelnetEnable=srvcTelnetEnable, bootCnfgSetStatus=bootCnfgSetStatus, currentFirmware=currentFirmware, backupSetStatus=backupSetStatus, srvcSshEnable=srvcSshEnable, currSoftName=currSoftName, nextBootFirmware=nextBootFirmware, guiConfig=guiConfig, runCnfgSaveAs=runCnfgSaveAs, runCnfgLastSaveResult=runCnfgLastSaveResult, serviceConfig=serviceConfig, restartStkMemberDevice=restartStkMemberDevice, nextBootLastSetResult=nextBootLastSetResult, backupLastSetResult=backupLastSetResult, backupCnfgLastSetResult=backupCnfgLastSetResult, currSoftSaveStatus=currSoftSaveStatus, backupPath=backupPath, backupCnfgExists=backupCnfgExists, guiAppletConfig=guiAppletConfig, nextBootVersion=nextBootVersion)
