...
mibBuilder.exportSymbols("AT-SETUP-MIB", currSoftLastSaveResult=currSoftLastSaveResult, bootCnfgPath=bootCnfgPath, guiAppletConfig=guiAppletConfig, PYSNMP_MODULE_ID=setup, runningConfig=runningConfig, backupCnfgSetStatus=backupCnfgSetStatus, guiAppletSwVer=guiAppletSwVer, currSoftSaveToFile=currSoftSaveToFile, guiAppletSysSwVer=guiAppletSysSwVer, nextBootLastSetResult=nextBootLastSetResult, nextBootFirmware=nextBootFirmware, currSoftSaveStatus=currSoftSaveStatus, nextBootSetStatus=nextBootSetStatus, backupSetStatus=backupSetStatus, restartStkMemberDevice=restartStkMemberDevice, runCnfgSaveAs=runCnfgSaveAs, bootCnfgLastSetResult=bootCnfgLastSetResult, currSoftName=currSoftName, currSoftVersion=currSoftVersion, defaultConfig=defaultConfig, serviceConfig=serviceConfig, nextBootVersion=nextBootVersion, backupVersion=backupVersion, currSoftSaveAs=currSoftSaveAs, backupFirmware=backupFirmware, restartDevice=restartDevice, runCnfgLastSaveResult=runCnfgLastSaveResult, SystemFileOperationType=SystemFileOperationType, backupCnfgPath=backupCnfgPath, setup=setup, currentFirmware=currentFirmware, backupCnfgExists=backupCnfgExists, srvcSshEnable=srvcSshEnable, guiConfig=guiConfig, deviceConfiguration=deviceConfiguration, bootCnfgExists=bootCnfgExists, srvcTelnetEnable=srvcTelnetEnable, backupConfig=backupConfig, dfltCnfgPath=dfltCnfgPath, nextBootPath=nextBootPath, backupCnfgLastSetResult=backupCnfgLastSetResult, bootCnfgSetStatus=bootCnfgSetStatus, nextBootConfig=nextBootConfig, backupLastSetResult=backupLastSetResult, runCnfgSaveAsStatus=runCnfgSaveAsStatus, dfltCnfgExists=dfltCnfgExists, backupPath=backupPath, firmware=firmware)
