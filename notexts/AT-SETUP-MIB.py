...
mibBuilder.exportSymbols("AT-SETUP-MIB", backupSetStatus=backupSetStatus, PYSNMP_MODULE_ID=setup, restartDevice=restartDevice, restartStkMemberDevice=restartStkMemberDevice, currSoftName=currSoftName, setup=setup, firmware=firmware, bootCnfgPath=bootCnfgPath, backupCnfgLastSetResult=backupCnfgLastSetResult, backupVersion=backupVersion, currSoftSaveToFile=currSoftSaveToFile, guiAppletSwVer=guiAppletSwVer, deviceConfiguration=deviceConfiguration, backupFirmware=backupFirmware, currentFirmware=currentFirmware, srvcSshEnable=srvcSshEnable, backupLastSetResult=backupLastSetResult, nextBootConfig=nextBootConfig, currSoftSaveStatus=currSoftSaveStatus, nextBootLastSetResult=nextBootLastSetResult, backupCnfgPath=backupCnfgPath, guiConfig=guiConfig, backupCnfgSetStatus=backupCnfgSetStatus, srvcTelnetEnable=srvcTelnetEnable, SystemFileOperationType=SystemFileOperationType, nextBootFirmware=nextBootFirmware, runCnfgSaveAsStatus=runCnfgSaveAsStatus, bootCnfgSetStatus=bootCnfgSetStatus, backupCnfgExists=backupCnfgExists, guiAppletSysSwVer=guiAppletSysSwVer, nextBootVersion=nextBootVersion, currSoftSaveAs=currSoftSaveAs, runningConfig=runningConfig, defaultConfig=defaultConfig, currSoftLastSaveResult=currSoftLastSaveResult, dfltCnfgExists=dfltCnfgExists, nextBootSetStatus=nextBootSetStatus, serviceConfig=serviceConfig, bootCnfgLastSetResult=bootCnfgLastSetResult, runCnfgSaveAs=runCnfgSaveAs, backupConfig=backupConfig, backupPath=backupPath, nextBootPath=nextBootPath, guiAppletConfig=guiAppletConfig, bootCnfgExists=bootCnfgExists, dfltCnfgPath=dfltCnfgPath, runCnfgLastSaveResult=runCnfgLastSaveResult, currSoftVersion=currSoftVersion)
