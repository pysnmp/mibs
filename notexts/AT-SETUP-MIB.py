...
mibBuilder.exportSymbols("AT-SETUP-MIB", nextBootVersion=nextBootVersion, currSoftLastSaveResult=currSoftLastSaveResult, backupCnfgSetStatus=backupCnfgSetStatus, currSoftSaveAs=currSoftSaveAs, guiConfig=guiConfig, guiAppletSwVer=guiAppletSwVer, setup=setup, nextBootFirmware=nextBootFirmware, dfltCnfgPath=dfltCnfgPath, runningConfig=runningConfig, currSoftVersion=currSoftVersion, bootCnfgSetStatus=bootCnfgSetStatus, PYSNMP_MODULE_ID=setup, currSoftSaveToFile=currSoftSaveToFile, backupCnfgPath=backupCnfgPath, currSoftSaveStatus=currSoftSaveStatus, defaultConfig=defaultConfig, dfltCnfgExists=dfltCnfgExists, currSoftName=currSoftName, nextBootPath=nextBootPath, runCnfgSaveAs=runCnfgSaveAs, bootCnfgExists=bootCnfgExists, backupLastSetResult=backupLastSetResult, srvcTelnetEnable=srvcTelnetEnable, guiAppletConfig=guiAppletConfig, guiAppletSysSwVer=guiAppletSysSwVer, bootCnfgLastSetResult=bootCnfgLastSetResult, backupPath=backupPath, bootCnfgPath=bootCnfgPath, nextBootConfig=nextBootConfig, backupFirmware=backupFirmware, backupVersion=backupVersion, nextBootLastSetResult=nextBootLastSetResult, serviceConfig=serviceConfig, currentFirmware=currentFirmware, backupSetStatus=backupSetStatus, srvcSshEnable=srvcSshEnable, runCnfgSaveAsStatus=runCnfgSaveAsStatus, SystemFileOperationType=SystemFileOperationType, backupCnfgExists=backupCnfgExists, nextBootSetStatus=nextBootSetStatus, backupConfig=backupConfig, backupCnfgLastSetResult=backupCnfgLastSetResult, deviceConfiguration=deviceConfiguration, firmware=firmware, restartStkMemberDevice=restartStkMemberDevice, runCnfgLastSaveResult=runCnfgLastSaveResult, restartDevice=restartDevice)
