...
mibBuilder.exportSymbols("AT-SETUP-MIB", nextBootConfig=nextBootConfig, srvcSshEnable=srvcSshEnable, SystemFileOperationType=SystemFileOperationType, setup=setup, dfltCnfgExists=dfltCnfgExists, backupPath=backupPath, bootCnfgExists=bootCnfgExists, backupConfig=backupConfig, currSoftName=currSoftName, firmware=firmware, currSoftSaveToFile=currSoftSaveToFile, runningConfig=runningConfig, currSoftSaveStatus=currSoftSaveStatus, nextBootLastSetResult=nextBootLastSetResult, bootCnfgPath=bootCnfgPath, currSoftSaveAs=currSoftSaveAs, nextBootSetStatus=nextBootSetStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, restartDevice=restartDevice, srvcTelnetEnable=srvcTelnetEnable, guiAppletSwVer=guiAppletSwVer, backupFirmware=backupFirmware, backupCnfgExists=backupCnfgExists, backupCnfgPath=backupCnfgPath, bootCnfgLastSetResult=bootCnfgLastSetResult, defaultConfig=defaultConfig, backupSetStatus=backupSetStatus, serviceConfig=serviceConfig, backupLastSetResult=backupLastSetResult, runCnfgSaveAsStatus=runCnfgSaveAsStatus, guiAppletConfig=guiAppletConfig, dfltCnfgPath=dfltCnfgPath, backupCnfgSetStatus=backupCnfgSetStatus, runCnfgSaveAs=runCnfgSaveAs, bootCnfgSetStatus=bootCnfgSetStatus, currentFirmware=currentFirmware, backupVersion=backupVersion, guiAppletSysSwVer=guiAppletSysSwVer, runCnfgLastSaveResult=runCnfgLastSaveResult, nextBootPath=nextBootPath, guiConfig=guiConfig, PYSNMP_MODULE_ID=setup, currSoftVersion=currSoftVersion, currSoftLastSaveResult=currSoftLastSaveResult, nextBootFirmware=nextBootFirmware, nextBootVersion=nextBootVersion, deviceConfiguration=deviceConfiguration, restartStkMemberDevice=restartStkMemberDevice)
