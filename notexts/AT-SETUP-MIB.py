...
mibBuilder.exportSymbols("AT-SETUP-MIB", currentFirmware=currentFirmware, guiAppletConfig=guiAppletConfig, bootCnfgPath=bootCnfgPath, backupLastSetResult=backupLastSetResult, nextBootSetStatus=nextBootSetStatus, serviceConfig=serviceConfig, srvcTelnetEnable=srvcTelnetEnable, guiAppletSwVer=guiAppletSwVer, dfltCnfgPath=dfltCnfgPath, nextBootFirmware=nextBootFirmware, runCnfgSaveAs=runCnfgSaveAs, backupPath=backupPath, nextBootConfig=nextBootConfig, backupVersion=backupVersion, srvcSshEnable=srvcSshEnable, bootCnfgLastSetResult=bootCnfgLastSetResult, backupCnfgLastSetResult=backupCnfgLastSetResult, currSoftName=currSoftName, backupSetStatus=backupSetStatus, bootCnfgExists=bootCnfgExists, backupCnfgSetStatus=backupCnfgSetStatus, currSoftSaveStatus=currSoftSaveStatus, runCnfgLastSaveResult=runCnfgLastSaveResult, backupCnfgExists=backupCnfgExists, PYSNMP_MODULE_ID=setup, dfltCnfgExists=dfltCnfgExists, backupCnfgPath=backupCnfgPath, restartStkMemberDevice=restartStkMemberDevice, defaultConfig=defaultConfig, backupConfig=backupConfig, guiAppletSysSwVer=guiAppletSysSwVer, backupFirmware=backupFirmware, runningConfig=runningConfig, restartDevice=restartDevice, currSoftVersion=currSoftVersion, nextBootLastSetResult=nextBootLastSetResult, currSoftLastSaveResult=currSoftLastSaveResult, nextBootPath=nextBootPath, bootCnfgSetStatus=bootCnfgSetStatus, SystemFileOperationType=SystemFileOperationType, deviceConfiguration=deviceConfiguration, nextBootVersion=nextBootVersion, setup=setup, runCnfgSaveAsStatus=runCnfgSaveAsStatus, firmware=firmware, currSoftSaveAs=currSoftSaveAs, currSoftSaveToFile=currSoftSaveToFile, guiConfig=guiConfig)
