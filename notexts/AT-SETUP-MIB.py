...
mibBuilder.exportSymbols("AT-SETUP-MIB", backupVersion=backupVersion, runCnfgLastSaveResult=runCnfgLastSaveResult, dfltCnfgExists=dfltCnfgExists, currSoftSaveToFile=currSoftSaveToFile, runCnfgSaveAsStatus=runCnfgSaveAsStatus, backupFirmware=backupFirmware, bootCnfgLastSetResult=bootCnfgLastSetResult, nextBootConfig=nextBootConfig, dfltCnfgPath=dfltCnfgPath, firmware=firmware, runningConfig=runningConfig, restartDevice=restartDevice, guiConfig=guiConfig, nextBootLastSetResult=nextBootLastSetResult, guiAppletConfig=guiAppletConfig, nextBootFirmware=nextBootFirmware, defaultConfig=defaultConfig, backupCnfgPath=backupCnfgPath, backupCnfgLastSetResult=backupCnfgLastSetResult, currSoftSaveStatus=currSoftSaveStatus, currSoftLastSaveResult=currSoftLastSaveResult, backupPath=backupPath, backupConfig=backupConfig, srvcTelnetEnable=srvcTelnetEnable, deviceConfiguration=deviceConfiguration, guiAppletSwVer=guiAppletSwVer, PYSNMP_MODULE_ID=setup, currentFirmware=currentFirmware, backupCnfgExists=backupCnfgExists, bootCnfgPath=bootCnfgPath, currSoftName=currSoftName, bootCnfgExists=bootCnfgExists, nextBootSetStatus=nextBootSetStatus, currSoftVersion=currSoftVersion, setup=setup, currSoftSaveAs=currSoftSaveAs, backupSetStatus=backupSetStatus, backupCnfgSetStatus=backupCnfgSetStatus, bootCnfgSetStatus=bootCnfgSetStatus, nextBootPath=nextBootPath, srvcSshEnable=srvcSshEnable, nextBootVersion=nextBootVersion, runCnfgSaveAs=runCnfgSaveAs, SystemFileOperationType=SystemFileOperationType, serviceConfig=serviceConfig, restartStkMemberDevice=restartStkMemberDevice, backupLastSetResult=backupLastSetResult, guiAppletSysSwVer=guiAppletSysSwVer)
