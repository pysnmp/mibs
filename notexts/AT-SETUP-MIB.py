...
mibBuilder.exportSymbols("AT-SETUP-MIB", backupVersion=backupVersion, runCnfgSaveAs=runCnfgSaveAs, backupCnfgPath=backupCnfgPath, bootCnfgExists=bootCnfgExists, PYSNMP_MODULE_ID=setup, runningConfig=runningConfig, currSoftSaveStatus=currSoftSaveStatus, runCnfgLastSaveResult=runCnfgLastSaveResult, dfltCnfgExists=dfltCnfgExists, restartDevice=restartDevice, backupLastSetResult=backupLastSetResult, backupFirmware=backupFirmware, guiAppletSysSwVer=guiAppletSysSwVer, backupPath=backupPath, bootCnfgLastSetResult=bootCnfgLastSetResult, firmware=firmware, currSoftSaveToFile=currSoftSaveToFile, nextBootLastSetResult=nextBootLastSetResult, nextBootConfig=nextBootConfig, backupCnfgExists=backupCnfgExists, nextBootPath=nextBootPath, bootCnfgPath=bootCnfgPath, backupCnfgLastSetResult=backupCnfgLastSetResult, serviceConfig=serviceConfig, currentFirmware=currentFirmware, deviceConfiguration=deviceConfiguration, currSoftName=currSoftName, bootCnfgSetStatus=bootCnfgSetStatus, backupCnfgSetStatus=backupCnfgSetStatus, currSoftSaveAs=currSoftSaveAs, dfltCnfgPath=dfltCnfgPath, nextBootVersion=nextBootVersion, runCnfgSaveAsStatus=runCnfgSaveAsStatus, nextBootFirmware=nextBootFirmware, backupSetStatus=backupSetStatus, srvcSshEnable=srvcSshEnable, backupConfig=backupConfig, currSoftVersion=currSoftVersion, guiAppletSwVer=guiAppletSwVer, guiConfig=guiConfig, currSoftLastSaveResult=currSoftLastSaveResult, restartStkMemberDevice=restartStkMemberDevice, defaultConfig=defaultConfig, SystemFileOperationType=SystemFileOperationType, nextBootSetStatus=nextBootSetStatus, guiAppletConfig=guiAppletConfig, setup=setup, srvcTelnetEnable=srvcTelnetEnable)
