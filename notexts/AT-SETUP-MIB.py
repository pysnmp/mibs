...
mibBuilder.exportSymbols("AT-SETUP-MIB", nextBootConfig=nextBootConfig, dfltCnfgExists=dfltCnfgExists, guiAppletSysSwVer=guiAppletSysSwVer, currSoftSaveAs=currSoftSaveAs, guiConfig=guiConfig, runCnfgSaveAsStatus=runCnfgSaveAsStatus, currSoftSaveToFile=currSoftSaveToFile, backupLastSetResult=backupLastSetResult, runCnfgLastSaveResult=runCnfgLastSaveResult, bootCnfgExists=bootCnfgExists, nextBootLastSetResult=nextBootLastSetResult, bootCnfgPath=bootCnfgPath, serviceConfig=serviceConfig, currSoftVersion=currSoftVersion, bootCnfgSetStatus=bootCnfgSetStatus, SystemFileOperationType=SystemFileOperationType, nextBootFirmware=nextBootFirmware, backupPath=backupPath, dfltCnfgPath=dfltCnfgPath, backupCnfgExists=backupCnfgExists, nextBootVersion=nextBootVersion, bootCnfgLastSetResult=bootCnfgLastSetResult, srvcSshEnable=srvcSshEnable, backupVersion=backupVersion, backupCnfgSetStatus=backupCnfgSetStatus, guiAppletSwVer=guiAppletSwVer, deviceConfiguration=deviceConfiguration, currSoftName=currSoftName, firmware=firmware, backupSetStatus=backupSetStatus, currSoftSaveStatus=currSoftSaveStatus, defaultConfig=defaultConfig, currSoftLastSaveResult=currSoftLastSaveResult, PYSNMP_MODULE_ID=setup, nextBootPath=nextBootPath, runningConfig=runningConfig, restartStkMemberDevice=restartStkMemberDevice, currentFirmware=currentFirmware, runCnfgSaveAs=runCnfgSaveAs, backupCnfgLastSetResult=backupCnfgLastSetResult, nextBootSetStatus=nextBootSetStatus, backupCnfgPath=backupCnfgPath, backupConfig=backupConfig, srvcTelnetEnable=srvcTelnetEnable, backupFirmware=backupFirmware, guiAppletConfig=guiAppletConfig, setup=setup, restartDevice=restartDevice)
