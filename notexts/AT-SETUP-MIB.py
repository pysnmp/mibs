...
mibBuilder.exportSymbols("AT-SETUP-MIB", currSoftSaveAs=currSoftSaveAs, backupSetStatus=backupSetStatus, deviceConfiguration=deviceConfiguration, currSoftLastSaveResult=currSoftLastSaveResult, currSoftSaveStatus=currSoftSaveStatus, bootCnfgLastSetResult=bootCnfgLastSetResult, restartDevice=restartDevice, dfltCnfgPath=dfltCnfgPath, guiAppletSysSwVer=guiAppletSysSwVer, runCnfgSaveAsStatus=runCnfgSaveAsStatus, defaultConfig=defaultConfig, nextBootVersion=nextBootVersion, bootCnfgPath=bootCnfgPath, nextBootLastSetResult=nextBootLastSetResult, backupLastSetResult=backupLastSetResult, nextBootSetStatus=nextBootSetStatus, runningConfig=runningConfig, backupCnfgPath=backupCnfgPath, backupCnfgSetStatus=backupCnfgSetStatus, currSoftVersion=currSoftVersion, backupFirmware=backupFirmware, srvcTelnetEnable=srvcTelnetEnable, firmware=firmware, runCnfgSaveAs=runCnfgSaveAs, bootCnfgExists=bootCnfgExists, serviceConfig=serviceConfig, currSoftSaveToFile=currSoftSaveToFile, runCnfgLastSaveResult=runCnfgLastSaveResult, PYSNMP_MODULE_ID=setup, currSoftName=currSoftName, guiConfig=guiConfig, guiAppletConfig=guiAppletConfig, restartStkMemberDevice=restartStkMemberDevice, SystemFileOperationType=SystemFileOperationType, backupConfig=backupConfig, dfltCnfgExists=dfltCnfgExists, nextBootConfig=nextBootConfig, backupPath=backupPath, bootCnfgSetStatus=bootCnfgSetStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, backupVersion=backupVersion, srvcSshEnable=srvcSshEnable, nextBootFirmware=nextBootFirmware, guiAppletSwVer=guiAppletSwVer, backupCnfgExists=backupCnfgExists, currentFirmware=currentFirmware, nextBootPath=nextBootPath, setup=setup)
