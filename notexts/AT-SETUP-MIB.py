...
mibBuilder.exportSymbols("AT-SETUP-MIB", nextBootSetStatus=nextBootSetStatus, nextBootPath=nextBootPath, restartStkMemberDevice=restartStkMemberDevice, backupVersion=backupVersion, backupLastSetResult=backupLastSetResult, runCnfgLastSaveResult=runCnfgLastSaveResult, backupCnfgSetStatus=backupCnfgSetStatus, guiConfig=guiConfig, guiAppletSwVer=guiAppletSwVer, nextBootVersion=nextBootVersion, guiAppletConfig=guiAppletConfig, backupFirmware=backupFirmware, bootCnfgExists=bootCnfgExists, backupPath=backupPath, backupCnfgLastSetResult=backupCnfgLastSetResult, srvcSshEnable=srvcSshEnable, bootCnfgPath=bootCnfgPath, guiAppletSysSwVer=guiAppletSysSwVer, deviceConfiguration=deviceConfiguration, serviceConfig=serviceConfig, backupCnfgExists=backupCnfgExists, currentFirmware=currentFirmware, PYSNMP_MODULE_ID=setup, currSoftSaveAs=currSoftSaveAs, nextBootFirmware=nextBootFirmware, nextBootLastSetResult=nextBootLastSetResult, currSoftSaveStatus=currSoftSaveStatus, currSoftVersion=currSoftVersion, runCnfgSaveAs=runCnfgSaveAs, nextBootConfig=nextBootConfig, dfltCnfgExists=dfltCnfgExists, defaultConfig=defaultConfig, backupConfig=backupConfig, srvcTelnetEnable=srvcTelnetEnable, bootCnfgSetStatus=bootCnfgSetStatus, dfltCnfgPath=dfltCnfgPath, backupCnfgPath=backupCnfgPath, setup=setup, currSoftSaveToFile=currSoftSaveToFile, restartDevice=restartDevice, currSoftLastSaveResult=currSoftLastSaveResult, backupSetStatus=backupSetStatus, currSoftName=currSoftName, bootCnfgLastSetResult=bootCnfgLastSetResult, SystemFileOperationType=SystemFileOperationType, runCnfgSaveAsStatus=runCnfgSaveAsStatus, firmware=firmware, runningConfig=runningConfig)
