...
mibBuilder.exportSymbols("AT-SETUP-MIB", runCnfgLastSaveResult=runCnfgLastSaveResult, firmware=firmware, currSoftSaveToFile=currSoftSaveToFile, runCnfgSaveAs=runCnfgSaveAs, nextBootVersion=nextBootVersion, srvcTelnetEnable=srvcTelnetEnable, bootCnfgPath=bootCnfgPath, serviceConfig=serviceConfig, bootCnfgSetStatus=bootCnfgSetStatus, defaultConfig=defaultConfig, dfltCnfgExists=dfltCnfgExists, backupCnfgSetStatus=backupCnfgSetStatus, nextBootSetStatus=nextBootSetStatus, backupSetStatus=backupSetStatus, currSoftVersion=currSoftVersion, nextBootPath=nextBootPath, guiConfig=guiConfig, nextBootLastSetResult=nextBootLastSetResult, backupConfig=backupConfig, backupCnfgPath=backupCnfgPath, guiAppletSysSwVer=guiAppletSysSwVer, srvcSshEnable=srvcSshEnable, backupPath=backupPath, guiAppletConfig=guiAppletConfig, runningConfig=runningConfig, SystemFileOperationType=SystemFileOperationType, deviceConfiguration=deviceConfiguration, backupLastSetResult=backupLastSetResult, runCnfgSaveAsStatus=runCnfgSaveAsStatus, nextBootConfig=nextBootConfig, PYSNMP_MODULE_ID=setup, dfltCnfgPath=dfltCnfgPath, currSoftSaveStatus=currSoftSaveStatus, backupFirmware=backupFirmware, bootCnfgLastSetResult=bootCnfgLastSetResult, currSoftName=currSoftName, currSoftSaveAs=currSoftSaveAs, backupCnfgLastSetResult=backupCnfgLastSetResult, currentFirmware=currentFirmware, backupVersion=backupVersion, restartStkMemberDevice=restartStkMemberDevice, guiAppletSwVer=guiAppletSwVer, setup=setup, currSoftLastSaveResult=currSoftLastSaveResult, bootCnfgExists=bootCnfgExists, backupCnfgExists=backupCnfgExists, nextBootFirmware=nextBootFirmware, restartDevice=restartDevice)
