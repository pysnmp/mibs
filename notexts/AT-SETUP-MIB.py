...
mibBuilder.exportSymbols("AT-SETUP-MIB", backupCnfgExists=backupCnfgExists, currSoftSaveAs=currSoftSaveAs, backupFirmware=backupFirmware, backupSetStatus=backupSetStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, runCnfgLastSaveResult=runCnfgLastSaveResult, nextBootSetStatus=nextBootSetStatus, srvcSshEnable=srvcSshEnable, setup=setup, srvcTelnetEnable=srvcTelnetEnable, runningConfig=runningConfig, PYSNMP_MODULE_ID=setup, currSoftSaveStatus=currSoftSaveStatus, currSoftName=currSoftName, bootCnfgLastSetResult=bootCnfgLastSetResult, bootCnfgSetStatus=bootCnfgSetStatus, currSoftSaveToFile=currSoftSaveToFile, bootCnfgPath=bootCnfgPath, nextBootPath=nextBootPath, nextBootFirmware=nextBootFirmware, firmware=firmware, backupPath=backupPath, nextBootVersion=nextBootVersion, guiAppletSwVer=guiAppletSwVer, nextBootLastSetResult=nextBootLastSetResult, currSoftLastSaveResult=currSoftLastSaveResult, nextBootConfig=nextBootConfig, guiAppletConfig=guiAppletConfig, SystemFileOperationType=SystemFileOperationType, runCnfgSaveAsStatus=runCnfgSaveAsStatus, dfltCnfgPath=dfltCnfgPath, restartDevice=restartDevice, backupLastSetResult=backupLastSetResult, restartStkMemberDevice=restartStkMemberDevice, backupCnfgPath=backupCnfgPath, serviceConfig=serviceConfig, currSoftVersion=currSoftVersion, backupVersion=backupVersion, deviceConfiguration=deviceConfiguration, runCnfgSaveAs=runCnfgSaveAs, guiAppletSysSwVer=guiAppletSysSwVer, backupCnfgSetStatus=backupCnfgSetStatus, guiConfig=guiConfig, currentFirmware=currentFirmware, backupConfig=backupConfig, defaultConfig=defaultConfig, bootCnfgExists=bootCnfgExists, dfltCnfgExists=dfltCnfgExists)
