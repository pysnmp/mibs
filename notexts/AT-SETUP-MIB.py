...
mibBuilder.exportSymbols("AT-SETUP-MIB", SystemFileOperationType=SystemFileOperationType, setup=setup, dfltCnfgExists=dfltCnfgExists, backupCnfgLastSetResult=backupCnfgLastSetResult, currSoftSaveStatus=currSoftSaveStatus, firmware=firmware, currSoftSaveToFile=currSoftSaveToFile, nextBootPath=nextBootPath, deviceConfiguration=deviceConfiguration, nextBootVersion=nextBootVersion, srvcTelnetEnable=srvcTelnetEnable, guiConfig=guiConfig, bootCnfgExists=bootCnfgExists, dfltCnfgPath=dfltCnfgPath, nextBootSetStatus=nextBootSetStatus, nextBootFirmware=nextBootFirmware, nextBootLastSetResult=nextBootLastSetResult, backupSetStatus=backupSetStatus, currSoftName=currSoftName, currSoftVersion=currSoftVersion, backupVersion=backupVersion, bootCnfgSetStatus=bootCnfgSetStatus, srvcSshEnable=srvcSshEnable, guiAppletSysSwVer=guiAppletSysSwVer, backupLastSetResult=backupLastSetResult, runCnfgSaveAs=runCnfgSaveAs, runCnfgLastSaveResult=runCnfgLastSaveResult, restartStkMemberDevice=restartStkMemberDevice, PYSNMP_MODULE_ID=setup, guiAppletConfig=guiAppletConfig, backupCnfgExists=backupCnfgExists, currentFirmware=currentFirmware, runningConfig=runningConfig, restartDevice=restartDevice, serviceConfig=serviceConfig, backupConfig=backupConfig, backupCnfgPath=backupCnfgPath, nextBootConfig=nextBootConfig, defaultConfig=defaultConfig, currSoftSaveAs=currSoftSaveAs, bootCnfgLastSetResult=bootCnfgLastSetResult, currSoftLastSaveResult=currSoftLastSaveResult, guiAppletSwVer=guiAppletSwVer, backupFirmware=backupFirmware, backupCnfgSetStatus=backupCnfgSetStatus, backupPath=backupPath, runCnfgSaveAsStatus=runCnfgSaveAsStatus, bootCnfgPath=bootCnfgPath)
