...
mibBuilder.exportSymbols("AT-SETUP-MIB", nextBootConfig=nextBootConfig, defaultConfig=defaultConfig, runCnfgSaveAsStatus=runCnfgSaveAsStatus, bootCnfgPath=bootCnfgPath, currSoftSaveStatus=currSoftSaveStatus, guiAppletSwVer=guiAppletSwVer, restartDevice=restartDevice, srvcSshEnable=srvcSshEnable, setup=setup, backupCnfgLastSetResult=backupCnfgLastSetResult, backupCnfgExists=backupCnfgExists, bootCnfgLastSetResult=bootCnfgLastSetResult, backupCnfgPath=backupCnfgPath, SystemFileOperationType=SystemFileOperationType, nextBootVersion=nextBootVersion, dfltCnfgExists=dfltCnfgExists, backupSetStatus=backupSetStatus, nextBootSetStatus=nextBootSetStatus, currSoftVersion=currSoftVersion, bootCnfgExists=bootCnfgExists, backupPath=backupPath, runCnfgLastSaveResult=runCnfgLastSaveResult, runCnfgSaveAs=runCnfgSaveAs, currentFirmware=currentFirmware, runningConfig=runningConfig, dfltCnfgPath=dfltCnfgPath, firmware=firmware, currSoftLastSaveResult=currSoftLastSaveResult, currSoftSaveAs=currSoftSaveAs, guiAppletConfig=guiAppletConfig, currSoftName=currSoftName, backupVersion=backupVersion, guiConfig=guiConfig, restartStkMemberDevice=restartStkMemberDevice, nextBootFirmware=nextBootFirmware, backupCnfgSetStatus=backupCnfgSetStatus, PYSNMP_MODULE_ID=setup, backupConfig=backupConfig, currSoftSaveToFile=currSoftSaveToFile, srvcTelnetEnable=srvcTelnetEnable, guiAppletSysSwVer=guiAppletSysSwVer, serviceConfig=serviceConfig, deviceConfiguration=deviceConfiguration, nextBootLastSetResult=nextBootLastSetResult, backupLastSetResult=backupLastSetResult, nextBootPath=nextBootPath, bootCnfgSetStatus=bootCnfgSetStatus, backupFirmware=backupFirmware)
