...
mibBuilder.exportSymbols("AT-SETUP-MIB", currentFirmware=currentFirmware, runCnfgSaveAs=runCnfgSaveAs, backupFirmware=backupFirmware, setup=setup, backupPath=backupPath, bootCnfgSetStatus=bootCnfgSetStatus, runCnfgSaveAsStatus=runCnfgSaveAsStatus, nextBootPath=nextBootPath, defaultConfig=defaultConfig, dfltCnfgExists=dfltCnfgExists, runCnfgLastSaveResult=runCnfgLastSaveResult, srvcTelnetEnable=srvcTelnetEnable, backupCnfgPath=backupCnfgPath, SystemFileOperationType=SystemFileOperationType, backupCnfgExists=backupCnfgExists, deviceConfiguration=deviceConfiguration, currSoftSaveAs=currSoftSaveAs, PYSNMP_MODULE_ID=setup, currSoftSaveToFile=currSoftSaveToFile, nextBootVersion=nextBootVersion, backupConfig=backupConfig, backupSetStatus=backupSetStatus, firmware=firmware, currSoftSaveStatus=currSoftSaveStatus, backupVersion=backupVersion, nextBootConfig=nextBootConfig, currSoftName=currSoftName, restartDevice=restartDevice, serviceConfig=serviceConfig, srvcSshEnable=srvcSshEnable, guiAppletSysSwVer=guiAppletSysSwVer, currSoftVersion=currSoftVersion, bootCnfgExists=bootCnfgExists, nextBootSetStatus=nextBootSetStatus, nextBootFirmware=nextBootFirmware, dfltCnfgPath=dfltCnfgPath, guiAppletConfig=guiAppletConfig, guiAppletSwVer=guiAppletSwVer, backupCnfgSetStatus=backupCnfgSetStatus, currSoftLastSaveResult=currSoftLastSaveResult, nextBootLastSetResult=nextBootLastSetResult, bootCnfgPath=bootCnfgPath, backupLastSetResult=backupLastSetResult, backupCnfgLastSetResult=backupCnfgLastSetResult, bootCnfgLastSetResult=bootCnfgLastSetResult, runningConfig=runningConfig, guiConfig=guiConfig, restartStkMemberDevice=restartStkMemberDevice)
