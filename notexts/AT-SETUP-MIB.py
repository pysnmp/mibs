...
mibBuilder.exportSymbols("AT-SETUP-MIB", backupConfig=backupConfig, backupPath=backupPath, SystemFileOperationType=SystemFileOperationType, currSoftName=currSoftName, PYSNMP_MODULE_ID=setup, runCnfgSaveAsStatus=runCnfgSaveAsStatus, currSoftSaveStatus=currSoftSaveStatus, serviceConfig=serviceConfig, dfltCnfgPath=dfltCnfgPath, dfltCnfgExists=dfltCnfgExists, backupCnfgPath=backupCnfgPath, bootCnfgExists=bootCnfgExists, backupFirmware=backupFirmware, guiAppletConfig=guiAppletConfig, nextBootConfig=nextBootConfig, setup=setup, runningConfig=runningConfig, srvcTelnetEnable=srvcTelnetEnable, currSoftSaveToFile=currSoftSaveToFile, nextBootPath=nextBootPath, restartDevice=restartDevice, currSoftLastSaveResult=currSoftLastSaveResult, currSoftVersion=currSoftVersion, restartStkMemberDevice=restartStkMemberDevice, nextBootLastSetResult=nextBootLastSetResult, nextBootSetStatus=nextBootSetStatus, backupVersion=backupVersion, guiConfig=guiConfig, firmware=firmware, backupCnfgExists=backupCnfgExists, backupSetStatus=backupSetStatus, guiAppletSysSwVer=guiAppletSysSwVer, srvcSshEnable=srvcSshEnable, currentFirmware=currentFirmware, deviceConfiguration=deviceConfiguration, runCnfgLastSaveResult=runCnfgLastSaveResult, guiAppletSwVer=guiAppletSwVer, bootCnfgLastSetResult=bootCnfgLastSetResult, backupLastSetResult=backupLastSetResult, nextBootFirmware=nextBootFirmware, nextBootVersion=nextBootVersion, bootCnfgSetStatus=bootCnfgSetStatus, currSoftSaveAs=currSoftSaveAs, runCnfgSaveAs=runCnfgSaveAs, backupCnfgSetStatus=backupCnfgSetStatus, bootCnfgPath=bootCnfgPath, backupCnfgLastSetResult=backupCnfgLastSetResult, defaultConfig=defaultConfig)
