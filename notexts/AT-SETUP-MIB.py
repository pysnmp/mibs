...
mibBuilder.exportSymbols("AT-SETUP-MIB", currSoftLastSaveResult=currSoftLastSaveResult, dfltCnfgExists=dfltCnfgExists, dfltCnfgPath=dfltCnfgPath, nextBootConfig=nextBootConfig, deviceConfiguration=deviceConfiguration, backupLastSetResult=backupLastSetResult, backupVersion=backupVersion, currSoftSaveToFile=currSoftSaveToFile, nextBootPath=nextBootPath, PYSNMP_MODULE_ID=setup, restartStkMemberDevice=restartStkMemberDevice, currSoftName=currSoftName, backupSetStatus=backupSetStatus, bootCnfgExists=bootCnfgExists, defaultConfig=defaultConfig, guiAppletSysSwVer=guiAppletSysSwVer, currSoftVersion=currSoftVersion, currSoftSaveAs=currSoftSaveAs, guiConfig=guiConfig, backupFirmware=backupFirmware, runningConfig=runningConfig, backupCnfgSetStatus=backupCnfgSetStatus, bootCnfgSetStatus=bootCnfgSetStatus, setup=setup, bootCnfgPath=bootCnfgPath, currentFirmware=currentFirmware, srvcTelnetEnable=srvcTelnetEnable, bootCnfgLastSetResult=bootCnfgLastSetResult, firmware=firmware, backupConfig=backupConfig, backupPath=backupPath, runCnfgSaveAs=runCnfgSaveAs, runCnfgLastSaveResult=runCnfgLastSaveResult, serviceConfig=serviceConfig, SystemFileOperationType=SystemFileOperationType, nextBootFirmware=nextBootFirmware, nextBootLastSetResult=nextBootLastSetResult, guiAppletSwVer=guiAppletSwVer, runCnfgSaveAsStatus=runCnfgSaveAsStatus, guiAppletConfig=guiAppletConfig, currSoftSaveStatus=currSoftSaveStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, nextBootSetStatus=nextBootSetStatus, srvcSshEnable=srvcSshEnable, nextBootVersion=nextBootVersion, backupCnfgPath=backupCnfgPath, backupCnfgExists=backupCnfgExists, restartDevice=restartDevice)
