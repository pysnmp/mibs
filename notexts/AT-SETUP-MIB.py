...
mibBuilder.exportSymbols("AT-SETUP-MIB", currSoftVersion=currSoftVersion, backupCnfgSetStatus=backupCnfgSetStatus, PYSNMP_MODULE_ID=setup, SystemFileOperationType=SystemFileOperationType, backupCnfgPath=backupCnfgPath, restartStkMemberDevice=restartStkMemberDevice, nextBootSetStatus=nextBootSetStatus, currSoftName=currSoftName, nextBootFirmware=nextBootFirmware, dfltCnfgPath=dfltCnfgPath, runCnfgLastSaveResult=runCnfgLastSaveResult, guiAppletSysSwVer=guiAppletSysSwVer, currSoftSaveToFile=currSoftSaveToFile, guiAppletSwVer=guiAppletSwVer, backupVersion=backupVersion, nextBootVersion=nextBootVersion, deviceConfiguration=deviceConfiguration, backupConfig=backupConfig, nextBootLastSetResult=nextBootLastSetResult, backupFirmware=backupFirmware, runCnfgSaveAs=runCnfgSaveAs, backupSetStatus=backupSetStatus, bootCnfgSetStatus=bootCnfgSetStatus, currSoftLastSaveResult=currSoftLastSaveResult, backupCnfgLastSetResult=backupCnfgLastSetResult, restartDevice=restartDevice, serviceConfig=serviceConfig, currSoftSaveStatus=currSoftSaveStatus, srvcSshEnable=srvcSshEnable, guiAppletConfig=guiAppletConfig, guiConfig=guiConfig, backupPath=backupPath, runningConfig=runningConfig, setup=setup, bootCnfgExists=bootCnfgExists, dfltCnfgExists=dfltCnfgExists, currentFirmware=currentFirmware, srvcTelnetEnable=srvcTelnetEnable, nextBootConfig=nextBootConfig, defaultConfig=defaultConfig, bootCnfgPath=bootCnfgPath, runCnfgSaveAsStatus=runCnfgSaveAsStatus, currSoftSaveAs=currSoftSaveAs, firmware=firmware, bootCnfgLastSetResult=bootCnfgLastSetResult, backupCnfgExists=backupCnfgExists, backupLastSetResult=backupLastSetResult, nextBootPath=nextBootPath)
