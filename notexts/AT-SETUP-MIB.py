...
mibBuilder.exportSymbols("AT-SETUP-MIB", guiAppletSysSwVer=guiAppletSysSwVer, SystemFileOperationType=SystemFileOperationType, restartStkMemberDevice=restartStkMemberDevice, backupConfig=backupConfig, backupCnfgLastSetResult=backupCnfgLastSetResult, nextBootVersion=nextBootVersion, bootCnfgSetStatus=bootCnfgSetStatus, defaultConfig=defaultConfig, runCnfgLastSaveResult=runCnfgLastSaveResult, srvcTelnetEnable=srvcTelnetEnable, currSoftLastSaveResult=currSoftLastSaveResult, serviceConfig=serviceConfig, runningConfig=runningConfig, backupCnfgSetStatus=backupCnfgSetStatus, backupSetStatus=backupSetStatus, backupCnfgPath=backupCnfgPath, dfltCnfgPath=dfltCnfgPath, currentFirmware=currentFirmware, PYSNMP_MODULE_ID=setup, dfltCnfgExists=dfltCnfgExists, bootCnfgPath=bootCnfgPath, setup=setup, guiAppletConfig=guiAppletConfig, backupCnfgExists=backupCnfgExists, guiAppletSwVer=guiAppletSwVer, restartDevice=restartDevice, nextBootLastSetResult=nextBootLastSetResult, backupFirmware=backupFirmware, currSoftSaveAs=currSoftSaveAs, nextBootPath=nextBootPath, currSoftSaveStatus=currSoftSaveStatus, bootCnfgLastSetResult=bootCnfgLastSetResult, backupVersion=backupVersion, currSoftSaveToFile=currSoftSaveToFile, nextBootFirmware=nextBootFirmware, firmware=firmware, runCnfgSaveAs=runCnfgSaveAs, currSoftName=currSoftName, backupPath=backupPath, deviceConfiguration=deviceConfiguration, backupLastSetResult=backupLastSetResult, nextBootConfig=nextBootConfig, srvcSshEnable=srvcSshEnable, nextBootSetStatus=nextBootSetStatus, bootCnfgExists=bootCnfgExists, runCnfgSaveAsStatus=runCnfgSaveAsStatus, currSoftVersion=currSoftVersion, guiConfig=guiConfig)
