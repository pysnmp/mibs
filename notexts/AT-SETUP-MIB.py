...
mibBuilder.exportSymbols("AT-SETUP-MIB", currSoftSaveStatus=currSoftSaveStatus, deviceConfiguration=deviceConfiguration, PYSNMP_MODULE_ID=setup, guiAppletConfig=guiAppletConfig, currSoftVersion=currSoftVersion, currSoftLastSaveResult=currSoftLastSaveResult, nextBootPath=nextBootPath, bootCnfgSetStatus=bootCnfgSetStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, backupCnfgExists=backupCnfgExists, srvcSshEnable=srvcSshEnable, SystemFileOperationType=SystemFileOperationType, nextBootFirmware=nextBootFirmware, runCnfgSaveAs=runCnfgSaveAs, backupSetStatus=backupSetStatus, restartDevice=restartDevice, guiConfig=guiConfig, bootCnfgLastSetResult=bootCnfgLastSetResult, guiAppletSysSwVer=guiAppletSysSwVer, backupPath=backupPath, runCnfgLastSaveResult=runCnfgLastSaveResult, dfltCnfgExists=dfltCnfgExists, serviceConfig=serviceConfig, firmware=firmware, currSoftSaveAs=currSoftSaveAs, backupLastSetResult=backupLastSetResult, nextBootSetStatus=nextBootSetStatus, currSoftName=currSoftName, backupVersion=backupVersion, dfltCnfgPath=dfltCnfgPath, backupFirmware=backupFirmware, currentFirmware=currentFirmware, defaultConfig=defaultConfig, backupCnfgSetStatus=backupCnfgSetStatus, restartStkMemberDevice=restartStkMemberDevice, currSoftSaveToFile=currSoftSaveToFile, nextBootLastSetResult=nextBootLastSetResult, setup=setup, backupConfig=backupConfig, runCnfgSaveAsStatus=runCnfgSaveAsStatus, bootCnfgExists=bootCnfgExists, nextBootVersion=nextBootVersion, nextBootConfig=nextBootConfig, srvcTelnetEnable=srvcTelnetEnable, bootCnfgPath=bootCnfgPath, guiAppletSwVer=guiAppletSwVer, runningConfig=runningConfig, backupCnfgPath=backupCnfgPath)
