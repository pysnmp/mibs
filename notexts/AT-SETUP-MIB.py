...
mibBuilder.exportSymbols("AT-SETUP-MIB", bootCnfgLastSetResult=bootCnfgLastSetResult, nextBootVersion=nextBootVersion, backupPath=backupPath, backupCnfgSetStatus=backupCnfgSetStatus, setup=setup, currSoftName=currSoftName, currSoftSaveAs=currSoftSaveAs, nextBootConfig=nextBootConfig, bootCnfgSetStatus=bootCnfgSetStatus, restartDevice=restartDevice, dfltCnfgExists=dfltCnfgExists, firmware=firmware, runCnfgSaveAs=runCnfgSaveAs, backupConfig=backupConfig, nextBootFirmware=nextBootFirmware, runCnfgLastSaveResult=runCnfgLastSaveResult, backupVersion=backupVersion, backupCnfgLastSetResult=backupCnfgLastSetResult, defaultConfig=defaultConfig, currentFirmware=currentFirmware, backupCnfgExists=backupCnfgExists, guiAppletSwVer=guiAppletSwVer, runningConfig=runningConfig, restartStkMemberDevice=restartStkMemberDevice, nextBootSetStatus=nextBootSetStatus, deviceConfiguration=deviceConfiguration, bootCnfgPath=bootCnfgPath, serviceConfig=serviceConfig, srvcTelnetEnable=srvcTelnetEnable, currSoftLastSaveResult=currSoftLastSaveResult, currSoftSaveToFile=currSoftSaveToFile, guiAppletConfig=guiAppletConfig, guiAppletSysSwVer=guiAppletSysSwVer, currSoftSaveStatus=currSoftSaveStatus, nextBootLastSetResult=nextBootLastSetResult, backupFirmware=backupFirmware, backupCnfgPath=backupCnfgPath, srvcSshEnable=srvcSshEnable, SystemFileOperationType=SystemFileOperationType, backupLastSetResult=backupLastSetResult, currSoftVersion=currSoftVersion, runCnfgSaveAsStatus=runCnfgSaveAsStatus, nextBootPath=nextBootPath, bootCnfgExists=bootCnfgExists, backupSetStatus=backupSetStatus, PYSNMP_MODULE_ID=setup, guiConfig=guiConfig, dfltCnfgPath=dfltCnfgPath)
