...
mibBuilder.exportSymbols("AT-SETUP-MIB", nextBootVersion=nextBootVersion, bootCnfgSetStatus=bootCnfgSetStatus, SystemFileOperationType=SystemFileOperationType, firmware=firmware, guiAppletSwVer=guiAppletSwVer, backupCnfgPath=backupCnfgPath, nextBootPath=nextBootPath, currSoftSaveStatus=currSoftSaveStatus, runCnfgSaveAs=runCnfgSaveAs, runCnfgSaveAsStatus=runCnfgSaveAsStatus, srvcTelnetEnable=srvcTelnetEnable, currSoftVersion=currSoftVersion, backupLastSetResult=backupLastSetResult, bootCnfgPath=bootCnfgPath, bootCnfgExists=bootCnfgExists, nextBootConfig=nextBootConfig, backupConfig=backupConfig, runCnfgLastSaveResult=runCnfgLastSaveResult, PYSNMP_MODULE_ID=setup, currentFirmware=currentFirmware, restartDevice=restartDevice, nextBootLastSetResult=nextBootLastSetResult, backupCnfgLastSetResult=backupCnfgLastSetResult, guiAppletSysSwVer=guiAppletSysSwVer, runningConfig=runningConfig, backupCnfgExists=backupCnfgExists, setup=setup, currSoftLastSaveResult=currSoftLastSaveResult, backupFirmware=backupFirmware, dfltCnfgPath=dfltCnfgPath, deviceConfiguration=deviceConfiguration, backupSetStatus=backupSetStatus, serviceConfig=serviceConfig, srvcSshEnable=srvcSshEnable, dfltCnfgExists=dfltCnfgExists, nextBootFirmware=nextBootFirmware, guiConfig=guiConfig, currSoftSaveToFile=currSoftSaveToFile, currSoftName=currSoftName, bootCnfgLastSetResult=bootCnfgLastSetResult, currSoftSaveAs=currSoftSaveAs, backupVersion=backupVersion, backupPath=backupPath, restartStkMemberDevice=restartStkMemberDevice, defaultConfig=defaultConfig, guiAppletConfig=guiAppletConfig, backupCnfgSetStatus=backupCnfgSetStatus, nextBootSetStatus=nextBootSetStatus)
