...
mibBuilder.exportSymbols("AT-SETUP-MIB", nextBootFirmware=nextBootFirmware, nextBootConfig=nextBootConfig, guiAppletSwVer=guiAppletSwVer, deviceConfiguration=deviceConfiguration, defaultConfig=defaultConfig, nextBootVersion=nextBootVersion, currentFirmware=currentFirmware, currSoftSaveAs=currSoftSaveAs, bootCnfgLastSetResult=bootCnfgLastSetResult, backupCnfgLastSetResult=backupCnfgLastSetResult, restartDevice=restartDevice, backupConfig=backupConfig, currSoftSaveToFile=currSoftSaveToFile, PYSNMP_MODULE_ID=setup, nextBootLastSetResult=nextBootLastSetResult, srvcSshEnable=srvcSshEnable, srvcTelnetEnable=srvcTelnetEnable, runCnfgSaveAs=runCnfgSaveAs, SystemFileOperationType=SystemFileOperationType, backupFirmware=backupFirmware, backupPath=backupPath, backupSetStatus=backupSetStatus, runCnfgSaveAsStatus=runCnfgSaveAsStatus, backupVersion=backupVersion, serviceConfig=serviceConfig, bootCnfgExists=bootCnfgExists, guiAppletConfig=guiAppletConfig, guiAppletSysSwVer=guiAppletSysSwVer, currSoftSaveStatus=currSoftSaveStatus, firmware=firmware, nextBootPath=nextBootPath, dfltCnfgPath=dfltCnfgPath, backupCnfgSetStatus=backupCnfgSetStatus, currSoftName=currSoftName, bootCnfgSetStatus=bootCnfgSetStatus, guiConfig=guiConfig, backupCnfgPath=backupCnfgPath, backupLastSetResult=backupLastSetResult, runCnfgLastSaveResult=runCnfgLastSaveResult, nextBootSetStatus=nextBootSetStatus, restartStkMemberDevice=restartStkMemberDevice, bootCnfgPath=bootCnfgPath, runningConfig=runningConfig, setup=setup, currSoftLastSaveResult=currSoftLastSaveResult, backupCnfgExists=backupCnfgExists, dfltCnfgExists=dfltCnfgExists, currSoftVersion=currSoftVersion)
