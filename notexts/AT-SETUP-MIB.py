...
mibBuilder.exportSymbols("AT-SETUP-MIB", bootCnfgLastSetResult=bootCnfgLastSetResult, nextBootLastSetResult=nextBootLastSetResult, setup=setup, runCnfgSaveAs=runCnfgSaveAs, guiConfig=guiConfig, guiAppletConfig=guiAppletConfig, backupCnfgSetStatus=backupCnfgSetStatus, bootCnfgExists=bootCnfgExists, currSoftSaveStatus=currSoftSaveStatus, bootCnfgSetStatus=bootCnfgSetStatus, backupLastSetResult=backupLastSetResult, currentFirmware=currentFirmware, backupCnfgLastSetResult=backupCnfgLastSetResult, runCnfgLastSaveResult=runCnfgLastSaveResult, backupPath=backupPath, guiAppletSysSwVer=guiAppletSysSwVer, guiAppletSwVer=guiAppletSwVer, currSoftName=currSoftName, currSoftLastSaveResult=currSoftLastSaveResult, nextBootVersion=nextBootVersion, srvcSshEnable=srvcSshEnable, dfltCnfgPath=dfltCnfgPath, srvcTelnetEnable=srvcTelnetEnable, nextBootPath=nextBootPath, firmware=firmware, defaultConfig=defaultConfig, runCnfgSaveAsStatus=runCnfgSaveAsStatus, currSoftSaveAs=currSoftSaveAs, serviceConfig=serviceConfig, restartDevice=restartDevice, SystemFileOperationType=SystemFileOperationType, restartStkMemberDevice=restartStkMemberDevice, backupCnfgPath=backupCnfgPath, backupSetStatus=backupSetStatus, PYSNMP_MODULE_ID=setup, backupFirmware=backupFirmware, deviceConfiguration=deviceConfiguration, currSoftSaveToFile=currSoftSaveToFile, currSoftVersion=currSoftVersion, backupCnfgExists=backupCnfgExists, backupVersion=backupVersion, bootCnfgPath=bootCnfgPath, runningConfig=runningConfig, dfltCnfgExists=dfltCnfgExists, backupConfig=backupConfig, nextBootFirmware=nextBootFirmware, nextBootSetStatus=nextBootSetStatus, nextBootConfig=nextBootConfig)
