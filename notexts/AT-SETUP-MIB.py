...
mibBuilder.exportSymbols("AT-SETUP-MIB", backupCnfgExists=backupCnfgExists, nextBootPath=nextBootPath, backupCnfgPath=backupCnfgPath, currSoftVersion=currSoftVersion, nextBootFirmware=nextBootFirmware, bootCnfgLastSetResult=bootCnfgLastSetResult, guiAppletConfig=guiAppletConfig, nextBootSetStatus=nextBootSetStatus, runningConfig=runningConfig, backupPath=backupPath, deviceConfiguration=deviceConfiguration, backupLastSetResult=backupLastSetResult, backupCnfgSetStatus=backupCnfgSetStatus, restartDevice=restartDevice, bootCnfgPath=bootCnfgPath, nextBootVersion=nextBootVersion, runCnfgSaveAsStatus=runCnfgSaveAsStatus, runCnfgLastSaveResult=runCnfgLastSaveResult, backupCnfgLastSetResult=backupCnfgLastSetResult, restartStkMemberDevice=restartStkMemberDevice, srvcTelnetEnable=srvcTelnetEnable, backupVersion=backupVersion, defaultConfig=defaultConfig, bootCnfgSetStatus=bootCnfgSetStatus, backupFirmware=backupFirmware, nextBootConfig=nextBootConfig, srvcSshEnable=srvcSshEnable, dfltCnfgExists=dfltCnfgExists, dfltCnfgPath=dfltCnfgPath, currentFirmware=currentFirmware, currSoftSaveAs=currSoftSaveAs, bootCnfgExists=bootCnfgExists, serviceConfig=serviceConfig, firmware=firmware, backupSetStatus=backupSetStatus, guiConfig=guiConfig, runCnfgSaveAs=runCnfgSaveAs, SystemFileOperationType=SystemFileOperationType, PYSNMP_MODULE_ID=setup, guiAppletSwVer=guiAppletSwVer, nextBootLastSetResult=nextBootLastSetResult, currSoftName=currSoftName, guiAppletSysSwVer=guiAppletSysSwVer, currSoftSaveStatus=currSoftSaveStatus, currSoftSaveToFile=currSoftSaveToFile, currSoftLastSaveResult=currSoftLastSaveResult, setup=setup, backupConfig=backupConfig)
