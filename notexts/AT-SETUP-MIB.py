...
mibBuilder.exportSymbols("AT-SETUP-MIB", nextBootLastSetResult=nextBootLastSetResult, backupCnfgExists=backupCnfgExists, nextBootFirmware=nextBootFirmware, defaultConfig=defaultConfig, currSoftSaveStatus=currSoftSaveStatus, runCnfgSaveAs=runCnfgSaveAs, dfltCnfgPath=dfltCnfgPath, nextBootConfig=nextBootConfig, backupFirmware=backupFirmware, currSoftSaveAs=currSoftSaveAs, srvcTelnetEnable=srvcTelnetEnable, bootCnfgSetStatus=bootCnfgSetStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, bootCnfgPath=bootCnfgPath, bootCnfgLastSetResult=bootCnfgLastSetResult, guiConfig=guiConfig, firmware=firmware, runCnfgSaveAsStatus=runCnfgSaveAsStatus, guiAppletConfig=guiAppletConfig, nextBootVersion=nextBootVersion, PYSNMP_MODULE_ID=setup, bootCnfgExists=bootCnfgExists, dfltCnfgExists=dfltCnfgExists, guiAppletSysSwVer=guiAppletSysSwVer, restartDevice=restartDevice, backupCnfgSetStatus=backupCnfgSetStatus, nextBootPath=nextBootPath, backupCnfgPath=backupCnfgPath, currSoftName=currSoftName, backupPath=backupPath, backupSetStatus=backupSetStatus, deviceConfiguration=deviceConfiguration, backupVersion=backupVersion, srvcSshEnable=srvcSshEnable, restartStkMemberDevice=restartStkMemberDevice, currSoftSaveToFile=currSoftSaveToFile, backupLastSetResult=backupLastSetResult, runCnfgLastSaveResult=runCnfgLastSaveResult, SystemFileOperationType=SystemFileOperationType, serviceConfig=serviceConfig, nextBootSetStatus=nextBootSetStatus, setup=setup, backupConfig=backupConfig, currSoftLastSaveResult=currSoftLastSaveResult, guiAppletSwVer=guiAppletSwVer, runningConfig=runningConfig, currentFirmware=currentFirmware, currSoftVersion=currSoftVersion)
