...
mibBuilder.exportSymbols("AT-SETUP-MIB", backupCnfgPath=backupCnfgPath, currSoftVersion=currSoftVersion, backupLastSetResult=backupLastSetResult, PYSNMP_MODULE_ID=setup, serviceConfig=serviceConfig, currSoftLastSaveResult=currSoftLastSaveResult, defaultConfig=defaultConfig, deviceConfiguration=deviceConfiguration, guiAppletSwVer=guiAppletSwVer, guiAppletSysSwVer=guiAppletSysSwVer, currSoftSaveToFile=currSoftSaveToFile, backupFirmware=backupFirmware, nextBootPath=nextBootPath, dfltCnfgExists=dfltCnfgExists, nextBootSetStatus=nextBootSetStatus, currSoftSaveStatus=currSoftSaveStatus, nextBootConfig=nextBootConfig, dfltCnfgPath=dfltCnfgPath, backupVersion=backupVersion, runCnfgLastSaveResult=runCnfgLastSaveResult, currSoftName=currSoftName, runningConfig=runningConfig, backupPath=backupPath, guiConfig=guiConfig, firmware=firmware, backupCnfgExists=backupCnfgExists, nextBootFirmware=nextBootFirmware, nextBootLastSetResult=nextBootLastSetResult, restartStkMemberDevice=restartStkMemberDevice, bootCnfgPath=bootCnfgPath, bootCnfgExists=bootCnfgExists, srvcSshEnable=srvcSshEnable, currSoftSaveAs=currSoftSaveAs, currentFirmware=currentFirmware, bootCnfgLastSetResult=bootCnfgLastSetResult, bootCnfgSetStatus=bootCnfgSetStatus, backupConfig=backupConfig, srvcTelnetEnable=srvcTelnetEnable, guiAppletConfig=guiAppletConfig, runCnfgSaveAsStatus=runCnfgSaveAsStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, nextBootVersion=nextBootVersion, setup=setup, backupCnfgSetStatus=backupCnfgSetStatus, backupSetStatus=backupSetStatus, runCnfgSaveAs=runCnfgSaveAs, restartDevice=restartDevice, SystemFileOperationType=SystemFileOperationType)
