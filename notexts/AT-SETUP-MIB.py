...
mibBuilder.exportSymbols("AT-SETUP-MIB", currSoftLastSaveResult=currSoftLastSaveResult, backupCnfgLastSetResult=backupCnfgLastSetResult, nextBootConfig=nextBootConfig, backupVersion=backupVersion, currentFirmware=currentFirmware, currSoftSaveAs=currSoftSaveAs, nextBootFirmware=nextBootFirmware, runCnfgSaveAsStatus=runCnfgSaveAsStatus, bootCnfgExists=bootCnfgExists, srvcTelnetEnable=srvcTelnetEnable, srvcSshEnable=srvcSshEnable, dfltCnfgPath=dfltCnfgPath, runningConfig=runningConfig, runCnfgSaveAs=runCnfgSaveAs, backupFirmware=backupFirmware, bootCnfgPath=bootCnfgPath, backupCnfgExists=backupCnfgExists, guiAppletConfig=guiAppletConfig, bootCnfgSetStatus=bootCnfgSetStatus, firmware=firmware, nextBootPath=nextBootPath, nextBootSetStatus=nextBootSetStatus, PYSNMP_MODULE_ID=setup, backupLastSetResult=backupLastSetResult, currSoftSaveToFile=currSoftSaveToFile, defaultConfig=defaultConfig, guiAppletSwVer=guiAppletSwVer, backupSetStatus=backupSetStatus, guiAppletSysSwVer=guiAppletSysSwVer, deviceConfiguration=deviceConfiguration, SystemFileOperationType=SystemFileOperationType, setup=setup, backupCnfgSetStatus=backupCnfgSetStatus, serviceConfig=serviceConfig, nextBootLastSetResult=nextBootLastSetResult, bootCnfgLastSetResult=bootCnfgLastSetResult, restartStkMemberDevice=restartStkMemberDevice, guiConfig=guiConfig, restartDevice=restartDevice, runCnfgLastSaveResult=runCnfgLastSaveResult, backupCnfgPath=backupCnfgPath, backupConfig=backupConfig, dfltCnfgExists=dfltCnfgExists, currSoftName=currSoftName, backupPath=backupPath, nextBootVersion=nextBootVersion, currSoftVersion=currSoftVersion, currSoftSaveStatus=currSoftSaveStatus)
