...
mibBuilder.exportSymbols("AT-SETUP-MIB", currSoftSaveStatus=currSoftSaveStatus, nextBootFirmware=nextBootFirmware, PYSNMP_MODULE_ID=setup, backupCnfgPath=backupCnfgPath, bootCnfgExists=bootCnfgExists, serviceConfig=serviceConfig, firmware=firmware, backupCnfgExists=backupCnfgExists, currSoftSaveAs=currSoftSaveAs, runCnfgLastSaveResult=runCnfgLastSaveResult, nextBootVersion=nextBootVersion, backupConfig=backupConfig, restartStkMemberDevice=restartStkMemberDevice, bootCnfgLastSetResult=bootCnfgLastSetResult, currSoftVersion=currSoftVersion, currSoftLastSaveResult=currSoftLastSaveResult, restartDevice=restartDevice, runCnfgSaveAsStatus=runCnfgSaveAsStatus, SystemFileOperationType=SystemFileOperationType, dfltCnfgExists=dfltCnfgExists, nextBootSetStatus=nextBootSetStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, nextBootConfig=nextBootConfig, currSoftName=currSoftName, nextBootPath=nextBootPath, guiAppletSysSwVer=guiAppletSysSwVer, nextBootLastSetResult=nextBootLastSetResult, currentFirmware=currentFirmware, bootCnfgSetStatus=bootCnfgSetStatus, backupLastSetResult=backupLastSetResult, srvcTelnetEnable=srvcTelnetEnable, srvcSshEnable=srvcSshEnable, bootCnfgPath=bootCnfgPath, backupSetStatus=backupSetStatus, defaultConfig=defaultConfig, deviceConfiguration=deviceConfiguration, runningConfig=runningConfig, setup=setup, guiAppletSwVer=guiAppletSwVer, guiAppletConfig=guiAppletConfig, runCnfgSaveAs=runCnfgSaveAs, currSoftSaveToFile=currSoftSaveToFile, backupPath=backupPath, backupCnfgSetStatus=backupCnfgSetStatus, backupFirmware=backupFirmware, guiConfig=guiConfig, backupVersion=backupVersion, dfltCnfgPath=dfltCnfgPath)
