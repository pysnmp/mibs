...
mibBuilder.exportSymbols("AT-SETUP-MIB", setup=setup, backupSetStatus=backupSetStatus, currSoftLastSaveResult=currSoftLastSaveResult, runCnfgLastSaveResult=runCnfgLastSaveResult, nextBootSetStatus=nextBootSetStatus, deviceConfiguration=deviceConfiguration, backupCnfgPath=backupCnfgPath, srvcSshEnable=srvcSshEnable, runningConfig=runningConfig, nextBootFirmware=nextBootFirmware, backupCnfgLastSetResult=backupCnfgLastSetResult, nextBootConfig=nextBootConfig, runCnfgSaveAs=runCnfgSaveAs, backupPath=backupPath, bootCnfgExists=bootCnfgExists, currSoftVersion=currSoftVersion, firmware=firmware, bootCnfgLastSetResult=bootCnfgLastSetResult, currSoftName=currSoftName, backupLastSetResult=backupLastSetResult, backupConfig=backupConfig, backupCnfgExists=backupCnfgExists, currentFirmware=currentFirmware, currSoftSaveAs=currSoftSaveAs, backupFirmware=backupFirmware, guiAppletSysSwVer=guiAppletSysSwVer, nextBootPath=nextBootPath, guiConfig=guiConfig, bootCnfgPath=bootCnfgPath, SystemFileOperationType=SystemFileOperationType, dfltCnfgPath=dfltCnfgPath, guiAppletSwVer=guiAppletSwVer, restartDevice=restartDevice, serviceConfig=serviceConfig, currSoftSaveStatus=currSoftSaveStatus, nextBootVersion=nextBootVersion, guiAppletConfig=guiAppletConfig, defaultConfig=defaultConfig, bootCnfgSetStatus=bootCnfgSetStatus, backupCnfgSetStatus=backupCnfgSetStatus, backupVersion=backupVersion, PYSNMP_MODULE_ID=setup, runCnfgSaveAsStatus=runCnfgSaveAsStatus, dfltCnfgExists=dfltCnfgExists, nextBootLastSetResult=nextBootLastSetResult, restartStkMemberDevice=restartStkMemberDevice, currSoftSaveToFile=currSoftSaveToFile, srvcTelnetEnable=srvcTelnetEnable)
