...
mibBuilder.exportSymbols("AT-SETUP-MIB", guiConfig=guiConfig, bootCnfgLastSetResult=bootCnfgLastSetResult, currSoftSaveToFile=currSoftSaveToFile, nextBootFirmware=nextBootFirmware, defaultConfig=defaultConfig, deviceConfiguration=deviceConfiguration, PYSNMP_MODULE_ID=setup, backupCnfgLastSetResult=backupCnfgLastSetResult, currSoftSaveAs=currSoftSaveAs, backupLastSetResult=backupLastSetResult, guiAppletSysSwVer=guiAppletSysSwVer, backupConfig=backupConfig, currentFirmware=currentFirmware, srvcTelnetEnable=srvcTelnetEnable, nextBootSetStatus=nextBootSetStatus, backupPath=backupPath, restartStkMemberDevice=restartStkMemberDevice, srvcSshEnable=srvcSshEnable, backupCnfgExists=backupCnfgExists, dfltCnfgExists=dfltCnfgExists, runningConfig=runningConfig, nextBootVersion=nextBootVersion, runCnfgSaveAs=runCnfgSaveAs, nextBootPath=nextBootPath, firmware=firmware, bootCnfgPath=bootCnfgPath, bootCnfgExists=bootCnfgExists, bootCnfgSetStatus=bootCnfgSetStatus, currSoftSaveStatus=currSoftSaveStatus, dfltCnfgPath=dfltCnfgPath, currSoftName=currSoftName, nextBootConfig=nextBootConfig, backupFirmware=backupFirmware, runCnfgSaveAsStatus=runCnfgSaveAsStatus, serviceConfig=serviceConfig, SystemFileOperationType=SystemFileOperationType, currSoftLastSaveResult=currSoftLastSaveResult, backupVersion=backupVersion, runCnfgLastSaveResult=runCnfgLastSaveResult, guiAppletConfig=guiAppletConfig, backupCnfgPath=backupCnfgPath, nextBootLastSetResult=nextBootLastSetResult, backupSetStatus=backupSetStatus, guiAppletSwVer=guiAppletSwVer, restartDevice=restartDevice, currSoftVersion=currSoftVersion, setup=setup, backupCnfgSetStatus=backupCnfgSetStatus)
