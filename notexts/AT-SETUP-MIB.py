...
mibBuilder.exportSymbols("AT-SETUP-MIB", currSoftSaveStatus=currSoftSaveStatus, currSoftSaveAs=currSoftSaveAs, nextBootLastSetResult=nextBootLastSetResult, backupSetStatus=backupSetStatus, PYSNMP_MODULE_ID=setup, backupFirmware=backupFirmware, serviceConfig=serviceConfig, runCnfgLastSaveResult=runCnfgLastSaveResult, restartStkMemberDevice=restartStkMemberDevice, backupCnfgExists=backupCnfgExists, guiConfig=guiConfig, currSoftName=currSoftName, bootCnfgPath=bootCnfgPath, guiAppletSysSwVer=guiAppletSysSwVer, nextBootPath=nextBootPath, bootCnfgLastSetResult=bootCnfgLastSetResult, dfltCnfgPath=dfltCnfgPath, guiAppletSwVer=guiAppletSwVer, nextBootSetStatus=nextBootSetStatus, SystemFileOperationType=SystemFileOperationType, dfltCnfgExists=dfltCnfgExists, backupConfig=backupConfig, backupCnfgLastSetResult=backupCnfgLastSetResult, deviceConfiguration=deviceConfiguration, nextBootConfig=nextBootConfig, runCnfgSaveAs=runCnfgSaveAs, runningConfig=runningConfig, currSoftLastSaveResult=currSoftLastSaveResult, bootCnfgExists=bootCnfgExists, srvcTelnetEnable=srvcTelnetEnable, runCnfgSaveAsStatus=runCnfgSaveAsStatus, srvcSshEnable=srvcSshEnable, firmware=firmware, restartDevice=restartDevice, currSoftSaveToFile=currSoftSaveToFile, backupLastSetResult=backupLastSetResult, bootCnfgSetStatus=bootCnfgSetStatus, guiAppletConfig=guiAppletConfig, backupCnfgSetStatus=backupCnfgSetStatus, nextBootFirmware=nextBootFirmware, setup=setup, backupPath=backupPath, nextBootVersion=nextBootVersion, defaultConfig=defaultConfig, backupCnfgPath=backupCnfgPath, currentFirmware=currentFirmware, backupVersion=backupVersion, currSoftVersion=currSoftVersion)
