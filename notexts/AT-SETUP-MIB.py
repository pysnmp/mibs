...
mibBuilder.exportSymbols("AT-SETUP-MIB", firmware=firmware, backupVersion=backupVersion, guiConfig=guiConfig, srvcTelnetEnable=srvcTelnetEnable, nextBootPath=nextBootPath, guiAppletSwVer=guiAppletSwVer, bootCnfgExists=bootCnfgExists, nextBootVersion=nextBootVersion, currSoftName=currSoftName, backupSetStatus=backupSetStatus, setup=setup, nextBootLastSetResult=nextBootLastSetResult, defaultConfig=defaultConfig, backupConfig=backupConfig, guiAppletConfig=guiAppletConfig, currSoftLastSaveResult=currSoftLastSaveResult, backupFirmware=backupFirmware, backupCnfgExists=backupCnfgExists, currSoftSaveToFile=currSoftSaveToFile, currSoftSaveStatus=currSoftSaveStatus, backupLastSetResult=backupLastSetResult, nextBootFirmware=nextBootFirmware, bootCnfgSetStatus=bootCnfgSetStatus, PYSNMP_MODULE_ID=setup, deviceConfiguration=deviceConfiguration, nextBootSetStatus=nextBootSetStatus, restartStkMemberDevice=restartStkMemberDevice, runCnfgSaveAsStatus=runCnfgSaveAsStatus, SystemFileOperationType=SystemFileOperationType, currentFirmware=currentFirmware, guiAppletSysSwVer=guiAppletSysSwVer, runCnfgSaveAs=runCnfgSaveAs, backupCnfgLastSetResult=backupCnfgLastSetResult, dfltCnfgExists=dfltCnfgExists, bootCnfgPath=bootCnfgPath, bootCnfgLastSetResult=bootCnfgLastSetResult, serviceConfig=serviceConfig, runningConfig=runningConfig, srvcSshEnable=srvcSshEnable, backupCnfgSetStatus=backupCnfgSetStatus, restartDevice=restartDevice, dfltCnfgPath=dfltCnfgPath, runCnfgLastSaveResult=runCnfgLastSaveResult, currSoftVersion=currSoftVersion, nextBootConfig=nextBootConfig, backupCnfgPath=backupCnfgPath, currSoftSaveAs=currSoftSaveAs, backupPath=backupPath)
