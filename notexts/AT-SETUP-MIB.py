...
mibBuilder.exportSymbols("AT-SETUP-MIB", srvcTelnetEnable=srvcTelnetEnable, currSoftSaveAs=currSoftSaveAs, currSoftLastSaveResult=currSoftLastSaveResult, deviceConfiguration=deviceConfiguration, nextBootVersion=nextBootVersion, backupLastSetResult=backupLastSetResult, currSoftVersion=currSoftVersion, guiAppletConfig=guiAppletConfig, currSoftName=currSoftName, PYSNMP_MODULE_ID=setup, bootCnfgLastSetResult=bootCnfgLastSetResult, backupVersion=backupVersion, currSoftSaveToFile=currSoftSaveToFile, guiAppletSwVer=guiAppletSwVer, setup=setup, restartDevice=restartDevice, runCnfgSaveAs=runCnfgSaveAs, currentFirmware=currentFirmware, backupPath=backupPath, dfltCnfgExists=dfltCnfgExists, nextBootConfig=nextBootConfig, guiConfig=guiConfig, runCnfgSaveAsStatus=runCnfgSaveAsStatus, bootCnfgPath=bootCnfgPath, backupConfig=backupConfig, runningConfig=runningConfig, nextBootLastSetResult=nextBootLastSetResult, serviceConfig=serviceConfig, backupCnfgPath=backupCnfgPath, guiAppletSysSwVer=guiAppletSysSwVer, SystemFileOperationType=SystemFileOperationType, backupSetStatus=backupSetStatus, firmware=firmware, restartStkMemberDevice=restartStkMemberDevice, nextBootSetStatus=nextBootSetStatus, backupCnfgSetStatus=backupCnfgSetStatus, runCnfgLastSaveResult=runCnfgLastSaveResult, bootCnfgExists=bootCnfgExists, nextBootFirmware=nextBootFirmware, dfltCnfgPath=dfltCnfgPath, nextBootPath=nextBootPath, currSoftSaveStatus=currSoftSaveStatus, backupFirmware=backupFirmware, bootCnfgSetStatus=bootCnfgSetStatus, srvcSshEnable=srvcSshEnable, backupCnfgLastSetResult=backupCnfgLastSetResult, defaultConfig=defaultConfig, backupCnfgExists=backupCnfgExists)
