...
mibBuilder.exportSymbols("AT-SETUP-MIB", guiConfig=guiConfig, dfltCnfgPath=dfltCnfgPath, backupConfig=backupConfig, currSoftSaveToFile=currSoftSaveToFile, runCnfgSaveAs=runCnfgSaveAs, restartStkMemberDevice=restartStkMemberDevice, restartDevice=restartDevice, nextBootLastSetResult=nextBootLastSetResult, bootCnfgSetStatus=bootCnfgSetStatus, currSoftSaveStatus=currSoftSaveStatus, backupSetStatus=backupSetStatus, firmware=firmware, nextBootPath=nextBootPath, SystemFileOperationType=SystemFileOperationType, setup=setup, backupLastSetResult=backupLastSetResult, serviceConfig=serviceConfig, backupVersion=backupVersion, backupCnfgLastSetResult=backupCnfgLastSetResult, guiAppletSysSwVer=guiAppletSysSwVer, currSoftVersion=currSoftVersion, runCnfgLastSaveResult=runCnfgLastSaveResult, bootCnfgPath=bootCnfgPath, backupCnfgExists=backupCnfgExists, deviceConfiguration=deviceConfiguration, PYSNMP_MODULE_ID=setup, currentFirmware=currentFirmware, bootCnfgExists=bootCnfgExists, nextBootFirmware=nextBootFirmware, dfltCnfgExists=dfltCnfgExists, guiAppletSwVer=guiAppletSwVer, guiAppletConfig=guiAppletConfig, currSoftLastSaveResult=currSoftLastSaveResult, srvcTelnetEnable=srvcTelnetEnable, currSoftName=currSoftName, nextBootSetStatus=nextBootSetStatus, backupPath=backupPath, runCnfgSaveAsStatus=runCnfgSaveAsStatus, bootCnfgLastSetResult=bootCnfgLastSetResult, srvcSshEnable=srvcSshEnable, defaultConfig=defaultConfig, nextBootVersion=nextBootVersion, backupFirmware=backupFirmware, currSoftSaveAs=currSoftSaveAs, nextBootConfig=nextBootConfig, runningConfig=runningConfig, backupCnfgPath=backupCnfgPath, backupCnfgSetStatus=backupCnfgSetStatus)
