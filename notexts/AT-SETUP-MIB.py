...
mibBuilder.exportSymbols("AT-SETUP-MIB", runCnfgSaveAsStatus=runCnfgSaveAsStatus, bootCnfgSetStatus=bootCnfgSetStatus, backupCnfgPath=backupCnfgPath, backupCnfgExists=backupCnfgExists, SystemFileOperationType=SystemFileOperationType, guiAppletSwVer=guiAppletSwVer, nextBootSetStatus=nextBootSetStatus, nextBootConfig=nextBootConfig, nextBootLastSetResult=nextBootLastSetResult, bootCnfgPath=bootCnfgPath, dfltCnfgPath=dfltCnfgPath, backupCnfgLastSetResult=backupCnfgLastSetResult, nextBootFirmware=nextBootFirmware, backupPath=backupPath, currSoftSaveAs=currSoftSaveAs, bootCnfgExists=bootCnfgExists, backupVersion=backupVersion, PYSNMP_MODULE_ID=setup, bootCnfgLastSetResult=bootCnfgLastSetResult, srvcTelnetEnable=srvcTelnetEnable, guiAppletSysSwVer=guiAppletSysSwVer, backupLastSetResult=backupLastSetResult, currSoftSaveToFile=currSoftSaveToFile, backupFirmware=backupFirmware, guiAppletConfig=guiAppletConfig, runCnfgSaveAs=runCnfgSaveAs, backupConfig=backupConfig, currentFirmware=currentFirmware, backupCnfgSetStatus=backupCnfgSetStatus, firmware=firmware, backupSetStatus=backupSetStatus, runCnfgLastSaveResult=runCnfgLastSaveResult, restartDevice=restartDevice, serviceConfig=serviceConfig, defaultConfig=defaultConfig, currSoftName=currSoftName, currSoftLastSaveResult=currSoftLastSaveResult, srvcSshEnable=srvcSshEnable, restartStkMemberDevice=restartStkMemberDevice, currSoftSaveStatus=currSoftSaveStatus, dfltCnfgExists=dfltCnfgExists, deviceConfiguration=deviceConfiguration, guiConfig=guiConfig, currSoftVersion=currSoftVersion, nextBootVersion=nextBootVersion, runningConfig=runningConfig, nextBootPath=nextBootPath, setup=setup)
