...
mibBuilder.exportSymbols("AT-SETUP-MIB", runCnfgSaveAs=runCnfgSaveAs, SystemFileOperationType=SystemFileOperationType, backupCnfgSetStatus=backupCnfgSetStatus, bootCnfgExists=bootCnfgExists, dfltCnfgPath=dfltCnfgPath, nextBootSetStatus=nextBootSetStatus, nextBootPath=nextBootPath, nextBootFirmware=nextBootFirmware, backupCnfgPath=backupCnfgPath, deviceConfiguration=deviceConfiguration, nextBootLastSetResult=nextBootLastSetResult, currSoftLastSaveResult=currSoftLastSaveResult, bootCnfgSetStatus=bootCnfgSetStatus, currentFirmware=currentFirmware, srvcSshEnable=srvcSshEnable, currSoftVersion=currSoftVersion, PYSNMP_MODULE_ID=setup, firmware=firmware, restartDevice=restartDevice, currSoftSaveToFile=currSoftSaveToFile, backupLastSetResult=backupLastSetResult, runningConfig=runningConfig, guiAppletSysSwVer=guiAppletSysSwVer, setup=setup, dfltCnfgExists=dfltCnfgExists, currSoftSaveAs=currSoftSaveAs, guiAppletSwVer=guiAppletSwVer, backupSetStatus=backupSetStatus, backupPath=backupPath, backupConfig=backupConfig, defaultConfig=defaultConfig, guiConfig=guiConfig, nextBootConfig=nextBootConfig, serviceConfig=serviceConfig, runCnfgLastSaveResult=runCnfgLastSaveResult, restartStkMemberDevice=restartStkMemberDevice, backupCnfgLastSetResult=backupCnfgLastSetResult, currSoftSaveStatus=currSoftSaveStatus, guiAppletConfig=guiAppletConfig, runCnfgSaveAsStatus=runCnfgSaveAsStatus, backupVersion=backupVersion, srvcTelnetEnable=srvcTelnetEnable, currSoftName=currSoftName, nextBootVersion=nextBootVersion, backupFirmware=backupFirmware, bootCnfgPath=bootCnfgPath, bootCnfgLastSetResult=bootCnfgLastSetResult, backupCnfgExists=backupCnfgExists)
