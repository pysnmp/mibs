...
mibBuilder.exportSymbols("AT-SETUP-MIB", firmware=firmware, backupVersion=backupVersion, bootCnfgSetStatus=bootCnfgSetStatus, backupCnfgExists=backupCnfgExists, backupSetStatus=backupSetStatus, guiConfig=guiConfig, bootCnfgExists=bootCnfgExists, currSoftSaveAs=currSoftSaveAs, PYSNMP_MODULE_ID=setup, dfltCnfgPath=dfltCnfgPath, guiAppletSysSwVer=guiAppletSysSwVer, currSoftSaveStatus=currSoftSaveStatus, restartStkMemberDevice=restartStkMemberDevice, bootCnfgLastSetResult=bootCnfgLastSetResult, backupConfig=backupConfig, currentFirmware=currentFirmware, currSoftSaveToFile=currSoftSaveToFile, nextBootLastSetResult=nextBootLastSetResult, srvcSshEnable=srvcSshEnable, guiAppletConfig=guiAppletConfig, nextBootPath=nextBootPath, currSoftLastSaveResult=currSoftLastSaveResult, backupLastSetResult=backupLastSetResult, SystemFileOperationType=SystemFileOperationType, backupPath=backupPath, nextBootSetStatus=nextBootSetStatus, dfltCnfgExists=dfltCnfgExists, backupCnfgSetStatus=backupCnfgSetStatus, setup=setup, runCnfgSaveAsStatus=runCnfgSaveAsStatus, currSoftName=currSoftName, backupCnfgPath=backupCnfgPath, nextBootConfig=nextBootConfig, currSoftVersion=currSoftVersion, restartDevice=restartDevice, bootCnfgPath=bootCnfgPath, backupCnfgLastSetResult=backupCnfgLastSetResult, deviceConfiguration=deviceConfiguration, runCnfgLastSaveResult=runCnfgLastSaveResult, srvcTelnetEnable=srvcTelnetEnable, guiAppletSwVer=guiAppletSwVer, serviceConfig=serviceConfig, defaultConfig=defaultConfig, runningConfig=runningConfig, runCnfgSaveAs=runCnfgSaveAs, backupFirmware=backupFirmware, nextBootFirmware=nextBootFirmware, nextBootVersion=nextBootVersion)
