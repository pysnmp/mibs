...
mibBuilder.exportSymbols("AT-SETUP-MIB", backupPath=backupPath, backupCnfgExists=backupCnfgExists, guiAppletConfig=guiAppletConfig, dfltCnfgPath=dfltCnfgPath, backupLastSetResult=backupLastSetResult, dfltCnfgExists=dfltCnfgExists, backupCnfgPath=backupCnfgPath, setup=setup, nextBootPath=nextBootPath, nextBootSetStatus=nextBootSetStatus, bootCnfgPath=bootCnfgPath, backupCnfgSetStatus=backupCnfgSetStatus, PYSNMP_MODULE_ID=setup, bootCnfgSetStatus=bootCnfgSetStatus, runCnfgSaveAs=runCnfgSaveAs, srvcSshEnable=srvcSshEnable, guiAppletSysSwVer=guiAppletSysSwVer, nextBootFirmware=nextBootFirmware, currSoftLastSaveResult=currSoftLastSaveResult, currSoftSaveStatus=currSoftSaveStatus, backupConfig=backupConfig, nextBootLastSetResult=nextBootLastSetResult, SystemFileOperationType=SystemFileOperationType, backupVersion=backupVersion, currentFirmware=currentFirmware, runCnfgSaveAsStatus=runCnfgSaveAsStatus, defaultConfig=defaultConfig, backupFirmware=backupFirmware, guiConfig=guiConfig, nextBootConfig=nextBootConfig, runningConfig=runningConfig, bootCnfgLastSetResult=bootCnfgLastSetResult, runCnfgLastSaveResult=runCnfgLastSaveResult, currSoftVersion=currSoftVersion, currSoftSaveToFile=currSoftSaveToFile, currSoftName=currSoftName, backupCnfgLastSetResult=backupCnfgLastSetResult, serviceConfig=serviceConfig, guiAppletSwVer=guiAppletSwVer, deviceConfiguration=deviceConfiguration, currSoftSaveAs=currSoftSaveAs, restartStkMemberDevice=restartStkMemberDevice, bootCnfgExists=bootCnfgExists, restartDevice=restartDevice, srvcTelnetEnable=srvcTelnetEnable, backupSetStatus=backupSetStatus, firmware=firmware, nextBootVersion=nextBootVersion)
