...
mibBuilder.exportSymbols("AT-SETUP-MIB", nextBootLastSetResult=nextBootLastSetResult, backupCnfgPath=backupCnfgPath, currSoftName=currSoftName, SystemFileOperationType=SystemFileOperationType, runCnfgSaveAsStatus=runCnfgSaveAsStatus, PYSNMP_MODULE_ID=setup, runCnfgLastSaveResult=runCnfgLastSaveResult, firmware=firmware, backupCnfgLastSetResult=backupCnfgLastSetResult, dfltCnfgPath=dfltCnfgPath, guiConfig=guiConfig, backupLastSetResult=backupLastSetResult, restartStkMemberDevice=restartStkMemberDevice, restartDevice=restartDevice, currSoftSaveStatus=currSoftSaveStatus, runCnfgSaveAs=runCnfgSaveAs, dfltCnfgExists=dfltCnfgExists, backupPath=backupPath, backupVersion=backupVersion, currSoftVersion=currSoftVersion, defaultConfig=defaultConfig, backupFirmware=backupFirmware, guiAppletSysSwVer=guiAppletSysSwVer, setup=setup, bootCnfgSetStatus=bootCnfgSetStatus, serviceConfig=serviceConfig, bootCnfgLastSetResult=bootCnfgLastSetResult, guiAppletSwVer=guiAppletSwVer, backupCnfgExists=backupCnfgExists, deviceConfiguration=deviceConfiguration, backupCnfgSetStatus=backupCnfgSetStatus, currSoftSaveAs=currSoftSaveAs, guiAppletConfig=guiAppletConfig, srvcSshEnable=srvcSshEnable, currSoftSaveToFile=currSoftSaveToFile, backupConfig=backupConfig, currSoftLastSaveResult=currSoftLastSaveResult, runningConfig=runningConfig, nextBootPath=nextBootPath, nextBootSetStatus=nextBootSetStatus, backupSetStatus=backupSetStatus, nextBootFirmware=nextBootFirmware, bootCnfgPath=bootCnfgPath, bootCnfgExists=bootCnfgExists, currentFirmware=currentFirmware, nextBootConfig=nextBootConfig, nextBootVersion=nextBootVersion, srvcTelnetEnable=srvcTelnetEnable)
