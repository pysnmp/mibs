...
mibBuilder.exportSymbols("AT-SETUP-MIB", backupPath=backupPath, srvcTelnetEnable=srvcTelnetEnable, guiAppletConfig=guiAppletConfig, currSoftSaveAs=currSoftSaveAs, nextBootPath=nextBootPath, guiAppletSysSwVer=guiAppletSysSwVer, currentFirmware=currentFirmware, nextBootLastSetResult=nextBootLastSetResult, serviceConfig=serviceConfig, restartDevice=restartDevice, runningConfig=runningConfig, PYSNMP_MODULE_ID=setup, runCnfgSaveAs=runCnfgSaveAs, nextBootSetStatus=nextBootSetStatus, backupCnfgPath=backupCnfgPath, runCnfgSaveAsStatus=runCnfgSaveAsStatus, SystemFileOperationType=SystemFileOperationType, bootCnfgPath=bootCnfgPath, setup=setup, firmware=firmware, currSoftName=currSoftName, backupCnfgLastSetResult=backupCnfgLastSetResult, backupFirmware=backupFirmware, nextBootConfig=nextBootConfig, guiAppletSwVer=guiAppletSwVer, currSoftSaveStatus=currSoftSaveStatus, backupLastSetResult=backupLastSetResult, currSoftVersion=currSoftVersion, backupCnfgSetStatus=backupCnfgSetStatus, deviceConfiguration=deviceConfiguration, backupCnfgExists=backupCnfgExists, backupConfig=backupConfig, nextBootFirmware=nextBootFirmware, backupSetStatus=backupSetStatus, guiConfig=guiConfig, dfltCnfgPath=dfltCnfgPath, runCnfgLastSaveResult=runCnfgLastSaveResult, nextBootVersion=nextBootVersion, currSoftLastSaveResult=currSoftLastSaveResult, dfltCnfgExists=dfltCnfgExists, restartStkMemberDevice=restartStkMemberDevice, currSoftSaveToFile=currSoftSaveToFile, srvcSshEnable=srvcSshEnable, defaultConfig=defaultConfig, bootCnfgExists=bootCnfgExists, bootCnfgSetStatus=bootCnfgSetStatus, bootCnfgLastSetResult=bootCnfgLastSetResult, backupVersion=backupVersion)
