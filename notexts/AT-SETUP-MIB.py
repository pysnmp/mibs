...
mibBuilder.exportSymbols("AT-SETUP-MIB", guiAppletSysSwVer=guiAppletSysSwVer, srvcTelnetEnable=srvcTelnetEnable, runCnfgSaveAs=runCnfgSaveAs, nextBootFirmware=nextBootFirmware, currSoftVersion=currSoftVersion, PYSNMP_MODULE_ID=setup, backupCnfgSetStatus=backupCnfgSetStatus, backupFirmware=backupFirmware, runCnfgLastSaveResult=runCnfgLastSaveResult, guiAppletSwVer=guiAppletSwVer, nextBootPath=nextBootPath, SystemFileOperationType=SystemFileOperationType, currSoftSaveToFile=currSoftSaveToFile, backupLastSetResult=backupLastSetResult, nextBootConfig=nextBootConfig, nextBootSetStatus=nextBootSetStatus, dfltCnfgPath=dfltCnfgPath, backupCnfgPath=backupCnfgPath, currSoftName=currSoftName, bootCnfgExists=bootCnfgExists, backupCnfgExists=backupCnfgExists, bootCnfgLastSetResult=bootCnfgLastSetResult, guiConfig=guiConfig, runningConfig=runningConfig, nextBootVersion=nextBootVersion, defaultConfig=defaultConfig, nextBootLastSetResult=nextBootLastSetResult, restartDevice=restartDevice, backupCnfgLastSetResult=backupCnfgLastSetResult, bootCnfgPath=bootCnfgPath, serviceConfig=serviceConfig, currSoftSaveStatus=currSoftSaveStatus, deviceConfiguration=deviceConfiguration, restartStkMemberDevice=restartStkMemberDevice, currSoftSaveAs=currSoftSaveAs, currentFirmware=currentFirmware, srvcSshEnable=srvcSshEnable, backupPath=backupPath, bootCnfgSetStatus=bootCnfgSetStatus, setup=setup, runCnfgSaveAsStatus=runCnfgSaveAsStatus, backupConfig=backupConfig, backupVersion=backupVersion, dfltCnfgExists=dfltCnfgExists, currSoftLastSaveResult=currSoftLastSaveResult, guiAppletConfig=guiAppletConfig, backupSetStatus=backupSetStatus, firmware=firmware)
