...
mibBuilder.exportSymbols("AT-SETUP-MIB", currentFirmware=currentFirmware, bootCnfgLastSetResult=bootCnfgLastSetResult, currSoftSaveStatus=currSoftSaveStatus, runCnfgSaveAsStatus=runCnfgSaveAsStatus, guiAppletSwVer=guiAppletSwVer, firmware=firmware, nextBootLastSetResult=nextBootLastSetResult, currSoftLastSaveResult=currSoftLastSaveResult, currSoftSaveAs=currSoftSaveAs, backupCnfgExists=backupCnfgExists, guiAppletConfig=guiAppletConfig, backupFirmware=backupFirmware, backupPath=backupPath, currSoftVersion=currSoftVersion, SystemFileOperationType=SystemFileOperationType, bootCnfgExists=bootCnfgExists, nextBootFirmware=nextBootFirmware, PYSNMP_MODULE_ID=setup, restartStkMemberDevice=restartStkMemberDevice, srvcSshEnable=srvcSshEnable, backupConfig=backupConfig, srvcTelnetEnable=srvcTelnetEnable, backupCnfgPath=backupCnfgPath, bootCnfgPath=bootCnfgPath, backupCnfgSetStatus=backupCnfgSetStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, setup=setup, runCnfgLastSaveResult=runCnfgLastSaveResult, nextBootConfig=nextBootConfig, backupSetStatus=backupSetStatus, deviceConfiguration=deviceConfiguration, runCnfgSaveAs=runCnfgSaveAs, nextBootPath=nextBootPath, currSoftSaveToFile=currSoftSaveToFile, nextBootSetStatus=nextBootSetStatus, restartDevice=restartDevice, bootCnfgSetStatus=bootCnfgSetStatus, dfltCnfgExists=dfltCnfgExists, dfltCnfgPath=dfltCnfgPath, defaultConfig=defaultConfig, currSoftName=currSoftName, nextBootVersion=nextBootVersion, guiAppletSysSwVer=guiAppletSysSwVer, serviceConfig=serviceConfig, backupVersion=backupVersion, runningConfig=runningConfig, backupLastSetResult=backupLastSetResult, guiConfig=guiConfig)
