...
mibBuilder.exportSymbols("AT-SETUP-MIB", nextBootSetStatus=nextBootSetStatus, backupVersion=backupVersion, backupLastSetResult=backupLastSetResult, backupCnfgExists=backupCnfgExists, runningConfig=runningConfig, setup=setup, restartDevice=restartDevice, currentFirmware=currentFirmware, srvcTelnetEnable=srvcTelnetEnable, bootCnfgLastSetResult=bootCnfgLastSetResult, nextBootVersion=nextBootVersion, currSoftSaveToFile=currSoftSaveToFile, guiAppletSysSwVer=guiAppletSysSwVer, nextBootConfig=nextBootConfig, runCnfgSaveAs=runCnfgSaveAs, backupCnfgLastSetResult=backupCnfgLastSetResult, currSoftVersion=currSoftVersion, dfltCnfgExists=dfltCnfgExists, backupPath=backupPath, currSoftName=currSoftName, backupSetStatus=backupSetStatus, runCnfgSaveAsStatus=runCnfgSaveAsStatus, nextBootLastSetResult=nextBootLastSetResult, bootCnfgPath=bootCnfgPath, backupConfig=backupConfig, PYSNMP_MODULE_ID=setup, firmware=firmware, currSoftSaveAs=currSoftSaveAs, guiAppletSwVer=guiAppletSwVer, runCnfgLastSaveResult=runCnfgLastSaveResult, bootCnfgExists=bootCnfgExists, restartStkMemberDevice=restartStkMemberDevice, serviceConfig=serviceConfig, guiConfig=guiConfig, defaultConfig=defaultConfig, backupFirmware=backupFirmware, deviceConfiguration=deviceConfiguration, backupCnfgPath=backupCnfgPath, SystemFileOperationType=SystemFileOperationType, bootCnfgSetStatus=bootCnfgSetStatus, dfltCnfgPath=dfltCnfgPath, nextBootPath=nextBootPath, currSoftLastSaveResult=currSoftLastSaveResult, guiAppletConfig=guiAppletConfig, nextBootFirmware=nextBootFirmware, srvcSshEnable=srvcSshEnable, backupCnfgSetStatus=backupCnfgSetStatus, currSoftSaveStatus=currSoftSaveStatus)
