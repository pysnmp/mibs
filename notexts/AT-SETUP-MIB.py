...
mibBuilder.exportSymbols("AT-SETUP-MIB", guiAppletSwVer=guiAppletSwVer, srvcSshEnable=srvcSshEnable, dfltCnfgExists=dfltCnfgExists, firmware=firmware, guiConfig=guiConfig, backupCnfgLastSetResult=backupCnfgLastSetResult, backupVersion=backupVersion, setup=setup, backupSetStatus=backupSetStatus, defaultConfig=defaultConfig, currSoftName=currSoftName, nextBootConfig=nextBootConfig, backupLastSetResult=backupLastSetResult, dfltCnfgPath=dfltCnfgPath, bootCnfgPath=bootCnfgPath, nextBootSetStatus=nextBootSetStatus, currentFirmware=currentFirmware, restartStkMemberDevice=restartStkMemberDevice, backupCnfgExists=backupCnfgExists, bootCnfgLastSetResult=bootCnfgLastSetResult, PYSNMP_MODULE_ID=setup, backupPath=backupPath, runCnfgLastSaveResult=runCnfgLastSaveResult, backupCnfgSetStatus=backupCnfgSetStatus, currSoftLastSaveResult=currSoftLastSaveResult, nextBootLastSetResult=nextBootLastSetResult, srvcTelnetEnable=srvcTelnetEnable, guiAppletConfig=guiAppletConfig, bootCnfgSetStatus=bootCnfgSetStatus, restartDevice=restartDevice, runCnfgSaveAs=runCnfgSaveAs, backupCnfgPath=backupCnfgPath, backupConfig=backupConfig, runningConfig=runningConfig, nextBootPath=nextBootPath, currSoftSaveToFile=currSoftSaveToFile, currSoftSaveAs=currSoftSaveAs, runCnfgSaveAsStatus=runCnfgSaveAsStatus, backupFirmware=backupFirmware, nextBootFirmware=nextBootFirmware, guiAppletSysSwVer=guiAppletSysSwVer, nextBootVersion=nextBootVersion, currSoftVersion=currSoftVersion, deviceConfiguration=deviceConfiguration, bootCnfgExists=bootCnfgExists, currSoftSaveStatus=currSoftSaveStatus, serviceConfig=serviceConfig, SystemFileOperationType=SystemFileOperationType)
