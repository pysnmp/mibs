...
mibBuilder.exportSymbols("AT-SETUP-MIB", guiAppletConfig=guiAppletConfig, backupCnfgPath=backupCnfgPath, backupSetStatus=backupSetStatus, srvcSshEnable=srvcSshEnable, backupVersion=backupVersion, backupLastSetResult=backupLastSetResult, defaultConfig=defaultConfig, nextBootFirmware=nextBootFirmware, runCnfgLastSaveResult=runCnfgLastSaveResult, nextBootPath=nextBootPath, nextBootLastSetResult=nextBootLastSetResult, deviceConfiguration=deviceConfiguration, bootCnfgSetStatus=bootCnfgSetStatus, bootCnfgPath=bootCnfgPath, bootCnfgLastSetResult=bootCnfgLastSetResult, runCnfgSaveAs=runCnfgSaveAs, backupCnfgSetStatus=backupCnfgSetStatus, guiAppletSysSwVer=guiAppletSysSwVer, currSoftName=currSoftName, guiConfig=guiConfig, guiAppletSwVer=guiAppletSwVer, firmware=firmware, currSoftLastSaveResult=currSoftLastSaveResult, backupFirmware=backupFirmware, dfltCnfgPath=dfltCnfgPath, backupCnfgExists=backupCnfgExists, serviceConfig=serviceConfig, nextBootVersion=nextBootVersion, currSoftSaveToFile=currSoftSaveToFile, backupCnfgLastSetResult=backupCnfgLastSetResult, SystemFileOperationType=SystemFileOperationType, srvcTelnetEnable=srvcTelnetEnable, nextBootSetStatus=nextBootSetStatus, backupConfig=backupConfig, backupPath=backupPath, dfltCnfgExists=dfltCnfgExists, nextBootConfig=nextBootConfig, currSoftSaveAs=currSoftSaveAs, restartStkMemberDevice=restartStkMemberDevice, setup=setup, currentFirmware=currentFirmware, currSoftVersion=currSoftVersion, restartDevice=restartDevice, runningConfig=runningConfig, runCnfgSaveAsStatus=runCnfgSaveAsStatus, PYSNMP_MODULE_ID=setup, currSoftSaveStatus=currSoftSaveStatus, bootCnfgExists=bootCnfgExists)
