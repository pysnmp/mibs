...
mibBuilder.exportSymbols("AT-SETUP-MIB", backupVersion=backupVersion, runCnfgSaveAsStatus=runCnfgSaveAsStatus, nextBootLastSetResult=nextBootLastSetResult, bootCnfgExists=bootCnfgExists, restartStkMemberDevice=restartStkMemberDevice, backupCnfgExists=backupCnfgExists, guiAppletConfig=guiAppletConfig, currSoftSaveAs=currSoftSaveAs, nextBootSetStatus=nextBootSetStatus, setup=setup, nextBootVersion=nextBootVersion, runningConfig=runningConfig, backupFirmware=backupFirmware, backupCnfgLastSetResult=backupCnfgLastSetResult, restartDevice=restartDevice, currSoftName=currSoftName, dfltCnfgPath=dfltCnfgPath, runCnfgLastSaveResult=runCnfgLastSaveResult, currSoftVersion=currSoftVersion, backupLastSetResult=backupLastSetResult, bootCnfgSetStatus=bootCnfgSetStatus, firmware=firmware, backupCnfgPath=backupCnfgPath, guiAppletSysSwVer=guiAppletSysSwVer, backupPath=backupPath, nextBootConfig=nextBootConfig, bootCnfgPath=bootCnfgPath, SystemFileOperationType=SystemFileOperationType, srvcSshEnable=srvcSshEnable, serviceConfig=serviceConfig, backupSetStatus=backupSetStatus, defaultConfig=defaultConfig, currentFirmware=currentFirmware, deviceConfiguration=deviceConfiguration, runCnfgSaveAs=runCnfgSaveAs, guiAppletSwVer=guiAppletSwVer, nextBootFirmware=nextBootFirmware, backupConfig=backupConfig, backupCnfgSetStatus=backupCnfgSetStatus, guiConfig=guiConfig, currSoftSaveToFile=currSoftSaveToFile, currSoftSaveStatus=currSoftSaveStatus, currSoftLastSaveResult=currSoftLastSaveResult, srvcTelnetEnable=srvcTelnetEnable, nextBootPath=nextBootPath, PYSNMP_MODULE_ID=setup, dfltCnfgExists=dfltCnfgExists, bootCnfgLastSetResult=bootCnfgLastSetResult)
