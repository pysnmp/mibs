...
mibBuilder.exportSymbols("AT-SETUP-MIB", srvcSshEnable=srvcSshEnable, runCnfgSaveAs=runCnfgSaveAs, nextBootConfig=nextBootConfig, backupCnfgSetStatus=backupCnfgSetStatus, defaultConfig=defaultConfig, restartDevice=restartDevice, backupPath=backupPath, PYSNMP_MODULE_ID=setup, backupCnfgPath=backupCnfgPath, backupCnfgExists=backupCnfgExists, guiAppletSwVer=guiAppletSwVer, currentFirmware=currentFirmware, guiConfig=guiConfig, bootCnfgSetStatus=bootCnfgSetStatus, nextBootSetStatus=nextBootSetStatus, restartStkMemberDevice=restartStkMemberDevice, currSoftVersion=currSoftVersion, runningConfig=runningConfig, nextBootFirmware=nextBootFirmware, bootCnfgExists=bootCnfgExists, setup=setup, nextBootVersion=nextBootVersion, guiAppletConfig=guiAppletConfig, backupFirmware=backupFirmware, guiAppletSysSwVer=guiAppletSysSwVer, currSoftSaveAs=currSoftSaveAs, bootCnfgPath=bootCnfgPath, backupLastSetResult=backupLastSetResult, deviceConfiguration=deviceConfiguration, runCnfgLastSaveResult=runCnfgLastSaveResult, nextBootLastSetResult=nextBootLastSetResult, currSoftSaveStatus=currSoftSaveStatus, backupSetStatus=backupSetStatus, currSoftSaveToFile=currSoftSaveToFile, currSoftName=currSoftName, firmware=firmware, dfltCnfgExists=dfltCnfgExists, srvcTelnetEnable=srvcTelnetEnable, bootCnfgLastSetResult=bootCnfgLastSetResult, dfltCnfgPath=dfltCnfgPath, currSoftLastSaveResult=currSoftLastSaveResult, backupCnfgLastSetResult=backupCnfgLastSetResult, runCnfgSaveAsStatus=runCnfgSaveAsStatus, backupConfig=backupConfig, serviceConfig=serviceConfig, SystemFileOperationType=SystemFileOperationType, nextBootPath=nextBootPath, backupVersion=backupVersion)
