...
mibBuilder.exportSymbols("AT-SETUP-MIB", setup=setup, srvcTelnetEnable=srvcTelnetEnable, currSoftVersion=currSoftVersion, guiAppletSysSwVer=guiAppletSysSwVer, nextBootLastSetResult=nextBootLastSetResult, backupConfig=backupConfig, guiConfig=guiConfig, runCnfgSaveAs=runCnfgSaveAs, nextBootSetStatus=nextBootSetStatus, currSoftSaveToFile=currSoftSaveToFile, PYSNMP_MODULE_ID=setup, dfltCnfgExists=dfltCnfgExists, currSoftSaveStatus=currSoftSaveStatus, nextBootVersion=nextBootVersion, currSoftName=currSoftName, SystemFileOperationType=SystemFileOperationType, serviceConfig=serviceConfig, dfltCnfgPath=dfltCnfgPath, backupVersion=backupVersion, runCnfgLastSaveResult=runCnfgLastSaveResult, defaultConfig=defaultConfig, nextBootFirmware=nextBootFirmware, restartStkMemberDevice=restartStkMemberDevice, guiAppletConfig=guiAppletConfig, bootCnfgExists=bootCnfgExists, currSoftLastSaveResult=currSoftLastSaveResult, bootCnfgSetStatus=bootCnfgSetStatus, guiAppletSwVer=guiAppletSwVer, backupCnfgExists=backupCnfgExists, backupPath=backupPath, restartDevice=restartDevice, deviceConfiguration=deviceConfiguration, nextBootConfig=nextBootConfig, backupCnfgLastSetResult=backupCnfgLastSetResult, currSoftSaveAs=currSoftSaveAs, backupFirmware=backupFirmware, currentFirmware=currentFirmware, bootCnfgLastSetResult=bootCnfgLastSetResult, backupCnfgPath=backupCnfgPath, backupSetStatus=backupSetStatus, backupCnfgSetStatus=backupCnfgSetStatus, srvcSshEnable=srvcSshEnable, bootCnfgPath=bootCnfgPath, runningConfig=runningConfig, nextBootPath=nextBootPath, runCnfgSaveAsStatus=runCnfgSaveAsStatus, backupLastSetResult=backupLastSetResult, firmware=firmware)
