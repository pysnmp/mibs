...
mibBuilder.exportSymbols("AT-SETUP-MIB", backupCnfgLastSetResult=backupCnfgLastSetResult, currentFirmware=currentFirmware, backupLastSetResult=backupLastSetResult, srvcSshEnable=srvcSshEnable, srvcTelnetEnable=srvcTelnetEnable, deviceConfiguration=deviceConfiguration, guiAppletSwVer=guiAppletSwVer, nextBootPath=nextBootPath, backupPath=backupPath, runCnfgSaveAs=runCnfgSaveAs, SystemFileOperationType=SystemFileOperationType, backupVersion=backupVersion, runCnfgLastSaveResult=runCnfgLastSaveResult, guiAppletConfig=guiAppletConfig, nextBootVersion=nextBootVersion, backupConfig=backupConfig, guiConfig=guiConfig, backupSetStatus=backupSetStatus, dfltCnfgExists=dfltCnfgExists, restartDevice=restartDevice, currSoftLastSaveResult=currSoftLastSaveResult, firmware=firmware, bootCnfgPath=bootCnfgPath, dfltCnfgPath=dfltCnfgPath, currSoftVersion=currSoftVersion, setup=setup, runningConfig=runningConfig, currSoftSaveStatus=currSoftSaveStatus, currSoftSaveToFile=currSoftSaveToFile, nextBootSetStatus=nextBootSetStatus, guiAppletSysSwVer=guiAppletSysSwVer, restartStkMemberDevice=restartStkMemberDevice, PYSNMP_MODULE_ID=setup, nextBootConfig=nextBootConfig, nextBootLastSetResult=nextBootLastSetResult, currSoftSaveAs=currSoftSaveAs, defaultConfig=defaultConfig, backupFirmware=backupFirmware, bootCnfgExists=bootCnfgExists, backupCnfgExists=backupCnfgExists, currSoftName=currSoftName, runCnfgSaveAsStatus=runCnfgSaveAsStatus, serviceConfig=serviceConfig, backupCnfgPath=backupCnfgPath, bootCnfgSetStatus=bootCnfgSetStatus, backupCnfgSetStatus=backupCnfgSetStatus, nextBootFirmware=nextBootFirmware, bootCnfgLastSetResult=bootCnfgLastSetResult)
