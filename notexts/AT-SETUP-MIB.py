...
mibBuilder.exportSymbols("AT-SETUP-MIB", backupCnfgSetStatus=backupCnfgSetStatus, currSoftSaveToFile=currSoftSaveToFile, bootCnfgSetStatus=bootCnfgSetStatus, SystemFileOperationType=SystemFileOperationType, currSoftSaveStatus=currSoftSaveStatus, bootCnfgPath=bootCnfgPath, runCnfgLastSaveResult=runCnfgLastSaveResult, nextBootConfig=nextBootConfig, currSoftName=currSoftName, nextBootFirmware=nextBootFirmware, nextBootPath=nextBootPath, backupCnfgPath=backupCnfgPath, backupVersion=backupVersion, setup=setup, backupLastSetResult=backupLastSetResult, backupConfig=backupConfig, restartStkMemberDevice=restartStkMemberDevice, currentFirmware=currentFirmware, dfltCnfgExists=dfltCnfgExists, firmware=firmware, bootCnfgExists=bootCnfgExists, nextBootSetStatus=nextBootSetStatus, backupPath=backupPath, nextBootLastSetResult=nextBootLastSetResult, currSoftLastSaveResult=currSoftLastSaveResult, backupFirmware=backupFirmware, nextBootVersion=nextBootVersion, backupCnfgLastSetResult=backupCnfgLastSetResult, runCnfgSaveAsStatus=runCnfgSaveAsStatus, bootCnfgLastSetResult=bootCnfgLastSetResult, backupCnfgExists=backupCnfgExists, currSoftSaveAs=currSoftSaveAs, srvcTelnetEnable=srvcTelnetEnable, guiAppletConfig=guiAppletConfig, guiAppletSysSwVer=guiAppletSysSwVer, restartDevice=restartDevice, backupSetStatus=backupSetStatus, dfltCnfgPath=dfltCnfgPath, serviceConfig=serviceConfig, currSoftVersion=currSoftVersion, defaultConfig=defaultConfig, guiAppletSwVer=guiAppletSwVer, guiConfig=guiConfig, srvcSshEnable=srvcSshEnable, runningConfig=runningConfig, runCnfgSaveAs=runCnfgSaveAs, deviceConfiguration=deviceConfiguration, PYSNMP_MODULE_ID=setup)
