...
mibBuilder.exportSymbols("AT-SETUP-MIB", backupConfig=backupConfig, backupLastSetResult=backupLastSetResult, currSoftSaveAs=currSoftSaveAs, backupFirmware=backupFirmware, backupSetStatus=backupSetStatus, currSoftLastSaveResult=currSoftLastSaveResult, runCnfgSaveAsStatus=runCnfgSaveAsStatus, nextBootVersion=nextBootVersion, dfltCnfgPath=dfltCnfgPath, backupCnfgLastSetResult=backupCnfgLastSetResult, srvcTelnetEnable=srvcTelnetEnable, defaultConfig=defaultConfig, deviceConfiguration=deviceConfiguration, guiAppletSysSwVer=guiAppletSysSwVer, currSoftVersion=currSoftVersion, PYSNMP_MODULE_ID=setup, srvcSshEnable=srvcSshEnable, guiConfig=guiConfig, nextBootLastSetResult=nextBootLastSetResult, serviceConfig=serviceConfig, SystemFileOperationType=SystemFileOperationType, restartDevice=restartDevice, nextBootSetStatus=nextBootSetStatus, bootCnfgExists=bootCnfgExists, currSoftName=currSoftName, backupVersion=backupVersion, runCnfgSaveAs=runCnfgSaveAs, dfltCnfgExists=dfltCnfgExists, guiAppletSwVer=guiAppletSwVer, guiAppletConfig=guiAppletConfig, setup=setup, backupCnfgPath=backupCnfgPath, backupPath=backupPath, restartStkMemberDevice=restartStkMemberDevice, nextBootFirmware=nextBootFirmware, nextBootPath=nextBootPath, runningConfig=runningConfig, runCnfgLastSaveResult=runCnfgLastSaveResult, bootCnfgPath=bootCnfgPath, backupCnfgExists=backupCnfgExists, bootCnfgSetStatus=bootCnfgSetStatus, bootCnfgLastSetResult=bootCnfgLastSetResult, currentFirmware=currentFirmware, currSoftSaveToFile=currSoftSaveToFile, firmware=firmware, currSoftSaveStatus=currSoftSaveStatus, nextBootConfig=nextBootConfig, backupCnfgSetStatus=backupCnfgSetStatus)
