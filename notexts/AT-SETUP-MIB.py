...
mibBuilder.exportSymbols("AT-SETUP-MIB", restartStkMemberDevice=restartStkMemberDevice, nextBootVersion=nextBootVersion, currSoftLastSaveResult=currSoftLastSaveResult, runCnfgSaveAs=runCnfgSaveAs, bootCnfgExists=bootCnfgExists, currSoftSaveAs=currSoftSaveAs, currSoftSaveToFile=currSoftSaveToFile, backupPath=backupPath, bootCnfgSetStatus=bootCnfgSetStatus, backupVersion=backupVersion, firmware=firmware, nextBootLastSetResult=nextBootLastSetResult, guiAppletConfig=guiAppletConfig, SystemFileOperationType=SystemFileOperationType, backupCnfgLastSetResult=backupCnfgLastSetResult, currSoftVersion=currSoftVersion, srvcTelnetEnable=srvcTelnetEnable, runningConfig=runningConfig, dfltCnfgExists=dfltCnfgExists, backupConfig=backupConfig, currentFirmware=currentFirmware, dfltCnfgPath=dfltCnfgPath, nextBootSetStatus=nextBootSetStatus, deviceConfiguration=deviceConfiguration, backupCnfgPath=backupCnfgPath, nextBootFirmware=nextBootFirmware, guiConfig=guiConfig, guiAppletSysSwVer=guiAppletSysSwVer, defaultConfig=defaultConfig, currSoftName=currSoftName, PYSNMP_MODULE_ID=setup, backupFirmware=backupFirmware, srvcSshEnable=srvcSshEnable, nextBootPath=nextBootPath, runCnfgSaveAsStatus=runCnfgSaveAsStatus, bootCnfgLastSetResult=bootCnfgLastSetResult, backupSetStatus=backupSetStatus, setup=setup, backupCnfgExists=backupCnfgExists, runCnfgLastSaveResult=runCnfgLastSaveResult, restartDevice=restartDevice, nextBootConfig=nextBootConfig, serviceConfig=serviceConfig, bootCnfgPath=bootCnfgPath, guiAppletSwVer=guiAppletSwVer, backupCnfgSetStatus=backupCnfgSetStatus, backupLastSetResult=backupLastSetResult, currSoftSaveStatus=currSoftSaveStatus)
