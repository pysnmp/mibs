...
mibBuilder.exportSymbols("AT-SETUP-MIB", dfltCnfgPath=dfltCnfgPath, backupLastSetResult=backupLastSetResult, guiAppletSwVer=guiAppletSwVer, firmware=firmware, setup=setup, backupCnfgLastSetResult=backupCnfgLastSetResult, backupFirmware=backupFirmware, serviceConfig=serviceConfig, restartDevice=restartDevice, currSoftSaveToFile=currSoftSaveToFile, PYSNMP_MODULE_ID=setup, runCnfgSaveAs=runCnfgSaveAs, runCnfgSaveAsStatus=runCnfgSaveAsStatus, runCnfgLastSaveResult=runCnfgLastSaveResult, deviceConfiguration=deviceConfiguration, guiConfig=guiConfig, currSoftSaveStatus=currSoftSaveStatus, currSoftSaveAs=currSoftSaveAs, currSoftLastSaveResult=currSoftLastSaveResult, guiAppletConfig=guiAppletConfig, guiAppletSysSwVer=guiAppletSysSwVer, bootCnfgExists=bootCnfgExists, bootCnfgLastSetResult=bootCnfgLastSetResult, backupSetStatus=backupSetStatus, nextBootLastSetResult=nextBootLastSetResult, SystemFileOperationType=SystemFileOperationType, currSoftVersion=currSoftVersion, backupConfig=backupConfig, nextBootPath=nextBootPath, backupCnfgPath=backupCnfgPath, bootCnfgPath=bootCnfgPath, nextBootSetStatus=nextBootSetStatus, dfltCnfgExists=dfltCnfgExists, currSoftName=currSoftName, restartStkMemberDevice=restartStkMemberDevice, backupCnfgSetStatus=backupCnfgSetStatus, backupVersion=backupVersion, backupPath=backupPath, runningConfig=runningConfig, bootCnfgSetStatus=bootCnfgSetStatus, nextBootVersion=nextBootVersion, srvcTelnetEnable=srvcTelnetEnable, nextBootFirmware=nextBootFirmware, srvcSshEnable=srvcSshEnable, backupCnfgExists=backupCnfgExists, defaultConfig=defaultConfig, currentFirmware=currentFirmware, nextBootConfig=nextBootConfig)
