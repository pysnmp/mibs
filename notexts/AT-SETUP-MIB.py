...
mibBuilder.exportSymbols("AT-SETUP-MIB", currSoftName=currSoftName, backupSetStatus=backupSetStatus, backupCnfgSetStatus=backupCnfgSetStatus, currSoftSaveToFile=currSoftSaveToFile, nextBootFirmware=nextBootFirmware, restartStkMemberDevice=restartStkMemberDevice, runCnfgLastSaveResult=runCnfgLastSaveResult, guiConfig=guiConfig, srvcTelnetEnable=srvcTelnetEnable, SystemFileOperationType=SystemFileOperationType, nextBootSetStatus=nextBootSetStatus, guiAppletSysSwVer=guiAppletSysSwVer, bootCnfgSetStatus=bootCnfgSetStatus, runCnfgSaveAsStatus=runCnfgSaveAsStatus, PYSNMP_MODULE_ID=setup, backupLastSetResult=backupLastSetResult, nextBootConfig=nextBootConfig, firmware=firmware, restartDevice=restartDevice, nextBootVersion=nextBootVersion, srvcSshEnable=srvcSshEnable, serviceConfig=serviceConfig, currSoftSaveStatus=currSoftSaveStatus, bootCnfgExists=bootCnfgExists, backupConfig=backupConfig, currSoftVersion=currSoftVersion, currentFirmware=currentFirmware, defaultConfig=defaultConfig, backupCnfgExists=backupCnfgExists, dfltCnfgPath=dfltCnfgPath, backupCnfgLastSetResult=backupCnfgLastSetResult, bootCnfgLastSetResult=bootCnfgLastSetResult, currSoftSaveAs=currSoftSaveAs, backupFirmware=backupFirmware, runCnfgSaveAs=runCnfgSaveAs, backupVersion=backupVersion, backupCnfgPath=backupCnfgPath, setup=setup, backupPath=backupPath, guiAppletSwVer=guiAppletSwVer, deviceConfiguration=deviceConfiguration, currSoftLastSaveResult=currSoftLastSaveResult, guiAppletConfig=guiAppletConfig, bootCnfgPath=bootCnfgPath, runningConfig=runningConfig, dfltCnfgExists=dfltCnfgExists, nextBootPath=nextBootPath, nextBootLastSetResult=nextBootLastSetResult)
