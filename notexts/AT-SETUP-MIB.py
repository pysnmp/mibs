...
mibBuilder.exportSymbols("AT-SETUP-MIB", nextBootVersion=nextBootVersion, backupVersion=backupVersion, guiAppletSysSwVer=guiAppletSysSwVer, currSoftVersion=currSoftVersion, nextBootSetStatus=nextBootSetStatus, firmware=firmware, nextBootLastSetResult=nextBootLastSetResult, backupFirmware=backupFirmware, serviceConfig=serviceConfig, runCnfgSaveAsStatus=runCnfgSaveAsStatus, currSoftName=currSoftName, runCnfgSaveAs=runCnfgSaveAs, currSoftSaveToFile=currSoftSaveToFile, currentFirmware=currentFirmware, backupCnfgExists=backupCnfgExists, backupCnfgLastSetResult=backupCnfgLastSetResult, srvcSshEnable=srvcSshEnable, nextBootFirmware=nextBootFirmware, deviceConfiguration=deviceConfiguration, defaultConfig=defaultConfig, backupCnfgSetStatus=backupCnfgSetStatus, restartDevice=restartDevice, guiAppletSwVer=guiAppletSwVer, dfltCnfgExists=dfltCnfgExists, backupSetStatus=backupSetStatus, backupPath=backupPath, PYSNMP_MODULE_ID=setup, bootCnfgExists=bootCnfgExists, bootCnfgSetStatus=bootCnfgSetStatus, backupLastSetResult=backupLastSetResult, runCnfgLastSaveResult=runCnfgLastSaveResult, dfltCnfgPath=dfltCnfgPath, runningConfig=runningConfig, setup=setup, backupCnfgPath=backupCnfgPath, nextBootPath=nextBootPath, SystemFileOperationType=SystemFileOperationType, currSoftSaveAs=currSoftSaveAs, guiConfig=guiConfig, bootCnfgPath=bootCnfgPath, nextBootConfig=nextBootConfig, currSoftLastSaveResult=currSoftLastSaveResult, currSoftSaveStatus=currSoftSaveStatus, guiAppletConfig=guiAppletConfig, srvcTelnetEnable=srvcTelnetEnable, restartStkMemberDevice=restartStkMemberDevice, backupConfig=backupConfig, bootCnfgLastSetResult=bootCnfgLastSetResult)
