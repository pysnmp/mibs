...
mibBuilder.exportSymbols("AT-SETUP-MIB", SystemFileOperationType=SystemFileOperationType, runCnfgLastSaveResult=runCnfgLastSaveResult, bootCnfgLastSetResult=bootCnfgLastSetResult, backupVersion=backupVersion, backupCnfgLastSetResult=backupCnfgLastSetResult, nextBootFirmware=nextBootFirmware, restartStkMemberDevice=restartStkMemberDevice, dfltCnfgExists=dfltCnfgExists, deviceConfiguration=deviceConfiguration, backupSetStatus=backupSetStatus, nextBootConfig=nextBootConfig, restartDevice=restartDevice, PYSNMP_MODULE_ID=setup, currSoftVersion=currSoftVersion, currSoftSaveToFile=currSoftSaveToFile, backupCnfgPath=backupCnfgPath, serviceConfig=serviceConfig, nextBootSetStatus=nextBootSetStatus, currSoftName=currSoftName, nextBootVersion=nextBootVersion, nextBootLastSetResult=nextBootLastSetResult, guiConfig=guiConfig, guiAppletSysSwVer=guiAppletSysSwVer, currSoftSaveAs=currSoftSaveAs, currSoftLastSaveResult=currSoftLastSaveResult, backupPath=backupPath, setup=setup, srvcSshEnable=srvcSshEnable, defaultConfig=defaultConfig, bootCnfgExists=bootCnfgExists, nextBootPath=nextBootPath, backupConfig=backupConfig, guiAppletConfig=guiAppletConfig, currSoftSaveStatus=currSoftSaveStatus, bootCnfgSetStatus=bootCnfgSetStatus, guiAppletSwVer=guiAppletSwVer, runCnfgSaveAs=runCnfgSaveAs, backupFirmware=backupFirmware, runningConfig=runningConfig, runCnfgSaveAsStatus=runCnfgSaveAsStatus, bootCnfgPath=bootCnfgPath, firmware=firmware, backupLastSetResult=backupLastSetResult, srvcTelnetEnable=srvcTelnetEnable, backupCnfgExists=backupCnfgExists, currentFirmware=currentFirmware, dfltCnfgPath=dfltCnfgPath, backupCnfgSetStatus=backupCnfgSetStatus)
