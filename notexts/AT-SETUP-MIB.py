...
mibBuilder.exportSymbols("AT-SETUP-MIB", nextBootConfig=nextBootConfig, bootCnfgLastSetResult=bootCnfgLastSetResult, backupConfig=backupConfig, guiAppletSwVer=guiAppletSwVer, runCnfgSaveAsStatus=runCnfgSaveAsStatus, currSoftSaveToFile=currSoftSaveToFile, SystemFileOperationType=SystemFileOperationType, serviceConfig=serviceConfig, guiAppletConfig=guiAppletConfig, dfltCnfgPath=dfltCnfgPath, currentFirmware=currentFirmware, backupCnfgSetStatus=backupCnfgSetStatus, currSoftVersion=currSoftVersion, backupFirmware=backupFirmware, restartDevice=restartDevice, defaultConfig=defaultConfig, runCnfgSaveAs=runCnfgSaveAs, backupCnfgPath=backupCnfgPath, dfltCnfgExists=dfltCnfgExists, currSoftLastSaveResult=currSoftLastSaveResult, setup=setup, bootCnfgSetStatus=bootCnfgSetStatus, backupLastSetResult=backupLastSetResult, nextBootSetStatus=nextBootSetStatus, restartStkMemberDevice=restartStkMemberDevice, guiConfig=guiConfig, firmware=firmware, bootCnfgExists=bootCnfgExists, srvcSshEnable=srvcSshEnable, currSoftName=currSoftName, currSoftSaveStatus=currSoftSaveStatus, nextBootLastSetResult=nextBootLastSetResult, backupCnfgLastSetResult=backupCnfgLastSetResult, guiAppletSysSwVer=guiAppletSysSwVer, backupCnfgExists=backupCnfgExists, backupPath=backupPath, backupSetStatus=backupSetStatus, runningConfig=runningConfig, nextBootPath=nextBootPath, currSoftSaveAs=currSoftSaveAs, nextBootVersion=nextBootVersion, srvcTelnetEnable=srvcTelnetEnable, nextBootFirmware=nextBootFirmware, backupVersion=backupVersion, runCnfgLastSaveResult=runCnfgLastSaveResult, bootCnfgPath=bootCnfgPath, PYSNMP_MODULE_ID=setup, deviceConfiguration=deviceConfiguration)
