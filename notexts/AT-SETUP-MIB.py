...
mibBuilder.exportSymbols("AT-SETUP-MIB", firmware=firmware, bootCnfgSetStatus=bootCnfgSetStatus, nextBootLastSetResult=nextBootLastSetResult, currSoftVersion=currSoftVersion, backupLastSetResult=backupLastSetResult, backupCnfgPath=backupCnfgPath, backupFirmware=backupFirmware, serviceConfig=serviceConfig, nextBootFirmware=nextBootFirmware, currentFirmware=currentFirmware, bootCnfgLastSetResult=bootCnfgLastSetResult, guiAppletSwVer=guiAppletSwVer, currSoftSaveAs=currSoftSaveAs, currSoftSaveStatus=currSoftSaveStatus, PYSNMP_MODULE_ID=setup, backupConfig=backupConfig, nextBootPath=nextBootPath, bootCnfgPath=bootCnfgPath, backupVersion=backupVersion, nextBootConfig=nextBootConfig, guiAppletConfig=guiAppletConfig, restartStkMemberDevice=restartStkMemberDevice, runCnfgSaveAsStatus=runCnfgSaveAsStatus, defaultConfig=defaultConfig, nextBootSetStatus=nextBootSetStatus, setup=setup, dfltCnfgPath=dfltCnfgPath, runCnfgLastSaveResult=runCnfgLastSaveResult, backupCnfgExists=backupCnfgExists, guiConfig=guiConfig, SystemFileOperationType=SystemFileOperationType, deviceConfiguration=deviceConfiguration, backupCnfgLastSetResult=backupCnfgLastSetResult, currSoftName=currSoftName, dfltCnfgExists=dfltCnfgExists, currSoftLastSaveResult=currSoftLastSaveResult, guiAppletSysSwVer=guiAppletSysSwVer, srvcTelnetEnable=srvcTelnetEnable, currSoftSaveToFile=currSoftSaveToFile, runCnfgSaveAs=runCnfgSaveAs, runningConfig=runningConfig, backupPath=backupPath, restartDevice=restartDevice, bootCnfgExists=bootCnfgExists, srvcSshEnable=srvcSshEnable, nextBootVersion=nextBootVersion, backupSetStatus=backupSetStatus, backupCnfgSetStatus=backupCnfgSetStatus)
