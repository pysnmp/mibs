...
mibBuilder.exportSymbols("AT-SETUP-MIB", firmware=firmware, restartStkMemberDevice=restartStkMemberDevice, srvcTelnetEnable=srvcTelnetEnable, runCnfgSaveAs=runCnfgSaveAs, defaultConfig=defaultConfig, SystemFileOperationType=SystemFileOperationType, currSoftSaveStatus=currSoftSaveStatus, bootCnfgLastSetResult=bootCnfgLastSetResult, guiAppletConfig=guiAppletConfig, nextBootFirmware=nextBootFirmware, runCnfgSaveAsStatus=runCnfgSaveAsStatus, currentFirmware=currentFirmware, currSoftSaveToFile=currSoftSaveToFile, srvcSshEnable=srvcSshEnable, dfltCnfgExists=dfltCnfgExists, backupConfig=backupConfig, guiAppletSwVer=guiAppletSwVer, backupVersion=backupVersion, dfltCnfgPath=dfltCnfgPath, nextBootSetStatus=nextBootSetStatus, backupCnfgLastSetResult=backupCnfgLastSetResult, nextBootPath=nextBootPath, runCnfgLastSaveResult=runCnfgLastSaveResult, serviceConfig=serviceConfig, setup=setup, PYSNMP_MODULE_ID=setup, currSoftLastSaveResult=currSoftLastSaveResult, bootCnfgSetStatus=bootCnfgSetStatus, nextBootVersion=nextBootVersion, nextBootLastSetResult=nextBootLastSetResult, backupCnfgExists=backupCnfgExists, currSoftName=currSoftName, backupCnfgSetStatus=backupCnfgSetStatus, backupCnfgPath=backupCnfgPath, guiAppletSysSwVer=guiAppletSysSwVer, backupLastSetResult=backupLastSetResult, backupFirmware=backupFirmware, backupPath=backupPath, backupSetStatus=backupSetStatus, deviceConfiguration=deviceConfiguration, nextBootConfig=nextBootConfig, guiConfig=guiConfig, restartDevice=restartDevice, currSoftVersion=currSoftVersion, bootCnfgPath=bootCnfgPath, currSoftSaveAs=currSoftSaveAs, bootCnfgExists=bootCnfgExists, runningConfig=runningConfig)
