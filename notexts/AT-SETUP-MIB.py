...
mibBuilder.exportSymbols("AT-SETUP-MIB", backupLastSetResult=backupLastSetResult, nextBootVersion=nextBootVersion, bootCnfgPath=bootCnfgPath, backupFirmware=backupFirmware, restartDevice=restartDevice, guiAppletConfig=guiAppletConfig, currSoftLastSaveResult=currSoftLastSaveResult, PYSNMP_MODULE_ID=setup, backupPath=backupPath, backupConfig=backupConfig, restartStkMemberDevice=restartStkMemberDevice, srvcTelnetEnable=srvcTelnetEnable, backupCnfgLastSetResult=backupCnfgLastSetResult, dfltCnfgPath=dfltCnfgPath, runCnfgSaveAs=runCnfgSaveAs, guiAppletSwVer=guiAppletSwVer, currSoftSaveAs=currSoftSaveAs, nextBootFirmware=nextBootFirmware, defaultConfig=defaultConfig, bootCnfgSetStatus=bootCnfgSetStatus, backupVersion=backupVersion, guiConfig=guiConfig, currentFirmware=currentFirmware, runCnfgSaveAsStatus=runCnfgSaveAsStatus, nextBootPath=nextBootPath, firmware=firmware, srvcSshEnable=srvcSshEnable, dfltCnfgExists=dfltCnfgExists, nextBootSetStatus=nextBootSetStatus, bootCnfgLastSetResult=bootCnfgLastSetResult, runCnfgLastSaveResult=runCnfgLastSaveResult, nextBootLastSetResult=nextBootLastSetResult, setup=setup, backupCnfgSetStatus=backupCnfgSetStatus, currSoftName=currSoftName, currSoftSaveToFile=currSoftSaveToFile, currSoftSaveStatus=currSoftSaveStatus, backupSetStatus=backupSetStatus, bootCnfgExists=bootCnfgExists, nextBootConfig=nextBootConfig, backupCnfgExists=backupCnfgExists, guiAppletSysSwVer=guiAppletSysSwVer, deviceConfiguration=deviceConfiguration, serviceConfig=serviceConfig, runningConfig=runningConfig, currSoftVersion=currSoftVersion, SystemFileOperationType=SystemFileOperationType, backupCnfgPath=backupCnfgPath)
