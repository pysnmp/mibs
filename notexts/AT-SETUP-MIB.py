...
mibBuilder.exportSymbols("AT-SETUP-MIB", runningConfig=runningConfig, currSoftLastSaveResult=currSoftLastSaveResult, currSoftVersion=currSoftVersion, deviceConfiguration=deviceConfiguration, currSoftName=currSoftName, srvcTelnetEnable=srvcTelnetEnable, bootCnfgSetStatus=bootCnfgSetStatus, SystemFileOperationType=SystemFileOperationType, nextBootFirmware=nextBootFirmware, backupVersion=backupVersion, backupConfig=backupConfig, restartStkMemberDevice=restartStkMemberDevice, PYSNMP_MODULE_ID=setup, backupCnfgSetStatus=backupCnfgSetStatus, nextBootLastSetResult=nextBootLastSetResult, restartDevice=restartDevice, setup=setup, backupCnfgExists=backupCnfgExists, serviceConfig=serviceConfig, guiAppletConfig=guiAppletConfig, backupSetStatus=backupSetStatus, runCnfgSaveAs=runCnfgSaveAs, backupLastSetResult=backupLastSetResult, guiAppletSysSwVer=guiAppletSysSwVer, currentFirmware=currentFirmware, backupPath=backupPath, currSoftSaveAs=currSoftSaveAs, bootCnfgPath=bootCnfgPath, srvcSshEnable=srvcSshEnable, dfltCnfgPath=dfltCnfgPath, firmware=firmware, guiConfig=guiConfig, currSoftSaveToFile=currSoftSaveToFile, runCnfgLastSaveResult=runCnfgLastSaveResult, backupCnfgLastSetResult=backupCnfgLastSetResult, runCnfgSaveAsStatus=runCnfgSaveAsStatus, bootCnfgExists=bootCnfgExists, backupCnfgPath=backupCnfgPath, nextBootConfig=nextBootConfig, currSoftSaveStatus=currSoftSaveStatus, backupFirmware=backupFirmware, nextBootPath=nextBootPath, nextBootVersion=nextBootVersion, bootCnfgLastSetResult=bootCnfgLastSetResult, defaultConfig=defaultConfig, dfltCnfgExists=dfltCnfgExists, guiAppletSwVer=guiAppletSwVer, nextBootSetStatus=nextBootSetStatus)
