...
mibBuilder.exportSymbols("AT-SETUP-MIB", nextBootPath=nextBootPath, guiAppletSysSwVer=guiAppletSysSwVer, backupCnfgExists=backupCnfgExists, backupConfig=backupConfig, currSoftVersion=currSoftVersion, guiConfig=guiConfig, dfltCnfgExists=dfltCnfgExists, runCnfgLastSaveResult=runCnfgLastSaveResult, currSoftSaveStatus=currSoftSaveStatus, SystemFileOperationType=SystemFileOperationType, currSoftName=currSoftName, nextBootLastSetResult=nextBootLastSetResult, backupVersion=backupVersion, bootCnfgSetStatus=bootCnfgSetStatus, firmware=firmware, backupLastSetResult=backupLastSetResult, nextBootSetStatus=nextBootSetStatus, deviceConfiguration=deviceConfiguration, bootCnfgLastSetResult=bootCnfgLastSetResult, backupCnfgPath=backupCnfgPath, dfltCnfgPath=dfltCnfgPath, runningConfig=runningConfig, bootCnfgExists=bootCnfgExists, serviceConfig=serviceConfig, srvcTelnetEnable=srvcTelnetEnable, backupPath=backupPath, runCnfgSaveAsStatus=runCnfgSaveAsStatus, currentFirmware=currentFirmware, srvcSshEnable=srvcSshEnable, PYSNMP_MODULE_ID=setup, nextBootVersion=nextBootVersion, runCnfgSaveAs=runCnfgSaveAs, restartDevice=restartDevice, backupSetStatus=backupSetStatus, setup=setup, nextBootFirmware=nextBootFirmware, guiAppletConfig=guiAppletConfig, guiAppletSwVer=guiAppletSwVer, restartStkMemberDevice=restartStkMemberDevice, bootCnfgPath=bootCnfgPath, backupCnfgSetStatus=backupCnfgSetStatus, currSoftLastSaveResult=currSoftLastSaveResult, currSoftSaveToFile=currSoftSaveToFile, defaultConfig=defaultConfig, nextBootConfig=nextBootConfig, backupFirmware=backupFirmware, currSoftSaveAs=currSoftSaveAs, backupCnfgLastSetResult=backupCnfgLastSetResult)
