...
Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, Counter32, IpAddress, ObjectIdentity, Bits, ModuleIdentity, Gauge32, Integer32, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "Counter32", "IpAddress", "ObjectIdentity", "Bits", "ModuleIdentity", "Gauge32", "Integer32", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("ALCATEL-IND1-TIMETRA-TC-MIB", ServiceAdminStatus=ServiceAdminStatus, TmnxCustId=TmnxCustId, TmnxSlaProfileStringOrEmpty=TmnxSlaProfileStringOrEmpty, TmnxDHCP6MsgType=TmnxDHCP6MsgType, TmnxVRtrIDOrZero=TmnxVRtrIDOrZero, TmnxBgpRouteTarget=TmnxBgpRouteTarget, TIpProtocol=TIpProtocol, TFrameType=TFrameType, TmnxMldGroupFilterMode=TmnxMldGroupFilterMode, TmnxDhcpOptionType=TmnxDhcpOptionType, TmnxSubProfileString=TmnxSubProfileString, IpAddressPrefixLength=IpAddressPrefixLength, TNamedItem=TNamedItem, TNamedItemOrEmpty=TNamedItemOrEmpty, TmnxMldVersion=TmnxMldVersion, TmnxActionType=TmnxActionType, TmnxVcType=TmnxVcType, TmnxVRtrID=TmnxVRtrID, QTagOrZero=QTagOrZero, TmnxAppProfileStringOrEmpty=TmnxAppProfileStringOrEmpty, TmnxIgmpVersion=TmnxIgmpVersion, TmnxTunnelID=TmnxTunnelID, TmnxIgmpGroupType=TmnxIgmpGroupType, TmnxVPNRouteDistinguisher=TmnxVPNRouteDistinguisher, TmnxServId=TmnxServId, TmnxOperState=TmnxOperState, TmnxManagedRouteStatus=TmnxManagedRouteStatus, ServiceOperStatus=ServiceOperStatus, TEgressQueueId=TEgressQueueId, TmnxStatus=TmnxStatus, TmnxStrSapId=TmnxStrSapId, TPIRRate=TPIRRate, TDSCPFilterActionValue=TDSCPFilterActionValue, TmnxMulticastAddrFamily=TmnxMulticastAddrFamily, TmnxSlaProfileString=TmnxSlaProfileString, TmnxBGPFamilyType=TmnxBGPFamilyType, QTag=QTag, TLspExpValue=TLspExpValue, TMlpppQoSProfileId=TMlpppQoSProfileId, PYSNMP_MODULE_ID=timetraTCMIBModule, TFCType=TFCType, TmnxPortID=TmnxPortID, TSecondaryShaper10GPIRRate=TSecondaryShaper10GPIRRate, TDSCPName=TDSCPName, TmnxPppoeUserNameOrEmpty=TmnxPppoeUserNameOrEmpty, TmnxBgpLocalPreference=TmnxBgpLocalPreference, TmnxVRtrMplsLspID=TmnxVRtrMplsLspID, TCpmProtPolicyID=TCpmProtPolicyID, InterfaceIndex=InterfaceIndex, TmnxOspfInstance=TmnxOspfInstance, SdpBindId=SdpBindId, ServiceAccessPoint=ServiceAccessPoint, TIpOption=TIpOption, TPortSchedulerCIR=TPortSchedulerCIR, TCIRRate=TCIRRate, TSapIngressPolicyID=TSapIngressPolicyID, TmnxVcId=TmnxVcId, TFCName=TFCName, TPIRRateOverride=TPIRRateOverride, TmnxSubMgtIntDestId=TmnxSubMgtIntDestId, TmnxSubProfileStringOrEmpty=TmnxSubProfileStringOrEmpty, TPolicyID=TPolicyID, TmnxAppProfileString=TmnxAppProfileString, TmnxAncpStringOrZero=TmnxAncpStringOrZero, TFCNameOrEmpty=TFCNameOrEmpty, TmnxTunnelType=TmnxTunnelType, TQueueId=TQueueId, TmnxAdminState=TmnxAdminState, TmnxSubIdentString=TmnxSubIdentString, TmnxIgmpGroupFilterMode=TmnxIgmpGroupFilterMode, TDSCPValue=TDSCPValue, TmnxBgpAutonomousSystem=TmnxBgpAutonomousSystem, TSapEgressPolicyID=TSapEgressPolicyID, TPIRRateOrZero=TPIRRateOrZero, TPolicyStatementNameOrEmpty=TPolicyStatementNameOrEmpty, TDSCPValueOrNone=TDSCPValueOrNone, TmnxSubMgtIntDestIdOrEmpty=TmnxSubMgtIntDestIdOrEmpty, TmnxSubIdentStringOrEmpty=TmnxSubIdentStringOrEmpty, TIngressQueueId=TIngressQueueId, TmnxDhcpVendorOption=TmnxDhcpVendorOption, TmnxEnabledDisabled=TmnxEnabledDisabled, TTcpUdpPort=TTcpUdpPort, TTcpUdpPortOperator=TTcpUdpPortOperator, TItemLongDescription=TItemLongDescription, timetraTCMIBModule=timetraTCMIBModule, TDSCPNameOrEmpty=TDSCPNameOrEmpty, TmnxAncpString=TmnxAncpString, TItemDescription=TItemDescription, Dot1PPriority=Dot1PPriority, TPortSchedulerPIR=TPortSchedulerPIR, TmnxMldGroupType=TmnxMldGroupType, TFCSet=TFCSet, TmnxEncapVal=TmnxEncapVal, TmnxBgpPreference=TmnxBgpPreference, TWeight=TWeight, TmnxVcIdOrNone=TmnxVcIdOrNone)
