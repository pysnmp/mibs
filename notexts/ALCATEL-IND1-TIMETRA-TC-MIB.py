...
Integer32, NotificationType, IpAddress, ObjectIdentity, TimeTicks, MibIdentifier, Counter64, Unsigned32, Counter32, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "IpAddress", "ObjectIdentity", "TimeTicks", "MibIdentifier", "Counter64", "Unsigned32", "Counter32", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits")
...
mibBuilder.exportSymbols("ALCATEL-IND1-TIMETRA-TC-MIB", TmnxSubProfileString=TmnxSubProfileString, TIngressQueueId=TIngressQueueId, TmnxVcType=TmnxVcType, TmnxPppoeUserNameOrEmpty=TmnxPppoeUserNameOrEmpty, ServiceOperStatus=ServiceOperStatus, TTcpUdpPortOperator=TTcpUdpPortOperator, TQueueId=TQueueId, TFCName=TFCName, TDSCPValue=TDSCPValue, TmnxMldGroupFilterMode=TmnxMldGroupFilterMode, TItemLongDescription=TItemLongDescription, TmnxVRtrIDOrZero=TmnxVRtrIDOrZero, TSapEgressPolicyID=TSapEgressPolicyID, TmnxAdminState=TmnxAdminState, TMlpppQoSProfileId=TMlpppQoSProfileId, ServiceAccessPoint=ServiceAccessPoint, TmnxActionType=TmnxActionType, QTagOrZero=QTagOrZero, TmnxSlaProfileStringOrEmpty=TmnxSlaProfileStringOrEmpty, TmnxOspfInstance=TmnxOspfInstance, TmnxAppProfileString=TmnxAppProfileString, TEgressQueueId=TEgressQueueId, TIpOption=TIpOption, TmnxVRtrID=TmnxVRtrID, TmnxStrSapId=TmnxStrSapId, TmnxAncpString=TmnxAncpString, TPortSchedulerCIR=TPortSchedulerCIR, TmnxVPNRouteDistinguisher=TmnxVPNRouteDistinguisher, TNamedItem=TNamedItem, TSecondaryShaper10GPIRRate=TSecondaryShaper10GPIRRate, TPolicyStatementNameOrEmpty=TPolicyStatementNameOrEmpty, TLspExpValue=TLspExpValue, TCpmProtPolicyID=TCpmProtPolicyID, TmnxVRtrMplsLspID=TmnxVRtrMplsLspID, TmnxSubIdentString=TmnxSubIdentString, TmnxAncpStringOrZero=TmnxAncpStringOrZero, TPortSchedulerPIR=TPortSchedulerPIR, TmnxTunnelType=TmnxTunnelType, QTag=QTag, Dot1PPriority=Dot1PPriority, TmnxMulticastAddrFamily=TmnxMulticastAddrFamily, ServiceAdminStatus=ServiceAdminStatus, TmnxDhcpVendorOption=TmnxDhcpVendorOption, TIpProtocol=TIpProtocol, TmnxSubMgtIntDestIdOrEmpty=TmnxSubMgtIntDestIdOrEmpty, TmnxBGPFamilyType=TmnxBGPFamilyType, TmnxAppProfileStringOrEmpty=TmnxAppProfileStringOrEmpty, TmnxMldVersion=TmnxMldVersion, TmnxEnabledDisabled=TmnxEnabledDisabled, TmnxSubMgtIntDestId=TmnxSubMgtIntDestId, TPIRRate=TPIRRate, TDSCPFilterActionValue=TDSCPFilterActionValue, TDSCPName=TDSCPName, TTcpUdpPort=TTcpUdpPort, TPolicyID=TPolicyID, TFCNameOrEmpty=TFCNameOrEmpty, TmnxManagedRouteStatus=TmnxManagedRouteStatus, TItemDescription=TItemDescription, InterfaceIndex=InterfaceIndex, TDSCPValueOrNone=TDSCPValueOrNone, timetraTCMIBModule=timetraTCMIBModule, TmnxDhcpOptionType=TmnxDhcpOptionType, TmnxPortID=TmnxPortID, TmnxVcId=TmnxVcId, TDSCPNameOrEmpty=TDSCPNameOrEmpty, TNamedItemOrEmpty=TNamedItemOrEmpty, TmnxOperState=TmnxOperState, TmnxCustId=TmnxCustId, TmnxSubProfileStringOrEmpty=TmnxSubProfileStringOrEmpty, TmnxSlaProfileString=TmnxSlaProfileString, TmnxDHCP6MsgType=TmnxDHCP6MsgType, TFCSet=TFCSet, SdpBindId=SdpBindId, TCIRRate=TCIRRate, TmnxIgmpGroupFilterMode=TmnxIgmpGroupFilterMode, TmnxTunnelID=TmnxTunnelID, TmnxBgpAutonomousSystem=TmnxBgpAutonomousSystem, TPIRRateOrZero=TPIRRateOrZero, TSapIngressPolicyID=TSapIngressPolicyID, TmnxBgpLocalPreference=TmnxBgpLocalPreference, TPIRRateOverride=TPIRRateOverride, TmnxEncapVal=TmnxEncapVal, TmnxMldGroupType=TmnxMldGroupType, TmnxBgpPreference=TmnxBgpPreference, PYSNMP_MODULE_ID=timetraTCMIBModule, TmnxIgmpGroupType=TmnxIgmpGroupType, IpAddressPrefixLength=IpAddressPrefixLength, TmnxServId=TmnxServId, TmnxStatus=TmnxStatus, TFCType=TFCType, TFrameType=TFrameType, TWeight=TWeight, TmnxIgmpVersion=TmnxIgmpVersion, TmnxSubIdentStringOrEmpty=TmnxSubIdentStringOrEmpty, TmnxVcIdOrNone=TmnxVcIdOrNone, TmnxBgpRouteTarget=TmnxBgpRouteTarget)
