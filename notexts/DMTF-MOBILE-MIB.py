...
mibBuilder.exportSymbols("DMTF-MOBILE-MIB", DmiCounter=DmiCounter, dmtfVideoOutputDeviceEntry=dmtfVideoOutputDeviceEntry, dmtfPointingDeviceEntry=dmtfPointingDeviceEntry, devicesSupported=devicesSupported, portableBatteryManufactureDate=portableBatteryManufactureDate, dmtfDynOids=dmtfDynOids, deviceBayIndex=deviceBayIndex, dmtfInfraredPortState=dmtfInfraredPortState, DmiGroupId=DmiGroupId, DmiInteger=DmiInteger, iREnableState=iREnableState, pointingDevicePortName=pointingDevicePortName, overrideAC=overrideAC, d3TimerValue=d3TimerValue, powerManagementEnabledDisabled=powerManagementEnabledDisabled, portableBatteryManufacturer=portableBatteryManufacturer, pointingDeviceDriverVersion=pointingDeviceDriverVersion, dmtfPortableBatteryTraps=dmtfPortableBatteryTraps, dmtfDynamicStatesEntry=dmtfDynamicStatesEntry, pointingDeviceType=pointingDeviceType, dmtfVideoOutputDeviceState=dmtfVideoOutputDeviceState, portableBatteryDeviceChemistry=portableBatteryDeviceChemistry, type2=type2, iRProtocol=iRProtocol, iRVirtualCOMPortName=iRVirtualCOMPortName, deviceBayLocation=deviceBayLocation, dmtfPortableBatteryMaintenanceRequired=dmtfPortableBatteryMaintenanceRequired, portableBatteryDesignVoltage=portableBatteryDesignVoltage, iRVirtualLPTPortName=iRVirtualLPTPortName, dmtf=dmtf, type=type, ringEventResume=ringEventResume, reducedCPUClockSpeed=reducedCPUClockSpeed, deviceBayType=deviceBayType, portableBatterySerialNumber=portableBatterySerialNumber, dockingStatus=dockingStatus, iRLocation=iRLocation, d1TimerValue=d1TimerValue, portableBatteryChargingStatus=portableBatteryChargingStatus, remainingTimeToFullBattery=remainingTimeToFullBattery, pointingDeviceInterface=pointingDeviceInterface, dmtfPortableBatteryState=dmtfPortableBatteryState, smartBatteryVersion=smartBatteryVersion, DmiOctetstring=DmiOctetstring, builtIn=builtIn, PYSNMP_MODULE_ID=dmtfMobileComputerMIF, contrast=contrast, videoGroupReference=videoGroupReference, dmtfPortableBatteryEvSys=dmtfPortableBatteryEvSys, iRIndex=iRIndex, iRSpeedLimit=iRSpeedLimit, DmiCounter64=DmiCounter64, dmtfInfraredPortTable=dmtfInfraredPortTable, dmtfPortableBatteryCriticalCombinedBatterysCharge=dmtfPortableBatteryCriticalCombinedBatterysCharge, pointingDeviceDriverName=pointingDeviceDriverName, dmtfPowerManagementEntry=dmtfPowerManagementEntry, pointingDeviceButtons=pointingDeviceButtons, dmtfPointingDeviceTable=dmtfPointingDeviceTable, currentPowerManagementState=currentPowerManagementState, dmtfPortableBatteryEntry=dmtfPortableBatteryEntry, dmtfPortableBatteryEvSub=dmtfPortableBatteryEvSub, colorSupport=colorSupport, fullChargeCapacity=fullChargeCapacity, iRPhysicalPortName=iRPhysicalPortName, deviceCurrentlyAttached=deviceCurrentlyAttached, brightness=brightness, dmtfPortableBatteryLowCombinedBatterysCharge=dmtfPortableBatteryLowCombinedBatterysCharge, DmiCompId=DmiCompId, dmtfSystemPowerManagementEntry=dmtfSystemPowerManagementEntry, iRLimitSpeedEnable=iRLimitSpeedEnable, DmiGauge=DmiGauge, securitySettings=securitySettings, dmtfDeviceBayEntry=dmtfDeviceBayEntry, dmtfPortableBatteryTable=dmtfPortableBatteryTable, dmtfPowerManagementBinaryAssociationTableState=dmtfPowerManagementBinaryAssociationTableState, dmtfPowerManagementTable=dmtfPowerManagementTable, dmtfPowerManagementTableState=dmtfPowerManagementTableState, dmtfSystemPowerManagementTable=dmtfSystemPowerManagementTable, dmtfPowerManagementBinaryAssociationTable=dmtfPowerManagementBinaryAssociationTable, aCLineStatus=aCLineStatus, dmtfPowerManagementBinaryAssociationEntry=dmtfPowerManagementBinaryAssociationEntry, dmtfMobileComputerMIF=dmtfMobileComputerMIF, portableBatteryDesignCapacity=portableBatteryDesignCapacity, operationalGroupIndex=operationalGroupIndex, dmtfDeviceBayState=dmtfDeviceBayState, dmtfStdMifs=dmtfStdMifs, powerUnitIndex=powerUnitIndex, index=index, fRUGroupIndex=fRUGroupIndex, remainingBatteryTime=remainingBatteryTime, pointingDeviceIRQ=pointingDeviceIRQ, dmtfVideoOutputDeviceTable=dmtfVideoOutputDeviceTable, powerManagementCapabilities=powerManagementCapabilities, dmtfDeviceBayTable=dmtfDeviceBayTable, portableBatteryLocation=portableBatteryLocation, alarmResume=alarmResume, ref2=ref2, portableBatteryIndex=portableBatteryIndex, portableBatteryDeviceName=portableBatteryDeviceName, d2TimerValue=d2TimerValue, index2=index2, dmtfInfraredPortEntry=dmtfInfraredPortEntry, dmtfDynamicStatesTable=dmtfDynamicStatesTable, remainingCapacity=remainingCapacity, ref1=ref1, maximumError=maximumError)
