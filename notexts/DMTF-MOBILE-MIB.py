...
mibBuilder.exportSymbols("DMTF-MOBILE-MIB", dmtf=dmtf, portableBatterySerialNumber=portableBatterySerialNumber, PYSNMP_MODULE_ID=dmtfMobileComputerMIF, dmtfPowerManagementTableState=dmtfPowerManagementTableState, remainingTimeToFullBattery=remainingTimeToFullBattery, overrideAC=overrideAC, deviceBayType=deviceBayType, pointingDevicePortName=pointingDevicePortName, alarmResume=alarmResume, type=type, dmtfPowerManagementBinaryAssociationTableState=dmtfPowerManagementBinaryAssociationTableState, aCLineStatus=aCLineStatus, videoGroupReference=videoGroupReference, securitySettings=securitySettings, dmtfPortableBatteryEntry=dmtfPortableBatteryEntry, deviceBayIndex=deviceBayIndex, pointingDeviceDriverName=pointingDeviceDriverName, reducedCPUClockSpeed=reducedCPUClockSpeed, dmtfPortableBatteryState=dmtfPortableBatteryState, devicesSupported=devicesSupported, dmtfSystemPowerManagementEntry=dmtfSystemPowerManagementEntry, dmtfPortableBatteryEvSys=dmtfPortableBatteryEvSys, dmtfDynOids=dmtfDynOids, dmtfPointingDeviceEntry=dmtfPointingDeviceEntry, dmtfPowerManagementTable=dmtfPowerManagementTable, dmtfPowerManagementBinaryAssociationTable=dmtfPowerManagementBinaryAssociationTable, pointingDeviceButtons=pointingDeviceButtons, portableBatteryIndex=portableBatteryIndex, pointingDeviceType=pointingDeviceType, dmtfInfraredPortTable=dmtfInfraredPortTable, operationalGroupIndex=operationalGroupIndex, dmtfPortableBatteryTable=dmtfPortableBatteryTable, maximumError=maximumError, dmtfMobileComputerMIF=dmtfMobileComputerMIF, powerManagementEnabledDisabled=powerManagementEnabledDisabled, remainingCapacity=remainingCapacity, contrast=contrast, index2=index2, iRProtocol=iRProtocol, portableBatteryChargingStatus=portableBatteryChargingStatus, dmtfDeviceBayTable=dmtfDeviceBayTable, iRIndex=iRIndex, DmiCounter64=DmiCounter64, dmtfSystemPowerManagementTable=dmtfSystemPowerManagementTable, iRVirtualLPTPortName=iRVirtualLPTPortName, DmiCompId=DmiCompId, pointingDeviceDriverVersion=pointingDeviceDriverVersion, DmiInteger=DmiInteger, iRSpeedLimit=iRSpeedLimit, DmiGroupId=DmiGroupId, fRUGroupIndex=fRUGroupIndex, dmtfPortableBatteryLowCombinedBatterysCharge=dmtfPortableBatteryLowCombinedBatterysCharge, d2TimerValue=d2TimerValue, portableBatteryDesignVoltage=portableBatteryDesignVoltage, iRVirtualCOMPortName=iRVirtualCOMPortName, DmiGauge=DmiGauge, ringEventResume=ringEventResume, fullChargeCapacity=fullChargeCapacity, dmtfInfraredPortState=dmtfInfraredPortState, index=index, colorSupport=colorSupport, portableBatteryManufacturer=portableBatteryManufacturer, smartBatteryVersion=smartBatteryVersion, dmtfPortableBatteryTraps=dmtfPortableBatteryTraps, iRLimitSpeedEnable=iRLimitSpeedEnable, dmtfVideoOutputDeviceEntry=dmtfVideoOutputDeviceEntry, dmtfStdMifs=dmtfStdMifs, portableBatteryDeviceName=portableBatteryDeviceName, powerManagementCapabilities=powerManagementCapabilities, d3TimerValue=d3TimerValue, deviceCurrentlyAttached=deviceCurrentlyAttached, portableBatteryLocation=portableBatteryLocation, iRLocation=iRLocation, DmiOctetstring=DmiOctetstring, dmtfPortableBatteryMaintenanceRequired=dmtfPortableBatteryMaintenanceRequired, portableBatteryDesignCapacity=portableBatteryDesignCapacity, builtIn=builtIn, portableBatteryManufactureDate=portableBatteryManufactureDate, ref1=ref1, dmtfPortableBatteryEvSub=dmtfPortableBatteryEvSub, dmtfInfraredPortEntry=dmtfInfraredPortEntry, deviceBayLocation=deviceBayLocation, dmtfVideoOutputDeviceState=dmtfVideoOutputDeviceState, dmtfDeviceBayState=dmtfDeviceBayState, DmiCounter=DmiCounter, iRPhysicalPortName=iRPhysicalPortName, pointingDeviceIRQ=pointingDeviceIRQ, iREnableState=iREnableState, dmtfPointingDeviceTable=dmtfPointingDeviceTable, remainingBatteryTime=remainingBatteryTime, portableBatteryDeviceChemistry=portableBatteryDeviceChemistry, dmtfDynamicStatesTable=dmtfDynamicStatesTable, ref2=ref2, dmtfPowerManagementBinaryAssociationEntry=dmtfPowerManagementBinaryAssociationEntry, brightness=brightness, dmtfPowerManagementEntry=dmtfPowerManagementEntry, dockingStatus=dockingStatus, type2=type2, dmtfDeviceBayEntry=dmtfDeviceBayEntry, currentPowerManagementState=currentPowerManagementState, dmtfDynamicStatesEntry=dmtfDynamicStatesEntry, dmtfVideoOutputDeviceTable=dmtfVideoOutputDeviceTable, pointingDeviceInterface=pointingDeviceInterface, powerUnitIndex=powerUnitIndex, dmtfPortableBatteryCriticalCombinedBatterysCharge=dmtfPortableBatteryCriticalCombinedBatterysCharge, d1TimerValue=d1TimerValue)
