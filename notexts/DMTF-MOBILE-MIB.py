...
mibBuilder.exportSymbols("DMTF-MOBILE-MIB", dockingStatus=dockingStatus, operationalGroupIndex=operationalGroupIndex, dmtfVideoOutputDeviceTable=dmtfVideoOutputDeviceTable, dmtfDynamicStatesTable=dmtfDynamicStatesTable, maximumError=maximumError, DmiGauge=DmiGauge, dmtfPowerManagementEntry=dmtfPowerManagementEntry, dmtfPointingDeviceEntry=dmtfPointingDeviceEntry, DmiCounter64=DmiCounter64, deviceBayIndex=deviceBayIndex, reducedCPUClockSpeed=reducedCPUClockSpeed, dmtfMobileComputerMIF=dmtfMobileComputerMIF, DmiGroupId=DmiGroupId, iRLocation=iRLocation, ringEventResume=ringEventResume, pointingDevicePortName=pointingDevicePortName, portableBatteryDesignVoltage=portableBatteryDesignVoltage, iRSpeedLimit=iRSpeedLimit, pointingDeviceButtons=pointingDeviceButtons, contrast=contrast, dmtfPortableBatteryEvSub=dmtfPortableBatteryEvSub, dmtfPortableBatteryEvSys=dmtfPortableBatteryEvSys, dmtfSystemPowerManagementEntry=dmtfSystemPowerManagementEntry, index=index, dmtfPowerManagementBinaryAssociationTableState=dmtfPowerManagementBinaryAssociationTableState, portableBatteryDeviceChemistry=portableBatteryDeviceChemistry, d1TimerValue=d1TimerValue, portableBatteryLocation=portableBatteryLocation, portableBatteryManufacturer=portableBatteryManufacturer, powerUnitIndex=powerUnitIndex, remainingBatteryTime=remainingBatteryTime, dmtfPowerManagementTable=dmtfPowerManagementTable, colorSupport=colorSupport, videoGroupReference=videoGroupReference, dmtfPortableBatteryEntry=dmtfPortableBatteryEntry, dmtfPortableBatteryTraps=dmtfPortableBatteryTraps, builtIn=builtIn, dmtfPortableBatteryCriticalCombinedBatterysCharge=dmtfPortableBatteryCriticalCombinedBatterysCharge, dmtfInfraredPortEntry=dmtfInfraredPortEntry, deviceBayType=deviceBayType, deviceBayLocation=deviceBayLocation, powerManagementEnabledDisabled=powerManagementEnabledDisabled, iRVirtualCOMPortName=iRVirtualCOMPortName, dmtfSystemPowerManagementTable=dmtfSystemPowerManagementTable, dmtfInfraredPortTable=dmtfInfraredPortTable, portableBatteryDeviceName=portableBatteryDeviceName, iRIndex=iRIndex, iRProtocol=iRProtocol, DmiOctetstring=DmiOctetstring, pointingDeviceDriverVersion=pointingDeviceDriverVersion, dmtfPowerManagementTableState=dmtfPowerManagementTableState, aCLineStatus=aCLineStatus, deviceCurrentlyAttached=deviceCurrentlyAttached, alarmResume=alarmResume, pointingDeviceType=pointingDeviceType, iREnableState=iREnableState, dmtf=dmtf, PYSNMP_MODULE_ID=dmtfMobileComputerMIF, smartBatteryVersion=smartBatteryVersion, securitySettings=securitySettings, d2TimerValue=d2TimerValue, type=type, iRLimitSpeedEnable=iRLimitSpeedEnable, overrideAC=overrideAC, ref2=ref2, powerManagementCapabilities=powerManagementCapabilities, index2=index2, dmtfDeviceBayState=dmtfDeviceBayState, dmtfDeviceBayTable=dmtfDeviceBayTable, currentPowerManagementState=currentPowerManagementState, DmiCompId=DmiCompId, iRVirtualLPTPortName=iRVirtualLPTPortName, portableBatteryIndex=portableBatteryIndex, fullChargeCapacity=fullChargeCapacity, dmtfDeviceBayEntry=dmtfDeviceBayEntry, dmtfVideoOutputDeviceEntry=dmtfVideoOutputDeviceEntry, dmtfPowerManagementBinaryAssociationTable=dmtfPowerManagementBinaryAssociationTable, dmtfVideoOutputDeviceState=dmtfVideoOutputDeviceState, portableBatteryChargingStatus=portableBatteryChargingStatus, remainingCapacity=remainingCapacity, dmtfInfraredPortState=dmtfInfraredPortState, portableBatteryDesignCapacity=portableBatteryDesignCapacity, type2=type2, portableBatteryManufactureDate=portableBatteryManufactureDate, fRUGroupIndex=fRUGroupIndex, pointingDeviceInterface=pointingDeviceInterface, dmtfDynOids=dmtfDynOids, dmtfPortableBatteryLowCombinedBatterysCharge=dmtfPortableBatteryLowCombinedBatterysCharge, pointingDeviceDriverName=pointingDeviceDriverName, ref1=ref1, devicesSupported=devicesSupported, iRPhysicalPortName=iRPhysicalPortName, DmiInteger=DmiInteger, remainingTimeToFullBattery=remainingTimeToFullBattery, dmtfStdMifs=dmtfStdMifs, dmtfPowerManagementBinaryAssociationEntry=dmtfPowerManagementBinaryAssociationEntry, dmtfPortableBatteryTable=dmtfPortableBatteryTable, portableBatterySerialNumber=portableBatterySerialNumber, pointingDeviceIRQ=pointingDeviceIRQ, d3TimerValue=d3TimerValue, dmtfPortableBatteryMaintenanceRequired=dmtfPortableBatteryMaintenanceRequired, dmtfPointingDeviceTable=dmtfPointingDeviceTable, dmtfPortableBatteryState=dmtfPortableBatteryState, DmiCounter=DmiCounter, dmtfDynamicStatesEntry=dmtfDynamicStatesEntry, brightness=brightness)
