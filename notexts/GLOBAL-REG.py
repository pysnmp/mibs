...
mibBuilder.exportSymbols("GLOBAL-REG", globalRegModule=globalRegModule, modules=modules, controllerReg=controllerReg, controllerOrionReg=controllerOrionReg, orion=orion, caps=caps, PYSNMP_MODULE_ID=globalRegModule, products=products, controller=controller, generic=generic, root=root, regs=regs, reg=reg, delta=delta, expr=expr)
