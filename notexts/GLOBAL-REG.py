...
mibBuilder.exportSymbols("GLOBAL-REG", globalRegModule=globalRegModule, reg=reg, regs=regs, controllerReg=controllerReg, generic=generic, caps=caps, delta=delta, orion=orion, root=root, products=products, expr=expr, controller=controller, modules=modules, controllerOrionReg=controllerOrionReg, PYSNMP_MODULE_ID=globalRegModule)
