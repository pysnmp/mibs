...
vlanCountAPI, vlanAMRRules, vlanSystem, vlanTestAPI, vlanPort, vlanAPI, vlanAMRSubnets, vlanAMRStats, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAMRRules", "vlanSystem", "vlanTestAPI", "vlanPort", "vlanAPI", "vlanAMRSubnets", "vlanAMRStats", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIPort=vlanTestAPIPort, SfpsSwitchPort=SfpsSwitchPort, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameEntry=vlanNameEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemLastChange=vlanSystemLastChange, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemDomainName=vlanSystemDomainName, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameVlanName=vlanNameVlanName, vlanSystemTable=vlanSystemTable, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameTable=vlanNameTable, vlanSystemOperTime=vlanSystemOperTime, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortVlanId=vlanPortVlanId, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanPortPortNum=vlanPortPortNum, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortRouterPort=vlanPortRouterPort, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortTable=vlanPortTable, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortEntry=vlanPortEntry, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemVersion=vlanSystemVersion, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortVlanName=vlanPortVlanName, SfpsAddress=SfpsAddress, vlanSystemEntry=vlanSystemEntry, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameNHash=vlanNameNHash, VlanSwitchInstance=VlanSwitchInstance, vlanNameNumUsers=vlanNameNumUsers, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameIndex=vlanNameIndex, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanCountAPITotal=vlanCountAPITotal, vlanPortPortStatus=vlanPortPortStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameVlanId=vlanNameVlanId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortRelayAgent=vlanPortRelayAgent, HexInteger=HexInteger, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled)
