...
vlanAMRRules, vlanCountAPI, vlanSystem, vlanAPI, vlanAMRSubnets, vlanTestAPI, vlanAMRStats, vlanPort, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanCountAPI", "vlanSystem", "vlanAPI", "vlanAMRSubnets", "vlanTestAPI", "vlanAMRStats", "vlanPort", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", SfpsAddress=SfpsAddress, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemEntry=vlanSystemEntry, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIPort=vlanTestAPIPort, vlanNameNumUsers=vlanNameNumUsers, vlanSystemVersion=vlanSystemVersion, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameVlanId=vlanNameVlanId, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameStatusTime=vlanNameStatusTime, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameTable=vlanNameTable, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, HexInteger=HexInteger, vlanNameEntry=vlanNameEntry, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameVlanRule=vlanNameVlanRule, vlanSystemTable=vlanSystemTable, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortTable=vlanPortTable, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanCountAPITotal=vlanCountAPITotal, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPINvramId=sfpsVAPINvramId, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemMibRev=vlanSystemMibRev, vlanPortAdminStatus=vlanPortAdminStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemPollCount=vlanSystemPollCount, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameIndex=vlanNameIndex, vlanSystemLastChange=vlanSystemLastChange, vlanPortPortStatus=vlanPortPortStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortEntry=vlanPortEntry, vlanNameNHash=vlanNameNHash, vlanNameVlanName=vlanNameVlanName, vlanPortRouterPort=vlanPortRouterPort, vlanPortVlanId=vlanPortVlanId)
