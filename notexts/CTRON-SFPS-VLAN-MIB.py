...
vlanSystem, vlanCountAPI, vlanAMRRules, vlanAMRStats, vlanAPI, vlanPort, vlanName, vlanAMRSubnets, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanCountAPI", "vlanAMRRules", "vlanAMRStats", "vlanAPI", "vlanPort", "vlanName", "vlanAMRSubnets", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRRulesTable=vlanAMRRulesTable, SfpsSwitchPort=SfpsSwitchPort, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIVlanName=vlanTestAPIVlanName, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameIndex=vlanNameIndex, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIUserAlias=sfpsVAPIUserAlias, SfpsAddress=SfpsAddress, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortPortStatus=vlanPortPortStatus, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemVersion=vlanSystemVersion, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameEntry=vlanNameEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameVlanId=vlanNameVlanId, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameVlanRule=vlanNameVlanRule, vlanSystemEntry=vlanSystemEntry, vlanPortPortNum=vlanPortPortNum, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemDomainName=vlanSystemDomainName, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemMibRev=vlanSystemMibRev, vlanNameNHash=vlanNameNHash, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortVlanId=vlanPortVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputAble=vlanTestAPIOutputAble, HexInteger=HexInteger, vlanPortRouterPort=vlanPortRouterPort, vlanPortTable=vlanPortTable, vlanCountAPITotal=vlanCountAPITotal, vlanNameTable=vlanNameTable, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemTable=vlanSystemTable, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemOperTime=vlanSystemOperTime, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameVlanName=vlanNameVlanName, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortEntry=vlanPortEntry, vlanPortAdminStatus=vlanPortAdminStatus)
