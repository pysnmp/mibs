...
vlanAMRSubnets, vlanCountAPI, vlanSystem, vlanAMRStats, vlanAPI, vlanPort, vlanName, vlanTestAPI, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanCountAPI", "vlanSystem", "vlanAMRStats", "vlanAPI", "vlanPort", "vlanName", "vlanTestAPI", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortVlanName=vlanPortVlanName, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameNHash=vlanNameNHash, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemMibRev=vlanSystemMibRev, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameNumUsers=vlanNameNumUsers, vlanNameEntry=vlanNameEntry, vlanSystemEntry=vlanSystemEntry, vlanPortTable=vlanPortTable, vlanSystemOperTime=vlanSystemOperTime, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameIndex=vlanNameIndex, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIVlanName=vlanTestAPIVlanName, VlanSwitchInstance=VlanSwitchInstance, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortPortNum=vlanPortPortNum, HexInteger=HexInteger, vlanSystemVersion=vlanSystemVersion, vlanNameTable=vlanNameTable, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameVlanId=vlanNameVlanId, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, SfpsAddress=SfpsAddress, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortVlanId=vlanPortVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameVlanRule=vlanNameVlanRule, vlanPortRouterPort=vlanPortRouterPort, vlanNameVlanName=vlanNameVlanName, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemLastChange=vlanSystemLastChange, vlanPortFloodPolicy=vlanPortFloodPolicy)
