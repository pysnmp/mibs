...
vlanAPI, vlanSystem, vlanPort, vlanName, vlanAMRRules, vlanAMRStats, vlanAMRSubnets, vlanCountAPI, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanSystem", "vlanPort", "vlanName", "vlanAMRRules", "vlanAMRStats", "vlanAMRSubnets", "vlanCountAPI", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", HexInteger=HexInteger, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameNumUsers=vlanNameNumUsers, vlanNameVlanId=vlanNameVlanId, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemLastChange=vlanSystemLastChange, vlanNameVlanRule=vlanNameVlanRule, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameVlanName=vlanNameVlanName, vlanSystemPollCount=vlanSystemPollCount, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemTable=vlanSystemTable, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortEntry=vlanPortEntry, SfpsAddress=SfpsAddress, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIPort=vlanTestAPIPort, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameNHash=vlanNameNHash, vlanAMRRulesRule=vlanAMRRulesRule, SfpsSwitchPort=SfpsSwitchPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortVlanId=vlanPortVlanId, vlanNameTable=vlanNameTable, vlanNameEntry=vlanNameEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameOperStatus=vlanNameOperStatus, vlanPortPortNum=vlanPortPortNum, vlanPortTable=vlanPortTable, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemMibRev=vlanSystemMibRev, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemEntry=vlanSystemEntry, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortRouterPort=vlanPortRouterPort, vlanPortPortStatus=vlanPortPortStatus, vlanSystemOperTime=vlanSystemOperTime, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortVlanName=vlanPortVlanName, sfpsVAPIUserAlias=sfpsVAPIUserAlias, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemVersion=vlanSystemVersion, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameMappedPorts=vlanNameMappedPorts, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIVlanName=vlanTestAPIVlanName)
