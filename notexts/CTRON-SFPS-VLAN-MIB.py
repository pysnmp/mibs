...
vlanAMRStats, vlanCountAPI, vlanPort, vlanAPI, vlanSystem, vlanName, vlanAMRSubnets, vlanAMRRules, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanCountAPI", "vlanPort", "vlanAPI", "vlanSystem", "vlanName", "vlanAMRSubnets", "vlanAMRRules", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameNHash=vlanNameNHash, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemTable=vlanSystemTable, vlanPortTable=vlanPortTable, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemAdminReset=vlanSystemAdminReset, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameOperStatus=vlanNameOperStatus, vlanSystemPollCount=vlanSystemPollCount, SfpsAddress=SfpsAddress, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameVlanName=vlanNameVlanName, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortPortNum=vlanPortPortNum, VlanSwitchInstance=VlanSwitchInstance, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanPortEntry=vlanPortEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemDomainName=vlanSystemDomainName, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIPort=vlanTestAPIPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemVersion=vlanSystemVersion, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortVlanId=vlanPortVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemEntry=vlanSystemEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameIndex=vlanNameIndex, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, HexInteger=HexInteger, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemOperTime=vlanSystemOperTime, vlanPortVlanName=vlanPortVlanName, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameEntry=vlanNameEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameTable=vlanNameTable, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameStatusTime=vlanNameStatusTime, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameVlanId=vlanNameVlanId, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIVlanId=vlanTestAPIVlanId)
