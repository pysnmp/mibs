...
vlanCountAPI, vlanTestAPI, vlanAMRSubnets, vlanAMRRules, vlanAMRStats, vlanSystem, vlanAPI, vlanName, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanTestAPI", "vlanAMRSubnets", "vlanAMRRules", "vlanAMRStats", "vlanSystem", "vlanAPI", "vlanName", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameVlanRule=vlanNameVlanRule, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortEntry=vlanPortEntry, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemEntry=vlanSystemEntry, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemMibRev=vlanSystemMibRev, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameTable=vlanNameTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortRelayAgent=vlanPortRelayAgent, vlanCountAPITotal=vlanCountAPITotal, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIPort=vlanTestAPIPort, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameNHash=vlanNameNHash, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameStatusTime=vlanNameStatusTime, SfpsAddress=SfpsAddress, vlanSystemLastChange=vlanSystemLastChange, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameVlanName=vlanNameVlanName, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortTable=vlanPortTable, vlanNameIndex=vlanNameIndex, HexInteger=HexInteger, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIOutPort=sfpsVAPIOutPort, VlanSwitchInstance=VlanSwitchInstance, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemPollCount=vlanSystemPollCount, vlanNameEntry=vlanNameEntry, vlanPortRouterPort=vlanPortRouterPort, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameVlanId=vlanNameVlanId, vlanPortPortNum=vlanPortPortNum, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemTable=vlanSystemTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameAdminStatus=vlanNameAdminStatus)
