...
vlanName, vlanAMRRules, vlanAPI, vlanTestAPI, vlanSystem, vlanPort, vlanAMRSubnets, vlanAMRStats, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanAMRRules", "vlanAPI", "vlanTestAPI", "vlanSystem", "vlanPort", "vlanAMRSubnets", "vlanAMRStats", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameTable=vlanNameTable, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemPollCount=vlanSystemPollCount, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortPortNum=vlanPortPortNum, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemEntry=vlanSystemEntry, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortEntry=vlanPortEntry, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortPortStatus=vlanPortPortStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRRulesRule=vlanAMRRulesRule, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortTable=vlanPortTable, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemLastChange=vlanSystemLastChange, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameEntry=vlanNameEntry, vlanNameVlanId=vlanNameVlanId, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameVlanName=vlanNameVlanName, vlanSystemOperTime=vlanSystemOperTime, vlanPortUniPolicy=vlanPortUniPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, SfpsAddress=SfpsAddress, sfpsVAPIVlanId=sfpsVAPIVlanId, HexInteger=HexInteger, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanCountAPITotal=vlanCountAPITotal, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemVersion=vlanSystemVersion, vlanSystemDomainName=vlanSystemDomainName, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameFloodPolicy=vlanNameFloodPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanNameIndex=vlanNameIndex, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortVlanName=vlanPortVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameMappedPorts=vlanNameMappedPorts)
