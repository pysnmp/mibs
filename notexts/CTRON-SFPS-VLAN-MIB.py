...
vlanAMRStats, vlanPort, vlanSystem, vlanAMRSubnets, vlanAMRRules, vlanCountAPI, vlanName, vlanAPI, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanPort", "vlanSystem", "vlanAMRSubnets", "vlanAMRRules", "vlanCountAPI", "vlanName", "vlanAPI", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortPortStatus=vlanPortPortStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameNumUsers=vlanNameNumUsers, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameIndex=vlanNameIndex, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, HexInteger=HexInteger, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortAdminStatus=vlanPortAdminStatus, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemEntry=vlanSystemEntry, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortRelayAgent=vlanPortRelayAgent, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIPort=vlanTestAPIPort, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameTable=vlanNameTable, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemTable=vlanSystemTable, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameVlanName=vlanNameVlanName, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameNHash=vlanNameNHash, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameEntry=vlanNameEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameVlanRule=vlanNameVlanRule, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, SfpsAddress=SfpsAddress, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemDomainName=vlanSystemDomainName, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortPortNum=vlanPortPortNum, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortEntry=vlanPortEntry, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortVlanId=vlanPortVlanId, VlanSwitchInstance=VlanSwitchInstance, vlanPortRouterPort=vlanPortRouterPort, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortTable=vlanPortTable, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortVlanName=vlanPortVlanName, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanNameFloodPolicy=vlanNameFloodPolicy)
