...
vlanAMRStats, vlanTestAPI, vlanName, vlanAPI, vlanAMRSubnets, vlanPort, vlanSystem, vlanCountAPI, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanTestAPI", "vlanName", "vlanAPI", "vlanAMRSubnets", "vlanPort", "vlanSystem", "vlanCountAPI", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameRelayAgent=vlanNameRelayAgent, vlanNameNumUsers=vlanNameNumUsers, vlanPortPortNum=vlanPortPortNum, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemEntry=vlanSystemEntry, vlanSystemVersion=vlanSystemVersion, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameStatusTime=vlanNameStatusTime, vlanPortVlanName=vlanPortVlanName, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameEntry=vlanNameEntry, vlanSystemLastChange=vlanSystemLastChange, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameVlanId=vlanNameVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameVlanName=vlanNameVlanName, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIPort=vlanTestAPIPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameOperStatus=vlanNameOperStatus, VlanSwitchInstance=VlanSwitchInstance, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameTable=vlanNameTable, vlanNameVlanRule=vlanNameVlanRule, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, SfpsSwitchPort=SfpsSwitchPort, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanSystemMibRev=vlanSystemMibRev, vlanPortVlanId=vlanPortVlanId, SfpsAddress=SfpsAddress, vlanPortPortStatus=vlanPortPortStatus, HexInteger=HexInteger, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortEntry=vlanPortEntry, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortRouterPort=vlanPortRouterPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameNHash=vlanNameNHash, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameIndex=vlanNameIndex, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemTable=vlanSystemTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanPortTable=vlanPortTable, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy)
