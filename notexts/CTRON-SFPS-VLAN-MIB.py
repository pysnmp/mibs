...
vlanAPI, vlanAMRStats, vlanName, vlanTestAPI, vlanSystem, vlanAMRRules, vlanAMRSubnets, vlanCountAPI, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanAMRStats", "vlanName", "vlanTestAPI", "vlanSystem", "vlanAMRRules", "vlanAMRSubnets", "vlanCountAPI", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", HexInteger=HexInteger, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameIndex=vlanNameIndex, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameVlanId=vlanNameVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortPortNum=vlanPortPortNum, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameStatusTime=vlanNameStatusTime, SfpsAddress=SfpsAddress, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameEntry=vlanNameEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIPort=vlanTestAPIPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemPollCount=vlanSystemPollCount, vlanPortPortStatus=vlanPortPortStatus, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameVlanRule=vlanNameVlanRule, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameNHash=vlanNameNHash, vlanPortVlanName=vlanPortVlanName, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemVersion=vlanSystemVersion, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemTable=vlanSystemTable, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortVlanId=vlanPortVlanId, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, VlanSwitchInstance=VlanSwitchInstance, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanSystemEntry=vlanSystemEntry, vlanSystemLastChange=vlanSystemLastChange, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortRouterPort=vlanPortRouterPort, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameTable=vlanNameTable, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortTable=vlanPortTable, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus)
