...
vlanSystem, vlanAPI, vlanAMRRules, vlanAMRSubnets, vlanPort, vlanCountAPI, vlanTestAPI, vlanName, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanAPI", "vlanAMRRules", "vlanAMRSubnets", "vlanPort", "vlanCountAPI", "vlanTestAPI", "vlanName", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortEntry=vlanPortEntry, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortRouterPort=vlanPortRouterPort, vlanNameTable=vlanNameTable, vlanCountAPIAdmin=vlanCountAPIAdmin, SfpsSwitchPort=SfpsSwitchPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemDomainName=vlanSystemDomainName, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameIndex=vlanNameIndex, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIVlanName=sfpsVAPIVlanName, SfpsAddress=SfpsAddress, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRRulesEntry=vlanAMRRulesEntry, HexInteger=HexInteger, vlanPortTable=vlanPortTable, vlanSystemMibRev=vlanSystemMibRev, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemTable=vlanSystemTable, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemOperTime=vlanSystemOperTime, vlanNameOperStatus=vlanNameOperStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanPortVlanName=vlanPortVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameEntry=vlanNameEntry, vlanPortVlanId=vlanPortVlanId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameStatusTime=vlanNameStatusTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemVersion=vlanSystemVersion, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIPort=vlanTestAPIPort, vlanNameVlanId=vlanNameVlanId, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameNHash=vlanNameNHash, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameNumUsers=vlanNameNumUsers)
