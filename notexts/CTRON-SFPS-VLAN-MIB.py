...
vlanAMRStats, vlanAMRRules, vlanTestAPI, vlanName, vlanAPI, vlanPort, vlanAMRSubnets, vlanCountAPI, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanAMRRules", "vlanTestAPI", "vlanName", "vlanAPI", "vlanPort", "vlanAMRSubnets", "vlanCountAPI", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemAdminReset=vlanSystemAdminReset, vlanNameEntry=vlanNameEntry, vlanNameVlanRule=vlanNameVlanRule, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortPortNum=vlanPortPortNum, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemEntry=vlanSystemEntry, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemVersion=vlanSystemVersion, vlanPortVlanName=vlanPortVlanName, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortVlanId=vlanPortVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, SfpsSwitchPort=SfpsSwitchPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortLayer3Learning=vlanPortLayer3Learning, VlanSwitchInstance=VlanSwitchInstance, SfpsAddress=SfpsAddress, vlanPortEntry=vlanPortEntry, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanPortPortStatus=vlanPortPortStatus, vlanNameTable=vlanNameTable, vlanTestAPIPort=vlanTestAPIPort, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameNHash=vlanNameNHash, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameVlanId=vlanNameVlanId, vlanNameVlanName=vlanNameVlanName, vlanNameIndex=vlanNameIndex, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortTable=vlanPortTable, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortRouterPort=vlanPortRouterPort, HexInteger=HexInteger, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameOperStatus=vlanNameOperStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameStatusTime=vlanNameStatusTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime)
