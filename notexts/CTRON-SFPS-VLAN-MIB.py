...
vlanName, vlanAMRStats, vlanAMRRules, vlanPort, vlanCountAPI, vlanTestAPI, vlanAMRSubnets, vlanAPI, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanAMRStats", "vlanAMRRules", "vlanPort", "vlanCountAPI", "vlanTestAPI", "vlanAMRSubnets", "vlanAPI", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameVlanId=vlanNameVlanId, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemEntry=vlanSystemEntry, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortRouterPort=vlanPortRouterPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameVlanRule=vlanNameVlanRule, vlanSystemPollCount=vlanSystemPollCount, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemDomainName=vlanSystemDomainName, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemVersion=vlanSystemVersion, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIUserAlias=sfpsVAPIUserAlias, SfpsSwitchPort=SfpsSwitchPort, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIVlanName=vlanTestAPIVlanName, SfpsAddress=SfpsAddress, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameTable=vlanNameTable, vlanNameEntry=vlanNameEntry, vlanTestAPIPort=vlanTestAPIPort, vlanNameNHash=vlanNameNHash, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameOperStatus=vlanNameOperStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortVlanId=vlanPortVlanId, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortTable=vlanPortTable, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameVlanName=vlanNameVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameMappedPorts=vlanNameMappedPorts, HexInteger=HexInteger, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortPortNum=vlanPortPortNum, vlanPortVlanName=vlanPortVlanName, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry)
