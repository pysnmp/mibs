...
vlanTestAPI, vlanPort, vlanAMRStats, vlanAMRRules, vlanSystem, vlanName, vlanAMRSubnets, vlanAPI, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanPort", "vlanAMRStats", "vlanAMRRules", "vlanSystem", "vlanName", "vlanAMRSubnets", "vlanAPI", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameStatusTime=vlanNameStatusTime, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemVersion=vlanSystemVersion, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPINvramId=sfpsVAPINvramId, SfpsSwitchPort=SfpsSwitchPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemEntry=vlanSystemEntry, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameTable=vlanNameTable, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameVlanRule=vlanNameVlanRule, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortPortNum=vlanPortPortNum, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, SfpsAddress=SfpsAddress, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemMibRev=vlanSystemMibRev, vlanPortVlanId=vlanPortVlanId, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortEntry=vlanPortEntry, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameIndex=vlanNameIndex, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortTable=vlanPortTable, vlanSystemTable=vlanSystemTable, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameNumUsers=vlanNameNumUsers, vlanNameEntry=vlanNameEntry, HexInteger=HexInteger, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortRouterPort=vlanPortRouterPort, vlanNameNHash=vlanNameNHash, vlanPortRelayAgent=vlanPortRelayAgent, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortVlanName=vlanPortVlanName, vlanCountAPITotal=vlanCountAPITotal, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortPortStatus=vlanPortPortStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIRouterPort=sfpsVAPIRouterPort)
