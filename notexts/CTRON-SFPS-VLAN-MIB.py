...
vlanSystem, vlanCountAPI, vlanAMRStats, vlanAPI, vlanAMRSubnets, vlanPort, vlanAMRRules, vlanName, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanCountAPI", "vlanAMRStats", "vlanAPI", "vlanAMRSubnets", "vlanPort", "vlanAMRRules", "vlanName", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortTable=vlanPortTable, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemDomainName=vlanSystemDomainName, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemVersion=vlanSystemVersion, vlanNameIndex=vlanNameIndex, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortVlanName=vlanPortVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, SfpsAddress=SfpsAddress, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemTable=vlanSystemTable, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanCountAPITotal=vlanCountAPITotal, HexInteger=HexInteger, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIPort=vlanTestAPIPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameVlanName=vlanNameVlanName, vlanNameTable=vlanNameTable, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameNHash=vlanNameNHash, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameEntry=vlanNameEntry, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortPortNum=vlanPortPortNum, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIVerb=vlanTestAPIVerb, VlanSwitchInstance=VlanSwitchInstance, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemOperTime=vlanSystemOperTime, vlanNameVlanRule=vlanNameVlanRule, vlanNameVlanId=vlanNameVlanId, SfpsSwitchPort=SfpsSwitchPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemLastChange=vlanSystemLastChange)
