...
vlanTestAPI, vlanAPI, vlanAMRRules, vlanAMRSubnets, vlanPort, vlanAMRStats, vlanSystem, vlanCountAPI, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanAPI", "vlanAMRRules", "vlanAMRSubnets", "vlanPort", "vlanAMRStats", "vlanSystem", "vlanCountAPI", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputTable=vlanTestAPIOutputTable, VlanSwitchInstance=VlanSwitchInstance, vlanNameVlanRule=vlanNameVlanRule, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputMap=vlanTestAPIOutputMap, HexInteger=HexInteger, vlanPortTable=vlanPortTable, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameNumUsers=vlanNameNumUsers, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameTable=vlanNameTable, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameVlanId=vlanNameVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameIndex=vlanNameIndex, vlanNameStatusTime=vlanNameStatusTime, vlanSystemEntry=vlanSystemEntry, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortVlanName=vlanPortVlanName, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIRouterPort=sfpsVAPIRouterPort, SfpsAddress=SfpsAddress, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortVlanId=vlanPortVlanId, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemVersion=vlanSystemVersion, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemTable=vlanSystemTable, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanPortRouterPort=vlanPortRouterPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameEntry=vlanNameEntry, vlanNameNHash=vlanNameNHash, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemMibRev=vlanSystemMibRev, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemOperStatus=vlanSystemOperStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortEntry=vlanPortEntry, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanCountAPITotal=vlanCountAPITotal, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortPortStatus=vlanPortPortStatus, vlanPortPortNum=vlanPortPortNum, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameOperStatus=vlanNameOperStatus)
