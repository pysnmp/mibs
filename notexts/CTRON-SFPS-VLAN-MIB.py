...
vlanCountAPI, vlanTestAPI, vlanAMRRules, vlanAMRStats, vlanPort, vlanSystem, vlanAPI, vlanAMRSubnets, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanTestAPI", "vlanAMRRules", "vlanAMRStats", "vlanPort", "vlanSystem", "vlanAPI", "vlanAMRSubnets", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortPortNum=vlanPortPortNum, HexInteger=HexInteger, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanNameVlanName=vlanNameVlanName, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameOperStatus=vlanNameOperStatus, vlanNameIndex=vlanNameIndex, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortTable=vlanPortTable, vlanSystemAgentIP=vlanSystemAgentIP, SfpsAddress=SfpsAddress, vlanPortRouterPort=vlanPortRouterPort, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemEntry=vlanSystemEntry, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, SfpsSwitchPort=SfpsSwitchPort, vlanSystemTable=vlanSystemTable, vlanNameTable=vlanNameTable, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanSystemDomainName=vlanSystemDomainName, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortVlanId=vlanPortVlanId, vlanNameEntry=vlanNameEntry, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, VlanSwitchInstance=VlanSwitchInstance, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortEntry=vlanPortEntry, vlanNameVlanId=vlanNameVlanId, vlanNameNHash=vlanNameNHash, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameVlanRule=vlanNameVlanRule, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortVlanName=vlanPortVlanName, vlanSystemPriorPollTime=vlanSystemPriorPollTime)
