...
vlanName, vlanAPI, vlanAMRSubnets, vlanAMRRules, vlanPort, vlanSystem, vlanCountAPI, vlanTestAPI, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanAPI", "vlanAMRSubnets", "vlanAMRRules", "vlanPort", "vlanSystem", "vlanCountAPI", "vlanTestAPI", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortVlanId=vlanPortVlanId, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, HexInteger=HexInteger, vlanNameVlanId=vlanNameVlanId, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameNHash=vlanNameNHash, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemPollCount=vlanSystemPollCount, SfpsAddress=SfpsAddress, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemEntry=vlanSystemEntry, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, VlanSwitchInstance=VlanSwitchInstance, vlanPortVlanName=vlanPortVlanName, vlanPortTable=vlanPortTable, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemMibRev=vlanSystemMibRev, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortPortStatus=vlanPortPortStatus, vlanNameVlanRule=vlanNameVlanRule, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanCountAPITotal=vlanCountAPITotal, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemOperTime=vlanSystemOperTime, vlanSystemLastChange=vlanSystemLastChange, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameIndex=vlanNameIndex, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortEntry=vlanPortEntry, vlanNameOperStatus=vlanNameOperStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanSystemTable=vlanSystemTable, vlanPortPortNum=vlanPortPortNum, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemVersion=vlanSystemVersion, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameTable=vlanNameTable, vlanPortFloodPolicy=vlanPortFloodPolicy)
