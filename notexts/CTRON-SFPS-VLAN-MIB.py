...
vlanCountAPI, vlanName, vlanAMRRules, vlanAMRSubnets, vlanPort, vlanAMRStats, vlanTestAPI, vlanSystem, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanName", "vlanAMRRules", "vlanAMRSubnets", "vlanPort", "vlanAMRStats", "vlanTestAPI", "vlanSystem", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemTable=vlanSystemTable, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortTable=vlanPortTable, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemVersion=vlanSystemVersion, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameVlanId=vlanNameVlanId, vlanPortEntry=vlanPortEntry, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameStatusTime=vlanNameStatusTime, vlanPortPortNum=vlanPortPortNum, SfpsSwitchPort=SfpsSwitchPort, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemOperTime=vlanSystemOperTime, vlanSystemMibRev=vlanSystemMibRev, vlanCountAPITotal=vlanCountAPITotal, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, HexInteger=HexInteger, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameOperStatus=vlanNameOperStatus, vlanPortVlanName=vlanPortVlanName, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameVlanName=vlanNameVlanName, vlanNameEntry=vlanNameEntry, vlanNameNHash=vlanNameNHash, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortPortStatus=vlanPortPortStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortUniPolicy=vlanPortUniPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanNameTable=vlanNameTable, vlanNameIndex=vlanNameIndex, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemPollCount=vlanSystemPollCount, vlanPortVlanId=vlanPortVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, SfpsAddress=SfpsAddress, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameUniPolicy=vlanNameUniPolicy)
