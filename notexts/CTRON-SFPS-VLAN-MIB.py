...
vlanCountAPI, vlanAPI, vlanTestAPI, vlanSystem, vlanAMRRules, vlanAMRStats, vlanPort, vlanName, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAPI", "vlanTestAPI", "vlanSystem", "vlanAMRRules", "vlanAMRStats", "vlanPort", "vlanName", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIVlanId=sfpsVAPIVlanId, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameTable=vlanNameTable, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameVlanId=vlanNameVlanId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, HexInteger=HexInteger, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemLastChange=vlanSystemLastChange, vlanSystemAdminReset=vlanSystemAdminReset, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemAgentIP=vlanSystemAgentIP, VlanSwitchInstance=VlanSwitchInstance, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameNHash=vlanNameNHash, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortVlanName=vlanPortVlanName, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortTable=vlanPortTable, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameIndex=vlanNameIndex, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemMibRev=vlanSystemMibRev, vlanPortRouterPort=vlanPortRouterPort, vlanSystemVersion=vlanSystemVersion, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameOperStatus=vlanNameOperStatus, vlanSystemDomainName=vlanSystemDomainName, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameEntry=vlanNameEntry, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortPortStatus=vlanPortPortStatus, vlanSystemOperTime=vlanSystemOperTime, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemPollCount=vlanSystemPollCount, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameVlanName=vlanNameVlanName, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortEntry=vlanPortEntry, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, SfpsAddress=SfpsAddress, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortPortNum=vlanPortPortNum, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortRelayAgent=vlanPortRelayAgent)
