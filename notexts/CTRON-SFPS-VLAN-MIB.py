...
vlanSystem, vlanCountAPI, vlanTestAPI, vlanAMRSubnets, vlanAMRStats, vlanAMRRules, vlanAPI, vlanName, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanCountAPI", "vlanTestAPI", "vlanAMRSubnets", "vlanAMRStats", "vlanAMRRules", "vlanAPI", "vlanName", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameIndex=vlanNameIndex, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIPort=vlanTestAPIPort, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanCountAPITotal=vlanCountAPITotal, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortTable=vlanPortTable, vlanPortPortNum=vlanPortPortNum, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameNumUsers=vlanNameNumUsers, vlanSystemDomainName=vlanSystemDomainName, vlanNameVlanRule=vlanNameVlanRule, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, SfpsAddress=SfpsAddress, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemPollCount=vlanSystemPollCount, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemLastChange=vlanSystemLastChange, vlanPortEntry=vlanPortEntry, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRRulesRule=vlanAMRRulesRule, SfpsSwitchPort=SfpsSwitchPort, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemTable=vlanSystemTable, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameStatusTime=vlanNameStatusTime, vlanNameVlanId=vlanNameVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemEntry=vlanSystemEntry, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemOperTime=vlanSystemOperTime, vlanSystemVersion=vlanSystemVersion, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameTable=vlanNameTable, vlanPortVlanName=vlanPortVlanName, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemMibRev=vlanSystemMibRev, vlanNameEntry=vlanNameEntry, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, HexInteger=HexInteger, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameVlanName=vlanNameVlanName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameEnabledPorts=vlanNameEnabledPorts)
