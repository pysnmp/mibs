...
vlanSystem, vlanAPI, vlanName, vlanAMRRules, vlanPort, vlanAMRStats, vlanTestAPI, vlanCountAPI, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanAPI", "vlanName", "vlanAMRRules", "vlanPort", "vlanAMRStats", "vlanTestAPI", "vlanCountAPI", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameOperStatus=vlanNameOperStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortTable=vlanPortTable, vlanAMRRulesStatus=vlanAMRRulesStatus, VlanSwitchInstance=VlanSwitchInstance, HexInteger=HexInteger, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameIndex=vlanNameIndex, vlanSystemOperStatus=vlanSystemOperStatus, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemMibRev=vlanSystemMibRev, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemOperTime=vlanSystemOperTime, vlanNameTable=vlanNameTable, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortPortNum=vlanPortPortNum, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameVlanId=vlanNameVlanId, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemTable=vlanSystemTable, vlanSystemLastChange=vlanSystemLastChange, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemVersion=vlanSystemVersion, vlanNameEntry=vlanNameEntry, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, SfpsAddress=SfpsAddress, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortVlanName=vlanPortVlanName, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIPort=vlanTestAPIPort, vlanPortVlanId=vlanPortVlanId, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameNumUsers=vlanNameNumUsers, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemEntry=vlanSystemEntry, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameNHash=vlanNameNHash, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortRouterPort=vlanPortRouterPort, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameVlanName=vlanNameVlanName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIVlanName=vlanTestAPIVlanName)
