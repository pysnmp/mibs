...
vlanTestAPI, vlanAMRStats, vlanName, vlanAMRRules, vlanAMRSubnets, vlanCountAPI, vlanSystem, vlanAPI, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanAMRStats", "vlanName", "vlanAMRRules", "vlanAMRSubnets", "vlanCountAPI", "vlanSystem", "vlanAPI", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemTable=vlanSystemTable, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameNumUsers=vlanNameNumUsers, vlanNameNHash=vlanNameNHash, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIPort=vlanTestAPIPort, vlanSystemEntry=vlanSystemEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemOperTime=vlanSystemOperTime, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortVlanId=vlanPortVlanId, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameTable=vlanNameTable, SfpsSwitchPort=SfpsSwitchPort, vlanSystemVersion=vlanSystemVersion, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortTable=vlanPortTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortRouterPort=vlanPortRouterPort, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameVlanName=vlanNameVlanName, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameEntry=vlanNameEntry, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemPollCount=vlanSystemPollCount, vlanNameFloodPolicy=vlanNameFloodPolicy, HexInteger=HexInteger, vlanNameVlanRule=vlanNameVlanRule, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameIndex=vlanNameIndex, vlanPortPortStatus=vlanPortPortStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameUniPolicy=vlanNameUniPolicy, SfpsAddress=SfpsAddress, vlanPortVlanName=vlanPortVlanName, vlanNameVlanId=vlanNameVlanId, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortEntry=vlanPortEntry, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIVerb=sfpsVAPIVerb)
