...
vlanCountAPI, vlanName, vlanAMRRules, vlanPort, vlanSystem, vlanAPI, vlanTestAPI, vlanAMRSubnets, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanName", "vlanAMRRules", "vlanPort", "vlanSystem", "vlanAPI", "vlanTestAPI", "vlanAMRSubnets", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIInPort=sfpsVAPIInPort, vlanNameVlanName=vlanNameVlanName, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameIndex=vlanNameIndex, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemEntry=vlanSystemEntry, VlanSwitchInstance=VlanSwitchInstance, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameStatusTime=vlanNameStatusTime, SfpsAddress=SfpsAddress, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortTable=vlanPortTable, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameTable=vlanNameTable, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameNHash=vlanNameNHash, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortRouterPort=vlanPortRouterPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemVersion=vlanSystemVersion, vlanNameVlanId=vlanNameVlanId, vlanNameOperStatus=vlanNameOperStatus, vlanSystemTable=vlanSystemTable, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortEntry=vlanPortEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortVlanId=vlanPortVlanId, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameEntry=vlanNameEntry, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortPortNum=vlanPortPortNum, vlanPortVlanName=vlanPortVlanName, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIRouterPort=sfpsVAPIRouterPort, HexInteger=HexInteger, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIPort=vlanTestAPIPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIOutPort=sfpsVAPIOutPort, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameNumUsers=vlanNameNumUsers, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameVlanRule=vlanNameVlanRule, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemOperStatus=vlanSystemOperStatus)
