...
vlanPort, vlanTestAPI, vlanAMRRules, vlanAMRSubnets, vlanAPI, vlanSystem, vlanName, vlanCountAPI, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanTestAPI", "vlanAMRRules", "vlanAMRSubnets", "vlanAPI", "vlanSystem", "vlanName", "vlanCountAPI", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemOperTime=vlanSystemOperTime, SfpsAddress=SfpsAddress, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemMibRev=vlanSystemMibRev, vlanNameVlanName=vlanNameVlanName, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemVersion=vlanSystemVersion, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameEntry=vlanNameEntry, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemDomainName=vlanSystemDomainName, vlanNameNumUsers=vlanNameNumUsers, vlanNameRelayAgent=vlanNameRelayAgent, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortTable=vlanPortTable, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemEntry=vlanSystemEntry, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanCountAPITotal=vlanCountAPITotal, vlanPortPortStatus=vlanPortPortStatus, vlanNameStatusTime=vlanNameStatusTime, vlanNameVlanId=vlanNameVlanId, vlanPortRouterPort=vlanPortRouterPort, vlanNameFloodPolicy=vlanNameFloodPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanNameIndex=vlanNameIndex, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameNHash=vlanNameNHash, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemPollCount=vlanSystemPollCount, vlanPortEntry=vlanPortEntry, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemTable=vlanSystemTable, HexInteger=HexInteger, vlanNameTable=vlanNameTable, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameOperStatus=vlanNameOperStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortVlanId=vlanPortVlanId, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortPortNum=vlanPortPortNum, sfpsVAPIVlanName=sfpsVAPIVlanName)
