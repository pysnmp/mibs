...
vlanTestAPI, vlanAMRStats, vlanSystem, vlanName, vlanPort, vlanAMRRules, vlanAMRSubnets, vlanCountAPI, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanAMRStats", "vlanSystem", "vlanName", "vlanPort", "vlanAMRRules", "vlanAMRSubnets", "vlanCountAPI", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortPortNum=vlanPortPortNum, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameVlanId=vlanNameVlanId, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameEntry=vlanNameEntry, vlanPortTable=vlanPortTable, vlanTestAPIVlanName=vlanTestAPIVlanName, VlanSwitchInstance=VlanSwitchInstance, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameIndex=vlanNameIndex, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, HexInteger=HexInteger, vlanNameTable=vlanNameTable, vlanNameVlanRule=vlanNameVlanRule, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameNHash=vlanNameNHash, vlanPortVlanId=vlanPortVlanId, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemOperTime=vlanSystemOperTime, vlanSystemVersion=vlanSystemVersion, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemTable=vlanSystemTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameNumUsers=vlanNameNumUsers, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameFloodPorts=vlanNameFloodPorts, SfpsSwitchPort=SfpsSwitchPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortEntry=vlanPortEntry, vlanPortVlanName=vlanPortVlanName, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameVlanName=vlanNameVlanName, vlanSystemSwitchInstance=vlanSystemSwitchInstance, SfpsAddress=SfpsAddress, vlanSystemPollCount=vlanSystemPollCount, vlanCountAPITotal=vlanCountAPITotal, vlanNameEnabledPorts=vlanNameEnabledPorts)
