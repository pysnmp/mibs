...
vlanAMRRules, vlanAMRStats, vlanSystem, vlanTestAPI, vlanPort, vlanAMRSubnets, vlanAPI, vlanName, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanAMRStats", "vlanSystem", "vlanTestAPI", "vlanPort", "vlanAMRSubnets", "vlanAPI", "vlanName", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameNHash=vlanNameNHash, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameEntry=vlanNameEntry, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameOperStatus=vlanNameOperStatus, vlanPortVlanName=vlanPortVlanName, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortEntry=vlanPortEntry, HexInteger=HexInteger, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortPortStatus=vlanPortPortStatus, vlanAMRRulesStatus=vlanAMRRulesStatus, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemEntry=vlanSystemEntry, vlanCountAPITotal=vlanCountAPITotal, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameStatusTime=vlanNameStatusTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, SfpsAddress=SfpsAddress, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortRouterPort=vlanPortRouterPort, SfpsSwitchPort=SfpsSwitchPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameIndex=vlanNameIndex, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemTable=vlanSystemTable, vlanPortAdminStatus=vlanPortAdminStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortVlanId=vlanPortVlanId, vlanNameVlanName=vlanNameVlanName, vlanPortTable=vlanPortTable, vlanPortPortNum=vlanPortPortNum, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemLastChange=vlanSystemLastChange, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameTable=vlanNameTable, vlanTestAPIPort=vlanTestAPIPort)
