...
vlanAMRRules, vlanTestAPI, vlanCountAPI, vlanAMRSubnets, vlanName, vlanAMRStats, vlanSystem, vlanPort, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanTestAPI", "vlanCountAPI", "vlanAMRSubnets", "vlanName", "vlanAMRStats", "vlanSystem", "vlanPort", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortTable=vlanPortTable, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameVlanName=vlanNameVlanName, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameStatusTime=vlanNameStatusTime, vlanSystemVersion=vlanSystemVersion, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortEntry=vlanPortEntry, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameOperStatus=vlanNameOperStatus, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameNHash=vlanNameNHash, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameRelayAgent=vlanNameRelayAgent, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortVlanId=vlanPortVlanId, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameTable=vlanNameTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortVlanName=vlanPortVlanName, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, HexInteger=HexInteger, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemLastChange=vlanSystemLastChange, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameEntry=vlanNameEntry, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameVlanId=vlanNameVlanId, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemEntry=vlanSystemEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortPortNum=vlanPortPortNum, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, SfpsAddress=SfpsAddress, vlanAMRRulesTable=vlanAMRRulesTable, VlanSwitchInstance=VlanSwitchInstance, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIPort=vlanTestAPIPort, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameIndex=vlanNameIndex, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIVlanName=sfpsVAPIVlanName)
