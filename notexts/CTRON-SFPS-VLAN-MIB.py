...
vlanName, vlanAMRRules, vlanAPI, vlanSystem, vlanCountAPI, vlanTestAPI, vlanAMRSubnets, vlanPort, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanAMRRules", "vlanAPI", "vlanSystem", "vlanCountAPI", "vlanTestAPI", "vlanAMRSubnets", "vlanPort", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemLastChange=vlanSystemLastChange, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIVlanId=sfpsVAPIVlanId, SfpsSwitchPort=SfpsSwitchPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameEntry=vlanNameEntry, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortPortNum=vlanPortPortNum, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameVlanRule=vlanNameVlanRule, vlanPortPortStatus=vlanPortPortStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameVlanId=vlanNameVlanId, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, SfpsAddress=SfpsAddress, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortEntry=vlanPortEntry, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemMibRev=vlanSystemMibRev, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemTable=vlanSystemTable, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameIndex=vlanNameIndex, vlanTestAPIPort=vlanTestAPIPort, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanCountAPITotal=vlanCountAPITotal, vlanNameOperStatus=vlanNameOperStatus, vlanNameTable=vlanNameTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameNumUsers=vlanNameNumUsers, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, HexInteger=HexInteger, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIVerb=sfpsVAPIVerb, VlanSwitchInstance=VlanSwitchInstance, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameNHash=vlanNameNHash, vlanNameRelayAgent=vlanNameRelayAgent, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanNameStatusTime=vlanNameStatusTime, vlanPortTable=vlanPortTable, vlanSystemEntry=vlanSystemEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemVersion=vlanSystemVersion, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt)
