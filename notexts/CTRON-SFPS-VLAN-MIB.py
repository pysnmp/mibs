...
vlanPort, vlanSystem, vlanTestAPI, vlanAPI, vlanName, vlanAMRStats, vlanAMRRules, vlanCountAPI, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanSystem", "vlanTestAPI", "vlanAPI", "vlanName", "vlanAMRStats", "vlanAMRRules", "vlanCountAPI", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemVersion=vlanSystemVersion, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameMappedPorts=vlanNameMappedPorts, vlanCountAPITotal=vlanCountAPITotal, vlanNameNumUsers=vlanNameNumUsers, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameEntry=vlanNameEntry, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortVlanId=vlanPortVlanId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortEntry=vlanPortEntry, vlanSystemOperTime=vlanSystemOperTime, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameVlanName=vlanNameVlanName, vlanPortRouterPort=vlanPortRouterPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortPortNum=vlanPortPortNum, vlanNameNHash=vlanNameNHash, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemEntry=vlanSystemEntry, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemLastChange=vlanSystemLastChange, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameVlanId=vlanNameVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameTable=vlanNameTable, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortVlanName=vlanPortVlanName, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanNameIndex=vlanNameIndex, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortPortStatus=vlanPortPortStatus, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, SfpsAddress=SfpsAddress, vlanNameVlanRule=vlanNameVlanRule, vlanSystemMibRev=vlanSystemMibRev, vlanPortTable=vlanPortTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameEnabledPorts=vlanNameEnabledPorts, HexInteger=HexInteger, vlanSystemPollCount=vlanSystemPollCount, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameStatusTime=vlanNameStatusTime, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIVlanId=sfpsVAPIVlanId)
