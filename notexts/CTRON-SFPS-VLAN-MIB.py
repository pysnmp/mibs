...
vlanAMRStats, vlanName, vlanCountAPI, vlanTestAPI, vlanAPI, vlanAMRRules, vlanPort, vlanSystem, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanName", "vlanCountAPI", "vlanTestAPI", "vlanAPI", "vlanAMRRules", "vlanPort", "vlanSystem", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameVlanId=vlanNameVlanId, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortEntry=vlanPortEntry, vlanPortVlanId=vlanPortVlanId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPINvramId=sfpsVAPINvramId, vlanCountAPITotal=vlanCountAPITotal, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameOperStatus=vlanNameOperStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemTable=vlanSystemTable, vlanNameNumUsers=vlanNameNumUsers, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, SfpsAddress=SfpsAddress, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortLayer3Learning=vlanPortLayer3Learning, HexInteger=HexInteger, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortPortNum=vlanPortPortNum, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameNHash=vlanNameNHash, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortTable=vlanPortTable, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, SfpsSwitchPort=SfpsSwitchPort, vlanSystemPollCount=vlanSystemPollCount, vlanNameVlanName=vlanNameVlanName, vlanSystemVersion=vlanSystemVersion, vlanNameIndex=vlanNameIndex, vlanNameTable=vlanNameTable, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameVlanRule=vlanNameVlanRule, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameEntry=vlanNameEntry, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemOperTime=vlanSystemOperTime, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortPortStatus=vlanPortPortStatus, vlanNameStatusTime=vlanNameStatusTime, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortVlanName=vlanPortVlanName)
