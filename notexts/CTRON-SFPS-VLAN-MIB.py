...
vlanCountAPI, vlanAMRStats, vlanName, vlanAPI, vlanAMRSubnets, vlanAMRRules, vlanPort, vlanSystem, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAMRStats", "vlanName", "vlanAPI", "vlanAMRSubnets", "vlanAMRRules", "vlanPort", "vlanSystem", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortPortStatus=vlanPortPortStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortVlanId=vlanPortVlanId, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortPortNum=vlanPortPortNum, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortEntry=vlanPortEntry, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameOperStatus=vlanNameOperStatus, VlanSwitchInstance=VlanSwitchInstance, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameEntry=vlanNameEntry, vlanNameVlanName=vlanNameVlanName, vlanPortTable=vlanPortTable, vlanNameVlanId=vlanNameVlanId, HexInteger=HexInteger, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameTable=vlanNameTable, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemPollCount=vlanSystemPollCount, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanNameStatusTime=vlanNameStatusTime, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanCountAPITotal=vlanCountAPITotal, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameNHash=vlanNameNHash, vlanTestAPIPort=vlanTestAPIPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameIndex=vlanNameIndex, vlanPortVlanName=vlanPortVlanName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemTable=vlanSystemTable, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemVersion=vlanSystemVersion, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortRouterPort=vlanPortRouterPort, SfpsSwitchPort=SfpsSwitchPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemOperTime=vlanSystemOperTime, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, SfpsAddress=SfpsAddress, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameNumUsers=vlanNameNumUsers, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap)
