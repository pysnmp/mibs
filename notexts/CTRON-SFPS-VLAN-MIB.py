...
vlanAMRStats, vlanSystem, vlanName, vlanAMRSubnets, vlanPort, vlanAPI, vlanAMRRules, vlanTestAPI, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanSystem", "vlanName", "vlanAMRSubnets", "vlanPort", "vlanAPI", "vlanAMRRules", "vlanTestAPI", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanAMRRulesTable=vlanAMRRulesTable, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortEntry=vlanPortEntry, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameIndex=vlanNameIndex, vlanNameOperStatus=vlanNameOperStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemTable=vlanSystemTable, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameVlanName=vlanNameVlanName, vlanNameEntry=vlanNameEntry, vlanPortLayer3Learning=vlanPortLayer3Learning, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, SfpsAddress=SfpsAddress, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortVlanId=vlanPortVlanId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, SfpsSwitchPort=SfpsSwitchPort, vlanNameNHash=vlanNameNHash, vlanPortPortStatus=vlanPortPortStatus, vlanSystemOperTime=vlanSystemOperTime, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, HexInteger=HexInteger, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemDomainName=vlanSystemDomainName, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortTable=vlanPortTable, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameVlanId=vlanNameVlanId, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortRouterPort=vlanPortRouterPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortVlanName=vlanPortVlanName, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanCountAPITotal=vlanCountAPITotal, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameVlanRule=vlanNameVlanRule, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameTable=vlanNameTable, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemMibRev=vlanSystemMibRev, vlanSystemVersion=vlanSystemVersion, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortPortNum=vlanPortPortNum, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIVlanName=sfpsVAPIVlanName)
