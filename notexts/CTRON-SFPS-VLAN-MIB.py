...
vlanTestAPI, vlanAMRSubnets, vlanPort, vlanName, vlanAPI, vlanAMRRules, vlanAMRStats, vlanSystem, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanAMRSubnets", "vlanPort", "vlanName", "vlanAPI", "vlanAMRRules", "vlanAMRStats", "vlanSystem", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortPortNum=vlanPortPortNum, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortVlanName=vlanPortVlanName, vlanSystemLastChange=vlanSystemLastChange, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputTap=vlanTestAPIOutputTap, SfpsSwitchPort=SfpsSwitchPort, vlanPortPortStatus=vlanPortPortStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameVlanName=vlanNameVlanName, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemFirstPollTime=vlanSystemFirstPollTime, HexInteger=HexInteger, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameOperStatus=vlanNameOperStatus, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameIndex=vlanNameIndex, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIInPort=sfpsVAPIInPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemOperTime=vlanSystemOperTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortEntry=vlanPortEntry, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortPortPolicy=vlanPortPortPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortTable=vlanPortTable, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameVlanRule=vlanNameVlanRule, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameNHash=vlanNameNHash, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameNumUsers=vlanNameNumUsers, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemVersion=vlanSystemVersion, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameEntry=vlanNameEntry, vlanNameStatusTime=vlanNameStatusTime, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemAdminStatus=vlanSystemAdminStatus, SfpsAddress=SfpsAddress, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemTable=vlanSystemTable, vlanNameTable=vlanNameTable, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortVlanId=vlanPortVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus)
