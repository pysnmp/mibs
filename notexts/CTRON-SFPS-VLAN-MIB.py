...
vlanAPI, vlanPort, vlanCountAPI, vlanTestAPI, vlanName, vlanSystem, vlanAMRRules, vlanAMRSubnets, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanPort", "vlanCountAPI", "vlanTestAPI", "vlanName", "vlanSystem", "vlanAMRRules", "vlanAMRSubnets", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameNHash=vlanNameNHash, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortEntry=vlanPortEntry, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameIndex=vlanNameIndex, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemOperTime=vlanSystemOperTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameTable=vlanNameTable, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortVlanId=vlanPortVlanId, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, HexInteger=HexInteger, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemEntry=vlanSystemEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, VlanSwitchInstance=VlanSwitchInstance, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortVlanName=vlanPortVlanName, vlanPortTable=vlanPortTable, vlanNameVlanId=vlanNameVlanId, vlanNameNumUsers=vlanNameNumUsers, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputMap=vlanTestAPIOutputMap, SfpsAddress=SfpsAddress, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIPort=vlanTestAPIPort, vlanSystemPollCount=vlanSystemPollCount, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameEntry=vlanNameEntry, vlanSystemVersion=vlanSystemVersion, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameVlanName=vlanNameVlanName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanCountAPITotal=vlanCountAPITotal, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortPortStatus=vlanPortPortStatus, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry)
