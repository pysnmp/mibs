...
vlanName, vlanCountAPI, vlanSystem, vlanAMRRules, vlanAPI, vlanAMRSubnets, vlanPort, vlanTestAPI, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanCountAPI", "vlanSystem", "vlanAMRRules", "vlanAPI", "vlanAMRSubnets", "vlanPort", "vlanTestAPI", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPINvramId=sfpsVAPINvramId, SfpsAddress=SfpsAddress, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameTable=vlanNameTable, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemMibRev=vlanSystemMibRev, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemVersion=vlanSystemVersion, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameEntry=vlanNameEntry, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameOperStatus=vlanNameOperStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameMappedPorts=vlanNameMappedPorts, HexInteger=HexInteger, vlanNameNumUsers=vlanNameNumUsers, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanCountAPITotal=vlanCountAPITotal, vlanPortPortNum=vlanPortPortNum, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameVlanId=vlanNameVlanId, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIPort=vlanTestAPIPort, vlanPortRelayAgent=vlanPortRelayAgent, vlanCountAPIAdmin=vlanCountAPIAdmin, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameIndex=vlanNameIndex, SfpsSwitchPort=SfpsSwitchPort, vlanPortEntry=vlanPortEntry, vlanNameNHash=vlanNameNHash, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortVlanName=vlanPortVlanName, vlanPortTable=vlanPortTable, vlanPortVlanId=vlanPortVlanId, vlanNameVlanName=vlanNameVlanName, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemEntry=vlanSystemEntry, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemTable=vlanSystemTable, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemAdminReset=vlanSystemAdminReset)
