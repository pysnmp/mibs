...
vlanCountAPI, vlanAMRRules, vlanTestAPI, vlanAMRSubnets, vlanSystem, vlanAPI, vlanAMRStats, vlanName, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAMRRules", "vlanTestAPI", "vlanAMRSubnets", "vlanSystem", "vlanAPI", "vlanAMRStats", "vlanName", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemOperTime=vlanSystemOperTime, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, HexInteger=HexInteger, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemVersion=vlanSystemVersion, vlanNameOperStatus=vlanNameOperStatus, vlanPortTable=vlanPortTable, vlanNameIndex=vlanNameIndex, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortVlanName=vlanPortVlanName, vlanSystemPriorPollTime=vlanSystemPriorPollTime, VlanSwitchInstance=VlanSwitchInstance, vlanPortVlanId=vlanPortVlanId, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameVlanId=vlanNameVlanId, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameVlanRule=vlanNameVlanRule, vlanPortFloodPolicy=vlanPortFloodPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIPort=vlanTestAPIPort, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameTable=vlanNameTable, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameVlanName=vlanNameVlanName, vlanPortPortNum=vlanPortPortNum, SfpsAddress=SfpsAddress, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameNumUsers=vlanNameNumUsers, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameStatusTime=vlanNameStatusTime, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanCountAPITotal=vlanCountAPITotal, vlanSystemEntry=vlanSystemEntry, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemLastChange=vlanSystemLastChange, vlanPortEntry=vlanPortEntry, vlanNameNHash=vlanNameNHash, vlanSystemTable=vlanSystemTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIOutPort=sfpsVAPIOutPort)
