...
vlanAMRStats, vlanCountAPI, vlanAPI, vlanAMRRules, vlanName, vlanTestAPI, vlanPort, vlanAMRSubnets, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanCountAPI", "vlanAPI", "vlanAMRRules", "vlanName", "vlanTestAPI", "vlanPort", "vlanAMRSubnets", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemTable=vlanSystemTable, vlanPortVlanName=vlanPortVlanName, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanNameNHash=vlanNameNHash, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortRouterPort=vlanPortRouterPort, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameVlanName=vlanNameVlanName, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameNumUsers=vlanNameNumUsers, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemVersion=vlanSystemVersion, SfpsAddress=SfpsAddress, vlanNameVlanRule=vlanNameVlanRule, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemMibRev=vlanSystemMibRev, vlanSystemEntry=vlanSystemEntry, vlanSystemLastChange=vlanSystemLastChange, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesRule=vlanAMRRulesRule, vlanCountAPITotal=vlanCountAPITotal, SfpsSwitchPort=SfpsSwitchPort, vlanNameOperStatus=vlanNameOperStatus, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameTable=vlanNameTable, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameIndex=vlanNameIndex, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortTable=vlanPortTable, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortPortNum=vlanPortPortNum, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameVlanId=vlanNameVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortVlanId=vlanPortVlanId, HexInteger=HexInteger, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameEntry=vlanNameEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesTable=vlanAMRRulesTable)
