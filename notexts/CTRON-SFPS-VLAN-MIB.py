...
vlanSystem, vlanTestAPI, vlanAMRRules, vlanAMRStats, vlanPort, vlanAPI, vlanName, vlanAMRSubnets, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanTestAPI", "vlanAMRRules", "vlanAMRStats", "vlanPort", "vlanAPI", "vlanName", "vlanAMRSubnets", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIPort=vlanTestAPIPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameVlanRule=vlanNameVlanRule, vlanSystemVersion=vlanSystemVersion, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortPortNum=vlanPortPortNum, vlanPortPortStatus=vlanPortPortStatus, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRRulesRule=vlanAMRRulesRule, VlanSwitchInstance=VlanSwitchInstance, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanCountAPITotal=vlanCountAPITotal, vlanNameEntry=vlanNameEntry, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortVlanId=vlanPortVlanId, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortVlanName=vlanPortVlanName, vlanNameUniPolicy=vlanNameUniPolicy, HexInteger=HexInteger, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameTable=vlanNameTable, vlanSystemPollCount=vlanSystemPollCount, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameStatusTime=vlanNameStatusTime, vlanNameNHash=vlanNameNHash, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemLastChange=vlanSystemLastChange, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortRouterPort=vlanPortRouterPort, vlanNameVlanId=vlanNameVlanId, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemTable=vlanSystemTable, vlanPortTable=vlanPortTable, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameOperStatus=vlanNameOperStatus, vlanNameVlanName=vlanNameVlanName, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIInPort=sfpsVAPIInPort, SfpsAddress=SfpsAddress, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameRelayAgent=vlanNameRelayAgent, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameNumUsers=vlanNameNumUsers, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemEntry=vlanSystemEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemDomainName=vlanSystemDomainName, vlanPortEntry=vlanPortEntry, vlanNameIndex=vlanNameIndex, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus)
