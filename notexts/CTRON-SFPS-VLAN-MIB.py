...
vlanAMRRules, vlanCountAPI, vlanPort, vlanName, vlanAPI, vlanSystem, vlanTestAPI, vlanAMRSubnets, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanCountAPI", "vlanPort", "vlanName", "vlanAPI", "vlanSystem", "vlanTestAPI", "vlanAMRSubnets", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemPollCount=vlanSystemPollCount, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemOperTime=vlanSystemOperTime, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameNHash=vlanNameNHash, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRRulesTable=vlanAMRRulesTable, HexInteger=HexInteger, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameOperStatus=vlanNameOperStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemTable=vlanSystemTable, vlanSystemMibRev=vlanSystemMibRev, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortPortStatus=vlanPortPortStatus, vlanNameVlanName=vlanNameVlanName, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortVlanId=vlanPortVlanId, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortTable=vlanPortTable, vlanTestAPIPort=vlanTestAPIPort, vlanPortEntry=vlanPortEntry, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortVlanName=vlanPortVlanName, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, SfpsSwitchPort=SfpsSwitchPort, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameNumUsers=vlanNameNumUsers, vlanPortRouterPort=vlanPortRouterPort, vlanSystemAgentIP=vlanSystemAgentIP, SfpsAddress=SfpsAddress, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameTable=vlanNameTable, vlanNameStatusTime=vlanNameStatusTime, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemEntry=vlanSystemEntry, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameIndex=vlanNameIndex, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemDomainName=vlanSystemDomainName, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanCountAPITotal=vlanCountAPITotal, vlanNameVlanId=vlanNameVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC)
