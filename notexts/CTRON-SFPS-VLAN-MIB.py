...
vlanAMRRules, vlanPort, vlanAMRStats, vlanSystem, vlanName, vlanCountAPI, vlanAPI, vlanAMRSubnets, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanPort", "vlanAMRStats", "vlanSystem", "vlanName", "vlanCountAPI", "vlanAPI", "vlanAMRSubnets", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemDomainName=vlanSystemDomainName, vlanNameOperStatus=vlanNameOperStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameNumUsers=vlanNameNumUsers, vlanPortPortNum=vlanPortPortNum, vlanPortPortStatus=vlanPortPortStatus, VlanSwitchInstance=VlanSwitchInstance, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortUniPolicy=vlanPortUniPolicy, HexInteger=HexInteger, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortLayer3Learning=vlanPortLayer3Learning, SfpsAddress=SfpsAddress, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIPort=vlanTestAPIPort, vlanPortTable=vlanPortTable, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameIndex=vlanNameIndex, vlanNameNHash=vlanNameNHash, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemLastChange=vlanSystemLastChange, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortVlanId=vlanPortVlanId, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameEntry=vlanNameEntry, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemOperTime=vlanSystemOperTime, vlanSystemVersion=vlanSystemVersion, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameVlanId=vlanNameVlanId, vlanPortRouterPort=vlanPortRouterPort, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameTable=vlanNameTable, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemEntry=vlanSystemEntry, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRRulesRule=vlanAMRRulesRule)
