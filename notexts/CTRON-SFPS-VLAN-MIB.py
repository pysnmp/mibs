...
vlanTestAPI, vlanCountAPI, vlanAMRStats, vlanAMRSubnets, vlanSystem, vlanName, vlanPort, vlanAPI, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanCountAPI", "vlanAMRStats", "vlanAMRSubnets", "vlanSystem", "vlanName", "vlanPort", "vlanAPI", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, VlanSwitchInstance=VlanSwitchInstance, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemDomainName=vlanSystemDomainName, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameNumUsers=vlanNameNumUsers, vlanNameVlanName=vlanNameVlanName, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameVlanId=vlanNameVlanId, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPINvramId=sfpsVAPINvramId, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortPortStatus=vlanPortPortStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortEntry=vlanPortEntry, vlanNameTable=vlanNameTable, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortTable=vlanPortTable, vlanTestAPIPort=vlanTestAPIPort, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, HexInteger=HexInteger, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameEntry=vlanNameEntry, vlanPortPortNum=vlanPortPortNum, vlanPortRouterPort=vlanPortRouterPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortVlanId=vlanPortVlanId, sfpsVAPIInPort=sfpsVAPIInPort, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, SfpsAddress=SfpsAddress, vlanNameOperStatus=vlanNameOperStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemEntry=vlanSystemEntry, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemTable=vlanSystemTable, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemVersion=vlanSystemVersion, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameStatusTime=vlanNameStatusTime, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameIndex=vlanNameIndex, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameNHash=vlanNameNHash, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameRelayAgent=vlanNameRelayAgent)
