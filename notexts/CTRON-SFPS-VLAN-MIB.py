...
vlanCountAPI, vlanAPI, vlanName, vlanSystem, vlanAMRStats, vlanPort, vlanAMRRules, vlanTestAPI, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAPI", "vlanName", "vlanSystem", "vlanAMRStats", "vlanPort", "vlanAMRRules", "vlanTestAPI", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", SfpsSwitchPort=SfpsSwitchPort, vlanSystemPollCount=vlanSystemPollCount, vlanPortEntry=vlanPortEntry, HexInteger=HexInteger, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameVlanId=vlanNameVlanId, vlanPortPortStatus=vlanPortPortStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanCountAPITotal=vlanCountAPITotal, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameVlanName=vlanNameVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortPortNum=vlanPortPortNum, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortVlanName=vlanPortVlanName, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanSystemLastChange=vlanSystemLastChange, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameNumUsers=vlanNameNumUsers, vlanSystemDomainName=vlanSystemDomainName, vlanPortRouterPort=vlanPortRouterPort, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemVersion=vlanSystemVersion, vlanSystemTable=vlanSystemTable, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortTable=vlanPortTable, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameEntry=vlanNameEntry, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIVlanName=sfpsVAPIVlanName, SfpsAddress=SfpsAddress, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIPort=vlanTestAPIPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemEntry=vlanSystemEntry, vlanPortVlanId=vlanPortVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameIndex=vlanNameIndex, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameTable=vlanNameTable, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled)
