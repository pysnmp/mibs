...
vlanAMRStats, vlanAMRSubnets, vlanAPI, vlanCountAPI, vlanName, vlanTestAPI, vlanPort, vlanSystem, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanAMRSubnets", "vlanAPI", "vlanCountAPI", "vlanName", "vlanTestAPI", "vlanPort", "vlanSystem", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemLastChange=vlanSystemLastChange, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameIndex=vlanNameIndex, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortPortStatus=vlanPortPortStatus, vlanPortAdminStatus=vlanPortAdminStatus, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemMibRev=vlanSystemMibRev, vlanCountAPITotal=vlanCountAPITotal, SfpsAddress=SfpsAddress, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemTable=vlanSystemTable, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIPort=vlanTestAPIPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemEntry=vlanSystemEntry, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemPollCount=vlanSystemPollCount, vlanNameVlanId=vlanNameVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortPortNum=vlanPortPortNum, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameTable=vlanNameTable, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortRouterPort=vlanPortRouterPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, HexInteger=HexInteger, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortVlanName=vlanPortVlanName, vlanNameStatusTime=vlanNameStatusTime, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortTable=vlanPortTable, vlanPortVlanId=vlanPortVlanId, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputPort=vlanTestAPIOutputPort, SfpsSwitchPort=SfpsSwitchPort, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameVlanName=vlanNameVlanName, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameEntry=vlanNameEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemVersion=vlanSystemVersion, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortUniPolicy=vlanPortUniPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemDomainName=vlanSystemDomainName)
