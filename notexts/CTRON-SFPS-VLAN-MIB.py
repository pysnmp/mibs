...
vlanAMRSubnets, vlanTestAPI, vlanAMRRules, vlanAMRStats, vlanSystem, vlanCountAPI, vlanAPI, vlanPort, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanTestAPI", "vlanAMRRules", "vlanAMRStats", "vlanSystem", "vlanCountAPI", "vlanAPI", "vlanPort", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanAMRRulesRule=vlanAMRRulesRule, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameVlanName=vlanNameVlanName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameOperStatus=vlanNameOperStatus, vlanNameNHash=vlanNameNHash, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemOperTime=vlanSystemOperTime, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortVlanName=vlanPortVlanName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameIndex=vlanNameIndex, vlanPortTable=vlanPortTable, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameStatusTime=vlanNameStatusTime, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, HexInteger=HexInteger, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputPort=vlanTestAPIOutputPort, VlanSwitchInstance=VlanSwitchInstance, vlanNameVlanId=vlanNameVlanId, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameTable=vlanNameTable, vlanPortVlanId=vlanPortVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemVersion=vlanSystemVersion, vlanPortPortStatus=vlanPortPortStatus, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortRouterPort=vlanPortRouterPort, vlanSystemDomainName=vlanSystemDomainName, vlanPortPortNum=vlanPortPortNum, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemTable=vlanSystemTable, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortEntry=vlanPortEntry, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameEntry=vlanNameEntry, SfpsAddress=SfpsAddress, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap)
