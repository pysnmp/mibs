...
vlanSystem, vlanCountAPI, vlanAPI, vlanAMRRules, vlanName, vlanTestAPI, vlanAMRSubnets, vlanPort, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanCountAPI", "vlanAPI", "vlanAMRRules", "vlanName", "vlanTestAPI", "vlanAMRSubnets", "vlanPort", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortVlanName=vlanPortVlanName, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameStatusTime=vlanNameStatusTime, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameIndex=vlanNameIndex, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortTable=vlanPortTable, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, SfpsSwitchPort=SfpsSwitchPort, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameNHash=vlanNameNHash, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortEntry=vlanPortEntry, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemPollCount=vlanSystemPollCount, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, HexInteger=HexInteger, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanCountAPITotal=vlanCountAPITotal, vlanPortPortStatus=vlanPortPortStatus, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameVlanName=vlanNameVlanName, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemDomainName=vlanSystemDomainName, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameEntry=vlanNameEntry, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemVersion=vlanSystemVersion, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameNumUsers=vlanNameNumUsers, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIPort=vlanTestAPIPort, vlanNameTable=vlanNameTable, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemTable=vlanSystemTable, vlanPortPortNum=vlanPortPortNum, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemEntry=vlanSystemEntry, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRRulesTable=vlanAMRRulesTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameOperStatus=vlanNameOperStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemMibRev=vlanSystemMibRev, vlanNameFloodPorts=vlanNameFloodPorts, SfpsAddress=SfpsAddress)
