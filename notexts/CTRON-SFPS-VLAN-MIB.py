...
vlanAPI, vlanSystem, vlanCountAPI, vlanName, vlanAMRStats, vlanAMRRules, vlanTestAPI, vlanAMRSubnets, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanSystem", "vlanCountAPI", "vlanName", "vlanAMRStats", "vlanAMRRules", "vlanTestAPI", "vlanAMRSubnets", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortEntry=vlanPortEntry, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameIndex=vlanNameIndex, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemDomainName=vlanSystemDomainName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortPortStatus=vlanPortPortStatus, vlanNameEntry=vlanNameEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemPollCount=vlanSystemPollCount, vlanSystemOperTime=vlanSystemOperTime, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameVlanRule=vlanNameVlanRule, vlanNameMappedPorts=vlanNameMappedPorts, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemVersion=vlanSystemVersion, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemLastChange=vlanSystemLastChange, vlanNameFloodPorts=vlanNameFloodPorts, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameNHash=vlanNameNHash, vlanNameVlanId=vlanNameVlanId, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameVlanName=vlanNameVlanName, vlanTestAPIPort=vlanTestAPIPort, HexInteger=HexInteger, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, SfpsAddress=SfpsAddress, vlanNameTable=vlanNameTable, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, SfpsSwitchPort=SfpsSwitchPort, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortRouterPort=vlanPortRouterPort, vlanSystemMibRev=vlanSystemMibRev, vlanNameOperStatus=vlanNameOperStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortTable=vlanPortTable, vlanPortVlanName=vlanPortVlanName, vlanPortPortNum=vlanPortPortNum, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemTable=vlanSystemTable, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameStatusTime=vlanNameStatusTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanCountAPIAutoreg=vlanCountAPIAutoreg)
