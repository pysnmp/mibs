...
vlanAPI, vlanAMRRules, vlanSystem, vlanName, vlanCountAPI, vlanTestAPI, vlanAMRSubnets, vlanAMRStats, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanAMRRules", "vlanSystem", "vlanName", "vlanCountAPI", "vlanTestAPI", "vlanAMRSubnets", "vlanAMRStats", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortPortStatus=vlanPortPortStatus, vlanNameVlanName=vlanNameVlanName, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameTable=vlanNameTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameNHash=vlanNameNHash, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemTable=vlanSystemTable, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortEntry=vlanPortEntry, vlanPortRouterPort=vlanPortRouterPort, vlanNameNumUsers=vlanNameNumUsers, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, SfpsAddress=SfpsAddress, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemVersion=vlanSystemVersion, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, SfpsSwitchPort=SfpsSwitchPort, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemSwitchInstance=vlanSystemSwitchInstance, VlanSwitchInstance=VlanSwitchInstance, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemDomainName=vlanSystemDomainName, vlanSystemEntry=vlanSystemEntry, vlanTestAPIPort=vlanTestAPIPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortPortNum=vlanPortPortNum, vlanNameOperStatus=vlanNameOperStatus, vlanPortVlanId=vlanPortVlanId, HexInteger=HexInteger, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortTable=vlanPortTable, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanSystemLastChange=vlanSystemLastChange, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanCountAPITotal=vlanCountAPITotal, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameVlanId=vlanNameVlanId, vlanSystemOperTime=vlanSystemOperTime, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameIndex=vlanNameIndex, vlanPortVlanName=vlanPortVlanName)
