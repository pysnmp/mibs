...
vlanPort, vlanCountAPI, vlanTestAPI, vlanAMRRules, vlanAPI, vlanAMRSubnets, vlanName, vlanSystem, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanCountAPI", "vlanTestAPI", "vlanAMRRules", "vlanAPI", "vlanAMRSubnets", "vlanName", "vlanSystem", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, HexInteger=HexInteger, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemDomainName=vlanSystemDomainName, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortVlanName=vlanPortVlanName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemLastChange=vlanSystemLastChange, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortTable=vlanPortTable, vlanNameMappedPorts=vlanNameMappedPorts, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemTable=vlanSystemTable, vlanNameIndex=vlanNameIndex, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortPortStatus=vlanPortPortStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortRelayAgent=vlanPortRelayAgent, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameTable=vlanNameTable, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameVlanName=vlanNameVlanName, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemEntry=vlanSystemEntry, vlanPortRouterPort=vlanPortRouterPort, SfpsSwitchPort=SfpsSwitchPort, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemMibRev=vlanSystemMibRev, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortEntry=vlanPortEntry, vlanNameEntry=vlanNameEntry, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameRelayAgent=vlanNameRelayAgent, SfpsAddress=SfpsAddress, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, VlanSwitchInstance=VlanSwitchInstance, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameVlanId=vlanNameVlanId, vlanPortPortNum=vlanPortPortNum, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameNHash=vlanNameNHash, vlanTestAPIVerb=vlanTestAPIVerb, vlanCountAPITotal=vlanCountAPITotal)
