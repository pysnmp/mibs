...
vlanCountAPI, vlanName, vlanAMRSubnets, vlanAPI, vlanSystem, vlanAMRStats, vlanPort, vlanAMRRules, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanName", "vlanAMRSubnets", "vlanAPI", "vlanSystem", "vlanAMRStats", "vlanPort", "vlanAMRRules", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameRelayAgent=vlanNameRelayAgent, vlanPortVlanName=vlanPortVlanName, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortVlanId=vlanPortVlanId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, VlanSwitchInstance=VlanSwitchInstance, vlanNameNumUsers=vlanNameNumUsers, vlanNameFloodPorts=vlanNameFloodPorts, HexInteger=HexInteger, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, SfpsAddress=SfpsAddress, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemPollCount=vlanSystemPollCount, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemVersion=vlanSystemVersion, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemEntry=vlanSystemEntry, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameEntry=vlanNameEntry, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameIndex=vlanNameIndex, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameTable=vlanNameTable, vlanNameNHash=vlanNameNHash, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanNameStatusTime=vlanNameStatusTime, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortEntry=vlanPortEntry, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameVlanName=vlanNameVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortTable=vlanPortTable, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix)
