...
vlanTestAPI, vlanPort, vlanName, vlanAMRSubnets, vlanSystem, vlanAPI, vlanAMRStats, vlanAMRRules, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanPort", "vlanName", "vlanAMRSubnets", "vlanSystem", "vlanAPI", "vlanAMRStats", "vlanAMRRules", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortRelayAgent=vlanPortRelayAgent, vlanNameVlanName=vlanNameVlanName, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortTable=vlanPortTable, vlanSystemLastChange=vlanSystemLastChange, vlanSystemVersion=vlanSystemVersion, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameVlanRule=vlanNameVlanRule, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameNHash=vlanNameNHash, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortPortNum=vlanPortPortNum, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortVlanName=vlanPortVlanName, vlanNameIndex=vlanNameIndex, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, SfpsSwitchPort=SfpsSwitchPort, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, VlanSwitchInstance=VlanSwitchInstance, vlanPortEntry=vlanPortEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortAdminStatus=vlanPortAdminStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIPort=vlanTestAPIPort, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemPriorPollTime=vlanSystemPriorPollTime, HexInteger=HexInteger, vlanNameEntry=vlanNameEntry, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameTable=vlanNameTable, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortVlanId=vlanPortVlanId, vlanPortRouterPort=vlanPortRouterPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemEntry=vlanSystemEntry, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemTable=vlanSystemTable, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIVlanId=vlanTestAPIVlanId, SfpsAddress=SfpsAddress, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortPortStatus=vlanPortPortStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanCountAPITotal=vlanCountAPITotal, vlanSystemMibRev=vlanSystemMibRev)
