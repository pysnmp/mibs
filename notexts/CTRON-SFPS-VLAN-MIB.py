...
vlanAMRRules, vlanAMRStats, vlanSystem, vlanName, vlanAPI, vlanCountAPI, vlanAMRSubnets, vlanTestAPI, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanAMRStats", "vlanSystem", "vlanName", "vlanAPI", "vlanCountAPI", "vlanAMRSubnets", "vlanTestAPI", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortVlanId=vlanPortVlanId, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemMibRev=vlanSystemMibRev, vlanNameEntry=vlanNameEntry, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameOperStatus=vlanNameOperStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameRelayAgent=vlanNameRelayAgent, HexInteger=HexInteger, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameVlanName=vlanNameVlanName, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanCountAPITotal=vlanCountAPITotal, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameTable=vlanNameTable, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPINvramId=sfpsVAPINvramId, VlanSwitchInstance=VlanSwitchInstance, vlanNameNHash=vlanNameNHash, vlanSystemDomainName=vlanSystemDomainName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemVersion=vlanSystemVersion, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemOperTime=vlanSystemOperTime, vlanPortRouterPort=vlanPortRouterPort, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortTable=vlanPortTable, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemAdminReset=vlanSystemAdminReset, SfpsAddress=SfpsAddress, vlanSystemEntry=vlanSystemEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameStatusTime=vlanNameStatusTime, vlanNameVlanId=vlanNameVlanId, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortEntry=vlanPortEntry, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemPollCount=vlanSystemPollCount, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameVlanRule=vlanNameVlanRule, vlanNameIndex=vlanNameIndex, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortPortNum=vlanPortPortNum, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanCountAPIAutoreg=vlanCountAPIAutoreg, SfpsSwitchPort=SfpsSwitchPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemLastChange=vlanSystemLastChange, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue)
