...
vlanPort, vlanAMRSubnets, vlanTestAPI, vlanAMRStats, vlanSystem, vlanAMRRules, vlanCountAPI, vlanName, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAMRSubnets", "vlanTestAPI", "vlanAMRStats", "vlanSystem", "vlanAMRRules", "vlanCountAPI", "vlanName", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameTable=vlanNameTable, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemVersion=vlanSystemVersion, VlanSwitchInstance=VlanSwitchInstance, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameVlanName=vlanNameVlanName, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameVlanId=vlanNameVlanId, SfpsAddress=SfpsAddress, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, HexInteger=HexInteger, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortVlanName=vlanPortVlanName, vlanPortVlanId=vlanPortVlanId, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemTable=vlanSystemTable, vlanPortEntry=vlanPortEntry, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortPortNum=vlanPortPortNum, vlanNameIndex=vlanNameIndex, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameStatusTime=vlanNameStatusTime, vlanNameEntry=vlanNameEntry, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemMibRev=vlanSystemMibRev, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameNumUsers=vlanNameNumUsers, vlanPortPortStatus=vlanPortPortStatus, vlanNameNHash=vlanNameNHash, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIInPort=sfpsVAPIInPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemEntry=vlanSystemEntry, vlanPortTable=vlanPortTable, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemDomainName=vlanSystemDomainName, vlanSystemPollCount=vlanSystemPollCount, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule)
