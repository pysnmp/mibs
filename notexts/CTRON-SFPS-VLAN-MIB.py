...
vlanName, vlanPort, vlanAMRRules, vlanAMRStats, vlanTestAPI, vlanCountAPI, vlanAPI, vlanSystem, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanPort", "vlanAMRRules", "vlanAMRStats", "vlanTestAPI", "vlanCountAPI", "vlanAPI", "vlanSystem", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", HexInteger=HexInteger, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameEntry=vlanNameEntry, vlanSystemDomainName=vlanSystemDomainName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemEntry=vlanSystemEntry, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemTable=vlanSystemTable, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortEntry=vlanPortEntry, vlanPortVlanName=vlanPortVlanName, vlanNameNumUsers=vlanNameNumUsers, VlanSwitchInstance=VlanSwitchInstance, SfpsAddress=SfpsAddress, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameIndex=vlanNameIndex, vlanNameNHash=vlanNameNHash, vlanSystemOperTime=vlanSystemOperTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemPollCount=vlanSystemPollCount, vlanPortTable=vlanPortTable, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemMibRev=vlanSystemMibRev, vlanPortPortStatus=vlanPortPortStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameTable=vlanNameTable, vlanSystemAdminStatus=vlanSystemAdminStatus, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameVlanRule=vlanNameVlanRule, vlanNameVlanName=vlanNameVlanName, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemVersion=vlanSystemVersion, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortPortNum=vlanPortPortNum, vlanCountAPITotal=vlanCountAPITotal, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag)
