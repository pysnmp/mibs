...
vlanAMRSubnets, vlanTestAPI, vlanName, vlanAMRRules, vlanAPI, vlanSystem, vlanCountAPI, vlanPort, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanTestAPI", "vlanName", "vlanAMRRules", "vlanAPI", "vlanSystem", "vlanCountAPI", "vlanPort", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemLastChange=vlanSystemLastChange, vlanNameNHash=vlanNameNHash, vlanPortRouterPort=vlanPortRouterPort, vlanNameVlanRule=vlanNameVlanRule, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemSwitchInstance=vlanSystemSwitchInstance, VlanSwitchInstance=VlanSwitchInstance, vlanNameTable=vlanNameTable, vlanNameStatusTime=vlanNameStatusTime, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemEntry=vlanSystemEntry, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanCountAPITotal=vlanCountAPITotal, vlanAMRRulesTable=vlanAMRRulesTable, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortPortNum=vlanPortPortNum, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIPort=vlanTestAPIPort, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameVlanId=vlanNameVlanId, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortVlanId=vlanPortVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemTable=vlanSystemTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, SfpsAddress=SfpsAddress, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortEntry=vlanPortEntry, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameNumUsers=vlanNameNumUsers, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameIndex=vlanNameIndex, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortVlanName=vlanPortVlanName, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameEntry=vlanNameEntry, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemMibRev=vlanSystemMibRev, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortPortStatus=vlanPortPortStatus, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortTable=vlanPortTable, vlanAMRRulesRule=vlanAMRRulesRule, HexInteger=HexInteger, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameVlanName=vlanNameVlanName, vlanPortLayer3Learning=vlanPortLayer3Learning)
