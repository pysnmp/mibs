...
vlanAMRStats, vlanTestAPI, vlanPort, vlanName, vlanSystem, vlanCountAPI, vlanAMRRules, vlanAPI, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanTestAPI", "vlanPort", "vlanName", "vlanSystem", "vlanCountAPI", "vlanAMRRules", "vlanAPI", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemOperTime=vlanSystemOperTime, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemPollCount=vlanSystemPollCount, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameVlanRule=vlanNameVlanRule, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameNumUsers=vlanNameNumUsers, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIPort=vlanTestAPIPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortEntry=vlanPortEntry, vlanSystemSwitchInstance=vlanSystemSwitchInstance, HexInteger=HexInteger, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortVlanId=vlanPortVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameEntry=vlanNameEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortVlanName=vlanPortVlanName, vlanSystemVersion=vlanSystemVersion, vlanNameNHash=vlanNameNHash, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRRulesRule=vlanAMRRulesRule, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameTable=vlanNameTable, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameIndex=vlanNameIndex, VlanSwitchInstance=VlanSwitchInstance, SfpsAddress=SfpsAddress, SfpsSwitchPort=SfpsSwitchPort, vlanSystemLastChange=vlanSystemLastChange, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameStatusTime=vlanNameStatusTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameOperStatus=vlanNameOperStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemEntry=vlanSystemEntry, vlanSystemTable=vlanSystemTable, vlanPortTable=vlanPortTable, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameVlanId=vlanNameVlanId, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortRouterPort=vlanPortRouterPort)
