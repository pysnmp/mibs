...
vlanAPI, vlanSystem, vlanPort, vlanTestAPI, vlanAMRStats, vlanCountAPI, vlanAMRSubnets, vlanAMRRules, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanSystem", "vlanPort", "vlanTestAPI", "vlanAMRStats", "vlanCountAPI", "vlanAMRSubnets", "vlanAMRRules", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputPort=vlanTestAPIOutputPort, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameEntry=vlanNameEntry, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameVlanRule=vlanNameVlanRule, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameTable=vlanNameTable, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortVlanId=vlanPortVlanId, vlanSystemVersion=vlanSystemVersion, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIVerb=sfpsVAPIVerb, vlanCountAPITotal=vlanCountAPITotal, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortTable=vlanPortTable, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameNHash=vlanNameNHash, vlanPortPortStatus=vlanPortPortStatus, HexInteger=HexInteger, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortEntry=vlanPortEntry, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemOperTime=vlanSystemOperTime, vlanNameVlanName=vlanNameVlanName, vlanSystemDomainName=vlanSystemDomainName, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanSystemTable=vlanSystemTable, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemLastChange=vlanSystemLastChange, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, VlanSwitchInstance=VlanSwitchInstance, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameNumUsers=vlanNameNumUsers, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortVlanName=vlanPortVlanName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortPortNum=vlanPortPortNum, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameIndex=vlanNameIndex, SfpsAddress=SfpsAddress, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble)
