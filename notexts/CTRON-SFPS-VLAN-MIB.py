...
vlanAPI, vlanTestAPI, vlanAMRRules, vlanAMRStats, vlanName, vlanCountAPI, vlanPort, vlanSystem, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanTestAPI", "vlanAMRRules", "vlanAMRStats", "vlanName", "vlanCountAPI", "vlanPort", "vlanSystem", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemLastChange=vlanSystemLastChange, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortVlanId=vlanPortVlanId, vlanSystemVersion=vlanSystemVersion, vlanPortPortNum=vlanPortPortNum, vlanSystemEntry=vlanSystemEntry, vlanNameEnabledPorts=vlanNameEnabledPorts, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortVlanName=vlanPortVlanName, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameAdminStatus=vlanNameAdminStatus, HexInteger=HexInteger, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, SfpsAddress=SfpsAddress, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanCountAPITotal=vlanCountAPITotal, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemTable=vlanSystemTable, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameIndex=vlanNameIndex, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameNumUsers=vlanNameNumUsers, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemMibRev=vlanSystemMibRev, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortTable=vlanPortTable, vlanNameVlanName=vlanNameVlanName, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameTable=vlanNameTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameNHash=vlanNameNHash, vlanNameVlanId=vlanNameVlanId, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortPortStatus=vlanPortPortStatus, vlanSystemDomainName=vlanSystemDomainName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemOperTime=vlanSystemOperTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg)
