...
vlanAMRRules, vlanName, vlanAPI, vlanTestAPI, vlanPort, vlanCountAPI, vlanAMRStats, vlanAMRSubnets, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanName", "vlanAPI", "vlanTestAPI", "vlanPort", "vlanCountAPI", "vlanAMRStats", "vlanAMRSubnets", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortRouterPort=vlanPortRouterPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameStatusTime=vlanNameStatusTime, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemOperTime=vlanSystemOperTime, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIPort=vlanTestAPIPort, vlanNameNHash=vlanNameNHash, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameVlanId=vlanNameVlanId, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameTable=vlanNameTable, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanCountAPITotal=vlanCountAPITotal, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameVlanRule=vlanNameVlanRule, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemMibRev=vlanSystemMibRev, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortEntry=vlanPortEntry, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortLayer3Learning=vlanPortLayer3Learning, SfpsAddress=SfpsAddress, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameNumUsers=vlanNameNumUsers, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameVlanName=vlanNameVlanName, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputTap=vlanTestAPIOutputTap, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortVlanId=vlanPortVlanId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameEntry=vlanNameEntry, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemEntry=vlanSystemEntry, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemTable=vlanSystemTable, HexInteger=HexInteger, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemVersion=vlanSystemVersion, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortTable=vlanPortTable, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortPortStatus=vlanPortPortStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemPollCount=vlanSystemPollCount)
