...
vlanAPI, vlanTestAPI, vlanAMRRules, vlanCountAPI, vlanSystem, vlanAMRSubnets, vlanPort, vlanName, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanTestAPI", "vlanAMRRules", "vlanCountAPI", "vlanSystem", "vlanAMRSubnets", "vlanPort", "vlanName", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortVlanName=vlanPortVlanName, vlanNameNHash=vlanNameNHash, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortVlanId=vlanPortVlanId, SfpsSwitchPort=SfpsSwitchPort, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemOperTime=vlanSystemOperTime, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortEntry=vlanPortEntry, vlanTestAPIPort=vlanTestAPIPort, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameIndex=vlanNameIndex, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortPortStatus=vlanPortPortStatus, vlanSystemMibRev=vlanSystemMibRev, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameVlanName=vlanNameVlanName, vlanPortPortNum=vlanPortPortNum, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemDomainName=vlanSystemDomainName, SfpsAddress=SfpsAddress, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameTable=vlanNameTable, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemVersion=vlanSystemVersion, vlanCountAPITotal=vlanCountAPITotal, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameVlanId=vlanNameVlanId, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameNumUsers=vlanNameNumUsers, vlanNameEntry=vlanNameEntry, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameOperStatus=vlanNameOperStatus, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, HexInteger=HexInteger, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemAdminStatus=vlanSystemAdminStatus, VlanSwitchInstance=VlanSwitchInstance, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortTable=vlanPortTable, vlanSystemTable=vlanSystemTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus)
