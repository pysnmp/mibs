...
vlanCountAPI, vlanAMRRules, vlanAMRStats, vlanAPI, vlanAMRSubnets, vlanSystem, vlanPort, vlanTestAPI, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAMRRules", "vlanAMRStats", "vlanAPI", "vlanAMRSubnets", "vlanSystem", "vlanPort", "vlanTestAPI", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameMappedPorts=vlanNameMappedPorts, vlanNameVlanId=vlanNameVlanId, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemMibRev=vlanSystemMibRev, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameVlanName=vlanNameVlanName, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameTable=vlanNameTable, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemVersion=vlanSystemVersion, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortEntry=vlanPortEntry, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemTable=vlanSystemTable, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameStatusTime=vlanNameStatusTime, vlanPortPortStatus=vlanPortPortStatus, vlanCountAPITotal=vlanCountAPITotal, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameNHash=vlanNameNHash, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortVlanId=vlanPortVlanId, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameOperStatus=vlanNameOperStatus, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortVlanName=vlanPortVlanName, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemEntry=vlanSystemEntry, vlanTestAPIPort=vlanTestAPIPort, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputPort=vlanTestAPIOutputPort, HexInteger=HexInteger, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemPollCount=vlanSystemPollCount, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, SfpsAddress=SfpsAddress, vlanNameIndex=vlanNameIndex, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemSwitchInstance=vlanSystemSwitchInstance, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameEntry=vlanNameEntry, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortTable=vlanPortTable, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameNumUsers=vlanNameNumUsers, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemOperTime=vlanSystemOperTime)
