...
vlanTestAPI, vlanAMRSubnets, vlanSystem, vlanName, vlanAMRRules, vlanAMRStats, vlanPort, vlanCountAPI, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanAMRSubnets", "vlanSystem", "vlanName", "vlanAMRRules", "vlanAMRStats", "vlanPort", "vlanCountAPI", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", SfpsSwitchPort=SfpsSwitchPort, vlanPortTable=vlanPortTable, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputTable=vlanTestAPIOutputTable, SfpsAddress=SfpsAddress, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortPortStatus=vlanPortPortStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameNHash=vlanNameNHash, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemVersion=vlanSystemVersion, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortEntry=vlanPortEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemTable=vlanSystemTable, vlanPortRouterPort=vlanPortRouterPort, vlanSystemMibRev=vlanSystemMibRev, vlanSystemOperTime=vlanSystemOperTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameNumUsers=vlanNameNumUsers, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameTable=vlanNameTable, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortPortNum=vlanPortPortNum, vlanNameVlanRule=vlanNameVlanRule, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameVlanId=vlanNameVlanId, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemEntry=vlanSystemEntry, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPINvramId=sfpsVAPINvramId, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanCountAPITotal=vlanCountAPITotal, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortVlanName=vlanPortVlanName, vlanPortVlanId=vlanPortVlanId, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, HexInteger=HexInteger, vlanSystemPollCount=vlanSystemPollCount, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameVlanName=vlanNameVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameIndex=vlanNameIndex, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix)
