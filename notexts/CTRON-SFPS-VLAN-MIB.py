...
vlanAMRRules, vlanTestAPI, vlanPort, vlanCountAPI, vlanSystem, vlanAPI, vlanAMRStats, vlanName, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanTestAPI", "vlanPort", "vlanCountAPI", "vlanSystem", "vlanAPI", "vlanAMRStats", "vlanName", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameEntry=vlanNameEntry, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameOperStatus=vlanNameOperStatus, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, SfpsAddress=SfpsAddress, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameAdminStatus=vlanNameAdminStatus, VlanSwitchInstance=VlanSwitchInstance, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameTable=vlanNameTable, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameNHash=vlanNameNHash, vlanSystemMibRev=vlanSystemMibRev, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortPortNum=vlanPortPortNum, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemTable=vlanSystemTable, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIInPort=sfpsVAPIInPort, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortVlanId=vlanPortVlanId, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameVlanName=vlanNameVlanName, vlanPortRouterPort=vlanPortRouterPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortPortStatus=vlanPortPortStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemVersion=vlanSystemVersion, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameIndex=vlanNameIndex, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortVlanName=vlanPortVlanName, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameVlanId=vlanNameVlanId, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, HexInteger=HexInteger, vlanPortTable=vlanPortTable, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIPort=vlanTestAPIPort, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemDomainName=vlanSystemDomainName)
