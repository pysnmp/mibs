...
vlanName, vlanCountAPI, vlanPort, vlanAMRStats, vlanAPI, vlanAMRRules, vlanSystem, vlanTestAPI, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanCountAPI", "vlanPort", "vlanAMRStats", "vlanAPI", "vlanAMRRules", "vlanSystem", "vlanTestAPI", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameTable=vlanNameTable, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIPort=vlanTestAPIPort, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemEntry=vlanSystemEntry, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanCountAPITotal=vlanCountAPITotal, vlanNameVlanName=vlanNameVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortPortNum=vlanPortPortNum, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameVlanId=vlanNameVlanId, HexInteger=HexInteger, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortVlanName=vlanPortVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameVlanRule=vlanNameVlanRule, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemOperTime=vlanSystemOperTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortEntry=vlanPortEntry, SfpsSwitchPort=SfpsSwitchPort, vlanSystemVersion=vlanSystemVersion, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameStatusTime=vlanNameStatusTime, vlanSystemLastChange=vlanSystemLastChange, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanPortTable=vlanPortTable, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameIndex=vlanNameIndex, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRSubnetsMask=vlanAMRSubnetsMask, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameNHash=vlanNameNHash, vlanPortVlanId=vlanPortVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameOperStatus=vlanNameOperStatus, SfpsAddress=SfpsAddress, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue)
