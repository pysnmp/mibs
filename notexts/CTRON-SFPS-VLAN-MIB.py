...
vlanName, vlanAMRSubnets, vlanCountAPI, vlanPort, vlanSystem, vlanAMRRules, vlanAPI, vlanTestAPI, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanAMRSubnets", "vlanCountAPI", "vlanPort", "vlanSystem", "vlanAMRRules", "vlanAPI", "vlanTestAPI", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameIndex=vlanNameIndex, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemVersion=vlanSystemVersion, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameVlanName=vlanNameVlanName, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, VlanSwitchInstance=VlanSwitchInstance, SfpsAddress=SfpsAddress, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameNHash=vlanNameNHash, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, HexInteger=HexInteger, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemEntry=vlanSystemEntry, vlanNameEntry=vlanNameEntry, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameOperStatus=vlanNameOperStatus, vlanPortVlanName=vlanPortVlanName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIPort=vlanTestAPIPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameMappedPorts=vlanNameMappedPorts, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortVlanId=vlanPortVlanId, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemOperTime=vlanSystemOperTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemPollCount=vlanSystemPollCount, vlanPortEntry=vlanPortEntry, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameVlanRule=vlanNameVlanRule, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameNumUsers=vlanNameNumUsers, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameVlanId=vlanNameVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemLastChange=vlanSystemLastChange, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemTable=vlanSystemTable, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortTable=vlanPortTable, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanCountAPITotal=vlanCountAPITotal, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameTable=vlanNameTable, vlanPortPortNum=vlanPortPortNum, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortFloodPolicy=vlanPortFloodPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemOperStatus=vlanSystemOperStatus)
