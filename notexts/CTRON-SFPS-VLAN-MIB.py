...
vlanName, vlanCountAPI, vlanTestAPI, vlanSystem, vlanAMRSubnets, vlanAMRStats, vlanAPI, vlanAMRRules, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanCountAPI", "vlanTestAPI", "vlanSystem", "vlanAMRSubnets", "vlanAMRStats", "vlanAPI", "vlanAMRRules", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIVerb=vlanTestAPIVerb, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortRouterPort=vlanPortRouterPort, vlanSystemEntry=vlanSystemEntry, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanPortPortNum=vlanPortPortNum, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemMibRev=vlanSystemMibRev, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRRulesRule=vlanAMRRulesRule, SfpsSwitchPort=SfpsSwitchPort, vlanSystemTable=vlanSystemTable, HexInteger=HexInteger, vlanNameVlanId=vlanNameVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemDomainName=vlanSystemDomainName, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanCountAPIAdmin=vlanCountAPIAdmin, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameEntry=vlanNameEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameTable=vlanNameTable, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemVersion=vlanSystemVersion, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIPort=vlanTestAPIPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortVlanName=vlanPortVlanName, vlanNameOperStatus=vlanNameOperStatus, vlanSystemOperTime=vlanSystemOperTime, SfpsAddress=SfpsAddress, vlanNameNHash=vlanNameNHash, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameStatusTime=vlanNameStatusTime, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortTable=vlanPortTable, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIUserAlias=sfpsVAPIUserAlias)
