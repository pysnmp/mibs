...
vlanAMRStats, vlanAPI, vlanName, vlanCountAPI, vlanSystem, vlanPort, vlanTestAPI, vlanAMRSubnets, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanAPI", "vlanName", "vlanCountAPI", "vlanSystem", "vlanPort", "vlanTestAPI", "vlanAMRSubnets", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameEntry=vlanNameEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortPortNum=vlanPortPortNum, vlanNameTable=vlanNameTable, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameIndex=vlanNameIndex, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemOperTime=vlanSystemOperTime, vlanNameNHash=vlanNameNHash, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemTable=vlanSystemTable, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortTable=vlanPortTable, HexInteger=HexInteger, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameVlanName=vlanNameVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemPollCount=vlanSystemPollCount, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIInPort=sfpsVAPIInPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanCountAPITotal=vlanCountAPITotal, vlanSystemDomainName=vlanSystemDomainName, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemEntry=vlanSystemEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIPort=vlanTestAPIPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameOperStatus=vlanNameOperStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIVlanName=vlanTestAPIVlanName, SfpsAddress=SfpsAddress, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, SfpsSwitchPort=SfpsSwitchPort, vlanPortVlanId=vlanPortVlanId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemMibRev=vlanSystemMibRev, vlanPortEntry=vlanPortEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemVersion=vlanSystemVersion, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortRouterPort=vlanPortRouterPort)
