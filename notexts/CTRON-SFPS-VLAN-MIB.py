...
vlanAMRStats, vlanTestAPI, vlanCountAPI, vlanAMRSubnets, vlanPort, vlanAPI, vlanAMRRules, vlanName, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanTestAPI", "vlanCountAPI", "vlanAMRSubnets", "vlanPort", "vlanAPI", "vlanAMRRules", "vlanName", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemDomainName=vlanSystemDomainName, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemEntry=vlanSystemEntry, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortRouterPort=vlanPortRouterPort, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortPortNum=vlanPortPortNum, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortVlanName=vlanPortVlanName, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemMibRev=vlanSystemMibRev, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortTable=vlanPortTable, vlanSystemTable=vlanSystemTable, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIVlanName=vlanTestAPIVlanName, SfpsAddress=SfpsAddress, vlanPortEntry=vlanPortEntry, vlanPortAdminStatus=vlanPortAdminStatus, HexInteger=HexInteger, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameVlanId=vlanNameVlanId, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameNHash=vlanNameNHash, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemOperTime=vlanSystemOperTime, vlanPortVlanId=vlanPortVlanId, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanCountAPITotal=vlanCountAPITotal, vlanSystemPollCount=vlanSystemPollCount, vlanNameTable=vlanNameTable, vlanTestAPIPort=vlanTestAPIPort, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameStatusTime=vlanNameStatusTime, VlanSwitchInstance=VlanSwitchInstance, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, SfpsSwitchPort=SfpsSwitchPort, vlanNameIndex=vlanNameIndex, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameVlanName=vlanNameVlanName, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameVlanRule=vlanNameVlanRule, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortPortPolicy=vlanPortPortPolicy)
