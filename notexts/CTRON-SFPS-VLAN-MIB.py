...
vlanSystem, vlanTestAPI, vlanAPI, vlanName, vlanAMRStats, vlanAMRRules, vlanCountAPI, vlanPort, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanTestAPI", "vlanAPI", "vlanName", "vlanAMRStats", "vlanAMRRules", "vlanCountAPI", "vlanPort", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemPollCount=vlanSystemPollCount, vlanPortTable=vlanPortTable, vlanNameNumUsers=vlanNameNumUsers, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortPortNum=vlanPortPortNum, vlanNameNHash=vlanNameNHash, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortPortPolicy=vlanPortPortPolicy, SfpsAddress=SfpsAddress, vlanPortPortStatus=vlanPortPortStatus, vlanSystemVersion=vlanSystemVersion, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameEntry=vlanNameEntry, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameTable=vlanNameTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemEntry=vlanSystemEntry, HexInteger=HexInteger, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameVlanName=vlanNameVlanName, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortVlanId=vlanPortVlanId, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortRelayAgent=vlanPortRelayAgent, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameStatusTime=vlanNameStatusTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortRouterPort=vlanPortRouterPort, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIPort=vlanTestAPIPort, vlanPortEntry=vlanPortEntry, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemTable=vlanSystemTable, vlanNameVlanId=vlanNameVlanId, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameVlanRule=vlanNameVlanRule, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameIndex=vlanNameIndex, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIVlanId=sfpsVAPIVlanId)
