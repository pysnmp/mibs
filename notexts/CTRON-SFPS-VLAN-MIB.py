...
vlanName, vlanPort, vlanTestAPI, vlanSystem, vlanAMRRules, vlanAMRSubnets, vlanAPI, vlanCountAPI, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanPort", "vlanTestAPI", "vlanSystem", "vlanAMRRules", "vlanAMRSubnets", "vlanAPI", "vlanCountAPI", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameEntry=vlanNameEntry, vlanNameOperStatus=vlanNameOperStatus, HexInteger=HexInteger, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameTable=vlanNameTable, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemPollCount=vlanSystemPollCount, vlanNameVlanRule=vlanNameVlanRule, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortVlanId=vlanPortVlanId, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortEntry=vlanPortEntry, vlanPortTable=vlanPortTable, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortRouterPort=vlanPortRouterPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIPort=vlanTestAPIPort, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIVlanName=sfpsVAPIVlanName, SfpsAddress=SfpsAddress, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameStatusTime=vlanNameStatusTime, vlanNameVlanId=vlanNameVlanId, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortPortStatus=vlanPortPortStatus, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputPort=vlanTestAPIOutputPort, VlanSwitchInstance=VlanSwitchInstance, vlanSystemOperTime=vlanSystemOperTime, vlanPortVlanName=vlanPortVlanName, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameVlanName=vlanNameVlanName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortPortNum=vlanPortPortNum, vlanNameAdminStatus=vlanNameAdminStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameNumUsers=vlanNameNumUsers, vlanSystemTable=vlanSystemTable, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameNHash=vlanNameNHash, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemVersion=vlanSystemVersion, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRRulesRule=vlanAMRRulesRule)
