...
vlanName, vlanCountAPI, vlanAPI, vlanTestAPI, vlanSystem, vlanAMRSubnets, vlanAMRRules, vlanPort, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanCountAPI", "vlanAPI", "vlanTestAPI", "vlanSystem", "vlanAMRSubnets", "vlanAMRRules", "vlanPort", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortEntry=vlanPortEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameVlanName=vlanNameVlanName, vlanPortTable=vlanPortTable, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameEntry=vlanNameEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, VlanSwitchInstance=VlanSwitchInstance, vlanSystemTable=vlanSystemTable, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIVlanId=sfpsVAPIVlanId, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemOperTime=vlanSystemOperTime, vlanNameIndex=vlanNameIndex, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemLastChange=vlanSystemLastChange, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanCountAPITotal=vlanCountAPITotal, HexInteger=HexInteger, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemMibRev=vlanSystemMibRev, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortVlanId=vlanPortVlanId, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameOperStatus=vlanNameOperStatus, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameTable=vlanNameTable, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemEntry=vlanSystemEntry, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortVlanName=vlanPortVlanName, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameNHash=vlanNameNHash, SfpsAddress=SfpsAddress, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameVlanId=vlanNameVlanId, vlanTestAPIVlanId=vlanTestAPIVlanId)
