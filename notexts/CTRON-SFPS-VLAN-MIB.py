...
vlanPort, vlanTestAPI, vlanCountAPI, vlanAMRRules, vlanAPI, vlanAMRStats, vlanSystem, vlanAMRSubnets, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanTestAPI", "vlanCountAPI", "vlanAMRRules", "vlanAPI", "vlanAMRStats", "vlanSystem", "vlanAMRSubnets", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortTable=vlanPortTable, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameOperStatus=vlanNameOperStatus, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameVlanId=vlanNameVlanId, SfpsAddress=SfpsAddress, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameVlanRule=vlanNameVlanRule, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortEntry=vlanPortEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, VlanSwitchInstance=VlanSwitchInstance, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameTable=vlanNameTable, vlanPortVlanId=vlanPortVlanId, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemEntry=vlanSystemEntry, vlanSystemVersion=vlanSystemVersion, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameStatusTime=vlanNameStatusTime, vlanNameVlanName=vlanNameVlanName, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameEntry=vlanNameEntry, vlanPortPortNum=vlanPortPortNum, vlanPortPortStatus=vlanPortPortStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemPollCount=vlanSystemPollCount, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemOperTime=vlanSystemOperTime, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameNHash=vlanNameNHash, vlanNameIndex=vlanNameIndex, HexInteger=HexInteger, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemTable=vlanSystemTable, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputTable=vlanTestAPIOutputTable)
