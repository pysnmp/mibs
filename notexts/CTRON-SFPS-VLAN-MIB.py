...
vlanAMRRules, vlanAMRSubnets, vlanSystem, vlanName, vlanAMRStats, vlanPort, vlanCountAPI, vlanTestAPI, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanAMRSubnets", "vlanSystem", "vlanName", "vlanAMRStats", "vlanPort", "vlanCountAPI", "vlanTestAPI", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemOperTime=vlanSystemOperTime, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameTable=vlanNameTable, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, VlanSwitchInstance=VlanSwitchInstance, vlanNameVlanRule=vlanNameVlanRule, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameStatusTime=vlanNameStatusTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, HexInteger=HexInteger, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameVlanId=vlanNameVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, SfpsAddress=SfpsAddress, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemPollCount=vlanSystemPollCount, vlanSystemEntry=vlanSystemEntry, vlanNameEntry=vlanNameEntry, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemVersion=vlanSystemVersion, vlanPortEntry=vlanPortEntry, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortVlanId=vlanPortVlanId, vlanNameIndex=vlanNameIndex, vlanSystemAgentIP=vlanSystemAgentIP, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortPortNum=vlanPortPortNum, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIPort=vlanTestAPIPort, vlanSystemLastChange=vlanSystemLastChange, vlanPortVlanName=vlanPortVlanName, vlanSystemMibRev=vlanSystemMibRev, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortPortStatus=vlanPortPortStatus, vlanNameOperStatus=vlanNameOperStatus, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemDomainName=vlanSystemDomainName, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameVlanName=vlanNameVlanName, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, SfpsSwitchPort=SfpsSwitchPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortTable=vlanPortTable, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameNumUsers=vlanNameNumUsers, vlanSystemTable=vlanSystemTable, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameMappedPorts=vlanNameMappedPorts)
