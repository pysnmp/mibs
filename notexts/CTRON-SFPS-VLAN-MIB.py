...
vlanCountAPI, vlanAMRStats, vlanAMRSubnets, vlanPort, vlanTestAPI, vlanAMRRules, vlanName, vlanAPI, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAMRStats", "vlanAMRSubnets", "vlanPort", "vlanTestAPI", "vlanAMRRules", "vlanName", "vlanAPI", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortPortNum=vlanPortPortNum, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameVlanName=vlanNameVlanName, vlanSystemLastChange=vlanSystemLastChange, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortTable=vlanPortTable, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanCountAPITotal=vlanCountAPITotal, vlanPortVlanName=vlanPortVlanName, vlanSystemVersion=vlanSystemVersion, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameVlanRule=vlanNameVlanRule, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameTable=vlanNameTable, vlanSystemTable=vlanSystemTable, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameVlanId=vlanNameVlanId, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortRouterPort=vlanPortRouterPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemDomainName=vlanSystemDomainName, vlanPortEntry=vlanPortEntry, vlanSystemEntry=vlanSystemEntry, SfpsAddress=SfpsAddress, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortPortStatus=vlanPortPortStatus, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIPort=vlanTestAPIPort, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameNHash=vlanNameNHash, vlanSystemOperTime=vlanSystemOperTime, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemMibRev=vlanSystemMibRev, vlanPortVlanId=vlanPortVlanId, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameEntry=vlanNameEntry, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIInPort=sfpsVAPIInPort, HexInteger=HexInteger, vlanAMRRulesTable=vlanAMRRulesTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameStatusTime=vlanNameStatusTime, vlanNameIndex=vlanNameIndex, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy)
