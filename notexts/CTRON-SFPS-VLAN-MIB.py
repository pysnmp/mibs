...
vlanAPI, vlanAMRStats, vlanTestAPI, vlanAMRRules, vlanPort, vlanSystem, vlanAMRSubnets, vlanName, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanAMRStats", "vlanTestAPI", "vlanAMRRules", "vlanPort", "vlanSystem", "vlanAMRSubnets", "vlanName", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortRelayAgent=vlanPortRelayAgent, SfpsAddress=SfpsAddress, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameEntry=vlanNameEntry, vlanNameVlanRule=vlanNameVlanRule, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemMibRev=vlanSystemMibRev, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameStatusTime=vlanNameStatusTime, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortPortStatus=vlanPortPortStatus, vlanNameTable=vlanNameTable, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanPortEntry=vlanPortEntry, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortPortNum=vlanPortPortNum, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameIndex=vlanNameIndex, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortVlanId=vlanPortVlanId, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemTable=vlanSystemTable, vlanNameNHash=vlanNameNHash, vlanPortVlanName=vlanPortVlanName, vlanSystemDomainName=vlanSystemDomainName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRSubnetsMask=vlanAMRSubnetsMask, HexInteger=HexInteger, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortTable=vlanPortTable, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, VlanSwitchInstance=VlanSwitchInstance, vlanNameVlanId=vlanNameVlanId, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemVersion=vlanSystemVersion, vlanCountAPIAdmin=vlanCountAPIAdmin)
