...
vlanTestAPI, vlanPort, vlanAMRRules, vlanAMRSubnets, vlanName, vlanAMRStats, vlanSystem, vlanAPI, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanPort", "vlanAMRRules", "vlanAMRSubnets", "vlanName", "vlanAMRStats", "vlanSystem", "vlanAPI", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameVlanRule=vlanNameVlanRule, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemTable=vlanSystemTable, vlanPortVlanName=vlanPortVlanName, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameFloodPorts=vlanNameFloodPorts, SfpsAddress=SfpsAddress, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIPort=vlanTestAPIPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameTable=vlanNameTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemEntry=vlanSystemEntry, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameNumUsers=vlanNameNumUsers, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortTable=vlanPortTable, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameIndex=vlanNameIndex, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameVlanName=vlanNameVlanName, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortUniPolicy=vlanPortUniPolicy, HexInteger=HexInteger, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameVlanId=vlanNameVlanId, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameEntry=vlanNameEntry, vlanNameMappedPorts=vlanNameMappedPorts, VlanSwitchInstance=VlanSwitchInstance, vlanNameOperStatus=vlanNameOperStatus, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanSystemVersion=vlanSystemVersion, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortVlanId=vlanPortVlanId, vlanNameNHash=vlanNameNHash, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortRouterPort=vlanPortRouterPort, SfpsSwitchPort=SfpsSwitchPort, vlanNameUniPolicy=vlanNameUniPolicy)
