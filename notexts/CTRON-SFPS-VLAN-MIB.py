...
vlanAMRStats, vlanAMRSubnets, vlanCountAPI, vlanPort, vlanTestAPI, vlanSystem, vlanAMRRules, vlanName, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanAMRSubnets", "vlanCountAPI", "vlanPort", "vlanTestAPI", "vlanSystem", "vlanAMRRules", "vlanName", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameVlanName=vlanNameVlanName, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortFloodPolicy=vlanPortFloodPolicy, SfpsAddress=SfpsAddress, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanCountAPITotal=vlanCountAPITotal, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameNHash=vlanNameNHash, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortRouterPort=vlanPortRouterPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortVlanName=vlanPortVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemLastChange=vlanSystemLastChange, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameOperStatus=vlanNameOperStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortVlanId=vlanPortVlanId, vlanPortPortNum=vlanPortPortNum, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameEntry=vlanNameEntry, vlanNameNumUsers=vlanNameNumUsers, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemOperTime=vlanSystemOperTime, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemPollCount=vlanSystemPollCount, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIPort=vlanTestAPIPort, vlanSystemEntry=vlanSystemEntry, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemTable=vlanSystemTable, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortTable=vlanPortTable, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemMibRev=vlanSystemMibRev, vlanNameTable=vlanNameTable, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortEntry=vlanPortEntry, vlanNameIndex=vlanNameIndex, vlanNameVlanRule=vlanNameVlanRule, vlanSystemDomainName=vlanSystemDomainName, SfpsSwitchPort=SfpsSwitchPort, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemVersion=vlanSystemVersion, HexInteger=HexInteger, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameVlanId=vlanNameVlanId, vlanNameStatusTime=vlanNameStatusTime)
