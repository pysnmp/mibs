...
vlanAMRRules, vlanAMRSubnets, vlanAMRStats, vlanPort, vlanName, vlanAPI, vlanTestAPI, vlanCountAPI, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanAMRSubnets", "vlanAMRStats", "vlanPort", "vlanName", "vlanAPI", "vlanTestAPI", "vlanCountAPI", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemTable=vlanSystemTable, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameVlanName=vlanNameVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameEntry=vlanNameEntry, vlanNameVlanId=vlanNameVlanId, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortVlanName=vlanPortVlanName, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanCountAPITotal=vlanCountAPITotal, vlanPortEntry=vlanPortEntry, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, HexInteger=HexInteger, vlanSystemLastChange=vlanSystemLastChange, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIPort=vlanTestAPIPort, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortTable=vlanPortTable, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameTable=vlanNameTable, vlanSystemMibRev=vlanSystemMibRev, SfpsAddress=SfpsAddress, vlanNameStatusTime=vlanNameStatusTime, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameNHash=vlanNameNHash, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemVersion=vlanSystemVersion, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemEntry=vlanSystemEntry, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemPollCount=vlanSystemPollCount, vlanNameVlanRule=vlanNameVlanRule, SfpsSwitchPort=SfpsSwitchPort, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameOperStatus=vlanNameOperStatus)
