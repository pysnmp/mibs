...
vlanAMRSubnets, vlanAMRRules, vlanName, vlanAMRStats, vlanSystem, vlanTestAPI, vlanPort, vlanAPI, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanAMRRules", "vlanName", "vlanAMRStats", "vlanSystem", "vlanTestAPI", "vlanPort", "vlanAPI", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameVlanName=vlanNameVlanName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortVlanName=vlanPortVlanName, vlanNameIndex=vlanNameIndex, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameNHash=vlanNameNHash, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemVersion=vlanSystemVersion, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIPort=vlanTestAPIPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameEntry=vlanNameEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemTable=vlanSystemTable, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemEntry=vlanSystemEntry, vlanTestAPIVlanId=vlanTestAPIVlanId, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortVlanId=vlanPortVlanId, vlanSystemLastChange=vlanSystemLastChange, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemPollCount=vlanSystemPollCount, SfpsSwitchPort=SfpsSwitchPort, vlanPortTable=vlanPortTable, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameOperStatus=vlanNameOperStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortPortNum=vlanPortPortNum, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameTable=vlanNameTable, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputAble=vlanTestAPIOutputAble, HexInteger=HexInteger, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameFloodPorts=vlanNameFloodPorts, SfpsAddress=SfpsAddress, vlanTestAPIVerb=vlanTestAPIVerb, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName)
