...
vlanAMRSubnets, vlanName, vlanAMRStats, vlanAMRRules, vlanPort, vlanSystem, vlanAPI, vlanCountAPI, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanName", "vlanAMRStats", "vlanAMRRules", "vlanPort", "vlanSystem", "vlanAPI", "vlanCountAPI", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortVlanName=vlanPortVlanName, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameVlanRule=vlanNameVlanRule, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortPortNum=vlanPortPortNum, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemDomainName=vlanSystemDomainName, vlanCountAPITotal=vlanCountAPITotal, vlanSystemOperTime=vlanSystemOperTime, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameIndex=vlanNameIndex, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameOperStatus=vlanNameOperStatus, vlanSystemEntry=vlanSystemEntry, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemVersion=vlanSystemVersion, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, SfpsAddress=SfpsAddress, HexInteger=HexInteger, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortTable=vlanPortTable, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameVlanId=vlanNameVlanId, vlanCountAPIAdmin=vlanCountAPIAdmin, SfpsSwitchPort=SfpsSwitchPort, vlanPortVlanId=vlanPortVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameEntry=vlanNameEntry, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameTable=vlanNameTable, vlanSystemTable=vlanSystemTable, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameStatusTime=vlanNameStatusTime, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemPollCount=vlanSystemPollCount, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIPort=vlanTestAPIPort, vlanPortEntry=vlanPortEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameVlanName=vlanNameVlanName, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputMap=vlanTestAPIOutputMap)
