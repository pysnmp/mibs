...
vlanName, vlanPort, vlanCountAPI, vlanAMRStats, vlanTestAPI, vlanSystem, vlanAMRRules, vlanAMRSubnets, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanPort", "vlanCountAPI", "vlanAMRStats", "vlanTestAPI", "vlanSystem", "vlanAMRRules", "vlanAMRSubnets", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameVlanId=vlanNameVlanId, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameOperStatus=vlanNameOperStatus, SfpsAddress=SfpsAddress, vlanNameEntry=vlanNameEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemEntry=vlanSystemEntry, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameVlanRule=vlanNameVlanRule, vlanAMRRulesStatus=vlanAMRRulesStatus, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, SfpsSwitchPort=SfpsSwitchPort, vlanPortVlanId=vlanPortVlanId, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemPollCount=vlanSystemPollCount, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameTable=vlanNameTable, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIPort=vlanTestAPIPort, vlanPortPortNum=vlanPortPortNum, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemLastChange=vlanSystemLastChange, vlanNameIndex=vlanNameIndex, vlanNameVlanName=vlanNameVlanName, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortPortStatus=vlanPortPortStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, HexInteger=HexInteger, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemTable=vlanSystemTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemDomainName=vlanSystemDomainName, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortTable=vlanPortTable, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortVlanName=vlanPortVlanName, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemOperTime=vlanSystemOperTime, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameNHash=vlanNameNHash, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortEntry=vlanPortEntry, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable)
