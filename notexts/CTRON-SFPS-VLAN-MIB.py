...
vlanAPI, vlanAMRRules, vlanName, vlanAMRSubnets, vlanAMRStats, vlanSystem, vlanCountAPI, vlanPort, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanAMRRules", "vlanName", "vlanAMRSubnets", "vlanAMRStats", "vlanSystem", "vlanCountAPI", "vlanPort", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIVerb=sfpsVAPIVerb, vlanPortVlanId=vlanPortVlanId, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameTable=vlanNameTable, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortEntry=vlanPortEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameStatusTime=vlanNameStatusTime, vlanNameIndex=vlanNameIndex, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortUniPolicy=vlanPortUniPolicy, SfpsAddress=SfpsAddress, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortFloodPolicy=vlanPortFloodPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameVlanName=vlanNameVlanName, vlanSystemEntry=vlanSystemEntry, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemMibRev=vlanSystemMibRev, HexInteger=HexInteger, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameNHash=vlanNameNHash, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameNumUsers=vlanNameNumUsers, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameEntry=vlanNameEntry, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortRouterPort=vlanPortRouterPort, vlanPortVlanName=vlanPortVlanName, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemOperTime=vlanSystemOperTime, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortTable=vlanPortTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameVlanId=vlanNameVlanId, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortPortNum=vlanPortPortNum, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemVersion=vlanSystemVersion, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortPortStatus=vlanPortPortStatus, vlanSystemPollCount=vlanSystemPollCount, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemTable=vlanSystemTable, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameVlanRule=vlanNameVlanRule, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanCountAPITotal=vlanCountAPITotal)
