...
vlanTestAPI, vlanAPI, vlanPort, vlanSystem, vlanAMRRules, vlanCountAPI, vlanName, vlanAMRSubnets, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanAPI", "vlanPort", "vlanSystem", "vlanAMRRules", "vlanCountAPI", "vlanName", "vlanAMRSubnets", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameIndex=vlanNameIndex, vlanPortAdminStatus=vlanPortAdminStatus, SfpsAddress=SfpsAddress, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortPortNum=vlanPortPortNum, vlanSystemPollCount=vlanSystemPollCount, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortTable=vlanPortTable, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameVlanId=vlanNameVlanId, vlanNameTable=vlanNameTable, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortEntry=vlanPortEntry, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameVlanName=vlanNameVlanName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIPort=vlanTestAPIPort, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanCountAPIAdmin=vlanCountAPIAdmin, SfpsSwitchPort=SfpsSwitchPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameNHash=vlanNameNHash, vlanCountAPITotal=vlanCountAPITotal, vlanPortPortStatus=vlanPortPortStatus, vlanNameOperStatus=vlanNameOperStatus, vlanSystemLastChange=vlanSystemLastChange, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemVersion=vlanSystemVersion, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortVlanName=vlanPortVlanName, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortVlanId=vlanPortVlanId, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, HexInteger=HexInteger, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameNumUsers=vlanNameNumUsers, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIInPort=sfpsVAPIInPort, VlanSwitchInstance=VlanSwitchInstance, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemTable=vlanSystemTable, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemDomainName=vlanSystemDomainName)
