...
vlanSystem, vlanAMRRules, vlanAMRSubnets, vlanTestAPI, vlanAMRStats, vlanName, vlanAPI, vlanPort, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanAMRRules", "vlanAMRSubnets", "vlanTestAPI", "vlanAMRStats", "vlanName", "vlanAPI", "vlanPort", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemPollCount=vlanSystemPollCount, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemDomainName=vlanSystemDomainName, vlanNameTable=vlanNameTable, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanCountAPITotal=vlanCountAPITotal, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameNHash=vlanNameNHash, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortPortStatus=vlanPortPortStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, HexInteger=HexInteger, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameEntry=vlanNameEntry, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortVlanName=vlanPortVlanName, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanSystemOperTime=vlanSystemOperTime, vlanSystemEntry=vlanSystemEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortPortPolicy=vlanPortPortPolicy, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, SfpsAddress=SfpsAddress, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameOperStatus=vlanNameOperStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemTable=vlanSystemTable, vlanSystemMibRev=vlanSystemMibRev, vlanNameVlanId=vlanNameVlanId, vlanTestAPIPort=vlanTestAPIPort, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemVersion=vlanSystemVersion, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortTable=vlanPortTable, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameStatusTime=vlanNameStatusTime, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask)
