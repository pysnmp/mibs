...
vlanSystem, vlanAMRRules, vlanPort, vlanCountAPI, vlanTestAPI, vlanName, vlanAPI, vlanAMRSubnets, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanAMRRules", "vlanPort", "vlanCountAPI", "vlanTestAPI", "vlanName", "vlanAPI", "vlanAMRSubnets", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemDomainName=vlanSystemDomainName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameStatusTime=vlanNameStatusTime, vlanNameNumUsers=vlanNameNumUsers, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemMibRev=vlanSystemMibRev, vlanSystemEntry=vlanSystemEntry, vlanNameVlanId=vlanNameVlanId, vlanCountAPITotal=vlanCountAPITotal, vlanNameNHash=vlanNameNHash, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortEntry=vlanPortEntry, VlanSwitchInstance=VlanSwitchInstance, vlanSystemOperTime=vlanSystemOperTime, HexInteger=HexInteger, vlanSystemVersion=vlanSystemVersion, vlanTestAPIPort=vlanTestAPIPort, SfpsSwitchPort=SfpsSwitchPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameEntry=vlanNameEntry, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameTable=vlanNameTable, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemLastPollTime=vlanSystemLastPollTime, SfpsAddress=SfpsAddress, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortVlanName=vlanPortVlanName, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemPollCount=vlanSystemPollCount, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameVlanName=vlanNameVlanName, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemTable=vlanSystemTable, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortVlanId=vlanPortVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortTable=vlanPortTable)
