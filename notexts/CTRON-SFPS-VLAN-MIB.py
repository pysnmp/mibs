...
vlanCountAPI, vlanAMRStats, vlanPort, vlanAMRSubnets, vlanTestAPI, vlanSystem, vlanAPI, vlanAMRRules, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAMRStats", "vlanPort", "vlanAMRSubnets", "vlanTestAPI", "vlanSystem", "vlanAPI", "vlanAMRRules", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameMappedPorts=vlanNameMappedPorts, SfpsAddress=SfpsAddress, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameIndex=vlanNameIndex, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemMibRev=vlanSystemMibRev, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemTable=vlanSystemTable, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIPort=vlanTestAPIPort, vlanPortRouterPort=vlanPortRouterPort, vlanSystemLastChange=vlanSystemLastChange, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemVersion=vlanSystemVersion, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortVlanId=vlanPortVlanId, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortEntry=vlanPortEntry, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortTable=vlanPortTable, vlanPortPortNum=vlanPortPortNum, vlanNameNHash=vlanNameNHash, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIRouterPort=sfpsVAPIRouterPort, HexInteger=HexInteger, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameOperStatus=vlanNameOperStatus, VlanSwitchInstance=VlanSwitchInstance, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemEntry=vlanSystemEntry, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemPriorPollTime=vlanSystemPriorPollTime, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameTable=vlanNameTable, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanNameEntry=vlanNameEntry, vlanNameVlanName=vlanNameVlanName, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameVlanId=vlanNameVlanId, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemPollCount=vlanSystemPollCount, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameVlanRule=vlanNameVlanRule)
