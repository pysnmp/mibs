...
vlanSystem, vlanCountAPI, vlanPort, vlanAMRSubnets, vlanAPI, vlanAMRRules, vlanName, vlanAMRStats, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanCountAPI", "vlanPort", "vlanAMRSubnets", "vlanAPI", "vlanAMRRules", "vlanName", "vlanAMRStats", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameRelayAgent=vlanNameRelayAgent, HexInteger=HexInteger, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameEntry=vlanNameEntry, vlanPortPortNum=vlanPortPortNum, vlanNameNHash=vlanNameNHash, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameIndex=vlanNameIndex, vlanSystemTable=vlanSystemTable, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameVlanRule=vlanNameVlanRule, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanCountAPITotal=vlanCountAPITotal, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIPort=vlanTestAPIPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemEntry=vlanSystemEntry, vlanNameVlanId=vlanNameVlanId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortVlanName=vlanPortVlanName, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortPortStatus=vlanPortPortStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemOperTime=vlanSystemOperTime, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameVlanName=vlanNameVlanName, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemPollCount=vlanSystemPollCount, vlanPortEntry=vlanPortEntry, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, SfpsAddress=SfpsAddress, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortVlanId=vlanPortVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameTable=vlanNameTable, vlanNameNumUsers=vlanNameNumUsers, vlanSystemVersion=vlanSystemVersion, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemLastChange=vlanSystemLastChange, vlanNameOperStatus=vlanNameOperStatus, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortTable=vlanPortTable, sfpsVAPINvramId=sfpsVAPINvramId, SfpsSwitchPort=SfpsSwitchPort)
