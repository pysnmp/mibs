...
vlanCountAPI, vlanAMRSubnets, vlanPort, vlanName, vlanTestAPI, vlanAPI, vlanAMRStats, vlanSystem, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAMRSubnets", "vlanPort", "vlanName", "vlanTestAPI", "vlanAPI", "vlanAMRStats", "vlanSystem", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemDomainName=vlanSystemDomainName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameUniPolicy=vlanNameUniPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameNHash=vlanNameNHash, vlanNameVlanRule=vlanNameVlanRule, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortVlanId=vlanPortVlanId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, HexInteger=HexInteger, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameNumUsers=vlanNameNumUsers, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameTable=vlanNameTable, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameEntry=vlanNameEntry, sfpsVAPIVlanName=sfpsVAPIVlanName, VlanSwitchInstance=VlanSwitchInstance, vlanSystemMibRev=vlanSystemMibRev, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIPort=vlanTestAPIPort, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortTable=vlanPortTable, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemVersion=vlanSystemVersion, vlanNameVlanName=vlanNameVlanName, vlanNameIndex=vlanNameIndex, SfpsAddress=SfpsAddress, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameVlanId=vlanNameVlanId, vlanSystemEntry=vlanSystemEntry, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortPortNum=vlanPortPortNum, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortVlanName=vlanPortVlanName, vlanCountAPITotal=vlanCountAPITotal, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemTable=vlanSystemTable, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRRulesEntry=vlanAMRRulesEntry)
