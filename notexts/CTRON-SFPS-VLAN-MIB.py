...
vlanPort, vlanTestAPI, vlanName, vlanAPI, vlanSystem, vlanAMRSubnets, vlanAMRStats, vlanAMRRules, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanTestAPI", "vlanName", "vlanAPI", "vlanSystem", "vlanAMRSubnets", "vlanAMRStats", "vlanAMRRules", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIVlanName=sfpsVAPIVlanName, HexInteger=HexInteger, vlanAMRRulesTable=vlanAMRRulesTable, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortPortStatus=vlanPortPortStatus, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortTable=vlanPortTable, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemDomainName=vlanSystemDomainName, vlanNameVlanName=vlanNameVlanName, vlanPortVlanName=vlanPortVlanName, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameTable=vlanNameTable, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemVersion=vlanSystemVersion, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortRouterPort=vlanPortRouterPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortVlanId=vlanPortVlanId, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameStatusTime=vlanNameStatusTime, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameOperStatus=vlanNameOperStatus, vlanSystemMibRev=vlanSystemMibRev, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameVlanRule=vlanNameVlanRule, vlanCountAPITotal=vlanCountAPITotal, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortEntry=vlanPortEntry, vlanNameVlanId=vlanNameVlanId, vlanPortPortNum=vlanPortPortNum, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemEntry=vlanSystemEntry, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemAgentIP=vlanSystemAgentIP, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemTable=vlanSystemTable, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameNumUsers=vlanNameNumUsers, SfpsAddress=SfpsAddress)
