...
vlanAMRRules, vlanAMRStats, vlanAMRSubnets, vlanPort, vlanSystem, vlanCountAPI, vlanTestAPI, vlanAPI, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanAMRStats", "vlanAMRSubnets", "vlanPort", "vlanSystem", "vlanCountAPI", "vlanTestAPI", "vlanAPI", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameNumUsers=vlanNameNumUsers, vlanSystemEntry=vlanSystemEntry, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameNHash=vlanNameNHash, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortEntry=vlanPortEntry, vlanSystemTable=vlanSystemTable, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortTable=vlanPortTable, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemLastPollTime=vlanSystemLastPollTime, SfpsSwitchPort=SfpsSwitchPort, vlanPortPortNum=vlanPortPortNum, vlanPortVlanName=vlanPortVlanName, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemVersion=vlanSystemVersion, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameTable=vlanNameTable, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanCountAPITotal=vlanCountAPITotal, vlanPortRouterPort=vlanPortRouterPort, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameUniPolicy=vlanNameUniPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanNameVlanRule=vlanNameVlanRule, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemMibRev=vlanSystemMibRev, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameEntry=vlanNameEntry, vlanSystemPollCount=vlanSystemPollCount, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameStatusTime=vlanNameStatusTime, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameIndex=vlanNameIndex, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameVlanName=vlanNameVlanName, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortVlanId=vlanPortVlanId, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, HexInteger=HexInteger, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIVlanName=vlanTestAPIVlanName, SfpsAddress=SfpsAddress, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemDomainName=vlanSystemDomainName)
