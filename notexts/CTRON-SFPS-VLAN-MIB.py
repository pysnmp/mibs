...
vlanAMRRules, vlanAMRSubnets, vlanTestAPI, vlanAPI, vlanAMRStats, vlanPort, vlanCountAPI, vlanName, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanAMRSubnets", "vlanTestAPI", "vlanAPI", "vlanAMRStats", "vlanPort", "vlanCountAPI", "vlanName", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameStatusTime=vlanNameStatusTime, vlanNameIndex=vlanNameIndex, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameVlanId=vlanNameVlanId, vlanNameVlanName=vlanNameVlanName, vlanPortTable=vlanPortTable, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIPort=vlanTestAPIPort, vlanPortRouterPort=vlanPortRouterPort, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameTable=vlanNameTable, SfpsSwitchPort=SfpsSwitchPort, vlanNameVlanRule=vlanNameVlanRule, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemPriorPollTime=vlanSystemPriorPollTime, HexInteger=HexInteger, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortVlanId=vlanPortVlanId, vlanSystemPollCount=vlanSystemPollCount, vlanCountAPITotal=vlanCountAPITotal, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortEntry=vlanPortEntry, vlanNameNumUsers=vlanNameNumUsers, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemDomainName=vlanSystemDomainName, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemTable=vlanSystemTable, vlanSystemLastChange=vlanSystemLastChange, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, VlanSwitchInstance=VlanSwitchInstance, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemEntry=vlanSystemEntry, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortVlanName=vlanPortVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemAdminReset=vlanSystemAdminReset, SfpsAddress=SfpsAddress, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameNHash=vlanNameNHash, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortPortNum=vlanPortPortNum, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameEntry=vlanNameEntry, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemOperTime=vlanSystemOperTime)
