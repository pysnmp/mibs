...
vlanAMRSubnets, vlanPort, vlanAMRRules, vlanAMRStats, vlanSystem, vlanTestAPI, vlanAPI, vlanCountAPI, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanPort", "vlanAMRRules", "vlanAMRStats", "vlanSystem", "vlanTestAPI", "vlanAPI", "vlanCountAPI", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameVlanRule=vlanNameVlanRule, vlanPortRouterPort=vlanPortRouterPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, HexInteger=HexInteger, vlanNameVlanName=vlanNameVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameIndex=vlanNameIndex, vlanSystemLastChange=vlanSystemLastChange, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameNHash=vlanNameNHash, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemOperTime=vlanSystemOperTime, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameFloodPorts=vlanNameFloodPorts, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortPortNum=vlanPortPortNum, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortVlanName=vlanPortVlanName, vlanPortVlanId=vlanPortVlanId, vlanNameNumUsers=vlanNameNumUsers, vlanNameTable=vlanNameTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemOperStatus=vlanSystemOperStatus, SfpsAddress=SfpsAddress, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameStatusTime=vlanNameStatusTime, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameEntry=vlanNameEntry, vlanSystemVersion=vlanSystemVersion, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameVlanId=vlanNameVlanId, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemEntry=vlanSystemEntry, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortTable=vlanPortTable, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, VlanSwitchInstance=VlanSwitchInstance, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemPollCount=vlanSystemPollCount, vlanPortEntry=vlanPortEntry, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, SfpsSwitchPort=SfpsSwitchPort)
