...
vlanAMRStats, vlanSystem, vlanPort, vlanAMRRules, vlanAPI, vlanCountAPI, vlanAMRSubnets, vlanTestAPI, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanSystem", "vlanPort", "vlanAMRRules", "vlanAPI", "vlanCountAPI", "vlanAMRSubnets", "vlanTestAPI", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortPortNum=vlanPortPortNum, vlanPortEntry=vlanPortEntry, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortVlanName=vlanPortVlanName, vlanSystemPollCount=vlanSystemPollCount, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortPortStatus=vlanPortPortStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameVlanId=vlanNameVlanId, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameNHash=vlanNameNHash, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameTable=vlanNameTable, vlanNameOperStatus=vlanNameOperStatus, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameStatusTime=vlanNameStatusTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemTable=vlanSystemTable, vlanSystemDomainName=vlanSystemDomainName, vlanNameEntry=vlanNameEntry, HexInteger=HexInteger, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortTable=vlanPortTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameIndex=vlanNameIndex, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIPort=vlanTestAPIPort, vlanNameFloodPorts=vlanNameFloodPorts, SfpsAddress=SfpsAddress, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRRulesEntry=vlanAMRRulesEntry, SfpsSwitchPort=SfpsSwitchPort, vlanNameVlanName=vlanNameVlanName, vlanSystemEntry=vlanSystemEntry, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRRulesStatus=vlanAMRRulesStatus, VlanSwitchInstance=VlanSwitchInstance, vlanSystemVersion=vlanSystemVersion, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputPort=vlanTestAPIOutputPort)
