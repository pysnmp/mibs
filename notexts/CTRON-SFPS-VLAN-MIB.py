...
vlanAMRStats, vlanTestAPI, vlanPort, vlanSystem, vlanCountAPI, vlanName, vlanAMRRules, vlanAMRSubnets, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanTestAPI", "vlanPort", "vlanSystem", "vlanCountAPI", "vlanName", "vlanAMRRules", "vlanAMRSubnets", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameVlanRule=vlanNameVlanRule, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameNHash=vlanNameNHash, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemVersion=vlanSystemVersion, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesStatus=vlanAMRRulesStatus, VlanSwitchInstance=VlanSwitchInstance, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanCountAPITotal=vlanCountAPITotal, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameStatusTime=vlanNameStatusTime, vlanSystemLastChange=vlanSystemLastChange, vlanNameVlanName=vlanNameVlanName, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameEntry=vlanNameEntry, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemTable=vlanSystemTable, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemEntry=vlanSystemEntry, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortPortPolicy=vlanPortPortPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameIndex=vlanNameIndex, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortTable=vlanPortTable, vlanPortPortNum=vlanPortPortNum, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIPort=vlanTestAPIPort, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortEntry=vlanPortEntry, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemPollCount=vlanSystemPollCount, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortVlanName=vlanPortVlanName, SfpsAddress=SfpsAddress, vlanNameTable=vlanNameTable, HexInteger=HexInteger, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPINvramId=sfpsVAPINvramId)
