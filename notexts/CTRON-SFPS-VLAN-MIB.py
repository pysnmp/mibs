...
vlanAMRRules, vlanAMRStats, vlanAPI, vlanSystem, vlanPort, vlanName, vlanCountAPI, vlanTestAPI, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanAMRStats", "vlanAPI", "vlanSystem", "vlanPort", "vlanName", "vlanCountAPI", "vlanTestAPI", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemVersion=vlanSystemVersion, vlanPortTable=vlanPortTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemEntry=vlanSystemEntry, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, HexInteger=HexInteger, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameVlanId=vlanNameVlanId, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameEntry=vlanNameEntry, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameNHash=vlanNameNHash, vlanPortEntry=vlanPortEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemMibRev=vlanSystemMibRev, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIPort=vlanTestAPIPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortVlanName=vlanPortVlanName, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortPortStatus=vlanPortPortStatus, vlanSystemDomainName=vlanSystemDomainName, VlanSwitchInstance=VlanSwitchInstance, vlanNameFloodPorts=vlanNameFloodPorts, SfpsAddress=SfpsAddress, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortPortNum=vlanPortPortNum, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemPollCount=vlanSystemPollCount, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, SfpsSwitchPort=SfpsSwitchPort, vlanNameTable=vlanNameTable, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameIndex=vlanNameIndex, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameVlanName=vlanNameVlanName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameNumUsers=vlanNameNumUsers, vlanNameVlanRule=vlanNameVlanRule, vlanSystemOperTime=vlanSystemOperTime, vlanPortVlanId=vlanPortVlanId)
