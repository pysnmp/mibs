...
vlanCountAPI, vlanAMRStats, vlanSystem, vlanPort, vlanAPI, vlanAMRSubnets, vlanName, vlanAMRRules, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAMRStats", "vlanSystem", "vlanPort", "vlanAPI", "vlanAMRSubnets", "vlanName", "vlanAMRRules", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortPortStatus=vlanPortPortStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemTable=vlanSystemTable, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIPort=vlanTestAPIPort, vlanSystemVersion=vlanSystemVersion, vlanSystemAgentIP=vlanSystemAgentIP, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortVlanId=vlanPortVlanId, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameIndex=vlanNameIndex, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanCountAPIAdmin=vlanCountAPIAdmin, HexInteger=HexInteger, SfpsAddress=SfpsAddress, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemDomainName=vlanSystemDomainName, vlanPortTable=vlanPortTable, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanCountAPITotal=vlanCountAPITotal, vlanNameTable=vlanNameTable, vlanNameMappedPorts=vlanNameMappedPorts, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortVlanName=vlanPortVlanName, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameNHash=vlanNameNHash, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameVlanName=vlanNameVlanName, vlanPortEntry=vlanPortEntry, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameVlanRule=vlanNameVlanRule, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemEntry=vlanSystemEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameVlanId=vlanNameVlanId, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortPortNum=vlanPortPortNum, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanPortLayer3Learning=vlanPortLayer3Learning)
