...
vlanAPI, vlanAMRStats, vlanCountAPI, vlanAMRRules, vlanPort, vlanSystem, vlanAMRSubnets, vlanTestAPI, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanAMRStats", "vlanCountAPI", "vlanAMRRules", "vlanPort", "vlanSystem", "vlanAMRSubnets", "vlanTestAPI", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemDomainName=vlanSystemDomainName, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortTable=vlanPortTable, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, HexInteger=HexInteger, vlanSystemMibRev=vlanSystemMibRev, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemPollCount=vlanSystemPollCount, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortPortStatus=vlanPortPortStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortEntry=vlanPortEntry, vlanSystemTable=vlanSystemTable, vlanNameVlanName=vlanNameVlanName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanSystemVersion=vlanSystemVersion, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameTable=vlanNameTable, vlanAMRRulesTable=vlanAMRRulesTable, SfpsAddress=SfpsAddress, vlanPortVlanName=vlanPortVlanName, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortRouterPort=vlanPortRouterPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameVlanId=vlanNameVlanId, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameMappedPorts=vlanNameMappedPorts, vlanCountAPITotal=vlanCountAPITotal, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortVlanId=vlanPortVlanId, vlanNameNumUsers=vlanNameNumUsers, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameEntry=vlanNameEntry, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemOperTime=vlanSystemOperTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameVlanRule=vlanNameVlanRule, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameIndex=vlanNameIndex, vlanSystemEntry=vlanSystemEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortPortNum=vlanPortPortNum, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, VlanSwitchInstance=VlanSwitchInstance, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort)
