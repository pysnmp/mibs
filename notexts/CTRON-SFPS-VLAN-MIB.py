...
vlanSystem, vlanAMRSubnets, vlanTestAPI, vlanAMRRules, vlanName, vlanAPI, vlanPort, vlanCountAPI, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanAMRSubnets", "vlanTestAPI", "vlanAMRRules", "vlanName", "vlanAPI", "vlanPort", "vlanCountAPI", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameEntry=vlanNameEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIVerb=sfpsVAPIVerb, HexInteger=HexInteger, SfpsAddress=SfpsAddress, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortEntry=vlanPortEntry, vlanSystemTable=vlanSystemTable, vlanNameTable=vlanNameTable, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortVlanId=vlanPortVlanId, vlanNameNHash=vlanNameNHash, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemVersion=vlanSystemVersion, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameStatusTime=vlanNameStatusTime, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortTable=vlanPortTable, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, SfpsSwitchPort=SfpsSwitchPort, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameIndex=vlanNameIndex, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameOperStatus=vlanNameOperStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemOperTime=vlanSystemOperTime, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameVlanName=vlanNameVlanName, vlanSystemDomainName=vlanSystemDomainName, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemLastChange=vlanSystemLastChange, vlanNameNumUsers=vlanNameNumUsers, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortVlanName=vlanPortVlanName, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortPortNum=vlanPortPortNum, vlanPortRouterPort=vlanPortRouterPort, vlanSystemEntry=vlanSystemEntry, vlanCountAPITotal=vlanCountAPITotal, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemAdminReset=vlanSystemAdminReset)
