...
vlanTestAPI, vlanName, vlanCountAPI, vlanAMRStats, vlanAMRSubnets, vlanAPI, vlanAMRRules, vlanSystem, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanName", "vlanCountAPI", "vlanAMRStats", "vlanAMRSubnets", "vlanAPI", "vlanAMRRules", "vlanSystem", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemTable=vlanSystemTable, vlanNameStatusTime=vlanNameStatusTime, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameOperStatus=vlanNameOperStatus, SfpsSwitchPort=SfpsSwitchPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameIndex=vlanNameIndex, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortPortNum=vlanPortPortNum, vlanAMRRulesTable=vlanAMRRulesTable, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemDomainName=vlanSystemDomainName, HexInteger=HexInteger, vlanNameNumUsers=vlanNameNumUsers, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortTable=vlanPortTable, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortVlanId=vlanPortVlanId, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameVlanName=vlanNameVlanName, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortPortStatus=vlanPortPortStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortUniPolicy=vlanPortUniPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameNHash=vlanNameNHash, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemPollCount=vlanSystemPollCount, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameVlanId=vlanNameVlanId, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIPort=vlanTestAPIPort, vlanPortVlanName=vlanPortVlanName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, SfpsAddress=SfpsAddress, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemEntry=vlanSystemEntry, vlanNameEntry=vlanNameEntry, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameTable=vlanNameTable, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameRelayAgent=vlanNameRelayAgent)
