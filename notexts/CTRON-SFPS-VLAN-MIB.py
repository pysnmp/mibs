...
vlanAMRStats, vlanAMRRules, vlanPort, vlanCountAPI, vlanAMRSubnets, vlanSystem, vlanName, vlanTestAPI, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanAMRRules", "vlanPort", "vlanCountAPI", "vlanAMRSubnets", "vlanSystem", "vlanName", "vlanTestAPI", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIPort=vlanTestAPIPort, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameEntry=vlanNameEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortPortStatus=vlanPortPortStatus, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortVlanId=vlanPortVlanId, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortEntry=vlanPortEntry, vlanPortTable=vlanPortTable, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortPortPolicy=vlanPortPortPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortVlanName=vlanPortVlanName, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameIndex=vlanNameIndex, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameVlanId=vlanNameVlanId, vlanPortPortNum=vlanPortPortNum, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemVersion=vlanSystemVersion, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemLastChange=vlanSystemLastChange, vlanAMRRulesEntry=vlanAMRRulesEntry, VlanSwitchInstance=VlanSwitchInstance, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemMibRev=vlanSystemMibRev, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, SfpsSwitchPort=SfpsSwitchPort, vlanSystemOperTime=vlanSystemOperTime, vlanNameTable=vlanNameTable, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemPollCount=vlanSystemPollCount, vlanSystemEntry=vlanSystemEntry, vlanNameNumUsers=vlanNameNumUsers, SfpsAddress=SfpsAddress, HexInteger=HexInteger, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIVlanName=sfpsVAPIVlanName)
