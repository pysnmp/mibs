...
vlanAMRStats, vlanAMRRules, vlanSystem, vlanAPI, vlanPort, vlanAMRSubnets, vlanTestAPI, vlanName, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanAMRRules", "vlanSystem", "vlanAPI", "vlanPort", "vlanAMRSubnets", "vlanTestAPI", "vlanName", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemEntry=vlanSystemEntry, vlanNameEntry=vlanNameEntry, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameVlanRule=vlanNameVlanRule, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameIndex=vlanNameIndex, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameUniPolicy=vlanNameUniPolicy, SfpsAddress=SfpsAddress, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortPortStatus=vlanPortPortStatus, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameStatusTime=vlanNameStatusTime, vlanPortTable=vlanPortTable, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortEntry=vlanPortEntry, vlanSystemVersion=vlanSystemVersion, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemDomainName=vlanSystemDomainName, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemMibRev=vlanSystemMibRev, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortPortNum=vlanPortPortNum, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameVlanName=vlanNameVlanName, sfpsVAPIVerb=sfpsVAPIVerb, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameNHash=vlanNameNHash, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputTap=vlanTestAPIOutputTap, SfpsSwitchPort=SfpsSwitchPort, vlanNameNumUsers=vlanNameNumUsers, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, HexInteger=HexInteger, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemOperTime=vlanSystemOperTime, VlanSwitchInstance=VlanSwitchInstance, vlanNameTable=vlanNameTable, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortVlanId=vlanPortVlanId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemLastChange=vlanSystemLastChange, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemTable=vlanSystemTable, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask)
