...
vlanName, vlanCountAPI, vlanAPI, vlanSystem, vlanAMRSubnets, vlanPort, vlanTestAPI, vlanAMRRules, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanCountAPI", "vlanAPI", "vlanSystem", "vlanAMRSubnets", "vlanPort", "vlanTestAPI", "vlanAMRRules", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", HexInteger=HexInteger, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortEntry=vlanPortEntry, vlanSystemTable=vlanSystemTable, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameTable=vlanNameTable, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortVlanName=vlanPortVlanName, vlanSystemPollCount=vlanSystemPollCount, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemVersion=vlanSystemVersion, vlanSystemEntry=vlanSystemEntry, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortVlanId=vlanPortVlanId, vlanNameEntry=vlanNameEntry, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortPortNum=vlanPortPortNum, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameIndex=vlanNameIndex, vlanNameVlanId=vlanNameVlanId, vlanCountAPITotal=vlanCountAPITotal, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortPortStatus=vlanPortPortStatus, vlanNameNHash=vlanNameNHash, vlanTestAPIVerb=vlanTestAPIVerb, VlanSwitchInstance=VlanSwitchInstance, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIPort=vlanTestAPIPort, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameMappedPorts=vlanNameMappedPorts, SfpsAddress=SfpsAddress, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameVlanName=vlanNameVlanName, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortTable=vlanPortTable, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemLastChange=vlanSystemLastChange, vlanPortPortPolicy=vlanPortPortPolicy)
