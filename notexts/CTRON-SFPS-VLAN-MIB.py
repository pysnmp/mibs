...
vlanPort, vlanAPI, vlanName, vlanTestAPI, vlanAMRStats, vlanAMRSubnets, vlanSystem, vlanCountAPI, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAPI", "vlanName", "vlanTestAPI", "vlanAMRStats", "vlanAMRSubnets", "vlanSystem", "vlanCountAPI", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortTable=vlanPortTable, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemOperTime=vlanSystemOperTime, vlanSystemLastChange=vlanSystemLastChange, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanCountAPITotal=vlanCountAPITotal, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemDomainName=vlanSystemDomainName, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIOutPort=sfpsVAPIOutPort, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameVlanId=vlanNameVlanId, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameOperStatus=vlanNameOperStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, HexInteger=HexInteger, vlanNameVlanName=vlanNameVlanName, vlanNameAdminStatus=vlanNameAdminStatus, VlanSwitchInstance=VlanSwitchInstance, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortPortNum=vlanPortPortNum, vlanTestAPIPort=vlanTestAPIPort, vlanPortRouterPort=vlanPortRouterPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortEntry=vlanPortEntry, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemPollCount=vlanSystemPollCount, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameIndex=vlanNameIndex, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, SfpsAddress=SfpsAddress, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameNHash=vlanNameNHash, vlanNameVlanRule=vlanNameVlanRule, vlanSystemVersion=vlanSystemVersion, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameEntry=vlanNameEntry, vlanPortPortStatus=vlanPortPortStatus, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortVlanId=vlanPortVlanId, vlanPortVlanName=vlanPortVlanName, vlanNameNumUsers=vlanNameNumUsers, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameTable=vlanNameTable, vlanSystemEntry=vlanSystemEntry, vlanNameStatusTime=vlanNameStatusTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask)
