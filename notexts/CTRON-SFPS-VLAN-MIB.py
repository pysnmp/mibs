...
vlanAMRRules, vlanCountAPI, vlanTestAPI, vlanName, vlanAMRStats, vlanPort, vlanAPI, vlanSystem, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanCountAPI", "vlanTestAPI", "vlanName", "vlanAMRStats", "vlanPort", "vlanAPI", "vlanSystem", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameVlanName=vlanNameVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPINvramId=sfpsVAPINvramId, HexInteger=HexInteger, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortRouterPort=vlanPortRouterPort, vlanSystemEntry=vlanSystemEntry, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemPollCount=vlanSystemPollCount, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameEntry=vlanNameEntry, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortVlanId=vlanPortVlanId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanPortEntry=vlanPortEntry, SfpsAddress=SfpsAddress, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIPort=vlanTestAPIPort, vlanSystemVersion=vlanSystemVersion, vlanNameNumUsers=vlanNameNumUsers, vlanSystemAdminReset=vlanSystemAdminReset, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemAgentIP=vlanSystemAgentIP, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanCountAPITotal=vlanCountAPITotal, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameVlanId=vlanNameVlanId, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemLastChange=vlanSystemLastChange, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortPortStatus=vlanPortPortStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameNHash=vlanNameNHash, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameIndex=vlanNameIndex, vlanNameOperStatus=vlanNameOperStatus, VlanSwitchInstance=VlanSwitchInstance, vlanNameTable=vlanNameTable, vlanPortPortNum=vlanPortPortNum, vlanPortTable=vlanPortTable, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemOperTime=vlanSystemOperTime, vlanSystemTable=vlanSystemTable)
