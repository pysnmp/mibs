...
vlanAMRStats, vlanTestAPI, vlanCountAPI, vlanAPI, vlanName, vlanAMRSubnets, vlanAMRRules, vlanSystem, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanTestAPI", "vlanCountAPI", "vlanAPI", "vlanName", "vlanAMRSubnets", "vlanAMRRules", "vlanSystem", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortPortNum=vlanPortPortNum, vlanNameNumUsers=vlanNameNumUsers, SfpsSwitchPort=SfpsSwitchPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameNHash=vlanNameNHash, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortTable=vlanPortTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameIndex=vlanNameIndex, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortEntry=vlanPortEntry, vlanSystemPollCount=vlanSystemPollCount, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemTable=vlanSystemTable, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameVlanName=vlanNameVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameTable=vlanNameTable, vlanPortRelayAgent=vlanPortRelayAgent, vlanCountAPITotal=vlanCountAPITotal, vlanSystemEntry=vlanSystemEntry, SfpsAddress=SfpsAddress, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPINvramId=sfpsVAPINvramId, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortRouterPort=vlanPortRouterPort, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, HexInteger=HexInteger, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemDomainName=vlanSystemDomainName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanSystemMibRev=vlanSystemMibRev, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortVlanId=vlanPortVlanId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemVersion=vlanSystemVersion, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameOperStatus=vlanNameOperStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIPort=vlanTestAPIPort)
