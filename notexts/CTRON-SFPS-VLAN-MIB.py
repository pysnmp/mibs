...
vlanAMRStats, vlanAMRSubnets, vlanName, vlanPort, vlanAMRRules, vlanTestAPI, vlanSystem, vlanCountAPI, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanAMRSubnets", "vlanName", "vlanPort", "vlanAMRRules", "vlanTestAPI", "vlanSystem", "vlanCountAPI", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemLastChange=vlanSystemLastChange, vlanPortPortNum=vlanPortPortNum, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanCountAPITotal=vlanCountAPITotal, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameIndex=vlanNameIndex, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameTable=vlanNameTable, vlanNameVlanId=vlanNameVlanId, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortVlanName=vlanPortVlanName, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemMibRev=vlanSystemMibRev, vlanNameVlanRule=vlanNameVlanRule, vlanSystemOperStatus=vlanSystemOperStatus, VlanSwitchInstance=VlanSwitchInstance, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameOperStatus=vlanNameOperStatus, vlanNameNumUsers=vlanNameNumUsers, vlanPortPortStatus=vlanPortPortStatus, vlanNameEntry=vlanNameEntry, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortEntry=vlanPortEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, SfpsAddress=SfpsAddress, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemVersion=vlanSystemVersion, HexInteger=HexInteger, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemEntry=vlanSystemEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortTable=vlanPortTable, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameStatusTime=vlanNameStatusTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemTable=vlanSystemTable, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameNHash=vlanNameNHash)
