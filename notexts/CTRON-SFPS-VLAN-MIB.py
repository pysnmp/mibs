...
vlanSystem, vlanAMRStats, vlanName, vlanTestAPI, vlanCountAPI, vlanAMRRules, vlanPort, vlanAMRSubnets, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanAMRStats", "vlanName", "vlanTestAPI", "vlanCountAPI", "vlanAMRRules", "vlanPort", "vlanAMRSubnets", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameEntry=vlanNameEntry, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortRouterPort=vlanPortRouterPort, vlanNameVlanRule=vlanNameVlanRule, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRRulesRule=vlanAMRRulesRule, VlanSwitchInstance=VlanSwitchInstance, vlanNameNHash=vlanNameNHash, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortVlanId=vlanPortVlanId, vlanCountAPITotal=vlanCountAPITotal, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameVlanName=vlanNameVlanName, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemTable=vlanSystemTable, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemVersion=vlanSystemVersion, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIRouterPort=sfpsVAPIRouterPort, SfpsAddress=SfpsAddress, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortEntry=vlanPortEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemDomainName=vlanSystemDomainName, vlanSystemEntry=vlanSystemEntry, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIVerb=vlanTestAPIVerb, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameIndex=vlanNameIndex, vlanSystemMibRev=vlanSystemMibRev, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortPortNum=vlanPortPortNum, HexInteger=HexInteger, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemLastChange=vlanSystemLastChange, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortPortStatus=vlanPortPortStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameTable=vlanNameTable, vlanPortTable=vlanPortTable, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortLayer3Learning=vlanPortLayer3Learning)
