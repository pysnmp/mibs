...
vlanPort, vlanTestAPI, vlanAMRSubnets, vlanName, vlanCountAPI, vlanAPI, vlanAMRStats, vlanAMRRules, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanTestAPI", "vlanAMRSubnets", "vlanName", "vlanCountAPI", "vlanAPI", "vlanAMRStats", "vlanAMRRules", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortPortPolicy=vlanPortPortPolicy, vlanNameTable=vlanNameTable, vlanNameVlanName=vlanNameVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanCountAPITotal=vlanCountAPITotal, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemPollCount=vlanSystemPollCount, vlanNameVlanRule=vlanNameVlanRule, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameStatusTime=vlanNameStatusTime, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIPort=vlanTestAPIPort, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemEntry=vlanSystemEntry, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, SfpsSwitchPort=SfpsSwitchPort, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemLastChange=vlanSystemLastChange, vlanNameMappedPorts=vlanNameMappedPorts, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameVlanId=vlanNameVlanId, vlanPortEntry=vlanPortEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameIndex=vlanNameIndex, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemVersion=vlanSystemVersion, vlanPortVlanName=vlanPortVlanName, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameEntry=vlanNameEntry, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemDomainName=vlanSystemDomainName, vlanPortVlanId=vlanPortVlanId, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortUniPolicy=vlanPortUniPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameRelayAgent=vlanNameRelayAgent, HexInteger=HexInteger, vlanAMRRulesStatus=vlanAMRRulesStatus, SfpsAddress=SfpsAddress, vlanNameOperStatus=vlanNameOperStatus, vlanSystemTable=vlanSystemTable, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortTable=vlanPortTable, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIVlanName=vlanTestAPIVlanName)
