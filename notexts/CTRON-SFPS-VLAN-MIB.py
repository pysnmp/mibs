...
vlanPort, vlanAMRRules, vlanTestAPI, vlanAMRStats, vlanAPI, vlanAMRSubnets, vlanCountAPI, vlanName, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAMRRules", "vlanTestAPI", "vlanAMRStats", "vlanAPI", "vlanAMRSubnets", "vlanCountAPI", "vlanName", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemOperTime=vlanSystemOperTime, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemVersion=vlanSystemVersion, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortVlanId=vlanPortVlanId, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameVlanName=vlanNameVlanName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemDomainName=vlanSystemDomainName, vlanPortTable=vlanPortTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortEntry=vlanPortEntry, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, HexInteger=HexInteger, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameEntry=vlanNameEntry, vlanPortVlanName=vlanPortVlanName, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputTable=vlanTestAPIOutputTable, SfpsAddress=SfpsAddress, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameIndex=vlanNameIndex, sfpsVAPIOutPort=sfpsVAPIOutPort, SfpsSwitchPort=SfpsSwitchPort, vlanSystemMibRev=vlanSystemMibRev, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIPort=vlanTestAPIPort, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanCountAPITotal=vlanCountAPITotal, vlanNameStatusTime=vlanNameStatusTime, vlanSystemLastChange=vlanSystemLastChange, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameTable=vlanNameTable, vlanNameNumUsers=vlanNameNumUsers, vlanNameVlanId=vlanNameVlanId, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemEntry=vlanSystemEntry, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance)
