...
vlanAPI, vlanSystem, vlanPort, vlanAMRStats, vlanAMRSubnets, vlanTestAPI, vlanCountAPI, vlanAMRRules, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanSystem", "vlanPort", "vlanAMRStats", "vlanAMRSubnets", "vlanTestAPI", "vlanCountAPI", "vlanAMRRules", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameNHash=vlanNameNHash, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameNumUsers=vlanNameNumUsers, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortPortNum=vlanPortPortNum, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortEntry=vlanPortEntry, vlanAMRRulesEntry=vlanAMRRulesEntry, VlanSwitchInstance=VlanSwitchInstance, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemDomainName=vlanSystemDomainName, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameIndex=vlanNameIndex, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameVlanId=vlanNameVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameVlanName=vlanNameVlanName, SfpsAddress=SfpsAddress, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameTable=vlanNameTable, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameVlanRule=vlanNameVlanRule, vlanNameStatusTime=vlanNameStatusTime, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortTable=vlanPortTable, vlanPortVlanId=vlanPortVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, HexInteger=HexInteger, vlanSystemPollCount=vlanSystemPollCount, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortVlanName=vlanPortVlanName, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemVersion=vlanSystemVersion, vlanPortPortStatus=vlanPortPortStatus, vlanSystemTable=vlanSystemTable, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameEnabledPorts=vlanNameEnabledPorts)
