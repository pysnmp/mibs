...
vlanAMRStats, vlanSystem, vlanAMRSubnets, vlanTestAPI, vlanName, vlanAMRRules, vlanPort, vlanAPI, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanSystem", "vlanAMRSubnets", "vlanTestAPI", "vlanName", "vlanAMRRules", "vlanPort", "vlanAPI", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemMibRev=vlanSystemMibRev, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortEntry=vlanPortEntry, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameNHash=vlanNameNHash, vlanNameEntry=vlanNameEntry, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortAdminStatus=vlanPortAdminStatus, VlanSwitchInstance=VlanSwitchInstance, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameVlanRule=vlanNameVlanRule, vlanSystemEntry=vlanSystemEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortVlanName=vlanPortVlanName, vlanNameRelayAgent=vlanNameRelayAgent, HexInteger=HexInteger, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortTable=vlanPortTable, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameIndex=vlanNameIndex, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIPort=vlanTestAPIPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameVlanName=vlanNameVlanName, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortUniPolicy=vlanPortUniPolicy, SfpsAddress=SfpsAddress, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameOperStatus=vlanNameOperStatus, vlanNameTable=vlanNameTable, vlanSystemVersion=vlanSystemVersion, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameNumUsers=vlanNameNumUsers, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanPortVlanId=vlanPortVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemPollCount=vlanSystemPollCount, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIVerb=sfpsVAPIVerb, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPINvramId=sfpsVAPINvramId, vlanCountAPITotal=vlanCountAPITotal, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemAdminReset=vlanSystemAdminReset)
