...
vlanName, vlanPort, vlanTestAPI, vlanAPI, vlanAMRSubnets, vlanCountAPI, vlanSystem, vlanAMRStats, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanPort", "vlanTestAPI", "vlanAPI", "vlanAMRSubnets", "vlanCountAPI", "vlanSystem", "vlanAMRStats", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemPollCount=vlanSystemPollCount, vlanPortTable=vlanPortTable, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortEntry=vlanPortEntry, vlanTestAPIPort=vlanTestAPIPort, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortRouterPort=vlanPortRouterPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameTable=vlanNameTable, vlanSystemEntry=vlanSystemEntry, vlanNameVlanRule=vlanNameVlanRule, HexInteger=HexInteger, vlanNameVlanName=vlanNameVlanName, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemOperTime=vlanSystemOperTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameVlanId=vlanNameVlanId, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemDomainName=vlanSystemDomainName, vlanNameIndex=vlanNameIndex, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIOutPort=sfpsVAPIOutPort, VlanSwitchInstance=VlanSwitchInstance, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemLastChange=vlanSystemLastChange, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameNHash=vlanNameNHash, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, SfpsAddress=SfpsAddress, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemTable=vlanSystemTable, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortPortNum=vlanPortPortNum, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanNameStatusTime=vlanNameStatusTime, vlanPortVlanId=vlanPortVlanId, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameEntry=vlanNameEntry, vlanPortVlanName=vlanPortVlanName, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameUniPolicy=vlanNameUniPolicy)
