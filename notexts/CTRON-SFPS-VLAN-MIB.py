...
vlanAPI, vlanCountAPI, vlanAMRSubnets, vlanSystem, vlanName, vlanAMRStats, vlanAMRRules, vlanTestAPI, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanCountAPI", "vlanAMRSubnets", "vlanSystem", "vlanName", "vlanAMRStats", "vlanAMRRules", "vlanTestAPI", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortPortStatus=vlanPortPortStatus, vlanPortRouterPort=vlanPortRouterPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortEntry=vlanPortEntry, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameVlanId=vlanNameVlanId, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortVlanName=vlanPortVlanName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameTable=vlanNameTable, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanCountAPITotal=vlanCountAPITotal, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortVlanId=vlanPortVlanId, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameVlanName=vlanNameVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemMibRev=vlanSystemMibRev, vlanSystemVersion=vlanSystemVersion, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortTable=vlanPortTable, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameEntry=vlanNameEntry, vlanNameOperStatus=vlanNameOperStatus, SfpsAddress=SfpsAddress, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameUniPolicy=vlanNameUniPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameNHash=vlanNameNHash, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameNumUsers=vlanNameNumUsers, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanNameVlanRule=vlanNameVlanRule, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameStatusTime=vlanNameStatusTime, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameIndex=vlanNameIndex, vlanSystemEntry=vlanSystemEntry, HexInteger=HexInteger, VlanSwitchInstance=VlanSwitchInstance, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemTable=vlanSystemTable, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemPollCount=vlanSystemPollCount, vlanSystemLastChange=vlanSystemLastChange, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap)
