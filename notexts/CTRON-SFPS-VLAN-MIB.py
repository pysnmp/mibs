...
vlanAPI, vlanAMRSubnets, vlanAMRStats, vlanPort, vlanCountAPI, vlanName, vlanAMRRules, vlanTestAPI, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanAMRSubnets", "vlanAMRStats", "vlanPort", "vlanCountAPI", "vlanName", "vlanAMRRules", "vlanTestAPI", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameEntry=vlanNameEntry, vlanTestAPIVlanName=vlanTestAPIVlanName, SfpsAddress=SfpsAddress, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortPortStatus=vlanPortPortStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortEntry=vlanPortEntry, vlanNameStatusTime=vlanNameStatusTime, vlanSystemVersion=vlanSystemVersion, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIPort=vlanTestAPIPort, vlanNameVlanId=vlanNameVlanId, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameNumUsers=vlanNameNumUsers, vlanSystemEntry=vlanSystemEntry, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRRulesTable=vlanAMRRulesTable, vlanCountAPITotal=vlanCountAPITotal, vlanNameVlanRule=vlanNameVlanRule, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameNHash=vlanNameNHash, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemOperTime=vlanSystemOperTime, vlanPortRelayAgent=vlanPortRelayAgent, HexInteger=HexInteger, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameIndex=vlanNameIndex, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanPortTable=vlanPortTable, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameTable=vlanNameTable, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortVlanName=vlanPortVlanName, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameVlanName=vlanNameVlanName, vlanSystemTable=vlanSystemTable, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortVlanId=vlanPortVlanId, SfpsSwitchPort=SfpsSwitchPort, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameEnabledPorts=vlanNameEnabledPorts)
