...
vlanName, vlanCountAPI, vlanAMRSubnets, vlanAMRRules, vlanAMRStats, vlanPort, vlanSystem, vlanAPI, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanCountAPI", "vlanAMRSubnets", "vlanAMRRules", "vlanAMRStats", "vlanPort", "vlanSystem", "vlanAPI", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemEntry=vlanSystemEntry, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, VlanSwitchInstance=VlanSwitchInstance, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortPortNum=vlanPortPortNum, vlanSystemAgentIP=vlanSystemAgentIP, SfpsAddress=SfpsAddress, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortVlanName=vlanPortVlanName, vlanSystemLastChange=vlanSystemLastChange, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIPort=vlanTestAPIPort, vlanSystemOperStatus=vlanSystemOperStatus, vlanCountAPITotal=vlanCountAPITotal, vlanSystemVersion=vlanSystemVersion, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortTable=vlanPortTable, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameOperStatus=vlanNameOperStatus, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemTable=vlanSystemTable, vlanCountAPIAdmin=vlanCountAPIAdmin, SfpsSwitchPort=SfpsSwitchPort, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameStatusTime=vlanNameStatusTime, vlanPortEntry=vlanPortEntry, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemOperTime=vlanSystemOperTime, HexInteger=HexInteger, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortVlanId=vlanPortVlanId, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameNHash=vlanNameNHash, vlanNameTable=vlanNameTable, vlanNameVlanId=vlanNameVlanId, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameIndex=vlanNameIndex, vlanPortPortStatus=vlanPortPortStatus, vlanNameEntry=vlanNameEntry, vlanNameNumUsers=vlanNameNumUsers, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameVlanRule=vlanNameVlanRule, vlanPortUniPolicy=vlanPortUniPolicy)
