...
vlanAPI, vlanPort, vlanTestAPI, vlanAMRRules, vlanName, vlanSystem, vlanAMRSubnets, vlanAMRStats, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanPort", "vlanTestAPI", "vlanAMRRules", "vlanName", "vlanSystem", "vlanAMRSubnets", "vlanAMRStats", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemVersion=vlanSystemVersion, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameVlanName=vlanNameVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanPortPortNum=vlanPortPortNum, vlanPortEntry=vlanPortEntry, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameEntry=vlanNameEntry, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameNumUsers=vlanNameNumUsers, vlanSystemTable=vlanSystemTable, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameNHash=vlanNameNHash, vlanNameOperStatus=vlanNameOperStatus, SfpsAddress=SfpsAddress, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, HexInteger=HexInteger, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortTable=vlanPortTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortPortStatus=vlanPortPortStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemDomainName=vlanSystemDomainName, vlanPortVlanName=vlanPortVlanName, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameVlanId=vlanNameVlanId, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemPollCount=vlanSystemPollCount, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortVlanId=vlanPortVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameVlanRule=vlanNameVlanRule, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameTable=vlanNameTable, vlanPortRouterPort=vlanPortRouterPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemMibRev=vlanSystemMibRev, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameIndex=vlanNameIndex, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemLastChange=vlanSystemLastChange, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRRulesStatus=vlanAMRRulesStatus, VlanSwitchInstance=VlanSwitchInstance, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemEntry=vlanSystemEntry)
