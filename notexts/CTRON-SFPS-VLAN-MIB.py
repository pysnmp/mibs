...
vlanName, vlanCountAPI, vlanAMRSubnets, vlanAMRStats, vlanTestAPI, vlanAMRRules, vlanPort, vlanSystem, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanCountAPI", "vlanAMRSubnets", "vlanAMRStats", "vlanTestAPI", "vlanAMRRules", "vlanPort", "vlanSystem", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanCountAPITotal=vlanCountAPITotal, vlanNameVlanId=vlanNameVlanId, vlanNameNumUsers=vlanNameNumUsers, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortUniPolicy=vlanPortUniPolicy, SfpsAddress=SfpsAddress, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortEntry=vlanPortEntry, vlanSystemDomainName=vlanSystemDomainName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemTable=vlanSystemTable, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortPortNum=vlanPortPortNum, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameVlanName=vlanNameVlanName, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemEntry=vlanSystemEntry, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortTable=vlanPortTable, vlanNameTable=vlanNameTable, vlanNameVlanRule=vlanNameVlanRule, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanNameStatusTime=vlanNameStatusTime, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortRouterPort=vlanPortRouterPort, SfpsSwitchPort=SfpsSwitchPort, vlanNameNHash=vlanNameNHash, HexInteger=HexInteger, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemMibRev=vlanSystemMibRev, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortVlanName=vlanPortVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortVlanId=vlanPortVlanId, vlanSystemOperTime=vlanSystemOperTime, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameIndex=vlanNameIndex, vlanSystemPriorPollTime=vlanSystemPriorPollTime, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameEntry=vlanNameEntry)
