...
vlanName, vlanAMRSubnets, vlanAMRStats, vlanPort, vlanTestAPI, vlanAPI, vlanSystem, vlanCountAPI, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanAMRSubnets", "vlanAMRStats", "vlanPort", "vlanTestAPI", "vlanAPI", "vlanSystem", "vlanCountAPI", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIVlanId=sfpsVAPIVlanId, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemTable=vlanSystemTable, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameStatusTime=vlanNameStatusTime, vlanSystemDomainName=vlanSystemDomainName, SfpsSwitchPort=SfpsSwitchPort, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameNumUsers=vlanNameNumUsers, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemMibRev=vlanSystemMibRev, vlanPortTable=vlanPortTable, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIPort=vlanTestAPIPort, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortVlanName=vlanPortVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameVlanId=vlanNameVlanId, vlanPortVlanId=vlanPortVlanId, vlanNameNHash=vlanNameNHash, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameIndex=vlanNameIndex, vlanNameMappedPorts=vlanNameMappedPorts, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortEntry=vlanPortEntry, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortPortStatus=vlanPortPortStatus, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemOperTime=vlanSystemOperTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemVersion=vlanSystemVersion, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortPortNum=vlanPortPortNum, SfpsAddress=SfpsAddress, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputTable=vlanTestAPIOutputTable, HexInteger=HexInteger, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemEntry=vlanSystemEntry, vlanNameTable=vlanNameTable, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy)
