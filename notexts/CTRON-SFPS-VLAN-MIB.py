...
vlanName, vlanTestAPI, vlanAMRSubnets, vlanCountAPI, vlanSystem, vlanAMRRules, vlanAPI, vlanPort, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanTestAPI", "vlanAMRSubnets", "vlanCountAPI", "vlanSystem", "vlanAMRRules", "vlanAPI", "vlanPort", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemPollCount=vlanSystemPollCount, vlanSystemMibRev=vlanSystemMibRev, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameEntry=vlanNameEntry, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, SfpsAddress=SfpsAddress, vlanSystemEntry=vlanSystemEntry, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortTable=vlanPortTable, vlanPortPortNum=vlanPortPortNum, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameIndex=vlanNameIndex, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemVersion=vlanSystemVersion, vlanNameUniPolicy=vlanNameUniPolicy, HexInteger=HexInteger, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemOperTime=vlanSystemOperTime, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanCountAPITotal=vlanCountAPITotal, vlanPortVlanId=vlanPortVlanId, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameVlanRule=vlanNameVlanRule, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortVlanName=vlanPortVlanName, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIPort=vlanTestAPIPort, vlanSystemTable=vlanSystemTable, vlanNameTable=vlanNameTable, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortRouterPort=vlanPortRouterPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, SfpsSwitchPort=SfpsSwitchPort, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameVlanName=vlanNameVlanName, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortEntry=vlanPortEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPINvramId=sfpsVAPINvramId)
