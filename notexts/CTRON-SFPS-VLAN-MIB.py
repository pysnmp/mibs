...
vlanSystem, vlanAMRStats, vlanAMRSubnets, vlanTestAPI, vlanAMRRules, vlanName, vlanAPI, vlanCountAPI, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanAMRStats", "vlanAMRSubnets", "vlanTestAPI", "vlanAMRRules", "vlanName", "vlanAPI", "vlanCountAPI", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameNHash=vlanNameNHash, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemLastChange=vlanSystemLastChange, vlanNameFloodPorts=vlanNameFloodPorts, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemVersion=vlanSystemVersion, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanNameOperStatus=vlanNameOperStatus, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, HexInteger=HexInteger, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemPollCount=vlanSystemPollCount, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortPortNum=vlanPortPortNum, vlanSystemOperTime=vlanSystemOperTime, vlanPortPortStatus=vlanPortPortStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameVlanName=vlanNameVlanName, vlanNameVlanId=vlanNameVlanId, vlanPortVlanName=vlanPortVlanName, vlanNameTable=vlanNameTable, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanCountAPITotal=vlanCountAPITotal, vlanSystemTable=vlanSystemTable, vlanSystemMibRev=vlanSystemMibRev, vlanSystemEntry=vlanSystemEntry, vlanSystemDomainName=vlanSystemDomainName, vlanPortEntry=vlanPortEntry, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameIndex=vlanNameIndex, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, SfpsAddress=SfpsAddress, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortTable=vlanPortTable, vlanNameEntry=vlanNameEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning)
