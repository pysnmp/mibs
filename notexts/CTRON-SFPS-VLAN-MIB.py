...
vlanAMRStats, vlanSystem, vlanAPI, vlanTestAPI, vlanCountAPI, vlanAMRRules, vlanPort, vlanName, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanSystem", "vlanAPI", "vlanTestAPI", "vlanCountAPI", "vlanAMRRules", "vlanPort", "vlanName", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameVlanId=vlanNameVlanId, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortVlanName=vlanPortVlanName, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortEntry=vlanPortEntry, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemEntry=vlanSystemEntry, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemVersion=vlanSystemVersion, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortTable=vlanPortTable, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, SfpsAddress=SfpsAddress, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameVlanRule=vlanNameVlanRule, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIPort=vlanTestAPIPort, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameIndex=vlanNameIndex, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortAdminStatus=vlanPortAdminStatus, HexInteger=HexInteger, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameTable=vlanNameTable, SfpsSwitchPort=SfpsSwitchPort, vlanSystemTable=vlanSystemTable, vlanPortPortNum=vlanPortPortNum, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameNumUsers=vlanNameNumUsers, vlanSystemMibRev=vlanSystemMibRev, vlanNameVlanName=vlanNameVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortRouterPort=vlanPortRouterPort, vlanSystemDomainName=vlanSystemDomainName, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanCountAPITotal=vlanCountAPITotal, vlanNameStatusTime=vlanNameStatusTime, vlanNameRelayAgent=vlanNameRelayAgent)
