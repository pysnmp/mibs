...
vlanCountAPI, vlanAMRRules, vlanAMRSubnets, vlanTestAPI, vlanPort, vlanName, vlanAMRStats, vlanSystem, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAMRRules", "vlanAMRSubnets", "vlanTestAPI", "vlanPort", "vlanName", "vlanAMRStats", "vlanSystem", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortVlanName=vlanPortVlanName, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemOperTime=vlanSystemOperTime, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, HexInteger=HexInteger, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemEntry=vlanSystemEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemPollCount=vlanSystemPollCount, vlanNameEntry=vlanNameEntry, vlanCountAPITotal=vlanCountAPITotal, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameNHash=vlanNameNHash, SfpsAddress=SfpsAddress, vlanNameVlanId=vlanNameVlanId, vlanSystemTable=vlanSystemTable, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIPort=vlanTestAPIPort, vlanPortPortNum=vlanPortPortNum, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemMibRev=vlanSystemMibRev, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortEntry=vlanPortEntry, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameVlanName=vlanNameVlanName, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameIndex=vlanNameIndex, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameOperStatus=vlanNameOperStatus, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemDomainName=vlanSystemDomainName, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameTable=vlanNameTable, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortVlanId=vlanPortVlanId, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemVersion=vlanSystemVersion, vlanPortTable=vlanPortTable)
