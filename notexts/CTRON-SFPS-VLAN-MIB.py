...
vlanCountAPI, vlanAPI, vlanAMRSubnets, vlanPort, vlanAMRRules, vlanTestAPI, vlanAMRStats, vlanSystem, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAPI", "vlanAMRSubnets", "vlanPort", "vlanAMRRules", "vlanTestAPI", "vlanAMRStats", "vlanSystem", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortLayer3Learning=vlanPortLayer3Learning, VlanSwitchInstance=VlanSwitchInstance, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameNHash=vlanNameNHash, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortVlanId=vlanPortVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameEntry=vlanNameEntry, vlanSystemOperTime=vlanSystemOperTime, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameVlanId=vlanNameVlanId, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemVersion=vlanSystemVersion, SfpsAddress=SfpsAddress, vlanSystemEntry=vlanSystemEntry, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameStatusTime=vlanNameStatusTime, vlanSystemDomainName=vlanSystemDomainName, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortVlanName=vlanPortVlanName, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIPort=vlanTestAPIPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameNumUsers=vlanNameNumUsers, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortPortStatus=vlanPortPortStatus, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameIndex=vlanNameIndex, vlanPortPortNum=vlanPortPortNum, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, HexInteger=HexInteger, vlanPortEntry=vlanPortEntry, vlanSystemLastChange=vlanSystemLastChange, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameTable=vlanNameTable, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameOperStatus=vlanNameOperStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortTable=vlanPortTable, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameVlanRule=vlanNameVlanRule)
