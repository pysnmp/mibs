...
vlanAMRRules, vlanSystem, vlanName, vlanAPI, vlanAMRStats, vlanPort, vlanTestAPI, vlanCountAPI, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanSystem", "vlanName", "vlanAPI", "vlanAMRStats", "vlanPort", "vlanTestAPI", "vlanCountAPI", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameVlanName=vlanNameVlanName, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortTable=vlanPortTable, HexInteger=HexInteger, vlanSystemEntry=vlanSystemEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameEntry=vlanNameEntry, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemDomainName=vlanSystemDomainName, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameOperStatus=vlanNameOperStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanCountAPITotal=vlanCountAPITotal, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortPortNum=vlanPortPortNum, vlanPortFloodPolicy=vlanPortFloodPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameVlanId=vlanNameVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameTable=vlanNameTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameNumUsers=vlanNameNumUsers, vlanNameIndex=vlanNameIndex, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameStatusTime=vlanNameStatusTime, vlanSystemOperTime=vlanSystemOperTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortVlanId=vlanPortVlanId, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemVersion=vlanSystemVersion, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortVlanName=vlanPortVlanName, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortEntry=vlanPortEntry, SfpsAddress=SfpsAddress, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameNHash=vlanNameNHash, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIInPort=sfpsVAPIInPort, SfpsSwitchPort=SfpsSwitchPort, vlanAMRRulesTable=vlanAMRRulesTable)
