...
vlanAMRSubnets, vlanAMRStats, vlanAMRRules, vlanSystem, vlanTestAPI, vlanPort, vlanAPI, vlanCountAPI, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanAMRStats", "vlanAMRRules", "vlanSystem", "vlanTestAPI", "vlanPort", "vlanAPI", "vlanCountAPI", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemEntry=vlanSystemEntry, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameIndex=vlanNameIndex, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortVlanName=vlanPortVlanName, vlanPortPortStatus=vlanPortPortStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemDomainName=vlanSystemDomainName, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameNHash=vlanNameNHash, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortPortNum=vlanPortPortNum, vlanPortTable=vlanPortTable, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemAgentIP=vlanSystemAgentIP, HexInteger=HexInteger, vlanPortEntry=vlanPortEntry, vlanNameVlanId=vlanNameVlanId, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIPort=vlanTestAPIPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, SfpsAddress=SfpsAddress, VlanSwitchInstance=VlanSwitchInstance, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameNumUsers=vlanNameNumUsers, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemVersion=vlanSystemVersion, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortVlanId=vlanPortVlanId, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameTable=vlanNameTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemLastChange=vlanSystemLastChange, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameVlanRule=vlanNameVlanRule, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemTable=vlanSystemTable, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemOperStatus=vlanSystemOperStatus)
