...
vlanTestAPI, vlanAMRRules, vlanAPI, vlanName, vlanSystem, vlanCountAPI, vlanAMRStats, vlanPort, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanAMRRules", "vlanAPI", "vlanName", "vlanSystem", "vlanCountAPI", "vlanAMRStats", "vlanPort", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, HexInteger=HexInteger, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortPortNum=vlanPortPortNum, vlanCountAPITotal=vlanCountAPITotal, vlanSystemVersion=vlanSystemVersion, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameVlanRule=vlanNameVlanRule, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameTable=vlanNameTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameEntry=vlanNameEntry, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemLastChange=vlanSystemLastChange, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemEntry=vlanSystemEntry, vlanNameIndex=vlanNameIndex, vlanPortRouterPort=vlanPortRouterPort, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortVlanName=vlanPortVlanName, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemPollCount=vlanSystemPollCount, vlanPortVlanId=vlanPortVlanId, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemTable=vlanSystemTable, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameOperStatus=vlanNameOperStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, SfpsAddress=SfpsAddress, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortEntry=vlanPortEntry, vlanTestAPIPort=vlanTestAPIPort, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameVlanName=vlanNameVlanName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortTable=vlanPortTable, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIVlanId=vlanTestAPIVlanId, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameNHash=vlanNameNHash, sfpsVAPIUserMAC=sfpsVAPIUserMAC)
