...
vlanName, vlanPort, vlanAMRSubnets, vlanAMRStats, vlanAPI, vlanAMRRules, vlanTestAPI, vlanCountAPI, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanPort", "vlanAMRSubnets", "vlanAMRStats", "vlanAPI", "vlanAMRRules", "vlanTestAPI", "vlanCountAPI", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameNumUsers=vlanNameNumUsers, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemEntry=vlanSystemEntry, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemOperTime=vlanSystemOperTime, vlanNameVlanName=vlanNameVlanName, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortPortNum=vlanPortPortNum, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanSystemLastChange=vlanSystemLastChange, vlanSystemAdminStatus=vlanSystemAdminStatus, VlanSwitchInstance=VlanSwitchInstance, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemTable=vlanSystemTable, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameTable=vlanNameTable, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortPortStatus=vlanPortPortStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemVersion=vlanSystemVersion, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputMap=vlanTestAPIOutputMap, SfpsAddress=SfpsAddress, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, HexInteger=HexInteger, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortPortPolicy=vlanPortPortPolicy, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIVerb=vlanTestAPIVerb, SfpsSwitchPort=SfpsSwitchPort, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortEntry=vlanPortEntry, vlanNameVlanId=vlanNameVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameEntry=vlanNameEntry, vlanNameNHash=vlanNameNHash, vlanNameStatusTime=vlanNameStatusTime, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortTable=vlanPortTable, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortVlanName=vlanPortVlanName, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortVlanId=vlanPortVlanId, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIUserMAC=sfpsVAPIUserMAC)
