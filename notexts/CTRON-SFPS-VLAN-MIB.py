...
vlanPort, vlanAMRRules, vlanName, vlanCountAPI, vlanTestAPI, vlanSystem, vlanAPI, vlanAMRStats, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAMRRules", "vlanName", "vlanCountAPI", "vlanTestAPI", "vlanSystem", "vlanAPI", "vlanAMRStats", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameEntry=vlanNameEntry, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemDomainName=vlanSystemDomainName, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortVlanId=vlanPortVlanId, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameTable=vlanNameTable, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameOperStatus=vlanNameOperStatus, vlanNameVlanRule=vlanNameVlanRule, VlanSwitchInstance=VlanSwitchInstance, vlanPortPortNum=vlanPortPortNum, vlanSystemSwitchInstance=vlanSystemSwitchInstance, SfpsAddress=SfpsAddress, vlanSystemEntry=vlanSystemEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortVlanName=vlanPortVlanName, vlanTestAPIPort=vlanTestAPIPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameVlanName=vlanNameVlanName, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameIndex=vlanNameIndex, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemMibRev=vlanSystemMibRev, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameVlanId=vlanNameVlanId, vlanSystemLastChange=vlanSystemLastChange, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortEntry=vlanPortEntry, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputTable=vlanTestAPIOutputTable, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameNHash=vlanNameNHash, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortTable=vlanPortTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, HexInteger=HexInteger, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameStatusTime=vlanNameStatusTime, vlanCountAPITotal=vlanCountAPITotal, vlanSystemTable=vlanSystemTable)
