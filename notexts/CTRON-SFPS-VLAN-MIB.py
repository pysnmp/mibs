...
vlanPort, vlanSystem, vlanName, vlanAMRRules, vlanAMRStats, vlanTestAPI, vlanAPI, vlanAMRSubnets, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanSystem", "vlanName", "vlanAMRRules", "vlanAMRStats", "vlanTestAPI", "vlanAPI", "vlanAMRSubnets", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortTable=vlanPortTable, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemVersion=vlanSystemVersion, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortVlanName=vlanPortVlanName, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemEntry=vlanSystemEntry, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameNHash=vlanNameNHash, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameTable=vlanNameTable, vlanSystemDomainName=vlanSystemDomainName, vlanSystemTable=vlanSystemTable, vlanNameOperStatus=vlanNameOperStatus, vlanNameVlanRule=vlanNameVlanRule, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortVlanId=vlanPortVlanId, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortPortNum=vlanPortPortNum, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameVlanName=vlanNameVlanName, vlanAMRRulesRule=vlanAMRRulesRule, HexInteger=HexInteger, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIVerb=vlanTestAPIVerb, SfpsSwitchPort=SfpsSwitchPort, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameIndex=vlanNameIndex, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortLayer3Learning=vlanPortLayer3Learning, SfpsAddress=SfpsAddress, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemLastChange=vlanSystemLastChange, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameNumUsers=vlanNameNumUsers, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortPortStatus=vlanPortPortStatus, vlanPortRelayAgent=vlanPortRelayAgent)
