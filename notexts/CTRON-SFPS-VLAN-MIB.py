...
vlanAMRRules, vlanAMRStats, vlanName, vlanPort, vlanTestAPI, vlanAPI, vlanCountAPI, vlanSystem, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanAMRStats", "vlanName", "vlanPort", "vlanTestAPI", "vlanAPI", "vlanCountAPI", "vlanSystem", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameVlanName=vlanNameVlanName, vlanTestAPIVerb=vlanTestAPIVerb, VlanSwitchInstance=VlanSwitchInstance, vlanCountAPITotal=vlanCountAPITotal, vlanNameStatusTime=vlanNameStatusTime, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameEntry=vlanNameEntry, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameVlanId=vlanNameVlanId, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortVlanId=vlanPortVlanId, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameNHash=vlanNameNHash, vlanSystemTable=vlanSystemTable, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameOperStatus=vlanNameOperStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPINvramId=sfpsVAPINvramId, SfpsAddress=SfpsAddress, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemOperTime=vlanSystemOperTime, vlanNameIndex=vlanNameIndex, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanPortPortNum=vlanPortPortNum, HexInteger=HexInteger, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemLastChange=vlanSystemLastChange, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemPollCount=vlanSystemPollCount, vlanNameTable=vlanNameTable, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemVersion=vlanSystemVersion, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIPort=vlanTestAPIPort, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortEntry=vlanPortEntry, vlanNameVlanRule=vlanNameVlanRule, vlanPortPortStatus=vlanPortPortStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortVlanName=vlanPortVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemEntry=vlanSystemEntry, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemMibRev=vlanSystemMibRev, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortTable=vlanPortTable, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameUniPolicy=vlanNameUniPolicy)
