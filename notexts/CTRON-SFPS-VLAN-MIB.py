...
vlanSystem, vlanCountAPI, vlanAMRStats, vlanName, vlanAMRSubnets, vlanAMRRules, vlanTestAPI, vlanAPI, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanCountAPI", "vlanAMRStats", "vlanName", "vlanAMRSubnets", "vlanAMRRules", "vlanTestAPI", "vlanAPI", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortRouterPort=vlanPortRouterPort, vlanNameUniPolicy=vlanNameUniPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, VlanSwitchInstance=VlanSwitchInstance, SfpsSwitchPort=SfpsSwitchPort, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortEntry=vlanPortEntry, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameStatusTime=vlanNameStatusTime, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameVlanName=vlanNameVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameTable=vlanNameTable, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, HexInteger=HexInteger, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortPortStatus=vlanPortPortStatus, vlanNameNumUsers=vlanNameNumUsers, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameNHash=vlanNameNHash, vlanSystemVersion=vlanSystemVersion, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortTable=vlanPortTable, vlanSystemTable=vlanSystemTable, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanCountAPITotal=vlanCountAPITotal, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemEntry=vlanSystemEntry, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortVlanName=vlanPortVlanName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameVlanId=vlanNameVlanId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameEntry=vlanNameEntry, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanNameIndex=vlanNameIndex, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortPortNum=vlanPortPortNum, SfpsAddress=SfpsAddress, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent)
