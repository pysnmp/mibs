...
vlanAMRRules, vlanName, vlanAPI, vlanTestAPI, vlanCountAPI, vlanAMRStats, vlanPort, vlanAMRSubnets, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanName", "vlanAPI", "vlanTestAPI", "vlanCountAPI", "vlanAMRStats", "vlanPort", "vlanAMRSubnets", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameNHash=vlanNameNHash, vlanNameOperStatus=vlanNameOperStatus, vlanNameNumUsers=vlanNameNumUsers, vlanNameVlanName=vlanNameVlanName, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortTable=vlanPortTable, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemPollCount=vlanSystemPollCount, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemDomainName=vlanSystemDomainName, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameVlanId=vlanNameVlanId, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortPortNum=vlanPortPortNum, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemTable=vlanSystemTable, vlanNameEntry=vlanNameEntry, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIPort=vlanTestAPIPort, vlanCountAPITotal=vlanCountAPITotal, vlanPortPortStatus=vlanPortPortStatus, vlanSystemAdminReset=vlanSystemAdminReset, SfpsAddress=SfpsAddress, vlanSystemVersion=vlanSystemVersion, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameTable=vlanNameTable, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemOperStatus=vlanSystemOperStatus, SfpsSwitchPort=SfpsSwitchPort, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortEntry=vlanPortEntry, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortUniPolicy=vlanPortUniPolicy, HexInteger=HexInteger, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortVlanName=vlanPortVlanName, vlanSystemLastChange=vlanSystemLastChange, vlanPortVlanId=vlanPortVlanId, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameIndex=vlanNameIndex, sfpsVAPINvramId=sfpsVAPINvramId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortRouterPort=vlanPortRouterPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameVlanRule=vlanNameVlanRule, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortFloodPolicy=vlanPortFloodPolicy)
