...
vlanName, vlanAMRStats, vlanPort, vlanCountAPI, vlanAMRRules, vlanAPI, vlanTestAPI, vlanSystem, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanAMRStats", "vlanPort", "vlanCountAPI", "vlanAMRRules", "vlanAPI", "vlanTestAPI", "vlanSystem", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameUniPolicy=vlanNameUniPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortVlanId=vlanPortVlanId, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemTable=vlanSystemTable, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, SfpsSwitchPort=SfpsSwitchPort, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemLastChange=vlanSystemLastChange, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortEntry=vlanPortEntry, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameVlanId=vlanNameVlanId, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortVlanName=vlanPortVlanName, vlanNameEntry=vlanNameEntry, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemEntry=vlanSystemEntry, vlanSystemVersion=vlanSystemVersion, vlanPortRouterPort=vlanPortRouterPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameNumUsers=vlanNameNumUsers, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortTable=vlanPortTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameTable=vlanNameTable, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameNHash=vlanNameNHash, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameStatusTime=vlanNameStatusTime, vlanSystemDomainName=vlanSystemDomainName, vlanNameAdminStatus=vlanNameAdminStatus, SfpsAddress=SfpsAddress, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameVlanName=vlanNameVlanName, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortPortStatus=vlanPortPortStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortPortNum=vlanPortPortNum, vlanNameIndex=vlanNameIndex, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, HexInteger=HexInteger, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemAgentIP=vlanSystemAgentIP)
