...
vlanAMRSubnets, vlanAMRStats, vlanCountAPI, vlanName, vlanSystem, vlanTestAPI, vlanAPI, vlanPort, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanAMRStats", "vlanCountAPI", "vlanName", "vlanSystem", "vlanTestAPI", "vlanAPI", "vlanPort", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRRulesTable=vlanAMRRulesTable, SfpsAddress=SfpsAddress, vlanPortRouterPort=vlanPortRouterPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortPortNum=vlanPortPortNum, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputTap=vlanTestAPIOutputTap, HexInteger=HexInteger, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameStatusTime=vlanNameStatusTime, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemDomainName=vlanSystemDomainName, VlanSwitchInstance=VlanSwitchInstance, vlanCountAPITotal=vlanCountAPITotal, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameEntry=vlanNameEntry, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameVlanRule=vlanNameVlanRule, vlanNameIndex=vlanNameIndex, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameVlanName=vlanNameVlanName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortTable=vlanPortTable, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortVlanName=vlanPortVlanName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameOperStatus=vlanNameOperStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortVlanId=vlanPortVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameUniPolicy=vlanNameUniPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameVlanId=vlanNameVlanId, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemEntry=vlanSystemEntry, vlanTestAPIPort=vlanTestAPIPort, vlanNameNHash=vlanNameNHash, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemVersion=vlanSystemVersion, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemTable=vlanSystemTable, vlanNameTable=vlanNameTable)
