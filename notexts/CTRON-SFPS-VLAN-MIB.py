...
vlanAPI, vlanName, vlanAMRSubnets, vlanCountAPI, vlanTestAPI, vlanAMRStats, vlanSystem, vlanAMRRules, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanName", "vlanAMRSubnets", "vlanCountAPI", "vlanTestAPI", "vlanAMRStats", "vlanSystem", "vlanAMRRules", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPINvramId=sfpsVAPINvramId, SfpsAddress=SfpsAddress, vlanNameMappedPorts=vlanNameMappedPorts, SfpsSwitchPort=SfpsSwitchPort, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanCountAPITotal=vlanCountAPITotal, vlanSystemLastChange=vlanSystemLastChange, vlanSystemEntry=vlanSystemEntry, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameVlanId=vlanNameVlanId, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, HexInteger=HexInteger, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameNumUsers=vlanNameNumUsers, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemMibRev=vlanSystemMibRev, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortTable=vlanPortTable, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameIndex=vlanNameIndex, VlanSwitchInstance=VlanSwitchInstance, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortPortStatus=vlanPortPortStatus, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameTable=vlanNameTable, vlanSystemVersion=vlanSystemVersion, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortPortNum=vlanPortPortNum, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameNHash=vlanNameNHash, vlanPortVlanId=vlanPortVlanId, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameEntry=vlanNameEntry, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortEntry=vlanPortEntry, vlanSystemOperTime=vlanSystemOperTime, vlanNameVlanRule=vlanNameVlanRule, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortVlanName=vlanPortVlanName, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIPort=vlanTestAPIPort, vlanPortRouterPort=vlanPortRouterPort, vlanNameVlanName=vlanNameVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts)
