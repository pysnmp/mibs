...
vlanCountAPI, vlanAPI, vlanAMRRules, vlanSystem, vlanName, vlanAMRSubnets, vlanPort, vlanAMRStats, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAPI", "vlanAMRRules", "vlanSystem", "vlanName", "vlanAMRSubnets", "vlanPort", "vlanAMRStats", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanCountAPITotal=vlanCountAPITotal, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameVlanName=vlanNameVlanName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemLastChange=vlanSystemLastChange, vlanNameTable=vlanNameTable, vlanPortTable=vlanPortTable, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortVlanId=vlanPortVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortEntry=vlanPortEntry, HexInteger=HexInteger, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemTable=vlanSystemTable, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, SfpsSwitchPort=SfpsSwitchPort, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortRouterPort=vlanPortRouterPort, vlanNameVlanId=vlanNameVlanId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemOperTime=vlanSystemOperTime, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortVlanName=vlanPortVlanName, vlanSystemEntry=vlanSystemEntry, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemPollCount=vlanSystemPollCount, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemVersion=vlanSystemVersion, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameIndex=vlanNameIndex, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameNumUsers=vlanNameNumUsers, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIVerb=sfpsVAPIVerb, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameMappedPorts=vlanNameMappedPorts, SfpsAddress=SfpsAddress, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortPortNum=vlanPortPortNum, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameEntry=vlanNameEntry, vlanNameOperStatus=vlanNameOperStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy)
