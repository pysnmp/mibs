...
vlanSystem, vlanPort, vlanAMRStats, vlanCountAPI, vlanName, vlanAMRRules, vlanTestAPI, vlanAPI, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanPort", "vlanAMRStats", "vlanCountAPI", "vlanName", "vlanAMRRules", "vlanTestAPI", "vlanAPI", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameNHash=vlanNameNHash, vlanNameVlanRule=vlanNameVlanRule, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameNumUsers=vlanNameNumUsers, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameIndex=vlanNameIndex, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemLastChange=vlanSystemLastChange, vlanPortVlanName=vlanPortVlanName, vlanPortRouterPort=vlanPortRouterPort, vlanCountAPITotal=vlanCountAPITotal, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortTable=vlanPortTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameFloodPorts=vlanNameFloodPorts, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemOperTime=vlanSystemOperTime, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputAble=vlanTestAPIOutputAble, SfpsSwitchPort=SfpsSwitchPort, vlanNameVlanName=vlanNameVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemVersion=vlanSystemVersion, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameTable=vlanNameTable, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameEntry=vlanNameEntry, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIPort=vlanTestAPIPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortEntry=vlanPortEntry, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortPortStatus=vlanPortPortStatus, vlanPortVlanId=vlanPortVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortPortNum=vlanPortPortNum, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameVlanId=vlanNameVlanId, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemMibRev=vlanSystemMibRev, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, HexInteger=HexInteger, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, VlanSwitchInstance=VlanSwitchInstance, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortAdminStatus=vlanPortAdminStatus, SfpsAddress=SfpsAddress, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId)
