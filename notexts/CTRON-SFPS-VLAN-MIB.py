...
vlanTestAPI, vlanName, vlanAMRSubnets, vlanAMRRules, vlanSystem, vlanCountAPI, vlanAMRStats, vlanPort, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanName", "vlanAMRSubnets", "vlanAMRRules", "vlanSystem", "vlanCountAPI", "vlanAMRStats", "vlanPort", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortTable=vlanPortTable, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanPortPortNum=vlanPortPortNum, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortEntry=vlanPortEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, VlanSwitchInstance=VlanSwitchInstance, vlanNameVlanName=vlanNameVlanName, vlanNameIndex=vlanNameIndex, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanCountAPITotal=vlanCountAPITotal, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameEntry=vlanNameEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortPortStatus=vlanPortPortStatus, vlanPortVlanName=vlanPortVlanName, vlanNameTable=vlanNameTable, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameOperStatus=vlanNameOperStatus, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameNHash=vlanNameNHash, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemVersion=vlanSystemVersion, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemTable=vlanSystemTable, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemEntry=vlanSystemEntry, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIVlanId=sfpsVAPIVlanId, SfpsSwitchPort=SfpsSwitchPort, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, SfpsAddress=SfpsAddress, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, HexInteger=HexInteger, vlanPortVlanId=vlanPortVlanId, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIPort=vlanTestAPIPort, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix)
