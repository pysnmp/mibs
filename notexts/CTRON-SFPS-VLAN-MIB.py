...
vlanAMRSubnets, vlanSystem, vlanName, vlanAMRStats, vlanTestAPI, vlanAPI, vlanAMRRules, vlanCountAPI, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanSystem", "vlanName", "vlanAMRStats", "vlanTestAPI", "vlanAPI", "vlanAMRRules", "vlanCountAPI", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemMibRev=vlanSystemMibRev, vlanPortEntry=vlanPortEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemDomainName=vlanSystemDomainName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, SfpsAddress=SfpsAddress, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameVlanId=vlanNameVlanId, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemOperTime=vlanSystemOperTime, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameTable=vlanNameTable, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameRelayAgent=vlanNameRelayAgent, SfpsSwitchPort=SfpsSwitchPort, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortTable=vlanPortTable, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameVlanName=vlanNameVlanName, vlanNameNHash=vlanNameNHash, vlanTestAPIPort=vlanTestAPIPort, vlanPortPortNum=vlanPortPortNum, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameEntry=vlanNameEntry, vlanPortVlanName=vlanPortVlanName, vlanSystemVersion=vlanSystemVersion, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIVlanId=vlanTestAPIVlanId, HexInteger=HexInteger, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemLastChange=vlanSystemLastChange, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemEntry=vlanSystemEntry, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortRouterPort=vlanPortRouterPort, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemTable=vlanSystemTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus)
