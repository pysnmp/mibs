...
vlanTestAPI, vlanSystem, vlanName, vlanAPI, vlanCountAPI, vlanAMRRules, vlanAMRStats, vlanAMRSubnets, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanSystem", "vlanName", "vlanAPI", "vlanCountAPI", "vlanAMRRules", "vlanAMRStats", "vlanAMRSubnets", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameAdminStatus=vlanNameAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameTable=vlanNameTable, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameNumUsers=vlanNameNumUsers, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameVlanName=vlanNameVlanName, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemOperTime=vlanSystemOperTime, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortRouterPort=vlanPortRouterPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemPollCount=vlanSystemPollCount, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortPortStatus=vlanPortPortStatus, vlanNameVlanRule=vlanNameVlanRule, vlanNameNHash=vlanNameNHash, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameOperStatus=vlanNameOperStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanCountAPITotal=vlanCountAPITotal, vlanPortVlanId=vlanPortVlanId, vlanPortTable=vlanPortTable, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameVlanId=vlanNameVlanId, vlanPortVlanName=vlanPortVlanName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortEntry=vlanPortEntry, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemTable=vlanSystemTable, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIPort=vlanTestAPIPort, vlanNameStatusTime=vlanNameStatusTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, HexInteger=HexInteger, vlanNameEntry=vlanNameEntry, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameIndex=vlanNameIndex, SfpsAddress=SfpsAddress, vlanSystemVersion=vlanSystemVersion, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIVerb=vlanTestAPIVerb)
