...
vlanPort, vlanAPI, vlanName, vlanAMRStats, vlanCountAPI, vlanAMRRules, vlanTestAPI, vlanSystem, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAPI", "vlanName", "vlanAMRStats", "vlanCountAPI", "vlanAMRRules", "vlanTestAPI", "vlanSystem", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanNameEntry=vlanNameEntry, vlanPortPortStatus=vlanPortPortStatus, vlanNameIndex=vlanNameIndex, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIPort=vlanTestAPIPort, vlanPortEntry=vlanPortEntry, SfpsSwitchPort=SfpsSwitchPort, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameNumUsers=vlanNameNumUsers, SfpsAddress=SfpsAddress, vlanSystemVersion=vlanSystemVersion, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameVlanId=vlanNameVlanId, vlanSystemTable=vlanSystemTable, vlanSystemPollCount=vlanSystemPollCount, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemEntry=vlanSystemEntry, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortRouterPort=vlanPortRouterPort, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortVlanName=vlanPortVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameTable=vlanNameTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortTable=vlanPortTable, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameVlanName=vlanNameVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemDomainName=vlanSystemDomainName, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameMappedPorts=vlanNameMappedPorts, VlanSwitchInstance=VlanSwitchInstance, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemOperTime=vlanSystemOperTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortPortNum=vlanPortPortNum, HexInteger=HexInteger, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameNHash=vlanNameNHash)
