...
vlanPort, vlanCountAPI, vlanTestAPI, vlanAMRRules, vlanSystem, vlanAMRStats, vlanAMRSubnets, vlanName, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanCountAPI", "vlanTestAPI", "vlanAMRRules", "vlanSystem", "vlanAMRStats", "vlanAMRSubnets", "vlanName", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameTable=vlanNameTable, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameIndex=vlanNameIndex, vlanNameNHash=vlanNameNHash, vlanPortVlanId=vlanPortVlanId, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameNumUsers=vlanNameNumUsers, vlanPortPortNum=vlanPortPortNum, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameVlanName=vlanNameVlanName, vlanSystemDomainName=vlanSystemDomainName, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortTable=vlanPortTable, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameStatusTime=vlanNameStatusTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemTable=vlanSystemTable, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemLastChange=vlanSystemLastChange, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortRouterPort=vlanPortRouterPort, vlanNameVlanRule=vlanNameVlanRule, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemEntry=vlanSystemEntry, vlanSystemOperTime=vlanSystemOperTime, vlanPortPortStatus=vlanPortPortStatus, vlanNameEntry=vlanNameEntry, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameVlanId=vlanNameVlanId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemVersion=vlanSystemVersion, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, SfpsSwitchPort=SfpsSwitchPort, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanCountAPITotal=vlanCountAPITotal, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortEntry=vlanPortEntry, HexInteger=HexInteger, vlanSystemPollCount=vlanSystemPollCount, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortVlanName=vlanPortVlanName, vlanNameRelayAgent=vlanNameRelayAgent, SfpsAddress=SfpsAddress, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy)
