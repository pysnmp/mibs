...
vlanCountAPI, vlanAMRStats, vlanAMRRules, vlanTestAPI, vlanAMRSubnets, vlanSystem, vlanPort, vlanName, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAMRStats", "vlanAMRRules", "vlanTestAPI", "vlanAMRSubnets", "vlanSystem", "vlanPort", "vlanName", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortPortPolicy=vlanPortPortPolicy, vlanNameEntry=vlanNameEntry, vlanSystemOperTime=vlanSystemOperTime, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortRouterPort=vlanPortRouterPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemVersion=vlanSystemVersion, vlanNameTable=vlanNameTable, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameVlanRule=vlanNameVlanRule, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemTable=vlanSystemTable, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameVlanId=vlanNameVlanId, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortPortNum=vlanPortPortNum, vlanNameFloodPorts=vlanNameFloodPorts, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemLastChange=vlanSystemLastChange, vlanNameIndex=vlanNameIndex, vlanNameOperStatus=vlanNameOperStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameNHash=vlanNameNHash, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortEntry=vlanPortEntry, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, VlanSwitchInstance=VlanSwitchInstance, vlanPortUniPolicy=vlanPortUniPolicy, SfpsAddress=SfpsAddress, vlanNameStatusTime=vlanNameStatusTime, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanSystemEntry=vlanSystemEntry, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortVlanId=vlanPortVlanId, HexInteger=HexInteger, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameVlanName=vlanNameVlanName, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanCountAPITotal=vlanCountAPITotal, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameNumUsers=vlanNameNumUsers, vlanPortTable=vlanPortTable, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameAdminStatus=vlanNameAdminStatus)
