...
vlanTestAPI, vlanCountAPI, vlanAMRSubnets, vlanPort, vlanAPI, vlanName, vlanAMRStats, vlanSystem, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanCountAPI", "vlanAMRSubnets", "vlanPort", "vlanAPI", "vlanName", "vlanAMRStats", "vlanSystem", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameVlanName=vlanNameVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameIndex=vlanNameIndex, vlanNameNHash=vlanNameNHash, vlanSystemEntry=vlanSystemEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortVlanName=vlanPortVlanName, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameVlanRule=vlanNameVlanRule, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPINvramId=sfpsVAPINvramId, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameNumUsers=vlanNameNumUsers, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameTable=vlanNameTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortTable=vlanPortTable, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, VlanSwitchInstance=VlanSwitchInstance, vlanPortEntry=vlanPortEntry, vlanCountAPITotal=vlanCountAPITotal, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortRouterPort=vlanPortRouterPort, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemVersion=vlanSystemVersion, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, SfpsAddress=SfpsAddress, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemPollCount=vlanSystemPollCount, vlanPortPortStatus=vlanPortPortStatus, HexInteger=HexInteger, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIPort=vlanTestAPIPort, vlanPortVlanId=vlanPortVlanId, vlanNameEntry=vlanNameEntry, vlanSystemTable=vlanSystemTable, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameVlanId=vlanNameVlanId)
