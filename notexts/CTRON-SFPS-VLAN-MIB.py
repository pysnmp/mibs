...
vlanPort, vlanAMRRules, vlanAPI, vlanName, vlanAMRSubnets, vlanAMRStats, vlanTestAPI, vlanSystem, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAMRRules", "vlanAPI", "vlanName", "vlanAMRSubnets", "vlanAMRStats", "vlanTestAPI", "vlanSystem", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortEntry=vlanPortEntry, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortRouterPort=vlanPortRouterPort, vlanPortPortNum=vlanPortPortNum, vlanSystemLastChange=vlanSystemLastChange, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortVlanId=vlanPortVlanId, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIPort=vlanTestAPIPort, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemMibRev=vlanSystemMibRev, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIVlanName=vlanTestAPIVlanName, HexInteger=HexInteger, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortTable=vlanPortTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanCountAPITotal=vlanCountAPITotal, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameEntry=vlanNameEntry, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameVlanRule=vlanNameVlanRule, vlanNameVlanName=vlanNameVlanName, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameIndex=vlanNameIndex, vlanNameVlanId=vlanNameVlanId, SfpsSwitchPort=SfpsSwitchPort, vlanSystemTable=vlanSystemTable, vlanPortVlanName=vlanPortVlanName, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameNumUsers=vlanNameNumUsers, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, SfpsAddress=SfpsAddress, vlanNameNHash=vlanNameNHash, vlanNameTable=vlanNameTable, vlanSystemEntry=vlanSystemEntry, vlanSystemVersion=vlanSystemVersion, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemOperTime=vlanSystemOperTime)
