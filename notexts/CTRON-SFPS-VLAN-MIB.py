...
vlanTestAPI, vlanSystem, vlanCountAPI, vlanAMRRules, vlanAPI, vlanPort, vlanName, vlanAMRSubnets, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanSystem", "vlanCountAPI", "vlanAMRRules", "vlanAPI", "vlanPort", "vlanName", "vlanAMRSubnets", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortPortStatus=vlanPortPortStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortTable=vlanPortTable, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanPortVlanId=vlanPortVlanId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIOutPort=sfpsVAPIOutPort, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortEntry=vlanPortEntry, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanNameVlanName=vlanNameVlanName, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameTable=vlanNameTable, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIPort=vlanTestAPIPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemTable=vlanSystemTable, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameStatusTime=vlanNameStatusTime, SfpsAddress=SfpsAddress, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, HexInteger=HexInteger, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemMibRev=vlanSystemMibRev, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameNHash=vlanNameNHash, VlanSwitchInstance=VlanSwitchInstance, vlanNameEntry=vlanNameEntry, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameIndex=vlanNameIndex, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemEntry=vlanSystemEntry, vlanSystemVersion=vlanSystemVersion, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameVlanId=vlanNameVlanId, vlanNameOperStatus=vlanNameOperStatus, vlanSystemOperStatus=vlanSystemOperStatus)
