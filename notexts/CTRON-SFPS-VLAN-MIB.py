...
vlanAPI, vlanSystem, vlanAMRRules, vlanCountAPI, vlanPort, vlanAMRSubnets, vlanAMRStats, vlanTestAPI, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanSystem", "vlanAMRRules", "vlanCountAPI", "vlanPort", "vlanAMRSubnets", "vlanAMRStats", "vlanTestAPI", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameOperStatus=vlanNameOperStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemVersion=vlanSystemVersion, vlanSystemEntry=vlanSystemEntry, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortPortStatus=vlanPortPortStatus, vlanNameVlanId=vlanNameVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortVlanName=vlanPortVlanName, vlanNameEntry=vlanNameEntry, vlanSystemTable=vlanSystemTable, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameNHash=vlanNameNHash, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemDomainName=vlanSystemDomainName, VlanSwitchInstance=VlanSwitchInstance, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameNumUsers=vlanNameNumUsers, vlanAMRRulesTable=vlanAMRRulesTable, SfpsSwitchPort=SfpsSwitchPort, vlanNameIndex=vlanNameIndex, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortEntry=vlanPortEntry, HexInteger=HexInteger, vlanPortRouterPort=vlanPortRouterPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameTable=vlanNameTable, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameVlanRule=vlanNameVlanRule, SfpsAddress=SfpsAddress, vlanSystemMibRev=vlanSystemMibRev, vlanSystemPollCount=vlanSystemPollCount, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortTable=vlanPortTable, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameVlanName=vlanNameVlanName, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortPortNum=vlanPortPortNum, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemOperTime=vlanSystemOperTime, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameAdminStatus=vlanNameAdminStatus)
