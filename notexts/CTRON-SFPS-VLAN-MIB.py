...
vlanAMRStats, vlanAPI, vlanAMRSubnets, vlanTestAPI, vlanCountAPI, vlanAMRRules, vlanSystem, vlanName, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanAPI", "vlanAMRSubnets", "vlanTestAPI", "vlanCountAPI", "vlanAMRRules", "vlanSystem", "vlanName", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemOperTime=vlanSystemOperTime, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortVlanName=vlanPortVlanName, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemMibRev=vlanSystemMibRev, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemLastChange=vlanSystemLastChange, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameNumUsers=vlanNameNumUsers, vlanSystemTable=vlanSystemTable, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortVlanId=vlanPortVlanId, vlanNameVlanName=vlanNameVlanName, SfpsSwitchPort=SfpsSwitchPort, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortEntry=vlanPortEntry, vlanNameNHash=vlanNameNHash, vlanNameEntry=vlanNameEntry, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIInPort=sfpsVAPIInPort, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemDomainName=vlanSystemDomainName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameVlanId=vlanNameVlanId, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameIndex=vlanNameIndex, vlanNameStatusTime=vlanNameStatusTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortPortNum=vlanPortPortNum, vlanSystemPriorPollTime=vlanSystemPriorPollTime, SfpsAddress=SfpsAddress, vlanSystemPollCount=vlanSystemPollCount, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemEntry=vlanSystemEntry, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortTable=vlanPortTable, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameTable=vlanNameTable, vlanNameOperStatus=vlanNameOperStatus, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemVersion=vlanSystemVersion, HexInteger=HexInteger, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortPortPolicy=vlanPortPortPolicy)
