...
vlanName, vlanCountAPI, vlanTestAPI, vlanSystem, vlanAPI, vlanPort, vlanAMRSubnets, vlanAMRStats, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanCountAPI", "vlanTestAPI", "vlanSystem", "vlanAPI", "vlanPort", "vlanAMRSubnets", "vlanAMRStats", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameNHash=vlanNameNHash, HexInteger=HexInteger, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemEntry=vlanSystemEntry, vlanNameVlanName=vlanNameVlanName, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortVlanName=vlanPortVlanName, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemVersion=vlanSystemVersion, vlanSystemMibRev=vlanSystemMibRev, vlanSystemOperTime=vlanSystemOperTime, vlanPortTable=vlanPortTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIInPort=sfpsVAPIInPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortVlanId=vlanPortVlanId, vlanPortEntry=vlanPortEntry, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameNumUsers=vlanNameNumUsers, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemPollCount=vlanSystemPollCount, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRSubnetsMask=vlanAMRSubnetsMask, SfpsSwitchPort=SfpsSwitchPort, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortUniPolicy=vlanPortUniPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanPortPortNum=vlanPortPortNum, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemSwitchInstance=vlanSystemSwitchInstance, SfpsAddress=SfpsAddress, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameEntry=vlanNameEntry, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortPortStatus=vlanPortPortStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameTable=vlanNameTable, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameIndex=vlanNameIndex, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortRouterPort=vlanPortRouterPort, vlanNameOperStatus=vlanNameOperStatus, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemTable=vlanSystemTable, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanCountAPITotal=vlanCountAPITotal, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIPort=vlanTestAPIPort, vlanNameVlanId=vlanNameVlanId, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName)
