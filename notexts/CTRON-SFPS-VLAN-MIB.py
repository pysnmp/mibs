...
vlanAMRRules, vlanAMRStats, vlanAPI, vlanTestAPI, vlanSystem, vlanAMRSubnets, vlanPort, vlanName, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanAMRStats", "vlanAPI", "vlanTestAPI", "vlanSystem", "vlanAMRSubnets", "vlanPort", "vlanName", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", HexInteger=HexInteger, vlanNameRelayAgent=vlanNameRelayAgent, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemOperTime=vlanSystemOperTime, vlanPortPortStatus=vlanPortPortStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameNumUsers=vlanNameNumUsers, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameEntry=vlanNameEntry, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameVlanName=vlanNameVlanName, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIPort=vlanTestAPIPort, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortTable=vlanPortTable, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameIndex=vlanNameIndex, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemEntry=vlanSystemEntry, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortEntry=vlanPortEntry, vlanPortRouterPort=vlanPortRouterPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortPortNum=vlanPortPortNum, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemVersion=vlanSystemVersion, vlanPortVlanName=vlanPortVlanName, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, VlanSwitchInstance=VlanSwitchInstance, vlanNameStatusTime=vlanNameStatusTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRRulesEntry=vlanAMRRulesEntry, SfpsSwitchPort=SfpsSwitchPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameTable=vlanNameTable, vlanSystemAdminStatus=vlanSystemAdminStatus, SfpsAddress=SfpsAddress, vlanSystemPollCount=vlanSystemPollCount, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIVerb=sfpsVAPIVerb, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameVlanId=vlanNameVlanId, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortVlanId=vlanPortVlanId, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIUserMAC=sfpsVAPIUserMAC)
