...
vlanTestAPI, vlanPort, vlanCountAPI, vlanAMRRules, vlanSystem, vlanAPI, vlanName, vlanAMRSubnets, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanPort", "vlanCountAPI", "vlanAMRRules", "vlanSystem", "vlanAPI", "vlanName", "vlanAMRSubnets", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanNameNumUsers=vlanNameNumUsers, vlanNameVlanRule=vlanNameVlanRule, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortEntry=vlanPortEntry, vlanNameStatusTime=vlanNameStatusTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIPort=vlanTestAPIPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameVlanId=vlanNameVlanId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemOperTime=vlanSystemOperTime, vlanSystemLastChange=vlanSystemLastChange, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortVlanName=vlanPortVlanName, vlanNameNHash=vlanNameNHash, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortPortNum=vlanPortPortNum, vlanNameTable=vlanNameTable, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameVlanName=vlanNameVlanName, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortPortStatus=vlanPortPortStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortVlanId=vlanPortVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortTable=vlanPortTable, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIVlanId=sfpsVAPIVlanId, HexInteger=HexInteger, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemVersion=vlanSystemVersion, SfpsAddress=SfpsAddress, vlanSystemEntry=vlanSystemEntry, vlanNameIndex=vlanNameIndex, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemTable=vlanSystemTable, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemPollCount=vlanSystemPollCount)
