...
vlanAPI, vlanCountAPI, vlanTestAPI, vlanAMRSubnets, vlanAMRStats, vlanPort, vlanAMRRules, vlanSystem, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanCountAPI", "vlanTestAPI", "vlanAMRSubnets", "vlanAMRStats", "vlanPort", "vlanAMRRules", "vlanSystem", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanNameVlanName=vlanNameVlanName, vlanSystemTable=vlanSystemTable, vlanCountAPIAdmin=vlanCountAPIAdmin, VlanSwitchInstance=VlanSwitchInstance, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortVlanName=vlanPortVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortRouterPort=vlanPortRouterPort, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameVlanId=vlanNameVlanId, vlanNameNumUsers=vlanNameNumUsers, vlanPortPortNum=vlanPortPortNum, vlanPortEntry=vlanPortEntry, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemEntry=vlanSystemEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemVersion=vlanSystemVersion, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameNHash=vlanNameNHash, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameTable=vlanNameTable, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, SfpsAddress=SfpsAddress, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortVlanId=vlanPortVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemOperTime=vlanSystemOperTime, HexInteger=HexInteger, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemLastChange=vlanSystemLastChange, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameVlanRule=vlanNameVlanRule, vlanNameOperStatus=vlanNameOperStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortTable=vlanPortTable, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC)
