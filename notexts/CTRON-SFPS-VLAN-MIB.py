...
vlanName, vlanSystem, vlanPort, vlanAMRSubnets, vlanAMRStats, vlanAPI, vlanAMRRules, vlanTestAPI, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanSystem", "vlanPort", "vlanAMRSubnets", "vlanAMRStats", "vlanAPI", "vlanAMRRules", "vlanTestAPI", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortPortStatus=vlanPortPortStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortEntry=vlanPortEntry, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemOperTime=vlanSystemOperTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIPort=vlanTestAPIPort, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, SfpsAddress=SfpsAddress, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemVersion=vlanSystemVersion, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortTable=vlanPortTable, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameNHash=vlanNameNHash, vlanNameRelayAgent=vlanNameRelayAgent, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortVlanId=vlanPortVlanId, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemEntry=vlanSystemEntry, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameVlanId=vlanNameVlanId, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, HexInteger=HexInteger, vlanNameEntry=vlanNameEntry, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameVlanName=vlanNameVlanName, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemMibRev=vlanSystemMibRev, vlanNameTable=vlanNameTable, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanNameNumUsers=vlanNameNumUsers, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemTable=vlanSystemTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameIndex=vlanNameIndex)
