...
vlanSystem, vlanAMRRules, vlanName, vlanPort, vlanAMRStats, vlanAMRSubnets, vlanTestAPI, vlanCountAPI, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanAMRRules", "vlanName", "vlanPort", "vlanAMRStats", "vlanAMRSubnets", "vlanTestAPI", "vlanCountAPI", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemPollCount=vlanSystemPollCount, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemDomainName=vlanSystemDomainName, vlanNameOperStatus=vlanNameOperStatus, vlanNameIndex=vlanNameIndex, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemEntry=vlanSystemEntry, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameVlanId=vlanNameVlanId, vlanNameEntry=vlanNameEntry, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameNumUsers=vlanNameNumUsers, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanSystemTable=vlanSystemTable, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameNHash=vlanNameNHash, vlanNameTable=vlanNameTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortVlanId=vlanPortVlanId, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemVersion=vlanSystemVersion, HexInteger=HexInteger, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIPort=vlanTestAPIPort, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, SfpsSwitchPort=SfpsSwitchPort, vlanAMRRulesEntry=vlanAMRRulesEntry, SfpsAddress=SfpsAddress, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortVlanName=vlanPortVlanName, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortEntry=vlanPortEntry, vlanPortTable=vlanPortTable, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortPortNum=vlanPortPortNum, vlanSystemOperTime=vlanSystemOperTime, vlanPortPortStatus=vlanPortPortStatus, vlanNameStatusTime=vlanNameStatusTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime)
