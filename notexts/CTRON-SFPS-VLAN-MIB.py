...
vlanAPI, vlanAMRRules, vlanAMRSubnets, vlanTestAPI, vlanAMRStats, vlanCountAPI, vlanPort, vlanName, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanAMRRules", "vlanAMRSubnets", "vlanTestAPI", "vlanAMRStats", "vlanCountAPI", "vlanPort", "vlanName", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameIndex=vlanNameIndex, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameTable=vlanNameTable, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameOperStatus=vlanNameOperStatus, vlanSystemTable=vlanSystemTable, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortPortNum=vlanPortPortNum, vlanCountAPITotal=vlanCountAPITotal, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRRulesEntry=vlanAMRRulesEntry, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameVlanId=vlanNameVlanId, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortPortStatus=vlanPortPortStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIPort=vlanTestAPIPort, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameNHash=vlanNameNHash, vlanSystemDomainName=vlanSystemDomainName, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortEntry=vlanPortEntry, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRRulesTable=vlanAMRRulesTable, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemLastPollTime=vlanSystemLastPollTime, SfpsAddress=SfpsAddress, vlanPortVlanId=vlanPortVlanId, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanSystemLastChange=vlanSystemLastChange, vlanSystemEntry=vlanSystemEntry, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortTable=vlanPortTable, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameVlanName=vlanNameVlanName, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemMibRev=vlanSystemMibRev, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortVlanName=vlanPortVlanName, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemVersion=vlanSystemVersion, vlanTestAPIVerb=vlanTestAPIVerb, HexInteger=HexInteger, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameEntry=vlanNameEntry, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemOperStatus=vlanSystemOperStatus)
