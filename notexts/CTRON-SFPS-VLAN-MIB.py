...
vlanTestAPI, vlanAMRStats, vlanAMRRules, vlanAMRSubnets, vlanName, vlanAPI, vlanCountAPI, vlanPort, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanAMRStats", "vlanAMRRules", "vlanAMRSubnets", "vlanName", "vlanAPI", "vlanCountAPI", "vlanPort", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameStatusTime=vlanNameStatusTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameVlanName=vlanNameVlanName, vlanSystemEntry=vlanSystemEntry, vlanSystemMibRev=vlanSystemMibRev, vlanPortTable=vlanPortTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameNHash=vlanNameNHash, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemAdminReset=vlanSystemAdminReset, VlanSwitchInstance=VlanSwitchInstance, vlanPortPortStatus=vlanPortPortStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortEntry=vlanPortEntry, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameIndex=vlanNameIndex, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, SfpsSwitchPort=SfpsSwitchPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemTable=vlanSystemTable, vlanPortRouterPort=vlanPortRouterPort, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, HexInteger=HexInteger, vlanSystemVersion=vlanSystemVersion, vlanSystemLastChange=vlanSystemLastChange, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortVlanName=vlanPortVlanName, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortPortNum=vlanPortPortNum, vlanSystemPollCount=vlanSystemPollCount, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIVlanName=vlanTestAPIVlanName, SfpsAddress=SfpsAddress, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemDomainName=vlanSystemDomainName, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameTable=vlanNameTable, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameVlanId=vlanNameVlanId, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameEntry=vlanNameEntry)
