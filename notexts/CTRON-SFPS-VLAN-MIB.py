...
vlanAMRStats, vlanSystem, vlanAPI, vlanCountAPI, vlanPort, vlanTestAPI, vlanName, vlanAMRRules, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanSystem", "vlanAPI", "vlanCountAPI", "vlanPort", "vlanTestAPI", "vlanName", "vlanAMRRules", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameVlanId=vlanNameVlanId, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameOperStatus=vlanNameOperStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemMibRev=vlanSystemMibRev, vlanNameEntry=vlanNameEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortVlanName=vlanPortVlanName, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameTable=vlanNameTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortVlanId=vlanPortVlanId, vlanSystemLastChange=vlanSystemLastChange, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemVersion=vlanSystemVersion, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameVlanName=vlanNameVlanName, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameIndex=vlanNameIndex, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemEntry=vlanSystemEntry, vlanNameNHash=vlanNameNHash, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, SfpsSwitchPort=SfpsSwitchPort, vlanSystemPollCount=vlanSystemPollCount, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemSwitchInstance=vlanSystemSwitchInstance, VlanSwitchInstance=VlanSwitchInstance, vlanPortTable=vlanPortTable, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortEntry=vlanPortEntry, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortRouterPort=vlanPortRouterPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIVlanId=sfpsVAPIVlanId, HexInteger=HexInteger, SfpsAddress=SfpsAddress, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemTable=vlanSystemTable)
