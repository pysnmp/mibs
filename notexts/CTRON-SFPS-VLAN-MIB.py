...
vlanAPI, vlanSystem, vlanName, vlanPort, vlanAMRSubnets, vlanAMRStats, vlanAMRRules, vlanTestAPI, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanSystem", "vlanName", "vlanPort", "vlanAMRSubnets", "vlanAMRStats", "vlanAMRRules", "vlanTestAPI", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemVersion=vlanSystemVersion, vlanPortEntry=vlanPortEntry, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, SfpsAddress=SfpsAddress, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameVlanName=vlanNameVlanName, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortVlanId=vlanPortVlanId, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemTable=vlanSystemTable, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortTable=vlanPortTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameVlanRule=vlanNameVlanRule, vlanNameVlanId=vlanNameVlanId, HexInteger=HexInteger, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemDomainName=vlanSystemDomainName, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemLastChange=vlanSystemLastChange, vlanNameNHash=vlanNameNHash, vlanNameTable=vlanNameTable, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortPortNum=vlanPortPortNum, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemMibRev=vlanSystemMibRev, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIPort=vlanTestAPIPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortPortStatus=vlanPortPortStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameOperStatus=vlanNameOperStatus, VlanSwitchInstance=VlanSwitchInstance, vlanNameIndex=vlanNameIndex, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, SfpsSwitchPort=SfpsSwitchPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameEntry=vlanNameEntry, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy)
