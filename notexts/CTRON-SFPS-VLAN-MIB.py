...
vlanAPI, vlanAMRSubnets, vlanSystem, vlanCountAPI, vlanTestAPI, vlanPort, vlanAMRStats, vlanAMRRules, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanAMRSubnets", "vlanSystem", "vlanCountAPI", "vlanTestAPI", "vlanPort", "vlanAMRStats", "vlanAMRRules", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameEntry=vlanNameEntry, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortPortNum=vlanPortPortNum, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemEntry=vlanSystemEntry, vlanSystemDomainName=vlanSystemDomainName, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPINvramId=sfpsVAPINvramId, HexInteger=HexInteger, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemMibRev=vlanSystemMibRev, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameVlanName=vlanNameVlanName, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIVlanName=vlanTestAPIVlanName, SfpsAddress=SfpsAddress, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameNumUsers=vlanNameNumUsers, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameStatusTime=vlanNameStatusTime, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortVlanId=vlanPortVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameIndex=vlanNameIndex, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameVlanId=vlanNameVlanId, vlanSystemTable=vlanSystemTable, vlanNameNHash=vlanNameNHash, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortEntry=vlanPortEntry, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanCountAPITotal=vlanCountAPITotal, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemPollCount=vlanSystemPollCount, vlanPortVlanName=vlanPortVlanName, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameTable=vlanNameTable, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortTable=vlanPortTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus)
