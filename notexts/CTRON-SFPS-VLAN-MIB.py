...
vlanSystem, vlanAMRRules, vlanTestAPI, vlanAMRSubnets, vlanCountAPI, vlanName, vlanAMRStats, vlanAPI, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanAMRRules", "vlanTestAPI", "vlanAMRSubnets", "vlanCountAPI", "vlanName", "vlanAMRStats", "vlanAPI", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameNHash=vlanNameNHash, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIVlanName=sfpsVAPIVlanName, VlanSwitchInstance=VlanSwitchInstance, vlanPortEntry=vlanPortEntry, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanCountAPITotal=vlanCountAPITotal, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemMibRev=vlanSystemMibRev, HexInteger=HexInteger, vlanNameStatusTime=vlanNameStatusTime, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameTable=vlanNameTable, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortVlanId=vlanPortVlanId, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemEntry=vlanSystemEntry, vlanPortTable=vlanPortTable, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemVersion=vlanSystemVersion, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemDomainName=vlanSystemDomainName, vlanNameVlanRule=vlanNameVlanRule, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemPollCount=vlanSystemPollCount, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemOperTime=vlanSystemOperTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemLastChange=vlanSystemLastChange, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortPortNum=vlanPortPortNum, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameEntry=vlanNameEntry, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, SfpsAddress=SfpsAddress, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortVlanName=vlanPortVlanName, vlanNameIndex=vlanNameIndex, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortPortStatus=vlanPortPortStatus, vlanNameVlanId=vlanNameVlanId, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemTable=vlanSystemTable, sfpsVAPIVerb=sfpsVAPIVerb, vlanCountAPIAutoreg=vlanCountAPIAutoreg, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameVlanName=vlanNameVlanName, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPINvramId=sfpsVAPINvramId)
