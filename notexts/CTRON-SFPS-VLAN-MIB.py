...
vlanSystem, vlanAMRRules, vlanTestAPI, vlanAMRStats, vlanAMRSubnets, vlanCountAPI, vlanPort, vlanName, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanAMRRules", "vlanTestAPI", "vlanAMRStats", "vlanAMRSubnets", "vlanCountAPI", "vlanPort", "vlanName", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameMappedPorts=vlanNameMappedPorts, vlanNameVlanName=vlanNameVlanName, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIPort=vlanTestAPIPort, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameStatusTime=vlanNameStatusTime, vlanPortTable=vlanPortTable, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameNHash=vlanNameNHash, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameIndex=vlanNameIndex, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemEntry=vlanSystemEntry, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameTable=vlanNameTable, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortPortNum=vlanPortPortNum, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemMibRev=vlanSystemMibRev, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanNameVlanId=vlanNameVlanId, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemPollCount=vlanSystemPollCount, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortRouterPort=vlanPortRouterPort, vlanNameOperStatus=vlanNameOperStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemVersion=vlanSystemVersion, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortFloodPolicy=vlanPortFloodPolicy, HexInteger=HexInteger, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRSubnetsMask=vlanAMRSubnetsMask, SfpsAddress=SfpsAddress, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortVlanName=vlanPortVlanName, vlanPortVlanId=vlanPortVlanId, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanSystemTable=vlanSystemTable)
