...
vlanPort, vlanAMRRules, vlanAMRStats, vlanSystem, vlanAPI, vlanCountAPI, vlanTestAPI, vlanName, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAMRRules", "vlanAMRStats", "vlanSystem", "vlanAPI", "vlanCountAPI", "vlanTestAPI", "vlanName", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemVersion=vlanSystemVersion, SfpsAddress=SfpsAddress, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortVlanName=vlanPortVlanName, vlanSystemEntry=vlanSystemEntry, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameNHash=vlanNameNHash, HexInteger=HexInteger, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameVlanRule=vlanNameVlanRule, vlanPortEntry=vlanPortEntry, vlanPortUniPolicy=vlanPortUniPolicy, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameStatusTime=vlanNameStatusTime, vlanPortTable=vlanPortTable, vlanAMRRulesStatus=vlanAMRRulesStatus, VlanSwitchInstance=VlanSwitchInstance, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameNumUsers=vlanNameNumUsers, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortVlanId=vlanPortVlanId, vlanNameOperStatus=vlanNameOperStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemMibRev=vlanSystemMibRev, vlanNameVlanName=vlanNameVlanName, vlanSystemDomainName=vlanSystemDomainName, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortRouterPort=vlanPortRouterPort, vlanNameEntry=vlanNameEntry, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameVlanId=vlanNameVlanId, vlanNameIndex=vlanNameIndex, vlanSystemTable=vlanSystemTable, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameTable=vlanNameTable, vlanCountAPIAdmin=vlanCountAPIAdmin)
