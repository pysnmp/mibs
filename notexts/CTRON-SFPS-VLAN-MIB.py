...
vlanCountAPI, vlanAMRSubnets, vlanAPI, vlanTestAPI, vlanName, vlanAMRStats, vlanPort, vlanAMRRules, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAMRSubnets", "vlanAPI", "vlanTestAPI", "vlanName", "vlanAMRStats", "vlanPort", "vlanAMRRules", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortVlanId=vlanPortVlanId, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemEntry=vlanSystemEntry, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameRelayAgent=vlanNameRelayAgent, SfpsSwitchPort=SfpsSwitchPort, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortTable=vlanPortTable, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortVlanName=vlanPortVlanName, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameNHash=vlanNameNHash, vlanSystemTable=vlanSystemTable, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemVersion=vlanSystemVersion, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, HexInteger=HexInteger, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, VlanSwitchInstance=VlanSwitchInstance, vlanNameVlanName=vlanNameVlanName, vlanPortEntry=vlanPortEntry, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameOperStatus=vlanNameOperStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortPortNum=vlanPortPortNum, vlanTestAPIPort=vlanTestAPIPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameTable=vlanNameTable, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameVlanId=vlanNameVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameStatusTime=vlanNameStatusTime, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemMibRev=vlanSystemMibRev, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemPollCount=vlanSystemPollCount, vlanNameIndex=vlanNameIndex, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIInPort=sfpsVAPIInPort, SfpsAddress=SfpsAddress, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName)
