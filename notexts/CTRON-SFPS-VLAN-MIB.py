...
vlanAMRStats, vlanPort, vlanAMRRules, vlanCountAPI, vlanAMRSubnets, vlanAPI, vlanSystem, vlanTestAPI, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanPort", "vlanAMRRules", "vlanCountAPI", "vlanAMRSubnets", "vlanAPI", "vlanSystem", "vlanTestAPI", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortPortNum=vlanPortPortNum, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameIndex=vlanNameIndex, VlanSwitchInstance=VlanSwitchInstance, vlanPortVlanName=vlanPortVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortRouterPort=vlanPortRouterPort, vlanNameNumUsers=vlanNameNumUsers, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameEntry=vlanNameEntry, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortEntry=vlanPortEntry, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameNHash=vlanNameNHash, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanCountAPIAdmin=vlanCountAPIAdmin, SfpsAddress=SfpsAddress, vlanPortPortStatus=vlanPortPortStatus, vlanSystemTable=vlanSystemTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, HexInteger=HexInteger, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemLastChange=vlanSystemLastChange, vlanSystemEntry=vlanSystemEntry, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, SfpsSwitchPort=SfpsSwitchPort, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortVlanId=vlanPortVlanId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameTable=vlanNameTable, vlanNameUniPolicy=vlanNameUniPolicy, vlanCountAPITotal=vlanCountAPITotal, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameVlanName=vlanNameVlanName, vlanNameOperStatus=vlanNameOperStatus, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortTable=vlanPortTable, vlanTestAPIVerb=vlanTestAPIVerb, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemOperTime=vlanSystemOperTime, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy)
