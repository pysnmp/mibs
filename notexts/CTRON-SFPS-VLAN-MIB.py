...
vlanAPI, vlanName, vlanPort, vlanTestAPI, vlanCountAPI, vlanAMRStats, vlanAMRRules, vlanAMRSubnets, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanName", "vlanPort", "vlanTestAPI", "vlanCountAPI", "vlanAMRStats", "vlanAMRRules", "vlanAMRSubnets", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, SfpsSwitchPort=SfpsSwitchPort, vlanPortVlanId=vlanPortVlanId, vlanSystemPollCount=vlanSystemPollCount, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameNHash=vlanNameNHash, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameStatusTime=vlanNameStatusTime, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, HexInteger=HexInteger, vlanNameVlanId=vlanNameVlanId, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameIndex=vlanNameIndex, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameNumUsers=vlanNameNumUsers, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIInPort=sfpsVAPIInPort, vlanCountAPITotal=vlanCountAPITotal, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameTable=vlanNameTable, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemAdminStatus=vlanSystemAdminStatus, SfpsAddress=SfpsAddress, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortTable=vlanPortTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameOperStatus=vlanNameOperStatus, vlanSystemVersion=vlanSystemVersion, vlanPortEntry=vlanPortEntry, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputTable=vlanTestAPIOutputTable, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemEntry=vlanSystemEntry, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemLastChange=vlanSystemLastChange, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameEntry=vlanNameEntry, vlanPortRouterPort=vlanPortRouterPort, vlanNameVlanName=vlanNameVlanName, vlanPortPortNum=vlanPortPortNum, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemTable=vlanSystemTable, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortPortPolicy=vlanPortPortPolicy)
