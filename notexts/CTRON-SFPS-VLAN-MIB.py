...
vlanSystem, vlanTestAPI, vlanAPI, vlanPort, vlanAMRSubnets, vlanAMRRules, vlanCountAPI, vlanAMRStats, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanTestAPI", "vlanAPI", "vlanPort", "vlanAMRSubnets", "vlanAMRRules", "vlanCountAPI", "vlanAMRStats", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemLastChange=vlanSystemLastChange, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameIndex=vlanNameIndex, vlanNameAdminStatus=vlanNameAdminStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameEntry=vlanNameEntry, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameStatusTime=vlanNameStatusTime, HexInteger=HexInteger, vlanSystemEntry=vlanSystemEntry, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameVlanRule=vlanNameVlanRule, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortRouterPort=vlanPortRouterPort, vlanPortPortNum=vlanPortPortNum, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortVlanId=vlanPortVlanId, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortVlanName=vlanPortVlanName, vlanPortTable=vlanPortTable, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameNHash=vlanNameNHash, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemAdminReset=vlanSystemAdminReset, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, SfpsAddress=SfpsAddress, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameVlanId=vlanNameVlanId, vlanSystemOperTime=vlanSystemOperTime, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameNumUsers=vlanNameNumUsers, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameTable=vlanNameTable, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameFloodPorts=vlanNameFloodPorts, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRRulesStatus=vlanAMRRulesStatus)
