...
vlanTestAPI, vlanName, vlanAMRSubnets, vlanPort, vlanSystem, vlanAMRStats, vlanAPI, vlanCountAPI, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanName", "vlanAMRSubnets", "vlanPort", "vlanSystem", "vlanAMRStats", "vlanAPI", "vlanCountAPI", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortVlanId=vlanPortVlanId, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortEntry=vlanPortEntry, HexInteger=HexInteger, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameVlanRule=vlanNameVlanRule, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameTable=vlanNameTable, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemTable=vlanSystemTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIOutPort=sfpsVAPIOutPort, VlanSwitchInstance=VlanSwitchInstance, vlanPortPortNum=vlanPortPortNum, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortRouterPort=vlanPortRouterPort, SfpsAddress=SfpsAddress, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameNHash=vlanNameNHash, vlanNameOperStatus=vlanNameOperStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameIndex=vlanNameIndex, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameVlanId=vlanNameVlanId, vlanSystemDomainName=vlanSystemDomainName, vlanNameVlanName=vlanNameVlanName, vlanPortVlanName=vlanPortVlanName, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanCountAPITotal=vlanCountAPITotal, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortTable=vlanPortTable, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemOperTime=vlanSystemOperTime, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemVersion=vlanSystemVersion)
