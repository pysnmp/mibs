...
vlanAMRSubnets, vlanPort, vlanTestAPI, vlanAPI, vlanAMRRules, vlanSystem, vlanCountAPI, vlanName, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanPort", "vlanTestAPI", "vlanAPI", "vlanAMRRules", "vlanSystem", "vlanCountAPI", "vlanName", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortVlanName=vlanPortVlanName, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemTable=vlanSystemTable, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameOperStatus=vlanNameOperStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameNHash=vlanNameNHash, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameVlanName=vlanNameVlanName, SfpsAddress=SfpsAddress, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortTable=vlanPortTable, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameTable=vlanNameTable, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemDomainName=vlanSystemDomainName, vlanSystemEntry=vlanSystemEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRRulesRule=vlanAMRRulesRule, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemLastChange=vlanSystemLastChange, vlanPortPortNum=vlanPortPortNum, sfpsVAPIInPort=sfpsVAPIInPort, VlanSwitchInstance=VlanSwitchInstance, vlanNameIndex=vlanNameIndex, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemVersion=vlanSystemVersion, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameVlanId=vlanNameVlanId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemPollCount=vlanSystemPollCount, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemOperTime=vlanSystemOperTime, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortEntry=vlanPortEntry, vlanNameNumUsers=vlanNameNumUsers, HexInteger=HexInteger, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemMibRev=vlanSystemMibRev, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy)
