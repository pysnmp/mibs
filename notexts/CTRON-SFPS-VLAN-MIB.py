...
vlanName, vlanTestAPI, vlanCountAPI, vlanSystem, vlanPort, vlanAPI, vlanAMRSubnets, vlanAMRStats, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanTestAPI", "vlanCountAPI", "vlanSystem", "vlanPort", "vlanAPI", "vlanAMRSubnets", "vlanAMRStats", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameEntry=vlanNameEntry, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortEntry=vlanPortEntry, vlanPortPortNum=vlanPortPortNum, vlanAMRRulesStatus=vlanAMRRulesStatus, HexInteger=HexInteger, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortTable=vlanPortTable, vlanSystemDomainName=vlanSystemDomainName, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemTable=vlanSystemTable, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemVersion=vlanSystemVersion, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRRulesRule=vlanAMRRulesRule, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortPortStatus=vlanPortPortStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameTable=vlanNameTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortRouterPort=vlanPortRouterPort, vlanPortVlanName=vlanPortVlanName, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, SfpsAddress=SfpsAddress, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameNHash=vlanNameNHash, vlanNameVlanId=vlanNameVlanId, vlanSystemEntry=vlanSystemEntry, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemLastChange=vlanSystemLastChange, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameNumUsers=vlanNameNumUsers, VlanSwitchInstance=VlanSwitchInstance, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemMibRev=vlanSystemMibRev, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameStatusTime=vlanNameStatusTime, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameOperStatus=vlanNameOperStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortVlanId=vlanPortVlanId, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask)
