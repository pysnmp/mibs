...
vlanAMRStats, vlanAMRSubnets, vlanPort, vlanSystem, vlanName, vlanAMRRules, vlanAPI, vlanCountAPI, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanAMRSubnets", "vlanPort", "vlanSystem", "vlanName", "vlanAMRRules", "vlanAPI", "vlanCountAPI", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameVlanId=vlanNameVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIVerb=sfpsVAPIVerb, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemVersion=vlanSystemVersion, vlanNameNumUsers=vlanNameNumUsers, HexInteger=HexInteger, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortVlanId=vlanPortVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortVlanName=vlanPortVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortPortStatus=vlanPortPortStatus, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemTable=vlanSystemTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameTable=vlanNameTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortTable=vlanPortTable, vlanNameStatusTime=vlanNameStatusTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameIndex=vlanNameIndex, VlanSwitchInstance=VlanSwitchInstance, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortEntry=vlanPortEntry, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortRelayAgent=vlanPortRelayAgent, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemOperTime=vlanSystemOperTime, vlanSystemMibRev=vlanSystemMibRev, vlanSystemPollCount=vlanSystemPollCount, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortPortNum=vlanPortPortNum, vlanNameNHash=vlanNameNHash, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameVlanRule=vlanNameVlanRule, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemEntry=vlanSystemEntry, SfpsAddress=SfpsAddress, vlanNameEntry=vlanNameEntry, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort)
