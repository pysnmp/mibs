...
vlanAMRStats, vlanAMRSubnets, vlanAMRRules, vlanAPI, vlanSystem, vlanName, vlanTestAPI, vlanCountAPI, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanAMRSubnets", "vlanAMRRules", "vlanAPI", "vlanSystem", "vlanName", "vlanTestAPI", "vlanCountAPI", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortUniPolicy=vlanPortUniPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortRouterPort=vlanPortRouterPort, vlanPortTable=vlanPortTable, vlanTestAPIPort=vlanTestAPIPort, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortPortNum=vlanPortPortNum, vlanSystemLastChange=vlanSystemLastChange, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemVersion=vlanSystemVersion, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameNHash=vlanNameNHash, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanCountAPITotal=vlanCountAPITotal, vlanNameNumUsers=vlanNameNumUsers, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, SfpsAddress=SfpsAddress, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemTable=vlanSystemTable, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIVerb=vlanTestAPIVerb, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameVlanId=vlanNameVlanId, SfpsSwitchPort=SfpsSwitchPort, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemMibRev=vlanSystemMibRev, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameVlanRule=vlanNameVlanRule, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortVlanId=vlanPortVlanId, vlanNameEntry=vlanNameEntry, vlanNameIndex=vlanNameIndex, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemEntry=vlanSystemEntry, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRRulesTable=vlanAMRRulesTable, HexInteger=HexInteger, vlanNameTable=vlanNameTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortEntry=vlanPortEntry, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortFloodPolicy=vlanPortFloodPolicy)
