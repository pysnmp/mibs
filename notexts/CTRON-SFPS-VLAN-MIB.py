...
vlanTestAPI, vlanAPI, vlanSystem, vlanAMRStats, vlanAMRSubnets, vlanPort, vlanAMRRules, vlanName, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanAPI", "vlanSystem", "vlanAMRStats", "vlanAMRSubnets", "vlanPort", "vlanAMRRules", "vlanName", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIPort=vlanTestAPIPort, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameTable=vlanNameTable, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemEntry=vlanSystemEntry, vlanPortPortStatus=vlanPortPortStatus, vlanNameIndex=vlanNameIndex, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameOperStatus=vlanNameOperStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortVlanId=vlanPortVlanId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIVerb=sfpsVAPIVerb, SfpsAddress=SfpsAddress, vlanSystemOperTime=vlanSystemOperTime, vlanSystemTable=vlanSystemTable, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortPortNum=vlanPortPortNum, vlanNameNHash=vlanNameNHash, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemDomainName=vlanSystemDomainName, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemVersion=vlanSystemVersion, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameNumUsers=vlanNameNumUsers, vlanPortVlanName=vlanPortVlanName, vlanPortTable=vlanPortTable, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemLastChange=vlanSystemLastChange, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemPollCount=vlanSystemPollCount, vlanNameVlanRule=vlanNameVlanRule, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortEntry=vlanPortEntry, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, HexInteger=HexInteger, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortRouterPort=vlanPortRouterPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIInPort=sfpsVAPIInPort, VlanSwitchInstance=VlanSwitchInstance, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameVlanName=vlanNameVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId)
