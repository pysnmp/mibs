...
vlanName, vlanAMRSubnets, vlanAMRRules, vlanPort, vlanAPI, vlanTestAPI, vlanSystem, vlanCountAPI, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanAMRSubnets", "vlanAMRRules", "vlanPort", "vlanAPI", "vlanTestAPI", "vlanSystem", "vlanCountAPI", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameRelayAgent=vlanNameRelayAgent, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameTable=vlanNameTable, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemLastChange=vlanSystemLastChange, SfpsSwitchPort=SfpsSwitchPort, vlanPortTable=vlanPortTable, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIPort=vlanTestAPIPort, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortPortNum=vlanPortPortNum, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, SfpsAddress=SfpsAddress, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameVlanName=vlanNameVlanName, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameNHash=vlanNameNHash, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemVersion=vlanSystemVersion, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemMibRev=vlanSystemMibRev, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameEntry=vlanNameEntry, vlanPortVlanName=vlanPortVlanName, vlanSystemDomainName=vlanSystemDomainName, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemEntry=vlanSystemEntry, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemPollCount=vlanSystemPollCount, vlanNameVlanId=vlanNameVlanId, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameStatusTime=vlanNameStatusTime, HexInteger=HexInteger, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanCountAPITotal=vlanCountAPITotal, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemOperTime=vlanSystemOperTime, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemTable=vlanSystemTable, sfpsVAPIVlanName=sfpsVAPIVlanName, VlanSwitchInstance=VlanSwitchInstance)
