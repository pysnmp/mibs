...
vlanName, vlanSystem, vlanAPI, vlanCountAPI, vlanAMRRules, vlanTestAPI, vlanAMRStats, vlanAMRSubnets, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanSystem", "vlanAPI", "vlanCountAPI", "vlanAMRRules", "vlanTestAPI", "vlanAMRStats", "vlanAMRSubnets", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", SfpsSwitchPort=SfpsSwitchPort, vlanNameOperStatus=vlanNameOperStatus, vlanSystemPollCount=vlanSystemPollCount, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemOperTime=vlanSystemOperTime, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameEntry=vlanNameEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameVlanId=vlanNameVlanId, vlanNameTable=vlanNameTable, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortPortNum=vlanPortPortNum, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIPort=vlanTestAPIPort, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortEntry=vlanPortEntry, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortPortStatus=vlanPortPortStatus, vlanNameVlanRule=vlanNameVlanRule, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortTable=vlanPortTable, vlanNameIndex=vlanNameIndex, SfpsAddress=SfpsAddress, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemLastChange=vlanSystemLastChange, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortVlanName=vlanPortVlanName, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemTable=vlanSystemTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanCountAPIAutoreg=vlanCountAPIAutoreg, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameNumUsers=vlanNameNumUsers, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemEntry=vlanSystemEntry, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemDomainName=vlanSystemDomainName, vlanNameVlanName=vlanNameVlanName, HexInteger=HexInteger, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortVlanId=vlanPortVlanId, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanCountAPITotal=vlanCountAPITotal, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIOutPort=sfpsVAPIOutPort)
