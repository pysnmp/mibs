...
vlanName, vlanAMRStats, vlanAPI, vlanPort, vlanCountAPI, vlanTestAPI, vlanSystem, vlanAMRRules, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanAMRStats", "vlanAPI", "vlanPort", "vlanCountAPI", "vlanTestAPI", "vlanSystem", "vlanAMRRules", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameVlanRule=vlanNameVlanRule, vlanNameTable=vlanNameTable, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameNHash=vlanNameNHash, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIInPort=sfpsVAPIInPort, VlanSwitchInstance=VlanSwitchInstance, vlanNameVlanName=vlanNameVlanName, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, SfpsAddress=SfpsAddress, vlanSystemPollCount=vlanSystemPollCount, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIPort=vlanTestAPIPort, vlanPortVlanId=vlanPortVlanId, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameOperStatus=vlanNameOperStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameIndex=vlanNameIndex, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameEntry=vlanNameEntry, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortTable=vlanPortTable, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameNumUsers=vlanNameNumUsers, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameStatusTime=vlanNameStatusTime, SfpsSwitchPort=SfpsSwitchPort, vlanSystemEntry=vlanSystemEntry, vlanSystemOperTime=vlanSystemOperTime, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemMibRev=vlanSystemMibRev, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortVlanName=vlanPortVlanName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemTable=vlanSystemTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemLastChange=vlanSystemLastChange, vlanSystemDomainName=vlanSystemDomainName, vlanSystemVersion=vlanSystemVersion, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortPortNum=vlanPortPortNum, vlanNameVlanId=vlanNameVlanId, vlanAMRRulesEntry=vlanAMRRulesEntry, HexInteger=HexInteger, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts)
