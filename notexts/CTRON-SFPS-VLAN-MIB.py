...
vlanAMRSubnets, vlanName, vlanPort, vlanTestAPI, vlanAMRRules, vlanSystem, vlanAMRStats, vlanAPI, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanName", "vlanPort", "vlanTestAPI", "vlanAMRRules", "vlanSystem", "vlanAMRStats", "vlanAPI", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemEntry=vlanSystemEntry, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanSystemMibRev=vlanSystemMibRev, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortPortNum=vlanPortPortNum, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameIndex=vlanNameIndex, vlanNameNHash=vlanNameNHash, vlanNameVlanId=vlanNameVlanId, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemTable=vlanSystemTable, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortEntry=vlanPortEntry, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, HexInteger=HexInteger, vlanPortTable=vlanPortTable, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameVlanName=vlanNameVlanName, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortRouterPort=vlanPortRouterPort, vlanNameVlanRule=vlanNameVlanRule, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameEntry=vlanNameEntry, vlanSystemVersion=vlanSystemVersion, vlanNameOperStatus=vlanNameOperStatus, vlanSystemOperTime=vlanSystemOperTime, vlanPortVlanId=vlanPortVlanId, vlanNameTable=vlanNameTable, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortVlanName=vlanPortVlanName, SfpsSwitchPort=SfpsSwitchPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, SfpsAddress=SfpsAddress, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameMappedPorts=vlanNameMappedPorts, vlanCountAPITotal=vlanCountAPITotal)
