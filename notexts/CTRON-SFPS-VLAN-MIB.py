...
vlanTestAPI, vlanAMRRules, vlanAMRStats, vlanName, vlanCountAPI, vlanAMRSubnets, vlanAPI, vlanPort, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanAMRRules", "vlanAMRStats", "vlanName", "vlanCountAPI", "vlanAMRSubnets", "vlanAPI", "vlanPort", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIVlanName=sfpsVAPIVlanName, SfpsAddress=SfpsAddress, vlanSystemTable=vlanSystemTable, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortTable=vlanPortTable, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortEntry=vlanPortEntry, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameOperStatus=vlanNameOperStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortVlanId=vlanPortVlanId, vlanSystemPollCount=vlanSystemPollCount, vlanSystemOperTime=vlanSystemOperTime, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIPort=vlanTestAPIPort, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanNameVlanName=vlanNameVlanName, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameIndex=vlanNameIndex, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemVersion=vlanSystemVersion, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemMibRev=vlanSystemMibRev, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameEntry=vlanNameEntry, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameNHash=vlanNameNHash, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemDomainName=vlanSystemDomainName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemEntry=vlanSystemEntry, SfpsSwitchPort=SfpsSwitchPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortPortNum=vlanPortPortNum, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameVlanId=vlanNameVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortRouterPort=vlanPortRouterPort, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameTable=vlanNameTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, VlanSwitchInstance=VlanSwitchInstance, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, HexInteger=HexInteger, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIVlanId=vlanTestAPIVlanId)
