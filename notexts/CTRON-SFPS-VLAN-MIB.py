...
vlanAPI, vlanAMRSubnets, vlanAMRStats, vlanTestAPI, vlanCountAPI, vlanPort, vlanSystem, vlanAMRRules, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanAMRSubnets", "vlanAMRStats", "vlanTestAPI", "vlanCountAPI", "vlanPort", "vlanSystem", "vlanAMRRules", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameTable=vlanNameTable, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemDomainName=vlanSystemDomainName, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortPortNum=vlanPortPortNum, vlanPortRouterPort=vlanPortRouterPort, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameOperStatus=vlanNameOperStatus, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortVlanId=vlanPortVlanId, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameNumUsers=vlanNameNumUsers, VlanSwitchInstance=VlanSwitchInstance, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemTable=vlanSystemTable, vlanSystemPollCount=vlanSystemPollCount, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanCountAPITotal=vlanCountAPITotal, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, SfpsSwitchPort=SfpsSwitchPort, vlanNameNHash=vlanNameNHash, SfpsAddress=SfpsAddress, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortPortStatus=vlanPortPortStatus, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, HexInteger=HexInteger, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameVlanId=vlanNameVlanId, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameIndex=vlanNameIndex, vlanNameVlanRule=vlanNameVlanRule, vlanSystemEntry=vlanSystemEntry, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortTable=vlanPortTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortEntry=vlanPortEntry, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy)
