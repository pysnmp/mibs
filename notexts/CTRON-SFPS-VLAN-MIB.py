...
vlanCountAPI, vlanAMRRules, vlanAMRSubnets, vlanPort, vlanName, vlanSystem, vlanTestAPI, vlanAPI, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAMRRules", "vlanAMRSubnets", "vlanPort", "vlanName", "vlanSystem", "vlanTestAPI", "vlanAPI", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameOperStatus=vlanNameOperStatus, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortVlanId=vlanPortVlanId, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameVlanName=vlanNameVlanName, vlanPortPortNum=vlanPortPortNum, vlanPortRouterPort=vlanPortRouterPort, vlanPortLayer3Learning=vlanPortLayer3Learning, SfpsAddress=SfpsAddress, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameStatusTime=vlanNameStatusTime, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameTable=vlanNameTable, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemAdminReset=vlanSystemAdminReset, VlanSwitchInstance=VlanSwitchInstance, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIPort=vlanTestAPIPort, vlanPortTable=vlanPortTable, vlanNameNumUsers=vlanNameNumUsers, vlanNameNHash=vlanNameNHash, vlanSystemVersion=vlanSystemVersion, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemEntry=vlanSystemEntry, vlanSystemOperTime=vlanSystemOperTime, vlanSystemDomainName=vlanSystemDomainName, vlanPortVlanName=vlanPortVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputAble=vlanTestAPIOutputAble, HexInteger=HexInteger, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemTable=vlanSystemTable, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortRelayAgent=vlanPortRelayAgent, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameEntry=vlanNameEntry, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortEntry=vlanPortEntry, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIVlanName=sfpsVAPIVlanName, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameIndex=vlanNameIndex, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy)
