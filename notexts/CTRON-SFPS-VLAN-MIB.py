...
vlanSystem, vlanTestAPI, vlanPort, vlanCountAPI, vlanName, vlanAMRSubnets, vlanAMRRules, vlanAPI, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanTestAPI", "vlanPort", "vlanCountAPI", "vlanName", "vlanAMRSubnets", "vlanAMRRules", "vlanAPI", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameStatusTime=vlanNameStatusTime, vlanPortPortStatus=vlanPortPortStatus, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameTable=vlanNameTable, vlanSystemEntry=vlanSystemEntry, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemMibRev=vlanSystemMibRev, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortTable=vlanPortTable, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameRelayAgent=vlanNameRelayAgent, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameEntry=vlanNameEntry, VlanSwitchInstance=VlanSwitchInstance, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, SfpsAddress=SfpsAddress, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortEntry=vlanPortEntry, sfpsVAPINvramId=sfpsVAPINvramId, HexInteger=HexInteger, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemOperTime=vlanSystemOperTime, SfpsSwitchPort=SfpsSwitchPort, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameIndex=vlanNameIndex, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemDomainName=vlanSystemDomainName, vlanSystemVersion=vlanSystemVersion, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortVlanId=vlanPortVlanId, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortRouterPort=vlanPortRouterPort, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameVlanId=vlanNameVlanId, vlanSystemTable=vlanSystemTable, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortPortNum=vlanPortPortNum, vlanCountAPITotal=vlanCountAPITotal, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameNumUsers=vlanNameNumUsers, vlanNameVlanRule=vlanNameVlanRule, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameVlanName=vlanNameVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts)
