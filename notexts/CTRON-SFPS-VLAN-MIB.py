...
vlanName, vlanCountAPI, vlanAMRRules, vlanPort, vlanAPI, vlanAMRStats, vlanAMRSubnets, vlanTestAPI, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanCountAPI", "vlanAMRRules", "vlanPort", "vlanAPI", "vlanAMRStats", "vlanAMRSubnets", "vlanTestAPI", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameNumUsers=vlanNameNumUsers, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortPortStatus=vlanPortPortStatus, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameTable=vlanNameTable, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemEntry=vlanSystemEntry, vlanCountAPITotal=vlanCountAPITotal, vlanPortVlanId=vlanPortVlanId, vlanAMRRulesTable=vlanAMRRulesTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortPortNum=vlanPortPortNum, vlanNameVlanId=vlanNameVlanId, VlanSwitchInstance=VlanSwitchInstance, HexInteger=HexInteger, vlanPortVlanName=vlanPortVlanName, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemTable=vlanSystemTable, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortRouterPort=vlanPortRouterPort, vlanNameEntry=vlanNameEntry, vlanNameVlanRule=vlanNameVlanRule, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemDomainName=vlanSystemDomainName, vlanNameNHash=vlanNameNHash, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, SfpsAddress=SfpsAddress, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemVersion=vlanSystemVersion, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortEntry=vlanPortEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortTable=vlanPortTable, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemPollCount=vlanSystemPollCount, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameOperStatus=vlanNameOperStatus, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning)
