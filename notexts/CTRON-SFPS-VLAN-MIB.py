...
vlanName, vlanPort, vlanSystem, vlanAPI, vlanTestAPI, vlanCountAPI, vlanAMRSubnets, vlanAMRStats, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanPort", "vlanSystem", "vlanAPI", "vlanTestAPI", "vlanCountAPI", "vlanAMRSubnets", "vlanAMRStats", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameVlanName=vlanNameVlanName, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortRelayAgent=vlanPortRelayAgent, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameVlanId=vlanNameVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortEntry=vlanPortEntry, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameTable=vlanNameTable, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, SfpsAddress=SfpsAddress, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameIndex=vlanNameIndex, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameVlanRule=vlanNameVlanRule, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameNHash=vlanNameNHash, vlanPortTable=vlanPortTable, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortVlanId=vlanPortVlanId, vlanNameStatusTime=vlanNameStatusTime, vlanSystemOperTime=vlanSystemOperTime, vlanAMRRulesStatus=vlanAMRRulesStatus, VlanSwitchInstance=VlanSwitchInstance, vlanPortPortStatus=vlanPortPortStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, SfpsSwitchPort=SfpsSwitchPort, vlanPortRouterPort=vlanPortRouterPort, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanCountAPITotal=vlanCountAPITotal, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemDomainName=vlanSystemDomainName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortVlanName=vlanPortVlanName, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemTable=vlanSystemTable, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameAdminStatus=vlanNameAdminStatus, HexInteger=HexInteger, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemEntry=vlanSystemEntry, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt)
