...
vlanCountAPI, vlanAMRSubnets, vlanTestAPI, vlanAMRRules, vlanSystem, vlanAPI, vlanName, vlanPort, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAMRSubnets", "vlanTestAPI", "vlanAMRRules", "vlanSystem", "vlanAPI", "vlanName", "vlanPort", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameRelayAgent=vlanNameRelayAgent, vlanNameTable=vlanNameTable, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemVersion=vlanSystemVersion, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemAdminStatus=vlanSystemAdminStatus, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIVlanName=vlanTestAPIVlanName, SfpsAddress=SfpsAddress, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameStatusTime=vlanNameStatusTime, vlanPortEntry=vlanPortEntry, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemEntry=vlanSystemEntry, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortPortStatus=vlanPortPortStatus, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameVlanId=vlanNameVlanId, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemTable=vlanSystemTable, vlanPortVlanName=vlanPortVlanName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanSystemPollCount=vlanSystemPollCount, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, HexInteger=HexInteger, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemLastChange=vlanSystemLastChange, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIPort=vlanTestAPIPort, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameNHash=vlanNameNHash, vlanSystemDomainName=vlanSystemDomainName, vlanNameNumUsers=vlanNameNumUsers, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortTable=vlanPortTable, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameEntry=vlanNameEntry, vlanNameVlanRule=vlanNameVlanRule, vlanCountAPITotal=vlanCountAPITotal, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameVlanName=vlanNameVlanName, vlanPortVlanId=vlanPortVlanId, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId)
