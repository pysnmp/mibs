...
vlanAMRRules, vlanAMRStats, vlanAMRSubnets, vlanName, vlanPort, vlanSystem, vlanTestAPI, vlanAPI, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanAMRStats", "vlanAMRSubnets", "vlanName", "vlanPort", "vlanSystem", "vlanTestAPI", "vlanAPI", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameNHash=vlanNameNHash, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemTable=vlanSystemTable, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameStatusTime=vlanNameStatusTime, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortPortStatus=vlanPortPortStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameVlanName=vlanNameVlanName, vlanPortTable=vlanPortTable, VlanSwitchInstance=VlanSwitchInstance, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, SfpsAddress=SfpsAddress, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemLastChange=vlanSystemLastChange, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortVlanName=vlanPortVlanName, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameVlanId=vlanNameVlanId, HexInteger=HexInteger, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIPort=vlanTestAPIPort, vlanNameEntry=vlanNameEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemEntry=vlanSystemEntry, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortVlanId=vlanPortVlanId, vlanNameNumUsers=vlanNameNumUsers, vlanSystemOperTime=vlanSystemOperTime, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameTable=vlanNameTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameOperStatus=vlanNameOperStatus, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameIndex=vlanNameIndex, vlanSystemPollCount=vlanSystemPollCount, vlanPortPortNum=vlanPortPortNum, vlanTestAPIVlanName=vlanTestAPIVlanName)
