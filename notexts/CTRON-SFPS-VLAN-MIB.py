...
vlanAMRRules, vlanPort, vlanName, vlanAMRSubnets, vlanAPI, vlanCountAPI, vlanAMRStats, vlanTestAPI, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanPort", "vlanName", "vlanAMRSubnets", "vlanAPI", "vlanCountAPI", "vlanAMRStats", "vlanTestAPI", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIVlanName=vlanTestAPIVlanName, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameNHash=vlanNameNHash, vlanNameIndex=vlanNameIndex, vlanNameTable=vlanNameTable, vlanSystemOperTime=vlanSystemOperTime, vlanSystemVersion=vlanSystemVersion, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortVlanName=vlanPortVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemPriorPollTime=vlanSystemPriorPollTime, SfpsAddress=SfpsAddress, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameUniPolicy=vlanNameUniPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameNumUsers=vlanNameNumUsers, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemEntry=vlanSystemEntry, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameEntry=vlanNameEntry, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortVlanId=vlanPortVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameVlanId=vlanNameVlanId, vlanNameStatusTime=vlanNameStatusTime, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemMibRev=vlanSystemMibRev, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemAgentIP=vlanSystemAgentIP, HexInteger=HexInteger, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortTable=vlanPortTable, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortRouterPort=vlanPortRouterPort, vlanPortPortNum=vlanPortPortNum, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix)
