...
vlanAMRSubnets, vlanAPI, vlanTestAPI, vlanSystem, vlanAMRRules, vlanCountAPI, vlanAMRStats, vlanName, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanAPI", "vlanTestAPI", "vlanSystem", "vlanAMRRules", "vlanCountAPI", "vlanAMRStats", "vlanName", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameVlanRule=vlanNameVlanRule, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameVlanId=vlanNameVlanId, HexInteger=HexInteger, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemDomainName=vlanSystemDomainName, VlanSwitchInstance=VlanSwitchInstance, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanCountAPITotal=vlanCountAPITotal, vlanPortTable=vlanPortTable, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameNHash=vlanNameNHash, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameVlanName=vlanNameVlanName, vlanSystemTable=vlanSystemTable, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameEntry=vlanNameEntry, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameTable=vlanNameTable, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortPortStatus=vlanPortPortStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, SfpsAddress=SfpsAddress, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemMibRev=vlanSystemMibRev, vlanSystemOperTime=vlanSystemOperTime, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameNumUsers=vlanNameNumUsers, vlanNameOperStatus=vlanNameOperStatus, vlanPortEntry=vlanPortEntry, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemEntry=vlanSystemEntry, vlanSystemVersion=vlanSystemVersion, vlanPortVlanId=vlanPortVlanId, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortPortNum=vlanPortPortNum, vlanSystemFirstPollTime=vlanSystemFirstPollTime)
