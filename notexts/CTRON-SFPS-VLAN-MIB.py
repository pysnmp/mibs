...
vlanSystem, vlanTestAPI, vlanAPI, vlanPort, vlanCountAPI, vlanAMRStats, vlanAMRSubnets, vlanName, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanTestAPI", "vlanAPI", "vlanPort", "vlanCountAPI", "vlanAMRStats", "vlanAMRSubnets", "vlanName", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanSystemTable=vlanSystemTable, vlanPortVlanName=vlanPortVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameVlanName=vlanNameVlanName, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemEntry=vlanSystemEntry, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameTable=vlanNameTable, HexInteger=HexInteger, vlanPortVlanId=vlanPortVlanId, vlanSystemDomainName=vlanSystemDomainName, SfpsSwitchPort=SfpsSwitchPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortPortNum=vlanPortPortNum, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanSystemOperTime=vlanSystemOperTime, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameVlanRule=vlanNameVlanRule, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameNumUsers=vlanNameNumUsers, vlanNameIndex=vlanNameIndex, vlanPortTable=vlanPortTable, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameEntry=vlanNameEntry, vlanNameOperStatus=vlanNameOperStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameNHash=vlanNameNHash, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIVlanName=vlanTestAPIVlanName, SfpsAddress=SfpsAddress, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRRulesTable=vlanAMRRulesTable)
