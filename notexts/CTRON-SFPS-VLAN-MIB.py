...
vlanPort, vlanName, vlanSystem, vlanAMRRules, vlanAMRSubnets, vlanTestAPI, vlanAPI, vlanCountAPI, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanName", "vlanSystem", "vlanAMRRules", "vlanAMRSubnets", "vlanTestAPI", "vlanAPI", "vlanCountAPI", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputAble=vlanTestAPIOutputAble, HexInteger=HexInteger, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemDomainName=vlanSystemDomainName, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIInPort=sfpsVAPIInPort, SfpsSwitchPort=SfpsSwitchPort, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIPort=vlanTestAPIPort, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameVlanId=vlanNameVlanId, VlanSwitchInstance=VlanSwitchInstance, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortVlanName=vlanPortVlanName, vlanNameTable=vlanNameTable, vlanSystemTable=vlanSystemTable, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameVlanName=vlanNameVlanName, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemVersion=vlanSystemVersion, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemMibRev=vlanSystemMibRev, vlanCountAPITotal=vlanCountAPITotal, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameIndex=vlanNameIndex, vlanPortVlanId=vlanPortVlanId, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortRouterPort=vlanPortRouterPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameNHash=vlanNameNHash, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemEntry=vlanSystemEntry, vlanSystemPollCount=vlanSystemPollCount, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortEntry=vlanPortEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, SfpsAddress=SfpsAddress, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortPortStatus=vlanPortPortStatus, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortPortNum=vlanPortPortNum, vlanPortTable=vlanPortTable)
