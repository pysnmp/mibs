...
vlanName, vlanAMRSubnets, vlanAMRRules, vlanAMRStats, vlanSystem, vlanTestAPI, vlanPort, vlanCountAPI, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanAMRSubnets", "vlanAMRRules", "vlanAMRStats", "vlanSystem", "vlanTestAPI", "vlanPort", "vlanCountAPI", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameUniPolicy=vlanNameUniPolicy, SfpsAddress=SfpsAddress, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameVlanId=vlanNameVlanId, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameIndex=vlanNameIndex, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemOperTime=vlanSystemOperTime, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRRulesTable=vlanAMRRulesTable, HexInteger=HexInteger, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortPortNum=vlanPortPortNum, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameAdminStatus=vlanNameAdminStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIOutPort=sfpsVAPIOutPort, VlanSwitchInstance=VlanSwitchInstance, vlanNameNumUsers=vlanNameNumUsers, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortTable=vlanPortTable, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortVlanName=vlanPortVlanName, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemMibRev=vlanSystemMibRev, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortEntry=vlanPortEntry, vlanSystemDomainName=vlanSystemDomainName, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameVlanName=vlanNameVlanName, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameTable=vlanNameTable, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameEntry=vlanNameEntry, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortPortStatus=vlanPortPortStatus, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemEntry=vlanSystemEntry, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIPort=vlanTestAPIPort, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameNHash=vlanNameNHash, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameOperStatus=vlanNameOperStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemVersion=vlanSystemVersion, vlanPortRelayAgent=vlanPortRelayAgent)
