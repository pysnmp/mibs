...
vlanAMRRules, vlanAMRSubnets, vlanAPI, vlanCountAPI, vlanPort, vlanSystem, vlanTestAPI, vlanName, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanAMRSubnets", "vlanAPI", "vlanCountAPI", "vlanPort", "vlanSystem", "vlanTestAPI", "vlanName", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameVlanRule=vlanNameVlanRule, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameTable=vlanNameTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameEntry=vlanNameEntry, vlanNameNHash=vlanNameNHash, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortEntry=vlanPortEntry, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemPollCount=vlanSystemPollCount, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortUniPolicy=vlanPortUniPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortTable=vlanPortTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemAgentIP=vlanSystemAgentIP, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemOperTime=vlanSystemOperTime, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameVlanName=vlanNameVlanName, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameUniPolicy=vlanNameUniPolicy, SfpsAddress=SfpsAddress, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameIndex=vlanNameIndex, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemMibRev=vlanSystemMibRev, HexInteger=HexInteger, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameNumUsers=vlanNameNumUsers, vlanPortVlanName=vlanPortVlanName, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemLastChange=vlanSystemLastChange, vlanPortRouterPort=vlanPortRouterPort, vlanSystemVersion=vlanSystemVersion, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameOperStatus=vlanNameOperStatus, vlanCountAPITotal=vlanCountAPITotal, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortVlanId=vlanPortVlanId, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemTable=vlanSystemTable, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortLayer3Learning=vlanPortLayer3Learning)
