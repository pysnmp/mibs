...
vlanAMRRules, vlanSystem, vlanAMRStats, vlanPort, vlanAMRSubnets, vlanName, vlanTestAPI, vlanAPI, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanSystem", "vlanAMRStats", "vlanPort", "vlanAMRSubnets", "vlanName", "vlanTestAPI", "vlanAPI", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortPortStatus=vlanPortPortStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemDomainName=vlanSystemDomainName, vlanPortPortNum=vlanPortPortNum, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameIndex=vlanNameIndex, vlanSystemVersion=vlanSystemVersion, HexInteger=HexInteger, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortEntry=vlanPortEntry, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemTable=vlanSystemTable, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanNameEntry=vlanNameEntry, vlanNameVlanRule=vlanNameVlanRule, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortRouterPort=vlanPortRouterPort, vlanPortVlanName=vlanPortVlanName, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemOperTime=vlanSystemOperTime, vlanPortTable=vlanPortTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, SfpsAddress=SfpsAddress, vlanSystemLastChange=vlanSystemLastChange, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameNumUsers=vlanNameNumUsers, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameTable=vlanNameTable, vlanPortVlanId=vlanPortVlanId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIPort=vlanTestAPIPort, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameVlanId=vlanNameVlanId, VlanSwitchInstance=VlanSwitchInstance)
