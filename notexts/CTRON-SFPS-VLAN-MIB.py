...
vlanSystem, vlanAMRStats, vlanAPI, vlanPort, vlanCountAPI, vlanAMRRules, vlanTestAPI, vlanAMRSubnets, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanAMRStats", "vlanAPI", "vlanPort", "vlanCountAPI", "vlanAMRRules", "vlanTestAPI", "vlanAMRSubnets", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortVlanName=vlanPortVlanName, vlanTestAPIVerb=vlanTestAPIVerb, HexInteger=HexInteger, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemEntry=vlanSystemEntry, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemVersion=vlanSystemVersion, SfpsSwitchPort=SfpsSwitchPort, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameVlanId=vlanNameVlanId, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortEntry=vlanPortEntry, vlanPortPortNum=vlanPortPortNum, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameEntry=vlanNameEntry, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemLastChange=vlanSystemLastChange, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortRouterPort=vlanPortRouterPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemOperTime=vlanSystemOperTime, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemTable=vlanSystemTable, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameVlanName=vlanNameVlanName, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, SfpsAddress=SfpsAddress, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameStatusTime=vlanNameStatusTime, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemPollCount=vlanSystemPollCount, vlanNameTable=vlanNameTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemMibRev=vlanSystemMibRev, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemDomainName=vlanSystemDomainName, vlanNameOperStatus=vlanNameOperStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameNHash=vlanNameNHash, vlanPortTable=vlanPortTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, VlanSwitchInstance=VlanSwitchInstance, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameVlanRule=vlanNameVlanRule, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameIndex=vlanNameIndex, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameAdminStatus=vlanNameAdminStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy)
