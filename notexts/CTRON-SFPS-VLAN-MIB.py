...
vlanPort, vlanTestAPI, vlanAMRRules, vlanCountAPI, vlanAMRSubnets, vlanAPI, vlanName, vlanAMRStats, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanTestAPI", "vlanAMRRules", "vlanCountAPI", "vlanAMRSubnets", "vlanAPI", "vlanName", "vlanAMRStats", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIInPort=sfpsVAPIInPort, vlanNameEntry=vlanNameEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortEntry=vlanPortEntry, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemEntry=vlanSystemEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameVlanName=vlanNameVlanName, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIPort=vlanTestAPIPort, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRRulesTable=vlanAMRRulesTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, HexInteger=HexInteger, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemOperTime=vlanSystemOperTime, vlanPortTable=vlanPortTable, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRRulesEntry=vlanAMRRulesEntry, VlanSwitchInstance=VlanSwitchInstance, vlanPortVlanName=vlanPortVlanName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameNHash=vlanNameNHash, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortRouterPort=vlanPortRouterPort, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortUniPolicy=vlanPortUniPolicy, vlanCountAPITotal=vlanCountAPITotal, vlanNameTable=vlanNameTable, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortVlanId=vlanPortVlanId, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, SfpsAddress=SfpsAddress, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameOperStatus=vlanNameOperStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemTable=vlanSystemTable, vlanNameNumUsers=vlanNameNumUsers, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemMibRev=vlanSystemMibRev, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameVlanId=vlanNameVlanId, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanNameIndex=vlanNameIndex, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortPortPolicy=vlanPortPortPolicy)
