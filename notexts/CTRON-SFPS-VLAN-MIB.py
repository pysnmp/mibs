...
vlanAMRRules, vlanAPI, vlanCountAPI, vlanName, vlanSystem, vlanAMRStats, vlanPort, vlanTestAPI, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanAPI", "vlanCountAPI", "vlanName", "vlanSystem", "vlanAMRStats", "vlanPort", "vlanTestAPI", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanCountAPITotal=vlanCountAPITotal, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameIndex=vlanNameIndex, vlanNameStatusTime=vlanNameStatusTime, vlanPortTable=vlanPortTable, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameEntry=vlanNameEntry, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameTable=vlanNameTable, sfpsVAPIOutPort=sfpsVAPIOutPort, SfpsAddress=SfpsAddress, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemOperTime=vlanSystemOperTime, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemVersion=vlanSystemVersion, vlanNameVlanName=vlanNameVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIPort=vlanTestAPIPort, vlanNameOperStatus=vlanNameOperStatus, VlanSwitchInstance=VlanSwitchInstance, vlanNameVlanId=vlanNameVlanId, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortVlanName=vlanPortVlanName, vlanSystemDomainName=vlanSystemDomainName, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemMibRev=vlanSystemMibRev, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameNHash=vlanNameNHash, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemPollCount=vlanSystemPollCount, vlanPortVlanId=vlanPortVlanId, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortPortNum=vlanPortPortNum, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemEntry=vlanSystemEntry, vlanSystemLastChange=vlanSystemLastChange, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortEntry=vlanPortEntry, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortPortPolicy=vlanPortPortPolicy, HexInteger=HexInteger, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemTable=vlanSystemTable)
