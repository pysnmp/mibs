...
vlanSystem, vlanTestAPI, vlanAMRStats, vlanName, vlanAPI, vlanAMRSubnets, vlanCountAPI, vlanAMRRules, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanTestAPI", "vlanAMRStats", "vlanName", "vlanAPI", "vlanAMRSubnets", "vlanCountAPI", "vlanAMRRules", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameEntry=vlanNameEntry, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameVlanName=vlanNameVlanName, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameMappedPorts=vlanNameMappedPorts, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameNumUsers=vlanNameNumUsers, vlanPortTable=vlanPortTable, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameVlanId=vlanNameVlanId, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemPollCount=vlanSystemPollCount, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemOperStatus=vlanSystemOperStatus, vlanCountAPITotal=vlanCountAPITotal, vlanNameTable=vlanNameTable, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameIndex=vlanNameIndex, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemTable=vlanSystemTable, vlanNameNHash=vlanNameNHash, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemMibRev=vlanSystemMibRev, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIPort=vlanTestAPIPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortEntry=vlanPortEntry, vlanSystemVersion=vlanSystemVersion, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, HexInteger=HexInteger, vlanPortVlanId=vlanPortVlanId, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortPortNum=vlanPortPortNum, VlanSwitchInstance=VlanSwitchInstance, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameVlanRule=vlanNameVlanRule, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortUniPolicy=vlanPortUniPolicy, SfpsAddress=SfpsAddress, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemEntry=vlanSystemEntry, vlanSystemAgentIP=vlanSystemAgentIP)
