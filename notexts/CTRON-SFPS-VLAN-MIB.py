...
vlanAMRRules, vlanSystem, vlanName, vlanPort, vlanCountAPI, vlanTestAPI, vlanAMRStats, vlanAPI, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanSystem", "vlanName", "vlanPort", "vlanCountAPI", "vlanTestAPI", "vlanAMRStats", "vlanAPI", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemVersion=vlanSystemVersion, vlanPortPortNum=vlanPortPortNum, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIInPort=sfpsVAPIInPort, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameNHash=vlanNameNHash, SfpsAddress=SfpsAddress, vlanPortTable=vlanPortTable, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortVlanId=vlanPortVlanId, vlanSystemTable=vlanSystemTable, vlanPortVlanName=vlanPortVlanName, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameVlanName=vlanNameVlanName, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameStatusTime=vlanNameStatusTime, vlanNameIndex=vlanNameIndex, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanCountAPITotal=vlanCountAPITotal, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemLastChange=vlanSystemLastChange, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIPort=vlanTestAPIPort, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameEntry=vlanNameEntry, vlanPortEntry=vlanPortEntry, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemOperTime=vlanSystemOperTime, vlanSystemLastPollTime=vlanSystemLastPollTime, SfpsSwitchPort=SfpsSwitchPort, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameOperStatus=vlanNameOperStatus, vlanSystemEntry=vlanSystemEntry, vlanNameTable=vlanNameTable, vlanNameNumUsers=vlanNameNumUsers, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameVlanRule=vlanNameVlanRule, vlanSystemPollCount=vlanSystemPollCount, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemDomainName=vlanSystemDomainName, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, HexInteger=HexInteger, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemSwitchInstance=vlanSystemSwitchInstance)
