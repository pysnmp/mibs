...
vlanAMRSubnets, vlanPort, vlanAPI, vlanTestAPI, vlanCountAPI, vlanSystem, vlanAMRStats, vlanAMRRules, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanPort", "vlanAPI", "vlanTestAPI", "vlanCountAPI", "vlanSystem", "vlanAMRStats", "vlanAMRRules", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameNHash=vlanNameNHash, vlanNameStatusTime=vlanNameStatusTime, HexInteger=HexInteger, sfpsVAPIVlanName=sfpsVAPIVlanName, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameNumUsers=vlanNameNumUsers, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemTable=vlanSystemTable, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortPortNum=vlanPortPortNum, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortTable=vlanPortTable, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameEntry=vlanNameEntry, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameVlanId=vlanNameVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortVlanName=vlanPortVlanName, vlanSystemEntry=vlanSystemEntry, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameTable=vlanNameTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortRouterPort=vlanPortRouterPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortPortStatus=vlanPortPortStatus, vlanNameVlanName=vlanNameVlanName, vlanSystemPollCount=vlanSystemPollCount, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, SfpsAddress=SfpsAddress, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortVlanId=vlanPortVlanId, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemVersion=vlanSystemVersion, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemDomainName=vlanSystemDomainName, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanCountAPITotal=vlanCountAPITotal, vlanSystemMibRev=vlanSystemMibRev, vlanPortEntry=vlanPortEntry, vlanSystemLastPollTime=vlanSystemLastPollTime)
