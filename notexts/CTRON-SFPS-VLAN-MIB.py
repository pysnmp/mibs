...
vlanPort, vlanAMRRules, vlanCountAPI, vlanSystem, vlanName, vlanAMRSubnets, vlanTestAPI, vlanAMRStats, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAMRRules", "vlanCountAPI", "vlanSystem", "vlanName", "vlanAMRSubnets", "vlanTestAPI", "vlanAMRStats", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameVlanRule=vlanNameVlanRule, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortEntry=vlanPortEntry, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortVlanName=vlanPortVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameOperStatus=vlanNameOperStatus, vlanSystemEntry=vlanSystemEntry, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameEntry=vlanNameEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameTable=vlanNameTable, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortVlanId=vlanPortVlanId, vlanPortTable=vlanPortTable, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameVlanName=vlanNameVlanName, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameNHash=vlanNameNHash, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameMappedPorts=vlanNameMappedPorts, HexInteger=HexInteger, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameNumUsers=vlanNameNumUsers, SfpsAddress=SfpsAddress, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemVersion=vlanSystemVersion, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIPort=vlanTestAPIPort, vlanPortPortNum=vlanPortPortNum, vlanSystemTable=vlanSystemTable, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputTap=vlanTestAPIOutputTap, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameIndex=vlanNameIndex, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemPollCount=vlanSystemPollCount, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortRouterPort=vlanPortRouterPort, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameVlanId=vlanNameVlanId, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemDomainName=vlanSystemDomainName, VlanSwitchInstance=VlanSwitchInstance)
