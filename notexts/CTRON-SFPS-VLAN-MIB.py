...
vlanAMRSubnets, vlanAPI, vlanPort, vlanCountAPI, vlanSystem, vlanTestAPI, vlanAMRRules, vlanName, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanAPI", "vlanPort", "vlanCountAPI", "vlanSystem", "vlanTestAPI", "vlanAMRRules", "vlanName", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIPort=vlanTestAPIPort, vlanNameIndex=vlanNameIndex, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameStatusTime=vlanNameStatusTime, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIVerb=sfpsVAPIVerb, SfpsSwitchPort=SfpsSwitchPort, vlanPortEntry=vlanPortEntry, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortPortNum=vlanPortPortNum, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameOperStatus=vlanNameOperStatus, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPINvramId=sfpsVAPINvramId, HexInteger=HexInteger, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortVlanName=vlanPortVlanName, vlanSystemOperTime=vlanSystemOperTime, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameVlanRule=vlanNameVlanRule, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameVlanId=vlanNameVlanId, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameVlanName=vlanNameVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameTable=vlanNameTable, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanCountAPITotal=vlanCountAPITotal, vlanNameEntry=vlanNameEntry, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameNHash=vlanNameNHash, vlanPortTable=vlanPortTable, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemTable=vlanSystemTable, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, SfpsAddress=SfpsAddress, vlanSystemVersion=vlanSystemVersion, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemOperStatus=vlanSystemOperStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemEntry=vlanSystemEntry, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRSubnetsMask=vlanAMRSubnetsMask, VlanSwitchInstance=VlanSwitchInstance, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortVlanId=vlanPortVlanId, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask)
