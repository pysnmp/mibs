...
vlanAMRStats, vlanAPI, vlanCountAPI, vlanPort, vlanAMRRules, vlanName, vlanAMRSubnets, vlanTestAPI, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanAPI", "vlanCountAPI", "vlanPort", "vlanAMRRules", "vlanName", "vlanAMRSubnets", "vlanTestAPI", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", SfpsAddress=SfpsAddress, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemDomainName=vlanSystemDomainName, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, HexInteger=HexInteger, vlanNameVlanId=vlanNameVlanId, VlanSwitchInstance=VlanSwitchInstance, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortEntry=vlanPortEntry, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameOperStatus=vlanNameOperStatus, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortPortNum=vlanPortPortNum, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemEntry=vlanSystemEntry, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortVlanId=vlanPortVlanId, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortTable=vlanPortTable, vlanNameEntry=vlanNameEntry, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortPortStatus=vlanPortPortStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortVlanName=vlanPortVlanName, vlanSystemVersion=vlanSystemVersion, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameIndex=vlanNameIndex, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameVlanRule=vlanNameVlanRule, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, SfpsSwitchPort=SfpsSwitchPort, vlanCountAPITotal=vlanCountAPITotal, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameStatusTime=vlanNameStatusTime, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameTable=vlanNameTable, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemMibRev=vlanSystemMibRev, vlanPortRouterPort=vlanPortRouterPort)
