...
vlanPort, vlanCountAPI, vlanName, vlanAMRStats, vlanAPI, vlanAMRRules, vlanAMRSubnets, vlanTestAPI, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanCountAPI", "vlanName", "vlanAMRStats", "vlanAPI", "vlanAMRRules", "vlanAMRSubnets", "vlanTestAPI", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortVlanName=vlanPortVlanName, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, SfpsAddress=SfpsAddress, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIVerb=sfpsVAPIVerb, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortRouterPort=vlanPortRouterPort, vlanNameIndex=vlanNameIndex, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemOperTime=vlanSystemOperTime, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortPortNum=vlanPortPortNum, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemMibRev=vlanSystemMibRev, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortEntry=vlanPortEntry, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemVersion=vlanSystemVersion, vlanNameVlanName=vlanNameVlanName, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameFloodPolicy=vlanNameFloodPolicy, HexInteger=HexInteger, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameStatusTime=vlanNameStatusTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameNumUsers=vlanNameNumUsers, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameNHash=vlanNameNHash, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameFloodPorts=vlanNameFloodPorts, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameTable=vlanNameTable, vlanSystemPollCount=vlanSystemPollCount, vlanNameVlanRule=vlanNameVlanRule, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortTable=vlanPortTable, vlanSystemEntry=vlanSystemEntry, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, SfpsSwitchPort=SfpsSwitchPort, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameVlanId=vlanNameVlanId, vlanNameEntry=vlanNameEntry, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameMappedPorts=vlanNameMappedPorts)
