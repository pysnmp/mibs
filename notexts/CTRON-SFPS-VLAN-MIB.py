...
vlanName, vlanAMRRules, vlanAMRSubnets, vlanTestAPI, vlanSystem, vlanPort, vlanCountAPI, vlanAPI, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanAMRRules", "vlanAMRSubnets", "vlanTestAPI", "vlanSystem", "vlanPort", "vlanCountAPI", "vlanAPI", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortPortStatus=vlanPortPortStatus, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameNHash=vlanNameNHash, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameOperStatus=vlanNameOperStatus, vlanNameVlanRule=vlanNameVlanRule, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortEntry=vlanPortEntry, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameStatusTime=vlanNameStatusTime, SfpsAddress=SfpsAddress, vlanSystemMibRev=vlanSystemMibRev, VlanSwitchInstance=VlanSwitchInstance, vlanSystemEntry=vlanSystemEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameEntry=vlanNameEntry, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputMap=vlanTestAPIOutputMap, HexInteger=HexInteger, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemLastChange=vlanSystemLastChange, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemVersion=vlanSystemVersion, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanNameNumUsers=vlanNameNumUsers, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIPort=vlanTestAPIPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemOperTime=vlanSystemOperTime, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemPollCount=vlanSystemPollCount, vlanNameIndex=vlanNameIndex, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameTable=vlanNameTable, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemDomainName=vlanSystemDomainName, vlanSystemTable=vlanSystemTable, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortRelayAgent=vlanPortRelayAgent, vlanCountAPITotal=vlanCountAPITotal, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameVlanId=vlanNameVlanId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortVlanName=vlanPortVlanName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameVlanName=vlanNameVlanName, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortTable=vlanPortTable)
