...
vlanCountAPI, vlanTestAPI, vlanAPI, vlanPort, vlanName, vlanAMRRules, vlanAMRSubnets, vlanAMRStats, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanTestAPI", "vlanAPI", "vlanPort", "vlanName", "vlanAMRRules", "vlanAMRSubnets", "vlanAMRStats", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameEntry=vlanNameEntry, vlanNameVlanId=vlanNameVlanId, SfpsAddress=SfpsAddress, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameNHash=vlanNameNHash, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemDomainName=vlanSystemDomainName, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortTable=vlanPortTable, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, HexInteger=HexInteger, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortEntry=vlanPortEntry, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemTable=vlanSystemTable, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameOperStatus=vlanNameOperStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameVlanRule=vlanNameVlanRule, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemPollCount=vlanSystemPollCount, vlanSystemMibRev=vlanSystemMibRev, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortVlanId=vlanPortVlanId, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameIndex=vlanNameIndex, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemEntry=vlanSystemEntry, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameTable=vlanNameTable, vlanNameNumUsers=vlanNameNumUsers, vlanPortPortNum=vlanPortPortNum, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemLastChange=vlanSystemLastChange, vlanPortVlanName=vlanPortVlanName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemVersion=vlanSystemVersion, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIPort=vlanTestAPIPort)
