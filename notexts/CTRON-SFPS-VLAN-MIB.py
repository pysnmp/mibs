...
vlanTestAPI, vlanCountAPI, vlanAMRRules, vlanAPI, vlanAMRStats, vlanAMRSubnets, vlanName, vlanPort, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanCountAPI", "vlanAMRRules", "vlanAPI", "vlanAMRStats", "vlanAMRSubnets", "vlanName", "vlanPort", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortRelayAgent=vlanPortRelayAgent, SfpsAddress=SfpsAddress, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanSystemMibRev=vlanSystemMibRev, vlanPortEntry=vlanPortEntry, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemPollCount=vlanSystemPollCount, vlanSystemOperTime=vlanSystemOperTime, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortTable=vlanPortTable, vlanNameNHash=vlanNameNHash, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, HexInteger=HexInteger, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameStatusTime=vlanNameStatusTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameVlanName=vlanNameVlanName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameEntry=vlanNameEntry, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, SfpsSwitchPort=SfpsSwitchPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortVlanId=vlanPortVlanId, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameVlanRule=vlanNameVlanRule, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortPortNum=vlanPortPortNum, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemTable=vlanSystemTable, vlanNameVlanId=vlanNameVlanId, vlanSystemVersion=vlanSystemVersion, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemLastChange=vlanSystemLastChange, vlanNameTable=vlanNameTable, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortVlanName=vlanPortVlanName, VlanSwitchInstance=VlanSwitchInstance, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameIndex=vlanNameIndex, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy)
