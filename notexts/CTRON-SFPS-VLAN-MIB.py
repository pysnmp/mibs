...
vlanTestAPI, vlanAPI, vlanCountAPI, vlanPort, vlanAMRSubnets, vlanSystem, vlanName, vlanAMRRules, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanAPI", "vlanCountAPI", "vlanPort", "vlanAMRSubnets", "vlanSystem", "vlanName", "vlanAMRRules", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIPort=vlanTestAPIPort, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemMibRev=vlanSystemMibRev, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemOperStatus=vlanSystemOperStatus, SfpsAddress=SfpsAddress, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemEntry=vlanSystemEntry, vlanNameOperStatus=vlanNameOperStatus, vlanPortPortStatus=vlanPortPortStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameIndex=vlanNameIndex, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanCountAPITotal=vlanCountAPITotal, vlanPortTable=vlanPortTable, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameNHash=vlanNameNHash, HexInteger=HexInteger, vlanNameEntry=vlanNameEntry, vlanSystemVersion=vlanSystemVersion, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortEntry=vlanPortEntry, vlanSystemTable=vlanSystemTable, vlanSystemLastChange=vlanSystemLastChange, vlanSystemOperTime=vlanSystemOperTime, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameVlanName=vlanNameVlanName, vlanPortPortPolicy=vlanPortPortPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortPortNum=vlanPortPortNum, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortVlanId=vlanPortVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameVlanRule=vlanNameVlanRule, vlanPortVlanName=vlanPortVlanName, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameTable=vlanNameTable, vlanSystemPollCount=vlanSystemPollCount, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPINvramId=sfpsVAPINvramId)
