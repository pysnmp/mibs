...
vlanPort, vlanAMRSubnets, vlanName, vlanAMRRules, vlanSystem, vlanCountAPI, vlanAMRStats, vlanAPI, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAMRSubnets", "vlanName", "vlanAMRRules", "vlanSystem", "vlanCountAPI", "vlanAMRStats", "vlanAPI", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameStatusTime=vlanNameStatusTime, SfpsAddress=SfpsAddress, vlanSystemEntry=vlanSystemEntry, vlanSystemTable=vlanSystemTable, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortTable=vlanPortTable, vlanPortVlanName=vlanPortVlanName, vlanNameEntry=vlanNameEntry, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameIndex=vlanNameIndex, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, SfpsSwitchPort=SfpsSwitchPort, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanPortVlanId=vlanPortVlanId, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanCountAPITotal=vlanCountAPITotal, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortRelayAgent=vlanPortRelayAgent, HexInteger=HexInteger, vlanNameVlanName=vlanNameVlanName, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameNumUsers=vlanNameNumUsers, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortPortNum=vlanPortPortNum, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemDomainName=vlanSystemDomainName, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemMibRev=vlanSystemMibRev, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameNHash=vlanNameNHash, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemVersion=vlanSystemVersion, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameTable=vlanNameTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortPortStatus=vlanPortPortStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameVlanId=vlanNameVlanId)
