...
vlanTestAPI, vlanSystem, vlanAMRStats, vlanCountAPI, vlanAPI, vlanAMRRules, vlanName, vlanPort, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanSystem", "vlanAMRStats", "vlanCountAPI", "vlanAPI", "vlanAMRRules", "vlanName", "vlanPort", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameTable=vlanNameTable, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortPortStatus=vlanPortPortStatus, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemVersion=vlanSystemVersion, vlanNameEntry=vlanNameEntry, vlanPortTable=vlanPortTable, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemEntry=vlanSystemEntry, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, SfpsSwitchPort=SfpsSwitchPort, vlanPortPortNum=vlanPortPortNum, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemOperTime=vlanSystemOperTime, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputTap=vlanTestAPIOutputTap, VlanSwitchInstance=VlanSwitchInstance, vlanSystemLastChange=vlanSystemLastChange, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanCountAPITotal=vlanCountAPITotal, vlanPortEntry=vlanPortEntry, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemPollCount=vlanSystemPollCount, vlanNameNHash=vlanNameNHash, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameVlanName=vlanNameVlanName, vlanPortUniPolicy=vlanPortUniPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemDomainName=vlanSystemDomainName, vlanNameVlanId=vlanNameVlanId, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortVlanId=vlanPortVlanId, SfpsAddress=SfpsAddress, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameIndex=vlanNameIndex, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameVlanRule=vlanNameVlanRule, HexInteger=HexInteger, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemTable=vlanSystemTable, sfpsVAPIVlanId=sfpsVAPIVlanId)
