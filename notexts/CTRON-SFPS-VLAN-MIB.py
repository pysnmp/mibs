...
vlanAMRRules, vlanAMRStats, vlanAMRSubnets, vlanName, vlanAPI, vlanCountAPI, vlanSystem, vlanTestAPI, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanAMRStats", "vlanAMRSubnets", "vlanName", "vlanAPI", "vlanCountAPI", "vlanSystem", "vlanTestAPI", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortVlanId=vlanPortVlanId, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemVersion=vlanSystemVersion, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortEntry=vlanPortEntry, vlanNameOperStatus=vlanNameOperStatus, vlanSystemTable=vlanSystemTable, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemLastChange=vlanSystemLastChange, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameEnabledPorts=vlanNameEnabledPorts, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortTable=vlanPortTable, vlanCountAPITotal=vlanCountAPITotal, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortVlanName=vlanPortVlanName, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameVlanId=vlanNameVlanId, vlanNameVlanRule=vlanNameVlanRule, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameIndex=vlanNameIndex, SfpsAddress=SfpsAddress, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameTable=vlanNameTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameNHash=vlanNameNHash, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRRulesStatus=vlanAMRRulesStatus, SfpsSwitchPort=SfpsSwitchPort, vlanNameVlanName=vlanNameVlanName, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameEntry=vlanNameEntry, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIVerb=vlanTestAPIVerb, HexInteger=HexInteger, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortPortNum=vlanPortPortNum, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemOperTime=vlanSystemOperTime, vlanSystemPollCount=vlanSystemPollCount, vlanSystemAgentIP=vlanSystemAgentIP)
