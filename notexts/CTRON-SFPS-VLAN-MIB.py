...
vlanTestAPI, vlanCountAPI, vlanAMRSubnets, vlanName, vlanSystem, vlanPort, vlanAMRRules, vlanAPI, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanCountAPI", "vlanAMRSubnets", "vlanName", "vlanSystem", "vlanPort", "vlanAMRRules", "vlanAPI", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIVerb=sfpsVAPIVerb, vlanCountAPITotal=vlanCountAPITotal, vlanNameVlanName=vlanNameVlanName, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameOperStatus=vlanNameOperStatus, HexInteger=HexInteger, vlanSystemPollCount=vlanSystemPollCount, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIPort=vlanTestAPIPort, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameStatusTime=vlanNameStatusTime, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemDomainName=vlanSystemDomainName, vlanNameIndex=vlanNameIndex, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortPortNum=vlanPortPortNum, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameNumUsers=vlanNameNumUsers, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortPortStatus=vlanPortPortStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortRelayAgent=vlanPortRelayAgent, SfpsSwitchPort=SfpsSwitchPort, vlanSystemTable=vlanSystemTable, vlanNameEntry=vlanNameEntry, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanCountAPIAdmin=vlanCountAPIAdmin, SfpsAddress=SfpsAddress, vlanSystemMibRev=vlanSystemMibRev, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameTable=vlanNameTable, vlanSystemVersion=vlanSystemVersion, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemEntry=vlanSystemEntry, vlanPortAdminStatus=vlanPortAdminStatus, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortTable=vlanPortTable, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortVlanId=vlanPortVlanId, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameNHash=vlanNameNHash, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortVlanName=vlanPortVlanName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortFloodPolicy=vlanPortFloodPolicy)
