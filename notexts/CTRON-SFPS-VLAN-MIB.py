...
vlanSystem, vlanTestAPI, vlanName, vlanAMRRules, vlanAMRSubnets, vlanCountAPI, vlanPort, vlanAMRStats, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanTestAPI", "vlanName", "vlanAMRRules", "vlanAMRSubnets", "vlanCountAPI", "vlanPort", "vlanAMRStats", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemLastChange=vlanSystemLastChange, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameIndex=vlanNameIndex, vlanNameVlanName=vlanNameVlanName, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortTable=vlanPortTable, vlanSystemPollCount=vlanSystemPollCount, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameTable=vlanNameTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanCountAPITotal=vlanCountAPITotal, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemEntry=vlanSystemEntry, vlanAMRRulesStatus=vlanAMRRulesStatus, SfpsAddress=SfpsAddress, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameVlanRule=vlanNameVlanRule, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortPortStatus=vlanPortPortStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortEntry=vlanPortEntry, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameNHash=vlanNameNHash, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIUserAlias=sfpsVAPIUserAlias, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputTable=vlanTestAPIOutputTable, SfpsSwitchPort=SfpsSwitchPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, HexInteger=HexInteger, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortRouterPort=vlanPortRouterPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemVersion=vlanSystemVersion, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemMibRev=vlanSystemMibRev, vlanSystemTable=vlanSystemTable, vlanNameNumUsers=vlanNameNumUsers, vlanNameVlanId=vlanNameVlanId, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanNameEntry=vlanNameEntry, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortVlanName=vlanPortVlanName, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIPort=vlanTestAPIPort, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortVlanId=vlanPortVlanId, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortPortNum=vlanPortPortNum)
