...
vlanTestAPI, vlanAMRRules, vlanSystem, vlanName, vlanAMRSubnets, vlanCountAPI, vlanAPI, vlanPort, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanAMRRules", "vlanSystem", "vlanName", "vlanAMRSubnets", "vlanCountAPI", "vlanAPI", "vlanPort", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", HexInteger=HexInteger, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameTable=vlanNameTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameVlanRule=vlanNameVlanRule, vlanSystemMibRev=vlanSystemMibRev, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameNumUsers=vlanNameNumUsers, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortRouterPort=vlanPortRouterPort, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemLastChange=vlanSystemLastChange, vlanSystemPollCount=vlanSystemPollCount, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameNHash=vlanNameNHash, vlanSystemEntry=vlanSystemEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemTable=vlanSystemTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIVerb=vlanTestAPIVerb, VlanSwitchInstance=VlanSwitchInstance, SfpsSwitchPort=SfpsSwitchPort, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortVlanId=vlanPortVlanId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameVlanName=vlanNameVlanName, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemVersion=vlanSystemVersion, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortEntry=vlanPortEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortTable=vlanPortTable, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortPortNum=vlanPortPortNum, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameEntry=vlanNameEntry, vlanPortVlanName=vlanPortVlanName, SfpsAddress=SfpsAddress, vlanNameVlanId=vlanNameVlanId, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIPort=vlanTestAPIPort)
