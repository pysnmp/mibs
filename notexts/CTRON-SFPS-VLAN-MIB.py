...
vlanPort, vlanAMRStats, vlanCountAPI, vlanTestAPI, vlanAMRSubnets, vlanName, vlanAPI, vlanSystem, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAMRStats", "vlanCountAPI", "vlanTestAPI", "vlanAMRSubnets", "vlanName", "vlanAPI", "vlanSystem", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, SfpsSwitchPort=SfpsSwitchPort, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemEntry=vlanSystemEntry, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameTable=vlanNameTable, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortAdminStatus=vlanPortAdminStatus, HexInteger=HexInteger, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemTable=vlanSystemTable, vlanPortRouterPort=vlanPortRouterPort, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemDomainName=vlanSystemDomainName, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIPort=vlanTestAPIPort, vlanNameVlanName=vlanNameVlanName, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortPortStatus=vlanPortPortStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameOperStatus=vlanNameOperStatus, vlanNameVlanRule=vlanNameVlanRule, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortPortNum=vlanPortPortNum, vlanSystemLastChange=vlanSystemLastChange, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortVlanName=vlanPortVlanName, vlanCountAPITotal=vlanCountAPITotal, vlanPortVlanId=vlanPortVlanId, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameNHash=vlanNameNHash, vlanPortTable=vlanPortTable, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameFloodPorts=vlanNameFloodPorts, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortEntry=vlanPortEntry, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemOperStatus=vlanSystemOperStatus, SfpsAddress=SfpsAddress, vlanSystemOperTime=vlanSystemOperTime, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameEntry=vlanNameEntry, vlanNameIndex=vlanNameIndex, vlanNameVlanId=vlanNameVlanId, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputTable=vlanTestAPIOutputTable)
