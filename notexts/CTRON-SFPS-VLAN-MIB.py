...
vlanPort, vlanSystem, vlanAMRSubnets, vlanName, vlanAMRRules, vlanCountAPI, vlanTestAPI, vlanAPI, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanSystem", "vlanAMRSubnets", "vlanName", "vlanAMRRules", "vlanCountAPI", "vlanTestAPI", "vlanAPI", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameIndex=vlanNameIndex, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortVlanId=vlanPortVlanId, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameOperStatus=vlanNameOperStatus, vlanSystemVersion=vlanSystemVersion, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameVlanName=vlanNameVlanName, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, SfpsSwitchPort=SfpsSwitchPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortTable=vlanPortTable, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortVlanName=vlanPortVlanName, vlanPortEntry=vlanPortEntry, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameStatusTime=vlanNameStatusTime, vlanNameEntry=vlanNameEntry, vlanNameNHash=vlanNameNHash, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, HexInteger=HexInteger, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemDomainName=vlanSystemDomainName, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortPortNum=vlanPortPortNum, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemLastChange=vlanSystemLastChange, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameTable=vlanNameTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, VlanSwitchInstance=VlanSwitchInstance, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanCountAPITotal=vlanCountAPITotal, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemPollCount=vlanSystemPollCount, SfpsAddress=SfpsAddress, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameVlanId=vlanNameVlanId, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortRouterPort=vlanPortRouterPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameNumUsers=vlanNameNumUsers, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameUniPolicy=vlanNameUniPolicy)
