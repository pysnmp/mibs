...
vlanTestAPI, vlanPort, vlanName, vlanCountAPI, vlanAMRSubnets, vlanAMRStats, vlanAMRRules, vlanSystem, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanPort", "vlanName", "vlanCountAPI", "vlanAMRSubnets", "vlanAMRStats", "vlanAMRRules", "vlanSystem", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemVersion=vlanSystemVersion, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameTable=vlanNameTable, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortVlanId=vlanPortVlanId, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortVlanName=vlanPortVlanName, vlanNameVlanName=vlanNameVlanName, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortTable=vlanPortTable, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIVlanId=sfpsVAPIVlanId, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemEntry=vlanSystemEntry, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputAble=vlanTestAPIOutputAble, HexInteger=HexInteger, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameEntry=vlanNameEntry, vlanNameMappedPorts=vlanNameMappedPorts, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanNameIndex=vlanNameIndex, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemMibRev=vlanSystemMibRev, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameNumUsers=vlanNameNumUsers, vlanSystemTable=vlanSystemTable, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameNHash=vlanNameNHash, vlanPortEntry=vlanPortEntry, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameVlanId=vlanNameVlanId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortPortNum=vlanPortPortNum, SfpsAddress=SfpsAddress, vlanPortRouterPort=vlanPortRouterPort, vlanSystemAdminReset=vlanSystemAdminReset)
