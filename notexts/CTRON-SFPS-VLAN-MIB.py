...
vlanAMRStats, vlanAPI, vlanTestAPI, vlanSystem, vlanCountAPI, vlanAMRSubnets, vlanName, vlanPort, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanAPI", "vlanTestAPI", "vlanSystem", "vlanCountAPI", "vlanAMRSubnets", "vlanName", "vlanPort", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, SfpsAddress=SfpsAddress, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameVlanName=vlanNameVlanName, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIPort=vlanTestAPIPort, vlanNameVlanId=vlanNameVlanId, vlanNameIndex=vlanNameIndex, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortTable=vlanPortTable, vlanSystemTable=vlanSystemTable, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameEntry=vlanNameEntry, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameRelayAgent=vlanNameRelayAgent, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameNumUsers=vlanNameNumUsers, vlanSystemLastChange=vlanSystemLastChange, vlanPortVlanName=vlanPortVlanName, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortVlanId=vlanPortVlanId, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemOperTime=vlanSystemOperTime, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameTable=vlanNameTable, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, HexInteger=HexInteger, vlanNameNHash=vlanNameNHash, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemEntry=vlanSystemEntry, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortPortNum=vlanPortPortNum, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameOperStatus=vlanNameOperStatus, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanSystemVersion=vlanSystemVersion, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortEntry=vlanPortEntry, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemSwitchInstance=vlanSystemSwitchInstance, VlanSwitchInstance=VlanSwitchInstance, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortAdminStatus=vlanPortAdminStatus)
