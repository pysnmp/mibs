...
vlanPort, vlanAMRSubnets, vlanAPI, vlanAMRRules, vlanCountAPI, vlanSystem, vlanAMRStats, vlanTestAPI, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAMRSubnets", "vlanAPI", "vlanAMRRules", "vlanCountAPI", "vlanSystem", "vlanAMRStats", "vlanTestAPI", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIInPort=sfpsVAPIInPort, vlanPortTable=vlanPortTable, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemDomainName=vlanSystemDomainName, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, VlanSwitchInstance=VlanSwitchInstance, HexInteger=HexInteger, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameVlanName=vlanNameVlanName, vlanSystemMibRev=vlanSystemMibRev, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanCountAPITotal=vlanCountAPITotal, vlanNameOperStatus=vlanNameOperStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortVlanId=vlanPortVlanId, vlanSystemEntry=vlanSystemEntry, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortRouterPort=vlanPortRouterPort, vlanSystemTable=vlanSystemTable, vlanSystemVersion=vlanSystemVersion, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameVlanId=vlanNameVlanId, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortPortStatus=vlanPortPortStatus, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanNameEntry=vlanNameEntry, SfpsAddress=SfpsAddress, vlanNameNHash=vlanNameNHash, vlanTestAPIPort=vlanTestAPIPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameTable=vlanNameTable, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortEntry=vlanPortEntry, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemOperTime=vlanSystemOperTime, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortPortNum=vlanPortPortNum, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameIndex=vlanNameIndex)
