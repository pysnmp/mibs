...
vlanCountAPI, vlanAPI, vlanAMRRules, vlanName, vlanPort, vlanTestAPI, vlanSystem, vlanAMRStats, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAPI", "vlanAMRRules", "vlanName", "vlanPort", "vlanTestAPI", "vlanSystem", "vlanAMRStats", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemTable=vlanSystemTable, vlanNameNumUsers=vlanNameNumUsers, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemOperStatus=vlanSystemOperStatus, VlanSwitchInstance=VlanSwitchInstance, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemVersion=vlanSystemVersion, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameIndex=vlanNameIndex, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortPortNum=vlanPortPortNum, vlanCountAPITotal=vlanCountAPITotal, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, HexInteger=HexInteger, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemOperTime=vlanSystemOperTime, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortTable=vlanPortTable, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameVlanName=vlanNameVlanName, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameStatusTime=vlanNameStatusTime, vlanSystemLastChange=vlanSystemLastChange, vlanSystemMibRev=vlanSystemMibRev, vlanNameTable=vlanNameTable, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, SfpsAddress=SfpsAddress, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameOperStatus=vlanNameOperStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameNHash=vlanNameNHash, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortVlanId=vlanPortVlanId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortVlanName=vlanPortVlanName, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortEntry=vlanPortEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemEntry=vlanSystemEntry, vlanNameVlanId=vlanNameVlanId, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIPort=vlanTestAPIPort, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIOutPort=sfpsVAPIOutPort)
