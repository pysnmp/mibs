...
vlanTestAPI, vlanCountAPI, vlanAMRStats, vlanAMRSubnets, vlanAMRRules, vlanAPI, vlanPort, vlanSystem, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanCountAPI", "vlanAMRStats", "vlanAMRSubnets", "vlanAMRRules", "vlanAPI", "vlanPort", "vlanSystem", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameEntry=vlanNameEntry, vlanSystemAdminReset=vlanSystemAdminReset, vlanCountAPITotal=vlanCountAPITotal, vlanSystemMibRev=vlanSystemMibRev, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRRulesTable=vlanAMRRulesTable, SfpsAddress=SfpsAddress, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameNumUsers=vlanNameNumUsers, vlanNameTable=vlanNameTable, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemTable=vlanSystemTable, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameVlanId=vlanNameVlanId, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemVersion=vlanSystemVersion, vlanNameVlanName=vlanNameVlanName, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortEntry=vlanPortEntry, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameIndex=vlanNameIndex, vlanPortPortNum=vlanPortPortNum, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameVlanRule=vlanNameVlanRule, vlanSystemDomainName=vlanSystemDomainName, SfpsSwitchPort=SfpsSwitchPort, vlanPortTable=vlanPortTable, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, HexInteger=HexInteger, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemPollCount=vlanSystemPollCount, vlanPortRouterPort=vlanPortRouterPort, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameNHash=vlanNameNHash, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemEntry=vlanSystemEntry, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRRulesStatus=vlanAMRRulesStatus)
