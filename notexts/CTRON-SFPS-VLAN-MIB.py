...
vlanTestAPI, vlanAMRStats, vlanAMRSubnets, vlanSystem, vlanPort, vlanCountAPI, vlanAMRRules, vlanAPI, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanAMRStats", "vlanAMRSubnets", "vlanSystem", "vlanPort", "vlanCountAPI", "vlanAMRRules", "vlanAPI", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortPortPolicy=vlanPortPortPolicy, vlanCountAPITotal=vlanCountAPITotal, vlanNameNumUsers=vlanNameNumUsers, vlanSystemTable=vlanSystemTable, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortRouterPort=vlanPortRouterPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemEntry=vlanSystemEntry, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameEntry=vlanNameEntry, vlanPortEntry=vlanPortEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIVlanName=sfpsVAPIVlanName, SfpsAddress=SfpsAddress, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortPortStatus=vlanPortPortStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameVlanRule=vlanNameVlanRule, vlanNameTable=vlanNameTable, vlanSystemLastChange=vlanSystemLastChange, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortVlanId=vlanPortVlanId, HexInteger=HexInteger, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemVersion=vlanSystemVersion, vlanSystemMibRev=vlanSystemMibRev, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortPortNum=vlanPortPortNum, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameIndex=vlanNameIndex, vlanNameOperStatus=vlanNameOperStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputAble=vlanTestAPIOutputAble, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIPort=vlanTestAPIPort, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortTable=vlanPortTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameVlanId=vlanNameVlanId, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemOperTime=vlanSystemOperTime, vlanNameVlanName=vlanNameVlanName, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortVlanName=vlanPortVlanName, vlanNameStatusTime=vlanNameStatusTime, vlanNameRelayAgent=vlanNameRelayAgent, SfpsSwitchPort=SfpsSwitchPort)
