...
vlanAMRSubnets, vlanAMRStats, vlanName, vlanCountAPI, vlanSystem, vlanTestAPI, vlanAPI, vlanAMRRules, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanAMRStats", "vlanName", "vlanCountAPI", "vlanSystem", "vlanTestAPI", "vlanAPI", "vlanAMRRules", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortEntry=vlanPortEntry, vlanSystemDomainName=vlanSystemDomainName, vlanPortRouterPort=vlanPortRouterPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameVlanId=vlanNameVlanId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameEntry=vlanNameEntry, vlanNameTable=vlanNameTable, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameVlanRule=vlanNameVlanRule, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemVersion=vlanSystemVersion, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, HexInteger=HexInteger, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemMibRev=vlanSystemMibRev, vlanNameVlanName=vlanNameVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, SfpsAddress=SfpsAddress, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanCountAPITotal=vlanCountAPITotal, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortPortNum=vlanPortPortNum, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortTable=vlanPortTable, vlanPortVlanId=vlanPortVlanId, vlanNameIndex=vlanNameIndex, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemLastChange=vlanSystemLastChange, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameNHash=vlanNameNHash, vlanPortVlanName=vlanPortVlanName, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemPollCount=vlanSystemPollCount, vlanSystemTable=vlanSystemTable, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameOperStatus=vlanNameOperStatus, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameFloodPorts=vlanNameFloodPorts)
