...
vlanSystem, vlanName, vlanCountAPI, vlanAMRStats, vlanAMRSubnets, vlanAMRRules, vlanAPI, vlanTestAPI, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanName", "vlanCountAPI", "vlanAMRStats", "vlanAMRSubnets", "vlanAMRRules", "vlanAPI", "vlanTestAPI", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemMibRev=vlanSystemMibRev, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortVlanId=vlanPortVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameVlanId=vlanNameVlanId, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemTable=vlanSystemTable, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIPort=vlanTestAPIPort, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameNHash=vlanNameNHash, vlanPortEntry=vlanPortEntry, vlanSystemOperTime=vlanSystemOperTime, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemEntry=vlanSystemEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIVlanId=vlanTestAPIVlanId, VlanSwitchInstance=VlanSwitchInstance, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemVersion=vlanSystemVersion, vlanNameEntry=vlanNameEntry, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameTable=vlanNameTable, vlanPortRouterPort=vlanPortRouterPort, vlanPortPortStatus=vlanPortPortStatus, vlanNameIndex=vlanNameIndex, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortVlanName=vlanPortVlanName, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIVlanName=sfpsVAPIVlanName, SfpsAddress=SfpsAddress, vlanCountAPITotal=vlanCountAPITotal, vlanNameVlanName=vlanNameVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameNumUsers=vlanNameNumUsers, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameVlanRule=vlanNameVlanRule, vlanSystemDomainName=vlanSystemDomainName, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRRulesTable=vlanAMRRulesTable, SfpsSwitchPort=SfpsSwitchPort, HexInteger=HexInteger, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortPortNum=vlanPortPortNum, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortTable=vlanPortTable, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortAdminStatus=vlanPortAdminStatus)
