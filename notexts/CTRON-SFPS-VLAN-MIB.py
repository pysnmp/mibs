...
vlanAMRSubnets, vlanSystem, vlanAMRRules, vlanName, vlanCountAPI, vlanTestAPI, vlanAPI, vlanAMRStats, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanSystem", "vlanAMRRules", "vlanName", "vlanCountAPI", "vlanTestAPI", "vlanAPI", "vlanAMRStats", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemMibRev=vlanSystemMibRev, vlanNameVlanId=vlanNameVlanId, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemLastChange=vlanSystemLastChange, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortEntry=vlanPortEntry, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortVlanName=vlanPortVlanName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, VlanSwitchInstance=VlanSwitchInstance, SfpsAddress=SfpsAddress, vlanSystemOperTime=vlanSystemOperTime, vlanSystemEntry=vlanSystemEntry, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanPortPortStatus=vlanPortPortStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanSystemTable=vlanSystemTable, vlanPortTable=vlanPortTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameIndex=vlanNameIndex, vlanPortVlanId=vlanPortVlanId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameEntry=vlanNameEntry, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortRouterPort=vlanPortRouterPort, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemVersion=vlanSystemVersion, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemAdminStatus=vlanSystemAdminStatus, SfpsSwitchPort=SfpsSwitchPort, vlanNameEnabledPorts=vlanNameEnabledPorts, HexInteger=HexInteger, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameNumUsers=vlanNameNumUsers, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameTable=vlanNameTable, vlanSystemPollCount=vlanSystemPollCount, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameOperStatus=vlanNameOperStatus, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortPortNum=vlanPortPortNum, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus)
