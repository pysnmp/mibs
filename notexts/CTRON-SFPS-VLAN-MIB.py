...
vlanSystem, vlanName, vlanAMRStats, vlanCountAPI, vlanAPI, vlanAMRSubnets, vlanPort, vlanAMRRules, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanName", "vlanAMRStats", "vlanCountAPI", "vlanAPI", "vlanAMRSubnets", "vlanPort", "vlanAMRRules", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemPollCount=vlanSystemPollCount, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortEntry=vlanPortEntry, vlanNameNumUsers=vlanNameNumUsers, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, SfpsAddress=SfpsAddress, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemTable=vlanSystemTable, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemDomainName=vlanSystemDomainName, vlanNameVlanId=vlanNameVlanId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputTable=vlanTestAPIOutputTable, VlanSwitchInstance=VlanSwitchInstance, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortVlanId=vlanPortVlanId, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortRouterPort=vlanPortRouterPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIPort=vlanTestAPIPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, SfpsSwitchPort=SfpsSwitchPort, vlanNameEntry=vlanNameEntry, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameTable=vlanNameTable, vlanSystemMibRev=vlanSystemMibRev, vlanNameNHash=vlanNameNHash, vlanPortTable=vlanPortTable, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameIndex=vlanNameIndex, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortPortNum=vlanPortPortNum, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemOperTime=vlanSystemOperTime, vlanSystemVersion=vlanSystemVersion, HexInteger=HexInteger, vlanNameStatusTime=vlanNameStatusTime, vlanSystemEntry=vlanSystemEntry, vlanNameVlanName=vlanNameVlanName, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemLastChange=vlanSystemLastChange, vlanNameOperStatus=vlanNameOperStatus)
