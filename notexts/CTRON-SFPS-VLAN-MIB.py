...
vlanAMRRules, vlanCountAPI, vlanTestAPI, vlanAMRSubnets, vlanPort, vlanName, vlanSystem, vlanAPI, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanCountAPI", "vlanTestAPI", "vlanAMRSubnets", "vlanPort", "vlanName", "vlanSystem", "vlanAPI", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortVlanId=vlanPortVlanId, vlanNameOperStatus=vlanNameOperStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameAdminStatus=vlanNameAdminStatus, HexInteger=HexInteger, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemOperTime=vlanSystemOperTime, vlanSystemDomainName=vlanSystemDomainName, vlanSystemTable=vlanSystemTable, vlanSystemPollCount=vlanSystemPollCount, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemEntry=vlanSystemEntry, vlanNameTable=vlanNameTable, vlanSystemMibRev=vlanSystemMibRev, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameEntry=vlanNameEntry, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameStatusTime=vlanNameStatusTime, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortRelayAgent=vlanPortRelayAgent, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortTable=vlanPortTable, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemVersion=vlanSystemVersion, vlanNameVlanName=vlanNameVlanName, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortVlanName=vlanPortVlanName, vlanPortEntry=vlanPortEntry, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameNumUsers=vlanNameNumUsers, vlanNameNHash=vlanNameNHash, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortPortNum=vlanPortPortNum, SfpsAddress=SfpsAddress, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanCountAPITotal=vlanCountAPITotal, vlanNameVlanRule=vlanNameVlanRule, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag)
