...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMDiskRemoved=dcxSMDiskRemoved, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMObjects=dcxSMObjects, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxDxmStatusState=dcxDxmStatusState, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxDxmObjects=dcxDxmObjects, dcxSMBootDevice=dcxSMBootDevice, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxIpdrGroup=dcxIpdrGroup, dcxSMBootHostname=dcxSMBootHostname, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMBootPassword=dcxSMBootPassword, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxIpdrFileName=dcxIpdrFileName, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMRebootAction=dcxSMRebootAction, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxIpdrEnable=dcxIpdrEnable, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMDiskInserted=dcxSMDiskInserted, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMBootPath=dcxSMBootPath, dcxSMDiskFailed=dcxSMDiskFailed, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMBootUsername=dcxSMBootUsername, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMBootGroup=dcxSMBootGroup, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxDxmStatusPort=dcxDxmStatusPort)
