...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusState=dcxDxmStatusState, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxIpdrGroup=dcxIpdrGroup, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxDxmObjects=dcxDxmObjects, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMBootDevice=dcxSMBootDevice, dcxIpdrEnable=dcxIpdrEnable, dcxSMDownloadDevice=dcxSMDownloadDevice, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMBootHostname=dcxSMBootHostname, dcxSMBootPassword=dcxSMBootPassword, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxIpdrFileName=dcxIpdrFileName, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMObjects=dcxSMObjects, dcxSMBootUsername=dcxSMBootUsername, dcxSMBootPath=dcxSMBootPath, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMTrapGroup=dcxSMTrapGroup, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMRebootAction=dcxSMRebootAction, dcxSMBootGroup=dcxSMBootGroup, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMConfigFileDate=dcxSMConfigFileDate, cmtsC3SMMIB=cmtsC3SMMIB)
