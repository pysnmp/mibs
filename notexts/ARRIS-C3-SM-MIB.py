...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMDownloadPath=dcxSMDownloadPath, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMBootHostname=dcxSMBootHostname, dcxSMBootUsername=dcxSMBootUsername, dcxSMBootDevice=dcxSMBootDevice, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMDownloadControl=dcxSMDownloadControl, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxIpdrFileName=dcxIpdrFileName, dcxSMObjects=dcxSMObjects, dcxSMBootPath=dcxSMBootPath, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMBootPassword=dcxSMBootPassword, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxDxmStatusPort=dcxDxmStatusPort, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxIpdrGroup=dcxIpdrGroup, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxIpdrEnable=dcxIpdrEnable, dcxSMTrapGroup=dcxSMTrapGroup, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxDxmObjects=dcxDxmObjects, dcxSMRebootAction=dcxSMRebootAction, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMBootGroup=dcxSMBootGroup, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmStatusState=dcxDxmStatusState, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum)
