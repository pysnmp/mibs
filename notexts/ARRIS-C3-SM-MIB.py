...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMBootGroup=dcxSMBootGroup, dcxSMBootPassword=dcxSMBootPassword, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMTrapGroup=dcxSMTrapGroup, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxDxmStatusState=dcxDxmStatusState, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMBootHostname=dcxSMBootHostname, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMRebootAction=dcxSMRebootAction, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxDxmObjects=dcxDxmObjects, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMBootDevice=dcxSMBootDevice, dcxSMBootUsername=dcxSMBootUsername, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMObjects=dcxSMObjects, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMBootPath=dcxSMBootPath, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxIpdrGroup=dcxIpdrGroup, dcxIpdrEnable=dcxIpdrEnable, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMDownloadHostname=dcxSMDownloadHostname)
