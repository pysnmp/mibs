...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMRebootAction=dcxSMRebootAction, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMBootPath=dcxSMBootPath, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMBootHostname=dcxSMBootHostname, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMBootDevice=dcxSMBootDevice, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMDownloadPath=dcxSMDownloadPath, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxIpdrFileName=dcxIpdrFileName, dcxSMDiskInserted=dcxSMDiskInserted, dcxDxmStatusState=dcxDxmStatusState, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMBootUsername=dcxSMBootUsername, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMBootGroup=dcxSMBootGroup, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxIpdrEnable=dcxIpdrEnable, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMSoftwareIndex=dcxSMSoftwareIndex, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxDxmObjects=dcxDxmObjects, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxIpdrGroup=dcxIpdrGroup, dcxSMObjects=dcxSMObjects, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMBootPassword=dcxSMBootPassword)
