...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMBootDevice=dcxSMBootDevice, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMBootUsername=dcxSMBootUsername, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, cmtsC3SMMIB=cmtsC3SMMIB, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMBootPassword=dcxSMBootPassword, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMBootPath=dcxSMBootPath, dcxDxmObjects=dcxDxmObjects, dcxDxmStatusState=dcxDxmStatusState, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMBootGroup=dcxSMBootGroup, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusPort=dcxDxmStatusPort, dcxIpdrEnable=dcxIpdrEnable, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMObjects=dcxSMObjects, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxIpdrGroup=dcxIpdrGroup, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxDxmStatusEnable=dcxDxmStatusEnable, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMRebootAction=dcxSMRebootAction, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMBootHostname=dcxSMBootHostname, dcxSMDiskInserted=dcxSMDiskInserted)
