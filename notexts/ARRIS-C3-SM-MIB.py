...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMDownloadPath=dcxSMDownloadPath, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMBootPath=dcxSMBootPath, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxIpdrEnable=dcxIpdrEnable, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMBootHostname=dcxSMBootHostname, dcxSMRebootAction=dcxSMRebootAction, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxDxmStatusPort=dcxDxmStatusPort, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxDxmObjects=dcxDxmObjects, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMObjects=dcxSMObjects, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMBootGroup=dcxSMBootGroup, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMTrapGroup=dcxSMTrapGroup, dcxDxmStatusState=dcxDxmStatusState, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxIpdrGroup=dcxIpdrGroup, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMBootUsername=dcxSMBootUsername, dcxSMBootPassword=dcxSMBootPassword, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMBootDevice=dcxSMBootDevice, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMConfigFileIndex=dcxSMConfigFileIndex)
