...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxIpdrFileName=dcxIpdrFileName, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxDxmObjects=dcxDxmObjects, dcxSMBootDevice=dcxSMBootDevice, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMDiskFailed=dcxSMDiskFailed, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxIpdrGroup=dcxIpdrGroup, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMBootPassword=dcxSMBootPassword, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMBootPath=dcxSMBootPath, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMBootHostname=dcxSMBootHostname, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxIpdrEnable=dcxIpdrEnable, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxDxmStatusRole=dcxDxmStatusRole, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMRebootAction=dcxSMRebootAction, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMObjects=dcxSMObjects, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMBootGroup=dcxSMBootGroup, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMBootUsername=dcxSMBootUsername, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, cmtsC3SMMIB=cmtsC3SMMIB, dcxDxmStatusState=dcxDxmStatusState, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername)
