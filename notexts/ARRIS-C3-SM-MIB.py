...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMBootUsername=dcxSMBootUsername, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMRebootAction=dcxSMRebootAction, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxDxmObjects=dcxDxmObjects, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMDownloadControl=dcxSMDownloadControl, dcxDxmStatusState=dcxDxmStatusState, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMDiskInserted=dcxSMDiskInserted, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMBootHostname=dcxSMBootHostname, cmtsC3SMMIB=cmtsC3SMMIB, dcxIpdrGroup=dcxIpdrGroup, dcxDxmStatusRole=dcxDxmStatusRole, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMBootGroup=dcxSMBootGroup, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMBootPath=dcxSMBootPath, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxIpdrEnable=dcxIpdrEnable, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMTrapGroup=dcxSMTrapGroup, dcxIpdrFileName=dcxIpdrFileName, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMBootDevice=dcxSMBootDevice, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMObjects=dcxSMObjects, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMBootPassword=dcxSMBootPassword, dcxSMConfigFileDesc=dcxSMConfigFileDesc)
