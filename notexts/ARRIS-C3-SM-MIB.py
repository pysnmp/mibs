...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxDxmStatusEnable=dcxDxmStatusEnable, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMBootUsername=dcxSMBootUsername, dcxDxmStatusRole=dcxDxmStatusRole, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMBootGroup=dcxSMBootGroup, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMRebootAction=dcxSMRebootAction, dcxSMBootPath=dcxSMBootPath, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMSoftwareListTable=dcxSMSoftwareListTable, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxIpdrGroup=dcxIpdrGroup, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxDxmStatusState=dcxDxmStatusState, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxIpdrFileName=dcxIpdrFileName, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMDownloadPath=dcxSMDownloadPath, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMBootPassword=dcxSMBootPassword, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMObjects=dcxSMObjects, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxIpdrEnable=dcxIpdrEnable, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMBootDevice=dcxSMBootDevice, dcxDxmObjects=dcxDxmObjects, dcxSMBootHostname=dcxSMBootHostname, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged)
