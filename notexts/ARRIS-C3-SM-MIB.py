...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMObjects=dcxSMObjects, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMBootDevice=dcxSMBootDevice, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMBootGroup=dcxSMBootGroup, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMDiskFailed=dcxSMDiskFailed, dcxDxmStatusPort=dcxDxmStatusPort, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxIpdrEnable=dcxIpdrEnable, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMBootPassword=dcxSMBootPassword, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, cmtsC3SMMIB=cmtsC3SMMIB, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxDxmStatusState=dcxDxmStatusState, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMDiskInserted=dcxSMDiskInserted, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMBootHostname=dcxSMBootHostname, dcxSMRebootAction=dcxSMRebootAction, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMBootUsername=dcxSMBootUsername, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMBootPath=dcxSMBootPath, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmObjects=dcxDxmObjects, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxIpdrGroup=dcxIpdrGroup)
