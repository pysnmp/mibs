...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxDxmObjects=dcxDxmObjects, dcxSMBootUsername=dcxSMBootUsername, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxIpdrEnable=dcxIpdrEnable, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMBootPath=dcxSMBootPath, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxDxmStatusState=dcxDxmStatusState, dcxSMBootPassword=dcxSMBootPassword, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMRebootAction=dcxSMRebootAction, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxIpdrFileName=dcxIpdrFileName, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMBootGroup=dcxSMBootGroup, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxIpdrGroup=dcxIpdrGroup, dcxDxmStatusPort=dcxDxmStatusPort, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMBootHostname=dcxSMBootHostname, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMBootDevice=dcxSMBootDevice, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMObjects=dcxSMObjects, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxDxmStatusEnable=dcxDxmStatusEnable, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMTrapGroup=dcxSMTrapGroup)
