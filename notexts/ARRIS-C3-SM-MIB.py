...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMDiskInserted=dcxSMDiskInserted, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMBootPath=dcxSMBootPath, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMRebootAction=dcxSMRebootAction, dcxSMTrapGroup=dcxSMTrapGroup, dcxIpdrEnable=dcxIpdrEnable, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMObjects=dcxSMObjects, dcxSMBootGroup=dcxSMBootGroup, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxDxmObjects=dcxDxmObjects, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxDxmStatusPort=dcxDxmStatusPort, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxIpdrGroup=dcxIpdrGroup, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMBootDevice=dcxSMBootDevice, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMBootUsername=dcxSMBootUsername, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMBootPassword=dcxSMBootPassword, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMBootHostname=dcxSMBootHostname, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxDxmStatusState=dcxDxmStatusState, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigFileGroup=dcxSMConfigFileGroup)
