...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMBootHostname=dcxSMBootHostname, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMBootGroup=dcxSMBootGroup, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxIpdrEnable=dcxIpdrEnable, dcxSMDiskInserted=dcxSMDiskInserted, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMBootDevice=dcxSMBootDevice, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMDownloadPath=dcxSMDownloadPath, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMBootPassword=dcxSMBootPassword, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMDownloadStatus=dcxSMDownloadStatus, cmtsC3SMMIB=cmtsC3SMMIB, dcxDxmStatusState=dcxDxmStatusState, dcxSMDownloadControl=dcxSMDownloadControl, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMBootPath=dcxSMBootPath, dcxSMBootUsername=dcxSMBootUsername, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxDxmObjects=dcxDxmObjects, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxIpdrFileName=dcxIpdrFileName, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMRebootAction=dcxSMRebootAction, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMObjects=dcxSMObjects, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxIpdrGroup=dcxIpdrGroup, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged)
