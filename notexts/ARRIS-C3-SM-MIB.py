...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMRebootAction=dcxSMRebootAction, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMTrapGroup=dcxSMTrapGroup, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxDxmStatusState=dcxDxmStatusState, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMDownloadGroup=dcxSMDownloadGroup, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMBootPassword=dcxSMBootPassword, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMBootDevice=dcxSMBootDevice, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMDiskInserted=dcxSMDiskInserted, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMSoftwareListTable=dcxSMSoftwareListTable, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMBootUsername=dcxSMBootUsername, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxIpdrEnable=dcxIpdrEnable, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxIpdrGroup=dcxIpdrGroup, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxDxmObjects=dcxDxmObjects, dcxSMBootGroup=dcxSMBootGroup, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMObjects=dcxSMObjects, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMBootPath=dcxSMBootPath, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMBootHostname=dcxSMBootHostname, dcxIpdrFileName=dcxIpdrFileName, dcxDxmStatusRole=dcxDxmStatusRole, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount)
