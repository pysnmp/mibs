...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMBootDevice=dcxSMBootDevice, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxIpdrFileName=dcxIpdrFileName, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMObjects=dcxSMObjects, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMBootPassword=dcxSMBootPassword, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMBootUsername=dcxSMBootUsername, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmObjects=dcxDxmObjects, dcxSMBootPath=dcxSMBootPath, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMBootHostname=dcxSMBootHostname, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMDiskFailed=dcxSMDiskFailed, dcxDxmStatusState=dcxDxmStatusState, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxIpdrEnable=dcxIpdrEnable, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMRebootAction=dcxSMRebootAction, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxIpdrGroup=dcxIpdrGroup, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMBootGroup=dcxSMBootGroup, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount)
