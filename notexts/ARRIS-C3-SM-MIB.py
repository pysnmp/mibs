...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMBootHostname=dcxSMBootHostname, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMBootPassword=dcxSMBootPassword, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMSoftwareSize=dcxSMSoftwareSize, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMBootPath=dcxSMBootPath, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, cmtsC3SMMIB=cmtsC3SMMIB, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMBootGroup=dcxSMBootGroup, dcxIpdrFileName=dcxIpdrFileName, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxDxmObjects=dcxDxmObjects, dcxSMBootDevice=dcxSMBootDevice, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMRebootAction=dcxSMRebootAction, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxIpdrEnable=dcxIpdrEnable, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMBootUsername=dcxSMBootUsername, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMObjects=dcxSMObjects, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxIpdrGroup=dcxIpdrGroup, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMDownloadPath=dcxSMDownloadPath, dcxDxmStatusState=dcxDxmStatusState, dcxSMSoftwareVersion=dcxSMSoftwareVersion)
