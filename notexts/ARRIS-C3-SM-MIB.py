...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMDownloadControl=dcxSMDownloadControl, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxDxmObjects=dcxDxmObjects, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxDxmStatusState=dcxDxmStatusState, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxIpdrEnable=dcxIpdrEnable, dcxDxmStatusRole=dcxDxmStatusRole, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMRebootAction=dcxSMRebootAction, dcxIpdrGroup=dcxIpdrGroup, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMObjects=dcxSMObjects, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMBootPassword=dcxSMBootPassword, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxIpdrFileName=dcxIpdrFileName, dcxSMDiskInserted=dcxSMDiskInserted, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMBootPath=dcxSMBootPath, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMBootGroup=dcxSMBootGroup, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMBootHostname=dcxSMBootHostname, dcxSMBootUsername=dcxSMBootUsername, dcxSMBootDevice=dcxSMBootDevice, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMMiscUserIndex=dcxSMMiscUserIndex)
