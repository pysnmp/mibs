...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMDownloadPassword=dcxSMDownloadPassword, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxDxmStatusPort=dcxDxmStatusPort, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMDownloadPath=dcxSMDownloadPath, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxIpdrFileName=dcxIpdrFileName, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMBootGroup=dcxSMBootGroup, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMBootDevice=dcxSMBootDevice, dcxDxmStatusState=dcxDxmStatusState, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxIpdrGroup=dcxIpdrGroup, dcxIpdrEnable=dcxIpdrEnable, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMBootPassword=dcxSMBootPassword, dcxSMBootUsername=dcxSMBootUsername, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxDxmObjects=dcxDxmObjects, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMObjects=dcxSMObjects, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMBootHostname=dcxSMBootHostname, dcxSMRebootAction=dcxSMRebootAction, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMBootPath=dcxSMBootPath, dcxSMConfigFileIndex=dcxSMConfigFileIndex)
