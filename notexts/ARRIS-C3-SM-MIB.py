...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMDiskInserted=dcxSMDiskInserted, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMBootUsername=dcxSMBootUsername, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxDxmStatusState=dcxDxmStatusState, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMRebootAction=dcxSMRebootAction, dcxSMBootPassword=dcxSMBootPassword, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMBootPath=dcxSMBootPath, dcxSMBootDevice=dcxSMBootDevice, dcxDxmObjects=dcxDxmObjects, dcxSMBootHostname=dcxSMBootHostname, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMObjects=dcxSMObjects, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxIpdrGroup=dcxIpdrGroup, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxIpdrEnable=dcxIpdrEnable, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMBootGroup=dcxSMBootGroup)
