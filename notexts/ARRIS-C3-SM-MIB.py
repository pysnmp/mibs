...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMDownloadControl=dcxSMDownloadControl, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxIpdrFileName=dcxIpdrFileName, dcxSMObjects=dcxSMObjects, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMBootPassword=dcxSMBootPassword, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMBootUsername=dcxSMBootUsername, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMRebootAction=dcxSMRebootAction, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusState=dcxDxmStatusState, dcxIpdrGroup=dcxIpdrGroup, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmObjects=dcxDxmObjects, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMBootDevice=dcxSMBootDevice, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMBootPath=dcxSMBootPath, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMBootGroup=dcxSMBootGroup, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxIpdrEnable=dcxIpdrEnable, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMBootHostname=dcxSMBootHostname, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMDownloadStatus=dcxSMDownloadStatus, cmtsC3SMMIB=cmtsC3SMMIB, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval)
