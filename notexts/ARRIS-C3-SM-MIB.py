...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusState=dcxDxmStatusState, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMRebootAction=dcxSMRebootAction, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMBootPath=dcxSMBootPath, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxIpdrGroup=dcxIpdrGroup, dcxSMDiskInserted=dcxSMDiskInserted, dcxIpdrEnable=dcxIpdrEnable, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxDxmStatusPort=dcxDxmStatusPort, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMDownloadControl=dcxSMDownloadControl, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMBootDevice=dcxSMBootDevice, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxDxmObjects=dcxDxmObjects, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMBootGroup=dcxSMBootGroup, dcxSMBootPassword=dcxSMBootPassword, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMBootHostname=dcxSMBootHostname, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMObjects=dcxSMObjects, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxIpdrFileName=dcxIpdrFileName, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMDownloadPath=dcxSMDownloadPath, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMBootUsername=dcxSMBootUsername, dcxSMConfigFileDate=dcxSMConfigFileDate)
