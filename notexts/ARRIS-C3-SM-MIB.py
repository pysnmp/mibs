...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMBootPassword=dcxSMBootPassword, dcxSMBootUsername=dcxSMBootUsername, dcxSMBootPath=dcxSMBootPath, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxIpdrFileName=dcxIpdrFileName, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmObjects=dcxDxmObjects, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMRebootAction=dcxSMRebootAction, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxIpdrEnable=dcxIpdrEnable, dcxDxmStatusState=dcxDxmStatusState, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMDiskFailed=dcxSMDiskFailed, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMBootHostname=dcxSMBootHostname, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxIpdrGroup=dcxIpdrGroup, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMObjects=dcxSMObjects, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMBootDevice=dcxSMBootDevice, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMBootGroup=dcxSMBootGroup, dcxSMTrapGroup=dcxSMTrapGroup, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMDownloadDevice=dcxSMDownloadDevice, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd)
