...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMBootPath=dcxSMBootPath, dcxSMBootPassword=dcxSMBootPassword, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMBootDevice=dcxSMBootDevice, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxIpdrGroup=dcxIpdrGroup, dcxSMBootUsername=dcxSMBootUsername, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMBootHostname=dcxSMBootHostname, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMObjects=dcxSMObjects, dcxIpdrFileName=dcxIpdrFileName, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxDxmStatusState=dcxDxmStatusState, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxDxmStatusEnable=dcxDxmStatusEnable, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxDxmStatusPort=dcxDxmStatusPort, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMBootGroup=dcxSMBootGroup, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxIpdrEnable=dcxIpdrEnable, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxDxmObjects=dcxDxmObjects, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMTrapGroup=dcxSMTrapGroup, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMDownloadControl=dcxSMDownloadControl, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxDxmStatusRole=dcxDxmStatusRole, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMRebootAction=dcxSMRebootAction)
