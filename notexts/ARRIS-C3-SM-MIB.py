...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMRebootAction=dcxSMRebootAction, dcxSMDiskFailed=dcxSMDiskFailed, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxDxmStatusPort=dcxDxmStatusPort, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMDownloadPath=dcxSMDownloadPath, dcxDxmStatusState=dcxDxmStatusState, dcxIpdrEnable=dcxIpdrEnable, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMBootPassword=dcxSMBootPassword, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxIpdrFileName=dcxIpdrFileName, dcxSMBootDevice=dcxSMBootDevice, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMDiskInserted=dcxSMDiskInserted, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMBootPath=dcxSMBootPath, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxDxmObjects=dcxDxmObjects, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMObjects=dcxSMObjects, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxIpdrGroup=dcxIpdrGroup, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMBootUsername=dcxSMBootUsername, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMBootHostname=dcxSMBootHostname, dcxSMBootGroup=dcxSMBootGroup, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMSoftwareDate=dcxSMSoftwareDate)
