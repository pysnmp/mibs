...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMBootPath=dcxSMBootPath, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMBootDevice=dcxSMBootDevice, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMSoftwareDesc=dcxSMSoftwareDesc, cmtsC3SMMIB=cmtsC3SMMIB, dcxDxmStatusState=dcxDxmStatusState, dcxSMBootUsername=dcxSMBootUsername, dcxSMBootPassword=dcxSMBootPassword, dcxSMBootHostname=dcxSMBootHostname, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMDiskInserted=dcxSMDiskInserted, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxIpdrEnable=dcxIpdrEnable, dcxSMRebootAction=dcxSMRebootAction, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxIpdrFileName=dcxIpdrFileName, dcxSMDownloadPath=dcxSMDownloadPath, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMTrapGroup=dcxSMTrapGroup, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxDxmStatusRole=dcxDxmStatusRole, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMObjects=dcxSMObjects, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxDxmObjects=dcxDxmObjects, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxIpdrGroup=dcxIpdrGroup, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMBootGroup=dcxSMBootGroup, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMSoftwareIndex=dcxSMSoftwareIndex)
