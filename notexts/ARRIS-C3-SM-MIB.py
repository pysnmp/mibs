...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMBootGroup=dcxSMBootGroup, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxIpdrFileName=dcxIpdrFileName, dcxSMMiscUserIndex=dcxSMMiscUserIndex, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxDxmStatusState=dcxDxmStatusState, dcxSMTrapGroup=dcxSMTrapGroup, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMRebootAction=dcxSMRebootAction, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMObjects=dcxSMObjects, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxIpdrEnable=dcxIpdrEnable, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxIpdrGroup=dcxIpdrGroup, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMDownloadControl=dcxSMDownloadControl, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxDxmStatusPort=dcxDxmStatusPort, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMDownloadPath=dcxSMDownloadPath, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMBootPath=dcxSMBootPath, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMBootDevice=dcxSMBootDevice, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMBootPassword=dcxSMBootPassword, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxDxmObjects=dcxDxmObjects, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMBootUsername=dcxSMBootUsername, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMBootHostname=dcxSMBootHostname, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMSoftwareIndex=dcxSMSoftwareIndex)
