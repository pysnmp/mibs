...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMDiskFailed=dcxSMDiskFailed, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxIpdrGroup=dcxIpdrGroup, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMDownloadPath=dcxSMDownloadPath, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMObjects=dcxSMObjects, dcxSMBootGroup=dcxSMBootGroup, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusState=dcxDxmStatusState, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMBootUsername=dcxSMBootUsername, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMDiskInserted=dcxSMDiskInserted, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMBootHostname=dcxSMBootHostname, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMBootDevice=dcxSMBootDevice, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMBootPassword=dcxSMBootPassword, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMBootPath=dcxSMBootPath, dcxIpdrFileName=dcxIpdrFileName, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxIpdrEnable=dcxIpdrEnable, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMRebootAction=dcxSMRebootAction, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxDxmObjects=dcxDxmObjects, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMConfigFileGroup=dcxSMConfigFileGroup)
