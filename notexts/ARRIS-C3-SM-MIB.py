...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMBootHostname=dcxSMBootHostname, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxDxmStatusState=dcxDxmStatusState, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMBootUsername=dcxSMBootUsername, dcxSMBootGroup=dcxSMBootGroup, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMBootDevice=dcxSMBootDevice, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMBootPassword=dcxSMBootPassword, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMObjects=dcxSMObjects, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxDxmObjects=dcxDxmObjects, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxIpdrGroup=dcxIpdrGroup, dcxSMBootPath=dcxSMBootPath, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxIpdrFileName=dcxIpdrFileName, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMRebootAction=dcxSMRebootAction, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxIpdrEnable=dcxIpdrEnable)
