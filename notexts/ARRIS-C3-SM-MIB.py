...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMDownloadPassword=dcxSMDownloadPassword, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMBootUsername=dcxSMBootUsername, dcxSMDownloadControl=dcxSMDownloadControl, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMBootPassword=dcxSMBootPassword, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMBootHostname=dcxSMBootHostname, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxIpdrFileName=dcxIpdrFileName, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMBootGroup=dcxSMBootGroup, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxIpdrEnable=dcxIpdrEnable, dcxSMDiskInserted=dcxSMDiskInserted, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxIpdrGroup=dcxIpdrGroup, dcxSMBootDevice=dcxSMBootDevice, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusState=dcxDxmStatusState, dcxSMObjects=dcxSMObjects, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxDxmObjects=dcxDxmObjects, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMRebootAction=dcxSMRebootAction, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMBootPath=dcxSMBootPath, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword)
