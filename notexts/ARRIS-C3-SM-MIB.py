...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxIpdrEnable=dcxIpdrEnable, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMBootPassword=dcxSMBootPassword, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxDxmStatusState=dcxDxmStatusState, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMDiskFailed=dcxSMDiskFailed, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMDownloadGroup=dcxSMDownloadGroup, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusRole=dcxDxmStatusRole, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMBootUsername=dcxSMBootUsername, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMBootDevice=dcxSMBootDevice, dcxSMBootGroup=dcxSMBootGroup, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxDxmObjects=dcxDxmObjects, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMBootPath=dcxSMBootPath, dcxIpdrGroup=dcxIpdrGroup, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMRebootAction=dcxSMRebootAction, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMObjects=dcxSMObjects, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxIpdrFileName=dcxIpdrFileName, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMBootHostname=dcxSMBootHostname, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum)
