...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMBootHostname=dcxSMBootHostname, dcxSMDownloadPath=dcxSMDownloadPath, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMRebootAction=dcxSMRebootAction, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMBootUsername=dcxSMBootUsername, dcxDxmObjects=dcxDxmObjects, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMDiskInserted=dcxSMDiskInserted, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMObjects=dcxSMObjects, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMBootPassword=dcxSMBootPassword, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMDownloadControl=dcxSMDownloadControl, dcxIpdrEnable=dcxIpdrEnable, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxIpdrGroup=dcxIpdrGroup, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMBootPath=dcxSMBootPath, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMBootDevice=dcxSMBootDevice, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMBootGroup=dcxSMBootGroup, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, cmtsC3SMMIB=cmtsC3SMMIB, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxDxmStatusState=dcxDxmStatusState, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMDownloadHostname=dcxSMDownloadHostname)
