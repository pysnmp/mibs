...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMBootGroup=dcxSMBootGroup, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxDxmObjects=dcxDxmObjects, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxIpdrGroup=dcxIpdrGroup, dcxSMBootPassword=dcxSMBootPassword, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMBootPath=dcxSMBootPath, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMBootHostname=dcxSMBootHostname, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxIpdrEnable=dcxIpdrEnable, dcxSMSoftwareStatus=dcxSMSoftwareStatus, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMBootDevice=dcxSMBootDevice, dcxSMObjects=dcxSMObjects, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxDxmStatusState=dcxDxmStatusState, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMRebootAction=dcxSMRebootAction, dcxSMBootUsername=dcxSMBootUsername, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMSoftwareDesc=dcxSMSoftwareDesc)
