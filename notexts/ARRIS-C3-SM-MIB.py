...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMBootDevice=dcxSMBootDevice, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxDxmStatusState=dcxDxmStatusState, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMRebootAction=dcxSMRebootAction, dcxSMObjects=dcxSMObjects, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMBootPassword=dcxSMBootPassword, dcxSMBootUsername=dcxSMBootUsername, dcxSMDiskInserted=dcxSMDiskInserted, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxIpdrEnable=dcxIpdrEnable, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxIpdrGroup=dcxIpdrGroup, dcxSMBootPath=dcxSMBootPath, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMBootHostname=dcxSMBootHostname, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxDxmObjects=dcxDxmObjects, dcxSMBootGroup=dcxSMBootGroup, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMConfigFileDate=dcxSMConfigFileDate, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMConfigFileGroup=dcxSMConfigFileGroup, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange)
