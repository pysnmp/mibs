...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMDownloadControl=dcxSMDownloadControl, dcxSMBootUsername=dcxSMBootUsername, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMTrapGroup=dcxSMTrapGroup, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxIpdrGroup=dcxIpdrGroup, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxIpdrEnable=dcxIpdrEnable, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMBootGroup=dcxSMBootGroup, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMBootDevice=dcxSMBootDevice, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMBootPath=dcxSMBootPath, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMRebootAction=dcxSMRebootAction, dcxSMBootPassword=dcxSMBootPassword, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmObjects=dcxDxmObjects, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMObjects=dcxSMObjects, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMSoftwareVersion=dcxSMSoftwareVersion, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMBootHostname=dcxSMBootHostname, dcxDxmStatusState=dcxDxmStatusState)
