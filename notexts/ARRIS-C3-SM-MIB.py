...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxDxmStatusPort=dcxDxmStatusPort, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMBootUsername=dcxSMBootUsername, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMBootDevice=dcxSMBootDevice, dcxSMRebootAction=dcxSMRebootAction, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxDxmObjects=dcxDxmObjects, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxDxmStatusState=dcxDxmStatusState, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMBootPath=dcxSMBootPath, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMBootPassword=dcxSMBootPassword, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMBootGroup=dcxSMBootGroup, dcxIpdrGroup=dcxIpdrGroup, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxIpdrEnable=dcxIpdrEnable, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMDiskFailed=dcxSMDiskFailed, dcxIpdrFileName=dcxIpdrFileName, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMBootHostname=dcxSMBootHostname, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMObjects=dcxSMObjects, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup)
