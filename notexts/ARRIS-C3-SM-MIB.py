...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMBootGroup=dcxSMBootGroup, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmStatusState=dcxDxmStatusState, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMBootHostname=dcxSMBootHostname, dcxIpdrFileName=dcxIpdrFileName, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmObjects=dcxDxmObjects, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMDownloadControl=dcxSMDownloadControl, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMObjects=dcxSMObjects, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxIpdrEnable=dcxIpdrEnable, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMBootPath=dcxSMBootPath, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMBootPassword=dcxSMBootPassword, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMDownloadPath=dcxSMDownloadPath, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMRebootAction=dcxSMRebootAction, dcxSMBootUsername=dcxSMBootUsername, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMBootDevice=dcxSMBootDevice, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxIpdrGroup=dcxIpdrGroup, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMConfigFileDate=dcxSMConfigFileDate, cmtsC3SMMIB=cmtsC3SMMIB, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry)
