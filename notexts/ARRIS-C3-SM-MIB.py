...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxIpdrGroup=dcxIpdrGroup, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMRebootAction=dcxSMRebootAction, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMBootGroup=dcxSMBootGroup, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMBootPassword=dcxSMBootPassword, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxIpdrEnable=dcxIpdrEnable, dcxDxmStatusState=dcxDxmStatusState, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxIpdrFileName=dcxIpdrFileName, dcxSMBootPath=dcxSMBootPath, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMMiscUserIndex=dcxSMMiscUserIndex, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMObjects=dcxSMObjects, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMBootHostname=dcxSMBootHostname, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmObjects=dcxDxmObjects, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMBootDevice=dcxSMBootDevice, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMBootUsername=dcxSMBootUsername, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMDownloadGroup=dcxSMDownloadGroup)
