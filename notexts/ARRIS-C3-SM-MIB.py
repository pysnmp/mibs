...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMDiskRemoved=dcxSMDiskRemoved, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMRebootAction=dcxSMRebootAction, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxDxmStatusState=dcxDxmStatusState, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMBootPath=dcxSMBootPath, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxIpdrGroup=dcxIpdrGroup, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMBootGroup=dcxSMBootGroup, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMObjects=dcxSMObjects, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMDownloadControl=dcxSMDownloadControl, PYSNMP_MODULE_ID=cmtsC3SMMIB, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxDxmObjects=dcxDxmObjects, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMBootPassword=dcxSMBootPassword, dcxSMBootDevice=dcxSMBootDevice, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxIpdrEnable=dcxIpdrEnable, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMBootUsername=dcxSMBootUsername, dcxSMBootHostname=dcxSMBootHostname, dcxSMTrapGroup=dcxSMTrapGroup, dcxIpdrFileName=dcxIpdrFileName, dcxDxmStatusPort=dcxDxmStatusPort)
