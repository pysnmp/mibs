...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMDownloadControl=dcxSMDownloadControl, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxIpdrFileName=dcxIpdrFileName, dcxSMBootPassword=dcxSMBootPassword, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxDxmObjects=dcxDxmObjects, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMRebootAction=dcxSMRebootAction, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMBootHostname=dcxSMBootHostname, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxIpdrEnable=dcxIpdrEnable, dcxSMObjects=dcxSMObjects, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMBootUsername=dcxSMBootUsername, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmStatusState=dcxDxmStatusState, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMBootDevice=dcxSMBootDevice, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxIpdrGroup=dcxIpdrGroup, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMBootGroup=dcxSMBootGroup, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMBootPath=dcxSMBootPath, PYSNMP_MODULE_ID=cmtsC3SMMIB)
