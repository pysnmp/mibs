...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMBootUsername=dcxSMBootUsername, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMBootDevice=dcxSMBootDevice, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxIpdrGroup=dcxIpdrGroup, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMMiscUserTable=dcxSMMiscUserTable, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxDxmStatusState=dcxDxmStatusState, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMRebootAction=dcxSMRebootAction, dcxDxmObjects=dcxDxmObjects, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMBootGroup=dcxSMBootGroup, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMBootPath=dcxSMBootPath, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxIpdrFileName=dcxIpdrFileName, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMBootHostname=dcxSMBootHostname, dcxSMObjects=dcxSMObjects, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMBootPassword=dcxSMBootPassword, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusRole=dcxDxmStatusRole, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxIpdrEnable=dcxIpdrEnable, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMDownloadHostname=dcxSMDownloadHostname)
