...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxIpdrGroup=dcxIpdrGroup, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMBootHostname=dcxSMBootHostname, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMBootPassword=dcxSMBootPassword, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxIpdrFileName=dcxIpdrFileName, dcxSMObjects=dcxSMObjects, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMBootPath=dcxSMBootPath, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxDxmStatusState=dcxDxmStatusState, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxIpdrEnable=dcxIpdrEnable, dcxSMBootUsername=dcxSMBootUsername, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMBootDevice=dcxSMBootDevice, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMBootGroup=dcxSMBootGroup, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmObjects=dcxDxmObjects, dcxSMRebootAction=dcxSMRebootAction, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd)
