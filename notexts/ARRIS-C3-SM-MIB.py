...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMBootUsername=dcxSMBootUsername, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMBootHostname=dcxSMBootHostname, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxIpdrEnable=dcxIpdrEnable, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxIpdrGroup=dcxIpdrGroup, dcxSMBootPath=dcxSMBootPath, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxDxmObjects=dcxDxmObjects, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMBootDevice=dcxSMBootDevice, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMDiskInserted=dcxSMDiskInserted, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMRebootAction=dcxSMRebootAction, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMObjects=dcxSMObjects, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxDxmStatusState=dcxDxmStatusState, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxIpdrFileName=dcxIpdrFileName, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMBootPassword=dcxSMBootPassword, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMBootGroup=dcxSMBootGroup, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMTrapGroup=dcxSMTrapGroup)
