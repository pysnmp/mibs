...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMTrapGroup=dcxSMTrapGroup, dcxIpdrEnable=dcxIpdrEnable, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMDownloadPath=dcxSMDownloadPath, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMBootHostname=dcxSMBootHostname, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxDxmObjects=dcxDxmObjects, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMRebootAction=dcxSMRebootAction, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMObjects=dcxSMObjects, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMBootPassword=dcxSMBootPassword, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMBootUsername=dcxSMBootUsername, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMBootDevice=dcxSMBootDevice, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxIpdrGroup=dcxIpdrGroup, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMBootGroup=dcxSMBootGroup, dcxSMBootPath=dcxSMBootPath, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxDxmStatusState=dcxDxmStatusState, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged)
