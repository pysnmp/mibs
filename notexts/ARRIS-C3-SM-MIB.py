...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMBootDevice=dcxSMBootDevice, dcxSMRebootAction=dcxSMRebootAction, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxIpdrFileName=dcxIpdrFileName, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxDxmStatusPort=dcxDxmStatusPort, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMBootUsername=dcxSMBootUsername, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmObjects=dcxDxmObjects, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxDxmStatusState=dcxDxmStatusState, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusRole=dcxDxmStatusRole, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMBootGroup=dcxSMBootGroup, dcxSMDownloadControl=dcxSMDownloadControl, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMObjects=dcxSMObjects, dcxSMBootHostname=dcxSMBootHostname, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMDownloadPath=dcxSMDownloadPath, dcxIpdrEnable=dcxIpdrEnable, dcxIpdrGroup=dcxIpdrGroup, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMBootPath=dcxSMBootPath, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMBootPassword=dcxSMBootPassword, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmStatusGroup=dcxDxmStatusGroup)
