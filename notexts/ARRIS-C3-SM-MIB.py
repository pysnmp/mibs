...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMSoftwareVersion=dcxSMSoftwareVersion, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMDiskFailed=dcxSMDiskFailed, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxIpdrGroup=dcxIpdrGroup, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMObjects=dcxSMObjects, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxIpdrFileName=dcxIpdrFileName, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMBootGroup=dcxSMBootGroup, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMBootPath=dcxSMBootPath, dcxSMBootUsername=dcxSMBootUsername, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMBootDevice=dcxSMBootDevice, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmObjects=dcxDxmObjects, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxDxmStatusState=dcxDxmStatusState, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMDownloadUsername=dcxSMDownloadUsername, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMBootHostname=dcxSMBootHostname, dcxSMBootPassword=dcxSMBootPassword, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMRebootAction=dcxSMRebootAction, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxIpdrEnable=dcxIpdrEnable, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMDiskInserted=dcxSMDiskInserted)
