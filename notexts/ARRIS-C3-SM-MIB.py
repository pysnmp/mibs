...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMDownloadPath=dcxSMDownloadPath, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmObjects=dcxDxmObjects, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxDxmStatusState=dcxDxmStatusState, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMBootDevice=dcxSMBootDevice, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMBootPassword=dcxSMBootPassword, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMBootPath=dcxSMBootPath, dcxSMBootUsername=dcxSMBootUsername, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMRebootAction=dcxSMRebootAction, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxIpdrGroup=dcxIpdrGroup, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMDiskInserted=dcxSMDiskInserted, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMBootGroup=dcxSMBootGroup, dcxIpdrEnable=dcxIpdrEnable, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxIpdrFileName=dcxIpdrFileName, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMDownloadControl=dcxSMDownloadControl, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMBootHostname=dcxSMBootHostname, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMObjects=dcxSMObjects)
