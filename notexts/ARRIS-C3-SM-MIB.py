...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxIpdrFileName=dcxIpdrFileName, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMMiscUserIndex=dcxSMMiscUserIndex, cmtsC3SMMIB=cmtsC3SMMIB, dcxIpdrGroup=dcxIpdrGroup, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMObjects=dcxSMObjects, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxDxmStatusState=dcxDxmStatusState, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMTrapGroup=dcxSMTrapGroup, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMBootHostname=dcxSMBootHostname, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxDxmObjects=dcxDxmObjects, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxDxmStatusPort=dcxDxmStatusPort, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMBootUsername=dcxSMBootUsername, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxIpdrEnable=dcxIpdrEnable, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMBootPath=dcxSMBootPath, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMDownloadPath=dcxSMDownloadPath, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMRebootAction=dcxSMRebootAction, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMBootDevice=dcxSMBootDevice, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMBootGroup=dcxSMBootGroup, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMBootPassword=dcxSMBootPassword)
