...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMBootPassword=dcxSMBootPassword, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMBootHostname=dcxSMBootHostname, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxIpdrGroup=dcxIpdrGroup, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxIpdrEnable=dcxIpdrEnable, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMObjects=dcxSMObjects, dcxSMBootGroup=dcxSMBootGroup, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMBootDevice=dcxSMBootDevice, cmtsC3SMMIB=cmtsC3SMMIB, dcxDxmObjects=dcxDxmObjects, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMBootUsername=dcxSMBootUsername, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMBootPath=dcxSMBootPath, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxIpdrFileName=dcxIpdrFileName, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxDxmStatusState=dcxDxmStatusState, dcxSMRebootAction=dcxSMRebootAction, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMDownloadControl=dcxSMDownloadControl, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMSoftwareDesc=dcxSMSoftwareDesc)
