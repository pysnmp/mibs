...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxIpdrEnable=dcxIpdrEnable, dcxSMBootPassword=dcxSMBootPassword, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigFileDesc=dcxSMConfigFileDesc, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMRebootAction=dcxSMRebootAction, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMBootHostname=dcxSMBootHostname, dcxDxmStatusPort=dcxDxmStatusPort, dcxIpdrGroup=dcxIpdrGroup, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMDiskFailed=dcxSMDiskFailed, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxDxmObjects=dcxDxmObjects, dcxSMBootDevice=dcxSMBootDevice, dcxSMObjects=dcxSMObjects, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMBootPath=dcxSMBootPath, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxDxmStatusState=dcxDxmStatusState, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxDxmStatusRole=dcxDxmStatusRole, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxIpdrFileName=dcxIpdrFileName, dcxSMBootUsername=dcxSMBootUsername, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMBootGroup=dcxSMBootGroup, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxIpdrUserLoginName=dcxIpdrUserLoginName)
