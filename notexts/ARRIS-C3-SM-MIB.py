...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxIpdrFileName=dcxIpdrFileName, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxDxmStatusState=dcxDxmStatusState, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMDownloadPath=dcxSMDownloadPath, dcxIpdrGroup=dcxIpdrGroup, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxIpdrEnable=dcxIpdrEnable, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMBootUsername=dcxSMBootUsername, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMBootPassword=dcxSMBootPassword, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMBootDevice=dcxSMBootDevice, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxDxmObjects=dcxDxmObjects, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMBootGroup=dcxSMBootGroup, dcxSMBootPath=dcxSMBootPath, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMObjects=dcxSMObjects, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMRebootAction=dcxSMRebootAction, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMBootHostname=dcxSMBootHostname, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMDownloadControl=dcxSMDownloadControl, dcxDxmStatusGroup=dcxDxmStatusGroup)
