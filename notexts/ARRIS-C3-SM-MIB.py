...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxIpdrGroup=dcxIpdrGroup, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMObjects=dcxSMObjects, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMBootUsername=dcxSMBootUsername, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxDxmObjects=dcxDxmObjects, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMBootDevice=dcxSMBootDevice, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMBootPassword=dcxSMBootPassword, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMRebootAction=dcxSMRebootAction, dcxSMBootHostname=dcxSMBootHostname, dcxSMBootGroup=dcxSMBootGroup, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxIpdrEnable=dcxIpdrEnable, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxDxmStatusState=dcxDxmStatusState, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMDiskInserted=dcxSMDiskInserted, dcxIpdrFileName=dcxIpdrFileName, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMBootPath=dcxSMBootPath, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup)
