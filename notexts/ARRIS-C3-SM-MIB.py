...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMRebootAction=dcxSMRebootAction, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMBootHostname=dcxSMBootHostname, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMBootPassword=dcxSMBootPassword, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusRole=dcxDxmStatusRole, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusState=dcxDxmStatusState, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMObjects=dcxSMObjects, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMBootGroup=dcxSMBootGroup, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMBootDevice=dcxSMBootDevice, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMBootPath=dcxSMBootPath, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxIpdrGroup=dcxIpdrGroup, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxDxmObjects=dcxDxmObjects, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxIpdrFileName=dcxIpdrFileName, dcxSMBootUsername=dcxSMBootUsername, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxIpdrEnable=dcxIpdrEnable, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount)
