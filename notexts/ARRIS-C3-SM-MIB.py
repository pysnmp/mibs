...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMBootDevice=dcxSMBootDevice, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMDiskInserted=dcxSMDiskInserted, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMRebootAction=dcxSMRebootAction, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMBootUsername=dcxSMBootUsername, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxIpdrFileName=dcxIpdrFileName, dcxSMDownloadControl=dcxSMDownloadControl, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMBootPath=dcxSMBootPath, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxIpdrEnable=dcxIpdrEnable, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMBootGroup=dcxSMBootGroup, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMObjects=dcxSMObjects, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMTrapGroup=dcxSMTrapGroup, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxDxmObjects=dcxDxmObjects, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMBootPassword=dcxSMBootPassword, dcxDxmStatusPort=dcxDxmStatusPort, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMDownloadPath=dcxSMDownloadPath, dcxIpdrGroup=dcxIpdrGroup, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusState=dcxDxmStatusState, dcxSMBootHostname=dcxSMBootHostname, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount)
