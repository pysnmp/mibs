...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMDownloadPassword=dcxSMDownloadPassword, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMObjects=dcxSMObjects, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMDownloadControl=dcxSMDownloadControl, dcxDxmStatusState=dcxDxmStatusState, dcxSMRebootAction=dcxSMRebootAction, dcxSMBootUsername=dcxSMBootUsername, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxDxmStatusPort=dcxDxmStatusPort, dcxDxmObjects=dcxDxmObjects, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxIpdrGroup=dcxIpdrGroup, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxIpdrEnable=dcxIpdrEnable, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMBootGroup=dcxSMBootGroup, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMDownloadPath=dcxSMDownloadPath, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMBootDevice=dcxSMBootDevice, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMBootPath=dcxSMBootPath, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMBootPassword=dcxSMBootPassword, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMDownloadDevice=dcxSMDownloadDevice, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMBootHostname=dcxSMBootHostname, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxIpdrFileName=dcxIpdrFileName, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMSoftwareStatus=dcxSMSoftwareStatus)
