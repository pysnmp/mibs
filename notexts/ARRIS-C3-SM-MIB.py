...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxIpdrGroup=dcxIpdrGroup, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMBootUsername=dcxSMBootUsername, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMBootDevice=dcxSMBootDevice, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMBootPath=dcxSMBootPath, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMBootGroup=dcxSMBootGroup, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMMiscUserTable=dcxSMMiscUserTable, cmtsC3SMMIB=cmtsC3SMMIB, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxDxmStatusPort=dcxDxmStatusPort, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxIpdrEnable=dcxIpdrEnable, dcxSMDiskInserted=dcxSMDiskInserted, dcxDxmStatusState=dcxDxmStatusState, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMRebootAction=dcxSMRebootAction, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMObjects=dcxSMObjects, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMBootPassword=dcxSMBootPassword, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMBootHostname=dcxSMBootHostname, dcxSMTrapGroup=dcxSMTrapGroup, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxDxmObjects=dcxDxmObjects, dcxSMSoftwareSize=dcxSMSoftwareSize)
