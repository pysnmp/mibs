...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMBootGroup=dcxSMBootGroup, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMTrapGroup=dcxSMTrapGroup, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMBootUsername=dcxSMBootUsername, dcxDxmObjects=dcxDxmObjects, dcxIpdrFileName=dcxIpdrFileName, dcxSMBootPath=dcxSMBootPath, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMBootDevice=dcxSMBootDevice, dcxIpdrEnable=dcxIpdrEnable, dcxDxmStatusRole=dcxDxmStatusRole, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMDiskInserted=dcxSMDiskInserted, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMBootHostname=dcxSMBootHostname, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxDxmStatusState=dcxDxmStatusState, dcxSMBootPassword=dcxSMBootPassword, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMRebootAction=dcxSMRebootAction, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMObjects=dcxSMObjects, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxIpdrGroup=dcxIpdrGroup, cmtsC3SMMIB=cmtsC3SMMIB)
