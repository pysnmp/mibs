...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxIpdrGroup=dcxIpdrGroup, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMBootPath=dcxSMBootPath, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMMiscUserTable=dcxSMMiscUserTable, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMBootPassword=dcxSMBootPassword, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxDxmStatusState=dcxDxmStatusState, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMRebootAction=dcxSMRebootAction, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMBootGroup=dcxSMBootGroup, dcxSMTrapGroup=dcxSMTrapGroup, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMBootDevice=dcxSMBootDevice, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMObjects=dcxSMObjects, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMDiskInserted=dcxSMDiskInserted, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxIpdrEnable=dcxIpdrEnable, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMBootUsername=dcxSMBootUsername, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmObjects=dcxDxmObjects, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxIpdrFileName=dcxIpdrFileName, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMBootHostname=dcxSMBootHostname, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMDownloadPassword=dcxSMDownloadPassword)
