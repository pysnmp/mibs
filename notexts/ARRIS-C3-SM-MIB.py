...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxIpdrGroup=dcxIpdrGroup, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMObjects=dcxSMObjects, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMBootGroup=dcxSMBootGroup, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMBootPassword=dcxSMBootPassword, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMDiskFailed=dcxSMDiskFailed, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMTrapGroup=dcxSMTrapGroup, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMBootPath=dcxSMBootPath, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMDownloadControl=dcxSMDownloadControl, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMBootDevice=dcxSMBootDevice, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmStatusState=dcxDxmStatusState, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMBootHostname=dcxSMBootHostname, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMBootUsername=dcxSMBootUsername, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxIpdrEnable=dcxIpdrEnable, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxIpdrFileName=dcxIpdrFileName, dcxDxmObjects=dcxDxmObjects, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMRebootAction=dcxSMRebootAction, dcxSMMiscUserTable=dcxSMMiscUserTable)
