...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxDxmStatusRole=dcxDxmStatusRole, dcxIpdrGroup=dcxIpdrGroup, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMBootUsername=dcxSMBootUsername, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMObjects=dcxSMObjects, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMBootDevice=dcxSMBootDevice, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMBootPath=dcxSMBootPath, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMBootGroup=dcxSMBootGroup, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMBootHostname=dcxSMBootHostname, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxDxmObjects=dcxDxmObjects, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMMiscUserTable=dcxSMMiscUserTable, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxDxmStatusState=dcxDxmStatusState, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMDiskFailed=dcxSMDiskFailed, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMBootPassword=dcxSMBootPassword, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMRebootAction=dcxSMRebootAction, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxIpdrEnable=dcxIpdrEnable, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMDownloadControl=dcxSMDownloadControl)
