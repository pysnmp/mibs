...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMMiscUserTable=dcxSMMiscUserTable, dcxDxmStatusState=dcxDxmStatusState, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxIpdrEnable=dcxIpdrEnable, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMBootGroup=dcxSMBootGroup, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, cmtsC3SMMIB=cmtsC3SMMIB, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMObjects=dcxSMObjects, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMBootPath=dcxSMBootPath, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMBootUsername=dcxSMBootUsername, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxIpdrGroup=dcxIpdrGroup, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxIpdrFileName=dcxIpdrFileName, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMRebootAction=dcxSMRebootAction, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMBootDevice=dcxSMBootDevice, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMBootHostname=dcxSMBootHostname, dcxDxmObjects=dcxDxmObjects, dcxDxmStatusPort=dcxDxmStatusPort, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMBootPassword=dcxSMBootPassword, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount)
