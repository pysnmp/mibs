...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMBootDevice=dcxSMBootDevice, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMDownloadPath=dcxSMDownloadPath, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxIpdrEnable=dcxIpdrEnable, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMBootHostname=dcxSMBootHostname, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMDownloadControl=dcxSMDownloadControl, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMBootUsername=dcxSMBootUsername, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMObjects=dcxSMObjects, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMDiskInserted=dcxSMDiskInserted, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMBootPassword=dcxSMBootPassword, dcxSMSoftwareSize=dcxSMSoftwareSize, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxIpdrGroup=dcxIpdrGroup, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxDxmObjects=dcxDxmObjects, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMBootPath=dcxSMBootPath, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMRebootAction=dcxSMRebootAction, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxIpdrFileName=dcxIpdrFileName, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMBootGroup=dcxSMBootGroup, dcxDxmStatusState=dcxDxmStatusState, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd)
