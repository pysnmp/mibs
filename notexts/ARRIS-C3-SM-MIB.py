...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMBootPath=dcxSMBootPath, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMRebootAction=dcxSMRebootAction, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMBootPassword=dcxSMBootPassword, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMBootDevice=dcxSMBootDevice, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMObjects=dcxSMObjects, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxIpdrGroup=dcxIpdrGroup, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxIpdrEnable=dcxIpdrEnable, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxDxmObjects=dcxDxmObjects, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxDxmStatusRole=dcxDxmStatusRole, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMBootUsername=dcxSMBootUsername, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMDownloadPath=dcxSMDownloadPath, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMBootHostname=dcxSMBootHostname, dcxSMBootGroup=dcxSMBootGroup, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusState=dcxDxmStatusState, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount)
