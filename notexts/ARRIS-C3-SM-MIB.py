...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMRebootAction=dcxSMRebootAction, dcxDxmStatusRole=dcxDxmStatusRole, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusState=dcxDxmStatusState, dcxSMBootDevice=dcxSMBootDevice, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMBootPath=dcxSMBootPath, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMBootUsername=dcxSMBootUsername, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxDxmObjects=dcxDxmObjects, dcxSMBootGroup=dcxSMBootGroup, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxIpdrGroup=dcxIpdrGroup, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxIpdrFileName=dcxIpdrFileName, dcxSMObjects=dcxSMObjects, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMBootHostname=dcxSMBootHostname, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMDownloadPath=dcxSMDownloadPath, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMBootPassword=dcxSMBootPassword, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxIpdrEnable=dcxIpdrEnable, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMConfigFileSize=dcxSMConfigFileSize, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval)
