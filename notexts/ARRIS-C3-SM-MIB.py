...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMBootPath=dcxSMBootPath, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxDxmStatusState=dcxDxmStatusState, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMBootHostname=dcxSMBootHostname, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMObjects=dcxSMObjects, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxIpdrGroup=dcxIpdrGroup, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMRebootAction=dcxSMRebootAction, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxDxmObjects=dcxDxmObjects, dcxSMBootPassword=dcxSMBootPassword, dcxSMBootUsername=dcxSMBootUsername, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxIpdrFileName=dcxIpdrFileName, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxIpdrEnable=dcxIpdrEnable, dcxDxmStatusPort=dcxDxmStatusPort, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMBootDevice=dcxSMBootDevice, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMBootGroup=dcxSMBootGroup, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMConfigFileEntry=dcxSMConfigFileEntry)
