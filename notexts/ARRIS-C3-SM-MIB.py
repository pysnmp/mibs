...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMBootUsername=dcxSMBootUsername, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMBootPath=dcxSMBootPath, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxIpdrEnable=dcxIpdrEnable, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMBootHostname=dcxSMBootHostname, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMRebootAction=dcxSMRebootAction, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMBootDevice=dcxSMBootDevice, dcxIpdrFileName=dcxIpdrFileName, dcxSMImageBootFailed=dcxSMImageBootFailed, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMObjects=dcxSMObjects, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMBootPassword=dcxSMBootPassword, dcxDxmStatusState=dcxDxmStatusState, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxIpdrGroup=dcxIpdrGroup, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxDxmObjects=dcxDxmObjects, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMBootGroup=dcxSMBootGroup, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMConfigFileEntry=dcxSMConfigFileEntry)
