...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMDownloadStatus=dcxSMDownloadStatus, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxIpdrGroup=dcxIpdrGroup, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMRebootAction=dcxSMRebootAction, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMBootPath=dcxSMBootPath, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxDxmStatusState=dcxDxmStatusState, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMBootPassword=dcxSMBootPassword, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMBootHostname=dcxSMBootHostname, dcxSMBootGroup=dcxSMBootGroup, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMBootDevice=dcxSMBootDevice, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmObjects=dcxDxmObjects, dcxIpdrEnable=dcxIpdrEnable, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMObjects=dcxSMObjects, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMDownloadPath=dcxSMDownloadPath, dcxDxmStatusRole=dcxDxmStatusRole, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMBootUsername=dcxSMBootUsername, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMDiskInserted=dcxSMDiskInserted, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount)
