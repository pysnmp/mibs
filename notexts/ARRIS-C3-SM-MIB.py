...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMBootHostname=dcxSMBootHostname, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMConfigFileTable=dcxSMConfigFileTable, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxIpdrFileName=dcxIpdrFileName, dcxSMRebootAction=dcxSMRebootAction, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMObjects=dcxSMObjects, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMBootDevice=dcxSMBootDevice, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxIpdrEnable=dcxIpdrEnable, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMBootPassword=dcxSMBootPassword, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMBootPath=dcxSMBootPath, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMBootGroup=dcxSMBootGroup, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMBootUsername=dcxSMBootUsername, dcxDxmStatusState=dcxDxmStatusState, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxIpdrGroup=dcxIpdrGroup, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxDxmObjects=dcxDxmObjects, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxDxmStatusPort=dcxDxmStatusPort)
