...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMBootGroup=dcxSMBootGroup, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxDxmObjects=dcxDxmObjects, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxIpdrEnable=dcxIpdrEnable, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMBootPassword=dcxSMBootPassword, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMDownloadStatus=dcxSMDownloadStatus, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMBootDevice=dcxSMBootDevice, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxIpdrGroup=dcxIpdrGroup, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMRebootAction=dcxSMRebootAction, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxDxmStatusRole=dcxDxmStatusRole, dcxDxmStatusState=dcxDxmStatusState, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMBootPath=dcxSMBootPath, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMBootUsername=dcxSMBootUsername, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMBootHostname=dcxSMBootHostname, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMObjects=dcxSMObjects, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxIpdrFileName=dcxIpdrFileName, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount)
