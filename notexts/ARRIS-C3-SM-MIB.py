...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxDxmStatusState=dcxDxmStatusState, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxIpdrEnable=dcxIpdrEnable, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxIpdrGroup=dcxIpdrGroup, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMBootUsername=dcxSMBootUsername, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxDxmObjects=dcxDxmObjects, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMBootHostname=dcxSMBootHostname, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMBootPassword=dcxSMBootPassword, dcxSMBootPath=dcxSMBootPath, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMRebootAction=dcxSMRebootAction, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMBootGroup=dcxSMBootGroup, dcxIpdrFileName=dcxIpdrFileName, dcxSMBootDevice=dcxSMBootDevice, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMObjects=dcxSMObjects, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMDownloadUsername=dcxSMDownloadUsername, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxDxmStatusPort=dcxDxmStatusPort, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMDownloadHostname=dcxSMDownloadHostname)
