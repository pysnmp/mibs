...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMDownloadPath=dcxSMDownloadPath, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMBootGroup=dcxSMBootGroup, dcxSMBootUsername=dcxSMBootUsername, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxDxmStatusPort=dcxDxmStatusPort, dcxIpdrGroup=dcxIpdrGroup, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMBootPassword=dcxSMBootPassword, dcxSMBootDevice=dcxSMBootDevice, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxDxmStatusState=dcxDxmStatusState, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMDownloadControl=dcxSMDownloadControl, dcxIpdrFileName=dcxIpdrFileName, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMDownloadHostname=dcxSMDownloadHostname, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxIpdrEnable=dcxIpdrEnable, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMDiskFailed=dcxSMDiskFailed, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMBootPath=dcxSMBootPath, dcxSMObjects=dcxSMObjects, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMRebootAction=dcxSMRebootAction, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxDxmStatusRole=dcxDxmStatusRole, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxDxmObjects=dcxDxmObjects, dcxSMBootHostname=dcxSMBootHostname, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMConfigFileIndex=dcxSMConfigFileIndex)
