...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMTrapGroup=dcxSMTrapGroup, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMBootHostname=dcxSMBootHostname, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxIpdrEnable=dcxIpdrEnable, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMObjects=dcxSMObjects, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxIpdrGroup=dcxIpdrGroup, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMBootUsername=dcxSMBootUsername, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMBootGroup=dcxSMBootGroup, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxDxmObjects=dcxDxmObjects, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMBootPath=dcxSMBootPath, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMDownloadPassword=dcxSMDownloadPassword, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMRebootAction=dcxSMRebootAction, dcxSMDiskFailed=dcxSMDiskFailed, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMBootPassword=dcxSMBootPassword, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxDxmStatusState=dcxDxmStatusState, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxIpdrFileName=dcxIpdrFileName, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMBootDevice=dcxSMBootDevice, dcxSMDownloadHostname=dcxSMDownloadHostname)
