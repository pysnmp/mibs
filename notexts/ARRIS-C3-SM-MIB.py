...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxIpdrFileName=dcxIpdrFileName, dcxSMObjects=dcxSMObjects, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMBootPassword=dcxSMBootPassword, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxIpdrEnable=dcxIpdrEnable, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMBootGroup=dcxSMBootGroup, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMDiskFailed=dcxSMDiskFailed, dcxDxmStatusState=dcxDxmStatusState, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMConfigFileGroup=dcxSMConfigFileGroup, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxDxmStatusPort=dcxDxmStatusPort, dcxIpdrGroup=dcxIpdrGroup, dcxSMRebootAction=dcxSMRebootAction, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMBootUsername=dcxSMBootUsername, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMBootHostname=dcxSMBootHostname, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMBootDevice=dcxSMBootDevice, dcxDxmObjects=dcxDxmObjects, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMBootPath=dcxSMBootPath, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress)
