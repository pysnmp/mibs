...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMObjects=dcxSMObjects, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxIpdrGroup=dcxIpdrGroup, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxIpdrFileName=dcxIpdrFileName, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, cmtsC3SMMIB=cmtsC3SMMIB, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMRebootAction=dcxSMRebootAction, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmStatusState=dcxDxmStatusState, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMBootPassword=dcxSMBootPassword, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMBootPath=dcxSMBootPath, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMBootUsername=dcxSMBootUsername, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMDiskFailed=dcxSMDiskFailed, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMBootDevice=dcxSMBootDevice, dcxIpdrEnable=dcxIpdrEnable, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMBootHostname=dcxSMBootHostname, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxDxmObjects=dcxDxmObjects, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMBootGroup=dcxSMBootGroup, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMSoftwareDate=dcxSMSoftwareDate)
