...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxIpdrEnable=dcxIpdrEnable, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMBootGroup=dcxSMBootGroup, dcxIpdrGroup=dcxIpdrGroup, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmObjects=dcxDxmObjects, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxDxmStatusState=dcxDxmStatusState, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMRebootAction=dcxSMRebootAction, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMBootUsername=dcxSMBootUsername, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMSoftwareSize=dcxSMSoftwareSize, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMBootPath=dcxSMBootPath, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMBootPassword=dcxSMBootPassword, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMBootDevice=dcxSMBootDevice, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxIpdrFileName=dcxIpdrFileName, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMBootHostname=dcxSMBootHostname, dcxDxmStatusRole=dcxDxmStatusRole, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMObjects=dcxSMObjects, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount)
