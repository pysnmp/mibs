...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxLastRssi=mIfNxLastRssi, mIfNxTemperature=mIfNxTemperature, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxHardwareId=mIfNxHardwareId, mdsIfNxMIBGroups=mdsIfNxMIBGroups, InitStatus=InitStatus, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, AlarmFlags=AlarmFlags, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxCompliance=mIfNxCompliance, ModemType=ModemType, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, DeviceModeType=DeviceModeType, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxConfig=mIfNxConfig, LinkStatus=LinkStatus, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxAlarms=mIfNxAlarms, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxLastChan=mIfNxLastChan, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxInitStatus=mIfNxInitStatus, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus)
