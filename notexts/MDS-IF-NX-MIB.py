...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, LinkStatus=LinkStatus, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, InitStatus=InitStatus, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, UnsignedShort=UnsignedShort, InetIpAddress=InetIpAddress, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxSerialNumber=mIfNxSerialNumber, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, AlarmFlags=AlarmFlags, mIfNxApInfoApAddress=mIfNxApInfoApAddress, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxLastChan=mIfNxLastChan, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxConfig=mIfNxConfig, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, ModemType=ModemType, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxTemperature=mIfNxTemperature, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxInitStatus=mIfNxInitStatus, mdsIfNxMIB=mdsIfNxMIB, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, DeviceModeType=DeviceModeType, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus)
