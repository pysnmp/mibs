...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxConfig=mIfNxConfig, InitStatus=InitStatus, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, LinkStatus=LinkStatus, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxCompliance=mIfNxCompliance, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusTable=mIfNxStatusTable, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, ModemType=ModemType, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxLastRssi=mIfNxLastRssi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, DeviceModeType=DeviceModeType, mIfNxHardwareRevision=mIfNxHardwareRevision, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatus=mIfNxStatus, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, UnsignedShort=UnsignedShort, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, InetIpAddress=InetIpAddress, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusActChanTable=mIfNxStatusActChanTable, AlarmFlags=AlarmFlags, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxActiveNic=mIfNxActiveNic, mIfNxMIBObjects=mIfNxMIBObjects, mdsIfNxMIB=mdsIfNxMIB, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxLastLqi=mIfNxLastLqi, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxAlarms=mIfNxAlarms, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess)
