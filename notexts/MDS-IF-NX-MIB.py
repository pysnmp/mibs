...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxTemperature=mIfNxTemperature, AlarmFlags=AlarmFlags, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxFirmwareRevision=mIfNxFirmwareRevision, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mdsIfNxMIBGroups=mdsIfNxMIBGroups, UnsignedShort=UnsignedShort, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxLastChan=mIfNxLastChan, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxInitStatus=mIfNxInitStatus, InitStatus=InitStatus, LinkStatus=LinkStatus, DeviceModeType=DeviceModeType, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, FirmwareRevision=FirmwareRevision, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxConfig=mIfNxConfig, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, ModemType=ModemType, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, UnsignedByte=UnsignedByte, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusTable=mIfNxStatusTable, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, InetIpAddress=InetIpAddress, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxLastLqi=mIfNxLastLqi, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError)
