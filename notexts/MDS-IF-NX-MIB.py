...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusGroup=mIfNxStatusGroup, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, AlarmFlags=AlarmFlags, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxLastChan=mIfNxLastChan, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, ModemType=ModemType, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, InitStatus=InitStatus, mdsIfNxMIBConformance=mdsIfNxMIBConformance, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, FirmwareRevision=FirmwareRevision, UnsignedByte=UnsignedByte, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxLastLqi=mIfNxLastLqi, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxConfig=mIfNxConfig, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, UnsignedShort=UnsignedShort, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, LinkStatus=LinkStatus, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus)
