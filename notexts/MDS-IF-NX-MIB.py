...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, FirmwareRevision=FirmwareRevision, InitStatus=InitStatus, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, UnsignedByte=UnsignedByte, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, UnsignedShort=UnsignedShort, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mdsIfNxMIB=mdsIfNxMIB, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxCompliance=mIfNxCompliance, mIfNxSerialNumber=mIfNxSerialNumber, LinkStatus=LinkStatus, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, ModemType=ModemType, mIfNxActiveNic=mIfNxActiveNic, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxAlarms=mIfNxAlarms, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxConfig=mIfNxConfig, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxLastLqi=mIfNxLastLqi, DeviceModeType=DeviceModeType, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusTable=mIfNxStatusTable, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxCurrentModem=mIfNxCurrentModem)
