...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", InetIpAddress=InetIpAddress, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, DeviceModeType=DeviceModeType, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, UnsignedByte=UnsignedByte, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, AlarmFlags=AlarmFlags, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxCompliance=mIfNxCompliance, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxCurrentModem=mIfNxCurrentModem, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxLastChan=mIfNxLastChan, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxAlarms=mIfNxAlarms, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, UnsignedShort=UnsignedShort, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, LinkStatus=LinkStatus, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxHardwareId=mIfNxHardwareId, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxConfig=mIfNxConfig, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, InitStatus=InitStatus, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxInitStatus=mIfNxInitStatus, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusActChanTable=mIfNxStatusActChanTable, ModemType=ModemType, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry)
