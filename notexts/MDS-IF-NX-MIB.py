...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxActiveNic=mIfNxActiveNic, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxAlarms=mIfNxAlarms, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxCompliance=mIfNxCompliance, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, LinkStatus=LinkStatus, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxMacStatsTxError=mIfNxMacStatsTxError, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mdsIfNxMIB=mdsIfNxMIB, AlarmFlags=AlarmFlags, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, FirmwareRevision=FirmwareRevision, InetIpAddress=InetIpAddress, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxLinkStatus=mIfNxLinkStatus, DeviceModeType=DeviceModeType, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxFirmwareRevision=mIfNxFirmwareRevision, PYSNMP_MODULE_ID=mdsIfNxMIB, InitStatus=InitStatus, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, ModemType=ModemType, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxTemperature=mIfNxTemperature, UnsignedByte=UnsignedByte, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable)
