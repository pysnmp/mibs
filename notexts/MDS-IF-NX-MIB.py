...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, ModemType=ModemType, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mdsIfNxMIBConformance=mdsIfNxMIBConformance, InitStatus=InitStatus, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, InetIpAddress=InetIpAddress, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, LinkStatus=LinkStatus, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxHardwareId=mIfNxHardwareId, DeviceModeType=DeviceModeType, mIfNxLinkStatus=mIfNxLinkStatus, UnsignedShort=UnsignedShort, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, FirmwareRevision=FirmwareRevision, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusTable=mIfNxStatusTable, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxConfig=mIfNxConfig, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxTemperature=mIfNxTemperature, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxLastLqi=mIfNxLastLqi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, AlarmFlags=AlarmFlags, UnsignedByte=UnsignedByte, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mdsIfNxMIBGroups=mdsIfNxMIBGroups)
