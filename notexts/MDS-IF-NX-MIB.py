...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mdsIfNxMIB=mdsIfNxMIB, LinkStatus=LinkStatus, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusGroup=mIfNxStatusGroup, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, UnsignedByte=UnsignedByte, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, InitStatus=InitStatus, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxLinkStatus=mIfNxLinkStatus, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxTemperature=mIfNxTemperature, mIfNxLastRssi=mIfNxLastRssi, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, ModemType=ModemType, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxHardwareId=mIfNxHardwareId, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxMIBObjects=mIfNxMIBObjects, AlarmFlags=AlarmFlags, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxLastLqi=mIfNxLastLqi, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, DeviceModeType=DeviceModeType, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes)
