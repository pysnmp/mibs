...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxLinkStatus=mIfNxLinkStatus, DeviceModeType=DeviceModeType, mIfNxActiveNic=mIfNxActiveNic, AlarmFlags=AlarmFlags, InitStatus=InitStatus, mdsIfNxMIBGroups=mdsIfNxMIBGroups, ModemType=ModemType, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, InetIpAddress=InetIpAddress, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxLastRssi=mIfNxLastRssi, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, UnsignedShort=UnsignedShort, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, LinkStatus=LinkStatus, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusTable=mIfNxStatusTable, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, UnsignedByte=UnsignedByte, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxConfig=mIfNxConfig, FirmwareRevision=FirmwareRevision, mIfNxStatus=mIfNxStatus, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxAlarms=mIfNxAlarms, mIfNxTemperature=mIfNxTemperature, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxLastChan=mIfNxLastChan)
