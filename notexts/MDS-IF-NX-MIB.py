...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxInitStatus=mIfNxInitStatus, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxLastLqi=mIfNxLastLqi, InetIpAddress=InetIpAddress, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, InitStatus=InitStatus, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxLastChan=mIfNxLastChan, DeviceModeType=DeviceModeType, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, LinkStatus=LinkStatus, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxHardwareId=mIfNxHardwareId, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mdsIfNxMIBGroups=mdsIfNxMIBGroups, UnsignedByte=UnsignedByte, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, ModemType=ModemType, mIfNxStatusActChanTable=mIfNxStatusActChanTable, PYSNMP_MODULE_ID=mdsIfNxMIB, AlarmFlags=AlarmFlags, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxAlarms=mIfNxAlarms, UnsignedShort=UnsignedShort, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop)
