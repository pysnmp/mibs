...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, ModemType=ModemType, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, InitStatus=InitStatus, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxConfig=mIfNxConfig, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatus=mIfNxStatus, mIfNxStatusTable=mIfNxStatusTable, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxLastLqi=mIfNxLastLqi, mIfNxActiveNic=mIfNxActiveNic, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxHardwareId=mIfNxHardwareId, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxLastRssi=mIfNxLastRssi, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, LinkStatus=LinkStatus, mIfNxAlarms=mIfNxAlarms, mIfNxSerialNumber=mIfNxSerialNumber, InetIpAddress=InetIpAddress, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, UnsignedByte=UnsignedByte, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, AlarmFlags=AlarmFlags, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, UnsignedShort=UnsignedShort, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes)
