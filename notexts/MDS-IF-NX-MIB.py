...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxConfig=mIfNxConfig, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, UnsignedShort=UnsignedShort, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, FirmwareRevision=FirmwareRevision, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxInitStatus=mIfNxInitStatus, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxLastRssi=mIfNxLastRssi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxSerialNumber=mIfNxSerialNumber, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxAlarms=mIfNxAlarms, mIfNxLastChan=mIfNxLastChan, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, InitStatus=InitStatus, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxFirmwareRevision=mIfNxFirmwareRevision, UnsignedByte=UnsignedByte, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mdsIfNxMIBConformance=mdsIfNxMIBConformance, ModemType=ModemType, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, AlarmFlags=AlarmFlags, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, InetIpAddress=InetIpAddress, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, DeviceModeType=DeviceModeType, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry)
