...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, ModemType=ModemType, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, UnsignedShort=UnsignedShort, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxConfig=mIfNxConfig, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, InitStatus=InitStatus, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, InetIpAddress=InetIpAddress, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxAlarms=mIfNxAlarms, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxMacStatsTxError=mIfNxMacStatsTxError, FirmwareRevision=FirmwareRevision, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, DeviceModeType=DeviceModeType, AlarmFlags=AlarmFlags, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatus=mIfNxStatus, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxLastChan=mIfNxLastChan, PYSNMP_MODULE_ID=mdsIfNxMIB, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive)
