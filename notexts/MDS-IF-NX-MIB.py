...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxCompliance=mIfNxCompliance, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxHardwareId=mIfNxHardwareId, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusTable=mIfNxStatusTable, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxAlarms=mIfNxAlarms, InetIpAddress=InetIpAddress, DeviceModeType=DeviceModeType, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, FirmwareRevision=FirmwareRevision, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, ModemType=ModemType, mIfNxLastChan=mIfNxLastChan, mdsIfNxMIB=mdsIfNxMIB, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, UnsignedShort=UnsignedShort, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusActChanTable=mIfNxStatusActChanTable, LinkStatus=LinkStatus, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxConfig=mIfNxConfig, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, InitStatus=InitStatus, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxTemperature=mIfNxTemperature, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxActiveNic=mIfNxActiveNic)
