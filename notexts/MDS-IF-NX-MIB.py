...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, UnsignedByte=UnsignedByte, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, DeviceModeType=DeviceModeType, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, LinkStatus=LinkStatus, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxConfig=mIfNxConfig, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxLastChan=mIfNxLastChan, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mdsIfNxMIB=mdsIfNxMIB, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, PYSNMP_MODULE_ID=mdsIfNxMIB, InetIpAddress=InetIpAddress, UnsignedShort=UnsignedShort, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxInitStatus=mIfNxInitStatus, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, InitStatus=InitStatus, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, ModemType=ModemType, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus)
