...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxAlarms=mIfNxAlarms, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxCompliance=mIfNxCompliance, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxLastLqi=mIfNxLastLqi, InetIpAddress=InetIpAddress, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, FirmwareRevision=FirmwareRevision, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, AlarmFlags=AlarmFlags, mIfNxHardwareId=mIfNxHardwareId, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxActiveNic=mIfNxActiveNic, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mdsIfNxMIB=mdsIfNxMIB, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEntry=mIfNxStatusEntry, ModemType=ModemType, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, UnsignedByte=UnsignedByte, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, InitStatus=InitStatus, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, UnsignedShort=UnsignedShort, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxFirmwareRevision=mIfNxFirmwareRevision, DeviceModeType=DeviceModeType, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress)
