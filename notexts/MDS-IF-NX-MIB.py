...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxTemperature=mIfNxTemperature, DeviceModeType=DeviceModeType, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, UnsignedShort=UnsignedShort, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxHardwareId=mIfNxHardwareId, InitStatus=InitStatus, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, LinkStatus=LinkStatus, UnsignedByte=UnsignedByte, mIfNxLastChan=mIfNxLastChan, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, ModemType=ModemType, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusTable=mIfNxStatusTable, InetIpAddress=InetIpAddress, FirmwareRevision=FirmwareRevision, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxAlarms=mIfNxAlarms, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxCompliance=mIfNxCompliance, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxLastRssi=mIfNxLastRssi, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mdsIfNxMIBConformance=mdsIfNxMIBConformance)
