...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxCurrentModem=mIfNxCurrentModem, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, ModemType=ModemType, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxCompliance=mIfNxCompliance, mIfNxLastChan=mIfNxLastChan, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEntry=mIfNxStatusEntry, InetIpAddress=InetIpAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, FirmwareRevision=FirmwareRevision, mIfNxHardwareId=mIfNxHardwareId, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxActiveNic=mIfNxActiveNic, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, LinkStatus=LinkStatus, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, UnsignedByte=UnsignedByte, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mdsIfNxMIB=mdsIfNxMIB, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, InitStatus=InitStatus, mIfNxStatus=mIfNxStatus, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, AlarmFlags=AlarmFlags, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxAlarms=mIfNxAlarms, mIfNxLastRssi=mIfNxLastRssi, UnsignedShort=UnsignedShort, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, DeviceModeType=DeviceModeType, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxConfig=mIfNxConfig, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances)
