...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusActChanTable=mIfNxStatusActChanTable, ModemType=ModemType, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, InitStatus=InitStatus, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxLastLqi=mIfNxLastLqi, AlarmFlags=AlarmFlags, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxActiveNic=mIfNxActiveNic, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxConfig=mIfNxConfig, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, InetIpAddress=InetIpAddress, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxHardwareId=mIfNxHardwareId, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxLastChan=mIfNxLastChan, UnsignedShort=UnsignedShort, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, PYSNMP_MODULE_ID=mdsIfNxMIB, UnsignedByte=UnsignedByte, mIfNxStatus=mIfNxStatus, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxCurrentModem=mIfNxCurrentModem, DeviceModeType=DeviceModeType, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, FirmwareRevision=FirmwareRevision, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop)
