...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, ModemType=ModemType, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, InitStatus=InitStatus, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, UnsignedByte=UnsignedByte, mIfNxInitStatus=mIfNxInitStatus, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, FirmwareRevision=FirmwareRevision, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxCompliance=mIfNxCompliance, InetIpAddress=InetIpAddress, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxTemperature=mIfNxTemperature, mIfNxConfig=mIfNxConfig, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxLinkStatus=mIfNxLinkStatus, DeviceModeType=DeviceModeType, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxLastRssi=mIfNxLastRssi, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, LinkStatus=LinkStatus, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, UnsignedShort=UnsignedShort, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes)
