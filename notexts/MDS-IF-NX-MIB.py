...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxLastRssi=mIfNxLastRssi, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mdsIfNxMIBGroups=mdsIfNxMIBGroups, DeviceModeType=DeviceModeType, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxCurrentModem=mIfNxCurrentModem, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mdsIfNxMIB=mdsIfNxMIB, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, AlarmFlags=AlarmFlags, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxInitStatus=mIfNxInitStatus, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, ModemType=ModemType, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, UnsignedByte=UnsignedByte, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxConfig=mIfNxConfig, mIfNxStatusTable=mIfNxStatusTable, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, InitStatus=InitStatus, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, UnsignedShort=UnsignedShort, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, LinkStatus=LinkStatus, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, FirmwareRevision=FirmwareRevision, mIfNxHardwareId=mIfNxHardwareId)
