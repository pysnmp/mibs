...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, LinkStatus=LinkStatus, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, AlarmFlags=AlarmFlags, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, InitStatus=InitStatus, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, InetIpAddress=InetIpAddress, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxLastLqi=mIfNxLastLqi, mIfNxCurrentModem=mIfNxCurrentModem, DeviceModeType=DeviceModeType, mIfNxLastChan=mIfNxLastChan, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, UnsignedByte=UnsignedByte, FirmwareRevision=FirmwareRevision, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusEntry=mIfNxStatusEntry, ModemType=ModemType, mdsIfNxMIB=mdsIfNxMIB, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatus=mIfNxStatus, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxLastRssi=mIfNxLastRssi, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusTable=mIfNxStatusTable, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxConfig=mIfNxConfig, mIfNxActiveNic=mIfNxActiveNic, mIfNxInitStatus=mIfNxInitStatus, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxTemperature=mIfNxTemperature, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, UnsignedShort=UnsignedShort)
