...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, ModemType=ModemType, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxHardwareId=mIfNxHardwareId, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, DeviceModeType=DeviceModeType, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxAlarms=mIfNxAlarms, mIfNxHardwareRevision=mIfNxHardwareRevision, LinkStatus=LinkStatus, mIfNxStatusTable=mIfNxStatusTable, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, InetIpAddress=InetIpAddress, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxLastRssi=mIfNxLastRssi, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusGroup=mIfNxStatusGroup, InitStatus=InitStatus, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxConfig=mIfNxConfig, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, AlarmFlags=AlarmFlags, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, UnsignedShort=UnsignedShort, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxCompliance=mIfNxCompliance, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, UnsignedByte=UnsignedByte, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency)
