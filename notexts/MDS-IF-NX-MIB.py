...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxInitStatus=mIfNxInitStatus, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxMacStatsTxError=mIfNxMacStatsTxError, InitStatus=InitStatus, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, AlarmFlags=AlarmFlags, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxCurrentModem=mIfNxCurrentModem, UnsignedByte=UnsignedByte, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, LinkStatus=LinkStatus, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatus=mIfNxStatus, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, UnsignedShort=UnsignedShort, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, InetIpAddress=InetIpAddress, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxActiveNic=mIfNxActiveNic, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, ModemType=ModemType, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mdsIfNxMIB=mdsIfNxMIB, DeviceModeType=DeviceModeType, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync)
