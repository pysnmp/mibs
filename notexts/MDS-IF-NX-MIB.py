...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEntry=mIfNxStatusEntry, FirmwareRevision=FirmwareRevision, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, ModemType=ModemType, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxLastChan=mIfNxLastChan, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxLastLqi=mIfNxLastLqi, InitStatus=InitStatus, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxConfig=mIfNxConfig, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, InetIpAddress=InetIpAddress, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, UnsignedShort=UnsignedShort, mIfNxHardwareId=mIfNxHardwareId, LinkStatus=LinkStatus, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mdsIfNxMIB=mdsIfNxMIB, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, UnsignedByte=UnsignedByte, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, DeviceModeType=DeviceModeType, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail)
