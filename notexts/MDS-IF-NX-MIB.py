...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, InetIpAddress=InetIpAddress, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxActiveNic=mIfNxActiveNic, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, ModemType=ModemType, mIfNxMacStatsTxError=mIfNxMacStatsTxError, FirmwareRevision=FirmwareRevision, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, LinkStatus=LinkStatus, mIfNxStatusTable=mIfNxStatusTable, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, PYSNMP_MODULE_ID=mdsIfNxMIB, mdsIfNxMIBGroups=mdsIfNxMIBGroups, AlarmFlags=AlarmFlags, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxHardwareId=mIfNxHardwareId, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxSerialNumber=mIfNxSerialNumber, UnsignedShort=UnsignedShort, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, InitStatus=InitStatus, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, UnsignedByte=UnsignedByte, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode)
