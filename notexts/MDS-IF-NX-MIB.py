...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxInitStatus=mIfNxInitStatus, InetIpAddress=InetIpAddress, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEntry=mIfNxStatusEntry, UnsignedByte=UnsignedByte, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, InitStatus=InitStatus, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxCompliance=mIfNxCompliance, mIfNxTemperature=mIfNxTemperature, mIfNxActiveNic=mIfNxActiveNic, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, UnsignedShort=UnsignedShort, mIfNxConfig=mIfNxConfig, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxHardwareId=mIfNxHardwareId, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, AlarmFlags=AlarmFlags, FirmwareRevision=FirmwareRevision, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mdsIfNxMIB=mdsIfNxMIB, LinkStatus=LinkStatus, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusGroup=mIfNxStatusGroup, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, DeviceModeType=DeviceModeType, mIfNxMacStatsTxError=mIfNxMacStatsTxError, ModemType=ModemType)
