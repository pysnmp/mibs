...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, FirmwareRevision=FirmwareRevision, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, LinkStatus=LinkStatus, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, UnsignedShort=UnsignedShort, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxCompliance=mIfNxCompliance, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, ModemType=ModemType, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusTable=mIfNxStatusTable, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, InitStatus=InitStatus, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxActiveNic=mIfNxActiveNic, mIfNxInitStatus=mIfNxInitStatus, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatus=mIfNxStatus, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, AlarmFlags=AlarmFlags, mIfNxTemperature=mIfNxTemperature, mIfNxLastChan=mIfNxLastChan, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, InetIpAddress=InetIpAddress, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, UnsignedByte=UnsignedByte, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus)
