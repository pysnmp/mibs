...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, DeviceModeType=DeviceModeType, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxHardwareId=mIfNxHardwareId, mIfNxConfig=mIfNxConfig, UnsignedByte=UnsignedByte, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, UnsignedShort=UnsignedShort, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, LinkStatus=LinkStatus, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, FirmwareRevision=FirmwareRevision, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, ModemType=ModemType, InetIpAddress=InetIpAddress, InitStatus=InitStatus, AlarmFlags=AlarmFlags, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxInitStatus=mIfNxInitStatus, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxActiveNic=mIfNxActiveNic, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatus=mIfNxStatus, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp)
