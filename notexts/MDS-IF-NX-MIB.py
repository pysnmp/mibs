...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, AlarmFlags=AlarmFlags, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, ModemType=ModemType, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxSerialNumber=mIfNxSerialNumber, LinkStatus=LinkStatus, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mdsIfNxMIB=mdsIfNxMIB, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, InitStatus=InitStatus, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxApInfoApAddress=mIfNxApInfoApAddress, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, InetIpAddress=InetIpAddress, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, FirmwareRevision=FirmwareRevision, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatus=mIfNxStatus, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxInitStatus=mIfNxInitStatus, mIfNxLastChan=mIfNxLastChan, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, DeviceModeType=DeviceModeType, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, UnsignedByte=UnsignedByte, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxLastRssi=mIfNxLastRssi, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi)
