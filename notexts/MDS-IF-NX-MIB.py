...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, DeviceModeType=DeviceModeType, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, AlarmFlags=AlarmFlags, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxLastRssi=mIfNxLastRssi, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxConfig=mIfNxConfig, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, UnsignedByte=UnsignedByte, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatus=mIfNxStatus, LinkStatus=LinkStatus, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, UnsignedShort=UnsignedShort, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxTemperature=mIfNxTemperature, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxLastChan=mIfNxLastChan, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxInitStatus=mIfNxInitStatus, mdsIfNxMIB=mdsIfNxMIB, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxAlarms=mIfNxAlarms, FirmwareRevision=FirmwareRevision, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, ModemType=ModemType, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, InitStatus=InitStatus, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError)
