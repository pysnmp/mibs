...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxLinkStatus=mIfNxLinkStatus, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatus=mIfNxStatus, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxInitStatus=mIfNxInitStatus, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, AlarmFlags=AlarmFlags, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, LinkStatus=LinkStatus, mIfNxLastChan=mIfNxLastChan, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxConfig=mIfNxConfig, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxTemperature=mIfNxTemperature, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, ModemType=ModemType, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, InitStatus=InitStatus, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, UnsignedShort=UnsignedShort, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxCurrentModem=mIfNxCurrentModem, PYSNMP_MODULE_ID=mdsIfNxMIB, InetIpAddress=InetIpAddress, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, DeviceModeType=DeviceModeType, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusTable=mIfNxStatusTable, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, UnsignedByte=UnsignedByte, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus)
