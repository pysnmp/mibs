...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, InitStatus=InitStatus, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusTable=mIfNxStatusTable, mIfNxConfig=mIfNxConfig, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, InetIpAddress=InetIpAddress, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatus=mIfNxStatus, LinkStatus=LinkStatus, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, AlarmFlags=AlarmFlags, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mdsIfNxMIBConformance=mdsIfNxMIBConformance, ModemType=ModemType, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, UnsignedByte=UnsignedByte, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mdsIfNxMIB=mdsIfNxMIB, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, DeviceModeType=DeviceModeType, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup)
