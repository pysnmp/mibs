...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatus=mIfNxStatus, mIfNxActiveNic=mIfNxActiveNic, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxCompliance=mIfNxCompliance, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, LinkStatus=LinkStatus, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusActChanTable=mIfNxStatusActChanTable, UnsignedByte=UnsignedByte, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, InitStatus=InitStatus, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxInitStatus=mIfNxInitStatus, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, ModemType=ModemType, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, AlarmFlags=AlarmFlags, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, UnsignedShort=UnsignedShort, mIfNxConfig=mIfNxConfig, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, InetIpAddress=InetIpAddress, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxAlarms=mIfNxAlarms, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry)
