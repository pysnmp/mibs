...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxLastRssi=mIfNxLastRssi, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, UnsignedShort=UnsignedShort, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, UnsignedByte=UnsignedByte, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatus=mIfNxStatus, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxConfig=mIfNxConfig, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, ModemType=ModemType, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxTemperature=mIfNxTemperature, InetIpAddress=InetIpAddress, mIfNxLastLqi=mIfNxLastLqi, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, DeviceModeType=DeviceModeType, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxLinkStatus=mIfNxLinkStatus, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxMIBObjects=mIfNxMIBObjects, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, InitStatus=InitStatus, mIfNxActiveNic=mIfNxActiveNic, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusTable=mIfNxStatusTable, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, LinkStatus=LinkStatus, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxCompliance=mIfNxCompliance, mIfNxAlarms=mIfNxAlarms, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop)
