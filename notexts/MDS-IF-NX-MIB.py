...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusTable=mIfNxStatusTable, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, AlarmFlags=AlarmFlags, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxLastRssi=mIfNxLastRssi, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mdsIfNxMIB=mdsIfNxMIB, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, UnsignedByte=UnsignedByte, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxConfig=mIfNxConfig, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, InitStatus=InitStatus, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, ModemType=ModemType, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatus=mIfNxStatus, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxCompliance=mIfNxCompliance, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, LinkStatus=LinkStatus, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxMacStatsTxError=mIfNxMacStatsTxError)
