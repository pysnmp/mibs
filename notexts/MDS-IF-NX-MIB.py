...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, UnsignedByte=UnsignedByte, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, FirmwareRevision=FirmwareRevision, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusTable=mIfNxStatusTable, mIfNxAlarms=mIfNxAlarms, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, UnsignedShort=UnsignedShort, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxTemperature=mIfNxTemperature, ModemType=ModemType, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, LinkStatus=LinkStatus, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mdsIfNxMIB=mdsIfNxMIB, InetIpAddress=InetIpAddress, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, DeviceModeType=DeviceModeType, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxConfig=mIfNxConfig, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatus=mIfNxStatus, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, InitStatus=InitStatus, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxHardwareId=mIfNxHardwareId, AlarmFlags=AlarmFlags, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError)
