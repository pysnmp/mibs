...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, ModemType=ModemType, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxInitStatus=mIfNxInitStatus, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, AlarmFlags=AlarmFlags, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, InetIpAddress=InetIpAddress, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusTable=mIfNxStatusTable, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, LinkStatus=LinkStatus, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, DeviceModeType=DeviceModeType, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxTemperature=mIfNxTemperature, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, InitStatus=InitStatus, UnsignedByte=UnsignedByte, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatus=mIfNxStatus, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, FirmwareRevision=FirmwareRevision, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxApInfoApAddress=mIfNxApInfoApAddress, UnsignedShort=UnsignedShort, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxCompliance=mIfNxCompliance, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry)
