...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, AlarmFlags=AlarmFlags, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxConfig=mIfNxConfig, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, UnsignedByte=UnsignedByte, mIfNxInitStatus=mIfNxInitStatus, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, InetIpAddress=InetIpAddress, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, InitStatus=InitStatus, mIfNxLastLqi=mIfNxLastLqi, mIfNxCompliance=mIfNxCompliance, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, LinkStatus=LinkStatus, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxAlarms=mIfNxAlarms, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxActiveNic=mIfNxActiveNic, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxLastChan=mIfNxLastChan, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, DeviceModeType=DeviceModeType, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, UnsignedShort=UnsignedShort, ModemType=ModemType, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxHardwareId=mIfNxHardwareId, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr)
