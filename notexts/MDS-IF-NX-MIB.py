...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxLastChan=mIfNxLastChan, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxHardwareId=mIfNxHardwareId, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEntry=mIfNxStatusEntry, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxApInfoApAddress=mIfNxApInfoApAddress, UnsignedByte=UnsignedByte, DeviceModeType=DeviceModeType, mIfNxLastRssi=mIfNxLastRssi, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxInitStatus=mIfNxInitStatus, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusGroup=mIfNxStatusGroup, InitStatus=InitStatus, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusTable=mIfNxStatusTable, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, LinkStatus=LinkStatus, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxLinkStatus=mIfNxLinkStatus, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxCompliance=mIfNxCompliance, UnsignedShort=UnsignedShort, ModemType=ModemType, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxLastLqi=mIfNxLastLqi, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, FirmwareRevision=FirmwareRevision, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxConfig=mIfNxConfig, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, InetIpAddress=InetIpAddress)
