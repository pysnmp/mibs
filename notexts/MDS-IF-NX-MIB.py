...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxTemperature=mIfNxTemperature, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxCompliance=mIfNxCompliance, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxActiveNic=mIfNxActiveNic, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxInitStatus=mIfNxInitStatus, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatus=mIfNxStatus, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxHardwareRevision=mIfNxHardwareRevision, AlarmFlags=AlarmFlags, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, InitStatus=InitStatus, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, ModemType=ModemType, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEntry=mIfNxStatusEntry, PYSNMP_MODULE_ID=mdsIfNxMIB, FirmwareRevision=FirmwareRevision, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mdsIfNxMIB=mdsIfNxMIB, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, InetIpAddress=InetIpAddress, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxLastChan=mIfNxLastChan, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mdsIfNxMIBConformance=mdsIfNxMIBConformance, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxConfig=mIfNxConfig)
