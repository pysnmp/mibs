...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusTable=mIfNxStatusTable, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, UnsignedShort=UnsignedShort, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mdsIfNxMIB=mdsIfNxMIB, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatus=mIfNxStatus, InitStatus=InitStatus, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, UnsignedByte=UnsignedByte, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxInitStatus=mIfNxInitStatus, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxConfig=mIfNxConfig, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxLastLqi=mIfNxLastLqi, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, LinkStatus=LinkStatus, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxLastChan=mIfNxLastChan, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, ModemType=ModemType, FirmwareRevision=FirmwareRevision, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, InetIpAddress=InetIpAddress, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxTemperature=mIfNxTemperature, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes)
