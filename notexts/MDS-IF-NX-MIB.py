...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxTemperature=mIfNxTemperature, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxHardwareId=mIfNxHardwareId, InetIpAddress=InetIpAddress, mIfNxLastRssi=mIfNxLastRssi, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxLastLqi=mIfNxLastLqi, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxConfig=mIfNxConfig, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, ModemType=ModemType, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxLastChan=mIfNxLastChan, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusActChanTable=mIfNxStatusActChanTable, UnsignedByte=UnsignedByte, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, FirmwareRevision=FirmwareRevision, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEntry=mIfNxStatusEntry, LinkStatus=LinkStatus, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, InitStatus=InitStatus, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxAlarms=mIfNxAlarms, mIfNxActiveNic=mIfNxActiveNic, DeviceModeType=DeviceModeType, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxCompliance=mIfNxCompliance, AlarmFlags=AlarmFlags, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusTable=mIfNxStatusTable, mIfNxInitStatus=mIfNxInitStatus, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, UnsignedShort=UnsignedShort, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId)
