...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxInitStatus=mIfNxInitStatus, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, InetIpAddress=InetIpAddress, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, DeviceModeType=DeviceModeType, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatus=mIfNxStatus, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, LinkStatus=LinkStatus, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxLastLqi=mIfNxLastLqi, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, ModemType=ModemType, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, AlarmFlags=AlarmFlags, FirmwareRevision=FirmwareRevision, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, UnsignedShort=UnsignedShort, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxConfig=mIfNxConfig, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxCompliance=mIfNxCompliance, mIfNxStatusGroup=mIfNxStatusGroup, InitStatus=InitStatus, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, UnsignedByte=UnsignedByte, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxActiveNic=mIfNxActiveNic)
