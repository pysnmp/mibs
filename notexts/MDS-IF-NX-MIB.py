...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxCurrentModem=mIfNxCurrentModem, LinkStatus=LinkStatus, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, AlarmFlags=AlarmFlags, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, InetIpAddress=InetIpAddress, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxAlarms=mIfNxAlarms, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxCompliance=mIfNxCompliance, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxLastRssi=mIfNxLastRssi, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, UnsignedShort=UnsignedShort, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxLinkStatus=mIfNxLinkStatus, DeviceModeType=DeviceModeType, InitStatus=InitStatus, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, ModemType=ModemType, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull)
