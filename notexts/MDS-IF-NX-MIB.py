...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mdsIfNxMIB=mdsIfNxMIB, ModemType=ModemType, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, UnsignedByte=UnsignedByte, DeviceModeType=DeviceModeType, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusTable=mIfNxStatusTable, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxLastRssi=mIfNxLastRssi, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, FirmwareRevision=FirmwareRevision, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, InetIpAddress=InetIpAddress, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusGroup=mIfNxStatusGroup, AlarmFlags=AlarmFlags, mIfNxLastLqi=mIfNxLastLqi, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mdsIfNxMIBGroups=mdsIfNxMIBGroups, LinkStatus=LinkStatus, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatus=mIfNxStatus, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, InitStatus=InitStatus, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxAlarms=mIfNxAlarms, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, UnsignedShort=UnsignedShort, mIfNxInitStatus=mIfNxInitStatus, mIfNxConfig=mIfNxConfig, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi)
