...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxLastRssi=mIfNxLastRssi, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusTable=mIfNxStatusTable, AlarmFlags=AlarmFlags, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, DeviceModeType=DeviceModeType, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, LinkStatus=LinkStatus, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxConfig=mIfNxConfig, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxLastChan=mIfNxLastChan, mIfNxInitStatus=mIfNxInitStatus, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatus=mIfNxStatus, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, InitStatus=InitStatus, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, InetIpAddress=InetIpAddress, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxCompliance=mIfNxCompliance, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, ModemType=ModemType, UnsignedShort=UnsignedShort, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, FirmwareRevision=FirmwareRevision, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxHardwareId=mIfNxHardwareId)
