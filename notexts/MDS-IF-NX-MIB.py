...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, UnsignedShort=UnsignedShort, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, AlarmFlags=AlarmFlags, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, ModemType=ModemType, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxActiveNic=mIfNxActiveNic, mIfNxInitStatus=mIfNxInitStatus, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxCurrentModem=mIfNxCurrentModem, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxSerialNumber=mIfNxSerialNumber, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, InitStatus=InitStatus, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, LinkStatus=LinkStatus, UnsignedByte=UnsignedByte, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusActChanTable=mIfNxStatusActChanTable, DeviceModeType=DeviceModeType, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, FirmwareRevision=FirmwareRevision, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mdsIfNxMIB=mdsIfNxMIB, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxApInfoApAddress=mIfNxApInfoApAddress)
