...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEntry=mIfNxStatusEntry, AlarmFlags=AlarmFlags, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxConfig=mIfNxConfig, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxCompliance=mIfNxCompliance, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxAlarms=mIfNxAlarms, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusGroup=mIfNxStatusGroup, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, UnsignedByte=UnsignedByte, mIfNxCurrentModem=mIfNxCurrentModem, DeviceModeType=DeviceModeType, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, LinkStatus=LinkStatus, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, InitStatus=InitStatus, ModemType=ModemType, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, InetIpAddress=InetIpAddress, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsTxError=mIfNxMacStatsTxError, FirmwareRevision=FirmwareRevision)
