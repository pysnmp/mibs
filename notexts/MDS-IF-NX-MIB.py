...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxLastChan=mIfNxLastChan, UnsignedShort=UnsignedShort, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxActiveNic=mIfNxActiveNic, ModemType=ModemType, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxLastLqi=mIfNxLastLqi, FirmwareRevision=FirmwareRevision, mIfNxAlarms=mIfNxAlarms, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, DeviceModeType=DeviceModeType, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, InitStatus=InitStatus, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxCompliance=mIfNxCompliance, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusActChanTable=mIfNxStatusActChanTable, AlarmFlags=AlarmFlags, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatus=mIfNxStatus, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxCurrentModem=mIfNxCurrentModem, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, InetIpAddress=InetIpAddress, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxMIBObjects=mIfNxMIBObjects, LinkStatus=LinkStatus, mIfNxInitStatus=mIfNxInitStatus, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry)
