...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxActiveNic=mIfNxActiveNic, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxAlarms=mIfNxAlarms, InetIpAddress=InetIpAddress, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusTable=mIfNxStatusTable, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, UnsignedByte=UnsignedByte, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, DeviceModeType=DeviceModeType, ModemType=ModemType, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxInitStatus=mIfNxInitStatus, AlarmFlags=AlarmFlags, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, InitStatus=InitStatus, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mdsIfNxMIB=mdsIfNxMIB, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, FirmwareRevision=FirmwareRevision, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, LinkStatus=LinkStatus, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxLastChan=mIfNxLastChan, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError)
