...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxAlarms=mIfNxAlarms, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, AlarmFlags=AlarmFlags, mIfNxActiveNic=mIfNxActiveNic, UnsignedByte=UnsignedByte, mIfNxHardwareId=mIfNxHardwareId, LinkStatus=LinkStatus, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, DeviceModeType=DeviceModeType, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, InitStatus=InitStatus, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mdsIfNxMIB=mdsIfNxMIB, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, InetIpAddress=InetIpAddress, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, UnsignedShort=UnsignedShort, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, FirmwareRevision=FirmwareRevision, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxConfig=mIfNxConfig, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxApInfoApAddress=mIfNxApInfoApAddress, ModemType=ModemType, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi)
