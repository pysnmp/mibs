...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusTable=mIfNxStatusTable, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxHardwareId=mIfNxHardwareId, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mdsIfNxMIBConformance=mdsIfNxMIBConformance, UnsignedByte=UnsignedByte, InetIpAddress=InetIpAddress, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, ModemType=ModemType, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, DeviceModeType=DeviceModeType, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, AlarmFlags=AlarmFlags, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusActChanTable=mIfNxStatusActChanTable, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxActiveNic=mIfNxActiveNic, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatus=mIfNxStatus, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxLastRssi=mIfNxLastRssi, LinkStatus=LinkStatus, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxLastLqi=mIfNxLastLqi, mIfNxTemperature=mIfNxTemperature, mdsIfNxMIBGroups=mdsIfNxMIBGroups, InitStatus=InitStatus, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, UnsignedShort=UnsignedShort, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime)
