...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxInitStatus=mIfNxInitStatus, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, LinkStatus=LinkStatus, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxLastLqi=mIfNxLastLqi, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxConfig=mIfNxConfig, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, InetIpAddress=InetIpAddress, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, UnsignedShort=UnsignedShort, InitStatus=InitStatus, mIfNxStatusTable=mIfNxStatusTable, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, FirmwareRevision=FirmwareRevision, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, AlarmFlags=AlarmFlags, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, DeviceModeType=DeviceModeType, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxAlarms=mIfNxAlarms, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxHardwareId=mIfNxHardwareId, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, ModemType=ModemType, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes)
