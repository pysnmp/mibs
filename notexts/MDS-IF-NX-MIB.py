...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxConfig=mIfNxConfig, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxSerialNumber=mIfNxSerialNumber, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxTemperature=mIfNxTemperature, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxAlarms=mIfNxAlarms, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatus=mIfNxStatus, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, InetIpAddress=InetIpAddress, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, DeviceModeType=DeviceModeType, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, LinkStatus=LinkStatus, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusTable=mIfNxStatusTable, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxFirmwareRevision=mIfNxFirmwareRevision, UnsignedShort=UnsignedShort, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxLastLqi=mIfNxLastLqi, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxLastChan=mIfNxLastChan, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, InitStatus=InitStatus, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mdsIfNxMIB=mdsIfNxMIB, PYSNMP_MODULE_ID=mdsIfNxMIB, ModemType=ModemType, mIfNxActiveNic=mIfNxActiveNic, AlarmFlags=AlarmFlags, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp)
