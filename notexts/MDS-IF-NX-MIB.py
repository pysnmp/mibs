...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, DeviceModeType=DeviceModeType, mIfNxConfig=mIfNxConfig, mIfNxLastRssi=mIfNxLastRssi, mIfNxLastChan=mIfNxLastChan, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, UnsignedByte=UnsignedByte, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxAlarms=mIfNxAlarms, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mdsIfNxMIB=mdsIfNxMIB, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, InetIpAddress=InetIpAddress, ModemType=ModemType, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxCurrentModem=mIfNxCurrentModem, AlarmFlags=AlarmFlags, LinkStatus=LinkStatus, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxLastLqi=mIfNxLastLqi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxCompliance=mIfNxCompliance, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, UnsignedShort=UnsignedShort, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, InitStatus=InitStatus, mIfNxStatusGroup=mIfNxStatusGroup, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatus=mIfNxStatus, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxTemperature=mIfNxTemperature, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc)
