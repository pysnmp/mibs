...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, InitStatus=InitStatus, ModemType=ModemType, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxMIBObjects=mIfNxMIBObjects, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, InetIpAddress=InetIpAddress, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatus=mIfNxStatus, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxLastRssi=mIfNxLastRssi, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, UnsignedByte=UnsignedByte, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, LinkStatus=LinkStatus, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxTemperature=mIfNxTemperature, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusTable=mIfNxStatusTable, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxCurrentModem=mIfNxCurrentModem, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxCompliance=mIfNxCompliance, DeviceModeType=DeviceModeType, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxConfig=mIfNxConfig, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess)
