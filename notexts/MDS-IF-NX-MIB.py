...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, LinkStatus=LinkStatus, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxTemperature=mIfNxTemperature, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusActChanTable=mIfNxStatusActChanTable, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, InitStatus=InitStatus, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, AlarmFlags=AlarmFlags, InetIpAddress=InetIpAddress, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxAlarms=mIfNxAlarms, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxLastChan=mIfNxLastChan, mIfNxCompliance=mIfNxCompliance, UnsignedByte=UnsignedByte, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxInitStatus=mIfNxInitStatus, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxMacStatsTxError=mIfNxMacStatsTxError, FirmwareRevision=FirmwareRevision, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatus=mIfNxStatus, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxConfig=mIfNxConfig, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, ModemType=ModemType, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull)
