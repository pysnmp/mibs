...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxCompliance=mIfNxCompliance, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxInitStatus=mIfNxInitStatus, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, AlarmFlags=AlarmFlags, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, ModemType=ModemType, InetIpAddress=InetIpAddress, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, InitStatus=InitStatus, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, UnsignedShort=UnsignedShort, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusGroup=mIfNxStatusGroup, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, FirmwareRevision=FirmwareRevision, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxHardwareId=mIfNxHardwareId, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, UnsignedByte=UnsignedByte, LinkStatus=LinkStatus, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry)
