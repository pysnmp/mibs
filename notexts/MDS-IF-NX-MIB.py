...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, DeviceModeType=DeviceModeType, UnsignedByte=UnsignedByte, mIfNxHardwareRevision=mIfNxHardwareRevision, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxCompliance=mIfNxCompliance, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxSerialNumber=mIfNxSerialNumber, ModemType=ModemType, mIfNxLastRssi=mIfNxLastRssi, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mdsIfNxMIB=mdsIfNxMIB, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxApInfoApAddress=mIfNxApInfoApAddress, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, FirmwareRevision=FirmwareRevision, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, InetIpAddress=InetIpAddress, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, InitStatus=InitStatus, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatus=mIfNxStatus, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxLastChan=mIfNxLastChan, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxActiveNic=mIfNxActiveNic, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, LinkStatus=LinkStatus, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress)
