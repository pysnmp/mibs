...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, ModemType=ModemType, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxCompliance=mIfNxCompliance, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxMacStatsTxError=mIfNxMacStatsTxError, AlarmFlags=AlarmFlags, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxAlarms=mIfNxAlarms, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, UnsignedByte=UnsignedByte, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusEntry=mIfNxStatusEntry, DeviceModeType=DeviceModeType, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, InetIpAddress=InetIpAddress, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, InitStatus=InitStatus, mIfNxLastRssi=mIfNxLastRssi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxLastChan=mIfNxLastChan, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, FirmwareRevision=FirmwareRevision, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxHardwareId=mIfNxHardwareId, mIfNxConfig=mIfNxConfig, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxActiveNic=mIfNxActiveNic)
