...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxLastRssi=mIfNxLastRssi, AlarmFlags=AlarmFlags, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, InitStatus=InitStatus, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxLastChan=mIfNxLastChan, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxAlarms=mIfNxAlarms, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxInitStatus=mIfNxInitStatus, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxConfig=mIfNxConfig, FirmwareRevision=FirmwareRevision, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, DeviceModeType=DeviceModeType, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxLastLqi=mIfNxLastLqi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, UnsignedShort=UnsignedShort, LinkStatus=LinkStatus, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxHardwareId=mIfNxHardwareId, UnsignedByte=UnsignedByte, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, ModemType=ModemType, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry)
