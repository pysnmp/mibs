...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxActiveNic=mIfNxActiveNic, mIfNxCompliance=mIfNxCompliance, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, LinkStatus=LinkStatus, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, UnsignedShort=UnsignedShort, mIfNxConfig=mIfNxConfig, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, ModemType=ModemType, mIfNxLastChan=mIfNxLastChan, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxInitStatus=mIfNxInitStatus, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusTable=mIfNxStatusTable, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxApInfoApAddress=mIfNxApInfoApAddress, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, AlarmFlags=AlarmFlags, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxLastLqi=mIfNxLastLqi, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, InitStatus=InitStatus, UnsignedByte=UnsignedByte, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp)
