...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, InetIpAddress=InetIpAddress, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxFirmwareRevision=mIfNxFirmwareRevision, FirmwareRevision=FirmwareRevision, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxLastLqi=mIfNxLastLqi, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxLastRssi=mIfNxLastRssi, ModemType=ModemType, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, DeviceModeType=DeviceModeType, LinkStatus=LinkStatus, mIfNxActiveNic=mIfNxActiveNic, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxConfig=mIfNxConfig, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, PYSNMP_MODULE_ID=mdsIfNxMIB, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, UnsignedShort=UnsignedShort, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mdsIfNxMIB=mdsIfNxMIB, mIfNxAlarms=mIfNxAlarms, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, InitStatus=InitStatus, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxInitStatus=mIfNxInitStatus, mIfNxTemperature=mIfNxTemperature, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxApInfoApAddress=mIfNxApInfoApAddress)
