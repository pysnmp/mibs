...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, AlarmFlags=AlarmFlags, mdsIfNxMIBGroups=mdsIfNxMIBGroups, ModemType=ModemType, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxInitStatus=mIfNxInitStatus, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mdsIfNxMIB=mdsIfNxMIB, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxTemperature=mIfNxTemperature, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxLastChan=mIfNxLastChan, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, DeviceModeType=DeviceModeType, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusActChanTable=mIfNxStatusActChanTable, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatus=mIfNxStatus, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, InitStatus=InitStatus, InetIpAddress=InetIpAddress, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxLastLqi=mIfNxLastLqi, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxCompliance=mIfNxCompliance, mIfNxConfig=mIfNxConfig, UnsignedByte=UnsignedByte, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxAlarms=mIfNxAlarms, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxActiveNic=mIfNxActiveNic, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi)
