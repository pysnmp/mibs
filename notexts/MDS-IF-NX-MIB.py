...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxTemperature=mIfNxTemperature, UnsignedByte=UnsignedByte, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, UnsignedShort=UnsignedShort, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, PYSNMP_MODULE_ID=mdsIfNxMIB, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, FirmwareRevision=FirmwareRevision, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusActChanTable=mIfNxStatusActChanTable, InitStatus=InitStatus, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, AlarmFlags=AlarmFlags, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mdsIfNxMIB=mdsIfNxMIB, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxCompliance=mIfNxCompliance, LinkStatus=LinkStatus, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxInitStatus=mIfNxInitStatus, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusTable=mIfNxStatusTable, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxConfig=mIfNxConfig, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, DeviceModeType=DeviceModeType, mIfNxFirmwareRevision=mIfNxFirmwareRevision, ModemType=ModemType)
