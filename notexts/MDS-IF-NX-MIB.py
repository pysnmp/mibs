...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, DeviceModeType=DeviceModeType, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxLastLqi=mIfNxLastLqi, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxHardwareId=mIfNxHardwareId, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, AlarmFlags=AlarmFlags, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, UnsignedShort=UnsignedShort, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxActiveNic=mIfNxActiveNic, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusTable=mIfNxStatusTable, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxCompliance=mIfNxCompliance, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, FirmwareRevision=FirmwareRevision, InitStatus=InitStatus, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, InetIpAddress=InetIpAddress, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxAlarms=mIfNxAlarms, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxConfig=mIfNxConfig, ModemType=ModemType, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxHardwareRevision=mIfNxHardwareRevision, UnsignedByte=UnsignedByte, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatus=mIfNxStatus, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress)
