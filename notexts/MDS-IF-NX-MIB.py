...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxFirmwareRevision=mIfNxFirmwareRevision, DeviceModeType=DeviceModeType, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusTable=mIfNxStatusTable, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mdsIfNxMIB=mdsIfNxMIB, InitStatus=InitStatus, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, AlarmFlags=AlarmFlags, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, InetIpAddress=InetIpAddress, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, UnsignedByte=UnsignedByte, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatus=mIfNxStatus, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, ModemType=ModemType, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxInitStatus=mIfNxInitStatus, mIfNxHardwareId=mIfNxHardwareId, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxLastRssi=mIfNxLastRssi, UnsignedShort=UnsignedShort, mIfNxConfig=mIfNxConfig, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxTemperature=mIfNxTemperature, mIfNxAlarms=mIfNxAlarms, mIfNxLastChan=mIfNxLastChan, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxLastLqi=mIfNxLastLqi, mIfNxCompliance=mIfNxCompliance, FirmwareRevision=FirmwareRevision, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry)
