...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxAlarms=mIfNxAlarms, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxFirmwareRevision=mIfNxFirmwareRevision, FirmwareRevision=FirmwareRevision, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, UnsignedByte=UnsignedByte, mIfNxStatus=mIfNxStatus, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxLastRssi=mIfNxLastRssi, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxLastLqi=mIfNxLastLqi, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxCompliance=mIfNxCompliance, mdsIfNxMIBConformance=mdsIfNxMIBConformance, InitStatus=InitStatus, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, DeviceModeType=DeviceModeType, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, AlarmFlags=AlarmFlags, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, InetIpAddress=InetIpAddress, mIfNxActiveNic=mIfNxActiveNic, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEntry=mIfNxStatusEntry, mdsIfNxMIB=mdsIfNxMIB, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxConfig=mIfNxConfig, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxLastChan=mIfNxLastChan, ModemType=ModemType, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, UnsignedShort=UnsignedShort, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxHardwareId=mIfNxHardwareId, mIfNxApInfoApAddress=mIfNxApInfoApAddress)
