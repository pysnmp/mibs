...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, AlarmFlags=AlarmFlags, mIfNxCompliance=mIfNxCompliance, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxTemperature=mIfNxTemperature, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxFirmwareRevision=mIfNxFirmwareRevision, UnsignedShort=UnsignedShort, FirmwareRevision=FirmwareRevision, mIfNxLastLqi=mIfNxLastLqi, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxActiveNic=mIfNxActiveNic, mIfNxConfig=mIfNxConfig, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatus=mIfNxStatus, DeviceModeType=DeviceModeType, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusTable=mIfNxStatusTable, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, InetIpAddress=InetIpAddress, ModemType=ModemType, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, InitStatus=InitStatus, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, LinkStatus=LinkStatus, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusGroup=mIfNxStatusGroup, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets)
