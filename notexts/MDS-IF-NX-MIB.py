...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatus=mIfNxStatus, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxInitStatus=mIfNxInitStatus, DeviceModeType=DeviceModeType, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, PYSNMP_MODULE_ID=mdsIfNxMIB, FirmwareRevision=FirmwareRevision, mIfNxAlarms=mIfNxAlarms, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxHardwareId=mIfNxHardwareId, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, ModemType=ModemType, mIfNxActiveNic=mIfNxActiveNic, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, LinkStatus=LinkStatus, UnsignedShort=UnsignedShort, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, InetIpAddress=InetIpAddress, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, InitStatus=InitStatus, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxLastRssi=mIfNxLastRssi, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull)
