...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, InitStatus=InitStatus, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxInitStatus=mIfNxInitStatus, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, LinkStatus=LinkStatus, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, InetIpAddress=InetIpAddress, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, ModemType=ModemType, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, AlarmFlags=AlarmFlags, DeviceModeType=DeviceModeType, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxAlarms=mIfNxAlarms, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, UnsignedByte=UnsignedByte, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, UnsignedShort=UnsignedShort, mIfNxActiveNic=mIfNxActiveNic, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry)
