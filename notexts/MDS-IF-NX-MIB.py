...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatus=mIfNxStatus, mIfNxCompliance=mIfNxCompliance, mIfNxCurrentModem=mIfNxCurrentModem, ModemType=ModemType, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, InetIpAddress=InetIpAddress, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, InitStatus=InitStatus, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, UnsignedByte=UnsignedByte, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, DeviceModeType=DeviceModeType, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, AlarmFlags=AlarmFlags, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, FirmwareRevision=FirmwareRevision, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxLastRssi=mIfNxLastRssi, LinkStatus=LinkStatus, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusTable=mIfNxStatusTable, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp)
