...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, ModemType=ModemType, mIfNxAlarms=mIfNxAlarms, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, InetIpAddress=InetIpAddress, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusTable=mIfNxStatusTable, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, UnsignedByte=UnsignedByte, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mdsIfNxMIBGroups=mdsIfNxMIBGroups, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, DeviceModeType=DeviceModeType, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatus=mIfNxStatus, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, InitStatus=InitStatus, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxLastChan=mIfNxLastChan, UnsignedShort=UnsignedShort, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusActChanTable=mIfNxStatusActChanTable, AlarmFlags=AlarmFlags, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, LinkStatus=LinkStatus, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode)
