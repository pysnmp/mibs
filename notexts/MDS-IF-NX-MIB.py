...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxHardwareId=mIfNxHardwareId, mIfNxLastLqi=mIfNxLastLqi, mIfNxLinkStatus=mIfNxLinkStatus, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, UnsignedByte=UnsignedByte, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, UnsignedShort=UnsignedShort, mIfNxInitStatus=mIfNxInitStatus, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatus=mIfNxStatus, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMIBObjects=mIfNxMIBObjects, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxLastChan=mIfNxLastChan, mIfNxAlarms=mIfNxAlarms, ModemType=ModemType, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, PYSNMP_MODULE_ID=mdsIfNxMIB, mdsIfNxMIB=mdsIfNxMIB, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxActiveNic=mIfNxActiveNic, mIfNxSerialNumber=mIfNxSerialNumber, DeviceModeType=DeviceModeType, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, InetIpAddress=InetIpAddress, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, InitStatus=InitStatus, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry)
