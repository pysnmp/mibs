...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, LinkStatus=LinkStatus, ModemType=ModemType, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxHardwareId=mIfNxHardwareId, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxLastLqi=mIfNxLastLqi, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, DeviceModeType=DeviceModeType, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxConfig=mIfNxConfig, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxAlarms=mIfNxAlarms, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, InetIpAddress=InetIpAddress, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, InitStatus=InitStatus, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxCompliance=mIfNxCompliance, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxTemperature=mIfNxTemperature, UnsignedByte=UnsignedByte, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, FirmwareRevision=FirmwareRevision, mIfNxStatus=mIfNxStatus, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxLastChan=mIfNxLastChan, UnsignedShort=UnsignedShort, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr)
