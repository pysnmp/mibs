...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxHardwareRevision=mIfNxHardwareRevision, AlarmFlags=AlarmFlags, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, DeviceModeType=DeviceModeType, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, InitStatus=InitStatus, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxLastLqi=mIfNxLastLqi, ModemType=ModemType, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, UnsignedByte=UnsignedByte, FirmwareRevision=FirmwareRevision, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxLastChan=mIfNxLastChan, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxConfig=mIfNxConfig, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, InetIpAddress=InetIpAddress, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mdsIfNxMIB=mdsIfNxMIB, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, UnsignedShort=UnsignedShort, LinkStatus=LinkStatus, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxSerialNumber=mIfNxSerialNumber)
