...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", LinkStatus=LinkStatus, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxAlarms=mIfNxAlarms, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatus=mIfNxStatus, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, FirmwareRevision=FirmwareRevision, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxTemperature=mIfNxTemperature, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, AlarmFlags=AlarmFlags, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxMIBObjects=mIfNxMIBObjects, UnsignedByte=UnsignedByte, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, UnsignedShort=UnsignedShort, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxLastChan=mIfNxLastChan, InetIpAddress=InetIpAddress, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxConfig=mIfNxConfig, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusGroup=mIfNxStatusGroup, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, ModemType=ModemType, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxInitStatus=mIfNxInitStatus, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mdsIfNxMIB=mdsIfNxMIB, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, DeviceModeType=DeviceModeType, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, InitStatus=InitStatus, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxHardwareId=mIfNxHardwareId)
