...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", InetIpAddress=InetIpAddress, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxTemperature=mIfNxTemperature, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, ModemType=ModemType, mIfNxMIBObjects=mIfNxMIBObjects, InitStatus=InitStatus, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxAlarms=mIfNxAlarms, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, UnsignedByte=UnsignedByte, mIfNxLastLqi=mIfNxLastLqi, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, PYSNMP_MODULE_ID=mdsIfNxMIB, UnsignedShort=UnsignedShort, LinkStatus=LinkStatus, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusTable=mIfNxStatusTable, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxLastChan=mIfNxLastChan, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mdsIfNxMIBGroups=mdsIfNxMIBGroups, AlarmFlags=AlarmFlags, FirmwareRevision=FirmwareRevision, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxCompliance=mIfNxCompliance, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive)
