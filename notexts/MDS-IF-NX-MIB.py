...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxHardwareId=mIfNxHardwareId, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, InetIpAddress=InetIpAddress, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxInitStatus=mIfNxInitStatus, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxLinkStatus=mIfNxLinkStatus, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxMIBObjects=mIfNxMIBObjects, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxConfig=mIfNxConfig, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusTable=mIfNxStatusTable, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxLastRssi=mIfNxLastRssi, LinkStatus=LinkStatus, UnsignedShort=UnsignedShort, UnsignedByte=UnsignedByte, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, InitStatus=InitStatus, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, DeviceModeType=DeviceModeType, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxAlarms=mIfNxAlarms, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxLastChan=mIfNxLastChan, ModemType=ModemType, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxCompliance=mIfNxCompliance, AlarmFlags=AlarmFlags, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets)
