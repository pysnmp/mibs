...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusActChanTable=mIfNxStatusActChanTable, AlarmFlags=AlarmFlags, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatus=mIfNxStatus, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxCurrentModem=mIfNxCurrentModem, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxFirmwareRevision=mIfNxFirmwareRevision, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxActiveNic=mIfNxActiveNic, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxConfig=mIfNxConfig, LinkStatus=LinkStatus, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, InetIpAddress=InetIpAddress, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxCompliance=mIfNxCompliance, DeviceModeType=DeviceModeType, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, UnsignedShort=UnsignedShort, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, ModemType=ModemType, UnsignedByte=UnsignedByte, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, InitStatus=InitStatus, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxInitStatus=mIfNxInitStatus, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets)
