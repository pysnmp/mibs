...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, DeviceModeType=DeviceModeType, mIfNxHardwareRevision=mIfNxHardwareRevision, InitStatus=InitStatus, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxTemperature=mIfNxTemperature, ModemType=ModemType, InetIpAddress=InetIpAddress, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusTable=mIfNxStatusTable, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, UnsignedByte=UnsignedByte, mIfNxAlarms=mIfNxAlarms, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxActiveNic=mIfNxActiveNic, LinkStatus=LinkStatus, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, UnsignedShort=UnsignedShort, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxCompliance=mIfNxCompliance, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxLastLqi=mIfNxLastLqi, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, FirmwareRevision=FirmwareRevision, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, PYSNMP_MODULE_ID=mdsIfNxMIB)
