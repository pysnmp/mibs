...
# ASN.1 source MDS-IF-NX-MIB
# Source digest sha256:93d17c21761126eeb4b309167f05d51bc4791eff20f871a91fee86092a9cc78d
...
if mibBuilder.loadTexts: mdsIfNxMIB.setLastUpdated('2018-05-16 00:00')
...
mIfNxStatusTable = MibTable((1, 3, 6, 1, 4, 1, 4130, 10, 2, 3, 1, 2, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: mIfNxStatusTable.setStatus('current')
mIfNxStatusEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4130, 10, 2, 3, 1, 2, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "IF-MIB", "ifIndex"))
...
mIfNxStatusConnRemTable = MibTable((1, 3, 6, 1, 4, 1, 4130, 10, 2, 3, 1, 2, 2), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: mIfNxStatusConnRemTable.setStatus('current')
mIfNxStatusConnRemEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4130, 10, 2, 3, 1, 2, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "IF-MIB", "ifIndex"), (0, "MDS-IF-NX-MIB", "mIfNxStatusConnRemAddress"))
...
mIfNxStatusEndpointTable = MibTable((1, 3, 6, 1, 4, 1, 4130, 10, 2, 3, 1, 2, 3), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: mIfNxStatusEndpointTable.setStatus('current')
mIfNxStatusEndpointEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4130, 10, 2, 3, 1, 2, 3, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "IF-MIB", "ifIndex"), (0, "MDS-IF-NX-MIB", "mIfNxStatusEndpointAddress"))
...
mIfNxStatusActChanTable = MibTable((1, 3, 6, 1, 4, 1, 4130, 10, 2, 3, 1, 2, 4), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: mIfNxStatusActChanTable.setStatus('current')
mIfNxStatusActChanEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4130, 10, 2, 3, 1, 2, 4, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "IF-MIB", "ifIndex"), (0, "MDS-IF-NX-MIB", "mIfNxStatusActChanChannel"))
...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", AlarmFlags=AlarmFlags, DeviceModeType=DeviceModeType, FirmwareRevision=FirmwareRevision, InetIpAddress=InetIpAddress, InitStatus=InitStatus, LinkStatus=LinkStatus, ModemType=ModemType, PYSNMP_MODULE_ID=mdsIfNxMIB, UnsignedByte=UnsignedByte, UnsignedShort=UnsignedShort, mIfNxActiveNic=mIfNxActiveNic, mIfNxAlarms=mIfNxAlarms, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxCompliance=mIfNxCompliance, mIfNxConfig=mIfNxConfig, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxHardwareId=mIfNxHardwareId, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxInitStatus=mIfNxInitStatus, mIfNxLastChan=mIfNxLastChan, mIfNxLastLqi=mIfNxLastLqi, mIfNxLastRssi=mIfNxLastRssi, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatus=mIfNxStatus, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusTable=mIfNxStatusTable, mIfNxTemperature=mIfNxTemperature, mdsIfNxMIB=mdsIfNxMIB, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mdsIfNxMIBGroups=mdsIfNxMIBGroups)
