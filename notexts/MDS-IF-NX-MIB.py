...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxActiveNic=mIfNxActiveNic, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, InitStatus=InitStatus, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, ModemType=ModemType, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, UnsignedShort=UnsignedShort, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxConfig=mIfNxConfig, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatus=mIfNxStatus, AlarmFlags=AlarmFlags, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, InetIpAddress=InetIpAddress, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, FirmwareRevision=FirmwareRevision, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, LinkStatus=LinkStatus, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxLinkStatus=mIfNxLinkStatus, DeviceModeType=DeviceModeType, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxInitStatus=mIfNxInitStatus)
