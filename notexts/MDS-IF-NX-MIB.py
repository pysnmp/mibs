...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEntry=mIfNxStatusEntry, InetIpAddress=InetIpAddress, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxHardwareId=mIfNxHardwareId, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxLastLqi=mIfNxLastLqi, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxAlarms=mIfNxAlarms, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, UnsignedByte=UnsignedByte, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, LinkStatus=LinkStatus, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, UnsignedShort=UnsignedShort, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, DeviceModeType=DeviceModeType, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, InitStatus=InitStatus, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusGroup=mIfNxStatusGroup, AlarmFlags=AlarmFlags, mIfNxConfig=mIfNxConfig, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, FirmwareRevision=FirmwareRevision, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, ModemType=ModemType, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatus=mIfNxStatus, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusActChanTable=mIfNxStatusActChanTable)
