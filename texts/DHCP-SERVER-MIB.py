...
# ASN.1 source DHCP-SERVER-MIB
# Source digest sha256:6b7679cd58dd49222d84855c56b6c0ce300f4e47735a477743eeafe8d4c8f616
...
if mibBuilder.loadTexts: dhcpServMib.setLastUpdated('1906-06-22 08:30')
...
dhcpServRangeTable = MibTable((1, 3, 6, 1, 4, 1, 1751, 1, 48, 1, 1, 1, 1, 7, 2), ).setMaxAccess("notaccessible")
...
dhcpServRangeEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1751, 1, 48, 1, 1, 1, 1, 7, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "DHCP-SERVER-MIB", "dhcpServRangeSubnetAddr"), (0, "DHCP-SERVER-MIB", "dhcpServRangeStart"))
...
dhcpServFailoverTable = MibTable((1, 3, 6, 1, 4, 1, 1751, 1, 48, 1, 1, 1, 1, 8, 1), ).setMaxAccess("notaccessible")
...
dhcpServFailoverEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1751, 1, 48, 1, 1, 1, 1, 8, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "DHCP-SERVER-MIB", "dhcpServFailoverPartnerAddr"))
...
ipspgDhcpTrapTable = MibTable((1, 3, 6, 1, 4, 1, 1751, 1, 48, 2, 1), ).setMaxAccess("notaccessible")
...
ipspgDhcpTrapEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1751, 1, 48, 2, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "DHCP-SERVER-MIB", "ipspgDhcpTrIndex"))
...
mibBuilder.exportSymbols("DHCP-SERVER-MIB", DhcpServTimeInterval=DhcpServTimeInterval, PYSNMP_MODULE_ID=dhcpServMib, dhcpServBootpCountDroppedNotServingSubnet=dhcpServBootpCountDroppedNotServingSubnet, dhcpServBootpCountDroppedUnknownClients=dhcpServBootpCountDroppedUnknownClients, dhcpServBootpCountInvalids=dhcpServBootpCountInvalids, dhcpServBootpCountReplies=dhcpServBootpCountReplies, dhcpServBootpCountRequests=dhcpServBootpCountRequests, dhcpServBootpCounters=dhcpServBootpCounters, dhcpServBootpStatLastArrivalTime=dhcpServBootpStatLastArrivalTime, dhcpServBootpStatMaxArrivalInterval=dhcpServBootpStatMaxArrivalInterval, dhcpServBootpStatMaxResponseTime=dhcpServBootpStatMaxResponseTime, dhcpServBootpStatMinArrivalInterval=dhcpServBootpStatMinArrivalInterval, dhcpServBootpStatMinResponseTime=dhcpServBootpStatMinResponseTime, dhcpServBootpStatSumResponseTime=dhcpServBootpStatSumResponseTime, dhcpServBootpStatistics=dhcpServBootpStatistics, dhcpServConfiguration=dhcpServConfiguration, dhcpServCountFullSubnets=dhcpServCountFullSubnets, dhcpServCountUnusedSubnets=dhcpServCountUnusedSubnets, dhcpServCountUsedSubnets=dhcpServCountUsedSubnets, dhcpServDhcpCountAcks=dhcpServDhcpCountAcks, dhcpServDhcpCountDeclines=dhcpServDhcpCountDeclines, dhcpServDhcpCountDiscovers=dhcpServDhcpCountDiscovers, dhcpServDhcpCountDroppedNotServingSubnet=dhcpServDhcpCountDroppedNotServingSubnet, dhcpServDhcpCountDroppedUnknownClient=dhcpServDhcpCountDroppedUnknownClient, dhcpServDhcpCountInforms=dhcpServDhcpCountInforms, dhcpServDhcpCountInvalids=dhcpServDhcpCountInvalids, dhcpServDhcpCountNacks=dhcpServDhcpCountNacks, dhcpServDhcpCountOffers=dhcpServDhcpCountOffers, dhcpServDhcpCountReleases=dhcpServDhcpCountReleases, dhcpServDhcpCountRequests=dhcpServDhcpCountRequests, dhcpServDhcpCounters=dhcpServDhcpCounters, dhcpServDhcpStatLastArrivalTime=dhcpServDhcpStatLastArrivalTime, dhcpServDhcpStatMaxArrivalInterval=dhcpServDhcpStatMaxArrivalInterval, dhcpServDhcpStatMaxResponseTime=dhcpServDhcpStatMaxResponseTime, dhcpServDhcpStatMinArrivalInterval=dhcpServDhcpStatMinArrivalInterval, dhcpServDhcpStatMinResponseTime=dhcpServDhcpStatMinResponseTime, dhcpServDhcpStatSumResponseTime=dhcpServDhcpStatSumResponseTime, dhcpServDhcpStatistics=dhcpServDhcpStatistics, dhcpServFailover=dhcpServFailover, dhcpServFailoverEntry=dhcpServFailoverEntry, dhcpServFailoverPartnerAddr=dhcpServFailoverPartnerAddr, dhcpServFailoverPartnerPolltime=dhcpServFailoverPartnerPolltime, dhcpServFailoverPartnerStatus=dhcpServFailoverPartnerStatus, dhcpServFailoverPartnerType=dhcpServFailoverPartnerType, dhcpServFailoverTable=dhcpServFailoverTable, dhcpServMib=dhcpServMib, dhcpServMibObjects=dhcpServMibObjects, dhcpServMibTraps=dhcpServMibTraps, dhcpServRangeEnd=dhcpServRangeEnd, dhcpServRangeEntry=dhcpServRangeEntry, dhcpServRangeInUse=dhcpServRangeInUse, dhcpServRangeOutstandingOffers=dhcpServRangeOutstandingOffers, dhcpServRangeStart=dhcpServRangeStart, dhcpServRangeSubnetAddr=dhcpServRangeSubnetAddr, dhcpServRangeSubnetMask=dhcpServRangeSubnetMask, dhcpServRangeTable=dhcpServRangeTable, dhcpServRangeType=dhcpServRangeType, dhcpServRangeUnavailable=dhcpServRangeUnavailable, dhcpServRangeUnused=dhcpServRangeUnused, dhcpServSubnetCounters=dhcpServSubnetCounters, dhcpServSystem=dhcpServSystem, dhcpServSystemDescr=dhcpServSystemDescr, dhcpServSystemResetTime=dhcpServSystemResetTime, dhcpServSystemStatus=dhcpServSystemStatus, dhcpServSystemUpTime=dhcpServSystemUpTime, dhcpServerBadPacket=dhcpServerBadPacket, dhcpServerDropUnknownClient=dhcpServerDropUnknownClient, dhcpServerFailoverActive=dhcpServerFailoverActive, dhcpServerFailoverReturnedControl=dhcpServerFailoverReturnedControl, dhcpServerPingResponseReceived=dhcpServerPingResponseReceived, dhcpServerReload=dhcpServerReload, dhcpServerStarted=dhcpServerStarted, dhcpServerStopped=dhcpServerStopped, dhcpServerSubnetDepleted=dhcpServerSubnetDepleted, dhcpServerSubnetThresholdDescent=dhcpServerSubnetThresholdDescent, dhcpServerSubnetThresholdExceeded=dhcpServerSubnetThresholdExceeded, ipspg=ipspg, ipspgDHCP=ipspgDHCP, ipspgDNS=ipspgDNS, ipspgDhcpTrClass=ipspgDhcpTrClass, ipspgDhcpTrDiagId=ipspgDhcpTrDiagId, ipspgDhcpTrId=ipspgDhcpTrId, ipspgDhcpTrIndex=ipspgDhcpTrIndex, ipspgDhcpTrPriority=ipspgDhcpTrPriority, ipspgDhcpTrSequence=ipspgDhcpTrSequence, ipspgDhcpTrSuspect=ipspgDhcpTrSuspect, ipspgDhcpTrText=ipspgDhcpTrText, ipspgDhcpTrTime=ipspgDhcpTrTime, ipspgDhcpTrType=ipspgDhcpTrType, ipspgDhcpTrapEntry=ipspgDhcpTrapEntry, ipspgDhcpTrapTable=ipspgDhcpTrapTable, ipspgServices=ipspgServices, ipspgTrap=ipspgTrap, lucent=lucent, mibs=mibs, products=products)
