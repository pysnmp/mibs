...
TimeTicks, IpAddress, Gauge32, Counter32, Counter64, ModuleIdentity, iso, MibIdentifier, Integer32, NotificationType, Unsigned32, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Gauge32", "Counter32", "Counter64", "ModuleIdentity", "iso", "MibIdentifier", "Integer32", "NotificationType", "Unsigned32", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("HIPATH-WIRELESS-HWC-MIB", stationIPv6Address3=stationIPv6Address3, topologyGateway=topologyGateway, muBSSIDMac=muBSSIDMac, apLogFileUtilityCurrent=apLogFileUtilityCurrent, maxVideoBWforAssociation=maxVideoBWforAssociation, recurrenceWeekly=recurrenceWeekly, dhcpRelayListenersGroup=dhcpRelayListenersGroup, vnsDomain=vnsDomain, blacklistedClientEndTime=blacklistedClientEndTime, vnsCount=vnsCount, friendlyAPManufacturer=friendlyAPManufacturer, apLLDP=apLLDP, vnsWDSStatTxFrame=vnsWDSStatTxFrame, apEnvironment=apEnvironment, radiusStrictMode=radiusStrictMode, externalRadiusServerAddress=externalRadiusServerAddress, vnsStatRxOctects=vnsStatRxOctects, apTotalStationsAOutOctets=apTotalStationsAOutOctets, vnsRadiusServerAuthType=vnsRadiusServerAuthType, topoWireStatBroadcastRxPkts=topoWireStatBroadcastRxPkts, radiusExtnsSettingEntry=radiusExtnsSettingEntry, siteGroup=siteGroup, schedule=schedule, topologyStat=topologyStat, vnsFilterRuleEntry=vnsFilterRuleEntry, assocEntry=assocEntry, logEventDescription=logEventDescription, vnsRateControlProfTable=vnsRateControlProfTable, wlanCPIntLogoffButton=wlanCPIntLogoffButton, vnsWDSRFEntry=vnsWDSRFEntry, vnsRadiusServerTimeout=vnsRadiusServerTimeout, muACLEntry=muACLEntry, scanGroupAPAssignAllowSpectrumAnalysis=scanGroupAPAssignAllowSpectrumAnalysis, vnsConfigTable=vnsConfigTable, tunnelCount=tunnelCount, tspecDirection=tspecDirection, muAccessListMACAddress=muAccessListMACAddress, dedicatedScanGrpBlockAdHocPeriod=dedicatedScanGrpBlockAdHocPeriod, outOfServiceScanGroupTable=outOfServiceScanGroupTable, radioVNSEntry=radioVNSEntry, wlanSupressSSID=wlanSupressSSID, scanAPRowStatus=scanAPRowStatus, vnsWEPKeyTable=vnsWEPKeyTable, vnsStatName=vnsStatName, wlanSessionTimeout=wlanSessionTimeout, wlanRadiusPort=wlanRadiusPort, vnsWINSServers=vnsWINSServers, apAccCurrentReassocReqRx=apAccCurrentReassocReqRx, apPerfWlanCurPeakDLPktsPerSec=apPerfWlanCurPeakDLPktsPerSec, apLogServerIP=apLogServerIP, ntpServerEnabled=ntpServerEnabled, vnsRadiusServerTable=vnsRadiusServerTable, apWiredIfIndex=apWiredIfIndex, topologyStaticIPv6Address=topologyStaticIPv6Address, vnsStatTable=vnsStatTable, apPerformanceReportbyRadioAndWlanEntry=apPerformanceReportbyRadioAndWlanEntry, apVlanID=apVlanID, vnsRadiusServerRetries=vnsRadiusServerRetries, vnsAPFilterRuleOrder=vnsAPFilterRuleOrder, wlanQuietIE=wlanQuietIE, topologyDHCPUsage=topologyDHCPUsage, apChnlUtilCurPeakUtilization=apChnlUtilCurPeakUtilization, apPerfWlanAverageClientsPerSec=apPerfWlanAverageClientsPerSec, activeThreatCategory=activeThreatCategory, vnsQoSWirelessWMMFlag=vnsQoSWirelessWMMFlag, wlanStatsGroup=wlanStatsGroup, apRadioType=apRadioType, vnsStatMulticastTxPkts=vnsStatMulticastTxPkts, topoStatBroadcastTxPkts=topoStatBroadcastTxPkts, apOutDiscards=apOutDiscards, muACLRowStatus=muACLRowStatus, widsWipsEnginePollRetry=widsWipsEnginePollRetry, vnsStrictSubnetAdherence=vnsStrictSubnetAdherence, muVnsSSID=muVnsSSID, dasReplayInterval=dasReplayInterval, authorizedAPTable=authorizedAPTable, mgmtPortDomain=mgmtPortDomain, apStatus=apStatus, hiPathWirelessLogAlarm=hiPathWirelessLogAlarm, apByChannelGroup=apByChannelGroup, sysLogSupport=sysLogSupport, detectLinkFailure=detectLinkFailure, vnsAPFilterIPAddress=vnsAPFilterIPAddress, wlanCPGuestAccLifetime=wlanCPGuestAccLifetime, portMacAddress=portMacAddress, apIfMAC=apIfMAC, apTotalStationsGInOctets=apTotalStationsGInOctets, muMACAddress=muMACAddress, outOfSrvScanGrpScanRowStatus=outOfSrvScanGrpScanRowStatus, vnsAPFilterPortLow=vnsAPFilterPortLow, apLogFileCopyDestination=apLogFileCopyDestination, destinationIP=destinationIP, licenseDaysRemaining=licenseDaysRemaining, clientAutologinOption=clientAutologinOption, apStatsObjects=apStatsObjects, apRadioStatusTable=apRadioStatusTable, wlanNumEntries=wlanNumEntries, wlanAuthReplaceCalledStationIDWithZone=wlanAuthReplaceCalledStationIDWithZone, controllerStats=controllerStats, topologySyncGateway=topologySyncGateway, apLEDMode=apLEDMode, cpSharedSecret=cpSharedSecret, apAccCurrentDisassocDeauthReqTx=apAccCurrentDisassocDeauthReqTx, armIndex=armIndex, apAccessibilityTable=apAccessibilityTable, apChannelUtilizationEntry=apChannelUtilizationEntry, dedicatedScanGrpMaxConcurrentAttacksPerAP=dedicatedScanGrpMaxConcurrentAttacksPerAP, vnsStatTxPkts=vnsStatTxPkts, apEventDescription=apEventDescription, externalRadiusServerSharedSecret=externalRadiusServerSharedSecret, muTopologyName=muTopologyName, apAntennaTable=apAntennaTable, outOfServiceScanGroupEntry=outOfServiceScanGroupEntry, vnsPrivacyEntry=vnsPrivacyEntry, vnsWDSStatTable=vnsWDSStatTable, muAccessListEntry=muAccessListEntry, vnsQoSWirelessUseAdmControlVoice=vnsQoSWirelessUseAdmControlVoice, vnsExceptionStatPktsDenied=vnsExceptionStatPktsDenied, prohibitedAPRowStatus=prohibitedAPRowStatus, topoStatTxOctets=topoStatTxOctets, hiPathWirelessHWCConformance=hiPathWirelessHWCConformance, inServiceScanGroup=inServiceScanGroup, vnsAPFilterTable=vnsAPFilterTable, dedicatedScanGroupEntry=dedicatedScanGroupEntry, apAccCurPeakDisassocDeauthReqTx=apAccCurPeakDisassocDeauthReqTx, vnsWDSRFaService=vnsWDSRFaService, apPerfRadioPrevPeakChannelUtilization=apPerfRadioPrevPeakChannelUtilization, apNeighboursEntry=apNeighboursEntry, assocMUMacAddress=assocMUMacAddress, apAccAverageReassocReqRx=apAccAverageReassocReqRx, countermeasureAPGroup=countermeasureAPGroup, radiusMacAddressFormatOption=radiusMacAddressFormatOption, apChnlUtilAverageUtilization=apChnlUtilAverageUtilization, apPerfRadioAverageSNR=apPerfRadioAverageSNR, wlanPrivWEPKeyIndex=wlanPrivWEPKeyIndex, apEntry=apEntry, apRadioStatusChannelOffset=apRadioStatusChannelOffset, uncategorizedAPDescption=uncategorizedAPDescption, apPerfWlanAverageULOctetsPerSec=apPerfWlanAverageULOctetsPerSec, apLogFTProtocol=apLogFTProtocol, uncategorizedAPEntry=uncategorizedAPEntry, externalRadiusServerName=externalRadiusServerName, applyMacAddressFormat=applyMacAddressFormat, wlanRadiusUsage=wlanRadiusUsage, wlanID=wlanID, wlanAuthRadiusOperatorName=wlanAuthRadiusOperatorName, scanAPControllerIPAddress=scanAPControllerIPAddress, apRadioStatusEntry=apRadioStatusEntry, scanGroupAPAssignName=scanGroupAPAssignName, vnsInterfaceName=vnsInterfaceName, muAPName=muAPName, HundredthOfGauge32=HundredthOfGauge32, siteCoSID=siteCoSID, dedicatedScanGrpRowStatus=dedicatedScanGrpRowStatus, apAccessibilityEntry=apAccessibilityEntry, nearbyApRSS=nearbyApRSS, mobileUnitCount=mobileUnitCount, wlanCPExtConnection=wlanCPExtConnection, wlanCP802HttpRedirect=wlanCP802HttpRedirect, tunnelEndIP=tunnelEndIP, apAntennaIndex=apAntennaIndex, stationsByProtocolAC=stationsByProtocolAC, siteStrictLimitEnableR2=siteStrictLimitEnableR2, siteID=siteID, apRadioTable=apRadioTable, nearbyApIndex=nearbyApIndex, vnsStatTxOctects=vnsStatTxOctects, apByChannelNumber=apByChannelNumber, wlanAuthMacBasedAuth=wlanAuthMacBasedAuth, apPerfWlanAverageULPktsPerSec=apPerfWlanAverageULPktsPerSec, apUpTime=apUpTime, vnsRateControlProfName=vnsRateControlProfName, siteEnableSecureTunnel=siteEnableSecureTunnel, scanAPSerialNumber=scanAPSerialNumber, vnsExceptionFiterName=vnsExceptionFiterName, select=select, apSSHConnection=apSSHConnection, assocVnsIfIndex=assocVnsIfIndex, apPerfRadioAverageRSS=apPerfRadioAverageRSS, apLogFileCopyProtocol=apLogFileCopyProtocol, portDHCPMaxLease=portDHCPMaxLease, vnsAPFilterMask=vnsAPFilterMask, wlanCPIdentity=wlanCPIdentity, threatSummaryActiveThreat=threatSummaryActiveThreat, maxBackgroundBWforAssociation=maxBackgroundBWforAssociation, assocTable=assocTable, siteCosEntry=siteCosEntry, apEncryptCntTraffic=apEncryptCntTraffic, apPerfWlanAverageDLOctetsPerSec=apPerfWlanAverageDLOctetsPerSec, loadGrpWlanEntry=loadGrpWlanEntry, uncategorizedAPManufacturer=uncategorizedAPManufacturer, portDHCPWins=portDHCPWins, ntpTimeServer1=ntpTimeServer1, vns3rdPartyAPEntry=vns3rdPartyAPEntry, apIpAddress=apIpAddress, topoCompleteStatBroadcastRxPkts=topoCompleteStatBroadcastRxPkts, recurrenceMonthly=recurrenceMonthly, sysLogServerEnabled=sysLogServerEnabled, muAccessListBitmaskLength=muAccessListBitmaskLength, siteLoadControlEnableR2=siteLoadControlEnableR2, vnsStatMulticastRxPkts=vnsStatMulticastRxPkts, scanGroupAPAssignFordwardingService=scanGroupAPAssignFordwardingService, dasPort=dasPort, dedicatedScanGrpScan2400MHzFreq=dedicatedScanGrpScan2400MHzFreq, apRestartServiceContAbsent=apRestartServiceContAbsent, wlanServiceType=wlanServiceType, topoStatMulticastRxPkts=topoStatMulticastRxPkts, vnIfIndex=vnIfIndex, apRegDiscoveryInterval=apRegDiscoveryInterval, stationIPAddress=stationIPAddress, vnsDLSPort=vnsDLSPort, wlan=wlan, wlanCPTable=wlanCPTable, apPerfWlanCurrentDLOctetsPerSec=apPerfWlanCurrentDLOctetsPerSec, loadGroupLoadControlStrictLimitR2=loadGroupLoadControlStrictLimitR2, muTable=muTable, friendlyAPCounts=friendlyAPCounts, vnsEnable11hSupport=vnsEnable11hSupport, portDuplexMode=portDuplexMode, topoWireStatTxPkts=topoWireStatTxPkts, maxVoiceBWforAssociation=maxVoiceBWforAssociation, layerTwoPortGroup=layerTwoPortGroup, wlanIdleSessionPostAuth=wlanIdleSessionPostAuth, apLogPassword=apLogPassword, vnsDLSAddress=vnsDLSAddress, wlanEnabled=wlanEnabled, vnsQoSEntry=vnsQoSEntry, apInterfaceMTU=apInterfaceMTU, licenseRegulatoryDomain=licenseRegulatoryDomain, cpURL=cpURL, apIPAddress=apIPAddress, channel=channel, primaryDNS=primaryDNS, wlanRadiusServerAcctUseVNSName=wlanRadiusServerAcctUseVNSName, siteDefaultDNSServer=siteDefaultDNSServer, apName=apName, tertiaryDNS=tertiaryDNS, apMaintainClientSession=apMaintainClientSession, dedicatedScanGrpListeningPort=dedicatedScanGrpListeningPort, stationAPName=stationAPName, wlanAuthRadiusIncludeAP=wlanAuthRadiusIncludeAP, apTotalStationsAInOctets=apTotalStationsAInOctets, apLogFileCopyIndex=apLogFileCopyIndex, vnsAllowMulticast=vnsAllowMulticast, apChnlUtilPrevPeakUtilization=apChnlUtilPrevPeakUtilization, vnsAPFilterEtherType=vnsAPFilterEtherType, topoExceptionStatPktsAllowed=topoExceptionStatPktsAllowed, accessRejectMsgEntry=accessRejectMsgEntry, apSecureTunnel=apSecureTunnel, wlanMirrorN=wlanMirrorN, portEnabled=portEnabled, wlanRadioManagement11k=wlanRadioManagement11k, wlanRadiusTimeout=wlanRadiusTimeout, tspecDlViolations=tspecDlViolations)
mibBuilder.exportSymbols("HIPATH-WIRELESS-HWC-MIB", wlanAuthRadiusOperatorNameSpace=wlanAuthRadiusOperatorNameSpace, wlanCPGuestIDPrefix=wlanCPGuestIDPrefix, muDefaultCoS=muDefaultCoS, siteLocalRadiusAuthentication=siteLocalRadiusAuthentication, prohibitedAPEntry=prohibitedAPEntry, HundredthOfInt32=HundredthOfInt32, muRxOctets=muRxOctets, cpPasswordLabel=cpPasswordLabel, radiusInfo=radiusInfo, wlanBlockMuToMuTraffic=wlanBlockMuToMuTraffic, apPollTimeout=apPollTimeout, inSrvScanGrpSecurityThreats=inSrvScanGrpSecurityThreats, apPerformanceReportByRadioEntry=apPerformanceReportByRadioEntry, siteEncryptCommBetweenAPs=siteEncryptCommBetweenAPs, vnsFilterIDStatus=vnsFilterIDStatus, widsWips=widsWips, vnsParentIfIndex=vnsParentIfIndex, muUser=muUser, stationsByProtocolError=stationsByProtocolError, tunnelStartHWC=tunnelStartHWC, scanGroupAPAssignRadio2=scanGroupAPAssignRadio2, logNotifications=logNotifications, apAccCurrentDisassocDeauthReqRx=apAccCurrentDisassocDeauthReqRx, apAntennaEntry=apAntennaEntry, apInvalidPolicyCount=apInvalidPolicyCount, wlanRadiusServerAuthNASIP=wlanRadiusServerAuthNASIP, pollingMechanism=pollingMechanism, apPerfRadioAveragePktRetx=apPerfRadioAveragePktRetx, radiusAccounting=radiusAccounting, wlanRadiusServerMacPW=wlanRadiusServerMacPW, activeThreatIndex=activeThreatIndex, apPerfWlanPrevPeakULOctetsPerSec=apPerfWlanPrevPeakULOctetsPerSec, loadGroupLoadControlEnableR1=loadGroupLoadControlEnableR1, loadGrpWlanAssigned=loadGrpWlanAssigned, muState=muState, scanGroupAPAssignAllowScanning=scanGroupAPAssignAllowScanning, vnsAssignmentMode=vnsAssignmentMode, vnsWEPKeyValue=vnsWEPKeyValue, apPerfRadioCurrentPktRetx=apPerfRadioCurrentPktRetx, muACLType=muACLType, vnLocalClients=vnLocalClients, topoCompleteStatTxOctets=topoCompleteStatTxOctets, loadGroupName=loadGroupName, siteWlanEntry=siteWlanEntry, prohibitedAPMAC=prohibitedAPMAC, vnsQoSClassificationServiceClass=vnsQoSClassificationServiceClass, apPerfWlanCurPeakDLOctetsPerSec=apPerfWlanCurPeakDLOctetsPerSec, apRegSecurityMode=apRegSecurityMode, topoCompleteStatEntry=topoCompleteStatEntry, apPerfRadioCurPeakChannelUtilization=apPerfRadioCurPeakChannelUtilization, vnsFilterRuleProtocol=vnsFilterRuleProtocol, muDot11ConnectionCapability=muDot11ConnectionCapability, assocCount=assocCount, vnsWDSRFbgService=vnsWDSRFbgService, apGroup=apGroup, wlanRemoteable=wlanRemoteable, radacctStartOnIPAddr=radacctStartOnIPAddr, includeServiceType=includeServiceType, apTotalStationsN24OutOctets=apTotalStationsN24OutOctets, vnsStatus=vnsStatus, siteLoadControlEnableR1=siteLoadControlEnableR1, hiPathWirelessHWCAlarms=hiPathWirelessHWCAlarms, apPerformanceReportByRadioTable=apPerformanceReportByRadioTable, apRadioAntennaType=apRadioAntennaType, apPerformanceReportbyRadioAndWlanTable=apPerformanceReportbyRadioAndWlanTable, phyDHCPRangeStatus=phyDHCPRangeStatus, wlanRadiusServerAcctNASId=wlanRadiusServerAcctNASId, siteEncryptCommAPtoController=siteEncryptCommAPtoController, apRegClusterSharedSecret=apRegClusterSharedSecret, stationsByProtocolB=stationsByProtocolB, muPolicyName=muPolicyName, siteTableNextAvailableIndex=siteTableNextAvailableIndex, countermeasureAPThreatCategory=countermeasureAPThreatCategory, topologyGroup=topologyGroup, prohibitedAPClassify=prohibitedAPClassify, vnsWDSStatEntry=vnsWDSStatEntry, apIndex=apIndex, physicalPortCount=physicalPortCount, muACLTable=muACLTable, logEventComponent=logEventComponent, wlanRadiusNASID=wlanRadiusNASID, vnsWEPKeyIndex=vnsWEPKeyIndex, mobileUnits=mobileUnits, activeThreatsCounts=activeThreatsCounts, vns3rdPartyAP=vns3rdPartyAP, dedicatedScanGroupTable=dedicatedScanGroupTable, vnsWDSStatAPRadio=vnsWDSStatAPRadio, apRegUseClusterEncryption=apRegUseClusterEncryption, topologyDynamicEgress=topologyDynamicEgress, apTotalStationsA=apTotalStationsA, vnsQoSWirelessUseAdmControlVideo=vnsQoSWirelessUseAdmControlVideo, countermeasureAPCountermeasure=countermeasureAPCountermeasure, wlanCPUseHTTPSforConnection=wlanCPUseHTTPSforConnection, threatSummaryGroup=threatSummaryGroup, muIPAddress=muIPAddress, apLogFrequency=apLogFrequency, apLogQuickSelectedOption=apLogQuickSelectedOption, sysLogServersEntry=sysLogServersEntry, apLogManagement=apLogManagement, clientServiceTypeLogin=clientServiceTypeLogin, vnsStatRadiusReqFailed=vnsStatRadiusReqFailed, apPerfWlanCurrentULOctetsPerSec=apPerfWlanCurrentULOctetsPerSec, wlanStatsEntry=wlanStatsEntry, apLogCollectionEnable=apLogCollectionEnable, vnsSessionAvailabilityEnable=vnsSessionAvailabilityEnable, countermeasureAPSerial=countermeasureAPSerial, stationsByProtocolN5=stationsByProtocolN5, wlanRadiusServerMacAuthType=wlanRadiusServerMacAuthType, threatSummaryEntry=threatSummaryEntry, vnsAPFilterRuleDirection=vnsAPFilterRuleDirection, vnsUseDHCPRelay=vnsUseDHCPRelay, authorizedAPClassify=authorizedAPClassify, pairIPAddress=pairIPAddress, apAccPrevPeakDisassocDeauthReqRx=apAccPrevPeakDisassocDeauthReqRx, wlanAuthAutoAuthAuthorizedUser=wlanAuthAutoAuthAuthorizedUser, portDHCPEnable=portDHCPEnable, vnsStatBroadcastTxPkts=vnsStatBroadcastTxPkts, vnsStatBroadcastRxPkts=vnsStatBroadcastRxPkts, wlanPrivRekeyInterval=wlanPrivRekeyInterval, apRadioAntennaEntry=apRadioAntennaEntry, apRole=apRole, vnsAPFilterProtocol=vnsAPFilterProtocol, topoCompleteStatRxPkts=topoCompleteStatRxPkts, apTotalStationsACOutOctets=apTotalStationsACOutOctets, portMgmtTrafficEnable=portMgmtTrafficEnable, friendlyAPGroup=friendlyAPGroup, vnsDHCPRangeEntry=vnsDHCPRangeEntry, topologyVlanID=topologyVlanID, apRegistrationRequests=apRegistrationRequests, apZone=apZone, apLogFileUtility=apLogFileUtility, topoStatFrameChkSeqErrors=topoStatFrameChkSeqErrors, apLogFileCopyServerIP=apLogFileCopyServerIP, vnsStatRxPkts=vnsStatRxPkts, layerTwoPortTable=layerTwoPortTable, wlanRadiusName=wlanRadiusName, apIPMulticastAssembly=apIPMulticastAssembly, wlanDot11hClientPowerReduction=wlanDot11hClientPowerReduction, scanGroupAPAssignApSerial=scanGroupAPAssignApSerial, wlanAuthRadiusIncludePolicy=wlanAuthRadiusIncludePolicy, wlanSecurityReportEntry=wlanSecurityReportEntry, wlanPrivWEPKeyLength=wlanPrivWEPKeyLength, wlanRadiusServerAcctUseVNSIPAddr=wlanRadiusServerAcctUseVNSIPAddr, wlanRadiusServerMacNASId=wlanRadiusServerMacNASId, widsWipsEngineGroup=widsWipsEngineGroup, apPerfWlanPrevPeakDLOctetsPerSec=apPerfWlanPrevPeakDLOctetsPerSec, wlanRadiusServerTable=wlanRadiusServerTable, topoExceptionFiterName=topoExceptionFiterName, sitePolicyGroup=sitePolicyGroup, portDHCPGateway=portDHCPGateway, apInDiscards=apInDiscards, fastFailover=fastFailover, sysLogServerIP=sysLogServerIP, vnsPrivWPA1Enabled=vnsPrivWPA1Enabled, dasInfo=dasInfo, PYSNMP_MODULE_ID=hiPathWirelessControllerMib, apMICErrorWarning=apMICErrorWarning, radioVNSTable=radioVNSTable, stationRoamedAPName=stationRoamedAPName, apLogFileCopyRowStatus=apLogFileCopyRowStatus, phyDHCPRangeStart=phyDHCPRangeStart, dedicatedScanGrpCounterMeasures=dedicatedScanGrpCounterMeasures, wlanVNSID=wlanVNSID, wlanAuthType=wlanAuthType, vnsSSID=vnsSSID, topoStatName=topoStatName, apRegistration=apRegistration, siteRowStatus=siteRowStatus, authorizedAPRowStatus=authorizedAPRowStatus, vnsWDSStatSSID=vnsWDSStatSSID, muAccessListGroup=muAccessListGroup, wlanSecurityReportNotes=wlanSecurityReportNotes, licenseType=licenseType, topoCompleteStatMulticastTxPkts=topoCompleteStatMulticastTxPkts, apTotalStationsN24=apTotalStationsN24, sysSoftwareVersion=sysSoftwareVersion, apPerfRadioPrevPeakRSS=apPerfRadioPrevPeakRSS, tspecDlRate=tspecDlRate, vnsDHCPRangeType=vnsDHCPRangeType, sensorManagement=sensorManagement, topoWireStatBroadcastTxPkts=topoWireStatBroadcastTxPkts, apAccCurPeakDisassocDeauthReqRx=apAccCurPeakDisassocDeauthReqRx, logEventSeverity=logEventSeverity, muACLMACAddress=muACLMACAddress, muACLGroup=muACLGroup, wlanRadiusRetries=wlanRadiusRetries, apPerfWlanCurrentDLPktsPerSec=apPerfWlanCurrentDLPktsPerSec, loadGroupID=loadGroupID, imageVersionOfngap36xx=imageVersionOfngap36xx, vnsWDSStatTxRate=vnsWDSStatTxRate, sitePolicyID=sitePolicyID, authenticationAdvancedGroup=authenticationAdvancedGroup, siteAPTable=siteAPTable, scanAPEntry=scanAPEntry, topologyStatGroup=topologyStatGroup, stationsByProtocolUnavailable=stationsByProtocolUnavailable, cpFooterURL=cpFooterURL, topologySynchronize=topologySynchronize, apStatsTable=apStatsTable, inServiceScanGroupEntry=inServiceScanGroupEntry, apAccAverageDisassocDeauthReqRx=apAccAverageDisassocDeauthReqRx, loadGroupClientCountRadio2=loadGroupClientCountRadio2, apOutOctets=apOutOctets, accessRejectMsgTable=accessRejectMsgTable, wlanAuthCollectAcctInformation=wlanAuthCollectAcctInformation, wlanCPExtEnableHttps=wlanCPExtEnableHttps, apRadioAntennaTable=apRadioAntennaTable, topologyEgressPort=topologyEgressPort, apEventId=apEventId, outOfSrvScanGrpScanTimeInterval=outOfSrvScanGrpScanTimeInterval, imagePath26xx=imagePath26xx, vnsRateControlCBS=vnsRateControlCBS, scanGroupAPAssignInactiveAP=scanGroupAPAssignInactiveAP, wlanPrivManagementFrameProtection=wlanPrivManagementFrameProtection, vnsWDSRFTable=vnsWDSRFTable, wlanDot11hSupport=wlanDot11hSupport, loadGrpRadiosTable=loadGrpRadiosTable, vnsDHCPRangeTable=vnsDHCPRangeTable, apPerfWlanAverageDLPktsPerSec=apPerfWlanAverageDLPktsPerSec, blacklistedClientMAC=blacklistedClientMAC, apTelnetAccess=apTelnetAccess, countermeasureAPName=countermeasureAPName, sysLogServerRowStatus=sysLogServerRowStatus, vnsRadiusServerNasAddress=vnsRadiusServerNasAddress, dhcpRelayListenersID=dhcpRelayListenersID, wlanStatsID=wlanStatsID, logEventSeverityThreshold=logEventSeverityThreshold, loadGrpRadiosEntry=loadGrpRadiosEntry, advancedFilteringMode=advancedFilteringMode, wlanStatsTable=wlanStatsTable, licenseForeignAP=licenseForeignAP, topologyLinkLocalIPv6Address=topologyLinkLocalIPv6Address, dedicatedScanGrpName=dedicatedScanGrpName, apLogDirectory=apLogDirectory, stationsByProtocolGroup=stationsByProtocolGroup, serverUsageModel=serverUsageModel, wlanEntry=wlanEntry, apPerfWlanULOctets=apPerfWlanULOctets, scanAPTable=scanAPTable, stationAPSSID=stationAPSSID, vnsApplyPowerBackOff=vnsApplyPowerBackOff, muGroup=muGroup, topoWireStatMulticastRxPkts=topoWireStatMulticastRxPkts, wlanCPGuestMinPassLength=wlanCPGuestMinPassLength, widsWipsEnginePollInterval=widsWipsEnginePollInterval, prohibitedAPTable=prohibitedAPTable, activeThreatRSS=activeThreatRSS, vnsAuthModel=vnsAuthModel, vns3rdPartyAPTable=vns3rdPartyAPTable, wlanPrivWPAPSK=wlanPrivWPAPSK, wlanRadiusServerAuthAuthType=wlanRadiusServerAuthAuthType, assocRxPackets=assocRxPackets, wlanRadiusServerAuthUseVNSIPAddr=wlanRadiusServerAuthUseVNSIPAddr, tftpSever=tftpSever)
mibBuilder.exportSymbols("HIPATH-WIRELESS-HWC-MIB", vnsMode=vnsMode, vnsWDSStatAPName=vnsWDSStatAPName, wlanCPCustomSpecificURL=wlanCPCustomSpecificURL, blacklistedClientStatTime=blacklistedClientStatTime, vnsStatEntry=vnsStatEntry, inSrvScanGrpClassifySourceIF=inSrvScanGrpClassifySourceIF, stationIPv6Address1=stationIPv6Address1, apRowStatus=apRowStatus, wlanDefaultTopologyID=wlanDefaultTopologyID, apNotifications=apNotifications, siteAPGroup=siteAPGroup, vnsSuppressSSID=vnsSuppressSSID, stationsByProtocol=stationsByProtocol, netflowInterval=netflowInterval, apCertificateExpiry=apCertificateExpiry, portDHCPDnsServers=portDHCPDnsServers, wlanAuthRadiusIncludeVNS=wlanAuthRadiusIncludeVNS, outOfSrvScanGrpScanType=outOfSrvScanGrpScanType, apAccCurPeakReassocReqRx=apAccCurPeakReassocReqRx, synchronizeGuestPort=synchronizeGuestPort, topologyMemberId=topologyMemberId, apPerfWlanCurPeakClientsPerSec=apPerfWlanCurPeakClientsPerSec, vnsWDSRFPreferredParent=vnsWDSRFPreferredParent, wlanPrivWPAversion=wlanPrivWPAversion, wlanRadiusServerMacUseVNSName=wlanRadiusServerMacUseVNSName, sysLogServerPort=sysLogServerPort, imageVersionOfap26xx=imageVersionOfap26xx, uncategorizedAPGroup=uncategorizedAPGroup, vnsWDSStatRxError=vnsWDSStatRxError, activeThreatExtraDetails=activeThreatExtraDetails, vnsWDSStatAPRole=vnsWDSStatAPRole, wlanGroup=wlanGroup, topologyManagementTraffic=topologyManagementTraffic, vnsRadiusServerNASIdentifier=vnsRadiusServerNASIdentifier, physicalPortsTable=physicalPortsTable, apPerfWlanCurPeakULPktsPerSec=apPerfWlanCurPeakULPktsPerSec, vnsFilterRuleAction=vnsFilterRuleAction, siteAPEntry=siteAPEntry, topologyMTUsize=topologyMTUsize, portVlanID=portVlanID, scanGroupAPAssignRadio1=scanGroupAPAssignRadio1, stationName=stationName, includeAllServiceMessages=includeAllServiceMessages, apAntennaType=apAntennaType, inSrvScanGrpName=inSrvScanGrpName, scanAPProfileName=scanAPProfileName, vnsRateControlProfile=vnsRateControlProfile, apLogSelectedAPsEntry=apLogSelectedAPsEntry, topoWireStatFrameChkSeqErrors=topoWireStatFrameChkSeqErrors, wlanAuthAllowUnauthorizedUser=wlanAuthAllowUnauthorizedUser, dhcpRelayListenersTable=dhcpRelayListenersTable, topoWireStatName=topoWireStatName, apPerfRadioCurrentChannelUtilization=apPerfRadioCurrentChannelUtilization, sitePolicyEntry=sitePolicyEntry, sitePolicyTable=sitePolicyTable, wlanStatsRadiusReqRejected=wlanStatsRadiusReqRejected, outOfSrvScanGrpSecurityScan=outOfSrvScanGrpSecurityScan, dhcpRelayListenersEntry=dhcpRelayListenersEntry, threatSummaryIndex=threatSummaryIndex, stationSessionNotifications=stationSessionNotifications, siteEntry=siteEntry, apTotalStationsBOutOctets=apTotalStationsBOutOctets, siteCosGroup=siteCosGroup, cpMessage=cpMessage, serverPollingInterval=serverPollingInterval, vnsQoSWireless80211eFlag=vnsQoSWireless80211eFlag, apAccAverageAssocReqRx=apAccAverageAssocReqRx, vnsFilterRuleDirection=vnsFilterRuleDirection, wlanStatsRadiusTotRequests=wlanStatsRadiusTotRequests, wlanAuthRadiusIncludeTopology=wlanAuthRadiusIncludeTopology, ntpObjects=ntpObjects, widsWipsReport=widsWipsReport, radiusExtnsSetting=radiusExtnsSetting, apChannelUtilizationTable=apChannelUtilizationTable, apOutErrors=apOutErrors, apSpecific=apSpecific, apRegSSHPassword=apRegSSHPassword, portDHCPDefaultLease=portDHCPDefaultLease, vnsPrivacyTable=vnsPrivacyTable, apChnlUtilCurrentUtilization=apChnlUtilCurrentUtilization, vnsWDSStatAPParent=vnsWDSStatAPParent, wlanCPSelectionOption=wlanCPSelectionOption, topoStatRxPkts=topoStatRxPkts, apLogFileCopyPassword=apLogFileCopyPassword, widsWipsEngineControllerIPAddress=widsWipsEngineControllerIPAddress, apLogFileCopyOperationStatus=apLogFileCopyOperationStatus, topoWireStatTable=topoWireStatTable, wlanCPExtTosValue=wlanCPExtTosValue, vnsRateControlProfEntry=vnsRateControlProfEntry, dhcpRelayListenersNextIndex=dhcpRelayListenersNextIndex, vnForeignClients=vnForeignClients, apSerialNo=apSerialNo, apFastFailoverEnable=apFastFailoverEnable, tspecMuMACAddress=tspecMuMACAddress, licensingInformationGroup=licensingInformationGroup, radiusExtnsSettingGroup=radiusExtnsSettingGroup, topoCompleteStatRxOctets=topoCompleteStatRxOctets, siteStrictLimitEnableR1=siteStrictLimitEnableR1, vnsFilterRulePortLow=vnsFilterRulePortLow, wlanRadiusServerAuthUseVNSName=wlanRadiusServerAuthUseVNSName, uncategorizedAPMAC=uncategorizedAPMAC, stationEventAlarm=stationEventAlarm, wlanProcessClientIE=wlanProcessClientIE, tspecUlRate=tspecUlRate, wlanAuthMACBasedAuthReAuthOnAreaRoam=wlanAuthMACBasedAuthReAuthOnAreaRoam, tspecBssMac=tspecBssMac, maxBestEffortBWforAssociation=maxBestEffortBWforAssociation, hiPathWirelessHWCObsolete=hiPathWirelessHWCObsolete, vnsQoSWirelessTurboVoiceFlag=vnsQoSWirelessTurboVoiceFlag, wlanEngerySaveMode=wlanEngerySaveMode, dhcpRelayListenersMaxEntries=dhcpRelayListenersMaxEntries, topoStatTable=topoStatTable, apSSHAccess=apSSHAccess, nearbyApChannel=nearbyApChannel, topoStatTxPkts=topoStatTxPkts, hiPathWirelessController=hiPathWirelessController, vnsFilterIDEntry=vnsFilterIDEntry, apTotalStationsN50=apTotalStationsN50, vnsQoSPriorityOverrideFlag=vnsQoSPriorityOverrideFlag, apPerfRadioPrevPeakSNR=apPerfRadioPrevPeakSNR, vnsPrivWPASharedKey=vnsPrivWPASharedKey, wlanCPReplaceIPwithFQDN=wlanCPReplaceIPwithFQDN, topologyPreFixLength=topologyPreFixLength, apPerfWlanDLPkts=apPerfWlanDLPkts, muTxPackets=muTxPackets, wlanBeaconReport=wlanBeaconReport, threatSummaryHistoricalCounts=threatSummaryHistoricalCounts, threatSummaryTable=threatSummaryTable, siteMaxClientR1=siteMaxClientR1, sites=sites, apBroadcastDisassociate=apBroadcastDisassociate, apStatsSessionDuration=apStatsSessionDuration, topologyEntry=topologyEntry, apTotalStationsBInOctets=apTotalStationsBInOctets, ntpTimeServer2=ntpTimeServer2, outOfSrvScanGrpChannelList=outOfSrvScanGrpChannelList, apEffectiveTunnelMTU=apEffectiveTunnelMTU, wlanCPExtTosOverride=wlanCPExtTosOverride, wlanAuthRadiusIncludeEgressRC=wlanAuthRadiusIncludeEgressRC, vnsExceptionStatEntry=vnsExceptionStatEntry, availabilityStatus=availabilityStatus, wlanPrivPrivacyType=wlanPrivPrivacyType, apNeighboursTable=apNeighboursTable, topoExceptionStatTable=topoExceptionStatTable, wlanStatsRadiusReqFailed=wlanStatsRadiusReqFailed, apRadioAntennaModel=apRadioAntennaModel, loadGrpRadiosRadio2=loadGrpRadiosRadio2, muAPSerialNo=muAPSerialNo, apRadioStatusChannel=apRadioStatusChannel, wlanCPGuestAllowedLifetimeAcct=wlanCPGuestAllowedLifetimeAcct, authorizedAPEntry=authorizedAPEntry, dedicatedScanGrpClassifySourceIF=dedicatedScanGrpClassifySourceIF, vnsFilterRulePortHigh=vnsFilterRulePortHigh, maxVideoBWforReassociation=maxVideoBWforReassociation, tspecMDR=tspecMDR, cpStatusCheck=cpStatusCheck, wlanCPEntry=wlanCPEntry, apState=apState, apStatsGroup=apStatsGroup, scanAPAcessPointName=scanAPAcessPointName, apTotalStationsN24InOctets=apTotalStationsN24InOctets, siteWlanTable=siteWlanTable, vnsQoSWirelessUseAdmControlBackground=vnsQoSWirelessUseAdmControlBackground, activeThreatDeviceMAC=activeThreatDeviceMAC, physicalPortsInternalVlanID=physicalPortsInternalVlanID, maxVoiceBWforReassociation=maxVoiceBWforReassociation, wlanRadiusServerUsage=wlanRadiusServerUsage, accessPoints=accessPoints, scanGroupsCurrentEntries=scanGroupsCurrentEntries, prohibitedAPCategory=prohibitedAPCategory, apTunnelAlarm=apTunnelAlarm, phyDHCPRangeEntry=phyDHCPRangeEntry, vnRole=vnRole, outOfSrvScanGrpScanActivity=outOfSrvScanGrpScanActivity, wlanStatsAssociatedClients=wlanStatsAssociatedClients, vnsMgmIpAddress=vnsMgmIpAddress, blacklistedClientReason=blacklistedClientReason, apLogSelectedAPsTable=apLogSelectedAPsTable, wlanPrivTable=wlanPrivTable, radioVNSRowStatus=radioVNSRowStatus, scanGroupAPAssignmentGroup=scanGroupAPAssignmentGroup, apByChannelEntry=apByChannelEntry, vnsPrivDynamicRekeyFrequency=vnsPrivDynamicRekeyFrequency, topoWireStatRxOctets=topoWireStatRxOctets, apTotalStationsGOutOctets=apTotalStationsGOutOctets, loadGroupType=loadGroupType, radiusFFOEid=radiusFFOEid, apRadioProtocol=apRadioProtocol, vnsConfigEntry=vnsConfigEntry, hiPathWirelessHWCGroup=hiPathWirelessHWCGroup, apRadioStatusChannelWidth=apRadioStatusChannelWidth, loadBalancing=loadBalancing, stationsByProtocolG=stationsByProtocolG, radiusExtnsIndex=radiusExtnsIndex, wlanAuthEntry=wlanAuthEntry, topologyTagged=topologyTagged, topoWireStatTxOctets=topoWireStatTxOctets, loadGroupTable=loadGroupTable, activeThreatTable=activeThreatTable, vnsCaptivePortalEntry=vnsCaptivePortalEntry, apPortifIndex=apPortifIndex, apHwVersion=apHwVersion, topoCompleteStatFrameTooLongErrors=topoCompleteStatFrameTooLongErrors, muConnectionProtocol=muConnectionProtocol, wirelessQoS=wirelessQoS, wlanRadiusNASIDUseVNSName=wlanRadiusNASIDUseVNSName, apAccReassocReqRx=apAccReassocReqRx, activeThreatThreat=activeThreatThreat, phyDHCPRangeTable=phyDHCPRangeTable, physicalPortsGroup=physicalPortsGroup, scanGroupAPAssignmentEntry=scanGroupAPAssignmentEntry, outOfSrvScanGrpName=outOfSrvScanGrpName, apPerfRadioCurPeakPktRetx=apPerfRadioCurPeakPktRetx, externalRadiusServerTable=externalRadiusServerTable, assocStartSysUpTime=assocStartSysUpTime, imagePath36xx=imagePath36xx, topoWireStatEntry=topoWireStatEntry, apStatsMuCounts=apStatsMuCounts, widsWipsEngineTable=widsWipsEngineTable, vnsFilterRuleIPAddress=vnsFilterRuleIPAddress, vnsAPFilterRowStatus=vnsAPFilterRowStatus, muAccessListTable=muAccessListTable, HundredthOfGauge64=HundredthOfGauge64, maxBestEffortBWforReassociation=maxBestEffortBWforReassociation, vnsRadiusServerName=vnsRadiusServerName, loadGroup=loadGroup, siteTable=siteTable, authorizedAPManufacturer=authorizedAPManufacturer, wlanSSID=wlanSSID, apAccPrevPeakReassocReqRx=apAccPrevPeakReassocReqRx, vnsPrivWEPKeyType=vnsPrivWEPKeyType, siteBandPreferenceEnable=siteBandPreferenceEnable, wlanCPRedirectURL=wlanCPRedirectURL, wlanRadiusIndex=wlanRadiusIndex, apHome=apHome, wlanCPGuestSessionLifetime=wlanCPGuestSessionLifetime, apRadioFrequency=apRadioFrequency, apPerfWlanCurrentClientsPerSec=apPerfWlanCurrentClientsPerSec, vnsDescription=vnsDescription, vnsDLSSupportEnable=vnsDLSSupportEnable, wlanSecurityReportUnsecureType=wlanSecurityReportUnsecureType, topoCompleteStatBroadcastTxPkts=topoCompleteStatBroadcastTxPkts, uncategorizedAPTable=uncategorizedAPTable, vnsFilterIDTable=vnsFilterIDTable, wirelessEWCGroups=wirelessEWCGroups, wlanAuthRadiusIncludeSSID=wlanAuthRadiusIncludeSSID, outOfServiceScanGroup=outOfServiceScanGroup, serviceLogFacility=serviceLogFacility, wlanCPAuthType=wlanCPAuthType, associations=associations, vnsWDSRFBackupParent=vnsWDSRFBackupParent, topoStatMulticastTxPkts=topoStatMulticastTxPkts, muTSPECEntry=muTSPECEntry, outOfSrvScanGrpRadio=outOfSrvScanGrpRadio)
mibBuilder.exportSymbols("HIPATH-WIRELESS-HWC-MIB", activeThreatDateTime=activeThreatDateTime, wlanRadiusNASIP=wlanRadiusNASIP, vnsFilterID=vnsFilterID, portDHCPDomain=portDHCPDomain, topoStatEntry=topoStatEntry, portMask=portMask, authorizedAPMAC=authorizedAPMAC, topologyGroupMembers=topologyGroupMembers, topoCompleteStatFrameChkSeqErrors=topoCompleteStatFrameChkSeqErrors, LogEventSeverity=LogEventSeverity, layerTwoPortName=layerTwoPortName, vnsDHCPRangeStart=vnsDHCPRangeStart, apAccPrevPeakAssocReqRx=apAccPrevPeakAssocReqRx, vnsStatsObjects=vnsStatsObjects, cpDefaultRedirectionURL=cpDefaultRedirectionURL, vnsMgmtTrafficEnable=vnsMgmtTrafficEnable, apLinkTimeout=apLinkTimeout, clearAccessRejectMsg=clearAccessRejectMsg, apRadioIndex=apRadioIndex, apPerfRadioPktRetx=apPerfRadioPktRetx, apRegTelnetPassword=apRegTelnetPassword, wlanRadiusAuthType=wlanRadiusAuthType, loadGroupLoadControl=loadGroupLoadControl, vnsAPFilterAction=vnsAPFilterAction, scanGroupAPAssignGroupName=scanGroupAPAssignGroupName, friendlyAPTable=friendlyAPTable, activeVNSSessionCount=activeVNSSessionCount, radiusFastFailoverEventsEntry=radiusFastFailoverEventsEntry, phyDHCPRangeEnd=phyDHCPRangeEnd, vnsQoSPriorityOverrideDSCP=vnsQoSPriorityOverrideDSCP, widsWipsObjectsGroup=widsWipsObjectsGroup, vnsPrivWEPKeyLength=vnsPrivWEPKeyLength, loadGroupClientCountRadio1=loadGroupClientCountRadio1, wlanCPExtAddIPtoURL=wlanCPExtAddIPtoURL, startHour=startHour, dashboard=dashboard, siteWlanGroup=siteWlanGroup, wlanCPIntStatusCheckButton=wlanCPIntStatusCheckButton, vnsRadiusServerSharedSecret=vnsRadiusServerSharedSecret, apLogFileUtilityLimit=apLogFileUtilityLimit, apDesc=apDesc, licenseAvailableAP=licenseAvailableAP, apPerfRadioCurrentRSS=apPerfRadioCurrentRSS, cpHeaderURL=cpHeaderURL, vnsQoSWirelessULPolicerAction=vnsQoSWirelessULPolicerAction, topoStatBroadcastRxPkts=topoStatBroadcastRxPkts, scanGroupAPAssignControllerIPAddress=scanGroupAPAssignControllerIPAddress, wlanPrivWPAv2EncryptionType=wlanPrivWPAv2EncryptionType, topologyTable=topologyTable, apInOctets=apInOctets, vnsExceptionStatPktsAllowed=vnsExceptionStatPktsAllowed, apTable=apTable, hiPathWirelessControllerMib=hiPathWirelessControllerMib, vnsRateControlProfInd=vnsRateControlProfInd, vnsAPFilterEntry=vnsAPFilterEntry, tunnelStartIP=tunnelStartIP, wlanPrivBroadcastRekeying=wlanPrivBroadcastRekeying, tspecSsid=tspecSsid, threatSummaryCategory=threatSummaryCategory, topology=topology, tspecApSerialNumber=tspecApSerialNumber, licenseLocalRadarAP=licenseLocalRadarAP, ntpTimeServer3=ntpTimeServer3, inSrvScanGrpScan5GHzSelection=inSrvScanGrpScan5GHzSelection, layerTwoPortMgmtState=layerTwoPortMgmtState, radiusId=radiusId, maxBackgroundBWforReassociation=maxBackgroundBWforReassociation, apPerfWlanPrevPeakULPktsPerSec=apPerfWlanPrevPeakULPktsPerSec, loadGroupLoadControlStrictLimitR1=loadGroupLoadControlStrictLimitR1, apAntennaGroup=apAntennaGroup, availability=availability, vnsFilterRuleOrder=vnsFilterRuleOrder, topologyAPRegistration=topologyAPRegistration, apLocationbasedService=apLocationbasedService, inSrvScanGrpblockAdHocClientsPeriod=inSrvScanGrpblockAdHocClientsPeriod, apTotalStationsACInOctets=apTotalStationsACInOctets, widsWipsEngineEntry=widsWipsEngineEntry, ntpTimezone=ntpTimezone, apAccPrevPeakDisassocDeauthReqTx=apAccPrevPeakDisassocDeauthReqTx, muRxPackets=muRxPackets, assocRxOctets=assocRxOctets, vnHeartbeatInterval=vnHeartbeatInterval, topoExceptionStatEntry=topoExceptionStatEntry, wlanUnsecuredWlanCounts=wlanUnsecuredWlanCounts, apAccDisassocDeauthReqRx=apAccDisassocDeauthReqRx, vnsQoSWirelessEnableUAPSD=vnsQoSWirelessEnableUAPSD, systemObjects=systemObjects, stationsByProtocolN24=stationsByProtocolN24, portName=portName, vnsGlobalSetting=vnsGlobalSetting, wlanRowStatus=wlanRowStatus, apPerfRadioPrevPeakPktRetx=apPerfRadioPrevPeakPktRetx, nearbyApInfo=nearbyApInfo, prohibitedAPManufacturer=prohibitedAPManufacturer, apLogUserId=apLogUserId, tunnelEndHWC=tunnelEndHWC, topologyLayer3=topologyLayer3, authorizedAPGroup=authorizedAPGroup, apRadioAntennaGroup=apRadioAntennaGroup, apPerfWlanPrevPeakClientsPerSec=apPerfWlanPrevPeakClientsPerSec, apMaintenanceCycle=apMaintenanceCycle, uncategorizedAPCounts=uncategorizedAPCounts, activeThreatEntry=activeThreatEntry, siteWlanApRadioAssigned=siteWlanApRadioAssigned, dedicatedScanGrpDetectRogueAP=dedicatedScanGrpDetectRogueAP, countermeasureAPEntry=countermeasureAPEntry, physicalPortsEntry=physicalPortsEntry, wassp=wassp, loadGroupBandPreference=loadGroupBandPreference, vnsRateControlCIR=vnsRateControlCIR, loadGrpRadiosRadio1=loadGrpRadiosRadio1, wlanAuthRadiusAcctAfterMacBaseAuthorization=wlanAuthRadiusAcctAfterMacBaseAuthorization, phyDHCPRangeGroup=phyDHCPRangeGroup, apAccCurrentAssocReqRx=apAccCurrentAssocReqRx, assocDuration=assocDuration, siteAPMember=siteAPMember, wlanAuthRadiusIncludeIngressRC=wlanAuthRadiusIncludeIngressRC, vnsQoSWirelessLegacyFlag=vnsQoSWirelessLegacyFlag, loadGroupEntry=loadGroupEntry, inSrvScanGrpRowStatus=inSrvScanGrpRowStatus, stationEventType=stationEventType, externalRadiusServerEntry=externalRadiusServerEntry, radiusExtnsSettingTable=radiusExtnsSettingTable, apRadioAttenuation=apRadioAttenuation, siteMaxEntries=siteMaxEntries, sysLogLevel=sysLogLevel, apLogFileCopyTable=apLogFileCopyTable, cpLoginLabel=cpLoginLabel, vnsVlanID=vnsVlanID, wlanRadiusNASUseVnsIP=wlanRadiusNASUseVnsIP, cpReplaceGatewayWithFQDN=cpReplaceGatewayWithFQDN, outOfSrvScanGrpChannelDwellTime=outOfSrvScanGrpChannelDwellTime, wlanRadiusEntry=wlanRadiusEntry, siteWlanApRadioIndex=siteWlanApRadioIndex, vnsDHCPRangeEnd=vnsDHCPRangeEnd, hiPathWirelessAppLogFacility=hiPathWirelessAppLogFacility, dhcpRelayListeners=dhcpRelayListeners, externalRadiusServerRowStatus=externalRadiusServerRowStatus, dhcpRelayListenersNumEntries=dhcpRelayListenersNumEntries, apPerfWlanPrevPeakDLPktsPerSec=apPerfWlanPrevPeakDLPktsPerSec, siteMaxClientR2=siteMaxClientR2, vnsWEPKeyEntry=vnsWEPKeyEntry, radiusFastFailoverEvents=radiusFastFailoverEvents, muWLANID=muWLANID, licenseInServiceRadarAP=licenseInServiceRadarAP, muTxOctets=muTxOctets, layerTwoPortEntry=layerTwoPortEntry, vnsDHCPRangeIndex=vnsDHCPRangeIndex, vnsWDSRFBridge=vnsWDSRFBridge, inSrvScanGrpMaxConcurrentAttacksPerAP=inSrvScanGrpMaxConcurrentAttacksPerAP, scanAPGroup=scanAPGroup, activeThreatGroup=activeThreatGroup, recurrenceDaily=recurrenceDaily, apByChannelAPs=apByChannelAPs, apPerfWlanCurrentULPktsPerSec=apPerfWlanCurrentULPktsPerSec, topoExceptionStatPktsDenied=topoExceptionStatPktsDenied, apInErrors=apInErrors, wlanSecurityReportTable=wlanSecurityReportTable, countermeasureAPTable=countermeasureAPTable, vnsFilterRuleStatus=vnsFilterRuleStatus, apSecureDataTunnelType=apSecureDataTunnelType, vnsSLPEnabled=vnsSLPEnabled, dedicatedScanGrpScan5GHzFreq=dedicatedScanGrpScan5GHzFreq, stationBSSID=stationBSSID, duration=duration, portFunction=portFunction, radioIfIndex=radioIfIndex, apLogFileCopyUserID=apLogFileCopyUserID, hwcAvailabilityRank=hwcAvailabilityRank, wlanMaxEntries=wlanMaxEntries, apAccAssocReqRx=apAccAssocReqRx, sysLogServersTable=sysLogServersTable, vnsCaptivePortalTable=vnsCaptivePortalTable, muDuration=muDuration, vnsQoSTable=vnsQoSTable, widsWipsEngineRowStatus=widsWipsEngineRowStatus, wlanAuthTable=wlanAuthTable, topologySyncIPEnd=topologySyncIPEnd, wlanRadiusPriority=wlanRadiusPriority, inSrvScanGrpDetectRogueAP=inSrvScanGrpDetectRogueAP, vnsStatRadiusReqRejected=vnsStatRadiusReqRejected, apLogFileCopyEntry=apLogFileCopyEntry, wlanRadiusServerAcctSIAR=wlanRadiusServerAcctSIAR, muTSPECTable=muTSPECTable, apTotalStationsG=apTotalStationsG, licenseForeignRadarAP=licenseForeignRadarAP, virtualNetworks=virtualNetworks, apInNUcastPkts=apInNUcastPkts, vnsConfigWLANID=vnsConfigWLANID, apConfigObjects=apConfigObjects, mitigatorAnalysisEngine=mitigatorAnalysisEngine, vnsPrivWPA2Enabled=vnsPrivWPA2Enabled, stationDetailEvent=stationDetailEvent, mgmtPortObjects=mgmtPortObjects, topoStatRxOctets=topoStatRxOctets, tunnelStatsTable=tunnelStatsTable, apPerfRadioAverageChannelUtilization=apPerfRadioAverageChannelUtilization, secureConnection=secureConnection, armReplyMessage=armReplyMessage, wlanNetFlow=wlanNetFlow, vnsStatRadiusTotRequests=vnsStatRadiusTotRequests, inSrvScanGrpScan2400MHzSelection=inSrvScanGrpScan2400MHzSelection, scanAPProfileType=scanAPProfileType, apSiteID=apSiteID, scanGroupMaxEntries=scanGroupMaxEntries, apPollInterval=apPollInterval, vnsDHCPRangeStatus=vnsDHCPRangeStatus, stationsByProtocolA=stationsByProtocolA, wlanPrivGroupKPSR=wlanPrivGroupKPSR, apAntennanName=apAntennanName, uncategorizedAPSSID=uncategorizedAPSSID, licenseMode=licenseMode, topologyIsGroup=topologyIsGroup, siteReplaceStnIDwithSiteName=siteReplaceStnIDwithSiteName, activeThreatCounterMeasure=activeThreatCounterMeasure, vnsRadiusServerRowStatus=vnsRadiusServerRowStatus, destinationName=destinationName, wlanIdleTimeoutPreAuth=wlanIdleTimeoutPreAuth, wlanPrivKeyManagement=wlanPrivKeyManagement, wlanCPSendLoginTo=wlanCPSendLoginTo, wlanRadiusServerMacUseVNSIPAddr=wlanRadiusServerMacUseVNSIPAddr, siteNumEntries=siteNumEntries, topoCompleteStatTable=topoCompleteStatTable, inSrvScanGrpListeningPort=inSrvScanGrpListeningPort, friendlyAPMacAddress=friendlyAPMacAddress, tspecSBA=tspecSBA, vnsConfigObjects=vnsConfigObjects, friendlyAPDescription=friendlyAPDescription, topoWireStatRxPkts=topoWireStatRxPkts, wlanRadiusTable=wlanRadiusTable, vnManagerObjects=vnManagerObjects, tunnelStatus=tunnelStatus, apPerfRadioCurPeakSNR=apPerfRadioCurPeakSNR, nearbyApBSSID=nearbyApBSSID, synchronizeSystemConfig=synchronizeSystemConfig, wlanPrivEntry=wlanPrivEntry, tspecAC=tspecAC, vnsWDSStatTxError=vnsWDSStatTxError, topologyIPv6Gateway=topologyIPv6Gateway, apLogFileCopyOperation=apLogFileCopyOperation, licensingInformation=licensingInformation, wlanName=wlanName, wlanPrivfastTransition=wlanPrivfastTransition, countermeasureAPThreatIndex=countermeasureAPThreatIndex, vnsWDSStatRxRSSI=vnsWDSStatRxRSSI, wlanRadiusServerUse=wlanRadiusServerUse, apOutUcastPkts=apOutUcastPkts, vnsPrivUseSharedKey=vnsPrivUseSharedKey, vnTotalClients=vnTotalClients, mgmtPortHostname=mgmtPortHostname, wlanRadiusServerAuthNASId=wlanRadiusServerAuthNASId, wlanSecurityReportFlag=wlanSecurityReportFlag, apCredentialType=apCredentialType, tspecUlViolations=tspecUlViolations)
mibBuilder.exportSymbols("HIPATH-WIRELESS-HWC-MIB", tspecMuIPAddress=tspecMuIPAddress, vnsRadiusServerPort=vnsRadiusServerPort, netflowAndMirrorN=netflowAndMirrorN, apAccCurPeakAssocReqRx=apAccCurPeakAssocReqRx, vnsFilterRuleTable=vnsFilterRuleTable, countermeasureAPTime=countermeasureAPTime, tunnelStatsTxBytes=tunnelStatsTxBytes, portIpAddress=portIpAddress, apOutNUcastPkts=apOutNUcastPkts, tunnelsTxRxBytes=tunnelsTxRxBytes, siteCosTable=siteCosTable, prohibitedAPGroup=prohibitedAPGroup, apCount=apCount, licenseLocalAP=licenseLocalAP, vnsQoSPriorityOverrideSC=vnsQoSPriorityOverrideSC, fastFailoverEvents=fastFailoverEvents, hiPathWirelessHWCModule=hiPathWirelessHWCModule, cpConnectionIP=cpConnectionIP, apLogDestination=apLogDestination, topoCompleteStatName=topoCompleteStatName, phyDHCPRangeType=phyDHCPRangeType, apSoftwareVersion=apSoftwareVersion, apPerfWlanCurPeakULOctetsPerSec=apPerfWlanCurPeakULOctetsPerSec, apTotalStationsN50OutOctets=apTotalStationsN50OutOctets, vnsFilterRuleEtherType=vnsFilterRuleEtherType, apTotalStationsAC=apTotalStationsAC, apPerfWlanULPkts=apPerfWlanULPkts, wlanCPExtPort=wlanCPExtPort, friendlyAPEntry=friendlyAPEntry, stationEventTimeStamp=stationEventTimeStamp, activeThreatAPName=activeThreatAPName, apRadioEntry=apRadioEntry, topologyIPMask=topologyIPMask, dnsObjects=dnsObjects, jumboFrames=jumboFrames, apLogFileCopyServerDirectory=apLogFileCopyServerDirectory, authorizedAPDescription=authorizedAPDescription, apEventAPSerialNumber=apEventAPSerialNumber, wlanSecurityReportGroup=wlanSecurityReportGroup, cpLogOff=cpLogOff, topologySyncMask=topologySyncMask, topoWireStatMulticastTxPkts=topoWireStatMulticastTxPkts, layerTwoPortMacAddress=layerTwoPortMacAddress, apHostname=apHostname, topoCompleteStatMulticastRxPkts=topoCompleteStatMulticastRxPkts, vnsDNSServers=vnsDNSServers, siteCoSMember=siteCoSMember, inSrvScanGrpCounterMeasuresType=inSrvScanGrpCounterMeasuresType, clientMessageDelayTime=clientMessageDelayTime, vnsWDSStatRxFrame=vnsWDSStatRxFrame, mirrorFirstN=mirrorFirstN, stationMacAddress=stationMacAddress, wlanRadiusServerName=wlanRadiusServerName, topoCompleteStatTxPkts=topoCompleteStatTxPkts, apAccAverageDisassocDeauthReqTx=apAccAverageDisassocDeauthReqTx, dhcpRelayListenersRowStatus=dhcpRelayListenersRowStatus, topoWireStatFrameTooLongErrors=topoWireStatFrameTooLongErrors, blaclistedClientGroup=blaclistedClientGroup, apSerialNumber=apSerialNumber, tunnelStatsRxBytes=tunnelStatsRxBytes, vnsExceptionStatTable=vnsExceptionStatTable, radiusFastFailoverEventsTable=radiusFastFailoverEventsTable, wlanRadiusServerAcctNASIP=wlanRadiusServerAcctNASIP, topologySyncIPStart=topologySyncIPStart, topologyConfig=topologyConfig, vnsIfIndex=vnsIfIndex, physicalFlash=physicalFlash, apPerfRadioCurPeakRSS=apPerfRadioCurPeakRSS, muConnectionCapability=muConnectionCapability, muAccessListRowStatus=muAccessListRowStatus, vnsRadiusServerEntry=vnsRadiusServerEntry, apTotalStationsB=apTotalStationsB, apTotalStationsN50InOctets=apTotalStationsN50InOctets, vnsQoSWirelessUseAdmControlBestEffort=vnsQoSWirelessUseAdmControlBestEffort, wlanPrivWEPKey=wlanPrivWEPKey, apActiveCount=apActiveCount, sitePolicyMember=sitePolicyMember, startMinute=startMinute, sysSerialNo=sysSerialNo, inServiceScanGroupTable=inServiceScanGroupTable, wlanCPExtSharedSecret=wlanCPExtSharedSecret, vnsEnabled=vnsEnabled, secondaryDNS=secondaryDNS, apStatsEntry=apStatsEntry, ntpEnabled=ntpEnabled, vnsProcessClientIEReq=vnsProcessClientIEReq, cpConnectionPort=cpConnectionPort, apPlatforms=apPlatforms, wlanRadiusServerEntry=wlanRadiusServerEntry, scanGroupAPAssignmentTable=scanGroupAPAssignmentTable, prohibitedAPDescription=prohibitedAPDescription, muEntry=muEntry, wlanAuthRadiusTimeoutRole=wlanAuthRadiusTimeoutRole, loadGroupLoadControlEnableR2=loadGroupLoadControlEnableR2, stationIPv6Address2=stationIPv6Address2, tunnelStatsEntry=tunnelStatsEntry, apByChannelTable=apByChannelTable, dedicatedScanGroup=dedicatedScanGroup, authenticationAdvanced=authenticationAdvanced, sysCPUType=sysCPUType, scanGroupProfileID=scanGroupProfileID, mgmtPortIfIndex=mgmtPortIfIndex, apInUcastPkts=apInUcastPkts, cpType=cpType, apStaticMTUsize=apStaticMTUsize, tspecProtocol=tspecProtocol, vnsMUSessionTimeout=vnsMUSessionTimeout, wlanSynchronize=wlanSynchronize, topologyIPAddress=topologyIPAddress, protocols=protocols, vnsAPFilterPortHigh=vnsAPFilterPortHigh, topologyMode=topologyMode, uncategorizedAPClassify=uncategorizedAPClassify, apSwVersion=apSwVersion, wlanAppVisibility=wlanAppVisibility, phyDHCPRangeIndex=phyDHCPRangeIndex, blacklistedClientTable=blacklistedClientTable, apPerfRadioCurrentSNR=apPerfRadioCurrentSNR, tunnelStatsTxRxBytes=tunnelStatsTxRxBytes, vnsWDSStatRxRate=vnsWDSStatRxRate, assocTxOctets=assocTxOctets, apRadioNumber=apRadioNumber, wlanTable=wlanTable, mirrorL2Ports=mirrorL2Ports, wlanCPExtEncryption=wlanCPExtEncryption, blacklistedClientEntry=blacklistedClientEntry, radiusFastFailoverEventsGroup=radiusFastFailoverEventsGroup, wlanTableNextAvailableIndex=wlanTableNextAvailableIndex, topologyID=topologyID, siteName=siteName, apAccDisassocDeauthReqTx=apAccDisassocDeauthReqTx, sysLogServerIndex=sysLogServerIndex, wlanAuthMACBasedAuthOnRoam=wlanAuthMACBasedAuthOnRoam, wlanCPGuestMaxConcurrentSession=wlanCPGuestMaxConcurrentSession, vnsQoSWirelessDLPolicerAction=vnsQoSWirelessDLPolicerAction, weakCipherEnable=weakCipherEnable, topologyName=topologyName, topoStatFrameTooLongErrors=topoStatFrameTooLongErrors, wlanRadiusServerMacNASIP=wlanRadiusServerMacNASIP, apIpAssignmentType=apIpAssignmentType, apRegDiscoveryRetries=apRegDiscoveryRetries, loadGrpWlanTable=loadGrpWlanTable, apMacAddress=apMacAddress, physicalPortObjects=physicalPortObjects, netflowDestinationIP=netflowDestinationIP, apLocation=apLocation, assocTxPackets=assocTxPackets, friendlyAPSSID=friendlyAPSSID, tspecNMS=tspecNMS, dedicatedScanGrpSecurityThreats=dedicatedScanGrpSecurityThreats, armCount=armCount, apPerfWlanDLOctets=apPerfWlanDLOctets, vnsWDSRFAPName=vnsWDSRFAPName, wlanPrivWPAv1EncryptionType=wlanPrivWPAv1EncryptionType)
