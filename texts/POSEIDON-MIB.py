...
NotificationType, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, iso, TimeTicks, ModuleIdentity, IpAddress, Counter32, Bits, enterprises, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "iso", "TimeTicks", "ModuleIdentity", "IpAddress", "Counter32", "Bits", "enterprises", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", InputAlarmState=InputAlarmState, tsAlarm=tsAlarm, sensTable=sensTable, sensEntry=sensEntry, sensLimitMin=sensLimitMin, sensIndex=sensIndex, UnitType=UnitType, outIndex=outIndex, SensorString=SensorString, OutputType=OutputType, tsAlarmTable=tsAlarmTable, inpValue=inpValue, charonII=charonII, PositiveInteger=PositiveInteger, sensSetup=sensSetup, sensSetupName=sensSetupName, sensFlags=sensFlags, SensorFlags=SensorFlags, tsAlarmsPresent=tsAlarmsPresent, outTable=outTable, hwgroup=hwgroup, IOName=IOName, tsAlarmSensName=tsAlarmSensName, SensorName=SensorName, outMode=outMode, sensUnit=sensUnit, sensValue=sensValue, sensUnitString=sensUnitString, sensSetupTable=sensSetupTable, sensLimitMax=sensLimitMax, sensSetupIndex=sensSetupIndex, OnOff=OnOff, sensID=sensID, outEntry=outEntry, SensorValue=SensorValue, OutputMode=OutputMode, outName=outName, tsAlarmId=tsAlarmId, SensorUnitString=SensorUnitString, tsAlarmIdx=tsAlarmIdx, tsTrapAlarmEnd=tsTrapAlarmEnd, inpTable=inpTable, sensHysteresis=sensHysteresis, inpAlarmState=inpAlarmState, outType=outType, InputAlarmSetup=InputAlarmSetup, TimeStamp=TimeStamp, sensValueRaw=sensValueRaw, info=info, setup=setup, tsAlarmTime=tsAlarmTime, sensSetupEntry=sensSetupEntry, outValue=outValue, poseidon=poseidon, tsAlarmEntry=tsAlarmEntry, tsTrapAlarmStart=tsTrapAlarmStart, inpAlarmStateChanged=inpAlarmStateChanged, sensState=sensState, inpName=inpName, inpAlarmSetup=inpAlarmSetup, inpIndex=inpIndex, sensName=sensName, sensString=sensString, tsAlarmDescr=tsAlarmDescr, unitType=unitType, inpEntry=inpEntry, sensAlarmStateChanged=sensAlarmStateChanged, SensorState=SensorState, SensorID=SensorID, infoAddressMAC=infoAddressMAC)
