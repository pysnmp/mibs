...
Counter64, Gauge32, NotificationType, ObjectIdentity, enterprises, iso, Counter32, TimeTicks, Unsigned32, IpAddress, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "NotificationType", "ObjectIdentity", "enterprises", "iso", "Counter32", "TimeTicks", "Unsigned32", "IpAddress", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", outTable=outTable, sensUnit=sensUnit, sensState=sensState, tsAlarmSensName=tsAlarmSensName, outIndex=outIndex, sensEntry=sensEntry, tsAlarmsPresent=tsAlarmsPresent, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmDescr=tsAlarmDescr, unitType=unitType, inpEntry=inpEntry, sensAlarmStateChanged=sensAlarmStateChanged, SensorName=SensorName, sensSetupName=sensSetupName, sensFlags=sensFlags, inpAlarmSetup=inpAlarmSetup, inpTable=inpTable, UnitType=UnitType, outValue=outValue, OutputType=OutputType, InputAlarmSetup=InputAlarmSetup, sensUnitString=sensUnitString, sensSetupEntry=sensSetupEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, TimeStamp=TimeStamp, SensorUnitString=SensorUnitString, inpIndex=inpIndex, setup=setup, OnOff=OnOff, sensTable=sensTable, inpAlarmState=inpAlarmState, outName=outName, sensName=sensName, sensSetup=sensSetup, sensSetupIndex=sensSetupIndex, tsAlarmId=tsAlarmId, SensorValue=SensorValue, sensValueRaw=sensValueRaw, sensLimitMin=sensLimitMin, infoAddressMAC=infoAddressMAC, IOName=IOName, sensLimitMax=sensLimitMax, PositiveInteger=PositiveInteger, info=info, SensorFlags=SensorFlags, InputAlarmState=InputAlarmState, SensorString=SensorString, sensID=sensID, outType=outType, inpAlarmStateChanged=inpAlarmStateChanged, OutputMode=OutputMode, sensIndex=sensIndex, tsAlarmTime=tsAlarmTime, inpValue=inpValue, sensValue=sensValue, charonII=charonII, sensHysteresis=sensHysteresis, hwgroup=hwgroup, sensSetupTable=sensSetupTable, tsAlarm=tsAlarm, SensorState=SensorState, outMode=outMode, sensString=sensString, SensorID=SensorID, inpName=inpName, poseidon=poseidon, tsAlarmTable=tsAlarmTable, outEntry=outEntry, tsAlarmEntry=tsAlarmEntry, tsAlarmIdx=tsAlarmIdx)
