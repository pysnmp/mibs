...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, ObjectIdentity, Counter32, iso, Bits, IpAddress, enterprises, TimeTicks, ModuleIdentity, Gauge32, Integer32, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "ObjectIdentity", "Counter32", "iso", "Bits", "IpAddress", "enterprises", "TimeTicks", "ModuleIdentity", "Gauge32", "Integer32", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensSetupEntry=sensSetupEntry, infoAddressMAC=infoAddressMAC, sensString=sensString, SensorValue=SensorValue, InputAlarmSetup=InputAlarmSetup, tsAlarmSensName=tsAlarmSensName, OutputType=OutputType, setup=setup, SensorID=SensorID, unitType=unitType, SensorString=SensorString, poseidon=poseidon, hwgroup=hwgroup, inpEntry=inpEntry, IOName=IOName, info=info, sensValueRaw=sensValueRaw, sensID=sensID, sensSetupTable=sensSetupTable, sensValue=sensValue, tsAlarmEntry=tsAlarmEntry, sensUnitString=sensUnitString, outIndex=outIndex, sensName=sensName, tsTrapAlarmEnd=tsTrapAlarmEnd, inpTable=inpTable, InputAlarmState=InputAlarmState, SensorState=SensorState, TimeStamp=TimeStamp, SensorName=SensorName, sensTable=sensTable, sensEntry=sensEntry, tsAlarmIdx=tsAlarmIdx, sensLimitMin=sensLimitMin, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmsPresent=tsAlarmsPresent, sensSetupIndex=sensSetupIndex, inpAlarmStateChanged=inpAlarmStateChanged, inpIndex=inpIndex, outMode=outMode, outValue=outValue, PositiveInteger=PositiveInteger, outName=outName, OutputMode=OutputMode, inpName=inpName, outType=outType, SensorFlags=SensorFlags, sensHysteresis=sensHysteresis, tsAlarmId=tsAlarmId, tsAlarmDescr=tsAlarmDescr, tsAlarmTime=tsAlarmTime, tsAlarm=tsAlarm, UnitType=UnitType, inpAlarmSetup=inpAlarmSetup, sensLimitMax=sensLimitMax, sensState=sensState, OnOff=OnOff, sensIndex=sensIndex, SensorUnitString=SensorUnitString, outTable=outTable, inpAlarmState=inpAlarmState, outEntry=outEntry, tsAlarmTable=tsAlarmTable, sensSetup=sensSetup, sensSetupName=sensSetupName, sensUnit=sensUnit, tsTrapAlarmStart=tsTrapAlarmStart, charonII=charonII, inpValue=inpValue, sensFlags=sensFlags)
