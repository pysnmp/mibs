...
ObjectIdentity, Integer32, NotificationType, IpAddress, Gauge32, enterprises, TimeTicks, MibIdentifier, ModuleIdentity, Unsigned32, Bits, Counter64, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "NotificationType", "IpAddress", "Gauge32", "enterprises", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Unsigned32", "Bits", "Counter64", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorValue=SensorValue, sensString=sensString, info=info, sensState=sensState, outIndex=outIndex, outName=outName, tsAlarmIdx=tsAlarmIdx, outType=outType, sensName=sensName, SensorFlags=SensorFlags, tsAlarmTable=tsAlarmTable, sensIndex=sensIndex, InputAlarmState=InputAlarmState, sensLimitMax=sensLimitMax, inpName=inpName, SensorString=SensorString, IOName=IOName, SensorName=SensorName, sensTable=sensTable, UnitType=UnitType, charonII=charonII, tsAlarmDescr=tsAlarmDescr, tsAlarmEntry=tsAlarmEntry, setup=setup, sensSetupIndex=sensSetupIndex, sensLimitMin=sensLimitMin, sensSetupTable=sensSetupTable, unitType=unitType, outEntry=outEntry, hwgroup=hwgroup, sensID=sensID, OutputMode=OutputMode, tsAlarm=tsAlarm, tsAlarmsPresent=tsAlarmsPresent, OnOff=OnOff, tsAlarmSensName=tsAlarmSensName, sensHysteresis=sensHysteresis, inpAlarmSetup=inpAlarmSetup, sensValue=sensValue, SensorUnitString=SensorUnitString, SensorID=SensorID, poseidon=poseidon, infoAddressMAC=infoAddressMAC, inpAlarmStateChanged=inpAlarmStateChanged, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, inpEntry=inpEntry, sensValueRaw=sensValueRaw, InputAlarmSetup=InputAlarmSetup, outMode=outMode, sensUnit=sensUnit, sensUnitString=sensUnitString, SensorState=SensorState, inpTable=inpTable, OutputType=OutputType, sensSetupEntry=sensSetupEntry, inpAlarmState=inpAlarmState, inpIndex=inpIndex, sensFlags=sensFlags, tsTrapAlarmEnd=tsTrapAlarmEnd, outValue=outValue, tsAlarmTime=tsAlarmTime, sensSetup=sensSetup, sensSetupName=sensSetupName, inpValue=inpValue, outTable=outTable, tsAlarmId=tsAlarmId, PositiveInteger=PositiveInteger, TimeStamp=TimeStamp, sensEntry=sensEntry)
