...
TimeTicks, Counter32, Integer32, ObjectIdentity, MibIdentifier, Bits, Unsigned32, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, NotificationType, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "Integer32", "ObjectIdentity", "MibIdentifier", "Bits", "Unsigned32", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "NotificationType", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensLimitMax=sensLimitMax, tsTrapAlarmStart=tsTrapAlarmStart, sensValueRaw=sensValueRaw, sensName=sensName, OnOff=OnOff, TimeStamp=TimeStamp, outType=outType, hwgroup=hwgroup, sensSetup=sensSetup, inpEntry=inpEntry, sensAlarmStateChanged=sensAlarmStateChanged, SensorFlags=SensorFlags, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorState=SensorState, OutputType=OutputType, tsAlarmIdx=tsAlarmIdx, tsAlarmSensName=tsAlarmSensName, inpAlarmStateChanged=inpAlarmStateChanged, sensSetupName=sensSetupName, tsAlarm=tsAlarm, tsAlarmsPresent=tsAlarmsPresent, infoAddressMAC=infoAddressMAC, SensorUnitString=SensorUnitString, charonII=charonII, SensorString=SensorString, IOName=IOName, outMode=outMode, PositiveInteger=PositiveInteger, sensIndex=sensIndex, InputAlarmState=InputAlarmState, inpTable=inpTable, InputAlarmSetup=InputAlarmSetup, setup=setup, outName=outName, sensUnit=sensUnit, inpName=inpName, inpAlarmSetup=inpAlarmSetup, sensTable=sensTable, outTable=outTable, outEntry=outEntry, outIndex=outIndex, outValue=outValue, inpAlarmState=inpAlarmState, inpIndex=inpIndex, UnitType=UnitType, poseidon=poseidon, sensString=sensString, sensUnitString=sensUnitString, tsAlarmEntry=tsAlarmEntry, SensorID=SensorID, sensValue=sensValue, SensorValue=SensorValue, tsAlarmTime=tsAlarmTime, sensSetupIndex=sensSetupIndex, sensHysteresis=sensHysteresis, inpValue=inpValue, sensID=sensID, tsAlarmTable=tsAlarmTable, tsAlarmId=tsAlarmId, info=info, tsAlarmDescr=tsAlarmDescr, unitType=unitType, sensSetupTable=sensSetupTable, sensLimitMin=sensLimitMin, sensState=sensState, sensEntry=sensEntry, SensorName=SensorName, sensSetupEntry=sensSetupEntry, OutputMode=OutputMode, sensFlags=sensFlags)
