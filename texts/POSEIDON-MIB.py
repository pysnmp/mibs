...
mibBuilder.exportSymbols("POSEIDON-MIB", charonII=charonII, sensLimitMin=sensLimitMin, tsAlarm=tsAlarm, TimeStamp=TimeStamp, IOName=IOName, sensSetupName=sensSetupName, tsAlarmDescr=tsAlarmDescr, sensValue=sensValue, sensState=sensState, sensSetupIndex=sensSetupIndex, sensFlags=sensFlags, sensSetupTable=sensSetupTable, SensorName=SensorName, inpValue=inpValue, tsAlarmIdx=tsAlarmIdx, outTable=outTable, inpAlarmState=inpAlarmState, outMode=outMode, poseidon=poseidon, sensUnitString=sensUnitString, inpEntry=inpEntry, PositiveInteger=PositiveInteger, SensorUnitString=SensorUnitString, hwgroup=hwgroup, sensName=sensName, unitType=unitType, sensIndex=sensIndex, sensLimitMax=sensLimitMax, sensValueRaw=sensValueRaw, inpTable=inpTable, sensAlarmStateChanged=sensAlarmStateChanged, InputAlarmSetup=InputAlarmSetup, tsAlarmTime=tsAlarmTime, tsTrapAlarmEnd=tsTrapAlarmEnd, sensSetupEntry=sensSetupEntry, inpAlarmSetup=inpAlarmSetup, sensString=sensString, sensHysteresis=sensHysteresis, infoAddressMAC=infoAddressMAC, sensSetup=sensSetup, tsAlarmsPresent=tsAlarmsPresent, OutputType=OutputType, tsTrapAlarmStart=tsTrapAlarmStart, SensorID=SensorID, inpIndex=inpIndex, setup=setup, info=info, outIndex=outIndex, sensTable=sensTable, inpName=inpName, inpAlarmStateChanged=inpAlarmStateChanged, InputAlarmState=InputAlarmState, OutputMode=OutputMode, UnitType=UnitType, tsAlarmId=tsAlarmId, SensorString=SensorString, sensUnit=sensUnit, outName=outName, sensID=sensID, outValue=outValue, outType=outType, outEntry=outEntry, SensorState=SensorState, SensorFlags=SensorFlags, SensorValue=SensorValue, sensEntry=sensEntry, tsAlarmTable=tsAlarmTable, tsAlarmSensName=tsAlarmSensName, tsAlarmEntry=tsAlarmEntry, OnOff=OnOff)
