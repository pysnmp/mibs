...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Bits, Counter64, Unsigned32, iso, Gauge32, Counter32, TimeTicks, IpAddress, ObjectIdentity, Integer32, NotificationType, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Bits", "Counter64", "Unsigned32", "iso", "Gauge32", "Counter32", "TimeTicks", "IpAddress", "ObjectIdentity", "Integer32", "NotificationType", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorState=SensorState, charonII=charonII, sensAlarmStateChanged=sensAlarmStateChanged, outName=outName, sensFlags=sensFlags, inpName=inpName, TimeStamp=TimeStamp, hwgroup=hwgroup, sensLimitMax=sensLimitMax, tsAlarmId=tsAlarmId, inpIndex=inpIndex, tsTrapAlarmEnd=tsTrapAlarmEnd, poseidon=poseidon, IOName=IOName, sensUnit=sensUnit, sensLimitMin=sensLimitMin, InputAlarmState=InputAlarmState, SensorUnitString=SensorUnitString, setup=setup, inpEntry=inpEntry, tsAlarmDescr=tsAlarmDescr, sensValue=sensValue, inpValue=inpValue, tsAlarm=tsAlarm, infoAddressMAC=infoAddressMAC, sensString=sensString, sensHysteresis=sensHysteresis, SensorString=SensorString, outValue=outValue, sensID=sensID, sensState=sensState, sensSetup=sensSetup, SensorValue=SensorValue, sensName=sensName, OutputMode=OutputMode, PositiveInteger=PositiveInteger, SensorFlags=SensorFlags, tsAlarmsPresent=tsAlarmsPresent, OutputType=OutputType, OnOff=OnOff, inpTable=inpTable, outTable=outTable, sensEntry=sensEntry, inpAlarmState=inpAlarmState, tsAlarmSensName=tsAlarmSensName, tsTrapAlarmStart=tsTrapAlarmStart, sensValueRaw=sensValueRaw, inpAlarmSetup=inpAlarmSetup, outMode=outMode, sensTable=sensTable, outEntry=outEntry, tsAlarmTime=tsAlarmTime, sensSetupIndex=sensSetupIndex, SensorName=SensorName, sensSetupTable=sensSetupTable, unitType=unitType, tsAlarmIdx=tsAlarmIdx, outType=outType, tsAlarmEntry=tsAlarmEntry, UnitType=UnitType, outIndex=outIndex, sensIndex=sensIndex, InputAlarmSetup=InputAlarmSetup, sensUnitString=sensUnitString, sensSetupEntry=sensSetupEntry, inpAlarmStateChanged=inpAlarmStateChanged, info=info, sensSetupName=sensSetupName, tsAlarmTable=tsAlarmTable, SensorID=SensorID)
