...
Gauge32, Counter64, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Bits, NotificationType, iso, ObjectIdentity, TimeTicks, Integer32, Unsigned32, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Bits", "NotificationType", "iso", "ObjectIdentity", "TimeTicks", "Integer32", "Unsigned32", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorID=SensorID, sensUnitString=sensUnitString, SensorFlags=SensorFlags, outMode=outMode, OutputType=OutputType, inpEntry=inpEntry, UnitType=UnitType, info=info, sensValueRaw=sensValueRaw, tsAlarm=tsAlarm, outEntry=outEntry, sensIndex=sensIndex, sensString=sensString, tsAlarmTable=tsAlarmTable, outValue=outValue, sensFlags=sensFlags, sensTable=sensTable, tsAlarmEntry=tsAlarmEntry, tsAlarmTime=tsAlarmTime, IOName=IOName, tsAlarmIdx=tsAlarmIdx, sensHysteresis=sensHysteresis, PositiveInteger=PositiveInteger, sensSetupTable=sensSetupTable, inpAlarmSetup=inpAlarmSetup, sensLimitMax=sensLimitMax, outType=outType, inpAlarmStateChanged=inpAlarmStateChanged, charonII=charonII, SensorState=SensorState, sensEntry=sensEntry, sensLimitMin=sensLimitMin, tsTrapAlarmEnd=tsTrapAlarmEnd, outIndex=outIndex, sensSetupEntry=sensSetupEntry, tsAlarmDescr=tsAlarmDescr, infoAddressMAC=infoAddressMAC, SensorValue=SensorValue, outName=outName, inpTable=inpTable, sensSetupIndex=sensSetupIndex, outTable=outTable, inpAlarmState=inpAlarmState, sensID=sensID, InputAlarmState=InputAlarmState, tsAlarmId=tsAlarmId, tsAlarmsPresent=tsAlarmsPresent, SensorString=SensorString, unitType=unitType, sensName=sensName, SensorUnitString=SensorUnitString, SensorName=SensorName, tsAlarmSensName=tsAlarmSensName, OutputMode=OutputMode, TimeStamp=TimeStamp, inpIndex=inpIndex, sensValue=sensValue, sensSetupName=sensSetupName, sensState=sensState, tsTrapAlarmStart=tsTrapAlarmStart, inpName=inpName, sensSetup=sensSetup, sensAlarmStateChanged=sensAlarmStateChanged, hwgroup=hwgroup, inpValue=inpValue, setup=setup, sensUnit=sensUnit, InputAlarmSetup=InputAlarmSetup, poseidon=poseidon, OnOff=OnOff)
