...
IpAddress, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, Counter32, TimeTicks, enterprises, Counter64, NotificationType, Unsigned32, Integer32, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "Counter32", "TimeTicks", "enterprises", "Counter64", "NotificationType", "Unsigned32", "Integer32", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", UnitType=UnitType, SensorState=SensorState, inpAlarmState=inpAlarmState, inpAlarmStateChanged=inpAlarmStateChanged, setup=setup, charonII=charonII, SensorUnitString=SensorUnitString, tsAlarmId=tsAlarmId, tsAlarmDescr=tsAlarmDescr, outMode=outMode, outEntry=outEntry, sensTable=sensTable, sensSetupName=sensSetupName, SensorName=SensorName, sensUnit=sensUnit, hwgroup=hwgroup, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmTime=tsAlarmTime, PositiveInteger=PositiveInteger, inpIndex=inpIndex, sensID=sensID, poseidon=poseidon, inpEntry=inpEntry, sensLimitMax=sensLimitMax, sensValueRaw=sensValueRaw, InputAlarmSetup=InputAlarmSetup, outType=outType, SensorID=SensorID, IOName=IOName, TimeStamp=TimeStamp, SensorFlags=SensorFlags, outValue=outValue, sensValue=sensValue, tsAlarmTable=tsAlarmTable, infoAddressMAC=infoAddressMAC, OutputMode=OutputMode, sensString=sensString, tsAlarmSensName=tsAlarmSensName, sensLimitMin=sensLimitMin, sensFlags=sensFlags, sensName=sensName, outTable=outTable, tsAlarmEntry=tsAlarmEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, sensSetupEntry=sensSetupEntry, inpName=inpName, sensState=sensState, inpTable=inpTable, unitType=unitType, sensSetupTable=sensSetupTable, tsAlarmsPresent=tsAlarmsPresent, info=info, outName=outName, tsAlarm=tsAlarm, SensorString=SensorString, sensAlarmStateChanged=sensAlarmStateChanged, InputAlarmState=InputAlarmState, SensorValue=SensorValue, sensSetupIndex=sensSetupIndex, sensSetup=sensSetup, outIndex=outIndex, inpValue=inpValue, tsAlarmIdx=tsAlarmIdx, sensHysteresis=sensHysteresis, sensUnitString=sensUnitString, sensIndex=sensIndex, OnOff=OnOff, inpAlarmSetup=inpAlarmSetup, OutputType=OutputType, sensEntry=sensEntry)
