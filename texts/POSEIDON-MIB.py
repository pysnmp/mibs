...
mibBuilder.exportSymbols("POSEIDON-MIB", inpEntry=inpEntry, sensUnit=sensUnit, SensorFlags=SensorFlags, inpIndex=inpIndex, tsAlarmId=tsAlarmId, sensState=sensState, tsAlarmIdx=tsAlarmIdx, sensSetup=sensSetup, SensorString=SensorString, charonII=charonII, sensHysteresis=sensHysteresis, sensUnitString=sensUnitString, sensID=sensID, InputAlarmSetup=InputAlarmSetup, sensSetupTable=sensSetupTable, sensLimitMax=sensLimitMax, hwgroup=hwgroup, sensSetupIndex=sensSetupIndex, SensorID=SensorID, SensorUnitString=SensorUnitString, setup=setup, inpValue=inpValue, sensAlarmStateChanged=sensAlarmStateChanged, OutputType=OutputType, PositiveInteger=PositiveInteger, outIndex=outIndex, InputAlarmState=InputAlarmState, outType=outType, sensString=sensString, sensName=sensName, inpAlarmState=inpAlarmState, sensTable=sensTable, tsAlarmsPresent=tsAlarmsPresent, tsAlarmEntry=tsAlarmEntry, tsAlarmSensName=tsAlarmSensName, tsAlarmTime=tsAlarmTime, tsTrapAlarmEnd=tsTrapAlarmEnd, outValue=outValue, SensorState=SensorState, sensValue=sensValue, sensFlags=sensFlags, sensValueRaw=sensValueRaw, OnOff=OnOff, outMode=outMode, sensIndex=sensIndex, sensSetupEntry=sensSetupEntry, outEntry=outEntry, inpAlarmStateChanged=inpAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, outTable=outTable, OutputMode=OutputMode, sensSetupName=sensSetupName, outName=outName, SensorValue=SensorValue, inpTable=inpTable, poseidon=poseidon, info=info, inpAlarmSetup=inpAlarmSetup, tsAlarm=tsAlarm, unitType=unitType, infoAddressMAC=infoAddressMAC, TimeStamp=TimeStamp, UnitType=UnitType, sensEntry=sensEntry, tsAlarmTable=tsAlarmTable, inpName=inpName, tsAlarmDescr=tsAlarmDescr, SensorName=SensorName, sensLimitMin=sensLimitMin, IOName=IOName)
