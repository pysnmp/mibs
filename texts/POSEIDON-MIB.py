...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorValue=SensorValue, sensName=sensName, sensIndex=sensIndex, SensorUnitString=SensorUnitString, sensSetupEntry=sensSetupEntry, sensString=sensString, infoAddressMAC=infoAddressMAC, tsAlarmsPresent=tsAlarmsPresent, OutputMode=OutputMode, charonII=charonII, hwgroup=hwgroup, UnitType=UnitType, inpTable=inpTable, inpAlarmState=inpAlarmState, sensTable=sensTable, inpValue=inpValue, tsAlarmSensName=tsAlarmSensName, sensFlags=sensFlags, sensLimitMin=sensLimitMin, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmEntry=tsAlarmEntry, SensorString=SensorString, sensSetupTable=sensSetupTable, poseidon=poseidon, sensLimitMax=sensLimitMax, sensEntry=sensEntry, inpAlarmSetup=inpAlarmSetup, sensSetupIndex=sensSetupIndex, outIndex=outIndex, sensSetupName=sensSetupName, sensValue=sensValue, sensAlarmStateChanged=sensAlarmStateChanged, IOName=IOName, inpEntry=inpEntry, outEntry=outEntry, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarm=tsAlarm, tsAlarmTime=tsAlarmTime, SensorState=SensorState, sensState=sensState, InputAlarmSetup=InputAlarmSetup, sensValueRaw=sensValueRaw, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmIdx=tsAlarmIdx, SensorName=SensorName, sensID=sensID, outMode=outMode, TimeStamp=TimeStamp, inpName=inpName, tsAlarmTable=tsAlarmTable, unitType=unitType, outTable=outTable, PositiveInteger=PositiveInteger, info=info, sensHysteresis=sensHysteresis, sensUnitString=sensUnitString, outName=outName, tsAlarmId=tsAlarmId, sensSetup=sensSetup, setup=setup, SensorID=SensorID, sensUnit=sensUnit, OnOff=OnOff, tsAlarmDescr=tsAlarmDescr, outValue=outValue, OutputType=OutputType, InputAlarmState=InputAlarmState, SensorFlags=SensorFlags, outType=outType, inpIndex=inpIndex)
