...
Unsigned32, Counter32, Integer32, enterprises, Counter64, NotificationType, ModuleIdentity, Bits, MibIdentifier, TimeTicks, IpAddress, iso, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "Integer32", "enterprises", "Counter64", "NotificationType", "ModuleIdentity", "Bits", "MibIdentifier", "TimeTicks", "IpAddress", "iso", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("POSEIDON-MIB", InputAlarmSetup=InputAlarmSetup, sensEntry=sensEntry, sensFlags=sensFlags, PositiveInteger=PositiveInteger, TimeStamp=TimeStamp, tsTrapAlarmEnd=tsTrapAlarmEnd, OnOff=OnOff, IOName=IOName, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarm=tsAlarm, inpEntry=inpEntry, inpValue=inpValue, sensIndex=sensIndex, sensSetupTable=sensSetupTable, sensState=sensState, outMode=outMode, sensHysteresis=sensHysteresis, sensAlarmStateChanged=sensAlarmStateChanged, outIndex=outIndex, tsAlarmSensName=tsAlarmSensName, SensorFlags=SensorFlags, SensorState=SensorState, sensSetupIndex=sensSetupIndex, sensLimitMin=sensLimitMin, UnitType=UnitType, OutputType=OutputType, SensorUnitString=SensorUnitString, tsAlarmDescr=tsAlarmDescr, tsAlarmTable=tsAlarmTable, inpTable=inpTable, outType=outType, infoAddressMAC=infoAddressMAC, sensName=sensName, sensSetup=sensSetup, hwgroup=hwgroup, inpName=inpName, sensString=sensString, tsAlarmsPresent=tsAlarmsPresent, sensValueRaw=sensValueRaw, info=info, sensLimitMax=sensLimitMax, SensorString=SensorString, setup=setup, outEntry=outEntry, sensID=sensID, SensorName=SensorName, poseidon=poseidon, outName=outName, sensTable=sensTable, tsAlarmTime=tsAlarmTime, unitType=unitType, tsAlarmEntry=tsAlarmEntry, outValue=outValue, sensValue=sensValue, SensorID=SensorID, charonII=charonII, inpAlarmSetup=inpAlarmSetup, InputAlarmState=InputAlarmState, sensUnit=sensUnit, inpAlarmState=inpAlarmState, tsAlarmIdx=tsAlarmIdx, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmId=tsAlarmId, sensUnitString=sensUnitString, sensSetupName=sensSetupName, inpIndex=inpIndex, outTable=outTable, OutputMode=OutputMode, SensorValue=SensorValue, sensSetupEntry=sensSetupEntry)
