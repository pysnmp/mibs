...
enterprises, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, ObjectIdentity, MibIdentifier, Counter64, Bits, Unsigned32, ModuleIdentity, Gauge32, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "ObjectIdentity", "MibIdentifier", "Counter64", "Bits", "Unsigned32", "ModuleIdentity", "Gauge32", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", OutputMode=OutputMode, info=info, outIndex=outIndex, sensLimitMax=sensLimitMax, sensFlags=sensFlags, sensString=sensString, outValue=outValue, PositiveInteger=PositiveInteger, UnitType=UnitType, charonII=charonII, inpTable=inpTable, sensName=sensName, sensValueRaw=sensValueRaw, IOName=IOName, tsAlarmEntry=tsAlarmEntry, SensorUnitString=SensorUnitString, sensHysteresis=sensHysteresis, sensEntry=sensEntry, outType=outType, sensSetup=sensSetup, SensorString=SensorString, tsTrapAlarmStart=tsTrapAlarmStart, sensTable=sensTable, SensorID=SensorID, InputAlarmState=InputAlarmState, SensorValue=SensorValue, infoAddressMAC=infoAddressMAC, sensSetupEntry=sensSetupEntry, inpAlarmSetup=inpAlarmSetup, sensSetupName=sensSetupName, sensAlarmStateChanged=sensAlarmStateChanged, poseidon=poseidon, inpAlarmStateChanged=inpAlarmStateChanged, setup=setup, OnOff=OnOff, tsAlarmDescr=tsAlarmDescr, sensSetupTable=sensSetupTable, sensState=sensState, sensValue=sensValue, SensorState=SensorState, TimeStamp=TimeStamp, outEntry=outEntry, sensLimitMin=sensLimitMin, InputAlarmSetup=InputAlarmSetup, sensIndex=sensIndex, inpEntry=inpEntry, sensID=sensID, inpIndex=inpIndex, outTable=outTable, tsAlarmsPresent=tsAlarmsPresent, inpName=inpName, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmTime=tsAlarmTime, sensSetupIndex=sensSetupIndex, OutputType=OutputType, tsAlarmSensName=tsAlarmSensName, hwgroup=hwgroup, tsAlarm=tsAlarm, inpValue=inpValue, outName=outName, sensUnit=sensUnit, outMode=outMode, tsAlarmTable=tsAlarmTable, tsAlarmIdx=tsAlarmIdx, SensorFlags=SensorFlags, sensUnitString=sensUnitString, inpAlarmState=inpAlarmState, unitType=unitType, SensorName=SensorName, tsAlarmId=tsAlarmId)
