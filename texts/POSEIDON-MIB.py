...
Counter64, TimeTicks, Unsigned32, IpAddress, iso, Integer32, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, NotificationType, ModuleIdentity, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "Unsigned32", "IpAddress", "iso", "Integer32", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "NotificationType", "ModuleIdentity", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensValueRaw=sensValueRaw, tsAlarmEntry=tsAlarmEntry, outTable=outTable, inpIndex=inpIndex, PositiveInteger=PositiveInteger, tsAlarm=tsAlarm, OutputType=OutputType, tsAlarmId=tsAlarmId, tsAlarmTime=tsAlarmTime, info=info, sensSetupTable=sensSetupTable, sensValue=sensValue, sensLimitMax=sensLimitMax, outValue=outValue, sensSetupName=sensSetupName, InputAlarmSetup=InputAlarmSetup, sensHysteresis=sensHysteresis, inpAlarmStateChanged=inpAlarmStateChanged, UnitType=UnitType, hwgroup=hwgroup, OnOff=OnOff, SensorName=SensorName, TimeStamp=TimeStamp, InputAlarmState=InputAlarmState, sensUnitString=sensUnitString, sensTable=sensTable, sensLimitMin=sensLimitMin, poseidon=poseidon, sensAlarmStateChanged=sensAlarmStateChanged, sensUnit=sensUnit, sensString=sensString, infoAddressMAC=infoAddressMAC, charonII=charonII, tsAlarmSensName=tsAlarmSensName, SensorFlags=SensorFlags, outMode=outMode, sensSetup=sensSetup, sensSetupIndex=sensSetupIndex, inpValue=inpValue, outType=outType, sensEntry=sensEntry, inpEntry=inpEntry, sensID=sensID, setup=setup, outName=outName, tsAlarmTable=tsAlarmTable, tsAlarmDescr=tsAlarmDescr, SensorValue=SensorValue, outEntry=outEntry, sensFlags=sensFlags, tsAlarmsPresent=tsAlarmsPresent, sensIndex=sensIndex, outIndex=outIndex, inpName=inpName, inpAlarmSetup=inpAlarmSetup, tsTrapAlarmStart=tsTrapAlarmStart, unitType=unitType, inpAlarmState=inpAlarmState, sensSetupEntry=sensSetupEntry, sensState=sensState, tsTrapAlarmEnd=tsTrapAlarmEnd, OutputMode=OutputMode, IOName=IOName, inpTable=inpTable, SensorUnitString=SensorUnitString, sensName=sensName, tsAlarmIdx=tsAlarmIdx, SensorState=SensorState, SensorString=SensorString, SensorID=SensorID)
