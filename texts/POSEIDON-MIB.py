...
Unsigned32, NotificationType, Gauge32, TimeTicks, ModuleIdentity, Counter32, Bits, enterprises, Counter64, iso, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "Gauge32", "TimeTicks", "ModuleIdentity", "Counter32", "Bits", "enterprises", "Counter64", "iso", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", InputAlarmState=InputAlarmState, TimeStamp=TimeStamp, sensSetupIndex=sensSetupIndex, inpIndex=inpIndex, SensorState=SensorState, inpValue=inpValue, outMode=outMode, tsAlarmSensName=tsAlarmSensName, sensSetupTable=sensSetupTable, tsAlarmsPresent=tsAlarmsPresent, sensState=sensState, tsAlarmId=tsAlarmId, sensFlags=sensFlags, sensEntry=sensEntry, tsAlarmTime=tsAlarmTime, sensLimitMin=sensLimitMin, tsAlarmIdx=tsAlarmIdx, SensorName=SensorName, sensIndex=sensIndex, SensorFlags=SensorFlags, info=info, IOName=IOName, sensString=sensString, sensUnit=sensUnit, tsAlarm=tsAlarm, sensHysteresis=sensHysteresis, sensLimitMax=sensLimitMax, inpAlarmSetup=inpAlarmSetup, outTable=outTable, OutputType=OutputType, charonII=charonII, outEntry=outEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorString=SensorString, inpAlarmState=inpAlarmState, tsAlarmTable=tsAlarmTable, hwgroup=hwgroup, inpAlarmStateChanged=inpAlarmStateChanged, sensTable=sensTable, outIndex=outIndex, sensUnitString=sensUnitString, SensorUnitString=SensorUnitString, tsAlarmDescr=tsAlarmDescr, sensValueRaw=sensValueRaw, inpEntry=inpEntry, sensSetup=sensSetup, InputAlarmSetup=InputAlarmSetup, outValue=outValue, outType=outType, sensSetupEntry=sensSetupEntry, sensSetupName=sensSetupName, OutputMode=OutputMode, setup=setup, outName=outName, sensValue=sensValue, tsTrapAlarmStart=tsTrapAlarmStart, unitType=unitType, UnitType=UnitType, OnOff=OnOff, SensorID=SensorID, poseidon=poseidon, inpTable=inpTable, tsAlarmEntry=tsAlarmEntry, sensAlarmStateChanged=sensAlarmStateChanged, infoAddressMAC=infoAddressMAC, inpName=inpName, SensorValue=SensorValue, sensName=sensName, sensID=sensID, PositiveInteger=PositiveInteger)
