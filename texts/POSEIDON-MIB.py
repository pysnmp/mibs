...
Bits, Gauge32, TimeTicks, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, IpAddress, Counter32, NotificationType, Integer32, ObjectIdentity, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "TimeTicks", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "IpAddress", "Counter32", "NotificationType", "Integer32", "ObjectIdentity", "enterprises", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpAlarmState=inpAlarmState, sensHysteresis=sensHysteresis, SensorValue=SensorValue, outValue=outValue, sensLimitMin=sensLimitMin, tsAlarmEntry=tsAlarmEntry, hwgroup=hwgroup, sensName=sensName, sensFlags=sensFlags, sensID=sensID, tsAlarmDescr=tsAlarmDescr, outEntry=outEntry, sensString=sensString, infoAddressMAC=infoAddressMAC, UnitType=UnitType, tsAlarmSensName=tsAlarmSensName, IOName=IOName, inpAlarmSetup=inpAlarmSetup, InputAlarmState=InputAlarmState, SensorName=SensorName, poseidon=poseidon, outType=outType, sensTable=sensTable, tsAlarmsPresent=tsAlarmsPresent, sensSetupTable=sensSetupTable, sensSetupEntry=sensSetupEntry, inpName=inpName, sensValue=sensValue, charonII=charonII, info=info, tsAlarmTable=tsAlarmTable, setup=setup, sensLimitMax=sensLimitMax, sensUnit=sensUnit, SensorFlags=SensorFlags, inpIndex=inpIndex, sensUnitString=sensUnitString, tsAlarm=tsAlarm, inpAlarmStateChanged=inpAlarmStateChanged, sensSetup=sensSetup, OnOff=OnOff, OutputMode=OutputMode, SensorUnitString=SensorUnitString, inpTable=inpTable, unitType=unitType, inpValue=inpValue, tsAlarmIdx=tsAlarmIdx, TimeStamp=TimeStamp, SensorID=SensorID, outMode=outMode, SensorString=SensorString, PositiveInteger=PositiveInteger, outTable=outTable, sensValueRaw=sensValueRaw, SensorState=SensorState, outIndex=outIndex, inpEntry=inpEntry, tsAlarmTime=tsAlarmTime, sensIndex=sensIndex, outName=outName, tsAlarmId=tsAlarmId, OutputType=OutputType, sensSetupIndex=sensSetupIndex, sensSetupName=sensSetupName, InputAlarmSetup=InputAlarmSetup, sensEntry=sensEntry, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, tsTrapAlarmEnd=tsTrapAlarmEnd, sensState=sensState)
