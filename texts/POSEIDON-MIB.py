...
NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, MibIdentifier, Integer32, ModuleIdentity, iso, ObjectIdentity, Bits, Unsigned32, Counter64, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "MibIdentifier", "Integer32", "ModuleIdentity", "iso", "ObjectIdentity", "Bits", "Unsigned32", "Counter64", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("POSEIDON-MIB", OutputType=OutputType, OnOff=OnOff, inpValue=inpValue, hwgroup=hwgroup, outTable=outTable, outIndex=outIndex, UnitType=UnitType, tsAlarmSensName=tsAlarmSensName, SensorName=SensorName, unitType=unitType, SensorState=SensorState, poseidon=poseidon, sensState=sensState, tsAlarmDescr=tsAlarmDescr, sensSetupTable=sensSetupTable, SensorValue=SensorValue, sensName=sensName, tsAlarmEntry=tsAlarmEntry, IOName=IOName, tsAlarmTable=tsAlarmTable, tsAlarmIdx=tsAlarmIdx, sensLimitMin=sensLimitMin, inpEntry=inpEntry, outValue=outValue, SensorString=SensorString, tsAlarm=tsAlarm, outType=outType, outEntry=outEntry, sensEntry=sensEntry, sensIndex=sensIndex, infoAddressMAC=infoAddressMAC, inpName=inpName, sensSetup=sensSetup, sensHysteresis=sensHysteresis, SensorFlags=SensorFlags, inpAlarmStateChanged=inpAlarmStateChanged, sensTable=sensTable, sensSetupEntry=sensSetupEntry, sensID=sensID, sensAlarmStateChanged=sensAlarmStateChanged, sensUnitString=sensUnitString, InputAlarmState=InputAlarmState, sensValueRaw=sensValueRaw, InputAlarmSetup=InputAlarmSetup, tsTrapAlarmEnd=tsTrapAlarmEnd, tsTrapAlarmStart=tsTrapAlarmStart, inpIndex=inpIndex, sensFlags=sensFlags, inpAlarmState=inpAlarmState, tsAlarmId=tsAlarmId, sensSetupIndex=sensSetupIndex, SensorUnitString=SensorUnitString, sensLimitMax=sensLimitMax, sensValue=sensValue, setup=setup, tsAlarmsPresent=tsAlarmsPresent, info=info, SensorID=SensorID, outName=outName, inpTable=inpTable, outMode=outMode, sensString=sensString, sensSetupName=sensSetupName, PositiveInteger=PositiveInteger, TimeStamp=TimeStamp, sensUnit=sensUnit, OutputMode=OutputMode, inpAlarmSetup=inpAlarmSetup, charonII=charonII, tsAlarmTime=tsAlarmTime)
