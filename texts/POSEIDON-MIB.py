...
Unsigned32, Bits, Counter64, ObjectIdentity, NotificationType, MibIdentifier, enterprises, TimeTicks, IpAddress, Integer32, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "Counter64", "ObjectIdentity", "NotificationType", "MibIdentifier", "enterprises", "TimeTicks", "IpAddress", "Integer32", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", TimeStamp=TimeStamp, tsAlarmSensName=tsAlarmSensName, SensorValue=SensorValue, charonII=charonII, SensorString=SensorString, setup=setup, SensorState=SensorState, PositiveInteger=PositiveInteger, sensState=sensState, OnOff=OnOff, inpAlarmState=inpAlarmState, InputAlarmSetup=InputAlarmSetup, sensUnitString=sensUnitString, OutputMode=OutputMode, InputAlarmState=InputAlarmState, sensTable=sensTable, outTable=outTable, sensIndex=sensIndex, sensFlags=sensFlags, UnitType=UnitType, outValue=outValue, outName=outName, tsAlarmIdx=tsAlarmIdx, outType=outType, unitType=unitType, SensorUnitString=SensorUnitString, inpIndex=inpIndex, tsAlarmsPresent=tsAlarmsPresent, sensLimitMin=sensLimitMin, sensSetupIndex=sensSetupIndex, tsTrapAlarmStart=tsTrapAlarmStart, OutputType=OutputType, IOName=IOName, inpEntry=inpEntry, outMode=outMode, sensAlarmStateChanged=sensAlarmStateChanged, inpValue=inpValue, outIndex=outIndex, sensValueRaw=sensValueRaw, infoAddressMAC=infoAddressMAC, SensorName=SensorName, sensSetup=sensSetup, SensorFlags=SensorFlags, sensID=sensID, tsAlarm=tsAlarm, outEntry=outEntry, inpName=inpName, SensorID=SensorID, info=info, tsAlarmTable=tsAlarmTable, tsAlarmId=tsAlarmId, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmTime=tsAlarmTime, hwgroup=hwgroup, poseidon=poseidon, inpAlarmSetup=inpAlarmSetup, sensSetupEntry=sensSetupEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, sensValue=sensValue, sensHysteresis=sensHysteresis, sensSetupTable=sensSetupTable, sensString=sensString, sensName=sensName, inpTable=inpTable, sensUnit=sensUnit, tsAlarmEntry=tsAlarmEntry, sensEntry=sensEntry, sensSetupName=sensSetupName, tsAlarmDescr=tsAlarmDescr, sensLimitMax=sensLimitMax)
