...
mibBuilder.exportSymbols("POSEIDON-MIB", inpTable=inpTable, tsAlarmIdx=tsAlarmIdx, OutputMode=OutputMode, SensorUnitString=SensorUnitString, setup=setup, sensEntry=sensEntry, OutputType=OutputType, sensIndex=sensIndex, sensSetupEntry=sensSetupEntry, inpValue=inpValue, SensorName=SensorName, sensHysteresis=sensHysteresis, outEntry=outEntry, tsAlarmId=tsAlarmId, infoAddressMAC=infoAddressMAC, sensSetup=sensSetup, outMode=outMode, UnitType=UnitType, sensValue=sensValue, inpAlarmStateChanged=inpAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, info=info, TimeStamp=TimeStamp, InputAlarmState=InputAlarmState, SensorFlags=SensorFlags, sensString=sensString, outType=outType, outValue=outValue, sensValueRaw=sensValueRaw, tsAlarmDescr=tsAlarmDescr, PositiveInteger=PositiveInteger, sensSetupName=sensSetupName, SensorState=SensorState, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmSensName=tsAlarmSensName, sensUnit=sensUnit, OnOff=OnOff, inpAlarmState=inpAlarmState, tsAlarmsPresent=tsAlarmsPresent, sensSetupTable=sensSetupTable, sensAlarmStateChanged=sensAlarmStateChanged, SensorString=SensorString, SensorID=SensorID, sensLimitMax=sensLimitMax, sensFlags=sensFlags, poseidon=poseidon, sensState=sensState, tsAlarm=tsAlarm, sensTable=sensTable, outName=outName, inpIndex=inpIndex, unitType=unitType, sensSetupIndex=sensSetupIndex, outTable=outTable, sensUnitString=sensUnitString, sensLimitMin=sensLimitMin, InputAlarmSetup=InputAlarmSetup, charonII=charonII, inpName=inpName, sensID=sensID, outIndex=outIndex, tsAlarmEntry=tsAlarmEntry, inpEntry=inpEntry, tsAlarmTable=tsAlarmTable, hwgroup=hwgroup, SensorValue=SensorValue, inpAlarmSetup=inpAlarmSetup, IOName=IOName, sensName=sensName, tsAlarmTime=tsAlarmTime)
