...
ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, MibIdentifier, ObjectIdentity, Bits, IpAddress, Gauge32, TimeTicks, Counter32, Unsigned32, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "MibIdentifier", "ObjectIdentity", "Bits", "IpAddress", "Gauge32", "TimeTicks", "Counter32", "Unsigned32", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensHysteresis=sensHysteresis, inpAlarmState=inpAlarmState, tsAlarmIdx=tsAlarmIdx, sensID=sensID, OnOff=OnOff, SensorState=SensorState, sensValueRaw=sensValueRaw, tsAlarmSensName=tsAlarmSensName, UnitType=UnitType, sensTable=sensTable, tsAlarmId=tsAlarmId, sensLimitMax=sensLimitMax, outMode=outMode, sensName=sensName, IOName=IOName, sensEntry=sensEntry, inpAlarmSetup=inpAlarmSetup, inpName=inpName, outValue=outValue, outName=outName, sensUnit=sensUnit, inpIndex=inpIndex, infoAddressMAC=infoAddressMAC, sensSetup=sensSetup, InputAlarmSetup=InputAlarmSetup, inpValue=inpValue, sensLimitMin=sensLimitMin, sensSetupIndex=sensSetupIndex, sensValue=sensValue, tsAlarmTable=tsAlarmTable, sensSetupName=sensSetupName, inpAlarmStateChanged=inpAlarmStateChanged, OutputMode=OutputMode, sensIndex=sensIndex, PositiveInteger=PositiveInteger, InputAlarmState=InputAlarmState, outEntry=outEntry, outIndex=outIndex, SensorUnitString=SensorUnitString, sensUnitString=sensUnitString, unitType=unitType, poseidon=poseidon, inpEntry=inpEntry, tsAlarmDescr=tsAlarmDescr, charonII=charonII, tsTrapAlarmEnd=tsTrapAlarmEnd, OutputType=OutputType, outTable=outTable, sensState=sensState, tsAlarmEntry=tsAlarmEntry, tsAlarmTime=tsAlarmTime, outType=outType, SensorString=SensorString, inpTable=inpTable, sensSetupTable=sensSetupTable, sensSetupEntry=sensSetupEntry, TimeStamp=TimeStamp, sensString=sensString, tsAlarmsPresent=tsAlarmsPresent, info=info, sensFlags=sensFlags, SensorName=SensorName, sensAlarmStateChanged=sensAlarmStateChanged, setup=setup, tsTrapAlarmStart=tsTrapAlarmStart, SensorID=SensorID, SensorValue=SensorValue, SensorFlags=SensorFlags, hwgroup=hwgroup, tsAlarm=tsAlarm)
