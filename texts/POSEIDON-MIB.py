...
MibIdentifier, ObjectIdentity, ModuleIdentity, Unsigned32, NotificationType, iso, TimeTicks, Gauge32, Integer32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "NotificationType", "iso", "TimeTicks", "Gauge32", "Integer32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensLimitMin=sensLimitMin, inpTable=inpTable, outEntry=outEntry, sensUnitString=sensUnitString, sensLimitMax=sensLimitMax, outName=outName, sensHysteresis=sensHysteresis, poseidon=poseidon, sensValue=sensValue, inpAlarmState=inpAlarmState, SensorUnitString=SensorUnitString, tsAlarmsPresent=tsAlarmsPresent, sensSetupIndex=sensSetupIndex, tsTrapAlarmStart=tsTrapAlarmStart, sensTable=sensTable, sensIndex=sensIndex, tsAlarmIdx=tsAlarmIdx, tsAlarmTime=tsAlarmTime, sensSetupEntry=sensSetupEntry, inpAlarmSetup=inpAlarmSetup, sensAlarmStateChanged=sensAlarmStateChanged, SensorFlags=SensorFlags, hwgroup=hwgroup, sensUnit=sensUnit, inpValue=inpValue, sensValueRaw=sensValueRaw, SensorValue=SensorValue, sensSetupTable=sensSetupTable, sensString=sensString, tsAlarmId=tsAlarmId, unitType=unitType, OutputMode=OutputMode, inpEntry=inpEntry, outIndex=outIndex, OnOff=OnOff, TimeStamp=TimeStamp, info=info, SensorName=SensorName, outMode=outMode, InputAlarmState=InputAlarmState, sensName=sensName, sensID=sensID, tsAlarmSensName=tsAlarmSensName, outValue=outValue, outType=outType, tsAlarmTable=tsAlarmTable, sensEntry=sensEntry, sensSetup=sensSetup, SensorState=SensorState, inpIndex=inpIndex, tsAlarmEntry=tsAlarmEntry, tsAlarm=tsAlarm, SensorString=SensorString, inpName=inpName, tsTrapAlarmEnd=tsTrapAlarmEnd, setup=setup, PositiveInteger=PositiveInteger, sensState=sensState, sensSetupName=sensSetupName, charonII=charonII, IOName=IOName, outTable=outTable, inpAlarmStateChanged=inpAlarmStateChanged, OutputType=OutputType, InputAlarmSetup=InputAlarmSetup, tsAlarmDescr=tsAlarmDescr, SensorID=SensorID, UnitType=UnitType, infoAddressMAC=infoAddressMAC, sensFlags=sensFlags)
