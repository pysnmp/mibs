...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorName=SensorName, sensSetupIndex=sensSetupIndex, poseidon=poseidon, inpValue=inpValue, infoAddressMAC=infoAddressMAC, inpEntry=inpEntry, OutputType=OutputType, sensString=sensString, sensValueRaw=sensValueRaw, inpIndex=inpIndex, setup=setup, sensEntry=sensEntry, sensValue=sensValue, info=info, OnOff=OnOff, tsAlarmTable=tsAlarmTable, outName=outName, SensorUnitString=SensorUnitString, SensorString=SensorString, inpAlarmState=inpAlarmState, sensState=sensState, tsAlarmTime=tsAlarmTime, sensID=sensID, sensSetupEntry=sensSetupEntry, inpAlarmSetup=inpAlarmSetup, hwgroup=hwgroup, outMode=outMode, tsAlarm=tsAlarm, UnitType=UnitType, IOName=IOName, tsAlarmId=tsAlarmId, SensorID=SensorID, PositiveInteger=PositiveInteger, sensLimitMax=sensLimitMax, TimeStamp=TimeStamp, InputAlarmState=InputAlarmState, inpName=inpName, sensSetupTable=sensSetupTable, sensTable=sensTable, tsAlarmsPresent=tsAlarmsPresent, outValue=outValue, sensHysteresis=sensHysteresis, outTable=outTable, sensIndex=sensIndex, tsAlarmSensName=tsAlarmSensName, sensLimitMin=sensLimitMin, inpAlarmStateChanged=inpAlarmStateChanged, sensName=sensName, tsAlarmDescr=tsAlarmDescr, unitType=unitType, SensorState=SensorState, OutputMode=OutputMode, outIndex=outIndex, tsAlarmIdx=tsAlarmIdx, sensSetup=sensSetup, SensorValue=SensorValue, charonII=charonII, sensUnitString=sensUnitString, tsTrapAlarmStart=tsTrapAlarmStart, sensFlags=sensFlags, outEntry=outEntry, sensSetupName=sensSetupName, tsTrapAlarmEnd=tsTrapAlarmEnd, sensAlarmStateChanged=sensAlarmStateChanged, InputAlarmSetup=InputAlarmSetup, outType=outType, SensorFlags=SensorFlags, tsAlarmEntry=tsAlarmEntry, inpTable=inpTable, sensUnit=sensUnit)
