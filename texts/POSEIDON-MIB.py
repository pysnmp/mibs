...
iso, TimeTicks, Integer32, Counter32, MibIdentifier, ObjectIdentity, ModuleIdentity, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, Unsigned32, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Integer32", "Counter32", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "Unsigned32", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorValue=SensorValue, SensorName=SensorName, outEntry=outEntry, infoAddressMAC=infoAddressMAC, sensSetupTable=sensSetupTable, sensID=sensID, InputAlarmState=InputAlarmState, tsAlarm=tsAlarm, tsAlarmTime=tsAlarmTime, outIndex=outIndex, OutputType=OutputType, outType=outType, tsAlarmTable=tsAlarmTable, SensorString=SensorString, sensState=sensState, tsAlarmEntry=tsAlarmEntry, IOName=IOName, inpValue=inpValue, outMode=outMode, setup=setup, sensLimitMax=sensLimitMax, unitType=unitType, tsAlarmId=tsAlarmId, sensEntry=sensEntry, SensorFlags=SensorFlags, sensSetupName=sensSetupName, inpTable=inpTable, inpAlarmState=inpAlarmState, SensorState=SensorState, inpIndex=inpIndex, sensName=sensName, tsTrapAlarmEnd=tsTrapAlarmEnd, sensUnitString=sensUnitString, sensFlags=sensFlags, SensorID=SensorID, charonII=charonII, sensIndex=sensIndex, sensSetupEntry=sensSetupEntry, sensUnit=sensUnit, sensValue=sensValue, sensValueRaw=sensValueRaw, InputAlarmSetup=InputAlarmSetup, inpEntry=inpEntry, outTable=outTable, inpAlarmSetup=inpAlarmSetup, sensHysteresis=sensHysteresis, info=info, tsAlarmSensName=tsAlarmSensName, outValue=outValue, sensAlarmStateChanged=sensAlarmStateChanged, PositiveInteger=PositiveInteger, sensSetupIndex=sensSetupIndex, OnOff=OnOff, tsAlarmDescr=tsAlarmDescr, hwgroup=hwgroup, OutputMode=OutputMode, SensorUnitString=SensorUnitString, inpName=inpName, tsAlarmIdx=tsAlarmIdx, outName=outName, sensString=sensString, sensLimitMin=sensLimitMin, sensTable=sensTable, tsAlarmsPresent=tsAlarmsPresent, inpAlarmStateChanged=inpAlarmStateChanged, poseidon=poseidon, TimeStamp=TimeStamp, sensSetup=sensSetup, UnitType=UnitType, tsTrapAlarmStart=tsTrapAlarmStart)
