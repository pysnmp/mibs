...
mibBuilder.exportSymbols("POSEIDON-MIB", sensTable=sensTable, SensorUnitString=SensorUnitString, inpIndex=inpIndex, outMode=outMode, sensSetupIndex=sensSetupIndex, OnOff=OnOff, inpName=inpName, outType=outType, SensorString=SensorString, sensValueRaw=sensValueRaw, sensFlags=sensFlags, tsAlarm=tsAlarm, outIndex=outIndex, InputAlarmSetup=InputAlarmSetup, sensString=sensString, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmIdx=tsAlarmIdx, infoAddressMAC=infoAddressMAC, sensState=sensState, sensID=sensID, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorName=SensorName, OutputMode=OutputMode, inpTable=inpTable, sensSetupTable=sensSetupTable, IOName=IOName, SensorValue=SensorValue, outEntry=outEntry, tsAlarmEntry=tsAlarmEntry, tsAlarmTime=tsAlarmTime, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmDescr=tsAlarmDescr, setup=setup, sensName=sensName, inpAlarmState=inpAlarmState, OutputType=OutputType, inpValue=inpValue, SensorFlags=SensorFlags, tsAlarmId=tsAlarmId, inpAlarmSetup=inpAlarmSetup, outTable=outTable, tsAlarmSensName=tsAlarmSensName, unitType=unitType, charonII=charonII, hwgroup=hwgroup, inpAlarmStateChanged=inpAlarmStateChanged, UnitType=UnitType, sensSetupName=sensSetupName, SensorID=SensorID, sensIndex=sensIndex, sensValue=sensValue, sensSetupEntry=sensSetupEntry, sensUnitString=sensUnitString, outName=outName, PositiveInteger=PositiveInteger, tsAlarmsPresent=tsAlarmsPresent, sensHysteresis=sensHysteresis, TimeStamp=TimeStamp, poseidon=poseidon, sensEntry=sensEntry, outValue=outValue, tsAlarmTable=tsAlarmTable, sensSetup=sensSetup, sensUnit=sensUnit, sensLimitMin=sensLimitMin, info=info, inpEntry=inpEntry, sensLimitMax=sensLimitMax, SensorState=SensorState, InputAlarmState=InputAlarmState)
