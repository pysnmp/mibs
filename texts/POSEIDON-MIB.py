...
Counter64, MibIdentifier, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, NotificationType, ModuleIdentity, Unsigned32, Gauge32, iso, Bits, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "NotificationType", "ModuleIdentity", "Unsigned32", "Gauge32", "iso", "Bits", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmsPresent=tsAlarmsPresent, SensorName=SensorName, inpAlarmState=inpAlarmState, tsTrapAlarmStart=tsTrapAlarmStart, sensName=sensName, poseidon=poseidon, inpIndex=inpIndex, tsAlarmEntry=tsAlarmEntry, outName=outName, IOName=IOName, infoAddressMAC=infoAddressMAC, setup=setup, inpAlarmStateChanged=inpAlarmStateChanged, inpName=inpName, inpValue=inpValue, tsAlarmTime=tsAlarmTime, tsTrapAlarmEnd=tsTrapAlarmEnd, outEntry=outEntry, sensValueRaw=sensValueRaw, OnOff=OnOff, SensorID=SensorID, PositiveInteger=PositiveInteger, info=info, tsAlarmDescr=tsAlarmDescr, TimeStamp=TimeStamp, sensIndex=sensIndex, sensEntry=sensEntry, tsAlarmSensName=tsAlarmSensName, sensSetupEntry=sensSetupEntry, sensAlarmStateChanged=sensAlarmStateChanged, SensorString=SensorString, sensLimitMax=sensLimitMax, outMode=outMode, charonII=charonII, tsAlarmIdx=tsAlarmIdx, InputAlarmSetup=InputAlarmSetup, tsAlarmId=tsAlarmId, sensString=sensString, sensSetupIndex=sensSetupIndex, sensTable=sensTable, OutputType=OutputType, sensSetupTable=sensSetupTable, SensorFlags=SensorFlags, sensValue=sensValue, outValue=outValue, outIndex=outIndex, UnitType=UnitType, SensorUnitString=SensorUnitString, sensState=sensState, outTable=outTable, inpTable=inpTable, sensUnit=sensUnit, sensFlags=sensFlags, hwgroup=hwgroup, sensUnitString=sensUnitString, tsAlarm=tsAlarm, tsAlarmTable=tsAlarmTable, outType=outType, unitType=unitType, sensSetupName=sensSetupName, SensorValue=SensorValue, inpEntry=inpEntry, sensHysteresis=sensHysteresis, sensID=sensID, OutputMode=OutputMode, sensSetup=sensSetup, sensLimitMin=sensLimitMin, inpAlarmSetup=inpAlarmSetup, InputAlarmState=InputAlarmState, SensorState=SensorState)
