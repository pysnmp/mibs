...
MibIdentifier, Counter64, Gauge32, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, Counter32, Bits, Integer32, ModuleIdentity, TimeTicks, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "Gauge32", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "Counter32", "Bits", "Integer32", "ModuleIdentity", "TimeTicks", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", outType=outType, tsAlarmId=tsAlarmId, hwgroup=hwgroup, tsAlarmIdx=tsAlarmIdx, sensSetupTable=sensSetupTable, InputAlarmState=InputAlarmState, inpIndex=inpIndex, tsAlarmTime=tsAlarmTime, infoAddressMAC=infoAddressMAC, sensLimitMax=sensLimitMax, sensName=sensName, setup=setup, outValue=outValue, sensIndex=sensIndex, sensState=sensState, outEntry=outEntry, sensUnit=sensUnit, sensSetupIndex=sensSetupIndex, SensorString=SensorString, sensValue=sensValue, tsTrapAlarmStart=tsTrapAlarmStart, unitType=unitType, inpTable=inpTable, SensorUnitString=SensorUnitString, sensID=sensID, SensorState=SensorState, charonII=charonII, info=info, sensSetup=sensSetup, SensorFlags=SensorFlags, outIndex=outIndex, sensValueRaw=sensValueRaw, inpAlarmSetup=inpAlarmSetup, sensSetupName=sensSetupName, UnitType=UnitType, inpValue=inpValue, IOName=IOName, tsTrapAlarmEnd=tsTrapAlarmEnd, sensSetupEntry=sensSetupEntry, sensLimitMin=sensLimitMin, inpAlarmStateChanged=inpAlarmStateChanged, poseidon=poseidon, InputAlarmSetup=InputAlarmSetup, sensEntry=sensEntry, sensUnitString=sensUnitString, sensAlarmStateChanged=sensAlarmStateChanged, SensorName=SensorName, tsAlarmsPresent=tsAlarmsPresent, PositiveInteger=PositiveInteger, sensTable=sensTable, SensorValue=SensorValue, inpEntry=inpEntry, tsAlarmEntry=tsAlarmEntry, tsAlarmDescr=tsAlarmDescr, sensString=sensString, sensHysteresis=sensHysteresis, OutputMode=OutputMode, OnOff=OnOff, inpName=inpName, TimeStamp=TimeStamp, tsAlarmSensName=tsAlarmSensName, sensFlags=sensFlags, tsAlarm=tsAlarm, outTable=outTable, outName=outName, OutputType=OutputType, SensorID=SensorID, inpAlarmState=inpAlarmState, tsAlarmTable=tsAlarmTable, outMode=outMode)
