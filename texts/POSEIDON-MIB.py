...
mibBuilder.exportSymbols("POSEIDON-MIB", inpEntry=inpEntry, sensName=sensName, outName=outName, sensID=sensID, tsAlarmEntry=tsAlarmEntry, sensSetup=sensSetup, tsAlarmsPresent=tsAlarmsPresent, sensValue=sensValue, tsAlarmTime=tsAlarmTime, setup=setup, unitType=unitType, outTable=outTable, SensorState=SensorState, IOName=IOName, inpAlarmStateChanged=inpAlarmStateChanged, InputAlarmState=InputAlarmState, tsTrapAlarmEnd=tsTrapAlarmEnd, sensEntry=sensEntry, sensSetupTable=sensSetupTable, sensHysteresis=sensHysteresis, SensorFlags=SensorFlags, OnOff=OnOff, SensorValue=SensorValue, OutputType=OutputType, sensIndex=sensIndex, sensSetupIndex=sensSetupIndex, TimeStamp=TimeStamp, tsAlarmId=tsAlarmId, sensSetupName=sensSetupName, inpTable=inpTable, SensorString=SensorString, sensUnit=sensUnit, info=info, outValue=outValue, outType=outType, outEntry=outEntry, outMode=outMode, tsAlarm=tsAlarm, poseidon=poseidon, tsAlarmIdx=tsAlarmIdx, sensAlarmStateChanged=sensAlarmStateChanged, SensorID=SensorID, sensValueRaw=sensValueRaw, sensString=sensString, SensorName=SensorName, PositiveInteger=PositiveInteger, InputAlarmSetup=InputAlarmSetup, inpValue=inpValue, OutputMode=OutputMode, sensUnitString=sensUnitString, inpIndex=inpIndex, charonII=charonII, infoAddressMAC=infoAddressMAC, sensLimitMax=sensLimitMax, tsTrapAlarmStart=tsTrapAlarmStart, sensTable=sensTable, tsAlarmSensName=tsAlarmSensName, sensFlags=sensFlags, sensLimitMin=sensLimitMin, tsAlarmTable=tsAlarmTable, inpAlarmSetup=inpAlarmSetup, sensState=sensState, SensorUnitString=SensorUnitString, inpName=inpName, UnitType=UnitType, outIndex=outIndex, inpAlarmState=inpAlarmState, sensSetupEntry=sensSetupEntry, hwgroup=hwgroup, tsAlarmDescr=tsAlarmDescr)
