...
ObjectIdentity, Unsigned32, Counter64, IpAddress, Bits, NotificationType, MibIdentifier, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises, Counter32, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Counter64", "IpAddress", "Bits", "NotificationType", "MibIdentifier", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises", "Counter32", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", OutputMode=OutputMode, tsAlarm=tsAlarm, sensString=sensString, sensName=sensName, unitType=unitType, sensSetupTable=sensSetupTable, tsAlarmDescr=tsAlarmDescr, sensFlags=sensFlags, UnitType=UnitType, tsAlarmId=tsAlarmId, sensValueRaw=sensValueRaw, hwgroup=hwgroup, inpName=inpName, inpIndex=inpIndex, sensHysteresis=sensHysteresis, sensSetupIndex=sensSetupIndex, tsTrapAlarmStart=tsTrapAlarmStart, inpEntry=inpEntry, InputAlarmSetup=InputAlarmSetup, SensorState=SensorState, charonII=charonII, setup=setup, inpValue=inpValue, outMode=outMode, inpAlarmStateChanged=inpAlarmStateChanged, inpAlarmState=inpAlarmState, sensSetup=sensSetup, sensAlarmStateChanged=sensAlarmStateChanged, poseidon=poseidon, outTable=outTable, sensEntry=sensEntry, SensorName=SensorName, sensLimitMin=sensLimitMin, outIndex=outIndex, tsAlarmTime=tsAlarmTime, OutputType=OutputType, PositiveInteger=PositiveInteger, sensTable=sensTable, sensValue=sensValue, sensUnitString=sensUnitString, OnOff=OnOff, tsAlarmsPresent=tsAlarmsPresent, tsAlarmIdx=tsAlarmIdx, info=info, SensorFlags=SensorFlags, outType=outType, sensSetupEntry=sensSetupEntry, SensorUnitString=SensorUnitString, inpTable=inpTable, inpAlarmSetup=inpAlarmSetup, outValue=outValue, sensUnit=sensUnit, outEntry=outEntry, infoAddressMAC=infoAddressMAC, sensSetupName=sensSetupName, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmEntry=tsAlarmEntry, SensorValue=SensorValue, tsAlarmTable=tsAlarmTable, sensIndex=sensIndex, sensLimitMax=sensLimitMax, SensorString=SensorString, outName=outName, tsAlarmSensName=tsAlarmSensName, InputAlarmState=InputAlarmState, SensorID=SensorID, sensState=sensState, TimeStamp=TimeStamp, IOName=IOName, sensID=sensID)
