...
mibBuilder.exportSymbols("POSEIDON-MIB", sensFlags=sensFlags, charonII=charonII, outType=outType, tsAlarmSensName=tsAlarmSensName, outValue=outValue, tsAlarmEntry=tsAlarmEntry, sensIndex=sensIndex, tsAlarmsPresent=tsAlarmsPresent, outEntry=outEntry, outIndex=outIndex, inpValue=inpValue, outMode=outMode, sensEntry=sensEntry, info=info, sensValue=sensValue, tsAlarm=tsAlarm, unitType=unitType, TimeStamp=TimeStamp, sensSetupName=sensSetupName, sensUnitString=sensUnitString, tsAlarmIdx=tsAlarmIdx, sensSetupTable=sensSetupTable, inpAlarmStateChanged=inpAlarmStateChanged, SensorString=SensorString, infoAddressMAC=infoAddressMAC, sensSetup=sensSetup, InputAlarmState=InputAlarmState, outTable=outTable, sensLimitMin=sensLimitMin, sensLimitMax=sensLimitMax, tsTrapAlarmStart=tsTrapAlarmStart, inpName=inpName, poseidon=poseidon, tsAlarmDescr=tsAlarmDescr, SensorFlags=SensorFlags, setup=setup, SensorValue=SensorValue, OnOff=OnOff, inpEntry=inpEntry, inpIndex=inpIndex, tsAlarmTable=tsAlarmTable, OutputType=OutputType, sensSetupEntry=sensSetupEntry, SensorName=SensorName, IOName=IOName, sensID=sensID, tsAlarmTime=tsAlarmTime, outName=outName, inpAlarmState=inpAlarmState, sensState=sensState, PositiveInteger=PositiveInteger, sensHysteresis=sensHysteresis, InputAlarmSetup=InputAlarmSetup, OutputMode=OutputMode, sensName=sensName, UnitType=UnitType, tsAlarmId=tsAlarmId, sensSetupIndex=sensSetupIndex, inpTable=inpTable, sensValueRaw=sensValueRaw, SensorUnitString=SensorUnitString, hwgroup=hwgroup, sensUnit=sensUnit, SensorID=SensorID, sensTable=sensTable, sensString=sensString, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorState=SensorState, inpAlarmSetup=inpAlarmSetup)
