...
enterprises, ModuleIdentity, MibIdentifier, TimeTicks, Counter32, iso, Counter64, Unsigned32, Integer32, NotificationType, ObjectIdentity, Bits, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Counter32", "iso", "Counter64", "Unsigned32", "Integer32", "NotificationType", "ObjectIdentity", "Bits", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensIndex=sensIndex, sensID=sensID, tsAlarmTime=tsAlarmTime, sensSetupTable=sensSetupTable, PositiveInteger=PositiveInteger, outMode=outMode, OutputMode=OutputMode, inpAlarmStateChanged=inpAlarmStateChanged, sensTable=sensTable, sensSetup=sensSetup, tsAlarmSensName=tsAlarmSensName, setup=setup, sensUnitString=sensUnitString, sensFlags=sensFlags, sensLimitMax=sensLimitMax, sensAlarmStateChanged=sensAlarmStateChanged, sensString=sensString, SensorName=SensorName, infoAddressMAC=infoAddressMAC, inpEntry=inpEntry, outEntry=outEntry, tsAlarmEntry=tsAlarmEntry, InputAlarmState=InputAlarmState, TimeStamp=TimeStamp, hwgroup=hwgroup, inpValue=inpValue, tsAlarmId=tsAlarmId, SensorString=SensorString, inpName=inpName, OnOff=OnOff, inpAlarmState=inpAlarmState, outIndex=outIndex, outValue=outValue, sensValue=sensValue, tsAlarmTable=tsAlarmTable, sensLimitMin=sensLimitMin, sensHysteresis=sensHysteresis, sensValueRaw=sensValueRaw, sensSetupEntry=sensSetupEntry, charonII=charonII, inpTable=inpTable, poseidon=poseidon, InputAlarmSetup=InputAlarmSetup, info=info, sensUnit=sensUnit, SensorFlags=SensorFlags, SensorState=SensorState, tsAlarm=tsAlarm, sensName=sensName, outTable=outTable, UnitType=UnitType, outName=outName, SensorID=SensorID, SensorValue=SensorValue, sensEntry=sensEntry, unitType=unitType, tsAlarmDescr=tsAlarmDescr, inpAlarmSetup=inpAlarmSetup, sensSetupIndex=sensSetupIndex, outType=outType, sensState=sensState, tsTrapAlarmStart=tsTrapAlarmStart, OutputType=OutputType, sensSetupName=sensSetupName, tsTrapAlarmEnd=tsTrapAlarmEnd, inpIndex=inpIndex, tsAlarmsPresent=tsAlarmsPresent, tsAlarmIdx=tsAlarmIdx, IOName=IOName, SensorUnitString=SensorUnitString)
