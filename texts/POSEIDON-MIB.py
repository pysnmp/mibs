...
Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, Counter64, Integer32, IpAddress, enterprises, MibIdentifier, ObjectIdentity, Unsigned32, ModuleIdentity, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "Counter64", "Integer32", "IpAddress", "enterprises", "MibIdentifier", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("POSEIDON-MIB", outType=outType, SensorState=SensorState, PositiveInteger=PositiveInteger, SensorName=SensorName, sensSetupIndex=sensSetupIndex, outName=outName, sensEntry=sensEntry, outTable=outTable, inpEntry=inpEntry, sensIndex=sensIndex, sensLimitMax=sensLimitMax, inpAlarmStateChanged=inpAlarmStateChanged, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorUnitString=SensorUnitString, sensValue=sensValue, tsAlarmTable=tsAlarmTable, unitType=unitType, sensUnitString=sensUnitString, SensorValue=SensorValue, sensSetupTable=sensSetupTable, sensFlags=sensFlags, charonII=charonII, poseidon=poseidon, sensUnit=sensUnit, sensHysteresis=sensHysteresis, tsAlarmSensName=tsAlarmSensName, TimeStamp=TimeStamp, OutputType=OutputType, hwgroup=hwgroup, infoAddressMAC=infoAddressMAC, tsAlarmDescr=tsAlarmDescr, tsTrapAlarmStart=tsTrapAlarmStart, setup=setup, inpAlarmSetup=inpAlarmSetup, tsAlarmId=tsAlarmId, SensorID=SensorID, inpAlarmState=inpAlarmState, sensAlarmStateChanged=sensAlarmStateChanged, inpValue=inpValue, OutputMode=OutputMode, tsAlarmsPresent=tsAlarmsPresent, SensorString=SensorString, outValue=outValue, sensID=sensID, sensLimitMin=sensLimitMin, SensorFlags=SensorFlags, sensName=sensName, sensTable=sensTable, InputAlarmState=InputAlarmState, sensString=sensString, inpTable=inpTable, IOName=IOName, tsAlarmIdx=tsAlarmIdx, inpIndex=inpIndex, tsAlarmTime=tsAlarmTime, inpName=inpName, sensSetupName=sensSetupName, info=info, outMode=outMode, outIndex=outIndex, OnOff=OnOff, sensValueRaw=sensValueRaw, sensSetup=sensSetup, sensState=sensState, UnitType=UnitType, tsAlarmEntry=tsAlarmEntry, sensSetupEntry=sensSetupEntry, outEntry=outEntry, InputAlarmSetup=InputAlarmSetup, tsAlarm=tsAlarm)
