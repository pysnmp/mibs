...
mibBuilder.exportSymbols("POSEIDON-MIB", sensUnitString=sensUnitString, unitType=unitType, tsTrapAlarmStart=tsTrapAlarmStart, sensSetupEntry=sensSetupEntry, sensState=sensState, sensLimitMax=sensLimitMax, sensSetupIndex=sensSetupIndex, SensorID=SensorID, tsAlarmIdx=tsAlarmIdx, inpAlarmSetup=inpAlarmSetup, InputAlarmState=InputAlarmState, sensFlags=sensFlags, tsAlarmTable=tsAlarmTable, IOName=IOName, inpAlarmState=inpAlarmState, SensorUnitString=SensorUnitString, outIndex=outIndex, sensString=sensString, tsTrapAlarmEnd=tsTrapAlarmEnd, sensIndex=sensIndex, SensorName=SensorName, poseidon=poseidon, TimeStamp=TimeStamp, tsAlarmSensName=tsAlarmSensName, sensValueRaw=sensValueRaw, outEntry=outEntry, inpTable=inpTable, tsAlarm=tsAlarm, sensSetupName=sensSetupName, info=info, charonII=charonII, outName=outName, sensSetupTable=sensSetupTable, outType=outType, sensSetup=sensSetup, inpIndex=inpIndex, setup=setup, sensHysteresis=sensHysteresis, outTable=outTable, tsAlarmsPresent=tsAlarmsPresent, OutputType=OutputType, SensorString=SensorString, sensAlarmStateChanged=sensAlarmStateChanged, UnitType=UnitType, tsAlarmTime=tsAlarmTime, SensorValue=SensorValue, InputAlarmSetup=InputAlarmSetup, sensTable=sensTable, inpValue=inpValue, sensLimitMin=sensLimitMin, sensID=sensID, hwgroup=hwgroup, inpEntry=inpEntry, outValue=outValue, sensValue=sensValue, SensorFlags=SensorFlags, sensName=sensName, tsAlarmId=tsAlarmId, SensorState=SensorState, tsAlarmDescr=tsAlarmDescr, infoAddressMAC=infoAddressMAC, OutputMode=OutputMode, sensUnit=sensUnit, inpName=inpName, tsAlarmEntry=tsAlarmEntry, sensEntry=sensEntry, OnOff=OnOff, inpAlarmStateChanged=inpAlarmStateChanged, outMode=outMode, PositiveInteger=PositiveInteger)
