...
Counter32, Integer32, Counter64, enterprises, NotificationType, Unsigned32, iso, MibIdentifier, ObjectIdentity, Bits, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "Counter64", "enterprises", "NotificationType", "Unsigned32", "iso", "MibIdentifier", "ObjectIdentity", "Bits", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensState=sensState, info=info, sensLimitMax=sensLimitMax, tsAlarmId=tsAlarmId, sensName=sensName, PositiveInteger=PositiveInteger, SensorString=SensorString, sensSetupEntry=sensSetupEntry, tsAlarmTable=tsAlarmTable, hwgroup=hwgroup, sensString=sensString, TimeStamp=TimeStamp, SensorFlags=SensorFlags, SensorState=SensorState, tsTrapAlarmEnd=tsTrapAlarmEnd, sensFlags=sensFlags, tsAlarmTime=tsAlarmTime, sensAlarmStateChanged=sensAlarmStateChanged, inpValue=inpValue, inpAlarmState=inpAlarmState, SensorValue=SensorValue, setup=setup, charonII=charonII, OnOff=OnOff, outMode=outMode, sensTable=sensTable, inpAlarmStateChanged=inpAlarmStateChanged, sensUnitString=sensUnitString, sensSetupTable=sensSetupTable, sensLimitMin=sensLimitMin, OutputType=OutputType, sensID=sensID, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarm=tsAlarm, SensorName=SensorName, outEntry=outEntry, tsAlarmSensName=tsAlarmSensName, SensorUnitString=SensorUnitString, outName=outName, outType=outType, tsAlarmEntry=tsAlarmEntry, sensSetup=sensSetup, SensorID=SensorID, inpAlarmSetup=inpAlarmSetup, outTable=outTable, outValue=outValue, tsAlarmDescr=tsAlarmDescr, UnitType=UnitType, InputAlarmSetup=InputAlarmSetup, inpTable=inpTable, sensEntry=sensEntry, tsAlarmsPresent=tsAlarmsPresent, sensSetupIndex=sensSetupIndex, inpEntry=inpEntry, sensHysteresis=sensHysteresis, inpIndex=inpIndex, InputAlarmState=InputAlarmState, poseidon=poseidon, inpName=inpName, sensValue=sensValue, sensValueRaw=sensValueRaw, sensUnit=sensUnit, IOName=IOName, tsAlarmIdx=tsAlarmIdx, unitType=unitType, sensIndex=sensIndex, outIndex=outIndex, infoAddressMAC=infoAddressMAC, sensSetupName=sensSetupName, OutputMode=OutputMode)
