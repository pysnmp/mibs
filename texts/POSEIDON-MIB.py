...
Counter32, Gauge32, TimeTicks, Counter64, ModuleIdentity, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, Integer32, enterprises, NotificationType, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "TimeTicks", "Counter64", "ModuleIdentity", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "Integer32", "enterprises", "NotificationType", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", poseidon=poseidon, SensorID=SensorID, sensTable=sensTable, tsAlarmEntry=tsAlarmEntry, InputAlarmSetup=InputAlarmSetup, outType=outType, sensEntry=sensEntry, hwgroup=hwgroup, sensIndex=sensIndex, sensSetup=sensSetup, sensSetupTable=sensSetupTable, sensLimitMin=sensLimitMin, sensUnitString=sensUnitString, sensString=sensString, PositiveInteger=PositiveInteger, charonII=charonII, tsTrapAlarmStart=tsTrapAlarmStart, sensValueRaw=sensValueRaw, sensSetupIndex=sensSetupIndex, sensHysteresis=sensHysteresis, outEntry=outEntry, tsAlarmSensName=tsAlarmSensName, infoAddressMAC=infoAddressMAC, TimeStamp=TimeStamp, tsAlarmsPresent=tsAlarmsPresent, IOName=IOName, sensID=sensID, tsAlarmTime=tsAlarmTime, InputAlarmState=InputAlarmState, UnitType=UnitType, sensValue=sensValue, SensorName=SensorName, SensorFlags=SensorFlags, outName=outName, sensState=sensState, tsAlarmTable=tsAlarmTable, setup=setup, inpEntry=inpEntry, inpValue=inpValue, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorValue=SensorValue, inpName=inpName, tsAlarm=tsAlarm, inpIndex=inpIndex, sensSetupEntry=sensSetupEntry, outIndex=outIndex, inpAlarmSetup=inpAlarmSetup, sensName=sensName, OnOff=OnOff, sensSetupName=sensSetupName, sensLimitMax=sensLimitMax, info=info, inpTable=inpTable, outTable=outTable, tsAlarmId=tsAlarmId, sensFlags=sensFlags, outValue=outValue, inpAlarmStateChanged=inpAlarmStateChanged, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmIdx=tsAlarmIdx, SensorUnitString=SensorUnitString, unitType=unitType, SensorString=SensorString, sensUnit=sensUnit, outMode=outMode, OutputType=OutputType, OutputMode=OutputMode, tsAlarmDescr=tsAlarmDescr, inpAlarmState=inpAlarmState, SensorState=SensorState)
