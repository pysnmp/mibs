...
mibBuilder.exportSymbols("POSEIDON-MIB", inpTable=inpTable, sensID=sensID, outTable=outTable, sensSetup=sensSetup, sensSetupName=sensSetupName, InputAlarmSetup=InputAlarmSetup, SensorID=SensorID, outValue=outValue, tsAlarmTime=tsAlarmTime, sensString=sensString, outIndex=outIndex, outMode=outMode, sensUnit=sensUnit, tsAlarmIdx=tsAlarmIdx, tsTrapAlarmEnd=tsTrapAlarmEnd, charonII=charonII, SensorName=SensorName, SensorValue=SensorValue, tsAlarm=tsAlarm, sensTable=sensTable, tsAlarmDescr=tsAlarmDescr, sensState=sensState, sensLimitMin=sensLimitMin, PositiveInteger=PositiveInteger, tsTrapAlarmStart=tsTrapAlarmStart, hwgroup=hwgroup, tsAlarmId=tsAlarmId, poseidon=poseidon, sensEntry=sensEntry, unitType=unitType, sensHysteresis=sensHysteresis, inpValue=inpValue, sensValueRaw=sensValueRaw, tsAlarmSensName=tsAlarmSensName, inpAlarmState=inpAlarmState, inpAlarmStateChanged=inpAlarmStateChanged, sensAlarmStateChanged=sensAlarmStateChanged, sensSetupEntry=sensSetupEntry, inpEntry=inpEntry, inpAlarmSetup=inpAlarmSetup, SensorState=SensorState, SensorUnitString=SensorUnitString, outEntry=outEntry, outName=outName, tsAlarmsPresent=tsAlarmsPresent, sensName=sensName, IOName=IOName, setup=setup, sensUnitString=sensUnitString, tsAlarmEntry=tsAlarmEntry, inpName=inpName, sensLimitMax=sensLimitMax, OnOff=OnOff, SensorString=SensorString, InputAlarmState=InputAlarmState, info=info, sensValue=sensValue, sensSetupTable=sensSetupTable, OutputMode=OutputMode, inpIndex=inpIndex, outType=outType, sensIndex=sensIndex, OutputType=OutputType, infoAddressMAC=infoAddressMAC, tsAlarmTable=tsAlarmTable, sensSetupIndex=sensSetupIndex, UnitType=UnitType, TimeStamp=TimeStamp, SensorFlags=SensorFlags, sensFlags=sensFlags)
