...
Gauge32, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, Counter32, enterprises, NotificationType, ModuleIdentity, ObjectIdentity, TimeTicks, Unsigned32, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "Counter32", "enterprises", "NotificationType", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "Unsigned32", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorState=SensorState, unitType=unitType, SensorValue=SensorValue, sensValueRaw=sensValueRaw, sensState=sensState, tsTrapAlarmStart=tsTrapAlarmStart, infoAddressMAC=infoAddressMAC, sensIndex=sensIndex, inpAlarmStateChanged=inpAlarmStateChanged, sensSetupEntry=sensSetupEntry, inpAlarmSetup=inpAlarmSetup, inpValue=inpValue, sensSetup=sensSetup, inpAlarmState=inpAlarmState, OutputType=OutputType, sensSetupName=sensSetupName, sensID=sensID, SensorUnitString=SensorUnitString, tsAlarmTime=tsAlarmTime, PositiveInteger=PositiveInteger, sensLimitMax=sensLimitMax, outValue=outValue, sensSetupIndex=sensSetupIndex, sensLimitMin=sensLimitMin, sensTable=sensTable, tsAlarmEntry=tsAlarmEntry, sensFlags=sensFlags, inpEntry=inpEntry, sensName=sensName, inpIndex=inpIndex, tsAlarmIdx=tsAlarmIdx, SensorFlags=SensorFlags, inpName=inpName, outIndex=outIndex, OutputMode=OutputMode, outMode=outMode, InputAlarmSetup=InputAlarmSetup, sensValue=sensValue, SensorID=SensorID, setup=setup, outType=outType, SensorString=SensorString, sensUnit=sensUnit, outEntry=outEntry, sensUnitString=sensUnitString, InputAlarmState=InputAlarmState, sensString=sensString, inpTable=inpTable, outName=outName, tsAlarmSensName=tsAlarmSensName, poseidon=poseidon, outTable=outTable, tsAlarm=tsAlarm, sensAlarmStateChanged=sensAlarmStateChanged, info=info, tsTrapAlarmEnd=tsTrapAlarmEnd, charonII=charonII, tsAlarmsPresent=tsAlarmsPresent, tsAlarmId=tsAlarmId, IOName=IOName, UnitType=UnitType, TimeStamp=TimeStamp, hwgroup=hwgroup, tsAlarmTable=tsAlarmTable, sensHysteresis=sensHysteresis, sensEntry=sensEntry, tsAlarmDescr=tsAlarmDescr, SensorName=SensorName, OnOff=OnOff, sensSetupTable=sensSetupTable)
