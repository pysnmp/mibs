...
Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, Gauge32, TimeTicks, Unsigned32, MibIdentifier, enterprises, Counter32, Counter64, Bits, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "Gauge32", "TimeTicks", "Unsigned32", "MibIdentifier", "enterprises", "Counter32", "Counter64", "Bits", "NotificationType", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", unitType=unitType, OutputMode=OutputMode, SensorValue=SensorValue, InputAlarmSetup=InputAlarmSetup, inpValue=inpValue, sensTable=sensTable, sensSetupIndex=sensSetupIndex, PositiveInteger=PositiveInteger, sensSetupEntry=sensSetupEntry, outType=outType, outTable=outTable, SensorID=SensorID, tsAlarm=tsAlarm, sensSetup=sensSetup, sensID=sensID, info=info, tsAlarmTable=tsAlarmTable, OnOff=OnOff, SensorName=SensorName, SensorState=SensorState, tsAlarmDescr=tsAlarmDescr, hwgroup=hwgroup, InputAlarmState=InputAlarmState, sensLimitMin=sensLimitMin, SensorFlags=SensorFlags, TimeStamp=TimeStamp, sensUnit=sensUnit, tsAlarmEntry=tsAlarmEntry, tsAlarmIdx=tsAlarmIdx, sensFlags=sensFlags, setup=setup, poseidon=poseidon, UnitType=UnitType, outIndex=outIndex, sensLimitMax=sensLimitMax, SensorString=SensorString, sensString=sensString, infoAddressMAC=infoAddressMAC, tsAlarmsPresent=tsAlarmsPresent, sensUnitString=sensUnitString, sensValueRaw=sensValueRaw, sensAlarmStateChanged=sensAlarmStateChanged, OutputType=OutputType, sensName=sensName, inpTable=inpTable, sensValue=sensValue, outName=outName, outMode=outMode, sensIndex=sensIndex, tsTrapAlarmStart=tsTrapAlarmStart, sensSetupTable=sensSetupTable, outEntry=outEntry, tsAlarmSensName=tsAlarmSensName, charonII=charonII, IOName=IOName, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorUnitString=SensorUnitString, inpEntry=inpEntry, inpAlarmSetup=inpAlarmSetup, sensSetupName=sensSetupName, sensState=sensState, tsAlarmTime=tsAlarmTime, sensHysteresis=sensHysteresis, tsAlarmId=tsAlarmId, inpIndex=inpIndex, inpName=inpName, inpAlarmStateChanged=inpAlarmStateChanged, outValue=outValue, inpAlarmState=inpAlarmState, sensEntry=sensEntry)
