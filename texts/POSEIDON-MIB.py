...
ObjectIdentity, Gauge32, NotificationType, Integer32, Unsigned32, Counter64, IpAddress, MibIdentifier, ModuleIdentity, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "NotificationType", "Integer32", "Unsigned32", "Counter64", "IpAddress", "MibIdentifier", "ModuleIdentity", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmDescr=tsAlarmDescr, sensSetupTable=sensSetupTable, sensHysteresis=sensHysteresis, SensorName=SensorName, sensIndex=sensIndex, sensSetupIndex=sensSetupIndex, PositiveInteger=PositiveInteger, outMode=outMode, inpEntry=inpEntry, inpTable=inpTable, SensorValue=SensorValue, sensUnit=sensUnit, tsAlarm=tsAlarm, sensLimitMax=sensLimitMax, tsTrapAlarmEnd=tsTrapAlarmEnd, IOName=IOName, inpName=inpName, SensorID=SensorID, outEntry=outEntry, sensState=sensState, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmEntry=tsAlarmEntry, tsAlarmId=tsAlarmId, tsTrapAlarmStart=tsTrapAlarmStart, inpIndex=inpIndex, outTable=outTable, inpAlarmSetup=inpAlarmSetup, outName=outName, SensorString=SensorString, sensUnitString=sensUnitString, hwgroup=hwgroup, OutputMode=OutputMode, InputAlarmSetup=InputAlarmSetup, tsAlarmTable=tsAlarmTable, infoAddressMAC=infoAddressMAC, unitType=unitType, sensAlarmStateChanged=sensAlarmStateChanged, UnitType=UnitType, sensEntry=sensEntry, inpAlarmState=inpAlarmState, sensName=sensName, TimeStamp=TimeStamp, tsAlarmSensName=tsAlarmSensName, sensString=sensString, sensSetupEntry=sensSetupEntry, tsAlarmIdx=tsAlarmIdx, sensLimitMin=sensLimitMin, SensorState=SensorState, setup=setup, SensorUnitString=SensorUnitString, tsAlarmsPresent=tsAlarmsPresent, OnOff=OnOff, outIndex=outIndex, SensorFlags=SensorFlags, poseidon=poseidon, InputAlarmState=InputAlarmState, OutputType=OutputType, sensValueRaw=sensValueRaw, charonII=charonII, outType=outType, sensSetupName=sensSetupName, outValue=outValue, sensID=sensID, tsAlarmTime=tsAlarmTime, info=info, sensTable=sensTable, sensFlags=sensFlags, inpValue=inpValue, sensValue=sensValue, sensSetup=sensSetup)
