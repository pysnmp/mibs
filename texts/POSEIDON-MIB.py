...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, NotificationType, iso, Integer32, Bits, Counter32, Unsigned32, enterprises, IpAddress, Counter64, MibIdentifier, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "NotificationType", "iso", "Integer32", "Bits", "Counter32", "Unsigned32", "enterprises", "IpAddress", "Counter64", "MibIdentifier", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensFlags=sensFlags, SensorString=SensorString, unitType=unitType, OutputMode=OutputMode, IOName=IOName, sensTable=sensTable, sensSetup=sensSetup, inpValue=inpValue, tsTrapAlarmEnd=tsTrapAlarmEnd, sensIndex=sensIndex, SensorValue=SensorValue, info=info, InputAlarmState=InputAlarmState, outValue=outValue, tsAlarmEntry=tsAlarmEntry, inpAlarmStateChanged=inpAlarmStateChanged, PositiveInteger=PositiveInteger, tsAlarmTable=tsAlarmTable, SensorState=SensorState, tsAlarmSensName=tsAlarmSensName, sensSetupTable=sensSetupTable, sensString=sensString, inpTable=inpTable, sensEntry=sensEntry, tsAlarmId=tsAlarmId, inpIndex=inpIndex, SensorName=SensorName, sensUnitString=sensUnitString, poseidon=poseidon, sensID=sensID, infoAddressMAC=infoAddressMAC, UnitType=UnitType, SensorFlags=SensorFlags, setup=setup, sensSetupEntry=sensSetupEntry, inpAlarmState=inpAlarmState, sensName=sensName, InputAlarmSetup=InputAlarmSetup, charonII=charonII, hwgroup=hwgroup, inpName=inpName, outMode=outMode, tsAlarm=tsAlarm, tsAlarmTime=tsAlarmTime, SensorUnitString=SensorUnitString, sensLimitMax=sensLimitMax, sensHysteresis=sensHysteresis, TimeStamp=TimeStamp, outTable=outTable, sensSetupIndex=sensSetupIndex, inpAlarmSetup=inpAlarmSetup, outIndex=outIndex, inpEntry=inpEntry, tsAlarmsPresent=tsAlarmsPresent, tsAlarmDescr=tsAlarmDescr, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, outEntry=outEntry, outName=outName, sensUnit=sensUnit, sensSetupName=sensSetupName, OnOff=OnOff, SensorID=SensorID, sensValue=sensValue, OutputType=OutputType, sensValueRaw=sensValueRaw, sensLimitMin=sensLimitMin, tsAlarmIdx=tsAlarmIdx, outType=outType, sensState=sensState)
