...
mibBuilder.exportSymbols("POSEIDON-MIB", outType=outType, hwgroup=hwgroup, sensUnitString=sensUnitString, sensSetupIndex=sensSetupIndex, sensFlags=sensFlags, sensEntry=sensEntry, SensorState=SensorState, tsAlarmEntry=tsAlarmEntry, tsAlarmId=tsAlarmId, sensString=sensString, outMode=outMode, SensorID=SensorID, outEntry=outEntry, inpName=inpName, poseidon=poseidon, sensHysteresis=sensHysteresis, tsAlarmSensName=tsAlarmSensName, sensValue=sensValue, tsAlarmTable=tsAlarmTable, SensorValue=SensorValue, SensorUnitString=SensorUnitString, info=info, setup=setup, PositiveInteger=PositiveInteger, inpAlarmStateChanged=inpAlarmStateChanged, charonII=charonII, tsTrapAlarmEnd=tsTrapAlarmEnd, sensAlarmStateChanged=sensAlarmStateChanged, OutputType=OutputType, SensorString=SensorString, sensUnit=sensUnit, tsAlarmTime=tsAlarmTime, SensorName=SensorName, infoAddressMAC=infoAddressMAC, inpIndex=inpIndex, sensLimitMin=sensLimitMin, sensSetup=sensSetup, sensTable=sensTable, inpAlarmState=inpAlarmState, outValue=outValue, sensIndex=sensIndex, tsAlarm=tsAlarm, outName=outName, InputAlarmSetup=InputAlarmSetup, outTable=outTable, sensSetupTable=sensSetupTable, TimeStamp=TimeStamp, IOName=IOName, inpAlarmSetup=inpAlarmSetup, tsAlarmsPresent=tsAlarmsPresent, sensLimitMax=sensLimitMax, tsTrapAlarmStart=tsTrapAlarmStart, inpTable=inpTable, tsAlarmDescr=tsAlarmDescr, sensName=sensName, SensorFlags=SensorFlags, UnitType=UnitType, tsAlarmIdx=tsAlarmIdx, sensSetupName=sensSetupName, unitType=unitType, inpValue=inpValue, outIndex=outIndex, inpEntry=inpEntry, OnOff=OnOff, OutputMode=OutputMode, sensState=sensState, InputAlarmState=InputAlarmState, sensSetupEntry=sensSetupEntry, sensID=sensID, sensValueRaw=sensValueRaw)
