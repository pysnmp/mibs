...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, iso, ModuleIdentity, Gauge32, Counter64, Unsigned32, Bits, ObjectIdentity, MibIdentifier, Counter32, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "iso", "ModuleIdentity", "Gauge32", "Counter64", "Unsigned32", "Bits", "ObjectIdentity", "MibIdentifier", "Counter32", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpEntry=inpEntry, sensTable=sensTable, sensSetupTable=sensSetupTable, sensLimitMax=sensLimitMax, InputAlarmSetup=InputAlarmSetup, OutputType=OutputType, PositiveInteger=PositiveInteger, inpAlarmState=inpAlarmState, outIndex=outIndex, outName=outName, IOName=IOName, inpAlarmSetup=inpAlarmSetup, sensSetupIndex=sensSetupIndex, inpTable=inpTable, sensAlarmStateChanged=sensAlarmStateChanged, poseidon=poseidon, sensUnitString=sensUnitString, tsAlarmEntry=tsAlarmEntry, SensorState=SensorState, unitType=unitType, SensorString=SensorString, setup=setup, sensID=sensID, info=info, outEntry=outEntry, outType=outType, tsAlarmId=tsAlarmId, tsAlarmIdx=tsAlarmIdx, infoAddressMAC=infoAddressMAC, SensorValue=SensorValue, charonII=charonII, sensSetupName=sensSetupName, outValue=outValue, sensLimitMin=sensLimitMin, sensSetupEntry=sensSetupEntry, SensorName=SensorName, UnitType=UnitType, OutputMode=OutputMode, inpValue=inpValue, outMode=outMode, sensName=sensName, sensSetup=sensSetup, sensIndex=sensIndex, tsAlarmSensName=tsAlarmSensName, tsTrapAlarmEnd=tsTrapAlarmEnd, sensValueRaw=sensValueRaw, sensHysteresis=sensHysteresis, tsTrapAlarmStart=tsTrapAlarmStart, InputAlarmState=InputAlarmState, SensorID=SensorID, sensState=sensState, hwgroup=hwgroup, SensorFlags=SensorFlags, sensString=sensString, sensUnit=sensUnit, OnOff=OnOff, inpAlarmStateChanged=inpAlarmStateChanged, inpName=inpName, TimeStamp=TimeStamp, outTable=outTable, tsAlarm=tsAlarm, sensEntry=sensEntry, sensFlags=sensFlags, tsAlarmDescr=tsAlarmDescr, tsAlarmsPresent=tsAlarmsPresent, SensorUnitString=SensorUnitString, tsAlarmTable=tsAlarmTable, inpIndex=inpIndex, sensValue=sensValue, tsAlarmTime=tsAlarmTime)
