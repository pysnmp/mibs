...
iso, MibIdentifier, Bits, Counter32, ModuleIdentity, NotificationType, ObjectIdentity, IpAddress, enterprises, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "Bits", "Counter32", "ModuleIdentity", "NotificationType", "ObjectIdentity", "IpAddress", "enterprises", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmDescr=tsAlarmDescr, sensSetupName=sensSetupName, sensFlags=sensFlags, tsAlarmEntry=tsAlarmEntry, outName=outName, outType=outType, InputAlarmSetup=InputAlarmSetup, sensIndex=sensIndex, tsTrapAlarmStart=tsTrapAlarmStart, sensUnitString=sensUnitString, sensString=sensString, tsAlarmSensName=tsAlarmSensName, infoAddressMAC=infoAddressMAC, tsAlarmId=tsAlarmId, unitType=unitType, SensorUnitString=SensorUnitString, sensLimitMax=sensLimitMax, inpName=inpName, OutputMode=OutputMode, tsAlarmIdx=tsAlarmIdx, OnOff=OnOff, outValue=outValue, outTable=outTable, sensUnit=sensUnit, TimeStamp=TimeStamp, InputAlarmState=InputAlarmState, SensorName=SensorName, outMode=outMode, info=info, inpIndex=inpIndex, inpTable=inpTable, sensValueRaw=sensValueRaw, outEntry=outEntry, tsAlarmTable=tsAlarmTable, SensorID=SensorID, sensSetupEntry=sensSetupEntry, sensLimitMin=sensLimitMin, OutputType=OutputType, SensorFlags=SensorFlags, inpAlarmState=inpAlarmState, sensSetup=sensSetup, tsAlarmTime=tsAlarmTime, inpEntry=inpEntry, inpAlarmStateChanged=inpAlarmStateChanged, sensID=sensID, sensSetupIndex=sensSetupIndex, tsAlarm=tsAlarm, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorState=SensorState, SensorString=SensorString, outIndex=outIndex, sensEntry=sensEntry, PositiveInteger=PositiveInteger, hwgroup=hwgroup, inpValue=inpValue, sensTable=sensTable, sensName=sensName, sensSetupTable=sensSetupTable, sensHysteresis=sensHysteresis, setup=setup, UnitType=UnitType, charonII=charonII, inpAlarmSetup=inpAlarmSetup, sensValue=sensValue, IOName=IOName, tsAlarmsPresent=tsAlarmsPresent, poseidon=poseidon, sensAlarmStateChanged=sensAlarmStateChanged, SensorValue=SensorValue, sensState=sensState)
