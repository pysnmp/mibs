...
NotificationType, ModuleIdentity, Bits, MibIdentifier, Unsigned32, Gauge32, Integer32, IpAddress, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Bits", "MibIdentifier", "Unsigned32", "Gauge32", "Integer32", "IpAddress", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensTable=sensTable, tsAlarmTime=tsAlarmTime, PositiveInteger=PositiveInteger, TimeStamp=TimeStamp, inpTable=inpTable, SensorString=SensorString, UnitType=UnitType, outIndex=outIndex, inpValue=inpValue, SensorValue=SensorValue, tsAlarmId=tsAlarmId, inpEntry=inpEntry, sensEntry=sensEntry, SensorID=SensorID, sensSetup=sensSetup, sensLimitMax=sensLimitMax, OutputType=OutputType, InputAlarmSetup=InputAlarmSetup, sensState=sensState, sensUnit=sensUnit, infoAddressMAC=infoAddressMAC, sensAlarmStateChanged=sensAlarmStateChanged, inpAlarmSetup=inpAlarmSetup, setup=setup, poseidon=poseidon, sensHysteresis=sensHysteresis, sensString=sensString, hwgroup=hwgroup, outMode=outMode, tsAlarmEntry=tsAlarmEntry, IOName=IOName, outEntry=outEntry, sensSetupIndex=sensSetupIndex, inpAlarmStateChanged=inpAlarmStateChanged, outName=outName, SensorUnitString=SensorUnitString, sensIndex=sensIndex, outTable=outTable, sensValueRaw=sensValueRaw, InputAlarmState=InputAlarmState, SensorFlags=SensorFlags, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmDescr=tsAlarmDescr, outType=outType, sensID=sensID, tsAlarmsPresent=tsAlarmsPresent, tsAlarmIdx=tsAlarmIdx, inpName=inpName, sensSetupEntry=sensSetupEntry, SensorName=SensorName, sensValue=sensValue, sensFlags=sensFlags, sensUnitString=sensUnitString, tsAlarm=tsAlarm, sensSetupTable=sensSetupTable, OnOff=OnOff, outValue=outValue, OutputMode=OutputMode, tsTrapAlarmStart=tsTrapAlarmStart, charonII=charonII, info=info, sensName=sensName, tsAlarmSensName=tsAlarmSensName, sensSetupName=sensSetupName, sensLimitMin=sensLimitMin, inpAlarmState=inpAlarmState, tsAlarmTable=tsAlarmTable, SensorState=SensorState, unitType=unitType, inpIndex=inpIndex)
