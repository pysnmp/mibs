...
MibIdentifier, Counter64, Unsigned32, enterprises, Gauge32, Bits, Integer32, Counter32, ObjectIdentity, iso, IpAddress, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "Unsigned32", "enterprises", "Gauge32", "Bits", "Integer32", "Counter32", "ObjectIdentity", "iso", "IpAddress", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("POSEIDON-MIB", UnitType=UnitType, SensorUnitString=SensorUnitString, sensEntry=sensEntry, sensName=sensName, tsAlarmIdx=tsAlarmIdx, tsAlarmSensName=tsAlarmSensName, SensorState=SensorState, sensIndex=sensIndex, SensorValue=SensorValue, SensorString=SensorString, OutputType=OutputType, inpTable=inpTable, tsAlarmId=tsAlarmId, SensorName=SensorName, outType=outType, hwgroup=hwgroup, SensorID=SensorID, OnOff=OnOff, outEntry=outEntry, sensTable=sensTable, sensSetupEntry=sensSetupEntry, outTable=outTable, sensHysteresis=sensHysteresis, outMode=outMode, sensLimitMin=sensLimitMin, charonII=charonII, sensSetupTable=sensSetupTable, inpAlarmState=inpAlarmState, tsTrapAlarmStart=tsTrapAlarmStart, sensAlarmStateChanged=sensAlarmStateChanged, setup=setup, tsAlarmDescr=tsAlarmDescr, InputAlarmSetup=InputAlarmSetup, inpAlarmSetup=inpAlarmSetup, inpName=inpName, sensLimitMax=sensLimitMax, inpEntry=inpEntry, sensValueRaw=sensValueRaw, inpValue=inpValue, InputAlarmState=InputAlarmState, inpIndex=inpIndex, sensSetup=sensSetup, TimeStamp=TimeStamp, sensState=sensState, sensID=sensID, tsAlarm=tsAlarm, PositiveInteger=PositiveInteger, IOName=IOName, sensString=sensString, sensUnit=sensUnit, sensValue=sensValue, OutputMode=OutputMode, sensUnitString=sensUnitString, tsAlarmTable=tsAlarmTable, infoAddressMAC=infoAddressMAC, sensSetupName=sensSetupName, poseidon=poseidon, outName=outName, info=info, inpAlarmStateChanged=inpAlarmStateChanged, sensSetupIndex=sensSetupIndex, tsAlarmEntry=tsAlarmEntry, SensorFlags=SensorFlags, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmsPresent=tsAlarmsPresent, unitType=unitType, tsAlarmTime=tsAlarmTime, sensFlags=sensFlags, outIndex=outIndex, outValue=outValue)
