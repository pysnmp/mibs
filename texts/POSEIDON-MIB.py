...
mibBuilder.exportSymbols("POSEIDON-MIB", inpName=inpName, SensorValue=SensorValue, sensEntry=sensEntry, inpAlarmSetup=inpAlarmSetup, sensUnit=sensUnit, sensValue=sensValue, outValue=outValue, sensState=sensState, tsAlarmIdx=tsAlarmIdx, infoAddressMAC=infoAddressMAC, sensName=sensName, hwgroup=hwgroup, unitType=unitType, outEntry=outEntry, OnOff=OnOff, SensorUnitString=SensorUnitString, SensorState=SensorState, InputAlarmState=InputAlarmState, outType=outType, sensSetup=sensSetup, sensHysteresis=sensHysteresis, SensorString=SensorString, TimeStamp=TimeStamp, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmId=tsAlarmId, OutputType=OutputType, sensIndex=sensIndex, SensorName=SensorName, sensLimitMax=sensLimitMax, tsAlarmSensName=tsAlarmSensName, sensSetupEntry=sensSetupEntry, IOName=IOName, poseidon=poseidon, InputAlarmSetup=InputAlarmSetup, sensFlags=sensFlags, SensorID=SensorID, info=info, sensSetupIndex=sensSetupIndex, tsTrapAlarmEnd=tsTrapAlarmEnd, sensTable=sensTable, outTable=outTable, sensSetupTable=sensSetupTable, outIndex=outIndex, outName=outName, tsAlarm=tsAlarm, tsAlarmTime=tsAlarmTime, OutputMode=OutputMode, tsAlarmsPresent=tsAlarmsPresent, inpAlarmStateChanged=inpAlarmStateChanged, sensAlarmStateChanged=sensAlarmStateChanged, outMode=outMode, sensString=sensString, sensUnitString=sensUnitString, sensLimitMin=sensLimitMin, tsAlarmEntry=tsAlarmEntry, inpValue=inpValue, inpIndex=inpIndex, tsAlarmTable=tsAlarmTable, setup=setup, inpEntry=inpEntry, charonII=charonII, sensID=sensID, sensSetupName=sensSetupName, PositiveInteger=PositiveInteger, SensorFlags=SensorFlags, sensValueRaw=sensValueRaw, UnitType=UnitType, tsAlarmDescr=tsAlarmDescr, inpAlarmState=inpAlarmState, inpTable=inpTable)
