...
mibBuilder.exportSymbols("POSEIDON-MIB", OutputType=OutputType, tsAlarm=tsAlarm, SensorFlags=SensorFlags, sensAlarmStateChanged=sensAlarmStateChanged, unitType=unitType, inpName=inpName, outIndex=outIndex, sensFlags=sensFlags, tsAlarmSensName=tsAlarmSensName, InputAlarmState=InputAlarmState, sensID=sensID, OutputMode=OutputMode, outMode=outMode, sensUnitString=sensUnitString, sensSetup=sensSetup, sensLimitMin=sensLimitMin, outValue=outValue, SensorUnitString=SensorUnitString, outEntry=outEntry, sensEntry=sensEntry, sensName=sensName, tsAlarmEntry=tsAlarmEntry, sensLimitMax=sensLimitMax, inpValue=inpValue, sensString=sensString, inpIndex=inpIndex, OnOff=OnOff, sensValueRaw=sensValueRaw, sensSetupTable=sensSetupTable, tsAlarmIdx=tsAlarmIdx, setup=setup, tsTrapAlarmStart=tsTrapAlarmStart, hwgroup=hwgroup, tsTrapAlarmEnd=tsTrapAlarmEnd, sensState=sensState, sensHysteresis=sensHysteresis, UnitType=UnitType, charonII=charonII, sensIndex=sensIndex, sensTable=sensTable, SensorID=SensorID, PositiveInteger=PositiveInteger, inpAlarmSetup=inpAlarmSetup, tsAlarmTime=tsAlarmTime, sensSetupName=sensSetupName, inpTable=inpTable, InputAlarmSetup=InputAlarmSetup, sensSetupIndex=sensSetupIndex, IOName=IOName, SensorName=SensorName, info=info, SensorState=SensorState, sensValue=sensValue, SensorString=SensorString, poseidon=poseidon, TimeStamp=TimeStamp, SensorValue=SensorValue, outName=outName, tsAlarmTable=tsAlarmTable, tsAlarmDescr=tsAlarmDescr, sensSetupEntry=sensSetupEntry, tsAlarmId=tsAlarmId, outType=outType, sensUnit=sensUnit, tsAlarmsPresent=tsAlarmsPresent, inpEntry=inpEntry, infoAddressMAC=infoAddressMAC, outTable=outTable, inpAlarmState=inpAlarmState, inpAlarmStateChanged=inpAlarmStateChanged)
