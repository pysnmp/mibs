...
enterprises, Bits, ObjectIdentity, MibIdentifier, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, ModuleIdentity, IpAddress, Unsigned32, Counter64, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "ObjectIdentity", "MibIdentifier", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "ModuleIdentity", "IpAddress", "Unsigned32", "Counter64", "iso", "NotificationType")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensName=sensName, tsAlarmSensName=tsAlarmSensName, sensLimitMax=sensLimitMax, sensUnit=sensUnit, outIndex=outIndex, unitType=unitType, sensSetupIndex=sensSetupIndex, tsAlarmId=tsAlarmId, hwgroup=hwgroup, InputAlarmState=InputAlarmState, UnitType=UnitType, inpValue=inpValue, SensorValue=SensorValue, inpAlarmSetup=inpAlarmSetup, tsAlarmIdx=tsAlarmIdx, tsAlarm=tsAlarm, poseidon=poseidon, infoAddressMAC=infoAddressMAC, sensValueRaw=sensValueRaw, tsAlarmTable=tsAlarmTable, outMode=outMode, inpIndex=inpIndex, PositiveInteger=PositiveInteger, inpAlarmState=inpAlarmState, sensSetupTable=sensSetupTable, sensSetup=sensSetup, OutputMode=OutputMode, sensID=sensID, sensEntry=sensEntry, SensorID=SensorID, InputAlarmSetup=InputAlarmSetup, TimeStamp=TimeStamp, sensHysteresis=sensHysteresis, outTable=outTable, outType=outType, SensorFlags=SensorFlags, outValue=outValue, tsTrapAlarmEnd=tsTrapAlarmEnd, OnOff=OnOff, sensString=sensString, tsAlarmTime=tsAlarmTime, inpAlarmStateChanged=inpAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, SensorString=SensorString, sensAlarmStateChanged=sensAlarmStateChanged, IOName=IOName, charonII=charonII, sensIndex=sensIndex, sensState=sensState, tsAlarmsPresent=tsAlarmsPresent, outName=outName, sensUnitString=sensUnitString, sensLimitMin=sensLimitMin, OutputType=OutputType, sensSetupName=sensSetupName, info=info, SensorState=SensorState, inpTable=inpTable, SensorUnitString=SensorUnitString, outEntry=outEntry, tsAlarmEntry=tsAlarmEntry, sensFlags=sensFlags, inpEntry=inpEntry, inpName=inpName, sensValue=sensValue, tsAlarmDescr=tsAlarmDescr, sensSetupEntry=sensSetupEntry, sensTable=sensTable, SensorName=SensorName, setup=setup)
