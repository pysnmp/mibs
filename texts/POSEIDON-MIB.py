...
mibBuilder.exportSymbols("POSEIDON-MIB", TimeStamp=TimeStamp, sensID=sensID, OutputMode=OutputMode, SensorValue=SensorValue, SensorString=SensorString, inpEntry=inpEntry, sensIndex=sensIndex, tsAlarmTable=tsAlarmTable, tsAlarmIdx=tsAlarmIdx, tsTrapAlarmStart=tsTrapAlarmStart, outMode=outMode, charonII=charonII, InputAlarmSetup=InputAlarmSetup, PositiveInteger=PositiveInteger, sensValueRaw=sensValueRaw, sensUnit=sensUnit, tsAlarmId=tsAlarmId, infoAddressMAC=infoAddressMAC, sensString=sensString, poseidon=poseidon, outName=outName, sensName=sensName, tsAlarmSensName=tsAlarmSensName, hwgroup=hwgroup, outEntry=outEntry, tsAlarmDescr=tsAlarmDescr, SensorName=SensorName, inpName=inpName, sensState=sensState, SensorFlags=SensorFlags, OutputType=OutputType, tsAlarmEntry=tsAlarmEntry, sensEntry=sensEntry, tsAlarmsPresent=tsAlarmsPresent, outIndex=outIndex, OnOff=OnOff, IOName=IOName, inpTable=inpTable, inpAlarmState=inpAlarmState, tsAlarmTime=tsAlarmTime, sensSetup=sensSetup, sensSetupTable=sensSetupTable, sensLimitMin=sensLimitMin, UnitType=UnitType, SensorID=SensorID, sensValue=sensValue, inpIndex=inpIndex, inpAlarmSetup=inpAlarmSetup, outTable=outTable, sensAlarmStateChanged=sensAlarmStateChanged, InputAlarmState=InputAlarmState, outValue=outValue, sensSetupEntry=sensSetupEntry, sensLimitMax=sensLimitMax, sensFlags=sensFlags, SensorUnitString=SensorUnitString, SensorState=SensorState, tsTrapAlarmEnd=tsTrapAlarmEnd, setup=setup, inpAlarmStateChanged=inpAlarmStateChanged, inpValue=inpValue, sensUnitString=sensUnitString, tsAlarm=tsAlarm, unitType=unitType, sensSetupIndex=sensSetupIndex, outType=outType, sensSetupName=sensSetupName, sensHysteresis=sensHysteresis, sensTable=sensTable, info=info)
