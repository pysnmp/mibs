...
mibBuilder.exportSymbols("POSEIDON-MIB", inpName=inpName, sensLimitMin=sensLimitMin, sensSetupEntry=sensSetupEntry, SensorString=SensorString, OutputType=OutputType, sensFlags=sensFlags, sensSetupIndex=sensSetupIndex, SensorUnitString=SensorUnitString, InputAlarmState=InputAlarmState, inpTable=inpTable, inpIndex=inpIndex, outTable=outTable, outValue=outValue, sensState=sensState, outType=outType, tsTrapAlarmEnd=tsTrapAlarmEnd, outName=outName, sensName=sensName, sensUnitString=sensUnitString, info=info, SensorValue=SensorValue, tsTrapAlarmStart=tsTrapAlarmStart, outMode=outMode, tsAlarmTime=tsAlarmTime, OnOff=OnOff, inpValue=inpValue, sensLimitMax=sensLimitMax, IOName=IOName, OutputMode=OutputMode, SensorName=SensorName, poseidon=poseidon, sensID=sensID, sensHysteresis=sensHysteresis, inpAlarmStateChanged=inpAlarmStateChanged, sensTable=sensTable, setup=setup, tsAlarmId=tsAlarmId, SensorID=SensorID, tsAlarmDescr=tsAlarmDescr, sensAlarmStateChanged=sensAlarmStateChanged, sensValue=sensValue, outEntry=outEntry, charonII=charonII, PositiveInteger=PositiveInteger, tsAlarmSensName=tsAlarmSensName, sensSetupTable=sensSetupTable, tsAlarmIdx=tsAlarmIdx, tsAlarmTable=tsAlarmTable, sensValueRaw=sensValueRaw, tsAlarm=tsAlarm, tsAlarmEntry=tsAlarmEntry, unitType=unitType, inpAlarmSetup=inpAlarmSetup, hwgroup=hwgroup, InputAlarmSetup=InputAlarmSetup, SensorState=SensorState, UnitType=UnitType, sensSetupName=sensSetupName, sensString=sensString, sensUnit=sensUnit, inpAlarmState=inpAlarmState, sensEntry=sensEntry, TimeStamp=TimeStamp, sensSetup=sensSetup, outIndex=outIndex, SensorFlags=SensorFlags, sensIndex=sensIndex, infoAddressMAC=infoAddressMAC, tsAlarmsPresent=tsAlarmsPresent, inpEntry=inpEntry)
