...
Integer32, IpAddress, Gauge32, iso, MibIdentifier, Counter32, Counter64, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, enterprises, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "Gauge32", "iso", "MibIdentifier", "Counter32", "Counter64", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "enterprises", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensSetupIndex=sensSetupIndex, outEntry=outEntry, sensName=sensName, sensUnitString=sensUnitString, TimeStamp=TimeStamp, unitType=unitType, sensLimitMin=sensLimitMin, sensIndex=sensIndex, sensID=sensID, tsAlarmId=tsAlarmId, OutputMode=OutputMode, sensValue=sensValue, inpAlarmState=inpAlarmState, UnitType=UnitType, tsTrapAlarmEnd=tsTrapAlarmEnd, setup=setup, outTable=outTable, OnOff=OnOff, tsAlarmsPresent=tsAlarmsPresent, sensSetupTable=sensSetupTable, inpEntry=inpEntry, tsAlarmIdx=tsAlarmIdx, sensSetup=sensSetup, SensorState=SensorState, charonII=charonII, InputAlarmSetup=InputAlarmSetup, sensEntry=sensEntry, outIndex=outIndex, sensLimitMax=sensLimitMax, SensorID=SensorID, poseidon=poseidon, sensHysteresis=sensHysteresis, hwgroup=hwgroup, tsAlarmSensName=tsAlarmSensName, SensorUnitString=SensorUnitString, inpValue=inpValue, PositiveInteger=PositiveInteger, IOName=IOName, tsAlarmTime=tsAlarmTime, inpAlarmStateChanged=inpAlarmStateChanged, SensorValue=SensorValue, SensorName=SensorName, outType=outType, outMode=outMode, sensString=sensString, SensorString=SensorString, info=info, inpName=inpName, sensState=sensState, sensUnit=sensUnit, tsAlarmEntry=tsAlarmEntry, sensSetupEntry=sensSetupEntry, sensSetupName=sensSetupName, SensorFlags=SensorFlags, inpTable=inpTable, tsAlarmDescr=tsAlarmDescr, sensValueRaw=sensValueRaw, sensAlarmStateChanged=sensAlarmStateChanged, outName=outName, OutputType=OutputType, outValue=outValue, infoAddressMAC=infoAddressMAC, inpAlarmSetup=inpAlarmSetup, sensTable=sensTable, tsAlarmTable=tsAlarmTable, InputAlarmState=InputAlarmState, tsAlarm=tsAlarm, inpIndex=inpIndex, tsTrapAlarmStart=tsTrapAlarmStart, sensFlags=sensFlags)
