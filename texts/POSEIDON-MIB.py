...
Counter64, Integer32, Bits, MibIdentifier, Counter32, enterprises, iso, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, IpAddress, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "Bits", "MibIdentifier", "Counter32", "enterprises", "iso", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "IpAddress", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarm=tsAlarm, tsAlarmTime=tsAlarmTime, sensIndex=sensIndex, sensSetupName=sensSetupName, sensValueRaw=sensValueRaw, sensUnitString=sensUnitString, outIndex=outIndex, UnitType=UnitType, inpTable=inpTable, outMode=outMode, inpAlarmSetup=inpAlarmSetup, sensUnit=sensUnit, tsAlarmEntry=tsAlarmEntry, sensString=sensString, outType=outType, tsAlarmIdx=tsAlarmIdx, tsAlarmId=tsAlarmId, outEntry=outEntry, inpAlarmStateChanged=inpAlarmStateChanged, sensSetupEntry=sensSetupEntry, SensorValue=SensorValue, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorFlags=SensorFlags, TimeStamp=TimeStamp, outTable=outTable, sensFlags=sensFlags, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmSensName=tsAlarmSensName, SensorID=SensorID, SensorString=SensorString, OutputType=OutputType, outName=outName, PositiveInteger=PositiveInteger, sensState=sensState, inpValue=inpValue, tsAlarmTable=tsAlarmTable, inpEntry=inpEntry, infoAddressMAC=infoAddressMAC, OnOff=OnOff, OutputMode=OutputMode, sensSetupTable=sensSetupTable, sensName=sensName, inpIndex=inpIndex, SensorState=SensorState, InputAlarmSetup=InputAlarmSetup, hwgroup=hwgroup, IOName=IOName, sensHysteresis=sensHysteresis, sensAlarmStateChanged=sensAlarmStateChanged, sensLimitMin=sensLimitMin, sensID=sensID, charonII=charonII, tsAlarmsPresent=tsAlarmsPresent, SensorName=SensorName, sensSetupIndex=sensSetupIndex, inpAlarmState=inpAlarmState, sensValue=sensValue, sensEntry=sensEntry, poseidon=poseidon, SensorUnitString=SensorUnitString, InputAlarmState=InputAlarmState, info=info, tsAlarmDescr=tsAlarmDescr, inpName=inpName, outValue=outValue, sensLimitMax=sensLimitMax, unitType=unitType, setup=setup, sensSetup=sensSetup, sensTable=sensTable)
