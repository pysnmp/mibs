...
iso, Gauge32, enterprises, Integer32, ObjectIdentity, NotificationType, IpAddress, Counter32, MibIdentifier, Bits, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "enterprises", "Integer32", "ObjectIdentity", "NotificationType", "IpAddress", "Counter32", "MibIdentifier", "Bits", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensSetupIndex=sensSetupIndex, tsTrapAlarmEnd=tsTrapAlarmEnd, outValue=outValue, InputAlarmSetup=InputAlarmSetup, outName=outName, setup=setup, inpAlarmState=inpAlarmState, tsAlarmDescr=tsAlarmDescr, tsAlarmTime=tsAlarmTime, infoAddressMAC=infoAddressMAC, IOName=IOName, inpEntry=inpEntry, unitType=unitType, sensSetupTable=sensSetupTable, poseidon=poseidon, outEntry=outEntry, OutputType=OutputType, UnitType=UnitType, SensorString=SensorString, hwgroup=hwgroup, charonII=charonII, sensHysteresis=sensHysteresis, tsAlarmIdx=tsAlarmIdx, sensSetup=sensSetup, inpTable=inpTable, TimeStamp=TimeStamp, outType=outType, sensName=sensName, tsAlarmsPresent=tsAlarmsPresent, outIndex=outIndex, sensEntry=sensEntry, sensUnitString=sensUnitString, sensUnit=sensUnit, inpValue=inpValue, sensFlags=sensFlags, sensLimitMax=sensLimitMax, inpAlarmStateChanged=inpAlarmStateChanged, inpAlarmSetup=inpAlarmSetup, SensorName=SensorName, inpIndex=inpIndex, sensString=sensString, sensSetupEntry=sensSetupEntry, OutputMode=OutputMode, sensID=sensID, SensorState=SensorState, SensorFlags=SensorFlags, sensValueRaw=sensValueRaw, tsAlarmTable=tsAlarmTable, inpName=inpName, InputAlarmState=InputAlarmState, SensorUnitString=SensorUnitString, tsAlarmId=tsAlarmId, sensLimitMin=sensLimitMin, outMode=outMode, outTable=outTable, info=info, sensIndex=sensIndex, sensTable=sensTable, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmSensName=tsAlarmSensName, PositiveInteger=PositiveInteger, sensSetupName=sensSetupName, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmEntry=tsAlarmEntry, SensorValue=SensorValue, sensState=sensState, tsAlarm=tsAlarm, OnOff=OnOff, sensValue=sensValue, SensorID=SensorID)
