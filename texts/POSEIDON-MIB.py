...
Counter64, enterprises, Integer32, ObjectIdentity, MibIdentifier, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, iso, TimeTicks, ModuleIdentity, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "enterprises", "Integer32", "ObjectIdentity", "MibIdentifier", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "iso", "TimeTicks", "ModuleIdentity", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorID=SensorID, sensValueRaw=sensValueRaw, SensorUnitString=SensorUnitString, sensValue=sensValue, sensName=sensName, outType=outType, sensUnitString=sensUnitString, tsAlarmSensName=tsAlarmSensName, inpIndex=inpIndex, OutputType=OutputType, inpAlarmStateChanged=inpAlarmStateChanged, UnitType=UnitType, setup=setup, sensState=sensState, sensString=sensString, sensIndex=sensIndex, tsAlarmIdx=tsAlarmIdx, inpAlarmSetup=inpAlarmSetup, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmTime=tsAlarmTime, sensTable=sensTable, SensorState=SensorState, unitType=unitType, charonII=charonII, tsAlarmId=tsAlarmId, sensLimitMin=sensLimitMin, sensLimitMax=sensLimitMax, OutputMode=OutputMode, InputAlarmState=InputAlarmState, sensHysteresis=sensHysteresis, inpEntry=inpEntry, SensorValue=SensorValue, SensorString=SensorString, inpAlarmState=inpAlarmState, tsAlarmsPresent=tsAlarmsPresent, sensSetup=sensSetup, InputAlarmSetup=InputAlarmSetup, PositiveInteger=PositiveInteger, sensSetupEntry=sensSetupEntry, TimeStamp=TimeStamp, tsAlarmEntry=tsAlarmEntry, outEntry=outEntry, sensSetupIndex=sensSetupIndex, outName=outName, tsAlarm=tsAlarm, inpValue=inpValue, sensID=sensID, sensEntry=sensEntry, sensUnit=sensUnit, infoAddressMAC=infoAddressMAC, tsAlarmTable=tsAlarmTable, sensSetupName=sensSetupName, inpTable=inpTable, hwgroup=hwgroup, outMode=outMode, IOName=IOName, outIndex=outIndex, sensFlags=sensFlags, info=info, SensorName=SensorName, inpName=inpName, OnOff=OnOff, tsTrapAlarmStart=tsTrapAlarmStart, SensorFlags=SensorFlags, outValue=outValue, tsAlarmDescr=tsAlarmDescr, sensSetupTable=sensSetupTable, poseidon=poseidon, outTable=outTable)
