...
ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, IpAddress, MibIdentifier, iso, Integer32, Bits, ModuleIdentity, Gauge32, Counter32, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "IpAddress", "MibIdentifier", "iso", "Integer32", "Bits", "ModuleIdentity", "Gauge32", "Counter32", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensSetupTable=sensSetupTable, sensSetupEntry=sensSetupEntry, SensorName=SensorName, charonII=charonII, tsAlarmTable=tsAlarmTable, outEntry=outEntry, inpAlarmSetup=inpAlarmSetup, info=info, sensUnitString=sensUnitString, sensAlarmStateChanged=sensAlarmStateChanged, IOName=IOName, InputAlarmState=InputAlarmState, sensSetupIndex=sensSetupIndex, sensSetupName=sensSetupName, outMode=outMode, inpName=inpName, SensorUnitString=SensorUnitString, tsAlarmDescr=tsAlarmDescr, sensValueRaw=sensValueRaw, sensLimitMin=sensLimitMin, sensValue=sensValue, tsAlarmSensName=tsAlarmSensName, inpAlarmStateChanged=inpAlarmStateChanged, inpAlarmState=inpAlarmState, tsAlarmIdx=tsAlarmIdx, SensorValue=SensorValue, UnitType=UnitType, OutputType=OutputType, OutputMode=OutputMode, poseidon=poseidon, outType=outType, sensTable=sensTable, sensID=sensID, SensorFlags=SensorFlags, TimeStamp=TimeStamp, sensEntry=sensEntry, SensorState=SensorState, inpEntry=inpEntry, PositiveInteger=PositiveInteger, sensState=sensState, sensString=sensString, tsAlarmEntry=tsAlarmEntry, tsAlarmId=tsAlarmId, sensLimitMax=sensLimitMax, inpTable=inpTable, tsTrapAlarmStart=tsTrapAlarmStart, unitType=unitType, OnOff=OnOff, inpIndex=inpIndex, inpValue=inpValue, sensUnit=sensUnit, tsAlarmsPresent=tsAlarmsPresent, outIndex=outIndex, tsAlarm=tsAlarm, tsAlarmTime=tsAlarmTime, InputAlarmSetup=InputAlarmSetup, infoAddressMAC=infoAddressMAC, sensHysteresis=sensHysteresis, tsTrapAlarmEnd=tsTrapAlarmEnd, hwgroup=hwgroup, SensorID=SensorID, outName=outName, SensorString=SensorString, sensName=sensName, outValue=outValue, setup=setup, outTable=outTable, sensSetup=sensSetup, sensFlags=sensFlags, sensIndex=sensIndex)
