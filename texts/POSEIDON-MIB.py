...
mibBuilder.exportSymbols("POSEIDON-MIB", sensTable=sensTable, sensUnitString=sensUnitString, poseidon=poseidon, sensValue=sensValue, tsAlarm=tsAlarm, sensAlarmStateChanged=sensAlarmStateChanged, inpTable=inpTable, TimeStamp=TimeStamp, inpValue=inpValue, outTable=outTable, sensState=sensState, SensorValue=SensorValue, inpAlarmSetup=inpAlarmSetup, IOName=IOName, sensValueRaw=sensValueRaw, setup=setup, tsAlarmIdx=tsAlarmIdx, sensSetup=sensSetup, tsTrapAlarmStart=tsTrapAlarmStart, outMode=outMode, PositiveInteger=PositiveInteger, sensLimitMin=sensLimitMin, outValue=outValue, SensorUnitString=SensorUnitString, sensString=sensString, outEntry=outEntry, hwgroup=hwgroup, unitType=unitType, inpName=inpName, inpEntry=inpEntry, sensLimitMax=sensLimitMax, InputAlarmSetup=InputAlarmSetup, SensorID=SensorID, info=info, OnOff=OnOff, sensHysteresis=sensHysteresis, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorName=SensorName, sensID=sensID, SensorState=SensorState, outName=outName, inpIndex=inpIndex, sensUnit=sensUnit, outType=outType, tsAlarmEntry=tsAlarmEntry, tsAlarmSensName=tsAlarmSensName, tsAlarmsPresent=tsAlarmsPresent, InputAlarmState=InputAlarmState, inpAlarmStateChanged=inpAlarmStateChanged, UnitType=UnitType, sensFlags=sensFlags, OutputType=OutputType, charonII=charonII, tsAlarmId=tsAlarmId, sensSetupTable=sensSetupTable, SensorString=SensorString, tsAlarmTime=tsAlarmTime, sensName=sensName, sensSetupEntry=sensSetupEntry, tsAlarmDescr=tsAlarmDescr, tsAlarmTable=tsAlarmTable, sensIndex=sensIndex, SensorFlags=SensorFlags, sensSetupName=sensSetupName, inpAlarmState=inpAlarmState, sensEntry=sensEntry, sensSetupIndex=sensSetupIndex, outIndex=outIndex, infoAddressMAC=infoAddressMAC, OutputMode=OutputMode)
