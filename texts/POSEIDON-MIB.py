...
Unsigned32, IpAddress, Integer32, Bits, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, MibIdentifier, TimeTicks, NotificationType, Counter32, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "Integer32", "Bits", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "TimeTicks", "NotificationType", "Counter32", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensEntry=sensEntry, infoAddressMAC=infoAddressMAC, InputAlarmState=InputAlarmState, IOName=IOName, SensorUnitString=SensorUnitString, inpEntry=inpEntry, sensSetupEntry=sensSetupEntry, inpAlarmState=inpAlarmState, inpValue=inpValue, outTable=outTable, sensAlarmStateChanged=sensAlarmStateChanged, sensTable=sensTable, sensUnit=sensUnit, tsTrapAlarmEnd=tsTrapAlarmEnd, UnitType=UnitType, tsAlarmId=tsAlarmId, inpTable=inpTable, outIndex=outIndex, tsAlarm=tsAlarm, tsAlarmTime=tsAlarmTime, OutputMode=OutputMode, hwgroup=hwgroup, sensHysteresis=sensHysteresis, TimeStamp=TimeStamp, InputAlarmSetup=InputAlarmSetup, SensorName=SensorName, inpAlarmSetup=inpAlarmSetup, outEntry=outEntry, tsAlarmsPresent=tsAlarmsPresent, tsAlarmTable=tsAlarmTable, SensorString=SensorString, poseidon=poseidon, OnOff=OnOff, inpAlarmStateChanged=inpAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, outMode=outMode, SensorFlags=SensorFlags, sensIndex=sensIndex, sensFlags=sensFlags, sensLimitMax=sensLimitMax, OutputType=OutputType, sensValueRaw=sensValueRaw, outValue=outValue, sensSetupName=sensSetupName, outType=outType, sensString=sensString, unitType=unitType, sensSetup=sensSetup, tsAlarmSensName=tsAlarmSensName, sensUnitString=sensUnitString, sensName=sensName, tsAlarmEntry=tsAlarmEntry, tsAlarmDescr=tsAlarmDescr, charonII=charonII, outName=outName, inpIndex=inpIndex, sensSetupTable=sensSetupTable, sensSetupIndex=sensSetupIndex, PositiveInteger=PositiveInteger, sensLimitMin=sensLimitMin, SensorState=SensorState, sensValue=sensValue, sensID=sensID, tsAlarmIdx=tsAlarmIdx, sensState=sensState, setup=setup, inpName=inpName, info=info, SensorValue=SensorValue, SensorID=SensorID)
