...
mibBuilder.exportSymbols("POSEIDON-MIB", sensTable=sensTable, outEntry=outEntry, sensSetup=sensSetup, tsAlarm=tsAlarm, outType=outType, SensorFlags=SensorFlags, InputAlarmSetup=InputAlarmSetup, unitType=unitType, poseidon=poseidon, outMode=outMode, OutputType=OutputType, SensorName=SensorName, setup=setup, sensIndex=sensIndex, charonII=charonII, tsAlarmEntry=tsAlarmEntry, tsAlarmId=tsAlarmId, sensSetupIndex=sensSetupIndex, sensSetupName=sensSetupName, outTable=outTable, sensLimitMin=sensLimitMin, sensValue=sensValue, sensID=sensID, tsAlarmTime=tsAlarmTime, InputAlarmState=InputAlarmState, inpEntry=inpEntry, inpName=inpName, inpAlarmStateChanged=inpAlarmStateChanged, info=info, inpTable=inpTable, sensValueRaw=sensValueRaw, tsTrapAlarmStart=tsTrapAlarmStart, sensName=sensName, outValue=outValue, tsAlarmDescr=tsAlarmDescr, SensorUnitString=SensorUnitString, hwgroup=hwgroup, sensSetupEntry=sensSetupEntry, sensAlarmStateChanged=sensAlarmStateChanged, OutputMode=OutputMode, outIndex=outIndex, outName=outName, sensState=sensState, TimeStamp=TimeStamp, sensString=sensString, IOName=IOName, tsAlarmSensName=tsAlarmSensName, infoAddressMAC=infoAddressMAC, SensorString=SensorString, tsAlarmTable=tsAlarmTable, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorID=SensorID, inpIndex=inpIndex, UnitType=UnitType, SensorState=SensorState, sensUnit=sensUnit, tsAlarmsPresent=tsAlarmsPresent, OnOff=OnOff, inpAlarmState=inpAlarmState, tsAlarmIdx=tsAlarmIdx, sensSetupTable=sensSetupTable, sensLimitMax=sensLimitMax, sensHysteresis=sensHysteresis, sensFlags=sensFlags, SensorValue=SensorValue, inpValue=inpValue, sensUnitString=sensUnitString, inpAlarmSetup=inpAlarmSetup, PositiveInteger=PositiveInteger, sensEntry=sensEntry)
