...
MibIdentifier, iso, Integer32, Counter32, Gauge32, IpAddress, Unsigned32, ModuleIdentity, TimeTicks, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "Integer32", "Counter32", "Gauge32", "IpAddress", "Unsigned32", "ModuleIdentity", "TimeTicks", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmIdx=tsAlarmIdx, tsTrapAlarmStart=tsTrapAlarmStart, sensUnitString=sensUnitString, sensSetupEntry=sensSetupEntry, sensName=sensName, sensSetup=sensSetup, tsAlarm=tsAlarm, OutputMode=OutputMode, sensFlags=sensFlags, sensSetupName=sensSetupName, sensIndex=sensIndex, outType=outType, inpTable=inpTable, outEntry=outEntry, sensString=sensString, outIndex=outIndex, sensUnit=sensUnit, sensTable=sensTable, tsAlarmEntry=tsAlarmEntry, outName=outName, SensorUnitString=SensorUnitString, setup=setup, OutputType=OutputType, tsAlarmTable=tsAlarmTable, inpIndex=inpIndex, sensValueRaw=sensValueRaw, infoAddressMAC=infoAddressMAC, sensLimitMin=sensLimitMin, IOName=IOName, outMode=outMode, inpAlarmSetup=inpAlarmSetup, tsAlarmTime=tsAlarmTime, SensorName=SensorName, sensID=sensID, SensorString=SensorString, inpName=inpName, tsTrapAlarmEnd=tsTrapAlarmEnd, sensSetupTable=sensSetupTable, outValue=outValue, tsAlarmDescr=tsAlarmDescr, inpAlarmStateChanged=inpAlarmStateChanged, TimeStamp=TimeStamp, poseidon=poseidon, SensorValue=SensorValue, OnOff=OnOff, sensSetupIndex=sensSetupIndex, sensAlarmStateChanged=sensAlarmStateChanged, hwgroup=hwgroup, SensorFlags=SensorFlags, inpAlarmState=inpAlarmState, sensLimitMax=sensLimitMax, unitType=unitType, tsAlarmsPresent=tsAlarmsPresent, PositiveInteger=PositiveInteger, info=info, sensEntry=sensEntry, sensHysteresis=sensHysteresis, InputAlarmState=InputAlarmState, UnitType=UnitType, SensorID=SensorID, outTable=outTable, sensValue=sensValue, InputAlarmSetup=InputAlarmSetup, sensState=sensState, SensorState=SensorState, tsAlarmSensName=tsAlarmSensName, inpValue=inpValue, charonII=charonII, tsAlarmId=tsAlarmId, inpEntry=inpEntry)
