...
ObjectIdentity, MibIdentifier, Gauge32, iso, NotificationType, Counter64, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, Unsigned32, Integer32, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "Gauge32", "iso", "NotificationType", "Counter64", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "Unsigned32", "Integer32", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorFlags=SensorFlags, info=info, sensSetupName=sensSetupName, tsAlarmIdx=tsAlarmIdx, sensSetup=sensSetup, sensSetupEntry=sensSetupEntry, UnitType=UnitType, infoAddressMAC=infoAddressMAC, tsAlarmDescr=tsAlarmDescr, IOName=IOName, outValue=outValue, outMode=outMode, sensState=sensState, sensValue=sensValue, sensName=sensName, InputAlarmSetup=InputAlarmSetup, charonII=charonII, tsAlarm=tsAlarm, TimeStamp=TimeStamp, inpName=inpName, outType=outType, outEntry=outEntry, sensLimitMax=sensLimitMax, OutputMode=OutputMode, sensLimitMin=sensLimitMin, sensID=sensID, tsAlarmSensName=tsAlarmSensName, sensUnitString=sensUnitString, sensHysteresis=sensHysteresis, sensAlarmStateChanged=sensAlarmStateChanged, sensTable=sensTable, poseidon=poseidon, inpValue=inpValue, inpAlarmState=inpAlarmState, sensEntry=sensEntry, tsAlarmEntry=tsAlarmEntry, hwgroup=hwgroup, inpTable=inpTable, inpAlarmSetup=inpAlarmSetup, outIndex=outIndex, SensorState=SensorState, OnOff=OnOff, OutputType=OutputType, SensorValue=SensorValue, SensorUnitString=SensorUnitString, inpIndex=inpIndex, PositiveInteger=PositiveInteger, sensString=sensString, outTable=outTable, inpAlarmStateChanged=inpAlarmStateChanged, InputAlarmState=InputAlarmState, outName=outName, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorName=SensorName, sensUnit=sensUnit, tsAlarmId=tsAlarmId, SensorID=SensorID, sensValueRaw=sensValueRaw, tsAlarmsPresent=tsAlarmsPresent, sensIndex=sensIndex, tsAlarmTime=tsAlarmTime, inpEntry=inpEntry, unitType=unitType, setup=setup, sensSetupIndex=sensSetupIndex, sensSetupTable=sensSetupTable, SensorString=SensorString, tsTrapAlarmStart=tsTrapAlarmStart, sensFlags=sensFlags, tsAlarmTable=tsAlarmTable)
