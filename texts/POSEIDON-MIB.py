...
mibBuilder.exportSymbols("POSEIDON-MIB", inpName=inpName, SensorState=SensorState, sensValue=sensValue, OutputType=OutputType, inpAlarmState=inpAlarmState, sensAlarmStateChanged=sensAlarmStateChanged, sensID=sensID, SensorString=SensorString, tsAlarmDescr=tsAlarmDescr, SensorFlags=SensorFlags, tsAlarmSensName=tsAlarmSensName, outTable=outTable, outMode=outMode, inpAlarmSetup=inpAlarmSetup, tsAlarmId=tsAlarmId, IOName=IOName, SensorValue=SensorValue, setup=setup, SensorName=SensorName, inpIndex=inpIndex, inpValue=inpValue, outIndex=outIndex, sensValueRaw=sensValueRaw, tsAlarmEntry=tsAlarmEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, unitType=unitType, charonII=charonII, PositiveInteger=PositiveInteger, SensorID=SensorID, sensUnit=sensUnit, UnitType=UnitType, sensState=sensState, sensName=sensName, sensLimitMin=sensLimitMin, sensSetupEntry=sensSetupEntry, TimeStamp=TimeStamp, SensorUnitString=SensorUnitString, sensSetup=sensSetup, inpEntry=inpEntry, poseidon=poseidon, tsAlarmTime=tsAlarmTime, inpTable=inpTable, outName=outName, sensIndex=sensIndex, InputAlarmState=InputAlarmState, tsAlarmTable=tsAlarmTable, sensSetupIndex=sensSetupIndex, inpAlarmStateChanged=inpAlarmStateChanged, sensFlags=sensFlags, sensHysteresis=sensHysteresis, tsAlarm=tsAlarm, tsTrapAlarmStart=tsTrapAlarmStart, outValue=outValue, outType=outType, sensTable=sensTable, sensUnitString=sensUnitString, outEntry=outEntry, tsAlarmsPresent=tsAlarmsPresent, sensEntry=sensEntry, sensSetupName=sensSetupName, sensLimitMax=sensLimitMax, infoAddressMAC=infoAddressMAC, info=info, sensString=sensString, sensSetupTable=sensSetupTable, OnOff=OnOff, OutputMode=OutputMode, hwgroup=hwgroup, InputAlarmSetup=InputAlarmSetup, tsAlarmIdx=tsAlarmIdx)
