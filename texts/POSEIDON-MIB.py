...
mibBuilder.exportSymbols("POSEIDON-MIB", sensState=sensState, sensUnitString=sensUnitString, inpValue=inpValue, SensorID=SensorID, sensEntry=sensEntry, hwgroup=hwgroup, SensorState=SensorState, outValue=outValue, tsAlarmIdx=tsAlarmIdx, charonII=charonII, sensSetupIndex=sensSetupIndex, sensID=sensID, tsAlarmDescr=tsAlarmDescr, sensLimitMin=sensLimitMin, unitType=unitType, outIndex=outIndex, outEntry=outEntry, sensString=sensString, UnitType=UnitType, IOName=IOName, tsAlarm=tsAlarm, InputAlarmSetup=InputAlarmSetup, sensHysteresis=sensHysteresis, PositiveInteger=PositiveInteger, inpTable=inpTable, outName=outName, SensorValue=SensorValue, OutputMode=OutputMode, tsAlarmSensName=tsAlarmSensName, OutputType=OutputType, InputAlarmState=InputAlarmState, sensSetupName=sensSetupName, tsAlarmTable=tsAlarmTable, sensFlags=sensFlags, sensSetupEntry=sensSetupEntry, sensValueRaw=sensValueRaw, sensSetupTable=sensSetupTable, inpAlarmStateChanged=inpAlarmStateChanged, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmEntry=tsAlarmEntry, sensLimitMax=sensLimitMax, SensorString=SensorString, SensorName=SensorName, tsAlarmTime=tsAlarmTime, info=info, inpIndex=inpIndex, sensName=sensName, poseidon=poseidon, sensIndex=sensIndex, tsAlarmsPresent=tsAlarmsPresent, inpAlarmState=inpAlarmState, tsTrapAlarmStart=tsTrapAlarmStart, SensorFlags=SensorFlags, OnOff=OnOff, sensTable=sensTable, sensValue=sensValue, outType=outType, inpEntry=inpEntry, sensSetup=sensSetup, inpName=inpName, outTable=outTable, infoAddressMAC=infoAddressMAC, setup=setup, tsAlarmId=tsAlarmId, sensAlarmStateChanged=sensAlarmStateChanged, inpAlarmSetup=inpAlarmSetup, outMode=outMode, SensorUnitString=SensorUnitString, sensUnit=sensUnit, TimeStamp=TimeStamp)
