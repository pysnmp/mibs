...
ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, Gauge32, Counter32, ModuleIdentity, enterprises, NotificationType, TimeTicks, Unsigned32, Integer32, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "Gauge32", "Counter32", "ModuleIdentity", "enterprises", "NotificationType", "TimeTicks", "Unsigned32", "Integer32", "Bits", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensUnit=sensUnit, inpEntry=inpEntry, infoAddressMAC=infoAddressMAC, unitType=unitType, sensLimitMin=sensLimitMin, SensorValue=SensorValue, sensState=sensState, tsAlarmsPresent=tsAlarmsPresent, tsAlarmId=tsAlarmId, OutputMode=OutputMode, SensorID=SensorID, poseidon=poseidon, sensIndex=sensIndex, sensName=sensName, sensValue=sensValue, inpTable=inpTable, OnOff=OnOff, inpIndex=inpIndex, info=info, UnitType=UnitType, sensEntry=sensEntry, PositiveInteger=PositiveInteger, inpValue=inpValue, tsAlarmTable=tsAlarmTable, tsAlarmSensName=tsAlarmSensName, tsAlarmIdx=tsAlarmIdx, tsTrapAlarmEnd=tsTrapAlarmEnd, outValue=outValue, sensSetupTable=sensSetupTable, sensFlags=sensFlags, outName=outName, sensID=sensID, tsAlarmEntry=tsAlarmEntry, SensorUnitString=SensorUnitString, InputAlarmState=InputAlarmState, charonII=charonII, outType=outType, outTable=outTable, tsAlarmTime=tsAlarmTime, sensSetup=sensSetup, sensSetupIndex=sensSetupIndex, inpAlarmStateChanged=inpAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, SensorString=SensorString, inpAlarmSetup=inpAlarmSetup, outEntry=outEntry, tsAlarm=tsAlarm, sensUnitString=sensUnitString, tsAlarmDescr=tsAlarmDescr, OutputType=OutputType, sensValueRaw=sensValueRaw, TimeStamp=TimeStamp, SensorFlags=SensorFlags, InputAlarmSetup=InputAlarmSetup, sensHysteresis=sensHysteresis, IOName=IOName, sensString=sensString, SensorName=SensorName, sensSetupName=sensSetupName, sensAlarmStateChanged=sensAlarmStateChanged, outMode=outMode, setup=setup, sensSetupEntry=sensSetupEntry, inpName=inpName, sensLimitMax=sensLimitMax, sensTable=sensTable, inpAlarmState=inpAlarmState, SensorState=SensorState, hwgroup=hwgroup, outIndex=outIndex)
