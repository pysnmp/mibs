...
mibBuilder.exportSymbols("POSEIDON-MIB", sensSetupTable=sensSetupTable, sensSetupName=sensSetupName, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmDescr=tsAlarmDescr, sensFlags=sensFlags, sensSetupEntry=sensSetupEntry, TimeStamp=TimeStamp, sensTable=sensTable, inpName=inpName, SensorID=SensorID, outType=outType, tsAlarmId=tsAlarmId, SensorString=SensorString, setup=setup, sensValueRaw=sensValueRaw, sensUnit=sensUnit, inpEntry=inpEntry, OutputType=OutputType, SensorValue=SensorValue, InputAlarmSetup=InputAlarmSetup, sensID=sensID, hwgroup=hwgroup, infoAddressMAC=infoAddressMAC, sensLimitMax=sensLimitMax, PositiveInteger=PositiveInteger, unitType=unitType, OnOff=OnOff, outName=outName, charonII=charonII, inpAlarmSetup=inpAlarmSetup, inpAlarmState=inpAlarmState, SensorState=SensorState, sensSetupIndex=sensSetupIndex, tsAlarmTable=tsAlarmTable, sensName=sensName, sensUnitString=sensUnitString, tsAlarmsPresent=tsAlarmsPresent, sensLimitMin=sensLimitMin, tsAlarmTime=tsAlarmTime, sensValue=sensValue, OutputMode=OutputMode, inpTable=inpTable, tsAlarmEntry=tsAlarmEntry, tsTrapAlarmEnd=tsTrapAlarmEnd, inpAlarmStateChanged=inpAlarmStateChanged, outMode=outMode, sensHysteresis=sensHysteresis, poseidon=poseidon, SensorUnitString=SensorUnitString, tsAlarmIdx=tsAlarmIdx, sensIndex=sensIndex, sensString=sensString, IOName=IOName, outIndex=outIndex, sensState=sensState, outEntry=outEntry, tsAlarm=tsAlarm, outValue=outValue, SensorFlags=SensorFlags, UnitType=UnitType, tsAlarmSensName=tsAlarmSensName, SensorName=SensorName, sensSetup=sensSetup, sensEntry=sensEntry, inpIndex=inpIndex, sensAlarmStateChanged=sensAlarmStateChanged, InputAlarmState=InputAlarmState, info=info, inpValue=inpValue, outTable=outTable)
