...
iso, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, ModuleIdentity, enterprises, Counter64, TimeTicks, Unsigned32, Gauge32, Bits, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "ModuleIdentity", "enterprises", "Counter64", "TimeTicks", "Unsigned32", "Gauge32", "Bits", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensEntry=sensEntry, PositiveInteger=PositiveInteger, outType=outType, sensID=sensID, outIndex=outIndex, OutputMode=OutputMode, inpEntry=inpEntry, InputAlarmSetup=InputAlarmSetup, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmSensName=tsAlarmSensName, unitType=unitType, sensIndex=sensIndex, outTable=outTable, tsAlarmDescr=tsAlarmDescr, SensorValue=SensorValue, inpTable=inpTable, sensTable=sensTable, info=info, hwgroup=hwgroup, inpAlarmSetup=inpAlarmSetup, UnitType=UnitType, sensValueRaw=sensValueRaw, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmTime=tsAlarmTime, sensSetup=sensSetup, sensValue=sensValue, tsAlarmId=tsAlarmId, tsAlarmsPresent=tsAlarmsPresent, outName=outName, SensorName=SensorName, sensSetupEntry=sensSetupEntry, tsAlarmTable=tsAlarmTable, sensSetupName=sensSetupName, SensorID=SensorID, inpName=inpName, InputAlarmState=InputAlarmState, sensState=sensState, sensLimitMin=sensLimitMin, sensLimitMax=sensLimitMax, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarm=tsAlarm, inpValue=inpValue, inpIndex=inpIndex, SensorFlags=SensorFlags, infoAddressMAC=infoAddressMAC, outMode=outMode, SensorState=SensorState, outEntry=outEntry, SensorUnitString=SensorUnitString, SensorString=SensorString, sensString=sensString, tsAlarmIdx=tsAlarmIdx, TimeStamp=TimeStamp, sensUnit=sensUnit, IOName=IOName, charonII=charonII, tsAlarmEntry=tsAlarmEntry, setup=setup, outValue=outValue, sensUnitString=sensUnitString, OutputType=OutputType, sensSetupTable=sensSetupTable, sensHysteresis=sensHysteresis, inpAlarmState=inpAlarmState, inpAlarmStateChanged=inpAlarmStateChanged, sensName=sensName, poseidon=poseidon, sensFlags=sensFlags, OnOff=OnOff, sensSetupIndex=sensSetupIndex)
