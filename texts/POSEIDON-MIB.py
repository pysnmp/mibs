...
MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, MibIdentifier, Counter64, Bits, Integer32, Counter32, TimeTicks, Unsigned32, IpAddress, ModuleIdentity, ObjectIdentity, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "MibIdentifier", "Counter64", "Bits", "Integer32", "Counter32", "TimeTicks", "Unsigned32", "IpAddress", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", OutputMode=OutputMode, OnOff=OnOff, outName=outName, InputAlarmSetup=InputAlarmSetup, SensorName=SensorName, outIndex=outIndex, PositiveInteger=PositiveInteger, SensorFlags=SensorFlags, tsAlarmTime=tsAlarmTime, sensHysteresis=sensHysteresis, poseidon=poseidon, SensorUnitString=SensorUnitString, outValue=outValue, sensSetupTable=sensSetupTable, SensorValue=SensorValue, tsAlarmsPresent=tsAlarmsPresent, setup=setup, tsAlarm=tsAlarm, hwgroup=hwgroup, inpTable=inpTable, tsAlarmSensName=tsAlarmSensName, OutputType=OutputType, SensorID=SensorID, TimeStamp=TimeStamp, tsAlarmId=tsAlarmId, sensAlarmStateChanged=sensAlarmStateChanged, inpEntry=inpEntry, sensSetupIndex=sensSetupIndex, inpName=inpName, charonII=charonII, sensTable=sensTable, inpValue=inpValue, SensorState=SensorState, outTable=outTable, InputAlarmState=InputAlarmState, inpIndex=inpIndex, UnitType=UnitType, inpAlarmSetup=inpAlarmSetup, tsAlarmDescr=tsAlarmDescr, sensFlags=sensFlags, sensState=sensState, tsAlarmEntry=tsAlarmEntry, info=info, sensValueRaw=sensValueRaw, sensValue=sensValue, sensLimitMax=sensLimitMax, outEntry=outEntry, sensString=sensString, sensUnit=sensUnit, sensSetup=sensSetup, IOName=IOName, sensLimitMin=sensLimitMin, inpAlarmStateChanged=inpAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorString=SensorString, outMode=outMode, sensIndex=sensIndex, sensUnitString=sensUnitString, sensName=sensName, sensID=sensID, sensEntry=sensEntry, tsAlarmTable=tsAlarmTable, outType=outType, sensSetupEntry=sensSetupEntry, unitType=unitType, tsAlarmIdx=tsAlarmIdx, sensSetupName=sensSetupName, inpAlarmState=inpAlarmState, infoAddressMAC=infoAddressMAC)
