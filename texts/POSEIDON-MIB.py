...
iso, IpAddress, Counter64, enterprises, Gauge32, NotificationType, Unsigned32, MibIdentifier, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Counter64", "enterprises", "Gauge32", "NotificationType", "Unsigned32", "MibIdentifier", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensTable=sensTable, infoAddressMAC=infoAddressMAC, outIndex=outIndex, setup=setup, inpTable=inpTable, PositiveInteger=PositiveInteger, outName=outName, sensEntry=sensEntry, sensLimitMin=sensLimitMin, sensName=sensName, poseidon=poseidon, inpValue=inpValue, unitType=unitType, tsAlarm=tsAlarm, outMode=outMode, tsAlarmId=tsAlarmId, hwgroup=hwgroup, UnitType=UnitType, sensLimitMax=sensLimitMax, sensUnitString=sensUnitString, tsTrapAlarmStart=tsTrapAlarmStart, InputAlarmSetup=InputAlarmSetup, SensorName=SensorName, outTable=outTable, tsAlarmSensName=tsAlarmSensName, sensSetupEntry=sensSetupEntry, inpAlarmStateChanged=inpAlarmStateChanged, info=info, tsAlarmTime=tsAlarmTime, outType=outType, inpAlarmSetup=inpAlarmSetup, OnOff=OnOff, sensUnit=sensUnit, sensHysteresis=sensHysteresis, SensorState=SensorState, tsAlarmIdx=tsAlarmIdx, sensID=sensID, tsTrapAlarmEnd=tsTrapAlarmEnd, sensSetupName=sensSetupName, sensFlags=sensFlags, sensValue=sensValue, SensorUnitString=SensorUnitString, SensorFlags=SensorFlags, tsAlarmEntry=tsAlarmEntry, OutputType=OutputType, sensSetup=sensSetup, inpIndex=inpIndex, OutputMode=OutputMode, sensString=sensString, tsAlarmsPresent=tsAlarmsPresent, sensAlarmStateChanged=sensAlarmStateChanged, sensState=sensState, sensValueRaw=sensValueRaw, outValue=outValue, inpAlarmState=inpAlarmState, IOName=IOName, outEntry=outEntry, SensorValue=SensorValue, InputAlarmState=InputAlarmState, tsAlarmTable=tsAlarmTable, tsAlarmDescr=tsAlarmDescr, sensSetupTable=sensSetupTable, TimeStamp=TimeStamp, SensorString=SensorString, inpName=inpName, sensIndex=sensIndex, inpEntry=inpEntry, charonII=charonII, SensorID=SensorID, sensSetupIndex=sensSetupIndex)
