...
Unsigned32, iso, enterprises, Bits, Gauge32, Counter64, Integer32, NotificationType, ModuleIdentity, TimeTicks, ObjectIdentity, IpAddress, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "enterprises", "Bits", "Gauge32", "Counter64", "Integer32", "NotificationType", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "IpAddress", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensEntry=sensEntry, tsAlarmsPresent=tsAlarmsPresent, inpIndex=inpIndex, sensUnit=sensUnit, SensorValue=SensorValue, sensState=sensState, sensSetup=sensSetup, sensLimitMax=sensLimitMax, tsAlarmEntry=tsAlarmEntry, infoAddressMAC=infoAddressMAC, sensFlags=sensFlags, inpAlarmStateChanged=inpAlarmStateChanged, sensIndex=sensIndex, sensSetupIndex=sensSetupIndex, tsAlarm=tsAlarm, sensAlarmStateChanged=sensAlarmStateChanged, outMode=outMode, TimeStamp=TimeStamp, sensUnitString=sensUnitString, charonII=charonII, inpAlarmState=inpAlarmState, outIndex=outIndex, sensSetupEntry=sensSetupEntry, tsAlarmTable=tsAlarmTable, OutputType=OutputType, tsAlarmTime=tsAlarmTime, inpName=inpName, OnOff=OnOff, unitType=unitType, outType=outType, UnitType=UnitType, tsAlarmDescr=tsAlarmDescr, SensorState=SensorState, IOName=IOName, SensorFlags=SensorFlags, PositiveInteger=PositiveInteger, InputAlarmState=InputAlarmState, inpTable=inpTable, outEntry=outEntry, sensValue=sensValue, sensName=sensName, outTable=outTable, outValue=outValue, tsAlarmIdx=tsAlarmIdx, sensSetupTable=sensSetupTable, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorID=SensorID, tsAlarmId=tsAlarmId, sensString=sensString, sensSetupName=sensSetupName, inpEntry=inpEntry, inpValue=inpValue, InputAlarmSetup=InputAlarmSetup, sensHysteresis=sensHysteresis, inpAlarmSetup=inpAlarmSetup, sensValueRaw=sensValueRaw, SensorUnitString=SensorUnitString, sensLimitMin=sensLimitMin, tsTrapAlarmStart=tsTrapAlarmStart, SensorName=SensorName, setup=setup, info=info, sensID=sensID, poseidon=poseidon, sensTable=sensTable, hwgroup=hwgroup, SensorString=SensorString, OutputMode=OutputMode, tsAlarmSensName=tsAlarmSensName, outName=outName)
