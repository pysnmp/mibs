...
ObjectIdentity, NotificationType, iso, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, Unsigned32, enterprises, MibIdentifier, IpAddress, Counter32, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "iso", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "Unsigned32", "enterprises", "MibIdentifier", "IpAddress", "Counter32", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpName=inpName, sensIndex=sensIndex, tsAlarmTable=tsAlarmTable, inpIndex=inpIndex, sensLimitMax=sensLimitMax, setup=setup, sensEntry=sensEntry, tsAlarmId=tsAlarmId, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmEnd=tsTrapAlarmEnd, unitType=unitType, tsAlarmEntry=tsAlarmEntry, tsTrapAlarmStart=tsTrapAlarmStart, sensLimitMin=sensLimitMin, SensorID=SensorID, infoAddressMAC=infoAddressMAC, inpAlarmState=inpAlarmState, SensorValue=SensorValue, SensorFlags=SensorFlags, sensName=sensName, tsAlarmSensName=tsAlarmSensName, outTable=outTable, InputAlarmSetup=InputAlarmSetup, IOName=IOName, tsAlarmIdx=tsAlarmIdx, SensorState=SensorState, poseidon=poseidon, sensState=sensState, SensorString=SensorString, inpTable=inpTable, sensSetupName=sensSetupName, sensHysteresis=sensHysteresis, inpEntry=inpEntry, sensUnitString=sensUnitString, tsAlarmsPresent=tsAlarmsPresent, inpAlarmStateChanged=inpAlarmStateChanged, OnOff=OnOff, tsAlarmDescr=tsAlarmDescr, tsAlarmTime=tsAlarmTime, outMode=outMode, sensTable=sensTable, info=info, OutputType=OutputType, sensSetup=sensSetup, SensorUnitString=SensorUnitString, outIndex=outIndex, sensString=sensString, inpValue=inpValue, outEntry=outEntry, charonII=charonII, sensFlags=sensFlags, outValue=outValue, OutputMode=OutputMode, PositiveInteger=PositiveInteger, sensUnit=sensUnit, sensSetupTable=sensSetupTable, tsAlarm=tsAlarm, inpAlarmSetup=inpAlarmSetup, UnitType=UnitType, InputAlarmState=InputAlarmState, sensSetupIndex=sensSetupIndex, sensSetupEntry=sensSetupEntry, outType=outType, SensorName=SensorName, sensValue=sensValue, sensID=sensID, outName=outName, hwgroup=hwgroup, TimeStamp=TimeStamp, sensValueRaw=sensValueRaw)
