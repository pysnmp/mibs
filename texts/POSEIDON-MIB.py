...
mibBuilder.exportSymbols("POSEIDON-MIB", TimeStamp=TimeStamp, tsAlarmTable=tsAlarmTable, InputAlarmSetup=InputAlarmSetup, tsAlarmSensName=tsAlarmSensName, SensorFlags=SensorFlags, unitType=unitType, SensorID=SensorID, inpEntry=inpEntry, inpAlarmState=inpAlarmState, sensEntry=sensEntry, sensLimitMin=sensLimitMin, sensName=sensName, inpName=inpName, SensorValue=SensorValue, sensFlags=sensFlags, outMode=outMode, outValue=outValue, sensSetupTable=sensSetupTable, outName=outName, tsAlarm=tsAlarm, sensSetupEntry=sensSetupEntry, sensHysteresis=sensHysteresis, tsTrapAlarmEnd=tsTrapAlarmEnd, sensIndex=sensIndex, poseidon=poseidon, info=info, OnOff=OnOff, PositiveInteger=PositiveInteger, SensorName=SensorName, sensTable=sensTable, sensString=sensString, sensValue=sensValue, InputAlarmState=InputAlarmState, sensUnit=sensUnit, hwgroup=hwgroup, tsAlarmDescr=tsAlarmDescr, sensUnitString=sensUnitString, tsAlarmId=tsAlarmId, sensSetupIndex=sensSetupIndex, inpAlarmStateChanged=inpAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, UnitType=UnitType, SensorState=SensorState, sensLimitMax=sensLimitMax, inpValue=inpValue, tsAlarmEntry=tsAlarmEntry, tsAlarmIdx=tsAlarmIdx, inpIndex=inpIndex, OutputType=OutputType, setup=setup, infoAddressMAC=infoAddressMAC, tsAlarmsPresent=tsAlarmsPresent, charonII=charonII, outEntry=outEntry, inpAlarmSetup=inpAlarmSetup, OutputMode=OutputMode, SensorUnitString=SensorUnitString, sensValueRaw=sensValueRaw, tsAlarmTime=tsAlarmTime, sensSetupName=sensSetupName, sensAlarmStateChanged=sensAlarmStateChanged, inpTable=inpTable, SensorString=SensorString, IOName=IOName, sensState=sensState, outIndex=outIndex, sensID=sensID, sensSetup=sensSetup, outType=outType, outTable=outTable)
