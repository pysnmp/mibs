...
mibBuilder.exportSymbols("POSEIDON-MIB", sensLimitMin=sensLimitMin, sensSetupTable=sensSetupTable, tsAlarmEntry=tsAlarmEntry, tsAlarmId=tsAlarmId, setup=setup, OutputType=OutputType, sensHysteresis=sensHysteresis, SensorUnitString=SensorUnitString, sensUnitString=sensUnitString, OutputMode=OutputMode, unitType=unitType, sensUnit=sensUnit, tsAlarmsPresent=tsAlarmsPresent, outTable=outTable, sensID=sensID, outType=outType, PositiveInteger=PositiveInteger, sensAlarmStateChanged=sensAlarmStateChanged, sensName=sensName, SensorString=SensorString, InputAlarmSetup=InputAlarmSetup, outIndex=outIndex, sensFlags=sensFlags, inpAlarmSetup=inpAlarmSetup, sensLimitMax=sensLimitMax, inpName=inpName, sensEntry=sensEntry, sensString=sensString, outValue=outValue, sensSetupName=sensSetupName, inpTable=inpTable, OnOff=OnOff, inpEntry=inpEntry, tsAlarmSensName=tsAlarmSensName, sensSetupIndex=sensSetupIndex, tsAlarmTable=tsAlarmTable, InputAlarmState=InputAlarmState, sensState=sensState, tsAlarmTime=tsAlarmTime, inpAlarmState=inpAlarmState, IOName=IOName, sensSetup=sensSetup, UnitType=UnitType, poseidon=poseidon, tsAlarmIdx=tsAlarmIdx, tsTrapAlarmStart=tsTrapAlarmStart, tsTrapAlarmEnd=tsTrapAlarmEnd, outEntry=outEntry, SensorState=SensorState, sensValue=sensValue, tsAlarm=tsAlarm, hwgroup=hwgroup, inpIndex=inpIndex, SensorValue=SensorValue, tsAlarmDescr=tsAlarmDescr, sensSetupEntry=sensSetupEntry, SensorFlags=SensorFlags, infoAddressMAC=infoAddressMAC, info=info, sensTable=sensTable, sensValueRaw=sensValueRaw, TimeStamp=TimeStamp, outName=outName, SensorName=SensorName, inpValue=inpValue, charonII=charonII, inpAlarmStateChanged=inpAlarmStateChanged, SensorID=SensorID, sensIndex=sensIndex, outMode=outMode)
