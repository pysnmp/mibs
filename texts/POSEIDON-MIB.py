...
mibBuilder.exportSymbols("POSEIDON-MIB", sensFlags=sensFlags, IOName=IOName, outType=outType, tsAlarmsPresent=tsAlarmsPresent, sensState=sensState, sensUnit=sensUnit, charonII=charonII, inpTable=inpTable, OutputType=OutputType, sensSetupName=sensSetupName, sensSetupTable=sensSetupTable, outValue=outValue, tsTrapAlarmStart=tsTrapAlarmStart, SensorFlags=SensorFlags, inpAlarmStateChanged=inpAlarmStateChanged, hwgroup=hwgroup, poseidon=poseidon, OutputMode=OutputMode, UnitType=UnitType, info=info, inpAlarmSetup=inpAlarmSetup, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmId=tsAlarmId, sensSetup=sensSetup, sensSetupIndex=sensSetupIndex, outEntry=outEntry, sensID=sensID, inpEntry=inpEntry, sensString=sensString, setup=setup, SensorName=SensorName, TimeStamp=TimeStamp, sensValue=sensValue, sensIndex=sensIndex, sensTable=sensTable, tsAlarmTime=tsAlarmTime, outTable=outTable, tsAlarmSensName=tsAlarmSensName, sensSetupEntry=sensSetupEntry, sensLimitMax=sensLimitMax, sensUnitString=sensUnitString, SensorID=SensorID, inpAlarmState=inpAlarmState, InputAlarmSetup=InputAlarmSetup, SensorString=SensorString, outIndex=outIndex, inpName=inpName, SensorUnitString=SensorUnitString, sensValueRaw=sensValueRaw, inpIndex=inpIndex, tsAlarm=tsAlarm, tsAlarmEntry=tsAlarmEntry, tsAlarmDescr=tsAlarmDescr, sensAlarmStateChanged=sensAlarmStateChanged, PositiveInteger=PositiveInteger, inpValue=inpValue, sensHysteresis=sensHysteresis, SensorState=SensorState, tsAlarmIdx=tsAlarmIdx, OnOff=OnOff, sensEntry=sensEntry, infoAddressMAC=infoAddressMAC, sensName=sensName, outMode=outMode, SensorValue=SensorValue, unitType=unitType, sensLimitMin=sensLimitMin, InputAlarmState=InputAlarmState, tsAlarmTable=tsAlarmTable, outName=outName)
