...
enterprises, Bits, Integer32, ObjectIdentity, TimeTicks, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, Gauge32, Counter32, ModuleIdentity, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "Integer32", "ObjectIdentity", "TimeTicks", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "Gauge32", "Counter32", "ModuleIdentity", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensSetup=sensSetup, tsAlarmDescr=tsAlarmDescr, sensUnitString=sensUnitString, InputAlarmSetup=InputAlarmSetup, SensorName=SensorName, SensorString=SensorString, tsAlarmSensName=tsAlarmSensName, sensSetupIndex=sensSetupIndex, sensSetupName=sensSetupName, PositiveInteger=PositiveInteger, sensState=sensState, tsAlarmEntry=tsAlarmEntry, tsAlarmTime=tsAlarmTime, infoAddressMAC=infoAddressMAC, sensSetupTable=sensSetupTable, UnitType=UnitType, SensorID=SensorID, OutputMode=OutputMode, sensAlarmStateChanged=sensAlarmStateChanged, sensValueRaw=sensValueRaw, outEntry=outEntry, unitType=unitType, sensHysteresis=sensHysteresis, sensTable=sensTable, OnOff=OnOff, tsTrapAlarmEnd=tsTrapAlarmEnd, IOName=IOName, sensLimitMin=sensLimitMin, outType=outType, tsAlarm=tsAlarm, sensFlags=sensFlags, SensorState=SensorState, tsAlarmTable=tsAlarmTable, tsTrapAlarmStart=tsTrapAlarmStart, outTable=outTable, outName=outName, sensID=sensID, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmsPresent=tsAlarmsPresent, sensSetupEntry=sensSetupEntry, SensorValue=SensorValue, TimeStamp=TimeStamp, hwgroup=hwgroup, inpValue=inpValue, info=info, SensorUnitString=SensorUnitString, inpIndex=inpIndex, sensString=sensString, SensorFlags=SensorFlags, outValue=outValue, sensLimitMax=sensLimitMax, outIndex=outIndex, outMode=outMode, poseidon=poseidon, OutputType=OutputType, sensEntry=sensEntry, tsAlarmIdx=tsAlarmIdx, inpAlarmSetup=inpAlarmSetup, inpName=inpName, inpTable=inpTable, inpEntry=inpEntry, sensIndex=sensIndex, inpAlarmState=inpAlarmState, sensName=sensName, sensUnit=sensUnit, setup=setup, sensValue=sensValue, charonII=charonII, InputAlarmState=InputAlarmState, tsAlarmId=tsAlarmId)
