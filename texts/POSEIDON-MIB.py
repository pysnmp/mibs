...
IpAddress, Unsigned32, enterprises, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, Bits, Counter32, ModuleIdentity, MibIdentifier, TimeTicks, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "enterprises", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "Bits", "Counter32", "ModuleIdentity", "MibIdentifier", "TimeTicks", "iso", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensSetupName=sensSetupName, outName=outName, sensFlags=sensFlags, sensSetupEntry=sensSetupEntry, sensUnitString=sensUnitString, tsAlarmEntry=tsAlarmEntry, tsAlarmDescr=tsAlarmDescr, sensEntry=sensEntry, PositiveInteger=PositiveInteger, sensSetup=sensSetup, sensSetupTable=sensSetupTable, outValue=outValue, tsAlarmsPresent=tsAlarmsPresent, tsAlarm=tsAlarm, outMode=outMode, sensValueRaw=sensValueRaw, info=info, outIndex=outIndex, infoAddressMAC=infoAddressMAC, tsAlarmId=tsAlarmId, charonII=charonII, InputAlarmSetup=InputAlarmSetup, inpAlarmSetup=inpAlarmSetup, inpAlarmState=inpAlarmState, outTable=outTable, sensValue=sensValue, tsAlarmTable=tsAlarmTable, sensName=sensName, inpAlarmStateChanged=inpAlarmStateChanged, inpTable=inpTable, sensID=sensID, tsTrapAlarmEnd=tsTrapAlarmEnd, IOName=IOName, SensorFlags=SensorFlags, SensorID=SensorID, UnitType=UnitType, sensHysteresis=sensHysteresis, SensorValue=SensorValue, SensorName=SensorName, sensIndex=sensIndex, setup=setup, sensTable=sensTable, tsAlarmSensName=tsAlarmSensName, sensSetupIndex=sensSetupIndex, TimeStamp=TimeStamp, OnOff=OnOff, OutputType=OutputType, poseidon=poseidon, tsTrapAlarmStart=tsTrapAlarmStart, OutputMode=OutputMode, SensorString=SensorString, InputAlarmState=InputAlarmState, inpEntry=inpEntry, inpName=inpName, sensUnit=sensUnit, outEntry=outEntry, hwgroup=hwgroup, outType=outType, tsAlarmTime=tsAlarmTime, tsAlarmIdx=tsAlarmIdx, unitType=unitType, sensLimitMin=sensLimitMin, sensState=sensState, inpValue=inpValue, sensString=sensString, sensAlarmStateChanged=sensAlarmStateChanged, SensorState=SensorState, SensorUnitString=SensorUnitString, sensLimitMax=sensLimitMax, inpIndex=inpIndex)
