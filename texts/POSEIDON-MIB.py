...
NotificationType, ModuleIdentity, enterprises, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, Bits, MibIdentifier, TimeTicks, Gauge32, Integer32, IpAddress, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "enterprises", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "Bits", "MibIdentifier", "TimeTicks", "Gauge32", "Integer32", "IpAddress", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensIndex=sensIndex, OutputMode=OutputMode, tsAlarmTable=tsAlarmTable, SensorUnitString=SensorUnitString, outIndex=outIndex, SensorFlags=SensorFlags, OnOff=OnOff, sensTable=sensTable, OutputType=OutputType, sensUnitString=sensUnitString, sensAlarmStateChanged=sensAlarmStateChanged, SensorState=SensorState, sensValueRaw=sensValueRaw, poseidon=poseidon, SensorValue=SensorValue, tsAlarm=tsAlarm, inpIndex=inpIndex, sensLimitMax=sensLimitMax, charonII=charonII, sensUnit=sensUnit, UnitType=UnitType, unitType=unitType, sensValue=sensValue, sensFlags=sensFlags, tsAlarmTime=tsAlarmTime, hwgroup=hwgroup, tsAlarmDescr=tsAlarmDescr, tsAlarmSensName=tsAlarmSensName, sensString=sensString, setup=setup, inpEntry=inpEntry, InputAlarmSetup=InputAlarmSetup, inpValue=inpValue, inpAlarmSetup=inpAlarmSetup, sensName=sensName, tsAlarmsPresent=tsAlarmsPresent, tsAlarmEntry=tsAlarmEntry, tsAlarmId=tsAlarmId, TimeStamp=TimeStamp, SensorString=SensorString, sensID=sensID, tsTrapAlarmStart=tsTrapAlarmStart, outType=outType, outMode=outMode, inpAlarmStateChanged=inpAlarmStateChanged, InputAlarmState=InputAlarmState, tsAlarmIdx=tsAlarmIdx, sensSetupName=sensSetupName, IOName=IOName, inpAlarmState=inpAlarmState, info=info, infoAddressMAC=infoAddressMAC, sensSetupIndex=sensSetupIndex, sensHysteresis=sensHysteresis, sensSetupEntry=sensSetupEntry, outTable=outTable, SensorName=SensorName, inpName=inpName, sensEntry=sensEntry, sensSetupTable=sensSetupTable, sensState=sensState, PositiveInteger=PositiveInteger, outEntry=outEntry, outValue=outValue, tsTrapAlarmEnd=tsTrapAlarmEnd, sensSetup=sensSetup, SensorID=SensorID, outName=outName, inpTable=inpTable, sensLimitMin=sensLimitMin)
