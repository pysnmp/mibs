...
mibBuilder.exportSymbols("POSEIDON-MIB", outEntry=outEntry, SensorID=SensorID, inpName=inpName, sensUnitString=sensUnitString, SensorName=SensorName, sensEntry=sensEntry, inpAlarmState=inpAlarmState, sensIndex=sensIndex, sensFlags=sensFlags, InputAlarmSetup=InputAlarmSetup, sensLimitMin=sensLimitMin, infoAddressMAC=infoAddressMAC, sensValueRaw=sensValueRaw, tsTrapAlarmStart=tsTrapAlarmStart, inpEntry=inpEntry, outValue=outValue, IOName=IOName, hwgroup=hwgroup, tsAlarm=tsAlarm, tsAlarmEntry=tsAlarmEntry, tsAlarmId=tsAlarmId, sensLimitMax=sensLimitMax, outType=outType, inpIndex=inpIndex, sensAlarmStateChanged=sensAlarmStateChanged, InputAlarmState=InputAlarmState, inpValue=inpValue, sensValue=sensValue, sensID=sensID, sensUnit=sensUnit, OutputMode=OutputMode, OutputType=OutputType, sensState=sensState, tsAlarmIdx=tsAlarmIdx, charonII=charonII, sensSetupTable=sensSetupTable, tsAlarmTable=tsAlarmTable, sensName=sensName, info=info, setup=setup, SensorFlags=SensorFlags, sensHysteresis=sensHysteresis, UnitType=UnitType, inpTable=inpTable, SensorState=SensorState, TimeStamp=TimeStamp, inpAlarmStateChanged=inpAlarmStateChanged, SensorString=SensorString, inpAlarmSetup=inpAlarmSetup, SensorValue=SensorValue, sensTable=sensTable, sensSetup=sensSetup, sensSetupName=sensSetupName, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorUnitString=SensorUnitString, tsAlarmDescr=tsAlarmDescr, outName=outName, outTable=outTable, tsAlarmsPresent=tsAlarmsPresent, OnOff=OnOff, unitType=unitType, sensSetupIndex=sensSetupIndex, outIndex=outIndex, PositiveInteger=PositiveInteger, tsAlarmTime=tsAlarmTime, sensSetupEntry=sensSetupEntry, outMode=outMode, tsAlarmSensName=tsAlarmSensName, poseidon=poseidon, sensString=sensString)
