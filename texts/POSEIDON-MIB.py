...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, Unsigned32, Counter64, iso, MibIdentifier, ObjectIdentity, enterprises, TimeTicks, NotificationType, Counter32, ModuleIdentity, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "Unsigned32", "Counter64", "iso", "MibIdentifier", "ObjectIdentity", "enterprises", "TimeTicks", "NotificationType", "Counter32", "ModuleIdentity", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", InputAlarmSetup=InputAlarmSetup, charonII=charonII, PositiveInteger=PositiveInteger, SensorValue=SensorValue, tsAlarmDescr=tsAlarmDescr, tsAlarmTime=tsAlarmTime, inpEntry=inpEntry, infoAddressMAC=infoAddressMAC, sensSetupTable=sensSetupTable, tsAlarmIdx=tsAlarmIdx, TimeStamp=TimeStamp, sensSetupName=sensSetupName, sensValueRaw=sensValueRaw, sensValue=sensValue, tsTrapAlarmStart=tsTrapAlarmStart, SensorID=SensorID, SensorName=SensorName, sensName=sensName, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmEnd=tsTrapAlarmEnd, OutputMode=OutputMode, SensorString=SensorString, inpName=inpName, sensUnitString=sensUnitString, tsAlarmSensName=tsAlarmSensName, outType=outType, sensID=sensID, setup=setup, tsAlarmTable=tsAlarmTable, IOName=IOName, poseidon=poseidon, sensEntry=sensEntry, tsAlarmId=tsAlarmId, inpTable=inpTable, outValue=outValue, sensUnit=sensUnit, sensFlags=sensFlags, SensorFlags=SensorFlags, InputAlarmState=InputAlarmState, hwgroup=hwgroup, inpValue=inpValue, unitType=unitType, sensSetupEntry=sensSetupEntry, sensIndex=sensIndex, outTable=outTable, SensorState=SensorState, sensSetup=sensSetup, sensTable=sensTable, tsAlarm=tsAlarm, sensSetupIndex=sensSetupIndex, sensLimitMin=sensLimitMin, sensHysteresis=sensHysteresis, outName=outName, outMode=outMode, tsAlarmsPresent=tsAlarmsPresent, outIndex=outIndex, inpAlarmSetup=inpAlarmSetup, info=info, tsAlarmEntry=tsAlarmEntry, UnitType=UnitType, OnOff=OnOff, inpIndex=inpIndex, sensState=sensState, outEntry=outEntry, inpAlarmState=inpAlarmState, sensString=sensString, sensLimitMax=sensLimitMax, inpAlarmStateChanged=inpAlarmStateChanged, SensorUnitString=SensorUnitString, OutputType=OutputType)
