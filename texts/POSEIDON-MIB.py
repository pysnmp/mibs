...
mibBuilder.exportSymbols("POSEIDON-MIB", inpEntry=inpEntry, outValue=outValue, tsAlarmId=tsAlarmId, sensString=sensString, sensSetupIndex=sensSetupIndex, outIndex=outIndex, inpTable=inpTable, sensTable=sensTable, sensLimitMin=sensLimitMin, tsAlarmsPresent=tsAlarmsPresent, tsAlarmTime=tsAlarmTime, inpAlarmState=inpAlarmState, outEntry=outEntry, info=info, SensorUnitString=SensorUnitString, hwgroup=hwgroup, SensorFlags=SensorFlags, outName=outName, OutputType=OutputType, sensUnit=sensUnit, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, TimeStamp=TimeStamp, SensorID=SensorID, outTable=outTable, poseidon=poseidon, sensEntry=sensEntry, tsAlarmEntry=tsAlarmEntry, sensSetup=sensSetup, OnOff=OnOff, inpIndex=inpIndex, SensorState=SensorState, sensState=sensState, tsAlarmTable=tsAlarmTable, sensSetupTable=sensSetupTable, tsAlarmIdx=tsAlarmIdx, sensID=sensID, tsAlarmSensName=tsAlarmSensName, PositiveInteger=PositiveInteger, outMode=outMode, sensSetupEntry=sensSetupEntry, sensValue=sensValue, unitType=unitType, sensSetupName=sensSetupName, inpAlarmStateChanged=inpAlarmStateChanged, inpValue=inpValue, inpAlarmSetup=inpAlarmSetup, SensorName=SensorName, tsTrapAlarmEnd=tsTrapAlarmEnd, InputAlarmState=InputAlarmState, charonII=charonII, UnitType=UnitType, sensFlags=sensFlags, sensLimitMax=sensLimitMax, InputAlarmSetup=InputAlarmSetup, sensIndex=sensIndex, inpName=inpName, IOName=IOName, sensName=sensName, sensUnitString=sensUnitString, sensHysteresis=sensHysteresis, sensValueRaw=sensValueRaw, OutputMode=OutputMode, tsAlarm=tsAlarm, infoAddressMAC=infoAddressMAC, outType=outType, tsAlarmDescr=tsAlarmDescr, setup=setup, SensorValue=SensorValue, SensorString=SensorString)
