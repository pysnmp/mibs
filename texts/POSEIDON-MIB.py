...
mibBuilder.exportSymbols("POSEIDON-MIB", outName=outName, SensorFlags=SensorFlags, tsAlarmTable=tsAlarmTable, outMode=outMode, sensValue=sensValue, unitType=unitType, OnOff=OnOff, outIndex=outIndex, tsAlarmDescr=tsAlarmDescr, sensAlarmStateChanged=sensAlarmStateChanged, TimeStamp=TimeStamp, tsAlarmsPresent=tsAlarmsPresent, SensorValue=SensorValue, tsTrapAlarmStart=tsTrapAlarmStart, sensID=sensID, OutputMode=OutputMode, outTable=outTable, sensSetupEntry=sensSetupEntry, sensHysteresis=sensHysteresis, sensFlags=sensFlags, sensValueRaw=sensValueRaw, inpIndex=inpIndex, tsAlarmTime=tsAlarmTime, infoAddressMAC=infoAddressMAC, tsAlarm=tsAlarm, sensName=sensName, inpName=inpName, inpAlarmState=inpAlarmState, tsAlarmIdx=tsAlarmIdx, outType=outType, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorUnitString=SensorUnitString, SensorState=SensorState, outEntry=outEntry, tsAlarmId=tsAlarmId, PositiveInteger=PositiveInteger, sensSetup=sensSetup, sensLimitMin=sensLimitMin, inpAlarmSetup=inpAlarmSetup, tsAlarmEntry=tsAlarmEntry, IOName=IOName, SensorName=SensorName, poseidon=poseidon, inpTable=inpTable, sensSetupIndex=sensSetupIndex, InputAlarmState=InputAlarmState, sensLimitMax=sensLimitMax, sensEntry=sensEntry, inpAlarmStateChanged=inpAlarmStateChanged, setup=setup, tsAlarmSensName=tsAlarmSensName, sensState=sensState, outValue=outValue, info=info, charonII=charonII, SensorString=SensorString, InputAlarmSetup=InputAlarmSetup, sensSetupTable=sensSetupTable, UnitType=UnitType, sensSetupName=sensSetupName, sensString=sensString, sensUnitString=sensUnitString, inpValue=inpValue, inpEntry=inpEntry, sensIndex=sensIndex, SensorID=SensorID, hwgroup=hwgroup, OutputType=OutputType, sensUnit=sensUnit, sensTable=sensTable)
