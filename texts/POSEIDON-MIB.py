...
mibBuilder.exportSymbols("POSEIDON-MIB", OutputMode=OutputMode, charonII=charonII, poseidon=poseidon, tsAlarmSensName=tsAlarmSensName, SensorValue=SensorValue, sensAlarmStateChanged=sensAlarmStateChanged, outIndex=outIndex, OnOff=OnOff, inpAlarmSetup=inpAlarmSetup, outType=outType, sensValueRaw=sensValueRaw, inpTable=inpTable, TimeStamp=TimeStamp, sensTable=sensTable, sensSetup=sensSetup, tsAlarmId=tsAlarmId, tsAlarmEntry=tsAlarmEntry, tsAlarmTime=tsAlarmTime, infoAddressMAC=infoAddressMAC, SensorUnitString=SensorUnitString, inpAlarmState=inpAlarmState, outTable=outTable, tsAlarmTable=tsAlarmTable, sensSetupTable=sensSetupTable, UnitType=UnitType, inpName=inpName, outValue=outValue, inpAlarmStateChanged=inpAlarmStateChanged, InputAlarmSetup=InputAlarmSetup, SensorFlags=SensorFlags, inpIndex=inpIndex, sensLimitMax=sensLimitMax, inpEntry=inpEntry, outEntry=outEntry, unitType=unitType, IOName=IOName, SensorString=SensorString, sensValue=sensValue, setup=setup, InputAlarmState=InputAlarmState, sensFlags=sensFlags, sensEntry=sensEntry, info=info, inpValue=inpValue, tsAlarmsPresent=tsAlarmsPresent, sensSetupEntry=sensSetupEntry, tsAlarmDescr=tsAlarmDescr, sensState=sensState, sensSetupName=sensSetupName, outMode=outMode, tsAlarmIdx=tsAlarmIdx, SensorID=SensorID, tsTrapAlarmStart=tsTrapAlarmStart, SensorState=SensorState, sensUnit=sensUnit, tsAlarm=tsAlarm, outName=outName, tsTrapAlarmEnd=tsTrapAlarmEnd, sensSetupIndex=sensSetupIndex, hwgroup=hwgroup, sensLimitMin=sensLimitMin, sensName=sensName, sensString=sensString, sensUnitString=sensUnitString, sensID=sensID, sensHysteresis=sensHysteresis, sensIndex=sensIndex, OutputType=OutputType, PositiveInteger=PositiveInteger, SensorName=SensorName)
