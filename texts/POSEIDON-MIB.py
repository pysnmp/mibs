...
mibBuilder.exportSymbols("POSEIDON-MIB", sensLimitMin=sensLimitMin, charonII=charonII, sensValueRaw=sensValueRaw, TimeStamp=TimeStamp, sensIndex=sensIndex, tsAlarmId=tsAlarmId, sensUnit=sensUnit, infoAddressMAC=infoAddressMAC, unitType=unitType, tsAlarmsPresent=tsAlarmsPresent, inpEntry=inpEntry, sensSetupName=sensSetupName, IOName=IOName, sensValue=sensValue, InputAlarmState=InputAlarmState, InputAlarmSetup=InputAlarmSetup, inpTable=inpTable, outValue=outValue, sensName=sensName, tsTrapAlarmStart=tsTrapAlarmStart, sensID=sensID, tsAlarm=tsAlarm, PositiveInteger=PositiveInteger, sensSetup=sensSetup, poseidon=poseidon, inpAlarmState=inpAlarmState, SensorName=SensorName, tsAlarmIdx=tsAlarmIdx, outEntry=outEntry, OutputMode=OutputMode, OutputType=OutputType, sensAlarmStateChanged=sensAlarmStateChanged, outType=outType, UnitType=UnitType, SensorString=SensorString, tsTrapAlarmEnd=tsTrapAlarmEnd, setup=setup, tsAlarmSensName=tsAlarmSensName, sensSetupIndex=sensSetupIndex, inpName=inpName, hwgroup=hwgroup, inpValue=inpValue, sensSetupTable=sensSetupTable, outTable=outTable, outMode=outMode, sensUnitString=sensUnitString, info=info, tsAlarmEntry=tsAlarmEntry, sensEntry=sensEntry, SensorUnitString=SensorUnitString, sensLimitMax=sensLimitMax, tsAlarmTable=tsAlarmTable, tsAlarmDescr=tsAlarmDescr, sensFlags=sensFlags, sensTable=sensTable, inpAlarmStateChanged=inpAlarmStateChanged, SensorFlags=SensorFlags, sensString=sensString, SensorState=SensorState, SensorID=SensorID, SensorValue=SensorValue, inpAlarmSetup=inpAlarmSetup, inpIndex=inpIndex, OnOff=OnOff, outIndex=outIndex, outName=outName, tsAlarmTime=tsAlarmTime, sensHysteresis=sensHysteresis, sensState=sensState, sensSetupEntry=sensSetupEntry)
