...
TimeTicks, Counter64, Integer32, Counter32, ObjectIdentity, Gauge32, Bits, MibIdentifier, enterprises, iso, NotificationType, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "Integer32", "Counter32", "ObjectIdentity", "Gauge32", "Bits", "MibIdentifier", "enterprises", "iso", "NotificationType", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpValue=inpValue, sensSetupName=sensSetupName, SensorState=SensorState, PositiveInteger=PositiveInteger, SensorFlags=SensorFlags, inpEntry=inpEntry, tsAlarmDescr=tsAlarmDescr, SensorUnitString=SensorUnitString, sensSetupIndex=sensSetupIndex, hwgroup=hwgroup, tsAlarmEntry=tsAlarmEntry, sensHysteresis=sensHysteresis, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarm=tsAlarm, OutputMode=OutputMode, SensorValue=SensorValue, inpTable=inpTable, inpAlarmSetup=inpAlarmSetup, infoAddressMAC=infoAddressMAC, outValue=outValue, SensorName=SensorName, sensValue=sensValue, tsAlarmIdx=tsAlarmIdx, sensUnit=sensUnit, sensValueRaw=sensValueRaw, tsAlarmSensName=tsAlarmSensName, sensLimitMax=sensLimitMax, outName=outName, outIndex=outIndex, sensState=sensState, sensLimitMin=sensLimitMin, inpAlarmStateChanged=inpAlarmStateChanged, sensString=sensString, OnOff=OnOff, InputAlarmSetup=InputAlarmSetup, outEntry=outEntry, InputAlarmState=InputAlarmState, outMode=outMode, sensSetupEntry=sensSetupEntry, sensName=sensName, charonII=charonII, sensSetup=sensSetup, sensFlags=sensFlags, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmId=tsAlarmId, sensIndex=sensIndex, tsTrapAlarmStart=tsTrapAlarmStart, SensorID=SensorID, OutputType=OutputType, sensUnitString=sensUnitString, TimeStamp=TimeStamp, outTable=outTable, inpIndex=inpIndex, outType=outType, SensorString=SensorString, inpName=inpName, UnitType=UnitType, poseidon=poseidon, sensTable=sensTable, sensEntry=sensEntry, sensID=sensID, tsAlarmsPresent=tsAlarmsPresent, info=info, IOName=IOName, tsAlarmTable=tsAlarmTable, sensSetupTable=sensSetupTable, unitType=unitType, setup=setup, tsAlarmTime=tsAlarmTime, inpAlarmState=inpAlarmState)
