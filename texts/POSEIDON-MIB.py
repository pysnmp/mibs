...
IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, enterprises, ModuleIdentity, Integer32, NotificationType, MibIdentifier, ObjectIdentity, Unsigned32, Counter64, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "enterprises", "ModuleIdentity", "Integer32", "NotificationType", "MibIdentifier", "ObjectIdentity", "Unsigned32", "Counter64", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorValue=SensorValue, OnOff=OnOff, outMode=outMode, sensName=sensName, outType=outType, sensState=sensState, tsAlarmTable=tsAlarmTable, tsAlarmsPresent=tsAlarmsPresent, tsAlarmTime=tsAlarmTime, sensSetupIndex=sensSetupIndex, sensString=sensString, sensLimitMin=sensLimitMin, inpAlarmStateChanged=inpAlarmStateChanged, inpAlarmState=inpAlarmState, IOName=IOName, SensorFlags=SensorFlags, tsAlarmSensName=tsAlarmSensName, tsTrapAlarmStart=tsTrapAlarmStart, unitType=unitType, InputAlarmState=InputAlarmState, inpName=inpName, outValue=outValue, sensSetup=sensSetup, hwgroup=hwgroup, sensEntry=sensEntry, outIndex=outIndex, sensTable=sensTable, tsTrapAlarmEnd=tsTrapAlarmEnd, sensUnit=sensUnit, sensSetupName=sensSetupName, sensID=sensID, TimeStamp=TimeStamp, outTable=outTable, tsAlarmEntry=tsAlarmEntry, sensFlags=sensFlags, inpTable=inpTable, PositiveInteger=PositiveInteger, tsAlarmId=tsAlarmId, inpValue=inpValue, sensSetupEntry=sensSetupEntry, sensAlarmStateChanged=sensAlarmStateChanged, OutputMode=OutputMode, outEntry=outEntry, inpIndex=inpIndex, inpAlarmSetup=inpAlarmSetup, sensIndex=sensIndex, sensUnitString=sensUnitString, tsAlarm=tsAlarm, SensorState=SensorState, info=info, setup=setup, sensHysteresis=sensHysteresis, inpEntry=inpEntry, SensorString=SensorString, SensorUnitString=SensorUnitString, tsAlarmDescr=tsAlarmDescr, SensorID=SensorID, sensValue=sensValue, infoAddressMAC=infoAddressMAC, OutputType=OutputType, SensorName=SensorName, sensValueRaw=sensValueRaw, charonII=charonII, tsAlarmIdx=tsAlarmIdx, sensSetupTable=sensSetupTable, outName=outName, sensLimitMax=sensLimitMax, poseidon=poseidon, UnitType=UnitType, InputAlarmSetup=InputAlarmSetup)
