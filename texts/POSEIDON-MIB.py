...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmDescr=tsAlarmDescr, outName=outName, sensState=sensState, tsAlarmTime=tsAlarmTime, sensHysteresis=sensHysteresis, sensString=sensString, outMode=outMode, inpAlarmStateChanged=inpAlarmStateChanged, SensorFlags=SensorFlags, inpAlarmState=inpAlarmState, InputAlarmSetup=InputAlarmSetup, tsAlarmSensName=tsAlarmSensName, sensLimitMin=sensLimitMin, tsAlarmEntry=tsAlarmEntry, infoAddressMAC=infoAddressMAC, sensSetupTable=sensSetupTable, tsTrapAlarmStart=tsTrapAlarmStart, inpTable=inpTable, inpName=inpName, hwgroup=hwgroup, outValue=outValue, outTable=outTable, sensID=sensID, OnOff=OnOff, OutputMode=OutputMode, inpValue=inpValue, inpEntry=inpEntry, sensName=sensName, SensorString=SensorString, sensSetup=sensSetup, tsAlarmIdx=tsAlarmIdx, PositiveInteger=PositiveInteger, sensSetupEntry=sensSetupEntry, sensIndex=sensIndex, setup=setup, tsAlarm=tsAlarm, sensLimitMax=sensLimitMax, sensAlarmStateChanged=sensAlarmStateChanged, OutputType=OutputType, sensSetupIndex=sensSetupIndex, tsAlarmId=tsAlarmId, charonII=charonII, poseidon=poseidon, inpAlarmSetup=inpAlarmSetup, sensUnit=sensUnit, SensorID=SensorID, outIndex=outIndex, tsAlarmsPresent=tsAlarmsPresent, info=info, SensorValue=SensorValue, sensTable=sensTable, sensEntry=sensEntry, IOName=IOName, InputAlarmState=InputAlarmState, inpIndex=inpIndex, sensUnitString=sensUnitString, sensSetupName=sensSetupName, unitType=unitType, outType=outType, TimeStamp=TimeStamp, SensorName=SensorName, tsTrapAlarmEnd=tsTrapAlarmEnd, sensValue=sensValue, SensorUnitString=SensorUnitString, UnitType=UnitType, tsAlarmTable=tsAlarmTable, outEntry=outEntry, SensorState=SensorState, sensValueRaw=sensValueRaw, sensFlags=sensFlags)
