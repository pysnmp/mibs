...
MibIdentifier, Integer32, IpAddress, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, Gauge32, NotificationType, Bits, ModuleIdentity, Unsigned32, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "IpAddress", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "Gauge32", "NotificationType", "Bits", "ModuleIdentity", "Unsigned32", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpAlarmState=inpAlarmState, InputAlarmSetup=InputAlarmSetup, sensLimitMax=sensLimitMax, outTable=outTable, sensString=sensString, SensorState=SensorState, tsAlarmTable=tsAlarmTable, unitType=unitType, SensorUnitString=SensorUnitString, SensorName=SensorName, sensAlarmStateChanged=sensAlarmStateChanged, hwgroup=hwgroup, SensorString=SensorString, inpAlarmSetup=inpAlarmSetup, UnitType=UnitType, sensUnitString=sensUnitString, sensSetup=sensSetup, sensValue=sensValue, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmTime=tsAlarmTime, tsAlarmsPresent=tsAlarmsPresent, tsAlarmId=tsAlarmId, outValue=outValue, sensEntry=sensEntry, sensFlags=sensFlags, inpAlarmStateChanged=inpAlarmStateChanged, outType=outType, outEntry=outEntry, OutputType=OutputType, sensSetupEntry=sensSetupEntry, inpEntry=inpEntry, poseidon=poseidon, PositiveInteger=PositiveInteger, SensorFlags=SensorFlags, IOName=IOName, TimeStamp=TimeStamp, outName=outName, sensValueRaw=sensValueRaw, tsAlarmSensName=tsAlarmSensName, InputAlarmState=InputAlarmState, OnOff=OnOff, infoAddressMAC=infoAddressMAC, sensSetupIndex=sensSetupIndex, sensLimitMin=sensLimitMin, info=info, sensIndex=sensIndex, SensorID=SensorID, sensState=sensState, outMode=outMode, tsAlarmEntry=tsAlarmEntry, sensHysteresis=sensHysteresis, sensID=sensID, outIndex=outIndex, tsTrapAlarmEnd=tsTrapAlarmEnd, charonII=charonII, sensUnit=sensUnit, inpValue=inpValue, inpName=inpName, inpTable=inpTable, tsAlarmIdx=tsAlarmIdx, sensSetupTable=sensSetupTable, sensSetupName=sensSetupName, tsAlarm=tsAlarm, SensorValue=SensorValue, OutputMode=OutputMode, setup=setup, inpIndex=inpIndex, tsAlarmDescr=tsAlarmDescr, sensName=sensName, sensTable=sensTable)
