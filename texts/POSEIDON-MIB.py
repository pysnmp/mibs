...
mibBuilder.exportSymbols("POSEIDON-MIB", outMode=outMode, IOName=IOName, inpIndex=inpIndex, inpAlarmSetup=inpAlarmSetup, sensUnitString=sensUnitString, tsAlarmEntry=tsAlarmEntry, sensSetup=sensSetup, sensHysteresis=sensHysteresis, outIndex=outIndex, SensorValue=SensorValue, sensState=sensState, inpEntry=inpEntry, unitType=unitType, sensSetupTable=sensSetupTable, sensLimitMax=sensLimitMax, UnitType=UnitType, inpName=inpName, tsAlarmsPresent=tsAlarmsPresent, InputAlarmState=InputAlarmState, inpTable=inpTable, sensName=sensName, inpValue=inpValue, OutputType=OutputType, outTable=outTable, tsAlarmDescr=tsAlarmDescr, tsAlarmTime=tsAlarmTime, SensorState=SensorState, setup=setup, tsAlarmIdx=tsAlarmIdx, OnOff=OnOff, InputAlarmSetup=InputAlarmSetup, SensorUnitString=SensorUnitString, tsAlarmTable=tsAlarmTable, sensSetupName=sensSetupName, SensorFlags=SensorFlags, sensUnit=sensUnit, hwgroup=hwgroup, outValue=outValue, outType=outType, tsAlarmId=tsAlarmId, sensLimitMin=sensLimitMin, SensorString=SensorString, inpAlarmState=inpAlarmState, sensFlags=sensFlags, sensID=sensID, poseidon=poseidon, sensValue=sensValue, tsTrapAlarmEnd=tsTrapAlarmEnd, sensIndex=sensIndex, sensAlarmStateChanged=sensAlarmStateChanged, info=info, OutputMode=OutputMode, sensTable=sensTable, outName=outName, sensSetupIndex=sensSetupIndex, charonII=charonII, outEntry=outEntry, tsTrapAlarmStart=tsTrapAlarmStart, sensEntry=sensEntry, tsAlarmSensName=tsAlarmSensName, PositiveInteger=PositiveInteger, TimeStamp=TimeStamp, inpAlarmStateChanged=inpAlarmStateChanged, infoAddressMAC=infoAddressMAC, sensString=sensString, sensSetupEntry=sensSetupEntry, tsAlarm=tsAlarm, SensorID=SensorID, SensorName=SensorName, sensValueRaw=sensValueRaw)
