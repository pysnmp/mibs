...
iso, TimeTicks, enterprises, Bits, MibIdentifier, Counter32, Counter64, ModuleIdentity, ObjectIdentity, Unsigned32, Integer32, Gauge32, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "enterprises", "Bits", "MibIdentifier", "Counter32", "Counter64", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "Integer32", "Gauge32", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("POSEIDON-MIB", inpName=inpName, sensSetupTable=sensSetupTable, sensFlags=sensFlags, SensorState=SensorState, charonII=charonII, inpAlarmState=inpAlarmState, outValue=outValue, tsAlarmId=tsAlarmId, unitType=unitType, inpIndex=inpIndex, SensorID=SensorID, tsAlarmDescr=tsAlarmDescr, sensEntry=sensEntry, infoAddressMAC=infoAddressMAC, sensValue=sensValue, sensValueRaw=sensValueRaw, InputAlarmState=InputAlarmState, outEntry=outEntry, SensorString=SensorString, sensHysteresis=sensHysteresis, tsAlarmTable=tsAlarmTable, tsAlarmEntry=tsAlarmEntry, info=info, inpAlarmStateChanged=inpAlarmStateChanged, sensAlarmStateChanged=sensAlarmStateChanged, sensState=sensState, outTable=outTable, inpEntry=inpEntry, sensSetupIndex=sensSetupIndex, OutputMode=OutputMode, SensorFlags=SensorFlags, outIndex=outIndex, tsAlarmsPresent=tsAlarmsPresent, OutputType=OutputType, tsAlarmSensName=tsAlarmSensName, sensSetupEntry=sensSetupEntry, outName=outName, sensLimitMin=sensLimitMin, tsTrapAlarmEnd=tsTrapAlarmEnd, sensIndex=sensIndex, outMode=outMode, sensSetup=sensSetup, SensorValue=SensorValue, inpTable=inpTable, poseidon=poseidon, tsAlarmIdx=tsAlarmIdx, sensLimitMax=sensLimitMax, IOName=IOName, sensName=sensName, tsTrapAlarmStart=tsTrapAlarmStart, inpAlarmSetup=inpAlarmSetup, tsAlarmTime=tsAlarmTime, sensID=sensID, TimeStamp=TimeStamp, sensUnitString=sensUnitString, SensorName=SensorName, setup=setup, sensTable=sensTable, sensSetupName=sensSetupName, inpValue=inpValue, outType=outType, SensorUnitString=SensorUnitString, UnitType=UnitType, PositiveInteger=PositiveInteger, sensString=sensString, sensUnit=sensUnit, InputAlarmSetup=InputAlarmSetup, tsAlarm=tsAlarm, hwgroup=hwgroup, OnOff=OnOff)
