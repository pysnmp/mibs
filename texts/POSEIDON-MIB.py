...
NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, Counter64, iso, ObjectIdentity, IpAddress, MibIdentifier, Counter32, ModuleIdentity, Unsigned32, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "Counter64", "iso", "ObjectIdentity", "IpAddress", "MibIdentifier", "Counter32", "ModuleIdentity", "Unsigned32", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", outTable=outTable, UnitType=UnitType, OutputType=OutputType, SensorID=SensorID, outType=outType, sensLimitMax=sensLimitMax, TimeStamp=TimeStamp, info=info, sensState=sensState, inpIndex=inpIndex, sensSetupEntry=sensSetupEntry, IOName=IOName, tsAlarmSensName=tsAlarmSensName, sensFlags=sensFlags, outMode=outMode, outEntry=outEntry, sensAlarmStateChanged=sensAlarmStateChanged, sensSetup=sensSetup, tsAlarmDescr=tsAlarmDescr, SensorUnitString=SensorUnitString, inpValue=inpValue, sensUnit=sensUnit, tsTrapAlarmEnd=tsTrapAlarmEnd, SensorName=SensorName, charonII=charonII, tsAlarm=tsAlarm, tsAlarmsPresent=tsAlarmsPresent, OutputMode=OutputMode, tsAlarmTable=tsAlarmTable, SensorFlags=SensorFlags, inpEntry=inpEntry, sensUnitString=sensUnitString, sensValue=sensValue, inpAlarmStateChanged=inpAlarmStateChanged, SensorValue=SensorValue, sensEntry=sensEntry, tsAlarmTime=tsAlarmTime, sensSetupTable=sensSetupTable, inpTable=inpTable, hwgroup=hwgroup, sensTable=sensTable, poseidon=poseidon, outName=outName, tsAlarmIdx=tsAlarmIdx, outValue=outValue, infoAddressMAC=infoAddressMAC, sensSetupName=sensSetupName, tsTrapAlarmStart=tsTrapAlarmStart, OnOff=OnOff, inpAlarmSetup=inpAlarmSetup, sensID=sensID, inpName=inpName, tsAlarmEntry=tsAlarmEntry, InputAlarmSetup=InputAlarmSetup, SensorString=SensorString, sensName=sensName, sensString=sensString, sensIndex=sensIndex, sensValueRaw=sensValueRaw, tsAlarmId=tsAlarmId, sensSetupIndex=sensSetupIndex, sensHysteresis=sensHysteresis, inpAlarmState=inpAlarmState, SensorState=SensorState, outIndex=outIndex, sensLimitMin=sensLimitMin, setup=setup, unitType=unitType, InputAlarmState=InputAlarmState, PositiveInteger=PositiveInteger)
