...
ObjectIdentity, Integer32, Counter32, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, NotificationType, IpAddress, Unsigned32, TimeTicks, Counter64, Bits, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "Counter32", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "NotificationType", "IpAddress", "Unsigned32", "TimeTicks", "Counter64", "Bits", "iso")
...
mibBuilder.exportSymbols("POSEIDON-MIB", poseidon=poseidon, outName=outName, sensSetupEntry=sensSetupEntry, UnitType=UnitType, InputAlarmSetup=InputAlarmSetup, OutputMode=OutputMode, SensorFlags=SensorFlags, sensSetupName=sensSetupName, sensLimitMax=sensLimitMax, SensorID=SensorID, tsAlarmIdx=tsAlarmIdx, sensHysteresis=sensHysteresis, TimeStamp=TimeStamp, outIndex=outIndex, charonII=charonII, sensSetupIndex=sensSetupIndex, info=info, SensorString=SensorString, sensString=sensString, tsAlarmTable=tsAlarmTable, OutputType=OutputType, tsTrapAlarmStart=tsTrapAlarmStart, unitType=unitType, inpAlarmState=inpAlarmState, sensName=sensName, SensorName=SensorName, SensorState=SensorState, inpEntry=inpEntry, sensEntry=sensEntry, OnOff=OnOff, setup=setup, sensIndex=sensIndex, sensAlarmStateChanged=sensAlarmStateChanged, inpIndex=inpIndex, outEntry=outEntry, inpName=inpName, inpTable=inpTable, tsTrapAlarmEnd=tsTrapAlarmEnd, tsAlarmTime=tsAlarmTime, inpValue=inpValue, inpAlarmSetup=inpAlarmSetup, sensState=sensState, outValue=outValue, infoAddressMAC=infoAddressMAC, SensorValue=SensorValue, sensValueRaw=sensValueRaw, IOName=IOName, tsAlarmSensName=tsAlarmSensName, tsAlarmEntry=tsAlarmEntry, sensFlags=sensFlags, sensLimitMin=sensLimitMin, sensSetup=sensSetup, outMode=outMode, tsAlarmId=tsAlarmId, tsAlarmsPresent=tsAlarmsPresent, SensorUnitString=SensorUnitString, tsAlarm=tsAlarm, InputAlarmState=InputAlarmState, hwgroup=hwgroup, sensUnitString=sensUnitString, sensValue=sensValue, inpAlarmStateChanged=inpAlarmStateChanged, sensTable=sensTable, outType=outType, sensUnit=sensUnit, PositiveInteger=PositiveInteger, sensID=sensID, outTable=outTable, tsAlarmDescr=tsAlarmDescr, sensSetupTable=sensSetupTable)
