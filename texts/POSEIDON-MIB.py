...
Integer32, Gauge32, Counter64, TimeTicks, ObjectIdentity, iso, NotificationType, IpAddress, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, ModuleIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "Counter64", "TimeTicks", "ObjectIdentity", "iso", "NotificationType", "IpAddress", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "ModuleIdentity", "enterprises")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensFlags=sensFlags, SensorUnitString=SensorUnitString, TimeStamp=TimeStamp, tsAlarmsPresent=tsAlarmsPresent, tsAlarmId=tsAlarmId, tsAlarmDescr=tsAlarmDescr, sensLimitMin=sensLimitMin, setup=setup, sensState=sensState, sensTable=sensTable, outIndex=outIndex, inpEntry=inpEntry, tsAlarmTable=tsAlarmTable, info=info, OnOff=OnOff, tsAlarmSensName=tsAlarmSensName, tsAlarmTime=tsAlarmTime, sensSetupIndex=sensSetupIndex, sensValue=sensValue, InputAlarmState=InputAlarmState, tsAlarmIdx=tsAlarmIdx, sensLimitMax=sensLimitMax, UnitType=UnitType, inpName=inpName, sensUnit=sensUnit, sensHysteresis=sensHysteresis, SensorState=SensorState, SensorName=SensorName, SensorValue=SensorValue, SensorID=SensorID, inpIndex=inpIndex, InputAlarmSetup=InputAlarmSetup, inpAlarmSetup=inpAlarmSetup, OutputType=OutputType, inpValue=inpValue, tsAlarm=tsAlarm, sensEntry=sensEntry, sensSetupTable=sensSetupTable, PositiveInteger=PositiveInteger, outTable=outTable, infoAddressMAC=infoAddressMAC, sensSetup=sensSetup, inpAlarmState=inpAlarmState, sensSetupName=sensSetupName, unitType=unitType, sensAlarmStateChanged=sensAlarmStateChanged, poseidon=poseidon, sensName=sensName, inpTable=inpTable, sensID=sensID, outType=outType, tsTrapAlarmEnd=tsTrapAlarmEnd, sensValueRaw=sensValueRaw, inpAlarmStateChanged=inpAlarmStateChanged, hwgroup=hwgroup, tsTrapAlarmStart=tsTrapAlarmStart, IOName=IOName, charonII=charonII, outEntry=outEntry, sensIndex=sensIndex, outName=outName, sensUnitString=sensUnitString, SensorString=SensorString, SensorFlags=SensorFlags, sensString=sensString, OutputMode=OutputMode, outMode=outMode, outValue=outValue, tsAlarmEntry=tsAlarmEntry, sensSetupEntry=sensSetupEntry)
