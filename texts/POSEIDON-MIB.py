...
enterprises, Unsigned32, Integer32, Gauge32, iso, Counter32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, ObjectIdentity, IpAddress, MibIdentifier, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Unsigned32", "Integer32", "Gauge32", "iso", "Counter32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "ObjectIdentity", "IpAddress", "MibIdentifier", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensHysteresis=sensHysteresis, outType=outType, SensorName=SensorName, outEntry=outEntry, outMode=outMode, outTable=outTable, sensEntry=sensEntry, sensID=sensID, infoAddressMAC=infoAddressMAC, sensIndex=sensIndex, SensorValue=SensorValue, sensString=sensString, sensSetup=sensSetup, tsTrapAlarmEnd=tsTrapAlarmEnd, sensSetupIndex=sensSetupIndex, tsAlarm=tsAlarm, SensorFlags=SensorFlags, tsAlarmIdx=tsAlarmIdx, outIndex=outIndex, tsAlarmsPresent=tsAlarmsPresent, sensFlags=sensFlags, inpAlarmStateChanged=inpAlarmStateChanged, sensSetupTable=sensSetupTable, inpAlarmState=inpAlarmState, sensUnit=sensUnit, PositiveInteger=PositiveInteger, TimeStamp=TimeStamp, outValue=outValue, OutputMode=OutputMode, inpAlarmSetup=inpAlarmSetup, sensName=sensName, tsAlarmEntry=tsAlarmEntry, tsAlarmDescr=tsAlarmDescr, tsAlarmTable=tsAlarmTable, InputAlarmState=InputAlarmState, OutputType=OutputType, sensState=sensState, SensorID=SensorID, poseidon=poseidon, inpEntry=inpEntry, inpValue=inpValue, charonII=charonII, info=info, sensValue=sensValue, sensAlarmStateChanged=sensAlarmStateChanged, tsAlarmTime=tsAlarmTime, sensValueRaw=sensValueRaw, inpIndex=inpIndex, sensLimitMax=sensLimitMax, tsTrapAlarmStart=tsTrapAlarmStart, unitType=unitType, inpName=inpName, UnitType=UnitType, inpTable=inpTable, setup=setup, sensSetupName=sensSetupName, hwgroup=hwgroup, tsAlarmSensName=tsAlarmSensName, SensorState=SensorState, sensTable=sensTable, sensSetupEntry=sensSetupEntry, InputAlarmSetup=InputAlarmSetup, IOName=IOName, outName=outName, sensUnitString=sensUnitString, tsAlarmId=tsAlarmId, OnOff=OnOff, sensLimitMin=sensLimitMin, SensorString=SensorString, SensorUnitString=SensorUnitString)
