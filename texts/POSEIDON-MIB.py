...
Gauge32, Integer32, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, enterprises, ObjectIdentity, Counter64, MibIdentifier, iso, Bits, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "enterprises", "ObjectIdentity", "Counter64", "MibIdentifier", "iso", "Bits", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", tsAlarmTable=tsAlarmTable, outName=outName, OutputType=OutputType, sensFlags=sensFlags, SensorString=SensorString, SensorFlags=SensorFlags, tsAlarmIdx=tsAlarmIdx, unitType=unitType, SensorUnitString=SensorUnitString, outTable=outTable, outValue=outValue, IOName=IOName, PositiveInteger=PositiveInteger, tsAlarmEntry=tsAlarmEntry, sensIndex=sensIndex, tsAlarmTime=tsAlarmTime, sensHysteresis=sensHysteresis, sensName=sensName, infoAddressMAC=infoAddressMAC, SensorValue=SensorValue, sensLimitMin=sensLimitMin, OnOff=OnOff, inpAlarmState=inpAlarmState, outType=outType, tsTrapAlarmEnd=tsTrapAlarmEnd, sensAlarmStateChanged=sensAlarmStateChanged, charonII=charonII, sensTable=sensTable, outEntry=outEntry, hwgroup=hwgroup, inpEntry=inpEntry, sensSetup=sensSetup, SensorState=SensorState, poseidon=poseidon, OutputMode=OutputMode, outMode=outMode, sensID=sensID, info=info, tsAlarm=tsAlarm, InputAlarmState=InputAlarmState, sensSetupIndex=sensSetupIndex, SensorID=SensorID, setup=setup, sensSetupEntry=sensSetupEntry, sensString=sensString, sensValue=sensValue, inpName=inpName, InputAlarmSetup=InputAlarmSetup, inpValue=inpValue, sensUnit=sensUnit, tsTrapAlarmStart=tsTrapAlarmStart, TimeStamp=TimeStamp, inpAlarmSetup=inpAlarmSetup, sensValueRaw=sensValueRaw, sensSetupTable=sensSetupTable, inpIndex=inpIndex, sensEntry=sensEntry, sensUnitString=sensUnitString, UnitType=UnitType, SensorName=SensorName, outIndex=outIndex, tsAlarmSensName=tsAlarmSensName, tsAlarmsPresent=tsAlarmsPresent, sensSetupName=sensSetupName, inpAlarmStateChanged=inpAlarmStateChanged, sensState=sensState, sensLimitMax=sensLimitMax, tsAlarmDescr=tsAlarmDescr, inpTable=inpTable, tsAlarmId=tsAlarmId)
