...
ModuleIdentity, Counter64, NotificationType, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, MibIdentifier, Integer32, TimeTicks, enterprises, iso, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "NotificationType", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "MibIdentifier", "Integer32", "TimeTicks", "enterprises", "iso", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensValue=sensValue, inpEntry=inpEntry, SensorState=SensorState, poseidon=poseidon, sensAlarmStateChanged=sensAlarmStateChanged, SensorID=SensorID, SensorString=SensorString, tsAlarmIdx=tsAlarmIdx, sensTable=sensTable, UnitType=UnitType, inpIndex=inpIndex, tsAlarm=tsAlarm, sensSetupIndex=sensSetupIndex, TimeStamp=TimeStamp, tsAlarmsPresent=tsAlarmsPresent, tsTrapAlarmStart=tsTrapAlarmStart, setup=setup, SensorName=SensorName, sensValueRaw=sensValueRaw, PositiveInteger=PositiveInteger, sensIndex=sensIndex, sensSetupTable=sensSetupTable, sensString=sensString, info=info, InputAlarmState=InputAlarmState, outIndex=outIndex, sensSetupName=sensSetupName, inpAlarmSetup=inpAlarmSetup, outMode=outMode, inpAlarmState=inpAlarmState, sensSetupEntry=sensSetupEntry, charonII=charonII, sensEntry=sensEntry, sensLimitMin=sensLimitMin, sensName=sensName, tsAlarmTable=tsAlarmTable, inpValue=inpValue, SensorUnitString=SensorUnitString, outTable=outTable, outType=outType, inpTable=inpTable, tsAlarmDescr=tsAlarmDescr, outValue=outValue, infoAddressMAC=infoAddressMAC, sensState=sensState, sensFlags=sensFlags, sensID=sensID, OutputMode=OutputMode, outName=outName, SensorFlags=SensorFlags, tsTrapAlarmEnd=tsTrapAlarmEnd, outEntry=outEntry, sensHysteresis=sensHysteresis, sensLimitMax=sensLimitMax, inpName=inpName, IOName=IOName, OutputType=OutputType, sensUnit=sensUnit, inpAlarmStateChanged=inpAlarmStateChanged, InputAlarmSetup=InputAlarmSetup, sensUnitString=sensUnitString, sensSetup=sensSetup, OnOff=OnOff, SensorValue=SensorValue, tsAlarmId=tsAlarmId, tsAlarmSensName=tsAlarmSensName, tsAlarmEntry=tsAlarmEntry, hwgroup=hwgroup, unitType=unitType, tsAlarmTime=tsAlarmTime)
