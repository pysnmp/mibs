...
Integer32, Gauge32, enterprises, Bits, Counter64, Unsigned32, ModuleIdentity, iso, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "enterprises", "Bits", "Counter64", "Unsigned32", "ModuleIdentity", "iso", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorString=SensorString, SensorName=SensorName, inpAlarmStateChanged=inpAlarmStateChanged, UnitType=UnitType, sensEntry=sensEntry, tsTrapAlarmStart=tsTrapAlarmStart, outIndex=outIndex, SensorID=SensorID, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmEnd=tsTrapAlarmEnd, inpValue=inpValue, inpAlarmState=inpAlarmState, sensSetupIndex=sensSetupIndex, sensTable=sensTable, sensValue=sensValue, outEntry=outEntry, sensSetupEntry=sensSetupEntry, outValue=outValue, sensFlags=sensFlags, OnOff=OnOff, sensUnit=sensUnit, tsAlarm=tsAlarm, IOName=IOName, outType=outType, hwgroup=hwgroup, tsAlarmIdx=tsAlarmIdx, tsAlarmId=tsAlarmId, TimeStamp=TimeStamp, inpIndex=inpIndex, unitType=unitType, info=info, PositiveInteger=PositiveInteger, SensorState=SensorState, InputAlarmSetup=InputAlarmSetup, SensorFlags=SensorFlags, outName=outName, outMode=outMode, tsAlarmTime=tsAlarmTime, sensLimitMin=sensLimitMin, sensID=sensID, OutputType=OutputType, setup=setup, tsAlarmTable=tsAlarmTable, sensUnitString=sensUnitString, sensString=sensString, sensSetupTable=sensSetupTable, sensHysteresis=sensHysteresis, inpName=inpName, infoAddressMAC=infoAddressMAC, SensorUnitString=SensorUnitString, poseidon=poseidon, inpEntry=inpEntry, InputAlarmState=InputAlarmState, tsAlarmEntry=tsAlarmEntry, tsAlarmDescr=tsAlarmDescr, inpAlarmSetup=inpAlarmSetup, OutputMode=OutputMode, sensState=sensState, charonII=charonII, sensLimitMax=sensLimitMax, outTable=outTable, sensSetup=sensSetup, sensValueRaw=sensValueRaw, sensIndex=sensIndex, sensName=sensName, SensorValue=SensorValue, tsAlarmsPresent=tsAlarmsPresent, sensSetupName=sensSetupName, inpTable=inpTable, tsAlarmSensName=tsAlarmSensName)
