...
Counter32, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, TimeTicks, enterprises, Counter64, NotificationType, ObjectIdentity, Bits, MibIdentifier, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "TimeTicks", "enterprises", "Counter64", "NotificationType", "ObjectIdentity", "Bits", "MibIdentifier", "iso", "Gauge32")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorName=SensorName, sensSetupEntry=sensSetupEntry, hwgroup=hwgroup, SensorState=SensorState, inpIndex=inpIndex, OutputType=OutputType, tsAlarmDescr=tsAlarmDescr, sensString=sensString, sensAlarmStateChanged=sensAlarmStateChanged, sensName=sensName, sensUnitString=sensUnitString, inpTable=inpTable, outTable=outTable, tsAlarmIdx=tsAlarmIdx, sensState=sensState, PositiveInteger=PositiveInteger, SensorUnitString=SensorUnitString, outEntry=outEntry, OnOff=OnOff, sensSetupIndex=sensSetupIndex, inpValue=inpValue, inpName=inpName, sensID=sensID, tsAlarm=tsAlarm, OutputMode=OutputMode, outIndex=outIndex, sensSetupTable=sensSetupTable, SensorFlags=SensorFlags, sensHysteresis=sensHysteresis, InputAlarmSetup=InputAlarmSetup, tsAlarmEntry=tsAlarmEntry, outName=outName, IOName=IOName, SensorString=SensorString, infoAddressMAC=infoAddressMAC, sensIndex=sensIndex, tsAlarmTime=tsAlarmTime, sensSetup=sensSetup, sensValueRaw=sensValueRaw, sensSetupName=sensSetupName, sensUnit=sensUnit, inpAlarmStateChanged=inpAlarmStateChanged, inpAlarmState=inpAlarmState, outType=outType, sensTable=sensTable, outMode=outMode, unitType=unitType, SensorValue=SensorValue, tsAlarmTable=tsAlarmTable, tsAlarmId=tsAlarmId, InputAlarmState=InputAlarmState, inpAlarmSetup=inpAlarmSetup, tsAlarmSensName=tsAlarmSensName, SensorID=SensorID, sensFlags=sensFlags, sensLimitMin=sensLimitMin, UnitType=UnitType, poseidon=poseidon, sensEntry=sensEntry, tsTrapAlarmStart=tsTrapAlarmStart, tsTrapAlarmEnd=tsTrapAlarmEnd, TimeStamp=TimeStamp, setup=setup, outValue=outValue, tsAlarmsPresent=tsAlarmsPresent, charonII=charonII, sensLimitMax=sensLimitMax, sensValue=sensValue, info=info, inpEntry=inpEntry)
