...
enterprises, MibIdentifier, Bits, ObjectIdentity, Unsigned32, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, ModuleIdentity, Gauge32, iso, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "Bits", "ObjectIdentity", "Unsigned32", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "ModuleIdentity", "Gauge32", "iso", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("POSEIDON-MIB", SensorName=SensorName, sensName=sensName, outEntry=outEntry, inpValue=inpValue, IOName=IOName, info=info, SensorID=SensorID, setup=setup, unitType=unitType, charonII=charonII, inpAlarmState=inpAlarmState, InputAlarmState=InputAlarmState, inpAlarmSetup=inpAlarmSetup, outType=outType, tsAlarmEntry=tsAlarmEntry, sensSetup=sensSetup, hwgroup=hwgroup, sensSetupTable=sensSetupTable, inpName=inpName, sensLimitMin=sensLimitMin, TimeStamp=TimeStamp, sensID=sensID, SensorState=SensorState, UnitType=UnitType, tsAlarm=tsAlarm, tsTrapAlarmEnd=tsTrapAlarmEnd, outMode=outMode, sensUnit=sensUnit, sensEntry=sensEntry, tsAlarmId=tsAlarmId, sensValue=sensValue, sensFlags=sensFlags, inpAlarmStateChanged=inpAlarmStateChanged, infoAddressMAC=infoAddressMAC, sensLimitMax=sensLimitMax, sensAlarmStateChanged=sensAlarmStateChanged, outIndex=outIndex, tsAlarmTable=tsAlarmTable, poseidon=poseidon, OutputMode=OutputMode, PositiveInteger=PositiveInteger, sensValueRaw=sensValueRaw, inpTable=inpTable, sensSetupIndex=sensSetupIndex, sensSetupName=sensSetupName, outName=outName, sensTable=sensTable, SensorUnitString=SensorUnitString, tsTrapAlarmStart=tsTrapAlarmStart, tsAlarmDescr=tsAlarmDescr, sensString=sensString, sensState=sensState, tsAlarmsPresent=tsAlarmsPresent, inpEntry=inpEntry, sensSetupEntry=sensSetupEntry, InputAlarmSetup=InputAlarmSetup, SensorValue=SensorValue, outTable=outTable, sensHysteresis=sensHysteresis, sensIndex=sensIndex, tsAlarmSensName=tsAlarmSensName, tsAlarmTime=tsAlarmTime, inpIndex=inpIndex, SensorFlags=SensorFlags, outValue=outValue, OnOff=OnOff, SensorString=SensorString, sensUnitString=sensUnitString, tsAlarmIdx=tsAlarmIdx, OutputType=OutputType)
