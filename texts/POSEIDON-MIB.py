...
NotificationType, TimeTicks, IpAddress, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, Integer32, ModuleIdentity, iso, MibIdentifier, Counter32, enterprises, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "IpAddress", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "Integer32", "ModuleIdentity", "iso", "MibIdentifier", "Counter32", "enterprises", "Bits")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensSetupTable=sensSetupTable, SensorUnitString=SensorUnitString, tsAlarmSensName=tsAlarmSensName, info=info, SensorState=SensorState, inpName=inpName, sensTable=sensTable, tsAlarmTable=tsAlarmTable, sensName=sensName, tsAlarm=tsAlarm, tsAlarmDescr=tsAlarmDescr, SensorName=SensorName, sensValue=sensValue, outMode=outMode, inpAlarmSetup=inpAlarmSetup, sensState=sensState, TimeStamp=TimeStamp, tsTrapAlarmEnd=tsTrapAlarmEnd, charonII=charonII, infoAddressMAC=infoAddressMAC, tsAlarmId=tsAlarmId, PositiveInteger=PositiveInteger, outType=outType, IOName=IOName, sensString=sensString, sensUnit=sensUnit, poseidon=poseidon, outEntry=outEntry, outName=outName, sensValueRaw=sensValueRaw, sensEntry=sensEntry, sensFlags=sensFlags, OutputType=OutputType, OutputMode=OutputMode, sensID=sensID, sensAlarmStateChanged=sensAlarmStateChanged, tsTrapAlarmStart=tsTrapAlarmStart, outIndex=outIndex, sensLimitMax=sensLimitMax, InputAlarmSetup=InputAlarmSetup, InputAlarmState=InputAlarmState, hwgroup=hwgroup, inpValue=inpValue, SensorString=SensorString, sensSetupEntry=sensSetupEntry, sensHysteresis=sensHysteresis, sensIndex=sensIndex, unitType=unitType, UnitType=UnitType, tsAlarmEntry=tsAlarmEntry, SensorValue=SensorValue, inpTable=inpTable, sensSetup=sensSetup, tsAlarmIdx=tsAlarmIdx, OnOff=OnOff, SensorID=SensorID, inpIndex=inpIndex, outValue=outValue, sensSetupIndex=sensSetupIndex, inpEntry=inpEntry, inpAlarmState=inpAlarmState, setup=setup, outTable=outTable, tsAlarmsPresent=tsAlarmsPresent, sensSetupName=sensSetupName, inpAlarmStateChanged=inpAlarmStateChanged, tsAlarmTime=tsAlarmTime, sensUnitString=sensUnitString, SensorFlags=SensorFlags, sensLimitMin=sensLimitMin)
