...
mibBuilder.exportSymbols("NAT-MIB", natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natAddressMappingCreations=natAddressMappingCreations, natInterfaceServiceType=natInterfaceServiceType, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natStatsAddrMapGroup=natStatsAddrMapGroup, NatTranslationEntity=NatTranslationEntity, natInterfaceEntry=natInterfaceEntry, natPoolRangeType=natPoolRangeType, NatBindIdOrZero=NatBindIdOrZero, natSessionPublicAddrType=natSessionPublicAddrType, natPoolRangePoolIndex=natPoolRangePoolIndex, natMapIntAddrExt=natMapIntAddrExt, natNotifCtrl=natNotifCtrl, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natAddrBindInTranslates=natAddrBindInTranslates, natL4ProtocolTable=natL4ProtocolTable, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natMappingExtPort=natMappingExtPort, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, SubscriberIndex=SubscriberIndex, NatBindId=NatBindId, natAddrMapEntry=natAddrMapEntry, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natProtocolTable=natProtocolTable, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, VlanIndexOrZero=VlanIndexOrZero, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natOutOfPortErrors=natOutOfPortErrors, natLimitSubscribers=natLimitSubscribers, natMapObjects=natMapObjects, NatAddrMapId=NatAddrMapId, natStatsProtocolGroup=natStatsProtocolGroup, natPoolRangeDeallocations=natPoolRangeDeallocations, natMIBNotificationGroup=natMIBNotificationGroup, natProtocol=natProtocol, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natSubscriberIdentifierType=natSubscriberIdentifierType, natLimitsTable=natLimitsTable, natMIBCompliances=natMIBCompliances, natAddrPortBindSessions=natAddrPortBindSessions, natConfigGroup=natConfigGroup, natAddrMapTable=natAddrMapTable, natInstanceEntry=natInstanceEntry, natMIBFullCompliance=natMIBFullCompliance, natAddrBindType=natAddrBindType, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natNotifThrottlingInterval=natNotifThrottlingInterval, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natMappingIntPort=natMappingIntPort, natBasicStatefulCompliance=natBasicStatefulCompliance, natTcpDefNegTimeout=natTcpDefNegTimeout, natAddrMapName=natAddrMapName, natMappingIntAddressType=natMappingIntAddressType, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natAddrMapStorageType=natAddrMapStorageType, natAddressMappingRemovals=natAddressMappingRemovals, natAddrPortBindTable=natAddrPortBindTable, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natInterfaceDiscards=natInterfaceDiscards, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natProtocolEntry=natProtocolEntry, natCGNCompliance=natCGNCompliance, natAddrBindMapIndex=natAddrBindMapIndex, natMappingIntAddress=natMappingIntAddress, natMappingExtAddressType=natMappingExtAddressType, NatPoolingType=NatPoolingType, natPoolObjects=natPoolObjects, natPoolTable=natPoolTable, natPoolPortMax=natPoolPortMax, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natPoolRangeAllocations=natPoolRangeAllocations, NatSessionId=NatSessionId, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, PYSNMP_MODULE_ID=natMIB, natSessionMaxIdleTime=natSessionMaxIdleTime, natL4ProtocolTranslations=natL4ProtocolTranslations, natSubscribers=natSubscribers, natMIBGroups=natMIBGroups, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natSessionIndex=natSessionIndex, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natMappingPool=natMappingPool, natSessionPrivateAddrType=natSessionPrivateAddrType, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natNotifMappings=natNotifMappings, natAddrPortBindType=natAddrPortBindType, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natMappingFilterBehavior=natMappingFilterBehavior, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natCountersEntry=natCountersEntry, natAddrBindEntry=natAddrBindEntry, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natLimitFragments=natLimitFragments, natPoolRealm=natPoolRealm, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natSessionInTranslates=natSessionInTranslates, natMapIntAddrIntType=natMapIntAddrIntType, natMappingTable=natMappingTable, NatBindMode=NatBindMode, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natMappingEntry=natMappingEntry, natFragmentsCompliance=natFragmentsCompliance, natSessionUpTime=natSessionUpTime, natSessionProtocolType=natSessionProtocolType, natGroupAddrMapObjects=natGroupAddrMapObjects, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natNotifSubscriberMappings=natNotifSubscriberMappings, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natSubscriberMappingRemovals=natSubscriberMappingRemovals, SubscriberIdentifierType=SubscriberIdentifierType, natDefTimeouts=natDefTimeouts, natSessionEntry=natSessionEntry, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natPoolPortMin=natPoolPortMin, natGroupBasicNotifications=natGroupBasicNotifications, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natMappingIntRealm=natMappingIntRealm, natCountersTable=natCountersTable, natSubscriberMappingCreations=natSubscriberMappingCreations, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natPoolRangeEnd=natPoolRangeEnd, natSubscriberRealm=natSubscriberRealm, NatPoolId=NatPoolId, natAddrBindSessions=natAddrBindSessions, natSubscriberResourceErrors=natSubscriberResourceErrors, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natMapIntAddrTable=natMapIntAddrTable, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natMapIntAddrInt=natMapIntAddrInt, natSubsInterfaceIndex=natSubsInterfaceIndex, natAddrMapInTranslates=natAddrMapInTranslates, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natSessionTable=natSessionTable, natInterfaceTable=natInterfaceTable, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natAddrBindTable=natAddrBindTable, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natMappingSubsIndex=natMappingSubsIndex, natPoolRangeTable=natPoolRangeTable, natAddrBindOutTranslates=natAddrBindOutTranslates, natBindDefIdleTimeout=natBindDefIdleTimeout, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natAddrBindId=natAddrBindId, natInstanceIndex=natInstanceIndex, natInstanceAlias=natInstanceAlias, natPoolIndex=natPoolIndex, natSubscriberTranslations=natSubscriberTranslations, natInterfaceRowStatus=natInterfaceRowStatus, natAddrMapAddrUsed=natAddrMapAddrUsed, natProtocolInTranslates=natProtocolInTranslates, natStatsInterfaceGroup=natStatsInterfaceGroup, natLimitAddressMappings=natLimitAddressMappings, natInterfaceInTranslates=natInterfaceInTranslates, natAddrPortBindEntry=natAddrPortBindEntry, natSubscribersEntry=natSubscribersEntry, natL4ProtocolNumber=natL4ProtocolNumber, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natMIBObjects=natMIBObjects, NatBehaviorType=NatBehaviorType, natAddrPortBindProtocol=natAddrPortBindProtocol, natAddrMapCompliance=natAddrMapCompliance, natInterfaceRealm=natInterfaceRealm, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natGroupSubscriberObjects=natGroupSubscriberObjects, natAddrMapIndex=natAddrMapIndex, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natSessionOutTranslates=natSessionOutTranslates, natPoolWatermarkLow=natPoolWatermarkLow, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natProtocolDiscards=natProtocolDiscards, natCounters=natCounters, natInstanceTable=natInstanceTable, natMIBNotifications=natMIBNotifications, natMappingExtAddress=natMappingExtAddress, natPoolEntry=natPoolEntry, NatAssociationType=NatAssociationType, natSessionDirection=natSessionDirection, natMappingProto=natMappingProto, natAddrMapProtocol=natAddrMapProtocol, natResourceErrors=natResourceErrors, NatProtocolType=NatProtocolType, natSessionPublicDstPort=natSessionPublicDstPort, natNotifAddrMappings=natNotifAddrMappings, natBasicStatelessCompliance=natBasicStatelessCompliance, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natPoolRangeEntry=natPoolRangeEntry, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natSessionPublicSrcPort=natSessionPublicSrcPort, natMappingAddressPooling=natMappingAddressPooling, natMappingCreations=natMappingCreations, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natSubscriberIndex=natSubscriberIndex, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natPoolRangeBegin=natPoolRangeBegin, natAddrMapRowStatus=natAddrMapRowStatus, natSessionPrivateDstPort=natSessionPrivateDstPort, natGroupStatelessObjects=natGroupStatelessObjects, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natGroupFragmentObjects=natGroupFragmentObjects, natAddrMapEntryType=natAddrMapEntryType, natSessionAddrMapIndex=natSessionAddrMapIndex, natInterfaceStorageType=natInterfaceStorageType, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natMapIntAddrExtType=natMapIntAddrExtType, natAddrMapDiscards=natAddrMapDiscards, natLimitMappings=natLimitMappings, natGroupStatefulObjects=natGroupStatefulObjects, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natPacketDiscard=natPacketDiscard, natTranslationGroup=natTranslationGroup, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natL4ProtocolEntry=natL4ProtocolEntry, natLimitsEntry=natLimitsEntry, natPoolWatermarkHigh=natPoolWatermarkHigh, natSubscriberLimitMappings=natSubscriberLimitMappings, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natProtocolOutTranslates=natProtocolOutTranslates, natInterfaceOutTranslates=natInterfaceOutTranslates, natMappingRemovals=natMappingRemovals, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natAddrBindLocalAddr=natAddrBindLocalAddr, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natSubscriberIntPrefix=natSubscriberIntPrefix, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natAddrPortBindId=natAddrPortBindId, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natMappingExtRealm=natMappingExtRealm, natSubscribersTable=natSubscribersTable, natMIBConformance=natMIBConformance, natTranslations=natTranslations, natMapIntAddrEntry=natMapIntAddrEntry, natQuotaDrops=natQuotaDrops, natMappingMapBehavior=natMappingMapBehavior)
mibBuilder.exportSymbols("NAT-MIB", natSessionPublicDstAddr=natSessionPublicDstAddr, natAddrMapOutTranslates=natAddrMapOutTranslates, ProtocolNumber=ProtocolNumber, natMIB=natMIB, NatProtocolMap=NatProtocolMap)
