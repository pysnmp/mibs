...
mibBuilder.exportSymbols("NAT-MIB", natProtocolEntry=natProtocolEntry, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natBasicStatelessCompliance=natBasicStatelessCompliance, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natMapIntAddrInt=natMapIntAddrInt, natMappingExtRealm=natMappingExtRealm, natMappingIntPort=natMappingIntPort, natMappingCreations=natMappingCreations, natMIBFullCompliance=natMIBFullCompliance, NatSessionId=NatSessionId, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natMapIntAddrTable=natMapIntAddrTable, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natSessionPublicAddrType=natSessionPublicAddrType, NatPoolId=NatPoolId, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natMappingFilterBehavior=natMappingFilterBehavior, natInterfaceRealm=natInterfaceRealm, natMappingPool=natMappingPool, NatTranslationEntity=NatTranslationEntity, natLimitSubscribers=natLimitSubscribers, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natSubscriberTranslations=natSubscriberTranslations, natCGNCompliance=natCGNCompliance, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natProtocolDiscards=natProtocolDiscards, natPoolEntry=natPoolEntry, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natAddrMapDiscards=natAddrMapDiscards, natStatsProtocolGroup=natStatsProtocolGroup, natInterfaceDiscards=natInterfaceDiscards, natStatsAddrMapGroup=natStatsAddrMapGroup, natGroupStatefulObjects=natGroupStatefulObjects, natMappingAddressPooling=natMappingAddressPooling, natConfigGroup=natConfigGroup, natSessionOutTranslates=natSessionOutTranslates, NatAddrMapId=NatAddrMapId, natOutOfPortErrors=natOutOfPortErrors, natPoolTable=natPoolTable, natCounters=natCounters, NatBindIdOrZero=NatBindIdOrZero, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, NatProtocolMap=NatProtocolMap, natSessionProtocolType=natSessionProtocolType, natSessionPrivateAddrType=natSessionPrivateAddrType, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natPoolRangeEntry=natPoolRangeEntry, natAddrBindOutTranslates=natAddrBindOutTranslates, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natPoolPortMax=natPoolPortMax, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natProtocolTable=natProtocolTable, natMapObjects=natMapObjects, natPacketDiscard=natPacketDiscard, natSubscriberIdentifierType=natSubscriberIdentifierType, natAddrBindSessions=natAddrBindSessions, natNotifCtrl=natNotifCtrl, natSessionEntry=natSessionEntry, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natPoolWatermarkHigh=natPoolWatermarkHigh, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natSubsInterfaceIndex=natSubsInterfaceIndex, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natAddrMapInTranslates=natAddrMapInTranslates, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natInstanceTable=natInstanceTable, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natAddrMapStorageType=natAddrMapStorageType, natAddrBindTable=natAddrBindTable, natSessionUpTime=natSessionUpTime, natLimitFragments=natLimitFragments, natAddrMapEntryType=natAddrMapEntryType, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natSubscribersEntry=natSubscribersEntry, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natFragmentsCompliance=natFragmentsCompliance, natProtocolInTranslates=natProtocolInTranslates, natL4ProtocolEntry=natL4ProtocolEntry, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natNotifMappings=natNotifMappings, natGroupStatelessObjects=natGroupStatelessObjects, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natAddrPortBindId=natAddrPortBindId, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natGroupFragmentObjects=natGroupFragmentObjects, natPoolRangeEnd=natPoolRangeEnd, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natAddrMapProtocol=natAddrMapProtocol, natLimitMappings=natLimitMappings, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natMIBConformance=natMIBConformance, natSubscribers=natSubscribers, natAddrBindId=natAddrBindId, natAddrPortBindTable=natAddrPortBindTable, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natCountersEntry=natCountersEntry, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natPoolRangeTable=natPoolRangeTable, natSubscribersTable=natSubscribersTable, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natL4ProtocolTranslations=natL4ProtocolTranslations, natLimitAddressMappings=natLimitAddressMappings, natAddrBindType=natAddrBindType, natAddrBindLocalAddr=natAddrBindLocalAddr, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natInterfaceStorageType=natInterfaceStorageType, natPoolRangeBegin=natPoolRangeBegin, natMappingExtPort=natMappingExtPort, natAddressMappingRemovals=natAddressMappingRemovals, SubscriberIdentifierType=SubscriberIdentifierType, natAddrBindMapIndex=natAddrBindMapIndex, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natInstanceAlias=natInstanceAlias, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natMappingIntAddress=natMappingIntAddress, natSubscriberIntPrefix=natSubscriberIntPrefix, natInterfaceOutTranslates=natInterfaceOutTranslates, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natAddrMapIndex=natAddrMapIndex, natSessionIndex=natSessionIndex, natProtocol=natProtocol, natLimitsTable=natLimitsTable, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natAddrPortBindType=natAddrPortBindType, natMapIntAddrEntry=natMapIntAddrEntry, natAddrPortBindEntry=natAddrPortBindEntry, natSessionInTranslates=natSessionInTranslates, natMappingIntRealm=natMappingIntRealm, natPoolRangeType=natPoolRangeType, natSessionMaxIdleTime=natSessionMaxIdleTime, natAddressMappingCreations=natAddressMappingCreations, natAddrMapName=natAddrMapName, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natMappingsNotifyThreshold=natMappingsNotifyThreshold, ProtocolNumber=ProtocolNumber, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natMIB=natMIB, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natAddrMapOutTranslates=natAddrMapOutTranslates, natPoolObjects=natPoolObjects, natTranslations=natTranslations, natMappingEntry=natMappingEntry, natAddrMapCompliance=natAddrMapCompliance, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natSessionAddrMapIndex=natSessionAddrMapIndex, PYSNMP_MODULE_ID=natMIB, natInterfaceInTranslates=natInterfaceInTranslates, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natPoolRealm=natPoolRealm, natMappingSubsIndex=natMappingSubsIndex, natSubscriberRealm=natSubscriberRealm, natMIBObjects=natMIBObjects, natMIBNotifications=natMIBNotifications, natAddrPortBindProtocol=natAddrPortBindProtocol, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natMappingProto=natMappingProto, natInstanceIndex=natInstanceIndex, natMapIntAddrExt=natMapIntAddrExt, natAddrMapEntry=natAddrMapEntry, natMappingIntAddressType=natMappingIntAddressType, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natSessionTable=natSessionTable, natSubscriberMappingCreations=natSubscriberMappingCreations, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natAddrMapAddrUsed=natAddrMapAddrUsed, natQuotaDrops=natQuotaDrops, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natMappingExtAddressType=natMappingExtAddressType, natNotifThrottlingInterval=natNotifThrottlingInterval, natMIBCompliances=natMIBCompliances, natNotifAddrMappings=natNotifAddrMappings, natResourceErrors=natResourceErrors, natSubscriberIndex=natSubscriberIndex, natSessionDirection=natSessionDirection, VlanIndexOrZero=VlanIndexOrZero, natInstanceEntry=natInstanceEntry, natTranslationGroup=natTranslationGroup, natInterfaceEntry=natInterfaceEntry, natAddrBindInTranslates=natAddrBindInTranslates, natSessionPublicDstPort=natSessionPublicDstPort, natMappingRemovals=natMappingRemovals, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natAddrMapRowStatus=natAddrMapRowStatus, natInterfaceTable=natInterfaceTable, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natSessionPublicDstAddr=natSessionPublicDstAddr, natStatsInterfaceGroup=natStatsInterfaceGroup, NatBindMode=NatBindMode, natPoolPortMin=natPoolPortMin, natAddrBindEntry=natAddrBindEntry, natSessionPublicSrcPort=natSessionPublicSrcPort, natNotifSubscriberMappings=natNotifSubscriberMappings, natPoolRangePoolIndex=natPoolRangePoolIndex, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natGroupBasicNotifications=natGroupBasicNotifications, natAddrPortBindSessions=natAddrPortBindSessions, natBindDefIdleTimeout=natBindDefIdleTimeout, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natMIBNotificationGroup=natMIBNotificationGroup, NatBindId=NatBindId, natInterfaceRowStatus=natInterfaceRowStatus, natInterfaceServiceType=natInterfaceServiceType, natOtherDefIdleTimeout=natOtherDefIdleTimeout, NatAssociationType=NatAssociationType, natMapIntAddrExtType=natMapIntAddrExtType, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natPoolRangeDeallocations=natPoolRangeDeallocations, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natSessionCurrentIdleTime=natSessionCurrentIdleTime, NatBehaviorType=NatBehaviorType, natCountersTable=natCountersTable, natPoolIndex=natPoolIndex, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natMappingTable=natMappingTable, natTcpDefNegTimeout=natTcpDefNegTimeout, natMappingMapBehavior=natMappingMapBehavior, natBasicStatefulCompliance=natBasicStatefulCompliance, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natL4ProtocolTable=natL4ProtocolTable, natMapIntAddrIntType=natMapIntAddrIntType, NatProtocolType=NatProtocolType, natMIBGroups=natMIBGroups, natSubscriberLimitMappings=natSubscriberLimitMappings, natGroupAddrMapObjects=natGroupAddrMapObjects, natAddrMapTable=natAddrMapTable, natSessionPrivateDstPort=natSessionPrivateDstPort, natLimitsEntry=natLimitsEntry, NatPoolingType=NatPoolingType, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natProtocolOutTranslates=natProtocolOutTranslates, natGroupSubscriberObjects=natGroupSubscriberObjects, natMappingExtAddress=natMappingExtAddress, natSubscriberResourceErrors=natSubscriberResourceErrors, natPoolWatermarkLow=natPoolWatermarkLow, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natDefTimeouts=natDefTimeouts, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType)
mibBuilder.exportSymbols("NAT-MIB", natAddrPortBindMapIndex=natAddrPortBindMapIndex, natSessionPrivateDstAddr=natSessionPrivateDstAddr, SubscriberIndex=SubscriberIndex, natL4ProtocolNumber=natL4ProtocolNumber, natPoolRangeAllocations=natPoolRangeAllocations)
