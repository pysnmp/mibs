...
mibBuilder.exportSymbols("NAT-MIB", NatPoolId=NatPoolId, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natSessionPrivateDstPort=natSessionPrivateDstPort, natMIBGroups=natMIBGroups, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natStatsProtocolGroup=natStatsProtocolGroup, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natNotifSubscriberMappings=natNotifSubscriberMappings, natSessionPublicDstPort=natSessionPublicDstPort, natCountersTable=natCountersTable, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natMIBFullCompliance=natMIBFullCompliance, natStatsInterfaceGroup=natStatsInterfaceGroup, natAddrMapCompliance=natAddrMapCompliance, natDefTimeouts=natDefTimeouts, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natSessionDirection=natSessionDirection, natCounters=natCounters, NatAssociationType=NatAssociationType, natMapIntAddrInt=natMapIntAddrInt, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natBindDefIdleTimeout=natBindDefIdleTimeout, natSessionTable=natSessionTable, natProtocolDiscards=natProtocolDiscards, natL4ProtocolTranslations=natL4ProtocolTranslations, natAddrMapProtocol=natAddrMapProtocol, natSubscriberTranslations=natSubscriberTranslations, natMappingExtPort=natMappingExtPort, natSubsInterfaceIndex=natSubsInterfaceIndex, natL4ProtocolNumber=natL4ProtocolNumber, VlanIndexOrZero=VlanIndexOrZero, natSubscribersTable=natSubscribersTable, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natNotifThrottlingInterval=natNotifThrottlingInterval, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natSessionPrivateAddrType=natSessionPrivateAddrType, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natMIB=natMIB, natProtocolOutTranslates=natProtocolOutTranslates, natMappingProto=natMappingProto, NatBindId=NatBindId, natMIBCompliances=natMIBCompliances, NatPoolingType=NatPoolingType, natAddrPortBindEntry=natAddrPortBindEntry, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natAddrBindSessions=natAddrBindSessions, natMappingCreations=natMappingCreations, natLimitsTable=natLimitsTable, natAddrMapTable=natAddrMapTable, natAddrBindEntry=natAddrBindEntry, natAddrMapIndex=natAddrMapIndex, natMapObjects=natMapObjects, natPacketDiscard=natPacketDiscard, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natAddrPortBindTable=natAddrPortBindTable, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natAddrMapName=natAddrMapName, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natMappingIntRealm=natMappingIntRealm, natAddrBindOutTranslates=natAddrBindOutTranslates, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natSessionProtocolType=natSessionProtocolType, natAddrMapStorageType=natAddrMapStorageType, NatBehaviorType=NatBehaviorType, natPoolRangePoolIndex=natPoolRangePoolIndex, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natL4ProtocolTable=natL4ProtocolTable, natConfigGroup=natConfigGroup, SubscriberIdentifierType=SubscriberIdentifierType, natMappingSubsIndex=natMappingSubsIndex, natSessionPrivateDstAddr=natSessionPrivateDstAddr, NatSessionId=NatSessionId, natMappingMapBehavior=natMappingMapBehavior, natQuotaDrops=natQuotaDrops, natMappingExtAddress=natMappingExtAddress, natAddrPortBindProtocol=natAddrPortBindProtocol, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natPoolPortMax=natPoolPortMax, natSubscriberLimitMappings=natSubscriberLimitMappings, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natSubscriberIdentifierType=natSubscriberIdentifierType, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natInterfaceRealm=natInterfaceRealm, natAddrMapDiscards=natAddrMapDiscards, natOutOfPortErrors=natOutOfPortErrors, natMappingIntPort=natMappingIntPort, natMappingAddressPooling=natMappingAddressPooling, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natSessionOutTranslates=natSessionOutTranslates, natGroupStatefulObjects=natGroupStatefulObjects, natGroupFragmentObjects=natGroupFragmentObjects, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natGroupBasicNotifications=natGroupBasicNotifications, natPoolRangeTable=natPoolRangeTable, natSubscribers=natSubscribers, natAddressMappingCreations=natAddressMappingCreations, natLimitSubscribers=natLimitSubscribers, natPoolIndex=natPoolIndex, natSubscriberMappingCreations=natSubscriberMappingCreations, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natNotifCtrl=natNotifCtrl, NatBindMode=NatBindMode, natAddrMapAddrUsed=natAddrMapAddrUsed, natAddrPortBindSessions=natAddrPortBindSessions, natMapIntAddrExt=natMapIntAddrExt, natSessionEntry=natSessionEntry, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natMappingExtAddressType=natMappingExtAddressType, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natPoolWatermarkLow=natPoolWatermarkLow, natInterfaceDiscards=natInterfaceDiscards, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, ProtocolNumber=ProtocolNumber, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natProtocolInTranslates=natProtocolInTranslates, natProtocolEntry=natProtocolEntry, natPoolWatermarkHigh=natPoolWatermarkHigh, natAddrBindLocalAddr=natAddrBindLocalAddr, natPoolRealm=natPoolRealm, natSubscribersEntry=natSubscribersEntry, natSessionUpTime=natSessionUpTime, natInterfaceRowStatus=natInterfaceRowStatus, natTranslationGroup=natTranslationGroup, NatTranslationEntity=NatTranslationEntity, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natNotifMappings=natNotifMappings, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natPoolObjects=natPoolObjects, natMIBConformance=natMIBConformance, natMappingTable=natMappingTable, natMapIntAddrIntType=natMapIntAddrIntType, natFragmentsCompliance=natFragmentsCompliance, natLimitMappings=natLimitMappings, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natTcpDefNegTimeout=natTcpDefNegTimeout, natSessionInTranslates=natSessionInTranslates, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natInterfaceOutTranslates=natInterfaceOutTranslates, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natInstanceEntry=natInstanceEntry, natPoolPortMin=natPoolPortMin, natPoolRangeType=natPoolRangeType, natLimitAddressMappings=natLimitAddressMappings, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natSessionMaxIdleTime=natSessionMaxIdleTime, natBasicStatefulCompliance=natBasicStatefulCompliance, natGroupSubscriberObjects=natGroupSubscriberObjects, natInterfaceInTranslates=natInterfaceInTranslates, natCountersEntry=natCountersEntry, natInterfaceTable=natInterfaceTable, natTranslations=natTranslations, natMappingFilterBehavior=natMappingFilterBehavior, natMapIntAddrExtType=natMapIntAddrExtType, natSessionPublicDstAddr=natSessionPublicDstAddr, natInstanceTable=natInstanceTable, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natMappingEntry=natMappingEntry, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natAddrPortBindType=natAddrPortBindType, PYSNMP_MODULE_ID=natMIB, natPoolRangeDeallocations=natPoolRangeDeallocations, natPoolRangeEntry=natPoolRangeEntry, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natInterfaceEntry=natInterfaceEntry, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natAddressMappingRemovals=natAddressMappingRemovals, natAddrBindMapIndex=natAddrBindMapIndex, natMIBObjects=natMIBObjects, natSubscriberResourceErrors=natSubscriberResourceErrors, natMappingIntAddressType=natMappingIntAddressType, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natInstanceAlias=natInstanceAlias, natMappingIntAddress=natMappingIntAddress, natBasicStatelessCompliance=natBasicStatelessCompliance, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natGroupStatelessObjects=natGroupStatelessObjects, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natCGNCompliance=natCGNCompliance, natAddrMapOutTranslates=natAddrMapOutTranslates, natMIBNotifications=natMIBNotifications, natMappingPool=natMappingPool, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natSessionPublicAddrType=natSessionPublicAddrType, natAddrMapInTranslates=natAddrMapInTranslates, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natMapIntAddrTable=natMapIntAddrTable, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natAddrMapRowStatus=natAddrMapRowStatus, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natAddrBindTable=natAddrBindTable, natMIBNotificationGroup=natMIBNotificationGroup, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natMapIntAddrEntry=natMapIntAddrEntry, natSubscriberRealm=natSubscriberRealm, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natLimitsEntry=natLimitsEntry, NatBindIdOrZero=NatBindIdOrZero, NatProtocolType=NatProtocolType, natSubscriberIndex=natSubscriberIndex, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natMappingRemovals=natMappingRemovals, natL4ProtocolEntry=natL4ProtocolEntry, natPoolRangeBegin=natPoolRangeBegin, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natSubscriberIntPrefix=natSubscriberIntPrefix, natPoolEntry=natPoolEntry, natLimitFragments=natLimitFragments, natPoolRangeEnd=natPoolRangeEnd, natInterfaceServiceType=natInterfaceServiceType, NatAddrMapId=NatAddrMapId, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natProtocolTable=natProtocolTable, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natAddrBindId=natAddrBindId, natSessionIndex=natSessionIndex, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natAddrMapEntry=natAddrMapEntry, natGroupAddrMapObjects=natGroupAddrMapObjects, natAddrBindInTranslates=natAddrBindInTranslates, natAddrPortBindId=natAddrPortBindId, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, SubscriberIndex=SubscriberIndex, natStatsAddrMapGroup=natStatsAddrMapGroup, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natMappingExtRealm=natMappingExtRealm, natProtocol=natProtocol, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natNotifAddrMappings=natNotifAddrMappings, natInstanceIndex=natInstanceIndex, natPoolRangeAllocations=natPoolRangeAllocations, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, NatProtocolMap=NatProtocolMap, natInterfaceStorageType=natInterfaceStorageType, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natSessionAddrMapIndex=natSessionAddrMapIndex)
mibBuilder.exportSymbols("NAT-MIB", natResourceErrors=natResourceErrors, natAddrBindType=natAddrBindType, natPoolTable=natPoolTable, natAddrMapEntryType=natAddrMapEntryType, natSessionPublicSrcPort=natSessionPublicSrcPort)
