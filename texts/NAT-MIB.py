...
mibBuilder.exportSymbols("NAT-MIB", natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natMappingIntAddressType=natMappingIntAddressType, natSessionPrivateAddrType=natSessionPrivateAddrType, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natSubscriberIndex=natSubscriberIndex, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natAddrBindMapIndex=natAddrBindMapIndex, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natTcpDefNegTimeout=natTcpDefNegTimeout, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natSessionUpTime=natSessionUpTime, natMIBNotificationGroup=natMIBNotificationGroup, SubscriberIdentifierType=SubscriberIdentifierType, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natAddrPortBindTable=natAddrPortBindTable, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natMappingSubsIndex=natMappingSubsIndex, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natAddressMappingCreations=natAddressMappingCreations, natMappingMapBehavior=natMappingMapBehavior, NatSessionId=NatSessionId, natNotifMappings=natNotifMappings, natLimitsEntry=natLimitsEntry, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natStatsInterfaceGroup=natStatsInterfaceGroup, natSubscriberTranslations=natSubscriberTranslations, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, NatPoolId=NatPoolId, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natFragmentsCompliance=natFragmentsCompliance, natStatsAddrMapGroup=natStatsAddrMapGroup, natInterfaceStorageType=natInterfaceStorageType, natMappingIntRealm=natMappingIntRealm, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natStatsProtocolGroup=natStatsProtocolGroup, natInterfaceServiceType=natInterfaceServiceType, natGroupBasicNotifications=natGroupBasicNotifications, natSessionPublicDstAddr=natSessionPublicDstAddr, natNotifSubscriberMappings=natNotifSubscriberMappings, natInstanceIndex=natInstanceIndex, natL4ProtocolEntry=natL4ProtocolEntry, natSubsInterfaceIndex=natSubsInterfaceIndex, natPoolIndex=natPoolIndex, ProtocolNumber=ProtocolNumber, natMIBConformance=natMIBConformance, natProtocol=natProtocol, natProtocolOutTranslates=natProtocolOutTranslates, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natPoolRangePoolIndex=natPoolRangePoolIndex, natSubscriberLimitMappings=natSubscriberLimitMappings, natMapIntAddrInt=natMapIntAddrInt, natPoolEntry=natPoolEntry, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, VlanIndexOrZero=VlanIndexOrZero, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natProtocolDiscards=natProtocolDiscards, natAddrMapEntry=natAddrMapEntry, natMapIntAddrEntry=natMapIntAddrEntry, natSessionIndex=natSessionIndex, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natMappingExtPort=natMappingExtPort, natCGNCompliance=natCGNCompliance, natAddrBindType=natAddrBindType, natPoolRangeAllocations=natPoolRangeAllocations, natSubscriberResourceErrors=natSubscriberResourceErrors, NatAssociationType=NatAssociationType, natGroupStatelessObjects=natGroupStatelessObjects, natMapIntAddrTable=natMapIntAddrTable, PYSNMP_MODULE_ID=natMIB, natAddrMapRowStatus=natAddrMapRowStatus, natLimitSubscribers=natLimitSubscribers, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natLimitFragments=natLimitFragments, natBasicStatelessCompliance=natBasicStatelessCompliance, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natMIBFullCompliance=natMIBFullCompliance, natInstanceAlias=natInstanceAlias, NatPoolingType=NatPoolingType, natSessionAddrMapIndex=natSessionAddrMapIndex, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natAddrBindId=natAddrBindId, natSessionMaxIdleTime=natSessionMaxIdleTime, natMappingCreations=natMappingCreations, natMapObjects=natMapObjects, natAddrBindSessions=natAddrBindSessions, natAddrMapTable=natAddrMapTable, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natSubscribers=natSubscribers, natAddrMapStorageType=natAddrMapStorageType, natPoolRangeTable=natPoolRangeTable, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, NatTranslationEntity=NatTranslationEntity, natDefTimeouts=natDefTimeouts, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natAddrMapDiscards=natAddrMapDiscards, natLimitsTable=natLimitsTable, natMappingPool=natMappingPool, natAddrMapEntryType=natAddrMapEntryType, natSessionPublicSrcPort=natSessionPublicSrcPort, natInterfaceEntry=natInterfaceEntry, natPoolTable=natPoolTable, natPoolRealm=natPoolRealm, natPoolWatermarkHigh=natPoolWatermarkHigh, natSessionPublicAddrType=natSessionPublicAddrType, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natInterfaceOutTranslates=natInterfaceOutTranslates, natAddrBindOutTranslates=natAddrBindOutTranslates, natProtocolEntry=natProtocolEntry, natSessionPublicDstPort=natSessionPublicDstPort, natMappingAddressPooling=natMappingAddressPooling, natAddressMappingRemovals=natAddressMappingRemovals, natInstanceEntry=natInstanceEntry, natMappingExtAddress=natMappingExtAddress, natAddrPortBindSessions=natAddrPortBindSessions, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natInterfaceRealm=natInterfaceRealm, natTranslationGroup=natTranslationGroup, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natQuotaDrops=natQuotaDrops, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natSessionTable=natSessionTable, natMapIntAddrExt=natMapIntAddrExt, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natMappingExtRealm=natMappingExtRealm, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natAddrBindTable=natAddrBindTable, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natAddrMapName=natAddrMapName, natSessionProtocolType=natSessionProtocolType, natMappingExtAddressType=natMappingExtAddressType, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natBindDefIdleTimeout=natBindDefIdleTimeout, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natTranslations=natTranslations, natAddrMapProtocol=natAddrMapProtocol, natAddrPortBindId=natAddrPortBindId, natLimitAddressMappings=natLimitAddressMappings, natCountersTable=natCountersTable, natAddrMapIndex=natAddrMapIndex, natL4ProtocolNumber=natL4ProtocolNumber, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, NatBindMode=NatBindMode, natGroupStatefulObjects=natGroupStatefulObjects, natL4ProtocolTable=natL4ProtocolTable, natAddrPortBindType=natAddrPortBindType, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natPoolRangeDeallocations=natPoolRangeDeallocations, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natPoolRangeType=natPoolRangeType, natPoolRangeEntry=natPoolRangeEntry, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natOutOfPortErrors=natOutOfPortErrors, natSessionPrivateSrcPort=natSessionPrivateSrcPort, NatBehaviorType=NatBehaviorType, natInterfaceDiscards=natInterfaceDiscards, natAddrPortBindEntry=natAddrPortBindEntry, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natPoolWatermarkLow=natPoolWatermarkLow, natGroupSubscriberObjects=natGroupSubscriberObjects, NatProtocolType=NatProtocolType, natNotifAddrMappings=natNotifAddrMappings, natInterfaceInTranslates=natInterfaceInTranslates, natMapIntAddrExtType=natMapIntAddrExtType, natBasicStatefulCompliance=natBasicStatefulCompliance, natMappingFilterBehavior=natMappingFilterBehavior, natSubscriberIdentifierType=natSubscriberIdentifierType, natMIBGroups=natMIBGroups, natInterfaceRowStatus=natInterfaceRowStatus, natMappingTable=natMappingTable, natSessionDirection=natSessionDirection, NatBindIdOrZero=NatBindIdOrZero, natMappingEntry=natMappingEntry, natSessionPrivateDstPort=natSessionPrivateDstPort, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natSessionEntry=natSessionEntry, natConfigGroup=natConfigGroup, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natResourceErrors=natResourceErrors, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natAddrMapInTranslates=natAddrMapInTranslates, natAddrMapAddrUsed=natAddrMapAddrUsed, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natSessionOutTranslates=natSessionOutTranslates, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natMapIntAddrIntType=natMapIntAddrIntType, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natCountersEntry=natCountersEntry, NatProtocolMap=NatProtocolMap, natPoolPortMin=natPoolPortMin, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natGroupAddrMapObjects=natGroupAddrMapObjects, natMIBCompliances=natMIBCompliances, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natMappingIntPort=natMappingIntPort, natLimitMappings=natLimitMappings, natNotifThrottlingInterval=natNotifThrottlingInterval, natPacketDiscard=natPacketDiscard, natPoolObjects=natPoolObjects, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natSessionInTranslates=natSessionInTranslates, natProtocolInTranslates=natProtocolInTranslates, natMappingProto=natMappingProto, natSubscribersEntry=natSubscribersEntry, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natSubscriberMappingCreations=natSubscriberMappingCreations, natAddrBindEntry=natAddrBindEntry, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natPoolPortMax=natPoolPortMax, NatBindId=NatBindId, natNotifCtrl=natNotifCtrl, natAddrBindInTranslates=natAddrBindInTranslates, natAddrPortBindProtocol=natAddrPortBindProtocol, natSubscriberRealm=natSubscriberRealm, natAddrMapCompliance=natAddrMapCompliance, natMIBObjects=natMIBObjects, natPoolRangeEnd=natPoolRangeEnd, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natAddrBindLocalAddr=natAddrBindLocalAddr, natInstanceTable=natInstanceTable, natL4ProtocolTranslations=natL4ProtocolTranslations, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natPoolRangeBegin=natPoolRangeBegin, NatAddrMapId=NatAddrMapId, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natProtocolTable=natProtocolTable, natMappingIntAddress=natMappingIntAddress, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natMIB=natMIB, natMappingRemovals=natMappingRemovals, natSubscribersTable=natSubscribersTable, natInterfaceTable=natInterfaceTable, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natMIBNotifications=natMIBNotifications, natCounters=natCounters)
mibBuilder.exportSymbols("NAT-MIB", natAddrMapOutTranslates=natAddrMapOutTranslates, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, SubscriberIndex=SubscriberIndex, natGroupFragmentObjects=natGroupFragmentObjects, natSubscriberIntPrefix=natSubscriberIntPrefix)
