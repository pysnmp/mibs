...
mibBuilder.exportSymbols("NAT-MIB", natMappingIntAddress=natMappingIntAddress, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natL4ProtocolTable=natL4ProtocolTable, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natMapIntAddrEntry=natMapIntAddrEntry, natInstanceIndex=natInstanceIndex, natMappingTable=natMappingTable, natSubscriberIntPrefixType=natSubscriberIntPrefixType, NatBehaviorType=NatBehaviorType, natInstanceAlias=natInstanceAlias, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natMIBGroups=natMIBGroups, natPoolPortMax=natPoolPortMax, natFragmentsCompliance=natFragmentsCompliance, natSubscriberTranslations=natSubscriberTranslations, natSessionPublicSrcPort=natSessionPublicSrcPort, natSubscriberIdentifierType=natSubscriberIdentifierType, natProtocolInTranslates=natProtocolInTranslates, natPacketDiscard=natPacketDiscard, natAddressMappingRemovals=natAddressMappingRemovals, natMappingRemovals=natMappingRemovals, natLimitSubscribers=natLimitSubscribers, natSessionProtocolType=natSessionProtocolType, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natLimitAddressMappings=natLimitAddressMappings, natNotifSubscriberMappings=natNotifSubscriberMappings, natMappingFilterBehavior=natMappingFilterBehavior, natQuotaDrops=natQuotaDrops, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, NatProtocolMap=NatProtocolMap, NatSessionId=NatSessionId, natSubscriberIntPrefix=natSubscriberIntPrefix, natInterfaceTable=natInterfaceTable, NatBindMode=NatBindMode, natPoolEntry=natPoolEntry, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natGroupAddrMapObjects=natGroupAddrMapObjects, natMappingPool=natMappingPool, natProtocolTable=natProtocolTable, natMapObjects=natMapObjects, NatBindIdOrZero=NatBindIdOrZero, natTcpDefNegTimeout=natTcpDefNegTimeout, natMIBCompliances=natMIBCompliances, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natStatsAddrMapGroup=natStatsAddrMapGroup, NatAssociationType=NatAssociationType, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natAddrMapInTranslates=natAddrMapInTranslates, natPoolRangeDeallocations=natPoolRangeDeallocations, natAddrMapTable=natAddrMapTable, natLimitMappings=natLimitMappings, natSessionUpTime=natSessionUpTime, natBindDefIdleTimeout=natBindDefIdleTimeout, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natAddrMapAddrUsed=natAddrMapAddrUsed, natAddrPortBindType=natAddrPortBindType, natMIBFullCompliance=natMIBFullCompliance, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natSubsInterfaceIndex=natSubsInterfaceIndex, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natInterfaceStorageType=natInterfaceStorageType, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natMappingIntRealm=natMappingIntRealm, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natMappingMapBehavior=natMappingMapBehavior, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natSessionInTranslates=natSessionInTranslates, natInstanceEntry=natInstanceEntry, natProtocolOutTranslates=natProtocolOutTranslates, natPoolRealm=natPoolRealm, natAddrBindId=natAddrBindId, natInterfaceEntry=natInterfaceEntry, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natNotifCtrl=natNotifCtrl, natMapIntAddrInt=natMapIntAddrInt, natMappingExtAddress=natMappingExtAddress, natAddrPortBindId=natAddrPortBindId, natAddrPortBindSessions=natAddrPortBindSessions, natAddrMapName=natAddrMapName, NatAddrMapId=NatAddrMapId, natAddrBindEntry=natAddrBindEntry, natAddrBindLocalAddr=natAddrBindLocalAddr, natAddrMapEntryType=natAddrMapEntryType, natInterfaceOutTranslates=natInterfaceOutTranslates, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natAddressMappingCreations=natAddressMappingCreations, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natSubscribers=natSubscribers, natSubscriberLimitMappings=natSubscriberLimitMappings, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natTranslations=natTranslations, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natGroupStatelessObjects=natGroupStatelessObjects, natMappingIntAddressType=natMappingIntAddressType, natSubscriberRealm=natSubscriberRealm, natSubscriberResourceErrors=natSubscriberResourceErrors, natAddrPortBindTable=natAddrPortBindTable, natDefTimeouts=natDefTimeouts, natAddrMapStorageType=natAddrMapStorageType, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natGroupStatefulObjects=natGroupStatefulObjects, natNotifAddrMappings=natNotifAddrMappings, NatProtocolType=NatProtocolType, natAddrMapProtocol=natAddrMapProtocol, natPoolPortMin=natPoolPortMin, natMapIntAddrExtType=natMapIntAddrExtType, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natBasicStatefulCompliance=natBasicStatefulCompliance, natAddrPortBindProtocol=natAddrPortBindProtocol, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natCountersEntry=natCountersEntry, natMapIntAddrIntType=natMapIntAddrIntType, VlanIndexOrZero=VlanIndexOrZero, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natPoolTable=natPoolTable, natGroupSubscriberObjects=natGroupSubscriberObjects, natL4ProtocolEntry=natL4ProtocolEntry, NatBindId=NatBindId, natProtocolEntry=natProtocolEntry, SubscriberIndex=SubscriberIndex, natPoolRangePoolIndex=natPoolRangePoolIndex, natLimitFragments=natLimitFragments, natPoolRangeAllocations=natPoolRangeAllocations, natMappingExtRealm=natMappingExtRealm, natAddrMapEntry=natAddrMapEntry, natTranslationGroup=natTranslationGroup, natLimitsEntry=natLimitsEntry, natMapIntAddrTable=natMapIntAddrTable, NatPoolId=NatPoolId, natMappingIntPort=natMappingIntPort, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natNotifMappings=natNotifMappings, natSessionPublicDstPort=natSessionPublicDstPort, natPoolObjects=natPoolObjects, natProtocolDiscards=natProtocolDiscards, natSubscriberMappingCreations=natSubscriberMappingCreations, ProtocolNumber=ProtocolNumber, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natConfigGroup=natConfigGroup, natGroupBasicNotifications=natGroupBasicNotifications, natPoolIndex=natPoolIndex, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natAddrPortBindEntry=natAddrPortBindEntry, natBasicStatelessCompliance=natBasicStatelessCompliance, natResourceErrors=natResourceErrors, natStatsInterfaceGroup=natStatsInterfaceGroup, natAddrBindInTranslates=natAddrBindInTranslates, SubscriberIdentifierType=SubscriberIdentifierType, natProtocol=natProtocol, natSessionCurrentIdleTime=natSessionCurrentIdleTime, NatTranslationEntity=NatTranslationEntity, natPoolWatermarkLow=natPoolWatermarkLow, natMIBNotificationGroup=natMIBNotificationGroup, natSessionPrivateAddrType=natSessionPrivateAddrType, natAddrBindType=natAddrBindType, natSubscribersTable=natSubscribersTable, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natSessionTable=natSessionTable, natOutOfPortErrors=natOutOfPortErrors, natCGNCompliance=natCGNCompliance, natSessionMaxIdleTime=natSessionMaxIdleTime, natAddrBindOutTranslates=natAddrBindOutTranslates, natGroupFragmentObjects=natGroupFragmentObjects, natMIBObjects=natMIBObjects, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natMIBConformance=natMIBConformance, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natPoolWatermarkHigh=natPoolWatermarkHigh, natSessionAddrMapIndex=natSessionAddrMapIndex, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natMappingExtPort=natMappingExtPort, natCounters=natCounters, natSessionPrivateDstPort=natSessionPrivateDstPort, natMapIntAddrExt=natMapIntAddrExt, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natL4ProtocolTranslations=natL4ProtocolTranslations, natStatsProtocolGroup=natStatsProtocolGroup, natPoolRangeType=natPoolRangeType, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natAddrMapRowStatus=natAddrMapRowStatus, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natAddrBindMapIndex=natAddrBindMapIndex, natNotifThrottlingInterval=natNotifThrottlingInterval, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natAddrBindTable=natAddrBindTable, natCountersTable=natCountersTable, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natInterfaceRealm=natInterfaceRealm, natInterfaceServiceType=natInterfaceServiceType, natInterfaceInTranslates=natInterfaceInTranslates, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natSessionPublicDstAddr=natSessionPublicDstAddr, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natSessionIndex=natSessionIndex, natSessionEntry=natSessionEntry, natInterfaceDiscards=natInterfaceDiscards, natSessionPublicAddrType=natSessionPublicAddrType, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natAddrMapCompliance=natAddrMapCompliance, natAddrMapOutTranslates=natAddrMapOutTranslates, natAddrMapIndex=natAddrMapIndex, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, PYSNMP_MODULE_ID=natMIB, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natMappingEntry=natMappingEntry, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natL4ProtocolNumber=natL4ProtocolNumber, natMappingAddressPooling=natMappingAddressPooling, natSessionOutTranslates=natSessionOutTranslates, natMIB=natMIB, natPoolRangeEnd=natPoolRangeEnd, natMappingProto=natMappingProto, natSubscriberIndex=natSubscriberIndex, natMappingExtAddressType=natMappingExtAddressType, natLimitsTable=natLimitsTable, natMappingSubsIndex=natMappingSubsIndex, natMappingCreations=natMappingCreations, natInterfaceRowStatus=natInterfaceRowStatus, natAddrMapDiscards=natAddrMapDiscards, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natInstanceTable=natInstanceTable, NatPoolingType=NatPoolingType, natMIBNotifications=natMIBNotifications, natPoolRangeEntry=natPoolRangeEntry, natSubscribersEntry=natSubscribersEntry, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natPoolRangeBegin=natPoolRangeBegin, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout)
mibBuilder.exportSymbols("NAT-MIB", natSessionDirection=natSessionDirection, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natAddrBindSessions=natAddrBindSessions, natPoolRangeTable=natPoolRangeTable, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom)
