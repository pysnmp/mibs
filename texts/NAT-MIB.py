...
mibBuilder.exportSymbols("NAT-MIB", natNotifThrottlingInterval=natNotifThrottlingInterval, natCGNCompliance=natCGNCompliance, natSubscriberResourceErrors=natSubscriberResourceErrors, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natProtocol=natProtocol, natLimitFragments=natLimitFragments, natMappingExtAddressType=natMappingExtAddressType, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natMapIntAddrTable=natMapIntAddrTable, natPoolWatermarkLow=natPoolWatermarkLow, natPoolWatermarkHigh=natPoolWatermarkHigh, natConfigGroup=natConfigGroup, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natStatsInterfaceGroup=natStatsInterfaceGroup, natSessionInTranslates=natSessionInTranslates, natSubscriberLimitMappings=natSubscriberLimitMappings, natInterfaceRealm=natInterfaceRealm, natAddrBindType=natAddrBindType, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natPoolRangeType=natPoolRangeType, natAddrBindEntry=natAddrBindEntry, natPoolPortMax=natPoolPortMax, natPacketDiscard=natPacketDiscard, natPoolRangeTable=natPoolRangeTable, natMappingSubsIndex=natMappingSubsIndex, natMappingIntAddressType=natMappingIntAddressType, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natAddrMapInTranslates=natAddrMapInTranslates, natAddrMapDiscards=natAddrMapDiscards, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natAddrMapRowStatus=natAddrMapRowStatus, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natMapIntAddrEntry=natMapIntAddrEntry, natInstanceTable=natInstanceTable, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natPoolIndex=natPoolIndex, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natSubscriberMappingCreations=natSubscriberMappingCreations, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natAddrPortBindTable=natAddrPortBindTable, natGroupStatefulObjects=natGroupStatefulObjects, natGroupFragmentObjects=natGroupFragmentObjects, NatBindMode=NatBindMode, natMIBNotificationGroup=natMIBNotificationGroup, natMIBNotifications=natMIBNotifications, ProtocolNumber=ProtocolNumber, PYSNMP_MODULE_ID=natMIB, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natSessionPublicDstPort=natSessionPublicDstPort, natInterfaceOutTranslates=natInterfaceOutTranslates, natMappingProto=natMappingProto, natSubscribersEntry=natSubscribersEntry, natSessionPublicDstAddr=natSessionPublicDstAddr, natL4ProtocolTable=natL4ProtocolTable, natMIBFullCompliance=natMIBFullCompliance, NatBehaviorType=NatBehaviorType, natSessionAddrMapIndex=natSessionAddrMapIndex, natInterfaceRowStatus=natInterfaceRowStatus, natMappingExtPort=natMappingExtPort, natGroupAddrMapObjects=natGroupAddrMapObjects, natAddrMapStorageType=natAddrMapStorageType, natLimitSubscribers=natLimitSubscribers, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natAddrMapProtocol=natAddrMapProtocol, natAddrBindSessions=natAddrBindSessions, natMapObjects=natMapObjects, natInterfaceInTranslates=natInterfaceInTranslates, natAddrMapName=natAddrMapName, natAddrBindInTranslates=natAddrBindInTranslates, natAddressMappingCreations=natAddressMappingCreations, natInterfaceEntry=natInterfaceEntry, natStatsAddrMapGroup=natStatsAddrMapGroup, natInstanceEntry=natInstanceEntry, natMappingExtRealm=natMappingExtRealm, natAddressMappingRemovals=natAddressMappingRemovals, natAddrPortBindId=natAddrPortBindId, natSubscribers=natSubscribers, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natMIBConformance=natMIBConformance, natPoolPortMin=natPoolPortMin, natSubscriberTranslations=natSubscriberTranslations, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natGroupSubscriberObjects=natGroupSubscriberObjects, natLimitAddressMappings=natLimitAddressMappings, natPoolObjects=natPoolObjects, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natNotifSubscriberMappings=natNotifSubscriberMappings, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natMappingFilterBehavior=natMappingFilterBehavior, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natMIB=natMIB, VlanIndexOrZero=VlanIndexOrZero, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natAddrMapEntryType=natAddrMapEntryType, natDefTimeouts=natDefTimeouts, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natProtocolOutTranslates=natProtocolOutTranslates, natMIBCompliances=natMIBCompliances, NatBindId=NatBindId, natPoolTable=natPoolTable, natTranslationGroup=natTranslationGroup, natPoolRangeEntry=natPoolRangeEntry, natMapIntAddrExt=natMapIntAddrExt, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natProtocolEntry=natProtocolEntry, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natInstanceIndex=natInstanceIndex, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natMappingRemovals=natMappingRemovals, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natAddrPortBindProtocol=natAddrPortBindProtocol, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natSessionPrivateDstPort=natSessionPrivateDstPort, natAddrBindId=natAddrBindId, natSessionMaxIdleTime=natSessionMaxIdleTime, natSubscriberIdentifierType=natSubscriberIdentifierType, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natMapIntAddrInt=natMapIntAddrInt, natProtocolTable=natProtocolTable, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natL4ProtocolEntry=natL4ProtocolEntry, natInterfaceServiceType=natInterfaceServiceType, natSessionOutTranslates=natSessionOutTranslates, natProtocolInTranslates=natProtocolInTranslates, natAddrPortBindSessions=natAddrPortBindSessions, natLimitMappings=natLimitMappings, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natBasicStatefulCompliance=natBasicStatefulCompliance, natSessionPublicAddrType=natSessionPublicAddrType, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natOutOfPortErrors=natOutOfPortErrors, natSubsInterfaceIndex=natSubsInterfaceIndex, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natSubscribersTable=natSubscribersTable, natBasicStatelessCompliance=natBasicStatelessCompliance, natAddrBindLocalAddr=natAddrBindLocalAddr, natCountersEntry=natCountersEntry, natProtocolDiscards=natProtocolDiscards, natAddrMapIndex=natAddrMapIndex, natL4ProtocolNumber=natL4ProtocolNumber, natPoolRangeBegin=natPoolRangeBegin, NatProtocolType=NatProtocolType, SubscriberIdentifierType=SubscriberIdentifierType, NatSessionId=NatSessionId, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natMappingEntry=natMappingEntry, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, NatPoolingType=NatPoolingType, natMappingPool=natMappingPool, natFragmentsCompliance=natFragmentsCompliance, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natAddrPortBindType=natAddrPortBindType, natAddrMapCompliance=natAddrMapCompliance, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natInstanceAlias=natInstanceAlias, natSessionPublicSrcPort=natSessionPublicSrcPort, natInterfaceDiscards=natInterfaceDiscards, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natSubscriberIntPrefix=natSubscriberIntPrefix, natInterfaceStorageType=natInterfaceStorageType, natQuotaDrops=natQuotaDrops, natMappingMapBehavior=natMappingMapBehavior, natAddrMapOutTranslates=natAddrMapOutTranslates, natMappingIntAddress=natMappingIntAddress, natMappingCreations=natMappingCreations, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natInterfaceTable=natInterfaceTable, natSessionUpTime=natSessionUpTime, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natMIBObjects=natMIBObjects, natLimitsTable=natLimitsTable, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natMappingAddressPooling=natMappingAddressPooling, natPoolEntry=natPoolEntry, natNotifCtrl=natNotifCtrl, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natStatsProtocolGroup=natStatsProtocolGroup, natMappingTable=natMappingTable, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natSessionDirection=natSessionDirection, natPoolRangeDeallocations=natPoolRangeDeallocations, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natMIBGroups=natMIBGroups, natNotifMappings=natNotifMappings, natSessionEntry=natSessionEntry, natAddrMapTable=natAddrMapTable, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natLimitsEntry=natLimitsEntry, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natSessionProtocolType=natSessionProtocolType, natAddrBindTable=natAddrBindTable, natAddrMapAddrUsed=natAddrMapAddrUsed, natCounters=natCounters, natSessionIndex=natSessionIndex, natL4ProtocolTranslations=natL4ProtocolTranslations, natCountersTable=natCountersTable, natMappingExtAddress=natMappingExtAddress, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natTcpDefNegTimeout=natTcpDefNegTimeout, natResourceErrors=natResourceErrors, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natSubscriberRealm=natSubscriberRealm, natSessionTable=natSessionTable, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natNotifAddrMappings=natNotifAddrMappings, natSubscriberIndex=natSubscriberIndex, NatTranslationEntity=NatTranslationEntity, NatProtocolMap=NatProtocolMap, NatBindIdOrZero=NatBindIdOrZero, natGroupBasicNotifications=natGroupBasicNotifications, NatAddrMapId=NatAddrMapId, natTranslations=natTranslations, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natBindDefIdleTimeout=natBindDefIdleTimeout, NatAssociationType=NatAssociationType, natMappingIntPort=natMappingIntPort, SubscriberIndex=SubscriberIndex, natPoolRangeEnd=natPoolRangeEnd, natAddrBindMapIndex=natAddrBindMapIndex, natAddrPortBindEntry=natAddrPortBindEntry, natPoolRealm=natPoolRealm, natMapIntAddrExtType=natMapIntAddrExtType, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natGroupStatelessObjects=natGroupStatelessObjects, natPoolRangePoolIndex=natPoolRangePoolIndex, NatPoolId=NatPoolId, natAddrBindOutTranslates=natAddrBindOutTranslates, natAddrMapEntry=natAddrMapEntry, natMapIntAddrIntType=natMapIntAddrIntType, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natPoolRangeAllocations=natPoolRangeAllocations)
mibBuilder.exportSymbols("NAT-MIB", natMappingIntRealm=natMappingIntRealm, natSessionPrivateAddrType=natSessionPrivateAddrType, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout)
