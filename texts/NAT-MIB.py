...
Bits, Counter64, Unsigned32, mib_2, ModuleIdentity, TimeTicks, NotificationType, Counter32, IpAddress, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "Unsigned32", "mib-2", "ModuleIdentity", "TimeTicks", "NotificationType", "Counter32", "IpAddress", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "Gauge32")
...
mibBuilder.exportSymbols("NAT-MIB", natMapIntAddrTable=natMapIntAddrTable, natGroupSubscriberObjects=natGroupSubscriberObjects, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natNotifThrottlingInterval=natNotifThrottlingInterval, NatProtocolType=NatProtocolType, natFragmentsCompliance=natFragmentsCompliance, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natAddrBindInTranslates=natAddrBindInTranslates, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natNotifSubscriberMappings=natNotifSubscriberMappings, natPoolRangeAllocations=natPoolRangeAllocations, natMappingSubsIndex=natMappingSubsIndex, natPoolIndex=natPoolIndex, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natMappingFilterBehavior=natMappingFilterBehavior, natL4ProtocolTable=natL4ProtocolTable, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natAddrMapIndex=natAddrMapIndex, natSubscriberIdentifierType=natSubscriberIdentifierType, natSubscriberIndex=natSubscriberIndex, natSubscriberMappingCreations=natSubscriberMappingCreations, natL4ProtocolEntry=natL4ProtocolEntry, natMapIntAddrExtType=natMapIntAddrExtType, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natAddrBindLocalAddr=natAddrBindLocalAddr, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natL4ProtocolTranslations=natL4ProtocolTranslations, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natNotifCtrl=natNotifCtrl, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natSessionIndex=natSessionIndex, VlanIndexOrZero=VlanIndexOrZero, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natMappingEntry=natMappingEntry, natMappingExtPort=natMappingExtPort, natMapIntAddrIntRealm=natMapIntAddrIntRealm, NatProtocolMap=NatProtocolMap, natSubscribersTable=natSubscribersTable, natPoolObjects=natPoolObjects, natLimitMappings=natLimitMappings, natMIB=natMIB, natGroupFragmentObjects=natGroupFragmentObjects, natAddrMapRowStatus=natAddrMapRowStatus, natAddrPortBindType=natAddrPortBindType, natSessionPrivateDstPort=natSessionPrivateDstPort, natPoolRangeEnd=natPoolRangeEnd, natSessionInTranslates=natSessionInTranslates, ProtocolNumber=ProtocolNumber, natGroupAddrMapObjects=natGroupAddrMapObjects, natAddrBindMapIndex=natAddrBindMapIndex, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natMappingExtAddressType=natMappingExtAddressType, natPoolWatermarkHigh=natPoolWatermarkHigh, natSubscriberQuotaDrops=natSubscriberQuotaDrops, NatBindIdOrZero=NatBindIdOrZero, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natSubscriberIntPrefix=natSubscriberIntPrefix, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natAddrBindType=natAddrBindType, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, SubscriberIdentifierType=SubscriberIdentifierType, natMapIntAddrIntType=natMapIntAddrIntType, natSubscribers=natSubscribers, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natSessionTable=natSessionTable, natMappingExtAddress=natMappingExtAddress, natBindDefIdleTimeout=natBindDefIdleTimeout, natAddrMapTable=natAddrMapTable, natSubscribersEntry=natSubscribersEntry, natMIBNotificationGroup=natMIBNotificationGroup, natSessionAddrMapIndex=natSessionAddrMapIndex, natSessionProtocolType=natSessionProtocolType, natTcpDefNegTimeout=natTcpDefNegTimeout, natCGNCompliance=natCGNCompliance, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natStatsProtocolGroup=natStatsProtocolGroup, natSubscriberTranslations=natSubscriberTranslations, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natMapIntAddrExt=natMapIntAddrExt, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natAddrBindEntry=natAddrBindEntry, natMappingExtRealm=natMappingExtRealm, natMapIntAddrEntry=natMapIntAddrEntry, natCountersTable=natCountersTable, natLimitFragments=natLimitFragments, natSessionUpTime=natSessionUpTime, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natPoolEntry=natPoolEntry, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natPoolRangeTable=natPoolRangeTable, natAddrMapName=natAddrMapName, natSessionPublicAddrType=natSessionPublicAddrType, natConfigGroup=natConfigGroup, natAddrPortBindTable=natAddrPortBindTable, natInstanceTable=natInstanceTable, natInstanceAlias=natInstanceAlias, natResourceErrors=natResourceErrors, natPoolRangeEntry=natPoolRangeEntry, natAddrBindTable=natAddrBindTable, natMappingRemovals=natMappingRemovals, natMIBObjects=natMIBObjects, natPoolWatermarkLow=natPoolWatermarkLow, natAddressMappingRemovals=natAddressMappingRemovals, natPoolPortMin=natPoolPortMin, natTranslations=natTranslations, natGroupBasicNotifications=natGroupBasicNotifications, natAddrPortBindId=natAddrPortBindId, natSessionPublicDstAddr=natSessionPublicDstAddr, natSubscriberResourceErrors=natSubscriberResourceErrors, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natMapIntAddrInt=natMapIntAddrInt, natInterfaceRowStatus=natInterfaceRowStatus, natPacketDiscard=natPacketDiscard, natPoolRangeBegin=natPoolRangeBegin, natMIBNotifications=natMIBNotifications, natSessionOutTranslates=natSessionOutTranslates, natL4ProtocolNumber=natL4ProtocolNumber, natGroupSubscriberNotifications=natGroupSubscriberNotifications, NatAddrMapId=NatAddrMapId, natProtocolTable=natProtocolTable, natMapObjects=natMapObjects, NatBehaviorType=NatBehaviorType, natSubscriberRealm=natSubscriberRealm, natInstanceEntry=natInstanceEntry, natSessionPublicDstPort=natSessionPublicDstPort, natAddrMapInTranslates=natAddrMapInTranslates, natNotifMappings=natNotifMappings, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natSessionPublicSrcPort=natSessionPublicSrcPort, natMIBCompliances=natMIBCompliances, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natDefTimeouts=natDefTimeouts, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natProtocolInTranslates=natProtocolInTranslates, natCounters=natCounters, PYSNMP_MODULE_ID=natMIB, natGroupStatefulObjects=natGroupStatefulObjects, natCountersEntry=natCountersEntry, natLimitSubscribers=natLimitSubscribers, natSessionPrivateAddrType=natSessionPrivateAddrType, SubscriberIndex=SubscriberIndex, natAddrMapEntryType=natAddrMapEntryType, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natSubscriberLimitMappings=natSubscriberLimitMappings, natAddrPortBindProtocol=natAddrPortBindProtocol, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natTranslationGroup=natTranslationGroup, natOutOfPortErrors=natOutOfPortErrors, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natGroupStatelessObjects=natGroupStatelessObjects, natAddrMapProtocol=natAddrMapProtocol, natQuotaDrops=natQuotaDrops, natAddressMappingCreations=natAddressMappingCreations, natPoolRangeDeallocations=natPoolRangeDeallocations, NatTranslationEntity=NatTranslationEntity, natMIBConformance=natMIBConformance, natAddrBindId=natAddrBindId, natProtocolEntry=natProtocolEntry, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, NatAssociationType=NatAssociationType, natInterfaceInTranslates=natInterfaceInTranslates, natPoolRealm=natPoolRealm, natInterfaceTable=natInterfaceTable, natLimitsTable=natLimitsTable, natAddrMapOutTranslates=natAddrMapOutTranslates, NatBindMode=NatBindMode, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natMappingIntAddress=natMappingIntAddress, natMIBGroups=natMIBGroups, natProtocol=natProtocol, natInterfaceRealm=natInterfaceRealm, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natBasicStatelessCompliance=natBasicStatelessCompliance, natMappingAddressPooling=natMappingAddressPooling, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natAddrMapAddrUsed=natAddrMapAddrUsed, natMappingIntPort=natMappingIntPort, NatPoolingType=NatPoolingType, natLimitAddressMappings=natLimitAddressMappings, natMappingProto=natMappingProto, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natProtocolOutTranslates=natProtocolOutTranslates, natAddrMapEntry=natAddrMapEntry, natMIBFullCompliance=natMIBFullCompliance, natInterfaceStorageType=natInterfaceStorageType, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natMappingCreations=natMappingCreations, natPoolTable=natPoolTable, NatBindId=NatBindId, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natNotifAddrMappings=natNotifAddrMappings, natMappingMapBehavior=natMappingMapBehavior, natSessionEntry=natSessionEntry, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natMappingTable=natMappingTable, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natStatsAddrMapGroup=natStatsAddrMapGroup, natAddrMapStorageType=natAddrMapStorageType, natPoolRangeType=natPoolRangeType, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, NatPoolId=NatPoolId, natAddrBindSessions=natAddrBindSessions, natLimitsEntry=natLimitsEntry, natPoolRangePoolIndex=natPoolRangePoolIndex, natAddrBindOutTranslates=natAddrBindOutTranslates, natPoolPortMax=natPoolPortMax, natSessionMaxIdleTime=natSessionMaxIdleTime, natAddrMapCompliance=natAddrMapCompliance, natInterfaceServiceType=natInterfaceServiceType, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natMappingIntAddressType=natMappingIntAddressType, natInterfaceEntry=natInterfaceEntry, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natAddrMapDiscards=natAddrMapDiscards, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natSubsInterfaceIndex=natSubsInterfaceIndex, natAddrPortBindEntry=natAddrPortBindEntry, natInterfaceOutTranslates=natInterfaceOutTranslates, natAddrPortBindSessions=natAddrPortBindSessions, natMappingIntRealm=natMappingIntRealm, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natInstanceIndex=natInstanceIndex, NatSessionId=NatSessionId, natProtocolDiscards=natProtocolDiscards, natMappingPool=natMappingPool, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natSessionDirection=natSessionDirection, natMapIntAddrExtRealm=natMapIntAddrExtRealm)
mibBuilder.exportSymbols("NAT-MIB", natInterfaceDiscards=natInterfaceDiscards, natBasicStatefulCompliance=natBasicStatefulCompliance, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natStatsInterfaceGroup=natStatsInterfaceGroup, natSessionPrivateSrcPort=natSessionPrivateSrcPort)
