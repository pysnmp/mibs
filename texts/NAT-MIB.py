...
mib_2, iso, ObjectIdentity, TimeTicks, IpAddress, Gauge32, Counter64, Integer32, Counter32, MibIdentifier, Unsigned32, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "iso", "ObjectIdentity", "TimeTicks", "IpAddress", "Gauge32", "Counter64", "Integer32", "Counter32", "MibIdentifier", "Unsigned32", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("NAT-MIB", natMappingIntPort=natMappingIntPort, natAddrPortBindProtocol=natAddrPortBindProtocol, NatPoolingType=NatPoolingType, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natInterfaceInTranslates=natInterfaceInTranslates, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natMappingExtAddress=natMappingExtAddress, natSessionEntry=natSessionEntry, natMIBObjects=natMIBObjects, natMappingCreations=natMappingCreations, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natMapIntAddrTable=natMapIntAddrTable, natAddrPortBindInTranslates=natAddrPortBindInTranslates, NatSessionId=NatSessionId, natInterfaceRealm=natInterfaceRealm, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natMapIntAddrInt=natMapIntAddrInt, NatBindIdOrZero=NatBindIdOrZero, natMIB=natMIB, natSessionProtocolType=natSessionProtocolType, natSubscriberRealm=natSubscriberRealm, NatProtocolMap=NatProtocolMap, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natLimitsTable=natLimitsTable, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, NatPoolId=NatPoolId, natMappingExtAddressType=natMappingExtAddressType, natAddrMapName=natAddrMapName, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, NatBindId=NatBindId, natMIBConformance=natMIBConformance, natAddrMapDiscards=natAddrMapDiscards, natSessionIndex=natSessionIndex, natAddrBindType=natAddrBindType, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natMIBCompliances=natMIBCompliances, natInstanceTable=natInstanceTable, natLimitAddressMappings=natLimitAddressMappings, natL4ProtocolNumber=natL4ProtocolNumber, natStatsAddrMapGroup=natStatsAddrMapGroup, natAddrPortBindId=natAddrPortBindId, natConfigGroup=natConfigGroup, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natAddrPortBindLocalPort=natAddrPortBindLocalPort, VlanIndexOrZero=VlanIndexOrZero, natAddrMapEntry=natAddrMapEntry, natGroupAddrMapObjects=natGroupAddrMapObjects, natStatsInterfaceGroup=natStatsInterfaceGroup, natMapIntAddrEntry=natMapIntAddrEntry, natProtocolOutTranslates=natProtocolOutTranslates, natAddrPortBindTable=natAddrPortBindTable, natAddrPortBindSessions=natAddrPortBindSessions, natSubscribersEntry=natSubscribersEntry, natSubscriberLimitMappings=natSubscriberLimitMappings, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natProtocolTable=natProtocolTable, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natAddrPortBindType=natAddrPortBindType, natAddressMappingRemovals=natAddressMappingRemovals, natOutOfPortErrors=natOutOfPortErrors, natSessionPublicDstPort=natSessionPublicDstPort, natPoolTable=natPoolTable, natMappingTable=natMappingTable, natSessionPublicAddrType=natSessionPublicAddrType, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natNotifCtrl=natNotifCtrl, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natAddrBindInTranslates=natAddrBindInTranslates, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natProtocolInTranslates=natProtocolInTranslates, natAddrMapOutTranslates=natAddrMapOutTranslates, natInterfaceEntry=natInterfaceEntry, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natNotifAddrMappings=natNotifAddrMappings, natInstanceAlias=natInstanceAlias, NatAddrMapId=NatAddrMapId, natProtocolDiscards=natProtocolDiscards, natMappingIntAddress=natMappingIntAddress, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natMappingMapBehavior=natMappingMapBehavior, natMappingFilterBehavior=natMappingFilterBehavior, natAddrMapTable=natAddrMapTable, natSubscriberIndex=natSubscriberIndex, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natAddrMapStorageType=natAddrMapStorageType, natFragmentsCompliance=natFragmentsCompliance, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natL4ProtocolEntry=natL4ProtocolEntry, natMapIntAddrExt=natMapIntAddrExt, natCounters=natCounters, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natMappingIntRealm=natMappingIntRealm, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, SubscriberIndex=SubscriberIndex, natAddressMappingCreations=natAddressMappingCreations, natAddrMapEntryType=natAddrMapEntryType, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, NatBehaviorType=NatBehaviorType, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natSubscribersTable=natSubscribersTable, natCountersTable=natCountersTable, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natPoolRangeBegin=natPoolRangeBegin, natCGNCompliance=natCGNCompliance, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natSessionMaxIdleTime=natSessionMaxIdleTime, PYSNMP_MODULE_ID=natMIB, natSessionPublicSrcPort=natSessionPublicSrcPort, natPoolPortMax=natPoolPortMax, natSessionAddrMapIndex=natSessionAddrMapIndex, natPoolRangeEntry=natPoolRangeEntry, natLimitFragments=natLimitFragments, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natPacketDiscard=natPacketDiscard, natMappingPool=natMappingPool, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natSubscriberIdentifierType=natSubscriberIdentifierType, NatAssociationType=NatAssociationType, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natAddrMapRowStatus=natAddrMapRowStatus, natMappingSubsIndex=natMappingSubsIndex, natInterfaceServiceType=natInterfaceServiceType, natSubscriberIntPrefix=natSubscriberIntPrefix, natInterfaceStorageType=natInterfaceStorageType, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natAddrPortBindEntry=natAddrPortBindEntry, natInstanceIndex=natInstanceIndex, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natBasicStatelessCompliance=natBasicStatelessCompliance, natSessionPrivateAddrType=natSessionPrivateAddrType, natPoolEntry=natPoolEntry, natAddrMapInTranslates=natAddrMapInTranslates, natProtocol=natProtocol, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natNotifSubscriberMappings=natNotifSubscriberMappings, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natSessionOutTranslates=natSessionOutTranslates, natPoolRangeType=natPoolRangeType, natBasicStatefulCompliance=natBasicStatefulCompliance, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, ProtocolNumber=ProtocolNumber, natAddrBindSessions=natAddrBindSessions, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natPoolIndex=natPoolIndex, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natNotifMappings=natNotifMappings, natLimitsEntry=natLimitsEntry, natGroupSubscriberObjects=natGroupSubscriberObjects, natAddrBindMapIndex=natAddrBindMapIndex, natL4ProtocolTranslations=natL4ProtocolTranslations, natGroupStatefulObjects=natGroupStatefulObjects, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natTranslationGroup=natTranslationGroup, natMappingEntry=natMappingEntry, natSessionInTranslates=natSessionInTranslates, natL4ProtocolTable=natL4ProtocolTable, NatProtocolType=NatProtocolType, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natAddrMapProtocol=natAddrMapProtocol, natSubsInterfaceIndex=natSubsInterfaceIndex, natInterfaceOutTranslates=natInterfaceOutTranslates, natPoolRangeTable=natPoolRangeTable, natInterfaceTable=natInterfaceTable, NatTranslationEntity=NatTranslationEntity, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natAddrMapIndex=natAddrMapIndex, natAddrMapAddrUsed=natAddrMapAddrUsed, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natPoolObjects=natPoolObjects, natMapIntAddrIntType=natMapIntAddrIntType, natAddrBindTable=natAddrBindTable, natSessionPrivateDstPort=natSessionPrivateDstPort, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natPoolRangeAllocations=natPoolRangeAllocations, natPoolRangeDeallocations=natPoolRangeDeallocations, natMIBNotificationGroup=natMIBNotificationGroup, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natSessionDirection=natSessionDirection, natSubscriberTranslations=natSubscriberTranslations, natPoolWatermarkLow=natPoolWatermarkLow, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natBindDefIdleTimeout=natBindDefIdleTimeout, natSubscriberResourceErrors=natSubscriberResourceErrors, natPoolPortMin=natPoolPortMin, natPoolWatermarkHigh=natPoolWatermarkHigh, natMapObjects=natMapObjects, natMappingExtRealm=natMappingExtRealm, natMappingIntAddressType=natMappingIntAddressType, natNotifThrottlingInterval=natNotifThrottlingInterval, natInterfaceRowStatus=natInterfaceRowStatus, natTranslations=natTranslations, natPoolRealm=natPoolRealm, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natSessionTable=natSessionTable, NatBindMode=NatBindMode, natPoolRangePoolIndex=natPoolRangePoolIndex, natSessionUpTime=natSessionUpTime, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natMappingExtPort=natMappingExtPort, natDefTimeouts=natDefTimeouts, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natMappingRemovals=natMappingRemovals, natTcpDefNegTimeout=natTcpDefNegTimeout, natSubscriberMappingCreations=natSubscriberMappingCreations, natInstanceEntry=natInstanceEntry, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natAddrBindLocalAddr=natAddrBindLocalAddr, natLimitMappings=natLimitMappings, natMapIntAddrExtType=natMapIntAddrExtType, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natInterfaceDiscards=natInterfaceDiscards, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natSubscribers=natSubscribers, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natAddrBindEntry=natAddrBindEntry, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natProtocolEntry=natProtocolEntry, natAddrBindOutTranslates=natAddrBindOutTranslates, natAddrBindId=natAddrBindId, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natPoolRangeEnd=natPoolRangeEnd, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natMappingProto=natMappingProto, natResourceErrors=natResourceErrors, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natLimitSubscribers=natLimitSubscribers, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natSessionPublicDstAddr=natSessionPublicDstAddr, natMIBGroups=natMIBGroups, natMIBFullCompliance=natMIBFullCompliance, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natMIBNotifications=natMIBNotifications, natGroupStatelessObjects=natGroupStatelessObjects, natMappingAddressPooling=natMappingAddressPooling, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natGroupFragmentObjects=natGroupFragmentObjects, natGroupBasicNotifications=natGroupBasicNotifications, natAddrMapCompliance=natAddrMapCompliance, natCountersEntry=natCountersEntry)
mibBuilder.exportSymbols("NAT-MIB", natStatsProtocolGroup=natStatsProtocolGroup, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, SubscriberIdentifierType=SubscriberIdentifierType, natQuotaDrops=natQuotaDrops)
