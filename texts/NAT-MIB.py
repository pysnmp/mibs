...
Gauge32, Counter64, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, mib_2, TimeTicks, iso, Counter32, Unsigned32, ModuleIdentity, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "mib-2", "TimeTicks", "iso", "Counter32", "Unsigned32", "ModuleIdentity", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("NAT-MIB", natTcpDefIdleTimeout=natTcpDefIdleTimeout, natAddrBindLocalAddr=natAddrBindLocalAddr, natSessionDirection=natSessionDirection, ProtocolNumber=ProtocolNumber, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natResourceErrors=natResourceErrors, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natGroupSubscriberObjects=natGroupSubscriberObjects, VlanIndexOrZero=VlanIndexOrZero, NatBehaviorType=NatBehaviorType, natMappingSubsIndex=natMappingSubsIndex, natNotifSubscriberMappings=natNotifSubscriberMappings, natPoolRangeEntry=natPoolRangeEntry, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natMappingFilterBehavior=natMappingFilterBehavior, natGroupStatelessObjects=natGroupStatelessObjects, natMappingEntry=natMappingEntry, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natMapIntAddrInt=natMapIntAddrInt, natSubscriberMappingCreations=natSubscriberMappingCreations, natCGNCompliance=natCGNCompliance, natTcpDefNegTimeout=natTcpDefNegTimeout, NatSessionId=NatSessionId, natAddrPortBindSessions=natAddrPortBindSessions, SubscriberIndex=SubscriberIndex, natSessionIndex=natSessionIndex, NatBindIdOrZero=NatBindIdOrZero, natAddrMapOutTranslates=natAddrMapOutTranslates, natSessionMaxIdleTime=natSessionMaxIdleTime, natMappingExtAddressType=natMappingExtAddressType, natMapObjects=natMapObjects, natPoolPortMax=natPoolPortMax, natSubscriberTranslations=natSubscriberTranslations, natMIBConformance=natMIBConformance, natMappingAddressPooling=natMappingAddressPooling, natInstanceIndex=natInstanceIndex, natAddrPortBindType=natAddrPortBindType, natProtocolDiscards=natProtocolDiscards, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natSessionPrivateAddrType=natSessionPrivateAddrType, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natMappingExtAddress=natMappingExtAddress, natProtocolInTranslates=natProtocolInTranslates, natMapIntAddrEntry=natMapIntAddrEntry, natBasicStatelessCompliance=natBasicStatelessCompliance, natMapIntAddrExtType=natMapIntAddrExtType, NatPoolingType=NatPoolingType, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natSessionPrivateDstPort=natSessionPrivateDstPort, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, NatProtocolType=NatProtocolType, natAddrMapEntry=natAddrMapEntry, natProtocolTable=natProtocolTable, natProtocol=natProtocol, natProtocolOutTranslates=natProtocolOutTranslates, natMapIntAddrTable=natMapIntAddrTable, natFragmentsCompliance=natFragmentsCompliance, NatPoolId=NatPoolId, natInterfaceDiscards=natInterfaceDiscards, natProtocolEntry=natProtocolEntry, natAddrBindSessions=natAddrBindSessions, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natPacketDiscard=natPacketDiscard, natInterfaceServiceType=natInterfaceServiceType, natMIBGroups=natMIBGroups, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natAddrBindEntry=natAddrBindEntry, natInterfaceTable=natInterfaceTable, natMappingMapBehavior=natMappingMapBehavior, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natStatsProtocolGroup=natStatsProtocolGroup, natMappingIntPort=natMappingIntPort, natL4ProtocolTable=natL4ProtocolTable, NatAddrMapId=NatAddrMapId, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natLimitSubscribers=natLimitSubscribers, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natAddrMapProtocol=natAddrMapProtocol, natGroupBasicNotifications=natGroupBasicNotifications, natPoolEntry=natPoolEntry, natAddrPortBindEntry=natAddrPortBindEntry, natPoolIndex=natPoolIndex, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natAddrMapDiscards=natAddrMapDiscards, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natAddrMapAddrUsed=natAddrMapAddrUsed, natPoolPortMin=natPoolPortMin, natSubscriberIntPrefix=natSubscriberIntPrefix, natSubscriberIdentifierType=natSubscriberIdentifierType, natL4ProtocolNumber=natL4ProtocolNumber, natGroupFragmentObjects=natGroupFragmentObjects, natBindDefIdleTimeout=natBindDefIdleTimeout, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natInterfaceStorageType=natInterfaceStorageType, natPoolRangeTable=natPoolRangeTable, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natAddrPortBindProtocol=natAddrPortBindProtocol, natSubsInterfaceIndex=natSubsInterfaceIndex, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natAddrMapInTranslates=natAddrMapInTranslates, natPoolObjects=natPoolObjects, natAddressMappingCreations=natAddressMappingCreations, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natAddrBindOutTranslates=natAddrBindOutTranslates, PYSNMP_MODULE_ID=natMIB, natMIBObjects=natMIBObjects, natAddressMappingRemovals=natAddressMappingRemovals, natPoolRangeEnd=natPoolRangeEnd, natAddrBindType=natAddrBindType, natLimitsEntry=natLimitsEntry, natL4ProtocolEntry=natL4ProtocolEntry, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natL4ProtocolTranslations=natL4ProtocolTranslations, natInstanceAlias=natInstanceAlias, natTranslationGroup=natTranslationGroup, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natBasicStatefulCompliance=natBasicStatefulCompliance, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natMapIntAddrIntType=natMapIntAddrIntType, natStatsAddrMapGroup=natStatsAddrMapGroup, natMIB=natMIB, natSubscribersEntry=natSubscribersEntry, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natMIBNotifications=natMIBNotifications, natSubscribersTable=natSubscribersTable, natAddrMapCompliance=natAddrMapCompliance, natAddrBindMapIndex=natAddrBindMapIndex, natInterfaceRealm=natInterfaceRealm, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natMappingIntAddress=natMappingIntAddress, natConfigGroup=natConfigGroup, natCountersTable=natCountersTable, natAddrPortBindId=natAddrPortBindId, natMappingTable=natMappingTable, natSessionPublicDstAddr=natSessionPublicDstAddr, natSessionInTranslates=natSessionInTranslates, natInterfaceOutTranslates=natInterfaceOutTranslates, natAddrMapEntryType=natAddrMapEntryType, natPoolRangeAllocations=natPoolRangeAllocations, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natAddrBindInTranslates=natAddrBindInTranslates, NatBindId=NatBindId, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natNotifMappings=natNotifMappings, natLimitMappings=natLimitMappings, natMappingIntAddressType=natMappingIntAddressType, natSessionUpTime=natSessionUpTime, natAddrBindTable=natAddrBindTable, natMappingPool=natMappingPool, natGroupStatefulObjects=natGroupStatefulObjects, NatAssociationType=NatAssociationType, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natInterfaceInTranslates=natInterfaceInTranslates, natSessionEntry=natSessionEntry, natMIBCompliances=natMIBCompliances, natAddrMapRowStatus=natAddrMapRowStatus, natAddrPortBindTable=natAddrPortBindTable, natInterfaceEntry=natInterfaceEntry, natPoolRangeDeallocations=natPoolRangeDeallocations, natStatsInterfaceGroup=natStatsInterfaceGroup, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natOutOfPortErrors=natOutOfPortErrors, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natInstanceEntry=natInstanceEntry, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natSubscriberResourceErrors=natSubscriberResourceErrors, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natPoolRangeType=natPoolRangeType, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natAddrMapIndex=natAddrMapIndex, natMIBNotificationGroup=natMIBNotificationGroup, natInstanceTable=natInstanceTable, natPoolRealm=natPoolRealm, natPoolWatermarkLow=natPoolWatermarkLow, natDefTimeouts=natDefTimeouts, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natAddrMapStorageType=natAddrMapStorageType, NatBindMode=NatBindMode, natMIBFullCompliance=natMIBFullCompliance, natNotifCtrl=natNotifCtrl, natSessionPublicDstPort=natSessionPublicDstPort, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natUdpDefIdleTimeout=natUdpDefIdleTimeout, SubscriberIdentifierType=SubscriberIdentifierType, natCounters=natCounters, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natSessionProtocolType=natSessionProtocolType, natSessionPublicAddrType=natSessionPublicAddrType, natLimitsTable=natLimitsTable, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natMappingExtPort=natMappingExtPort, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natTranslations=natTranslations, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natLimitAddressMappings=natLimitAddressMappings, natAddrMapName=natAddrMapName, natPoolWatermarkHigh=natPoolWatermarkHigh, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natMappingProto=natMappingProto, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natSessionOutTranslates=natSessionOutTranslates, natGroupAddrMapObjects=natGroupAddrMapObjects, natAddrMapTable=natAddrMapTable, natSubscriberLimitMappings=natSubscriberLimitMappings, NatProtocolMap=NatProtocolMap, natMapIntAddrExt=natMapIntAddrExt, natLimitFragments=natLimitFragments, natSessionPublicSrcPort=natSessionPublicSrcPort, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natCountersEntry=natCountersEntry, natPoolTable=natPoolTable, natSubscriberRealm=natSubscriberRealm, natMappingCreations=natMappingCreations, natInterfaceRowStatus=natInterfaceRowStatus, natPoolRangePoolIndex=natPoolRangePoolIndex, natSubscribers=natSubscribers, NatTranslationEntity=NatTranslationEntity, natNotifAddrMappings=natNotifAddrMappings, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natAddrBindId=natAddrBindId, natSessionAddrMapIndex=natSessionAddrMapIndex, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natSessionTable=natSessionTable, natSubscriberIndex=natSubscriberIndex, natMappingRemovals=natMappingRemovals, natMappingIntRealm=natMappingIntRealm)
mibBuilder.exportSymbols("NAT-MIB", natAddrMapLocalAddrType=natAddrMapLocalAddrType, natNotifThrottlingInterval=natNotifThrottlingInterval, natPoolRangeBegin=natPoolRangeBegin, natMappingExtRealm=natMappingExtRealm, natQuotaDrops=natQuotaDrops)
