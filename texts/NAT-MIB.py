...
mibBuilder.exportSymbols("NAT-MIB", natAddrMapEntry=natAddrMapEntry, natLimitSubscribers=natLimitSubscribers, natProtocol=natProtocol, natInstanceIndex=natInstanceIndex, natCountersEntry=natCountersEntry, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natSessionEntry=natSessionEntry, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natPoolRangeAllocations=natPoolRangeAllocations, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natPoolRangePoolIndex=natPoolRangePoolIndex, natPoolPortMin=natPoolPortMin, natLimitAddressMappings=natLimitAddressMappings, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natLimitFragments=natLimitFragments, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natInterfaceServiceType=natInterfaceServiceType, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natGroupBasicNotifications=natGroupBasicNotifications, natAddrPortBindTable=natAddrPortBindTable, NatProtocolMap=NatProtocolMap, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natInterfaceStorageType=natInterfaceStorageType, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natSubscriberResourceErrors=natSubscriberResourceErrors, natAddrBindType=natAddrBindType, natAddrBindOutTranslates=natAddrBindOutTranslates, natMapIntAddrExt=natMapIntAddrExt, natAddrMapName=natAddrMapName, natProtocolDiscards=natProtocolDiscards, natAddrPortBindType=natAddrPortBindType, NatTranslationEntity=NatTranslationEntity, natMapIntAddrEntry=natMapIntAddrEntry, natMappingExtPort=natMappingExtPort, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, NatBindIdOrZero=NatBindIdOrZero, natInterfaceTable=natInterfaceTable, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natAddrPortBindId=natAddrPortBindId, natSessionProtocolType=natSessionProtocolType, natNotifAddrMappings=natNotifAddrMappings, VlanIndexOrZero=VlanIndexOrZero, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natStatsAddrMapGroup=natStatsAddrMapGroup, natMappingSubsIndex=natMappingSubsIndex, PYSNMP_MODULE_ID=natMIB, natL4ProtocolNumber=natL4ProtocolNumber, natAddressMappingCreations=natAddressMappingCreations, natGroupStatefulObjects=natGroupStatefulObjects, natSessionPrivateDstPort=natSessionPrivateDstPort, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, NatBindMode=NatBindMode, natPoolWatermarkLow=natPoolWatermarkLow, natNotifSubscriberMappings=natNotifSubscriberMappings, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natSessionTable=natSessionTable, natPoolPortMax=natPoolPortMax, natInterfaceRowStatus=natInterfaceRowStatus, natAddrMapCompliance=natAddrMapCompliance, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natMappingExtRealm=natMappingExtRealm, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natPoolRangeBegin=natPoolRangeBegin, NatAddrMapId=NatAddrMapId, natLimitMappings=natLimitMappings, natInterfaceDiscards=natInterfaceDiscards, natMappingCreations=natMappingCreations, natMIBCompliances=natMIBCompliances, natStatsInterfaceGroup=natStatsInterfaceGroup, natL4ProtocolEntry=natL4ProtocolEntry, natTcpDefNegTimeout=natTcpDefNegTimeout, natAddrMapInTranslates=natAddrMapInTranslates, natAddrMapDiscards=natAddrMapDiscards, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natNotifMappings=natNotifMappings, natSubscriberIdentifierType=natSubscriberIdentifierType, natMappingRemovals=natMappingRemovals, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natMappingProto=natMappingProto, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natSessionOutTranslates=natSessionOutTranslates, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natCGNCompliance=natCGNCompliance, natSessionDirection=natSessionDirection, natProtocolTable=natProtocolTable, natL4ProtocolTranslations=natL4ProtocolTranslations, natSessionUpTime=natSessionUpTime, natAddrMapOutTranslates=natAddrMapOutTranslates, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natSubsInterfaceIndex=natSubsInterfaceIndex, SubscriberIdentifierType=SubscriberIdentifierType, natGroupFragmentObjects=natGroupFragmentObjects, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natAddrBindId=natAddrBindId, natSubscribersTable=natSubscribersTable, natPoolRangeEntry=natPoolRangeEntry, natAddrBindEntry=natAddrBindEntry, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natTranslationGroup=natTranslationGroup, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natInterfaceInTranslates=natInterfaceInTranslates, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natStatsProtocolGroup=natStatsProtocolGroup, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natAddrPortBindEntry=natAddrPortBindEntry, natMappingEntry=natMappingEntry, natMappingIntRealm=natMappingIntRealm, natPoolRangeTable=natPoolRangeTable, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natAddrMapStorageType=natAddrMapStorageType, natMappingMapBehavior=natMappingMapBehavior, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natMappingExtAddressType=natMappingExtAddressType, natAddrPortBindProtocol=natAddrPortBindProtocol, natSubscribersEntry=natSubscribersEntry, natSessionIndex=natSessionIndex, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natQuotaDrops=natQuotaDrops, natMIBObjects=natMIBObjects, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natConfigGroup=natConfigGroup, natSessionPublicDstAddr=natSessionPublicDstAddr, natNotifCtrl=natNotifCtrl, NatPoolId=NatPoolId, natGroupSubscriberObjects=natGroupSubscriberObjects, natPoolObjects=natPoolObjects, NatBindId=NatBindId, natResourceErrors=natResourceErrors, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natSessionPrivateAddrType=natSessionPrivateAddrType, natSessionPublicSrcPort=natSessionPublicSrcPort, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natSessionPublicDstPort=natSessionPublicDstPort, natMIBNotificationGroup=natMIBNotificationGroup, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natBasicStatelessCompliance=natBasicStatelessCompliance, natMIBConformance=natMIBConformance, ProtocolNumber=ProtocolNumber, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, NatSessionId=NatSessionId, natSubscriberIntPrefix=natSubscriberIntPrefix, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natMapIntAddrInt=natMapIntAddrInt, natDefTimeouts=natDefTimeouts, natMapObjects=natMapObjects, natMapIntAddrExtType=natMapIntAddrExtType, SubscriberIndex=SubscriberIndex, natLimitsTable=natLimitsTable, natProtocolOutTranslates=natProtocolOutTranslates, natPoolRealm=natPoolRealm, natInstanceTable=natInstanceTable, natAddrBindInTranslates=natAddrBindInTranslates, natAddressMappingRemovals=natAddressMappingRemovals, natSessionPublicAddrType=natSessionPublicAddrType, NatProtocolType=NatProtocolType, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natNotifThrottlingInterval=natNotifThrottlingInterval, natLimitsEntry=natLimitsEntry, natAddrBindMapIndex=natAddrBindMapIndex, natMappingAddressPooling=natMappingAddressPooling, natPoolRangeDeallocations=natPoolRangeDeallocations, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, NatBehaviorType=NatBehaviorType, natInterfaceOutTranslates=natInterfaceOutTranslates, natBindDefIdleTimeout=natBindDefIdleTimeout, NatAssociationType=NatAssociationType, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natPoolRangeEnd=natPoolRangeEnd, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natSubscriberIndex=natSubscriberIndex, natSubscriberTranslations=natSubscriberTranslations, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natMappingFilterBehavior=natMappingFilterBehavior, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natSessionAddrMapIndex=natSessionAddrMapIndex, natSubscriberMappingCreations=natSubscriberMappingCreations, natAddrMapTable=natAddrMapTable, natL4ProtocolTable=natL4ProtocolTable, natPoolEntry=natPoolEntry, natInterfaceEntry=natInterfaceEntry, natPoolTable=natPoolTable, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natMappingExtAddress=natMappingExtAddress, natPacketDiscard=natPacketDiscard, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natGroupAddrMapObjects=natGroupAddrMapObjects, natAddrBindLocalAddr=natAddrBindLocalAddr, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natMapIntAddrIntType=natMapIntAddrIntType, natInstanceEntry=natInstanceEntry, natAddrBindTable=natAddrBindTable, NatPoolingType=NatPoolingType, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natAddrPortBindSessions=natAddrPortBindSessions, natMIBGroups=natMIBGroups, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natPoolIndex=natPoolIndex, natSubscriberRealm=natSubscriberRealm, natMIBFullCompliance=natMIBFullCompliance, natSubscriberLimitMappings=natSubscriberLimitMappings, natCounters=natCounters, natMIB=natMIB, natGroupStatelessObjects=natGroupStatelessObjects, natSessionMaxIdleTime=natSessionMaxIdleTime, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natProtocolInTranslates=natProtocolInTranslates, natMappingIntAddress=natMappingIntAddress, natAddrMapIndex=natAddrMapIndex, natAddrBindSessions=natAddrBindSessions, natInterfaceRealm=natInterfaceRealm, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natMapIntAddrTable=natMapIntAddrTable, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natFragmentsCompliance=natFragmentsCompliance, natSessionInTranslates=natSessionInTranslates, natAddrMapProtocol=natAddrMapProtocol, natAddrMapEntryType=natAddrMapEntryType, natPoolRangeType=natPoolRangeType, natInstanceAlias=natInstanceAlias, natProtocolEntry=natProtocolEntry, natAddrMapAddrUsed=natAddrMapAddrUsed, natOutOfPortErrors=natOutOfPortErrors, natMappingPool=natMappingPool, natAddrMapRowStatus=natAddrMapRowStatus, natSubscribers=natSubscribers, natTranslations=natTranslations, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natMIBNotifications=natMIBNotifications, natMappingTable=natMappingTable, natMappingIntPort=natMappingIntPort, natCountersTable=natCountersTable, natPoolWatermarkHigh=natPoolWatermarkHigh, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort)
mibBuilder.exportSymbols("NAT-MIB", natMappingIntAddressType=natMappingIntAddressType, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natBasicStatefulCompliance=natBasicStatefulCompliance)
