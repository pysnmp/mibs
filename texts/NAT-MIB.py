...
mibBuilder.exportSymbols("NAT-MIB", natTcpDefNegTimeout=natTcpDefNegTimeout, natInterfaceTable=natInterfaceTable, natAddrMapAddrUsed=natAddrMapAddrUsed, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natBasicStatefulCompliance=natBasicStatefulCompliance, natSessionUpTime=natSessionUpTime, natTcpDefIdleTimeout=natTcpDefIdleTimeout, NatAddrMapId=NatAddrMapId, natPoolRangeTable=natPoolRangeTable, natLimitAddressMappings=natLimitAddressMappings, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natLimitMappings=natLimitMappings, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natAddrMapEntryType=natAddrMapEntryType, natSessionPrivateDstPort=natSessionPrivateDstPort, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natAddrMapInTranslates=natAddrMapInTranslates, natSubscriberMappingCreations=natSubscriberMappingCreations, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natCounters=natCounters, natSessionInTranslates=natSessionInTranslates, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natPoolEntry=natPoolEntry, natSubscriberLimitMappings=natSubscriberLimitMappings, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natPoolRangeDeallocations=natPoolRangeDeallocations, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natSessionPrivateAddrType=natSessionPrivateAddrType, natMappingTable=natMappingTable, NatTranslationEntity=NatTranslationEntity, natAddrBindMapIndex=natAddrBindMapIndex, natMappingIntAddress=natMappingIntAddress, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natBindDefIdleTimeout=natBindDefIdleTimeout, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natPoolRangeBegin=natPoolRangeBegin, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natPacketDiscard=natPacketDiscard, natAddrMapName=natAddrMapName, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natQuotaDrops=natQuotaDrops, natSubscribersEntry=natSubscribersEntry, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natNotifSubscriberMappings=natNotifSubscriberMappings, natL4ProtocolNumber=natL4ProtocolNumber, natNotifCtrl=natNotifCtrl, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natTranslationGroup=natTranslationGroup, natMappingIntAddressType=natMappingIntAddressType, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natMIB=natMIB, natPoolPortMax=natPoolPortMax, natPoolWatermarkLow=natPoolWatermarkLow, natAddrBindType=natAddrBindType, natAddrMapStorageType=natAddrMapStorageType, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natStatsAddrMapGroup=natStatsAddrMapGroup, natSubscriberIntPrefix=natSubscriberIntPrefix, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natSubscriberResourceErrors=natSubscriberResourceErrors, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natMappingExtAddressType=natMappingExtAddressType, natSessionMaxIdleTime=natSessionMaxIdleTime, natAddrPortBindSessions=natAddrPortBindSessions, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natPoolPortMin=natPoolPortMin, ProtocolNumber=ProtocolNumber, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, NatBindMode=NatBindMode, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natProtocolDiscards=natProtocolDiscards, natMapIntAddrExtType=natMapIntAddrExtType, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natSessionTable=natSessionTable, NatBehaviorType=NatBehaviorType, natLimitsTable=natLimitsTable, natAddrMapDiscards=natAddrMapDiscards, natInterfaceOutTranslates=natInterfaceOutTranslates, natAddrBindTable=natAddrBindTable, natSessionPublicDstPort=natSessionPublicDstPort, NatBindIdOrZero=NatBindIdOrZero, natSessionOutTranslates=natSessionOutTranslates, natPoolRangePoolIndex=natPoolRangePoolIndex, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natMappingMapBehavior=natMappingMapBehavior, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natLimitFragments=natLimitFragments, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natInstanceEntry=natInstanceEntry, natSessionPublicDstAddr=natSessionPublicDstAddr, natPoolRealm=natPoolRealm, natL4ProtocolTable=natL4ProtocolTable, natSessionIndex=natSessionIndex, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natInterfaceInTranslates=natInterfaceInTranslates, natMapIntAddrIntRealm=natMapIntAddrIntRealm, SubscriberIdentifierType=SubscriberIdentifierType, natAddrMapIndex=natAddrMapIndex, natSessionDirection=natSessionDirection, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natInterfaceDiscards=natInterfaceDiscards, natInterfaceStorageType=natInterfaceStorageType, natAddrBindOutTranslates=natAddrBindOutTranslates, natInterfaceServiceType=natInterfaceServiceType, natProtocolEntry=natProtocolEntry, natSessionPublicAddrType=natSessionPublicAddrType, natGroupAddrMapObjects=natGroupAddrMapObjects, natMappingCreations=natMappingCreations, natAddrMapRowStatus=natAddrMapRowStatus, natGroupStatefulObjects=natGroupStatefulObjects, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natDefTimeouts=natDefTimeouts, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natMapObjects=natMapObjects, natInterfaceEntry=natInterfaceEntry, natMappingIntRealm=natMappingIntRealm, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natCountersEntry=natCountersEntry, natMIBFullCompliance=natMIBFullCompliance, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natL4ProtocolEntry=natL4ProtocolEntry, natMIBObjects=natMIBObjects, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natAddressMappingCreations=natAddressMappingCreations, natMappingPool=natMappingPool, natAddrBindId=natAddrBindId, natNotifThrottlingInterval=natNotifThrottlingInterval, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natMappingFilterBehavior=natMappingFilterBehavior, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natTranslations=natTranslations, natMappingAddressPooling=natMappingAddressPooling, natCGNCompliance=natCGNCompliance, natProtocolTable=natProtocolTable, natOutOfPortErrors=natOutOfPortErrors, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, NatProtocolType=NatProtocolType, natFragmentsCompliance=natFragmentsCompliance, PYSNMP_MODULE_ID=natMIB, natConfigGroup=natConfigGroup, natGroupSubscriberObjects=natGroupSubscriberObjects, natAddressMappingRemovals=natAddressMappingRemovals, natMappingSubsIndex=natMappingSubsIndex, natNotifMappings=natNotifMappings, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, NatProtocolMap=NatProtocolMap, natAddrPortBindId=natAddrPortBindId, natMIBNotifications=natMIBNotifications, natAddrPortBindEntry=natAddrPortBindEntry, natSubscriberTranslations=natSubscriberTranslations, natMapIntAddrTable=natMapIntAddrTable, natResourceErrors=natResourceErrors, natAddrBindInTranslates=natAddrBindInTranslates, natPoolRangeAllocations=natPoolRangeAllocations, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natInstanceIndex=natInstanceIndex, natMIBGroups=natMIBGroups, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natPoolRangeEntry=natPoolRangeEntry, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natProtocolOutTranslates=natProtocolOutTranslates, natMapIntAddrEntry=natMapIntAddrEntry, natMappingExtPort=natMappingExtPort, natInterfaceRowStatus=natInterfaceRowStatus, natAddrPortBindType=natAddrPortBindType, natInstanceAlias=natInstanceAlias, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natAddrMapCompliance=natAddrMapCompliance, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, NatPoolingType=NatPoolingType, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natPoolRangeType=natPoolRangeType, natMapIntAddrExt=natMapIntAddrExt, natMappingEntry=natMappingEntry, natLimitSubscribers=natLimitSubscribers, natGroupBasicNotifications=natGroupBasicNotifications, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natAddrBindLocalAddr=natAddrBindLocalAddr, natPoolIndex=natPoolIndex, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, VlanIndexOrZero=VlanIndexOrZero, natSubsInterfaceIndex=natSubsInterfaceIndex, natAddrMapOutTranslates=natAddrMapOutTranslates, natAddrBindEntry=natAddrBindEntry, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natSessionEntry=natSessionEntry, natInstanceTable=natInstanceTable, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natStatsProtocolGroup=natStatsProtocolGroup, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natL4ProtocolTranslations=natL4ProtocolTranslations, natMapIntAddrIntType=natMapIntAddrIntType, natMappingExtAddress=natMappingExtAddress, natGroupStatelessObjects=natGroupStatelessObjects, natSessionPublicSrcPort=natSessionPublicSrcPort, natGroupFragmentObjects=natGroupFragmentObjects, natAddrPortBindProtocol=natAddrPortBindProtocol, natCountersTable=natCountersTable, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natMappingExtRealm=natMappingExtRealm, natPoolObjects=natPoolObjects, NatBindId=NatBindId, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natSubscriberIndex=natSubscriberIndex, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natSubscribers=natSubscribers, natAddrPortBindTable=natAddrPortBindTable, natProtocol=natProtocol, natPoolWatermarkHigh=natPoolWatermarkHigh, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natAddrMapEntry=natAddrMapEntry, natSessionAddrMapIndex=natSessionAddrMapIndex, natProtocolInTranslates=natProtocolInTranslates, natStatsInterfaceGroup=natStatsInterfaceGroup, natAddrBindSessions=natAddrBindSessions, natNotifAddrMappings=natNotifAddrMappings, natMappingRemovals=natMappingRemovals, NatPoolId=NatPoolId, SubscriberIndex=SubscriberIndex, natPoolTable=natPoolTable, natPoolRangeEnd=natPoolRangeEnd, natInterfaceRealm=natInterfaceRealm, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natSubscribersTable=natSubscribersTable, natMIBConformance=natMIBConformance, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natAddrMapProtocol=natAddrMapProtocol, natMIBCompliances=natMIBCompliances, natSubscriberRealm=natSubscriberRealm, natBasicStatelessCompliance=natBasicStatelessCompliance, natMIBNotificationGroup=natMIBNotificationGroup, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natMappingProto=natMappingProto, natSubscriberIdentifierType=natSubscriberIdentifierType, natSessionProtocolType=natSessionProtocolType, natMapIntAddrInt=natMapIntAddrInt, NatAssociationType=NatAssociationType)
mibBuilder.exportSymbols("NAT-MIB", natLimitsEntry=natLimitsEntry, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natAddrMapTable=natAddrMapTable, NatSessionId=NatSessionId, natMappingIntPort=natMappingIntPort)
