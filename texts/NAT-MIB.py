...
mibBuilder.exportSymbols("NAT-MIB", natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natPacketDiscard=natPacketDiscard, natCountersEntry=natCountersEntry, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natAddrBindMapIndex=natAddrBindMapIndex, natSessionTable=natSessionTable, natMappingTable=natMappingTable, natSessionAddrMapIndex=natSessionAddrMapIndex, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natAddrBindOutTranslates=natAddrBindOutTranslates, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natMapIntAddrExtRealm=natMapIntAddrExtRealm, NatProtocolMap=NatProtocolMap, natLimitSubscribers=natLimitSubscribers, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natInterfaceRealm=natInterfaceRealm, natMIBGroups=natMIBGroups, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natGroupSubscriberObjects=natGroupSubscriberObjects, natAddrBindType=natAddrBindType, SubscriberIndex=SubscriberIndex, natSessionPublicDstPort=natSessionPublicDstPort, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natAddrMapOutTranslates=natAddrMapOutTranslates, natStatsAddrMapGroup=natStatsAddrMapGroup, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natPoolPortMin=natPoolPortMin, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natMIB=natMIB, natPoolRangeDeallocations=natPoolRangeDeallocations, natMappingCreations=natMappingCreations, natPoolRangeEnd=natPoolRangeEnd, natInterfaceRowStatus=natInterfaceRowStatus, natMappingSubsIndex=natMappingSubsIndex, natInterfaceOutTranslates=natInterfaceOutTranslates, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natCGNCompliance=natCGNCompliance, natAddrMapEntryType=natAddrMapEntryType, natAddrMapDiscards=natAddrMapDiscards, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natInterfaceStorageType=natInterfaceStorageType, natL4ProtocolTranslations=natL4ProtocolTranslations, natAddrMapName=natAddrMapName, natMIBConformance=natMIBConformance, NatTranslationEntity=NatTranslationEntity, natPoolRangePoolIndex=natPoolRangePoolIndex, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natNotifAddrMappings=natNotifAddrMappings, natPoolPortMax=natPoolPortMax, natAddrMapEntry=natAddrMapEntry, natBasicStatefulCompliance=natBasicStatefulCompliance, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natAddrMapAddrUsed=natAddrMapAddrUsed, natMapIntAddrTable=natMapIntAddrTable, natCountersTable=natCountersTable, natPoolObjects=natPoolObjects, natNotifCtrl=natNotifCtrl, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natPoolWatermarkLow=natPoolWatermarkLow, natGroupAddrMapObjects=natGroupAddrMapObjects, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natSessionInTranslates=natSessionInTranslates, natSubscriberIndex=natSubscriberIndex, natMappingFilterBehavior=natMappingFilterBehavior, natGroupStatelessObjects=natGroupStatelessObjects, natMappingEntry=natMappingEntry, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natAddrPortBindType=natAddrPortBindType, natBindDefIdleTimeout=natBindDefIdleTimeout, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natNotifSubscriberMappings=natNotifSubscriberMappings, natMIBNotifications=natMIBNotifications, natAddrPortBindSessions=natAddrPortBindSessions, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natTranslationGroup=natTranslationGroup, NatAssociationType=NatAssociationType, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natStatsProtocolGroup=natStatsProtocolGroup, natNotifMappings=natNotifMappings, natInstanceTable=natInstanceTable, natCounters=natCounters, natResourceErrors=natResourceErrors, natAddrBindInTranslates=natAddrBindInTranslates, natPoolWatermarkHigh=natPoolWatermarkHigh, natAddrMapRowStatus=natAddrMapRowStatus, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natConfigGroup=natConfigGroup, natSessionDirection=natSessionDirection, natSessionPrivateAddrType=natSessionPrivateAddrType, natAddrMapInTranslates=natAddrMapInTranslates, natInstanceAlias=natInstanceAlias, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, NatPoolId=NatPoolId, natInterfaceInTranslates=natInterfaceInTranslates, natAddressMappingRemovals=natAddressMappingRemovals, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natSessionPublicAddrType=natSessionPublicAddrType, ProtocolNumber=ProtocolNumber, natMappingIntPort=natMappingIntPort, VlanIndexOrZero=VlanIndexOrZero, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natAddrPortBindId=natAddrPortBindId, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natLimitsTable=natLimitsTable, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natPoolRealm=natPoolRealm, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natSessionOutTranslates=natSessionOutTranslates, NatBindIdOrZero=NatBindIdOrZero, natAddrBindEntry=natAddrBindEntry, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natMappingMapBehavior=natMappingMapBehavior, natL4ProtocolNumber=natL4ProtocolNumber, natLimitMappings=natLimitMappings, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natTranslations=natTranslations, natInterfaceEntry=natInterfaceEntry, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natSessionPrivateDstPort=natSessionPrivateDstPort, NatProtocolType=NatProtocolType, natSubscriberLimitMappings=natSubscriberLimitMappings, natSessionUpTime=natSessionUpTime, natMIBCompliances=natMIBCompliances, natInstanceEntry=natInstanceEntry, natMapObjects=natMapObjects, natStatsInterfaceGroup=natStatsInterfaceGroup, natAddrMapProtocol=natAddrMapProtocol, natAddrPortBindProtocol=natAddrPortBindProtocol, natInterfaceDiscards=natInterfaceDiscards, natSessionProtocolType=natSessionProtocolType, natSubscriberResourceErrors=natSubscriberResourceErrors, natSubsInterfaceIndex=natSubsInterfaceIndex, natSubscribersEntry=natSubscribersEntry, natGroupStatefulObjects=natGroupStatefulObjects, NatSessionId=NatSessionId, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, NatPoolingType=NatPoolingType, natPoolRangeTable=natPoolRangeTable, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natSubscribersTable=natSubscribersTable, natFragmentsCompliance=natFragmentsCompliance, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natMappingIntRealm=natMappingIntRealm, natSessionMaxIdleTime=natSessionMaxIdleTime, natMapIntAddrExt=natMapIntAddrExt, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natSubscriberIdentifierType=natSubscriberIdentifierType, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natMappingProto=natMappingProto, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natInstanceIndex=natInstanceIndex, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natLimitsEntry=natLimitsEntry, NatBindMode=NatBindMode, natAddrBindSessions=natAddrBindSessions, natSubscriberMappingCreations=natSubscriberMappingCreations, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natAddrMapTable=natAddrMapTable, natSessionPublicDstAddr=natSessionPublicDstAddr, natProtocolDiscards=natProtocolDiscards, natLimitAddressMappings=natLimitAddressMappings, natL4ProtocolTable=natL4ProtocolTable, natAddrPortBindTable=natAddrPortBindTable, natMappingExtAddressType=natMappingExtAddressType, natProtocolOutTranslates=natProtocolOutTranslates, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natSubscriberRealm=natSubscriberRealm, natMappingExtRealm=natMappingExtRealm, natAddrMapStorageType=natAddrMapStorageType, NatAddrMapId=NatAddrMapId, natQuotaDrops=natQuotaDrops, natSessionIndex=natSessionIndex, natMapIntAddrInt=natMapIntAddrInt, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natProtocolEntry=natProtocolEntry, natInterfaceServiceType=natInterfaceServiceType, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natSubscriberIntPrefix=natSubscriberIntPrefix, natPoolRangeAllocations=natPoolRangeAllocations, natProtocol=natProtocol, natL4ProtocolEntry=natL4ProtocolEntry, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natMIBObjects=natMIBObjects, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natSubscribers=natSubscribers, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natMappingExtPort=natMappingExtPort, SubscriberIdentifierType=SubscriberIdentifierType, natPoolRangeEntry=natPoolRangeEntry, PYSNMP_MODULE_ID=natMIB, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natMappingPool=natMappingPool, natMapIntAddrIntType=natMapIntAddrIntType, natAddrMapCompliance=natAddrMapCompliance, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natLimitFragments=natLimitFragments, natPoolRangeType=natPoolRangeType, natProtocolTable=natProtocolTable, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, NatBehaviorType=NatBehaviorType, natAddrMapIndex=natAddrMapIndex, natSessionPublicSrcPort=natSessionPublicSrcPort, natAddrBindId=natAddrBindId, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natSubscriberTranslations=natSubscriberTranslations, natSessionEntry=natSessionEntry, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natProtocolInTranslates=natProtocolInTranslates, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natPoolEntry=natPoolEntry, natPoolRangeBegin=natPoolRangeBegin, natPoolTable=natPoolTable, natDefTimeouts=natDefTimeouts, natMIBNotificationGroup=natMIBNotificationGroup, natMappingRemovals=natMappingRemovals, natMapIntAddrEntry=natMapIntAddrEntry, natOutOfPortErrors=natOutOfPortErrors, natBasicStatelessCompliance=natBasicStatelessCompliance, natMappingIntAddressType=natMappingIntAddressType, natNotifThrottlingInterval=natNotifThrottlingInterval, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natPoolIndex=natPoolIndex, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natAddrBindLocalAddr=natAddrBindLocalAddr, natMIBFullCompliance=natMIBFullCompliance, natMappingExtAddress=natMappingExtAddress, natAddrPortBindEntry=natAddrPortBindEntry, natInterfaceTable=natInterfaceTable, natMappingAddressPooling=natMappingAddressPooling, natAddressMappingCreations=natAddressMappingCreations, natGroupFragmentObjects=natGroupFragmentObjects, natGroupBasicNotifications=natGroupBasicNotifications)
mibBuilder.exportSymbols("NAT-MIB", natMappingIntAddress=natMappingIntAddress, NatBindId=NatBindId, natTcpDefNegTimeout=natTcpDefNegTimeout, natMapIntAddrExtType=natMapIntAddrExtType, natAddrBindTable=natAddrBindTable)
