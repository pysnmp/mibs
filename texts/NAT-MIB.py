...
mibBuilder.exportSymbols("NAT-MIB", natAddrBindEntry=natAddrBindEntry, natFragmentsCompliance=natFragmentsCompliance, natMIB=natMIB, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natMIBNotifications=natMIBNotifications, natMIBGroups=natMIBGroups, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natStatsAddrMapGroup=natStatsAddrMapGroup, natPoolRangeEnd=natPoolRangeEnd, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natSessionProtocolType=natSessionProtocolType, NatPoolingType=NatPoolingType, natAddrBindLocalAddr=natAddrBindLocalAddr, natQuotaDrops=natQuotaDrops, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natMappingSubsIndex=natMappingSubsIndex, natAddrPortBindProtocol=natAddrPortBindProtocol, natSubscriberIntPrefix=natSubscriberIntPrefix, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natNotifThrottlingInterval=natNotifThrottlingInterval, natAddrBindTable=natAddrBindTable, natSessionPublicDstAddr=natSessionPublicDstAddr, natSubscribers=natSubscribers, natMappingFilterBehavior=natMappingFilterBehavior, natSubscriberIdentifierType=natSubscriberIdentifierType, natBasicStatefulCompliance=natBasicStatefulCompliance, natMappingIntAddress=natMappingIntAddress, natAddrBindSessions=natAddrBindSessions, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, NatAddrMapId=NatAddrMapId, NatBindMode=NatBindMode, natMIBNotificationGroup=natMIBNotificationGroup, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natProtocolOutTranslates=natProtocolOutTranslates, natStatsProtocolGroup=natStatsProtocolGroup, natMapObjects=natMapObjects, natMappingExtAddressType=natMappingExtAddressType, NatAssociationType=NatAssociationType, NatProtocolType=NatProtocolType, natConfigGroup=natConfigGroup, natAddrPortBindEntry=natAddrPortBindEntry, natAddrMapAddrUsed=natAddrMapAddrUsed, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natMappingIntRealm=natMappingIntRealm, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, NatPoolId=NatPoolId, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natMappingCreations=natMappingCreations, natAddrMapOutTranslates=natAddrMapOutTranslates, natAddrPortBindSessions=natAddrPortBindSessions, natMappingRemovals=natMappingRemovals, natL4ProtocolEntry=natL4ProtocolEntry, natL4ProtocolNumber=natL4ProtocolNumber, natSubscriberMappingRemovals=natSubscriberMappingRemovals, NatTranslationEntity=NatTranslationEntity, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natSessionIndex=natSessionIndex, natInterfaceServiceType=natInterfaceServiceType, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natLimitsEntry=natLimitsEntry, natMappingIntPort=natMappingIntPort, natInterfaceDiscards=natInterfaceDiscards, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natL4ProtocolTranslations=natL4ProtocolTranslations, natTranslations=natTranslations, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natL4ProtocolTable=natL4ProtocolTable, natOtherDefIdleTimeout=natOtherDefIdleTimeout, SubscriberIdentifierType=SubscriberIdentifierType, natAddrBindLocalAddrType=natAddrBindLocalAddrType, SubscriberIndex=SubscriberIndex, natLimitsTable=natLimitsTable, NatBindId=NatBindId, natMappingAddressPooling=natMappingAddressPooling, natAddrMapCompliance=natAddrMapCompliance, natInstanceIndex=natInstanceIndex, natAddrPortBindId=natAddrPortBindId, natSubscriberIndex=natSubscriberIndex, natAddrMapIndex=natAddrMapIndex, natMappingIntAddressType=natMappingIntAddressType, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natPoolPortMax=natPoolPortMax, natMapIntAddrExtType=natMapIntAddrExtType, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natPoolRangeBegin=natPoolRangeBegin, natInstanceTable=natInstanceTable, natAddrMapName=natAddrMapName, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natGroupFragmentObjects=natGroupFragmentObjects, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natLimitSubscribers=natLimitSubscribers, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natTranslationGroup=natTranslationGroup, natStatsInterfaceGroup=natStatsInterfaceGroup, natAddrMapProtocol=natAddrMapProtocol, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natGroupBasicNotifications=natGroupBasicNotifications, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natLimitAddressMappings=natLimitAddressMappings, natProtocol=natProtocol, natAddrMapLocalAddrType=natAddrMapLocalAddrType, NatSessionId=NatSessionId, natNotifAddrMappings=natNotifAddrMappings, natInstanceAlias=natInstanceAlias, natCountersEntry=natCountersEntry, natMappingProto=natMappingProto, natMappingMapBehavior=natMappingMapBehavior, natPoolWatermarkHigh=natPoolWatermarkHigh, natSubscribersTable=natSubscribersTable, natSubscriberResourceErrors=natSubscriberResourceErrors, natCGNCompliance=natCGNCompliance, natAddrMapDiscards=natAddrMapDiscards, natMappingExtRealm=natMappingExtRealm, natPoolPortMin=natPoolPortMin, natDefTimeouts=natDefTimeouts, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natAddressMappingRemovals=natAddressMappingRemovals, natPoolRealm=natPoolRealm, natAddrBindOutTranslates=natAddrBindOutTranslates, natSessionEntry=natSessionEntry, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natSessionPrivateAddrType=natSessionPrivateAddrType, natSubscribersEntry=natSubscribersEntry, natPoolIndex=natPoolIndex, natSessionTable=natSessionTable, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natSubscriberMappingCreations=natSubscriberMappingCreations, natProtocolInTranslates=natProtocolInTranslates, natPoolRangeDeallocations=natPoolRangeDeallocations, natPoolRangeTable=natPoolRangeTable, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natSessionPrivateDstPort=natSessionPrivateDstPort, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natResourceErrors=natResourceErrors, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natSubsInterfaceIndex=natSubsInterfaceIndex, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natCounters=natCounters, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natSessionInTranslates=natSessionInTranslates, natGroupSubscriberObjects=natGroupSubscriberObjects, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natPoolRangePoolIndex=natPoolRangePoolIndex, natSessionPublicSrcPort=natSessionPublicSrcPort, natMapIntAddrTable=natMapIntAddrTable, natSessionAddrMapIndex=natSessionAddrMapIndex, natMappingTable=natMappingTable, natMIBCompliances=natMIBCompliances, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, ProtocolNumber=ProtocolNumber, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natSessionDirection=natSessionDirection, NatBehaviorType=NatBehaviorType, natBasicStatelessCompliance=natBasicStatelessCompliance, natPacketDiscard=natPacketDiscard, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natInterfaceEntry=natInterfaceEntry, natSubscriberLimitMappings=natSubscriberLimitMappings, natSessionMaxIdleTime=natSessionMaxIdleTime, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natNotifCtrl=natNotifCtrl, natInterfaceRowStatus=natInterfaceRowStatus, natPoolWatermarkLow=natPoolWatermarkLow, natInterfaceStorageType=natInterfaceStorageType, natProtocolDiscards=natProtocolDiscards, natSubscriberTranslations=natSubscriberTranslations, natAddrBindId=natAddrBindId, natGroupStatefulObjects=natGroupStatefulObjects, natSessionPublicAddrType=natSessionPublicAddrType, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natMIBConformance=natMIBConformance, natMapIntAddrIntType=natMapIntAddrIntType, natInstanceEntry=natInstanceEntry, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natAddrBindInTranslates=natAddrBindInTranslates, natOutOfPortErrors=natOutOfPortErrors, natPoolRangeAllocations=natPoolRangeAllocations, natInterfaceRealm=natInterfaceRealm, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natNotifSubscriberMappings=natNotifSubscriberMappings, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natMIBObjects=natMIBObjects, natPoolEntry=natPoolEntry, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natLimitMappings=natLimitMappings, natInterfaceInTranslates=natInterfaceInTranslates, NatBindIdOrZero=NatBindIdOrZero, VlanIndexOrZero=VlanIndexOrZero, natPoolRangeEntry=natPoolRangeEntry, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natMapIntAddrInt=natMapIntAddrInt, natLimitFragments=natLimitFragments, NatProtocolMap=NatProtocolMap, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natNotifMappings=natNotifMappings, natMappingEntry=natMappingEntry, natMappingPool=natMappingPool, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natSubscriberRealm=natSubscriberRealm, natMappingExtAddress=natMappingExtAddress, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, PYSNMP_MODULE_ID=natMIB, natGroupStatelessObjects=natGroupStatelessObjects, natAddrBindType=natAddrBindType, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natSessionPublicDstPort=natSessionPublicDstPort, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natSessionOutTranslates=natSessionOutTranslates, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natAddrMapStorageType=natAddrMapStorageType, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natMIBFullCompliance=natMIBFullCompliance, natMapIntAddrExt=natMapIntAddrExt, natInterfaceOutTranslates=natInterfaceOutTranslates, natAddressMappingCreations=natAddressMappingCreations, natAddrMapInTranslates=natAddrMapInTranslates, natInterfaceTable=natInterfaceTable, natAddrBindMapIndex=natAddrBindMapIndex, natPoolRangeType=natPoolRangeType, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natAddrMapEntry=natAddrMapEntry, natAddrPortBindTable=natAddrPortBindTable, natTcpDefNegTimeout=natTcpDefNegTimeout, natPoolObjects=natPoolObjects, natPoolTable=natPoolTable, natMappingExtPort=natMappingExtPort, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natProtocolEntry=natProtocolEntry, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natAddrMapEntryType=natAddrMapEntryType, natAddrPortBindType=natAddrPortBindType, natSessionUpTime=natSessionUpTime, natProtocolTable=natProtocolTable, natGroupAddrMapObjects=natGroupAddrMapObjects, natAddrMapTable=natAddrMapTable, natMapIntAddrEntry=natMapIntAddrEntry)
mibBuilder.exportSymbols("NAT-MIB", natCountersTable=natCountersTable, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natBindDefIdleTimeout=natBindDefIdleTimeout, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natAddrMapRowStatus=natAddrMapRowStatus)
