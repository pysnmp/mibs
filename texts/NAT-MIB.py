...
mibBuilder.exportSymbols("NAT-MIB", natSessionIndex=natSessionIndex, natAddrMapOutTranslates=natAddrMapOutTranslates, natProtocolOutTranslates=natProtocolOutTranslates, natMapObjects=natMapObjects, natProtocolTable=natProtocolTable, natAddrMapEntryType=natAddrMapEntryType, natStatsInterfaceGroup=natStatsInterfaceGroup, natInterfaceRowStatus=natInterfaceRowStatus, NatBehaviorType=NatBehaviorType, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natLimitAddressMappings=natLimitAddressMappings, natMappingCreations=natMappingCreations, natMapIntAddrEntry=natMapIntAddrEntry, natPacketDiscard=natPacketDiscard, natSubscriberTranslations=natSubscriberTranslations, natGroupSubscriberObjects=natGroupSubscriberObjects, natInterfaceInTranslates=natInterfaceInTranslates, natAddrBindOutTranslates=natAddrBindOutTranslates, natMappingProto=natMappingProto, natFragmentsCompliance=natFragmentsCompliance, natL4ProtocolTable=natL4ProtocolTable, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, NatProtocolType=NatProtocolType, natTcpDefNegTimeout=natTcpDefNegTimeout, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natStatsProtocolGroup=natStatsProtocolGroup, natCGNCompliance=natCGNCompliance, natGroupStatelessObjects=natGroupStatelessObjects, natSessionDirection=natSessionDirection, natAddrMapTable=natAddrMapTable, natAddrMapEntry=natAddrMapEntry, natMIBConformance=natMIBConformance, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natMIBFullCompliance=natMIBFullCompliance, natNotifSubscriberMappings=natNotifSubscriberMappings, natAddrMapTranslationEntity=natAddrMapTranslationEntity, NatProtocolMap=NatProtocolMap, NatBindMode=NatBindMode, natLimitSubscribers=natLimitSubscribers, natMapIntAddrExtType=natMapIntAddrExtType, NatAddrMapId=NatAddrMapId, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, PYSNMP_MODULE_ID=natMIB, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, NatBindId=NatBindId, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natPoolRangeTable=natPoolRangeTable, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natMapIntAddrIntType=natMapIntAddrIntType, natStatsAddrMapGroup=natStatsAddrMapGroup, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natSubscriberIndex=natSubscriberIndex, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natSubsInterfaceIndex=natSubsInterfaceIndex, NatTranslationEntity=NatTranslationEntity, natSessionPublicAddrType=natSessionPublicAddrType, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natSessionMaxIdleTime=natSessionMaxIdleTime, natSessionEntry=natSessionEntry, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natSessionOutTranslates=natSessionOutTranslates, natNotifMappings=natNotifMappings, natAddrBindTable=natAddrBindTable, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natPoolRangeType=natPoolRangeType, natMapIntAddrExt=natMapIntAddrExt, natSubscriberRealm=natSubscriberRealm, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natAddrMapProtocol=natAddrMapProtocol, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natAddrBindGlobalAddr=natAddrBindGlobalAddr, SubscriberIdentifierType=SubscriberIdentifierType, natPoolRangePoolIndex=natPoolRangePoolIndex, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natAddressMappingRemovals=natAddressMappingRemovals, natAddrPortBindSessions=natAddrPortBindSessions, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natInstanceEntry=natInstanceEntry, natInterfaceRealm=natInterfaceRealm, natSessionInTranslates=natSessionInTranslates, natProtocolDiscards=natProtocolDiscards, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natMIBNotifications=natMIBNotifications, natSubscriberResourceErrors=natSubscriberResourceErrors, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natPoolEntry=natPoolEntry, natSessionPublicDstAddr=natSessionPublicDstAddr, natOutOfPortErrors=natOutOfPortErrors, natAddrMapInTranslates=natAddrMapInTranslates, natAddrBindLocalAddr=natAddrBindLocalAddr, NatPoolId=NatPoolId, natBindDefIdleTimeout=natBindDefIdleTimeout, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natGroupBasicNotifications=natGroupBasicNotifications, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natProtocolInTranslates=natProtocolInTranslates, natConfigGroup=natConfigGroup, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natAddrMapIndex=natAddrMapIndex, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natAddrBindEntry=natAddrBindEntry, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natInterfaceDiscards=natInterfaceDiscards, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natAddrMapRowStatus=natAddrMapRowStatus, natAddrPortBindType=natAddrPortBindType, natAddressMappingCreations=natAddressMappingCreations, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natMappingFilterBehavior=natMappingFilterBehavior, natLimitsTable=natLimitsTable, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natPoolRangeEnd=natPoolRangeEnd, natAddrMapName=natAddrMapName, natDefTimeouts=natDefTimeouts, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, ProtocolNumber=ProtocolNumber, natSubscriberMappingCreations=natSubscriberMappingCreations, natMappingTable=natMappingTable, natAddrBindType=natAddrBindType, natL4ProtocolTranslations=natL4ProtocolTranslations, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natMIBNotificationGroup=natMIBNotificationGroup, natSessionUpTime=natSessionUpTime, natGroupAddrMapObjects=natGroupAddrMapObjects, natMIBGroups=natMIBGroups, natCounters=natCounters, natPoolRangeEntry=natPoolRangeEntry, natNotifAddrMappings=natNotifAddrMappings, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natSessionPrivateAddrType=natSessionPrivateAddrType, natPoolRealm=natPoolRealm, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natLimitMappings=natLimitMappings, natPoolWatermarkHigh=natPoolWatermarkHigh, SubscriberIndex=SubscriberIndex, natPoolPortMin=natPoolPortMin, natAddrBindSessions=natAddrBindSessions, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natMappingMapBehavior=natMappingMapBehavior, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natCountersTable=natCountersTable, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natInterfaceServiceType=natInterfaceServiceType, NatBindIdOrZero=NatBindIdOrZero, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natMappingIntPort=natMappingIntPort, natInstanceAlias=natInstanceAlias, natInterfaceOutTranslates=natInterfaceOutTranslates, natMappingRemovals=natMappingRemovals, natMappingEntry=natMappingEntry, natSubscribers=natSubscribers, natAddrPortBindProtocol=natAddrPortBindProtocol, natNotifCtrl=natNotifCtrl, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natSessionPublicSrcPort=natSessionPublicSrcPort, natMappingExtAddress=natMappingExtAddress, natMappingAddressPooling=natMappingAddressPooling, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natInstanceIndex=natInstanceIndex, natMappingIntAddressType=natMappingIntAddressType, natMIBCompliances=natMIBCompliances, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natMapIntAddrInt=natMapIntAddrInt, natPoolRangeAllocations=natPoolRangeAllocations, natL4ProtocolEntry=natL4ProtocolEntry, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natAddrMapStorageType=natAddrMapStorageType, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natQuotaDrops=natQuotaDrops, natAddrPortBindId=natAddrPortBindId, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natPoolIndex=natPoolIndex, natMappingExtPort=natMappingExtPort, natAddrMapCompliance=natAddrMapCompliance, natMapIntAddrTable=natMapIntAddrTable, natPoolRangeDeallocations=natPoolRangeDeallocations, natSubscriberLimitMappings=natSubscriberLimitMappings, natSessionCurrentIdleTime=natSessionCurrentIdleTime, NatPoolingType=NatPoolingType, VlanIndexOrZero=VlanIndexOrZero, natPoolPortMax=natPoolPortMax, natSessionPrivateDstPort=natSessionPrivateDstPort, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natLimitsEntry=natLimitsEntry, natSubscriberIntPrefix=natSubscriberIntPrefix, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natLimitFragments=natLimitFragments, natProtocolEntry=natProtocolEntry, natAddrBindInTranslates=natAddrBindInTranslates, natInterfaceStorageType=natInterfaceStorageType, natMappingPool=natMappingPool, natSessionAddrMapIndex=natSessionAddrMapIndex, natSessionProtocolType=natSessionProtocolType, natSessionTable=natSessionTable, natInterfaceTable=natInterfaceTable, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natCountersEntry=natCountersEntry, NatAssociationType=NatAssociationType, natAddrPortBindTable=natAddrPortBindTable, natL4ProtocolNumber=natL4ProtocolNumber, natGroupStatefulObjects=natGroupStatefulObjects, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natPoolWatermarkLow=natPoolWatermarkLow, NatSessionId=NatSessionId, natMappingIntAddress=natMappingIntAddress, natGroupFragmentObjects=natGroupFragmentObjects, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natSubscriberIdentifierType=natSubscriberIdentifierType, natProtocol=natProtocol, natMIB=natMIB, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natResourceErrors=natResourceErrors, natPoolRangeBegin=natPoolRangeBegin, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natMappingExtRealm=natMappingExtRealm, natMappingSubsIndex=natMappingSubsIndex, natSubscribersEntry=natSubscribersEntry, natTranslations=natTranslations, natAddrMapAddrUsed=natAddrMapAddrUsed, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natNotifThrottlingInterval=natNotifThrottlingInterval, natPoolObjects=natPoolObjects, natAddrMapDiscards=natAddrMapDiscards, natAddrPortBindEntry=natAddrPortBindEntry, natTranslationGroup=natTranslationGroup, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natPoolTable=natPoolTable, natMIBObjects=natMIBObjects, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natBasicStatefulCompliance=natBasicStatefulCompliance, natSessionPublicDstPort=natSessionPublicDstPort, natInterfaceEntry=natInterfaceEntry, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natInstanceTable=natInstanceTable, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natSubscribersTable=natSubscribersTable, natMappingIntRealm=natMappingIntRealm, natMappingExtAddressType=natMappingExtAddressType, natAddrBindId=natAddrBindId, natAddrBindMapIndex=natAddrBindMapIndex)
mibBuilder.exportSymbols("NAT-MIB", natBasicStatelessCompliance=natBasicStatelessCompliance, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals)
