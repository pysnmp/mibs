...
mibBuilder.exportSymbols("NAT-MIB", natAddrPortBindProtocol=natAddrPortBindProtocol, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natMappingIntPort=natMappingIntPort, natSubscriberIntPrefix=natSubscriberIntPrefix, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natTcpDefNegTimeout=natTcpDefNegTimeout, natInterfaceInTranslates=natInterfaceInTranslates, natSessionPublicDstPort=natSessionPublicDstPort, natMIBNotificationGroup=natMIBNotificationGroup, natGroupFragmentObjects=natGroupFragmentObjects, natSessionAddrMapIndex=natSessionAddrMapIndex, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natProtocolInTranslates=natProtocolInTranslates, natProtocolEntry=natProtocolEntry, natMIBNotifications=natMIBNotifications, natMappingRemovals=natMappingRemovals, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natProtocol=natProtocol, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natPoolRangePoolIndex=natPoolRangePoolIndex, NatTranslationEntity=NatTranslationEntity, natSessionMaxIdleTime=natSessionMaxIdleTime, natMappingIntRealm=natMappingIntRealm, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natInterfaceServiceType=natInterfaceServiceType, natAddrBindSessions=natAddrBindSessions, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natSubscribers=natSubscribers, natMIBGroups=natMIBGroups, SubscriberIndex=SubscriberIndex, natAddrMapAddrUsed=natAddrMapAddrUsed, natConfigGroup=natConfigGroup, NatPoolId=NatPoolId, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natAddressMappingCreations=natAddressMappingCreations, natSessionPublicAddrType=natSessionPublicAddrType, natLimitFragments=natLimitFragments, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, PYSNMP_MODULE_ID=natMIB, natInterfaceOutTranslates=natInterfaceOutTranslates, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natInterfaceEntry=natInterfaceEntry, natQuotaDrops=natQuotaDrops, natMapIntAddrEntry=natMapIntAddrEntry, natMapIntAddrExt=natMapIntAddrExt, natSubscriberResourceErrors=natSubscriberResourceErrors, natBasicStatelessCompliance=natBasicStatelessCompliance, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natPoolObjects=natPoolObjects, SubscriberIdentifierType=SubscriberIdentifierType, natMIBFullCompliance=natMIBFullCompliance, natNotifMappings=natNotifMappings, natInstanceIndex=natInstanceIndex, natGroupSubscriberObjects=natGroupSubscriberObjects, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natProtocolDiscards=natProtocolDiscards, natAddrMapInTranslates=natAddrMapInTranslates, natAddrBindType=natAddrBindType, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natOtherDefIdleTimeout=natOtherDefIdleTimeout, NatBehaviorType=NatBehaviorType, natMappingIntAddress=natMappingIntAddress, natInterfaceStorageType=natInterfaceStorageType, natInterfaceTable=natInterfaceTable, natMappingIntAddressType=natMappingIntAddressType, natMappingSubsIndex=natMappingSubsIndex, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natAddrBindOutTranslates=natAddrBindOutTranslates, natAddrMapEntryType=natAddrMapEntryType, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natMappingExtAddressType=natMappingExtAddressType, ProtocolNumber=ProtocolNumber, NatProtocolType=NatProtocolType, NatProtocolMap=NatProtocolMap, natAddrMapDiscards=natAddrMapDiscards, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natCountersEntry=natCountersEntry, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natInterfaceRealm=natInterfaceRealm, natResourceErrors=natResourceErrors, natAddrBindMapIndex=natAddrBindMapIndex, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natSessionUpTime=natSessionUpTime, natPoolRangeType=natPoolRangeType, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natTranslationGroup=natTranslationGroup, natSessionDirection=natSessionDirection, NatAssociationType=NatAssociationType, natStatsAddrMapGroup=natStatsAddrMapGroup, natGroupStatefulObjects=natGroupStatefulObjects, natMappingMapBehavior=natMappingMapBehavior, natGroupStatelessObjects=natGroupStatelessObjects, NatSessionId=NatSessionId, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natCounters=natCounters, natMappingExtPort=natMappingExtPort, natMappingAddressPooling=natMappingAddressPooling, natPacketDiscard=natPacketDiscard, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natSessionInTranslates=natSessionInTranslates, natMapObjects=natMapObjects, natSessionIndex=natSessionIndex, natSessionEntry=natSessionEntry, natAddressMappingRemovals=natAddressMappingRemovals, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natNotifSubscriberMappings=natNotifSubscriberMappings, natMapIntAddrIntType=natMapIntAddrIntType, natPoolPortMax=natPoolPortMax, natAddrMapEntry=natAddrMapEntry, natInstanceAlias=natInstanceAlias, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natStatsProtocolGroup=natStatsProtocolGroup, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natMIB=natMIB, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natPoolRealm=natPoolRealm, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natAddrPortBindId=natAddrPortBindId, natL4ProtocolNumber=natL4ProtocolNumber, natPoolIndex=natPoolIndex, natLimitAddressMappings=natLimitAddressMappings, natDefTimeouts=natDefTimeouts, VlanIndexOrZero=VlanIndexOrZero, natSessionPublicSrcPort=natSessionPublicSrcPort, natMappingEntry=natMappingEntry, natSubscribersTable=natSubscribersTable, natAddrMapTable=natAddrMapTable, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natLimitSubscribers=natLimitSubscribers, natMappingPool=natMappingPool, natFragmentsCompliance=natFragmentsCompliance, natSubscriberRealm=natSubscriberRealm, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natMappingExtAddress=natMappingExtAddress, natBasicStatefulCompliance=natBasicStatefulCompliance, natSubscriberLimitMappings=natSubscriberLimitMappings, natBindDefIdleTimeout=natBindDefIdleTimeout, natAddrMapRowStatus=natAddrMapRowStatus, natL4ProtocolTable=natL4ProtocolTable, natAddrBindInTranslates=natAddrBindInTranslates, natAddrMapCompliance=natAddrMapCompliance, natSessionTable=natSessionTable, NatBindId=NatBindId, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natPoolRangeBegin=natPoolRangeBegin, natCGNCompliance=natCGNCompliance, natSessionOutTranslates=natSessionOutTranslates, natL4ProtocolEntry=natL4ProtocolEntry, natSubsInterfaceIndex=natSubsInterfaceIndex, natMIBObjects=natMIBObjects, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natLimitMappings=natLimitMappings, natInterfaceDiscards=natInterfaceDiscards, natNotifThrottlingInterval=natNotifThrottlingInterval, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natNotifAddrMappings=natNotifAddrMappings, natLimitsEntry=natLimitsEntry, natProtocolTable=natProtocolTable, natMappingFilterBehavior=natMappingFilterBehavior, natInstanceEntry=natInstanceEntry, natOutOfPortErrors=natOutOfPortErrors, natMappingTable=natMappingTable, natAddrMapProtocol=natAddrMapProtocol, natAddrMapName=natAddrMapName, natSubscriberIdentifierType=natSubscriberIdentifierType, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natMIBConformance=natMIBConformance, natMappingCreations=natMappingCreations, natMappingExtRealm=natMappingExtRealm, NatPoolingType=NatPoolingType, natMappingProto=natMappingProto, natAddrBindEntry=natAddrBindEntry, natAddrPortBindType=natAddrPortBindType, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natAddrBindId=natAddrBindId, natPoolTable=natPoolTable, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natAddrMapLocalAddrType=natAddrMapLocalAddrType, NatBindIdOrZero=NatBindIdOrZero, natProtocolOutTranslates=natProtocolOutTranslates, natMIBCompliances=natMIBCompliances, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natLimitsTable=natLimitsTable, natPoolPortMin=natPoolPortMin, natSubscribersEntry=natSubscribersEntry, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natTranslations=natTranslations, natAddrMapStorageType=natAddrMapStorageType, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natStatsInterfaceGroup=natStatsInterfaceGroup, natPoolRangeAllocations=natPoolRangeAllocations, natAddrPortBindTable=natAddrPortBindTable, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natSessionProtocolType=natSessionProtocolType, natPoolWatermarkHigh=natPoolWatermarkHigh, natMapIntAddrTable=natMapIntAddrTable, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natSessionPrivateAddrType=natSessionPrivateAddrType, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natGroupAddrMapObjects=natGroupAddrMapObjects, natAddrMapOutTranslates=natAddrMapOutTranslates, natL4ProtocolTranslations=natL4ProtocolTranslations, natPoolEntry=natPoolEntry, natInterfaceRowStatus=natInterfaceRowStatus, natPoolRangeEnd=natPoolRangeEnd, natCountersTable=natCountersTable, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natSubscriberTranslations=natSubscriberTranslations, natAddrBindLocalAddr=natAddrBindLocalAddr, natInstanceTable=natInstanceTable, natSubscriberIndex=natSubscriberIndex, natPoolRangeTable=natPoolRangeTable, NatBindMode=NatBindMode, natAddrPortBindEntry=natAddrPortBindEntry, natAddrPortBindSessions=natAddrPortBindSessions, natSubscriberMappingCreations=natSubscriberMappingCreations, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natNotifCtrl=natNotifCtrl, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natMapIntAddrInt=natMapIntAddrInt, natGroupBasicNotifications=natGroupBasicNotifications, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natSessionPublicDstAddr=natSessionPublicDstAddr, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natPoolRangeEntry=natPoolRangeEntry, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natAddrBindTable=natAddrBindTable, natSessionPrivateDstPort=natSessionPrivateDstPort, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natAddrMapIndex=natAddrMapIndex, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natSessionPrivateDstAddr=natSessionPrivateDstAddr)
mibBuilder.exportSymbols("NAT-MIB", natPoolRangeDeallocations=natPoolRangeDeallocations, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natPoolWatermarkLow=natPoolWatermarkLow, NatAddrMapId=NatAddrMapId, natMapIntAddrExtType=natMapIntAddrExtType)
