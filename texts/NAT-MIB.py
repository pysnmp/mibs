...
mibBuilder.exportSymbols("NAT-MIB", natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natPoolTable=natPoolTable, natBindDefIdleTimeout=natBindDefIdleTimeout, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natProtocolEntry=natProtocolEntry, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natAddrMapTable=natAddrMapTable, natMIBGroups=natMIBGroups, natCountersTable=natCountersTable, natLimitsTable=natLimitsTable, natPoolRangePoolIndex=natPoolRangePoolIndex, natSessionIndex=natSessionIndex, natInstanceAlias=natInstanceAlias, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natProtocolDiscards=natProtocolDiscards, natMapIntAddrEntry=natMapIntAddrEntry, natInterfaceDiscards=natInterfaceDiscards, natInterfaceEntry=natInterfaceEntry, natMapIntAddrIntType=natMapIntAddrIntType, natSubscriberLimitMappings=natSubscriberLimitMappings, natAddrMapRowStatus=natAddrMapRowStatus, natMapIntAddrExtType=natMapIntAddrExtType, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natConfigGroup=natConfigGroup, natMapIntAddrTable=natMapIntAddrTable, natAddrPortBindProtocol=natAddrPortBindProtocol, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natNotifMappings=natNotifMappings, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natAddrMapStorageType=natAddrMapStorageType, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natSessionMaxIdleTime=natSessionMaxIdleTime, natStatsAddrMapGroup=natStatsAddrMapGroup, natMIBObjects=natMIBObjects, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, NatProtocolType=NatProtocolType, natAddrPortBindType=natAddrPortBindType, natMIBCompliances=natMIBCompliances, natSessionPublicAddrType=natSessionPublicAddrType, natNotifSubscriberMappings=natNotifSubscriberMappings, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natPoolRangeTable=natPoolRangeTable, natSubscriberIntPrefix=natSubscriberIntPrefix, natAddrMapLocalPortTo=natAddrMapLocalPortTo, natSessionProtocolType=natSessionProtocolType, NatAddrMapId=NatAddrMapId, natPoolRangeBegin=natPoolRangeBegin, natSubscriberRealm=natSubscriberRealm, natPoolRangeType=natPoolRangeType, natPoolRangeAllocations=natPoolRangeAllocations, natMappingAddressPooling=natMappingAddressPooling, natAddressMappingCreations=natAddressMappingCreations, natLimitFragments=natLimitFragments, natOutOfPortErrors=natOutOfPortErrors, natAddressMappingRemovals=natAddressMappingRemovals, natProtocolTable=natProtocolTable, natMappingExtPort=natMappingExtPort, natAddrMapOutTranslates=natAddrMapOutTranslates, natL4ProtocolEntry=natL4ProtocolEntry, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natPoolRangeEntry=natPoolRangeEntry, NatTranslationEntity=NatTranslationEntity, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natInterfaceRealm=natInterfaceRealm, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode, natAddrBindMapIndex=natAddrBindMapIndex, natProtocolInTranslates=natProtocolInTranslates, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, NatBindId=NatBindId, natTcpDefNegTimeout=natTcpDefNegTimeout, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natAddrPortBindId=natAddrPortBindId, natProtocol=natProtocol, natMappingCreations=natMappingCreations, natDefTimeouts=natDefTimeouts, natL4ProtocolNumber=natL4ProtocolNumber, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, ProtocolNumber=ProtocolNumber, natLimitAddressMappings=natLimitAddressMappings, natMapIntAddrInt=natMapIntAddrInt, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natInstanceIndex=natInstanceIndex, natSessionPublicDstAddr=natSessionPublicDstAddr, natAddrPortBindSessions=natAddrPortBindSessions, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natPoolWatermarkHigh=natPoolWatermarkHigh, natSessionTable=natSessionTable, natAddrMapAddrUsed=natAddrMapAddrUsed, natGroupFragmentObjects=natGroupFragmentObjects, natAddrBindSessions=natAddrBindSessions, natAddrBindTable=natAddrBindTable, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natMappingIntPort=natMappingIntPort, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natMappingTable=natMappingTable, NatBindMode=NatBindMode, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natAddrMapIndex=natAddrMapIndex, natPoolRangeEnd=natPoolRangeEnd, natAddrMapDiscards=natAddrMapDiscards, natSubscriberIdentifierType=natSubscriberIdentifierType, natSessionPublicSrcPort=natSessionPublicSrcPort, natFragmentsCompliance=natFragmentsCompliance, natPoolPortMax=natPoolPortMax, natMappingPool=natMappingPool, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natSessionPublicDstPort=natSessionPublicDstPort, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natMappingExtAddressType=natMappingExtAddressType, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natSessionPrivateDstPort=natSessionPrivateDstPort, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natSubscriberQuotaDrops=natSubscriberQuotaDrops, SubscriberIdentifierType=SubscriberIdentifierType, natMappingsNotifyThreshold=natMappingsNotifyThreshold, SubscriberIndex=SubscriberIndex, natSessionInTranslates=natSessionInTranslates, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natPoolWatermarkLow=natPoolWatermarkLow, natPoolPortMin=natPoolPortMin, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natSubscriberIndex=natSubscriberIndex, natGroupStatefulObjects=natGroupStatefulObjects, natBasicStatelessCompliance=natBasicStatelessCompliance, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, NatAssociationType=NatAssociationType, natMappingEntry=natMappingEntry, natInterfaceTable=natInterfaceTable, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, natPacketDiscard=natPacketDiscard, natMappingSubsIndex=natMappingSubsIndex, NatPoolingType=NatPoolingType, natMappingExtAddress=natMappingExtAddress, natMappingIntRealm=natMappingIntRealm, natMappingExtRealm=natMappingExtRealm, natSubsInterfaceIndex=natSubsInterfaceIndex, natAddrBindOutTranslates=natAddrBindOutTranslates, natGroupSubscriberNotifications=natGroupSubscriberNotifications, NatProtocolMap=NatProtocolMap, natMapObjects=natMapObjects, natAddrMapEntryType=natAddrMapEntryType, NatBehaviorType=NatBehaviorType, natMappingRemovals=natMappingRemovals, natMIB=natMIB, natLimitsEntry=natLimitsEntry, NatSessionId=NatSessionId, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natMapIntAddrExt=natMapIntAddrExt, natInstanceEntry=natInstanceEntry, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natTranslations=natTranslations, natSessionEntry=natSessionEntry, natPoolEntry=natPoolEntry, natMappingFilterBehavior=natMappingFilterBehavior, natMappingMapBehavior=natMappingMapBehavior, natBasicStatefulCompliance=natBasicStatefulCompliance, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natInterfaceInTranslates=natInterfaceInTranslates, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natStatsInterfaceGroup=natStatsInterfaceGroup, natMIBNotificationGroup=natMIBNotificationGroup, natNotifAddrMappings=natNotifAddrMappings, natGroupAddrMapObjects=natGroupAddrMapObjects, natSubscriberTranslations=natSubscriberTranslations, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, natSessionUpTime=natSessionUpTime, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natInterfaceOutTranslates=natInterfaceOutTranslates, natAddrMapProtocol=natAddrMapProtocol, natAddrBindLocalAddr=natAddrBindLocalAddr, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natAddrMapInTranslates=natAddrMapInTranslates, natResourceErrors=natResourceErrors, natCGNCompliance=natCGNCompliance, natNotifThrottlingInterval=natNotifThrottlingInterval, natMIBConformance=natMIBConformance, natQuotaDrops=natQuotaDrops, natSessionAddrMapIndex=natSessionAddrMapIndex, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natSubscribersTable=natSubscribersTable, natPoolRealm=natPoolRealm, natPoolObjects=natPoolObjects, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natNotifCtrl=natNotifCtrl, natGroupStatelessObjects=natGroupStatelessObjects, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natLimitMappings=natLimitMappings, natGroupBasicNotifications=natGroupBasicNotifications, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, NatBindIdOrZero=NatBindIdOrZero, natAddrMapCompliance=natAddrMapCompliance, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natInterfaceStorageType=natInterfaceStorageType, natProtocolOutTranslates=natProtocolOutTranslates, natAddrBindEntry=natAddrBindEntry, natStatsProtocolGroup=natStatsProtocolGroup, natSubscribers=natSubscribers, natAddrPortBindInTranslates=natAddrPortBindInTranslates, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natSessionPrivateAddrType=natSessionPrivateAddrType, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natGroupSubscriberObjects=natGroupSubscriberObjects, natSubscriberResourceErrors=natSubscriberResourceErrors, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natL4ProtocolTable=natL4ProtocolTable, natMappingIntAddressType=natMappingIntAddressType, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natSubscriberMappingCreations=natSubscriberMappingCreations, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natSessionOutTranslates=natSessionOutTranslates, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natInterfaceRowStatus=natInterfaceRowStatus, VlanIndexOrZero=VlanIndexOrZero, natInstanceTable=natInstanceTable, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natL4ProtocolTranslations=natL4ProtocolTranslations, natCounters=natCounters, natAddrPortBindEntry=natAddrPortBindEntry, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natMIBNotifications=natMIBNotifications, natLimitSubscribers=natLimitSubscribers, natAddrBindId=natAddrBindId, natMIBFullCompliance=natMIBFullCompliance, natSubscribersEntry=natSubscribersEntry, natAddrMapName=natAddrMapName, PYSNMP_MODULE_ID=natMIB, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natAddrBindType=natAddrBindType, natInterfaceServiceType=natInterfaceServiceType, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natCountersEntry=natCountersEntry, NatPoolId=NatPoolId, natAddrMapEntry=natAddrMapEntry, natMappingProto=natMappingProto, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natSessionDirection=natSessionDirection, natTranslationGroup=natTranslationGroup)
mibBuilder.exportSymbols("NAT-MIB", natPoolRangeDeallocations=natPoolRangeDeallocations, natMappingIntAddress=natMappingIntAddress, natPoolIndex=natPoolIndex, natAddrBindInTranslates=natAddrBindInTranslates, natAddrPortBindTable=natAddrPortBindTable)
