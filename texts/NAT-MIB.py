...
ObjectIdentity, mib_2, iso, Gauge32, Counter64, TimeTicks, Counter32, ModuleIdentity, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "mib-2", "iso", "Gauge32", "Counter64", "TimeTicks", "Counter32", "ModuleIdentity", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("NAT-MIB", NatProtocolType=NatProtocolType, NatBindIdOrZero=NatBindIdOrZero, natMappingEntry=natMappingEntry, natMappingProto=natMappingProto, natPoolRangeBegin=natPoolRangeBegin, natMapIntAddrExt=natMapIntAddrExt, natAddrPortBindOutTranslates=natAddrPortBindOutTranslates, natSessionPrivateSrcPort=natSessionPrivateSrcPort, natMapIntAddrIntType=natMapIntAddrIntType, natMappingPool=natMappingPool, natPoolTable=natPoolTable, NatTranslationEntity=NatTranslationEntity, natPoolRangeDeallocations=natPoolRangeDeallocations, natSubscriberMapNotifyThresh=natSubscriberMapNotifyThresh, natCounters=natCounters, natCountersTable=natCountersTable, natL4ProtocolNumber=natL4ProtocolNumber, natInterfaceOutTranslates=natInterfaceOutTranslates, natProtocolDiscards=natProtocolDiscards, natNotifPoolWatermarkLow=natNotifPoolWatermarkLow, natBasicStatelessCompliance=natBasicStatelessCompliance, ProtocolNumber=ProtocolNumber, natMIBReadOnlyCompliance=natMIBReadOnlyCompliance, natInterfaceStorageType=natInterfaceStorageType, natNotifPoolWatermarkHigh=natNotifPoolWatermarkHigh, natQuotaDrops=natQuotaDrops, natSubsInterfaceIdentifierEntry=natSubsInterfaceIdentifierEntry, natAddrBindNumberOfEntries=natAddrBindNumberOfEntries, natGroupAddrMapNotifications=natGroupAddrMapNotifications, natSessionPrivateDstEPBindId=natSessionPrivateDstEPBindId, natSubscriberQuotaDrops=natSubscriberQuotaDrops, natAddrMapIndex=natAddrMapIndex, natAddrMapGlobalAddrTo=natAddrMapGlobalAddrTo, natGroupFragmentObjects=natGroupFragmentObjects, natAddrBindTable=natAddrBindTable, natStatsProtocolGroup=natStatsProtocolGroup, natSubscriberVpnIdentifier=natSubscriberVpnIdentifier, natPoolWatermarkLow=natPoolWatermarkLow, natMapIntAddrExtRealm=natMapIntAddrExtRealm, natCountersEntry=natCountersEntry, natSubscriberIPEncapsIdType=natSubscriberIPEncapsIdType, natAddrPortBindNumberOfEntries=natAddrPortBindNumberOfEntries, natMIBNotifications=natMIBNotifications, natAddrMapRowStatus=natAddrMapRowStatus, natMappingRemovals=natMappingRemovals, natLimitSubscribers=natLimitSubscribers, natSubscribersTable=natSubscribersTable, natMappingIntAddress=natMappingIntAddress, natSubscriberIndex=natSubscriberIndex, natSubscriberIntPrefixLength=natSubscriberIntPrefixLength, natAddrMapLocalAddrFrom=natAddrMapLocalAddrFrom, natProtocolEntry=natProtocolEntry, natSubscriberIdentifierType=natSubscriberIdentifierType, natInstanceAlias=natInstanceAlias, natAddrPortBindTable=natAddrPortBindTable, natInterfaceRowStatus=natInterfaceRowStatus, natAddrPortBindGlobalPort=natAddrPortBindGlobalPort, natGroupStatelessObjects=natGroupStatelessObjects, natSubscriberMappingRemovals=natSubscriberMappingRemovals, natPoolRangeEntry=natPoolRangeEntry, natTranslationGroup=natTranslationGroup, natPoolEntry=natPoolEntry, natAddrPortBindMapIndex=natAddrPortBindMapIndex, natAddrPortBindProtocol=natAddrPortBindProtocol, natSubscriberIPEncapsIdAddr=natSubscriberIPEncapsIdAddr, natAddrMapEntryType=natAddrMapEntryType, natNotifThrottlingInterval=natNotifThrottlingInterval, natMIBCompliances=natMIBCompliances, natMappingIntRealm=natMappingIntRealm, natAddrPortBindInTranslates=natAddrPortBindInTranslates, NatPoolingType=NatPoolingType, natAddrMapCompliance=natAddrMapCompliance, natAddrBindMapIndex=natAddrBindMapIndex, natDefTimeouts=natDefTimeouts, natAddrPortBindGlobalAddr=natAddrPortBindGlobalAddr, natOutOfPortErrors=natOutOfPortErrors, natAddrBindTranslationEntity=natAddrBindTranslationEntity, natPoolIndex=natPoolIndex, natL4ProtocolOutOfPortErrors=natL4ProtocolOutOfPortErrors, natInstanceTable=natInstanceTable, natAddrMapEntry=natAddrMapEntry, natPoolPortMax=natPoolPortMax, natMapIntAddrExtType=natMapIntAddrExtType, natSubsInterfaceIdentifierTable=natSubsInterfaceIdentifierTable, natGroupSubscriberNotifications=natGroupSubscriberNotifications, natSessionPrivateDstPort=natSessionPrivateDstPort, VlanIndexOrZero=VlanIndexOrZero, natNotifAddrMappings=natNotifAddrMappings, natMapIntAddrEntry=natMapIntAddrEntry, natMappingExtRealm=natMappingExtRealm, natAddrMapProtocol=natAddrMapProtocol, natAddrPortBindEntry=natAddrPortBindEntry, natAddrPortBindTranslationEntity=natAddrPortBindTranslationEntity, natStatsAddrMapGroup=natStatsAddrMapGroup, natAddrBindLocalAddr=natAddrBindLocalAddr, natAddrMapGlobalPortFrom=natAddrMapGlobalPortFrom, natUdpDefIdleTimeout=natUdpDefIdleTimeout, natPoolRangePoolIndex=natPoolRangePoolIndex, natLimitFragments=natLimitFragments, natL4ProtocolQuotaDrops=natL4ProtocolQuotaDrops, PYSNMP_MODULE_ID=natMIB, natAddrBindOutTranslates=natAddrBindOutTranslates, natTcpDefNegTimeout=natTcpDefNegTimeout, SubscriberIdentifierType=SubscriberIdentifierType, natGroupStatefulObjects=natGroupStatefulObjects, SubsInterfaceIdRowIndex=SubsInterfaceIdRowIndex, natSubscriberVlanIdentifier=natSubscriberVlanIdentifier, natMapIntAddrSubsIndex=natMapIntAddrSubsIndex, natIcmpDefIdleTimeout=natIcmpDefIdleTimeout, natGroupBasicNotifications=natGroupBasicNotifications, natProtocolOutTranslates=natProtocolOutTranslates, natSessionOutTranslates=natSessionOutTranslates, natAddressMappingCreations=natAddressMappingCreations, natBindDefIdleTimeout=natBindDefIdleTimeout, natSubscribers=natSubscribers, natAddrPortBindGlobalAddrType=natAddrPortBindGlobalAddrType, natAddrMapTable=natAddrMapTable, natAddrPortBindId=natAddrPortBindId, natMappingCreations=natMappingCreations, natGroupSubscriberObjects=natGroupSubscriberObjects, natSessionProtocolType=natSessionProtocolType, natFragmentsCompliance=natFragmentsCompliance, natPoolRangeEnd=natPoolRangeEnd, natAddrMapLocalAddrTo=natAddrMapLocalAddrTo, natAddrPortBindMaxIdleTime=natAddrPortBindMaxIdleTime, natAddrMapOutTranslates=natAddrMapOutTranslates, natPoolRangeTable=natPoolRangeTable, natAddrMapDiscards=natAddrMapDiscards, NatBehaviorType=NatBehaviorType, natAddrMapGlobalPortTo=natAddrMapGlobalPortTo, natPoolPortMin=natPoolPortMin, natSubsInterfaceIndex=natSubsInterfaceIndex, natMapIntAddrInt=natMapIntAddrInt, natSubscriberMappingCreations=natSubscriberMappingCreations, natAddrBindType=natAddrBindType, natMIBNotificationGroup=natMIBNotificationGroup, natMIBGroups=natMIBGroups, natNotifCtrl=natNotifCtrl, natAddrMapInTranslates=natAddrMapInTranslates, natSessionPrivateSrcAddr=natSessionPrivateSrcAddr, natOtherDefIdleTimeout=natOtherDefIdleTimeout, natSessionPrivateDstAddr=natSessionPrivateDstAddr, natPoolRealm=natPoolRealm, natInterfaceInTranslates=natInterfaceInTranslates, natAddrBindSessions=natAddrBindSessions, natResourceErrors=natResourceErrors, natAddrPortBindLocalAddr=natAddrPortBindLocalAddr, natAddrMapTranslationEntity=natAddrMapTranslationEntity, natL4ProtocolEntry=natL4ProtocolEntry, natSessionPublicSrcPort=natSessionPublicSrcPort, natLimitsEntry=natLimitsEntry, natMapIntAddrIntRealm=natMapIntAddrIntRealm, natMapIntAddrTable=natMapIntAddrTable, natL4ProtocolMappingRemovals=natL4ProtocolMappingRemovals, natAddrPortBindLocalPort=natAddrPortBindLocalPort, natProtocolInTranslates=natProtocolInTranslates, natSessionMaxIdleTime=natSessionMaxIdleTime, natSubsInterfaceIdSubsIndex=natSubsInterfaceIdSubsIndex, natMappingFilterBehavior=natMappingFilterBehavior, natAddrMapLocalAddrType=natAddrMapLocalAddrType, natAddrBindInTranslates=natAddrBindInTranslates, natSessionPublicDstPort=natSessionPublicDstPort, natLimitsTable=natLimitsTable, natSessionPrivateSrcEPBindMode=natSessionPrivateSrcEPBindMode, natSessionPrivateAddrType=natSessionPrivateAddrType, natMappingExtAddressType=natMappingExtAddressType, natSubscriberResourceErrors=natSubscriberResourceErrors, natAddrMapLocalPortFrom=natAddrMapLocalPortFrom, natAddrMapLocalPortTo=natAddrMapLocalPortTo, NatProtocolMap=NatProtocolMap, natAddrPortBindLocalAddrType=natAddrPortBindLocalAddrType, natSessionDirection=natSessionDirection, natSessionPublicAddrType=natSessionPublicAddrType, natL4ProtocolMappingCreations=natL4ProtocolMappingCreations, natLimitMappings=natLimitMappings, natMappingTable=natMappingTable, natMappingExtAddress=natMappingExtAddress, NatAssociationType=NatAssociationType, natMIBConformance=natMIBConformance, natMappingExtPort=natMappingExtPort, natSubscribersEntry=natSubscribersEntry, natSubsInterfaceIdRowIndex=natSubsInterfaceIdRowIndex, natAddrBindEntry=natAddrBindEntry, natAddrBindGlobalAddr=natAddrBindGlobalAddr, natAddrPortBindSessions=natAddrPortBindSessions, natAddrBindMaxIdleTime=natAddrBindMaxIdleTime, natSessionPrivateSrcEPBindId=natSessionPrivateSrcEPBindId, NatAddrMapId=NatAddrMapId, NatPoolId=NatPoolId, natAddrMapName=natAddrMapName, natInstanceEntry=natInstanceEntry, natBasicStatefulCompliance=natBasicStatefulCompliance, natCGNCompliance=natCGNCompliance, natSubscriberIntPrefixType=natSubscriberIntPrefixType, natInterfaceDiscards=natInterfaceDiscards, natSessionIndex=natSessionIndex, natSessionCurrentIdleTime=natSessionCurrentIdleTime, natInstanceIndex=natInstanceIndex, natProtocol=natProtocol, natAddressMappingRemovals=natAddressMappingRemovals, natGroupAddrMapObjects=natGroupAddrMapObjects, natMIBFullCompliance=natMIBFullCompliance, natTcpDefIdleTimeout=natTcpDefIdleTimeout, natAddrBindGlobalAddrType=natAddrBindGlobalAddrType, natMappingSubsIndex=natMappingSubsIndex, natSessionInTranslates=natSessionInTranslates, natStatsInterfaceGroup=natStatsInterfaceGroup, natPoolWatermarkHigh=natPoolWatermarkHigh, natMapObjects=natMapObjects, natAddrMapStorageType=natAddrMapStorageType, natMappingIntAddressType=natMappingIntAddressType, NatSessionId=NatSessionId, natMappingMapBehavior=natMappingMapBehavior, natAddrMapAddrUsed=natAddrMapAddrUsed, natConfigGroup=natConfigGroup, natMappingsNotifyThreshold=natMappingsNotifyThreshold, natAddrPortBindCurrentIdleTime=natAddrPortBindCurrentIdleTime, natSubscriberLimitMappings=natSubscriberLimitMappings, NatBindId=NatBindId, natInterfaceServiceType=natInterfaceServiceType, natL4ProtocolResourceErrors=natL4ProtocolResourceErrors, natPoolRangeAllocations=natPoolRangeAllocations, natAddrMapGlobalAddrType=natAddrMapGlobalAddrType, natMIB=natMIB, natL4ProtocolTable=natL4ProtocolTable, natSessionPublicDstAddr=natSessionPublicDstAddr, natL4ProtocolTranslations=natL4ProtocolTranslations, natInterfaceRealm=natInterfaceRealm, natSubscriberTranslations=natSubscriberTranslations, natNotifSubscriberMappings=natNotifSubscriberMappings, natSessionEntry=natSessionEntry, natProtocolTable=natProtocolTable, natTranslations=natTranslations, natNotifMappings=natNotifMappings, natLimitAddressMappings=natLimitAddressMappings, natAddrMapNotifyThreshold=natAddrMapNotifyThreshold, natMappingIntPort=natMappingIntPort, natSubscriberOutOfPortErrors=natSubscriberOutOfPortErrors, SubscriberIndex=SubscriberIndex, natSessionPublicSrcAddr=natSessionPublicSrcAddr, natSubscriberIntPrefix=natSubscriberIntPrefix, natSubscriberRealm=natSubscriberRealm, natAddrPortBindType=natAddrPortBindType, natAddrBindId=natAddrBindId, natInterfaceTable=natInterfaceTable, natSessionTable=natSessionTable, natPoolRangeType=natPoolRangeType, natAddrBindCurrentIdleTime=natAddrBindCurrentIdleTime, natPoolObjects=natPoolObjects, natAddrMapGlobalAddrFrom=natAddrMapGlobalAddrFrom, natSessionUpTime=natSessionUpTime, natMIBObjects=natMIBObjects, natAddrBindLocalAddrType=natAddrBindLocalAddrType, natSessionPrivateDstEPBindMode=natSessionPrivateDstEPBindMode)
mibBuilder.exportSymbols("NAT-MIB", natMappingAddressPooling=natMappingAddressPooling, NatBindMode=NatBindMode, natSessionAddrMapIndex=natSessionAddrMapIndex, natPacketDiscard=natPacketDiscard, natInterfaceEntry=natInterfaceEntry)
