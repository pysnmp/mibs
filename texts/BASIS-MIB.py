...
mibBuilder.exportSymbols("BASIS-MIB", basis=basis, frPort=frPort, vismPort=vismPort, bbChan=bbChan, snaportCnfSig=snaportCnfSig, rpmChan=rpmChan, dsx1=dsx1, frPortCnfResPartGrp=frPortCnfResPartGrp, bbIfStateGrp=bbIfStateGrp, bbChanCntGrp=bbChanCntGrp, cwsonetObjects=cwsonetObjects, bbChanCnfGrp=bbChanCnfGrp, par=par, axisDiagnostics=axisDiagnostics, dsx3Framing=dsx3Framing, axisSvc=axisSvc, sna=sna, atmAddressRegistration=atmAddressRegistration, ausmPort=ausmPort, basisMIB=basisMIB, sonet=sonet, frPortCnfSig=frPortCnfSig, basisSystem=basisSystem, basisServices=basisServices, axisRedundancy=axisRedundancy, virtualInterface=virtualInterface, frPortCnt=frPortCnt, ausmPortCnt=ausmPortCnt, basisAsm=basisAsm, atmLineCnfGrp=atmLineCnfGrp, snaportCnt=snaportCnt, atmLmiSignaling=atmLmiSignaling, dsx3=dsx3, x21=x21, frPortCnfX21PortGrp=frPortCnfX21PortGrp, PYSNMP_MODULE_ID=basisMIB, ausmChan=ausmChan, circuitEmulation=circuitEmulation, basisLines=basisLines, bbIfCnt=bbIfCnt, rpmPort=rpmPort, frPortCnf=frPortCnf, frChan=frChan, bbChanStateGrp=bbChanStateGrp, dsx0Vism=dsx0Vism, dsx3Line=dsx3Line, bbInterface=bbInterface, rpmInterface=rpmInterface, snaPortCntSig=snaPortCntSig, vismChanGrp=vismChanGrp, atmLines=atmLines, snaport=snaport, voice=voice, bbIfCnfResPartGrp=bbIfCnfResPartGrp, cardSpecific=cardSpecific, bbIfCnf=bbIfCnf, snaportCnf=snaportCnf, atmLineCntGrp=atmLineCntGrp, dsx1Plcp=dsx1Plcp, vismChanCnfGrp=vismChanCnfGrp, ausmPortCnf=ausmPortCnf, plcp=plcp, dsx1Framing=dsx1Framing, rpmChanGrp=rpmChanGrp, frPortServiceQueGrp=frPortServiceQueGrp, atm=atm, basisShelf=basisShelf, cesmChan=cesmChan, frameRelay=frameRelay, cardGeneric=cardGeneric, frPortCntSig=frPortCntSig, dsx1Line=dsx1Line)
