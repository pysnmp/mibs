...
mibBuilder.exportSymbols("BASIS-MIB", frPortCnfResPartGrp=frPortCnfResPartGrp, bbChanCnfGrp=bbChanCnfGrp, sna=sna, virtualInterface=virtualInterface, par=par, basisLines=basisLines, basisAsm=basisAsm, dsx1Plcp=dsx1Plcp, atm=atm, snaportCnfSig=snaportCnfSig, frameRelay=frameRelay, frPortCnfSig=frPortCnfSig, cesmChan=cesmChan, sonet=sonet, atmLineCntGrp=atmLineCntGrp, rpmInterface=rpmInterface, frChan=frChan, atmAddressRegistration=atmAddressRegistration, atmLineCnfGrp=atmLineCnfGrp, bbIfCnfResPartGrp=bbIfCnfResPartGrp, rpmPort=rpmPort, ausmPort=ausmPort, axisDiagnostics=axisDiagnostics, cardGeneric=cardGeneric, plcp=plcp, frPortCnf=frPortCnf, ausmPortCnf=ausmPortCnf, snaport=snaport, basisShelf=basisShelf, snaportCnf=snaportCnf, frPortCnfX21PortGrp=frPortCnfX21PortGrp, bbInterface=bbInterface, basisSystem=basisSystem, atmLmiSignaling=atmLmiSignaling, dsx0Vism=dsx0Vism, snaportCnt=snaportCnt, bbIfCnt=bbIfCnt, ausmPortCnt=ausmPortCnt, bbChan=bbChan, dsx1=dsx1, bbIfStateGrp=bbIfStateGrp, x21=x21, cwsonetObjects=cwsonetObjects, axisSvc=axisSvc, dsx1Framing=dsx1Framing, basisMIB=basisMIB, vismPort=vismPort, dsx3=dsx3, frPortServiceQueGrp=frPortServiceQueGrp, snaPortCntSig=snaPortCntSig, rpmChanGrp=rpmChanGrp, basisServices=basisServices, bbChanStateGrp=bbChanStateGrp, dsx1Line=dsx1Line, cardSpecific=cardSpecific, frPortCntSig=frPortCntSig, voice=voice, circuitEmulation=circuitEmulation, dsx3Line=dsx3Line, PYSNMP_MODULE_ID=basisMIB, vismChanCnfGrp=vismChanCnfGrp, rpmChan=rpmChan, atmLines=atmLines, basis=basis, frPort=frPort, dsx3Framing=dsx3Framing, axisRedundancy=axisRedundancy, frPortCnt=frPortCnt, bbIfCnf=bbIfCnf, vismChanGrp=vismChanGrp, bbChanCntGrp=bbChanCntGrp, ausmChan=ausmChan)
