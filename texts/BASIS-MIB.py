...
mibBuilder.exportSymbols("BASIS-MIB", basisSystem=basisSystem, atmLineCntGrp=atmLineCntGrp, rpmChan=rpmChan, bbChanCnfGrp=bbChanCnfGrp, PYSNMP_MODULE_ID=basisMIB, frPortCnt=frPortCnt, bbChanStateGrp=bbChanStateGrp, atmLines=atmLines, basis=basis, dsx0Vism=dsx0Vism, bbIfCnt=bbIfCnt, sna=sna, dsx3Line=dsx3Line, basisShelf=basisShelf, dsx1Plcp=dsx1Plcp, cardSpecific=cardSpecific, axisRedundancy=axisRedundancy, cwsonetObjects=cwsonetObjects, bbIfStateGrp=bbIfStateGrp, snaport=snaport, dsx1Framing=dsx1Framing, atm=atm, rpmChanGrp=rpmChanGrp, snaportCnfSig=snaportCnfSig, frPortCnfResPartGrp=frPortCnfResPartGrp, rpmPort=rpmPort, frPortServiceQueGrp=frPortServiceQueGrp, frPortCntSig=frPortCntSig, x21=x21, bbIfCnf=bbIfCnf, atmAddressRegistration=atmAddressRegistration, frameRelay=frameRelay, frPortCnfX21PortGrp=frPortCnfX21PortGrp, cesmChan=cesmChan, vismChanCnfGrp=vismChanCnfGrp, par=par, dsx3=dsx3, snaPortCntSig=snaPortCntSig, vismPort=vismPort, frPort=frPort, virtualInterface=virtualInterface, rpmInterface=rpmInterface, atmLmiSignaling=atmLmiSignaling, frPortCnfSig=frPortCnfSig, voice=voice, axisSvc=axisSvc, ausmChan=ausmChan, cardGeneric=cardGeneric, basisAsm=basisAsm, plcp=plcp, frPortCnf=frPortCnf, vismChanGrp=vismChanGrp, basisLines=basisLines, snaportCnt=snaportCnt, atmLineCnfGrp=atmLineCnfGrp, dsx3Framing=dsx3Framing, ausmPort=ausmPort, circuitEmulation=circuitEmulation, dsx1Line=dsx1Line, basisServices=basisServices, axisDiagnostics=axisDiagnostics, dsx1=dsx1, ausmPortCnf=ausmPortCnf, snaportCnf=snaportCnf, sonet=sonet, bbInterface=bbInterface, basisMIB=basisMIB, frChan=frChan, ausmPortCnt=ausmPortCnt, bbChanCntGrp=bbChanCntGrp, bbIfCnfResPartGrp=bbIfCnfResPartGrp, bbChan=bbChan)
