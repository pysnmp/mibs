...
mibBuilder.exportSymbols("BASIS-MIB", bbIfCnf=bbIfCnf, atmLineCntGrp=atmLineCntGrp, rpmChan=rpmChan, cwsonetObjects=cwsonetObjects, atmLmiSignaling=atmLmiSignaling, virtualInterface=virtualInterface, bbIfCnfResPartGrp=bbIfCnfResPartGrp, basis=basis, axisDiagnostics=axisDiagnostics, bbIfCnt=bbIfCnt, PYSNMP_MODULE_ID=basisMIB, dsx1=dsx1, bbChanCntGrp=bbChanCntGrp, cardGeneric=cardGeneric, axisSvc=axisSvc, plcp=plcp, frPortCnf=frPortCnf, snaport=snaport, axisRedundancy=axisRedundancy, basisMIB=basisMIB, snaportCnt=snaportCnt, frPortCnfX21PortGrp=frPortCnfX21PortGrp, atm=atm, ausmChan=ausmChan, dsx3=dsx3, x21=x21, frPortCnfSig=frPortCnfSig, atmAddressRegistration=atmAddressRegistration, basisSystem=basisSystem, rpmChanGrp=rpmChanGrp, ausmPortCnt=ausmPortCnt, frPort=frPort, cardSpecific=cardSpecific, dsx1Line=dsx1Line, bbChan=bbChan, rpmInterface=rpmInterface, frameRelay=frameRelay, dsx1Framing=dsx1Framing, par=par, dsx1Plcp=dsx1Plcp, ausmPort=ausmPort, circuitEmulation=circuitEmulation, bbInterface=bbInterface, rpmPort=rpmPort, snaPortCntSig=snaPortCntSig, dsx3Framing=dsx3Framing, voice=voice, vismChanCnfGrp=vismChanCnfGrp, atmLines=atmLines, frChan=frChan, frPortCnt=frPortCnt, basisShelf=basisShelf, frPortServiceQueGrp=frPortServiceQueGrp, sna=sna, bbChanCnfGrp=bbChanCnfGrp, frPortCnfResPartGrp=frPortCnfResPartGrp, basisAsm=basisAsm, dsx0Vism=dsx0Vism, vismPort=vismPort, dsx3Line=dsx3Line, bbChanStateGrp=bbChanStateGrp, snaportCnfSig=snaportCnfSig, atmLineCnfGrp=atmLineCnfGrp, cesmChan=cesmChan, basisLines=basisLines, vismChanGrp=vismChanGrp, sonet=sonet, frPortCntSig=frPortCntSig, basisServices=basisServices, ausmPortCnf=ausmPortCnf, snaportCnf=snaportCnf, bbIfStateGrp=bbIfStateGrp)
