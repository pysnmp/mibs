...
mibBuilder.exportSymbols("BASIS-MIB", frPortServiceQueGrp=frPortServiceQueGrp, dsx1Line=dsx1Line, dsx3=dsx3, ausmPort=ausmPort, bbIfCnt=bbIfCnt, cwsonetObjects=cwsonetObjects, atmLineCnfGrp=atmLineCnfGrp, frameRelay=frameRelay, frPortCnt=frPortCnt, frPortCntSig=frPortCntSig, frPortCnfX21PortGrp=frPortCnfX21PortGrp, frChan=frChan, vismPort=vismPort, sonet=sonet, frPortCnfResPartGrp=frPortCnfResPartGrp, basisShelf=basisShelf, cesmChan=cesmChan, dsx3Framing=dsx3Framing, bbIfCnfResPartGrp=bbIfCnfResPartGrp, snaportCnf=snaportCnf, x21=x21, dsx1=dsx1, cardSpecific=cardSpecific, bbChanStateGrp=bbChanStateGrp, snaportCnt=snaportCnt, sna=sna, bbChan=bbChan, atmLineCntGrp=atmLineCntGrp, ausmPortCnf=ausmPortCnf, basisLines=basisLines, basisAsm=basisAsm, dsx1Plcp=dsx1Plcp, basisServices=basisServices, basis=basis, frPortCnf=frPortCnf, circuitEmulation=circuitEmulation, cardGeneric=cardGeneric, plcp=plcp, snaportCnfSig=snaportCnfSig, vismChanCnfGrp=vismChanCnfGrp, ausmPortCnt=ausmPortCnt, rpmInterface=rpmInterface, frPort=frPort, vismChanGrp=vismChanGrp, bbIfCnf=bbIfCnf, bbIfStateGrp=bbIfStateGrp, snaPortCntSig=snaPortCntSig, rpmChan=rpmChan, rpmChanGrp=rpmChanGrp, atm=atm, atmAddressRegistration=atmAddressRegistration, frPortCnfSig=frPortCnfSig, voice=voice, rpmPort=rpmPort, bbChanCntGrp=bbChanCntGrp, PYSNMP_MODULE_ID=basisMIB, axisDiagnostics=axisDiagnostics, atmLines=atmLines, dsx3Line=dsx3Line, dsx1Framing=dsx1Framing, dsx0Vism=dsx0Vism, snaport=snaport, bbInterface=bbInterface, par=par, axisRedundancy=axisRedundancy, axisSvc=axisSvc, virtualInterface=virtualInterface, ausmChan=ausmChan, atmLmiSignaling=atmLmiSignaling, bbChanCnfGrp=bbChanCnfGrp, basisSystem=basisSystem, basisMIB=basisMIB)
