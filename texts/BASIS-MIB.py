...
mibBuilder.exportSymbols("BASIS-MIB", virtualInterface=virtualInterface, basisServices=basisServices, frPortCnfX21PortGrp=frPortCnfX21PortGrp, dsx1Framing=dsx1Framing, basisShelf=basisShelf, atmLines=atmLines, ausmChan=ausmChan, axisSvc=axisSvc, dsx3Framing=dsx3Framing, atmLineCnfGrp=atmLineCnfGrp, dsx1Plcp=dsx1Plcp, atm=atm, frPortCnfSig=frPortCnfSig, bbChanCntGrp=bbChanCntGrp, axisRedundancy=axisRedundancy, snaPortCntSig=snaPortCntSig, atmAddressRegistration=atmAddressRegistration, bbChan=bbChan, bbIfCnt=bbIfCnt, rpmChanGrp=rpmChanGrp, ausmPortCnf=ausmPortCnf, rpmInterface=rpmInterface, bbIfCnf=bbIfCnf, rpmPort=rpmPort, snaportCnt=snaportCnt, basisMIB=basisMIB, PYSNMP_MODULE_ID=basisMIB, dsx1Line=dsx1Line, basisSystem=basisSystem, frameRelay=frameRelay, snaportCnf=snaportCnf, bbIfCnfResPartGrp=bbIfCnfResPartGrp, atmLineCntGrp=atmLineCntGrp, dsx3=dsx3, bbChanStateGrp=bbChanStateGrp, rpmChan=rpmChan, circuitEmulation=circuitEmulation, par=par, cardGeneric=cardGeneric, frPortCntSig=frPortCntSig, ausmPortCnt=ausmPortCnt, basis=basis, vismChanCnfGrp=vismChanCnfGrp, basisAsm=basisAsm, bbChanCnfGrp=bbChanCnfGrp, basisLines=basisLines, atmLmiSignaling=atmLmiSignaling, snaportCnfSig=snaportCnfSig, cardSpecific=cardSpecific, cesmChan=cesmChan, vismPort=vismPort, frPortCnf=frPortCnf, ausmPort=ausmPort, frChan=frChan, frPortCnt=frPortCnt, sna=sna, x21=x21, cwsonetObjects=cwsonetObjects, dsx1=dsx1, snaport=snaport, voice=voice, axisDiagnostics=axisDiagnostics, plcp=plcp, frPort=frPort, vismChanGrp=vismChanGrp, bbInterface=bbInterface, bbIfStateGrp=bbIfStateGrp, dsx3Line=dsx3Line, dsx0Vism=dsx0Vism, sonet=sonet, frPortServiceQueGrp=frPortServiceQueGrp, frPortCnfResPartGrp=frPortCnfResPartGrp)
