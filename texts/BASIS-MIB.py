...
mibBuilder.exportSymbols("BASIS-MIB", atm=atm, basis=basis, basisServices=basisServices, dsx3=dsx3, frPortCntSig=frPortCntSig, rpmChanGrp=rpmChanGrp, ausmChan=ausmChan, rpmInterface=rpmInterface, basisShelf=basisShelf, rpmChan=rpmChan, frPortServiceQueGrp=frPortServiceQueGrp, frameRelay=frameRelay, ausmPort=ausmPort, sonet=sonet, plcp=plcp, ausmPortCnt=ausmPortCnt, vismPort=vismPort, atmLmiSignaling=atmLmiSignaling, dsx1=dsx1, axisSvc=axisSvc, basisLines=basisLines, vismChanGrp=vismChanGrp, atmLines=atmLines, bbInterface=bbInterface, dsx0Vism=dsx0Vism, dsx1Plcp=dsx1Plcp, frPortCnfX21PortGrp=frPortCnfX21PortGrp, virtualInterface=virtualInterface, bbChanStateGrp=bbChanStateGrp, frChan=frChan, circuitEmulation=circuitEmulation, bbIfCnt=bbIfCnt, dsx1Framing=dsx1Framing, dsx3Line=dsx3Line, vismChanCnfGrp=vismChanCnfGrp, rpmPort=rpmPort, cardGeneric=cardGeneric, frPort=frPort, par=par, frPortCnt=frPortCnt, atmLineCnfGrp=atmLineCnfGrp, bbChanCnfGrp=bbChanCnfGrp, x21=x21, sna=sna, basisSystem=basisSystem, atmAddressRegistration=atmAddressRegistration, bbChan=bbChan, PYSNMP_MODULE_ID=basisMIB, axisRedundancy=axisRedundancy, cardSpecific=cardSpecific, snaport=snaport, snaPortCntSig=snaPortCntSig, bbIfCnf=bbIfCnf, bbChanCntGrp=bbChanCntGrp, frPortCnfSig=frPortCnfSig, snaportCnf=snaportCnf, dsx3Framing=dsx3Framing, voice=voice, basisMIB=basisMIB, cesmChan=cesmChan, frPortCnf=frPortCnf, atmLineCntGrp=atmLineCntGrp, bbIfCnfResPartGrp=bbIfCnfResPartGrp, bbIfStateGrp=bbIfStateGrp, frPortCnfResPartGrp=frPortCnfResPartGrp, snaportCnt=snaportCnt, dsx1Line=dsx1Line, axisDiagnostics=axisDiagnostics, cwsonetObjects=cwsonetObjects, basisAsm=basisAsm, ausmPortCnf=ausmPortCnf, snaportCnfSig=snaportCnfSig)
