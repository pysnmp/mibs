...
mibBuilder.exportSymbols("BASIS-MIB", ausmChan=ausmChan, sna=sna, sonet=sonet, cardSpecific=cardSpecific, rpmPort=rpmPort, frPortCnfSig=frPortCnfSig, x21=x21, dsx1Plcp=dsx1Plcp, bbInterface=bbInterface, plcp=plcp, frPortCnfX21PortGrp=frPortCnfX21PortGrp, rpmChan=rpmChan, bbIfCnfResPartGrp=bbIfCnfResPartGrp, frPortCntSig=frPortCntSig, vismPort=vismPort, dsx1Framing=dsx1Framing, basisShelf=basisShelf, dsx0Vism=dsx0Vism, frChan=frChan, frPortCnfResPartGrp=frPortCnfResPartGrp, snaport=snaport, bbIfCnf=bbIfCnf, frPortServiceQueGrp=frPortServiceQueGrp, PYSNMP_MODULE_ID=basisMIB, bbIfStateGrp=bbIfStateGrp, rpmInterface=rpmInterface, par=par, snaportCnf=snaportCnf, dsx3=dsx3, cwsonetObjects=cwsonetObjects, cardGeneric=cardGeneric, frameRelay=frameRelay, ausmPort=ausmPort, vismChanGrp=vismChanGrp, basisLines=basisLines, bbChan=bbChan, axisRedundancy=axisRedundancy, virtualInterface=virtualInterface, bbChanCntGrp=bbChanCntGrp, circuitEmulation=circuitEmulation, voice=voice, basis=basis, atm=atm, frPortCnt=frPortCnt, ausmPortCnf=ausmPortCnf, snaportCnfSig=snaportCnfSig, bbIfCnt=bbIfCnt, dsx1=dsx1, frPortCnf=frPortCnf, bbChanCnfGrp=bbChanCnfGrp, axisSvc=axisSvc, dsx3Line=dsx3Line, cesmChan=cesmChan, snaPortCntSig=snaPortCntSig, basisMIB=basisMIB, rpmChanGrp=rpmChanGrp, basisAsm=basisAsm, atmLines=atmLines, atmAddressRegistration=atmAddressRegistration, snaportCnt=snaportCnt, dsx3Framing=dsx3Framing, dsx1Line=dsx1Line, basisServices=basisServices, vismChanCnfGrp=vismChanCnfGrp, frPort=frPort, atmLineCntGrp=atmLineCntGrp, ausmPortCnt=ausmPortCnt, atmLmiSignaling=atmLmiSignaling, atmLineCnfGrp=atmLineCnfGrp, basisSystem=basisSystem, bbChanStateGrp=bbChanStateGrp, axisDiagnostics=axisDiagnostics)
