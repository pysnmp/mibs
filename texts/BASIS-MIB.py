...
mibBuilder.exportSymbols("BASIS-MIB", dsx1Line=dsx1Line, frPortCnt=frPortCnt, atmLines=atmLines, vismChanCnfGrp=vismChanCnfGrp, cesmChan=cesmChan, dsx3Framing=dsx3Framing, cwsonetObjects=cwsonetObjects, frPortServiceQueGrp=frPortServiceQueGrp, bbInterface=bbInterface, basisSystem=basisSystem, cardGeneric=cardGeneric, snaportCnf=snaportCnf, dsx3Line=dsx3Line, basis=basis, plcp=plcp, basisLines=basisLines, rpmPort=rpmPort, frPortCnfSig=frPortCnfSig, atmLineCntGrp=atmLineCntGrp, frPortCnfResPartGrp=frPortCnfResPartGrp, basisShelf=basisShelf, ausmChan=ausmChan, atm=atm, circuitEmulation=circuitEmulation, frameRelay=frameRelay, atmAddressRegistration=atmAddressRegistration, dsx1=dsx1, dsx1Framing=dsx1Framing, frChan=frChan, rpmChan=rpmChan, atmLineCnfGrp=atmLineCnfGrp, snaportCnt=snaportCnt, ausmPortCnf=ausmPortCnf, sna=sna, snaportCnfSig=snaportCnfSig, PYSNMP_MODULE_ID=basisMIB, ausmPort=ausmPort, par=par, sonet=sonet, basisMIB=basisMIB, frPort=frPort, snaport=snaport, axisDiagnostics=axisDiagnostics, frPortCnfX21PortGrp=frPortCnfX21PortGrp, frPortCntSig=frPortCntSig, basisAsm=basisAsm, vismPort=vismPort, virtualInterface=virtualInterface, bbChanStateGrp=bbChanStateGrp, frPortCnf=frPortCnf, voice=voice, ausmPortCnt=ausmPortCnt, bbIfCnfResPartGrp=bbIfCnfResPartGrp, bbIfCnt=bbIfCnt, x21=x21, basisServices=basisServices, bbChanCnfGrp=bbChanCnfGrp, dsx3=dsx3, bbChanCntGrp=bbChanCntGrp, dsx1Plcp=dsx1Plcp, bbChan=bbChan, vismChanGrp=vismChanGrp, rpmInterface=rpmInterface, rpmChanGrp=rpmChanGrp, atmLmiSignaling=atmLmiSignaling, axisRedundancy=axisRedundancy, axisSvc=axisSvc, dsx0Vism=dsx0Vism, snaPortCntSig=snaPortCntSig, bbIfStateGrp=bbIfStateGrp, cardSpecific=cardSpecific, bbIfCnf=bbIfCnf)
