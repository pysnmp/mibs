...
mibBuilder.exportSymbols("BASIS-MIB", basisAsm=basisAsm, snaPortCntSig=snaPortCntSig, rpmPort=rpmPort, dsx3=dsx3, frPortCnfResPartGrp=frPortCnfResPartGrp, circuitEmulation=circuitEmulation, vismChanCnfGrp=vismChanCnfGrp, atmLines=atmLines, snaportCnfSig=snaportCnfSig, bbIfStateGrp=bbIfStateGrp, atmLmiSignaling=atmLmiSignaling, atmLineCntGrp=atmLineCntGrp, dsx1Line=dsx1Line, frPortServiceQueGrp=frPortServiceQueGrp, sna=sna, bbIfCnt=bbIfCnt, basis=basis, frPortCnfX21PortGrp=frPortCnfX21PortGrp, cardSpecific=cardSpecific, vismChanGrp=vismChanGrp, bbChanCnfGrp=bbChanCnfGrp, bbChanCntGrp=bbChanCntGrp, rpmChanGrp=rpmChanGrp, par=par, axisRedundancy=axisRedundancy, basisLines=basisLines, dsx3Framing=dsx3Framing, snaport=snaport, dsx3Line=dsx3Line, bbChanStateGrp=bbChanStateGrp, bbChan=bbChan, frChan=frChan, frPortCnt=frPortCnt, rpmChan=rpmChan, frPortCnfSig=frPortCnfSig, atmAddressRegistration=atmAddressRegistration, atm=atm, cesmChan=cesmChan, dsx1=dsx1, frameRelay=frameRelay, dsx0Vism=dsx0Vism, cwsonetObjects=cwsonetObjects, ausmChan=ausmChan, vismPort=vismPort, PYSNMP_MODULE_ID=basisMIB, frPortCnf=frPortCnf, snaportCnf=snaportCnf, bbIfCnf=bbIfCnf, sonet=sonet, dsx1Plcp=dsx1Plcp, bbIfCnfResPartGrp=bbIfCnfResPartGrp, frPort=frPort, basisServices=basisServices, snaportCnt=snaportCnt, voice=voice, bbInterface=bbInterface, basisSystem=basisSystem, plcp=plcp, basisShelf=basisShelf, dsx1Framing=dsx1Framing, ausmPort=ausmPort, ausmPortCnf=ausmPortCnf, basisMIB=basisMIB, axisSvc=axisSvc, axisDiagnostics=axisDiagnostics, x21=x21, rpmInterface=rpmInterface, cardGeneric=cardGeneric, ausmPortCnt=ausmPortCnt, virtualInterface=virtualInterface, atmLineCnfGrp=atmLineCnfGrp, frPortCntSig=frPortCntSig)
