...
mibBuilder.exportSymbols("BASIS-MIB", bbChan=bbChan, rpmChan=rpmChan, frPortCnf=frPortCnf, bbInterface=bbInterface, vismPort=vismPort, basisMIB=basisMIB, virtualInterface=virtualInterface, rpmPort=rpmPort, atmLines=atmLines, ausmChan=ausmChan, basis=basis, axisSvc=axisSvc, frPortCnfX21PortGrp=frPortCnfX21PortGrp, atm=atm, bbChanCntGrp=bbChanCntGrp, snaportCnfSig=snaportCnfSig, snaPortCntSig=snaPortCntSig, basisLines=basisLines, dsx3Framing=dsx3Framing, ausmPortCnt=ausmPortCnt, frPort=frPort, bbChanStateGrp=bbChanStateGrp, cesmChan=cesmChan, atmLineCnfGrp=atmLineCnfGrp, PYSNMP_MODULE_ID=basisMIB, dsx1=dsx1, axisRedundancy=axisRedundancy, atmLmiSignaling=atmLmiSignaling, x21=x21, atmLineCntGrp=atmLineCntGrp, cardSpecific=cardSpecific, atmAddressRegistration=atmAddressRegistration, basisServices=basisServices, circuitEmulation=circuitEmulation, snaportCnf=snaportCnf, bbIfStateGrp=bbIfStateGrp, plcp=plcp, frameRelay=frameRelay, frPortCnfResPartGrp=frPortCnfResPartGrp, sna=sna, vismChanCnfGrp=vismChanCnfGrp, ausmPortCnf=ausmPortCnf, rpmInterface=rpmInterface, bbIfCnt=bbIfCnt, basisSystem=basisSystem, snaportCnt=snaportCnt, basisAsm=basisAsm, vismChanGrp=vismChanGrp, dsx3=dsx3, cwsonetObjects=cwsonetObjects, frChan=frChan, snaport=snaport, basisShelf=basisShelf, dsx0Vism=dsx0Vism, rpmChanGrp=rpmChanGrp, frPortCnt=frPortCnt, voice=voice, dsx3Line=dsx3Line, dsx1Plcp=dsx1Plcp, sonet=sonet, frPortCnfSig=frPortCnfSig, ausmPort=ausmPort, bbIfCnf=bbIfCnf, bbChanCnfGrp=bbChanCnfGrp, dsx1Line=dsx1Line, cardGeneric=cardGeneric, dsx1Framing=dsx1Framing, par=par, frPortCntSig=frPortCntSig, axisDiagnostics=axisDiagnostics, bbIfCnfResPartGrp=bbIfCnfResPartGrp, frPortServiceQueGrp=frPortServiceQueGrp)
