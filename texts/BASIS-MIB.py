...
mibBuilder.exportSymbols("BASIS-MIB", axisRedundancy=axisRedundancy, atmLmiSignaling=atmLmiSignaling, frChan=frChan, frPortCnfSig=frPortCnfSig, cardGeneric=cardGeneric, snaportCnt=snaportCnt, axisSvc=axisSvc, dsx1Plcp=dsx1Plcp, basisLines=basisLines, frameRelay=frameRelay, voice=voice, vismChanGrp=vismChanGrp, atmLineCntGrp=atmLineCntGrp, basisAsm=basisAsm, frPortCnt=frPortCnt, atmLineCnfGrp=atmLineCnfGrp, frPortCntSig=frPortCntSig, cwsonetObjects=cwsonetObjects, vismChanCnfGrp=vismChanCnfGrp, dsx1Framing=dsx1Framing, ausmChan=ausmChan, snaport=snaport, vismPort=vismPort, rpmChan=rpmChan, snaportCnf=snaportCnf, basis=basis, dsx1=dsx1, bbIfCnfResPartGrp=bbIfCnfResPartGrp, cardSpecific=cardSpecific, sonet=sonet, sna=sna, rpmInterface=rpmInterface, atmAddressRegistration=atmAddressRegistration, dsx3Line=dsx3Line, basisShelf=basisShelf, frPortCnfResPartGrp=frPortCnfResPartGrp, ausmPortCnt=ausmPortCnt, PYSNMP_MODULE_ID=basisMIB, cesmChan=cesmChan, atmLines=atmLines, frPortServiceQueGrp=frPortServiceQueGrp, ausmPortCnf=ausmPortCnf, bbInterface=bbInterface, basisServices=basisServices, bbChanCntGrp=bbChanCntGrp, bbChanCnfGrp=bbChanCnfGrp, dsx3Framing=dsx3Framing, frPort=frPort, rpmChanGrp=rpmChanGrp, basisMIB=basisMIB, circuitEmulation=circuitEmulation, rpmPort=rpmPort, bbChanStateGrp=bbChanStateGrp, dsx3=dsx3, bbChan=bbChan, basisSystem=basisSystem, ausmPort=ausmPort, plcp=plcp, snaportCnfSig=snaportCnfSig, axisDiagnostics=axisDiagnostics, virtualInterface=virtualInterface, frPortCnf=frPortCnf, x21=x21, bbIfCnf=bbIfCnf, snaPortCntSig=snaPortCntSig, dsx1Line=dsx1Line, frPortCnfX21PortGrp=frPortCnfX21PortGrp, bbIfStateGrp=bbIfStateGrp, bbIfCnt=bbIfCnt, atm=atm, par=par, dsx0Vism=dsx0Vism)
