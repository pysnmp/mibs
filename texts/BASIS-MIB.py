...
mibBuilder.exportSymbols("BASIS-MIB", dsx3=dsx3, axisSvc=axisSvc, dsx0Vism=dsx0Vism, atmLmiSignaling=atmLmiSignaling, dsx3Framing=dsx3Framing, snaportCnfSig=snaportCnfSig, basisMIB=basisMIB, rpmChanGrp=rpmChanGrp, cardSpecific=cardSpecific, basisShelf=basisShelf, dsx1Framing=dsx1Framing, frPortCnf=frPortCnf, atm=atm, bbIfCnt=bbIfCnt, snaportCnf=snaportCnf, ausmChan=ausmChan, ausmPortCnf=ausmPortCnf, voice=voice, snaportCnt=snaportCnt, bbInterface=bbInterface, vismPort=vismPort, sonet=sonet, bbChan=bbChan, rpmChan=rpmChan, plcp=plcp, vismChanCnfGrp=vismChanCnfGrp, ausmPortCnt=ausmPortCnt, rpmPort=rpmPort, axisDiagnostics=axisDiagnostics, virtualInterface=virtualInterface, basisAsm=basisAsm, cesmChan=cesmChan, frPortServiceQueGrp=frPortServiceQueGrp, sna=sna, ausmPort=ausmPort, circuitEmulation=circuitEmulation, bbChanStateGrp=bbChanStateGrp, frPortCnfSig=frPortCnfSig, bbIfCnf=bbIfCnf, frameRelay=frameRelay, basisLines=basisLines, frChan=frChan, frPortCnfX21PortGrp=frPortCnfX21PortGrp, atmLineCnfGrp=atmLineCnfGrp, bbChanCntGrp=bbChanCntGrp, frPortCnfResPartGrp=frPortCnfResPartGrp, rpmInterface=rpmInterface, basis=basis, PYSNMP_MODULE_ID=basisMIB, snaPortCntSig=snaPortCntSig, atmLineCntGrp=atmLineCntGrp, bbIfCnfResPartGrp=bbIfCnfResPartGrp, bbIfStateGrp=bbIfStateGrp, cardGeneric=cardGeneric, basisServices=basisServices, x21=x21, dsx1Plcp=dsx1Plcp, dsx1=dsx1, dsx3Line=dsx3Line, dsx1Line=dsx1Line, frPort=frPort, snaport=snaport, atmLines=atmLines, axisRedundancy=axisRedundancy, par=par, vismChanGrp=vismChanGrp, frPortCnt=frPortCnt, frPortCntSig=frPortCntSig, atmAddressRegistration=atmAddressRegistration, bbChanCnfGrp=bbChanCnfGrp, basisSystem=basisSystem, cwsonetObjects=cwsonetObjects)
