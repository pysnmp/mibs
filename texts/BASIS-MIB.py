...
mibBuilder.exportSymbols("BASIS-MIB", ausmPortCnt=ausmPortCnt, cesmChan=cesmChan, ausmPort=ausmPort, frPortCnfX21PortGrp=frPortCnfX21PortGrp, snaPortCntSig=snaPortCntSig, snaportCnf=snaportCnf, bbChanCnfGrp=bbChanCnfGrp, cardGeneric=cardGeneric, basisServices=basisServices, frPort=frPort, dsx3Line=dsx3Line, atmLines=atmLines, atmLineCntGrp=atmLineCntGrp, plcp=plcp, frPortCnfSig=frPortCnfSig, atmLineCnfGrp=atmLineCnfGrp, voice=voice, bbIfStateGrp=bbIfStateGrp, frPortCnf=frPortCnf, dsx1Framing=dsx1Framing, frPortServiceQueGrp=frPortServiceQueGrp, ausmPortCnf=ausmPortCnf, snaportCnt=snaportCnt, basisMIB=basisMIB, dsx1Plcp=dsx1Plcp, dsx1=dsx1, snaport=snaport, snaportCnfSig=snaportCnfSig, vismPort=vismPort, bbChan=bbChan, basis=basis, bbIfCnfResPartGrp=bbIfCnfResPartGrp, frameRelay=frameRelay, axisSvc=axisSvc, vismChanGrp=vismChanGrp, rpmChan=rpmChan, basisSystem=basisSystem, dsx0Vism=dsx0Vism, par=par, basisLines=basisLines, PYSNMP_MODULE_ID=basisMIB, sonet=sonet, frChan=frChan, atm=atm, bbInterface=bbInterface, virtualInterface=virtualInterface, bbIfCnf=bbIfCnf, cardSpecific=cardSpecific, dsx3Framing=dsx3Framing, ausmChan=ausmChan, circuitEmulation=circuitEmulation, x21=x21, frPortCnt=frPortCnt, dsx1Line=dsx1Line, sna=sna, rpmInterface=rpmInterface, bbChanStateGrp=bbChanStateGrp, vismChanCnfGrp=vismChanCnfGrp, frPortCnfResPartGrp=frPortCnfResPartGrp, rpmChanGrp=rpmChanGrp, frPortCntSig=frPortCntSig, bbChanCntGrp=bbChanCntGrp, atmLmiSignaling=atmLmiSignaling, axisDiagnostics=axisDiagnostics, rpmPort=rpmPort, dsx3=dsx3, cwsonetObjects=cwsonetObjects, atmAddressRegistration=atmAddressRegistration, basisAsm=basisAsm, bbIfCnt=bbIfCnt, axisRedundancy=axisRedundancy, basisShelf=basisShelf)
