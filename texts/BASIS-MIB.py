...
mibBuilder.exportSymbols("BASIS-MIB", x21=x21, basisServices=basisServices, snaPortCntSig=snaPortCntSig, bbIfStateGrp=bbIfStateGrp, cardSpecific=cardSpecific, ausmPortCnt=ausmPortCnt, ausmChan=ausmChan, axisSvc=axisSvc, dsx1Line=dsx1Line, atmLineCntGrp=atmLineCntGrp, rpmChanGrp=rpmChanGrp, snaportCnt=snaportCnt, snaportCnfSig=snaportCnfSig, frPortCnfResPartGrp=frPortCnfResPartGrp, basisSystem=basisSystem, PYSNMP_MODULE_ID=basisMIB, dsx1Plcp=dsx1Plcp, axisDiagnostics=axisDiagnostics, bbIfCnfResPartGrp=bbIfCnfResPartGrp, frPortCntSig=frPortCntSig, voice=voice, frPortCnfSig=frPortCnfSig, bbChanStateGrp=bbChanStateGrp, frPortServiceQueGrp=frPortServiceQueGrp, bbIfCnf=bbIfCnf, dsx1=dsx1, cardGeneric=cardGeneric, atm=atm, cesmChan=cesmChan, bbInterface=bbInterface, basis=basis, atmLineCnfGrp=atmLineCnfGrp, virtualInterface=virtualInterface, snaport=snaport, dsx3=dsx3, ausmPort=ausmPort, sonet=sonet, dsx0Vism=dsx0Vism, basisMIB=basisMIB, basisShelf=basisShelf, atmAddressRegistration=atmAddressRegistration, dsx1Framing=dsx1Framing, dsx3Framing=dsx3Framing, plcp=plcp, frChan=frChan, frPort=frPort, frPortCnt=frPortCnt, ausmPortCnf=ausmPortCnf, rpmChan=rpmChan, par=par, axisRedundancy=axisRedundancy, snaportCnf=snaportCnf, frPortCnf=frPortCnf, bbChanCnfGrp=bbChanCnfGrp, atmLines=atmLines, frameRelay=frameRelay, frPortCnfX21PortGrp=frPortCnfX21PortGrp, circuitEmulation=circuitEmulation, basisAsm=basisAsm, vismChanGrp=vismChanGrp, rpmInterface=rpmInterface, vismPort=vismPort, bbChan=bbChan, sna=sna, basisLines=basisLines, bbIfCnt=bbIfCnt, bbChanCntGrp=bbChanCntGrp, rpmPort=rpmPort, cwsonetObjects=cwsonetObjects, atmLmiSignaling=atmLmiSignaling, vismChanCnfGrp=vismChanCnfGrp, dsx3Line=dsx3Line)
