...
mibBuilder.exportSymbols("BASIS-MIB", atm=atm, dsx1Framing=dsx1Framing, basisAsm=basisAsm, basisServices=basisServices, bbIfCnt=bbIfCnt, snaportCnf=snaportCnf, frPortCntSig=frPortCntSig, vismChanGrp=vismChanGrp, ausmPortCnf=ausmPortCnf, frPortServiceQueGrp=frPortServiceQueGrp, snaportCnt=snaportCnt, basisLines=basisLines, bbChanStateGrp=bbChanStateGrp, dsx1Plcp=dsx1Plcp, plcp=plcp, frPortCnfSig=frPortCnfSig, frPort=frPort, virtualInterface=virtualInterface, bbChanCnfGrp=bbChanCnfGrp, snaport=snaport, vismPort=vismPort, atmLineCntGrp=atmLineCntGrp, dsx3Framing=dsx3Framing, bbInterface=bbInterface, dsx1=dsx1, rpmInterface=rpmInterface, atmLineCnfGrp=atmLineCnfGrp, rpmPort=rpmPort, dsx3=dsx3, atmLmiSignaling=atmLmiSignaling, basisMIB=basisMIB, par=par, dsx1Line=dsx1Line, rpmChan=rpmChan, cwsonetObjects=cwsonetObjects, frPortCnfX21PortGrp=frPortCnfX21PortGrp, ausmPort=ausmPort, axisRedundancy=axisRedundancy, circuitEmulation=circuitEmulation, bbChanCntGrp=bbChanCntGrp, rpmChanGrp=rpmChanGrp, bbIfCnfResPartGrp=bbIfCnfResPartGrp, bbIfStateGrp=bbIfStateGrp, sna=sna, cardSpecific=cardSpecific, snaportCnfSig=snaportCnfSig, axisSvc=axisSvc, basisSystem=basisSystem, dsx0Vism=dsx0Vism, cesmChan=cesmChan, vismChanCnfGrp=vismChanCnfGrp, basisShelf=basisShelf, frPortCnfResPartGrp=frPortCnfResPartGrp, dsx3Line=dsx3Line, atmLines=atmLines, bbIfCnf=bbIfCnf, voice=voice, frPortCnt=frPortCnt, axisDiagnostics=axisDiagnostics, PYSNMP_MODULE_ID=basisMIB, cardGeneric=cardGeneric, atmAddressRegistration=atmAddressRegistration, x21=x21, frChan=frChan, frameRelay=frameRelay, sonet=sonet, basis=basis, frPortCnf=frPortCnf, ausmPortCnt=ausmPortCnt, ausmChan=ausmChan, snaPortCntSig=snaPortCntSig, bbChan=bbChan)
