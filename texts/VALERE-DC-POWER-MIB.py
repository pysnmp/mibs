...
ObjectIdentity, Counter32, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, iso, NotificationType, MibIdentifier, Counter64, enterprises, IpAddress, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "iso", "NotificationType", "MibIdentifier", "Counter64", "enterprises", "IpAddress", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("VALERE-DC-POWER-MIB", vpwrBDTClearAlarm=vpwrBDTClearAlarm, vpwrRectAlarmAmbTemp=vpwrRectAlarmAmbTemp, vpwrTrapLogout=vpwrTrapLogout, sysAlarmDefaultName=sysAlarmDefaultName, vpwrTrapACFAlarm=vpwrTrapACFAlarm, vpwrIoModuleTestGroup=vpwrIoModuleTestGroup, vpwrLvdContactorReconnectDelayTimer=vpwrLvdContactorReconnectDelayTimer, vpwrTrapSwDownloadNoReboot=vpwrTrapSwDownloadNoReboot, vpwrDcPowerAlarmGroup=vpwrDcPowerAlarmGroup, vpwrRectifierHVSDSetpoint=vpwrRectifierHVSDSetpoint, vpwrDcPowerDist=vpwrDcPowerDist, vpwrTrapIShareAlarm=vpwrTrapIShareAlarm, vpwrRectAlarmUV=vpwrRectAlarmUV, vpwrBayctrlTestDate=vpwrBayctrlTestDate, vpwrBayctrlCapacity=vpwrBayctrlCapacity, vpwrAlarmsPresent=vpwrAlarmsPresent, batteryTempCompHighStartTemperature=batteryTempCompHighStartTemperature, vpwrTrapIpIndex=vpwrTrapIpIndex, vpwrPanelModuleCapacity=vpwrPanelModuleCapacity, vpwrRectAlarmReserved=vpwrRectAlarmReserved, vpwrModuleOperHours=vpwrModuleOperHours, vpwrIoModuleConfigGroup=vpwrIoModuleConfigGroup, vpwrTrapBDAlarm=vpwrTrapBDAlarm, vpwrPanelModuleOID=vpwrPanelModuleOID, vpwrDcPowerBayController=vpwrDcPowerBayController, PositiveInteger=PositiveInteger, thermalProbeEntry=thermalProbeEntry, vpwrDcPowerDcDcConverter=vpwrDcPowerDcDcConverter, vpwrRingerParameterTable=vpwrRingerParameterTable, vpwrTrapEntry=vpwrTrapEntry, vpwrDcAcInverterConfigGroup=vpwrDcAcInverterConfigGroup, vpwrWriteCommunityString=vpwrWriteCommunityString, vpwrTrapAdminPwdChange=vpwrTrapAdminPwdChange, vpwrBayctrlModelNumber=vpwrBayctrlModelNumber, vpwrDcAcInverterAlarmGroup=vpwrDcAcInverterAlarmGroup, vpwrAlarmEntry=vpwrAlarmEntry, vpwrTrapCriticality=vpwrTrapCriticality, vpwrPanelBayIndex=vpwrPanelBayIndex, vpwrRingerAlarmBOverTemp=vpwrRingerAlarmBOverTemp, vpwrPanelModuleIdentEntry=vpwrPanelModuleIdentEntry, vpwrDcDcConverterTestGroup=vpwrDcDcConverterTestGroup, vpwrTrapSystemOK=vpwrTrapSystemOK, vpwrDcPowerTraps=vpwrDcPowerTraps, vpwrTrapHVSDAlarm=vpwrTrapHVSDAlarm, sysRelayConfigEntry=sysRelayConfigEntry, vpwrBDTAbortVoltage=vpwrBDTAbortVoltage, sysAuxAlarmIndex=sysAuxAlarmIndex, vpwrBayctrlModuleIdentEntry=vpwrBayctrlModuleIdentEntry, vpwrSystemBDAlarmSetpoint=vpwrSystemBDAlarmSetpoint, vpwrSystemIdentTable=vpwrSystemIdentTable, vpwrDcPowerMgt=vpwrDcPowerMgt, sysAuxAlarmConfigEntry=sysAuxAlarmConfigEntry, sysAlarmRedundancyState=sysAlarmRedundancyState, vpwrLvdContactorDisconnectSetpoint=vpwrLvdContactorDisconnectSetpoint, vpwrTrapEventTimeStamp=vpwrTrapEventTimeStamp, vpwrSystemInternalTempUThreshold=vpwrSystemInternalTempUThreshold, vpwrSystemTempCompStartTemperature=vpwrSystemTempCompStartTemperature, vpwrTrapCfgChange=vpwrTrapCfgChange, vpwrTrapRingerAAlarm=vpwrTrapRingerAAlarm, vpwrRectAlarmIShare=vpwrRectAlarmIShare, vpwrRectAlarmShortPinShutdown=vpwrRectAlarmShortPinShutdown, vpwrBatteryCurrentGroup=vpwrBatteryCurrentGroup, thermalProbeTable=thermalProbeTable, sysAuxAlarmSeverity=sysAuxAlarmSeverity, vpwrRingerAlarmaBFailed=vpwrRingerAlarmaBFailed, vpwrDcPowerTrapsMsgString=vpwrDcPowerTrapsMsgString, vpwrRingerParameterDcVoltage=vpwrRingerParameterDcVoltage, vpwrIdentManufacturer=vpwrIdentManufacturer, vpwrBattetyCurrentLimitValue=vpwrBattetyCurrentLimitValue, vpwrModuleModelNumber=vpwrModuleModelNumber, vpwrTrapPowerMinorAlarm=vpwrTrapPowerMinorAlarm, vpwrRingerAlarmGroup=vpwrRingerAlarmGroup, sysAlarmIndex=sysAlarmIndex, sysAuxAlarmToRelayMapping=sysAuxAlarmToRelayMapping, vpwrBDTAlarmCoefficient=vpwrBDTAlarmCoefficient, vpwrPanelModuleOperHours=vpwrPanelModuleOperHours, vpwrIdentModel=vpwrIdentModel, vpwrPanelModuleModelNumber=vpwrPanelModuleModelNumber, vpwrTrapModuleFailAlarm=vpwrTrapModuleFailAlarm, PYSNMP_MODULE_ID=vpwrDcPowerMgt, thermalProbeState=thermalProbeState, vpwrTrapModuleCommAlarm=vpwrTrapModuleCommAlarm, vpwrBatteryCurrentLimitAdminState=vpwrBatteryCurrentLimitAdminState, vpwrTrapCommunityString=vpwrTrapCommunityString, sysRelayIndex=sysRelayIndex, vpwrModuleIdentTable=vpwrModuleIdentTable, sysAlarmConfigTable=sysAlarmConfigTable, vpwrModuleIdentEntry=vpwrModuleIdentEntry, vpwrPanelModuleSerialNumber=vpwrPanelModuleSerialNumber, vpwrBatteryTempIndex=vpwrBatteryTempIndex, vpwrBatteryTempGroup=vpwrBatteryTempGroup, vpwrPanelIdentEntry=vpwrPanelIdentEntry, vpwrSystemHVAlarmSetpoint=vpwrSystemHVAlarmSetpoint, vpwrLvdContactorWarningSetpoint=vpwrLvdContactorWarningSetpoint, vpwrBatteryTempEntry=vpwrBatteryTempEntry, batteryTempCompRunawayTemperature=batteryTempCompRunawayTemperature, vpwrRectAlarmACFail=vpwrRectAlarmACFail, vpwrDcPowerDcAcInverter=vpwrDcPowerDcAcInverter, vpwrSystemParameterGroup=vpwrSystemParameterGroup, vpwrModuleOID=vpwrModuleOID, vpwrRectifierCurrentLimit=vpwrRectifierCurrentLimit, vpwrReadCommunityString=vpwrReadCommunityString, vpwrTrapThermalProbeAlarm=vpwrTrapThermalProbeAlarm, vpwrRectAlarmModDisableShutdown=vpwrRectAlarmModDisableShutdown, vpwrDcPowerLvd=vpwrDcPowerLvd, vpwrBayctrlModuleIdentTable=vpwrBayctrlModuleIdentTable, vpwrPanelModuleTestDate=vpwrPanelModuleTestDate, vpwrBayctrlSerialNumber=vpwrBayctrlSerialNumber, vpwrIoModuleAlarmGroup=vpwrIoModuleAlarmGroup, vpwrRingerAlarmBOverCurrent=vpwrRingerAlarmBOverCurrent, vpwrDcPowerRinger=vpwrDcPowerRinger, vpwrRectifierConfigGroup=vpwrRectifierConfigGroup, vpwrBatteryTempUThreshold=vpwrBatteryTempUThreshold, vpwrTrapSwDownloadAndReboot=vpwrTrapSwDownloadAndReboot, sysAlarmIShareState=sysAlarmIShareState, vpwrRingerAlarmAOTemp=vpwrRingerAlarmAOTemp, batteryTempCompensation=batteryTempCompensation, batteryTempCompRunawayState=batteryTempCompRunawayState, vpwrTrapModuleRemoved=vpwrTrapModuleRemoved, vpwrRectAlarmDCFail=vpwrRectAlarmDCFail, vpwrRingerParameterAdminState=vpwrRingerParameterAdminState, vpwrBoostVoltage=vpwrBoostVoltage, vpwrLvdContactorReconnectSetpoint=vpwrLvdContactorReconnectSetpoint, vpwrSystemBayctrlIdentGroup=vpwrSystemBayctrlIdentGroup, sysRelayCustomName=sysRelayCustomName, vpwrBayctrlIdentTable=vpwrBayctrlIdentTable, vpwrRectAlarmHVSD=vpwrRectAlarmHVSD, vpwrLvdContactorState=vpwrLvdContactorState, batteryTempCompHighSlope=batteryTempCompHighSlope, vpwrPanelModuleOperStatus=vpwrPanelModuleOperStatus, vpwrTrapUnmappedAddressAlarm=vpwrTrapUnmappedAddressAlarm, vpwrBDTAdminState=vpwrBDTAdminState, vpwrTrapIllegalConfigSubmit=vpwrTrapIllegalConfigSubmit, vpwrBayctrlIndex=vpwrBayctrlIndex, vpwrBoostAdminState=vpwrBoostAdminState, batteryTempCompRunawayStopVoltage=batteryTempCompRunawayStopVoltage, vpwrDcAcInverterTestGroup=vpwrDcAcInverterTestGroup, vpwrSystemInternalTempLThreshold=vpwrSystemInternalTempLThreshold, vpwrLvdDisconnectSetpoint=vpwrLvdDisconnectSetpoint, vpwrTrapIpAddress=vpwrTrapIpAddress, vpwrDcPowerSnmpConfig=vpwrDcPowerSnmpConfig, vpwrLvdConfigGroup=vpwrLvdConfigGroup, vpwrSystemCurrent=vpwrSystemCurrent, vpwrSystemIdentEntry=vpwrSystemIdentEntry, vpwrTrapBatteryRechgIlimitFailAlarm=vpwrTrapBatteryRechgIlimitFailAlarm, vpwrBoostOperState=vpwrBoostOperState, vpwrTrapThermalCompActive=vpwrTrapThermalCompActive, vpwrTrapOIDChange=vpwrTrapOIDChange, vpwrAlarmTime=vpwrAlarmTime, vpwrTrapSystemRedundancyAlarm=vpwrTrapSystemRedundancyAlarm, vpwrBoostDuration=vpwrBoostDuration, sysAlarmToRelayMapping=sysAlarmToRelayMapping, sysAlarmOperStatus=sysAlarmOperStatus, vpwrLvdTestGroup=vpwrLvdTestGroup, vpwrSystemVoltage=vpwrSystemVoltage, vpwrBayIndex=vpwrBayIndex, sysAlarmComFailState=sysAlarmComFailState, vpwrRingerNumberPresent=vpwrRingerNumberPresent, vpwrSystemPanelIdentGroup=vpwrSystemPanelIdentGroup, vpwrBatteryDischargeTestGroup=vpwrBatteryDischargeTestGroup, vpwrBayctrlIdentEntry=vpwrBayctrlIdentEntry, vpwrBatteryTempName=vpwrBatteryTempName, sysRelayConfigTable=sysRelayConfigTable, batteryTempCompLowSlope=batteryTempCompLowSlope, sysRelayDefaultName=sysRelayDefaultName, vpwrTrapDisplayFirmwareMismatchAlarm=vpwrTrapDisplayFirmwareMismatchAlarm, vpwrTrapSingleRingerAlarm=vpwrTrapSingleRingerAlarm, vpwrBDTOperState=vpwrBDTOperState, vpwrTrapMultipleModuleFailAlarm=vpwrTrapMultipleModuleFailAlarm, batteryTempCompHighStopVoltage=batteryTempCompHighStopVoltage, vpwrTrapMultipleConvFailAlarm=vpwrTrapMultipleConvFailAlarm, vpwrRectAlarmBoostComm=vpwrRectAlarmBoostComm, vpwrTrapBatteryTempAlarmSet=vpwrTrapBatteryTempAlarmSet, vpwrTrapMultipleRingerAlarm=vpwrTrapMultipleRingerAlarm, vpwrDcPowerSystem=vpwrDcPowerSystem, vpwrLvdReconnectDelayTimer=vpwrLvdReconnectDelayTimer, vpwrLvdReconnectSetpoint=vpwrLvdReconnectSetpoint, vpwrBayctrlOperStatus=vpwrBayctrlOperStatus, vpwrDcPowerModuleIdent=vpwrDcPowerModuleIdent, vpwrBatteryTempLThreshold=vpwrBatteryTempLThreshold, vpwrRectifierTestGroup=vpwrRectifierTestGroup, vpwrRingerParameterFrequency=vpwrRingerParameterFrequency, vpwrDcPowerTest=vpwrDcPowerTest, vpwrModuleSerialNumber=vpwrModuleSerialNumber, vpwrSystemShelfCapacity=vpwrSystemShelfCapacity, vpwrTrapSystemAlive=vpwrTrapSystemAlive, vpwrLvdContactorConfigEntry=vpwrLvdContactorConfigEntry, vpwrDcPowerIoModule=vpwrDcPowerIoModule, vpwrTrapInternalTempAlarmSet=vpwrTrapInternalTempAlarmSet, vpwrTrapModuleAlarm=vpwrTrapModuleAlarm, vpwrSystemTempCompStopVoltage=vpwrSystemTempCompStopVoltage, vpwrTrapConfigErrorAlarm=vpwrTrapConfigErrorAlarm, vpwrSystemConfigGroup=vpwrSystemConfigGroup, vpwrTrapClearEventHistory=vpwrTrapClearEventHistory, vpwrRectifierAlarmGroup=vpwrRectifierAlarmGroup, vpwrSystemControllerState=vpwrSystemControllerState, vpwrTrapBatteryTempAlarmCleared=vpwrTrapBatteryTempAlarmCleared, vpwrTrapLVDOpenAlarm=vpwrTrapLVDOpenAlarm, vpwrTrapLvdFuseOpen=vpwrTrapLvdFuseOpen, sysAuxAlarmOperStatus=sysAuxAlarmOperStatus, vpwrAlarmTable=vpwrAlarmTable, vpwrIdentControllerVersion=vpwrIdentControllerVersion, vpwrPanelModuleIdentTable=vpwrPanelModuleIdentTable, sysAuxAlarmPolarity=sysAuxAlarmPolarity, vpwrModuleCurrent=vpwrModuleCurrent, vpwrTrapPowerMajorAlarm=vpwrTrapPowerMajorAlarm, sysRelayAlarmSeverity=sysRelayAlarmSeverity, sysAuxAlarmCustomName=sysAuxAlarmCustomName, vpwrBayctrlCurrent=vpwrBayctrlCurrent, vpwrTrapRingerBAlarm=vpwrTrapRingerBAlarm, vpwrLvdAlarmCBOpen=vpwrLvdAlarmCBOpen, vpwrSystemType=vpwrSystemType, vpwrRectAlarmBoostFail=vpwrRectAlarmBoostFail, vpwrDcPowerTrio=vpwrDcPowerTrio, sysAlarmCustomName=sysAlarmCustomName, vpwrBDTAlarmVoltage=vpwrBDTAlarmVoltage, vpwrIdentName=vpwrIdentName, vpwrRingerConfigGroup=vpwrRingerConfigGroup, vpwrTrapTable=vpwrTrapTable, sysAlarmSeverity=sysAlarmSeverity, vpwrTrapModuleInserted=vpwrTrapModuleInserted, vpwrTrapUserIpAddress=vpwrTrapUserIpAddress, vpwrRectAlarmDCEnable=vpwrRectAlarmDCEnable, vpwrPanelModuleIndex=vpwrPanelModuleIndex, vpwrModuleIndex=vpwrModuleIndex, vpwrTrapAuxAlarm=vpwrTrapAuxAlarm, vpwrTrapsMsgString=vpwrTrapsMsgString, batteryTempCompLowStartTemperature=batteryTempCompLowStartTemperature, vpwrTrapHVAlarm=vpwrTrapHVAlarm, batteryTempCompSenseSource=batteryTempCompSenseSource, vpwrRectAlarmRemoteShutdown=vpwrRectAlarmRemoteShutdown, vpwrRingerParameterAcVoltage=vpwrRingerParameterAcVoltage, vpwrRectifierCurrentLimitAdminState=vpwrRectifierCurrentLimitAdminState, batteryTempCompLowStopVoltage=batteryTempCompLowStopVoltage, vpwrTrapDistAlarm=vpwrTrapDistAlarm, vpwrRectAlarmFanFail=vpwrRectAlarmFanFail, vpwrModuleTestDate=vpwrModuleTestDate, vpwrModuleOperStatus=vpwrModuleOperStatus, vpwrRingerAlarmaAFailed=vpwrRingerAlarmaAFailed, vpwrPanelIdentTable=vpwrPanelIdentTable, vpwrRingerParameterEntry=vpwrRingerParameterEntry, vpwrTrapConverterInputFailAlarm=vpwrTrapConverterInputFailAlarm, vpwrRingerAlarmAOCurrent=vpwrRingerAlarmAOCurrent, vpwrSystemTempCompensationSlope=vpwrSystemTempCompensationSlope, vpwrTrapDistributionCommAlarm=vpwrTrapDistributionCommAlarm, vpwrTrapConverterAlarm=vpwrTrapConverterAlarm, vpwrDcPowerProducts=vpwrDcPowerProducts, vpwrSystemThermalSenseType=vpwrSystemThermalSenseType, vpwrTrapRingerCommAlarm=vpwrTrapRingerCommAlarm, vpwrBatteryBoostGroup=vpwrBatteryBoostGroup, vpwrBatteryTempTable=vpwrBatteryTempTable, vpwrIdentAgentSoftwareVersion=vpwrIdentAgentSoftwareVersion, vpwrTrapSystemOverTemperatureAlarm=vpwrTrapSystemOverTemperatureAlarm, vpwrSystemInternalTemperature=vpwrSystemInternalTemperature)
mibBuilder.exportSymbols("VALERE-DC-POWER-MIB", vpwrTrapInternalTempAlarmCleared=vpwrTrapInternalTempAlarmCleared, NonNegativeInteger=NonNegativeInteger, vpwrDcPowerBatteryGroup=vpwrDcPowerBatteryGroup, vpwrLvdContactorIndex=vpwrLvdContactorIndex, vpwrTrapLoginFail=vpwrTrapLoginFail, vpwrDcDcConverterAlarmGroup=vpwrDcDcConverterAlarmGroup, vpwrTrapLoginSuccess=vpwrTrapLoginSuccess, vpwrBattetyCurrentValue=vpwrBattetyCurrentValue, vpwrSystemIdentGroup=vpwrSystemIdentGroup, vpwrBDTDuration=vpwrBDTDuration, vpwrDcDcConverterConfigGroup=vpwrDcDcConverterConfigGroup, sysAuxAlarmDefaultName=sysAuxAlarmDefaultName, vpwrBayctrlOperHours=vpwrBayctrlOperHours, vpwrModuleCapacity=vpwrModuleCapacity, vpwrSystemTempCompensation=vpwrSystemTempCompensation, vpwrTrapLVDWarningAlarm=vpwrTrapLVDWarningAlarm, vpwrTrapBatteryDischargeTestAlarm=vpwrTrapBatteryDischargeTestAlarm, sysAlarmConfigEntry=sysAlarmConfigEntry, vpwrTrapThermalCompInactive=vpwrTrapThermalCompInactive, vpwrBayctrlOID=vpwrBayctrlOID, vpwrRingerIndex=vpwrRingerIndex, vpwrRectAlarmIntTemp=vpwrRectAlarmIntTemp, vpwrLvdAlarmContactorOpen=vpwrLvdAlarmContactorOpen, vpwrLvdAlarmWarning=vpwrLvdAlarmWarning, vpwrRectAlarmLowVoltage=vpwrRectAlarmLowVoltage, vpwrTrapThermalRunaway=vpwrTrapThermalRunaway, vpwrPanelModuleCurrent=vpwrPanelModuleCurrent, vpwrRectifierFVSetpoint=vpwrRectifierFVSetpoint, vpwrTrapSystemClockChange=vpwrTrapSystemClockChange, sysAuxAlarmConfigTable=sysAuxAlarmConfigTable, vpwrRingerTestGroup=vpwrRingerTestGroup, vpwrLvdContactorConfigTable=vpwrLvdContactorConfigTable, vpwrModuleFwVersion=vpwrModuleFwVersion, vpwrLvdWarningSetpoint=vpwrLvdWarningSetpoint, vpwrSystemTempCompensationState=vpwrSystemTempCompensationState, vpwrAlarmIndex=vpwrAlarmIndex, vpwrBayctrlFwVersion=vpwrBayctrlFwVersion, vpwrBatteryTemp=vpwrBatteryTemp, vpwrLvdAlarmGroup=vpwrLvdAlarmGroup, vpwrDcPowerRectifier=vpwrDcPowerRectifier, vpwrAlarmDescr=vpwrAlarmDescr, vpwrPanelModuleFwVersion=vpwrPanelModuleFwVersion)
