...
Counter32, enterprises, Bits, Gauge32, Integer32, Counter64, MibIdentifier, iso, NotificationType, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "enterprises", "Bits", "Gauge32", "Integer32", "Counter64", "MibIdentifier", "iso", "NotificationType", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("VALERE-DC-POWER-MIB", vpwrModuleOperStatus=vpwrModuleOperStatus, batteryTempCompRunawayStopVoltage=batteryTempCompRunawayStopVoltage, vpwrSystemInternalTempUThreshold=vpwrSystemInternalTempUThreshold, sysAuxAlarmSeverity=sysAuxAlarmSeverity, sysAlarmComFailState=sysAlarmComFailState, vpwrModuleOperHours=vpwrModuleOperHours, vpwrTrapConverterInputFailAlarm=vpwrTrapConverterInputFailAlarm, vpwrDcPowerBayController=vpwrDcPowerBayController, vpwrPanelModuleCurrent=vpwrPanelModuleCurrent, vpwrTrapConfigErrorAlarm=vpwrTrapConfigErrorAlarm, sysRelayConfigEntry=sysRelayConfigEntry, vpwrPanelModuleOperHours=vpwrPanelModuleOperHours, vpwrTrapMultipleRingerAlarm=vpwrTrapMultipleRingerAlarm, vpwrPanelModuleIndex=vpwrPanelModuleIndex, vpwrSystemInternalTemperature=vpwrSystemInternalTemperature, vpwrTrapSystemOverTemperatureAlarm=vpwrTrapSystemOverTemperatureAlarm, vpwrBatteryTempEntry=vpwrBatteryTempEntry, vpwrRectAlarmBoostComm=vpwrRectAlarmBoostComm, PYSNMP_MODULE_ID=vpwrDcPowerMgt, vpwrSystemShelfCapacity=vpwrSystemShelfCapacity, vpwrPanelModuleIdentEntry=vpwrPanelModuleIdentEntry, vpwrSystemBayctrlIdentGroup=vpwrSystemBayctrlIdentGroup, vpwrIdentControllerVersion=vpwrIdentControllerVersion, vpwrBayctrlOperStatus=vpwrBayctrlOperStatus, vpwrSystemTempCompensationSlope=vpwrSystemTempCompensationSlope, vpwrRectAlarmHVSD=vpwrRectAlarmHVSD, vpwrIoModuleTestGroup=vpwrIoModuleTestGroup, vpwrBoostOperState=vpwrBoostOperState, sysAuxAlarmIndex=sysAuxAlarmIndex, vpwrRingerAlarmBOverCurrent=vpwrRingerAlarmBOverCurrent, vpwrSystemIdentEntry=vpwrSystemIdentEntry, vpwrBatteryTemp=vpwrBatteryTemp, vpwrRectAlarmIntTemp=vpwrRectAlarmIntTemp, vpwrBayctrlSerialNumber=vpwrBayctrlSerialNumber, vpwrLvdReconnectSetpoint=vpwrLvdReconnectSetpoint, vpwrLvdContactorState=vpwrLvdContactorState, vpwrAlarmIndex=vpwrAlarmIndex, vpwrAlarmsPresent=vpwrAlarmsPresent, vpwrBDTAlarmCoefficient=vpwrBDTAlarmCoefficient, sysAlarmIShareState=sysAlarmIShareState, sysRelayConfigTable=sysRelayConfigTable, vpwrSystemTempCompensationState=vpwrSystemTempCompensationState, vpwrSystemIdentGroup=vpwrSystemIdentGroup, vpwrRingerAlarmGroup=vpwrRingerAlarmGroup, vpwrTrapHVAlarm=vpwrTrapHVAlarm, vpwrRectAlarmAmbTemp=vpwrRectAlarmAmbTemp, vpwrTrapClearEventHistory=vpwrTrapClearEventHistory, vpwrPanelModuleSerialNumber=vpwrPanelModuleSerialNumber, vpwrIdentAgentSoftwareVersion=vpwrIdentAgentSoftwareVersion, vpwrRectifierHVSDSetpoint=vpwrRectifierHVSDSetpoint, vpwrTrapModuleFailAlarm=vpwrTrapModuleFailAlarm, sysAlarmSeverity=sysAlarmSeverity, vpwrDcPowerDist=vpwrDcPowerDist, vpwrLvdConfigGroup=vpwrLvdConfigGroup, vpwrRectAlarmUV=vpwrRectAlarmUV, vpwrBDTAbortVoltage=vpwrBDTAbortVoltage, vpwrTrapSingleRingerAlarm=vpwrTrapSingleRingerAlarm, vpwrTrapThermalRunaway=vpwrTrapThermalRunaway, thermalProbeState=thermalProbeState, vpwrAlarmDescr=vpwrAlarmDescr, vpwrRingerParameterAcVoltage=vpwrRingerParameterAcVoltage, vpwrModuleTestDate=vpwrModuleTestDate, PositiveInteger=PositiveInteger, vpwrTrapDisplayFirmwareMismatchAlarm=vpwrTrapDisplayFirmwareMismatchAlarm, vpwrDcPowerSystem=vpwrDcPowerSystem, vpwrSystemCurrent=vpwrSystemCurrent, vpwrModuleCapacity=vpwrModuleCapacity, vpwrAlarmEntry=vpwrAlarmEntry, vpwrBayctrlOID=vpwrBayctrlOID, vpwrTrapSystemRedundancyAlarm=vpwrTrapSystemRedundancyAlarm, vpwrRingerParameterAdminState=vpwrRingerParameterAdminState, vpwrTrapMultipleModuleFailAlarm=vpwrTrapMultipleModuleFailAlarm, vpwrRectAlarmFanFail=vpwrRectAlarmFanFail, sysAlarmToRelayMapping=sysAlarmToRelayMapping, vpwrSystemControllerState=vpwrSystemControllerState, vpwrModuleSerialNumber=vpwrModuleSerialNumber, vpwrTrapTable=vpwrTrapTable, vpwrTrapModuleInserted=vpwrTrapModuleInserted, vpwrTrapUnmappedAddressAlarm=vpwrTrapUnmappedAddressAlarm, vpwrDcPowerTraps=vpwrDcPowerTraps, vpwrRectAlarmDCFail=vpwrRectAlarmDCFail, sysAlarmConfigEntry=sysAlarmConfigEntry, vpwrBattetyCurrentValue=vpwrBattetyCurrentValue, vpwrPanelModuleTestDate=vpwrPanelModuleTestDate, sysAlarmDefaultName=sysAlarmDefaultName, batteryTempCompLowSlope=batteryTempCompLowSlope, vpwrRingerParameterTable=vpwrRingerParameterTable, vpwrRectifierConfigGroup=vpwrRectifierConfigGroup, vpwrDcPowerProducts=vpwrDcPowerProducts, vpwrBatteryTempIndex=vpwrBatteryTempIndex, vpwrPanelModuleModelNumber=vpwrPanelModuleModelNumber, vpwrTrapModuleAlarm=vpwrTrapModuleAlarm, vpwrBayIndex=vpwrBayIndex, vpwrTrapCfgChange=vpwrTrapCfgChange, vpwrRectAlarmDCEnable=vpwrRectAlarmDCEnable, vpwrTrapModuleCommAlarm=vpwrTrapModuleCommAlarm, vpwrModuleFwVersion=vpwrModuleFwVersion, vpwrRectifierAlarmGroup=vpwrRectifierAlarmGroup, vpwrTrapLogout=vpwrTrapLogout, vpwrSystemInternalTempLThreshold=vpwrSystemInternalTempLThreshold, vpwrPanelBayIndex=vpwrPanelBayIndex, vpwrRingerAlarmBOverTemp=vpwrRingerAlarmBOverTemp, vpwrBatteryTempGroup=vpwrBatteryTempGroup, vpwrTrapSystemClockChange=vpwrTrapSystemClockChange, vpwrLvdDisconnectSetpoint=vpwrLvdDisconnectSetpoint, vpwrRingerTestGroup=vpwrRingerTestGroup, vpwrLvdContactorReconnectDelayTimer=vpwrLvdContactorReconnectDelayTimer, vpwrBatteryTempLThreshold=vpwrBatteryTempLThreshold, vpwrLvdTestGroup=vpwrLvdTestGroup, vpwrSystemHVAlarmSetpoint=vpwrSystemHVAlarmSetpoint, vpwrTrapLoginFail=vpwrTrapLoginFail, vpwrBatteryTempTable=vpwrBatteryTempTable, vpwrModuleIndex=vpwrModuleIndex, vpwrModuleModelNumber=vpwrModuleModelNumber, vpwrModuleIdentTable=vpwrModuleIdentTable, vpwrTrapInternalTempAlarmSet=vpwrTrapInternalTempAlarmSet, vpwrBayctrlIdentEntry=vpwrBayctrlIdentEntry, vpwrBDTAdminState=vpwrBDTAdminState, batteryTempCompensation=batteryTempCompensation, vpwrLvdContactorConfigEntry=vpwrLvdContactorConfigEntry, vpwrTrapConverterAlarm=vpwrTrapConverterAlarm, vpwrDcPowerSnmpConfig=vpwrDcPowerSnmpConfig, sysAuxAlarmToRelayMapping=sysAuxAlarmToRelayMapping, vpwrBatteryCurrentGroup=vpwrBatteryCurrentGroup, vpwrRectifierTestGroup=vpwrRectifierTestGroup, vpwrBatteryDischargeTestGroup=vpwrBatteryDischargeTestGroup, vpwrDcAcInverterAlarmGroup=vpwrDcAcInverterAlarmGroup, vpwrTrapLoginSuccess=vpwrTrapLoginSuccess, sysAlarmCustomName=sysAlarmCustomName, vpwrLvdReconnectDelayTimer=vpwrLvdReconnectDelayTimer, vpwrLvdAlarmGroup=vpwrLvdAlarmGroup, vpwrRectifierCurrentLimitAdminState=vpwrRectifierCurrentLimitAdminState, batteryTempCompLowStartTemperature=batteryTempCompLowStartTemperature, NonNegativeInteger=NonNegativeInteger, vpwrLvdContactorWarningSetpoint=vpwrLvdContactorWarningSetpoint, vpwrTrapLVDWarningAlarm=vpwrTrapLVDWarningAlarm, vpwrWriteCommunityString=vpwrWriteCommunityString, vpwrTrapRingerCommAlarm=vpwrTrapRingerCommAlarm, vpwrRectifierFVSetpoint=vpwrRectifierFVSetpoint, vpwrTrapPowerMinorAlarm=vpwrTrapPowerMinorAlarm, vpwrRingerAlarmAOTemp=vpwrRingerAlarmAOTemp, vpwrModuleCurrent=vpwrModuleCurrent, vpwrBayctrlIdentTable=vpwrBayctrlIdentTable, vpwrSystemTempCompStartTemperature=vpwrSystemTempCompStartTemperature, vpwrAlarmTime=vpwrAlarmTime, vpwrDcDcConverterConfigGroup=vpwrDcDcConverterConfigGroup, batteryTempCompSenseSource=batteryTempCompSenseSource, vpwrDcDcConverterTestGroup=vpwrDcDcConverterTestGroup, vpwrDcPowerAlarmGroup=vpwrDcPowerAlarmGroup, vpwrBattetyCurrentLimitValue=vpwrBattetyCurrentLimitValue, vpwrLvdContactorDisconnectSetpoint=vpwrLvdContactorDisconnectSetpoint, vpwrSystemBDAlarmSetpoint=vpwrSystemBDAlarmSetpoint, vpwrIoModuleAlarmGroup=vpwrIoModuleAlarmGroup, vpwrTrapEventTimeStamp=vpwrTrapEventTimeStamp, vpwrIoModuleConfigGroup=vpwrIoModuleConfigGroup, vpwrLvdContactorReconnectSetpoint=vpwrLvdContactorReconnectSetpoint, vpwrTrapsMsgString=vpwrTrapsMsgString, vpwrBayctrlIndex=vpwrBayctrlIndex, vpwrRectAlarmBoostFail=vpwrRectAlarmBoostFail, sysAlarmIndex=sysAlarmIndex, vpwrDcPowerLvd=vpwrDcPowerLvd, vpwrRingerParameterFrequency=vpwrRingerParameterFrequency, sysAuxAlarmDefaultName=sysAuxAlarmDefaultName, vpwrDcPowerIoModule=vpwrDcPowerIoModule, batteryTempCompHighSlope=batteryTempCompHighSlope, vpwrTrapLVDOpenAlarm=vpwrTrapLVDOpenAlarm, vpwrDcPowerTrio=vpwrDcPowerTrio, vpwrDcAcInverterTestGroup=vpwrDcAcInverterTestGroup, batteryTempCompLowStopVoltage=batteryTempCompLowStopVoltage, vpwrTrapDistributionCommAlarm=vpwrTrapDistributionCommAlarm, vpwrModuleIdentEntry=vpwrModuleIdentEntry, sysRelayIndex=sysRelayIndex, batteryTempCompRunawayState=batteryTempCompRunawayState, vpwrTrapACFAlarm=vpwrTrapACFAlarm, vpwrLvdAlarmWarning=vpwrLvdAlarmWarning, vpwrDcAcInverterConfigGroup=vpwrDcAcInverterConfigGroup, vpwrTrapSystemAlive=vpwrTrapSystemAlive, sysAuxAlarmCustomName=sysAuxAlarmCustomName, vpwrIdentManufacturer=vpwrIdentManufacturer, vpwrTrapEntry=vpwrTrapEntry, vpwrDcPowerBatteryGroup=vpwrDcPowerBatteryGroup, vpwrBayctrlCapacity=vpwrBayctrlCapacity, vpwrSystemType=vpwrSystemType, vpwrSystemParameterGroup=vpwrSystemParameterGroup, vpwrBoostVoltage=vpwrBoostVoltage, vpwrBayctrlOperHours=vpwrBayctrlOperHours, vpwrReadCommunityString=vpwrReadCommunityString, vpwrBDTOperState=vpwrBDTOperState, vpwrDcPowerTest=vpwrDcPowerTest, vpwrDcPowerTrapsMsgString=vpwrDcPowerTrapsMsgString, vpwrLvdContactorIndex=vpwrLvdContactorIndex, vpwrBatteryTempUThreshold=vpwrBatteryTempUThreshold, thermalProbeTable=thermalProbeTable, vpwrRingerParameterDcVoltage=vpwrRingerParameterDcVoltage, vpwrTrapDistAlarm=vpwrTrapDistAlarm, vpwrLvdContactorConfigTable=vpwrLvdContactorConfigTable, vpwrTrapMultipleConvFailAlarm=vpwrTrapMultipleConvFailAlarm, vpwrRingerIndex=vpwrRingerIndex, vpwrIdentName=vpwrIdentName, vpwrSystemIdentTable=vpwrSystemIdentTable, thermalProbeEntry=thermalProbeEntry, vpwrTrapIpIndex=vpwrTrapIpIndex, sysAuxAlarmPolarity=sysAuxAlarmPolarity, vpwrSystemThermalSenseType=vpwrSystemThermalSenseType, vpwrTrapHVSDAlarm=vpwrTrapHVSDAlarm, vpwrRectAlarmIShare=vpwrRectAlarmIShare, vpwrPanelIdentTable=vpwrPanelIdentTable, vpwrRectAlarmLowVoltage=vpwrRectAlarmLowVoltage, sysRelayDefaultName=sysRelayDefaultName, vpwrRectAlarmShortPinShutdown=vpwrRectAlarmShortPinShutdown, vpwrDcPowerMgt=vpwrDcPowerMgt, vpwrTrapIllegalConfigSubmit=vpwrTrapIllegalConfigSubmit, vpwrLvdAlarmContactorOpen=vpwrLvdAlarmContactorOpen, vpwrRingerNumberPresent=vpwrRingerNumberPresent, vpwrBoostDuration=vpwrBoostDuration, vpwrRingerAlarmaAFailed=vpwrRingerAlarmaAFailed, vpwrTrapBatteryDischargeTestAlarm=vpwrTrapBatteryDischargeTestAlarm, vpwrAlarmTable=vpwrAlarmTable, batteryTempCompHighStopVoltage=batteryTempCompHighStopVoltage, vpwrTrapThermalCompInactive=vpwrTrapThermalCompInactive, vpwrBDTDuration=vpwrBDTDuration, vpwrSystemPanelIdentGroup=vpwrSystemPanelIdentGroup, sysAuxAlarmConfigTable=sysAuxAlarmConfigTable, vpwrBDTClearAlarm=vpwrBDTClearAlarm, vpwrTrapCommunityString=vpwrTrapCommunityString, vpwrTrapRingerBAlarm=vpwrTrapRingerBAlarm, vpwrBatteryBoostGroup=vpwrBatteryBoostGroup, sysAlarmOperStatus=sysAlarmOperStatus, sysAlarmRedundancyState=sysAlarmRedundancyState, vpwrPanelModuleIdentTable=vpwrPanelModuleIdentTable, vpwrBayctrlFwVersion=vpwrBayctrlFwVersion, vpwrTrapAdminPwdChange=vpwrTrapAdminPwdChange, vpwrDcPowerModuleIdent=vpwrDcPowerModuleIdent, vpwrRingerAlarmAOCurrent=vpwrRingerAlarmAOCurrent, vpwrTrapIpAddress=vpwrTrapIpAddress, vpwrPanelModuleFwVersion=vpwrPanelModuleFwVersion, vpwrSystemConfigGroup=vpwrSystemConfigGroup, vpwrTrapThermalProbeAlarm=vpwrTrapThermalProbeAlarm, vpwrTrapCriticality=vpwrTrapCriticality, vpwrTrapSwDownloadAndReboot=vpwrTrapSwDownloadAndReboot, sysRelayCustomName=sysRelayCustomName, vpwrBayctrlModuleIdentEntry=vpwrBayctrlModuleIdentEntry, vpwrTrapLvdFuseOpen=vpwrTrapLvdFuseOpen, vpwrSystemTempCompStopVoltage=vpwrSystemTempCompStopVoltage, vpwrRectAlarmReserved=vpwrRectAlarmReserved, vpwrTrapSwDownloadNoReboot=vpwrTrapSwDownloadNoReboot, vpwrBayctrlModuleIdentTable=vpwrBayctrlModuleIdentTable, vpwrRectAlarmACFail=vpwrRectAlarmACFail, sysAlarmConfigTable=sysAlarmConfigTable, vpwrRingerConfigGroup=vpwrRingerConfigGroup, vpwrTrapAuxAlarm=vpwrTrapAuxAlarm, vpwrTrapBatteryRechgIlimitFailAlarm=vpwrTrapBatteryRechgIlimitFailAlarm, vpwrIdentModel=vpwrIdentModel, vpwrDcPowerDcDcConverter=vpwrDcPowerDcDcConverter)
mibBuilder.exportSymbols("VALERE-DC-POWER-MIB", vpwrTrapBDAlarm=vpwrTrapBDAlarm, vpwrTrapThermalCompActive=vpwrTrapThermalCompActive, vpwrLvdAlarmCBOpen=vpwrLvdAlarmCBOpen, vpwrBatteryTempName=vpwrBatteryTempName, vpwrTrapModuleRemoved=vpwrTrapModuleRemoved, sysAuxAlarmOperStatus=sysAuxAlarmOperStatus, vpwrBDTAlarmVoltage=vpwrBDTAlarmVoltage, vpwrBoostAdminState=vpwrBoostAdminState, vpwrTrapUserIpAddress=vpwrTrapUserIpAddress, vpwrBayctrlCurrent=vpwrBayctrlCurrent, vpwrTrapPowerMajorAlarm=vpwrTrapPowerMajorAlarm, vpwrSystemTempCompensation=vpwrSystemTempCompensation, vpwrDcDcConverterAlarmGroup=vpwrDcDcConverterAlarmGroup, vpwrRectAlarmRemoteShutdown=vpwrRectAlarmRemoteShutdown, vpwrBayctrlTestDate=vpwrBayctrlTestDate, vpwrPanelModuleCapacity=vpwrPanelModuleCapacity, batteryTempCompHighStartTemperature=batteryTempCompHighStartTemperature, batteryTempCompRunawayTemperature=batteryTempCompRunawayTemperature, vpwrDcPowerRectifier=vpwrDcPowerRectifier, vpwrDcPowerDcAcInverter=vpwrDcPowerDcAcInverter, vpwrTrapSystemOK=vpwrTrapSystemOK, vpwrRingerParameterEntry=vpwrRingerParameterEntry, vpwrDcPowerRinger=vpwrDcPowerRinger, vpwrTrapIShareAlarm=vpwrTrapIShareAlarm, sysAuxAlarmConfigEntry=sysAuxAlarmConfigEntry, vpwrModuleOID=vpwrModuleOID, vpwrTrapBatteryTempAlarmCleared=vpwrTrapBatteryTempAlarmCleared, vpwrSystemVoltage=vpwrSystemVoltage, vpwrBatteryCurrentLimitAdminState=vpwrBatteryCurrentLimitAdminState, vpwrRectifierCurrentLimit=vpwrRectifierCurrentLimit, vpwrTrapInternalTempAlarmCleared=vpwrTrapInternalTempAlarmCleared, vpwrPanelIdentEntry=vpwrPanelIdentEntry, vpwrTrapOIDChange=vpwrTrapOIDChange, vpwrLvdWarningSetpoint=vpwrLvdWarningSetpoint, vpwrTrapBatteryTempAlarmSet=vpwrTrapBatteryTempAlarmSet, vpwrPanelModuleOperStatus=vpwrPanelModuleOperStatus, vpwrRingerAlarmaBFailed=vpwrRingerAlarmaBFailed, vpwrRectAlarmModDisableShutdown=vpwrRectAlarmModDisableShutdown, sysRelayAlarmSeverity=sysRelayAlarmSeverity, vpwrTrapRingerAAlarm=vpwrTrapRingerAAlarm, vpwrPanelModuleOID=vpwrPanelModuleOID, vpwrBayctrlModelNumber=vpwrBayctrlModelNumber)
