...
mibBuilder.exportSymbols("VALERE-DC-POWER-MIB", vpwrTrapMultipleConvFailAlarm=vpwrTrapMultipleConvFailAlarm, vpwrModuleIdentEntry=vpwrModuleIdentEntry, sysAlarmComFailState=sysAlarmComFailState, vpwrTrapModuleRemoved=vpwrTrapModuleRemoved, vpwrTrapSystemAlive=vpwrTrapSystemAlive, vpwrBoostOperState=vpwrBoostOperState, PYSNMP_MODULE_ID=vpwrDcPowerMgt, vpwrTrapHVSDAlarm=vpwrTrapHVSDAlarm, vpwrRectAlarmIShare=vpwrRectAlarmIShare, vpwrTrapBatteryDischargeTestAlarm=vpwrTrapBatteryDischargeTestAlarm, vpwrRectifierCurrentLimitAdminState=vpwrRectifierCurrentLimitAdminState, sysAlarmDefaultName=sysAlarmDefaultName, vpwrTrapAuxAlarm=vpwrTrapAuxAlarm, batteryTempCompRunawayState=batteryTempCompRunawayState, vpwrTrapUnmappedAddressAlarm=vpwrTrapUnmappedAddressAlarm, vpwrDcDcConverterTestGroup=vpwrDcDcConverterTestGroup, vpwrLvdDisconnectSetpoint=vpwrLvdDisconnectSetpoint, vpwrLvdConfigGroup=vpwrLvdConfigGroup, sysAuxAlarmToRelayMapping=sysAuxAlarmToRelayMapping, vpwrTrapSwDownloadAndReboot=vpwrTrapSwDownloadAndReboot, vpwrLvdContactorConfigEntry=vpwrLvdContactorConfigEntry, vpwrTrapOIDChange=vpwrTrapOIDChange, vpwrSystemTempCompStopVoltage=vpwrSystemTempCompStopVoltage, vpwrBoostVoltage=vpwrBoostVoltage, vpwrBayctrlFwVersion=vpwrBayctrlFwVersion, vpwrBatteryTempUThreshold=vpwrBatteryTempUThreshold, vpwrTrapCommunityString=vpwrTrapCommunityString, vpwrRectAlarmUV=vpwrRectAlarmUV, sysAuxAlarmPolarity=sysAuxAlarmPolarity, vpwrTrapDisplayFirmwareMismatchAlarm=vpwrTrapDisplayFirmwareMismatchAlarm, vpwrBayctrlIdentTable=vpwrBayctrlIdentTable, vpwrLvdAlarmContactorOpen=vpwrLvdAlarmContactorOpen, sysAlarmSeverity=sysAlarmSeverity, vpwrSystemShelfCapacity=vpwrSystemShelfCapacity, vpwrTrapEntry=vpwrTrapEntry, vpwrTrapMultipleModuleFailAlarm=vpwrTrapMultipleModuleFailAlarm, sysRelayConfigTable=sysRelayConfigTable, vpwrBatteryTempEntry=vpwrBatteryTempEntry, vpwrDcPowerTraps=vpwrDcPowerTraps, vpwrRectAlarmModDisableShutdown=vpwrRectAlarmModDisableShutdown, vpwrDcPowerTrapsMsgString=vpwrDcPowerTrapsMsgString, sysAlarmConfigTable=sysAlarmConfigTable, sysRelayConfigEntry=sysRelayConfigEntry, vpwrBayctrlModuleIdentEntry=vpwrBayctrlModuleIdentEntry, vpwrLvdContactorState=vpwrLvdContactorState, vpwrDcPowerIoModule=vpwrDcPowerIoModule, vpwrTrapModuleInserted=vpwrTrapModuleInserted, vpwrModuleCurrent=vpwrModuleCurrent, vpwrBatteryTempLThreshold=vpwrBatteryTempLThreshold, sysAuxAlarmConfigEntry=sysAuxAlarmConfigEntry, vpwrModuleCapacity=vpwrModuleCapacity, vpwrModuleIdentTable=vpwrModuleIdentTable, vpwrIdentManufacturer=vpwrIdentManufacturer, vpwrBoostDuration=vpwrBoostDuration, vpwrTrapBDAlarm=vpwrTrapBDAlarm, vpwrDcDcConverterConfigGroup=vpwrDcDcConverterConfigGroup, vpwrIdentModel=vpwrIdentModel, vpwrTrapConverterInputFailAlarm=vpwrTrapConverterInputFailAlarm, vpwrBayctrlSerialNumber=vpwrBayctrlSerialNumber, vpwrLvdTestGroup=vpwrLvdTestGroup, vpwrTrapModuleFailAlarm=vpwrTrapModuleFailAlarm, vpwrLvdContactorReconnectSetpoint=vpwrLvdContactorReconnectSetpoint, vpwrSystemInternalTempLThreshold=vpwrSystemInternalTempLThreshold, sysAlarmConfigEntry=sysAlarmConfigEntry, vpwrPanelModuleCurrent=vpwrPanelModuleCurrent, batteryTempCompRunawayStopVoltage=batteryTempCompRunawayStopVoltage, vpwrPanelModuleTestDate=vpwrPanelModuleTestDate, vpwrPanelIdentEntry=vpwrPanelIdentEntry, vpwrBayctrlIdentEntry=vpwrBayctrlIdentEntry, vpwrBatteryTemp=vpwrBatteryTemp, vpwrBayctrlModelNumber=vpwrBayctrlModelNumber, vpwrLvdWarningSetpoint=vpwrLvdWarningSetpoint, vpwrRectifierFVSetpoint=vpwrRectifierFVSetpoint, vpwrWriteCommunityString=vpwrWriteCommunityString, vpwrAlarmsPresent=vpwrAlarmsPresent, vpwrTrapThermalCompInactive=vpwrTrapThermalCompInactive, vpwrIoModuleConfigGroup=vpwrIoModuleConfigGroup, vpwrTrapLVDWarningAlarm=vpwrTrapLVDWarningAlarm, vpwrIdentName=vpwrIdentName, vpwrRingerTestGroup=vpwrRingerTestGroup, vpwrSystemCurrent=vpwrSystemCurrent, vpwrDcPowerModuleIdent=vpwrDcPowerModuleIdent, sysRelayAlarmSeverity=sysRelayAlarmSeverity, vpwrRectAlarmBoostComm=vpwrRectAlarmBoostComm, vpwrSystemTempCompStartTemperature=vpwrSystemTempCompStartTemperature, vpwrLvdContactorWarningSetpoint=vpwrLvdContactorWarningSetpoint, vpwrModuleIndex=vpwrModuleIndex, vpwrTrapACFAlarm=vpwrTrapACFAlarm, vpwrTrapBatteryRechgIlimitFailAlarm=vpwrTrapBatteryRechgIlimitFailAlarm, sysAuxAlarmDefaultName=sysAuxAlarmDefaultName, vpwrSystemType=vpwrSystemType, vpwrRectAlarmLowVoltage=vpwrRectAlarmLowVoltage, vpwrRingerParameterEntry=vpwrRingerParameterEntry, vpwrTrapPowerMinorAlarm=vpwrTrapPowerMinorAlarm, vpwrBDTAdminState=vpwrBDTAdminState, vpwrDcPowerRinger=vpwrDcPowerRinger, vpwrLvdContactorDisconnectSetpoint=vpwrLvdContactorDisconnectSetpoint, vpwrDcPowerMgt=vpwrDcPowerMgt, sysAlarmIShareState=sysAlarmIShareState, vpwrRingerAlarmaAFailed=vpwrRingerAlarmaAFailed, vpwrBDTDuration=vpwrBDTDuration, vpwrAlarmTime=vpwrAlarmTime, vpwrBatteryTempIndex=vpwrBatteryTempIndex, vpwrBDTAlarmCoefficient=vpwrBDTAlarmCoefficient, vpwrDcPowerSnmpConfig=vpwrDcPowerSnmpConfig, vpwrTrapInternalTempAlarmSet=vpwrTrapInternalTempAlarmSet, vpwrTrapConverterAlarm=vpwrTrapConverterAlarm, vpwrTrapSystemClockChange=vpwrTrapSystemClockChange, vpwrAlarmDescr=vpwrAlarmDescr, vpwrPanelModuleFwVersion=vpwrPanelModuleFwVersion, vpwrDcPowerBayController=vpwrDcPowerBayController, vpwrDcAcInverterTestGroup=vpwrDcAcInverterTestGroup, vpwrTrapRingerBAlarm=vpwrTrapRingerBAlarm, vpwrPanelModuleIdentTable=vpwrPanelModuleIdentTable, batteryTempCompHighStopVoltage=batteryTempCompHighStopVoltage, vpwrBayIndex=vpwrBayIndex, sysAlarmToRelayMapping=sysAlarmToRelayMapping, vpwrRingerParameterTable=vpwrRingerParameterTable, vpwrRectAlarmReserved=vpwrRectAlarmReserved, vpwrSystemConfigGroup=vpwrSystemConfigGroup, vpwrSystemInternalTempUThreshold=vpwrSystemInternalTempUThreshold, vpwrTrapRingerAAlarm=vpwrTrapRingerAAlarm, vpwrSystemControllerState=vpwrSystemControllerState, vpwrBayctrlOperHours=vpwrBayctrlOperHours, thermalProbeTable=thermalProbeTable, vpwrPanelModuleOperHours=vpwrPanelModuleOperHours, vpwrSystemInternalTemperature=vpwrSystemInternalTemperature, vpwrIdentAgentSoftwareVersion=vpwrIdentAgentSoftwareVersion, vpwrPanelModuleIdentEntry=vpwrPanelModuleIdentEntry, vpwrTrapMultipleRingerAlarm=vpwrTrapMultipleRingerAlarm, vpwrDcPowerLvd=vpwrDcPowerLvd, vpwrLvdContactorIndex=vpwrLvdContactorIndex, vpwrTrapBatteryTempAlarmSet=vpwrTrapBatteryTempAlarmSet, vpwrTrapConfigErrorAlarm=vpwrTrapConfigErrorAlarm, sysRelayCustomName=sysRelayCustomName, vpwrTrapIShareAlarm=vpwrTrapIShareAlarm, vpwrSystemVoltage=vpwrSystemVoltage, vpwrTrapSystemRedundancyAlarm=vpwrTrapSystemRedundancyAlarm, vpwrRingerAlarmBOverCurrent=vpwrRingerAlarmBOverCurrent, vpwrTrapPowerMajorAlarm=vpwrTrapPowerMajorAlarm, vpwrRectifierConfigGroup=vpwrRectifierConfigGroup, sysAuxAlarmCustomName=sysAuxAlarmCustomName, vpwrBoostAdminState=vpwrBoostAdminState, sysAlarmCustomName=sysAlarmCustomName, vpwrPanelIdentTable=vpwrPanelIdentTable, sysAuxAlarmIndex=sysAuxAlarmIndex, vpwrTrapSwDownloadNoReboot=vpwrTrapSwDownloadNoReboot, vpwrDcPowerBatteryGroup=vpwrDcPowerBatteryGroup, vpwrTrapSystemOK=vpwrTrapSystemOK, vpwrRingerParameterDcVoltage=vpwrRingerParameterDcVoltage, batteryTempCompSenseSource=batteryTempCompSenseSource, vpwrBDTAbortVoltage=vpwrBDTAbortVoltage, vpwrTrapModuleCommAlarm=vpwrTrapModuleCommAlarm, vpwrBayctrlTestDate=vpwrBayctrlTestDate, vpwrBayctrlOperStatus=vpwrBayctrlOperStatus, vpwrTrapAdminPwdChange=vpwrTrapAdminPwdChange, vpwrSystemTempCompensation=vpwrSystemTempCompensation, vpwrLvdAlarmGroup=vpwrLvdAlarmGroup, PositiveInteger=PositiveInteger, batteryTempCompRunawayTemperature=batteryTempCompRunawayTemperature, vpwrTrapIpIndex=vpwrTrapIpIndex, vpwrPanelModuleSerialNumber=vpwrPanelModuleSerialNumber, vpwrDcPowerDcDcConverter=vpwrDcPowerDcDcConverter, vpwrPanelModuleOID=vpwrPanelModuleOID, vpwrIoModuleTestGroup=vpwrIoModuleTestGroup, vpwrTrapCfgChange=vpwrTrapCfgChange, vpwrPanelModuleCapacity=vpwrPanelModuleCapacity, vpwrDcPowerAlarmGroup=vpwrDcPowerAlarmGroup, sysAuxAlarmSeverity=sysAuxAlarmSeverity, vpwrRectAlarmACFail=vpwrRectAlarmACFail, vpwrPanelModuleModelNumber=vpwrPanelModuleModelNumber, vpwrLvdReconnectSetpoint=vpwrLvdReconnectSetpoint, vpwrDcPowerDcAcInverter=vpwrDcPowerDcAcInverter, vpwrPanelModuleOperStatus=vpwrPanelModuleOperStatus, batteryTempCompensation=batteryTempCompensation, vpwrLvdAlarmCBOpen=vpwrLvdAlarmCBOpen, vpwrRectAlarmFanFail=vpwrRectAlarmFanFail, vpwrRectifierTestGroup=vpwrRectifierTestGroup, vpwrSystemIdentEntry=vpwrSystemIdentEntry, vpwrSystemHVAlarmSetpoint=vpwrSystemHVAlarmSetpoint, vpwrTrapTable=vpwrTrapTable, vpwrTrapThermalCompActive=vpwrTrapThermalCompActive, sysRelayIndex=sysRelayIndex, vpwrModuleModelNumber=vpwrModuleModelNumber, vpwrTrapIllegalConfigSubmit=vpwrTrapIllegalConfigSubmit, vpwrLvdContactorConfigTable=vpwrLvdContactorConfigTable, vpwrLvdAlarmWarning=vpwrLvdAlarmWarning, vpwrRectAlarmAmbTemp=vpwrRectAlarmAmbTemp, vpwrBatteryTempTable=vpwrBatteryTempTable, vpwrModuleSerialNumber=vpwrModuleSerialNumber, vpwrReadCommunityString=vpwrReadCommunityString, vpwrRectifierHVSDSetpoint=vpwrRectifierHVSDSetpoint, vpwrModuleFwVersion=vpwrModuleFwVersion, vpwrTrapSingleRingerAlarm=vpwrTrapSingleRingerAlarm, vpwrTrapRingerCommAlarm=vpwrTrapRingerCommAlarm, vpwrBattetyCurrentLimitValue=vpwrBattetyCurrentLimitValue, vpwrIoModuleAlarmGroup=vpwrIoModuleAlarmGroup, vpwrAlarmEntry=vpwrAlarmEntry, vpwrBayctrlModuleIdentTable=vpwrBayctrlModuleIdentTable, vpwrBayctrlOID=vpwrBayctrlOID, vpwrSystemTempCompensationState=vpwrSystemTempCompensationState, batteryTempCompHighStartTemperature=batteryTempCompHighStartTemperature, vpwrRingerAlarmAOCurrent=vpwrRingerAlarmAOCurrent, vpwrTrapDistAlarm=vpwrTrapDistAlarm, vpwrRectifierAlarmGroup=vpwrRectifierAlarmGroup, vpwrRingerConfigGroup=vpwrRingerConfigGroup, vpwrTrapSystemOverTemperatureAlarm=vpwrTrapSystemOverTemperatureAlarm, vpwrBatteryDischargeTestGroup=vpwrBatteryDischargeTestGroup, vpwrDcPowerSystem=vpwrDcPowerSystem, vpwrRectAlarmShortPinShutdown=vpwrRectAlarmShortPinShutdown, vpwrTrapLogout=vpwrTrapLogout, vpwrRectifierCurrentLimit=vpwrRectifierCurrentLimit, vpwrBayctrlIndex=vpwrBayctrlIndex, vpwrDcPowerTrio=vpwrDcPowerTrio, vpwrSystemPanelIdentGroup=vpwrSystemPanelIdentGroup, thermalProbeState=thermalProbeState, vpwrTrapDistributionCommAlarm=vpwrTrapDistributionCommAlarm, sysAuxAlarmConfigTable=sysAuxAlarmConfigTable, vpwrRingerAlarmAOTemp=vpwrRingerAlarmAOTemp, vpwrSystemBDAlarmSetpoint=vpwrSystemBDAlarmSetpoint, vpwrDcPowerRectifier=vpwrDcPowerRectifier, vpwrDcPowerTest=vpwrDcPowerTest, vpwrBattetyCurrentValue=vpwrBattetyCurrentValue, vpwrBayctrlCapacity=vpwrBayctrlCapacity, vpwrDcDcConverterAlarmGroup=vpwrDcDcConverterAlarmGroup, batteryTempCompHighSlope=batteryTempCompHighSlope, vpwrTrapsMsgString=vpwrTrapsMsgString, vpwrRectAlarmIntTemp=vpwrRectAlarmIntTemp, vpwrRectAlarmRemoteShutdown=vpwrRectAlarmRemoteShutdown, vpwrRingerParameterAdminState=vpwrRingerParameterAdminState, vpwrLvdReconnectDelayTimer=vpwrLvdReconnectDelayTimer, vpwrBatteryTempGroup=vpwrBatteryTempGroup, vpwrAlarmIndex=vpwrAlarmIndex, vpwrDcPowerProducts=vpwrDcPowerProducts, vpwrDcAcInverterConfigGroup=vpwrDcAcInverterConfigGroup, vpwrSystemTempCompensationSlope=vpwrSystemTempCompensationSlope, vpwrTrapLoginSuccess=vpwrTrapLoginSuccess, vpwrDcPowerDist=vpwrDcPowerDist, vpwrTrapModuleAlarm=vpwrTrapModuleAlarm, vpwrRingerIndex=vpwrRingerIndex, vpwrBatteryCurrentLimitAdminState=vpwrBatteryCurrentLimitAdminState, vpwrTrapLVDOpenAlarm=vpwrTrapLVDOpenAlarm, vpwrRingerParameterFrequency=vpwrRingerParameterFrequency, vpwrTrapThermalProbeAlarm=vpwrTrapThermalProbeAlarm, thermalProbeEntry=thermalProbeEntry, vpwrTrapIpAddress=vpwrTrapIpAddress, vpwrBatteryCurrentGroup=vpwrBatteryCurrentGroup, vpwrTrapLvdFuseOpen=vpwrTrapLvdFuseOpen, vpwrTrapHVAlarm=vpwrTrapHVAlarm, vpwrRectAlarmDCEnable=vpwrRectAlarmDCEnable, vpwrTrapUserIpAddress=vpwrTrapUserIpAddress, sysAlarmRedundancyState=sysAlarmRedundancyState, NonNegativeInteger=NonNegativeInteger, vpwrTrapCriticality=vpwrTrapCriticality)
mibBuilder.exportSymbols("VALERE-DC-POWER-MIB", vpwrModuleTestDate=vpwrModuleTestDate, vpwrModuleOperHours=vpwrModuleOperHours, vpwrSystemThermalSenseType=vpwrSystemThermalSenseType, vpwrTrapInternalTempAlarmCleared=vpwrTrapInternalTempAlarmCleared, sysRelayDefaultName=sysRelayDefaultName, vpwrSystemIdentGroup=vpwrSystemIdentGroup, vpwrModuleOID=vpwrModuleOID, vpwrIdentControllerVersion=vpwrIdentControllerVersion, vpwrSystemIdentTable=vpwrSystemIdentTable, sysAlarmIndex=sysAlarmIndex, vpwrRingerNumberPresent=vpwrRingerNumberPresent, vpwrTrapLoginFail=vpwrTrapLoginFail, vpwrBDTAlarmVoltage=vpwrBDTAlarmVoltage, vpwrRingerParameterAcVoltage=vpwrRingerParameterAcVoltage, sysAlarmOperStatus=sysAlarmOperStatus, vpwrRingerAlarmaBFailed=vpwrRingerAlarmaBFailed, vpwrTrapClearEventHistory=vpwrTrapClearEventHistory, vpwrBDTOperState=vpwrBDTOperState, batteryTempCompLowStopVoltage=batteryTempCompLowStopVoltage, vpwrRingerAlarmGroup=vpwrRingerAlarmGroup, sysAuxAlarmOperStatus=sysAuxAlarmOperStatus, vpwrRingerAlarmBOverTemp=vpwrRingerAlarmBOverTemp, vpwrTrapEventTimeStamp=vpwrTrapEventTimeStamp, vpwrRectAlarmBoostFail=vpwrRectAlarmBoostFail, vpwrPanelBayIndex=vpwrPanelBayIndex, vpwrBayctrlCurrent=vpwrBayctrlCurrent, vpwrRectAlarmDCFail=vpwrRectAlarmDCFail, vpwrSystemParameterGroup=vpwrSystemParameterGroup, batteryTempCompLowStartTemperature=batteryTempCompLowStartTemperature, vpwrBDTClearAlarm=vpwrBDTClearAlarm, vpwrPanelModuleIndex=vpwrPanelModuleIndex, vpwrSystemBayctrlIdentGroup=vpwrSystemBayctrlIdentGroup, vpwrLvdContactorReconnectDelayTimer=vpwrLvdContactorReconnectDelayTimer, vpwrAlarmTable=vpwrAlarmTable, batteryTempCompLowSlope=batteryTempCompLowSlope, vpwrModuleOperStatus=vpwrModuleOperStatus, vpwrDcAcInverterAlarmGroup=vpwrDcAcInverterAlarmGroup, vpwrBatteryTempName=vpwrBatteryTempName, vpwrTrapBatteryTempAlarmCleared=vpwrTrapBatteryTempAlarmCleared, vpwrTrapThermalRunaway=vpwrTrapThermalRunaway, vpwrBatteryBoostGroup=vpwrBatteryBoostGroup, vpwrRectAlarmHVSD=vpwrRectAlarmHVSD)
