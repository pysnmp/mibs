...
ObjectIdentity, IpAddress, Gauge32, NotificationType, enterprises, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, iso, TimeTicks, ModuleIdentity, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Gauge32", "NotificationType", "enterprises", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "iso", "TimeTicks", "ModuleIdentity", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("VALERE-DC-POWER-MIB", vpwrSystemIdentGroup=vpwrSystemIdentGroup, vpwrTrapBatteryTempAlarmCleared=vpwrTrapBatteryTempAlarmCleared, vpwrTrapSystemAlive=vpwrTrapSystemAlive, thermalProbeEntry=thermalProbeEntry, vpwrLvdContactorWarningSetpoint=vpwrLvdContactorWarningSetpoint, vpwrTrapHVSDAlarm=vpwrTrapHVSDAlarm, vpwrTrapPowerMajorAlarm=vpwrTrapPowerMajorAlarm, batteryTempCompRunawayStopVoltage=batteryTempCompRunawayStopVoltage, vpwrTrapBDAlarm=vpwrTrapBDAlarm, vpwrDcPowerProducts=vpwrDcPowerProducts, sysRelayCustomName=sysRelayCustomName, vpwrBattetyCurrentLimitValue=vpwrBattetyCurrentLimitValue, vpwrSystemTempCompensationSlope=vpwrSystemTempCompensationSlope, vpwrTrapUnmappedAddressAlarm=vpwrTrapUnmappedAddressAlarm, vpwrModuleIndex=vpwrModuleIndex, vpwrBayctrlModuleIdentEntry=vpwrBayctrlModuleIdentEntry, vpwrModuleOperHours=vpwrModuleOperHours, vpwrDcDcConverterTestGroup=vpwrDcDcConverterTestGroup, vpwrBayctrlTestDate=vpwrBayctrlTestDate, vpwrTrapThermalRunaway=vpwrTrapThermalRunaway, vpwrBatteryTempTable=vpwrBatteryTempTable, vpwrTrapEntry=vpwrTrapEntry, vpwrRingerParameterDcVoltage=vpwrRingerParameterDcVoltage, vpwrDcDcConverterConfigGroup=vpwrDcDcConverterConfigGroup, vpwrTrapLVDWarningAlarm=vpwrTrapLVDWarningAlarm, sysAlarmRedundancyState=sysAlarmRedundancyState, vpwrBayctrlIdentTable=vpwrBayctrlIdentTable, NonNegativeInteger=NonNegativeInteger, sysAlarmConfigTable=sysAlarmConfigTable, vpwrModuleIdentEntry=vpwrModuleIdentEntry, vpwrDcPowerSystem=vpwrDcPowerSystem, vpwrSystemShelfCapacity=vpwrSystemShelfCapacity, vpwrBatteryDischargeTestGroup=vpwrBatteryDischargeTestGroup, vpwrPanelModuleIdentEntry=vpwrPanelModuleIdentEntry, vpwrSystemInternalTempLThreshold=vpwrSystemInternalTempLThreshold, vpwrPanelModuleCapacity=vpwrPanelModuleCapacity, sysRelayAlarmSeverity=sysRelayAlarmSeverity, vpwrTrapIShareAlarm=vpwrTrapIShareAlarm, vpwrBatteryTempEntry=vpwrBatteryTempEntry, vpwrTrapBatteryTempAlarmSet=vpwrTrapBatteryTempAlarmSet, vpwrSystemTempCompensationState=vpwrSystemTempCompensationState, vpwrTrapInternalTempAlarmSet=vpwrTrapInternalTempAlarmSet, vpwrTrapModuleAlarm=vpwrTrapModuleAlarm, vpwrSystemType=vpwrSystemType, vpwrTrapClearEventHistory=vpwrTrapClearEventHistory, vpwrRingerParameterAcVoltage=vpwrRingerParameterAcVoltage, vpwrRectAlarmReserved=vpwrRectAlarmReserved, vpwrLvdContactorConfigTable=vpwrLvdContactorConfigTable, batteryTempCompRunawayTemperature=batteryTempCompRunawayTemperature, vpwrTrapLVDOpenAlarm=vpwrTrapLVDOpenAlarm, vpwrTrapOIDChange=vpwrTrapOIDChange, vpwrPanelModuleFwVersion=vpwrPanelModuleFwVersion, vpwrBayctrlIndex=vpwrBayctrlIndex, vpwrTrapMultipleModuleFailAlarm=vpwrTrapMultipleModuleFailAlarm, vpwrBoostAdminState=vpwrBoostAdminState, vpwrTrapDistAlarm=vpwrTrapDistAlarm, sysAlarmCustomName=sysAlarmCustomName, sysAuxAlarmConfigEntry=sysAuxAlarmConfigEntry, vpwrBoostOperState=vpwrBoostOperState, vpwrBDTClearAlarm=vpwrBDTClearAlarm, vpwrModuleModelNumber=vpwrModuleModelNumber, vpwrRingerIndex=vpwrRingerIndex, vpwrLvdContactorState=vpwrLvdContactorState, PYSNMP_MODULE_ID=vpwrDcPowerMgt, vpwrBayctrlModuleIdentTable=vpwrBayctrlModuleIdentTable, vpwrPanelModuleOID=vpwrPanelModuleOID, vpwrBayctrlCurrent=vpwrBayctrlCurrent, vpwrRectAlarmDCFail=vpwrRectAlarmDCFail, vpwrRingerAlarmAOCurrent=vpwrRingerAlarmAOCurrent, vpwrLvdContactorConfigEntry=vpwrLvdContactorConfigEntry, vpwrSystemTempCompStopVoltage=vpwrSystemTempCompStopVoltage, vpwrModuleSerialNumber=vpwrModuleSerialNumber, sysAlarmIndex=sysAlarmIndex, vpwrPanelModuleTestDate=vpwrPanelModuleTestDate, vpwrRectAlarmIShare=vpwrRectAlarmIShare, vpwrLvdContactorDisconnectSetpoint=vpwrLvdContactorDisconnectSetpoint, vpwrTrapLoginSuccess=vpwrTrapLoginSuccess, sysAlarmToRelayMapping=sysAlarmToRelayMapping, vpwrTrapConverterInputFailAlarm=vpwrTrapConverterInputFailAlarm, vpwrSystemControllerState=vpwrSystemControllerState, vpwrRectifierCurrentLimitAdminState=vpwrRectifierCurrentLimitAdminState, vpwrBayctrlOID=vpwrBayctrlOID, vpwrRingerAlarmBOverTemp=vpwrRingerAlarmBOverTemp, vpwrIdentControllerVersion=vpwrIdentControllerVersion, sysAlarmSeverity=sysAlarmSeverity, vpwrBatteryBoostGroup=vpwrBatteryBoostGroup, sysAlarmDefaultName=sysAlarmDefaultName, vpwrRectAlarmAmbTemp=vpwrRectAlarmAmbTemp, vpwrRectifierCurrentLimit=vpwrRectifierCurrentLimit, vpwrReadCommunityString=vpwrReadCommunityString, vpwrSystemTempCompensation=vpwrSystemTempCompensation, vpwrLvdContactorReconnectSetpoint=vpwrLvdContactorReconnectSetpoint, vpwrTrapThermalProbeAlarm=vpwrTrapThermalProbeAlarm, vpwrSystemThermalSenseType=vpwrSystemThermalSenseType, vpwrTrapSystemOK=vpwrTrapSystemOK, vpwrIoModuleTestGroup=vpwrIoModuleTestGroup, vpwrBatteryTempIndex=vpwrBatteryTempIndex, vpwrTrapInternalTempAlarmCleared=vpwrTrapInternalTempAlarmCleared, vpwrDcPowerTraps=vpwrDcPowerTraps, sysAuxAlarmSeverity=sysAuxAlarmSeverity, vpwrIdentAgentSoftwareVersion=vpwrIdentAgentSoftwareVersion, vpwrTrapIpIndex=vpwrTrapIpIndex, vpwrRectAlarmFanFail=vpwrRectAlarmFanFail, vpwrAlarmTime=vpwrAlarmTime, batteryTempCompHighStopVoltage=batteryTempCompHighStopVoltage, vpwrBatteryTemp=vpwrBatteryTemp, vpwrAlarmDescr=vpwrAlarmDescr, batteryTempCompLowStopVoltage=batteryTempCompLowStopVoltage, vpwrLvdTestGroup=vpwrLvdTestGroup, vpwrRingerConfigGroup=vpwrRingerConfigGroup, vpwrPanelModuleSerialNumber=vpwrPanelModuleSerialNumber, vpwrAlarmIndex=vpwrAlarmIndex, vpwrModuleCurrent=vpwrModuleCurrent, vpwrBatteryTempLThreshold=vpwrBatteryTempLThreshold, vpwrTrapHVAlarm=vpwrTrapHVAlarm, vpwrTrapAuxAlarm=vpwrTrapAuxAlarm, vpwrRectAlarmBoostFail=vpwrRectAlarmBoostFail, sysAlarmConfigEntry=sysAlarmConfigEntry, PositiveInteger=PositiveInteger, vpwrBayctrlCapacity=vpwrBayctrlCapacity, batteryTempCompensation=batteryTempCompensation, vpwrRingerAlarmGroup=vpwrRingerAlarmGroup, vpwrTrapModuleFailAlarm=vpwrTrapModuleFailAlarm, vpwrTrapMultipleRingerAlarm=vpwrTrapMultipleRingerAlarm, vpwrDcPowerDcAcInverter=vpwrDcPowerDcAcInverter, vpwrWriteCommunityString=vpwrWriteCommunityString, vpwrTrapLvdFuseOpen=vpwrTrapLvdFuseOpen, vpwrIdentManufacturer=vpwrIdentManufacturer, vpwrLvdWarningSetpoint=vpwrLvdWarningSetpoint, vpwrRingerAlarmBOverCurrent=vpwrRingerAlarmBOverCurrent, vpwrDcPowerIoModule=vpwrDcPowerIoModule, vpwrRectifierFVSetpoint=vpwrRectifierFVSetpoint, vpwrPanelModuleIdentTable=vpwrPanelModuleIdentTable, vpwrDcAcInverterConfigGroup=vpwrDcAcInverterConfigGroup, vpwrTrapLogout=vpwrTrapLogout, vpwrTrapLoginFail=vpwrTrapLoginFail, vpwrDcPowerDist=vpwrDcPowerDist, vpwrTrapSwDownloadAndReboot=vpwrTrapSwDownloadAndReboot, vpwrModuleIdentTable=vpwrModuleIdentTable, vpwrPanelModuleOperHours=vpwrPanelModuleOperHours, vpwrBattetyCurrentValue=vpwrBattetyCurrentValue, batteryTempCompHighStartTemperature=batteryTempCompHighStartTemperature, vpwrRingerAlarmAOTemp=vpwrRingerAlarmAOTemp, vpwrSystemBayctrlIdentGroup=vpwrSystemBayctrlIdentGroup, vpwrLvdDisconnectSetpoint=vpwrLvdDisconnectSetpoint, vpwrBayctrlOperStatus=vpwrBayctrlOperStatus, vpwrIdentModel=vpwrIdentModel, vpwrSystemIdentEntry=vpwrSystemIdentEntry, sysRelayIndex=sysRelayIndex, vpwrBayIndex=vpwrBayIndex, vpwrAlarmEntry=vpwrAlarmEntry, vpwrTrapRingerBAlarm=vpwrTrapRingerBAlarm, thermalProbeTable=thermalProbeTable, vpwrBDTAlarmCoefficient=vpwrBDTAlarmCoefficient, vpwrSystemBDAlarmSetpoint=vpwrSystemBDAlarmSetpoint, vpwrPanelModuleIndex=vpwrPanelModuleIndex, vpwrBDTOperState=vpwrBDTOperState, vpwrRectAlarmLowVoltage=vpwrRectAlarmLowVoltage, vpwrRingerAlarmaAFailed=vpwrRingerAlarmaAFailed, vpwrDcPowerTrio=vpwrDcPowerTrio, vpwrSystemInternalTempUThreshold=vpwrSystemInternalTempUThreshold, batteryTempCompRunawayState=batteryTempCompRunawayState, sysAlarmComFailState=sysAlarmComFailState, vpwrTrapDistributionCommAlarm=vpwrTrapDistributionCommAlarm, vpwrRectAlarmHVSD=vpwrRectAlarmHVSD, sysRelayConfigTable=sysRelayConfigTable, vpwrLvdContactorReconnectDelayTimer=vpwrLvdContactorReconnectDelayTimer, vpwrRingerParameterTable=vpwrRingerParameterTable, vpwrDcPowerAlarmGroup=vpwrDcPowerAlarmGroup, vpwrSystemParameterGroup=vpwrSystemParameterGroup, vpwrRectAlarmShortPinShutdown=vpwrRectAlarmShortPinShutdown, sysAuxAlarmOperStatus=sysAuxAlarmOperStatus, vpwrTrapBatteryRechgIlimitFailAlarm=vpwrTrapBatteryRechgIlimitFailAlarm, vpwrPanelBayIndex=vpwrPanelBayIndex, vpwrTrapModuleRemoved=vpwrTrapModuleRemoved, vpwrRectAlarmUV=vpwrRectAlarmUV, vpwrLvdConfigGroup=vpwrLvdConfigGroup, sysAuxAlarmToRelayMapping=sysAuxAlarmToRelayMapping, vpwrRectAlarmRemoteShutdown=vpwrRectAlarmRemoteShutdown, vpwrRingerTestGroup=vpwrRingerTestGroup, vpwrModuleCapacity=vpwrModuleCapacity, vpwrBoostDuration=vpwrBoostDuration, vpwrBayctrlModelNumber=vpwrBayctrlModelNumber, vpwrDcPowerLvd=vpwrDcPowerLvd, vpwrBDTAdminState=vpwrBDTAdminState, vpwrBatteryTempUThreshold=vpwrBatteryTempUThreshold, vpwrTrapSystemOverTemperatureAlarm=vpwrTrapSystemOverTemperatureAlarm, vpwrRectifierHVSDSetpoint=vpwrRectifierHVSDSetpoint, vpwrPanelIdentTable=vpwrPanelIdentTable, vpwrRectifierConfigGroup=vpwrRectifierConfigGroup, vpwrTrapSystemClockChange=vpwrTrapSystemClockChange, vpwrTrapACFAlarm=vpwrTrapACFAlarm, vpwrBayctrlSerialNumber=vpwrBayctrlSerialNumber, vpwrTrapMultipleConvFailAlarm=vpwrTrapMultipleConvFailAlarm, vpwrRectAlarmDCEnable=vpwrRectAlarmDCEnable, vpwrTrapDisplayFirmwareMismatchAlarm=vpwrTrapDisplayFirmwareMismatchAlarm, vpwrTrapsMsgString=vpwrTrapsMsgString, batteryTempCompHighSlope=batteryTempCompHighSlope, vpwrBatteryTempGroup=vpwrBatteryTempGroup, vpwrLvdReconnectDelayTimer=vpwrLvdReconnectDelayTimer, sysAuxAlarmDefaultName=sysAuxAlarmDefaultName, sysAlarmIShareState=sysAlarmIShareState, vpwrSystemVoltage=vpwrSystemVoltage, vpwrTrapRingerAAlarm=vpwrTrapRingerAAlarm, vpwrLvdContactorIndex=vpwrLvdContactorIndex, vpwrLvdAlarmCBOpen=vpwrLvdAlarmCBOpen, vpwrModuleOID=vpwrModuleOID, vpwrTrapUserIpAddress=vpwrTrapUserIpAddress, vpwrRectifierAlarmGroup=vpwrRectifierAlarmGroup, vpwrPanelModuleCurrent=vpwrPanelModuleCurrent, vpwrTrapEventTimeStamp=vpwrTrapEventTimeStamp, vpwrTrapTable=vpwrTrapTable, sysAuxAlarmPolarity=sysAuxAlarmPolarity, batteryTempCompLowSlope=batteryTempCompLowSlope, vpwrTrapIpAddress=vpwrTrapIpAddress, vpwrBatteryCurrentLimitAdminState=vpwrBatteryCurrentLimitAdminState, vpwrBDTAlarmVoltage=vpwrBDTAlarmVoltage, vpwrModuleTestDate=vpwrModuleTestDate, vpwrRingerNumberPresent=vpwrRingerNumberPresent, vpwrDcPowerModuleIdent=vpwrDcPowerModuleIdent, vpwrLvdAlarmContactorOpen=vpwrLvdAlarmContactorOpen, vpwrTrapSwDownloadNoReboot=vpwrTrapSwDownloadNoReboot, vpwrBDTAbortVoltage=vpwrBDTAbortVoltage, vpwrSystemTempCompStartTemperature=vpwrSystemTempCompStartTemperature, vpwrDcPowerRinger=vpwrDcPowerRinger, vpwrDcAcInverterTestGroup=vpwrDcAcInverterTestGroup, vpwrLvdReconnectSetpoint=vpwrLvdReconnectSetpoint, vpwrDcDcConverterAlarmGroup=vpwrDcDcConverterAlarmGroup, vpwrTrapBatteryDischargeTestAlarm=vpwrTrapBatteryDischargeTestAlarm, sysAlarmOperStatus=sysAlarmOperStatus, vpwrBatteryTempName=vpwrBatteryTempName, sysRelayConfigEntry=sysRelayConfigEntry, vpwrBDTDuration=vpwrBDTDuration, vpwrAlarmsPresent=vpwrAlarmsPresent, vpwrTrapAdminPwdChange=vpwrTrapAdminPwdChange, vpwrTrapCfgChange=vpwrTrapCfgChange, vpwrBoostVoltage=vpwrBoostVoltage, vpwrIoModuleAlarmGroup=vpwrIoModuleAlarmGroup, vpwrBayctrlOperHours=vpwrBayctrlOperHours, vpwrDcPowerSnmpConfig=vpwrDcPowerSnmpConfig, vpwrRingerAlarmaBFailed=vpwrRingerAlarmaBFailed, thermalProbeState=thermalProbeState, vpwrBayctrlIdentEntry=vpwrBayctrlIdentEntry, vpwrRingerParameterEntry=vpwrRingerParameterEntry, batteryTempCompSenseSource=batteryTempCompSenseSource, sysAuxAlarmIndex=sysAuxAlarmIndex, vpwrSystemPanelIdentGroup=vpwrSystemPanelIdentGroup, vpwrDcPowerMgt=vpwrDcPowerMgt, vpwrModuleFwVersion=vpwrModuleFwVersion, vpwrDcPowerBayController=vpwrDcPowerBayController, vpwrDcAcInverterAlarmGroup=vpwrDcAcInverterAlarmGroup, vpwrSystemConfigGroup=vpwrSystemConfigGroup, vpwrRingerParameterFrequency=vpwrRingerParameterFrequency, vpwrPanelIdentEntry=vpwrPanelIdentEntry)
mibBuilder.exportSymbols("VALERE-DC-POWER-MIB", vpwrTrapSystemRedundancyAlarm=vpwrTrapSystemRedundancyAlarm, vpwrAlarmTable=vpwrAlarmTable, batteryTempCompLowStartTemperature=batteryTempCompLowStartTemperature, vpwrPanelModuleOperStatus=vpwrPanelModuleOperStatus, vpwrTrapThermalCompInactive=vpwrTrapThermalCompInactive, vpwrTrapModuleCommAlarm=vpwrTrapModuleCommAlarm, vpwrRectAlarmIntTemp=vpwrRectAlarmIntTemp, vpwrSystemInternalTemperature=vpwrSystemInternalTemperature, vpwrSystemCurrent=vpwrSystemCurrent, vpwrTrapThermalCompActive=vpwrTrapThermalCompActive, vpwrBayctrlFwVersion=vpwrBayctrlFwVersion, vpwrTrapCommunityString=vpwrTrapCommunityString, sysRelayDefaultName=sysRelayDefaultName, vpwrIoModuleConfigGroup=vpwrIoModuleConfigGroup, vpwrTrapConfigErrorAlarm=vpwrTrapConfigErrorAlarm, vpwrModuleOperStatus=vpwrModuleOperStatus, vpwrRectifierTestGroup=vpwrRectifierTestGroup, vpwrRectAlarmBoostComm=vpwrRectAlarmBoostComm, vpwrLvdAlarmGroup=vpwrLvdAlarmGroup, vpwrRectAlarmModDisableShutdown=vpwrRectAlarmModDisableShutdown, vpwrRectAlarmACFail=vpwrRectAlarmACFail, vpwrRingerParameterAdminState=vpwrRingerParameterAdminState, vpwrDcPowerTrapsMsgString=vpwrDcPowerTrapsMsgString, vpwrBatteryCurrentGroup=vpwrBatteryCurrentGroup, vpwrDcPowerDcDcConverter=vpwrDcPowerDcDcConverter, vpwrTrapRingerCommAlarm=vpwrTrapRingerCommAlarm, vpwrTrapConverterAlarm=vpwrTrapConverterAlarm, vpwrTrapSingleRingerAlarm=vpwrTrapSingleRingerAlarm, vpwrDcPowerRectifier=vpwrDcPowerRectifier, vpwrSystemHVAlarmSetpoint=vpwrSystemHVAlarmSetpoint, vpwrLvdAlarmWarning=vpwrLvdAlarmWarning, vpwrPanelModuleModelNumber=vpwrPanelModuleModelNumber, vpwrDcPowerBatteryGroup=vpwrDcPowerBatteryGroup, vpwrTrapIllegalConfigSubmit=vpwrTrapIllegalConfigSubmit, sysAuxAlarmCustomName=sysAuxAlarmCustomName, vpwrIdentName=vpwrIdentName, vpwrTrapModuleInserted=vpwrTrapModuleInserted, vpwrSystemIdentTable=vpwrSystemIdentTable, sysAuxAlarmConfigTable=sysAuxAlarmConfigTable, vpwrDcPowerTest=vpwrDcPowerTest, vpwrTrapCriticality=vpwrTrapCriticality, vpwrTrapPowerMinorAlarm=vpwrTrapPowerMinorAlarm)
