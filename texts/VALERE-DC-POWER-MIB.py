...
Counter32, Integer32, NotificationType, Bits, Gauge32, iso, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, MibIdentifier, enterprises, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "NotificationType", "Bits", "Gauge32", "iso", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "MibIdentifier", "enterprises", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("VALERE-DC-POWER-MIB", vpwrRingerParameterDcVoltage=vpwrRingerParameterDcVoltage, vpwrDcPowerSystem=vpwrDcPowerSystem, vpwrDcPowerBayController=vpwrDcPowerBayController, vpwrAlarmDescr=vpwrAlarmDescr, vpwrRectAlarmDCFail=vpwrRectAlarmDCFail, vpwrTrapBDAlarm=vpwrTrapBDAlarm, vpwrPanelBayIndex=vpwrPanelBayIndex, vpwrDcPowerTraps=vpwrDcPowerTraps, vpwrModuleOperStatus=vpwrModuleOperStatus, batteryTempCompHighSlope=batteryTempCompHighSlope, vpwrTrapRingerAAlarm=vpwrTrapRingerAAlarm, vpwrBayctrlFwVersion=vpwrBayctrlFwVersion, thermalProbeEntry=thermalProbeEntry, vpwrAlarmsPresent=vpwrAlarmsPresent, vpwrTrapModuleFailAlarm=vpwrTrapModuleFailAlarm, vpwrBDTOperState=vpwrBDTOperState, vpwrDcPowerProducts=vpwrDcPowerProducts, vpwrTrapOIDChange=vpwrTrapOIDChange, vpwrBayctrlOperHours=vpwrBayctrlOperHours, vpwrTrapInternalTempAlarmSet=vpwrTrapInternalTempAlarmSet, vpwrSystemConfigGroup=vpwrSystemConfigGroup, vpwrSystemControllerState=vpwrSystemControllerState, batteryTempCompLowStopVoltage=batteryTempCompLowStopVoltage, PYSNMP_MODULE_ID=vpwrDcPowerMgt, vpwrTrapTable=vpwrTrapTable, vpwrTrapSingleRingerAlarm=vpwrTrapSingleRingerAlarm, vpwrTrapACFAlarm=vpwrTrapACFAlarm, vpwrTrapSystemOK=vpwrTrapSystemOK, vpwrTrapRingerCommAlarm=vpwrTrapRingerCommAlarm, vpwrBayctrlSerialNumber=vpwrBayctrlSerialNumber, vpwrModuleCurrent=vpwrModuleCurrent, vpwrIdentModel=vpwrIdentModel, vpwrBDTAlarmVoltage=vpwrBDTAlarmVoltage, vpwrRingerAlarmBOverTemp=vpwrRingerAlarmBOverTemp, vpwrBatteryTempEntry=vpwrBatteryTempEntry, vpwrBatteryDischargeTestGroup=vpwrBatteryDischargeTestGroup, vpwrTrapAuxAlarm=vpwrTrapAuxAlarm, vpwrRingerNumberPresent=vpwrRingerNumberPresent, vpwrSystemInternalTempLThreshold=vpwrSystemInternalTempLThreshold, vpwrTrapRingerBAlarm=vpwrTrapRingerBAlarm, vpwrTrapConfigErrorAlarm=vpwrTrapConfigErrorAlarm, vpwrPanelModuleCurrent=vpwrPanelModuleCurrent, vpwrBatteryCurrentLimitAdminState=vpwrBatteryCurrentLimitAdminState, vpwrBayctrlModuleIdentEntry=vpwrBayctrlModuleIdentEntry, vpwrTrapLoginSuccess=vpwrTrapLoginSuccess, vpwrRectifierFVSetpoint=vpwrRectifierFVSetpoint, vpwrTrapThermalCompInactive=vpwrTrapThermalCompInactive, vpwrDcAcInverterTestGroup=vpwrDcAcInverterTestGroup, vpwrDcDcConverterConfigGroup=vpwrDcDcConverterConfigGroup, vpwrTrapClearEventHistory=vpwrTrapClearEventHistory, vpwrPanelModuleSerialNumber=vpwrPanelModuleSerialNumber, vpwrSystemVoltage=vpwrSystemVoltage, vpwrPanelIdentEntry=vpwrPanelIdentEntry, vpwrRingerParameterTable=vpwrRingerParameterTable, vpwrSystemHVAlarmSetpoint=vpwrSystemHVAlarmSetpoint, vpwrSystemCurrent=vpwrSystemCurrent, sysRelayIndex=sysRelayIndex, sysAlarmOperStatus=sysAlarmOperStatus, vpwrTrapCfgChange=vpwrTrapCfgChange, vpwrModuleModelNumber=vpwrModuleModelNumber, vpwrAlarmTable=vpwrAlarmTable, vpwrIoModuleConfigGroup=vpwrIoModuleConfigGroup, vpwrSystemParameterGroup=vpwrSystemParameterGroup, vpwrAlarmIndex=vpwrAlarmIndex, vpwrTrapIShareAlarm=vpwrTrapIShareAlarm, thermalProbeState=thermalProbeState, vpwrDcPowerMgt=vpwrDcPowerMgt, vpwrDcPowerSnmpConfig=vpwrDcPowerSnmpConfig, vpwrTrapThermalProbeAlarm=vpwrTrapThermalProbeAlarm, sysAlarmSeverity=sysAlarmSeverity, vpwrBayctrlCurrent=vpwrBayctrlCurrent, vpwrLvdContactorReconnectSetpoint=vpwrLvdContactorReconnectSetpoint, vpwrDcPowerModuleIdent=vpwrDcPowerModuleIdent, vpwrModuleIdentEntry=vpwrModuleIdentEntry, vpwrBayctrlModelNumber=vpwrBayctrlModelNumber, vpwrSystemTempCompStartTemperature=vpwrSystemTempCompStartTemperature, vpwrTrapEntry=vpwrTrapEntry, vpwrSystemThermalSenseType=vpwrSystemThermalSenseType, vpwrTrapEventTimeStamp=vpwrTrapEventTimeStamp, vpwrTrapUnmappedAddressAlarm=vpwrTrapUnmappedAddressAlarm, sysRelayConfigEntry=sysRelayConfigEntry, vpwrTrapsMsgString=vpwrTrapsMsgString, vpwrDcPowerIoModule=vpwrDcPowerIoModule, vpwrTrapAdminPwdChange=vpwrTrapAdminPwdChange, vpwrTrapModuleRemoved=vpwrTrapModuleRemoved, vpwrSystemInternalTemperature=vpwrSystemInternalTemperature, vpwrRingerParameterEntry=vpwrRingerParameterEntry, vpwrRingerParameterFrequency=vpwrRingerParameterFrequency, batteryTempCompRunawayTemperature=batteryTempCompRunawayTemperature, vpwrBDTAlarmCoefficient=vpwrBDTAlarmCoefficient, vpwrBoostVoltage=vpwrBoostVoltage, vpwrRingerTestGroup=vpwrRingerTestGroup, vpwrModuleSerialNumber=vpwrModuleSerialNumber, vpwrBayctrlModuleIdentTable=vpwrBayctrlModuleIdentTable, vpwrDcPowerRinger=vpwrDcPowerRinger, vpwrTrapConverterAlarm=vpwrTrapConverterAlarm, vpwrDcPowerBatteryGroup=vpwrDcPowerBatteryGroup, vpwrSystemTempCompensationSlope=vpwrSystemTempCompensationSlope, vpwrBayctrlIdentTable=vpwrBayctrlIdentTable, vpwrBatteryCurrentGroup=vpwrBatteryCurrentGroup, vpwrAlarmEntry=vpwrAlarmEntry, vpwrModuleFwVersion=vpwrModuleFwVersion, vpwrSystemShelfCapacity=vpwrSystemShelfCapacity, vpwrTrapIpAddress=vpwrTrapIpAddress, vpwrTrapUserIpAddress=vpwrTrapUserIpAddress, vpwrTrapDisplayFirmwareMismatchAlarm=vpwrTrapDisplayFirmwareMismatchAlarm, vpwrLvdReconnectSetpoint=vpwrLvdReconnectSetpoint, vpwrModuleOperHours=vpwrModuleOperHours, vpwrSystemBDAlarmSetpoint=vpwrSystemBDAlarmSetpoint, vpwrRectAlarmIntTemp=vpwrRectAlarmIntTemp, vpwrTrapSystemAlive=vpwrTrapSystemAlive, vpwrTrapMultipleRingerAlarm=vpwrTrapMultipleRingerAlarm, vpwrIdentAgentSoftwareVersion=vpwrIdentAgentSoftwareVersion, vpwrRectAlarmFanFail=vpwrRectAlarmFanFail, vpwrBayIndex=vpwrBayIndex, vpwrRectAlarmRemoteShutdown=vpwrRectAlarmRemoteShutdown, vpwrBattetyCurrentValue=vpwrBattetyCurrentValue, vpwrBatteryTempGroup=vpwrBatteryTempGroup, sysAuxAlarmCustomName=sysAuxAlarmCustomName, vpwrModuleCapacity=vpwrModuleCapacity, vpwrRectifierConfigGroup=vpwrRectifierConfigGroup, vpwrTrapBatteryRechgIlimitFailAlarm=vpwrTrapBatteryRechgIlimitFailAlarm, sysAuxAlarmConfigTable=sysAuxAlarmConfigTable, batteryTempCompHighStopVoltage=batteryTempCompHighStopVoltage, vpwrTrapIllegalConfigSubmit=vpwrTrapIllegalConfigSubmit, sysAlarmRedundancyState=sysAlarmRedundancyState, batteryTempCompRunawayStopVoltage=batteryTempCompRunawayStopVoltage, vpwrBatteryTempName=vpwrBatteryTempName, vpwrTrapThermalRunaway=vpwrTrapThermalRunaway, sysAuxAlarmDefaultName=sysAuxAlarmDefaultName, vpwrPanelModuleTestDate=vpwrPanelModuleTestDate, vpwrAlarmTime=vpwrAlarmTime, vpwrPanelModuleFwVersion=vpwrPanelModuleFwVersion, vpwrIdentName=vpwrIdentName, sysAuxAlarmSeverity=sysAuxAlarmSeverity, vpwrBayctrlIndex=vpwrBayctrlIndex, vpwrTrapHVSDAlarm=vpwrTrapHVSDAlarm, vpwrBayctrlTestDate=vpwrBayctrlTestDate, vpwrTrapInternalTempAlarmCleared=vpwrTrapInternalTempAlarmCleared, vpwrLvdContactorWarningSetpoint=vpwrLvdContactorWarningSetpoint, vpwrLvdReconnectDelayTimer=vpwrLvdReconnectDelayTimer, vpwrTrapConverterInputFailAlarm=vpwrTrapConverterInputFailAlarm, sysRelayConfigTable=sysRelayConfigTable, vpwrSystemIdentEntry=vpwrSystemIdentEntry, vpwrPanelModuleCapacity=vpwrPanelModuleCapacity, sysAuxAlarmIndex=sysAuxAlarmIndex, vpwrBoostOperState=vpwrBoostOperState, sysAlarmConfigTable=sysAlarmConfigTable, vpwrLvdContactorDisconnectSetpoint=vpwrLvdContactorDisconnectSetpoint, vpwrRectAlarmIShare=vpwrRectAlarmIShare, vpwrRingerParameterAcVoltage=vpwrRingerParameterAcVoltage, vpwrBoostDuration=vpwrBoostDuration, vpwrTrapBatteryDischargeTestAlarm=vpwrTrapBatteryDischargeTestAlarm, vpwrRectifierCurrentLimitAdminState=vpwrRectifierCurrentLimitAdminState, vpwrSystemPanelIdentGroup=vpwrSystemPanelIdentGroup, vpwrPanelModuleIdentEntry=vpwrPanelModuleIdentEntry, vpwrBayctrlCapacity=vpwrBayctrlCapacity, sysRelayAlarmSeverity=sysRelayAlarmSeverity, vpwrBDTDuration=vpwrBDTDuration, vpwrDcPowerDcAcInverter=vpwrDcPowerDcAcInverter, vpwrRectAlarmReserved=vpwrRectAlarmReserved, vpwrTrapMultipleConvFailAlarm=vpwrTrapMultipleConvFailAlarm, vpwrTrapSwDownloadNoReboot=vpwrTrapSwDownloadNoReboot, vpwrRectAlarmHVSD=vpwrRectAlarmHVSD, vpwrPanelIdentTable=vpwrPanelIdentTable, vpwrTrapLoginFail=vpwrTrapLoginFail, vpwrRectAlarmDCEnable=vpwrRectAlarmDCEnable, sysAuxAlarmToRelayMapping=sysAuxAlarmToRelayMapping, vpwrRectAlarmBoostFail=vpwrRectAlarmBoostFail, sysAlarmToRelayMapping=sysAlarmToRelayMapping, vpwrRingerAlarmBOverCurrent=vpwrRingerAlarmBOverCurrent, vpwrSystemIdentTable=vpwrSystemIdentTable, vpwrLvdContactorReconnectDelayTimer=vpwrLvdContactorReconnectDelayTimer, vpwrRingerAlarmAOTemp=vpwrRingerAlarmAOTemp, vpwrRectifierTestGroup=vpwrRectifierTestGroup, vpwrBoostAdminState=vpwrBoostAdminState, batteryTempCompSenseSource=batteryTempCompSenseSource, vpwrTrapThermalCompActive=vpwrTrapThermalCompActive, PositiveInteger=PositiveInteger, vpwrTrapIpIndex=vpwrTrapIpIndex, vpwrDcPowerDist=vpwrDcPowerDist, vpwrModuleTestDate=vpwrModuleTestDate, vpwrTrapDistAlarm=vpwrTrapDistAlarm, sysAlarmIShareState=sysAlarmIShareState, vpwrPanelModuleModelNumber=vpwrPanelModuleModelNumber, vpwrTrapSystemRedundancyAlarm=vpwrTrapSystemRedundancyAlarm, vpwrRectAlarmBoostComm=vpwrRectAlarmBoostComm, sysAuxAlarmConfigEntry=sysAuxAlarmConfigEntry, vpwrPanelModuleOperStatus=vpwrPanelModuleOperStatus, vpwrTrapDistributionCommAlarm=vpwrTrapDistributionCommAlarm, vpwrTrapLVDWarningAlarm=vpwrTrapLVDWarningAlarm, sysAlarmConfigEntry=sysAlarmConfigEntry, vpwrSystemInternalTempUThreshold=vpwrSystemInternalTempUThreshold, batteryTempCompLowStartTemperature=batteryTempCompLowStartTemperature, vpwrDcPowerRectifier=vpwrDcPowerRectifier, vpwrSystemTempCompStopVoltage=vpwrSystemTempCompStopVoltage, vpwrBattetyCurrentLimitValue=vpwrBattetyCurrentLimitValue, vpwrRectAlarmLowVoltage=vpwrRectAlarmLowVoltage, sysAuxAlarmPolarity=sysAuxAlarmPolarity, vpwrBDTClearAlarm=vpwrBDTClearAlarm, vpwrTrapLogout=vpwrTrapLogout, vpwrDcPowerTrio=vpwrDcPowerTrio, vpwrDcAcInverterAlarmGroup=vpwrDcAcInverterAlarmGroup, vpwrSystemTempCompensationState=vpwrSystemTempCompensationState, vpwrSystemType=vpwrSystemType, batteryTempCompRunawayState=batteryTempCompRunawayState, vpwrPanelModuleOperHours=vpwrPanelModuleOperHours, vpwrRingerParameterAdminState=vpwrRingerParameterAdminState, vpwrTrapModuleInserted=vpwrTrapModuleInserted, vpwrDcAcInverterConfigGroup=vpwrDcAcInverterConfigGroup, vpwrRingerAlarmAOCurrent=vpwrRingerAlarmAOCurrent, vpwrTrapLvdFuseOpen=vpwrTrapLvdFuseOpen, vpwrRectAlarmShortPinShutdown=vpwrRectAlarmShortPinShutdown, vpwrTrapModuleCommAlarm=vpwrTrapModuleCommAlarm, vpwrRectAlarmAmbTemp=vpwrRectAlarmAmbTemp, sysAuxAlarmOperStatus=sysAuxAlarmOperStatus, vpwrLvdTestGroup=vpwrLvdTestGroup, vpwrBayctrlOID=vpwrBayctrlOID, batteryTempCompLowSlope=batteryTempCompLowSlope, vpwrTrapHVAlarm=vpwrTrapHVAlarm, vpwrDcPowerLvd=vpwrDcPowerLvd, vpwrTrapCriticality=vpwrTrapCriticality, vpwrRingerAlarmGroup=vpwrRingerAlarmGroup, vpwrBatteryTempIndex=vpwrBatteryTempIndex, vpwrRingerIndex=vpwrRingerIndex, vpwrDcPowerAlarmGroup=vpwrDcPowerAlarmGroup, vpwrDcPowerDcDcConverter=vpwrDcPowerDcDcConverter, vpwrPanelModuleOID=vpwrPanelModuleOID, vpwrModuleIndex=vpwrModuleIndex, vpwrBatteryTemp=vpwrBatteryTemp, vpwrRingerConfigGroup=vpwrRingerConfigGroup, vpwrTrapBatteryTempAlarmCleared=vpwrTrapBatteryTempAlarmCleared, vpwrTrapModuleAlarm=vpwrTrapModuleAlarm, vpwrTrapMultipleModuleFailAlarm=vpwrTrapMultipleModuleFailAlarm, sysRelayCustomName=sysRelayCustomName, vpwrBatteryTempUThreshold=vpwrBatteryTempUThreshold, vpwrLvdContactorConfigTable=vpwrLvdContactorConfigTable, vpwrTrapBatteryTempAlarmSet=vpwrTrapBatteryTempAlarmSet, vpwrLvdAlarmContactorOpen=vpwrLvdAlarmContactorOpen, vpwrBDTAdminState=vpwrBDTAdminState, vpwrPanelModuleIdentTable=vpwrPanelModuleIdentTable, vpwrLvdAlarmGroup=vpwrLvdAlarmGroup, vpwrBatteryTempLThreshold=vpwrBatteryTempLThreshold, vpwrIoModuleAlarmGroup=vpwrIoModuleAlarmGroup, vpwrRectifierHVSDSetpoint=vpwrRectifierHVSDSetpoint, vpwrRectifierAlarmGroup=vpwrRectifierAlarmGroup, vpwrBatteryBoostGroup=vpwrBatteryBoostGroup, vpwrBatteryTempTable=vpwrBatteryTempTable, vpwrLvdAlarmWarning=vpwrLvdAlarmWarning, vpwrRingerAlarmaAFailed=vpwrRingerAlarmaAFailed, vpwrIdentControllerVersion=vpwrIdentControllerVersion, sysRelayDefaultName=sysRelayDefaultName, batteryTempCompHighStartTemperature=batteryTempCompHighStartTemperature, vpwrSystemBayctrlIdentGroup=vpwrSystemBayctrlIdentGroup)
mibBuilder.exportSymbols("VALERE-DC-POWER-MIB", vpwrTrapPowerMajorAlarm=vpwrTrapPowerMajorAlarm, vpwrRectAlarmUV=vpwrRectAlarmUV, vpwrLvdAlarmCBOpen=vpwrLvdAlarmCBOpen, vpwrTrapSystemOverTemperatureAlarm=vpwrTrapSystemOverTemperatureAlarm, vpwrSystemIdentGroup=vpwrSystemIdentGroup, sysAlarmComFailState=sysAlarmComFailState, vpwrTrapCommunityString=vpwrTrapCommunityString, vpwrTrapSwDownloadAndReboot=vpwrTrapSwDownloadAndReboot, vpwrBayctrlOperStatus=vpwrBayctrlOperStatus, vpwrIoModuleTestGroup=vpwrIoModuleTestGroup, vpwrBDTAbortVoltage=vpwrBDTAbortVoltage, vpwrLvdContactorConfigEntry=vpwrLvdContactorConfigEntry, vpwrReadCommunityString=vpwrReadCommunityString, vpwrModuleOID=vpwrModuleOID, vpwrRectAlarmACFail=vpwrRectAlarmACFail, vpwrWriteCommunityString=vpwrWriteCommunityString, vpwrLvdContactorIndex=vpwrLvdContactorIndex, vpwrRectifierCurrentLimit=vpwrRectifierCurrentLimit, NonNegativeInteger=NonNegativeInteger, vpwrModuleIdentTable=vpwrModuleIdentTable, vpwrIdentManufacturer=vpwrIdentManufacturer, batteryTempCompensation=batteryTempCompensation, vpwrDcPowerTrapsMsgString=vpwrDcPowerTrapsMsgString, vpwrDcDcConverterAlarmGroup=vpwrDcDcConverterAlarmGroup, vpwrLvdDisconnectSetpoint=vpwrLvdDisconnectSetpoint, vpwrLvdConfigGroup=vpwrLvdConfigGroup, vpwrDcDcConverterTestGroup=vpwrDcDcConverterTestGroup, sysAlarmDefaultName=sysAlarmDefaultName, sysAlarmCustomName=sysAlarmCustomName, vpwrSystemTempCompensation=vpwrSystemTempCompensation, vpwrRingerAlarmaBFailed=vpwrRingerAlarmaBFailed, vpwrTrapLVDOpenAlarm=vpwrTrapLVDOpenAlarm, vpwrDcPowerTest=vpwrDcPowerTest, vpwrPanelModuleIndex=vpwrPanelModuleIndex, vpwrLvdWarningSetpoint=vpwrLvdWarningSetpoint, vpwrLvdContactorState=vpwrLvdContactorState, thermalProbeTable=thermalProbeTable, vpwrTrapPowerMinorAlarm=vpwrTrapPowerMinorAlarm, vpwrTrapSystemClockChange=vpwrTrapSystemClockChange, vpwrBayctrlIdentEntry=vpwrBayctrlIdentEntry, vpwrRectAlarmModDisableShutdown=vpwrRectAlarmModDisableShutdown, sysAlarmIndex=sysAlarmIndex)
