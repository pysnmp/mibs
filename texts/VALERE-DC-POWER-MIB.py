...
ModuleIdentity, ObjectIdentity, Counter32, Gauge32, TimeTicks, Counter64, enterprises, Integer32, Bits, NotificationType, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "Counter32", "Gauge32", "TimeTicks", "Counter64", "enterprises", "Integer32", "Bits", "NotificationType", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress")
...
mibBuilder.exportSymbols("VALERE-DC-POWER-MIB", vpwrTrapThermalRunaway=vpwrTrapThermalRunaway, vpwrDcPowerMgt=vpwrDcPowerMgt, vpwrRingerTestGroup=vpwrRingerTestGroup, vpwrTrapLoginSuccess=vpwrTrapLoginSuccess, sysAlarmRedundancyState=sysAlarmRedundancyState, vpwrPanelIdentTable=vpwrPanelIdentTable, vpwrSystemCurrent=vpwrSystemCurrent, vpwrTrapHVSDAlarm=vpwrTrapHVSDAlarm, vpwrTrapDistributionCommAlarm=vpwrTrapDistributionCommAlarm, vpwrRectAlarmDCEnable=vpwrRectAlarmDCEnable, vpwrTrapBatteryDischargeTestAlarm=vpwrTrapBatteryDischargeTestAlarm, vpwrRingerAlarmaBFailed=vpwrRingerAlarmaBFailed, vpwrSystemParameterGroup=vpwrSystemParameterGroup, vpwrBayctrlOperHours=vpwrBayctrlOperHours, vpwrTrapConverterInputFailAlarm=vpwrTrapConverterInputFailAlarm, vpwrLvdTestGroup=vpwrLvdTestGroup, vpwrRectifierCurrentLimit=vpwrRectifierCurrentLimit, sysAuxAlarmPolarity=sysAuxAlarmPolarity, vpwrSystemTempCompensationSlope=vpwrSystemTempCompensationSlope, vpwrDcPowerModuleIdent=vpwrDcPowerModuleIdent, vpwrBDTAbortVoltage=vpwrBDTAbortVoltage, vpwrLvdContactorWarningSetpoint=vpwrLvdContactorWarningSetpoint, vpwrBayctrlModuleIdentTable=vpwrBayctrlModuleIdentTable, vpwrBayctrlCapacity=vpwrBayctrlCapacity, batteryTempCompLowStopVoltage=batteryTempCompLowStopVoltage, vpwrDcPowerTrapsMsgString=vpwrDcPowerTrapsMsgString, vpwrModuleOperStatus=vpwrModuleOperStatus, vpwrRectifierTestGroup=vpwrRectifierTestGroup, PositiveInteger=PositiveInteger, vpwrLvdConfigGroup=vpwrLvdConfigGroup, vpwrTrapRingerCommAlarm=vpwrTrapRingerCommAlarm, vpwrSystemInternalTemperature=vpwrSystemInternalTemperature, vpwrAlarmIndex=vpwrAlarmIndex, vpwrSystemIdentTable=vpwrSystemIdentTable, vpwrBatteryCurrentGroup=vpwrBatteryCurrentGroup, vpwrDcAcInverterConfigGroup=vpwrDcAcInverterConfigGroup, vpwrPanelModuleModelNumber=vpwrPanelModuleModelNumber, vpwrTrapModuleAlarm=vpwrTrapModuleAlarm, vpwrRingerParameterDcVoltage=vpwrRingerParameterDcVoltage, vpwrBayctrlIdentTable=vpwrBayctrlIdentTable, vpwrBayctrlTestDate=vpwrBayctrlTestDate, sysAlarmSeverity=sysAlarmSeverity, vpwrTrapLVDOpenAlarm=vpwrTrapLVDOpenAlarm, vpwrPanelModuleOperStatus=vpwrPanelModuleOperStatus, vpwrIdentAgentSoftwareVersion=vpwrIdentAgentSoftwareVersion, vpwrTrapIpAddress=vpwrTrapIpAddress, vpwrSystemVoltage=vpwrSystemVoltage, vpwrAlarmTime=vpwrAlarmTime, vpwrTrapIShareAlarm=vpwrTrapIShareAlarm, vpwrAlarmTable=vpwrAlarmTable, vpwrSystemInternalTempUThreshold=vpwrSystemInternalTempUThreshold, sysRelayCustomName=sysRelayCustomName, vpwrTrapDisplayFirmwareMismatchAlarm=vpwrTrapDisplayFirmwareMismatchAlarm, vpwrAlarmEntry=vpwrAlarmEntry, vpwrTrapSwDownloadNoReboot=vpwrTrapSwDownloadNoReboot, vpwrBDTClearAlarm=vpwrBDTClearAlarm, sysAlarmIndex=sysAlarmIndex, sysAuxAlarmCustomName=sysAuxAlarmCustomName, vpwrLvdContactorConfigTable=vpwrLvdContactorConfigTable, vpwrTrapHVAlarm=vpwrTrapHVAlarm, vpwrTrapInternalTempAlarmCleared=vpwrTrapInternalTempAlarmCleared, vpwrSystemIdentGroup=vpwrSystemIdentGroup, vpwrDcPowerRinger=vpwrDcPowerRinger, vpwrIdentManufacturer=vpwrIdentManufacturer, vpwrLvdContactorIndex=vpwrLvdContactorIndex, vpwrBayctrlCurrent=vpwrBayctrlCurrent, vpwrTrapBDAlarm=vpwrTrapBDAlarm, vpwrTrapUnmappedAddressAlarm=vpwrTrapUnmappedAddressAlarm, vpwrRectifierCurrentLimitAdminState=vpwrRectifierCurrentLimitAdminState, vpwrPanelModuleFwVersion=vpwrPanelModuleFwVersion, vpwrPanelModuleSerialNumber=vpwrPanelModuleSerialNumber, vpwrLvdReconnectSetpoint=vpwrLvdReconnectSetpoint, batteryTempCompLowSlope=batteryTempCompLowSlope, vpwrTrapModuleInserted=vpwrTrapModuleInserted, vpwrTrapCommunityString=vpwrTrapCommunityString, vpwrModuleIdentTable=vpwrModuleIdentTable, vpwrSystemConfigGroup=vpwrSystemConfigGroup, thermalProbeState=thermalProbeState, vpwrTrapMultipleConvFailAlarm=vpwrTrapMultipleConvFailAlarm, vpwrTrapModuleCommAlarm=vpwrTrapModuleCommAlarm, vpwrTrapMultipleRingerAlarm=vpwrTrapMultipleRingerAlarm, batteryTempCompRunawayState=batteryTempCompRunawayState, vpwrBatteryTempName=vpwrBatteryTempName, vpwrRectAlarmUV=vpwrRectAlarmUV, vpwrRectAlarmAmbTemp=vpwrRectAlarmAmbTemp, vpwrTrapLogout=vpwrTrapLogout, vpwrRectAlarmIShare=vpwrRectAlarmIShare, vpwrRingerParameterEntry=vpwrRingerParameterEntry, sysAlarmToRelayMapping=sysAlarmToRelayMapping, vpwrDcDcConverterAlarmGroup=vpwrDcDcConverterAlarmGroup, vpwrModuleSerialNumber=vpwrModuleSerialNumber, sysAlarmConfigTable=sysAlarmConfigTable, vpwrModuleFwVersion=vpwrModuleFwVersion, vpwrTrapConverterAlarm=vpwrTrapConverterAlarm, vpwrBDTOperState=vpwrBDTOperState, vpwrDcPowerDist=vpwrDcPowerDist, vpwrModuleIdentEntry=vpwrModuleIdentEntry, vpwrPanelModuleIndex=vpwrPanelModuleIndex, vpwrBayctrlIndex=vpwrBayctrlIndex, vpwrTrapLoginFail=vpwrTrapLoginFail, vpwrModuleOID=vpwrModuleOID, vpwrTrapRingerAAlarm=vpwrTrapRingerAAlarm, vpwrModuleCapacity=vpwrModuleCapacity, vpwrWriteCommunityString=vpwrWriteCommunityString, vpwrRectifierConfigGroup=vpwrRectifierConfigGroup, vpwrSystemThermalSenseType=vpwrSystemThermalSenseType, vpwrTrapAdminPwdChange=vpwrTrapAdminPwdChange, vpwrBayctrlOperStatus=vpwrBayctrlOperStatus, vpwrRingerAlarmBOverTemp=vpwrRingerAlarmBOverTemp, vpwrBDTAlarmCoefficient=vpwrBDTAlarmCoefficient, sysRelayConfigEntry=sysRelayConfigEntry, vpwrTrapCriticality=vpwrTrapCriticality, vpwrBoostOperState=vpwrBoostOperState, vpwrLvdContactorDisconnectSetpoint=vpwrLvdContactorDisconnectSetpoint, batteryTempCompRunawayStopVoltage=batteryTempCompRunawayStopVoltage, vpwrBatteryTempLThreshold=vpwrBatteryTempLThreshold, vpwrDcAcInverterTestGroup=vpwrDcAcInverterTestGroup, vpwrSystemTempCompensationState=vpwrSystemTempCompensationState, vpwrTrapSystemOK=vpwrTrapSystemOK, vpwrPanelModuleCapacity=vpwrPanelModuleCapacity, vpwrRectifierFVSetpoint=vpwrRectifierFVSetpoint, vpwrDcPowerBatteryGroup=vpwrDcPowerBatteryGroup, vpwrLvdContactorReconnectDelayTimer=vpwrLvdContactorReconnectDelayTimer, vpwrDcPowerIoModule=vpwrDcPowerIoModule, vpwrDcDcConverterConfigGroup=vpwrDcDcConverterConfigGroup, vpwrTrapBatteryTempAlarmCleared=vpwrTrapBatteryTempAlarmCleared, vpwrTrapSystemClockChange=vpwrTrapSystemClockChange, vpwrRectAlarmBoostComm=vpwrRectAlarmBoostComm, vpwrLvdContactorReconnectSetpoint=vpwrLvdContactorReconnectSetpoint, batteryTempCompensation=batteryTempCompensation, vpwrBayctrlModuleIdentEntry=vpwrBayctrlModuleIdentEntry, vpwrIoModuleConfigGroup=vpwrIoModuleConfigGroup, vpwrSystemIdentEntry=vpwrSystemIdentEntry, vpwrPanelModuleIdentEntry=vpwrPanelModuleIdentEntry, batteryTempCompRunawayTemperature=batteryTempCompRunawayTemperature, vpwrBatteryTemp=vpwrBatteryTemp, vpwrTrapDistAlarm=vpwrTrapDistAlarm, vpwrPanelBayIndex=vpwrPanelBayIndex, vpwrBoostAdminState=vpwrBoostAdminState, vpwrDcPowerTest=vpwrDcPowerTest, vpwrTrapModuleFailAlarm=vpwrTrapModuleFailAlarm, vpwrTrapClearEventHistory=vpwrTrapClearEventHistory, vpwrSystemType=vpwrSystemType, sysAlarmCustomName=sysAlarmCustomName, batteryTempCompHighStartTemperature=batteryTempCompHighStartTemperature, vpwrTrapThermalCompInactive=vpwrTrapThermalCompInactive, vpwrTrapSystemAlive=vpwrTrapSystemAlive, sysRelayAlarmSeverity=sysRelayAlarmSeverity, vpwrBayctrlOID=vpwrBayctrlOID, vpwrTrapIpIndex=vpwrTrapIpIndex, vpwrBayctrlModelNumber=vpwrBayctrlModelNumber, vpwrSystemPanelIdentGroup=vpwrSystemPanelIdentGroup, vpwrDcPowerAlarmGroup=vpwrDcPowerAlarmGroup, vpwrTrapRingerBAlarm=vpwrTrapRingerBAlarm, vpwrRectifierAlarmGroup=vpwrRectifierAlarmGroup, vpwrDcPowerDcDcConverter=vpwrDcPowerDcDcConverter, vpwrTrapOIDChange=vpwrTrapOIDChange, vpwrModuleIndex=vpwrModuleIndex, vpwrBayctrlIdentEntry=vpwrBayctrlIdentEntry, thermalProbeTable=thermalProbeTable, vpwrBatteryTempIndex=vpwrBatteryTempIndex, sysAuxAlarmIndex=sysAuxAlarmIndex, vpwrTrapPowerMinorAlarm=vpwrTrapPowerMinorAlarm, vpwrPanelModuleCurrent=vpwrPanelModuleCurrent, vpwrRingerNumberPresent=vpwrRingerNumberPresent, sysAuxAlarmToRelayMapping=sysAuxAlarmToRelayMapping, vpwrBattetyCurrentLimitValue=vpwrBattetyCurrentLimitValue, vpwrBatteryDischargeTestGroup=vpwrBatteryDischargeTestGroup, vpwrModuleTestDate=vpwrModuleTestDate, vpwrRingerAlarmaAFailed=vpwrRingerAlarmaAFailed, vpwrModuleCurrent=vpwrModuleCurrent, vpwrRingerIndex=vpwrRingerIndex, vpwrBayctrlFwVersion=vpwrBayctrlFwVersion, vpwrRingerParameterFrequency=vpwrRingerParameterFrequency, vpwrBayIndex=vpwrBayIndex, vpwrLvdAlarmGroup=vpwrLvdAlarmGroup, vpwrDcPowerLvd=vpwrDcPowerLvd, vpwrTrapThermalCompActive=vpwrTrapThermalCompActive, vpwrRectAlarmBoostFail=vpwrRectAlarmBoostFail, vpwrRectAlarmReserved=vpwrRectAlarmReserved, vpwrLvdContactorState=vpwrLvdContactorState, vpwrDcPowerDcAcInverter=vpwrDcPowerDcAcInverter, vpwrRingerParameterTable=vpwrRingerParameterTable, vpwrReadCommunityString=vpwrReadCommunityString, NonNegativeInteger=NonNegativeInteger, vpwrTrapModuleRemoved=vpwrTrapModuleRemoved, vpwrBDTAlarmVoltage=vpwrBDTAlarmVoltage, sysAuxAlarmOperStatus=sysAuxAlarmOperStatus, vpwrIoModuleAlarmGroup=vpwrIoModuleAlarmGroup, vpwrTrapLVDWarningAlarm=vpwrTrapLVDWarningAlarm, vpwrTrapSystemOverTemperatureAlarm=vpwrTrapSystemOverTemperatureAlarm, vpwrDcPowerRectifier=vpwrDcPowerRectifier, vpwrTrapConfigErrorAlarm=vpwrTrapConfigErrorAlarm, vpwrTrapUserIpAddress=vpwrTrapUserIpAddress, vpwrBatteryCurrentLimitAdminState=vpwrBatteryCurrentLimitAdminState, vpwrBDTAdminState=vpwrBDTAdminState, vpwrTrapACFAlarm=vpwrTrapACFAlarm, vpwrBayctrlSerialNumber=vpwrBayctrlSerialNumber, vpwrSystemBDAlarmSetpoint=vpwrSystemBDAlarmSetpoint, batteryTempCompLowStartTemperature=batteryTempCompLowStartTemperature, vpwrBoostDuration=vpwrBoostDuration, vpwrPanelModuleTestDate=vpwrPanelModuleTestDate, vpwrBatteryTempEntry=vpwrBatteryTempEntry, vpwrTrapBatteryTempAlarmSet=vpwrTrapBatteryTempAlarmSet, vpwrBattetyCurrentValue=vpwrBattetyCurrentValue, vpwrIdentName=vpwrIdentName, vpwrLvdWarningSetpoint=vpwrLvdWarningSetpoint, vpwrDcDcConverterTestGroup=vpwrDcDcConverterTestGroup, vpwrDcPowerSnmpConfig=vpwrDcPowerSnmpConfig, vpwrRectAlarmFanFail=vpwrRectAlarmFanFail, vpwrTrapThermalProbeAlarm=vpwrTrapThermalProbeAlarm, sysRelayIndex=sysRelayIndex, sysAlarmConfigEntry=sysAlarmConfigEntry, vpwrLvdReconnectDelayTimer=vpwrLvdReconnectDelayTimer, vpwrIdentModel=vpwrIdentModel, vpwrRectAlarmDCFail=vpwrRectAlarmDCFail, sysAuxAlarmConfigTable=sysAuxAlarmConfigTable, vpwrPanelModuleOID=vpwrPanelModuleOID, vpwrSystemTempCompStopVoltage=vpwrSystemTempCompStopVoltage, sysAlarmOperStatus=sysAlarmOperStatus, vpwrRingerParameterAcVoltage=vpwrRingerParameterAcVoltage, PYSNMP_MODULE_ID=vpwrDcPowerMgt, vpwrPanelModuleOperHours=vpwrPanelModuleOperHours, vpwrPanelIdentEntry=vpwrPanelIdentEntry, vpwrTrapsMsgString=vpwrTrapsMsgString, vpwrRingerAlarmBOverCurrent=vpwrRingerAlarmBOverCurrent, vpwrBoostVoltage=vpwrBoostVoltage, vpwrSystemControllerState=vpwrSystemControllerState, batteryTempCompHighSlope=batteryTempCompHighSlope, vpwrRectAlarmACFail=vpwrRectAlarmACFail, vpwrDcPowerTraps=vpwrDcPowerTraps, vpwrBatteryBoostGroup=vpwrBatteryBoostGroup, batteryTempCompHighStopVoltage=batteryTempCompHighStopVoltage, batteryTempCompSenseSource=batteryTempCompSenseSource, vpwrTrapSingleRingerAlarm=vpwrTrapSingleRingerAlarm, vpwrBDTDuration=vpwrBDTDuration, vpwrSystemBayctrlIdentGroup=vpwrSystemBayctrlIdentGroup, vpwrDcPowerBayController=vpwrDcPowerBayController, vpwrDcPowerTrio=vpwrDcPowerTrio, vpwrTrapBatteryRechgIlimitFailAlarm=vpwrTrapBatteryRechgIlimitFailAlarm, vpwrTrapEventTimeStamp=vpwrTrapEventTimeStamp, vpwrModuleModelNumber=vpwrModuleModelNumber, vpwrDcPowerSystem=vpwrDcPowerSystem, vpwrSystemHVAlarmSetpoint=vpwrSystemHVAlarmSetpoint, sysRelayDefaultName=sysRelayDefaultName, sysAuxAlarmDefaultName=sysAuxAlarmDefaultName, vpwrBatteryTempTable=vpwrBatteryTempTable, vpwrLvdAlarmContactorOpen=vpwrLvdAlarmContactorOpen, vpwrTrapSwDownloadAndReboot=vpwrTrapSwDownloadAndReboot, vpwrRectAlarmHVSD=vpwrRectAlarmHVSD, vpwrRectAlarmRemoteShutdown=vpwrRectAlarmRemoteShutdown, sysAlarmIShareState=sysAlarmIShareState, vpwrTrapMultipleModuleFailAlarm=vpwrTrapMultipleModuleFailAlarm, vpwrBatteryTempGroup=vpwrBatteryTempGroup)
mibBuilder.exportSymbols("VALERE-DC-POWER-MIB", vpwrRingerAlarmAOTemp=vpwrRingerAlarmAOTemp, vpwrAlarmsPresent=vpwrAlarmsPresent, vpwrRectifierHVSDSetpoint=vpwrRectifierHVSDSetpoint, vpwrLvdAlarmCBOpen=vpwrLvdAlarmCBOpen, thermalProbeEntry=thermalProbeEntry, vpwrRingerParameterAdminState=vpwrRingerParameterAdminState, vpwrModuleOperHours=vpwrModuleOperHours, vpwrSystemTempCompensation=vpwrSystemTempCompensation, sysAuxAlarmSeverity=sysAuxAlarmSeverity, vpwrRectAlarmModDisableShutdown=vpwrRectAlarmModDisableShutdown, vpwrTrapInternalTempAlarmSet=vpwrTrapInternalTempAlarmSet, vpwrRectAlarmShortPinShutdown=vpwrRectAlarmShortPinShutdown, sysAlarmComFailState=sysAlarmComFailState, vpwrRingerConfigGroup=vpwrRingerConfigGroup, vpwrRectAlarmLowVoltage=vpwrRectAlarmLowVoltage, vpwrSystemInternalTempLThreshold=vpwrSystemInternalTempLThreshold, sysAlarmDefaultName=sysAlarmDefaultName, vpwrSystemTempCompStartTemperature=vpwrSystemTempCompStartTemperature, vpwrRectAlarmIntTemp=vpwrRectAlarmIntTemp, vpwrTrapLvdFuseOpen=vpwrTrapLvdFuseOpen, vpwrLvdAlarmWarning=vpwrLvdAlarmWarning, vpwrRingerAlarmGroup=vpwrRingerAlarmGroup, vpwrTrapEntry=vpwrTrapEntry, vpwrAlarmDescr=vpwrAlarmDescr, vpwrTrapSystemRedundancyAlarm=vpwrTrapSystemRedundancyAlarm, vpwrLvdContactorConfigEntry=vpwrLvdContactorConfigEntry, vpwrIdentControllerVersion=vpwrIdentControllerVersion, vpwrTrapAuxAlarm=vpwrTrapAuxAlarm, vpwrSystemShelfCapacity=vpwrSystemShelfCapacity, vpwrPanelModuleIdentTable=vpwrPanelModuleIdentTable, vpwrTrapPowerMajorAlarm=vpwrTrapPowerMajorAlarm, vpwrRingerAlarmAOCurrent=vpwrRingerAlarmAOCurrent, vpwrLvdDisconnectSetpoint=vpwrLvdDisconnectSetpoint, vpwrTrapIllegalConfigSubmit=vpwrTrapIllegalConfigSubmit, vpwrDcPowerProducts=vpwrDcPowerProducts, vpwrTrapCfgChange=vpwrTrapCfgChange, vpwrIoModuleTestGroup=vpwrIoModuleTestGroup, vpwrBatteryTempUThreshold=vpwrBatteryTempUThreshold, vpwrDcAcInverterAlarmGroup=vpwrDcAcInverterAlarmGroup, sysRelayConfigTable=sysRelayConfigTable, vpwrTrapTable=vpwrTrapTable, sysAuxAlarmConfigEntry=sysAuxAlarmConfigEntry)
