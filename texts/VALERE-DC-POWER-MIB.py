...
Integer32, Unsigned32, ObjectIdentity, enterprises, TimeTicks, Counter64, IpAddress, MibIdentifier, ModuleIdentity, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "ObjectIdentity", "enterprises", "TimeTicks", "Counter64", "IpAddress", "MibIdentifier", "ModuleIdentity", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "Bits")
...
mibBuilder.exportSymbols("VALERE-DC-POWER-MIB", vpwrTrapRingerBAlarm=vpwrTrapRingerBAlarm, vpwrRectAlarmRemoteShutdown=vpwrRectAlarmRemoteShutdown, vpwrTrapLVDWarningAlarm=vpwrTrapLVDWarningAlarm, vpwrModuleTestDate=vpwrModuleTestDate, vpwrAlarmEntry=vpwrAlarmEntry, vpwrTrapThermalCompInactive=vpwrTrapThermalCompInactive, vpwrRectifierAlarmGroup=vpwrRectifierAlarmGroup, vpwrAlarmTable=vpwrAlarmTable, vpwrSystemIdentGroup=vpwrSystemIdentGroup, vpwrSystemTempCompStartTemperature=vpwrSystemTempCompStartTemperature, vpwrSystemTempCompensationSlope=vpwrSystemTempCompensationSlope, vpwrPanelModuleIdentTable=vpwrPanelModuleIdentTable, vpwrDcPowerRinger=vpwrDcPowerRinger, vpwrBatteryCurrentGroup=vpwrBatteryCurrentGroup, vpwrSystemTempCompensation=vpwrSystemTempCompensation, vpwrBoostVoltage=vpwrBoostVoltage, vpwrRingerAlarmBOverCurrent=vpwrRingerAlarmBOverCurrent, vpwrDcPowerBatteryGroup=vpwrDcPowerBatteryGroup, vpwrBayctrlIdentTable=vpwrBayctrlIdentTable, vpwrBayctrlOperHours=vpwrBayctrlOperHours, batteryTempCompRunawayTemperature=batteryTempCompRunawayTemperature, sysAuxAlarmConfigTable=sysAuxAlarmConfigTable, vpwrPanelModuleSerialNumber=vpwrPanelModuleSerialNumber, vpwrLvdDisconnectSetpoint=vpwrLvdDisconnectSetpoint, vpwrBayctrlOID=vpwrBayctrlOID, vpwrTrapOIDChange=vpwrTrapOIDChange, vpwrRectAlarmUV=vpwrRectAlarmUV, vpwrRectAlarmLowVoltage=vpwrRectAlarmLowVoltage, vpwrDcPowerProducts=vpwrDcPowerProducts, vpwrPanelModuleOperStatus=vpwrPanelModuleOperStatus, vpwrDcAcInverterAlarmGroup=vpwrDcAcInverterAlarmGroup, vpwrIoModuleConfigGroup=vpwrIoModuleConfigGroup, vpwrBDTDuration=vpwrBDTDuration, vpwrLvdReconnectSetpoint=vpwrLvdReconnectSetpoint, vpwrRingerAlarmaAFailed=vpwrRingerAlarmaAFailed, vpwrBDTAlarmVoltage=vpwrBDTAlarmVoltage, vpwrBDTAlarmCoefficient=vpwrBDTAlarmCoefficient, vpwrSystemConfigGroup=vpwrSystemConfigGroup, vpwrRingerAlarmaBFailed=vpwrRingerAlarmaBFailed, vpwrDcDcConverterAlarmGroup=vpwrDcDcConverterAlarmGroup, vpwrTrapEntry=vpwrTrapEntry, vpwrLvdContactorDisconnectSetpoint=vpwrLvdContactorDisconnectSetpoint, vpwrDcPowerDist=vpwrDcPowerDist, vpwrDcDcConverterTestGroup=vpwrDcDcConverterTestGroup, batteryTempCompLowStopVoltage=batteryTempCompLowStopVoltage, vpwrTrapPowerMajorAlarm=vpwrTrapPowerMajorAlarm, vpwrDcPowerSnmpConfig=vpwrDcPowerSnmpConfig, vpwrSystemParameterGroup=vpwrSystemParameterGroup, vpwrSystemPanelIdentGroup=vpwrSystemPanelIdentGroup, vpwrTrapInternalTempAlarmCleared=vpwrTrapInternalTempAlarmCleared, vpwrRingerNumberPresent=vpwrRingerNumberPresent, vpwrLvdContactorState=vpwrLvdContactorState, sysAlarmIShareState=sysAlarmIShareState, sysRelayIndex=sysRelayIndex, vpwrRectifierCurrentLimitAdminState=vpwrRectifierCurrentLimitAdminState, vpwrTrapInternalTempAlarmSet=vpwrTrapInternalTempAlarmSet, vpwrRectAlarmShortPinShutdown=vpwrRectAlarmShortPinShutdown, vpwrDcPowerRectifier=vpwrDcPowerRectifier, vpwrDcPowerDcAcInverter=vpwrDcPowerDcAcInverter, vpwrTrapUserIpAddress=vpwrTrapUserIpAddress, vpwrDcPowerLvd=vpwrDcPowerLvd, batteryTempCompHighStartTemperature=batteryTempCompHighStartTemperature, vpwrIoModuleAlarmGroup=vpwrIoModuleAlarmGroup, vpwrIdentModel=vpwrIdentModel, vpwrBDTAdminState=vpwrBDTAdminState, vpwrLvdContactorWarningSetpoint=vpwrLvdContactorWarningSetpoint, vpwrRectAlarmFanFail=vpwrRectAlarmFanFail, vpwrAlarmsPresent=vpwrAlarmsPresent, vpwrIoModuleTestGroup=vpwrIoModuleTestGroup, vpwrPanelModuleCapacity=vpwrPanelModuleCapacity, vpwrTrapThermalRunaway=vpwrTrapThermalRunaway, vpwrTrapMultipleRingerAlarm=vpwrTrapMultipleRingerAlarm, sysAlarmIndex=sysAlarmIndex, vpwrLvdAlarmCBOpen=vpwrLvdAlarmCBOpen, sysAuxAlarmPolarity=sysAuxAlarmPolarity, vpwrTrapModuleAlarm=vpwrTrapModuleAlarm, vpwrBayctrlModelNumber=vpwrBayctrlModelNumber, vpwrRingerConfigGroup=vpwrRingerConfigGroup, vpwrRectAlarmAmbTemp=vpwrRectAlarmAmbTemp, vpwrDcPowerAlarmGroup=vpwrDcPowerAlarmGroup, vpwrBattetyCurrentLimitValue=vpwrBattetyCurrentLimitValue, vpwrLvdContactorIndex=vpwrLvdContactorIndex, vpwrTrapModuleCommAlarm=vpwrTrapModuleCommAlarm, vpwrDcPowerTest=vpwrDcPowerTest, vpwrTrapLogout=vpwrTrapLogout, vpwrTrapLvdFuseOpen=vpwrTrapLvdFuseOpen, vpwrSystemTempCompensationState=vpwrSystemTempCompensationState, thermalProbeState=thermalProbeState, vpwrTrapDisplayFirmwareMismatchAlarm=vpwrTrapDisplayFirmwareMismatchAlarm, vpwrRectAlarmDCFail=vpwrRectAlarmDCFail, sysAuxAlarmToRelayMapping=sysAuxAlarmToRelayMapping, vpwrBayctrlIdentEntry=vpwrBayctrlIdentEntry, vpwrIdentAgentSoftwareVersion=vpwrIdentAgentSoftwareVersion, vpwrTrapTable=vpwrTrapTable, vpwrTrapHVAlarm=vpwrTrapHVAlarm, vpwrTrapSwDownloadNoReboot=vpwrTrapSwDownloadNoReboot, vpwrDcAcInverterTestGroup=vpwrDcAcInverterTestGroup, vpwrTrapIpIndex=vpwrTrapIpIndex, sysAlarmToRelayMapping=sysAlarmToRelayMapping, vpwrDcPowerTrio=vpwrDcPowerTrio, sysAlarmComFailState=sysAlarmComFailState, vpwrRingerParameterAcVoltage=vpwrRingerParameterAcVoltage, vpwrModuleSerialNumber=vpwrModuleSerialNumber, vpwrBattetyCurrentValue=vpwrBattetyCurrentValue, vpwrRingerAlarmGroup=vpwrRingerAlarmGroup, vpwrModuleIndex=vpwrModuleIndex, sysAuxAlarmDefaultName=sysAuxAlarmDefaultName, vpwrRectAlarmACFail=vpwrRectAlarmACFail, vpwrAlarmTime=vpwrAlarmTime, vpwrDcAcInverterConfigGroup=vpwrDcAcInverterConfigGroup, vpwrIdentControllerVersion=vpwrIdentControllerVersion, vpwrTrapIShareAlarm=vpwrTrapIShareAlarm, vpwrLvdAlarmWarning=vpwrLvdAlarmWarning, vpwrRectAlarmIntTemp=vpwrRectAlarmIntTemp, vpwrBoostAdminState=vpwrBoostAdminState, vpwrTrapThermalProbeAlarm=vpwrTrapThermalProbeAlarm, vpwrBayctrlTestDate=vpwrBayctrlTestDate, batteryTempCompensation=batteryTempCompensation, vpwrRectifierHVSDSetpoint=vpwrRectifierHVSDSetpoint, sysAlarmRedundancyState=sysAlarmRedundancyState, vpwrSystemVoltage=vpwrSystemVoltage, vpwrBayctrlModuleIdentEntry=vpwrBayctrlModuleIdentEntry, vpwrLvdContactorConfigTable=vpwrLvdContactorConfigTable, vpwrTrapLVDOpenAlarm=vpwrTrapLVDOpenAlarm, vpwrSystemInternalTemperature=vpwrSystemInternalTemperature, vpwrBDTAbortVoltage=vpwrBDTAbortVoltage, vpwrRectAlarmReserved=vpwrRectAlarmReserved, vpwrModuleOperStatus=vpwrModuleOperStatus, vpwrLvdAlarmContactorOpen=vpwrLvdAlarmContactorOpen, vpwrModuleOID=vpwrModuleOID, vpwrModuleCapacity=vpwrModuleCapacity, sysRelayAlarmSeverity=sysRelayAlarmSeverity, sysAlarmCustomName=sysAlarmCustomName, vpwrModuleModelNumber=vpwrModuleModelNumber, vpwrTrapUnmappedAddressAlarm=vpwrTrapUnmappedAddressAlarm, sysAuxAlarmOperStatus=sysAuxAlarmOperStatus, vpwrBDTOperState=vpwrBDTOperState, vpwrLvdContactorConfigEntry=vpwrLvdContactorConfigEntry, vpwrBatteryTempName=vpwrBatteryTempName, vpwrTrapModuleFailAlarm=vpwrTrapModuleFailAlarm, vpwrDcPowerModuleIdent=vpwrDcPowerModuleIdent, vpwrTrapSystemClockChange=vpwrTrapSystemClockChange, vpwrTrapSystemOverTemperatureAlarm=vpwrTrapSystemOverTemperatureAlarm, vpwrRingerIndex=vpwrRingerIndex, vpwrBatteryCurrentLimitAdminState=vpwrBatteryCurrentLimitAdminState, sysRelayDefaultName=sysRelayDefaultName, vpwrRectifierConfigGroup=vpwrRectifierConfigGroup, sysAlarmConfigEntry=sysAlarmConfigEntry, vpwrBatteryTempTable=vpwrBatteryTempTable, vpwrPanelModuleTestDate=vpwrPanelModuleTestDate, vpwrRingerParameterTable=vpwrRingerParameterTable, vpwrDcPowerBayController=vpwrDcPowerBayController, vpwrTrapPowerMinorAlarm=vpwrTrapPowerMinorAlarm, vpwrTrapBatteryRechgIlimitFailAlarm=vpwrTrapBatteryRechgIlimitFailAlarm, vpwrPanelModuleIdentEntry=vpwrPanelModuleIdentEntry, vpwrTrapAdminPwdChange=vpwrTrapAdminPwdChange, sysAlarmDefaultName=sysAlarmDefaultName, vpwrLvdWarningSetpoint=vpwrLvdWarningSetpoint, vpwrTrapBatteryDischargeTestAlarm=vpwrTrapBatteryDischargeTestAlarm, vpwrTrapIpAddress=vpwrTrapIpAddress, batteryTempCompRunawayStopVoltage=batteryTempCompRunawayStopVoltage, vpwrRectAlarmModDisableShutdown=vpwrRectAlarmModDisableShutdown, vpwrIdentManufacturer=vpwrIdentManufacturer, vpwrBayctrlModuleIdentTable=vpwrBayctrlModuleIdentTable, vpwrTrapConverterInputFailAlarm=vpwrTrapConverterInputFailAlarm, vpwrTrapConfigErrorAlarm=vpwrTrapConfigErrorAlarm, vpwrReadCommunityString=vpwrReadCommunityString, sysAlarmOperStatus=sysAlarmOperStatus, vpwrLvdAlarmGroup=vpwrLvdAlarmGroup, vpwrBatteryTempLThreshold=vpwrBatteryTempLThreshold, vpwrSystemShelfCapacity=vpwrSystemShelfCapacity, vpwrWriteCommunityString=vpwrWriteCommunityString, vpwrPanelIdentEntry=vpwrPanelIdentEntry, sysAlarmConfigTable=sysAlarmConfigTable, vpwrTrapDistAlarm=vpwrTrapDistAlarm, vpwrRectAlarmBoostComm=vpwrRectAlarmBoostComm, vpwrBayctrlFwVersion=vpwrBayctrlFwVersion, PYSNMP_MODULE_ID=vpwrDcPowerMgt, vpwrDcPowerSystem=vpwrDcPowerSystem, vpwrIdentName=vpwrIdentName, vpwrBayctrlOperStatus=vpwrBayctrlOperStatus, vpwrTrapModuleRemoved=vpwrTrapModuleRemoved, vpwrDcPowerIoModule=vpwrDcPowerIoModule, vpwrRectifierFVSetpoint=vpwrRectifierFVSetpoint, vpwrAlarmIndex=vpwrAlarmIndex, vpwrRectAlarmBoostFail=vpwrRectAlarmBoostFail, vpwrRingerAlarmBOverTemp=vpwrRingerAlarmBOverTemp, vpwrSystemInternalTempUThreshold=vpwrSystemInternalTempUThreshold, vpwrModuleIdentTable=vpwrModuleIdentTable, vpwrTrapACFAlarm=vpwrTrapACFAlarm, vpwrSystemBDAlarmSetpoint=vpwrSystemBDAlarmSetpoint, vpwrTrapBatteryTempAlarmCleared=vpwrTrapBatteryTempAlarmCleared, vpwrTrapCfgChange=vpwrTrapCfgChange, sysAlarmSeverity=sysAlarmSeverity, vpwrLvdTestGroup=vpwrLvdTestGroup, vpwrBatteryTempUThreshold=vpwrBatteryTempUThreshold, PositiveInteger=PositiveInteger, vpwrTrapThermalCompActive=vpwrTrapThermalCompActive, vpwrTrapsMsgString=vpwrTrapsMsgString, vpwrSystemType=vpwrSystemType, sysAuxAlarmConfigEntry=sysAuxAlarmConfigEntry, vpwrRingerParameterFrequency=vpwrRingerParameterFrequency, vpwrRectAlarmHVSD=vpwrRectAlarmHVSD, batteryTempCompLowSlope=batteryTempCompLowSlope, vpwrDcPowerMgt=vpwrDcPowerMgt, vpwrTrapHVSDAlarm=vpwrTrapHVSDAlarm, vpwrLvdContactorReconnectDelayTimer=vpwrLvdContactorReconnectDelayTimer, vpwrSystemTempCompStopVoltage=vpwrSystemTempCompStopVoltage, vpwrBayctrlCapacity=vpwrBayctrlCapacity, vpwrDcDcConverterConfigGroup=vpwrDcDcConverterConfigGroup, vpwrDcPowerTraps=vpwrDcPowerTraps, vpwrDcPowerDcDcConverter=vpwrDcPowerDcDcConverter, vpwrBDTClearAlarm=vpwrBDTClearAlarm, vpwrBoostOperState=vpwrBoostOperState, vpwrBatteryTempGroup=vpwrBatteryTempGroup, vpwrPanelIdentTable=vpwrPanelIdentTable, vpwrPanelModuleCurrent=vpwrPanelModuleCurrent, vpwrTrapCommunityString=vpwrTrapCommunityString, vpwrTrapLoginSuccess=vpwrTrapLoginSuccess, thermalProbeEntry=thermalProbeEntry, vpwrTrapSwDownloadAndReboot=vpwrTrapSwDownloadAndReboot, vpwrTrapBatteryTempAlarmSet=vpwrTrapBatteryTempAlarmSet, sysRelayConfigEntry=sysRelayConfigEntry, vpwrTrapBDAlarm=vpwrTrapBDAlarm, vpwrRectifierTestGroup=vpwrRectifierTestGroup, batteryTempCompLowStartTemperature=batteryTempCompLowStartTemperature, batteryTempCompSenseSource=batteryTempCompSenseSource, vpwrBoostDuration=vpwrBoostDuration, NonNegativeInteger=NonNegativeInteger, vpwrPanelBayIndex=vpwrPanelBayIndex, vpwrSystemHVAlarmSetpoint=vpwrSystemHVAlarmSetpoint, vpwrSystemInternalTempLThreshold=vpwrSystemInternalTempLThreshold, vpwrTrapClearEventHistory=vpwrTrapClearEventHistory, vpwrPanelModuleFwVersion=vpwrPanelModuleFwVersion, vpwrRingerTestGroup=vpwrRingerTestGroup, vpwrTrapSystemOK=vpwrTrapSystemOK, vpwrBatteryBoostGroup=vpwrBatteryBoostGroup, thermalProbeTable=thermalProbeTable, vpwrRectifierCurrentLimit=vpwrRectifierCurrentLimit, vpwrLvdReconnectDelayTimer=vpwrLvdReconnectDelayTimer, vpwrTrapMultipleModuleFailAlarm=vpwrTrapMultipleModuleFailAlarm, vpwrModuleCurrent=vpwrModuleCurrent, vpwrBatteryTempEntry=vpwrBatteryTempEntry, vpwrTrapRingerAAlarm=vpwrTrapRingerAAlarm, vpwrTrapSingleRingerAlarm=vpwrTrapSingleRingerAlarm, batteryTempCompRunawayState=batteryTempCompRunawayState, vpwrModuleOperHours=vpwrModuleOperHours, sysRelayConfigTable=sysRelayConfigTable, vpwrPanelModuleOperHours=vpwrPanelModuleOperHours, vpwrSystemCurrent=vpwrSystemCurrent, vpwrSystemIdentTable=vpwrSystemIdentTable, vpwrTrapDistributionCommAlarm=vpwrTrapDistributionCommAlarm, vpwrModuleIdentEntry=vpwrModuleIdentEntry, vpwrLvdContactorReconnectSetpoint=vpwrLvdContactorReconnectSetpoint)
mibBuilder.exportSymbols("VALERE-DC-POWER-MIB", vpwrPanelModuleIndex=vpwrPanelModuleIndex, vpwrRingerParameterEntry=vpwrRingerParameterEntry, vpwrTrapModuleInserted=vpwrTrapModuleInserted, vpwrTrapSystemRedundancyAlarm=vpwrTrapSystemRedundancyAlarm, vpwrModuleFwVersion=vpwrModuleFwVersion, vpwrRingerAlarmAOTemp=vpwrRingerAlarmAOTemp, vpwrPanelModuleOID=vpwrPanelModuleOID, vpwrTrapCriticality=vpwrTrapCriticality, vpwrBatteryDischargeTestGroup=vpwrBatteryDischargeTestGroup, vpwrSystemIdentEntry=vpwrSystemIdentEntry, vpwrTrapEventTimeStamp=vpwrTrapEventTimeStamp, vpwrSystemBayctrlIdentGroup=vpwrSystemBayctrlIdentGroup, vpwrTrapAuxAlarm=vpwrTrapAuxAlarm, vpwrTrapSystemAlive=vpwrTrapSystemAlive, batteryTempCompHighSlope=batteryTempCompHighSlope, vpwrTrapRingerCommAlarm=vpwrTrapRingerCommAlarm, vpwrRingerParameterAdminState=vpwrRingerParameterAdminState, sysRelayCustomName=sysRelayCustomName, vpwrAlarmDescr=vpwrAlarmDescr, sysAuxAlarmCustomName=sysAuxAlarmCustomName, vpwrRingerParameterDcVoltage=vpwrRingerParameterDcVoltage, vpwrBayIndex=vpwrBayIndex, vpwrTrapIllegalConfigSubmit=vpwrTrapIllegalConfigSubmit, batteryTempCompHighStopVoltage=batteryTempCompHighStopVoltage, vpwrLvdConfigGroup=vpwrLvdConfigGroup, vpwrTrapLoginFail=vpwrTrapLoginFail, vpwrRectAlarmIShare=vpwrRectAlarmIShare, vpwrRectAlarmDCEnable=vpwrRectAlarmDCEnable, vpwrBatteryTempIndex=vpwrBatteryTempIndex, sysAuxAlarmIndex=sysAuxAlarmIndex, sysAuxAlarmSeverity=sysAuxAlarmSeverity, vpwrBatteryTemp=vpwrBatteryTemp, vpwrTrapMultipleConvFailAlarm=vpwrTrapMultipleConvFailAlarm, vpwrDcPowerTrapsMsgString=vpwrDcPowerTrapsMsgString, vpwrBayctrlCurrent=vpwrBayctrlCurrent, vpwrRingerAlarmAOCurrent=vpwrRingerAlarmAOCurrent, vpwrPanelModuleModelNumber=vpwrPanelModuleModelNumber, vpwrBayctrlSerialNumber=vpwrBayctrlSerialNumber, vpwrBayctrlIndex=vpwrBayctrlIndex, vpwrTrapConverterAlarm=vpwrTrapConverterAlarm, vpwrSystemControllerState=vpwrSystemControllerState, vpwrSystemThermalSenseType=vpwrSystemThermalSenseType)
