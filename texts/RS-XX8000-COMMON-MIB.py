...
mibBuilder.exportSymbols("RS-XX8000-COMMON-MIB", LogbookMaxEntryNumber=LogbookMaxEntryNumber, ntpServerAddrTable=ntpServerAddrTable, LogbookEntryMessagesExcDVB=LogbookEntryMessagesExcDVB, LogbookEntrySlope=LogbookEntrySlope, ProdInfoModuleNameTv=ProdInfoModuleNameTv, ProdInfoModuleNameFm=ProdInfoModuleNameFm, identNumberHW=identNumberHW, rsXx8000EventsV2=rsXx8000EventsV2, groupNTP=groupNTP, groupSnmpConfig=groupSnmpConfig, SwitchOnOff=SwitchOnOff, rsTrapsAllOff=rsTrapsAllOff, groupTransmitterConfig=groupTransmitterConfig, Trigger=Trigger, trapSinkInformUnacknowledged=trapSinkInformUnacknowledged, productInformation=productInformation, ntpSyncFailed=ntpSyncFailed, groupProductInformation=groupProductInformation, eventTxName=eventTxName, eventTxMask=eventTxMask, eventHistoryTx=eventHistoryTx, EventMask=EventMask, rsTrapsAllOn=rsTrapsAllOn, EventClass=EventClass, eventTxPriority=eventTxPriority, eventHistoryEvent=eventHistoryEvent, eventsTxEntry=eventsTxEntry, TimeOfDay=TimeOfDay, trapSinkPort=trapSinkPort, identNumberSW=identNumberSW, rsXx8000Common=rsXx8000Common, FailDelayMode=FailDelayMode, ProdInfoModuleNameNsu=ProdInfoModuleNameNsu, swUpdateMode=swUpdateMode, trapSinkInformRetry=trapSinkInformRetry, rsXx8000CommonGroups=rsXx8000CommonGroups, rsXx8000CommonObjs=rsXx8000CommonObjs, LogbookEntryMessagesExcFM=LogbookEntryMessagesExcFM, LogbookEntryMessagesXV703=LogbookEntryMessagesXV703, LogbookEntryMessagesNSU=LogbookEntryMessagesNSU, groupSwMaintenance=groupSwMaintenance, indexProgram=indexProgram, IndexProgram=IndexProgram, eventsTxTable=eventsTxTable, FailDelayStatus=FailDelayStatus, eventHistoryEventState=eventHistoryEventState, swUpdateDeviceName=swUpdateDeviceName, snmpConfig=snmpConfig, rsTrapsAllFaultsOff=rsTrapsAllFaultsOff, IndexRack=IndexRack, indexAB=indexAB, EqualizerCalibrationState=EqualizerCalibrationState, indexRack=indexRack, rsXx8000CommonConf=rsXx8000CommonConf, swUpdateStarted=swUpdateStarted, eventHistory=eventHistory, TvStandard=TvStandard, groupEventObjects=groupEventObjects, trapSinkEntry=trapSinkEntry, testTrap=testTrap, groupEventTest=groupEventTest, ntpState=ntpState, counterEvents=counterEvents, Sx801AmplifierState=Sx801AmplifierState, LogbookEntryMessagesExcATV=LogbookEntryMessagesExcATV, trapSinkInformTimeout=trapSinkInformTimeout, swUpdateDeviceGroup=swUpdateDeviceGroup, InputSource=InputSource, groupNotifyTest=groupNotifyTest, restart=restart, LogbookEntryMessagesNetCCU=LogbookEntryMessagesNetCCU, rsXx8000CommonEvents=rsXx8000CommonEvents, IndexAmplifier=IndexAmplifier, ReadableString=ReadableString, ntpLastSync=ntpLastSync, eventsTxV2=eventsTxV2, groupEventHistory=groupEventHistory, rsTrapsAllWarningsOn=rsTrapsAllWarningsOn, eventHistoryNumber=eventHistoryNumber, EventMaxEntryNumber=EventMaxEntryNumber, eventHistoryEventDate=eventHistoryEventDate, swUpdateStart=swUpdateStart, irtTrapsAllOn=irtTrapsAllOn, ntpMode=ntpMode, ntpServerAddrIdx=ntpServerAddrIdx, trapSinkTable=trapSinkTable, swMaintenance=swMaintenance, eventAlarmPriority=eventAlarmPriority, LogbookEntryMessagesOST=LogbookEntryMessagesOST, eventTx=eventTx, irtTrapsAllOff=irtTrapsAllOff, eventMapObjects=eventMapObjects, dateTime=dateTime, ntpServerAddress=ntpServerAddress, versionNumberHW=versionNumberHW, groupObsoletedObjects=groupObsoletedObjects, eventAlarmClass=eventAlarmClass, groupNotify=groupNotify, IndexAB=IndexAB, LogbookEntryMessagesExcTv=LogbookEntryMessagesExcTv, eventEvent=eventEvent, sendTestTrap=sendTestTrap, ntpSyncTimeInterval=ntpSyncTimeInterval, swUpdate=swUpdate, ntp=ntp, indexAmplifier=indexAmplifier, rsXx8000MibModule=rsXx8000MibModule, xx8000BasicCompliance=xx8000BasicCompliance, IndexTransmitter=IndexTransmitter, AtvStandard=AtvStandard, versionNumberSW=versionNumberSW, trapSinkVersion=trapSinkVersion, trapSinkUse=trapSinkUse, EventPriority=EventPriority, eventHistoryTable=eventHistoryTable, trapSinkNumber=trapSinkNumber, eventHistoryEntry=eventHistoryEntry, rsXx8000=rsXx8000, ntpServerAddrEntry=ntpServerAddrEntry, trapSinkAddress=trapSinkAddress, transmitterConfig=transmitterConfig, LockState=LockState, serialNumber=serialNumber, eventHistoryModule=eventHistoryModule, PYSNMP_MODULE_ID=rsXx8000MibModule, trapSinkCommunity=trapSinkCommunity, EventState=EventState, eventTxEvent=eventTxEvent, indexTransmitter=indexTransmitter, rsTrapsAllWarningsOff=rsTrapsAllWarningsOff, eventTxNameIdx=eventTxNameIdx, groupNotifyNTP=groupNotifyNTP, rsTrapsAllFaultsOn=rsTrapsAllFaultsOn, FloatingPoint=FloatingPoint, rsXx8000CommonCompls=rsXx8000CommonCompls)
