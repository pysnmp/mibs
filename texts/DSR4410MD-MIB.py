...
mibBuilder.exportSymbols("DSR4410MD-MIB", port1Polarity=port1Polarity, ethernet10_100=ethernet10_100, audio1LeftLanguageStatus=audio1LeftLanguageStatus, alarmTest=alarmTest, signalPower=signalPower, source=source, dvbS2symbolRate=dvbS2symbolRate, satelliteName=satelliteName, polarization=polarization, alarmConditionLED=alarmConditionLED, mode=mode, codeDownload=codeDownload, unitAddress=unitAddress, identMIBVersion=identMIBVersion, videoOutput625Lines=videoOutput625Lines, acpProgram=acpProgram, lostlockcount=lostlockcount, acpUnitAddress=acpUnitAddress, accessControl=accessControl, videoPID=videoPID, caMsgCount=caMsgCount, fecRate=fecRate, gigEipAddress=gigEipAddress, gigEgateway=gigEgateway, field=field, audio1DownMix=audio1DownMix, screenDisplay=screenDisplay, port2=port2, contrast=contrast, ledStatus=ledStatus, patMsgCount=patMsgCount, diagnosticScreen=diagnosticScreen, channelStatus=channelStatus, freq=freq, alarms=alarms, dataMib=dataMib, audio2Config=audio2Config, symbolRate=symbolRate, acpKeyStream=acpKeyStream, firmware=firmware, virtualChannelMsgCount=virtualChannelMsgCount, port2Satellite=port2Satellite, audio1TestPattern=audio1TestPattern, codeDownloadBit=codeDownloadBit, identUnitModel=identUnitModel, bootVersion=bootVersion, channelNumber=channelNumber, retuneMsgCnt=retuneMsgCnt, subnetMask=subnetMask, ber=ber, ebno=ebno, evenBlkoutMsgCount=evenBlkoutMsgCount, upgradeFirmwareVersion=upgradeFirmwareVersion, satelliteStatus=satelliteStatus, subtitleLanguageStatus=subtitleLanguageStatus, rfPortsMib=rfPortsMib, transponderNumber=transponderNumber, macAddr=macAddr, mpegServiceNumber=mpegServiceNumber, port2SetupMode=port2SetupMode, org=org, audio2TestPattern=audio2TestPattern, dvbCodeRate=dvbCodeRate, subtitleDisplay=subtitleDisplay, irdStatus=irdStatus, gigEmacAddr=gigEmacAddr, tvPasscard=tvPasscard, formatRate=formatRate, acpMib=acpMib, port1SetupMode=port1SetupMode, diagnosticMib=diagnosticMib, symbolCodeBit=symbolCodeBit, ethernetGigE=ethernetGigE, statusMib=statusMib, networkTextMsgCount=networkTextMsgCount, clearCounters=clearCounters, retuneMsgStatistic=retuneMsgStatistic, secondaryAudioPID=secondaryAudioPID, niMsgCount=niMsgCount, audio1RightGain=audio1RightGain, subtitleMsgCount=subtitleMsgCount, ethernetIP=ethernetIP, unitControl=unitControl, resetIRD=resetIRD, acpMode=acpMode, audio1Config=audio1Config, subtitleLanguage=subtitleLanguage, audio1RightLanguage=audio1RightLanguage, extHardwareMib=extHardwareMib, port1Satellite=port1Satellite, rf=rf, textSetup=textSetup, primaryAudioPID=primaryAudioPID, audio1DiagNorm=audio1DiagNorm, transponder=transponder, asiEnable=asiEnable, serviceNumber=serviceNumber, dwnldPreMsgCount=dwnldPreMsgCount, videoMib=videoMib, audio=audio, falseLock=falseLock, audio1LeftLanguage=audio1LeftLanguage, internet=internet, encryptionMode=encryptionMode, muxStatus=muxStatus, secondaryAudioLock=secondaryAudioLock, waveform=waveform, dsr=dsr, audio2LeftGain=audio2LeftGain, dvbSymbolRate=dvbSymbolRate, cueToneSignal=cueToneSignal, alarmLedStatus=alarmLedStatus, acpAuthState=acpAuthState, audioConfig=audioConfig, audioMib=audioMib, giMIB=giMIB, videoLock=videoLock, psk8SymbolRate=psk8SymbolRate, snr=snr, giproducts=giproducts, audio2LeftLanguage=audio2LeftLanguage, defaultGateway=defaultGateway, lnbPower=lnbPower, authorizedLED=authorizedLED, testMib=testMib, dwnldMsgCount=dwnldMsgCount, alarmTrigger=alarmTrigger, audio1Compression=audio1Compression, audio2Output=audio2Output, manualTune=manualTune, unitAddr=unitAddr, rserror=rserror, channelMib=channelMib, audio2DiagNorm=audio2DiagNorm, gigEmode=gigEmode, downloadLED=downloadLED, port2Polarity=port2Polarity, channelNum=channelNum, uimMsgCount=uimMsgCount, audioOutput=audioOutput, authorizationState=authorizationState, pmtMsgCount=pmtMsgCount, fingerPrintMessageCount=fingerPrintMessageCount, fpgaVersion=fpgaVersion, falseLockStatus=falseLockStatus, channelSelect=channelSelect, aspectRatioInput=aspectRatioInput, modulationMode=modulationMode, retuneMonitorEnable=retuneMonitorEnable, coMsgCount=coMsgCount, audio1RightLanguageStatus=audio1RightLanguageStatus, serviceSelectionMib=serviceSelectionMib, gigEsubnetMask=gigEsubnetMask, mptsPort=mptsPort, ebNo=ebNo, signalStatus=signalStatus, aspectRatioOutput=aspectRatioOutput, retuneMsgVirtNetworkIDindex=retuneMsgVirtNetworkIDindex, audio2DownMix=audio2DownMix, audio2Compression=audio2Compression, acquisitionState=acquisitionState, primaryAudioLock=primaryAudioLock, frequencyOffset=frequencyOffset, line=line, acpEncryptMode=acpEncryptMode, dvbS2codeRate=dvbS2codeRate, activePort=activePort, testSignals=testSignals, retuneMsgVirtChannel=retuneMsgVirtChannel, PYSNMP_MODULE_ID=dsr, audio2RightLanguageStatus=audio2RightLanguageStatus, frequency=frequency, alarmLEDBlinkStatus=alarmLEDBlinkStatus, clearrserror=clearrserror, audio2GainControl=audio2GainControl, audio1LeftGain=audio1LeftGain, mptsIpAddr=mptsIpAddr, psk8CodeRate=psk8CodeRate, vctIDFast=vctIDFast, dataStatus=dataStatus, unitControlMib=unitControlMib, videoOutput525Lines=videoOutput525Lines, vits=vits, audio2RightGain=audio2RightGain, audio2LeftLanguageStatus=audio2LeftLanguageStatus, videoTestPattern=videoTestPattern, ipAddress=ipAddress, messages=messages, dod=dod, emmMsgCount=emmMsgCount, rfPortsSetup=rfPortsSetup, identificationGroup=identificationGroup, signalQuality=signalQuality, clearlostlockcount=clearlostlockcount, hcmMsgCount=hcmMsgCount, vctID=vctID, audio1GainControl=audio1GainControl, private=private, audio2RightLanguage=audio2RightLanguage, port1=port1, retuneMsgCRC=retuneMsgCRC, retuneMonitorMIB=retuneMonitorMIB, audio1Output=audio1Output, retuneMsgVCTid=retuneMsgVCTid, signalLED=signalLED, enterprises=enterprises, video=video, xpndrNumber=xpndrNumber, retuneMsgActivationTime=retuneMsgActivationTime, acpIndex=acpIndex, firmwareVersion=firmwareVersion)
