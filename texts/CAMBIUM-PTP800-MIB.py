...
Unsigned32, NotificationType, enterprises, Counter64, iso, Gauge32, MibIdentifier, IpAddress, NotificationType, Counter32, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "enterprises", "Counter64", "iso", "Gauge32", "MibIdentifier", "IpAddress", "NotificationType", "Counter32", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", dataPortStatus=dataPortStatus, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rFUStatusTrap=rFUStatusTrap, userTableIndex=userTableIndex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortDisabledWarning=dataPortDisabledWarning, rFUTxPowerAlarm=rFUTxPowerAlarm, userPassword=userPassword, primaryRecoveryPeriod=primaryRecoveryPeriod, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, transmitCodeRate=transmitCodeRate, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, transmitCapacity=transmitCapacity, protectionAvailabilityStatus=protectionAvailabilityStatus, softwareVersion=softwareVersion, sMTPEmailAlert=sMTPEmailAlert, managementPortForcedConfiguration=managementPortForcedConfiguration, subnetMask=subnetMask, neighborMACAddress=neighborMACAddress, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, configuration=configuration, syslogClient=syslogClient, hTTPSPortNumber=hTTPSPortNumber, protectionStats=protectionStats, rFUTxPowerMin=rFUTxPowerMin, remoteInternetAddress=remoteInternetAddress, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, radioLicenseMinModulation=radioLicenseMinModulation, iPDSCPPriorityTable=iPDSCPPriorityTable, bootVersion=bootVersion, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFULockoutAlarm=rFULockoutAlarm, rFUVersionBank2=rFUVersionBank2, remoteInternetAddressType=remoteInternetAddressType, fiberY=fiberY, radioLicenseBandwidth=radioLicenseBandwidth, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, sNMPTrapVersion=sNMPTrapVersion, sntp=sntp, sNTPPollInterval=sNTPPollInterval, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rFUTxFreqMax=rFUTxFreqMax, telnetPortNumber=telnetPortNumber, licence=licence, tFTPServerInternetAddressType=tFTPServerInternetAddressType, minModulation=minModulation, daylightSaving=daylightSaving, rFUCableAlarm=rFUCableAlarm, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, managementPortConfigurationMismatch=managementPortConfigurationMismatch, hTTPPortNumber=hTTPPortNumber, siteName=siteName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rFUProtectionCompatibility=rFUProtectionCompatibility, rFFeederLoss=rFFeederLoss, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, faultProtectionSwitching=faultProtectionSwitching, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, iPv6Address=iPv6Address, remoteSecondaryIPAddress=remoteSecondaryIPAddress, receivePower=receivePower, managementPortWirelessDownAlert=managementPortWirelessDownAlert, protectionState=protectionState, dataPortConfigurationMismatch=dataPortConfigurationMismatch, protectionInterfaceStatus=protectionInterfaceStatus, sNTPServerResponse=sNTPServerResponse, phyControl=phyControl, minCodeRate=minCodeRate, userName=userName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, radioLicenseBand=radioLicenseBand, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, managementCommittedInformationRate=managementCommittedInformationRate, transmitDataRate=transmitDataRate, rFUActiveFirmwareBank=rFUActiveFirmwareBank, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, radioLicenseCodeRate=radioLicenseCodeRate, rFURfBand=rFURfBand, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, transmitterStatus=transmitterStatus, userTableNumber=userTableNumber, neighborInternetAddress=neighborInternetAddress, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, longitude=longitude, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, linkLoss=linkLoss, radioLicenseRegion=radioLicenseRegion, userTableEntry=userTableEntry, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, localPacketFiltering=localPacketFiltering, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, phyStatus=phyStatus, activeUnit=activeUnit, hTTPAccessEnabled=hTTPAccessEnabled, altitude=altitude, management=management, remoteSecondaryMACAddress=remoteSecondaryMACAddress, tFTPServerIPAddress=tFTPServerIPAddress, versions=versions, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, rFURFSwitchAlarm=rFURFSwitchAlarm, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerInternetAddressType=sNTPServerInternetAddressType, receiveModulation=receiveModulation, sNTPServerTable=sNTPServerTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, radioLicenseMaxEIRP=radioLicenseMaxEIRP, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rFURxFreqMin=rFURxFreqMin, aAAControl=aAAControl, protectionSwitchCause=protectionSwitchCause, remoteMACAddress=remoteMACAddress, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, snmpControl=snmpControl, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, managementMode=managementMode, systemReset=systemReset, reset=reset, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, protection=protection, rFUPowerButtonPressed=rFUPowerButtonPressed, linkNameMismatchTrap=linkNameMismatchTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rFUTxMuteStatus=rFUTxMuteStatus, rFURxFreqMax=rFURxFreqMax, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rFUVersionBank1=rFUVersionBank1, ethernetPriorityTable=ethernetPriorityTable, neighborIPAddress=neighborIPAddress, receiveDataRate=receiveDataRate, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, radioLicenseRxFreq=radioLicenseRxFreq, transmitCapacityLimitDetail=transmitCapacityLimitDetail, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPSyncTrap=sNTPSyncTrap, dataPortPauseFrames=dataPortPauseFrames, diverseAntennaGain=diverseAntennaGain, managementPortStatusTrap=managementPortStatusTrap, vectorError=vectorError, remoteIPAddress=remoteIPAddress, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUFreqSpacing=rFUFreqSpacing, rfu=rfu, remotePrimaryIPAddress=remotePrimaryIPAddress, alignmentMode=alignmentMode, timeZone=timeZone, tFTPServerPortNumber=tFTPServerPortNumber, sNTPPrimaryServer=sNTPPrimaryServer, userEnabled=userEnabled, remotePrimaryMACAddress=remotePrimaryMACAddress, sNMPEnabledTraps=sNMPEnabledTraps, ptmp=ptmp, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, maxModulation=maxModulation, protectionStatus=protectionStatus, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, sMTPServerPortNumber=sMTPServerPortNumber, iPv6PrefixLength=iPv6PrefixLength, sNTPLastSync=sNTPLastSync, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sMTPServerIPAddress=sMTPServerIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitPower=transmitPower, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, syslogClientTrap=syslogClientTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rFUPlatformCompatibility=rFUPlatformCompatibility, syslogState=syslogState, iPVersion=iPVersion, protectionConfigurationStatus=protectionConfigurationStatus, numberOfAntennas=numberOfAntennas, ethernetPriorityTableNumber=ethernetPriorityTableNumber, radioLicenseTxFreq=radioLicenseTxFreq, iFCableLength=iFCableLength, sNTPServerTimeout=sNTPServerTimeout, rFUTxBandAboveRx=rFUTxBandAboveRx, neighborInternetAddressType=neighborInternetAddressType, sNTPServerTableEntry=sNTPServerTableEntry, rxDiversityVid=rxDiversityVid, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, productVariant=productVariant, bridge=bridge, dataPortWirelessDownAlert=dataPortWirelessDownAlert, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, ethernet=ethernet, encryptionAlgorithm=encryptionAlgorithm, ptpTraps=ptpTraps, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, maximumTransmitPower=maximumTransmitPower, aTPCEnable=aTPCEnable, secureModeAlarm=secureModeAlarm, enableTransmission=enableTransmission, maxCodeRate=maxCodeRate, cambium=cambium, endId=endId, rFUBranchingConfiguration=rFUBranchingConfiguration, unitOutOfCalibration=unitOutOfCalibration, tFTPServerInternetAddress=tFTPServerInternetAddress, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, activeAvailableTime=activeAvailableTime, systemClock=systemClock, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, remotePrimaryInternetAddress=remotePrimaryInternetAddress, sNTPServerTableIndex=sNTPServerTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptp800=ptp800, rFUType=rFUType, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, ptpTrapPrefix=ptpTrapPrefix, secureModeAlarmTrap=secureModeAlarmTrap, sNMPPortNumber=sNMPPortNumber, protectionConfig=protectionConfig, vLANManagementPriority=vLANManagementPriority, sNTPServerRetries=sNTPServerRetries, secondarySoftwareVersion=secondarySoftwareVersion, ptp=ptp, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transmitCapacityLimit=transmitCapacityLimit, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rFUStatus=rFUStatus, diverseRfFeederLoss=diverseRfFeederLoss, vLANManagementVID=vLANManagementVID, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPSync=sNTPSync, rxDiversityVlanTpid=rxDiversityVlanTpid, radioLicenseMaxModulation=radioLicenseMaxModulation, protectionStateTrap=protectionStateTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, radioLicenseIdentifier=radioLicenseIdentifier)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", telnetAccessEnabled=telnetAccessEnabled, smtp=smtp, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, managementPortAutoNegotiation=managementPortAutoNegotiation, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, linkNameMismatch=linkNameMismatch, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapTable=sNMPTrapTable, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, rFUSerial=rFUSerial, vLANManagementVIDValidation=vLANManagementVIDValidation, radioLicenseModulation=radioLicenseModulation, sNTPState=sNTPState, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, wirelessLinkStatus=wirelessLinkStatus, linkName=linkName, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, wirelessLinkAvailability=wirelessLinkAvailability, hardwareVersion=hardwareVersion, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sNTPServerIPAddress=sNTPServerIPAddress, rFUTxPowerMax=rFUTxPowerMax, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, primaryRecovery=primaryRecovery, encryption=encryption, iPv6GatewayAddress=iPv6GatewayAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, managementPortDisabledWarning=managementPortDisabledWarning, qOSPriorityScheme=qOSPriorityScheme, sNTPServerPortNumber=sNTPServerPortNumber, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, primarySecondaryMode=primarySecondaryMode, syslogControl=syslogControl, syslogStateTrap=syslogStateTrap, rFUConnectedPlatform=rFUConnectedPlatform, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, alarms=alarms, latitude=latitude, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, supplementary=supplementary, l2CPPriorityTable=l2CPPriorityTable, managementPortStatus=managementPortStatus, sNTPServerTableNumber=sNTPServerTableNumber, userRole=userRole, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, dSCPManagementPriority=dSCPManagementPriority, transmitModulation=transmitModulation, requestedProtectionState=requestedProtectionState, rFUTransceiverLocation=rFUTransceiverLocation, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, radioLicense=radioLicense, gatewayIPAddress=gatewayIPAddress, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, alignmentModeTrap=alignmentModeTrap, rFUPowerAlarm=rFUPowerAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortFiberStatus=dataPortFiberStatus, sNMPCommunityString=sNMPCommunityString, sMTPServerInternetAddressType=sMTPServerInternetAddressType, mPLSTCPriorityTable=mPLSTCPriorityTable, antennaGain=antennaGain, encryptionEnabledMismatch=encryptionEnabledMismatch, userTable=userTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, pubStats=pubStats, iPv4Address=iPv4Address, sMTPEnabledMessages=sMTPEnabledMessages, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rFURpsAlarm=rFURpsAlarm, securityLevel=securityLevel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, productName=productName, rFUTxFreqMin=rFUTxFreqMin, receiveCodeRate=receiveCodeRate, aggregateDataRate=aggregateDataRate, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm)
