...
Bits, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, ObjectIdentity, Counter64, Integer32, iso, NotificationType, Gauge32, TimeTicks, Counter32, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "ObjectIdentity", "Counter64", "Integer32", "iso", "NotificationType", "Gauge32", "TimeTicks", "Counter32", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, configuration=configuration, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, rxDiversityVlanTpid=rxDiversityVlanTpid, protectionAvailabilityStatus=protectionAvailabilityStatus, alignmentMode=alignmentMode, rFURfBand=rFURfBand, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, qOSPriorityScheme=qOSPriorityScheme, alignmentModeTrap=alignmentModeTrap, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rFUType=rFUType, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, endId=endId, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, remoteInternetAddress=remoteInternetAddress, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, productName=productName, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rFUFreqSpacing=rFUFreqSpacing, subnetMask=subnetMask, rFUActiveFirmwareBank=rFUActiveFirmwareBank, userTableIndex=userTableIndex, rFFeederLoss=rFFeederLoss, remotePrimaryInternetAddress=remotePrimaryInternetAddress, radioLicense=radioLicense, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortConfigurationMismatch=dataPortConfigurationMismatch, timeZone=timeZone, softwareVersion=softwareVersion, managementPortAutoNegotiation=managementPortAutoNegotiation, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, aTPCEnable=aTPCEnable, sMTPServerInternetAddress=sMTPServerInternetAddress, siteName=siteName, wirelessLinkAvailability=wirelessLinkAvailability, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPSync=sNTPSync, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, encryptionAlgorithm=encryptionAlgorithm, rxDiversityVid=rxDiversityVid, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPLastSync=sNTPLastSync, ptp800=ptp800, rFULockoutAlarm=rFULockoutAlarm, diverseAntennaGain=diverseAntennaGain, sNTPServerPortNumber=sNTPServerPortNumber, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, unitOutOfCalibration=unitOutOfCalibration, hTTPPortNumber=hTTPPortNumber, iPv6Address=iPv6Address, sNTPSyncTrap=sNTPSyncTrap, iPv6PrefixLength=iPv6PrefixLength, sNTPPrimaryServer=sNTPPrimaryServer, activeAvailableTime=activeAvailableTime, iPDSCPPriorityTable=iPDSCPPriorityTable, hTTPAccessEnabled=hTTPAccessEnabled, phyControl=phyControl, tFTPServerIPAddress=tFTPServerIPAddress, alarms=alarms, protection=protection, rFUPlatformCompatibility=rFUPlatformCompatibility, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rFUTxMuteStatus=rFUTxMuteStatus, primarySecondaryMode=primarySecondaryMode, encryptionEnabledMismatch=encryptionEnabledMismatch, receiveDataRate=receiveDataRate, receiveCodeRate=receiveCodeRate, radioLicenseMaxModulation=radioLicenseMaxModulation, iPv6GatewayAddress=iPv6GatewayAddress, userName=userName, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, sNTPServerIPAddress=sNTPServerIPAddress, versions=versions, remoteSecondaryMACAddress=remoteSecondaryMACAddress, linkName=linkName, receiveModulation=receiveModulation, remoteMACAddress=remoteMACAddress, hTTPSPortNumber=hTTPSPortNumber, secureModeAlarm=secureModeAlarm, rFUTransceiverLocation=rFUTransceiverLocation, rFUTxPowerAlarm=rFUTxPowerAlarm, tFTPServerInternetAddressType=tFTPServerInternetAddressType, linkNameMismatch=linkNameMismatch, ptpTrapPrefix=ptpTrapPrefix, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortFiberStatus=dataPortFiberStatus, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, sNTPServerTable=sNTPServerTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, radioLicenseTxFreq=radioLicenseTxFreq, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, transmitCodeRate=transmitCodeRate, rFURxFreqMin=rFURxFreqMin, dataPortDisabledWarning=dataPortDisabledWarning, protectionConfig=protectionConfig, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, managementPortStatus=managementPortStatus, ptpTraps=ptpTraps, altitude=altitude, activeWirelessLinkAvailability=activeWirelessLinkAvailability, l2CPPriorityTable=l2CPPriorityTable, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, diverseRfFeederLoss=diverseRfFeederLoss, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, dataPortFiberStatusTrap=dataPortFiberStatusTrap, protectionStatus=protectionStatus, protectionConfigurationStatus=protectionConfigurationStatus, phyStatus=phyStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, linkLoss=linkLoss, linkNameMismatchTrap=linkNameMismatchTrap, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, syslogControl=syslogControl, radioLicenseBand=radioLicenseBand, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, transmitDataRate=transmitDataRate, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, wirelessLinkStatus=wirelessLinkStatus, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, protectionStats=protectionStats, sNTPServerInternetAddress=sNTPServerInternetAddress, remoteInternetAddressType=remoteInternetAddressType, sNMPEnabledTraps=sNMPEnabledTraps, fiberY=fiberY, enableTransmission=enableTransmission, hardwareVersion=hardwareVersion, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, protectionInterfaceStatus=protectionInterfaceStatus, ethernet=ethernet, sNTPServerInternetAddressType=sNTPServerInternetAddressType, vLANManagementVID=vLANManagementVID, protectionSwitchCause=protectionSwitchCause, sNMPCommunityString=sNMPCommunityString, bridge=bridge, transmitterStatus=transmitterStatus, userTableEntry=userTableEntry, sNTPServerResponse=sNTPServerResponse, rFURxFreqMax=rFURxFreqMax, neighborIPAddress=neighborIPAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, longitude=longitude, maximumTransmitPower=maximumTransmitPower, protectionState=protectionState, radioLicenseBandwidth=radioLicenseBandwidth, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFUCableAlarm=rFUCableAlarm, maxCodeRate=maxCodeRate, syslogClient=syslogClient, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, remotePrimarySecondaryMode=remotePrimarySecondaryMode, sNTPServerTimeout=sNTPServerTimeout, radioLicenseRxFreq=radioLicenseRxFreq, radioLicenseModulation=radioLicenseModulation, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ptmp=ptmp, radioLicenseMinCodeRate=radioLicenseMinCodeRate, requestedProtectionState=requestedProtectionState, faultProtectionSwitching=faultProtectionSwitching, managementPortDisabledWarning=managementPortDisabledWarning, transmitModulation=transmitModulation, systemReset=systemReset, sNMPTrapTable=sNMPTrapTable, encryption=encryption, sNTPServerTableNumber=sNTPServerTableNumber, remotePrimaryIPAddress=remotePrimaryIPAddress, transmitCapacity=transmitCapacity, sMTPServerPortNumber=sMTPServerPortNumber, remotePrimaryMACAddress=remotePrimaryMACAddress, reset=reset, rxDiversityDataPortStatus=rxDiversityDataPortStatus, management=management, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, ethernetFiberSupport=ethernetFiberSupport, sMTPServerInternetAddressType=sMTPServerInternetAddressType, productVariant=productVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteSecondaryIPAddress=remoteSecondaryIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rFURFSwitchAlarm=rFURFSwitchAlarm, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFUVersionBank1=rFUVersionBank1, activeUnit=activeUnit, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sntp=sntp, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licence=licence, dataPortStatus=dataPortStatus, managementCommittedInformationRate=managementCommittedInformationRate, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, tFTPServerPortNumber=tFTPServerPortNumber, secureModeAlarmTrap=secureModeAlarmTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, securityLevel=securityLevel, radioLicenseRegion=radioLicenseRegion, daylightSaving=daylightSaving, secondarySoftwareVersion=secondarySoftwareVersion, maxModulation=maxModulation, rFUTxFreqMax=rFUTxFreqMax, smtp=smtp, managementPortStatusTrap=managementPortStatusTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkStatusTrap=wirelessLinkStatusTrap, neighborInternetAddressType=neighborInternetAddressType, sNMPTrapPortNumber=sNMPTrapPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFUSerial=rFUSerial, iPv4Address=iPv4Address, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, l2CPPriorityTableNumber=l2CPPriorityTableNumber, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, vectorError=vectorError, telnetPortNumber=telnetPortNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, systemClock=systemClock, rFUStatusTrap=rFUStatusTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, neighborInternetAddress=neighborInternetAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapTableIndex=sNMPTrapTableIndex, radioLicenseIdentifier=radioLicenseIdentifier, primaryRecoveryPeriod=primaryRecoveryPeriod, rFUPowerButtonPressed=rFUPowerButtonPressed, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, telnetAccessEnabled=telnetAccessEnabled, protectionStateTrap=protectionStateTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, sNMPTrapInternetAddress=sNMPTrapInternetAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUVersionBank2=rFUVersionBank2, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, receivePower=receivePower, radioLicenseMinModulation=radioLicenseMinModulation, vLANManagementVIDValidation=vLANManagementVIDValidation, sMTPEmailAlert=sMTPEmailAlert, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, transmitCapacityLimit=transmitCapacityLimit, ptp=ptp, ethernetPriorityTable=ethernetPriorityTable, numberOfAntennas=numberOfAntennas, minModulation=minModulation, snmpControl=snmpControl, userPassword=userPassword, managementMode=managementMode, rFUTxBandAboveRx=rFUTxBandAboveRx, dSCPManagementPriority=dSCPManagementPriority, rFUConnectedPlatform=rFUConnectedPlatform, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sMTPEnabledMessages=sMTPEnabledMessages, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, bootVersion=bootVersion, transmitPower=transmitPower, pubStats=pubStats, syslogClientTrap=syslogClientTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, iFCableLength=iFCableLength, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFUBranchingConfiguration=rFUBranchingConfiguration, radioLicenseCodeRate=radioLicenseCodeRate, rFUTxFreqMin=rFUTxFreqMin, rfu=rfu, syslogState=syslogState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFURpsAlarm=rFURpsAlarm, minCodeRate=minCodeRate, sNTPServerTableIndex=sNTPServerTableIndex, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, gatewayIPAddress=gatewayIPAddress, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, userRole=userRole, userTable=userTable, aggregateDataRate=aggregateDataRate, sNTPState=sNTPState, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, rFUTxPowerMin=rFUTxPowerMin, rFUPowerAlarm=rFUPowerAlarm, neighborMACAddress=neighborMACAddress, userEnabled=userEnabled, sNMPTrapVersion=sNMPTrapVersion, vLANManagementPriority=vLANManagementPriority, sNMPTrapTableNumber=sNMPTrapTableNumber, userTableNumber=userTableNumber, localPacketFiltering=localPacketFiltering, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, latitude=latitude, transmitCapacityLimitDetail=transmitCapacityLimitDetail, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syslogStateTrap=syslogStateTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPVersion=iPVersion, sNTPPollInterval=sNTPPollInterval, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataPortPauseFrames=dataPortPauseFrames, antennaGain=antennaGain, rFUProtectionCompatibility=rFUProtectionCompatibility, aAAControl=aAAControl, sNTPServerRetries=sNTPServerRetries, rFUStatus=rFUStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, remoteIPAddress=remoteIPAddress, primaryRecovery=primaryRecovery, supplementary=supplementary, radioLicenseMaxEIRP=radioLicenseMaxEIRP, cambium=cambium, managementPortForcedConfiguration=managementPortForcedConfiguration, rFUTxPowerMax=rFUTxPowerMax, sNMPPortNumber=sNMPPortNumber)
