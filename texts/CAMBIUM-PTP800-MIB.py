...
NotificationType, IpAddress, Counter64, Bits, MibIdentifier, Integer32, TimeTicks, Gauge32, ObjectIdentity, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Counter64", "Bits", "MibIdentifier", "Integer32", "TimeTicks", "Gauge32", "ObjectIdentity", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, alignmentMode=alignmentMode, userTableEntry=userTableEntry, snmpControl=snmpControl, sNTPServerTableNumber=sNTPServerTableNumber, sNTPServerRetries=sNTPServerRetries, rFUConnectedPlatform=rFUConnectedPlatform, iPDSCPPriorityTable=iPDSCPPriorityTable, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rFURpsAlarm=rFURpsAlarm, sNTPServerPortNumber=sNTPServerPortNumber, remoteSecondaryIPAddress=remoteSecondaryIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, linkNameMismatch=linkNameMismatch, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, faultProtectionSwitching=faultProtectionSwitching, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rfu=rfu, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, userTable=userTable, ptmp=ptmp, altitude=altitude, rxDiversityVid=rxDiversityVid, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, systemReset=systemReset, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, vLANManagementVID=vLANManagementVID, rFURxFreqMax=rFURxFreqMax, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPServerPortNumber=sMTPServerPortNumber, longitude=longitude, ethernetPriorityTableEntry=ethernetPriorityTableEntry, alignmentModeTrap=alignmentModeTrap, bridge=bridge, rFUTxFreqMin=rFUTxFreqMin, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFURfBand=rFURfBand, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, dataPortDisabledWarning=dataPortDisabledWarning, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rFUVersionBank1=rFUVersionBank1, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, minModulation=minModulation, sNTPServerIPAddress=sNTPServerIPAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, dataPortPauseFrames=dataPortPauseFrames, ptpTraps=ptpTraps, sNTPServerTableIndex=sNTPServerTableIndex, receiveCodeRate=receiveCodeRate, configuration=configuration, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, smtp=smtp, managementPortAutoNegotiation=managementPortAutoNegotiation, primaryRecovery=primaryRecovery, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, iPVersion=iPVersion, rFUVersionBank2=rFUVersionBank2, rFUPowerButtonPressed=rFUPowerButtonPressed, alarms=alarms, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapVersion=sNMPTrapVersion, radioLicenseBandwidth=radioLicenseBandwidth, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sNTPSyncTrap=sNTPSyncTrap, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFUTxPowerMin=rFUTxPowerMin, rFURxFreqMin=rFURxFreqMin, sNTPLastSync=sNTPLastSync, protectionConfigurationStatus=protectionConfigurationStatus, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rFUTxMuteStatus=rFUTxMuteStatus, ptp=ptp, primarySecondaryMode=primarySecondaryMode, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, unitOutOfCalibration=unitOutOfCalibration, ethernet=ethernet, sMTPEnabledMessages=sMTPEnabledMessages, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, syslogState=syslogState, managementMode=managementMode, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitCapacityLimit=transmitCapacityLimit, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vLANManagementVIDValidation=vLANManagementVIDValidation, telnetPortNumber=telnetPortNumber, rFUFreqSpacing=rFUFreqSpacing, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, linkName=linkName, radioLicenseBand=radioLicenseBand, syslogClientTrap=syslogClientTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rFUSerial=rFUSerial, remoteInternetAddressType=remoteInternetAddressType, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapTableIndex=sNMPTrapTableIndex, receivePower=receivePower, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapInternetAddress=sNMPTrapInternetAddress, wirelessLinkStatus=wirelessLinkStatus, radioLicenseRxFreq=radioLicenseRxFreq, activeUnit=activeUnit, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFUStatusTrap=rFUStatusTrap, rFULockoutAlarm=rFULockoutAlarm, l2CPPriorityTableEntry=l2CPPriorityTableEntry, radioLicenseTxFreq=radioLicenseTxFreq, sMTPEmailAlert=sMTPEmailAlert, iPv4Address=iPv4Address, userTableIndex=userTableIndex, syslogControl=syslogControl, sNMPTrapTableNumber=sNMPTrapTableNumber, rFURFSwitchAlarm=rFURFSwitchAlarm, managementPortStatusTrap=managementPortStatusTrap, protectionStats=protectionStats, rFUTxBandAboveRx=rFUTxBandAboveRx, phyStatus=phyStatus, sNTPSync=sNTPSync, systemClock=systemClock, sNTPServerInternetAddressType=sNTPServerInternetAddressType, managementPortDisabledWarning=managementPortDisabledWarning, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, telnetAccessEnabled=telnetAccessEnabled, activeAvailableTime=activeAvailableTime, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, neighborMACAddress=neighborMACAddress, minCodeRate=minCodeRate, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogStateTrap=syslogStateTrap, secondarySoftwareVersion=secondarySoftwareVersion, managementPortConfigurationMismatch=managementPortConfigurationMismatch, aTPCEnable=aTPCEnable, protectionStatus=protectionStatus, tFTPServerIPAddress=tFTPServerIPAddress, hardwareVersion=hardwareVersion, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, qOSPriorityScheme=qOSPriorityScheme, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, secureModeAlarmTrap=secureModeAlarmTrap, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, aggregateDataRate=aggregateDataRate, receiveModulation=receiveModulation, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, siteName=siteName, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, tFTPServerInternetAddress=tFTPServerInternetAddress, supplementary=supplementary, remotePrimaryIPAddress=remotePrimaryIPAddress, pubStats=pubStats, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, phyControl=phyControl, sNMPTrapIPAddress=sNMPTrapIPAddress, endId=endId, protectionStateTrap=protectionStateTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerTable=sNTPServerTable, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, transmitCapacity=transmitCapacity, sNTPServerTimeout=sNTPServerTimeout, managementPortForcedConfiguration=managementPortForcedConfiguration, maxCodeRate=maxCodeRate, tFTPServerInternetAddressType=tFTPServerInternetAddressType, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, protectionInterfaceStatus=protectionInterfaceStatus, sntp=sntp, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitCodeRate=transmitCodeRate, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, neighborInternetAddressType=neighborInternetAddressType, radioLicenseMinCodeRate=radioLicenseMinCodeRate, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, protectionState=protectionState, reset=reset, rFUTxFreqMax=rFUTxFreqMax, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNTPServerTableEntry=sNTPServerTableEntry, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, sMTPServerIPAddress=sMTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, radioLicenseRegion=radioLicenseRegion, requestedProtectionState=requestedProtectionState, ethernetPriorityTable=ethernetPriorityTable, userEnabled=userEnabled, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, hTTPSPortNumber=hTTPSPortNumber, licence=licence, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, softwareVersion=softwareVersion, latitude=latitude, remotePrimaryMACAddress=remotePrimaryMACAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rFUPlatformCompatibility=rFUPlatformCompatibility, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dataPortStatus=dataPortStatus, receiveDataRate=receiveDataRate, radioLicenseMaxModulation=radioLicenseMaxModulation, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, protectionSwitchCause=protectionSwitchCause, transmitCapacityLimitDetail=transmitCapacityLimitDetail, rFUTxPowerMax=rFUTxPowerMax, sMTPServerInternetAddress=sMTPServerInternetAddress, protectionConfig=protectionConfig, userPassword=userPassword, cambium=cambium, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, managementCommittedInformationRate=managementCommittedInformationRate, antennaGain=antennaGain, rFUTransceiverLocation=rFUTransceiverLocation, rFUTxPowerAlarm=rFUTxPowerAlarm, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFUActiveFirmwareBank=rFUActiveFirmwareBank, hTTPPortNumber=hTTPPortNumber, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, l2CPPriorityTable=l2CPPriorityTable, ptp800=ptp800, transmitModulation=transmitModulation, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, dataPortFiberStatusTrap=dataPortFiberStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, diverseAntennaGain=diverseAntennaGain, remoteInternetAddress=remoteInternetAddress, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, gatewayIPAddress=gatewayIPAddress, fiberY=fiberY, radioLicenseIdentifier=radioLicenseIdentifier, iFCableLength=iFCableLength, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, remoteIPAddress=remoteIPAddress, productName=productName, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rFFeederLoss=rFFeederLoss, ptpTrapPrefix=ptpTrapPrefix, rFUType=rFUType, vectorError=vectorError, numberOfAntennas=numberOfAntennas, localPacketFiltering=localPacketFiltering)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", wirelessLinkStatusTrap=wirelessLinkStatusTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rxDiversityDataPortStatus=rxDiversityDataPortStatus, encryptionAlgorithm=encryptionAlgorithm, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, userTableNumber=userTableNumber, userRole=userRole, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, encryptionEnabledMismatch=encryptionEnabledMismatch, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFUCableAlarm=rFUCableAlarm, mPLSTCPriorityTable=mPLSTCPriorityTable, bootVersion=bootVersion, iPv6GatewayAddress=iPv6GatewayAddress, enableTransmission=enableTransmission, remotePrimarySecondaryMode=remotePrimarySecondaryMode, sNTPServerInternetAddress=sNTPServerInternetAddress, maxModulation=maxModulation, iPv6Address=iPv6Address, sNMPPortNumber=sNMPPortNumber, radioLicenseModulation=radioLicenseModulation, managementPortWirelessDownAlert=managementPortWirelessDownAlert, productVariant=productVariant, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, sNTPPollInterval=sNTPPollInterval, sNTPPrimaryServer=sNTPPrimaryServer, linkNameMismatchTrap=linkNameMismatchTrap, aAAControl=aAAControl, sNTPServerResponse=sNTPServerResponse, neighborIPAddress=neighborIPAddress, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rFUStatus=rFUStatus, hTTPAccessEnabled=hTTPAccessEnabled, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, vLANManagementPriority=vLANManagementPriority, management=management, subnetMask=subnetMask, sNTPState=sNTPState, secureModeAlarm=secureModeAlarm, remoteMACAddress=remoteMACAddress, timeZone=timeZone, versions=versions, remotePrimaryInternetAddress=remotePrimaryInternetAddress, syslogClient=syslogClient, userName=userName, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, rFUBranchingConfiguration=rFUBranchingConfiguration, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rFUProtectionCompatibility=rFUProtectionCompatibility, sNMPEnabledTraps=sNMPEnabledTraps, protectionAvailabilityStatus=protectionAvailabilityStatus, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkLoss=linkLoss, sNMPTrapTable=sNMPTrapTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, daylightSaving=daylightSaving, sNMPCommunityString=sNMPCommunityString, rxDiversityVlanTpid=rxDiversityVlanTpid, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, transmitPower=transmitPower, dataPortFiberStatus=dataPortFiberStatus, remoteSecondaryMACAddress=remoteSecondaryMACAddress, radioLicenseCodeRate=radioLicenseCodeRate, rFUPowerAlarm=rFUPowerAlarm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, encryption=encryption, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, securityLevel=securityLevel, sNMPTrapTableEntry=sNMPTrapTableEntry, protection=protection, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, neighborInternetAddress=neighborInternetAddress, diverseRfFeederLoss=diverseRfFeederLoss, radioLicenseMinModulation=radioLicenseMinModulation, transmitterStatus=transmitterStatus, iPv6PrefixLength=iPv6PrefixLength, radioLicense=radioLicense, transmitDataRate=transmitDataRate, maximumTransmitPower=maximumTransmitPower, managementPortStatus=managementPortStatus, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, radioLicenseMaxEIRP=radioLicenseMaxEIRP, tFTPServerPortNumber=tFTPServerPortNumber, primaryRecoveryPeriod=primaryRecoveryPeriod, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm)
