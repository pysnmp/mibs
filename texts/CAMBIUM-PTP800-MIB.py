...
Integer32, TimeTicks, enterprises, NotificationType, Gauge32, iso, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, IpAddress, MibIdentifier, ModuleIdentity, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "enterprises", "NotificationType", "Gauge32", "iso", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "IpAddress", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, wirelessLinkStatus=wirelessLinkStatus, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, sNTPServerTimeout=sNTPServerTimeout, sNMPPortNumber=sNMPPortNumber, configuration=configuration, activeUnit=activeUnit, rFUStatusTrap=rFUStatusTrap, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, transmitDataRate=transmitDataRate, activeAvailableTime=activeAvailableTime, sNTPPrimaryServer=sNTPPrimaryServer, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, transmitCapacity=transmitCapacity, ethernetPriorityTableIndex=ethernetPriorityTableIndex, licence=licence, sNMPTrapVersion=sNMPTrapVersion, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, hTTPAccessEnabled=hTTPAccessEnabled, maximumTransmitPower=maximumTransmitPower, rFUProtectionCompatibility=rFUProtectionCompatibility, managementPortDisabledWarning=managementPortDisabledWarning, rxDiversityDataPortStatus=rxDiversityDataPortStatus, antennaGain=antennaGain, longitude=longitude, iPVersion=iPVersion, radioLicenseTxFreq=radioLicenseTxFreq, mPLSTCPriorityTable=mPLSTCPriorityTable, protectionStatus=protectionStatus, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rFUPlatformCompatibility=rFUPlatformCompatibility, rFURxFreqMin=rFURxFreqMin, userEnabled=userEnabled, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, radioLicense=radioLicense, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerResponse=sNTPServerResponse, transmitterStatus=transmitterStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, radioLicenseCodeRate=radioLicenseCodeRate, phyStatus=phyStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, managementPortStatusTrap=managementPortStatusTrap, rFUFreqSpacing=rFUFreqSpacing, managementMode=managementMode, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, transmitPower=transmitPower, protectionAvailabilityStatus=protectionAvailabilityStatus, userName=userName, remotePrimaryMACAddress=remotePrimaryMACAddress, faultProtectionSwitching=faultProtectionSwitching, syslogState=syslogState, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPLastSync=sNTPLastSync, management=management, iPv4Address=iPv4Address, userRole=userRole, linkLoss=linkLoss, sNTPServerRetries=sNTPServerRetries, remoteSecondaryIPAddress=remoteSecondaryIPAddress, protectionSwitchCause=protectionSwitchCause, dataPortWirelessDownAlert=dataPortWirelessDownAlert, secureModeAlarmTrap=secureModeAlarmTrap, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, syslogStateTrap=syslogStateTrap, aAAControl=aAAControl, ethernetPriorityTableEntry=ethernetPriorityTableEntry, managementPortWirelessDownAlert=managementPortWirelessDownAlert, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPPollInterval=sNTPPollInterval, protectionState=protectionState, productName=productName, aggregateDataRate=aggregateDataRate, neighborInternetAddress=neighborInternetAddress, remoteInternetAddressType=remoteInternetAddressType, radioLicenseMaxModulation=radioLicenseMaxModulation, userTableNumber=userTableNumber, rFUBranchingConfiguration=rFUBranchingConfiguration, rFFeederLoss=rFFeederLoss, receiveDataRate=receiveDataRate, rFUVersionBank1=rFUVersionBank1, receiveCodeRate=receiveCodeRate, sMTPServerPortNumber=sMTPServerPortNumber, transmitCodeRate=transmitCodeRate, telnetPortNumber=telnetPortNumber, maxCodeRate=maxCodeRate, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, ptpTraps=ptpTraps, tFTPServerPortNumber=tFTPServerPortNumber, rFUCableAlarm=rFUCableAlarm, timeZone=timeZone, sNTPServerTableIndex=sNTPServerTableIndex, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, radioLicenseIdentifier=radioLicenseIdentifier, sNMPTrapInternetAddress=sNMPTrapInternetAddress, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, remoteInternetAddress=remoteInternetAddress, latitude=latitude, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receivePower=receivePower, encryptionEnabledMismatch=encryptionEnabledMismatch, radioLicenseMinCodeRate=radioLicenseMinCodeRate, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, userPassword=userPassword, minCodeRate=minCodeRate, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, iFCableLength=iFCableLength, reset=reset, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, protectionStateTrap=protectionStateTrap, receiveModulation=receiveModulation, rFUSerial=rFUSerial, activeWirelessLinkAvailability=activeWirelessLinkAvailability, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, encryptionAlgorithm=encryptionAlgorithm, protectionConfigurationStatus=protectionConfigurationStatus, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFURpsAlarm=rFURpsAlarm, transmitModulation=transmitModulation, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, l2CPPriorityTable=l2CPPriorityTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, primarySecondaryMode=primarySecondaryMode, rFURFSwitchAlarm=rFURFSwitchAlarm, userTable=userTable, vLANManagementPriority=vLANManagementPriority, syslogClientTrap=syslogClientTrap, radioLicenseRegion=radioLicenseRegion, rFUPowerButtonPressed=rFUPowerButtonPressed, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, protection=protection, diverseRfFeederLoss=diverseRfFeederLoss, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPSync=sNTPSync, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sntp=sntp, hTTPSPortNumber=hTTPSPortNumber, ethernetFiberSupport=ethernetFiberSupport, alignmentModeTrap=alignmentModeTrap, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, fiberY=fiberY, alarms=alarms, telnetAccessEnabled=telnetAccessEnabled, subnetMask=subnetMask, cambium=cambium, minModulation=minModulation, bootVersion=bootVersion, phyControl=phyControl, rFUTxFreqMax=rFUTxFreqMax, radioLicenseMaxEIRP=radioLicenseMaxEIRP, tFTPServerInternetAddress=tFTPServerInternetAddress, softwareVersion=softwareVersion, neighborInternetAddressType=neighborInternetAddressType, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, snmpControl=snmpControl, dataPortPauseFrames=dataPortPauseFrames, sMTPEmailAlert=sMTPEmailAlert, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, sMTPServerIPAddress=sMTPServerIPAddress, userTableIndex=userTableIndex, vLANManagementVIDValidation=vLANManagementVIDValidation, alignmentMode=alignmentMode, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, syslogClient=syslogClient, sMTPServerInternetAddress=sMTPServerInternetAddress, qOSPriorityScheme=qOSPriorityScheme, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, managementPortStatus=managementPortStatus, managementPortAutoNegotiation=managementPortAutoNegotiation, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, iPv6PrefixLength=iPv6PrefixLength, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortStatusTrap=dataPortStatusTrap, rFULockoutAlarm=rFULockoutAlarm, iPv6Address=iPv6Address, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, ptp800=ptp800, supplementary=supplementary, diverseAntennaGain=diverseAntennaGain, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, remoteIPAddress=remoteIPAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, endId=endId, dSCPManagementPriority=dSCPManagementPriority, encryption=encryption, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPTrapTableIndex=sNMPTrapTableIndex, rFUType=rFUType, linkNameMismatch=linkNameMismatch, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, hardwareVersion=hardwareVersion, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, versions=versions, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFURxFreqMax=rFURxFreqMax, rFUStatus=rFUStatus, secureModeAlarm=secureModeAlarm, remotePrimaryInternetAddress=remotePrimaryInternetAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPServerTable=sNTPServerTable, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, rFUTransceiverLocation=rFUTransceiverLocation, transmitCapacityLimit=transmitCapacityLimit, localPacketFiltering=localPacketFiltering, sNTPState=sNTPState, hTTPPortNumber=hTTPPortNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rFUVersionBank2=rFUVersionBank2, sMTPEnabledMessages=sMTPEnabledMessages, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, radioLicenseBandwidth=radioLicenseBandwidth, ptmp=ptmp, aTPCEnable=aTPCEnable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, unitOutOfCalibration=unitOutOfCalibration, ethernetPriorityTable=ethernetPriorityTable, requestedProtectionState=requestedProtectionState, sNMPEnabledTraps=sNMPEnabledTraps, daylightSaving=daylightSaving, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, sNMPCommunityString=sNMPCommunityString, linkNameMismatchTrap=linkNameMismatchTrap, rxDiversityVid=rxDiversityVid, productVariant=productVariant, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, iPv6GatewayAddress=iPv6GatewayAddress, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, maxModulation=maxModulation, remotePrimaryIPAddress=remotePrimaryIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkName=linkName, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rxDiversityVlanTpid=rxDiversityVlanTpid, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFUTxFreqMin=rFUTxFreqMin)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", vectorError=vectorError, managementCommittedInformationRate=managementCommittedInformationRate, rFUTxBandAboveRx=rFUTxBandAboveRx, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, systemClock=systemClock, dataPortFiberStatus=dataPortFiberStatus, radioLicenseModulation=radioLicenseModulation, radioLicenseMinModulation=radioLicenseMinModulation, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, systemReset=systemReset, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, gatewayIPAddress=gatewayIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, siteName=siteName, iPDSCPPriorityTable=iPDSCPPriorityTable, l2CPPriorityTableEntry=l2CPPriorityTableEntry, radioLicenseBand=radioLicenseBand, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rFURfBand=rFURfBand, rFUTxPowerAlarm=rFUTxPowerAlarm, sNTPServerTableEntry=sNTPServerTableEntry, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, userTableEntry=userTableEntry, neighborMACAddress=neighborMACAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, syslogControl=syslogControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, protectionStats=protectionStats, rFUConnectedPlatform=rFUConnectedPlatform, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitCapacityLimitDetail=transmitCapacityLimitDetail, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, remotePrimarySecondaryMode=remotePrimarySecondaryMode, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, primaryRecoveryPeriod=primaryRecoveryPeriod, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortStatus=dataPortStatus, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, remoteMACAddress=remoteMACAddress, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, sNTPSyncTrap=sNTPSyncTrap, securityLevel=securityLevel, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, neighborIPAddress=neighborIPAddress, ethernet=ethernet, rFUActiveFirmwareBank=rFUActiveFirmwareBank, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, altitude=altitude, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, remoteSecondaryMACAddress=remoteSecondaryMACAddress, protectionInterfaceStatus=protectionInterfaceStatus, sNMPTrapTable=sNMPTrapTable, dataPortDisabledWarning=dataPortDisabledWarning, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, enableTransmission=enableTransmission, ptpTrapPrefix=ptpTrapPrefix, numberOfAntennas=numberOfAntennas, sNMPTrapIPAddress=sNMPTrapIPAddress, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, managementPortForcedConfiguration=managementPortForcedConfiguration, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, pubStats=pubStats, wirelessLinkAvailability=wirelessLinkAvailability, vLANManagementVID=vLANManagementVID, rFUPowerAlarm=rFUPowerAlarm, protectionConfig=protectionConfig, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rFUTxPowerMax=rFUTxPowerMax, wirelessLinkStatusTrap=wirelessLinkStatusTrap, radioLicenseRxFreq=radioLicenseRxFreq, bridge=bridge, primaryRecovery=primaryRecovery, dataPortFiberStatusTrap=dataPortFiberStatusTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapTableEntry=sNMPTrapTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerIPAddress=sNTPServerIPAddress, sNTPServerTableNumber=sNTPServerTableNumber, ptp=ptp, rFUTxPowerMin=rFUTxPowerMin, smtp=smtp, rFUTxMuteStatus=rFUTxMuteStatus, rfu=rfu, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap)
