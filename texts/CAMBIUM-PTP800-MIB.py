...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", dataPortFiberStatus=dataPortFiberStatus, userPassword=userPassword, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, protectionInterfaceStatus=protectionInterfaceStatus, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, receiveDataRate=receiveDataRate, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, aggregateDataRate=aggregateDataRate, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dataPortStatusTrap=dataPortStatusTrap, sNMPPortNumber=sNMPPortNumber, configuration=configuration, transmitCapacityLimitDetail=transmitCapacityLimitDetail, primaryRecovery=primaryRecovery, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, rxDiversityDataPortStatus=rxDiversityDataPortStatus, rFUPowerButtonPressed=rFUPowerButtonPressed, iPv4Address=iPv4Address, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFURFSwitchAlarm=rFURFSwitchAlarm, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rxDiversityVid=rxDiversityVid, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, phyControl=phyControl, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, secondarySoftwareVersion=secondarySoftwareVersion, requestedProtectionState=requestedProtectionState, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, protectionState=protectionState, rFUTransceiverLocation=rFUTransceiverLocation, protectionStats=protectionStats, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, radioLicenseCodeRate=radioLicenseCodeRate, diverseRfFeederLoss=diverseRfFeederLoss, receiveModulation=receiveModulation, reset=reset, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, hardwareVersion=hardwareVersion, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, alarms=alarms, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, managementPortDisabledWarning=managementPortDisabledWarning, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, maxCodeRate=maxCodeRate, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, alignmentModeTrap=alignmentModeTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rFUConnectedPlatform=rFUConnectedPlatform, rFURpsAlarm=rFURpsAlarm, secureModeAlarmTrap=secureModeAlarmTrap, userRole=userRole, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortWirelessDownAlert=dataPortWirelessDownAlert, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ptp800=ptp800, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitCapacity=transmitCapacity, receiveCodeRate=receiveCodeRate, managementCommittedInformationRate=managementCommittedInformationRate, neighborInternetAddressType=neighborInternetAddressType, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPServerIPAddress=sNTPServerIPAddress, sNMPCommunityString=sNMPCommunityString, encryption=encryption, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, timeZone=timeZone, fiberY=fiberY, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rFUFreqSpacing=rFUFreqSpacing, rFUActiveFirmwareBank=rFUActiveFirmwareBank, encryptionAlgorithm=encryptionAlgorithm, rFUSerial=rFUSerial, supplementary=supplementary, maxModulation=maxModulation, rfu=rfu, diverseAntennaGain=diverseAntennaGain, remoteIPAddress=remoteIPAddress, sNMPTrapVersion=sNMPTrapVersion, protectionStateTrap=protectionStateTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFFeederLoss=rFFeederLoss, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, altitude=altitude, iPv6PrefixLength=iPv6PrefixLength, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, hTTPPortNumber=hTTPPortNumber, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, subnetMask=subnetMask, productName=productName, qOSPriorityScheme=qOSPriorityScheme, rFUTxBandAboveRx=rFUTxBandAboveRx, userTableIndex=userTableIndex, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, cambium=cambium, transmitCapacityLimit=transmitCapacityLimit, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, linkLoss=linkLoss, rFUTxFreqMin=rFUTxFreqMin, gatewayIPAddress=gatewayIPAddress, sNTPServerPortNumber=sNTPServerPortNumber, rFUVersionBank1=rFUVersionBank1, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, neighborInternetAddress=neighborInternetAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, daylightSaving=daylightSaving, pubStats=pubStats, maximumTransmitPower=maximumTransmitPower, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTable=sNMPTrapTable, sNTPPollInterval=sNTPPollInterval, receivePower=receivePower, rxDiversityVlanTpid=rxDiversityVlanTpid, protection=protection, managementPortStatusTrap=managementPortStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, managementPortStatus=managementPortStatus, aAAControl=aAAControl, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rFUTxFreqMax=rFUTxFreqMax, minCodeRate=minCodeRate, radioLicenseModulation=radioLicenseModulation, sntp=sntp, sNTPServerTable=sNTPServerTable, transmitCodeRate=transmitCodeRate, sNTPServerTableIndex=sNTPServerTableIndex, vLANManagementVIDValidation=vLANManagementVIDValidation, wirelessLinkStatus=wirelessLinkStatus, licence=licence, alignmentMode=alignmentMode, sMTPEmailAlert=sMTPEmailAlert, primarySecondaryMode=primarySecondaryMode, softwareVersion=softwareVersion, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, radioLicenseBand=radioLicenseBand, aTPCEnable=aTPCEnable, rFUTxPowerMin=rFUTxPowerMin, ethernetPriorityTableNumber=ethernetPriorityTableNumber, phyStatus=phyStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dataPortConfigurationMismatch=dataPortConfigurationMismatch, radioLicenseBandwidth=radioLicenseBandwidth, secureModeAlarm=secureModeAlarm, radioLicenseMinModulation=radioLicenseMinModulation, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tFTPServerIPAddress=tFTPServerIPAddress, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, sNTPServerTimeout=sNTPServerTimeout, sNTPServerTableNumber=sNTPServerTableNumber, protectionConfig=protectionConfig, syslogClient=syslogClient, sMTPServerIPAddress=sMTPServerIPAddress, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rFURfBand=rFURfBand, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPSyncTrap=sNTPSyncTrap, sNTPServerRetries=sNTPServerRetries, vLANManagementVID=vLANManagementVID, remotePrimaryInternetAddress=remotePrimaryInternetAddress, protectionConfigurationStatus=protectionConfigurationStatus, versions=versions, sMTPServerPortNumber=sMTPServerPortNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, protectionStatus=protectionStatus, systemReset=systemReset, rFUStatusTrap=rFUStatusTrap, userName=userName, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, protectionAvailabilityStatus=protectionAvailabilityStatus, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, unitOutOfCalibration=unitOutOfCalibration, ptp=ptp, enableTransmission=enableTransmission, productVariant=productVariant, userEnabled=userEnabled, wirelessLinkAvailability=wirelessLinkAvailability, activeUnit=activeUnit, userTableEntry=userTableEntry, dataPortFiberStatusTrap=dataPortFiberStatusTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, managementPortForcedConfiguration=managementPortForcedConfiguration, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFUStatus=rFUStatus, neighborMACAddress=neighborMACAddress, rFUProtectionCompatibility=rFUProtectionCompatibility, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rFUVersionBank2=rFUVersionBank2, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, radioLicenseIdentifier=radioLicenseIdentifier, sNTPServerInternetAddress=sNTPServerInternetAddress, managementMode=managementMode, longitude=longitude, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, antennaGain=antennaGain, transmitterStatus=transmitterStatus, remotePrimaryMACAddress=remotePrimaryMACAddress, vectorError=vectorError, activeWirelessLinkAvailability=activeWirelessLinkAvailability, dataPortDisabledWarning=dataPortDisabledWarning, linkNameMismatch=linkNameMismatch, bridge=bridge, numberOfAntennas=numberOfAntennas, ethernet=ethernet, ptpTraps=ptpTraps, ethernetFiberSupport=ethernetFiberSupport, managementPortWirelessDownAlert=managementPortWirelessDownAlert, transmitModulation=transmitModulation, l2CPPriorityTableNumber=l2CPPriorityTableNumber, vLANManagementPriority=vLANManagementPriority, sNTPState=sNTPState, radioLicenseRegion=radioLicenseRegion, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, activeAvailableTime=activeAvailableTime, managementPortAutoNegotiation=managementPortAutoNegotiation, faultProtectionSwitching=faultProtectionSwitching, radioLicenseMaxEIRP=radioLicenseMaxEIRP, protectionSwitchCause=protectionSwitchCause, ptmp=ptmp, rFUPowerAlarm=rFUPowerAlarm, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rFUTxPowerMax=rFUTxPowerMax, sNMPTrapTableNumber=sNMPTrapTableNumber, management=management, sNTPPrimaryServer=sNTPPrimaryServer, remoteMACAddress=remoteMACAddress, l2CPPriorityTable=l2CPPriorityTable, tFTPServerPortNumber=tFTPServerPortNumber, syslogControl=syslogControl, siteName=siteName, rFUBranchingConfiguration=rFUBranchingConfiguration, rFUType=rFUType, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, latitude=latitude, iPv6Address=iPv6Address, smtp=smtp, localPacketFiltering=localPacketFiltering)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNTPServerResponse=sNTPServerResponse, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, primaryRecoveryPeriod=primaryRecoveryPeriod, snmpControl=snmpControl, neighborIPAddress=neighborIPAddress, radioLicense=radioLicense, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkName=linkName, dataPortPauseFrames=dataPortPauseFrames, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, hTTPSPortNumber=hTTPSPortNumber, remotePrimarySecondaryMode=remotePrimarySecondaryMode, wirelessLinkStatusTrap=wirelessLinkStatusTrap, dataPortStatus=dataPortStatus, dSCPManagementPriority=dSCPManagementPriority, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sNTPServerTableEntry=sNTPServerTableEntry, iPVersion=iPVersion, userTable=userTable, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, transmitDataRate=transmitDataRate, rFUTxPowerAlarm=rFUTxPowerAlarm, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, bootVersion=bootVersion, rFUPlatformCompatibility=rFUPlatformCompatibility, sNMPEnabledTraps=sNMPEnabledTraps, rFURxFreqMax=rFURxFreqMax, radioLicenseMinCodeRate=radioLicenseMinCodeRate, telnetPortNumber=telnetPortNumber, iFCableLength=iFCableLength, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, minModulation=minModulation, encryptionEnabledMismatch=encryptionEnabledMismatch, syslogState=syslogState, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, userTableNumber=userTableNumber, radioLicenseTxFreq=radioLicenseTxFreq, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, tFTPServerInternetAddress=tFTPServerInternetAddress, remotePrimaryIPAddress=remotePrimaryIPAddress, endId=endId, remoteInternetAddress=remoteInternetAddress, remoteInternetAddressType=remoteInternetAddressType, sNTPLastSync=sNTPLastSync, rFUTxMuteStatus=rFUTxMuteStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, syslogStateTrap=syslogStateTrap, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, remoteSecondaryIPAddress=remoteSecondaryIPAddress, sNTPSync=sNTPSync, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, ethernetPriorityTable=ethernetPriorityTable, linkNameMismatchTrap=linkNameMismatchTrap, hTTPAccessEnabled=hTTPAccessEnabled, iPv6GatewayAddress=iPv6GatewayAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, securityLevel=securityLevel, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, systemClock=systemClock, iPDSCPPriorityTable=iPDSCPPriorityTable, rFURxFreqMin=rFURxFreqMin, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, telnetAccessEnabled=telnetAccessEnabled, radioLicenseMaxModulation=radioLicenseMaxModulation, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rFULockoutAlarm=rFULockoutAlarm, rFUCableAlarm=rFUCableAlarm, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogClientTrap=syslogClientTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, radioLicenseRxFreq=radioLicenseRxFreq, transmitPower=transmitPower)
