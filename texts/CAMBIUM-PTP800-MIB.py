...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", management=management, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, receiveCodeRate=receiveCodeRate, rFULockoutAlarm=rFULockoutAlarm, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, primaryRecoveryPeriod=primaryRecoveryPeriod, sNMPTrapTableIndex=sNMPTrapTableIndex, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rFUTxMuteStatus=rFUTxMuteStatus, sNTPServerIPAddress=sNTPServerIPAddress, remotePrimaryIPAddress=remotePrimaryIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPState=sNTPState, protectionInterfaceStatus=protectionInterfaceStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, protectionState=protectionState, linkName=linkName, radioLicenseMaxModulation=radioLicenseMaxModulation, rFUCableAlarm=rFUCableAlarm, rFURxFreqMax=rFURxFreqMax, radioLicenseRegion=radioLicenseRegion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, managementMode=managementMode, hardwareVersion=hardwareVersion, remoteMaximumTransmitPower=remoteMaximumTransmitPower, secureModeAlarmTrap=secureModeAlarmTrap, linkLoss=linkLoss, systemClock=systemClock, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, fiberY=fiberY, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syslogState=syslogState, protectionStatus=protectionStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, securityLevel=securityLevel, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, tFTPServerInternetAddress=tFTPServerInternetAddress, smtp=smtp, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, gatewayIPAddress=gatewayIPAddress, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, neighborInternetAddressType=neighborInternetAddressType, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, iPv6Address=iPv6Address, sMTPServerPortNumber=sMTPServerPortNumber, rFUTxPowerMax=rFUTxPowerMax, activeUnit=activeUnit, syslogClientTrap=syslogClientTrap, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, iPDSCPPriorityTable=iPDSCPPriorityTable, radioLicenseModulation=radioLicenseModulation, managementPortAutoNegotiation=managementPortAutoNegotiation, softwareVersion=softwareVersion, ethernet=ethernet, rFURfBand=rFURfBand, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ptmp=ptmp, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, radioLicense=radioLicense, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, useVLANForManagementInterfaces=useVLANForManagementInterfaces, remotePrimarySecondaryMode=remotePrimarySecondaryMode, ptp=ptp, maxCodeRate=maxCodeRate, rFUTxFreqMax=rFUTxFreqMax, rFUTxFreqMin=rFUTxFreqMin, transmitCapacityLimit=transmitCapacityLimit, aAAControl=aAAControl, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, sNTPPollInterval=sNTPPollInterval, hTTPSPortNumber=hTTPSPortNumber, sNTPServerTable=sNTPServerTable, maxModulation=maxModulation, rFUStatusTrap=rFUStatusTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, neighborMACAddress=neighborMACAddress, ptpTrapPrefix=ptpTrapPrefix, maximumTransmitPower=maximumTransmitPower, hTTPAccessEnabled=hTTPAccessEnabled, rFUVersionBank1=rFUVersionBank1, rFUPlatformCompatibility=rFUPlatformCompatibility, sMTPEmailAlert=sMTPEmailAlert, sNMPCommunityString=sNMPCommunityString, radioLicenseBandwidth=radioLicenseBandwidth, managementPortStatus=managementPortStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerInternetAddress=sNTPServerInternetAddress, bridge=bridge, telnetAccessEnabled=telnetAccessEnabled, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, sNTPServerTableIndex=sNTPServerTableIndex, userTable=userTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, sNMPTrapIPAddress=sNMPTrapIPAddress, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, alignmentModeTrap=alignmentModeTrap, transmitCapacityLimitDetail=transmitCapacityLimitDetail, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, secureModeAlarm=secureModeAlarm, daylightSaving=daylightSaving, sMTPServerInternetAddress=sMTPServerInternetAddress, transmitterStatus=transmitterStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, cambium=cambium, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, iPv6GatewayAddress=iPv6GatewayAddress, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, userPassword=userPassword, reset=reset, ptpTraps=ptpTraps, dataPortStatusTrap=dataPortStatusTrap, qOSPriorityScheme=qOSPriorityScheme, snmpControl=snmpControl, rFUPowerButtonPressed=rFUPowerButtonPressed, rFUVersionBank2=rFUVersionBank2, receiveDataRate=receiveDataRate, neighborInternetAddress=neighborInternetAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, aTPCEnable=aTPCEnable, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, hTTPSAccessEnabled=hTTPSAccessEnabled, radioLicenseTxFreq=radioLicenseTxFreq, iPv4Address=iPv4Address, managementPortForcedConfiguration=managementPortForcedConfiguration, tFTPServerInternetAddressType=tFTPServerInternetAddressType, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ethernetPriorityTableEntry=ethernetPriorityTableEntry, activeWirelessLinkAvailability=activeWirelessLinkAvailability, dataPortDisabledWarning=dataPortDisabledWarning, timeZone=timeZone, protection=protection, vLANManagementVIDValidation=vLANManagementVIDValidation, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, diverseRfFeederLoss=diverseRfFeederLoss, syslogClient=syslogClient, transmitCapacity=transmitCapacity, transmitModulation=transmitModulation, sNTPServerTimeout=sNTPServerTimeout, radioLicenseMaxEIRP=radioLicenseMaxEIRP, rFUStatus=rFUStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rxDiversityVlanTpid=rxDiversityVlanTpid, ethernetPriorityTable=ethernetPriorityTable, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, wirelessLinkAvailability=wirelessLinkAvailability, primaryRecovery=primaryRecovery, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, dataPortWirelessDownAlert=dataPortWirelessDownAlert, minModulation=minModulation, requestedProtectionState=requestedProtectionState, enabledDiagnosticAlarms=enabledDiagnosticAlarms, remoteInternetAddressType=remoteInternetAddressType, userEnabled=userEnabled, mPLSTCPriorityTable=mPLSTCPriorityTable, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, phyStatus=phyStatus, endId=endId, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, tFTPServerPortNumber=tFTPServerPortNumber, bootVersion=bootVersion, systemReset=systemReset, alignmentMode=alignmentMode, rFURpsAlarm=rFURpsAlarm, radioLicenseCodeRate=radioLicenseCodeRate, alarms=alarms, protectionSwitchCause=protectionSwitchCause, configuration=configuration, remotePrimaryInternetAddress=remotePrimaryInternetAddress, linkNameMismatch=linkNameMismatch, rxDiversityDataPortStatus=rxDiversityDataPortStatus, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, sNTPServerResponse=sNTPServerResponse, protectionConfig=protectionConfig, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber, rfu=rfu, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapVersion=sNMPTrapVersion, receivePower=receivePower, sNTPServerTableEntry=sNTPServerTableEntry, l2CPPriorityTableIndex=l2CPPriorityTableIndex, activeAvailableTime=activeAvailableTime, sNMPTrapTable=sNMPTrapTable, siteName=siteName, userTableEntry=userTableEntry, dataPortPauseFrames=dataPortPauseFrames, latitude=latitude, userName=userName, sNTPServerTableNumber=sNTPServerTableNumber, versions=versions, managementPortDisabledWarning=managementPortDisabledWarning, userTableIndex=userTableIndex, rFUType=rFUType, neighborIPAddress=neighborIPAddress, rFUTxPowerMin=rFUTxPowerMin, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, encryption=encryption, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, transmitDataRate=transmitDataRate, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, syslogControl=syslogControl, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFUBranchingConfiguration=rFUBranchingConfiguration, linkNameMismatchTrap=linkNameMismatchTrap, dataPortStatus=dataPortStatus, productVariant=productVariant, sMTPEnabledMessages=sMTPEnabledMessages, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, receiveModulation=receiveModulation, pubStats=pubStats, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, managementPortStatusTrap=managementPortStatusTrap, telnetPortNumber=telnetPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPEnabledTraps=sNMPEnabledTraps, longitude=longitude, managementCommittedInformationRate=managementCommittedInformationRate, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, phyControl=phyControl, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, sNMPPortNumber=sNMPPortNumber, remoteSecondaryIPAddress=remoteSecondaryIPAddress, primarySecondaryMode=primarySecondaryMode, protectionStateTrap=protectionStateTrap, sNTPLastSync=sNTPLastSync, localPacketFiltering=localPacketFiltering, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, sNTPPrimaryServer=sNTPPrimaryServer, vectorError=vectorError, secondarySoftwareVersion=secondarySoftwareVersion, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, radioLicenseIdentifier=radioLicenseIdentifier)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", ethernetPriorityTableNumber=ethernetPriorityTableNumber, l2CPPriorityTable=l2CPPriorityTable, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, protectionAvailabilityStatus=protectionAvailabilityStatus, iPVersion=iPVersion, dataPortFiberStatus=dataPortFiberStatus, transmitPower=transmitPower, radioLicenseBand=radioLicenseBand, managementPortWirelessDownAlert=managementPortWirelessDownAlert, wirelessLinkStatus=wirelessLinkStatus, rFUTransceiverLocation=rFUTransceiverLocation, antennaGain=antennaGain, subnetMask=subnetMask, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, radioLicenseMinCodeRate=radioLicenseMinCodeRate, numberOfAntennas=numberOfAntennas, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sntp=sntp, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, radioLicenseRxFreq=radioLicenseRxFreq, protectionStats=protectionStats, sMTPServerInternetAddressType=sMTPServerInternetAddressType, aggregateDataRate=aggregateDataRate, rFUFreqSpacing=rFUFreqSpacing, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, unitOutOfCalibration=unitOutOfCalibration, faultProtectionSwitching=faultProtectionSwitching, rFUSerial=rFUSerial, rFUPowerAlarm=rFUPowerAlarm, sNTPSyncTrap=sNTPSyncTrap, enableTransmission=enableTransmission, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, rFURFSwitchAlarm=rFURFSwitchAlarm, userTableNumber=userTableNumber, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, supplementary=supplementary, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, encryptionAlgorithm=encryptionAlgorithm, radioLicenseMinModulation=radioLicenseMinModulation, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rFUProtectionCompatibility=rFUProtectionCompatibility, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rFFeederLoss=rFFeederLoss, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dSCPManagementPriority=dSCPManagementPriority, userRole=userRole, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFURxFreqMin=rFURxFreqMin, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, syslogStateTrap=syslogStateTrap, sNTPServerRetries=sNTPServerRetries, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vLANManagementVID=vLANManagementVID, encryptionEnabledMismatch=encryptionEnabledMismatch, remoteIPAddress=remoteIPAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, vLANManagementPriority=vLANManagementPriority, remotePrimaryMACAddress=remotePrimaryMACAddress, rxDiversityVid=rxDiversityVid, rFUTxPowerAlarm=rFUTxPowerAlarm, protectionConfigurationStatus=protectionConfigurationStatus, ptp800=ptp800, altitude=altitude, rFUTxBandAboveRx=rFUTxBandAboveRx, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rFUConnectedPlatform=rFUConnectedPlatform, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, sNMPTrapTableEntry=sNMPTrapTableEntry, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, minCodeRate=minCodeRate, sNTPServerPortNumber=sNTPServerPortNumber, iPv6PrefixLength=iPv6PrefixLength, licence=licence, transmitCodeRate=transmitCodeRate, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, remoteInternetAddress=remoteInternetAddress, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, hTTPPortNumber=hTTPPortNumber, diverseAntennaGain=diverseAntennaGain, sNTPSync=sNTPSync, iFCableLength=iFCableLength, productName=productName, remoteMACAddress=remoteMACAddress, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap)
