...
MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, TimeTicks, enterprises, Counter64, Unsigned32, iso, NotificationType, Counter32, IpAddress, ModuleIdentity, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "TimeTicks", "enterprises", "Counter64", "Unsigned32", "iso", "NotificationType", "Counter32", "IpAddress", "ModuleIdentity", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, requestedProtectionState=requestedProtectionState, snmpControl=snmpControl, sNMPTrapIPAddress=sNMPTrapIPAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, systemReset=systemReset, dataPortFiberStatusTrap=dataPortFiberStatusTrap, primaryRecoveryPeriod=primaryRecoveryPeriod, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, supplementary=supplementary, remoteInternetAddress=remoteInternetAddress, managementPortStatusTrap=managementPortStatusTrap, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTableNumber=sNMPTrapTableNumber, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, numberOfAntennas=numberOfAntennas, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, protectionConfig=protectionConfig, receiveCodeRate=receiveCodeRate, syslogClientTrap=syslogClientTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rFUPowerAlarm=rFUPowerAlarm, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFUSerial=rFUSerial, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, rFURpsAlarm=rFURpsAlarm, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, sNTPSyncTrap=sNTPSyncTrap, protectionStateTrap=protectionStateTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerResponse=sNTPServerResponse, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, unitOutOfCalibration=unitOutOfCalibration, latitude=latitude, sNMPPortNumber=sNMPPortNumber, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, transmitCapacityLimit=transmitCapacityLimit, versions=versions, rFUVersionBank1=rFUVersionBank1, linkName=linkName, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementCommittedInformationRate=managementCommittedInformationRate, ptpTraps=ptpTraps, secureModeAlarmTrap=secureModeAlarmTrap, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rFUCableAlarm=rFUCableAlarm, antennaGain=antennaGain, rFUTxFreqMin=rFUTxFreqMin, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, minCodeRate=minCodeRate, managementPortDisabledWarning=managementPortDisabledWarning, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, minModulation=minModulation, transmitCodeRate=transmitCodeRate, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receivePower=receivePower, iPv6GatewayAddress=iPv6GatewayAddress, maxModulation=maxModulation, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, secondarySoftwareVersion=secondarySoftwareVersion, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, radioLicenseRegion=radioLicenseRegion, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, secureModeAlarm=secureModeAlarm, reset=reset, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, radioLicense=radioLicense, activeAvailableTime=activeAvailableTime, syslogState=syslogState, rFUActiveFirmwareBank=rFUActiveFirmwareBank, sNTPServerIPAddress=sNTPServerIPAddress, protection=protection, syslogControl=syslogControl, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPState=sNTPState, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, bridge=bridge, sNTPServerTableEntry=sNTPServerTableEntry, subnetMask=subnetMask, tFTPServerPortNumber=tFTPServerPortNumber, radioLicenseTxFreq=radioLicenseTxFreq, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, diverseRfFeederLoss=diverseRfFeederLoss, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFURxFreqMin=rFURxFreqMin, rFUStatusTrap=rFUStatusTrap, rFUTxPowerMax=rFUTxPowerMax, radioLicenseBand=radioLicenseBand, ethernetPriorityTable=ethernetPriorityTable, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, smtp=smtp, rFUTransceiverLocation=rFUTransceiverLocation, vectorError=vectorError, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, managementPortForcedConfiguration=managementPortForcedConfiguration, rFUTxPowerAlarm=rFUTxPowerAlarm, userEnabled=userEnabled, protectionStatus=protectionStatus, cambium=cambium, productName=productName, hardwareVersion=hardwareVersion, transmitPower=transmitPower, ptp=ptp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPServerInternetAddress=sNTPServerInternetAddress, remotePrimaryInternetAddress=remotePrimaryInternetAddress, activeUnit=activeUnit, linkNameMismatch=linkNameMismatch, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, longitude=longitude, rFULockoutAlarm=rFULockoutAlarm, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANManagementVID=vLANManagementVID, sNTPServerPortNumber=sNTPServerPortNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPPollInterval=sNTPPollInterval, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, l2CPPriorityTableEntry=l2CPPriorityTableEntry, alignmentMode=alignmentMode, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dSCPManagementPriority=dSCPManagementPriority, transmitModulation=transmitModulation, remotePrimarySecondaryMode=remotePrimarySecondaryMode, neighborMACAddress=neighborMACAddress, userTable=userTable, iPv4Address=iPv4Address, sNTPSync=sNTPSync, wirelessLinkAvailability=wirelessLinkAvailability, localPacketFiltering=localPacketFiltering, userName=userName, timeZone=timeZone, protectionInterfaceStatus=protectionInterfaceStatus, fiberY=fiberY, diverseAntennaGain=diverseAntennaGain, remoteInternetAddressType=remoteInternetAddressType, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptmp=ptmp, bootVersion=bootVersion, neighborInternetAddress=neighborInternetAddress, syslogClient=syslogClient, telnetPortNumber=telnetPortNumber, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUTxMuteStatus=rFUTxMuteStatus, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, telnetAccessEnabled=telnetAccessEnabled, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, vLANManagementVIDValidation=vLANManagementVIDValidation, managementPortStatus=managementPortStatus, rFUVersionBank2=rFUVersionBank2, transmitCapacity=transmitCapacity, endId=endId, sntp=sntp, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, ethernetFiberSupport=ethernetFiberSupport, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rFUBranchingConfiguration=rFUBranchingConfiguration, primarySecondaryMode=primarySecondaryMode, iPv6Address=iPv6Address, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, transmitCapacityLimitDetail=transmitCapacityLimitDetail, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, phyStatus=phyStatus, alignmentModeTrap=alignmentModeTrap, protectionState=protectionState, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, userPassword=userPassword, rFUTxFreqMax=rFUTxFreqMax, iFCableLength=iFCableLength, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, remoteIPAddress=remoteIPAddress, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, userRole=userRole, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, sNTPServerRetries=sNTPServerRetries, sMTPEmailAlert=sMTPEmailAlert, remotePrimaryIPAddress=remotePrimaryIPAddress, hTTPSPortNumber=hTTPSPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, radioLicenseMaxModulation=radioLicenseMaxModulation, remotePrimaryMACAddress=remotePrimaryMACAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, faultProtectionSwitching=faultProtectionSwitching, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, maxCodeRate=maxCodeRate, neighborInternetAddressType=neighborInternetAddressType, activeWirelessLinkAvailability=activeWirelessLinkAvailability, sNMPTrapTableIndex=sNMPTrapTableIndex, managementPortAutoNegotiation=managementPortAutoNegotiation, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, hTTPSAccessEnabled=hTTPSAccessEnabled, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, sMTPServerIPAddress=sMTPServerIPAddress, linkNameMismatchTrap=linkNameMismatchTrap, dataPortFiberStatus=dataPortFiberStatus, protectionAvailabilityStatus=protectionAvailabilityStatus, rFURFSwitchAlarm=rFURFSwitchAlarm, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, qOSPriorityScheme=qOSPriorityScheme, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerTableIndex=sNTPServerTableIndex, remoteSecondaryIPAddress=remoteSecondaryIPAddress, transmitterStatus=transmitterStatus, protectionStats=protectionStats, rFUProtectionCompatibility=rFUProtectionCompatibility, rFURxFreqMax=rFURxFreqMax, protectionSwitchCause=protectionSwitchCause, maximumTransmitPower=maximumTransmitPower, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerTableNumber=sNTPServerTableNumber, radioLicenseRxFreq=radioLicenseRxFreq, alarms=alarms, iPv6PrefixLength=iPv6PrefixLength, primaryRecovery=primaryRecovery, protectionConfigurationStatus=protectionConfigurationStatus, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapVersion=sNMPTrapVersion, receiveDataRate=receiveDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, hTTPPortNumber=hTTPPortNumber, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFUFreqSpacing=rFUFreqSpacing, sNMPCommunityString=sNMPCommunityString, l2CPPriorityTable=l2CPPriorityTable, licence=licence, syslogStateTrap=syslogStateTrap, wirelessLinkStatus=wirelessLinkStatus, rFUTxBandAboveRx=rFUTxBandAboveRx, sMTPServerPortNumber=sMTPServerPortNumber, encryption=encryption, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, radioLicenseMaxEIRP=radioLicenseMaxEIRP, rxDiversityDataPortStatus=rxDiversityDataPortStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sMTPSourceEmailAddress=sMTPSourceEmailAddress, productVariant=productVariant)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", userTableEntry=userTableEntry, sNTPLastSync=sNTPLastSync, receiveModulation=receiveModulation, enableTransmission=enableTransmission, sNMPEnabledTraps=sNMPEnabledTraps, daylightSaving=daylightSaving, sNTPServerTimeout=sNTPServerTimeout, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, encryptionEnabledMismatch=encryptionEnabledMismatch, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, aggregateDataRate=aggregateDataRate, ethernetPriorityTableIndex=ethernetPriorityTableIndex, gatewayIPAddress=gatewayIPAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, neighborIPAddress=neighborIPAddress, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, configuration=configuration, iPVersion=iPVersion, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPPrimaryServer=sNTPPrimaryServer, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, rFUTxPowerMin=rFUTxPowerMin, wirelessLinkStatusTrap=wirelessLinkStatusTrap, sNTPServerTable=sNTPServerTable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortDisabledWarning=dataPortDisabledWarning, managementPortWirelessDownAlert=managementPortWirelessDownAlert, systemClock=systemClock, siteName=siteName, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ptp800=ptp800, mPLSTCPriorityTable=mPLSTCPriorityTable, hTTPAccessEnabled=hTTPAccessEnabled, remoteMACAddress=remoteMACAddress, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rFUType=rFUType, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rxDiversityVid=rxDiversityVid, sMTPEnabledMessages=sMTPEnabledMessages, rFUStatus=rFUStatus, aAAControl=aAAControl, dataPortPauseFrames=dataPortPauseFrames, securityLevel=securityLevel, transmitDataRate=transmitDataRate, ethernetPriorityTableNumber=ethernetPriorityTableNumber, pubStats=pubStats, tFTPServerIPAddress=tFTPServerIPAddress, radioLicenseIdentifier=radioLicenseIdentifier, rFUPlatformCompatibility=rFUPlatformCompatibility, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, radioLicenseCodeRate=radioLicenseCodeRate, dataPortWirelessDownAlert=dataPortWirelessDownAlert, management=management, altitude=altitude, radioLicenseBandwidth=radioLicenseBandwidth, iPDSCPPriorityTable=iPDSCPPriorityTable, managementMode=managementMode, userTableIndex=userTableIndex, ethernet=ethernet, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, dataPortStatusTrap=dataPortStatusTrap, radioLicenseModulation=radioLicenseModulation, rfu=rfu, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, radioLicenseMinModulation=radioLicenseMinModulation, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rFUPowerButtonPressed=rFUPowerButtonPressed, rFURfBand=rFURfBand, vLANManagementPriority=vLANManagementPriority, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, rxDiversityVlanTpid=rxDiversityVlanTpid, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkLoss=linkLoss, rFFeederLoss=rFFeederLoss, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, aTPCEnable=aTPCEnable, phyControl=phyControl, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, userTableNumber=userTableNumber, managementPortConfigurationMismatch=managementPortConfigurationMismatch, softwareVersion=softwareVersion, rFUConnectedPlatform=rFUConnectedPlatform, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType)
