...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", remoteSecondaryIPAddress=remoteSecondaryIPAddress, maxModulation=maxModulation, antennaGain=antennaGain, remoteMACAddress=remoteMACAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, vLANManagementVID=vLANManagementVID, activeUnit=activeUnit, linkNameMismatchTrap=linkNameMismatchTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, neighborInternetAddressType=neighborInternetAddressType, ethernetPriorityTableEntry=ethernetPriorityTableEntry, alarms=alarms, sNTPPrimaryServer=sNTPPrimaryServer, sNTPPollInterval=sNTPPollInterval, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, ptpTrapPrefix=ptpTrapPrefix, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, protectionState=protectionState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rFURxFreqMin=rFURxFreqMin, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hardwareVersion=hardwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, rFUTxPowerMin=rFUTxPowerMin, endId=endId, ptp=ptp, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapPortNumber=sNMPTrapPortNumber, rFURpsAlarm=rFURpsAlarm, primaryRecovery=primaryRecovery, dataPortPauseFrames=dataPortPauseFrames, l2CPPriorityTable=l2CPPriorityTable, sMTPServerInternetAddress=sMTPServerInternetAddress, rFUTxBandAboveRx=rFUTxBandAboveRx, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, iPv6PrefixLength=iPv6PrefixLength, telnetAccessEnabled=telnetAccessEnabled, supplementary=supplementary, syslogClientTrap=syslogClientTrap, receiveModulation=receiveModulation, remoteInternetAddress=remoteInternetAddress, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, protectionConfigurationStatus=protectionConfigurationStatus, gatewayIPAddress=gatewayIPAddress, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, aTPCEnable=aTPCEnable, secondarySoftwareVersion=secondarySoftwareVersion, radioLicenseTxFreq=radioLicenseTxFreq, hTTPSPortNumber=hTTPSPortNumber, protectionStatus=protectionStatus, sNTPServerTable=sNTPServerTable, systemReset=systemReset, daylightSaving=daylightSaving, rFUCableAlarm=rFUCableAlarm, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rfu=rfu, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPServerTimeout=sNTPServerTimeout, transmitModulation=transmitModulation, syslogState=syslogState, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPServerTableEntry=sNTPServerTableEntry, managementMode=managementMode, sNMPPortNumber=sNMPPortNumber, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFUTxPowerMax=rFUTxPowerMax, cambium=cambium, aAAControl=aAAControl, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, telnetPortNumber=telnetPortNumber, phyStatus=phyStatus, receivePower=receivePower, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementCommittedInformationRate=managementCommittedInformationRate, transmitPower=transmitPower, enabledDiagnosticAlarms=enabledDiagnosticAlarms, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, productName=productName, sNMPEnabledTraps=sNMPEnabledTraps, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, vLANManagementPriority=vLANManagementPriority, pubStats=pubStats, sNTPSyncTrap=sNTPSyncTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, transmitCapacityLimit=transmitCapacityLimit, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rFUTxFreqMin=rFUTxFreqMin, linkLoss=linkLoss, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, radioLicenseCodeRate=radioLicenseCodeRate, rFUTxMuteStatus=rFUTxMuteStatus, radioLicense=radioLicense, syslogStateTrap=syslogStateTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkStatusTrap=wirelessLinkStatusTrap, sNTPServerPortNumber=sNTPServerPortNumber, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, remotePrimaryMACAddress=remotePrimaryMACAddress, maxCodeRate=maxCodeRate, radioLicenseBandwidth=radioLicenseBandwidth, neighborInternetAddress=neighborInternetAddress, vLANManagementVIDValidation=vLANManagementVIDValidation, receiveCodeRate=receiveCodeRate, sNMPTrapTableNumber=sNMPTrapTableNumber, rFUVersionBank1=rFUVersionBank1, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, managementPortForcedConfiguration=managementPortForcedConfiguration, rFUStatusTrap=rFUStatusTrap, fiberY=fiberY, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, radioLicenseRxFreq=radioLicenseRxFreq, userEnabled=userEnabled, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rFURfBand=rFURfBand, remoteMaximumTransmitPower=remoteMaximumTransmitPower, versions=versions, userPassword=userPassword, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, management=management, hTTPAccessEnabled=hTTPAccessEnabled, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPServerRetries=sNTPServerRetries, requestedProtectionState=requestedProtectionState, iPDSCPPriorityTable=iPDSCPPriorityTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, siteName=siteName, rFUVersionBank2=rFUVersionBank2, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rxDiversityDataPortStatus=rxDiversityDataPortStatus, remotePrimaryIPAddress=remotePrimaryIPAddress, sNTPLastSync=sNTPLastSync, syslogLocalWrappedTrap=syslogLocalWrappedTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, managementPortAutoNegotiation=managementPortAutoNegotiation, bootVersion=bootVersion, radioLicenseIdentifier=radioLicenseIdentifier, primarySecondaryMode=primarySecondaryMode, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, userName=userName, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, syslogClient=syslogClient, productVariant=productVariant, protectionSwitchCause=protectionSwitchCause, protectionAvailabilityStatus=protectionAvailabilityStatus, iPv4Address=iPv4Address, diverseAntennaGain=diverseAntennaGain, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, localPacketFiltering=localPacketFiltering, tFTPServerInternetAddress=tFTPServerInternetAddress, activeAvailableTime=activeAvailableTime, rxDiversityVid=rxDiversityVid, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, syslogControl=syslogControl, softwareVersion=softwareVersion, rFUTxPowerAlarm=rFUTxPowerAlarm, userTable=userTable, tFTPServerIPAddress=tFTPServerIPAddress, neighborIPAddress=neighborIPAddress, radioLicenseMinCodeRate=radioLicenseMinCodeRate, encryptionEnabledMismatch=encryptionEnabledMismatch, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sNTPServerTableNumber=sNTPServerTableNumber, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveDataRate=receiveDataRate, sNMPTrapIPAddress=sNMPTrapIPAddress, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, managementPortDisabledWarning=managementPortDisabledWarning, protectionStateTrap=protectionStateTrap, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, vectorError=vectorError, sntp=sntp, primaryRecoveryPeriod=primaryRecoveryPeriod, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFUConnectedPlatform=rFUConnectedPlatform, ethernetPriorityTableNumber=ethernetPriorityTableNumber, numberOfAntennas=numberOfAntennas, enableTransmission=enableTransmission, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, altitude=altitude, rFURxFreqMax=rFURxFreqMax, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPSync=sNTPSync, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFUPlatformCompatibility=rFUPlatformCompatibility, sNTPServerTableIndex=sNTPServerTableIndex, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, unitOutOfCalibration=unitOutOfCalibration, configuration=configuration, activeWirelessLinkAvailability=activeWirelessLinkAvailability, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPVersion=iPVersion, rFUStatus=rFUStatus, hTTPPortNumber=hTTPPortNumber, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, sNMPCommunityString=sNMPCommunityString, sNTPState=sNTPState, phyControl=phyControl, ethernet=ethernet, ptmp=ptmp, rFUBranchingConfiguration=rFUBranchingConfiguration, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, remoteInternetAddressType=remoteInternetAddressType, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, protection=protection, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, timeZone=timeZone, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, rFUTransceiverLocation=rFUTransceiverLocation, sNMPTrapTableIndex=sNMPTrapTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, smtp=smtp, iFCableLength=iFCableLength, transmitCodeRate=transmitCodeRate, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, remotePrimaryInternetAddress=remotePrimaryInternetAddress, dataPortStatus=dataPortStatus, aggregateDataRate=aggregateDataRate, userTableNumber=userTableNumber, remotePrimarySecondaryMode=remotePrimarySecondaryMode, ethernetPriorityTable=ethernetPriorityTable, mPLSTCPriorityTable=mPLSTCPriorityTable, protectionInterfaceStatus=protectionInterfaceStatus, rFUType=rFUType, sMTPServerIPAddress=sMTPServerIPAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", transmitCapacityLimitDetail=transmitCapacityLimitDetail, sNMPTrapVersion=sNMPTrapVersion, userTableEntry=userTableEntry, sMTPEmailAlert=sMTPEmailAlert, dataPortFiberStatus=dataPortFiberStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rFUPowerAlarm=rFUPowerAlarm, protectionConfig=protectionConfig, tFTPServerPortNumber=tFTPServerPortNumber, userRole=userRole, linkName=linkName, transmitterStatus=transmitterStatus, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, alignmentModeTrap=alignmentModeTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, bridge=bridge, radioLicenseMaxModulation=radioLicenseMaxModulation, maximumTransmitPower=maximumTransmitPower, neighborMACAddress=neighborMACAddress, snmpControl=snmpControl, rFFeederLoss=rFFeederLoss, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, licence=licence, rFUFreqSpacing=rFUFreqSpacing, longitude=longitude, protectionStats=protectionStats, wirelessLinkStatus=wirelessLinkStatus, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, qOSPriorityScheme=qOSPriorityScheme, dataPortStatusTrap=dataPortStatusTrap, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, ptp800=ptp800, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, minModulation=minModulation, rxDiversityVlanTpid=rxDiversityVlanTpid, sNMPTrapTable=sNMPTrapTable, transmitDataRate=transmitDataRate, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ptpTraps=ptpTraps, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, linkNameMismatch=linkNameMismatch, radioLicenseModulation=radioLicenseModulation, reset=reset, radioLicenseRegion=radioLicenseRegion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortDisabledWarning=dataPortDisabledWarning, systemClock=systemClock, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, iPv6GatewayAddress=iPv6GatewayAddress, rFUPowerButtonPressed=rFUPowerButtonPressed, dSCPManagementPriority=dSCPManagementPriority, securityLevel=securityLevel, rFUSerial=rFUSerial, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerIPAddress=sNTPServerIPAddress, radioLicenseBand=radioLicenseBand, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rFUActiveFirmwareBank=rFUActiveFirmwareBank, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rFULockoutAlarm=rFULockoutAlarm, radioLicenseMinModulation=radioLicenseMinModulation, rFUProtectionCompatibility=rFUProtectionCompatibility, faultProtectionSwitching=faultProtectionSwitching, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, remoteIPAddress=remoteIPAddress, minCodeRate=minCodeRate, transmitCapacity=transmitCapacity, alignmentMode=alignmentMode, userTableIndex=userTableIndex, secureModeAlarm=secureModeAlarm, encryption=encryption, latitude=latitude, managementPortStatus=managementPortStatus, diverseRfFeederLoss=diverseRfFeederLoss, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, managementPortStatusTrap=managementPortStatusTrap, subnetMask=subnetMask, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rFURFSwitchAlarm=rFURFSwitchAlarm, sNTPServerResponse=sNTPServerResponse, secureModeAlarmTrap=secureModeAlarmTrap, iPv6Address=iPv6Address, rFUTxFreqMax=rFUTxFreqMax)
