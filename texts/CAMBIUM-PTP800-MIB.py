...
Counter32, MibIdentifier, ModuleIdentity, Bits, Integer32, TimeTicks, Gauge32, enterprises, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, iso, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "ModuleIdentity", "Bits", "Integer32", "TimeTicks", "Gauge32", "enterprises", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "iso", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", pubStats=pubStats, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, aTPCEnable=aTPCEnable, managementPortStatusTrap=managementPortStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, remotePrimaryMACAddress=remotePrimaryMACAddress, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFURxFreqMax=rFURxFreqMax, rFUBranchingConfiguration=rFUBranchingConfiguration, rFURxFreqMin=rFURxFreqMin, dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementPortWirelessDownAlert=managementPortWirelessDownAlert, unitOutOfCalibration=unitOutOfCalibration, gatewayIPAddress=gatewayIPAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, iFCableLength=iFCableLength, managementPortStatus=managementPortStatus, systemReset=systemReset, ptpTraps=ptpTraps, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPTrapPortNumber=sNMPTrapPortNumber, rFUStatusTrap=rFUStatusTrap, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, altitude=altitude, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rFUTxFreqMax=rFUTxFreqMax, sNTPServerIPAddress=sNTPServerIPAddress, rFUActiveFirmwareBank=rFUActiveFirmwareBank, radioLicenseIdentifier=radioLicenseIdentifier, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, remoteSecondaryIPAddress=remoteSecondaryIPAddress, cambium=cambium, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, managementCommittedInformationRate=managementCommittedInformationRate, versions=versions, iPv4Address=iPv4Address, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, ptp=ptp, sNMPEnabledTraps=sNMPEnabledTraps, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, transmitterStatus=transmitterStatus, rFULockoutAlarm=rFULockoutAlarm, managementPortDisabledWarning=managementPortDisabledWarning, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, endId=endId, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerResponse=sNTPServerResponse, transmitDataRate=transmitDataRate, encryptionAlgorithm=encryptionAlgorithm, protectionConfigurationStatus=protectionConfigurationStatus, rFURFSwitchAlarm=rFURFSwitchAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, productVariant=productVariant, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, sNMPTrapTableIndex=sNMPTrapTableIndex, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, timeZone=timeZone, radioLicenseBand=radioLicenseBand, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, primarySecondaryMode=primarySecondaryMode, userTableNumber=userTableNumber, smtp=smtp, sNTPServerTableEntry=sNTPServerTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, linkNameMismatchTrap=linkNameMismatchTrap, vLANManagementPriority=vLANManagementPriority, rFURpsAlarm=rFURpsAlarm, rFUTxMuteStatus=rFUTxMuteStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFUStatus=rFUStatus, remotePrimaryInternetAddress=remotePrimaryInternetAddress, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, neighborInternetAddress=neighborInternetAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitCapacity=transmitCapacity, vectorError=vectorError, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFUTxPowerMin=rFUTxPowerMin, protectionState=protectionState, ethernetPriorityTableNumber=ethernetPriorityTableNumber, radioLicenseModulation=radioLicenseModulation, protectionConfig=protectionConfig, protectionStats=protectionStats, radioLicenseCodeRate=radioLicenseCodeRate, radioLicenseTxFreq=radioLicenseTxFreq, sNTPServerTable=sNTPServerTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, managementPortForcedConfiguration=managementPortForcedConfiguration, rFUProtectionCompatibility=rFUProtectionCompatibility, licence=licence, dataPortDisabledWarning=dataPortDisabledWarning, receiveCodeRate=receiveCodeRate, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, syslogClientTrap=syslogClientTrap, syslogClient=syslogClient, dataPortFiberStatus=dataPortFiberStatus, userTableIndex=userTableIndex, linkLoss=linkLoss, protection=protection, userTable=userTable, ptmp=ptmp, sNTPServerTimeout=sNTPServerTimeout, rFUPowerButtonPressed=rFUPowerButtonPressed, dSCPManagementPriority=dSCPManagementPriority, faultProtectionSwitching=faultProtectionSwitching, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, radioLicense=radioLicense, softwareVersion=softwareVersion, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, sMTPEmailAlert=sMTPEmailAlert, rFUTransceiverLocation=rFUTransceiverLocation, rxDiversityDataPortStatus=rxDiversityDataPortStatus, tFTPServerIPAddress=tFTPServerIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, telnetPortNumber=telnetPortNumber, encryption=encryption, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkNameMismatch=linkNameMismatch, protectionStatus=protectionStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, sNMPTrapTableEntry=sNMPTrapTableEntry, iPVersion=iPVersion, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, protectionInterfaceStatus=protectionInterfaceStatus, dataPortStatus=dataPortStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, latitude=latitude, siteName=siteName, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapIPAddress=sNMPTrapIPAddress, remoteSecondaryMACAddress=remoteSecondaryMACAddress, sNMPCommunityString=sNMPCommunityString, alignmentMode=alignmentMode, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, configuration=configuration, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, sNMPPortNumber=sNMPPortNumber, alignmentModeTrap=alignmentModeTrap, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, fiberY=fiberY, tFTPServerPortNumber=tFTPServerPortNumber, antennaGain=antennaGain, bridge=bridge, receiveDataRate=receiveDataRate, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, diverseRfFeederLoss=diverseRfFeederLoss, hTTPAccessEnabled=hTTPAccessEnabled, vLANManagementVIDValidation=vLANManagementVIDValidation, systemClock=systemClock, subnetMask=subnetMask, dataPortPauseFrames=dataPortPauseFrames, sNMPTrapTable=sNMPTrapTable, rfu=rfu, l2CPPriorityTableEntry=l2CPPriorityTableEntry, minModulation=minModulation, neighborInternetAddressType=neighborInternetAddressType, receiveModulation=receiveModulation, maximumTransmitPower=maximumTransmitPower, securityLevel=securityLevel, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sntp=sntp, managementMode=managementMode, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, protectionAvailabilityStatus=protectionAvailabilityStatus, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, dataPortFiberStatusTrap=dataPortFiberStatusTrap, diverseAntennaGain=diverseAntennaGain, sNTPSync=sNTPSync, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, daylightSaving=daylightSaving, neighborMACAddress=neighborMACAddress, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, primaryRecoveryPeriod=primaryRecoveryPeriod, encryptionEnabledMismatch=encryptionEnabledMismatch, rFUType=rFUType, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rxDiversityVlanTpid=rxDiversityVlanTpid, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, protectionStateTrap=protectionStateTrap, phyControl=phyControl, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, aAAControl=aAAControl, remotePrimaryIPAddress=remotePrimaryIPAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, radioLicenseMinCodeRate=radioLicenseMinCodeRate, sNTPSyncTrap=sNTPSyncTrap, sNTPLastSync=sNTPLastSync, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPPollInterval=sNTPPollInterval, longitude=longitude, mPLSTCPriorityTable=mPLSTCPriorityTable, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, ptp800=ptp800, hardwareVersion=hardwareVersion, radioLicenseRxFreq=radioLicenseRxFreq, maxModulation=maxModulation, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, syslogState=syslogState, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, l2CPPriorityTable=l2CPPriorityTable, rFUConnectedPlatform=rFUConnectedPlatform, phyStatus=phyStatus, ethernetFiberSupport=ethernetFiberSupport, ethernet=ethernet, linkName=linkName, transmitCapacityLimit=transmitCapacityLimit, tFTPServerInternetAddress=tFTPServerInternetAddress, rFURfBand=rFURfBand, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPServerPortNumber=sNTPServerPortNumber, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, remoteIPAddress=remoteIPAddress, rFUFreqSpacing=rFUFreqSpacing, iPv6Address=iPv6Address, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, vLANManagementVID=vLANManagementVID, remoteMACAddress=remoteMACAddress, rFUTxPowerMax=rFUTxPowerMax, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, transmitPower=transmitPower, remoteInternetAddressType=remoteInternetAddressType, transmitModulation=transmitModulation, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, userName=userName, sNTPServerRetries=sNTPServerRetries, management=management, numberOfAntennas=numberOfAntennas, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitCodeRate=transmitCodeRate, hTTPPortNumber=hTTPPortNumber, iPv6PrefixLength=iPv6PrefixLength)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", activeUnit=activeUnit, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rFUTxFreqMin=rFUTxFreqMin, rFUTxBandAboveRx=rFUTxBandAboveRx, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, minCodeRate=minCodeRate, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, qOSPriorityScheme=qOSPriorityScheme, rFUSerial=rFUSerial, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFUVersionBank1=rFUVersionBank1, rxDiversityVid=rxDiversityVid, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rFFeederLoss=rFFeederLoss, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, maxCodeRate=maxCodeRate, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogStateTrap=syslogStateTrap, radioLicenseMaxModulation=radioLicenseMaxModulation, userEnabled=userEnabled, hTTPSPortNumber=hTTPSPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, localPacketFiltering=localPacketFiltering, secureModeAlarm=secureModeAlarm, managementPortConfigurationMismatch=managementPortConfigurationMismatch, aggregateDataRate=aggregateDataRate, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, receivePower=receivePower, userTableEntry=userTableEntry, rFUPowerAlarm=rFUPowerAlarm, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, protectionSwitchCause=protectionSwitchCause, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, sNMPTrapVersion=sNMPTrapVersion, productName=productName, sNTPState=sNTPState, managementPortAutoNegotiation=managementPortAutoNegotiation, sMTPServerInternetAddress=sMTPServerInternetAddress, wirelessLinkStatusTrap=wirelessLinkStatusTrap, sNTPPrimaryServer=sNTPPrimaryServer, remoteInternetAddress=remoteInternetAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, wirelessLinkStatus=wirelessLinkStatus, alarms=alarms, activeWirelessLinkAvailability=activeWirelessLinkAvailability, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, requestedProtectionState=requestedProtectionState, radioLicenseBandwidth=radioLicenseBandwidth, rFUVersionBank2=rFUVersionBank2, userPassword=userPassword, reset=reset, enableTransmission=enableTransmission, supplementary=supplementary, snmpControl=snmpControl, rFUCableAlarm=rFUCableAlarm, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rFUTxPowerAlarm=rFUTxPowerAlarm, userRole=userRole, radioLicenseRegion=radioLicenseRegion, syslogControl=syslogControl, rFUPlatformCompatibility=rFUPlatformCompatibility, ethernetPriorityTable=ethernetPriorityTable, secureModeAlarmTrap=secureModeAlarmTrap, primaryRecovery=primaryRecovery, bootVersion=bootVersion, ptpTrapPrefix=ptpTrapPrefix, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, telnetAccessEnabled=telnetAccessEnabled, radioLicenseMinModulation=radioLicenseMinModulation, sNTPServerTableIndex=sNTPServerTableIndex, neighborIPAddress=neighborIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, sNTPServerTableNumber=sNTPServerTableNumber, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortStatusTrap=dataPortStatusTrap, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, transmitCapacityLimitDetail=transmitCapacityLimitDetail, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, activeAvailableTime=activeAvailableTime)
