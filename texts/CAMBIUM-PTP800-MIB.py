...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", neighborInternetAddress=neighborInternetAddress, iPv6GatewayAddress=iPv6GatewayAddress, linkNameMismatch=linkNameMismatch, sNMPEnabledTraps=sNMPEnabledTraps, managementCommittedInformationRate=managementCommittedInformationRate, transmitterStatus=transmitterStatus, sNTPServerTable=sNTPServerTable, syslogState=syslogState, dataPortStatus=dataPortStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rFURfBand=rFURfBand, radioLicenseIdentifier=radioLicenseIdentifier, wirelessLinkStatus=wirelessLinkStatus, protectionStats=protectionStats, remotePrimaryMACAddress=remotePrimaryMACAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, userTable=userTable, managementMode=managementMode, faultProtectionSwitching=faultProtectionSwitching, phyControl=phyControl, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, userTableNumber=userTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, ptpTrapPrefix=ptpTrapPrefix, sNMPPortNumber=sNMPPortNumber, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, tFTPServerPortNumber=tFTPServerPortNumber, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, alignmentMode=alignmentMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rFURxFreqMax=rFURxFreqMax, dataPortStatusTrap=dataPortStatusTrap, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, sNTPSync=sNTPSync, wirelessLinkAvailability=wirelessLinkAvailability, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPServerIPAddress=tFTPServerIPAddress, aggregateDataRate=aggregateDataRate, sMTPServerInternetAddress=sMTPServerInternetAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, reset=reset, userPassword=userPassword, protection=protection, rFURFSwitchAlarm=rFURFSwitchAlarm, minCodeRate=minCodeRate, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rFUTxFreqMax=rFUTxFreqMax, aAAControl=aAAControl, telnetAccessEnabled=telnetAccessEnabled, siteName=siteName, receiveCodeRate=receiveCodeRate, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFUTxBandAboveRx=rFUTxBandAboveRx, userRole=userRole, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, managementPortAutoNegotiation=managementPortAutoNegotiation, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, endId=endId, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, minModulation=minModulation, ptpTraps=ptpTraps, sNTPServerIPAddress=sNTPServerIPAddress, secureModeAlarm=secureModeAlarm, sMTPServerPortNumber=sMTPServerPortNumber, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, tFTPServerInternetAddress=tFTPServerInternetAddress, systemReset=systemReset, dataPortPauseFrames=dataPortPauseFrames, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerTableIndex=sNTPServerTableIndex, fiberY=fiberY, licence=licence, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPServerRetries=sNTPServerRetries, iFCableLength=iFCableLength, diverseRfFeederLoss=diverseRfFeederLoss, transmitCapacityLimit=transmitCapacityLimit, rFUTxFreqMin=rFUTxFreqMin, sNTPServerTableEntry=sNTPServerTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, requestedProtectionState=requestedProtectionState, linkNameMismatchTrap=linkNameMismatchTrap, sNTPLastSync=sNTPLastSync, receiveDataRate=receiveDataRate, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rFUConnectedPlatform=rFUConnectedPlatform, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, supplementary=supplementary, rFUTxPowerAlarm=rFUTxPowerAlarm, rFUType=rFUType, syslogClient=syslogClient, syslogStateTrap=syslogStateTrap, enableTransmission=enableTransmission, numberOfAntennas=numberOfAntennas, maxCodeRate=maxCodeRate, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, encryptionEnabledMismatch=encryptionEnabledMismatch, alignmentModeTrap=alignmentModeTrap, radioLicenseRegion=radioLicenseRegion, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, radioLicenseMaxModulation=radioLicenseMaxModulation, syslogControl=syslogControl, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, protectionStateTrap=protectionStateTrap, dataPortFiberStatus=dataPortFiberStatus, maximumTransmitPower=maximumTransmitPower, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPSyncTrap=sNTPSyncTrap, rxDiversityVlanTpid=rxDiversityVlanTpid, daylightSaving=daylightSaving, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, receivePower=receivePower, timeZone=timeZone, rFUPowerButtonPressed=rFUPowerButtonPressed, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, productVariant=productVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remotePrimaryInternetAddress=remotePrimaryInternetAddress, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, l2CPPriorityTable=l2CPPriorityTable, protectionState=protectionState, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rxDiversityDataPortStatus=rxDiversityDataPortStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPVersion=iPVersion, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remoteInternetAddress=remoteInternetAddress, neighborIPAddress=neighborIPAddress, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, altitude=altitude, sMTPServerIPAddress=sMTPServerIPAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, secondarySoftwareVersion=secondarySoftwareVersion, encryptionAlgorithm=encryptionAlgorithm, cambium=cambium, transmitCapacity=transmitCapacity, ethernetPriorityTable=ethernetPriorityTable, sNMPTrapIPAddress=sNMPTrapIPAddress, radioLicenseCodeRate=radioLicenseCodeRate, subnetMask=subnetMask, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, managementPortDisabledWarning=managementPortDisabledWarning, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, activeWirelessLinkAvailability=activeWirelessLinkAvailability, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapTable=sNMPTrapTable, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, activeUnit=activeUnit, sNTPServerInternetAddress=sNTPServerInternetAddress, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, remoteInternetAddressType=remoteInternetAddressType, secureModeAlarmTrap=secureModeAlarmTrap, sNTPPollInterval=sNTPPollInterval, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rFUTransceiverLocation=rFUTransceiverLocation, rFUPlatformCompatibility=rFUPlatformCompatibility, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, ethernet=ethernet, sNTPServerTimeout=sNTPServerTimeout, rFUTxMuteStatus=rFUTxMuteStatus, versions=versions, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetFiberSupport=ethernetFiberSupport, protectionConfigurationStatus=protectionConfigurationStatus, linkLoss=linkLoss, radioLicenseMinModulation=radioLicenseMinModulation, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, smtp=smtp, vLANManagementVIDValidation=vLANManagementVIDValidation, softwareVersion=softwareVersion, receiveModulation=receiveModulation, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, aTPCEnable=aTPCEnable, userName=userName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, hTTPSPortNumber=hTTPSPortNumber, transmitDataRate=transmitDataRate, dSCPManagementPriority=dSCPManagementPriority, rFFeederLoss=rFFeederLoss, sNTPServerTableNumber=sNTPServerTableNumber, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFUStatusTrap=rFUStatusTrap, protectionConfig=protectionConfig, useVLANForManagementInterfaces=useVLANForManagementInterfaces, longitude=longitude, gatewayIPAddress=gatewayIPAddress, alarms=alarms, primaryRecoveryPeriod=primaryRecoveryPeriod, rFUActiveFirmwareBank=rFUActiveFirmwareBank, vLANManagementVID=vLANManagementVID, protectionAvailabilityStatus=protectionAvailabilityStatus, pubStats=pubStats, management=management, qOSPriorityScheme=qOSPriorityScheme, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rxDiversityVid=rxDiversityVid, phyStatus=phyStatus, rFUVersionBank2=rFUVersionBank2, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sntp=sntp, unitOutOfCalibration=unitOutOfCalibration, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, radioLicenseBandwidth=radioLicenseBandwidth, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rFUBranchingConfiguration=rFUBranchingConfiguration, remotePrimaryIPAddress=remotePrimaryIPAddress, transmitPower=transmitPower, remoteIPAddress=remoteIPAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, sMTPEmailAlert=sMTPEmailAlert, transmitModulation=transmitModulation, radioLicenseRxFreq=radioLicenseRxFreq, bootVersion=bootVersion, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, sMTPServerInternetAddressType=sMTPServerInternetAddressType, antennaGain=antennaGain, rFURxFreqMin=rFURxFreqMin, rFUTxPowerMin=rFUTxPowerMin, protectionInterfaceStatus=protectionInterfaceStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, latitude=latitude, localPacketFiltering=localPacketFiltering, sNMPTrapVersion=sNMPTrapVersion, rFUTxPowerMax=rFUTxPowerMax, tFTPServerInternetAddressType=tFTPServerInternetAddressType, remoteMACAddress=remoteMACAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rFUSerial=rFUSerial, vectorError=vectorError, sNTPServerResponse=sNTPServerResponse, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, neighborInternetAddressType=neighborInternetAddressType, radioLicenseMaxEIRP=radioLicenseMaxEIRP, ptp800=ptp800, maxModulation=maxModulation)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", dataPortFiberStatusTrap=dataPortFiberStatusTrap, diverseAntennaGain=diverseAntennaGain, syslogClientTrap=syslogClientTrap, primaryRecovery=primaryRecovery, protectionSwitchCause=protectionSwitchCause, mPLSTCPriorityTable=mPLSTCPriorityTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, radioLicenseTxFreq=radioLicenseTxFreq, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, userEnabled=userEnabled, iPv6PrefixLength=iPv6PrefixLength, transmitCapacityLimitDetail=transmitCapacityLimitDetail, rFUProtectionCompatibility=rFUProtectionCompatibility, iPDSCPPriorityTable=iPDSCPPriorityTable, configuration=configuration, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPPrimaryServer=sNTPPrimaryServer, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hTTPPortNumber=hTTPPortNumber, sNMPCommunityString=sNMPCommunityString, userTableEntry=userTableEntry, vLANManagementPriority=vLANManagementPriority, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, rFUStatus=rFUStatus, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, ptp=ptp, primarySecondaryMode=primarySecondaryMode, encryption=encryption, managementPortStatus=managementPortStatus, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, radioLicenseBand=radioLicenseBand, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, productName=productName, bridge=bridge, systemClock=systemClock, radioLicense=radioLicense, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkName=linkName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUCableAlarm=rFUCableAlarm, rFUPowerAlarm=rFUPowerAlarm, dataPortDisabledWarning=dataPortDisabledWarning, ptmp=ptmp, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, activeAvailableTime=activeAvailableTime, rfu=rfu, rFUFreqSpacing=rFUFreqSpacing, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rFULockoutAlarm=rFULockoutAlarm, transmitCodeRate=transmitCodeRate, telnetPortNumber=telnetPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, snmpControl=snmpControl, hardwareVersion=hardwareVersion, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, userTableIndex=userTableIndex, remoteSecondaryIPAddress=remoteSecondaryIPAddress, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, managementPortForcedConfiguration=managementPortForcedConfiguration, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iPv6Address=iPv6Address, hTTPAccessEnabled=hTTPAccessEnabled, neighborMACAddress=neighborMACAddress, securityLevel=securityLevel, managementPortStatusTrap=managementPortStatusTrap, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, sNTPState=sNTPState, radioLicenseMinCodeRate=radioLicenseMinCodeRate, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, iPv4Address=iPv4Address, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, rFURpsAlarm=rFURpsAlarm, radioLicenseModulation=radioLicenseModulation, sNMPTrapTableIndex=sNMPTrapTableIndex, protectionStatus=protectionStatus, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFUVersionBank1=rFUVersionBank1, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber)
