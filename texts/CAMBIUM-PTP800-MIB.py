...
Counter64, Counter32, enterprises, Bits, iso, IpAddress, Gauge32, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, NotificationType, Integer32, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Counter32", "enterprises", "Bits", "iso", "IpAddress", "Gauge32", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "NotificationType", "Integer32", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", managementPortAutoNegotiation=managementPortAutoNegotiation, daylightSaving=daylightSaving, protectionStateTrap=protectionStateTrap, primarySecondaryMode=primarySecondaryMode, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPServerTableEntry=sNTPServerTableEntry, requestedProtectionState=requestedProtectionState, remotePrimaryIPAddress=remotePrimaryIPAddress, rFUTransceiverLocation=rFUTransceiverLocation, qOSPriorityScheme=qOSPriorityScheme, wirelessLinkStatusTrap=wirelessLinkStatusTrap, transmitCapacity=transmitCapacity, radioLicenseRxFreq=radioLicenseRxFreq, vLANManagementPriority=vLANManagementPriority, rFURpsAlarm=rFURpsAlarm, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, wirelessLinkAvailability=wirelessLinkAvailability, pubStats=pubStats, l2CPPriorityTable=l2CPPriorityTable, sNTPSync=sNTPSync, neighborMACAddress=neighborMACAddress, minCodeRate=minCodeRate, sMTPEmailAlert=sMTPEmailAlert, rFUPowerButtonPressed=rFUPowerButtonPressed, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogClient=syslogClient, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, radioLicenseMinCodeRate=radioLicenseMinCodeRate, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, remoteInternetAddress=remoteInternetAddress, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, linkName=linkName, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, userName=userName, rFUVersionBank2=rFUVersionBank2, sNMPTrapIPAddress=sNMPTrapIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitCodeRate=transmitCodeRate, iPv6Address=iPv6Address, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, encryption=encryption, sNTPServerRetries=sNTPServerRetries, sNTPSyncTrap=sNTPSyncTrap, protectionStatus=protectionStatus, linkNameMismatch=linkNameMismatch, phyStatus=phyStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, userTable=userTable, transmitPower=transmitPower, userTableNumber=userTableNumber, remotePrimaryMACAddress=remotePrimaryMACAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, tFTPServerIPAddress=tFTPServerIPAddress, dataPortStatus=dataPortStatus, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, encryptionEnabledMismatch=encryptionEnabledMismatch, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, systemClock=systemClock, transmitCapacityLimit=transmitCapacityLimit, radioLicenseMaxModulation=radioLicenseMaxModulation, radioLicenseBandwidth=radioLicenseBandwidth, radioLicenseCodeRate=radioLicenseCodeRate, bootVersion=bootVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, minModulation=minModulation, sntp=sntp, sNTPServerTable=sNTPServerTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, managementMode=managementMode, sNTPServerTableNumber=sNTPServerTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, neighborIPAddress=neighborIPAddress, managementPortStatusTrap=managementPortStatusTrap, diverseRfFeederLoss=diverseRfFeederLoss, sNMPCommunityString=sNMPCommunityString, latitude=latitude, rFUPowerAlarm=rFUPowerAlarm, rxDiversityDataPortStatus=rxDiversityDataPortStatus, antennaGain=antennaGain, sNTPServerIPAddress=sNTPServerIPAddress, rFUBranchingConfiguration=rFUBranchingConfiguration, transmitterStatus=transmitterStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, remotePrimarySecondaryMode=remotePrimarySecondaryMode, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, receivePower=receivePower, activeUnit=activeUnit, neighborInternetAddressType=neighborInternetAddressType, tFTPServerPortNumber=tFTPServerPortNumber, licence=licence, iPVersion=iPVersion, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, ethernetPriorityTableIndex=ethernetPriorityTableIndex, secureModeAlarm=secureModeAlarm, radioLicenseMaxEIRP=radioLicenseMaxEIRP, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, userEnabled=userEnabled, rxDiversityVlanTpid=rxDiversityVlanTpid, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetFiberSupport=ethernetFiberSupport, unitOutOfCalibration=unitOutOfCalibration, rFUStatusTrap=rFUStatusTrap, managementPortStatus=managementPortStatus, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, iPv6PrefixLength=iPv6PrefixLength, altitude=altitude, remoteInternetAddressType=remoteInternetAddressType, radioLicenseRegion=radioLicenseRegion, primaryRecovery=primaryRecovery, hardwareVersion=hardwareVersion, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernet=ethernet, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPv4Address=iPv4Address, sNTPPollInterval=sNTPPollInterval, sNTPServerResponse=sNTPServerResponse, radioLicenseMinModulation=radioLicenseMinModulation, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rFUTxPowerMin=rFUTxPowerMin, productName=productName, vLANManagementVID=vLANManagementVID, hTTPSPortNumber=hTTPSPortNumber, rFURxFreqMin=rFURxFreqMin, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, endId=endId, productVariant=productVariant, dataPortFiberStatusTrap=dataPortFiberStatusTrap, phyControl=phyControl, sNTPPrimaryServer=sNTPPrimaryServer, diverseAntennaGain=diverseAntennaGain, faultProtectionSwitching=faultProtectionSwitching, ptmp=ptmp, versions=versions, rxDiversityVid=rxDiversityVid, userTableIndex=userTableIndex, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, activeAvailableTime=activeAvailableTime, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, vLANManagementVIDValidation=vLANManagementVIDValidation, rFUTxFreqMax=rFUTxFreqMax, syslogStateTrap=syslogStateTrap, longitude=longitude, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transmitModulation=transmitModulation, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, maximumTransmitPower=maximumTransmitPower, transmitDataRate=transmitDataRate, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, syslogControl=syslogControl, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, reset=reset, receiveDataRate=receiveDataRate, sNMPEnabledTraps=sNMPEnabledTraps, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, sNTPServerTimeout=sNTPServerTimeout, syslogClientTrap=syslogClientTrap, hTTPPortNumber=hTTPPortNumber, managementPortForcedConfiguration=managementPortForcedConfiguration, ptp800=ptp800, dataPortDisabledWarning=dataPortDisabledWarning, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, sNMPTrapTable=sNMPTrapTable, vectorError=vectorError, radioLicenseTxFreq=radioLicenseTxFreq, managementPortDisabledWarning=managementPortDisabledWarning, protectionState=protectionState, localPacketFiltering=localPacketFiltering, remotePrimaryInternetAddress=remotePrimaryInternetAddress, ptpTrapPrefix=ptpTrapPrefix, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, enableTransmission=enableTransmission, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkLoss=linkLoss, encryptionAlgorithm=encryptionAlgorithm, protectionStats=protectionStats, managementPortWirelessDownAlert=managementPortWirelessDownAlert, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, telnetPortNumber=telnetPortNumber, smtp=smtp, dataPortStatusTrap=dataPortStatusTrap, maxCodeRate=maxCodeRate, dataPortWirelessDownAlert=dataPortWirelessDownAlert, aAAControl=aAAControl, sMTPServerInternetAddressType=sMTPServerInternetAddressType, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, fiberY=fiberY, protectionSwitchCause=protectionSwitchCause, iFCableLength=iFCableLength, rFUTxMuteStatus=rFUTxMuteStatus, rFUVersionBank1=rFUVersionBank1, radioLicense=radioLicense, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, protectionConfigurationStatus=protectionConfigurationStatus, protection=protection, syslogState=syslogState, sMTPServerInternetAddress=sMTPServerInternetAddress, rFUTxBandAboveRx=rFUTxBandAboveRx, sNMPTrapPortNumber=sNMPTrapPortNumber, primaryRecoveryPeriod=primaryRecoveryPeriod, sNMPTrapTableIndex=sNMPTrapTableIndex, userRole=userRole, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, telnetAccessEnabled=telnetAccessEnabled, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, radioLicenseBand=radioLicenseBand, radioLicenseModulation=radioLicenseModulation, maxModulation=maxModulation, mPLSTCPriorityTable=mPLSTCPriorityTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, l2CPPriorityTableEntry=l2CPPriorityTableEntry, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, managementPortConfigurationMismatch=managementPortConfigurationMismatch, subnetMask=subnetMask, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, cambium=cambium, siteName=siteName, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sMTPServerIPAddress=sMTPServerIPAddress, bridge=bridge, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPPortNumber=sNMPPortNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, rFURFSwitchAlarm=rFURFSwitchAlarm, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptp=ptp, userPassword=userPassword, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rFUTxPowerAlarm=rFUTxPowerAlarm, remoteMACAddress=remoteMACAddress, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, userTableEntry=userTableEntry, radioLicenseIdentifier=radioLicenseIdentifier, hTTPAccessEnabled=hTTPAccessEnabled, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rFULockoutAlarm=rFULockoutAlarm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveCodeRate=receiveCodeRate, aTPCEnable=aTPCEnable, rFUCableAlarm=rFUCableAlarm, rFURfBand=rFURfBand, useVLANForManagementInterfaces=useVLANForManagementInterfaces, protectionInterfaceStatus=protectionInterfaceStatus, ptpTraps=ptpTraps, ethernetPriorityTable=ethernetPriorityTable, rFUFreqSpacing=rFUFreqSpacing, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFUProtectionCompatibility=rFUProtectionCompatibility, iPv6GatewayAddress=iPv6GatewayAddress, sNTPServerTableIndex=sNTPServerTableIndex, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, alarms=alarms, numberOfAntennas=numberOfAntennas, rFUStatus=rFUStatus, aggregateDataRate=aggregateDataRate, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, securityLevel=securityLevel, secureModeAlarmTrap=secureModeAlarmTrap, remoteSecondaryMACAddress=remoteSecondaryMACAddress, neighborInternetAddress=neighborInternetAddress, linkNameMismatchTrap=linkNameMismatchTrap, rFUTxFreqMin=rFUTxFreqMin, rFFeederLoss=rFFeederLoss, alignmentModeTrap=alignmentModeTrap, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, protectionAvailabilityStatus=protectionAvailabilityStatus, dSCPManagementPriority=dSCPManagementPriority, remoteIPAddress=remoteIPAddress, rFUConnectedPlatform=rFUConnectedPlatform, transmitCapacityLimitDetail=transmitCapacityLimitDetail, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPLastSync=sNTPLastSync, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, configuration=configuration, gatewayIPAddress=gatewayIPAddress, management=management, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, dataPortPauseFrames=dataPortPauseFrames, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, wirelessLinkStatus=wirelessLinkStatus, rFUActiveFirmwareBank=rFUActiveFirmwareBank, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFUTxPowerMax=rFUTxPowerMax, rFUType=rFUType, managementCommittedInformationRate=managementCommittedInformationRate, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortFiberStatus=dataPortFiberStatus, rfu=rfu, timeZone=timeZone, systemReset=systemReset, rFUPlatformCompatibility=rFUPlatformCompatibility, receiveModulation=receiveModulation, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, supplementary=supplementary, dataPortConfigurationMismatch=dataPortConfigurationMismatch, remoteSecondaryIPAddress=remoteSecondaryIPAddress, alignmentMode=alignmentMode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapTableNumber=sNMPTrapTableNumber, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, protectionConfig=protectionConfig, rFURxFreqMax=rFURxFreqMax, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, softwareVersion=softwareVersion, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPState=sNTPState, remoteMaximumTransmitPower=remoteMaximumTransmitPower, snmpControl=snmpControl, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rFUSerial=rFUSerial, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap)
