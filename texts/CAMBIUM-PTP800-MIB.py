...
IpAddress, Bits, NotificationType, Integer32, Counter64, ObjectIdentity, TimeTicks, NotificationType, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, Gauge32, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "NotificationType", "Integer32", "Counter64", "ObjectIdentity", "TimeTicks", "NotificationType", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "Gauge32", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", radioLicenseCodeRate=radioLicenseCodeRate, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPServerTimeout=sNTPServerTimeout, transmitDataRate=transmitDataRate, userPassword=userPassword, pubStats=pubStats, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, siteName=siteName, hardwareVersion=hardwareVersion, userRole=userRole, syslogClientTrap=syslogClientTrap, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rFUTxPowerMax=rFUTxPowerMax, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, remoteIPAddress=remoteIPAddress, vLANManagementVIDValidation=vLANManagementVIDValidation, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, ptp=ptp, linkName=linkName, rFUPowerButtonPressed=rFUPowerButtonPressed, hTTPPortNumber=hTTPPortNumber, ptpTraps=ptpTraps, rxDiversityVlanTpid=rxDiversityVlanTpid, smtp=smtp, sNMPTrapTableEntry=sNMPTrapTableEntry, telnetPortNumber=telnetPortNumber, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, radioLicense=radioLicense, rFUSerial=rFUSerial, radioLicenseBand=radioLicenseBand, primarySecondaryMode=primarySecondaryMode, userName=userName, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, protection=protection, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, sNTPSync=sNTPSync, alarms=alarms, encryptionEnabledMismatch=encryptionEnabledMismatch, rFUTxFreqMin=rFUTxFreqMin, remotePrimaryIPAddress=remotePrimaryIPAddress, encryptionAlgorithm=encryptionAlgorithm, ethernetFiberSupport=ethernetFiberSupport, fiberY=fiberY, systemClock=systemClock, rfu=rfu, altitude=altitude, productName=productName, rFURFSwitchAlarm=rFURFSwitchAlarm, gatewayIPAddress=gatewayIPAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, phyControl=phyControl, transmitCodeRate=transmitCodeRate, requestedProtectionState=requestedProtectionState, aggregateDataRate=aggregateDataRate, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPServerPortNumber=tFTPServerPortNumber, rFURfBand=rFURfBand, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, radioLicenseTxFreq=radioLicenseTxFreq, l2CPPriorityTableIndex=l2CPPriorityTableIndex, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rFURxFreqMax=rFURxFreqMax, l2CPPriorityTable=l2CPPriorityTable, rFUTxBandAboveRx=rFUTxBandAboveRx, endId=endId, diverseAntennaGain=diverseAntennaGain, rFUTxPowerAlarm=rFUTxPowerAlarm, maxCodeRate=maxCodeRate, receivePower=receivePower, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, unitOutOfCalibration=unitOutOfCalibration, reset=reset, protectionStateTrap=protectionStateTrap, iFCableLength=iFCableLength, systemReset=systemReset, softwareVersion=softwareVersion, radioLicenseBandwidth=radioLicenseBandwidth, syslogState=syslogState, qOSPriorityScheme=qOSPriorityScheme, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, aAAControl=aAAControl, alignmentModeTrap=alignmentModeTrap, rFUPowerAlarm=rFUPowerAlarm, sntp=sntp, managementPortConfigurationMismatch=managementPortConfigurationMismatch, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, managementPortAutoNegotiation=managementPortAutoNegotiation, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFUConnectedPlatform=rFUConnectedPlatform, sNMPEnabledTraps=sNMPEnabledTraps, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, bootVersion=bootVersion, sMTPEmailAlert=sMTPEmailAlert, rFUBranchingConfiguration=rFUBranchingConfiguration, sMTPServerInternetAddressType=sMTPServerInternetAddressType, diverseRfFeederLoss=diverseRfFeederLoss, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, transmitCapacityLimit=transmitCapacityLimit, dataPortWirelessDownAlert=dataPortWirelessDownAlert, radioLicenseMinModulation=radioLicenseMinModulation, hTTPSPortNumber=hTTPSPortNumber, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, securityLevel=securityLevel, syslogLocalWrappedTrap=syslogLocalWrappedTrap, timeZone=timeZone, managementCommittedInformationRate=managementCommittedInformationRate, productVariant=productVariant, primaryRecoveryPeriod=primaryRecoveryPeriod, rFURpsAlarm=rFURpsAlarm, sNTPServerIPAddress=sNTPServerIPAddress, sNMPCommunityString=sNMPCommunityString, rFUProtectionCompatibility=rFUProtectionCompatibility, supplementary=supplementary, sNTPPrimaryServer=sNTPPrimaryServer, sMTPServerPortNumber=sMTPServerPortNumber, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rFUStatusTrap=rFUStatusTrap, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, aTPCEnable=aTPCEnable, remoteMACAddress=remoteMACAddress, telnetAccessEnabled=telnetAccessEnabled, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, neighborInternetAddress=neighborInternetAddress, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, maxModulation=maxModulation, protectionState=protectionState, iPv6PrefixLength=iPv6PrefixLength, protectionAvailabilityStatus=protectionAvailabilityStatus, enableTransmission=enableTransmission, dataPortPauseFrames=dataPortPauseFrames, longitude=longitude, protectionConfigurationStatus=protectionConfigurationStatus, rFULockoutAlarm=rFULockoutAlarm, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, radioLicenseMaxModulation=radioLicenseMaxModulation, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userTableIndex=userTableIndex, userTableNumber=userTableNumber, remoteInternetAddressType=remoteInternetAddressType, syslogControl=syslogControl, userEnabled=userEnabled, protectionStats=protectionStats, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rFUPlatformCompatibility=rFUPlatformCompatibility, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPLastSync=sNTPLastSync, iPv4Address=iPv4Address, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rFUTxMuteStatus=rFUTxMuteStatus, sMTPEnabledMessages=sMTPEnabledMessages, ethernetPriorityTableNumber=ethernetPriorityTableNumber, activeUnit=activeUnit, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, ethernetPriorityTableEntry=ethernetPriorityTableEntry, neighborMACAddress=neighborMACAddress, faultProtectionSwitching=faultProtectionSwitching, radioLicenseMaxEIRP=radioLicenseMaxEIRP, numberOfAntennas=numberOfAntennas, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, versions=versions, remotePrimarySecondaryMode=remotePrimarySecondaryMode, sNMPPortNumber=sNMPPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, managementPortForcedConfiguration=managementPortForcedConfiguration, sNMPTrapPortNumber=sNMPTrapPortNumber, rxDiversityDataPortStatus=rxDiversityDataPortStatus, protectionStatus=protectionStatus, sNTPServerRetries=sNTPServerRetries, radioLicenseIdentifier=radioLicenseIdentifier, iPv6Address=iPv6Address, ptpTrapPrefix=ptpTrapPrefix, sNTPServerTableNumber=sNTPServerTableNumber, protectionInterfaceStatus=protectionInterfaceStatus, minCodeRate=minCodeRate, ptmp=ptmp, transmitCapacityLimitDetail=transmitCapacityLimitDetail, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, bridge=bridge, managementPortStatus=managementPortStatus, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPServerResponse=sNTPServerResponse, wirelessLinkStatusTrap=wirelessLinkStatusTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, userTable=userTable, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, vLANManagementVID=vLANManagementVID, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rFUActiveFirmwareBank=rFUActiveFirmwareBank, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, antennaGain=antennaGain, ethernet=ethernet, activeAvailableTime=activeAvailableTime, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, linkLoss=linkLoss, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, secondarySoftwareVersion=secondarySoftwareVersion, rFUVersionBank2=rFUVersionBank2, primaryRecovery=primaryRecovery, secureModeAlarmTrap=secureModeAlarmTrap, transmitterStatus=transmitterStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, tFTPServerInternetAddress=tFTPServerInternetAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rFUStatus=rFUStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveModulation=receiveModulation, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, dataPortStatus=dataPortStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapTable=sNMPTrapTable, vectorError=vectorError, receiveCodeRate=receiveCodeRate, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rxDiversityVid=rxDiversityVid, neighborIPAddress=neighborIPAddress, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPSyncTrap=sNTPSyncTrap, sNTPServerTableIndex=sNTPServerTableIndex, remotePrimaryInternetAddress=remotePrimaryInternetAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, phyStatus=phyStatus, sNTPServerTable=sNTPServerTable, receiveDataRate=receiveDataRate)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", iPVersion=iPVersion, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, radioLicenseModulation=radioLicenseModulation, syslogClient=syslogClient, iPv6GatewayAddress=iPv6GatewayAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessLinkStatus=wirelessLinkStatus, cambium=cambium, dataPortStatusTrap=dataPortStatusTrap, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, activeWirelessLinkAvailability=activeWirelessLinkAvailability, alignmentMode=alignmentMode, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, protectionConfig=protectionConfig, sNTPServerInternetAddress=sNTPServerInternetAddress, management=management, vLANManagementPriority=vLANManagementPriority, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPDSCPPriorityTable=iPDSCPPriorityTable, rFUTransceiverLocation=rFUTransceiverLocation, encryption=encryption, radioLicenseRegion=radioLicenseRegion, neighborInternetAddressType=neighborInternetAddressType, tFTPServerIPAddress=tFTPServerIPAddress, remotePrimaryMACAddress=remotePrimaryMACAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, transmitCapacity=transmitCapacity, configuration=configuration, rFUFreqSpacing=rFUFreqSpacing, remoteSecondaryMACAddress=remoteSecondaryMACAddress, linkNameMismatch=linkNameMismatch, snmpControl=snmpControl, rFUTxFreqMax=rFUTxFreqMax, latitude=latitude, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortDisabledWarning=dataPortDisabledWarning, rFUTxPowerMin=rFUTxPowerMin, rFUType=rFUType, remoteInternetAddress=remoteInternetAddress, subnetMask=subnetMask, managementPortDisabledWarning=managementPortDisabledWarning, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, transmitPower=transmitPower, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, userTableEntry=userTableEntry, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, remoteSecondaryIPAddress=remoteSecondaryIPAddress, secureModeAlarm=secureModeAlarm, rFUCableAlarm=rFUCableAlarm, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rFFeederLoss=rFFeederLoss, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, licence=licence, sMTPServerInternetAddress=sMTPServerInternetAddress, transmitModulation=transmitModulation, dSCPManagementPriority=dSCPManagementPriority, linkNameMismatchTrap=linkNameMismatchTrap, sNTPPollInterval=sNTPPollInterval, rFUVersionBank1=rFUVersionBank1, sNTPServerPortNumber=sNTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, radioLicenseMinCodeRate=radioLicenseMinCodeRate, wirelessLinkAvailability=wirelessLinkAvailability, maximumTransmitPower=maximumTransmitPower, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, localPacketFiltering=localPacketFiltering, daylightSaving=daylightSaving, radioLicenseRxFreq=radioLicenseRxFreq, managementPortStatusTrap=managementPortStatusTrap, minModulation=minModulation, sNTPState=sNTPState, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, ptp800=ptp800, managementMode=managementMode, sNMPTrapVersion=sNMPTrapVersion, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, protectionSwitchCause=protectionSwitchCause, dataPortFiberStatus=dataPortFiberStatus, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rFURxFreqMin=rFURxFreqMin, ethernetPriorityTable=ethernetPriorityTable, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, syslogStateTrap=syslogStateTrap)
