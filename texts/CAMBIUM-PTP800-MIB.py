...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, iPVersion=iPVersion, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, protection=protection, altitude=altitude, mPLSTCPriorityTable=mPLSTCPriorityTable, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, wirelessLinkStatusTrap=wirelessLinkStatusTrap, transmitterStatus=transmitterStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sMTPServerPortNumber=sMTPServerPortNumber, vectorError=vectorError, remotePrimaryIPAddress=remotePrimaryIPAddress, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, l2CPPriorityTableEntry=l2CPPriorityTableEntry, remoteMACAddress=remoteMACAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, neighborInternetAddress=neighborInternetAddress, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, vLANManagementVID=vLANManagementVID, minCodeRate=minCodeRate, maxCodeRate=maxCodeRate, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, primarySecondaryMode=primarySecondaryMode, subnetMask=subnetMask, receiveModulation=receiveModulation, tFTPServerInternetAddress=tFTPServerInternetAddress, radioLicenseBand=radioLicenseBand, dSCPManagementPriority=dSCPManagementPriority, diverseRfFeederLoss=diverseRfFeederLoss, radioLicenseRegion=radioLicenseRegion, transmitCapacity=transmitCapacity, remotePrimaryInternetAddress=remotePrimaryInternetAddress, rFUTxBandAboveRx=rFUTxBandAboveRx, wirelessLinkAvailability=wirelessLinkAvailability, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, telnetPortNumber=telnetPortNumber, remoteInternetAddress=remoteInternetAddress, radioLicenseMaxModulation=radioLicenseMaxModulation, protectionConfigurationStatus=protectionConfigurationStatus, systemReset=systemReset, secondarySoftwareVersion=secondarySoftwareVersion, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, enableTransmission=enableTransmission, phyStatus=phyStatus, iPv6Address=iPv6Address, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerInternetAddress=sNTPServerInternetAddress, iPv6GatewayAddress=iPv6GatewayAddress, rFUSerial=rFUSerial, protectionStateTrap=protectionStateTrap, rxDiversityVid=rxDiversityVid, managementPortAutoNegotiation=managementPortAutoNegotiation, rFUPowerButtonPressed=rFUPowerButtonPressed, managementPortDisabledWarning=managementPortDisabledWarning, sNMPTrapTableIndex=sNMPTrapTableIndex, ptp800=ptp800, fiberY=fiberY, radioLicenseCodeRate=radioLicenseCodeRate, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, protectionInterfaceStatus=protectionInterfaceStatus, primaryRecovery=primaryRecovery, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, snmpControl=snmpControl, encryptionEnabledMismatch=encryptionEnabledMismatch, secureModeAlarmTrap=secureModeAlarmTrap, tFTPServerIPAddress=tFTPServerIPAddress, aggregateDataRate=aggregateDataRate, rFURxFreqMin=rFURxFreqMin, ptpTrapPrefix=ptpTrapPrefix, rFUTxFreqMax=rFUTxFreqMax, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, bridge=bridge, rFUProtectionCompatibility=rFUProtectionCompatibility, configuration=configuration, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iFCableLength=iFCableLength, rFUVersionBank1=rFUVersionBank1, latitude=latitude, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogState=syslogState, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, pubStats=pubStats, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteSecondaryMACAddress=remoteSecondaryMACAddress, userRole=userRole, remoteIPAddress=remoteIPAddress, sNTPSyncTrap=sNTPSyncTrap, linkName=linkName, sNTPServerResponse=sNTPServerResponse, licence=licence, ethernetFiberSupport=ethernetFiberSupport, numberOfAntennas=numberOfAntennas, userPassword=userPassword, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkNameMismatchTrap=linkNameMismatchTrap, sNMPCommunityString=sNMPCommunityString, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, versions=versions, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, managementCommittedInformationRate=managementCommittedInformationRate, dataPortStatus=dataPortStatus, cambium=cambium, iPv4Address=iPv4Address, sMTPServerInternetAddressType=sMTPServerInternetAddressType, siteName=siteName, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sNTPServerTimeout=sNTPServerTimeout, dataPortConfigurationMismatch=dataPortConfigurationMismatch, radioLicenseRxFreq=radioLicenseRxFreq, sNMPPortNumber=sNMPPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, userEnabled=userEnabled, userTableEntry=userTableEntry, transmitCapacityLimit=transmitCapacityLimit, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, alignmentModeTrap=alignmentModeTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveCodeRate=receiveCodeRate, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, timeZone=timeZone, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, productVariant=productVariant, radioLicenseMinModulation=radioLicenseMinModulation, userTableIndex=userTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userName=userName, wirelessLinkStatus=wirelessLinkStatus, ptp=ptp, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, encryptionAlgorithm=encryptionAlgorithm, sNTPServerIPAddress=sNTPServerIPAddress, rFUActiveFirmwareBank=rFUActiveFirmwareBank, radioLicenseIdentifier=radioLicenseIdentifier, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, aTPCEnable=aTPCEnable, sNTPServerPortNumber=sNTPServerPortNumber, rFUTxPowerMax=rFUTxPowerMax, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, secureModeAlarm=secureModeAlarm, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, neighborIPAddress=neighborIPAddress, sNTPPrimaryServer=sNTPPrimaryServer, syslogLocalWrappedTrap=syslogLocalWrappedTrap, receivePower=receivePower, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, linkLoss=linkLoss, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, endId=endId, protectionConfig=protectionConfig, transmitPower=transmitPower, remotePrimarySecondaryMode=remotePrimarySecondaryMode, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, requestedProtectionState=requestedProtectionState, vLANManagementPriority=vLANManagementPriority, sMTPServerInternetAddress=sMTPServerInternetAddress, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rFUTxMuteStatus=rFUTxMuteStatus, rFURfBand=rFURfBand, sNTPServerTableIndex=sNTPServerTableIndex, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, radioLicenseModulation=radioLicenseModulation, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, systemClock=systemClock, iPv6PrefixLength=iPv6PrefixLength, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, tFTPServerPortNumber=tFTPServerPortNumber, transmitModulation=transmitModulation, rFUStatus=rFUStatus, qOSPriorityScheme=qOSPriorityScheme, sNMPEnabledTraps=sNMPEnabledTraps, transmitDataRate=transmitDataRate, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rFUTxFreqMin=rFUTxFreqMin, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rFURxFreqMax=rFURxFreqMax, userTable=userTable, managementMode=managementMode, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, syslogStateTrap=syslogStateTrap, sNTPLastSync=sNTPLastSync, useVLANForManagementInterfaces=useVLANForManagementInterfaces, smtp=smtp, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, bootVersion=bootVersion, rfu=rfu, rFURpsAlarm=rFURpsAlarm, protectionAvailabilityStatus=protectionAvailabilityStatus, maximumTransmitPower=maximumTransmitPower, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, antennaGain=antennaGain, transmitCapacityLimitDetail=transmitCapacityLimitDetail, hTTPSPortNumber=hTTPSPortNumber, localPacketFiltering=localPacketFiltering, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPPollInterval=sNTPPollInterval, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, hardwareVersion=hardwareVersion, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortStatusTrap=dataPortStatusTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapVersion=sNMPTrapVersion, remoteInternetAddressType=remoteInternetAddressType, gatewayIPAddress=gatewayIPAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rFURFSwitchAlarm=rFURFSwitchAlarm, rFUTxPowerAlarm=rFUTxPowerAlarm, sNTPState=sNTPState, sNMPTrapTableNumber=sNMPTrapTableNumber, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rFUPowerAlarm=rFUPowerAlarm, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, radioLicenseMinCodeRate=radioLicenseMinCodeRate, syslogClient=syslogClient, iPDSCPPriorityTable=iPDSCPPriorityTable, primaryRecoveryPeriod=primaryRecoveryPeriod, protectionSwitchCause=protectionSwitchCause, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, neighborInternetAddressType=neighborInternetAddressType, aAAControl=aAAControl, linkNameMismatch=linkNameMismatch, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, alignmentMode=alignmentMode, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, daylightSaving=daylightSaving, activeAvailableTime=activeAvailableTime, l2CPPriorityTable=l2CPPriorityTable, ptmp=ptmp, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, rFUFreqSpacing=rFUFreqSpacing)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", radioLicense=radioLicense, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, management=management, phyControl=phyControl, faultProtectionSwitching=faultProtectionSwitching, syslogControl=syslogControl, sNTPServerTable=sNTPServerTable, rFUVersionBank2=rFUVersionBank2, hTTPPortNumber=hTTPPortNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, remoteSecondaryIPAddress=remoteSecondaryIPAddress, reset=reset, rFULockoutAlarm=rFULockoutAlarm, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, rFUPlatformCompatibility=rFUPlatformCompatibility, sNTPServerRetries=sNTPServerRetries, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, remotePrimaryMACAddress=remotePrimaryMACAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, radioLicenseBandwidth=radioLicenseBandwidth, sNTPSync=sNTPSync, sNMPTrapTable=sNMPTrapTable, diverseAntennaGain=diverseAntennaGain, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, softwareVersion=softwareVersion, activeWirelessLinkAvailability=activeWirelessLinkAvailability, receiveDataRate=receiveDataRate, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, ethernet=ethernet, radioLicenseTxFreq=radioLicenseTxFreq, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rFUStatusTrap=rFUStatusTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, alarms=alarms, rFUBranchingConfiguration=rFUBranchingConfiguration, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sMTPEmailAlert=sMTPEmailAlert, sntp=sntp, protectionState=protectionState, rFUTxPowerMin=rFUTxPowerMin, unitOutOfCalibration=unitOutOfCalibration, encryption=encryption, sNTPServerTableNumber=sNTPServerTableNumber, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, protectionStatus=protectionStatus, rFUTransceiverLocation=rFUTransceiverLocation, neighborMACAddress=neighborMACAddress, ethernetPriorityTable=ethernetPriorityTable, rxDiversityVlanTpid=rxDiversityVlanTpid, syslogClientTrap=syslogClientTrap, protectionStats=protectionStats, longitude=longitude, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, managementPortStatusTrap=managementPortStatusTrap, rFUCableAlarm=rFUCableAlarm, ptpTraps=ptpTraps, rFUType=rFUType, managementPortForcedConfiguration=managementPortForcedConfiguration, dataPortPauseFrames=dataPortPauseFrames, userTableNumber=userTableNumber, activeUnit=activeUnit, sMTPServerIPAddress=sMTPServerIPAddress, maxModulation=maxModulation, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, vLANManagementVIDValidation=vLANManagementVIDValidation, dataPortFiberStatus=dataPortFiberStatus, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, minModulation=minModulation, managementPortStatus=managementPortStatus, radioLicenseMaxEIRP=radioLicenseMaxEIRP, securityLevel=securityLevel, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, ethernetPriorityTableIndex=ethernetPriorityTableIndex, productName=productName, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, hTTPAccessEnabled=hTTPAccessEnabled, rFFeederLoss=rFFeederLoss, sNTPServerTableEntry=sNTPServerTableEntry, transmitCodeRate=transmitCodeRate, supplementary=supplementary, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rFUConnectedPlatform=rFUConnectedPlatform)
