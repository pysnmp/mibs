...
NotificationType, Counter32, ModuleIdentity, MibIdentifier, Bits, Gauge32, TimeTicks, Unsigned32, ObjectIdentity, Counter64, enterprises, IpAddress, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "ModuleIdentity", "MibIdentifier", "Bits", "Gauge32", "TimeTicks", "Unsigned32", "ObjectIdentity", "Counter64", "enterprises", "IpAddress", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNTPServerTableNumber=sNTPServerTableNumber, rFUTxPowerAlarm=rFUTxPowerAlarm, sNTPServerIPAddress=sNTPServerIPAddress, radioLicenseBand=radioLicenseBand, sNTPSyncTrap=sNTPSyncTrap, transmitModulation=transmitModulation, syslogState=syslogState, transmitPower=transmitPower, transmitCapacityLimitDetail=transmitCapacityLimitDetail, remotePrimaryIPAddress=remotePrimaryIPAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, ethernetPriorityTable=ethernetPriorityTable, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, sNTPServerRetries=sNTPServerRetries, radioLicenseRxFreq=radioLicenseRxFreq, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, qOSPriorityScheme=qOSPriorityScheme, receivePower=receivePower, radioLicenseTxFreq=radioLicenseTxFreq, configuration=configuration, sMTPSourceEmailAddress=sMTPSourceEmailAddress, neighborMACAddress=neighborMACAddress, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, ptpTraps=ptpTraps, dataPortFiberStatus=dataPortFiberStatus, l2CPPriorityTable=l2CPPriorityTable, rFFeederLoss=rFFeederLoss, neighborInternetAddressType=neighborInternetAddressType, userName=userName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTable=sNMPTrapTable, rFULockoutAlarm=rFULockoutAlarm, ptp800=ptp800, sNTPLastSync=sNTPLastSync, rFUTxPowerMin=rFUTxPowerMin, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rFUCableAlarm=rFUCableAlarm, alignmentMode=alignmentMode, cambium=cambium, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, neighborIPAddress=neighborIPAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFUTxMuteStatus=rFUTxMuteStatus, gatewayIPAddress=gatewayIPAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernetPriorityTableIndex=ethernetPriorityTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFUPowerButtonPressed=rFUPowerButtonPressed, rFUTransceiverLocation=rFUTransceiverLocation, vectorError=vectorError, sMTPEnabledMessages=sMTPEnabledMessages, securityLevel=securityLevel, userTableEntry=userTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, productVariant=productVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, sMTPServerInternetAddressType=sMTPServerInternetAddressType, hTTPAccessEnabled=hTTPAccessEnabled, rFUTxPowerMax=rFUTxPowerMax, sNTPState=sNTPState, protection=protection, wirelessLinkStatus=wirelessLinkStatus, encryptionEnabledMismatch=encryptionEnabledMismatch, receiveModulation=receiveModulation, radioLicenseIdentifier=radioLicenseIdentifier, reset=reset, antennaGain=antennaGain, sMTPServerPortNumber=sMTPServerPortNumber, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, remotePrimaryInternetAddress=remotePrimaryInternetAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, managementPortStatus=managementPortStatus, iPv6Address=iPv6Address, rFUConnectedPlatform=rFUConnectedPlatform, userRole=userRole, secondarySoftwareVersion=secondarySoftwareVersion, protectionStats=protectionStats, softwareVersion=softwareVersion, vLANManagementPriority=vLANManagementPriority, rFUStatusTrap=rFUStatusTrap, ethernet=ethernet, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rFUPowerAlarm=rFUPowerAlarm, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, transmitCodeRate=transmitCodeRate, sNMPTrapTableEntry=sNMPTrapTableEntry, aggregateDataRate=aggregateDataRate, receiveCodeRate=receiveCodeRate, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rFUProtectionCompatibility=rFUProtectionCompatibility, hardwareVersion=hardwareVersion, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, diverseAntennaGain=diverseAntennaGain, transmitCapacity=transmitCapacity, requestedProtectionState=requestedProtectionState, daylightSaving=daylightSaving, localPacketFiltering=localPacketFiltering, dataPortStatus=dataPortStatus, rFURFSwitchAlarm=rFURFSwitchAlarm, licence=licence, sMTPServerIPAddress=sMTPServerIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, iPv4Address=iPv4Address, protectionConfigurationStatus=protectionConfigurationStatus, longitude=longitude, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, activeUnit=activeUnit, rFUActiveFirmwareBank=rFUActiveFirmwareBank, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, productName=productName, secureModeAlarmTrap=secureModeAlarmTrap, alignmentModeTrap=alignmentModeTrap, userEnabled=userEnabled, radioLicenseRegion=radioLicenseRegion, management=management, endId=endId, latitude=latitude, alarms=alarms, sNMPCommunityString=sNMPCommunityString, sNTPServerInternetAddress=sNTPServerInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, iPv6GatewayAddress=iPv6GatewayAddress, radioLicenseModulation=radioLicenseModulation, rFUVersionBank1=rFUVersionBank1, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, userTableIndex=userTableIndex, subnetMask=subnetMask, remoteMACAddress=remoteMACAddress, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFURxFreqMax=rFURxFreqMax, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, neighborInternetAddress=neighborInternetAddress, dataPortDisabledWarning=dataPortDisabledWarning, encryptionAlgorithm=encryptionAlgorithm, rFURfBand=rFURfBand, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rFUTxFreqMin=rFUTxFreqMin, aAAControl=aAAControl, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, minModulation=minModulation, managementPortAutoNegotiation=managementPortAutoNegotiation, telnetAccessEnabled=telnetAccessEnabled, faultProtectionSwitching=faultProtectionSwitching, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, sNTPServerTable=sNTPServerTable, protectionStatus=protectionStatus, rFUStatus=rFUStatus, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, managementMode=managementMode, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFUVersionBank2=rFUVersionBank2, dataPortPauseFrames=dataPortPauseFrames, rxDiversityVlanTpid=rxDiversityVlanTpid, iPv6PrefixLength=iPv6PrefixLength, useVLANForManagementInterfaces=useVLANForManagementInterfaces, radioLicenseMaxModulation=radioLicenseMaxModulation, remotePrimarySecondaryMode=remotePrimarySecondaryMode, primaryRecoveryPeriod=primaryRecoveryPeriod, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, systemClock=systemClock, sNMPTrapIPAddress=sNMPTrapIPAddress, transmitDataRate=transmitDataRate, snmpControl=snmpControl, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, linkNameMismatchTrap=linkNameMismatchTrap, sNTPPollInterval=sNTPPollInterval, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, systemReset=systemReset, sntp=sntp, numberOfAntennas=numberOfAntennas, protectionInterfaceStatus=protectionInterfaceStatus, syslogClientTrap=syslogClientTrap, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sNMPPortNumber=sNMPPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogControl=syslogControl, iPDSCPPriorityTable=iPDSCPPriorityTable, activeWirelessLinkAvailability=activeWirelessLinkAvailability, transmitCapacityLimit=transmitCapacityLimit, tFTPServerPortNumber=tFTPServerPortNumber, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, versions=versions, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortFiberStatusTrap=dataPortFiberStatusTrap, protectionSwitchCause=protectionSwitchCause, l2CPPriorityTableIndex=l2CPPriorityTableIndex, linkLoss=linkLoss, sNTPPrimaryServer=sNTPPrimaryServer, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rFURxFreqMin=rFURxFreqMin, radioLicenseCodeRate=radioLicenseCodeRate, telnetPortNumber=telnetPortNumber, enableTransmission=enableTransmission, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ptmp=ptmp, bootVersion=bootVersion, radioLicenseMinModulation=radioLicenseMinModulation, ptpTrapPrefix=ptpTrapPrefix, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, syslogStateTrap=syslogStateTrap, ethernetFiberSupport=ethernetFiberSupport, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, sNTPSync=sNTPSync, radioLicenseMaxEIRP=radioLicenseMaxEIRP, aTPCEnable=aTPCEnable, remoteSecondaryIPAddress=remoteSecondaryIPAddress, userTableNumber=userTableNumber, userPassword=userPassword, protectionConfig=protectionConfig, fiberY=fiberY, rFURpsAlarm=rFURpsAlarm, userTable=userTable, radioLicenseMinCodeRate=radioLicenseMinCodeRate, sNTPServerResponse=sNTPServerResponse, iFCableLength=iFCableLength, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, ethernetPriorityTableEntry=ethernetPriorityTableEntry, supplementary=supplementary, rFUTxFreqMax=rFUTxFreqMax, rFUTxBandAboveRx=rFUTxBandAboveRx, rFUPlatformCompatibility=rFUPlatformCompatibility, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, radioLicense=radioLicense, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, maxCodeRate=maxCodeRate, minCodeRate=minCodeRate, sNMPTrapVersion=sNMPTrapVersion, diverseRfFeederLoss=diverseRfFeederLoss, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, wirelessLinkAvailability=wirelessLinkAvailability, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", dSCPManagementPriority=dSCPManagementPriority, rxDiversityVid=rxDiversityVid, pubStats=pubStats, encryption=encryption, vLANManagementVID=vLANManagementVID, sMTPEmailAlert=sMTPEmailAlert, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, rxDiversityDataPortStatus=rxDiversityDataPortStatus, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, remotePrimaryMACAddress=remotePrimaryMACAddress, ptp=ptp, hTTPSAccessEnabled=hTTPSAccessEnabled, primarySecondaryMode=primarySecondaryMode, maxModulation=maxModulation, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, sMTPServerInternetAddress=sMTPServerInternetAddress, altitude=altitude, sNTPServerTableEntry=sNTPServerTableEntry, protectionAvailabilityStatus=protectionAvailabilityStatus, siteName=siteName, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, timeZone=timeZone, wirelessLinkStatusTrap=wirelessLinkStatusTrap, activeAvailableTime=activeAvailableTime, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, managementPortForcedConfiguration=managementPortForcedConfiguration, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, remoteSecondaryMACAddress=remoteSecondaryMACAddress, sNTPServerTimeout=sNTPServerTimeout, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, maximumTransmitPower=maximumTransmitPower, managementPortDisabledWarning=managementPortDisabledWarning, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, sNMPTrapInternetAddress=sNMPTrapInternetAddress, transmitterStatus=transmitterStatus, unitOutOfCalibration=unitOutOfCalibration, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, vLANManagementVIDValidation=vLANManagementVIDValidation, phyControl=phyControl, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, secureModeAlarm=secureModeAlarm, syslogClient=syslogClient, protectionStateTrap=protectionStateTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, protectionState=protectionState, linkName=linkName, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rFUType=rFUType, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerTableIndex=sNTPServerTableIndex, bridge=bridge, managementPortStatusTrap=managementPortStatusTrap, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, smtp=smtp, rFUFreqSpacing=rFUFreqSpacing, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sNTPServerPortNumber=sNTPServerPortNumber, remoteIPAddress=remoteIPAddress, hTTPPortNumber=hTTPPortNumber, rfu=rfu, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remoteInternetAddressType=remoteInternetAddressType, iPVersion=iPVersion, rFUSerial=rFUSerial, managementCommittedInformationRate=managementCommittedInformationRate, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, radioLicenseBandwidth=radioLicenseBandwidth, ethernetPriorityTableNumber=ethernetPriorityTableNumber, remoteInternetAddress=remoteInternetAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, primaryRecovery=primaryRecovery, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dataPortStatusTrap=dataPortStatusTrap, linkNameMismatch=linkNameMismatch, receiveDataRate=receiveDataRate, phyStatus=phyStatus, hTTPSPortNumber=hTTPSPortNumber, rFUBranchingConfiguration=rFUBranchingConfiguration)
