...
NotificationType, ObjectIdentity, NotificationType, Integer32, Counter32, iso, IpAddress, Bits, ModuleIdentity, Unsigned32, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "NotificationType", "Integer32", "Counter32", "iso", "IpAddress", "Bits", "ModuleIdentity", "Unsigned32", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, mPLSTCPriorityTable=mPLSTCPriorityTable, protectionStats=protectionStats, sNTPSyncTrap=sNTPSyncTrap, sNTPServerResponse=sNTPServerResponse, l2CPPriorityTableIndex=l2CPPriorityTableIndex, aAAControl=aAAControl, ptp800=ptp800, sNTPServerRetries=sNTPServerRetries, rFULockoutAlarm=rFULockoutAlarm, ethernet=ethernet, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, ptp=ptp, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, reset=reset, managementPortAutoNegotiation=managementPortAutoNegotiation, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, vectorError=vectorError, softwareVersion=softwareVersion, rFUSerial=rFUSerial, rFFeederLoss=rFFeederLoss, managementPortWirelessDownAlert=managementPortWirelessDownAlert, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, userEnabled=userEnabled, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rFUProtectionCompatibility=rFUProtectionCompatibility, rFUTxFreqMax=rFUTxFreqMax, cambium=cambium, neighborInternetAddressType=neighborInternetAddressType, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, transmitDataRate=transmitDataRate, radioLicenseCodeRate=radioLicenseCodeRate, dataPortDisabledWarning=dataPortDisabledWarning, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, remoteSecondaryMACAddress=remoteSecondaryMACAddress, radioLicenseModulation=radioLicenseModulation, protectionStatus=protectionStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, smtp=smtp, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, rFUVersionBank2=rFUVersionBank2, l2CPPriorityTable=l2CPPriorityTable, receiveCodeRate=receiveCodeRate, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rFUBranchingConfiguration=rFUBranchingConfiguration, systemReset=systemReset, timeZone=timeZone, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, dSCPManagementPriority=dSCPManagementPriority, tFTPServerPortNumber=tFTPServerPortNumber, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, neighborIPAddress=neighborIPAddress, radioLicenseBand=radioLicenseBand, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFUTxMuteStatus=rFUTxMuteStatus, remotePrimaryInternetAddress=remotePrimaryInternetAddress, managementCommittedInformationRate=managementCommittedInformationRate, radioLicenseTxFreq=radioLicenseTxFreq, sNTPSync=sNTPSync, transmitCodeRate=transmitCodeRate, protectionAvailabilityStatus=protectionAvailabilityStatus, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, daylightSaving=daylightSaving, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, alignmentMode=alignmentMode, productVariant=productVariant, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, radioLicenseMinModulation=radioLicenseMinModulation, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, dataPortFiberStatus=dataPortFiberStatus, iPv6PrefixLength=iPv6PrefixLength, remoteInternetAddress=remoteInternetAddress, syslogClientTrap=syslogClientTrap, activeWirelessLinkAvailability=activeWirelessLinkAvailability, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, rxDiversityDataPortStatus=rxDiversityDataPortStatus, wirelessLinkStatus=wirelessLinkStatus, syslogClient=syslogClient, rFURfBand=rFURfBand, maximumTransmitPower=maximumTransmitPower, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, radioLicense=radioLicense, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, hTTPSPortNumber=hTTPSPortNumber, snmpControl=snmpControl, primaryRecoveryPeriod=primaryRecoveryPeriod, transmitModulation=transmitModulation, protectionStateTrap=protectionStateTrap, qOSPriorityScheme=qOSPriorityScheme, numberOfAntennas=numberOfAntennas, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telnetAccessEnabled=telnetAccessEnabled, iPVersion=iPVersion, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, remoteInternetAddressType=remoteInternetAddressType, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, productName=productName, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, activeAvailableTime=activeAvailableTime, versions=versions, sNMPTrapPortNumber=sNMPTrapPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, protectionState=protectionState, protectionConfigurationStatus=protectionConfigurationStatus, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rFUFreqSpacing=rFUFreqSpacing, protectionInterfaceStatus=protectionInterfaceStatus, aTPCEnable=aTPCEnable, remoteMACAddress=remoteMACAddress, hardwareVersion=hardwareVersion, remoteSecondaryIPAddress=remoteSecondaryIPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, radioLicenseRxFreq=radioLicenseRxFreq, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, iFCableLength=iFCableLength, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, secureModeAlarm=secureModeAlarm, linkName=linkName, sNMPTrapIPAddress=sNMPTrapIPAddress, vLANManagementVID=vLANManagementVID, enableTransmission=enableTransmission, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, iPv6GatewayAddress=iPv6GatewayAddress, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, protection=protection, requestedProtectionState=requestedProtectionState, licence=licence, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, vLANManagementVIDValidation=vLANManagementVIDValidation, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPTrapVersion=sNMPTrapVersion, rFURFSwitchAlarm=rFURFSwitchAlarm, ethernetPriorityTableEntry=ethernetPriorityTableEntry, protectionSwitchCause=protectionSwitchCause, rFUTxPowerMin=rFUTxPowerMin, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ptpTraps=ptpTraps, sNTPServerPortNumber=sNTPServerPortNumber, endId=endId, syslogStateTrap=syslogStateTrap, rFUConnectedPlatform=rFUConnectedPlatform, transmitterStatus=transmitterStatus, userRole=userRole, dataPortStatusTrap=dataPortStatusTrap, rFUTxBandAboveRx=rFUTxBandAboveRx, syslogControl=syslogControl, rFUTxFreqMin=rFUTxFreqMin, receiveDataRate=receiveDataRate, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, diverseAntennaGain=diverseAntennaGain, longitude=longitude, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, managementMode=managementMode, altitude=altitude, primaryRecovery=primaryRecovery, maxCodeRate=maxCodeRate, wirelessLinkStatusTrap=wirelessLinkStatusTrap, encryption=encryption, sNMPTrapTableEntry=sNMPTrapTableEntry, userTableNumber=userTableNumber, ptmp=ptmp, receiveModulation=receiveModulation, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, dataPortConfigurationMismatch=dataPortConfigurationMismatch, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, aggregateDataRate=aggregateDataRate, diverseRfFeederLoss=diverseRfFeederLoss, iPv6Address=iPv6Address, sNTPPrimaryServer=sNTPPrimaryServer, rFUStatusTrap=rFUStatusTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sntp=sntp, rxDiversityVid=rxDiversityVid, subnetMask=subnetMask, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPServerTable=sNTPServerTable, sMTPEnabledMessages=sMTPEnabledMessages, hTTPPortNumber=hTTPPortNumber, rFUPlatformCompatibility=rFUPlatformCompatibility, linkNameMismatch=linkNameMismatch, transmitCapacity=transmitCapacity, userPassword=userPassword, gatewayIPAddress=gatewayIPAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, remotePrimarySecondaryMode=remotePrimarySecondaryMode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, supplementary=supplementary, rFUActiveFirmwareBank=rFUActiveFirmwareBank, latitude=latitude, userTableEntry=userTableEntry, vLANManagementPriority=vLANManagementPriority, userTableIndex=userTableIndex, sNMPTrapTable=sNMPTrapTable, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, transmitCapacityLimit=transmitCapacityLimit, radioLicenseBandwidth=radioLicenseBandwidth, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPState=sNTPState, encryptionEnabledMismatch=encryptionEnabledMismatch, radioLicenseMaxEIRP=radioLicenseMaxEIRP, bootVersion=bootVersion, radioLicenseMaxModulation=radioLicenseMaxModulation, managementPortForcedConfiguration=managementPortForcedConfiguration, protectionConfig=protectionConfig, rxDiversityVlanTpid=rxDiversityVlanTpid, systemClock=systemClock, sNTPServerTimeout=sNTPServerTimeout, enabledDiagnosticAlarms=enabledDiagnosticAlarms, faultProtectionSwitching=faultProtectionSwitching, ethernetFiberSupport=ethernetFiberSupport, neighborInternetAddress=neighborInternetAddress, pubStats=pubStats, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sMTPServerInternetAddress=sMTPServerInternetAddress, sMTPServerIPAddress=sMTPServerIPAddress, siteName=siteName, minCodeRate=minCodeRate, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, rFURxFreqMin=rFURxFreqMin, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, userTable=userTable)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFURpsAlarm=rFURpsAlarm, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, remoteIPAddress=remoteIPAddress, antennaGain=antennaGain, alarms=alarms, primarySecondaryMode=primarySecondaryMode, neighborMACAddress=neighborMACAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, telnetPortNumber=telnetPortNumber, rFUTransceiverLocation=rFUTransceiverLocation, sMTPEmailAlert=sMTPEmailAlert, dataPortStatus=dataPortStatus, fiberY=fiberY, linkNameMismatchTrap=linkNameMismatchTrap, securityLevel=securityLevel, iPv4Address=iPv4Address, rFUVersionBank1=rFUVersionBank1, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementPortStatusTrap=managementPortStatusTrap, sNMPPortNumber=sNMPPortNumber, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, ethernetPriorityTable=ethernetPriorityTable, maxModulation=maxModulation, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, sNTPServerIPAddress=sNTPServerIPAddress, transmitCapacityLimitDetail=transmitCapacityLimitDetail, secondarySoftwareVersion=secondarySoftwareVersion, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rfu=rfu, iPDSCPPriorityTable=iPDSCPPriorityTable, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, sNTPLastSync=sNTPLastSync, encryptionAlgorithm=encryptionAlgorithm, activeUnit=activeUnit, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, secureModeAlarmTrap=secureModeAlarmTrap, management=management, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPCommunityString=sNMPCommunityString, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, syslogState=syslogState, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rFURxFreqMax=rFURxFreqMax, radioLicenseRegion=radioLicenseRegion, rFUTxPowerMax=rFUTxPowerMax, tFTPServerIPAddress=tFTPServerIPAddress, userName=userName, remotePrimaryIPAddress=remotePrimaryIPAddress, receivePower=receivePower, minModulation=minModulation, tFTPServerInternetAddressType=tFTPServerInternetAddressType, remotePrimaryMACAddress=remotePrimaryMACAddress, configuration=configuration, managementPortStatus=managementPortStatus, dataPortPauseFrames=dataPortPauseFrames, rFUCableAlarm=rFUCableAlarm, radioLicenseIdentifier=radioLicenseIdentifier, rFUStatus=rFUStatus, sNTPServerTableEntry=sNTPServerTableEntry, rFUPowerAlarm=rFUPowerAlarm, managementPortDisabledWarning=managementPortDisabledWarning, alignmentModeTrap=alignmentModeTrap, radioLicenseMinCodeRate=radioLicenseMinCodeRate, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, sNTPPollInterval=sNTPPollInterval, bridge=bridge, linkLoss=linkLoss, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, phyControl=phyControl, phyStatus=phyStatus, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, sNTPServerTableIndex=sNTPServerTableIndex, rFUPowerButtonPressed=rFUPowerButtonPressed, rFUTxPowerAlarm=rFUTxPowerAlarm, sMTPServerPortNumber=sMTPServerPortNumber, rFUType=rFUType, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, transmitPower=transmitPower, unitOutOfCalibration=unitOutOfCalibration, localPacketFiltering=localPacketFiltering)
