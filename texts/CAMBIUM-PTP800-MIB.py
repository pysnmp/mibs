...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, ModuleIdentity, iso, Unsigned32, MibIdentifier, NotificationType, enterprises, IpAddress, Integer32, Counter32, TimeTicks, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "ModuleIdentity", "iso", "Unsigned32", "MibIdentifier", "NotificationType", "enterprises", "IpAddress", "Integer32", "Counter32", "TimeTicks", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", productName=productName, protectionStats=protectionStats, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, radioLicenseRegion=radioLicenseRegion, sNTPServerIPAddress=sNTPServerIPAddress, rxDiversityVlanTpid=rxDiversityVlanTpid, iPDSCPPriorityTable=iPDSCPPriorityTable, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFUPowerAlarm=rFUPowerAlarm, rFURpsAlarm=rFURpsAlarm, protectionStatus=protectionStatus, transmitCapacityLimit=transmitCapacityLimit, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, pubStats=pubStats, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, latitude=latitude, secureModeAlarmTrap=secureModeAlarmTrap, rFUStatus=rFUStatus, rFUTxFreqMin=rFUTxFreqMin, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, dSCPManagementPriority=dSCPManagementPriority, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, telnetAccessEnabled=telnetAccessEnabled, unitOutOfCalibration=unitOutOfCalibration, managementMode=managementMode, mPLSTCPriorityTable=mPLSTCPriorityTable, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, remotePrimarySecondaryMode=remotePrimarySecondaryMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityString=sNMPCommunityString, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, faultProtectionSwitching=faultProtectionSwitching, sNMPTrapTableIndex=sNMPTrapTableIndex, radioLicenseModulation=radioLicenseModulation, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rFUTxPowerMax=rFUTxPowerMax, syslogClient=syslogClient, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, radioLicenseBand=radioLicenseBand, phyControl=phyControl, remoteSecondaryIPAddress=remoteSecondaryIPAddress, protectionConfig=protectionConfig, remoteMACAddress=remoteMACAddress, maxCodeRate=maxCodeRate, sNTPLastSync=sNTPLastSync, remotePrimaryIPAddress=remotePrimaryIPAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNMPTrapVersion=sNMPTrapVersion, transmitModulation=transmitModulation, activeUnit=activeUnit, l2CPPriorityTableEntry=l2CPPriorityTableEntry, radioLicenseTxFreq=radioLicenseTxFreq, sNTPServerPortNumber=sNTPServerPortNumber, transmitDataRate=transmitDataRate, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, secureModeAlarm=secureModeAlarm, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, remoteInternetAddress=remoteInternetAddress, encryption=encryption, neighborInternetAddress=neighborInternetAddress, encryptionEnabledMismatch=encryptionEnabledMismatch, enabledDiagnosticAlarms=enabledDiagnosticAlarms, remotePrimaryMACAddress=remotePrimaryMACAddress, alignmentMode=alignmentMode, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, activeAvailableTime=activeAvailableTime, rFFeederLoss=rFFeederLoss, iPVersion=iPVersion, sNTPPollInterval=sNTPPollInterval, ethernetFiberSupport=ethernetFiberSupport, bridge=bridge, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rFUTxPowerAlarm=rFUTxPowerAlarm, hTTPPortNumber=hTTPPortNumber, dataPortFiberStatus=dataPortFiberStatus, radioLicenseMinCodeRate=radioLicenseMinCodeRate, radioLicenseRxFreq=radioLicenseRxFreq, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, transmitCodeRate=transmitCodeRate, versions=versions, timeZone=timeZone, encryptionAlgorithm=encryptionAlgorithm, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ethernetPriorityTable=ethernetPriorityTable, gatewayIPAddress=gatewayIPAddress, vLANManagementVID=vLANManagementVID, userRole=userRole, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerResponse=sNTPServerResponse, rFUType=rFUType, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, securityLevel=securityLevel, sMTPServerInternetAddress=sMTPServerInternetAddress, rFUTxFreqMax=rFUTxFreqMax, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPEmailAlert=sMTPEmailAlert, fiberY=fiberY, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, vLANManagementVIDValidation=vLANManagementVIDValidation, neighborIPAddress=neighborIPAddress, radioLicense=radioLicense, syslogControl=syslogControl, transmitCapacity=transmitCapacity, linkNameMismatchTrap=linkNameMismatchTrap, siteName=siteName, userTableIndex=userTableIndex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rFUBranchingConfiguration=rFUBranchingConfiguration, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, vLANManagementPriority=vLANManagementPriority, protectionAvailabilityStatus=protectionAvailabilityStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, snmpControl=snmpControl, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, alignmentModeTrap=alignmentModeTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, radioLicenseIdentifier=radioLicenseIdentifier, sMTPServerInternetAddressType=sMTPServerInternetAddressType, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, managementCommittedInformationRate=managementCommittedInformationRate, rFUPowerButtonPressed=rFUPowerButtonPressed, dataPortPauseFrames=dataPortPauseFrames, minModulation=minModulation, sNTPServerTableNumber=sNTPServerTableNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, sNTPState=sNTPState, telnetPortNumber=telnetPortNumber, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, sNTPServerTable=sNTPServerTable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ptp800=ptp800, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, protectionState=protectionState, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, managementPortStatus=managementPortStatus, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, radioLicenseMaxEIRP=radioLicenseMaxEIRP, sNTPSync=sNTPSync, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, protectionConfigurationStatus=protectionConfigurationStatus, sntp=sntp, enableTransmission=enableTransmission, transmitterStatus=transmitterStatus, vectorError=vectorError, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPPortNumber=sNMPPortNumber, rFULockoutAlarm=rFULockoutAlarm, primarySecondaryMode=primarySecondaryMode, requestedProtectionState=requestedProtectionState, linkLoss=linkLoss, localPacketFiltering=localPacketFiltering, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, aTPCEnable=aTPCEnable, rfu=rfu, ptpTraps=ptpTraps, remotePrimaryInternetAddress=remotePrimaryInternetAddress, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, endId=endId, transmitCapacityLimitDetail=transmitCapacityLimitDetail, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, l2CPPriorityTable=l2CPPriorityTable, rFUConnectedPlatform=rFUConnectedPlatform, dataPortStatus=dataPortStatus, systemReset=systemReset, userPassword=userPassword, rFURFSwitchAlarm=rFURFSwitchAlarm, receivePower=receivePower, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, iPv6Address=iPv6Address, configuration=configuration, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, managementPortStatusTrap=managementPortStatusTrap, neighborMACAddress=neighborMACAddress, remoteSecondaryMACAddress=remoteSecondaryMACAddress, iPv6PrefixLength=iPv6PrefixLength, neighborInternetAddressType=neighborInternetAddressType, rFUCableAlarm=rFUCableAlarm, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iFCableLength=iFCableLength, systemClock=systemClock, cambium=cambium, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, syslogStateTrap=syslogStateTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveDataRate=receiveDataRate, useVLANForManagementInterfaces=useVLANForManagementInterfaces, smtp=smtp, rFUSerial=rFUSerial, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, ptmp=ptmp, secondarySoftwareVersion=secondarySoftwareVersion, remoteMaximumTransmitPower=remoteMaximumTransmitPower, radioLicenseBandwidth=radioLicenseBandwidth, subnetMask=subnetMask, sNTPServerTimeout=sNTPServerTimeout, transmitPower=transmitPower, rFUVersionBank1=rFUVersionBank1, receiveCodeRate=receiveCodeRate, tFTPServerIPAddress=tFTPServerIPAddress, hTTPAccessEnabled=hTTPAccessEnabled, rFUTransceiverLocation=rFUTransceiverLocation, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, primaryRecoveryPeriod=primaryRecoveryPeriod, rFUVersionBank2=rFUVersionBank2, ethernet=ethernet, productVariant=productVariant, syslogState=syslogState, radioLicenseCodeRate=radioLicenseCodeRate, reset=reset, hardwareVersion=hardwareVersion, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, sMTPServerPortNumber=sMTPServerPortNumber, rFUPlatformCompatibility=rFUPlatformCompatibility, userTableNumber=userTableNumber, remoteIPAddress=remoteIPAddress, sNTPServerTableEntry=sNTPServerTableEntry, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, maximumTransmitPower=maximumTransmitPower, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, licence=licence, ethernetPriorityTableEntry=ethernetPriorityTableEntry, userTableEntry=userTableEntry, protectionStateTrap=protectionStateTrap, supplementary=supplementary)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", wirelessLinkStatus=wirelessLinkStatus, sNTPSyncTrap=sNTPSyncTrap, rFUFreqSpacing=rFUFreqSpacing, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFURxFreqMin=rFURxFreqMin, daylightSaving=daylightSaving, maxModulation=maxModulation, management=management, rxDiversityDataPortStatus=rxDiversityDataPortStatus, radioLicenseMinModulation=radioLicenseMinModulation, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, managementPortDisabledWarning=managementPortDisabledWarning, userEnabled=userEnabled, iPv4Address=iPv4Address, minCodeRate=minCodeRate, sNMPTrapTableEntry=sNMPTrapTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, phyStatus=phyStatus, primaryRecovery=primaryRecovery, tFTPServerInternetAddress=tFTPServerInternetAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, hTTPSAccessEnabled=hTTPSAccessEnabled, diverseAntennaGain=diverseAntennaGain, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, antennaGain=antennaGain, altitude=altitude, aAAControl=aAAControl, remoteInternetAddressType=remoteInternetAddressType, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rxDiversityVid=rxDiversityVid, ptp=ptp, sNTPPrimaryServer=sNTPPrimaryServer, longitude=longitude, wirelessLinkAvailability=wirelessLinkAvailability, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rFUTxBandAboveRx=rFUTxBandAboveRx, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, rFURxFreqMax=rFURxFreqMax, syslogClientTrap=syslogClientTrap, dataPortDisabledWarning=dataPortDisabledWarning, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerTableIndex=sNTPServerTableIndex, linkNameMismatch=linkNameMismatch, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, aggregateDataRate=aggregateDataRate, bootVersion=bootVersion, rFURfBand=rFURfBand, radioLicenseMaxModulation=radioLicenseMaxModulation, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUTxMuteStatus=rFUTxMuteStatus, iPv6GatewayAddress=iPv6GatewayAddress, alarms=alarms, managementPortAutoNegotiation=managementPortAutoNegotiation, numberOfAntennas=numberOfAntennas, protectionSwitchCause=protectionSwitchCause, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, managementPortForcedConfiguration=managementPortForcedConfiguration, qOSPriorityScheme=qOSPriorityScheme, hTTPSPortNumber=hTTPSPortNumber, receiveModulation=receiveModulation, sNMPTrapTable=sNMPTrapTable, dataPortStatusTrap=dataPortStatusTrap, protection=protection, sNTPServerRetries=sNTPServerRetries, ptpTrapPrefix=ptpTrapPrefix, protectionInterfaceStatus=protectionInterfaceStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rFUTxPowerMin=rFUTxPowerMin, userName=userName, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, softwareVersion=softwareVersion, rFUProtectionCompatibility=rFUProtectionCompatibility, userTable=userTable, diverseRfFeederLoss=diverseRfFeederLoss, rFUActiveFirmwareBank=rFUActiveFirmwareBank, sNMPEnabledTraps=sNMPEnabledTraps, linkName=linkName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rFUStatusTrap=rFUStatusTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType)
