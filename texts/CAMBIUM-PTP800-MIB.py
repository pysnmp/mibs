...
Integer32, ObjectIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, NotificationType, Unsigned32, Counter32, ModuleIdentity, Counter64, IpAddress, TimeTicks, Gauge32, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "NotificationType", "Unsigned32", "Counter32", "ModuleIdentity", "Counter64", "IpAddress", "TimeTicks", "Gauge32", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, subnetMask=subnetMask, managementCommittedInformationRate=managementCommittedInformationRate, sNMPTrapTable=sNMPTrapTable, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, managementPortStatusTrap=managementPortStatusTrap, enableTransmission=enableTransmission, dataPortFiberStatus=dataPortFiberStatus, rFUPowerAlarm=rFUPowerAlarm, sNTPServerRetries=sNTPServerRetries, remoteMaximumTransmitPower=remoteMaximumTransmitPower, alignmentMode=alignmentMode, activeAvailableTime=activeAvailableTime, l2CPPriorityTable=l2CPPriorityTable, sNTPLastSync=sNTPLastSync, maxCodeRate=maxCodeRate, transmitDataRate=transmitDataRate, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, managementPortAutoNegotiation=managementPortAutoNegotiation, fiberY=fiberY, radioLicenseMaxModulation=radioLicenseMaxModulation, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rFUVersionBank1=rFUVersionBank1, linkName=linkName, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, qOSPriorityScheme=qOSPriorityScheme, siteName=siteName, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, vectorError=vectorError, antennaGain=antennaGain, rFULockoutAlarm=rFULockoutAlarm, rFURxFreqMax=rFURxFreqMax, dataPortStatus=dataPortStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFURxFreqMin=rFURxFreqMin, sNTPServerTableIndex=sNTPServerTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, radioLicense=radioLicense, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptpTrapPrefix=ptpTrapPrefix, productName=productName, userTableNumber=userTableNumber, requestedProtectionState=requestedProtectionState, remoteSecondaryIPAddress=remoteSecondaryIPAddress, protectionState=protectionState, syslogClient=syslogClient, wirelessLinkAvailability=wirelessLinkAvailability, protectionConfigurationStatus=protectionConfigurationStatus, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, diverseAntennaGain=diverseAntennaGain, rFURFSwitchAlarm=rFURFSwitchAlarm, primarySecondaryMode=primarySecondaryMode, diverseRfFeederLoss=diverseRfFeederLoss, radioLicenseIdentifier=radioLicenseIdentifier, encryption=encryption, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, remoteInternetAddressType=remoteInternetAddressType, rFFeederLoss=rFFeederLoss, sNTPState=sNTPState, remotePrimarySecondaryMode=remotePrimarySecondaryMode, gatewayIPAddress=gatewayIPAddress, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, iPv6Address=iPv6Address, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, systemReset=systemReset, sNMPTrapTableEntry=sNMPTrapTableEntry, protection=protection, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPCommunityString=sNMPCommunityString, syslogStateTrap=syslogStateTrap, rFUTransceiverLocation=rFUTransceiverLocation, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, altitude=altitude, daylightSaving=daylightSaving, remotePrimaryIPAddress=remotePrimaryIPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, wirelessLinkStatus=wirelessLinkStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, faultProtectionSwitching=faultProtectionSwitching, receivePower=receivePower, neighborInternetAddress=neighborInternetAddress, radioLicenseRegion=radioLicenseRegion, protectionInterfaceStatus=protectionInterfaceStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPServerIPAddress=tFTPServerIPAddress, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, ptpTraps=ptpTraps, userRole=userRole, protectionStatus=protectionStatus, protectionStats=protectionStats, sNTPSyncTrap=sNTPSyncTrap, primaryRecoveryPeriod=primaryRecoveryPeriod, smtp=smtp, ptmp=ptmp, radioLicenseBandwidth=radioLicenseBandwidth, rFUActiveFirmwareBank=rFUActiveFirmwareBank, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rFUStatusTrap=rFUStatusTrap, remoteIPAddress=remoteIPAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, neighborInternetAddressType=neighborInternetAddressType, managementMode=managementMode, hTTPSAccessEnabled=hTTPSAccessEnabled, radioLicenseCodeRate=radioLicenseCodeRate, aTPCEnable=aTPCEnable, sNTPPrimaryServer=sNTPPrimaryServer, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, productVariant=productVariant, ethernetPriorityTableEntry=ethernetPriorityTableEntry, transmitCodeRate=transmitCodeRate, hTTPPortNumber=hTTPPortNumber, rFUTxFreqMin=rFUTxFreqMin, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, transmitCapacityLimitDetail=transmitCapacityLimitDetail, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ethernetPriorityTable=ethernetPriorityTable, sNMPPortNumber=sNMPPortNumber, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, sNTPSync=sNTPSync, sNTPServerTableNumber=sNTPServerTableNumber, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, syslogClientTrap=syslogClientTrap, radioLicenseRxFreq=radioLicenseRxFreq, dataPortDisabledWarning=dataPortDisabledWarning, hTTPAccessEnabled=hTTPAccessEnabled, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, radioLicenseBand=radioLicenseBand, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, radioLicenseMinModulation=radioLicenseMinModulation, protectionStateTrap=protectionStateTrap, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, licence=licence, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, secondarySoftwareVersion=secondarySoftwareVersion, linkNameMismatchTrap=linkNameMismatchTrap, telnetPortNumber=telnetPortNumber, rFUTxPowerMin=rFUTxPowerMin, iPv6GatewayAddress=iPv6GatewayAddress, rxDiversityVlanTpid=rxDiversityVlanTpid, secureModeAlarm=secureModeAlarm, management=management, transmitterStatus=transmitterStatus, phyStatus=phyStatus, endId=endId, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, transmitCapacity=transmitCapacity, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, numberOfAntennas=numberOfAntennas, supplementary=supplementary, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userName=userName, sNTPServerInternetAddress=sNTPServerInternetAddress, managementPortForcedConfiguration=managementPortForcedConfiguration, hardwareVersion=hardwareVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, minModulation=minModulation, mPLSTCPriorityTable=mPLSTCPriorityTable, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rFUTxPowerMax=rFUTxPowerMax, userEnabled=userEnabled, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, linkLoss=linkLoss, dataPortPauseFrames=dataPortPauseFrames, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, iPVersion=iPVersion, vLANManagementPriority=vLANManagementPriority, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, unitOutOfCalibration=unitOutOfCalibration, rFUTxPowerAlarm=rFUTxPowerAlarm, reset=reset, longitude=longitude, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFUPowerButtonPressed=rFUPowerButtonPressed, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, phyControl=phyControl, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, remoteSecondaryMACAddress=remoteSecondaryMACAddress, managementPortStatus=managementPortStatus, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rFUBranchingConfiguration=rFUBranchingConfiguration, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, remoteMACAddress=remoteMACAddress, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, configuration=configuration, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, vLANManagementVID=vLANManagementVID, userTableIndex=userTableIndex, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, maxModulation=maxModulation, radioLicenseTxFreq=radioLicenseTxFreq, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, receiveCodeRate=receiveCodeRate, rFUStatus=rFUStatus, dataPortFiberStatusTrap=dataPortFiberStatusTrap, receiveDataRate=receiveDataRate, ethernet=ethernet, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, sNTPServerInternetAddressType=sNTPServerInternetAddressType, syslogState=syslogState, managementPortDisabledWarning=managementPortDisabledWarning, l2CPPriorityTableNumber=l2CPPriorityTableNumber, wirelessLinkStatusTrap=wirelessLinkStatusTrap, sNTPServerTable=sNTPServerTable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rFUVersionBank2=rFUVersionBank2, rFUCableAlarm=rFUCableAlarm, rFUSerial=rFUSerial, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, remoteInternetAddress=remoteInternetAddress, radioLicenseModulation=radioLicenseModulation, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, sMTPServerIPAddress=sMTPServerIPAddress, rFURfBand=rFURfBand, timeZone=timeZone, vLANManagementVIDValidation=vLANManagementVIDValidation, sMTPServerInternetAddressType=sMTPServerInternetAddressType, userPassword=userPassword, syslogControl=syslogControl, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, cambium=cambium, dataPortConfigurationMismatch=dataPortConfigurationMismatch, activeUnit=activeUnit, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerPortNumber=sNTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, iPv6PrefixLength=iPv6PrefixLength, transmitPower=transmitPower)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", alignmentModeTrap=alignmentModeTrap, softwareVersion=softwareVersion, rFUFreqSpacing=rFUFreqSpacing, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rFUConnectedPlatform=rFUConnectedPlatform, encryptionEnabledMismatch=encryptionEnabledMismatch, pubStats=pubStats, iFCableLength=iFCableLength, versions=versions, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, primaryRecovery=primaryRecovery, remotePrimaryMACAddress=remotePrimaryMACAddress, userTableEntry=userTableEntry, rFUTxFreqMax=rFUTxFreqMax, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, l2CPPriorityTableIndex=l2CPPriorityTableIndex, protectionConfig=protectionConfig, maximumTransmitPower=maximumTransmitPower, receiveModulation=receiveModulation, latitude=latitude, dSCPManagementPriority=dSCPManagementPriority, sNTPServerTimeout=sNTPServerTimeout, encryptionAlgorithm=encryptionAlgorithm, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, aggregateDataRate=aggregateDataRate, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, neighborIPAddress=neighborIPAddress, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, hTTPSPortNumber=hTTPSPortNumber, snmpControl=snmpControl, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, sMTPServerPortNumber=sMTPServerPortNumber, minCodeRate=minCodeRate, sNTPServerIPAddress=sNTPServerIPAddress, rFUType=rFUType, userTable=userTable, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ptp800=ptp800, bootVersion=bootVersion, telnetAccessEnabled=telnetAccessEnabled, sMTPEmailAlert=sMTPEmailAlert, rFUTxMuteStatus=rFUTxMuteStatus, iPv4Address=iPv4Address, transmitCapacityLimit=transmitCapacityLimit, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, aAAControl=aAAControl, systemClock=systemClock, radioLicenseMaxEIRP=radioLicenseMaxEIRP, sNMPTrapIPAddress=sNMPTrapIPAddress, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, ptp=ptp, neighborMACAddress=neighborMACAddress, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, protectionSwitchCause=protectionSwitchCause, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPTrapVersion=sNMPTrapVersion, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, securityLevel=securityLevel, transmitModulation=transmitModulation, bridge=bridge, alarms=alarms, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPPollInterval=sNTPPollInterval, rFUTxBandAboveRx=rFUTxBandAboveRx, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rFUPlatformCompatibility=rFUPlatformCompatibility, protectionAvailabilityStatus=protectionAvailabilityStatus, remotePrimaryInternetAddress=remotePrimaryInternetAddress, sNTPServerResponse=sNTPServerResponse, rxDiversityVid=rxDiversityVid, rFURpsAlarm=rFURpsAlarm, linkNameMismatch=linkNameMismatch, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rfu=rfu, secureModeAlarmTrap=secureModeAlarmTrap, ethernetFiberSupport=ethernetFiberSupport, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sNTPServerTableEntry=sNTPServerTableEntry, rFUProtectionCompatibility=rFUProtectionCompatibility, sntp=sntp, localPacketFiltering=localPacketFiltering)
