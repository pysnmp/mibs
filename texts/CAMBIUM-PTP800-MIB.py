...
MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, Integer32, Bits, Gauge32, MibIdentifier, Counter32, Counter64, NotificationType, ModuleIdentity, IpAddress, TimeTicks, NotificationType, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "Integer32", "Bits", "Gauge32", "MibIdentifier", "Counter32", "Counter64", "NotificationType", "ModuleIdentity", "IpAddress", "TimeTicks", "NotificationType", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", syslogState=syslogState, rFUPowerAlarm=rFUPowerAlarm, remoteIPAddress=remoteIPAddress, neighborInternetAddressType=neighborInternetAddressType, alignmentMode=alignmentMode, linkNameMismatch=linkNameMismatch, neighborMACAddress=neighborMACAddress, smtp=smtp, siteName=siteName, remoteInternetAddressType=remoteInternetAddressType, radioLicenseBand=radioLicenseBand, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rxDiversityVid=rxDiversityVid, protectionSwitchCause=protectionSwitchCause, sNTPServerPortNumber=sNTPServerPortNumber, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, sNTPPrimaryServer=sNTPPrimaryServer, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, wirelessLinkStatus=wirelessLinkStatus, linkName=linkName, rFUTxBandAboveRx=rFUTxBandAboveRx, rFUConnectedPlatform=rFUConnectedPlatform, management=management, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerInternetAddress=sNTPServerInternetAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPServerInternetAddress=tFTPServerInternetAddress, rFURFSwitchAlarm=rFURFSwitchAlarm, systemReset=systemReset, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, sNTPPollInterval=sNTPPollInterval, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerPortNumber=tFTPServerPortNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dataPortStatus=dataPortStatus, rFUSerial=rFUSerial, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sMTPEnabledMessages=sMTPEnabledMessages, cambium=cambium, managementPortDisabledWarning=managementPortDisabledWarning, secondarySoftwareVersion=secondarySoftwareVersion, radioLicenseModulation=radioLicenseModulation, remoteSecondaryIPAddress=remoteSecondaryIPAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPServerRetries=sNTPServerRetries, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rFURfBand=rFURfBand, remotePrimarySecondaryMode=remotePrimarySecondaryMode, sMTPServerIPAddress=sMTPServerIPAddress, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, linkLoss=linkLoss, rFFeederLoss=rFFeederLoss, hardwareVersion=hardwareVersion, snmpControl=snmpControl, aTPCEnable=aTPCEnable, licence=licence, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rfu=rfu, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, remoteMACAddress=remoteMACAddress, rxDiversityDataPortStatus=rxDiversityDataPortStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, pubStats=pubStats, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, sNTPState=sNTPState, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, requestedProtectionState=requestedProtectionState, maximumTransmitPower=maximumTransmitPower, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapVersion=sNMPTrapVersion, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rFUActiveFirmwareBank=rFUActiveFirmwareBank, userTable=userTable, managementPortStatus=managementPortStatus, sNTPSync=sNTPSync, ptpTrapPrefix=ptpTrapPrefix, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rFUTxPowerAlarm=rFUTxPowerAlarm, telnetPortNumber=telnetPortNumber, remotePrimaryIPAddress=remotePrimaryIPAddress, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, activeWirelessLinkAvailability=activeWirelessLinkAvailability, neighborInternetAddress=neighborInternetAddress, vLANManagementVIDValidation=vLANManagementVIDValidation, radioLicenseMaxEIRP=radioLicenseMaxEIRP, radioLicense=radioLicense, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rFUTxMuteStatus=rFUTxMuteStatus, linkNameMismatchTrap=linkNameMismatchTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, iPv6GatewayAddress=iPv6GatewayAddress, syslogControl=syslogControl, protectionStateTrap=protectionStateTrap, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, aggregateDataRate=aggregateDataRate, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, rFUBranchingConfiguration=rFUBranchingConfiguration, productName=productName, bridge=bridge, userEnabled=userEnabled, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, unitOutOfCalibration=unitOutOfCalibration, transmitDataRate=transmitDataRate, systemClock=systemClock, radioLicenseIdentifier=radioLicenseIdentifier, remotePrimaryInternetAddress=remotePrimaryInternetAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, iPVersion=iPVersion, diverseAntennaGain=diverseAntennaGain, managementPortConfigurationMismatch=managementPortConfigurationMismatch, subnetMask=subnetMask, sNTPServerInternetAddressType=sNTPServerInternetAddressType, receiveCodeRate=receiveCodeRate, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPLastSync=sNTPLastSync, localPacketFiltering=localPacketFiltering, iPv6PrefixLength=iPv6PrefixLength, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, radioLicenseMinModulation=radioLicenseMinModulation, fiberY=fiberY, sNMPTrapTable=sNMPTrapTable, vLANManagementVID=vLANManagementVID, sNTPServerTimeout=sNTPServerTimeout, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementPortWirelessDownAlert=managementPortWirelessDownAlert, radioLicenseMinCodeRate=radioLicenseMinCodeRate, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, protectionConfigurationStatus=protectionConfigurationStatus, rFUTransceiverLocation=rFUTransceiverLocation, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, activeAvailableTime=activeAvailableTime, gatewayIPAddress=gatewayIPAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, primaryRecovery=primaryRecovery, userTableEntry=userTableEntry, sNTPServerResponse=sNTPServerResponse, sMTPEmailAlert=sMTPEmailAlert, managementCommittedInformationRate=managementCommittedInformationRate, securityLevel=securityLevel, managementMode=managementMode, sNMPTrapIPAddress=sNMPTrapIPAddress, encryption=encryption, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, l2CPPriorityTableNumber=l2CPPriorityTableNumber, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ptp800=ptp800, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, remoteInternetAddress=remoteInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPPortNumber=sNMPPortNumber, transmitCodeRate=transmitCodeRate, phyControl=phyControl, rFUVersionBank2=rFUVersionBank2, latitude=latitude, vLANManagementPriority=vLANManagementPriority, userPassword=userPassword, aAAControl=aAAControl, radioLicenseMaxModulation=radioLicenseMaxModulation, alignmentModeTrap=alignmentModeTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, maxCodeRate=maxCodeRate, ethernetFiberSupport=ethernetFiberSupport, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, phyStatus=phyStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rFUFreqSpacing=rFUFreqSpacing, protection=protection, rFURxFreqMin=rFURxFreqMin, sNTPServerTableIndex=sNTPServerTableIndex, minModulation=minModulation, rxDiversityVlanTpid=rxDiversityVlanTpid, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, radioLicenseTxFreq=radioLicenseTxFreq, userName=userName, daylightSaving=daylightSaving, diverseRfFeederLoss=diverseRfFeederLoss, sNTPServerTableEntry=sNTPServerTableEntry, receiveDataRate=receiveDataRate, wirelessLinkAvailability=wirelessLinkAvailability, syslogClientTrap=syslogClientTrap, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, managementPortStatusTrap=managementPortStatusTrap, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, antennaGain=antennaGain, dataPortFiberStatus=dataPortFiberStatus, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, transmitCapacityLimit=transmitCapacityLimit, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityTable=l2CPPriorityTable, managementPortForcedConfiguration=managementPortForcedConfiguration, sMTPSourceEmailAddress=sMTPSourceEmailAddress, secureModeAlarm=secureModeAlarm, ethernetPriorityTableEntry=ethernetPriorityTableEntry, qOSPriorityScheme=qOSPriorityScheme, sNTPServerIPAddress=sNTPServerIPAddress, faultProtectionSwitching=faultProtectionSwitching, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, timeZone=timeZone, versions=versions, enableTransmission=enableTransmission, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, alarms=alarms, ptpTraps=ptpTraps, ptp=ptp, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, radioLicenseBandwidth=radioLicenseBandwidth, rFUPlatformCompatibility=rFUPlatformCompatibility, bootVersion=bootVersion, rFUVersionBank1=rFUVersionBank1, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFUType=rFUType, radioLicenseRxFreq=radioLicenseRxFreq, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerTableNumber=sNTPServerTableNumber, neighborIPAddress=neighborIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitCapacity=transmitCapacity, syslogStateTrap=syslogStateTrap, transmitterStatus=transmitterStatus, ethernet=ethernet, iPv4Address=iPv4Address, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFULockoutAlarm=rFULockoutAlarm, primaryRecoveryPeriod=primaryRecoveryPeriod, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, protectionConfig=protectionConfig, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, managementPortAutoNegotiation=managementPortAutoNegotiation, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, vectorError=vectorError, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, dSCPManagementPriority=dSCPManagementPriority, iFCableLength=iFCableLength, rFUPowerButtonPressed=rFUPowerButtonPressed, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rFUTxFreqMax=rFUTxFreqMax, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, protectionAvailabilityStatus=protectionAvailabilityStatus, radioLicenseRegion=radioLicenseRegion, rFUStatusTrap=rFUStatusTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", protectionState=protectionState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPPortNumber=hTTPPortNumber, syslogClient=syslogClient, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, remotePrimaryMACAddress=remotePrimaryMACAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ptmp=ptmp, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, dataPortDisabledWarning=dataPortDisabledWarning, protectionStats=protectionStats, transmitModulation=transmitModulation, sNMPCommunityString=sNMPCommunityString, userTableNumber=userTableNumber, sntp=sntp, receivePower=receivePower, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, iPv6Address=iPv6Address, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, wirelessLinkStatusTrap=wirelessLinkStatusTrap, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, configuration=configuration, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, receiveModulation=receiveModulation, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortPauseFrames=dataPortPauseFrames, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, altitude=altitude, tFTPServerIPAddress=tFTPServerIPAddress, ethernetPriorityTable=ethernetPriorityTable, numberOfAntennas=numberOfAntennas, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, transmitPower=transmitPower, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rFUTxPowerMin=rFUTxPowerMin, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rFURpsAlarm=rFURpsAlarm, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, remoteMaximumTransmitPower=remoteMaximumTransmitPower, activeUnit=activeUnit, protectionInterfaceStatus=protectionInterfaceStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, rFUTxPowerMax=rFUTxPowerMax, supplementary=supplementary, sNMPTrapTableIndex=sNMPTrapTableIndex, rFUCableAlarm=rFUCableAlarm, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, rFURxFreqMax=rFURxFreqMax, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, transmitCapacityLimitDetail=transmitCapacityLimitDetail, maxModulation=maxModulation, rFUStatus=rFUStatus, sNTPServerTable=sNTPServerTable, encryptionEnabledMismatch=encryptionEnabledMismatch, rFUProtectionCompatibility=rFUProtectionCompatibility, longitude=longitude, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, productVariant=productVariant, userTableIndex=userTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, encryptionAlgorithm=encryptionAlgorithm, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPSyncTrap=sNTPSyncTrap, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userRole=userRole, minCodeRate=minCodeRate, endId=endId, dataPortStatusTrap=dataPortStatusTrap, radioLicenseCodeRate=radioLicenseCodeRate, ethernetPriorityTableNumber=ethernetPriorityTableNumber, protectionStatus=protectionStatus, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, reset=reset, softwareVersion=softwareVersion, secureModeAlarmTrap=secureModeAlarmTrap, rFUTxFreqMin=rFUTxFreqMin, sMTPServerInternetAddressType=sMTPServerInternetAddressType, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, primarySecondaryMode=primarySecondaryMode, remoteSecondaryMACAddress=remoteSecondaryMACAddress)
