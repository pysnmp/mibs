...
Bits, ModuleIdentity, MibIdentifier, Counter32, ObjectIdentity, NotificationType, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, TimeTicks, Unsigned32, enterprises, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "MibIdentifier", "Counter32", "ObjectIdentity", "NotificationType", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "TimeTicks", "Unsigned32", "enterprises", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", protectionState=protectionState, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, hTTPAccessEnabled=hTTPAccessEnabled, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, alignmentModeTrap=alignmentModeTrap, userRole=userRole, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, rFUVersionBank2=rFUVersionBank2, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPLastSync=sNTPLastSync, userName=userName, rFUPowerButtonPressed=rFUPowerButtonPressed, sNTPServerResponse=sNTPServerResponse, rFUTxPowerMin=rFUTxPowerMin, radioLicenseMinModulation=radioLicenseMinModulation, alignmentMode=alignmentMode, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, rFUTxPowerAlarm=rFUTxPowerAlarm, maximumTransmitPower=maximumTransmitPower, linkLoss=linkLoss, linkNameMismatch=linkNameMismatch, activeWirelessLinkAvailability=activeWirelessLinkAvailability, sNTPServerTimeout=sNTPServerTimeout, rFUTxFreqMax=rFUTxFreqMax, localPacketFiltering=localPacketFiltering, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerTable=sNTPServerTable, sMTPServerInternetAddressType=sMTPServerInternetAddressType, rFUSerial=rFUSerial, diverseAntennaGain=diverseAntennaGain, sNTPServerInternetAddress=sNTPServerInternetAddress, remoteInternetAddress=remoteInternetAddress, protectionStateTrap=protectionStateTrap, rxDiversityDataPortStatus=rxDiversityDataPortStatus, vLANManagementVID=vLANManagementVID, syslogClientTrap=syslogClientTrap, rFULockoutAlarm=rFULockoutAlarm, aTPCEnable=aTPCEnable, syslogState=syslogState, phyStatus=phyStatus, minCodeRate=minCodeRate, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, fiberY=fiberY, iPv4Address=iPv4Address, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUStatusTrap=rFUStatusTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, versions=versions, userTableIndex=userTableIndex, subnetMask=subnetMask, transmitPower=transmitPower, endId=endId, iPv6Address=iPv6Address, ethernetPriorityTableIndex=ethernetPriorityTableIndex, remoteIPAddress=remoteIPAddress, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rxDiversityVlanTpid=rxDiversityVlanTpid, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, userTable=userTable, protectionConfigurationStatus=protectionConfigurationStatus, receiveDataRate=receiveDataRate, rFUTxBandAboveRx=rFUTxBandAboveRx, mPLSTCPriorityTable=mPLSTCPriorityTable, hTTPSAccessEnabled=hTTPSAccessEnabled, rFUTxPowerMax=rFUTxPowerMax, radioLicenseBand=radioLicenseBand, gatewayIPAddress=gatewayIPAddress, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernetPriorityTable=ethernetPriorityTable, rFURFSwitchAlarm=rFURFSwitchAlarm, managementPortForcedConfiguration=managementPortForcedConfiguration, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, dataPortStatus=dataPortStatus, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, sMTPEnabledMessages=sMTPEnabledMessages, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, userTableEntry=userTableEntry, maxCodeRate=maxCodeRate, qOSPriorityScheme=qOSPriorityScheme, tFTPServerPortNumber=tFTPServerPortNumber, syslogStateTrap=syslogStateTrap, sNTPServerRetries=sNTPServerRetries, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, transmitCapacityLimit=transmitCapacityLimit, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, rFURxFreqMin=rFURxFreqMin, daylightSaving=daylightSaving, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, smtp=smtp, altitude=altitude, managementMode=managementMode, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, activeAvailableTime=activeAvailableTime, ptp=ptp, snmpControl=snmpControl, protectionStats=protectionStats, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, remoteMACAddress=remoteMACAddress, vLANManagementVIDValidation=vLANManagementVIDValidation, primarySecondaryMode=primarySecondaryMode, radioLicenseIdentifier=radioLicenseIdentifier, bootVersion=bootVersion, timeZone=timeZone, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, configuration=configuration, ethernet=ethernet, aAAControl=aAAControl, linkName=linkName, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, protectionStatus=protectionStatus, hTTPPortNumber=hTTPPortNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, transmitDataRate=transmitDataRate, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, ptpTraps=ptpTraps, dataPortFiberStatusTrap=dataPortFiberStatusTrap, transmitterStatus=transmitterStatus, sNTPServerTableNumber=sNTPServerTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, antennaGain=antennaGain, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rFUPowerAlarm=rFUPowerAlarm, protectionConfig=protectionConfig, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, longitude=longitude, radioLicenseBandwidth=radioLicenseBandwidth, userPassword=userPassword, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, managementCommittedInformationRate=managementCommittedInformationRate, sNTPPrimaryServer=sNTPPrimaryServer, managementPortStatus=managementPortStatus, rFUBranchingConfiguration=rFUBranchingConfiguration, radioLicenseMaxModulation=radioLicenseMaxModulation, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerTableEntry=sNTPServerTableEntry, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, telnetPortNumber=telnetPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, receivePower=receivePower, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortFiberStatus=dataPortFiberStatus, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, alarms=alarms, sMTPServerIPAddress=sMTPServerIPAddress, remoteInternetAddressType=remoteInternetAddressType, rFUTxFreqMin=rFUTxFreqMin, radioLicenseTxFreq=radioLicenseTxFreq, secureModeAlarm=secureModeAlarm, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, dataPortWirelessDownAlert=dataPortWirelessDownAlert, productVariant=productVariant, numberOfAntennas=numberOfAntennas, userTableNumber=userTableNumber, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, activeUnit=activeUnit, useVLANForManagementInterfaces=useVLANForManagementInterfaces, remoteSecondaryIPAddress=remoteSecondaryIPAddress, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, remotePrimaryIPAddress=remotePrimaryIPAddress, protectionSwitchCause=protectionSwitchCause, l2CPPriorityTable=l2CPPriorityTable, ptpTrapPrefix=ptpTrapPrefix, ethernetFiberSupport=ethernetFiberSupport, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, hardwareVersion=hardwareVersion, sNTPServerIPAddress=sNTPServerIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, radioLicenseRegion=radioLicenseRegion, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPServerTableIndex=sNTPServerTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, radioLicenseCodeRate=radioLicenseCodeRate, sNMPPortNumber=sNMPPortNumber, protectionInterfaceStatus=protectionInterfaceStatus, rxDiversityVid=rxDiversityVid, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rFUType=rFUType, iPv6GatewayAddress=iPv6GatewayAddress, sNTPServerPortNumber=sNTPServerPortNumber, transmitCodeRate=transmitCodeRate, iFCableLength=iFCableLength, enableTransmission=enableTransmission, systemClock=systemClock, minModulation=minModulation, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userEnabled=userEnabled, managementPortStatusTrap=managementPortStatusTrap, systemReset=systemReset, rFUVersionBank1=rFUVersionBank1, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, tFTPServerIPAddress=tFTPServerIPAddress, remotePrimarySecondaryMode=remotePrimarySecondaryMode, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, faultProtectionSwitching=faultProtectionSwitching, management=management, rFUConnectedPlatform=rFUConnectedPlatform, rFURfBand=rFURfBand, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, cambium=cambium, rfu=rfu, licence=licence, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, transmitCapacityLimitDetail=transmitCapacityLimitDetail, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, neighborIPAddress=neighborIPAddress, syslogControl=syslogControl, radioLicenseModulation=radioLicenseModulation, remoteSecondaryMACAddress=remoteSecondaryMACAddress, softwareVersion=softwareVersion, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANManagementPriority=vLANManagementPriority, encryption=encryption, syslogClient=syslogClient, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, hTTPSPortNumber=hTTPSPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, protectionAvailabilityStatus=protectionAvailabilityStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, requestedProtectionState=requestedProtectionState, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rFUPlatformCompatibility=rFUPlatformCompatibility, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFUTransceiverLocation=rFUTransceiverLocation, securityLevel=securityLevel, sNMPTrapVersion=sNMPTrapVersion)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", linkNameMismatchTrap=linkNameMismatchTrap, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPVersion=iPVersion, l2CPPriorityTableIndex=l2CPPriorityTableIndex, siteName=siteName, supplementary=supplementary, iPv6PrefixLength=iPv6PrefixLength, productName=productName, managementPortAutoNegotiation=managementPortAutoNegotiation, dataPortPauseFrames=dataPortPauseFrames, unitOutOfCalibration=unitOutOfCalibration, managementPortDisabledWarning=managementPortDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, transmitModulation=transmitModulation, sNTPServerInternetAddressType=sNTPServerInternetAddressType, telnetAccessEnabled=telnetAccessEnabled, vectorError=vectorError, sNMPCommunityString=sNMPCommunityString, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rFUCableAlarm=rFUCableAlarm, rFURpsAlarm=rFURpsAlarm, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, ptmp=ptmp, radioLicenseMaxEIRP=radioLicenseMaxEIRP, maxModulation=maxModulation, wirelessLinkStatusTrap=wirelessLinkStatusTrap, sNMPTrapTable=sNMPTrapTable, transmitCapacity=transmitCapacity, neighborMACAddress=neighborMACAddress, phyControl=phyControl, bridge=bridge, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, ptp800=ptp800, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogLocalWrappedTrap=syslogLocalWrappedTrap, primaryRecoveryPeriod=primaryRecoveryPeriod, wirelessLinkStatus=wirelessLinkStatus, sNTPState=sNTPState, encryptionAlgorithm=encryptionAlgorithm, primaryRecovery=primaryRecovery, remotePrimaryMACAddress=remotePrimaryMACAddress, sMTPEmailAlert=sMTPEmailAlert, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, radioLicenseRxFreq=radioLicenseRxFreq, encryptionEnabledMismatch=encryptionEnabledMismatch, aggregateDataRate=aggregateDataRate, rFUFreqSpacing=rFUFreqSpacing, rFURxFreqMax=rFURxFreqMax, sNTPSync=sNTPSync, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, reset=reset, rFUProtectionCompatibility=rFUProtectionCompatibility, rFUTxMuteStatus=rFUTxMuteStatus, protection=protection, neighborInternetAddressType=neighborInternetAddressType, radioLicense=radioLicense, pubStats=pubStats, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sntp=sntp, remotePrimaryInternetAddress=remotePrimaryInternetAddress, sNTPSyncTrap=sNTPSyncTrap, dSCPManagementPriority=dSCPManagementPriority, dataPortStatusTrap=dataPortStatusTrap, sNTPPollInterval=sNTPPollInterval, dataPortDisabledWarning=dataPortDisabledWarning, secureModeAlarmTrap=secureModeAlarmTrap, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, latitude=latitude, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, neighborInternetAddress=neighborInternetAddress, receiveCodeRate=receiveCodeRate, rFFeederLoss=rFFeederLoss, diverseRfFeederLoss=diverseRfFeederLoss, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, receiveModulation=receiveModulation, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFUStatus=rFUStatus, sNMPEnabledTraps=sNMPEnabledTraps, rFUActiveFirmwareBank=rFUActiveFirmwareBank, radioLicenseMinCodeRate=radioLicenseMinCodeRate, l2CPPriorityTableEntry=l2CPPriorityTableEntry)
