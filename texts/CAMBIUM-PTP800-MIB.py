...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, ModuleIdentity, Bits, Counter64, NotificationType, enterprises, iso, Counter32, Integer32, NotificationType, Gauge32, IpAddress, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Bits", "Counter64", "NotificationType", "enterprises", "iso", "Counter32", "Integer32", "NotificationType", "Gauge32", "IpAddress", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", remoteSecondaryIPAddress=remoteSecondaryIPAddress, management=management, latitude=latitude, protectionInterfaceStatus=protectionInterfaceStatus, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, unitOutOfCalibration=unitOutOfCalibration, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTableEntry=sNMPTrapTableEntry, bootVersion=bootVersion, rFUType=rFUType, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, receiveCodeRate=receiveCodeRate, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, remotePrimaryInternetAddress=remotePrimaryInternetAddress, sNTPServerIPAddress=sNTPServerIPAddress, rFUTxPowerMin=rFUTxPowerMin, sMTPEnabledMessages=sMTPEnabledMessages, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPLastSync=sNTPLastSync, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, protection=protection, softwareVersion=softwareVersion, rFUSerial=rFUSerial, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, maxModulation=maxModulation, dataPortConfigurationMismatch=dataPortConfigurationMismatch, transmitCodeRate=transmitCodeRate, altitude=altitude, radioLicenseMinCodeRate=radioLicenseMinCodeRate, sNTPSync=sNTPSync, userTableEntry=userTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, remoteIPAddress=remoteIPAddress, managementPortAutoNegotiation=managementPortAutoNegotiation, ptpTrapPrefix=ptpTrapPrefix, managementPortDisabledWarning=managementPortDisabledWarning, ethernetPriorityTable=ethernetPriorityTable, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, rFUProtectionCompatibility=rFUProtectionCompatibility, hTTPPortNumber=hTTPPortNumber, radioLicenseBand=radioLicenseBand, userEnabled=userEnabled, transmitDataRate=transmitDataRate, sMTPServerIPAddress=sMTPServerIPAddress, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, productName=productName, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, managementPortForcedConfiguration=managementPortForcedConfiguration, antennaGain=antennaGain, secondarySoftwareVersion=secondarySoftwareVersion, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, rFURfBand=rFURfBand, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, userName=userName, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, transmitterStatus=transmitterStatus, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rFURFSwitchAlarm=rFURFSwitchAlarm, protectionStateTrap=protectionStateTrap, configuration=configuration, userRole=userRole, rxDiversityDataPortStatus=rxDiversityDataPortStatus, minModulation=minModulation, neighborIPAddress=neighborIPAddress, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, encryption=encryption, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, radioLicenseMinModulation=radioLicenseMinModulation, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, hardwareVersion=hardwareVersion, rFUTxMuteStatus=rFUTxMuteStatus, siteName=siteName, remoteMACAddress=remoteMACAddress, licence=licence, telnetPortNumber=telnetPortNumber, iFCableLength=iFCableLength, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, protectionSwitchCause=protectionSwitchCause, vLANManagementPriority=vLANManagementPriority, rFUVersionBank2=rFUVersionBank2, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, sNTPSyncTrap=sNTPSyncTrap, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, dataPortFiberStatus=dataPortFiberStatus, maxCodeRate=maxCodeRate, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, radioLicenseIdentifier=radioLicenseIdentifier, iPv6PrefixLength=iPv6PrefixLength, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, activeAvailableTime=activeAvailableTime, sNMPTrapVersion=sNMPTrapVersion, rFUPowerAlarm=rFUPowerAlarm, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, qOSPriorityScheme=qOSPriorityScheme, sNTPState=sNTPState, telnetAccessEnabled=telnetAccessEnabled, syslogClientTrap=syslogClientTrap, longitude=longitude, syslogControl=syslogControl, rFUTxBandAboveRx=rFUTxBandAboveRx, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, versions=versions, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFUTxFreqMax=rFUTxFreqMax, sntp=sntp, ethernetFiberSupport=ethernetFiberSupport, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, supplementary=supplementary, rfu=rfu, rFULockoutAlarm=rFULockoutAlarm, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rFUActiveFirmwareBank=rFUActiveFirmwareBank, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, activeUnit=activeUnit, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, radioLicenseMaxEIRP=radioLicenseMaxEIRP, syslogState=syslogState, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetPriorityTableIndex=ethernetPriorityTableIndex, alarms=alarms, aAAControl=aAAControl, rFUTxFreqMin=rFUTxFreqMin, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFUPowerButtonPressed=rFUPowerButtonPressed, transmitModulation=transmitModulation, linkNameMismatch=linkNameMismatch, localPacketFiltering=localPacketFiltering, remoteInternetAddressType=remoteInternetAddressType, securityLevel=securityLevel, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, alignmentModeTrap=alignmentModeTrap, requestedProtectionState=requestedProtectionState, sNTPServerTableNumber=sNTPServerTableNumber, sNMPCommunityString=sNMPCommunityString, neighborInternetAddress=neighborInternetAddress, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ptp=ptp, rFUConnectedPlatform=rFUConnectedPlatform, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rFFeederLoss=rFFeederLoss, linkName=linkName, transmitCapacityLimitDetail=transmitCapacityLimitDetail, syslogClient=syslogClient, sNMPTrapTableIndex=sNMPTrapTableIndex, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, neighborMACAddress=neighborMACAddress, radioLicenseRegion=radioLicenseRegion, protectionState=protectionState, wirelessLinkAvailability=wirelessLinkAvailability, protectionStatus=protectionStatus, remoteInternetAddress=remoteInternetAddress, secureModeAlarmTrap=secureModeAlarmTrap, rFUCableAlarm=rFUCableAlarm, protectionAvailabilityStatus=protectionAvailabilityStatus, rxDiversityVid=rxDiversityVid, phyControl=phyControl, protectionConfigurationStatus=protectionConfigurationStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, fiberY=fiberY, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, dataPortDisabledWarning=dataPortDisabledWarning, iPv6Address=iPv6Address, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, managementPortStatus=managementPortStatus, sMTPServerPortNumber=sMTPServerPortNumber, diverseAntennaGain=diverseAntennaGain, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, numberOfAntennas=numberOfAntennas, rFUTxPowerMax=rFUTxPowerMax, protectionConfig=protectionConfig, managementCommittedInformationRate=managementCommittedInformationRate, radioLicenseBandwidth=radioLicenseBandwidth, radioLicenseTxFreq=radioLicenseTxFreq, remotePrimaryMACAddress=remotePrimaryMACAddress, phyStatus=phyStatus, rFURpsAlarm=rFURpsAlarm, maximumTransmitPower=maximumTransmitPower, receivePower=receivePower, remotePrimarySecondaryMode=remotePrimarySecondaryMode, sMTPEmailAlert=sMTPEmailAlert, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerRetries=sNTPServerRetries, transmitCapacityLimit=transmitCapacityLimit, smtp=smtp, receiveDataRate=receiveDataRate, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, sNTPServerTable=sNTPServerTable, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPServerPortNumber=tFTPServerPortNumber, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, systemClock=systemClock, sNMPEnabledTraps=sNMPEnabledTraps, secureModeAlarm=secureModeAlarm, radioLicenseModulation=radioLicenseModulation, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, remoteMaximumTransmitPower=remoteMaximumTransmitPower, managementPortStatusTrap=managementPortStatusTrap, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, daylightSaving=daylightSaving, aggregateDataRate=aggregateDataRate, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, wirelessLinkStatusTrap=wirelessLinkStatusTrap, l2CPPriorityTable=l2CPPriorityTable, rFUFreqSpacing=rFUFreqSpacing, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, userPassword=userPassword, hTTPAccessEnabled=hTTPAccessEnabled, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vLANManagementVIDValidation=vLANManagementVIDValidation, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, userTable=userTable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, syslogStateTrap=syslogStateTrap, wirelessLinkStatus=wirelessLinkStatus, rFURxFreqMin=rFURxFreqMin, primaryRecovery=primaryRecovery, sNTPServerTimeout=sNTPServerTimeout, hTTPSAccessEnabled=hTTPSAccessEnabled, rFUStatus=rFUStatus, alignmentMode=alignmentMode, linkNameMismatchTrap=linkNameMismatchTrap, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, sNMPTrapTableNumber=sNMPTrapTableNumber, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, transmitCapacity=transmitCapacity, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPPortNumber=sNMPPortNumber, sNTPServerTableEntry=sNTPServerTableEntry, iPv4Address=iPv4Address, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFUTransceiverLocation=rFUTransceiverLocation)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUVersionBank1=rFUVersionBank1, faultProtectionSwitching=faultProtectionSwitching, rxDiversityVlanTpid=rxDiversityVlanTpid, dataPortStatus=dataPortStatus, ptmp=ptmp, minCodeRate=minCodeRate, rFUStatusTrap=rFUStatusTrap, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, cambium=cambium, aTPCEnable=aTPCEnable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, pubStats=pubStats, neighborInternetAddressType=neighborInternetAddressType, mPLSTCPriorityTable=mPLSTCPriorityTable, radioLicenseCodeRate=radioLicenseCodeRate, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, ptpTraps=ptpTraps, productVariant=productVariant, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, vectorError=vectorError, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, iPv6GatewayAddress=iPv6GatewayAddress, rFUTxPowerAlarm=rFUTxPowerAlarm, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, remotePrimaryIPAddress=remotePrimaryIPAddress, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, protectionStats=protectionStats, primaryRecoveryPeriod=primaryRecoveryPeriod, receiveModulation=receiveModulation, diverseRfFeederLoss=diverseRfFeederLoss, activeWirelessLinkAvailability=activeWirelessLinkAvailability, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, radioLicense=radioLicense, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFUPlatformCompatibility=rFUPlatformCompatibility, hTTPSPortNumber=hTTPSPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ptp800=ptp800, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerResponse=sNTPServerResponse, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPPollInterval=sNTPPollInterval, tFTPServerIPAddress=tFTPServerIPAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, bridge=bridge, managementMode=managementMode, encryptionEnabledMismatch=encryptionEnabledMismatch, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dSCPManagementPriority=dSCPManagementPriority, rFURxFreqMax=rFURxFreqMax, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementPortConfigurationMismatch=managementPortConfigurationMismatch, userTableNumber=userTableNumber, iPVersion=iPVersion, encryptionAlgorithm=encryptionAlgorithm, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, timeZone=timeZone, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dataPortPauseFrames=dataPortPauseFrames, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortStatusTrap=dataPortStatusTrap, primarySecondaryMode=primarySecondaryMode, userTableIndex=userTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, radioLicenseRxFreq=radioLicenseRxFreq, transmitPower=transmitPower, sMTPServerInternetAddress=sMTPServerInternetAddress, linkLoss=linkLoss, sNMPTrapTable=sNMPTrapTable, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, vLANManagementVID=vLANManagementVID, snmpControl=snmpControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, reset=reset, radioLicenseMaxModulation=radioLicenseMaxModulation, rFUBranchingConfiguration=rFUBranchingConfiguration, gatewayIPAddress=gatewayIPAddress, ethernet=ethernet, subnetMask=subnetMask, enableTransmission=enableTransmission, endId=endId, systemReset=systemReset, sNTPServerPortNumber=sNTPServerPortNumber)
