...
ModuleIdentity, iso, NotificationType, NotificationType, Gauge32, enterprises, TimeTicks, Bits, MibIdentifier, IpAddress, ObjectIdentity, Counter32, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "NotificationType", "NotificationType", "Gauge32", "enterprises", "TimeTicks", "Bits", "MibIdentifier", "IpAddress", "ObjectIdentity", "Counter32", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", syslogStateTrap=syslogStateTrap, linkLoss=linkLoss, rFUTxPowerMax=rFUTxPowerMax, remoteSecondaryIPAddress=remoteSecondaryIPAddress, siteName=siteName, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, sntp=sntp, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, telnetPortNumber=telnetPortNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, aggregateDataRate=aggregateDataRate, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, supplementary=supplementary, radioLicenseRegion=radioLicenseRegion, rFURFSwitchAlarm=rFURFSwitchAlarm, antennaGain=antennaGain, hTTPAccessEnabled=hTTPAccessEnabled, sNMPPortNumber=sNMPPortNumber, radioLicenseMinModulation=radioLicenseMinModulation, sMTPServerInternetAddress=sMTPServerInternetAddress, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, transmitPower=transmitPower, productName=productName, encryptionEnabledMismatch=encryptionEnabledMismatch, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapTableNumber=sNMPTrapTableNumber, rFUTxFreqMin=rFUTxFreqMin, syslogControl=syslogControl, rFUStatusTrap=rFUStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, rFUFreqSpacing=rFUFreqSpacing, telnetAccessEnabled=telnetAccessEnabled, rFUStatus=rFUStatus, protectionInterfaceStatus=protectionInterfaceStatus, ptp=ptp, hTTPPortNumber=hTTPPortNumber, requestedProtectionState=requestedProtectionState, rFUTxPowerMin=rFUTxPowerMin, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, alignmentMode=alignmentMode, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, securityLevel=securityLevel, versions=versions, iPv6Address=iPv6Address, ethernet=ethernet, sNTPServerPortNumber=sNTPServerPortNumber, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, aTPCEnable=aTPCEnable, cambium=cambium, ptpTraps=ptpTraps, l2CPPriorityTableNumber=l2CPPriorityTableNumber, diverseRfFeederLoss=diverseRfFeederLoss, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, smtp=smtp, sNTPLastSync=sNTPLastSync, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, subnetMask=subnetMask, managementMode=managementMode, primarySecondaryMode=primarySecondaryMode, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, remoteInternetAddressType=remoteInternetAddressType, maxCodeRate=maxCodeRate, remoteIPAddress=remoteIPAddress, numberOfAntennas=numberOfAntennas, activeUnit=activeUnit, sMTPEmailAlert=sMTPEmailAlert, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rFURfBand=rFURfBand, userPassword=userPassword, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rFUBranchingConfiguration=rFUBranchingConfiguration, sNTPServerResponse=sNTPServerResponse, radioLicenseBandwidth=radioLicenseBandwidth, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, minModulation=minModulation, sNTPServerTableEntry=sNTPServerTableEntry, encryptionAlgorithm=encryptionAlgorithm, receiveDataRate=receiveDataRate, radioLicenseMaxModulation=radioLicenseMaxModulation, linkName=linkName, tFTPServerIPAddress=tFTPServerIPAddress, ethernetPriorityTable=ethernetPriorityTable, softwareVersion=softwareVersion, radioLicenseCodeRate=radioLicenseCodeRate, sNMPTrapTable=sNMPTrapTable, transmitModulation=transmitModulation, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, remotePrimaryMACAddress=remotePrimaryMACAddress, sMTPServerPortNumber=sMTPServerPortNumber, wirelessLinkStatusTrap=wirelessLinkStatusTrap, hardwareVersion=hardwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapIPAddress=sNMPTrapIPAddress, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, sNMPCommunityString=sNMPCommunityString, diverseAntennaGain=diverseAntennaGain, primaryRecovery=primaryRecovery, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, transmitDataRate=transmitDataRate, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, protectionState=protectionState, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, phyStatus=phyStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, remotePrimarySecondaryMode=remotePrimarySecondaryMode, userName=userName, phyControl=phyControl, radioLicenseBand=radioLicenseBand, productVariant=productVariant, sNTPServerTableIndex=sNTPServerTableIndex, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, vLANManagementPriority=vLANManagementPriority, protectionStatus=protectionStatus, gatewayIPAddress=gatewayIPAddress, activeWirelessLinkAvailability=activeWirelessLinkAvailability, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, sNTPSync=sNTPSync, sNTPServerInternetAddress=sNTPServerInternetAddress, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rxDiversityDataPortStatus=rxDiversityDataPortStatus, rFUTxBandAboveRx=rFUTxBandAboveRx, remotePrimaryInternetAddress=remotePrimaryInternetAddress, systemReset=systemReset, radioLicenseIdentifier=radioLicenseIdentifier, endId=endId, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, remoteInternetAddress=remoteInternetAddress, secureModeAlarm=secureModeAlarm, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, iPVersion=iPVersion, sNMPTrapVersion=sNMPTrapVersion, aAAControl=aAAControl, secondarySoftwareVersion=secondarySoftwareVersion, longitude=longitude, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, rFURxFreqMin=rFURxFreqMin, protectionConfigurationStatus=protectionConfigurationStatus, protectionAvailabilityStatus=protectionAvailabilityStatus, syslogClientTrap=syslogClientTrap, transmitCapacityLimitDetail=transmitCapacityLimitDetail, dataPortPauseFrames=dataPortPauseFrames, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, minCodeRate=minCodeRate, fiberY=fiberY, vLANManagementVIDValidation=vLANManagementVIDValidation, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rFUPowerButtonPressed=rFUPowerButtonPressed, protectionStats=protectionStats, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, altitude=altitude, activeAvailableTime=activeAvailableTime, qOSPriorityScheme=qOSPriorityScheme, rFFeederLoss=rFFeederLoss, rFUProtectionCompatibility=rFUProtectionCompatibility, rFUCableAlarm=rFUCableAlarm, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, rFURpsAlarm=rFURpsAlarm, dSCPManagementPriority=dSCPManagementPriority, rFUType=rFUType, tFTPServerPortNumber=tFTPServerPortNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, licence=licence, iPv4Address=iPv4Address, sNTPServerTable=sNTPServerTable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, remoteSecondaryMACAddress=remoteSecondaryMACAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, enableTransmission=enableTransmission, rFURxFreqMax=rFURxFreqMax, managementCommittedInformationRate=managementCommittedInformationRate, latitude=latitude, wirelessLinkStatus=wirelessLinkStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, configuration=configuration, daylightSaving=daylightSaving, receivePower=receivePower, maxModulation=maxModulation, unitOutOfCalibration=unitOutOfCalibration, ptmp=ptmp, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sNTPSyncTrap=sNTPSyncTrap, dataPortStatus=dataPortStatus, userEnabled=userEnabled, sMTPEnabledMessages=sMTPEnabledMessages, sNTPState=sNTPState, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, transmitCapacityLimit=transmitCapacityLimit, userTableIndex=userTableIndex, rFUVersionBank1=rFUVersionBank1, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitCapacity=transmitCapacity, management=management, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rFULockoutAlarm=rFULockoutAlarm, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, radioLicense=radioLicense, remoteMACAddress=remoteMACAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, bridge=bridge, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapInternetAddress=sNMPTrapInternetAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, rFUPlatformCompatibility=rFUPlatformCompatibility, linkNameMismatchTrap=linkNameMismatchTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, l2CPPriorityTableEntry=l2CPPriorityTableEntry, neighborMACAddress=neighborMACAddress, bootVersion=bootVersion, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPPollInterval=sNTPPollInterval, dataPortStatusTrap=dataPortStatusTrap, managementPortStatus=managementPortStatus, syslogClient=syslogClient, syslogState=syslogState, sNTPServerRetries=sNTPServerRetries, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, localPacketFiltering=localPacketFiltering, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, receiveModulation=receiveModulation, protectionConfig=protectionConfig, rFUTxFreqMax=rFUTxFreqMax, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, userTableNumber=userTableNumber, hTTPSPortNumber=hTTPSPortNumber, vLANManagementVID=vLANManagementVID, rFUTxMuteStatus=rFUTxMuteStatus, protection=protection, userTableEntry=userTableEntry, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, rFUTxPowerAlarm=rFUTxPowerAlarm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, systemClock=systemClock, radioLicenseRxFreq=radioLicenseRxFreq)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sMTPServerIPAddress=sMTPServerIPAddress, encryption=encryption, reset=reset, neighborIPAddress=neighborIPAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, radioLicenseMinCodeRate=radioLicenseMinCodeRate, managementPortAutoNegotiation=managementPortAutoNegotiation, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPv6PrefixLength=iPv6PrefixLength, ethernetFiberSupport=ethernetFiberSupport, transmitCodeRate=transmitCodeRate, vectorError=vectorError, managementPortDisabledWarning=managementPortDisabledWarning, snmpControl=snmpControl, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetPriorityTableEntry=ethernetPriorityTableEntry, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, protectionStateTrap=protectionStateTrap, l2CPPriorityTable=l2CPPriorityTable, userTable=userTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteMaximumTransmitPower=remoteMaximumTransmitPower, iPv6GatewayAddress=iPv6GatewayAddress, remotePrimaryIPAddress=remotePrimaryIPAddress, alarms=alarms, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rFUVersionBank2=rFUVersionBank2, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFUPowerAlarm=rFUPowerAlarm, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, linkNameMismatch=linkNameMismatch, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rxDiversityVid=rxDiversityVid, alignmentModeTrap=alignmentModeTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveCodeRate=receiveCodeRate, maximumTransmitPower=maximumTransmitPower, tFTPServerInternetAddressType=tFTPServerInternetAddressType, managementPortForcedConfiguration=managementPortForcedConfiguration, radioLicenseModulation=radioLicenseModulation, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, neighborInternetAddress=neighborInternetAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, rFUConnectedPlatform=rFUConnectedPlatform, radioLicenseMaxEIRP=radioLicenseMaxEIRP, timeZone=timeZone, protectionSwitchCause=protectionSwitchCause, sNMPEnabledTraps=sNMPEnabledTraps, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, rFUSerial=rFUSerial, rxDiversityVlanTpid=rxDiversityVlanTpid, ptp800=ptp800, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerTimeout=sNTPServerTimeout, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, pubStats=pubStats, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, managementPortStatusTrap=managementPortStatusTrap, sNTPServerIPAddress=sNTPServerIPAddress, iFCableLength=iFCableLength, rFUTransceiverLocation=rFUTransceiverLocation, userRole=userRole, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dataPortWirelessDownAlert=dataPortWirelessDownAlert, primaryRecoveryPeriod=primaryRecoveryPeriod, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortFiberStatus=dataPortFiberStatus, radioLicenseTxFreq=radioLicenseTxFreq, ptpTrapPrefix=ptpTrapPrefix, sNTPServerTableNumber=sNTPServerTableNumber, faultProtectionSwitching=faultProtectionSwitching, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, neighborInternetAddressType=neighborInternetAddressType, rfu=rfu, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, dataPortDisabledWarning=dataPortDisabledWarning, transmitterStatus=transmitterStatus, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPPrimaryServer=sNTPPrimaryServer)
