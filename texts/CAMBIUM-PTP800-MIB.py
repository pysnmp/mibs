...
ObjectIdentity, MibIdentifier, enterprises, Integer32, Bits, Gauge32, NotificationType, Counter64, Unsigned32, IpAddress, Counter32, NotificationType, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "enterprises", "Integer32", "Bits", "Gauge32", "NotificationType", "Counter64", "Unsigned32", "IpAddress", "Counter32", "NotificationType", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", management=management, rFUStatusTrap=rFUStatusTrap, smtp=smtp, sNTPServerIPAddress=sNTPServerIPAddress, syslogClientTrap=syslogClientTrap, aAAControl=aAAControl, encryption=encryption, protectionConfig=protectionConfig, radioLicenseModulation=radioLicenseModulation, sNTPServerTable=sNTPServerTable, rFUPowerAlarm=rFUPowerAlarm, numberOfAntennas=numberOfAntennas, activeWirelessLinkAvailability=activeWirelessLinkAvailability, bridge=bridge, rFUTransceiverLocation=rFUTransceiverLocation, localPacketFiltering=localPacketFiltering, maxModulation=maxModulation, sMTPEmailAlert=sMTPEmailAlert, dataPortStatus=dataPortStatus, sNTPServerRetries=sNTPServerRetries, neighborMACAddress=neighborMACAddress, rFUVersionBank1=rFUVersionBank1, rFUTxPowerAlarm=rFUTxPowerAlarm, protectionAvailabilityStatus=protectionAvailabilityStatus, radioLicenseIdentifier=radioLicenseIdentifier, rFURxFreqMin=rFURxFreqMin, l2CPPriorityTableIndex=l2CPPriorityTableIndex, radioLicenseBandwidth=radioLicenseBandwidth, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPState=sNTPState, remoteInternetAddressType=remoteInternetAddressType, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rFUCableAlarm=rFUCableAlarm, transmitterStatus=transmitterStatus, gatewayIPAddress=gatewayIPAddress, hTTPAccessEnabled=hTTPAccessEnabled, rFUConnectedPlatform=rFUConnectedPlatform, maxCodeRate=maxCodeRate, receiveDataRate=receiveDataRate, phyControl=phyControl, sNTPPollInterval=sNTPPollInterval, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, remoteMACAddress=remoteMACAddress, remoteIPAddress=remoteIPAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, primaryRecovery=primaryRecovery, l2CPPriorityTable=l2CPPriorityTable, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, vLANManagementVID=vLANManagementVID, iPVersion=iPVersion, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, sNMPTrapVersion=sNMPTrapVersion, qOSPriorityScheme=qOSPriorityScheme, hTTPSPortNumber=hTTPSPortNumber, rFUActiveFirmwareBank=rFUActiveFirmwareBank, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, remotePrimaryInternetAddress=remotePrimaryInternetAddress, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, altitude=altitude, encryptionEnabledMismatch=encryptionEnabledMismatch, remoteSecondaryIPAddress=remoteSecondaryIPAddress, protectionStateTrap=protectionStateTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapTable=sNMPTrapTable, rFUTxBandAboveRx=rFUTxBandAboveRx, syslogControl=syslogControl, encryptionAlgorithm=encryptionAlgorithm, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkName=linkName, neighborIPAddress=neighborIPAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerResponse=sNTPServerResponse, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, protectionInterfaceStatus=protectionInterfaceStatus, rFURfBand=rFURfBand, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, diverseAntennaGain=diverseAntennaGain, sntp=sntp, longitude=longitude, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, reset=reset, rFUVersionBank2=rFUVersionBank2, radioLicense=radioLicense, productVariant=productVariant, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, sNTPServerPortNumber=sNTPServerPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, primarySecondaryMode=primarySecondaryMode, linkNameMismatchTrap=linkNameMismatchTrap, neighborInternetAddress=neighborInternetAddress, vLANManagementPriority=vLANManagementPriority, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, latitude=latitude, sNMPEnabledTraps=sNMPEnabledTraps, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dataPortStatusTrap=dataPortStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, enableTransmission=enableTransmission, ptmp=ptmp, rFUTxPowerMin=rFUTxPowerMin, sNTPSyncTrap=sNTPSyncTrap, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, remotePrimaryIPAddress=remotePrimaryIPAddress, syslogClient=syslogClient, hardwareVersion=hardwareVersion, rfu=rfu, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, transmitDataRate=transmitDataRate, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rFULockoutAlarm=rFULockoutAlarm, securityLevel=securityLevel, transmitCodeRate=transmitCodeRate, endId=endId, managementPortDisabledWarning=managementPortDisabledWarning, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, protectionStats=protectionStats, managementPortForcedConfiguration=managementPortForcedConfiguration, rxDiversityDataPortStatus=rxDiversityDataPortStatus, faultProtectionSwitching=faultProtectionSwitching, managementPortWirelessDownAlert=managementPortWirelessDownAlert, receivePower=receivePower, sNTPSync=sNTPSync, radioLicenseMaxModulation=radioLicenseMaxModulation, sNTPServerTableEntry=sNTPServerTableEntry, remoteSecondaryMACAddress=remoteSecondaryMACAddress, ptp800=ptp800, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, radioLicenseMinModulation=radioLicenseMinModulation, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, secondarySoftwareVersion=secondarySoftwareVersion, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, configuration=configuration, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ptp=ptp, rFURFSwitchAlarm=rFURFSwitchAlarm, vectorError=vectorError, syslogStateTrap=syslogStateTrap, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, linkLoss=linkLoss, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityTableEntry=l2CPPriorityTableEntry, unitOutOfCalibration=unitOutOfCalibration, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, alarms=alarms, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPServerInternetAddress=sNTPServerInternetAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rFUPlatformCompatibility=rFUPlatformCompatibility, pubStats=pubStats, radioLicenseMaxEIRP=radioLicenseMaxEIRP, userRole=userRole, subnetMask=subnetMask, receiveCodeRate=receiveCodeRate, userEnabled=userEnabled, tFTPServerIPAddress=tFTPServerIPAddress, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, primaryRecoveryPeriod=primaryRecoveryPeriod, receiveModulation=receiveModulation, dataPortFiberStatus=dataPortFiberStatus, transmitModulation=transmitModulation, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, activeUnit=activeUnit, versions=versions, dataPortFiberStatusTrap=dataPortFiberStatusTrap, protectionStatus=protectionStatus, licence=licence, radioLicenseRegion=radioLicenseRegion, iFCableLength=iFCableLength, neighborInternetAddressType=neighborInternetAddressType, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, userTableIndex=userTableIndex, cambium=cambium, userName=userName, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, telnetAccessEnabled=telnetAccessEnabled, diverseRfFeederLoss=diverseRfFeederLoss, rFUStatus=rFUStatus, rFUBranchingConfiguration=rFUBranchingConfiguration, rFUTxPowerMax=rFUTxPowerMax, ethernetPriorityTableIndex=ethernetPriorityTableIndex, managementMode=managementMode, bootVersion=bootVersion, rFUTxFreqMax=rFUTxFreqMax, userTable=userTable, rFUTxMuteStatus=rFUTxMuteStatus, transmitCapacityLimit=transmitCapacityLimit, rFUType=rFUType, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, managementPortStatusTrap=managementPortStatusTrap, antennaGain=antennaGain, userPassword=userPassword, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, radioLicenseMinCodeRate=radioLicenseMinCodeRate, telnetPortNumber=telnetPortNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, sMTPEnabledMessages=sMTPEnabledMessages, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, alignmentMode=alignmentMode, rFUTxFreqMin=rFUTxFreqMin, protection=protection, transmitCapacity=transmitCapacity, iPv4Address=iPv4Address, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, aTPCEnable=aTPCEnable, aggregateDataRate=aggregateDataRate, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, remotePrimarySecondaryMode=remotePrimarySecondaryMode, requestedProtectionState=requestedProtectionState, alignmentModeTrap=alignmentModeTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ethernetPriorityTable=ethernetPriorityTable, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, hTTPSAccessEnabled=hTTPSAccessEnabled, iPv6PrefixLength=iPv6PrefixLength, sNMPTrapPortNumber=sNMPTrapPortNumber, radioLicenseTxFreq=radioLicenseTxFreq, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, sNTPPrimaryServer=sNTPPrimaryServer, userTableEntry=userTableEntry, radioLicenseBand=radioLicenseBand, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, activeAvailableTime=activeAvailableTime, rFFeederLoss=rFFeederLoss, snmpControl=snmpControl, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", managementCommittedInformationRate=managementCommittedInformationRate, minCodeRate=minCodeRate, secureModeAlarmTrap=secureModeAlarmTrap, syslogState=syslogState, minModulation=minModulation, rFUSerial=rFUSerial, wirelessLinkAvailability=wirelessLinkAvailability, sNTPServerTableNumber=sNTPServerTableNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, vLANManagementVIDValidation=vLANManagementVIDValidation, ethernet=ethernet, phyStatus=phyStatus, productName=productName, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, userTableNumber=userTableNumber, systemReset=systemReset, ethernetFiberSupport=ethernetFiberSupport, timeZone=timeZone, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, sMTPServerPortNumber=sMTPServerPortNumber, fiberY=fiberY, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mPLSTCPriorityTable=mPLSTCPriorityTable, supplementary=supplementary, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortDisabledWarning=dataPortDisabledWarning, ptpTrapPrefix=ptpTrapPrefix, syslogLocalWrappedTrap=syslogLocalWrappedTrap, protectionConfigurationStatus=protectionConfigurationStatus, linkNameMismatch=linkNameMismatch, rFURpsAlarm=rFURpsAlarm, rxDiversityVid=rxDiversityVid, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, transmitPower=transmitPower, remotePrimaryMACAddress=remotePrimaryMACAddress, remoteInternetAddress=remoteInternetAddress, radioLicenseRxFreq=radioLicenseRxFreq, sNTPLastSync=sNTPLastSync, hTTPPortNumber=hTTPPortNumber, transmitCapacityLimitDetail=transmitCapacityLimitDetail, siteName=siteName, sMTPServerInternetAddressType=sMTPServerInternetAddressType, iPv6Address=iPv6Address, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, rFUFreqSpacing=rFUFreqSpacing, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPPortNumber=sNMPPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, wirelessLinkStatus=wirelessLinkStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rFURxFreqMax=rFURxFreqMax, daylightSaving=daylightSaving, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, secureModeAlarm=secureModeAlarm, softwareVersion=softwareVersion, maximumTransmitPower=maximumTransmitPower, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, systemClock=systemClock, tFTPServerInternetAddress=tFTPServerInternetAddress, rFUPowerButtonPressed=rFUPowerButtonPressed, dSCPManagementPriority=dSCPManagementPriority, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, sNTPServerTimeout=sNTPServerTimeout, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, dataPortPauseFrames=dataPortPauseFrames, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPCommunityString=sNMPCommunityString, sNTPServerTableIndex=sNTPServerTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementPortStatus=managementPortStatus, managementPortAutoNegotiation=managementPortAutoNegotiation, radioLicenseCodeRate=radioLicenseCodeRate, rxDiversityVlanTpid=rxDiversityVlanTpid, rFUProtectionCompatibility=rFUProtectionCompatibility, ptpTraps=ptpTraps, protectionSwitchCause=protectionSwitchCause, protectionState=protectionState, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, sNMPTrapTableNumber=sNMPTrapTableNumber, iPv6GatewayAddress=iPv6GatewayAddress)
