...
Gauge32, iso, ObjectIdentity, Integer32, Bits, NotificationType, Unsigned32, IpAddress, Counter32, enterprises, NotificationType, ModuleIdentity, TimeTicks, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "ObjectIdentity", "Integer32", "Bits", "NotificationType", "Unsigned32", "IpAddress", "Counter32", "enterprises", "NotificationType", "ModuleIdentity", "TimeTicks", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rxDiversityVlanTpid=rxDiversityVlanTpid, alignmentModeTrap=alignmentModeTrap, userTable=userTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, productName=productName, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, encryptionEnabledMismatch=encryptionEnabledMismatch, ethernetPriorityTable=ethernetPriorityTable, softwareVersion=softwareVersion, rFUConnectedPlatform=rFUConnectedPlatform, endId=endId, sNTPLastSync=sNTPLastSync, sNMPTrapTable=sNMPTrapTable, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, encryptionAlgorithm=encryptionAlgorithm, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, iPv6PrefixLength=iPv6PrefixLength, linkLoss=linkLoss, receiveDataRate=receiveDataRate, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, radioLicenseMaxModulation=radioLicenseMaxModulation, userTableEntry=userTableEntry, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, radioLicense=radioLicense, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, versions=versions, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, dataPortFiberStatusTrap=dataPortFiberStatusTrap, maxCodeRate=maxCodeRate, protectionStateTrap=protectionStateTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, ptmp=ptmp, remoteMACAddress=remoteMACAddress, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, sNMPPortNumber=sNMPPortNumber, protectionConfigurationStatus=protectionConfigurationStatus, dataPortDisabledWarning=dataPortDisabledWarning, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, protectionState=protectionState, bootVersion=bootVersion, productVariant=productVariant, aggregateDataRate=aggregateDataRate, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, wirelessLinkStatusTrap=wirelessLinkStatusTrap, radioLicenseBand=radioLicenseBand, altitude=altitude, rFFeederLoss=rFFeederLoss, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, primarySecondaryMode=primarySecondaryMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPState=sNTPState, rxDiversityVid=rxDiversityVid, transmitterStatus=transmitterStatus, iPVersion=iPVersion, userName=userName, managementPortAutoNegotiation=managementPortAutoNegotiation, rFUType=rFUType, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, bridge=bridge, receiveModulation=receiveModulation, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, dSCPManagementPriority=dSCPManagementPriority, useVLANForManagementInterfaces=useVLANForManagementInterfaces, faultProtectionSwitching=faultProtectionSwitching, dataPortStatusTrap=dataPortStatusTrap, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, sNTPSync=sNTPSync, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rFUTxPowerMin=rFUTxPowerMin, maximumTransmitPower=maximumTransmitPower, sNTPServerTable=sNTPServerTable, rFUTxBandAboveRx=rFUTxBandAboveRx, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, primaryRecovery=primaryRecovery, linkName=linkName, transmitCodeRate=transmitCodeRate, requestedProtectionState=requestedProtectionState, managementPortForcedConfiguration=managementPortForcedConfiguration, iPv6GatewayAddress=iPv6GatewayAddress, sntp=sntp, diverseAntennaGain=diverseAntennaGain, alignmentMode=alignmentMode, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, sNTPServerTableIndex=sNTPServerTableIndex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPServerIPAddress=tFTPServerIPAddress, rFUTxPowerAlarm=rFUTxPowerAlarm, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ptp=ptp, sNTPPollInterval=sNTPPollInterval, rxDiversityDataPortStatus=rxDiversityDataPortStatus, radioLicenseBandwidth=radioLicenseBandwidth, systemReset=systemReset, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, radioLicenseMinModulation=radioLicenseMinModulation, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rFUStatusTrap=rFUStatusTrap, remotePrimaryIPAddress=remotePrimaryIPAddress, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, receiveCodeRate=receiveCodeRate, vLANManagementPriority=vLANManagementPriority, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, supplementary=supplementary, rFURFSwitchAlarm=rFURFSwitchAlarm, enableTransmission=enableTransmission, secureModeAlarmTrap=secureModeAlarmTrap, systemClock=systemClock, dataPortPauseFrames=dataPortPauseFrames, pubStats=pubStats, rFUTxFreqMin=rFUTxFreqMin, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, numberOfAntennas=numberOfAntennas, rFUVersionBank1=rFUVersionBank1, protectionAvailabilityStatus=protectionAvailabilityStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, alarms=alarms, rFURpsAlarm=rFURpsAlarm, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remoteSecondaryIPAddress=remoteSecondaryIPAddress, configuration=configuration, encryption=encryption, rFUSerial=rFUSerial, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, remoteIPAddress=remoteIPAddress, syslogState=syslogState, sMTPEmailAlert=sMTPEmailAlert, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, remoteInternetAddress=remoteInternetAddress, daylightSaving=daylightSaving, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rFUPlatformCompatibility=rFUPlatformCompatibility, unitOutOfCalibration=unitOutOfCalibration, protectionSwitchCause=protectionSwitchCause, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, neighborMACAddress=neighborMACAddress, sNTPServerTableNumber=sNTPServerTableNumber, primaryRecoveryPeriod=primaryRecoveryPeriod, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, protectionConfig=protectionConfig, ptp800=ptp800, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, snmpControl=snmpControl, dataPortStatus=dataPortStatus, rFUBranchingConfiguration=rFUBranchingConfiguration, phyControl=phyControl, diverseRfFeederLoss=diverseRfFeederLoss, rFUPowerButtonPressed=rFUPowerButtonPressed, linkNameMismatch=linkNameMismatch, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rFUTransceiverLocation=rFUTransceiverLocation, hTTPAccessEnabled=hTTPAccessEnabled, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, sNTPSyncTrap=sNTPSyncTrap, userPassword=userPassword, iPv4Address=iPv4Address, radioLicenseRxFreq=radioLicenseRxFreq, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, iPv6Address=iPv6Address, ethernetFiberSupport=ethernetFiberSupport, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, hTTPSPortNumber=hTTPSPortNumber, userEnabled=userEnabled, neighborInternetAddress=neighborInternetAddress, radioLicenseRegion=radioLicenseRegion, sNMPTrapPortNumber=sNMPTrapPortNumber, telnetAccessEnabled=telnetAccessEnabled, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPTrapIPAddress=sNMPTrapIPAddress, telnetPortNumber=telnetPortNumber, rFURxFreqMin=rFURxFreqMin, wirelessLinkStatus=wirelessLinkStatus, radioLicenseCodeRate=radioLicenseCodeRate, sNTPServerRetries=sNTPServerRetries, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, latitude=latitude, protectionStats=protectionStats, neighborInternetAddressType=neighborInternetAddressType, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, subnetMask=subnetMask, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, managementMode=managementMode, licence=licence, transmitDataRate=transmitDataRate, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFUActiveFirmwareBank=rFUActiveFirmwareBank, sNTPServerInternetAddressType=sNTPServerInternetAddressType, transmitPower=transmitPower, minModulation=minModulation, aAAControl=aAAControl, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapVersion=sNMPTrapVersion, maxModulation=maxModulation, hardwareVersion=hardwareVersion, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, radioLicenseMinCodeRate=radioLicenseMinCodeRate, hTTPPortNumber=hTTPPortNumber, rFUCableAlarm=rFUCableAlarm, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerTimeout=sNTPServerTimeout, protection=protection, radioLicenseTxFreq=radioLicenseTxFreq, remotePrimarySecondaryMode=remotePrimarySecondaryMode, tFTPServerPortNumber=tFTPServerPortNumber, receivePower=receivePower, sNTPServerPortNumber=sNTPServerPortNumber, ptpTraps=ptpTraps, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, transmitCapacity=transmitCapacity, radioLicenseIdentifier=radioLicenseIdentifier, managementPortStatus=managementPortStatus, sMTPEnabledMessages=sMTPEnabledMessages, qOSPriorityScheme=qOSPriorityScheme, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, reset=reset, vectorError=vectorError, fiberY=fiberY, syslogStateTrap=syslogStateTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rFUTxFreqMax=rFUTxFreqMax, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rFUFreqSpacing=rFUFreqSpacing, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, radioLicenseModulation=radioLicenseModulation, sNMPTrapTableEntry=sNMPTrapTableEntry, protectionStatus=protectionStatus, ethernet=ethernet, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPServerTableEntry=sNTPServerTableEntry, transmitCapacityLimitDetail=transmitCapacityLimitDetail, remotePrimaryInternetAddress=remotePrimaryInternetAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPServerResponse=sNTPServerResponse)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", vLANManagementVID=vLANManagementVID, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rFUTxPowerMax=rFUTxPowerMax, secureModeAlarm=secureModeAlarm, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, dataPortFiberStatus=dataPortFiberStatus, userRole=userRole, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, sMTPServerPortNumber=sMTPServerPortNumber, syslogClient=syslogClient, longitude=longitude, securityLevel=securityLevel, rFUVersionBank2=rFUVersionBank2, neighborIPAddress=neighborIPAddress, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, vLANManagementVIDValidation=vLANManagementVIDValidation, rFURfBand=rFURfBand, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rFURxFreqMax=rFURxFreqMax, phyStatus=phyStatus, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, activeAvailableTime=activeAvailableTime, syslogControl=syslogControl, timeZone=timeZone, sNTPServerIPAddress=sNTPServerIPAddress, sNMPCommunityString=sNMPCommunityString, managementPortDisabledWarning=managementPortDisabledWarning, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, managementPortConfigurationMismatch=managementPortConfigurationMismatch, wirelessLinkAvailability=wirelessLinkAvailability, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rFUTxMuteStatus=rFUTxMuteStatus, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, management=management, ethernetPriorityTableNumber=ethernetPriorityTableNumber, localPacketFiltering=localPacketFiltering, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, tFTPServerInternetAddress=tFTPServerInternetAddress, transmitCapacityLimit=transmitCapacityLimit, secondarySoftwareVersion=secondarySoftwareVersion, remoteInternetAddressType=remoteInternetAddressType, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, managementPortStatusTrap=managementPortStatusTrap, rFULockoutAlarm=rFULockoutAlarm, rFUPowerAlarm=rFUPowerAlarm, managementCommittedInformationRate=managementCommittedInformationRate, userTableIndex=userTableIndex, sNMPTrapInternetAddress=sNMPTrapInternetAddress, linkNameMismatchTrap=linkNameMismatchTrap, rFUStatus=rFUStatus, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, activeWirelessLinkAvailability=activeWirelessLinkAvailability, sMTPServerInternetAddressType=sMTPServerInternetAddressType, activeUnit=activeUnit, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, mPLSTCPriorityTable=mPLSTCPriorityTable, siteName=siteName, aTPCEnable=aTPCEnable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, remoteSecondaryMACAddress=remoteSecondaryMACAddress, cambium=cambium, antennaGain=antennaGain, remotePrimaryMACAddress=remotePrimaryMACAddress, iFCableLength=iFCableLength, userTableNumber=userTableNumber, transmitModulation=transmitModulation, sMTPServerInternetAddress=sMTPServerInternetAddress, smtp=smtp, protectionInterfaceStatus=protectionInterfaceStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, l2CPPriorityTable=l2CPPriorityTable, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, gatewayIPAddress=gatewayIPAddress, ptpTrapPrefix=ptpTrapPrefix, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rfu=rfu, minCodeRate=minCodeRate, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rFUProtectionCompatibility=rFUProtectionCompatibility, syslogClientTrap=syslogClientTrap)
