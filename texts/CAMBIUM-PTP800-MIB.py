...
Integer32, ModuleIdentity, Counter32, IpAddress, enterprises, Gauge32, ObjectIdentity, MibIdentifier, Unsigned32, TimeTicks, Counter64, iso, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "Counter32", "IpAddress", "enterprises", "Gauge32", "ObjectIdentity", "MibIdentifier", "Unsigned32", "TimeTicks", "Counter64", "iso", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", localPacketFiltering=localPacketFiltering, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, sNTPPrimaryServer=sNTPPrimaryServer, rFUVersionBank1=rFUVersionBank1, iPv4Address=iPv4Address, rFUStatusTrap=rFUStatusTrap, siteName=siteName, protectionState=protectionState, l2CPPriorityTable=l2CPPriorityTable, sNMPTrapIPAddress=sNMPTrapIPAddress, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFURFSwitchAlarm=rFURFSwitchAlarm, telnetPortNumber=telnetPortNumber, rFUVersionBank2=rFUVersionBank2, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rxDiversityVid=rxDiversityVid, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNTPSyncTrap=sNTPSyncTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, radioLicenseRxFreq=radioLicenseRxFreq, ethernetPriorityTable=ethernetPriorityTable, rFURfBand=rFURfBand, managementPortStatus=managementPortStatus, aTPCEnable=aTPCEnable, rFUStatus=rFUStatus, rFURpsAlarm=rFURpsAlarm, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFUProtectionCompatibility=rFUProtectionCompatibility, radioLicenseCodeRate=radioLicenseCodeRate, protectionStateTrap=protectionStateTrap, ptpTraps=ptpTraps, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, softwareVersion=softwareVersion, radioLicenseMinModulation=radioLicenseMinModulation, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, iPDSCPPriorityTable=iPDSCPPriorityTable, managementMode=managementMode, sNTPState=sNTPState, vLANManagementPriority=vLANManagementPriority, radioLicenseMaxEIRP=radioLicenseMaxEIRP, alignmentModeTrap=alignmentModeTrap, dataPortPauseFrames=dataPortPauseFrames, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPServerTable=sNTPServerTable, sNTPSync=sNTPSync, rfu=rfu, hTTPSPortNumber=hTTPSPortNumber, productName=productName, unitOutOfCalibration=unitOutOfCalibration, neighborInternetAddress=neighborInternetAddress, tFTPServerPortNumber=tFTPServerPortNumber, versions=versions, productVariant=productVariant, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPServerResponse=sNTPServerResponse, syslogClient=syslogClient, sNMPTrapInternetAddress=sNMPTrapInternetAddress, linkNameMismatch=linkNameMismatch, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, rFUTransceiverLocation=rFUTransceiverLocation, latitude=latitude, pubStats=pubStats, neighborInternetAddressType=neighborInternetAddressType, iPv6Address=iPv6Address, protectionStats=protectionStats, protectionStatus=protectionStatus, userEnabled=userEnabled, radioLicense=radioLicense, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogState=syslogState, dataPortDisabledWarning=dataPortDisabledWarning, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, transmitCapacity=transmitCapacity, remotePrimarySecondaryMode=remotePrimarySecondaryMode, encryptionEnabledMismatch=encryptionEnabledMismatch, gatewayIPAddress=gatewayIPAddress, radioLicenseIdentifier=radioLicenseIdentifier, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, longitude=longitude, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetFiberSupport=ethernetFiberSupport, dataPortFiberStatus=dataPortFiberStatus, sMTPServerPortNumber=sMTPServerPortNumber, protectionConfigurationStatus=protectionConfigurationStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, rFUFreqSpacing=rFUFreqSpacing, radioLicenseRegion=radioLicenseRegion, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rFUActiveFirmwareBank=rFUActiveFirmwareBank, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rFULockoutAlarm=rFULockoutAlarm, encryption=encryption, transmitModulation=transmitModulation, sNTPServerPortNumber=sNTPServerPortNumber, faultProtectionSwitching=faultProtectionSwitching, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, endId=endId, userRole=userRole, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, radioLicenseBandwidth=radioLicenseBandwidth, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFUTxFreqMin=rFUTxFreqMin, diverseRfFeederLoss=diverseRfFeederLoss, rFUTxPowerAlarm=rFUTxPowerAlarm, managementPortStatusTrap=managementPortStatusTrap, userPassword=userPassword, altitude=altitude, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPServerTableEntry=sNTPServerTableEntry, rFFeederLoss=rFFeederLoss, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, remoteSecondaryMACAddress=remoteSecondaryMACAddress, userTableEntry=userTableEntry, protection=protection, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, secureModeAlarm=secureModeAlarm, linkName=linkName, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ptmp=ptmp, linkLoss=linkLoss, iPv6PrefixLength=iPv6PrefixLength, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, vectorError=vectorError, radioLicenseMinCodeRate=radioLicenseMinCodeRate, sNMPTrapVersion=sNMPTrapVersion, primaryRecovery=primaryRecovery, dataPortFiberStatusTrap=dataPortFiberStatusTrap, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, systemReset=systemReset, sMTPServerIPAddress=sMTPServerIPAddress, subnetMask=subnetMask, rxDiversityVlanTpid=rxDiversityVlanTpid, managementPortForcedConfiguration=managementPortForcedConfiguration, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, linkNameMismatchTrap=linkNameMismatchTrap, diverseAntennaGain=diverseAntennaGain, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPServerInternetAddressType=tFTPServerInternetAddressType, wirelessLinkStatusTrap=wirelessLinkStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receiveCodeRate=receiveCodeRate, secureModeAlarmTrap=secureModeAlarmTrap, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, receivePower=receivePower, wirelessLinkStatus=wirelessLinkStatus, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rFURxFreqMin=rFURxFreqMin, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, sNTPServerIPAddress=sNTPServerIPAddress, radioLicenseTxFreq=radioLicenseTxFreq, radioLicenseBand=radioLicenseBand, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rFUConnectedPlatform=rFUConnectedPlatform, rFUTxPowerMax=rFUTxPowerMax, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUPlatformCompatibility=rFUPlatformCompatibility, protectionConfig=protectionConfig, rFUSerial=rFUSerial, rFUTxFreqMax=rFUTxFreqMax, rFUTxBandAboveRx=rFUTxBandAboveRx, activeUnit=activeUnit, radioLicenseMaxModulation=radioLicenseMaxModulation, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, primarySecondaryMode=primarySecondaryMode, telnetAccessEnabled=telnetAccessEnabled, sMTPEnabledMessages=sMTPEnabledMessages, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, remoteSecondaryIPAddress=remoteSecondaryIPAddress, phyStatus=phyStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, sntp=sntp, alarms=alarms, rFURxFreqMax=rFURxFreqMax, remotePrimaryIPAddress=remotePrimaryIPAddress, ptpTrapPrefix=ptpTrapPrefix, remotePrimaryMACAddress=remotePrimaryMACAddress, sNMPEnabledTraps=sNMPEnabledTraps, syslogClientTrap=syslogClientTrap, daylightSaving=daylightSaving, dSCPManagementPriority=dSCPManagementPriority, iFCableLength=iFCableLength, configuration=configuration, protectionAvailabilityStatus=protectionAvailabilityStatus, alignmentMode=alignmentMode, enableTransmission=enableTransmission, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, rFUTxMuteStatus=rFUTxMuteStatus, userTableIndex=userTableIndex, timeZone=timeZone, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, bootVersion=bootVersion, cambium=cambium, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, remoteMaximumTransmitPower=remoteMaximumTransmitPower, radioLicenseModulation=radioLicenseModulation, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPPollInterval=sNTPPollInterval, qOSPriorityScheme=qOSPriorityScheme, supplementary=supplementary, protectionInterfaceStatus=protectionInterfaceStatus, syslogControl=syslogControl, vLANManagementVID=vLANManagementVID, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, userTableNumber=userTableNumber, minModulation=minModulation, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, management=management, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, managementPortDisabledWarning=managementPortDisabledWarning, sNMPPortNumber=sNMPPortNumber, remoteMACAddress=remoteMACAddress, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, sNTPServerRetries=sNTPServerRetries, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rFUPowerAlarm=rFUPowerAlarm, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, sNTPServerTableNumber=sNTPServerTableNumber, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, managementCommittedInformationRate=managementCommittedInformationRate, enabledDiagnosticAlarms=enabledDiagnosticAlarms, l2CPPriorityTableEntry=l2CPPriorityTableEntry, remoteInternetAddress=remoteInternetAddress, licence=licence, rFUPowerButtonPressed=rFUPowerButtonPressed, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, remoteIPAddress=remoteIPAddress, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, iPVersion=iPVersion, managementPortAutoNegotiation=managementPortAutoNegotiation, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, smtp=smtp, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, dataPortConfigurationMismatch=dataPortConfigurationMismatch)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", vLANManagementVIDValidation=vLANManagementVIDValidation, secondarySoftwareVersion=secondarySoftwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, fiberY=fiberY, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, sNTPServerTableIndex=sNTPServerTableIndex, rFUBranchingConfiguration=rFUBranchingConfiguration, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, requestedProtectionState=requestedProtectionState, sNTPServerInternetAddressType=sNTPServerInternetAddressType, transmitCodeRate=transmitCodeRate, minCodeRate=minCodeRate, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, dataPortStatusTrap=dataPortStatusTrap, rFUCableAlarm=rFUCableAlarm, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, systemClock=systemClock, transmitterStatus=transmitterStatus, rFUType=rFUType, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNMPTrapTable=sNMPTrapTable, tFTPServerIPAddress=tFTPServerIPAddress, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, snmpControl=snmpControl, ethernetPriorityTableNumber=ethernetPriorityTableNumber, userTable=userTable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rFUTxPowerMin=rFUTxPowerMin, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPServerTimeout=sNTPServerTimeout, maxModulation=maxModulation, sNMPCommunityString=sNMPCommunityString, ptp=ptp, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, hardwareVersion=hardwareVersion, ptp800=ptp800, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, receiveModulation=receiveModulation, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, antennaGain=antennaGain, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, remoteInternetAddressType=remoteInternetAddressType, mPLSTCPriorityTable=mPLSTCPriorityTable, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, receiveDataRate=receiveDataRate, transmitCapacityLimit=transmitCapacityLimit, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, iPv6GatewayAddress=iPv6GatewayAddress, reset=reset, sNTPLastSync=sNTPLastSync, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, primaryRecoveryPeriod=primaryRecoveryPeriod, userName=userName, sMTPServerInternetAddressType=sMTPServerInternetAddressType, neighborMACAddress=neighborMACAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, neighborIPAddress=neighborIPAddress, transmitCapacityLimitDetail=transmitCapacityLimitDetail, hTTPAccessEnabled=hTTPAccessEnabled, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, maxCodeRate=maxCodeRate, sMTPEmailAlert=sMTPEmailAlert, transmitDataRate=transmitDataRate, aggregateDataRate=aggregateDataRate, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, ethernet=ethernet, ethernetPriorityTableIndex=ethernetPriorityTableIndex, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, phyControl=phyControl, hTTPPortNumber=hTTPPortNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, numberOfAntennas=numberOfAntennas, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, aAAControl=aAAControl, remotePrimaryInternetAddress=remotePrimaryInternetAddress, securityLevel=securityLevel, bridge=bridge, dataPortStatus=dataPortStatus, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, activeAvailableTime=activeAvailableTime, syslogStateTrap=syslogStateTrap, rxDiversityDataPortStatus=rxDiversityDataPortStatus, transmitPower=transmitPower, protectionSwitchCause=protectionSwitchCause, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, maximumTransmitPower=maximumTransmitPower)
