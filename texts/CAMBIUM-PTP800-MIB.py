...
Integer32, ObjectIdentity, enterprises, TimeTicks, Bits, Counter32, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, Unsigned32, MibIdentifier, Counter64, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "enterprises", "TimeTicks", "Bits", "Counter32", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "Unsigned32", "MibIdentifier", "Counter64", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNTPServerTable=sNTPServerTable, remoteInternetAddress=remoteInternetAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFURxFreqMax=rFURxFreqMax, neighborInternetAddress=neighborInternetAddress, sNTPServerIPAddress=sNTPServerIPAddress, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, remotePrimaryInternetAddress=remotePrimaryInternetAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, remoteSecondaryIPAddress=remoteSecondaryIPAddress, ptp800=ptp800, aTPCEnable=aTPCEnable, neighborInternetAddressType=neighborInternetAddressType, licence=licence, sNTPServerResponse=sNTPServerResponse, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, primaryRecoveryPeriod=primaryRecoveryPeriod, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userPassword=userPassword, tFTPServerPortNumber=tFTPServerPortNumber, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, iPv6GatewayAddress=iPv6GatewayAddress, l2CPPriorityTable=l2CPPriorityTable, remotePrimaryMACAddress=remotePrimaryMACAddress, rFUPowerAlarm=rFUPowerAlarm, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, management=management, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, qOSPriorityScheme=qOSPriorityScheme, protectionState=protectionState, activeUnit=activeUnit, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, managementPortStatus=managementPortStatus, rFFeederLoss=rFFeederLoss, sNTPServerTableIndex=sNTPServerTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, l2CPPriorityTableNumber=l2CPPriorityTableNumber, neighborIPAddress=neighborIPAddress, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, vLANManagementVIDValidation=vLANManagementVIDValidation, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, protectionConfigurationStatus=protectionConfigurationStatus, rFUCableAlarm=rFUCableAlarm, dataPortStatus=dataPortStatus, rFUTxMuteStatus=rFUTxMuteStatus, userTableIndex=userTableIndex, protectionConfig=protectionConfig, rFUStatusTrap=rFUStatusTrap, fiberY=fiberY, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortStatusTrap=dataPortStatusTrap, cambium=cambium, syslogState=syslogState, sNMPPortNumber=sNMPPortNumber, remotePrimarySecondaryMode=remotePrimarySecondaryMode, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFURFSwitchAlarm=rFURFSwitchAlarm, sNMPCommunityString=sNMPCommunityString, remotePrimaryIPAddress=remotePrimaryIPAddress, aAAControl=aAAControl, sNTPPollInterval=sNTPPollInterval, rxDiversityDataPortStatus=rxDiversityDataPortStatus, radioLicenseBand=radioLicenseBand, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, linkNameMismatch=linkNameMismatch, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, radioLicenseTxFreq=radioLicenseTxFreq, transmitterStatus=transmitterStatus, encryptionEnabledMismatch=encryptionEnabledMismatch, softwareVersion=softwareVersion, rFUVersionBank1=rFUVersionBank1, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, protectionStateTrap=protectionStateTrap, enableTransmission=enableTransmission, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rFUTxFreqMin=rFUTxFreqMin, iPv6Address=iPv6Address, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPv4Address=iPv4Address, latitude=latitude, rFURfBand=rFURfBand, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, numberOfAntennas=numberOfAntennas, primaryRecovery=primaryRecovery, hTTPSPortNumber=hTTPSPortNumber, rFURpsAlarm=rFURpsAlarm, ethernetPriorityTable=ethernetPriorityTable, syslogClient=syslogClient, alignmentModeTrap=alignmentModeTrap, wirelessLinkStatus=wirelessLinkStatus, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, maxCodeRate=maxCodeRate, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, protectionInterfaceStatus=protectionInterfaceStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rFUTxPowerMax=rFUTxPowerMax, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, secureModeAlarmTrap=secureModeAlarmTrap, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, userEnabled=userEnabled, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetPriorityTableEntry=ethernetPriorityTableEntry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapIPAddress=sNMPTrapIPAddress, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, userTable=userTable, encryption=encryption, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, altitude=altitude, syslogControl=syslogControl, ethernetFiberSupport=ethernetFiberSupport, minModulation=minModulation, radioLicenseMaxEIRP=radioLicenseMaxEIRP, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, radioLicenseMaxModulation=radioLicenseMaxModulation, radioLicenseRegion=radioLicenseRegion, remoteInternetAddressType=remoteInternetAddressType, gatewayIPAddress=gatewayIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, activeAvailableTime=activeAvailableTime, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, unitOutOfCalibration=unitOutOfCalibration, rFUTxPowerMin=rFUTxPowerMin, rFUVersionBank2=rFUVersionBank2, hTTPAccessEnabled=hTTPAccessEnabled, rFUSerial=rFUSerial, sNMPTrapVersion=sNMPTrapVersion, systemReset=systemReset, rFUTxBandAboveRx=rFUTxBandAboveRx, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPState=sNTPState, remoteMACAddress=remoteMACAddress, managementPortDisabledWarning=managementPortDisabledWarning, timeZone=timeZone, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPEnabledTraps=sNMPEnabledTraps, vLANManagementPriority=vLANManagementPriority, syslogStateTrap=syslogStateTrap, bootVersion=bootVersion, rFUFreqSpacing=rFUFreqSpacing, rFURxFreqMin=rFURxFreqMin, productVariant=productVariant, primarySecondaryMode=primarySecondaryMode, protectionAvailabilityStatus=protectionAvailabilityStatus, daylightSaving=daylightSaving, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, dataPortFiberStatus=dataPortFiberStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUTransceiverLocation=rFUTransceiverLocation, telnetPortNumber=telnetPortNumber, rFUStatus=rFUStatus, phyControl=phyControl, userName=userName, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, smtp=smtp, syslogClientTrap=syslogClientTrap, userRole=userRole, radioLicenseMinCodeRate=radioLicenseMinCodeRate, maximumTransmitPower=maximumTransmitPower, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, managementPortAutoNegotiation=managementPortAutoNegotiation, maxModulation=maxModulation, sNTPSyncTrap=sNTPSyncTrap, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, ptmp=ptmp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFUPowerButtonPressed=rFUPowerButtonPressed, neighborMACAddress=neighborMACAddress, protection=protection, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, dataPortPauseFrames=dataPortPauseFrames, phyStatus=phyStatus, radioLicenseBandwidth=radioLicenseBandwidth, protectionStatus=protectionStatus, rFUType=rFUType, sNTPServerPortNumber=sNTPServerPortNumber, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, minCodeRate=minCodeRate, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sntp=sntp, sNTPSync=sNTPSync, antennaGain=antennaGain, sNMPTrapInternetAddress=sNMPTrapInternetAddress, secureModeAlarm=secureModeAlarm, sMTPServerPortNumber=sMTPServerPortNumber, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, wirelessLinkAvailability=wirelessLinkAvailability, sNTPServerTableEntry=sNTPServerTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkLoss=linkLoss, encryptionAlgorithm=encryptionAlgorithm, managementPortStatusTrap=managementPortStatusTrap, snmpControl=snmpControl, l2CPPriorityTableEntry=l2CPPriorityTableEntry, managementCommittedInformationRate=managementCommittedInformationRate, systemClock=systemClock, versions=versions, linkName=linkName, pubStats=pubStats, receivePower=receivePower, protectionStats=protectionStats, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, aggregateDataRate=aggregateDataRate, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, protectionSwitchCause=protectionSwitchCause, receiveDataRate=receiveDataRate, requestedProtectionState=requestedProtectionState, diverseRfFeederLoss=diverseRfFeederLoss, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, radioLicenseModulation=radioLicenseModulation, reset=reset, managementPortConfigurationMismatch=managementPortConfigurationMismatch, iPv6PrefixLength=iPv6PrefixLength, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, radioLicenseCodeRate=radioLicenseCodeRate, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, transmitPower=transmitPower, ptp=ptp, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sNTPLastSync=sNTPLastSync, userTableNumber=userTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, alignmentMode=alignmentMode, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rFUBranchingConfiguration=rFUBranchingConfiguration, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, ptpTraps=ptpTraps, iFCableLength=iFCableLength, faultProtectionSwitching=faultProtectionSwitching, rFULockoutAlarm=rFULockoutAlarm, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, longitude=longitude, bridge=bridge, rxDiversityVid=rxDiversityVid, receiveModulation=receiveModulation, productName=productName, supplementary=supplementary, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, securityLevel=securityLevel, sMTPEmailAlert=sMTPEmailAlert, sNTPServerTableNumber=sNTPServerTableNumber, ethernet=ethernet, tFTPServerIPAddress=tFTPServerIPAddress, radioLicenseMinModulation=radioLicenseMinModulation, userTableEntry=userTableEntry, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitCapacity=transmitCapacity, ethernetPriorityTableIndex=ethernetPriorityTableIndex, radioLicense=radioLicense, transmitCodeRate=transmitCodeRate, l2CPPriorityTableIndex=l2CPPriorityTableIndex, managementPortForcedConfiguration=managementPortForcedConfiguration, transmitCapacityLimit=transmitCapacityLimit, receiveCodeRate=receiveCodeRate, rfu=rfu, diverseAntennaGain=diverseAntennaGain, iPVersion=iPVersion, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, configuration=configuration, vLANManagementVID=vLANManagementVID, transmitCapacityLimitDetail=transmitCapacityLimitDetail, radioLicenseIdentifier=radioLicenseIdentifier, linkNameMismatchTrap=linkNameMismatchTrap, endId=endId, vectorError=vectorError, sNTPPrimaryServer=sNTPPrimaryServer, subnetMask=subnetMask, sMTPServerInternetAddress=sMTPServerInternetAddress, dataPortDisabledWarning=dataPortDisabledWarning, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rFUPlatformCompatibility=rFUPlatformCompatibility, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rxDiversityVlanTpid=rxDiversityVlanTpid, radioLicenseRxFreq=radioLicenseRxFreq, remoteIPAddress=remoteIPAddress, rFUTxFreqMax=rFUTxFreqMax, siteName=siteName, remoteSecondaryMACAddress=remoteSecondaryMACAddress, wirelessLinkStatusTrap=wirelessLinkStatusTrap, ptpTrapPrefix=ptpTrapPrefix, sNTPServerRetries=sNTPServerRetries, rFUConnectedPlatform=rFUConnectedPlatform, sNTPServerTimeout=sNTPServerTimeout, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, localPacketFiltering=localPacketFiltering, rFUProtectionCompatibility=rFUProtectionCompatibility, managementMode=managementMode, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, transmitModulation=transmitModulation, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, mPLSTCPriorityTable=mPLSTCPriorityTable, transmitDataRate=transmitDataRate, hardwareVersion=hardwareVersion, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, rFUTxPowerAlarm=rFUTxPowerAlarm, sNMPTrapTable=sNMPTrapTable, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, alarms=alarms, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, hTTPPortNumber=hTTPPortNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime)
