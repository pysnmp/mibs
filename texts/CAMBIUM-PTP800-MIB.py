...
Bits, NotificationType, Integer32, Unsigned32, MibIdentifier, NotificationType, TimeTicks, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, iso, Counter32, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "Integer32", "Unsigned32", "MibIdentifier", "NotificationType", "TimeTicks", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "iso", "Counter32", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFULockoutAlarm=rFULockoutAlarm, protectionStatus=protectionStatus, productVariant=productVariant, rFFeederLoss=rFFeederLoss, linkName=linkName, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, radioLicenseRegion=radioLicenseRegion, remotePrimaryInternetAddress=remotePrimaryInternetAddress, ethernetPriorityTable=ethernetPriorityTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, minCodeRate=minCodeRate, qOSPriorityScheme=qOSPriorityScheme, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, hTTPPortNumber=hTTPPortNumber, managementMode=managementMode, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerTableEntry=sNTPServerTableEntry, protectionState=protectionState, faultProtectionSwitching=faultProtectionSwitching, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, remoteInternetAddress=remoteInternetAddress, vLANManagementPriority=vLANManagementPriority, sMTPEmailAlert=sMTPEmailAlert, iPv4Address=iPv4Address, remoteSecondaryMACAddress=remoteSecondaryMACAddress, supplementary=supplementary, versions=versions, sMTPServerInternetAddressType=sMTPServerInternetAddressType, rFUBranchingConfiguration=rFUBranchingConfiguration, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, activeUnit=activeUnit, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, pubStats=pubStats, primarySecondaryMode=primarySecondaryMode, rFUType=rFUType, l2CPPriorityTable=l2CPPriorityTable, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, tFTPServerInternetAddressType=tFTPServerInternetAddressType, managementPortDisabledWarning=managementPortDisabledWarning, radioLicenseMinModulation=radioLicenseMinModulation, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, radioLicenseRxFreq=radioLicenseRxFreq, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, bridge=bridge, fiberY=fiberY, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, rFUStatus=rFUStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, sNMPTrapTable=sNMPTrapTable, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, radioLicenseMinCodeRate=radioLicenseMinCodeRate, tFTPServerIPAddress=tFTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, sNTPServerPortNumber=sNTPServerPortNumber, encryptionEnabledMismatch=encryptionEnabledMismatch, altitude=altitude, sNMPTrapTableEntry=sNMPTrapTableEntry, reset=reset, rFUTransceiverLocation=rFUTransceiverLocation, useVLANForManagementInterfaces=useVLANForManagementInterfaces, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, receiveDataRate=receiveDataRate, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, rFURxFreqMin=rFURxFreqMin, wirelessLinkAvailability=wirelessLinkAvailability, protectionConfig=protectionConfig, maxModulation=maxModulation, iFCableLength=iFCableLength, transmitModulation=transmitModulation, linkNameMismatchTrap=linkNameMismatchTrap, sNTPServerIPAddress=sNTPServerIPAddress, iPv6PrefixLength=iPv6PrefixLength, rFUTxBandAboveRx=rFUTxBandAboveRx, userTableIndex=userTableIndex, remoteMACAddress=remoteMACAddress, neighborIPAddress=neighborIPAddress, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, unitOutOfCalibration=unitOutOfCalibration, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sMTPServerIPAddress=sMTPServerIPAddress, dataPortPauseFrames=dataPortPauseFrames, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, gatewayIPAddress=gatewayIPAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, transmitPower=transmitPower, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, aTPCEnable=aTPCEnable, sNTPPrimaryServer=sNTPPrimaryServer, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, mPLSTCPriorityTable=mPLSTCPriorityTable, neighborInternetAddressType=neighborInternetAddressType, receiveCodeRate=receiveCodeRate, dSCPManagementPriority=dSCPManagementPriority, remotePrimaryMACAddress=remotePrimaryMACAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ptmp=ptmp, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rFURFSwitchAlarm=rFURFSwitchAlarm, radioLicenseTxFreq=radioLicenseTxFreq, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, alignmentModeTrap=alignmentModeTrap, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, radioLicenseIdentifier=radioLicenseIdentifier, ethernetFiberSupport=ethernetFiberSupport, radioLicenseModulation=radioLicenseModulation, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, remotePrimaryIPAddress=remotePrimaryIPAddress, rFUTxPowerMax=rFUTxPowerMax, radioLicenseCodeRate=radioLicenseCodeRate, radioLicenseBandwidth=radioLicenseBandwidth, sNMPCommunityString=sNMPCommunityString, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, ptpTraps=ptpTraps, rfu=rfu, neighborMACAddress=neighborMACAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, sNMPTrapPortNumber=sNMPTrapPortNumber, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, sNMPPortNumber=sNMPPortNumber, sNTPServerTableNumber=sNTPServerTableNumber, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, sNMPTrapTableNumber=sNMPTrapTableNumber, securityLevel=securityLevel, dataPortStatusTrap=dataPortStatusTrap, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, licence=licence, requestedProtectionState=requestedProtectionState, wirelessLinkStatusTrap=wirelessLinkStatusTrap, userTable=userTable, transmitDataRate=transmitDataRate, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, minModulation=minModulation, sNTPServerTimeout=sNTPServerTimeout, antennaGain=antennaGain, rFURxFreqMax=rFURxFreqMax, vLANManagementVID=vLANManagementVID, protectionSwitchCause=protectionSwitchCause, managementPortForcedConfiguration=managementPortForcedConfiguration, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rxDiversityVlanTpid=rxDiversityVlanTpid, linkLoss=linkLoss, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, managementPortStatus=managementPortStatus, configuration=configuration, sNMPTrapInternetAddress=sNMPTrapInternetAddress, iPv6GatewayAddress=iPv6GatewayAddress, transmitterStatus=transmitterStatus, sNMPTrapVersion=sNMPTrapVersion, subnetMask=subnetMask, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rxDiversityVid=rxDiversityVid, dataPortDisabledWarning=dataPortDisabledWarning, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, timeZone=timeZone, remotePrimarySecondaryMode=remotePrimarySecondaryMode, sNTPServerTableIndex=sNTPServerTableIndex, userTableEntry=userTableEntry, management=management, managementPortStatusTrap=managementPortStatusTrap, protectionInterfaceStatus=protectionInterfaceStatus, userPassword=userPassword, transmitCapacity=transmitCapacity, ptpTrapPrefix=ptpTrapPrefix, receiveModulation=receiveModulation, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, ethernetPriorityTableNumber=ethernetPriorityTableNumber, secureModeAlarm=secureModeAlarm, sNTPSyncTrap=sNTPSyncTrap, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, sMTPEnabledMessages=sMTPEnabledMessages, rFURpsAlarm=rFURpsAlarm, syslogClientTrap=syslogClientTrap, syslogStateTrap=syslogStateTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rFUStatusTrap=rFUStatusTrap, ptp=ptp, sNTPSync=sNTPSync, endId=endId, latitude=latitude, sNTPServerResponse=sNTPServerResponse, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ethernetPriorityTableIndex=ethernetPriorityTableIndex, systemReset=systemReset, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapIPAddress=sNMPTrapIPAddress, rFUProtectionCompatibility=rFUProtectionCompatibility, rFUPowerAlarm=rFUPowerAlarm, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, localPacketFiltering=localPacketFiltering, secureModeAlarmTrap=secureModeAlarmTrap, managementCommittedInformationRate=managementCommittedInformationRate, transmitCodeRate=transmitCodeRate, rFURfBand=rFURfBand, encryptionAlgorithm=encryptionAlgorithm, receivePower=receivePower, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortFiberStatus=dataPortFiberStatus, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, sNTPServerRetries=sNTPServerRetries, rFUFreqSpacing=rFUFreqSpacing, protectionConfigurationStatus=protectionConfigurationStatus, numberOfAntennas=numberOfAntennas, rFUVersionBank1=rFUVersionBank1, phyControl=phyControl, neighborInternetAddress=neighborInternetAddress, transmitCapacityLimit=transmitCapacityLimit, linkNameMismatch=linkNameMismatch, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, activeAvailableTime=activeAvailableTime, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, vectorError=vectorError, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, sNTPPollInterval=sNTPPollInterval, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, protectionAvailabilityStatus=protectionAvailabilityStatus, wirelessLinkStatus=wirelessLinkStatus, telnetPortNumber=telnetPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, secondarySoftwareVersion=secondarySoftwareVersion, dataPortStatus=dataPortStatus, sNTPServerTable=sNTPServerTable, remoteSecondaryIPAddress=remoteSecondaryIPAddress, userTableNumber=userTableNumber, iPVersion=iPVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, radioLicenseMaxModulation=radioLicenseMaxModulation, transmitCapacityLimitDetail=transmitCapacityLimitDetail, enableTransmission=enableTransmission, softwareVersion=softwareVersion, diverseAntennaGain=diverseAntennaGain, rFUTxFreqMax=rFUTxFreqMax, rFUTxFreqMin=rFUTxFreqMin, ethernet=ethernet, ptp800=ptp800, rFUVersionBank2=rFUVersionBank2)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, alignmentMode=alignmentMode, telnetAccessEnabled=telnetAccessEnabled, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, tFTPServerPortNumber=tFTPServerPortNumber, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, userRole=userRole, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, rxDiversityDataPortStatus=rxDiversityDataPortStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, bootVersion=bootVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, protection=protection, radioLicenseBand=radioLicenseBand, tFTPServerInternetAddress=tFTPServerInternetAddress, maxCodeRate=maxCodeRate, rFUTxPowerMin=rFUTxPowerMin, userName=userName, productName=productName, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, remoteInternetAddressType=remoteInternetAddressType, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, longitude=longitude, sNMPEnabledTraps=sNMPEnabledTraps, aAAControl=aAAControl, alarms=alarms, protectionStateTrap=protectionStateTrap, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, rFUPowerButtonPressed=rFUPowerButtonPressed, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, radioLicense=radioLicense, sNTPLastSync=sNTPLastSync, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, hTTPSPortNumber=hTTPSPortNumber, cambium=cambium, dataPortConfigurationMismatch=dataPortConfigurationMismatch, remoteMaximumTransmitPower=remoteMaximumTransmitPower, aggregateDataRate=aggregateDataRate, rFUConnectedPlatform=rFUConnectedPlatform, syslogState=syslogState, rFUPlatformCompatibility=rFUPlatformCompatibility, snmpControl=snmpControl, diverseRfFeederLoss=diverseRfFeederLoss, siteName=siteName, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, primaryRecoveryPeriod=primaryRecoveryPeriod, sntp=sntp, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, sNTPState=sNTPState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogControl=syslogControl, rFUSerial=rFUSerial, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, activeWirelessLinkAvailability=activeWirelessLinkAvailability, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, encryption=encryption, managementPortAutoNegotiation=managementPortAutoNegotiation, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, smtp=smtp, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, userEnabled=userEnabled, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, systemClock=systemClock, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, rFUCableAlarm=rFUCableAlarm, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, daylightSaving=daylightSaving, vLANManagementVIDValidation=vLANManagementVIDValidation, protectionStats=protectionStats, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, dataPortFiberStatusTrap=dataPortFiberStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, syslogClient=syslogClient, phyStatus=phyStatus, remoteIPAddress=remoteIPAddress, iPv6Address=iPv6Address, primaryRecovery=primaryRecovery, rFUTxMuteStatus=rFUTxMuteStatus, hardwareVersion=hardwareVersion, rFUTxPowerAlarm=rFUTxPowerAlarm)
