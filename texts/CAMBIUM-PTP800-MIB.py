...
TimeTicks, IpAddress, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, Counter32, NotificationType, Gauge32, Unsigned32, iso, MibIdentifier, Counter64, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "Counter32", "NotificationType", "Gauge32", "Unsigned32", "iso", "MibIdentifier", "Counter64", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNTPPollInterval=sNTPPollInterval, rxDiversityVid=rxDiversityVid, ptmp=ptmp, iPv6GatewayAddress=iPv6GatewayAddress, protectionConfigurationStatus=protectionConfigurationStatus, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPServerTimeout=sNTPServerTimeout, rFUConnectedPlatform=rFUConnectedPlatform, rFURxFreqMax=rFURxFreqMax, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rFFeederLoss=rFFeederLoss, l2CPPriorityTable=l2CPPriorityTable, syslogStateTrap=syslogStateTrap, phyControl=phyControl, secureModeAlarmTrap=secureModeAlarmTrap, secureModeAlarm=secureModeAlarm, sNTPServerPortNumber=sNTPServerPortNumber, sNTPPrimaryServer=sNTPPrimaryServer, neighborMACAddress=neighborMACAddress, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, remoteSecondaryMACAddress=remoteSecondaryMACAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortPauseFrames=dataPortPauseFrames, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rFUSerial=rFUSerial, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, radioLicenseCodeRate=radioLicenseCodeRate, sNMPEnabledTraps=sNMPEnabledTraps, dataPortWirelessDownAlert=dataPortWirelessDownAlert, bootVersion=bootVersion, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, managementCommittedInformationRate=managementCommittedInformationRate, radioLicenseRegion=radioLicenseRegion, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, telnetPortNumber=telnetPortNumber, activeWirelessLinkAvailability=activeWirelessLinkAvailability, protectionInterfaceStatus=protectionInterfaceStatus, rFUTransceiverLocation=rFUTransceiverLocation, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, transmitCapacityLimit=transmitCapacityLimit, alarms=alarms, snmpControl=snmpControl, syslogControl=syslogControl, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpTraps=ptpTraps, sNMPTrapTable=sNMPTrapTable, remotePrimaryIPAddress=remotePrimaryIPAddress, minModulation=minModulation, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, transmitCapacity=transmitCapacity, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, dataPortDisabledWarning=dataPortDisabledWarning, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, syslogClientTrap=syslogClientTrap, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rFURfBand=rFURfBand, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, siteName=siteName, rFUTxMuteStatus=rFUTxMuteStatus, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rFUStatus=rFUStatus, sNTPState=sNTPState, maxCodeRate=maxCodeRate, localPacketFiltering=localPacketFiltering, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFURpsAlarm=rFURpsAlarm, maximumTransmitPower=maximumTransmitPower, protectionState=protectionState, cambium=cambium, radioLicenseMinModulation=radioLicenseMinModulation, rFUStatusTrap=rFUStatusTrap, ptp800=ptp800, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, licence=licence, userTableIndex=userTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, protectionStateTrap=protectionStateTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, aggregateDataRate=aggregateDataRate, sNTPSync=sNTPSync, receiveDataRate=receiveDataRate, endId=endId, diverseRfFeederLoss=diverseRfFeederLoss, protectionAvailabilityStatus=protectionAvailabilityStatus, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, protectionSwitchCause=protectionSwitchCause, linkNameMismatchTrap=linkNameMismatchTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, encryptionAlgorithm=encryptionAlgorithm, transmitCodeRate=transmitCodeRate, activeAvailableTime=activeAvailableTime, wirelessLinkStatus=wirelessLinkStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rFUProtectionCompatibility=rFUProtectionCompatibility, rFUTxFreqMax=rFUTxFreqMax, faultProtectionSwitching=faultProtectionSwitching, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, requestedProtectionState=requestedProtectionState, hTTPAccessEnabled=hTTPAccessEnabled, gatewayIPAddress=gatewayIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, protectionStatus=protectionStatus, iPVersion=iPVersion, transmitPower=transmitPower, softwareVersion=softwareVersion, transmitterStatus=transmitterStatus, sNTPServerTableIndex=sNTPServerTableIndex, vLANManagementVIDValidation=vLANManagementVIDValidation, rFUTxPowerAlarm=rFUTxPowerAlarm, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, remotePrimaryInternetAddress=remotePrimaryInternetAddress, primaryRecovery=primaryRecovery, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, rFUVersionBank1=rFUVersionBank1, iPDSCPPriorityTable=iPDSCPPriorityTable, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rFURxFreqMin=rFURxFreqMin, remoteSecondaryIPAddress=remoteSecondaryIPAddress, protectionStats=protectionStats, radioLicenseMaxEIRP=radioLicenseMaxEIRP, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, sNTPServerTableEntry=sNTPServerTableEntry, sNMPPortNumber=sNMPPortNumber, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, securityLevel=securityLevel, remoteInternetAddress=remoteInternetAddress, alignmentMode=alignmentMode, managementPortForcedConfiguration=managementPortForcedConfiguration, rFUType=rFUType, rFUTxBandAboveRx=rFUTxBandAboveRx, configuration=configuration, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, iFCableLength=iFCableLength, bridge=bridge, neighborInternetAddressType=neighborInternetAddressType, sNMPTrapTableEntry=sNMPTrapTableEntry, rFUPowerButtonPressed=rFUPowerButtonPressed, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sMTPEmailAlert=sMTPEmailAlert, rFUCableAlarm=rFUCableAlarm, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, radioLicenseBandwidth=radioLicenseBandwidth, ptpTrapPrefix=ptpTrapPrefix, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapTableNumber=sNMPTrapTableNumber, rFUVersionBank2=rFUVersionBank2, userTableNumber=userTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, l2CPPriorityTableNumber=l2CPPriorityTableNumber, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, radioLicenseBand=radioLicenseBand, vLANManagementPriority=vLANManagementPriority, managementPortStatus=managementPortStatus, rFUTxPowerMin=rFUTxPowerMin, sNTPLastSync=sNTPLastSync, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, dataPortStatus=dataPortStatus, rFURFSwitchAlarm=rFURFSwitchAlarm, radioLicenseRxFreq=radioLicenseRxFreq, rFUPlatformCompatibility=rFUPlatformCompatibility, radioLicenseMaxModulation=radioLicenseMaxModulation, supplementary=supplementary, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, hardwareVersion=hardwareVersion, remoteIPAddress=remoteIPAddress, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, remoteInternetAddressType=remoteInternetAddressType, remotePrimaryMACAddress=remotePrimaryMACAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, protectionConfig=protectionConfig, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, vectorError=vectorError, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, userTableEntry=userTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, ptp=ptp, dataPortFiberStatusTrap=dataPortFiberStatusTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hTTPSAccessEnabled=hTTPSAccessEnabled, managementPortStatusTrap=managementPortStatusTrap, timeZone=timeZone, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, receivePower=receivePower, maxModulation=maxModulation, reset=reset, sNTPServerTableNumber=sNTPServerTableNumber, antennaGain=antennaGain, syslogClient=syslogClient, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rxDiversityVlanTpid=rxDiversityVlanTpid, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, hTTPPortNumber=hTTPPortNumber, telnetAccessEnabled=telnetAccessEnabled, activeUnit=activeUnit, userRole=userRole, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tFTPServerInternetAddress=tFTPServerInternetAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, subnetMask=subnetMask, receiveCodeRate=receiveCodeRate, iPv6Address=iPv6Address, fiberY=fiberY, radioLicenseTxFreq=radioLicenseTxFreq, encryption=encryption, systemClock=systemClock, linkName=linkName, tFTPServerPortNumber=tFTPServerPortNumber, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, versions=versions, minCodeRate=minCodeRate, wirelessLinkAvailability=wirelessLinkAvailability, userEnabled=userEnabled, radioLicenseMinCodeRate=radioLicenseMinCodeRate, ethernetPriorityTableNumber=ethernetPriorityTableNumber, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, encryptionEnabledMismatch=encryptionEnabledMismatch, rFUTxFreqMin=rFUTxFreqMin, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, radioLicenseModulation=radioLicenseModulation, enableTransmission=enableTransmission, sNMPTrapInternetAddress=sNMPTrapInternetAddress, syslogState=syslogState, sNMPTrapVersion=sNMPTrapVersion, longitude=longitude, altitude=altitude, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPSyncTrap=sNTPSyncTrap, aAAControl=aAAControl, sMTPServerPortNumber=sMTPServerPortNumber, primarySecondaryMode=primarySecondaryMode, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, sMTPEnabledMessages=sMTPEnabledMessages)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", userTable=userTable, receiveModulation=receiveModulation, rFULockoutAlarm=rFULockoutAlarm, sntp=sntp, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, managementPortDisabledWarning=managementPortDisabledWarning, numberOfAntennas=numberOfAntennas, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, diverseAntennaGain=diverseAntennaGain, ethernetFiberSupport=ethernetFiberSupport, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, productName=productName, primaryRecoveryPeriod=primaryRecoveryPeriod, sNMPTrapTableIndex=sNMPTrapTableIndex, vLANManagementVID=vLANManagementVID, neighborInternetAddress=neighborInternetAddress, managementPortAutoNegotiation=managementPortAutoNegotiation, linkLoss=linkLoss, smtp=smtp, sNTPServerTable=sNTPServerTable, latitude=latitude, sNMPCommunityString=sNMPCommunityString, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, linkNameMismatch=linkNameMismatch, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, qOSPriorityScheme=qOSPriorityScheme, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dataPortConfigurationMismatch=dataPortConfigurationMismatch, secondarySoftwareVersion=secondarySoftwareVersion, radioLicenseIdentifier=radioLicenseIdentifier, ethernet=ethernet, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, iPv6PrefixLength=iPv6PrefixLength, transmitDataRate=transmitDataRate, rFUFreqSpacing=rFUFreqSpacing, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, daylightSaving=daylightSaving, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rFUActiveFirmwareBank=rFUActiveFirmwareBank, ethernetPriorityTable=ethernetPriorityTable, alignmentModeTrap=alignmentModeTrap, aTPCEnable=aTPCEnable, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, neighborIPAddress=neighborIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, protection=protection, pubStats=pubStats, dSCPManagementPriority=dSCPManagementPriority, tFTPServerIPAddress=tFTPServerIPAddress, rFUBranchingConfiguration=rFUBranchingConfiguration, managementMode=managementMode, hTTPSPortNumber=hTTPSPortNumber, transmitModulation=transmitModulation, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, remoteMACAddress=remoteMACAddress, unitOutOfCalibration=unitOutOfCalibration, phyStatus=phyStatus, rFUPowerAlarm=rFUPowerAlarm, transmitCapacityLimitDetail=transmitCapacityLimitDetail, userName=userName, sNTPServerResponse=sNTPServerResponse, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, systemReset=systemReset, sNTPServerRetries=sNTPServerRetries, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, iPv4Address=iPv4Address, remotePrimarySecondaryMode=remotePrimarySecondaryMode, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, management=management, radioLicense=radioLicense, productVariant=productVariant, userPassword=userPassword, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, dataPortFiberStatus=dataPortFiberStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rFUTxPowerMax=rFUTxPowerMax, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rfu=rfu)
