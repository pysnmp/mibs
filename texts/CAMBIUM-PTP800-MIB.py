...
NotificationType, Integer32, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, MibIdentifier, iso, Counter32, TimeTicks, Counter64, Unsigned32, IpAddress, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "MibIdentifier", "iso", "Counter32", "TimeTicks", "Counter64", "Unsigned32", "IpAddress", "Bits", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", hTTPAccessEnabled=hTTPAccessEnabled, vLANManagementVIDValidation=vLANManagementVIDValidation, protectionConfig=protectionConfig, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPCommunityString=sNMPCommunityString, sMTPServerIPAddress=sMTPServerIPAddress, rFUPowerButtonPressed=rFUPowerButtonPressed, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, linkName=linkName, dataPortStatus=dataPortStatus, rFUStatusTrap=rFUStatusTrap, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, managementPortStatusTrap=managementPortStatusTrap, phyStatus=phyStatus, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, minModulation=minModulation, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, dSCPManagementPriority=dSCPManagementPriority, rFURpsAlarm=rFURpsAlarm, userTableNumber=userTableNumber, protectionAvailabilityStatus=protectionAvailabilityStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortDisabledWarning=dataPortDisabledWarning, cambium=cambium, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, vectorError=vectorError, iPVersion=iPVersion, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rFUProtectionCompatibility=rFUProtectionCompatibility, iPv6GatewayAddress=iPv6GatewayAddress, linkLoss=linkLoss, versions=versions, syslogClient=syslogClient, protectionConfigurationStatus=protectionConfigurationStatus, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, securityLevel=securityLevel, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, longitude=longitude, ethernet=ethernet, aggregateDataRate=aggregateDataRate, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, aAAControl=aAAControl, userEnabled=userEnabled, bridge=bridge, sNMPTrapTableNumber=sNMPTrapTableNumber, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, fiberY=fiberY, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, radioLicenseIdentifier=radioLicenseIdentifier, wirelessLinkStatus=wirelessLinkStatus, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, configuration=configuration, tFTPServerPortNumber=tFTPServerPortNumber, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernetPriorityTable=ethernetPriorityTable, sNMPTrapIPAddress=sNMPTrapIPAddress, remotePrimaryIPAddress=remotePrimaryIPAddress, sNTPServerPortNumber=sNTPServerPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTable=sNMPTrapTable, remoteInternetAddressType=remoteInternetAddressType, sNTPPrimaryServer=sNTPPrimaryServer, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, localPacketFiltering=localPacketFiltering, receivePower=receivePower, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, subnetMask=subnetMask, userPassword=userPassword, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitCodeRate=transmitCodeRate, rxDiversityDataPortStatus=rxDiversityDataPortStatus, linkNameMismatch=linkNameMismatch, rFFeederLoss=rFFeederLoss, tFTPServerInternetAddressType=tFTPServerInternetAddressType, primaryRecoveryPeriod=primaryRecoveryPeriod, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rFURxFreqMin=rFURxFreqMin, radioLicenseCodeRate=radioLicenseCodeRate, rFUTxMuteStatus=rFUTxMuteStatus, sNMPEnabledTraps=sNMPEnabledTraps, dataPortFiberStatus=dataPortFiberStatus, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sMTPServerPortNumber=sMTPServerPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, remoteMACAddress=remoteMACAddress, transmitterStatus=transmitterStatus, sNTPServerTable=sNTPServerTable, userRole=userRole, protectionStateTrap=protectionStateTrap, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPv4Address=iPv4Address, managementPortStatus=managementPortStatus, radioLicenseMaxModulation=radioLicenseMaxModulation, altitude=altitude, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, transmitModulation=transmitModulation, rFUStatus=rFUStatus, receiveCodeRate=receiveCodeRate, protectionStatus=protectionStatus, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rFUConnectedPlatform=rFUConnectedPlatform, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, sNTPPollInterval=sNTPPollInterval, dataPortPauseFrames=dataPortPauseFrames, syslogControl=syslogControl, rxDiversityVid=rxDiversityVid, radioLicenseRegion=radioLicenseRegion, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, protection=protection, iFCableLength=iFCableLength, sNMPTrapTableIndex=sNMPTrapTableIndex, maximumTransmitPower=maximumTransmitPower, neighborInternetAddressType=neighborInternetAddressType, telnetAccessEnabled=telnetAccessEnabled, receiveDataRate=receiveDataRate, userTable=userTable, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, sNTPLastSync=sNTPLastSync, remoteInternetAddress=remoteInternetAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, maxModulation=maxModulation, userName=userName, enableTransmission=enableTransmission, syslogState=syslogState, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rFURFSwitchAlarm=rFURFSwitchAlarm, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPServerRetries=sNTPServerRetries, syslogStateTrap=syslogStateTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, neighborInternetAddress=neighborInternetAddress, neighborMACAddress=neighborMACAddress, protectionInterfaceStatus=protectionInterfaceStatus, systemClock=systemClock, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, transmitDataRate=transmitDataRate, radioLicenseModulation=radioLicenseModulation, rxDiversityVlanTpid=rxDiversityVlanTpid, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sMTPServerInternetAddressType=sMTPServerInternetAddressType, secureModeAlarmTrap=secureModeAlarmTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, bootVersion=bootVersion, sNTPServerTableIndex=sNTPServerTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, encryptionAlgorithm=encryptionAlgorithm, rFUTxBandAboveRx=rFUTxBandAboveRx, rFURfBand=rFURfBand, encryptionEnabledMismatch=encryptionEnabledMismatch, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, systemReset=systemReset, sNMPTrapTableEntry=sNMPTrapTableEntry, rFUVersionBank2=rFUVersionBank2, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkStatusTrap=wirelessLinkStatusTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, telnetPortNumber=telnetPortNumber, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, userTableEntry=userTableEntry, managementCommittedInformationRate=managementCommittedInformationRate, rFUTxPowerMax=rFUTxPowerMax, vLANManagementVID=vLANManagementVID, userTableIndex=userTableIndex, requestedProtectionState=requestedProtectionState, rFUVersionBank1=rFUVersionBank1, alarms=alarms, rFUSerial=rFUSerial, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, sMTPEnabledMessages=sMTPEnabledMessages, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, maxCodeRate=maxCodeRate, iPv6PrefixLength=iPv6PrefixLength, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, latitude=latitude, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sMTPEmailAlert=sMTPEmailAlert, siteName=siteName, wirelessLinkAvailability=wirelessLinkAvailability, rFUPlatformCompatibility=rFUPlatformCompatibility, reset=reset, rFUFreqSpacing=rFUFreqSpacing, managementPortWirelessDownAlert=managementPortWirelessDownAlert, managementPortAutoNegotiation=managementPortAutoNegotiation, radioLicenseTxFreq=radioLicenseTxFreq, rFUTxFreqMax=rFUTxFreqMax, radioLicenseMinCodeRate=radioLicenseMinCodeRate, secondarySoftwareVersion=secondarySoftwareVersion, ptpTrapPrefix=ptpTrapPrefix, ethernetFiberSupport=ethernetFiberSupport, protectionStats=protectionStats, primarySecondaryMode=primarySecondaryMode, transmitCapacityLimitDetail=transmitCapacityLimitDetail, sNTPServerTableNumber=sNTPServerTableNumber, alignmentModeTrap=alignmentModeTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, management=management, sNTPSync=sNTPSync, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, productVariant=productVariant, rFUCableAlarm=rFUCableAlarm, rFUType=rFUType, diverseRfFeederLoss=diverseRfFeederLoss, sMTPSourceEmailAddress=sMTPSourceEmailAddress, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, managementPortDisabledWarning=managementPortDisabledWarning, radioLicenseBandwidth=radioLicenseBandwidth, ptp800=ptp800, protectionState=protectionState, pubStats=pubStats, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, timeZone=timeZone, dataPortStatusTrap=dataPortStatusTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, remotePrimaryMACAddress=remotePrimaryMACAddress, unitOutOfCalibration=unitOutOfCalibration, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, antennaGain=antennaGain, iPDSCPPriorityTable=iPDSCPPriorityTable, primaryRecovery=primaryRecovery, activeUnit=activeUnit, supplementary=supplementary, alignmentMode=alignmentMode, radioLicenseMinModulation=radioLicenseMinModulation, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, radioLicenseRxFreq=radioLicenseRxFreq, radioLicenseBand=radioLicenseBand, ethernetPriorityTableNumber=ethernetPriorityTableNumber, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFUPowerAlarm=rFUPowerAlarm, remotePrimaryInternetAddress=remotePrimaryInternetAddress, managementMode=managementMode, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, sMTPServerInternetAddress=sMTPServerInternetAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", managementPortForcedConfiguration=managementPortForcedConfiguration, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, minCodeRate=minCodeRate, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, sNTPServerTableEntry=sNTPServerTableEntry, transmitCapacity=transmitCapacity, remotePrimarySecondaryMode=remotePrimarySecondaryMode, vLANManagementPriority=vLANManagementPriority, activeAvailableTime=activeAvailableTime, neighborIPAddress=neighborIPAddress, productName=productName, phyControl=phyControl, mPLSTCPriorityTable=mPLSTCPriorityTable, diverseAntennaGain=diverseAntennaGain, sNTPServerResponse=sNTPServerResponse, daylightSaving=daylightSaving, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rFUTransceiverLocation=rFUTransceiverLocation, ptmp=ptmp, secureModeAlarm=secureModeAlarm, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, iPv6Address=iPv6Address, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFUTxFreqMin=rFUTxFreqMin, transmitPower=transmitPower, rFUBranchingConfiguration=rFUBranchingConfiguration, protectionSwitchCause=protectionSwitchCause, sNTPServerTimeout=sNTPServerTimeout, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPSyncTrap=sNTPSyncTrap, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, licence=licence, numberOfAntennas=numberOfAntennas, sNMPPortNumber=sNMPPortNumber, remoteIPAddress=remoteIPAddress, rFUTxPowerAlarm=rFUTxPowerAlarm, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, sNTPServerIPAddress=sNTPServerIPAddress, radioLicense=radioLicense, rFULockoutAlarm=rFULockoutAlarm, softwareVersion=softwareVersion, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, snmpControl=snmpControl, activeWirelessLinkAvailability=activeWirelessLinkAvailability, endId=endId, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rFUTxPowerMin=rFUTxPowerMin, encryption=encryption, linkNameMismatchTrap=linkNameMismatchTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, smtp=smtp, hTTPSPortNumber=hTTPSPortNumber, hTTPPortNumber=hTTPPortNumber, gatewayIPAddress=gatewayIPAddress, remoteSecondaryMACAddress=remoteSecondaryMACAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sntp=sntp, ptp=ptp, sNTPState=sNTPState, remoteSecondaryIPAddress=remoteSecondaryIPAddress, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, transmitCapacityLimit=transmitCapacityLimit, ptpTraps=ptpTraps, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, receiveModulation=receiveModulation, aTPCEnable=aTPCEnable, faultProtectionSwitching=faultProtectionSwitching, radioLicenseMaxEIRP=radioLicenseMaxEIRP, qOSPriorityScheme=qOSPriorityScheme, hardwareVersion=hardwareVersion, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, rfu=rfu, sNMPTrapVersion=sNMPTrapVersion, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rFURxFreqMax=rFURxFreqMax, l2CPPriorityTable=l2CPPriorityTable, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap)
