...
enterprises, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, Bits, Gauge32, NotificationType, Unsigned32, MibIdentifier, NotificationType, iso, ObjectIdentity, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "Bits", "Gauge32", "NotificationType", "Unsigned32", "MibIdentifier", "NotificationType", "iso", "ObjectIdentity", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", ptpTraps=ptpTraps, rxDiversityVid=rxDiversityVid, l2CPPriorityTableIndex=l2CPPriorityTableIndex, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFULockoutAlarm=rFULockoutAlarm, sNTPServerPortNumber=sNTPServerPortNumber, aAAControl=aAAControl, rFUTxPowerMin=rFUTxPowerMin, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryption=encryption, subnetMask=subnetMask, diverseRfFeederLoss=diverseRfFeederLoss, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rxDiversityDataPortStatus=rxDiversityDataPortStatus, rFUTransceiverLocation=rFUTransceiverLocation, sNMPTrapInternetAddress=sNMPTrapInternetAddress, remoteSecondaryIPAddress=remoteSecondaryIPAddress, iPv6Address=iPv6Address, pubStats=pubStats, radioLicenseMaxModulation=radioLicenseMaxModulation, remotePrimarySecondaryMode=remotePrimarySecondaryMode, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rFUBranchingConfiguration=rFUBranchingConfiguration, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, bridge=bridge, sMTPEmailAlert=sMTPEmailAlert, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rFURpsAlarm=rFURpsAlarm, receiveCodeRate=receiveCodeRate, telnetPortNumber=telnetPortNumber, localPacketFiltering=localPacketFiltering, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPv4Address=iPv4Address, vLANManagementPriority=vLANManagementPriority, syslogState=syslogState, rFUStatusTrap=rFUStatusTrap, latitude=latitude, sNTPServerTableIndex=sNTPServerTableIndex, ethernetPriorityTable=ethernetPriorityTable, receiveModulation=receiveModulation, systemClock=systemClock, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptmp=ptmp, altitude=altitude, dSCPManagementPriority=dSCPManagementPriority, vLANManagementVIDValidation=vLANManagementVIDValidation, transmitModulation=transmitModulation, neighborMACAddress=neighborMACAddress, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNMPCommunityString=sNMPCommunityString, iPVersion=iPVersion, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, transmitDataRate=transmitDataRate, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, activeUnit=activeUnit, remoteIPAddress=remoteIPAddress, receivePower=receivePower, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPTrapVersion=sNMPTrapVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, protectionStateTrap=protectionStateTrap, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, ethernetPriorityTableEntry=ethernetPriorityTableEntry, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, wirelessLinkStatusTrap=wirelessLinkStatusTrap, syslogControl=syslogControl, l2CPPriorityTable=l2CPPriorityTable, sNTPLastSync=sNTPLastSync, alignmentMode=alignmentMode, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, hTTPSPortNumber=hTTPSPortNumber, rFUStatus=rFUStatus, syslogStateTrap=syslogStateTrap, managementPortStatus=managementPortStatus, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rFUCableAlarm=rFUCableAlarm, sNTPServerInternetAddress=sNTPServerInternetAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sMTPEnabledMessages=sMTPEnabledMessages, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, l2CPPriorityTableNumber=l2CPPriorityTableNumber, phyStatus=phyStatus, dataPortStatus=dataPortStatus, rFUType=rFUType, l2CPPriorityTableEntry=l2CPPriorityTableEntry, transmitCapacityLimit=transmitCapacityLimit, radioLicenseMinModulation=radioLicenseMinModulation, rFURfBand=rFURfBand, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, linkLoss=linkLoss, userRole=userRole, managementPortAutoNegotiation=managementPortAutoNegotiation, userEnabled=userEnabled, iFCableLength=iFCableLength, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rFURxFreqMax=rFURxFreqMax, timeZone=timeZone, dataPortDisabledWarning=dataPortDisabledWarning, protectionInterfaceStatus=protectionInterfaceStatus, syslogClient=syslogClient, protectionStats=protectionStats, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, userTableNumber=userTableNumber, managementPortStatusTrap=managementPortStatusTrap, supplementary=supplementary, securityLevel=securityLevel, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, faultProtectionSwitching=faultProtectionSwitching, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, radioLicenseRegion=radioLicenseRegion, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, protection=protection, receiveDataRate=receiveDataRate, primaryRecovery=primaryRecovery, remotePrimaryInternetAddress=remotePrimaryInternetAddress, rFFeederLoss=rFFeederLoss, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, remoteMACAddress=remoteMACAddress, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, systemReset=systemReset, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, managementMode=managementMode, vectorError=vectorError, rFURFSwitchAlarm=rFURFSwitchAlarm, sNMPTrapIPAddress=sNMPTrapIPAddress, reset=reset, cambium=cambium, primaryRecoveryPeriod=primaryRecoveryPeriod, remotePrimaryIPAddress=remotePrimaryIPAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerTable=sNTPServerTable, mPLSTCPriorityTable=mPLSTCPriorityTable, remoteSecondaryMACAddress=remoteSecondaryMACAddress, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, iPv6PrefixLength=iPv6PrefixLength, minModulation=minModulation, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, productVariant=productVariant, antennaGain=antennaGain, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, sntp=sntp, aggregateDataRate=aggregateDataRate, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rFUTxFreqMin=rFUTxFreqMin, activeAvailableTime=activeAvailableTime, ethernet=ethernet, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sNTPServerTableEntry=sNTPServerTableEntry, userName=userName, rFUPlatformCompatibility=rFUPlatformCompatibility, rFUTxFreqMax=rFUTxFreqMax, softwareVersion=softwareVersion, vLANManagementVID=vLANManagementVID, userTableEntry=userTableEntry, sNTPState=sNTPState, rFUVersionBank1=rFUVersionBank1, userTableIndex=userTableIndex, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, hTTPAccessEnabled=hTTPAccessEnabled, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogClientTrap=syslogClientTrap, neighborInternetAddressType=neighborInternetAddressType, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, rFUProtectionCompatibility=rFUProtectionCompatibility, linkName=linkName, rFUTxPowerAlarm=rFUTxPowerAlarm, telnetAccessEnabled=telnetAccessEnabled, radioLicenseTxFreq=radioLicenseTxFreq, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPSync=sNTPSync, sNTPServerResponse=sNTPServerResponse, radioLicenseBandwidth=radioLicenseBandwidth, enableTransmission=enableTransmission, sMTPSourceEmailAddress=sMTPSourceEmailAddress, protectionAvailabilityStatus=protectionAvailabilityStatus, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, rFUVersionBank2=rFUVersionBank2, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, rFUActiveFirmwareBank=rFUActiveFirmwareBank, linkNameMismatchTrap=linkNameMismatchTrap, hTTPPortNumber=hTTPPortNumber, radioLicenseCodeRate=radioLicenseCodeRate, requestedProtectionState=requestedProtectionState, numberOfAntennas=numberOfAntennas, encryptionEnabledMismatch=encryptionEnabledMismatch, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sNTPServerIPAddress=sNTPServerIPAddress, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, rFUTxMuteStatus=rFUTxMuteStatus, rFUFreqSpacing=rFUFreqSpacing, managementPortDisabledWarning=managementPortDisabledWarning, daylightSaving=daylightSaving, radioLicenseBand=radioLicenseBand, maxModulation=maxModulation, radioLicenseModulation=radioLicenseModulation, alarms=alarms, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, longitude=longitude, alignmentModeTrap=alignmentModeTrap, maxCodeRate=maxCodeRate, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, transmitCodeRate=transmitCodeRate, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, ptpTrapPrefix=ptpTrapPrefix, sNMPEnabledTraps=sNMPEnabledTraps, managementPortForcedConfiguration=managementPortForcedConfiguration, tFTPServerIPAddress=tFTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sMTPServerInternetAddressType=sMTPServerInternetAddressType, primarySecondaryMode=primarySecondaryMode, phyControl=phyControl, userPassword=userPassword, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteInternetAddressType=remoteInternetAddressType, dataPortFiberStatus=dataPortFiberStatus, sNTPSyncTrap=sNTPSyncTrap, wirelessLinkAvailability=wirelessLinkAvailability, siteName=siteName, transmitCapacityLimitDetail=transmitCapacityLimitDetail, configuration=configuration, secondarySoftwareVersion=secondarySoftwareVersion, rFUSerial=rFUSerial, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerTableNumber=sNTPServerTableNumber, protectionConfig=protectionConfig, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rxDiversityVlanTpid=rxDiversityVlanTpid, tFTPServerInternetAddressType=tFTPServerInternetAddressType, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rFURxFreqMin=rFURxFreqMin, sMTPServerPortNumber=sMTPServerPortNumber, rFUPowerAlarm=rFUPowerAlarm, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", neighborInternetAddress=neighborInternetAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ptp=ptp, ethernetFiberSupport=ethernetFiberSupport, transmitCapacity=transmitCapacity, ethernetPriorityTableNumber=ethernetPriorityTableNumber, minCodeRate=minCodeRate, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, sNMPPortNumber=sNMPPortNumber, ptp800=ptp800, wirelessLinkStatus=wirelessLinkStatus, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, sNTPPrimaryServer=sNTPPrimaryServer, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, unitOutOfCalibration=unitOutOfCalibration, tFTPServerInternetAddress=tFTPServerInternetAddress, neighborIPAddress=neighborIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, versions=versions, remoteInternetAddress=remoteInternetAddress, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, secureModeAlarmTrap=secureModeAlarmTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, secureModeAlarm=secureModeAlarm, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, bootVersion=bootVersion, rfu=rfu, dataPortPauseFrames=dataPortPauseFrames, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, hardwareVersion=hardwareVersion, rFUTxPowerMax=rFUTxPowerMax, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, sMTPServerInternetAddress=sMTPServerInternetAddress, radioLicenseIdentifier=radioLicenseIdentifier, dataPortConfigurationMismatch=dataPortConfigurationMismatch, fiberY=fiberY, gatewayIPAddress=gatewayIPAddress, remotePrimaryMACAddress=remotePrimaryMACAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, radioLicense=radioLicense, sNMPTrapPortNumber=sNMPTrapPortNumber, protectionState=protectionState, linkNameMismatch=linkNameMismatch, rFUConnectedPlatform=rFUConnectedPlatform, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, diverseAntennaGain=diverseAntennaGain, radioLicenseRxFreq=radioLicenseRxFreq, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, endId=endId, encryptionAlgorithm=encryptionAlgorithm, managementCommittedInformationRate=managementCommittedInformationRate, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPServerRetries=sNTPServerRetries, ethernetPriorityTableIndex=ethernetPriorityTableIndex, snmpControl=snmpControl, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, sNTPServerTimeout=sNTPServerTimeout, licence=licence, protectionStatus=protectionStatus, transmitterStatus=transmitterStatus, management=management, maximumTransmitPower=maximumTransmitPower, productName=productName, protectionSwitchCause=protectionSwitchCause, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, smtp=smtp, sNTPPollInterval=sNTPPollInterval, userTable=userTable, qOSPriorityScheme=qOSPriorityScheme, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rFUTxBandAboveRx=rFUTxBandAboveRx, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, rFUPowerButtonPressed=rFUPowerButtonPressed, transmitPower=transmitPower, protectionConfigurationStatus=protectionConfigurationStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, radioLicenseMaxEIRP=radioLicenseMaxEIRP, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, aTPCEnable=aTPCEnable, sNMPTrapTable=sNMPTrapTable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName)
