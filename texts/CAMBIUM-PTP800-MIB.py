...
Counter64, ModuleIdentity, Integer32, ObjectIdentity, Bits, Counter32, Gauge32, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, IpAddress, iso, NotificationType, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "Integer32", "ObjectIdentity", "Bits", "Counter32", "Gauge32", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "IpAddress", "iso", "NotificationType", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", syslogClient=syslogClient, timeZone=timeZone, rFUPowerButtonPressed=rFUPowerButtonPressed, receiveDataRate=receiveDataRate, protectionSwitchCause=protectionSwitchCause, neighborMACAddress=neighborMACAddress, altitude=altitude, sMTPServerPortNumber=sMTPServerPortNumber, rFUTxFreqMin=rFUTxFreqMin, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, radioLicenseBandwidth=radioLicenseBandwidth, wirelessLinkStatus=wirelessLinkStatus, ptpTrapPrefix=ptpTrapPrefix, minCodeRate=minCodeRate, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rFUStatus=rFUStatus, transmitPower=transmitPower, linkNameMismatch=linkNameMismatch, sNTPServerResponse=sNTPServerResponse, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, maxCodeRate=maxCodeRate, rFUPlatformCompatibility=rFUPlatformCompatibility, productName=productName, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, radioLicenseMinCodeRate=radioLicenseMinCodeRate, numberOfAntennas=numberOfAntennas, telnetAccessEnabled=telnetAccessEnabled, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ethernetFiberSupport=ethernetFiberSupport, linkLoss=linkLoss, remoteInternetAddress=remoteInternetAddress, minModulation=minModulation, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, managementPortAutoNegotiation=managementPortAutoNegotiation, syslogClientTrap=syslogClientTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, remotePrimaryIPAddress=remotePrimaryIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hTTPPortNumber=hTTPPortNumber, sNTPSync=sNTPSync, sMTPEnabledMessages=sMTPEnabledMessages, rFURxFreqMax=rFURxFreqMax, userRole=userRole, rFUTxMuteStatus=rFUTxMuteStatus, primarySecondaryMode=primarySecondaryMode, remoteIPAddress=remoteIPAddress, managementPortStatus=managementPortStatus, secondarySoftwareVersion=secondarySoftwareVersion, protectionStats=protectionStats, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, bootVersion=bootVersion, rxDiversityDataPortStatus=rxDiversityDataPortStatus, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPCommunityString=sNMPCommunityString, primaryRecoveryPeriod=primaryRecoveryPeriod, transmitterStatus=transmitterStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerInternetAddress=sNTPServerInternetAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vLANManagementVID=vLANManagementVID, sNTPServerTableEntry=sNTPServerTableEntry, rFUStatusTrap=rFUStatusTrap, systemClock=systemClock, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, sNTPServerInternetAddressType=sNTPServerInternetAddressType, latitude=latitude, userName=userName, userTableIndex=userTableIndex, qOSPriorityScheme=qOSPriorityScheme, aTPCEnable=aTPCEnable, bridge=bridge, rFURfBand=rFURfBand, diverseRfFeederLoss=diverseRfFeederLoss, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, softwareVersion=softwareVersion, faultProtectionSwitching=faultProtectionSwitching, iPv6Address=iPv6Address, pubStats=pubStats, rFURpsAlarm=rFURpsAlarm, activeUnit=activeUnit, userPassword=userPassword, userTableEntry=userTableEntry, sNMPTrapTable=sNMPTrapTable, supplementary=supplementary, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, wirelessLinkAvailability=wirelessLinkAvailability, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rFUFreqSpacing=rFUFreqSpacing, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, dataPortStatusTrap=dataPortStatusTrap, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, securityLevel=securityLevel, ethernetPriorityTableEntry=ethernetPriorityTableEntry, radioLicenseIdentifier=radioLicenseIdentifier, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerTableNumber=sNTPServerTableNumber, managementPortForcedConfiguration=managementPortForcedConfiguration, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, alignmentModeTrap=alignmentModeTrap, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, ptp=ptp, protectionConfigurationStatus=protectionConfigurationStatus, rFUActiveFirmwareBank=rFUActiveFirmwareBank, sNTPServerRetries=sNTPServerRetries, managementPortConfigurationMismatch=managementPortConfigurationMismatch, vectorError=vectorError, tFTPServerInternetAddress=tFTPServerInternetAddress, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, activeAvailableTime=activeAvailableTime, sNMPTrapIPAddress=sNMPTrapIPAddress, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, managementPortDisabledWarning=managementPortDisabledWarning, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, radioLicenseCodeRate=radioLicenseCodeRate, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapVersion=sNMPTrapVersion, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, vLANManagementPriority=vLANManagementPriority, managementMode=managementMode, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dSCPManagementPriority=dSCPManagementPriority, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, snmpControl=snmpControl, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, phyControl=phyControl, dataPortStatus=dataPortStatus, rFUVersionBank2=rFUVersionBank2, management=management, l2CPPriorityTableIndex=l2CPPriorityTableIndex, linkName=linkName, transmitCapacityLimit=transmitCapacityLimit, rFUTxBandAboveRx=rFUTxBandAboveRx, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, licence=licence, ethernet=ethernet, radioLicenseRegion=radioLicenseRegion, remoteInternetAddressType=remoteInternetAddressType, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortFiberStatus=dataPortFiberStatus, sNTPPollInterval=sNTPPollInterval, managementPortStatusTrap=managementPortStatusTrap, protectionStatus=protectionStatus, diverseAntennaGain=diverseAntennaGain, sMTPServerIPAddress=sMTPServerIPAddress, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rFUTransceiverLocation=rFUTransceiverLocation, tFTPServerIPAddress=tFTPServerIPAddress, rFURFSwitchAlarm=rFURFSwitchAlarm, radioLicenseRxFreq=radioLicenseRxFreq, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, neighborIPAddress=neighborIPAddress, rFUProtectionCompatibility=rFUProtectionCompatibility, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, remotePrimaryInternetAddress=remotePrimaryInternetAddress, encryptionEnabledMismatch=encryptionEnabledMismatch, receiveCodeRate=receiveCodeRate, tFTPServerPortNumber=tFTPServerPortNumber, rFUVersionBank1=rFUVersionBank1, receivePower=receivePower, transmitModulation=transmitModulation, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, iPv6PrefixLength=iPv6PrefixLength, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, requestedProtectionState=requestedProtectionState, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPLastSync=sNTPLastSync, remotePrimarySecondaryMode=remotePrimarySecondaryMode, syslogControl=syslogControl, cambium=cambium, protection=protection, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, radioLicenseModulation=radioLicenseModulation, unitOutOfCalibration=unitOutOfCalibration, rFUType=rFUType, iFCableLength=iFCableLength, secureModeAlarmTrap=secureModeAlarmTrap, ethernetPriorityTable=ethernetPriorityTable, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, radioLicenseMinModulation=radioLicenseMinModulation, userTable=userTable, receiveModulation=receiveModulation, ptmp=ptmp, alarms=alarms, rFUCableAlarm=rFUCableAlarm, sNTPState=sNTPState, userEnabled=userEnabled, userTableNumber=userTableNumber, localPacketFiltering=localPacketFiltering, sNTPServerIPAddress=sNTPServerIPAddress, radioLicenseMaxModulation=radioLicenseMaxModulation, productVariant=productVariant, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, encryptionAlgorithm=encryptionAlgorithm, maximumTransmitPower=maximumTransmitPower, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, dataPortConfigurationMismatch=dataPortConfigurationMismatch, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, protectionInterfaceStatus=protectionInterfaceStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, gatewayIPAddress=gatewayIPAddress, aAAControl=aAAControl, remoteSecondaryMACAddress=remoteSecondaryMACAddress, remoteMACAddress=remoteMACAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, remotePrimaryMACAddress=remotePrimaryMACAddress, siteName=siteName, rFFeederLoss=rFFeederLoss, iPv4Address=iPv4Address, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sntp=sntp, daylightSaving=daylightSaving, rFURxFreqMin=rFURxFreqMin, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, subnetMask=subnetMask, remoteMaximumTransmitPower=remoteMaximumTransmitPower, versions=versions, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, hardwareVersion=hardwareVersion, iPv6GatewayAddress=iPv6GatewayAddress, rFUTxFreqMax=rFUTxFreqMax, secureModeAlarm=secureModeAlarm, primaryRecovery=primaryRecovery, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerTimeout=sNTPServerTimeout, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNTPServerTableIndex=sNTPServerTableIndex, radioLicenseTxFreq=radioLicenseTxFreq, protectionStateTrap=protectionStateTrap, smtp=smtp, maxModulation=maxModulation, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, radioLicenseMaxEIRP=radioLicenseMaxEIRP, rFUTxPowerAlarm=rFUTxPowerAlarm, configuration=configuration, enableTransmission=enableTransmission, vLANManagementVIDValidation=vLANManagementVIDValidation, reset=reset, radioLicenseBand=radioLicenseBand, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, protectionAvailabilityStatus=protectionAvailabilityStatus, phyStatus=phyStatus, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rxDiversityVid=rxDiversityVid, l2CPPriorityTableEntry=l2CPPriorityTableEntry, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sNTPServerTable=sNTPServerTable, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rFUTxPowerMax=rFUTxPowerMax, radioLicense=radioLicense, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rFUPowerAlarm=rFUPowerAlarm, rFUBranchingConfiguration=rFUBranchingConfiguration, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPSyncTrap=sNTPSyncTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, antennaGain=antennaGain, encryption=encryption, hTTPSPortNumber=hTTPSPortNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, l2CPPriorityTable=l2CPPriorityTable, rFULockoutAlarm=rFULockoutAlarm, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPTrapTableNumber=sNMPTrapTableNumber, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, managementCommittedInformationRate=managementCommittedInformationRate, rFUTxPowerMin=rFUTxPowerMin, iPVersion=iPVersion, syslogState=syslogState, sMTPEmailAlert=sMTPEmailAlert, transmitCodeRate=transmitCodeRate, syslogLocalWrappedTrap=syslogLocalWrappedTrap, endId=endId, linkNameMismatchTrap=linkNameMismatchTrap, rfu=rfu, sMTPServerInternetAddress=sMTPServerInternetAddress, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, neighborInternetAddress=neighborInternetAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, protectionState=protectionState, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, protectionConfig=protectionConfig, sNTPPrimaryServer=sNTPPrimaryServer, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rxDiversityVlanTpid=rxDiversityVlanTpid, sNMPPortNumber=sNMPPortNumber, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, ptp800=ptp800, dataPortPauseFrames=dataPortPauseFrames, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, telnetPortNumber=telnetPortNumber, rFUConnectedPlatform=rFUConnectedPlatform, activeWirelessLinkAvailability=activeWirelessLinkAvailability, fiberY=fiberY, transmitDataRate=transmitDataRate, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, systemReset=systemReset, alignmentMode=alignmentMode, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, transmitCapacityLimitDetail=transmitCapacityLimitDetail, syslogStateTrap=syslogStateTrap, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, longitude=longitude, neighborInternetAddressType=neighborInternetAddressType, rFUSerial=rFUSerial, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dataPortDisabledWarning=dataPortDisabledWarning, transmitCapacity=transmitCapacity, aggregateDataRate=aggregateDataRate, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessLinkStatusTrap=wirelessLinkStatusTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, remoteSecondaryIPAddress=remoteSecondaryIPAddress, sNMPEnabledTraps=sNMPEnabledTraps)
