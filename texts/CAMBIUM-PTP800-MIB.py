...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, Unsigned32, ModuleIdentity, MibIdentifier, NotificationType, Integer32, TimeTicks, Gauge32, iso, ObjectIdentity, Counter32, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "Unsigned32", "ModuleIdentity", "MibIdentifier", "NotificationType", "Integer32", "TimeTicks", "Gauge32", "iso", "ObjectIdentity", "Counter32", "Bits", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", versions=versions, sNMPTrapTableNumber=sNMPTrapTableNumber, latitude=latitude, iPDSCPPriorityTable=iPDSCPPriorityTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, managementPortForcedConfiguration=managementPortForcedConfiguration, receiveDataRate=receiveDataRate, protectionState=protectionState, configuration=configuration, transmitCodeRate=transmitCodeRate, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rFUVersionBank1=rFUVersionBank1, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, wirelessLinkStatus=wirelessLinkStatus, securityLevel=securityLevel, sMTPServerPortNumber=sMTPServerPortNumber, endId=endId, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, dataPortDisabledWarning=dataPortDisabledWarning, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, l2CPPriorityTable=l2CPPriorityTable, sntp=sntp, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ptp800=ptp800, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, linkLoss=linkLoss, sNMPTrapPortNumber=sNMPTrapPortNumber, iPv4Address=iPv4Address, encryptionAlgorithm=encryptionAlgorithm, alignmentModeTrap=alignmentModeTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, remotePrimaryIPAddress=remotePrimaryIPAddress, vLANManagementVID=vLANManagementVID, vLANManagementVIDValidation=vLANManagementVIDValidation, rFURxFreqMin=rFURxFreqMin, rFFeederLoss=rFFeederLoss, tFTPServerInternetAddress=tFTPServerInternetAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rFUStatus=rFUStatus, sNTPSync=sNTPSync, radioLicenseCodeRate=radioLicenseCodeRate, fiberY=fiberY, protectionStats=protectionStats, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPState=sNTPState, syslogClient=syslogClient, tFTPServerPortNumber=tFTPServerPortNumber, ptmp=ptmp, remotePrimaryMACAddress=remotePrimaryMACAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, smtp=smtp, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, radioLicenseBandwidth=radioLicenseBandwidth, sNTPServerRetries=sNTPServerRetries, rFUVersionBank2=rFUVersionBank2, sMTPServerInternetAddress=sMTPServerInternetAddress, dSCPManagementPriority=dSCPManagementPriority, subnetMask=subnetMask, alignmentMode=alignmentMode, sNTPServerInternetAddress=sNTPServerInternetAddress, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, snmpControl=snmpControl, protectionConfig=protectionConfig, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, userTable=userTable, unitOutOfCalibration=unitOutOfCalibration, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptp=ptp, maxModulation=maxModulation, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, neighborIPAddress=neighborIPAddress, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, faultProtectionSwitching=faultProtectionSwitching, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, aAAControl=aAAControl, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, wirelessLinkStatusTrap=wirelessLinkStatusTrap, protection=protection, diverseRfFeederLoss=diverseRfFeederLoss, remotePrimaryInternetAddress=remotePrimaryInternetAddress, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkNameMismatch=linkNameMismatch, managementPortAutoNegotiation=managementPortAutoNegotiation, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dataPortFiberStatus=dataPortFiberStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rFURFSwitchAlarm=rFURFSwitchAlarm, sNTPServerTableEntry=sNTPServerTableEntry, qOSPriorityScheme=qOSPriorityScheme, encryptionEnabledMismatch=encryptionEnabledMismatch, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, primaryRecovery=primaryRecovery, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, aTPCEnable=aTPCEnable, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rFUCableAlarm=rFUCableAlarm, secureModeAlarm=secureModeAlarm, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, sNTPServerTableIndex=sNTPServerTableIndex, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rxDiversityVlanTpid=rxDiversityVlanTpid, telnetPortNumber=telnetPortNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, rxDiversityVid=rxDiversityVid, hTTPPortNumber=hTTPPortNumber, sNMPTrapTable=sNMPTrapTable, systemClock=systemClock, rFUType=rFUType, numberOfAntennas=numberOfAntennas, sMTPEnabledMessages=sMTPEnabledMessages, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, managementPortDisabledWarning=managementPortDisabledWarning, rFUPowerAlarm=rFUPowerAlarm, sNTPServerTimeout=sNTPServerTimeout, linkName=linkName, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, hTTPAccessEnabled=hTTPAccessEnabled, syslogStateTrap=syslogStateTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, managementCommittedInformationRate=managementCommittedInformationRate, rFUFreqSpacing=rFUFreqSpacing, sNTPServerTableNumber=sNTPServerTableNumber, protectionAvailabilityStatus=protectionAvailabilityStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, syslogState=syslogState, tFTPServerIPAddress=tFTPServerIPAddress, longitude=longitude, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, radioLicenseIdentifier=radioLicenseIdentifier, rFUTxFreqMax=rFUTxFreqMax, rFUTxFreqMin=rFUTxFreqMin, licence=licence, tFTPServerInternetAddressType=tFTPServerInternetAddressType, radioLicenseModulation=radioLicenseModulation, reset=reset, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, radioLicenseMaxModulation=radioLicenseMaxModulation, iPv6PrefixLength=iPv6PrefixLength, altitude=altitude, timeZone=timeZone, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, maxCodeRate=maxCodeRate, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, remoteSecondaryIPAddress=remoteSecondaryIPAddress, userTableIndex=userTableIndex, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, phyStatus=phyStatus, hTTPSPortNumber=hTTPSPortNumber, ptpTrapPrefix=ptpTrapPrefix, iFCableLength=iFCableLength, radioLicenseBand=radioLicenseBand, protectionStateTrap=protectionStateTrap, neighborInternetAddress=neighborInternetAddress, rFUConnectedPlatform=rFUConnectedPlatform, transmitPower=transmitPower, sNMPTrapVersion=sNMPTrapVersion, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, management=management, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, vLANManagementPriority=vLANManagementPriority, primarySecondaryMode=primarySecondaryMode, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, receivePower=receivePower, softwareVersion=softwareVersion, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFUProtectionCompatibility=rFUProtectionCompatibility, rFUTxPowerAlarm=rFUTxPowerAlarm, protectionConfigurationStatus=protectionConfigurationStatus, remoteIPAddress=remoteIPAddress, sNTPServerResponse=sNTPServerResponse, protectionInterfaceStatus=protectionInterfaceStatus, sMTPEmailAlert=sMTPEmailAlert, linkNameMismatchTrap=linkNameMismatchTrap, localPacketFiltering=localPacketFiltering, antennaGain=antennaGain, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPSyncTrap=sNTPSyncTrap, managementPortStatusTrap=managementPortStatusTrap, radioLicenseTxFreq=radioLicenseTxFreq, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userName=userName, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, vectorError=vectorError, bootVersion=bootVersion, activeWirelessLinkAvailability=activeWirelessLinkAvailability, alarms=alarms, remoteMACAddress=remoteMACAddress, rFUBranchingConfiguration=rFUBranchingConfiguration, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFURfBand=rFURfBand, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPCommunityString=sNMPCommunityString, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rFUPlatformCompatibility=rFUPlatformCompatibility, userTableEntry=userTableEntry, pubStats=pubStats, sNTPPollInterval=sNTPPollInterval, rFURxFreqMax=rFURxFreqMax, sNTPPrimaryServer=sNTPPrimaryServer, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sMTPSourceEmailAddress=sMTPSourceEmailAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataPortStatusTrap=dataPortStatusTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, receiveModulation=receiveModulation, secondarySoftwareVersion=secondarySoftwareVersion, cambium=cambium, syslogClientTrap=syslogClientTrap, activeUnit=activeUnit, dataPortStatus=dataPortStatus, minCodeRate=minCodeRate, bridge=bridge, iPv6Address=iPv6Address, neighborMACAddress=neighborMACAddress, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, remoteInternetAddress=remoteInternetAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, managementPortStatus=managementPortStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, userPassword=userPassword, iPVersion=iPVersion, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFUTxPowerMax=rFUTxPowerMax, sNMPPortNumber=sNMPPortNumber, enableTransmission=enableTransmission)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", dataPortPauseFrames=dataPortPauseFrames, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteInternetAddressType=remoteInternetAddressType, daylightSaving=daylightSaving, supplementary=supplementary, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, sNTPLastSync=sNTPLastSync, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, neighborInternetAddressType=neighborInternetAddressType, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveCodeRate=receiveCodeRate, rFURpsAlarm=rFURpsAlarm, managementMode=managementMode, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPServerPortNumber=sNTPServerPortNumber, rfu=rfu, wirelessLinkAvailability=wirelessLinkAvailability, userRole=userRole, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, radioLicenseMinModulation=radioLicenseMinModulation, phyControl=phyControl, l2CPPriorityTableNumber=l2CPPriorityTableNumber, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, rxDiversityDataPortStatus=rxDiversityDataPortStatus, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rFUPowerButtonPressed=rFUPowerButtonPressed, radioLicenseRegion=radioLicenseRegion, remoteSecondaryMACAddress=remoteSecondaryMACAddress, productName=productName, primaryRecoveryPeriod=primaryRecoveryPeriod, rFUTransceiverLocation=rFUTransceiverLocation, rFUStatusTrap=rFUStatusTrap, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, systemReset=systemReset, mPLSTCPriorityTable=mPLSTCPriorityTable, transmitModulation=transmitModulation, transmitCapacityLimit=transmitCapacityLimit, ethernetFiberSupport=ethernetFiberSupport, rFUTxPowerMin=rFUTxPowerMin, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetPriorityTable=ethernetPriorityTable, activeAvailableTime=activeAvailableTime, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, userEnabled=userEnabled, ptpTraps=ptpTraps, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rFUSerial=rFUSerial, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, rFUTxBandAboveRx=rFUTxBandAboveRx, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, encryption=encryption, iPv6GatewayAddress=iPv6GatewayAddress, ethernet=ethernet, syslogControl=syslogControl, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, diverseAntennaGain=diverseAntennaGain, productVariant=productVariant, transmitCapacity=transmitCapacity, radioLicense=radioLicense, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, protectionStatus=protectionStatus, transmitterStatus=transmitterStatus, userTableNumber=userTableNumber, transmitCapacityLimitDetail=transmitCapacityLimitDetail, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, maximumTransmitPower=maximumTransmitPower, hardwareVersion=hardwareVersion, radioLicenseRxFreq=radioLicenseRxFreq, siteName=siteName, transmitDataRate=transmitDataRate, minModulation=minModulation, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPServerTable=sNTPServerTable, radioLicenseMaxEIRP=radioLicenseMaxEIRP, sNMPEnabledTraps=sNMPEnabledTraps, rFULockoutAlarm=rFULockoutAlarm, aggregateDataRate=aggregateDataRate, sNTPServerIPAddress=sNTPServerIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, requestedProtectionState=requestedProtectionState, rFUTxMuteStatus=rFUTxMuteStatus, protectionSwitchCause=protectionSwitchCause)
