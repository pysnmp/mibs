...
ModuleIdentity, Integer32, IpAddress, Counter64, Gauge32, ObjectIdentity, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Bits, NotificationType, TimeTicks, Unsigned32, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "IpAddress", "Counter64", "Gauge32", "ObjectIdentity", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Bits", "NotificationType", "TimeTicks", "Unsigned32", "Counter32", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", radioLicenseCodeRate=radioLicenseCodeRate, qOSPriorityScheme=qOSPriorityScheme, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityString=sNMPCommunityString, daylightSaving=daylightSaving, snmpControl=snmpControl, aggregateDataRate=aggregateDataRate, ethernetPriorityTableEntry=ethernetPriorityTableEntry, softwareVersion=softwareVersion, rFUPowerAlarm=rFUPowerAlarm, sNMPEnabledTraps=sNMPEnabledTraps, diverseAntennaGain=diverseAntennaGain, configuration=configuration, remoteInternetAddress=remoteInternetAddress, radioLicenseRegion=radioLicenseRegion, vLANManagementVID=vLANManagementVID, dataPortPauseFrames=dataPortPauseFrames, transmitCapacityLimit=transmitCapacityLimit, linkName=linkName, protectionState=protectionState, encryption=encryption, neighborMACAddress=neighborMACAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, encryptionAlgorithm=encryptionAlgorithm, rFUTransceiverLocation=rFUTransceiverLocation, managementCommittedInformationRate=managementCommittedInformationRate, remoteMACAddress=remoteMACAddress, rFUStatusTrap=rFUStatusTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, vLANManagementVIDValidation=vLANManagementVIDValidation, enableTransmission=enableTransmission, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, smtp=smtp, bridge=bridge, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rFUSerial=rFUSerial, sntp=sntp, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernet=ethernet, dataPortStatusTrap=dataPortStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rxDiversityDataPortStatus=rxDiversityDataPortStatus, ptpTraps=ptpTraps, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, userRole=userRole, iFCableLength=iFCableLength, radioLicense=radioLicense, linkNameMismatch=linkNameMismatch, rFUTxFreqMax=rFUTxFreqMax, hTTPAccessEnabled=hTTPAccessEnabled, maximumTransmitPower=maximumTransmitPower, receiveModulation=receiveModulation, managementPortDisabledWarning=managementPortDisabledWarning, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, userTableEntry=userTableEntry, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, reset=reset, userTable=userTable, tFTPServerPortNumber=tFTPServerPortNumber, syslogState=syslogState, dataPortFiberStatus=dataPortFiberStatus, userTableIndex=userTableIndex, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, radioLicenseModulation=radioLicenseModulation, ptmp=ptmp, sNTPSyncTrap=sNTPSyncTrap, radioLicenseBand=radioLicenseBand, dSCPManagementPriority=dSCPManagementPriority, ethernetFiberSupport=ethernetFiberSupport, hTTPPortNumber=hTTPPortNumber, linkLoss=linkLoss, primaryRecovery=primaryRecovery, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPServerTable=sNTPServerTable, rFURFSwitchAlarm=rFURFSwitchAlarm, rFUCableAlarm=rFUCableAlarm, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, supplementary=supplementary, activeAvailableTime=activeAvailableTime, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, iPDSCPPriorityTable=iPDSCPPriorityTable, userName=userName, receivePower=receivePower, syslogClientTrap=syslogClientTrap, transmitCodeRate=transmitCodeRate, fiberY=fiberY, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPPrimaryServer=sNTPPrimaryServer, transmitDataRate=transmitDataRate, rFUPowerButtonPressed=rFUPowerButtonPressed, systemClock=systemClock, radioLicenseTxFreq=radioLicenseTxFreq, syslogClient=syslogClient, activeWirelessLinkAvailability=activeWirelessLinkAvailability, useVLANForManagementInterfaces=useVLANForManagementInterfaces, gatewayIPAddress=gatewayIPAddress, localPacketFiltering=localPacketFiltering, sNMPTrapTableIndex=sNMPTrapTableIndex, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, secureModeAlarm=secureModeAlarm, alignmentMode=alignmentMode, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, bootVersion=bootVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, minModulation=minModulation, userEnabled=userEnabled, activeUnit=activeUnit, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, iPv6PrefixLength=iPv6PrefixLength, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, phyControl=phyControl, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, radioLicenseMinModulation=radioLicenseMinModulation, userTableNumber=userTableNumber, iPv6Address=iPv6Address, management=management, neighborInternetAddress=neighborInternetAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, remoteSecondaryMACAddress=remoteSecondaryMACAddress, altitude=altitude, managementPortAutoNegotiation=managementPortAutoNegotiation, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ethernetPriorityTable=ethernetPriorityTable, sNMPTrapIPAddress=sNMPTrapIPAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, telnetAccessEnabled=telnetAccessEnabled, antennaGain=antennaGain, remotePrimaryIPAddress=remotePrimaryIPAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, requestedProtectionState=requestedProtectionState, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, sNTPServerTableNumber=sNTPServerTableNumber, sNTPPollInterval=sNTPPollInterval, pubStats=pubStats, wirelessLinkAvailability=wirelessLinkAvailability, rxDiversityVlanTpid=rxDiversityVlanTpid, sMTPEmailAlert=sMTPEmailAlert, sNMPPortNumber=sNMPPortNumber, iPVersion=iPVersion, rFUTxPowerMin=rFUTxPowerMin, diverseRfFeederLoss=diverseRfFeederLoss, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, transmitCapacity=transmitCapacity, rFUBranchingConfiguration=rFUBranchingConfiguration, transmitCapacityLimitDetail=transmitCapacityLimitDetail, secureModeAlarmTrap=secureModeAlarmTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, endId=endId, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapInternetAddress=sNMPTrapInternetAddress, transmitPower=transmitPower, rxDiversityVid=rxDiversityVid, syslogControl=syslogControl, rFUTxPowerAlarm=rFUTxPowerAlarm, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, timeZone=timeZone, managementPortForcedConfiguration=managementPortForcedConfiguration, systemReset=systemReset, rFURxFreqMax=rFURxFreqMax, rFUActiveFirmwareBank=rFUActiveFirmwareBank, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, sNTPServerTableIndex=sNTPServerTableIndex, ptpTrapPrefix=ptpTrapPrefix, unitOutOfCalibration=unitOutOfCalibration, sMTPServerPortNumber=sMTPServerPortNumber, faultProtectionSwitching=faultProtectionSwitching, receiveDataRate=receiveDataRate, hTTPSAccessEnabled=hTTPSAccessEnabled, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, licence=licence, sNTPServerResponse=sNTPServerResponse, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPLastSync=sNTPLastSync, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPServerTableEntry=sNTPServerTableEntry, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, radioLicenseRxFreq=radioLicenseRxFreq, managementMode=managementMode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, phyStatus=phyStatus, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, managementPortStatusTrap=managementPortStatusTrap, iPv4Address=iPv4Address, radioLicenseMaxModulation=radioLicenseMaxModulation, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, remotePrimaryMACAddress=remotePrimaryMACAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, protectionAvailabilityStatus=protectionAvailabilityStatus, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, remoteSecondaryIPAddress=remoteSecondaryIPAddress, rFUTxFreqMin=rFUTxFreqMin, radioLicenseBandwidth=radioLicenseBandwidth, maxModulation=maxModulation, transmitModulation=transmitModulation, alignmentModeTrap=alignmentModeTrap, wirelessLinkStatusTrap=wirelessLinkStatusTrap, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, minCodeRate=minCodeRate, rFUProtectionCompatibility=rFUProtectionCompatibility, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFUVersionBank1=rFUVersionBank1, aAAControl=aAAControl, alarms=alarms, versions=versions, userPassword=userPassword, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, productVariant=productVariant, l2CPPriorityTable=l2CPPriorityTable, rFURxFreqMin=rFURxFreqMin, sMTPSourceEmailAddress=sMTPSourceEmailAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, maxCodeRate=maxCodeRate, longitude=longitude, rFUTxMuteStatus=rFUTxMuteStatus, sNTPServerIPAddress=sNTPServerIPAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, siteName=siteName, protectionStats=protectionStats, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, subnetMask=subnetMask, vLANManagementPriority=vLANManagementPriority, sNTPState=sNTPState, dataPortWirelessDownAlert=dataPortWirelessDownAlert, primarySecondaryMode=primarySecondaryMode, remoteInternetAddressType=remoteInternetAddressType, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, vectorError=vectorError, secondarySoftwareVersion=secondarySoftwareVersion, protectionStatus=protectionStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hardwareVersion=hardwareVersion)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", linkNameMismatchTrap=linkNameMismatchTrap, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, radioLicenseMaxEIRP=radioLicenseMaxEIRP, latitude=latitude, protectionConfig=protectionConfig, rFURpsAlarm=rFURpsAlarm, rFUStatus=rFUStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, remotePrimaryInternetAddress=remotePrimaryInternetAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, ptp800=ptp800, sNTPServerInternetAddressType=sNTPServerInternetAddressType, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, neighborInternetAddressType=neighborInternetAddressType, sMTPEnabledMessages=sMTPEnabledMessages, rFFeederLoss=rFFeederLoss, aTPCEnable=aTPCEnable, tFTPServerIPAddress=tFTPServerIPAddress, dataPortStatus=dataPortStatus, rFURfBand=rFURfBand, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, receiveCodeRate=receiveCodeRate, sNTPServerTimeout=sNTPServerTimeout, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, radioLicenseMinCodeRate=radioLicenseMinCodeRate, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rFUType=rFUType, neighborIPAddress=neighborIPAddress, telnetPortNumber=telnetPortNumber, sNTPServerRetries=sNTPServerRetries, syslogStateTrap=syslogStateTrap, hTTPSPortNumber=hTTPSPortNumber, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, wirelessLinkStatus=wirelessLinkStatus, rFUTxBandAboveRx=rFUTxBandAboveRx, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, radioLicenseIdentifier=radioLicenseIdentifier, transmitterStatus=transmitterStatus, dataPortDisabledWarning=dataPortDisabledWarning, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, remoteIPAddress=remoteIPAddress, sNMPTrapTable=sNMPTrapTable, numberOfAntennas=numberOfAntennas, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, protectionSwitchCause=protectionSwitchCause, protectionInterfaceStatus=protectionInterfaceStatus, productName=productName, rFUConnectedPlatform=rFUConnectedPlatform, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerIPAddress=sMTPServerIPAddress, rFUFreqSpacing=rFUFreqSpacing, sNTPSync=sNTPSync, primaryRecoveryPeriod=primaryRecoveryPeriod, protectionConfigurationStatus=protectionConfigurationStatus, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, rfu=rfu, rFUTxPowerMax=rFUTxPowerMax, ptp=ptp, encryptionEnabledMismatch=encryptionEnabledMismatch, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, cambium=cambium, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFUPlatformCompatibility=rFUPlatformCompatibility, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapVersion=sNMPTrapVersion, rFUVersionBank2=rFUVersionBank2, protection=protection, sNTPServerPortNumber=sNTPServerPortNumber, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, protectionStateTrap=protectionStateTrap, securityLevel=securityLevel, managementPortStatus=managementPortStatus, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFULockoutAlarm=rFULockoutAlarm)
