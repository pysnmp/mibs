...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", syslogControl=syslogControl, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, remoteMACAddress=remoteMACAddress, sNTPServerRetries=sNTPServerRetries, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, vectorError=vectorError, activeWirelessLinkAvailability=activeWirelessLinkAvailability, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, snmpControl=snmpControl, unitOutOfCalibration=unitOutOfCalibration, pubStats=pubStats, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, dataPortDisabledWarning=dataPortDisabledWarning, neighborInternetAddressType=neighborInternetAddressType, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, userRole=userRole, iFCableLength=iFCableLength, rFUVersionBank1=rFUVersionBank1, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rFUPowerButtonPressed=rFUPowerButtonPressed, receivePower=receivePower, radioLicenseBand=radioLicenseBand, neighborIPAddress=neighborIPAddress, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, transmitModulation=transmitModulation, rFURxFreqMin=rFURxFreqMin, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, userEnabled=userEnabled, managementPortConfigurationMismatch=managementPortConfigurationMismatch, iPv4Address=iPv4Address, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, radioLicenseRegion=radioLicenseRegion, primarySecondaryMode=primarySecondaryMode, sNMPTrapPortNumber=sNMPTrapPortNumber, rFURxFreqMax=rFURxFreqMax, sNMPCommunityString=sNMPCommunityString, rFURFSwitchAlarm=rFURFSwitchAlarm, reset=reset, maxCodeRate=maxCodeRate, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dSCPManagementPriority=dSCPManagementPriority, rFUPlatformCompatibility=rFUPlatformCompatibility, protectionConfig=protectionConfig, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, subnetMask=subnetMask, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerTableIndex=sNTPServerTableIndex, longitude=longitude, managementPortStatus=managementPortStatus, userName=userName, endId=endId, remotePrimarySecondaryMode=remotePrimarySecondaryMode, ethernetPriorityTable=ethernetPriorityTable, securityLevel=securityLevel, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, qOSPriorityScheme=qOSPriorityScheme, transmitCodeRate=transmitCodeRate, sNMPTrapInternetAddress=sNMPTrapInternetAddress, managementPortDisabledWarning=managementPortDisabledWarning, aAAControl=aAAControl, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dataPortStatus=dataPortStatus, sNTPState=sNTPState, hTTPPortNumber=hTTPPortNumber, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPSyncTrap=sNTPSyncTrap, protectionConfigurationStatus=protectionConfigurationStatus, remoteIPAddress=remoteIPAddress, supplementary=supplementary, bootVersion=bootVersion, telnetPortNumber=telnetPortNumber, protectionStatus=protectionStatus, sNTPServerResponse=sNTPServerResponse, minModulation=minModulation, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, managementPortAutoNegotiation=managementPortAutoNegotiation, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, managementCommittedInformationRate=managementCommittedInformationRate, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, softwareVersion=softwareVersion, vLANManagementVIDValidation=vLANManagementVIDValidation, remoteSecondaryIPAddress=remoteSecondaryIPAddress, sNTPServerTimeout=sNTPServerTimeout, rFURfBand=rFURfBand, transmitDataRate=transmitDataRate, systemClock=systemClock, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sMTPServerInternetAddress=sMTPServerInternetAddress, sntp=sntp, sMTPServerIPAddress=sMTPServerIPAddress, transmitCapacityLimitDetail=transmitCapacityLimitDetail, radioLicenseMinCodeRate=radioLicenseMinCodeRate, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, timeZone=timeZone, sNMPTrapTableEntry=sNMPTrapTableEntry, maximumTransmitPower=maximumTransmitPower, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, syslogState=syslogState, radioLicenseTxFreq=radioLicenseTxFreq, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, remoteMaximumTransmitPower=remoteMaximumTransmitPower, remoteInternetAddressType=remoteInternetAddressType, dataPortStatusTrap=dataPortStatusTrap, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, userPassword=userPassword, rFUConnectedPlatform=rFUConnectedPlatform, remotePrimaryInternetAddress=remotePrimaryInternetAddress, ptmp=ptmp, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, numberOfAntennas=numberOfAntennas, radioLicense=radioLicense, iPv6PrefixLength=iPv6PrefixLength, alignmentMode=alignmentMode, sNTPPollInterval=sNTPPollInterval, hTTPAccessEnabled=hTTPAccessEnabled, transmitCapacity=transmitCapacity, rFUStatusTrap=rFUStatusTrap, phyStatus=phyStatus, wirelessLinkStatus=wirelessLinkStatus, wirelessLinkAvailability=wirelessLinkAvailability, linkName=linkName, managementPortWirelessDownAlert=managementPortWirelessDownAlert, remoteInternetAddress=remoteInternetAddress, productName=productName, rFUProtectionCompatibility=rFUProtectionCompatibility, daylightSaving=daylightSaving, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, syslogStateTrap=syslogStateTrap, rFUTxPowerMax=rFUTxPowerMax, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, vLANManagementVID=vLANManagementVID, licence=licence, sNTPServerPortNumber=sNTPServerPortNumber, alarms=alarms, sNMPTrapIPAddress=sNMPTrapIPAddress, smtp=smtp, receiveDataRate=receiveDataRate, protection=protection, remotePrimaryMACAddress=remotePrimaryMACAddress, localPacketFiltering=localPacketFiltering, protectionSwitchCause=protectionSwitchCause, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, iPv6GatewayAddress=iPv6GatewayAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rxDiversityVid=rxDiversityVid, altitude=altitude, rFUTxMuteStatus=rFUTxMuteStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, sMTPEnabledMessages=sMTPEnabledMessages, linkLoss=linkLoss, sNTPServerInternetAddress=sNTPServerInternetAddress, radioLicenseIdentifier=radioLicenseIdentifier, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, encryptionAlgorithm=encryptionAlgorithm, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, primaryRecovery=primaryRecovery, ptpTrapPrefix=ptpTrapPrefix, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptp=ptp, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, userTableIndex=userTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, rFURpsAlarm=rFURpsAlarm, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, transmitCapacityLimit=transmitCapacityLimit, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, diverseRfFeederLoss=diverseRfFeederLoss, iPv6Address=iPv6Address, management=management, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, ethernetFiberSupport=ethernetFiberSupport, dataPortFiberStatus=dataPortFiberStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, secondarySoftwareVersion=secondarySoftwareVersion, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, managementPortForcedConfiguration=managementPortForcedConfiguration, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, cambium=cambium, versions=versions, diverseAntennaGain=diverseAntennaGain, secureModeAlarmTrap=secureModeAlarmTrap, radioLicenseMinModulation=radioLicenseMinModulation, systemReset=systemReset, sNTPServerTable=sNTPServerTable, productVariant=productVariant, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, sMTPSourceEmailAddress=sMTPSourceEmailAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, receiveCodeRate=receiveCodeRate, sMTPEmailAlert=sMTPEmailAlert, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, ethernet=ethernet, sNMPPortNumber=sNMPPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userTableEntry=userTableEntry, rFUTxFreqMin=rFUTxFreqMin, bridge=bridge, primaryRecoveryPeriod=primaryRecoveryPeriod, aTPCEnable=aTPCEnable, sNTPServerTableEntry=sNTPServerTableEntry, aggregateDataRate=aggregateDataRate, rFUTxPowerAlarm=rFUTxPowerAlarm, tFTPServerPortNumber=tFTPServerPortNumber, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, sNTPSync=sNTPSync, wirelessLinkStatusTrap=wirelessLinkStatusTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ptpTraps=ptpTraps, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, rxDiversityVlanTpid=rxDiversityVlanTpid, encryption=encryption, sNTPServerInternetAddressType=sNTPServerInternetAddressType, l2CPPriorityTableNumber=l2CPPriorityTableNumber, neighborMACAddress=neighborMACAddress, radioLicenseRxFreq=radioLicenseRxFreq, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPServerTableNumber=sNTPServerTableNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetPriorityTableIndex=ethernetPriorityTableIndex, faultProtectionSwitching=faultProtectionSwitching, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, activeUnit=activeUnit, protectionAvailabilityStatus=protectionAvailabilityStatus, protectionStats=protectionStats, rFUPowerAlarm=rFUPowerAlarm, neighborInternetAddress=neighborInternetAddress, radioLicenseBandwidth=radioLicenseBandwidth, encryptionEnabledMismatch=encryptionEnabledMismatch, userTable=userTable, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, syslogClientTrap=syslogClientTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, secureModeAlarm=secureModeAlarm, linkNameMismatch=linkNameMismatch, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", hTTPSPortNumber=hTTPSPortNumber, userTableNumber=userTableNumber, protectionState=protectionState, sNMPTrapVersion=sNMPTrapVersion, configuration=configuration, dataPortPauseFrames=dataPortPauseFrames, maxModulation=maxModulation, sNTPLastSync=sNTPLastSync, protectionInterfaceStatus=protectionInterfaceStatus, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, remotePrimaryIPAddress=remotePrimaryIPAddress, rFUFreqSpacing=rFUFreqSpacing, sNMPTrapTableIndex=sNMPTrapTableIndex, phyControl=phyControl, radioLicenseModulation=radioLicenseModulation, rFUBranchingConfiguration=rFUBranchingConfiguration, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, enableTransmission=enableTransmission, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapTable=sNMPTrapTable, sNTPPrimaryServer=sNTPPrimaryServer, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFUType=rFUType, radioLicenseCodeRate=radioLicenseCodeRate, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, transmitPower=transmitPower, rfu=rfu, rFUTxBandAboveRx=rFUTxBandAboveRx, radioLicenseMaxModulation=radioLicenseMaxModulation, rFUSerial=rFUSerial, rFULockoutAlarm=rFULockoutAlarm, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, alignmentModeTrap=alignmentModeTrap, hardwareVersion=hardwareVersion, linkNameMismatchTrap=linkNameMismatchTrap, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, useVLANForManagementInterfaces=useVLANForManagementInterfaces, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFUCableAlarm=rFUCableAlarm, receiveModulation=receiveModulation, rFFeederLoss=rFFeederLoss, activeAvailableTime=activeAvailableTime, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, gatewayIPAddress=gatewayIPAddress, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, latitude=latitude, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, requestedProtectionState=requestedProtectionState, antennaGain=antennaGain, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, transmitterStatus=transmitterStatus, rFUTxFreqMax=rFUTxFreqMax, protectionStateTrap=protectionStateTrap, iPVersion=iPVersion, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFUVersionBank2=rFUVersionBank2, vLANManagementPriority=vLANManagementPriority, rFUActiveFirmwareBank=rFUActiveFirmwareBank, hTTPSAccessEnabled=hTTPSAccessEnabled, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sMTPServerInternetAddressType=sMTPServerInternetAddressType, telnetAccessEnabled=telnetAccessEnabled, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, rFUStatus=rFUStatus, fiberY=fiberY, rFUTxPowerMin=rFUTxPowerMin, sNTPServerIPAddress=sNTPServerIPAddress, ptp800=ptp800, tFTPServerIPAddress=tFTPServerIPAddress, managementPortStatusTrap=managementPortStatusTrap, minCodeRate=minCodeRate, syslogClient=syslogClient, managementMode=managementMode, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, tFTPServerInternetAddress=tFTPServerInternetAddress, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rFUTransceiverLocation=rFUTransceiverLocation, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, siteName=siteName, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, l2CPPriorityTable=l2CPPriorityTable)
