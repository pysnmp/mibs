...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", neighborInternetAddressType=neighborInternetAddressType, requestedProtectionState=requestedProtectionState, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, sNTPServerTableEntry=sNTPServerTableEntry, neighborInternetAddress=neighborInternetAddress, alignmentModeTrap=alignmentModeTrap, fiberY=fiberY, protectionConfigurationStatus=protectionConfigurationStatus, userEnabled=userEnabled, unitOutOfCalibration=unitOutOfCalibration, vLANManagementVID=vLANManagementVID, rFFeederLoss=rFFeederLoss, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rFUPlatformCompatibility=rFUPlatformCompatibility, rFUTxFreqMax=rFUTxFreqMax, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, protectionSwitchCause=protectionSwitchCause, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPPollInterval=sNTPPollInterval, diverseRfFeederLoss=diverseRfFeederLoss, hTTPAccessEnabled=hTTPAccessEnabled, iPv6Address=iPv6Address, faultProtectionSwitching=faultProtectionSwitching, primarySecondaryMode=primarySecondaryMode, iFCableLength=iFCableLength, encryption=encryption, managementPortAutoNegotiation=managementPortAutoNegotiation, rxDiversityVid=rxDiversityVid, sNTPPrimaryServer=sNTPPrimaryServer, rxDiversityVlanTpid=rxDiversityVlanTpid, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, activeWirelessLinkAvailability=activeWirelessLinkAvailability, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, receiveCodeRate=receiveCodeRate, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rFURxFreqMin=rFURxFreqMin, wirelessLinkAvailability=wirelessLinkAvailability, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, numberOfAntennas=numberOfAntennas, productName=productName, minCodeRate=minCodeRate, longitude=longitude, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapTable=sNMPTrapTable, maximumTransmitPower=maximumTransmitPower, ptp=ptp, sNMPTrapTableIndex=sNMPTrapTableIndex, alignmentMode=alignmentMode, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, snmpControl=snmpControl, radioLicense=radioLicense, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, secondarySoftwareVersion=secondarySoftwareVersion, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveModulation=receiveModulation, syslogState=syslogState, alarms=alarms, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, userTable=userTable, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, protectionStatus=protectionStatus, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, sNMPCommunityString=sNMPCommunityString, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, activeUnit=activeUnit, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, remotePrimaryMACAddress=remotePrimaryMACAddress, iPVersion=iPVersion, rFUPowerAlarm=rFUPowerAlarm, daylightSaving=daylightSaving, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, enableTransmission=enableTransmission, managementPortDisabledWarning=managementPortDisabledWarning, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, maxCodeRate=maxCodeRate, hardwareVersion=hardwareVersion, sNMPTrapVersion=sNMPTrapVersion, rFUVersionBank2=rFUVersionBank2, neighborMACAddress=neighborMACAddress, radioLicenseMaxEIRP=radioLicenseMaxEIRP, sMTPServerIPAddress=sMTPServerIPAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, managementPortForcedConfiguration=managementPortForcedConfiguration, transmitPower=transmitPower, diverseAntennaGain=diverseAntennaGain, linkLoss=linkLoss, mPLSTCPriorityTable=mPLSTCPriorityTable, rFURpsAlarm=rFURpsAlarm, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, remoteInternetAddress=remoteInternetAddress, protection=protection, protectionConfig=protectionConfig, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sntp=sntp, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, encryptionEnabledMismatch=encryptionEnabledMismatch, sNTPServerTable=sNTPServerTable, managementPortStatus=managementPortStatus, ptpTraps=ptpTraps, protectionState=protectionState, versions=versions, sNTPServerIPAddress=sNTPServerIPAddress, sNTPState=sNTPState, protectionStateTrap=protectionStateTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, transmitCodeRate=transmitCodeRate, syslogClientTrap=syslogClientTrap, gatewayIPAddress=gatewayIPAddress, remoteInternetAddressType=remoteInternetAddressType, wirelessLinkStatusTrap=wirelessLinkStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userName=userName, transmitCapacityLimitDetail=transmitCapacityLimitDetail, bridge=bridge, aTPCEnable=aTPCEnable, sNTPServerResponse=sNTPServerResponse, subnetMask=subnetMask, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, remotePrimaryIPAddress=remotePrimaryIPAddress, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, primaryRecoveryPeriod=primaryRecoveryPeriod, vLANManagementPriority=vLANManagementPriority, neighborIPAddress=neighborIPAddress, licence=licence, radioLicenseBandwidth=radioLicenseBandwidth, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rFUTxPowerAlarm=rFUTxPowerAlarm, linkNameMismatch=linkNameMismatch, transmitModulation=transmitModulation, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, receivePower=receivePower, localPacketFiltering=localPacketFiltering, telnetAccessEnabled=telnetAccessEnabled, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, transmitCapacityLimit=transmitCapacityLimit, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, secureModeAlarmTrap=secureModeAlarmTrap, iPv6PrefixLength=iPv6PrefixLength, dataPortFiberStatus=dataPortFiberStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rFUVersionBank1=rFUVersionBank1, rFUConnectedPlatform=rFUConnectedPlatform, management=management, ptpTrapPrefix=ptpTrapPrefix, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, aAAControl=aAAControl, sNMPTrapTableNumber=sNMPTrapTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFUProtectionCompatibility=rFUProtectionCompatibility, antennaGain=antennaGain, sNTPServerTimeout=sNTPServerTimeout, sNMPTrapTableEntry=sNMPTrapTableEntry, reset=reset, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, transmitDataRate=transmitDataRate, endId=endId, sMTPServerPortNumber=sMTPServerPortNumber, sMTPEmailAlert=sMTPEmailAlert, sMTPEnabledMessages=sMTPEnabledMessages, rFUBranchingConfiguration=rFUBranchingConfiguration, rFUTransceiverLocation=rFUTransceiverLocation, timeZone=timeZone, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerTableIndex=sNTPServerTableIndex, aggregateDataRate=aggregateDataRate, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFUStatus=rFUStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, radioLicenseBand=radioLicenseBand, rFUStatusTrap=rFUStatusTrap, radioLicenseIdentifier=radioLicenseIdentifier, userTableEntry=userTableEntry, systemReset=systemReset, remoteSecondaryIPAddress=remoteSecondaryIPAddress, rFUTxPowerMax=rFUTxPowerMax, sMTPServerInternetAddress=sMTPServerInternetAddress, siteName=siteName, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, pubStats=pubStats, rFUTxBandAboveRx=rFUTxBandAboveRx, latitude=latitude, remoteIPAddress=remoteIPAddress, sNTPServerRetries=sNTPServerRetries, sMTPSourceEmailAddress=sMTPSourceEmailAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sNTPServerTableNumber=sNTPServerTableNumber, syslogStateTrap=syslogStateTrap, systemClock=systemClock, rFUTxFreqMin=rFUTxFreqMin, vLANManagementVIDValidation=vLANManagementVIDValidation, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, radioLicenseCodeRate=radioLicenseCodeRate, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, tFTPServerInternetAddress=tFTPServerInternetAddress, managementCommittedInformationRate=managementCommittedInformationRate, vectorError=vectorError, ptmp=ptmp, dataPortStatus=dataPortStatus, userTableNumber=userTableNumber, wirelessLinkStatus=wirelessLinkStatus, productVariant=productVariant, managementMode=managementMode, sNMPTrapPortNumber=sNMPTrapPortNumber, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rFUPowerButtonPressed=rFUPowerButtonPressed, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, cambium=cambium, sNTPLastSync=sNTPLastSync, qOSPriorityScheme=qOSPriorityScheme, securityLevel=securityLevel, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rFUCableAlarm=rFUCableAlarm, rFUTxPowerMin=rFUTxPowerMin, hTTPPortNumber=hTTPPortNumber, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, ptp800=ptp800, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rFUFreqSpacing=rFUFreqSpacing, syslogControl=syslogControl, protectionStats=protectionStats, sNTPSync=sNTPSync, rFUTxMuteStatus=rFUTxMuteStatus, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, sNTPSyncTrap=sNTPSyncTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rFUActiveFirmwareBank=rFUActiveFirmwareBank, radioLicenseMinCodeRate=radioLicenseMinCodeRate, activeAvailableTime=activeAvailableTime, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, sNTPServerPortNumber=sNTPServerPortNumber, rFUSerial=rFUSerial, remoteMACAddress=remoteMACAddress, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, remoteSecondaryMACAddress=remoteSecondaryMACAddress, minModulation=minModulation, userPassword=userPassword, radioLicenseTxFreq=radioLicenseTxFreq, iPv6GatewayAddress=iPv6GatewayAddress, rFULockoutAlarm=rFULockoutAlarm, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, radioLicenseRxFreq=radioLicenseRxFreq, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetPriorityTable=ethernetPriorityTable, radioLicenseRegion=radioLicenseRegion, protectionInterfaceStatus=protectionInterfaceStatus, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, dataPortStatusTrap=dataPortStatusTrap, userRole=userRole, radioLicenseMinModulation=radioLicenseMinModulation, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, dataPortFiberStatusTrap=dataPortFiberStatusTrap, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, hTTPSPortNumber=hTTPSPortNumber, managementPortStatusTrap=managementPortStatusTrap, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, maxModulation=maxModulation, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dSCPManagementPriority=dSCPManagementPriority, rFURxFreqMax=rFURxFreqMax, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, supplementary=supplementary, secureModeAlarm=secureModeAlarm, dataPortDisabledWarning=dataPortDisabledWarning, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, rfu=rfu, primaryRecovery=primaryRecovery, phyStatus=phyStatus, phyControl=phyControl, telnetPortNumber=telnetPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rFURfBand=rFURfBand, smtp=smtp, dataPortPauseFrames=dataPortPauseFrames, altitude=altitude, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, tFTPServerPortNumber=tFTPServerPortNumber, rFUType=rFUType, iPv4Address=iPv4Address, ethernet=ethernet, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, syslogClient=syslogClient, linkNameMismatchTrap=linkNameMismatchTrap, ethernetFiberSupport=ethernetFiberSupport, bootVersion=bootVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitterStatus=transmitterStatus, remotePrimarySecondaryMode=remotePrimarySecondaryMode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, radioLicenseMaxModulation=radioLicenseMaxModulation, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, userTableIndex=userTableIndex, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, remotePrimaryInternetAddress=remotePrimaryInternetAddress, radioLicenseModulation=radioLicenseModulation, sNMPPortNumber=sNMPPortNumber, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rFURFSwitchAlarm=rFURFSwitchAlarm, receiveDataRate=receiveDataRate, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkName=linkName, protectionAvailabilityStatus=protectionAvailabilityStatus, transmitCapacity=transmitCapacity, configuration=configuration, softwareVersion=softwareVersion, l2CPPriorityTable=l2CPPriorityTable)
