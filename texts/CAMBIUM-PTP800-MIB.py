...
TimeTicks, NotificationType, ObjectIdentity, Counter64, Bits, ModuleIdentity, Unsigned32, IpAddress, NotificationType, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "ObjectIdentity", "Counter64", "Bits", "ModuleIdentity", "Unsigned32", "IpAddress", "NotificationType", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "enterprises", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", transmitCapacity=transmitCapacity, sNTPState=sNTPState, licence=licence, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, secureModeAlarm=secureModeAlarm, sNTPServerResponse=sNTPServerResponse, iPv4Address=iPv4Address, sMTPServerIPAddress=sMTPServerIPAddress, rFUTxBandAboveRx=rFUTxBandAboveRx, configuration=configuration, radioLicenseMinModulation=radioLicenseMinModulation, siteName=siteName, rFUStatus=rFUStatus, timeZone=timeZone, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, radioLicenseMaxModulation=radioLicenseMaxModulation, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userTableIndex=userTableIndex, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUBranchingConfiguration=rFUBranchingConfiguration, secureModeAlarmTrap=secureModeAlarmTrap, wirelessLinkStatus=wirelessLinkStatus, softwareVersion=softwareVersion, dSCPManagementPriority=dSCPManagementPriority, enableTransmission=enableTransmission, maximumTransmitPower=maximumTransmitPower, protectionState=protectionState, managementPortDisabledWarning=managementPortDisabledWarning, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rFUPowerButtonPressed=rFUPowerButtonPressed, sNMPTrapIPAddress=sNMPTrapIPAddress, protectionConfigurationStatus=protectionConfigurationStatus, remoteSecondaryIPAddress=remoteSecondaryIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, l2CPPriorityTableNumber=l2CPPriorityTableNumber, radioLicenseRegion=radioLicenseRegion, latitude=latitude, userTableNumber=userTableNumber, snmpControl=snmpControl, wirelessLinkAvailability=wirelessLinkAvailability, managementPortAutoNegotiation=managementPortAutoNegotiation, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, rFUTransceiverLocation=rFUTransceiverLocation, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rFUTxFreqMin=rFUTxFreqMin, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, hardwareVersion=hardwareVersion, rFUPlatformCompatibility=rFUPlatformCompatibility, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortPauseFrames=dataPortPauseFrames, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, ethernetPriorityTable=ethernetPriorityTable, aTPCEnable=aTPCEnable, pubStats=pubStats, systemClock=systemClock, smtp=smtp, ethernet=ethernet, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rfu=rfu, sNTPLastSync=sNTPLastSync, remoteIPAddress=remoteIPAddress, alignmentMode=alignmentMode, receiveCodeRate=receiveCodeRate, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, sNTPSyncTrap=sNTPSyncTrap, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, remoteSecondaryMACAddress=remoteSecondaryMACAddress, ptp=ptp, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, radioLicenseBandwidth=radioLicenseBandwidth, protectionStateTrap=protectionStateTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, numberOfAntennas=numberOfAntennas, receivePower=receivePower, neighborInternetAddressType=neighborInternetAddressType, rFUTxPowerMin=rFUTxPowerMin, syslogState=syslogState, primaryRecoveryPeriod=primaryRecoveryPeriod, userName=userName, protectionInterfaceStatus=protectionInterfaceStatus, securityLevel=securityLevel, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, productName=productName, minModulation=minModulation, faultProtectionSwitching=faultProtectionSwitching, rFUVersionBank1=rFUVersionBank1, vLANManagementVIDValidation=vLANManagementVIDValidation, syslogClientTrap=syslogClientTrap, neighborInternetAddress=neighborInternetAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, daylightSaving=daylightSaving, rFULockoutAlarm=rFULockoutAlarm, longitude=longitude, sNMPPortNumber=sNMPPortNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPServerIPAddress=sNTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPServerRetries=sNTPServerRetries, linkName=linkName, iPDSCPPriorityTable=iPDSCPPriorityTable, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortFiberStatus=dataPortFiberStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rxDiversityVlanTpid=rxDiversityVlanTpid, radioLicenseTxFreq=radioLicenseTxFreq, radioLicense=radioLicense, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rFUTxPowerMax=rFUTxPowerMax, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, transmitterStatus=transmitterStatus, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, sNMPCommunityString=sNMPCommunityString, rFUTxPowerAlarm=rFUTxPowerAlarm, userTableEntry=userTableEntry, ethernetFiberSupport=ethernetFiberSupport, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitCapacityLimit=transmitCapacityLimit, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, rFUCableAlarm=rFUCableAlarm, linkNameMismatch=linkNameMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, radioLicenseMinCodeRate=radioLicenseMinCodeRate, protectionStats=protectionStats, encryption=encryption, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUStatusTrap=rFUStatusTrap, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, transmitCapacityLimitDetail=transmitCapacityLimitDetail, sNTPPollInterval=sNTPPollInterval, dataPortWirelessDownAlert=dataPortWirelessDownAlert, activeWirelessLinkAvailability=activeWirelessLinkAvailability, iPv6GatewayAddress=iPv6GatewayAddress, syslogClient=syslogClient, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, userEnabled=userEnabled, neighborMACAddress=neighborMACAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sMTPEnabledMessages=sMTPEnabledMessages, userPassword=userPassword, receiveModulation=receiveModulation, vLANManagementPriority=vLANManagementPriority, sntp=sntp, managementPortStatus=managementPortStatus, ptpTrapPrefix=ptpTrapPrefix, bridge=bridge, remotePrimaryInternetAddress=remotePrimaryInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, maxModulation=maxModulation, subnetMask=subnetMask, alignmentModeTrap=alignmentModeTrap, protectionSwitchCause=protectionSwitchCause, syslogControl=syslogControl, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, iPVersion=iPVersion, diverseRfFeederLoss=diverseRfFeederLoss, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, sNMPTrapTableEntry=sNMPTrapTableEntry, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, mPLSTCPriorityTable=mPLSTCPriorityTable, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, primaryRecovery=primaryRecovery, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, rFURFSwitchAlarm=rFURFSwitchAlarm, sMTPServerInternetAddressType=sMTPServerInternetAddressType, encryptionAlgorithm=encryptionAlgorithm, rFUActiveFirmwareBank=rFUActiveFirmwareBank, management=management, minCodeRate=minCodeRate, hTTPAccessEnabled=hTTPAccessEnabled, transmitDataRate=transmitDataRate, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, cambium=cambium, reset=reset, ptpTraps=ptpTraps, sMTPSourceEmailAddress=sMTPSourceEmailAddress, wirelessLinkStatusTrap=wirelessLinkStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, radioLicenseBand=radioLicenseBand, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, l2CPPriorityTable=l2CPPriorityTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, transmitPower=transmitPower, hTTPSAccessEnabled=hTTPSAccessEnabled, l2CPPriorityTableEntry=l2CPPriorityTableEntry, diverseAntennaGain=diverseAntennaGain, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, vectorError=vectorError, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, linkLoss=linkLoss, transmitCodeRate=transmitCodeRate, aggregateDataRate=aggregateDataRate, rFUVersionBank2=rFUVersionBank2, sNMPTrapTableIndex=sNMPTrapTableIndex, ptp800=ptp800, sNTPServerTable=sNTPServerTable, neighborIPAddress=neighborIPAddress, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, hTTPPortNumber=hTTPPortNumber, localPacketFiltering=localPacketFiltering, activeAvailableTime=activeAvailableTime, managementPortStatusTrap=managementPortStatusTrap, iFCableLength=iFCableLength, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, phyControl=phyControl, tFTPServerInternetAddress=tFTPServerInternetAddress, radioLicenseRxFreq=radioLicenseRxFreq, dataPortDisabledWarning=dataPortDisabledWarning, rFFeederLoss=rFFeederLoss, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFUFreqSpacing=rFUFreqSpacing, remoteInternetAddressType=remoteInternetAddressType, sNTPServerPortNumber=sNTPServerPortNumber, rFUTxFreqMax=rFUTxFreqMax, antennaGain=antennaGain, ptmp=ptmp, rFUPowerAlarm=rFUPowerAlarm, dataPortStatusTrap=dataPortStatusTrap, vLANManagementVID=vLANManagementVID, rFUSerial=rFUSerial, rFURfBand=rFURfBand, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, endId=endId, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, iPv6Address=iPv6Address, remoteInternetAddress=remoteInternetAddress, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, qOSPriorityScheme=qOSPriorityScheme, radioLicenseCodeRate=radioLicenseCodeRate, unitOutOfCalibration=unitOutOfCalibration, radioLicenseIdentifier=radioLicenseIdentifier, requestedProtectionState=requestedProtectionState, encryptionEnabledMismatch=encryptionEnabledMismatch, sMTPEmailAlert=sMTPEmailAlert, protectionAvailabilityStatus=protectionAvailabilityStatus, rFUConnectedPlatform=rFUConnectedPlatform, dataPortStatus=dataPortStatus, iPv6PrefixLength=iPv6PrefixLength, remotePrimaryIPAddress=remotePrimaryIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rFURxFreqMin=rFURxFreqMin, sNTPSync=sNTPSync, supplementary=supplementary, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerTableEntry=sNTPServerTableEntry, bootVersion=bootVersion, rFUProtectionCompatibility=rFUProtectionCompatibility, hTTPSPortNumber=hTTPSPortNumber, protectionConfig=protectionConfig, systemReset=systemReset, remotePrimarySecondaryMode=remotePrimarySecondaryMode, remoteMACAddress=remoteMACAddress, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, receiveDataRate=receiveDataRate, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPEnabledTraps=sNMPEnabledTraps, fiberY=fiberY, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPPrimaryServer=sNTPPrimaryServer, radioLicenseModulation=radioLicenseModulation, remotePrimaryMACAddress=remotePrimaryMACAddress, telnetPortNumber=telnetPortNumber, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementMode=managementMode, managementPortForcedConfiguration=managementPortForcedConfiguration, rxDiversityVid=rxDiversityVid, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, transmitModulation=transmitModulation, sNTPServerTableIndex=sNTPServerTableIndex, linkNameMismatchTrap=linkNameMismatchTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, aAAControl=aAAControl, userRole=userRole, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, protectionStatus=protectionStatus, rFUTxMuteStatus=rFUTxMuteStatus, syslogStateTrap=syslogStateTrap, activeUnit=activeUnit, sNTPServerTableNumber=sNTPServerTableNumber, protection=protection, alarms=alarms, sMTPServerInternetAddress=sMTPServerInternetAddress, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, productVariant=productVariant, syslogLocalWrappedTrap=syslogLocalWrappedTrap, primarySecondaryMode=primarySecondaryMode, rFURxFreqMax=rFURxFreqMax, altitude=altitude, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, versions=versions, telnetAccessEnabled=telnetAccessEnabled, userTable=userTable, sNTPServerTimeout=sNTPServerTimeout, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFURpsAlarm=rFURpsAlarm, maxCodeRate=maxCodeRate, managementCommittedInformationRate=managementCommittedInformationRate, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, tFTPServerPortNumber=tFTPServerPortNumber, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, gatewayIPAddress=gatewayIPAddress, rFUType=rFUType, phyStatus=phyStatus)
