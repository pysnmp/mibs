...
NotificationType, Counter32, TimeTicks, Gauge32, Unsigned32, NotificationType, iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Bits, enterprises, Integer32, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "TimeTicks", "Gauge32", "Unsigned32", "NotificationType", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Bits", "enterprises", "Integer32", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", radioLicenseMaxEIRP=radioLicenseMaxEIRP, receiveCodeRate=receiveCodeRate, remotePrimaryIPAddress=remotePrimaryIPAddress, subnetMask=subnetMask, dataPortPauseFrames=dataPortPauseFrames, receivePower=receivePower, wirelessLinkStatus=wirelessLinkStatus, encryptionAlgorithm=encryptionAlgorithm, primarySecondaryMode=primarySecondaryMode, configuration=configuration, iPv6PrefixLength=iPv6PrefixLength, radioLicenseMinModulation=radioLicenseMinModulation, dataPortStatus=dataPortStatus, managementMode=managementMode, transmitterStatus=transmitterStatus, managementPortForcedConfiguration=managementPortForcedConfiguration, rFUTxPowerMin=rFUTxPowerMin, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, userTable=userTable, linkName=linkName, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNMPPortNumber=sNMPPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, encryptionEnabledMismatch=encryptionEnabledMismatch, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPPollInterval=sNTPPollInterval, rFURFSwitchAlarm=rFURFSwitchAlarm, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, remoteIPAddress=remoteIPAddress, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, remoteSecondaryMACAddress=remoteSecondaryMACAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkLoss=linkLoss, activeAvailableTime=activeAvailableTime, managementPortStatus=managementPortStatus, sNTPServerTableNumber=sNTPServerTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, useVLANForManagementInterfaces=useVLANForManagementInterfaces, longitude=longitude, rFUTxFreqMin=rFUTxFreqMin, cambium=cambium, remoteInternetAddressType=remoteInternetAddressType, rFUSerial=rFUSerial, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rFUTxFreqMax=rFUTxFreqMax, numberOfAntennas=numberOfAntennas, transmitCapacityLimit=transmitCapacityLimit, ethernetPriorityTableEntry=ethernetPriorityTableEntry, neighborInternetAddress=neighborInternetAddress, fiberY=fiberY, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, userEnabled=userEnabled, tFTPServerIPAddress=tFTPServerIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, enableTransmission=enableTransmission, snmpControl=snmpControl, securityLevel=securityLevel, linkNameMismatch=linkNameMismatch, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rFUPlatformCompatibility=rFUPlatformCompatibility, vLANManagementVIDValidation=vLANManagementVIDValidation, receiveModulation=receiveModulation, endId=endId, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, sNMPEnabledTraps=sNMPEnabledTraps, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sNTPServerRetries=sNTPServerRetries, dataPortStatusTrap=dataPortStatusTrap, vLANManagementVID=vLANManagementVID, gatewayIPAddress=gatewayIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPv6GatewayAddress=iPv6GatewayAddress, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, wirelessLinkAvailability=wirelessLinkAvailability, tFTPServerPortNumber=tFTPServerPortNumber, bridge=bridge, syslogClient=syslogClient, remoteMACAddress=remoteMACAddress, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, sNTPServerIPAddress=sNTPServerIPAddress, ethernetPriorityTable=ethernetPriorityTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, protection=protection, rFURxFreqMin=rFURxFreqMin, remotePrimaryInternetAddress=remotePrimaryInternetAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, syslogStateTrap=syslogStateTrap, sNTPServerPortNumber=sNTPServerPortNumber, rxDiversityVlanTpid=rxDiversityVlanTpid, tFTPServerInternetAddress=tFTPServerInternetAddress, transmitCapacityLimitDetail=transmitCapacityLimitDetail, encryption=encryption, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, alignmentModeTrap=alignmentModeTrap, rxDiversityVid=rxDiversityVid, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, transmitDataRate=transmitDataRate, protectionStateTrap=protectionStateTrap, secondarySoftwareVersion=secondarySoftwareVersion, rFUPowerButtonPressed=rFUPowerButtonPressed, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, hTTPAccessEnabled=hTTPAccessEnabled, iPv6Address=iPv6Address, iPVersion=iPVersion, systemClock=systemClock, sNMPTrapTableNumber=sNMPTrapTableNumber, rFFeederLoss=rFFeederLoss, ethernet=ethernet, rFUTxBandAboveRx=rFUTxBandAboveRx, rFUTransceiverLocation=rFUTransceiverLocation, managementCommittedInformationRate=managementCommittedInformationRate, antennaGain=antennaGain, receiveDataRate=receiveDataRate, telnetAccessEnabled=telnetAccessEnabled, maxCodeRate=maxCodeRate, sNTPLastSync=sNTPLastSync, rFUTxPowerAlarm=rFUTxPowerAlarm, userTableEntry=userTableEntry, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, userPassword=userPassword, managementPortStatusTrap=managementPortStatusTrap, phyControl=phyControl, neighborMACAddress=neighborMACAddress, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rFULockoutAlarm=rFULockoutAlarm, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, managementPortDisabledWarning=managementPortDisabledWarning, neighborIPAddress=neighborIPAddress, minModulation=minModulation, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, transmitModulation=transmitModulation, faultProtectionSwitching=faultProtectionSwitching, sntp=sntp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, protectionStatus=protectionStatus, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, aggregateDataRate=aggregateDataRate, protectionConfig=protectionConfig, rFUTxPowerMax=rFUTxPowerMax, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapTable=sNMPTrapTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, sNMPTrapIPAddress=sNMPTrapIPAddress, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFUConnectedPlatform=rFUConnectedPlatform, ethernetPriorityTableIndex=ethernetPriorityTableIndex, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, sNTPServerResponse=sNTPServerResponse, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rFUVersionBank2=rFUVersionBank2, iPDSCPPriorityTable=iPDSCPPriorityTable, sMTPEnabledMessages=sMTPEnabledMessages, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, aAAControl=aAAControl, maxModulation=maxModulation, transmitCapacity=transmitCapacity, radioLicenseMaxModulation=radioLicenseMaxModulation, radioLicenseCodeRate=radioLicenseCodeRate, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, unitOutOfCalibration=unitOutOfCalibration, ptmp=ptmp, iFCableLength=iFCableLength, userName=userName, secureModeAlarmTrap=secureModeAlarmTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFUStatusTrap=rFUStatusTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, alarms=alarms, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, smtp=smtp, sNTPServerTableIndex=sNTPServerTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, aTPCEnable=aTPCEnable, licence=licence, dataPortFiberStatus=dataPortFiberStatus, rFUPowerAlarm=rFUPowerAlarm, activeUnit=activeUnit, ethernetFiberSupport=ethernetFiberSupport, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, syslogClientTrap=syslogClientTrap, sMTPServerPortNumber=sMTPServerPortNumber, primaryRecoveryPeriod=primaryRecoveryPeriod, ptp800=ptp800, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, secureModeAlarm=secureModeAlarm, vectorError=vectorError, softwareVersion=softwareVersion, hardwareVersion=hardwareVersion, sNTPServerTableEntry=sNTPServerTableEntry, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, sNTPPrimaryServer=sNTPPrimaryServer, sNTPSyncTrap=sNTPSyncTrap, rxDiversityDataPortStatus=rxDiversityDataPortStatus, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, management=management, radioLicenseTxFreq=radioLicenseTxFreq, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, requestedProtectionState=requestedProtectionState, sNMPTrapTableIndex=sNMPTrapTableIndex, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, radioLicenseModulation=radioLicenseModulation, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, sMTPServerIPAddress=sMTPServerIPAddress, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, l2CPPriorityTableEntry=l2CPPriorityTableEntry, transmitPower=transmitPower, supplementary=supplementary, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, latitude=latitude, protectionSwitchCause=protectionSwitchCause, primaryRecovery=primaryRecovery, alignmentMode=alignmentMode, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPCommunityString=sNMPCommunityString, radioLicenseRegion=radioLicenseRegion, phyStatus=phyStatus, telnetPortNumber=telnetPortNumber, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, ptp=ptp, protectionAvailabilityStatus=protectionAvailabilityStatus, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, radioLicenseRxFreq=radioLicenseRxFreq, protectionConfigurationStatus=protectionConfigurationStatus, dSCPManagementPriority=dSCPManagementPriority, remotePrimaryMACAddress=remotePrimaryMACAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapVersion=sNMPTrapVersion, radioLicenseBandwidth=radioLicenseBandwidth, diverseRfFeederLoss=diverseRfFeederLoss, iPv4Address=iPv4Address, siteName=siteName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUStatus=rFUStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rFUCableAlarm=rFUCableAlarm, radioLicenseIdentifier=radioLicenseIdentifier, protectionStats=protectionStats, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, timeZone=timeZone, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remoteInternetAddress=remoteInternetAddress, radioLicense=radioLicense, altitude=altitude, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rFUFreqSpacing=rFUFreqSpacing, rFURfBand=rFURfBand, rFUVersionBank1=rFUVersionBank1, productVariant=productVariant, protectionState=protectionState, sMTPEmailAlert=sMTPEmailAlert, rFURxFreqMax=rFURxFreqMax, transmitCodeRate=transmitCodeRate, daylightSaving=daylightSaving, mPLSTCPriorityTable=mPLSTCPriorityTable, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, rfu=rfu, radioLicenseBand=radioLicenseBand, vLANManagementPriority=vLANManagementPriority, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, productName=productName, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, remotePrimarySecondaryMode=remotePrimarySecondaryMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rFURpsAlarm=rFURpsAlarm, rFUTxMuteStatus=rFUTxMuteStatus, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, neighborInternetAddressType=neighborInternetAddressType, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, l2CPPriorityTable=l2CPPriorityTable, syslogControl=syslogControl, sMTPServerInternetAddress=sMTPServerInternetAddress, versions=versions, sMTPServerInternetAddressType=sMTPServerInternetAddressType, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userRole=userRole, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerTimeout=sNTPServerTimeout, minCodeRate=minCodeRate, diverseAntennaGain=diverseAntennaGain, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rFUBranchingConfiguration=rFUBranchingConfiguration, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, sNTPSync=sNTPSync, sNTPServerTable=sNTPServerTable, sNMPTrapInternetAddress=sNMPTrapInternetAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpTrapPrefix=ptpTrapPrefix, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, protectionInterfaceStatus=protectionInterfaceStatus, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, syslogState=syslogState, dataPortDisabledWarning=dataPortDisabledWarning, pubStats=pubStats, sNTPServerInternetAddress=sNTPServerInternetAddress, userTableNumber=userTableNumber, rFUType=rFUType, managementPortAutoNegotiation=managementPortAutoNegotiation, localPacketFiltering=localPacketFiltering, userTableIndex=userTableIndex, ptpTraps=ptpTraps, sNTPState=sNTPState, linkNameMismatchTrap=linkNameMismatchTrap, activeWirelessLinkAvailability=activeWirelessLinkAvailability, reset=reset, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, qOSPriorityScheme=qOSPriorityScheme, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, remoteSecondaryIPAddress=remoteSecondaryIPAddress, rFUProtectionCompatibility=rFUProtectionCompatibility, systemReset=systemReset, maximumTransmitPower=maximumTransmitPower, bootVersion=bootVersion)
