...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, altitude=altitude, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapTableEntry=sNMPTrapTableEntry, rFUTxPowerAlarm=rFUTxPowerAlarm, tFTPServerInternetAddressType=tFTPServerInternetAddressType, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, dataPortDisabledWarning=dataPortDisabledWarning, userRole=userRole, activeAvailableTime=activeAvailableTime, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, diverseAntennaGain=diverseAntennaGain, sNTPPollInterval=sNTPPollInterval, wirelessLinkStatus=wirelessLinkStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, remotePrimarySecondaryMode=remotePrimarySecondaryMode, userTableEntry=userTableEntry, aAAControl=aAAControl, telnetPortNumber=telnetPortNumber, radioLicenseRegion=radioLicenseRegion, ethernetPriorityTableEntry=ethernetPriorityTableEntry, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFUProtectionCompatibility=rFUProtectionCompatibility, management=management, receiveCodeRate=receiveCodeRate, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, telnetAccessEnabled=telnetAccessEnabled, sMTPServerIPAddress=sMTPServerIPAddress, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, pubStats=pubStats, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, protectionStats=protectionStats, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, radioLicenseIdentifier=radioLicenseIdentifier, sNMPTrapInternetAddress=sNMPTrapInternetAddress, hTTPSPortNumber=hTTPSPortNumber, sNTPServerTableEntry=sNTPServerTableEntry, vLANManagementVID=vLANManagementVID, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, userEnabled=userEnabled, remotePrimaryMACAddress=remotePrimaryMACAddress, securityLevel=securityLevel, transmitCodeRate=transmitCodeRate, localPacketFiltering=localPacketFiltering, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userTableIndex=userTableIndex, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, neighborInternetAddressType=neighborInternetAddressType, dataPortConfigurationMismatch=dataPortConfigurationMismatch, primaryRecoveryPeriod=primaryRecoveryPeriod, wirelessLinkStatusTrap=wirelessLinkStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, licence=licence, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, latitude=latitude, sNTPServerIPAddress=sNTPServerIPAddress, managementPortStatus=managementPortStatus, neighborMACAddress=neighborMACAddress, rFUTxFreqMin=rFUTxFreqMin, rFUStatus=rFUStatus, dataPortStatus=dataPortStatus, radioLicenseRxFreq=radioLicenseRxFreq, rFURFSwitchAlarm=rFURFSwitchAlarm, transmitCapacityLimitDetail=transmitCapacityLimitDetail, smtp=smtp, rFUCableAlarm=rFUCableAlarm, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, encryption=encryption, radioLicenseMaxEIRP=radioLicenseMaxEIRP, receivePower=receivePower, aggregateDataRate=aggregateDataRate, sNTPServerTimeout=sNTPServerTimeout, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, activeWirelessLinkAvailability=activeWirelessLinkAvailability, diverseRfFeederLoss=diverseRfFeederLoss, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, managementPortDisabledWarning=managementPortDisabledWarning, rFUTxBandAboveRx=rFUTxBandAboveRx, sNTPSyncTrap=sNTPSyncTrap, minModulation=minModulation, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, linkName=linkName, l2CPPriorityTable=l2CPPriorityTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ptpTraps=ptpTraps, maximumTransmitPower=maximumTransmitPower, sNTPServerPortNumber=sNTPServerPortNumber, sNTPServerTable=sNTPServerTable, sntp=sntp, linkNameMismatchTrap=linkNameMismatchTrap, remoteInternetAddressType=remoteInternetAddressType, sNTPServerRetries=sNTPServerRetries, phyStatus=phyStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUBranchingConfiguration=rFUBranchingConfiguration, protectionSwitchCause=protectionSwitchCause, rFUFreqSpacing=rFUFreqSpacing, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, protectionStatus=protectionStatus, remoteInternetAddress=remoteInternetAddress, vectorError=vectorError, alignmentModeTrap=alignmentModeTrap, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, requestedProtectionState=requestedProtectionState, managementPortForcedConfiguration=managementPortForcedConfiguration, sNTPPrimaryServer=sNTPPrimaryServer, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rxDiversityDataPortStatus=rxDiversityDataPortStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerResponse=sNTPServerResponse, bridge=bridge, transmitterStatus=transmitterStatus, faultProtectionSwitching=faultProtectionSwitching, rFUVersionBank1=rFUVersionBank1, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, radioLicense=radioLicense, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, longitude=longitude, endId=endId, radioLicenseCodeRate=radioLicenseCodeRate, encryptionAlgorithm=encryptionAlgorithm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, gatewayIPAddress=gatewayIPAddress, rFURfBand=rFURfBand, rFUConnectedPlatform=rFUConnectedPlatform, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, remoteMACAddress=remoteMACAddress, neighborInternetAddress=neighborInternetAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, protectionConfig=protectionConfig, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, rFUType=rFUType, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, managementPortAutoNegotiation=managementPortAutoNegotiation, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rFURxFreqMin=rFURxFreqMin, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, wirelessLinkAvailability=wirelessLinkAvailability, receiveModulation=receiveModulation, radioLicenseBand=radioLicenseBand, radioLicenseModulation=radioLicenseModulation, protection=protection, radioLicenseBandwidth=radioLicenseBandwidth, linkLoss=linkLoss, sNMPEnabledTraps=sNMPEnabledTraps, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, ptp=ptp, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, primaryRecovery=primaryRecovery, rFUTxPowerMin=rFUTxPowerMin, protectionStateTrap=protectionStateTrap, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, iFCableLength=iFCableLength, radioLicenseTxFreq=radioLicenseTxFreq, sMTPServerPortNumber=sMTPServerPortNumber, ethernet=ethernet, maxModulation=maxModulation, protectionState=protectionState, receiveDataRate=receiveDataRate, sNTPLastSync=sNTPLastSync, rFUTxPowerMax=rFUTxPowerMax, activeUnit=activeUnit, remotePrimaryIPAddress=remotePrimaryIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, aTPCEnable=aTPCEnable, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, phyControl=phyControl, systemReset=systemReset, sNTPServerTableNumber=sNTPServerTableNumber, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, fiberY=fiberY, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitDataRate=transmitDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPSync=sNTPSync, sMTPEmailAlert=sMTPEmailAlert, softwareVersion=softwareVersion, rFURxFreqMax=rFURxFreqMax, iPv4Address=iPv4Address, protectionInterfaceStatus=protectionInterfaceStatus, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFFeederLoss=rFFeederLoss, productName=productName, rxDiversityVlanTpid=rxDiversityVlanTpid, minCodeRate=minCodeRate, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, tFTPServerIPAddress=tFTPServerIPAddress, protectionAvailabilityStatus=protectionAvailabilityStatus, transmitCapacityLimit=transmitCapacityLimit, enableTransmission=enableTransmission, syslogState=syslogState, managementPortStatusTrap=managementPortStatusTrap, productVariant=productVariant, rFUPowerButtonPressed=rFUPowerButtonPressed, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syslogStateTrap=syslogStateTrap, ethernetFiberSupport=ethernetFiberSupport, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, timeZone=timeZone, antennaGain=antennaGain, syslogClient=syslogClient, userName=userName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, systemClock=systemClock, primarySecondaryMode=primarySecondaryMode, sNMPCommunityString=sNMPCommunityString, managementMode=managementMode, syslogClientTrap=syslogClientTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, iPVersion=iPVersion, rFUTxMuteStatus=rFUTxMuteStatus, dataPortFiberStatus=dataPortFiberStatus, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, sNTPServerTableIndex=sNTPServerTableIndex, dataPortStatusTrap=dataPortStatusTrap, userTable=userTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userPassword=userPassword, sNTPServerInternetAddress=sNTPServerInternetAddress, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, secureModeAlarm=secureModeAlarm, rxDiversityVid=rxDiversityVid, snmpControl=snmpControl, dataPortFiberStatusTrap=dataPortFiberStatusTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, maxCodeRate=maxCodeRate, reset=reset, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, encryptionEnabledMismatch=encryptionEnabledMismatch)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sMTPServerInternetAddressType=sMTPServerInternetAddressType, ptmp=ptmp, iPv6GatewayAddress=iPv6GatewayAddress, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, alarms=alarms, daylightSaving=daylightSaving, hardwareVersion=hardwareVersion, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, managementCommittedInformationRate=managementCommittedInformationRate, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, radioLicenseMinCodeRate=radioLicenseMinCodeRate, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, unitOutOfCalibration=unitOutOfCalibration, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, configuration=configuration, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rFUTxFreqMax=rFUTxFreqMax, dSCPManagementPriority=dSCPManagementPriority, iPv6Address=iPv6Address, ptp800=ptp800, alignmentMode=alignmentMode, transmitModulation=transmitModulation, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFUStatusTrap=rFUStatusTrap, rFUActiveFirmwareBank=rFUActiveFirmwareBank, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, remoteSecondaryMACAddress=remoteSecondaryMACAddress, vLANManagementVIDValidation=vLANManagementVIDValidation, rFUVersionBank2=rFUVersionBank2, rFURpsAlarm=rFURpsAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, subnetMask=subnetMask, syslogControl=syslogControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, cambium=cambium, qOSPriorityScheme=qOSPriorityScheme, vLANManagementPriority=vLANManagementPriority, siteName=siteName, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, transmitPower=transmitPower, secureModeAlarmTrap=secureModeAlarmTrap, rFUTransceiverLocation=rFUTransceiverLocation, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, remoteIPAddress=remoteIPAddress, sNMPTrapTable=sNMPTrapTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ethernetPriorityTable=ethernetPriorityTable, dataPortPauseFrames=dataPortPauseFrames, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, radioLicenseMaxModulation=radioLicenseMaxModulation, rFUSerial=rFUSerial, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, rFUPowerAlarm=rFUPowerAlarm, bootVersion=bootVersion, protectionConfigurationStatus=protectionConfigurationStatus, sNTPState=sNTPState, versions=versions, useVLANForManagementInterfaces=useVLANForManagementInterfaces, linkNameMismatch=linkNameMismatch, sNMPPortNumber=sNMPPortNumber, iPv6PrefixLength=iPv6PrefixLength, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, rFULockoutAlarm=rFULockoutAlarm, rfu=rfu, rFUPlatformCompatibility=rFUPlatformCompatibility, sMTPServerInternetAddress=sMTPServerInternetAddress, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, userTableNumber=userTableNumber, transmitCapacity=transmitCapacity, remotePrimaryInternetAddress=remotePrimaryInternetAddress, ptpTrapPrefix=ptpTrapPrefix, neighborIPAddress=neighborIPAddress, sNMPTrapVersion=sNMPTrapVersion, radioLicenseMinModulation=radioLicenseMinModulation, remoteSecondaryIPAddress=remoteSecondaryIPAddress, supplementary=supplementary, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tFTPServerInternetAddress=tFTPServerInternetAddress, numberOfAntennas=numberOfAntennas, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTableIndex=sNMPTrapTableIndex)
