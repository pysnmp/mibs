...
NotificationType, Bits, Integer32, IpAddress, ModuleIdentity, Counter64, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Unsigned32, MibIdentifier, ObjectIdentity, TimeTicks, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "Integer32", "IpAddress", "ModuleIdentity", "Counter64", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Unsigned32", "MibIdentifier", "ObjectIdentity", "TimeTicks", "NotificationType", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, radioLicenseMaxEIRP=radioLicenseMaxEIRP, radioLicenseRegion=radioLicenseRegion, transmitPower=transmitPower, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, rxDiversityVlanTpid=rxDiversityVlanTpid, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, rFUTxMuteStatus=rFUTxMuteStatus, protection=protection, softwareVersion=softwareVersion, sntp=sntp, smtp=smtp, protectionAvailabilityStatus=protectionAvailabilityStatus, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, telnetPortNumber=telnetPortNumber, transmitCapacity=transmitCapacity, sNMPTrapTableNumber=sNMPTrapTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rFURfBand=rFURfBand, vLANManagementVID=vLANManagementVID, supplementary=supplementary, primaryRecovery=primaryRecovery, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rFUPowerButtonPressed=rFUPowerButtonPressed, rxDiversityDataPortStatus=rxDiversityDataPortStatus, transmitCapacityLimit=transmitCapacityLimit, neighborMACAddress=neighborMACAddress, neighborInternetAddressType=neighborInternetAddressType, radioLicenseBandwidth=radioLicenseBandwidth, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, pubStats=pubStats, tFTPServerIPAddress=tFTPServerIPAddress, rFUStatus=rFUStatus, protectionConfig=protectionConfig, ethernetPriorityTableIndex=ethernetPriorityTableIndex, endId=endId, ethernetPriorityTableNumber=ethernetPriorityTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPPortNumber=sNMPPortNumber, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, alarms=alarms, qOSPriorityScheme=qOSPriorityScheme, alignmentMode=alignmentMode, linkLoss=linkLoss, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, subnetMask=subnetMask, altitude=altitude, userEnabled=userEnabled, primarySecondaryMode=primarySecondaryMode, sNTPServerTableNumber=sNTPServerTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, remotePrimaryInternetAddress=remotePrimaryInternetAddress, secureModeAlarmTrap=secureModeAlarmTrap, rFUTxFreqMin=rFUTxFreqMin, systemReset=systemReset, transmitDataRate=transmitDataRate, sMTPServerIPAddress=sMTPServerIPAddress, userName=userName, sMTPServerInternetAddress=sMTPServerInternetAddress, rFUFreqSpacing=rFUFreqSpacing, iPv6Address=iPv6Address, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, vectorError=vectorError, remoteInternetAddress=remoteInternetAddress, maxCodeRate=maxCodeRate, linkNameMismatchTrap=linkNameMismatchTrap, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, sNTPServerResponse=sNTPServerResponse, systemClock=systemClock, transmitModulation=transmitModulation, phyControl=phyControl, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, versions=versions, protectionConfigurationStatus=protectionConfigurationStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPServerRetries=sNTPServerRetries, secureModeAlarm=secureModeAlarm, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, dataPortDisabledWarning=dataPortDisabledWarning, receivePower=receivePower, sNTPSync=sNTPSync, snmpControl=snmpControl, hTTPSAccessEnabled=hTTPSAccessEnabled, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, remoteInternetAddressType=remoteInternetAddressType, remotePrimaryMACAddress=remotePrimaryMACAddress, rFUTransceiverLocation=rFUTransceiverLocation, sNTPServerTable=sNTPServerTable, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFURFSwitchAlarm=rFURFSwitchAlarm, radioLicenseIdentifier=radioLicenseIdentifier, activeWirelessLinkAvailability=activeWirelessLinkAvailability, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, requestedProtectionState=requestedProtectionState, rfu=rfu, radioLicense=radioLicense, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, protectionInterfaceStatus=protectionInterfaceStatus, encryption=encryption, faultProtectionSwitching=faultProtectionSwitching, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, protectionStats=protectionStats, remoteMACAddress=remoteMACAddress, protectionState=protectionState, securityLevel=securityLevel, sNMPTrapTable=sNMPTrapTable, ethernetFiberSupport=ethernetFiberSupport, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, primaryRecoveryPeriod=primaryRecoveryPeriod, sNMPTrapTableEntry=sNMPTrapTableEntry, managementPortStatus=managementPortStatus, radioLicenseCodeRate=radioLicenseCodeRate, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rFUProtectionCompatibility=rFUProtectionCompatibility, iPv6GatewayAddress=iPv6GatewayAddress, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, ethernetPriorityTable=ethernetPriorityTable, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, unitOutOfCalibration=unitOutOfCalibration, sMTPServerInternetAddressType=sMTPServerInternetAddressType, alignmentModeTrap=alignmentModeTrap, managementCommittedInformationRate=managementCommittedInformationRate, activeAvailableTime=activeAvailableTime, rxDiversityVid=rxDiversityVid, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, radioLicenseMinModulation=radioLicenseMinModulation, antennaGain=antennaGain, receiveCodeRate=receiveCodeRate, encryptionAlgorithm=encryptionAlgorithm, encryptionEnabledMismatch=encryptionEnabledMismatch, longitude=longitude, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPTrapPortNumber=sNMPTrapPortNumber, aTPCEnable=aTPCEnable, rFUStatusTrap=rFUStatusTrap, rFFeederLoss=rFFeederLoss, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, configuration=configuration, userTable=userTable, iPVersion=iPVersion, rFUConnectedPlatform=rFUConnectedPlatform, dataPortStatusTrap=dataPortStatusTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ethernet=ethernet, radioLicenseTxFreq=radioLicenseTxFreq, cambium=cambium, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapVersion=sNMPTrapVersion, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPPollInterval=sNTPPollInterval, siteName=siteName, remoteSecondaryMACAddress=remoteSecondaryMACAddress, hTTPPortNumber=hTTPPortNumber, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, radioLicenseModulation=radioLicenseModulation, l2CPPriorityTable=l2CPPriorityTable, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, vLANManagementPriority=vLANManagementPriority, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rFUVersionBank1=rFUVersionBank1, localPacketFiltering=localPacketFiltering, syslogState=syslogState, linkName=linkName, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPEmailAlert=sMTPEmailAlert, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, gatewayIPAddress=gatewayIPAddress, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, sNTPPrimaryServer=sNTPPrimaryServer, linkNameMismatch=linkNameMismatch, rFUPlatformCompatibility=rFUPlatformCompatibility, sNTPSyncTrap=sNTPSyncTrap, hTTPSPortNumber=hTTPSPortNumber, licence=licence, enableTransmission=enableTransmission, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerTimeout=sNTPServerTimeout, managementMode=managementMode, managementPortDisabledWarning=managementPortDisabledWarning, rFUBranchingConfiguration=rFUBranchingConfiguration, remoteSecondaryIPAddress=remoteSecondaryIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, wirelessLinkAvailability=wirelessLinkAvailability, aAAControl=aAAControl, rFUTxPowerMin=rFUTxPowerMin, neighborInternetAddress=neighborInternetAddress, userTableEntry=userTableEntry, managementPortConfigurationMismatch=managementPortConfigurationMismatch, remoteIPAddress=remoteIPAddress, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFUTxPowerMax=rFUTxPowerMax, management=management, latitude=latitude, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, managementPortWirelessDownAlert=managementPortWirelessDownAlert, protectionSwitchCause=protectionSwitchCause, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, sMTPServerPortNumber=sMTPServerPortNumber, transmitterStatus=transmitterStatus, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, syslogClientTrap=syslogClientTrap, managementPortAutoNegotiation=managementPortAutoNegotiation, rFURpsAlarm=rFURpsAlarm, dataPortFiberStatusTrap=dataPortFiberStatusTrap, maximumTransmitPower=maximumTransmitPower, receiveModulation=receiveModulation, radioLicenseMaxModulation=radioLicenseMaxModulation, timeZone=timeZone, ptp800=ptp800, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortPauseFrames=dataPortPauseFrames, dataPortConfigurationMismatch=dataPortConfigurationMismatch, l2CPPriorityTableNumber=l2CPPriorityTableNumber, radioLicenseBand=radioLicenseBand, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, syslogClient=syslogClient, ptp=ptp, neighborIPAddress=neighborIPAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rFUPowerAlarm=rFUPowerAlarm, aggregateDataRate=aggregateDataRate, numberOfAntennas=numberOfAntennas, protectionStateTrap=protectionStateTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, hTTPAccessEnabled=hTTPAccessEnabled, iFCableLength=iFCableLength, ptmp=ptmp, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, dataPortFiberStatus=dataPortFiberStatus, rFUTxPowerAlarm=rFUTxPowerAlarm, sNTPLastSync=sNTPLastSync, sNMPCommunityString=sNMPCommunityString, rFUTxBandAboveRx=rFUTxBandAboveRx, userRole=userRole, transmitCodeRate=transmitCodeRate, userTableIndex=userTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessLinkStatusTrap=wirelessLinkStatusTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, productVariant=productVariant, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, transmitCapacityLimitDetail=transmitCapacityLimitDetail, rFUCableAlarm=rFUCableAlarm, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, productName=productName, secondarySoftwareVersion=secondarySoftwareVersion, ptpTraps=ptpTraps, iPv4Address=iPv4Address, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFUTxFreqMax=rFUTxFreqMax, remotePrimaryIPAddress=remotePrimaryIPAddress, activeUnit=activeUnit, bridge=bridge, minModulation=minModulation, sNTPState=sNTPState, tFTPServerPortNumber=tFTPServerPortNumber, dSCPManagementPriority=dSCPManagementPriority, sNTPServerTableEntry=sNTPServerTableEntry, userPassword=userPassword, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, rFULockoutAlarm=rFULockoutAlarm, bootVersion=bootVersion, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, dataPortStatus=dataPortStatus, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, telnetAccessEnabled=telnetAccessEnabled, diverseRfFeederLoss=diverseRfFeederLoss, sNTPServerTableIndex=sNTPServerTableIndex, rFUActiveFirmwareBank=rFUActiveFirmwareBank, protectionStatus=protectionStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogControl=syslogControl, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, vLANManagementVIDValidation=vLANManagementVIDValidation, receiveDataRate=receiveDataRate, userTableNumber=userTableNumber, managementPortStatusTrap=managementPortStatusTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, managementPortForcedConfiguration=managementPortForcedConfiguration, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerPortNumber=sNTPServerPortNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, minCodeRate=minCodeRate, syslogStateTrap=syslogStateTrap, rFURxFreqMax=rFURxFreqMax, maxModulation=maxModulation, diverseAntennaGain=diverseAntennaGain, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFURxFreqMin=rFURxFreqMin, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ptpTrapPrefix=ptpTrapPrefix, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFUType=rFUType, reset=reset, remotePrimarySecondaryMode=remotePrimarySecondaryMode, fiberY=fiberY, wirelessLinkStatus=wirelessLinkStatus, sNMPEnabledTraps=sNMPEnabledTraps, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hardwareVersion=hardwareVersion, radioLicenseRxFreq=radioLicenseRxFreq, sNTPServerIPAddress=sNTPServerIPAddress, daylightSaving=daylightSaving, rFUVersionBank2=rFUVersionBank2, rFUSerial=rFUSerial, iPv6PrefixLength=iPv6PrefixLength, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, phyStatus=phyStatus, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility)
