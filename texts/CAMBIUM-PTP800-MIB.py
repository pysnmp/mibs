...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, iso, ModuleIdentity, Counter64, enterprises, Unsigned32, ObjectIdentity, Counter32, Integer32, Bits, IpAddress, Gauge32, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "iso", "ModuleIdentity", "Counter64", "enterprises", "Unsigned32", "ObjectIdentity", "Counter32", "Integer32", "Bits", "IpAddress", "Gauge32", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, neighborInternetAddress=neighborInternetAddress, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, protectionInterfaceStatus=protectionInterfaceStatus, userEnabled=userEnabled, productVariant=productVariant, neighborInternetAddressType=neighborInternetAddressType, receiveDataRate=receiveDataRate, syslogLocalWrappedTrap=syslogLocalWrappedTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, encryption=encryption, userTableNumber=userTableNumber, managementCommittedInformationRate=managementCommittedInformationRate, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ptpTrapPrefix=ptpTrapPrefix, sNTPServerTimeout=sNTPServerTimeout, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sMTPServerIPAddress=sMTPServerIPAddress, syslogClient=syslogClient, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, rFUFreqSpacing=rFUFreqSpacing, softwareVersion=softwareVersion, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rFUBranchingConfiguration=rFUBranchingConfiguration, radioLicenseModulation=radioLicenseModulation, subnetMask=subnetMask, antennaGain=antennaGain, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rxDiversityVid=rxDiversityVid, transmitDataRate=transmitDataRate, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortStatusTrap=dataPortStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, protectionConfigurationStatus=protectionConfigurationStatus, numberOfAntennas=numberOfAntennas, daylightSaving=daylightSaving, sNTPServerResponse=sNTPServerResponse, minModulation=minModulation, sMTPEnabledMessages=sMTPEnabledMessages, primarySecondaryMode=primarySecondaryMode, latitude=latitude, remoteInternetAddress=remoteInternetAddress, radioLicense=radioLicense, iPv6GatewayAddress=iPv6GatewayAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, radioLicenseMaxEIRP=radioLicenseMaxEIRP, remoteIPAddress=remoteIPAddress, unitOutOfCalibration=unitOutOfCalibration, transmitCapacity=transmitCapacity, dataPortPauseFrames=dataPortPauseFrames, securityLevel=securityLevel, tFTPServerInternetAddress=tFTPServerInternetAddress, rFUStatusTrap=rFUStatusTrap, radioLicenseBandwidth=radioLicenseBandwidth, l2CPPriorityTable=l2CPPriorityTable, userTableEntry=userTableEntry, managementMode=managementMode, receivePower=receivePower, remoteSecondaryIPAddress=remoteSecondaryIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPServerTableNumber=sNTPServerTableNumber, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rFUPowerAlarm=rFUPowerAlarm, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPSync=sNTPSync, iPv6Address=iPv6Address, remotePrimaryMACAddress=remotePrimaryMACAddress, protectionStateTrap=protectionStateTrap, transmitPower=transmitPower, versions=versions, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, alignmentModeTrap=alignmentModeTrap, localPacketFiltering=localPacketFiltering, hTTPAccessEnabled=hTTPAccessEnabled, transmitCodeRate=transmitCodeRate, supplementary=supplementary, sMTPServerInternetAddress=sMTPServerInternetAddress, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, sNTPServerIPAddress=sNTPServerIPAddress, management=management, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, protectionState=protectionState, bridge=bridge, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, neighborMACAddress=neighborMACAddress, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, userName=userName, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, activeAvailableTime=activeAvailableTime, managementPortStatusTrap=managementPortStatusTrap, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, linkNameMismatchTrap=linkNameMismatchTrap, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, phyStatus=phyStatus, sNMPCommunityString=sNMPCommunityString, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rxDiversityDataPortStatus=rxDiversityDataPortStatus, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, remotePrimaryInternetAddress=remotePrimaryInternetAddress, radioLicenseRegion=radioLicenseRegion, rFUConnectedPlatform=rFUConnectedPlatform, linkLoss=linkLoss, rFUType=rFUType, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hTTPSPortNumber=hTTPSPortNumber, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANManagementVIDValidation=vLANManagementVIDValidation, ethernet=ethernet, userTable=userTable, rFUProtectionCompatibility=rFUProtectionCompatibility, sNMPTrapIPAddress=sNMPTrapIPAddress, managementPortForcedConfiguration=managementPortForcedConfiguration, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, aTPCEnable=aTPCEnable, aggregateDataRate=aggregateDataRate, fiberY=fiberY, sNTPSyncTrap=sNTPSyncTrap, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, vLANManagementPriority=vLANManagementPriority, systemClock=systemClock, remoteInternetAddressType=remoteInternetAddressType, altitude=altitude, alarms=alarms, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rFURFSwitchAlarm=rFURFSwitchAlarm, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, radioLicenseRxFreq=radioLicenseRxFreq, radioLicenseBand=radioLicenseBand, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, hTTPPortNumber=hTTPPortNumber, longitude=longitude, dSCPManagementPriority=dSCPManagementPriority, systemReset=systemReset, rFULockoutAlarm=rFULockoutAlarm, syslogControl=syslogControl, ethernetPriorityTableIndex=ethernetPriorityTableIndex, receiveModulation=receiveModulation, timeZone=timeZone, maximumTransmitPower=maximumTransmitPower, wirelessLinkStatusTrap=wirelessLinkStatusTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rxDiversityVlanTpid=rxDiversityVlanTpid, protection=protection, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPState=sNTPState, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sMTPEmailAlert=sMTPEmailAlert, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, gatewayIPAddress=gatewayIPAddress, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, rFFeederLoss=rFFeederLoss, rFUTxFreqMin=rFUTxFreqMin, wirelessLinkStatus=wirelessLinkStatus, ethernetFiberSupport=ethernetFiberSupport, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, bootVersion=bootVersion, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sNTPServerTableIndex=sNTPServerTableIndex, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, l2CPPriorityTableNumber=l2CPPriorityTableNumber, encryptionAlgorithm=encryptionAlgorithm, mPLSTCPriorityTable=mPLSTCPriorityTable, syslogStateTrap=syslogStateTrap, sNTPServerRetries=sNTPServerRetries, managementPortAutoNegotiation=managementPortAutoNegotiation, rFUVersionBank2=rFUVersionBank2, transmitCapacityLimit=transmitCapacityLimit, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetPriorityTable=ethernetPriorityTable, rFUStatus=rFUStatus, userTableIndex=userTableIndex, rFURfBand=rFURfBand, faultProtectionSwitching=faultProtectionSwitching, sNTPServerTable=sNTPServerTable, rFURpsAlarm=rFURpsAlarm, primaryRecovery=primaryRecovery, tFTPServerInternetAddressType=tFTPServerInternetAddressType, managementPortDisabledWarning=managementPortDisabledWarning, sNMPTrapVersion=sNMPTrapVersion, enableTransmission=enableTransmission, ptmp=ptmp, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rFURxFreqMin=rFURxFreqMin, receiveCodeRate=receiveCodeRate, secureModeAlarm=secureModeAlarm, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFUTxPowerAlarm=rFUTxPowerAlarm, linkName=linkName, pubStats=pubStats, rFUVersionBank1=rFUVersionBank1, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, ptp=ptp, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rFUPowerButtonPressed=rFUPowerButtonPressed, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, requestedProtectionState=requestedProtectionState, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, siteName=siteName, remoteMACAddress=remoteMACAddress, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, licence=licence, tFTPServerIPAddress=tFTPServerIPAddress, protectionStatus=protectionStatus, transmitModulation=transmitModulation, productName=productName, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, activeUnit=activeUnit, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataPortFiberStatusTrap=dataPortFiberStatusTrap, alignmentMode=alignmentMode, sNMPTrapTable=sNMPTrapTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, diverseRfFeederLoss=diverseRfFeederLoss, diverseAntennaGain=diverseAntennaGain, rFUPlatformCompatibility=rFUPlatformCompatibility, rFUTxPowerMin=rFUTxPowerMin, vLANManagementVID=vLANManagementVID, ptp800=ptp800, dataPortFiberStatus=dataPortFiberStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sntp=sntp)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", dataPortStatus=dataPortStatus, encryptionEnabledMismatch=encryptionEnabledMismatch, radioLicenseCodeRate=radioLicenseCodeRate, wirelessLinkAvailability=wirelessLinkAvailability, phyControl=phyControl, remotePrimaryIPAddress=remotePrimaryIPAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, radioLicenseMinModulation=radioLicenseMinModulation, userRole=userRole, minCodeRate=minCodeRate, iPVersion=iPVersion, hardwareVersion=hardwareVersion, telnetPortNumber=telnetPortNumber, cambium=cambium, sNTPServerTableEntry=sNTPServerTableEntry, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, endId=endId, syslogState=syslogState, rFUTxMuteStatus=rFUTxMuteStatus, syslogClientTrap=syslogClientTrap, userPassword=userPassword, neighborIPAddress=neighborIPAddress, transmitCapacityLimitDetail=transmitCapacityLimitDetail, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, sNMPEnabledTraps=sNMPEnabledTraps, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, protectionSwitchCause=protectionSwitchCause, iFCableLength=iFCableLength, sNTPServerPortNumber=sNTPServerPortNumber, sNMPPortNumber=sNMPPortNumber, smtp=smtp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, protectionAvailabilityStatus=protectionAvailabilityStatus, aAAControl=aAAControl, ethernetPriorityTableEntry=ethernetPriorityTableEntry, remotePrimarySecondaryMode=remotePrimarySecondaryMode, configuration=configuration, rFUCableAlarm=rFUCableAlarm, sNTPPollInterval=sNTPPollInterval, iPv6PrefixLength=iPv6PrefixLength, primaryRecoveryPeriod=primaryRecoveryPeriod, rFUTxBandAboveRx=rFUTxBandAboveRx, sNMPTrapPortNumber=sNMPTrapPortNumber, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPv4Address=iPv4Address, rFUTxFreqMax=rFUTxFreqMax, maxModulation=maxModulation, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, radioLicenseMinCodeRate=radioLicenseMinCodeRate, radioLicenseTxFreq=radioLicenseTxFreq, qOSPriorityScheme=qOSPriorityScheme, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, telnetAccessEnabled=telnetAccessEnabled, sNTPLastSync=sNTPLastSync, ethernetPriorityTableNumber=ethernetPriorityTableNumber, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, sNTPPrimaryServer=sNTPPrimaryServer, radioLicenseMaxModulation=radioLicenseMaxModulation, transmitterStatus=transmitterStatus, rFUSerial=rFUSerial, enabledDiagnosticAlarms=enabledDiagnosticAlarms, protectionConfig=protectionConfig, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rFURxFreqMax=rFURxFreqMax, snmpControl=snmpControl, vectorError=vectorError, reset=reset, sNMPTrapInternetAddress=sNMPTrapInternetAddress, linkNameMismatch=linkNameMismatch, rFUTxPowerMax=rFUTxPowerMax, tFTPServerPortNumber=tFTPServerPortNumber, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, sNMPTrapTableEntry=sNMPTrapTableEntry, rfu=rfu, rFUActiveFirmwareBank=rFUActiveFirmwareBank, dataPortDisabledWarning=dataPortDisabledWarning, maxCodeRate=maxCodeRate, rFUTransceiverLocation=rFUTransceiverLocation, radioLicenseIdentifier=radioLicenseIdentifier, ptpTraps=ptpTraps, secureModeAlarmTrap=secureModeAlarmTrap, managementPortStatus=managementPortStatus, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, protectionStats=protectionStats)
