...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, phyStatus=phyStatus, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rFUPowerButtonPressed=rFUPowerButtonPressed, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, diverseAntennaGain=diverseAntennaGain, daylightSaving=daylightSaving, sNTPServerIPAddress=sNTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, secondarySoftwareVersion=secondarySoftwareVersion, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, radioLicenseMaxModulation=radioLicenseMaxModulation, siteName=siteName, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, receivePower=receivePower, rFUActiveFirmwareBank=rFUActiveFirmwareBank, linkNameMismatchTrap=linkNameMismatchTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, iPv6Address=iPv6Address, sMTPServerInternetAddressType=sMTPServerInternetAddressType, wirelessLinkStatus=wirelessLinkStatus, rFURpsAlarm=rFURpsAlarm, primaryRecovery=primaryRecovery, radioLicenseMinCodeRate=radioLicenseMinCodeRate, activeUnit=activeUnit, numberOfAntennas=numberOfAntennas, remoteSecondaryIPAddress=remoteSecondaryIPAddress, linkNameMismatch=linkNameMismatch, managementPortWirelessDownAlert=managementPortWirelessDownAlert, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, alignmentMode=alignmentMode, managementCommittedInformationRate=managementCommittedInformationRate, mPLSTCPriorityTable=mPLSTCPriorityTable, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, transmitDataRate=transmitDataRate, rFUStatus=rFUStatus, systemReset=systemReset, ptp=ptp, receiveModulation=receiveModulation, sMTPSourceEmailAddress=sMTPSourceEmailAddress, productName=productName, rFUTxPowerMax=rFUTxPowerMax, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, protectionAvailabilityStatus=protectionAvailabilityStatus, radioLicenseBandwidth=radioLicenseBandwidth, ethernetPriorityTable=ethernetPriorityTable, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, bootVersion=bootVersion, sNTPServerTableEntry=sNTPServerTableEntry, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPTrapVersion=sNMPTrapVersion, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ptpTraps=ptpTraps, sNTPServerPortNumber=sNTPServerPortNumber, rxDiversityVlanTpid=rxDiversityVlanTpid, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rfu=rfu, rFUTxFreqMin=rFUTxFreqMin, l2CPPriorityTable=l2CPPriorityTable, alarms=alarms, smtp=smtp, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dataPortFiberStatus=dataPortFiberStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, userTableNumber=userTableNumber, minCodeRate=minCodeRate, vectorError=vectorError, rFUProtectionCompatibility=rFUProtectionCompatibility, management=management, remoteInternetAddress=remoteInternetAddress, hardwareVersion=hardwareVersion, reset=reset, configuration=configuration, fiberY=fiberY, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFURfBand=rFURfBand, ptpTrapPrefix=ptpTrapPrefix, transmitCapacityLimit=transmitCapacityLimit, tFTPServerPortNumber=tFTPServerPortNumber, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, productVariant=productVariant, tFTPServerInternetAddressType=tFTPServerInternetAddressType, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, vLANManagementVIDValidation=vLANManagementVIDValidation, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, iPv6PrefixLength=iPv6PrefixLength, sNTPPrimaryServer=sNTPPrimaryServer, userRole=userRole, remoteMaximumTransmitPower=remoteMaximumTransmitPower, localPacketFiltering=localPacketFiltering, rFURFSwitchAlarm=rFURFSwitchAlarm, subnetMask=subnetMask, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userTable=userTable, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, pubStats=pubStats, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, transmitModulation=transmitModulation, hTTPSPortNumber=hTTPSPortNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, iPv6GatewayAddress=iPv6GatewayAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFUPlatformCompatibility=rFUPlatformCompatibility, linkLoss=linkLoss, managementPortDisabledWarning=managementPortDisabledWarning, qOSPriorityScheme=qOSPriorityScheme, latitude=latitude, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, neighborMACAddress=neighborMACAddress, sNTPState=sNTPState, radioLicenseRxFreq=radioLicenseRxFreq, radioLicenseCodeRate=radioLicenseCodeRate, syslogLocalWrappedTrap=syslogLocalWrappedTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, aAAControl=aAAControl, remoteIPAddress=remoteIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, radioLicenseIdentifier=radioLicenseIdentifier, remotePrimaryInternetAddress=remotePrimaryInternetAddress, sMTPServerPortNumber=sMTPServerPortNumber, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, linkName=linkName, dataPortStatus=dataPortStatus, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, sNTPServerResponse=sNTPServerResponse, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rFUConnectedPlatform=rFUConnectedPlatform, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, sMTPEnabledMessages=sMTPEnabledMessages, rFUTxFreqMax=rFUTxFreqMax, managementPortForcedConfiguration=managementPortForcedConfiguration, rxDiversityVid=rxDiversityVid, ptp800=ptp800, sNTPLastSync=sNTPLastSync, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, transmitCapacity=transmitCapacity, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remotePrimaryMACAddress=remotePrimaryMACAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userEnabled=userEnabled, tFTPServerInternetAddress=tFTPServerInternetAddress, telnetAccessEnabled=telnetAccessEnabled, managementPortStatus=managementPortStatus, receiveDataRate=receiveDataRate, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerTimeout=sNTPServerTimeout, sNTPServerRetries=sNTPServerRetries, wirelessLinkAvailability=wirelessLinkAvailability, rFURxFreqMin=rFURxFreqMin, encryption=encryption, radioLicense=radioLicense, minModulation=minModulation, telnetPortNumber=telnetPortNumber, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, sNTPServerTableIndex=sNTPServerTableIndex, remotePrimaryIPAddress=remotePrimaryIPAddress, rFUTxPowerMin=rFUTxPowerMin, activeWirelessLinkAvailability=activeWirelessLinkAvailability, protectionStateTrap=protectionStateTrap, ptmp=ptmp, supplementary=supplementary, sNTPSyncTrap=sNTPSyncTrap, userPassword=userPassword, rFUVersionBank1=rFUVersionBank1, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, systemClock=systemClock, protectionStats=protectionStats, maximumTransmitPower=maximumTransmitPower, sNTPSync=sNTPSync, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, hTTPPortNumber=hTTPPortNumber, faultProtectionSwitching=faultProtectionSwitching, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, iFCableLength=iFCableLength, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, radioLicenseMinModulation=radioLicenseMinModulation, sNMPTrapInternetAddress=sNMPTrapInternetAddress, enableTransmission=enableTransmission, sNMPPortNumber=sNMPPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogStateTrap=syslogStateTrap, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, versions=versions, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, neighborInternetAddress=neighborInternetAddress, bridge=bridge, sNMPTrapTable=sNMPTrapTable, snmpControl=snmpControl, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rFULockoutAlarm=rFULockoutAlarm, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFUTxMuteStatus=rFUTxMuteStatus, alignmentModeTrap=alignmentModeTrap, rFURxFreqMax=rFURxFreqMax, secureModeAlarmTrap=secureModeAlarmTrap, diverseRfFeederLoss=diverseRfFeederLoss, protectionInterfaceStatus=protectionInterfaceStatus, sntp=sntp, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, protectionConfigurationStatus=protectionConfigurationStatus, encryptionAlgorithm=encryptionAlgorithm, requestedProtectionState=requestedProtectionState, l2CPPriorityTableEntry=l2CPPriorityTableEntry, maxModulation=maxModulation, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rFUType=rFUType, managementMode=managementMode, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, radioLicenseMaxEIRP=radioLicenseMaxEIRP, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dataPortStatusTrap=dataPortStatusTrap, protectionSwitchCause=protectionSwitchCause, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, userTableIndex=userTableIndex, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, transmitterStatus=transmitterStatus, userTableEntry=userTableEntry, altitude=altitude, sNMPTrapTableEntry=sNMPTrapTableEntry, aTPCEnable=aTPCEnable, transmitCapacityLimitDetail=transmitCapacityLimitDetail, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, remoteInternetAddressType=remoteInternetAddressType, rFUSerial=rFUSerial)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, protectionState=protectionState, rxDiversityDataPortStatus=rxDiversityDataPortStatus, rFUBranchingConfiguration=rFUBranchingConfiguration, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogClient=syslogClient, gatewayIPAddress=gatewayIPAddress, primaryRecoveryPeriod=primaryRecoveryPeriod, dataPortPauseFrames=dataPortPauseFrames, primarySecondaryMode=primarySecondaryMode, antennaGain=antennaGain, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, userName=userName, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sNMPCommunityString=sNMPCommunityString, timeZone=timeZone, managementPortAutoNegotiation=managementPortAutoNegotiation, unitOutOfCalibration=unitOutOfCalibration, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerIPAddress=tFTPServerIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, hTTPAccessEnabled=hTTPAccessEnabled, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, protectionStatus=protectionStatus, dSCPManagementPriority=dSCPManagementPriority, vLANManagementPriority=vLANManagementPriority, remoteMACAddress=remoteMACAddress, syslogControl=syslogControl, activeAvailableTime=activeAvailableTime, protectionConfig=protectionConfig, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rFUTxBandAboveRx=rFUTxBandAboveRx, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, neighborInternetAddressType=neighborInternetAddressType, radioLicenseRegion=radioLicenseRegion, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, transmitPower=transmitPower, sMTPEmailAlert=sMTPEmailAlert, rFUStatusTrap=rFUStatusTrap, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, rFUCableAlarm=rFUCableAlarm, sNMPTrapTableIndex=sNMPTrapTableIndex, securityLevel=securityLevel, rFUFreqSpacing=rFUFreqSpacing, rFUVersionBank2=rFUVersionBank2, licence=licence, maxCodeRate=maxCodeRate, syslogState=syslogState, iPVersion=iPVersion, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernet=ethernet, rFUPowerAlarm=rFUPowerAlarm, softwareVersion=softwareVersion, cambium=cambium, sNTPServerTable=sNTPServerTable, secureModeAlarm=secureModeAlarm, ethernetFiberSupport=ethernetFiberSupport, rFUTxPowerAlarm=rFUTxPowerAlarm, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, endId=endId, phyControl=phyControl, neighborIPAddress=neighborIPAddress, syslogClientTrap=syslogClientTrap, radioLicenseModulation=radioLicenseModulation, iPv4Address=iPv4Address, receiveCodeRate=receiveCodeRate, rFFeederLoss=rFFeederLoss, sMTPServerIPAddress=sMTPServerIPAddress, vLANManagementVID=vLANManagementVID, rFUTransceiverLocation=rFUTransceiverLocation, radioLicenseBand=radioLicenseBand, longitude=longitude, encryptionEnabledMismatch=encryptionEnabledMismatch, transmitCodeRate=transmitCodeRate, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, radioLicenseTxFreq=radioLicenseTxFreq, managementPortStatusTrap=managementPortStatusTrap, sNTPPollInterval=sNTPPollInterval, protection=protection, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataPortDisabledWarning=dataPortDisabledWarning, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility)
