...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", altitude=altitude, softwareVersion=softwareVersion, rFUTxPowerMax=rFUTxPowerMax, secureModeAlarmTrap=secureModeAlarmTrap, primarySecondaryMode=primarySecondaryMode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userTableNumber=userTableNumber, rFULockoutAlarm=rFULockoutAlarm, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, radioLicenseBand=radioLicenseBand, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, radioLicenseMinModulation=radioLicenseMinModulation, sMTPSourceEmailAddress=sMTPSourceEmailAddress, protectionStateTrap=protectionStateTrap, aTPCEnable=aTPCEnable, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptp=ptp, radioLicense=radioLicense, rFURpsAlarm=rFURpsAlarm, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, alignmentModeTrap=alignmentModeTrap, sNMPTrapVersion=sNMPTrapVersion, rFUTransceiverLocation=rFUTransceiverLocation, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, managementPortStatusTrap=managementPortStatusTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, managementPortAutoNegotiation=managementPortAutoNegotiation, rxDiversityVlanTpid=rxDiversityVlanTpid, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, configuration=configuration, ptmp=ptmp, iPv6GatewayAddress=iPv6GatewayAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, secondarySoftwareVersion=secondarySoftwareVersion, diverseAntennaGain=diverseAntennaGain, sNTPServerTimeout=sNTPServerTimeout, rfu=rfu, remotePrimaryInternetAddress=remotePrimaryInternetAddress, vLANManagementVID=vLANManagementVID, sNTPSync=sNTPSync, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dataPortConfigurationMismatch=dataPortConfigurationMismatch, radioLicenseRegion=radioLicenseRegion, transmitDataRate=transmitDataRate, syslogClientTrap=syslogClientTrap, transmitModulation=transmitModulation, protectionStats=protectionStats, transmitCodeRate=transmitCodeRate, systemClock=systemClock, activeWirelessLinkAvailability=activeWirelessLinkAvailability, iPv6Address=iPv6Address, hTTPSAccessEnabled=hTTPSAccessEnabled, rFUTxFreqMin=rFUTxFreqMin, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, managementCommittedInformationRate=managementCommittedInformationRate, sNTPLastSync=sNTPLastSync, sNTPSyncTrap=sNTPSyncTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, remoteSecondaryIPAddress=remoteSecondaryIPAddress, userPassword=userPassword, productName=productName, remoteInternetAddressType=remoteInternetAddressType, receiveCodeRate=receiveCodeRate, mPLSTCPriorityTable=mPLSTCPriorityTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, remoteInternetAddress=remoteInternetAddress, neighborMACAddress=neighborMACAddress, transmitterStatus=transmitterStatus, reset=reset, radioLicenseModulation=radioLicenseModulation, transmitCapacity=transmitCapacity, hTTPAccessEnabled=hTTPAccessEnabled, rFFeederLoss=rFFeederLoss, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, sNTPServerIPAddress=sNTPServerIPAddress, securityLevel=securityLevel, rFUPowerAlarm=rFUPowerAlarm, minCodeRate=minCodeRate, syslogControl=syslogControl, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, sNTPPollInterval=sNTPPollInterval, rFUPowerButtonPressed=rFUPowerButtonPressed, protectionSwitchCause=protectionSwitchCause, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, siteName=siteName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rxDiversityVid=rxDiversityVid, dataPortStatusTrap=dataPortStatusTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, hTTPPortNumber=hTTPPortNumber, primaryRecovery=primaryRecovery, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, remotePrimaryIPAddress=remotePrimaryIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, snmpControl=snmpControl, systemReset=systemReset, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, transmitPower=transmitPower, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, aggregateDataRate=aggregateDataRate, remoteMACAddress=remoteMACAddress, encryptionAlgorithm=encryptionAlgorithm, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, sNMPTrapTableNumber=sNMPTrapTableNumber, rFUType=rFUType, protectionStatus=protectionStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, neighborIPAddress=neighborIPAddress, rFUBranchingConfiguration=rFUBranchingConfiguration, iPDSCPPriorityTable=iPDSCPPriorityTable, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, syslogClient=syslogClient, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sMTPEmailAlert=sMTPEmailAlert, managementMode=managementMode, transmitCapacityLimit=transmitCapacityLimit, tFTPServerInternetAddress=tFTPServerInternetAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, remotePrimaryMACAddress=remotePrimaryMACAddress, sNTPServerTableEntry=sNTPServerTableEntry, tFTPServerIPAddress=tFTPServerIPAddress, sntp=sntp, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, linkNameMismatchTrap=linkNameMismatchTrap, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, maxModulation=maxModulation, sNMPCommunityString=sNMPCommunityString, l2CPPriorityTableEntry=l2CPPriorityTableEntry, radioLicenseMinCodeRate=radioLicenseMinCodeRate, vLANManagementVIDValidation=vLANManagementVIDValidation, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFUTxMuteStatus=rFUTxMuteStatus, rFUCableAlarm=rFUCableAlarm, activeAvailableTime=activeAvailableTime, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, subnetMask=subnetMask, faultProtectionSwitching=faultProtectionSwitching, hardwareVersion=hardwareVersion, protectionInterfaceStatus=protectionInterfaceStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, l2CPPriorityTable=l2CPPriorityTable, managementPortStatus=managementPortStatus, numberOfAntennas=numberOfAntennas, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerResponse=sNTPServerResponse, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, tFTPServerPortNumber=tFTPServerPortNumber, protectionState=protectionState, rFUSerial=rFUSerial, enableTransmission=enableTransmission, transmitCapacityLimitDetail=transmitCapacityLimitDetail, rFURFSwitchAlarm=rFURFSwitchAlarm, telnetPortNumber=telnetPortNumber, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, userTableEntry=userTableEntry, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rFURfBand=rFURfBand, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, managementPortForcedConfiguration=managementPortForcedConfiguration, alignmentMode=alignmentMode, receivePower=receivePower, managementPortDisabledWarning=managementPortDisabledWarning, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPState=sNTPState, wirelessLinkStatus=wirelessLinkStatus, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, supplementary=supplementary, rFUStatusTrap=rFUStatusTrap, secureModeAlarm=secureModeAlarm, rFUPlatformCompatibility=rFUPlatformCompatibility, receiveModulation=receiveModulation, rFUTxPowerAlarm=rFUTxPowerAlarm, antennaGain=antennaGain, alarms=alarms, phyControl=phyControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, neighborInternetAddressType=neighborInternetAddressType, versions=versions, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rxDiversityDataPortStatus=rxDiversityDataPortStatus, userRole=userRole, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, ptpTrapPrefix=ptpTrapPrefix, rFUVersionBank1=rFUVersionBank1, rFUTxBandAboveRx=rFUTxBandAboveRx, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, minModulation=minModulation, protectionConfig=protectionConfig, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ethernetPriorityTableNumber=ethernetPriorityTableNumber, iPv4Address=iPv4Address, pubStats=pubStats, wirelessLinkAvailability=wirelessLinkAvailability, encryption=encryption, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, ptpTraps=ptpTraps, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, ethernet=ethernet, sMTPServerIPAddress=sMTPServerIPAddress, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, bootVersion=bootVersion, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, userEnabled=userEnabled, fiberY=fiberY, daylightSaving=daylightSaving, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sNMPEnabledTraps=sNMPEnabledTraps, ethernetPriorityTable=ethernetPriorityTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, maxCodeRate=maxCodeRate, licence=licence, iPVersion=iPVersion, dSCPManagementPriority=dSCPManagementPriority, sNTPPrimaryServer=sNTPPrimaryServer, radioLicenseMaxEIRP=radioLicenseMaxEIRP, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, radioLicenseMaxModulation=radioLicenseMaxModulation, management=management, cambium=cambium, neighborInternetAddress=neighborInternetAddress, linkLoss=linkLoss, protectionAvailabilityStatus=protectionAvailabilityStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPTrapTableIndex=sNMPTrapTableIndex, rFUTxFreqMax=rFUTxFreqMax, remotePrimarySecondaryMode=remotePrimarySecondaryMode, iFCableLength=iFCableLength, receiveDataRate=receiveDataRate, activeUnit=activeUnit, sNTPServerRetries=sNTPServerRetries)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", telnetAccessEnabled=telnetAccessEnabled, rFURxFreqMax=rFURxFreqMax, ethernetFiberSupport=ethernetFiberSupport, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, localPacketFiltering=localPacketFiltering, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, remoteIPAddress=remoteIPAddress, syslogState=syslogState, phyStatus=phyStatus, gatewayIPAddress=gatewayIPAddress, rFUTxPowerMin=rFUTxPowerMin, latitude=latitude, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUFreqSpacing=rFUFreqSpacing, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, sNTPServerTableNumber=sNTPServerTableNumber, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, remoteSecondaryMACAddress=remoteSecondaryMACAddress, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, radioLicenseBandwidth=radioLicenseBandwidth, dataPortDisabledWarning=dataPortDisabledWarning, vectorError=vectorError, radioLicenseTxFreq=radioLicenseTxFreq, userTableIndex=userTableIndex, wirelessLinkStatusTrap=wirelessLinkStatusTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, protectionConfigurationStatus=protectionConfigurationStatus, rFUProtectionCompatibility=rFUProtectionCompatibility, dataPortStatus=dataPortStatus, rFUStatus=rFUStatus, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, primaryRecoveryPeriod=primaryRecoveryPeriod, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dataPortFiberStatus=dataPortFiberStatus, vLANManagementPriority=vLANManagementPriority, userTable=userTable, syslogStateTrap=syslogStateTrap, productVariant=productVariant, rFUConnectedPlatform=rFUConnectedPlatform, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, sMTPServerInternetAddress=sMTPServerInternetAddress, longitude=longitude, linkNameMismatch=linkNameMismatch, userName=userName, rFUVersionBank2=rFUVersionBank2, timeZone=timeZone, ptp800=ptp800, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNMPTrapPortNumber=sNMPTrapPortNumber, iPv6PrefixLength=iPv6PrefixLength, dataPortPauseFrames=dataPortPauseFrames, sNTPServerTableIndex=sNTPServerTableIndex, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, protection=protection, aAAControl=aAAControl, managementPortConfigurationMismatch=managementPortConfigurationMismatch, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, maximumTransmitPower=maximumTransmitPower, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, diverseRfFeederLoss=diverseRfFeederLoss, linkName=linkName, radioLicenseRxFreq=radioLicenseRxFreq, radioLicenseIdentifier=radioLicenseIdentifier, qOSPriorityScheme=qOSPriorityScheme, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, unitOutOfCalibration=unitOutOfCalibration, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, sNTPServerTable=sNTPServerTable, requestedProtectionState=requestedProtectionState, sNMPTrapTable=sNMPTrapTable, encryptionEnabledMismatch=encryptionEnabledMismatch, l2CPPriorityTableIndex=l2CPPriorityTableIndex, bridge=bridge, sNTPServerInternetAddress=sNTPServerInternetAddress, endId=endId, rFURxFreqMin=rFURxFreqMin, radioLicenseCodeRate=radioLicenseCodeRate, smtp=smtp, sNMPPortNumber=sNMPPortNumber)
