...
ObjectIdentity, MibIdentifier, Unsigned32, TimeTicks, Counter32, Counter64, ModuleIdentity, NotificationType, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, IpAddress, enterprises, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "Unsigned32", "TimeTicks", "Counter32", "Counter64", "ModuleIdentity", "NotificationType", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "IpAddress", "enterprises", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, telnetAccessEnabled=telnetAccessEnabled, sNTPState=sNTPState, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, remotePrimaryIPAddress=remotePrimaryIPAddress, reset=reset, sNTPSyncTrap=sNTPSyncTrap, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, hTTPSAccessEnabled=hTTPSAccessEnabled, minCodeRate=minCodeRate, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rFURFSwitchAlarm=rFURFSwitchAlarm, smtp=smtp, rFURpsAlarm=rFURpsAlarm, linkName=linkName, syslogClient=syslogClient, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, managementPortForcedConfiguration=managementPortForcedConfiguration, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, aAAControl=aAAControl, vLANManagementVID=vLANManagementVID, transmitPower=transmitPower, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUVersionBank2=rFUVersionBank2, remoteSecondaryMACAddress=remoteSecondaryMACAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, requestedProtectionState=requestedProtectionState, localPacketFiltering=localPacketFiltering, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, productVariant=productVariant, siteName=siteName, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, unitOutOfCalibration=unitOutOfCalibration, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, securityLevel=securityLevel, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerRetries=sNTPServerRetries, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rFFeederLoss=rFFeederLoss, rFURxFreqMin=rFURxFreqMin, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, sNTPPrimaryServer=sNTPPrimaryServer, rfu=rfu, sNTPPollInterval=sNTPPollInterval, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, rxDiversityDataPortStatus=rxDiversityDataPortStatus, primarySecondaryMode=primarySecondaryMode, productName=productName, encryptionEnabledMismatch=encryptionEnabledMismatch, ptp800=ptp800, radioLicenseBand=radioLicenseBand, ethernetPriorityTable=ethernetPriorityTable, alarms=alarms, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerTable=sNTPServerTable, transmitCapacityLimit=transmitCapacityLimit, radioLicenseMinCodeRate=radioLicenseMinCodeRate, remoteSecondaryIPAddress=remoteSecondaryIPAddress, vectorError=vectorError, maxModulation=maxModulation, systemClock=systemClock, neighborInternetAddressType=neighborInternetAddressType, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, linkNameMismatch=linkNameMismatch, iFCableLength=iFCableLength, radioLicenseRxFreq=radioLicenseRxFreq, secureModeAlarm=secureModeAlarm, protectionStatus=protectionStatus, protectionAvailabilityStatus=protectionAvailabilityStatus, encryption=encryption, receiveDataRate=receiveDataRate, mPLSTCPriorityTable=mPLSTCPriorityTable, rFUActiveFirmwareBank=rFUActiveFirmwareBank, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, encryptionAlgorithm=encryptionAlgorithm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rFUTxPowerMax=rFUTxPowerMax, radioLicenseMaxEIRP=radioLicenseMaxEIRP, iPv6GatewayAddress=iPv6GatewayAddress, syslogState=syslogState, aTPCEnable=aTPCEnable, protectionSwitchCause=protectionSwitchCause, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, userTableNumber=userTableNumber, wirelessLinkStatusTrap=wirelessLinkStatusTrap, numberOfAntennas=numberOfAntennas, transmitterStatus=transmitterStatus, rFUSerial=rFUSerial, ethernetFiberSupport=ethernetFiberSupport, primaryRecoveryPeriod=primaryRecoveryPeriod, sMTPEnabledMessages=sMTPEnabledMessages, rFURfBand=rFURfBand, transmitModulation=transmitModulation, sNTPServerInternetAddressType=sNTPServerInternetAddressType, radioLicenseRegion=radioLicenseRegion, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, dSCPManagementPriority=dSCPManagementPriority, radioLicenseModulation=radioLicenseModulation, qOSPriorityScheme=qOSPriorityScheme, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, phyControl=phyControl, l2CPPriorityTable=l2CPPriorityTable, syslogControl=syslogControl, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rFUType=rFUType, userRole=userRole, rFUProtectionCompatibility=rFUProtectionCompatibility, rFUTxMuteStatus=rFUTxMuteStatus, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, latitude=latitude, sMTPServerIPAddress=sMTPServerIPAddress, userPassword=userPassword, sMTPEmailAlert=sMTPEmailAlert, management=management, activeAvailableTime=activeAvailableTime, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, remoteInternetAddressType=remoteInternetAddressType, rFUBranchingConfiguration=rFUBranchingConfiguration, telnetPortNumber=telnetPortNumber, sNTPServerResponse=sNTPServerResponse, radioLicenseMaxModulation=radioLicenseMaxModulation, protectionStats=protectionStats, transmitCapacityLimitDetail=transmitCapacityLimitDetail, sNMPTrapTableNumber=sNMPTrapTableNumber, remotePrimaryMACAddress=remotePrimaryMACAddress, managementPortStatus=managementPortStatus, supplementary=supplementary, vLANManagementPriority=vLANManagementPriority, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPPortNumber=sNMPPortNumber, dataPortDisabledWarning=dataPortDisabledWarning, gatewayIPAddress=gatewayIPAddress, longitude=longitude, hardwareVersion=hardwareVersion, aggregateDataRate=aggregateDataRate, softwareVersion=softwareVersion, userTableEntry=userTableEntry, protectionStateTrap=protectionStateTrap, sNTPServerTableEntry=sNTPServerTableEntry, iPv4Address=iPv4Address, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapTableIndex=sNMPTrapTableIndex, radioLicenseTxFreq=radioLicenseTxFreq, userTableIndex=userTableIndex, radioLicenseIdentifier=radioLicenseIdentifier, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, protectionState=protectionState, rFULockoutAlarm=rFULockoutAlarm, sNTPServerPortNumber=sNTPServerPortNumber, rFUStatusTrap=rFUStatusTrap, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, sNMPTrapVersion=sNMPTrapVersion, hTTPAccessEnabled=hTTPAccessEnabled, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, radioLicenseBandwidth=radioLicenseBandwidth, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, hTTPPortNumber=hTTPPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, rxDiversityVlanTpid=rxDiversityVlanTpid, transmitCodeRate=transmitCodeRate, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, diverseAntennaGain=diverseAntennaGain, versions=versions, linkLoss=linkLoss, daylightSaving=daylightSaving, bootVersion=bootVersion, iPVersion=iPVersion, sNTPSync=sNTPSync, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, radioLicense=radioLicense, enableTransmission=enableTransmission, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rFUStatus=rFUStatus, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerTimeout=sNTPServerTimeout, rFUPlatformCompatibility=rFUPlatformCompatibility, protectionConfigurationStatus=protectionConfigurationStatus, linkNameMismatchTrap=linkNameMismatchTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dataPortFiberStatus=dataPortFiberStatus, transmitCapacity=transmitCapacity, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveCodeRate=receiveCodeRate, dataPortStatus=dataPortStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, remotePrimaryInternetAddress=remotePrimaryInternetAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, managementPortStatusTrap=managementPortStatusTrap, licence=licence, primaryRecovery=primaryRecovery, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, fiberY=fiberY, sNMPCommunityString=sNMPCommunityString, rFUPowerButtonPressed=rFUPowerButtonPressed, wirelessLinkStatus=wirelessLinkStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPv6PrefixLength=iPv6PrefixLength, cambium=cambium, receivePower=receivePower, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, hTTPSPortNumber=hTTPSPortNumber, managementPortAutoNegotiation=managementPortAutoNegotiation, transmitDataRate=transmitDataRate, radioLicenseMinModulation=radioLicenseMinModulation, ptpTrapPrefix=ptpTrapPrefix, configuration=configuration, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, secureModeAlarmTrap=secureModeAlarmTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, protectionInterfaceStatus=protectionInterfaceStatus, sNMPTrapTable=sNMPTrapTable, neighborInternetAddress=neighborInternetAddress, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rFUTxFreqMax=rFUTxFreqMax, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rFUConnectedPlatform=rFUConnectedPlatform, vLANManagementVIDValidation=vLANManagementVIDValidation, dataPortStatusTrap=dataPortStatusTrap, sNTPLastSync=sNTPLastSync, timeZone=timeZone, rxDiversityVid=rxDiversityVid, minModulation=minModulation, alignmentModeTrap=alignmentModeTrap, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerTableIndex=sNTPServerTableIndex, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, systemReset=systemReset)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetPriorityTableIndex=ethernetPriorityTableIndex, activeWirelessLinkAvailability=activeWirelessLinkAvailability, l2CPPriorityTableEntry=l2CPPriorityTableEntry, pubStats=pubStats, subnetMask=subnetMask, diverseRfFeederLoss=diverseRfFeederLoss, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tFTPServerInternetAddressType=tFTPServerInternetAddressType, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogClientTrap=syslogClientTrap, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, rFUTxBandAboveRx=rFUTxBandAboveRx, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFUTxPowerMin=rFUTxPowerMin, iPv6Address=iPv6Address, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, syslogStateTrap=syslogStateTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, userName=userName, dataPortPauseFrames=dataPortPauseFrames, remoteMACAddress=remoteMACAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, bridge=bridge, remoteInternetAddress=remoteInternetAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rFUCableAlarm=rFUCableAlarm, managementPortWirelessDownAlert=managementPortWirelessDownAlert, antennaGain=antennaGain, activeUnit=activeUnit, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerIPAddress=sNTPServerIPAddress, ptpTraps=ptpTraps, sNMPTrapTableEntry=sNMPTrapTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sMTPServerInternetAddress=sMTPServerInternetAddress, maximumTransmitPower=maximumTransmitPower, protection=protection, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, managementPortConfigurationMismatch=managementPortConfigurationMismatch, userTable=userTable, receiveModulation=receiveModulation, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, userEnabled=userEnabled, rFUPowerAlarm=rFUPowerAlarm, rFUTransceiverLocation=rFUTransceiverLocation, managementMode=managementMode, protectionConfig=protectionConfig, rFUVersionBank1=rFUVersionBank1, radioLicenseCodeRate=radioLicenseCodeRate, remoteIPAddress=remoteIPAddress, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rFUFreqSpacing=rFUFreqSpacing, sntp=sntp, faultProtectionSwitching=faultProtectionSwitching, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, endId=endId, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementCommittedInformationRate=managementCommittedInformationRate, neighborMACAddress=neighborMACAddress, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, phyStatus=phyStatus, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, sNTPServerTableNumber=sNTPServerTableNumber, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, managementPortDisabledWarning=managementPortDisabledWarning, ptmp=ptmp, alignmentMode=alignmentMode, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, snmpControl=snmpControl, neighborIPAddress=neighborIPAddress, ethernet=ethernet, sNMPEnabledTraps=sNMPEnabledTraps, rFURxFreqMax=rFURxFreqMax, rFUTxPowerAlarm=rFUTxPowerAlarm, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, maxCodeRate=maxCodeRate, altitude=altitude, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, ptp=ptp, remotePrimarySecondaryMode=remotePrimarySecondaryMode, tFTPServerPortNumber=tFTPServerPortNumber, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, rFUTxFreqMin=rFUTxFreqMin, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm)
