...
NotificationType, ObjectIdentity, Unsigned32, TimeTicks, Counter64, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, ModuleIdentity, MibIdentifier, IpAddress, Bits, iso, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Unsigned32", "TimeTicks", "Counter64", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "ModuleIdentity", "MibIdentifier", "IpAddress", "Bits", "iso", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, configuration=configuration, linkNameMismatch=linkNameMismatch, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPSyncTrap=sNTPSyncTrap, qOSPriorityScheme=qOSPriorityScheme, userPassword=userPassword, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, rFUVersionBank1=rFUVersionBank1, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, smtp=smtp, rFUTxPowerAlarm=rFUTxPowerAlarm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, radioLicenseRxFreq=radioLicenseRxFreq, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, encryptionEnabledMismatch=encryptionEnabledMismatch, telnetPortNumber=telnetPortNumber, neighborInternetAddressType=neighborInternetAddressType, sNTPPrimaryServer=sNTPPrimaryServer, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, transmitModulation=transmitModulation, versions=versions, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, radioLicenseTxFreq=radioLicenseTxFreq, userTableNumber=userTableNumber, rFUTxBandAboveRx=rFUTxBandAboveRx, rFURfBand=rFURfBand, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, syslogClient=syslogClient, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, snmpControl=snmpControl, timeZone=timeZone, dataPortStatus=dataPortStatus, protectionSwitchCause=protectionSwitchCause, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, mPLSTCPriorityTable=mPLSTCPriorityTable, remoteMACAddress=remoteMACAddress, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, protectionStats=protectionStats, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortStatusTrap=dataPortStatusTrap, hardwareVersion=hardwareVersion, l2CPPriorityTableNumber=l2CPPriorityTableNumber, iFCableLength=iFCableLength, rFUVersionBank2=rFUVersionBank2, dataPortDisabledWarning=dataPortDisabledWarning, radioLicense=radioLicense, sNTPServerTableEntry=sNTPServerTableEntry, secureModeAlarmTrap=secureModeAlarmTrap, rFURxFreqMax=rFURxFreqMax, protectionStatus=protectionStatus, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, remoteIPAddress=remoteIPAddress, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, licence=licence, linkName=linkName, radioLicenseBand=radioLicenseBand, vLANManagementPriority=vLANManagementPriority, supplementary=supplementary, pubStats=pubStats, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, wirelessLinkStatus=wirelessLinkStatus, sNTPServerTableNumber=sNTPServerTableNumber, remotePrimarySecondaryMode=remotePrimarySecondaryMode, remoteSecondaryMACAddress=remoteSecondaryMACAddress, radioLicenseRegion=radioLicenseRegion, siteName=siteName, fiberY=fiberY, managementPortStatus=managementPortStatus, sNTPServerResponse=sNTPServerResponse, alignmentModeTrap=alignmentModeTrap, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, neighborMACAddress=neighborMACAddress, sNTPSync=sNTPSync, hTTPSPortNumber=hTTPSPortNumber, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, sNTPPollInterval=sNTPPollInterval, rFUFreqSpacing=rFUFreqSpacing, sntp=sntp, sNMPEnabledTraps=sNMPEnabledTraps, iPVersion=iPVersion, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hTTPPortNumber=hTTPPortNumber, receiveCodeRate=receiveCodeRate, transmitterStatus=transmitterStatus, userTableEntry=userTableEntry, encryptionAlgorithm=encryptionAlgorithm, encryption=encryption, transmitPower=transmitPower, ptp=ptp, dataPortFiberStatusTrap=dataPortFiberStatusTrap, iPv6PrefixLength=iPv6PrefixLength, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, localPacketFiltering=localPacketFiltering, primarySecondaryMode=primarySecondaryMode, syslogControl=syslogControl, radioLicenseMaxModulation=radioLicenseMaxModulation, managementPortStatusTrap=managementPortStatusTrap, secureModeAlarm=secureModeAlarm, ptmp=ptmp, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, maximumTransmitPower=maximumTransmitPower, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, management=management, rfu=rfu, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, linkNameMismatchTrap=linkNameMismatchTrap, userRole=userRole, phyControl=phyControl, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, ptp800=ptp800, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, dSCPManagementPriority=dSCPManagementPriority, phyStatus=phyStatus, maxCodeRate=maxCodeRate, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rFUTxMuteStatus=rFUTxMuteStatus, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFUConnectedPlatform=rFUConnectedPlatform, transmitCodeRate=transmitCodeRate, receiveModulation=receiveModulation, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, managementCommittedInformationRate=managementCommittedInformationRate, remotePrimaryIPAddress=remotePrimaryIPAddress, rFURFSwitchAlarm=rFURFSwitchAlarm, rFUProtectionCompatibility=rFUProtectionCompatibility, systemClock=systemClock, alignmentMode=alignmentMode, userName=userName, sNMPTrapVersion=sNMPTrapVersion, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPCommunityString=sNMPCommunityString, ptpTrapPrefix=ptpTrapPrefix, wirelessLinkStatusTrap=wirelessLinkStatusTrap, faultProtectionSwitching=faultProtectionSwitching, iPv4Address=iPv4Address, dataPortConfigurationMismatch=dataPortConfigurationMismatch, aTPCEnable=aTPCEnable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, protection=protection, altitude=altitude, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, activeAvailableTime=activeAvailableTime, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, neighborInternetAddress=neighborInternetAddress, syslogState=syslogState, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, protectionInterfaceStatus=protectionInterfaceStatus, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, softwareVersion=softwareVersion, vLANManagementVID=vLANManagementVID, alarms=alarms, subnetMask=subnetMask, sNTPLastSync=sNTPLastSync, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerIPAddress=sNTPServerIPAddress, rFUSerial=rFUSerial, protectionState=protectionState, iPv6GatewayAddress=iPv6GatewayAddress, bridge=bridge, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tFTPServerIPAddress=tFTPServerIPAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, managementPortWirelessDownAlert=managementPortWirelessDownAlert, managementPortDisabledWarning=managementPortDisabledWarning, minCodeRate=minCodeRate, rFUStatus=rFUStatus, sMTPEmailAlert=sMTPEmailAlert, neighborIPAddress=neighborIPAddress, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, activeUnit=activeUnit, rFURpsAlarm=rFURpsAlarm, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFUPowerButtonPressed=rFUPowerButtonPressed, requestedProtectionState=requestedProtectionState, radioLicenseModulation=radioLicenseModulation, protectionStateTrap=protectionStateTrap, transmitDataRate=transmitDataRate, rFUTxFreqMax=rFUTxFreqMax, maxModulation=maxModulation, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, receivePower=receivePower, managementPortForcedConfiguration=managementPortForcedConfiguration, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, syslogClientTrap=syslogClientTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, diverseRfFeederLoss=diverseRfFeederLoss, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, protectionConfig=protectionConfig, vLANManagementVIDValidation=vLANManagementVIDValidation, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remoteSecondaryIPAddress=remoteSecondaryIPAddress, radioLicenseMaxEIRP=radioLicenseMaxEIRP, cambium=cambium, dataPortFiberStatus=dataPortFiberStatus, userEnabled=userEnabled, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, longitude=longitude, protectionAvailabilityStatus=protectionAvailabilityStatus, sNMPTrapTable=sNMPTrapTable, productName=productName, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPServerTable=sNTPServerTable, enableTransmission=enableTransmission, managementMode=managementMode, remotePrimaryMACAddress=remotePrimaryMACAddress, managementPortAutoNegotiation=managementPortAutoNegotiation, rFUBranchingConfiguration=rFUBranchingConfiguration, sMTPEnabledMessages=sMTPEnabledMessages, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sNTPServerPortNumber=sNTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, sNTPState=sNTPState, rFURxFreqMin=rFURxFreqMin, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, bootVersion=bootVersion, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rFUType=rFUType, tFTPServerPortNumber=tFTPServerPortNumber, transmitCapacityLimit=transmitCapacityLimit)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", ethernetPriorityTable=ethernetPriorityTable, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, ethernet=ethernet, aggregateDataRate=aggregateDataRate, ptpTraps=ptpTraps, sNTPServerTableIndex=sNTPServerTableIndex, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, minModulation=minModulation, rxDiversityVlanTpid=rxDiversityVlanTpid, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, unitOutOfCalibration=unitOutOfCalibration, rFULockoutAlarm=rFULockoutAlarm, endId=endId, radioLicenseMinModulation=radioLicenseMinModulation, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, diverseAntennaGain=diverseAntennaGain, sNMPTrapTableNumber=sNMPTrapTableNumber, remotePrimaryInternetAddress=remotePrimaryInternetAddress, telnetAccessEnabled=telnetAccessEnabled, sNTPServerRetries=sNTPServerRetries, iPDSCPPriorityTable=iPDSCPPriorityTable, rFUCableAlarm=rFUCableAlarm, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rFUTxPowerMax=rFUTxPowerMax, sMTPServerPortNumber=sMTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, l2CPPriorityTable=l2CPPriorityTable, tFTPServerInternetAddress=tFTPServerInternetAddress, rFFeederLoss=rFFeederLoss, userTableIndex=userTableIndex, radioLicenseIdentifier=radioLicenseIdentifier, remoteInternetAddress=remoteInternetAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hTTPAccessEnabled=hTTPAccessEnabled, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, productVariant=productVariant, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, transmitCapacityLimitDetail=transmitCapacityLimitDetail, radioLicenseBandwidth=radioLicenseBandwidth, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, remoteInternetAddressType=remoteInternetAddressType, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, primaryRecoveryPeriod=primaryRecoveryPeriod, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFUTransceiverLocation=rFUTransceiverLocation, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, numberOfAntennas=numberOfAntennas, radioLicenseCodeRate=radioLicenseCodeRate, ethernetFiberSupport=ethernetFiberSupport, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerTimeout=sNTPServerTimeout, radioLicenseMinCodeRate=radioLicenseMinCodeRate, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, reset=reset, rFUPowerAlarm=rFUPowerAlarm, rxDiversityVid=rxDiversityVid, antennaGain=antennaGain, userTable=userTable, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dataPortPauseFrames=dataPortPauseFrames, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, daylightSaving=daylightSaving, rFUTxPowerMin=rFUTxPowerMin, receiveDataRate=receiveDataRate, protectionConfigurationStatus=protectionConfigurationStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPPortNumber=sNMPPortNumber, iPv6Address=iPv6Address, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, primaryRecovery=primaryRecovery, securityLevel=securityLevel, latitude=latitude, aAAControl=aAAControl, secondarySoftwareVersion=secondarySoftwareVersion, rFUPlatformCompatibility=rFUPlatformCompatibility, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, linkLoss=linkLoss, syslogStateTrap=syslogStateTrap, transmitCapacity=transmitCapacity, rFUTxFreqMin=rFUTxFreqMin, ethernetPriorityTableIndex=ethernetPriorityTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, systemReset=systemReset, rFUStatusTrap=rFUStatusTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, vectorError=vectorError)
