...
MibIdentifier, iso, NotificationType, Unsigned32, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, ModuleIdentity, Counter64, NotificationType, TimeTicks, ObjectIdentity, Gauge32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "NotificationType", "Unsigned32", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "ModuleIdentity", "Counter64", "NotificationType", "TimeTicks", "ObjectIdentity", "Gauge32", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", alarms=alarms, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, minModulation=minModulation, rFUStatusTrap=rFUStatusTrap, phyControl=phyControl, telnetPortNumber=telnetPortNumber, endId=endId, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerPortNumber=sNTPServerPortNumber, rFUTxBandAboveRx=rFUTxBandAboveRx, ptmp=ptmp, radioLicenseRxFreq=radioLicenseRxFreq, sNTPState=sNTPState, userPassword=userPassword, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, radioLicenseIdentifier=radioLicenseIdentifier, wirelessLinkStatusTrap=wirelessLinkStatusTrap, protectionStateTrap=protectionStateTrap, protectionConfig=protectionConfig, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPCommunityString=sNMPCommunityString, iPv6GatewayAddress=iPv6GatewayAddress, snmpControl=snmpControl, gatewayIPAddress=gatewayIPAddress, aAAControl=aAAControl, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPServerTimeout=sNTPServerTimeout, rFUTransceiverLocation=rFUTransceiverLocation, rFUTxPowerMin=rFUTxPowerMin, hTTPSAccessEnabled=hTTPSAccessEnabled, rxDiversityDataPortStatus=rxDiversityDataPortStatus, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rxDiversityVlanTpid=rxDiversityVlanTpid, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, remoteIPAddress=remoteIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, neighborMACAddress=neighborMACAddress, aTPCEnable=aTPCEnable, userRole=userRole, radioLicenseBandwidth=radioLicenseBandwidth, telnetAccessEnabled=telnetAccessEnabled, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, encryptionAlgorithm=encryptionAlgorithm, fiberY=fiberY, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, sNTPServerIPAddress=sNTPServerIPAddress, iFCableLength=iFCableLength, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, enableTransmission=enableTransmission, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, linkLoss=linkLoss, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, radioLicenseMinModulation=radioLicenseMinModulation, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rFUActiveFirmwareBank=rFUActiveFirmwareBank, latitude=latitude, userTableEntry=userTableEntry, minCodeRate=minCodeRate, rFUCableAlarm=rFUCableAlarm, ptpTraps=ptpTraps, iPv4Address=iPv4Address, rFUTxFreqMax=rFUTxFreqMax, hTTPAccessEnabled=hTTPAccessEnabled, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, hardwareVersion=hardwareVersion, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementPortDisabledWarning=managementPortDisabledWarning, unitOutOfCalibration=unitOutOfCalibration, dataPortFiberStatus=dataPortFiberStatus, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, linkNameMismatchTrap=linkNameMismatchTrap, primarySecondaryMode=primarySecondaryMode, ptp=ptp, sNMPPortNumber=sNMPPortNumber, smtp=smtp, syslogControl=syslogControl, managementPortAutoNegotiation=managementPortAutoNegotiation, rFUTxFreqMin=rFUTxFreqMin, remoteInternetAddress=remoteInternetAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rFUSerial=rFUSerial, localPacketFiltering=localPacketFiltering, managementPortStatusTrap=managementPortStatusTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, secureModeAlarm=secureModeAlarm, bootVersion=bootVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rFURpsAlarm=rFURpsAlarm, rFUPowerButtonPressed=rFUPowerButtonPressed, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, protectionStatus=protectionStatus, sNMPTrapTable=sNMPTrapTable, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, siteName=siteName, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, protection=protection, sNTPServerTableEntry=sNTPServerTableEntry, sNTPLastSync=sNTPLastSync, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, timeZone=timeZone, rfu=rfu, rFUStatus=rFUStatus, transmitModulation=transmitModulation, rFFeederLoss=rFFeederLoss, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, protectionStats=protectionStats, sMTPServerInternetAddressType=sMTPServerInternetAddressType, qOSPriorityScheme=qOSPriorityScheme, iPv6PrefixLength=iPv6PrefixLength, sNTPServerInternetAddress=sNTPServerInternetAddress, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, reset=reset, sNMPTrapTableEntry=sNMPTrapTableEntry, aggregateDataRate=aggregateDataRate, daylightSaving=daylightSaving, sNMPTrapPortNumber=sNMPTrapPortNumber, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, sMTPEnabledMessages=sMTPEnabledMessages, transmitDataRate=transmitDataRate, sNTPServerTableIndex=sNTPServerTableIndex, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, vLANManagementVID=vLANManagementVID, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPServerIPAddress=tFTPServerIPAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, hTTPPortNumber=hTTPPortNumber, vLANManagementVIDValidation=vLANManagementVIDValidation, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUTxPowerAlarm=rFUTxPowerAlarm, remoteSecondaryIPAddress=remoteSecondaryIPAddress, radioLicenseTxFreq=radioLicenseTxFreq, sNMPTrapTableIndex=sNMPTrapTableIndex, diverseRfFeederLoss=diverseRfFeederLoss, managementPortStatus=managementPortStatus, userEnabled=userEnabled, sNTPServerRetries=sNTPServerRetries, sNMPTrapIPAddress=sNMPTrapIPAddress, management=management, sNTPPollInterval=sNTPPollInterval, activeWirelessLinkAvailability=activeWirelessLinkAvailability, diverseAntennaGain=diverseAntennaGain, productVariant=productVariant, radioLicenseMaxEIRP=radioLicenseMaxEIRP, phyStatus=phyStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFURxFreqMax=rFURxFreqMax, receivePower=receivePower, radioLicense=radioLicense, remoteMACAddress=remoteMACAddress, hTTPSPortNumber=hTTPSPortNumber, userTableNumber=userTableNumber, remotePrimaryMACAddress=remotePrimaryMACAddress, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, sMTPServerPortNumber=sMTPServerPortNumber, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, versions=versions, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFURFSwitchAlarm=rFURFSwitchAlarm, activeAvailableTime=activeAvailableTime, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, protectionSwitchCause=protectionSwitchCause, encryptionEnabledMismatch=encryptionEnabledMismatch, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, requestedProtectionState=requestedProtectionState, syslogClient=syslogClient, sNTPPrimaryServer=sNTPPrimaryServer, sMTPServerIPAddress=sMTPServerIPAddress, configuration=configuration, faultProtectionSwitching=faultProtectionSwitching, sNTPServerTableNumber=sNTPServerTableNumber, managementMode=managementMode, syslogState=syslogState, encryption=encryption, bridge=bridge, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, supplementary=supplementary, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, sMTPSourceEmailAddress=sMTPSourceEmailAddress, maximumTransmitPower=maximumTransmitPower, ethernetFiberSupport=ethernetFiberSupport, userTable=userTable, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, managementCommittedInformationRate=managementCommittedInformationRate, userTableIndex=userTableIndex, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, cambium=cambium, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rFUType=rFUType, rxDiversityVid=rxDiversityVid, licence=licence, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, pubStats=pubStats, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFUFreqSpacing=rFUFreqSpacing, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, neighborIPAddress=neighborIPAddress, subnetMask=subnetMask, primaryRecovery=primaryRecovery, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, maxModulation=maxModulation, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rFUConnectedPlatform=rFUConnectedPlatform, receiveCodeRate=receiveCodeRate, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, radioLicenseRegion=radioLicenseRegion, protectionState=protectionState, radioLicenseMaxModulation=radioLicenseMaxModulation, sNMPEnabledTraps=sNMPEnabledTraps, altitude=altitude, vLANManagementPriority=vLANManagementPriority, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPSync=sNTPSync, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, protectionConfigurationStatus=protectionConfigurationStatus, neighborInternetAddressType=neighborInternetAddressType, productName=productName, rFUProtectionCompatibility=rFUProtectionCompatibility, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sNTPServerTable=sNTPServerTable, antennaGain=antennaGain, managementPortForcedConfiguration=managementPortForcedConfiguration, rFUPowerAlarm=rFUPowerAlarm, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataPortStatusTrap=dataPortStatusTrap, ethernet=ethernet, linkNameMismatch=linkNameMismatch)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", mPLSTCPriorityTable=mPLSTCPriorityTable, dataPortStatus=dataPortStatus, systemClock=systemClock, vectorError=vectorError, remoteSecondaryMACAddress=remoteSecondaryMACAddress, ptp800=ptp800, transmitCapacityLimitDetail=transmitCapacityLimitDetail, iPv6Address=iPv6Address, rFUVersionBank2=rFUVersionBank2, transmitCodeRate=transmitCodeRate, rFUTxPowerMax=rFUTxPowerMax, radioLicenseBand=radioLicenseBand, radioLicenseCodeRate=radioLicenseCodeRate, alignmentModeTrap=alignmentModeTrap, syslogClientTrap=syslogClientTrap, protectionInterfaceStatus=protectionInterfaceStatus, dataPortPauseFrames=dataPortPauseFrames, ptpTrapPrefix=ptpTrapPrefix, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPSyncTrap=sNTPSyncTrap, iPVersion=iPVersion, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, activeUnit=activeUnit, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, sntp=sntp, radioLicenseMinCodeRate=radioLicenseMinCodeRate, sNMPTrapVersion=sNMPTrapVersion, remotePrimarySecondaryMode=remotePrimarySecondaryMode, systemReset=systemReset, dSCPManagementPriority=dSCPManagementPriority, rFUPlatformCompatibility=rFUPlatformCompatibility, remotePrimaryIPAddress=remotePrimaryIPAddress, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rFUVersionBank1=rFUVersionBank1, transmitterStatus=transmitterStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, primaryRecoveryPeriod=primaryRecoveryPeriod, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, transmitCapacityLimit=transmitCapacityLimit, tFTPServerPortNumber=tFTPServerPortNumber, rFURfBand=rFURfBand, ethernetPriorityTable=ethernetPriorityTable, transmitCapacity=transmitCapacity, remoteMaximumTransmitPower=remoteMaximumTransmitPower, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, maxCodeRate=maxCodeRate, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, neighborInternetAddress=neighborInternetAddress, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkStatus=wirelessLinkStatus, secondarySoftwareVersion=secondarySoftwareVersion, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, radioLicenseModulation=radioLicenseModulation, userName=userName, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, protectionAvailabilityStatus=protectionAvailabilityStatus, softwareVersion=softwareVersion, tFTPServerInternetAddress=tFTPServerInternetAddress, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, alignmentMode=alignmentMode, remoteInternetAddressType=remoteInternetAddressType, l2CPPriorityTable=l2CPPriorityTable, remotePrimaryInternetAddress=remotePrimaryInternetAddress, rFURxFreqMin=rFURxFreqMin, sNTPServerResponse=sNTPServerResponse, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPServerInternetAddressType=sNTPServerInternetAddressType, syslogStateTrap=syslogStateTrap, linkName=linkName, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rFUTxMuteStatus=rFUTxMuteStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rFULockoutAlarm=rFULockoutAlarm, transmitPower=transmitPower, receiveDataRate=receiveDataRate, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, receiveModulation=receiveModulation, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rFUBranchingConfiguration=rFUBranchingConfiguration, wirelessLinkAvailability=wirelessLinkAvailability, longitude=longitude, securityLevel=securityLevel, numberOfAntennas=numberOfAntennas)
