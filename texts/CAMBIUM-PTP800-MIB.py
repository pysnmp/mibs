...
enterprises, TimeTicks, Gauge32, Counter64, NotificationType, NotificationType, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, iso, Bits, Integer32, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "Gauge32", "Counter64", "NotificationType", "NotificationType", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "iso", "Bits", "Integer32", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", l2CPPriorityTable=l2CPPriorityTable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, radioLicense=radioLicense, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userPassword=userPassword, remoteSecondaryIPAddress=remoteSecondaryIPAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syslogClientTrap=syslogClientTrap, rFUPowerAlarm=rFUPowerAlarm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, hTTPAccessEnabled=hTTPAccessEnabled, receiveCodeRate=receiveCodeRate, iPv6PrefixLength=iPv6PrefixLength, ethernet=ethernet, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, latitude=latitude, rFUTxBandAboveRx=rFUTxBandAboveRx, encryption=encryption, rFUTxFreqMin=rFUTxFreqMin, linkNameMismatch=linkNameMismatch, ptpTrapPrefix=ptpTrapPrefix, hTTPSPortNumber=hTTPSPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, linkNameMismatchTrap=linkNameMismatchTrap, maxModulation=maxModulation, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, dataPortPauseFrames=dataPortPauseFrames, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, radioLicenseCodeRate=radioLicenseCodeRate, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rFUCableAlarm=rFUCableAlarm, subnetMask=subnetMask, sNTPServerTable=sNTPServerTable, primaryRecovery=primaryRecovery, wirelessLinkStatusTrap=wirelessLinkStatusTrap, protection=protection, sNTPServerInternetAddress=sNTPServerInternetAddress, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataPortStatusTrap=dataPortStatusTrap, vectorError=vectorError, managementPortAutoNegotiation=managementPortAutoNegotiation, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, tFTPServerPortNumber=tFTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerResponse=sNTPServerResponse, rFURxFreqMin=rFURxFreqMin, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, sNTPServerTableNumber=sNTPServerTableNumber, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, rFUBranchingConfiguration=rFUBranchingConfiguration, sNTPPollInterval=sNTPPollInterval, productVariant=productVariant, managementPortConfigurationMismatch=managementPortConfigurationMismatch, alignmentModeTrap=alignmentModeTrap, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rFUStatus=rFUStatus, rFUTransceiverLocation=rFUTransceiverLocation, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, radioLicenseModulation=radioLicenseModulation, secondarySoftwareVersion=secondarySoftwareVersion, iPVersion=iPVersion, encryptionEnabledMismatch=encryptionEnabledMismatch, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, protectionStateTrap=protectionStateTrap, managementPortDisabledWarning=managementPortDisabledWarning, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, qOSPriorityScheme=qOSPriorityScheme, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, reset=reset, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, numberOfAntennas=numberOfAntennas, longitude=longitude, ethernetPriorityTableEntry=ethernetPriorityTableEntry, protectionStats=protectionStats, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, radioLicenseMinModulation=radioLicenseMinModulation, ptp=ptp, sNTPServerRetries=sNTPServerRetries, rFURxFreqMax=rFURxFreqMax, primaryRecoveryPeriod=primaryRecoveryPeriod, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerTimeout=sNTPServerTimeout, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, sNTPSync=sNTPSync, activeUnit=activeUnit, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, versions=versions, userTableIndex=userTableIndex, hardwareVersion=hardwareVersion, sNTPServerInternetAddressType=sNTPServerInternetAddressType, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, diverseAntennaGain=diverseAntennaGain, sNMPTrapVersion=sNMPTrapVersion, userName=userName, configuration=configuration, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, aggregateDataRate=aggregateDataRate, dataPortFiberStatus=dataPortFiberStatus, sNMPCommunityString=sNMPCommunityString, activeWirelessLinkAvailability=activeWirelessLinkAvailability, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, transmitCapacityLimitDetail=transmitCapacityLimitDetail, userTable=userTable, bridge=bridge, dataPortDisabledWarning=dataPortDisabledWarning, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, aTPCEnable=aTPCEnable, managementCommittedInformationRate=managementCommittedInformationRate, protectionState=protectionState, rFUSerial=rFUSerial, phyControl=phyControl, rxDiversityDataPortStatus=rxDiversityDataPortStatus, syslogClient=syslogClient, softwareVersion=softwareVersion, remotePrimaryInternetAddress=remotePrimaryInternetAddress, rxDiversityVid=rxDiversityVid, managementPortStatusTrap=managementPortStatusTrap, protectionSwitchCause=protectionSwitchCause, managementPortWirelessDownAlert=managementPortWirelessDownAlert, securityLevel=securityLevel, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, remoteInternetAddressType=remoteInternetAddressType, iPv6GatewayAddress=iPv6GatewayAddress, protectionConfig=protectionConfig, sNTPState=sNTPState, transmitCapacityLimit=transmitCapacityLimit, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, diverseRfFeederLoss=diverseRfFeederLoss, rFUTxPowerMin=rFUTxPowerMin, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFUTxMuteStatus=rFUTxMuteStatus, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, dataPortStatus=dataPortStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, radioLicenseMinCodeRate=radioLicenseMinCodeRate, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteMACAddress=remoteMACAddress, rFUActiveFirmwareBank=rFUActiveFirmwareBank, localPacketFiltering=localPacketFiltering, requestedProtectionState=requestedProtectionState, altitude=altitude, syslogState=syslogState, unitOutOfCalibration=unitOutOfCalibration, pubStats=pubStats, rFURFSwitchAlarm=rFURFSwitchAlarm, tFTPServerInternetAddress=tFTPServerInternetAddress, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, sMTPEnabledMessages=sMTPEnabledMessages, vLANManagementVIDValidation=vLANManagementVIDValidation, radioLicenseMaxEIRP=radioLicenseMaxEIRP, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, transmitterStatus=transmitterStatus, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, linkName=linkName, ethernetPriorityTableNumber=ethernetPriorityTableNumber, phyStatus=phyStatus, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, userTableEntry=userTableEntry, rFUTxPowerMax=rFUTxPowerMax, aAAControl=aAAControl, rFURfBand=rFURfBand, protectionConfigurationStatus=protectionConfigurationStatus, rfu=rfu, radioLicenseTxFreq=radioLicenseTxFreq, management=management, sNMPTrapTable=sNMPTrapTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, minCodeRate=minCodeRate, rFUConnectedPlatform=rFUConnectedPlatform, iPv6Address=iPv6Address, ethernetPriorityTable=ethernetPriorityTable, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, timeZone=timeZone, wirelessLinkStatus=wirelessLinkStatus, faultProtectionSwitching=faultProtectionSwitching, userTableNumber=userTableNumber, supplementary=supplementary, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, neighborIPAddress=neighborIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, sNMPPortNumber=sNMPPortNumber, rFUFreqSpacing=rFUFreqSpacing, sMTPServerPortNumber=sMTPServerPortNumber, alarms=alarms, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, syslogControl=syslogControl, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteInternetAddress=remoteInternetAddress, receiveModulation=receiveModulation, secureModeAlarmTrap=secureModeAlarmTrap, linkLoss=linkLoss, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, managementMode=managementMode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, managementPortStatus=managementPortStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, radioLicenseRxFreq=radioLicenseRxFreq, radioLicenseRegion=radioLicenseRegion, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, remotePrimaryIPAddress=remotePrimaryIPAddress, sNTPLastSync=sNTPLastSync, iPv4Address=iPv4Address, systemClock=systemClock, rFUStatusTrap=rFUStatusTrap, ptpTraps=ptpTraps, dSCPManagementPriority=dSCPManagementPriority, sntp=sntp, iPDSCPPriorityTable=iPDSCPPriorityTable, rFUVersionBank1=rFUVersionBank1, sNTPServerIPAddress=sNTPServerIPAddress, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, radioLicenseMaxModulation=radioLicenseMaxModulation, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rFFeederLoss=rFFeederLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, telnetPortNumber=telnetPortNumber, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, sNTPServerTableEntry=sNTPServerTableEntry, radioLicenseBand=radioLicenseBand, rFUVersionBank2=rFUVersionBank2, cambium=cambium, sNTPServerTableIndex=sNTPServerTableIndex, rFUTxFreqMax=rFUTxFreqMax, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, sNTPPrimaryServer=sNTPPrimaryServer, transmitDataRate=transmitDataRate, primarySecondaryMode=primarySecondaryMode, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", transmitCapacity=transmitCapacity, endId=endId, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, siteName=siteName, rFUProtectionCompatibility=rFUProtectionCompatibility, protectionStatus=protectionStatus, licence=licence, transmitModulation=transmitModulation, activeAvailableTime=activeAvailableTime, dataPortConfigurationMismatch=dataPortConfigurationMismatch, daylightSaving=daylightSaving, rFUType=rFUType, rFUTxPowerAlarm=rFUTxPowerAlarm, ptmp=ptmp, receivePower=receivePower, sNTPServerPortNumber=sNTPServerPortNumber, enableTransmission=enableTransmission, sMTPServerIPAddress=sMTPServerIPAddress, sNTPSyncTrap=sNTPSyncTrap, encryptionAlgorithm=encryptionAlgorithm, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, maximumTransmitPower=maximumTransmitPower, rFULockoutAlarm=rFULockoutAlarm, bootVersion=bootVersion, alignmentMode=alignmentMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortFiberStatusTrap=dataPortFiberStatusTrap, vLANManagementPriority=vLANManagementPriority, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, protectionAvailabilityStatus=protectionAvailabilityStatus, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rFUPowerButtonPressed=rFUPowerButtonPressed, radioLicenseIdentifier=radioLicenseIdentifier, systemReset=systemReset, managementPortForcedConfiguration=managementPortForcedConfiguration, minModulation=minModulation, vLANManagementVID=vLANManagementVID, sNMPEnabledTraps=sNMPEnabledTraps, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, transmitPower=transmitPower, hTTPPortNumber=hTTPPortNumber, neighborInternetAddressType=neighborInternetAddressType, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, gatewayIPAddress=gatewayIPAddress, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, wirelessLinkAvailability=wirelessLinkAvailability, sMTPEmailAlert=sMTPEmailAlert, radioLicenseBandwidth=radioLicenseBandwidth, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, remoteSecondaryMACAddress=remoteSecondaryMACAddress, iFCableLength=iFCableLength, syslogStateTrap=syslogStateTrap, antennaGain=antennaGain, remotePrimaryMACAddress=remotePrimaryMACAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userEnabled=userEnabled, receiveDataRate=receiveDataRate, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, userRole=userRole, sNMPTrapIPAddress=sNMPTrapIPAddress, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, fiberY=fiberY, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, neighborMACAddress=neighborMACAddress, neighborInternetAddress=neighborInternetAddress, rFURpsAlarm=rFURpsAlarm, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, protectionInterfaceStatus=protectionInterfaceStatus, secureModeAlarm=secureModeAlarm, smtp=smtp, ptp800=ptp800, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, productName=productName, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, snmpControl=snmpControl, rFUPlatformCompatibility=rFUPlatformCompatibility, rxDiversityVlanTpid=rxDiversityVlanTpid, telnetAccessEnabled=telnetAccessEnabled, remoteIPAddress=remoteIPAddress, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, ethernetFiberSupport=ethernetFiberSupport, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, transmitCodeRate=transmitCodeRate, maxCodeRate=maxCodeRate, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss)
