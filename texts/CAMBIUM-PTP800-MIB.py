...
MibIdentifier, ObjectIdentity, NotificationType, Counter32, Unsigned32, iso, NotificationType, TimeTicks, Counter64, enterprises, Bits, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "NotificationType", "Counter32", "Unsigned32", "iso", "NotificationType", "TimeTicks", "Counter64", "enterprises", "Bits", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPPrimaryServer=sNTPPrimaryServer, ethernet=ethernet, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, bridge=bridge, iPv6GatewayAddress=iPv6GatewayAddress, encryption=encryption, rFUTxPowerAlarm=rFUTxPowerAlarm, alignmentMode=alignmentMode, sMTPServerPortNumber=sMTPServerPortNumber, rFULockoutAlarm=rFULockoutAlarm, rFUConnectedPlatform=rFUConnectedPlatform, maximumTransmitPower=maximumTransmitPower, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFURxFreqMin=rFURxFreqMin, endId=endId, dataPortConfigurationMismatch=dataPortConfigurationMismatch, protectionAvailabilityStatus=protectionAvailabilityStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, encryptionAlgorithm=encryptionAlgorithm, maxCodeRate=maxCodeRate, requestedProtectionState=requestedProtectionState, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, ptmp=ptmp, phyStatus=phyStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receivePower=receivePower, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerTableNumber=sNTPServerTableNumber, neighborIPAddress=neighborIPAddress, rFUVersionBank2=rFUVersionBank2, transmitterStatus=transmitterStatus, longitude=longitude, radioLicenseRegion=radioLicenseRegion, l2CPPriorityTableNumber=l2CPPriorityTableNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userTableEntry=userTableEntry, managementPortForcedConfiguration=managementPortForcedConfiguration, softwareVersion=softwareVersion, unitOutOfCalibration=unitOutOfCalibration, radioLicenseModulation=radioLicenseModulation, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rFUPlatformCompatibility=rFUPlatformCompatibility, diverseAntennaGain=diverseAntennaGain, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, daylightSaving=daylightSaving, remotePrimaryIPAddress=remotePrimaryIPAddress, managementCommittedInformationRate=managementCommittedInformationRate, activeAvailableTime=activeAvailableTime, secureModeAlarm=secureModeAlarm, iPv4Address=iPv4Address, rFUTxFreqMin=rFUTxFreqMin, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, phyControl=phyControl, ethernetFiberSupport=ethernetFiberSupport, hardwareVersion=hardwareVersion, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, latitude=latitude, sntp=sntp, dataPortFiberStatus=dataPortFiberStatus, protectionConfigurationStatus=protectionConfigurationStatus, sNTPServerTable=sNTPServerTable, remoteMACAddress=remoteMACAddress, sMTPEnabledMessages=sMTPEnabledMessages, systemClock=systemClock, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, transmitCapacity=transmitCapacity, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, syslogStateTrap=syslogStateTrap, remoteIPAddress=remoteIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rxDiversityVid=rxDiversityVid, gatewayIPAddress=gatewayIPAddress, userTable=userTable, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFUTxMuteStatus=rFUTxMuteStatus, siteName=siteName, rFUStatus=rFUStatus, linkNameMismatch=linkNameMismatch, rFUPowerAlarm=rFUPowerAlarm, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFUTxBandAboveRx=rFUTxBandAboveRx, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rFURpsAlarm=rFURpsAlarm, linkLoss=linkLoss, licence=licence, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, neighborInternetAddress=neighborInternetAddress, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFUVersionBank1=rFUVersionBank1, antennaGain=antennaGain, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, protectionConfig=protectionConfig, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vectorError=vectorError, managementPortStatusTrap=managementPortStatusTrap, vLANManagementVID=vLANManagementVID, configuration=configuration, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPServerTableEntry=sNTPServerTableEntry, transmitPower=transmitPower, sNTPSyncTrap=sNTPSyncTrap, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, vLANManagementPriority=vLANManagementPriority, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sNTPServerIPAddress=sNTPServerIPAddress, syslogClient=syslogClient, iFCableLength=iFCableLength, receiveModulation=receiveModulation, managementPortAutoNegotiation=managementPortAutoNegotiation, sMTPEmailAlert=sMTPEmailAlert, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, timeZone=timeZone, management=management, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, sNMPTrapTable=sNMPTrapTable, numberOfAntennas=numberOfAntennas, rFURxFreqMax=rFURxFreqMax, remoteInternetAddressType=remoteInternetAddressType, systemReset=systemReset, rFUFreqSpacing=rFUFreqSpacing, maxModulation=maxModulation, altitude=altitude, radioLicenseBand=radioLicenseBand, iPv6Address=iPv6Address, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rFUPowerButtonPressed=rFUPowerButtonPressed, transmitDataRate=transmitDataRate, iPVersion=iPVersion, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, transmitModulation=transmitModulation, syslogState=syslogState, iPDSCPPriorityTable=iPDSCPPriorityTable, fiberY=fiberY, protection=protection, sNTPLastSync=sNTPLastSync, userName=userName, alignmentModeTrap=alignmentModeTrap, radioLicenseMinCodeRate=radioLicenseMinCodeRate, faultProtectionSwitching=faultProtectionSwitching, radioLicenseCodeRate=radioLicenseCodeRate, pubStats=pubStats, reset=reset, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, radioLicenseIdentifier=radioLicenseIdentifier, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, rFUProtectionCompatibility=rFUProtectionCompatibility, rfu=rfu, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, ptp800=ptp800, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, wirelessLinkStatusTrap=wirelessLinkStatusTrap, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, remoteSecondaryIPAddress=remoteSecondaryIPAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, userEnabled=userEnabled, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, radioLicenseRxFreq=radioLicenseRxFreq, linkName=linkName, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, primarySecondaryMode=primarySecondaryMode, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, sNMPPortNumber=sNMPPortNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, aTPCEnable=aTPCEnable, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, rFUType=rFUType, sNTPState=sNTPState, remoteInternetAddress=remoteInternetAddress, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remotePrimaryInternetAddress=remotePrimaryInternetAddress, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, protectionSwitchCause=protectionSwitchCause, rFUSerial=rFUSerial, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, snmpControl=snmpControl, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, aggregateDataRate=aggregateDataRate, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rFURfBand=rFURfBand, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, ethernetPriorityTable=ethernetPriorityTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, productVariant=productVariant, securityLevel=securityLevel, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, sNMPTrapTableNumber=sNMPTrapTableNumber, alarms=alarms, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, remotePrimaryMACAddress=remotePrimaryMACAddress, localPacketFiltering=localPacketFiltering, minCodeRate=minCodeRate, userRole=userRole, protectionStateTrap=protectionStateTrap, rFURFSwitchAlarm=rFURFSwitchAlarm, ptpTrapPrefix=ptpTrapPrefix, sNTPServerTableIndex=sNTPServerTableIndex, activeUnit=activeUnit, sNMPTrapVersion=sNMPTrapVersion, sNTPServerTimeout=sNTPServerTimeout, sNMPEnabledTraps=sNMPEnabledTraps, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rFUTransceiverLocation=rFUTransceiverLocation, managementPortDisabledWarning=managementPortDisabledWarning, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, userTableIndex=userTableIndex, protectionInterfaceStatus=protectionInterfaceStatus, sNTPPollInterval=sNTPPollInterval, transmitCapacityLimitDetail=transmitCapacityLimitDetail, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, receiveCodeRate=receiveCodeRate, sNTPSync=sNTPSync, dataPortPauseFrames=dataPortPauseFrames, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, hTTPPortNumber=hTTPPortNumber, dSCPManagementPriority=dSCPManagementPriority, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUTxPowerMax=rFUTxPowerMax, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, minModulation=minModulation, neighborInternetAddressType=neighborInternetAddressType, qOSPriorityScheme=qOSPriorityScheme, managementPortStatus=managementPortStatus, smtp=smtp, syslogControl=syslogControl, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", iPv6PrefixLength=iPv6PrefixLength, rFUCableAlarm=rFUCableAlarm, l2CPPriorityTable=l2CPPriorityTable, wirelessLinkAvailability=wirelessLinkAvailability, dataPortStatusTrap=dataPortStatusTrap, bootVersion=bootVersion, managementPortWirelessDownAlert=managementPortWirelessDownAlert, activeWirelessLinkAvailability=activeWirelessLinkAvailability, subnetMask=subnetMask, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerRetries=sNTPServerRetries, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessLinkStatus=wirelessLinkStatus, tFTPServerIPAddress=tFTPServerIPAddress, protectionStatus=protectionStatus, vLANManagementVIDValidation=vLANManagementVIDValidation, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogClientTrap=syslogClientTrap, aAAControl=aAAControl, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, radioLicenseMinModulation=radioLicenseMinModulation, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, radioLicenseMaxModulation=radioLicenseMaxModulation, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, transmitCapacityLimit=transmitCapacityLimit, sNMPCommunityString=sNMPCommunityString, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernetPriorityTableEntry=ethernetPriorityTableEntry, linkNameMismatchTrap=linkNameMismatchTrap, secondarySoftwareVersion=secondarySoftwareVersion, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptp=ptp, rxDiversityVlanTpid=rxDiversityVlanTpid, protectionStats=protectionStats, neighborMACAddress=neighborMACAddress, rFUStatusTrap=rFUStatusTrap, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, radioLicenseTxFreq=radioLicenseTxFreq, encryptionEnabledMismatch=encryptionEnabledMismatch, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPServerInternetAddress=sNTPServerInternetAddress, enableTransmission=enableTransmission, diverseRfFeederLoss=diverseRfFeederLoss, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, userTableNumber=userTableNumber, productName=productName, rFUTxFreqMax=rFUTxFreqMax, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, radioLicenseBandwidth=radioLicenseBandwidth, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, sNTPServerResponse=sNTPServerResponse, managementMode=managementMode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, cambium=cambium, rFFeederLoss=rFFeederLoss, radioLicenseMaxEIRP=radioLicenseMaxEIRP, versions=versions, telnetPortNumber=telnetPortNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userPassword=userPassword, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rFUTxPowerMin=rFUTxPowerMin, remotePrimarySecondaryMode=remotePrimarySecondaryMode, receiveDataRate=receiveDataRate, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortDisabledWarning=dataPortDisabledWarning, rFUActiveFirmwareBank=rFUActiveFirmwareBank, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFUBranchingConfiguration=rFUBranchingConfiguration, radioLicense=radioLicense, transmitCodeRate=transmitCodeRate, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, hTTPSPortNumber=hTTPSPortNumber, supplementary=supplementary, dataPortStatus=dataPortStatus, protectionState=protectionState, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, primaryRecoveryPeriod=primaryRecoveryPeriod, ptpTraps=ptpTraps, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, primaryRecovery=primaryRecovery, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap)
