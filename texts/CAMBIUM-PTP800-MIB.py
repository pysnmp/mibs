...
Gauge32, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ObjectIdentity, Counter64, MibIdentifier, IpAddress, Integer32, Counter32, NotificationType, TimeTicks, Bits, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ObjectIdentity", "Counter64", "MibIdentifier", "IpAddress", "Integer32", "Counter32", "NotificationType", "TimeTicks", "Bits", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", protectionStats=protectionStats, rFUTxFreqMin=rFUTxFreqMin, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, receiveModulation=receiveModulation, rFUConnectedPlatform=rFUConnectedPlatform, phyStatus=phyStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, transmitCodeRate=transmitCodeRate, altitude=altitude, rFURxFreqMax=rFURxFreqMax, userPassword=userPassword, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, dataPortPauseFrames=dataPortPauseFrames, sNTPServerTableEntry=sNTPServerTableEntry, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, rFUFreqSpacing=rFUFreqSpacing, userTableEntry=userTableEntry, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, protectionInterfaceStatus=protectionInterfaceStatus, radioLicenseMinCodeRate=radioLicenseMinCodeRate, iPv6PrefixLength=iPv6PrefixLength, tFTPServerPortNumber=tFTPServerPortNumber, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, sNTPServerTableIndex=sNTPServerTableIndex, rFUBranchingConfiguration=rFUBranchingConfiguration, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, neighborInternetAddress=neighborInternetAddress, radioLicenseIdentifier=radioLicenseIdentifier, requestedProtectionState=requestedProtectionState, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPState=sNTPState, siteName=siteName, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rFUPowerButtonPressed=rFUPowerButtonPressed, iPDSCPPriorityTable=iPDSCPPriorityTable, telnetPortNumber=telnetPortNumber, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, linkNameMismatch=linkNameMismatch, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, userName=userName, protectionStateTrap=protectionStateTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, latitude=latitude, sNMPTrapTableIndex=sNMPTrapTableIndex, aAAControl=aAAControl, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, radioLicenseMaxModulation=radioLicenseMaxModulation, sMTPServerInternetAddressType=sMTPServerInternetAddressType, transmitCapacityLimitDetail=transmitCapacityLimitDetail, antennaGain=antennaGain, productName=productName, ptpTrapPrefix=ptpTrapPrefix, hTTPSPortNumber=hTTPSPortNumber, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, primaryRecoveryPeriod=primaryRecoveryPeriod, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, protectionConfig=protectionConfig, configuration=configuration, syslogLocalWrappedTrap=syslogLocalWrappedTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, managementMode=managementMode, secureModeAlarm=secureModeAlarm, protectionStatus=protectionStatus, sNTPServerRetries=sNTPServerRetries, bootVersion=bootVersion, rFULockoutAlarm=rFULockoutAlarm, snmpControl=snmpControl, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, l2CPPriorityTable=l2CPPriorityTable, transmitCapacity=transmitCapacity, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, tFTPServerIPAddress=tFTPServerIPAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, remoteIPAddress=remoteIPAddress, sNMPCommunityString=sNMPCommunityString, rFUTxPowerMin=rFUTxPowerMin, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, transmitterStatus=transmitterStatus, alarms=alarms, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, reset=reset, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerTable=sNTPServerTable, remoteSecondaryMACAddress=remoteSecondaryMACAddress, sMTPServerIPAddress=sMTPServerIPAddress, hTTPAccessEnabled=hTTPAccessEnabled, syslogClientTrap=syslogClientTrap, management=management, syslogClient=syslogClient, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, enableTransmission=enableTransmission, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFUPlatformCompatibility=rFUPlatformCompatibility, linkNameMismatchTrap=linkNameMismatchTrap, longitude=longitude, sNMPPortNumber=sNMPPortNumber, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, iPVersion=iPVersion, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, ethernetPriorityTableNumber=ethernetPriorityTableNumber, remoteInternetAddressType=remoteInternetAddressType, managementPortStatus=managementPortStatus, encryptionEnabledMismatch=encryptionEnabledMismatch, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, neighborInternetAddressType=neighborInternetAddressType, diverseAntennaGain=diverseAntennaGain, transmitPower=transmitPower, rxDiversityVid=rxDiversityVid, ptp=ptp, sMTPServerInternetAddress=sMTPServerInternetAddress, rFUProtectionCompatibility=rFUProtectionCompatibility, sNTPLastSync=sNTPLastSync, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, aTPCEnable=aTPCEnable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapVersion=sNMPTrapVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, ethernetPriorityTable=ethernetPriorityTable, managementPortStatusTrap=managementPortStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, versions=versions, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, vLANManagementPriority=vLANManagementPriority, protectionState=protectionState, rFUCableAlarm=rFUCableAlarm, iPv6Address=iPv6Address, remoteInternetAddress=remoteInternetAddress, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, minModulation=minModulation, secondarySoftwareVersion=secondarySoftwareVersion, rFUTxFreqMax=rFUTxFreqMax, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, pubStats=pubStats, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, protectionConfigurationStatus=protectionConfigurationStatus, activeUnit=activeUnit, aggregateDataRate=aggregateDataRate, rFURFSwitchAlarm=rFURFSwitchAlarm, fiberY=fiberY, licence=licence, dataPortFiberStatus=dataPortFiberStatus, primaryRecovery=primaryRecovery, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rfu=rfu, hardwareVersion=hardwareVersion, supplementary=supplementary, linkName=linkName, protectionSwitchCause=protectionSwitchCause, ethernetFiberSupport=ethernetFiberSupport, secureModeAlarmTrap=secureModeAlarmTrap, neighborMACAddress=neighborMACAddress, faultProtectionSwitching=faultProtectionSwitching, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tFTPServerInternetAddressType=tFTPServerInternetAddressType, neighborIPAddress=neighborIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, l2CPPriorityTableEntry=l2CPPriorityTableEntry, userTable=userTable, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, remotePrimaryMACAddress=remotePrimaryMACAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, activeAvailableTime=activeAvailableTime, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, rFUTxPowerMax=rFUTxPowerMax, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, vLANManagementVID=vLANManagementVID, remoteSecondaryIPAddress=remoteSecondaryIPAddress, dSCPManagementPriority=dSCPManagementPriority, iPv6GatewayAddress=iPv6GatewayAddress, ethernet=ethernet, mPLSTCPriorityTable=mPLSTCPriorityTable, radioLicenseTxFreq=radioLicenseTxFreq, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, maximumTransmitPower=maximumTransmitPower, sNTPPrimaryServer=sNTPPrimaryServer, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFUTxPowerAlarm=rFUTxPowerAlarm, sNMPTrapIPAddress=sNMPTrapIPAddress, systemClock=systemClock, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, alignmentModeTrap=alignmentModeTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, vectorError=vectorError, managementPortForcedConfiguration=managementPortForcedConfiguration, wirelessLinkStatusTrap=wirelessLinkStatusTrap, minCodeRate=minCodeRate, rFURpsAlarm=rFURpsAlarm, managementCommittedInformationRate=managementCommittedInformationRate, cambium=cambium, userTableNumber=userTableNumber, maxModulation=maxModulation, rFUType=rFUType, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, radioLicense=radioLicense, managementPortConfigurationMismatch=managementPortConfigurationMismatch, receiveCodeRate=receiveCodeRate, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, sMTPEmailAlert=sMTPEmailAlert, sNTPPollInterval=sNTPPollInterval, securityLevel=securityLevel, sNTPSync=sNTPSync, remotePrimaryInternetAddress=remotePrimaryInternetAddress, sNTPServerPortNumber=sNTPServerPortNumber, numberOfAntennas=numberOfAntennas, smtp=smtp, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dataPortStatus=dataPortStatus, iFCableLength=iFCableLength, gatewayIPAddress=gatewayIPAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, subnetMask=subnetMask, telnetAccessEnabled=telnetAccessEnabled, endId=endId, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ptmp=ptmp, userTableIndex=userTableIndex, unitOutOfCalibration=unitOutOfCalibration, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, radioLicenseMinModulation=radioLicenseMinModulation, encryption=encryption, rxDiversityVlanTpid=rxDiversityVlanTpid, linkLoss=linkLoss, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, sNMPEnabledTraps=sNMPEnabledTraps, rFFeederLoss=rFFeederLoss, sNTPSyncTrap=sNTPSyncTrap, rFURxFreqMin=rFURxFreqMin, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, timeZone=timeZone, transmitDataRate=transmitDataRate, sNTPServerResponse=sNTPServerResponse, rxDiversityDataPortStatus=rxDiversityDataPortStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, rFUVersionBank2=rFUVersionBank2, iPv4Address=iPv4Address)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNTPServerTimeout=sNTPServerTimeout, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataPortStatusTrap=dataPortStatusTrap, sNTPServerIPAddress=sNTPServerIPAddress, receivePower=receivePower, radioLicenseRxFreq=radioLicenseRxFreq, rFUTxMuteStatus=rFUTxMuteStatus, systemReset=systemReset, transmitCapacityLimit=transmitCapacityLimit, rFUActiveFirmwareBank=rFUActiveFirmwareBank, sMTPEnabledMessages=sMTPEnabledMessages, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, vLANManagementVIDValidation=vLANManagementVIDValidation, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, protectionAvailabilityStatus=protectionAvailabilityStatus, syslogStateTrap=syslogStateTrap, sNMPTrapTable=sNMPTrapTable, daylightSaving=daylightSaving, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, syslogControl=syslogControl, alignmentMode=alignmentMode, receiveDataRate=receiveDataRate, qOSPriorityScheme=qOSPriorityScheme, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, primarySecondaryMode=primarySecondaryMode, softwareVersion=softwareVersion, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, transmitModulation=transmitModulation, remotePrimarySecondaryMode=remotePrimarySecondaryMode, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, encryptionAlgorithm=encryptionAlgorithm, syslogState=syslogState, rFURfBand=rFURfBand, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ptpTraps=ptpTraps, rFUPowerAlarm=rFUPowerAlarm, rFUStatusTrap=rFUStatusTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFUVersionBank1=rFUVersionBank1, enabledDiagnosticAlarms=enabledDiagnosticAlarms, diverseRfFeederLoss=diverseRfFeederLoss, sNTPServerTableNumber=sNTPServerTableNumber, radioLicenseCodeRate=radioLicenseCodeRate, hTTPPortNumber=hTTPPortNumber, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, ptp800=ptp800, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, tFTPServerInternetAddress=tFTPServerInternetAddress, radioLicenseRegion=radioLicenseRegion, bridge=bridge, rFUTransceiverLocation=rFUTransceiverLocation, userEnabled=userEnabled, rFUTxBandAboveRx=rFUTxBandAboveRx, radioLicenseModulation=radioLicenseModulation, sMTPServerPortNumber=sMTPServerPortNumber, localPacketFiltering=localPacketFiltering, phyControl=phyControl, radioLicenseBand=radioLicenseBand, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, maxCodeRate=maxCodeRate, protection=protection, managementPortAutoNegotiation=managementPortAutoNegotiation, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, radioLicenseBandwidth=radioLicenseBandwidth, dataPortWirelessDownAlert=dataPortWirelessDownAlert, productVariant=productVariant, dataPortDisabledWarning=dataPortDisabledWarning, remotePrimaryIPAddress=remotePrimaryIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, activeWirelessLinkAvailability=activeWirelessLinkAvailability, userRole=userRole, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, wirelessLinkStatus=wirelessLinkStatus, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, remoteMACAddress=remoteMACAddress, rFUSerial=rFUSerial, managementPortDisabledWarning=managementPortDisabledWarning, sntp=sntp, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rFUStatus=rFUStatus)
