...
ObjectIdentity, IpAddress, Unsigned32, Counter32, Bits, MibIdentifier, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, enterprises, NotificationType, Integer32, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Unsigned32", "Counter32", "Bits", "MibIdentifier", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "enterprises", "NotificationType", "Integer32", "NotificationType", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUTxFreqMin=rFUTxFreqMin, fiberY=fiberY, transmitModulation=transmitModulation, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, userRole=userRole, managementPortStatus=managementPortStatus, longitude=longitude, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, unitOutOfCalibration=unitOutOfCalibration, radioLicenseCodeRate=radioLicenseCodeRate, transmitCapacityLimitDetail=transmitCapacityLimitDetail, systemClock=systemClock, sNMPTrapTableEntry=sNMPTrapTableEntry, rFURxFreqMin=rFURxFreqMin, sNMPTrapTableNumber=sNMPTrapTableNumber, userTableEntry=userTableEntry, productVariant=productVariant, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveModulation=receiveModulation, encryptionEnabledMismatch=encryptionEnabledMismatch, rFUTxPowerMin=rFUTxPowerMin, telnetPortNumber=telnetPortNumber, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, diverseRfFeederLoss=diverseRfFeederLoss, iFCableLength=iFCableLength, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, minModulation=minModulation, sNTPSyncTrap=sNTPSyncTrap, rFUConnectedPlatform=rFUConnectedPlatform, endId=endId, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapTable=sNMPTrapTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, secureModeAlarm=secureModeAlarm, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, rFUTxBandAboveRx=rFUTxBandAboveRx, activeUnit=activeUnit, rFUProtectionCompatibility=rFUProtectionCompatibility, sNMPEnabledTraps=sNMPEnabledTraps, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, protectionSwitchCause=protectionSwitchCause, dataPortFiberStatus=dataPortFiberStatus, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, neighborIPAddress=neighborIPAddress, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, syslogControl=syslogControl, radioLicenseMinModulation=radioLicenseMinModulation, managementPortWirelessDownAlert=managementPortWirelessDownAlert, mPLSTCPriorityTable=mPLSTCPriorityTable, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, activeWirelessLinkAvailability=activeWirelessLinkAvailability, diverseAntennaGain=diverseAntennaGain, protectionConfig=protectionConfig, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, ptp800=ptp800, userTableNumber=userTableNumber, transmitCodeRate=transmitCodeRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, syslogStateTrap=syslogStateTrap, radioLicense=radioLicense, l2CPPriorityTableIndex=l2CPPriorityTableIndex, vLANManagementVIDValidation=vLANManagementVIDValidation, sNMPTrapTableIndex=sNMPTrapTableIndex, rFUVersionBank1=rFUVersionBank1, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, transmitPower=transmitPower, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, protectionStats=protectionStats, minCodeRate=minCodeRate, alarms=alarms, primaryRecovery=primaryRecovery, sNTPState=sNTPState, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rxDiversityVid=rxDiversityVid, radioLicenseIdentifier=radioLicenseIdentifier, ptp=ptp, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, neighborInternetAddress=neighborInternetAddress, alignmentMode=alignmentMode, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, rFUTxPowerAlarm=rFUTxPowerAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerResponse=sNTPServerResponse, rFULockoutAlarm=rFULockoutAlarm, telnetAccessEnabled=telnetAccessEnabled, sNTPServerTableIndex=sNTPServerTableIndex, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, qOSPriorityScheme=qOSPriorityScheme, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, managementCommittedInformationRate=managementCommittedInformationRate, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerRetries=sNTPServerRetries, sMTPServerPortNumber=sMTPServerPortNumber, protectionStatus=protectionStatus, rFUFreqSpacing=rFUFreqSpacing, antennaGain=antennaGain, dataPortPauseFrames=dataPortPauseFrames, managementPortAutoNegotiation=managementPortAutoNegotiation, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rFUPowerButtonPressed=rFUPowerButtonPressed, maxModulation=maxModulation, syslogState=syslogState, radioLicenseTxFreq=radioLicenseTxFreq, sNTPServerPortNumber=sNTPServerPortNumber, transmitCapacityLimit=transmitCapacityLimit, rFUSerial=rFUSerial, vLANManagementPriority=vLANManagementPriority, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, aAAControl=aAAControl, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, subnetMask=subnetMask, remotePrimarySecondaryMode=remotePrimarySecondaryMode, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, encryption=encryption, ethernetPriorityTableNumber=ethernetPriorityTableNumber, timeZone=timeZone, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, altitude=altitude, l2CPPriorityTableEntry=l2CPPriorityTableEntry, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptmp=ptmp, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, primarySecondaryMode=primarySecondaryMode, radioLicenseRxFreq=radioLicenseRxFreq, dataPortDisabledWarning=dataPortDisabledWarning, remoteSecondaryIPAddress=remoteSecondaryIPAddress, vectorError=vectorError, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, radioLicenseRegion=radioLicenseRegion, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, linkLoss=linkLoss, wirelessLinkStatusTrap=wirelessLinkStatusTrap, hardwareVersion=hardwareVersion, protectionAvailabilityStatus=protectionAvailabilityStatus, protection=protection, syslogLocalWrappedTrap=syslogLocalWrappedTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, pubStats=pubStats, sNTPPollInterval=sNTPPollInterval, linkNameMismatchTrap=linkNameMismatchTrap, rFUStatus=rFUStatus, dataPortStatusTrap=dataPortStatusTrap, supplementary=supplementary, localPacketFiltering=localPacketFiltering, siteName=siteName, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogClient=syslogClient, radioLicenseMaxEIRP=radioLicenseMaxEIRP, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, hTTPSAccessEnabled=hTTPSAccessEnabled, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rFURxFreqMax=rFURxFreqMax, protectionInterfaceStatus=protectionInterfaceStatus, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFUTransceiverLocation=rFUTransceiverLocation, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, wirelessLinkAvailability=wirelessLinkAvailability, remoteInternetAddressType=remoteInternetAddressType, dataPortStatus=dataPortStatus, sNTPServerTable=sNTPServerTable, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rFUTxPowerMax=rFUTxPowerMax, bridge=bridge, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, userTableIndex=userTableIndex, numberOfAntennas=numberOfAntennas, phyControl=phyControl, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, ethernet=ethernet, rFUTxFreqMax=rFUTxFreqMax, transmitterStatus=transmitterStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, hTTPAccessEnabled=hTTPAccessEnabled, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, remotePrimaryMACAddress=remotePrimaryMACAddress, latitude=latitude, enableTransmission=enableTransmission, sMTPEmailAlert=sMTPEmailAlert, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rFUPowerAlarm=rFUPowerAlarm, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, rFUBranchingConfiguration=rFUBranchingConfiguration, configuration=configuration, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, userEnabled=userEnabled, linkName=linkName, sMTPEnabledMessages=sMTPEnabledMessages, useVLANForManagementInterfaces=useVLANForManagementInterfaces, primaryRecoveryPeriod=primaryRecoveryPeriod, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, linkNameMismatch=linkNameMismatch, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, sNMPPortNumber=sNMPPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPServerTimeout=sNTPServerTimeout, remoteMACAddress=remoteMACAddress, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, dataPortFiberStatusTrap=dataPortFiberStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, maxCodeRate=maxCodeRate, systemReset=systemReset, radioLicenseMinCodeRate=radioLicenseMinCodeRate, activeAvailableTime=activeAvailableTime, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rFUStatusTrap=rFUStatusTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, smtp=smtp, productName=productName, sNTPSync=sNTPSync, neighborInternetAddressType=neighborInternetAddressType, ptpTraps=ptpTraps, securityLevel=securityLevel, transmitDataRate=transmitDataRate, syslogClientTrap=syslogClientTrap, gatewayIPAddress=gatewayIPAddress, l2CPPriorityTable=l2CPPriorityTable, snmpControl=snmpControl, softwareVersion=softwareVersion, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rfu=rfu, neighborMACAddress=neighborMACAddress, remoteInternetAddress=remoteInternetAddress, rFUCableAlarm=rFUCableAlarm, protectionState=protectionState, requestedProtectionState=requestedProtectionState, rFUPlatformCompatibility=rFUPlatformCompatibility, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, reset=reset, secureModeAlarmTrap=secureModeAlarmTrap, managementPortStatusTrap=managementPortStatusTrap, cambium=cambium)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", managementPortForcedConfiguration=managementPortForcedConfiguration, ethernetPriorityTable=ethernetPriorityTable, remoteIPAddress=remoteIPAddress, remotePrimaryInternetAddress=remotePrimaryInternetAddress, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, radioLicenseModulation=radioLicenseModulation, sNMPCommunityString=sNMPCommunityString, sNMPTrapIPAddress=sNMPTrapIPAddress, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, faultProtectionSwitching=faultProtectionSwitching, rFUType=rFUType, aTPCEnable=aTPCEnable, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, encryptionAlgorithm=encryptionAlgorithm, radioLicenseMaxModulation=radioLicenseMaxModulation, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rxDiversityVlanTpid=rxDiversityVlanTpid, iPv4Address=iPv4Address, bootVersion=bootVersion, rFFeederLoss=rFFeederLoss, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hTTPSPortNumber=hTTPSPortNumber, hTTPPortNumber=hTTPPortNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, sNMPTrapVersion=sNMPTrapVersion, wirelessLinkStatus=wirelessLinkStatus, managementPortDisabledWarning=managementPortDisabledWarning, rFURFSwitchAlarm=rFURFSwitchAlarm, ethernetFiberSupport=ethernetFiberSupport, tFTPServerIPAddress=tFTPServerIPAddress, iPVersion=iPVersion, ptpTrapPrefix=ptpTrapPrefix, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rxDiversityDataPortStatus=rxDiversityDataPortStatus, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, management=management, radioLicenseBandwidth=radioLicenseBandwidth, transmitCapacity=transmitCapacity, radioLicenseBand=radioLicenseBand, protectionConfigurationStatus=protectionConfigurationStatus, vLANManagementVID=vLANManagementVID, remoteSecondaryMACAddress=remoteSecondaryMACAddress, userName=userName, receivePower=receivePower, licence=licence, managementMode=managementMode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sntp=sntp, protectionStateTrap=protectionStateTrap, rFURpsAlarm=rFURpsAlarm, sNTPServerTableNumber=sNTPServerTableNumber, sNTPPrimaryServer=sNTPPrimaryServer, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sMTPServerInternetAddressType=sMTPServerInternetAddressType, alignmentModeTrap=alignmentModeTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dSCPManagementPriority=dSCPManagementPriority, rFUTxMuteStatus=rFUTxMuteStatus, daylightSaving=daylightSaving, sNTPServerTableEntry=sNTPServerTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rFUVersionBank2=rFUVersionBank2, versions=versions, receiveCodeRate=receiveCodeRate, phyStatus=phyStatus, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, iPv6Address=iPv6Address, maximumTransmitPower=maximumTransmitPower, userPassword=userPassword, sNTPLastSync=sNTPLastSync, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, iPv6PrefixLength=iPv6PrefixLength, userTable=userTable, sNTPServerIPAddress=sNTPServerIPAddress, receiveDataRate=receiveDataRate, remotePrimaryIPAddress=remotePrimaryIPAddress, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rFURfBand=rFURfBand, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm)
