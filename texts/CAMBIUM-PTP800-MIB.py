...
MibIdentifier, NotificationType, NotificationType, Counter64, enterprises, TimeTicks, Unsigned32, Gauge32, iso, ModuleIdentity, ObjectIdentity, IpAddress, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "NotificationType", "Counter64", "enterprises", "TimeTicks", "Unsigned32", "Gauge32", "iso", "ModuleIdentity", "ObjectIdentity", "IpAddress", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", activeAvailableTime=activeAvailableTime, linkNameMismatch=linkNameMismatch, rFUTxBandAboveRx=rFUTxBandAboveRx, remotePrimaryInternetAddress=remotePrimaryInternetAddress, hTTPSPortNumber=hTTPSPortNumber, dSCPManagementPriority=dSCPManagementPriority, fiberY=fiberY, radioLicenseMinCodeRate=radioLicenseMinCodeRate, aAAControl=aAAControl, ptp800=ptp800, timeZone=timeZone, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, rFUPowerButtonPressed=rFUPowerButtonPressed, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, bootVersion=bootVersion, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, productVariant=productVariant, rFULockoutAlarm=rFULockoutAlarm, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, activeUnit=activeUnit, rFUVersionBank1=rFUVersionBank1, gatewayIPAddress=gatewayIPAddress, configuration=configuration, diverseRfFeederLoss=diverseRfFeederLoss, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, radioLicenseRxFreq=radioLicenseRxFreq, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, managementPortStatusTrap=managementPortStatusTrap, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, licence=licence, userRole=userRole, rFUTxMuteStatus=rFUTxMuteStatus, systemClock=systemClock, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, radioLicenseBandwidth=radioLicenseBandwidth, aTPCEnable=aTPCEnable, snmpControl=snmpControl, sNTPServerTable=sNTPServerTable, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rFUPowerAlarm=rFUPowerAlarm, neighborMACAddress=neighborMACAddress, sNTPServerPortNumber=sNTPServerPortNumber, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, management=management, tFTPServerPortNumber=tFTPServerPortNumber, secureModeAlarm=secureModeAlarm, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, protectionState=protectionState, sNTPServerTableIndex=sNTPServerTableIndex, tFTPServerInternetAddressType=tFTPServerInternetAddressType, neighborIPAddress=neighborIPAddress, neighborInternetAddress=neighborInternetAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFUTransceiverLocation=rFUTransceiverLocation, encryption=encryption, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, l2CPPriorityTableIndex=l2CPPriorityTableIndex, syslogClientTrap=syslogClientTrap, transmitModulation=transmitModulation, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, iPv6Address=iPv6Address, minModulation=minModulation, transmitPower=transmitPower, rFFeederLoss=rFFeederLoss, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rFUConnectedPlatform=rFUConnectedPlatform, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, userPassword=userPassword, unitOutOfCalibration=unitOutOfCalibration, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, managementPortForcedConfiguration=managementPortForcedConfiguration, ptp=ptp, systemReset=systemReset, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rFUCableAlarm=rFUCableAlarm, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, diverseAntennaGain=diverseAntennaGain, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, neighborInternetAddressType=neighborInternetAddressType, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, protectionConfig=protectionConfig, wirelessLinkAvailability=wirelessLinkAvailability, altitude=altitude, dataPortStatus=dataPortStatus, rFUSerial=rFUSerial, cambium=cambium, pubStats=pubStats, sNTPLastSync=sNTPLastSync, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTable=sNMPTrapTable, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerIPAddress=sNTPServerIPAddress, receiveDataRate=receiveDataRate, rxDiversityVlanTpid=rxDiversityVlanTpid, radioLicense=radioLicense, tFTPServerIPAddress=tFTPServerIPAddress, remotePrimaryMACAddress=remotePrimaryMACAddress, rFUPlatformCompatibility=rFUPlatformCompatibility, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPv6PrefixLength=iPv6PrefixLength, receivePower=receivePower, sNMPTrapVersion=sNMPTrapVersion, rFUStatusTrap=rFUStatusTrap, vLANManagementPriority=vLANManagementPriority, managementCommittedInformationRate=managementCommittedInformationRate, rFUProtectionCompatibility=rFUProtectionCompatibility, managementPortAutoNegotiation=managementPortAutoNegotiation, remotePrimaryIPAddress=remotePrimaryIPAddress, transmitterStatus=transmitterStatus, sNTPPrimaryServer=sNTPPrimaryServer, userEnabled=userEnabled, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerRetries=sNTPServerRetries, remoteSecondaryMACAddress=remoteSecondaryMACAddress, dataPortPauseFrames=dataPortPauseFrames, protectionAvailabilityStatus=protectionAvailabilityStatus, sNMPCommunityString=sNMPCommunityString, rFUVersionBank2=rFUVersionBank2, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, dataPortDisabledWarning=dataPortDisabledWarning, antennaGain=antennaGain, rFURpsAlarm=rFURpsAlarm, smtp=smtp, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, phyControl=phyControl, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, transmitCapacityLimit=transmitCapacityLimit, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rFURFSwitchAlarm=rFURFSwitchAlarm, activeWirelessLinkAvailability=activeWirelessLinkAvailability, ethernetFiberSupport=ethernetFiberSupport, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rFUFreqSpacing=rFUFreqSpacing, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, transmitCapacityLimitDetail=transmitCapacityLimitDetail, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, protectionStateTrap=protectionStateTrap, remoteInternetAddressType=remoteInternetAddressType, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, qOSPriorityScheme=qOSPriorityScheme, rxDiversityDataPortStatus=rxDiversityDataPortStatus, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, reset=reset, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitCapacity=transmitCapacity, minCodeRate=minCodeRate, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetPriorityTable=ethernetPriorityTable, maxCodeRate=maxCodeRate, telnetPortNumber=telnetPortNumber, radioLicenseMaxEIRP=radioLicenseMaxEIRP, vLANManagementVID=vLANManagementVID, managementMode=managementMode, iPv6GatewayAddress=iPv6GatewayAddress, primaryRecoveryPeriod=primaryRecoveryPeriod, protection=protection, sMTPEnabledMessages=sMTPEnabledMessages, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rFUTxPowerAlarm=rFUTxPowerAlarm, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapIPAddress=sNMPTrapIPAddress, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, enableTransmission=enableTransmission, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkName=linkName, wirelessLinkStatus=wirelessLinkStatus, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, vLANManagementVIDValidation=vLANManagementVIDValidation, protectionStats=protectionStats, radioLicenseIdentifier=radioLicenseIdentifier, syslogLocalWrappedTrap=syslogLocalWrappedTrap, radioLicenseModulation=radioLicenseModulation, protectionInterfaceStatus=protectionInterfaceStatus, hardwareVersion=hardwareVersion, ptmp=ptmp, alignmentMode=alignmentMode, rFUType=rFUType, userTableIndex=userTableIndex, versions=versions, bridge=bridge, transmitDataRate=transmitDataRate, rFURxFreqMax=rFURxFreqMax, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, primaryRecovery=primaryRecovery, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rxDiversityVid=rxDiversityVid, sNMPTrapPortNumber=sNMPTrapPortNumber, latitude=latitude, userTable=userTable, radioLicenseCodeRate=radioLicenseCodeRate, endId=endId, dataPortFiberStatus=dataPortFiberStatus, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, maximumTransmitPower=maximumTransmitPower, managementPortDisabledWarning=managementPortDisabledWarning, phyStatus=phyStatus, remoteInternetAddress=remoteInternetAddress, encryptionAlgorithm=encryptionAlgorithm, receiveModulation=receiveModulation, iFCableLength=iFCableLength, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, userTableEntry=userTableEntry, daylightSaving=daylightSaving, alarms=alarms, rFUTxPowerMin=rFUTxPowerMin, l2CPPriorityTable=l2CPPriorityTable, sNMPTrapTableEntry=sNMPTrapTableEntry, faultProtectionSwitching=faultProtectionSwitching, sNTPSyncTrap=sNTPSyncTrap, managementPortStatus=managementPortStatus, sntp=sntp, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, supplementary=supplementary, vectorError=vectorError, ethernet=ethernet, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFURxFreqMin=rFURxFreqMin, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkNameMismatchTrap=linkNameMismatchTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rFUStatus=rFUStatus, sMTPServerIPAddress=sMTPServerIPAddress, remoteMACAddress=remoteMACAddress, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, rFUBranchingConfiguration=rFUBranchingConfiguration, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFUTxFreqMin=rFUTxFreqMin)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUTxFreqMax=rFUTxFreqMax, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, secondarySoftwareVersion=secondarySoftwareVersion, remoteIPAddress=remoteIPAddress, sNMPPortNumber=sNMPPortNumber, userTableNumber=userTableNumber, protectionSwitchCause=protectionSwitchCause, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerTableNumber=sNTPServerTableNumber, rFURfBand=rFURfBand, dataPortConfigurationMismatch=dataPortConfigurationMismatch, localPacketFiltering=localPacketFiltering, radioLicenseMinModulation=radioLicenseMinModulation, sNTPSync=sNTPSync, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sMTPServerInternetAddress=sMTPServerInternetAddress, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementPortWirelessDownAlert=managementPortWirelessDownAlert, softwareVersion=softwareVersion, primarySecondaryMode=primarySecondaryMode, hTTPSAccessEnabled=hTTPSAccessEnabled, longitude=longitude, rFUTxPowerMax=rFUTxPowerMax, encryptionEnabledMismatch=encryptionEnabledMismatch, rFUActiveFirmwareBank=rFUActiveFirmwareBank, iPVersion=iPVersion, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, syslogControl=syslogControl, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, productName=productName, syslogStateTrap=syslogStateTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, sMTPServerInternetAddressType=sMTPServerInternetAddressType, secureModeAlarmTrap=secureModeAlarmTrap, sNTPPollInterval=sNTPPollInterval, receiveCodeRate=receiveCodeRate, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, l2CPPriorityTableNumber=l2CPPriorityTableNumber, requestedProtectionState=requestedProtectionState, ptpTraps=ptpTraps, transmitCodeRate=transmitCodeRate, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, aggregateDataRate=aggregateDataRate, syslogState=syslogState, dataPortStatusTrap=dataPortStatusTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, rfu=rfu, alignmentModeTrap=alignmentModeTrap, radioLicenseBand=radioLicenseBand, sNMPEnabledTraps=sNMPEnabledTraps, ptpTrapPrefix=ptpTrapPrefix, radioLicenseRegion=radioLicenseRegion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapTableIndex=sNMPTrapTableIndex, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, securityLevel=securityLevel, hTTPPortNumber=hTTPPortNumber, radioLicenseMaxModulation=radioLicenseMaxModulation, sMTPEmailAlert=sMTPEmailAlert, radioLicenseTxFreq=radioLicenseTxFreq, subnetMask=subnetMask, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, maxModulation=maxModulation, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPServerResponse=sNTPServerResponse, numberOfAntennas=numberOfAntennas, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, syslogClient=syslogClient, linkLoss=linkLoss, tFTPServerInternetAddress=tFTPServerInternetAddress, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, remoteSecondaryIPAddress=remoteSecondaryIPAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPServerTableEntry=sNTPServerTableEntry, sNTPState=sNTPState, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, siteName=siteName, userName=userName, iPv4Address=iPv4Address, sNTPServerTimeout=sNTPServerTimeout, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, protectionConfigurationStatus=protectionConfigurationStatus, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, protectionStatus=protectionStatus, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility)
