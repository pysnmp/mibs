...
Gauge32, Integer32, Counter64, enterprises, MibIdentifier, IpAddress, NotificationType, Counter32, ObjectIdentity, Unsigned32, iso, ModuleIdentity, TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "Counter64", "enterprises", "MibIdentifier", "IpAddress", "NotificationType", "Counter32", "ObjectIdentity", "Unsigned32", "iso", "ModuleIdentity", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUPowerButtonPressed=rFUPowerButtonPressed, transmitModulation=transmitModulation, systemReset=systemReset, latitude=latitude, managementMode=managementMode, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, sNTPServerTimeout=sNTPServerTimeout, rxDiversityVid=rxDiversityVid, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPState=sNTPState, sNTPServerIPAddress=sNTPServerIPAddress, primarySecondaryMode=primarySecondaryMode, phyStatus=phyStatus, telnetAccessEnabled=telnetAccessEnabled, sNTPServerRetries=sNTPServerRetries, localPacketFiltering=localPacketFiltering, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rfu=rfu, iPDSCPPriorityTable=iPDSCPPriorityTable, neighborInternetAddressType=neighborInternetAddressType, sNMPTrapTableIndex=sNMPTrapTableIndex, rFURxFreqMin=rFURxFreqMin, rFUTransceiverLocation=rFUTransceiverLocation, dataPortDisabledWarning=dataPortDisabledWarning, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sntp=sntp, sNMPTrapTableEntry=sNMPTrapTableEntry, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, endId=endId, ptpTraps=ptpTraps, rFUCableAlarm=rFUCableAlarm, receivePower=receivePower, remotePrimarySecondaryMode=remotePrimarySecondaryMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, radioLicenseTxFreq=radioLicenseTxFreq, configuration=configuration, managementPortForcedConfiguration=managementPortForcedConfiguration, rFUTxPowerMin=rFUTxPowerMin, syslogStateTrap=syslogStateTrap, minModulation=minModulation, radioLicense=radioLicense, siteName=siteName, faultProtectionSwitching=faultProtectionSwitching, sNMPPortNumber=sNMPPortNumber, ethernetFiberSupport=ethernetFiberSupport, rFUBranchingConfiguration=rFUBranchingConfiguration, rFURpsAlarm=rFURpsAlarm, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, reset=reset, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, daylightSaving=daylightSaving, sNTPServerResponse=sNTPServerResponse, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, iPVersion=iPVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitCapacityLimitDetail=transmitCapacityLimitDetail, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, dataPortPauseFrames=dataPortPauseFrames, productName=productName, tFTPServerInternetAddress=tFTPServerInternetAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, sNTPPollInterval=sNTPPollInterval, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, userPassword=userPassword, dataPortFiberStatusTrap=dataPortFiberStatusTrap, securityLevel=securityLevel, rxDiversityDataPortStatus=rxDiversityDataPortStatus, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, managementCommittedInformationRate=managementCommittedInformationRate, transmitCapacityLimit=transmitCapacityLimit, tFTPServerIPAddress=tFTPServerIPAddress, linkName=linkName, sNMPTrapIPAddress=sNMPTrapIPAddress, bridge=bridge, sNTPSyncTrap=sNTPSyncTrap, iPv6GatewayAddress=iPv6GatewayAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rFUPowerAlarm=rFUPowerAlarm, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, rFUSerial=rFUSerial, linkLoss=linkLoss, linkNameMismatchTrap=linkNameMismatchTrap, qOSPriorityScheme=qOSPriorityScheme, protectionStatus=protectionStatus, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, vLANManagementVID=vLANManagementVID, radioLicenseCodeRate=radioLicenseCodeRate, softwareVersion=softwareVersion, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, vectorError=vectorError, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, userTable=userTable, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rFUTxFreqMax=rFUTxFreqMax, productVariant=productVariant, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, sMTPServerInternetAddress=sMTPServerInternetAddress, fiberY=fiberY, rFUType=rFUType, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, radioLicenseMinCodeRate=radioLicenseMinCodeRate, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ptmp=ptmp, aggregateDataRate=aggregateDataRate, sNTPServerTableIndex=sNTPServerTableIndex, versions=versions, userTableEntry=userTableEntry, altitude=altitude, secureModeAlarmTrap=secureModeAlarmTrap, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, requestedProtectionState=requestedProtectionState, remoteInternetAddress=remoteInternetAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, rFUTxBandAboveRx=rFUTxBandAboveRx, phyControl=phyControl, ethernet=ethernet, rFUTxMuteStatus=rFUTxMuteStatus, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, sMTPEmailAlert=sMTPEmailAlert, rFURfBand=rFURfBand, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, receiveModulation=receiveModulation, dataPortFiberStatus=dataPortFiberStatus, sMTPEnabledMessages=sMTPEnabledMessages, rFURxFreqMax=rFURxFreqMax, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, userTableNumber=userTableNumber, sNMPTrapTable=sNMPTrapTable, rxDiversityVlanTpid=rxDiversityVlanTpid, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, radioLicenseMinModulation=radioLicenseMinModulation, pubStats=pubStats, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rFUTxFreqMin=rFUTxFreqMin, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, radioLicenseBand=radioLicenseBand, remotePrimaryMACAddress=remotePrimaryMACAddress, minCodeRate=minCodeRate, rFUTxPowerMax=rFUTxPowerMax, neighborInternetAddress=neighborInternetAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, sNMPTrapVersion=sNMPTrapVersion, sNTPLastSync=sNTPLastSync, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rFURFSwitchAlarm=rFURFSwitchAlarm, rFUActiveFirmwareBank=rFUActiveFirmwareBank, encryption=encryption, sNMPTrapPortNumber=sNMPTrapPortNumber, protectionSwitchCause=protectionSwitchCause, aAAControl=aAAControl, sMTPServerIPAddress=sMTPServerIPAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iFCableLength=iFCableLength, transmitterStatus=transmitterStatus, managementPortConfigurationMismatch=managementPortConfigurationMismatch, syslogClientTrap=syslogClientTrap, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, radioLicenseMaxModulation=radioLicenseMaxModulation, transmitCapacity=transmitCapacity, sNTPServerInternetAddressType=sNTPServerInternetAddressType, vLANManagementPriority=vLANManagementPriority, maxModulation=maxModulation, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rFUConnectedPlatform=rFUConnectedPlatform, transmitDataRate=transmitDataRate, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, syslogState=syslogState, neighborIPAddress=neighborIPAddress, userRole=userRole, syslogClient=syslogClient, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, maximumTransmitPower=maximumTransmitPower, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPPrimaryServer=sNTPPrimaryServer, alarms=alarms, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, encryptionEnabledMismatch=encryptionEnabledMismatch, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, snmpControl=snmpControl, longitude=longitude, timeZone=timeZone, aTPCEnable=aTPCEnable, rFUPlatformCompatibility=rFUPlatformCompatibility, smtp=smtp, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, ptpTrapPrefix=ptpTrapPrefix, rFULockoutAlarm=rFULockoutAlarm, hTTPSPortNumber=hTTPSPortNumber, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rFFeederLoss=rFFeederLoss, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, systemClock=systemClock, tFTPServerPortNumber=tFTPServerPortNumber, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, activeAvailableTime=activeAvailableTime, licence=licence, dataPortConfigurationMismatch=dataPortConfigurationMismatch, remotePrimaryInternetAddress=remotePrimaryInternetAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPServerTable=sNTPServerTable, radioLicenseBandwidth=radioLicenseBandwidth, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, secondarySoftwareVersion=secondarySoftwareVersion, receiveDataRate=receiveDataRate, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, protectionState=protectionState, sNMPEnabledTraps=sNMPEnabledTraps, managementPortStatus=managementPortStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, linkNameMismatch=linkNameMismatch, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, maxCodeRate=maxCodeRate, protectionAvailabilityStatus=protectionAvailabilityStatus, transmitPower=transmitPower, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, dataPortStatus=dataPortStatus, iPv6Address=iPv6Address, telnetPortNumber=telnetPortNumber, diverseRfFeederLoss=diverseRfFeederLoss, dSCPManagementPriority=dSCPManagementPriority, rFUVersionBank1=rFUVersionBank1, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, numberOfAntennas=numberOfAntennas, sNTPSync=sNTPSync, protection=protection, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, management=management, unitOutOfCalibration=unitOutOfCalibration, activeWirelessLinkAvailability=activeWirelessLinkAvailability, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rFUTxPowerAlarm=rFUTxPowerAlarm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, encryptionAlgorithm=encryptionAlgorithm, sNTPServerTableEntry=sNTPServerTableEntry, managementPortAutoNegotiation=managementPortAutoNegotiation, gatewayIPAddress=gatewayIPAddress, iPv6PrefixLength=iPv6PrefixLength, userEnabled=userEnabled, remoteIPAddress=remoteIPAddress, ethernetPriorityTable=ethernetPriorityTable, diverseAntennaGain=diverseAntennaGain, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber, userTableIndex=userTableIndex, ptp800=ptp800, activeUnit=activeUnit, remoteMACAddress=remoteMACAddress, sNMPCommunityString=sNMPCommunityString, rFUVersionBank2=rFUVersionBank2, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, remoteInternetAddressType=remoteInternetAddressType, protectionStats=protectionStats, primaryRecovery=primaryRecovery, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, userName=userName, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, l2CPPriorityTable=l2CPPriorityTable, protectionStateTrap=protectionStateTrap, bootVersion=bootVersion, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, managementPortDisabledWarning=managementPortDisabledWarning, hardwareVersion=hardwareVersion, radioLicenseIdentifier=radioLicenseIdentifier, hTTPAccessEnabled=hTTPAccessEnabled, enableTransmission=enableTransmission, sNTPServerPortNumber=sNTPServerPortNumber, rFUProtectionCompatibility=rFUProtectionCompatibility, rFUFreqSpacing=rFUFreqSpacing, transmitCodeRate=transmitCodeRate, protectionInterfaceStatus=protectionInterfaceStatus, hTTPPortNumber=hTTPPortNumber, receiveCodeRate=receiveCodeRate, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, remotePrimaryIPAddress=remotePrimaryIPAddress, dataPortStatusTrap=dataPortStatusTrap, secureModeAlarm=secureModeAlarm, managementPortStatusTrap=managementPortStatusTrap, iPv4Address=iPv4Address, rFUStatusTrap=rFUStatusTrap, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, cambium=cambium, syslogControl=syslogControl, ptp=ptp, vLANManagementVIDValidation=vLANManagementVIDValidation, antennaGain=antennaGain, radioLicenseMaxEIRP=radioLicenseMaxEIRP, alignmentMode=alignmentMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUStatus=rFUStatus, neighborMACAddress=neighborMACAddress, primaryRecoveryPeriod=primaryRecoveryPeriod, radioLicenseRegion=radioLicenseRegion, protectionConfig=protectionConfig, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, radioLicenseRxFreq=radioLicenseRxFreq, wirelessLinkAvailability=wirelessLinkAvailability, supplementary=supplementary, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, remoteSecondaryIPAddress=remoteSecondaryIPAddress, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, alignmentModeTrap=alignmentModeTrap, protectionConfigurationStatus=protectionConfigurationStatus, wirelessLinkStatus=wirelessLinkStatus, subnetMask=subnetMask, radioLicenseModulation=radioLicenseModulation)
