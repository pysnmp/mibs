...
Gauge32, MibIdentifier, iso, IpAddress, Counter64, Unsigned32, TimeTicks, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, ModuleIdentity, NotificationType, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "iso", "IpAddress", "Counter64", "Unsigned32", "TimeTicks", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "ModuleIdentity", "NotificationType", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", mPLSTCPriorityTable=mPLSTCPriorityTable, syslogControl=syslogControl, activeWirelessLinkAvailability=activeWirelessLinkAvailability, aAAControl=aAAControl, managementPortDisabledWarning=managementPortDisabledWarning, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, useVLANForManagementInterfaces=useVLANForManagementInterfaces, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, phyStatus=phyStatus, versions=versions, rFURpsAlarm=rFURpsAlarm, protectionStateTrap=protectionStateTrap, minModulation=minModulation, localPacketFiltering=localPacketFiltering, sNTPSyncTrap=sNTPSyncTrap, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, iPv6PrefixLength=iPv6PrefixLength, aggregateDataRate=aggregateDataRate, maxModulation=maxModulation, rFUType=rFUType, sNTPServerIPAddress=sNTPServerIPAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, sNTPServerTableIndex=sNTPServerTableIndex, syslogClientTrap=syslogClientTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveDataRate=receiveDataRate, rFURfBand=rFURfBand, telnetPortNumber=telnetPortNumber, sNTPServerTimeout=sNTPServerTimeout, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, transmitCapacity=transmitCapacity, configuration=configuration, radioLicenseRegion=radioLicenseRegion, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, rFUTransceiverLocation=rFUTransceiverLocation, sntp=sntp, rFUStatusTrap=rFUStatusTrap, requestedProtectionState=requestedProtectionState, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, management=management, syslogStateTrap=syslogStateTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, managementPortConfigurationMismatch=managementPortConfigurationMismatch, ethernetPriorityTableIndex=ethernetPriorityTableIndex, remoteSecondaryMACAddress=remoteSecondaryMACAddress, longitude=longitude, sNTPSync=sNTPSync, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, vLANManagementPriority=vLANManagementPriority, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, radioLicenseMinCodeRate=radioLicenseMinCodeRate, radioLicenseBandwidth=radioLicenseBandwidth, iPv6GatewayAddress=iPv6GatewayAddress, rFUBranchingConfiguration=rFUBranchingConfiguration, rFUTxBandAboveRx=rFUTxBandAboveRx, ptpTraps=ptpTraps, numberOfAntennas=numberOfAntennas, alignmentMode=alignmentMode, ptp=ptp, rFUPlatformCompatibility=rFUPlatformCompatibility, remoteInternetAddressType=remoteInternetAddressType, dataPortStatus=dataPortStatus, sNTPServerTable=sNTPServerTable, primarySecondaryMode=primarySecondaryMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFULockoutAlarm=rFULockoutAlarm, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, altitude=altitude, sNMPTrapTableEntry=sNMPTrapTableEntry, hTTPSPortNumber=hTTPSPortNumber, radioLicenseIdentifier=radioLicenseIdentifier, neighborInternetAddress=neighborInternetAddress, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, radioLicenseMinModulation=radioLicenseMinModulation, sMTPServerPortNumber=sMTPServerPortNumber, transmitterStatus=transmitterStatus, sNTPLastSync=sNTPLastSync, endId=endId, userTableNumber=userTableNumber, sNMPPortNumber=sNMPPortNumber, faultProtectionSwitching=faultProtectionSwitching, rFUTxPowerAlarm=rFUTxPowerAlarm, pubStats=pubStats, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, aTPCEnable=aTPCEnable, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkNameMismatchTrap=linkNameMismatchTrap, managementPortAutoNegotiation=managementPortAutoNegotiation, protectionStatus=protectionStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, secondarySoftwareVersion=secondarySoftwareVersion, dataPortFiberStatusTrap=dataPortFiberStatusTrap, userTableIndex=userTableIndex, latitude=latitude, managementMode=managementMode, radioLicenseBand=radioLicenseBand, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, maxCodeRate=maxCodeRate, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFURxFreqMin=rFURxFreqMin, wirelessLinkAvailability=wirelessLinkAvailability, managementCommittedInformationRate=managementCommittedInformationRate, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapTableNumber=sNMPTrapTableNumber, minCodeRate=minCodeRate, enableTransmission=enableTransmission, sMTPEnabledMessages=sMTPEnabledMessages, bootVersion=bootVersion, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, gatewayIPAddress=gatewayIPAddress, linkName=linkName, sNMPTrapIPAddress=sNMPTrapIPAddress, siteName=siteName, sNTPServerTableNumber=sNTPServerTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, supplementary=supplementary, dataPortDisabledWarning=dataPortDisabledWarning, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitCodeRate=transmitCodeRate, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, rxDiversityVid=rxDiversityVid, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, dataPortPauseFrames=dataPortPauseFrames, qOSPriorityScheme=qOSPriorityScheme, ethernetPriorityTableNumber=ethernetPriorityTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vectorError=vectorError, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFURFSwitchAlarm=rFURFSwitchAlarm, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, secureModeAlarmTrap=secureModeAlarmTrap, telnetAccessEnabled=telnetAccessEnabled, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rFUTxFreqMin=rFUTxFreqMin, remotePrimaryIPAddress=remotePrimaryIPAddress, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, managementPortStatusTrap=managementPortStatusTrap, ptpTrapPrefix=ptpTrapPrefix, remoteIPAddress=remoteIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, secureModeAlarm=secureModeAlarm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogState=syslogState, alignmentModeTrap=alignmentModeTrap, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitCapacityLimitDetail=transmitCapacityLimitDetail, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortFiberStatus=dataPortFiberStatus, radioLicenseRxFreq=radioLicenseRxFreq, sNTPPollInterval=sNTPPollInterval, rFUFreqSpacing=rFUFreqSpacing, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, smtp=smtp, rFUPowerAlarm=rFUPowerAlarm, l2CPPriorityTableEntry=l2CPPriorityTableEntry, bridge=bridge, userRole=userRole, subnetMask=subnetMask, alarms=alarms, rFUTxPowerMax=rFUTxPowerMax, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, ptmp=ptmp, sNMPTrapInternetAddress=sNMPTrapInternetAddress, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, remoteSecondaryIPAddress=remoteSecondaryIPAddress, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, vLANManagementVIDValidation=vLANManagementVIDValidation, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sNMPCommunityString=sNMPCommunityString, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetFiberSupport=ethernetFiberSupport, activeUnit=activeUnit, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, reset=reset, tFTPServerIPAddress=tFTPServerIPAddress, rFUStatus=rFUStatus, productVariant=productVariant, userTable=userTable, phyControl=phyControl, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, sNTPServerResponse=sNTPServerResponse, rFUTxPowerMin=rFUTxPowerMin, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, radioLicenseModulation=radioLicenseModulation, protection=protection, radioLicenseCodeRate=radioLicenseCodeRate, rfu=rfu, daylightSaving=daylightSaving, hTTPSAccessEnabled=hTTPSAccessEnabled, radioLicenseTxFreq=radioLicenseTxFreq, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, cambium=cambium, productName=productName, receivePower=receivePower, dSCPManagementPriority=dSCPManagementPriority, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rxDiversityVlanTpid=rxDiversityVlanTpid, ptp800=ptp800, receiveModulation=receiveModulation, remoteInternetAddress=remoteInternetAddress, managementPortForcedConfiguration=managementPortForcedConfiguration, primaryRecovery=primaryRecovery, neighborInternetAddressType=neighborInternetAddressType, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkLoss=linkLoss, timeZone=timeZone, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, neighborMACAddress=neighborMACAddress, managementPortStatus=managementPortStatus, rFUVersionBank1=rFUVersionBank1, remotePrimarySecondaryMode=remotePrimarySecondaryMode, userPassword=userPassword, protectionStats=protectionStats, linkNameMismatch=linkNameMismatch, sNTPServerPortNumber=sNTPServerPortNumber, fiberY=fiberY, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rFFeederLoss=rFFeederLoss, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, encryptionAlgorithm=encryptionAlgorithm, rxDiversityDataPortStatus=rxDiversityDataPortStatus, activeAvailableTime=activeAvailableTime, radioLicenseMaxEIRP=radioLicenseMaxEIRP, remotePrimaryInternetAddress=remotePrimaryInternetAddress, rFUCableAlarm=rFUCableAlarm, ethernetPriorityTableEntry=ethernetPriorityTableEntry, remoteMACAddress=remoteMACAddress, maximumTransmitPower=maximumTransmitPower, iPDSCPPriorityTable=iPDSCPPriorityTable, rFUSerial=rFUSerial, l2CPPriorityTable=l2CPPriorityTable, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapTable=sNMPTrapTable, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, l2CPPriorityTableIndex=l2CPPriorityTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, radioLicenseMaxModulation=radioLicenseMaxModulation, licence=licence, transmitCapacityLimit=transmitCapacityLimit, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, hardwareVersion=hardwareVersion, protectionSwitchCause=protectionSwitchCause, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNTPServerRetries=sNTPServerRetries, transmitPower=transmitPower, sNTPServerTableEntry=sNTPServerTableEntry, userEnabled=userEnabled, systemReset=systemReset, encryptionEnabledMismatch=encryptionEnabledMismatch, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, diverseAntennaGain=diverseAntennaGain, userTableEntry=userTableEntry, rFUVersionBank2=rFUVersionBank2, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, hTTPAccessEnabled=hTTPAccessEnabled, rFUProtectionCompatibility=rFUProtectionCompatibility, rFUConnectedPlatform=rFUConnectedPlatform, softwareVersion=softwareVersion, tFTPServerInternetAddress=tFTPServerInternetAddress, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, ethernet=ethernet, iPv4Address=iPv4Address, sMTPServerIPAddress=sMTPServerIPAddress, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFUTxMuteStatus=rFUTxMuteStatus, rFURxFreqMax=rFURxFreqMax, sMTPSourceEmailAddress=sMTPSourceEmailAddress, protectionConfigurationStatus=protectionConfigurationStatus, iPVersion=iPVersion, protectionInterfaceStatus=protectionInterfaceStatus, dataPortStatusTrap=dataPortStatusTrap, transmitDataRate=transmitDataRate, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, protectionAvailabilityStatus=protectionAvailabilityStatus, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, wirelessLinkStatus=wirelessLinkStatus, sNTPPrimaryServer=sNTPPrimaryServer, securityLevel=securityLevel, rFUPowerButtonPressed=rFUPowerButtonPressed, protectionState=protectionState, iPv6Address=iPv6Address, systemClock=systemClock, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, sMTPServerInternetAddressType=sMTPServerInternetAddressType, userName=userName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, protectionConfig=protectionConfig, wirelessLinkStatusTrap=wirelessLinkStatusTrap, neighborIPAddress=neighborIPAddress, iFCableLength=iFCableLength, primaryRecoveryPeriod=primaryRecoveryPeriod, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, remotePrimaryMACAddress=remotePrimaryMACAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, receiveCodeRate=receiveCodeRate, antennaGain=antennaGain, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, radioLicense=radioLicense, sMTPEmailAlert=sMTPEmailAlert, sNTPState=sNTPState, sNMPTrapVersion=sNMPTrapVersion, encryption=encryption, hTTPPortNumber=hTTPPortNumber, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, dataPortConfigurationMismatch=dataPortConfigurationMismatch, snmpControl=snmpControl, rFUTxFreqMax=rFUTxFreqMax, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, transmitModulation=transmitModulation, rFUActiveFirmwareBank=rFUActiveFirmwareBank, syslogClient=syslogClient, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, ethernetPriorityTable=ethernetPriorityTable, vLANManagementVID=vLANManagementVID, diverseRfFeederLoss=diverseRfFeederLoss)
