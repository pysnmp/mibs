...
Counter32, ObjectIdentity, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, Gauge32, NotificationType, Integer32, Counter64, Unsigned32, enterprises, ModuleIdentity, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "Gauge32", "NotificationType", "Integer32", "Counter64", "Unsigned32", "enterprises", "ModuleIdentity", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", secondarySoftwareVersion=secondarySoftwareVersion, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, rFUBranchingConfiguration=rFUBranchingConfiguration, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, faultProtectionSwitching=faultProtectionSwitching, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, sNTPSyncTrap=sNTPSyncTrap, managementPortDisabledWarning=managementPortDisabledWarning, userTableIndex=userTableIndex, sNTPSync=sNTPSync, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, numberOfAntennas=numberOfAntennas, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, sMTPServerPortNumber=sMTPServerPortNumber, supplementary=supplementary, radioLicenseMaxModulation=radioLicenseMaxModulation, sMTPEnabledMessages=sMTPEnabledMessages, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitCodeRate=transmitCodeRate, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, syslogClient=syslogClient, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, telnetPortNumber=telnetPortNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, syslogControl=syslogControl, managementPortWirelessDownAlert=managementPortWirelessDownAlert, receivePower=receivePower, rFUTxBandAboveRx=rFUTxBandAboveRx, subnetMask=subnetMask, rFUPlatformCompatibility=rFUPlatformCompatibility, rFUTxMuteStatus=rFUTxMuteStatus, sNMPTrapTable=sNMPTrapTable, encryption=encryption, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, vectorError=vectorError, rFUTransceiverLocation=rFUTransceiverLocation, sMTPServerInternetAddress=sMTPServerInternetAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rFURxFreqMax=rFURxFreqMax, userName=userName, ptmp=ptmp, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerIPAddress=sNTPServerIPAddress, sNTPServerResponse=sNTPServerResponse, dataPortConfigurationMismatch=dataPortConfigurationMismatch, protectionInterfaceStatus=protectionInterfaceStatus, hardwareVersion=hardwareVersion, snmpControl=snmpControl, systemClock=systemClock, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, remoteInternetAddressType=remoteInternetAddressType, primaryRecoveryPeriod=primaryRecoveryPeriod, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, tFTPServerIPAddress=tFTPServerIPAddress, rFURxFreqMin=rFURxFreqMin, sNTPServerInternetAddress=sNTPServerInternetAddress, ptp800=ptp800, minCodeRate=minCodeRate, wirelessLinkAvailability=wirelessLinkAvailability, remotePrimaryMACAddress=remotePrimaryMACAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, localPacketFiltering=localPacketFiltering, rFUTxPowerMin=rFUTxPowerMin, rFUConnectedPlatform=rFUConnectedPlatform, rFUStatus=rFUStatus, phyControl=phyControl, sNMPCommunityString=sNMPCommunityString, rxDiversityVid=rxDiversityVid, remoteMACAddress=remoteMACAddress, maximumTransmitPower=maximumTransmitPower, vLANManagementVID=vLANManagementVID, transmitCapacityLimit=transmitCapacityLimit, securityLevel=securityLevel, ptp=ptp, transmitCapacityLimitDetail=transmitCapacityLimitDetail, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, neighborMACAddress=neighborMACAddress, remoteSecondaryMACAddress=remoteSecondaryMACAddress, transmitPower=transmitPower, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, dataPortPauseFrames=dataPortPauseFrames, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, dataPortStatusTrap=dataPortStatusTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, remotePrimarySecondaryMode=remotePrimarySecondaryMode, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, ethernetPriorityTable=ethernetPriorityTable, userRole=userRole, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, protectionStateTrap=protectionStateTrap, aAAControl=aAAControl, radioLicenseRxFreq=radioLicenseRxFreq, maxCodeRate=maxCodeRate, requestedProtectionState=requestedProtectionState, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, iPVersion=iPVersion, sNMPTrapVersion=sNMPTrapVersion, rFUSerial=rFUSerial, aTPCEnable=aTPCEnable, radioLicenseMaxEIRP=radioLicenseMaxEIRP, tFTPServerPortNumber=tFTPServerPortNumber, transmitDataRate=transmitDataRate, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteInternetAddress=remoteInternetAddress, managementPortStatus=managementPortStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, userTableNumber=userTableNumber, dSCPManagementPriority=dSCPManagementPriority, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, linkLoss=linkLoss, rFUType=rFUType, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, iPv6GatewayAddress=iPv6GatewayAddress, radioLicenseCodeRate=radioLicenseCodeRate, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, aggregateDataRate=aggregateDataRate, ethernet=ethernet, ptpTraps=ptpTraps, configuration=configuration, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, managementPortAutoNegotiation=managementPortAutoNegotiation, unitOutOfCalibration=unitOutOfCalibration, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licence=licence, remotePrimaryInternetAddress=remotePrimaryInternetAddress, timeZone=timeZone, protectionStatus=protectionStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFUStatusTrap=rFUStatusTrap, activeAvailableTime=activeAvailableTime, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, radioLicense=radioLicense, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, systemReset=systemReset, softwareVersion=softwareVersion, neighborIPAddress=neighborIPAddress, rFURfBand=rFURfBand, activeWirelessLinkAvailability=activeWirelessLinkAvailability, wirelessLinkStatus=wirelessLinkStatus, rFFeederLoss=rFFeederLoss, rFUVersionBank1=rFUVersionBank1, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rFUVersionBank2=rFUVersionBank2, smtp=smtp, alarms=alarms, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFURFSwitchAlarm=rFURFSwitchAlarm, transmitterStatus=transmitterStatus, rFUPowerButtonPressed=rFUPowerButtonPressed, protectionStats=protectionStats, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, primarySecondaryMode=primarySecondaryMode, management=management, bridge=bridge, rFUActiveFirmwareBank=rFUActiveFirmwareBank, dataPortFiberStatus=dataPortFiberStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, transmitModulation=transmitModulation, sNMPEnabledTraps=sNMPEnabledTraps, receiveDataRate=receiveDataRate, rFULockoutAlarm=rFULockoutAlarm, dataPortFiberStatusTrap=dataPortFiberStatusTrap, alignmentMode=alignmentMode, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, phyStatus=phyStatus, rFUCableAlarm=rFUCableAlarm, hTTPPortNumber=hTTPPortNumber, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, ptpTrapPrefix=ptpTrapPrefix, protectionSwitchCause=protectionSwitchCause, userEnabled=userEnabled, radioLicenseBandwidth=radioLicenseBandwidth, ethernetFiberSupport=ethernetFiberSupport, radioLicenseTxFreq=radioLicenseTxFreq, latitude=latitude, versions=versions, hTTPAccessEnabled=hTTPAccessEnabled, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rxDiversityVlanTpid=rxDiversityVlanTpid, ethernetPriorityTableEntry=ethernetPriorityTableEntry, alignmentModeTrap=alignmentModeTrap, sNTPServerTimeout=sNTPServerTimeout, l2CPPriorityTable=l2CPPriorityTable, sNMPTrapInternetAddress=sNMPTrapInternetAddress, vLANManagementPriority=vLANManagementPriority, primaryRecovery=primaryRecovery, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementMode=managementMode, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, sNTPPollInterval=sNTPPollInterval, minModulation=minModulation, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, radioLicenseBand=radioLicenseBand, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, secureModeAlarmTrap=secureModeAlarmTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, linkNameMismatch=linkNameMismatch, longitude=longitude, rFURpsAlarm=rFURpsAlarm, protection=protection, sntp=sntp, fiberY=fiberY, syslogState=syslogState, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, sNTPServerTableIndex=sNTPServerTableIndex, transmitCapacity=transmitCapacity, diverseRfFeederLoss=diverseRfFeederLoss, enableTransmission=enableTransmission, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, l2CPPriorityTableNumber=l2CPPriorityTableNumber, protectionConfig=protectionConfig, rFUPowerAlarm=rFUPowerAlarm, managementPortConfigurationMismatch=managementPortConfigurationMismatch, syslogLocalWrappedTrap=syslogLocalWrappedTrap, productName=productName, encryptionAlgorithm=encryptionAlgorithm, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, qOSPriorityScheme=qOSPriorityScheme, userPassword=userPassword, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, iPDSCPPriorityTable=iPDSCPPriorityTable, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, syslogStateTrap=syslogStateTrap, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, radioLicenseIdentifier=radioLicenseIdentifier, syslogClientTrap=syslogClientTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sNTPServerPortNumber=sNTPServerPortNumber, dataPortStatus=dataPortStatus, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, hTTPSAccessEnabled=hTTPSAccessEnabled)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", receiveModulation=receiveModulation, maxModulation=maxModulation, sNMPPortNumber=sNMPPortNumber, remoteSecondaryIPAddress=remoteSecondaryIPAddress, sNTPServerTableEntry=sNTPServerTableEntry, rFUFreqSpacing=rFUFreqSpacing, remoteIPAddress=remoteIPAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, remotePrimaryIPAddress=remotePrimaryIPAddress, daylightSaving=daylightSaving, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, managementPortForcedConfiguration=managementPortForcedConfiguration, productVariant=productVariant, managementCommittedInformationRate=managementCommittedInformationRate, userTable=userTable, cambium=cambium, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, receiveCodeRate=receiveCodeRate, wirelessLinkStatusTrap=wirelessLinkStatusTrap, protectionConfigurationStatus=protectionConfigurationStatus, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, managementPortStatusTrap=managementPortStatusTrap, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, radioLicenseMinModulation=radioLicenseMinModulation, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, linkNameMismatchTrap=linkNameMismatchTrap, diverseAntennaGain=diverseAntennaGain, sNTPServerTableNumber=sNTPServerTableNumber, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, protectionAvailabilityStatus=protectionAvailabilityStatus, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, radioLicenseRegion=radioLicenseRegion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, neighborInternetAddress=neighborInternetAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, siteName=siteName, iPv6PrefixLength=iPv6PrefixLength, rFUTxFreqMin=rFUTxFreqMin, altitude=altitude, bootVersion=bootVersion, hTTPSPortNumber=hTTPSPortNumber, activeUnit=activeUnit, neighborInternetAddressType=neighborInternetAddressType, userTableEntry=userTableEntry, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapPortNumber=sNMPTrapPortNumber, gatewayIPAddress=gatewayIPAddress, sNTPPrimaryServer=sNTPPrimaryServer, encryptionEnabledMismatch=encryptionEnabledMismatch, protectionState=protectionState, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, iPv6Address=iPv6Address, rxDiversityDataPortStatus=rxDiversityDataPortStatus, reset=reset, sNTPServerTable=sNTPServerTable, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, iFCableLength=iFCableLength, vLANManagementVIDValidation=vLANManagementVIDValidation, rFUProtectionCompatibility=rFUProtectionCompatibility, iPv4Address=iPv4Address, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rfu=rfu, sNMPTrapIPAddress=sNMPTrapIPAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPLastSync=sNTPLastSync, rFUTxPowerMax=rFUTxPowerMax, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, linkName=linkName, sNTPServerRetries=sNTPServerRetries, sNMPTrapTableIndex=sNMPTrapTableIndex, rFUTxFreqMax=rFUTxFreqMax, antennaGain=antennaGain, sNTPState=sNTPState, secureModeAlarm=secureModeAlarm, pubStats=pubStats, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, rFUTxPowerAlarm=rFUTxPowerAlarm, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, radioLicenseMinCodeRate=radioLicenseMinCodeRate, endId=endId, radioLicenseModulation=radioLicenseModulation, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus)
