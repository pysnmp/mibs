...
NotificationType, MibIdentifier, iso, NotificationType, TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, ModuleIdentity, enterprises, Counter32, Unsigned32, IpAddress, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "iso", "NotificationType", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "ModuleIdentity", "enterprises", "Counter32", "Unsigned32", "IpAddress", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", receivePower=receivePower, rFFeederLoss=rFFeederLoss, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, linkName=linkName, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, iPv4Address=iPv4Address, neighborIPAddress=neighborIPAddress, productName=productName, faultProtectionSwitching=faultProtectionSwitching, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, remoteSecondaryIPAddress=remoteSecondaryIPAddress, rFULockoutAlarm=rFULockoutAlarm, transmitCodeRate=transmitCodeRate, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, activeAvailableTime=activeAvailableTime, bootVersion=bootVersion, receiveModulation=receiveModulation, licence=licence, userTableNumber=userTableNumber, managementPortStatusTrap=managementPortStatusTrap, remoteIPAddress=remoteIPAddress, rFUTxFreqMax=rFUTxFreqMax, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, managementCommittedInformationRate=managementCommittedInformationRate, managementMode=managementMode, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, qOSPriorityScheme=qOSPriorityScheme, mPLSTCPriorityTable=mPLSTCPriorityTable, remotePrimaryIPAddress=remotePrimaryIPAddress, alignmentModeTrap=alignmentModeTrap, sNTPServerTableEntry=sNTPServerTableEntry, productVariant=productVariant, userPassword=userPassword, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, cambium=cambium, hTTPPortNumber=hTTPPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, minModulation=minModulation, sNTPSyncTrap=sNTPSyncTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, l2CPPriorityTable=l2CPPriorityTable, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, sNMPTrapTable=sNMPTrapTable, sNTPSync=sNTPSync, snmpControl=snmpControl, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, remotePrimaryMACAddress=remotePrimaryMACAddress, sMTPServerPortNumber=sMTPServerPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPServerInternetAddress=sMTPServerInternetAddress, userTable=userTable, linkLoss=linkLoss, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, protectionSwitchCause=protectionSwitchCause, rFUTxPowerAlarm=rFUTxPowerAlarm, remoteMACAddress=remoteMACAddress, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, neighborInternetAddress=neighborInternetAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userRole=userRole, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, rxDiversityVid=rxDiversityVid, rFUPowerButtonPressed=rFUPowerButtonPressed, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, managementPortForcedConfiguration=managementPortForcedConfiguration, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerTable=sNTPServerTable, securityLevel=securityLevel, sNMPTrapIPAddress=sNMPTrapIPAddress, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, hardwareVersion=hardwareVersion, encryption=encryption, sNTPServerTimeout=sNTPServerTimeout, transmitterStatus=transmitterStatus, vLANManagementVIDValidation=vLANManagementVIDValidation, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sMTPEmailAlert=sMTPEmailAlert, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, protectionStatus=protectionStatus, phyControl=phyControl, transmitCapacityLimitDetail=transmitCapacityLimitDetail, antennaGain=antennaGain, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rFUTransceiverLocation=rFUTransceiverLocation, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, maxCodeRate=maxCodeRate, ethernetPriorityTable=ethernetPriorityTable, hTTPSAccessEnabled=hTTPSAccessEnabled, radioLicenseRegion=radioLicenseRegion, protectionStats=protectionStats, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rFUTxBandAboveRx=rFUTxBandAboveRx, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, radioLicenseMinModulation=radioLicenseMinModulation, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, radioLicenseTxFreq=radioLicenseTxFreq, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, receiveDataRate=receiveDataRate, rFUStatusTrap=rFUStatusTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, userTableIndex=userTableIndex, sNMPPortNumber=sNMPPortNumber, maximumTransmitPower=maximumTransmitPower, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, maxModulation=maxModulation, bridge=bridge, rFURxFreqMax=rFURxFreqMax, ethernetFiberSupport=ethernetFiberSupport, configuration=configuration, sNMPCommunityString=sNMPCommunityString, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, hTTPAccessEnabled=hTTPAccessEnabled, supplementary=supplementary, sNTPServerTableIndex=sNTPServerTableIndex, daylightSaving=daylightSaving, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, iPv6PrefixLength=iPv6PrefixLength, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, transmitModulation=transmitModulation, managementPortDisabledWarning=managementPortDisabledWarning, transmitDataRate=transmitDataRate, neighborMACAddress=neighborMACAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, linkNameMismatchTrap=linkNameMismatchTrap, dataPortStatusTrap=dataPortStatusTrap, rFUConnectedPlatform=rFUConnectedPlatform, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPEnabledTraps=sNMPEnabledTraps, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, altitude=altitude, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortStatus=dataPortStatus, rFUVersionBank1=rFUVersionBank1, dataPortFiberStatus=dataPortFiberStatus, transmitCapacity=transmitCapacity, aTPCEnable=aTPCEnable, rFUTxPowerMin=rFUTxPowerMin, rFUStatus=rFUStatus, sNTPPollInterval=sNTPPollInterval, radioLicenseMaxModulation=radioLicenseMaxModulation, softwareVersion=softwareVersion, protectionState=protectionState, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, sntp=sntp, rFUBranchingConfiguration=rFUBranchingConfiguration, remotePrimarySecondaryMode=remotePrimarySecondaryMode, sNTPServerRetries=sNTPServerRetries, syslogClient=syslogClient, receiveCodeRate=receiveCodeRate, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, syslogStateTrap=syslogStateTrap, ethernet=ethernet, ptpTraps=ptpTraps, rFUPlatformCompatibility=rFUPlatformCompatibility, dataPortPauseFrames=dataPortPauseFrames, iPv6GatewayAddress=iPv6GatewayAddress, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, syslogClientTrap=syslogClientTrap, alignmentMode=alignmentMode, protectionAvailabilityStatus=protectionAvailabilityStatus, radioLicenseBandwidth=radioLicenseBandwidth, transmitCapacityLimit=transmitCapacityLimit, rFUCableAlarm=rFUCableAlarm, rxDiversityDataPortStatus=rxDiversityDataPortStatus, radioLicenseRxFreq=radioLicenseRxFreq, secureModeAlarm=secureModeAlarm, activeUnit=activeUnit, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rFUProtectionCompatibility=rFUProtectionCompatibility, systemReset=systemReset, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, radioLicenseIdentifier=radioLicenseIdentifier, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rFUPowerAlarm=rFUPowerAlarm, neighborInternetAddressType=neighborInternetAddressType, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sMTPServerIPAddress=sMTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, sNMPTrapTableIndex=sNMPTrapTableIndex, gatewayIPAddress=gatewayIPAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, localPacketFiltering=localPacketFiltering, requestedProtectionState=requestedProtectionState, sNTPServerIPAddress=sNTPServerIPAddress, rxDiversityVlanTpid=rxDiversityVlanTpid, reset=reset, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, remoteSecondaryMACAddress=remoteSecondaryMACAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, managementPortAutoNegotiation=managementPortAutoNegotiation, protection=protection, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, protectionConfigurationStatus=protectionConfigurationStatus, vLANManagementPriority=vLANManagementPriority, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, encryptionAlgorithm=encryptionAlgorithm, l2CPPriorityTableNumber=l2CPPriorityTableNumber, enableTransmission=enableTransmission, primaryRecoveryPeriod=primaryRecoveryPeriod, sNMPTrapPortNumber=sNMPTrapPortNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rFURpsAlarm=rFURpsAlarm, diverseAntennaGain=diverseAntennaGain, radioLicense=radioLicense, ethernetPriorityTableNumber=ethernetPriorityTableNumber, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, dSCPManagementPriority=dSCPManagementPriority, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, encryptionEnabledMismatch=encryptionEnabledMismatch, ptp=ptp, ethernetPriorityTableIndex=ethernetPriorityTableIndex, linkNameMismatch=linkNameMismatch, rFUSerial=rFUSerial, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, sNTPPrimaryServer=sNTPPrimaryServer, numberOfAntennas=numberOfAntennas, secondarySoftwareVersion=secondarySoftwareVersion, rFURxFreqMin=rFURxFreqMin, tFTPServerIPAddress=tFTPServerIPAddress, siteName=siteName, rFUFreqSpacing=rFUFreqSpacing, ptpTrapPrefix=ptpTrapPrefix, minCodeRate=minCodeRate, iPDSCPPriorityTable=iPDSCPPriorityTable, managementPortStatus=managementPortStatus, telnetPortNumber=telnetPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, iPv6Address=iPv6Address, enabledDiagnosticAlarms=enabledDiagnosticAlarms, activeWirelessLinkAvailability=activeWirelessLinkAvailability, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vLANManagementVID=vLANManagementVID, secureModeAlarmTrap=secureModeAlarmTrap, sNTPServerResponse=sNTPServerResponse, syslogControl=syslogControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, latitude=latitude, subnetMask=subnetMask, l2CPPriorityTableEntry=l2CPPriorityTableEntry, transmitPower=transmitPower, primarySecondaryMode=primarySecondaryMode, pubStats=pubStats, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, remoteInternetAddressType=remoteInternetAddressType, rFUTxFreqMin=rFUTxFreqMin, unitOutOfCalibration=unitOutOfCalibration, rFUActiveFirmwareBank=rFUActiveFirmwareBank, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, protectionInterfaceStatus=protectionInterfaceStatus, radioLicenseCodeRate=radioLicenseCodeRate, systemClock=systemClock, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, sNTPLastSync=sNTPLastSync, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, radioLicenseModulation=radioLicenseModulation, fiberY=fiberY, rfu=rfu, alarms=alarms, ptp800=ptp800, wirelessLinkStatusTrap=wirelessLinkStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, management=management, aAAControl=aAAControl, iFCableLength=iFCableLength, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telnetAccessEnabled=telnetAccessEnabled, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, timeZone=timeZone, userTableEntry=userTableEntry, versions=versions, syslogState=syslogState, sMTPServerInternetAddressType=sMTPServerInternetAddressType, wirelessLinkStatus=wirelessLinkStatus, rFURFSwitchAlarm=rFURFSwitchAlarm, rFUTxMuteStatus=rFUTxMuteStatus, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, iPVersion=iPVersion, ptmp=ptmp, rFUTxPowerMax=rFUTxPowerMax, rFUType=rFUType, sMTPEnabledMessages=sMTPEnabledMessages, userName=userName, primaryRecovery=primaryRecovery, remotePrimaryInternetAddress=remotePrimaryInternetAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, phyStatus=phyStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, hTTPSPortNumber=hTTPSPortNumber, radioLicenseBand=radioLicenseBand, diverseRfFeederLoss=diverseRfFeederLoss, rFUVersionBank2=rFUVersionBank2, dataPortFiberStatusTrap=dataPortFiberStatusTrap, vectorError=vectorError, smtp=smtp, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, userEnabled=userEnabled, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, protectionStateTrap=protectionStateTrap, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, sNTPState=sNTPState, dataPortConfigurationMismatch=dataPortConfigurationMismatch, protectionConfig=protectionConfig, managementPortConfigurationMismatch=managementPortConfigurationMismatch, radioLicenseMinCodeRate=radioLicenseMinCodeRate, longitude=longitude, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapVersion=sNMPTrapVersion, dataPortDisabledWarning=dataPortDisabledWarning, endId=endId, rFURfBand=rFURfBand, aggregateDataRate=aggregateDataRate, remoteInternetAddress=remoteInternetAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPServerPortNumber=sNTPServerPortNumber)
