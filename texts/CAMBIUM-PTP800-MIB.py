...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", receivePower=receivePower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iFCableLength=iFCableLength, rFFeederLoss=rFFeederLoss, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, sNTPPrimaryServer=sNTPPrimaryServer, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, snmpControl=snmpControl, rFULockoutAlarm=rFULockoutAlarm, rxDiversityDataPortStatus=rxDiversityDataPortStatus, neighborInternetAddress=neighborInternetAddress, cambium=cambium, sNMPCommunityString=sNMPCommunityString, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, diverseAntennaGain=diverseAntennaGain, radioLicenseMaxModulation=radioLicenseMaxModulation, secureModeAlarmTrap=secureModeAlarmTrap, sNTPServerPortNumber=sNTPServerPortNumber, sNTPServerTableIndex=sNTPServerTableIndex, rFUStatus=rFUStatus, hTTPPortNumber=hTTPPortNumber, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, iPVersion=iPVersion, rFUTxBandAboveRx=rFUTxBandAboveRx, dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementPortStatus=managementPortStatus, protectionStats=protectionStats, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, managementPortAutoNegotiation=managementPortAutoNegotiation, sNTPPollInterval=sNTPPollInterval, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, pubStats=pubStats, minModulation=minModulation, remotePrimaryInternetAddress=remotePrimaryInternetAddress, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, radioLicenseIdentifier=radioLicenseIdentifier, telnetAccessEnabled=telnetAccessEnabled, radioLicenseRxFreq=radioLicenseRxFreq, rFUVersionBank2=rFUVersionBank2, neighborInternetAddressType=neighborInternetAddressType, sNMPTrapTable=sNMPTrapTable, rFUTxPowerAlarm=rFUTxPowerAlarm, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, smtp=smtp, protectionStateTrap=protectionStateTrap, protectionInterfaceStatus=protectionInterfaceStatus, receiveModulation=receiveModulation, remotePrimaryMACAddress=remotePrimaryMACAddress, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNTPSync=sNTPSync, ptp800=ptp800, remoteSecondaryIPAddress=remoteSecondaryIPAddress, subnetMask=subnetMask, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPServerRetries=sNTPServerRetries, maxCodeRate=maxCodeRate, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPServerTimeout=sNTPServerTimeout, ethernetPriorityTableNumber=ethernetPriorityTableNumber, management=management, maxModulation=maxModulation, sNTPServerTable=sNTPServerTable, iPv4Address=iPv4Address, sMTPServerPortNumber=sMTPServerPortNumber, configuration=configuration, minCodeRate=minCodeRate, sNTPServerTableNumber=sNTPServerTableNumber, fiberY=fiberY, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, neighborIPAddress=neighborIPAddress, rFURfBand=rFURfBand, secureModeAlarm=secureModeAlarm, syslogClient=syslogClient, sMTPSourceEmailAddress=sMTPSourceEmailAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, vLANManagementVIDValidation=vLANManagementVIDValidation, protection=protection, radioLicenseModulation=radioLicenseModulation, remoteMACAddress=remoteMACAddress, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerTableEntry=sNTPServerTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, hTTPAccessEnabled=hTTPAccessEnabled, radioLicenseBandwidth=radioLicenseBandwidth, sMTPServerInternetAddressType=sMTPServerInternetAddressType, transmitterStatus=transmitterStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ptmp=ptmp, timeZone=timeZone, daylightSaving=daylightSaving, tFTPServerInternetAddressType=tFTPServerInternetAddressType, securityLevel=securityLevel, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rFUPowerButtonPressed=rFUPowerButtonPressed, sMTPEmailAlert=sMTPEmailAlert, phyControl=phyControl, rFUTxPowerMin=rFUTxPowerMin, bootVersion=bootVersion, managementPortWirelessDownAlert=managementPortWirelessDownAlert, endId=endId, activeUnit=activeUnit, managementPortDisabledWarning=managementPortDisabledWarning, rFUConnectedPlatform=rFUConnectedPlatform, transmitCapacity=transmitCapacity, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerInternetAddress=sNTPServerInternetAddress, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, receiveCodeRate=receiveCodeRate, rFURxFreqMin=rFURxFreqMin, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, l2CPPriorityTableEntry=l2CPPriorityTableEntry, linkNameMismatch=linkNameMismatch, rFUTxFreqMax=rFUTxFreqMax, ethernetPriorityTableIndex=ethernetPriorityTableIndex, wirelessLinkStatusTrap=wirelessLinkStatusTrap, vectorError=vectorError, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, managementPortForcedConfiguration=managementPortForcedConfiguration, longitude=longitude, managementPortStatusTrap=managementPortStatusTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, faultProtectionSwitching=faultProtectionSwitching, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rFURpsAlarm=rFURpsAlarm, sNMPEnabledTraps=sNMPEnabledTraps, sMTPServerInternetAddress=sMTPServerInternetAddress, phyStatus=phyStatus, rFUProtectionCompatibility=rFUProtectionCompatibility, dataPortFiberStatus=dataPortFiberStatus, dataPortStatus=dataPortStatus, managementMode=managementMode, sNMPTrapPortNumber=sNMPTrapPortNumber, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, radioLicenseMaxEIRP=radioLicenseMaxEIRP, remotePrimaryIPAddress=remotePrimaryIPAddress, ptpTraps=ptpTraps, supplementary=supplementary, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, rFUVersionBank1=rFUVersionBank1, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, sNTPState=sNTPState, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, iPv6Address=iPv6Address, alignmentModeTrap=alignmentModeTrap, bridge=bridge, radioLicenseCodeRate=radioLicenseCodeRate, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rxDiversityVid=rxDiversityVid, syslogStateTrap=syslogStateTrap, sNTPLastSync=sNTPLastSync, ethernetFiberSupport=ethernetFiberSupport, remoteInternetAddressType=remoteInternetAddressType, softwareVersion=softwareVersion, enableTransmission=enableTransmission, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userTableNumber=userTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, activeWirelessLinkAvailability=activeWirelessLinkAvailability, diverseRfFeederLoss=diverseRfFeederLoss, tFTPServerInternetAddress=tFTPServerInternetAddress, protectionAvailabilityStatus=protectionAvailabilityStatus, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPEnabledMessages=sMTPEnabledMessages, vLANManagementPriority=vLANManagementPriority, alignmentMode=alignmentMode, userTable=userTable, protectionState=protectionState, managementCommittedInformationRate=managementCommittedInformationRate, encryptionAlgorithm=encryptionAlgorithm, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rFUPlatformCompatibility=rFUPlatformCompatibility, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, syslogClientTrap=syslogClientTrap, userName=userName, radioLicenseMinModulation=radioLicenseMinModulation, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, rFUCableAlarm=rFUCableAlarm, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sNMPTrapTableIndex=sNMPTrapTableIndex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, iPDSCPPriorityTable=iPDSCPPriorityTable, protectionStatus=protectionStatus, transmitModulation=transmitModulation, linkName=linkName, receiveDataRate=receiveDataRate, wirelessLinkAvailability=wirelessLinkAvailability, primaryRecoveryPeriod=primaryRecoveryPeriod, telnetPortNumber=telnetPortNumber, ptp=ptp, dSCPManagementPriority=dSCPManagementPriority, sNTPServerInternetAddressType=sNTPServerInternetAddressType, radioLicenseTxFreq=radioLicenseTxFreq, remoteIPAddress=remoteIPAddress, aTPCEnable=aTPCEnable, activeAvailableTime=activeAvailableTime, gatewayIPAddress=gatewayIPAddress, syslogControl=syslogControl, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remoteSecondaryMACAddress=remoteSecondaryMACAddress, syslogState=syslogState, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFUTransceiverLocation=rFUTransceiverLocation, transmitCodeRate=transmitCodeRate, remotePrimarySecondaryMode=remotePrimarySecondaryMode, sNTPSyncTrap=sNTPSyncTrap, rFUTxPowerMax=rFUTxPowerMax, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rFUPowerAlarm=rFUPowerAlarm, radioLicense=radioLicense, radioLicenseBand=radioLicenseBand, transmitCapacityLimit=transmitCapacityLimit, sNTPServerResponse=sNTPServerResponse, licence=licence, userPassword=userPassword, rFUType=rFUType, rFUBranchingConfiguration=rFUBranchingConfiguration, latitude=latitude, requestedProtectionState=requestedProtectionState, rFUTxFreqMin=rFUTxFreqMin, rFUSerial=rFUSerial, transmitPower=transmitPower, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, systemClock=systemClock, rFUStatusTrap=rFUStatusTrap, rFURFSwitchAlarm=rFURFSwitchAlarm, reset=reset, ethernet=ethernet, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rFUActiveFirmwareBank=rFUActiveFirmwareBank, neighborMACAddress=neighborMACAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", dataPortDisabledWarning=dataPortDisabledWarning, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, antennaGain=antennaGain, rFUFreqSpacing=rFUFreqSpacing, encryption=encryption, rfu=rfu, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rxDiversityVlanTpid=rxDiversityVlanTpid, sNTPServerIPAddress=sNTPServerIPAddress, userRole=userRole, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, linkLoss=linkLoss, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, protectionConfigurationStatus=protectionConfigurationStatus, aggregateDataRate=aggregateDataRate, dataPortStatusTrap=dataPortStatusTrap, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPServerPortNumber=tFTPServerPortNumber, protectionConfig=protectionConfig, localPacketFiltering=localPacketFiltering, rFUTxMuteStatus=rFUTxMuteStatus, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, linkNameMismatchTrap=linkNameMismatchTrap, protectionSwitchCause=protectionSwitchCause, vLANManagementVID=vLANManagementVID, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, secondarySoftwareVersion=secondarySoftwareVersion, l2CPPriorityTable=l2CPPriorityTable, siteName=siteName, unitOutOfCalibration=unitOutOfCalibration, transmitDataRate=transmitDataRate, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, iPv6PrefixLength=iPv6PrefixLength, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, wirelessLinkStatus=wirelessLinkStatus, ethernetPriorityTable=ethernetPriorityTable, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, sntp=sntp, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rFURxFreqMax=rFURxFreqMax, userTableIndex=userTableIndex, primaryRecovery=primaryRecovery, alarms=alarms, userEnabled=userEnabled, dataPortPauseFrames=dataPortPauseFrames, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, numberOfAntennas=numberOfAntennas, remoteInternetAddress=remoteInternetAddress, systemReset=systemReset, ptpTrapPrefix=ptpTrapPrefix, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, sNMPTrapVersion=sNMPTrapVersion, maximumTransmitPower=maximumTransmitPower, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, productName=productName, encryptionEnabledMismatch=encryptionEnabledMismatch, dataPortFiberStatusTrap=dataPortFiberStatusTrap, qOSPriorityScheme=qOSPriorityScheme, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, productVariant=productVariant, hTTPSPortNumber=hTTPSPortNumber, primarySecondaryMode=primarySecondaryMode, aAAControl=aAAControl, sNMPPortNumber=sNMPPortNumber, hardwareVersion=hardwareVersion, altitude=altitude, radioLicenseRegion=radioLicenseRegion, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userTableEntry=userTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, versions=versions, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitCapacityLimitDetail=transmitCapacityLimitDetail)
