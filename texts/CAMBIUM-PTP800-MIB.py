...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", reset=reset, sNTPServerTimeout=sNTPServerTimeout, syslogClient=syslogClient, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPState=sNTPState, radioLicenseMaxModulation=radioLicenseMaxModulation, aTPCEnable=aTPCEnable, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, rFUFreqSpacing=rFUFreqSpacing, radioLicenseBandwidth=radioLicenseBandwidth, productName=productName, syslogControl=syslogControl, userTableNumber=userTableNumber, radioLicenseMaxEIRP=radioLicenseMaxEIRP, sNMPPortNumber=sNMPPortNumber, maxCodeRate=maxCodeRate, syslogState=syslogState, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, hTTPPortNumber=hTTPPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, managementPortStatusTrap=managementPortStatusTrap, l2CPPriorityTable=l2CPPriorityTable, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rFUVersionBank2=rFUVersionBank2, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, protection=protection, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPServerTable=sNTPServerTable, qOSPriorityScheme=qOSPriorityScheme, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, receiveCodeRate=receiveCodeRate, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, bridge=bridge, remoteSecondaryIPAddress=remoteSecondaryIPAddress, rfu=rfu, systemReset=systemReset, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapVersion=sNMPTrapVersion, longitude=longitude, rFUPowerAlarm=rFUPowerAlarm, protectionState=protectionState, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, userRole=userRole, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, enabledDiagnosticAlarms=enabledDiagnosticAlarms, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, syslogLocalWrappedTrap=syslogLocalWrappedTrap, timeZone=timeZone, dataPortFiberStatus=dataPortFiberStatus, dataPortStatusTrap=dataPortStatusTrap, hTTPAccessEnabled=hTTPAccessEnabled, transmitModulation=transmitModulation, iPDSCPPriorityTable=iPDSCPPriorityTable, radioLicenseCodeRate=radioLicenseCodeRate, iFCableLength=iFCableLength, radioLicenseTxFreq=radioLicenseTxFreq, linkNameMismatchTrap=linkNameMismatchTrap, radioLicenseIdentifier=radioLicenseIdentifier, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFUActiveFirmwareBank=rFUActiveFirmwareBank, siteName=siteName, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, maximumTransmitPower=maximumTransmitPower, remoteInternetAddress=remoteInternetAddress, alignmentModeTrap=alignmentModeTrap, receiveModulation=receiveModulation, ethernet=ethernet, managementPortAutoNegotiation=managementPortAutoNegotiation, mPLSTCPriorityTable=mPLSTCPriorityTable, encryptionEnabledMismatch=encryptionEnabledMismatch, userTableEntry=userTableEntry, rFURfBand=rFURfBand, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, diverseAntennaGain=diverseAntennaGain, radioLicenseMinCodeRate=radioLicenseMinCodeRate, userPassword=userPassword, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, userTableIndex=userTableIndex, altitude=altitude, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementMode=managementMode, transmitCapacity=transmitCapacity, bootVersion=bootVersion, rFUTxMuteStatus=rFUTxMuteStatus, rxDiversityVid=rxDiversityVid, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerIPAddress=sNTPServerIPAddress, vLANManagementVID=vLANManagementVID, managementPortConfigurationMismatch=managementPortConfigurationMismatch, ethernetPriorityTable=ethernetPriorityTable, smtp=smtp, sNTPPrimaryServer=sNTPPrimaryServer, subnetMask=subnetMask, sMTPServerPortNumber=sMTPServerPortNumber, rFUVersionBank1=rFUVersionBank1, alarms=alarms, rFUBranchingConfiguration=rFUBranchingConfiguration, ethernetPriorityTableEntry=ethernetPriorityTableEntry, receiveDataRate=receiveDataRate, protectionStateTrap=protectionStateTrap, rFUStatus=rFUStatus, secureModeAlarm=secureModeAlarm, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, cambium=cambium, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, radioLicenseRegion=radioLicenseRegion, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkNameMismatch=linkNameMismatch, fiberY=fiberY, radioLicenseModulation=radioLicenseModulation, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, systemClock=systemClock, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, transmitCapacityLimitDetail=transmitCapacityLimitDetail, neighborIPAddress=neighborIPAddress, aggregateDataRate=aggregateDataRate, radioLicenseMinModulation=radioLicenseMinModulation, rFUProtectionCompatibility=rFUProtectionCompatibility, iPv6Address=iPv6Address, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptp=ptp, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, wirelessLinkStatusTrap=wirelessLinkStatusTrap, encryption=encryption, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rFUTransceiverLocation=rFUTransceiverLocation, primarySecondaryMode=primarySecondaryMode, remotePrimaryInternetAddress=remotePrimaryInternetAddress, rFURpsAlarm=rFURpsAlarm, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, receivePower=receivePower, rFUType=rFUType, remoteSecondaryMACAddress=remoteSecondaryMACAddress, radioLicenseBand=radioLicenseBand, sNTPSync=sNTPSync, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rFULockoutAlarm=rFULockoutAlarm, telnetPortNumber=telnetPortNumber, remotePrimaryMACAddress=remotePrimaryMACAddress, management=management, neighborInternetAddress=neighborInternetAddress, dataPortPauseFrames=dataPortPauseFrames, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, l2CPPriorityTableIndex=l2CPPriorityTableIndex, daylightSaving=daylightSaving, linkName=linkName, latitude=latitude, endId=endId, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tFTPServerInternetAddress=tFTPServerInternetAddress, dataPortDisabledWarning=dataPortDisabledWarning, rFUTxPowerMax=rFUTxPowerMax, syslogStateTrap=syslogStateTrap, rFUTxFreqMax=rFUTxFreqMax, protectionStats=protectionStats, requestedProtectionState=requestedProtectionState, sNTPLastSync=sNTPLastSync, rFFeederLoss=rFFeederLoss, dataPortWirelessDownAlert=dataPortWirelessDownAlert, useVLANForManagementInterfaces=useVLANForManagementInterfaces, remotePrimaryIPAddress=remotePrimaryIPAddress, iPv6GatewayAddress=iPv6GatewayAddress, protectionConfig=protectionConfig, rFUPlatformCompatibility=rFUPlatformCompatibility, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, sNMPTrapPortNumber=sNMPTrapPortNumber, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sNTPServerRetries=sNTPServerRetries, minCodeRate=minCodeRate, sNMPTrapTableEntry=sNMPTrapTableEntry, rFUTxPowerMin=rFUTxPowerMin, sNTPServerInternetAddress=sNTPServerInternetAddress, userName=userName, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, sMTPServerInternetAddress=sMTPServerInternetAddress, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, sntp=sntp, rFURxFreqMin=rFURxFreqMin, activeUnit=activeUnit, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerPortNumber=sNTPServerPortNumber, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, syslogClientTrap=syslogClientTrap, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, phyStatus=phyStatus, remoteIPAddress=remoteIPAddress, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFUTxPowerAlarm=rFUTxPowerAlarm, rFUCableAlarm=rFUCableAlarm, rFUSerial=rFUSerial, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, sNTPPollInterval=sNTPPollInterval, rFURxFreqMax=rFURxFreqMax, ptpTraps=ptpTraps, wirelessLinkStatus=wirelessLinkStatus, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, faultProtectionSwitching=faultProtectionSwitching, iPv4Address=iPv4Address, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitterStatus=transmitterStatus, transmitCapacityLimit=transmitCapacityLimit, userEnabled=userEnabled, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rFUTxFreqMin=rFUTxFreqMin, sNMPTrapTableIndex=sNMPTrapTableIndex, vLANManagementPriority=vLANManagementPriority, sMTPEmailAlert=sMTPEmailAlert, sNTPServerTableEntry=sNTPServerTableEntry, unitOutOfCalibration=unitOutOfCalibration, sNMPEnabledTraps=sNMPEnabledTraps, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, transmitPower=transmitPower, productVariant=productVariant, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, secureModeAlarmTrap=secureModeAlarmTrap, vectorError=vectorError, vLANManagementVIDValidation=vLANManagementVIDValidation, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityString=sNMPCommunityString, sNTPSyncTrap=sNTPSyncTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ptpTrapPrefix=ptpTrapPrefix, rFUTxBandAboveRx=rFUTxBandAboveRx, dataPortFiberStatusTrap=dataPortFiberStatusTrap, numberOfAntennas=numberOfAntennas, protectionAvailabilityStatus=protectionAvailabilityStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitCodeRate=transmitCodeRate, neighborInternetAddressType=neighborInternetAddressType, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, remoteMACAddress=remoteMACAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, maxModulation=maxModulation, rFUPowerButtonPressed=rFUPowerButtonPressed, protectionConfigurationStatus=protectionConfigurationStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, hardwareVersion=hardwareVersion, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, linkLoss=linkLoss, sMTPServerIPAddress=sMTPServerIPAddress, rxDiversityDataPortStatus=rxDiversityDataPortStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, hTTPSPortNumber=hTTPSPortNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPServerTableNumber=sNTPServerTableNumber, encryptionAlgorithm=encryptionAlgorithm, snmpControl=snmpControl, activeAvailableTime=activeAvailableTime, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, userTable=userTable, rFURFSwitchAlarm=rFURFSwitchAlarm, supplementary=supplementary, activeWirelessLinkAvailability=activeWirelessLinkAvailability, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, ptp800=ptp800, enableTransmission=enableTransmission, versions=versions, l2CPPriorityTableEntry=l2CPPriorityTableEntry, protectionStatus=protectionStatus, transmitDataRate=transmitDataRate, rFUConnectedPlatform=rFUConnectedPlatform, tFTPServerInternetAddressType=tFTPServerInternetAddressType, securityLevel=securityLevel, primaryRecoveryPeriod=primaryRecoveryPeriod, rxDiversityVlanTpid=rxDiversityVlanTpid, phyControl=phyControl, configuration=configuration, ethernetFiberSupport=ethernetFiberSupport, dSCPManagementPriority=dSCPManagementPriority, managementPortStatus=managementPortStatus, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, aAAControl=aAAControl, protectionSwitchCause=protectionSwitchCause, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, iPv6PrefixLength=iPv6PrefixLength, sMTPEnabledMessages=sMTPEnabledMessages, diverseRfFeederLoss=diverseRfFeederLoss, neighborMACAddress=neighborMACAddress, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, localPacketFiltering=localPacketFiltering, hTTPSAccessEnabled=hTTPSAccessEnabled, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, antennaGain=antennaGain, ptmp=ptmp, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, sNMPTrapTable=sNMPTrapTable, iPVersion=iPVersion, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, minModulation=minModulation, tFTPServerIPAddress=tFTPServerIPAddress, radioLicenseRxFreq=radioLicenseRxFreq, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, managementPortForcedConfiguration=managementPortForcedConfiguration, licence=licence, dataPortStatus=dataPortStatus, primaryRecovery=primaryRecovery, alignmentMode=alignmentMode, protectionInterfaceStatus=protectionInterfaceStatus, rFUStatusTrap=rFUStatusTrap, softwareVersion=softwareVersion, sNTPServerResponse=sNTPServerResponse, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, managementPortWirelessDownAlert=managementPortWirelessDownAlert, managementPortDisabledWarning=managementPortDisabledWarning, wirelessLinkAvailability=wirelessLinkAvailability, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, managementCommittedInformationRate=managementCommittedInformationRate, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, remoteInternetAddressType=remoteInternetAddressType, secondarySoftwareVersion=secondarySoftwareVersion, ethernetPriorityTableNumber=ethernetPriorityTableNumber, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, radioLicense=radioLicense, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, pubStats=pubStats, sMTPServerInternetAddressType=sMTPServerInternetAddressType, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress)
