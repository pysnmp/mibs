...
MibIdentifier, IpAddress, Bits, Integer32, TimeTicks, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, NotificationType, Gauge32, Counter64, Unsigned32, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "Bits", "Integer32", "TimeTicks", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "NotificationType", "Gauge32", "Counter64", "Unsigned32", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", vLANManagementPriority=vLANManagementPriority, encryptionAlgorithm=encryptionAlgorithm, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, activeUnit=activeUnit, remotePrimarySecondaryMode=remotePrimarySecondaryMode, iFCableLength=iFCableLength, receiveModulation=receiveModulation, neighborInternetAddress=neighborInternetAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, linkNameMismatch=linkNameMismatch, sMTPEnabledMessages=sMTPEnabledMessages, localPacketFiltering=localPacketFiltering, sNMPTrapIPAddress=sNMPTrapIPAddress, diverseAntennaGain=diverseAntennaGain, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveDataRate=receiveDataRate, rFUTxFreqMax=rFUTxFreqMax, sNTPState=sNTPState, rFUTxFreqMin=rFUTxFreqMin, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, secondarySoftwareVersion=secondarySoftwareVersion, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFUSerial=rFUSerial, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, iPDSCPPriorityTable=iPDSCPPriorityTable, phyStatus=phyStatus, userTableEntry=userTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, activeAvailableTime=activeAvailableTime, transmitCodeRate=transmitCodeRate, rFURfBand=rFURfBand, rFULockoutAlarm=rFULockoutAlarm, managementPortDisabledWarning=managementPortDisabledWarning, rFUCableAlarm=rFUCableAlarm, protectionStats=protectionStats, gatewayIPAddress=gatewayIPAddress, bridge=bridge, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFFeederLoss=rFFeederLoss, snmpControl=snmpControl, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, daylightSaving=daylightSaving, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, transmitCapacityLimit=transmitCapacityLimit, configuration=configuration, radioLicenseBandwidth=radioLicenseBandwidth, protectionState=protectionState, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, encryptionEnabledMismatch=encryptionEnabledMismatch, wirelessLinkStatus=wirelessLinkStatus, softwareVersion=softwareVersion, minCodeRate=minCodeRate, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPPrimaryServer=sNTPPrimaryServer, rFURpsAlarm=rFURpsAlarm, wirelessLinkStatusTrap=wirelessLinkStatusTrap, managementMode=managementMode, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, protectionStateTrap=protectionStateTrap, diverseRfFeederLoss=diverseRfFeederLoss, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFUVersionBank2=rFUVersionBank2, vLANManagementVID=vLANManagementVID, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPCommunityString=sNMPCommunityString, sNTPLastSync=sNTPLastSync, transmitCapacityLimitDetail=transmitCapacityLimitDetail, neighborInternetAddressType=neighborInternetAddressType, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, protectionAvailabilityStatus=protectionAvailabilityStatus, iPv4Address=iPv4Address, productVariant=productVariant, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, rFUBranchingConfiguration=rFUBranchingConfiguration, rFUTxPowerAlarm=rFUTxPowerAlarm, bootVersion=bootVersion, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, linkLoss=linkLoss, protection=protection, ptpTraps=ptpTraps, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapPortNumber=sNMPTrapPortNumber, userTable=userTable, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, requestedProtectionState=requestedProtectionState, sNTPSyncTrap=sNTPSyncTrap, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, hTTPSPortNumber=hTTPSPortNumber, syslogControl=syslogControl, latitude=latitude, fiberY=fiberY, receivePower=receivePower, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, timeZone=timeZone, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, rFUStatusTrap=rFUStatusTrap, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, hTTPAccessEnabled=hTTPAccessEnabled, endId=endId, rFURxFreqMax=rFURxFreqMax, secureModeAlarmTrap=secureModeAlarmTrap, radioLicenseIdentifier=radioLicenseIdentifier, altitude=altitude, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFUPlatformCompatibility=rFUPlatformCompatibility, transmitModulation=transmitModulation, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, protectionStatus=protectionStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sNTPServerTableEntry=sNTPServerTableEntry, sNTPServerInternetAddress=sNTPServerInternetAddress, ptmp=ptmp, neighborIPAddress=neighborIPAddress, pubStats=pubStats, supplementary=supplementary, activeWirelessLinkAvailability=activeWirelessLinkAvailability, enabledDiagnosticAlarms=enabledDiagnosticAlarms, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, dataPortFiberStatusTrap=dataPortFiberStatusTrap, encryption=encryption, siteName=siteName, maxModulation=maxModulation, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, phyControl=phyControl, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, receiveCodeRate=receiveCodeRate, sNTPServerTable=sNTPServerTable, radioLicenseBand=radioLicenseBand, remotePrimaryInternetAddress=remotePrimaryInternetAddress, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, systemClock=systemClock, remoteInternetAddressType=remoteInternetAddressType, rFUConnectedPlatform=rFUConnectedPlatform, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, sMTPServerPortNumber=sMTPServerPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, reset=reset, sNMPTrapTableIndex=sNMPTrapTableIndex, rFUTxBandAboveRx=rFUTxBandAboveRx, qOSPriorityScheme=qOSPriorityScheme, remoteSecondaryIPAddress=remoteSecondaryIPAddress, aggregateDataRate=aggregateDataRate, rFURxFreqMin=rFURxFreqMin, smtp=smtp, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFUTxPowerMin=rFUTxPowerMin, sNTPServerTimeout=sNTPServerTimeout, tFTPServerInternetAddressType=tFTPServerInternetAddressType, maxCodeRate=maxCodeRate, ptp800=ptp800, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPTrapTable=sNMPTrapTable, vectorError=vectorError, iPv6Address=iPv6Address, userRole=userRole, primaryRecovery=primaryRecovery, remoteMACAddress=remoteMACAddress, managementPortForcedConfiguration=managementPortForcedConfiguration, sntp=sntp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, radioLicenseModulation=radioLicenseModulation, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, telnetAccessEnabled=telnetAccessEnabled, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPPollInterval=sNTPPollInterval, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, protectionSwitchCause=protectionSwitchCause, enableTransmission=enableTransmission, radioLicenseTxFreq=radioLicenseTxFreq, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, unitOutOfCalibration=unitOutOfCalibration, rFUFreqSpacing=rFUFreqSpacing, productName=productName, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, managementPortStatusTrap=managementPortStatusTrap, rxDiversityVid=rxDiversityVid, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rFURFSwitchAlarm=rFURFSwitchAlarm, wirelessLinkAvailability=wirelessLinkAvailability, sNMPEnabledTraps=sNMPEnabledTraps, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, linkNameMismatchTrap=linkNameMismatchTrap, transmitDataRate=transmitDataRate, managementPortStatus=managementPortStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, radioLicenseRxFreq=radioLicenseRxFreq, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dataPortStatus=dataPortStatus, remoteInternetAddress=remoteInternetAddress, subnetMask=subnetMask, syslogClient=syslogClient, managementPortAutoNegotiation=managementPortAutoNegotiation, radioLicenseMaxEIRP=radioLicenseMaxEIRP, iPVersion=iPVersion, sNTPServerRetries=sNTPServerRetries, antennaGain=antennaGain, aAAControl=aAAControl, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, ethernetPriorityTable=ethernetPriorityTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, l2CPPriorityTableIndex=l2CPPriorityTableIndex, radioLicenseMinCodeRate=radioLicenseMinCodeRate, primarySecondaryMode=primarySecondaryMode, securityLevel=securityLevel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitCapacity=transmitCapacity, rFUPowerAlarm=rFUPowerAlarm, userEnabled=userEnabled, ethernetFiberSupport=ethernetFiberSupport, neighborMACAddress=neighborMACAddress, rFUType=rFUType, hTTPPortNumber=hTTPPortNumber, management=management, sNMPTrapTableEntry=sNMPTrapTableEntry, numberOfAntennas=numberOfAntennas, radioLicense=radioLicense, protectionConfigurationStatus=protectionConfigurationStatus, rxDiversityDataPortStatus=rxDiversityDataPortStatus, licence=licence, rFUTransceiverLocation=rFUTransceiverLocation, aTPCEnable=aTPCEnable, hardwareVersion=hardwareVersion, sNTPServerTableNumber=sNTPServerTableNumber, sNTPServerTableIndex=sNTPServerTableIndex, alignmentMode=alignmentMode, tFTPServerIPAddress=tFTPServerIPAddress, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userTableIndex=userTableIndex, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, minModulation=minModulation, faultProtectionSwitching=faultProtectionSwitching, userPassword=userPassword, l2CPPriorityTable=l2CPPriorityTable)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", versions=versions, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPSync=sNTPSync, rxDiversityVlanTpid=rxDiversityVlanTpid, tFTPServerInternetAddress=tFTPServerInternetAddress, userName=userName, rFUTxPowerMax=rFUTxPowerMax, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dSCPManagementPriority=dSCPManagementPriority, rfu=rfu, syslogStateTrap=syslogStateTrap, sNTPServerPortNumber=sNTPServerPortNumber, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, protectionConfig=protectionConfig, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, ptpTrapPrefix=ptpTrapPrefix, ethernetPriorityTableEntry=ethernetPriorityTableEntry, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, secureModeAlarm=secureModeAlarm, dataPortConfigurationMismatch=dataPortConfigurationMismatch, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, managementCommittedInformationRate=managementCommittedInformationRate, radioLicenseMinModulation=radioLicenseMinModulation, remoteIPAddress=remoteIPAddress, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, syslogClientTrap=syslogClientTrap, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, sMTPServerIPAddress=sMTPServerIPAddress, protectionInterfaceStatus=protectionInterfaceStatus, syslogState=syslogState, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNTPServerIPAddress=sNTPServerIPAddress, iPv6PrefixLength=iPv6PrefixLength, iPv6GatewayAddress=iPv6GatewayAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNMPPortNumber=sNMPPortNumber, alignmentModeTrap=alignmentModeTrap, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, alarms=alarms, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, radioLicenseMaxModulation=radioLicenseMaxModulation, userTableNumber=userTableNumber, dataPortFiberStatus=dataPortFiberStatus, rFUPowerButtonPressed=rFUPowerButtonPressed, rFUVersionBank1=rFUVersionBank1, rFUTxMuteStatus=rFUTxMuteStatus, cambium=cambium, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptp=ptp, transmitterStatus=transmitterStatus, sNMPTrapVersion=sNMPTrapVersion, telnetPortNumber=telnetPortNumber, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, remotePrimaryIPAddress=remotePrimaryIPAddress, ethernet=ethernet, rFUStatus=rFUStatus, dataPortDisabledWarning=dataPortDisabledWarning, rFUProtectionCompatibility=rFUProtectionCompatibility, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, dataPortPauseFrames=dataPortPauseFrames, sNTPServerResponse=sNTPServerResponse, systemReset=systemReset, tFTPServerPortNumber=tFTPServerPortNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, vLANManagementVIDValidation=vLANManagementVIDValidation, radioLicenseCodeRate=radioLicenseCodeRate, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, dataPortStatusTrap=dataPortStatusTrap, radioLicenseRegion=radioLicenseRegion, remotePrimaryMACAddress=remotePrimaryMACAddress, longitude=longitude, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, managementPortConfigurationMismatch=managementPortConfigurationMismatch, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, primaryRecoveryPeriod=primaryRecoveryPeriod, transmitPower=transmitPower, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, linkName=linkName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress)
