...
Integer32, Counter64, ModuleIdentity, iso, NotificationType, enterprises, Gauge32, MibIdentifier, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, IpAddress, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "ModuleIdentity", "iso", "NotificationType", "enterprises", "Gauge32", "MibIdentifier", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "IpAddress", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUProtectionCompatibility=rFUProtectionCompatibility, ptmp=ptmp, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerTableNumber=sNTPServerTableNumber, userTableIndex=userTableIndex, ptp800=ptp800, sNTPSyncTrap=sNTPSyncTrap, vLANManagementVID=vLANManagementVID, remotePrimarySecondaryMode=remotePrimarySecondaryMode, securityLevel=securityLevel, managementPortDisabledWarning=managementPortDisabledWarning, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, receiveCodeRate=receiveCodeRate, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, syslogClient=syslogClient, daylightSaving=daylightSaving, sNTPServerInternetAddressType=sNTPServerInternetAddressType, faultProtectionSwitching=faultProtectionSwitching, remoteSecondaryIPAddress=remoteSecondaryIPAddress, rxDiversityVid=rxDiversityVid, transmitModulation=transmitModulation, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPState=sNTPState, protectionState=protectionState, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, radioLicenseModulation=radioLicenseModulation, syslogControl=syslogControl, wirelessLinkStatusTrap=wirelessLinkStatusTrap, endId=endId, sNTPServerResponse=sNTPServerResponse, reset=reset, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, subnetMask=subnetMask, managementPortForcedConfiguration=managementPortForcedConfiguration, versions=versions, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, encryptionEnabledMismatch=encryptionEnabledMismatch, sNTPPollInterval=sNTPPollInterval, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sNMPTrapTableEntry=sNMPTrapTableEntry, qOSPriorityScheme=qOSPriorityScheme, wirelessLinkStatus=wirelessLinkStatus, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, remotePrimaryIPAddress=remotePrimaryIPAddress, rFUFreqSpacing=rFUFreqSpacing, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPSync=sNTPSync, minModulation=minModulation, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sNMPPortNumber=sNMPPortNumber, neighborMACAddress=neighborMACAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, iFCableLength=iFCableLength, rFURFSwitchAlarm=rFURFSwitchAlarm, iPv6Address=iPv6Address, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapIPAddress=sNMPTrapIPAddress, managementMode=managementMode, bridge=bridge, useVLANForManagementInterfaces=useVLANForManagementInterfaces, remoteSecondaryMACAddress=remoteSecondaryMACAddress, transmitCapacity=transmitCapacity, sNMPCommunityString=sNMPCommunityString, remoteMACAddress=remoteMACAddress, rFUTxPowerMin=rFUTxPowerMin, radioLicenseRegion=radioLicenseRegion, linkNameMismatch=linkNameMismatch, gatewayIPAddress=gatewayIPAddress, alarms=alarms, dataPortStatus=dataPortStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, radioLicenseMinCodeRate=radioLicenseMinCodeRate, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPLastSync=sNTPLastSync, transmitCapacityLimitDetail=transmitCapacityLimitDetail, radioLicenseRxFreq=radioLicenseRxFreq, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteInternetAddressType=remoteInternetAddressType, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, telnetAccessEnabled=telnetAccessEnabled, ethernetFiberSupport=ethernetFiberSupport, requestedProtectionState=requestedProtectionState, softwareVersion=softwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, rFUStatusTrap=rFUStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rfu=rfu, systemReset=systemReset, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, transmitCapacityLimit=transmitCapacityLimit, l2CPPriorityTable=l2CPPriorityTable, sNTPPrimaryServer=sNTPPrimaryServer, rFURxFreqMax=rFURxFreqMax, sNTPServerTableEntry=sNTPServerTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, telnetPortNumber=telnetPortNumber, primarySecondaryMode=primarySecondaryMode, radioLicenseMaxModulation=radioLicenseMaxModulation, managementPortStatus=managementPortStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, productVariant=productVariant, transmitDataRate=transmitDataRate, rFUCableAlarm=rFUCableAlarm, primaryRecoveryPeriod=primaryRecoveryPeriod, secondarySoftwareVersion=secondarySoftwareVersion, aAAControl=aAAControl, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sMTPEnabledMessages=sMTPEnabledMessages, userPassword=userPassword, userRole=userRole, vectorError=vectorError, rFUTxMuteStatus=rFUTxMuteStatus, rFUTxBandAboveRx=rFUTxBandAboveRx, protectionStateTrap=protectionStateTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, remotePrimaryMACAddress=remotePrimaryMACAddress, remoteInternetAddress=remoteInternetAddress, sMTPServerPortNumber=sMTPServerPortNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPPortNumber=hTTPPortNumber, phyStatus=phyStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, encryptionAlgorithm=encryptionAlgorithm, rFUVersionBank1=rFUVersionBank1, secureModeAlarmTrap=secureModeAlarmTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rFUVersionBank2=rFUVersionBank2, activeUnit=activeUnit, dataPortConfigurationMismatch=dataPortConfigurationMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, sNMPTrapTable=sNMPTrapTable, linkName=linkName, enableTransmission=enableTransmission, iPVersion=iPVersion, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userTable=userTable, rFURxFreqMin=rFURxFreqMin, rFUBranchingConfiguration=rFUBranchingConfiguration, unitOutOfCalibration=unitOutOfCalibration, syslogState=syslogState, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, snmpControl=snmpControl, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, radioLicenseIdentifier=radioLicenseIdentifier, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, rFUPowerButtonPressed=rFUPowerButtonPressed, transmitPower=transmitPower, radioLicenseCodeRate=radioLicenseCodeRate, rFURfBand=rFURfBand, dataPortDisabledWarning=dataPortDisabledWarning, protectionAvailabilityStatus=protectionAvailabilityStatus, receiveDataRate=receiveDataRate, radioLicenseBand=radioLicenseBand, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, userEnabled=userEnabled, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, sntp=sntp, rxDiversityDataPortStatus=rxDiversityDataPortStatus, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, radioLicenseBandwidth=radioLicenseBandwidth, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, ethernet=ethernet, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rFUType=rFUType, maxModulation=maxModulation, hTTPAccessEnabled=hTTPAccessEnabled, vLANManagementPriority=vLANManagementPriority, neighborIPAddress=neighborIPAddress, rFUConnectedPlatform=rFUConnectedPlatform, protectionStatus=protectionStatus, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, siteName=siteName, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPv4Address=iPv4Address, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rFUStatus=rFUStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, radioLicenseMaxEIRP=radioLicenseMaxEIRP, rFUTransceiverLocation=rFUTransceiverLocation, sNTPServerIPAddress=sNTPServerIPAddress, managementPortStatusTrap=managementPortStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, alignmentMode=alignmentMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptpTraps=ptpTraps, activeAvailableTime=activeAvailableTime, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, receiveModulation=receiveModulation, primaryRecovery=primaryRecovery, rFUTxPowerAlarm=rFUTxPowerAlarm, linkLoss=linkLoss, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFUTxFreqMax=rFUTxFreqMax, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sMTPEmailAlert=sMTPEmailAlert, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, ptp=ptp, transmitterStatus=transmitterStatus, localPacketFiltering=localPacketFiltering, mPLSTCPriorityTable=mPLSTCPriorityTable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licence=licence, aggregateDataRate=aggregateDataRate, neighborInternetAddress=neighborInternetAddress, minCodeRate=minCodeRate, encryption=encryption, userName=userName, ethernetPriorityTable=ethernetPriorityTable, phyControl=phyControl, diverseRfFeederLoss=diverseRfFeederLoss, remotePrimaryInternetAddress=remotePrimaryInternetAddress, linkNameMismatchTrap=linkNameMismatchTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, timeZone=timeZone, neighborInternetAddressType=neighborInternetAddressType, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, configuration=configuration, longitude=longitude, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, diverseAntennaGain=diverseAntennaGain, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, managementPortAutoNegotiation=managementPortAutoNegotiation, secureModeAlarm=secureModeAlarm, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", management=management, protection=protection, iPv6PrefixLength=iPv6PrefixLength, userTableEntry=userTableEntry, dataPortStatusTrap=dataPortStatusTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, aTPCEnable=aTPCEnable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, hTTPSPortNumber=hTTPSPortNumber, syslogStateTrap=syslogStateTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, maxCodeRate=maxCodeRate, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receivePower=receivePower, dataPortPauseFrames=dataPortPauseFrames, managementCommittedInformationRate=managementCommittedInformationRate, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFUTxFreqMin=rFUTxFreqMin, sNTPServerRetries=sNTPServerRetries, antennaGain=antennaGain, supplementary=supplementary, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rFULockoutAlarm=rFULockoutAlarm, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, protectionStats=protectionStats, rFURpsAlarm=rFURpsAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber, latitude=latitude, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, dataPortFiberStatus=dataPortFiberStatus, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFUSerial=rFUSerial, syslogClientTrap=syslogClientTrap, maximumTransmitPower=maximumTransmitPower, rxDiversityVlanTpid=rxDiversityVlanTpid, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, altitude=altitude, sNTPServerTimeout=sNTPServerTimeout, protectionInterfaceStatus=protectionInterfaceStatus, smtp=smtp, rFFeederLoss=rFFeederLoss, radioLicense=radioLicense, hardwareVersion=hardwareVersion, iPv6GatewayAddress=iPv6GatewayAddress, radioLicenseTxFreq=radioLicenseTxFreq, sNMPEnabledTraps=sNMPEnabledTraps, bootVersion=bootVersion, rFUActiveFirmwareBank=rFUActiveFirmwareBank, tFTPServerPortNumber=tFTPServerPortNumber, ptpTrapPrefix=ptpTrapPrefix, protectionSwitchCause=protectionSwitchCause, protectionConfigurationStatus=protectionConfigurationStatus, sNTPServerTableIndex=sNTPServerTableIndex, rFUPlatformCompatibility=rFUPlatformCompatibility, sNMPTrapVersion=sNMPTrapVersion, activeWirelessLinkAvailability=activeWirelessLinkAvailability, l2CPPriorityTableEntry=l2CPPriorityTableEntry, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, transmitCodeRate=transmitCodeRate, sNTPServerPortNumber=sNTPServerPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, alignmentModeTrap=alignmentModeTrap, protectionConfig=protectionConfig, systemClock=systemClock, cambium=cambium, rFUPowerAlarm=rFUPowerAlarm, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, productName=productName, sNMPTrapInternetAddress=sNMPTrapInternetAddress, numberOfAntennas=numberOfAntennas, sNTPServerTable=sNTPServerTable, pubStats=pubStats, fiberY=fiberY, radioLicenseMinModulation=radioLicenseMinModulation, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, vLANManagementVIDValidation=vLANManagementVIDValidation, rFUTxPowerMax=rFUTxPowerMax, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, userTableNumber=userTableNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sMTPServerInternetAddress=sMTPServerInternetAddress, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, remoteIPAddress=remoteIPAddress)
