...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUTxBandAboveRx=rFUTxBandAboveRx, sNTPState=sNTPState, rFURfBand=rFURfBand, protectionConfigurationStatus=protectionConfigurationStatus, rFURpsAlarm=rFURpsAlarm, rFURFSwitchAlarm=rFURFSwitchAlarm, sNTPPollInterval=sNTPPollInterval, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPServerInternetAddressType=sMTPServerInternetAddressType, softwareVersion=softwareVersion, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTableNumber=sNMPTrapTableNumber, localPacketFiltering=localPacketFiltering, faultProtectionSwitching=faultProtectionSwitching, remoteIPAddress=remoteIPAddress, transmitCapacityLimit=transmitCapacityLimit, diverseAntennaGain=diverseAntennaGain, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFUTxPowerAlarm=rFUTxPowerAlarm, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, endId=endId, licence=licence, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPPortNumber=sNMPPortNumber, managementPortStatusTrap=managementPortStatusTrap, alignmentMode=alignmentMode, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, iFCableLength=iFCableLength, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, secureModeAlarmTrap=secureModeAlarmTrap, neighborMACAddress=neighborMACAddress, linkLoss=linkLoss, rFUConnectedPlatform=rFUConnectedPlatform, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, maximumTransmitPower=maximumTransmitPower, sMTPServerIPAddress=sMTPServerIPAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, aAAControl=aAAControl, altitude=altitude, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, qOSPriorityScheme=qOSPriorityScheme, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, productName=productName, aggregateDataRate=aggregateDataRate, radioLicenseCodeRate=radioLicenseCodeRate, receivePower=receivePower, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, linkNameMismatch=linkNameMismatch, management=management, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetPriorityTable=ethernetPriorityTable, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rFUVersionBank2=rFUVersionBank2, minModulation=minModulation, transmitterStatus=transmitterStatus, rFFeederLoss=rFFeederLoss, snmpControl=snmpControl, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, radioLicenseBandwidth=radioLicenseBandwidth, sNTPLastSync=sNTPLastSync, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, rFUPowerAlarm=rFUPowerAlarm, sMTPEnabledMessages=sMTPEnabledMessages, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetFiberSupport=ethernetFiberSupport, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, alignmentModeTrap=alignmentModeTrap, rFUCableAlarm=rFUCableAlarm, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, remotePrimaryMACAddress=remotePrimaryMACAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, dataPortFiberStatus=dataPortFiberStatus, cambium=cambium, userEnabled=userEnabled, syslogClientTrap=syslogClientTrap, radioLicenseModulation=radioLicenseModulation, linkNameMismatchTrap=linkNameMismatchTrap, sntp=sntp, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, l2CPPriorityTable=l2CPPriorityTable, telnetPortNumber=telnetPortNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, minCodeRate=minCodeRate, rFULockoutAlarm=rFULockoutAlarm, sNMPTrapTable=sNMPTrapTable, syslogState=syslogState, pubStats=pubStats, sNTPServerTimeout=sNTPServerTimeout, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitCapacity=transmitCapacity, wirelessLinkStatusTrap=wirelessLinkStatusTrap, unitOutOfCalibration=unitOutOfCalibration, longitude=longitude, wirelessLinkStatus=wirelessLinkStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPServerTableNumber=sNTPServerTableNumber, ptmp=ptmp, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rFUTxPowerMax=rFUTxPowerMax, hTTPPortNumber=hTTPPortNumber, systemClock=systemClock, rFUVersionBank1=rFUVersionBank1, ethernet=ethernet, activeWirelessLinkAvailability=activeWirelessLinkAvailability, sMTPEmailAlert=sMTPEmailAlert, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, versions=versions, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, receiveModulation=receiveModulation, managementPortConfigurationMismatch=managementPortConfigurationMismatch, phyStatus=phyStatus, iPv6PrefixLength=iPv6PrefixLength, radioLicenseMaxEIRP=radioLicenseMaxEIRP, iPVersion=iPVersion, sNMPTrapVersion=sNMPTrapVersion, transmitPower=transmitPower, encryption=encryption, rFUTxPowerMin=rFUTxPowerMin, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, timeZone=timeZone, transmitCapacityLimitDetail=transmitCapacityLimitDetail, rFUProtectionCompatibility=rFUProtectionCompatibility, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rFUTxFreqMin=rFUTxFreqMin, rFURxFreqMax=rFURxFreqMax, rFUPowerButtonPressed=rFUPowerButtonPressed, rxDiversityDataPortStatus=rxDiversityDataPortStatus, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogStateTrap=syslogStateTrap, remoteSecondaryIPAddress=remoteSecondaryIPAddress, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, userTableEntry=userTableEntry, smtp=smtp, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rxDiversityVid=rxDiversityVid, rFUType=rFUType, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, subnetMask=subnetMask, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rFUPlatformCompatibility=rFUPlatformCompatibility, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUTxFreqMax=rFUTxFreqMax, vectorError=vectorError, activeAvailableTime=activeAvailableTime, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, linkName=linkName, radioLicenseTxFreq=radioLicenseTxFreq, sNTPServerTableIndex=sNTPServerTableIndex, userName=userName, radioLicenseRxFreq=radioLicenseRxFreq, iPDSCPPriorityTable=iPDSCPPriorityTable, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, securityLevel=securityLevel, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rFUStatusTrap=rFUStatusTrap, configuration=configuration, rfu=rfu, alarms=alarms, primaryRecovery=primaryRecovery, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, protection=protection, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, rFUTxMuteStatus=rFUTxMuteStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, secondarySoftwareVersion=secondarySoftwareVersion, remotePrimarySecondaryMode=remotePrimarySecondaryMode, radioLicenseMinModulation=radioLicenseMinModulation, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableEntry=sNMPTrapTableEntry, requestedProtectionState=requestedProtectionState, remoteMACAddress=remoteMACAddress, iPv6Address=iPv6Address, vLANManagementVIDValidation=vLANManagementVIDValidation, remotePrimaryIPAddress=remotePrimaryIPAddress, antennaGain=antennaGain, iPv6GatewayAddress=iPv6GatewayAddress, siteName=siteName, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rFURxFreqMin=rFURxFreqMin, sNTPSyncTrap=sNTPSyncTrap, secureModeAlarm=secureModeAlarm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, activeUnit=activeUnit, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, userTableNumber=userTableNumber, dataPortStatusTrap=dataPortStatusTrap, encryptionAlgorithm=encryptionAlgorithm, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, bootVersion=bootVersion, neighborIPAddress=neighborIPAddress, managementPortAutoNegotiation=managementPortAutoNegotiation, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, telnetAccessEnabled=telnetAccessEnabled, neighborInternetAddress=neighborInternetAddress, rxDiversityVlanTpid=rxDiversityVlanTpid, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, daylightSaving=daylightSaving, sNTPServerTableEntry=sNTPServerTableEntry, radioLicenseRegion=radioLicenseRegion, protectionSwitchCause=protectionSwitchCause, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ptp=ptp, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, gatewayIPAddress=gatewayIPAddress, dSCPManagementPriority=dSCPManagementPriority, userTableIndex=userTableIndex, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userTable=userTable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, vLANManagementVID=vLANManagementVID, bridge=bridge, encryptionEnabledMismatch=encryptionEnabledMismatch, transmitCodeRate=transmitCodeRate, ptp800=ptp800, protectionStateTrap=protectionStateTrap, sNMPCommunityString=sNMPCommunityString, fiberY=fiberY, protectionStats=protectionStats, sNTPServerRetries=sNTPServerRetries, remoteSecondaryMACAddress=remoteSecondaryMACAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, l2CPPriorityTableIndex=l2CPPriorityTableIndex, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, rFUTransceiverLocation=rFUTransceiverLocation, remoteInternetAddress=remoteInternetAddress, vLANManagementPriority=vLANManagementPriority, transmitDataRate=transmitDataRate, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", dataPortStatus=dataPortStatus, hTTPAccessEnabled=hTTPAccessEnabled, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, iPv4Address=iPv4Address, primarySecondaryMode=primarySecondaryMode, managementPortDisabledWarning=managementPortDisabledWarning, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, radioLicenseIdentifier=radioLicenseIdentifier, maxModulation=maxModulation, managementPortStatus=managementPortStatus, reset=reset, diverseRfFeederLoss=diverseRfFeederLoss, sNTPServerResponse=sNTPServerResponse, protectionInterfaceStatus=protectionInterfaceStatus, syslogClient=syslogClient, managementPortForcedConfiguration=managementPortForcedConfiguration, phyControl=phyControl, radioLicense=radioLicense, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, syslogControl=syslogControl, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rFUFreqSpacing=rFUFreqSpacing, primaryRecoveryPeriod=primaryRecoveryPeriod, protectionState=protectionState, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, supplementary=supplementary, sNTPSync=sNTPSync, sNTPPrimaryServer=sNTPPrimaryServer, numberOfAntennas=numberOfAntennas, transmitModulation=transmitModulation, tFTPServerIPAddress=tFTPServerIPAddress, maxCodeRate=maxCodeRate, receiveCodeRate=receiveCodeRate, sNTPServerPortNumber=sNTPServerPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerIPAddress=sNTPServerIPAddress, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementMode=managementMode, rFUSerial=rFUSerial, userPassword=userPassword, systemReset=systemReset, sNMPTrapPortNumber=sNMPTrapPortNumber, userRole=userRole, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ptpTraps=ptpTraps, sMTPSourceEmailAddress=sMTPSourceEmailAddress, neighborInternetAddressType=neighborInternetAddressType, protectionConfig=protectionConfig, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hardwareVersion=hardwareVersion, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, enableTransmission=enableTransmission, remotePrimaryInternetAddress=remotePrimaryInternetAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, productVariant=productVariant, managementCommittedInformationRate=managementCommittedInformationRate, remoteInternetAddressType=remoteInternetAddressType, aTPCEnable=aTPCEnable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, protectionStatus=protectionStatus, dataPortDisabledWarning=dataPortDisabledWarning, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, tFTPServerInternetAddress=tFTPServerInternetAddress, tFTPServerPortNumber=tFTPServerPortNumber, latitude=latitude, radioLicenseMaxModulation=radioLicenseMaxModulation, sMTPServerPortNumber=sMTPServerPortNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPServerTable=sNTPServerTable, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rFUStatus=rFUStatus, radioLicenseBand=radioLicenseBand, rFUBranchingConfiguration=rFUBranchingConfiguration, receiveDataRate=receiveDataRate, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, hTTPSPortNumber=hTTPSPortNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dataPortPauseFrames=dataPortPauseFrames, protectionAvailabilityStatus=protectionAvailabilityStatus, wirelessLinkAvailability=wirelessLinkAvailability)
