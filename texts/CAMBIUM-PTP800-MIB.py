...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, syslogState=syslogState, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, iPv4Address=iPv4Address, remoteMACAddress=remoteMACAddress, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rFUStatus=rFUStatus, transmitPower=transmitPower, rFULockoutAlarm=rFULockoutAlarm, rFUTxPowerAlarm=rFUTxPowerAlarm, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, radioLicenseMinCodeRate=radioLicenseMinCodeRate, hTTPSPortNumber=hTTPSPortNumber, licence=licence, sNTPServerTableNumber=sNTPServerTableNumber, fiberY=fiberY, remotePrimaryInternetAddress=remotePrimaryInternetAddress, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, iPv6PrefixLength=iPv6PrefixLength, tFTPServerPortNumber=tFTPServerPortNumber, syslogStateTrap=syslogStateTrap, aTPCEnable=aTPCEnable, encryptionAlgorithm=encryptionAlgorithm, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ptmp=ptmp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, vLANManagementVID=vLANManagementVID, remoteSecondaryMACAddress=remoteSecondaryMACAddress, syslogClient=syslogClient, receivePower=receivePower, transmitCapacityLimitDetail=transmitCapacityLimitDetail, radioLicenseMaxEIRP=radioLicenseMaxEIRP, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, primaryRecovery=primaryRecovery, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, configuration=configuration, ethernetPriorityTable=ethernetPriorityTable, transmitCapacityLimit=transmitCapacityLimit, sNMPTrapVersion=sNMPTrapVersion, linkName=linkName, remotePrimaryIPAddress=remotePrimaryIPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkNameMismatch=linkNameMismatch, dataPortStatusTrap=dataPortStatusTrap, longitude=longitude, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, daylightSaving=daylightSaving, primaryRecoveryPeriod=primaryRecoveryPeriod, sNTPServerRetries=sNTPServerRetries, diverseRfFeederLoss=diverseRfFeederLoss, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dSCPManagementPriority=dSCPManagementPriority, syslogClientTrap=syslogClientTrap, vLANManagementVIDValidation=vLANManagementVIDValidation, syslogControl=syslogControl, userTableNumber=userTableNumber, radioLicenseTxFreq=radioLicenseTxFreq, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, sntp=sntp, rFUVersionBank2=rFUVersionBank2, radioLicenseMaxModulation=radioLicenseMaxModulation, protectionStatus=protectionStatus, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, remoteInternetAddress=remoteInternetAddress, userEnabled=userEnabled, sNTPServerTable=sNTPServerTable, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, protectionAvailabilityStatus=protectionAvailabilityStatus, userTable=userTable, sNMPTrapTableNumber=sNMPTrapTableNumber, managementPortAutoNegotiation=managementPortAutoNegotiation, remoteSecondaryIPAddress=remoteSecondaryIPAddress, protectionSwitchCause=protectionSwitchCause, ethernet=ethernet, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, endId=endId, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, aggregateDataRate=aggregateDataRate, receiveCodeRate=receiveCodeRate, phyControl=phyControl, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, rFUStatusTrap=rFUStatusTrap, dataPortFiberStatus=dataPortFiberStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, managementCommittedInformationRate=managementCommittedInformationRate, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ptpTrapPrefix=ptpTrapPrefix, rFUTxPowerMax=rFUTxPowerMax, transmitDataRate=transmitDataRate, minModulation=minModulation, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, hTTPPortNumber=hTTPPortNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, sNTPServerTableEntry=sNTPServerTableEntry, versions=versions, secureModeAlarm=secureModeAlarm, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rFUTxFreqMin=rFUTxFreqMin, rFUBranchingConfiguration=rFUBranchingConfiguration, managementPortStatus=managementPortStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, remoteIPAddress=remoteIPAddress, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, protectionStats=protectionStats, rFUFreqSpacing=rFUFreqSpacing, rFURfBand=rFURfBand, smtp=smtp, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, neighborIPAddress=neighborIPAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPCommunityString=sNMPCommunityString, gatewayIPAddress=gatewayIPAddress, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapInternetAddress=sNMPTrapInternetAddress, transmitCapacity=transmitCapacity, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, faultProtectionSwitching=faultProtectionSwitching, dataPortStatus=dataPortStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rFURpsAlarm=rFURpsAlarm, rFUCableAlarm=rFUCableAlarm, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, protectionInterfaceStatus=protectionInterfaceStatus, softwareVersion=softwareVersion, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, l2CPPriorityTable=l2CPPriorityTable, rFUPowerAlarm=rFUPowerAlarm, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rFUTransceiverLocation=rFUTransceiverLocation, alarms=alarms, ethernetPriorityTableIndex=ethernetPriorityTableIndex, bridge=bridge, vectorError=vectorError, encryptionEnabledMismatch=encryptionEnabledMismatch, activeWirelessLinkAvailability=activeWirelessLinkAvailability, bootVersion=bootVersion, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, alignmentMode=alignmentMode, sNMPTrapIPAddress=sNMPTrapIPAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, unitOutOfCalibration=unitOutOfCalibration, altitude=altitude, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerResponse=sNTPServerResponse, rFUTxPowerMin=rFUTxPowerMin, sNTPServerTableIndex=sNTPServerTableIndex, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, userName=userName, sNTPServerPortNumber=sNTPServerPortNumber, radioLicenseCodeRate=radioLicenseCodeRate, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, activeAvailableTime=activeAvailableTime, rFUSerial=rFUSerial, dataPortConfigurationMismatch=dataPortConfigurationMismatch, iPv6GatewayAddress=iPv6GatewayAddress, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, neighborMACAddress=neighborMACAddress, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, managementPortStatusTrap=managementPortStatusTrap, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, snmpControl=snmpControl, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, dataPortPauseFrames=dataPortPauseFrames, dataPortDisabledWarning=dataPortDisabledWarning, radioLicenseModulation=radioLicenseModulation, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, radioLicenseBandwidth=radioLicenseBandwidth, activeUnit=activeUnit, sNTPServerIPAddress=sNTPServerIPAddress, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, timeZone=timeZone, rFUActiveFirmwareBank=rFUActiveFirmwareBank, neighborInternetAddressType=neighborInternetAddressType, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, phyStatus=phyStatus, systemClock=systemClock, protectionConfig=protectionConfig, requestedProtectionState=requestedProtectionState, rFURFSwitchAlarm=rFURFSwitchAlarm, hardwareVersion=hardwareVersion, rFUTxBandAboveRx=rFUTxBandAboveRx, radioLicense=radioLicense, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rFURxFreqMin=rFURxFreqMin, sMTPServerPortNumber=sMTPServerPortNumber, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, minCodeRate=minCodeRate, sMTPServerIPAddress=sMTPServerIPAddress, rxDiversityVid=rxDiversityVid, rFUPlatformCompatibility=rFUPlatformCompatibility, syslogLocalWrappedTrap=syslogLocalWrappedTrap, latitude=latitude, numberOfAntennas=numberOfAntennas, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rFUConnectedPlatform=rFUConnectedPlatform, protectionState=protectionState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rFUVersionBank1=rFUVersionBank1, ptp=ptp, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, iFCableLength=iFCableLength, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rFUPowerButtonPressed=rFUPowerButtonPressed, enableTransmission=enableTransmission, rxDiversityVlanTpid=rxDiversityVlanTpid, managementPortWirelessDownAlert=managementPortWirelessDownAlert, alignmentModeTrap=alignmentModeTrap, iPVersion=iPVersion, sNTPSync=sNTPSync, userPassword=userPassword, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, linkLoss=linkLoss, receiveDataRate=receiveDataRate, vLANManagementPriority=vLANManagementPriority, sNTPPrimaryServer=sNTPPrimaryServer, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapTable=sNMPTrapTable, maxModulation=maxModulation, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, radioLicenseRegion=radioLicenseRegion, rFUTxMuteStatus=rFUTxMuteStatus, managementPortForcedConfiguration=managementPortForcedConfiguration)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerIPAddress=tFTPServerIPAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPLastSync=sNTPLastSync, aAAControl=aAAControl, managementPortConfigurationMismatch=managementPortConfigurationMismatch, ptpTraps=ptpTraps, radioLicenseBand=radioLicenseBand, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rFURxFreqMax=rFURxFreqMax, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetFiberSupport=ethernetFiberSupport, transmitterStatus=transmitterStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, maxCodeRate=maxCodeRate, systemReset=systemReset, sNTPServerInternetAddressType=sNTPServerInternetAddressType, siteName=siteName, protection=protection, encryption=encryption, neighborInternetAddress=neighborInternetAddress, secondarySoftwareVersion=secondarySoftwareVersion, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, transmitModulation=transmitModulation, rFFeederLoss=rFFeederLoss, sMTPServerInternetAddress=sMTPServerInternetAddress, transmitCodeRate=transmitCodeRate, sMTPServerInternetAddressType=sMTPServerInternetAddressType, protectionStateTrap=protectionStateTrap, iPv6Address=iPv6Address, antennaGain=antennaGain, management=management, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFUType=rFUType, userRole=userRole, qOSPriorityScheme=qOSPriorityScheme, remotePrimaryMACAddress=remotePrimaryMACAddress, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, securityLevel=securityLevel, sNMPPortNumber=sNMPPortNumber, rFUTxFreqMax=rFUTxFreqMax, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, subnetMask=subnetMask, diverseAntennaGain=diverseAntennaGain, managementPortDisabledWarning=managementPortDisabledWarning, sNTPServerInternetAddress=sNTPServerInternetAddress, wirelessLinkStatus=wirelessLinkStatus, sNTPServerTimeout=sNTPServerTimeout, receiveModulation=receiveModulation, productVariant=productVariant, ptp800=ptp800, maximumTransmitPower=maximumTransmitPower, rfu=rfu, userTableEntry=userTableEntry, rFUProtectionCompatibility=rFUProtectionCompatibility, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, radioLicenseRxFreq=radioLicenseRxFreq, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPState=sNTPState, linkNameMismatchTrap=linkNameMismatchTrap, sNMPEnabledTraps=sNMPEnabledTraps, productName=productName, localPacketFiltering=localPacketFiltering, l2CPPriorityTableNumber=l2CPPriorityTableNumber, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, radioLicenseIdentifier=radioLicenseIdentifier, rxDiversityDataPortStatus=rxDiversityDataPortStatus, radioLicenseMinModulation=radioLicenseMinModulation, supplementary=supplementary, sNTPPollInterval=sNTPPollInterval, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, userTableIndex=userTableIndex, sMTPEmailAlert=sMTPEmailAlert, reset=reset, telnetPortNumber=telnetPortNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, primarySecondaryMode=primarySecondaryMode, cambium=cambium, remoteInternetAddressType=remoteInternetAddressType, managementMode=managementMode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, protectionConfigurationStatus=protectionConfigurationStatus, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, wirelessLinkStatusTrap=wirelessLinkStatusTrap, wirelessLinkAvailability=wirelessLinkAvailability, pubStats=pubStats)
