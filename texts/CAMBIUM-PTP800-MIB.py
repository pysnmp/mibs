...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", encryption=encryption, activeWirelessLinkAvailability=activeWirelessLinkAvailability, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPPortNumber=sNMPPortNumber, dataPortPauseFrames=dataPortPauseFrames, protectionAvailabilityStatus=protectionAvailabilityStatus, remoteInternetAddressType=remoteInternetAddressType, useVLANForManagementInterfaces=useVLANForManagementInterfaces, numberOfAntennas=numberOfAntennas, sNMPTrapInternetAddress=sNMPTrapInternetAddress, softwareVersion=softwareVersion, radioLicenseMaxModulation=radioLicenseMaxModulation, bridge=bridge, rFUStatusTrap=rFUStatusTrap, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, ethernet=ethernet, antennaGain=antennaGain, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, maxCodeRate=maxCodeRate, snmpControl=snmpControl, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogState=syslogState, protectionStateTrap=protectionStateTrap, sNTPLastSync=sNTPLastSync, iPVersion=iPVersion, radioLicenseMaxEIRP=radioLicenseMaxEIRP, remotePrimaryInternetAddress=remotePrimaryInternetAddress, endId=endId, userRole=userRole, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rFUTxBandAboveRx=rFUTxBandAboveRx, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, radioLicenseIdentifier=radioLicenseIdentifier, sNTPPrimaryServer=sNTPPrimaryServer, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, sNTPSync=sNTPSync, sNTPServerRetries=sNTPServerRetries, longitude=longitude, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, sNTPServerTimeout=sNTPServerTimeout, neighborInternetAddress=neighborInternetAddress, sNTPServerPortNumber=sNTPServerPortNumber, sNTPServerTable=sNTPServerTable, alignmentMode=alignmentMode, aAAControl=aAAControl, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFUPlatformCompatibility=rFUPlatformCompatibility, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dSCPManagementPriority=dSCPManagementPriority, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, syslogLocalWrappedTrap=syslogLocalWrappedTrap, cambium=cambium, enabledDiagnosticAlarms=enabledDiagnosticAlarms, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, managementPortAutoNegotiation=managementPortAutoNegotiation, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, iPv4Address=iPv4Address, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, managementPortConfigurationMismatch=managementPortConfigurationMismatch, ptpTrapPrefix=ptpTrapPrefix, rFUTransceiverLocation=rFUTransceiverLocation, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetPriorityTable=ethernetPriorityTable, telnetPortNumber=telnetPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPEnabledTraps=sNMPEnabledTraps, transmitCapacity=transmitCapacity, linkNameMismatch=linkNameMismatch, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, iPv6GatewayAddress=iPv6GatewayAddress, protection=protection, sNTPServerIPAddress=sNTPServerIPAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, diverseAntennaGain=diverseAntennaGain, tFTPServerInternetAddressType=tFTPServerInternetAddressType, timeZone=timeZone, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, syslogClientTrap=syslogClientTrap, remotePrimaryIPAddress=remotePrimaryIPAddress, protectionState=protectionState, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, iPDSCPPriorityTable=iPDSCPPriorityTable, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, minModulation=minModulation, sntp=sntp, productVariant=productVariant, radioLicense=radioLicense, rFUTxFreqMax=rFUTxFreqMax, hTTPSPortNumber=hTTPSPortNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dataPortStatusTrap=dataPortStatusTrap, aggregateDataRate=aggregateDataRate, sNMPTrapVersion=sNMPTrapVersion, neighborIPAddress=neighborIPAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, minCodeRate=minCodeRate, transmitterStatus=transmitterStatus, userPassword=userPassword, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, managementPortDisabledWarning=managementPortDisabledWarning, altitude=altitude, receiveDataRate=receiveDataRate, rFURxFreqMax=rFURxFreqMax, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkStatusTrap=wirelessLinkStatusTrap, sNTPSyncTrap=sNTPSyncTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sMTPEmailAlert=sMTPEmailAlert, rfu=rfu, linkNameMismatchTrap=linkNameMismatchTrap, linkName=linkName, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rFFeederLoss=rFFeederLoss, sMTPServerPortNumber=sMTPServerPortNumber, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, wirelessLinkStatus=wirelessLinkStatus, remoteIPAddress=remoteIPAddress, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementPortForcedConfiguration=managementPortForcedConfiguration, gatewayIPAddress=gatewayIPAddress, secureModeAlarm=secureModeAlarm, protectionStats=protectionStats, versions=versions, secureModeAlarmTrap=secureModeAlarmTrap, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, radioLicenseMinModulation=radioLicenseMinModulation, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, transmitCapacityLimitDetail=transmitCapacityLimitDetail, ethernetFiberSupport=ethernetFiberSupport, sMTPServerInternetAddress=sMTPServerInternetAddress, primaryRecovery=primaryRecovery, phyStatus=phyStatus, enableTransmission=enableTransmission, remotePrimarySecondaryMode=remotePrimarySecondaryMode, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, sNTPServerInternetAddress=sNTPServerInternetAddress, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, radioLicenseCodeRate=radioLicenseCodeRate, wirelessLinkAvailability=wirelessLinkAvailability, userTable=userTable, neighborMACAddress=neighborMACAddress, sNTPServerResponse=sNTPServerResponse, protectionConfig=protectionConfig, radioLicenseModulation=radioLicenseModulation, protectionSwitchCause=protectionSwitchCause, maximumTransmitPower=maximumTransmitPower, userTableEntry=userTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFURFSwitchAlarm=rFURFSwitchAlarm, dataPortConfigurationMismatch=dataPortConfigurationMismatch, primarySecondaryMode=primarySecondaryMode, sNMPCommunityString=sNMPCommunityString, ptmp=ptmp, securityLevel=securityLevel, hardwareVersion=hardwareVersion, managementMode=managementMode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, configuration=configuration, maxModulation=maxModulation, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, reset=reset, syslogStateTrap=syslogStateTrap, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, userName=userName, receiveCodeRate=receiveCodeRate, ptp800=ptp800, rFUVersionBank1=rFUVersionBank1, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rFUType=rFUType, vectorError=vectorError, rxDiversityVid=rxDiversityVid, vLANManagementVIDValidation=vLANManagementVIDValidation, licence=licence, rFUBranchingConfiguration=rFUBranchingConfiguration, rFUPowerAlarm=rFUPowerAlarm, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, l2CPPriorityTable=l2CPPriorityTable, transmitDataRate=transmitDataRate, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, radioLicenseMinCodeRate=radioLicenseMinCodeRate, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, latitude=latitude, sNTPServerInternetAddressType=sNTPServerInternetAddressType, vLANManagementPriority=vLANManagementPriority, radioLicenseRegion=radioLicenseRegion, neighborInternetAddressType=neighborInternetAddressType, fiberY=fiberY, pubStats=pubStats, linkLoss=linkLoss, receivePower=receivePower, bootVersion=bootVersion, productName=productName, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFUProtectionCompatibility=rFUProtectionCompatibility, vLANManagementVID=vLANManagementVID, systemReset=systemReset, sNTPServerTableNumber=sNTPServerTableNumber, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, ptpTraps=ptpTraps, radioLicenseBand=radioLicenseBand, rFUTxPowerMin=rFUTxPowerMin, sNMPTrapPortNumber=sNMPTrapPortNumber, iPv6Address=iPv6Address, smtp=smtp, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, subnetMask=subnetMask, radioLicenseRxFreq=radioLicenseRxFreq, rFUVersionBank2=rFUVersionBank2, syslogClient=syslogClient, daylightSaving=daylightSaving, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, requestedProtectionState=requestedProtectionState, transmitPower=transmitPower, phyControl=phyControl, rFUPowerButtonPressed=rFUPowerButtonPressed, userTableNumber=userTableNumber, userEnabled=userEnabled, dataPortStatus=dataPortStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, managementPortStatus=managementPortStatus, transmitCapacityLimit=transmitCapacityLimit, radioLicenseBandwidth=radioLicenseBandwidth, rFUTxFreqMin=rFUTxFreqMin, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remotePrimaryMACAddress=remotePrimaryMACAddress, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", activeUnit=activeUnit, rFULockoutAlarm=rFULockoutAlarm, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, managementPortWirelessDownAlert=managementPortWirelessDownAlert, protectionConfigurationStatus=protectionConfigurationStatus, rFURxFreqMin=rFURxFreqMin, rFUTxPowerAlarm=rFUTxPowerAlarm, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPPollInterval=sNTPPollInterval, unitOutOfCalibration=unitOutOfCalibration, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, sNMPTrapTableEntry=sNMPTrapTableEntry, qOSPriorityScheme=qOSPriorityScheme, transmitModulation=transmitModulation, transmitCodeRate=transmitCodeRate, sNTPServerTableIndex=sNTPServerTableIndex, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, ptp=ptp, tFTPServerIPAddress=tFTPServerIPAddress, systemClock=systemClock, aTPCEnable=aTPCEnable, secondarySoftwareVersion=secondarySoftwareVersion, rFUSerial=rFUSerial, syslogControl=syslogControl, managementCommittedInformationRate=managementCommittedInformationRate, hTTPPortNumber=hTTPPortNumber, alignmentModeTrap=alignmentModeTrap, faultProtectionSwitching=faultProtectionSwitching, mPLSTCPriorityTable=mPLSTCPriorityTable, diverseRfFeederLoss=diverseRfFeederLoss, dataPortDisabledWarning=dataPortDisabledWarning, remoteMACAddress=remoteMACAddress, rFURfBand=rFURfBand, siteName=siteName, activeAvailableTime=activeAvailableTime, encryptionAlgorithm=encryptionAlgorithm, iFCableLength=iFCableLength, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapIPAddress=sNMPTrapIPAddress, rFUTxMuteStatus=rFUTxMuteStatus, management=management, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, receiveModulation=receiveModulation, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, iPv6PrefixLength=iPv6PrefixLength, userTableIndex=userTableIndex, dataPortFiberStatus=dataPortFiberStatus, rFUConnectedPlatform=rFUConnectedPlatform, telnetAccessEnabled=telnetAccessEnabled, hTTPSAccessEnabled=hTTPSAccessEnabled, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, rFUTxPowerMax=rFUTxPowerMax, supplementary=supplementary, alarms=alarms, rFURpsAlarm=rFURpsAlarm, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, managementPortStatusTrap=managementPortStatusTrap, remoteSecondaryIPAddress=remoteSecondaryIPAddress, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sNTPServerTableEntry=sNTPServerTableEntry, rFUActiveFirmwareBank=rFUActiveFirmwareBank, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, primaryRecoveryPeriod=primaryRecoveryPeriod, radioLicenseTxFreq=radioLicenseTxFreq, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, encryptionEnabledMismatch=encryptionEnabledMismatch, remoteInternetAddress=remoteInternetAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sMTPEnabledMessages=sMTPEnabledMessages, rxDiversityVlanTpid=rxDiversityVlanTpid, sNTPState=sNTPState, rFUFreqSpacing=rFUFreqSpacing, localPacketFiltering=localPacketFiltering, rFUCableAlarm=rFUCableAlarm, hTTPAccessEnabled=hTTPAccessEnabled, protectionStatus=protectionStatus, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, protectionInterfaceStatus=protectionInterfaceStatus, sNMPTrapTable=sNMPTrapTable, rFUStatus=rFUStatus)
