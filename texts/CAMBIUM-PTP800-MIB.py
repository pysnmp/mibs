...
TimeTicks, Counter32, enterprises, ObjectIdentity, Counter64, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, ModuleIdentity, Unsigned32, MibIdentifier, NotificationType, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "enterprises", "ObjectIdentity", "Counter64", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "ModuleIdentity", "Unsigned32", "MibIdentifier", "NotificationType", "IpAddress", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", l2CPPriorityTable=l2CPPriorityTable, encryption=encryption, rFURFSwitchAlarm=rFURFSwitchAlarm, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, transmitDataRate=transmitDataRate, alarms=alarms, radioLicenseBandwidth=radioLicenseBandwidth, transmitCapacityLimit=transmitCapacityLimit, sNMPTrapTableEntry=sNMPTrapTableEntry, rFUPlatformCompatibility=rFUPlatformCompatibility, sNTPSync=sNTPSync, encryptionAlgorithm=encryptionAlgorithm, managementPortStatus=managementPortStatus, securityLevel=securityLevel, sNMPEnabledTraps=sNMPEnabledTraps, userTableNumber=userTableNumber, latitude=latitude, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hardwareVersion=hardwareVersion, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, remotePrimaryInternetAddress=remotePrimaryInternetAddress, userRole=userRole, protectionSwitchCause=protectionSwitchCause, tFTPServerPortNumber=tFTPServerPortNumber, ptmp=ptmp, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPv6PrefixLength=iPv6PrefixLength, managementPortForcedConfiguration=managementPortForcedConfiguration, radioLicenseMaxModulation=radioLicenseMaxModulation, ethernet=ethernet, radioLicenseCodeRate=radioLicenseCodeRate, rFUBranchingConfiguration=rFUBranchingConfiguration, sNMPTrapVersion=sNMPTrapVersion, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ptp=ptp, sNTPSyncTrap=sNTPSyncTrap, radioLicenseModulation=radioLicenseModulation, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rFUStatus=rFUStatus, faultProtectionSwitching=faultProtectionSwitching, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, receiveCodeRate=receiveCodeRate, rFUTxMuteStatus=rFUTxMuteStatus, neighborInternetAddress=neighborInternetAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, transmitCapacity=transmitCapacity, rFUVersionBank1=rFUVersionBank1, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, remotePrimarySecondaryMode=remotePrimarySecondaryMode, protectionStats=protectionStats, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rFURfBand=rFURfBand, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, fiberY=fiberY, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, radioLicenseRxFreq=radioLicenseRxFreq, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, transmitterStatus=transmitterStatus, transmitCapacityLimitDetail=transmitCapacityLimitDetail, aAAControl=aAAControl, mPLSTCPriorityTable=mPLSTCPriorityTable, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, numberOfAntennas=numberOfAntennas, sNTPServerTimeout=sNTPServerTimeout, sMTPEmailAlert=sMTPEmailAlert, rFUProtectionCompatibility=rFUProtectionCompatibility, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, transmitModulation=transmitModulation, radioLicenseTxFreq=radioLicenseTxFreq, sMTPEnabledMessages=sMTPEnabledMessages, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, alignmentMode=alignmentMode, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerTableEntry=sNTPServerTableEntry, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, licence=licence, longitude=longitude, iPv6Address=iPv6Address, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sntp=sntp, sMTPServerIPAddress=sMTPServerIPAddress, localPacketFiltering=localPacketFiltering, managementPortDisabledWarning=managementPortDisabledWarning, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkStatusTrap=wirelessLinkStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ptp800=ptp800, secureModeAlarm=secureModeAlarm, hTTPAccessEnabled=hTTPAccessEnabled, rFUSerial=rFUSerial, userTable=userTable, sNMPTrapIPAddress=sNMPTrapIPAddress, radioLicenseMaxEIRP=radioLicenseMaxEIRP, secondarySoftwareVersion=secondarySoftwareVersion, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, sNTPPrimaryServer=sNTPPrimaryServer, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogStateTrap=syslogStateTrap, radioLicenseMinCodeRate=radioLicenseMinCodeRate, telnetAccessEnabled=telnetAccessEnabled, linkNameMismatch=linkNameMismatch, rFURxFreqMax=rFURxFreqMax, protectionConfigurationStatus=protectionConfigurationStatus, neighborInternetAddressType=neighborInternetAddressType, primarySecondaryMode=primarySecondaryMode, syslogClientTrap=syslogClientTrap, snmpControl=snmpControl, softwareVersion=softwareVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, vectorError=vectorError, rFUTxPowerMin=rFUTxPowerMin, protectionStatus=protectionStatus, protectionConfig=protectionConfig, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, receiveModulation=receiveModulation, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, subnetMask=subnetMask, primaryRecovery=primaryRecovery, minModulation=minModulation, aggregateDataRate=aggregateDataRate, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, syslogControl=syslogControl, rFUType=rFUType, remoteSecondaryMACAddress=remoteSecondaryMACAddress, productName=productName, dataPortFiberStatus=dataPortFiberStatus, systemReset=systemReset, sNMPTrapPortNumber=sNMPTrapPortNumber, radioLicenseIdentifier=radioLicenseIdentifier, enableTransmission=enableTransmission, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, qOSPriorityScheme=qOSPriorityScheme, gatewayIPAddress=gatewayIPAddress, hTTPPortNumber=hTTPPortNumber, linkNameMismatchTrap=linkNameMismatchTrap, userPassword=userPassword, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rFUPowerButtonPressed=rFUPowerButtonPressed, endId=endId, sNTPPollInterval=sNTPPollInterval, secureModeAlarmTrap=secureModeAlarmTrap, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, remoteSecondaryIPAddress=remoteSecondaryIPAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receivePower=receivePower, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, telnetPortNumber=telnetPortNumber, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rfu=rfu, rFUVersionBank2=rFUVersionBank2, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFUTransceiverLocation=rFUTransceiverLocation, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, remotePrimaryIPAddress=remotePrimaryIPAddress, maxModulation=maxModulation, sNTPServerTableNumber=sNTPServerTableNumber, syslogState=syslogState, minCodeRate=minCodeRate, ptpTrapPrefix=ptpTrapPrefix, unitOutOfCalibration=unitOutOfCalibration, smtp=smtp, rFUCableAlarm=rFUCableAlarm, ethernetPriorityTable=ethernetPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernetFiberSupport=ethernetFiberSupport, wirelessLinkAvailability=wirelessLinkAvailability, rFUTxPowerMax=rFUTxPowerMax, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, diverseAntennaGain=diverseAntennaGain, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, sNTPServerTable=sNTPServerTable, timeZone=timeZone, diverseRfFeederLoss=diverseRfFeederLoss, siteName=siteName, rFURxFreqMin=rFURxFreqMin, managementPortConfigurationMismatch=managementPortConfigurationMismatch, userEnabled=userEnabled, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, bootVersion=bootVersion, systemClock=systemClock, sNMPCommunityString=sNMPCommunityString, antennaGain=antennaGain, rFUTxPowerAlarm=rFUTxPowerAlarm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPState=sNTPState, supplementary=supplementary, pubStats=pubStats, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerRetries=sNTPServerRetries, activeUnit=activeUnit, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, sNTPServerTableIndex=sNTPServerTableIndex, rFFeederLoss=rFFeederLoss, maxCodeRate=maxCodeRate, rFUTxFreqMin=rFUTxFreqMin, management=management, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, userTableEntry=userTableEntry, requestedProtectionState=requestedProtectionState, ptpTraps=ptpTraps, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, radioLicenseRegion=radioLicenseRegion, sNTPLastSync=sNTPLastSync, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, neighborIPAddress=neighborIPAddress, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, neighborMACAddress=neighborMACAddress, remoteInternetAddressType=remoteInternetAddressType, encryptionEnabledMismatch=encryptionEnabledMismatch, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, remoteIPAddress=remoteIPAddress, versions=versions, rxDiversityDataPortStatus=rxDiversityDataPortStatus, dataPortStatus=dataPortStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, productVariant=productVariant, dataPortStatusTrap=dataPortStatusTrap, protectionStateTrap=protectionStateTrap, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, protection=protection, rFULockoutAlarm=rFULockoutAlarm)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", protectionAvailabilityStatus=protectionAvailabilityStatus, syslogClient=syslogClient, protectionState=protectionState, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, wirelessLinkStatus=wirelessLinkStatus, activeWirelessLinkAvailability=activeWirelessLinkAvailability, remoteMACAddress=remoteMACAddress, userTableIndex=userTableIndex, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNMPTrapTable=sNMPTrapTable, altitude=altitude, phyControl=phyControl, linkLoss=linkLoss, sMTPServerPortNumber=sMTPServerPortNumber, phyStatus=phyStatus, userName=userName, radioLicenseBand=radioLicenseBand, dataPortPauseFrames=dataPortPauseFrames, remotePrimaryMACAddress=remotePrimaryMACAddress, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPPortNumber=sNMPPortNumber, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rFUPowerAlarm=rFUPowerAlarm, remoteInternetAddress=remoteInternetAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, enabledDiagnosticAlarms=enabledDiagnosticAlarms, aTPCEnable=aTPCEnable, radioLicenseMinModulation=radioLicenseMinModulation, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, dSCPManagementPriority=dSCPManagementPriority, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, alignmentModeTrap=alignmentModeTrap, rFUTxBandAboveRx=rFUTxBandAboveRx, vLANManagementVID=vLANManagementVID, bridge=bridge, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, cambium=cambium, rxDiversityVlanTpid=rxDiversityVlanTpid, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rFUFreqSpacing=rFUFreqSpacing, rxDiversityVid=rxDiversityVid, sNTPServerIPAddress=sNTPServerIPAddress, radioLicense=radioLicense, iFCableLength=iFCableLength, rFURpsAlarm=rFURpsAlarm, receiveDataRate=receiveDataRate, linkName=linkName, protectionInterfaceStatus=protectionInterfaceStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, reset=reset, managementPortAutoNegotiation=managementPortAutoNegotiation, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, maximumTransmitPower=maximumTransmitPower, primaryRecoveryPeriod=primaryRecoveryPeriod, sNTPServerResponse=sNTPServerResponse, iPVersion=iPVersion, vLANManagementPriority=vLANManagementPriority, sNTPServerPortNumber=sNTPServerPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, iPv4Address=iPv4Address, sNMPTrapTableIndex=sNMPTrapTableIndex, activeAvailableTime=activeAvailableTime, managementPortWirelessDownAlert=managementPortWirelessDownAlert, daylightSaving=daylightSaving, dataPortDisabledWarning=dataPortDisabledWarning, managementMode=managementMode, configuration=configuration, transmitPower=transmitPower, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, rFUStatusTrap=rFUStatusTrap, rFUTxFreqMax=rFUTxFreqMax, managementCommittedInformationRate=managementCommittedInformationRate, vLANManagementVIDValidation=vLANManagementVIDValidation, hTTPSPortNumber=hTTPSPortNumber, iPv6GatewayAddress=iPv6GatewayAddress, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, managementPortStatusTrap=managementPortStatusTrap, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rFUConnectedPlatform=rFUConnectedPlatform, transmitCodeRate=transmitCodeRate, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap)
