...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", hardwareVersion=hardwareVersion, rFUSerial=rFUSerial, secondarySoftwareVersion=secondarySoftwareVersion, latitude=latitude, remoteSecondaryMACAddress=remoteSecondaryMACAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, siteName=siteName, wirelessLinkAvailability=wirelessLinkAvailability, daylightSaving=daylightSaving, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPServerTable=sNTPServerTable, rFUTxBandAboveRx=rFUTxBandAboveRx, radioLicenseRegion=radioLicenseRegion, primaryRecovery=primaryRecovery, rFUBranchingConfiguration=rFUBranchingConfiguration, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortStatusTrap=dataPortStatusTrap, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, rFUTxFreqMin=rFUTxFreqMin, dataPortFiberStatus=dataPortFiberStatus, encryptionAlgorithm=encryptionAlgorithm, vLANManagementPriority=vLANManagementPriority, encryption=encryption, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFURxFreqMax=rFURxFreqMax, sNTPPollInterval=sNTPPollInterval, dataPortPauseFrames=dataPortPauseFrames, productVariant=productVariant, userTable=userTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, neighborMACAddress=neighborMACAddress, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rFURxFreqMin=rFURxFreqMin, systemClock=systemClock, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, iPDSCPPriorityTable=iPDSCPPriorityTable, secureModeAlarmTrap=secureModeAlarmTrap, rFUConnectedPlatform=rFUConnectedPlatform, iPv6Address=iPv6Address, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rFUActiveFirmwareBank=rFUActiveFirmwareBank, managementPortStatusTrap=managementPortStatusTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, userName=userName, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, radioLicense=radioLicense, ethernetPriorityTableIndex=ethernetPriorityTableIndex, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernet=ethernet, l2CPPriorityTable=l2CPPriorityTable, transmitCapacityLimit=transmitCapacityLimit, managementPortConfigurationMismatch=managementPortConfigurationMismatch, pubStats=pubStats, telnetPortNumber=telnetPortNumber, linkLoss=linkLoss, ptp=ptp, remoteInternetAddressType=remoteInternetAddressType, radioLicenseMaxModulation=radioLicenseMaxModulation, dSCPManagementPriority=dSCPManagementPriority, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, protectionConfig=protectionConfig, protectionStats=protectionStats, linkNameMismatchTrap=linkNameMismatchTrap, hTTPAccessEnabled=hTTPAccessEnabled, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, userRole=userRole, qOSPriorityScheme=qOSPriorityScheme, rxDiversityVid=rxDiversityVid, tFTPServerInternetAddressType=tFTPServerInternetAddressType, numberOfAntennas=numberOfAntennas, supplementary=supplementary, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, vLANManagementVID=vLANManagementVID, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTable=sNMPTrapTable, iPv4Address=iPv4Address, sNTPSync=sNTPSync, vLANManagementVIDValidation=vLANManagementVIDValidation, faultProtectionSwitching=faultProtectionSwitching, telnetAccessEnabled=telnetAccessEnabled, rFUTxFreqMax=rFUTxFreqMax, tFTPServerIPAddress=tFTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, sNTPSyncTrap=sNTPSyncTrap, managementPortAutoNegotiation=managementPortAutoNegotiation, iPv6PrefixLength=iPv6PrefixLength, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkStatusTrap=wirelessLinkStatusTrap, syslogStateTrap=syslogStateTrap, receiveCodeRate=receiveCodeRate, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, protection=protection, ptmp=ptmp, maximumTransmitPower=maximumTransmitPower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, managementPortForcedConfiguration=managementPortForcedConfiguration, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rFURfBand=rFURfBand, userTableEntry=userTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, radioLicenseMinModulation=radioLicenseMinModulation, managementCommittedInformationRate=managementCommittedInformationRate, phyControl=phyControl, remoteIPAddress=remoteIPAddress, primarySecondaryMode=primarySecondaryMode, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, enableTransmission=enableTransmission, transmitDataRate=transmitDataRate, dataPortStatus=dataPortStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, timeZone=timeZone, protectionAvailabilityStatus=protectionAvailabilityStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveModulation=receiveModulation, syslogLocalWrappedTrap=syslogLocalWrappedTrap, maxModulation=maxModulation, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, protectionStatus=protectionStatus, receiveDataRate=receiveDataRate, alignmentModeTrap=alignmentModeTrap, bridge=bridge, localPacketFiltering=localPacketFiltering, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, primaryRecoveryPeriod=primaryRecoveryPeriod, managementPortDisabledWarning=managementPortDisabledWarning, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, sMTPEmailAlert=sMTPEmailAlert, sNTPLastSync=sNTPLastSync, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFUStatusTrap=rFUStatusTrap, linkNameMismatch=linkNameMismatch, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, sNTPServerResponse=sNTPServerResponse, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, l2CPPriorityTableIndex=l2CPPriorityTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rFUFreqSpacing=rFUFreqSpacing, rFULockoutAlarm=rFULockoutAlarm, transmitModulation=transmitModulation, neighborIPAddress=neighborIPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, iPv6GatewayAddress=iPv6GatewayAddress, remotePrimaryIPAddress=remotePrimaryIPAddress, sNTPServerTableEntry=sNTPServerTableEntry, softwareVersion=softwareVersion, sNTPServerTimeout=sNTPServerTimeout, sNTPState=sNTPState, systemReset=systemReset, dataPortConfigurationMismatch=dataPortConfigurationMismatch, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapTableEntry=sNMPTrapTableEntry, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, tFTPServerPortNumber=tFTPServerPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rxDiversityVlanTpid=rxDiversityVlanTpid, remoteSecondaryIPAddress=remoteSecondaryIPAddress, userEnabled=userEnabled, iFCableLength=iFCableLength, wirelessLinkStatus=wirelessLinkStatus, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, sNTPServerTableIndex=sNTPServerTableIndex, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, sNMPTrapVersion=sNMPTrapVersion, antennaGain=antennaGain, longitude=longitude, rFUProtectionCompatibility=rFUProtectionCompatibility, ptpTraps=ptpTraps, ptpTrapPrefix=ptpTrapPrefix, snmpControl=snmpControl, transmitterStatus=transmitterStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, transmitCapacityLimitDetail=transmitCapacityLimitDetail, altitude=altitude, rFUPlatformCompatibility=rFUPlatformCompatibility, sNTPServerRetries=sNTPServerRetries, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, hTTPSPortNumber=hTTPSPortNumber, ethernetPriorityTable=ethernetPriorityTable, protectionConfigurationStatus=protectionConfigurationStatus, transmitPower=transmitPower, gatewayIPAddress=gatewayIPAddress, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFFeederLoss=rFFeederLoss, radioLicenseMaxEIRP=radioLicenseMaxEIRP, versions=versions, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, protectionState=protectionState, productName=productName, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, transmitCodeRate=transmitCodeRate, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, neighborInternetAddressType=neighborInternetAddressType, rFURFSwitchAlarm=rFURFSwitchAlarm, sNTPServerPortNumber=sNTPServerPortNumber, remotePrimaryInternetAddress=remotePrimaryInternetAddress, rFUVersionBank1=rFUVersionBank1, userTableIndex=userTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, radioLicenseBandwidth=radioLicenseBandwidth, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, radioLicenseCodeRate=radioLicenseCodeRate, bootVersion=bootVersion, userPassword=userPassword, sNTPServerTableNumber=sNTPServerTableNumber, radioLicenseIdentifier=radioLicenseIdentifier, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, radioLicenseRxFreq=radioLicenseRxFreq, transmitCapacity=transmitCapacity, radioLicenseTxFreq=radioLicenseTxFreq, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dataPortDisabledWarning=dataPortDisabledWarning, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, iPVersion=iPVersion, secureModeAlarm=secureModeAlarm, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, activeAvailableTime=activeAvailableTime, alarms=alarms, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, receivePower=receivePower, phyStatus=phyStatus, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, userTableNumber=userTableNumber, syslogControl=syslogControl, cambium=cambium, radioLicenseBand=radioLicenseBand, diverseAntennaGain=diverseAntennaGain, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, aTPCEnable=aTPCEnable, rFUTransceiverLocation=rFUTransceiverLocation, sNMPTrapIPAddress=sNMPTrapIPAddress, rFURpsAlarm=rFURpsAlarm, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUTxPowerAlarm=rFUTxPowerAlarm, radioLicenseModulation=radioLicenseModulation, reset=reset)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", syslogClientTrap=syslogClientTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, remoteMACAddress=remoteMACAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, subnetMask=subnetMask, ptp800=ptp800, rFUVersionBank2=rFUVersionBank2, rfu=rfu, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, protectionSwitchCause=protectionSwitchCause, rFUTxPowerMin=rFUTxPowerMin, neighborInternetAddress=neighborInternetAddress, aAAControl=aAAControl, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, aggregateDataRate=aggregateDataRate, rFUTxPowerMax=rFUTxPowerMax, sntp=sntp, encryptionEnabledMismatch=encryptionEnabledMismatch, sMTPServerIPAddress=sMTPServerIPAddress, licence=licence, rFUPowerButtonPressed=rFUPowerButtonPressed, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, remoteInternetAddress=remoteInternetAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, securityLevel=securityLevel, rFUTxMuteStatus=rFUTxMuteStatus, managementPortStatus=managementPortStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, managementMode=managementMode, rFUPowerAlarm=rFUPowerAlarm, sNTPServerIPAddress=sNTPServerIPAddress, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber, rFUCableAlarm=rFUCableAlarm, sMTPEnabledMessages=sMTPEnabledMessages, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, useVLANForManagementInterfaces=useVLANForManagementInterfaces, protectionInterfaceStatus=protectionInterfaceStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, hTTPPortNumber=hTTPPortNumber, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, management=management, activeWirelessLinkAvailability=activeWirelessLinkAvailability, sMTPServerPortNumber=sMTPServerPortNumber, remotePrimarySecondaryMode=remotePrimarySecondaryMode, activeUnit=activeUnit, minCodeRate=minCodeRate, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPCommunityString=sNMPCommunityString, sNMPPortNumber=sNMPPortNumber, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, diverseRfFeederLoss=diverseRfFeederLoss, protectionStateTrap=protectionStateTrap, alignmentMode=alignmentMode, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, configuration=configuration, requestedProtectionState=requestedProtectionState, maxCodeRate=maxCodeRate, fiberY=fiberY, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, linkName=linkName, vectorError=vectorError, rFUStatus=rFUStatus, remotePrimaryMACAddress=remotePrimaryMACAddress, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rFUType=rFUType, radioLicenseMinCodeRate=radioLicenseMinCodeRate, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, syslogClient=syslogClient, minModulation=minModulation, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, smtp=smtp, syslogState=syslogState, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPPrimaryServer=sNTPPrimaryServer, ethernetFiberSupport=ethernetFiberSupport, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, endId=endId)
