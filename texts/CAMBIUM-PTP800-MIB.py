...
Unsigned32, ObjectIdentity, Bits, MibIdentifier, Integer32, NotificationType, TimeTicks, Counter64, IpAddress, Gauge32, Counter32, enterprises, NotificationType, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "Bits", "MibIdentifier", "Integer32", "NotificationType", "TimeTicks", "Counter64", "IpAddress", "Gauge32", "Counter32", "enterprises", "NotificationType", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rFUPowerButtonPressed=rFUPowerButtonPressed, bridge=bridge, activeWirelessLinkAvailability=activeWirelessLinkAvailability, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, neighborInternetAddressType=neighborInternetAddressType, rfu=rfu, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sNTPServerIPAddress=sNTPServerIPAddress, remoteSecondaryMACAddress=remoteSecondaryMACAddress, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, dataPortStatusTrap=dataPortStatusTrap, protection=protection, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, remotePrimaryInternetAddress=remotePrimaryInternetAddress, dSCPManagementPriority=dSCPManagementPriority, requestedProtectionState=requestedProtectionState, neighborInternetAddress=neighborInternetAddress, rFURfBand=rFURfBand, cambium=cambium, smtp=smtp, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, hTTPPortNumber=hTTPPortNumber, remoteMACAddress=remoteMACAddress, wirelessLinkAvailability=wirelessLinkAvailability, telnetAccessEnabled=telnetAccessEnabled, remotePrimaryMACAddress=remotePrimaryMACAddress, latitude=latitude, rFURxFreqMin=rFURxFreqMin, systemClock=systemClock, productName=productName, transmitCodeRate=transmitCodeRate, configuration=configuration, gatewayIPAddress=gatewayIPAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, linkNameMismatch=linkNameMismatch, sNTPLastSync=sNTPLastSync, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, managementPortWirelessDownAlert=managementPortWirelessDownAlert, syslogControl=syslogControl, rxDiversityVid=rxDiversityVid, remoteSecondaryIPAddress=remoteSecondaryIPAddress, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, protectionConfig=protectionConfig, rFUFreqSpacing=rFUFreqSpacing, fiberY=fiberY, userPassword=userPassword, dataPortStatus=dataPortStatus, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sNTPServerTableEntry=sNTPServerTableEntry, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, endId=endId, radioLicenseRegion=radioLicenseRegion, qOSPriorityScheme=qOSPriorityScheme, numberOfAntennas=numberOfAntennas, sNTPServerInternetAddress=sNTPServerInternetAddress, sMTPEmailAlert=sMTPEmailAlert, radioLicenseMaxModulation=radioLicenseMaxModulation, rFUTxPowerMax=rFUTxPowerMax, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, softwareVersion=softwareVersion, maxModulation=maxModulation, sNTPServerTableIndex=sNTPServerTableIndex, protectionStatus=protectionStatus, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rFUTxFreqMin=rFUTxFreqMin, rFUCableAlarm=rFUCableAlarm, syslogClient=syslogClient, timeZone=timeZone, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, secureModeAlarm=secureModeAlarm, sMTPServerIPAddress=sMTPServerIPAddress, linkName=linkName, daylightSaving=daylightSaving, aAAControl=aAAControl, rFUTransceiverLocation=rFUTransceiverLocation, encryption=encryption, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, radioLicenseTxFreq=radioLicenseTxFreq, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rFUTxPowerMin=rFUTxPowerMin, aTPCEnable=aTPCEnable, sNTPServerTableNumber=sNTPServerTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetPriorityTable=ethernetPriorityTable, rFUBranchingConfiguration=rFUBranchingConfiguration, userTableIndex=userTableIndex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitCapacityLimitDetail=transmitCapacityLimitDetail, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, activeAvailableTime=activeAvailableTime, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, ptpTraps=ptpTraps, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, maxCodeRate=maxCodeRate, managementPortDisabledWarning=managementPortDisabledWarning, management=management, vLANManagementVID=vLANManagementVID, protectionAvailabilityStatus=protectionAvailabilityStatus, antennaGain=antennaGain, transmitterStatus=transmitterStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, alignmentMode=alignmentMode, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, versions=versions, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitCapacity=transmitCapacity, rFUPowerAlarm=rFUPowerAlarm, localPacketFiltering=localPacketFiltering, maximumTransmitPower=maximumTransmitPower, rFUPlatformCompatibility=rFUPlatformCompatibility, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, licence=licence, sNMPTrapTable=sNMPTrapTable, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, sNTPSync=sNTPSync, wirelessLinkStatus=wirelessLinkStatus, rFUTxMuteStatus=rFUTxMuteStatus, sNTPServerTable=sNTPServerTable, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, sNMPTrapVersion=sNMPTrapVersion, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, receiveCodeRate=receiveCodeRate, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, managementPortAutoNegotiation=managementPortAutoNegotiation, linkNameMismatchTrap=linkNameMismatchTrap, diverseRfFeederLoss=diverseRfFeederLoss, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkLoss=linkLoss, sMTPEnabledMessages=sMTPEnabledMessages, primaryRecoveryPeriod=primaryRecoveryPeriod, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, receiveModulation=receiveModulation, sNTPServerTimeout=sNTPServerTimeout, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFUConnectedPlatform=rFUConnectedPlatform, iPVersion=iPVersion, subnetMask=subnetMask, snmpControl=snmpControl, neighborIPAddress=neighborIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortDisabledWarning=dataPortDisabledWarning, useVLANForManagementInterfaces=useVLANForManagementInterfaces, secureModeAlarmTrap=secureModeAlarmTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rFUTxBandAboveRx=rFUTxBandAboveRx, radioLicenseRxFreq=radioLicenseRxFreq, protectionConfigurationStatus=protectionConfigurationStatus, rFURFSwitchAlarm=rFURFSwitchAlarm, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, protectionState=protectionState, managementCommittedInformationRate=managementCommittedInformationRate, managementMode=managementMode, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPv6PrefixLength=iPv6PrefixLength, managementPortForcedConfiguration=managementPortForcedConfiguration, transmitCapacityLimit=transmitCapacityLimit, systemReset=systemReset, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, tFTPServerInternetAddress=tFTPServerInternetAddress, ethernet=ethernet, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPServerPortNumber=tFTPServerPortNumber, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, protectionStats=protectionStats, enabledDiagnosticAlarms=enabledDiagnosticAlarms, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, radioLicenseBand=radioLicenseBand, telnetPortNumber=telnetPortNumber, sNTPState=sNTPState, userEnabled=userEnabled, iPDSCPPriorityTable=iPDSCPPriorityTable, sMTPServerPortNumber=sMTPServerPortNumber, hardwareVersion=hardwareVersion, remoteInternetAddress=remoteInternetAddress, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rFUTxPowerAlarm=rFUTxPowerAlarm, rFUStatusTrap=rFUStatusTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, protectionStateTrap=protectionStateTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, reset=reset, longitude=longitude, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFUStatus=rFUStatus, diverseAntennaGain=diverseAntennaGain, sNMPPortNumber=sNMPPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, transmitPower=transmitPower, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerInternetAddressType=sNTPServerInternetAddressType, neighborMACAddress=neighborMACAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPEnabledTraps=sNMPEnabledTraps, ptmp=ptmp, radioLicenseModulation=radioLicenseModulation, iPv4Address=iPv4Address, sntp=sntp, secondarySoftwareVersion=secondarySoftwareVersion, iPv6Address=iPv6Address, rFUVersionBank2=rFUVersionBank2, phyStatus=phyStatus, hTTPAccessEnabled=hTTPAccessEnabled, userTable=userTable, ethernetFiberSupport=ethernetFiberSupport, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rFFeederLoss=rFFeederLoss, aggregateDataRate=aggregateDataRate, protectionSwitchCause=protectionSwitchCause, radioLicenseMinModulation=radioLicenseMinModulation, dataPortConfigurationMismatch=dataPortConfigurationMismatch, vectorError=vectorError, iFCableLength=iFCableLength, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, syslogState=syslogState, pubStats=pubStats, minCodeRate=minCodeRate, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, receivePower=receivePower, ethernetPriorityTableIndex=ethernetPriorityTableIndex, phyControl=phyControl, sNTPServerRetries=sNTPServerRetries, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, remoteInternetAddressType=remoteInternetAddressType, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, rFURpsAlarm=rFURpsAlarm, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, remotePrimaryIPAddress=remotePrimaryIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rFURxFreqMax=rFURxFreqMax, alarms=alarms, iPv6GatewayAddress=iPv6GatewayAddress, altitude=altitude, protectionInterfaceStatus=protectionInterfaceStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, encryptionAlgorithm=encryptionAlgorithm, minModulation=minModulation, userTableEntry=userTableEntry, rxDiversityVlanTpid=rxDiversityVlanTpid, primarySecondaryMode=primarySecondaryMode, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, activeUnit=activeUnit, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFULockoutAlarm=rFULockoutAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, primaryRecovery=primaryRecovery, encryptionEnabledMismatch=encryptionEnabledMismatch, sNMPCommunityString=sNMPCommunityString, radioLicense=radioLicense, sNTPServerResponse=sNTPServerResponse, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, userName=userName, wirelessLinkStatusTrap=wirelessLinkStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveDataRate=receiveDataRate, userRole=userRole, productVariant=productVariant, dataPortFiberStatus=dataPortFiberStatus, alignmentModeTrap=alignmentModeTrap, syslogClientTrap=syslogClientTrap, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, rFUType=rFUType, l2CPPriorityTableNumber=l2CPPriorityTableNumber, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, managementPortStatusTrap=managementPortStatusTrap, remotePrimarySecondaryMode=remotePrimarySecondaryMode, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, mPLSTCPriorityTable=mPLSTCPriorityTable, transmitDataRate=transmitDataRate, radioLicenseBandwidth=radioLicenseBandwidth, syslogStateTrap=syslogStateTrap, radioLicenseIdentifier=radioLicenseIdentifier, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, siteName=siteName, hTTPSPortNumber=hTTPSPortNumber, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, supplementary=supplementary, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, securityLevel=securityLevel, rFUActiveFirmwareBank=rFUActiveFirmwareBank, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPPollInterval=sNTPPollInterval, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFUVersionBank1=rFUVersionBank1, sNTPServerPortNumber=sNTPServerPortNumber, unitOutOfCalibration=unitOutOfCalibration, managementPortStatus=managementPortStatus, rFUProtectionCompatibility=rFUProtectionCompatibility, tFTPServerIPAddress=tFTPServerIPAddress, dataPortPauseFrames=dataPortPauseFrames, transmitModulation=transmitModulation, ptpTrapPrefix=ptpTrapPrefix, enableTransmission=enableTransmission, rFUSerial=rFUSerial, ptp=ptp, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userTableNumber=userTableNumber, remoteIPAddress=remoteIPAddress, vLANManagementVIDValidation=vLANManagementVIDValidation, bootVersion=bootVersion, l2CPPriorityTableIndex=l2CPPriorityTableIndex, l2CPPriorityTable=l2CPPriorityTable, rFUTxFreqMax=rFUTxFreqMax, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, radioLicenseCodeRate=radioLicenseCodeRate, vLANManagementPriority=vLANManagementPriority, faultProtectionSwitching=faultProtectionSwitching, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, ptp800=ptp800)
