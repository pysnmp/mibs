...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, userRole=userRole, vLANManagementVIDValidation=vLANManagementVIDValidation, mPLSTCPriorityTable=mPLSTCPriorityTable, managementPortConfigurationMismatch=managementPortConfigurationMismatch, linkName=linkName, protectionStatus=protectionStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapIPAddress=sNMPTrapIPAddress, receiveModulation=receiveModulation, iPv6PrefixLength=iPv6PrefixLength, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, sNTPSync=sNTPSync, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, transmitCodeRate=transmitCodeRate, hardwareVersion=hardwareVersion, alarms=alarms, maxCodeRate=maxCodeRate, vLANManagementVID=vLANManagementVID, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, unitOutOfCalibration=unitOutOfCalibration, pubStats=pubStats, faultProtectionSwitching=faultProtectionSwitching, rFFeederLoss=rFFeederLoss, syslogClient=syslogClient, tFTPServerPortNumber=tFTPServerPortNumber, rFUVersionBank2=rFUVersionBank2, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, iPv6Address=iPv6Address, userTable=userTable, productVariant=productVariant, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, minModulation=minModulation, softwareVersion=softwareVersion, sNMPTrapTable=sNMPTrapTable, transmitPower=transmitPower, rFUProtectionCompatibility=rFUProtectionCompatibility, maxModulation=maxModulation, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, radioLicenseMinModulation=radioLicenseMinModulation, radioLicenseModulation=radioLicenseModulation, rFURxFreqMin=rFURxFreqMin, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, transmitCapacity=transmitCapacity, rFUTxFreqMax=rFUTxFreqMax, latitude=latitude, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementMode=managementMode, radioLicenseRxFreq=radioLicenseRxFreq, protectionConfigurationStatus=protectionConfigurationStatus, localPacketFiltering=localPacketFiltering, smtp=smtp, protection=protection, sNMPTrapVersion=sNMPTrapVersion, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dataPortPauseFrames=dataPortPauseFrames, radioLicenseRegion=radioLicenseRegion, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, vLANManagementPriority=vLANManagementPriority, wirelessLinkStatusTrap=wirelessLinkStatusTrap, userPassword=userPassword, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPSyncTrap=sNTPSyncTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ptpTrapPrefix=ptpTrapPrefix, sNMPEnabledTraps=sNMPEnabledTraps, l2CPPriorityTable=l2CPPriorityTable, neighborInternetAddress=neighborInternetAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, encryption=encryption, receivePower=receivePower, iFCableLength=iFCableLength, radioLicenseCodeRate=radioLicenseCodeRate, radioLicenseIdentifier=radioLicenseIdentifier, altitude=altitude, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFUFreqSpacing=rFUFreqSpacing, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, encryptionAlgorithm=encryptionAlgorithm, sNTPServerInternetAddress=sNTPServerInternetAddress, configuration=configuration, siteName=siteName, secureModeAlarm=secureModeAlarm, activeAvailableTime=activeAvailableTime, l2CPPriorityTableNumber=l2CPPriorityTableNumber, securityLevel=securityLevel, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dSCPManagementPriority=dSCPManagementPriority, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogStateTrap=syslogStateTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rFUTransceiverLocation=rFUTransceiverLocation, sMTPServerPortNumber=sMTPServerPortNumber, syslogClientTrap=syslogClientTrap, telnetAccessEnabled=telnetAccessEnabled, bootVersion=bootVersion, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, maximumTransmitPower=maximumTransmitPower, managementCommittedInformationRate=managementCommittedInformationRate, receiveDataRate=receiveDataRate, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogControl=syslogControl, rFUBranchingConfiguration=rFUBranchingConfiguration, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, rFUCableAlarm=rFUCableAlarm, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, fiberY=fiberY, radioLicenseMaxEIRP=radioLicenseMaxEIRP, neighborMACAddress=neighborMACAddress, primaryRecoveryPeriod=primaryRecoveryPeriod, alignmentMode=alignmentMode, linkLoss=linkLoss, userTableIndex=userTableIndex, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernet=ethernet, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, linkNameMismatch=linkNameMismatch, primarySecondaryMode=primarySecondaryMode, userName=userName, encryptionEnabledMismatch=encryptionEnabledMismatch, ptp800=ptp800, ethernetPriorityTable=ethernetPriorityTable, qOSPriorityScheme=qOSPriorityScheme, antennaGain=antennaGain, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, numberOfAntennas=numberOfAntennas, rFUPowerAlarm=rFUPowerAlarm, daylightSaving=daylightSaving, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, iPVersion=iPVersion, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, sMTPServerInternetAddress=sMTPServerInternetAddress, protectionAvailabilityStatus=protectionAvailabilityStatus, remoteIPAddress=remoteIPAddress, transmitterStatus=transmitterStatus, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, remoteMaximumTransmitPower=remoteMaximumTransmitPower, productName=productName, sNTPLastSync=sNTPLastSync, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, sNMPPortNumber=sNMPPortNumber, userTableNumber=userTableNumber, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, transmitCapacityLimitDetail=transmitCapacityLimitDetail, syslogState=syslogState, tFTPServerInternetAddress=tFTPServerInternetAddress, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapTableNumber=sNMPTrapTableNumber, bridge=bridge, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rFURFSwitchAlarm=rFURFSwitchAlarm, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, radioLicenseBandwidth=radioLicenseBandwidth, remotePrimaryIPAddress=remotePrimaryIPAddress, telnetPortNumber=telnetPortNumber, rFUVersionBank1=rFUVersionBank1, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteInternetAddressType=remoteInternetAddressType, sNTPServerResponse=sNTPServerResponse, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, radioLicenseMinCodeRate=radioLicenseMinCodeRate, tFTPServerIPAddress=tFTPServerIPAddress, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, longitude=longitude, dataPortStatus=dataPortStatus, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rFUTxPowerMax=rFUTxPowerMax, managementPortForcedConfiguration=managementPortForcedConfiguration, dataPortStatusTrap=dataPortStatusTrap, activeUnit=activeUnit, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, aAAControl=aAAControl, secondarySoftwareVersion=secondarySoftwareVersion, rFUType=rFUType, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, reset=reset, sNTPServerIPAddress=sNTPServerIPAddress, versions=versions, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, supplementary=supplementary, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, protectionStats=protectionStats, sNTPServerPortNumber=sNTPServerPortNumber, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, rFURxFreqMax=rFURxFreqMax, rFUTxFreqMin=rFUTxFreqMin, transmitDataRate=transmitDataRate, userEnabled=userEnabled, dataPortDisabledWarning=dataPortDisabledWarning, rFULockoutAlarm=rFULockoutAlarm, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, radioLicenseTxFreq=radioLicenseTxFreq, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNTPServerTableNumber=sNTPServerTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ptp=ptp, management=management, timeZone=timeZone, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, sNTPServerTableEntry=sNTPServerTableEntry, rFUPowerButtonPressed=rFUPowerButtonPressed, ethernetPriorityTableNumber=ethernetPriorityTableNumber, phyStatus=phyStatus, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, ptpTraps=ptpTraps, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetFiberSupport=ethernetFiberSupport, aTPCEnable=aTPCEnable, licence=licence, radioLicenseBand=radioLicenseBand, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, aggregateDataRate=aggregateDataRate, diverseAntennaGain=diverseAntennaGain, sNTPPrimaryServer=sNTPPrimaryServer, sNMPCommunityString=sNMPCommunityString, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, protectionSwitchCause=protectionSwitchCause, dataPortFiberStatus=dataPortFiberStatus, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPPollInterval=sNTPPollInterval, remoteMACAddress=remoteMACAddress, receiveCodeRate=receiveCodeRate, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, remoteInternetAddress=remoteInternetAddress, systemClock=systemClock, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, transmitCapacityLimit=transmitCapacityLimit)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", protectionStateTrap=protectionStateTrap, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, primaryRecovery=primaryRecovery, l2CPPriorityTableEntry=l2CPPriorityTableEntry, linkNameMismatchTrap=linkNameMismatchTrap, hTTPPortNumber=hTTPPortNumber, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rFUStatusTrap=rFUStatusTrap, iPv4Address=iPv4Address, rFUTxMuteStatus=rFUTxMuteStatus, secureModeAlarmTrap=secureModeAlarmTrap, endId=endId, systemReset=systemReset, neighborIPAddress=neighborIPAddress, protectionState=protectionState, rFUStatus=rFUStatus, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, minCodeRate=minCodeRate, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sNTPServerTableIndex=sNTPServerTableIndex, rFUActiveFirmwareBank=rFUActiveFirmwareBank, protectionConfig=protectionConfig, radioLicenseMaxModulation=radioLicenseMaxModulation, enableTransmission=enableTransmission, remoteSecondaryIPAddress=remoteSecondaryIPAddress, sMTPServerIPAddress=sMTPServerIPAddress, managementPortStatusTrap=managementPortStatusTrap, ptmp=ptmp, wirelessLinkStatus=wirelessLinkStatus, rFUPlatformCompatibility=rFUPlatformCompatibility, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rxDiversityVlanTpid=rxDiversityVlanTpid, rFUConnectedPlatform=rFUConnectedPlatform, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, radioLicense=radioLicense, sNTPServerTimeout=sNTPServerTimeout, requestedProtectionState=requestedProtectionState, sNTPServerTable=sNTPServerTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFURfBand=rFURfBand, phyControl=phyControl, remotePrimaryInternetAddress=remotePrimaryInternetAddress, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTableEntry=userTableEntry, rFUTxBandAboveRx=rFUTxBandAboveRx, ethernetPriorityTableIndex=ethernetPriorityTableIndex, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, subnetMask=subnetMask, remoteSecondaryMACAddress=remoteSecondaryMACAddress, neighborInternetAddressType=neighborInternetAddressType, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rFUTxPowerMin=rFUTxPowerMin, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sntp=sntp, transmitModulation=transmitModulation, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, gatewayIPAddress=gatewayIPAddress, sNTPState=sNTPState, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, vectorError=vectorError, alignmentModeTrap=alignmentModeTrap, diverseRfFeederLoss=diverseRfFeederLoss, rxDiversityVid=rxDiversityVid, rFURpsAlarm=rFURpsAlarm, managementPortDisabledWarning=managementPortDisabledWarning, cambium=cambium, rfu=rfu, hTTPSPortNumber=hTTPSPortNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remotePrimaryMACAddress=remotePrimaryMACAddress, snmpControl=snmpControl, managementPortStatus=managementPortStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, managementPortAutoNegotiation=managementPortAutoNegotiation, rFUTxPowerAlarm=rFUTxPowerAlarm, dataPortConfigurationMismatch=dataPortConfigurationMismatch, iPv6GatewayAddress=iPv6GatewayAddress, protectionInterfaceStatus=protectionInterfaceStatus, sNTPServerRetries=sNTPServerRetries, dataPortWirelessDownAlert=dataPortWirelessDownAlert, activeWirelessLinkAvailability=activeWirelessLinkAvailability, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFUSerial=rFUSerial, sMTPEnabledMessages=sMTPEnabledMessages, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry)
