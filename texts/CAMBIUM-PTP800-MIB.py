...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFUVersionBank2=rFUVersionBank2, ptpTraps=ptpTraps, sNMPPortNumber=sNMPPortNumber, protection=protection, smtp=smtp, receiveDataRate=receiveDataRate, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, vLANManagementVID=vLANManagementVID, timeZone=timeZone, managementPortDisabledWarning=managementPortDisabledWarning, phyStatus=phyStatus, protectionSwitchCause=protectionSwitchCause, transmitCapacity=transmitCapacity, dataPortPauseFrames=dataPortPauseFrames, neighborInternetAddressType=neighborInternetAddressType, endId=endId, supplementary=supplementary, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, diverseRfFeederLoss=diverseRfFeederLoss, rFUTxPowerMin=rFUTxPowerMin, sMTPServerIPAddress=sMTPServerIPAddress, remoteSecondaryIPAddress=remoteSecondaryIPAddress, siteName=siteName, alignmentModeTrap=alignmentModeTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, configuration=configuration, sNMPEnabledTraps=sNMPEnabledTraps, ethernet=ethernet, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, tFTPServerInternetAddress=tFTPServerInternetAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, versions=versions, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementMode=managementMode, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, sNTPSyncTrap=sNTPSyncTrap, minModulation=minModulation, linkLoss=linkLoss, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, sNTPServerTimeout=sNTPServerTimeout, remotePrimarySecondaryMode=remotePrimarySecondaryMode, remoteIPAddress=remoteIPAddress, sNTPServerTable=sNTPServerTable, protectionStateTrap=protectionStateTrap, ptmp=ptmp, rxDiversityVid=rxDiversityVid, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, sNTPServerResponse=sNTPServerResponse, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, managementCommittedInformationRate=managementCommittedInformationRate, neighborInternetAddress=neighborInternetAddress, userTableEntry=userTableEntry, managementPortStatus=managementPortStatus, protectionAvailabilityStatus=protectionAvailabilityStatus, ptpTrapPrefix=ptpTrapPrefix, iFCableLength=iFCableLength, l2CPPriorityTableIndex=l2CPPriorityTableIndex, userTableNumber=userTableNumber, faultProtectionSwitching=faultProtectionSwitching, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFURxFreqMax=rFURxFreqMax, transmitCapacityLimitDetail=transmitCapacityLimitDetail, sNTPLastSync=sNTPLastSync, ethernetFiberSupport=ethernetFiberSupport, rFURfBand=rFURfBand, protectionState=protectionState, linkNameMismatchTrap=linkNameMismatchTrap, tFTPServerIPAddress=tFTPServerIPAddress, rFUActiveFirmwareBank=rFUActiveFirmwareBank, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, encryptionEnabledMismatch=encryptionEnabledMismatch, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, numberOfAntennas=numberOfAntennas, activeWirelessLinkAvailability=activeWirelessLinkAvailability, l2CPPriorityTable=l2CPPriorityTable, systemReset=systemReset, ptp=ptp, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, bootVersion=bootVersion, sMTPEnabledMessages=sMTPEnabledMessages, hTTPSPortNumber=hTTPSPortNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, hTTPPortNumber=hTTPPortNumber, licence=licence, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPState=sNTPState, transmitModulation=transmitModulation, unitOutOfCalibration=unitOutOfCalibration, dataPortFiberStatusTrap=dataPortFiberStatusTrap, activeUnit=activeUnit, rFUType=rFUType, sMTPServerInternetAddress=sMTPServerInternetAddress, maximumTransmitPower=maximumTransmitPower, securityLevel=securityLevel, mPLSTCPriorityTable=mPLSTCPriorityTable, aAAControl=aAAControl, sNMPCommunityString=sNMPCommunityString, remoteMACAddress=remoteMACAddress, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, hTTPAccessEnabled=hTTPAccessEnabled, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, radioLicenseMinCodeRate=radioLicenseMinCodeRate, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, transmitterStatus=transmitterStatus, sNTPServerRetries=sNTPServerRetries, sNMPTrapIPAddress=sNMPTrapIPAddress, remotePrimaryInternetAddress=remotePrimaryInternetAddress, userTable=userTable, gatewayIPAddress=gatewayIPAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, receiveModulation=receiveModulation, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, remotePrimaryMACAddress=remotePrimaryMACAddress, aTPCEnable=aTPCEnable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, neighborMACAddress=neighborMACAddress, altitude=altitude, rFULockoutAlarm=rFULockoutAlarm, radioLicenseMinModulation=radioLicenseMinModulation, transmitCapacityLimit=transmitCapacityLimit, management=management, protectionStatus=protectionStatus, wirelessLinkStatusTrap=wirelessLinkStatusTrap, primaryRecoveryPeriod=primaryRecoveryPeriod, remoteInternetAddress=remoteInternetAddress, radioLicense=radioLicense, ethernetPriorityTableIndex=ethernetPriorityTableIndex, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, bridge=bridge, localPacketFiltering=localPacketFiltering, encryption=encryption, radioLicenseRxFreq=radioLicenseRxFreq, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, aggregateDataRate=aggregateDataRate, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, radioLicenseMaxModulation=radioLicenseMaxModulation, qOSPriorityScheme=qOSPriorityScheme, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogClientTrap=syslogClientTrap, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, fiberY=fiberY, systemClock=systemClock, minCodeRate=minCodeRate, rxDiversityVlanTpid=rxDiversityVlanTpid, subnetMask=subnetMask, rFUPowerButtonPressed=rFUPowerButtonPressed, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, ethernetPriorityTable=ethernetPriorityTable, telnetAccessEnabled=telnetAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, enableTransmission=enableTransmission, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPServerTableEntry=sNTPServerTableEntry, iPv6Address=iPv6Address, transmitPower=transmitPower, sntp=sntp, rFUCableAlarm=rFUCableAlarm, rFUProtectionCompatibility=rFUProtectionCompatibility, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, maxCodeRate=maxCodeRate, rFUTxMuteStatus=rFUTxMuteStatus, rFUPowerAlarm=rFUPowerAlarm, protectionInterfaceStatus=protectionInterfaceStatus, syslogClient=syslogClient, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, transmitCodeRate=transmitCodeRate, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, secureModeAlarm=secureModeAlarm, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, vectorError=vectorError, rFUTxFreqMin=rFUTxFreqMin, hardwareVersion=hardwareVersion, iPDSCPPriorityTable=iPDSCPPriorityTable, encryptionAlgorithm=encryptionAlgorithm, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, managementPortAutoNegotiation=managementPortAutoNegotiation, dataPortDisabledWarning=dataPortDisabledWarning, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rFUTransceiverLocation=rFUTransceiverLocation, dataPortStatus=dataPortStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, protectionConfig=protectionConfig, syslogControl=syslogControl, sNTPServerTableIndex=sNTPServerTableIndex, radioLicenseTxFreq=radioLicenseTxFreq, userTableIndex=userTableIndex, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, sNTPSync=sNTPSync, softwareVersion=softwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, userName=userName, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rFUTxFreqMax=rFUTxFreqMax, dataPortStatusTrap=dataPortStatusTrap, diverseAntennaGain=diverseAntennaGain, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, remoteMaximumTransmitPower=remoteMaximumTransmitPower, snmpControl=snmpControl, dataPortWirelessDownAlert=dataPortWirelessDownAlert, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, iPv6PrefixLength=iPv6PrefixLength, rFUTxPowerMax=rFUTxPowerMax, wirelessLinkStatus=wirelessLinkStatus, neighborIPAddress=neighborIPAddress, receiveCodeRate=receiveCodeRate, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, remotePrimaryIPAddress=remotePrimaryIPAddress, transmitDataRate=transmitDataRate, rxDiversityDataPortStatus=rxDiversityDataPortStatus, rFUPlatformCompatibility=rFUPlatformCompatibility, radioLicenseCodeRate=radioLicenseCodeRate, managementPortForcedConfiguration=managementPortForcedConfiguration, rFURFSwitchAlarm=rFURFSwitchAlarm, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rfu=rfu, rFURxFreqMin=rFURxFreqMin, primarySecondaryMode=primarySecondaryMode, rFUStatusTrap=rFUStatusTrap, maxModulation=maxModulation, daylightSaving=daylightSaving, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, sNMPTrapTable=sNMPTrapTable, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, requestedProtectionState=requestedProtectionState, sNTPServerTableNumber=sNTPServerTableNumber, sMTPEmailAlert=sMTPEmailAlert, sNTPPrimaryServer=sNTPPrimaryServer, rFUVersionBank1=rFUVersionBank1, userRole=userRole, userEnabled=userEnabled, cambium=cambium, rFUBranchingConfiguration=rFUBranchingConfiguration, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, productName=productName)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tFTPServerPortNumber=tFTPServerPortNumber, alignmentMode=alignmentMode, rFUTxBandAboveRx=rFUTxBandAboveRx, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, receivePower=receivePower, managementPortStatusTrap=managementPortStatusTrap, rFUSerial=rFUSerial, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, longitude=longitude, protectionConfigurationStatus=protectionConfigurationStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, rFURpsAlarm=rFURpsAlarm, vLANManagementPriority=vLANManagementPriority, remoteInternetAddressType=remoteInternetAddressType, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFUConnectedPlatform=rFUConnectedPlatform, primaryRecovery=primaryRecovery, dataPortFiberStatus=dataPortFiberStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, linkName=linkName, rFFeederLoss=rFFeederLoss, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, radioLicenseModulation=radioLicenseModulation, alarms=alarms, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, protectionStats=protectionStats, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, linkNameMismatch=linkNameMismatch, antennaGain=antennaGain, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, rFUStatus=rFUStatus, dSCPManagementPriority=dSCPManagementPriority, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, radioLicenseIdentifier=radioLicenseIdentifier, sNMPTrapInternetAddress=sNMPTrapInternetAddress, radioLicenseBandwidth=radioLicenseBandwidth, rFUTxPowerAlarm=rFUTxPowerAlarm, phyControl=phyControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, hTTPSAccessEnabled=hTTPSAccessEnabled, iPVersion=iPVersion, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, sNTPPollInterval=sNTPPollInterval, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, radioLicenseBand=radioLicenseBand, activeAvailableTime=activeAvailableTime, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, radioLicenseMaxEIRP=radioLicenseMaxEIRP, iPv4Address=iPv4Address, userPassword=userPassword, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, iPv6GatewayAddress=iPv6GatewayAddress, ptp800=ptp800, radioLicenseRegion=radioLicenseRegion, ethernetPriorityTableNumber=ethernetPriorityTableNumber, secureModeAlarmTrap=secureModeAlarmTrap, secondarySoftwareVersion=secondarySoftwareVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, syslogStateTrap=syslogStateTrap, remoteSecondaryMACAddress=remoteSecondaryMACAddress, syslogState=syslogState, rFUFreqSpacing=rFUFreqSpacing, telnetPortNumber=telnetPortNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, latitude=latitude, productVariant=productVariant, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, vLANManagementVIDValidation=vLANManagementVIDValidation, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, reset=reset, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, pubStats=pubStats)
