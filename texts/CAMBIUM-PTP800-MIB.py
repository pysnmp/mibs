...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNTPPollInterval=sNTPPollInterval, localPacketFiltering=localPacketFiltering, gatewayIPAddress=gatewayIPAddress, remoteSecondaryIPAddress=remoteSecondaryIPAddress, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, syslogClientTrap=syslogClientTrap, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, neighborIPAddress=neighborIPAddress, remotePrimaryInternetAddress=remotePrimaryInternetAddress, sNTPServerTableIndex=sNTPServerTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, protectionStateTrap=protectionStateTrap, enableTransmission=enableTransmission, tFTPServerPortNumber=tFTPServerPortNumber, ethernetPriorityTable=ethernetPriorityTable, hardwareVersion=hardwareVersion, sNTPServerTable=sNTPServerTable, fiberY=fiberY, sNTPServerTableNumber=sNTPServerTableNumber, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rFUTxPowerMax=rFUTxPowerMax, userTable=userTable, sNTPPrimaryServer=sNTPPrimaryServer, protectionConfigurationStatus=protectionConfigurationStatus, rFUProtectionCompatibility=rFUProtectionCompatibility, protection=protection, sNTPLastSync=sNTPLastSync, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, maximumTransmitPower=maximumTransmitPower, rFUPowerAlarm=rFUPowerAlarm, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, remotePrimaryIPAddress=remotePrimaryIPAddress, remotePrimarySecondaryMode=remotePrimarySecondaryMode, ethernet=ethernet, requestedProtectionState=requestedProtectionState, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dSCPManagementPriority=dSCPManagementPriority, softwareVersion=softwareVersion, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rFURpsAlarm=rFURpsAlarm, rFUActiveFirmwareBank=rFUActiveFirmwareBank, protectionSwitchCause=protectionSwitchCause, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, syslogState=syslogState, bootVersion=bootVersion, mPLSTCPriorityTable=mPLSTCPriorityTable, endId=endId, transmitterStatus=transmitterStatus, longitude=longitude, radioLicenseCodeRate=radioLicenseCodeRate, ptp800=ptp800, sMTPEmailAlert=sMTPEmailAlert, receivePower=receivePower, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licence=licence, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tFTPServerIPAddress=tFTPServerIPAddress, bridge=bridge, altitude=altitude, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFUTxFreqMin=rFUTxFreqMin, userName=userName, iPv4Address=iPv4Address, rFUConnectedPlatform=rFUConnectedPlatform, vectorError=vectorError, sNMPTrapIPAddress=sNMPTrapIPAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, rFUCableAlarm=rFUCableAlarm, wirelessLinkStatus=wirelessLinkStatus, encryptionAlgorithm=encryptionAlgorithm, pubStats=pubStats, ptp=ptp, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, radioLicenseTxFreq=radioLicenseTxFreq, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, remoteInternetAddressType=remoteInternetAddressType, remoteIPAddress=remoteIPAddress, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNTPServerIPAddress=sNTPServerIPAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, sNTPState=sNTPState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortPauseFrames=dataPortPauseFrames, iPVersion=iPVersion, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, radioLicenseMaxModulation=radioLicenseMaxModulation, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUSerial=rFUSerial, iPv6PrefixLength=iPv6PrefixLength, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, radioLicenseRxFreq=radioLicenseRxFreq, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, rFUTransceiverLocation=rFUTransceiverLocation, sNMPTrapTable=sNMPTrapTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, protectionInterfaceStatus=protectionInterfaceStatus, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, syslogClient=syslogClient, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, remotePrimaryMACAddress=remotePrimaryMACAddress, sNMPEnabledTraps=sNMPEnabledTraps, rFUVersionBank2=rFUVersionBank2, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFUTxBandAboveRx=rFUTxBandAboveRx, radioLicenseIdentifier=radioLicenseIdentifier, transmitPower=transmitPower, phyStatus=phyStatus, timeZone=timeZone, rFUVersionBank1=rFUVersionBank1, diverseRfFeederLoss=diverseRfFeederLoss, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogLocalWrappedTrap=syslogLocalWrappedTrap, managementPortDisabledWarning=managementPortDisabledWarning, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, transmitCodeRate=transmitCodeRate, syslogStateTrap=syslogStateTrap, rxDiversityDataPortStatus=rxDiversityDataPortStatus, hTTPPortNumber=hTTPPortNumber, versions=versions, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, systemClock=systemClock, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, dataPortStatusTrap=dataPortStatusTrap, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, transmitCapacityLimitDetail=transmitCapacityLimitDetail, dataPortFiberStatusTrap=dataPortFiberStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, rFUFreqSpacing=rFUFreqSpacing, maxCodeRate=maxCodeRate, protectionConfig=protectionConfig, telnetAccessEnabled=telnetAccessEnabled, rFUStatusTrap=rFUStatusTrap, telnetPortNumber=telnetPortNumber, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, radioLicenseRegion=radioLicenseRegion, aTPCEnable=aTPCEnable, alarms=alarms, snmpControl=snmpControl, linkNameMismatchTrap=linkNameMismatchTrap, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, phyControl=phyControl, rFURFSwitchAlarm=rFURFSwitchAlarm, radioLicenseBandwidth=radioLicenseBandwidth, dataPortFiberStatus=dataPortFiberStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFUBranchingConfiguration=rFUBranchingConfiguration, dataPortStatus=dataPortStatus, userEnabled=userEnabled, latitude=latitude, aggregateDataRate=aggregateDataRate, syslogControl=syslogControl, remoteInternetAddress=remoteInternetAddress, transmitModulation=transmitModulation, productVariant=productVariant, sMTPServerInternetAddressType=sMTPServerInternetAddressType, managementPortForcedConfiguration=managementPortForcedConfiguration, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, ptpTrapPrefix=ptpTrapPrefix, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, daylightSaving=daylightSaving, aAAControl=aAAControl, smtp=smtp, linkName=linkName, sNTPServerTableEntry=sNTPServerTableEntry, siteName=siteName, managementPortAutoNegotiation=managementPortAutoNegotiation, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, antennaGain=antennaGain, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, transmitCapacity=transmitCapacity, activeAvailableTime=activeAvailableTime, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFURxFreqMin=rFURxFreqMin, hTTPSPortNumber=hTTPSPortNumber, linkNameMismatch=linkNameMismatch, ethernetPriorityTableIndex=ethernetPriorityTableIndex, reset=reset, ethernetFiberSupport=ethernetFiberSupport, rFUTxPowerMin=rFUTxPowerMin, enabledDiagnosticAlarms=enabledDiagnosticAlarms, encryption=encryption, alignmentModeTrap=alignmentModeTrap, secureModeAlarm=secureModeAlarm, management=management, userPassword=userPassword, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementMode=managementMode, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rFUTxMuteStatus=rFUTxMuteStatus, cambium=cambium, vLANManagementVIDValidation=vLANManagementVIDValidation, vLANManagementVID=vLANManagementVID, sNTPSyncTrap=sNTPSyncTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rxDiversityVlanTpid=rxDiversityVlanTpid, sNTPSync=sNTPSync, primarySecondaryMode=primarySecondaryMode, rFUPlatformCompatibility=rFUPlatformCompatibility, sNMPPortNumber=sNMPPortNumber, rFUType=rFUType, rFUPowerButtonPressed=rFUPowerButtonPressed, userRole=userRole, numberOfAntennas=numberOfAntennas, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, radioLicenseMaxEIRP=radioLicenseMaxEIRP, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, neighborInternetAddress=neighborInternetAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, managementPortStatus=managementPortStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, secondarySoftwareVersion=secondarySoftwareVersion, unitOutOfCalibration=unitOutOfCalibration, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, activeUnit=activeUnit, radioLicenseMinModulation=radioLicenseMinModulation, userTableNumber=userTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, radioLicense=radioLicense, protectionStats=protectionStats, vLANManagementPriority=vLANManagementPriority, l2CPPriorityTable=l2CPPriorityTable, sNMPCommunityString=sNMPCommunityString, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerInternetAddressType=sNTPServerInternetAddressType, protectionStatus=protectionStatus, neighborInternetAddressType=neighborInternetAddressType, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", useVLANForManagementInterfaces=useVLANForManagementInterfaces, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveModulation=receiveModulation, sNMPTrapInternetAddress=sNMPTrapInternetAddress, maxModulation=maxModulation, sMTPEnabledMessages=sMTPEnabledMessages, dataPortDisabledWarning=dataPortDisabledWarning, rFURxFreqMax=rFURxFreqMax, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rFFeederLoss=rFFeederLoss, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, qOSPriorityScheme=qOSPriorityScheme, supplementary=supplementary, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rFUTxPowerAlarm=rFUTxPowerAlarm, configuration=configuration, transmitDataRate=transmitDataRate, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, transmitCapacityLimit=transmitCapacityLimit, sNMPTrapTableIndex=sNMPTrapTableIndex, protectionAvailabilityStatus=protectionAvailabilityStatus, rFULockoutAlarm=rFULockoutAlarm, alignmentMode=alignmentMode, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rFURfBand=rFURfBand, iPv6GatewayAddress=iPv6GatewayAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPServerResponse=sNTPServerResponse, primaryRecovery=primaryRecovery, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, radioLicenseMinCodeRate=radioLicenseMinCodeRate, remoteMACAddress=remoteMACAddress, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, securityLevel=securityLevel, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, activeWirelessLinkAvailability=activeWirelessLinkAvailability, minModulation=minModulation, wirelessLinkStatusTrap=wirelessLinkStatusTrap, productName=productName, sNMPTrapVersion=sNMPTrapVersion, receiveCodeRate=receiveCodeRate, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, ptmp=ptmp, radioLicenseBand=radioLicenseBand, radioLicenseModulation=radioLicenseModulation, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, sntp=sntp, primaryRecoveryPeriod=primaryRecoveryPeriod, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rfu=rfu, subnetMask=subnetMask, rFUTxFreqMax=rFUTxFreqMax, linkLoss=linkLoss, iFCableLength=iFCableLength, receiveDataRate=receiveDataRate, rxDiversityVid=rxDiversityVid, neighborMACAddress=neighborMACAddress, userTableIndex=userTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, sNTPServerPortNumber=sNTPServerPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, userTableEntry=userTableEntry, diverseAntennaGain=diverseAntennaGain, sNTPServerTimeout=sNTPServerTimeout, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFUStatus=rFUStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, iPv6Address=iPv6Address, managementPortStatusTrap=managementPortStatusTrap, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, faultProtectionSwitching=faultProtectionSwitching, sNTPServerRetries=sNTPServerRetries, minCodeRate=minCodeRate, sMTPServerIPAddress=sMTPServerIPAddress, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, managementCommittedInformationRate=managementCommittedInformationRate, encryptionEnabledMismatch=encryptionEnabledMismatch, systemReset=systemReset, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, ethernetPriorityTableNumber=ethernetPriorityTableNumber, managementPortConfigurationMismatch=managementPortConfigurationMismatch, protectionState=protectionState, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap)
