...
MibIdentifier, ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, IpAddress, TimeTicks, NotificationType, Bits, Counter64, iso, Gauge32, ObjectIdentity, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "IpAddress", "TimeTicks", "NotificationType", "Bits", "Counter64", "iso", "Gauge32", "ObjectIdentity", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sntp=sntp, iFCableLength=iFCableLength, alignmentModeTrap=alignmentModeTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, maxCodeRate=maxCodeRate, bridge=bridge, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, maximumTransmitPower=maximumTransmitPower, transmitModulation=transmitModulation, sNTPServerResponse=sNTPServerResponse, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, unitOutOfCalibration=unitOutOfCalibration, remoteSecondaryMACAddress=remoteSecondaryMACAddress, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, sNTPServerPortNumber=sNTPServerPortNumber, sNTPPrimaryServer=sNTPPrimaryServer, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, vLANManagementVIDValidation=vLANManagementVIDValidation, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, phyControl=phyControl, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sMTPServerPortNumber=sMTPServerPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, activeWirelessLinkAvailability=activeWirelessLinkAvailability, sNTPServerTableIndex=sNTPServerTableIndex, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, radioLicenseMinCodeRate=radioLicenseMinCodeRate, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rFUTxPowerMin=rFUTxPowerMin, endId=endId, iPDSCPPriorityTable=iPDSCPPriorityTable, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFURfBand=rFURfBand, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rxDiversityVid=rxDiversityVid, sNMPEnabledTraps=sNMPEnabledTraps, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, diverseAntennaGain=diverseAntennaGain, userEnabled=userEnabled, faultProtectionSwitching=faultProtectionSwitching, sNTPServerInternetAddress=sNTPServerInternetAddress, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, iPv6PrefixLength=iPv6PrefixLength, antennaGain=antennaGain, sNTPSyncTrap=sNTPSyncTrap, reset=reset, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, latitude=latitude, encryption=encryption, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, secondarySoftwareVersion=secondarySoftwareVersion, radioLicenseTxFreq=radioLicenseTxFreq, dataPortPauseFrames=dataPortPauseFrames, radioLicenseRxFreq=radioLicenseRxFreq, receiveDataRate=receiveDataRate, protectionAvailabilityStatus=protectionAvailabilityStatus, rxDiversityVlanTpid=rxDiversityVlanTpid, sMTPEnabledMessages=sMTPEnabledMessages, productName=productName, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, longitude=longitude, rFUStatus=rFUStatus, numberOfAntennas=numberOfAntennas, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, remotePrimarySecondaryMode=remotePrimarySecondaryMode, encryptionEnabledMismatch=encryptionEnabledMismatch, sNTPPollInterval=sNTPPollInterval, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteIPAddress=remoteIPAddress, transmitCapacity=transmitCapacity, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rFUTxFreqMax=rFUTxFreqMax, remoteMACAddress=remoteMACAddress, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, tFTPServerInternetAddress=tFTPServerInternetAddress, rFFeederLoss=rFFeederLoss, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, remoteInternetAddressType=remoteInternetAddressType, l2CPPriorityTableIndex=l2CPPriorityTableIndex, wirelessLinkStatus=wirelessLinkStatus, userTableNumber=userTableNumber, protectionStateTrap=protectionStateTrap, securityLevel=securityLevel, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, sMTPServerIPAddress=sMTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, sNTPLastSync=sNTPLastSync, radioLicenseMaxEIRP=radioLicenseMaxEIRP, rFUTxPowerAlarm=rFUTxPowerAlarm, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, qOSPriorityScheme=qOSPriorityScheme, managementPortStatus=managementPortStatus, vLANManagementPriority=vLANManagementPriority, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, neighborInternetAddressType=neighborInternetAddressType, maxModulation=maxModulation, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPState=sNTPState, alignmentMode=alignmentMode, productVariant=productVariant, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitPower=transmitPower, hTTPSAccessEnabled=hTTPSAccessEnabled, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userName=userName, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFURpsAlarm=rFURpsAlarm, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, hTTPAccessEnabled=hTTPAccessEnabled, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, hTTPSPortNumber=hTTPSPortNumber, dataPortFiberStatus=dataPortFiberStatus, transmitCapacityLimitDetail=transmitCapacityLimitDetail, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, sNMPTrapTable=sNMPTrapTable, transmitCodeRate=transmitCodeRate, ptmp=ptmp, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sNMPTrapVersion=sNMPTrapVersion, requestedProtectionState=requestedProtectionState, rFURxFreqMax=rFURxFreqMax, rFUTransceiverLocation=rFUTransceiverLocation, dataPortConfigurationMismatch=dataPortConfigurationMismatch, wirelessLinkAvailability=wirelessLinkAvailability, protectionConfig=protectionConfig, syslogClient=syslogClient, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rFUStatusTrap=rFUStatusTrap, userTableIndex=userTableIndex, receivePower=receivePower, remotePrimaryIPAddress=remotePrimaryIPAddress, userPassword=userPassword, protectionStats=protectionStats, rFUBranchingConfiguration=rFUBranchingConfiguration, iPv4Address=iPv4Address, rFUVersionBank1=rFUVersionBank1, rFUTxMuteStatus=rFUTxMuteStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, syslogState=syslogState, rxDiversityDataPortStatus=rxDiversityDataPortStatus, timeZone=timeZone, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, sMTPEmailAlert=sMTPEmailAlert, syslogControl=syslogControl, protectionSwitchCause=protectionSwitchCause, transmitterStatus=transmitterStatus, altitude=altitude, radioLicenseBand=radioLicenseBand, phyStatus=phyStatus, ptp800=ptp800, telnetAccessEnabled=telnetAccessEnabled, pubStats=pubStats, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementPortStatusTrap=managementPortStatusTrap, rFUTxBandAboveRx=rFUTxBandAboveRx, radioLicenseRegion=radioLicenseRegion, rFUProtectionCompatibility=rFUProtectionCompatibility, neighborInternetAddress=neighborInternetAddress, hardwareVersion=hardwareVersion, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, transmitDataRate=transmitDataRate, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPCommunityString=sNMPCommunityString, telnetPortNumber=telnetPortNumber, wirelessLinkStatusTrap=wirelessLinkStatusTrap, remoteInternetAddress=remoteInternetAddress, subnetMask=subnetMask, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, linkName=linkName, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, syslogStateTrap=syslogStateTrap, diverseRfFeederLoss=diverseRfFeederLoss, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rFUPowerAlarm=rFUPowerAlarm, ptpTraps=ptpTraps, managementMode=managementMode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, alarms=alarms, minCodeRate=minCodeRate, sNMPTrapPortNumber=sNMPTrapPortNumber, rFUType=rFUType, daylightSaving=daylightSaving, rFULockoutAlarm=rFULockoutAlarm, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, ethernetPriorityTable=ethernetPriorityTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rFUSerial=rFUSerial, configuration=configuration, sNTPServerTimeout=sNTPServerTimeout, managementPortAutoNegotiation=managementPortAutoNegotiation, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, remotePrimaryInternetAddress=remotePrimaryInternetAddress, aTPCEnable=aTPCEnable, rfu=rfu, radioLicenseCodeRate=radioLicenseCodeRate, l2CPPriorityTable=l2CPPriorityTable, rFUPowerButtonPressed=rFUPowerButtonPressed, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPServerPortNumber=tFTPServerPortNumber, rFUTxFreqMin=rFUTxFreqMin, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPv6Address=iPv6Address, radioLicenseModulation=radioLicenseModulation, licence=licence, protectionState=protectionState, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, ethernetPriorityTableNumber=ethernetPriorityTableNumber, minModulation=minModulation, systemReset=systemReset, dSCPManagementPriority=dSCPManagementPriority, siteName=siteName, ptpTrapPrefix=ptpTrapPrefix, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, iPv6GatewayAddress=iPv6GatewayAddress, syslogClientTrap=syslogClientTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, hTTPPortNumber=hTTPPortNumber, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, linkNameMismatch=linkNameMismatch, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPVersion=iPVersion, userRole=userRole, tFTPServerIPAddress=tFTPServerIPAddress, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNMPPortNumber=sNMPPortNumber, secureModeAlarm=secureModeAlarm, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPServerTableEntry=sNTPServerTableEntry, rFURxFreqMin=rFURxFreqMin, neighborIPAddress=neighborIPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, radioLicenseIdentifier=radioLicenseIdentifier, dataPortDisabledWarning=dataPortDisabledWarning, rFUPlatformCompatibility=rFUPlatformCompatibility, receiveModulation=receiveModulation, remoteSecondaryIPAddress=remoteSecondaryIPAddress, vLANManagementVID=vLANManagementVID, sMTPServerInternetAddressType=sMTPServerInternetAddressType, rFUConnectedPlatform=rFUConnectedPlatform, versions=versions, snmpControl=snmpControl, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, cambium=cambium, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, protectionConfigurationStatus=protectionConfigurationStatus, supplementary=supplementary, primaryRecovery=primaryRecovery, managementCommittedInformationRate=managementCommittedInformationRate, ptp=ptp, activeUnit=activeUnit, sNTPServerRetries=sNTPServerRetries, gatewayIPAddress=gatewayIPAddress, receiveCodeRate=receiveCodeRate, management=management, radioLicenseMinModulation=radioLicenseMinModulation, sNTPServerTableNumber=sNTPServerTableNumber, userTableEntry=userTableEntry, primaryRecoveryPeriod=primaryRecoveryPeriod, protectionStatus=protectionStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rFUFreqSpacing=rFUFreqSpacing, rFUCableAlarm=rFUCableAlarm, protectionInterfaceStatus=protectionInterfaceStatus, fiberY=fiberY, sNTPServerTable=sNTPServerTable, activeAvailableTime=activeAvailableTime, transmitCapacityLimit=transmitCapacityLimit, radioLicense=radioLicense, rFUVersionBank2=rFUVersionBank2, linkLoss=linkLoss, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sNMPTrapTableEntry=sNMPTrapTableEntry, aggregateDataRate=aggregateDataRate, sNTPSync=sNTPSync, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, aAAControl=aAAControl, secureModeAlarmTrap=secureModeAlarmTrap, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, dataPortStatus=dataPortStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, radioLicenseBandwidth=radioLicenseBandwidth, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, enableTransmission=enableTransmission, rFUActiveFirmwareBank=rFUActiveFirmwareBank, linkNameMismatchTrap=linkNameMismatchTrap, smtp=smtp, sNMPTrapTableNumber=sNMPTrapTableNumber, managementPortForcedConfiguration=managementPortForcedConfiguration, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rFURFSwitchAlarm=rFURFSwitchAlarm, neighborMACAddress=neighborMACAddress, rFUTxPowerMax=rFUTxPowerMax, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, softwareVersion=softwareVersion, radioLicenseMaxModulation=radioLicenseMaxModulation, ethernet=ethernet, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, localPacketFiltering=localPacketFiltering, ethernetFiberSupport=ethernetFiberSupport, bootVersion=bootVersion, userTable=userTable, sNTPServerIPAddress=sNTPServerIPAddress, protection=protection, managementPortConfigurationMismatch=managementPortConfigurationMismatch, systemClock=systemClock, ethernetPriorityTableEntry=ethernetPriorityTableEntry, primarySecondaryMode=primarySecondaryMode, managementPortDisabledWarning=managementPortDisabledWarning, remotePrimaryMACAddress=remotePrimaryMACAddress, vectorError=vectorError)
