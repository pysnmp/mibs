...
iso, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, Counter64, ObjectIdentity, NotificationType, MibIdentifier, Integer32, NotificationType, Gauge32, ModuleIdentity, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "Counter64", "ObjectIdentity", "NotificationType", "MibIdentifier", "Integer32", "NotificationType", "Gauge32", "ModuleIdentity", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", syslogLocalWrappedTrap=syslogLocalWrappedTrap, rFUActiveFirmwareBank=rFUActiveFirmwareBank, secureModeAlarmTrap=secureModeAlarmTrap, protectionConfig=protectionConfig, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, iPv6PrefixLength=iPv6PrefixLength, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, transmitterStatus=transmitterStatus, wirelessLinkAvailability=wirelessLinkAvailability, neighborMACAddress=neighborMACAddress, maximumTransmitPower=maximumTransmitPower, rxDiversityDataPortStatus=rxDiversityDataPortStatus, cambium=cambium, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, neighborInternetAddress=neighborInternetAddress, secureModeAlarm=secureModeAlarm, aTPCEnable=aTPCEnable, radioLicenseModulation=radioLicenseModulation, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, radioLicenseTxFreq=radioLicenseTxFreq, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, dataPortFiberStatus=dataPortFiberStatus, sMTPServerPortNumber=sMTPServerPortNumber, ptpTraps=ptpTraps, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, sNTPServerPortNumber=sNTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, aAAControl=aAAControl, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, remotePrimaryIPAddress=remotePrimaryIPAddress, iFCableLength=iFCableLength, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, encryptionAlgorithm=encryptionAlgorithm, radioLicenseBandwidth=radioLicenseBandwidth, sMTPServerInternetAddressType=sMTPServerInternetAddressType, rFULockoutAlarm=rFULockoutAlarm, rFUStatus=rFUStatus, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, iPv6Address=iPv6Address, sMTPServerIPAddress=sMTPServerIPAddress, syslogStateTrap=syslogStateTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rFURFSwitchAlarm=rFURFSwitchAlarm, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, useVLANForManagementInterfaces=useVLANForManagementInterfaces, subnetMask=subnetMask, userName=userName, sNMPTrapPortNumber=sNMPTrapPortNumber, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, l2CPPriorityTableEntry=l2CPPriorityTableEntry, radioLicenseRxFreq=radioLicenseRxFreq, radioLicenseIdentifier=radioLicenseIdentifier, numberOfAntennas=numberOfAntennas, userPassword=userPassword, linkLoss=linkLoss, rxDiversityVlanTpid=rxDiversityVlanTpid, productVariant=productVariant, sNTPServerTableEntry=sNTPServerTableEntry, hardwareVersion=hardwareVersion, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, managementCommittedInformationRate=managementCommittedInformationRate, minCodeRate=minCodeRate, licence=licence, tFTPServerPortNumber=tFTPServerPortNumber, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, iPVersion=iPVersion, minModulation=minModulation, syslogClientTrap=syslogClientTrap, wirelessLinkStatusTrap=wirelessLinkStatusTrap, receiveModulation=receiveModulation, primarySecondaryMode=primarySecondaryMode, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPSync=sNTPSync, sNTPServerResponse=sNTPServerResponse, radioLicenseBand=radioLicenseBand, managementMode=managementMode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, syslogClient=syslogClient, l2CPPriorityTableIndex=l2CPPriorityTableIndex, alarms=alarms, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementPortStatus=managementPortStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUTransceiverLocation=rFUTransceiverLocation, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, rFUTxFreqMin=rFUTxFreqMin, vLANManagementVID=vLANManagementVID, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortFiberStatusTrap=dataPortFiberStatusTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, dSCPManagementPriority=dSCPManagementPriority, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, remotePrimarySecondaryMode=remotePrimarySecondaryMode, altitude=altitude, protectionStats=protectionStats, receiveDataRate=receiveDataRate, syslogState=syslogState, rFUTxFreqMax=rFUTxFreqMax, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ethernetPriorityTableEntry=ethernetPriorityTableEntry, transmitCodeRate=transmitCodeRate, primaryRecoveryPeriod=primaryRecoveryPeriod, gatewayIPAddress=gatewayIPAddress, ptmp=ptmp, radioLicenseCodeRate=radioLicenseCodeRate, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, ptpTrapPrefix=ptpTrapPrefix, ptp=ptp, dataPortDisabledWarning=dataPortDisabledWarning, versions=versions, encryptionEnabledMismatch=encryptionEnabledMismatch, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTable=sNMPTrapTable, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, rFUTxPowerMin=rFUTxPowerMin, rFURxFreqMax=rFURxFreqMax, sNTPServerTableIndex=sNTPServerTableIndex, sMTPEmailAlert=sMTPEmailAlert, userTableNumber=userTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, maxModulation=maxModulation, vectorError=vectorError, productName=productName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, protection=protection, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFUPowerButtonPressed=rFUPowerButtonPressed, requestedProtectionState=requestedProtectionState, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, hTTPAccessEnabled=hTTPAccessEnabled, primaryRecovery=primaryRecovery, bridge=bridge, remotePrimaryInternetAddress=remotePrimaryInternetAddress, userTableEntry=userTableEntry, diverseAntennaGain=diverseAntennaGain, rFUTxPowerMax=rFUTxPowerMax, syslogControl=syslogControl, rFUPowerAlarm=rFUPowerAlarm, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, wirelessLinkStatus=wirelessLinkStatus, protectionAvailabilityStatus=protectionAvailabilityStatus, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, hTTPSAccessEnabled=hTTPSAccessEnabled, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, fiberY=fiberY, sNMPPortNumber=sNMPPortNumber, l2CPPriorityTable=l2CPPriorityTable, iPv4Address=iPv4Address, userTable=userTable, rFUPlatformCompatibility=rFUPlatformCompatibility, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, vLANManagementVIDValidation=vLANManagementVIDValidation, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, rFURfBand=rFURfBand, sNTPServerRetries=sNTPServerRetries, rFUTxPowerAlarm=rFUTxPowerAlarm, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, protectionStateTrap=protectionStateTrap, sntp=sntp, rFURxFreqMin=rFURxFreqMin, dataPortStatus=dataPortStatus, diverseRfFeederLoss=diverseRfFeederLoss, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkName=linkName, activeWirelessLinkAvailability=activeWirelessLinkAvailability, mPLSTCPriorityTable=mPLSTCPriorityTable, activeAvailableTime=activeAvailableTime, radioLicense=radioLicense, sMTPEnabledMessages=sMTPEnabledMessages, timeZone=timeZone, transmitCapacityLimit=transmitCapacityLimit, localPacketFiltering=localPacketFiltering, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rFUFreqSpacing=rFUFreqSpacing, transmitCapacityLimitDetail=transmitCapacityLimitDetail, hTTPSPortNumber=hTTPSPortNumber, radioLicenseMaxEIRP=radioLicenseMaxEIRP, ethernetFiberSupport=ethernetFiberSupport, enableTransmission=enableTransmission, transmitDataRate=transmitDataRate, rFUTxBandAboveRx=rFUTxBandAboveRx, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, remoteIPAddress=remoteIPAddress, neighborIPAddress=neighborIPAddress, transmitPower=transmitPower, ethernetPriorityTable=ethernetPriorityTable, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, transmitModulation=transmitModulation, rFUProtectionCompatibility=rFUProtectionCompatibility, protectionState=protectionState, smtp=smtp, remoteInternetAddress=remoteInternetAddress, remoteInternetAddressType=remoteInternetAddressType, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, activeUnit=activeUnit, encryption=encryption, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rFUCableAlarm=rFUCableAlarm, ethernetPriorityTableNumber=ethernetPriorityTableNumber, telnetAccessEnabled=telnetAccessEnabled, alignmentModeTrap=alignmentModeTrap, protectionStatus=protectionStatus, ptp800=ptp800, radioLicenseMaxModulation=radioLicenseMaxModulation, iPDSCPPriorityTable=iPDSCPPriorityTable, unitOutOfCalibration=unitOutOfCalibration, systemClock=systemClock, sNMPTrapTableEntry=sNMPTrapTableEntry, aggregateDataRate=aggregateDataRate, dataPortPauseFrames=dataPortPauseFrames, systemReset=systemReset, vLANManagementPriority=vLANManagementPriority, remoteMACAddress=remoteMACAddress, rFUVersionBank2=rFUVersionBank2, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, endId=endId, managementPortForcedConfiguration=managementPortForcedConfiguration, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, secondarySoftwareVersion=secondarySoftwareVersion, phyControl=phyControl, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, daylightSaving=daylightSaving, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sNTPServerTableNumber=sNTPServerTableNumber, sNTPPrimaryServer=sNTPPrimaryServer, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, userTableIndex=userTableIndex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, pubStats=pubStats, sNMPTrapTableNumber=sNMPTrapTableNumber, rfu=rfu, sNMPTrapIPAddress=sNMPTrapIPAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", qOSPriorityScheme=qOSPriorityScheme, bootVersion=bootVersion, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, radioLicenseRegion=radioLicenseRegion, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, latitude=latitude, phyStatus=phyStatus, sNTPServerIPAddress=sNTPServerIPAddress, rFUConnectedPlatform=rFUConnectedPlatform, snmpControl=snmpControl, securityLevel=securityLevel, antennaGain=antennaGain, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, softwareVersion=softwareVersion, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFUTxMuteStatus=rFUTxMuteStatus, iPv6GatewayAddress=iPv6GatewayAddress, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, rFFeederLoss=rFFeederLoss, dataPortStatusTrap=dataPortStatusTrap, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, managementPortStatusTrap=managementPortStatusTrap, sNTPServerTable=sNTPServerTable, sNMPTrapVersion=sNMPTrapVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, siteName=siteName, telnetPortNumber=telnetPortNumber, linkNameMismatchTrap=linkNameMismatchTrap, sNTPLastSync=sNTPLastSync, managementPortAutoNegotiation=managementPortAutoNegotiation, maxCodeRate=maxCodeRate, rFUType=rFUType, ethernet=ethernet, faultProtectionSwitching=faultProtectionSwitching, longitude=longitude, receiveCodeRate=receiveCodeRate, sNMPTrapTableIndex=sNMPTrapTableIndex, rFUStatusTrap=rFUStatusTrap, managementPortDisabledWarning=managementPortDisabledWarning, remotePrimaryMACAddress=remotePrimaryMACAddress, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPServerTimeout=sNTPServerTimeout, receivePower=receivePower, userEnabled=userEnabled, tFTPServerIPAddress=tFTPServerIPAddress, configuration=configuration, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, l2CPPriorityTableNumber=l2CPPriorityTableNumber, reset=reset, transmitCapacity=transmitCapacity, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFUSerial=rFUSerial, protectionConfigurationStatus=protectionConfigurationStatus, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, rFURpsAlarm=rFURpsAlarm, linkNameMismatch=linkNameMismatch, supplementary=supplementary, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userRole=userRole, alignmentMode=alignmentMode, rFUVersionBank1=rFUVersionBank1, sNTPState=sNTPState, protectionSwitchCause=protectionSwitchCause, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, sNMPCommunityString=sNMPCommunityString, rxDiversityVid=rxDiversityVid, sNTPSyncTrap=sNTPSyncTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rFUBranchingConfiguration=rFUBranchingConfiguration, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, neighborInternetAddressType=neighborInternetAddressType, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, hTTPPortNumber=hTTPPortNumber, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, radioLicenseMinModulation=radioLicenseMinModulation, protectionInterfaceStatus=protectionInterfaceStatus, management=management, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, remoteSecondaryIPAddress=remoteSecondaryIPAddress)
