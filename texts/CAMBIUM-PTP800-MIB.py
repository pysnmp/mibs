...
Bits, ObjectIdentity, Counter32, NotificationType, Counter64, iso, IpAddress, Gauge32, enterprises, TimeTicks, MibIdentifier, Integer32, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "Counter32", "NotificationType", "Counter64", "iso", "IpAddress", "Gauge32", "enterprises", "TimeTicks", "MibIdentifier", "Integer32", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", vLANManagementVID=vLANManagementVID, ethernet=ethernet, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, vLANManagementVIDValidation=vLANManagementVIDValidation, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, userTableNumber=userTableNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, iPv6GatewayAddress=iPv6GatewayAddress, l2CPPriorityTable=l2CPPriorityTable, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, hTTPAccessEnabled=hTTPAccessEnabled, sNTPLastSync=sNTPLastSync, dataPortFiberStatus=dataPortFiberStatus, rFUTransceiverLocation=rFUTransceiverLocation, syslogLocalWrappedTrap=syslogLocalWrappedTrap, productVariant=productVariant, transmitCapacity=transmitCapacity, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerTableEntry=sNTPServerTableEntry, vLANManagementPriority=vLANManagementPriority, neighborInternetAddress=neighborInternetAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rFUTxFreqMax=rFUTxFreqMax, protectionStats=protectionStats, activeAvailableTime=activeAvailableTime, secureModeAlarm=secureModeAlarm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, radioLicenseRxFreq=radioLicenseRxFreq, activeUnit=activeUnit, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, dataPortPauseFrames=dataPortPauseFrames, remoteSecondaryMACAddress=remoteSecondaryMACAddress, radioLicense=radioLicense, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapTableIndex=sNMPTrapTableIndex, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, sNTPPollInterval=sNTPPollInterval, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFUTxBandAboveRx=rFUTxBandAboveRx, wirelessLinkStatusTrap=wirelessLinkStatusTrap, alarms=alarms, encryptionEnabledMismatch=encryptionEnabledMismatch, sNTPServerResponse=sNTPServerResponse, managementMode=managementMode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, userRole=userRole, aAAControl=aAAControl, enabledDiagnosticAlarms=enabledDiagnosticAlarms, primaryRecovery=primaryRecovery, sNMPTrapTable=sNMPTrapTable, radioLicenseRegion=radioLicenseRegion, daylightSaving=daylightSaving, remoteInternetAddressType=remoteInternetAddressType, sNTPSyncTrap=sNTPSyncTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPServerTableIndex=sNTPServerTableIndex, rFUTxMuteStatus=rFUTxMuteStatus, rFUProtectionCompatibility=rFUProtectionCompatibility, rxDiversityVid=rxDiversityVid, sNMPPortNumber=sNMPPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerTimeout=sNTPServerTimeout, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, rFUTxFreqMin=rFUTxFreqMin, protectionStateTrap=protectionStateTrap, transmitCapacityLimit=transmitCapacityLimit, tFTPServerPortNumber=tFTPServerPortNumber, userEnabled=userEnabled, rFUPowerAlarm=rFUPowerAlarm, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, iPv6Address=iPv6Address, systemReset=systemReset, radioLicenseMinCodeRate=radioLicenseMinCodeRate, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, vectorError=vectorError, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, hardwareVersion=hardwareVersion, linkLoss=linkLoss, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userTable=userTable, qOSPriorityScheme=qOSPriorityScheme, tFTPServerInternetAddressType=tFTPServerInternetAddressType, radioLicenseMinModulation=radioLicenseMinModulation, transmitCodeRate=transmitCodeRate, syslogClientTrap=syslogClientTrap, securityLevel=securityLevel, sNMPTrapPortNumber=sNMPTrapPortNumber, configuration=configuration, unitOutOfCalibration=unitOutOfCalibration, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rfu=rfu, siteName=siteName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rFURFSwitchAlarm=rFURFSwitchAlarm, syslogStateTrap=syslogStateTrap, transmitCapacityLimitDetail=transmitCapacityLimitDetail, sntp=sntp, remoteIPAddress=remoteIPAddress, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, rFUBranchingConfiguration=rFUBranchingConfiguration, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, aTPCEnable=aTPCEnable, sNMPTrapVersion=sNMPTrapVersion, managementPortStatus=managementPortStatus, alignmentModeTrap=alignmentModeTrap, protectionAvailabilityStatus=protectionAvailabilityStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, managementCommittedInformationRate=managementCommittedInformationRate, hTTPSPortNumber=hTTPSPortNumber, rFUFreqSpacing=rFUFreqSpacing, userTableEntry=userTableEntry, supplementary=supplementary, rFUVersionBank1=rFUVersionBank1, ethernetPriorityTableEntry=ethernetPriorityTableEntry, faultProtectionSwitching=faultProtectionSwitching, activeWirelessLinkAvailability=activeWirelessLinkAvailability, maxModulation=maxModulation, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFURxFreqMax=rFURxFreqMax, sMTPEnabledMessages=sMTPEnabledMessages, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, versions=versions, iPVersion=iPVersion, radioLicenseMaxModulation=radioLicenseMaxModulation, syslogState=syslogState, sNTPServerInternetAddress=sNTPServerInternetAddress, rFURfBand=rFURfBand, enableTransmission=enableTransmission, reset=reset, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFUTxPowerMax=rFUTxPowerMax, managementPortStatusTrap=managementPortStatusTrap, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, telnetPortNumber=telnetPortNumber, dSCPManagementPriority=dSCPManagementPriority, transmitterStatus=transmitterStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, subnetMask=subnetMask, cambium=cambium, receiveCodeRate=receiveCodeRate, rFUStatusTrap=rFUStatusTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, hTTPPortNumber=hTTPPortNumber, transmitDataRate=transmitDataRate, radioLicenseTxFreq=radioLicenseTxFreq, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, sNTPServerPortNumber=sNTPServerPortNumber, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, dataPortDisabledWarning=dataPortDisabledWarning, sMTPServerInternetAddressType=sMTPServerInternetAddressType, rxDiversityVlanTpid=rxDiversityVlanTpid, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, tFTPServerIPAddress=tFTPServerIPAddress, ptp800=ptp800, remotePrimaryInternetAddress=remotePrimaryInternetAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, protectionConfig=protectionConfig, aggregateDataRate=aggregateDataRate, userName=userName, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, ptmp=ptmp, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, systemClock=systemClock, numberOfAntennas=numberOfAntennas, ptp=ptp, alignmentMode=alignmentMode, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, syslogControl=syslogControl, iFCableLength=iFCableLength, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, userPassword=userPassword, sMTPServerInternetAddress=sMTPServerInternetAddress, maximumTransmitPower=maximumTransmitPower, rFUPlatformCompatibility=rFUPlatformCompatibility, sNMPEnabledTraps=sNMPEnabledTraps, transmitPower=transmitPower, phyStatus=phyStatus, timeZone=timeZone, rFUCableAlarm=rFUCableAlarm, managementPortForcedConfiguration=managementPortForcedConfiguration, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, ethernetPriorityTable=ethernetPriorityTable, rFURpsAlarm=rFURpsAlarm, remoteSecondaryIPAddress=remoteSecondaryIPAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, iPv4Address=iPv4Address, linkName=linkName, dataPortStatusTrap=dataPortStatusTrap, primarySecondaryMode=primarySecondaryMode, sNMPCommunityString=sNMPCommunityString, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFURxFreqMin=rFURxFreqMin, rxDiversityDataPortStatus=rxDiversityDataPortStatus, minModulation=minModulation, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, dataPortStatus=dataPortStatus, productName=productName, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, pubStats=pubStats, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sMTPServerIPAddress=sMTPServerIPAddress, secureModeAlarmTrap=secureModeAlarmTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveModulation=receiveModulation, remoteInternetAddress=remoteInternetAddress, protectionState=protectionState, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteMACAddress=remoteMACAddress, bridge=bridge, remotePrimaryIPAddress=remotePrimaryIPAddress, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, radioLicenseMaxEIRP=radioLicenseMaxEIRP, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, secondarySoftwareVersion=secondarySoftwareVersion, requestedProtectionState=requestedProtectionState, maxCodeRate=maxCodeRate, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPServerTableNumber=sNTPServerTableNumber, neighborIPAddress=neighborIPAddress, encryptionAlgorithm=encryptionAlgorithm, protectionSwitchCause=protectionSwitchCause, ethernetPriorityTableNumber=ethernetPriorityTableNumber, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, endId=endId, minCodeRate=minCodeRate, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, antennaGain=antennaGain, snmpControl=snmpControl, syslogClient=syslogClient, sNTPPrimaryServer=sNTPPrimaryServer, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", iPv6PrefixLength=iPv6PrefixLength, rFFeederLoss=rFFeederLoss, ptpTrapPrefix=ptpTrapPrefix, encryption=encryption, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, neighborInternetAddressType=neighborInternetAddressType, protectionStatus=protectionStatus, rFUStatus=rFUStatus, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, ethernetFiberSupport=ethernetFiberSupport, rFUType=rFUType, radioLicenseBandwidth=radioLicenseBandwidth, iPDSCPPriorityTable=iPDSCPPriorityTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, protectionConfigurationStatus=protectionConfigurationStatus, rFUVersionBank2=rFUVersionBank2, rFUConnectedPlatform=rFUConnectedPlatform, mPLSTCPriorityTable=mPLSTCPriorityTable, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, latitude=latitude, licence=licence, sNTPState=sNTPState, rFUPowerButtonPressed=rFUPowerButtonPressed, sNTPServerRetries=sNTPServerRetries, userTableIndex=userTableIndex, fiberY=fiberY, managementPortDisabledWarning=managementPortDisabledWarning, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, radioLicenseIdentifier=radioLicenseIdentifier, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, neighborMACAddress=neighborMACAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rFUTxPowerAlarm=rFUTxPowerAlarm, bootVersion=bootVersion, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, altitude=altitude, rFULockoutAlarm=rFULockoutAlarm, telnetAccessEnabled=telnetAccessEnabled, managementPortAutoNegotiation=managementPortAutoNegotiation, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, remotePrimaryMACAddress=remotePrimaryMACAddress, diverseAntennaGain=diverseAntennaGain, protectionInterfaceStatus=protectionInterfaceStatus, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpTraps=ptpTraps, rFUTxPowerMin=rFUTxPowerMin, longitude=longitude, management=management, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPSync=sNTPSync, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, rFUSerial=rFUSerial, linkNameMismatch=linkNameMismatch, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPServerPortNumber=sMTPServerPortNumber, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, diverseRfFeederLoss=diverseRfFeederLoss, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, radioLicenseModulation=radioLicenseModulation, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, smtp=smtp, linkNameMismatchTrap=linkNameMismatchTrap, radioLicenseBand=radioLicenseBand, softwareVersion=softwareVersion, protection=protection, sNTPServerIPAddress=sNTPServerIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, phyControl=phyControl, managementPortWirelessDownAlert=managementPortWirelessDownAlert, wirelessLinkStatus=wirelessLinkStatus, radioLicenseCodeRate=radioLicenseCodeRate, remotePrimarySecondaryMode=remotePrimarySecondaryMode, localPacketFiltering=localPacketFiltering, gatewayIPAddress=gatewayIPAddress, receiveDataRate=receiveDataRate, sNTPServerTable=sNTPServerTable, receivePower=receivePower, transmitModulation=transmitModulation, primaryRecoveryPeriod=primaryRecoveryPeriod)
