...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", ptpTraps=ptpTraps, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPState=sNTPState, hTTPSPortNumber=hTTPSPortNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, altitude=altitude, remotePrimarySecondaryMode=remotePrimarySecondaryMode, linkName=linkName, syslogState=syslogState, radioLicenseBand=radioLicenseBand, managementPortDisabledWarning=managementPortDisabledWarning, sMTPServerIPAddress=sMTPServerIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveCodeRate=receiveCodeRate, rFUStatusTrap=rFUStatusTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, remoteSecondaryIPAddress=remoteSecondaryIPAddress, dataPortStatusTrap=dataPortStatusTrap, transmitCodeRate=transmitCodeRate, secureModeAlarm=secureModeAlarm, supplementary=supplementary, diverseAntennaGain=diverseAntennaGain, remotePrimaryInternetAddress=remotePrimaryInternetAddress, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, radioLicenseRegion=radioLicenseRegion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetFiberSupport=ethernetFiberSupport, sNTPServerTableNumber=sNTPServerTableNumber, pubStats=pubStats, snmpControl=snmpControl, protectionStats=protectionStats, wirelessLinkAvailability=wirelessLinkAvailability, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, neighborMACAddress=neighborMACAddress, vLANManagementVIDValidation=vLANManagementVIDValidation, rFUBranchingConfiguration=rFUBranchingConfiguration, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, bootVersion=bootVersion, systemClock=systemClock, requestedProtectionState=requestedProtectionState, activeAvailableTime=activeAvailableTime, remoteMACAddress=remoteMACAddress, userTableEntry=userTableEntry, alarms=alarms, rFUPowerButtonPressed=rFUPowerButtonPressed, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, radioLicenseRxFreq=radioLicenseRxFreq, syslogClientTrap=syslogClientTrap, rFUConnectedPlatform=rFUConnectedPlatform, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, managementPortForcedConfiguration=managementPortForcedConfiguration, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, aggregateDataRate=aggregateDataRate, primaryRecovery=primaryRecovery, rFUTxPowerAlarm=rFUTxPowerAlarm, phyControl=phyControl, receivePower=receivePower, rFUTxFreqMin=rFUTxFreqMin, neighborInternetAddress=neighborInternetAddress, sNTPLastSync=sNTPLastSync, tFTPServerIPAddress=tFTPServerIPAddress, cambium=cambium, endId=endId, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, managementPortConfigurationMismatch=managementPortConfigurationMismatch, primaryRecoveryPeriod=primaryRecoveryPeriod, dSCPManagementPriority=dSCPManagementPriority, vLANManagementPriority=vLANManagementPriority, dataPortWirelessDownAlert=dataPortWirelessDownAlert, radioLicenseMaxModulation=radioLicenseMaxModulation, tFTPServerInternetAddressType=tFTPServerInternetAddressType, protectionStatus=protectionStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, transmitCapacity=transmitCapacity, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, licence=licence, rFUProtectionCompatibility=rFUProtectionCompatibility, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPTrapTableIndex=sNMPTrapTableIndex, rFUPlatformCompatibility=rFUPlatformCompatibility, transmitterStatus=transmitterStatus, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, managementMode=managementMode, telnetAccessEnabled=telnetAccessEnabled, sNTPServerTimeout=sNTPServerTimeout, diverseRfFeederLoss=diverseRfFeederLoss, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, fiberY=fiberY, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, radioLicenseBandwidth=radioLicenseBandwidth, vLANManagementVID=vLANManagementVID, secureModeAlarmTrap=secureModeAlarmTrap, rFULockoutAlarm=rFULockoutAlarm, antennaGain=antennaGain, mPLSTCPriorityTable=mPLSTCPriorityTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFUTxFreqMax=rFUTxFreqMax, userTableIndex=userTableIndex, receiveDataRate=receiveDataRate, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, aAAControl=aAAControl, productName=productName, rxDiversityDataPortStatus=rxDiversityDataPortStatus, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, managementPortStatus=managementPortStatus, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFURxFreqMin=rFURxFreqMin, dataPortPauseFrames=dataPortPauseFrames, rxDiversityVid=rxDiversityVid, sMTPServerInternetAddress=sMTPServerInternetAddress, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, minCodeRate=minCodeRate, rFUType=rFUType, protectionAvailabilityStatus=protectionAvailabilityStatus, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, securityLevel=securityLevel, wirelessLinkStatusTrap=wirelessLinkStatusTrap, userName=userName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortStatus=dataPortStatus, softwareVersion=softwareVersion, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, ethernetPriorityTableEntry=ethernetPriorityTableEntry, unitOutOfCalibration=unitOutOfCalibration, numberOfAntennas=numberOfAntennas, rFUSerial=rFUSerial, radioLicense=radioLicense, protectionInterfaceStatus=protectionInterfaceStatus, radioLicenseIdentifier=radioLicenseIdentifier, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, iPv4Address=iPv4Address, radioLicenseTxFreq=radioLicenseTxFreq, faultProtectionSwitching=faultProtectionSwitching, rFUVersionBank1=rFUVersionBank1, remotePrimaryIPAddress=remotePrimaryIPAddress, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, telnetPortNumber=telnetPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, sMTPServerPortNumber=sMTPServerPortNumber, longitude=longitude, primarySecondaryMode=primarySecondaryMode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapInternetAddress=sNMPTrapInternetAddress, secondarySoftwareVersion=secondarySoftwareVersion, iPDSCPPriorityTable=iPDSCPPriorityTable, iPv6GatewayAddress=iPv6GatewayAddress, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, radioLicenseCodeRate=radioLicenseCodeRate, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, iPv6PrefixLength=iPv6PrefixLength, maxModulation=maxModulation, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rFUPowerAlarm=rFUPowerAlarm, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, protectionSwitchCause=protectionSwitchCause, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, userTable=userTable, rFUVersionBank2=rFUVersionBank2, userTableNumber=userTableNumber, sNTPServerRetries=sNTPServerRetries, neighborIPAddress=neighborIPAddress, timeZone=timeZone, configuration=configuration, dataPortDisabledWarning=dataPortDisabledWarning, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rxDiversityVlanTpid=rxDiversityVlanTpid, sMTPEmailAlert=sMTPEmailAlert, minModulation=minModulation, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, gatewayIPAddress=gatewayIPAddress, transmitCapacityLimitDetail=transmitCapacityLimitDetail, smtp=smtp, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, iFCableLength=iFCableLength, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, phyStatus=phyStatus, aTPCEnable=aTPCEnable, rFUActiveFirmwareBank=rFUActiveFirmwareBank, transmitModulation=transmitModulation, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, protection=protection, protectionConfigurationStatus=protectionConfigurationStatus, enableTransmission=enableTransmission, remotePrimaryMACAddress=remotePrimaryMACAddress, bridge=bridge, ethernet=ethernet, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, encryptionEnabledMismatch=encryptionEnabledMismatch, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, managementPortAutoNegotiation=managementPortAutoNegotiation, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, latitude=latitude, radioLicenseModulation=radioLicenseModulation, reset=reset, userRole=userRole, radioLicenseMinCodeRate=radioLicenseMinCodeRate, linkNameMismatch=linkNameMismatch, rFUTxPowerMax=rFUTxPowerMax, siteName=siteName, linkNameMismatchTrap=linkNameMismatchTrap, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, maxCodeRate=maxCodeRate, userEnabled=userEnabled, sNTPSync=sNTPSync, sNMPCommunityString=sNMPCommunityString, rFUFreqSpacing=rFUFreqSpacing, versions=versions, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, qOSPriorityScheme=qOSPriorityScheme, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rFUTxPowerMin=rFUTxPowerMin, activeUnit=activeUnit, rFUTxMuteStatus=rFUTxMuteStatus, sNTPPollInterval=sNTPPollInterval, rFUCableAlarm=rFUCableAlarm, vectorError=vectorError, iPv6Address=iPv6Address, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, linkLoss=linkLoss, sNMPTrapTableEntry=sNMPTrapTableEntry, rFURfBand=rFURfBand, management=management, remoteIPAddress=remoteIPAddress, alignmentModeTrap=alignmentModeTrap, alignmentMode=alignmentMode, syslogControl=syslogControl, dataPortFiberStatusTrap=dataPortFiberStatusTrap, activeWirelessLinkAvailability=activeWirelessLinkAvailability, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapTable=sNMPTrapTable, neighborInternetAddressType=neighborInternetAddressType, l2CPPriorityTable=l2CPPriorityTable, sntp=sntp, rFUStatus=rFUStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, userPassword=userPassword, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, ethernetPriorityTable=ethernetPriorityTable, rFFeederLoss=rFFeederLoss, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPServerPortNumber=tFTPServerPortNumber, productVariant=productVariant, dataPortFiberStatus=dataPortFiberStatus, sNMPPortNumber=sNMPPortNumber, syslogStateTrap=syslogStateTrap, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, encryptionAlgorithm=encryptionAlgorithm, remoteSecondaryMACAddress=remoteSecondaryMACAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, hardwareVersion=hardwareVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteInternetAddressType=remoteInternetAddressType, rfu=rfu, rFURxFreqMax=rFURxFreqMax, sNTPServerTable=sNTPServerTable, rFUTxBandAboveRx=rFUTxBandAboveRx, sNMPTrapTableNumber=sNMPTrapTableNumber, protectionStateTrap=protectionStateTrap, transmitCapacityLimit=transmitCapacityLimit, sNTPServerTableIndex=sNTPServerTableIndex, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, remoteInternetAddress=remoteInternetAddress, protectionConfig=protectionConfig, wirelessLinkStatus=wirelessLinkStatus, systemReset=systemReset, hTTPSAccessEnabled=hTTPSAccessEnabled, encryption=encryption, receiveModulation=receiveModulation, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, sNTPServerResponse=sNTPServerResponse, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, rFURFSwitchAlarm=rFURFSwitchAlarm, rFURpsAlarm=rFURpsAlarm, maximumTransmitPower=maximumTransmitPower, managementPortStatusTrap=managementPortStatusTrap, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, sNTPServerPortNumber=sNTPServerPortNumber, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, protectionState=protectionState, sNMPEnabledTraps=sNMPEnabledTraps, rFUTransceiverLocation=rFUTransceiverLocation, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sNTPServerIPAddress=sNTPServerIPAddress, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, transmitPower=transmitPower, ptp=ptp, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, radioLicenseMinModulation=radioLicenseMinModulation, iPVersion=iPVersion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogClient=syslogClient, subnetMask=subnetMask, sNTPPrimaryServer=sNTPPrimaryServer, daylightSaving=daylightSaving, sNTPSyncTrap=sNTPSyncTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPTrapVersion=sNMPTrapVersion, ptmp=ptmp, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, hTTPPortNumber=hTTPPortNumber, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, localPacketFiltering=localPacketFiltering, transmitDataRate=transmitDataRate, ptp800=ptp800, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, managementCommittedInformationRate=managementCommittedInformationRate, sMTPEnabledMessages=sMTPEnabledMessages, sMTPSourceEmailAddress=sMTPSourceEmailAddress)
