...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", activeUnit=activeUnit, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, ethernetFiberSupport=ethernetFiberSupport, syslogStateTrap=syslogStateTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, remotePrimaryInternetAddress=remotePrimaryInternetAddress, unitOutOfCalibration=unitOutOfCalibration, linkName=linkName, protectionState=protectionState, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, rFUTxPowerMax=rFUTxPowerMax, securityLevel=securityLevel, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, diverseRfFeederLoss=diverseRfFeederLoss, smtp=smtp, l2CPPriorityTableNumber=l2CPPriorityTableNumber, protectionStateTrap=protectionStateTrap, sNTPServerRetries=sNTPServerRetries, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rFUConnectedPlatform=rFUConnectedPlatform, userTableNumber=userTableNumber, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPCommunityString=sNMPCommunityString, encryption=encryption, transmitCapacityLimit=transmitCapacityLimit, sNTPServerTimeout=sNTPServerTimeout, ptmp=ptmp, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, configuration=configuration, latitude=latitude, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, systemReset=systemReset, sNMPTrapInternetAddress=sNMPTrapInternetAddress, primarySecondaryMode=primarySecondaryMode, managementCommittedInformationRate=managementCommittedInformationRate, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rFUFreqSpacing=rFUFreqSpacing, wirelessLinkAvailability=wirelessLinkAvailability, qOSPriorityScheme=qOSPriorityScheme, enableTransmission=enableTransmission, rFUCableAlarm=rFUCableAlarm, radioLicenseRxFreq=radioLicenseRxFreq, radioLicenseBandwidth=radioLicenseBandwidth, linkNameMismatch=linkNameMismatch, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, receiveDataRate=receiveDataRate, sNTPServerPortNumber=sNTPServerPortNumber, rFUSerial=rFUSerial, maxModulation=maxModulation, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, activeAvailableTime=activeAvailableTime, tFTPServerInternetAddressType=tFTPServerInternetAddressType, vectorError=vectorError, timeZone=timeZone, bootVersion=bootVersion, sNTPSyncTrap=sNTPSyncTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, remoteMaximumTransmitPower=remoteMaximumTransmitPower, protectionStats=protectionStats, radioLicenseRegion=radioLicenseRegion, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, longitude=longitude, secureModeAlarmTrap=secureModeAlarmTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFUVersionBank2=rFUVersionBank2, syslogControl=syslogControl, dataPortFiberStatus=dataPortFiberStatus, protection=protection, sNTPServerResponse=sNTPServerResponse, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpTrapPrefix=ptpTrapPrefix, sNTPServerInternetAddressType=sNTPServerInternetAddressType, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, tFTPServerInternetAddress=tFTPServerInternetAddress, rFUPowerButtonPressed=rFUPowerButtonPressed, managementPortForcedConfiguration=managementPortForcedConfiguration, cambium=cambium, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rfu=rfu, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, rFULockoutAlarm=rFULockoutAlarm, protectionConfigurationStatus=protectionConfigurationStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarms=alarms, hardwareVersion=hardwareVersion, managementPortAutoNegotiation=managementPortAutoNegotiation, rFUTxMuteStatus=rFUTxMuteStatus, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, transmitModulation=transmitModulation, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, radioLicense=radioLicense, transmitCapacityLimitDetail=transmitCapacityLimitDetail, rxDiversityDataPortStatus=rxDiversityDataPortStatus, productVariant=productVariant, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, sNTPLastSync=sNTPLastSync, radioLicenseBand=radioLicenseBand, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, userTable=userTable, sNTPPollInterval=sNTPPollInterval, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFURxFreqMin=rFURxFreqMin, managementPortDisabledWarning=managementPortDisabledWarning, remoteIPAddress=remoteIPAddress, protectionInterfaceStatus=protectionInterfaceStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, userName=userName, alignmentMode=alignmentMode, rFURfBand=rFURfBand, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sNTPPrimaryServer=sNTPPrimaryServer, primaryRecovery=primaryRecovery, telnetAccessEnabled=telnetAccessEnabled, rFUPlatformCompatibility=rFUPlatformCompatibility, remoteMACAddress=remoteMACAddress, pubStats=pubStats, rFUBranchingConfiguration=rFUBranchingConfiguration, l2CPPriorityTable=l2CPPriorityTable, iPDSCPPriorityTable=iPDSCPPriorityTable, radioLicenseTxFreq=radioLicenseTxFreq, management=management, transmitCapacity=transmitCapacity, rFUTxBandAboveRx=rFUTxBandAboveRx, ethernet=ethernet, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, radioLicenseMinModulation=radioLicenseMinModulation, systemClock=systemClock, softwareVersion=softwareVersion, licence=licence, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userTableIndex=userTableIndex, remoteInternetAddressType=remoteInternetAddressType, neighborIPAddress=neighborIPAddress, maximumTransmitPower=maximumTransmitPower, rFUStatusTrap=rFUStatusTrap, vLANManagementPriority=vLANManagementPriority, dataPortStatus=dataPortStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPTrapTable=sNMPTrapTable, encryptionEnabledMismatch=encryptionEnabledMismatch, neighborInternetAddressType=neighborInternetAddressType, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, phyStatus=phyStatus, managementPortStatus=managementPortStatus, dataPortStatusTrap=dataPortStatusTrap, maxCodeRate=maxCodeRate, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rFUPowerAlarm=rFUPowerAlarm, sNMPTrapTableEntry=sNMPTrapTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, vLANManagementVID=vLANManagementVID, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, faultProtectionSwitching=faultProtectionSwitching, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rxDiversityVlanTpid=rxDiversityVlanTpid, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, protectionConfig=protectionConfig, subnetMask=subnetMask, sntp=sntp, rFURxFreqMax=rFURxFreqMax, syslogState=syslogState, linkLoss=linkLoss, sMTPEnabledMessages=sMTPEnabledMessages, hTTPAccessEnabled=hTTPAccessEnabled, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, neighborInternetAddress=neighborInternetAddress, dataPortPauseFrames=dataPortPauseFrames, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNTPServerIPAddress=sNTPServerIPAddress, activeWirelessLinkAvailability=activeWirelessLinkAvailability, iPv4Address=iPv4Address, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, minCodeRate=minCodeRate, hTTPPortNumber=hTTPPortNumber, remoteInternetAddress=remoteInternetAddress, remotePrimaryIPAddress=remotePrimaryIPAddress, minModulation=minModulation, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, sNMPTrapVersion=sNMPTrapVersion, telnetPortNumber=telnetPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, altitude=altitude, gatewayIPAddress=gatewayIPAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, neighborMACAddress=neighborMACAddress, sNMPPortNumber=sNMPPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, remoteSecondaryIPAddress=remoteSecondaryIPAddress, transmitterStatus=transmitterStatus, localPacketFiltering=localPacketFiltering, rFUTxPowerMin=rFUTxPowerMin, sNTPServerTableEntry=sNTPServerTableEntry, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, requestedProtectionState=requestedProtectionState, bridge=bridge, rFURFSwitchAlarm=rFURFSwitchAlarm, rFUTxPowerAlarm=rFUTxPowerAlarm, dataPortDisabledWarning=dataPortDisabledWarning, aAAControl=aAAControl, supplementary=supplementary, rFUVersionBank1=rFUVersionBank1, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFUStatus=rFUStatus, rxDiversityVid=rxDiversityVid, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, radioLicenseMinCodeRate=radioLicenseMinCodeRate, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, versions=versions, managementPortConfigurationMismatch=managementPortConfigurationMismatch, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, aggregateDataRate=aggregateDataRate, rFUTxFreqMin=rFUTxFreqMin, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rFUProtectionCompatibility=rFUProtectionCompatibility, tFTPServerIPAddress=tFTPServerIPAddress, daylightSaving=daylightSaving, syslogClientTrap=syslogClientTrap, remotePrimaryMACAddress=remotePrimaryMACAddress, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rFFeederLoss=rFFeederLoss, mPLSTCPriorityTable=mPLSTCPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, vLANManagementVIDValidation=vLANManagementVIDValidation, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, receiveModulation=receiveModulation, numberOfAntennas=numberOfAntennas, userRole=userRole, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogClient=syslogClient)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rFUTxFreqMax=rFUTxFreqMax, protectionSwitchCause=protectionSwitchCause, sMTPServerIPAddress=sMTPServerIPAddress, sMTPEmailAlert=sMTPEmailAlert, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, fiberY=fiberY, sNTPSync=sNTPSync, radioLicenseCodeRate=radioLicenseCodeRate, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, userEnabled=userEnabled, sMTPServerInternetAddressType=sMTPServerInternetAddressType, iPv6Address=iPv6Address, managementPortStatusTrap=managementPortStatusTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, hTTPSPortNumber=hTTPSPortNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUType=rFUType, transmitCodeRate=transmitCodeRate, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPEnabledTraps=sNMPEnabledTraps, transmitPower=transmitPower, radioLicenseModulation=radioLicenseModulation, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPServerTable=sNTPServerTable, snmpControl=snmpControl, iPv6GatewayAddress=iPv6GatewayAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, userPassword=userPassword, remoteSecondaryMACAddress=remoteSecondaryMACAddress, encryptionAlgorithm=encryptionAlgorithm, receiveCodeRate=receiveCodeRate, diverseAntennaGain=diverseAntennaGain, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPVersion=iPVersion, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, protectionStatus=protectionStatus, linkNameMismatchTrap=linkNameMismatchTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, siteName=siteName, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, ptp800=ptp800, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPServerTableNumber=sNTPServerTableNumber, receivePower=receivePower, sNTPServerTableIndex=sNTPServerTableIndex, dSCPManagementPriority=dSCPManagementPriority, antennaGain=antennaGain, phyControl=phyControl, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ptpTraps=ptpTraps, iFCableLength=iFCableLength, endId=endId, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, productName=productName, primaryRecoveryPeriod=primaryRecoveryPeriod, ethernetPriorityTableEntry=ethernetPriorityTableEntry, aTPCEnable=aTPCEnable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFURpsAlarm=rFURpsAlarm, ptp=ptp, reset=reset, radioLicenseMaxModulation=radioLicenseMaxModulation, userTableEntry=userTableEntry, ethernetPriorityTable=ethernetPriorityTable, sMTPServerInternetAddress=sMTPServerInternetAddress, managementMode=managementMode, sNMPTrapTableIndex=sNMPTrapTableIndex, rFUActiveFirmwareBank=rFUActiveFirmwareBank, iPv6PrefixLength=iPv6PrefixLength, wirelessLinkStatus=wirelessLinkStatus, protectionAvailabilityStatus=protectionAvailabilityStatus, secureModeAlarm=secureModeAlarm, sNTPState=sNTPState, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, transmitDataRate=transmitDataRate, rFUTransceiverLocation=rFUTransceiverLocation, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, radioLicenseIdentifier=radioLicenseIdentifier, alignmentModeTrap=alignmentModeTrap)
