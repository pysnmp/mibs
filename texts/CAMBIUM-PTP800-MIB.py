...
enterprises, Counter32, Gauge32, NotificationType, NotificationType, TimeTicks, iso, IpAddress, Unsigned32, Bits, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "Gauge32", "NotificationType", "NotificationType", "TimeTicks", "iso", "IpAddress", "Unsigned32", "Bits", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNTPState=sNTPState, rFUPlatformCompatibility=rFUPlatformCompatibility, transmitPower=transmitPower, minCodeRate=minCodeRate, userTableIndex=userTableIndex, iFCableLength=iFCableLength, managementPortAutoNegotiation=managementPortAutoNegotiation, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, managementMode=managementMode, linkName=linkName, securityLevel=securityLevel, neighborInternetAddress=neighborInternetAddress, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, userPassword=userPassword, linkNameMismatchTrap=linkNameMismatchTrap, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, timeZone=timeZone, systemReset=systemReset, maxCodeRate=maxCodeRate, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, aTPCEnable=aTPCEnable, activeAvailableTime=activeAvailableTime, managementPortWirelessDownAlert=managementPortWirelessDownAlert, fiberY=fiberY, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, versions=versions, radioLicenseBand=radioLicenseBand, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, secureModeAlarmTrap=secureModeAlarmTrap, rfu=rfu, rFUTxPowerAlarm=rFUTxPowerAlarm, managementPortConfigurationMismatch=managementPortConfigurationMismatch, hTTPSAccessEnabled=hTTPSAccessEnabled, rFURxFreqMin=rFURxFreqMin, rFUStatusTrap=rFUStatusTrap, hTTPSPortNumber=hTTPSPortNumber, managementPortStatus=managementPortStatus, sMTPEmailAlert=sMTPEmailAlert, linkNameMismatch=linkNameMismatch, radioLicenseMaxModulation=radioLicenseMaxModulation, ethernetPriorityTable=ethernetPriorityTable, wirelessLinkAvailability=wirelessLinkAvailability, rFURxFreqMax=rFURxFreqMax, sNTPPollInterval=sNTPPollInterval, iPDSCPPriorityTable=iPDSCPPriorityTable, protectionSwitchCause=protectionSwitchCause, dSCPManagementPriority=dSCPManagementPriority, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dataPortWirelessDownAlert=dataPortWirelessDownAlert, aAAControl=aAAControl, rxDiversityVid=rxDiversityVid, userRole=userRole, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, ptpTraps=ptpTraps, radioLicenseCodeRate=radioLicenseCodeRate, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, altitude=altitude, syslogControl=syslogControl, transmitCodeRate=transmitCodeRate, enableTransmission=enableTransmission, managementPortDisabledWarning=managementPortDisabledWarning, ptmp=ptmp, vLANManagementVIDValidation=vLANManagementVIDValidation, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, faultProtectionSwitching=faultProtectionSwitching, ptpTrapPrefix=ptpTrapPrefix, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rFUSerial=rFUSerial, rFUBranchingConfiguration=rFUBranchingConfiguration, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, radioLicenseMaxEIRP=radioLicenseMaxEIRP, radioLicenseBandwidth=radioLicenseBandwidth, sNMPTrapTableIndex=sNMPTrapTableIndex, bridge=bridge, radioLicenseTxFreq=radioLicenseTxFreq, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, sNTPServerInternetAddressType=sNTPServerInternetAddressType, activeWirelessLinkAvailability=activeWirelessLinkAvailability, receivePower=receivePower, managementPortStatusTrap=managementPortStatusTrap, userEnabled=userEnabled, transmitCapacityLimit=transmitCapacityLimit, rFUPowerButtonPressed=rFUPowerButtonPressed, aggregateDataRate=aggregateDataRate, transmitCapacity=transmitCapacity, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, primarySecondaryMode=primarySecondaryMode, requestedProtectionState=requestedProtectionState, iPv6PrefixLength=iPv6PrefixLength, managementCommittedInformationRate=managementCommittedInformationRate, sNTPPrimaryServer=sNTPPrimaryServer, siteName=siteName, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, ptp800=ptp800, rFUTxFreqMin=rFUTxFreqMin, remoteInternetAddressType=remoteInternetAddressType, userName=userName, secureModeAlarm=secureModeAlarm, transmitterStatus=transmitterStatus, rFUProtectionCompatibility=rFUProtectionCompatibility, cambium=cambium, ethernetPriorityTableNumber=ethernetPriorityTableNumber, hTTPAccessEnabled=hTTPAccessEnabled, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, localPacketFiltering=localPacketFiltering, ethernetFiberSupport=ethernetFiberSupport, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, reset=reset, remoteSecondaryIPAddress=remoteSecondaryIPAddress, alignmentModeTrap=alignmentModeTrap, configuration=configuration, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, endId=endId, diverseAntennaGain=diverseAntennaGain, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, primaryRecoveryPeriod=primaryRecoveryPeriod, tFTPServerIPAddress=tFTPServerIPAddress, protectionInterfaceStatus=protectionInterfaceStatus, secondarySoftwareVersion=secondarySoftwareVersion, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, vLANManagementVID=vLANManagementVID, alarms=alarms, remoteIPAddress=remoteIPAddress, rFUTxBandAboveRx=rFUTxBandAboveRx, sNTPServerTableNumber=sNTPServerTableNumber, rFUTxPowerMin=rFUTxPowerMin, userTableNumber=userTableNumber, rFUTransceiverLocation=rFUTransceiverLocation, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, sNTPSyncTrap=sNTPSyncTrap, dataPortPauseFrames=dataPortPauseFrames, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rFUActiveFirmwareBank=rFUActiveFirmwareBank, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, syslogStateTrap=syslogStateTrap, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, sMTPServerInternetAddressType=sMTPServerInternetAddressType, protectionState=protectionState, sntp=sntp, receiveCodeRate=receiveCodeRate, sNMPTrapTableNumber=sNMPTrapTableNumber, remotePrimarySecondaryMode=remotePrimarySecondaryMode, iPVersion=iPVersion, telnetAccessEnabled=telnetAccessEnabled, rxDiversityVlanTpid=rxDiversityVlanTpid, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkStatus=wirelessLinkStatus, supplementary=supplementary, rFUTxMuteStatus=rFUTxMuteStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, antennaGain=antennaGain, sNTPLastSync=sNTPLastSync, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, systemClock=systemClock, longitude=longitude, protectionAvailabilityStatus=protectionAvailabilityStatus, sNMPCommunityString=sNMPCommunityString, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPPortNumber=hTTPPortNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, subnetMask=subnetMask, latitude=latitude, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rFUType=rFUType, radioLicenseModulation=radioLicenseModulation, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyControl=phyControl, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, protectionStatus=protectionStatus, minModulation=minModulation, rFULockoutAlarm=rFULockoutAlarm, rFURFSwitchAlarm=rFURFSwitchAlarm, bootVersion=bootVersion, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, encryptionEnabledMismatch=encryptionEnabledMismatch, activeUnit=activeUnit, primaryRecovery=primaryRecovery, encryption=encryption, productName=productName, encryptionAlgorithm=encryptionAlgorithm, rFUVersionBank1=rFUVersionBank1, rFUTxFreqMax=rFUTxFreqMax, sNMPTrapTable=sNMPTrapTable, vLANManagementPriority=vLANManagementPriority, remotePrimaryInternetAddress=remotePrimaryInternetAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNMPEnabledTraps=sNMPEnabledTraps, productVariant=productVariant, linkLoss=linkLoss, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, diverseRfFeederLoss=diverseRfFeederLoss, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, dataPortDisabledWarning=dataPortDisabledWarning, radioLicenseIdentifier=radioLicenseIdentifier, rFUConnectedPlatform=rFUConnectedPlatform, sNTPSync=sNTPSync, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, hardwareVersion=hardwareVersion, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, syslogClientTrap=syslogClientTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, ethernet=ethernet, rFURfBand=rFURfBand, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, protectionStateTrap=protectionStateTrap, rxDiversityDataPortStatus=rxDiversityDataPortStatus, managementPortForcedConfiguration=managementPortForcedConfiguration, management=management, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, rFUCableAlarm=rFUCableAlarm, tFTPServerInternetAddress=tFTPServerInternetAddress, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, syslogClient=syslogClient, rFFeederLoss=rFFeederLoss, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rFURpsAlarm=rFURpsAlarm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFUFreqSpacing=rFUFreqSpacing, qOSPriorityScheme=qOSPriorityScheme, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rFUPowerAlarm=rFUPowerAlarm, alignmentMode=alignmentMode, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dataPortFiberStatus=dataPortFiberStatus, transmitCapacityLimitDetail=transmitCapacityLimitDetail, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, sNMPTrapVersion=sNMPTrapVersion, transmitDataRate=transmitDataRate, protectionStats=protectionStats, protectionConfigurationStatus=protectionConfigurationStatus, iPv6Address=iPv6Address)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", radioLicenseMinCodeRate=radioLicenseMinCodeRate, wirelessLinkStatusTrap=wirelessLinkStatusTrap, syslogState=syslogState, sNTPServerResponse=sNTPServerResponse, receiveModulation=receiveModulation, radioLicenseMinModulation=radioLicenseMinModulation, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, neighborIPAddress=neighborIPAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPv6GatewayAddress=iPv6GatewayAddress, unitOutOfCalibration=unitOutOfCalibration, rFUStatus=rFUStatus, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, gatewayIPAddress=gatewayIPAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, l2CPPriorityTable=l2CPPriorityTable, tFTPServerPortNumber=tFTPServerPortNumber, pubStats=pubStats, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, ptp=ptp, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licence=licence, userTable=userTable, sNTPServerRetries=sNTPServerRetries, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, remotePrimaryMACAddress=remotePrimaryMACAddress, remoteMACAddress=remoteMACAddress, remoteInternetAddress=remoteInternetAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, neighborInternetAddressType=neighborInternetAddressType, snmpControl=snmpControl, maxModulation=maxModulation, sNMPTrapTableEntry=sNMPTrapTableEntry, daylightSaving=daylightSaving, numberOfAntennas=numberOfAntennas, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber, smtp=smtp, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPServerPortNumber=sNTPServerPortNumber, sNTPServerTableIndex=sNTPServerTableIndex, receiveDataRate=receiveDataRate, softwareVersion=softwareVersion, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPPortNumber=sNMPPortNumber, radioLicense=radioLicense, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPServerTableEntry=sNTPServerTableEntry, remoteSecondaryMACAddress=remoteSecondaryMACAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, phyStatus=phyStatus, radioLicenseRxFreq=radioLicenseRxFreq, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, sNTPServerTimeout=sNTPServerTimeout, rFUTxPowerMax=rFUTxPowerMax, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, sNTPServerIPAddress=sNTPServerIPAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, protection=protection, dataPortStatusTrap=dataPortStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, telnetPortNumber=telnetPortNumber, radioLicenseRegion=radioLicenseRegion, iPv4Address=iPv4Address, dataPortFiberStatusTrap=dataPortFiberStatusTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortStatus=dataPortStatus, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, sNTPServerTable=sNTPServerTable, protectionConfig=protectionConfig, rFUVersionBank2=rFUVersionBank2, remotePrimaryIPAddress=remotePrimaryIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, neighborMACAddress=neighborMACAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, userTableEntry=userTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitModulation=transmitModulation, vectorError=vectorError, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, sMTPServerIPAddress=sMTPServerIPAddress)
