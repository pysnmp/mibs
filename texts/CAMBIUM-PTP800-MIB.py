...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, sNTPPrimaryServer=sNTPPrimaryServer, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, encryptionEnabledMismatch=encryptionEnabledMismatch, transmitCapacityLimit=transmitCapacityLimit, userName=userName, rFUSerial=rFUSerial, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPSyncTrap=sNTPSyncTrap, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFUConnectedPlatform=rFUConnectedPlatform, tFTPServerIPAddress=tFTPServerIPAddress, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, numberOfAntennas=numberOfAntennas, wirelessLinkAvailability=wirelessLinkAvailability, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitCodeRate=transmitCodeRate, endId=endId, radioLicense=radioLicense, sNTPServerTableNumber=sNTPServerTableNumber, systemClock=systemClock, ptmp=ptmp, radioLicenseBand=radioLicenseBand, radioLicenseBandwidth=radioLicenseBandwidth, syslogStateTrap=syslogStateTrap, productName=productName, dataPortFiberStatusTrap=dataPortFiberStatusTrap, antennaGain=antennaGain, sNMPTrapTableNumber=sNMPTrapTableNumber, systemReset=systemReset, tFTPServerInternetAddress=tFTPServerInternetAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPSync=sNTPSync, ptpTraps=ptpTraps, ethernetPriorityTable=ethernetPriorityTable, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFUStatus=rFUStatus, rFUTxPowerAlarm=rFUTxPowerAlarm, sNTPServerRetries=sNTPServerRetries, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, enableTransmission=enableTransmission, sNTPState=sNTPState, dataPortPauseFrames=dataPortPauseFrames, syslogClientTrap=syslogClientTrap, telnetPortNumber=telnetPortNumber, radioLicenseMinModulation=radioLicenseMinModulation, activeWirelessLinkAvailability=activeWirelessLinkAvailability, managementPortForcedConfiguration=managementPortForcedConfiguration, activeUnit=activeUnit, vectorError=vectorError, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, faultProtectionSwitching=faultProtectionSwitching, wirelessLinkStatus=wirelessLinkStatus, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, telnetAccessEnabled=telnetAccessEnabled, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, bootVersion=bootVersion, ethernetPriorityTableIndex=ethernetPriorityTableIndex, receivePower=receivePower, versions=versions, tFTPServerInternetAddressType=tFTPServerInternetAddressType, neighborInternetAddress=neighborInternetAddress, rFURfBand=rFURfBand, sMTPServerPortNumber=sMTPServerPortNumber, syslogState=syslogState, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, softwareVersion=softwareVersion, sNTPLastSync=sNTPLastSync, linkNameMismatchTrap=linkNameMismatchTrap, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, managementPortStatusTrap=managementPortStatusTrap, radioLicenseModulation=radioLicenseModulation, dataPortStatusTrap=dataPortStatusTrap, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, protectionInterfaceStatus=protectionInterfaceStatus, sNTPPollInterval=sNTPPollInterval, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, linkLoss=linkLoss, sNTPServerInternetAddress=sNTPServerInternetAddress, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rxDiversityVlanTpid=rxDiversityVlanTpid, sntp=sntp, sNTPServerIPAddress=sNTPServerIPAddress, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, rFUBranchingConfiguration=rFUBranchingConfiguration, iPv4Address=iPv4Address, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, managementMode=managementMode, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveModulation=receiveModulation, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rFULockoutAlarm=rFULockoutAlarm, configuration=configuration, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hTTPPortNumber=hTTPPortNumber, userTableEntry=userTableEntry, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, cambium=cambium, rFUFreqSpacing=rFUFreqSpacing, rFUPlatformCompatibility=rFUPlatformCompatibility, iPv6Address=iPv6Address, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, localPacketFiltering=localPacketFiltering, rFUActiveFirmwareBank=rFUActiveFirmwareBank, protectionStateTrap=protectionStateTrap, latitude=latitude, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, rFUVersionBank2=rFUVersionBank2, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, hardwareVersion=hardwareVersion, syslogControl=syslogControl, sMTPSourceEmailAddress=sMTPSourceEmailAddress, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, rxDiversityDataPortStatus=rxDiversityDataPortStatus, protectionConfig=protectionConfig, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, phyControl=phyControl, ethernetPriorityTableEntry=ethernetPriorityTableEntry, remotePrimarySecondaryMode=remotePrimarySecondaryMode, requestedProtectionState=requestedProtectionState, secureModeAlarmTrap=secureModeAlarmTrap, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, sNTPServerTableIndex=sNTPServerTableIndex, remotePrimaryMACAddress=remotePrimaryMACAddress, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, linkNameMismatch=linkNameMismatch, encryptionAlgorithm=encryptionAlgorithm, sMTPServerIPAddress=sMTPServerIPAddress, rFUVersionBank1=rFUVersionBank1, radioLicenseMaxEIRP=radioLicenseMaxEIRP, rFUCableAlarm=rFUCableAlarm, licence=licence, sNMPEnabledTraps=sNMPEnabledTraps, wirelessLinkStatusTrap=wirelessLinkStatusTrap, smtp=smtp, rFUType=rFUType, sNMPPortNumber=sNMPPortNumber, rFUTxPowerMin=rFUTxPowerMin, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, rFUTransceiverLocation=rFUTransceiverLocation, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, userTableNumber=userTableNumber, vLANManagementPriority=vLANManagementPriority, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, protection=protection, gatewayIPAddress=gatewayIPAddress, userEnabled=userEnabled, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapVersion=sNMPTrapVersion, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, remoteIPAddress=remoteIPAddress, remotePrimaryInternetAddress=remotePrimaryInternetAddress, bridge=bridge, protectionState=protectionState, maximumTransmitPower=maximumTransmitPower, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, diverseAntennaGain=diverseAntennaGain, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPCommunityString=sNMPCommunityString, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, vLANManagementVID=vLANManagementVID, radioLicenseIdentifier=radioLicenseIdentifier, timeZone=timeZone, protectionStatus=protectionStatus, radioLicenseRegion=radioLicenseRegion, remoteInternetAddress=remoteInternetAddress, managementPortAutoNegotiation=managementPortAutoNegotiation, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFURxFreqMin=rFURxFreqMin, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, alarms=alarms, fiberY=fiberY, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, secondarySoftwareVersion=secondarySoftwareVersion, maxCodeRate=maxCodeRate, sNTPServerTable=sNTPServerTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitCapacityLimitDetail=transmitCapacityLimitDetail, ethernet=ethernet, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, qOSPriorityScheme=qOSPriorityScheme, ptpTrapPrefix=ptpTrapPrefix, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPServerTimeout=sNTPServerTimeout, altitude=altitude, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, managementPortConfigurationMismatch=managementPortConfigurationMismatch, diverseRfFeederLoss=diverseRfFeederLoss, rFUTxMuteStatus=rFUTxMuteStatus, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, dSCPManagementPriority=dSCPManagementPriority, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, transmitModulation=transmitModulation, userRole=userRole, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hTTPSPortNumber=hTTPSPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, syslogClient=syslogClient, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPServerPortNumber=sNTPServerPortNumber, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFUTxBandAboveRx=rFUTxBandAboveRx, subnetMask=subnetMask, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rFUStatusTrap=rFUStatusTrap, remotePrimaryIPAddress=remotePrimaryIPAddress, rFURxFreqMax=rFURxFreqMax, radioLicenseCodeRate=radioLicenseCodeRate, aAAControl=aAAControl, rfu=rfu, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortStatus=dataPortStatus, longitude=longitude, vLANManagementVIDValidation=vLANManagementVIDValidation, rFURFSwitchAlarm=rFURFSwitchAlarm, l2CPPriorityTable=l2CPPriorityTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ptp=ptp, ptp800=ptp800, neighborMACAddress=neighborMACAddress, iPVersion=iPVersion, productVariant=productVariant, rFUTxPowerMax=rFUTxPowerMax, userTableIndex=userTableIndex, daylightSaving=daylightSaving, sMTPEmailAlert=sMTPEmailAlert, remoteMACAddress=remoteMACAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetFiberSupport=ethernetFiberSupport, radioLicenseRxFreq=radioLicenseRxFreq, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dataPortFiberStatus=dataPortFiberStatus, hTTPAccessEnabled=hTTPAccessEnabled, rFUTxFreqMax=rFUTxFreqMax, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNTPServerResponse=sNTPServerResponse, transmitDataRate=transmitDataRate, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, radioLicenseTxFreq=radioLicenseTxFreq, snmpControl=snmpControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, protectionConfigurationStatus=protectionConfigurationStatus, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, userTable=userTable, management=management, useVLANForManagementInterfaces=useVLANForManagementInterfaces, protectionStats=protectionStats, linkName=linkName, activeAvailableTime=activeAvailableTime, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteInternetAddressType=remoteInternetAddressType, iPv6PrefixLength=iPv6PrefixLength, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rxDiversityVid=rxDiversityVid, minModulation=minModulation, encryption=encryption, phyStatus=phyStatus, receiveCodeRate=receiveCodeRate, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFUProtectionCompatibility=rFUProtectionCompatibility, remoteSecondaryIPAddress=remoteSecondaryIPAddress, userPassword=userPassword, managementCommittedInformationRate=managementCommittedInformationRate, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, alignmentModeTrap=alignmentModeTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, protectionSwitchCause=protectionSwitchCause, primaryRecoveryPeriod=primaryRecoveryPeriod, rFUPowerAlarm=rFUPowerAlarm, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, maxModulation=maxModulation, transmitPower=transmitPower, iPv6GatewayAddress=iPv6GatewayAddress, managementPortStatus=managementPortStatus, transmitterStatus=transmitterStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPServerPortNumber=tFTPServerPortNumber, alignmentMode=alignmentMode, rFURpsAlarm=rFURpsAlarm, rFUTxFreqMin=rFUTxFreqMin, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dataPortDisabledWarning=dataPortDisabledWarning, aggregateDataRate=aggregateDataRate, radioLicenseMaxModulation=radioLicenseMaxModulation, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFUPowerButtonPressed=rFUPowerButtonPressed, transmitCapacity=transmitCapacity, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, securityLevel=securityLevel, minCodeRate=minCodeRate, rFFeederLoss=rFFeederLoss, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, receiveDataRate=receiveDataRate, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, aTPCEnable=aTPCEnable, l2CPPriorityTableEntry=l2CPPriorityTableEntry, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, iFCableLength=iFCableLength, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, supplementary=supplementary, primarySecondaryMode=primarySecondaryMode, mPLSTCPriorityTable=mPLSTCPriorityTable, reset=reset, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, sNTPServerInternetAddressType=sNTPServerInternetAddressType, pubStats=pubStats, managementPortDisabledWarning=managementPortDisabledWarning, primaryRecovery=primaryRecovery, radioLicenseMinCodeRate=radioLicenseMinCodeRate, siteName=siteName, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, secureModeAlarm=secureModeAlarm, sNMPTrapTable=sNMPTrapTable, neighborIPAddress=neighborIPAddress, protectionAvailabilityStatus=protectionAvailabilityStatus, neighborInternetAddressType=neighborInternetAddressType, dataPortWirelessDownAlert=dataPortWirelessDownAlert)
