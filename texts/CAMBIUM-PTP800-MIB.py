...
Counter64, Integer32, NotificationType, Gauge32, IpAddress, ObjectIdentity, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, ModuleIdentity, Counter32, Bits, MibIdentifier, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "NotificationType", "Gauge32", "IpAddress", "ObjectIdentity", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "ModuleIdentity", "Counter32", "Bits", "MibIdentifier", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", ethernet=ethernet, userRole=userRole, sNMPPortNumber=sNMPPortNumber, securityLevel=securityLevel, remoteInternetAddressType=remoteInternetAddressType, fiberY=fiberY, unitOutOfCalibration=unitOutOfCalibration, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, protectionConfigurationStatus=protectionConfigurationStatus, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, ptp=ptp, managementPortStatusTrap=managementPortStatusTrap, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, sNTPSync=sNTPSync, bridge=bridge, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, licence=licence, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveCodeRate=receiveCodeRate, vectorError=vectorError, radioLicenseMinCodeRate=radioLicenseMinCodeRate, qOSPriorityScheme=qOSPriorityScheme, remotePrimaryIPAddress=remotePrimaryIPAddress, rxDiversityVlanTpid=rxDiversityVlanTpid, transmitCodeRate=transmitCodeRate, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, remoteInternetAddress=remoteInternetAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, secondarySoftwareVersion=secondarySoftwareVersion, ptpTrapPrefix=ptpTrapPrefix, managementCommittedInformationRate=managementCommittedInformationRate, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, neighborIPAddress=neighborIPAddress, antennaGain=antennaGain, remoteMaximumTransmitPower=remoteMaximumTransmitPower, phyControl=phyControl, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, iFCableLength=iFCableLength, userPassword=userPassword, neighborInternetAddressType=neighborInternetAddressType, vLANManagementPriority=vLANManagementPriority, iPv4Address=iPv4Address, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPPrimaryServer=sNTPPrimaryServer, radioLicense=radioLicense, rFUTxMuteStatus=rFUTxMuteStatus, dataPortStatusTrap=dataPortStatusTrap, requestedProtectionState=requestedProtectionState, radioLicenseIdentifier=radioLicenseIdentifier, userEnabled=userEnabled, wirelessLinkStatus=wirelessLinkStatus, activeUnit=activeUnit, sMTPServerInternetAddress=sMTPServerInternetAddress, dataPortFiberStatus=dataPortFiberStatus, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, rxDiversityVid=rxDiversityVid, linkNameMismatch=linkNameMismatch, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetFiberSupport=ethernetFiberSupport, sntp=sntp, sNMPTrapTableNumber=sNMPTrapTableNumber, rFURpsAlarm=rFURpsAlarm, smtp=smtp, rfu=rfu, sNTPServerResponse=sNTPServerResponse, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, productName=productName, versions=versions, remoteSecondaryMACAddress=remoteSecondaryMACAddress, secureModeAlarm=secureModeAlarm, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, timeZone=timeZone, ethernetPriorityTableNumber=ethernetPriorityTableNumber, primarySecondaryMode=primarySecondaryMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transmitCapacityLimitDetail=transmitCapacityLimitDetail, transmitDataRate=transmitDataRate, rFURFSwitchAlarm=rFURFSwitchAlarm, sMTPServerPortNumber=sMTPServerPortNumber, secureModeAlarmTrap=secureModeAlarmTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, sMTPServerIPAddress=sMTPServerIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, radioLicenseBandwidth=radioLicenseBandwidth, dataPortFiberStatusTrap=dataPortFiberStatusTrap, faultProtectionSwitching=faultProtectionSwitching, rFUStatus=rFUStatus, rFULockoutAlarm=rFULockoutAlarm, numberOfAntennas=numberOfAntennas, transmitCapacity=transmitCapacity, rFUTxBandAboveRx=rFUTxBandAboveRx, sNTPServerPortNumber=sNTPServerPortNumber, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, syslogState=syslogState, transmitCapacityLimit=transmitCapacityLimit, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, vLANManagementVID=vLANManagementVID, supplementary=supplementary, sMTPSourceEmailAddress=sMTPSourceEmailAddress, gatewayIPAddress=gatewayIPAddress, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, hTTPPortNumber=hTTPPortNumber, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetPriorityTable=ethernetPriorityTable, alignmentModeTrap=alignmentModeTrap, aTPCEnable=aTPCEnable, rFUType=rFUType, productVariant=productVariant, userName=userName, rFURxFreqMin=rFURxFreqMin, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPServerIPAddress=sNTPServerIPAddress, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, dataPortStatus=dataPortStatus, rFUCableAlarm=rFUCableAlarm, tFTPServerInternetAddressType=tFTPServerInternetAddressType, primaryRecovery=primaryRecovery, phyStatus=phyStatus, primaryRecoveryPeriod=primaryRecoveryPeriod, snmpControl=snmpControl, diverseAntennaGain=diverseAntennaGain, hTTPAccessEnabled=hTTPAccessEnabled, enableTransmission=enableTransmission, sNMPCommunityString=sNMPCommunityString, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, rFUTxFreqMin=rFUTxFreqMin, siteName=siteName, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, neighborInternetAddress=neighborInternetAddress, minCodeRate=minCodeRate, receivePower=receivePower, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, protectionAvailabilityStatus=protectionAvailabilityStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, transmitterStatus=transmitterStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, l2CPPriorityTable=l2CPPriorityTable, rFURxFreqMax=rFURxFreqMax, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rFUTransceiverLocation=rFUTransceiverLocation, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, longitude=longitude, radioLicenseBand=radioLicenseBand, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, cambium=cambium, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, pubStats=pubStats, maxCodeRate=maxCodeRate, radioLicenseTxFreq=radioLicenseTxFreq, reset=reset, radioLicenseMinModulation=radioLicenseMinModulation, dSCPManagementPriority=dSCPManagementPriority, softwareVersion=softwareVersion, minModulation=minModulation, sNTPServerTimeout=sNTPServerTimeout, rFUFreqSpacing=rFUFreqSpacing, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, syslogClientTrap=syslogClientTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, hTTPSPortNumber=hTTPSPortNumber, receiveModulation=receiveModulation, rFUPowerButtonPressed=rFUPowerButtonPressed, linkName=linkName, remotePrimarySecondaryMode=remotePrimarySecondaryMode, managementPortAutoNegotiation=managementPortAutoNegotiation, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, iPv6PrefixLength=iPv6PrefixLength, sNTPServerTable=sNTPServerTable, rFUSerial=rFUSerial, userTableEntry=userTableEntry, ptp800=ptp800, sNMPTrapTable=sNMPTrapTable, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, radioLicenseRegion=radioLicenseRegion, systemReset=systemReset, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userTableNumber=userTableNumber, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, syslogControl=syslogControl, sNMPEnabledTraps=sNMPEnabledTraps, daylightSaving=daylightSaving, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, maximumTransmitPower=maximumTransmitPower, rFUActiveFirmwareBank=rFUActiveFirmwareBank, hTTPSAccessEnabled=hTTPSAccessEnabled, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, protectionState=protectionState, receiveDataRate=receiveDataRate, remotePrimaryInternetAddress=remotePrimaryInternetAddress, sNTPServerTableEntry=sNTPServerTableEntry, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sNTPLastSync=sNTPLastSync, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, dataPortDisabledWarning=dataPortDisabledWarning, rFUBranchingConfiguration=rFUBranchingConfiguration, iPv6GatewayAddress=iPv6GatewayAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ptmp=ptmp, remoteSecondaryIPAddress=remoteSecondaryIPAddress, managementPortStatus=managementPortStatus, protectionStats=protectionStats, neighborMACAddress=neighborMACAddress, ptpTraps=ptpTraps, managementPortDisabledWarning=managementPortDisabledWarning, sNTPServerTableIndex=sNTPServerTableIndex, rFUPowerAlarm=rFUPowerAlarm, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitModulation=transmitModulation, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, subnetMask=subnetMask, rFUTxPowerAlarm=rFUTxPowerAlarm, radioLicenseModulation=radioLicenseModulation, userTableIndex=userTableIndex, sNTPServerRetries=sNTPServerRetries, systemClock=systemClock, localPacketFiltering=localPacketFiltering, telnetPortNumber=telnetPortNumber, protectionStatus=protectionStatus, configuration=configuration, protectionSwitchCause=protectionSwitchCause, sNTPSyncTrap=sNTPSyncTrap, rFUVersionBank2=rFUVersionBank2, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, encryption=encryption, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerInternetAddressType=sNTPServerInternetAddressType)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFFeederLoss=rFFeederLoss, alignmentMode=alignmentMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, iPDSCPPriorityTable=iPDSCPPriorityTable, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, management=management, rFUVersionBank1=rFUVersionBank1, linkNameMismatchTrap=linkNameMismatchTrap, vLANManagementVIDValidation=vLANManagementVIDValidation, protectionInterfaceStatus=protectionInterfaceStatus, radioLicenseMaxEIRP=radioLicenseMaxEIRP, rFUTxFreqMax=rFUTxFreqMax, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, encryptionAlgorithm=encryptionAlgorithm, rFUStatusTrap=rFUStatusTrap, rFUProtectionCompatibility=rFUProtectionCompatibility, sNTPState=sNTPState, managementMode=managementMode, remotePrimaryMACAddress=remotePrimaryMACAddress, bootVersion=bootVersion, radioLicenseRxFreq=radioLicenseRxFreq, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, syslogStateTrap=syslogStateTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPv6Address=iPv6Address, maxModulation=maxModulation, encryptionEnabledMismatch=encryptionEnabledMismatch, aggregateDataRate=aggregateDataRate, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, alarms=alarms, sNMPTrapInternetAddress=sNMPTrapInternetAddress, transmitPower=transmitPower, syslogClient=syslogClient, rFUTxPowerMin=rFUTxPowerMin, iPVersion=iPVersion, sNTPPollInterval=sNTPPollInterval, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPServerInternetAddress=sNTPServerInternetAddress, wirelessLinkAvailability=wirelessLinkAvailability, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, activeAvailableTime=activeAvailableTime, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, remoteIPAddress=remoteIPAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rFUPlatformCompatibility=rFUPlatformCompatibility, sMTPEmailAlert=sMTPEmailAlert, sNTPServerTableNumber=sNTPServerTableNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, protectionConfig=protectionConfig, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remoteMACAddress=remoteMACAddress, protection=protection, rFUTxPowerMax=rFUTxPowerMax, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, radioLicenseCodeRate=radioLicenseCodeRate, hardwareVersion=hardwareVersion, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, linkLoss=linkLoss, userTable=userTable, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, protectionStateTrap=protectionStateTrap, radioLicenseMaxModulation=radioLicenseMaxModulation, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, altitude=altitude, dataPortPauseFrames=dataPortPauseFrames, activeWirelessLinkAvailability=activeWirelessLinkAvailability, telnetAccessEnabled=telnetAccessEnabled, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, latitude=latitude, rFUConnectedPlatform=rFUConnectedPlatform, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, endId=endId, managementPortConfigurationMismatch=managementPortConfigurationMismatch, managementPortForcedConfiguration=managementPortForcedConfiguration, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPTrapIPAddress=sNMPTrapIPAddress, diverseRfFeederLoss=diverseRfFeederLoss, aAAControl=aAAControl, sNMPTrapTableEntry=sNMPTrapTableEntry, rFURfBand=rFURfBand, tFTPServerPortNumber=tFTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress)
