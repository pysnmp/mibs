...
IpAddress, NotificationType, NotificationType, TimeTicks, Counter64, enterprises, Counter32, Gauge32, MibIdentifier, Integer32, Bits, ModuleIdentity, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "NotificationType", "TimeTicks", "Counter64", "enterprises", "Counter32", "Gauge32", "MibIdentifier", "Integer32", "Bits", "ModuleIdentity", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rFFeederLoss=rFFeederLoss, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, sNMPEnabledTraps=sNMPEnabledTraps, sMTPSourceEmailAddress=sMTPSourceEmailAddress, securityLevel=securityLevel, syslogClientTrap=syslogClientTrap, secureModeAlarm=secureModeAlarm, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, vectorError=vectorError, rFUTxFreqMin=rFUTxFreqMin, radioLicenseMaxEIRP=radioLicenseMaxEIRP, hTTPSPortNumber=hTTPSPortNumber, sNTPLastSync=sNTPLastSync, radioLicenseTxFreq=radioLicenseTxFreq, linkName=linkName, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, transmitCodeRate=transmitCodeRate, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rxDiversityVlanTpid=rxDiversityVlanTpid, sNTPServerIPAddress=sNTPServerIPAddress, smtp=smtp, rFUVersionBank1=rFUVersionBank1, faultProtectionSwitching=faultProtectionSwitching, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, bootVersion=bootVersion, managementPortConfigurationMismatch=managementPortConfigurationMismatch, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, systemClock=systemClock, rFURfBand=rFURfBand, rFURFSwitchAlarm=rFURFSwitchAlarm, rFURpsAlarm=rFURpsAlarm, remotePrimaryInternetAddress=remotePrimaryInternetAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, radioLicense=radioLicense, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, radioLicenseCodeRate=radioLicenseCodeRate, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFURxFreqMax=rFURxFreqMax, telnetAccessEnabled=telnetAccessEnabled, managementPortAutoNegotiation=managementPortAutoNegotiation, managementPortForcedConfiguration=managementPortForcedConfiguration, rFUStatusTrap=rFUStatusTrap, rFUTxMuteStatus=rFUTxMuteStatus, encryption=encryption, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, managementMode=managementMode, configuration=configuration, dataPortDisabledWarning=dataPortDisabledWarning, protectionStateTrap=protectionStateTrap, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUPowerButtonPressed=rFUPowerButtonPressed, remoteSecondaryMACAddress=remoteSecondaryMACAddress, minCodeRate=minCodeRate, sNTPServerPortNumber=sNTPServerPortNumber, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, rFUTransceiverLocation=rFUTransceiverLocation, rFUConnectedPlatform=rFUConnectedPlatform, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerResponse=sNTPServerResponse, iPDSCPPriorityTable=iPDSCPPriorityTable, wirelessLinkStatusTrap=wirelessLinkStatusTrap, remotePrimaryIPAddress=remotePrimaryIPAddress, maximumTransmitPower=maximumTransmitPower, alignmentModeTrap=alignmentModeTrap, sNTPServerRetries=sNTPServerRetries, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitCapacityLimitDetail=transmitCapacityLimitDetail, l2CPPriorityTableIndex=l2CPPriorityTableIndex, linkNameMismatch=linkNameMismatch, useVLANForManagementInterfaces=useVLANForManagementInterfaces, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, gatewayIPAddress=gatewayIPAddress, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, userTableIndex=userTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rFUTxPowerAlarm=rFUTxPowerAlarm, subnetMask=subnetMask, wirelessLinkStatus=wirelessLinkStatus, managementPortStatusTrap=managementPortStatusTrap, ptp800=ptp800, phyStatus=phyStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, siteName=siteName, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPServerTimeout=sNTPServerTimeout, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, productVariant=productVariant, userRole=userRole, ptpTraps=ptpTraps, hardwareVersion=hardwareVersion, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, protectionInterfaceStatus=protectionInterfaceStatus, encryptionEnabledMismatch=encryptionEnabledMismatch, syslogLocalWrappedTrap=syslogLocalWrappedTrap, vLANManagementVID=vLANManagementVID, hTTPPortNumber=hTTPPortNumber, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rFUTxPowerMin=rFUTxPowerMin, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapIPAddress=sNMPTrapIPAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dataPortStatusTrap=dataPortStatusTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ptpTrapPrefix=ptpTrapPrefix, sNTPSync=sNTPSync, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityTable=l2CPPriorityTable, sntp=sntp, linkLoss=linkLoss, sNTPServerTableNumber=sNTPServerTableNumber, snmpControl=snmpControl, syslogControl=syslogControl, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, hTTPAccessEnabled=hTTPAccessEnabled, radioLicenseModulation=radioLicenseModulation, unitOutOfCalibration=unitOutOfCalibration, diverseRfFeederLoss=diverseRfFeederLoss, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, userName=userName, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUTxFreqMax=rFUTxFreqMax, ethernetFiberSupport=ethernetFiberSupport, managementPortStatus=managementPortStatus, transmitCapacity=transmitCapacity, managementPortDisabledWarning=managementPortDisabledWarning, rxDiversityVid=rxDiversityVid, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, iPv6GatewayAddress=iPv6GatewayAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, enableTransmission=enableTransmission, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dataPortFiberStatusTrap=dataPortFiberStatusTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, protectionConfig=protectionConfig, rFULockoutAlarm=rFULockoutAlarm, transmitterStatus=transmitterStatus, rFURxFreqMin=rFURxFreqMin, rFUSerial=rFUSerial, qOSPriorityScheme=qOSPriorityScheme, receiveCodeRate=receiveCodeRate, transmitModulation=transmitModulation, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, neighborMACAddress=neighborMACAddress, tFTPServerIPAddress=tFTPServerIPAddress, userTableNumber=userTableNumber, latitude=latitude, radioLicenseMaxModulation=radioLicenseMaxModulation, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPPortNumber=sNMPPortNumber, ptp=ptp, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, secondarySoftwareVersion=secondarySoftwareVersion, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, transmitCapacityLimit=transmitCapacityLimit, remoteInternetAddressType=remoteInternetAddressType, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, bridge=bridge, sNTPServerTableIndex=sNTPServerTableIndex, rFUTxPowerMax=rFUTxPowerMax, iPVersion=iPVersion, radioLicenseRegion=radioLicenseRegion, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, protectionState=protectionState, sMTPEmailAlert=sMTPEmailAlert, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogStateTrap=syslogStateTrap, primaryRecoveryPeriod=primaryRecoveryPeriod, supplementary=supplementary, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, dataPortFiberStatus=dataPortFiberStatus, fiberY=fiberY, longitude=longitude, sNMPTrapInternetAddress=sNMPTrapInternetAddress, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, antennaGain=antennaGain, sNTPPollInterval=sNTPPollInterval, localPacketFiltering=localPacketFiltering, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, remoteMaximumTransmitPower=remoteMaximumTransmitPower, numberOfAntennas=numberOfAntennas, ethernet=ethernet, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, sNMPCommunityString=sNMPCommunityString, daylightSaving=daylightSaving, remoteInternetAddress=remoteInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, primaryRecovery=primaryRecovery, primarySecondaryMode=primarySecondaryMode, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sNTPPrimaryServer=sNTPPrimaryServer, requestedProtectionState=requestedProtectionState, encryptionAlgorithm=encryptionAlgorithm, maxCodeRate=maxCodeRate, sNMPTrapTableIndex=sNMPTrapTableIndex, rFUCableAlarm=rFUCableAlarm, rFUActiveFirmwareBank=rFUActiveFirmwareBank, systemReset=systemReset, sNTPServerTableEntry=sNTPServerTableEntry, minModulation=minModulation, telnetPortNumber=telnetPortNumber, remoteSecondaryIPAddress=remoteSecondaryIPAddress, vLANManagementPriority=vLANManagementPriority, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, radioLicenseIdentifier=radioLicenseIdentifier, rFUType=rFUType, rFUPlatformCompatibility=rFUPlatformCompatibility, licence=licence, rFUFreqSpacing=rFUFreqSpacing, protectionAvailabilityStatus=protectionAvailabilityStatus, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, remotePrimaryMACAddress=remotePrimaryMACAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetPriorityTable=ethernetPriorityTable, reset=reset, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, syslogState=syslogState, wirelessLinkAvailability=wirelessLinkAvailability, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementPortWirelessDownAlert=managementPortWirelessDownAlert, cambium=cambium, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, radioLicenseMinCodeRate=radioLicenseMinCodeRate, remoteMACAddress=remoteMACAddress, diverseAntennaGain=diverseAntennaGain, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, linkNameMismatchTrap=linkNameMismatchTrap, management=management, radioLicenseMinModulation=radioLicenseMinModulation)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", activeAvailableTime=activeAvailableTime, neighborIPAddress=neighborIPAddress, rFUBranchingConfiguration=rFUBranchingConfiguration, iPv6PrefixLength=iPv6PrefixLength, dataPortPauseFrames=dataPortPauseFrames, rFUVersionBank2=rFUVersionBank2, radioLicenseRxFreq=radioLicenseRxFreq, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, vLANManagementVIDValidation=vLANManagementVIDValidation, sNMPTrapVersion=sNMPTrapVersion, sNTPState=sNTPState, sMTPEnabledMessages=sMTPEnabledMessages, rxDiversityDataPortStatus=rxDiversityDataPortStatus, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, altitude=altitude, managementCommittedInformationRate=managementCommittedInformationRate, iPv6Address=iPv6Address, sMTPServerIPAddress=sMTPServerIPAddress, softwareVersion=softwareVersion, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, productName=productName, receiveModulation=receiveModulation, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rFUStatus=rFUStatus, syslogClient=syslogClient, alarms=alarms, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, userEnabled=userEnabled, remoteIPAddress=remoteIPAddress, sNTPSyncTrap=sNTPSyncTrap, protectionStats=protectionStats, aAAControl=aAAControl, alignmentMode=alignmentMode, tFTPServerPortNumber=tFTPServerPortNumber, aggregateDataRate=aggregateDataRate, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPTrapTable=sNMPTrapTable, rFUTxBandAboveRx=rFUTxBandAboveRx, protectionSwitchCause=protectionSwitchCause, ethernetPriorityTableIndex=ethernetPriorityTableIndex, maxModulation=maxModulation, sNTPServerTable=sNTPServerTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, activeWirelessLinkAvailability=activeWirelessLinkAvailability, endId=endId, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, userTableEntry=userTableEntry, ptmp=ptmp, userPassword=userPassword, protectionConfigurationStatus=protectionConfigurationStatus, dataPortStatus=dataPortStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, activeUnit=activeUnit, radioLicenseBand=radioLicenseBand, neighborInternetAddress=neighborInternetAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, neighborInternetAddressType=neighborInternetAddressType, rFUPowerAlarm=rFUPowerAlarm, timeZone=timeZone, versions=versions, iPv4Address=iPv4Address, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rFUProtectionCompatibility=rFUProtectionCompatibility, pubStats=pubStats, userTable=userTable, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, transmitDataRate=transmitDataRate, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transmitPower=transmitPower, sMTPServerInternetAddress=sMTPServerInternetAddress, receivePower=receivePower, protection=protection, aTPCEnable=aTPCEnable, sNMPTrapPortNumber=sNMPTrapPortNumber, radioLicenseBandwidth=radioLicenseBandwidth, dataPortWirelessDownAlert=dataPortWirelessDownAlert, phyControl=phyControl, sMTPServerInternetAddressType=sMTPServerInternetAddressType, receiveDataRate=receiveDataRate, iFCableLength=iFCableLength, protectionStatus=protectionStatus, rfu=rfu, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, dataPortConfigurationMismatch=dataPortConfigurationMismatch)
