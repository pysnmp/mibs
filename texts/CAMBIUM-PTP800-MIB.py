...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", managementPortStatus=managementPortStatus, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, minCodeRate=minCodeRate, radioLicenseMinCodeRate=radioLicenseMinCodeRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitDataRate=transmitDataRate, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, rFURfBand=rFURfBand, sNTPPrimaryServer=sNTPPrimaryServer, faultProtectionSwitching=faultProtectionSwitching, phyControl=phyControl, protectionSwitchCause=protectionSwitchCause, wirelessLinkStatus=wirelessLinkStatus, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, configuration=configuration, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, radioLicenseCodeRate=radioLicenseCodeRate, telnetAccessEnabled=telnetAccessEnabled, sMTPEnabledMessages=sMTPEnabledMessages, radioLicenseRxFreq=radioLicenseRxFreq, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, protectionStats=protectionStats, sNTPLastSync=sNTPLastSync, sNTPServerTable=sNTPServerTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, numberOfAntennas=numberOfAntennas, sNMPTrapVersion=sNMPTrapVersion, managementPortWirelessDownAlert=managementPortWirelessDownAlert, bridge=bridge, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPSyncTrap=sNTPSyncTrap, licence=licence, iPv6GatewayAddress=iPv6GatewayAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, protection=protection, reset=reset, remotePrimaryMACAddress=remotePrimaryMACAddress, sNMPCommunityString=sNMPCommunityString, rFUPowerAlarm=rFUPowerAlarm, hTTPPortNumber=hTTPPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, radioLicenseMinModulation=radioLicenseMinModulation, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, unitOutOfCalibration=unitOutOfCalibration, rFUVersionBank2=rFUVersionBank2, maxCodeRate=maxCodeRate, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPVersion=iPVersion, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFURFSwitchAlarm=rFURFSwitchAlarm, linkNameMismatchTrap=linkNameMismatchTrap, sNTPState=sNTPState, rFUBranchingConfiguration=rFUBranchingConfiguration, dataPortPauseFrames=dataPortPauseFrames, versions=versions, remoteSecondaryIPAddress=remoteSecondaryIPAddress, maxModulation=maxModulation, minModulation=minModulation, productVariant=productVariant, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, radioLicenseIdentifier=radioLicenseIdentifier, sMTPEmailAlert=sMTPEmailAlert, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, transmitterStatus=transmitterStatus, enableTransmission=enableTransmission, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, managementCommittedInformationRate=managementCommittedInformationRate, rFUPowerButtonPressed=rFUPowerButtonPressed, receivePower=receivePower, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rFUTxPowerMax=rFUTxPowerMax, radioLicenseMaxEIRP=radioLicenseMaxEIRP, rFUFreqSpacing=rFUFreqSpacing, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, userRole=userRole, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, primaryRecovery=primaryRecovery, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, dataPortFiberStatus=dataPortFiberStatus, rxDiversityVid=rxDiversityVid, rFUConnectedPlatform=rFUConnectedPlatform, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, ptmp=ptmp, requestedProtectionState=requestedProtectionState, phyStatus=phyStatus, antennaGain=antennaGain, tFTPServerIPAddress=tFTPServerIPAddress, rFUCableAlarm=rFUCableAlarm, hardwareVersion=hardwareVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rFURpsAlarm=rFURpsAlarm, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, neighborIPAddress=neighborIPAddress, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, latitude=latitude, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, alarms=alarms, aAAControl=aAAControl, radioLicenseModulation=radioLicenseModulation, activeWirelessLinkAvailability=activeWirelessLinkAvailability, longitude=longitude, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, pubStats=pubStats, dataPortWirelessDownAlert=dataPortWirelessDownAlert, iFCableLength=iFCableLength, neighborMACAddress=neighborMACAddress, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, transmitCapacity=transmitCapacity, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveCodeRate=receiveCodeRate, protectionInterfaceStatus=protectionInterfaceStatus, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, rFUTxFreqMin=rFUTxFreqMin, iPDSCPPriorityTable=iPDSCPPriorityTable, rfu=rfu, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, transmitCapacityLimitDetail=transmitCapacityLimitDetail, remotePrimaryIPAddress=remotePrimaryIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementPortDisabledWarning=managementPortDisabledWarning, syslogStateTrap=syslogStateTrap, productName=productName, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, receiveDataRate=receiveDataRate, rFUStatusTrap=rFUStatusTrap, wirelessLinkAvailability=wirelessLinkAvailability, secureModeAlarmTrap=secureModeAlarmTrap, sNTPServerTimeout=sNTPServerTimeout, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, sNTPServerInternetAddress=sNTPServerInternetAddress, primarySecondaryMode=primarySecondaryMode, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, ptpTraps=ptpTraps, snmpControl=snmpControl, syslogControl=syslogControl, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, userEnabled=userEnabled, sNMPEnabledTraps=sNMPEnabledTraps, secondarySoftwareVersion=secondarySoftwareVersion, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, rFUType=rFUType, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, transmitModulation=transmitModulation, rxDiversityVlanTpid=rxDiversityVlanTpid, ethernetPriorityTable=ethernetPriorityTable, aTPCEnable=aTPCEnable, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, managementMode=managementMode, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, bootVersion=bootVersion, sMTPServerIPAddress=sMTPServerIPAddress, diverseAntennaGain=diverseAntennaGain, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, ethernet=ethernet, sNMPTrapIPAddress=sNMPTrapIPAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sMTPServerInternetAddress=sMTPServerInternetAddress, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerInternetAddressType=sNTPServerInternetAddressType, diverseRfFeederLoss=diverseRfFeederLoss, management=management, transmitPower=transmitPower, tFTPServerInternetAddressType=tFTPServerInternetAddressType, radioLicenseRegion=radioLicenseRegion, sNTPServerTableNumber=sNTPServerTableNumber, gatewayIPAddress=gatewayIPAddress, radioLicenseBand=radioLicenseBand, ptp=ptp, remoteSecondaryMACAddress=remoteSecondaryMACAddress, protectionStatus=protectionStatus, managementPortStatusTrap=managementPortStatusTrap, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, syslogState=syslogState, sNTPServerTableIndex=sNTPServerTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userTable=userTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, iPv4Address=iPv4Address, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, protectionConfigurationStatus=protectionConfigurationStatus, iPv6PrefixLength=iPv6PrefixLength, vLANManagementPriority=vLANManagementPriority, protectionStateTrap=protectionStateTrap, remotePrimaryInternetAddress=remotePrimaryInternetAddress, userName=userName, rFULockoutAlarm=rFULockoutAlarm, dataPortStatusTrap=dataPortStatusTrap, remoteInternetAddressType=remoteInternetAddressType, rFUPlatformCompatibility=rFUPlatformCompatibility, userTableEntry=userTableEntry, subnetMask=subnetMask, wirelessLinkStatusTrap=wirelessLinkStatusTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, hTTPSPortNumber=hTTPSPortNumber, alignmentModeTrap=alignmentModeTrap, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, cambium=cambium, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, radioLicenseBandwidth=radioLicenseBandwidth, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPServerTableEntry=sNTPServerTableEntry, encryptionAlgorithm=encryptionAlgorithm, secureModeAlarm=secureModeAlarm, linkLoss=linkLoss, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, sntp=sntp, vLANManagementVIDValidation=vLANManagementVIDValidation, remoteInternetAddress=remoteInternetAddress, syslogClientTrap=syslogClientTrap, radioLicenseMaxModulation=radioLicenseMaxModulation, securityLevel=securityLevel, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, daylightSaving=daylightSaving, sNTPServerRetries=sNTPServerRetries, endId=endId, alignmentMode=alignmentMode, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, neighborInternetAddress=neighborInternetAddress, remoteMACAddress=remoteMACAddress, rFUActiveFirmwareBank=rFUActiveFirmwareBank, radioLicenseTxFreq=radioLicenseTxFreq, syslogClient=syslogClient, rFFeederLoss=rFFeederLoss, localPacketFiltering=localPacketFiltering, rFURxFreqMax=rFURxFreqMax, transmitCapacityLimit=transmitCapacityLimit, l2CPPriorityTable=l2CPPriorityTable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rFUTxFreqMax=rFUTxFreqMax, rFUTxPowerMin=rFUTxPowerMin, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPPortNumber=sNMPPortNumber, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, encryptionEnabledMismatch=encryptionEnabledMismatch, rFUTxBandAboveRx=rFUTxBandAboveRx, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerIPAddress=sNTPServerIPAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, protectionConfig=protectionConfig, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, managementPortAutoNegotiation=managementPortAutoNegotiation, radioLicense=radioLicense, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sMTPServerPortNumber=sMTPServerPortNumber, siteName=siteName, iPv6Address=iPv6Address, rFUStatus=rFUStatus, softwareVersion=softwareVersion, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, remoteIPAddress=remoteIPAddress, altitude=altitude, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, sNMPTrapTable=sNMPTrapTable, vLANManagementVID=vLANManagementVID, fiberY=fiberY, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, managementPortForcedConfiguration=managementPortForcedConfiguration, ethernetPriorityTableIndex=ethernetPriorityTableIndex, activeUnit=activeUnit, timeZone=timeZone, linkNameMismatch=linkNameMismatch, maximumTransmitPower=maximumTransmitPower, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, neighborInternetAddressType=neighborInternetAddressType, systemClock=systemClock, rFUVersionBank1=rFUVersionBank1, protectionState=protectionState, sNTPServerResponse=sNTPServerResponse, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, smtp=smtp, sNTPPollInterval=sNTPPollInterval, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, userTableNumber=userTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rFUTxMuteStatus=rFUTxMuteStatus, activeAvailableTime=activeAvailableTime, receiveModulation=receiveModulation, userPassword=userPassword, sNTPSync=sNTPSync, userTableIndex=userTableIndex, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dataPortStatus=dataPortStatus, supplementary=supplementary, primaryRecoveryPeriod=primaryRecoveryPeriod, ptp800=ptp800, aggregateDataRate=aggregateDataRate, rFUSerial=rFUSerial, ethernetPriorityTableEntry=ethernetPriorityTableEntry, encryption=encryption, systemReset=systemReset, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mPLSTCPriorityTable=mPLSTCPriorityTable, rFURxFreqMin=rFURxFreqMin, rFUProtectionCompatibility=rFUProtectionCompatibility, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerPortNumber=sNTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernetFiberSupport=ethernetFiberSupport, qOSPriorityScheme=qOSPriorityScheme, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, ptpTrapPrefix=ptpTrapPrefix, protectionAvailabilityStatus=protectionAvailabilityStatus, telnetPortNumber=telnetPortNumber, rFUTransceiverLocation=rFUTransceiverLocation, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitCodeRate=transmitCodeRate, rFUTxPowerAlarm=rFUTxPowerAlarm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, vectorError=vectorError, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remotePrimarySecondaryMode=remotePrimarySecondaryMode, hTTPAccessEnabled=hTTPAccessEnabled, linkName=linkName, dSCPManagementPriority=dSCPManagementPriority)
