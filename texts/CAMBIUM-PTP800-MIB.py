...
MibIdentifier, Unsigned32, enterprises, TimeTicks, IpAddress, Bits, ModuleIdentity, Integer32, Counter64, Counter32, NotificationType, ObjectIdentity, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Unsigned32", "enterprises", "TimeTicks", "IpAddress", "Bits", "ModuleIdentity", "Integer32", "Counter64", "Counter32", "NotificationType", "ObjectIdentity", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", numberOfAntennas=numberOfAntennas, hTTPAccessEnabled=hTTPAccessEnabled, ethernetPriorityTableIndex=ethernetPriorityTableIndex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, management=management, sNTPServerTableEntry=sNTPServerTableEntry, sNTPPollInterval=sNTPPollInterval, userName=userName, protectionStatus=protectionStatus, managementPortForcedConfiguration=managementPortForcedConfiguration, antennaGain=antennaGain, remoteInternetAddress=remoteInternetAddress, remoteSecondaryMACAddress=remoteSecondaryMACAddress, configuration=configuration, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, secureModeAlarmTrap=secureModeAlarmTrap, userTableNumber=userTableNumber, rFUPowerAlarm=rFUPowerAlarm, sNTPSync=sNTPSync, sNTPServerTableNumber=sNTPServerTableNumber, radioLicenseIdentifier=radioLicenseIdentifier, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, iPv4Address=iPv4Address, radioLicenseBandwidth=radioLicenseBandwidth, rFUTxBandAboveRx=rFUTxBandAboveRx, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, iPDSCPPriorityTable=iPDSCPPriorityTable, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rFUStatusTrap=rFUStatusTrap, remotePrimaryInternetAddress=remotePrimaryInternetAddress, transmitDataRate=transmitDataRate, radioLicenseTxFreq=radioLicenseTxFreq, sMTPServerInternetAddressType=sMTPServerInternetAddressType, subnetMask=subnetMask, neighborInternetAddress=neighborInternetAddress, dataPortStatusTrap=dataPortStatusTrap, phyControl=phyControl, encryptionEnabledMismatch=encryptionEnabledMismatch, siteName=siteName, rFURfBand=rFURfBand, altitude=altitude, iPv6GatewayAddress=iPv6GatewayAddress, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, sNMPTrapPortNumber=sNMPTrapPortNumber, alignmentMode=alignmentMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptp=ptp, sNMPCommunityString=sNMPCommunityString, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, sNTPServerResponse=sNTPServerResponse, rFUBranchingConfiguration=rFUBranchingConfiguration, phyStatus=phyStatus, tFTPServerPortNumber=tFTPServerPortNumber, dataPortPauseFrames=dataPortPauseFrames, sNMPTrapTable=sNMPTrapTable, radioLicenseCodeRate=radioLicenseCodeRate, linkNameMismatchTrap=linkNameMismatchTrap, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, alignmentModeTrap=alignmentModeTrap, sNTPState=sNTPState, systemClock=systemClock, sMTPServerPortNumber=sMTPServerPortNumber, rFUVersionBank1=rFUVersionBank1, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, maxCodeRate=maxCodeRate, radioLicenseMinModulation=radioLicenseMinModulation, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, managementCommittedInformationRate=managementCommittedInformationRate, sMTPServerInternetAddress=sMTPServerInternetAddress, rFUConnectedPlatform=rFUConnectedPlatform, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, protection=protection, telnetPortNumber=telnetPortNumber, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, encryption=encryption, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, securityLevel=securityLevel, sNMPTrapTableEntry=sNMPTrapTableEntry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rFUStatus=rFUStatus, ptpTrapPrefix=ptpTrapPrefix, managementPortAutoNegotiation=managementPortAutoNegotiation, rFUFreqSpacing=rFUFreqSpacing, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rxDiversityVid=rxDiversityVid, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, neighborMACAddress=neighborMACAddress, protectionAvailabilityStatus=protectionAvailabilityStatus, protectionStats=protectionStats, vLANManagementVIDValidation=vLANManagementVIDValidation, sNMPEnabledTraps=sNMPEnabledTraps, rxDiversityVlanTpid=rxDiversityVlanTpid, productName=productName, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, dataPortStatus=dataPortStatus, syslogStateTrap=syslogStateTrap, neighborIPAddress=neighborIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, transmitCodeRate=transmitCodeRate, rFFeederLoss=rFFeederLoss, linkName=linkName, qOSPriorityScheme=qOSPriorityScheme, licence=licence, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, supplementary=supplementary, vectorError=vectorError, reset=reset, rFUTxFreqMin=rFUTxFreqMin, vLANManagementVID=vLANManagementVID, encryptionAlgorithm=encryptionAlgorithm, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, endId=endId, rFUTxFreqMax=rFUTxFreqMax, userEnabled=userEnabled, unitOutOfCalibration=unitOutOfCalibration, hTTPSAccessEnabled=hTTPSAccessEnabled, iPVersion=iPVersion, userRole=userRole, rFUTransceiverLocation=rFUTransceiverLocation, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPServerRetries=sNTPServerRetries, receiveModulation=receiveModulation, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dSCPManagementPriority=dSCPManagementPriority, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, diverseRfFeederLoss=diverseRfFeederLoss, radioLicenseMaxEIRP=radioLicenseMaxEIRP, sNTPServerTableIndex=sNTPServerTableIndex, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, sMTPEmailAlert=sMTPEmailAlert, managementPortStatusTrap=managementPortStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sntp=sntp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userPassword=userPassword, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, iPv6PrefixLength=iPv6PrefixLength, cambium=cambium, transmitCapacityLimit=transmitCapacityLimit, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptpTraps=ptpTraps, ethernetPriorityTable=ethernetPriorityTable, vLANManagementPriority=vLANManagementPriority, minCodeRate=minCodeRate, l2CPPriorityTable=l2CPPriorityTable, fiberY=fiberY, radioLicenseRegion=radioLicenseRegion, syslogClient=syslogClient, primarySecondaryMode=primarySecondaryMode, aTPCEnable=aTPCEnable, receivePower=receivePower, rFUTxMuteStatus=rFUTxMuteStatus, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, radioLicenseMaxModulation=radioLicenseMaxModulation, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ethernetPriorityTableEntry=ethernetPriorityTableEntry, productVariant=productVariant, dataPortFiberStatus=dataPortFiberStatus, rFULockoutAlarm=rFULockoutAlarm, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, systemReset=systemReset, activeUnit=activeUnit, pubStats=pubStats, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, transmitCapacity=transmitCapacity, rFUProtectionCompatibility=rFUProtectionCompatibility, bootVersion=bootVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, radioLicenseBand=radioLicenseBand, rFUTxPowerMax=rFUTxPowerMax, wirelessLinkAvailability=wirelessLinkAvailability, tFTPServerIPAddress=tFTPServerIPAddress, ethernet=ethernet, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, latitude=latitude, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, diverseAntennaGain=diverseAntennaGain, dataPortFiberStatusTrap=dataPortFiberStatusTrap, hTTPSPortNumber=hTTPSPortNumber, smtp=smtp, neighborInternetAddressType=neighborInternetAddressType, transmitPower=transmitPower, rFUPlatformCompatibility=rFUPlatformCompatibility, remoteMACAddress=remoteMACAddress, remotePrimaryIPAddress=remotePrimaryIPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hardwareVersion=hardwareVersion, iPv6Address=iPv6Address, remotePrimaryMACAddress=remotePrimaryMACAddress, secureModeAlarm=secureModeAlarm, receiveCodeRate=receiveCodeRate, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, userTableIndex=userTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, remotePrimarySecondaryMode=remotePrimarySecondaryMode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sMTPEnabledMessages=sMTPEnabledMessages, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, sNTPServerIPAddress=sNTPServerIPAddress, primaryRecovery=primaryRecovery, sNMPTrapTableIndex=sNMPTrapTableIndex, protectionState=protectionState, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, sNTPSyncTrap=sNTPSyncTrap, sNTPServerPortNumber=sNTPServerPortNumber, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, radioLicenseRxFreq=radioLicenseRxFreq, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerTable=sNTPServerTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerInternetAddress=sNTPServerInternetAddress, rFURpsAlarm=rFURpsAlarm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telnetAccessEnabled=telnetAccessEnabled, activeAvailableTime=activeAvailableTime, transmitterStatus=transmitterStatus, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, versions=versions, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, maximumTransmitPower=maximumTransmitPower, managementMode=managementMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogClientTrap=syslogClientTrap, faultProtectionSwitching=faultProtectionSwitching, l2CPPriorityTableIndex=l2CPPriorityTableIndex, userTableEntry=userTableEntry, rFUTxPowerAlarm=rFUTxPowerAlarm, localPacketFiltering=localPacketFiltering, transmitModulation=transmitModulation, sMTPServerIPAddress=sMTPServerIPAddress, protectionStateTrap=protectionStateTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", linkNameMismatch=linkNameMismatch, minModulation=minModulation, snmpControl=snmpControl, remoteSecondaryIPAddress=remoteSecondaryIPAddress, rFUCableAlarm=rFUCableAlarm, sNTPServerTimeout=sNTPServerTimeout, rFURFSwitchAlarm=rFURFSwitchAlarm, rfu=rfu, sNTPPrimaryServer=sNTPPrimaryServer, timeZone=timeZone, gatewayIPAddress=gatewayIPAddress, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rFURxFreqMax=rFURxFreqMax, hTTPPortNumber=hTTPPortNumber, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, maxModulation=maxModulation, managementPortDisabledWarning=managementPortDisabledWarning, protectionInterfaceStatus=protectionInterfaceStatus, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, ethernetFiberSupport=ethernetFiberSupport, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, primaryRecoveryPeriod=primaryRecoveryPeriod, daylightSaving=daylightSaving, wirelessLinkStatusTrap=wirelessLinkStatusTrap, sNMPPortNumber=sNMPPortNumber, aAAControl=aAAControl, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rFURxFreqMin=rFURxFreqMin, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkLoss=linkLoss, ptmp=ptmp, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, sNTPLastSync=sNTPLastSync, rFUActiveFirmwareBank=rFUActiveFirmwareBank, protectionConfigurationStatus=protectionConfigurationStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, wirelessLinkStatus=wirelessLinkStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, syslogState=syslogState, rFUTxPowerMin=rFUTxPowerMin, sNMPTrapInternetAddress=sNMPTrapInternetAddress, userTable=userTable, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, managementPortConfigurationMismatch=managementPortConfigurationMismatch, protectionConfig=protectionConfig, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, alarms=alarms, iFCableLength=iFCableLength, dataPortDisabledWarning=dataPortDisabledWarning, softwareVersion=softwareVersion, rFUPowerButtonPressed=rFUPowerButtonPressed, protectionSwitchCause=protectionSwitchCause, rFUSerial=rFUSerial, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteMaximumTransmitPower=remoteMaximumTransmitPower, remoteInternetAddressType=remoteInternetAddressType, syslogControl=syslogControl, bridge=bridge, receiveDataRate=receiveDataRate, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rFUVersionBank2=rFUVersionBank2, enableTransmission=enableTransmission, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPTrapIPAddress=sNMPTrapIPAddress, requestedProtectionState=requestedProtectionState, l2CPPriorityTableNumber=l2CPPriorityTableNumber, aggregateDataRate=aggregateDataRate, ptp800=ptp800, radioLicense=radioLicense, transmitCapacityLimitDetail=transmitCapacityLimitDetail, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, remoteIPAddress=remoteIPAddress, longitude=longitude, radioLicenseModulation=radioLicenseModulation, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rFUType=rFUType, sNMPTrapVersion=sNMPTrapVersion, managementPortStatus=managementPortStatus)
