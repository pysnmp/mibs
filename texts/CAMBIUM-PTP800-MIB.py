...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", remotePrimaryMACAddress=remotePrimaryMACAddress, userName=userName, sMTPEnabledMessages=sMTPEnabledMessages, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, remoteMACAddress=remoteMACAddress, tFTPServerIPAddress=tFTPServerIPAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNMPEnabledTraps=sNMPEnabledTraps, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, reset=reset, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, smtp=smtp, l2CPPriorityTableIndex=l2CPPriorityTableIndex, telnetAccessEnabled=telnetAccessEnabled, maximumTransmitPower=maximumTransmitPower, iPDSCPPriorityTable=iPDSCPPriorityTable, radioLicenseMaxModulation=radioLicenseMaxModulation, rFUTxPowerMax=rFUTxPowerMax, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, dataPortStatusTrap=dataPortStatusTrap, softwareVersion=softwareVersion, wirelessLinkStatus=wirelessLinkStatus, sNTPServerTableEntry=sNTPServerTableEntry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, aAAControl=aAAControl, ethernetPriorityTableNumber=ethernetPriorityTableNumber, licence=licence, transmitModulation=transmitModulation, supplementary=supplementary, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, endId=endId, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, radioLicense=radioLicense, wirelessLinkAvailability=wirelessLinkAvailability, syslogClientTrap=syslogClientTrap, protectionStatus=protectionStatus, transmitCapacity=transmitCapacity, sNTPServerIPAddress=sNTPServerIPAddress, radioLicenseRxFreq=radioLicenseRxFreq, linkLoss=linkLoss, ethernetPriorityTable=ethernetPriorityTable, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rFUVersionBank2=rFUVersionBank2, primarySecondaryMode=primarySecondaryMode, sMTPServerIPAddress=sMTPServerIPAddress, versions=versions, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, sNTPPollInterval=sNTPPollInterval, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, dataPortPauseFrames=dataPortPauseFrames, managementPortStatus=managementPortStatus, remotePrimarySecondaryMode=remotePrimarySecondaryMode, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rFUCableAlarm=rFUCableAlarm, neighborMACAddress=neighborMACAddress, telnetPortNumber=telnetPortNumber, protectionConfig=protectionConfig, hTTPSPortNumber=hTTPSPortNumber, bootVersion=bootVersion, latitude=latitude, rFUStatus=rFUStatus, radioLicenseModulation=radioLicenseModulation, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rFUTxMuteStatus=rFUTxMuteStatus, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, unitOutOfCalibration=unitOutOfCalibration, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFUStatusTrap=rFUStatusTrap, remoteIPAddress=remoteIPAddress, longitude=longitude, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, vLANManagementPriority=vLANManagementPriority, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, phyStatus=phyStatus, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, userTableEntry=userTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, remoteInternetAddress=remoteInternetAddress, rFUPlatformCompatibility=rFUPlatformCompatibility, sNTPPrimaryServer=sNTPPrimaryServer, userTableIndex=userTableIndex, managementPortStatusTrap=managementPortStatusTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, diverseAntennaGain=diverseAntennaGain, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, phyControl=phyControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vLANManagementVID=vLANManagementVID, rFURxFreqMin=rFURxFreqMin, tFTPServerInternetAddress=tFTPServerInternetAddress, rFULockoutAlarm=rFULockoutAlarm, subnetMask=subnetMask, protectionInterfaceStatus=protectionInterfaceStatus, ptpTraps=ptpTraps, encryptionAlgorithm=encryptionAlgorithm, remoteSecondaryIPAddress=remoteSecondaryIPAddress, siteName=siteName, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, rFUProtectionCompatibility=rFUProtectionCompatibility, rFUTransceiverLocation=rFUTransceiverLocation, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, rFUTxPowerAlarm=rFUTxPowerAlarm, iPv6PrefixLength=iPv6PrefixLength, management=management, rFUTxFreqMax=rFUTxFreqMax, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, rxDiversityVlanTpid=rxDiversityVlanTpid, sNMPTrapTable=sNMPTrapTable, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, hardwareVersion=hardwareVersion, dSCPManagementPriority=dSCPManagementPriority, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rFUConnectedPlatform=rFUConnectedPlatform, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFUTxFreqMin=rFUTxFreqMin, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, protectionState=protectionState, gatewayIPAddress=gatewayIPAddress, sNTPLastSync=sNTPLastSync, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, remotePrimaryIPAddress=remotePrimaryIPAddress, alignmentMode=alignmentMode, receivePower=receivePower, transmitCapacityLimit=transmitCapacityLimit, timeZone=timeZone, productVariant=productVariant, remoteSecondaryMACAddress=remoteSecondaryMACAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPSyncTrap=sNTPSyncTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, managementPortForcedConfiguration=managementPortForcedConfiguration, userTable=userTable, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerTableIndex=sNTPServerTableIndex, protectionSwitchCause=protectionSwitchCause, wirelessLinkStatusTrap=wirelessLinkStatusTrap, sntp=sntp, radioLicenseBandwidth=radioLicenseBandwidth, transmitCapacityLimitDetail=transmitCapacityLimitDetail, tFTPServerInternetAddressType=tFTPServerInternetAddressType, faultProtectionSwitching=faultProtectionSwitching, linkNameMismatch=linkNameMismatch, transmitCodeRate=transmitCodeRate, maxCodeRate=maxCodeRate, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, protectionStats=protectionStats, rFUVersionBank1=rFUVersionBank1, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapIPAddress=sNMPTrapIPAddress, remotePrimaryInternetAddress=remotePrimaryInternetAddress, managementCommittedInformationRate=managementCommittedInformationRate, neighborInternetAddressType=neighborInternetAddressType, hTTPAccessEnabled=hTTPAccessEnabled, ptp800=ptp800, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, radioLicenseBand=radioLicenseBand, syslogStateTrap=syslogStateTrap, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortFiberStatus=dataPortFiberStatus, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, sMTPEmailAlert=sMTPEmailAlert, sMTPServerInternetAddress=sMTPServerInternetAddress, secureModeAlarm=secureModeAlarm, managementPortAutoNegotiation=managementPortAutoNegotiation, altitude=altitude, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUBranchingConfiguration=rFUBranchingConfiguration, ethernet=ethernet, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rFUFreqSpacing=rFUFreqSpacing, rFURxFreqMax=rFURxFreqMax, protectionConfigurationStatus=protectionConfigurationStatus, productName=productName, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFUType=rFUType, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, pubStats=pubStats, managementMode=managementMode, fiberY=fiberY, userPassword=userPassword, ptp=ptp, numberOfAntennas=numberOfAntennas, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPPortNumber=sNMPPortNumber, alignmentModeTrap=alignmentModeTrap, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, systemClock=systemClock, diverseRfFeederLoss=diverseRfFeederLoss, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, receiveCodeRate=receiveCodeRate, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, encryption=encryption, iPv4Address=iPv4Address, daylightSaving=daylightSaving, bridge=bridge, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rxDiversityVid=rxDiversityVid, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, ptmp=ptmp, enabledDiagnosticAlarms=enabledDiagnosticAlarms, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, sNMPTrapInternetAddress=sNMPTrapInternetAddress, activeWirelessLinkAvailability=activeWirelessLinkAvailability, enableTransmission=enableTransmission, rFURFSwitchAlarm=rFURFSwitchAlarm, sNTPServerTimeout=sNTPServerTimeout, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, transmitDataRate=transmitDataRate, userTableNumber=userTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, primaryRecoveryPeriod=primaryRecoveryPeriod, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogControl=syslogControl, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, l2CPPriorityTableEntry=l2CPPriorityTableEntry, requestedProtectionState=requestedProtectionState, tFTPServerPortNumber=tFTPServerPortNumber, maxModulation=maxModulation, sNTPServerTableNumber=sNTPServerTableNumber, rFUPowerButtonPressed=rFUPowerButtonPressed, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, primaryRecovery=primaryRecovery, ptpTrapPrefix=ptpTrapPrefix, remoteMaximumTransmitPower=remoteMaximumTransmitPower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortStatus=dataPortStatus, sNMPTrapVersion=sNMPTrapVersion, sNTPServerRetries=sNTPServerRetries, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUSerial=rFUSerial, antennaGain=antennaGain, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, neighborInternetAddress=neighborInternetAddress, ethernetFiberSupport=ethernetFiberSupport, dataPortDisabledWarning=dataPortDisabledWarning, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, transmitPower=transmitPower, activeUnit=activeUnit, rxDiversityDataPortStatus=rxDiversityDataPortStatus, protection=protection, sNTPServerTable=sNTPServerTable, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, syslogState=syslogState, receiveModulation=receiveModulation, radioLicenseCodeRate=radioLicenseCodeRate, sNTPServerResponse=sNTPServerResponse, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, sNTPSync=sNTPSync, transmitterStatus=transmitterStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, minModulation=minModulation, vLANManagementVIDValidation=vLANManagementVIDValidation, rFURpsAlarm=rFURpsAlarm, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, iPv6Address=iPv6Address, secondarySoftwareVersion=secondarySoftwareVersion, cambium=cambium, receiveDataRate=receiveDataRate, radioLicenseTxFreq=radioLicenseTxFreq, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, radioLicenseIdentifier=radioLicenseIdentifier, rFUActiveFirmwareBank=rFUActiveFirmwareBank, radioLicenseRegion=radioLicenseRegion, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, aTPCEnable=aTPCEnable, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rfu=rfu, localPacketFiltering=localPacketFiltering, activeAvailableTime=activeAvailableTime, l2CPPriorityTable=l2CPPriorityTable, encryptionEnabledMismatch=encryptionEnabledMismatch, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rFUTxBandAboveRx=rFUTxBandAboveRx, alarms=alarms, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, hTTPPortNumber=hTTPPortNumber, snmpControl=snmpControl, managementPortDisabledWarning=managementPortDisabledWarning, linkName=linkName, mPLSTCPriorityTable=mPLSTCPriorityTable, neighborIPAddress=neighborIPAddress, securityLevel=securityLevel, remoteInternetAddressType=remoteInternetAddressType, linkNameMismatchTrap=linkNameMismatchTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFFeederLoss=rFFeederLoss, syslogClient=syslogClient, userEnabled=userEnabled, iPVersion=iPVersion, aggregateDataRate=aggregateDataRate, sNMPTrapTableNumber=sNMPTrapTableNumber, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, sNMPCommunityString=sNMPCommunityString, secureModeAlarmTrap=secureModeAlarmTrap, configuration=configuration, userRole=userRole, protectionStateTrap=protectionStateTrap, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, radioLicenseMinModulation=radioLicenseMinModulation, rFUTxPowerMin=rFUTxPowerMin, iFCableLength=iFCableLength, vectorError=vectorError, systemReset=systemReset, sNTPState=sNTPState, qOSPriorityScheme=qOSPriorityScheme, rFUPowerAlarm=rFUPowerAlarm, protectionAvailabilityStatus=protectionAvailabilityStatus, minCodeRate=minCodeRate, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPv6GatewayAddress=iPv6GatewayAddress, rFURfBand=rFURfBand)
