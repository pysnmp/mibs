...
Counter64, TimeTicks, Gauge32, Counter32, Bits, Unsigned32, ModuleIdentity, MibIdentifier, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises, iso, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "Gauge32", "Counter32", "Bits", "Unsigned32", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises", "iso", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUConnectedPlatform=rFUConnectedPlatform, radioLicenseMinCodeRate=radioLicenseMinCodeRate, sNTPServerTableEntry=sNTPServerTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, receiveCodeRate=receiveCodeRate, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dataPortFiberStatus=dataPortFiberStatus, ptpTraps=ptpTraps, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, antennaGain=antennaGain, alignmentModeTrap=alignmentModeTrap, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rFUTxBandAboveRx=rFUTxBandAboveRx, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, alarms=alarms, softwareVersion=softwareVersion, userTableIndex=userTableIndex, iFCableLength=iFCableLength, rFUActiveFirmwareBank=rFUActiveFirmwareBank, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFUProtectionCompatibility=rFUProtectionCompatibility, dataPortWirelessDownAlert=dataPortWirelessDownAlert, radioLicenseModulation=radioLicenseModulation, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, sNTPState=sNTPState, protectionStateTrap=protectionStateTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, remotePrimaryIPAddress=remotePrimaryIPAddress, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, dataPortStatusTrap=dataPortStatusTrap, alignmentMode=alignmentMode, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, sNTPServerTableNumber=sNTPServerTableNumber, sNTPPrimaryServer=sNTPPrimaryServer, syslogClientTrap=syslogClientTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, securityLevel=securityLevel, ptp=ptp, rFUTxMuteStatus=rFUTxMuteStatus, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rxDiversityDataPortStatus=rxDiversityDataPortStatus, managementPortStatusTrap=managementPortStatusTrap, ptmp=ptmp, protection=protection, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, timeZone=timeZone, configuration=configuration, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFUTxPowerAlarm=rFUTxPowerAlarm, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, userTableEntry=userTableEntry, daylightSaving=daylightSaving, hTTPAccessEnabled=hTTPAccessEnabled, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPv6PrefixLength=iPv6PrefixLength, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, secureModeAlarm=secureModeAlarm, pubStats=pubStats, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, managementCommittedInformationRate=managementCommittedInformationRate, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, transmitModulation=transmitModulation, l2CPPriorityTable=l2CPPriorityTable, rxDiversityVlanTpid=rxDiversityVlanTpid, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, managementPortForcedConfiguration=managementPortForcedConfiguration, sNTPServerInternetAddressType=sNTPServerInternetAddressType, minModulation=minModulation, sNMPEnabledTraps=sNMPEnabledTraps, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, protectionInterfaceStatus=protectionInterfaceStatus, rFUVersionBank1=rFUVersionBank1, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, aTPCEnable=aTPCEnable, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tFTPServerInternetAddress=tFTPServerInternetAddress, userPassword=userPassword, transmitPower=transmitPower, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkStatus=wirelessLinkStatus, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, numberOfAntennas=numberOfAntennas, sMTPServerPortNumber=sMTPServerPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, ethernetPriorityTableEntry=ethernetPriorityTableEntry, transmitCapacityLimit=transmitCapacityLimit, dataPortPauseFrames=dataPortPauseFrames, receivePower=receivePower, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rFURfBand=rFURfBand, productVariant=productVariant, iPv4Address=iPv4Address, subnetMask=subnetMask, remoteSecondaryIPAddress=remoteSecondaryIPAddress, protectionStats=protectionStats, vectorError=vectorError, userTableNumber=userTableNumber, radioLicenseBandwidth=radioLicenseBandwidth, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, protectionConfigurationStatus=protectionConfigurationStatus, userTable=userTable, phyStatus=phyStatus, productName=productName, linkNameMismatchTrap=linkNameMismatchTrap, rFUPlatformCompatibility=rFUPlatformCompatibility, remoteMaximumTransmitPower=remoteMaximumTransmitPower, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, siteName=siteName, ptp800=ptp800, rfu=rfu, sNMPTrapTableEntry=sNMPTrapTableEntry, smtp=smtp, transmitCapacityLimitDetail=transmitCapacityLimitDetail, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rFURxFreqMax=rFURxFreqMax, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFUFreqSpacing=rFUFreqSpacing, aggregateDataRate=aggregateDataRate, rFUPowerAlarm=rFUPowerAlarm, diverseAntennaGain=diverseAntennaGain, bridge=bridge, rFUTxFreqMax=rFUTxFreqMax, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, managementPortAutoNegotiation=managementPortAutoNegotiation, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, gatewayIPAddress=gatewayIPAddress, transmitterStatus=transmitterStatus, sNTPPollInterval=sNTPPollInterval, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, iPVersion=iPVersion, iPv6Address=iPv6Address, supplementary=supplementary, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, minCodeRate=minCodeRate, sNMPTrapTableNumber=sNMPTrapTableNumber, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, vLANManagementVID=vLANManagementVID, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, linkName=linkName, userName=userName, syslogControl=syslogControl, longitude=longitude, dataPortDisabledWarning=dataPortDisabledWarning, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rFUPowerButtonPressed=rFUPowerButtonPressed, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, protectionSwitchCause=protectionSwitchCause, encryptionAlgorithm=encryptionAlgorithm, radioLicenseBand=radioLicenseBand, rFUSerial=rFUSerial, transmitCodeRate=transmitCodeRate, rFUCableAlarm=rFUCableAlarm, radioLicenseMaxEIRP=radioLicenseMaxEIRP, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sNMPPortNumber=sNMPPortNumber, syslogState=syslogState, wirelessLinkStatusTrap=wirelessLinkStatusTrap, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, sNTPSync=sNTPSync, neighborInternetAddress=neighborInternetAddress, userEnabled=userEnabled, neighborInternetAddressType=neighborInternetAddressType, tFTPServerPortNumber=tFTPServerPortNumber, rFUVersionBank2=rFUVersionBank2, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sNTPServerRetries=sNTPServerRetries, hTTPPortNumber=hTTPPortNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, activeWirelessLinkAvailability=activeWirelessLinkAvailability, sNTPLastSync=sNTPLastSync, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, secureModeAlarmTrap=secureModeAlarmTrap, sNTPServerPortNumber=sNTPServerPortNumber, bootVersion=bootVersion, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, remoteSecondaryMACAddress=remoteSecondaryMACAddress, managementPortDisabledWarning=managementPortDisabledWarning, activeAvailableTime=activeAvailableTime, hTTPSAccessEnabled=hTTPSAccessEnabled, radioLicenseMaxModulation=radioLicenseMaxModulation, radioLicenseTxFreq=radioLicenseTxFreq, faultProtectionSwitching=faultProtectionSwitching, encryption=encryption, unitOutOfCalibration=unitOutOfCalibration, receiveDataRate=receiveDataRate, syslogStateTrap=syslogStateTrap, linkLoss=linkLoss, transmitCapacity=transmitCapacity, managementPortWirelessDownAlert=managementPortWirelessDownAlert, vLANManagementVIDValidation=vLANManagementVIDValidation, maxCodeRate=maxCodeRate, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, qOSPriorityScheme=qOSPriorityScheme, receiveModulation=receiveModulation, aAAControl=aAAControl, rFULockoutAlarm=rFULockoutAlarm, radioLicense=radioLicense, telnetPortNumber=telnetPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, sNMPCommunityString=sNMPCommunityString, protectionAvailabilityStatus=protectionAvailabilityStatus, ethernetPriorityTable=ethernetPriorityTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, primaryRecoveryPeriod=primaryRecoveryPeriod, systemReset=systemReset, enableTransmission=enableTransmission, dSCPManagementPriority=dSCPManagementPriority, sNTPServerTable=sNTPServerTable, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, altitude=altitude, rxDiversityVid=rxDiversityVid, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rFFeederLoss=rFFeederLoss, rFUTxFreqMin=rFUTxFreqMin, neighborMACAddress=neighborMACAddress, sNTPSyncTrap=sNTPSyncTrap, encryptionEnabledMismatch=encryptionEnabledMismatch, ptpTrapPrefix=ptpTrapPrefix, dataPortStatus=dataPortStatus, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, remoteInternetAddressType=remoteInternetAddressType, versions=versions, sNMPTrapTable=sNMPTrapTable, cambium=cambium, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, iPv6GatewayAddress=iPv6GatewayAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rFURpsAlarm=rFURpsAlarm, hTTPSPortNumber=hTTPSPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, reset=reset, tFTPServerIPAddress=tFTPServerIPAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", activeUnit=activeUnit, radioLicenseIdentifier=radioLicenseIdentifier, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, radioLicenseRegion=radioLicenseRegion, wirelessLinkAvailability=wirelessLinkAvailability, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, sNMPTrapPortNumber=sNMPTrapPortNumber, protectionState=protectionState, ethernetFiberSupport=ethernetFiberSupport, primaryRecovery=primaryRecovery, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPServerResponse=sNTPServerResponse, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, snmpControl=snmpControl, rFUType=rFUType, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, ethernet=ethernet, vLANManagementPriority=vLANManagementPriority, sMTPEmailAlert=sMTPEmailAlert, neighborIPAddress=neighborIPAddress, rFUTxPowerMax=rFUTxPowerMax, phyControl=phyControl, ethernetPriorityTableIndex=ethernetPriorityTableIndex, maxModulation=maxModulation, managementMode=managementMode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, endId=endId, radioLicenseRxFreq=radioLicenseRxFreq, localPacketFiltering=localPacketFiltering, remoteMACAddress=remoteMACAddress, remotePrimarySecondaryMode=remotePrimarySecondaryMode, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, primarySecondaryMode=primarySecondaryMode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFUBranchingConfiguration=rFUBranchingConfiguration, sMTPServerIPAddress=sMTPServerIPAddress, requestedProtectionState=requestedProtectionState, protectionConfig=protectionConfig, remotePrimaryInternetAddress=remotePrimaryInternetAddress, telnetAccessEnabled=telnetAccessEnabled, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, rFUStatus=rFUStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, maximumTransmitPower=maximumTransmitPower, diverseRfFeederLoss=diverseRfFeederLoss, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rFUStatusTrap=rFUStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, sntp=sntp, remotePrimaryMACAddress=remotePrimaryMACAddress, protectionStatus=protectionStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, remoteIPAddress=remoteIPAddress, sNTPServerIPAddress=sNTPServerIPAddress, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, managementPortStatus=managementPortStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, syslogClient=syslogClient, rFURFSwitchAlarm=rFURFSwitchAlarm, remoteInternetAddress=remoteInternetAddress, radioLicenseCodeRate=radioLicenseCodeRate, rFUTransceiverLocation=rFUTransceiverLocation, l2CPPriorityTableIndex=l2CPPriorityTableIndex, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, latitude=latitude, rFURxFreqMin=rFURxFreqMin, tFTPServerInternetAddressType=tFTPServerInternetAddressType, management=management, fiberY=fiberY, radioLicenseMinModulation=radioLicenseMinModulation, systemClock=systemClock, rFUTxPowerMin=rFUTxPowerMin, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, sNMPTrapIPAddress=sNMPTrapIPAddress, hardwareVersion=hardwareVersion, userRole=userRole, sNTPServerTableIndex=sNTPServerTableIndex, linkNameMismatch=linkNameMismatch, licence=licence, sNMPTrapVersion=sNMPTrapVersion, sNTPServerTimeout=sNTPServerTimeout, transmitDataRate=transmitDataRate, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate)
