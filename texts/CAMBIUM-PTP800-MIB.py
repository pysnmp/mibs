...
iso, Gauge32, IpAddress, Unsigned32, Bits, MibIdentifier, TimeTicks, NotificationType, Integer32, ObjectIdentity, ModuleIdentity, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "IpAddress", "Unsigned32", "Bits", "MibIdentifier", "TimeTicks", "NotificationType", "Integer32", "ObjectIdentity", "ModuleIdentity", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUVersionBank2=rFUVersionBank2, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, ethernetPriorityTableNumber=ethernetPriorityTableNumber, wirelessLinkStatus=wirelessLinkStatus, radioLicenseModulation=radioLicenseModulation, sNMPCommunityString=sNMPCommunityString, sNMPTrapTable=sNMPTrapTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementPortDisabledWarning=managementPortDisabledWarning, rFUPlatformCompatibility=rFUPlatformCompatibility, sNMPTrapTableIndex=sNMPTrapTableIndex, protectionAvailabilityStatus=protectionAvailabilityStatus, sNTPLastSync=sNTPLastSync, remotePrimarySecondaryMode=remotePrimarySecondaryMode, iPv6Address=iPv6Address, linkLoss=linkLoss, sMTPEmailAlert=sMTPEmailAlert, managementPortStatusTrap=managementPortStatusTrap, transmitDataRate=transmitDataRate, rFURFSwitchAlarm=rFURFSwitchAlarm, rFUFreqSpacing=rFUFreqSpacing, activeUnit=activeUnit, iPv6PrefixLength=iPv6PrefixLength, protectionStats=protectionStats, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rFUPowerAlarm=rFUPowerAlarm, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, primaryRecovery=primaryRecovery, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, neighborInternetAddressType=neighborInternetAddressType, managementMode=managementMode, radioLicenseTxFreq=radioLicenseTxFreq, rFUTxFreqMax=rFUTxFreqMax, ethernetPriorityTableEntry=ethernetPriorityTableEntry, aTPCEnable=aTPCEnable, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, dataPortFiberStatus=dataPortFiberStatus, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, primaryRecoveryPeriod=primaryRecoveryPeriod, managementPortStatus=managementPortStatus, rFURxFreqMax=rFURxFreqMax, rFUSerial=rFUSerial, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFUStatusTrap=rFUStatusTrap, secondarySoftwareVersion=secondarySoftwareVersion, radioLicenseBandwidth=radioLicenseBandwidth, ptp800=ptp800, rFUActiveFirmwareBank=rFUActiveFirmwareBank, radioLicenseRegion=radioLicenseRegion, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, remoteInternetAddress=remoteInternetAddress, vLANManagementPriority=vLANManagementPriority, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rFULockoutAlarm=rFULockoutAlarm, aggregateDataRate=aggregateDataRate, numberOfAntennas=numberOfAntennas, radioLicenseMinModulation=radioLicenseMinModulation, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, sMTPServerPortNumber=sMTPServerPortNumber, protectionInterfaceStatus=protectionInterfaceStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, bootVersion=bootVersion, userName=userName, linkNameMismatch=linkNameMismatch, cambium=cambium, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, protectionSwitchCause=protectionSwitchCause, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, systemReset=systemReset, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sntp=sntp, sNTPSync=sNTPSync, rFURxFreqMin=rFURxFreqMin, protectionState=protectionState, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rxDiversityVlanTpid=rxDiversityVlanTpid, userTable=userTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPPrimaryServer=sNTPPrimaryServer, radioLicenseMaxModulation=radioLicenseMaxModulation, maxModulation=maxModulation, sNTPServerTable=sNTPServerTable, localPacketFiltering=localPacketFiltering, receiveModulation=receiveModulation, managementPortForcedConfiguration=managementPortForcedConfiguration, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, remotePrimaryInternetAddress=remotePrimaryInternetAddress, protectionStatus=protectionStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, iPVersion=iPVersion, sMTPServerInternetAddress=sMTPServerInternetAddress, vLANManagementVID=vLANManagementVID, phyStatus=phyStatus, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, latitude=latitude, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, productVariant=productVariant, maxCodeRate=maxCodeRate, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, protectionConfig=protectionConfig, iPDSCPPriorityTable=iPDSCPPriorityTable, rFUTxPowerMax=rFUTxPowerMax, minCodeRate=minCodeRate, securityLevel=securityLevel, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rFUCableAlarm=rFUCableAlarm, protectionStateTrap=protectionStateTrap, managementCommittedInformationRate=managementCommittedInformationRate, telnetAccessEnabled=telnetAccessEnabled, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rFUVersionBank1=rFUVersionBank1, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, neighborMACAddress=neighborMACAddress, syslogClientTrap=syslogClientTrap, vectorError=vectorError, linkNameMismatchTrap=linkNameMismatchTrap, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, phyControl=phyControl, transmitPower=transmitPower, telnetPortNumber=telnetPortNumber, secureModeAlarm=secureModeAlarm, systemClock=systemClock, management=management, remoteSecondaryIPAddress=remoteSecondaryIPAddress, siteName=siteName, hTTPAccessEnabled=hTTPAccessEnabled, minModulation=minModulation, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, ptp=ptp, userTableEntry=userTableEntry, iPv4Address=iPv4Address, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, configuration=configuration, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, sNMPTrapTableNumber=sNMPTrapTableNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, productName=productName, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, syslogState=syslogState, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPServerRetries=sNTPServerRetries, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPServerInternetAddress=tFTPServerInternetAddress, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rxDiversityDataPortStatus=rxDiversityDataPortStatus, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rFURpsAlarm=rFURpsAlarm, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, alignmentMode=alignmentMode, radioLicenseMinCodeRate=radioLicenseMinCodeRate, pubStats=pubStats, tFTPServerInternetAddressType=tFTPServerInternetAddressType, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, primarySecondaryMode=primarySecondaryMode, rFUTxFreqMin=rFUTxFreqMin, rFUTxPowerMin=rFUTxPowerMin, sNTPServerIPAddress=sNTPServerIPAddress, ptmp=ptmp, l2CPPriorityTable=l2CPPriorityTable, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPPortNumber=sNMPPortNumber, radioLicenseBand=radioLicenseBand, dataPortStatus=dataPortStatus, dataPortStatusTrap=dataPortStatusTrap, smtp=smtp, protection=protection, transmitCapacityLimit=transmitCapacityLimit, alignmentModeTrap=alignmentModeTrap, receiveCodeRate=receiveCodeRate, timeZone=timeZone, rFUType=rFUType, requestedProtectionState=requestedProtectionState, rFUStatus=rFUStatus, gatewayIPAddress=gatewayIPAddress, radioLicenseCodeRate=radioLicenseCodeRate, rFUPowerButtonPressed=rFUPowerButtonPressed, hTTPPortNumber=hTTPPortNumber, managementPortAutoNegotiation=managementPortAutoNegotiation, sNMPTrapTableEntry=sNMPTrapTableEntry, activeAvailableTime=activeAvailableTime, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, daylightSaving=daylightSaving, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, userTableNumber=userTableNumber, radioLicenseMaxEIRP=radioLicenseMaxEIRP, aAAControl=aAAControl, altitude=altitude, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, userRole=userRole, longitude=longitude, radioLicenseIdentifier=radioLicenseIdentifier, remotePrimaryIPAddress=remotePrimaryIPAddress, userPassword=userPassword, versions=versions, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitCapacity=transmitCapacity, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, mPLSTCPriorityTable=mPLSTCPriorityTable, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, diverseRfFeederLoss=diverseRfFeederLoss, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rFUConnectedPlatform=rFUConnectedPlatform, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, radioLicense=radioLicense, transmitCodeRate=transmitCodeRate, sMTPServerIPAddress=sMTPServerIPAddress, syslogStateTrap=syslogStateTrap, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerTimeout=sNTPServerTimeout, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, managementPortConfigurationMismatch=managementPortConfigurationMismatch, userEnabled=userEnabled, iPv6GatewayAddress=iPv6GatewayAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, softwareVersion=softwareVersion, dataPortFiberStatusTrap=dataPortFiberStatusTrap, neighborIPAddress=neighborIPAddress, rxDiversityVid=rxDiversityVid)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNTPServerTableIndex=sNTPServerTableIndex, rfu=rfu, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, fiberY=fiberY, hTTPSPortNumber=hTTPSPortNumber, encryptionAlgorithm=encryptionAlgorithm, linkName=linkName, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPSyncTrap=sNTPSyncTrap, ethernet=ethernet, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, qOSPriorityScheme=qOSPriorityScheme, remoteMACAddress=remoteMACAddress, supplementary=supplementary, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, dSCPManagementPriority=dSCPManagementPriority, rFUTxPowerAlarm=rFUTxPowerAlarm, enableTransmission=enableTransmission, ptpTrapPrefix=ptpTrapPrefix, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rFFeederLoss=rFFeederLoss, alarms=alarms, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, rFURfBand=rFURfBand, remoteIPAddress=remoteIPAddress, sNTPServerResponse=sNTPServerResponse, sNTPServerTableEntry=sNTPServerTableEntry, sNTPPollInterval=sNTPPollInterval, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, faultProtectionSwitching=faultProtectionSwitching, dataPortPauseFrames=dataPortPauseFrames, rFUBranchingConfiguration=rFUBranchingConfiguration, transmitModulation=transmitModulation, wirelessLinkAvailability=wirelessLinkAvailability, iFCableLength=iFCableLength, snmpControl=snmpControl, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rFUTxBandAboveRx=rFUTxBandAboveRx, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, transmitCapacityLimitDetail=transmitCapacityLimitDetail, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, userTableIndex=userTableIndex, rFUTxMuteStatus=rFUTxMuteStatus, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, sNTPServerPortNumber=sNTPServerPortNumber, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, vLANManagementVIDValidation=vLANManagementVIDValidation, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, reset=reset, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ptpTraps=ptpTraps, transmitterStatus=transmitterStatus, ethernetPriorityTable=ethernetPriorityTable, syslogClient=syslogClient, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hardwareVersion=hardwareVersion, sNMPEnabledTraps=sNMPEnabledTraps, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, sMTPEnabledMessages=sMTPEnabledMessages, rFUProtectionCompatibility=rFUProtectionCompatibility, sNMPTrapVersion=sNMPTrapVersion, l2CPPriorityTableNumber=l2CPPriorityTableNumber, protectionConfigurationStatus=protectionConfigurationStatus, endId=endId, rFUTransceiverLocation=rFUTransceiverLocation, subnetMask=subnetMask, diverseAntennaGain=diverseAntennaGain, neighborInternetAddress=neighborInternetAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, radioLicenseRxFreq=radioLicenseRxFreq, encryptionEnabledMismatch=encryptionEnabledMismatch, syslogControl=syslogControl, receivePower=receivePower, receiveDataRate=receiveDataRate, sNTPState=sNTPState, encryption=encryption, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapInternetAddress=sNMPTrapInternetAddress, activeWirelessLinkAvailability=activeWirelessLinkAvailability, remoteInternetAddressType=remoteInternetAddressType, ethernetFiberSupport=ethernetFiberSupport, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, licence=licence, remotePrimaryMACAddress=remotePrimaryMACAddress, bridge=bridge, maximumTransmitPower=maximumTransmitPower, antennaGain=antennaGain, unitOutOfCalibration=unitOutOfCalibration)
