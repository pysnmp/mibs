...
NotificationType, Integer32, ModuleIdentity, ObjectIdentity, iso, enterprises, Counter64, Gauge32, Bits, Unsigned32, NotificationType, MibIdentifier, Counter32, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "ModuleIdentity", "ObjectIdentity", "iso", "enterprises", "Counter64", "Gauge32", "Bits", "Unsigned32", "NotificationType", "MibIdentifier", "Counter32", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sntp=sntp, managementPortForcedConfiguration=managementPortForcedConfiguration, telnetAccessEnabled=telnetAccessEnabled, supplementary=supplementary, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, userTableNumber=userTableNumber, remoteIPAddress=remoteIPAddress, diverseRfFeederLoss=diverseRfFeederLoss, primarySecondaryMode=primarySecondaryMode, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUStatusTrap=rFUStatusTrap, sNTPSync=sNTPSync, dataPortFiberStatus=dataPortFiberStatus, sNTPPrimaryServer=sNTPPrimaryServer, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFUTxFreqMax=rFUTxFreqMax, secureModeAlarm=secureModeAlarm, tFTPServerPortNumber=tFTPServerPortNumber, rFUPowerAlarm=rFUPowerAlarm, secureModeAlarmTrap=secureModeAlarmTrap, vLANManagementPriority=vLANManagementPriority, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rFUPowerButtonPressed=rFUPowerButtonPressed, sNTPServerResponse=sNTPServerResponse, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, remoteSecondaryIPAddress=remoteSecondaryIPAddress, userName=userName, iPv4Address=iPv4Address, sMTPServerInternetAddressType=sMTPServerInternetAddressType, daylightSaving=daylightSaving, sNTPServerInternetAddress=sNTPServerInternetAddress, rxDiversityDataPortStatus=rxDiversityDataPortStatus, fiberY=fiberY, ptp=ptp, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, linkName=linkName, rFURfBand=rFURfBand, vLANManagementVID=vLANManagementVID, sNTPServerTimeout=sNTPServerTimeout, syslogClientTrap=syslogClientTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerTableNumber=sNTPServerTableNumber, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, aggregateDataRate=aggregateDataRate, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rFUTxMuteStatus=rFUTxMuteStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rFUBranchingConfiguration=rFUBranchingConfiguration, rFUPlatformCompatibility=rFUPlatformCompatibility, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, numberOfAntennas=numberOfAntennas, iPv6Address=iPv6Address, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, sMTPEmailAlert=sMTPEmailAlert, ptmp=ptmp, neighborInternetAddress=neighborInternetAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, enableTransmission=enableTransmission, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, receivePower=receivePower, sMTPServerIPAddress=sMTPServerIPAddress, antennaGain=antennaGain, hTTPAccessEnabled=hTTPAccessEnabled, neighborIPAddress=neighborIPAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, systemClock=systemClock, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, radioLicenseRegion=radioLicenseRegion, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rFUTxFreqMin=rFUTxFreqMin, rFUVersionBank2=rFUVersionBank2, radioLicenseMaxModulation=radioLicenseMaxModulation, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogControl=syslogControl, sNTPServerTableIndex=sNTPServerTableIndex, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rFUVersionBank1=rFUVersionBank1, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, management=management, cambium=cambium, protectionConfig=protectionConfig, aTPCEnable=aTPCEnable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, iPDSCPPriorityTable=iPDSCPPriorityTable, licence=licence, minModulation=minModulation, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, wirelessLinkAvailability=wirelessLinkAvailability, activeUnit=activeUnit, radioLicenseBandwidth=radioLicenseBandwidth, longitude=longitude, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, configuration=configuration, iPv6PrefixLength=iPv6PrefixLength, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, tFTPServerInternetAddress=tFTPServerInternetAddress, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sNTPServerInternetAddressType=sNTPServerInternetAddressType, encryptionAlgorithm=encryptionAlgorithm, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rfu=rfu, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPPollInterval=sNTPPollInterval, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPSyncTrap=sNTPSyncTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, requestedProtectionState=requestedProtectionState, transmitCapacityLimit=transmitCapacityLimit, sNTPState=sNTPState, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptp800=ptp800, sNMPCommunityString=sNMPCommunityString, sNMPPortNumber=sNMPPortNumber, systemReset=systemReset, activeAvailableTime=activeAvailableTime, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sNTPServerIPAddress=sNTPServerIPAddress, smtp=smtp, transmitDataRate=transmitDataRate, syslogState=syslogState, receiveModulation=receiveModulation, userRole=userRole, neighborMACAddress=neighborMACAddress, rFULockoutAlarm=rFULockoutAlarm, radioLicenseBand=radioLicenseBand, sNTPServerTableEntry=sNTPServerTableEntry, primaryRecovery=primaryRecovery, sNMPTrapPortNumber=sNMPTrapPortNumber, encryption=encryption, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, rFUActiveFirmwareBank=rFUActiveFirmwareBank, iPVersion=iPVersion, dataPortPauseFrames=dataPortPauseFrames, receiveCodeRate=receiveCodeRate, rxDiversityVlanTpid=rxDiversityVlanTpid, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rFUConnectedPlatform=rFUConnectedPlatform, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, protectionInterfaceStatus=protectionInterfaceStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dSCPManagementPriority=dSCPManagementPriority, maxCodeRate=maxCodeRate, snmpControl=snmpControl, sNMPTrapVersion=sNMPTrapVersion, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rFURpsAlarm=rFURpsAlarm, managementMode=managementMode, radioLicenseMaxEIRP=radioLicenseMaxEIRP, dataPortConfigurationMismatch=dataPortConfigurationMismatch, productName=productName, secondarySoftwareVersion=secondarySoftwareVersion, l2CPPriorityTableIndex=l2CPPriorityTableIndex, bootVersion=bootVersion, protectionSwitchCause=protectionSwitchCause, linkNameMismatchTrap=linkNameMismatchTrap, alarms=alarms, remoteSecondaryMACAddress=remoteSecondaryMACAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFUTxBandAboveRx=rFUTxBandAboveRx, productVariant=productVariant, mPLSTCPriorityTable=mPLSTCPriorityTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, bridge=bridge, rFFeederLoss=rFFeederLoss, rFUCableAlarm=rFUCableAlarm, l2CPPriorityTable=l2CPPriorityTable, gatewayIPAddress=gatewayIPAddress, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetPriorityTable=ethernetPriorityTable, radioLicenseTxFreq=radioLicenseTxFreq, linkLoss=linkLoss, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, sNTPServerRetries=sNTPServerRetries, rFUProtectionCompatibility=rFUProtectionCompatibility, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, endId=endId, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, managementCommittedInformationRate=managementCommittedInformationRate, userTableEntry=userTableEntry, alignmentMode=alignmentMode, managementPortAutoNegotiation=managementPortAutoNegotiation, radioLicense=radioLicense, pubStats=pubStats, linkNameMismatch=linkNameMismatch, transmitterStatus=transmitterStatus, rFUTxPowerMin=rFUTxPowerMin, sMTPServerPortNumber=sMTPServerPortNumber, remotePrimaryInternetAddress=remotePrimaryInternetAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, phyStatus=phyStatus, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFURxFreqMax=rFURxFreqMax, maximumTransmitPower=maximumTransmitPower, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, radioLicenseRxFreq=radioLicenseRxFreq, rxDiversityVid=rxDiversityVid, rFUTxPowerMax=rFUTxPowerMax, faultProtectionSwitching=faultProtectionSwitching, sNMPEnabledTraps=sNMPEnabledTraps, receiveDataRate=receiveDataRate, userTableIndex=userTableIndex, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerPortNumber=sNTPServerPortNumber, iPv6GatewayAddress=iPv6GatewayAddress, rFURFSwitchAlarm=rFURFSwitchAlarm, protectionStats=protectionStats, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, protectionConfigurationStatus=protectionConfigurationStatus, ptpTrapPrefix=ptpTrapPrefix, localPacketFiltering=localPacketFiltering, altitude=altitude, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, ethernet=ethernet, minCodeRate=minCodeRate, iFCableLength=iFCableLength, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, rFUTransceiverLocation=rFUTransceiverLocation, userEnabled=userEnabled, remoteInternetAddressType=remoteInternetAddressType, rFUTxPowerAlarm=rFUTxPowerAlarm, ptpTraps=ptpTraps, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, transmitModulation=transmitModulation, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, sNTPLastSync=sNTPLastSync, remotePrimarySecondaryMode=remotePrimarySecondaryMode, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapTable=sNMPTrapTable, vLANManagementVIDValidation=vLANManagementVIDValidation, syslogStateTrap=syslogStateTrap, managementPortStatusTrap=managementPortStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, activeWirelessLinkAvailability=activeWirelessLinkAvailability, vectorError=vectorError)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", remoteMACAddress=remoteMACAddress, encryptionEnabledMismatch=encryptionEnabledMismatch, rFUType=rFUType, dataPortStatusTrap=dataPortStatusTrap, latitude=latitude, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, securityLevel=securityLevel, timeZone=timeZone, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, hTTPPortNumber=hTTPPortNumber, transmitPower=transmitPower, unitOutOfCalibration=unitOutOfCalibration, protectionStatus=protectionStatus, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, hTTPSPortNumber=hTTPSPortNumber, protectionStateTrap=protectionStateTrap, managementPortStatus=managementPortStatus, radioLicenseMinCodeRate=radioLicenseMinCodeRate, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitCapacityLimitDetail=transmitCapacityLimitDetail, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, diverseAntennaGain=diverseAntennaGain, managementPortDisabledWarning=managementPortDisabledWarning, hardwareVersion=hardwareVersion, softwareVersion=softwareVersion, reset=reset, neighborInternetAddressType=neighborInternetAddressType, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, dataPortStatus=dataPortStatus, syslogClient=syslogClient, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, siteName=siteName, sNTPServerTable=sNTPServerTable, sMTPEnabledMessages=sMTPEnabledMessages, alignmentModeTrap=alignmentModeTrap, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, remotePrimaryMACAddress=remotePrimaryMACAddress, rFUStatus=rFUStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, subnetMask=subnetMask, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitCapacity=transmitCapacity, radioLicenseMinModulation=radioLicenseMinModulation, wirelessLinkStatus=wirelessLinkStatus, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, telnetPortNumber=telnetPortNumber, transmitCodeRate=transmitCodeRate, versions=versions, protectionState=protectionState, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, radioLicenseCodeRate=radioLicenseCodeRate, remotePrimaryIPAddress=remotePrimaryIPAddress, radioLicenseModulation=radioLicenseModulation, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFUSerial=rFUSerial, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, dataPortDisabledWarning=dataPortDisabledWarning, userTable=userTable, remoteInternetAddress=remoteInternetAddress, userPassword=userPassword, maxModulation=maxModulation, phyControl=phyControl, protectionAvailabilityStatus=protectionAvailabilityStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, qOSPriorityScheme=qOSPriorityScheme, protection=protection, rFUFreqSpacing=rFUFreqSpacing, radioLicenseIdentifier=radioLicenseIdentifier, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkStatusTrap=wirelessLinkStatusTrap, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, aAAControl=aAAControl, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, primaryRecoveryPeriod=primaryRecoveryPeriod, rFURxFreqMin=rFURxFreqMin, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility)
