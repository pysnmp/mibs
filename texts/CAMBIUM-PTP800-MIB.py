...
Integer32, Unsigned32, Counter64, TimeTicks, NotificationType, IpAddress, NotificationType, ModuleIdentity, enterprises, ObjectIdentity, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Counter64", "TimeTicks", "NotificationType", "IpAddress", "NotificationType", "ModuleIdentity", "enterprises", "ObjectIdentity", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", management=management, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, ptmp=ptmp, protectionStatus=protectionStatus, transmitDataRate=transmitDataRate, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, numberOfAntennas=numberOfAntennas, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, radioLicenseBandwidth=radioLicenseBandwidth, neighborInternetAddress=neighborInternetAddress, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, hTTPPortNumber=hTTPPortNumber, linkNameMismatchTrap=linkNameMismatchTrap, aTPCEnable=aTPCEnable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, protectionStateTrap=protectionStateTrap, vLANManagementPriority=vLANManagementPriority, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, remotePrimaryIPAddress=remotePrimaryIPAddress, maxModulation=maxModulation, encryption=encryption, alignmentModeTrap=alignmentModeTrap, sNTPState=sNTPState, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, sNTPPrimaryServer=sNTPPrimaryServer, minModulation=minModulation, sMTPEnabledMessages=sMTPEnabledMessages, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFUPlatformCompatibility=rFUPlatformCompatibility, rFUTransceiverLocation=rFUTransceiverLocation, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, rxDiversityDataPortStatus=rxDiversityDataPortStatus, userEnabled=userEnabled, rFUCableAlarm=rFUCableAlarm, hTTPSAccessEnabled=hTTPSAccessEnabled, rFURfBand=rFURfBand, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, bootVersion=bootVersion, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, rFURxFreqMax=rFURxFreqMax, dataPortFiberStatusTrap=dataPortFiberStatusTrap, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, linkName=linkName, sNMPPortNumber=sNMPPortNumber, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, sMTPEmailAlert=sMTPEmailAlert, ptp=ptp, secureModeAlarmTrap=secureModeAlarmTrap, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, ethernetPriorityTable=ethernetPriorityTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, linkLoss=linkLoss, radioLicenseMinModulation=radioLicenseMinModulation, protectionSwitchCause=protectionSwitchCause, userPassword=userPassword, remoteSecondaryMACAddress=remoteSecondaryMACAddress, radioLicenseRxFreq=radioLicenseRxFreq, radioLicenseMaxEIRP=radioLicenseMaxEIRP, alarms=alarms, ptpTrapPrefix=ptpTrapPrefix, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkAvailability=wirelessLinkAvailability, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, transmitterStatus=transmitterStatus, longitude=longitude, dataPortFiberStatus=dataPortFiberStatus, iPv4Address=iPv4Address, receivePower=receivePower, rFUActiveFirmwareBank=rFUActiveFirmwareBank, systemReset=systemReset, smtp=smtp, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, protectionStats=protectionStats, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, rFUVersionBank1=rFUVersionBank1, telnetPortNumber=telnetPortNumber, hTTPSPortNumber=hTTPSPortNumber, managementPortForcedConfiguration=managementPortForcedConfiguration, sNTPServerTimeout=sNTPServerTimeout, latitude=latitude, rfu=rfu, sNMPCommunityString=sNMPCommunityString, dSCPManagementPriority=dSCPManagementPriority, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rFUTxPowerMax=rFUTxPowerMax, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, radioLicenseCodeRate=radioLicenseCodeRate, protectionAvailabilityStatus=protectionAvailabilityStatus, rFUTxFreqMax=rFUTxFreqMax, secureModeAlarm=secureModeAlarm, rFUTxBandAboveRx=rFUTxBandAboveRx, subnetMask=subnetMask, sNTPServerRetries=sNTPServerRetries, sNTPServerIPAddress=sNTPServerIPAddress, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, softwareVersion=softwareVersion, vLANManagementVIDValidation=vLANManagementVIDValidation, rFURpsAlarm=rFURpsAlarm, phyControl=phyControl, transmitModulation=transmitModulation, sNTPServerTableIndex=sNTPServerTableIndex, faultProtectionSwitching=faultProtectionSwitching, sNTPServerTableNumber=sNTPServerTableNumber, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, protection=protection, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rFURxFreqMin=rFURxFreqMin, pubStats=pubStats, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPSync=sNTPSync, hardwareVersion=hardwareVersion, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, diverseRfFeederLoss=diverseRfFeederLoss, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, radioLicense=radioLicense, rFUPowerButtonPressed=rFUPowerButtonPressed, syslogControl=syslogControl, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, diverseAntennaGain=diverseAntennaGain, primaryRecovery=primaryRecovery, encryptionAlgorithm=encryptionAlgorithm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remoteIPAddress=remoteIPAddress, transmitPower=transmitPower, licence=licence, tFTPServerIPAddress=tFTPServerIPAddress, gatewayIPAddress=gatewayIPAddress, userTableNumber=userTableNumber, rFUType=rFUType, tFTPServerPortNumber=tFTPServerPortNumber, snmpControl=snmpControl, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, iPv6GatewayAddress=iPv6GatewayAddress, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, iPv6PrefixLength=iPv6PrefixLength, remoteInternetAddressType=remoteInternetAddressType, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPPollInterval=sNTPPollInterval, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapTableNumber=sNMPTrapTableNumber, productName=productName, dataPortStatus=dataPortStatus, sNTPSyncTrap=sNTPSyncTrap, userTable=userTable, userName=userName, radioLicenseTxFreq=radioLicenseTxFreq, l2CPPriorityTable=l2CPPriorityTable, localPacketFiltering=localPacketFiltering, protectionInterfaceStatus=protectionInterfaceStatus, transmitCapacityLimit=transmitCapacityLimit, userTableIndex=userTableIndex, rFURFSwitchAlarm=rFURFSwitchAlarm, iPv6Address=iPv6Address, configuration=configuration, managementPortAutoNegotiation=managementPortAutoNegotiation, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogStateTrap=syslogStateTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, phyStatus=phyStatus, siteName=siteName, supplementary=supplementary, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, aAAControl=aAAControl, managementCommittedInformationRate=managementCommittedInformationRate, radioLicenseMaxModulation=radioLicenseMaxModulation, dataPortPauseFrames=dataPortPauseFrames, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPLastSync=sNTPLastSync, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, alignmentMode=alignmentMode, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, sNMPTrapTableEntry=sNMPTrapTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rFUStatus=rFUStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerResponse=sNTPServerResponse, primaryRecoveryPeriod=primaryRecoveryPeriod, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rxDiversityVlanTpid=rxDiversityVlanTpid, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, remoteInternetAddress=remoteInternetAddress, dataPortDisabledWarning=dataPortDisabledWarning, enableTransmission=enableTransmission, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, activeWirelessLinkAvailability=activeWirelessLinkAvailability, fiberY=fiberY, sNTPServerInternetAddressType=sNTPServerInternetAddressType, remotePrimaryMACAddress=remotePrimaryMACAddress, rFUVersionBank2=rFUVersionBank2, qOSPriorityScheme=qOSPriorityScheme, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, productVariant=productVariant, sNTPServerPortNumber=sNTPServerPortNumber, linkNameMismatch=linkNameMismatch, rFUProtectionCompatibility=rFUProtectionCompatibility, hTTPAccessEnabled=hTTPAccessEnabled, rFUStatusTrap=rFUStatusTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, bridge=bridge, vLANManagementVID=vLANManagementVID, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, radioLicenseRegion=radioLicenseRegion, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, radioLicenseMinCodeRate=radioLicenseMinCodeRate, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rFUConnectedPlatform=rFUConnectedPlatform, sMTPServerInternetAddress=sMTPServerInternetAddress, rFUBranchingConfiguration=rFUBranchingConfiguration, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, sNMPTrapVersion=sNMPTrapVersion, activeUnit=activeUnit, sntp=sntp, unitOutOfCalibration=unitOutOfCalibration, systemClock=systemClock, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, iPVersion=iPVersion, transmitCodeRate=transmitCodeRate, rFULockoutAlarm=rFULockoutAlarm, iPDSCPPriorityTable=iPDSCPPriorityTable, maxCodeRate=maxCodeRate, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, wirelessLinkStatus=wirelessLinkStatus, antennaGain=antennaGain, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", receiveCodeRate=receiveCodeRate, endId=endId, sNMPTrapIPAddress=sNMPTrapIPAddress, rFUTxPowerMin=rFUTxPowerMin, neighborIPAddress=neighborIPAddress, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, rFUTxFreqMin=rFUTxFreqMin, l2CPPriorityTableNumber=l2CPPriorityTableNumber, transmitCapacity=transmitCapacity, rFUSerial=rFUSerial, remotePrimaryInternetAddress=remotePrimaryInternetAddress, protectionState=protectionState, remotePrimarySecondaryMode=remotePrimarySecondaryMode, maximumTransmitPower=maximumTransmitPower, radioLicenseIdentifier=radioLicenseIdentifier, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, telnetAccessEnabled=telnetAccessEnabled, radioLicenseModulation=radioLicenseModulation, requestedProtectionState=requestedProtectionState, daylightSaving=daylightSaving, rFUTxPowerAlarm=rFUTxPowerAlarm, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, transmitCapacityLimitDetail=transmitCapacityLimitDetail, timeZone=timeZone, protectionConfigurationStatus=protectionConfigurationStatus, primarySecondaryMode=primarySecondaryMode, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, iFCableLength=iFCableLength, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rFUFreqSpacing=rFUFreqSpacing, sNTPServerTableEntry=sNTPServerTableEntry, ptp800=ptp800, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerTable=sNTPServerTable, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, vectorError=vectorError, versions=versions, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortConfigurationMismatch=dataPortConfigurationMismatch, neighborMACAddress=neighborMACAddress, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, managementMode=managementMode, mPLSTCPriorityTable=mPLSTCPriorityTable, managementPortStatus=managementPortStatus, syslogClientTrap=syslogClientTrap, rxDiversityVid=rxDiversityVid, neighborInternetAddressType=neighborInternetAddressType, securityLevel=securityLevel, remoteSecondaryIPAddress=remoteSecondaryIPAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, radioLicenseBand=radioLicenseBand, managementPortDisabledWarning=managementPortDisabledWarning, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, cambium=cambium, userTableEntry=userTableEntry, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, userRole=userRole, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, aggregateDataRate=aggregateDataRate, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementPortStatusTrap=managementPortStatusTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, remoteMACAddress=remoteMACAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, syslogClient=syslogClient, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, activeAvailableTime=activeAvailableTime, dataPortStatusTrap=dataPortStatusTrap, protectionConfig=protectionConfig, ethernetPriorityTableEntry=ethernetPriorityTableEntry, altitude=altitude, rFUPowerAlarm=rFUPowerAlarm, reset=reset, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, receiveDataRate=receiveDataRate, receiveModulation=receiveModulation, syslogState=syslogState, minCodeRate=minCodeRate, rFUTxMuteStatus=rFUTxMuteStatus, ethernet=ethernet, ptpTraps=ptpTraps, sNMPTrapTable=sNMPTrapTable, rFFeederLoss=rFFeederLoss, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, encryptionEnabledMismatch=encryptionEnabledMismatch)
