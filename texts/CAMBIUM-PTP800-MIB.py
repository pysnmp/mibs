...
Integer32, ModuleIdentity, ObjectIdentity, Counter32, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, Gauge32, Counter64, IpAddress, enterprises, MibIdentifier, Bits, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "ObjectIdentity", "Counter32", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "Gauge32", "Counter64", "IpAddress", "enterprises", "MibIdentifier", "Bits", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", vLANManagementVIDValidation=vLANManagementVIDValidation, wirelessLinkStatus=wirelessLinkStatus, tFTPServerPortNumber=tFTPServerPortNumber, radioLicenseBand=radioLicenseBand, rFUBranchingConfiguration=rFUBranchingConfiguration, userTableNumber=userTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogClient=syslogClient, aAAControl=aAAControl, protectionStats=protectionStats, rFUVersionBank1=rFUVersionBank1, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, transmitCodeRate=transmitCodeRate, rFUTxMuteStatus=rFUTxMuteStatus, rFURxFreqMax=rFURxFreqMax, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, ptmp=ptmp, unitOutOfCalibration=unitOutOfCalibration, protectionAvailabilityStatus=protectionAvailabilityStatus, remoteInternetAddressType=remoteInternetAddressType, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, userTableIndex=userTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rFUTransceiverLocation=rFUTransceiverLocation, remotePrimarySecondaryMode=remotePrimarySecondaryMode, dataPortPauseFrames=dataPortPauseFrames, licence=licence, sMTPEmailAlert=sMTPEmailAlert, managementPortForcedConfiguration=managementPortForcedConfiguration, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, bridge=bridge, rFUPowerAlarm=rFUPowerAlarm, useVLANForManagementInterfaces=useVLANForManagementInterfaces, hTTPAccessEnabled=hTTPAccessEnabled, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, protection=protection, rFUTxFreqMax=rFUTxFreqMax, rFURpsAlarm=rFURpsAlarm, protectionInterfaceStatus=protectionInterfaceStatus, radioLicenseMinModulation=radioLicenseMinModulation, rFULockoutAlarm=rFULockoutAlarm, siteName=siteName, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, managementPortConfigurationMismatch=managementPortConfigurationMismatch, minCodeRate=minCodeRate, dataPortDisabledWarning=dataPortDisabledWarning, subnetMask=subnetMask, radioLicenseBandwidth=radioLicenseBandwidth, antennaGain=antennaGain, sMTPServerIPAddress=sMTPServerIPAddress, maxModulation=maxModulation, tFTPServerIPAddress=tFTPServerIPAddress, primaryRecoveryPeriod=primaryRecoveryPeriod, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, enableTransmission=enableTransmission, productName=productName, userTable=userTable, sNTPServerTimeout=sNTPServerTimeout, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, smtp=smtp, l2CPPriorityTableEntry=l2CPPriorityTableEntry, syslogState=syslogState, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, phyControl=phyControl, hardwareVersion=hardwareVersion, rFUTxPowerMax=rFUTxPowerMax, dSCPManagementPriority=dSCPManagementPriority, localPacketFiltering=localPacketFiltering, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, receivePower=receivePower, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sNMPTrapVersion=sNMPTrapVersion, dataPortStatus=dataPortStatus, alarms=alarms, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, sNTPPrimaryServer=sNTPPrimaryServer, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPEnabledTraps=sNMPEnabledTraps, minModulation=minModulation, transmitCapacityLimit=transmitCapacityLimit, hTTPSPortNumber=hTTPSPortNumber, sNTPSync=sNTPSync, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogLocalWrappedTrap=syslogLocalWrappedTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFUTxPowerMin=rFUTxPowerMin, latitude=latitude, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, telnetAccessEnabled=telnetAccessEnabled, sNTPServerRetries=sNTPServerRetries, hTTPSAccessEnabled=hTTPSAccessEnabled, diverseAntennaGain=diverseAntennaGain, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, gatewayIPAddress=gatewayIPAddress, neighborMACAddress=neighborMACAddress, linkLoss=linkLoss, rFURFSwitchAlarm=rFURFSwitchAlarm, sNMPPortNumber=sNMPPortNumber, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, ptp=ptp, sNTPServerPortNumber=sNTPServerPortNumber, vLANManagementPriority=vLANManagementPriority, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, managementMode=managementMode, remotePrimaryIPAddress=remotePrimaryIPAddress, supplementary=supplementary, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, userPassword=userPassword, receiveModulation=receiveModulation, rFFeederLoss=rFFeederLoss, rFUFreqSpacing=rFUFreqSpacing, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, sNTPState=sNTPState, iPv4Address=iPv4Address, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, radioLicenseRxFreq=radioLicenseRxFreq, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ethernetFiberSupport=ethernetFiberSupport, ethernet=ethernet, linkName=linkName, tFTPServerInternetAddress=tFTPServerInternetAddress, iPv6Address=iPv6Address, sMTPEnabledMessages=sMTPEnabledMessages, aggregateDataRate=aggregateDataRate, neighborInternetAddress=neighborInternetAddress, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rFUTxFreqMin=rFUTxFreqMin, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, alignmentMode=alignmentMode, endId=endId, requestedProtectionState=requestedProtectionState, alignmentModeTrap=alignmentModeTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, protectionState=protectionState, transmitCapacity=transmitCapacity, activeWirelessLinkAvailability=activeWirelessLinkAvailability, userRole=userRole, encryptionAlgorithm=encryptionAlgorithm, transmitDataRate=transmitDataRate, rFURfBand=rFURfBand, secondarySoftwareVersion=secondarySoftwareVersion, maxCodeRate=maxCodeRate, radioLicenseMaxEIRP=radioLicenseMaxEIRP, radioLicenseModulation=radioLicenseModulation, versions=versions, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPServerIPAddress=sNTPServerIPAddress, sNTPLastSync=sNTPLastSync, receiveCodeRate=receiveCodeRate, management=management, rFUCableAlarm=rFUCableAlarm, encryptionEnabledMismatch=encryptionEnabledMismatch, phyStatus=phyStatus, l2CPPriorityTable=l2CPPriorityTable, remotePrimaryInternetAddress=remotePrimaryInternetAddress, managementPortAutoNegotiation=managementPortAutoNegotiation, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, rFUConnectedPlatform=rFUConnectedPlatform, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, ethernetPriorityTable=ethernetPriorityTable, altitude=altitude, protectionSwitchCause=protectionSwitchCause, sNMPCommunityString=sNMPCommunityString, snmpControl=snmpControl, rFUSerial=rFUSerial, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, primaryRecovery=primaryRecovery, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rxDiversityDataPortStatus=rxDiversityDataPortStatus, transmitPower=transmitPower, configuration=configuration, transmitCapacityLimitDetail=transmitCapacityLimitDetail, sNTPServerResponse=sNTPServerResponse, radioLicenseMaxModulation=radioLicenseMaxModulation, managementPortStatusTrap=managementPortStatusTrap, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, radioLicenseIdentifier=radioLicenseIdentifier, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, managementPortDisabledWarning=managementPortDisabledWarning, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, remoteSecondaryIPAddress=remoteSecondaryIPAddress, userEnabled=userEnabled, rFUVersionBank2=rFUVersionBank2, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, tFTPServerInternetAddressType=tFTPServerInternetAddressType, securityLevel=securityLevel, sNTPServerTableEntry=sNTPServerTableEntry, hTTPPortNumber=hTTPPortNumber, sNTPServerTableIndex=sNTPServerTableIndex, mPLSTCPriorityTable=mPLSTCPriorityTable, remoteIPAddress=remoteIPAddress, qOSPriorityScheme=qOSPriorityScheme, userName=userName, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, userTableEntry=userTableEntry, ptp800=ptp800, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, vLANManagementVID=vLANManagementVID, sNTPServerTableNumber=sNTPServerTableNumber, remoteSecondaryMACAddress=remoteSecondaryMACAddress, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rxDiversityVid=rxDiversityVid, radioLicenseRegion=radioLicenseRegion, numberOfAntennas=numberOfAntennas, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPPollInterval=sNTPPollInterval, iPVersion=iPVersion, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFUPowerButtonPressed=rFUPowerButtonPressed, protectionConfigurationStatus=protectionConfigurationStatus, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, remoteInternetAddress=remoteInternetAddress, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, pubStats=pubStats, protectionConfig=protectionConfig, remoteMACAddress=remoteMACAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rFURxFreqMin=rFURxFreqMin, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapPortNumber=sNMPTrapPortNumber, activeUnit=activeUnit, encryption=encryption, rFUStatus=rFUStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUStatusTrap=rFUStatusTrap, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, remoteMaximumTransmitPower=remoteMaximumTransmitPower, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, cambium=cambium, productVariant=productVariant)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", radioLicenseMinCodeRate=radioLicenseMinCodeRate, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, transmitModulation=transmitModulation, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, primarySecondaryMode=primarySecondaryMode, longitude=longitude, aTPCEnable=aTPCEnable, syslogControl=syslogControl, iPv6PrefixLength=iPv6PrefixLength, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, softwareVersion=softwareVersion, protectionStatus=protectionStatus, sNMPTrapTable=sNMPTrapTable, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapInternetAddress=sNMPTrapInternetAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, activeAvailableTime=activeAvailableTime, wirelessLinkStatusTrap=wirelessLinkStatusTrap, daylightSaving=daylightSaving, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, receiveDataRate=receiveDataRate, ethernetPriorityTableIndex=ethernetPriorityTableIndex, radioLicenseTxFreq=radioLicenseTxFreq, transmitterStatus=transmitterStatus, protectionStateTrap=protectionStateTrap, timeZone=timeZone, systemClock=systemClock, diverseRfFeederLoss=diverseRfFeederLoss, bootVersion=bootVersion, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, sntp=sntp, ptpTraps=ptpTraps, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, ptpTrapPrefix=ptpTrapPrefix, sNTPServerTable=sNTPServerTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFUTxPowerAlarm=rFUTxPowerAlarm, dataPortStatusTrap=dataPortStatusTrap, vectorError=vectorError, fiberY=fiberY, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, radioLicenseCodeRate=radioLicenseCodeRate, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, managementCommittedInformationRate=managementCommittedInformationRate, faultProtectionSwitching=faultProtectionSwitching, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rFUTxBandAboveRx=rFUTxBandAboveRx, sNMPTrapTableIndex=sNMPTrapTableIndex, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rFUType=rFUType, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, neighborInternetAddressType=neighborInternetAddressType, systemReset=systemReset, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rFUActiveFirmwareBank=rFUActiveFirmwareBank, secureModeAlarmTrap=secureModeAlarmTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, rxDiversityVlanTpid=rxDiversityVlanTpid, rfu=rfu, sMTPServerPortNumber=sMTPServerPortNumber, neighborIPAddress=neighborIPAddress, telnetPortNumber=telnetPortNumber, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, reset=reset, rFUProtectionCompatibility=rFUProtectionCompatibility, remotePrimaryMACAddress=remotePrimaryMACAddress, linkNameMismatchTrap=linkNameMismatchTrap, radioLicense=radioLicense, dataPortFiberStatus=dataPortFiberStatus, syslogStateTrap=syslogStateTrap, managementPortStatus=managementPortStatus, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, secureModeAlarm=secureModeAlarm, sNTPSyncTrap=sNTPSyncTrap, rFUPlatformCompatibility=rFUPlatformCompatibility, iFCableLength=iFCableLength, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, maximumTransmitPower=maximumTransmitPower, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, linkNameMismatch=linkNameMismatch, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, dataPortWirelessDownAlert=dataPortWirelessDownAlert)
