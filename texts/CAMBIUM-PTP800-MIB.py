...
Gauge32, Integer32, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, iso, enterprises, Counter32, TimeTicks, ModuleIdentity, MibIdentifier, Bits, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "iso", "enterprises", "Counter32", "TimeTicks", "ModuleIdentity", "MibIdentifier", "Bits", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", receiveCodeRate=receiveCodeRate, rFULockoutAlarm=rFULockoutAlarm, protection=protection, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tFTPServerInternetAddress=tFTPServerInternetAddress, hTTPPortNumber=hTTPPortNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userEnabled=userEnabled, secureModeAlarmTrap=secureModeAlarmTrap, protectionState=protectionState, sNTPSyncTrap=sNTPSyncTrap, diverseRfFeederLoss=diverseRfFeederLoss, sMTPServerInternetAddress=sMTPServerInternetAddress, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, vLANManagementPriority=vLANManagementPriority, aAAControl=aAAControl, protectionConfigurationStatus=protectionConfigurationStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ptpTraps=ptpTraps, dataPortStatus=dataPortStatus, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, transmitCodeRate=transmitCodeRate, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFUVersionBank1=rFUVersionBank1, ptp800=ptp800, iPv6GatewayAddress=iPv6GatewayAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityString=sNMPCommunityString, remoteSecondaryMACAddress=remoteSecondaryMACAddress, aggregateDataRate=aggregateDataRate, sNTPServerRetries=sNTPServerRetries, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, sNTPServerIPAddress=sNTPServerIPAddress, enableTransmission=enableTransmission, radioLicenseBand=radioLicenseBand, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, telnetPortNumber=telnetPortNumber, rfu=rfu, managementPortConfigurationMismatch=managementPortConfigurationMismatch, radioLicenseMinModulation=radioLicenseMinModulation, rFUTxBandAboveRx=rFUTxBandAboveRx, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, radioLicenseModulation=radioLicenseModulation, sNMPPortNumber=sNMPPortNumber, protectionInterfaceStatus=protectionInterfaceStatus, dataPortFiberStatus=dataPortFiberStatus, sMTPServerIPAddress=sMTPServerIPAddress, userTable=userTable, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, syslogState=syslogState, ethernet=ethernet, rFURpsAlarm=rFURpsAlarm, radioLicenseMaxModulation=radioLicenseMaxModulation, tFTPServerIPAddress=tFTPServerIPAddress, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, protectionConfig=protectionConfig, enabledDiagnosticAlarms=enabledDiagnosticAlarms, encryptionAlgorithm=encryptionAlgorithm, rFUTxPowerAlarm=rFUTxPowerAlarm, ptp=ptp, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, endId=endId, rFUTxMuteStatus=rFUTxMuteStatus, radioLicenseCodeRate=radioLicenseCodeRate, maxCodeRate=maxCodeRate, transmitCapacityLimit=transmitCapacityLimit, sMTPServerInternetAddressType=sMTPServerInternetAddressType, alignmentModeTrap=alignmentModeTrap, linkNameMismatchTrap=linkNameMismatchTrap, productName=productName, vLANManagementVIDValidation=vLANManagementVIDValidation, hTTPSPortNumber=hTTPSPortNumber, sNTPState=sNTPState, versions=versions, rFUStatusTrap=rFUStatusTrap, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, radioLicenseIdentifier=radioLicenseIdentifier, userRole=userRole, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, userTableEntry=userTableEntry, minModulation=minModulation, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rFUStatus=rFUStatus, receiveDataRate=receiveDataRate, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerTimeout=sNTPServerTimeout, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, pubStats=pubStats, systemClock=systemClock, protectionSwitchCause=protectionSwitchCause, l2CPPriorityTable=l2CPPriorityTable, activeUnit=activeUnit, transmitDataRate=transmitDataRate, activeAvailableTime=activeAvailableTime, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, encryptionEnabledMismatch=encryptionEnabledMismatch, ethernetFiberSupport=ethernetFiberSupport, minCodeRate=minCodeRate, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rFUTxPowerMin=rFUTxPowerMin, sNTPSync=sNTPSync, maximumTransmitPower=maximumTransmitPower, fiberY=fiberY, licence=licence, neighborIPAddress=neighborIPAddress, localPacketFiltering=localPacketFiltering, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, configuration=configuration, managementPortStatus=managementPortStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, subnetMask=subnetMask, mPLSTCPriorityTable=mPLSTCPriorityTable, vLANManagementVID=vLANManagementVID, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, rFUCableAlarm=rFUCableAlarm, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rFUPowerAlarm=rFUPowerAlarm, syslogClientTrap=syslogClientTrap, ethernetPriorityTable=ethernetPriorityTable, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, alarms=alarms, radioLicenseRxFreq=radioLicenseRxFreq, protectionAvailabilityStatus=protectionAvailabilityStatus, transmitterStatus=transmitterStatus, sNMPTrapTable=sNMPTrapTable, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, alignmentMode=alignmentMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, bootVersion=bootVersion, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, iPDSCPPriorityTable=iPDSCPPriorityTable, secondarySoftwareVersion=secondarySoftwareVersion, bridge=bridge, protectionStatus=protectionStatus, supplementary=supplementary, hardwareVersion=hardwareVersion, sNTPServerInternetAddress=sNTPServerInternetAddress, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rFURFSwitchAlarm=rFURFSwitchAlarm, ptmp=ptmp, managementMode=managementMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, hTTPAccessEnabled=hTTPAccessEnabled, rFUTxFreqMin=rFUTxFreqMin, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, linkNameMismatch=linkNameMismatch, sNTPPollInterval=sNTPPollInterval, encryption=encryption, unitOutOfCalibration=unitOutOfCalibration, cambium=cambium, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userName=userName, vectorError=vectorError, syslogClient=syslogClient, neighborInternetAddressType=neighborInternetAddressType, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, linkLoss=linkLoss, longitude=longitude, smtp=smtp, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, protectionStateTrap=protectionStateTrap, rFUFreqSpacing=rFUFreqSpacing, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, primaryRecovery=primaryRecovery, receivePower=receivePower, dataPortStatusTrap=dataPortStatusTrap, antennaGain=antennaGain, sNTPPrimaryServer=sNTPPrimaryServer, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, diverseAntennaGain=diverseAntennaGain, rFUActiveFirmwareBank=rFUActiveFirmwareBank, sntp=sntp, linkName=linkName, iFCableLength=iFCableLength, remotePrimaryInternetAddress=remotePrimaryInternetAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, iPVersion=iPVersion, qOSPriorityScheme=qOSPriorityScheme, syslogStateTrap=syslogStateTrap, remotePrimaryIPAddress=remotePrimaryIPAddress, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, userTableNumber=userTableNumber, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, radioLicenseTxFreq=radioLicenseTxFreq, sNTPServerTable=sNTPServerTable, siteName=siteName, rxDiversityVid=rxDiversityVid, phyControl=phyControl, userTableIndex=userTableIndex, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFUPowerButtonPressed=rFUPowerButtonPressed, rFURxFreqMax=rFURxFreqMax, sNTPLastSync=sNTPLastSync, rFUConnectedPlatform=rFUConnectedPlatform, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, iPv6Address=iPv6Address, tFTPServerPortNumber=tFTPServerPortNumber, transmitPower=transmitPower, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, wirelessLinkStatus=wirelessLinkStatus, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, activeWirelessLinkAvailability=activeWirelessLinkAvailability, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, radioLicense=radioLicense, secureModeAlarm=secureModeAlarm, securityLevel=securityLevel, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, remotePrimarySecondaryMode=remotePrimarySecondaryMode, telnetAccessEnabled=telnetAccessEnabled, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPServerResponse=sNTPServerResponse, radioLicenseRegion=radioLicenseRegion, neighborInternetAddress=neighborInternetAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, softwareVersion=softwareVersion, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, systemReset=systemReset, rFUPlatformCompatibility=rFUPlatformCompatibility, managementPortWirelessDownAlert=managementPortWirelessDownAlert, transmitCapacity=transmitCapacity, iPv6PrefixLength=iPv6PrefixLength, rFUTxPowerMax=rFUTxPowerMax, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, gatewayIPAddress=gatewayIPAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerTableEntry=sNTPServerTableEntry, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFUProtectionCompatibility=rFUProtectionCompatibility, wirelessLinkStatusTrap=wirelessLinkStatusTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", primarySecondaryMode=primarySecondaryMode, remotePrimaryMACAddress=remotePrimaryMACAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rFUBranchingConfiguration=rFUBranchingConfiguration, managementCommittedInformationRate=managementCommittedInformationRate, syslogControl=syslogControl, radioLicenseBandwidth=radioLicenseBandwidth, remoteSecondaryIPAddress=remoteSecondaryIPAddress, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, dataPortPauseFrames=dataPortPauseFrames, wirelessLinkAvailability=wirelessLinkAvailability, remoteIPAddress=remoteIPAddress, dataPortDisabledWarning=dataPortDisabledWarning, rFURxFreqMin=rFURxFreqMin, radioLicenseMinCodeRate=radioLicenseMinCodeRate, ptpTrapPrefix=ptpTrapPrefix, numberOfAntennas=numberOfAntennas, sNMPTrapVersion=sNMPTrapVersion, rFURfBand=rFURfBand, rFUTxFreqMax=rFUTxFreqMax, receiveModulation=receiveModulation, sMTPServerPortNumber=sMTPServerPortNumber, transmitModulation=transmitModulation, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPServerTableIndex=sNTPServerTableIndex, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, remoteInternetAddressType=remoteInternetAddressType, daylightSaving=daylightSaving, altitude=altitude, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, l2CPPriorityTableIndex=l2CPPriorityTableIndex, protectionStats=protectionStats, rxDiversityVlanTpid=rxDiversityVlanTpid, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteMACAddress=remoteMACAddress, transmitCapacityLimitDetail=transmitCapacityLimitDetail, rFFeederLoss=rFFeederLoss, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, snmpControl=snmpControl, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, remoteInternetAddress=remoteInternetAddress, managementPortDisabledWarning=managementPortDisabledWarning, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, dSCPManagementPriority=dSCPManagementPriority, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rFUTransceiverLocation=rFUTransceiverLocation, reset=reset, managementPortStatusTrap=managementPortStatusTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, sNTPServerPortNumber=sNTPServerPortNumber, userPassword=userPassword, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, iPv4Address=iPv4Address, rFUType=rFUType, sNTPServerTableNumber=sNTPServerTableNumber, phyStatus=phyStatus, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sMTPEmailAlert=sMTPEmailAlert, faultProtectionSwitching=faultProtectionSwitching, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, primaryRecoveryPeriod=primaryRecoveryPeriod, sNMPEnabledTraps=sNMPEnabledTraps, management=management, timeZone=timeZone, managementPortAutoNegotiation=managementPortAutoNegotiation, sMTPEnabledMessages=sMTPEnabledMessages, productVariant=productVariant, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, maxModulation=maxModulation, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, aTPCEnable=aTPCEnable, managementPortForcedConfiguration=managementPortForcedConfiguration, latitude=latitude, rFUSerial=rFUSerial, neighborMACAddress=neighborMACAddress, rFUVersionBank2=rFUVersionBank2, requestedProtectionState=requestedProtectionState, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rxDiversityDataPortStatus=rxDiversityDataPortStatus, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm)
