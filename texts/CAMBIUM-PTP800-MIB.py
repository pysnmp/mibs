...
Counter64, MibIdentifier, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, iso, TimeTicks, Gauge32, IpAddress, NotificationType, Unsigned32, enterprises, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "iso", "TimeTicks", "Gauge32", "IpAddress", "NotificationType", "Unsigned32", "enterprises", "Bits", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUCableAlarm=rFUCableAlarm, rFFeederLoss=rFFeederLoss, longitude=longitude, timeZone=timeZone, protectionStateTrap=protectionStateTrap, minModulation=minModulation, daylightSaving=daylightSaving, radioLicenseIdentifier=radioLicenseIdentifier, rFUTransceiverLocation=rFUTransceiverLocation, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, linkNameMismatchTrap=linkNameMismatchTrap, tFTPServerPortNumber=tFTPServerPortNumber, radioLicenseRxFreq=radioLicenseRxFreq, vLANManagementPriority=vLANManagementPriority, managementPortStatusTrap=managementPortStatusTrap, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, remoteSecondaryMACAddress=remoteSecondaryMACAddress, neighborIPAddress=neighborIPAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rxDiversityVid=rxDiversityVid, rFUTxPowerAlarm=rFUTxPowerAlarm, ptmp=ptmp, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, syslogControl=syslogControl, receiveDataRate=receiveDataRate, dataPortStatusTrap=dataPortStatusTrap, rxDiversityVlanTpid=rxDiversityVlanTpid, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, antennaGain=antennaGain, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, primaryRecovery=primaryRecovery, remotePrimaryInternetAddress=remotePrimaryInternetAddress, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, managementPortWirelessDownAlert=managementPortWirelessDownAlert, maxCodeRate=maxCodeRate, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, sNTPServerTable=sNTPServerTable, dataPortStatus=dataPortStatus, wirelessLinkAvailability=wirelessLinkAvailability, bootVersion=bootVersion, qOSPriorityScheme=qOSPriorityScheme, alarms=alarms, rFUStatus=rFUStatus, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, hardwareVersion=hardwareVersion, rFUVersionBank1=rFUVersionBank1, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, radioLicenseTxFreq=radioLicenseTxFreq, wirelessLinkStatusTrap=wirelessLinkStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, protectionStats=protectionStats, rFUStatusTrap=rFUStatusTrap, reset=reset, bridge=bridge, iPDSCPPriorityTable=iPDSCPPriorityTable, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, sNTPServerIPAddress=sNTPServerIPAddress, remotePrimarySecondaryMode=remotePrimarySecondaryMode, iFCableLength=iFCableLength, remoteInternetAddressType=remoteInternetAddressType, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerRetries=sNTPServerRetries, encryptionAlgorithm=encryptionAlgorithm, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, productName=productName, protectionInterfaceStatus=protectionInterfaceStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, managementPortAutoNegotiation=managementPortAutoNegotiation, sNMPPortNumber=sNMPPortNumber, snmpControl=snmpControl, neighborInternetAddressType=neighborInternetAddressType, userPassword=userPassword, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, systemClock=systemClock, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, aAAControl=aAAControl, activeUnit=activeUnit, neighborMACAddress=neighborMACAddress, cambium=cambium, requestedProtectionState=requestedProtectionState, phyStatus=phyStatus, rFUSerial=rFUSerial, gatewayIPAddress=gatewayIPAddress, neighborInternetAddress=neighborInternetAddress, rFUProtectionCompatibility=rFUProtectionCompatibility, sMTPEnabledMessages=sMTPEnabledMessages, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, userEnabled=userEnabled, telnetPortNumber=telnetPortNumber, siteName=siteName, sNMPTrapVersion=sNMPTrapVersion, managementMode=managementMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNMPEnabledTraps=sNMPEnabledTraps, syslogState=syslogState, ethernetPriorityTableEntry=ethernetPriorityTableEntry, userTableEntry=userTableEntry, linkName=linkName, telnetAccessEnabled=telnetAccessEnabled, rFURxFreqMax=rFURxFreqMax, sNTPServerResponse=sNTPServerResponse, ptp=ptp, rFUVersionBank2=rFUVersionBank2, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, userTable=userTable, ptpTrapPrefix=ptpTrapPrefix, rFUBranchingConfiguration=rFUBranchingConfiguration, primaryRecoveryPeriod=primaryRecoveryPeriod, radioLicenseMinModulation=radioLicenseMinModulation, radioLicenseRegion=radioLicenseRegion, dataPortPauseFrames=dataPortPauseFrames, activeAvailableTime=activeAvailableTime, protectionConfig=protectionConfig, encryptionEnabledMismatch=encryptionEnabledMismatch, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, syslogLocalWrappedTrap=syslogLocalWrappedTrap, protectionStatus=protectionStatus, iPv6GatewayAddress=iPv6GatewayAddress, subnetMask=subnetMask, dSCPManagementPriority=dSCPManagementPriority, localPacketFiltering=localPacketFiltering, enabledDiagnosticAlarms=enabledDiagnosticAlarms, remoteInternetAddress=remoteInternetAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPVersion=iPVersion, transmitModulation=transmitModulation, remotePrimaryIPAddress=remotePrimaryIPAddress, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFUTxMuteStatus=rFUTxMuteStatus, radioLicenseMinCodeRate=radioLicenseMinCodeRate, l2CPPriorityTable=l2CPPriorityTable, transmitterStatus=transmitterStatus, versions=versions, rFURfBand=rFURfBand, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, hTTPAccessEnabled=hTTPAccessEnabled, radioLicense=radioLicense, phyControl=phyControl, radioLicenseBand=radioLicenseBand, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, softwareVersion=softwareVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPSyncTrap=sNTPSyncTrap, protectionAvailabilityStatus=protectionAvailabilityStatus, sNTPPollInterval=sNTPPollInterval, alignmentMode=alignmentMode, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortDisabledWarning=dataPortDisabledWarning, sNTPPrimaryServer=sNTPPrimaryServer, l2CPPriorityTableIndex=l2CPPriorityTableIndex, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, dataPortFiberStatus=dataPortFiberStatus, rFULockoutAlarm=rFULockoutAlarm, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, sNTPServerTableIndex=sNTPServerTableIndex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, protectionSwitchCause=protectionSwitchCause, sMTPServerInternetAddressType=sMTPServerInternetAddressType, encryption=encryption, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rFUTxBandAboveRx=rFUTxBandAboveRx, userName=userName, configuration=configuration, latitude=latitude, protectionState=protectionState, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, alignmentModeTrap=alignmentModeTrap, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, vectorError=vectorError, minCodeRate=minCodeRate, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, receivePower=receivePower, primarySecondaryMode=primarySecondaryMode, aTPCEnable=aTPCEnable, sNMPTrapTable=sNMPTrapTable, managementPortForcedConfiguration=managementPortForcedConfiguration, mPLSTCPriorityTable=mPLSTCPriorityTable, maxModulation=maxModulation, wirelessLinkStatus=wirelessLinkStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, pubStats=pubStats, ethernetPriorityTableIndex=ethernetPriorityTableIndex, radioLicenseCodeRate=radioLicenseCodeRate, diverseRfFeederLoss=diverseRfFeederLoss, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFUPowerAlarm=rFUPowerAlarm, managementPortDisabledWarning=managementPortDisabledWarning, sMTPServerIPAddress=sMTPServerIPAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerTableNumber=sNTPServerTableNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, sMTPEmailAlert=sMTPEmailAlert, securityLevel=securityLevel, sNTPLastSync=sNTPLastSync, ethernetPriorityTable=ethernetPriorityTable, rFURFSwitchAlarm=rFURFSwitchAlarm, syslogClient=syslogClient, maximumTransmitPower=maximumTransmitPower, syslogStateTrap=syslogStateTrap, numberOfAntennas=numberOfAntennas, rFUConnectedPlatform=rFUConnectedPlatform, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rxDiversityDataPortStatus=rxDiversityDataPortStatus, aggregateDataRate=aggregateDataRate, rFURxFreqMin=rFURxFreqMin, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, transmitCapacityLimitDetail=transmitCapacityLimitDetail, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rFUFreqSpacing=rFUFreqSpacing, supplementary=supplementary, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, managementPortStatus=managementPortStatus, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, secureModeAlarmTrap=secureModeAlarmTrap, transmitCapacityLimit=transmitCapacityLimit, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, ethernetFiberSupport=ethernetFiberSupport, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, receiveModulation=receiveModulation, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, secondarySoftwareVersion=secondarySoftwareVersion, tFTPServerIPAddress=tFTPServerIPAddress, sNTPSync=sNTPSync, sNTPServerPortNumber=sNTPServerPortNumber, enableTransmission=enableTransmission, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapInternetAddress=sNMPTrapInternetAddress, remoteIPAddress=remoteIPAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, rFUActiveFirmwareBank=rFUActiveFirmwareBank)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", iPv6PrefixLength=iPv6PrefixLength, userTableNumber=userTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortConfigurationMismatch=dataPortConfigurationMismatch, radioLicenseMaxModulation=radioLicenseMaxModulation, remoteMACAddress=remoteMACAddress, remotePrimaryMACAddress=remotePrimaryMACAddress, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, sNTPServerTimeout=sNTPServerTimeout, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, transmitCapacity=transmitCapacity, radioLicenseModulation=radioLicenseModulation, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, receiveCodeRate=receiveCodeRate, l2CPPriorityTableNumber=l2CPPriorityTableNumber, transmitCodeRate=transmitCodeRate, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rFUTxPowerMax=rFUTxPowerMax, protectionConfigurationStatus=protectionConfigurationStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, productVariant=productVariant, systemReset=systemReset, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, fiberY=fiberY, secureModeAlarm=secureModeAlarm, tFTPServerInternetAddressType=tFTPServerInternetAddressType, transmitDataRate=transmitDataRate, transmitPower=transmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber, rfu=rfu, rFUPlatformCompatibility=rFUPlatformCompatibility, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, protection=protection, sntp=sntp, hTTPSPortNumber=hTTPSPortNumber, ethernet=ethernet, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, userRole=userRole, managementCommittedInformationRate=managementCommittedInformationRate, endId=endId, linkLoss=linkLoss, faultProtectionSwitching=faultProtectionSwitching, syslogClientTrap=syslogClientTrap, sNTPServerTableEntry=sNTPServerTableEntry, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, smtp=smtp, altitude=altitude, linkNameMismatch=linkNameMismatch, ethernetPriorityTableNumber=ethernetPriorityTableNumber, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, sNTPState=sNTPState, radioLicenseMaxEIRP=radioLicenseMaxEIRP, vLANManagementVIDValidation=vLANManagementVIDValidation, diverseAntennaGain=diverseAntennaGain, rFUTxFreqMin=rFUTxFreqMin, rFURpsAlarm=rFURpsAlarm, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, hTTPPortNumber=hTTPPortNumber, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, sMTPServerPortNumber=sMTPServerPortNumber, vLANManagementVID=vLANManagementVID, ptp800=ptp800, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rFUPowerButtonPressed=rFUPowerButtonPressed, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, userTableIndex=userTableIndex, radioLicenseBandwidth=radioLicenseBandwidth, sNMPCommunityString=sNMPCommunityString, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, management=management, licence=licence, rFUTxFreqMax=rFUTxFreqMax, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rFUTxPowerMin=rFUTxPowerMin, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFUType=rFUType, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, iPv4Address=iPv4Address, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteSecondaryIPAddress=remoteSecondaryIPAddress, iPv6Address=iPv6Address, sNMPTrapTableIndex=sNMPTrapTableIndex)
