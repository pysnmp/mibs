...
Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, MibIdentifier, Counter64, enterprises, Unsigned32, Gauge32, Integer32, TimeTicks, Bits, NotificationType, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "MibIdentifier", "Counter64", "enterprises", "Unsigned32", "Gauge32", "Integer32", "TimeTicks", "Bits", "NotificationType", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", unitOutOfCalibration=unitOutOfCalibration, rFUTxPowerAlarm=rFUTxPowerAlarm, maximumTransmitPower=maximumTransmitPower, sMTPEmailAlert=sMTPEmailAlert, rFULockoutAlarm=rFULockoutAlarm, userPassword=userPassword, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, remotePrimaryInternetAddress=remotePrimaryInternetAddress, sNTPServerTable=sNTPServerTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, syslogStateTrap=syslogStateTrap, primaryRecovery=primaryRecovery, protectionConfig=protectionConfig, managementPortDisabledWarning=managementPortDisabledWarning, rxDiversityDataPortStatus=rxDiversityDataPortStatus, protectionStatus=protectionStatus, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, altitude=altitude, requestedProtectionState=requestedProtectionState, management=management, maxModulation=maxModulation, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, managementMode=managementMode, radioLicense=radioLicense, gatewayIPAddress=gatewayIPAddress, sNMPPortNumber=sNMPPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, neighborInternetAddress=neighborInternetAddress, radioLicenseRegion=radioLicenseRegion, managementPortAutoNegotiation=managementPortAutoNegotiation, rFUTxPowerMin=rFUTxPowerMin, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, snmpControl=snmpControl, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, userTableIndex=userTableIndex, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rFUVersionBank1=rFUVersionBank1, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPCommunityString=sNMPCommunityString, iFCableLength=iFCableLength, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rFURxFreqMin=rFURxFreqMin, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPServerTimeout=sNTPServerTimeout, sNTPPrimaryServer=sNTPPrimaryServer, encryptionAlgorithm=encryptionAlgorithm, systemReset=systemReset, protectionInterfaceStatus=protectionInterfaceStatus, neighborInternetAddressType=neighborInternetAddressType, transmitCapacityLimitDetail=transmitCapacityLimitDetail, tFTPServerPortNumber=tFTPServerPortNumber, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, vectorError=vectorError, sNTPState=sNTPState, rFUTxMuteStatus=rFUTxMuteStatus, rFUType=rFUType, rFUTxPowerMax=rFUTxPowerMax, l2CPPriorityTable=l2CPPriorityTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, protectionAvailabilityStatus=protectionAvailabilityStatus, productName=productName, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, enableTransmission=enableTransmission, protection=protection, sntp=sntp, ethernet=ethernet, radioLicenseMaxEIRP=radioLicenseMaxEIRP, iPv6Address=iPv6Address, alignmentMode=alignmentMode, sNMPTrapTableNumber=sNMPTrapTableNumber, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rFUSerial=rFUSerial, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remotePrimarySecondaryMode=remotePrimarySecondaryMode, linkName=linkName, radioLicenseIdentifier=radioLicenseIdentifier, userTableEntry=userTableEntry, rFUStatus=rFUStatus, linkNameMismatch=linkNameMismatch, hTTPSAccessEnabled=hTTPSAccessEnabled, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, securityLevel=securityLevel, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, managementPortStatusTrap=managementPortStatusTrap, rFUCableAlarm=rFUCableAlarm, rFUTxFreqMin=rFUTxFreqMin, sNTPPollInterval=sNTPPollInterval, sNTPServerIPAddress=sNTPServerIPAddress, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, telnetPortNumber=telnetPortNumber, radioLicenseRxFreq=radioLicenseRxFreq, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ptp=ptp, rFUPlatformCompatibility=rFUPlatformCompatibility, protectionStateTrap=protectionStateTrap, rFUTransceiverLocation=rFUTransceiverLocation, transmitModulation=transmitModulation, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, remoteSecondaryIPAddress=remoteSecondaryIPAddress, syslogClient=syslogClient, sNMPTrapPortNumber=sNMPTrapPortNumber, rFURxFreqMax=rFURxFreqMax, numberOfAntennas=numberOfAntennas, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rFFeederLoss=rFFeederLoss, reset=reset, sNTPServerTableIndex=sNTPServerTableIndex, neighborIPAddress=neighborIPAddress, latitude=latitude, linkNameMismatchTrap=linkNameMismatchTrap, rFURfBand=rFURfBand, tFTPServerIPAddress=tFTPServerIPAddress, vLANManagementVID=vLANManagementVID, phyControl=phyControl, encryption=encryption, fiberY=fiberY, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, primarySecondaryMode=primarySecondaryMode, pubStats=pubStats, sNTPServerRetries=sNTPServerRetries, sNTPServerTableEntry=sNTPServerTableEntry, transmitCapacity=transmitCapacity, remoteInternetAddressType=remoteInternetAddressType, sNTPServerResponse=sNTPServerResponse, sMTPServerInternetAddress=sMTPServerInternetAddress, radioLicenseMinModulation=radioLicenseMinModulation, licence=licence, siteName=siteName, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPServerTableNumber=sNTPServerTableNumber, aAAControl=aAAControl, protectionState=protectionState, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, rFUPowerButtonPressed=rFUPowerButtonPressed, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rFURpsAlarm=rFURpsAlarm, ethernetPriorityTableNumber=ethernetPriorityTableNumber, phyStatus=phyStatus, remoteMACAddress=remoteMACAddress, iPv6GatewayAddress=iPv6GatewayAddress, dSCPManagementPriority=dSCPManagementPriority, cambium=cambium, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, encryptionEnabledMismatch=encryptionEnabledMismatch, configuration=configuration, bridge=bridge, activeAvailableTime=activeAvailableTime, transmitCodeRate=transmitCodeRate, sNMPTrapTableIndex=sNMPTrapTableIndex, iPv6PrefixLength=iPv6PrefixLength, wirelessLinkStatusTrap=wirelessLinkStatusTrap, aggregateDataRate=aggregateDataRate, sNMPEnabledTraps=sNMPEnabledTraps, secondarySoftwareVersion=secondarySoftwareVersion, remotePrimaryMACAddress=remotePrimaryMACAddress, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, versions=versions, activeWirelessLinkAvailability=activeWirelessLinkAvailability, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFUPowerAlarm=rFUPowerAlarm, managementPortStatus=managementPortStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPv4Address=iPv4Address, dataPortStatusTrap=dataPortStatusTrap, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, sNTPSyncTrap=sNTPSyncTrap, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, protectionSwitchCause=protectionSwitchCause, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, userName=userName, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, hardwareVersion=hardwareVersion, softwareVersion=softwareVersion, syslogState=syslogState, antennaGain=antennaGain, maxCodeRate=maxCodeRate, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, radioLicenseMinCodeRate=radioLicenseMinCodeRate, telnetAccessEnabled=telnetAccessEnabled, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, aTPCEnable=aTPCEnable, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, remoteInternetAddress=remoteInternetAddress, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, remoteIPAddress=remoteIPAddress, smtp=smtp, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, hTTPSPortNumber=hTTPSPortNumber, transmitPower=transmitPower, radioLicenseModulation=radioLicenseModulation, minModulation=minModulation, rFUProtectionCompatibility=rFUProtectionCompatibility, vLANManagementVIDValidation=vLANManagementVIDValidation, rFUActiveFirmwareBank=rFUActiveFirmwareBank, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, userRole=userRole, iPDSCPPriorityTable=iPDSCPPriorityTable, minCodeRate=minCodeRate, sNMPTrapTableEntry=sNMPTrapTableEntry, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, ethernetPriorityTable=ethernetPriorityTable, receivePower=receivePower, transmitCapacityLimit=transmitCapacityLimit, managementCommittedInformationRate=managementCommittedInformationRate, primaryRecoveryPeriod=primaryRecoveryPeriod, dataPortPauseFrames=dataPortPauseFrames, qOSPriorityScheme=qOSPriorityScheme, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, protectionStats=protectionStats, wirelessLinkStatus=wirelessLinkStatus, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, rfu=rfu, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, subnetMask=subnetMask, tFTPServerInternetAddressType=tFTPServerInternetAddressType, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPVersion=iPVersion, longitude=longitude, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveCodeRate=receiveCodeRate, radioLicenseBand=radioLicenseBand, rxDiversityVlanTpid=rxDiversityVlanTpid, activeUnit=activeUnit, supplementary=supplementary, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUVersionBank2=rFUVersionBank2, sNTPServerInternetAddress=sNTPServerInternetAddress, rFURFSwitchAlarm=rFURFSwitchAlarm, userTable=userTable, remotePrimaryIPAddress=remotePrimaryIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortDisabledWarning=dataPortDisabledWarning, ethernetFiberSupport=ethernetFiberSupport, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, rFUFreqSpacing=rFUFreqSpacing, alignmentModeTrap=alignmentModeTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapTable=sNMPTrapTable, managementPortConfigurationMismatch=managementPortConfigurationMismatch, radioLicenseMaxModulation=radioLicenseMaxModulation, daylightSaving=daylightSaving, sNTPLastSync=sNTPLastSync, rFUConnectedPlatform=rFUConnectedPlatform, sNMPTrapIPAddress=sNMPTrapIPAddress, radioLicenseCodeRate=radioLicenseCodeRate, mPLSTCPriorityTable=mPLSTCPriorityTable, wirelessLinkAvailability=wirelessLinkAvailability, alarms=alarms, hTTPPortNumber=hTTPPortNumber, transmitDataRate=transmitDataRate, ptp800=ptp800, vLANManagementPriority=vLANManagementPriority, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, userTableNumber=userTableNumber, rFUTxFreqMax=rFUTxFreqMax, productVariant=productVariant, endId=endId, rFUBranchingConfiguration=rFUBranchingConfiguration, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, localPacketFiltering=localPacketFiltering, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, diverseAntennaGain=diverseAntennaGain, secureModeAlarmTrap=secureModeAlarmTrap, ptpTraps=ptpTraps, secureModeAlarm=secureModeAlarm, diverseRfFeederLoss=diverseRfFeederLoss, rxDiversityVid=rxDiversityVid, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, receiveModulation=receiveModulation, managementPortWirelessDownAlert=managementPortWirelessDownAlert, remoteSecondaryMACAddress=remoteSecondaryMACAddress, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, userEnabled=userEnabled, managementPortForcedConfiguration=managementPortForcedConfiguration, ptmp=ptmp, dataPortFiberStatus=dataPortFiberStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, transmitterStatus=transmitterStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortStatus=dataPortStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, bootVersion=bootVersion, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, systemClock=systemClock, rFUTxBandAboveRx=rFUTxBandAboveRx, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPAccessEnabled=hTTPAccessEnabled, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syslogControl=syslogControl, dataPortConfigurationMismatch=dataPortConfigurationMismatch, radioLicenseBandwidth=radioLicenseBandwidth, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptpTrapPrefix=ptpTrapPrefix, radioLicenseTxFreq=radioLicenseTxFreq, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rFUStatusTrap=rFUStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, timeZone=timeZone, neighborMACAddress=neighborMACAddress, protectionConfigurationStatus=protectionConfigurationStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, faultProtectionSwitching=faultProtectionSwitching, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, linkLoss=linkLoss, sNTPSync=sNTPSync, syslogClientTrap=syslogClientTrap, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, receiveDataRate=receiveDataRate)
