...
ObjectIdentity, IpAddress, Bits, Integer32, iso, Counter32, Counter64, NotificationType, ModuleIdentity, Unsigned32, TimeTicks, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Bits", "Integer32", "iso", "Counter32", "Counter64", "NotificationType", "ModuleIdentity", "Unsigned32", "TimeTicks", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, primarySecondaryMode=primarySecondaryMode, remoteMACAddress=remoteMACAddress, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, userTableEntry=userTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, transmitModulation=transmitModulation, minCodeRate=minCodeRate, receiveModulation=receiveModulation, vLANManagementVID=vLANManagementVID, bootVersion=bootVersion, managementPortWirelessDownAlert=managementPortWirelessDownAlert, versions=versions, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, iPv6GatewayAddress=iPv6GatewayAddress, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, remoteSecondaryIPAddress=remoteSecondaryIPAddress, telnetPortNumber=telnetPortNumber, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, radioLicenseIdentifier=radioLicenseIdentifier, sNMPTrapTableNumber=sNMPTrapTableNumber, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, linkName=linkName, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rfu=rfu, ptp=ptp, enabledDiagnosticAlarms=enabledDiagnosticAlarms, radioLicenseCodeRate=radioLicenseCodeRate, sNTPState=sNTPState, securityLevel=securityLevel, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, qOSPriorityScheme=qOSPriorityScheme, managementMode=managementMode, radioLicenseRxFreq=radioLicenseRxFreq, remotePrimaryMACAddress=remotePrimaryMACAddress, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, syslogClient=syslogClient, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementPortDisabledWarning=managementPortDisabledWarning, remoteInternetAddress=remoteInternetAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dSCPManagementPriority=dSCPManagementPriority, ptpTrapPrefix=ptpTrapPrefix, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, tFTPServerIPAddress=tFTPServerIPAddress, transmitCapacityLimit=transmitCapacityLimit, sNTPServerInternetAddress=sNTPServerInternetAddress, encryption=encryption, ethernetPriorityTable=ethernetPriorityTable, requestedProtectionState=requestedProtectionState, secureModeAlarm=secureModeAlarm, productVariant=productVariant, daylightSaving=daylightSaving, rFUFreqSpacing=rFUFreqSpacing, dataPortFiberStatus=dataPortFiberStatus, aAAControl=aAAControl, rFUTransceiverLocation=rFUTransceiverLocation, rFUTxFreqMax=rFUTxFreqMax, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, iPVersion=iPVersion, receiveDataRate=receiveDataRate, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remotePrimarySecondaryMode=remotePrimarySecondaryMode, remoteIPAddress=remoteIPAddress, radioLicenseMaxModulation=radioLicenseMaxModulation, rFUPlatformCompatibility=rFUPlatformCompatibility, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, neighborMACAddress=neighborMACAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, iPv6PrefixLength=iPv6PrefixLength, cambium=cambium, rFURpsAlarm=rFURpsAlarm, sNTPLastSync=sNTPLastSync, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, protectionInterfaceStatus=protectionInterfaceStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, linkLoss=linkLoss, linkNameMismatchTrap=linkNameMismatchTrap, hTTPAccessEnabled=hTTPAccessEnabled, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, managementPortForcedConfiguration=managementPortForcedConfiguration, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, protectionAvailabilityStatus=protectionAvailabilityStatus, timeZone=timeZone, iPDSCPPriorityTable=iPDSCPPriorityTable, radioLicenseMinCodeRate=radioLicenseMinCodeRate, protectionStatus=protectionStatus, sNTPServerResponse=sNTPServerResponse, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, snmpControl=snmpControl, softwareVersion=softwareVersion, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, phyStatus=phyStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, userTableIndex=userTableIndex, latitude=latitude, sNTPServerPortNumber=sNTPServerPortNumber, dataPortStatus=dataPortStatus, phyControl=phyControl, antennaGain=antennaGain, sNMPTrapInternetAddress=sNMPTrapInternetAddress, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, maxCodeRate=maxCodeRate, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, fiberY=fiberY, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkStatus=wirelessLinkStatus, bridge=bridge, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tFTPServerInternetAddressType=tFTPServerInternetAddressType, userTable=userTable, dataPortPauseFrames=dataPortPauseFrames, rFUCableAlarm=rFUCableAlarm, vectorError=vectorError, managementPortAutoNegotiation=managementPortAutoNegotiation, sNTPServerTableNumber=sNTPServerTableNumber, ptpTraps=ptpTraps, localPacketFiltering=localPacketFiltering, rFUVersionBank1=rFUVersionBank1, activeAvailableTime=activeAvailableTime, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, diverseAntennaGain=diverseAntennaGain, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sntp=sntp, userName=userName, syslogStateTrap=syslogStateTrap, rFUTxPowerAlarm=rFUTxPowerAlarm, rFUPowerButtonPressed=rFUPowerButtonPressed, ptmp=ptmp, alarms=alarms, sMTPEnabledMessages=sMTPEnabledMessages, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, pubStats=pubStats, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapVersion=sNMPTrapVersion, longitude=longitude, rFUTxPowerMax=rFUTxPowerMax, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rFUSerial=rFUSerial, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogState=syslogState, remotePrimaryInternetAddress=remotePrimaryInternetAddress, managementPortStatusTrap=managementPortStatusTrap, numberOfAntennas=numberOfAntennas, reset=reset, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPCommunityString=sNMPCommunityString, syslogClientTrap=syslogClientTrap, rFUConnectedPlatform=rFUConnectedPlatform, remoteInternetAddressType=remoteInternetAddressType, smtp=smtp, sNTPPollInterval=sNTPPollInterval, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, sNTPSyncTrap=sNTPSyncTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, protection=protection, alignmentMode=alignmentMode, radioLicenseModulation=radioLicenseModulation, aTPCEnable=aTPCEnable, rFUVersionBank2=rFUVersionBank2, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, radioLicenseMinModulation=radioLicenseMinModulation, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, radioLicenseBandwidth=radioLicenseBandwidth, remoteMaximumTransmitPower=remoteMaximumTransmitPower, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, wirelessLinkStatusTrap=wirelessLinkStatusTrap, ptp800=ptp800, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, encryptionEnabledMismatch=encryptionEnabledMismatch, primaryRecoveryPeriod=primaryRecoveryPeriod, protectionState=protectionState, configuration=configuration, sNMPPortNumber=sNMPPortNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, managementCommittedInformationRate=managementCommittedInformationRate, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, supplementary=supplementary, rFURfBand=rFURfBand, activeWirelessLinkAvailability=activeWirelessLinkAvailability, secureModeAlarmTrap=secureModeAlarmTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rFURFSwitchAlarm=rFURFSwitchAlarm, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, management=management, userPassword=userPassword, endId=endId, radioLicenseMaxEIRP=radioLicenseMaxEIRP, minModulation=minModulation, rFUStatus=rFUStatus, aggregateDataRate=aggregateDataRate, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, rFURxFreqMin=rFURxFreqMin, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, radioLicenseRegion=radioLicenseRegion, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, neighborIPAddress=neighborIPAddress, rFFeederLoss=rFFeederLoss, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, userEnabled=userEnabled, rFUPowerAlarm=rFUPowerAlarm, unitOutOfCalibration=unitOutOfCalibration, sMTPEmailAlert=sMTPEmailAlert, rFUBranchingConfiguration=rFUBranchingConfiguration, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerPortNumber=sMTPServerPortNumber, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, maximumTransmitPower=maximumTransmitPower, rFUTxFreqMin=rFUTxFreqMin, subnetMask=subnetMask, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, productName=productName, l2CPPriorityTableIndex=l2CPPriorityTableIndex, systemClock=systemClock, neighborInternetAddress=neighborInternetAddress, rFUTxPowerMin=rFUTxPowerMin, userRole=userRole, transmitPower=transmitPower, protectionStateTrap=protectionStateTrap, enableTransmission=enableTransmission, secondarySoftwareVersion=secondarySoftwareVersion, neighborInternetAddressType=neighborInternetAddressType, rFUTxBandAboveRx=rFUTxBandAboveRx, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPServerTableIndex=sNTPServerTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hardwareVersion=hardwareVersion, sNTPServerTable=sNTPServerTable, transmitCapacityLimitDetail=transmitCapacityLimitDetail)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", licence=licence, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, vLANManagementPriority=vLANManagementPriority, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telnetAccessEnabled=telnetAccessEnabled, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, ethernet=ethernet, radioLicenseTxFreq=radioLicenseTxFreq, protectionConfig=protectionConfig, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, diverseRfFeederLoss=diverseRfFeederLoss, hTTPSPortNumber=hTTPSPortNumber, transmitCapacity=transmitCapacity, linkNameMismatch=linkNameMismatch, dataPortDisabledWarning=dataPortDisabledWarning, transmitterStatus=transmitterStatus, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, protectionStats=protectionStats, primaryRecovery=primaryRecovery, rFUType=rFUType, dataPortWirelessDownAlert=dataPortWirelessDownAlert, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tFTPServerInternetAddress=tFTPServerInternetAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapTable=sNMPTrapTable, syslogControl=syslogControl, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPEnabledTraps=sNMPEnabledTraps, sNTPPrimaryServer=sNTPPrimaryServer, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rFURxFreqMax=rFURxFreqMax, rFULockoutAlarm=rFULockoutAlarm, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetFiberSupport=ethernetFiberSupport, sNTPSync=sNTPSync, sNTPServerTimeout=sNTPServerTimeout, dataPortStatusTrap=dataPortStatusTrap, maxModulation=maxModulation, receivePower=receivePower, rxDiversityVid=rxDiversityVid, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, faultProtectionSwitching=faultProtectionSwitching, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, userTableNumber=userTableNumber, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, encryptionAlgorithm=encryptionAlgorithm, radioLicense=radioLicense, iPv4Address=iPv4Address, receiveCodeRate=receiveCodeRate, transmitCodeRate=transmitCodeRate, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerTableEntry=sNTPServerTableEntry, systemReset=systemReset, radioLicenseBand=radioLicenseBand, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, remotePrimaryIPAddress=remotePrimaryIPAddress, sNTPServerRetries=sNTPServerRetries, iPv6Address=iPv6Address, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetPriorityTableIndex=ethernetPriorityTableIndex, l2CPPriorityTable=l2CPPriorityTable, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, altitude=altitude, rxDiversityVlanTpid=rxDiversityVlanTpid, remoteSecondaryMACAddress=remoteSecondaryMACAddress, activeUnit=activeUnit, iFCableLength=iFCableLength, gatewayIPAddress=gatewayIPAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rFUTxMuteStatus=rFUTxMuteStatus, tFTPServerPortNumber=tFTPServerPortNumber, transmitDataRate=transmitDataRate, protectionSwitchCause=protectionSwitchCause, rFUProtectionCompatibility=rFUProtectionCompatibility, protectionConfigurationStatus=protectionConfigurationStatus, siteName=siteName, managementPortStatus=managementPortStatus, alignmentModeTrap=alignmentModeTrap, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rFUStatusTrap=rFUStatusTrap, vLANManagementVIDValidation=vLANManagementVIDValidation)
