...
Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, TimeTicks, MibIdentifier, Integer32, iso, ObjectIdentity, NotificationType, enterprises, Counter32, Bits, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "TimeTicks", "MibIdentifier", "Integer32", "iso", "ObjectIdentity", "NotificationType", "enterprises", "Counter32", "Bits", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", primarySecondaryMode=primarySecondaryMode, sNTPSyncTrap=sNTPSyncTrap, sNTPServerResponse=sNTPServerResponse, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, gatewayIPAddress=gatewayIPAddress, remoteSecondaryIPAddress=remoteSecondaryIPAddress, sMTPServerIPAddress=sMTPServerIPAddress, managementPortStatusTrap=managementPortStatusTrap, neighborIPAddress=neighborIPAddress, sNTPServerRetries=sNTPServerRetries, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, transmitCapacityLimitDetail=transmitCapacityLimitDetail, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPServerIPAddress=sNTPServerIPAddress, transmitCodeRate=transmitCodeRate, userTable=userTable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, ethernet=ethernet, radioLicenseModulation=radioLicenseModulation, sNTPLastSync=sNTPLastSync, snmpControl=snmpControl, rFULockoutAlarm=rFULockoutAlarm, sMTPServerInternetAddress=sMTPServerInternetAddress, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, systemClock=systemClock, protection=protection, sNTPServerTableEntry=sNTPServerTableEntry, rFUSerial=rFUSerial, ethernetPriorityTableIndex=ethernetPriorityTableIndex, radioLicenseCodeRate=radioLicenseCodeRate, tFTPServerIPAddress=tFTPServerIPAddress, neighborMACAddress=neighborMACAddress, rFUPowerAlarm=rFUPowerAlarm, protectionInterfaceStatus=protectionInterfaceStatus, transmitPower=transmitPower, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, userRole=userRole, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, neighborInternetAddress=neighborInternetAddress, remoteInternetAddressType=remoteInternetAddressType, userTableEntry=userTableEntry, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, dataPortDisabledWarning=dataPortDisabledWarning, sNMPEnabledTraps=sNMPEnabledTraps, userTableNumber=userTableNumber, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, transmitterStatus=transmitterStatus, subnetMask=subnetMask, l2CPPriorityTableEntry=l2CPPriorityTableEntry, daylightSaving=daylightSaving, sNTPSync=sNTPSync, minCodeRate=minCodeRate, protectionStats=protectionStats, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tFTPServerPortNumber=tFTPServerPortNumber, hardwareVersion=hardwareVersion, remoteMACAddress=remoteMACAddress, diverseRfFeederLoss=diverseRfFeederLoss, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, radioLicenseMinCodeRate=radioLicenseMinCodeRate, userTableIndex=userTableIndex, radioLicense=radioLicense, rFUProtectionCompatibility=rFUProtectionCompatibility, wirelessLinkAvailability=wirelessLinkAvailability, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, activeAvailableTime=activeAvailableTime, licence=licence, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, radioLicenseIdentifier=radioLicenseIdentifier, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, radioLicenseRxFreq=radioLicenseRxFreq, vLANManagementPriority=vLANManagementPriority, alignmentMode=alignmentMode, linkNameMismatchTrap=linkNameMismatchTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, numberOfAntennas=numberOfAntennas, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, sNMPTrapVersion=sNMPTrapVersion, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, iPv6PrefixLength=iPv6PrefixLength, hTTPSAccessEnabled=hTTPSAccessEnabled, rFURxFreqMax=rFURxFreqMax, phyControl=phyControl, managementPortDisabledWarning=managementPortDisabledWarning, bootVersion=bootVersion, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ptp=ptp, requestedProtectionState=requestedProtectionState, linkNameMismatch=linkNameMismatch, receiveModulation=receiveModulation, encryptionEnabledMismatch=encryptionEnabledMismatch, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, secureModeAlarmTrap=secureModeAlarmTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, managementPortForcedConfiguration=managementPortForcedConfiguration, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, vLANManagementVID=vLANManagementVID, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rFUTxFreqMin=rFUTxFreqMin, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, vectorError=vectorError, rFUPlatformCompatibility=rFUPlatformCompatibility, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, alignmentModeTrap=alignmentModeTrap, altitude=altitude, iPVersion=iPVersion, maximumTransmitPower=maximumTransmitPower, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, protectionConfig=protectionConfig, rFUPowerButtonPressed=rFUPowerButtonPressed, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, syslogState=syslogState, pubStats=pubStats, protectionConfigurationStatus=protectionConfigurationStatus, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, faultProtectionSwitching=faultProtectionSwitching, fiberY=fiberY, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, sNTPServerPortNumber=sNTPServerPortNumber, managementMode=managementMode, rFUTxMuteStatus=rFUTxMuteStatus, supplementary=supplementary, smtp=smtp, minModulation=minModulation, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, latitude=latitude, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, protectionSwitchCause=protectionSwitchCause, dSCPManagementPriority=dSCPManagementPriority, cambium=cambium, hTTPAccessEnabled=hTTPAccessEnabled, protectionState=protectionState, receiveCodeRate=receiveCodeRate, managementPortStatus=managementPortStatus, ptmp=ptmp, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rFUCableAlarm=rFUCableAlarm, versions=versions, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, dataPortFiberStatus=dataPortFiberStatus, vLANManagementVIDValidation=vLANManagementVIDValidation, managementPortAutoNegotiation=managementPortAutoNegotiation, mPLSTCPriorityTable=mPLSTCPriorityTable, wirelessLinkStatus=wirelessLinkStatus, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, management=management, receiveDataRate=receiveDataRate, iFCableLength=iFCableLength, remotePrimaryIPAddress=remotePrimaryIPAddress, remoteSecondaryMACAddress=remoteSecondaryMACAddress, neighborInternetAddressType=neighborInternetAddressType, telnetAccessEnabled=telnetAccessEnabled, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, encryptionAlgorithm=encryptionAlgorithm, productVariant=productVariant, syslogClient=syslogClient, rxDiversityVlanTpid=rxDiversityVlanTpid, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, userPassword=userPassword, aAAControl=aAAControl, sntp=sntp, timeZone=timeZone, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, sNTPState=sNTPState, endId=endId, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rFUTxFreqMax=rFUTxFreqMax, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, sNMPPortNumber=sNMPPortNumber, bridge=bridge, unitOutOfCalibration=unitOutOfCalibration, dataPortPauseFrames=dataPortPauseFrames, primaryRecoveryPeriod=primaryRecoveryPeriod, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, maxModulation=maxModulation, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userEnabled=userEnabled, protectionStatus=protectionStatus, rFURFSwitchAlarm=rFURFSwitchAlarm, ethernetFiberSupport=ethernetFiberSupport, l2CPPriorityTableNumber=l2CPPriorityTableNumber, radioLicenseMinModulation=radioLicenseMinModulation, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPServerTableNumber=sNTPServerTableNumber, transmitModulation=transmitModulation, sMTPEmailAlert=sMTPEmailAlert, sNTPPrimaryServer=sNTPPrimaryServer, siteName=siteName, sMTPServerPortNumber=sMTPServerPortNumber, telnetPortNumber=telnetPortNumber, rFUTxPowerMax=rFUTxPowerMax, rFURfBand=rFURfBand, rxDiversityVid=rxDiversityVid, systemReset=systemReset, localPacketFiltering=localPacketFiltering, transmitCapacityLimit=transmitCapacityLimit, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, rFUVersionBank1=rFUVersionBank1, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rFUTxPowerMin=rFUTxPowerMin, rxDiversityDataPortStatus=rxDiversityDataPortStatus, enableTransmission=enableTransmission, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, linkLoss=linkLoss, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, remoteInternetAddress=remoteInternetAddress, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, radioLicenseRegion=radioLicenseRegion, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPTrapTableIndex=sNMPTrapTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, ptpTraps=ptpTraps, rFURxFreqMin=rFURxFreqMin, longitude=longitude, rFUFreqSpacing=rFUFreqSpacing, sNMPCommunityString=sNMPCommunityString, sNMPTrapTable=sNMPTrapTable, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, radioLicenseMaxModulation=radioLicenseMaxModulation, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, radioLicenseTxFreq=radioLicenseTxFreq, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPEnabledMessages=sMTPEnabledMessages, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, softwareVersion=softwareVersion, sMTPServerInternetAddressType=sMTPServerInternetAddressType, radioLicenseBandwidth=radioLicenseBandwidth)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapTableEntry=sNMPTrapTableEntry, remotePrimaryInternetAddress=remotePrimaryInternetAddress, receivePower=receivePower, phyStatus=phyStatus, linkName=linkName, aTPCEnable=aTPCEnable, rFUType=rFUType, rFUBranchingConfiguration=rFUBranchingConfiguration, rFUVersionBank2=rFUVersionBank2, rFUStatusTrap=rFUStatusTrap, rfu=rfu, ptp800=ptp800, secureModeAlarm=secureModeAlarm, l2CPPriorityTable=l2CPPriorityTable, rFUTransceiverLocation=rFUTransceiverLocation, rFUStatus=rFUStatus, iPv6Address=iPv6Address, rFFeederLoss=rFFeederLoss, alarms=alarms, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, activeWirelessLinkAvailability=activeWirelessLinkAvailability, userName=userName, managementCommittedInformationRate=managementCommittedInformationRate, syslogStateTrap=syslogStateTrap, syslogClientTrap=syslogClientTrap, protectionStateTrap=protectionStateTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, primaryRecovery=primaryRecovery, encryption=encryption, remoteMaximumTransmitPower=remoteMaximumTransmitPower, productName=productName, ethernetPriorityTable=ethernetPriorityTable, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, sNTPPollInterval=sNTPPollInterval, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rFUTxPowerAlarm=rFUTxPowerAlarm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, tFTPServerInternetAddressType=tFTPServerInternetAddressType, antennaGain=antennaGain, aggregateDataRate=aggregateDataRate, radioLicenseBand=radioLicenseBand, syslogControl=syslogControl, qOSPriorityScheme=qOSPriorityScheme, reset=reset, remotePrimarySecondaryMode=remotePrimarySecondaryMode, radioLicenseMaxEIRP=radioLicenseMaxEIRP, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, iPv6GatewayAddress=iPv6GatewayAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitCapacity=transmitCapacity, wirelessLinkStatusTrap=wirelessLinkStatusTrap, remotePrimaryMACAddress=remotePrimaryMACAddress, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerTableIndex=sNTPServerTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerTable=sNTPServerTable, iPv4Address=iPv4Address, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, diverseAntennaGain=diverseAntennaGain, ethernetPriorityTableNumber=ethernetPriorityTableNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rFUTxBandAboveRx=rFUTxBandAboveRx, hTTPSPortNumber=hTTPSPortNumber, ptpTrapPrefix=ptpTrapPrefix, activeUnit=activeUnit, maxCodeRate=maxCodeRate, configuration=configuration, rFURpsAlarm=rFURpsAlarm, dataPortStatusTrap=dataPortStatusTrap, securityLevel=securityLevel, hTTPPortNumber=hTTPPortNumber, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rFUConnectedPlatform=rFUConnectedPlatform, remoteIPAddress=remoteIPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitDataRate=transmitDataRate, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, sNTPServerTimeout=sNTPServerTimeout, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortStatus=dataPortStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, protectionAvailabilityStatus=protectionAvailabilityStatus)
