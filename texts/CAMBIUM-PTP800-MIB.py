...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", ptp800=ptp800, receivePower=receivePower, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, iPDSCPPriorityTable=iPDSCPPriorityTable, management=management, radioLicenseTxFreq=radioLicenseTxFreq, rFUTransceiverLocation=rFUTransceiverLocation, qOSPriorityScheme=qOSPriorityScheme, securityLevel=securityLevel, protectionStats=protectionStats, rFUPowerAlarm=rFUPowerAlarm, daylightSaving=daylightSaving, userName=userName, ptpTraps=ptpTraps, rFUTxMuteStatus=rFUTxMuteStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, tFTPServerIPAddress=tFTPServerIPAddress, rxDiversityVid=rxDiversityVid, aTPCEnable=aTPCEnable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rFUType=rFUType, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, sNMPPortNumber=sNMPPortNumber, rfu=rfu, remoteInternetAddressType=remoteInternetAddressType, userTableIndex=userTableIndex, rFUCableAlarm=rFUCableAlarm, userTable=userTable, wirelessLinkAvailability=wirelessLinkAvailability, l2CPPriorityTableEntry=l2CPPriorityTableEntry, numberOfAntennas=numberOfAntennas, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rFUActiveFirmwareBank=rFUActiveFirmwareBank, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, radioLicenseModulation=radioLicenseModulation, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rFUTxFreqMin=rFUTxFreqMin, maximumTransmitPower=maximumTransmitPower, sMTPServerInternetAddressType=sMTPServerInternetAddressType, wirelessLinkStatus=wirelessLinkStatus, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, linkNameMismatchTrap=linkNameMismatchTrap, remoteInternetAddress=remoteInternetAddress, userTableEntry=userTableEntry, userTableNumber=userTableNumber, sNTPServerRetries=sNTPServerRetries, radioLicenseBandwidth=radioLicenseBandwidth, enabledDiagnosticAlarms=enabledDiagnosticAlarms, protectionAvailabilityStatus=protectionAvailabilityStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, rxDiversityDataPortStatus=rxDiversityDataPortStatus, minModulation=minModulation, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, receiveCodeRate=receiveCodeRate, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, encryptionAlgorithm=encryptionAlgorithm, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, telnetAccessEnabled=telnetAccessEnabled, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userPassword=userPassword, ethernetPriorityTable=ethernetPriorityTable, secureModeAlarm=secureModeAlarm, managementCommittedInformationRate=managementCommittedInformationRate, maxModulation=maxModulation, enableTransmission=enableTransmission, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, neighborIPAddress=neighborIPAddress, managementPortStatusTrap=managementPortStatusTrap, smtp=smtp, telnetPortNumber=telnetPortNumber, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remotePrimaryMACAddress=remotePrimaryMACAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, aggregateDataRate=aggregateDataRate, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, activeAvailableTime=activeAvailableTime, sMTPServerIPAddress=sMTPServerIPAddress, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, sNTPServerIPAddress=sNTPServerIPAddress, sNTPServerTableIndex=sNTPServerTableIndex, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rFUStatus=rFUStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, remoteSecondaryIPAddress=remoteSecondaryIPAddress, vLANManagementVIDValidation=vLANManagementVIDValidation, configuration=configuration, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, productVariant=productVariant, endId=endId, remoteMACAddress=remoteMACAddress, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rFUPowerButtonPressed=rFUPowerButtonPressed, rFUTxFreqMax=rFUTxFreqMax, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, managementMode=managementMode, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapTableEntry=sNMPTrapTableEntry, hardwareVersion=hardwareVersion, remoteSecondaryMACAddress=remoteSecondaryMACAddress, longitude=longitude, rFURxFreqMin=rFURxFreqMin, receiveModulation=receiveModulation, protectionSwitchCause=protectionSwitchCause, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, ethernet=ethernet, neighborInternetAddressType=neighborInternetAddressType, sNMPTrapTableIndex=sNMPTrapTableIndex, systemReset=systemReset, activeUnit=activeUnit, secureModeAlarmTrap=secureModeAlarmTrap, radioLicenseBand=radioLicenseBand, sNTPServerPortNumber=sNTPServerPortNumber, remotePrimaryIPAddress=remotePrimaryIPAddress, radioLicenseRegion=radioLicenseRegion, dataPortPauseFrames=dataPortPauseFrames, transmitPower=transmitPower, maxCodeRate=maxCodeRate, rFULockoutAlarm=rFULockoutAlarm, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, requestedProtectionState=requestedProtectionState, sNMPCommunityString=sNMPCommunityString, rxDiversityVlanTpid=rxDiversityVlanTpid, transmitCapacity=transmitCapacity, aAAControl=aAAControl, sMTPServerInternetAddress=sMTPServerInternetAddress, versions=versions, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, supplementary=supplementary, transmitCapacityLimit=transmitCapacityLimit, neighborMACAddress=neighborMACAddress, sNTPServerTimeout=sNTPServerTimeout, wirelessLinkStatusTrap=wirelessLinkStatusTrap, syslogControl=syslogControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, remoteIPAddress=remoteIPAddress, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, localPacketFiltering=localPacketFiltering, useVLANForManagementInterfaces=useVLANForManagementInterfaces, secondarySoftwareVersion=secondarySoftwareVersion, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, syslogStateTrap=syslogStateTrap, userEnabled=userEnabled, timeZone=timeZone, radioLicenseRxFreq=radioLicenseRxFreq, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPPollInterval=sNTPPollInterval, radioLicenseMaxModulation=radioLicenseMaxModulation, radioLicenseIdentifier=radioLicenseIdentifier, l2CPPriorityTable=l2CPPriorityTable, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, diverseRfFeederLoss=diverseRfFeederLoss, radioLicense=radioLicense, sNMPTrapVersion=sNMPTrapVersion, rFUTxBandAboveRx=rFUTxBandAboveRx, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, ethernetPriorityTableEntry=ethernetPriorityTableEntry, protectionConfigurationStatus=protectionConfigurationStatus, rFUSerial=rFUSerial, rFUConnectedPlatform=rFUConnectedPlatform, altitude=altitude, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, antennaGain=antennaGain, sNTPSync=sNTPSync, bridge=bridge, tFTPServerInternetAddressType=tFTPServerInternetAddressType, fiberY=fiberY, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernetFiberSupport=ethernetFiberSupport, sNTPState=sNTPState, ptmp=ptmp, rFFeederLoss=rFFeederLoss, remotePrimaryInternetAddress=remotePrimaryInternetAddress, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, hTTPPortNumber=hTTPPortNumber, transmitterStatus=transmitterStatus, iPv6GatewayAddress=iPv6GatewayAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sMTPEmailAlert=sMTPEmailAlert, diverseAntennaGain=diverseAntennaGain, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, cambium=cambium, sMTPEnabledMessages=sMTPEnabledMessages, rFURFSwitchAlarm=rFURFSwitchAlarm, siteName=siteName, remotePrimarySecondaryMode=remotePrimarySecondaryMode, latitude=latitude, ptp=ptp, bootVersion=bootVersion, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, encryption=encryption, iPVersion=iPVersion, rFUProtectionCompatibility=rFUProtectionCompatibility, iFCableLength=iFCableLength, protectionConfig=protectionConfig, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, protection=protection, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, protectionStateTrap=protectionStateTrap, dataPortStatusTrap=dataPortStatusTrap, iPv4Address=iPv4Address, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, l2CPPriorityTableIndex=l2CPPriorityTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, primarySecondaryMode=primarySecondaryMode, radioLicenseMaxEIRP=radioLicenseMaxEIRP, rFURfBand=rFURfBand, tFTPServerInternetAddress=tFTPServerInternetAddress, productName=productName, iPv6PrefixLength=iPv6PrefixLength, vectorError=vectorError, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, transmitModulation=transmitModulation, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementPortAutoNegotiation=managementPortAutoNegotiation, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, managementPortForcedConfiguration=managementPortForcedConfiguration, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFUTxPowerMax=rFUTxPowerMax, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, sNTPPrimaryServer=sNTPPrimaryServer, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, primaryRecovery=primaryRecovery, ethernetPriorityTableIndex=ethernetPriorityTableIndex, encryptionEnabledMismatch=encryptionEnabledMismatch, alignmentMode=alignmentMode, neighborInternetAddress=neighborInternetAddress, unitOutOfCalibration=unitOutOfCalibration)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dataPortDisabledWarning=dataPortDisabledWarning, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPv6Address=iPv6Address, sntp=sntp, managementPortConfigurationMismatch=managementPortConfigurationMismatch, vLANManagementPriority=vLANManagementPriority, sNMPEnabledTraps=sNMPEnabledTraps, rFURpsAlarm=rFURpsAlarm, protectionStatus=protectionStatus, phyControl=phyControl, rFUTxPowerMin=rFUTxPowerMin, hTTPSPortNumber=hTTPSPortNumber, alignmentModeTrap=alignmentModeTrap, alarms=alarms, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, managementPortDisabledWarning=managementPortDisabledWarning, linkLoss=linkLoss, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, rFUVersionBank2=rFUVersionBank2, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, tFTPServerPortNumber=tFTPServerPortNumber, transmitCapacityLimitDetail=transmitCapacityLimitDetail, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, transmitCodeRate=transmitCodeRate, protectionInterfaceStatus=protectionInterfaceStatus, subnetMask=subnetMask, minCodeRate=minCodeRate, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, syslogState=syslogState, vLANManagementVID=vLANManagementVID, rFURxFreqMax=rFURxFreqMax, sNTPServerResponse=sNTPServerResponse, radioLicenseMinCodeRate=radioLicenseMinCodeRate, receiveDataRate=receiveDataRate, pubStats=pubStats, dataPortStatus=dataPortStatus, rFUPlatformCompatibility=rFUPlatformCompatibility, rFUBranchingConfiguration=rFUBranchingConfiguration, softwareVersion=softwareVersion, dataPortFiberStatus=dataPortFiberStatus, systemClock=systemClock, sNTPLastSync=sNTPLastSync, activeWirelessLinkAvailability=activeWirelessLinkAvailability, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, dSCPManagementPriority=dSCPManagementPriority, hTTPSAccessEnabled=hTTPSAccessEnabled, managementPortStatus=managementPortStatus, sNTPSyncTrap=sNTPSyncTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPTrapTable=sNMPTrapTable, sNTPServerTableEntry=sNTPServerTableEntry, phyStatus=phyStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPServerPortNumber=sMTPServerPortNumber, rFUTxPowerAlarm=rFUTxPowerAlarm, radioLicenseMinModulation=radioLicenseMinModulation, sNTPServerTable=sNTPServerTable, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, linkName=linkName, radioLicenseCodeRate=radioLicenseCodeRate, sNTPServerTableNumber=sNTPServerTableNumber, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, primaryRecoveryPeriod=primaryRecoveryPeriod, licence=licence, ptpTrapPrefix=ptpTrapPrefix, rFUStatusTrap=rFUStatusTrap, syslogClient=syslogClient, snmpControl=snmpControl, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, faultProtectionSwitching=faultProtectionSwitching, gatewayIPAddress=gatewayIPAddress, linkNameMismatch=linkNameMismatch, syslogClientTrap=syslogClientTrap, transmitDataRate=transmitDataRate, userRole=userRole, rFUVersionBank1=rFUVersionBank1, protectionState=protectionState, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, reset=reset, rFUFreqSpacing=rFUFreqSpacing, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus)
