...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", managementPortAutoNegotiation=managementPortAutoNegotiation, alignmentMode=alignmentMode, rFUFreqSpacing=rFUFreqSpacing, userPassword=userPassword, radioLicenseRegion=radioLicenseRegion, sNMPTrapVersion=sNMPTrapVersion, protectionAvailabilityStatus=protectionAvailabilityStatus, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, versions=versions, userTableEntry=userTableEntry, protectionStats=protectionStats, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, sNTPLastSync=sNTPLastSync, transmitCapacityLimitDetail=transmitCapacityLimitDetail, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, sNMPTrapIPAddress=sNMPTrapIPAddress, encryption=encryption, latitude=latitude, unitOutOfCalibration=unitOutOfCalibration, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, fiberY=fiberY, rFULockoutAlarm=rFULockoutAlarm, protectionSwitchCause=protectionSwitchCause, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, iPv6Address=iPv6Address, remotePrimaryIPAddress=remotePrimaryIPAddress, aggregateDataRate=aggregateDataRate, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, sNMPEnabledTraps=sNMPEnabledTraps, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, transmitterStatus=transmitterStatus, activeUnit=activeUnit, sNMPTrapTableIndex=sNMPTrapTableIndex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, endId=endId, neighborMACAddress=neighborMACAddress, rFUPowerButtonPressed=rFUPowerButtonPressed, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, managementPortStatusTrap=managementPortStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, gatewayIPAddress=gatewayIPAddress, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFUTxFreqMax=rFUTxFreqMax, ptp=ptp, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, localPacketFiltering=localPacketFiltering, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, aTPCEnable=aTPCEnable, ethernetPriorityTable=ethernetPriorityTable, iPDSCPPriorityTable=iPDSCPPriorityTable, managementCommittedInformationRate=managementCommittedInformationRate, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, primarySecondaryMode=primarySecondaryMode, remotePrimaryInternetAddress=remotePrimaryInternetAddress, encryptionAlgorithm=encryptionAlgorithm, managementMode=managementMode, transmitCodeRate=transmitCodeRate, aAAControl=aAAControl, rFURxFreqMin=rFURxFreqMin, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, protectionConfigurationStatus=protectionConfigurationStatus, rFUSerial=rFUSerial, transmitDataRate=transmitDataRate, ptpTraps=ptpTraps, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptp800=ptp800, telnetAccessEnabled=telnetAccessEnabled, licence=licence, hardwareVersion=hardwareVersion, phyStatus=phyStatus, sNTPServerPortNumber=sNTPServerPortNumber, telnetPortNumber=telnetPortNumber, rFUConnectedPlatform=rFUConnectedPlatform, remoteInternetAddressType=remoteInternetAddressType, neighborIPAddress=neighborIPAddress, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, sMTPEmailAlert=sMTPEmailAlert, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rFURpsAlarm=rFURpsAlarm, alarms=alarms, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, maxModulation=maxModulation, radioLicenseMinModulation=radioLicenseMinModulation, iPv6GatewayAddress=iPv6GatewayAddress, rFURxFreqMax=rFURxFreqMax, wirelessLinkAvailability=wirelessLinkAvailability, ptmp=ptmp, radioLicenseModulation=radioLicenseModulation, daylightSaving=daylightSaving, encryptionEnabledMismatch=encryptionEnabledMismatch, managementPortStatus=managementPortStatus, iPVersion=iPVersion, requestedProtectionState=requestedProtectionState, linkName=linkName, sntp=sntp, rFUActiveFirmwareBank=rFUActiveFirmwareBank, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, radioLicenseMaxModulation=radioLicenseMaxModulation, rxDiversityVlanTpid=rxDiversityVlanTpid, remoteIPAddress=remoteIPAddress, supplementary=supplementary, receiveModulation=receiveModulation, rFUTxPowerAlarm=rFUTxPowerAlarm, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPServerTimeout=sNTPServerTimeout, rFURFSwitchAlarm=rFURFSwitchAlarm, remoteMACAddress=remoteMACAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, primaryRecoveryPeriod=primaryRecoveryPeriod, transmitPower=transmitPower, longitude=longitude, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, userRole=userRole, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, l2CPPriorityTable=l2CPPriorityTable, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sNTPPrimaryServer=sNTPPrimaryServer, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, iPv4Address=iPv4Address, tFTPServerPortNumber=tFTPServerPortNumber, radioLicenseTxFreq=radioLicenseTxFreq, sNMPTrapPortNumber=sNMPTrapPortNumber, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, radioLicenseRxFreq=radioLicenseRxFreq, diverseAntennaGain=diverseAntennaGain, managementPortConfigurationMismatch=managementPortConfigurationMismatch, cambium=cambium, rFUStatusTrap=rFUStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapTable=sNMPTrapTable, numberOfAntennas=numberOfAntennas, protectionStatus=protectionStatus, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFUPlatformCompatibility=rFUPlatformCompatibility, radioLicenseCodeRate=radioLicenseCodeRate, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, l2CPPriorityTableEntry=l2CPPriorityTableEntry, qOSPriorityScheme=qOSPriorityScheme, phyControl=phyControl, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, securityLevel=securityLevel, sNTPServerTableIndex=sNTPServerTableIndex, mPLSTCPriorityTable=mPLSTCPriorityTable, hTTPAccessEnabled=hTTPAccessEnabled, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, iFCableLength=iFCableLength, sMTPEnabledMessages=sMTPEnabledMessages, systemReset=systemReset, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPSync=sNTPSync, neighborInternetAddress=neighborInternetAddress, sNMPPortNumber=sNMPPortNumber, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rFUTxFreqMin=rFUTxFreqMin, enableTransmission=enableTransmission, secureModeAlarm=secureModeAlarm, rFFeederLoss=rFFeederLoss, activeAvailableTime=activeAvailableTime, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, vLANManagementVIDValidation=vLANManagementVIDValidation, syslogControl=syslogControl, primaryRecovery=primaryRecovery, syslogStateTrap=syslogStateTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dataPortConfigurationMismatch=dataPortConfigurationMismatch, radioLicense=radioLicense, sNTPSyncTrap=sNTPSyncTrap, rFUTxPowerMax=rFUTxPowerMax, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, siteName=siteName, smtp=smtp, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPState=sNTPState, dataPortStatus=dataPortStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, rFUTxPowerMin=rFUTxPowerMin, linkNameMismatch=linkNameMismatch, tFTPServerInternetAddress=tFTPServerInternetAddress, receiveDataRate=receiveDataRate, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, remoteInternetAddress=remoteInternetAddress, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPServerIPAddress=sNTPServerIPAddress, rxDiversityVid=rxDiversityVid, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, maximumTransmitPower=maximumTransmitPower, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, radioLicenseIdentifier=radioLicenseIdentifier, sMTPServerPortNumber=sMTPServerPortNumber, linkNameMismatchTrap=linkNameMismatchTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, dataPortStatusTrap=dataPortStatusTrap, subnetMask=subnetMask, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortDisabledWarning=dataPortDisabledWarning, dSCPManagementPriority=dSCPManagementPriority, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, managementPortForcedConfiguration=managementPortForcedConfiguration, rFUVersionBank1=rFUVersionBank1, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vLANManagementVID=vLANManagementVID, rFUCableAlarm=rFUCableAlarm, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFUVersionBank2=rFUVersionBank2, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, rFUTxBandAboveRx=rFUTxBandAboveRx, radioLicenseBand=radioLicenseBand, syslogClientTrap=syslogClientTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, diverseRfFeederLoss=diverseRfFeederLoss, remotePrimaryMACAddress=remotePrimaryMACAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, softwareVersion=softwareVersion, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, configuration=configuration, sNTPServerTableNumber=sNTPServerTableNumber, protection=protection, managementPortDisabledWarning=managementPortDisabledWarning, transmitCapacity=transmitCapacity, rFUProtectionCompatibility=rFUProtectionCompatibility, transmitModulation=transmitModulation, sNTPServerTable=sNTPServerTable, sNTPPollInterval=sNTPPollInterval, productName=productName, remotePrimarySecondaryMode=remotePrimarySecondaryMode, maxCodeRate=maxCodeRate, sNTPServerRetries=sNTPServerRetries, radioLicenseBandwidth=radioLicenseBandwidth)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", ethernetPriorityTableEntry=ethernetPriorityTableEntry, rxDiversityDataPortStatus=rxDiversityDataPortStatus, wirelessLinkStatus=wirelessLinkStatus, rfu=rfu, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ethernetFiberSupport=ethernetFiberSupport, vectorError=vectorError, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, rFUTxMuteStatus=rFUTxMuteStatus, sMTPServerIPAddress=sMTPServerIPAddress, rFUType=rFUType, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptpTrapPrefix=ptpTrapPrefix, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, systemClock=systemClock, tFTPServerIPAddress=tFTPServerIPAddress, rFUStatus=rFUStatus, altitude=altitude, sMTPSourceEmailAddress=sMTPSourceEmailAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, protectionInterfaceStatus=protectionInterfaceStatus, syslogClient=syslogClient, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, protectionState=protectionState, wirelessLinkStatusTrap=wirelessLinkStatusTrap, neighborInternetAddressType=neighborInternetAddressType, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUTransceiverLocation=rFUTransceiverLocation, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, faultProtectionSwitching=faultProtectionSwitching, alignmentModeTrap=alignmentModeTrap, rFURfBand=rFURfBand, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, pubStats=pubStats, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, userName=userName, transmitCapacityLimit=transmitCapacityLimit, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, receivePower=receivePower, syslogState=syslogState, enabledDiagnosticAlarms=enabledDiagnosticAlarms, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receiveCodeRate=receiveCodeRate, remoteSecondaryIPAddress=remoteSecondaryIPAddress, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, protectionConfig=protectionConfig, bootVersion=bootVersion, snmpControl=snmpControl, sNTPServerResponse=sNTPServerResponse, protectionStateTrap=protectionStateTrap, antennaGain=antennaGain, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, hTTPSPortNumber=hTTPSPortNumber, dataPortFiberStatus=dataPortFiberStatus, reset=reset, bridge=bridge, userTableNumber=userTableNumber, userTableIndex=userTableIndex, sNTPServerTableEntry=sNTPServerTableEntry, minCodeRate=minCodeRate, hTTPPortNumber=hTTPPortNumber, vLANManagementPriority=vLANManagementPriority, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, sNMPCommunityString=sNMPCommunityString, secondarySoftwareVersion=secondarySoftwareVersion, minModulation=minModulation, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, management=management, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUPowerAlarm=rFUPowerAlarm, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, timeZone=timeZone, iPv6PrefixLength=iPv6PrefixLength, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, dataPortPauseFrames=dataPortPauseFrames, userTable=userTable, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ethernet=ethernet, rFUBranchingConfiguration=rFUBranchingConfiguration, userEnabled=userEnabled, tFTPServerInternetAddressType=tFTPServerInternetAddressType, hTTPSAccessEnabled=hTTPSAccessEnabled, productVariant=productVariant, linkLoss=linkLoss)
