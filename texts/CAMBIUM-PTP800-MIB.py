...
IpAddress, ModuleIdentity, MibIdentifier, Integer32, enterprises, NotificationType, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, Unsigned32, Counter64, iso, Gauge32, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "MibIdentifier", "Integer32", "enterprises", "NotificationType", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "Unsigned32", "Counter64", "iso", "Gauge32", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", smtp=smtp, sNTPServerTableNumber=sNTPServerTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, sNMPPortNumber=sNMPPortNumber, supplementary=supplementary, aggregateDataRate=aggregateDataRate, sMTPSourceEmailAddress=sMTPSourceEmailAddress, encryption=encryption, sntp=sntp, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, qOSPriorityScheme=qOSPriorityScheme, vLANManagementVIDValidation=vLANManagementVIDValidation, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, localPacketFiltering=localPacketFiltering, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFUProtectionCompatibility=rFUProtectionCompatibility, managementPortStatus=managementPortStatus, activeUnit=activeUnit, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, sNTPServerTimeout=sNTPServerTimeout, rFURxFreqMax=rFURxFreqMax, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, transmitModulation=transmitModulation, linkNameMismatch=linkNameMismatch, rFFeederLoss=rFFeederLoss, iPv6GatewayAddress=iPv6GatewayAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, radioLicenseTxFreq=radioLicenseTxFreq, rFUBranchingConfiguration=rFUBranchingConfiguration, remotePrimaryInternetAddress=remotePrimaryInternetAddress, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, telnetPortNumber=telnetPortNumber, dSCPManagementPriority=dSCPManagementPriority, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rfu=rfu, radioLicenseIdentifier=radioLicenseIdentifier, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, radioLicenseModulation=radioLicenseModulation, managementCommittedInformationRate=managementCommittedInformationRate, sNTPPollInterval=sNTPPollInterval, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, sMTPEnabledMessages=sMTPEnabledMessages, ethernetPriorityTable=ethernetPriorityTable, userTableIndex=userTableIndex, ethernet=ethernet, alarms=alarms, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, wirelessLinkStatusTrap=wirelessLinkStatusTrap, minModulation=minModulation, protectionState=protectionState, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rFUFreqSpacing=rFUFreqSpacing, rFUTransceiverLocation=rFUTransceiverLocation, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFULockoutAlarm=rFULockoutAlarm, endId=endId, hardwareVersion=hardwareVersion, ptmp=ptmp, remotePrimaryMACAddress=remotePrimaryMACAddress, iFCableLength=iFCableLength, ptp800=ptp800, primarySecondaryMode=primarySecondaryMode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPVersion=iPVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, vLANManagementPriority=vLANManagementPriority, rFUTxPowerAlarm=rFUTxPowerAlarm, sMTPServerPortNumber=sMTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, rxDiversityVid=rxDiversityVid, rFUTxPowerMax=rFUTxPowerMax, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, receiveCodeRate=receiveCodeRate, sNTPServerTableIndex=sNTPServerTableIndex, sNTPSync=sNTPSync, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, rFUStatus=rFUStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, userRole=userRole, softwareVersion=softwareVersion, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, receiveModulation=receiveModulation, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUSerial=rFUSerial, sNMPTrapPortNumber=sNMPTrapPortNumber, radioLicenseMinCodeRate=radioLicenseMinCodeRate, hTTPSAccessEnabled=hTTPSAccessEnabled, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, encryptionAlgorithm=encryptionAlgorithm, radioLicense=radioLicense, versions=versions, transmitPower=transmitPower, sNTPServerTable=sNTPServerTable, hTTPSPortNumber=hTTPSPortNumber, managementPortAutoNegotiation=managementPortAutoNegotiation, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rxDiversityDataPortStatus=rxDiversityDataPortStatus, syslogClient=syslogClient, altitude=altitude, syslogStateTrap=syslogStateTrap, reset=reset, vectorError=vectorError, protectionStats=protectionStats, linkLoss=linkLoss, snmpControl=snmpControl, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, sNTPServerRetries=sNTPServerRetries, protection=protection, managementPortForcedConfiguration=managementPortForcedConfiguration, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, dataPortStatus=dataPortStatus, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, linkNameMismatchTrap=linkNameMismatchTrap, userTableNumber=userTableNumber, aTPCEnable=aTPCEnable, remotePrimaryIPAddress=remotePrimaryIPAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rFURpsAlarm=rFURpsAlarm, alignmentMode=alignmentMode, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, ptp=ptp, managementMode=managementMode, userPassword=userPassword, transmitCapacity=transmitCapacity, ptpTraps=ptpTraps, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rFUTxBandAboveRx=rFUTxBandAboveRx, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, rFUTxFreqMax=rFUTxFreqMax, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFUTxFreqMin=rFUTxFreqMin, sNTPSyncTrap=sNTPSyncTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, l2CPPriorityTable=l2CPPriorityTable, iPDSCPPriorityTable=iPDSCPPriorityTable, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, encryptionEnabledMismatch=encryptionEnabledMismatch, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, managementPortDisabledWarning=managementPortDisabledWarning, fiberY=fiberY, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, minCodeRate=minCodeRate, iPv6Address=iPv6Address, dataPortFiberStatus=dataPortFiberStatus, remotePrimarySecondaryMode=remotePrimarySecondaryMode, wirelessLinkStatus=wirelessLinkStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, productVariant=productVariant, dataPortConfigurationMismatch=dataPortConfigurationMismatch, daylightSaving=daylightSaving, alignmentModeTrap=alignmentModeTrap, radioLicenseMaxModulation=radioLicenseMaxModulation, tFTPServerIPAddress=tFTPServerIPAddress, hTTPAccessEnabled=hTTPAccessEnabled, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPState=sNTPState, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, receiveDataRate=receiveDataRate, userTableEntry=userTableEntry, faultProtectionSwitching=faultProtectionSwitching, productName=productName, sMTPEmailAlert=sMTPEmailAlert, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rFUTxPowerMin=rFUTxPowerMin, transmitCapacityLimitDetail=transmitCapacityLimitDetail, userTable=userTable, radioLicenseBandwidth=radioLicenseBandwidth, protectionStateTrap=protectionStateTrap, secureModeAlarm=secureModeAlarm, pubStats=pubStats, rFUVersionBank2=rFUVersionBank2, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpTrapPrefix=ptpTrapPrefix, dataPortPauseFrames=dataPortPauseFrames, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, tFTPServerInternetAddress=tFTPServerInternetAddress, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rFUPowerButtonPressed=rFUPowerButtonPressed, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitCodeRate=transmitCodeRate, rFURFSwitchAlarm=rFURFSwitchAlarm, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, rFUType=rFUType, sNTPServerIPAddress=sNTPServerIPAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, receivePower=receivePower, userEnabled=userEnabled, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rFURxFreqMin=rFURxFreqMin, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rFUTxMuteStatus=rFUTxMuteStatus, aAAControl=aAAControl, numberOfAntennas=numberOfAntennas, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, protectionInterfaceStatus=protectionInterfaceStatus, sNMPEnabledTraps=sNMPEnabledTraps, activeWirelessLinkAvailability=activeWirelessLinkAvailability, sNTPServerTableEntry=sNTPServerTableEntry, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, mPLSTCPriorityTable=mPLSTCPriorityTable, bootVersion=bootVersion, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, sNTPServerPortNumber=sNTPServerPortNumber, securityLevel=securityLevel, maxCodeRate=maxCodeRate, rFUPlatformCompatibility=rFUPlatformCompatibility, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, systemClock=systemClock, userName=userName, protectionConfigurationStatus=protectionConfigurationStatus, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, iPv4Address=iPv4Address, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, neighborInternetAddress=neighborInternetAddress, protectionConfig=protectionConfig, telnetAccessEnabled=telnetAccessEnabled, protectionSwitchCause=protectionSwitchCause, vLANManagementVID=vLANManagementVID, radioLicenseCodeRate=radioLicenseCodeRate, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, secondarySoftwareVersion=secondarySoftwareVersion, phyControl=phyControl, sMTPServerInternetAddress=sMTPServerInternetAddress, rFUStatusTrap=rFUStatusTrap, sNMPTrapTable=sNMPTrapTable, rFUVersionBank1=rFUVersionBank1, syslogClientTrap=syslogClientTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, rFUConnectedPlatform=rFUConnectedPlatform, unitOutOfCalibration=unitOutOfCalibration, dataPortStatusTrap=dataPortStatusTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, managementPortStatusTrap=managementPortStatusTrap, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, radioLicenseBand=radioLicenseBand)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, transmitterStatus=transmitterStatus, maxModulation=maxModulation, sNTPServerInternetAddress=sNTPServerInternetAddress, siteName=siteName, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, requestedProtectionState=requestedProtectionState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPPrimaryServer=sNTPPrimaryServer, longitude=longitude, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, protectionStatus=protectionStatus, cambium=cambium, neighborIPAddress=neighborIPAddress, configuration=configuration, diverseAntennaGain=diverseAntennaGain, management=management, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapTableIndex=sNMPTrapTableIndex, timeZone=timeZone, remoteInternetAddress=remoteInternetAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remoteInternetAddressType=remoteInternetAddressType, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, syslogState=syslogState, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, systemReset=systemReset, sNMPCommunityString=sNMPCommunityString, ethernetPriorityTableEntry=ethernetPriorityTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFUPowerAlarm=rFUPowerAlarm, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, radioLicenseRxFreq=radioLicenseRxFreq, maximumTransmitPower=maximumTransmitPower, diverseRfFeederLoss=diverseRfFeederLoss, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, remoteMACAddress=remoteMACAddress, radioLicenseRegion=radioLicenseRegion, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, remoteIPAddress=remoteIPAddress, ethernetFiberSupport=ethernetFiberSupport, radioLicenseMaxEIRP=radioLicenseMaxEIRP, neighborInternetAddressType=neighborInternetAddressType, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, syslogControl=syslogControl, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, secureModeAlarmTrap=secureModeAlarmTrap, antennaGain=antennaGain, subnetMask=subnetMask, sNTPServerResponse=sNTPServerResponse, iPv6PrefixLength=iPv6PrefixLength, sNTPLastSync=sNTPLastSync, hTTPPortNumber=hTTPPortNumber, linkName=linkName, gatewayIPAddress=gatewayIPAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, phyStatus=phyStatus, rxDiversityVlanTpid=rxDiversityVlanTpid, primaryRecoveryPeriod=primaryRecoveryPeriod, latitude=latitude, radioLicenseMinModulation=radioLicenseMinModulation, activeAvailableTime=activeAvailableTime, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFUCableAlarm=rFUCableAlarm, neighborMACAddress=neighborMACAddress, protectionAvailabilityStatus=protectionAvailabilityStatus, sNMPTrapVersion=sNMPTrapVersion, transmitDataRate=transmitDataRate, rFURfBand=rFURfBand, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, licence=licence, dataPortDisabledWarning=dataPortDisabledWarning, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, remoteSecondaryIPAddress=remoteSecondaryIPAddress, bridge=bridge, primaryRecovery=primaryRecovery, transmitCapacityLimit=transmitCapacityLimit, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, enableTransmission=enableTransmission, dataPortWirelessDownAlert=dataPortWirelessDownAlert, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rFUActiveFirmwareBank=rFUActiveFirmwareBank)
