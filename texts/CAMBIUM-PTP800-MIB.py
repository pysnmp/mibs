...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", cambium=cambium, sNTPServerTableNumber=sNTPServerTableNumber, rFUTxMuteStatus=rFUTxMuteStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerTableIndex=sNTPServerTableIndex, sNMPPortNumber=sNMPPortNumber, rfu=rfu, supplementary=supplementary, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, fiberY=fiberY, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ptp=ptp, dataPortStatus=dataPortStatus, sNTPServerTable=sNTPServerTable, hTTPAccessEnabled=hTTPAccessEnabled, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFUTxPowerAlarm=rFUTxPowerAlarm, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptmp=ptmp, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, ethernetPriorityTable=ethernetPriorityTable, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, rFUConnectedPlatform=rFUConnectedPlatform, rFUStatusTrap=rFUStatusTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, transmitCapacityLimit=transmitCapacityLimit, sNTPPrimaryServer=sNTPPrimaryServer, sNTPSyncTrap=sNTPSyncTrap, versions=versions, alarms=alarms, rFUCableAlarm=rFUCableAlarm, userTableNumber=userTableNumber, radioLicenseBandwidth=radioLicenseBandwidth, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFUBranchingConfiguration=rFUBranchingConfiguration, sNTPServerTimeout=sNTPServerTimeout, securityLevel=securityLevel, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, iFCableLength=iFCableLength, encryptionAlgorithm=encryptionAlgorithm, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, radioLicenseIdentifier=radioLicenseIdentifier, managementPortStatus=managementPortStatus, managementPortDisabledWarning=managementPortDisabledWarning, smtp=smtp, sntp=sntp, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPEnabledTraps=sNMPEnabledTraps, remotePrimarySecondaryMode=remotePrimarySecondaryMode, transmitDataRate=transmitDataRate, telnetAccessEnabled=telnetAccessEnabled, reset=reset, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, vLANManagementVID=vLANManagementVID, sNMPTrapTable=sNMPTrapTable, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, hTTPSPortNumber=hTTPSPortNumber, ptpTraps=ptpTraps, receivePower=receivePower, encryption=encryption, managementMode=managementMode, sNTPServerRetries=sNTPServerRetries, sMTPSourceEmailAddress=sMTPSourceEmailAddress, radioLicenseRegion=radioLicenseRegion, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFUPowerAlarm=rFUPowerAlarm, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, syslogControl=syslogControl, pubStats=pubStats, sNTPServerTableEntry=sNTPServerTableEntry, activeAvailableTime=activeAvailableTime, sNTPLastSync=sNTPLastSync, radioLicenseMinModulation=radioLicenseMinModulation, phyControl=phyControl, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, alignmentModeTrap=alignmentModeTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, protectionStatus=protectionStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPVersion=iPVersion, rFUTxPowerMin=rFUTxPowerMin, remoteInternetAddress=remoteInternetAddress, protectionStats=protectionStats, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, iPv6Address=iPv6Address, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, receiveCodeRate=receiveCodeRate, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, sNTPServerInternetAddress=sNTPServerInternetAddress, remoteSecondaryIPAddress=remoteSecondaryIPAddress, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, ptp800=ptp800, maximumTransmitPower=maximumTransmitPower, ethernetFiberSupport=ethernetFiberSupport, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rFUTxFreqMax=rFUTxFreqMax, vectorError=vectorError, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, bridge=bridge, mPLSTCPriorityTable=mPLSTCPriorityTable, rFUPowerButtonPressed=rFUPowerButtonPressed, bootVersion=bootVersion, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rFUFreqSpacing=rFUFreqSpacing, localPacketFiltering=localPacketFiltering, rFUTransceiverLocation=rFUTransceiverLocation, sNMPTrapTableEntry=sNMPTrapTableEntry, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, subnetMask=subnetMask, diverseRfFeederLoss=diverseRfFeederLoss, rxDiversityVlanTpid=rxDiversityVlanTpid, protectionConfig=protectionConfig, userTableIndex=userTableIndex, managementCommittedInformationRate=managementCommittedInformationRate, alignmentMode=alignmentMode, protectionStateTrap=protectionStateTrap, rFUType=rFUType, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, protectionAvailabilityStatus=protectionAvailabilityStatus, maxCodeRate=maxCodeRate, vLANManagementVIDValidation=vLANManagementVIDValidation, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rFUTxFreqMin=rFUTxFreqMin, radioLicenseMinCodeRate=radioLicenseMinCodeRate, radioLicenseTxFreq=radioLicenseTxFreq, vLANManagementPriority=vLANManagementPriority, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, enableTransmission=enableTransmission, sMTPEnabledMessages=sMTPEnabledMessages, remoteMACAddress=remoteMACAddress, iPv6GatewayAddress=iPv6GatewayAddress, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, remoteMaximumTransmitPower=remoteMaximumTransmitPower, primaryRecoveryPeriod=primaryRecoveryPeriod, receiveDataRate=receiveDataRate, l2CPPriorityTableNumber=l2CPPriorityTableNumber, neighborMACAddress=neighborMACAddress, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, numberOfAntennas=numberOfAntennas, antennaGain=antennaGain, rxDiversityVid=rxDiversityVid, hTTPPortNumber=hTTPPortNumber, altitude=altitude, syslogClient=syslogClient, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, linkLoss=linkLoss, secureModeAlarmTrap=secureModeAlarmTrap, snmpControl=snmpControl, ethernet=ethernet, tFTPServerInternetAddress=tFTPServerInternetAddress, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerResponse=sNTPServerResponse, remoteInternetAddressType=remoteInternetAddressType, protection=protection, managementPortAutoNegotiation=managementPortAutoNegotiation, tFTPServerPortNumber=tFTPServerPortNumber, userName=userName, rFUVersionBank2=rFUVersionBank2, radioLicenseCodeRate=radioLicenseCodeRate, dataPortFiberStatus=dataPortFiberStatus, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, systemReset=systemReset, softwareVersion=softwareVersion, rFURxFreqMin=rFURxFreqMin, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNMPTrapVersion=sNMPTrapVersion, minModulation=minModulation, sNMPTrapInternetAddress=sNMPTrapInternetAddress, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, secondarySoftwareVersion=secondarySoftwareVersion, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, radioLicense=radioLicense, rFUSerial=rFUSerial, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, protectionConfigurationStatus=protectionConfigurationStatus, primaryRecovery=primaryRecovery, syslogStateTrap=syslogStateTrap, siteName=siteName, hardwareVersion=hardwareVersion, dataPortWirelessDownAlert=dataPortWirelessDownAlert, productVariant=productVariant, sNTPServerIPAddress=sNTPServerIPAddress, sMTPEmailAlert=sMTPEmailAlert, neighborIPAddress=neighborIPAddress, transmitPower=transmitPower, secureModeAlarm=secureModeAlarm, remoteIPAddress=remoteIPAddress, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, faultProtectionSwitching=faultProtectionSwitching, userRole=userRole, linkNameMismatch=linkNameMismatch, protectionInterfaceStatus=protectionInterfaceStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userTable=userTable, aAAControl=aAAControl, managementPortConfigurationMismatch=managementPortConfigurationMismatch, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, linkNameMismatchTrap=linkNameMismatchTrap, rFUVersionBank1=rFUVersionBank1, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, radioLicenseMaxModulation=radioLicenseMaxModulation, iPv6PrefixLength=iPv6PrefixLength, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rFULockoutAlarm=rFULockoutAlarm, rFUActiveFirmwareBank=rFUActiveFirmwareBank, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, licence=licence, wirelessLinkStatus=wirelessLinkStatus, requestedProtectionState=requestedProtectionState, management=management, rFFeederLoss=rFFeederLoss, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitCodeRate=transmitCodeRate, neighborInternetAddressType=neighborInternetAddressType, protectionSwitchCause=protectionSwitchCause, iPv4Address=iPv4Address, tFTPServerInternetAddressType=tFTPServerInternetAddressType, receiveModulation=receiveModulation, transmitterStatus=transmitterStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, l2CPPriorityTable=l2CPPriorityTable, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, sNMPCommunityString=sNMPCommunityString, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, maxModulation=maxModulation, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, unitOutOfCalibration=unitOutOfCalibration, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, systemClock=systemClock, userEnabled=userEnabled, neighborInternetAddress=neighborInternetAddress, tFTPServerIPAddress=tFTPServerIPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remotePrimaryInternetAddress=remotePrimaryInternetAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, syslogState=syslogState, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", dataPortDisabledWarning=dataPortDisabledWarning, dataPortStatusTrap=dataPortStatusTrap, radioLicenseModulation=radioLicenseModulation, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFUPlatformCompatibility=rFUPlatformCompatibility, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, syslogClientTrap=syslogClientTrap, rFUStatus=rFUStatus, endId=endId, managementPortForcedConfiguration=managementPortForcedConfiguration, iPDSCPPriorityTable=iPDSCPPriorityTable, productName=productName, sMTPServerInternetAddressType=sMTPServerInternetAddressType, encryptionEnabledMismatch=encryptionEnabledMismatch, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, activeUnit=activeUnit, sMTPServerPortNumber=sMTPServerPortNumber, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, minCodeRate=minCodeRate, rFUProtectionCompatibility=rFUProtectionCompatibility, sNTPPollInterval=sNTPPollInterval, remotePrimaryMACAddress=remotePrimaryMACAddress, rFURxFreqMax=rFURxFreqMax, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, qOSPriorityScheme=qOSPriorityScheme, userPassword=userPassword, longitude=longitude, userTableEntry=userTableEntry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, aggregateDataRate=aggregateDataRate, sMTPServerInternetAddress=sMTPServerInternetAddress, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, timeZone=timeZone, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, managementPortStatusTrap=managementPortStatusTrap, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, ptpTrapPrefix=ptpTrapPrefix, gatewayIPAddress=gatewayIPAddress, wirelessLinkStatusTrap=wirelessLinkStatusTrap, dSCPManagementPriority=dSCPManagementPriority, radioLicenseRxFreq=radioLicenseRxFreq, configuration=configuration, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, rFURpsAlarm=rFURpsAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetPriorityTableEntry=ethernetPriorityTableEntry, daylightSaving=daylightSaving, rFURfBand=rFURfBand, dataPortPauseFrames=dataPortPauseFrames, telnetPortNumber=telnetPortNumber, radioLicenseBand=radioLicenseBand, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, transmitModulation=transmitModulation, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, diverseAntennaGain=diverseAntennaGain, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remotePrimaryIPAddress=remotePrimaryIPAddress, latitude=latitude, dataPortFiberStatusTrap=dataPortFiberStatusTrap, transmitCapacity=transmitCapacity, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sNTPServerPortNumber=sNTPServerPortNumber, phyStatus=phyStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessLinkAvailability=wirelessLinkAvailability, protectionState=protectionState, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFUTxPowerMax=rFUTxPowerMax, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rFURFSwitchAlarm=rFURFSwitchAlarm, transmitCapacityLimitDetail=transmitCapacityLimitDetail, aTPCEnable=aTPCEnable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rFUTxBandAboveRx=rFUTxBandAboveRx, linkName=linkName, sNTPState=sNTPState, primarySecondaryMode=primarySecondaryMode, sNTPSync=sNTPSync, managementPortWirelessDownAlert=managementPortWirelessDownAlert)
