...
enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, ModuleIdentity, Bits, Integer32, ObjectIdentity, NotificationType, TimeTicks, Gauge32, Unsigned32, Counter64, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "ModuleIdentity", "Bits", "Integer32", "ObjectIdentity", "NotificationType", "TimeTicks", "Gauge32", "Unsigned32", "Counter64", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", protectionStateTrap=protectionStateTrap, iPVersion=iPVersion, protectionInterfaceStatus=protectionInterfaceStatus, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, managementPortStatusTrap=managementPortStatusTrap, transmitDataRate=transmitDataRate, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, systemReset=systemReset, primaryRecoveryPeriod=primaryRecoveryPeriod, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, antennaGain=antennaGain, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulation=receiveModulation, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, sNTPServerInternetAddress=sNTPServerInternetAddress, transmitCapacityLimitDetail=transmitCapacityLimitDetail, rFUVersionBank1=rFUVersionBank1, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, syslogClientTrap=syslogClientTrap, radioLicenseModulation=radioLicenseModulation, ethernetPriorityTableIndex=ethernetPriorityTableIndex, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, rFUProtectionCompatibility=rFUProtectionCompatibility, managementCommittedInformationRate=managementCommittedInformationRate, remoteSecondaryMACAddress=remoteSecondaryMACAddress, pubStats=pubStats, radioLicenseMinCodeRate=radioLicenseMinCodeRate, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rFFeederLoss=rFFeederLoss, cambium=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, sNMPTrapVersion=sNMPTrapVersion, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFUBranchingConfiguration=rFUBranchingConfiguration, encryptionEnabledMismatch=encryptionEnabledMismatch, syslogStateTrap=syslogStateTrap, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, productName=productName, radioLicenseRxFreq=radioLicenseRxFreq, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, sNTPServerTableEntry=sNTPServerTableEntry, gatewayIPAddress=gatewayIPAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, iFCableLength=iFCableLength, sNTPServerTimeout=sNTPServerTimeout, rFUTxFreqMin=rFUTxFreqMin, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, remoteMACAddress=remoteMACAddress, radioLicenseMaxModulation=radioLicenseMaxModulation, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, sNMPPortNumber=sNMPPortNumber, sNTPServerResponse=sNTPServerResponse, managementPortAutoNegotiation=managementPortAutoNegotiation, bridge=bridge, alignmentModeTrap=alignmentModeTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, sNMPEnabledTraps=sNMPEnabledTraps, ptpTraps=ptpTraps, sNMPTrapInternetAddress=sNMPTrapInternetAddress, receiveCodeRate=receiveCodeRate, protectionConfigurationStatus=protectionConfigurationStatus, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, protectionSwitchCause=protectionSwitchCause, ptp800=ptp800, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, maxCodeRate=maxCodeRate, licence=licence, rFUTransceiverLocation=rFUTransceiverLocation, hTTPAccessEnabled=hTTPAccessEnabled, latitude=latitude, userTable=userTable, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, vLANManagementVID=vLANManagementVID, sNMPTrapIPAddress=sNMPTrapIPAddress, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, linkNameMismatchTrap=linkNameMismatchTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, userTableNumber=userTableNumber, vLANManagementPriority=vLANManagementPriority, numberOfAntennas=numberOfAntennas, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, syslogClient=syslogClient, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, tFTPServerPortNumber=tFTPServerPortNumber, sNTPLastSync=sNTPLastSync, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, protectionState=protectionState, rFURxFreqMax=rFURxFreqMax, supplementary=supplementary, ethernetPriorityTableEntry=ethernetPriorityTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, versions=versions, linkLoss=linkLoss, radioLicenseCodeRate=radioLicenseCodeRate, faultProtectionSwitching=faultProtectionSwitching, siteName=siteName, ethernetPriorityTable=ethernetPriorityTable, rFUConnectedPlatform=rFUConnectedPlatform, snmpControl=snmpControl, endId=endId, hardwareVersion=hardwareVersion, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, wirelessLinkStatus=wirelessLinkStatus, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, rFUPowerButtonPressed=rFUPowerButtonPressed, management=management, aTPCEnable=aTPCEnable, sMTPServerPortNumber=sMTPServerPortNumber, rFUSerial=rFUSerial, encryptionAlgorithm=encryptionAlgorithm, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rxDiversityVid=rxDiversityVid, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, sNTPServerPortNumber=sNTPServerPortNumber, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFUFreqSpacing=rFUFreqSpacing, dataPortStatusTrap=dataPortStatusTrap, alarms=alarms, remotePrimarySecondaryMode=remotePrimarySecondaryMode, bootVersion=bootVersion, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, tFTPServerIPAddress=tFTPServerIPAddress, rFURfBand=rFURfBand, sNTPPrimaryServer=sNTPPrimaryServer, rFULockoutAlarm=rFULockoutAlarm, radioLicenseBandwidth=radioLicenseBandwidth, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPServerTable=sNTPServerTable, remotePrimaryMACAddress=remotePrimaryMACAddress, diverseAntennaGain=diverseAntennaGain, sNTPPollInterval=sNTPPollInterval, rFURpsAlarm=rFURpsAlarm, sNTPSync=sNTPSync, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, maximumTransmitPower=maximumTransmitPower, tFTPServerInternetAddress=tFTPServerInternetAddress, syslogState=syslogState, reset=reset, sNTPServerIPAddress=sNTPServerIPAddress, sNMPCommunityString=sNMPCommunityString, securityLevel=securityLevel, sNTPServerRetries=sNTPServerRetries, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, encryption=encryption, neighborInternetAddressType=neighborInternetAddressType, primaryRecovery=primaryRecovery, longitude=longitude, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, secondarySoftwareVersion=secondarySoftwareVersion, rFUTxPowerAlarm=rFUTxPowerAlarm, rFUVersionBank2=rFUVersionBank2, altitude=altitude, softwareVersion=softwareVersion, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFUCableAlarm=rFUCableAlarm, ethernetFiberSupport=ethernetFiberSupport, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, ptmp=ptmp, requestedProtectionState=requestedProtectionState, radioLicenseMaxEIRP=radioLicenseMaxEIRP, activeUnit=activeUnit, wirelessLinkAvailability=wirelessLinkAvailability, configuration=configuration, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, sMTPServerIPAddress=sMTPServerIPAddress, rFUStatusTrap=rFUStatusTrap, protectionStats=protectionStats, localPacketFiltering=localPacketFiltering, vectorError=vectorError, timeZone=timeZone, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, minModulation=minModulation, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, remoteInternetAddress=remoteInternetAddress, userTableEntry=userTableEntry, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, transmitCapacityLimit=transmitCapacityLimit, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, subnetMask=subnetMask, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, iPv6PrefixLength=iPv6PrefixLength, dataPortDisabledWarning=dataPortDisabledWarning, sNTPState=sNTPState, rfu=rfu, mPLSTCPriorityTable=mPLSTCPriorityTable, receivePower=receivePower, userEnabled=userEnabled, sNMPTrapTable=sNMPTrapTable, radioLicenseMinModulation=radioLicenseMinModulation, alignmentMode=alignmentMode, iPv6GatewayAddress=iPv6GatewayAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rFUTxPowerMin=rFUTxPowerMin, remoteMaximumTransmitPower=remoteMaximumTransmitPower, enableTransmission=enableTransmission, protectionStatus=protectionStatus, minCodeRate=minCodeRate, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, qOSPriorityScheme=qOSPriorityScheme, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerTableIndex=sNTPServerTableIndex, userPassword=userPassword, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rFUStatus=rFUStatus, neighborIPAddress=neighborIPAddress, sMTPEmailAlert=sMTPEmailAlert, activeAvailableTime=activeAvailableTime, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, aAAControl=aAAControl, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, hTTPSPortNumber=hTTPSPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, radioLicenseRegion=radioLicenseRegion, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, primarySecondaryMode=primarySecondaryMode, ethernet=ethernet, rFURxFreqMin=rFURxFreqMin, userName=userName, remoteInternetAddressType=remoteInternetAddressType, dataPortStatus=dataPortStatus, managementPortForcedConfiguration=managementPortForcedConfiguration, dataPortFiberStatusTrap=dataPortFiberStatusTrap, protectionAvailabilityStatus=protectionAvailabilityStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, daylightSaving=daylightSaving, hTTPSAccessEnabled=hTTPSAccessEnabled, rxDiversityVlanTpid=rxDiversityVlanTpid, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, productVariant=productVariant, wirelessLinkStatusTrap=wirelessLinkStatusTrap, managementPortStatus=managementPortStatus, managementMode=managementMode, fiberY=fiberY, telnetAccessEnabled=telnetAccessEnabled, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, radioLicense=radioLicense)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", remotePrimaryIPAddress=remotePrimaryIPAddress, unitOutOfCalibration=unitOutOfCalibration, dataPortFiberStatus=dataPortFiberStatus, ptp=ptp, ptpTrapPrefix=ptpTrapPrefix, dSCPManagementPriority=dSCPManagementPriority, aggregateDataRate=aggregateDataRate, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, secureModeAlarm=secureModeAlarm, telnetPortNumber=telnetPortNumber, maxModulation=maxModulation, remoteIPAddress=remoteIPAddress, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rFUTxPowerMax=rFUTxPowerMax, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, radioLicenseBand=radioLicenseBand, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rFUPowerAlarm=rFUPowerAlarm, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, userRole=userRole, protectionConfig=protectionConfig, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveDataRate=receiveDataRate, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, linkNameMismatch=linkNameMismatch, transmitModulation=transmitModulation, sNTPSyncTrap=sNTPSyncTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, managementPortConfigurationMismatch=managementPortConfigurationMismatch, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, radioLicenseIdentifier=radioLicenseIdentifier, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, linkName=linkName, smtp=smtp, rFUType=rFUType, iPv6Address=iPv6Address, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, transmitCodeRate=transmitCodeRate, userTableIndex=userTableIndex, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, secureModeAlarmTrap=secureModeAlarmTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapPortNumber=sNMPTrapPortNumber, remotePrimaryInternetAddress=remotePrimaryInternetAddress, rFUPlatformCompatibility=rFUPlatformCompatibility, hTTPPortNumber=hTTPPortNumber, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, transmitterStatus=transmitterStatus, protection=protection, neighborInternetAddress=neighborInternetAddress, syslogControl=syslogControl, remoteSecondaryIPAddress=remoteSecondaryIPAddress, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, diverseRfFeederLoss=diverseRfFeederLoss, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rFURFSwitchAlarm=rFURFSwitchAlarm, phyControl=phyControl, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, dataPortPauseFrames=dataPortPauseFrames, systemClock=systemClock, sNTPServerTableNumber=sNTPServerTableNumber, radioLicenseTxFreq=radioLicenseTxFreq, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementPortDisabledWarning=managementPortDisabledWarning, neighborMACAddress=neighborMACAddress, transmitCapacity=transmitCapacity, transmitPower=transmitPower, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFUTxMuteStatus=rFUTxMuteStatus, l2CPPriorityTable=l2CPPriorityTable, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rFUTxBandAboveRx=rFUTxBandAboveRx, phyStatus=phyStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, iPv4Address=iPv4Address, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rFUTxFreqMax=rFUTxFreqMax, sntp=sntp, vLANManagementVIDValidation=vLANManagementVIDValidation, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss)
