...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", neighborInternetAddress=neighborInternetAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, vLANManagementVIDValidation=vLANManagementVIDValidation, protectionAvailabilityStatus=protectionAvailabilityStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, receivePower=receivePower, sMTPServerInternetAddress=sMTPServerInternetAddress, configuration=configuration, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, linkNameMismatchTrap=linkNameMismatchTrap, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, radioLicenseTxFreq=radioLicenseTxFreq, unitOutOfCalibration=unitOutOfCalibration, sNTPServerTimeout=sNTPServerTimeout, remoteSecondaryIPAddress=remoteSecondaryIPAddress, primaryRecoveryPeriod=primaryRecoveryPeriod, tFTPServerInternetAddress=tFTPServerInternetAddress, radioLicenseMaxModulation=radioLicenseMaxModulation, productName=productName, rFUTxFreqMax=rFUTxFreqMax, sNMPTrapTable=sNMPTrapTable, rFUTxPowerMin=rFUTxPowerMin, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFURFSwitchAlarm=rFURFSwitchAlarm, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, neighborMACAddress=neighborMACAddress, dataPortStatus=dataPortStatus, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, bootVersion=bootVersion, rxDiversityVlanTpid=rxDiversityVlanTpid, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, radioLicenseRxFreq=radioLicenseRxFreq, secureModeAlarm=secureModeAlarm, radioLicenseBandwidth=radioLicenseBandwidth, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFUConnectedPlatform=rFUConnectedPlatform, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, rFUVersionBank1=rFUVersionBank1, transmitModulation=transmitModulation, syslogClientTrap=syslogClientTrap, secondarySoftwareVersion=secondarySoftwareVersion, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, protectionConfigurationStatus=protectionConfigurationStatus, userEnabled=userEnabled, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFURpsAlarm=rFURpsAlarm, ptmp=ptmp, remotePrimaryIPAddress=remotePrimaryIPAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, licence=licence, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, systemClock=systemClock, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, aggregateDataRate=aggregateDataRate, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dataPortPauseFrames=dataPortPauseFrames, maxModulation=maxModulation, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPServerIPAddress=sMTPServerIPAddress, rFUTransceiverLocation=rFUTransceiverLocation, dataPortFiberStatusTrap=dataPortFiberStatusTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, mPLSTCPriorityTable=mPLSTCPriorityTable, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, ptp800=ptp800, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, requestedProtectionState=requestedProtectionState, rFUPowerAlarm=rFUPowerAlarm, managementPortAutoNegotiation=managementPortAutoNegotiation, rFUTxPowerMax=rFUTxPowerMax, gatewayIPAddress=gatewayIPAddress, radioLicenseIdentifier=radioLicenseIdentifier, vLANManagementVID=vLANManagementVID, managementPortDisabledWarning=managementPortDisabledWarning, protectionStats=protectionStats, rFUVersionBank2=rFUVersionBank2, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerTableEntry=sNTPServerTableEntry, timeZone=timeZone, ptpTraps=ptpTraps, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, aTPCEnable=aTPCEnable, l2CPPriorityTable=l2CPPriorityTable, telnetAccessEnabled=telnetAccessEnabled, radioLicenseCodeRate=radioLicenseCodeRate, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, minModulation=minModulation, linkName=linkName, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, rFUStatus=rFUStatus, rFUFreqSpacing=rFUFreqSpacing, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, encryptionAlgorithm=encryptionAlgorithm, radioLicenseMaxEIRP=radioLicenseMaxEIRP, sNMPTrapTableIndex=sNMPTrapTableIndex, rFULockoutAlarm=rFULockoutAlarm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userTableNumber=userTableNumber, linkLoss=linkLoss, neighborIPAddress=neighborIPAddress, sNTPSyncTrap=sNTPSyncTrap, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, activeUnit=activeUnit, hardwareVersion=hardwareVersion, alarms=alarms, maximumTransmitPower=maximumTransmitPower, iFCableLength=iFCableLength, rFUBranchingConfiguration=rFUBranchingConfiguration, radioLicenseMinModulation=radioLicenseMinModulation, primaryRecovery=primaryRecovery, sMTPEmailAlert=sMTPEmailAlert, rFURxFreqMax=rFURxFreqMax, minCodeRate=minCodeRate, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementPortStatusTrap=managementPortStatusTrap, phyControl=phyControl, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, qOSPriorityScheme=qOSPriorityScheme, syslogStateTrap=syslogStateTrap, productVariant=productVariant, antennaGain=antennaGain, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, remoteSecondaryMACAddress=remoteSecondaryMACAddress, sNTPServerRetries=sNTPServerRetries, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, protectionConfig=protectionConfig, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sNMPTrapIPAddress=sNMPTrapIPAddress, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rFUTxFreqMin=rFUTxFreqMin, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPLastSync=sNTPLastSync, radioLicense=radioLicense, altitude=altitude, encryptionEnabledMismatch=encryptionEnabledMismatch, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerPortNumber=sNTPServerPortNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, securityLevel=securityLevel, remoteIPAddress=remoteIPAddress, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNMPEnabledTraps=sNMPEnabledTraps, ptp=ptp, rFURxFreqMin=rFURxFreqMin, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, hTTPSPortNumber=hTTPSPortNumber, rFUPowerButtonPressed=rFUPowerButtonPressed, secureModeAlarmTrap=secureModeAlarmTrap, dataPortDisabledWarning=dataPortDisabledWarning, userPassword=userPassword, ethernetFiberSupport=ethernetFiberSupport, transmitCodeRate=transmitCodeRate, managementPortStatus=managementPortStatus, transmitterStatus=transmitterStatus, sNTPState=sNTPState, numberOfAntennas=numberOfAntennas, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, userTableIndex=userTableIndex, protection=protection, daylightSaving=daylightSaving, radioLicenseRegion=radioLicenseRegion, protectionStatus=protectionStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFUActiveFirmwareBank=rFUActiveFirmwareBank, snmpControl=snmpControl, neighborInternetAddressType=neighborInternetAddressType, rxDiversityVid=rxDiversityVid, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, management=management, bridge=bridge, rfu=rfu, alignmentMode=alignmentMode, receiveModulation=receiveModulation, sNTPPollInterval=sNTPPollInterval, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, radioLicenseBand=radioLicenseBand, userTableEntry=userTableEntry, radioLicenseMinCodeRate=radioLicenseMinCodeRate, sntp=sntp, rFUType=rFUType, sNMPPortNumber=sNMPPortNumber, managementCommittedInformationRate=managementCommittedInformationRate, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rFUTxBandAboveRx=rFUTxBandAboveRx, remotePrimaryInternetAddress=remotePrimaryInternetAddress, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, smtp=smtp, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, managementPortConfigurationMismatch=managementPortConfigurationMismatch, latitude=latitude, remoteMACAddress=remoteMACAddress, rFUStatusTrap=rFUStatusTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, protectionInterfaceStatus=protectionInterfaceStatus, rxDiversityDataPortStatus=rxDiversityDataPortStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPv4Address=iPv4Address, dataPortStatusTrap=dataPortStatusTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, remoteInternetAddress=remoteInternetAddress, sNTPServerTable=sNTPServerTable, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rFUTxMuteStatus=rFUTxMuteStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, radioLicenseModulation=radioLicenseModulation, syslogState=syslogState, tFTPServerIPAddress=tFTPServerIPAddress, versions=versions, ethernetPriorityTableIndex=ethernetPriorityTableIndex, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, sNTPPrimaryServer=sNTPPrimaryServer, userRole=userRole, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, iPv6GatewayAddress=iPv6GatewayAddress, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, activeWirelessLinkAvailability=activeWirelessLinkAvailability, wirelessLinkAvailability=wirelessLinkAvailability, enableTransmission=enableTransmission, hTTPPortNumber=hTTPPortNumber, endId=endId, vLANManagementPriority=vLANManagementPriority, sNMPCommunityString=sNMPCommunityString, systemReset=systemReset, dataPortWirelessDownAlert=dataPortWirelessDownAlert, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPSync=sNTPSync, sMTPSourceEmailAddress=sMTPSourceEmailAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rFUProtectionCompatibility=rFUProtectionCompatibility, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, sNTPServerTableNumber=sNTPServerTableNumber, linkNameMismatch=linkNameMismatch, sNMPTrapVersion=sNMPTrapVersion, pubStats=pubStats, transmitDataRate=transmitDataRate, faultProtectionSwitching=faultProtectionSwitching)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNTPServerResponse=sNTPServerResponse, protectionSwitchCause=protectionSwitchCause, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, ethernet=ethernet, fiberY=fiberY, siteName=siteName, ethernetPriorityTableNumber=ethernetPriorityTableNumber, receiveCodeRate=receiveCodeRate, sMTPServerInternetAddressType=sMTPServerInternetAddressType, wirelessLinkStatusTrap=wirelessLinkStatusTrap, userTable=userTable, rFUCableAlarm=rFUCableAlarm, encryption=encryption, syslogControl=syslogControl, transmitCapacityLimitDetail=transmitCapacityLimitDetail, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, protectionState=protectionState, iPVersion=iPVersion, telnetPortNumber=telnetPortNumber, transmitCapacity=transmitCapacity, sNMPTrapTableEntry=sNMPTrapTableEntry, reset=reset, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rFUTxPowerAlarm=rFUTxPowerAlarm, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, alignmentModeTrap=alignmentModeTrap, iPv6Address=iPv6Address, sNTPServerInternetAddress=sNTPServerInternetAddress, transmitPower=transmitPower, aAAControl=aAAControl, receiveDataRate=receiveDataRate, activeAvailableTime=activeAvailableTime, rFFeederLoss=rFFeederLoss, syslogClient=syslogClient, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, remotePrimaryMACAddress=remotePrimaryMACAddress, ethernetPriorityTable=ethernetPriorityTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dataPortConfigurationMismatch=dataPortConfigurationMismatch, remoteInternetAddressType=remoteInternetAddressType, diverseAntennaGain=diverseAntennaGain, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, protectionStateTrap=protectionStateTrap, phyStatus=phyStatus, vectorError=vectorError, tFTPServerPortNumber=tFTPServerPortNumber, userName=userName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dSCPManagementPriority=dSCPManagementPriority, supplementary=supplementary, diverseRfFeederLoss=diverseRfFeederLoss, iPv6PrefixLength=iPv6PrefixLength, sMTPServerPortNumber=sMTPServerPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, managementPortForcedConfiguration=managementPortForcedConfiguration, managementMode=managementMode, localPacketFiltering=localPacketFiltering, primarySecondaryMode=primarySecondaryMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerTableIndex=sNTPServerTableIndex, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber, rFUPlatformCompatibility=rFUPlatformCompatibility, subnetMask=subnetMask, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, softwareVersion=softwareVersion, maxCodeRate=maxCodeRate, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataPortFiberStatus=dataPortFiberStatus, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, longitude=longitude, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, rFUSerial=rFUSerial, transmitCapacityLimit=transmitCapacityLimit, cambium=cambium, wirelessLinkStatus=wirelessLinkStatus, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, sNTPServerIPAddress=sNTPServerIPAddress, rFURfBand=rFURfBand)
