...
enterprises, Counter64, iso, Gauge32, MibIdentifier, ModuleIdentity, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, ObjectIdentity, Unsigned32, Counter32, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "iso", "Gauge32", "MibIdentifier", "ModuleIdentity", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "ObjectIdentity", "Unsigned32", "Counter32", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", remoteMACAddress=remoteMACAddress, rFUPowerAlarm=rFUPowerAlarm, sNTPServerTableEntry=sNTPServerTableEntry, sNTPServerTimeout=sNTPServerTimeout, userTableEntry=userTableEntry, rFULockoutAlarm=rFULockoutAlarm, rxDiversityVid=rxDiversityVid, rFUStatusTrap=rFUStatusTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetFiberSupport=ethernetFiberSupport, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerPortNumber=sNTPServerPortNumber, vectorError=vectorError, protectionStatus=protectionStatus, requestedProtectionState=requestedProtectionState, softwareVersion=softwareVersion, ethernet=ethernet, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, receiveCodeRate=receiveCodeRate, smtp=smtp, maxCodeRate=maxCodeRate, radioLicenseRegion=radioLicenseRegion, userTableIndex=userTableIndex, syslogClient=syslogClient, rFUBranchingConfiguration=rFUBranchingConfiguration, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFUTxMuteStatus=rFUTxMuteStatus, alignmentMode=alignmentMode, sNMPTrapTableIndex=sNMPTrapTableIndex, userRole=userRole, radioLicenseBand=radioLicenseBand, dataPortFiberStatusTrap=dataPortFiberStatusTrap, syslogStateTrap=syslogStateTrap, sntp=sntp, tFTPServerInternetAddress=tFTPServerInternetAddress, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, snmpControl=snmpControl, rFUStatus=rFUStatus, qOSPriorityScheme=qOSPriorityScheme, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPServerTableIndex=sNTPServerTableIndex, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, iPv6PrefixLength=iPv6PrefixLength, phyControl=phyControl, sNMPTrapVersion=sNMPTrapVersion, userPassword=userPassword, remotePrimaryIPAddress=remotePrimaryIPAddress, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, dataPortStatus=dataPortStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, tFTPServerPortNumber=tFTPServerPortNumber, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFUTxPowerMin=rFUTxPowerMin, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, iPv6Address=iPv6Address, protectionAvailabilityStatus=protectionAvailabilityStatus, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, l2CPPriorityTableNumber=l2CPPriorityTableNumber, reset=reset, radioLicenseMaxModulation=radioLicenseMaxModulation, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, dataPortFiberStatus=dataPortFiberStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteIPAddress=remoteIPAddress, radioLicenseBandwidth=radioLicenseBandwidth, syslogClientTrap=syslogClientTrap, protectionState=protectionState, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, iPv6GatewayAddress=iPv6GatewayAddress, syslogState=syslogState, antennaGain=antennaGain, managementPortDisabledWarning=managementPortDisabledWarning, rFUActiveFirmwareBank=rFUActiveFirmwareBank, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, diverseRfFeederLoss=diverseRfFeederLoss, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, altitude=altitude, subnetMask=subnetMask, syslogControl=syslogControl, gatewayIPAddress=gatewayIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, activeAvailableTime=activeAvailableTime, encryption=encryption, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rFURpsAlarm=rFURpsAlarm, encryptionAlgorithm=encryptionAlgorithm, transmitDataRate=transmitDataRate, managementPortStatus=managementPortStatus, rFUTxPowerMax=rFUTxPowerMax, remotePrimaryMACAddress=remotePrimaryMACAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, maximumTransmitPower=maximumTransmitPower, rFUPlatformCompatibility=rFUPlatformCompatibility, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, dSCPManagementPriority=dSCPManagementPriority, remoteInternetAddressType=remoteInternetAddressType, alignmentModeTrap=alignmentModeTrap, radioLicenseIdentifier=radioLicenseIdentifier, unitOutOfCalibration=unitOutOfCalibration, managementPortAutoNegotiation=managementPortAutoNegotiation, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, managementPortForcedConfiguration=managementPortForcedConfiguration, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerIPAddress=sNTPServerIPAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, managementPortStatusTrap=managementPortStatusTrap, systemClock=systemClock, radioLicenseMinModulation=radioLicenseMinModulation, protectionStats=protectionStats, neighborInternetAddress=neighborInternetAddress, vLANManagementPriority=vLANManagementPriority, iPv4Address=iPv4Address, sNTPPollInterval=sNTPPollInterval, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, versions=versions, sNTPSyncTrap=sNTPSyncTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receiveModulation=receiveModulation, configuration=configuration, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rFUType=rFUType, rFUCableAlarm=rFUCableAlarm, ptpTraps=ptpTraps, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, licence=licence, linkNameMismatchTrap=linkNameMismatchTrap, transmitModulation=transmitModulation, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, protectionConfig=protectionConfig, ptp=ptp, bootVersion=bootVersion, rFUConnectedPlatform=rFUConnectedPlatform, primarySecondaryMode=primarySecondaryMode, rFUTxBandAboveRx=rFUTxBandAboveRx, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rfu=rfu, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, ptpTrapPrefix=ptpTrapPrefix, primaryRecovery=primaryRecovery, l2CPPriorityTableIndex=l2CPPriorityTableIndex, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, hardwareVersion=hardwareVersion, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, remotePrimaryInternetAddress=remotePrimaryInternetAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, linkName=linkName, sNTPServerTable=sNTPServerTable, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerResponse=sNTPServerResponse, transmitPower=transmitPower, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, remoteInternetAddress=remoteInternetAddress, latitude=latitude, secondarySoftwareVersion=secondarySoftwareVersion, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, syslogLocalWrappedTrap=syslogLocalWrappedTrap, cambium=cambium, iPVersion=iPVersion, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userEnabled=userEnabled, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, primaryRecoveryPeriod=primaryRecoveryPeriod, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetPriorityTable=ethernetPriorityTable, pubStats=pubStats, maxModulation=maxModulation, longitude=longitude, encryptionEnabledMismatch=encryptionEnabledMismatch, sNTPServerInternetAddressType=sNTPServerInternetAddressType, remoteSecondaryIPAddress=remoteSecondaryIPAddress, alarms=alarms, systemReset=systemReset, radioLicenseModulation=radioLicenseModulation, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, management=management, remoteMaximumTransmitPower=remoteMaximumTransmitPower, neighborIPAddress=neighborIPAddress, endId=endId, l2CPPriorityTable=l2CPPriorityTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPTrapTable=sNMPTrapTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPServerRetries=sNTPServerRetries, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, phyStatus=phyStatus, transmitCodeRate=transmitCodeRate, fiberY=fiberY, hTTPAccessEnabled=hTTPAccessEnabled, activeUnit=activeUnit, faultProtectionSwitching=faultProtectionSwitching, userTable=userTable, productVariant=productVariant, productName=productName, rFUTxFreqMin=rFUTxFreqMin, dataPortConfigurationMismatch=dataPortConfigurationMismatch, supplementary=supplementary, iPDSCPPriorityTable=iPDSCPPriorityTable, hTTPPortNumber=hTTPPortNumber, managementCommittedInformationRate=managementCommittedInformationRate, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, neighborInternetAddressType=neighborInternetAddressType, numberOfAntennas=numberOfAntennas, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPCommunityString=sNMPCommunityString, radioLicenseRxFreq=radioLicenseRxFreq, radioLicenseCodeRate=radioLicenseCodeRate, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, vLANManagementVIDValidation=vLANManagementVIDValidation, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, transmitCapacityLimit=transmitCapacityLimit, managementMode=managementMode, l2CPPriorityTableEntry=l2CPPriorityTableEntry, linkLoss=linkLoss, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPState=sNTPState, radioLicense=radioLicense, receivePower=receivePower, sMTPEmailAlert=sMTPEmailAlert, protection=protection, vLANManagementVID=vLANManagementVID, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, radioLicenseMaxEIRP=radioLicenseMaxEIRP, protectionSwitchCause=protectionSwitchCause, ptp800=ptp800, dataPortPauseFrames=dataPortPauseFrames, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, rFUVersionBank1=rFUVersionBank1, rFUFreqSpacing=rFUFreqSpacing, sNTPLastSync=sNTPLastSync)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rxDiversityVlanTpid=rxDiversityVlanTpid, rFURFSwitchAlarm=rFURFSwitchAlarm, rFURxFreqMin=rFURxFreqMin, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ptmp=ptmp, rFUVersionBank2=rFUVersionBank2, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPPrimaryServer=sNTPPrimaryServer, rFUPowerButtonPressed=rFUPowerButtonPressed, transmitterStatus=transmitterStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, wirelessLinkStatusTrap=wirelessLinkStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, secureModeAlarmTrap=secureModeAlarmTrap, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rFURfBand=rFURfBand, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rFFeederLoss=rFFeederLoss, aTPCEnable=aTPCEnable, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rFUProtectionCompatibility=rFUProtectionCompatibility, protectionStateTrap=protectionStateTrap, protectionConfigurationStatus=protectionConfigurationStatus, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, sNMPPortNumber=sNMPPortNumber, rFUTxFreqMax=rFUTxFreqMax, rFUTransceiverLocation=rFUTransceiverLocation, telnetPortNumber=telnetPortNumber, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, dataPortDisabledWarning=dataPortDisabledWarning, receiveDataRate=receiveDataRate, neighborMACAddress=neighborMACAddress, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, protectionInterfaceStatus=protectionInterfaceStatus, securityLevel=securityLevel, userName=userName, mPLSTCPriorityTable=mPLSTCPriorityTable, iFCableLength=iFCableLength, sNTPServerTableNumber=sNTPServerTableNumber, radioLicenseTxFreq=radioLicenseTxFreq, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, sNTPSync=sNTPSync, sMTPServerPortNumber=sMTPServerPortNumber, aggregateDataRate=aggregateDataRate, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, telnetAccessEnabled=telnetAccessEnabled, userTableNumber=userTableNumber, localPacketFiltering=localPacketFiltering, rFUTxPowerAlarm=rFUTxPowerAlarm, rFURxFreqMax=rFURxFreqMax, bridge=bridge, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, aAAControl=aAAControl, enableTransmission=enableTransmission, transmitCapacity=transmitCapacity, managementPortConfigurationMismatch=managementPortConfigurationMismatch, linkNameMismatch=linkNameMismatch, secureModeAlarm=secureModeAlarm, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, wirelessLinkAvailability=wirelessLinkAvailability, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, wirelessLinkStatus=wirelessLinkStatus, minModulation=minModulation, activeWirelessLinkAvailability=activeWirelessLinkAvailability, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, dataPortStatusTrap=dataPortStatusTrap, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, siteName=siteName, daylightSaving=daylightSaving, minCodeRate=minCodeRate, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, rFUSerial=rFUSerial, transmitCapacityLimitDetail=transmitCapacityLimitDetail, timeZone=timeZone, remoteSecondaryMACAddress=remoteSecondaryMACAddress, remotePrimarySecondaryMode=remotePrimarySecondaryMode, diverseAntennaGain=diverseAntennaGain)
