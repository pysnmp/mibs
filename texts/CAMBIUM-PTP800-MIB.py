...
Integer32, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, iso, NotificationType, ModuleIdentity, IpAddress, Unsigned32, MibIdentifier, enterprises, ObjectIdentity, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "iso", "NotificationType", "ModuleIdentity", "IpAddress", "Unsigned32", "MibIdentifier", "enterprises", "ObjectIdentity", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", productName=productName, rxDiversityVid=rxDiversityVid, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, reset=reset, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, radioLicenseModulation=radioLicenseModulation, sMTPServerInternetAddress=sMTPServerInternetAddress, rFUVersionBank1=rFUVersionBank1, protectionConfigurationStatus=protectionConfigurationStatus, radioLicenseRxFreq=radioLicenseRxFreq, rFUSerial=rFUSerial, remoteSecondaryMACAddress=remoteSecondaryMACAddress, cambium=cambium, sntp=sntp, protection=protection, rFUTxPowerMax=rFUTxPowerMax, securityLevel=securityLevel, ptpTraps=ptpTraps, protectionInterfaceStatus=protectionInterfaceStatus, neighborInternetAddress=neighborInternetAddress, unitOutOfCalibration=unitOutOfCalibration, telnetAccessEnabled=telnetAccessEnabled, softwareVersion=softwareVersion, primaryRecovery=primaryRecovery, dataPortConfigurationMismatch=dataPortConfigurationMismatch, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, radioLicenseBandwidth=radioLicenseBandwidth, encryptionAlgorithm=encryptionAlgorithm, protectionState=protectionState, rFULockoutAlarm=rFULockoutAlarm, sNTPServerResponse=sNTPServerResponse, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, transmitterStatus=transmitterStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, managementMode=managementMode, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, activeUnit=activeUnit, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, ethernetPriorityTable=ethernetPriorityTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, linkLoss=linkLoss, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapVersion=sNMPTrapVersion, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, radioLicenseMinModulation=radioLicenseMinModulation, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, bridge=bridge, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, versions=versions, maxCodeRate=maxCodeRate, radioLicenseMinCodeRate=radioLicenseMinCodeRate, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPPrimaryServer=sNTPPrimaryServer, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, vectorError=vectorError, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, sNTPPollInterval=sNTPPollInterval, iPDSCPPriorityTable=iPDSCPPriorityTable, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, userRole=userRole, vLANManagementPriority=vLANManagementPriority, radioLicenseMaxEIRP=radioLicenseMaxEIRP, transmitDataRate=transmitDataRate, userTableEntry=userTableEntry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ptpTrapPrefix=ptpTrapPrefix, siteName=siteName, sNTPSyncTrap=sNTPSyncTrap, smtp=smtp, sNMPTrapTableNumber=sNMPTrapTableNumber, neighborInternetAddressType=neighborInternetAddressType, minCodeRate=minCodeRate, sNTPLastSync=sNTPLastSync, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, faultProtectionSwitching=faultProtectionSwitching, managementPortStatus=managementPortStatus, pubStats=pubStats, rFURxFreqMax=rFURxFreqMax, tFTPServerInternetAddress=tFTPServerInternetAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, userPassword=userPassword, radioLicenseMaxModulation=radioLicenseMaxModulation, localPacketFiltering=localPacketFiltering, rFUTxFreqMax=rFUTxFreqMax, encryptionEnabledMismatch=encryptionEnabledMismatch, sNMPCommunityString=sNMPCommunityString, managementPortDisabledWarning=managementPortDisabledWarning, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFUPowerButtonPressed=rFUPowerButtonPressed, ethernetPriorityTableEntry=ethernetPriorityTableEntry, userTableNumber=userTableNumber, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, primaryRecoveryPeriod=primaryRecoveryPeriod, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFUFreqSpacing=rFUFreqSpacing, linkName=linkName, protectionConfig=protectionConfig, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, dataPortFiberStatus=dataPortFiberStatus, rFUBranchingConfiguration=rFUBranchingConfiguration, systemClock=systemClock, management=management, sNTPServerTable=sNTPServerTable, secondarySoftwareVersion=secondarySoftwareVersion, latitude=latitude, wirelessLinkStatusTrap=wirelessLinkStatusTrap, activeAvailableTime=activeAvailableTime, l2CPPriorityTableEntry=l2CPPriorityTableEntry, remoteSecondaryIPAddress=remoteSecondaryIPAddress, rFUPowerAlarm=rFUPowerAlarm, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPVersion=iPVersion, sNTPServerPortNumber=sNTPServerPortNumber, iPv4Address=iPv4Address, dataPortFiberStatusTrap=dataPortFiberStatusTrap, timeZone=timeZone, antennaGain=antennaGain, transmitCapacityLimit=transmitCapacityLimit, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rFUTxPowerAlarm=rFUTxPowerAlarm, userName=userName, iFCableLength=iFCableLength, l2CPPriorityTable=l2CPPriorityTable, receivePower=receivePower, sNTPState=sNTPState, syslogClientTrap=syslogClientTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerRetries=sNTPServerRetries, bootVersion=bootVersion, rFUActiveFirmwareBank=rFUActiveFirmwareBank, radioLicenseTxFreq=radioLicenseTxFreq, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, aggregateDataRate=aggregateDataRate, sNTPServerTableIndex=sNTPServerTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, rFUStatus=rFUStatus, dataPortDisabledWarning=dataPortDisabledWarning, primarySecondaryMode=primarySecondaryMode, rFUStatusTrap=rFUStatusTrap, syslogControl=syslogControl, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, receiveCodeRate=receiveCodeRate, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, secureModeAlarmTrap=secureModeAlarmTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitPower=transmitPower, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogStateTrap=syslogStateTrap, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rFFeederLoss=rFFeederLoss, sMTPEnabledMessages=sMTPEnabledMessages, remotePrimaryIPAddress=remotePrimaryIPAddress, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, sNTPServerTimeout=sNTPServerTimeout, transmitCapacityLimitDetail=transmitCapacityLimitDetail, minModulation=minModulation, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementPortConfigurationMismatch=managementPortConfigurationMismatch, diverseRfFeederLoss=diverseRfFeederLoss, ethernetFiberSupport=ethernetFiberSupport, productVariant=productVariant, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFUTxBandAboveRx=rFUTxBandAboveRx, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, phyStatus=phyStatus, ptp=ptp, rFURFSwitchAlarm=rFURFSwitchAlarm, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, managementPortStatusTrap=managementPortStatusTrap, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, radioLicenseBand=radioLicenseBand, managementPortWirelessDownAlert=managementPortWirelessDownAlert, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, userEnabled=userEnabled, maxModulation=maxModulation, sNTPServerInternetAddress=sNTPServerInternetAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, subnetMask=subnetMask, diverseAntennaGain=diverseAntennaGain, ptmp=ptmp, protectionAvailabilityStatus=protectionAvailabilityStatus, remoteInternetAddress=remoteInternetAddress, secureModeAlarm=secureModeAlarm, remotePrimaryInternetAddress=remotePrimaryInternetAddress, sMTPServerPortNumber=sMTPServerPortNumber, radioLicenseCodeRate=radioLicenseCodeRate, ptp800=ptp800, mPLSTCPriorityTable=mPLSTCPriorityTable, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, wirelessLinkAvailability=wirelessLinkAvailability, rFURpsAlarm=rFURpsAlarm, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, alarms=alarms, radioLicense=radioLicense, sNMPTrapTable=sNMPTrapTable, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, userTable=userTable, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, rxDiversityVlanTpid=rxDiversityVlanTpid, rFUType=rFUType, radioLicenseIdentifier=radioLicenseIdentifier, sNMPTrapIPAddress=sNMPTrapIPAddress, rxDiversityDataPortStatus=rxDiversityDataPortStatus, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, numberOfAntennas=numberOfAntennas, protectionStateTrap=protectionStateTrap, transmitCapacity=transmitCapacity, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, alignmentModeTrap=alignmentModeTrap, managementCommittedInformationRate=managementCommittedInformationRate, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, neighborIPAddress=neighborIPAddress, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, snmpControl=snmpControl, requestedProtectionState=requestedProtectionState, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hTTPAccessEnabled=hTTPAccessEnabled, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, aTPCEnable=aTPCEnable, supplementary=supplementary, sMTPEmailAlert=sMTPEmailAlert, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, receiveModulation=receiveModulation, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, sNTPServerTableEntry=sNTPServerTableEntry, dataPortStatusTrap=dataPortStatusTrap, rFUTxMuteStatus=rFUTxMuteStatus, phyControl=phyControl, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, syslogState=syslogState, rFUTxPowerMin=rFUTxPowerMin, qOSPriorityScheme=qOSPriorityScheme, dataPortPauseFrames=dataPortPauseFrames, transmitCodeRate=transmitCodeRate, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, managementPortAutoNegotiation=managementPortAutoNegotiation, dataPortStatus=dataPortStatus, remoteMACAddress=remoteMACAddress, rFUPlatformCompatibility=rFUPlatformCompatibility)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", syslogClient=syslogClient, rFURfBand=rFURfBand, tFTPServerInternetAddressType=tFTPServerInternetAddressType, remotePrimarySecondaryMode=remotePrimarySecondaryMode, enableTransmission=enableTransmission, fiberY=fiberY, wirelessLinkStatus=wirelessLinkStatus, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, daylightSaving=daylightSaving, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tFTPServerPortNumber=tFTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkNameMismatch=linkNameMismatch, rFURxFreqMin=rFURxFreqMin, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, protectionStatus=protectionStatus, protectionSwitchCause=protectionSwitchCause, radioLicenseRegion=radioLicenseRegion, systemReset=systemReset, aAAControl=aAAControl, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPPortNumber=sNMPPortNumber, licence=licence, sMTPServerIPAddress=sMTPServerIPAddress, endId=endId, telnetPortNumber=telnetPortNumber, remoteInternetAddressType=remoteInternetAddressType, vLANManagementVID=vLANManagementVID, rFUConnectedPlatform=rFUConnectedPlatform, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, neighborMACAddress=neighborMACAddress, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, rFUProtectionCompatibility=rFUProtectionCompatibility, rFUTransceiverLocation=rFUTransceiverLocation, iPv6GatewayAddress=iPv6GatewayAddress, sNMPEnabledTraps=sNMPEnabledTraps, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, hardwareVersion=hardwareVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, l2CPPriorityTableNumber=l2CPPriorityTableNumber, maximumTransmitPower=maximumTransmitPower, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, configuration=configuration, tFTPServerIPAddress=tFTPServerIPAddress, alignmentMode=alignmentMode, sNTPSync=sNTPSync, enabledDiagnosticAlarms=enabledDiagnosticAlarms, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, hTTPSPortNumber=hTTPSPortNumber, longitude=longitude, managementPortForcedConfiguration=managementPortForcedConfiguration, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, vLANManagementVIDValidation=vLANManagementVIDValidation, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rFUTxFreqMin=rFUTxFreqMin, ethernet=ethernet, sNTPServerIPAddress=sNTPServerIPAddress, iPv6PrefixLength=iPv6PrefixLength, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, userTableIndex=userTableIndex, iPv6Address=iPv6Address, rFUCableAlarm=rFUCableAlarm, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, receiveDataRate=receiveDataRate, hTTPPortNumber=hTTPPortNumber, sNTPServerTableNumber=sNTPServerTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rfu=rfu, remotePrimaryMACAddress=remotePrimaryMACAddress, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, encryption=encryption, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, linkNameMismatchTrap=linkNameMismatchTrap, remoteIPAddress=remoteIPAddress, altitude=altitude, rFUVersionBank2=rFUVersionBank2, protectionStats=protectionStats, transmitModulation=transmitModulation)
