...
Unsigned32, MibIdentifier, Bits, IpAddress, enterprises, Counter64, Gauge32, NotificationType, Counter32, iso, Integer32, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "Bits", "IpAddress", "enterprises", "Counter64", "Gauge32", "NotificationType", "Counter32", "iso", "Integer32", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", diverseAntennaGain=diverseAntennaGain, phyStatus=phyStatus, supplementary=supplementary, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, protectionInterfaceStatus=protectionInterfaceStatus, neighborMACAddress=neighborMACAddress, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerTableIndex=sNTPServerTableIndex, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, dataPortPauseFrames=dataPortPauseFrames, rFUPowerAlarm=rFUPowerAlarm, activeWirelessLinkAvailability=activeWirelessLinkAvailability, ethernetPriorityTableEntry=ethernetPriorityTableEntry, cambium=cambium, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, latitude=latitude, iPv6GatewayAddress=iPv6GatewayAddress, rFURfBand=rFURfBand, dataPortWirelessDownAlert=dataPortWirelessDownAlert, configuration=configuration, productVariant=productVariant, numberOfAntennas=numberOfAntennas, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, protectionStats=protectionStats, gatewayIPAddress=gatewayIPAddress, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dSCPManagementPriority=dSCPManagementPriority, remoteInternetAddress=remoteInternetAddress, pubStats=pubStats, protectionConfig=protectionConfig, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rFUTxPowerAlarm=rFUTxPowerAlarm, bootVersion=bootVersion, activeAvailableTime=activeAvailableTime, iPVersion=iPVersion, requestedProtectionState=requestedProtectionState, rFULockoutAlarm=rFULockoutAlarm, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, hTTPSPortNumber=hTTPSPortNumber, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, userRole=userRole, managementPortForcedConfiguration=managementPortForcedConfiguration, rFUActiveFirmwareBank=rFUActiveFirmwareBank, siteName=siteName, remoteInternetAddressType=remoteInternetAddressType, transmitterStatus=transmitterStatus, managementPortDisabledWarning=managementPortDisabledWarning, remoteSecondaryIPAddress=remoteSecondaryIPAddress, daylightSaving=daylightSaving, userName=userName, tFTPServerInternetAddress=tFTPServerInternetAddress, licence=licence, rFUTxFreqMax=rFUTxFreqMax, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFUBranchingConfiguration=rFUBranchingConfiguration, radioLicense=radioLicense, fiberY=fiberY, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFUTxBandAboveRx=rFUTxBandAboveRx, managementPortWirelessDownAlert=managementPortWirelessDownAlert, managementCommittedInformationRate=managementCommittedInformationRate, ptpTrapPrefix=ptpTrapPrefix, sMTPEnabledMessages=sMTPEnabledMessages, unitOutOfCalibration=unitOutOfCalibration, protectionConfigurationStatus=protectionConfigurationStatus, wirelessLinkStatus=wirelessLinkStatus, sMTPServerIPAddress=sMTPServerIPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, maxModulation=maxModulation, primarySecondaryMode=primarySecondaryMode, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rFURxFreqMin=rFURxFreqMin, sNMPTrapInternetAddress=sNMPTrapInternetAddress, iPv4Address=iPv4Address, remoteMACAddress=remoteMACAddress, hTTPAccessEnabled=hTTPAccessEnabled, alignmentMode=alignmentMode, rFUConnectedPlatform=rFUConnectedPlatform, sntp=sntp, vLANManagementVID=vLANManagementVID, tFTPServerIPAddress=tFTPServerIPAddress, sNMPPortNumber=sNMPPortNumber, protectionAvailabilityStatus=protectionAvailabilityStatus, linkNameMismatch=linkNameMismatch, userTableIndex=userTableIndex, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, ptmp=ptmp, linkName=linkName, sNTPServerPortNumber=sNTPServerPortNumber, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, hardwareVersion=hardwareVersion, aAAControl=aAAControl, encryptionEnabledMismatch=encryptionEnabledMismatch, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPPollInterval=sNTPPollInterval, encryption=encryption, remoteIPAddress=remoteIPAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, faultProtectionSwitching=faultProtectionSwitching, rFUVersionBank2=rFUVersionBank2, sNMPTrapVersion=sNMPTrapVersion, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, radioLicenseCodeRate=radioLicenseCodeRate, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, transmitCapacity=transmitCapacity, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rFFeederLoss=rFFeederLoss, sNTPServerIPAddress=sNTPServerIPAddress, sNTPServerTableEntry=sNTPServerTableEntry, neighborInternetAddress=neighborInternetAddress, managementMode=managementMode, rFURxFreqMax=rFURxFreqMax, sNTPServerTable=sNTPServerTable, radioLicenseBand=radioLicenseBand, userTable=userTable, rFUPowerButtonPressed=rFUPowerButtonPressed, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, sMTPEmailAlert=sMTPEmailAlert, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, longitude=longitude, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, enableTransmission=enableTransmission, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remotePrimaryIPAddress=remotePrimaryIPAddress, alignmentModeTrap=alignmentModeTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, neighborIPAddress=neighborIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, dataPortDisabledWarning=dataPortDisabledWarning, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, diverseRfFeederLoss=diverseRfFeederLoss, sMTPSourceEmailAddress=sMTPSourceEmailAddress, endId=endId, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, radioLicenseMaxModulation=radioLicenseMaxModulation, rFUStatus=rFUStatus, encryptionAlgorithm=encryptionAlgorithm, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, receiveDataRate=receiveDataRate, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, neighborInternetAddressType=neighborInternetAddressType, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sNTPSyncTrap=sNTPSyncTrap, rFUType=rFUType, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, protectionState=protectionState, ethernet=ethernet, remotePrimaryMACAddress=remotePrimaryMACAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNMPTrapTable=sNMPTrapTable, primaryRecoveryPeriod=primaryRecoveryPeriod, iPv6PrefixLength=iPv6PrefixLength, wirelessLinkAvailability=wirelessLinkAvailability, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rFURFSwitchAlarm=rFURFSwitchAlarm, ethernetFiberSupport=ethernetFiberSupport, linkLoss=linkLoss, syslogLocalWrappedTrap=syslogLocalWrappedTrap, localPacketFiltering=localPacketFiltering, rFUVersionBank1=rFUVersionBank1, rFUTxPowerMax=rFUTxPowerMax, sNTPPrimaryServer=sNTPPrimaryServer, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortStatus=dataPortStatus, rFUTransceiverLocation=rFUTransceiverLocation, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, userTableEntry=userTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, timeZone=timeZone, maximumTransmitPower=maximumTransmitPower, sNTPLastSync=sNTPLastSync, vectorError=vectorError, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, maxCodeRate=maxCodeRate, vLANManagementPriority=vLANManagementPriority, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetPriorityTable=ethernetPriorityTable, transmitDataRate=transmitDataRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userTableNumber=userTableNumber, wirelessLinkStatusTrap=wirelessLinkStatusTrap, sNTPServerRetries=sNTPServerRetries, subnetMask=subnetMask, sNTPSync=sNTPSync, sNMPTrapTableNumber=sNMPTrapTableNumber, managementPortStatusTrap=managementPortStatusTrap, aggregateDataRate=aggregateDataRate, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, radioLicenseTxFreq=radioLicenseTxFreq, iPv6Address=iPv6Address, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, secureModeAlarm=secureModeAlarm, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, vLANManagementVIDValidation=vLANManagementVIDValidation, sNTPServerInternetAddress=sNTPServerInternetAddress, protectionStatus=protectionStatus, rFUCableAlarm=rFUCableAlarm, sNTPServerResponse=sNTPServerResponse, receiveModulation=receiveModulation, managementPortStatus=managementPortStatus, altitude=altitude, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, linkNameMismatchTrap=linkNameMismatchTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, transmitPower=transmitPower, rFUPlatformCompatibility=rFUPlatformCompatibility, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogStateTrap=syslogStateTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, telnetAccessEnabled=telnetAccessEnabled, securityLevel=securityLevel, rxDiversityVlanTpid=rxDiversityVlanTpid, radioLicenseMinCodeRate=radioLicenseMinCodeRate, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, alarms=alarms, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, hTTPPortNumber=hTTPPortNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, systemClock=systemClock, reset=reset, sNTPState=sNTPState, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ptp800=ptp800, iFCableLength=iFCableLength, dataPortStatusTrap=dataPortStatusTrap, rfu=rfu, mPLSTCPriorityTable=mPLSTCPriorityTable, transmitCapacityLimitDetail=transmitCapacityLimitDetail)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", syslogClient=syslogClient, qOSPriorityScheme=qOSPriorityScheme, sNTPServerInternetAddressType=sNTPServerInternetAddressType, managementPortAutoNegotiation=managementPortAutoNegotiation, receiveCodeRate=receiveCodeRate, protection=protection, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, protectionStateTrap=protectionStateTrap, remotePrimaryInternetAddress=remotePrimaryInternetAddress, userPassword=userPassword, remotePrimarySecondaryMode=remotePrimarySecondaryMode, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, systemReset=systemReset, secureModeAlarmTrap=secureModeAlarmTrap, minCodeRate=minCodeRate, smtp=smtp, iPDSCPPriorityTable=iPDSCPPriorityTable, bridge=bridge, tFTPServerInternetAddressType=tFTPServerInternetAddressType, radioLicenseRxFreq=radioLicenseRxFreq, activeUnit=activeUnit, ethernetPriorityTableIndex=ethernetPriorityTableIndex, radioLicenseRegion=radioLicenseRegion, productName=productName, sNMPTrapIPAddress=sNMPTrapIPAddress, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, management=management, versions=versions, ptpTraps=ptpTraps, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, radioLicenseModulation=radioLicenseModulation, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, sNMPCommunityString=sNMPCommunityString, rFUFreqSpacing=rFUFreqSpacing, syslogState=syslogState, sNMPTrapTableEntry=sNMPTrapTableEntry, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, radioLicenseIdentifier=radioLicenseIdentifier, dataPortFiberStatus=dataPortFiberStatus, telnetPortNumber=telnetPortNumber, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, radioLicenseBandwidth=radioLicenseBandwidth, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFUProtectionCompatibility=rFUProtectionCompatibility, aTPCEnable=aTPCEnable, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, rFUSerial=rFUSerial, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, antennaGain=antennaGain, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rFUTxFreqMin=rFUTxFreqMin, ptp=ptp, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, l2CPPriorityTable=l2CPPriorityTable, phyControl=phyControl, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, radioLicenseMinModulation=radioLicenseMinModulation, rFUTxPowerMin=rFUTxPowerMin, rxDiversityVid=rxDiversityVid, transmitModulation=transmitModulation, userEnabled=userEnabled, sNTPServerTimeout=sNTPServerTimeout, protectionSwitchCause=protectionSwitchCause, rFURpsAlarm=rFURpsAlarm, syslogControl=syslogControl, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, remoteSecondaryMACAddress=remoteSecondaryMACAddress, syslogClientTrap=syslogClientTrap, rFUStatusTrap=rFUStatusTrap, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, snmpControl=snmpControl, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sNTPServerTableNumber=sNTPServerTableNumber, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, softwareVersion=softwareVersion, receivePower=receivePower, primaryRecovery=primaryRecovery, rFUTxMuteStatus=rFUTxMuteStatus, minModulation=minModulation, transmitCapacityLimit=transmitCapacityLimit, transmitCodeRate=transmitCodeRate)
