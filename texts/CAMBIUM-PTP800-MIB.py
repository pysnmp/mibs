...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, remoteSecondaryIPAddress=remoteSecondaryIPAddress, cambium=cambium, managementPortAutoNegotiation=managementPortAutoNegotiation, rFURFSwitchAlarm=rFURFSwitchAlarm, sNTPLastSync=sNTPLastSync, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, linkName=linkName, receiveModulation=receiveModulation, sNTPServerTable=sNTPServerTable, dataPortPauseFrames=dataPortPauseFrames, faultProtectionSwitching=faultProtectionSwitching, sNTPPrimaryServer=sNTPPrimaryServer, tFTPServerPortNumber=tFTPServerPortNumber, telnetAccessEnabled=telnetAccessEnabled, managementPortWirelessDownAlert=managementPortWirelessDownAlert, transmitCapacityLimitDetail=transmitCapacityLimitDetail, receiveDataRate=receiveDataRate, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, radioLicenseMaxEIRP=radioLicenseMaxEIRP, rFFeederLoss=rFFeederLoss, sNMPPortNumber=sNMPPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, radioLicenseBand=radioLicenseBand, rxDiversityVlanTpid=rxDiversityVlanTpid, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, configuration=configuration, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, sMTPEnabledMessages=sMTPEnabledMessages, transmitterStatus=transmitterStatus, systemClock=systemClock, gatewayIPAddress=gatewayIPAddress, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, sNTPState=sNTPState, sNTPServerRetries=sNTPServerRetries, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, bridge=bridge, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyControl=phyControl, sNMPTrapVersion=sNMPTrapVersion, ethernetFiberSupport=ethernetFiberSupport, licence=licence, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dSCPManagementPriority=dSCPManagementPriority, rFUTxMuteStatus=rFUTxMuteStatus, userTable=userTable, remotePrimaryIPAddress=remotePrimaryIPAddress, protectionConfigurationStatus=protectionConfigurationStatus, remoteInternetAddressType=remoteInternetAddressType, vLANManagementPriority=vLANManagementPriority, syslogClient=syslogClient, timeZone=timeZone, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, snmpControl=snmpControl, dataPortConfigurationMismatch=dataPortConfigurationMismatch, longitude=longitude, sNTPSync=sNTPSync, phyStatus=phyStatus, hardwareVersion=hardwareVersion, tFTPServerInternetAddress=tFTPServerInternetAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, vLANManagementVIDValidation=vLANManagementVIDValidation, neighborInternetAddressType=neighborInternetAddressType, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, subnetMask=subnetMask, userTableEntry=userTableEntry, remoteMACAddress=remoteMACAddress, rFUStatusTrap=rFUStatusTrap, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, rFURfBand=rFURfBand, securityLevel=securityLevel, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rFUActiveFirmwareBank=rFUActiveFirmwareBank, qOSPriorityScheme=qOSPriorityScheme, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rFUPlatformCompatibility=rFUPlatformCompatibility, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, transmitModulation=transmitModulation, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, numberOfAntennas=numberOfAntennas, secureModeAlarm=secureModeAlarm, aggregateDataRate=aggregateDataRate, protectionStatus=protectionStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rfu=rfu, ethernet=ethernet, neighborIPAddress=neighborIPAddress, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, rFUVersionBank2=rFUVersionBank2, radioLicenseCodeRate=radioLicenseCodeRate, maxModulation=maxModulation, sNTPServerTableEntry=sNTPServerTableEntry, hTTPPortNumber=hTTPPortNumber, versions=versions, minCodeRate=minCodeRate, rFUStatus=rFUStatus, rFUBranchingConfiguration=rFUBranchingConfiguration, ptpTraps=ptpTraps, iFCableLength=iFCableLength, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, reset=reset, alignmentModeTrap=alignmentModeTrap, userTableIndex=userTableIndex, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rFUCableAlarm=rFUCableAlarm, dataPortStatus=dataPortStatus, transmitDataRate=transmitDataRate, sNTPServerResponse=sNTPServerResponse, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, localPacketFiltering=localPacketFiltering, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, protection=protection, antennaGain=antennaGain, telnetPortNumber=telnetPortNumber, sNMPTrapTable=sNMPTrapTable, sMTPEmailAlert=sMTPEmailAlert, diverseAntennaGain=diverseAntennaGain, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, userEnabled=userEnabled, rFUPowerAlarm=rFUPowerAlarm, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, requestedProtectionState=requestedProtectionState, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sMTPServerInternetAddressType=sMTPServerInternetAddressType, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, rFUTxFreqMin=rFUTxFreqMin, transmitCapacity=transmitCapacity, primarySecondaryMode=primarySecondaryMode, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, ptp=ptp, ptpTrapPrefix=ptpTrapPrefix, encryptionEnabledMismatch=encryptionEnabledMismatch, remotePrimaryInternetAddress=remotePrimaryInternetAddress, radioLicenseRegion=radioLicenseRegion, managementMode=managementMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, alarms=alarms, receiveCodeRate=receiveCodeRate, managementPortStatusTrap=managementPortStatusTrap, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, sNTPServerIPAddress=sNTPServerIPAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rFUTxFreqMax=rFUTxFreqMax, rFUFreqSpacing=rFUFreqSpacing, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rFUSerial=rFUSerial, hTTPAccessEnabled=hTTPAccessEnabled, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sNMPTrapPortNumber=sNMPTrapPortNumber, rFUTxPowerAlarm=rFUTxPowerAlarm, sNTPServerInternetAddress=sNTPServerInternetAddress, neighborMACAddress=neighborMACAddress, bootVersion=bootVersion, latitude=latitude, protectionStats=protectionStats, syslogStateTrap=syslogStateTrap, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, altitude=altitude, syslogControl=syslogControl, radioLicenseBandwidth=radioLicenseBandwidth, transmitCapacityLimit=transmitCapacityLimit, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, encryption=encryption, remotePrimarySecondaryMode=remotePrimarySecondaryMode, sMTPServerInternetAddress=sMTPServerInternetAddress, radioLicenseMaxModulation=radioLicenseMaxModulation, remoteIPAddress=remoteIPAddress, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, rFURpsAlarm=rFURpsAlarm, iPDSCPPriorityTable=iPDSCPPriorityTable, activeWirelessLinkAvailability=activeWirelessLinkAvailability, daylightSaving=daylightSaving, rxDiversityVid=rxDiversityVid, protectionStateTrap=protectionStateTrap, managementPortStatus=managementPortStatus, sNTPSyncTrap=sNTPSyncTrap, vectorError=vectorError, productVariant=productVariant, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, receivePower=receivePower, protectionState=protectionState, tFTPServerIPAddress=tFTPServerIPAddress, syslogState=syslogState, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, rFUTransceiverLocation=rFUTransceiverLocation, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, vLANManagementVID=vLANManagementVID, rFULockoutAlarm=rFULockoutAlarm, ethernetPriorityTable=ethernetPriorityTable, sNTPServerTimeout=sNTPServerTimeout, pubStats=pubStats, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, enableTransmission=enableTransmission, rFUPowerButtonPressed=rFUPowerButtonPressed, siteName=siteName, productName=productName, secureModeAlarmTrap=secureModeAlarmTrap, aAAControl=aAAControl, sMTPServerIPAddress=sMTPServerIPAddress, userTableNumber=userTableNumber, unitOutOfCalibration=unitOutOfCalibration, radioLicenseModulation=radioLicenseModulation, endId=endId, aTPCEnable=aTPCEnable, neighborInternetAddress=neighborInternetAddress, ptp800=ptp800, encryptionAlgorithm=encryptionAlgorithm, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rFUType=rFUType, remoteMaximumTransmitPower=remoteMaximumTransmitPower, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortFiberStatus=dataPortFiberStatus, iPv4Address=iPv4Address, sNTPServerTableNumber=sNTPServerTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, wirelessLinkStatus=wirelessLinkStatus, alignmentMode=alignmentMode, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, rFUConnectedPlatform=rFUConnectedPlatform, linkNameMismatch=linkNameMismatch, rFUProtectionCompatibility=rFUProtectionCompatibility, remoteSecondaryMACAddress=remoteSecondaryMACAddress, smtp=smtp, sNTPServerTableIndex=sNTPServerTableIndex, iPv6PrefixLength=iPv6PrefixLength)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFURxFreqMin=rFURxFreqMin, radioLicenseTxFreq=radioLicenseTxFreq, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rFUTxBandAboveRx=rFUTxBandAboveRx, primaryRecoveryPeriod=primaryRecoveryPeriod, ptmp=ptmp, hTTPSPortNumber=hTTPSPortNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, maxCodeRate=maxCodeRate, rFUTxPowerMax=rFUTxPowerMax, syslogClientTrap=syslogClientTrap, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, userPassword=userPassword, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, sNTPPollInterval=sNTPPollInterval, fiberY=fiberY, userName=userName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, activeUnit=activeUnit, radioLicenseRxFreq=radioLicenseRxFreq, userRole=userRole, managementPortDisabledWarning=managementPortDisabledWarning, rFURxFreqMax=rFURxFreqMax, protectionConfig=protectionConfig, diverseRfFeederLoss=diverseRfFeederLoss, sntp=sntp, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, dataPortStatusTrap=dataPortStatusTrap, radioLicenseMinModulation=radioLicenseMinModulation, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, maximumTransmitPower=maximumTransmitPower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, radioLicenseIdentifier=radioLicenseIdentifier, systemReset=systemReset, protectionAvailabilityStatus=protectionAvailabilityStatus, managementCommittedInformationRate=managementCommittedInformationRate, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv6Address=iPv6Address, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, management=management, managementPortForcedConfiguration=managementPortForcedConfiguration, remotePrimaryMACAddress=remotePrimaryMACAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortDisabledWarning=dataPortDisabledWarning, mPLSTCPriorityTable=mPLSTCPriorityTable, wirelessLinkStatusTrap=wirelessLinkStatusTrap, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, transmitPower=transmitPower, softwareVersion=softwareVersion, linkNameMismatchTrap=linkNameMismatchTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, l2CPPriorityTable=l2CPPriorityTable, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, iPv6GatewayAddress=iPv6GatewayAddress, linkLoss=linkLoss, radioLicenseMinCodeRate=radioLicenseMinCodeRate, sNMPCommunityString=sNMPCommunityString, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUTxPowerMin=rFUTxPowerMin, activeAvailableTime=activeAvailableTime, supplementary=supplementary, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, minModulation=minModulation, primaryRecovery=primaryRecovery, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, protectionInterfaceStatus=protectionInterfaceStatus, sNMPEnabledTraps=sNMPEnabledTraps, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rxDiversityDataPortStatus=rxDiversityDataPortStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, iPVersion=iPVersion, radioLicense=radioLicense, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, transmitCodeRate=transmitCodeRate, protectionSwitchCause=protectionSwitchCause, remoteInternetAddress=remoteInternetAddress, rFUVersionBank1=rFUVersionBank1, wirelessLinkAvailability=wirelessLinkAvailability, hTTPSAccessEnabled=hTTPSAccessEnabled)
