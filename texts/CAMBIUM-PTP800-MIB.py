...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", protection=protection, dataPortFiberStatus=dataPortFiberStatus, encryption=encryption, linkName=linkName, minCodeRate=minCodeRate, radioLicenseRxFreq=radioLicenseRxFreq, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, sNTPSyncTrap=sNTPSyncTrap, remoteIPAddress=remoteIPAddress, rFURfBand=rFURfBand, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, activeAvailableTime=activeAvailableTime, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rFUTxFreqMin=rFUTxFreqMin, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, managementPortStatus=managementPortStatus, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, sNTPServerInternetAddress=sNTPServerInternetAddress, pubStats=pubStats, alarms=alarms, ethernetPriorityTableNumber=ethernetPriorityTableNumber, maxModulation=maxModulation, dataPortStatusTrap=dataPortStatusTrap, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, transmitCodeRate=transmitCodeRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, versions=versions, rFUPowerAlarm=rFUPowerAlarm, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, transmitDataRate=transmitDataRate, longitude=longitude, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, primaryRecovery=primaryRecovery, diverseAntennaGain=diverseAntennaGain, radioLicenseMaxModulation=radioLicenseMaxModulation, ethernetPriorityTable=ethernetPriorityTable, encryptionAlgorithm=encryptionAlgorithm, cambium=cambium, protectionStatus=protectionStatus, dataPortDisabledWarning=dataPortDisabledWarning, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, transmitterStatus=transmitterStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, radioLicenseBandwidth=radioLicenseBandwidth, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, diverseRfFeederLoss=diverseRfFeederLoss, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, dataPortPauseFrames=dataPortPauseFrames, faultProtectionSwitching=faultProtectionSwitching, bootVersion=bootVersion, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, neighborMACAddress=neighborMACAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, userTable=userTable, protectionStats=protectionStats, rFUTxPowerAlarm=rFUTxPowerAlarm, sNMPPortNumber=sNMPPortNumber, remotePrimaryIPAddress=remotePrimaryIPAddress, sNMPTrapTable=sNMPTrapTable, protectionStateTrap=protectionStateTrap, userPassword=userPassword, secureModeAlarmTrap=secureModeAlarmTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, protectionState=protectionState, rFUStatus=rFUStatus, primarySecondaryMode=primarySecondaryMode, dSCPManagementPriority=dSCPManagementPriority, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, transmitCapacityLimit=transmitCapacityLimit, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPSync=sNTPSync, rFUType=rFUType, configuration=configuration, receiveDataRate=receiveDataRate, hTTPAccessEnabled=hTTPAccessEnabled, securityLevel=securityLevel, localPacketFiltering=localPacketFiltering, sNTPServerTableIndex=sNTPServerTableIndex, softwareVersion=softwareVersion, protectionConfigurationStatus=protectionConfigurationStatus, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, dataPortStatus=dataPortStatus, hTTPSPortNumber=hTTPSPortNumber, remoteSecondaryIPAddress=remoteSecondaryIPAddress, rFFeederLoss=rFFeederLoss, reset=reset, rFUConnectedPlatform=rFUConnectedPlatform, rFURFSwitchAlarm=rFURFSwitchAlarm, activeWirelessLinkAvailability=activeWirelessLinkAvailability, transmitCapacityLimitDetail=transmitCapacityLimitDetail, managementMode=managementMode, hTTPPortNumber=hTTPPortNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rxDiversityVid=rxDiversityVid, userTableIndex=userTableIndex, rFUTxFreqMax=rFUTxFreqMax, rFUFreqSpacing=rFUFreqSpacing, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, hardwareVersion=hardwareVersion, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, subnetMask=subnetMask, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, sMTPServerIPAddress=sMTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, timeZone=timeZone, sMTPServerPortNumber=sMTPServerPortNumber, neighborIPAddress=neighborIPAddress, rFUTxBandAboveRx=rFUTxBandAboveRx, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementPortAutoNegotiation=managementPortAutoNegotiation, neighborInternetAddress=neighborInternetAddress, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, receivePower=receivePower, sNMPTrapIPAddress=sNMPTrapIPAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, remoteMACAddress=remoteMACAddress, telnetPortNumber=telnetPortNumber, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sNTPLastSync=sNTPLastSync, managementPortForcedConfiguration=managementPortForcedConfiguration, management=management, vLANManagementVID=vLANManagementVID, rFURpsAlarm=rFURpsAlarm, siteName=siteName, altitude=altitude, dataPortConfigurationMismatch=dataPortConfigurationMismatch, protectionAvailabilityStatus=protectionAvailabilityStatus, radioLicenseIdentifier=radioLicenseIdentifier, protectionSwitchCause=protectionSwitchCause, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFULockoutAlarm=rFULockoutAlarm, radioLicenseMaxEIRP=radioLicenseMaxEIRP, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkStatusTrap=wirelessLinkStatusTrap, sNTPPrimaryServer=sNTPPrimaryServer, iPDSCPPriorityTable=iPDSCPPriorityTable, userTableNumber=userTableNumber, ptpTrapPrefix=ptpTrapPrefix, syslogClientTrap=syslogClientTrap, activeUnit=activeUnit, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, systemReset=systemReset, sMTPEmailAlert=sMTPEmailAlert, requestedProtectionState=requestedProtectionState, sNTPServerTableNumber=sNTPServerTableNumber, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rfu=rfu, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFUActiveFirmwareBank=rFUActiveFirmwareBank, telnetAccessEnabled=telnetAccessEnabled, phyStatus=phyStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, remotePrimaryMACAddress=remotePrimaryMACAddress, sNTPServerRetries=sNTPServerRetries, radioLicense=radioLicense, ptmp=ptmp, rxDiversityDataPortStatus=rxDiversityDataPortStatus, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, secondarySoftwareVersion=secondarySoftwareVersion, managementCommittedInformationRate=managementCommittedInformationRate, rFUVersionBank1=rFUVersionBank1, sNMPTrapVersion=sNMPTrapVersion, rFUCableAlarm=rFUCableAlarm, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licence=licence, l2CPPriorityTable=l2CPPriorityTable, protectionInterfaceStatus=protectionInterfaceStatus, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, wirelessLinkAvailability=wirelessLinkAvailability, rFUTxPowerMin=rFUTxPowerMin, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, minModulation=minModulation, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, tFTPServerPortNumber=tFTPServerPortNumber, ethernet=ethernet, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ethernetFiberSupport=ethernetFiberSupport, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, phyControl=phyControl, sNMPTrapTableEntry=sNMPTrapTableEntry, secureModeAlarm=secureModeAlarm, primaryRecoveryPeriod=primaryRecoveryPeriod, rFURxFreqMin=rFURxFreqMin, sNTPServerIPAddress=sNTPServerIPAddress, wirelessLinkStatus=wirelessLinkStatus, userRole=userRole, radioLicenseCodeRate=radioLicenseCodeRate, numberOfAntennas=numberOfAntennas, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rFURxFreqMax=rFURxFreqMax, dataPortFiberStatusTrap=dataPortFiberStatusTrap, aAAControl=aAAControl, iPv4Address=iPv4Address, tFTPServerIPAddress=tFTPServerIPAddress, maxCodeRate=maxCodeRate, aTPCEnable=aTPCEnable, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, protectionConfig=protectionConfig, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rFUTxMuteStatus=rFUTxMuteStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, unitOutOfCalibration=unitOutOfCalibration, productName=productName, transmitCapacity=transmitCapacity, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, transmitModulation=transmitModulation, qOSPriorityScheme=qOSPriorityScheme, radioLicenseMinModulation=radioLicenseMinModulation, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, vLANManagementPriority=vLANManagementPriority, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, sntp=sntp, sNMPEnabledTraps=sNMPEnabledTraps, endId=endId, remotePrimaryInternetAddress=remotePrimaryInternetAddress, radioLicenseTxFreq=radioLicenseTxFreq, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sMTPEnabledMessages=sMTPEnabledMessages, userTableEntry=userTableEntry, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, aggregateDataRate=aggregateDataRate, sMTPServerInternetAddress=sMTPServerInternetAddress, iFCableLength=iFCableLength, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, linkNameMismatch=linkNameMismatch, linkLoss=linkLoss, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, radioLicenseBand=radioLicenseBand, antennaGain=antennaGain, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFUTxPowerMax=rFUTxPowerMax, remoteInternetAddress=remoteInternetAddress, neighborInternetAddressType=neighborInternetAddressType)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", systemClock=systemClock, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, userEnabled=userEnabled, userName=userName, sNTPServerResponse=sNTPServerResponse, ptp=ptp, vLANManagementVIDValidation=vLANManagementVIDValidation, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, encryptionEnabledMismatch=encryptionEnabledMismatch, gatewayIPAddress=gatewayIPAddress, iPv6GatewayAddress=iPv6GatewayAddress, latitude=latitude, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, radioLicenseModulation=radioLicenseModulation, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rFUTransceiverLocation=rFUTransceiverLocation, remoteMaximumTransmitPower=remoteMaximumTransmitPower, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ptpTraps=ptpTraps, syslogControl=syslogControl, radioLicenseMinCodeRate=radioLicenseMinCodeRate, sNTPServerTable=sNTPServerTable, supplementary=supplementary, rFUPowerButtonPressed=rFUPowerButtonPressed, rFUProtectionCompatibility=rFUProtectionCompatibility, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, remotePrimarySecondaryMode=remotePrimarySecondaryMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, fiberY=fiberY, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, rFUBranchingConfiguration=rFUBranchingConfiguration, rFUSerial=rFUSerial, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, rFUVersionBank2=rFUVersionBank2, sNTPServerPortNumber=sNTPServerPortNumber, linkNameMismatchTrap=linkNameMismatchTrap, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFUPlatformCompatibility=rFUPlatformCompatibility, enableTransmission=enableTransmission, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitPower=transmitPower, rFUStatusTrap=rFUStatusTrap, sNTPPollInterval=sNTPPollInterval, receiveCodeRate=receiveCodeRate, iPv6PrefixLength=iPv6PrefixLength, sNTPServerInternetAddressType=sNTPServerInternetAddressType, managementPortStatusTrap=managementPortStatusTrap, ptp800=ptp800, bridge=bridge, daylightSaving=daylightSaving, vectorError=vectorError, smtp=smtp, sNTPServerTableEntry=sNTPServerTableEntry, sNTPState=sNTPState, syslogState=syslogState, sNTPServerTimeout=sNTPServerTimeout, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityString=sNMPCommunityString, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, sNMPTrapInternetAddress=sNMPTrapInternetAddress, managementPortDisabledWarning=managementPortDisabledWarning, iPVersion=iPVersion, iPv6Address=iPv6Address, alignmentMode=alignmentMode, syslogClient=syslogClient, receiveModulation=receiveModulation, syslogStateTrap=syslogStateTrap, remoteInternetAddressType=remoteInternetAddressType, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, radioLicenseRegion=radioLicenseRegion, alignmentModeTrap=alignmentModeTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, productVariant=productVariant, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rxDiversityVlanTpid=rxDiversityVlanTpid, snmpControl=snmpControl, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber)
