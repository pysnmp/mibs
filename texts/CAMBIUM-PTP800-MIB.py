...
MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, enterprises, Integer32, Counter64, IpAddress, TimeTicks, Bits, Gauge32, NotificationType, ObjectIdentity, MibIdentifier, iso, Counter32, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "enterprises", "Integer32", "Counter64", "IpAddress", "TimeTicks", "Bits", "Gauge32", "NotificationType", "ObjectIdentity", "MibIdentifier", "iso", "Counter32", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", systemReset=systemReset, dataPortFiberStatusTrap=dataPortFiberStatusTrap, aggregateDataRate=aggregateDataRate, managementPortDisabledWarning=managementPortDisabledWarning, dataPortStatus=dataPortStatus, userTableIndex=userTableIndex, dataPortPauseFrames=dataPortPauseFrames, encryptionAlgorithm=encryptionAlgorithm, fiberY=fiberY, sMTPEnabledMessages=sMTPEnabledMessages, syslogStateTrap=syslogStateTrap, rFURxFreqMin=rFURxFreqMin, ptp800=ptp800, managementMode=managementMode, telnetPortNumber=telnetPortNumber, bridge=bridge, syslogClient=syslogClient, l2CPPriorityTableNumber=l2CPPriorityTableNumber, latitude=latitude, localPacketFiltering=localPacketFiltering, sNTPPollInterval=sNTPPollInterval, rFUTxPowerAlarm=rFUTxPowerAlarm, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, vLANManagementVID=vLANManagementVID, linkNameMismatchTrap=linkNameMismatchTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, systemClock=systemClock, phyControl=phyControl, rFUPowerButtonPressed=rFUPowerButtonPressed, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, wirelessLinkStatusTrap=wirelessLinkStatusTrap, remotePrimaryInternetAddress=remotePrimaryInternetAddress, radioLicenseModulation=radioLicenseModulation, endId=endId, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPServerInternetAddress=sNTPServerInternetAddress, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, remoteSecondaryMACAddress=remoteSecondaryMACAddress, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rFUStatus=rFUStatus, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, ptpTrapPrefix=ptpTrapPrefix, radioLicenseMaxModulation=radioLicenseMaxModulation, radioLicenseRegion=radioLicenseRegion, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, radioLicenseCodeRate=radioLicenseCodeRate, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, antennaGain=antennaGain, ptpTraps=ptpTraps, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, receivePower=receivePower, tFTPServerIPAddress=tFTPServerIPAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPServerTimeout=sNTPServerTimeout, neighborIPAddress=neighborIPAddress, vLANManagementVIDValidation=vLANManagementVIDValidation, aAAControl=aAAControl, rFUPowerAlarm=rFUPowerAlarm, bootVersion=bootVersion, rFURpsAlarm=rFURpsAlarm, transmitCapacityLimitDetail=transmitCapacityLimitDetail, pubStats=pubStats, sNMPTrapIPAddress=sNMPTrapIPAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, protectionStatus=protectionStatus, rFUSerial=rFUSerial, remotePrimaryIPAddress=remotePrimaryIPAddress, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, ptmp=ptmp, protectionConfig=protectionConfig, tFTPServerPortNumber=tFTPServerPortNumber, vectorError=vectorError, rxDiversityDataPortStatus=rxDiversityDataPortStatus, rxDiversityVid=rxDiversityVid, timeZone=timeZone, rFUTxBandAboveRx=rFUTxBandAboveRx, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rfu=rfu, longitude=longitude, snmpControl=snmpControl, rFUTxFreqMin=rFUTxFreqMin, sNTPSyncTrap=sNTPSyncTrap, configuration=configuration, productName=productName, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, dataPortStatusTrap=dataPortStatusTrap, iFCableLength=iFCableLength, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, iPv6GatewayAddress=iPv6GatewayAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFUType=rFUType, remoteSecondaryIPAddress=remoteSecondaryIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, remoteMACAddress=remoteMACAddress, secureModeAlarmTrap=secureModeAlarmTrap, sNTPServerResponse=sNTPServerResponse, secureModeAlarm=secureModeAlarm, rFUPlatformCompatibility=rFUPlatformCompatibility, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitterStatus=transmitterStatus, phyStatus=phyStatus, protectionInterfaceStatus=protectionInterfaceStatus, neighborInternetAddress=neighborInternetAddress, rFUProtectionCompatibility=rFUProtectionCompatibility, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, receiveDataRate=receiveDataRate, protectionAvailabilityStatus=protectionAvailabilityStatus, radioLicenseRxFreq=radioLicenseRxFreq, hTTPAccessEnabled=hTTPAccessEnabled, radioLicenseTxFreq=radioLicenseTxFreq, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, faultProtectionSwitching=faultProtectionSwitching, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, qOSPriorityScheme=qOSPriorityScheme, primarySecondaryMode=primarySecondaryMode, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, radioLicenseMaxEIRP=radioLicenseMaxEIRP, smtp=smtp, enableTransmission=enableTransmission, radioLicense=radioLicense, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, managementPortStatus=managementPortStatus, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, activeAvailableTime=activeAvailableTime, rFFeederLoss=rFFeederLoss, sMTPServerIPAddress=sMTPServerIPAddress, securityLevel=securityLevel, sNMPPortNumber=sNMPPortNumber, sNMPCommunityString=sNMPCommunityString, productVariant=productVariant, siteName=siteName, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, transmitCapacityLimit=transmitCapacityLimit, sNTPServerTableNumber=sNTPServerTableNumber, ethernetFiberSupport=ethernetFiberSupport, neighborMACAddress=neighborMACAddress, minModulation=minModulation, secondarySoftwareVersion=secondarySoftwareVersion, rFUBranchingConfiguration=rFUBranchingConfiguration, versions=versions, ethernetPriorityTableIndex=ethernetPriorityTableIndex, reset=reset, rFUActiveFirmwareBank=rFUActiveFirmwareBank, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rFUTxFreqMax=rFUTxFreqMax, iPv6PrefixLength=iPv6PrefixLength, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, protection=protection, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, gatewayIPAddress=gatewayIPAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, diverseRfFeederLoss=diverseRfFeederLoss, sMTPServerInternetAddressType=sMTPServerInternetAddressType, rFURxFreqMax=rFURxFreqMax, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFUTxPowerMax=rFUTxPowerMax, licence=licence, neighborInternetAddressType=neighborInternetAddressType, sNTPSync=sNTPSync, linkName=linkName, sNTPPrimaryServer=sNTPPrimaryServer, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, alignmentMode=alignmentMode, sNTPLastSync=sNTPLastSync, sMTPServerInternetAddress=sMTPServerInternetAddress, transmitPower=transmitPower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, altitude=altitude, telnetAccessEnabled=telnetAccessEnabled, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, cambium=cambium, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, diverseAntennaGain=diverseAntennaGain, sMTPEmailAlert=sMTPEmailAlert, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitCapacity=transmitCapacity, wirelessLinkAvailability=wirelessLinkAvailability, dSCPManagementPriority=dSCPManagementPriority, receiveCodeRate=receiveCodeRate, hTTPSPortNumber=hTTPSPortNumber, linkNameMismatch=linkNameMismatch, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, protectionSwitchCause=protectionSwitchCause, unitOutOfCalibration=unitOutOfCalibration, userRole=userRole, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, syslogClientTrap=syslogClientTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rFULockoutAlarm=rFULockoutAlarm, rFUVersionBank2=rFUVersionBank2, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, maximumTransmitPower=maximumTransmitPower, sNTPState=sNTPState, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, primaryRecoveryPeriod=primaryRecoveryPeriod, remotePrimaryMACAddress=remotePrimaryMACAddress, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, ethernetPriorityTable=ethernetPriorityTable, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, softwareVersion=softwareVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteInternetAddress=remoteInternetAddress, radioLicenseBand=radioLicenseBand, sNMPTrapVersion=sNMPTrapVersion, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFUTxMuteStatus=rFUTxMuteStatus, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, protectionConfigurationStatus=protectionConfigurationStatus, iPv6Address=iPv6Address, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, remotePrimarySecondaryMode=remotePrimarySecondaryMode, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, iPv4Address=iPv4Address, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapInternetAddress=sNMPTrapInternetAddress, radioLicenseBandwidth=radioLicenseBandwidth, sNTPServerRetries=sNTPServerRetries, ethernet=ethernet, activeUnit=activeUnit, userPassword=userPassword, dataPortFiberStatus=dataPortFiberStatus, l2CPPriorityTable=l2CPPriorityTable, rFUTxPowerMin=rFUTxPowerMin, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, remoteInternetAddressType=remoteInternetAddressType, maxCodeRate=maxCodeRate, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, primaryRecovery=primaryRecovery, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, alarms=alarms, activeWirelessLinkAvailability=activeWirelessLinkAvailability, maxModulation=maxModulation)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", management=management, requestedProtectionState=requestedProtectionState, transmitDataRate=transmitDataRate, iPVersion=iPVersion, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapPortNumber=sNMPTrapPortNumber, supplementary=supplementary, ptp=ptp, sNTPServerPortNumber=sNTPServerPortNumber, managementPortAutoNegotiation=managementPortAutoNegotiation, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkStatus=wirelessLinkStatus, protectionStateTrap=protectionStateTrap, hTTPPortNumber=hTTPPortNumber, radioLicenseMinModulation=radioLicenseMinModulation, syslogControl=syslogControl, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, sNTPServerTableEntry=sNTPServerTableEntry, minCodeRate=minCodeRate, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, alignmentModeTrap=alignmentModeTrap, userName=userName, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, protectionState=protectionState, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, dataPortDisabledWarning=dataPortDisabledWarning, transmitModulation=transmitModulation, remoteIPAddress=remoteIPAddress, sntp=sntp, protectionStats=protectionStats, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, sNTPServerIPAddress=sNTPServerIPAddress, transmitCodeRate=transmitCodeRate, syslogState=syslogState, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rxDiversityVlanTpid=rxDiversityVlanTpid, sNTPServerTable=sNTPServerTable, userTableEntry=userTableEntry, managementPortStatusTrap=managementPortStatusTrap, rFUCableAlarm=rFUCableAlarm, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, sNMPTrapTableEntry=sNMPTrapTableEntry, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, linkLoss=linkLoss, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, receiveModulation=receiveModulation, enabledDiagnosticAlarms=enabledDiagnosticAlarms, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, encryption=encryption, managementPortForcedConfiguration=managementPortForcedConfiguration, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFURfBand=rFURfBand, rFUFreqSpacing=rFUFreqSpacing, rFUTransceiverLocation=rFUTransceiverLocation, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, numberOfAntennas=numberOfAntennas, userEnabled=userEnabled, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, rFURFSwitchAlarm=rFURFSwitchAlarm, sMTPServerPortNumber=sMTPServerPortNumber, daylightSaving=daylightSaving, radioLicenseIdentifier=radioLicenseIdentifier, managementPortConfigurationMismatch=managementPortConfigurationMismatch, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rFUVersionBank1=rFUVersionBank1, subnetMask=subnetMask, rFUStatusTrap=rFUStatusTrap, encryptionEnabledMismatch=encryptionEnabledMismatch, tFTPServerInternetAddressType=tFTPServerInternetAddressType, iPDSCPPriorityTable=iPDSCPPriorityTable, radioLicenseMinCodeRate=radioLicenseMinCodeRate, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vLANManagementPriority=vLANManagementPriority, hardwareVersion=hardwareVersion, managementCommittedInformationRate=managementCommittedInformationRate, rFUConnectedPlatform=rFUConnectedPlatform, userTable=userTable, userTableNumber=userTableNumber, aTPCEnable=aTPCEnable, sNMPTrapTable=sNMPTrapTable)
