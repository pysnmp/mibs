...
MibIdentifier, NotificationType, Integer32, Counter32, ModuleIdentity, enterprises, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, Unsigned32, NotificationType, Counter64, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Integer32", "Counter32", "ModuleIdentity", "enterprises", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "Unsigned32", "NotificationType", "Counter64", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", iPv6Address=iPv6Address, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, iPv4Address=iPv4Address, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rxDiversityDataPortStatus=rxDiversityDataPortStatus, versions=versions, encryption=encryption, encryptionEnabledMismatch=encryptionEnabledMismatch, receiveDataRate=receiveDataRate, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerPortNumber=sNTPServerPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, remoteSecondaryIPAddress=remoteSecondaryIPAddress, activeUnit=activeUnit, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, pubStats=pubStats, altitude=altitude, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPPrimaryServer=sNTPPrimaryServer, ptp=ptp, activeWirelessLinkAvailability=activeWirelessLinkAvailability, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, neighborInternetAddressType=neighborInternetAddressType, managementPortForcedConfiguration=managementPortForcedConfiguration, remotePrimaryMACAddress=remotePrimaryMACAddress, reset=reset, transmitModulation=transmitModulation, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, alarms=alarms, dataPortPauseFrames=dataPortPauseFrames, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, ptpTrapPrefix=ptpTrapPrefix, linkName=linkName, remoteSecondaryMACAddress=remoteSecondaryMACAddress, managementCommittedInformationRate=managementCommittedInformationRate, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, radioLicenseMaxEIRP=radioLicenseMaxEIRP, sNMPTrapTableEntry=sNMPTrapTableEntry, protection=protection, managementPortDisabledWarning=managementPortDisabledWarning, minModulation=minModulation, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, primaryRecoveryPeriod=primaryRecoveryPeriod, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, vLANManagementVIDValidation=vLANManagementVIDValidation, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, sNTPServerTableNumber=sNTPServerTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, rFUProtectionCompatibility=rFUProtectionCompatibility, linkNameMismatchTrap=linkNameMismatchTrap, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, endId=endId, wirelessLinkAvailability=wirelessLinkAvailability, securityLevel=securityLevel, ptpTraps=ptpTraps, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPTrapPortNumber=sNMPTrapPortNumber, rFUTxFreqMin=rFUTxFreqMin, subnetMask=subnetMask, userRole=userRole, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, dataPortFiberStatusTrap=dataPortFiberStatusTrap, receivePower=receivePower, hTTPSPortNumber=hTTPSPortNumber, sntp=sntp, rFUActiveFirmwareBank=rFUActiveFirmwareBank, sNMPTrapTableIndex=sNMPTrapTableIndex, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, userTableEntry=userTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, aAAControl=aAAControl, hTTPPortNumber=hTTPPortNumber, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, neighborInternetAddress=neighborInternetAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dataPortConfigurationMismatch=dataPortConfigurationMismatch, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, diverseRfFeederLoss=diverseRfFeederLoss, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, transmitCodeRate=transmitCodeRate, localPacketFiltering=localPacketFiltering, ethernet=ethernet, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, protectionConfig=protectionConfig, phyControl=phyControl, phyStatus=phyStatus, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rFUTxMuteStatus=rFUTxMuteStatus, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, remotePrimaryInternetAddress=remotePrimaryInternetAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, remoteMACAddress=remoteMACAddress, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, managementPortStatusTrap=managementPortStatusTrap, rFUFreqSpacing=rFUFreqSpacing, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, protectionConfigurationStatus=protectionConfigurationStatus, remoteIPAddress=remoteIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, productVariant=productVariant, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, managementMode=managementMode, receiveModulation=receiveModulation, vectorError=vectorError, transmitCapacityLimit=transmitCapacityLimit, sNTPServerResponse=sNTPServerResponse, radioLicenseBand=radioLicenseBand, cambium=cambium, l2CPPriorityTable=l2CPPriorityTable, radioLicenseBandwidth=radioLicenseBandwidth, linkNameMismatch=linkNameMismatch, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, smtp=smtp, iPv6GatewayAddress=iPv6GatewayAddress, daylightSaving=daylightSaving, enableTransmission=enableTransmission, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, remotePrimaryIPAddress=remotePrimaryIPAddress, fiberY=fiberY, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dSCPManagementPriority=dSCPManagementPriority, encryptionAlgorithm=encryptionAlgorithm, protectionStats=protectionStats, radioLicenseModulation=radioLicenseModulation, managementPortConfigurationMismatch=managementPortConfigurationMismatch, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, supplementary=supplementary, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rFUTxFreqMax=rFUTxFreqMax, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, radioLicenseMinModulation=radioLicenseMinModulation, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, dataPortDisabledWarning=dataPortDisabledWarning, alignmentModeTrap=alignmentModeTrap, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, gatewayIPAddress=gatewayIPAddress, aTPCEnable=aTPCEnable, ethernetPriorityTable=ethernetPriorityTable, sNTPLastSync=sNTPLastSync, radioLicenseIdentifier=radioLicenseIdentifier, productName=productName, rFULockoutAlarm=rFULockoutAlarm, syslogControl=syslogControl, radioLicenseCodeRate=radioLicenseCodeRate, remoteInternetAddressType=remoteInternetAddressType, rxDiversityVid=rxDiversityVid, rFURxFreqMax=rFURxFreqMax, sMTPServerIPAddress=sMTPServerIPAddress, timeZone=timeZone, l2CPPriorityTableIndex=l2CPPriorityTableIndex, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPSync=sNTPSync, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, ptp800=ptp800, vLANManagementVID=vLANManagementVID, tFTPServerIPAddress=tFTPServerIPAddress, maxCodeRate=maxCodeRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFUTxPowerAlarm=rFUTxPowerAlarm, rFUPowerButtonPressed=rFUPowerButtonPressed, sMTPEmailAlert=sMTPEmailAlert, sNMPCommunityString=sNMPCommunityString, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPPollInterval=sNTPPollInterval, rFFeederLoss=rFFeederLoss, rFUStatus=rFUStatus, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNMPTrapTable=sNMPTrapTable, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, radioLicenseRegion=radioLicenseRegion, secureModeAlarm=secureModeAlarm, sNMPTrapVersion=sNMPTrapVersion, rFUTxPowerMin=rFUTxPowerMin, userEnabled=userEnabled, userTable=userTable, protectionInterfaceStatus=protectionInterfaceStatus, minCodeRate=minCodeRate, requestedProtectionState=requestedProtectionState, radioLicenseMaxModulation=radioLicenseMaxModulation, activeAvailableTime=activeAvailableTime, bridge=bridge, l2CPPriorityTableNumber=l2CPPriorityTableNumber, managementPortStatus=managementPortStatus, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, radioLicenseRxFreq=radioLicenseRxFreq, sNTPServerInternetAddress=sNTPServerInternetAddress, rxDiversityVlanTpid=rxDiversityVlanTpid, sNTPServerTable=sNTPServerTable, qOSPriorityScheme=qOSPriorityScheme, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, neighborIPAddress=neighborIPAddress, rFUCableAlarm=rFUCableAlarm, rFUType=rFUType, softwareVersion=softwareVersion, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, protectionStateTrap=protectionStateTrap, rFUVersionBank2=rFUVersionBank2, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, iPVersion=iPVersion, sNTPServerTableEntry=sNTPServerTableEntry, managementPortAutoNegotiation=managementPortAutoNegotiation, syslogState=syslogState, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telnetPortNumber=telnetPortNumber, configuration=configuration, transmitCapacityLimitDetail=transmitCapacityLimitDetail, sNMPPortNumber=sNMPPortNumber, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, iPv6PrefixLength=iPv6PrefixLength, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, sNTPState=sNTPState, ethernetPriorityTableNumber=ethernetPriorityTableNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFUVersionBank1=rFUVersionBank1, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rFUPlatformCompatibility=rFUPlatformCompatibility, rFURFSwitchAlarm=rFURFSwitchAlarm, radioLicenseMinCodeRate=radioLicenseMinCodeRate, primarySecondaryMode=primarySecondaryMode, secureModeAlarmTrap=secureModeAlarmTrap, sNTPServerTimeout=sNTPServerTimeout, latitude=latitude, rFUTxBandAboveRx=rFUTxBandAboveRx, ethernetFiberSupport=ethernetFiberSupport, mPLSTCPriorityTable=mPLSTCPriorityTable, tFTPServerInternetAddress=tFTPServerInternetAddress, unitOutOfCalibration=unitOutOfCalibration, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, ptmp=ptmp, bootVersion=bootVersion, receiveCodeRate=receiveCodeRate)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", neighborMACAddress=neighborMACAddress, vLANManagementPriority=vLANManagementPriority, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sMTPEnabledMessages=sMTPEnabledMessages, rFURpsAlarm=rFURpsAlarm, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, primaryRecovery=primaryRecovery, longitude=longitude, faultProtectionSwitching=faultProtectionSwitching, userName=userName, transmitCapacity=transmitCapacity, rFUTxPowerMax=rFUTxPowerMax, remoteInternetAddress=remoteInternetAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, snmpControl=snmpControl, maxModulation=maxModulation, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFUTransceiverLocation=rFUTransceiverLocation, syslogClientTrap=syslogClientTrap, userTableNumber=userTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, hardwareVersion=hardwareVersion, protectionAvailabilityStatus=protectionAvailabilityStatus, userTableIndex=userTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, rfu=rfu, rFURfBand=rFURfBand, sNTPServerRetries=sNTPServerRetries, rFUConnectedPlatform=rFUConnectedPlatform, siteName=siteName, sNTPServerTableIndex=sNTPServerTableIndex, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, radioLicenseTxFreq=radioLicenseTxFreq, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, aggregateDataRate=aggregateDataRate, rFUStatusTrap=rFUStatusTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licence=licence, protectionStatus=protectionStatus, rFUSerial=rFUSerial, sNTPServerInternetAddressType=sNTPServerInternetAddressType, protectionSwitchCause=protectionSwitchCause, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, telnetAccessEnabled=telnetAccessEnabled, syslogClient=syslogClient, dataPortStatus=dataPortStatus, systemClock=systemClock, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, antennaGain=antennaGain, syslogStateTrap=syslogStateTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, userPassword=userPassword, ethernetPriorityTableEntry=ethernetPriorityTableEntry, transmitDataRate=transmitDataRate, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rFURxFreqMin=rFURxFreqMin, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPServerIPAddress=sNTPServerIPAddress, numberOfAntennas=numberOfAntennas, ethernetPriorityTableIndex=ethernetPriorityTableIndex, alignmentMode=alignmentMode, management=management, tFTPServerInternetAddressType=tFTPServerInternetAddressType, radioLicense=radioLicense, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, wirelessLinkStatus=wirelessLinkStatus, protectionState=protectionState, linkLoss=linkLoss, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, wirelessLinkStatusTrap=wirelessLinkStatusTrap, maximumTransmitPower=maximumTransmitPower, sNTPSyncTrap=sNTPSyncTrap, rFUPowerAlarm=rFUPowerAlarm, systemReset=systemReset, transmitPower=transmitPower, rFUBranchingConfiguration=rFUBranchingConfiguration, dataPortFiberStatus=dataPortFiberStatus, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, diverseAntennaGain=diverseAntennaGain, sMTPServerPortNumber=sMTPServerPortNumber, transmitterStatus=transmitterStatus, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, iFCableLength=iFCableLength)
