...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, securityLevel=securityLevel, l2CPPriorityTableEntry=l2CPPriorityTableEntry, primarySecondaryMode=primarySecondaryMode, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, radioLicenseBand=radioLicenseBand, linkNameMismatch=linkNameMismatch, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, dataPortFiberStatus=dataPortFiberStatus, sNMPEnabledTraps=sNMPEnabledTraps, rFURpsAlarm=rFURpsAlarm, phyStatus=phyStatus, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, managementPortDisabledWarning=managementPortDisabledWarning, secondarySoftwareVersion=secondarySoftwareVersion, rFURfBand=rFURfBand, rFURxFreqMax=rFURxFreqMax, rFUSerial=rFUSerial, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptp800=ptp800, rfu=rfu, remotePrimaryIPAddress=remotePrimaryIPAddress, alignmentModeTrap=alignmentModeTrap, remoteInternetAddress=remoteInternetAddress, activeUnit=activeUnit, numberOfAntennas=numberOfAntennas, telnetAccessEnabled=telnetAccessEnabled, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, radioLicenseRegion=radioLicenseRegion, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, licence=licence, rFFeederLoss=rFFeederLoss, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPSyncTrap=sNTPSyncTrap, rFUTxBandAboveRx=rFUTxBandAboveRx, rFUVersionBank2=rFUVersionBank2, protectionStats=protectionStats, receiveModulation=receiveModulation, radioLicenseRxFreq=radioLicenseRxFreq, telnetPortNumber=telnetPortNumber, radioLicenseTxFreq=radioLicenseTxFreq, userTableNumber=userTableNumber, bootVersion=bootVersion, pubStats=pubStats, sMTPServerPortNumber=sMTPServerPortNumber, activeWirelessLinkAvailability=activeWirelessLinkAvailability, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, maxModulation=maxModulation, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rFURxFreqMin=rFURxFreqMin, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, dSCPManagementPriority=dSCPManagementPriority, dataPortStatus=dataPortStatus, faultProtectionSwitching=faultProtectionSwitching, encryptionEnabledMismatch=encryptionEnabledMismatch, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hTTPAccessEnabled=hTTPAccessEnabled, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, neighborIPAddress=neighborIPAddress, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, management=management, userTableIndex=userTableIndex, dataPortPauseFrames=dataPortPauseFrames, sNMPTrapVersion=sNMPTrapVersion, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, bridge=bridge, aTPCEnable=aTPCEnable, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, rFUConnectedPlatform=rFUConnectedPlatform, protection=protection, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, daylightSaving=daylightSaving, vLANManagementPriority=vLANManagementPriority, hTTPSAccessEnabled=hTTPSAccessEnabled, linkName=linkName, tFTPServerInternetAddressType=tFTPServerInternetAddressType, receiveCodeRate=receiveCodeRate, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, remoteInternetAddressType=remoteInternetAddressType, transmitModulation=transmitModulation, rFUFreqSpacing=rFUFreqSpacing, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, encryptionAlgorithm=encryptionAlgorithm, radioLicenseMaxEIRP=radioLicenseMaxEIRP, altitude=altitude, productName=productName, protectionStatus=protectionStatus, sMTPEnabledMessages=sMTPEnabledMessages, iPDSCPPriorityTable=iPDSCPPriorityTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, remotePrimaryInternetAddress=remotePrimaryInternetAddress, localPacketFiltering=localPacketFiltering, secureModeAlarm=secureModeAlarm, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, userName=userName, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNTPPollInterval=sNTPPollInterval, userRole=userRole, ethernetPriorityTableEntry=ethernetPriorityTableEntry, minModulation=minModulation, sNMPTrapTableIndex=sNMPTrapTableIndex, softwareVersion=softwareVersion, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tFTPServerPortNumber=tFTPServerPortNumber, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, sNTPServerRetries=sNTPServerRetries, neighborMACAddress=neighborMACAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, maximumTransmitPower=maximumTransmitPower, minCodeRate=minCodeRate, rFUTxMuteStatus=rFUTxMuteStatus, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rFUPowerButtonPressed=rFUPowerButtonPressed, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, transmitCodeRate=transmitCodeRate, sMTPServerInternetAddress=sMTPServerInternetAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, maxCodeRate=maxCodeRate, remotePrimaryMACAddress=remotePrimaryMACAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFUTxPowerMax=rFUTxPowerMax, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, radioLicenseIdentifier=radioLicenseIdentifier, rxDiversityVid=rxDiversityVid, radioLicenseMinCodeRate=radioLicenseMinCodeRate, dataPortDisabledWarning=dataPortDisabledWarning, primaryRecovery=primaryRecovery, reset=reset, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFUStatusTrap=rFUStatusTrap, userTable=userTable, sNTPServerTable=sNTPServerTable, iFCableLength=iFCableLength, sNMPTrapTable=sNMPTrapTable, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, iPv4Address=iPv4Address, systemClock=systemClock, remoteSecondaryIPAddress=remoteSecondaryIPAddress, radioLicenseModulation=radioLicenseModulation, userEnabled=userEnabled, userPassword=userPassword, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ethernetPriorityTable=ethernetPriorityTable, remotePrimarySecondaryMode=remotePrimarySecondaryMode, gatewayIPAddress=gatewayIPAddress, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, sNTPServerResponse=sNTPServerResponse, radioLicenseCodeRate=radioLicenseCodeRate, syslogClient=syslogClient, ethernet=ethernet, dataPortStatusTrap=dataPortStatusTrap, protectionStateTrap=protectionStateTrap, transmitterStatus=transmitterStatus, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapTableEntry=sNMPTrapTableEntry, protectionAvailabilityStatus=protectionAvailabilityStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, iPv6Address=iPv6Address, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rFUVersionBank1=rFUVersionBank1, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, aggregateDataRate=aggregateDataRate, neighborInternetAddress=neighborInternetAddress, wirelessLinkAvailability=wirelessLinkAvailability, enableTransmission=enableTransmission, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFULockoutAlarm=rFULockoutAlarm, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, neighborInternetAddressType=neighborInternetAddressType, mPLSTCPriorityTable=mPLSTCPriorityTable, encryption=encryption, managementPortForcedConfiguration=managementPortForcedConfiguration, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, productVariant=productVariant, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, protectionInterfaceStatus=protectionInterfaceStatus, transmitCapacity=transmitCapacity, ptpTrapPrefix=ptpTrapPrefix, supplementary=supplementary, rFUStatus=rFUStatus, receiveDataRate=receiveDataRate, sMTPServerIPAddress=sMTPServerIPAddress, linkNameMismatchTrap=linkNameMismatchTrap, protectionSwitchCause=protectionSwitchCause, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, requestedProtectionState=requestedProtectionState, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber, hTTPSPortNumber=hTTPSPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, diverseRfFeederLoss=diverseRfFeederLoss, protectionConfigurationStatus=protectionConfigurationStatus, sNTPServerTableEntry=sNTPServerTableEntry, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, sMTPServerInternetAddressType=sMTPServerInternetAddressType, radioLicenseMaxModulation=radioLicenseMaxModulation, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userTableEntry=userTableEntry, cambium=cambium, sNTPLastSync=sNTPLastSync, rxDiversityDataPortStatus=rxDiversityDataPortStatus, smtp=smtp, rFUTransceiverLocation=rFUTransceiverLocation, secureModeAlarmTrap=secureModeAlarmTrap, radioLicenseBandwidth=radioLicenseBandwidth, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPPrimaryServer=sNTPPrimaryServer, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, versions=versions, rFUTxPowerAlarm=rFUTxPowerAlarm, sNTPServerTimeout=sNTPServerTimeout, protectionConfig=protectionConfig, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rFUBranchingConfiguration=rFUBranchingConfiguration, receivePower=receivePower, siteName=siteName, rxDiversityVlanTpid=rxDiversityVlanTpid, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, protectionState=protectionState, rFUCableAlarm=rFUCableAlarm, radioLicenseMinModulation=radioLicenseMinModulation, rFUProtectionCompatibility=rFUProtectionCompatibility, rFURFSwitchAlarm=rFURFSwitchAlarm, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, longitude=longitude, alignmentMode=alignmentMode, unitOutOfCalibration=unitOutOfCalibration, hardwareVersion=hardwareVersion, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, systemReset=systemReset)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUTxFreqMin=rFUTxFreqMin, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogClientTrap=syslogClientTrap, sMTPEmailAlert=sMTPEmailAlert, primaryRecoveryPeriod=primaryRecoveryPeriod, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, iPv6PrefixLength=iPv6PrefixLength, sntp=sntp, wirelessLinkStatusTrap=wirelessLinkStatusTrap, antennaGain=antennaGain, qOSPriorityScheme=qOSPriorityScheme, vectorError=vectorError, sNTPServerIPAddress=sNTPServerIPAddress, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, managementCommittedInformationRate=managementCommittedInformationRate, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, configuration=configuration, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, l2CPPriorityTable=l2CPPriorityTable, timeZone=timeZone, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitCapacityLimitDetail=transmitCapacityLimitDetail, sNTPServerTableNumber=sNTPServerTableNumber, fiberY=fiberY, sNTPServerTableIndex=sNTPServerTableIndex, managementMode=managementMode, syslogControl=syslogControl, wirelessLinkStatus=wirelessLinkStatus, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, subnetMask=subnetMask, sNTPServerInternetAddress=sNTPServerInternetAddress, iPVersion=iPVersion, phyControl=phyControl, sNTPSync=sNTPSync, diverseAntennaGain=diverseAntennaGain, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, rFUPowerAlarm=rFUPowerAlarm, managementPortStatusTrap=managementPortStatusTrap, managementPortAutoNegotiation=managementPortAutoNegotiation, activeAvailableTime=activeAvailableTime, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, transmitCapacityLimit=transmitCapacityLimit, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ptp=ptp, syslogStateTrap=syslogStateTrap, vLANManagementVIDValidation=vLANManagementVIDValidation, managementPortStatus=managementPortStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, hTTPPortNumber=hTTPPortNumber, endId=endId, remoteMACAddress=remoteMACAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ptpTraps=ptpTraps, ptmp=ptmp, rFUType=rFUType, rFUTxFreqMax=rFUTxFreqMax, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rFUPlatformCompatibility=rFUPlatformCompatibility, sNTPServerPortNumber=sNTPServerPortNumber, alarms=alarms, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, sNTPState=sNTPState, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, snmpControl=snmpControl, syslogState=syslogState, remoteMaximumTransmitPower=remoteMaximumTransmitPower, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ethernetFiberSupport=ethernetFiberSupport, latitude=latitude, transmitDataRate=transmitDataRate, vLANManagementVID=vLANManagementVID, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNMPCommunityString=sNMPCommunityString, iPv6GatewayAddress=iPv6GatewayAddress, remoteIPAddress=remoteIPAddress, sNMPPortNumber=sNMPPortNumber, radioLicense=radioLicense, linkLoss=linkLoss, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitPower=transmitPower, aAAControl=aAAControl, rFUTxPowerMin=rFUTxPowerMin, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus)
