...
Counter32, Counter64, TimeTicks, ObjectIdentity, IpAddress, ModuleIdentity, NotificationType, Unsigned32, MibIdentifier, NotificationType, Gauge32, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "TimeTicks", "ObjectIdentity", "IpAddress", "ModuleIdentity", "NotificationType", "Unsigned32", "MibIdentifier", "NotificationType", "Gauge32", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sMTPServerInternetAddress=sMTPServerInternetAddress, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, aTPCEnable=aTPCEnable, hTTPSAccessEnabled=hTTPSAccessEnabled, userTableIndex=userTableIndex, sMTPEmailAlert=sMTPEmailAlert, sNTPPrimaryServer=sNTPPrimaryServer, receiveCodeRate=receiveCodeRate, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, sNMPTrapTableEntry=sNMPTrapTableEntry, latitude=latitude, receiveDataRate=receiveDataRate, rxDiversityDataPortStatus=rxDiversityDataPortStatus, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFUTxBandAboveRx=rFUTxBandAboveRx, iFCableLength=iFCableLength, sMTPServerIPAddress=sMTPServerIPAddress, ptpTrapPrefix=ptpTrapPrefix, sNTPServerIPAddress=sNTPServerIPAddress, ethernetFiberSupport=ethernetFiberSupport, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, receivePower=receivePower, sNMPTrapTableIndex=sNMPTrapTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, sNTPServerTable=sNTPServerTable, activeUnit=activeUnit, rFURFSwitchAlarm=rFURFSwitchAlarm, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, transmitCapacityLimitDetail=transmitCapacityLimitDetail, syslogControl=syslogControl, ethernetPriorityTableNumber=ethernetPriorityTableNumber, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, sNTPServerPortNumber=sNTPServerPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, faultProtectionSwitching=faultProtectionSwitching, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, managementCommittedInformationRate=managementCommittedInformationRate, productVariant=productVariant, neighborIPAddress=neighborIPAddress, bootVersion=bootVersion, primaryRecovery=primaryRecovery, dataPortDisabledWarning=dataPortDisabledWarning, dataPortFiberStatus=dataPortFiberStatus, sMTPEnabledMessages=sMTPEnabledMessages, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFUVersionBank1=rFUVersionBank1, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFUTxFreqMin=rFUTxFreqMin, rFUSerial=rFUSerial, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rFURfBand=rFURfBand, rFURxFreqMax=rFURxFreqMax, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, transmitCodeRate=transmitCodeRate, transmitPower=transmitPower, tFTPServerInternetAddress=tFTPServerInternetAddress, userTableNumber=userTableNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rFULockoutAlarm=rFULockoutAlarm, hTTPPortNumber=hTTPPortNumber, telnetPortNumber=telnetPortNumber, telnetAccessEnabled=telnetAccessEnabled, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitModulation=transmitModulation, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, antennaGain=antennaGain, linkLoss=linkLoss, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, secondarySoftwareVersion=secondarySoftwareVersion, rFUTxPowerMin=rFUTxPowerMin, minCodeRate=minCodeRate, rFUTxPowerMax=rFUTxPowerMax, maximumTransmitPower=maximumTransmitPower, secureModeAlarm=secureModeAlarm, softwareVersion=softwareVersion, sNTPState=sNTPState, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANManagementVIDValidation=vLANManagementVIDValidation, rFUProtectionCompatibility=rFUProtectionCompatibility, userEnabled=userEnabled, activeAvailableTime=activeAvailableTime, rFUTxFreqMax=rFUTxFreqMax, rfu=rfu, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mPLSTCPriorityTable=mPLSTCPriorityTable, subnetMask=subnetMask, rFURpsAlarm=rFURpsAlarm, rFUTransceiverLocation=rFUTransceiverLocation, sNTPServerTableNumber=sNTPServerTableNumber, siteName=siteName, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, iPDSCPPriorityTable=iPDSCPPriorityTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rxDiversityVid=rxDiversityVid, sNTPPollInterval=sNTPPollInterval, sNMPTrapIPAddress=sNMPTrapIPAddress, neighborInternetAddress=neighborInternetAddress, radioLicenseBandwidth=radioLicenseBandwidth, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, protectionStateTrap=protectionStateTrap, managementPortStatus=managementPortStatus, managementPortForcedConfiguration=managementPortForcedConfiguration, sntp=sntp, remoteSecondaryIPAddress=remoteSecondaryIPAddress, vectorError=vectorError, l2CPPriorityTable=l2CPPriorityTable, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, daylightSaving=daylightSaving, neighborInternetAddressType=neighborInternetAddressType, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, remoteMACAddress=remoteMACAddress, protection=protection, sNMPTrapVersion=sNMPTrapVersion, rFUBranchingConfiguration=rFUBranchingConfiguration, protectionStats=protectionStats, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, radioLicenseRegion=radioLicenseRegion, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, encryption=encryption, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, ethernetPriorityTableEntry=ethernetPriorityTableEntry, endId=endId, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, phyControl=phyControl, altitude=altitude, receiveModulation=receiveModulation, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, syslogStateTrap=syslogStateTrap, remoteInternetAddress=remoteInternetAddress, productName=productName, minModulation=minModulation, encryptionEnabledMismatch=encryptionEnabledMismatch, sNMPEnabledTraps=sNMPEnabledTraps, ptp800=ptp800, ptp=ptp, requestedProtectionState=requestedProtectionState, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernet=ethernet, diverseRfFeederLoss=diverseRfFeederLoss, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, hTTPAccessEnabled=hTTPAccessEnabled, dataPortStatusTrap=dataPortStatusTrap, managementPortStatusTrap=managementPortStatusTrap, rFUPowerAlarm=rFUPowerAlarm, sNTPServerInternetAddressType=sNTPServerInternetAddressType, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rFUType=rFUType, maxModulation=maxModulation, remotePrimaryMACAddress=remotePrimaryMACAddress, sNTPSyncTrap=sNTPSyncTrap, management=management, iPv6Address=iPv6Address, tFTPServerIPAddress=tFTPServerIPAddress, protectionSwitchCause=protectionSwitchCause, sNTPSync=sNTPSync, primaryRecoveryPeriod=primaryRecoveryPeriod, alignmentModeTrap=alignmentModeTrap, transmitCapacityLimit=transmitCapacityLimit, pubStats=pubStats, userTable=userTable, radioLicenseMinModulation=radioLicenseMinModulation, iPv6PrefixLength=iPv6PrefixLength, configuration=configuration, linkName=linkName, managementMode=managementMode, wirelessLinkStatus=wirelessLinkStatus, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, dataPortConfigurationMismatch=dataPortConfigurationMismatch, radioLicenseIdentifier=radioLicenseIdentifier, licence=licence, versions=versions, systemClock=systemClock, radioLicenseBand=radioLicenseBand, transmitCapacity=transmitCapacity, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, hardwareVersion=hardwareVersion, ethernetPriorityTable=ethernetPriorityTable, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, managementPortConfigurationMismatch=managementPortConfigurationMismatch, protectionAvailabilityStatus=protectionAvailabilityStatus, syslogClientTrap=syslogClientTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortStatus=dataPortStatus, remotePrimaryIPAddress=remotePrimaryIPAddress, remoteIPAddress=remoteIPAddress, rFUStatusTrap=rFUStatusTrap, sNTPLastSync=sNTPLastSync, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, timeZone=timeZone, transmitDataRate=transmitDataRate, syslogState=syslogState, ptpTraps=ptpTraps, supplementary=supplementary, dSCPManagementPriority=dSCPManagementPriority, alignmentMode=alignmentMode, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, protectionStatus=protectionStatus, transmitterStatus=transmitterStatus, rFUPowerButtonPressed=rFUPowerButtonPressed, iPv4Address=iPv4Address, rxDiversityVlanTpid=rxDiversityVlanTpid, rFUTxPowerAlarm=rFUTxPowerAlarm, remoteInternetAddressType=remoteInternetAddressType, managementPortAutoNegotiation=managementPortAutoNegotiation, diverseAntennaGain=diverseAntennaGain, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFUStatus=rFUStatus, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, longitude=longitude, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, protectionConfigurationStatus=protectionConfigurationStatus, radioLicenseMinCodeRate=radioLicenseMinCodeRate, sNTPServerResponse=sNTPServerResponse, managementPortWirelessDownAlert=managementPortWirelessDownAlert, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFUVersionBank2=rFUVersionBank2, radioLicenseTxFreq=radioLicenseTxFreq, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, aAAControl=aAAControl, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, fiberY=fiberY, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, linkNameMismatch=linkNameMismatch, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, hTTPSPortNumber=hTTPSPortNumber, userTableEntry=userTableEntry, rFURxFreqMin=rFURxFreqMin)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", reset=reset, iPVersion=iPVersion, tFTPServerPortNumber=tFTPServerPortNumber, encryptionAlgorithm=encryptionAlgorithm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userName=userName, localPacketFiltering=localPacketFiltering, sNTPServerTimeout=sNTPServerTimeout, sNTPServerRetries=sNTPServerRetries, protectionConfig=protectionConfig, gatewayIPAddress=gatewayIPAddress, rFUPlatformCompatibility=rFUPlatformCompatibility, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, iPv6GatewayAddress=iPv6GatewayAddress, sNMPTrapTable=sNMPTrapTable, sNTPServerTableEntry=sNTPServerTableEntry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, aggregateDataRate=aggregateDataRate, radioLicenseMaxModulation=radioLicenseMaxModulation, unitOutOfCalibration=unitOutOfCalibration, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, neighborMACAddress=neighborMACAddress, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, radioLicenseRxFreq=radioLicenseRxFreq, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFUFreqSpacing=rFUFreqSpacing, userPassword=userPassword, rFUConnectedPlatform=rFUConnectedPlatform, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPPortNumber=sNMPPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, protectionInterfaceStatus=protectionInterfaceStatus, enableTransmission=enableTransmission, managementPortDisabledWarning=managementPortDisabledWarning, rFUCableAlarm=rFUCableAlarm, vLANManagementPriority=vLANManagementPriority, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, radioLicenseModulation=radioLicenseModulation, numberOfAntennas=numberOfAntennas, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, securityLevel=securityLevel, smtp=smtp, maxCodeRate=maxCodeRate, rFUActiveFirmwareBank=rFUActiveFirmwareBank, radioLicense=radioLicense, radioLicenseCodeRate=radioLicenseCodeRate, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkNameMismatchTrap=linkNameMismatchTrap, remotePrimarySecondaryMode=remotePrimarySecondaryMode, vLANManagementVID=vLANManagementVID, sMTPServerPortNumber=sMTPServerPortNumber, userRole=userRole, protectionState=protectionState, qOSPriorityScheme=qOSPriorityScheme, sNTPServerInternetAddress=sNTPServerInternetAddress, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sNMPCommunityString=sNMPCommunityString, wirelessLinkAvailability=wirelessLinkAvailability, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, rFFeederLoss=rFFeederLoss, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, ptmp=ptmp, rFUTxMuteStatus=rFUTxMuteStatus, radioLicenseMaxEIRP=radioLicenseMaxEIRP, systemReset=systemReset, dataPortPauseFrames=dataPortPauseFrames, activeWirelessLinkAvailability=activeWirelessLinkAvailability, l2CPPriorityTableEntry=l2CPPriorityTableEntry, remotePrimaryInternetAddress=remotePrimaryInternetAddress, alarms=alarms, sNTPServerTableIndex=sNTPServerTableIndex, snmpControl=snmpControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, cambium=cambium, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, bridge=bridge, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, syslogClient=syslogClient, phyStatus=phyStatus, primarySecondaryMode=primarySecondaryMode)
