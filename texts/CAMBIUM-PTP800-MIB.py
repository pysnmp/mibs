...
ModuleIdentity, ObjectIdentity, Integer32, NotificationType, MibIdentifier, Counter64, Gauge32, Counter32, NotificationType, enterprises, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "Integer32", "NotificationType", "MibIdentifier", "Counter64", "Gauge32", "Counter32", "NotificationType", "enterprises", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", alignmentModeTrap=alignmentModeTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, activeAvailableTime=activeAvailableTime, sNTPLastSync=sNTPLastSync, sNTPPollInterval=sNTPPollInterval, syslogState=syslogState, remoteSecondaryIPAddress=remoteSecondaryIPAddress, linkNameMismatchTrap=linkNameMismatchTrap, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, rFUTxPowerMax=rFUTxPowerMax, userTableIndex=userTableIndex, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, sNMPTrapTable=sNMPTrapTable, sNTPServerTableEntry=sNTPServerTableEntry, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, supplementary=supplementary, hTTPSPortNumber=hTTPSPortNumber, remoteIPAddress=remoteIPAddress, ethernetFiberSupport=ethernetFiberSupport, radioLicenseBandwidth=radioLicenseBandwidth, userRole=userRole, licence=licence, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPVersion=iPVersion, phyStatus=phyStatus, managementPortStatus=managementPortStatus, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rFURfBand=rFURfBand, rFUTxMuteStatus=rFUTxMuteStatus, rxDiversityDataPortStatus=rxDiversityDataPortStatus, dataPortStatusTrap=dataPortStatusTrap, reset=reset, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, sNTPServerPortNumber=sNTPServerPortNumber, dataPortStatus=dataPortStatus, transmitCapacityLimit=transmitCapacityLimit, iPv4Address=iPv4Address, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, radioLicenseMaxModulation=radioLicenseMaxModulation, iPv6PrefixLength=iPv6PrefixLength, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, syslogClientTrap=syslogClientTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, tFTPServerIPAddress=tFTPServerIPAddress, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transmitCapacityLimitDetail=transmitCapacityLimitDetail, remoteSecondaryMACAddress=remoteSecondaryMACAddress, smtp=smtp, rFUTxPowerAlarm=rFUTxPowerAlarm, faultProtectionSwitching=faultProtectionSwitching, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, dataPortDisabledWarning=dataPortDisabledWarning, l2CPPriorityTableNumber=l2CPPriorityTableNumber, userTable=userTable, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rFUVersionBank2=rFUVersionBank2, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, iFCableLength=iFCableLength, bridge=bridge, sNTPServerTimeout=sNTPServerTimeout, userEnabled=userEnabled, maxModulation=maxModulation, vectorError=vectorError, sNMPEnabledTraps=sNMPEnabledTraps, rFURpsAlarm=rFURpsAlarm, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, protectionConfig=protectionConfig, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sntp=sntp, rfu=rfu, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPState=sNTPState, alarms=alarms, bootVersion=bootVersion, managementMode=managementMode, maximumTransmitPower=maximumTransmitPower, encryptionAlgorithm=encryptionAlgorithm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, encryption=encryption, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFUPowerAlarm=rFUPowerAlarm, rFUTransceiverLocation=rFUTransceiverLocation, radioLicense=radioLicense, dSCPManagementPriority=dSCPManagementPriority, neighborInternetAddressType=neighborInternetAddressType, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNTPServerIPAddress=sNTPServerIPAddress, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, localPacketFiltering=localPacketFiltering, phyControl=phyControl, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, iPv6GatewayAddress=iPv6GatewayAddress, sMTPEnabledMessages=sMTPEnabledMessages, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rFUVersionBank1=rFUVersionBank1, hTTPPortNumber=hTTPPortNumber, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, radioLicenseMinModulation=radioLicenseMinModulation, securityLevel=securityLevel, rFUTxFreqMin=rFUTxFreqMin, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, hardwareVersion=hardwareVersion, rFUStatusTrap=rFUStatusTrap, configuration=configuration, dataPortFiberStatus=dataPortFiberStatus, remotePrimarySecondaryMode=remotePrimarySecondaryMode, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, protectionConfigurationStatus=protectionConfigurationStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, remotePrimaryMACAddress=remotePrimaryMACAddress, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPv6Address=iPv6Address, managementPortForcedConfiguration=managementPortForcedConfiguration, sMTPServerPortNumber=sMTPServerPortNumber, primaryRecovery=primaryRecovery, timeZone=timeZone, protectionStateTrap=protectionStateTrap, transmitCapacity=transmitCapacity, protectionState=protectionState, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFFeederLoss=rFFeederLoss, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rFUActiveFirmwareBank=rFUActiveFirmwareBank, receiveDataRate=receiveDataRate, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, systemClock=systemClock, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, activeWirelessLinkAvailability=activeWirelessLinkAvailability, unitOutOfCalibration=unitOutOfCalibration, rFUTxBandAboveRx=rFUTxBandAboveRx, neighborIPAddress=neighborIPAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, userName=userName, l2CPPriorityTable=l2CPPriorityTable, secureModeAlarmTrap=secureModeAlarmTrap, rFUConnectedPlatform=rFUConnectedPlatform, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, radioLicenseMinCodeRate=radioLicenseMinCodeRate, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ethernetPriorityTableNumber=ethernetPriorityTableNumber, gatewayIPAddress=gatewayIPAddress, rFUPlatformCompatibility=rFUPlatformCompatibility, ptp800=ptp800, ptpTrapPrefix=ptpTrapPrefix, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, ptp=ptp, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, userPassword=userPassword, rFULockoutAlarm=rFULockoutAlarm, pubStats=pubStats, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, enableTransmission=enableTransmission, maxCodeRate=maxCodeRate, transmitDataRate=transmitDataRate, rFUSerial=rFUSerial, rFUPowerButtonPressed=rFUPowerButtonPressed, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, requestedProtectionState=requestedProtectionState, managementPortDisabledWarning=managementPortDisabledWarning, sMTPServerIPAddress=sMTPServerIPAddress, sNTPPrimaryServer=sNTPPrimaryServer, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rFUCableAlarm=rFUCableAlarm, minCodeRate=minCodeRate, antennaGain=antennaGain, radioLicenseBand=radioLicenseBand, rxDiversityVlanTpid=rxDiversityVlanTpid, rFUTxFreqMax=rFUTxFreqMax, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, minModulation=minModulation, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, fiberY=fiberY, aTPCEnable=aTPCEnable, managementPortStatusTrap=managementPortStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, snmpControl=snmpControl, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, mPLSTCPriorityTable=mPLSTCPriorityTable, secureModeAlarm=secureModeAlarm, rFUFreqSpacing=rFUFreqSpacing, managementPortWirelessDownAlert=managementPortWirelessDownAlert, userTableNumber=userTableNumber, diverseAntennaGain=diverseAntennaGain, sNMPTrapIPAddress=sNMPTrapIPAddress, rFUBranchingConfiguration=rFUBranchingConfiguration, versions=versions, vLANManagementPriority=vLANManagementPriority, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, wirelessLinkStatus=wirelessLinkStatus, managementPortAutoNegotiation=managementPortAutoNegotiation, sMTPEmailAlert=sMTPEmailAlert, transmitterStatus=transmitterStatus, neighborMACAddress=neighborMACAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, systemReset=systemReset, syslogControl=syslogControl, rxDiversityVid=rxDiversityVid, rFURxFreqMax=rFURxFreqMax, protectionStats=protectionStats, vLANManagementVID=vLANManagementVID, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapPortNumber=sNMPTrapPortNumber, management=management, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, ethernetPriorityTable=ethernetPriorityTable, sNTPSync=sNTPSync, aggregateDataRate=aggregateDataRate, sNMPTrapVersion=sNMPTrapVersion, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, tFTPServerPortNumber=tFTPServerPortNumber, telnetAccessEnabled=telnetAccessEnabled, transmitCodeRate=transmitCodeRate, sNMPTrapTableIndex=sNMPTrapTableIndex, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, encryptionEnabledMismatch=encryptionEnabledMismatch, tFTPServerInternetAddress=tFTPServerInternetAddress, radioLicenseRxFreq=radioLicenseRxFreq, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, radioLicenseTxFreq=radioLicenseTxFreq, receiveModulation=receiveModulation, ptpTraps=ptpTraps, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hTTPSAccessEnabled=hTTPSAccessEnabled, remotePrimaryIPAddress=remotePrimaryIPAddress, radioLicenseIdentifier=radioLicenseIdentifier, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, cambium=cambium, dataPortPauseFrames=dataPortPauseFrames, receivePower=receivePower, protection=protection, longitude=longitude, protectionInterfaceStatus=protectionInterfaceStatus, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, ptmp=ptmp)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, activeUnit=activeUnit, sNTPSyncTrap=sNTPSyncTrap, rFURFSwitchAlarm=rFURFSwitchAlarm, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNMPPortNumber=sNMPPortNumber, productVariant=productVariant, rFUType=rFUType, remotePrimaryInternetAddress=remotePrimaryInternetAddress, remoteInternetAddressType=remoteInternetAddressType, sNTPServerTableNumber=sNTPServerTableNumber, syslogClient=syslogClient, endId=endId, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, alignmentMode=alignmentMode, radioLicenseCodeRate=radioLicenseCodeRate, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, telnetPortNumber=telnetPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerTable=sNTPServerTable, neighborInternetAddress=neighborInternetAddress, sNTPServerRetries=sNTPServerRetries, syslogStateTrap=syslogStateTrap, sNTPServerResponse=sNTPServerResponse, linkName=linkName, protectionSwitchCause=protectionSwitchCause, numberOfAntennas=numberOfAntennas, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, altitude=altitude, transmitPower=transmitPower, linkLoss=linkLoss, aAAControl=aAAControl, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, secondarySoftwareVersion=secondarySoftwareVersion, softwareVersion=softwareVersion, rFURxFreqMin=rFURxFreqMin, managementCommittedInformationRate=managementCommittedInformationRate, vLANManagementVIDValidation=vLANManagementVIDValidation, radioLicenseModulation=radioLicenseModulation, radioLicenseMaxEIRP=radioLicenseMaxEIRP, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, protectionAvailabilityStatus=protectionAvailabilityStatus, sNMPCommunityString=sNMPCommunityString, rFUTxPowerMin=rFUTxPowerMin, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, productName=productName, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernet=ethernet, diverseRfFeederLoss=diverseRfFeederLoss, sNTPServerTableIndex=sNTPServerTableIndex, protectionStatus=protectionStatus, siteName=siteName, wirelessLinkAvailability=wirelessLinkAvailability, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receiveCodeRate=receiveCodeRate, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, remoteInternetAddress=remoteInternetAddress, rFUStatus=rFUStatus, radioLicenseRegion=radioLicenseRegion, remoteMACAddress=remoteMACAddress, linkNameMismatch=linkNameMismatch, latitude=latitude, daylightSaving=daylightSaving, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, transmitModulation=transmitModulation, primaryRecoveryPeriod=primaryRecoveryPeriod, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, userTableEntry=userTableEntry, qOSPriorityScheme=qOSPriorityScheme, ethernetPriorityTableIndex=ethernetPriorityTableIndex, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, subnetMask=subnetMask, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNMPTrapTableEntry=sNMPTrapTableEntry, rFUProtectionCompatibility=rFUProtectionCompatibility, primarySecondaryMode=primarySecondaryMode, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap)
