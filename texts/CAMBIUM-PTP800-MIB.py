...
Counter64, enterprises, NotificationType, ObjectIdentity, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, MibIdentifier, iso, Bits, NotificationType, ModuleIdentity, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "enterprises", "NotificationType", "ObjectIdentity", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "MibIdentifier", "iso", "Bits", "NotificationType", "ModuleIdentity", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNTPServerIPAddress=sNTPServerIPAddress, transmitterStatus=transmitterStatus, protection=protection, telnetPortNumber=telnetPortNumber, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, minCodeRate=minCodeRate, unitOutOfCalibration=unitOutOfCalibration, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, maxCodeRate=maxCodeRate, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, rFUTxPowerMin=rFUTxPowerMin, wirelessLinkAvailability=wirelessLinkAvailability, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, remotePrimarySecondaryMode=remotePrimarySecondaryMode, protectionStateTrap=protectionStateTrap, activeAvailableTime=activeAvailableTime, vLANManagementPriority=vLANManagementPriority, secureModeAlarm=secureModeAlarm, aAAControl=aAAControl, ethernetPriorityTable=ethernetPriorityTable, minModulation=minModulation, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, iPv6Address=iPv6Address, receiveDataRate=receiveDataRate, rFUTxFreqMax=rFUTxFreqMax, sNTPServerTimeout=sNTPServerTimeout, vLANManagementVIDValidation=vLANManagementVIDValidation, primaryRecoveryPeriod=primaryRecoveryPeriod, altitude=altitude, syslogLocalWrappedTrap=syslogLocalWrappedTrap, longitude=longitude, userTableIndex=userTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, sNTPServerTableEntry=sNTPServerTableEntry, radioLicenseBandwidth=radioLicenseBandwidth, dataPortFiberStatusTrap=dataPortFiberStatusTrap, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, managementPortStatus=managementPortStatus, neighborIPAddress=neighborIPAddress, protectionAvailabilityStatus=protectionAvailabilityStatus, rxDiversityDataPortStatus=rxDiversityDataPortStatus, timeZone=timeZone, transmitModulation=transmitModulation, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, sNTPServerInternetAddress=sNTPServerInternetAddress, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, remoteIPAddress=remoteIPAddress, hTTPSPortNumber=hTTPSPortNumber, sNTPPrimaryServer=sNTPPrimaryServer, rFUBranchingConfiguration=rFUBranchingConfiguration, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, subnetMask=subnetMask, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, management=management, iPv6GatewayAddress=iPv6GatewayAddress, productName=productName, sNTPSync=sNTPSync, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, userTableNumber=userTableNumber, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, transmitDataRate=transmitDataRate, userName=userName, remotePrimaryIPAddress=remotePrimaryIPAddress, iPVersion=iPVersion, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, protectionStats=protectionStats, versions=versions, rFURfBand=rFURfBand, dataPortPauseFrames=dataPortPauseFrames, receivePower=receivePower, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, softwareVersion=softwareVersion, reset=reset, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, sNTPServerRetries=sNTPServerRetries, requestedProtectionState=requestedProtectionState, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, daylightSaving=daylightSaving, sNMPTrapTable=sNMPTrapTable, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, useVLANForManagementInterfaces=useVLANForManagementInterfaces, radioLicenseModulation=radioLicenseModulation, remoteInternetAddress=remoteInternetAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, primaryRecovery=primaryRecovery, tFTPServerPortNumber=tFTPServerPortNumber, rFURxFreqMax=rFURxFreqMax, rFURxFreqMin=rFURxFreqMin, managementPortForcedConfiguration=managementPortForcedConfiguration, radioLicenseMaxEIRP=radioLicenseMaxEIRP, sNTPServerResponse=sNTPServerResponse, userPassword=userPassword, licence=licence, sNMPTrapVersion=sNMPTrapVersion, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, endId=endId, syslogControl=syslogControl, managementMode=managementMode, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, systemClock=systemClock, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, sNTPState=sNTPState, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, syslogClientTrap=syslogClientTrap, rFULockoutAlarm=rFULockoutAlarm, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, sNTPServerTableIndex=sNTPServerTableIndex, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, sMTPEnabledMessages=sMTPEnabledMessages, alignmentMode=alignmentMode, rxDiversityVlanTpid=rxDiversityVlanTpid, ptpTrapPrefix=ptpTrapPrefix, dataPortConfigurationMismatch=dataPortConfigurationMismatch, radioLicenseBand=radioLicenseBand, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ptp=ptp, vLANManagementVID=vLANManagementVID, linkNameMismatchTrap=linkNameMismatchTrap, managementPortStatusTrap=managementPortStatusTrap, rFUTxFreqMin=rFUTxFreqMin, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, rFUStatus=rFUStatus, rFUType=rFUType, rFUSerial=rFUSerial, rFUPlatformCompatibility=rFUPlatformCompatibility, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, supplementary=supplementary, sMTPServerIPAddress=sMTPServerIPAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, fiberY=fiberY, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, snmpControl=snmpControl, transmitCapacityLimit=transmitCapacityLimit, l2CPPriorityTable=l2CPPriorityTable, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rFUCableAlarm=rFUCableAlarm, secureModeAlarmTrap=secureModeAlarmTrap, radioLicenseRegion=radioLicenseRegion, phyStatus=phyStatus, systemReset=systemReset, rfu=rfu, smtp=smtp, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, iPv6PrefixLength=iPv6PrefixLength, iPv4Address=iPv4Address, configuration=configuration, sNTPSyncTrap=sNTPSyncTrap, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, hTTPPortNumber=hTTPPortNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, neighborInternetAddress=neighborInternetAddress, diverseAntennaGain=diverseAntennaGain, protectionState=protectionState, rFUTxPowerMax=rFUTxPowerMax, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, latitude=latitude, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteMaximumTransmitPower=remoteMaximumTransmitPower, productVariant=productVariant, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFUTxPowerAlarm=rFUTxPowerAlarm, linkLoss=linkLoss, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, radioLicenseCodeRate=radioLicenseCodeRate, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, tFTPServerIPAddress=tFTPServerIPAddress, rFFeederLoss=rFFeederLoss, remoteInternetAddressType=remoteInternetAddressType, receiveCodeRate=receiveCodeRate, rFUStatusTrap=rFUStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, primarySecondaryMode=primarySecondaryMode, remoteSecondaryIPAddress=remoteSecondaryIPAddress, dataPortStatus=dataPortStatus, encryptionAlgorithm=encryptionAlgorithm, rFUTransceiverLocation=rFUTransceiverLocation, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, protectionInterfaceStatus=protectionInterfaceStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, qOSPriorityScheme=qOSPriorityScheme, aTPCEnable=aTPCEnable, userRole=userRole, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rFUFreqSpacing=rFUFreqSpacing, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, alignmentModeTrap=alignmentModeTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, radioLicenseMinModulation=radioLicenseMinModulation, syslogStateTrap=syslogStateTrap, telnetAccessEnabled=telnetAccessEnabled, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, securityLevel=securityLevel, phyControl=phyControl, radioLicenseTxFreq=radioLicenseTxFreq, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPServerPortNumber=sMTPServerPortNumber, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, sMTPEmailAlert=sMTPEmailAlert, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, iFCableLength=iFCableLength, numberOfAntennas=numberOfAntennas, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, radioLicense=radioLicense, sMTPSourceEmailAddress=sMTPSourceEmailAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, mPLSTCPriorityTable=mPLSTCPriorityTable, hTTPSAccessEnabled=hTTPSAccessEnabled, rFUPowerAlarm=rFUPowerAlarm, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, userTable=userTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataPortStatusTrap=dataPortStatusTrap, vectorError=vectorError, managementPortDisabledWarning=managementPortDisabledWarning, rFUActiveFirmwareBank=rFUActiveFirmwareBank, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, protectionConfigurationStatus=protectionConfigurationStatus, sNTPServerTable=sNTPServerTable, encryptionEnabledMismatch=encryptionEnabledMismatch, aggregateDataRate=aggregateDataRate, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, hTTPAccessEnabled=hTTPAccessEnabled, encryption=encryption, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogState=syslogState, sNMPCommunityString=sNMPCommunityString, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rFUTxMuteStatus=rFUTxMuteStatus, cambium=cambium)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", neighborInternetAddressType=neighborInternetAddressType, ptpTraps=ptpTraps, ptp800=ptp800, transmitPower=transmitPower, maxModulation=maxModulation, radioLicenseMinCodeRate=radioLicenseMinCodeRate, maximumTransmitPower=maximumTransmitPower, linkName=linkName, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, radioLicenseRxFreq=radioLicenseRxFreq, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, neighborMACAddress=neighborMACAddress, linkNameMismatch=linkNameMismatch, transmitCapacity=transmitCapacity, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, rxDiversityVid=rxDiversityVid, userEnabled=userEnabled, receiveModulation=receiveModulation, diverseRfFeederLoss=diverseRfFeederLoss, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, protectionConfig=protectionConfig, sNTPServerTableNumber=sNTPServerTableNumber, remotePrimaryMACAddress=remotePrimaryMACAddress, rFUVersionBank2=rFUVersionBank2, sNTPPollInterval=sNTPPollInterval, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, remotePrimaryInternetAddress=remotePrimaryInternetAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, rFUVersionBank1=rFUVersionBank1, localPacketFiltering=localPacketFiltering, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, protectionSwitchCause=protectionSwitchCause, ptmp=ptmp, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, enableTransmission=enableTransmission, dSCPManagementPriority=dSCPManagementPriority, activeUnit=activeUnit, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, dataPortFiberStatus=dataPortFiberStatus, bridge=bridge, bootVersion=bootVersion, ethernet=ethernet, sNMPPortNumber=sNMPPortNumber, faultProtectionSwitching=faultProtectionSwitching, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rFUProtectionCompatibility=rFUProtectionCompatibility, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, secondarySoftwareVersion=secondarySoftwareVersion, syslogClient=syslogClient, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, managementCommittedInformationRate=managementCommittedInformationRate, wirelessLinkStatusTrap=wirelessLinkStatusTrap, dataPortDisabledWarning=dataPortDisabledWarning, sNTPLastSync=sNTPLastSync, gatewayIPAddress=gatewayIPAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rFURFSwitchAlarm=rFURFSwitchAlarm, transmitCapacityLimitDetail=transmitCapacityLimitDetail, rFURpsAlarm=rFURpsAlarm, rFUTxBandAboveRx=rFUTxBandAboveRx, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, antennaGain=antennaGain, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, activeWirelessLinkAvailability=activeWirelessLinkAvailability, userTableEntry=userTableEntry, ethernetPriorityTableEntry=ethernetPriorityTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sntp=sntp, rFUConnectedPlatform=rFUConnectedPlatform, radioLicenseMaxModulation=radioLicenseMaxModulation, rFUPowerButtonPressed=rFUPowerButtonPressed, radioLicenseIdentifier=radioLicenseIdentifier, sNMPTrapTableNumber=sNMPTrapTableNumber, siteName=siteName, ethernetFiberSupport=ethernetFiberSupport, remoteMACAddress=remoteMACAddress, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, alarms=alarms, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, hardwareVersion=hardwareVersion, protectionStatus=protectionStatus, managementPortAutoNegotiation=managementPortAutoNegotiation, transmitCodeRate=transmitCodeRate, pubStats=pubStats)
