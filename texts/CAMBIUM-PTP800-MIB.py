...
Gauge32, enterprises, NotificationType, Bits, NotificationType, ModuleIdentity, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, Unsigned32, iso, IpAddress, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "NotificationType", "Bits", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "Unsigned32", "iso", "IpAddress", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", l2CPPriorityTable=l2CPPriorityTable, vLANManagementVIDValidation=vLANManagementVIDValidation, rFUFreqSpacing=rFUFreqSpacing, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, tFTPServerIPAddress=tFTPServerIPAddress, userTableEntry=userTableEntry, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, hardwareVersion=hardwareVersion, aAAControl=aAAControl, protectionConfig=protectionConfig, sNTPServerTimeout=sNTPServerTimeout, radioLicenseBand=radioLicenseBand, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, primaryRecovery=primaryRecovery, remoteSecondaryIPAddress=remoteSecondaryIPAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, radioLicenseBandwidth=radioLicenseBandwidth, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, maxModulation=maxModulation, useVLANForManagementInterfaces=useVLANForManagementInterfaces, smtp=smtp, protectionStats=protectionStats, sNTPServerPortNumber=sNTPServerPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, userTable=userTable, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, linkNameMismatchTrap=linkNameMismatchTrap, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, transmitPower=transmitPower, sntp=sntp, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, transmitterStatus=transmitterStatus, ptp800=ptp800, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, radioLicenseTxFreq=radioLicenseTxFreq, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPServerResponse=sNTPServerResponse, activeUnit=activeUnit, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFULockoutAlarm=rFULockoutAlarm, mPLSTCPriorityTable=mPLSTCPriorityTable, rFUTxMuteStatus=rFUTxMuteStatus, radioLicense=radioLicense, alarms=alarms, vectorError=vectorError, bridge=bridge, numberOfAntennas=numberOfAntennas, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, longitude=longitude, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, radioLicenseMaxEIRP=radioLicenseMaxEIRP, rFURxFreqMin=rFURxFreqMin, managementPortStatusTrap=managementPortStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, enableTransmission=enableTransmission, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, rFFeederLoss=rFFeederLoss, sNMPTrapPortNumber=sNMPTrapPortNumber, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, transmitModulation=transmitModulation, qOSPriorityScheme=qOSPriorityScheme, productVariant=productVariant, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, remotePrimaryInternetAddress=remotePrimaryInternetAddress, remotePrimaryMACAddress=remotePrimaryMACAddress, remotePrimaryIPAddress=remotePrimaryIPAddress, primarySecondaryMode=primarySecondaryMode, protectionStatus=protectionStatus, vLANManagementPriority=vLANManagementPriority, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, radioLicenseMinModulation=radioLicenseMinModulation, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rfu=rfu, telnetAccessEnabled=telnetAccessEnabled, dataPortFiberStatus=dataPortFiberStatus, rxDiversityDataPortStatus=rxDiversityDataPortStatus, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortStatusTrap=dataPortStatusTrap, phyControl=phyControl, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerIPAddress=sNTPServerIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rFURpsAlarm=rFURpsAlarm, dataPortConfigurationMismatch=dataPortConfigurationMismatch, faultProtectionSwitching=faultProtectionSwitching, ptpTrapPrefix=ptpTrapPrefix, syslogLocalWrappedTrap=syslogLocalWrappedTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, diverseRfFeederLoss=diverseRfFeederLoss, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, siteName=siteName, dataPortPauseFrames=dataPortPauseFrames, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, pubStats=pubStats, managementCommittedInformationRate=managementCommittedInformationRate, encryptionEnabledMismatch=encryptionEnabledMismatch, neighborMACAddress=neighborMACAddress, ethernet=ethernet, diverseAntennaGain=diverseAntennaGain, rFUPowerAlarm=rFUPowerAlarm, altitude=altitude, versions=versions, linkName=linkName, radioLicenseMinCodeRate=radioLicenseMinCodeRate, softwareVersion=softwareVersion, systemClock=systemClock, ptp=ptp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, iPv6Address=iPv6Address, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerTable=sNTPServerTable, remoteMACAddress=remoteMACAddress, ethernetFiberSupport=ethernetFiberSupport, fiberY=fiberY, subnetMask=subnetMask, transmitCodeRate=transmitCodeRate, sNTPSync=sNTPSync, wirelessLinkStatusTrap=wirelessLinkStatusTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, rFUStatusTrap=rFUStatusTrap, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, protectionSwitchCause=protectionSwitchCause, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, licence=licence, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, wirelessLinkAvailability=wirelessLinkAvailability, sMTPEnabledMessages=sMTPEnabledMessages, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, managementPortConfigurationMismatch=managementPortConfigurationMismatch, hTTPSAccessEnabled=hTTPSAccessEnabled, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, linkLoss=linkLoss, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, timeZone=timeZone, rFUTxBandAboveRx=rFUTxBandAboveRx, bootVersion=bootVersion, syslogClientTrap=syslogClientTrap, userName=userName, protectionConfigurationStatus=protectionConfigurationStatus, protectionAvailabilityStatus=protectionAvailabilityStatus, receiveCodeRate=receiveCodeRate, sNTPState=sNTPState, receiveModulation=receiveModulation, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, sNTPSyncTrap=sNTPSyncTrap, primaryRecoveryPeriod=primaryRecoveryPeriod, sNMPCommunityString=sNMPCommunityString, radioLicenseRxFreq=radioLicenseRxFreq, protectionState=protectionState, activeAvailableTime=activeAvailableTime, minModulation=minModulation, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapTable=sNMPTrapTable, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, latitude=latitude, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, hTTPSPortNumber=hTTPSPortNumber, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, tFTPServerInternetAddress=tFTPServerInternetAddress, rFUTxPowerAlarm=rFUTxPowerAlarm, dataPortStatus=dataPortStatus, sNTPPrimaryServer=sNTPPrimaryServer, receiveDataRate=receiveDataRate, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ethernetPriorityTable=ethernetPriorityTable, radioLicenseMaxModulation=radioLicenseMaxModulation, secureModeAlarmTrap=secureModeAlarmTrap, managementPortForcedConfiguration=managementPortForcedConfiguration, dataPortDisabledWarning=dataPortDisabledWarning, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, sNTPPollInterval=sNTPPollInterval, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, iPVersion=iPVersion, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, managementPortDisabledWarning=managementPortDisabledWarning, l2CPPriorityTableIndex=l2CPPriorityTableIndex, hTTPPortNumber=hTTPPortNumber, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFUTransceiverLocation=rFUTransceiverLocation, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rFUProtectionCompatibility=rFUProtectionCompatibility, antennaGain=antennaGain, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, remoteInternetAddressType=remoteInternetAddressType, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, encryption=encryption, radioLicenseCodeRate=radioLicenseCodeRate, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, protectionInterfaceStatus=protectionInterfaceStatus, ptpTraps=ptpTraps, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sMTPServerIPAddress=sMTPServerIPAddress, productName=productName, aggregateDataRate=aggregateDataRate, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rFUVersionBank1=rFUVersionBank1, userTableNumber=userTableNumber, remoteSecondaryMACAddress=remoteSecondaryMACAddress, sNTPLastSync=sNTPLastSync, endId=endId, rFURfBand=rFURfBand, l2CPPriorityTableEntry=l2CPPriorityTableEntry, daylightSaving=daylightSaving, remoteInternetAddress=remoteInternetAddress, managementPortStatus=managementPortStatus, systemReset=systemReset, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, securityLevel=securityLevel, userEnabled=userEnabled, supplementary=supplementary, rFUConnectedPlatform=rFUConnectedPlatform, neighborInternetAddress=neighborInternetAddress, snmpControl=snmpControl, management=management, userRole=userRole, secureModeAlarm=secureModeAlarm, dSCPManagementPriority=dSCPManagementPriority, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, encryptionAlgorithm=encryptionAlgorithm, cambium=cambium, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, configuration=configuration, iPv6GatewayAddress=iPv6GatewayAddress, rFUTxFreqMax=rFUTxFreqMax, tFTPServerPortNumber=tFTPServerPortNumber, rFUStatus=rFUStatus, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sNMPTrapVersion=sNMPTrapVersion, rFUPlatformCompatibility=rFUPlatformCompatibility, radioLicenseRegion=radioLicenseRegion, iPv4Address=iPv4Address)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", managementMode=managementMode, wirelessLinkStatus=wirelessLinkStatus, rFUTxFreqMin=rFUTxFreqMin, iPv6PrefixLength=iPv6PrefixLength, gatewayIPAddress=gatewayIPAddress, rFURxFreqMax=rFURxFreqMax, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, telnetPortNumber=telnetPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, minCodeRate=minCodeRate, rFUType=rFUType, rFUSerial=rFUSerial, radioLicenseModulation=radioLicenseModulation, rFUVersionBank2=rFUVersionBank2, rFUTxPowerMin=rFUTxPowerMin, managementPortAutoNegotiation=managementPortAutoNegotiation, transmitDataRate=transmitDataRate, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, reset=reset, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userTableIndex=userTableIndex, neighborInternetAddressType=neighborInternetAddressType, sNTPServerRetries=sNTPServerRetries, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, remotePrimarySecondaryMode=remotePrimarySecondaryMode, sMTPEmailAlert=sMTPEmailAlert, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transmitCapacityLimitDetail=transmitCapacityLimitDetail, requestedProtectionState=requestedProtectionState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, rFUPowerButtonPressed=rFUPowerButtonPressed, syslogState=syslogState, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, radioLicenseIdentifier=radioLicenseIdentifier, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, maxCodeRate=maxCodeRate, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, transmitCapacity=transmitCapacity, rFUBranchingConfiguration=rFUBranchingConfiguration, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, iFCableLength=iFCableLength, unitOutOfCalibration=unitOutOfCalibration, l2CPPriorityTableNumber=l2CPPriorityTableNumber, vLANManagementVID=vLANManagementVID, ptmp=ptmp, aTPCEnable=aTPCEnable, syslogStateTrap=syslogStateTrap, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, activeWirelessLinkAvailability=activeWirelessLinkAvailability, receivePower=receivePower, rxDiversityVid=rxDiversityVid, iPDSCPPriorityTable=iPDSCPPriorityTable, syslogControl=syslogControl, rFUActiveFirmwareBank=rFUActiveFirmwareBank, syslogClient=syslogClient, userPassword=userPassword, phyStatus=phyStatus, rFUTxPowerMax=rFUTxPowerMax, protection=protection, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rFUCableAlarm=rFUCableAlarm, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, maximumTransmitPower=maximumTransmitPower, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPServerTableEntry=sNTPServerTableEntry, alignmentModeTrap=alignmentModeTrap, alignmentMode=alignmentMode, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, linkNameMismatch=linkNameMismatch, localPacketFiltering=localPacketFiltering, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, protectionStateTrap=protectionStateTrap, rxDiversityVlanTpid=rxDiversityVlanTpid, neighborIPAddress=neighborIPAddress, sNMPPortNumber=sNMPPortNumber, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, transmitCapacityLimit=transmitCapacityLimit, sNTPServerTableIndex=sNTPServerTableIndex, rFURFSwitchAlarm=rFURFSwitchAlarm, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, remoteIPAddress=remoteIPAddress, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration)
