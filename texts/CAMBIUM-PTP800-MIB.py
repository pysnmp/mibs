...
TimeTicks, ModuleIdentity, iso, Bits, Integer32, Counter64, NotificationType, Unsigned32, IpAddress, Counter32, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "iso", "Bits", "Integer32", "Counter64", "NotificationType", "Unsigned32", "IpAddress", "Counter32", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", gatewayIPAddress=gatewayIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, endId=endId, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userTable=userTable, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, linkName=linkName, securityLevel=securityLevel, aTPCEnable=aTPCEnable, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, diverseAntennaGain=diverseAntennaGain, dataPortPauseFrames=dataPortPauseFrames, ptp800=ptp800, unitOutOfCalibration=unitOutOfCalibration, subnetMask=subnetMask, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, sNTPLastSync=sNTPLastSync, remoteSecondaryIPAddress=remoteSecondaryIPAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transmitCapacityLimitDetail=transmitCapacityLimitDetail, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ptpTrapPrefix=ptpTrapPrefix, protectionAvailabilityStatus=protectionAvailabilityStatus, protectionStats=protectionStats, rFUTxPowerMax=rFUTxPowerMax, rFUFreqSpacing=rFUFreqSpacing, rFUSerial=rFUSerial, tFTPServerInternetAddress=tFTPServerInternetAddress, ethernetFiberSupport=ethernetFiberSupport, receiveCodeRate=receiveCodeRate, aggregateDataRate=aggregateDataRate, antennaGain=antennaGain, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, sNMPCommunityString=sNMPCommunityString, softwareVersion=softwareVersion, userTableEntry=userTableEntry, rFUTxFreqMax=rFUTxFreqMax, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, dSCPManagementPriority=dSCPManagementPriority, radioLicenseBand=radioLicenseBand, rxDiversityVid=rxDiversityVid, linkNameMismatchTrap=linkNameMismatchTrap, remoteIPAddress=remoteIPAddress, rFUTransceiverLocation=rFUTransceiverLocation, sNTPSyncTrap=sNTPSyncTrap, protectionSwitchCause=protectionSwitchCause, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, telnetPortNumber=telnetPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, maximumTransmitPower=maximumTransmitPower, activeUnit=activeUnit, minModulation=minModulation, radioLicenseRegion=radioLicenseRegion, protection=protection, rFUTxPowerAlarm=rFUTxPowerAlarm, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, rFURxFreqMax=rFURxFreqMax, radioLicenseMaxModulation=radioLicenseMaxModulation, userName=userName, rFUCableAlarm=rFUCableAlarm, ethernetPriorityTableEntry=ethernetPriorityTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, syslogClient=syslogClient, activeWirelessLinkAvailability=activeWirelessLinkAvailability, sNTPServerTableIndex=sNTPServerTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitCodeRate=transmitCodeRate, rFUVersionBank2=rFUVersionBank2, diverseRfFeederLoss=diverseRfFeederLoss, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, localPacketFiltering=localPacketFiltering, rFUConnectedPlatform=rFUConnectedPlatform, rFURxFreqMin=rFURxFreqMin, userRole=userRole, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, sNTPSync=sNTPSync, receiveDataRate=receiveDataRate, neighborInternetAddress=neighborInternetAddress, sMTPEmailAlert=sMTPEmailAlert, encryptionEnabledMismatch=encryptionEnabledMismatch, rFUTxBandAboveRx=rFUTxBandAboveRx, transmitCapacity=transmitCapacity, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dataPortConfigurationMismatch=dataPortConfigurationMismatch, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rFURfBand=rFURfBand, encryption=encryption, snmpControl=snmpControl, siteName=siteName, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sNTPState=sNTPState, encryptionAlgorithm=encryptionAlgorithm, productName=productName, sNMPEnabledTraps=sNMPEnabledTraps, transmitterStatus=transmitterStatus, licence=licence, vLANManagementVIDValidation=vLANManagementVIDValidation, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, managementPortForcedConfiguration=managementPortForcedConfiguration, sNTPPrimaryServer=sNTPPrimaryServer, dataPortStatus=dataPortStatus, numberOfAntennas=numberOfAntennas, neighborMACAddress=neighborMACAddress, rFUPlatformCompatibility=rFUPlatformCompatibility, neighborInternetAddressType=neighborInternetAddressType, timeZone=timeZone, sMTPEnabledMessages=sMTPEnabledMessages, rFUTxFreqMin=rFUTxFreqMin, rFUVersionBank1=rFUVersionBank1, primarySecondaryMode=primarySecondaryMode, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapVersion=sNMPTrapVersion, cambium=cambium, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, syslogControl=syslogControl, remotePrimaryIPAddress=remotePrimaryIPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, remoteMACAddress=remoteMACAddress, rFUStatusTrap=rFUStatusTrap, userEnabled=userEnabled, iPDSCPPriorityTable=iPDSCPPriorityTable, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetPriorityTable=ethernetPriorityTable, dataPortFiberStatus=dataPortFiberStatus, rFFeederLoss=rFFeederLoss, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sMTPServerIPAddress=sMTPServerIPAddress, activeAvailableTime=activeAvailableTime, sNTPServerRetries=sNTPServerRetries, remotePrimaryInternetAddress=remotePrimaryInternetAddress, sNTPServerTable=sNTPServerTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, protectionState=protectionState, enableTransmission=enableTransmission, remoteInternetAddressType=remoteInternetAddressType, ptmp=ptmp, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, sNTPServerTimeout=sNTPServerTimeout, transmitModulation=transmitModulation, hTTPSPortNumber=hTTPSPortNumber, altitude=altitude, pubStats=pubStats, syslogStateTrap=syslogStateTrap, iPv6GatewayAddress=iPv6GatewayAddress, radioLicenseMaxEIRP=radioLicenseMaxEIRP, managementPortAutoNegotiation=managementPortAutoNegotiation, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, radioLicenseMinModulation=radioLicenseMinModulation, alarms=alarms, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, faultProtectionSwitching=faultProtectionSwitching, protectionInterfaceStatus=protectionInterfaceStatus, vLANManagementVID=vLANManagementVID, sNMPTrapTableNumber=sNMPTrapTableNumber, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, hTTPSAccessEnabled=hTTPSAccessEnabled, radioLicenseTxFreq=radioLicenseTxFreq, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iPv4Address=iPv4Address, wirelessLinkStatusTrap=wirelessLinkStatusTrap, sNTPServerTableEntry=sNTPServerTableEntry, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, remotePrimaryMACAddress=remotePrimaryMACAddress, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, iPVersion=iPVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPv6Address=iPv6Address, primaryRecovery=primaryRecovery, syslogLocalWrappedTrap=syslogLocalWrappedTrap, secureModeAlarm=secureModeAlarm, management=management, rFURpsAlarm=rFURpsAlarm, receivePower=receivePower, rfu=rfu, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, bootVersion=bootVersion, rFUBranchingConfiguration=rFUBranchingConfiguration, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, wirelessLinkStatus=wirelessLinkStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, radioLicenseIdentifier=radioLicenseIdentifier, supplementary=supplementary, remoteInternetAddress=remoteInternetAddress, phyStatus=phyStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortDisabledWarning=dataPortDisabledWarning, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, useVLANForManagementInterfaces=useVLANForManagementInterfaces, radioLicenseModulation=radioLicenseModulation, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, receiveModulation=receiveModulation, rxDiversityDataPortStatus=rxDiversityDataPortStatus, ptpTraps=ptpTraps, rFUProtectionCompatibility=rFUProtectionCompatibility, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, radioLicense=radioLicense, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, sNTPServerIPAddress=sNTPServerIPAddress, rFUStatus=rFUStatus, sNTPPollInterval=sNTPPollInterval, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mPLSTCPriorityTable=mPLSTCPriorityTable, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, neighborIPAddress=neighborIPAddress, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, sntp=sntp, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, transmitDataRate=transmitDataRate, qOSPriorityScheme=qOSPriorityScheme, sNMPTrapTableEntry=sNMPTrapTableEntry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, reset=reset, protectionConfig=protectionConfig, rFUActiveFirmwareBank=rFUActiveFirmwareBank, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rxDiversityVlanTpid=rxDiversityVlanTpid, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, protectionStatus=protectionStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, longitude=longitude, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, secureModeAlarmTrap=secureModeAlarmTrap, vectorError=vectorError, versions=versions, managementPortStatusTrap=managementPortStatusTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPServerResponse=sNTPServerResponse)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, primaryRecoveryPeriod=primaryRecoveryPeriod, hTTPPortNumber=hTTPPortNumber, remotePrimarySecondaryMode=remotePrimarySecondaryMode, requestedProtectionState=requestedProtectionState, userPassword=userPassword, rFUTxPowerMin=rFUTxPowerMin, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, syslogState=syslogState, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, userTableIndex=userTableIndex, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, bridge=bridge, smtp=smtp, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, sNMPPortNumber=sNMPPortNumber, remoteSecondaryMACAddress=remoteSecondaryMACAddress, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, dataPortStatusTrap=dataPortStatusTrap, managementPortDisabledWarning=managementPortDisabledWarning, iPv6PrefixLength=iPv6PrefixLength, radioLicenseBandwidth=radioLicenseBandwidth, protectionStateTrap=protectionStateTrap, managementPortStatus=managementPortStatus, alignmentModeTrap=alignmentModeTrap, l2CPPriorityTable=l2CPPriorityTable, phyControl=phyControl, hardwareVersion=hardwareVersion, alignmentMode=alignmentMode, ptp=ptp, linkNameMismatch=linkNameMismatch, managementMode=managementMode, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userTableNumber=userTableNumber, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, rFUPowerAlarm=rFUPowerAlarm, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, ethernet=ethernet, transmitCapacityLimit=transmitCapacityLimit, rFUTxMuteStatus=rFUTxMuteStatus, productVariant=productVariant, protectionConfigurationStatus=protectionConfigurationStatus, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, sNTPServerPortNumber=sNTPServerPortNumber, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rFUType=rFUType, configuration=configuration, transmitPower=transmitPower, sMTPServerPortNumber=sMTPServerPortNumber, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFUPowerButtonPressed=rFUPowerButtonPressed, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, sNMPTrapPortNumber=sNMPTrapPortNumber, fiberY=fiberY, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, maxModulation=maxModulation, maxCodeRate=maxCodeRate, managementCommittedInformationRate=managementCommittedInformationRate, iFCableLength=iFCableLength, minCodeRate=minCodeRate, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, telnetAccessEnabled=telnetAccessEnabled, remoteMaximumTransmitPower=remoteMaximumTransmitPower, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, radioLicenseCodeRate=radioLicenseCodeRate, vLANManagementPriority=vLANManagementPriority, sNMPTrapTable=sNMPTrapTable, latitude=latitude, rFURFSwitchAlarm=rFURFSwitchAlarm, wirelessLinkAvailability=wirelessLinkAvailability, hTTPAccessEnabled=hTTPAccessEnabled, syslogClientTrap=syslogClientTrap, daylightSaving=daylightSaving, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, linkLoss=linkLoss, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rFULockoutAlarm=rFULockoutAlarm, radioLicenseRxFreq=radioLicenseRxFreq, aAAControl=aAAControl, systemClock=systemClock, systemReset=systemReset)
