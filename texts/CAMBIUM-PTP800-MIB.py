...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", syslogControl=syslogControl, iPv6GatewayAddress=iPv6GatewayAddress, rFUTxFreqMax=rFUTxFreqMax, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, dataPortPauseFrames=dataPortPauseFrames, protectionConfigurationStatus=protectionConfigurationStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, qOSPriorityScheme=qOSPriorityScheme, vLANManagementVIDValidation=vLANManagementVIDValidation, userTableIndex=userTableIndex, aAAControl=aAAControl, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFURfBand=rFURfBand, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, managementPortStatus=managementPortStatus, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPLastSync=sNTPLastSync, telnetPortNumber=telnetPortNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, receiveCodeRate=receiveCodeRate, activeWirelessLinkAvailability=activeWirelessLinkAvailability, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, ptmp=ptmp, protectionAvailabilityStatus=protectionAvailabilityStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, linkLoss=linkLoss, radioLicenseBandwidth=radioLicenseBandwidth, rfu=rfu, tFTPServerPortNumber=tFTPServerPortNumber, daylightSaving=daylightSaving, neighborInternetAddress=neighborInternetAddress, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, fiberY=fiberY, unitOutOfCalibration=unitOutOfCalibration, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, maxCodeRate=maxCodeRate, rxDiversityVlanTpid=rxDiversityVlanTpid, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, alarms=alarms, sNTPPrimaryServer=sNTPPrimaryServer, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, diverseAntennaGain=diverseAntennaGain, userEnabled=userEnabled, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, l2CPPriorityTableEntry=l2CPPriorityTableEntry, maxModulation=maxModulation, receiveDataRate=receiveDataRate, telnetAccessEnabled=telnetAccessEnabled, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, managementPortStatusTrap=managementPortStatusTrap, sNTPServerTable=sNTPServerTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, remotePrimaryMACAddress=remotePrimaryMACAddress, versions=versions, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, altitude=altitude, protectionState=protectionState, phyControl=phyControl, radioLicenseModulation=radioLicenseModulation, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, neighborInternetAddressType=neighborInternetAddressType, transmitModulation=transmitModulation, rFUPowerAlarm=rFUPowerAlarm, rFUConnectedPlatform=rFUConnectedPlatform, ethernetPriorityTableIndex=ethernetPriorityTableIndex, protection=protection, sNTPState=sNTPState, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, receivePower=receivePower, secureModeAlarm=secureModeAlarm, longitude=longitude, dataPortStatusTrap=dataPortStatusTrap, activeAvailableTime=activeAvailableTime, sNTPServerIPAddress=sNTPServerIPAddress, snmpControl=snmpControl, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPEmailAlert=sMTPEmailAlert, l2CPPriorityTable=l2CPPriorityTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, remoteInternetAddressType=remoteInternetAddressType, sNMPTrapVersion=sNMPTrapVersion, rFURFSwitchAlarm=rFURFSwitchAlarm, management=management, sNTPServerPortNumber=sNTPServerPortNumber, securityLevel=securityLevel, encryption=encryption, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, bootVersion=bootVersion, rFUTxMuteStatus=rFUTxMuteStatus, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rFUVersionBank2=rFUVersionBank2, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, bridge=bridge, primarySecondaryMode=primarySecondaryMode, rFUCableAlarm=rFUCableAlarm, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, userTable=userTable, sMTPEnabledMessages=sMTPEnabledMessages, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, syslogClient=syslogClient, remoteIPAddress=remoteIPAddress, reset=reset, transmitCapacityLimit=transmitCapacityLimit, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, remoteSecondaryMACAddress=remoteSecondaryMACAddress, radioLicenseMaxModulation=radioLicenseMaxModulation, userName=userName, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, sNMPPortNumber=sNMPPortNumber, transmitCapacityLimitDetail=transmitCapacityLimitDetail, sNMPTrapTable=sNMPTrapTable, protectionStatus=protectionStatus, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, minModulation=minModulation, sNTPServerInternetAddressType=sNTPServerInternetAddressType, phyStatus=phyStatus, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, sNTPSync=sNTPSync, neighborMACAddress=neighborMACAddress, activeUnit=activeUnit, rFUFreqSpacing=rFUFreqSpacing, dataPortStatus=dataPortStatus, l2CPPriorityTableIndex=l2CPPriorityTableIndex, maximumTransmitPower=maximumTransmitPower, syslogClientTrap=syslogClientTrap, requestedProtectionState=requestedProtectionState, protectionConfig=protectionConfig, sNTPSyncTrap=sNTPSyncTrap, smtp=smtp, supplementary=supplementary, rFURxFreqMax=rFURxFreqMax, hTTPSAccessEnabled=hTTPSAccessEnabled, protectionInterfaceStatus=protectionInterfaceStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, transmitCapacity=transmitCapacity, linkName=linkName, ethernet=ethernet, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remotePrimaryIPAddress=remotePrimaryIPAddress, sNTPServerResponse=sNTPServerResponse, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, sNTPServerInternetAddress=sNTPServerInternetAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, managementCommittedInformationRate=managementCommittedInformationRate, endId=endId, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, transmitDataRate=transmitDataRate, sntp=sntp, ethernetPriorityTable=ethernetPriorityTable, rFUPowerButtonPressed=rFUPowerButtonPressed, sNTPServerRetries=sNTPServerRetries, localPacketFiltering=localPacketFiltering, numberOfAntennas=numberOfAntennas, radioLicenseIdentifier=radioLicenseIdentifier, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, remotePrimarySecondaryMode=remotePrimarySecondaryMode, wirelessLinkStatusTrap=wirelessLinkStatusTrap, systemClock=systemClock, vLANManagementPriority=vLANManagementPriority, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPv6PrefixLength=iPv6PrefixLength, dataPortConfigurationMismatch=dataPortConfigurationMismatch, iPv4Address=iPv4Address, cambium=cambium, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, hTTPSPortNumber=hTTPSPortNumber, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFURpsAlarm=rFURpsAlarm, transmitterStatus=transmitterStatus, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFUSerial=rFUSerial, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, sNMPCommunityString=sNMPCommunityString, iFCableLength=iFCableLength, managementMode=managementMode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPServerInternetAddress=sMTPServerInternetAddress, subnetMask=subnetMask, sMTPServerPortNumber=sMTPServerPortNumber, dSCPManagementPriority=dSCPManagementPriority, wirelessLinkAvailability=wirelessLinkAvailability, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, timeZone=timeZone, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, managementPortForcedConfiguration=managementPortForcedConfiguration, sNMPTrapTableNumber=sNMPTrapTableNumber, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, antennaGain=antennaGain, syslogState=syslogState, pubStats=pubStats, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userTableEntry=userTableEntry, ptpTrapPrefix=ptpTrapPrefix, licence=licence, sNTPServerTableIndex=sNTPServerTableIndex, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, latitude=latitude, vLANManagementVID=vLANManagementVID, systemReset=systemReset, sNTPServerTableEntry=sNTPServerTableEntry, remotePrimaryInternetAddress=remotePrimaryInternetAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, remoteSecondaryIPAddress=remoteSecondaryIPAddress, rFULockoutAlarm=rFULockoutAlarm, hTTPPortNumber=hTTPPortNumber, rFUTxPowerMax=rFUTxPowerMax, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rFUTxBandAboveRx=rFUTxBandAboveRx, ptp800=ptp800, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpTraps=ptpTraps, remoteInternetAddress=remoteInternetAddress, secondarySoftwareVersion=secondarySoftwareVersion, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, l2CPPriorityTableNumber=l2CPPriorityTableNumber, managementPortDisabledWarning=managementPortDisabledWarning, gatewayIPAddress=gatewayIPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortDisabledWarning=dataPortDisabledWarning, primaryRecovery=primaryRecovery, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, configuration=configuration, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, enableTransmission=enableTransmission)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUStatusTrap=rFUStatusTrap, diverseRfFeederLoss=diverseRfFeederLoss, vectorError=vectorError, linkNameMismatchTrap=linkNameMismatchTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, aTPCEnable=aTPCEnable, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, neighborIPAddress=neighborIPAddress, remoteMACAddress=remoteMACAddress, rFUBranchingConfiguration=rFUBranchingConfiguration, radioLicenseRegion=radioLicenseRegion, rxDiversityDataPortStatus=rxDiversityDataPortStatus, rFUVersionBank1=rFUVersionBank1, rxDiversityVid=rxDiversityVid, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rFUStatus=rFUStatus, softwareVersion=softwareVersion, rFURxFreqMin=rFURxFreqMin, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveModulation=receiveModulation, alignmentModeTrap=alignmentModeTrap, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, radioLicenseCodeRate=radioLicenseCodeRate, wirelessLinkStatus=wirelessLinkStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userPassword=userPassword, managementPortAutoNegotiation=managementPortAutoNegotiation, userTableNumber=userTableNumber, rFUTxFreqMin=rFUTxFreqMin, ethernetPriorityTableNumber=ethernetPriorityTableNumber, hTTPAccessEnabled=hTTPAccessEnabled, minCodeRate=minCodeRate, iPv6Address=iPv6Address, rFUTransceiverLocation=rFUTransceiverLocation, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFUPlatformCompatibility=rFUPlatformCompatibility, syslogStateTrap=syslogStateTrap, primaryRecoveryPeriod=primaryRecoveryPeriod, ethernetFiberSupport=ethernetFiberSupport, rFUProtectionCompatibility=rFUProtectionCompatibility, userRole=userRole, sNMPTrapPortNumber=sNMPTrapPortNumber, iPVersion=iPVersion, hardwareVersion=hardwareVersion, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rFUType=rFUType, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rFUTxPowerMin=rFUTxPowerMin, protectionStats=protectionStats, radioLicenseTxFreq=radioLicenseTxFreq, alignmentMode=alignmentMode, protectionSwitchCause=protectionSwitchCause, productName=productName, aggregateDataRate=aggregateDataRate, radioLicenseMaxEIRP=radioLicenseMaxEIRP, radioLicenseMinModulation=radioLicenseMinModulation, radioLicenseRxFreq=radioLicenseRxFreq, encryptionEnabledMismatch=encryptionEnabledMismatch, radioLicense=radioLicense, rFUTxPowerAlarm=rFUTxPowerAlarm, rFUActiveFirmwareBank=rFUActiveFirmwareBank, sNTPServerTableNumber=sNTPServerTableNumber, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rFFeederLoss=rFFeederLoss, dataPortFiberStatus=dataPortFiberStatus, protectionStateTrap=protectionStateTrap, linkNameMismatch=linkNameMismatch, sNTPPollInterval=sNTPPollInterval, siteName=siteName, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerTimeout=sNTPServerTimeout, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, ptp=ptp, managementPortConfigurationMismatch=managementPortConfigurationMismatch, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, radioLicenseBand=radioLicenseBand, productVariant=productVariant, encryptionAlgorithm=encryptionAlgorithm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, transmitPower=transmitPower, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, faultProtectionSwitching=faultProtectionSwitching, transmitCodeRate=transmitCodeRate)
