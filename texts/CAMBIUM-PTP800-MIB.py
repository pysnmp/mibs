...
iso, TimeTicks, Counter64, Integer32, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, ObjectIdentity, Unsigned32, NotificationType, Bits, Counter32, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Counter64", "Integer32", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "ObjectIdentity", "Unsigned32", "NotificationType", "Bits", "Counter32", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, sNMPPortNumber=sNMPPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, rxDiversityVid=rxDiversityVid, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ethernetPriorityTable=ethernetPriorityTable, userTableEntry=userTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rFUPowerButtonPressed=rFUPowerButtonPressed, protectionInterfaceStatus=protectionInterfaceStatus, faultProtectionSwitching=faultProtectionSwitching, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, dataPortDisabledWarning=dataPortDisabledWarning, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPLastSync=sNTPLastSync, remoteSecondaryMACAddress=remoteSecondaryMACAddress, localPacketFiltering=localPacketFiltering, rFURpsAlarm=rFURpsAlarm, transmitModulation=transmitModulation, iPv6GatewayAddress=iPv6GatewayAddress, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, userName=userName, receivePower=receivePower, wirelessLinkAvailability=wirelessLinkAvailability, sMTPEnabledMessages=sMTPEnabledMessages, qOSPriorityScheme=qOSPriorityScheme, supplementary=supplementary, sMTPServerPortNumber=sMTPServerPortNumber, diverseRfFeederLoss=diverseRfFeederLoss, radioLicenseBandwidth=radioLicenseBandwidth, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFURFSwitchAlarm=rFURFSwitchAlarm, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, vLANManagementVIDValidation=vLANManagementVIDValidation, dataPortPauseFrames=dataPortPauseFrames, transmitCodeRate=transmitCodeRate, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, systemReset=systemReset, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ptp800=ptp800, ptpTrapPrefix=ptpTrapPrefix, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, syslogClientTrap=syslogClientTrap, gatewayIPAddress=gatewayIPAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, wirelessLinkStatusTrap=wirelessLinkStatusTrap, subnetMask=subnetMask, rFUTxPowerMin=rFUTxPowerMin, protectionStatus=protectionStatus, rFUPowerAlarm=rFUPowerAlarm, radioLicenseMaxEIRP=radioLicenseMaxEIRP, phyControl=phyControl, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rFUTxFreqMin=rFUTxFreqMin, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, managementPortStatus=managementPortStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPPrimaryServer=sNTPPrimaryServer, rxDiversityDataPortStatus=rxDiversityDataPortStatus, tFTPServerIPAddress=tFTPServerIPAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, numberOfAntennas=numberOfAntennas, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rFUPlatformCompatibility=rFUPlatformCompatibility, alarms=alarms, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ptmp=ptmp, remoteInternetAddressType=remoteInternetAddressType, altitude=altitude, activeUnit=activeUnit, transmitterStatus=transmitterStatus, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, managementMode=managementMode, softwareVersion=softwareVersion, management=management, sMTPServerIPAddress=sMTPServerIPAddress, rFUProtectionCompatibility=rFUProtectionCompatibility, primaryRecoveryPeriod=primaryRecoveryPeriod, radioLicenseModulation=radioLicenseModulation, aggregateDataRate=aggregateDataRate, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rFUStatus=rFUStatus, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, managementPortWirelessDownAlert=managementPortWirelessDownAlert, reset=reset, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPServerTimeout=sNTPServerTimeout, sNTPServerInternetAddress=sNTPServerInternetAddress, activeAvailableTime=activeAvailableTime, radioLicenseMaxModulation=radioLicenseMaxModulation, sNMPTrapInternetAddress=sNMPTrapInternetAddress, vectorError=vectorError, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogClient=syslogClient, sNTPServerTableEntry=sNTPServerTableEntry, radioLicenseRegion=radioLicenseRegion, dataPortStatus=dataPortStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, mPLSTCPriorityTable=mPLSTCPriorityTable, remotePrimaryInternetAddress=remotePrimaryInternetAddress, ethernet=ethernet, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, remotePrimaryIPAddress=remotePrimaryIPAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNMPCommunityString=sNMPCommunityString, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rFUTransceiverLocation=rFUTransceiverLocation, secondarySoftwareVersion=secondarySoftwareVersion, iPv6PrefixLength=iPv6PrefixLength, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, syslogStateTrap=syslogStateTrap, snmpControl=snmpControl, userTableIndex=userTableIndex, alignmentModeTrap=alignmentModeTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, secureModeAlarm=secureModeAlarm, linkLoss=linkLoss, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, minCodeRate=minCodeRate, rFUBranchingConfiguration=rFUBranchingConfiguration, diverseAntennaGain=diverseAntennaGain, syslogState=syslogState, managementPortStatusTrap=managementPortStatusTrap, endId=endId, protection=protection, telnetAccessEnabled=telnetAccessEnabled, radioLicenseTxFreq=radioLicenseTxFreq, versions=versions, radioLicenseMinModulation=radioLicenseMinModulation, ptpTraps=ptpTraps, hTTPSPortNumber=hTTPSPortNumber, neighborIPAddress=neighborIPAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, linkName=linkName, sntp=sntp, cambium=cambium, sNMPTrapTableIndex=sNMPTrapTableIndex, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, remoteIPAddress=remoteIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, productVariant=productVariant, rFUStatusTrap=rFUStatusTrap, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, activeWirelessLinkAvailability=activeWirelessLinkAvailability, maxCodeRate=maxCodeRate, transmitCapacityLimitDetail=transmitCapacityLimitDetail, latitude=latitude, rFURxFreqMax=rFURxFreqMax, radioLicenseBand=radioLicenseBand, sNMPTrapTable=sNMPTrapTable, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, linkNameMismatch=linkNameMismatch, ethernetPriorityTableEntry=ethernetPriorityTableEntry, linkNameMismatchTrap=linkNameMismatchTrap, managementPortAutoNegotiation=managementPortAutoNegotiation, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapTableEntry=sNMPTrapTableEntry, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, pubStats=pubStats, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, sNTPSync=sNTPSync, transmitCapacityLimit=transmitCapacityLimit, sNTPServerIPAddress=sNTPServerIPAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, primarySecondaryMode=primarySecondaryMode, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFUSerial=rFUSerial, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, maxModulation=maxModulation, neighborMACAddress=neighborMACAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUVersionBank2=rFUVersionBank2, userPassword=userPassword, fiberY=fiberY, protectionSwitchCause=protectionSwitchCause, userTable=userTable, licence=licence, encryptionEnabledMismatch=encryptionEnabledMismatch, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, syslogControl=syslogControl, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, transmitPower=transmitPower, useVLANForManagementInterfaces=useVLANForManagementInterfaces, enableTransmission=enableTransmission, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, encryption=encryption, systemClock=systemClock, iPVersion=iPVersion, timeZone=timeZone, sMTPSourceEmailAddress=sMTPSourceEmailAddress, remoteMACAddress=remoteMACAddress, vLANManagementPriority=vLANManagementPriority, sMTPServerInternetAddress=sMTPServerInternetAddress, hTTPAccessEnabled=hTTPAccessEnabled, protectionAvailabilityStatus=protectionAvailabilityStatus, receiveModulation=receiveModulation, rFUTxPowerMax=rFUTxPowerMax, rFUType=rFUType, vLANManagementVID=vLANManagementVID, receiveDataRate=receiveDataRate, rFUVersionBank1=rFUVersionBank1, sNTPServerTableNumber=sNTPServerTableNumber, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rFULockoutAlarm=rFULockoutAlarm, managementPortForcedConfiguration=managementPortForcedConfiguration, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, hTTPPortNumber=hTTPPortNumber, userRole=userRole, phyStatus=phyStatus, radioLicense=radioLicense, sNMPTrapVersion=sNMPTrapVersion, wirelessLinkStatus=wirelessLinkStatus, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, rFUFreqSpacing=rFUFreqSpacing, productName=productName, alignmentMode=alignmentMode, rxDiversityVlanTpid=rxDiversityVlanTpid, managementPortDisabledWarning=managementPortDisabledWarning, siteName=siteName, rFURfBand=rFURfBand, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, sNTPServerRetries=sNTPServerRetries, maximumTransmitPower=maximumTransmitPower, requestedProtectionState=requestedProtectionState, hTTPSAccessEnabled=hTTPSAccessEnabled, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, ethernetFiberSupport=ethernetFiberSupport)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sNTPPollInterval=sNTPPollInterval, receiveCodeRate=receiveCodeRate, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, sNTPServerTable=sNTPServerTable, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, dataPortStatusTrap=dataPortStatusTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, encryptionAlgorithm=encryptionAlgorithm, protectionStateTrap=protectionStateTrap, smtp=smtp, iFCableLength=iFCableLength, remoteSecondaryIPAddress=remoteSecondaryIPAddress, minModulation=minModulation, iPv6Address=iPv6Address, neighborInternetAddressType=neighborInternetAddressType, antennaGain=antennaGain, protectionConfigurationStatus=protectionConfigurationStatus, configuration=configuration, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, unitOutOfCalibration=unitOutOfCalibration, sNTPServerTableIndex=sNTPServerTableIndex, hardwareVersion=hardwareVersion, neighborInternetAddress=neighborInternetAddress, telnetPortNumber=telnetPortNumber, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, iPv4Address=iPv4Address, sNMPTrapTableNumber=sNMPTrapTableNumber, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, radioLicenseMinCodeRate=radioLicenseMinCodeRate, sNTPSyncTrap=sNTPSyncTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, tFTPServerPortNumber=tFTPServerPortNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, remoteInternetAddress=remoteInternetAddress, dataPortFiberStatus=dataPortFiberStatus, radioLicenseCodeRate=radioLicenseCodeRate, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, aAAControl=aAAControl, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPServerResponse=sNTPServerResponse, rFURxFreqMin=rFURxFreqMin, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userEnabled=userEnabled, remotePrimaryMACAddress=remotePrimaryMACAddress, l2CPPriorityTable=l2CPPriorityTable, aTPCEnable=aTPCEnable, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, primaryRecovery=primaryRecovery, protectionState=protectionState, transmitDataRate=transmitDataRate, rFUTxFreqMax=rFUTxFreqMax, rFUTxMuteStatus=rFUTxMuteStatus, rFUConnectedPlatform=rFUConnectedPlatform, ethernetPriorityTableIndex=ethernetPriorityTableIndex, protectionStats=protectionStats, userTableNumber=userTableNumber, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rfu=rfu, managementCommittedInformationRate=managementCommittedInformationRate, bridge=bridge, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, securityLevel=securityLevel, daylightSaving=daylightSaving, rFUTxBandAboveRx=rFUTxBandAboveRx, radioLicenseIdentifier=radioLicenseIdentifier, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerInternetAddress=tFTPServerInternetAddress, ptp=ptp, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, longitude=longitude, transmitCapacity=transmitCapacity, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, sNTPState=sNTPState, bootVersion=bootVersion, radioLicenseRxFreq=radioLicenseRxFreq, rFUCableAlarm=rFUCableAlarm, rFUTxPowerAlarm=rFUTxPowerAlarm, secureModeAlarmTrap=secureModeAlarmTrap, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFFeederLoss=rFFeederLoss, protectionConfig=protectionConfig)
