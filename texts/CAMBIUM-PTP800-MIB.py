...
Gauge32, iso, enterprises, ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, TimeTicks, NotificationType, Unsigned32, Integer32, ObjectIdentity, MibIdentifier, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "enterprises", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "TimeTicks", "NotificationType", "Unsigned32", "Integer32", "ObjectIdentity", "MibIdentifier", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNTPLastSync=sNTPLastSync, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, longitude=longitude, secureModeAlarmTrap=secureModeAlarmTrap, qOSPriorityScheme=qOSPriorityScheme, configuration=configuration, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, versions=versions, snmpControl=snmpControl, linkNameMismatch=linkNameMismatch, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rFUProtectionCompatibility=rFUProtectionCompatibility, rFUVersionBank1=rFUVersionBank1, sMTPServerInternetAddressType=sMTPServerInternetAddressType, neighborIPAddress=neighborIPAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, bootVersion=bootVersion, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, userTable=userTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rFUTxPowerMin=rFUTxPowerMin, transmitDataRate=transmitDataRate, protectionStateTrap=protectionStateTrap, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, transmitterStatus=transmitterStatus, radioLicenseMaxModulation=radioLicenseMaxModulation, managementPortAutoNegotiation=managementPortAutoNegotiation, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, activeWirelessLinkAvailability=activeWirelessLinkAvailability, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, reset=reset, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortPauseFrames=dataPortPauseFrames, rFUPowerAlarm=rFUPowerAlarm, rFURfBand=rFURfBand, radioLicenseModulation=radioLicenseModulation, protection=protection, sNMPPortNumber=sNMPPortNumber, dSCPManagementPriority=dSCPManagementPriority, remoteIPAddress=remoteIPAddress, ptp800=ptp800, activeAvailableTime=activeAvailableTime, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rFUTxPowerMax=rFUTxPowerMax, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, sNTPServerPortNumber=sNTPServerPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, sNTPServerTimeout=sNTPServerTimeout, sNTPSyncTrap=sNTPSyncTrap, productName=productName, rFUStatusTrap=rFUStatusTrap, sNTPPrimaryServer=sNTPPrimaryServer, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, iPv6Address=iPv6Address, rFUActiveFirmwareBank=rFUActiveFirmwareBank, primaryRecoveryPeriod=primaryRecoveryPeriod, iPv6GatewayAddress=iPv6GatewayAddress, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, hardwareVersion=hardwareVersion, wirelessLinkStatusTrap=wirelessLinkStatusTrap, neighborInternetAddressType=neighborInternetAddressType, ptmp=ptmp, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveCodeRate=receiveCodeRate, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, linkLoss=linkLoss, rFUStatus=rFUStatus, ptp=ptp, supplementary=supplementary, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPCommunityString=sNMPCommunityString, radioLicenseRegion=radioLicenseRegion, protectionAvailabilityStatus=protectionAvailabilityStatus, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, phyStatus=phyStatus, rFUPlatformCompatibility=rFUPlatformCompatibility, tFTPServerInternetAddress=tFTPServerInternetAddress, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, encryptionEnabledMismatch=encryptionEnabledMismatch, radioLicenseRxFreq=radioLicenseRxFreq, sNMPTrapTable=sNMPTrapTable, radioLicenseBand=radioLicenseBand, transmitCodeRate=transmitCodeRate, rFULockoutAlarm=rFULockoutAlarm, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sMTPEnabledMessages=sMTPEnabledMessages, rfu=rfu, vLANManagementVID=vLANManagementVID, smtp=smtp, transmitCapacityLimitDetail=transmitCapacityLimitDetail, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, minModulation=minModulation, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, protectionStats=protectionStats, dataPortStatus=dataPortStatus, ptpTraps=ptpTraps, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, neighborInternetAddress=neighborInternetAddress, protectionInterfaceStatus=protectionInterfaceStatus, enableTransmission=enableTransmission, receivePower=receivePower, rFUTransceiverLocation=rFUTransceiverLocation, managementCommittedInformationRate=managementCommittedInformationRate, alarms=alarms, ethernetPriorityTableIndex=ethernetPriorityTableIndex, encryption=encryption, transmitPower=transmitPower, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, systemClock=systemClock, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPServerRetries=sNTPServerRetries, endId=endId, remoteSecondaryMACAddress=remoteSecondaryMACAddress, remotePrimarySecondaryMode=remotePrimarySecondaryMode, sNMPTrapVersion=sNMPTrapVersion, protectionConfigurationStatus=protectionConfigurationStatus, remotePrimaryInternetAddress=remotePrimaryInternetAddress, primaryRecovery=primaryRecovery, alignmentMode=alignmentMode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, subnetMask=subnetMask, sMTPSourceEmailAddress=sMTPSourceEmailAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPServerInternetAddressType=sNTPServerInternetAddressType, linkNameMismatchTrap=linkNameMismatchTrap, userEnabled=userEnabled, securityLevel=securityLevel, rFUFreqSpacing=rFUFreqSpacing, ethernetFiberSupport=ethernetFiberSupport, pubStats=pubStats, sNTPServerTableNumber=sNTPServerTableNumber, rFFeederLoss=rFFeederLoss, telnetAccessEnabled=telnetAccessEnabled, userTableEntry=userTableEntry, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, gatewayIPAddress=gatewayIPAddress, rFUVersionBank2=rFUVersionBank2, transmitCapacity=transmitCapacity, protectionState=protectionState, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ethernetPriorityTable=ethernetPriorityTable, altitude=altitude, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapPortNumber=sNMPTrapPortNumber, rFUConnectedPlatform=rFUConnectedPlatform, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, sNTPServerTableIndex=sNTPServerTableIndex, dataPortFiberStatusTrap=dataPortFiberStatusTrap, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, fiberY=fiberY, userName=userName, maxCodeRate=maxCodeRate, sNMPTrapTableIndex=sNMPTrapTableIndex, hTTPSPortNumber=hTTPSPortNumber, iPVersion=iPVersion, sMTPServerPortNumber=sMTPServerPortNumber, sntp=sntp, radioLicenseMaxEIRP=radioLicenseMaxEIRP, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, ptpTrapPrefix=ptpTrapPrefix, linkName=linkName, sNTPServerTableEntry=sNTPServerTableEntry, minCodeRate=minCodeRate, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, syslogStateTrap=syslogStateTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, mPLSTCPriorityTable=mPLSTCPriorityTable, remoteSecondaryIPAddress=remoteSecondaryIPAddress, remotePrimaryIPAddress=remotePrimaryIPAddress, wirelessLinkStatus=wirelessLinkStatus, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, syslogClientTrap=syslogClientTrap, managementPortDisabledWarning=managementPortDisabledWarning, systemReset=systemReset, management=management, unitOutOfCalibration=unitOutOfCalibration, transmitCapacityLimit=transmitCapacityLimit, managementPortForcedConfiguration=managementPortForcedConfiguration, vectorError=vectorError, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, hTTPSAccessEnabled=hTTPSAccessEnabled, numberOfAntennas=numberOfAntennas, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, faultProtectionSwitching=faultProtectionSwitching, rFURFSwitchAlarm=rFURFSwitchAlarm, receiveModulation=receiveModulation, daylightSaving=daylightSaving, radioLicenseTxFreq=radioLicenseTxFreq, syslogClient=syslogClient, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUTxMuteStatus=rFUTxMuteStatus, rFUBranchingConfiguration=rFUBranchingConfiguration, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, userTableNumber=userTableNumber, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, dataPortStatusTrap=dataPortStatusTrap, antennaGain=antennaGain, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, radioLicenseBandwidth=radioLicenseBandwidth, softwareVersion=softwareVersion, encryptionAlgorithm=encryptionAlgorithm, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userRole=userRole, maximumTransmitPower=maximumTransmitPower, sNMPTrapTableEntry=sNMPTrapTableEntry, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, radioLicenseIdentifier=radioLicenseIdentifier, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, primarySecondaryMode=primarySecondaryMode, rFUTxFreqMin=rFUTxFreqMin, requestedProtectionState=requestedProtectionState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPState=sNTPState, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, userTableIndex=userTableIndex, transmitModulation=transmitModulation, rFUType=rFUType, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, aTPCEnable=aTPCEnable, sNTPServerIPAddress=sNTPServerIPAddress, aggregateDataRate=aggregateDataRate, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, cambium=cambium, remoteInternetAddressType=remoteInternetAddressType, remoteInternetAddress=remoteInternetAddress, iFCableLength=iFCableLength, rxDiversityDataPortStatus=rxDiversityDataPortStatus, latitude=latitude)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNTPServerResponse=sNTPServerResponse, remotePrimaryMACAddress=remotePrimaryMACAddress, syslogState=syslogState, localPacketFiltering=localPacketFiltering, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNTPSync=sNTPSync, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, radioLicenseCodeRate=radioLicenseCodeRate, sMTPEmailAlert=sMTPEmailAlert, receiveDataRate=receiveDataRate, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, radioLicenseMinCodeRate=radioLicenseMinCodeRate, iPv6PrefixLength=iPv6PrefixLength, diverseAntennaGain=diverseAntennaGain, alignmentModeTrap=alignmentModeTrap, managementPortStatus=managementPortStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, protectionStatus=protectionStatus, tFTPServerIPAddress=tFTPServerIPAddress, iPv4Address=iPv4Address, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, aAAControl=aAAControl, dataPortDisabledWarning=dataPortDisabledWarning, vLANManagementPriority=vLANManagementPriority, siteName=siteName, rFURxFreqMax=rFURxFreqMax, sNMPEnabledTraps=sNMPEnabledTraps, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rFURxFreqMin=rFURxFreqMin, hTTPAccessEnabled=hTTPAccessEnabled, ethernet=ethernet, userPassword=userPassword, rxDiversityVid=rxDiversityVid, rFUPowerButtonPressed=rFUPowerButtonPressed, diverseRfFeederLoss=diverseRfFeederLoss, telnetPortNumber=telnetPortNumber, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, tFTPServerPortNumber=tFTPServerPortNumber, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, dataPortFiberStatus=dataPortFiberStatus, rFUTxPowerAlarm=rFUTxPowerAlarm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, neighborMACAddress=neighborMACAddress, secondarySoftwareVersion=secondarySoftwareVersion, activeUnit=activeUnit, sNTPPollInterval=sNTPPollInterval, l2CPPriorityTableEntry=l2CPPriorityTableEntry, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPServerInternetAddress=sNTPServerInternetAddress, managementPortStatusTrap=managementPortStatusTrap, rFUSerial=rFUSerial, l2CPPriorityTable=l2CPPriorityTable, radioLicense=radioLicense, bridge=bridge, productVariant=productVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, secureModeAlarm=secureModeAlarm, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, timeZone=timeZone, protectionConfig=protectionConfig, maxModulation=maxModulation, vLANManagementVIDValidation=vLANManagementVIDValidation, phyControl=phyControl, hTTPPortNumber=hTTPPortNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, rFUTxBandAboveRx=rFUTxBandAboveRx, radioLicenseMinModulation=radioLicenseMinModulation, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, syslogControl=syslogControl, sNTPServerTable=sNTPServerTable, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, remoteMACAddress=remoteMACAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rxDiversityVlanTpid=rxDiversityVlanTpid, rFUCableAlarm=rFUCableAlarm, rFUTxFreqMax=rFUTxFreqMax, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapTableNumber=sNMPTrapTableNumber, licence=licence, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, protectionSwitchCause=protectionSwitchCause, rFURpsAlarm=rFURpsAlarm, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, managementMode=managementMode)
