...
IpAddress, NotificationType, Gauge32, TimeTicks, Unsigned32, Counter64, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, MibIdentifier, ModuleIdentity, Integer32, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "Gauge32", "TimeTicks", "Unsigned32", "Counter64", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Integer32", "enterprises", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", minModulation=minModulation, transmitCodeRate=transmitCodeRate, fiberY=fiberY, managementPortAutoNegotiation=managementPortAutoNegotiation, syslogStateTrap=syslogStateTrap, rFURpsAlarm=rFURpsAlarm, syslogClient=syslogClient, protection=protection, numberOfAntennas=numberOfAntennas, radioLicenseCodeRate=radioLicenseCodeRate, snmpControl=snmpControl, qOSPriorityScheme=qOSPriorityScheme, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, linkNameMismatch=linkNameMismatch, rFUTransceiverLocation=rFUTransceiverLocation, primarySecondaryMode=primarySecondaryMode, rFUTxPowerAlarm=rFUTxPowerAlarm, rFUTxMuteStatus=rFUTxMuteStatus, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, ptp=ptp, rFUProtectionCompatibility=rFUProtectionCompatibility, primaryRecovery=primaryRecovery, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, aggregateDataRate=aggregateDataRate, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPPortNumber=sNMPPortNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, longitude=longitude, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, productVariant=productVariant, maxCodeRate=maxCodeRate, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, ethernet=ethernet, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, managementPortForcedConfiguration=managementPortForcedConfiguration, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, gatewayIPAddress=gatewayIPAddress, ethernetPriorityTable=ethernetPriorityTable, rFURxFreqMax=rFURxFreqMax, remotePrimaryIPAddress=remotePrimaryIPAddress, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, protectionAvailabilityStatus=protectionAvailabilityStatus, smtp=smtp, secondarySoftwareVersion=secondarySoftwareVersion, antennaGain=antennaGain, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementPortDisabledWarning=managementPortDisabledWarning, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, linkName=linkName, rFUStatusTrap=rFUStatusTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, secureModeAlarmTrap=secureModeAlarmTrap, userTableEntry=userTableEntry, transmitCapacity=transmitCapacity, protectionConfigurationStatus=protectionConfigurationStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, siteName=siteName, neighborInternetAddress=neighborInternetAddress, bootVersion=bootVersion, licence=licence, sNTPServerPortNumber=sNTPServerPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, maximumTransmitPower=maximumTransmitPower, productName=productName, transmitModulation=transmitModulation, protectionState=protectionState, iPVersion=iPVersion, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, radioLicenseIdentifier=radioLicenseIdentifier, rFURfBand=rFURfBand, activeUnit=activeUnit, hTTPSAccessEnabled=hTTPSAccessEnabled, localPacketFiltering=localPacketFiltering, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rFUVersionBank2=rFUVersionBank2, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, unitOutOfCalibration=unitOutOfCalibration, radioLicenseBandwidth=radioLicenseBandwidth, managementCommittedInformationRate=managementCommittedInformationRate, wirelessLinkStatus=wirelessLinkStatus, remoteSecondaryIPAddress=remoteSecondaryIPAddress, dataPortStatusTrap=dataPortStatusTrap, rFUTxPowerMax=rFUTxPowerMax, aAAControl=aAAControl, rFUPowerAlarm=rFUPowerAlarm, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, encryptionEnabledMismatch=encryptionEnabledMismatch, rFUCableAlarm=rFUCableAlarm, diverseRfFeederLoss=diverseRfFeederLoss, receiveCodeRate=receiveCodeRate, radioLicenseTxFreq=radioLicenseTxFreq, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFUTxFreqMin=rFUTxFreqMin, vectorError=vectorError, rFURxFreqMin=rFURxFreqMin, phyStatus=phyStatus, rFUFreqSpacing=rFUFreqSpacing, rFUPlatformCompatibility=rFUPlatformCompatibility, alignmentMode=alignmentMode, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, tFTPServerPortNumber=tFTPServerPortNumber, pubStats=pubStats, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userPassword=userPassword, ptp800=ptp800, radioLicenseMinCodeRate=radioLicenseMinCodeRate, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, userEnabled=userEnabled, vLANManagementVID=vLANManagementVID, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, endId=endId, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPv4Address=iPv4Address, vLANManagementPriority=vLANManagementPriority, rFUStatus=rFUStatus, sNMPTrapVersion=sNMPTrapVersion, remotePrimarySecondaryMode=remotePrimarySecondaryMode, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, syslogControl=syslogControl, ptpTrapPrefix=ptpTrapPrefix, primaryRecoveryPeriod=primaryRecoveryPeriod, remoteInternetAddressType=remoteInternetAddressType, sMTPEnabledMessages=sMTPEnabledMessages, rxDiversityDataPortStatus=rxDiversityDataPortStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, transmitCapacityLimitDetail=transmitCapacityLimitDetail, maxModulation=maxModulation, sNMPTrapTableNumber=sNMPTrapTableNumber, userName=userName, sNTPSync=sNTPSync, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapTable=sNMPTrapTable, ptpTraps=ptpTraps, radioLicense=radioLicense, sNTPServerTableEntry=sNTPServerTableEntry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receivePower=receivePower, mPLSTCPriorityTable=mPLSTCPriorityTable, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, remoteInternetAddress=remoteInternetAddress, securityLevel=securityLevel, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rFUActiveFirmwareBank=rFUActiveFirmwareBank, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, neighborIPAddress=neighborIPAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, rFUType=rFUType, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, diverseAntennaGain=diverseAntennaGain, sNMPTrapTableIndex=sNMPTrapTableIndex, activeAvailableTime=activeAvailableTime, sNTPServerTimeout=sNTPServerTimeout, radioLicenseRxFreq=radioLicenseRxFreq, rFUConnectedPlatform=rFUConnectedPlatform, managementPortStatusTrap=managementPortStatusTrap, telnetAccessEnabled=telnetAccessEnabled, dataPortPauseFrames=dataPortPauseFrames, remotePrimaryInternetAddress=remotePrimaryInternetAddress, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rfu=rfu, minCodeRate=minCodeRate, rFUTxPowerMin=rFUTxPowerMin, sMTPServerPortNumber=sMTPServerPortNumber, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rFUBranchingConfiguration=rFUBranchingConfiguration, phyControl=phyControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteMACAddress=remoteMACAddress, wirelessLinkAvailability=wirelessLinkAvailability, systemReset=systemReset, requestedProtectionState=requestedProtectionState, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, bridge=bridge, userTableIndex=userTableIndex, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, latitude=latitude, rFUTxFreqMax=rFUTxFreqMax, protectionConfig=protectionConfig, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, cambium=cambium, remoteIPAddress=remoteIPAddress, userRole=userRole, radioLicenseMinModulation=radioLicenseMinModulation, receiveDataRate=receiveDataRate, sNTPServerTableIndex=sNTPServerTableIndex, iPDSCPPriorityTable=iPDSCPPriorityTable, syslogState=syslogState, iFCableLength=iFCableLength, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, encryption=encryption, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rxDiversityVlanTpid=rxDiversityVlanTpid, neighborInternetAddressType=neighborInternetAddressType, hTTPPortNumber=hTTPPortNumber, systemClock=systemClock, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, radioLicenseBand=radioLicenseBand, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, dataPortDisabledWarning=dataPortDisabledWarning, faultProtectionSwitching=faultProtectionSwitching, userTable=userTable, remotePrimaryMACAddress=remotePrimaryMACAddress, ptmp=ptmp, managementMode=managementMode, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, alarms=alarms, rxDiversityVid=rxDiversityVid, supplementary=supplementary, linkNameMismatchTrap=linkNameMismatchTrap, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, aTPCEnable=aTPCEnable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, tFTPServerIPAddress=tFTPServerIPAddress, configuration=configuration, dSCPManagementPriority=dSCPManagementPriority, enableTransmission=enableTransmission, ethernetFiberSupport=ethernetFiberSupport, hardwareVersion=hardwareVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, transmitterStatus=transmitterStatus, protectionSwitchCause=protectionSwitchCause, sNTPPollInterval=sNTPPollInterval, subnetMask=subnetMask, managementPortConfigurationMismatch=managementPortConfigurationMismatch, radioLicenseModulation=radioLicenseModulation, protectionStats=protectionStats, neighborMACAddress=neighborMACAddress, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", userTableNumber=userTableNumber, softwareVersion=softwareVersion, dataPortConfigurationMismatch=dataPortConfigurationMismatch, iPv6GatewayAddress=iPv6GatewayAddress, altitude=altitude, linkLoss=linkLoss, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, syslogClientTrap=syslogClientTrap, radioLicenseRegion=radioLicenseRegion, rFFeederLoss=rFFeederLoss, rFUSerial=rFUSerial, l2CPPriorityTable=l2CPPriorityTable, dataPortFiberStatus=dataPortFiberStatus, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPServerIPAddress=sNTPServerIPAddress, management=management, sNMPCommunityString=sNMPCommunityString, iPv6PrefixLength=iPv6PrefixLength, sNTPServerResponse=sNTPServerResponse, syslogLocalWrappedTrap=syslogLocalWrappedTrap, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rFUPowerButtonPressed=rFUPowerButtonPressed, vLANManagementVIDValidation=vLANManagementVIDValidation, sMTPServerInternetAddress=sMTPServerInternetAddress, transmitDataRate=transmitDataRate, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, protectionInterfaceStatus=protectionInterfaceStatus, transmitPower=transmitPower, sNTPPrimaryServer=sNTPPrimaryServer, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, telnetPortNumber=telnetPortNumber, sNTPState=sNTPState, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, versions=versions, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, timeZone=timeZone, reset=reset, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, radioLicenseMaxModulation=radioLicenseMaxModulation, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUTxBandAboveRx=rFUTxBandAboveRx, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerTable=sNTPServerTable, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dataPortStatus=dataPortStatus, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, receiveModulation=receiveModulation, sNTPLastSync=sNTPLastSync, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, daylightSaving=daylightSaving, protectionStateTrap=protectionStateTrap, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, managementPortStatus=managementPortStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, transmitCapacityLimit=transmitCapacityLimit, encryptionAlgorithm=encryptionAlgorithm, iPv6Address=iPv6Address, sntp=sntp, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, secureModeAlarm=secureModeAlarm, hTTPSPortNumber=hTTPSPortNumber, protectionStatus=protectionStatus, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rFULockoutAlarm=rFULockoutAlarm, alignmentModeTrap=alignmentModeTrap, rFUVersionBank1=rFUVersionBank1, activeWirelessLinkAvailability=activeWirelessLinkAvailability, sNTPServerTableNumber=sNTPServerTableNumber, rFURFSwitchAlarm=rFURFSwitchAlarm, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNTPServerRetries=sNTPServerRetries, ethernetPriorityTableEntry=ethernetPriorityTableEntry, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress)
