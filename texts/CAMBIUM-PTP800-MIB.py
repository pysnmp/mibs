...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFULockoutAlarm=rFULockoutAlarm, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, userRole=userRole, ethernetFiberSupport=ethernetFiberSupport, l2CPPriorityTableNumber=l2CPPriorityTableNumber, userTableNumber=userTableNumber, radioLicenseIdentifier=radioLicenseIdentifier, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rFUTxFreqMin=rFUTxFreqMin, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, rFUSerial=rFUSerial, managementPortDisabledWarning=managementPortDisabledWarning, securityLevel=securityLevel, endId=endId, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapTableNumber=sNMPTrapTableNumber, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, diverseAntennaGain=diverseAntennaGain, phyStatus=phyStatus, protectionSwitchCause=protectionSwitchCause, sNTPServerTable=sNTPServerTable, rFUFreqSpacing=rFUFreqSpacing, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, primaryRecovery=primaryRecovery, rFUType=rFUType, telnetAccessEnabled=telnetAccessEnabled, productVariant=productVariant, activeWirelessLinkAvailability=activeWirelessLinkAvailability, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerPortNumber=sMTPServerPortNumber, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, bridge=bridge, wirelessLinkAvailability=wirelessLinkAvailability, rxDiversityVid=rxDiversityVid, receiveModulation=receiveModulation, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, snmpControl=snmpControl, radioLicenseRegion=radioLicenseRegion, wirelessLinkStatus=wirelessLinkStatus, sNTPServerTableEntry=sNTPServerTableEntry, transmitCodeRate=transmitCodeRate, rFUTransceiverLocation=rFUTransceiverLocation, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, daylightSaving=daylightSaving, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, protection=protection, bootVersion=bootVersion, transmitModulation=transmitModulation, minCodeRate=minCodeRate, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, ptpTraps=ptpTraps, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rFUStatus=rFUStatus, protectionConfigurationStatus=protectionConfigurationStatus, managementCommittedInformationRate=managementCommittedInformationRate, aTPCEnable=aTPCEnable, userTableIndex=userTableIndex, mPLSTCPriorityTable=mPLSTCPriorityTable, vLANManagementVIDValidation=vLANManagementVIDValidation, sNTPServerRetries=sNTPServerRetries, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, radioLicenseCodeRate=radioLicenseCodeRate, transmitCapacityLimit=transmitCapacityLimit, rFURFSwitchAlarm=rFURFSwitchAlarm, maxModulation=maxModulation, sntp=sntp, neighborInternetAddress=neighborInternetAddress, rFUTxBandAboveRx=rFUTxBandAboveRx, dataPortPauseFrames=dataPortPauseFrames, managementMode=managementMode, sNTPPollInterval=sNTPPollInterval, linkLoss=linkLoss, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, sMTPSourceEmailAddress=sMTPSourceEmailAddress, management=management, cambium=cambium, sMTPEnabledMessages=sMTPEnabledMessages, neighborIPAddress=neighborIPAddress, vLANManagementVID=vLANManagementVID, rFUTxFreqMax=rFUTxFreqMax, reset=reset, siteName=siteName, userName=userName, sNMPTrapInternetAddress=sNMPTrapInternetAddress, iPVersion=iPVersion, remotePrimarySecondaryMode=remotePrimarySecondaryMode, supplementary=supplementary, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPState=sNTPState, userEnabled=userEnabled, aggregateDataRate=aggregateDataRate, syslogClient=syslogClient, l2CPPriorityTable=l2CPPriorityTable, userTableEntry=userTableEntry, phyControl=phyControl, maxCodeRate=maxCodeRate, ptpTrapPrefix=ptpTrapPrefix, maximumTransmitPower=maximumTransmitPower, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rFUPlatformCompatibility=rFUPlatformCompatibility, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, radioLicenseMaxModulation=radioLicenseMaxModulation, telnetPortNumber=telnetPortNumber, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, sNTPServerResponse=sNTPServerResponse, rFUPowerAlarm=rFUPowerAlarm, activeUnit=activeUnit, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogClientTrap=syslogClientTrap, managementPortStatus=managementPortStatus, syslogControl=syslogControl, vLANManagementPriority=vLANManagementPriority, managementPortAutoNegotiation=managementPortAutoNegotiation, diverseRfFeederLoss=diverseRfFeederLoss, sNTPServerTimeout=sNTPServerTimeout, sNTPServerInternetAddress=sNTPServerInternetAddress, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapTable=sNMPTrapTable, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, remoteInternetAddress=remoteInternetAddress, sNTPLastSync=sNTPLastSync, faultProtectionSwitching=faultProtectionSwitching, versions=versions, activeAvailableTime=activeAvailableTime, rFURxFreqMin=rFURxFreqMin, neighborMACAddress=neighborMACAddress, alignmentModeTrap=alignmentModeTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFUConnectedPlatform=rFUConnectedPlatform, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, enableTransmission=enableTransmission, sNMPEnabledTraps=sNMPEnabledTraps, licence=licence, protectionConfig=protectionConfig, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, iPv6PrefixLength=iPv6PrefixLength, sNMPTrapIPAddress=sNMPTrapIPAddress, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, tFTPServerInternetAddress=tFTPServerInternetAddress, tFTPServerIPAddress=tFTPServerIPAddress, primarySecondaryMode=primarySecondaryMode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rxDiversityVlanTpid=rxDiversityVlanTpid, remoteIPAddress=remoteIPAddress, linkNameMismatchTrap=linkNameMismatchTrap, tFTPServerPortNumber=tFTPServerPortNumber, ethernetPriorityTable=ethernetPriorityTable, protectionState=protectionState, remoteMACAddress=remoteMACAddress, alignmentMode=alignmentMode, wirelessLinkStatusTrap=wirelessLinkStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, transmitPower=transmitPower, rFURfBand=rFURfBand, transmitDataRate=transmitDataRate, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, neighborInternetAddressType=neighborInternetAddressType, sMTPEmailAlert=sMTPEmailAlert, remoteSecondaryMACAddress=remoteSecondaryMACAddress, radioLicenseTxFreq=radioLicenseTxFreq, protectionStatus=protectionStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, rFUProtectionCompatibility=rFUProtectionCompatibility, receivePower=receivePower, tFTPServerInternetAddressType=tFTPServerInternetAddressType, minModulation=minModulation, systemReset=systemReset, rxDiversityDataPortStatus=rxDiversityDataPortStatus, configuration=configuration, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rFUActiveFirmwareBank=rFUActiveFirmwareBank, radioLicenseMaxEIRP=radioLicenseMaxEIRP, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPServerIPAddress=sMTPServerIPAddress, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, managementPortStatusTrap=managementPortStatusTrap, rFURpsAlarm=rFURpsAlarm, timeZone=timeZone, protectionStats=protectionStats, radioLicenseMinModulation=radioLicenseMinModulation, antennaGain=antennaGain, hTTPSPortNumber=hTTPSPortNumber, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, hTTPAccessEnabled=hTTPAccessEnabled, fiberY=fiberY, sNTPSyncTrap=sNTPSyncTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ptmp=ptmp, sNTPPrimaryServer=sNTPPrimaryServer, dataPortStatus=dataPortStatus, rFUPowerButtonPressed=rFUPowerButtonPressed, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, transmitCapacity=transmitCapacity, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, radioLicenseRxFreq=radioLicenseRxFreq, rFUVersionBank1=rFUVersionBank1, remotePrimaryInternetAddress=remotePrimaryInternetAddress, userTable=userTable, numberOfAntennas=numberOfAntennas, dataPortDisabledWarning=dataPortDisabledWarning, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, requestedProtectionState=requestedProtectionState, ptp=ptp, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, managementPortForcedConfiguration=managementPortForcedConfiguration, systemClock=systemClock, sNTPServerIPAddress=sNTPServerIPAddress, unitOutOfCalibration=unitOutOfCalibration, sNMPPortNumber=sNMPPortNumber, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, alarms=alarms, sNMPTrapVersion=sNMPTrapVersion, hTTPPortNumber=hTTPPortNumber, aAAControl=aAAControl, dSCPManagementPriority=dSCPManagementPriority, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFFeederLoss=rFFeederLoss, smtp=smtp, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, radioLicenseBand=radioLicenseBand, secondarySoftwareVersion=secondarySoftwareVersion, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rFUTxPowerMin=rFUTxPowerMin, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, linkNameMismatch=linkNameMismatch, radioLicenseMinCodeRate=radioLicenseMinCodeRate)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", ethernetPriorityTableIndex=ethernetPriorityTableIndex, radioLicenseModulation=radioLicenseModulation, protectionStateTrap=protectionStateTrap, secureModeAlarmTrap=secureModeAlarmTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rFUTxMuteStatus=rFUTxMuteStatus, receiveCodeRate=receiveCodeRate, syslogState=syslogState, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, userPassword=userPassword, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, protectionInterfaceStatus=protectionInterfaceStatus, secureModeAlarm=secureModeAlarm, remoteInternetAddressType=remoteInternetAddressType, encryptionEnabledMismatch=encryptionEnabledMismatch, altitude=altitude, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, ptp800=ptp800, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkName=linkName, rFUBranchingConfiguration=rFUBranchingConfiguration, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, protectionAvailabilityStatus=protectionAvailabilityStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rFUTxPowerAlarm=rFUTxPowerAlarm, hardwareVersion=hardwareVersion, iFCableLength=iFCableLength, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, syslogStateTrap=syslogStateTrap, dataPortStatusTrap=dataPortStatusTrap, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rFUStatusTrap=rFUStatusTrap, softwareVersion=softwareVersion, iPv6Address=iPv6Address, sNTPServerPortNumber=sNTPServerPortNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, remoteSecondaryIPAddress=remoteSecondaryIPAddress, transmitterStatus=transmitterStatus, pubStats=pubStats, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, rFUTxPowerMax=rFUTxPowerMax, rfu=rfu, sNTPServerTableIndex=sNTPServerTableIndex, ethernet=ethernet, rFUVersionBank2=rFUVersionBank2, primaryRecoveryPeriod=primaryRecoveryPeriod, remoteMaximumTransmitPower=remoteMaximumTransmitPower, remotePrimaryMACAddress=remotePrimaryMACAddress, latitude=latitude, gatewayIPAddress=gatewayIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, subnetMask=subnetMask, sNTPSync=sNTPSync, rFURxFreqMax=rFURxFreqMax, vectorError=vectorError, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPv6GatewayAddress=iPv6GatewayAddress, longitude=longitude, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, remotePrimaryIPAddress=remotePrimaryIPAddress, transmitCapacityLimitDetail=transmitCapacityLimitDetail, dataPortFiberStatus=dataPortFiberStatus, localPacketFiltering=localPacketFiltering, sNTPServerTableNumber=sNTPServerTableNumber, radioLicenseBandwidth=radioLicenseBandwidth, productName=productName, radioLicense=radioLicense, qOSPriorityScheme=qOSPriorityScheme, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, iPv4Address=iPv4Address, rFUCableAlarm=rFUCableAlarm, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, receiveDataRate=receiveDataRate, sNMPCommunityString=sNMPCommunityString, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, encryption=encryption)
