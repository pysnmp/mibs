...
Counter32, ObjectIdentity, Integer32, Counter64, enterprises, Gauge32, MibIdentifier, Bits, IpAddress, TimeTicks, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "Integer32", "Counter64", "enterprises", "Gauge32", "MibIdentifier", "Bits", "IpAddress", "TimeTicks", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", managementPortAutoNegotiation=managementPortAutoNegotiation, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sNTPServerTable=sNTPServerTable, transmitCapacity=transmitCapacity, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, protection=protection, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, syslogState=syslogState, configuration=configuration, managementPortDisabledWarning=managementPortDisabledWarning, ptmp=ptmp, radioLicense=radioLicense, reset=reset, iPv6GatewayAddress=iPv6GatewayAddress, l2CPPriorityTable=l2CPPriorityTable, remotePrimaryInternetAddress=remotePrimaryInternetAddress, primarySecondaryMode=primarySecondaryMode, receiveModulation=receiveModulation, protectionSwitchCause=protectionSwitchCause, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, primaryRecoveryPeriod=primaryRecoveryPeriod, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, userTableIndex=userTableIndex, dSCPManagementPriority=dSCPManagementPriority, remoteMACAddress=remoteMACAddress, ethernetPriorityTable=ethernetPriorityTable, transmitPower=transmitPower, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, secureModeAlarm=secureModeAlarm, radioLicenseRegion=radioLicenseRegion, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rFUBranchingConfiguration=rFUBranchingConfiguration, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, tFTPServerPortNumber=tFTPServerPortNumber, receiveCodeRate=receiveCodeRate, vectorError=vectorError, managementPortStatusTrap=managementPortStatusTrap, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, managementPortStatus=managementPortStatus, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, faultProtectionSwitching=faultProtectionSwitching, softwareVersion=softwareVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, qOSPriorityScheme=qOSPriorityScheme, radioLicenseMaxModulation=radioLicenseMaxModulation, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, sNMPTrapTableIndex=sNMPTrapTableIndex, mPLSTCPriorityTable=mPLSTCPriorityTable, latitude=latitude, ptp=ptp, dataPortConfigurationMismatch=dataPortConfigurationMismatch, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, unitOutOfCalibration=unitOutOfCalibration, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, fiberY=fiberY, sNTPServerTableNumber=sNTPServerTableNumber, snmpControl=snmpControl, sNTPPrimaryServer=sNTPPrimaryServer, linkNameMismatch=linkNameMismatch, sNMPTrapTableEntry=sNMPTrapTableEntry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rFUActiveFirmwareBank=rFUActiveFirmwareBank, sNTPState=sNTPState, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rFUCableAlarm=rFUCableAlarm, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, userRole=userRole, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFURpsAlarm=rFURpsAlarm, sntp=sntp, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, securityLevel=securityLevel, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPv6PrefixLength=iPv6PrefixLength, alignmentMode=alignmentMode, gatewayIPAddress=gatewayIPAddress, receivePower=receivePower, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, iFCableLength=iFCableLength, diverseRfFeederLoss=diverseRfFeederLoss, wirelessLinkAvailability=wirelessLinkAvailability, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, radioLicenseCodeRate=radioLicenseCodeRate, l2CPPriorityTableIndex=l2CPPriorityTableIndex, enableTransmission=enableTransmission, userEnabled=userEnabled, ptpTrapPrefix=ptpTrapPrefix, alarms=alarms, smtp=smtp, maximumTransmitPower=maximumTransmitPower, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, userTableNumber=userTableNumber, rxDiversityVid=rxDiversityVid, neighborInternetAddressType=neighborInternetAddressType, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, sNMPEnabledTraps=sNMPEnabledTraps, transmitterStatus=transmitterStatus, sNMPPortNumber=sNMPPortNumber, cambium=cambium, rFUTxPowerMin=rFUTxPowerMin, sMTPSourceEmailAddress=sMTPSourceEmailAddress, managementMode=managementMode, protectionConfigurationStatus=protectionConfigurationStatus, radioLicenseBand=radioLicenseBand, telnetPortNumber=telnetPortNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, neighborIPAddress=neighborIPAddress, systemReset=systemReset, remoteInternetAddress=remoteInternetAddress, activeWirelessLinkAvailability=activeWirelessLinkAvailability, vLANManagementVID=vLANManagementVID, telnetAccessEnabled=telnetAccessEnabled, rFUTxPowerMax=rFUTxPowerMax, minModulation=minModulation, sMTPServerIPAddress=sMTPServerIPAddress, activeUnit=activeUnit, linkName=linkName, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPSync=sNTPSync, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerRetries=sNTPServerRetries, subnetMask=subnetMask, receiveDataRate=receiveDataRate, antennaGain=antennaGain, longitude=longitude, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, pubStats=pubStats, ptpTraps=ptpTraps, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, radioLicenseIdentifier=radioLicenseIdentifier, rFUConnectedPlatform=rFUConnectedPlatform, syslogClientTrap=syslogClientTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dataPortDisabledWarning=dataPortDisabledWarning, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, rFURfBand=rFURfBand, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitDataRate=transmitDataRate, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, sMTPServerInternetAddress=sMTPServerInternetAddress, rFUVersionBank2=rFUVersionBank2, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, bridge=bridge, bootVersion=bootVersion, versions=versions, sNTPServerTimeout=sNTPServerTimeout, rFUTxFreqMax=rFUTxFreqMax, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, rFURFSwitchAlarm=rFURFSwitchAlarm, radioLicenseRxFreq=radioLicenseRxFreq, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, aAAControl=aAAControl, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, sNMPCommunityString=sNMPCommunityString, maxModulation=maxModulation, rFFeederLoss=rFFeederLoss, userTableEntry=userTableEntry, localPacketFiltering=localPacketFiltering, dataPortStatusTrap=dataPortStatusTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rFUStatusTrap=rFUStatusTrap, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rFUTxMuteStatus=rFUTxMuteStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPServerTableEntry=sNTPServerTableEntry, rFUTxFreqMin=rFUTxFreqMin, iPv4Address=iPv4Address, rFULockoutAlarm=rFULockoutAlarm, wirelessLinkStatus=wirelessLinkStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, remotePrimaryIPAddress=remotePrimaryIPAddress, syslogStateTrap=syslogStateTrap, vLANManagementVIDValidation=vLANManagementVIDValidation, radioLicenseMinModulation=radioLicenseMinModulation, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, sNTPServerResponse=sNTPServerResponse, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, alignmentModeTrap=alignmentModeTrap, sNTPServerTableIndex=sNTPServerTableIndex, productVariant=productVariant, sNTPLastSync=sNTPLastSync, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, transmitCapacityLimit=transmitCapacityLimit, syslogLocalWrappedTrap=syslogLocalWrappedTrap, encryptionEnabledMismatch=encryptionEnabledMismatch, sNMPTrapVersion=sNMPTrapVersion, ethernetFiberSupport=ethernetFiberSupport, productName=productName, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, remoteInternetAddressType=remoteInternetAddressType, numberOfAntennas=numberOfAntennas, tFTPServerInternetAddressType=tFTPServerInternetAddressType, protectionInterfaceStatus=protectionInterfaceStatus, transmitCodeRate=transmitCodeRate, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, aTPCEnable=aTPCEnable, ethernet=ethernet, syslogClient=syslogClient, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, transmitModulation=transmitModulation, sMTPEmailAlert=sMTPEmailAlert, managementPortWirelessDownAlert=managementPortWirelessDownAlert, phyStatus=phyStatus, protectionStatus=protectionStatus, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, linkLoss=linkLoss, rxDiversityVlanTpid=rxDiversityVlanTpid, radioLicenseTxFreq=radioLicenseTxFreq, remoteSecondaryIPAddress=remoteSecondaryIPAddress, remoteSecondaryMACAddress=remoteSecondaryMACAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ptp800=ptp800, siteName=siteName, hardwareVersion=hardwareVersion, remoteIPAddress=remoteIPAddress, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rFURxFreqMax=rFURxFreqMax, neighborMACAddress=neighborMACAddress, syslogControl=syslogControl, maxCodeRate=maxCodeRate, iPv6Address=iPv6Address, protectionStats=protectionStats, sMTPEnabledMessages=sMTPEnabledMessages, rFUSerial=rFUSerial, sNTPPollInterval=sNTPPollInterval, endId=endId, userName=userName, rFUPowerButtonPressed=rFUPowerButtonPressed, sNMPTrapTable=sNMPTrapTable, dataPortFiberStatus=dataPortFiberStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", iPVersion=iPVersion, sNTPServerIPAddress=sNTPServerIPAddress, primaryRecovery=primaryRecovery, enabledDiagnosticAlarms=enabledDiagnosticAlarms, radioLicenseMaxEIRP=radioLicenseMaxEIRP, protectionAvailabilityStatus=protectionAvailabilityStatus, vLANManagementPriority=vLANManagementPriority, protectionState=protectionState, managementCommittedInformationRate=managementCommittedInformationRate, rFUPowerAlarm=rFUPowerAlarm, supplementary=supplementary, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rFUTransceiverLocation=rFUTransceiverLocation, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, managementPortForcedConfiguration=managementPortForcedConfiguration, rFUTxPowerAlarm=rFUTxPowerAlarm, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, dataPortStatus=dataPortStatus, userTable=userTable, aggregateDataRate=aggregateDataRate, rFUVersionBank1=rFUVersionBank1, rFURxFreqMin=rFURxFreqMin, diverseAntennaGain=diverseAntennaGain, userPassword=userPassword, licence=licence, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, phyControl=phyControl, rfu=rfu, dataPortPauseFrames=dataPortPauseFrames, altitude=altitude, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, radioLicenseBandwidth=radioLicenseBandwidth, encryptionAlgorithm=encryptionAlgorithm, hTTPSAccessEnabled=hTTPSAccessEnabled, protectionStateTrap=protectionStateTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, systemClock=systemClock, rxDiversityDataPortStatus=rxDiversityDataPortStatus, hTTPPortNumber=hTTPPortNumber, remotePrimaryMACAddress=remotePrimaryMACAddress, sNTPSyncTrap=sNTPSyncTrap, daylightSaving=daylightSaving, rFUProtectionCompatibility=rFUProtectionCompatibility, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, secondarySoftwareVersion=secondarySoftwareVersion, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rFUPlatformCompatibility=rFUPlatformCompatibility, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, activeAvailableTime=activeAvailableTime, rFUTxBandAboveRx=rFUTxBandAboveRx, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, linkNameMismatchTrap=linkNameMismatchTrap, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rFUType=rFUType, sMTPServerPortNumber=sMTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFUFreqSpacing=rFUFreqSpacing, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, neighborInternetAddress=neighborInternetAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, management=management, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, encryption=encryption, radioLicenseModulation=radioLicenseModulation, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, requestedProtectionState=requestedProtectionState, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, hTTPAccessEnabled=hTTPAccessEnabled, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, minCodeRate=minCodeRate, transmitCapacityLimitDetail=transmitCapacityLimitDetail, sNTPServerPortNumber=sNTPServerPortNumber, secureModeAlarmTrap=secureModeAlarmTrap, timeZone=timeZone, protectionConfig=protectionConfig, rFUStatus=rFUStatus)
