...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, iso, NotificationType, NotificationType, Bits, Integer32, Gauge32, TimeTicks, Counter32, MibIdentifier, ModuleIdentity, Counter64, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "iso", "NotificationType", "NotificationType", "Bits", "Integer32", "Gauge32", "TimeTicks", "Counter32", "MibIdentifier", "ModuleIdentity", "Counter64", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", mPLSTCPriorityTable=mPLSTCPriorityTable, ethernet=ethernet, rFUTransceiverLocation=rFUTransceiverLocation, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, radioLicenseMinModulation=radioLicenseMinModulation, sMTPServerInternetAddressType=sMTPServerInternetAddressType, transmitCodeRate=transmitCodeRate, userEnabled=userEnabled, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sMTPServerIPAddress=sMTPServerIPAddress, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remoteIPAddress=remoteIPAddress, radioLicenseBand=radioLicenseBand, userRole=userRole, sNTPServerResponse=sNTPServerResponse, sNMPTrapIPAddress=sNMPTrapIPAddress, remotePrimaryMACAddress=remotePrimaryMACAddress, hTTPSPortNumber=hTTPSPortNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tFTPServerInternetAddressType=tFTPServerInternetAddressType, configuration=configuration, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, phyStatus=phyStatus, syslogStateTrap=syslogStateTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, rFUVersionBank1=rFUVersionBank1, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, transmitCapacityLimitDetail=transmitCapacityLimitDetail, rFURxFreqMin=rFURxFreqMin, protectionStateTrap=protectionStateTrap, maximumTransmitPower=maximumTransmitPower, dataPortStatus=dataPortStatus, neighborIPAddress=neighborIPAddress, sNTPServerTable=sNTPServerTable, remoteMACAddress=remoteMACAddress, longitude=longitude, iPv6GatewayAddress=iPv6GatewayAddress, transmitCapacity=transmitCapacity, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, fiberY=fiberY, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, dataPortPauseFrames=dataPortPauseFrames, syslogState=syslogState, sNMPCommunityString=sNMPCommunityString, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, receiveDataRate=receiveDataRate, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rFUConnectedPlatform=rFUConnectedPlatform, rFUFreqSpacing=rFUFreqSpacing, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receivePower=receivePower, localPacketFiltering=localPacketFiltering, syslogControl=syslogControl, radioLicenseModulation=radioLicenseModulation, sNMPPortNumber=sNMPPortNumber, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFUTxPowerAlarm=rFUTxPowerAlarm, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, alarms=alarms, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, diverseAntennaGain=diverseAntennaGain, protectionState=protectionState, systemReset=systemReset, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, enableTransmission=enableTransmission, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, wirelessLinkAvailability=wirelessLinkAvailability, activeAvailableTime=activeAvailableTime, radioLicenseMaxEIRP=radioLicenseMaxEIRP, secureModeAlarm=secureModeAlarm, minModulation=minModulation, rFULockoutAlarm=rFULockoutAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerRetries=sNTPServerRetries, unitOutOfCalibration=unitOutOfCalibration, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, securityLevel=securityLevel, rFURxFreqMax=rFURxFreqMax, aAAControl=aAAControl, subnetMask=subnetMask, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFUTxFreqMin=rFUTxFreqMin, protectionSwitchCause=protectionSwitchCause, userTableNumber=userTableNumber, hardwareVersion=hardwareVersion, tFTPServerPortNumber=tFTPServerPortNumber, qOSPriorityScheme=qOSPriorityScheme, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFUPowerAlarm=rFUPowerAlarm, sMTPEnabledMessages=sMTPEnabledMessages, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, rFUPlatformCompatibility=rFUPlatformCompatibility, transmitModulation=transmitModulation, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, syslogClientTrap=syslogClientTrap, radioLicenseBandwidth=radioLicenseBandwidth, rFUTxPowerMax=rFUTxPowerMax, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFUPowerButtonPressed=rFUPowerButtonPressed, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rFUStatusTrap=rFUStatusTrap, protectionConfigurationStatus=protectionConfigurationStatus, managementPortStatusTrap=managementPortStatusTrap, primarySecondaryMode=primarySecondaryMode, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, protectionConfig=protectionConfig, sNTPServerPortNumber=sNTPServerPortNumber, vLANManagementPriority=vLANManagementPriority, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, radioLicenseMaxModulation=radioLicenseMaxModulation, alignmentMode=alignmentMode, protectionStatus=protectionStatus, sNTPPollInterval=sNTPPollInterval, activeUnit=activeUnit, rfu=rfu, sMTPServerPortNumber=sMTPServerPortNumber, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerTimeout=sNTPServerTimeout, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, ptp800=ptp800, encryptionAlgorithm=encryptionAlgorithm, transmitCapacityLimit=transmitCapacityLimit, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, alignmentModeTrap=alignmentModeTrap, protection=protection, altitude=altitude, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rFUCableAlarm=rFUCableAlarm, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rFUSerial=rFUSerial, numberOfAntennas=numberOfAntennas, transmitDataRate=transmitDataRate, ptpTraps=ptpTraps, linkNameMismatch=linkNameMismatch, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, remoteInternetAddress=remoteInternetAddress, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, sNMPTrapTable=sNMPTrapTable, activeWirelessLinkAvailability=activeWirelessLinkAvailability, ptp=ptp, encryptionEnabledMismatch=encryptionEnabledMismatch, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rFFeederLoss=rFFeederLoss, protectionStats=protectionStats, userPassword=userPassword, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rFUBranchingConfiguration=rFUBranchingConfiguration, linkLoss=linkLoss, minCodeRate=minCodeRate, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, vLANManagementVIDValidation=vLANManagementVIDValidation, iPv4Address=iPv4Address, sNMPTrapTableIndex=sNMPTrapTableIndex, siteName=siteName, tFTPServerIPAddress=tFTPServerIPAddress, primaryRecoveryPeriod=primaryRecoveryPeriod, managementCommittedInformationRate=managementCommittedInformationRate, userTableIndex=userTableIndex, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ptmp=ptmp, iPv6PrefixLength=iPv6PrefixLength, rFURfBand=rFURfBand, secondarySoftwareVersion=secondarySoftwareVersion, rFUTxPowerMin=rFUTxPowerMin, primaryRecovery=primaryRecovery, remotePrimaryIPAddress=remotePrimaryIPAddress, encryption=encryption, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, iPv6Address=iPv6Address, hTTPSAccessEnabled=hTTPSAccessEnabled, rFUType=rFUType, secureModeAlarmTrap=secureModeAlarmTrap, iPVersion=iPVersion, transmitPower=transmitPower, managementPortDisabledWarning=managementPortDisabledWarning, hTTPAccessEnabled=hTTPAccessEnabled, dataPortStatusTrap=dataPortStatusTrap, rFUTxFreqMax=rFUTxFreqMax, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, rFUVersionBank2=rFUVersionBank2, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, softwareVersion=softwareVersion, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, maxModulation=maxModulation, pubStats=pubStats, vectorError=vectorError, rFUStatus=rFUStatus, systemClock=systemClock, telnetAccessEnabled=telnetAccessEnabled, protectionInterfaceStatus=protectionInterfaceStatus, dSCPManagementPriority=dSCPManagementPriority, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPSync=sNTPSync, hTTPPortNumber=hTTPPortNumber, sNTPPrimaryServer=sNTPPrimaryServer, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, rxDiversityVid=rxDiversityVid, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, linkNameMismatchTrap=linkNameMismatchTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, versions=versions, sMTPSourceEmailAddress=sMTPSourceEmailAddress, daylightSaving=daylightSaving, faultProtectionSwitching=faultProtectionSwitching, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, diverseRfFeederLoss=diverseRfFeederLoss, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, radioLicenseMinCodeRate=radioLicenseMinCodeRate, iPDSCPPriorityTable=iPDSCPPriorityTable, licence=licence, endId=endId, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userTable=userTable, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, management=management, neighborInternetAddress=neighborInternetAddress, receiveCodeRate=receiveCodeRate, productVariant=productVariant, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNTPServerInternetAddress=sNTPServerInternetAddress, radioLicense=radioLicense, radioLicenseRegion=radioLicenseRegion, remoteInternetAddressType=remoteInternetAddressType, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, neighborMACAddress=neighborMACAddress, managementPortStatus=managementPortStatus, neighborInternetAddressType=neighborInternetAddressType, remoteSecondaryIPAddress=remoteSecondaryIPAddress, dataPortFiberStatus=dataPortFiberStatus, rFUActiveFirmwareBank=rFUActiveFirmwareBank, cambium=cambium, bridge=bridge, dataPortDisabledWarning=dataPortDisabledWarning, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, radioLicenseIdentifier=radioLicenseIdentifier, l2CPPriorityTable=l2CPPriorityTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userTableEntry=userTableEntry, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, bootVersion=bootVersion, transmitterStatus=transmitterStatus, remoteSecondaryMACAddress=remoteSecondaryMACAddress, sNTPServerIPAddress=sNTPServerIPAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, userName=userName, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sntp=sntp, radioLicenseCodeRate=radioLicenseCodeRate, rFURFSwitchAlarm=rFURFSwitchAlarm, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, aTPCEnable=aTPCEnable, protectionAvailabilityStatus=protectionAvailabilityStatus, antennaGain=antennaGain, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, managementPortForcedConfiguration=managementPortForcedConfiguration, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, smtp=smtp, radioLicenseRxFreq=radioLicenseRxFreq, aggregateDataRate=aggregateDataRate, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, telnetPortNumber=telnetPortNumber, remotePrimaryInternetAddress=remotePrimaryInternetAddress, maxCodeRate=maxCodeRate, timeZone=timeZone, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, managementPortAutoNegotiation=managementPortAutoNegotiation, sNTPState=sNTPState, snmpControl=snmpControl, radioLicenseTxFreq=radioLicenseTxFreq, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sMTPEmailAlert=sMTPEmailAlert, syslogClient=syslogClient, receiveModulation=receiveModulation, rxDiversityDataPortStatus=rxDiversityDataPortStatus, rFUTxMuteStatus=rFUTxMuteStatus, productName=productName, sNTPSyncTrap=sNTPSyncTrap, iFCableLength=iFCableLength, rFURpsAlarm=rFURpsAlarm, l2CPPriorityTableEntry=l2CPPriorityTableEntry, reset=reset, remotePrimarySecondaryMode=remotePrimarySecondaryMode, sNTPServerTableEntry=sNTPServerTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, latitude=latitude, rxDiversityVlanTpid=rxDiversityVlanTpid, gatewayIPAddress=gatewayIPAddress, requestedProtectionState=requestedProtectionState, managementMode=managementMode, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPLastSync=sNTPLastSync, phyControl=phyControl, rFUTxBandAboveRx=rFUTxBandAboveRx, vLANManagementVID=vLANManagementVID, supplementary=supplementary, rFUProtectionCompatibility=rFUProtectionCompatibility, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, ethernetPriorityTable=ethernetPriorityTable, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, sNMPTrapVersion=sNMPTrapVersion, linkName=linkName, ethernetFiberSupport=ethernetFiberSupport, sNMPEnabledTraps=sNMPEnabledTraps)
