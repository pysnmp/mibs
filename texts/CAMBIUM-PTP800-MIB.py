...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", antennaGain=antennaGain, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, transmitModulation=transmitModulation, rFURfBand=rFURfBand, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, radioLicenseIdentifier=radioLicenseIdentifier, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, radioLicenseTxFreq=radioLicenseTxFreq, rFUBranchingConfiguration=rFUBranchingConfiguration, rFUVersionBank2=rFUVersionBank2, vLANManagementVID=vLANManagementVID, ethernetPriorityTableNumber=ethernetPriorityTableNumber, alarms=alarms, sNTPLastSync=sNTPLastSync, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, sNTPServerIPAddress=sNTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sNTPServerInternetAddress=sNTPServerInternetAddress, managementPortStatusTrap=managementPortStatusTrap, bootVersion=bootVersion, rFURFSwitchAlarm=rFURFSwitchAlarm, qOSPriorityScheme=qOSPriorityScheme, sNTPServerPortNumber=sNTPServerPortNumber, reset=reset, siteName=siteName, remotePrimaryInternetAddress=remotePrimaryInternetAddress, rxDiversityDataPortStatus=rxDiversityDataPortStatus, remoteIPAddress=remoteIPAddress, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, maxCodeRate=maxCodeRate, sntp=sntp, rFUPowerButtonPressed=rFUPowerButtonPressed, managementPortWirelessDownAlert=managementPortWirelessDownAlert, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, hardwareVersion=hardwareVersion, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFUStatusTrap=rFUStatusTrap, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapTable=sNMPTrapTable, managementPortConfigurationMismatch=managementPortConfigurationMismatch, productVariant=productVariant, userTable=userTable, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortPauseFrames=dataPortPauseFrames, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogControl=syslogControl, sNTPServerRetries=sNTPServerRetries, requestedProtectionState=requestedProtectionState, ptp=ptp, systemReset=systemReset, managementMode=managementMode, syslogClient=syslogClient, transmitCapacityLimit=transmitCapacityLimit, rFUCableAlarm=rFUCableAlarm, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, linkLoss=linkLoss, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerTableIndex=sNTPServerTableIndex, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, activeUnit=activeUnit, linkNameMismatchTrap=linkNameMismatchTrap, rxDiversityVid=rxDiversityVid, encryptionEnabledMismatch=encryptionEnabledMismatch, receivePower=receivePower, userName=userName, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, rFUTransceiverLocation=rFUTransceiverLocation, rFUTxFreqMax=rFUTxFreqMax, maxModulation=maxModulation, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, transmitDataRate=transmitDataRate, diverseRfFeederLoss=diverseRfFeederLoss, receiveCodeRate=receiveCodeRate, aggregateDataRate=aggregateDataRate, endId=endId, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, telnetAccessEnabled=telnetAccessEnabled, longitude=longitude, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userTableEntry=userTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, iPv4Address=iPv4Address, linkNameMismatch=linkNameMismatch, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, protectionConfigurationStatus=protectionConfigurationStatus, fiberY=fiberY, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerIPAddress=tFTPServerIPAddress, radioLicenseRxFreq=radioLicenseRxFreq, minCodeRate=minCodeRate, tFTPServerInternetAddress=tFTPServerInternetAddress, neighborIPAddress=neighborIPAddress, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sMTPEmailAlert=sMTPEmailAlert, sNTPServerTableEntry=sNTPServerTableEntry, hTTPAccessEnabled=hTTPAccessEnabled, radioLicenseBand=radioLicenseBand, l2CPPriorityTableIndex=l2CPPriorityTableIndex, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogState=syslogState, encryptionAlgorithm=encryptionAlgorithm, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, protectionState=protectionState, radioLicenseRegion=radioLicenseRegion, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rFUSerial=rFUSerial, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, altitude=altitude, sNMPTrapTableNumber=sNMPTrapTableNumber, remotePrimaryMACAddress=remotePrimaryMACAddress, neighborInternetAddress=neighborInternetAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPCommunityString=sNMPCommunityString, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortStatus=dataPortStatus, iPv6Address=iPv6Address, remoteSecondaryMACAddress=remoteSecondaryMACAddress, timeZone=timeZone, protectionInterfaceStatus=protectionInterfaceStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, securityLevel=securityLevel, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, rFUType=rFUType, transmitCapacityLimitDetail=transmitCapacityLimitDetail, protectionStateTrap=protectionStateTrap, aAAControl=aAAControl, neighborInternetAddressType=neighborInternetAddressType, iPVersion=iPVersion, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, managementCommittedInformationRate=managementCommittedInformationRate, primaryRecovery=primaryRecovery, wirelessLinkStatus=wirelessLinkStatus, ethernet=ethernet, userRole=userRole, rfu=rfu, rFURxFreqMin=rFURxFreqMin, localPacketFiltering=localPacketFiltering, minModulation=minModulation, rFURpsAlarm=rFURpsAlarm, ptpTraps=ptpTraps, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPPortNumber=sNMPPortNumber, syslogClientTrap=syslogClientTrap, radioLicenseModulation=radioLicenseModulation, protectionAvailabilityStatus=protectionAvailabilityStatus, rFULockoutAlarm=rFULockoutAlarm, hTTPPortNumber=hTTPPortNumber, telnetPortNumber=telnetPortNumber, remotePrimaryIPAddress=remotePrimaryIPAddress, alignmentModeTrap=alignmentModeTrap, managementPortStatus=managementPortStatus, bridge=bridge, sNTPServerTimeout=sNTPServerTimeout, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ptpTrapPrefix=ptpTrapPrefix, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, sNTPState=sNTPState, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, rFUVersionBank1=rFUVersionBank1, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, wirelessLinkStatusTrap=wirelessLinkStatusTrap, management=management, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, alignmentMode=alignmentMode, radioLicenseCodeRate=radioLicenseCodeRate, protectionConfig=protectionConfig, diverseAntennaGain=diverseAntennaGain, userPassword=userPassword, radioLicenseMaxModulation=radioLicenseMaxModulation, radioLicenseMaxEIRP=radioLicenseMaxEIRP, sNTPPrimaryServer=sNTPPrimaryServer, managementPortAutoNegotiation=managementPortAutoNegotiation, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, faultProtectionSwitching=faultProtectionSwitching, protectionStats=protectionStats, smtp=smtp, secureModeAlarm=secureModeAlarm, sNTPServerTable=sNTPServerTable, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, ethernetPriorityTable=ethernetPriorityTable, linkName=linkName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernetPriorityTableEntry=ethernetPriorityTableEntry, hTTPSPortNumber=hTTPSPortNumber, phyStatus=phyStatus, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rFUProtectionCompatibility=rFUProtectionCompatibility, dSCPManagementPriority=dSCPManagementPriority, userTableNumber=userTableNumber, primaryRecoveryPeriod=primaryRecoveryPeriod, syslogStateTrap=syslogStateTrap, tFTPServerPortNumber=tFTPServerPortNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, rFUConnectedPlatform=rFUConnectedPlatform, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, l2CPPriorityTableNumber=l2CPPriorityTableNumber, transmitCapacity=transmitCapacity, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, versions=versions, protectionSwitchCause=protectionSwitchCause, iPv6GatewayAddress=iPv6GatewayAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rFUTxPowerMin=rFUTxPowerMin, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPServerInternetAddressType=sNTPServerInternetAddressType, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, aTPCEnable=aTPCEnable, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, transmitCodeRate=transmitCodeRate, sNMPTrapInternetAddress=sNMPTrapInternetAddress, gatewayIPAddress=gatewayIPAddress, rxDiversityVlanTpid=rxDiversityVlanTpid, protectionStatus=protectionStatus, rFUPowerAlarm=rFUPowerAlarm, l2CPPriorityTableEntry=l2CPPriorityTableEntry, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFUTxBandAboveRx=rFUTxBandAboveRx, ethernetFiberSupport=ethernetFiberSupport, cambium=cambium, pubStats=pubStats, sNTPSyncTrap=sNTPSyncTrap, phyControl=phyControl, sNMPTrapVersion=sNMPTrapVersion, userEnabled=userEnabled, enableTransmission=enableTransmission, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, secondarySoftwareVersion=secondarySoftwareVersion, l2CPPriorityTable=l2CPPriorityTable, configuration=configuration, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, activeAvailableTime=activeAvailableTime, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, sNTPServerResponse=sNTPServerResponse, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", remoteInternetAddress=remoteInternetAddress, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, receiveDataRate=receiveDataRate, ptmp=ptmp, iPDSCPPriorityTable=iPDSCPPriorityTable, ptp800=ptp800, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, remoteInternetAddressType=remoteInternetAddressType, receiveModulation=receiveModulation, systemClock=systemClock, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, iPv6PrefixLength=iPv6PrefixLength, radioLicenseMinModulation=radioLicenseMinModulation, productName=productName, vectorError=vectorError, iFCableLength=iFCableLength, primarySecondaryMode=primarySecondaryMode, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, supplementary=supplementary, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rFUStatus=rFUStatus, unitOutOfCalibration=unitOutOfCalibration, rFFeederLoss=rFFeederLoss, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitPower=transmitPower, managementPortForcedConfiguration=managementPortForcedConfiguration, subnetMask=subnetMask, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPPollInterval=sNTPPollInterval, managementPortDisabledWarning=managementPortDisabledWarning, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPSync=sNTPSync, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, transmitterStatus=transmitterStatus, snmpControl=snmpControl, rFUPlatformCompatibility=rFUPlatformCompatibility, rFUTxFreqMin=rFUTxFreqMin, sMTPServerPortNumber=sMTPServerPortNumber, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rFUTxMuteStatus=rFUTxMuteStatus, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, remotePrimarySecondaryMode=remotePrimarySecondaryMode, daylightSaving=daylightSaving, rFUTxPowerAlarm=rFUTxPowerAlarm, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, rFUFreqSpacing=rFUFreqSpacing, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, softwareVersion=softwareVersion, licence=licence, vLANManagementVIDValidation=vLANManagementVIDValidation, neighborMACAddress=neighborMACAddress, dataPortStatusTrap=dataPortStatusTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, encryption=encryption, latitude=latitude, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, activeWirelessLinkAvailability=activeWirelessLinkAvailability, numberOfAntennas=numberOfAntennas, wirelessLinkAvailability=wirelessLinkAvailability, protection=protection, sNTPServerTableNumber=sNTPServerTableNumber, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, radioLicenseBandwidth=radioLicenseBandwidth, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, userTableIndex=userTableIndex, dataPortFiberStatus=dataPortFiberStatus, vLANManagementPriority=vLANManagementPriority, remoteSecondaryIPAddress=remoteSecondaryIPAddress, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, remoteMACAddress=remoteMACAddress, radioLicense=radioLicense, rFURxFreqMax=rFURxFreqMax, rFUTxPowerMax=rFUTxPowerMax, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, secureModeAlarmTrap=secureModeAlarmTrap, sNMPTrapPortNumber=sNMPTrapPortNumber)
