...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementPortStatusTrap=managementPortStatusTrap, radioLicenseBand=radioLicenseBand, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, vLANManagementVID=vLANManagementVID, transmitterStatus=transmitterStatus, rfu=rfu, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, faultProtectionSwitching=faultProtectionSwitching, qOSPriorityScheme=qOSPriorityScheme, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rFULockoutAlarm=rFULockoutAlarm, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, sNTPServerRetries=sNTPServerRetries, rFURxFreqMax=rFURxFreqMax, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, primaryRecovery=primaryRecovery, iPv6Address=iPv6Address, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, iPv6PrefixLength=iPv6PrefixLength, ethernet=ethernet, protectionConfig=protectionConfig, receiveCodeRate=receiveCodeRate, transmitCodeRate=transmitCodeRate, aggregateDataRate=aggregateDataRate, alarms=alarms, sNTPServerIPAddress=sNTPServerIPAddress, secureModeAlarm=secureModeAlarm, rFUTxPowerMax=rFUTxPowerMax, rFFeederLoss=rFFeederLoss, syslogClient=syslogClient, syslogControl=syslogControl, protectionState=protectionState, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, gatewayIPAddress=gatewayIPAddress, iFCableLength=iFCableLength, radioLicenseTxFreq=radioLicenseTxFreq, rFUPowerButtonPressed=rFUPowerButtonPressed, telnetPortNumber=telnetPortNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementPortAutoNegotiation=managementPortAutoNegotiation, encryptionEnabledMismatch=encryptionEnabledMismatch, rFUTransceiverLocation=rFUTransceiverLocation, rxDiversityVlanTpid=rxDiversityVlanTpid, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetPriorityTable=ethernetPriorityTable, securityLevel=securityLevel, rFURxFreqMin=rFURxFreqMin, rFUType=rFUType, protectionSwitchCause=protectionSwitchCause, remotePrimaryInternetAddress=remotePrimaryInternetAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPSyncTrap=sNTPSyncTrap, pubStats=pubStats, remoteSecondaryIPAddress=remoteSecondaryIPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, cambium=cambium, rFUStatus=rFUStatus, l2CPPriorityTableIndex=l2CPPriorityTableIndex, enableTransmission=enableTransmission, antennaGain=antennaGain, iPVersion=iPVersion, vLANManagementVIDValidation=vLANManagementVIDValidation, productName=productName, aAAControl=aAAControl, radioLicenseRegion=radioLicenseRegion, encryption=encryption, rFUTxBandAboveRx=rFUTxBandAboveRx, hTTPSPortNumber=hTTPSPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rFUVersionBank2=rFUVersionBank2, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, rFUPlatformCompatibility=rFUPlatformCompatibility, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, linkNameMismatch=linkNameMismatch, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, transmitCapacityLimitDetail=transmitCapacityLimitDetail, sMTPSourceEmailAddress=sMTPSourceEmailAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, radioLicenseCodeRate=radioLicenseCodeRate, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, alignmentModeTrap=alignmentModeTrap, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, diverseAntennaGain=diverseAntennaGain, softwareVersion=softwareVersion, management=management, sNMPTrapVersion=sNMPTrapVersion, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, managementPortDisabledWarning=managementPortDisabledWarning, hardwareVersion=hardwareVersion, telnetAccessEnabled=telnetAccessEnabled, sNTPLastSync=sNTPLastSync, transmitCapacityLimit=transmitCapacityLimit, reset=reset, vectorError=vectorError, hTTPSAccessEnabled=hTTPSAccessEnabled, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, protectionStatus=protectionStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, protectionConfigurationStatus=protectionConfigurationStatus, sNTPServerTableIndex=sNTPServerTableIndex, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, userPassword=userPassword, linkName=linkName, remoteInternetAddressType=remoteInternetAddressType, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, syslogState=syslogState, rFUTxPowerMin=rFUTxPowerMin, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, userTableEntry=userTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPPollInterval=sNTPPollInterval, rFURFSwitchAlarm=rFURFSwitchAlarm, managementPortConfigurationMismatch=managementPortConfigurationMismatch, endId=endId, sNTPPrimaryServer=sNTPPrimaryServer, sMTPServerPortNumber=sMTPServerPortNumber, longitude=longitude, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, ptpTraps=ptpTraps, userEnabled=userEnabled, primarySecondaryMode=primarySecondaryMode, radioLicenseMaxEIRP=radioLicenseMaxEIRP, radioLicenseBandwidth=radioLicenseBandwidth, remotePrimaryIPAddress=remotePrimaryIPAddress, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, radioLicenseModulation=radioLicenseModulation, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, managementCommittedInformationRate=managementCommittedInformationRate, rFUCableAlarm=rFUCableAlarm, rFURfBand=rFURfBand, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, aTPCEnable=aTPCEnable, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, sntp=sntp, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, subnetMask=subnetMask, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, userTableIndex=userTableIndex, protectionStateTrap=protectionStateTrap, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapIPAddress=sNMPTrapIPAddress, l2CPPriorityTable=l2CPPriorityTable, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNMPTrapInternetAddress=sNMPTrapInternetAddress, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, remotePrimarySecondaryMode=remotePrimarySecondaryMode, remoteIPAddress=remoteIPAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, rFUVersionBank1=rFUVersionBank1, dataPortStatus=dataPortStatus, radioLicenseRxFreq=radioLicenseRxFreq, managementPortWirelessDownAlert=managementPortWirelessDownAlert, linkNameMismatchTrap=linkNameMismatchTrap, syslogClientTrap=syslogClientTrap, managementMode=managementMode, sNTPServerTable=sNTPServerTable, rFUTxPowerAlarm=rFUTxPowerAlarm, protectionInterfaceStatus=protectionInterfaceStatus, minModulation=minModulation, sNMPTrapTable=sNMPTrapTable, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, transmitPower=transmitPower, phyStatus=phyStatus, dataPortDisabledWarning=dataPortDisabledWarning, iPDSCPPriorityTable=iPDSCPPriorityTable, maxCodeRate=maxCodeRate, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, protection=protection, bootVersion=bootVersion, maximumTransmitPower=maximumTransmitPower, secureModeAlarmTrap=secureModeAlarmTrap, radioLicenseIdentifier=radioLicenseIdentifier, radioLicenseMinModulation=radioLicenseMinModulation, userRole=userRole, primaryRecoveryPeriod=primaryRecoveryPeriod, hTTPAccessEnabled=hTTPAccessEnabled, remoteInternetAddress=remoteInternetAddress, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, sNMPEnabledTraps=sNMPEnabledTraps, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rFURpsAlarm=rFURpsAlarm, rFUProtectionCompatibility=rFUProtectionCompatibility, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, neighborInternetAddress=neighborInternetAddress, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, ptpTrapPrefix=ptpTrapPrefix, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyControl=phyControl, userName=userName, fiberY=fiberY, maxModulation=maxModulation, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, transmitCapacity=transmitCapacity, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPv4Address=iPv4Address, sNTPSync=sNTPSync, systemReset=systemReset, ptp800=ptp800, sNTPServerPortNumber=sNTPServerPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rFUStatusTrap=rFUStatusTrap, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, radioLicense=radioLicense, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, wirelessLinkStatusTrap=wirelessLinkStatusTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, minCodeRate=minCodeRate, managementPortStatus=managementPortStatus, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, secondarySoftwareVersion=secondarySoftwareVersion, tFTPServerInternetAddress=tFTPServerInternetAddress, diverseRfFeederLoss=diverseRfFeederLoss, syslogStateTrap=syslogStateTrap, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, vLANManagementPriority=vLANManagementPriority, dSCPManagementPriority=dSCPManagementPriority, sNTPServerResponse=sNTPServerResponse, rxDiversityVid=rxDiversityVid, transmitDataRate=transmitDataRate, rFUTxMuteStatus=rFUTxMuteStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerTableNumber=sNTPServerTableNumber, dataPortStatusTrap=dataPortStatusTrap, rFUConnectedPlatform=rFUConnectedPlatform, sNMPCommunityString=sNMPCommunityString, dataPortFiberStatus=dataPortFiberStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", transmitModulation=transmitModulation, activeUnit=activeUnit, neighborMACAddress=neighborMACAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, snmpControl=snmpControl, activeAvailableTime=activeAvailableTime, bridge=bridge, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, dataPortPauseFrames=dataPortPauseFrames, unitOutOfCalibration=unitOutOfCalibration, rxDiversityDataPortStatus=rxDiversityDataPortStatus, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFUFreqSpacing=rFUFreqSpacing, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, timeZone=timeZone, ptmp=ptmp, protectionStats=protectionStats, remotePrimaryMACAddress=remotePrimaryMACAddress, userTable=userTable, sNMPTrapTableEntry=sNMPTrapTableEntry, rFUTxFreqMin=rFUTxFreqMin, receiveDataRate=receiveDataRate, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFUTxFreqMax=rFUTxFreqMax, licence=licence, sNTPServerTimeout=sNTPServerTimeout, altitude=altitude, latitude=latitude, localPacketFiltering=localPacketFiltering, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkLoss=linkLoss, tFTPServerPortNumber=tFTPServerPortNumber, ethernetFiberSupport=ethernetFiberSupport, rFUActiveFirmwareBank=rFUActiveFirmwareBank, sMTPEmailAlert=sMTPEmailAlert, sNTPServerTableEntry=sNTPServerTableEntry, protectionAvailabilityStatus=protectionAvailabilityStatus, encryptionAlgorithm=encryptionAlgorithm, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, numberOfAntennas=numberOfAntennas, supplementary=supplementary, productVariant=productVariant, managementPortForcedConfiguration=managementPortForcedConfiguration, rFUSerial=rFUSerial, systemClock=systemClock, ptp=ptp, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, userTableNumber=userTableNumber, sNTPState=sNTPState, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, alignmentMode=alignmentMode, versions=versions, remoteMACAddress=remoteMACAddress, sMTPServerIPAddress=sMTPServerIPAddress, activeWirelessLinkAvailability=activeWirelessLinkAvailability, requestedProtectionState=requestedProtectionState, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, wirelessLinkStatus=wirelessLinkStatus, neighborIPAddress=neighborIPAddress, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, siteName=siteName, iPv6GatewayAddress=iPv6GatewayAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableNumber=sNMPTrapTableNumber, smtp=smtp, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sMTPServerInternetAddressType=sMTPServerInternetAddressType, radioLicenseMaxModulation=radioLicenseMaxModulation, configuration=configuration, daylightSaving=daylightSaving, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUBranchingConfiguration=rFUBranchingConfiguration, hTTPPortNumber=hTTPPortNumber, receivePower=receivePower, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, receiveModulation=receiveModulation, neighborInternetAddressType=neighborInternetAddressType, rFUPowerAlarm=rFUPowerAlarm, tFTPServerIPAddress=tFTPServerIPAddress, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNMPPortNumber=sNMPPortNumber)
