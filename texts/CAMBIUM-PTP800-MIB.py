...
Integer32, NotificationType, Counter32, Gauge32, Unsigned32, iso, enterprises, Bits, MibIdentifier, ObjectIdentity, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Counter32", "Gauge32", "Unsigned32", "iso", "enterprises", "Bits", "MibIdentifier", "ObjectIdentity", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, neighborIPAddress=neighborIPAddress, protectionState=protectionState, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, linkName=linkName, sNTPServerRetries=sNTPServerRetries, syslogClientTrap=syslogClientTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, radioLicenseIdentifier=radioLicenseIdentifier, licence=licence, ptp800=ptp800, sNTPPollInterval=sNTPPollInterval, managementPortWirelessDownAlert=managementPortWirelessDownAlert, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, supplementary=supplementary, vectorError=vectorError, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, unitOutOfCalibration=unitOutOfCalibration, aAAControl=aAAControl, managementPortForcedConfiguration=managementPortForcedConfiguration, radioLicenseMaxModulation=radioLicenseMaxModulation, phyStatus=phyStatus, sNTPSyncTrap=sNTPSyncTrap, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapTableNumber=sNMPTrapTableNumber, aggregateDataRate=aggregateDataRate, rFUStatusTrap=rFUStatusTrap, daylightSaving=daylightSaving, rFURfBand=rFURfBand, tFTPServerInternetAddressType=tFTPServerInternetAddressType, userTableIndex=userTableIndex, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFURxFreqMax=rFURxFreqMax, rFUTransceiverLocation=rFUTransceiverLocation, alignmentMode=alignmentMode, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFUProtectionCompatibility=rFUProtectionCompatibility, rFUVersionBank2=rFUVersionBank2, radioLicenseCodeRate=radioLicenseCodeRate, managementMode=managementMode, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, managementCommittedInformationRate=managementCommittedInformationRate, secureModeAlarmTrap=secureModeAlarmTrap, radioLicenseRxFreq=radioLicenseRxFreq, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPCommunityString=sNMPCommunityString, iPDSCPPriorityTable=iPDSCPPriorityTable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, alarms=alarms, protectionStateTrap=protectionStateTrap, radioLicenseTxFreq=radioLicenseTxFreq, syslogControl=syslogControl, rFUStatus=rFUStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sMTPServerIPAddress=sMTPServerIPAddress, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userRole=userRole, userName=userName, requestedProtectionState=requestedProtectionState, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rxDiversityDataPortStatus=rxDiversityDataPortStatus, managementPortStatusTrap=managementPortStatusTrap, dSCPManagementPriority=dSCPManagementPriority, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, transmitDataRate=transmitDataRate, ethernetPriorityTableNumber=ethernetPriorityTableNumber, activeUnit=activeUnit, rFURxFreqMin=rFURxFreqMin, useVLANForManagementInterfaces=useVLANForManagementInterfaces, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPv6PrefixLength=iPv6PrefixLength, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, enableTransmission=enableTransmission, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, maxCodeRate=maxCodeRate, vLANManagementVID=vLANManagementVID, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rFUVersionBank1=rFUVersionBank1, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, snmpControl=snmpControl, sNTPState=sNTPState, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, neighborMACAddress=neighborMACAddress, userTableNumber=userTableNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, radioLicense=radioLicense, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, encryptionEnabledMismatch=encryptionEnabledMismatch, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rxDiversityVlanTpid=rxDiversityVlanTpid, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, transmitCapacity=transmitCapacity, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetFiberSupport=ethernetFiberSupport, radioLicenseModulation=radioLicenseModulation, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, iPv6GatewayAddress=iPv6GatewayAddress, tFTPServerPortNumber=tFTPServerPortNumber, radioLicenseMinCodeRate=radioLicenseMinCodeRate, remoteMACAddress=remoteMACAddress, rFUPowerAlarm=rFUPowerAlarm, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, remoteSecondaryIPAddress=remoteSecondaryIPAddress, rFUSerial=rFUSerial, radioLicenseMinModulation=radioLicenseMinModulation, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, rFUConnectedPlatform=rFUConnectedPlatform, iPv6Address=iPv6Address, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUTxBandAboveRx=rFUTxBandAboveRx, management=management, minModulation=minModulation, latitude=latitude, transmitCodeRate=transmitCodeRate, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, secondarySoftwareVersion=secondarySoftwareVersion, remoteInternetAddressType=remoteInternetAddressType, hTTPSPortNumber=hTTPSPortNumber, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, bridge=bridge, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, receiveModulation=receiveModulation, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, remotePrimaryIPAddress=remotePrimaryIPAddress, dataPortPauseFrames=dataPortPauseFrames, fiberY=fiberY, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, transmitModulation=transmitModulation, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, ethernet=ethernet, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rFURpsAlarm=rFURpsAlarm, hTTPAccessEnabled=hTTPAccessEnabled, activeAvailableTime=activeAvailableTime, protectionStatus=protectionStatus, dataPortStatusTrap=dataPortStatusTrap, systemReset=systemReset, localPacketFiltering=localPacketFiltering, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, pubStats=pubStats, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitterStatus=transmitterStatus, secureModeAlarm=secureModeAlarm, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpTraps=ptpTraps, gatewayIPAddress=gatewayIPAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, syslogClient=syslogClient, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rFUBranchingConfiguration=rFUBranchingConfiguration, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rFULockoutAlarm=rFULockoutAlarm, protectionInterfaceStatus=protectionInterfaceStatus, transmitCapacityLimit=transmitCapacityLimit, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rfu=rfu, radioLicenseRegion=radioLicenseRegion, rFUCableAlarm=rFUCableAlarm, altitude=altitude, primaryRecoveryPeriod=primaryRecoveryPeriod, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerIPAddress=sNTPServerIPAddress, syslogState=syslogState, sNTPPrimaryServer=sNTPPrimaryServer, configuration=configuration, receiveCodeRate=receiveCodeRate, tFTPServerIPAddress=tFTPServerIPAddress, protectionConfig=protectionConfig, protectionAvailabilityStatus=protectionAvailabilityStatus, radioLicenseBandwidth=radioLicenseBandwidth, vLANManagementVIDValidation=vLANManagementVIDValidation, dataPortStatus=dataPortStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, telnetAccessEnabled=telnetAccessEnabled, sNMPEnabledTraps=sNMPEnabledTraps, neighborInternetAddress=neighborInternetAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPServerTimeout=sNTPServerTimeout, sNMPTrapPortNumber=sNMPTrapPortNumber, rFUTxPowerMax=rFUTxPowerMax, remotePrimarySecondaryMode=remotePrimarySecondaryMode, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, aTPCEnable=aTPCEnable, protectionConfigurationStatus=protectionConfigurationStatus, vLANManagementPriority=vLANManagementPriority, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, linkNameMismatch=linkNameMismatch, transmitPower=transmitPower, subnetMask=subnetMask, ptmp=ptmp, primarySecondaryMode=primarySecondaryMode, diverseAntennaGain=diverseAntennaGain, managementPortConfigurationMismatch=managementPortConfigurationMismatch, receiveDataRate=receiveDataRate, sNTPSync=sNTPSync, wirelessLinkAvailability=wirelessLinkAvailability, systemClock=systemClock, tFTPServerInternetAddress=tFTPServerInternetAddress, antennaGain=antennaGain, ptp=ptp, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sMTPServerPortNumber=sMTPServerPortNumber, softwareVersion=softwareVersion, reset=reset, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, bootVersion=bootVersion, rFUPlatformCompatibility=rFUPlatformCompatibility, rxDiversityVid=rxDiversityVid, remotePrimaryMACAddress=remotePrimaryMACAddress, sNMPTrapTable=sNMPTrapTable, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, l2CPPriorityTable=l2CPPriorityTable, radioLicenseBand=radioLicenseBand, linkLoss=linkLoss, userTableEntry=userTableEntry, longitude=longitude, rFUTxPowerAlarm=rFUTxPowerAlarm, encryptionAlgorithm=encryptionAlgorithm, rFUTxFreqMax=rFUTxFreqMax, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, activeWirelessLinkAvailability=activeWirelessLinkAvailability, syslogLocalWrappedTrap=syslogLocalWrappedTrap, alignmentModeTrap=alignmentModeTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", faultProtectionSwitching=faultProtectionSwitching, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, telnetPortNumber=telnetPortNumber, iFCableLength=iFCableLength, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, linkNameMismatchTrap=linkNameMismatchTrap, transmitCapacityLimitDetail=transmitCapacityLimitDetail, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, endId=endId, remotePrimaryInternetAddress=remotePrimaryInternetAddress, protectionSwitchCause=protectionSwitchCause, userPassword=userPassword, productVariant=productVariant, wirelessLinkStatusTrap=wirelessLinkStatusTrap, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, numberOfAntennas=numberOfAntennas, sMTPSourceEmailAddress=sMTPSourceEmailAddress, productName=productName, rFUPowerButtonPressed=rFUPowerButtonPressed, rFUTxMuteStatus=rFUTxMuteStatus, protectionStats=protectionStats, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPVersion=iPVersion, sNTPServerTableIndex=sNTPServerTableIndex, sNTPLastSync=sNTPLastSync, rFUTxPowerMin=rFUTxPowerMin, sNMPPortNumber=sNMPPortNumber, receivePower=receivePower, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rFURFSwitchAlarm=rFURFSwitchAlarm, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, userTable=userTable, protection=protection, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, managementPortStatus=managementPortStatus, qOSPriorityScheme=qOSPriorityScheme, sntp=sntp, rFFeederLoss=rFFeederLoss, neighborInternetAddressType=neighborInternetAddressType, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFUType=rFUType, hardwareVersion=hardwareVersion, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, encryption=encryption, rFUFreqSpacing=rFUFreqSpacing, minCodeRate=minCodeRate, ethernetPriorityTable=ethernetPriorityTable, primaryRecovery=primaryRecovery, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, smtp=smtp, managementPortAutoNegotiation=managementPortAutoNegotiation, remoteSecondaryMACAddress=remoteSecondaryMACAddress, timeZone=timeZone, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, remoteIPAddress=remoteIPAddress, sNMPTrapVersion=sNMPTrapVersion, sNTPServerTableNumber=sNTPServerTableNumber, userEnabled=userEnabled, syslogStateTrap=syslogStateTrap, dataPortFiberStatus=dataPortFiberStatus, rFUTxFreqMin=rFUTxFreqMin, sNTPServerResponse=sNTPServerResponse, wirelessLinkStatus=wirelessLinkStatus, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, maxModulation=maxModulation, securityLevel=securityLevel, iPv4Address=iPv4Address, sMTPServerInternetAddress=sMTPServerInternetAddress, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, phyControl=phyControl, maximumTransmitPower=maximumTransmitPower, sNTPServerTable=sNTPServerTable, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, cambium=cambium, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, ptpTrapPrefix=ptpTrapPrefix, remoteInternetAddress=remoteInternetAddress, sNTPServerTableEntry=sNTPServerTableEntry, siteName=siteName, diverseRfFeederLoss=diverseRfFeederLoss, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, hTTPPortNumber=hTTPPortNumber, managementPortDisabledWarning=managementPortDisabledWarning, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, versions=versions)
