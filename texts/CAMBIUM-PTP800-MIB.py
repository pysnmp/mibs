...
Counter64, NotificationType, ModuleIdentity, NotificationType, Bits, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, TimeTicks, Unsigned32, MibIdentifier, iso, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "ModuleIdentity", "NotificationType", "Bits", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "TimeTicks", "Unsigned32", "MibIdentifier", "iso", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", ethernetPriorityTableNumber=ethernetPriorityTableNumber, configuration=configuration, encryptionEnabledMismatch=encryptionEnabledMismatch, softwareVersion=softwareVersion, transmitterStatus=transmitterStatus, wirelessLinkStatusTrap=wirelessLinkStatusTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementPortForcedConfiguration=managementPortForcedConfiguration, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, protectionStats=protectionStats, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licence=licence, remoteInternetAddressType=remoteInternetAddressType, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rFUActiveFirmwareBank=rFUActiveFirmwareBank, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, syslogClientTrap=syslogClientTrap, managementPortDisabledWarning=managementPortDisabledWarning, dataPortConfigurationMismatch=dataPortConfigurationMismatch, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, userTable=userTable, systemReset=systemReset, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sNMPTrapVersion=sNMPTrapVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, phyControl=phyControl, sNMPCommunityString=sNMPCommunityString, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userPassword=userPassword, transmitCapacityLimit=transmitCapacityLimit, radioLicenseCodeRate=radioLicenseCodeRate, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, encryptionAlgorithm=encryptionAlgorithm, rFURxFreqMax=rFURxFreqMax, sNMPTrapTable=sNMPTrapTable, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, siteName=siteName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rFUPowerButtonPressed=rFUPowerButtonPressed, receiveDataRate=receiveDataRate, rfu=rfu, rFUTxPowerMax=rFUTxPowerMax, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, hardwareVersion=hardwareVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFUVersionBank2=rFUVersionBank2, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, phyStatus=phyStatus, maxCodeRate=maxCodeRate, minModulation=minModulation, unitOutOfCalibration=unitOutOfCalibration, faultProtectionSwitching=faultProtectionSwitching, aTPCEnable=aTPCEnable, tFTPServerInternetAddress=tFTPServerInternetAddress, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, sNTPPollInterval=sNTPPollInterval, sNTPServerInternetAddress=sNTPServerInternetAddress, userTableEntry=userTableEntry, iPDSCPPriorityTable=iPDSCPPriorityTable, productName=productName, neighborInternetAddress=neighborInternetAddress, radioLicenseMaxEIRP=radioLicenseMaxEIRP, dataPortStatusTrap=dataPortStatusTrap, dataPortPauseFrames=dataPortPauseFrames, enableTransmission=enableTransmission, sNTPServerPortNumber=sNTPServerPortNumber, primaryRecovery=primaryRecovery, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveModulation=receiveModulation, linkNameMismatch=linkNameMismatch, protectionAvailabilityStatus=protectionAvailabilityStatus, encryption=encryption, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, subnetMask=subnetMask, iPv4Address=iPv4Address, daylightSaving=daylightSaving, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, remotePrimaryIPAddress=remotePrimaryIPAddress, remoteMACAddress=remoteMACAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, iFCableLength=iFCableLength, activeAvailableTime=activeAvailableTime, transmitCapacity=transmitCapacity, rFUTxFreqMax=rFUTxFreqMax, radioLicenseModulation=radioLicenseModulation, dataPortFiberStatus=dataPortFiberStatus, rFUVersionBank1=rFUVersionBank1, iPv6GatewayAddress=iPv6GatewayAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, receiveCodeRate=receiveCodeRate, sNTPServerRetries=sNTPServerRetries, bootVersion=bootVersion, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFUStatusTrap=rFUStatusTrap, latitude=latitude, transmitModulation=transmitModulation, wirelessLinkStatus=wirelessLinkStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPServerInternetAddressType=tFTPServerInternetAddressType, telnetAccessEnabled=telnetAccessEnabled, maxModulation=maxModulation, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUBranchingConfiguration=rFUBranchingConfiguration, radioLicenseMaxModulation=radioLicenseMaxModulation, remoteSecondaryMACAddress=remoteSecondaryMACAddress, transmitDataRate=transmitDataRate, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, requestedProtectionState=requestedProtectionState, managementCommittedInformationRate=managementCommittedInformationRate, radioLicenseRxFreq=radioLicenseRxFreq, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sntp=sntp, rFURFSwitchAlarm=rFURFSwitchAlarm, management=management, sNTPServerTableIndex=sNTPServerTableIndex, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, localPacketFiltering=localPacketFiltering, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPState=sNTPState, sNTPServerTableNumber=sNTPServerTableNumber, rFUTransceiverLocation=rFUTransceiverLocation, gatewayIPAddress=gatewayIPAddress, remoteInternetAddress=remoteInternetAddress, sMTPServerPortNumber=sMTPServerPortNumber, syslogControl=syslogControl, ptpTrapPrefix=ptpTrapPrefix, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rFUConnectedPlatform=rFUConnectedPlatform, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, systemClock=systemClock, sNTPServerTableEntry=sNTPServerTableEntry, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, secureModeAlarmTrap=secureModeAlarmTrap, snmpControl=snmpControl, iPv6Address=iPv6Address, protectionInterfaceStatus=protectionInterfaceStatus, userEnabled=userEnabled, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, hTTPPortNumber=hTTPPortNumber, transmitPower=transmitPower, hTTPAccessEnabled=hTTPAccessEnabled, securityLevel=securityLevel, sNTPSync=sNTPSync, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, protectionSwitchCause=protectionSwitchCause, remoteIPAddress=remoteIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, fiberY=fiberY, aggregateDataRate=aggregateDataRate, dataPortStatus=dataPortStatus, neighborInternetAddressType=neighborInternetAddressType, l2CPPriorityTableEntry=l2CPPriorityTableEntry, transmitCapacityLimitDetail=transmitCapacityLimitDetail, supplementary=supplementary, transmitCodeRate=transmitCodeRate, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, longitude=longitude, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sNMPPortNumber=sNMPPortNumber, syslogClient=syslogClient, iPVersion=iPVersion, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFUTxBandAboveRx=rFUTxBandAboveRx, radioLicenseTxFreq=radioLicenseTxFreq, ptp=ptp, wirelessLinkAvailability=wirelessLinkAvailability, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, managementPortWirelessDownAlert=managementPortWirelessDownAlert, protectionConfig=protectionConfig, l2CPPriorityTable=l2CPPriorityTable, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, protectionStatus=protectionStatus, radioLicenseBand=radioLicenseBand, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerResponse=sNTPServerResponse, protectionConfigurationStatus=protectionConfigurationStatus, alignmentModeTrap=alignmentModeTrap, ptmp=ptmp, maximumTransmitPower=maximumTransmitPower, dataPortDisabledWarning=dataPortDisabledWarning, rxDiversityVlanTpid=rxDiversityVlanTpid, primarySecondaryMode=primarySecondaryMode, mPLSTCPriorityTable=mPLSTCPriorityTable, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, sNTPServerTable=sNTPServerTable, productVariant=productVariant, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, managementMode=managementMode, protectionState=protectionState, userTableIndex=userTableIndex, radioLicense=radioLicense, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPv6PrefixLength=iPv6PrefixLength, receivePower=receivePower, protectionStateTrap=protectionStateTrap, reset=reset, managementPortStatusTrap=managementPortStatusTrap, radioLicenseBandwidth=radioLicenseBandwidth, rFUTxPowerAlarm=rFUTxPowerAlarm, rFUTxMuteStatus=rFUTxMuteStatus, vLANManagementVIDValidation=vLANManagementVIDValidation, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, rFUSerial=rFUSerial, rxDiversityVid=rxDiversityVid, userName=userName, pubStats=pubStats, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, syslogStateTrap=syslogStateTrap, vLANManagementPriority=vLANManagementPriority, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ethernet=ethernet, neighborIPAddress=neighborIPAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, bridge=bridge, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, alarms=alarms, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dSCPManagementPriority=dSCPManagementPriority, sMTPEmailAlert=sMTPEmailAlert, altitude=altitude, protection=protection, remotePrimaryMACAddress=remotePrimaryMACAddress, vLANManagementVID=vLANManagementVID, remotePrimarySecondaryMode=remotePrimarySecondaryMode, linkName=linkName, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, managementPortStatus=managementPortStatus, hTTPSPortNumber=hTTPSPortNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ptpTraps=ptpTraps)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", diverseAntennaGain=diverseAntennaGain, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, aAAControl=aAAControl, tFTPServerPortNumber=tFTPServerPortNumber, activeUnit=activeUnit, endId=endId, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rFUPlatformCompatibility=rFUPlatformCompatibility, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, remoteSecondaryIPAddress=remoteSecondaryIPAddress, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, sNTPServerIPAddress=sNTPServerIPAddress, rFUProtectionCompatibility=rFUProtectionCompatibility, sNMPEnabledTraps=sNMPEnabledTraps, numberOfAntennas=numberOfAntennas, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rFURfBand=rFURfBand, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, secondarySoftwareVersion=secondarySoftwareVersion, tFTPServerIPAddress=tFTPServerIPAddress, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, sNTPSyncTrap=sNTPSyncTrap, rFUFreqSpacing=rFUFreqSpacing, rFUTxFreqMin=rFUTxFreqMin, ptp800=ptp800, linkLoss=linkLoss, rFUTxPowerMin=rFUTxPowerMin, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, smtp=smtp, remotePrimaryInternetAddress=remotePrimaryInternetAddress, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, sNTPServerTimeout=sNTPServerTimeout, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rFUType=rFUType, sMTPServerInternetAddress=sMTPServerInternetAddress, diverseRfFeederLoss=diverseRfFeederLoss, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, syslogState=syslogState, remoteMaximumTransmitPower=remoteMaximumTransmitPower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, neighborMACAddress=neighborMACAddress, userRole=userRole, managementPortAutoNegotiation=managementPortAutoNegotiation, cambium=cambium, sNMPTrapTableIndex=sNMPTrapTableIndex, timeZone=timeZone, telnetPortNumber=telnetPortNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPLastSync=sNTPLastSync, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rFUStatus=rFUStatus, rFURxFreqMin=rFURxFreqMin, qOSPriorityScheme=qOSPriorityScheme, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFFeederLoss=rFFeederLoss, dataPortFiberStatusTrap=dataPortFiberStatusTrap, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, rFURpsAlarm=rFURpsAlarm, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rFULockoutAlarm=rFULockoutAlarm, minCodeRate=minCodeRate, radioLicenseRegion=radioLicenseRegion, antennaGain=antennaGain, primaryRecoveryPeriod=primaryRecoveryPeriod, sNTPPrimaryServer=sNTPPrimaryServer, ethernetPriorityTable=ethernetPriorityTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userTableNumber=userTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, radioLicenseMinModulation=radioLicenseMinModulation, rFUPowerAlarm=rFUPowerAlarm, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, radioLicenseIdentifier=radioLicenseIdentifier, alignmentMode=alignmentMode, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, vectorError=vectorError, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, linkNameMismatchTrap=linkNameMismatchTrap, versions=versions, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rFUCableAlarm=rFUCableAlarm, secureModeAlarm=secureModeAlarm)
