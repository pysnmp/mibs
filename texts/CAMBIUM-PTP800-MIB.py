...
Bits, Counter32, enterprises, Gauge32, Counter64, NotificationType, iso, ObjectIdentity, Unsigned32, NotificationType, MibIdentifier, IpAddress, Integer32, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "enterprises", "Gauge32", "Counter64", "NotificationType", "iso", "ObjectIdentity", "Unsigned32", "NotificationType", "MibIdentifier", "IpAddress", "Integer32", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFULockoutAlarm=rFULockoutAlarm, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityTableIndex=l2CPPriorityTableIndex, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, systemReset=systemReset, hardwareVersion=hardwareVersion, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rFURxFreqMax=rFURxFreqMax, rFUConnectedPlatform=rFUConnectedPlatform, aAAControl=aAAControl, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, securityLevel=securityLevel, rFUTxFreqMin=rFUTxFreqMin, ethernetPriorityTable=ethernetPriorityTable, antennaGain=antennaGain, rxDiversityVid=rxDiversityVid, aggregateDataRate=aggregateDataRate, radioLicense=radioLicense, rFUFreqSpacing=rFUFreqSpacing, remotePrimaryInternetAddress=remotePrimaryInternetAddress, bootVersion=bootVersion, versions=versions, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitCapacityLimitDetail=transmitCapacityLimitDetail, sNTPServerTableNumber=sNTPServerTableNumber, userRole=userRole, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, alignmentModeTrap=alignmentModeTrap, alignmentMode=alignmentMode, remotePrimaryIPAddress=remotePrimaryIPAddress, l2CPPriorityTable=l2CPPriorityTable, rFUProtectionCompatibility=rFUProtectionCompatibility, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, remoteInternetAddressType=remoteInternetAddressType, protectionInterfaceStatus=protectionInterfaceStatus, rFUBranchingConfiguration=rFUBranchingConfiguration, protectionConfigurationStatus=protectionConfigurationStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, qOSPriorityScheme=qOSPriorityScheme, ptp800=ptp800, protectionAvailabilityStatus=protectionAvailabilityStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPSyncTrap=sNTPSyncTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, tFTPServerInternetAddressType=tFTPServerInternetAddressType, management=management, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, rFUCableAlarm=rFUCableAlarm, rFFeederLoss=rFFeederLoss, encryptionAlgorithm=encryptionAlgorithm, sMTPEnabledMessages=sMTPEnabledMessages, sNMPEnabledTraps=sNMPEnabledTraps, rxDiversityVlanTpid=rxDiversityVlanTpid, iPv6PrefixLength=iPv6PrefixLength, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPVersion=iPVersion, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPServerRetries=sNTPServerRetries, protection=protection, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ptp=ptp, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, alarms=alarms, rFUTxPowerMax=rFUTxPowerMax, radioLicenseBand=radioLicenseBand, rFUActiveFirmwareBank=rFUActiveFirmwareBank, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, daylightSaving=daylightSaving, radioLicenseBandwidth=radioLicenseBandwidth, telnetAccessEnabled=telnetAccessEnabled, supplementary=supplementary, minModulation=minModulation, sMTPServerInternetAddress=sMTPServerInternetAddress, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, dSCPManagementPriority=dSCPManagementPriority, sntp=sntp, rFUStatus=rFUStatus, userPassword=userPassword, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, maxCodeRate=maxCodeRate, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveModulation=receiveModulation, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, enabledDiagnosticAlarms=enabledDiagnosticAlarms, reset=reset, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, minCodeRate=minCodeRate, dataPortStatus=dataPortStatus, maxModulation=maxModulation, dataPortStatusTrap=dataPortStatusTrap, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, secureModeAlarm=secureModeAlarm, managementPortStatusTrap=managementPortStatusTrap, cambium=cambium, receivePower=receivePower, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, radioLicenseMaxModulation=radioLicenseMaxModulation, linkNameMismatch=linkNameMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rFUStatusTrap=rFUStatusTrap, remotePrimaryMACAddress=remotePrimaryMACAddress, radioLicenseRxFreq=radioLicenseRxFreq, linkLoss=linkLoss, aTPCEnable=aTPCEnable, ptmp=ptmp, transmitterStatus=transmitterStatus, iPv6Address=iPv6Address, iPv4Address=iPv4Address, protectionConfig=protectionConfig, requestedProtectionState=requestedProtectionState, dataPortDisabledWarning=dataPortDisabledWarning, encryptionEnabledMismatch=encryptionEnabledMismatch, rFUTransceiverLocation=rFUTransceiverLocation, pubStats=pubStats, syslogState=syslogState, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapTable=sNMPTrapTable, numberOfAntennas=numberOfAntennas, userTableEntry=userTableEntry, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, wirelessLinkStatusTrap=wirelessLinkStatusTrap, neighborIPAddress=neighborIPAddress, sNTPState=sNTPState, rFUType=rFUType, rFURpsAlarm=rFURpsAlarm, syslogControl=syslogControl, userTableNumber=userTableNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPServerPortNumber=tFTPServerPortNumber, syslogStateTrap=syslogStateTrap, vLANManagementVIDValidation=vLANManagementVIDValidation, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rFUPlatformCompatibility=rFUPlatformCompatibility, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, fiberY=fiberY, configuration=configuration, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, receiveDataRate=receiveDataRate, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, managementPortDisabledWarning=managementPortDisabledWarning, sNMPTrapTableNumber=sNMPTrapTableNumber, rFUVersionBank1=rFUVersionBank1, primarySecondaryMode=primarySecondaryMode, radioLicenseTxFreq=radioLicenseTxFreq, vectorError=vectorError, iPDSCPPriorityTable=iPDSCPPriorityTable, enableTransmission=enableTransmission, timeZone=timeZone, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, dataPortFiberStatusTrap=dataPortFiberStatusTrap, linkNameMismatchTrap=linkNameMismatchTrap, productName=productName, rFUPowerAlarm=rFUPowerAlarm, transmitDataRate=transmitDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, managementMode=managementMode, neighborMACAddress=neighborMACAddress, rxDiversityDataPortStatus=rxDiversityDataPortStatus, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, snmpControl=snmpControl, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, transmitCodeRate=transmitCodeRate, gatewayIPAddress=gatewayIPAddress, transmitCapacityLimit=transmitCapacityLimit, protectionStateTrap=protectionStateTrap, managementPortAutoNegotiation=managementPortAutoNegotiation, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyControl=phyControl, linkName=linkName, dataPortFiberStatus=dataPortFiberStatus, maximumTransmitPower=maximumTransmitPower, hTTPPortNumber=hTTPPortNumber, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, wirelessLinkStatus=wirelessLinkStatus, ethernetFiberSupport=ethernetFiberSupport, protectionStats=protectionStats, neighborInternetAddressType=neighborInternetAddressType, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, primaryRecoveryPeriod=primaryRecoveryPeriod, userTable=userTable, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, sNTPServerInternetAddress=sNTPServerInternetAddress, systemClock=systemClock, receiveCodeRate=receiveCodeRate, longitude=longitude, hTTPAccessEnabled=hTTPAccessEnabled, licence=licence, localPacketFiltering=localPacketFiltering, rFURfBand=rFURfBand, remoteMACAddress=remoteMACAddress, vLANManagementPriority=vLANManagementPriority, transmitPower=transmitPower, vLANManagementVID=vLANManagementVID, radioLicenseIdentifier=radioLicenseIdentifier, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, sNTPServerIPAddress=sNTPServerIPAddress, rFURxFreqMin=rFURxFreqMin, userTableIndex=userTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, protectionStatus=protectionStatus, rFUTxMuteStatus=rFUTxMuteStatus, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, hTTPSAccessEnabled=hTTPSAccessEnabled, radioLicenseMinModulation=radioLicenseMinModulation, rFUTxPowerMin=rFUTxPowerMin, sNTPLastSync=sNTPLastSync, tFTPServerIPAddress=tFTPServerIPAddress, rFUTxBandAboveRx=rFUTxBandAboveRx, iFCableLength=iFCableLength, sNTPPrimaryServer=sNTPPrimaryServer, secureModeAlarmTrap=secureModeAlarmTrap, ethernet=ethernet, managementPortForcedConfiguration=managementPortForcedConfiguration, dataPortPauseFrames=dataPortPauseFrames, userEnabled=userEnabled, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerResponse=sNTPServerResponse, protectionSwitchCause=protectionSwitchCause, siteName=siteName, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, sNTPSync=sNTPSync, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, radioLicenseCodeRate=radioLicenseCodeRate, managementPortStatus=managementPortStatus, rFUPowerButtonPressed=rFUPowerButtonPressed, remoteSecondaryMACAddress=remoteSecondaryMACAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", neighborInternetAddress=neighborInternetAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, sMTPServerIPAddress=sMTPServerIPAddress, primaryRecovery=primaryRecovery, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sMTPServerPortNumber=sMTPServerPortNumber, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rFURFSwitchAlarm=rFURFSwitchAlarm, bridge=bridge, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, encryption=encryption, rFUTxFreqMax=rFUTxFreqMax, syslogClient=syslogClient, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, faultProtectionSwitching=faultProtectionSwitching, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPServerTableIndex=sNTPServerTableIndex, ptpTrapPrefix=ptpTrapPrefix, rFUSerial=rFUSerial, sNMPCommunityString=sNMPCommunityString, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, smtp=smtp, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, diverseRfFeederLoss=diverseRfFeederLoss, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, sMTPEmailAlert=sMTPEmailAlert, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, activeWirelessLinkAvailability=activeWirelessLinkAvailability, telnetPortNumber=telnetPortNumber, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, rFUVersionBank2=rFUVersionBank2, l2CPPriorityTableNumber=l2CPPriorityTableNumber, diverseAntennaGain=diverseAntennaGain, remoteSecondaryIPAddress=remoteSecondaryIPAddress, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, activeAvailableTime=activeAvailableTime, rFUTxPowerAlarm=rFUTxPowerAlarm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, radioLicenseModulation=radioLicenseModulation, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sNMPPortNumber=sNMPPortNumber, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, managementPortWirelessDownAlert=managementPortWirelessDownAlert, altitude=altitude, productVariant=productVariant, syslogClientTrap=syslogClientTrap, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, sNTPServerTableEntry=sNTPServerTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, iPv6GatewayAddress=iPv6GatewayAddress, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, unitOutOfCalibration=unitOutOfCalibration, phyStatus=phyStatus, sNTPServerTimeout=sNTPServerTimeout, endId=endId, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapVersion=sNMPTrapVersion, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, sNTPPollInterval=sNTPPollInterval, managementCommittedInformationRate=managementCommittedInformationRate, rfu=rfu, subnetMask=subnetMask, softwareVersion=softwareVersion, dataPortConfigurationMismatch=dataPortConfigurationMismatch, transmitModulation=transmitModulation, radioLicenseRegion=radioLicenseRegion, radioLicenseMaxEIRP=radioLicenseMaxEIRP, transmitCapacity=transmitCapacity, remoteInternetAddress=remoteInternetAddress, ptpTraps=ptpTraps, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, userName=userName, radioLicenseMinCodeRate=radioLicenseMinCodeRate, sNTPServerTable=sNTPServerTable, wirelessLinkAvailability=wirelessLinkAvailability, activeUnit=activeUnit, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, latitude=latitude, protectionState=protectionState)
