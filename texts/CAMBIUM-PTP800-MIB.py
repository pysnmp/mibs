...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFURpsAlarm=rFURpsAlarm, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, radioLicenseRxFreq=radioLicenseRxFreq, rFUTxFreqMax=rFUTxFreqMax, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, sNMPTrapVersion=sNMPTrapVersion, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, radioLicenseCodeRate=radioLicenseCodeRate, linkLoss=linkLoss, rFURFSwitchAlarm=rFURFSwitchAlarm, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, vLANManagementVIDValidation=vLANManagementVIDValidation, sNMPPortNumber=sNMPPortNumber, activeWirelessLinkAvailability=activeWirelessLinkAvailability, ptp=ptp, l2CPPriorityTableIndex=l2CPPriorityTableIndex, protection=protection, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFUPowerButtonPressed=rFUPowerButtonPressed, iPv6Address=iPv6Address, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rFUTxPowerMax=rFUTxPowerMax, activeAvailableTime=activeAvailableTime, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, linkNameMismatchTrap=linkNameMismatchTrap, licence=licence, tFTPServerInternetAddress=tFTPServerInternetAddress, qOSPriorityScheme=qOSPriorityScheme, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, encryptionAlgorithm=encryptionAlgorithm, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, rFURxFreqMin=rFURxFreqMin, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, aAAControl=aAAControl, managementPortAutoNegotiation=managementPortAutoNegotiation, rFUTxMuteStatus=rFUTxMuteStatus, radioLicenseMinModulation=radioLicenseMinModulation, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPEnabledTraps=sNMPEnabledTraps, rFUTxPowerMin=rFUTxPowerMin, sNTPServerInternetAddressType=sNTPServerInternetAddressType, remoteInternetAddress=remoteInternetAddress, alarms=alarms, rFUConnectedPlatform=rFUConnectedPlatform, minCodeRate=minCodeRate, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, primarySecondaryMode=primarySecondaryMode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerResponse=sNTPServerResponse, secondarySoftwareVersion=secondarySoftwareVersion, vLANManagementVID=vLANManagementVID, neighborInternetAddressType=neighborInternetAddressType, encryption=encryption, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, ptpTraps=ptpTraps, vLANManagementPriority=vLANManagementPriority, sNMPTrapPortNumber=sNMPTrapPortNumber, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, latitude=latitude, iPv6GatewayAddress=iPv6GatewayAddress, altitude=altitude, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, remoteSecondaryIPAddress=remoteSecondaryIPAddress, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, securityLevel=securityLevel, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rFUStatusTrap=rFUStatusTrap, diverseRfFeederLoss=diverseRfFeederLoss, endId=endId, alignmentMode=alignmentMode, protectionConfig=protectionConfig, radioLicense=radioLicense, secureModeAlarmTrap=secureModeAlarmTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPVersion=iPVersion, rFUType=rFUType, sNTPServerIPAddress=sNTPServerIPAddress, protectionStats=protectionStats, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dataPortStatus=dataPortStatus, receivePower=receivePower, radioLicenseIdentifier=radioLicenseIdentifier, transmitPower=transmitPower, supplementary=supplementary, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, userTable=userTable, managementPortDisabledWarning=managementPortDisabledWarning, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rFURxFreqMax=rFURxFreqMax, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, remotePrimarySecondaryMode=remotePrimarySecondaryMode, sntp=sntp, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, protectionAvailabilityStatus=protectionAvailabilityStatus, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, ethernetFiberSupport=ethernetFiberSupport, primaryRecoveryPeriod=primaryRecoveryPeriod, diverseAntennaGain=diverseAntennaGain, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dataPortFiberStatus=dataPortFiberStatus, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, userEnabled=userEnabled, dSCPManagementPriority=dSCPManagementPriority, rFUTransceiverLocation=rFUTransceiverLocation, wirelessLinkStatus=wirelessLinkStatus, transmitterStatus=transmitterStatus, remotePrimaryInternetAddress=remotePrimaryInternetAddress, management=management, receiveCodeRate=receiveCodeRate, reset=reset, alignmentModeTrap=alignmentModeTrap, radioLicenseBandwidth=radioLicenseBandwidth, syslogClient=syslogClient, longitude=longitude, phyStatus=phyStatus, enableTransmission=enableTransmission, radioLicenseTxFreq=radioLicenseTxFreq, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, remoteIPAddress=remoteIPAddress, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, syslogClientTrap=syslogClientTrap, siteName=siteName, sNTPState=sNTPState, protectionInterfaceStatus=protectionInterfaceStatus, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, daylightSaving=daylightSaving, sMTPServerIPAddress=sMTPServerIPAddress, managementPortStatus=managementPortStatus, telnetPortNumber=telnetPortNumber, transmitModulation=transmitModulation, smtp=smtp, rFUFreqSpacing=rFUFreqSpacing, radioLicenseMaxEIRP=radioLicenseMaxEIRP, rxDiversityDataPortStatus=rxDiversityDataPortStatus, userRole=userRole, vectorError=vectorError, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ethernetPriorityTable=ethernetPriorityTable, dataPortDisabledWarning=dataPortDisabledWarning, activeUnit=activeUnit, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFUPlatformCompatibility=rFUPlatformCompatibility, linkNameMismatch=linkNameMismatch, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFUTxBandAboveRx=rFUTxBandAboveRx, primaryRecovery=primaryRecovery, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, protectionConfigurationStatus=protectionConfigurationStatus, iPv6PrefixLength=iPv6PrefixLength, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, encryptionEnabledMismatch=encryptionEnabledMismatch, dataPortStatusTrap=dataPortStatusTrap, radioLicenseRegion=radioLicenseRegion, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, transmitCapacity=transmitCapacity, transmitCapacityLimit=transmitCapacityLimit, wirelessLinkStatusTrap=wirelessLinkStatusTrap, tFTPServerPortNumber=tFTPServerPortNumber, rFULockoutAlarm=rFULockoutAlarm, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, managementCommittedInformationRate=managementCommittedInformationRate, syslogStateTrap=syslogStateTrap, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, ptmp=ptmp, configuration=configuration, numberOfAntennas=numberOfAntennas, protectionStateTrap=protectionStateTrap, userName=userName, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitCodeRate=transmitCodeRate, sNMPTrapIPAddress=sNMPTrapIPAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, remotePrimaryMACAddress=remotePrimaryMACAddress, rFUStatus=rFUStatus, bridge=bridge, rFUTxFreqMin=rFUTxFreqMin, receiveModulation=receiveModulation, unitOutOfCalibration=unitOutOfCalibration, ptp800=ptp800, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, aggregateDataRate=aggregateDataRate, radioLicenseMaxModulation=radioLicenseMaxModulation, maxCodeRate=maxCodeRate, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rFUVersionBank2=rFUVersionBank2, sNMPCommunityString=sNMPCommunityString, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerTable=sNTPServerTable, rFURfBand=rFURfBand, sNTPPollInterval=sNTPPollInterval, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPSyncTrap=sNTPSyncTrap, rFUCableAlarm=rFUCableAlarm, systemClock=systemClock, ethernetPriorityTableEntry=ethernetPriorityTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, hTTPAccessEnabled=hTTPAccessEnabled, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rxDiversityVid=rxDiversityVid, remoteInternetAddressType=remoteInternetAddressType, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, radioLicenseModulation=radioLicenseModulation, radioLicenseMinCodeRate=radioLicenseMinCodeRate, neighborInternetAddress=neighborInternetAddress, protectionState=protectionState, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitCapacityLimitDetail=transmitCapacityLimitDetail, timeZone=timeZone, productName=productName, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, phyControl=phyControl, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, telnetAccessEnabled=telnetAccessEnabled, ethernetPriorityTableIndex=ethernetPriorityTableIndex, gatewayIPAddress=gatewayIPAddress, l2CPPriorityTable=l2CPPriorityTable, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, requestedProtectionState=requestedProtectionState, neighborMACAddress=neighborMACAddress, localPacketFiltering=localPacketFiltering, sMTPEmailAlert=sMTPEmailAlert, userTableIndex=userTableIndex, secureModeAlarm=secureModeAlarm, userTableEntry=userTableEntry, antennaGain=antennaGain, sMTPEnabledMessages=sMTPEnabledMessages, neighborIPAddress=neighborIPAddress, remoteMACAddress=remoteMACAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPTrapTable=sNMPTrapTable, hTTPPortNumber=hTTPPortNumber, userPassword=userPassword, rFUActiveFirmwareBank=rFUActiveFirmwareBank, cambium=cambium, protectionSwitchCause=protectionSwitchCause, sNTPServerTableEntry=sNTPServerTableEntry, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, productVariant=productVariant, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rFUBranchingConfiguration=rFUBranchingConfiguration, hTTPSPortNumber=hTTPSPortNumber, aTPCEnable=aTPCEnable, sNTPSync=sNTPSync, syslogControl=syslogControl, hardwareVersion=hardwareVersion, rFUTxPowerAlarm=rFUTxPowerAlarm, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortFiberStatusTrap=dataPortFiberStatusTrap, versions=versions, softwareVersion=softwareVersion, rfu=rfu, maxModulation=maxModulation, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, fiberY=fiberY, iFCableLength=iFCableLength, rFUSerial=rFUSerial, protectionStatus=protectionStatus, receiveDataRate=receiveDataRate, userTableNumber=userTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, minModulation=minModulation, sNTPServerPortNumber=sNTPServerPortNumber, iPv4Address=iPv4Address, sNTPLastSync=sNTPLastSync, rFUPowerAlarm=rFUPowerAlarm, managementMode=managementMode, maximumTransmitPower=maximumTransmitPower, sMTPServerPortNumber=sMTPServerPortNumber, managementPortForcedConfiguration=managementPortForcedConfiguration, radioLicenseBand=radioLicenseBand, bootVersion=bootVersion, rFFeederLoss=rFFeederLoss, sNTPServerTimeout=sNTPServerTimeout, rFUVersionBank1=rFUVersionBank1, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dataPortPauseFrames=dataPortPauseFrames, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, subnetMask=subnetMask, pubStats=pubStats, sNTPPrimaryServer=sNTPPrimaryServer, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rFUProtectionCompatibility=rFUProtectionCompatibility, transmitDataRate=transmitDataRate, systemReset=systemReset, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, faultProtectionSwitching=faultProtectionSwitching, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, remotePrimaryIPAddress=remotePrimaryIPAddress, syslogState=syslogState, rxDiversityVlanTpid=rxDiversityVlanTpid, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, managementPortStatusTrap=managementPortStatusTrap, snmpControl=snmpControl, linkName=linkName, sNTPServerTableNumber=sNTPServerTableNumber, ethernet=ethernet, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerRetries=sNTPServerRetries)
