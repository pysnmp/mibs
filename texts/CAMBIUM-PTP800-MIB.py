...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNTPSync=sNTPSync, rFUTxBandAboveRx=rFUTxBandAboveRx, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPPrimaryServer=sNTPPrimaryServer, neighborIPAddress=neighborIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, rFULockoutAlarm=rFULockoutAlarm, softwareVersion=softwareVersion, radioLicenseIdentifier=radioLicenseIdentifier, radioLicenseRegion=radioLicenseRegion, linkName=linkName, ptp=ptp, managementMode=managementMode, sNTPServerTable=sNTPServerTable, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, radioLicenseMinModulation=radioLicenseMinModulation, sMTPEnabledMessages=sMTPEnabledMessages, userTable=userTable, radioLicenseTxFreq=radioLicenseTxFreq, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, alignmentModeTrap=alignmentModeTrap, ptpTraps=ptpTraps, sNMPTrapVersion=sNMPTrapVersion, protectionConfigurationStatus=protectionConfigurationStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, transmitCodeRate=transmitCodeRate, mPLSTCPriorityTable=mPLSTCPriorityTable, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, primarySecondaryMode=primarySecondaryMode, rxDiversityVid=rxDiversityVid, iPv6PrefixLength=iPv6PrefixLength, ethernetPriorityTable=ethernetPriorityTable, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, tFTPServerIPAddress=tFTPServerIPAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, l2CPPriorityTable=l2CPPriorityTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, dataPortPauseFrames=dataPortPauseFrames, productName=productName, rFUSerial=rFUSerial, iPv4Address=iPv4Address, transmitCapacity=transmitCapacity, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, dataPortFiberStatusTrap=dataPortFiberStatusTrap, remotePrimaryIPAddress=remotePrimaryIPAddress, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, neighborInternetAddressType=neighborInternetAddressType, rFUActiveFirmwareBank=rFUActiveFirmwareBank, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rFURFSwitchAlarm=rFURFSwitchAlarm, dataPortFiberStatus=dataPortFiberStatus, hardwareVersion=hardwareVersion, diverseRfFeederLoss=diverseRfFeederLoss, sMTPServerPortNumber=sMTPServerPortNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, remotePrimarySecondaryMode=remotePrimarySecondaryMode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, requestedProtectionState=requestedProtectionState, telnetAccessEnabled=telnetAccessEnabled, alignmentMode=alignmentMode, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remoteSecondaryIPAddress=remoteSecondaryIPAddress, minCodeRate=minCodeRate, sNTPServerIPAddress=sNTPServerIPAddress, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, primaryRecovery=primaryRecovery, rFURxFreqMax=rFURxFreqMax, radioLicenseRxFreq=radioLicenseRxFreq, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, encryptionEnabledMismatch=encryptionEnabledMismatch, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFUVersionBank2=rFUVersionBank2, transmitterStatus=transmitterStatus, syslogClientTrap=syslogClientTrap, rFURpsAlarm=rFURpsAlarm, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, management=management, protection=protection, subnetMask=subnetMask, linkNameMismatch=linkNameMismatch, siteName=siteName, secondarySoftwareVersion=secondarySoftwareVersion, userTableEntry=userTableEntry, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, ptp800=ptp800, protectionSwitchCause=protectionSwitchCause, systemReset=systemReset, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, activeUnit=activeUnit, neighborInternetAddress=neighborInternetAddress, qOSPriorityScheme=qOSPriorityScheme, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, numberOfAntennas=numberOfAntennas, rFUStatus=rFUStatus, rFUPlatformCompatibility=rFUPlatformCompatibility, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFUCableAlarm=rFUCableAlarm, dataPortDisabledWarning=dataPortDisabledWarning, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveDataRate=receiveDataRate, syslogControl=syslogControl, sMTPSourceEmailAddress=sMTPSourceEmailAddress, fiberY=fiberY, alarms=alarms, diverseAntennaGain=diverseAntennaGain, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, smtp=smtp, protectionStatus=protectionStatus, minModulation=minModulation, rFUTxMuteStatus=rFUTxMuteStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, reset=reset, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, vLANManagementVIDValidation=vLANManagementVIDValidation, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPServerInternetAddress=tFTPServerInternetAddress, protectionStats=protectionStats, aTPCEnable=aTPCEnable, iPv6GatewayAddress=iPv6GatewayAddress, maxModulation=maxModulation, latitude=latitude, activeAvailableTime=activeAvailableTime, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rFUVersionBank1=rFUVersionBank1, wirelessLinkStatus=wirelessLinkStatus, receiveCodeRate=receiveCodeRate, rFUTxFreqMin=rFUTxFreqMin, phyStatus=phyStatus, versions=versions, sNTPServerInternetAddressType=sNTPServerInternetAddressType, hTTPSAccessEnabled=hTTPSAccessEnabled, rxDiversityDataPortStatus=rxDiversityDataPortStatus, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, secureModeAlarmTrap=secureModeAlarmTrap, receivePower=receivePower, managementPortDisabledWarning=managementPortDisabledWarning, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, dataPortStatusTrap=dataPortStatusTrap, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, ptmp=ptmp, hTTPPortNumber=hTTPPortNumber, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, securityLevel=securityLevel, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFUTxPowerMin=rFUTxPowerMin, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogClient=syslogClient, productVariant=productVariant, phyControl=phyControl, iPv6Address=iPv6Address, sNTPPollInterval=sNTPPollInterval, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, protectionInterfaceStatus=protectionInterfaceStatus, rFFeederLoss=rFFeederLoss, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, dataPortConfigurationMismatch=dataPortConfigurationMismatch, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, pubStats=pubStats, unitOutOfCalibration=unitOutOfCalibration, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telnetPortNumber=telnetPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, rFUTxPowerMax=rFUTxPowerMax, maxCodeRate=maxCodeRate, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteInternetAddressType=remoteInternetAddressType, gatewayIPAddress=gatewayIPAddress, altitude=altitude, rFUPowerButtonPressed=rFUPowerButtonPressed, remoteSecondaryMACAddress=remoteSecondaryMACAddress, sNMPCommunityString=sNMPCommunityString, userRole=userRole, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, protectionAvailabilityStatus=protectionAvailabilityStatus, linkNameMismatchTrap=linkNameMismatchTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, radioLicenseCodeRate=radioLicenseCodeRate, timeZone=timeZone, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, bootVersion=bootVersion, managementPortConfigurationMismatch=managementPortConfigurationMismatch, encryptionAlgorithm=encryptionAlgorithm, vLANManagementVID=vLANManagementVID, hTTPSPortNumber=hTTPSPortNumber, wirelessLinkStatusTrap=wirelessLinkStatusTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, sMTPServerIPAddress=sMTPServerIPAddress, transmitCapacityLimit=transmitCapacityLimit, activeWirelessLinkAvailability=activeWirelessLinkAvailability, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFUTxPowerAlarm=rFUTxPowerAlarm, rFUTxFreqMax=rFUTxFreqMax, protectionConfig=protectionConfig, rFUStatusTrap=rFUStatusTrap, managementPortStatus=managementPortStatus, vectorError=vectorError, protectionState=protectionState, remoteIPAddress=remoteIPAddress, rxDiversityVlanTpid=rxDiversityVlanTpid, vLANManagementPriority=vLANManagementPriority, tFTPServerPortNumber=tFTPServerPortNumber, transmitDataRate=transmitDataRate, rFUPowerAlarm=rFUPowerAlarm, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rFURfBand=rFURfBand, iPVersion=iPVersion, sNMPTrapTable=sNMPTrapTable, systemClock=systemClock, cambium=cambium, sNTPServerTableEntry=sNTPServerTableEntry, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rFUTransceiverLocation=rFUTransceiverLocation, userName=userName, encryption=encryption, syslogState=syslogState, syslogStateTrap=syslogStateTrap, ptpTrapPrefix=ptpTrapPrefix, daylightSaving=daylightSaving, radioLicenseMinCodeRate=radioLicenseMinCodeRate, remotePrimaryInternetAddress=remotePrimaryInternetAddress, bridge=bridge, ethernetFiberSupport=ethernetFiberSupport, transmitPower=transmitPower, neighborMACAddress=neighborMACAddress, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, radioLicenseModulation=radioLicenseModulation, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerTimeout=sNTPServerTimeout, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sNTPServerTableIndex=sNTPServerTableIndex, aggregateDataRate=aggregateDataRate, wirelessLinkAvailability=wirelessLinkAvailability, rFUProtectionCompatibility=rFUProtectionCompatibility, ethernet=ethernet, managementCommittedInformationRate=managementCommittedInformationRate, snmpControl=snmpControl, rFURxFreqMin=rFURxFreqMin, iPDSCPPriorityTable=iPDSCPPriorityTable, receiveModulation=receiveModulation, sNTPServerResponse=sNTPServerResponse, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, localPacketFiltering=localPacketFiltering, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, remoteMACAddress=remoteMACAddress, managementPortStatusTrap=managementPortStatusTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, protectionStateTrap=protectionStateTrap, configuration=configuration, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rFUConnectedPlatform=rFUConnectedPlatform, radioLicense=radioLicense, rFUBranchingConfiguration=rFUBranchingConfiguration, sNMPPortNumber=sNMPPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licence=licence, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, secureModeAlarm=secureModeAlarm, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, transmitModulation=transmitModulation, sNTPServerInternetAddress=sNTPServerInternetAddress, hTTPAccessEnabled=hTTPAccessEnabled, userTableNumber=userTableNumber, rfu=rfu, userPassword=userPassword, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, managementPortAutoNegotiation=managementPortAutoNegotiation, userEnabled=userEnabled, sNTPSyncTrap=sNTPSyncTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rFUType=rFUType, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPEmailAlert=sMTPEmailAlert, dataPortStatus=dataPortStatus, managementPortForcedConfiguration=managementPortForcedConfiguration, aAAControl=aAAControl, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dSCPManagementPriority=dSCPManagementPriority, sNTPServerRetries=sNTPServerRetries, faultProtectionSwitching=faultProtectionSwitching, radioLicenseBand=radioLicenseBand, enableTransmission=enableTransmission, radioLicenseBandwidth=radioLicenseBandwidth, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, sNTPLastSync=sNTPLastSync, endId=endId, sntp=sntp, sNTPState=sNTPState, supplementary=supplementary, linkLoss=linkLoss, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, primaryRecoveryPeriod=primaryRecoveryPeriod, sNMPTrapIPAddress=sNMPTrapIPAddress, maximumTransmitPower=maximumTransmitPower, userTableIndex=userTableIndex, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rFUFreqSpacing=rFUFreqSpacing, antennaGain=antennaGain, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, longitude=longitude, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, remoteInternetAddress=remoteInternetAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitCapacityLimitDetail=transmitCapacityLimitDetail, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, radioLicenseMaxModulation=radioLicenseMaxModulation, remotePrimaryMACAddress=remotePrimaryMACAddress, iFCableLength=iFCableLength, sNTPServerTableNumber=sNTPServerTableNumber)
