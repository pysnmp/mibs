...
enterprises, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, Gauge32, ModuleIdentity, Unsigned32, Counter64, iso, IpAddress, Bits, Counter32, TimeTicks, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "Gauge32", "ModuleIdentity", "Unsigned32", "Counter64", "iso", "IpAddress", "Bits", "Counter32", "TimeTicks", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", activeUnit=activeUnit, rFUPowerButtonPressed=rFUPowerButtonPressed, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerTimeout=sNTPServerTimeout, linkLoss=linkLoss, managementPortStatusTrap=managementPortStatusTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, cambium=cambium, siteName=siteName, transmitCodeRate=transmitCodeRate, sNMPTrapTableIndex=sNMPTrapTableIndex, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, hardwareVersion=hardwareVersion, remoteInternetAddressType=remoteInternetAddressType, rFUTxFreqMax=rFUTxFreqMax, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, numberOfAntennas=numberOfAntennas, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, unitOutOfCalibration=unitOutOfCalibration, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, reset=reset, vectorError=vectorError, tFTPServerPortNumber=tFTPServerPortNumber, sNTPSync=sNTPSync, antennaGain=antennaGain, rFUStatusTrap=rFUStatusTrap, enableTransmission=enableTransmission, longitude=longitude, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, remotePrimaryMACAddress=remotePrimaryMACAddress, receiveModulation=receiveModulation, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, sNMPTrapIPAddress=sNMPTrapIPAddress, neighborMACAddress=neighborMACAddress, primaryRecovery=primaryRecovery, rFURpsAlarm=rFURpsAlarm, subnetMask=subnetMask, iPv6GatewayAddress=iPv6GatewayAddress, syslogControl=syslogControl, rfu=rfu, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, remoteIPAddress=remoteIPAddress, minCodeRate=minCodeRate, sNTPLastSync=sNTPLastSync, daylightSaving=daylightSaving, sNTPServerTableIndex=sNTPServerTableIndex, protectionConfigurationStatus=protectionConfigurationStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, activeWirelessLinkAvailability=activeWirelessLinkAvailability, l2CPPriorityTableEntry=l2CPPriorityTableEntry, l2CPPriorityTable=l2CPPriorityTable, userRole=userRole, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, smtp=smtp, tFTPServerInternetAddressType=tFTPServerInternetAddressType, neighborInternetAddress=neighborInternetAddress, transmitCapacity=transmitCapacity, syslogStateTrap=syslogStateTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, supplementary=supplementary, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, alarms=alarms, radioLicenseTxFreq=radioLicenseTxFreq, userTableIndex=userTableIndex, management=management, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, managementPortForcedConfiguration=managementPortForcedConfiguration, maxModulation=maxModulation, primarySecondaryMode=primarySecondaryMode, wirelessLinkStatusTrap=wirelessLinkStatusTrap, gatewayIPAddress=gatewayIPAddress, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, minModulation=minModulation, dataPortDisabledWarning=dataPortDisabledWarning, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPPortNumber=sNMPPortNumber, sNTPServerRetries=sNTPServerRetries, remotePrimaryInternetAddress=remotePrimaryInternetAddress, protection=protection, alignmentMode=alignmentMode, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sntp=sntp, remoteSecondaryMACAddress=remoteSecondaryMACAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, iPDSCPPriorityTable=iPDSCPPriorityTable, rFUTxBandAboveRx=rFUTxBandAboveRx, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, softwareVersion=softwareVersion, managementMode=managementMode, hTTPPortNumber=hTTPPortNumber, protectionStats=protectionStats, sNMPTrapPortNumber=sNMPTrapPortNumber, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, neighborIPAddress=neighborIPAddress, rFUActiveFirmwareBank=rFUActiveFirmwareBank, radioLicense=radioLicense, aggregateDataRate=aggregateDataRate, remotePrimaryIPAddress=remotePrimaryIPAddress, bridge=bridge, transmitPower=transmitPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkName=linkName, sMTPEnabledMessages=sMTPEnabledMessages, sNTPState=sNTPState, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, configuration=configuration, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, aTPCEnable=aTPCEnable, sMTPServerInternetAddress=sMTPServerInternetAddress, protectionAvailabilityStatus=protectionAvailabilityStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, requestedProtectionState=requestedProtectionState, endId=endId, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPServerTable=sNTPServerTable, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licence=licence, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, hTTPSPortNumber=hTTPSPortNumber, transmitDataRate=transmitDataRate, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, securityLevel=securityLevel, activeAvailableTime=activeAvailableTime, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, remoteMACAddress=remoteMACAddress, linkNameMismatch=linkNameMismatch, encryptionEnabledMismatch=encryptionEnabledMismatch, maximumTransmitPower=maximumTransmitPower, sNTPServerResponse=sNTPServerResponse, sNMPCommunityString=sNMPCommunityString, transmitCapacityLimitDetail=transmitCapacityLimitDetail, diverseAntennaGain=diverseAntennaGain, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, linkNameMismatchTrap=linkNameMismatchTrap, radioLicenseMaxModulation=radioLicenseMaxModulation, versions=versions, tFTPServerInternetAddress=tFTPServerInternetAddress, dataPortStatusTrap=dataPortStatusTrap, rxDiversityVlanTpid=rxDiversityVlanTpid, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFUSerial=rFUSerial, vLANManagementPriority=vLANManagementPriority, sMTPServerIPAddress=sMTPServerIPAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, receiveCodeRate=receiveCodeRate, rFUTxPowerMax=rFUTxPowerMax, phyControl=phyControl, iPv6Address=iPv6Address, latitude=latitude, secondarySoftwareVersion=secondarySoftwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, radioLicenseIdentifier=radioLicenseIdentifier, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, managementPortAutoNegotiation=managementPortAutoNegotiation, timeZone=timeZone, remoteInternetAddress=remoteInternetAddress, sNTPPrimaryServer=sNTPPrimaryServer, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, aAAControl=aAAControl, sNTPServerTableEntry=sNTPServerTableEntry, sNTPServerIPAddress=sNTPServerIPAddress, rFUConnectedPlatform=rFUConnectedPlatform, sNMPTrapTableEntry=sNMPTrapTableEntry, rFUType=rFUType, rxDiversityDataPortStatus=rxDiversityDataPortStatus, pubStats=pubStats, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, mPLSTCPriorityTable=mPLSTCPriorityTable, rFULockoutAlarm=rFULockoutAlarm, rFURfBand=rFURfBand, radioLicenseRxFreq=radioLicenseRxFreq, productName=productName, userName=userName, rFUBranchingConfiguration=rFUBranchingConfiguration, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ptp800=ptp800, faultProtectionSwitching=faultProtectionSwitching, rFUFreqSpacing=rFUFreqSpacing, userTable=userTable, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, diverseRfFeederLoss=diverseRfFeederLoss, rFFeederLoss=rFFeederLoss, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, managementPortConfigurationMismatch=managementPortConfigurationMismatch, radioLicenseBandwidth=radioLicenseBandwidth, sNTPServerPortNumber=sNTPServerPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, alignmentModeTrap=alignmentModeTrap, sNTPSyncTrap=sNTPSyncTrap, qOSPriorityScheme=qOSPriorityScheme, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, vLANManagementVIDValidation=vLANManagementVIDValidation, rxDiversityVid=rxDiversityVid, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapTableNumber=sNMPTrapTableNumber, radioLicenseMinModulation=radioLicenseMinModulation, neighborInternetAddressType=neighborInternetAddressType, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, protectionInterfaceStatus=protectionInterfaceStatus, transmitterStatus=transmitterStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, sNMPTrapVersion=sNMPTrapVersion, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rFUPlatformCompatibility=rFUPlatformCompatibility, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rFUTxPowerMin=rFUTxPowerMin, protectionStateTrap=protectionStateTrap, sNTPPollInterval=sNTPPollInterval, ethernetPriorityTable=ethernetPriorityTable, wirelessLinkStatus=wirelessLinkStatus, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, dataPortStatus=dataPortStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dSCPManagementPriority=dSCPManagementPriority, sNTPServerTableNumber=sNTPServerTableNumber, syslogState=syslogState, receivePower=receivePower, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, vLANManagementVID=vLANManagementVID, sMTPServerInternetAddressType=sMTPServerInternetAddressType, rFUVersionBank2=rFUVersionBank2, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, localPacketFiltering=localPacketFiltering, sNMPTrapInternetAddress=sNMPTrapInternetAddress, secureModeAlarmTrap=secureModeAlarmTrap, systemClock=systemClock, userTableNumber=userTableNumber, syslogClientTrap=syslogClientTrap, rFUProtectionCompatibility=rFUProtectionCompatibility, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, phyStatus=phyStatus, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, encryption=encryption, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTable=sNMPTrapTable, ptp=ptp, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, productVariant=productVariant, userEnabled=userEnabled, rFUTxFreqMin=rFUTxFreqMin, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sMTPSourceEmailAddress=sMTPSourceEmailAddress, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFUCableAlarm=rFUCableAlarm, protectionConfig=protectionConfig, radioLicenseModulation=radioLicenseModulation, rFUVersionBank1=rFUVersionBank1, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, telnetPortNumber=telnetPortNumber, iPv6PrefixLength=iPv6PrefixLength, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rFURFSwitchAlarm=rFURFSwitchAlarm, rFUStatus=rFUStatus, transmitCapacityLimit=transmitCapacityLimit, remotePrimarySecondaryMode=remotePrimarySecondaryMode, protectionState=protectionState, ptmp=ptmp, bootVersion=bootVersion, rFUTxMuteStatus=rFUTxMuteStatus, hTTPAccessEnabled=hTTPAccessEnabled, secureModeAlarm=secureModeAlarm, fiberY=fiberY, iFCableLength=iFCableLength, dataPortPauseFrames=dataPortPauseFrames, syslogClient=syslogClient, ethernet=ethernet, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rFUTransceiverLocation=rFUTransceiverLocation, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, radioLicenseMaxEIRP=radioLicenseMaxEIRP, managementPortStatus=managementPortStatus, radioLicenseBand=radioLicenseBand, encryptionAlgorithm=encryptionAlgorithm, snmpControl=snmpControl, radioLicenseRegion=radioLicenseRegion, transmitModulation=transmitModulation, userPassword=userPassword, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rFUPowerAlarm=rFUPowerAlarm, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rFUTxPowerAlarm=rFUTxPowerAlarm, rFURxFreqMin=rFURxFreqMin, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, primaryRecoveryPeriod=primaryRecoveryPeriod, ptpTrapPrefix=ptpTrapPrefix, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rFURxFreqMax=rFURxFreqMax, userTableEntry=userTableEntry, altitude=altitude, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, telnetAccessEnabled=telnetAccessEnabled, remoteSecondaryIPAddress=remoteSecondaryIPAddress, iPv4Address=iPv4Address, radioLicenseMinCodeRate=radioLicenseMinCodeRate, receiveDataRate=receiveDataRate, dataPortFiberStatus=dataPortFiberStatus, managementCommittedInformationRate=managementCommittedInformationRate, ptpTraps=ptpTraps, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, tFTPServerIPAddress=tFTPServerIPAddress, ethernetFiberSupport=ethernetFiberSupport, protectionSwitchCause=protectionSwitchCause, systemReset=systemReset, maxCodeRate=maxCodeRate, protectionStatus=protectionStatus, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, sMTPEmailAlert=sMTPEmailAlert, radioLicenseCodeRate=radioLicenseCodeRate, sMTPServerPortNumber=sMTPServerPortNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, managementPortDisabledWarning=managementPortDisabledWarning, iPVersion=iPVersion)
