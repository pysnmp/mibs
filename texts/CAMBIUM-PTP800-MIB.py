...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", vectorError=vectorError, managementPortStatusTrap=managementPortStatusTrap, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapInternetAddress=sNMPTrapInternetAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, transmitCapacityLimit=transmitCapacityLimit, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, timeZone=timeZone, transmitPower=transmitPower, l2CPPriorityTableIndex=l2CPPriorityTableIndex, numberOfAntennas=numberOfAntennas, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, aAAControl=aAAControl, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, rxDiversityVid=rxDiversityVid, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, protectionState=protectionState, endId=endId, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkStatusTrap=wirelessLinkStatusTrap, remotePrimarySecondaryMode=remotePrimarySecondaryMode, radioLicenseRxFreq=radioLicenseRxFreq, vLANManagementVIDValidation=vLANManagementVIDValidation, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, qOSPriorityScheme=qOSPriorityScheme, unitOutOfCalibration=unitOutOfCalibration, remotePrimaryInternetAddress=remotePrimaryInternetAddress, longitude=longitude, linkNameMismatchTrap=linkNameMismatchTrap, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, transmitModulation=transmitModulation, rxDiversityVlanTpid=rxDiversityVlanTpid, protection=protection, alarms=alarms, userTableIndex=userTableIndex, ptmp=ptmp, protectionStats=protectionStats, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, sNTPPrimaryServer=sNTPPrimaryServer, phyControl=phyControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, managementCommittedInformationRate=managementCommittedInformationRate, sNTPServerTimeout=sNTPServerTimeout, rFUPlatformCompatibility=rFUPlatformCompatibility, rFUTransceiverLocation=rFUTransceiverLocation, phyStatus=phyStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetFiberSupport=ethernetFiberSupport, managementPortAutoNegotiation=managementPortAutoNegotiation, mPLSTCPriorityTable=mPLSTCPriorityTable, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, radioLicenseBand=radioLicenseBand, transmitCapacity=transmitCapacity, syslogClient=syslogClient, dataPortPauseFrames=dataPortPauseFrames, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, protectionInterfaceStatus=protectionInterfaceStatus, telnetPortNumber=telnetPortNumber, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, receiveCodeRate=receiveCodeRate, cambium=cambium, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, protectionSwitchCause=protectionSwitchCause, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, userRole=userRole, hTTPPortNumber=hTTPPortNumber, vLANManagementPriority=vLANManagementPriority, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, receivePower=receivePower, ethernetPriorityTable=ethernetPriorityTable, remoteInternetAddress=remoteInternetAddress, syslogControl=syslogControl, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, wirelessLinkAvailability=wirelessLinkAvailability, remoteMACAddress=remoteMACAddress, sNTPServerResponse=sNTPServerResponse, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rFUConnectedPlatform=rFUConnectedPlatform, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, maxCodeRate=maxCodeRate, daylightSaving=daylightSaving, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, sMTPServerPortNumber=sMTPServerPortNumber, encryption=encryption, aggregateDataRate=aggregateDataRate, faultProtectionSwitching=faultProtectionSwitching, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, userEnabled=userEnabled, rFURxFreqMax=rFURxFreqMax, transmitCapacityLimitDetail=transmitCapacityLimitDetail, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, protectionConfig=protectionConfig, userName=userName, encryptionAlgorithm=encryptionAlgorithm, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPServerRetries=sNTPServerRetries, fiberY=fiberY, radioLicenseMinCodeRate=radioLicenseMinCodeRate, userTable=userTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerTable=sNTPServerTable, userTableEntry=userTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPCommunityString=sNMPCommunityString, subnetMask=subnetMask, rxDiversityDataPortStatus=rxDiversityDataPortStatus, remoteIPAddress=remoteIPAddress, transmitDataRate=transmitDataRate, syslogState=syslogState, rFUBranchingConfiguration=rFUBranchingConfiguration, dataPortFiberStatusTrap=dataPortFiberStatusTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, remoteSecondaryIPAddress=remoteSecondaryIPAddress, radioLicense=radioLicense, protectionStatus=protectionStatus, rFUSerial=rFUSerial, radioLicenseCodeRate=radioLicenseCodeRate, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ptpTrapPrefix=ptpTrapPrefix, syslogClientTrap=syslogClientTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, bridge=bridge, rFUVersionBank1=rFUVersionBank1, dataPortConfigurationMismatch=dataPortConfigurationMismatch, iPv6PrefixLength=iPv6PrefixLength, rFUPowerAlarm=rFUPowerAlarm, activeAvailableTime=activeAvailableTime, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, secondarySoftwareVersion=secondarySoftwareVersion, alignmentModeTrap=alignmentModeTrap, sNMPTrapTable=sNMPTrapTable, rFUStatusTrap=rFUStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, configuration=configuration, iPv6GatewayAddress=iPv6GatewayAddress, rFUTxFreqMin=rFUTxFreqMin, ptp800=ptp800, protectionStateTrap=protectionStateTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, management=management, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, latitude=latitude, sNTPState=sNTPState, productVariant=productVariant, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, primarySecondaryMode=primarySecondaryMode, secureModeAlarm=secureModeAlarm, sNMPPortNumber=sNMPPortNumber, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, sMTPServerInternetAddress=sMTPServerInternetAddress, radioLicenseBandwidth=radioLicenseBandwidth, localPacketFiltering=localPacketFiltering, radioLicenseModulation=radioLicenseModulation, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, enableTransmission=enableTransmission, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, systemClock=systemClock, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, ptp=ptp, protectionAvailabilityStatus=protectionAvailabilityStatus, linkNameMismatch=linkNameMismatch, antennaGain=antennaGain, maxModulation=maxModulation, ethernet=ethernet, remoteInternetAddressType=remoteInternetAddressType, syslogStateTrap=syslogStateTrap, rFURfBand=rFURfBand, remoteSecondaryMACAddress=remoteSecondaryMACAddress, snmpControl=snmpControl, sNTPServerTableEntry=sNTPServerTableEntry, sNTPServerInternetAddress=sNTPServerInternetAddress, iFCableLength=iFCableLength, dataPortStatus=dataPortStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, hardwareVersion=hardwareVersion, maximumTransmitPower=maximumTransmitPower, diverseAntennaGain=diverseAntennaGain, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, neighborInternetAddressType=neighborInternetAddressType, userPassword=userPassword, rFUTxFreqMax=rFUTxFreqMax, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, rFURpsAlarm=rFURpsAlarm, iPv4Address=iPv4Address, neighborIPAddress=neighborIPAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rFURFSwitchAlarm=rFURFSwitchAlarm, dSCPManagementPriority=dSCPManagementPriority, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, primaryRecovery=primaryRecovery, telnetAccessEnabled=telnetAccessEnabled, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, radioLicenseMinModulation=radioLicenseMinModulation, vLANManagementVID=vLANManagementVID, systemReset=systemReset, encryptionEnabledMismatch=encryptionEnabledMismatch, sntp=sntp, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, alignmentMode=alignmentMode, rFUVersionBank2=rFUVersionBank2, iPVersion=iPVersion, diverseRfFeederLoss=diverseRfFeederLoss, sNTPPollInterval=sNTPPollInterval, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, remotePrimaryMACAddress=remotePrimaryMACAddress, sNTPSyncTrap=sNTPSyncTrap, sNTPServerTableIndex=sNTPServerTableIndex, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, productName=productName, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, hTTPSPortNumber=hTTPSPortNumber, dataPortStatusTrap=dataPortStatusTrap, minCodeRate=minCodeRate, rFUTxPowerMin=rFUTxPowerMin, rFULockoutAlarm=rFULockoutAlarm, secureModeAlarmTrap=secureModeAlarmTrap, iPv6Address=iPv6Address, ethernetPriorityTableNumber=ethernetPriorityTableNumber, managementPortForcedConfiguration=managementPortForcedConfiguration, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerTableNumber=sNTPServerTableNumber, rFUTxMuteStatus=rFUTxMuteStatus, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, rFUFreqSpacing=rFUFreqSpacing, minModulation=minModulation)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", managementPortDisabledWarning=managementPortDisabledWarning, versions=versions, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, remotePrimaryIPAddress=remotePrimaryIPAddress, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFFeederLoss=rFFeederLoss, transmitterStatus=transmitterStatus, radioLicenseIdentifier=radioLicenseIdentifier, transmitCodeRate=transmitCodeRate, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, rFUTxPowerAlarm=rFUTxPowerAlarm, rfu=rfu, sNMPTrapTableEntry=sNMPTrapTableEntry, aTPCEnable=aTPCEnable, pubStats=pubStats, userTableNumber=userTableNumber, wirelessLinkStatus=wirelessLinkStatus, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rFURxFreqMin=rFURxFreqMin, rFUTxBandAboveRx=rFUTxBandAboveRx, bootVersion=bootVersion, sNTPServerIPAddress=sNTPServerIPAddress, reset=reset, rFUStatus=rFUStatus, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, receiveDataRate=receiveDataRate, l2CPPriorityTable=l2CPPriorityTable, ptpTraps=ptpTraps, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, protectionConfigurationStatus=protectionConfigurationStatus, primaryRecoveryPeriod=primaryRecoveryPeriod, sNMPTrapTableIndex=sNMPTrapTableIndex, rFUProtectionCompatibility=rFUProtectionCompatibility, managementMode=managementMode, licence=licence, hTTPAccessEnabled=hTTPAccessEnabled, softwareVersion=softwareVersion, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, sNMPTrapVersion=sNMPTrapVersion, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, altitude=altitude, tFTPServerInternetAddress=tFTPServerInternetAddress, rFUPowerButtonPressed=rFUPowerButtonPressed, managementPortWirelessDownAlert=managementPortWirelessDownAlert, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFUType=rFUType, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, siteName=siteName, managementPortStatus=managementPortStatus, radioLicenseRegion=radioLicenseRegion, activeWirelessLinkAvailability=activeWirelessLinkAvailability, syslogLocalWrappedTrap=syslogLocalWrappedTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPSync=sNTPSync, neighborInternetAddress=neighborInternetAddress, radioLicenseMaxModulation=radioLicenseMaxModulation, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, linkName=linkName, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, receiveModulation=receiveModulation, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, neighborMACAddress=neighborMACAddress, rFUCableAlarm=rFUCableAlarm, linkLoss=linkLoss, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tFTPServerIPAddress=tFTPServerIPAddress, sMTPServerIPAddress=sMTPServerIPAddress, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, requestedProtectionState=requestedProtectionState, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rFUTxPowerMax=rFUTxPowerMax, radioLicenseMaxEIRP=radioLicenseMaxEIRP, activeUnit=activeUnit, sNMPTrapPortNumber=sNMPTrapPortNumber, supplementary=supplementary, radioLicenseTxFreq=radioLicenseTxFreq, gatewayIPAddress=gatewayIPAddress, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, smtp=smtp, rFUActiveFirmwareBank=rFUActiveFirmwareBank, dataPortFiberStatus=dataPortFiberStatus, securityLevel=securityLevel, sNTPLastSync=sNTPLastSync, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap)
