...
iso, TimeTicks, ObjectIdentity, Integer32, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, NotificationType, IpAddress, ModuleIdentity, Unsigned32, Gauge32, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "ObjectIdentity", "Integer32", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "NotificationType", "IpAddress", "ModuleIdentity", "Unsigned32", "Gauge32", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, longitude=longitude, sMTPServerInternetAddressType=sMTPServerInternetAddressType, subnetMask=subnetMask, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, faultProtectionSwitching=faultProtectionSwitching, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, bootVersion=bootVersion, syslogStateTrap=syslogStateTrap, localPacketFiltering=localPacketFiltering, snmpControl=snmpControl, smtp=smtp, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, rFUStatusTrap=rFUStatusTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, iPDSCPPriorityTable=iPDSCPPriorityTable, userTableNumber=userTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPv4Address=iPv4Address, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, sNTPServerRetries=sNTPServerRetries, managementMode=managementMode, latitude=latitude, userTable=userTable, managementPortStatus=managementPortStatus, neighborIPAddress=neighborIPAddress, userName=userName, sNTPLastSync=sNTPLastSync, protectionStatus=protectionStatus, pubStats=pubStats, rFFeederLoss=rFFeederLoss, dataPortConfigurationMismatch=dataPortConfigurationMismatch, protectionConfigurationStatus=protectionConfigurationStatus, alignmentMode=alignmentMode, radioLicenseMaxEIRP=radioLicenseMaxEIRP, neighborInternetAddress=neighborInternetAddress, aTPCEnable=aTPCEnable, siteName=siteName, sNMPCommunityString=sNMPCommunityString, hTTPSAccessEnabled=hTTPSAccessEnabled, rFUPowerButtonPressed=rFUPowerButtonPressed, iPv6Address=iPv6Address, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, protectionAvailabilityStatus=protectionAvailabilityStatus, radioLicense=radioLicense, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, managementCommittedInformationRate=managementCommittedInformationRate, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, transmitPower=transmitPower, radioLicenseIdentifier=radioLicenseIdentifier, rFURfBand=rFURfBand, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, minCodeRate=minCodeRate, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, protectionConfig=protectionConfig, activeWirelessLinkAvailability=activeWirelessLinkAvailability, linkNameMismatch=linkNameMismatch, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, maxCodeRate=maxCodeRate, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernet=ethernet, secureModeAlarm=secureModeAlarm, ptmp=ptmp, rFUCableAlarm=rFUCableAlarm, userRole=userRole, maximumTransmitPower=maximumTransmitPower, remotePrimaryIPAddress=remotePrimaryIPAddress, syslogClientTrap=syslogClientTrap, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, dataPortDisabledWarning=dataPortDisabledWarning, syslogClient=syslogClient, sNMPPortNumber=sNMPPortNumber, securityLevel=securityLevel, rFUVersionBank2=rFUVersionBank2, secondarySoftwareVersion=secondarySoftwareVersion, enableTransmission=enableTransmission, rFUType=rFUType, minModulation=minModulation, rFUTxBandAboveRx=rFUTxBandAboveRx, hTTPPortNumber=hTTPPortNumber, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, rFUPowerAlarm=rFUPowerAlarm, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, remotePrimaryMACAddress=remotePrimaryMACAddress, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapVersion=sNMPTrapVersion, endId=endId, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, receiveModulation=receiveModulation, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, radioLicenseBand=radioLicenseBand, management=management, rFUTxFreqMin=rFUTxFreqMin, transmitModulation=transmitModulation, radioLicenseMinModulation=radioLicenseMinModulation, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFUConnectedPlatform=rFUConnectedPlatform, alarms=alarms, l2CPPriorityTable=l2CPPriorityTable, wirelessLinkAvailability=wirelessLinkAvailability, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rFUTxPowerAlarm=rFUTxPowerAlarm, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rxDiversityDataPortStatus=rxDiversityDataPortStatus, neighborMACAddress=neighborMACAddress, receiveDataRate=receiveDataRate, sNMPTrapTable=sNMPTrapTable, sNTPServerTableIndex=sNTPServerTableIndex, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemReset=systemReset, hTTPAccessEnabled=hTTPAccessEnabled, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, dataPortStatusTrap=dataPortStatusTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, transmitCapacityLimit=transmitCapacityLimit, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPServerPortNumber=sMTPServerPortNumber, userTableEntry=userTableEntry, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, protectionSwitchCause=protectionSwitchCause, sNTPPollInterval=sNTPPollInterval, sNTPServerIPAddress=sNTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPEmailAlert=sMTPEmailAlert, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, activeAvailableTime=activeAvailableTime, versions=versions, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rFURpsAlarm=rFURpsAlarm, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, dataPortWirelessDownAlert=dataPortWirelessDownAlert, l2CPPriorityTableNumber=l2CPPriorityTableNumber, radioLicenseModulation=radioLicenseModulation, rFUTxPowerMax=rFUTxPowerMax, ptp800=ptp800, licence=licence, sNTPServerPortNumber=sNTPServerPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rFUProtectionCompatibility=rFUProtectionCompatibility, primarySecondaryMode=primarySecondaryMode, sNTPServerTableEntry=sNTPServerTableEntry, syslogControl=syslogControl, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, remoteSecondaryIPAddress=remoteSecondaryIPAddress, productName=productName, rFULockoutAlarm=rFULockoutAlarm, linkLoss=linkLoss, sntp=sntp, tFTPServerIPAddress=tFTPServerIPAddress, rFUTransceiverLocation=rFUTransceiverLocation, hTTPSPortNumber=hTTPSPortNumber, remotePrimaryInternetAddress=remotePrimaryInternetAddress, vLANManagementVID=vLANManagementVID, systemClock=systemClock, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementPortStatusTrap=managementPortStatusTrap, radioLicenseRegion=radioLicenseRegion, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, receiveCodeRate=receiveCodeRate, l2CPPriorityTableEntry=l2CPPriorityTableEntry, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, sNTPServerTable=sNTPServerTable, configuration=configuration, unitOutOfCalibration=unitOutOfCalibration, requestedProtectionState=requestedProtectionState, hardwareVersion=hardwareVersion, linkName=linkName, rFUTxFreqMax=rFUTxFreqMax, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, encryptionAlgorithm=encryptionAlgorithm, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, sNTPServerInternetAddressType=sNTPServerInternetAddressType, remotePrimarySecondaryMode=remotePrimarySecondaryMode, diverseAntennaGain=diverseAntennaGain, rFUTxPowerMin=rFUTxPowerMin, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, encryption=encryption, altitude=altitude, iPVersion=iPVersion, rFUPlatformCompatibility=rFUPlatformCompatibility, ethernetFiberSupport=ethernetFiberSupport, remoteInternetAddress=remoteInternetAddress, protection=protection, activeUnit=activeUnit, transmitterStatus=transmitterStatus, tFTPServerPortNumber=tFTPServerPortNumber, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, qOSPriorityScheme=qOSPriorityScheme, primaryRecovery=primaryRecovery, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPEnabledTraps=sNMPEnabledTraps, iPv6PrefixLength=iPv6PrefixLength, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, remoteIPAddress=remoteIPAddress, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, syslogState=syslogState, supplementary=supplementary, ptpTraps=ptpTraps, sNTPSync=sNTPSync, dSCPManagementPriority=dSCPManagementPriority, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, phyStatus=phyStatus, radioLicenseRxFreq=radioLicenseRxFreq, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, transmitDataRate=transmitDataRate, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, timeZone=timeZone, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, numberOfAntennas=numberOfAntennas, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, gatewayIPAddress=gatewayIPAddress, sMTPServerIPAddress=sMTPServerIPAddress, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, sNMPTrapIPAddress=sNMPTrapIPAddress, userPassword=userPassword, remoteMACAddress=remoteMACAddress, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, maxModulation=maxModulation, managementPortDisabledWarning=managementPortDisabledWarning, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, protectionStateTrap=protectionStateTrap, encryptionEnabledMismatch=encryptionEnabledMismatch, protectionState=protectionState, managementPortAutoNegotiation=managementPortAutoNegotiation, dataPortPauseFrames=dataPortPauseFrames, sNTPServerResponse=sNTPServerResponse, aggregateDataRate=aggregateDataRate, sNTPPrimaryServer=sNTPPrimaryServer, userTableIndex=userTableIndex, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", phyControl=phyControl, sNTPServerTimeout=sNTPServerTimeout, neighborInternetAddressType=neighborInternetAddressType, sNMPTrapTableEntry=sNMPTrapTableEntry, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, transmitCapacity=transmitCapacity, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, receivePower=receivePower, sNTPServerInternetAddress=sNTPServerInternetAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sMTPEnabledMessages=sMTPEnabledMessages, telnetAccessEnabled=telnetAccessEnabled, iFCableLength=iFCableLength, primaryRecoveryPeriod=primaryRecoveryPeriod, productVariant=productVariant, diverseRfFeederLoss=diverseRfFeederLoss, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, iPv6GatewayAddress=iPv6GatewayAddress, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, ptp=ptp, sNTPState=sNTPState, rFURFSwitchAlarm=rFURFSwitchAlarm, rFUTxMuteStatus=rFUTxMuteStatus, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, radioLicenseMaxModulation=radioLicenseMaxModulation, rFUSerial=rFUSerial, remoteInternetAddressType=remoteInternetAddressType, rFURxFreqMin=rFURxFreqMin, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, ethernetPriorityTable=ethernetPriorityTable, userEnabled=userEnabled, radioLicenseCodeRate=radioLicenseCodeRate, radioLicenseBandwidth=radioLicenseBandwidth, ethernetPriorityTableNumber=ethernetPriorityTableNumber, protectionInterfaceStatus=protectionInterfaceStatus, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, rFUFreqSpacing=rFUFreqSpacing, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFUVersionBank1=rFUVersionBank1, managementPortForcedConfiguration=managementPortForcedConfiguration, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, daylightSaving=daylightSaving, protectionStats=protectionStats, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, secureModeAlarmTrap=secureModeAlarmTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, dataPortFiberStatus=dataPortFiberStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPSyncTrap=sNTPSyncTrap, linkNameMismatchTrap=linkNameMismatchTrap, vLANManagementPriority=vLANManagementPriority, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, reset=reset, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFUBranchingConfiguration=rFUBranchingConfiguration, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, aAAControl=aAAControl, radioLicenseTxFreq=radioLicenseTxFreq, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rxDiversityVid=rxDiversityVid, cambium=cambium, softwareVersion=softwareVersion, fiberY=fiberY, rxDiversityVlanTpid=rxDiversityVlanTpid, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vectorError=vectorError, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, transmitCodeRate=transmitCodeRate, alignmentModeTrap=alignmentModeTrap, vLANManagementVIDValidation=vLANManagementVIDValidation, rfu=rfu, telnetPortNumber=telnetPortNumber, bridge=bridge, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, antennaGain=antennaGain, wirelessLinkStatus=wirelessLinkStatus, transmitCapacityLimitDetail=transmitCapacityLimitDetail, rFUStatus=rFUStatus, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFURxFreqMax=rFURxFreqMax, wirelessLinkStatusTrap=wirelessLinkStatusTrap)
