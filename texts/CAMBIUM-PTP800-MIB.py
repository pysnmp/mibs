...
enterprises, Integer32, Counter32, ObjectIdentity, MibIdentifier, TimeTicks, ModuleIdentity, Bits, Unsigned32, NotificationType, IpAddress, iso, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "Counter32", "ObjectIdentity", "MibIdentifier", "TimeTicks", "ModuleIdentity", "Bits", "Unsigned32", "NotificationType", "IpAddress", "iso", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", syslogControl=syslogControl, latitude=latitude, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, remoteMACAddress=remoteMACAddress, protectionSwitchCause=protectionSwitchCause, sNMPTrapTable=sNMPTrapTable, daylightSaving=daylightSaving, neighborMACAddress=neighborMACAddress, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rFUStatus=rFUStatus, phyStatus=phyStatus, linkName=linkName, iPVersion=iPVersion, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, linkNameMismatchTrap=linkNameMismatchTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, encryptionEnabledMismatch=encryptionEnabledMismatch, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, licence=licence, radioLicenseMinModulation=radioLicenseMinModulation, radioLicenseBand=radioLicenseBand, rFUTxFreqMax=rFUTxFreqMax, receiveDataRate=receiveDataRate, rFURxFreqMax=rFURxFreqMax, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, configuration=configuration, userTableNumber=userTableNumber, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFUTxMuteStatus=rFUTxMuteStatus, rFUConnectedPlatform=rFUConnectedPlatform, activeWirelessLinkAvailability=activeWirelessLinkAvailability, syslogStateTrap=syslogStateTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPServerTableIndex=sNTPServerTableIndex, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rfu=rfu, managementPortAutoNegotiation=managementPortAutoNegotiation, sNMPTrapTableIndex=sNMPTrapTableIndex, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rFUProtectionCompatibility=rFUProtectionCompatibility, protectionConfigurationStatus=protectionConfigurationStatus, hTTPPortNumber=hTTPPortNumber, alarms=alarms, sNTPServerTimeout=sNTPServerTimeout, ethernet=ethernet, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortDisabledWarning=dataPortDisabledWarning, telnetAccessEnabled=telnetAccessEnabled, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, rFUTxPowerMin=rFUTxPowerMin, rFUSerial=rFUSerial, rFUStatusTrap=rFUStatusTrap, managementMode=managementMode, minModulation=minModulation, bridge=bridge, rxDiversityVid=rxDiversityVid, vLANManagementVID=vLANManagementVID, ptpTraps=ptpTraps, rFUPowerAlarm=rFUPowerAlarm, timeZone=timeZone, radioLicenseRxFreq=radioLicenseRxFreq, rFUActiveFirmwareBank=rFUActiveFirmwareBank, sMTPServerPortNumber=sMTPServerPortNumber, remoteSecondaryMACAddress=remoteSecondaryMACAddress, neighborInternetAddressType=neighborInternetAddressType, sMTPServerInternetAddress=sMTPServerInternetAddress, rFUCableAlarm=rFUCableAlarm, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPPrimaryServer=sNTPPrimaryServer, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, fiberY=fiberY, userName=userName, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, rFUPowerButtonPressed=rFUPowerButtonPressed, sNMPTrapInternetAddress=sNMPTrapInternetAddress, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapPortNumber=sNMPTrapPortNumber, protectionConfig=protectionConfig, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, management=management, linkLoss=linkLoss, secondarySoftwareVersion=secondarySoftwareVersion, cambium=cambium, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPServerTableEntry=sNTPServerTableEntry, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, sNTPPollInterval=sNTPPollInterval, ptmp=ptmp, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, secureModeAlarm=secureModeAlarm, radioLicenseIdentifier=radioLicenseIdentifier, softwareVersion=softwareVersion, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, remotePrimaryIPAddress=remotePrimaryIPAddress, alignmentMode=alignmentMode, rFUTxFreqMin=rFUTxFreqMin, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, radioLicenseCodeRate=radioLicenseCodeRate, ptp=ptp, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, radioLicenseMaxEIRP=radioLicenseMaxEIRP, telnetPortNumber=telnetPortNumber, dataPortPauseFrames=dataPortPauseFrames, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFURfBand=rFURfBand, remotePrimaryInternetAddress=remotePrimaryInternetAddress, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, protectionStats=protectionStats, wirelessLinkAvailability=wirelessLinkAvailability, encryptionAlgorithm=encryptionAlgorithm, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, siteName=siteName, sNTPState=sNTPState, endId=endId, iFCableLength=iFCableLength, managementPortStatusTrap=managementPortStatusTrap, qOSPriorityScheme=qOSPriorityScheme, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, requestedProtectionState=requestedProtectionState, aAAControl=aAAControl, productName=productName, aTPCEnable=aTPCEnable, faultProtectionSwitching=faultProtectionSwitching, sNMPPortNumber=sNMPPortNumber, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, protectionAvailabilityStatus=protectionAvailabilityStatus, sNTPServerIPAddress=sNTPServerIPAddress, remoteInternetAddress=remoteInternetAddress, bootVersion=bootVersion, managementPortStatus=managementPortStatus, sNTPServerTable=sNTPServerTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mPLSTCPriorityTable=mPLSTCPriorityTable, transmitPower=transmitPower, snmpControl=snmpControl, remotePrimaryMACAddress=remotePrimaryMACAddress, rFUTxBandAboveRx=rFUTxBandAboveRx, ethernetPriorityTable=ethernetPriorityTable, wirelessLinkStatus=wirelessLinkStatus, receiveModulation=receiveModulation, hTTPSPortNumber=hTTPSPortNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, minCodeRate=minCodeRate, maxModulation=maxModulation, transmitDataRate=transmitDataRate, rFUBranchingConfiguration=rFUBranchingConfiguration, transmitCapacityLimitDetail=transmitCapacityLimitDetail, userEnabled=userEnabled, dataPortStatusTrap=dataPortStatusTrap, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTableEntry=sNMPTrapTableEntry, linkNameMismatch=linkNameMismatch, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, vLANManagementPriority=vLANManagementPriority, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortFiberStatus=dataPortFiberStatus, alignmentModeTrap=alignmentModeTrap, neighborIPAddress=neighborIPAddress, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPv6PrefixLength=iPv6PrefixLength, sMTPEmailAlert=sMTPEmailAlert, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerIPAddress=tFTPServerIPAddress, protectionStatus=protectionStatus, userTable=userTable, tFTPServerPortNumber=tFTPServerPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, antennaGain=antennaGain, transmitCapacity=transmitCapacity, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, gatewayIPAddress=gatewayIPAddress, radioLicenseTxFreq=radioLicenseTxFreq, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rFURxFreqMin=rFURxFreqMin, remoteIPAddress=remoteIPAddress, radioLicenseModulation=radioLicenseModulation, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerPortNumber=sNTPServerPortNumber, managementPortDisabledWarning=managementPortDisabledWarning, sNTPServerRetries=sNTPServerRetries, radioLicense=radioLicense, l2CPPriorityTable=l2CPPriorityTable, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, altitude=altitude, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rFUVersionBank1=rFUVersionBank1, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, sNTPServerTableNumber=sNTPServerTableNumber, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, iPv6GatewayAddress=iPv6GatewayAddress, receivePower=receivePower, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, dataPortStatus=dataPortStatus, protectionInterfaceStatus=protectionInterfaceStatus, protectionState=protectionState, remoteInternetAddressType=remoteInternetAddressType, supplementary=supplementary, phyControl=phyControl, protectionStateTrap=protectionStateTrap, managementCommittedInformationRate=managementCommittedInformationRate, rFURpsAlarm=rFURpsAlarm, localPacketFiltering=localPacketFiltering, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, radioLicenseMaxModulation=radioLicenseMaxModulation, userRole=userRole, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rFUTransceiverLocation=rFUTransceiverLocation, primaryRecovery=primaryRecovery, maxCodeRate=maxCodeRate, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, primarySecondaryMode=primarySecondaryMode, sntp=sntp, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, vLANManagementVIDValidation=vLANManagementVIDValidation, transmitCapacityLimit=transmitCapacityLimit, activeAvailableTime=activeAvailableTime, rFUPlatformCompatibility=rFUPlatformCompatibility, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, userPassword=userPassword, remoteSecondaryIPAddress=remoteSecondaryIPAddress, userTableEntry=userTableEntry, rFULockoutAlarm=rFULockoutAlarm, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFURFSwitchAlarm=rFURFSwitchAlarm, syslogClientTrap=syslogClientTrap, ethernetFiberSupport=ethernetFiberSupport, l2CPPriorityTableEntry=l2CPPriorityTableEntry, neighborInternetAddress=neighborInternetAddress, secureModeAlarmTrap=secureModeAlarmTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, pubStats=pubStats, rFUVersionBank2=rFUVersionBank2)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", maximumTransmitPower=maximumTransmitPower, sMTPServerInternetAddressType=sMTPServerInternetAddressType, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, systemClock=systemClock, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, protection=protection, radioLicenseMinCodeRate=radioLicenseMinCodeRate, radioLicenseRegion=radioLicenseRegion, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, ethernetPriorityTableEntry=ethernetPriorityTableEntry, diverseRfFeederLoss=diverseRfFeederLoss, tFTPServerInternetAddress=tFTPServerInternetAddress, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, systemReset=systemReset, primaryRecoveryPeriod=primaryRecoveryPeriod, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, numberOfAntennas=numberOfAntennas, transmitModulation=transmitModulation, sNTPSync=sNTPSync, rFUFreqSpacing=rFUFreqSpacing, sMTPServerIPAddress=sMTPServerIPAddress, iPv6Address=iPv6Address, hTTPAccessEnabled=hTTPAccessEnabled, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, longitude=longitude, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, receiveCodeRate=receiveCodeRate, rxDiversityDataPortStatus=rxDiversityDataPortStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, managementPortForcedConfiguration=managementPortForcedConfiguration, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPLastSync=sNTPLastSync, hardwareVersion=hardwareVersion, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFFeederLoss=rFFeederLoss, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPServerResponse=sNTPServerResponse, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, dSCPManagementPriority=dSCPManagementPriority, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, userTableIndex=userTableIndex, transmitCodeRate=transmitCodeRate, remotePrimarySecondaryMode=remotePrimarySecondaryMode, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, unitOutOfCalibration=unitOutOfCalibration, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, reset=reset, ptp800=ptp800, iPv4Address=iPv4Address, syslogClient=syslogClient, enableTransmission=enableTransmission, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, productVariant=productVariant, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, activeUnit=activeUnit, aggregateDataRate=aggregateDataRate, transmitterStatus=transmitterStatus, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, smtp=smtp, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, sNMPCommunityString=sNMPCommunityString, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpTrapPrefix=ptpTrapPrefix, rFUTxPowerAlarm=rFUTxPowerAlarm, syslogState=syslogState, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, versions=versions, encryption=encryption, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rFUType=rFUType, rFUTxPowerMax=rFUTxPowerMax, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rxDiversityVlanTpid=rxDiversityVlanTpid, diverseAntennaGain=diverseAntennaGain, sNMPTrapVersion=sNMPTrapVersion, vectorError=vectorError, securityLevel=securityLevel, sNTPSyncTrap=sNTPSyncTrap, subnetMask=subnetMask, radioLicenseBandwidth=radioLicenseBandwidth)
