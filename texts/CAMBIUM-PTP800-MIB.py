...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, Integer32, Bits, iso, Counter64, NotificationType, MibIdentifier, enterprises, ObjectIdentity, Gauge32, NotificationType, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "Integer32", "Bits", "iso", "Counter64", "NotificationType", "MibIdentifier", "enterprises", "ObjectIdentity", "Gauge32", "NotificationType", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", managementPortForcedConfiguration=managementPortForcedConfiguration, minModulation=minModulation, diverseAntennaGain=diverseAntennaGain, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, endId=endId, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, transmitCapacity=transmitCapacity, vLANManagementVID=vLANManagementVID, rxDiversityVid=rxDiversityVid, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, vLANManagementVIDValidation=vLANManagementVIDValidation, sNTPSyncTrap=sNTPSyncTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, transmitterStatus=transmitterStatus, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sNTPServerTableIndex=sNTPServerTableIndex, receiveCodeRate=receiveCodeRate, l2CPPriorityTableEntry=l2CPPriorityTableEntry, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, managementMode=managementMode, sNTPState=sNTPState, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, syslogClientTrap=syslogClientTrap, receiveModulation=receiveModulation, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, hTTPSPortNumber=hTTPSPortNumber, requestedProtectionState=requestedProtectionState, primaryRecovery=primaryRecovery, transmitModulation=transmitModulation, sNTPServerResponse=sNTPServerResponse, remotePrimaryInternetAddress=remotePrimaryInternetAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, systemReset=systemReset, remotePrimaryIPAddress=remotePrimaryIPAddress, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, sNMPTrapTableEntry=sNMPTrapTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, sNTPServerTable=sNTPServerTable, linkNameMismatch=linkNameMismatch, radioLicenseMaxEIRP=radioLicenseMaxEIRP, radioLicenseMaxModulation=radioLicenseMaxModulation, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, cambium=cambium, remoteIPAddress=remoteIPAddress, remoteMACAddress=remoteMACAddress, radioLicenseModulation=radioLicenseModulation, transmitCodeRate=transmitCodeRate, secureModeAlarmTrap=secureModeAlarmTrap, syslogControl=syslogControl, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, versions=versions, radioLicenseRegion=radioLicenseRegion, syslogStateTrap=syslogStateTrap, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, alignmentModeTrap=alignmentModeTrap, receiveDataRate=receiveDataRate, sNMPTrapTableNumber=sNMPTrapTableNumber, telnetPortNumber=telnetPortNumber, rFUProtectionCompatibility=rFUProtectionCompatibility, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, localPacketFiltering=localPacketFiltering, sNMPPortNumber=sNMPPortNumber, remoteInternetAddress=remoteInternetAddress, productName=productName, linkNameMismatchTrap=linkNameMismatchTrap, bootVersion=bootVersion, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, maximumTransmitPower=maximumTransmitPower, ethernetPriorityTableIndex=ethernetPriorityTableIndex, snmpControl=snmpControl, sNTPLastSync=sNTPLastSync, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sntp=sntp, radioLicense=radioLicense, bridge=bridge, primaryRecoveryPeriod=primaryRecoveryPeriod, longitude=longitude, tFTPServerPortNumber=tFTPServerPortNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, subnetMask=subnetMask, rFUTransceiverLocation=rFUTransceiverLocation, managementPortAutoNegotiation=managementPortAutoNegotiation, reset=reset, radioLicenseBandwidth=radioLicenseBandwidth, sNTPServerTimeout=sNTPServerTimeout, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFUTxPowerMax=rFUTxPowerMax, managementPortConfigurationMismatch=managementPortConfigurationMismatch, protectionSwitchCause=protectionSwitchCause, radioLicenseMinCodeRate=radioLicenseMinCodeRate, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, radioLicenseRxFreq=radioLicenseRxFreq, userTableEntry=userTableEntry, alignmentMode=alignmentMode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, telnetAccessEnabled=telnetAccessEnabled, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, dataPortFiberStatus=dataPortFiberStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFUCableAlarm=rFUCableAlarm, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPVersion=iPVersion, iPv6GatewayAddress=iPv6GatewayAddress, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rFFeederLoss=rFFeederLoss, sMTPEmailAlert=sMTPEmailAlert, dataPortFiberStatusTrap=dataPortFiberStatusTrap, securityLevel=securityLevel, sNTPServerInternetAddressType=sNTPServerInternetAddressType, pubStats=pubStats, altitude=altitude, userEnabled=userEnabled, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, enabledDiagnosticAlarms=enabledDiagnosticAlarms, alarms=alarms, rFUSerial=rFUSerial, maxModulation=maxModulation, userTableNumber=userTableNumber, radioLicenseCodeRate=radioLicenseCodeRate, neighborMACAddress=neighborMACAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, userTable=userTable, rFUTxPowerMin=rFUTxPowerMin, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, rFUType=rFUType, iPv6Address=iPv6Address, secureModeAlarm=secureModeAlarm, sNTPServerTableEntry=sNTPServerTableEntry, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, phyStatus=phyStatus, remotePrimaryMACAddress=remotePrimaryMACAddress, dSCPManagementPriority=dSCPManagementPriority, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapVersion=sNMPTrapVersion, ptpTraps=ptpTraps, mPLSTCPriorityTable=mPLSTCPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rFURFSwitchAlarm=rFURFSwitchAlarm, ethernet=ethernet, protectionStatus=protectionStatus, secondarySoftwareVersion=secondarySoftwareVersion, dataPortPauseFrames=dataPortPauseFrames, encryptionAlgorithm=encryptionAlgorithm, radioLicenseBand=radioLicenseBand, enableTransmission=enableTransmission, rFUActiveFirmwareBank=rFUActiveFirmwareBank, sNMPTrapTableIndex=sNMPTrapTableIndex, neighborIPAddress=neighborIPAddress, ptp800=ptp800, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUStatus=rFUStatus, wirelessLinkStatus=wirelessLinkStatus, rFUTxFreqMax=rFUTxFreqMax, sNTPServerPortNumber=sNTPServerPortNumber, managementPortStatusTrap=managementPortStatusTrap, neighborInternetAddressType=neighborInternetAddressType, protectionStats=protectionStats, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, transmitDataRate=transmitDataRate, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, hTTPPortNumber=hTTPPortNumber, syslogClient=syslogClient, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rFUVersionBank2=rFUVersionBank2, productVariant=productVariant, primarySecondaryMode=primarySecondaryMode, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, activeUnit=activeUnit, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUConnectedPlatform=rFUConnectedPlatform, sNTPServerRetries=sNTPServerRetries, rFUFreqSpacing=rFUFreqSpacing, remoteSecondaryIPAddress=remoteSecondaryIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, management=management, vectorError=vectorError, rFUPowerButtonPressed=rFUPowerButtonPressed, transmitCapacityLimit=transmitCapacityLimit, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPPollInterval=sNTPPollInterval, sNMPTrapTable=sNMPTrapTable, rxDiversityDataPortStatus=rxDiversityDataPortStatus, smtp=smtp, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, sMTPEnabledMessages=sMTPEnabledMessages, vLANManagementPriority=vLANManagementPriority, l2CPPriorityTableNumber=l2CPPriorityTableNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, protectionConfigurationStatus=protectionConfigurationStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, userPassword=userPassword, rFUVersionBank1=rFUVersionBank1, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sNMPCommunityString=sNMPCommunityString, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, qOSPriorityScheme=qOSPriorityScheme, activeAvailableTime=activeAvailableTime, antennaGain=antennaGain, ethernetPriorityTableEntry=ethernetPriorityTableEntry, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, aTPCEnable=aTPCEnable, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rFURfBand=rFURfBand, encryptionEnabledMismatch=encryptionEnabledMismatch, numberOfAntennas=numberOfAntennas, linkLoss=linkLoss, encryption=encryption, siteName=siteName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkName=linkName, syslogLocalWrappedTrap=syslogLocalWrappedTrap, diverseRfFeederLoss=diverseRfFeederLoss, l2CPPriorityTable=l2CPPriorityTable, hardwareVersion=hardwareVersion, managementPortDisabledWarning=managementPortDisabledWarning, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, configuration=configuration, ptpTrapPrefix=ptpTrapPrefix, radioLicenseTxFreq=radioLicenseTxFreq, iFCableLength=iFCableLength, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, protectionState=protectionState, radioLicenseMinModulation=radioLicenseMinModulation, ethernetFiberSupport=ethernetFiberSupport, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPSync=sNTPSync, rFUTxBandAboveRx=rFUTxBandAboveRx)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", remoteSecondaryMACAddress=remoteSecondaryMACAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, transmitPower=transmitPower, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFURpsAlarm=rFURpsAlarm, sNTPPrimaryServer=sNTPPrimaryServer, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, managementCommittedInformationRate=managementCommittedInformationRate, receivePower=receivePower, ethernetPriorityTable=ethernetPriorityTable, rFUTxPowerAlarm=rFUTxPowerAlarm, protectionInterfaceStatus=protectionInterfaceStatus, systemClock=systemClock, protectionConfig=protectionConfig, protectionAvailabilityStatus=protectionAvailabilityStatus, remoteInternetAddressType=remoteInternetAddressType, supplementary=supplementary, phyControl=phyControl, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rFUPowerAlarm=rFUPowerAlarm, rFUTxMuteStatus=rFUTxMuteStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, neighborInternetAddress=neighborInternetAddress, rFURxFreqMin=rFURxFreqMin, userRole=userRole, sMTPServerPortNumber=sMTPServerPortNumber, transmitCapacityLimitDetail=transmitCapacityLimitDetail, timeZone=timeZone, sNTPServerTableNumber=sNTPServerTableNumber, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, rFUBranchingConfiguration=rFUBranchingConfiguration, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, protectionStateTrap=protectionStateTrap, iPv4Address=iPv4Address, aAAControl=aAAControl, managementPortStatus=managementPortStatus, dataPortStatus=dataPortStatus, protection=protection, faultProtectionSwitching=faultProtectionSwitching, ptp=ptp, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, userName=userName, syslogState=syslogState, rfu=rfu, softwareVersion=softwareVersion, rFULockoutAlarm=rFULockoutAlarm, tFTPServerInternetAddressType=tFTPServerInternetAddressType, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, activeWirelessLinkAvailability=activeWirelessLinkAvailability, sMTPServerInternetAddress=sMTPServerInternetAddress, gatewayIPAddress=gatewayIPAddress, rFUStatusTrap=rFUStatusTrap, hTTPAccessEnabled=hTTPAccessEnabled, wirelessLinkAvailability=wirelessLinkAvailability, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, daylightSaving=daylightSaving, ptmp=ptmp, rFUTxFreqMin=rFUTxFreqMin, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, dataPortStatusTrap=dataPortStatusTrap, fiberY=fiberY, sNTPServerIPAddress=sNTPServerIPAddress, rFUPlatformCompatibility=rFUPlatformCompatibility, tFTPServerIPAddress=tFTPServerIPAddress, dataPortDisabledWarning=dataPortDisabledWarning, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, rFURxFreqMax=rFURxFreqMax, latitude=latitude, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, minCodeRate=minCodeRate, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, maxCodeRate=maxCodeRate, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, rxDiversityVlanTpid=rxDiversityVlanTpid, unitOutOfCalibration=unitOutOfCalibration, userTableIndex=userTableIndex, radioLicenseIdentifier=radioLicenseIdentifier, iPv6PrefixLength=iPv6PrefixLength, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licence=licence, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm)
