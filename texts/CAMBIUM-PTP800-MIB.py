...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, activeUnit=activeUnit, aTPCEnable=aTPCEnable, remotePrimaryMACAddress=remotePrimaryMACAddress, pubStats=pubStats, radioLicenseMaxModulation=radioLicenseMaxModulation, rFUTxMuteStatus=rFUTxMuteStatus, sNTPServerTimeout=sNTPServerTimeout, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPServerRetries=sNTPServerRetries, licence=licence, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, altitude=altitude, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rFURpsAlarm=rFURpsAlarm, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, radioLicenseCodeRate=radioLicenseCodeRate, sMTPEmailAlert=sMTPEmailAlert, neighborInternetAddress=neighborInternetAddress, hTTPAccessEnabled=hTTPAccessEnabled, tFTPServerIPAddress=tFTPServerIPAddress, receiveDataRate=receiveDataRate, rFUPowerAlarm=rFUPowerAlarm, radioLicenseMaxEIRP=radioLicenseMaxEIRP, sNTPServerPortNumber=sNTPServerPortNumber, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, rFUTxPowerMin=rFUTxPowerMin, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, remotePrimaryIPAddress=remotePrimaryIPAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPState=sNTPState, dataPortFiberStatus=dataPortFiberStatus, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, maxModulation=maxModulation, rFURFSwitchAlarm=rFURFSwitchAlarm, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rFUTxFreqMin=rFUTxFreqMin, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, userRole=userRole, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, wirelessLinkAvailability=wirelessLinkAvailability, snmpControl=snmpControl, userTable=userTable, rFURxFreqMin=rFURxFreqMin, rFUTransceiverLocation=rFUTransceiverLocation, longitude=longitude, sntp=sntp, primarySecondaryMode=primarySecondaryMode, hardwareVersion=hardwareVersion, syslogClientTrap=syslogClientTrap, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, sNTPServerInternetAddressType=sNTPServerInternetAddressType, managementCommittedInformationRate=managementCommittedInformationRate, sNMPTrapInternetAddress=sNMPTrapInternetAddress, securityLevel=securityLevel, rFUTxPowerAlarm=rFUTxPowerAlarm, minModulation=minModulation, protectionStateTrap=protectionStateTrap, dSCPManagementPriority=dSCPManagementPriority, l2CPPriorityTableNumber=l2CPPriorityTableNumber, qOSPriorityScheme=qOSPriorityScheme, iFCableLength=iFCableLength, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, dataPortConfigurationMismatch=dataPortConfigurationMismatch, gatewayIPAddress=gatewayIPAddress, radioLicenseTxFreq=radioLicenseTxFreq, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, softwareVersion=softwareVersion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, faultProtectionSwitching=faultProtectionSwitching, protectionConfig=protectionConfig, sNTPServerTableNumber=sNTPServerTableNumber, rFFeederLoss=rFFeederLoss, ethernetPriorityTableEntry=ethernetPriorityTableEntry, aAAControl=aAAControl, userTableNumber=userTableNumber, maxCodeRate=maxCodeRate, sNTPServerTable=sNTPServerTable, dataPortPauseFrames=dataPortPauseFrames, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, phyControl=phyControl, neighborInternetAddressType=neighborInternetAddressType, ptpTraps=ptpTraps, iPVersion=iPVersion, vLANManagementVIDValidation=vLANManagementVIDValidation, sMTPServerPortNumber=sMTPServerPortNumber, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, radioLicenseMinCodeRate=radioLicenseMinCodeRate, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, telnetPortNumber=telnetPortNumber, remoteInternetAddress=remoteInternetAddress, syslogState=syslogState, rFUTxFreqMax=rFUTxFreqMax, phyStatus=phyStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, latitude=latitude, configuration=configuration, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkLoss=linkLoss, primaryRecovery=primaryRecovery, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, receivePower=receivePower, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPPrimaryServer=sNTPPrimaryServer, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, managementPortStatus=managementPortStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, wirelessLinkStatus=wirelessLinkStatus, ethernet=ethernet, rFUVersionBank1=rFUVersionBank1, reset=reset, sNMPTrapTableEntry=sNMPTrapTableEntry, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, syslogStateTrap=syslogStateTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPCommunityString=sNMPCommunityString, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, managementPortStatusTrap=managementPortStatusTrap, ptpTrapPrefix=ptpTrapPrefix, rFURfBand=rFURfBand, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, smtp=smtp, alignmentMode=alignmentMode, secureModeAlarm=secureModeAlarm, neighborMACAddress=neighborMACAddress, userEnabled=userEnabled, sMTPSourceEmailAddress=sMTPSourceEmailAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, sNTPServerInternetAddress=sNTPServerInternetAddress, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, unitOutOfCalibration=unitOutOfCalibration, sNTPSyncTrap=sNTPSyncTrap, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, secureModeAlarmTrap=secureModeAlarmTrap, userTableIndex=userTableIndex, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPTrapVersion=sNMPTrapVersion, remoteMaximumTransmitPower=remoteMaximumTransmitPower, radioLicenseRegion=radioLicenseRegion, managementPortAutoNegotiation=managementPortAutoNegotiation, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, wirelessLinkStatusTrap=wirelessLinkStatusTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortDisabledWarning=dataPortDisabledWarning, rFUTxBandAboveRx=rFUTxBandAboveRx, radioLicenseBandwidth=radioLicenseBandwidth, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rFURxFreqMax=rFURxFreqMax, sNTPServerTableIndex=sNTPServerTableIndex, management=management, protectionSwitchCause=protectionSwitchCause, cambium=cambium, transmitCodeRate=transmitCodeRate, transmitPower=transmitPower, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, sNMPEnabledTraps=sNMPEnabledTraps, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, ethernetPriorityTable=ethernetPriorityTable, protectionAvailabilityStatus=protectionAvailabilityStatus, remoteSecondaryMACAddress=remoteSecondaryMACAddress, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, remoteIPAddress=remoteIPAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, numberOfAntennas=numberOfAntennas, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitModulation=transmitModulation, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, protectionConfigurationStatus=protectionConfigurationStatus, systemClock=systemClock, dataPortStatusTrap=dataPortStatusTrap, fiberY=fiberY, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, transmitDataRate=transmitDataRate, radioLicenseModulation=radioLicenseModulation, dataPortFiberStatusTrap=dataPortFiberStatusTrap, remoteMACAddress=remoteMACAddress, diverseRfFeederLoss=diverseRfFeederLoss, sMTPServerInternetAddress=sMTPServerInternetAddress, activeWirelessLinkAvailability=activeWirelessLinkAvailability, iPv6GatewayAddress=iPv6GatewayAddress, sNTPServerIPAddress=sNTPServerIPAddress, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, transmitCapacityLimit=transmitCapacityLimit, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, remotePrimarySecondaryMode=remotePrimarySecondaryMode, ptp=ptp, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, vLANManagementPriority=vLANManagementPriority, sNTPSync=sNTPSync, sMTPEnabledMessages=sMTPEnabledMessages, hTTPPortNumber=hTTPPortNumber, radioLicenseIdentifier=radioLicenseIdentifier, sNMPTrapIPAddress=sNMPTrapIPAddress, rfu=rfu, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, sNTPPollInterval=sNTPPollInterval, secondarySoftwareVersion=secondarySoftwareVersion, managementPortConfigurationMismatch=managementPortConfigurationMismatch, localPacketFiltering=localPacketFiltering, remoteSecondaryIPAddress=remoteSecondaryIPAddress, productName=productName, rFUCableAlarm=rFUCableAlarm, timeZone=timeZone, enableTransmission=enableTransmission, protection=protection, rFUStatus=rFUStatus, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, encryptionEnabledMismatch=encryptionEnabledMismatch, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, protectionStats=protectionStats, sNTPLastSync=sNTPLastSync, encryptionAlgorithm=encryptionAlgorithm, useVLANForManagementInterfaces=useVLANForManagementInterfaces, bootVersion=bootVersion, sNTPServerResponse=sNTPServerResponse, bridge=bridge, diverseAntennaGain=diverseAntennaGain, supplementary=supplementary, transmitterStatus=transmitterStatus, rxDiversityDataPortStatus=rxDiversityDataPortStatus, ethernetFiberSupport=ethernetFiberSupport, rFUTxPowerMax=rFUTxPowerMax, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, radioLicenseMinModulation=radioLicenseMinModulation, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, linkNameMismatch=linkNameMismatch, vectorError=vectorError, rFUStatusTrap=rFUStatusTrap, remoteInternetAddressType=remoteInternetAddressType, rFULockoutAlarm=rFULockoutAlarm, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerTableEntry=sNTPServerTableEntry, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, rFUFreqSpacing=rFUFreqSpacing, rxDiversityVlanTpid=rxDiversityVlanTpid, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementPortForcedConfiguration=managementPortForcedConfiguration, neighborIPAddress=neighborIPAddress, hTTPSPortNumber=hTTPSPortNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", productVariant=productVariant, versions=versions, encryption=encryption, rFUPlatformCompatibility=rFUPlatformCompatibility, userPassword=userPassword, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, antennaGain=antennaGain, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, transmitCapacityLimitDetail=transmitCapacityLimitDetail, linkName=linkName, managementMode=managementMode, iPv6Address=iPv6Address, protectionState=protectionState, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, tFTPServerPortNumber=tFTPServerPortNumber, alarms=alarms, endId=endId, rFUProtectionCompatibility=rFUProtectionCompatibility, protectionInterfaceStatus=protectionInterfaceStatus, protectionStatus=protectionStatus, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, telnetAccessEnabled=telnetAccessEnabled, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPv4Address=iPv4Address, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sMTPServerIPAddress=sMTPServerIPAddress, radioLicenseBand=radioLicenseBand, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, mPLSTCPriorityTable=mPLSTCPriorityTable, ptmp=ptmp, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rFUBranchingConfiguration=rFUBranchingConfiguration, requestedProtectionState=requestedProtectionState, receiveModulation=receiveModulation, userName=userName, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ptp800=ptp800, rFUSerial=rFUSerial, rFUConnectedPlatform=rFUConnectedPlatform, syslogControl=syslogControl, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, activeAvailableTime=activeAvailableTime, syslogClient=syslogClient, subnetMask=subnetMask, daylightSaving=daylightSaving, dataPortStatus=dataPortStatus, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, aggregateDataRate=aggregateDataRate, rFUVersionBank2=rFUVersionBank2, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, sNMPTrapTable=sNMPTrapTable, l2CPPriorityTable=l2CPPriorityTable, remotePrimaryInternetAddress=remotePrimaryInternetAddress, maximumTransmitPower=maximumTransmitPower, transmitCapacity=transmitCapacity, userTableEntry=userTableEntry, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, siteName=siteName, alignmentModeTrap=alignmentModeTrap, rFUPowerButtonPressed=rFUPowerButtonPressed, vLANManagementVID=vLANManagementVID, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, primaryRecoveryPeriod=primaryRecoveryPeriod, enabledDiagnosticAlarms=enabledDiagnosticAlarms, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, radioLicenseRxFreq=radioLicenseRxFreq, sNMPPortNumber=sNMPPortNumber, rFUType=rFUType, iPv6PrefixLength=iPv6PrefixLength, receiveCodeRate=receiveCodeRate, minCodeRate=minCodeRate, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, radioLicense=radioLicense, linkNameMismatchTrap=linkNameMismatchTrap, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, managementPortDisabledWarning=managementPortDisabledWarning, rxDiversityVid=rxDiversityVid, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rFUActiveFirmwareBank=rFUActiveFirmwareBank, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, systemReset=systemReset)
