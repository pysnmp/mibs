...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, hTTPPortNumber=hTTPPortNumber, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, l2CPPriorityTable=l2CPPriorityTable, vectorError=vectorError, wirelessLinkStatus=wirelessLinkStatus, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, productVariant=productVariant, sNMPCommunityString=sNMPCommunityString, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, sMTPEnabledMessages=sMTPEnabledMessages, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, fiberY=fiberY, remoteSecondaryMACAddress=remoteSecondaryMACAddress, managementPortConfigurationMismatch=managementPortConfigurationMismatch, userRole=userRole, radioLicenseRxFreq=radioLicenseRxFreq, dataPortFiberStatusTrap=dataPortFiberStatusTrap, hTTPAccessEnabled=hTTPAccessEnabled, phyControl=phyControl, linkLoss=linkLoss, sNMPPortNumber=sNMPPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, protectionConfig=protectionConfig, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, snmpControl=snmpControl, transmitCapacity=transmitCapacity, vLANManagementVID=vLANManagementVID, sNTPState=sNTPState, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, phyStatus=phyStatus, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, neighborIPAddress=neighborIPAddress, sNTPSyncTrap=sNTPSyncTrap, dataPortPauseFrames=dataPortPauseFrames, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, enableTransmission=enableTransmission, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, aTPCEnable=aTPCEnable, radioLicenseMaxEIRP=radioLicenseMaxEIRP, sNMPTrapPortNumber=sNMPTrapPortNumber, linkNameMismatch=linkNameMismatch, sNTPServerInternetAddress=sNTPServerInternetAddress, managementPortStatus=managementPortStatus, rFURxFreqMin=rFURxFreqMin, remoteIPAddress=remoteIPAddress, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFUBranchingConfiguration=rFUBranchingConfiguration, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPSync=sNTPSync, linkName=linkName, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, tFTPServerIPAddress=tFTPServerIPAddress, activeAvailableTime=activeAvailableTime, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, alignmentModeTrap=alignmentModeTrap, secureModeAlarm=secureModeAlarm, remoteInternetAddressType=remoteInternetAddressType, qOSPriorityScheme=qOSPriorityScheme, managementPortStatusTrap=managementPortStatusTrap, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, userTableIndex=userTableIndex, neighborMACAddress=neighborMACAddress, sntp=sntp, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rFUCableAlarm=rFUCableAlarm, ethernet=ethernet, alignmentMode=alignmentMode, radioLicenseMinModulation=radioLicenseMinModulation, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, managementPortForcedConfiguration=managementPortForcedConfiguration, rFUPlatformCompatibility=rFUPlatformCompatibility, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitPower=transmitPower, radioLicense=radioLicense, sNMPTrapTable=sNMPTrapTable, sMTPServerInternetAddressType=sMTPServerInternetAddressType, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, transmitDataRate=transmitDataRate, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, diverseRfFeederLoss=diverseRfFeederLoss, managementMode=managementMode, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, managementCommittedInformationRate=managementCommittedInformationRate, primaryRecoveryPeriod=primaryRecoveryPeriod, rFUPowerButtonPressed=rFUPowerButtonPressed, transmitCapacityLimit=transmitCapacityLimit, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, iPVersion=iPVersion, ptmp=ptmp, rFUPowerAlarm=rFUPowerAlarm, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, faultProtectionSwitching=faultProtectionSwitching, linkNameMismatchTrap=linkNameMismatchTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteMACAddress=remoteMACAddress, systemReset=systemReset, rFUActiveFirmwareBank=rFUActiveFirmwareBank, protectionStatus=protectionStatus, wirelessLinkAvailability=wirelessLinkAvailability, rFUStatus=rFUStatus, rFFeederLoss=rFFeederLoss, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, remotePrimaryMACAddress=remotePrimaryMACAddress, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUTxPowerMax=rFUTxPowerMax, remotePrimarySecondaryMode=remotePrimarySecondaryMode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, timeZone=timeZone, rFUTxPowerAlarm=rFUTxPowerAlarm, minModulation=minModulation, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rFULockoutAlarm=rFULockoutAlarm, activeUnit=activeUnit, unitOutOfCalibration=unitOutOfCalibration, rFUTxFreqMax=rFUTxFreqMax, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, sMTPServerIPAddress=sMTPServerIPAddress, radioLicenseBand=radioLicenseBand, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerPortNumber=sNTPServerPortNumber, bridge=bridge, alarms=alarms, tFTPServerPortNumber=tFTPServerPortNumber, syslogControl=syslogControl, protectionStats=protectionStats, dataPortStatus=dataPortStatus, protectionInterfaceStatus=protectionInterfaceStatus, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, protectionConfigurationStatus=protectionConfigurationStatus, latitude=latitude, antennaGain=antennaGain, rxDiversityDataPortStatus=rxDiversityDataPortStatus, managementPortDisabledWarning=managementPortDisabledWarning, productName=productName, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, ethernetPriorityTable=ethernetPriorityTable, ptpTraps=ptpTraps, neighborInternetAddress=neighborInternetAddress, rFUVersionBank1=rFUVersionBank1, maxCodeRate=maxCodeRate, wirelessLinkStatusTrap=wirelessLinkStatusTrap, protection=protection, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, remoteSecondaryIPAddress=remoteSecondaryIPAddress, subnetMask=subnetMask, remoteInternetAddress=remoteInternetAddress, rFUStatusTrap=rFUStatusTrap, smtp=smtp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rxDiversityVid=rxDiversityVid, remotePrimaryIPAddress=remotePrimaryIPAddress, iPv6Address=iPv6Address, vLANManagementPriority=vLANManagementPriority, l2CPPriorityTableIndex=l2CPPriorityTableIndex, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, vLANManagementVIDValidation=vLANManagementVIDValidation, gatewayIPAddress=gatewayIPAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, protectionStateTrap=protectionStateTrap, aggregateDataRate=aggregateDataRate, transmitCapacityLimitDetail=transmitCapacityLimitDetail, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptp800=ptp800, sNTPServerTableEntry=sNTPServerTableEntry, receivePower=receivePower, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, securityLevel=securityLevel, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, iPv6GatewayAddress=iPv6GatewayAddress, sNTPPrimaryServer=sNTPPrimaryServer, radioLicenseMaxModulation=radioLicenseMaxModulation, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, userPassword=userPassword, syslogState=syslogState, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, maximumTransmitPower=maximumTransmitPower, rFUType=rFUType, receiveModulation=receiveModulation, transmitModulation=transmitModulation, softwareVersion=softwareVersion, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, numberOfAntennas=numberOfAntennas, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, protectionAvailabilityStatus=protectionAvailabilityStatus, activeWirelessLinkAvailability=activeWirelessLinkAvailability, sNMPTrapIPAddress=sNMPTrapIPAddress, rFUConnectedPlatform=rFUConnectedPlatform, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, sNTPServerResponse=sNTPServerResponse, rFURfBand=rFURfBand, cambium=cambium, licence=licence, supplementary=supplementary, rFUTxPowerMin=rFUTxPowerMin, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, secureModeAlarmTrap=secureModeAlarmTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitterStatus=transmitterStatus, encryptionEnabledMismatch=encryptionEnabledMismatch, tFTPServerInternetAddressType=tFTPServerInternetAddressType, aAAControl=aAAControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rFUFreqSpacing=rFUFreqSpacing, localPacketFiltering=localPacketFiltering, encryptionAlgorithm=encryptionAlgorithm, sMTPEmailAlert=sMTPEmailAlert, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPLastSync=sNTPLastSync, sNTPServerTableNumber=sNTPServerTableNumber, rxDiversityVlanTpid=rxDiversityVlanTpid, bootVersion=bootVersion, requestedProtectionState=requestedProtectionState, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerTableIndex=sNTPServerTableIndex, rFUVersionBank2=rFUVersionBank2, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPServerTable=sNTPServerTable, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, userName=userName, dataPortStatusTrap=dataPortStatusTrap, primarySecondaryMode=primarySecondaryMode, diverseAntennaGain=diverseAntennaGain, syslogClientTrap=syslogClientTrap, rFURFSwitchAlarm=rFURFSwitchAlarm)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", encryption=encryption, dataPortFiberStatus=dataPortFiberStatus, iPv6PrefixLength=iPv6PrefixLength, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFURpsAlarm=rFURpsAlarm, remotePrimaryInternetAddress=remotePrimaryInternetAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, hardwareVersion=hardwareVersion, daylightSaving=daylightSaving, iPv4Address=iPv4Address, telnetAccessEnabled=telnetAccessEnabled, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, tFTPServerInternetAddress=tFTPServerInternetAddress, userTableEntry=userTableEntry, hTTPSPortNumber=hTTPSPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userTableNumber=userTableNumber, primaryRecovery=primaryRecovery, radioLicenseMinCodeRate=radioLicenseMinCodeRate, minCodeRate=minCodeRate, telnetPortNumber=telnetPortNumber, radioLicenseTxFreq=radioLicenseTxFreq, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, ptpTrapPrefix=ptpTrapPrefix, rFUSerial=rFUSerial, rfu=rfu, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogClient=syslogClient, endId=endId, management=management, transmitCodeRate=transmitCodeRate, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ethernetFiberSupport=ethernetFiberSupport, userTable=userTable, sNTPServerTimeout=sNTPServerTimeout, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rFUProtectionCompatibility=rFUProtectionCompatibility, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, userEnabled=userEnabled, sNMPTrapVersion=sNMPTrapVersion, pubStats=pubStats, rFUTxMuteStatus=rFUTxMuteStatus, radioLicenseIdentifier=radioLicenseIdentifier, rFUTransceiverLocation=rFUTransceiverLocation, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rFUTxBandAboveRx=rFUTxBandAboveRx, siteName=siteName, receiveCodeRate=receiveCodeRate, sNMPTrapInternetAddress=sNMPTrapInternetAddress, protectionState=protectionState, radioLicenseCodeRate=radioLicenseCodeRate, protectionSwitchCause=protectionSwitchCause, sNMPEnabledTraps=sNMPEnabledTraps, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortDisabledWarning=dataPortDisabledWarning, managementPortAutoNegotiation=managementPortAutoNegotiation, radioLicenseBandwidth=radioLicenseBandwidth, systemClock=systemClock, neighborInternetAddressType=neighborInternetAddressType, configuration=configuration, rFUTxFreqMin=rFUTxFreqMin, sNTPServerIPAddress=sNTPServerIPAddress, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, radioLicenseRegion=radioLicenseRegion, iFCableLength=iFCableLength, longitude=longitude, ptp=ptp, reset=reset, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, dSCPManagementPriority=dSCPManagementPriority, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, syslogStateTrap=syslogStateTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sMTPServerPortNumber=sMTPServerPortNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, receiveDataRate=receiveDataRate, rFURxFreqMax=rFURxFreqMax, radioLicenseModulation=radioLicenseModulation, maxModulation=maxModulation, altitude=altitude, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerRetries=sNTPServerRetries, sNTPPollInterval=sNTPPollInterval, versions=versions)
