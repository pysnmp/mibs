...
ModuleIdentity, ObjectIdentity, Integer32, NotificationType, Gauge32, iso, NotificationType, TimeTicks, MibIdentifier, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "Integer32", "NotificationType", "Gauge32", "iso", "NotificationType", "TimeTicks", "MibIdentifier", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32", "Bits", "Counter64")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", primarySecondaryMode=primarySecondaryMode, linkNameMismatch=linkNameMismatch, localPacketFiltering=localPacketFiltering, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rFUVersionBank1=rFUVersionBank1, managementPortWirelessDownAlert=managementPortWirelessDownAlert, transmitCapacityLimit=transmitCapacityLimit, sNTPState=sNTPState, configuration=configuration, rFURfBand=rFURfBand, sMTPServerInternetAddress=sMTPServerInternetAddress, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, diverseAntennaGain=diverseAntennaGain, managementPortDisabledWarning=managementPortDisabledWarning, encryptionAlgorithm=encryptionAlgorithm, userRole=userRole, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, managementPortAutoNegotiation=managementPortAutoNegotiation, syslogStateTrap=syslogStateTrap, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, phyStatus=phyStatus, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, sNMPTrapVersion=sNMPTrapVersion, rfu=rfu, neighborInternetAddressType=neighborInternetAddressType, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, versions=versions, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, radioLicenseCodeRate=radioLicenseCodeRate, userTableNumber=userTableNumber, minCodeRate=minCodeRate, sNMPTrapPortNumber=sNMPTrapPortNumber, vLANManagementPriority=vLANManagementPriority, hTTPSPortNumber=hTTPSPortNumber, sNTPServerTableEntry=sNTPServerTableEntry, syslogClient=syslogClient, vectorError=vectorError, systemReset=systemReset, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapTableIndex=sNMPTrapTableIndex, fiberY=fiberY, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, reset=reset, sntp=sntp, snmpControl=snmpControl, l2CPPriorityTable=l2CPPriorityTable, sMTPServerPortNumber=sMTPServerPortNumber, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, wirelessLinkStatus=wirelessLinkStatus, protection=protection, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerTable=sNTPServerTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapTableNumber=sNMPTrapTableNumber, radioLicenseRegion=radioLicenseRegion, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, linkNameMismatchTrap=linkNameMismatchTrap, sNTPServerResponse=sNTPServerResponse, protectionConfig=protectionConfig, rFUTxMuteStatus=rFUTxMuteStatus, rxDiversityVlanTpid=rxDiversityVlanTpid, endId=endId, linkName=linkName, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, ptpTrapPrefix=ptpTrapPrefix, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rFUVersionBank2=rFUVersionBank2, unitOutOfCalibration=unitOutOfCalibration, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, activeAvailableTime=activeAvailableTime, primaryRecoveryPeriod=primaryRecoveryPeriod, telnetAccessEnabled=telnetAccessEnabled, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, management=management, remoteIPAddress=remoteIPAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, numberOfAntennas=numberOfAntennas, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, subnetMask=subnetMask, rFUProtectionCompatibility=rFUProtectionCompatibility, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, licence=licence, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, timeZone=timeZone, radioLicenseTxFreq=radioLicenseTxFreq, rFUActiveFirmwareBank=rFUActiveFirmwareBank, hTTPSAccessEnabled=hTTPSAccessEnabled, hTTPAccessEnabled=hTTPAccessEnabled, rFUConnectedPlatform=rFUConnectedPlatform, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, receivePower=receivePower, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, tFTPServerInternetAddress=tFTPServerInternetAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, bootVersion=bootVersion, transmitModulation=transmitModulation, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, aAAControl=aAAControl, sNMPTrapTableEntry=sNMPTrapTableEntry, managementPortStatusTrap=managementPortStatusTrap, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFURxFreqMin=rFURxFreqMin, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, telnetPortNumber=telnetPortNumber, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, userEnabled=userEnabled, sNTPPollInterval=sNTPPollInterval, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, qOSPriorityScheme=qOSPriorityScheme, phyControl=phyControl, sNTPServerPortNumber=sNTPServerPortNumber, sNTPServerTableNumber=sNTPServerTableNumber, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, productVariant=productVariant, rFUTxFreqMax=rFUTxFreqMax, remoteInternetAddress=remoteInternetAddress, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, rFUType=rFUType, receiveModulation=receiveModulation, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, transmitCodeRate=transmitCodeRate, rFUTxPowerMin=rFUTxPowerMin, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortDisabledWarning=dataPortDisabledWarning, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, transmitPower=transmitPower, secondarySoftwareVersion=secondarySoftwareVersion, dataPortFiberStatus=dataPortFiberStatus, productName=productName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitCapacityLimitDetail=transmitCapacityLimitDetail, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTable=sNMPTrapTable, iPv6Address=iPv6Address, ptpTraps=ptpTraps, radioLicenseMaxModulation=radioLicenseMaxModulation, radioLicenseRxFreq=radioLicenseRxFreq, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, alarms=alarms, radioLicenseBandwidth=radioLicenseBandwidth, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, transmitCapacity=transmitCapacity, rFUSerial=rFUSerial, rFUPowerAlarm=rFUPowerAlarm, protectionSwitchCause=protectionSwitchCause, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPSyncTrap=sNTPSyncTrap, radioLicenseIdentifier=radioLicenseIdentifier, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rxDiversityVid=rxDiversityVid, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, aTPCEnable=aTPCEnable, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ethernetFiberSupport=ethernetFiberSupport, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rFURpsAlarm=rFURpsAlarm, userPassword=userPassword, managementPortStatus=managementPortStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, remoteSecondaryMACAddress=remoteSecondaryMACAddress, bridge=bridge, dataPortWirelessDownAlert=dataPortWirelessDownAlert, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, softwareVersion=softwareVersion, systemClock=systemClock, primaryRecovery=primaryRecovery, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, managementPortForcedConfiguration=managementPortForcedConfiguration, alignmentModeTrap=alignmentModeTrap, linkLoss=linkLoss, ethernetPriorityTable=ethernetPriorityTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, radioLicenseMinModulation=radioLicenseMinModulation, managementMode=managementMode, remotePrimaryInternetAddress=remotePrimaryInternetAddress, rFUStatusTrap=rFUStatusTrap, securityLevel=securityLevel, rFUPlatformCompatibility=rFUPlatformCompatibility, rFUTxPowerMax=rFUTxPowerMax, requestedProtectionState=requestedProtectionState, daylightSaving=daylightSaving, cambium=cambium, radioLicenseBand=radioLicenseBand, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, remoteMACAddress=remoteMACAddress, dataPortPauseFrames=dataPortPauseFrames, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortStatusTrap=dataPortStatusTrap, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, ethernet=ethernet, diverseRfFeederLoss=diverseRfFeederLoss, userTableEntry=userTableEntry, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, longitude=longitude, rFUTxFreqMin=rFUTxFreqMin, maxModulation=maxModulation, radioLicense=radioLicense, protectionState=protectionState, neighborIPAddress=neighborIPAddress, iPv4Address=iPv4Address, neighborInternetAddress=neighborInternetAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPLastSync=sNTPLastSync, hardwareVersion=hardwareVersion, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, protectionStateTrap=protectionStateTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, protectionStats=protectionStats, minModulation=minModulation, sMTPServerIPAddress=sMTPServerIPAddress, ptp800=ptp800, encryptionEnabledMismatch=encryptionEnabledMismatch, activeUnit=activeUnit, enableTransmission=enableTransmission, secureModeAlarmTrap=secureModeAlarmTrap, radioLicenseModulation=radioLicenseModulation, iPv6PrefixLength=iPv6PrefixLength, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rFUTransceiverLocation=rFUTransceiverLocation)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", protectionConfigurationStatus=protectionConfigurationStatus, alignmentMode=alignmentMode, rFUTxPowerAlarm=rFUTxPowerAlarm, remotePrimaryIPAddress=remotePrimaryIPAddress, neighborMACAddress=neighborMACAddress, dataPortStatus=dataPortStatus, sNTPPrimaryServer=sNTPPrimaryServer, altitude=altitude, maxCodeRate=maxCodeRate, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, remotePrimaryMACAddress=remotePrimaryMACAddress, faultProtectionSwitching=faultProtectionSwitching, rFURFSwitchAlarm=rFURFSwitchAlarm, syslogClientTrap=syslogClientTrap, rFUPowerButtonPressed=rFUPowerButtonPressed, receiveDataRate=receiveDataRate, sMTPEmailAlert=sMTPEmailAlert, rFUStatus=rFUStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vLANManagementVID=vLANManagementVID, userTable=userTable, remoteInternetAddressType=remoteInternetAddressType, pubStats=pubStats, antennaGain=antennaGain, transmitDataRate=transmitDataRate, rFUTxBandAboveRx=rFUTxBandAboveRx, iPv6GatewayAddress=iPv6GatewayAddress, encryption=encryption, supplementary=supplementary, ptmp=ptmp, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, smtp=smtp, sNTPSync=sNTPSync, sNTPServerTimeout=sNTPServerTimeout, gatewayIPAddress=gatewayIPAddress, iPVersion=iPVersion, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, protectionStatus=protectionStatus, activeWirelessLinkAvailability=activeWirelessLinkAvailability, maximumTransmitPower=maximumTransmitPower, protectionAvailabilityStatus=protectionAvailabilityStatus, tFTPServerIPAddress=tFTPServerIPAddress, ptp=ptp, protectionInterfaceStatus=protectionInterfaceStatus, aggregateDataRate=aggregateDataRate, sNMPPortNumber=sNMPPortNumber, rFUFreqSpacing=rFUFreqSpacing, radioLicenseMaxEIRP=radioLicenseMaxEIRP, sNTPServerIPAddress=sNTPServerIPAddress, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, userName=userName, siteName=siteName, managementCommittedInformationRate=managementCommittedInformationRate, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rFUCableAlarm=rFUCableAlarm, wirelessLinkAvailability=wirelessLinkAvailability, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rFULockoutAlarm=rFULockoutAlarm, sNTPServerTableIndex=sNTPServerTableIndex, latitude=latitude, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, hTTPPortNumber=hTTPPortNumber, remoteSecondaryIPAddress=remoteSecondaryIPAddress, iFCableLength=iFCableLength, rFURxFreqMax=rFURxFreqMax, rFUBranchingConfiguration=rFUBranchingConfiguration, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkStatusTrap=wirelessLinkStatusTrap, sNTPServerRetries=sNTPServerRetries, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userTableIndex=userTableIndex, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityString=sNMPCommunityString, receiveCodeRate=receiveCodeRate, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogControl=syslogControl, vLANManagementVIDValidation=vLANManagementVIDValidation, transmitterStatus=transmitterStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, syslogState=syslogState, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rFFeederLoss=rFFeederLoss, secureModeAlarm=secureModeAlarm)
