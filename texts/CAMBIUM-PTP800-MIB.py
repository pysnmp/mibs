...
MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, ObjectIdentity, Counter32, NotificationType, enterprises, Gauge32, Unsigned32, Bits, IpAddress, iso, TimeTicks, NotificationType, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "ObjectIdentity", "Counter32", "NotificationType", "enterprises", "Gauge32", "Unsigned32", "Bits", "IpAddress", "iso", "TimeTicks", "NotificationType", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, diverseAntennaGain=diverseAntennaGain, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, softwareVersion=softwareVersion, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, secondarySoftwareVersion=secondarySoftwareVersion, rFUTxPowerMin=rFUTxPowerMin, wirelessLinkStatusTrap=wirelessLinkStatusTrap, radioLicense=radioLicense, phyControl=phyControl, rxDiversityVlanTpid=rxDiversityVlanTpid, protectionSwitchCause=protectionSwitchCause, remoteInternetAddress=remoteInternetAddress, aAAControl=aAAControl, sNTPServerIPAddress=sNTPServerIPAddress, ptmp=ptmp, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetFiberSupport=ethernetFiberSupport, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, remoteSecondaryMACAddress=remoteSecondaryMACAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vLANManagementVID=vLANManagementVID, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, requestedProtectionState=requestedProtectionState, protectionConfig=protectionConfig, sNMPTrapTableIndex=sNMPTrapTableIndex, remotePrimaryMACAddress=remotePrimaryMACAddress, rFUTxMuteStatus=rFUTxMuteStatus, primarySecondaryMode=primarySecondaryMode, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapTable=sNMPTrapTable, sNMPTrapPortNumber=sNMPTrapPortNumber, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, siteName=siteName, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, rFUPowerAlarm=rFUPowerAlarm, linkNameMismatch=linkNameMismatch, iPv6PrefixLength=iPv6PrefixLength, activeAvailableTime=activeAvailableTime, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPSyncTrap=sNTPSyncTrap, ethernet=ethernet, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, receivePower=receivePower, rFUTxFreqMax=rFUTxFreqMax, mPLSTCPriorityTable=mPLSTCPriorityTable, qOSPriorityScheme=qOSPriorityScheme, managementPortStatus=managementPortStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rFUPowerButtonPressed=rFUPowerButtonPressed, sMTPSourceEmailAddress=sMTPSourceEmailAddress, radioLicenseIdentifier=radioLicenseIdentifier, sNTPServerInternetAddress=sNTPServerInternetAddress, daylightSaving=daylightSaving, protectionConfigurationStatus=protectionConfigurationStatus, radioLicenseRegion=radioLicenseRegion, rFUConnectedPlatform=rFUConnectedPlatform, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, rFUActiveFirmwareBank=rFUActiveFirmwareBank, hTTPPortNumber=hTTPPortNumber, activeUnit=activeUnit, protectionStateTrap=protectionStateTrap, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, radioLicenseMinModulation=radioLicenseMinModulation, transmitModulation=transmitModulation, secureModeAlarm=secureModeAlarm, radioLicenseBand=radioLicenseBand, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, endId=endId, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, ptpTraps=ptpTraps, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, neighborMACAddress=neighborMACAddress, vLANManagementVIDValidation=vLANManagementVIDValidation, sNMPTrapVersion=sNMPTrapVersion, diverseRfFeederLoss=diverseRfFeederLoss, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rFUFreqSpacing=rFUFreqSpacing, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rFUProtectionCompatibility=rFUProtectionCompatibility, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, timeZone=timeZone, protectionStatus=protectionStatus, sMTPEnabledMessages=sMTPEnabledMessages, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, alignmentModeTrap=alignmentModeTrap, telnetAccessEnabled=telnetAccessEnabled, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, supplementary=supplementary, securityLevel=securityLevel, userTable=userTable, ethernetPriorityTable=ethernetPriorityTable, rFURxFreqMax=rFURxFreqMax, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, remoteMACAddress=remoteMACAddress, maxModulation=maxModulation, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFUVersionBank1=rFUVersionBank1, snmpControl=snmpControl, neighborInternetAddress=neighborInternetAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, managementPortForcedConfiguration=managementPortForcedConfiguration, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, protectionState=protectionState, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userTableEntry=userTableEntry, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, syslogState=syslogState, rFFeederLoss=rFFeederLoss, encryptionEnabledMismatch=encryptionEnabledMismatch, maximumTransmitPower=maximumTransmitPower, ptp800=ptp800, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rfu=rfu, iPVersion=iPVersion, iPv6GatewayAddress=iPv6GatewayAddress, sMTPServerPortNumber=sMTPServerPortNumber, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, syslogStateTrap=syslogStateTrap, sNTPServerTableEntry=sNTPServerTableEntry, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, rFUTxBandAboveRx=rFUTxBandAboveRx, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, bridge=bridge, rxDiversityDataPortStatus=rxDiversityDataPortStatus, faultProtectionSwitching=faultProtectionSwitching, rFUBranchingConfiguration=rFUBranchingConfiguration, primaryRecovery=primaryRecovery, smtp=smtp, maxCodeRate=maxCodeRate, userTableIndex=userTableIndex, bootVersion=bootVersion, rFUSerial=rFUSerial, radioLicenseTxFreq=radioLicenseTxFreq, pubStats=pubStats, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUTxPowerMax=rFUTxPowerMax, cambium=cambium, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, remoteIPAddress=remoteIPAddress, radioLicenseMaxModulation=radioLicenseMaxModulation, fiberY=fiberY, alignmentMode=alignmentMode, systemClock=systemClock, secureModeAlarmTrap=secureModeAlarmTrap, aTPCEnable=aTPCEnable, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, encryption=encryption, rFUCableAlarm=rFUCableAlarm, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, sNMPPortNumber=sNMPPortNumber, sNTPServerTable=sNTPServerTable, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, userRole=userRole, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerResponse=sNTPServerResponse, telnetPortNumber=telnetPortNumber, systemReset=systemReset, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sMTPEmailAlert=sMTPEmailAlert, syslogClientTrap=syslogClientTrap, reset=reset, minCodeRate=minCodeRate, rFUStatusTrap=rFUStatusTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, subnetMask=subnetMask, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, managementMode=managementMode, protectionAvailabilityStatus=protectionAvailabilityStatus, hTTPSPortNumber=hTTPSPortNumber, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, userEnabled=userEnabled, dSCPManagementPriority=dSCPManagementPriority, antennaGain=antennaGain, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementPortDisabledWarning=managementPortDisabledWarning, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rFURxFreqMin=rFURxFreqMin, transmitterStatus=transmitterStatus, ptp=ptp, transmitCapacity=transmitCapacity, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortFiberStatus=dataPortFiberStatus, longitude=longitude, tFTPServerIPAddress=tFTPServerIPAddress, protectionInterfaceStatus=protectionInterfaceStatus, sNTPPollInterval=sNTPPollInterval, sNTPSync=sNTPSync, dataPortStatusTrap=dataPortStatusTrap, transmitCodeRate=transmitCodeRate, receiveCodeRate=receiveCodeRate, rFUTxPowerAlarm=rFUTxPowerAlarm, productName=productName, rFURFSwitchAlarm=rFURFSwitchAlarm, linkLoss=linkLoss, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, wirelessLinkAvailability=wirelessLinkAvailability, l2CPPriorityTableIndex=l2CPPriorityTableIndex, linkName=linkName, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, managementCommittedInformationRate=managementCommittedInformationRate, sNTPServerTimeout=sNTPServerTimeout, iFCableLength=iFCableLength, sNTPServerRetries=sNTPServerRetries, rFURpsAlarm=rFURpsAlarm, ptpTrapPrefix=ptpTrapPrefix, rxDiversityVid=rxDiversityVid, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rFUVersionBank2=rFUVersionBank2, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, sNTPPrimaryServer=sNTPPrimaryServer, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, userPassword=userPassword, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, neighborIPAddress=neighborIPAddress, transmitDataRate=transmitDataRate, sNTPServerTableNumber=sNTPServerTableNumber, vectorError=vectorError, sNTPServerPortNumber=sNTPServerPortNumber, syslogClient=syslogClient, phyStatus=phyStatus, syslogControl=syslogControl, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, hardwareVersion=hardwareVersion)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", remoteInternetAddressType=remoteInternetAddressType, remotePrimaryIPAddress=remotePrimaryIPAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortDisabledWarning=dataPortDisabledWarning, transmitCapacityLimitDetail=transmitCapacityLimitDetail, protection=protection, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPAccessEnabled=hTTPAccessEnabled, receiveDataRate=receiveDataRate, remotePrimaryInternetAddress=remotePrimaryInternetAddress, dataPortStatus=dataPortStatus, sNTPState=sNTPState, sNMPTrapTableNumber=sNMPTrapTableNumber, managementPortStatusTrap=managementPortStatusTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, latitude=latitude, rFUTxFreqMin=rFUTxFreqMin, unitOutOfCalibration=unitOutOfCalibration, sNMPCommunityString=sNMPCommunityString, hTTPSAccessEnabled=hTTPSAccessEnabled, rFUType=rFUType, sntp=sntp, wirelessLinkStatus=wirelessLinkStatus, aggregateDataRate=aggregateDataRate, rFULockoutAlarm=rFULockoutAlarm, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, protectionStats=protectionStats, dataPortPauseFrames=dataPortPauseFrames, radioLicenseModulation=radioLicenseModulation, receiveModulation=receiveModulation, userTableNumber=userTableNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetPriorityTableEntry=ethernetPriorityTableEntry, gatewayIPAddress=gatewayIPAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, encryptionAlgorithm=encryptionAlgorithm, primaryRecoveryPeriod=primaryRecoveryPeriod, sNTPServerTableIndex=sNTPServerTableIndex, l2CPPriorityTable=l2CPPriorityTable, iPv4Address=iPv4Address, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, linkNameMismatchTrap=linkNameMismatchTrap, rFURfBand=rFURfBand, rFUStatus=rFUStatus, localPacketFiltering=localPacketFiltering, radioLicenseBandwidth=radioLicenseBandwidth, numberOfAntennas=numberOfAntennas, l2CPPriorityTableNumber=l2CPPriorityTableNumber, radioLicenseCodeRate=radioLicenseCodeRate, management=management, transmitCapacityLimit=transmitCapacityLimit, alarms=alarms, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapTableEntry=sNMPTrapTableEntry, rFUTransceiverLocation=rFUTransceiverLocation, minModulation=minModulation, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, radioLicenseRxFreq=radioLicenseRxFreq, managementPortAutoNegotiation=managementPortAutoNegotiation, configuration=configuration, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, userName=userName, vLANManagementPriority=vLANManagementPriority, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, transmitPower=transmitPower, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, altitude=altitude, iPv6Address=iPv6Address, productVariant=productVariant, radioLicenseMaxEIRP=radioLicenseMaxEIRP, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, licence=licence, versions=versions, sMTPServerInternetAddress=sMTPServerInternetAddress, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, sNTPLastSync=sNTPLastSync, sNMPTrapInternetAddress=sNMPTrapInternetAddress, remoteSecondaryIPAddress=remoteSecondaryIPAddress, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, enableTransmission=enableTransmission, rFUPlatformCompatibility=rFUPlatformCompatibility, sNMPTrapIPAddress=sNMPTrapIPAddress, neighborInternetAddressType=neighborInternetAddressType, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, activeWirelessLinkAvailability=activeWirelessLinkAvailability, remotePrimarySecondaryMode=remotePrimarySecondaryMode)
