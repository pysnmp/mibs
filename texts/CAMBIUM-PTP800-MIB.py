...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sntp=sntp, sNTPSyncTrap=sNTPSyncTrap, snmpControl=snmpControl, userName=userName, reset=reset, radioLicenseMinCodeRate=radioLicenseMinCodeRate, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, protection=protection, rFURfBand=rFURfBand, dSCPManagementPriority=dSCPManagementPriority, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rFUVersionBank1=rFUVersionBank1, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, vLANManagementVID=vLANManagementVID, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, ptp=ptp, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rfu=rfu, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, radioLicenseMaxEIRP=radioLicenseMaxEIRP, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, sNTPServerTableIndex=sNTPServerTableIndex, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerTableNumber=sNTPServerTableNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, managementPortStatus=managementPortStatus, radioLicenseRxFreq=radioLicenseRxFreq, receiveModulation=receiveModulation, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rFURFSwitchAlarm=rFURFSwitchAlarm, latitude=latitude, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, cambium=cambium, remoteSecondaryMACAddress=remoteSecondaryMACAddress, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rFFeederLoss=rFFeederLoss, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, iPv6Address=iPv6Address, smtp=smtp, sMTPServerPortNumber=sMTPServerPortNumber, siteName=siteName, transmitModulation=transmitModulation, productVariant=productVariant, minCodeRate=minCodeRate, sNMPTrapPortNumber=sNMPTrapPortNumber, aAAControl=aAAControl, wirelessLinkAvailability=wirelessLinkAvailability, hTTPSAccessEnabled=hTTPSAccessEnabled, systemClock=systemClock, versions=versions, alignmentMode=alignmentMode, sNMPEnabledTraps=sNMPEnabledTraps, hardwareVersion=hardwareVersion, sNTPServerTableEntry=sNTPServerTableEntry, endId=endId, sMTPEmailAlert=sMTPEmailAlert, userRole=userRole, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTable=sNMPTrapTable, bridge=bridge, aTPCEnable=aTPCEnable, protectionConfig=protectionConfig, dataPortStatusTrap=dataPortStatusTrap, alarms=alarms, secondarySoftwareVersion=secondarySoftwareVersion, aggregateDataRate=aggregateDataRate, radioLicenseMinModulation=radioLicenseMinModulation, activeUnit=activeUnit, sNTPServerResponse=sNTPServerResponse, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, rFUTxFreqMin=rFUTxFreqMin, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, productName=productName, iPv4Address=iPv4Address, radioLicenseModulation=radioLicenseModulation, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, maxCodeRate=maxCodeRate, transmitDataRate=transmitDataRate, primaryRecovery=primaryRecovery, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, protectionInterfaceStatus=protectionInterfaceStatus, encryptionEnabledMismatch=encryptionEnabledMismatch, phyControl=phyControl, sMTPServerInternetAddress=sMTPServerInternetAddress, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, remoteIPAddress=remoteIPAddress, ptpTraps=ptpTraps, remotePrimaryIPAddress=remotePrimaryIPAddress, rFUPowerButtonPressed=rFUPowerButtonPressed, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, secureModeAlarm=secureModeAlarm, transmitPower=transmitPower, linkNameMismatch=linkNameMismatch, transmitCapacity=transmitCapacity, neighborInternetAddress=neighborInternetAddress, protectionStatus=protectionStatus, managementPortStatusTrap=managementPortStatusTrap, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, rFUTxPowerAlarm=rFUTxPowerAlarm, encryptionAlgorithm=encryptionAlgorithm, protectionState=protectionState, sNMPTrapTableEntry=sNMPTrapTableEntry, neighborIPAddress=neighborIPAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, transmitCapacityLimit=transmitCapacityLimit, systemReset=systemReset, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, linkNameMismatchTrap=linkNameMismatchTrap, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rFUTxPowerMin=rFUTxPowerMin, ethernet=ethernet, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPPortNumber=hTTPPortNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, maximumTransmitPower=maximumTransmitPower, hTTPSPortNumber=hTTPSPortNumber, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, vectorError=vectorError, userTableEntry=userTableEntry, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, qOSPriorityScheme=qOSPriorityScheme, localPacketFiltering=localPacketFiltering, antennaGain=antennaGain, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, pubStats=pubStats, protectionStateTrap=protectionStateTrap, ptpTrapPrefix=ptpTrapPrefix, vLANManagementVIDValidation=vLANManagementVIDValidation, radioLicense=radioLicense, rFUTransceiverLocation=rFUTransceiverLocation, numberOfAntennas=numberOfAntennas, sNTPPrimaryServer=sNTPPrimaryServer, sNTPState=sNTPState, requestedProtectionState=requestedProtectionState, linkName=linkName, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, receivePower=receivePower, alignmentModeTrap=alignmentModeTrap, sNMPCommunityString=sNMPCommunityString, rFUTxFreqMax=rFUTxFreqMax, gatewayIPAddress=gatewayIPAddress, transmitCodeRate=transmitCodeRate, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hTTPAccessEnabled=hTTPAccessEnabled, rxDiversityVid=rxDiversityVid, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, phyStatus=phyStatus, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, fiberY=fiberY, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, linkLoss=linkLoss, sNTPServerIPAddress=sNTPServerIPAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUTxMuteStatus=rFUTxMuteStatus, daylightSaving=daylightSaving, rFUTxPowerMax=rFUTxPowerMax, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementPortConfigurationMismatch=managementPortConfigurationMismatch, supplementary=supplementary, activeAvailableTime=activeAvailableTime, diverseAntennaGain=diverseAntennaGain, l2CPPriorityTableEntry=l2CPPriorityTableEntry, telnetPortNumber=telnetPortNumber, syslogClient=syslogClient, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, radioLicenseCodeRate=radioLicenseCodeRate, syslogClientTrap=syslogClientTrap, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, protectionAvailabilityStatus=protectionAvailabilityStatus, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, sNTPServerTable=sNTPServerTable, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, rFUConnectedPlatform=rFUConnectedPlatform, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, sNTPSync=sNTPSync, sNTPServerInternetAddress=sNTPServerInternetAddress, management=management, primaryRecoveryPeriod=primaryRecoveryPeriod, userTableIndex=userTableIndex, rFUFreqSpacing=rFUFreqSpacing, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFUCableAlarm=rFUCableAlarm, sNMPTrapTableIndex=sNMPTrapTableIndex, rFURxFreqMin=rFURxFreqMin, transmitCapacityLimitDetail=transmitCapacityLimitDetail, rFUType=rFUType, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, encryption=encryption, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, ethernetPriorityTable=ethernetPriorityTable, receiveCodeRate=receiveCodeRate, neighborMACAddress=neighborMACAddress, transmitterStatus=transmitterStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, radioLicenseTxFreq=radioLicenseTxFreq, sNMPTrapIPAddress=sNMPTrapIPAddress, rFURxFreqMax=rFURxFreqMax, radioLicenseRegion=radioLicenseRegion, sNTPServerPortNumber=sNTPServerPortNumber, radioLicenseBandwidth=radioLicenseBandwidth, timeZone=timeZone, rxDiversityDataPortStatus=rxDiversityDataPortStatus, radioLicenseMaxModulation=radioLicenseMaxModulation, rFUStatusTrap=rFUStatusTrap, userEnabled=userEnabled, remoteMACAddress=remoteMACAddress, dataPortDisabledWarning=dataPortDisabledWarning, licence=licence, dataPortPauseFrames=dataPortPauseFrames, diverseRfFeederLoss=diverseRfFeederLoss, mPLSTCPriorityTable=mPLSTCPriorityTable, ptmp=ptmp, managementPortForcedConfiguration=managementPortForcedConfiguration, rFUPlatformCompatibility=rFUPlatformCompatibility, rFUActiveFirmwareBank=rFUActiveFirmwareBank, sMTPEnabledMessages=sMTPEnabledMessages, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, sNMPTrapInternetAddress=sNMPTrapInternetAddress, softwareVersion=softwareVersion, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, iFCableLength=iFCableLength, rFUPowerAlarm=rFUPowerAlarm, receiveDataRate=receiveDataRate, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, protectionSwitchCause=protectionSwitchCause, sNTPServerRetries=sNTPServerRetries, altitude=altitude, rxDiversityVlanTpid=rxDiversityVlanTpid, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogControl=syslogControl, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, radioLicenseIdentifier=radioLicenseIdentifier, subnetMask=subnetMask, ethernetPriorityTableNumber=ethernetPriorityTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", iPv6GatewayAddress=iPv6GatewayAddress, sNMPPortNumber=sNMPPortNumber, longitude=longitude, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, telnetAccessEnabled=telnetAccessEnabled, neighborInternetAddressType=neighborInternetAddressType, maxModulation=maxModulation, dataPortFiberStatusTrap=dataPortFiberStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, managementMode=managementMode, tFTPServerPortNumber=tFTPServerPortNumber, unitOutOfCalibration=unitOutOfCalibration, userTable=userTable, rFUBranchingConfiguration=rFUBranchingConfiguration, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, wirelessLinkStatus=wirelessLinkStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, primarySecondaryMode=primarySecondaryMode, rFUVersionBank2=rFUVersionBank2, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, sMTPServerIPAddress=sMTPServerIPAddress, managementPortAutoNegotiation=managementPortAutoNegotiation, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, activeWirelessLinkAvailability=activeWirelessLinkAvailability, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, protectionConfigurationStatus=protectionConfigurationStatus, faultProtectionSwitching=faultProtectionSwitching, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sNMPTrapVersion=sNMPTrapVersion, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rFUTxBandAboveRx=rFUTxBandAboveRx, protectionStats=protectionStats, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, remotePrimaryMACAddress=remotePrimaryMACAddress, minModulation=minModulation, managementCommittedInformationRate=managementCommittedInformationRate, rFUProtectionCompatibility=rFUProtectionCompatibility, bootVersion=bootVersion, rFULockoutAlarm=rFULockoutAlarm, syslogState=syslogState, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ethernetFiberSupport=ethernetFiberSupport, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, radioLicenseBand=radioLicenseBand, userPassword=userPassword, remoteInternetAddressType=remoteInternetAddressType, sNTPServerTimeout=sNTPServerTimeout, configuration=configuration, remoteInternetAddress=remoteInternetAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFURpsAlarm=rFURpsAlarm, remoteSecondaryIPAddress=remoteSecondaryIPAddress, secureModeAlarmTrap=secureModeAlarmTrap, dataPortStatus=dataPortStatus, ptp800=ptp800, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, vLANManagementPriority=vLANManagementPriority, syslogStateTrap=syslogStateTrap, remotePrimaryInternetAddress=remotePrimaryInternetAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPLastSync=sNTPLastSync, l2CPPriorityTable=l2CPPriorityTable, iPv6PrefixLength=iPv6PrefixLength, iPVersion=iPVersion, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rFUSerial=rFUSerial, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, securityLevel=securityLevel, managementPortDisabledWarning=managementPortDisabledWarning, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, sNTPPollInterval=sNTPPollInterval, enableTransmission=enableTransmission, rFUStatus=rFUStatus, dataPortFiberStatus=dataPortFiberStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userTableNumber=userTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortConfigurationMismatch=dataPortConfigurationMismatch)
