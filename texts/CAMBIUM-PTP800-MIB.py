...
Bits, Gauge32, ObjectIdentity, MibIdentifier, Integer32, Unsigned32, NotificationType, ModuleIdentity, enterprises, iso, Counter32, IpAddress, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "ObjectIdentity", "MibIdentifier", "Integer32", "Unsigned32", "NotificationType", "ModuleIdentity", "enterprises", "iso", "Counter32", "IpAddress", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", remoteIPAddress=remoteIPAddress, rFUCableAlarm=rFUCableAlarm, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, wirelessLinkStatus=wirelessLinkStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementPortForcedConfiguration=managementPortForcedConfiguration, sNMPTrapIPAddress=sNMPTrapIPAddress, userRole=userRole, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerTable=sNTPServerTable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, userTableEntry=userTableEntry, managementPortStatus=managementPortStatus, ptpTraps=ptpTraps, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, endId=endId, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, unitOutOfCalibration=unitOutOfCalibration, gatewayIPAddress=gatewayIPAddress, userPassword=userPassword, radioLicenseIdentifier=radioLicenseIdentifier, protectionConfigurationStatus=protectionConfigurationStatus, dataPortFiberStatus=dataPortFiberStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, telnetPortNumber=telnetPortNumber, linkLoss=linkLoss, rFUPowerButtonPressed=rFUPowerButtonPressed, neighborInternetAddress=neighborInternetAddress, vectorError=vectorError, sNMPTrapVersion=sNMPTrapVersion, transmitCapacityLimit=transmitCapacityLimit, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, activeUnit=activeUnit, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, protectionStateTrap=protectionStateTrap, dataPortDisabledWarning=dataPortDisabledWarning, rFUTxMuteStatus=rFUTxMuteStatus, receiveDataRate=receiveDataRate, sNMPTrapTable=sNMPTrapTable, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rxDiversityVid=rxDiversityVid, maximumTransmitPower=maximumTransmitPower, securityLevel=securityLevel, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, configuration=configuration, phyStatus=phyStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, wirelessLinkAvailability=wirelessLinkAvailability, pubStats=pubStats, sNTPServerTimeout=sNTPServerTimeout, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, softwareVersion=softwareVersion, iPv4Address=iPv4Address, sNMPPortNumber=sNMPPortNumber, versions=versions, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, hTTPPortNumber=hTTPPortNumber, sNTPState=sNTPState, protectionSwitchCause=protectionSwitchCause, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, siteName=siteName, licence=licence, latitude=latitude, sNTPPrimaryServer=sNTPPrimaryServer, secondarySoftwareVersion=secondarySoftwareVersion, hTTPSPortNumber=hTTPSPortNumber, systemClock=systemClock, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, sMTPEmailAlert=sMTPEmailAlert, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rFUTxFreqMax=rFUTxFreqMax, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, remoteSecondaryMACAddress=remoteSecondaryMACAddress, encryptionEnabledMismatch=encryptionEnabledMismatch, userTableIndex=userTableIndex, reset=reset, neighborMACAddress=neighborMACAddress, antennaGain=antennaGain, sMTPServerInternetAddress=sMTPServerInternetAddress, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, aAAControl=aAAControl, primaryRecoveryPeriod=primaryRecoveryPeriod, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, rFUTransceiverLocation=rFUTransceiverLocation, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, remotePrimarySecondaryMode=remotePrimarySecondaryMode, iPv6Address=iPv6Address, transmitCapacityLimitDetail=transmitCapacityLimitDetail, rFUPlatformCompatibility=rFUPlatformCompatibility, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, productVariant=productVariant, supplementary=supplementary, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, radioLicenseBand=radioLicenseBand, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, protection=protection, fiberY=fiberY, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, managementPortAutoNegotiation=managementPortAutoNegotiation, rFULockoutAlarm=rFULockoutAlarm, numberOfAntennas=numberOfAntennas, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, phyControl=phyControl, transmitCapacity=transmitCapacity, productName=productName, rFUSerial=rFUSerial, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, sNTPSyncTrap=sNTPSyncTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, aTPCEnable=aTPCEnable, sNTPServerResponse=sNTPServerResponse, rxDiversityVlanTpid=rxDiversityVlanTpid, transmitDataRate=transmitDataRate, ethernetPriorityTableNumber=ethernetPriorityTableNumber, remoteInternetAddress=remoteInternetAddress, alignmentModeTrap=alignmentModeTrap, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, localPacketFiltering=localPacketFiltering, iPVersion=iPVersion, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, sNTPServerIPAddress=sNTPServerIPAddress, vLANManagementPriority=vLANManagementPriority, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, rFUTxPowerAlarm=rFUTxPowerAlarm, sMTPServerInternetAddressType=sMTPServerInternetAddressType, iFCableLength=iFCableLength, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, maxModulation=maxModulation, daylightSaving=daylightSaving, rFUTxFreqMin=rFUTxFreqMin, diverseAntennaGain=diverseAntennaGain, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, syslogClientTrap=syslogClientTrap, rFURxFreqMax=rFURxFreqMax, managementPortDisabledWarning=managementPortDisabledWarning, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, transmitCodeRate=transmitCodeRate, managementPortWirelessDownAlert=managementPortWirelessDownAlert, hTTPAccessEnabled=hTTPAccessEnabled, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, timeZone=timeZone, protectionState=protectionState, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerIPAddress=tFTPServerIPAddress, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, rFUStatus=rFUStatus, linkName=linkName, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rFURxFreqMin=rFURxFreqMin, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFUTxBandAboveRx=rFUTxBandAboveRx, protectionAvailabilityStatus=protectionAvailabilityStatus, rFURFSwitchAlarm=rFURFSwitchAlarm, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remotePrimaryMACAddress=remotePrimaryMACAddress, userName=userName, dataPortPauseFrames=dataPortPauseFrames, sNTPServerTableEntry=sNTPServerTableEntry, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, syslogState=syslogState, sNMPTrapTableEntry=sNMPTrapTableEntry, activeWirelessLinkAvailability=activeWirelessLinkAvailability, sNTPServerPortNumber=sNTPServerPortNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dSCPManagementPriority=dSCPManagementPriority, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, l2CPPriorityTableEntry=l2CPPriorityTableEntry, transmitModulation=transmitModulation, remoteInternetAddressType=remoteInternetAddressType, radioLicenseModulation=radioLicenseModulation, receiveModulation=receiveModulation, sMTPServerIPAddress=sMTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userTable=userTable, managementMode=managementMode, maxCodeRate=maxCodeRate, remoteMaximumTransmitPower=remoteMaximumTransmitPower, protectionStatus=protectionStatus, primaryRecovery=primaryRecovery, ethernetPriorityTableEntry=ethernetPriorityTableEntry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPLastSync=sNTPLastSync, syslogStateTrap=syslogStateTrap, radioLicenseTxFreq=radioLicenseTxFreq, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rFFeederLoss=rFFeederLoss, sMTPServerPortNumber=sMTPServerPortNumber, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, requestedProtectionState=requestedProtectionState, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogClient=syslogClient, smtp=smtp, protectionStats=protectionStats, rxDiversityDataPortStatus=rxDiversityDataPortStatus, tFTPServerPortNumber=tFTPServerPortNumber, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFUStatusTrap=rFUStatusTrap, sNTPServerTableNumber=sNTPServerTableNumber, neighborIPAddress=neighborIPAddress, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, qOSPriorityScheme=qOSPriorityScheme, sNMPCommunityString=sNMPCommunityString, transmitterStatus=transmitterStatus, radioLicenseMaxEIRP=radioLicenseMaxEIRP, rFUType=rFUType, rFUTxPowerMin=rFUTxPowerMin, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, ptmp=ptmp, receivePower=receivePower, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, userTableNumber=userTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, encryption=encryption, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFUActiveFirmwareBank=rFUActiveFirmwareBank, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, remoteSecondaryIPAddress=remoteSecondaryIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, radioLicenseMinModulation=radioLicenseMinModulation, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sntp=sntp, longitude=longitude, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rFUTxPowerMax=rFUTxPowerMax, rFUBranchingConfiguration=rFUBranchingConfiguration, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, managementCommittedInformationRate=managementCommittedInformationRate, rFUProtectionCompatibility=rFUProtectionCompatibility, neighborInternetAddressType=neighborInternetAddressType, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernet=ethernet, faultProtectionSwitching=faultProtectionSwitching)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ethernetFiberSupport=ethernetFiberSupport, rFURfBand=rFURfBand, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, management=management, alignmentMode=alignmentMode, radioLicenseRegion=radioLicenseRegion, radioLicense=radioLicense, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, managementPortStatusTrap=managementPortStatusTrap, sNTPSync=sNTPSync, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPPollInterval=sNTPPollInterval, subnetMask=subnetMask, sNTPServerTableIndex=sNTPServerTableIndex, vLANManagementVIDValidation=vLANManagementVIDValidation, radioLicenseMinCodeRate=radioLicenseMinCodeRate, primarySecondaryMode=primarySecondaryMode, linkNameMismatch=linkNameMismatch, iPv6GatewayAddress=iPv6GatewayAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, mPLSTCPriorityTable=mPLSTCPriorityTable, ptp800=ptp800, altitude=altitude, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rFUVersionBank2=rFUVersionBank2, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, snmpControl=snmpControl, rFUFreqSpacing=rFUFreqSpacing, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, userEnabled=userEnabled, transmitPower=transmitPower, bootVersion=bootVersion, rFUConnectedPlatform=rFUConnectedPlatform, secureModeAlarm=secureModeAlarm, diverseRfFeederLoss=diverseRfFeederLoss, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortStatus=dataPortStatus, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, remotePrimaryInternetAddress=remotePrimaryInternetAddress, rFUPowerAlarm=rFUPowerAlarm, rFUVersionBank1=rFUVersionBank1, radioLicenseMaxModulation=radioLicenseMaxModulation, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessLinkStatusTrap=wirelessLinkStatusTrap, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, encryptionAlgorithm=encryptionAlgorithm, enableTransmission=enableTransmission, ethernetPriorityTable=ethernetPriorityTable, l2CPPriorityTable=l2CPPriorityTable, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, vLANManagementVID=vLANManagementVID, sNTPServerRetries=sNTPServerRetries, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, secureModeAlarmTrap=secureModeAlarmTrap, activeAvailableTime=activeAvailableTime, rfu=rfu, bridge=bridge, cambium=cambium, dataPortStatusTrap=dataPortStatusTrap, radioLicenseRxFreq=radioLicenseRxFreq, minCodeRate=minCodeRate, iPv6PrefixLength=iPv6PrefixLength, protectionInterfaceStatus=protectionInterfaceStatus, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, remotePrimaryIPAddress=remotePrimaryIPAddress, linkNameMismatchTrap=linkNameMismatchTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ptp=ptp, rFURpsAlarm=rFURpsAlarm, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, systemReset=systemReset, aggregateDataRate=aggregateDataRate, hardwareVersion=hardwareVersion, minModulation=minModulation, protectionConfig=protectionConfig, remoteMACAddress=remoteMACAddress, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, alarms=alarms, radioLicenseCodeRate=radioLicenseCodeRate, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, ptpTrapPrefix=ptpTrapPrefix, syslogControl=syslogControl, radioLicenseBandwidth=radioLicenseBandwidth, dataPortFiberStatusTrap=dataPortFiberStatusTrap, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, receiveCodeRate=receiveCodeRate)
