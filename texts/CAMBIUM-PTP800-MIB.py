...
Integer32, ModuleIdentity, IpAddress, TimeTicks, Bits, Counter32, iso, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, MibIdentifier, NotificationType, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "IpAddress", "TimeTicks", "Bits", "Counter32", "iso", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "MibIdentifier", "NotificationType", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", activeAvailableTime=activeAvailableTime, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, primaryRecoveryPeriod=primaryRecoveryPeriod, radioLicense=radioLicense, remoteMACAddress=remoteMACAddress, sNTPLastSync=sNTPLastSync, siteName=siteName, phyControl=phyControl, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerTableNumber=sNTPServerTableNumber, antennaGain=antennaGain, rFUTransceiverLocation=rFUTransceiverLocation, neighborInternetAddress=neighborInternetAddress, bridge=bridge, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, telnetPortNumber=telnetPortNumber, ptp800=ptp800, sMTPSourceEmailAddress=sMTPSourceEmailAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPServerInternetAddressType=sNTPServerInternetAddressType, radioLicenseRxFreq=radioLicenseRxFreq, wirelessLinkAvailability=wirelessLinkAvailability, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rxDiversityVlanTpid=rxDiversityVlanTpid, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, radioLicenseBandwidth=radioLicenseBandwidth, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, wirelessLinkStatus=wirelessLinkStatus, hardwareVersion=hardwareVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rFURFSwitchAlarm=rFURFSwitchAlarm, iPVersion=iPVersion, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFUPowerAlarm=rFUPowerAlarm, alignmentModeTrap=alignmentModeTrap, protectionConfigurationStatus=protectionConfigurationStatus, iPv6Address=iPv6Address, numberOfAntennas=numberOfAntennas, linkName=linkName, useVLANForManagementInterfaces=useVLANForManagementInterfaces, faultProtectionSwitching=faultProtectionSwitching, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, ethernetPriorityTableEntry=ethernetPriorityTableEntry, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, managementPortAutoNegotiation=managementPortAutoNegotiation, snmpControl=snmpControl, systemReset=systemReset, sNTPServerTimeout=sNTPServerTimeout, licence=licence, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rfu=rfu, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tFTPServerIPAddress=tFTPServerIPAddress, configuration=configuration, receiveCodeRate=receiveCodeRate, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, primarySecondaryMode=primarySecondaryMode, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, iFCableLength=iFCableLength, rFUVersionBank2=rFUVersionBank2, radioLicenseBand=radioLicenseBand, sntp=sntp, rFUPlatformCompatibility=rFUPlatformCompatibility, rFUSerial=rFUSerial, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rFUStatusTrap=rFUStatusTrap, rFUTxPowerMax=rFUTxPowerMax, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, remoteInternetAddress=remoteInternetAddress, reset=reset, ptmp=ptmp, unitOutOfCalibration=unitOutOfCalibration, syslogClient=syslogClient, productVariant=productVariant, neighborMACAddress=neighborMACAddress, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, iPv4Address=iPv4Address, fiberY=fiberY, hTTPSAccessEnabled=hTTPSAccessEnabled, longitude=longitude, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, gatewayIPAddress=gatewayIPAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, ethernetPriorityTableIndex=ethernetPriorityTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, timeZone=timeZone, maxCodeRate=maxCodeRate, sNTPServerResponse=sNTPServerResponse, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, linkNameMismatchTrap=linkNameMismatchTrap, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, ptpTrapPrefix=ptpTrapPrefix, radioLicenseMaxModulation=radioLicenseMaxModulation, rFUConnectedPlatform=rFUConnectedPlatform, radioLicenseIdentifier=radioLicenseIdentifier, sNMPTrapTableIndex=sNMPTrapTableIndex, neighborIPAddress=neighborIPAddress, minCodeRate=minCodeRate, enableTransmission=enableTransmission, sNTPServerTableIndex=sNTPServerTableIndex, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, linkNameMismatch=linkNameMismatch, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, rFUTxBandAboveRx=rFUTxBandAboveRx, encryptionEnabledMismatch=encryptionEnabledMismatch, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, wirelessLinkStatusTrap=wirelessLinkStatusTrap, ethernet=ethernet, protectionAvailabilityStatus=protectionAvailabilityStatus, transmitModulation=transmitModulation, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, pubStats=pubStats, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, l2CPPriorityTableNumber=l2CPPriorityTableNumber, userName=userName, smtp=smtp, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, dataPortPauseFrames=dataPortPauseFrames, sMTPServerIPAddress=sMTPServerIPAddress, receiveDataRate=receiveDataRate, sNTPPrimaryServer=sNTPPrimaryServer, remoteIPAddress=remoteIPAddress, userTableIndex=userTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpTraps=ptpTraps, l2CPPriorityTableEntry=l2CPPriorityTableEntry, userEnabled=userEnabled, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, linkLoss=linkLoss, cambium=cambium, dataPortFiberStatusTrap=dataPortFiberStatusTrap, transmitCapacity=transmitCapacity, rFUActiveFirmwareBank=rFUActiveFirmwareBank, dataPortStatus=dataPortStatus, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, vLANManagementVIDValidation=vLANManagementVIDValidation, hTTPPortNumber=hTTPPortNumber, rFUTxFreqMin=rFUTxFreqMin, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rFURfBand=rFURfBand, productName=productName, tFTPServerPortNumber=tFTPServerPortNumber, dataPortStatusTrap=dataPortStatusTrap, phyStatus=phyStatus, userRole=userRole, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, rxDiversityDataPortStatus=rxDiversityDataPortStatus, ethernetPriorityTable=ethernetPriorityTable, radioLicenseModulation=radioLicenseModulation, protectionStatus=protectionStatus, radioLicenseMinCodeRate=radioLicenseMinCodeRate, protectionConfig=protectionConfig, rFUCableAlarm=rFUCableAlarm, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, l2CPPriorityTable=l2CPPriorityTable, sNTPState=sNTPState, supplementary=supplementary, diverseAntennaGain=diverseAntennaGain, minModulation=minModulation, sNTPServerInternetAddress=sNTPServerInternetAddress, aAAControl=aAAControl, sNMPEnabledTraps=sNMPEnabledTraps, userTable=userTable, rFUStatus=rFUStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, alignmentMode=alignmentMode, rFUVersionBank1=rFUVersionBank1, radioLicenseCodeRate=radioLicenseCodeRate, sNTPPollInterval=sNTPPollInterval, sMTPServerInternetAddressType=sMTPServerInternetAddressType, remotePrimaryInternetAddress=remotePrimaryInternetAddress, syslogClientTrap=syslogClientTrap, alarms=alarms, versions=versions, softwareVersion=softwareVersion, managementCommittedInformationRate=managementCommittedInformationRate, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapVersion=sNMPTrapVersion, latitude=latitude, tFTPServerInternetAddressType=tFTPServerInternetAddressType, bootVersion=bootVersion, rFURxFreqMax=rFURxFreqMax, protectionStats=protectionStats, sNMPCommunityString=sNMPCommunityString, rFUFreqSpacing=rFUFreqSpacing, neighborInternetAddressType=neighborInternetAddressType, sNTPSync=sNTPSync, primaryRecovery=primaryRecovery, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, ethernetFiberSupport=ethernetFiberSupport, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, vectorError=vectorError, localPacketFiltering=localPacketFiltering, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rFFeederLoss=rFFeederLoss, managementPortStatus=managementPortStatus, sNMPPortNumber=sNMPPortNumber, protectionStateTrap=protectionStateTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, maximumTransmitPower=maximumTransmitPower, hTTPSPortNumber=hTTPSPortNumber, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, rFUTxFreqMax=rFUTxFreqMax, transmitCodeRate=transmitCodeRate, remoteInternetAddressType=remoteInternetAddressType, protectionState=protectionState, sNMPTrapTableEntry=sNMPTrapTableEntry, managementPortStatusTrap=managementPortStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, radioLicenseMaxEIRP=radioLicenseMaxEIRP, radioLicenseMinModulation=radioLicenseMinModulation, encryption=encryption, iPv6PrefixLength=iPv6PrefixLength, remoteSecondaryIPAddress=remoteSecondaryIPAddress, rFUType=rFUType, managementMode=managementMode, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, managementPortForcedConfiguration=managementPortForcedConfiguration, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rFUTxPowerAlarm=rFUTxPowerAlarm, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableNumber=sNMPTrapTableNumber, rFUTxMuteStatus=rFUTxMuteStatus, vLANManagementPriority=vLANManagementPriority, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, encryptionAlgorithm=encryptionAlgorithm, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, transmitCapacityLimitDetail=transmitCapacityLimitDetail, iPDSCPPriorityTable=iPDSCPPriorityTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPv6GatewayAddress=iPv6GatewayAddress, sMTPEmailAlert=sMTPEmailAlert, requestedProtectionState=requestedProtectionState, remotePrimaryMACAddress=remotePrimaryMACAddress, remotePrimaryIPAddress=remotePrimaryIPAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, activeUnit=activeUnit, dataPortFiberStatus=dataPortFiberStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rFURpsAlarm=rFURpsAlarm, subnetMask=subnetMask, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, userTableEntry=userTableEntry, receivePower=receivePower, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rFUProtectionCompatibility=rFUProtectionCompatibility, receiveModulation=receiveModulation, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerRetries=sNTPServerRetries, syslogState=syslogState, systemClock=systemClock, transmitCapacityLimit=transmitCapacityLimit, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, hTTPAccessEnabled=hTTPAccessEnabled, rFUBranchingConfiguration=rFUBranchingConfiguration, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPSyncTrap=sNTPSyncTrap, sNTPServerTable=sNTPServerTable, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rFULockoutAlarm=rFULockoutAlarm, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rFUPowerButtonPressed=rFUPowerButtonPressed, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, maxModulation=maxModulation, secondarySoftwareVersion=secondarySoftwareVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userPassword=userPassword, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, protectionInterfaceStatus=protectionInterfaceStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userTableNumber=userTableNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, daylightSaving=daylightSaving, managementPortDisabledWarning=managementPortDisabledWarning, syslogStateTrap=syslogStateTrap, transmitDataRate=transmitDataRate, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, radioLicenseRegion=radioLicenseRegion, vLANManagementVID=vLANManagementVID, rxDiversityVid=rxDiversityVid, endId=endId, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, telnetAccessEnabled=telnetAccessEnabled, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, qOSPriorityScheme=qOSPriorityScheme, management=management, protection=protection, diverseRfFeederLoss=diverseRfFeederLoss, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, syslogControl=syslogControl, ptp=ptp, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, securityLevel=securityLevel, aggregateDataRate=aggregateDataRate, sNMPTrapTable=sNMPTrapTable, aTPCEnable=aTPCEnable, protectionSwitchCause=protectionSwitchCause, transmitterStatus=transmitterStatus, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, altitude=altitude, secureModeAlarmTrap=secureModeAlarmTrap, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sNTPServerPortNumber=sNTPServerPortNumber, dataPortDisabledWarning=dataPortDisabledWarning, tFTPServerInternetAddress=tFTPServerInternetAddress, radioLicenseTxFreq=radioLicenseTxFreq, rFUTxPowerMin=rFUTxPowerMin, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, enabledDiagnosticAlarms=enabledDiagnosticAlarms, secureModeAlarm=secureModeAlarm, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, rFURxFreqMin=rFURxFreqMin, sMTPServerPortNumber=sMTPServerPortNumber, transmitPower=transmitPower, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex)
