...
IpAddress, TimeTicks, enterprises, Unsigned32, Integer32, Counter64, NotificationType, MibIdentifier, Bits, NotificationType, Counter32, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "enterprises", "Unsigned32", "Integer32", "Counter64", "NotificationType", "MibIdentifier", "Bits", "NotificationType", "Counter32", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, secureModeAlarmTrap=secureModeAlarmTrap, vLANManagementVID=vLANManagementVID, diverseAntennaGain=diverseAntennaGain, iPv6Address=iPv6Address, rFUFreqSpacing=rFUFreqSpacing, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rFUStatus=rFUStatus, aTPCEnable=aTPCEnable, rFULockoutAlarm=rFULockoutAlarm, telnetAccessEnabled=telnetAccessEnabled, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, l2CPPriorityTableIndex=l2CPPriorityTableIndex, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortStatusTrap=dataPortStatusTrap, productVariant=productVariant, systemClock=systemClock, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, remoteInternetAddressType=remoteInternetAddressType, rFURxFreqMax=rFURxFreqMax, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, securityLevel=securityLevel, ethernetPriorityTable=ethernetPriorityTable, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rFURpsAlarm=rFURpsAlarm, transmitCodeRate=transmitCodeRate, rFURfBand=rFURfBand, transmitDataRate=transmitDataRate, rFUCableAlarm=rFUCableAlarm, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, protectionState=protectionState, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, alarms=alarms, reset=reset, timeZone=timeZone, syslogClient=syslogClient, antennaGain=antennaGain, remoteIPAddress=remoteIPAddress, rfu=rfu, userTableNumber=userTableNumber, softwareVersion=softwareVersion, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, sNTPServerTable=sNTPServerTable, radioLicenseIdentifier=radioLicenseIdentifier, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, maxCodeRate=maxCodeRate, receiveCodeRate=receiveCodeRate, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, faultProtectionSwitching=faultProtectionSwitching, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, radioLicenseBandwidth=radioLicenseBandwidth, qOSPriorityScheme=qOSPriorityScheme, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, radioLicenseTxFreq=radioLicenseTxFreq, snmpControl=snmpControl, sNMPCommunityString=sNMPCommunityString, transmitterStatus=transmitterStatus, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rFUPlatformCompatibility=rFUPlatformCompatibility, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sNTPServerResponse=sNTPServerResponse, remotePrimaryIPAddress=remotePrimaryIPAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, iFCableLength=iFCableLength, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, userTable=userTable, sNTPServerPortNumber=sNTPServerPortNumber, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, hTTPAccessEnabled=hTTPAccessEnabled, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPPortNumber=sNMPPortNumber, pubStats=pubStats, l2CPPriorityTable=l2CPPriorityTable, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sntp=sntp, smtp=smtp, ethernet=ethernet, remoteInternetAddress=remoteInternetAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFUActiveFirmwareBank=rFUActiveFirmwareBank, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, radioLicenseModulation=radioLicenseModulation, hardwareVersion=hardwareVersion, primarySecondaryMode=primarySecondaryMode, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, protectionInterfaceStatus=protectionInterfaceStatus, configuration=configuration, maximumTransmitPower=maximumTransmitPower, neighborInternetAddressType=neighborInternetAddressType, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telnetPortNumber=telnetPortNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, dataPortStatus=dataPortStatus, rFUTxMuteStatus=rFUTxMuteStatus, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, management=management, ethernetFiberSupport=ethernetFiberSupport, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPServerTimeout=sNTPServerTimeout, activeAvailableTime=activeAvailableTime, radioLicenseMinCodeRate=radioLicenseMinCodeRate, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFUTxFreqMin=rFUTxFreqMin, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, radioLicenseMaxModulation=radioLicenseMaxModulation, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, iPVersion=iPVersion, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, endId=endId, rFUProtectionCompatibility=rFUProtectionCompatibility, protectionStatus=protectionStatus, radioLicenseMinModulation=radioLicenseMinModulation, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, linkNameMismatchTrap=linkNameMismatchTrap, rFFeederLoss=rFFeederLoss, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, managementPortForcedConfiguration=managementPortForcedConfiguration, wirelessLinkStatus=wirelessLinkStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, licence=licence, sNTPState=sNTPState, dataPortPauseFrames=dataPortPauseFrames, sNMPTrapVersion=sNMPTrapVersion, remoteSecondaryIPAddress=remoteSecondaryIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, vLANManagementPriority=vLANManagementPriority, transmitCapacity=transmitCapacity, protectionStateTrap=protectionStateTrap, syslogClientTrap=syslogClientTrap, sNTPLastSync=sNTPLastSync, rFUTxPowerMin=rFUTxPowerMin, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hTTPSPortNumber=hTTPSPortNumber, sNTPServerTableNumber=sNTPServerTableNumber, radioLicenseBand=radioLicenseBand, radioLicense=radioLicense, altitude=altitude, sMTPServerInternetAddressType=sMTPServerInternetAddressType, neighborMACAddress=neighborMACAddress, ptpTrapPrefix=ptpTrapPrefix, phyControl=phyControl, rFUStatusTrap=rFUStatusTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementCommittedInformationRate=managementCommittedInformationRate, secondarySoftwareVersion=secondarySoftwareVersion, rxDiversityVid=rxDiversityVid, phyStatus=phyStatus, aAAControl=aAAControl, latitude=latitude, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tFTPServerIPAddress=tFTPServerIPAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, managementPortStatus=managementPortStatus, sNTPServerIPAddress=sNTPServerIPAddress, rFURFSwitchAlarm=rFURFSwitchAlarm, activeUnit=activeUnit, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, managementPortStatusTrap=managementPortStatusTrap, userTableEntry=userTableEntry, hTTPPortNumber=hTTPPortNumber, longitude=longitude, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPServerRetries=sNTPServerRetries, localPacketFiltering=localPacketFiltering, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, encryption=encryption, unitOutOfCalibration=unitOutOfCalibration, linkName=linkName, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, managementMode=managementMode, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sNMPTrapTable=sNMPTrapTable, vLANManagementVIDValidation=vLANManagementVIDValidation, managementPortAutoNegotiation=managementPortAutoNegotiation, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, sNMPTrapTableIndex=sNMPTrapTableIndex, linkNameMismatch=linkNameMismatch, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortDisabledWarning=dataPortDisabledWarning, sNTPPrimaryServer=sNTPPrimaryServer, syslogState=syslogState, versions=versions, sNTPSyncTrap=sNTPSyncTrap, rFUTxFreqMax=rFUTxFreqMax, primaryRecoveryPeriod=primaryRecoveryPeriod, enableTransmission=enableTransmission, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, receiveDataRate=receiveDataRate, userRole=userRole, encryptionAlgorithm=encryptionAlgorithm, rFUVersionBank1=rFUVersionBank1, radioLicenseRxFreq=radioLicenseRxFreq, sNTPServerTableIndex=sNTPServerTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, protectionStats=protectionStats, userTableIndex=userTableIndex, numberOfAntennas=numberOfAntennas, wirelessLinkAvailability=wirelessLinkAvailability, rFUSerial=rFUSerial, neighborIPAddress=neighborIPAddress, sMTPEmailAlert=sMTPEmailAlert, transmitPower=transmitPower, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, systemReset=systemReset, sNMPTrapIPAddress=sNMPTrapIPAddress, diverseRfFeederLoss=diverseRfFeederLoss, transmitCapacityLimitDetail=transmitCapacityLimitDetail, rFUPowerAlarm=rFUPowerAlarm, remotePrimaryMACAddress=remotePrimaryMACAddress, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, userPassword=userPassword, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, sMTPServerInternetAddress=sMTPServerInternetAddress, encryptionEnabledMismatch=encryptionEnabledMismatch, protectionAvailabilityStatus=protectionAvailabilityStatus, requestedProtectionState=requestedProtectionState, rFUBranchingConfiguration=rFUBranchingConfiguration, ptp800=ptp800, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFUPowerButtonPressed=rFUPowerButtonPressed, sNMPTrapTableEntry=sNMPTrapTableEntry, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, siteName=siteName, transmitCapacityLimit=transmitCapacityLimit)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, iPv4Address=iPv4Address, protection=protection, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, daylightSaving=daylightSaving, remoteMACAddress=remoteMACAddress, sMTPServerIPAddress=sMTPServerIPAddress, managementPortDisabledWarning=managementPortDisabledWarning, protectionConfig=protectionConfig, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, gatewayIPAddress=gatewayIPAddress, rFUVersionBank2=rFUVersionBank2, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, productName=productName, dSCPManagementPriority=dSCPManagementPriority, remoteSecondaryMACAddress=remoteSecondaryMACAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPEnabledTraps=sNMPEnabledTraps, rxDiversityDataPortStatus=rxDiversityDataPortStatus, radioLicenseCodeRate=radioLicenseCodeRate, supplementary=supplementary, wirelessLinkStatusTrap=wirelessLinkStatusTrap, receivePower=receivePower, radioLicenseRegion=radioLicenseRegion, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ptmp=ptmp, sMTPEnabledMessages=sMTPEnabledMessages, dataPortWirelessDownAlert=dataPortWirelessDownAlert, protectionConfigurationStatus=protectionConfigurationStatus, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rxDiversityVlanTpid=rxDiversityVlanTpid, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFUTransceiverLocation=rFUTransceiverLocation, rFUConnectedPlatform=rFUConnectedPlatform, rFUTxBandAboveRx=rFUTxBandAboveRx, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, sNTPServerTableEntry=sNTPServerTableEntry, rFUTxPowerAlarm=rFUTxPowerAlarm, neighborInternetAddress=neighborInternetAddress, sNTPSync=sNTPSync, receiveModulation=receiveModulation, managementPortWirelessDownAlert=managementPortWirelessDownAlert, alignmentMode=alignmentMode, sMTPServerPortNumber=sMTPServerPortNumber, minModulation=minModulation, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, cambium=cambium, syslogControl=syslogControl, aggregateDataRate=aggregateDataRate, rFURxFreqMin=rFURxFreqMin, iPv6GatewayAddress=iPv6GatewayAddress, vectorError=vectorError, alignmentModeTrap=alignmentModeTrap, userEnabled=userEnabled, secureModeAlarm=secureModeAlarm, dataPortFiberStatus=dataPortFiberStatus, userName=userName, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, primaryRecovery=primaryRecovery, bridge=bridge, transmitModulation=transmitModulation, bootVersion=bootVersion, remotePrimaryInternetAddress=remotePrimaryInternetAddress, rFUTxPowerMax=rFUTxPowerMax, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, minCodeRate=minCodeRate, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, maxModulation=maxModulation, rFUType=rFUType, sNTPPollInterval=sNTPPollInterval, managementPortConfigurationMismatch=managementPortConfigurationMismatch, protectionSwitchCause=protectionSwitchCause, subnetMask=subnetMask, ptpTraps=ptpTraps, ptp=ptp, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, syslogStateTrap=syslogStateTrap, iPv6PrefixLength=iPv6PrefixLength, fiberY=fiberY, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, linkLoss=linkLoss, remotePrimarySecondaryMode=remotePrimarySecondaryMode, useVLANForManagementInterfaces=useVLANForManagementInterfaces)
