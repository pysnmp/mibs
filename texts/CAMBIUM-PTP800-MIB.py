...
ModuleIdentity, enterprises, NotificationType, ObjectIdentity, Counter64, Counter32, Integer32, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, IpAddress, Gauge32, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "NotificationType", "ObjectIdentity", "Counter64", "Counter32", "Integer32", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "IpAddress", "Gauge32", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNTPServerTableNumber=sNTPServerTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteInternetAddress=remoteInternetAddress, sMTPEmailAlert=sMTPEmailAlert, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, antennaGain=antennaGain, hTTPSAccessEnabled=hTTPSAccessEnabled, smtp=smtp, activeWirelessLinkAvailability=activeWirelessLinkAvailability, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, sNMPTrapVersion=sNMPTrapVersion, systemReset=systemReset, vLANManagementVIDValidation=vLANManagementVIDValidation, sNMPEnabledTraps=sNMPEnabledTraps, rFUTxPowerMax=rFUTxPowerMax, licence=licence, transmitPower=transmitPower, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFUFreqSpacing=rFUFreqSpacing, alignmentModeTrap=alignmentModeTrap, timeZone=timeZone, dataPortFiberStatus=dataPortFiberStatus, rxDiversityVlanTpid=rxDiversityVlanTpid, fiberY=fiberY, phyStatus=phyStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rfu=rfu, neighborMACAddress=neighborMACAddress, securityLevel=securityLevel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, userEnabled=userEnabled, aggregateDataRate=aggregateDataRate, syslogControl=syslogControl, rFUTransceiverLocation=rFUTransceiverLocation, rFUStatus=rFUStatus, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rFUType=rFUType, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, hTTPSPortNumber=hTTPSPortNumber, sNMPCommunityString=sNMPCommunityString, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, sNTPPollInterval=sNTPPollInterval, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPEnabledMessages=sMTPEnabledMessages, secureModeAlarm=secureModeAlarm, sMTPServerInternetAddress=sMTPServerInternetAddress, vectorError=vectorError, dSCPManagementPriority=dSCPManagementPriority, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, secureModeAlarmTrap=secureModeAlarmTrap, radioLicenseBand=radioLicenseBand, bootVersion=bootVersion, primaryRecoveryPeriod=primaryRecoveryPeriod, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, sNTPServerResponse=sNTPServerResponse, radioLicenseMinCodeRate=radioLicenseMinCodeRate, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, sNTPServerPortNumber=sNTPServerPortNumber, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFUPowerButtonPressed=rFUPowerButtonPressed, iPDSCPPriorityTable=iPDSCPPriorityTable, remoteMACAddress=remoteMACAddress, rFURxFreqMax=rFURxFreqMax, hTTPPortNumber=hTTPPortNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerTableIndex=sNTPServerTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, radioLicenseTxFreq=radioLicenseTxFreq, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, ethernetFiberSupport=ethernetFiberSupport, managementPortDisabledWarning=managementPortDisabledWarning, sNMPTrapInternetAddress=sNMPTrapInternetAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, unitOutOfCalibration=unitOutOfCalibration, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, syslogStateTrap=syslogStateTrap, supplementary=supplementary, ptp=ptp, diverseRfFeederLoss=diverseRfFeederLoss, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, managementPortAutoNegotiation=managementPortAutoNegotiation, activeAvailableTime=activeAvailableTime, syslogClientTrap=syslogClientTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, rFURfBand=rFURfBand, radioLicense=radioLicense, l2CPPriorityTable=l2CPPriorityTable, reset=reset, ethernet=ethernet, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, linkNameMismatchTrap=linkNameMismatchTrap, ptmp=ptmp, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, sNTPServerIPAddress=sNTPServerIPAddress, sNTPLastSync=sNTPLastSync, protectionAvailabilityStatus=protectionAvailabilityStatus, rFUTxMuteStatus=rFUTxMuteStatus, managementPortStatusTrap=managementPortStatusTrap, sNMPTrapTable=sNMPTrapTable, minModulation=minModulation, gatewayIPAddress=gatewayIPAddress, managementPortStatus=managementPortStatus, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, remotePrimarySecondaryMode=remotePrimarySecondaryMode, neighborInternetAddress=neighborInternetAddress, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, minCodeRate=minCodeRate, userTableNumber=userTableNumber, transmitCapacityLimit=transmitCapacityLimit, remotePrimaryIPAddress=remotePrimaryIPAddress, transmitCodeRate=transmitCodeRate, localPacketFiltering=localPacketFiltering, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPPortNumber=sNMPPortNumber, rFUCableAlarm=rFUCableAlarm, remotePrimaryMACAddress=remotePrimaryMACAddress, receiveModulation=receiveModulation, altitude=altitude, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, qOSPriorityScheme=qOSPriorityScheme, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, maximumTransmitPower=maximumTransmitPower, endId=endId, aTPCEnable=aTPCEnable, syslogState=syslogState, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, protectionStatus=protectionStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPServerRetries=sNTPServerRetries, rFUStatusTrap=rFUStatusTrap, remoteSecondaryIPAddress=remoteSecondaryIPAddress, sNTPState=sNTPState, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, subnetMask=subnetMask, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, syslogClient=syslogClient, remotePrimaryInternetAddress=remotePrimaryInternetAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, linkName=linkName, remoteIPAddress=remoteIPAddress, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, dataPortStatus=dataPortStatus, softwareVersion=softwareVersion, tFTPServerPortNumber=tFTPServerPortNumber, snmpControl=snmpControl, radioLicenseIdentifier=radioLicenseIdentifier, encryptionAlgorithm=encryptionAlgorithm, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rFUTxFreqMax=rFUTxFreqMax, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPServerTimeout=sNTPServerTimeout, aAAControl=aAAControl, phyControl=phyControl, rFFeederLoss=rFFeederLoss, rFUSerial=rFUSerial, protectionConfigurationStatus=protectionConfigurationStatus, telnetPortNumber=telnetPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, rFUVersionBank1=rFUVersionBank1, diverseAntennaGain=diverseAntennaGain, tFTPServerInternetAddressType=tFTPServerInternetAddressType, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, management=management, iPVersion=iPVersion, linkLoss=linkLoss, maxModulation=maxModulation, transmitDataRate=transmitDataRate, dataPortPauseFrames=dataPortPauseFrames, sntp=sntp, receiveCodeRate=receiveCodeRate, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, rFUPlatformCompatibility=rFUPlatformCompatibility, userPassword=userPassword, radioLicenseModulation=radioLicenseModulation, remoteInternetAddressType=remoteInternetAddressType, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rFULockoutAlarm=rFULockoutAlarm, rFUPowerAlarm=rFUPowerAlarm, managementPortForcedConfiguration=managementPortForcedConfiguration, rFUVersionBank2=rFUVersionBank2, protectionConfig=protectionConfig, dataPortStatusTrap=dataPortStatusTrap, rFUTxPowerAlarm=rFUTxPowerAlarm, rFURpsAlarm=rFURpsAlarm, vLANManagementVID=vLANManagementVID, protectionStateTrap=protectionStateTrap, sNTPServerTableEntry=sNTPServerTableEntry, bridge=bridge, radioLicenseMaxModulation=radioLicenseMaxModulation, configuration=configuration, iFCableLength=iFCableLength, versions=versions, l2CPPriorityTableNumber=l2CPPriorityTableNumber, transmitCapacityLimitDetail=transmitCapacityLimitDetail, sNTPSync=sNTPSync, rFURFSwitchAlarm=rFURFSwitchAlarm, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, vLANManagementPriority=vLANManagementPriority, wirelessLinkStatusTrap=wirelessLinkStatusTrap, radioLicenseCodeRate=radioLicenseCodeRate, userName=userName, primarySecondaryMode=primarySecondaryMode, telnetAccessEnabled=telnetAccessEnabled, radioLicenseBandwidth=radioLicenseBandwidth, requestedProtectionState=requestedProtectionState, activeUnit=activeUnit, protectionInterfaceStatus=protectionInterfaceStatus, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, sNTPServerTable=sNTPServerTable, encryptionEnabledMismatch=encryptionEnabledMismatch, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, primaryRecovery=primaryRecovery, dataPortFiberStatusTrap=dataPortFiberStatusTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, latitude=latitude, sMTPServerIPAddress=sMTPServerIPAddress, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, systemClock=systemClock, faultProtectionSwitching=faultProtectionSwitching, sNMPTrapPortNumber=sNMPTrapPortNumber, rFUConnectedPlatform=rFUConnectedPlatform, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, managementCommittedInformationRate=managementCommittedInformationRate, mPLSTCPriorityTable=mPLSTCPriorityTable, transmitModulation=transmitModulation, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitCapacity=transmitCapacity)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUTxFreqMin=rFUTxFreqMin, rFUTxPowerMin=rFUTxPowerMin, userTableEntry=userTableEntry, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, radioLicenseMinModulation=radioLicenseMinModulation, pubStats=pubStats, rFURxFreqMin=rFURxFreqMin, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitterStatus=transmitterStatus, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, neighborIPAddress=neighborIPAddress, numberOfAntennas=numberOfAntennas, dataPortDisabledWarning=dataPortDisabledWarning, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, sNTPServerInternetAddress=sNTPServerInternetAddress, managementMode=managementMode, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, sMTPServerPortNumber=sMTPServerPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, productVariant=productVariant, iPv6Address=iPv6Address, ethernetPriorityTable=ethernetPriorityTable, radioLicenseRxFreq=radioLicenseRxFreq, protectionSwitchCause=protectionSwitchCause, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPPrimaryServer=sNTPPrimaryServer, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptp800=ptp800, rFUTxBandAboveRx=rFUTxBandAboveRx, sNMPTrapTableIndex=sNMPTrapTableIndex, encryption=encryption, ethernetPriorityTableIndex=ethernetPriorityTableIndex, protection=protection, rFUProtectionCompatibility=rFUProtectionCompatibility, alarms=alarms, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userTable=userTable, wirelessLinkStatus=wirelessLinkStatus, iPv6GatewayAddress=iPv6GatewayAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNMPTrapIPAddress=sNMPTrapIPAddress, daylightSaving=daylightSaving, protectionState=protectionState, hTTPAccessEnabled=hTTPAccessEnabled, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, alignmentMode=alignmentMode, receiveDataRate=receiveDataRate, radioLicenseRegion=radioLicenseRegion, userRole=userRole, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, neighborInternetAddressType=neighborInternetAddressType, rxDiversityVid=rxDiversityVid, protectionStats=protectionStats, siteName=siteName, hardwareVersion=hardwareVersion, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortConfigurationMismatch=dataPortConfigurationMismatch, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, enableTransmission=enableTransmission, rFUActiveFirmwareBank=rFUActiveFirmwareBank, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPv6PrefixLength=iPv6PrefixLength, productName=productName, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, receivePower=receivePower, longitude=longitude, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ptpTrapPrefix=ptpTrapPrefix, maxCodeRate=maxCodeRate, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sNTPSyncTrap=sNTPSyncTrap, linkNameMismatch=linkNameMismatch, rFUBranchingConfiguration=rFUBranchingConfiguration, cambium=cambium, ptpTraps=ptpTraps, userTableIndex=userTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, iPv4Address=iPv4Address)
