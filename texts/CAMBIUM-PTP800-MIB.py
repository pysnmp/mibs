...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", l2CPPriorityTableNumber=l2CPPriorityTableNumber, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFUPowerAlarm=rFUPowerAlarm, protectionStats=protectionStats, protectionInterfaceStatus=protectionInterfaceStatus, aggregateDataRate=aggregateDataRate, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, sNTPServerResponse=sNTPServerResponse, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, radioLicenseBandwidth=radioLicenseBandwidth, maximumTransmitPower=maximumTransmitPower, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sNTPServerPortNumber=sNTPServerPortNumber, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, protectionConfig=protectionConfig, protectionState=protectionState, gatewayIPAddress=gatewayIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, remoteSecondaryIPAddress=remoteSecondaryIPAddress, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, pubStats=pubStats, activeWirelessLinkAvailability=activeWirelessLinkAvailability, ptpTraps=ptpTraps, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, encryptionEnabledMismatch=encryptionEnabledMismatch, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, localPacketFiltering=localPacketFiltering, minModulation=minModulation, wirelessLinkStatus=wirelessLinkStatus, remoteSecondaryMACAddress=remoteSecondaryMACAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, linkNameMismatch=linkNameMismatch, linkLoss=linkLoss, tFTPServerInternetAddress=tFTPServerInternetAddress, vectorError=vectorError, vLANManagementVID=vLANManagementVID, managementPortDisabledWarning=managementPortDisabledWarning, management=management, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetFiberSupport=ethernetFiberSupport, sNMPEnabledTraps=sNMPEnabledTraps, primaryRecoveryPeriod=primaryRecoveryPeriod, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, remotePrimarySecondaryMode=remotePrimarySecondaryMode, ptpTrapPrefix=ptpTrapPrefix, phyStatus=phyStatus, encryption=encryption, rFUTransceiverLocation=rFUTransceiverLocation, dataPortWirelessDownAlert=dataPortWirelessDownAlert, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, aAAControl=aAAControl, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, syslogState=syslogState, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, subnetMask=subnetMask, neighborInternetAddressType=neighborInternetAddressType, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, sMTPServerIPAddress=sMTPServerIPAddress, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, iPv6Address=iPv6Address, daylightSaving=daylightSaving, transmitCapacityLimitDetail=transmitCapacityLimitDetail, sntp=sntp, managementPortConfigurationMismatch=managementPortConfigurationMismatch, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rxDiversityVid=rxDiversityVid, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, requestedProtectionState=requestedProtectionState, hTTPPortNumber=hTTPPortNumber, radioLicenseTxFreq=radioLicenseTxFreq, ethernetPriorityTableIndex=ethernetPriorityTableIndex, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, encryptionAlgorithm=encryptionAlgorithm, neighborMACAddress=neighborMACAddress, rFUTxFreqMax=rFUTxFreqMax, remotePrimaryMACAddress=remotePrimaryMACAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, transmitCodeRate=transmitCodeRate, sNTPServerInternetAddress=sNTPServerInternetAddress, diverseRfFeederLoss=diverseRfFeederLoss, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, managementMode=managementMode, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, radioLicenseMaxModulation=radioLicenseMaxModulation, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, protection=protection, dSCPManagementPriority=dSCPManagementPriority, iPv4Address=iPv4Address, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPPrimaryServer=sNTPPrimaryServer, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rFUTxMuteStatus=rFUTxMuteStatus, rFUStatusTrap=rFUStatusTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, systemReset=systemReset, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, syslogControl=syslogControl, sNTPSyncTrap=sNTPSyncTrap, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rFUTxPowerAlarm=rFUTxPowerAlarm, transmitCapacityLimit=transmitCapacityLimit, configuration=configuration, enableTransmission=enableTransmission, dataPortPauseFrames=dataPortPauseFrames, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, protectionSwitchCause=protectionSwitchCause, rFUFreqSpacing=rFUFreqSpacing, sNTPServerTimeout=sNTPServerTimeout, managementPortStatus=managementPortStatus, neighborInternetAddress=neighborInternetAddress, latitude=latitude, alarms=alarms, remoteInternetAddressType=remoteInternetAddressType, snmpControl=snmpControl, radioLicenseIdentifier=radioLicenseIdentifier, fiberY=fiberY, protectionAvailabilityStatus=protectionAvailabilityStatus, protectionConfigurationStatus=protectionConfigurationStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, aTPCEnable=aTPCEnable, rFUStatus=rFUStatus, syslogClientTrap=syslogClientTrap, sNTPState=sNTPState, alignmentMode=alignmentMode, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rFURFSwitchAlarm=rFURFSwitchAlarm, linkName=linkName, managementPortForcedConfiguration=managementPortForcedConfiguration, rxDiversityDataPortStatus=rxDiversityDataPortStatus, qOSPriorityScheme=qOSPriorityScheme, secondarySoftwareVersion=secondarySoftwareVersion, sNTPServerTable=sNTPServerTable, sNTPSync=sNTPSync, productName=productName, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, transmitPower=transmitPower, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rFUTxFreqMin=rFUTxFreqMin, secureModeAlarmTrap=secureModeAlarmTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, diverseAntennaGain=diverseAntennaGain, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapTableEntry=sNMPTrapTableEntry, hTTPAccessEnabled=hTTPAccessEnabled, rFUPowerButtonPressed=rFUPowerButtonPressed, primarySecondaryMode=primarySecondaryMode, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, neighborIPAddress=neighborIPAddress, iPv6PrefixLength=iPv6PrefixLength, sMTPServerPortNumber=sMTPServerPortNumber, versions=versions, sNTPServerTableEntry=sNTPServerTableEntry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, phyControl=phyControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitModulation=transmitModulation, bootVersion=bootVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, productVariant=productVariant, rFUTxPowerMax=rFUTxPowerMax, rFUActiveFirmwareBank=rFUActiveFirmwareBank, radioLicenseBand=radioLicenseBand, remotePrimaryInternetAddress=remotePrimaryInternetAddress, rFURfBand=rFURfBand, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, siteName=siteName, altitude=altitude, antennaGain=antennaGain, systemClock=systemClock, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, remoteMACAddress=remoteMACAddress, sNMPPortNumber=sNMPPortNumber, receiveCodeRate=receiveCodeRate, rfu=rfu, endId=endId, userPassword=userPassword, remoteInternetAddress=remoteInternetAddress, telnetPortNumber=telnetPortNumber, transmitDataRate=transmitDataRate, wirelessLinkAvailability=wirelessLinkAvailability, managementCommittedInformationRate=managementCommittedInformationRate, transmitCapacity=transmitCapacity, receiveDataRate=receiveDataRate, userEnabled=userEnabled, userTableEntry=userTableEntry, rFUPlatformCompatibility=rFUPlatformCompatibility, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, activeUnit=activeUnit, sNMPCommunityString=sNMPCommunityString, activeAvailableTime=activeAvailableTime, radioLicenseRxFreq=radioLicenseRxFreq, receivePower=receivePower, l2CPPriorityTableEntry=l2CPPriorityTableEntry, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, rFUSerial=rFUSerial, maxCodeRate=maxCodeRate, reset=reset, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, maxModulation=maxModulation, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataPortFiberStatus=dataPortFiberStatus, sNTPServerTableNumber=sNTPServerTableNumber, numberOfAntennas=numberOfAntennas, primaryRecovery=primaryRecovery, userTable=userTable, syslogClient=syslogClient, ptmp=ptmp, rFURxFreqMax=rFURxFreqMax, iPVersion=iPVersion, ethernetPriorityTable=ethernetPriorityTable, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sMTPServerInternetAddressType=sMTPServerInternetAddressType, minCodeRate=minCodeRate, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapTable=sNMPTrapTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rFUTxPowerMin=rFUTxPowerMin, alignmentModeTrap=alignmentModeTrap, rFURxFreqMin=rFURxFreqMin, iPv6GatewayAddress=iPv6GatewayAddress, remoteIPAddress=remoteIPAddress, longitude=longitude, managementPortStatusTrap=managementPortStatusTrap, sMTPEmailAlert=sMTPEmailAlert, syslogStateTrap=syslogStateTrap, managementPortAutoNegotiation=managementPortAutoNegotiation, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, timeZone=timeZone)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, remotePrimaryIPAddress=remotePrimaryIPAddress, l2CPPriorityTable=l2CPPriorityTable, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, protectionStateTrap=protectionStateTrap, sNTPPollInterval=sNTPPollInterval, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, radioLicenseModulation=radioLicenseModulation, rFFeederLoss=rFFeederLoss, radioLicenseCodeRate=radioLicenseCodeRate, userName=userName, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerRetries=sNTPServerRetries, userTableIndex=userTableIndex, rFUBranchingConfiguration=rFUBranchingConfiguration, radioLicenseMaxEIRP=radioLicenseMaxEIRP, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, remoteMaximumTransmitPower=remoteMaximumTransmitPower, hTTPSAccessEnabled=hTTPSAccessEnabled, rFUTxBandAboveRx=rFUTxBandAboveRx, tFTPServerPortNumber=tFTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, protectionStatus=protectionStatus, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFUProtectionCompatibility=rFUProtectionCompatibility, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rxDiversityVlanTpid=rxDiversityVlanTpid, receiveModulation=receiveModulation, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFULockoutAlarm=rFULockoutAlarm, softwareVersion=softwareVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFUCableAlarm=rFUCableAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rFURpsAlarm=rFURpsAlarm, ptp800=ptp800, ethernet=ethernet, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, rFUConnectedPlatform=rFUConnectedPlatform, userRole=userRole, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, vLANManagementPriority=vLANManagementPriority, supplementary=supplementary, transmitterStatus=transmitterStatus, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, smtp=smtp, sMTPEnabledMessages=sMTPEnabledMessages, telnetAccessEnabled=telnetAccessEnabled, licence=licence, rFUVersionBank1=rFUVersionBank1, dataPortStatus=dataPortStatus, sNMPTrapVersion=sNMPTrapVersion, unitOutOfCalibration=unitOutOfCalibration, bridge=bridge, dataPortConfigurationMismatch=dataPortConfigurationMismatch, radioLicense=radioLicense, faultProtectionSwitching=faultProtectionSwitching, hardwareVersion=hardwareVersion, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, ethernetPriorityTableNumber=ethernetPriorityTableNumber, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, secureModeAlarm=secureModeAlarm, rFUType=rFUType, ptp=ptp, sNTPServerTableIndex=sNTPServerTableIndex, dataPortDisabledWarning=dataPortDisabledWarning, vLANManagementVIDValidation=vLANManagementVIDValidation, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, iPDSCPPriorityTable=iPDSCPPriorityTable, userTableNumber=userTableNumber, rFUVersionBank2=rFUVersionBank2, sMTPServerInternetAddress=sMTPServerInternetAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, securityLevel=securityLevel, wirelessLinkStatusTrap=wirelessLinkStatusTrap, radioLicenseRegion=radioLicenseRegion, cambium=cambium, sNTPServerIPAddress=sNTPServerIPAddress, linkNameMismatchTrap=linkNameMismatchTrap, iFCableLength=iFCableLength, sNTPLastSync=sNTPLastSync, radioLicenseMinModulation=radioLicenseMinModulation)
