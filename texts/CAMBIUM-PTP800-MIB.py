...
TimeTicks, Bits, Gauge32, Counter64, Unsigned32, iso, ObjectIdentity, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, MibIdentifier, IpAddress, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "Gauge32", "Counter64", "Unsigned32", "iso", "ObjectIdentity", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "MibIdentifier", "IpAddress", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rxDiversityVlanTpid=rxDiversityVlanTpid, management=management, sNMPTrapVersion=sNMPTrapVersion, linkNameMismatchTrap=linkNameMismatchTrap, transmitCapacityLimitDetail=transmitCapacityLimitDetail, iPVersion=iPVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, radioLicenseModulation=radioLicenseModulation, userEnabled=userEnabled, receivePower=receivePower, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, ptmp=ptmp, syslogControl=syslogControl, activeAvailableTime=activeAvailableTime, enableTransmission=enableTransmission, faultProtectionSwitching=faultProtectionSwitching, iPv6GatewayAddress=iPv6GatewayAddress, rFFeederLoss=rFFeederLoss, rxDiversityDataPortStatus=rxDiversityDataPortStatus, unitOutOfCalibration=unitOutOfCalibration, ethernetPriorityTable=ethernetPriorityTable, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, remotePrimarySecondaryMode=remotePrimarySecondaryMode, remoteInternetAddress=remoteInternetAddress, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, rFUPlatformCompatibility=rFUPlatformCompatibility, tFTPServerPortNumber=tFTPServerPortNumber, ethernet=ethernet, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, protection=protection, iPv6PrefixLength=iPv6PrefixLength, rFURfBand=rFURfBand, primaryRecoveryPeriod=primaryRecoveryPeriod, sNTPServerTimeout=sNTPServerTimeout, vLANManagementVID=vLANManagementVID, syslogClient=syslogClient, managementPortStatus=managementPortStatus, remoteInternetAddressType=remoteInternetAddressType, protectionAvailabilityStatus=protectionAvailabilityStatus, maxModulation=maxModulation, hTTPAccessEnabled=hTTPAccessEnabled, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, encryption=encryption, rFURFSwitchAlarm=rFURFSwitchAlarm, bootVersion=bootVersion, rFUType=rFUType, rFUConnectedPlatform=rFUConnectedPlatform, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, ptp800=ptp800, remotePrimaryInternetAddress=remotePrimaryInternetAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNMPPortNumber=sNMPPortNumber, sNTPState=sNTPState, rFUPowerButtonPressed=rFUPowerButtonPressed, remoteIPAddress=remoteIPAddress, cambium=cambium, rFUBranchingConfiguration=rFUBranchingConfiguration, remoteSecondaryIPAddress=remoteSecondaryIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerPortNumber=sNTPServerPortNumber, hardwareVersion=hardwareVersion, numberOfAntennas=numberOfAntennas, sMTPServerInternetAddress=sMTPServerInternetAddress, dataPortStatus=dataPortStatus, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, transmitPower=transmitPower, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTable=sNMPTrapTable, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rFUSerial=rFUSerial, sNTPServerTableIndex=sNTPServerTableIndex, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sNTPSyncTrap=sNTPSyncTrap, longitude=longitude, supplementary=supplementary, radioLicenseRxFreq=radioLicenseRxFreq, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, protectionState=protectionState, ptpTrapPrefix=ptpTrapPrefix, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, alarms=alarms, latitude=latitude, managementPortAutoNegotiation=managementPortAutoNegotiation, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, transmitCapacity=transmitCapacity, sNTPPrimaryServer=sNTPPrimaryServer, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, remoteMaximumTransmitPower=remoteMaximumTransmitPower, maxCodeRate=maxCodeRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, neighborMACAddress=neighborMACAddress, configuration=configuration, localPacketFiltering=localPacketFiltering, managementPortDisabledWarning=managementPortDisabledWarning, telnetPortNumber=telnetPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, endId=endId, radioLicenseIdentifier=radioLicenseIdentifier, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, managementPortWirelessDownAlert=managementPortWirelessDownAlert, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rxDiversityVid=rxDiversityVid, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, protectionConfigurationStatus=protectionConfigurationStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, userName=userName, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFUTxPowerAlarm=rFUTxPowerAlarm, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, transmitModulation=transmitModulation, managementCommittedInformationRate=managementCommittedInformationRate, secureModeAlarm=secureModeAlarm, rFUCableAlarm=rFUCableAlarm, sNTPSync=sNTPSync, versions=versions, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, protectionConfig=protectionConfig, sMTPEmailAlert=sMTPEmailAlert, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, userTableEntry=userTableEntry, alignmentMode=alignmentMode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, alignmentModeTrap=alignmentModeTrap, transmitDataRate=transmitDataRate, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, sntp=sntp, aggregateDataRate=aggregateDataRate, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, radioLicenseMinCodeRate=radioLicenseMinCodeRate, telnetAccessEnabled=telnetAccessEnabled, radioLicenseMaxEIRP=radioLicenseMaxEIRP, diverseRfFeederLoss=diverseRfFeederLoss, rFUTxFreqMin=rFUTxFreqMin, radioLicenseTxFreq=radioLicenseTxFreq, encryptionAlgorithm=encryptionAlgorithm, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, reset=reset, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerTable=sNTPServerTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNMPCommunityString=sNMPCommunityString, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, vLANManagementPriority=vLANManagementPriority, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, aAAControl=aAAControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, protectionStatus=protectionStatus, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, softwareVersion=softwareVersion, sMTPServerPortNumber=sMTPServerPortNumber, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, userPassword=userPassword, rFUVersionBank1=rFUVersionBank1, transmitCodeRate=transmitCodeRate, secondarySoftwareVersion=secondarySoftwareVersion, syslogState=syslogState, managementPortForcedConfiguration=managementPortForcedConfiguration, protectionStats=protectionStats, fiberY=fiberY, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sNTPServerRetries=sNTPServerRetries, sNMPTrapTableIndex=sNMPTrapTableIndex, siteName=siteName, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, l2CPPriorityTableNumber=l2CPPriorityTableNumber, systemClock=systemClock, protectionSwitchCause=protectionSwitchCause, pubStats=pubStats, userTableNumber=userTableNumber, radioLicenseMinModulation=radioLicenseMinModulation, rFUProtectionCompatibility=rFUProtectionCompatibility, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerTableNumber=sNTPServerTableNumber, snmpControl=snmpControl, rfu=rfu, primaryRecovery=primaryRecovery, transmitterStatus=transmitterStatus, smtp=smtp, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, ptp=ptp, remotePrimaryMACAddress=remotePrimaryMACAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, hTTPPortNumber=hTTPPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogClientTrap=syslogClientTrap, securityLevel=securityLevel, protectionStateTrap=protectionStateTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPServerIPAddress=sMTPServerIPAddress, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, wirelessLinkStatus=wirelessLinkStatus, sNMPEnabledTraps=sNMPEnabledTraps, syslogStateTrap=syslogStateTrap, radioLicenseBand=radioLicenseBand, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerInternetAddress=sNTPServerInternetAddress, remoteSecondaryMACAddress=remoteSecondaryMACAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFURxFreqMin=rFURxFreqMin, mPLSTCPriorityTable=mPLSTCPriorityTable, antennaGain=antennaGain, sNTPServerResponse=sNTPServerResponse, rFUTxPowerMax=rFUTxPowerMax, dataPortPauseFrames=dataPortPauseFrames, qOSPriorityScheme=qOSPriorityScheme, ptpTraps=ptpTraps, transmitCapacityLimit=transmitCapacityLimit, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, dSCPManagementPriority=dSCPManagementPriority, linkName=linkName, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, l2CPPriorityTable=l2CPPriorityTable, rFUTxPowerMin=rFUTxPowerMin, requestedProtectionState=requestedProtectionState, rFUTxFreqMax=rFUTxFreqMax, phyControl=phyControl, subnetMask=subnetMask, rFUStatus=rFUStatus, rFUTransceiverLocation=rFUTransceiverLocation, dataPortStatusTrap=dataPortStatusTrap, rFULockoutAlarm=rFULockoutAlarm, linkNameMismatch=linkNameMismatch, linkLoss=linkLoss, dataPortFiberStatusTrap=dataPortFiberStatusTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementMode=managementMode, secureModeAlarmTrap=secureModeAlarmTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", iPv6Address=iPv6Address, bridge=bridge, rFUActiveFirmwareBank=rFUActiveFirmwareBank, hTTPSPortNumber=hTTPSPortNumber, userRole=userRole, userTable=userTable, receiveCodeRate=receiveCodeRate, iPv4Address=iPv4Address, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, vectorError=vectorError, neighborInternetAddress=neighborInternetAddress, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, receiveModulation=receiveModulation, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, phyStatus=phyStatus, ethernetFiberSupport=ethernetFiberSupport, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, userTableIndex=userTableIndex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, primarySecondaryMode=primarySecondaryMode, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, maximumTransmitPower=maximumTransmitPower, timeZone=timeZone, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFURxFreqMax=rFURxFreqMax, remotePrimaryIPAddress=remotePrimaryIPAddress, activeWirelessLinkAvailability=activeWirelessLinkAvailability, sNTPServerIPAddress=sNTPServerIPAddress, radioLicense=radioLicense, encryptionEnabledMismatch=encryptionEnabledMismatch, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, vLANManagementVIDValidation=vLANManagementVIDValidation, productName=productName, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPLastSync=sNTPLastSync, neighborInternetAddressType=neighborInternetAddressType, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, dataPortFiberStatus=dataPortFiberStatus, minModulation=minModulation, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rFUFreqSpacing=rFUFreqSpacing, sNMPTrapInternetAddress=sNMPTrapInternetAddress, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, productVariant=productVariant, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, activeUnit=activeUnit, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPPollInterval=sNTPPollInterval, managementPortStatusTrap=managementPortStatusTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, licence=licence, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFUPowerAlarm=rFUPowerAlarm, altitude=altitude, radioLicenseCodeRate=radioLicenseCodeRate, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, sNTPServerTableEntry=sNTPServerTableEntry, tFTPServerIPAddress=tFTPServerIPAddress, daylightSaving=daylightSaving, radioLicenseRegion=radioLicenseRegion, radioLicenseMaxModulation=radioLicenseMaxModulation, sNMPTrapPortNumber=sNMPTrapPortNumber, rFUStatusTrap=rFUStatusTrap, rFURpsAlarm=rFURpsAlarm, minCodeRate=minCodeRate, dataPortDisabledWarning=dataPortDisabledWarning, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, remoteMACAddress=remoteMACAddress, radioLicenseBandwidth=radioLicenseBandwidth, diverseAntennaGain=diverseAntennaGain, rFUVersionBank2=rFUVersionBank2, gatewayIPAddress=gatewayIPAddress, rFUTxBandAboveRx=rFUTxBandAboveRx, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, receiveDataRate=receiveDataRate, iFCableLength=iFCableLength, rFUTxMuteStatus=rFUTxMuteStatus, managementPortConfigurationMismatch=managementPortConfigurationMismatch, neighborIPAddress=neighborIPAddress, systemReset=systemReset, wirelessLinkStatusTrap=wirelessLinkStatusTrap, protectionInterfaceStatus=protectionInterfaceStatus, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, aTPCEnable=aTPCEnable)
