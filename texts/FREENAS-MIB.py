...
iso, NotificationType, Counter32, Bits, ObjectIdentity, ModuleIdentity, IpAddress, Counter64, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, MibIdentifier, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Counter32", "Bits", "ObjectIdentity", "ModuleIdentity", "IpAddress", "Counter64", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "MibIdentifier", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("FREENAS-MIB", zpoolIndex=zpoolIndex, zfsArcCacheMissRatio=zfsArcCacheMissRatio, zvolEntry=zvolEntry, datasetUsed=datasetUsed, zpoolAvailable=zpoolAvailable, zpoolReadBytes1sec=zpoolReadBytes1sec, datasetDescr=datasetDescr, zfsArcP=zfsArcP, zfsZilstatOps10sec=zfsZilstatOps10sec, zvolSize=zvolSize, datasetEntry=datasetEntry, arc=arc, l2arc=l2arc, datasetSize=datasetSize, zpoolWriteOps=zpoolWriteOps, zfsArcMissPercent=zfsArcMissPercent, zvolDescr=zvolDescr, zil=zil, zpoolTable=zpoolTable, zfsArcHits=zfsArcHits, zvol=zvol, datasetTable=datasetTable, alertCancellation=alertCancellation, zpoolUsed=zpoolUsed, zfsL2ArcWrite=zfsL2ArcWrite, zfsL2ArcHits=zfsL2ArcHits, zpoolReadBytes=zpoolReadBytes, zpool=zpool, zfsL2ArcRead=zfsL2ArcRead, alertLevel=alertLevel, PYSNMP_MODULE_ID=freeNas, alert=alert, notificationObjects=notificationObjects, zpoolWriteBytes=zpoolWriteBytes, zpoolWriteBytes1sec=zpoolWriteBytes1sec, zvolIndex=zvolIndex, zvolAllocationUnits=zvolAllocationUnits, datasetAllocationUnits=datasetAllocationUnits, notificationPrefix=notificationPrefix, datasetIndex=datasetIndex, alertId=alertId, datasetAvailable=datasetAvailable, zpoolReadOps1sec=zpoolReadOps1sec, zfsArcMeta=zfsArcMeta, zpoolDescr=zpoolDescr, zvolTable=zvolTable, zfs=zfs, alertMessage=alertMessage, zfsZilstatOps1sec=zfsZilstatOps1sec, zpoolEntry=zpoolEntry, zpoolWriteOps1sec=zpoolWriteOps1sec, zfsArcC=zfsArcC, freeNas=freeNas, zvolUsed=zvolUsed, zfsArcMisses=zfsArcMisses, AlertLevelType=AlertLevelType, zfsArcSize=zfsArcSize, zfsZilstatOps5sec=zfsZilstatOps5sec, notifications=notifications, zfsL2ArcSize=zfsL2ArcSize, dataset=dataset, zfsArcCacheHitRatio=zfsArcCacheHitRatio, zpoolReadOps=zpoolReadOps, zpoolSize=zpoolSize, zfsL2ArcMisses=zfsL2ArcMisses, zpoolAllocationUnits=zpoolAllocationUnits, zvolAvailable=zvolAvailable, ZPoolHealthType=ZPoolHealthType, zpoolHealth=zpoolHealth, zfsArcData=zfsArcData)
