...
MibIdentifier, enterprises, NotificationType, iso, Unsigned32, Counter64, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, Gauge32, TimeTicks, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "enterprises", "NotificationType", "iso", "Unsigned32", "Counter64", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "Gauge32", "TimeTicks", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("FREENAS-MIB", zfsArcMissPercent=zfsArcMissPercent, arc=arc, zpoolUsed=zpoolUsed, zfsArcMeta=zfsArcMeta, datasetIndex=datasetIndex, zvolSize=zvolSize, zvol=zvol, zpoolWriteBytes=zpoolWriteBytes, zfsZilstatOps10sec=zfsZilstatOps10sec, datasetSize=datasetSize, zvolUsed=zvolUsed, zpoolWriteBytes1sec=zpoolWriteBytes1sec, zfsArcC=zfsArcC, zfsArcCacheMissRatio=zfsArcCacheMissRatio, datasetTable=datasetTable, alertCancellation=alertCancellation, zvolTable=zvolTable, zfsArcMisses=zfsArcMisses, zfsZilstatOps1sec=zfsZilstatOps1sec, zvolDescr=zvolDescr, zfsArcHits=zfsArcHits, datasetAllocationUnits=datasetAllocationUnits, datasetAvailable=datasetAvailable, notifications=notifications, zvolIndex=zvolIndex, zpoolEntry=zpoolEntry, zfsArcCacheHitRatio=zfsArcCacheHitRatio, PYSNMP_MODULE_ID=freeNas, zpoolReadBytes1sec=zpoolReadBytes1sec, datasetDescr=datasetDescr, zfsArcData=zfsArcData, zfsL2ArcSize=zfsL2ArcSize, zvolEntry=zvolEntry, alert=alert, zpoolSize=zpoolSize, zpoolWriteOps1sec=zpoolWriteOps1sec, zvolAllocationUnits=zvolAllocationUnits, freeNas=freeNas, zvolAvailable=zvolAvailable, zfsL2ArcRead=zfsL2ArcRead, datasetUsed=datasetUsed, notificationPrefix=notificationPrefix, zpoolAvailable=zpoolAvailable, zil=zil, notificationObjects=notificationObjects, dataset=dataset, zfsL2ArcHits=zfsL2ArcHits, alertId=alertId, zpoolTable=zpoolTable, ZPoolHealthType=ZPoolHealthType, AlertLevelType=AlertLevelType, zpoolIndex=zpoolIndex, zfsZilstatOps5sec=zfsZilstatOps5sec, datasetEntry=datasetEntry, zfsArcP=zfsArcP, alertMessage=alertMessage, zfs=zfs, zpoolReadOps1sec=zpoolReadOps1sec, zpoolWriteOps=zpoolWriteOps, l2arc=l2arc, zpoolReadBytes=zpoolReadBytes, zpoolReadOps=zpoolReadOps, zpool=zpool, zfsL2ArcMisses=zfsL2ArcMisses, zfsL2ArcWrite=zfsL2ArcWrite, alertLevel=alertLevel, zfsArcSize=zfsArcSize, zpoolHealth=zpoolHealth, zpoolAllocationUnits=zpoolAllocationUnits, zpoolDescr=zpoolDescr)
