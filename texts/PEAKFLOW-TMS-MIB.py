...
# ASN.1 source PEAKFLOW-TMS-MIB
# Source digest sha256:d61b7d34720fa1b2affe6128c38ae5a496291001eeab4964517a2eb6cc3eee58
...
if mibBuilder.loadTexts: peakflowTmsMIB.setLastUpdated('2014-03-12 00:00')
...
tmsMitigationTable = MibTable((1, 3, 6, 1, 4, 1, 9694, 1, 5, 5, 2, 3), ).setMaxAccess("notaccessible")
...
tmsMitigationEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9694, 1, 5, 5, 2, 3, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "PEAKFLOW-TMS-MIB", "tmsMitigationIndex"))
...
mibBuilder.exportSymbols("PEAKFLOW-TMS-MIB", PYSNMP_MODULE_ID=peakflowTmsMIB, TmsHundredths=TmsHundredths, TmsPercentage=TmsPercentage, TmsTableIndex=TmsTableIndex, TmsTableIndexOrZero=TmsTableIndexOrZero, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, deviceDiskUsage=deviceDiskUsage, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, deviceSwapSpaceUsage=deviceSwapSpaceUsage, greTunnelDown=greTunnelDown, greTunnelUp=greTunnelUp, hostFault=hostFault, peakflowTmsMIB=peakflowTmsMIB, peakflowTmsMgr=peakflowTmsMgr, peakflowTmsObj=peakflowTmsObj, peakflowTmsTraps=peakflowTmsTraps, peakflowTmsTrapsEnumerate=peakflowTmsTrapsEnumerate, subHostDown=subHostDown, subHostUp=subHostUp, tmsAutomitigationBgpDisabled=tmsAutomitigationBgpDisabled, tmsAutomitigationBgpEnabled=tmsAutomitigationBgpEnabled, tmsAutomitigationBgpSuspended=tmsAutomitigationBgpSuspended, tmsBgpNeighborDown=tmsBgpNeighborDown, tmsBgpNeighborUp=tmsBgpNeighborUp, tmsConfigError=tmsConfigError, tmsConfigMissing=tmsConfigMissing, tmsConfigOk=tmsConfigOk, tmsDestinationPrefix=tmsDestinationPrefix, tmsDestinationPrefixMask=tmsDestinationPrefixMask, tmsDpiConfig=tmsDpiConfig, tmsFilesystemCritical=tmsFilesystemCritical, tmsFilesystemNominal=tmsFilesystemNominal, tmsHostFault=tmsHostFault, tmsHostUpTime=tmsHostUpTime, tmsHwDeviceDown=tmsHwDeviceDown, tmsHwDeviceUp=tmsHwDeviceUp, tmsHwSensorCritical=tmsHwSensorCritical, tmsHwSensorOk=tmsHwSensorOk, tmsHwSensorUnknown=tmsHwSensorUnknown, tmsIpv6BgpNeighborDown=tmsIpv6BgpNeighborDown, tmsIpv6BgpNeighborUp=tmsIpv6BgpNeighborUp, tmsIpv6DestinationPrefix=tmsIpv6DestinationPrefix, tmsIpv6DestinationPrefixMask=tmsIpv6DestinationPrefixMask, tmsIpv6GreTunnelDown=tmsIpv6GreTunnelDown, tmsIpv6GreTunnelUp=tmsIpv6GreTunnelUp, tmsIpv6NexthopDown=tmsIpv6NexthopDown, tmsIpv6NexthopUp=tmsIpv6NexthopUp, tmsLastUpdate=tmsLastUpdate, tmsLinkDown=tmsLinkDown, tmsLinkUp=tmsLinkUp, tmsMitigationConfig=tmsMitigationConfig, tmsMitigationEntry=tmsMitigationEntry, tmsMitigationError=tmsMitigationError, tmsMitigationId=tmsMitigationId, tmsMitigationIndex=tmsMitigationIndex, tmsMitigationLastUpdate=tmsMitigationLastUpdate, tmsMitigationName=tmsMitigationName, tmsMitigationNumber=tmsMitigationNumber, tmsMitigationRunning=tmsMitigationRunning, tmsMitigationSuspended=tmsMitigationSuspended, tmsMitigationTable=tmsMitigationTable, tmsNexthopDown=tmsNexthopDown, tmsNexthopUp=tmsNexthopUp, tmsPerformanceLossy=tmsPerformanceLossy, tmsPerformanceOk=tmsPerformanceOk, tmsSpCommunicationDegraded=tmsSpCommunicationDegraded, tmsSpCommunicationDown=tmsSpCommunicationDown, tmsSpCommunicationUp=tmsSpCommunicationUp, tmsSwComponentDown=tmsSwComponentDown, tmsSwComponentUp=tmsSwComponentUp, tmsSystemPrefixesMissing=tmsSystemPrefixesMissing, tmsSystemPrefixesOk=tmsSystemPrefixesOk, tmsSystemStatusCritical=tmsSystemStatusCritical, tmsSystemStatusDegraded=tmsSystemStatusDegraded, tmsSystemStatusError=tmsSystemStatusError, tmsSystemStatusNominal=tmsSystemStatusNominal, tmsTrapBgpPeer=tmsTrapBgpPeer, tmsTrapComponentName=tmsTrapComponentName, tmsTrapDetail=tmsTrapDetail, tmsTrapGreDestination=tmsTrapGreDestination, tmsTrapGreName=tmsTrapGreName, tmsTrapGreSource=tmsTrapGreSource, tmsTrapIpv6BgpPeer=tmsTrapIpv6BgpPeer, tmsTrapIpv6GreDestination=tmsTrapIpv6GreDestination, tmsTrapIpv6GreSource=tmsTrapIpv6GreSource, tmsTrapIpv6Nexthop=tmsTrapIpv6Nexthop, tmsTrapNexthop=tmsTrapNexthop, tmsTrapString=tmsTrapString, tmsTrapSubhostName=tmsTrapSubhostName, tmsVersion=tmsVersion)
