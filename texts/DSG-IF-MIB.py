...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: dsgIfMIB.setRevisionsDescriptions(('This revision is published as part of the CableLabs DOCSIS\n        Set-top Gateway (DSG) Interface Specification CM-SP-DSG-I12', 'Initial revision, published as part of DOCSIS Set-top\n        Gateway Specification.',))
...
if mibBuilder.loadTexts: dsgIfTunnelDsStatsTable.setDescription('The IF Tunnel Downstream Stats Table contains the packet and\n        byte counters for the tunnel. It also contains the DSID used by\n        the tunnel traffic.')
...
if mibBuilder.loadTexts: dsgIfTunnelDsStatsEntry.setDescription('An entry in the DSG IF Tunnel Downstream Stats Table. An entry\n        in this table exists for each dsgIfTunnelIndex and an ifIndex of\n        docsCableDownstream(128).')
...
if mibBuilder.loadTexts: dsgIfTunnelDsStatsOctets.setDescription('This attribute indicates the count of the number of octets\n        transmitted in this tunnel')
...
if mibBuilder.loadTexts: dsgIfTunnelDsStatsDsid.setDescription('When operating with Multicast DSID Forwarding (MDF) enabled,\n        this object contains the DSID value with which the CMTS labels\n        the DSG Tunnel traffic. If no DSID has been created for this\n        tunnel then this object returns 0. When MDF is disabled this\n        object returns 0. Pre-3.0 DOCSIS devices are not required to\n        instantiate this object.')
