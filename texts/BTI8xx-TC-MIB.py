...
mibBuilder.exportSymbols("BTI8xx-TC-MIB", fruBaseInforevision=fruBaseInforevision, privateManagement=privateManagement, privateManagementConformance=privateManagementConformance, l2cpIndex=l2cpIndex, fruBaseInfoLocation=fruBaseInfoLocation, systemInfo=systemInfo, portIndex=portIndex, fruBaseInfotestedLoc=fruBaseInfotestedLoc, fruBaseInfopackSWVersion=fruBaseInfopackSWVersion, fruBaseInfoPECCode=fruBaseInfoPECCode, configManagement=configManagement, DSCPValue=DSCPValue, PrecedenceValue=PrecedenceValue, uniIndex=uniIndex, fruBaseInfopackName=fruBaseInfopackName, fruBaseInfomanufacturingLoc=fruBaseInfomanufacturingLoc, errorInfoDesc=errorInfoDesc, fruBaseInfoIssuedNumber=fruBaseInfoIssuedNumber, EnableType=EnableType, fruBaseInfotestedDate=fruBaseInfotestedDate, fruBaseInfoserialNumber=fruBaseInfoserialNumber, fruBaseInfoUSI=fruBaseInfoUSI, cosIndex=cosIndex, powerIndex=powerIndex, sessionResponderEntryId=sessionResponderEntryId, mainSystem=mainSystem, errorInfo=errorInfo, fruBaseInfo=fruBaseInfo, privateManagementGroups=privateManagementGroups, sessionIndex=sessionIndex, TcI1588ClkStratum=TcI1588ClkStratum, testSessionFarEndEntryId=testSessionFarEndEntryId, fruBaseInfopackShortName=fruBaseInfopackShortName, faultManagement=faultManagement, fruBaseInfoIndex=fruBaseInfoIndex, TcI1588ClkAccuracy=TcI1588ClkAccuracy, errorInfoCode=errorInfoCode, privateManagementTC=privateManagementTC, bwpDirection=bwpDirection, mpIndex=mpIndex, performanceManagement=performanceManagement, ethopIndex=ethopIndex, PYSNMP_MODULE_ID=privateManagement, CounterClear=CounterClear, fruBaseInfonumberOfMacAddress=fruBaseInfonumberOfMacAddress, TcI1588LogPeriod=TcI1588LogPeriod, fruBaseInfoEntry=fruBaseInfoEntry, PortOp=PortOp, fruBaseInfoTable=fruBaseInfoTable, errorInfoClear=errorInfoClear, fruInfo=fruInfo, RuleAction=RuleAction, ethPortIndex=ethPortIndex, evcIndex=evcIndex, fruBaseInfoCLEI=fruBaseInfoCLEI, fsIndex=fsIndex, fruBaseInfomanufacturingDate=fruBaseInfomanufacturingDate, fruBaseInfobaseMacaddress=fruBaseInfobaseMacaddress, privateManagementCompliances=privateManagementCompliances, bwCfgIndex=bwCfgIndex)
