...
mibBuilder.exportSymbols("UPS-MIB", upsBatteryCurrent=upsBatteryCurrent, upsBasicIdentGroup=upsBasicIdentGroup, upsIdent=upsIdent, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsCompliances=upsCompliances, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBypass=upsBypass, upsConfigLowBattTime=upsConfigLowBattTime, upsBasicCompliance=upsBasicCompliance, upsFullCompliance=upsFullCompliance, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsMIB=upsMIB, upsGroups=upsGroups, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmsPresent=upsAlarmsPresent, upsAlarmOnBypass=upsAlarmOnBypass, upsTestStartTime=upsTestStartTime, upsWellKnownTests=upsWellKnownTests, upsTrapOnBattery=upsTrapOnBattery, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfigOutputVA=upsConfigOutputVA, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmInputBad=upsAlarmInputBad, upsOutput=upsOutput, upsFullInputGroup=upsFullInputGroup, upsBasicInputGroup=upsBasicInputGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmBypassBad=upsAlarmBypassBad, upsObjects=upsObjects, upsAlarmGeneralFault=upsAlarmGeneralFault, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsFullIdentGroup=upsFullIdentGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsBypassNumLines=upsBypassNumLines, upsFullBypassGroup=upsFullBypassGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsOutputVoltage=upsOutputVoltage, upsBypassTable=upsBypassTable, upsTestId=upsTestId, upsConfigAudibleStatus=upsConfigAudibleStatus, upsFullControlGroup=upsFullControlGroup, upsRebootWithDuration=upsRebootWithDuration, upsInputEntry=upsInputEntry, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestResultsSummary=upsTestResultsSummary, upsBasicTestGroup=upsBasicTestGroup, upsBasicGroups=upsBasicGroups, upsIdentModel=upsIdentModel, upsAlarmEntry=upsAlarmEntry, upsControl=upsControl, upsConfig=upsConfig, upsOutputLineIndex=upsOutputLineIndex, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBypassPower=upsBypassPower, upsAlarmId=upsAlarmId, upsOutputCurrent=upsOutputCurrent, upsFullGroups=upsFullGroups, upsAlarmTempBad=upsAlarmTempBad, upsIdentManufacturer=upsIdentManufacturer, upsAlarmOnBattery=upsAlarmOnBattery, upsConfigOutputVoltage=upsConfigOutputVoltage, upsInputLineIndex=upsInputLineIndex, upsOutputPower=upsOutputPower, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsOutputNumLines=upsOutputNumLines, upsAlarmFanFailure=upsAlarmFanFailure, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBypassVoltage=upsBypassVoltage, upsBasicOutputGroup=upsBasicOutputGroup, upsConfigOutputPower=upsConfigOutputPower, upsIdentAttachedDevices=upsIdentAttachedDevices, upsInputCurrent=upsInputCurrent, upsBypassCurrent=upsBypassCurrent, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBattery=upsBattery, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBatteryStatus=upsBatteryStatus, upsInputNumLines=upsInputNumLines, PositiveInteger=PositiveInteger, upsBypassLineIndex=upsBypassLineIndex, upsSubsetControlGroup=upsSubsetControlGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmChargerFailed=upsAlarmChargerFailed, upsSubsetGroups=upsSubsetGroups, upsInputFrequency=upsInputFrequency, upsAlarmLowBattery=upsAlarmLowBattery, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsConfigInputFreq=upsConfigInputFreq, upsSubsetIdentGroup=upsSubsetIdentGroup, upsShutdownType=upsShutdownType, upsAlarmTable=upsAlarmTable, upsTraps=upsTraps, upsInputLineBads=upsInputLineBads, upsSubsetCompliance=upsSubsetCompliance, upsOutputFrequency=upsOutputFrequency, upsInput=upsInput, upsConfigInputVoltage=upsConfigInputVoltage, upsAutoRestart=upsAutoRestart, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBypassEntry=upsBypassEntry, upsBatteryTemperature=upsBatteryTemperature, upsAlarmTime=upsAlarmTime, upsAlarmOutputOverload=upsAlarmOutputOverload, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTestElapsedTime=upsTestElapsedTime, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConformance=upsConformance, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBatteryVoltage=upsBatteryVoltage, upsFullOutputGroup=upsFullOutputGroup, upsTestSpinLock=upsTestSpinLock, upsOutputTable=upsOutputTable, upsStartupAfterDelay=upsStartupAfterDelay, PYSNMP_MODULE_ID=upsMIB, upsAlarmFuseFailure=upsAlarmFuseFailure, upsFullTestGroup=upsFullTestGroup, upsBasicBypassGroup=upsBasicBypassGroup, NonNegativeInteger=NonNegativeInteger, upsFullConfigGroup=upsFullConfigGroup, upsIdentName=upsIdentName, upsOutputEntry=upsOutputEntry, upsTest=upsTest, upsBasicControlGroup=upsBasicControlGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsInputTable=upsInputTable, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsConfigOutputFreq=upsConfigOutputFreq, upsWellKnownAlarms=upsWellKnownAlarms, upsBasicBatteryGroup=upsBasicBatteryGroup, upsInputVoltage=upsInputVoltage, upsInputTruePower=upsInputTruePower, upsSubsetOutputGroup=upsSubsetOutputGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBypassFrequency=upsBypassFrequency, upsAlarm=upsAlarm, upsAlarmDescr=upsAlarmDescr, upsTrapTestCompleted=upsTrapTestCompleted, upsFullBatteryGroup=upsFullBatteryGroup, upsTestResultsDetail=upsTestResultsDetail, upsOutputSource=upsOutputSource)
