...
# Produced by pysmi-1.1.8 at Tue Aug  9 15:08:35 2022
...
NotificationType, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, Counter32, ObjectIdentity, TimeTicks, MibIdentifier, Gauge32, iso, mib_2, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "Counter32", "ObjectIdentity", "TimeTicks", "MibIdentifier", "Gauge32", "iso", "mib-2", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("UPS-MIB", upsBypassFrequency=upsBypassFrequency, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmsPresent=upsAlarmsPresent, upsSubsetConfigGroup=upsSubsetConfigGroup, upsInputNumLines=upsInputNumLines, upsOutputTable=upsOutputTable, upsSubsetInputGroup=upsSubsetInputGroup, upsTestElapsedTime=upsTestElapsedTime, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmId=upsAlarmId, upsInputVoltage=upsInputVoltage, upsTrapTestCompleted=upsTrapTestCompleted, upsFullOutputGroup=upsFullOutputGroup, upsBasicTestGroup=upsBasicTestGroup, upsBasicControlGroup=upsBasicControlGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTest=upsTest, upsConfigInputFreq=upsConfigInputFreq, upsBypassVoltage=upsBypassVoltage, upsAlarmEntry=upsAlarmEntry, PYSNMP_MODULE_ID=upsMIB, upsBypassTable=upsBypassTable, upsObjects=upsObjects, upsTraps=upsTraps, upsAlarmTestInProgress=upsAlarmTestInProgress, upsIdentManufacturer=upsIdentManufacturer, upsAlarmShutdownPending=upsAlarmShutdownPending, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBasicGroups=upsBasicGroups, upsFullInputGroup=upsFullInputGroup, upsSubsetGroups=upsSubsetGroups, upsOutputCurrent=upsOutputCurrent, upsOutputEntry=upsOutputEntry, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsWellKnownTests=upsWellKnownTests, upsOutputLineIndex=upsOutputLineIndex, upsOutputSource=upsOutputSource, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullBypassGroup=upsFullBypassGroup, upsBatteryCurrent=upsBatteryCurrent, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmInputBad=upsAlarmInputBad, upsBasicIdentGroup=upsBasicIdentGroup, upsInputCurrent=upsInputCurrent, upsAlarmTime=upsAlarmTime, upsAlarmDescr=upsAlarmDescr, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsInput=upsInput, upsAlarmOutputBad=upsAlarmOutputBad, upsTestSpinLock=upsTestSpinLock, upsBypassPower=upsBypassPower, upsAlarmTable=upsAlarmTable, upsBasicConfigGroup=upsBasicConfigGroup, upsMIB=upsMIB, upsInputEntry=upsInputEntry, upsInputFrequency=upsInputFrequency, upsShutdownType=upsShutdownType, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmFanFailure=upsAlarmFanFailure, upsBypassNumLines=upsBypassNumLines, upsFullIdentGroup=upsFullIdentGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsOutputPower=upsOutputPower, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsOutputPercentLoad=upsOutputPercentLoad, upsInputTable=upsInputTable, upsOutputFrequency=upsOutputFrequency, upsBasicInputGroup=upsBasicInputGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsConformance=upsConformance, upsBasicBypassGroup=upsBasicBypassGroup, upsInputTruePower=upsInputTruePower, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsFullControlGroup=upsFullControlGroup, upsIdent=upsIdent, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypassLineIndex=upsBypassLineIndex, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTestResultsDetail=upsTestResultsDetail, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTrapOnBattery=upsTrapOnBattery, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsOutputVoltage=upsOutputVoltage, upsBasicCompliance=upsBasicCompliance, upsBasicOutputGroup=upsBasicOutputGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmChargerFailed=upsAlarmChargerFailed, upsTestResultsSummary=upsTestResultsSummary, upsSubsetCompliance=upsSubsetCompliance, upsFullBatteryGroup=upsFullBatteryGroup, upsControl=upsControl, upsWellKnownAlarms=upsWellKnownAlarms, upsIdentName=upsIdentName, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsConfigOutputVA=upsConfigOutputVA, upsBypassCurrent=upsBypassCurrent, upsCompliances=upsCompliances, upsAlarmLowBattery=upsAlarmLowBattery, upsOutputNumLines=upsOutputNumLines, upsBatteryStatus=upsBatteryStatus, upsRebootWithDuration=upsRebootWithDuration, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsInputLineIndex=upsInputLineIndex, upsIdentAttachedDevices=upsIdentAttachedDevices, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsConfigInputVoltage=upsConfigInputVoltage, upsFullConfigGroup=upsFullConfigGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsBatteryVoltage=upsBatteryVoltage, upsStartupAfterDelay=upsStartupAfterDelay, NonNegativeInteger=NonNegativeInteger, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsConfigLowBattTime=upsConfigLowBattTime, upsTestId=upsTestId, upsGroups=upsGroups, upsOutput=upsOutput, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmTempBad=upsAlarmTempBad, upsBattery=upsBattery, upsBypass=upsBypass, upsFullCompliance=upsFullCompliance, upsSubsetIdentGroup=upsSubsetIdentGroup, upsConfigOutputPower=upsConfigOutputPower, upsAlarm=upsAlarm, upsBypassEntry=upsBypassEntry, PositiveInteger=PositiveInteger, upsAutoRestart=upsAutoRestart, upsConfigAudibleStatus=upsConfigAudibleStatus, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsConfig=upsConfig, upsAlarmGeneralFault=upsAlarmGeneralFault, upsFullTestGroup=upsFullTestGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBatteryTemperature=upsBatteryTemperature, upsInputLineBads=upsInputLineBads, upsTestStartTime=upsTestStartTime, upsIdentModel=upsIdentModel, upsBasicAlarmGroup=upsBasicAlarmGroup, upsFullGroups=upsFullGroups)
