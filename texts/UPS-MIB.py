...
# Produced by pysmi-1.1.8 at Thu Sep  8 10:11:10 2022
...
NotificationType, MibIdentifier, IpAddress, Unsigned32, ModuleIdentity, mib_2, iso, ObjectIdentity, Integer32, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "IpAddress", "Unsigned32", "ModuleIdentity", "mib-2", "iso", "ObjectIdentity", "Integer32", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmOutputBad=upsAlarmOutputBad, upsAutoRestart=upsAutoRestart, upsFullTestGroup=upsFullTestGroup, upsInputEntry=upsInputEntry, upsBasicOutputGroup=upsBasicOutputGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsFullIdentGroup=upsFullIdentGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsControl=upsControl, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsInputTruePower=upsInputTruePower, upsTrapOnBattery=upsTrapOnBattery, upsFullBypassGroup=upsFullBypassGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsTestResultsDetail=upsTestResultsDetail, PYSNMP_MODULE_ID=upsMIB, upsAlarmEntry=upsAlarmEntry, upsFullConfigGroup=upsFullConfigGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBasicTestGroup=upsBasicTestGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBasicControlGroup=upsBasicControlGroup, upsTestElapsedTime=upsTestElapsedTime, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsMIB=upsMIB, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBypassNumLines=upsBypassNumLines, upsAlarm=upsAlarm, upsAlarmInputBad=upsAlarmInputBad, upsSubsetControlGroup=upsSubsetControlGroup, upsTestResultsSummary=upsTestResultsSummary, upsConfigInputFreq=upsConfigInputFreq, upsAlarmDescr=upsAlarmDescr, upsTestStartTime=upsTestStartTime, upsConfigOutputPower=upsConfigOutputPower, upsTraps=upsTraps, upsInputLineBads=upsInputLineBads, upsTest=upsTest, upsBasicGroups=upsBasicGroups, upsIdentName=upsIdentName, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmLowBattery=upsAlarmLowBattery, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsFullControlGroup=upsFullControlGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsCompliances=upsCompliances, upsBasicInputGroup=upsBasicInputGroup, upsBatteryStatus=upsBatteryStatus, upsAlarmTestInProgress=upsAlarmTestInProgress, upsSubsetInputGroup=upsSubsetInputGroup, upsIdent=upsIdent, upsIdentManufacturer=upsIdentManufacturer, upsSecondsOnBattery=upsSecondsOnBattery, upsInputFrequency=upsInputFrequency, upsConfigLowBattTime=upsConfigLowBattTime, upsOutputPower=upsOutputPower, upsAlarmsPresent=upsAlarmsPresent, upsSubsetCompliance=upsSubsetCompliance, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmTempBad=upsAlarmTempBad, PositiveInteger=PositiveInteger, upsOutputSource=upsOutputSource, upsOutputVoltage=upsOutputVoltage, upsBypassFrequency=upsBypassFrequency, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBypassCurrent=upsBypassCurrent, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmShutdownPending=upsAlarmShutdownPending, upsOutputFrequency=upsOutputFrequency, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsStartupAfterDelay=upsStartupAfterDelay, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigOutputVA=upsConfigOutputVA, upsBypassVoltage=upsBypassVoltage, upsInputLineIndex=upsInputLineIndex, upsBatteryCurrent=upsBatteryCurrent, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsSubsetOutputGroup=upsSubsetOutputGroup, upsInputNumLines=upsInputNumLines, upsConfigOutputVoltage=upsConfigOutputVoltage, upsOutputEntry=upsOutputEntry, upsObjects=upsObjects, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBatteryVoltage=upsBatteryVoltage, upsGroups=upsGroups, upsOutputCurrent=upsOutputCurrent, upsAlarmFanFailure=upsAlarmFanFailure, upsInputTable=upsInputTable, upsAlarmTable=upsAlarmTable, upsConformance=upsConformance, upsAlarmBypassBad=upsAlarmBypassBad, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsOutputLineIndex=upsOutputLineIndex, upsOutputTable=upsOutputTable, upsBypassTable=upsBypassTable, upsFullGroups=upsFullGroups, upsIdentModel=upsIdentModel, upsSubsetGroups=upsSubsetGroups, upsBattery=upsBattery, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmTime=upsAlarmTime, upsAlarmGeneralFault=upsAlarmGeneralFault, upsOutputNumLines=upsOutputNumLines, upsBatteryTemperature=upsBatteryTemperature, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBasicAlarmGroup=upsBasicAlarmGroup, upsWellKnownTests=upsWellKnownTests, upsTrapTestCompleted=upsTrapTestCompleted, NonNegativeInteger=NonNegativeInteger, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsBypassEntry=upsBypassEntry, upsFullAlarmGroup=upsFullAlarmGroup, upsFullOutputGroup=upsFullOutputGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsInputVoltage=upsInputVoltage, upsAlarmOnBypass=upsAlarmOnBypass, upsBypassPower=upsBypassPower, upsConfig=upsConfig, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsShutdownType=upsShutdownType, upsFullInputGroup=upsFullInputGroup, upsTestId=upsTestId, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsOutput=upsOutput, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBypass=upsBypass, upsTestSpinLock=upsTestSpinLock, upsInput=upsInput, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsFullCompliance=upsFullCompliance, upsAlarmId=upsAlarmId, upsRebootWithDuration=upsRebootWithDuration, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBasicCompliance=upsBasicCompliance, upsBypassLineIndex=upsBypassLineIndex, upsInputCurrent=upsInputCurrent)
