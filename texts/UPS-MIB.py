...
# Produced by pysmi-1.1.12 at Wed Jun 26 13:31:30 2024
...
mib_2, TimeTicks, ModuleIdentity, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, iso, Bits, Counter64, IpAddress, Unsigned32, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "TimeTicks", "ModuleIdentity", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "iso", "Bits", "Counter64", "IpAddress", "Unsigned32", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("UPS-MIB", upsBatteryCurrent=upsBatteryCurrent, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBasicBypassGroup=upsBasicBypassGroup, upsBypass=upsBypass, upsOutputVoltage=upsOutputVoltage, upsInputLineBads=upsInputLineBads, upsConfigLowBattTime=upsConfigLowBattTime, upsFullGroups=upsFullGroups, upsAlarm=upsAlarm, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmTestInProgress=upsAlarmTestInProgress, upsIdentAttachedDevices=upsIdentAttachedDevices, upsInputTruePower=upsInputTruePower, upsBatteryVoltage=upsBatteryVoltage, upsOutput=upsOutput, upsFullOutputGroup=upsFullOutputGroup, upsOutputFrequency=upsOutputFrequency, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBypassEntry=upsBypassEntry, upsAlarmBypassBad=upsAlarmBypassBad, upsIdent=upsIdent, upsConfigOutputVA=upsConfigOutputVA, upsConfigInputFreq=upsConfigInputFreq, upsTestStartTime=upsTestStartTime, upsBattery=upsBattery, upsSubsetControlGroup=upsSubsetControlGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsSubsetInputGroup=upsSubsetInputGroup, PositiveInteger=PositiveInteger, upsAlarmDescr=upsAlarmDescr, upsOutputCurrent=upsOutputCurrent, upsOutputPower=upsOutputPower, upsBypassVoltage=upsBypassVoltage, PYSNMP_MODULE_ID=upsMIB, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmFanFailure=upsAlarmFanFailure, upsConfig=upsConfig, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBypassTable=upsBypassTable, upsCompliances=upsCompliances, upsAlarmBatteryBad=upsAlarmBatteryBad, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsInputFrequency=upsInputFrequency, upsOutputSource=upsOutputSource, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsSubsetGroups=upsSubsetGroups, upsSubsetConfigGroup=upsSubsetConfigGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsControl=upsControl, upsFullTestGroup=upsFullTestGroup, upsIdentName=upsIdentName, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsWellKnownAlarms=upsWellKnownAlarms, upsSubsetCompliance=upsSubsetCompliance, upsAlarmEntry=upsAlarmEntry, upsAlarmOnBattery=upsAlarmOnBattery, upsRebootWithDuration=upsRebootWithDuration, upsInputVoltage=upsInputVoltage, upsTraps=upsTraps, upsAlarmsPresent=upsAlarmsPresent, upsConfigOutputPower=upsConfigOutputPower, upsConformance=upsConformance, upsAutoRestart=upsAutoRestart, upsAlarmOnBypass=upsAlarmOnBypass, upsTestResultsDetail=upsTestResultsDetail, upsObjects=upsObjects, upsAlarmInputBad=upsAlarmInputBad, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmLowBattery=upsAlarmLowBattery, upsTest=upsTest, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsInputEntry=upsInputEntry, upsInputNumLines=upsInputNumLines, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBatteryTemperature=upsBatteryTemperature, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypassFrequency=upsBypassFrequency, upsFullBatteryGroup=upsFullBatteryGroup, upsInput=upsInput, upsOutputNumLines=upsOutputNumLines, upsWellKnownTests=upsWellKnownTests, upsTestResultsSummary=upsTestResultsSummary, upsAlarmChargerFailed=upsAlarmChargerFailed, upsInputLineIndex=upsInputLineIndex, upsBasicGroups=upsBasicGroups, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTestId=upsTestId, upsBasicAlarmGroup=upsBasicAlarmGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsBasicTestGroup=upsBasicTestGroup, upsInputCurrent=upsInputCurrent, NonNegativeInteger=NonNegativeInteger, upsBypassNumLines=upsBypassNumLines, upsBasicOutputGroup=upsBasicOutputGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsFullIdentGroup=upsFullIdentGroup, upsBasicCompliance=upsBasicCompliance, upsIdentManufacturer=upsIdentManufacturer, upsFullBypassGroup=upsFullBypassGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmId=upsAlarmId, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsShutdownAfterDelay=upsShutdownAfterDelay, upsShutdownType=upsShutdownType, upsBasicIdentGroup=upsBasicIdentGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBatteryStatus=upsBatteryStatus, upsOutputTable=upsOutputTable, upsBypassCurrent=upsBypassCurrent, upsInputTable=upsInputTable, upsFullControlGroup=upsFullControlGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTrapOnBattery=upsTrapOnBattery, upsBypassPower=upsBypassPower, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBypassLineIndex=upsBypassLineIndex, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTestSpinLock=upsTestSpinLock, upsAlarmTempBad=upsAlarmTempBad, upsIdentModel=upsIdentModel, upsMIB=upsMIB, upsBasicControlGroup=upsBasicControlGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsOutputEntry=upsOutputEntry, upsAlarmTime=upsAlarmTime, upsBasicInputGroup=upsBasicInputGroup, upsGroups=upsGroups, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBasicConfigGroup=upsBasicConfigGroup, upsTestElapsedTime=upsTestElapsedTime, upsConfigOutputFreq=upsConfigOutputFreq, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsFullCompliance=upsFullCompliance, upsFullInputGroup=upsFullInputGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsOutputLineIndex=upsOutputLineIndex, upsAlarmTable=upsAlarmTable, upsFullConfigGroup=upsFullConfigGroup)
