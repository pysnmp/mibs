...
# Produced by pysmi-1.1.12 at Wed May 29 10:51:43 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, mib_2, ModuleIdentity, Bits, Integer32, MibIdentifier, TimeTicks, Gauge32, NotificationType, Counter64, iso, ObjectIdentity, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "mib-2", "ModuleIdentity", "Bits", "Integer32", "MibIdentifier", "TimeTicks", "Gauge32", "NotificationType", "Counter64", "iso", "ObjectIdentity", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmOutputBad=upsAlarmOutputBad, upsBasicAlarmGroup=upsBasicAlarmGroup, PositiveInteger=PositiveInteger, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsInputCurrent=upsInputCurrent, upsOutputTable=upsOutputTable, upsOutput=upsOutput, upsFullCompliance=upsFullCompliance, upsTestId=upsTestId, upsBasicTestGroup=upsBasicTestGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsTestSpinLock=upsTestSpinLock, upsGroups=upsGroups, upsInputFrequency=upsInputFrequency, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBasicCompliance=upsBasicCompliance, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBasicIdentGroup=upsBasicIdentGroup, upsBasicInputGroup=upsBasicInputGroup, upsAlarmDescr=upsAlarmDescr, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, PYSNMP_MODULE_ID=upsMIB, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsSubsetCompliance=upsSubsetCompliance, upsAlarmFuseFailure=upsAlarmFuseFailure, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTestElapsedTime=upsTestElapsedTime, upsBasicBypassGroup=upsBasicBypassGroup, upsSubsetGroups=upsSubsetGroups, upsBattery=upsBattery, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTraps=upsTraps, upsConformance=upsConformance, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullOutputGroup=upsFullOutputGroup, upsRebootWithDuration=upsRebootWithDuration, upsBypassCurrent=upsBypassCurrent, upsIdentModel=upsIdentModel, upsOutputFrequency=upsOutputFrequency, upsAlarmInputBad=upsAlarmInputBad, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBatteryVoltage=upsBatteryVoltage, upsObjects=upsObjects, upsTestResultsDetail=upsTestResultsDetail, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsSubsetInputGroup=upsSubsetInputGroup, upsConfigInputFreq=upsConfigInputFreq, upsAlarmTime=upsAlarmTime, upsInputNumLines=upsInputNumLines, upsInputTruePower=upsInputTruePower, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmId=upsAlarmId, upsConfigOutputPower=upsConfigOutputPower, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmShutdownPending=upsAlarmShutdownPending, upsFullTestGroup=upsFullTestGroup, upsAutoRestart=upsAutoRestart, upsFullBypassGroup=upsFullBypassGroup, upsCompliances=upsCompliances, upsOutputSource=upsOutputSource, upsAlarmOnBypass=upsAlarmOnBypass, upsIdentName=upsIdentName, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmBypassBad=upsAlarmBypassBad, upsOutputPower=upsOutputPower, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsConfigOutputVA=upsConfigOutputVA, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, NonNegativeInteger=NonNegativeInteger, upsOutputEntry=upsOutputEntry, upsBasicControlGroup=upsBasicControlGroup, upsFullIdentGroup=upsFullIdentGroup, upsAlarmTempBad=upsAlarmTempBad, upsBasicGroups=upsBasicGroups, upsInputLineIndex=upsInputLineIndex, upsTrapOnBattery=upsTrapOnBattery, upsAlarmsPresent=upsAlarmsPresent, upsConfigLowBattTime=upsConfigLowBattTime, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsIdent=upsIdent, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsConfigInputVoltage=upsConfigInputVoltage, upsBatteryCurrent=upsBatteryCurrent, upsInputLineBads=upsInputLineBads, upsBasicBatteryGroup=upsBasicBatteryGroup, upsFullInputGroup=upsFullInputGroup, upsBypassFrequency=upsBypassFrequency, upsShutdownType=upsShutdownType, upsConfigOutputVoltage=upsConfigOutputVoltage, upsConfigOutputFreq=upsConfigOutputFreq, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBasicConfigGroup=upsBasicConfigGroup, upsInputVoltage=upsInputVoltage, upsBatteryStatus=upsBatteryStatus, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBatteryTemperature=upsBatteryTemperature, upsFullControlGroup=upsFullControlGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmEntry=upsAlarmEntry, upsBypassTable=upsBypassTable, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsWellKnownTests=upsWellKnownTests, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfig=upsConfig, upsTestResultsSummary=upsTestResultsSummary, upsSubsetControlGroup=upsSubsetControlGroup, upsFullGroups=upsFullGroups, upsAlarmTable=upsAlarmTable, upsTestStartTime=upsTestStartTime, upsFullConfigGroup=upsFullConfigGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTest=upsTest, upsOutputNumLines=upsOutputNumLines, upsAlarmFanFailure=upsAlarmFanFailure, upsBypassLineIndex=upsBypassLineIndex, upsControl=upsControl, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsMIB=upsMIB, upsAlarmOnBattery=upsAlarmOnBattery, upsIdentManufacturer=upsIdentManufacturer, upsBypassPower=upsBypassPower, upsInput=upsInput, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsInputTable=upsInputTable, upsOutputVoltage=upsOutputVoltage, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBypassVoltage=upsBypassVoltage, upsOutputCurrent=upsOutputCurrent, upsBypassEntry=upsBypassEntry, upsOutputLineIndex=upsOutputLineIndex, upsInputEntry=upsInputEntry, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsOutputPercentLoad=upsOutputPercentLoad, upsSubsetIdentGroup=upsSubsetIdentGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarm=upsAlarm, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBypass=upsBypass, upsAlarmBatteryBad=upsAlarmBatteryBad, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBypassNumLines=upsBypassNumLines)
