...
mibBuilder.exportSymbols("UPS-MIB", upsBatteryVoltage=upsBatteryVoltage, upsTraps=upsTraps, upsBypass=upsBypass, PYSNMP_MODULE_ID=upsMIB, upsSubsetInputGroup=upsSubsetInputGroup, upsOutputSource=upsOutputSource, upsAlarmId=upsAlarmId, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsFullOutputGroup=upsFullOutputGroup, upsOutputEntry=upsOutputEntry, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutputCurrent=upsOutputCurrent, upsFullConfigGroup=upsFullConfigGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBasicCompliance=upsBasicCompliance, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmEntry=upsAlarmEntry, upsAlarmBypassBad=upsAlarmBypassBad, upsFullTestGroup=upsFullTestGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsOutputPower=upsOutputPower, upsAlarmTime=upsAlarmTime, upsWellKnownTests=upsWellKnownTests, upsConfigInputVoltage=upsConfigInputVoltage, upsBypassNumLines=upsBypassNumLines, upsBatteryCurrent=upsBatteryCurrent, upsTestStartTime=upsTestStartTime, upsConfigOutputVoltage=upsConfigOutputVoltage, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsIdent=upsIdent, upsShutdownAfterDelay=upsShutdownAfterDelay, upsConfigOutputFreq=upsConfigOutputFreq, upsCompliances=upsCompliances, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsIdentModel=upsIdentModel, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsInputLineBads=upsInputLineBads, upsAlarmDescr=upsAlarmDescr, upsBypassEntry=upsBypassEntry, upsAlarmOutputBad=upsAlarmOutputBad, upsBypassLineIndex=upsBypassLineIndex, upsInputNumLines=upsInputNumLines, upsMIB=upsMIB, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsInputTruePower=upsInputTruePower, upsIdentName=upsIdentName, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsOutputNumLines=upsOutputNumLines, upsBatteryTemperature=upsBatteryTemperature, upsTestResultsSummary=upsTestResultsSummary, upsFullBatteryGroup=upsFullBatteryGroup, upsShutdownType=upsShutdownType, upsFullIdentGroup=upsFullIdentGroup, upsFullBypassGroup=upsFullBypassGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsConfig=upsConfig, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBypassCurrent=upsBypassCurrent, upsInputEntry=upsInputEntry, upsFullGroups=upsFullGroups, upsAlarm=upsAlarm, upsAlarmTable=upsAlarmTable, upsConfigOutputVA=upsConfigOutputVA, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTestId=upsTestId, upsConfigInputFreq=upsConfigInputFreq, upsFullControlGroup=upsFullControlGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsGroups=upsGroups, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsTrapOnBattery=upsTrapOnBattery, upsSubsetOutputGroup=upsSubsetOutputGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, NonNegativeInteger=NonNegativeInteger, upsAlarmChargerFailed=upsAlarmChargerFailed, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmsPresent=upsAlarmsPresent, upsOutputVoltage=upsOutputVoltage, upsRebootWithDuration=upsRebootWithDuration, upsSubsetGroups=upsSubsetGroups, upsBypassPower=upsBypassPower, upsAlarmTempBad=upsAlarmTempBad, upsBypassTable=upsBypassTable, upsBypassFrequency=upsBypassFrequency, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBasicAlarmGroup=upsBasicAlarmGroup, upsInput=upsInput, upsBasicTestGroup=upsBasicTestGroup, upsInputVoltage=upsInputVoltage, upsBasicGroups=upsBasicGroups, upsFullCompliance=upsFullCompliance, upsSubsetControlGroup=upsSubsetControlGroup, upsOutputTable=upsOutputTable, upsWellKnownAlarms=upsWellKnownAlarms, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBasicConfigGroup=upsBasicConfigGroup, upsTestElapsedTime=upsTestElapsedTime, upsAlarmOnBattery=upsAlarmOnBattery, PositiveInteger=PositiveInteger, upsInputCurrent=upsInputCurrent, upsFullInputGroup=upsFullInputGroup, upsBattery=upsBattery, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsInputFrequency=upsInputFrequency, upsConfigLowBattTime=upsConfigLowBattTime, upsObjects=upsObjects, upsTrapTestCompleted=upsTrapTestCompleted, upsInputTable=upsInputTable, upsIdentManufacturer=upsIdentManufacturer, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsOutputFrequency=upsOutputFrequency, upsTest=upsTest, upsAlarmInputBad=upsAlarmInputBad, upsBasicInputGroup=upsBasicInputGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutput=upsOutput, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsControl=upsControl, upsInputLineIndex=upsInputLineIndex, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTestResultsDetail=upsTestResultsDetail, upsBypassVoltage=upsBypassVoltage, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBatteryStatus=upsBatteryStatus, upsTestSpinLock=upsTestSpinLock, upsConformance=upsConformance, upsConfigOutputPower=upsConfigOutputPower, upsBasicOutputGroup=upsBasicOutputGroup, upsAutoRestart=upsAutoRestart, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsOutputLineIndex=upsOutputLineIndex, upsBasicControlGroup=upsBasicControlGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsSubsetCompliance=upsSubsetCompliance)
