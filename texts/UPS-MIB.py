...
mibBuilder.exportSymbols("UPS-MIB", upsInputCurrent=upsInputCurrent, upsConfigOutputVA=upsConfigOutputVA, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsOutputFrequency=upsOutputFrequency, upsBypassEntry=upsBypassEntry, upsOutputLineIndex=upsOutputLineIndex, upsAlarmFanFailure=upsAlarmFanFailure, upsShutdownType=upsShutdownType, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsOutputSource=upsOutputSource, upsFullBatteryGroup=upsFullBatteryGroup, upsOutputEntry=upsOutputEntry, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBypass=upsBypass, upsBasicTestGroup=upsBasicTestGroup, upsWellKnownTests=upsWellKnownTests, upsBypassLineIndex=upsBypassLineIndex, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsShutdownAfterDelay=upsShutdownAfterDelay, upsIdent=upsIdent, upsBasicGroups=upsBasicGroups, upsIdentManufacturer=upsIdentManufacturer, upsFullConfigGroup=upsFullConfigGroup, upsSubsetCompliance=upsSubsetCompliance, upsGroups=upsGroups, upsBasicControlGroup=upsBasicControlGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsOutputNumLines=upsOutputNumLines, upsAlarmOutputBad=upsAlarmOutputBad, upsFullIdentGroup=upsFullIdentGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsFullCompliance=upsFullCompliance, upsInputNumLines=upsInputNumLines, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmEntry=upsAlarmEntry, upsInputLineIndex=upsInputLineIndex, upsCompliances=upsCompliances, upsTestId=upsTestId, upsOutputPercentLoad=upsOutputPercentLoad, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBypassVoltage=upsBypassVoltage, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsSubsetGroups=upsSubsetGroups, upsBasicBatteryGroup=upsBasicBatteryGroup, upsFullControlGroup=upsFullControlGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsConfigOutputPower=upsConfigOutputPower, upsSubsetInputGroup=upsSubsetInputGroup, upsInputVoltage=upsInputVoltage, upsInput=upsInput, upsBasicConfigGroup=upsBasicConfigGroup, upsOutputPower=upsOutputPower, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmOnBattery=upsAlarmOnBattery, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmShutdownPending=upsAlarmShutdownPending, NonNegativeInteger=NonNegativeInteger, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBasicCompliance=upsBasicCompliance, upsBatteryStatus=upsBatteryStatus, upsBypassNumLines=upsBypassNumLines, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsOutputVoltage=upsOutputVoltage, upsAlarmInputBad=upsAlarmInputBad, upsConfigInputFreq=upsConfigInputFreq, upsFullTestGroup=upsFullTestGroup, upsTestResultsDetail=upsTestResultsDetail, upsInputFrequency=upsInputFrequency, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBatteryVoltage=upsBatteryVoltage, upsBasicIdentGroup=upsBasicIdentGroup, upsBasicInputGroup=upsBasicInputGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarm=upsAlarm, upsInputTruePower=upsInputTruePower, upsConfigOutputFreq=upsConfigOutputFreq, upsAutoRestart=upsAutoRestart, upsInputEntry=upsInputEntry, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTest=upsTest, upsTestResultsSummary=upsTestResultsSummary, PYSNMP_MODULE_ID=upsMIB, upsAlarmTempBad=upsAlarmTempBad, upsAlarmBypassBad=upsAlarmBypassBad, upsFullBypassGroup=upsFullBypassGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBypassFrequency=upsBypassFrequency, upsBypassCurrent=upsBypassCurrent, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsObjects=upsObjects, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmTable=upsAlarmTable, upsAlarmOutputOverload=upsAlarmOutputOverload, upsFullGroups=upsFullGroups, upsSubsetIdentGroup=upsSubsetIdentGroup, upsConformance=upsConformance, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmOnBypass=upsAlarmOnBypass, upsBatteryCurrent=upsBatteryCurrent, upsControl=upsControl, upsRebootWithDuration=upsRebootWithDuration, PositiveInteger=PositiveInteger, upsOutputCurrent=upsOutputCurrent, upsOutput=upsOutput, upsInputLineBads=upsInputLineBads, upsStartupAfterDelay=upsStartupAfterDelay, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmDescr=upsAlarmDescr, upsTestElapsedTime=upsTestElapsedTime, upsIdentName=upsIdentName, upsConfigInputVoltage=upsConfigInputVoltage, upsBattery=upsBattery, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsSubsetOutputGroup=upsSubsetOutputGroup, upsOutputTable=upsOutputTable, upsAlarmTime=upsAlarmTime, upsTestSpinLock=upsTestSpinLock, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTrapOnBattery=upsTrapOnBattery, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsFullInputGroup=upsFullInputGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsBypassPower=upsBypassPower, upsAlarmsPresent=upsAlarmsPresent, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsConfigAudibleStatus=upsConfigAudibleStatus, upsInputTable=upsInputTable, upsConfig=upsConfig, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmId=upsAlarmId, upsBypassTable=upsBypassTable, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsFullOutputGroup=upsFullOutputGroup, upsIdentModel=upsIdentModel, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTestStartTime=upsTestStartTime, upsTraps=upsTraps, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBatteryTemperature=upsBatteryTemperature, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsMIB=upsMIB)
