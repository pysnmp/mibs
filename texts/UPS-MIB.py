...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmFuseFailure=upsAlarmFuseFailure, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmOnBattery=upsAlarmOnBattery, upsBattery=upsBattery, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBasicTestGroup=upsBasicTestGroup, upsInputEntry=upsInputEntry, upsInputLineBads=upsInputLineBads, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullBypassGroup=upsFullBypassGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsOutputLineIndex=upsOutputLineIndex, upsBypassEntry=upsBypassEntry, upsSubsetGroups=upsSubsetGroups, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmFanFailure=upsAlarmFanFailure, upsFullOutputGroup=upsFullOutputGroup, upsTestSpinLock=upsTestSpinLock, upsConfigOutputPower=upsConfigOutputPower, upsBasicBypassGroup=upsBasicBypassGroup, upsOutputEntry=upsOutputEntry, upsInput=upsInput, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsFullConfigGroup=upsFullConfigGroup, upsOutputVoltage=upsOutputVoltage, upsOutputFrequency=upsOutputFrequency, upsOutputSource=upsOutputSource, upsIdentName=upsIdentName, upsTest=upsTest, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAutoRestart=upsAutoRestart, upsAlarmTable=upsAlarmTable, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsInputTable=upsInputTable, upsInputFrequency=upsInputFrequency, upsInputVoltage=upsInputVoltage, upsAlarmEntry=upsAlarmEntry, upsBypassNumLines=upsBypassNumLines, upsRebootWithDuration=upsRebootWithDuration, upsInputCurrent=upsInputCurrent, upsIdentModel=upsIdentModel, upsFullControlGroup=upsFullControlGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsFullAlarmGroup=upsFullAlarmGroup, upsTraps=upsTraps, upsOutputNumLines=upsOutputNumLines, upsSubsetControlGroup=upsSubsetControlGroup, upsBypassTable=upsBypassTable, upsAlarmDescr=upsAlarmDescr, upsTestStartTime=upsTestStartTime, PYSNMP_MODULE_ID=upsMIB, upsIdentManufacturer=upsIdentManufacturer, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsBypassVoltage=upsBypassVoltage, upsTestId=upsTestId, upsOutputTable=upsOutputTable, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBypassFrequency=upsBypassFrequency, upsConfigLowBattTime=upsConfigLowBattTime, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmInputBad=upsAlarmInputBad, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmTempBad=upsAlarmTempBad, upsAlarmGeneralFault=upsAlarmGeneralFault, upsShutdownAfterDelay=upsShutdownAfterDelay, upsTrapTestCompleted=upsTrapTestCompleted, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigOutputVA=upsConfigOutputVA, upsGroups=upsGroups, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarm=upsAlarm, upsAlarmsPresent=upsAlarmsPresent, upsObjects=upsObjects, upsFullGroups=upsFullGroups, upsFullIdentGroup=upsFullIdentGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBypassCurrent=upsBypassCurrent, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTestResultsDetail=upsTestResultsDetail, upsAlarmShutdownPending=upsAlarmShutdownPending, upsIdent=upsIdent, upsMIB=upsMIB, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConfig=upsConfig, upsAlarmOnBypass=upsAlarmOnBypass, upsBypass=upsBypass, upsShutdownType=upsShutdownType, upsTrapOnBattery=upsTrapOnBattery, upsBasicControlGroup=upsBasicControlGroup, upsOutputCurrent=upsOutputCurrent, upsOutput=upsOutput, upsBatteryCurrent=upsBatteryCurrent, upsConfigInputFreq=upsConfigInputFreq, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsOutputPower=upsOutputPower, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, PositiveInteger=PositiveInteger, upsBasicInputGroup=upsBasicInputGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTestElapsedTime=upsTestElapsedTime, upsWellKnownAlarms=upsWellKnownAlarms, upsFullTestGroup=upsFullTestGroup, upsBatteryTemperature=upsBatteryTemperature, upsSubsetCompliance=upsSubsetCompliance, upsBatteryVoltage=upsBatteryVoltage, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmOutputBad=upsAlarmOutputBad, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConformance=upsConformance, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsWellKnownTests=upsWellKnownTests, upsConfigAudibleStatus=upsConfigAudibleStatus, upsSecondsOnBattery=upsSecondsOnBattery, upsBypassLineIndex=upsBypassLineIndex, upsBypassPower=upsBypassPower, upsTestResultsSummary=upsTestResultsSummary, upsFullCompliance=upsFullCompliance, upsAlarmBypassBad=upsAlarmBypassBad, upsCompliances=upsCompliances, upsControl=upsControl, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBatteryStatus=upsBatteryStatus, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBasicGroups=upsBasicGroups, upsInputLineIndex=upsInputLineIndex, upsFullInputGroup=upsFullInputGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmId=upsAlarmId, upsBasicCompliance=upsBasicCompliance, upsBasicIdentGroup=upsBasicIdentGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmTime=upsAlarmTime, upsConfigOutputFreq=upsConfigOutputFreq, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, NonNegativeInteger=NonNegativeInteger, upsInputNumLines=upsInputNumLines, upsInputTruePower=upsInputTruePower)
