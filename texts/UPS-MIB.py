...
ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, Unsigned32, Gauge32, ObjectIdentity, MibIdentifier, iso, Counter64, NotificationType, mib_2, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "Unsigned32", "Gauge32", "ObjectIdentity", "MibIdentifier", "iso", "Counter64", "NotificationType", "mib-2", "Integer32", "IpAddress")
TimeInterval, DisplayString, AutonomousType, TextualConvention, TimeStamp, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "TimeInterval", "DisplayString", "AutonomousType", "TextualConvention", "TimeStamp", "TestAndIncr")
...
mibBuilder.exportSymbols("UPS-MIB", upsOutputTable=upsOutputTable, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsConfigOutputVoltage=upsConfigOutputVoltage, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmTable=upsAlarmTable, upsBatteryCurrent=upsBatteryCurrent, upsBasicOutputGroup=upsBasicOutputGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullBypassGroup=upsFullBypassGroup, upsOutputLineIndex=upsOutputLineIndex, upsBypassNumLines=upsBypassNumLines, upsAlarmFuseFailure=upsAlarmFuseFailure, upsOutputNumLines=upsOutputNumLines, upsSubsetCompliance=upsSubsetCompliance, upsFullConfigGroup=upsFullConfigGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsConfigLowBattTime=upsConfigLowBattTime, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsIdentModel=upsIdentModel, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBypassTable=upsBypassTable, upsBasicTestGroup=upsBasicTestGroup, upsFullOutputGroup=upsFullOutputGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsCompliances=upsCompliances, upsAutoRestart=upsAutoRestart, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmTempBad=upsAlarmTempBad, upsConfig=upsConfig, upsControl=upsControl, upsAlarmEntry=upsAlarmEntry, upsBatteryTemperature=upsBatteryTemperature, upsTrapOnBattery=upsTrapOnBattery, upsAlarmDescr=upsAlarmDescr, upsAlarmId=upsAlarmId, upsInputTable=upsInputTable, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsWellKnownTests=upsWellKnownTests, upsBasicGroups=upsBasicGroups, upsOutputFrequency=upsOutputFrequency, upsBasicCompliance=upsBasicCompliance, upsBasicBatteryGroup=upsBasicBatteryGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarm=upsAlarm, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsConfigOutputVA=upsConfigOutputVA, upsFullBatteryGroup=upsFullBatteryGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmGeneralFault=upsAlarmGeneralFault, PYSNMP_MODULE_ID=upsMIB, PositiveInteger=PositiveInteger, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsOutputVoltage=upsOutputVoltage, upsFullControlGroup=upsFullControlGroup, upsAlarmTime=upsAlarmTime, upsTestElapsedTime=upsTestElapsedTime, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmLowBattery=upsAlarmLowBattery, upsObjects=upsObjects, upsInputLineBads=upsInputLineBads, upsBypassLineIndex=upsBypassLineIndex, upsInputLineIndex=upsInputLineIndex, upsBasicInputGroup=upsBasicInputGroup, upsIdentManufacturer=upsIdentManufacturer, upsTestId=upsTestId, upsConformance=upsConformance, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmBatteryBad=upsAlarmBatteryBad, upsFullInputGroup=upsFullInputGroup, upsRebootWithDuration=upsRebootWithDuration, upsShutdownAfterDelay=upsShutdownAfterDelay, upsFullGroups=upsFullGroups, upsBatteryStatus=upsBatteryStatus, upsConfigInputFreq=upsConfigInputFreq, upsAlarmInputBad=upsAlarmInputBad, upsInputCurrent=upsInputCurrent, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsBatteryVoltage=upsBatteryVoltage, upsInputEntry=upsInputEntry, upsAlarmShutdownImminent=upsAlarmShutdownImminent, NonNegativeInteger=NonNegativeInteger, upsTrapTestCompleted=upsTrapTestCompleted, upsOutputEntry=upsOutputEntry, upsOutputSource=upsOutputSource, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsFullIdentGroup=upsFullIdentGroup, upsInputTruePower=upsInputTruePower, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTestResultsSummary=upsTestResultsSummary, upsTestResultsDetail=upsTestResultsDetail, upsAlarmOutputBad=upsAlarmOutputBad, upsBypassCurrent=upsBypassCurrent, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBypassVoltage=upsBypassVoltage, upsTraps=upsTraps, upsBasicControlGroup=upsBasicControlGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsSecondsOnBattery=upsSecondsOnBattery, upsTestSpinLock=upsTestSpinLock, upsFullTestGroup=upsFullTestGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBypassPower=upsBypassPower, upsInputVoltage=upsInputVoltage, upsOutputPercentLoad=upsOutputPercentLoad, upsOutput=upsOutput, upsIdent=upsIdent, upsBypassFrequency=upsBypassFrequency, upsGroups=upsGroups, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBasicAlarmGroup=upsBasicAlarmGroup, upsInput=upsInput, upsMIB=upsMIB, upsFullAlarmGroup=upsFullAlarmGroup, upsSubsetGroups=upsSubsetGroups, upsOutputPower=upsOutputPower, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBattery=upsBattery, upsSubsetInputGroup=upsSubsetInputGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsFullCompliance=upsFullCompliance, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmsPresent=upsAlarmsPresent, upsStartupAfterDelay=upsStartupAfterDelay, upsBasicBypassGroup=upsBasicBypassGroup, upsInputNumLines=upsInputNumLines, upsShutdownType=upsShutdownType, upsInputFrequency=upsInputFrequency, upsBypass=upsBypass, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsOutputCurrent=upsOutputCurrent, upsBypassEntry=upsBypassEntry, upsAlarmBypassBad=upsAlarmBypassBad, upsConfigOutputPower=upsConfigOutputPower, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBasicIdentGroup=upsBasicIdentGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsIdentName=upsIdentName, upsTest=upsTest, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTestStartTime=upsTestStartTime)
