...
# Produced by pysmi-1.1.8 at Tue Sep 12 06:54:27 2023
...
mibBuilder.exportSymbols("UPS-MIB", upsTestSpinLock=upsTestSpinLock, upsBypass=upsBypass, upsAlarmShutdownPending=upsAlarmShutdownPending, upsInputLineIndex=upsInputLineIndex, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTraps=upsTraps, upsBattery=upsBattery, upsAlarmEntry=upsAlarmEntry, upsInputVoltage=upsInputVoltage, upsAlarmOnBypass=upsAlarmOnBypass, upsBatteryVoltage=upsBatteryVoltage, upsBypassFrequency=upsBypassFrequency, upsFullGroups=upsFullGroups, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsSubsetCompliance=upsSubsetCompliance, upsBatteryCurrent=upsBatteryCurrent, upsAlarmTable=upsAlarmTable, upsFullTestGroup=upsFullTestGroup, upsOutputEntry=upsOutputEntry, upsAlarmDescr=upsAlarmDescr, upsAlarmsPresent=upsAlarmsPresent, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsSubsetControlGroup=upsSubsetControlGroup, upsInputLineBads=upsInputLineBads, upsShutdownAfterDelay=upsShutdownAfterDelay, upsConfigInputVoltage=upsConfigInputVoltage, upsSubsetOutputGroup=upsSubsetOutputGroup, PositiveInteger=PositiveInteger, upsIdentName=upsIdentName, upsBypassNumLines=upsBypassNumLines, upsFullControlGroup=upsFullControlGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsOutputSource=upsOutputSource, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBasicCompliance=upsBasicCompliance, upsOutputLineIndex=upsOutputLineIndex, upsBasicInputGroup=upsBasicInputGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsOutputVoltage=upsOutputVoltage, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConfigInputFreq=upsConfigInputFreq, upsOutputCurrent=upsOutputCurrent, upsAlarmTime=upsAlarmTime, upsFullAlarmGroup=upsFullAlarmGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmId=upsAlarmId, upsBasicOutputGroup=upsBasicOutputGroup, upsBypassEntry=upsBypassEntry, upsWellKnownTests=upsWellKnownTests, upsSubsetInputGroup=upsSubsetInputGroup, upsAutoRestart=upsAutoRestart, upsFullIdentGroup=upsFullIdentGroup, upsAlarmTempBad=upsAlarmTempBad, upsObjects=upsObjects, PYSNMP_MODULE_ID=upsMIB, upsBasicTestGroup=upsBasicTestGroup, upsTestResultsSummary=upsTestResultsSummary, upsConfigOutputVA=upsConfigOutputVA, upsTest=upsTest, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsSecondsOnBattery=upsSecondsOnBattery, upsTestId=upsTestId, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsOutputFrequency=upsOutputFrequency, upsInputTable=upsInputTable, upsOutputNumLines=upsOutputNumLines, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTestElapsedTime=upsTestElapsedTime, upsOutputPower=upsOutputPower, upsInput=upsInput, upsFullInputGroup=upsFullInputGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsInputTruePower=upsInputTruePower, upsFullCompliance=upsFullCompliance, upsInputFrequency=upsInputFrequency, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsInputNumLines=upsInputNumLines, upsBasicAlarmGroup=upsBasicAlarmGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmLowBattery=upsAlarmLowBattery, upsFullBypassGroup=upsFullBypassGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsIdentModel=upsIdentModel, upsOutputTable=upsOutputTable, upsFullConfigGroup=upsFullConfigGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigLowBattTime=upsConfigLowBattTime, upsStartupAfterDelay=upsStartupAfterDelay, upsOutput=upsOutput, upsBasicIdentGroup=upsBasicIdentGroup, upsControl=upsControl, upsInputCurrent=upsInputCurrent, upsCompliances=upsCompliances, upsRebootWithDuration=upsRebootWithDuration, upsBasicGroups=upsBasicGroups, upsInputEntry=upsInputEntry, upsConfigAudibleStatus=upsConfigAudibleStatus, upsSubsetConfigGroup=upsSubsetConfigGroup, upsConfigOutputPower=upsConfigOutputPower, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullOutputGroup=upsFullOutputGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsConformance=upsConformance, upsBatteryStatus=upsBatteryStatus, NonNegativeInteger=NonNegativeInteger, upsGroups=upsGroups, upsTestResultsDetail=upsTestResultsDetail, upsConfigOutputFreq=upsConfigOutputFreq, upsShutdownType=upsShutdownType, upsConfigOutputVoltage=upsConfigOutputVoltage, upsTrapTestCompleted=upsTrapTestCompleted, upsBypassLineIndex=upsBypassLineIndex, upsTrapOnBattery=upsTrapOnBattery, upsBypassVoltage=upsBypassVoltage, upsBasicControlGroup=upsBasicControlGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsMIB=upsMIB, upsAlarmFuseFailure=upsAlarmFuseFailure, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsIdent=upsIdent, upsTestStartTime=upsTestStartTime, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBasicBypassGroup=upsBasicBypassGroup, upsBypassCurrent=upsBypassCurrent, upsIdentManufacturer=upsIdentManufacturer, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsSubsetGroups=upsSubsetGroups, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsOutputPercentLoad=upsOutputPercentLoad, upsBypassTable=upsBypassTable, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBatteryTemperature=upsBatteryTemperature, upsAlarm=upsAlarm, upsConfig=upsConfig, upsBypassPower=upsBypassPower, upsAlarmInputBad=upsAlarmInputBad)
