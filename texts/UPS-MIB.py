...
Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, mib_2, IpAddress, NotificationType, Counter32, Bits, TimeTicks, MibIdentifier, Gauge32, Integer32, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "mib-2", "IpAddress", "NotificationType", "Counter32", "Bits", "TimeTicks", "MibIdentifier", "Gauge32", "Integer32", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("UPS-MIB", upsBypassEntry=upsBypassEntry, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsFullBatteryGroup=upsFullBatteryGroup, upsTest=upsTest, upsSecondsOnBattery=upsSecondsOnBattery, upsTestResultsSummary=upsTestResultsSummary, upsBasicOutputGroup=upsBasicOutputGroup, upsFullControlGroup=upsFullControlGroup, upsAlarmsPresent=upsAlarmsPresent, upsConfigInputVoltage=upsConfigInputVoltage, upsOutput=upsOutput, upsTestId=upsTestId, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBypassLineIndex=upsBypassLineIndex, upsBasicCompliance=upsBasicCompliance, upsTestStartTime=upsTestStartTime, upsGroups=upsGroups, upsBasicGroups=upsBasicGroups, upsBasicInputGroup=upsBasicInputGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsInputVoltage=upsInputVoltage, upsConfig=upsConfig, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, PositiveInteger=PositiveInteger, upsOutputVoltage=upsOutputVoltage, upsAlarmId=upsAlarmId, upsInputFrequency=upsInputFrequency, upsBasicControlGroup=upsBasicControlGroup, upsOutputPower=upsOutputPower, upsConfigOutputVA=upsConfigOutputVA, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBypassPower=upsBypassPower, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBypassCurrent=upsBypassCurrent, upsIdentManufacturer=upsIdentManufacturer, upsAlarmBypassBad=upsAlarmBypassBad, upsInputLineBads=upsInputLineBads, upsOutputSource=upsOutputSource, upsShutdownAfterDelay=upsShutdownAfterDelay, upsControl=upsControl, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmTable=upsAlarmTable, upsBatteryVoltage=upsBatteryVoltage, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsWellKnownTests=upsWellKnownTests, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmShutdownPending=upsAlarmShutdownPending, upsInputEntry=upsInputEntry, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmFanFailure=upsAlarmFanFailure, upsObjects=upsObjects, upsAlarmOutputOverload=upsAlarmOutputOverload, upsFullOutputGroup=upsFullOutputGroup, upsInputTruePower=upsInputTruePower, upsOutputFrequency=upsOutputFrequency, upsAutoRestart=upsAutoRestart, upsBasicAlarmGroup=upsBasicAlarmGroup, NonNegativeInteger=NonNegativeInteger, upsSubsetControlGroup=upsSubsetControlGroup, upsInputCurrent=upsInputCurrent, upsFullInputGroup=upsFullInputGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsShutdownType=upsShutdownType, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBattery=upsBattery, upsOutputNumLines=upsOutputNumLines, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBasicTestGroup=upsBasicTestGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsFullBypassGroup=upsFullBypassGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsConfigOutputPower=upsConfigOutputPower, upsAlarm=upsAlarm, upsConformance=upsConformance, upsFullGroups=upsFullGroups, upsSubsetCompliance=upsSubsetCompliance, upsTestElapsedTime=upsTestElapsedTime, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmOnBattery=upsAlarmOnBattery, upsBasicBypassGroup=upsBasicBypassGroup, upsTestResultsDetail=upsTestResultsDetail, upsOutputCurrent=upsOutputCurrent, upsBypassTable=upsBypassTable, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmTime=upsAlarmTime, upsFullConfigGroup=upsFullConfigGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTrapOnBattery=upsTrapOnBattery, upsIdentName=upsIdentName, upsInputLineIndex=upsInputLineIndex, upsAlarmBatteryBad=upsAlarmBatteryBad, upsConfigOutputFreq=upsConfigOutputFreq, PYSNMP_MODULE_ID=upsMIB, upsFullTestGroup=upsFullTestGroup, upsBypassVoltage=upsBypassVoltage, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBatteryStatus=upsBatteryStatus, upsOutputTable=upsOutputTable, upsAlarmEntry=upsAlarmEntry, upsSubsetIdentGroup=upsSubsetIdentGroup, upsInputTable=upsInputTable, upsOutputLineIndex=upsOutputLineIndex, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmInputBad=upsAlarmInputBad, upsAlarmLowBattery=upsAlarmLowBattery, upsRebootWithDuration=upsRebootWithDuration, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsCompliances=upsCompliances, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBatteryTemperature=upsBatteryTemperature, upsBypassNumLines=upsBypassNumLines, upsMIB=upsMIB, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsFullCompliance=upsFullCompliance, upsInputNumLines=upsInputNumLines, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBatteryCurrent=upsBatteryCurrent, upsBypass=upsBypass, upsSubsetGroups=upsSubsetGroups, upsBypassFrequency=upsBypassFrequency, upsAlarmTempBad=upsAlarmTempBad, upsAlarmDescr=upsAlarmDescr, upsFullAlarmGroup=upsFullAlarmGroup, upsIdent=upsIdent, upsFullIdentGroup=upsFullIdentGroup, upsOutputEntry=upsOutputEntry, upsIdentModel=upsIdentModel, upsConfigInputFreq=upsConfigInputFreq, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsInput=upsInput, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTraps=upsTraps, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestSpinLock=upsTestSpinLock)
