...
mibBuilder.exportSymbols("UPS-MIB", upsOutputEntry=upsOutputEntry, upsAlarmShutdownPending=upsAlarmShutdownPending, upsStartupAfterDelay=upsStartupAfterDelay, upsBatteryStatus=upsBatteryStatus, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBypassPower=upsBypassPower, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsWellKnownTests=upsWellKnownTests, upsIdent=upsIdent, upsInputFrequency=upsInputFrequency, upsConfigOutputPower=upsConfigOutputPower, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmBatteryBad=upsAlarmBatteryBad, upsOutputSource=upsOutputSource, upsBypass=upsBypass, upsAlarmDescr=upsAlarmDescr, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConformance=upsConformance, upsBatteryTemperature=upsBatteryTemperature, upsFullTestGroup=upsFullTestGroup, upsInputEntry=upsInputEntry, upsAlarmTempBad=upsAlarmTempBad, upsBypassEntry=upsBypassEntry, upsBasicOutputGroup=upsBasicOutputGroup, upsBasicCompliance=upsBasicCompliance, upsSubsetInputGroup=upsSubsetInputGroup, PositiveInteger=PositiveInteger, upsInputLineIndex=upsInputLineIndex, upsBasicBatteryGroup=upsBasicBatteryGroup, upsIdentModel=upsIdentModel, upsGroups=upsGroups, upsBattery=upsBattery, upsOutput=upsOutput, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsInputLineBads=upsInputLineBads, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBypassLineIndex=upsBypassLineIndex, upsSubsetIdentGroup=upsSubsetIdentGroup, upsFullInputGroup=upsFullInputGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmsPresent=upsAlarmsPresent, upsBatteryCurrent=upsBatteryCurrent, upsFullIdentGroup=upsFullIdentGroup, upsOutputLineIndex=upsOutputLineIndex, upsAlarmFanFailure=upsAlarmFanFailure, upsOutputTable=upsOutputTable, upsBasicInputGroup=upsBasicInputGroup, upsBasicControlGroup=upsBasicControlGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicAlarmGroup=upsBasicAlarmGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmOnBattery=upsAlarmOnBattery, upsTest=upsTest, upsTestId=upsTestId, upsAlarm=upsAlarm, upsInputVoltage=upsInputVoltage, upsBypassNumLines=upsBypassNumLines, upsInput=upsInput, PYSNMP_MODULE_ID=upsMIB, upsTraps=upsTraps, upsBasicTestGroup=upsBasicTestGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsInputTruePower=upsInputTruePower, upsSubsetGroups=upsSubsetGroups, upsFullOutputGroup=upsFullOutputGroup, upsTestResultsSummary=upsTestResultsSummary, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmGeneralFault=upsAlarmGeneralFault, upsFullAlarmGroup=upsFullAlarmGroup, upsConfigOutputVA=upsConfigOutputVA, upsMIB=upsMIB, upsTestStartTime=upsTestStartTime, upsInputCurrent=upsInputCurrent, upsTestElapsedTime=upsTestElapsedTime, upsConfigInputFreq=upsConfigInputFreq, upsBasicGroups=upsBasicGroups, upsOutputPower=upsOutputPower, upsConfig=upsConfig, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsOutputCurrent=upsOutputCurrent, upsBypassTable=upsBypassTable, upsAlarmInputBad=upsAlarmInputBad, upsIdentName=upsIdentName, upsBasicConfigGroup=upsBasicConfigGroup, upsBypassCurrent=upsBypassCurrent, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsInputNumLines=upsInputNumLines, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsFullCompliance=upsFullCompliance, upsOutputFrequency=upsOutputFrequency, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmLowBattery=upsAlarmLowBattery, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsShutdownAfterDelay=upsShutdownAfterDelay, upsSecondsOnBattery=upsSecondsOnBattery, upsSubsetCompliance=upsSubsetCompliance, upsAutoRestart=upsAutoRestart, upsAlarmChargerFailed=upsAlarmChargerFailed, upsFullConfigGroup=upsFullConfigGroup, upsBypassVoltage=upsBypassVoltage, upsConfigInputVoltage=upsConfigInputVoltage, upsRebootWithDuration=upsRebootWithDuration, upsTestSpinLock=upsTestSpinLock, upsAlarmOnBypass=upsAlarmOnBypass, upsControl=upsControl, upsTrapOnBattery=upsTrapOnBattery, upsObjects=upsObjects, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, NonNegativeInteger=NonNegativeInteger, upsAlarmTime=upsAlarmTime, upsFullGroups=upsFullGroups, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsOutputVoltage=upsOutputVoltage, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmTable=upsAlarmTable, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsInputTable=upsInputTable, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsFullBypassGroup=upsFullBypassGroup, upsAlarmId=upsAlarmId, upsOutputPercentLoad=upsOutputPercentLoad, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsTestResultsDetail=upsTestResultsDetail, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsFullControlGroup=upsFullControlGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmFuseFailure=upsAlarmFuseFailure, upsShutdownType=upsShutdownType, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsOutputNumLines=upsOutputNumLines, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypassFrequency=upsBypassFrequency, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmOutputBad=upsAlarmOutputBad, upsCompliances=upsCompliances, upsIdentManufacturer=upsIdentManufacturer, upsBatteryVoltage=upsBatteryVoltage, upsAlarmEntry=upsAlarmEntry)
