...
mibBuilder.exportSymbols("UPS-MIB", upsIdent=upsIdent, upsAlarmOutputBad=upsAlarmOutputBad, upsTrapOnBattery=upsTrapOnBattery, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmBatteryBad=upsAlarmBatteryBad, upsIdentManufacturer=upsIdentManufacturer, upsAlarm=upsAlarm, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestElapsedTime=upsTestElapsedTime, upsIdentModel=upsIdentModel, upsSubsetOutputGroup=upsSubsetOutputGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsConfigOutputVoltage=upsConfigOutputVoltage, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsOutputTable=upsOutputTable, upsGroups=upsGroups, upsFullBypassGroup=upsFullBypassGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullControlGroup=upsFullControlGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsFullTestGroup=upsFullTestGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmFuseFailure=upsAlarmFuseFailure, upsFullBatteryGroup=upsFullBatteryGroup, upsInputLineBads=upsInputLineBads, upsAlarmId=upsAlarmId, upsBypassVoltage=upsBypassVoltage, upsTest=upsTest, upsFullInputGroup=upsFullInputGroup, upsBypassEntry=upsBypassEntry, upsFullGroups=upsFullGroups, upsConfigOutputFreq=upsConfigOutputFreq, upsBypassFrequency=upsBypassFrequency, upsBasicIdentGroup=upsBasicIdentGroup, PYSNMP_MODULE_ID=upsMIB, upsInputCurrent=upsInputCurrent, upsAlarmTempBad=upsAlarmTempBad, upsSubsetCompliance=upsSubsetCompliance, upsSubsetGroups=upsSubsetGroups, upsBypassLineIndex=upsBypassLineIndex, upsShutdownAfterDelay=upsShutdownAfterDelay, upsOutputCurrent=upsOutputCurrent, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsFullConfigGroup=upsFullConfigGroup, upsOutputLineIndex=upsOutputLineIndex, upsBypassCurrent=upsBypassCurrent, upsBattery=upsBattery, upsTestResultsDetail=upsTestResultsDetail, upsShutdownType=upsShutdownType, upsAlarmsPresent=upsAlarmsPresent, upsBasicGroups=upsBasicGroups, upsIdentName=upsIdentName, upsTrapTestCompleted=upsTrapTestCompleted, upsBatteryVoltage=upsBatteryVoltage, upsAlarmFanFailure=upsAlarmFanFailure, upsObjects=upsObjects, upsConfigInputVoltage=upsConfigInputVoltage, upsOutputEntry=upsOutputEntry, upsOutputPercentLoad=upsOutputPercentLoad, upsWellKnownTests=upsWellKnownTests, upsSubsetIdentGroup=upsSubsetIdentGroup, upsInputNumLines=upsInputNumLines, upsBatteryStatus=upsBatteryStatus, upsFullCompliance=upsFullCompliance, upsAlarmGeneralFault=upsAlarmGeneralFault, upsFullIdentGroup=upsFullIdentGroup, upsConformance=upsConformance, upsAlarmShutdownPending=upsAlarmShutdownPending, upsOutputNumLines=upsOutputNumLines, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmDescr=upsAlarmDescr, upsAlarmOnBattery=upsAlarmOnBattery, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, NonNegativeInteger=NonNegativeInteger, upsSubsetInputGroup=upsSubsetInputGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBasicCompliance=upsBasicCompliance, upsOutputPower=upsOutputPower, upsAlarmInputBad=upsAlarmInputBad, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTestSpinLock=upsTestSpinLock, upsAlarmTime=upsAlarmTime, upsInputEntry=upsInputEntry, upsInputVoltage=upsInputVoltage, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsControl=upsControl, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicBypassGroup=upsBasicBypassGroup, upsCompliances=upsCompliances, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsWellKnownAlarms=upsWellKnownAlarms, upsConfigInputFreq=upsConfigInputFreq, upsConfigLowBattTime=upsConfigLowBattTime, upsBasicTestGroup=upsBasicTestGroup, upsAutoRestart=upsAutoRestart, upsRebootWithDuration=upsRebootWithDuration, upsAlarmEntry=upsAlarmEntry, upsTestStartTime=upsTestStartTime, upsBypass=upsBypass, upsBasicInputGroup=upsBasicInputGroup, upsMIB=upsMIB, upsInputTable=upsInputTable, upsBypassNumLines=upsBypassNumLines, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBypassTable=upsBypassTable, upsBatteryCurrent=upsBatteryCurrent, upsBypassPower=upsBypassPower, upsInputTruePower=upsInputTruePower, upsInputFrequency=upsInputFrequency, upsAlarmTable=upsAlarmTable, upsTestId=upsTestId, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutputSource=upsOutputSource, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTestResultsSummary=upsTestResultsSummary, upsTraps=upsTraps, upsBasicControlGroup=upsBasicControlGroup, upsConfigOutputPower=upsConfigOutputPower, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsOutputVoltage=upsOutputVoltage, upsConfigOutputVA=upsConfigOutputVA, upsBatteryTemperature=upsBatteryTemperature, upsInput=upsInput, upsConfig=upsConfig, upsFullAlarmGroup=upsFullAlarmGroup, upsOutput=upsOutput, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsInputLineIndex=upsInputLineIndex, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullOutputGroup=upsFullOutputGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsIdentAttachedDevices=upsIdentAttachedDevices, upsOutputFrequency=upsOutputFrequency, PositiveInteger=PositiveInteger, upsStartupAfterDelay=upsStartupAfterDelay)
