...
mibBuilder.exportSymbols("UPS-MIB", upsBypassLineIndex=upsBypassLineIndex, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTestElapsedTime=upsTestElapsedTime, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicControlGroup=upsBasicControlGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBasicIdentGroup=upsBasicIdentGroup, upsBypassVoltage=upsBypassVoltage, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBasicGroups=upsBasicGroups, upsTrapTestCompleted=upsTrapTestCompleted, PYSNMP_MODULE_ID=upsMIB, upsAlarmInputBad=upsAlarmInputBad, upsFullOutputGroup=upsFullOutputGroup, upsOutputLineIndex=upsOutputLineIndex, upsOutput=upsOutput, upsInputNumLines=upsInputNumLines, upsOutputPercentLoad=upsOutputPercentLoad, upsBypassPower=upsBypassPower, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsConfigLowBattTime=upsConfigLowBattTime, upsBasicTestGroup=upsBasicTestGroup, upsInputVoltage=upsInputVoltage, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmId=upsAlarmId, upsBasicBatteryGroup=upsBasicBatteryGroup, upsInputFrequency=upsInputFrequency, upsIdentModel=upsIdentModel, upsIdent=upsIdent, upsFullCompliance=upsFullCompliance, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsInputLineIndex=upsInputLineIndex, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmDescr=upsAlarmDescr, upsOutputCurrent=upsOutputCurrent, upsAlarmBypassBad=upsAlarmBypassBad, upsRebootWithDuration=upsRebootWithDuration, upsBypassNumLines=upsBypassNumLines, upsShutdownAfterDelay=upsShutdownAfterDelay, upsFullTestGroup=upsFullTestGroup, upsOutputSource=upsOutputSource, upsShutdownType=upsShutdownType, upsConfigOutputVoltage=upsConfigOutputVoltage, upsTestResultsDetail=upsTestResultsDetail, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsFullBypassGroup=upsFullBypassGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBasicOutputGroup=upsBasicOutputGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullConfigGroup=upsFullConfigGroup, upsTrapOnBattery=upsTrapOnBattery, upsTestResultsSummary=upsTestResultsSummary, upsAlarmTestInProgress=upsAlarmTestInProgress, upsInputLineBads=upsInputLineBads, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmOutputBad=upsAlarmOutputBad, upsObjects=upsObjects, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsSubsetIdentGroup=upsSubsetIdentGroup, upsInputEntry=upsInputEntry, upsBypassEntry=upsBypassEntry, upsConfigInputVoltage=upsConfigInputVoltage, upsBatteryVoltage=upsBatteryVoltage, upsMIB=upsMIB, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmTable=upsAlarmTable, upsSubsetConfigGroup=upsSubsetConfigGroup, upsOutputPower=upsOutputPower, upsControl=upsControl, upsIdentAttachedDevices=upsIdentAttachedDevices, upsOutputEntry=upsOutputEntry, upsGroups=upsGroups, upsBatteryStatus=upsBatteryStatus, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsFullInputGroup=upsFullInputGroup, upsInputTable=upsInputTable, PositiveInteger=PositiveInteger, upsBypassFrequency=upsBypassFrequency, upsOutputTable=upsOutputTable, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmFuseFailure=upsAlarmFuseFailure, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmTime=upsAlarmTime, NonNegativeInteger=NonNegativeInteger, upsFullGroups=upsFullGroups, upsConfigOutputFreq=upsConfigOutputFreq, upsIdentManufacturer=upsIdentManufacturer, upsFullIdentGroup=upsFullIdentGroup, upsBasicCompliance=upsBasicCompliance, upsConfigOutputPower=upsConfigOutputPower, upsWellKnownTests=upsWellKnownTests, upsInputCurrent=upsInputCurrent, upsConfigInputFreq=upsConfigInputFreq, upsSubsetCompliance=upsSubsetCompliance, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsSubsetGroups=upsSubsetGroups, upsCompliances=upsCompliances, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmOnBypass=upsAlarmOnBypass, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutputFrequency=upsOutputFrequency, upsAlarm=upsAlarm, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBypassCurrent=upsBypassCurrent, upsTest=upsTest, upsBypassTable=upsBypassTable, upsAlarmsPresent=upsAlarmsPresent, upsFullControlGroup=upsFullControlGroup, upsConfig=upsConfig, upsAlarmTempBad=upsAlarmTempBad, upsAlarmShutdownPending=upsAlarmShutdownPending, upsInput=upsInput, upsTestSpinLock=upsTestSpinLock, upsConformance=upsConformance, upsFullAlarmGroup=upsFullAlarmGroup, upsBatteryCurrent=upsBatteryCurrent, upsBypass=upsBypass, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAutoRestart=upsAutoRestart, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBasicAlarmGroup=upsBasicAlarmGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsFullBatteryGroup=upsFullBatteryGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsTestId=upsTestId, upsBatteryTemperature=upsBatteryTemperature, upsAlarmEntry=upsAlarmEntry, upsBattery=upsBattery, upsIdentName=upsIdentName, upsAlarmFanFailure=upsAlarmFanFailure, upsConfigOutputVA=upsConfigOutputVA, upsOutputNumLines=upsOutputNumLines, upsInputTruePower=upsInputTruePower, upsTraps=upsTraps, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmLowBattery=upsAlarmLowBattery, upsBasicInputGroup=upsBasicInputGroup, upsTestStartTime=upsTestStartTime, upsBasicBypassGroup=upsBasicBypassGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsWellKnownAlarms=upsWellKnownAlarms, upsOutputVoltage=upsOutputVoltage)
