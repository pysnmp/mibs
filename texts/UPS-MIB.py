...
# Produced by pysmi-1.1.8 at Wed Oct 11 09:59:34 2023
...
iso, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, NotificationType, ModuleIdentity, Integer32, TimeTicks, Counter32, ObjectIdentity, Unsigned32, mib_2, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "NotificationType", "ModuleIdentity", "Integer32", "TimeTicks", "Counter32", "ObjectIdentity", "Unsigned32", "mib-2", "IpAddress")
DisplayString, TimeStamp, AutonomousType, TestAndIncr, TextualConvention, TimeInterval = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "AutonomousType", "TestAndIncr", "TextualConvention", "TimeInterval")
...
mibBuilder.exportSymbols("UPS-MIB", upsInputCurrent=upsInputCurrent, upsOutputFrequency=upsOutputFrequency, upsAlarmLowBattery=upsAlarmLowBattery, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsOutputVoltage=upsOutputVoltage, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBasicGroups=upsBasicGroups, upsBasicBypassGroup=upsBasicBypassGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsStartupAfterDelay=upsStartupAfterDelay, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBatteryTemperature=upsBatteryTemperature, upsIdentModel=upsIdentModel, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutputCurrent=upsOutputCurrent, upsFullInputGroup=upsFullInputGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestResultsSummary=upsTestResultsSummary, upsBatteryVoltage=upsBatteryVoltage, upsFullOutputGroup=upsFullOutputGroup, upsAlarmTempBad=upsAlarmTempBad, upsConfigOutputPower=upsConfigOutputPower, NonNegativeInteger=NonNegativeInteger, upsTest=upsTest, upsShutdownAfterDelay=upsShutdownAfterDelay, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsBasicControlGroup=upsBasicControlGroup, PYSNMP_MODULE_ID=upsMIB, upsIdentManufacturer=upsIdentManufacturer, upsAlarmId=upsAlarmId, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsConfigInputVoltage=upsConfigInputVoltage, upsInputLineBads=upsInputLineBads, upsGroups=upsGroups, upsOutputPower=upsOutputPower, upsTrapOnBattery=upsTrapOnBattery, upsConfig=upsConfig, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsControl=upsControl, upsOutputEntry=upsOutputEntry, upsWellKnownAlarms=upsWellKnownAlarms, upsBasicCompliance=upsBasicCompliance, upsBasicIdentGroup=upsBasicIdentGroup, upsBypassTable=upsBypassTable, upsFullBatteryGroup=upsFullBatteryGroup, upsInputEntry=upsInputEntry, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsCompliances=upsCompliances, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsBasicInputGroup=upsBasicInputGroup, upsIdentName=upsIdentName, upsAlarmInputBad=upsAlarmInputBad, upsFullConfigGroup=upsFullConfigGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsObjects=upsObjects, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBypassFrequency=upsBypassFrequency, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmFanFailure=upsAlarmFanFailure, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, PositiveInteger=PositiveInteger, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsFullCompliance=upsFullCompliance, upsOutput=upsOutput, upsBatteryCurrent=upsBatteryCurrent, upsSecondsOnBattery=upsSecondsOnBattery, upsBypassNumLines=upsBypassNumLines, upsConformance=upsConformance, upsFullIdentGroup=upsFullIdentGroup, upsAlarmsPresent=upsAlarmsPresent, upsAlarmOutputOverload=upsAlarmOutputOverload, upsFullBypassGroup=upsFullBypassGroup, upsBypassEntry=upsBypassEntry, upsConfigOutputFreq=upsConfigOutputFreq, upsOutputNumLines=upsOutputNumLines, upsWellKnownTests=upsWellKnownTests, upsBasicTestGroup=upsBasicTestGroup, upsInputTruePower=upsInputTruePower, upsMIB=upsMIB, upsBypass=upsBypass, upsAlarm=upsAlarm, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBypassLineIndex=upsBypassLineIndex, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestElapsedTime=upsTestElapsedTime, upsBasicAlarmGroup=upsBasicAlarmGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBattery=upsBattery, upsInputFrequency=upsInputFrequency, upsTraps=upsTraps, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsOutputTable=upsOutputTable, upsAlarmTime=upsAlarmTime, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsSubsetOutputGroup=upsSubsetOutputGroup, upsInputLineIndex=upsInputLineIndex, upsOutputPercentLoad=upsOutputPercentLoad, upsShutdownType=upsShutdownType, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsSubsetCompliance=upsSubsetCompliance, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTrapTestCompleted=upsTrapTestCompleted, upsAutoRestart=upsAutoRestart, upsTestSpinLock=upsTestSpinLock, upsTestStartTime=upsTestStartTime, upsAlarmOnBattery=upsAlarmOnBattery, upsTestResultsDetail=upsTestResultsDetail, upsAlarmBypassBad=upsAlarmBypassBad, upsFullTestGroup=upsFullTestGroup, upsSubsetGroups=upsSubsetGroups, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBypassVoltage=upsBypassVoltage, upsBatteryStatus=upsBatteryStatus, upsConfigOutputVA=upsConfigOutputVA, upsConfigAudibleStatus=upsConfigAudibleStatus, upsRebootWithDuration=upsRebootWithDuration, upsAlarmEntry=upsAlarmEntry, upsInputTable=upsInputTable, upsTestId=upsTestId, upsBasicBatteryGroup=upsBasicBatteryGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsInputNumLines=upsInputNumLines, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConfigInputFreq=upsConfigInputFreq, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsInputVoltage=upsInputVoltage, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConfigLowBattTime=upsConfigLowBattTime, upsOutputLineIndex=upsOutputLineIndex, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsInput=upsInput, upsAlarmTable=upsAlarmTable, upsIdent=upsIdent, upsBypassCurrent=upsBypassCurrent, upsOutputSource=upsOutputSource, upsFullControlGroup=upsFullControlGroup, upsAlarmDescr=upsAlarmDescr, upsFullGroups=upsFullGroups, upsBypassPower=upsBypassPower, upsSubsetIdentGroup=upsSubsetIdentGroup)
