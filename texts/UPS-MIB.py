...
Bits, IpAddress, Unsigned32, TimeTicks, MibIdentifier, Counter64, Gauge32, mib_2, ModuleIdentity, Counter32, iso, NotificationType, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "Unsigned32", "TimeTicks", "MibIdentifier", "Counter64", "Gauge32", "mib-2", "ModuleIdentity", "Counter32", "iso", "NotificationType", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmOnBattery=upsAlarmOnBattery, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmDescr=upsAlarmDescr, upsAlarmOnBypass=upsAlarmOnBypass, upsShutdownType=upsShutdownType, upsObjects=upsObjects, upsWellKnownAlarms=upsWellKnownAlarms, upsInputLineIndex=upsInputLineIndex, upsOutputPercentLoad=upsOutputPercentLoad, upsSecondsOnBattery=upsSecondsOnBattery, upsIdentAttachedDevices=upsIdentAttachedDevices, upsFullIdentGroup=upsFullIdentGroup, upsInputVoltage=upsInputVoltage, upsSubsetGroups=upsSubsetGroups, upsFullTestGroup=upsFullTestGroup, upsConfigOutputPower=upsConfigOutputPower, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBypassTable=upsBypassTable, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsFullCompliance=upsFullCompliance, upsBypassVoltage=upsBypassVoltage, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsOutput=upsOutput, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsSubsetCompliance=upsSubsetCompliance, upsTestId=upsTestId, upsAlarmLowBattery=upsAlarmLowBattery, upsFullInputGroup=upsFullInputGroup, upsBatteryTemperature=upsBatteryTemperature, upsBypassLineIndex=upsBypassLineIndex, upsConformance=upsConformance, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmEntry=upsAlarmEntry, upsAutoRestart=upsAutoRestart, upsIdentModel=upsIdentModel, upsGroups=upsGroups, upsBasicOutputGroup=upsBasicOutputGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarm=upsAlarm, upsIdentName=upsIdentName, upsInputCurrent=upsInputCurrent, upsInputEntry=upsInputEntry, upsBatteryVoltage=upsBatteryVoltage, upsInputNumLines=upsInputNumLines, upsOutputNumLines=upsOutputNumLines, upsFullBatteryGroup=upsFullBatteryGroup, upsTraps=upsTraps, upsTestResultsSummary=upsTestResultsSummary, upsTrapTestCompleted=upsTrapTestCompleted, PYSNMP_MODULE_ID=upsMIB, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestElapsedTime=upsTestElapsedTime, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmTable=upsAlarmTable, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsControl=upsControl, upsBattery=upsBattery, upsAlarmOutputBad=upsAlarmOutputBad, upsConfigInputVoltage=upsConfigInputVoltage, upsBypassPower=upsBypassPower, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsConfigInputFreq=upsConfigInputFreq, upsBasicInputGroup=upsBasicInputGroup, upsOutputEntry=upsOutputEntry, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsConfig=upsConfig, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsSubsetControlGroup=upsSubsetControlGroup, upsWellKnownTests=upsWellKnownTests, upsBasicAlarmGroup=upsBasicAlarmGroup, upsInputFrequency=upsInputFrequency, upsAlarmTempBad=upsAlarmTempBad, upsOutputFrequency=upsOutputFrequency, upsBasicBypassGroup=upsBasicBypassGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, NonNegativeInteger=NonNegativeInteger, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullGroups=upsFullGroups, upsSubsetOutputGroup=upsSubsetOutputGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsIdent=upsIdent, upsTestStartTime=upsTestStartTime, upsBatteryCurrent=upsBatteryCurrent, upsBasicControlGroup=upsBasicControlGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsBasicGroups=upsBasicGroups, upsConfigLowBattTime=upsConfigLowBattTime, upsFullControlGroup=upsFullControlGroup, upsAlarmsPresent=upsAlarmsPresent, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsOutputCurrent=upsOutputCurrent, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestResultsDetail=upsTestResultsDetail, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBypass=upsBypass, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsInputTruePower=upsInputTruePower, upsCompliances=upsCompliances, upsFullAlarmGroup=upsFullAlarmGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmInputBad=upsAlarmInputBad, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsOutputSource=upsOutputSource, upsConfigOutputVA=upsConfigOutputVA, upsMIB=upsMIB, upsOutputTable=upsOutputTable, upsFullOutputGroup=upsFullOutputGroup, upsAlarmId=upsAlarmId, upsBasicTestGroup=upsBasicTestGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsInputLineBads=upsInputLineBads, upsBasicCompliance=upsBasicCompliance, upsAlarmTime=upsAlarmTime, upsSubsetInputGroup=upsSubsetInputGroup, upsOutputLineIndex=upsOutputLineIndex, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsIdentManufacturer=upsIdentManufacturer, upsConfigOutputFreq=upsConfigOutputFreq, upsBatteryStatus=upsBatteryStatus, upsInput=upsInput, upsRebootWithDuration=upsRebootWithDuration, upsBypassFrequency=upsBypassFrequency, upsTestSpinLock=upsTestSpinLock, upsTrapOnBattery=upsTrapOnBattery, PositiveInteger=PositiveInteger, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBypassCurrent=upsBypassCurrent, upsInputTable=upsInputTable, upsBypassNumLines=upsBypassNumLines, upsSubsetIdentGroup=upsSubsetIdentGroup, upsFullConfigGroup=upsFullConfigGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmFanFailure=upsAlarmFanFailure, upsFullBypassGroup=upsFullBypassGroup, upsOutputVoltage=upsOutputVoltage, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBypassEntry=upsBypassEntry, upsTest=upsTest, upsOutputPower=upsOutputPower)
