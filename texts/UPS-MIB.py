...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:21:03 2022
...
NotificationType, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Gauge32, mib_2, Integer32, TimeTicks, IpAddress, Bits, ModuleIdentity, Counter64, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Gauge32", "mib-2", "Integer32", "TimeTicks", "IpAddress", "Bits", "ModuleIdentity", "Counter64", "Counter32", "ObjectIdentity")
AutonomousType, TimeInterval, DisplayString, TimeStamp, TestAndIncr, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TimeInterval", "DisplayString", "TimeStamp", "TestAndIncr", "TextualConvention")
...
mibBuilder.exportSymbols("UPS-MIB", upsRebootWithDuration=upsRebootWithDuration, upsAlarmGeneralFault=upsAlarmGeneralFault, upsInputTable=upsInputTable, upsAlarmLowBattery=upsAlarmLowBattery, upsShutdownAfterDelay=upsShutdownAfterDelay, upsInputNumLines=upsInputNumLines, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmInputBad=upsAlarmInputBad, upsCompliances=upsCompliances, upsControl=upsControl, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, PYSNMP_MODULE_ID=upsMIB, upsAlarmTempBad=upsAlarmTempBad, upsConfigOutputVA=upsConfigOutputVA, upsFullControlGroup=upsFullControlGroup, upsOutput=upsOutput, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBatteryVoltage=upsBatteryVoltage, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsConfig=upsConfig, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmOnBypass=upsAlarmOnBypass, upsBasicTestGroup=upsBasicTestGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsConfigOutputPower=upsConfigOutputPower, upsTestResultsDetail=upsTestResultsDetail, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBatteryTemperature=upsBatteryTemperature, upsInputCurrent=upsInputCurrent, upsOutputCurrent=upsOutputCurrent, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmFanFailure=upsAlarmFanFailure, upsBatteryStatus=upsBatteryStatus, upsObjects=upsObjects, upsOutputSource=upsOutputSource, upsAlarmEntry=upsAlarmEntry, upsBasicBypassGroup=upsBasicBypassGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBasicOutputGroup=upsBasicOutputGroup, upsBypassFrequency=upsBypassFrequency, upsFullAlarmGroup=upsFullAlarmGroup, upsInput=upsInput, upsBypassTable=upsBypassTable, upsConfigOutputVoltage=upsConfigOutputVoltage, upsOutputVoltage=upsOutputVoltage, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBypassEntry=upsBypassEntry, upsFullBatteryGroup=upsFullBatteryGroup, upsBypassCurrent=upsBypassCurrent, upsAlarm=upsAlarm, upsAlarmsPresent=upsAlarmsPresent, upsInputLineIndex=upsInputLineIndex, upsTestSpinLock=upsTestSpinLock, upsAlarmBatteryBad=upsAlarmBatteryBad, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBasicInputGroup=upsBasicInputGroup, upsAlarmTable=upsAlarmTable, upsConfigInputFreq=upsConfigInputFreq, upsAlarmChargerFailed=upsAlarmChargerFailed, upsIdent=upsIdent, upsBasicCompliance=upsBasicCompliance, upsBypassLineIndex=upsBypassLineIndex, upsAlarmOutputBad=upsAlarmOutputBad, upsOutputEntry=upsOutputEntry, upsTraps=upsTraps, upsBasicGroups=upsBasicGroups, upsTestStartTime=upsTestStartTime, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsOutputLineIndex=upsOutputLineIndex, upsBypassNumLines=upsBypassNumLines, upsFullCompliance=upsFullCompliance, upsAlarmOnBattery=upsAlarmOnBattery, upsBasicControlGroup=upsBasicControlGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsSubsetOutputGroup=upsSubsetOutputGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsIdentName=upsIdentName, upsAlarmFuseFailure=upsAlarmFuseFailure, upsIdentModel=upsIdentModel, upsOutputNumLines=upsOutputNumLines, upsFullInputGroup=upsFullInputGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, NonNegativeInteger=NonNegativeInteger, upsInputLineBads=upsInputLineBads, upsMIB=upsMIB, upsOutputFrequency=upsOutputFrequency, upsBypass=upsBypass, upsInputEntry=upsInputEntry, upsConfigInputVoltage=upsConfigInputVoltage, upsOutputTable=upsOutputTable, upsFullOutputGroup=upsFullOutputGroup, upsBypassPower=upsBypassPower, upsFullTestGroup=upsFullTestGroup, upsAlarmDescr=upsAlarmDescr, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBatteryCurrent=upsBatteryCurrent, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmId=upsAlarmId, upsBasicConfigGroup=upsBasicConfigGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsInputFrequency=upsInputFrequency, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsIdentManufacturer=upsIdentManufacturer, upsOutputPower=upsOutputPower, upsSubsetControlGroup=upsSubsetControlGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConformance=upsConformance, upsWellKnownTests=upsWellKnownTests, upsFullGroups=upsFullGroups, upsInputTruePower=upsInputTruePower, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsTestElapsedTime=upsTestElapsedTime, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullConfigGroup=upsFullConfigGroup, upsTestResultsSummary=upsTestResultsSummary, upsTest=upsTest, upsAutoRestart=upsAutoRestart, PositiveInteger=PositiveInteger, upsInputVoltage=upsInputVoltage, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsStartupAfterDelay=upsStartupAfterDelay, upsTrapOnBattery=upsTrapOnBattery, upsFullBypassGroup=upsFullBypassGroup, upsSubsetGroups=upsSubsetGroups, upsShutdownType=upsShutdownType, upsTestId=upsTestId, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmTime=upsAlarmTime, upsBypassVoltage=upsBypassVoltage, upsFullIdentGroup=upsFullIdentGroup, upsSubsetCompliance=upsSubsetCompliance, upsBattery=upsBattery, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsWellKnownAlarms=upsWellKnownAlarms, upsGroups=upsGroups)
