...
# Produced by pysmi-1.1.8 at Thu Sep 29 12:10:12 2022
...
Unsigned32, ModuleIdentity, TimeTicks, IpAddress, mib_2, Gauge32, Integer32, iso, NotificationType, Counter32, Bits, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "TimeTicks", "IpAddress", "mib-2", "Gauge32", "Integer32", "iso", "NotificationType", "Counter32", "Bits", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("UPS-MIB", upsBatteryStatus=upsBatteryStatus, upsShutdownType=upsShutdownType, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsSubsetInputGroup=upsSubsetInputGroup, upsFullIdentGroup=upsFullIdentGroup, upsFullOutputGroup=upsFullOutputGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsIdentManufacturer=upsIdentManufacturer, upsBasicOutputGroup=upsBasicOutputGroup, upsObjects=upsObjects, upsAlarmGeneralFault=upsAlarmGeneralFault, upsOutputTable=upsOutputTable, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBypassTable=upsBypassTable, upsShutdownAfterDelay=upsShutdownAfterDelay, upsOutputEntry=upsOutputEntry, upsSubsetGroups=upsSubsetGroups, upsAlarmLowBattery=upsAlarmLowBattery, upsConformance=upsConformance, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsInputTruePower=upsInputTruePower, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmId=upsAlarmId, upsBypassNumLines=upsBypassNumLines, upsInputLineIndex=upsInputLineIndex, upsTestSpinLock=upsTestSpinLock, upsConfigOutputVA=upsConfigOutputVA, upsConfigLowBattTime=upsConfigLowBattTime, upsFullBypassGroup=upsFullBypassGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsOutputFrequency=upsOutputFrequency, upsOutputPower=upsOutputPower, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmEntry=upsAlarmEntry, upsAlarmOutputBad=upsAlarmOutputBad, upsBasicAlarmGroup=upsBasicAlarmGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsGroups=upsGroups, upsTestId=upsTestId, upsAlarmInputBad=upsAlarmInputBad, upsTestElapsedTime=upsTestElapsedTime, upsFullGroups=upsFullGroups, upsTrapOnBattery=upsTrapOnBattery, upsInputFrequency=upsInputFrequency, upsControl=upsControl, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBasicTestGroup=upsBasicTestGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsOutput=upsOutput, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmTempBad=upsAlarmTempBad, upsBasicInputGroup=upsBasicInputGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsInputCurrent=upsInputCurrent, upsBypassFrequency=upsBypassFrequency, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsCompliances=upsCompliances, upsBatteryTemperature=upsBatteryTemperature, upsBattery=upsBattery, upsBasicBatteryGroup=upsBasicBatteryGroup, upsSubsetCompliance=upsSubsetCompliance, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmTable=upsAlarmTable, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsIdentName=upsIdentName, upsSecondsOnBattery=upsSecondsOnBattery, upsBatteryCurrent=upsBatteryCurrent, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsIdentAttachedDevices=upsIdentAttachedDevices, upsStartupAfterDelay=upsStartupAfterDelay, upsFullBatteryGroup=upsFullBatteryGroup, upsOutputNumLines=upsOutputNumLines, upsAlarmChargerFailed=upsAlarmChargerFailed, upsRebootWithDuration=upsRebootWithDuration, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTrapTestCompleted=upsTrapTestCompleted, upsBasicGroups=upsBasicGroups, upsMIB=upsMIB, upsBypassVoltage=upsBypassVoltage, upsSubsetOutputGroup=upsSubsetOutputGroup, upsInput=upsInput, upsInputEntry=upsInputEntry, upsOutputSource=upsOutputSource, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsConfigOutputPower=upsConfigOutputPower, upsAlarmTime=upsAlarmTime, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsOutputLineIndex=upsOutputLineIndex, upsAlarm=upsAlarm, upsTestResultsSummary=upsTestResultsSummary, upsInputVoltage=upsInputVoltage, upsWellKnownAlarms=upsWellKnownAlarms, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsInputTable=upsInputTable, upsInputNumLines=upsInputNumLines, upsAutoRestart=upsAutoRestart, upsBatteryVoltage=upsBatteryVoltage, upsConfig=upsConfig, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBypassCurrent=upsBypassCurrent, upsTestStartTime=upsTestStartTime, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTest=upsTest, upsFullTestGroup=upsFullTestGroup, upsIdentModel=upsIdentModel, NonNegativeInteger=NonNegativeInteger, upsBypass=upsBypass, upsFullCompliance=upsFullCompliance, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsFullInputGroup=upsFullInputGroup, upsAlarmsPresent=upsAlarmsPresent, upsConfigOutputVoltage=upsConfigOutputVoltage, upsOutputCurrent=upsOutputCurrent, upsTestResultsDetail=upsTestResultsDetail, PYSNMP_MODULE_ID=upsMIB, upsBypassPower=upsBypassPower, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsIdent=upsIdent, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullControlGroup=upsFullControlGroup, upsBasicCompliance=upsBasicCompliance, PositiveInteger=PositiveInteger, upsInputLineBads=upsInputLineBads, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsBypassLineIndex=upsBypassLineIndex, upsBasicControlGroup=upsBasicControlGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBypassEntry=upsBypassEntry, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmTestInProgress=upsAlarmTestInProgress, upsOutputVoltage=upsOutputVoltage, upsSubsetControlGroup=upsSubsetControlGroup, upsConfigInputFreq=upsConfigInputFreq, upsAlarmDescr=upsAlarmDescr, upsFullConfigGroup=upsFullConfigGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTraps=upsTraps, upsWellKnownTests=upsWellKnownTests)
