...
mibBuilder.exportSymbols("UPS-MIB", upsInputVoltage=upsInputVoltage, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBasicGroups=upsBasicGroups, upsInputLineBads=upsInputLineBads, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmEntry=upsAlarmEntry, upsBatteryCurrent=upsBatteryCurrent, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsConfigOutputVA=upsConfigOutputVA, upsBypassNumLines=upsBypassNumLines, upsShutdownAfterDelay=upsShutdownAfterDelay, upsConfigInputFreq=upsConfigInputFreq, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmFuseFailure=upsAlarmFuseFailure, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTestResultsSummary=upsTestResultsSummary, upsAlarmId=upsAlarmId, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsShutdownType=upsShutdownType, upsGroups=upsGroups, upsFullBypassGroup=upsFullBypassGroup, upsBattery=upsBattery, upsOutputPower=upsOutputPower, upsBasicControlGroup=upsBasicControlGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBasicAlarmGroup=upsBasicAlarmGroup, upsInputEntry=upsInputEntry, upsBypassVoltage=upsBypassVoltage, upsAlarmsPresent=upsAlarmsPresent, upsOutputVoltage=upsOutputVoltage, upsAlarmDescr=upsAlarmDescr, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBypassPower=upsBypassPower, upsControl=upsControl, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmInputBad=upsAlarmInputBad, upsObjects=upsObjects, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsConfigInputVoltage=upsConfigInputVoltage, upsInputCurrent=upsInputCurrent, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmTestInProgress=upsAlarmTestInProgress, upsOutputFrequency=upsOutputFrequency, upsSubsetInputGroup=upsSubsetInputGroup, upsInputNumLines=upsInputNumLines, upsIdentName=upsIdentName, upsFullOutputGroup=upsFullOutputGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsBasicOutputGroup=upsBasicOutputGroup, upsIdent=upsIdent, upsOutput=upsOutput, upsTest=upsTest, upsFullControlGroup=upsFullControlGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsOutputCurrent=upsOutputCurrent, upsAlarmOnBattery=upsAlarmOnBattery, upsWellKnownTests=upsWellKnownTests, upsOutputLineIndex=upsOutputLineIndex, upsBypassCurrent=upsBypassCurrent, upsBypassFrequency=upsBypassFrequency, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmShutdownPending=upsAlarmShutdownPending, upsIdentManufacturer=upsIdentManufacturer, upsFullTestGroup=upsFullTestGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestSpinLock=upsTestSpinLock, upsAlarmChargerFailed=upsAlarmChargerFailed, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsConfigOutputPower=upsConfigOutputPower, upsConfigOutputVoltage=upsConfigOutputVoltage, upsFullAlarmGroup=upsFullAlarmGroup, upsIdentModel=upsIdentModel, upsBasicBypassGroup=upsBasicBypassGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBypassTable=upsBypassTable, PYSNMP_MODULE_ID=upsMIB, upsBatteryStatus=upsBatteryStatus, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsConfigOutputFreq=upsConfigOutputFreq, upsOutputPercentLoad=upsOutputPercentLoad, upsInputTable=upsInputTable, upsTestElapsedTime=upsTestElapsedTime, upsFullIdentGroup=upsFullIdentGroup, NonNegativeInteger=NonNegativeInteger, upsSubsetCompliance=upsSubsetCompliance, upsBypassLineIndex=upsBypassLineIndex, upsInput=upsInput, upsBasicCompliance=upsBasicCompliance, upsTestResultsDetail=upsTestResultsDetail, upsAlarmBatteryBad=upsAlarmBatteryBad, upsWellKnownAlarms=upsWellKnownAlarms, upsFullInputGroup=upsFullInputGroup, upsOutputEntry=upsOutputEntry, upsBasicInputGroup=upsBasicInputGroup, upsRebootWithDuration=upsRebootWithDuration, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBasicConfigGroup=upsBasicConfigGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBypass=upsBypass, upsBasicTestGroup=upsBasicTestGroup, upsTestId=upsTestId, upsAlarmTempBad=upsAlarmTempBad, PositiveInteger=PositiveInteger, upsFullCompliance=upsFullCompliance, upsAlarmTable=upsAlarmTable, upsSecondsOnBattery=upsSecondsOnBattery, upsTrapTestCompleted=upsTrapTestCompleted, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBatteryVoltage=upsBatteryVoltage, upsSubsetOutputGroup=upsSubsetOutputGroup, upsTrapOnBattery=upsTrapOnBattery, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsFullConfigGroup=upsFullConfigGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsSubsetGroups=upsSubsetGroups, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarm=upsAlarm, upsOutputSource=upsOutputSource, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmFanFailure=upsAlarmFanFailure, upsOutputNumLines=upsOutputNumLines, upsOutputTable=upsOutputTable, upsConfigLowBattTime=upsConfigLowBattTime, upsCompliances=upsCompliances, upsBatteryTemperature=upsBatteryTemperature, upsInputLineIndex=upsInputLineIndex, upsAutoRestart=upsAutoRestart, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsInputFrequency=upsInputFrequency, upsConformance=upsConformance, upsFullGroups=upsFullGroups, upsConfig=upsConfig, upsBypassEntry=upsBypassEntry, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTraps=upsTraps, upsTestStartTime=upsTestStartTime, upsInputTruePower=upsInputTruePower, upsMIB=upsMIB, upsAlarmTime=upsAlarmTime)
