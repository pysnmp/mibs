...
# Produced by pysmi-1.1.8 at Thu Sep 15 09:59:18 2022
...
IpAddress, Gauge32, Counter32, Bits, MibIdentifier, Integer32, mib_2, iso, TimeTicks, Counter64, NotificationType, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "Counter32", "Bits", "MibIdentifier", "Integer32", "mib-2", "iso", "TimeTicks", "Counter64", "NotificationType", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("UPS-MIB", upsBasicConfigGroup=upsBasicConfigGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsInputVoltage=upsInputVoltage, upsOutputNumLines=upsOutputNumLines, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmDescr=upsAlarmDescr, upsWellKnownTests=upsWellKnownTests, upsObjects=upsObjects, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsConfigInputFreq=upsConfigInputFreq, upsOutputEntry=upsOutputEntry, upsGroups=upsGroups, upsAlarmTime=upsAlarmTime, upsBypass=upsBypass, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsFullCompliance=upsFullCompliance, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBasicBypassGroup=upsBasicBypassGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsTestElapsedTime=upsTestElapsedTime, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsSubsetCompliance=upsSubsetCompliance, upsBasicControlGroup=upsBasicControlGroup, upsOutputPower=upsOutputPower, upsBypassCurrent=upsBypassCurrent, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsFullBatteryGroup=upsFullBatteryGroup, upsInputTable=upsInputTable, upsBypassNumLines=upsBypassNumLines, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmChargerFailed=upsAlarmChargerFailed, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmId=upsAlarmId, upsAlarmTestInProgress=upsAlarmTestInProgress, upsSubsetInputGroup=upsSubsetInputGroup, upsTestResultsDetail=upsTestResultsDetail, upsInputNumLines=upsInputNumLines, upsTestStartTime=upsTestStartTime, upsBasicTestGroup=upsBasicTestGroup, upsBypassEntry=upsBypassEntry, upsInputTruePower=upsInputTruePower, upsAlarmLowBattery=upsAlarmLowBattery, upsTrapTestCompleted=upsTrapTestCompleted, upsOutputFrequency=upsOutputFrequency, upsFullGroups=upsFullGroups, upsTrapOnBattery=upsTrapOnBattery, upsAlarmEntry=upsAlarmEntry, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBypassVoltage=upsBypassVoltage, upsBasicIdentGroup=upsBasicIdentGroup, upsIdentManufacturer=upsIdentManufacturer, upsInput=upsInput, upsOutputLineIndex=upsOutputLineIndex, upsFullBypassGroup=upsFullBypassGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsOutputVoltage=upsOutputVoltage, upsOutputTable=upsOutputTable, upsStartupAfterDelay=upsStartupAfterDelay, upsBatteryVoltage=upsBatteryVoltage, upsInputLineBads=upsInputLineBads, upsOutputCurrent=upsOutputCurrent, upsBypassTable=upsBypassTable, upsCompliances=upsCompliances, PYSNMP_MODULE_ID=upsMIB, upsBasicInputGroup=upsBasicInputGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmTempBad=upsAlarmTempBad, upsShutdownAfterDelay=upsShutdownAfterDelay, upsFullOutputGroup=upsFullOutputGroup, upsFullIdentGroup=upsFullIdentGroup, upsOutputSource=upsOutputSource, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsConfigOutputVA=upsConfigOutputVA, upsBasicCompliance=upsBasicCompliance, upsInputEntry=upsInputEntry, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsFullControlGroup=upsFullControlGroup, NonNegativeInteger=NonNegativeInteger, upsIdentAttachedDevices=upsIdentAttachedDevices, upsRebootWithDuration=upsRebootWithDuration, upsSubsetGroups=upsSubsetGroups, upsInputLineIndex=upsInputLineIndex, upsTest=upsTest, upsAlarmInputBad=upsAlarmInputBad, upsConfig=upsConfig, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBasicGroups=upsBasicGroups, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBypassFrequency=upsBypassFrequency, upsAlarmTable=upsAlarmTable, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTestSpinLock=upsTestSpinLock, upsConfigOutputPower=upsConfigOutputPower, upsMIB=upsMIB, upsBatteryCurrent=upsBatteryCurrent, upsBatteryTemperature=upsBatteryTemperature, upsBypassLineIndex=upsBypassLineIndex, upsIdentModel=upsIdentModel, upsAlarmFuseFailure=upsAlarmFuseFailure, upsFullInputGroup=upsFullInputGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestResultsSummary=upsTestResultsSummary, upsAlarmOutputOverload=upsAlarmOutputOverload, PositiveInteger=PositiveInteger, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsConfigInputVoltage=upsConfigInputVoltage, upsConformance=upsConformance, upsFullAlarmGroup=upsFullAlarmGroup, upsInputCurrent=upsInputCurrent, upsOutput=upsOutput, upsSubsetConfigGroup=upsSubsetConfigGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypassPower=upsBypassPower, upsInputFrequency=upsInputFrequency, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmOnBypass=upsAlarmOnBypass, upsBattery=upsBattery, upsWellKnownAlarms=upsWellKnownAlarms, upsIdentName=upsIdentName, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBatteryStatus=upsBatteryStatus, upsAlarmShutdownPending=upsAlarmShutdownPending, upsSubsetControlGroup=upsSubsetControlGroup, upsFullConfigGroup=upsFullConfigGroup, upsFullTestGroup=upsFullTestGroup, upsIdent=upsIdent, upsControl=upsControl, upsAlarmsPresent=upsAlarmsPresent, upsTraps=upsTraps, upsShutdownType=upsShutdownType, upsOutputPercentLoad=upsOutputPercentLoad, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsTestId=upsTestId, upsAutoRestart=upsAutoRestart, upsAlarm=upsAlarm)
