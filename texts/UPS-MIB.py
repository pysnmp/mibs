...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmOutputBad=upsAlarmOutputBad, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmEntry=upsAlarmEntry, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullIdentGroup=upsFullIdentGroup, upsMIB=upsMIB, upsInputCurrent=upsInputCurrent, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmOnBypass=upsAlarmOnBypass, upsWellKnownTests=upsWellKnownTests, upsBasicControlGroup=upsBasicControlGroup, upsBasicInputGroup=upsBasicInputGroup, upsAlarmInputBad=upsAlarmInputBad, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfigOutputPower=upsConfigOutputPower, upsInputVoltage=upsInputVoltage, upsBypassLineIndex=upsBypassLineIndex, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutputPower=upsOutputPower, upsOutputTable=upsOutputTable, upsSubsetGroups=upsSubsetGroups, upsIdentManufacturer=upsIdentManufacturer, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConfigLowBattTime=upsConfigLowBattTime, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsFullInputGroup=upsFullInputGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, NonNegativeInteger=NonNegativeInteger, upsFullCompliance=upsFullCompliance, upsBypassVoltage=upsBypassVoltage, upsObjects=upsObjects, upsBypassTable=upsBypassTable, upsBasicIdentGroup=upsBasicIdentGroup, upsTrapOnBattery=upsTrapOnBattery, upsAlarmsPresent=upsAlarmsPresent, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigInputFreq=upsConfigInputFreq, upsOutputFrequency=upsOutputFrequency, upsBypassFrequency=upsBypassFrequency, upsIdent=upsIdent, upsAlarmBatteryBad=upsAlarmBatteryBad, upsOutputLineIndex=upsOutputLineIndex, upsConfigOutputVoltage=upsConfigOutputVoltage, upsTestResultsSummary=upsTestResultsSummary, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsSubsetInputGroup=upsSubsetInputGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarm=upsAlarm, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTestSpinLock=upsTestSpinLock, upsSubsetControlGroup=upsSubsetControlGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsSubsetConfigGroup=upsSubsetConfigGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestResultsDetail=upsTestResultsDetail, upsOutputSource=upsOutputSource, upsInputFrequency=upsInputFrequency, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTestStartTime=upsTestStartTime, upsCompliances=upsCompliances, upsTestElapsedTime=upsTestElapsedTime, upsBasicTestGroup=upsBasicTestGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsShutdownType=upsShutdownType, upsInputLineBads=upsInputLineBads, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBatteryVoltage=upsBatteryVoltage, upsInputNumLines=upsInputNumLines, upsAlarmDescr=upsAlarmDescr, upsBatteryStatus=upsBatteryStatus, upsAlarmBypassBad=upsAlarmBypassBad, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsFullConfigGroup=upsFullConfigGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullControlGroup=upsFullControlGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsBattery=upsBattery, upsOutputVoltage=upsOutputVoltage, upsAutoRestart=upsAutoRestart, upsOutputEntry=upsOutputEntry, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsOutputCurrent=upsOutputCurrent, upsWellKnownAlarms=upsWellKnownAlarms, upsBasicAlarmGroup=upsBasicAlarmGroup, upsFullOutputGroup=upsFullOutputGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsIdentModel=upsIdentModel, upsAlarmShutdownPending=upsAlarmShutdownPending, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsConformance=upsConformance, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmTime=upsAlarmTime, upsGroups=upsGroups, upsConfigOutputVA=upsConfigOutputVA, upsFullTestGroup=upsFullTestGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsControl=upsControl, upsSubsetIdentGroup=upsSubsetIdentGroup, upsInputEntry=upsInputEntry, upsInputLineIndex=upsInputLineIndex, upsTestId=upsTestId, upsRebootWithDuration=upsRebootWithDuration, upsInputTruePower=upsInputTruePower, upsBatteryTemperature=upsBatteryTemperature, PYSNMP_MODULE_ID=upsMIB, upsAlarmTestInProgress=upsAlarmTestInProgress, upsStartupAfterDelay=upsStartupAfterDelay, upsBasicGroups=upsBasicGroups, upsBasicCompliance=upsBasicCompliance, upsOutput=upsOutput, upsFullBatteryGroup=upsFullBatteryGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBypass=upsBypass, upsAlarmTable=upsAlarmTable, upsTest=upsTest, upsBypassPower=upsBypassPower, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsInputTable=upsInputTable, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBypassNumLines=upsBypassNumLines, upsIdentName=upsIdentName, upsConfig=upsConfig, upsFullBypassGroup=upsFullBypassGroup, upsAlarmId=upsAlarmId, upsBatteryCurrent=upsBatteryCurrent, PositiveInteger=PositiveInteger, upsOutputNumLines=upsOutputNumLines, upsSubsetCompliance=upsSubsetCompliance, upsInput=upsInput, upsOutputPercentLoad=upsOutputPercentLoad, upsBasicConfigGroup=upsBasicConfigGroup, upsFullGroups=upsFullGroups, upsAlarmTempBad=upsAlarmTempBad, upsBypassCurrent=upsBypassCurrent, upsTraps=upsTraps, upsBypassEntry=upsBypassEntry)
