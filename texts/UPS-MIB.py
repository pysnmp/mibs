...
mibBuilder.exportSymbols("UPS-MIB", upsOutputPercentLoad=upsOutputPercentLoad, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfigInputFreq=upsConfigInputFreq, upsConfigOutputPower=upsConfigOutputPower, upsAlarmOnBypass=upsAlarmOnBypass, upsBypassPower=upsBypassPower, upsBasicIdentGroup=upsBasicIdentGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsCompliances=upsCompliances, upsAlarmFanFailure=upsAlarmFanFailure, upsBasicCompliance=upsBasicCompliance, upsIdentManufacturer=upsIdentManufacturer, upsBatteryVoltage=upsBatteryVoltage, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBypassNumLines=upsBypassNumLines, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBatteryStatus=upsBatteryStatus, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBasicGroups=upsBasicGroups, upsInputEntry=upsInputEntry, upsFullIdentGroup=upsFullIdentGroup, upsFullControlGroup=upsFullControlGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAutoRestart=upsAutoRestart, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmBypassBad=upsAlarmBypassBad, upsInputCurrent=upsInputCurrent, upsAlarmShutdownPending=upsAlarmShutdownPending, upsMIB=upsMIB, upsOutputTable=upsOutputTable, upsOutputEntry=upsOutputEntry, upsIdent=upsIdent, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBasicControlGroup=upsBasicControlGroup, upsOutputNumLines=upsOutputNumLines, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsOutputSource=upsOutputSource, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmTempBad=upsAlarmTempBad, upsInputFrequency=upsInputFrequency, upsInputTable=upsInputTable, PositiveInteger=PositiveInteger, upsFullOutputGroup=upsFullOutputGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBypass=upsBypass, upsWellKnownAlarms=upsWellKnownAlarms, upsSubsetOutputGroup=upsSubsetOutputGroup, upsOutput=upsOutput, upsFullInputGroup=upsFullInputGroup, upsBypassLineIndex=upsBypassLineIndex, upsTestSpinLock=upsTestSpinLock, upsOutputCurrent=upsOutputCurrent, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBypassVoltage=upsBypassVoltage, upsBypassFrequency=upsBypassFrequency, upsFullBypassGroup=upsFullBypassGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsShutdownAfterDelay=upsShutdownAfterDelay, upsOutputPower=upsOutputPower, upsBatteryCurrent=upsBatteryCurrent, upsBasicInputGroup=upsBasicInputGroup, upsConfig=upsConfig, upsFullAlarmGroup=upsFullAlarmGroup, upsRebootWithDuration=upsRebootWithDuration, upsControl=upsControl, upsBypassCurrent=upsBypassCurrent, upsAlarmId=upsAlarmId, upsIdentModel=upsIdentModel, upsFullTestGroup=upsFullTestGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmDescr=upsAlarmDescr, upsObjects=upsObjects, upsAlarmTable=upsAlarmTable, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmInputBad=upsAlarmInputBad, upsSubsetInputGroup=upsSubsetInputGroup, NonNegativeInteger=NonNegativeInteger, upsInputVoltage=upsInputVoltage, upsGroups=upsGroups, upsSubsetGroups=upsSubsetGroups, upsConfigOutputVoltage=upsConfigOutputVoltage, upsTrapTestCompleted=upsTrapTestCompleted, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsInputTruePower=upsInputTruePower, upsBasicAlarmGroup=upsBasicAlarmGroup, upsShutdownType=upsShutdownType, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigInputVoltage=upsConfigInputVoltage, upsTraps=upsTraps, upsConformance=upsConformance, upsWellKnownTests=upsWellKnownTests, upsTrapOnBattery=upsTrapOnBattery, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmChargerFailed=upsAlarmChargerFailed, upsOutputLineIndex=upsOutputLineIndex, upsOutputVoltage=upsOutputVoltage, upsInputLineBads=upsInputLineBads, upsFullBatteryGroup=upsFullBatteryGroup, upsBasicTestGroup=upsBasicTestGroup, upsTestResultsSummary=upsTestResultsSummary, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTestStartTime=upsTestStartTime, upsConfigOutputFreq=upsConfigOutputFreq, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsConfigLowBattTime=upsConfigLowBattTime, upsInputLineIndex=upsInputLineIndex, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarm=upsAlarm, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBypassEntry=upsBypassEntry, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullConfigGroup=upsFullConfigGroup, upsTest=upsTest, upsBatteryTemperature=upsBatteryTemperature, upsInputNumLines=upsInputNumLines, upsSubsetControlGroup=upsSubsetControlGroup, PYSNMP_MODULE_ID=upsMIB, upsTestResultsDetail=upsTestResultsDetail, upsBasicOutputGroup=upsBasicOutputGroup, upsOutputFrequency=upsOutputFrequency, upsAlarmEntry=upsAlarmEntry, upsBypassTable=upsBypassTable, upsTestId=upsTestId, upsConfigAudibleStatus=upsConfigAudibleStatus, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsIdentName=upsIdentName, upsAlarmsPresent=upsAlarmsPresent, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmTime=upsAlarmTime, upsBattery=upsBattery, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsFullCompliance=upsFullCompliance, upsBasicConfigGroup=upsBasicConfigGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsSubsetCompliance=upsSubsetCompliance, upsFullGroups=upsFullGroups, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConfigOutputVA=upsConfigOutputVA, upsAlarmOnBattery=upsAlarmOnBattery, upsInput=upsInput, upsTestElapsedTime=upsTestElapsedTime, upsAlarmOutputOverload=upsAlarmOutputOverload)
