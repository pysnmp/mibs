...
mibBuilder.exportSymbols("UPS-MIB", upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsStartupAfterDelay=upsStartupAfterDelay, upsInputEntry=upsInputEntry, upsInputVoltage=upsInputVoltage, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsIdentName=upsIdentName, upsBatteryCurrent=upsBatteryCurrent, upsOutputFrequency=upsOutputFrequency, upsOutputNumLines=upsOutputNumLines, upsOutputCurrent=upsOutputCurrent, upsAlarmsPresent=upsAlarmsPresent, upsAlarmId=upsAlarmId, upsFullConfigGroup=upsFullConfigGroup, upsConfigOutputVA=upsConfigOutputVA, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBasicAlarmGroup=upsBasicAlarmGroup, upsRebootWithDuration=upsRebootWithDuration, upsAlarmDescr=upsAlarmDescr, upsShutdownType=upsShutdownType, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsTestId=upsTestId, upsBattery=upsBattery, upsTestSpinLock=upsTestSpinLock, upsBasicInputGroup=upsBasicInputGroup, upsBatteryVoltage=upsBatteryVoltage, upsBasicCompliance=upsBasicCompliance, upsOutputTable=upsOutputTable, upsFullBatteryGroup=upsFullBatteryGroup, upsFullInputGroup=upsFullInputGroup, upsOutputEntry=upsOutputEntry, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTest=upsTest, upsAlarmLowBattery=upsAlarmLowBattery, upsConfigInputVoltage=upsConfigInputVoltage, upsConformance=upsConformance, upsTrapOnBattery=upsTrapOnBattery, upsIdentModel=upsIdentModel, upsFullBypassGroup=upsFullBypassGroup, upsTestElapsedTime=upsTestElapsedTime, upsBypassCurrent=upsBypassCurrent, upsAlarmGeneralFault=upsAlarmGeneralFault, upsOutputLineIndex=upsOutputLineIndex, upsInputFrequency=upsInputFrequency, upsOutput=upsOutput, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsGroups=upsGroups, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTestStartTime=upsTestStartTime, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBasicIdentGroup=upsBasicIdentGroup, upsControl=upsControl, upsAlarmEntry=upsAlarmEntry, upsBypassFrequency=upsBypassFrequency, upsBatteryStatus=upsBatteryStatus, upsConfigLowBattTime=upsConfigLowBattTime, upsConfigInputFreq=upsConfigInputFreq, upsTestResultsDetail=upsTestResultsDetail, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigOutputPower=upsConfigOutputPower, upsFullOutputGroup=upsFullOutputGroup, upsBypassLineIndex=upsBypassLineIndex, upsBypassNumLines=upsBypassNumLines, upsInputNumLines=upsInputNumLines, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsFullTestGroup=upsFullTestGroup, upsOutputVoltage=upsOutputVoltage, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAutoRestart=upsAutoRestart, NonNegativeInteger=NonNegativeInteger, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsWellKnownAlarms=upsWellKnownAlarms, upsFullControlGroup=upsFullControlGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsSubsetConfigGroup=upsSubsetConfigGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmOnBypass=upsAlarmOnBypass, upsTestResultsSummary=upsTestResultsSummary, upsBasicControlGroup=upsBasicControlGroup, upsBypassVoltage=upsBypassVoltage, upsSubsetInputGroup=upsSubsetInputGroup, upsObjects=upsObjects, upsCompliances=upsCompliances, upsConfig=upsConfig, upsAlarmOnBattery=upsAlarmOnBattery, upsSubsetControlGroup=upsSubsetControlGroup, upsFullGroups=upsFullGroups, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsInputTruePower=upsInputTruePower, upsAlarmChargerFailed=upsAlarmChargerFailed, upsInput=upsInput, upsOutputPercentLoad=upsOutputPercentLoad, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsIdentManufacturer=upsIdentManufacturer, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBypassTable=upsBypassTable, upsBasicTestGroup=upsBasicTestGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsWellKnownTests=upsWellKnownTests, upsTraps=upsTraps, upsFullIdentGroup=upsFullIdentGroup, upsSubsetCompliance=upsSubsetCompliance, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTrapTestCompleted=upsTrapTestCompleted, upsSecondsOnBattery=upsSecondsOnBattery, upsBatteryTemperature=upsBatteryTemperature, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConfigOutputVoltage=upsConfigOutputVoltage, upsOutputSource=upsOutputSource, upsIdent=upsIdent, upsAlarmInputBad=upsAlarmInputBad, upsTestNoTestsInitiated=upsTestNoTestsInitiated, PYSNMP_MODULE_ID=upsMIB, upsBypass=upsBypass, upsAlarmTable=upsAlarmTable, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBypassPower=upsBypassPower, upsAlarmTempBad=upsAlarmTempBad, upsAlarmBypassBad=upsAlarmBypassBad, upsBypassEntry=upsBypassEntry, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBasicOutputGroup=upsBasicOutputGroup, upsInputLineBads=upsInputLineBads, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsOutputPower=upsOutputPower, upsAlarm=upsAlarm, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmTime=upsAlarmTime, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsInputCurrent=upsInputCurrent, upsFullCompliance=upsFullCompliance, upsSubsetOutputGroup=upsSubsetOutputGroup, PositiveInteger=PositiveInteger, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmOutputOverload=upsAlarmOutputOverload, upsInputLineIndex=upsInputLineIndex, upsSubsetIdentGroup=upsSubsetIdentGroup, upsMIB=upsMIB, upsBasicBypassGroup=upsBasicBypassGroup, upsBasicGroups=upsBasicGroups, upsSubsetGroups=upsSubsetGroups, upsInputTable=upsInputTable)
