...
# Produced by pysmi-1.1.8 at Thu Jan  5 11:24:24 2023
...
NotificationType, Gauge32, ObjectIdentity, ModuleIdentity, mib_2, iso, TimeTicks, Unsigned32, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "ObjectIdentity", "ModuleIdentity", "mib-2", "iso", "TimeTicks", "Unsigned32", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "Bits", "Counter64")
...
mibBuilder.exportSymbols("UPS-MIB", upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBatteryCurrent=upsBatteryCurrent, upsAlarmEntry=upsAlarmEntry, upsConfigLowBattTime=upsConfigLowBattTime, upsBattery=upsBattery, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsMIB=upsMIB, upsConfigOutputVA=upsConfigOutputVA, upsAlarmLowBattery=upsAlarmLowBattery, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsFullBypassGroup=upsFullBypassGroup, upsAlarmInputBad=upsAlarmInputBad, upsCompliances=upsCompliances, upsInputNumLines=upsInputNumLines, upsBasicControlGroup=upsBasicControlGroup, upsIdentName=upsIdentName, upsAlarm=upsAlarm, upsAlarmTempBad=upsAlarmTempBad, upsStartupAfterDelay=upsStartupAfterDelay, upsFullControlGroup=upsFullControlGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsInputLineIndex=upsInputLineIndex, upsRebootWithDuration=upsRebootWithDuration, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBypassTable=upsBypassTable, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsFullIdentGroup=upsFullIdentGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsInputFrequency=upsInputFrequency, upsOutputPercentLoad=upsOutputPercentLoad, upsConformance=upsConformance, upsAutoRestart=upsAutoRestart, upsFullAlarmGroup=upsFullAlarmGroup, upsInputTable=upsInputTable, upsAlarmTable=upsAlarmTable, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBasicGroups=upsBasicGroups, upsBypassPower=upsBypassPower, upsGroups=upsGroups, upsFullCompliance=upsFullCompliance, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmOnBattery=upsAlarmOnBattery, upsOutputVoltage=upsOutputVoltage, upsTestElapsedTime=upsTestElapsedTime, upsAlarmOutputBad=upsAlarmOutputBad, upsBypassFrequency=upsBypassFrequency, PositiveInteger=PositiveInteger, upsSubsetGroups=upsSubsetGroups, upsBatteryTemperature=upsBatteryTemperature, upsBasicBypassGroup=upsBasicBypassGroup, upsInputLineBads=upsInputLineBads, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmId=upsAlarmId, upsOutputLineIndex=upsOutputLineIndex, upsOutputEntry=upsOutputEntry, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, PYSNMP_MODULE_ID=upsMIB, upsFullConfigGroup=upsFullConfigGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsConfigOutputPower=upsConfigOutputPower, upsFullTestGroup=upsFullTestGroup, upsBasicCompliance=upsBasicCompliance, upsTestStartTime=upsTestStartTime, upsAlarmTime=upsAlarmTime, upsTestId=upsTestId, NonNegativeInteger=NonNegativeInteger, upsAlarmTestInProgress=upsAlarmTestInProgress, upsInputCurrent=upsInputCurrent, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBypassCurrent=upsBypassCurrent, upsBypassLineIndex=upsBypassLineIndex, upsBasicIdentGroup=upsBasicIdentGroup, upsBasicTestGroup=upsBasicTestGroup, upsOutputSource=upsOutputSource, upsBasicInputGroup=upsBasicInputGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsIdentManufacturer=upsIdentManufacturer, upsAlarmBatteryBad=upsAlarmBatteryBad, upsConfigInputVoltage=upsConfigInputVoltage, upsSubsetCompliance=upsSubsetCompliance, upsInputVoltage=upsInputVoltage, upsBasicBatteryGroup=upsBasicBatteryGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBypassEntry=upsBypassEntry, upsTraps=upsTraps, upsFullOutputGroup=upsFullOutputGroup, upsTestResultsDetail=upsTestResultsDetail, upsBatteryVoltage=upsBatteryVoltage, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsControl=upsControl, upsAlarmChargerFailed=upsAlarmChargerFailed, upsTest=upsTest, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBypassNumLines=upsBypassNumLines, upsOutputPower=upsOutputPower, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConfigAudibleStatus=upsConfigAudibleStatus, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsInput=upsInput, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmOnBypass=upsAlarmOnBypass, upsBypass=upsBypass, upsWellKnownTests=upsWellKnownTests, upsBypassVoltage=upsBypassVoltage, upsAlarmDescr=upsAlarmDescr, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTrapOnBattery=upsTrapOnBattery, upsIdentModel=upsIdentModel, upsOutput=upsOutput, upsOutputCurrent=upsOutputCurrent, upsOutputTable=upsOutputTable, upsConfigInputFreq=upsConfigInputFreq, upsFullGroups=upsFullGroups, upsInputTruePower=upsInputTruePower, upsTestResultsSummary=upsTestResultsSummary, upsBasicOutputGroup=upsBasicOutputGroup, upsIdent=upsIdent, upsAlarmsPresent=upsAlarmsPresent, upsConfigOutputFreq=upsConfigOutputFreq, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsConfig=upsConfig, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsSubsetControlGroup=upsSubsetControlGroup, upsFullInputGroup=upsFullInputGroup, upsOutputFrequency=upsOutputFrequency, upsInputEntry=upsInputEntry, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestSpinLock=upsTestSpinLock, upsShutdownType=upsShutdownType, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBatteryStatus=upsBatteryStatus, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsObjects=upsObjects, upsOutputNumLines=upsOutputNumLines)
