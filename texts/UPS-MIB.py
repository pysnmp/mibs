...
TestAndIncr, TextualConvention, DisplayString, TimeInterval, AutonomousType, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TextualConvention", "DisplayString", "TimeInterval", "AutonomousType", "TimeStamp")
...
mibBuilder.exportSymbols("UPS-MIB", upsConfig=upsConfig, upsConformance=upsConformance, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmsPresent=upsAlarmsPresent, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarm=upsAlarm, upsOutputTable=upsOutputTable, upsStartupAfterDelay=upsStartupAfterDelay, upsSubsetBatteryGroup=upsSubsetBatteryGroup, PYSNMP_MODULE_ID=upsMIB, upsConfigOutputPower=upsConfigOutputPower, upsBasicCompliance=upsBasicCompliance, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsFullBatteryGroup=upsFullBatteryGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsInputLineBads=upsInputLineBads, upsBatteryVoltage=upsBatteryVoltage, upsControl=upsControl, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsSubsetCompliance=upsSubsetCompliance, upsSubsetIdentGroup=upsSubsetIdentGroup, upsOutputVoltage=upsOutputVoltage, upsFullBypassGroup=upsFullBypassGroup, PositiveInteger=PositiveInteger, upsAlarmOnBypass=upsAlarmOnBypass, upsConfigOutputFreq=upsConfigOutputFreq, upsBypassEntry=upsBypassEntry, upsTestId=upsTestId, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmId=upsAlarmId, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsBasicControlGroup=upsBasicControlGroup, upsBatteryTemperature=upsBatteryTemperature, upsTestResultsSummary=upsTestResultsSummary, upsBypassNumLines=upsBypassNumLines, upsBattery=upsBattery, upsInputEntry=upsInputEntry, upsAlarmDescr=upsAlarmDescr, upsOutputFrequency=upsOutputFrequency, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBypass=upsBypass, upsInputTruePower=upsInputTruePower, NonNegativeInteger=NonNegativeInteger, upsTest=upsTest, upsObjects=upsObjects, upsTestStartTime=upsTestStartTime, upsInputTable=upsInputTable, upsBypassVoltage=upsBypassVoltage, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsFullGroups=upsFullGroups, upsOutputPower=upsOutputPower, upsFullConfigGroup=upsFullConfigGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsBasicGroups=upsBasicGroups, upsBasicInputGroup=upsBasicInputGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTrapTestCompleted=upsTrapTestCompleted, upsFullIdentGroup=upsFullIdentGroup, upsBypassLineIndex=upsBypassLineIndex, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmTime=upsAlarmTime, upsOutput=upsOutput, upsFullTestGroup=upsFullTestGroup, upsRebootWithDuration=upsRebootWithDuration, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAutoRestart=upsAutoRestart, upsBasicAlarmGroup=upsBasicAlarmGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsOutputSource=upsOutputSource, upsAlarmTable=upsAlarmTable, upsOutputPercentLoad=upsOutputPercentLoad, upsBatteryStatus=upsBatteryStatus, upsOutputNumLines=upsOutputNumLines, upsBypassFrequency=upsBypassFrequency, upsFullInputGroup=upsFullInputGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsInputCurrent=upsInputCurrent, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmInputBad=upsAlarmInputBad, upsConfigInputFreq=upsConfigInputFreq, upsTestSpinLock=upsTestSpinLock, upsTrapOnBattery=upsTrapOnBattery, upsAlarmTempBad=upsAlarmTempBad, upsIdent=upsIdent, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmTestInProgress=upsAlarmTestInProgress, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsIdentModel=upsIdentModel, upsOutputCurrent=upsOutputCurrent, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmOutputOverload=upsAlarmOutputOverload, upsInputLineIndex=upsInputLineIndex, upsShutdownAfterDelay=upsShutdownAfterDelay, upsTraps=upsTraps, upsBasicOutputGroup=upsBasicOutputGroup, upsMIB=upsMIB, upsTestResultsDetail=upsTestResultsDetail, upsInput=upsInput, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBypassPower=upsBypassPower, upsFullControlGroup=upsFullControlGroup, upsTestElapsedTime=upsTestElapsedTime, upsConfigOutputVA=upsConfigOutputVA, upsWellKnownTests=upsWellKnownTests, upsBasicConfigGroup=upsBasicConfigGroup, upsInputNumLines=upsInputNumLines, upsConfigAudibleStatus=upsConfigAudibleStatus, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypassTable=upsBypassTable, upsOutputEntry=upsOutputEntry, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBasicTestGroup=upsBasicTestGroup, upsIdentName=upsIdentName, upsAlarmEntry=upsAlarmEntry, upsBasicBatteryGroup=upsBasicBatteryGroup, upsFullCompliance=upsFullCompliance, upsGroups=upsGroups, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsFullOutputGroup=upsFullOutputGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsShutdownType=upsShutdownType, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsConfigOutputVoltage=upsConfigOutputVoltage, upsIdentManufacturer=upsIdentManufacturer, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBatteryCurrent=upsBatteryCurrent, upsAlarmFanFailure=upsAlarmFanFailure, upsFullAlarmGroup=upsFullAlarmGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsBypassCurrent=upsBypassCurrent, upsConfigInputVoltage=upsConfigInputVoltage, upsBasicIdentGroup=upsBasicIdentGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsSubsetGroups=upsSubsetGroups, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsInputFrequency=upsInputFrequency, upsOutputLineIndex=upsOutputLineIndex, upsInputVoltage=upsInputVoltage, upsAlarmChargerFailed=upsAlarmChargerFailed, upsCompliances=upsCompliances)
