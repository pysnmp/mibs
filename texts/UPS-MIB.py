...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:18:01 2023
...
TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, NotificationType, Integer32, Bits, IpAddress, ModuleIdentity, Gauge32, mib_2, Counter32, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "NotificationType", "Integer32", "Bits", "IpAddress", "ModuleIdentity", "Gauge32", "mib-2", "Counter32", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsFullGroups=upsFullGroups, upsBasicInputGroup=upsBasicInputGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBasicTestGroup=upsBasicTestGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsFullTestGroup=upsFullTestGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, PositiveInteger=PositiveInteger, upsOutputVoltage=upsOutputVoltage, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBatteryVoltage=upsBatteryVoltage, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBasicCompliance=upsBasicCompliance, upsInputEntry=upsInputEntry, upsBasicIdentGroup=upsBasicIdentGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBasicConfigGroup=upsBasicConfigGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmId=upsAlarmId, upsAlarmDescr=upsAlarmDescr, upsAlarmOnBattery=upsAlarmOnBattery, upsOutputPower=upsOutputPower, upsAlarmEntry=upsAlarmEntry, upsFullOutputGroup=upsFullOutputGroup, NonNegativeInteger=NonNegativeInteger, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBypassPower=upsBypassPower, upsShutdownType=upsShutdownType, upsInputLineIndex=upsInputLineIndex, upsOutputLineIndex=upsOutputLineIndex, upsRebootWithDuration=upsRebootWithDuration, upsTest=upsTest, upsSubsetCompliance=upsSubsetCompliance, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmTable=upsAlarmTable, upsBatteryStatus=upsBatteryStatus, upsSecondsOnBattery=upsSecondsOnBattery, upsTestResultsDetail=upsTestResultsDetail, upsAlarmOnBypass=upsAlarmOnBypass, upsOutputFrequency=upsOutputFrequency, upsStartupAfterDelay=upsStartupAfterDelay, upsConfigInputVoltage=upsConfigInputVoltage, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBypassTable=upsBypassTable, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBypassEntry=upsBypassEntry, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsOutputCurrent=upsOutputCurrent, upsTestResultsSummary=upsTestResultsSummary, upsBypass=upsBypass, upsAlarmFanFailure=upsAlarmFanFailure, upsOutput=upsOutput, upsIdent=upsIdent, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsInputNumLines=upsInputNumLines, upsConfigAudibleStatus=upsConfigAudibleStatus, upsFullCompliance=upsFullCompliance, upsWellKnownAlarms=upsWellKnownAlarms, upsBypassVoltage=upsBypassVoltage, upsAlarmTestInProgress=upsAlarmTestInProgress, upsInputVoltage=upsInputVoltage, upsInputCurrent=upsInputCurrent, upsTestSpinLock=upsTestSpinLock, upsObjects=upsObjects, upsAlarmsPresent=upsAlarmsPresent, upsCompliances=upsCompliances, upsOutputEntry=upsOutputEntry, upsAlarm=upsAlarm, upsTrapOnBattery=upsTrapOnBattery, upsOutputTable=upsOutputTable, upsInputTable=upsInputTable, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBattery=upsBattery, upsBasicControlGroup=upsBasicControlGroup, upsConfig=upsConfig, upsMIB=upsMIB, upsAlarmInputBad=upsAlarmInputBad, upsGroups=upsGroups, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsInputTruePower=upsInputTruePower, upsFullConfigGroup=upsFullConfigGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsConfigInputFreq=upsConfigInputFreq, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBypassFrequency=upsBypassFrequency, upsBasicGroups=upsBasicGroups, upsBypassNumLines=upsBypassNumLines, upsBatteryTemperature=upsBatteryTemperature, upsTestElapsedTime=upsTestElapsedTime, upsBatteryCurrent=upsBatteryCurrent, upsAlarmLowBattery=upsAlarmLowBattery, upsConfigLowBattTime=upsConfigLowBattTime, upsControl=upsControl, upsConfigOutputPower=upsConfigOutputPower, upsAlarmTime=upsAlarmTime, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTraps=upsTraps, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsConfigOutputVA=upsConfigOutputVA, upsWellKnownTests=upsWellKnownTests, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmTempBad=upsAlarmTempBad, upsBasicBypassGroup=upsBasicBypassGroup, upsBypassCurrent=upsBypassCurrent, upsAlarmOutputBad=upsAlarmOutputBad, upsFullInputGroup=upsFullInputGroup, upsFullControlGroup=upsFullControlGroup, upsIdentModel=upsIdentModel, upsAlarmBypassBad=upsAlarmBypassBad, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsSubsetGroups=upsSubsetGroups, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsConfigOutputFreq=upsConfigOutputFreq, upsOutputSource=upsOutputSource, upsAutoRestart=upsAutoRestart, upsBypassLineIndex=upsBypassLineIndex, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConformance=upsConformance, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsOutputNumLines=upsOutputNumLines, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsConfigOutputVoltage=upsConfigOutputVoltage, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTestStartTime=upsTestStartTime, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsInputLineBads=upsInputLineBads, upsFullIdentGroup=upsFullIdentGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, PYSNMP_MODULE_ID=upsMIB, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsSubsetOutputGroup=upsSubsetOutputGroup, upsIdentName=upsIdentName, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTestId=upsTestId, upsIdentManufacturer=upsIdentManufacturer, upsInput=upsInput, upsInputFrequency=upsInputFrequency, upsFullBypassGroup=upsFullBypassGroup)
