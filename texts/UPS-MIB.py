...
mibBuilder.exportSymbols("UPS-MIB", upsIdentAttachedDevices=upsIdentAttachedDevices, upsOutputSource=upsOutputSource, upsInputEntry=upsInputEntry, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAutoRestart=upsAutoRestart, upsIdentManufacturer=upsIdentManufacturer, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsCompliances=upsCompliances, upsInputTable=upsInputTable, upsBypassVoltage=upsBypassVoltage, upsTestResultsDetail=upsTestResultsDetail, upsAlarmTime=upsAlarmTime, upsAlarm=upsAlarm, upsAlarmTable=upsAlarmTable, upsInputTruePower=upsInputTruePower, upsStartupAfterDelay=upsStartupAfterDelay, upsBasicIdentGroup=upsBasicIdentGroup, upsInput=upsInput, upsConfigInputFreq=upsConfigInputFreq, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBasicOutputGroup=upsBasicOutputGroup, upsOutputLineIndex=upsOutputLineIndex, upsInputFrequency=upsInputFrequency, upsIdent=upsIdent, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmId=upsAlarmId, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsFullBatteryGroup=upsFullBatteryGroup, upsGroups=upsGroups, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsSecondsOnBattery=upsSecondsOnBattery, upsInputVoltage=upsInputVoltage, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmChargerFailed=upsAlarmChargerFailed, upsFullInputGroup=upsFullInputGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsSubsetGroups=upsSubsetGroups, upsTest=upsTest, upsOutputNumLines=upsOutputNumLines, upsTrapOnBattery=upsTrapOnBattery, upsWellKnownTests=upsWellKnownTests, upsFullBypassGroup=upsFullBypassGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTestResultsSummary=upsTestResultsSummary, upsShutdownAfterDelay=upsShutdownAfterDelay, upsConfigInputVoltage=upsConfigInputVoltage, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmOutputBad=upsAlarmOutputBad, upsConfigOutputVA=upsConfigOutputVA, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsConfigOutputFreq=upsConfigOutputFreq, upsFullCompliance=upsFullCompliance, PYSNMP_MODULE_ID=upsMIB, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsInputLineIndex=upsInputLineIndex, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBypass=upsBypass, upsConfigOutputPower=upsConfigOutputPower, upsBattery=upsBattery, upsWellKnownAlarms=upsWellKnownAlarms, upsBasicAlarmGroup=upsBasicAlarmGroup, upsFullIdentGroup=upsFullIdentGroup, upsBypassLineIndex=upsBypassLineIndex, upsOutputFrequency=upsOutputFrequency, upsBypassTable=upsBypassTable, upsBypassNumLines=upsBypassNumLines, upsTraps=upsTraps, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBypassPower=upsBypassPower, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsFullGroups=upsFullGroups, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmTempBad=upsAlarmTempBad, upsBatteryVoltage=upsBatteryVoltage, upsOutput=upsOutput, upsBasicTestGroup=upsBasicTestGroup, upsBasicControlGroup=upsBasicControlGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsBypassCurrent=upsBypassCurrent, upsConformance=upsConformance, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicGroups=upsBasicGroups, upsOutputTable=upsOutputTable, upsInputCurrent=upsInputCurrent, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestSpinLock=upsTestSpinLock, upsOutputPower=upsOutputPower, upsAlarmBypassBad=upsAlarmBypassBad, upsBatteryCurrent=upsBatteryCurrent, upsBypassEntry=upsBypassEntry, upsSubsetControlGroup=upsSubsetControlGroup, upsTestStartTime=upsTestStartTime, upsSubsetInputGroup=upsSubsetInputGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsFullConfigGroup=upsFullConfigGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsInputLineBads=upsInputLineBads, upsTestId=upsTestId, upsAlarmOnBattery=upsAlarmOnBattery, NonNegativeInteger=NonNegativeInteger, upsFullControlGroup=upsFullControlGroup, upsMIB=upsMIB, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmDescr=upsAlarmDescr, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBatteryStatus=upsBatteryStatus, upsBasicConfigGroup=upsBasicConfigGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsOutputEntry=upsOutputEntry, upsBasicCompliance=upsBasicCompliance, upsFullOutputGroup=upsFullOutputGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsObjects=upsObjects, upsIdentModel=upsIdentModel, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsShutdownType=upsShutdownType, upsOutputVoltage=upsOutputVoltage, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBatteryTemperature=upsBatteryTemperature, upsSubsetConfigGroup=upsSubsetConfigGroup, upsInputNumLines=upsInputNumLines, upsAlarmFuseFailure=upsAlarmFuseFailure, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsIdentName=upsIdentName, upsFullTestGroup=upsFullTestGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmEntry=upsAlarmEntry, upsRebootWithDuration=upsRebootWithDuration, upsConfig=upsConfig, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmsPresent=upsAlarmsPresent, upsSubsetCompliance=upsSubsetCompliance, upsBypassFrequency=upsBypassFrequency, upsControl=upsControl, upsAlarmInputBad=upsAlarmInputBad, upsAlarmLowBattery=upsAlarmLowBattery, upsBasicBypassGroup=upsBasicBypassGroup, PositiveInteger=PositiveInteger, upsBasicInputGroup=upsBasicInputGroup, upsTestElapsedTime=upsTestElapsedTime, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsOutputCurrent=upsOutputCurrent)
