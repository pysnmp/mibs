...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmOutputOverload=upsAlarmOutputOverload, upsFullBypassGroup=upsFullBypassGroup, upsIdentManufacturer=upsIdentManufacturer, upsInput=upsInput, upsWellKnownAlarms=upsWellKnownAlarms, upsCompliances=upsCompliances, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmTable=upsAlarmTable, upsFullIdentGroup=upsFullIdentGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestElapsedTime=upsTestElapsedTime, upsAlarmOnBypass=upsAlarmOnBypass, upsTestId=upsTestId, upsOutputEntry=upsOutputEntry, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmTime=upsAlarmTime, upsSubsetGroups=upsSubsetGroups, upsTestStartTime=upsTestStartTime, upsConfig=upsConfig, upsWellKnownTests=upsWellKnownTests, upsBypassEntry=upsBypassEntry, upsTraps=upsTraps, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarm=upsAlarm, upsBypassCurrent=upsBypassCurrent, upsFullConfigGroup=upsFullConfigGroup, upsBatteryStatus=upsBatteryStatus, upsIdent=upsIdent, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicGroups=upsBasicGroups, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBypassFrequency=upsBypassFrequency, upsBatteryCurrent=upsBatteryCurrent, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsSubsetControlGroup=upsSubsetControlGroup, upsInputTable=upsInputTable, upsAlarmOnBattery=upsAlarmOnBattery, upsObjects=upsObjects, upsOutputFrequency=upsOutputFrequency, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsBasicConfigGroup=upsBasicConfigGroup, upsInputTruePower=upsInputTruePower, upsBatteryVoltage=upsBatteryVoltage, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBypassTable=upsBypassTable, upsBasicInputGroup=upsBasicInputGroup, upsAlarmTempBad=upsAlarmTempBad, upsShutdownAfterDelay=upsShutdownAfterDelay, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsGroups=upsGroups, upsTestSpinLock=upsTestSpinLock, upsBypassPower=upsBypassPower, upsConfigInputVoltage=upsConfigInputVoltage, upsTestResultsSummary=upsTestResultsSummary, upsAlarmFanFailure=upsAlarmFanFailure, upsRebootWithDuration=upsRebootWithDuration, upsBasicCompliance=upsBasicCompliance, upsStartupAfterDelay=upsStartupAfterDelay, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBattery=upsBattery, upsConfigLowBattTime=upsConfigLowBattTime, upsBypassLineIndex=upsBypassLineIndex, upsTest=upsTest, upsBypass=upsBypass, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsOutputNumLines=upsOutputNumLines, upsOutputPower=upsOutputPower, upsOutputTable=upsOutputTable, upsBasicControlGroup=upsBasicControlGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, PYSNMP_MODULE_ID=upsMIB, upsMIB=upsMIB, upsIdentName=upsIdentName, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConformance=upsConformance, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmGeneralFault=upsAlarmGeneralFault, upsOutputSource=upsOutputSource, upsAlarmDescr=upsAlarmDescr, upsBasicAlarmGroup=upsBasicAlarmGroup, upsOutput=upsOutput, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBatteryTemperature=upsBatteryTemperature, upsBasicTestGroup=upsBasicTestGroup, upsOutputCurrent=upsOutputCurrent, upsInputEntry=upsInputEntry, upsInputLineIndex=upsInputLineIndex, NonNegativeInteger=NonNegativeInteger, upsOutputPercentLoad=upsOutputPercentLoad, upsBasicBatteryGroup=upsBasicBatteryGroup, PositiveInteger=PositiveInteger, upsFullControlGroup=upsFullControlGroup, upsTestResultsDetail=upsTestResultsDetail, upsSubsetConfigGroup=upsSubsetConfigGroup, upsConfigOutputVA=upsConfigOutputVA, upsSubsetCompliance=upsSubsetCompliance, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmInputBad=upsAlarmInputBad, upsShutdownType=upsShutdownType, upsFullInputGroup=upsFullInputGroup, upsInputFrequency=upsInputFrequency, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmsPresent=upsAlarmsPresent, upsFullCompliance=upsFullCompliance, upsConfigOutputFreq=upsConfigOutputFreq, upsAutoRestart=upsAutoRestart, upsBasicIdentGroup=upsBasicIdentGroup, upsInputNumLines=upsInputNumLines, upsBypassVoltage=upsBypassVoltage, upsInputVoltage=upsInputVoltage, upsFullGroups=upsFullGroups, upsAlarmLowBattery=upsAlarmLowBattery, upsConfigInputFreq=upsConfigInputFreq, upsFullBatteryGroup=upsFullBatteryGroup, upsConfigOutputPower=upsConfigOutputPower, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBypassNumLines=upsBypassNumLines, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsIdentModel=upsIdentModel, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsSecondsOnBattery=upsSecondsOnBattery, upsOutputLineIndex=upsOutputLineIndex, upsAlarmId=upsAlarmId, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmChargerFailed=upsAlarmChargerFailed, upsTrapTestCompleted=upsTrapTestCompleted, upsInputCurrent=upsInputCurrent, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsInputLineBads=upsInputLineBads, upsTrapOnBattery=upsTrapOnBattery, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsSubsetOutputGroup=upsSubsetOutputGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsOutputVoltage=upsOutputVoltage, upsControl=upsControl, upsFullOutputGroup=upsFullOutputGroup, upsFullTestGroup=upsFullTestGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmEntry=upsAlarmEntry)
