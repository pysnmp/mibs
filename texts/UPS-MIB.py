...
mibBuilder.exportSymbols("UPS-MIB", upsObjects=upsObjects, upsAutoRestart=upsAutoRestart, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsFullControlGroup=upsFullControlGroup, upsOutput=upsOutput, upsTestSpinLock=upsTestSpinLock, upsShutdownAfterDelay=upsShutdownAfterDelay, upsInputLineBads=upsInputLineBads, upsConfigOutputFreq=upsConfigOutputFreq, upsFullTestGroup=upsFullTestGroup, upsFullInputGroup=upsFullInputGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBasicControlGroup=upsBasicControlGroup, upsAlarmTempBad=upsAlarmTempBad, upsCompliances=upsCompliances, upsInputFrequency=upsInputFrequency, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsConfigInputFreq=upsConfigInputFreq, upsBattery=upsBattery, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsOutputNumLines=upsOutputNumLines, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsConformance=upsConformance, upsAlarmsPresent=upsAlarmsPresent, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsOutputPower=upsOutputPower, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullIdentGroup=upsFullIdentGroup, upsGroups=upsGroups, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsConfigLowBattTime=upsConfigLowBattTime, upsOutputFrequency=upsOutputFrequency, upsAlarmOutputOverload=upsAlarmOutputOverload, upsOutputVoltage=upsOutputVoltage, upsTestStartTime=upsTestStartTime, upsTestResultsSummary=upsTestResultsSummary, upsBatteryVoltage=upsBatteryVoltage, upsFullBatteryGroup=upsFullBatteryGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsFullGroups=upsFullGroups, upsBasicBypassGroup=upsBasicBypassGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsOutputCurrent=upsOutputCurrent, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsSubsetControlGroup=upsSubsetControlGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsInputEntry=upsInputEntry, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsIdentModel=upsIdentModel, upsSecondsOnBattery=upsSecondsOnBattery, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmDescr=upsAlarmDescr, upsInputCurrent=upsInputCurrent, upsInputLineIndex=upsInputLineIndex, upsOutputEntry=upsOutputEntry, upsTest=upsTest, upsConfigOutputPower=upsConfigOutputPower, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicCompliance=upsBasicCompliance, upsStartupAfterDelay=upsStartupAfterDelay, upsBatteryStatus=upsBatteryStatus, upsInputTruePower=upsInputTruePower, upsBypassPower=upsBypassPower, upsBypass=upsBypass, upsBypassCurrent=upsBypassCurrent, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarm=upsAlarm, upsAlarmFanFailure=upsAlarmFanFailure, upsBypassFrequency=upsBypassFrequency, upsTrapTestCompleted=upsTrapTestCompleted, upsInputNumLines=upsInputNumLines, upsAlarmInputBad=upsAlarmInputBad, upsSubsetGroups=upsSubsetGroups, upsAlarmId=upsAlarmId, upsBasicInputGroup=upsBasicInputGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsConfig=upsConfig, upsBatteryCurrent=upsBatteryCurrent, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBatteryTemperature=upsBatteryTemperature, upsAlarmTable=upsAlarmTable, upsAlarmEntry=upsAlarmEntry, upsTestElapsedTime=upsTestElapsedTime, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBypassEntry=upsBypassEntry, NonNegativeInteger=NonNegativeInteger, upsIdentName=upsIdentName, upsAlarmOutputBad=upsAlarmOutputBad, upsBypassTable=upsBypassTable, upsControl=upsControl, upsIdent=upsIdent, upsOutputSource=upsOutputSource, upsAlarmBatteryBad=upsAlarmBatteryBad, upsInputVoltage=upsInputVoltage, upsSubsetCompliance=upsSubsetCompliance, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmLowBattery=upsAlarmLowBattery, upsTraps=upsTraps, upsTrapOnBattery=upsTrapOnBattery, upsRebootWithDuration=upsRebootWithDuration, upsShutdownType=upsShutdownType, upsAlarmFuseFailure=upsAlarmFuseFailure, upsConfigInputVoltage=upsConfigInputVoltage, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBasicGroups=upsBasicGroups, upsBypassNumLines=upsBypassNumLines, upsAlarmTime=upsAlarmTime, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmShutdownPending=upsAlarmShutdownPending, upsTestId=upsTestId, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBypassLineIndex=upsBypassLineIndex, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullBypassGroup=upsFullBypassGroup, upsTestResultsDetail=upsTestResultsDetail, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsInput=upsInput, upsBasicConfigGroup=upsBasicConfigGroup, upsBypassVoltage=upsBypassVoltage, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConfigAudibleStatus=upsConfigAudibleStatus, upsOutputLineIndex=upsOutputLineIndex, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsFullOutputGroup=upsFullOutputGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsWellKnownTests=upsWellKnownTests, upsMIB=upsMIB, PYSNMP_MODULE_ID=upsMIB, upsOutputTable=upsOutputTable, PositiveInteger=PositiveInteger, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsInputTable=upsInputTable, upsConfigOutputVA=upsConfigOutputVA, upsBasicAlarmGroup=upsBasicAlarmGroup, upsFullCompliance=upsFullCompliance, upsIdentManufacturer=upsIdentManufacturer, upsFullConfigGroup=upsFullConfigGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBasicTestGroup=upsBasicTestGroup)
