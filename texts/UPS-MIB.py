...
Counter32, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, Integer32, Bits, IpAddress, Counter64, ModuleIdentity, NotificationType, mib_2, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "Integer32", "Bits", "IpAddress", "Counter64", "ModuleIdentity", "NotificationType", "mib-2", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmBypassBad=upsAlarmBypassBad, upsBypassCurrent=upsBypassCurrent, upsAlarmId=upsAlarmId, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsConfigInputVoltage=upsConfigInputVoltage, upsOutputTable=upsOutputTable, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicOutputGroup=upsBasicOutputGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsIdent=upsIdent, upsWellKnownTests=upsWellKnownTests, upsConfig=upsConfig, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTestNoTestsInitiated=upsTestNoTestsInitiated, NonNegativeInteger=NonNegativeInteger, upsBatteryVoltage=upsBatteryVoltage, upsShutdownAfterDelay=upsShutdownAfterDelay, upsFullAlarmGroup=upsFullAlarmGroup, upsBatteryCurrent=upsBatteryCurrent, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsCompliances=upsCompliances, upsRebootWithDuration=upsRebootWithDuration, upsInputEntry=upsInputEntry, upsBatteryStatus=upsBatteryStatus, upsMIB=upsMIB, upsInputVoltage=upsInputVoltage, upsFullOutputGroup=upsFullOutputGroup, upsBypassVoltage=upsBypassVoltage, upsFullGroups=upsFullGroups, upsAlarmTempBad=upsAlarmTempBad, upsConfigAudibleStatus=upsConfigAudibleStatus, upsOutputLineIndex=upsOutputLineIndex, upsTraps=upsTraps, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTrapOnBattery=upsTrapOnBattery, upsSubsetControlGroup=upsSubsetControlGroup, upsGroups=upsGroups, upsBattery=upsBattery, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsTest=upsTest, upsTestResultsSummary=upsTestResultsSummary, upsTestElapsedTime=upsTestElapsedTime, upsTestSpinLock=upsTestSpinLock, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsOutputEntry=upsOutputEntry, upsFullIdentGroup=upsFullIdentGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsFullConfigGroup=upsFullConfigGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmTime=upsAlarmTime, upsSubsetOutputGroup=upsSubsetOutputGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsIdentManufacturer=upsIdentManufacturer, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTestId=upsTestId, upsSubsetIdentGroup=upsSubsetIdentGroup, upsFullCompliance=upsFullCompliance, upsBatteryTemperature=upsBatteryTemperature, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicCompliance=upsBasicCompliance, upsAlarmLowBattery=upsAlarmLowBattery, upsSubsetGroups=upsSubsetGroups, upsOutputCurrent=upsOutputCurrent, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsConfigLowBattTime=upsConfigLowBattTime, upsInputTruePower=upsInputTruePower, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmInputBad=upsAlarmInputBad, upsInputLineIndex=upsInputLineIndex, upsConformance=upsConformance, upsSubsetInputGroup=upsSubsetInputGroup, upsFullInputGroup=upsFullInputGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBasicInputGroup=upsBasicInputGroup, upsBypassNumLines=upsBypassNumLines, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmEntry=upsAlarmEntry, upsOutputNumLines=upsOutputNumLines, upsTestResultsDetail=upsTestResultsDetail, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsInputTable=upsInputTable, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConfigInputFreq=upsConfigInputFreq, upsBasicIdentGroup=upsBasicIdentGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsBypassTable=upsBypassTable, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConfigOutputVA=upsConfigOutputVA, upsBasicBypassGroup=upsBasicBypassGroup, upsFullBypassGroup=upsFullBypassGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsInputLineBads=upsInputLineBads, upsFullTestGroup=upsFullTestGroup, upsOutputFrequency=upsOutputFrequency, upsOutput=upsOutput, upsBypassEntry=upsBypassEntry, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsShutdownType=upsShutdownType, upsBypassFrequency=upsBypassFrequency, upsOutputPower=upsOutputPower, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsIdentName=upsIdentName, upsBypassLineIndex=upsBypassLineIndex, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsOutputSource=upsOutputSource, upsBypassPower=upsBypassPower, upsOutputVoltage=upsOutputVoltage, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmTable=upsAlarmTable, upsAlarmGeneralFault=upsAlarmGeneralFault, upsInputFrequency=upsInputFrequency, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBypass=upsBypass, upsObjects=upsObjects, upsInputCurrent=upsInputCurrent, PYSNMP_MODULE_ID=upsMIB, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmDescr=upsAlarmDescr, upsAlarmOnBypass=upsAlarmOnBypass, upsFullControlGroup=upsFullControlGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBasicGroups=upsBasicGroups, upsTestStartTime=upsTestStartTime, upsFullBatteryGroup=upsFullBatteryGroup, upsInput=upsInput, upsAlarmOutputBad=upsAlarmOutputBad, upsBasicTestGroup=upsBasicTestGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsIdentModel=upsIdentModel, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTrapTestCompleted=upsTrapTestCompleted, upsBasicControlGroup=upsBasicControlGroup, upsSubsetCompliance=upsSubsetCompliance, PositiveInteger=PositiveInteger, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmsPresent=upsAlarmsPresent, upsConfigOutputPower=upsConfigOutputPower, upsAlarm=upsAlarm, upsInputNumLines=upsInputNumLines, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAutoRestart=upsAutoRestart, upsControl=upsControl)
