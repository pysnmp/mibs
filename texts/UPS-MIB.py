...
# Produced by pysmi-1.1.8 at Mon Feb  6 14:20:48 2023
...
iso, IpAddress, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, Gauge32, mib_2, Counter64, Counter32, ObjectIdentity, MibIdentifier, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "Gauge32", "mib-2", "Counter64", "Counter32", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("UPS-MIB", upsWellKnownTests=upsWellKnownTests, upsAlarmOnBypass=upsAlarmOnBypass, upsTestElapsedTime=upsTestElapsedTime, upsBasicGroups=upsBasicGroups, upsTestResultsSummary=upsTestResultsSummary, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmsPresent=upsAlarmsPresent, upsTestSpinLock=upsTestSpinLock, upsOutputEntry=upsOutputEntry, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsConfigOutputPower=upsConfigOutputPower, upsFullGroups=upsFullGroups, upsTrapOnBattery=upsTrapOnBattery, upsShutdownType=upsShutdownType, upsOutput=upsOutput, upsSubsetOutputGroup=upsSubsetOutputGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicInputGroup=upsBasicInputGroup, upsInputTruePower=upsInputTruePower, upsAlarmTime=upsAlarmTime, upsFullInputGroup=upsFullInputGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmId=upsAlarmId, upsAlarmEntry=upsAlarmEntry, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBasicTestGroup=upsBasicTestGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsOutputSource=upsOutputSource, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, PYSNMP_MODULE_ID=upsMIB, upsBypassVoltage=upsBypassVoltage, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmFanFailure=upsAlarmFanFailure, upsBattery=upsBattery, upsBypassFrequency=upsBypassFrequency, upsBypassLineIndex=upsBypassLineIndex, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBatteryTemperature=upsBatteryTemperature, upsOutputPower=upsOutputPower, upsFullBypassGroup=upsFullBypassGroup, upsObjects=upsObjects, upsSubsetControlGroup=upsSubsetControlGroup, upsInputLineBads=upsInputLineBads, upsTest=upsTest, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsConformance=upsConformance, upsAlarmInputBad=upsAlarmInputBad, upsOutputCurrent=upsOutputCurrent, upsAutoRestart=upsAutoRestart, upsIdent=upsIdent, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsInputVoltage=upsInputVoltage, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmTempBad=upsAlarmTempBad, upsGroups=upsGroups, upsBypassEntry=upsBypassEntry, upsOutputNumLines=upsOutputNumLines, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, NonNegativeInteger=NonNegativeInteger, upsConfig=upsConfig, upsBasicCompliance=upsBasicCompliance, upsInputCurrent=upsInputCurrent, upsBatteryStatus=upsBatteryStatus, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmLowBattery=upsAlarmLowBattery, upsBypass=upsBypass, upsIdentModel=upsIdentModel, upsBatteryVoltage=upsBatteryVoltage, upsAlarm=upsAlarm, upsAlarmShutdownPending=upsAlarmShutdownPending, upsFullBatteryGroup=upsFullBatteryGroup, upsFullCompliance=upsFullCompliance, upsControl=upsControl, upsInputLineIndex=upsInputLineIndex, upsOutputFrequency=upsOutputFrequency, upsTestId=upsTestId, upsStartupAfterDelay=upsStartupAfterDelay, upsSubsetIdentGroup=upsSubsetIdentGroup, upsInputNumLines=upsInputNumLines, upsSubsetCompliance=upsSubsetCompliance, upsInputFrequency=upsInputFrequency, upsOutputTable=upsOutputTable, upsIdentManufacturer=upsIdentManufacturer, upsAlarmOnBattery=upsAlarmOnBattery, upsConfigInputFreq=upsConfigInputFreq, upsAlarmTable=upsAlarmTable, upsTrapTestCompleted=upsTrapTestCompleted, upsBasicBatteryGroup=upsBasicBatteryGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsFullTestGroup=upsFullTestGroup, upsBypassCurrent=upsBypassCurrent, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsOutputVoltage=upsOutputVoltage, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsIdentName=upsIdentName, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmDescr=upsAlarmDescr, upsSubsetGroups=upsSubsetGroups, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsFullAlarmGroup=upsFullAlarmGroup, upsInput=upsInput, upsConfigAudibleStatus=upsConfigAudibleStatus, upsWellKnownAlarms=upsWellKnownAlarms, upsInputEntry=upsInputEntry, upsFullOutputGroup=upsFullOutputGroup, upsFullControlGroup=upsFullControlGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsTraps=upsTraps, upsBasicControlGroup=upsBasicControlGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsBasicIdentGroup=upsBasicIdentGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsOutputLineIndex=upsOutputLineIndex, upsFullConfigGroup=upsFullConfigGroup, upsMIB=upsMIB, upsBypassPower=upsBypassPower, upsTestResultsDetail=upsTestResultsDetail, upsConfigOutputVA=upsConfigOutputVA, PositiveInteger=PositiveInteger, upsBasicOutputGroup=upsBasicOutputGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBatteryCurrent=upsBatteryCurrent, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTestStartTime=upsTestStartTime, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullIdentGroup=upsFullIdentGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBypassNumLines=upsBypassNumLines, upsCompliances=upsCompliances, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBypassTable=upsBypassTable, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsRebootWithDuration=upsRebootWithDuration, upsIdentAttachedDevices=upsIdentAttachedDevices, upsInputTable=upsInputTable, upsAlarmChargerFailed=upsAlarmChargerFailed)
