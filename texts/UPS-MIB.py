...
mibBuilder.exportSymbols("UPS-MIB", upsConfig=upsConfig, upsIdentManufacturer=upsIdentManufacturer, upsBasicCompliance=upsBasicCompliance, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsOutputNumLines=upsOutputNumLines, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBypass=upsBypass, upsOutputPower=upsOutputPower, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsOutputLineIndex=upsOutputLineIndex, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBypassVoltage=upsBypassVoltage, upsAlarmInputBad=upsAlarmInputBad, upsAlarm=upsAlarm, upsInputCurrent=upsInputCurrent, upsAlarmOnBypass=upsAlarmOnBypass, upsSubsetGroups=upsSubsetGroups, upsBasicGroups=upsBasicGroups, upsFullConfigGroup=upsFullConfigGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmTable=upsAlarmTable, upsObjects=upsObjects, upsOutputSource=upsOutputSource, upsFullGroups=upsFullGroups, upsConfigOutputPower=upsConfigOutputPower, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsInputNumLines=upsInputNumLines, upsBypassPower=upsBypassPower, upsIdent=upsIdent, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmTime=upsAlarmTime, upsInputEntry=upsInputEntry, upsAlarmOnBattery=upsAlarmOnBattery, upsIdentName=upsIdentName, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTrapOnBattery=upsTrapOnBattery, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsConformance=upsConformance, upsTestStartTime=upsTestStartTime, upsOutputTable=upsOutputTable, upsInputLineIndex=upsInputLineIndex, upsInputTruePower=upsInputTruePower, upsWellKnownAlarms=upsWellKnownAlarms, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBatteryVoltage=upsBatteryVoltage, upsControl=upsControl, upsAlarmChargerFailed=upsAlarmChargerFailed, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBattery=upsBattery, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsTestId=upsTestId, upsWellKnownTests=upsWellKnownTests, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmLowBattery=upsAlarmLowBattery, upsBypassTable=upsBypassTable, upsFullIdentGroup=upsFullIdentGroup, upsTestResultsDetail=upsTestResultsDetail, upsStartupAfterDelay=upsStartupAfterDelay, upsInputLineBads=upsInputLineBads, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsRebootWithDuration=upsRebootWithDuration, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsInput=upsInput, upsSecondsOnBattery=upsSecondsOnBattery, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBasicConfigGroup=upsBasicConfigGroup, upsTestResultsSummary=upsTestResultsSummary, upsOutputFrequency=upsOutputFrequency, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTraps=upsTraps, upsCompliances=upsCompliances, upsSubsetCompliance=upsSubsetCompliance, upsAlarmId=upsAlarmId, upsFullInputGroup=upsFullInputGroup, upsOutputCurrent=upsOutputCurrent, upsFullBatteryGroup=upsFullBatteryGroup, upsBypassLineIndex=upsBypassLineIndex, upsBatteryCurrent=upsBatteryCurrent, upsOutput=upsOutput, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsMIB=upsMIB, upsAlarmGeneralFault=upsAlarmGeneralFault, upsInputFrequency=upsInputFrequency, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsShutdownType=upsShutdownType, upsAlarmsPresent=upsAlarmsPresent, upsFullBypassGroup=upsFullBypassGroup, upsTestSpinLock=upsTestSpinLock, upsSubsetInputGroup=upsSubsetInputGroup, upsBatteryStatus=upsBatteryStatus, upsTest=upsTest, upsBasicInputGroup=upsBasicInputGroup, upsFullControlGroup=upsFullControlGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBasicTestGroup=upsBasicTestGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsFullCompliance=upsFullCompliance, PYSNMP_MODULE_ID=upsMIB, upsGroups=upsGroups, upsInputTable=upsInputTable, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBasicIdentGroup=upsBasicIdentGroup, upsBypassEntry=upsBypassEntry, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, NonNegativeInteger=NonNegativeInteger, PositiveInteger=PositiveInteger, upsIdentModel=upsIdentModel, upsConfigOutputVA=upsConfigOutputVA, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsInputVoltage=upsInputVoltage, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBypassCurrent=upsBypassCurrent, upsBypassNumLines=upsBypassNumLines, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmEntry=upsAlarmEntry, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmOutputBad=upsAlarmOutputBad, upsBypassFrequency=upsBypassFrequency, upsTestElapsedTime=upsTestElapsedTime, upsConfigInputFreq=upsConfigInputFreq, upsBatteryTemperature=upsBatteryTemperature, upsFullOutputGroup=upsFullOutputGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmTempBad=upsAlarmTempBad, upsOutputVoltage=upsOutputVoltage, upsOutputEntry=upsOutputEntry, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsBasicAlarmGroup=upsBasicAlarmGroup, upsFullTestGroup=upsFullTestGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmDescr=upsAlarmDescr, upsAlarmFanFailure=upsAlarmFanFailure, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBasicControlGroup=upsBasicControlGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAutoRestart=upsAutoRestart)
