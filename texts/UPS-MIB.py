...
mibBuilder.exportSymbols("UPS-MIB", upsInputTruePower=upsInputTruePower, upsOutputFrequency=upsOutputFrequency, upsBatteryVoltage=upsBatteryVoltage, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBattery=upsBattery, upsTestElapsedTime=upsTestElapsedTime, upsConfigInputFreq=upsConfigInputFreq, upsAlarmOutputOverload=upsAlarmOutputOverload, upsOutputSource=upsOutputSource, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmOnBattery=upsAlarmOnBattery, upsBasicAlarmGroup=upsBasicAlarmGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmOutputBad=upsAlarmOutputBad, upsControl=upsControl, upsOutputTable=upsOutputTable, upsInputLineIndex=upsInputLineIndex, upsOutputNumLines=upsOutputNumLines, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBasicBypassGroup=upsBasicBypassGroup, upsInputCurrent=upsInputCurrent, upsFullTestGroup=upsFullTestGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsOutputCurrent=upsOutputCurrent, upsBypassPower=upsBypassPower, upsAlarmOnBypass=upsAlarmOnBypass, upsSubsetGroups=upsSubsetGroups, upsAlarmsPresent=upsAlarmsPresent, PYSNMP_MODULE_ID=upsMIB, upsFullBypassGroup=upsFullBypassGroup, upsGroups=upsGroups, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmTestInProgress=upsAlarmTestInProgress, upsInputEntry=upsInputEntry, upsFullCompliance=upsFullCompliance, upsBypassFrequency=upsBypassFrequency, upsFullOutputGroup=upsFullOutputGroup, upsFullConfigGroup=upsFullConfigGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsBasicInputGroup=upsBasicInputGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfigLowBattTime=upsConfigLowBattTime, upsConformance=upsConformance, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmFanFailure=upsAlarmFanFailure, upsConfigOutputFreq=upsConfigOutputFreq, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsConfigOutputVA=upsConfigOutputVA, upsBasicConfigGroup=upsBasicConfigGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmBypassBad=upsAlarmBypassBad, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsOutput=upsOutput, upsBasicOutputGroup=upsBasicOutputGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsInputNumLines=upsInputNumLines, upsAlarmChargerFailed=upsAlarmChargerFailed, upsInputLineBads=upsInputLineBads, upsIdent=upsIdent, upsConfig=upsConfig, upsAlarmEntry=upsAlarmEntry, upsInputVoltage=upsInputVoltage, upsObjects=upsObjects, PositiveInteger=PositiveInteger, upsAlarmLowBattery=upsAlarmLowBattery, upsShutdownType=upsShutdownType, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmTable=upsAlarmTable, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmInputBad=upsAlarmInputBad, upsBypassVoltage=upsBypassVoltage, upsMIB=upsMIB, upsIdentModel=upsIdentModel, upsTestResultsDetail=upsTestResultsDetail, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBasicCompliance=upsBasicCompliance, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmBatteryBad=upsAlarmBatteryBad, upsFullControlGroup=upsFullControlGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsSubsetCompliance=upsSubsetCompliance, upsBatteryTemperature=upsBatteryTemperature, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBypass=upsBypass, NonNegativeInteger=NonNegativeInteger, upsAlarm=upsAlarm, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmTime=upsAlarmTime, upsTestResultsSummary=upsTestResultsSummary, upsBypassCurrent=upsBypassCurrent, upsIdentName=upsIdentName, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBasicGroups=upsBasicGroups, upsFullInputGroup=upsFullInputGroup, upsTrapOnBattery=upsTrapOnBattery, upsBatteryCurrent=upsBatteryCurrent, upsOutputVoltage=upsOutputVoltage, upsTest=upsTest, upsFullIdentGroup=upsFullIdentGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsInputTable=upsInputTable, upsOutputLineIndex=upsOutputLineIndex, upsInputFrequency=upsInputFrequency, upsTestId=upsTestId, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBypassEntry=upsBypassEntry, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBatteryStatus=upsBatteryStatus, upsTestSpinLock=upsTestSpinLock, upsInput=upsInput, upsBasicControlGroup=upsBasicControlGroup, upsBasicTestGroup=upsBasicTestGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmId=upsAlarmId, upsRebootWithDuration=upsRebootWithDuration, upsBypassNumLines=upsBypassNumLines, upsOutputPower=upsOutputPower, upsOutputEntry=upsOutputEntry, upsCompliances=upsCompliances, upsTraps=upsTraps, upsBypassTable=upsBypassTable, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsWellKnownTests=upsWellKnownTests, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestStartTime=upsTestStartTime, upsAlarmTempBad=upsAlarmTempBad, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsIdentManufacturer=upsIdentManufacturer, upsShutdownAfterDelay=upsShutdownAfterDelay, upsFullGroups=upsFullGroups, upsAutoRestart=upsAutoRestart, upsConfigOutputPower=upsConfigOutputPower, upsAlarmDescr=upsAlarmDescr, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBypassLineIndex=upsBypassLineIndex)
