...
# Produced by pysmi-1.1.12 at Mon Sep 16 14:51:43 2024
...
mibBuilder.exportSymbols("UPS-MIB", upsFullCompliance=upsFullCompliance, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBatteryCurrent=upsBatteryCurrent, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTestSpinLock=upsTestSpinLock, upsIdentModel=upsIdentModel, upsTrapOnBattery=upsTrapOnBattery, upsTestResultsSummary=upsTestResultsSummary, upsOutputCurrent=upsOutputCurrent, upsConfigInputVoltage=upsConfigInputVoltage, upsBatteryTemperature=upsBatteryTemperature, upsBatteryStatus=upsBatteryStatus, upsShutdownType=upsShutdownType, upsTestResultsDetail=upsTestResultsDetail, upsIdent=upsIdent, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsFullControlGroup=upsFullControlGroup, upsAlarm=upsAlarm, upsFullInputGroup=upsFullInputGroup, upsOutputSource=upsOutputSource, upsOutputPercentLoad=upsOutputPercentLoad, upsOutputTable=upsOutputTable, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsFullBypassGroup=upsFullBypassGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAutoRestart=upsAutoRestart, upsBattery=upsBattery, upsShutdownAfterDelay=upsShutdownAfterDelay, upsFullOutputGroup=upsFullOutputGroup, upsConfigOutputVA=upsConfigOutputVA, upsInput=upsInput, upsWellKnownAlarms=upsWellKnownAlarms, upsConfigLowBattTime=upsConfigLowBattTime, upsOutput=upsOutput, upsBasicBatteryGroup=upsBasicBatteryGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmEntry=upsAlarmEntry, upsBasicIdentGroup=upsBasicIdentGroup, upsBypassFrequency=upsBypassFrequency, upsAlarmBypassBad=upsAlarmBypassBad, upsInputTruePower=upsInputTruePower, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBypassVoltage=upsBypassVoltage, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsFullTestGroup=upsFullTestGroup, NonNegativeInteger=NonNegativeInteger, upsConfigOutputPower=upsConfigOutputPower, upsBasicInputGroup=upsBasicInputGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmFanFailure=upsAlarmFanFailure, upsBypassCurrent=upsBypassCurrent, upsFullGroups=upsFullGroups, upsBasicTestGroup=upsBasicTestGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTestId=upsTestId, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsOutputVoltage=upsOutputVoltage, upsAlarmsPresent=upsAlarmsPresent, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsObjects=upsObjects, PositiveInteger=PositiveInteger, upsOutputLineIndex=upsOutputLineIndex, upsAlarmInputBad=upsAlarmInputBad, upsTrapTestCompleted=upsTrapTestCompleted, upsGroups=upsGroups, upsOutputEntry=upsOutputEntry, upsConfigOutputFreq=upsConfigOutputFreq, upsBypassTable=upsBypassTable, upsBypass=upsBypass, upsFullConfigGroup=upsFullConfigGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsMIB=upsMIB, upsIdentManufacturer=upsIdentManufacturer, upsBasicGroups=upsBasicGroups, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, PYSNMP_MODULE_ID=upsMIB, upsInputFrequency=upsInputFrequency, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmBatteryBad=upsAlarmBatteryBad, upsOutputPower=upsOutputPower, upsFullBatteryGroup=upsFullBatteryGroup, upsOutputFrequency=upsOutputFrequency, upsAlarmTime=upsAlarmTime, upsTestElapsedTime=upsTestElapsedTime, upsBasicCompliance=upsBasicCompliance, upsBypassEntry=upsBypassEntry, upsTestStartTime=upsTestStartTime, upsSubsetIdentGroup=upsSubsetIdentGroup, upsSubsetCompliance=upsSubsetCompliance, upsInputLineBads=upsInputLineBads, upsAlarmOutputBad=upsAlarmOutputBad, upsIdentName=upsIdentName, upsAlarmTempBad=upsAlarmTempBad, upsSubsetControlGroup=upsSubsetControlGroup, upsCompliances=upsCompliances, upsAlarmGeneralFault=upsAlarmGeneralFault, upsFullAlarmGroup=upsFullAlarmGroup, upsInputNumLines=upsInputNumLines, upsInputTable=upsInputTable, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBasicOutputGroup=upsBasicOutputGroup, upsInputLineIndex=upsInputLineIndex, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsWellKnownTests=upsWellKnownTests, upsTraps=upsTraps, upsBypassLineIndex=upsBypassLineIndex, upsStartupAfterDelay=upsStartupAfterDelay, upsSubsetConfigGroup=upsSubsetConfigGroup, upsConformance=upsConformance, upsInputVoltage=upsInputVoltage, upsRebootWithDuration=upsRebootWithDuration, upsAlarmTestInProgress=upsAlarmTestInProgress, upsOutputNumLines=upsOutputNumLines, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsConfigAudibleStatus=upsConfigAudibleStatus, upsControl=upsControl, upsAlarmChargerFailed=upsAlarmChargerFailed, upsTest=upsTest, upsSubsetGroups=upsSubsetGroups, upsConfig=upsConfig, upsAlarmOnBattery=upsAlarmOnBattery, upsConfigInputFreq=upsConfigInputFreq, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmTable=upsAlarmTable, upsBypassPower=upsBypassPower, upsBasicBypassGroup=upsBasicBypassGroup, upsFullIdentGroup=upsFullIdentGroup, upsBypassNumLines=upsBypassNumLines, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsBasicConfigGroup=upsBasicConfigGroup, upsInputCurrent=upsInputCurrent, upsAlarmId=upsAlarmId, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmDescr=upsAlarmDescr, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsInputEntry=upsInputEntry, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBatteryVoltage=upsBatteryVoltage, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBasicControlGroup=upsBasicControlGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining)
