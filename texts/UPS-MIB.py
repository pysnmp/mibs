...
mibBuilder.exportSymbols("UPS-MIB", upsSecondsOnBattery=upsSecondsOnBattery, upsIdentManufacturer=upsIdentManufacturer, upsBasicOutputGroup=upsBasicOutputGroup, upsIdent=upsIdent, upsFullInputGroup=upsFullInputGroup, upsBypassTable=upsBypassTable, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBattery=upsBattery, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsSubsetGroups=upsSubsetGroups, upsConfigOutputFreq=upsConfigOutputFreq, upsBypassCurrent=upsBypassCurrent, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsOutputEntry=upsOutputEntry, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsGroups=upsGroups, upsInputNumLines=upsInputNumLines, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBypass=upsBypass, upsBypassNumLines=upsBypassNumLines, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmEntry=upsAlarmEntry, upsFullOutputGroup=upsFullOutputGroup, upsFullBypassGroup=upsFullBypassGroup, upsBasicCompliance=upsBasicCompliance, upsFullConfigGroup=upsFullConfigGroup, upsTest=upsTest, upsTestElapsedTime=upsTestElapsedTime, PYSNMP_MODULE_ID=upsMIB, upsTestSpinLock=upsTestSpinLock, upsOutputLineIndex=upsOutputLineIndex, upsAlarmDescr=upsAlarmDescr, upsConfig=upsConfig, upsFullCompliance=upsFullCompliance, upsBasicAlarmGroup=upsBasicAlarmGroup, upsInput=upsInput, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBypassVoltage=upsBypassVoltage, upsRebootWithDuration=upsRebootWithDuration, upsFullControlGroup=upsFullControlGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsControl=upsControl, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmOutputBad=upsAlarmOutputBad, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBatteryCurrent=upsBatteryCurrent, upsOutputFrequency=upsOutputFrequency, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsWellKnownAlarms=upsWellKnownAlarms, upsAutoRestart=upsAutoRestart, upsAlarm=upsAlarm, upsSubsetConfigGroup=upsSubsetConfigGroup, upsOutput=upsOutput, upsTestResultsSummary=upsTestResultsSummary, upsOutputPercentLoad=upsOutputPercentLoad, upsConfigInputVoltage=upsConfigInputVoltage, upsConfigOutputVA=upsConfigOutputVA, upsOutputNumLines=upsOutputNumLines, upsBasicInputGroup=upsBasicInputGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsInputFrequency=upsInputFrequency, upsConfigLowBattTime=upsConfigLowBattTime, upsSubsetIdentGroup=upsSubsetIdentGroup, upsConfigInputFreq=upsConfigInputFreq, upsAlarmChargerFailed=upsAlarmChargerFailed, upsOutputTable=upsOutputTable, upsTrapOnBattery=upsTrapOnBattery, NonNegativeInteger=NonNegativeInteger, upsTrapTestCompleted=upsTrapTestCompleted, PositiveInteger=PositiveInteger, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmTable=upsAlarmTable, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBasicControlGroup=upsBasicControlGroup, upsConfigOutputPower=upsConfigOutputPower, upsAlarmOnBattery=upsAlarmOnBattery, upsInputLineIndex=upsInputLineIndex, upsCompliances=upsCompliances, upsBatteryVoltage=upsBatteryVoltage, upsFullBatteryGroup=upsFullBatteryGroup, upsFullIdentGroup=upsFullIdentGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutputPower=upsOutputPower, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmTempBad=upsAlarmTempBad, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsIdentName=upsIdentName, upsBasicTestGroup=upsBasicTestGroup, upsShutdownType=upsShutdownType, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsSubsetCompliance=upsSubsetCompliance, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBasicGroups=upsBasicGroups, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBypassLineIndex=upsBypassLineIndex, upsBypassPower=upsBypassPower, upsBatteryTemperature=upsBatteryTemperature, upsConfigOutputVoltage=upsConfigOutputVoltage, upsInputLineBads=upsInputLineBads, upsInputCurrent=upsInputCurrent, upsBasicIdentGroup=upsBasicIdentGroup, upsOutputCurrent=upsOutputCurrent, upsTraps=upsTraps, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmLowBattery=upsAlarmLowBattery, upsOutputVoltage=upsOutputVoltage, upsSubsetControlGroup=upsSubsetControlGroup, upsFullGroups=upsFullGroups, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsFullAlarmGroup=upsFullAlarmGroup, upsConformance=upsConformance, upsTestId=upsTestId, upsMIB=upsMIB, upsWellKnownTests=upsWellKnownTests, upsInputTruePower=upsInputTruePower, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmTime=upsAlarmTime, upsBypassEntry=upsBypassEntry, upsInputTable=upsInputTable, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmShutdownPending=upsAlarmShutdownPending, upsFullTestGroup=upsFullTestGroup, upsAlarmInputBad=upsAlarmInputBad, upsObjects=upsObjects, upsTestResultsDetail=upsTestResultsDetail, upsBypassFrequency=upsBypassFrequency, upsInputVoltage=upsInputVoltage, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsSubsetInputGroup=upsSubsetInputGroup, upsBatteryStatus=upsBatteryStatus, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestStartTime=upsTestStartTime, upsAlarmId=upsAlarmId, upsAlarmsPresent=upsAlarmsPresent, upsOutputSource=upsOutputSource, upsShutdownAfterDelay=upsShutdownAfterDelay, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsStartupAfterDelay=upsStartupAfterDelay, upsSubsetOutputGroup=upsSubsetOutputGroup, upsIdentModel=upsIdentModel, upsInputEntry=upsInputEntry, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved)
