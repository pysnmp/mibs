...
# Produced by pysmi-1.1.12 at Tue Jun  4 07:46:15 2024
...
NotificationType, ObjectIdentity, TimeTicks, Integer32, Counter32, Bits, ModuleIdentity, Gauge32, Counter64, Unsigned32, mib_2, IpAddress, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "TimeTicks", "Integer32", "Counter32", "Bits", "ModuleIdentity", "Gauge32", "Counter64", "Unsigned32", "mib-2", "IpAddress", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TimeStamp, DisplayString, TextualConvention, TestAndIncr, TimeInterval, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "TextualConvention", "TestAndIncr", "TimeInterval", "AutonomousType")
...
mibBuilder.exportSymbols("UPS-MIB", upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmChargerFailed=upsAlarmChargerFailed, upsInputFrequency=upsInputFrequency, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmOnBattery=upsAlarmOnBattery, upsBasicTestGroup=upsBasicTestGroup, upsMIB=upsMIB, upsFullTestGroup=upsFullTestGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmBypassBad=upsAlarmBypassBad, PYSNMP_MODULE_ID=upsMIB, upsWellKnownTests=upsWellKnownTests, upsConfig=upsConfig, upsTestResultsDetail=upsTestResultsDetail, upsOutputSource=upsOutputSource, upsIdentModel=upsIdentModel, upsBypassFrequency=upsBypassFrequency, upsFullIdentGroup=upsFullIdentGroup, upsTest=upsTest, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsGroups=upsGroups, upsFullGroups=upsFullGroups, upsInputCurrent=upsInputCurrent, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsInputEntry=upsInputEntry, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmInputBad=upsAlarmInputBad, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBypassCurrent=upsBypassCurrent, upsAlarmId=upsAlarmId, upsShutdownType=upsShutdownType, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTrapTestCompleted=upsTrapTestCompleted, NonNegativeInteger=NonNegativeInteger, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsInputLineIndex=upsInputLineIndex, upsBasicGroups=upsBasicGroups, upsBatteryStatus=upsBatteryStatus, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsOutputPower=upsOutputPower, upsBypass=upsBypass, upsStartupAfterDelay=upsStartupAfterDelay, upsInputTruePower=upsInputTruePower, upsAlarmOnBypass=upsAlarmOnBypass, upsSubsetControlGroup=upsSubsetControlGroup, upsConfigOutputPower=upsConfigOutputPower, upsInputLineBads=upsInputLineBads, upsFullOutputGroup=upsFullOutputGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBatteryVoltage=upsBatteryVoltage, upsIdentManufacturer=upsIdentManufacturer, upsBypassNumLines=upsBypassNumLines, upsOutputVoltage=upsOutputVoltage, upsBatteryCurrent=upsBatteryCurrent, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsInputNumLines=upsInputNumLines, upsInputTable=upsInputTable, upsAlarmTable=upsAlarmTable, upsAlarmShutdownPending=upsAlarmShutdownPending, upsRebootWithDuration=upsRebootWithDuration, upsOutputLineIndex=upsOutputLineIndex, upsAlarmDescr=upsAlarmDescr, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTestElapsedTime=upsTestElapsedTime, upsTestResultsSummary=upsTestResultsSummary, upsAlarmOutputBad=upsAlarmOutputBad, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBasicConfigGroup=upsBasicConfigGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTrapOnBattery=upsTrapOnBattery, upsTestId=upsTestId, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTestSpinLock=upsTestSpinLock, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarm=upsAlarm, upsSubsetCompliance=upsSubsetCompliance, upsOutput=upsOutput, upsConformance=upsConformance, upsAlarmsPresent=upsAlarmsPresent, upsSubsetOutputGroup=upsSubsetOutputGroup, upsOutputFrequency=upsOutputFrequency, upsBypassTable=upsBypassTable, upsFullInputGroup=upsFullInputGroup, upsIdentName=upsIdentName, upsFullConfigGroup=upsFullConfigGroup, upsFullCompliance=upsFullCompliance, upsObjects=upsObjects, upsTestStartTime=upsTestStartTime, upsConfigLowBattTime=upsConfigLowBattTime, upsBypassEntry=upsBypassEntry, upsOutputCurrent=upsOutputCurrent, upsFullBypassGroup=upsFullBypassGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBypassPower=upsBypassPower, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsIdent=upsIdent, upsAutoRestart=upsAutoRestart, upsInput=upsInput, upsSubsetGroups=upsSubsetGroups, upsBasicCompliance=upsBasicCompliance, upsBasicOutputGroup=upsBasicOutputGroup, upsOutputNumLines=upsOutputNumLines, upsControl=upsControl, upsConfigOutputVA=upsConfigOutputVA, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBasicInputGroup=upsBasicInputGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsWellKnownAlarms=upsWellKnownAlarms, upsFullControlGroup=upsFullControlGroup, upsInputVoltage=upsInputVoltage, upsOutputEntry=upsOutputEntry, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBypassVoltage=upsBypassVoltage, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmTempBad=upsAlarmTempBad, upsShutdownAfterDelay=upsShutdownAfterDelay, upsFullAlarmGroup=upsFullAlarmGroup, upsBypassLineIndex=upsBypassLineIndex, upsOutputTable=upsOutputTable, upsBattery=upsBattery, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsConfigInputFreq=upsConfigInputFreq, upsSubsetInputGroup=upsSubsetInputGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTraps=upsTraps, upsAlarmEntry=upsAlarmEntry, upsBatteryTemperature=upsBatteryTemperature, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, PositiveInteger=PositiveInteger, upsSecondsOnBattery=upsSecondsOnBattery, upsCompliances=upsCompliances, upsAlarmTime=upsAlarmTime, upsBasicControlGroup=upsBasicControlGroup)
