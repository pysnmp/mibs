...
mibBuilder.exportSymbols("UPS-MIB", upsStartupAfterDelay=upsStartupAfterDelay, upsBypassCurrent=upsBypassCurrent, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarm=upsAlarm, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmLowBattery=upsAlarmLowBattery, upsBypassLineIndex=upsBypassLineIndex, upsBatteryVoltage=upsBatteryVoltage, upsFullConfigGroup=upsFullConfigGroup, upsBypassNumLines=upsBypassNumLines, upsInput=upsInput, upsSubsetGroups=upsSubsetGroups, upsAlarmFanFailure=upsAlarmFanFailure, upsTestResultsSummary=upsTestResultsSummary, upsOutputPower=upsOutputPower, upsBasicBypassGroup=upsBasicBypassGroup, upsOutputNumLines=upsOutputNumLines, upsSubsetIdentGroup=upsSubsetIdentGroup, upsInputLineIndex=upsInputLineIndex, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTest=upsTest, upsTestResultsDetail=upsTestResultsDetail, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicCompliance=upsBasicCompliance, upsIdentModel=upsIdentModel, upsFullBypassGroup=upsFullBypassGroup, PositiveInteger=PositiveInteger, upsConfigAudibleStatus=upsConfigAudibleStatus, upsGroups=upsGroups, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsMIB=upsMIB, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsShutdownType=upsShutdownType, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmTime=upsAlarmTime, upsRebootWithDuration=upsRebootWithDuration, upsObjects=upsObjects, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmOnBypass=upsAlarmOnBypass, upsConfig=upsConfig, PYSNMP_MODULE_ID=upsMIB, upsFullTestGroup=upsFullTestGroup, upsConformance=upsConformance, upsInputTruePower=upsInputTruePower, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsIdentManufacturer=upsIdentManufacturer, upsBatteryTemperature=upsBatteryTemperature, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsCompliances=upsCompliances, upsBasicBatteryGroup=upsBasicBatteryGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsSubsetInputGroup=upsSubsetInputGroup, upsIdentName=upsIdentName, upsInputTable=upsInputTable, upsAutoRestart=upsAutoRestart, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmTempBad=upsAlarmTempBad, upsConfigInputFreq=upsConfigInputFreq, upsFullOutputGroup=upsFullOutputGroup, upsFullInputGroup=upsFullInputGroup, upsBattery=upsBattery, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmInputBad=upsAlarmInputBad, upsTestSpinLock=upsTestSpinLock, upsBasicOutputGroup=upsBasicOutputGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmId=upsAlarmId, upsAlarmFuseFailure=upsAlarmFuseFailure, upsConfigOutputVoltage=upsConfigOutputVoltage, upsOutputCurrent=upsOutputCurrent, upsBasicTestGroup=upsBasicTestGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsSubsetConfigGroup=upsSubsetConfigGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsSubsetCompliance=upsSubsetCompliance, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsOutputTable=upsOutputTable, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsConfigOutputPower=upsConfigOutputPower, upsInputNumLines=upsInputNumLines, upsInputFrequency=upsInputFrequency, upsInputVoltage=upsInputVoltage, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmOutputOverload=upsAlarmOutputOverload, upsOutputSource=upsOutputSource, upsConfigLowBattTime=upsConfigLowBattTime, upsInputCurrent=upsInputCurrent, upsShutdownAfterDelay=upsShutdownAfterDelay, upsIdentAttachedDevices=upsIdentAttachedDevices, upsOutputFrequency=upsOutputFrequency, upsTestElapsedTime=upsTestElapsedTime, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBypass=upsBypass, upsConfigOutputVA=upsConfigOutputVA, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmsPresent=upsAlarmsPresent, upsBypassVoltage=upsBypassVoltage, upsFullGroups=upsFullGroups, upsAlarmBatteryBad=upsAlarmBatteryBad, upsConfigOutputFreq=upsConfigOutputFreq, upsTrapTestCompleted=upsTrapTestCompleted, upsBasicControlGroup=upsBasicControlGroup, upsBypassEntry=upsBypassEntry, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBasicInputGroup=upsBasicInputGroup, upsOutputVoltage=upsOutputVoltage, upsTestId=upsTestId, upsFullIdentGroup=upsFullIdentGroup, upsAlarmTable=upsAlarmTable, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBypassTable=upsBypassTable, upsBatteryCurrent=upsBatteryCurrent, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmBypassBad=upsAlarmBypassBad, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsInputEntry=upsInputEntry, upsConfigInputVoltage=upsConfigInputVoltage, upsTrapOnBattery=upsTrapOnBattery, upsAlarmShutdownPending=upsAlarmShutdownPending, upsFullCompliance=upsFullCompliance, upsBypassFrequency=upsBypassFrequency, upsOutputLineIndex=upsOutputLineIndex, upsAlarmDescr=upsAlarmDescr, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsTraps=upsTraps, upsBasicGroups=upsBasicGroups, upsWellKnownTests=upsWellKnownTests, NonNegativeInteger=NonNegativeInteger, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsInputLineBads=upsInputLineBads, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBypassPower=upsBypassPower, upsFullControlGroup=upsFullControlGroup, upsControl=upsControl, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmEntry=upsAlarmEntry, upsOutputEntry=upsOutputEntry, upsBatteryStatus=upsBatteryStatus, upsIdent=upsIdent, upsOutput=upsOutput, upsTestStartTime=upsTestStartTime)
