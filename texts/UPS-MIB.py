...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, mib_2, TimeTicks, Bits, ObjectIdentity, Integer32, Unsigned32, Gauge32, IpAddress, iso, MibIdentifier, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "mib-2", "TimeTicks", "Bits", "ObjectIdentity", "Integer32", "Unsigned32", "Gauge32", "IpAddress", "iso", "MibIdentifier", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("UPS-MIB", upsWellKnownAlarms=upsWellKnownAlarms, upsObjects=upsObjects, upsTrapTestCompleted=upsTrapTestCompleted, upsFullCompliance=upsFullCompliance, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsIdentModel=upsIdentModel, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsOutputCurrent=upsOutputCurrent, upsOutputPower=upsOutputPower, upsBasicBypassGroup=upsBasicBypassGroup, upsFullConfigGroup=upsFullConfigGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmOnBypass=upsAlarmOnBypass, PYSNMP_MODULE_ID=upsMIB, upsTraps=upsTraps, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarm=upsAlarm, upsBasicControlGroup=upsBasicControlGroup, upsInputEntry=upsInputEntry, upsOutputLineIndex=upsOutputLineIndex, upsAlarmTempBad=upsAlarmTempBad, upsOutputFrequency=upsOutputFrequency, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsInputLineIndex=upsInputLineIndex, upsInput=upsInput, upsAlarmLowBattery=upsAlarmLowBattery, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBypassTable=upsBypassTable, upsFullInputGroup=upsFullInputGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsOutputNumLines=upsOutputNumLines, upsBasicIdentGroup=upsBasicIdentGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTestStartTime=upsTestStartTime, upsAlarmBatteryBad=upsAlarmBatteryBad, upsInputTruePower=upsInputTruePower, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsInputCurrent=upsInputCurrent, upsAlarmId=upsAlarmId, upsBattery=upsBattery, upsBatteryCurrent=upsBatteryCurrent, upsBypass=upsBypass, upsOutputTable=upsOutputTable, upsOutputVoltage=upsOutputVoltage, upsAutoRestart=upsAutoRestart, PositiveInteger=PositiveInteger, upsConformance=upsConformance, upsConfigLowBattTime=upsConfigLowBattTime, upsBypassLineIndex=upsBypassLineIndex, upsInputVoltage=upsInputVoltage, upsShutdownType=upsShutdownType, upsConfigAudibleStatus=upsConfigAudibleStatus, upsSubsetCompliance=upsSubsetCompliance, upsGroups=upsGroups, upsAlarmChargerFailed=upsAlarmChargerFailed, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsIdentName=upsIdentName, upsInputLineBads=upsInputLineBads, upsAlarmTable=upsAlarmTable, upsFullBypassGroup=upsFullBypassGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsFullControlGroup=upsFullControlGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsInputNumLines=upsInputNumLines, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullOutputGroup=upsFullOutputGroup, upsConfig=upsConfig, upsConfigInputFreq=upsConfigInputFreq, upsOutputPercentLoad=upsOutputPercentLoad, upsBasicGroups=upsBasicGroups, upsBasicCompliance=upsBasicCompliance, upsBypassPower=upsBypassPower, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsSecondsOnBattery=upsSecondsOnBattery, upsOutputEntry=upsOutputEntry, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTrapOnBattery=upsTrapOnBattery, upsFullIdentGroup=upsFullIdentGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBasicTestGroup=upsBasicTestGroup, upsCompliances=upsCompliances, upsOutput=upsOutput, upsSubsetControlGroup=upsSubsetControlGroup, upsInputTable=upsInputTable, upsAlarmFanFailure=upsAlarmFanFailure, upsInputFrequency=upsInputFrequency, upsSubsetInputGroup=upsSubsetInputGroup, upsMIB=upsMIB, upsRebootWithDuration=upsRebootWithDuration, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsSubsetGroups=upsSubsetGroups, upsAlarmEntry=upsAlarmEntry, upsConfigOutputPower=upsConfigOutputPower, upsBasicOutputGroup=upsBasicOutputGroup, upsTestId=upsTestId, upsTestResultsDetail=upsTestResultsDetail, upsAlarmsPresent=upsAlarmsPresent, upsBasicInputGroup=upsBasicInputGroup, upsAlarmDescr=upsAlarmDescr, upsBypassNumLines=upsBypassNumLines, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTestSpinLock=upsTestSpinLock, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsBypassEntry=upsBypassEntry, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmOnBattery=upsAlarmOnBattery, upsIdent=upsIdent, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBatteryVoltage=upsBatteryVoltage, upsOutputSource=upsOutputSource, upsTest=upsTest, upsBypassFrequency=upsBypassFrequency, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsControl=upsControl, upsConfigOutputVoltage=upsConfigOutputVoltage, upsConfigOutputVA=upsConfigOutputVA, NonNegativeInteger=NonNegativeInteger, upsFullTestGroup=upsFullTestGroup, upsBatteryTemperature=upsBatteryTemperature, upsAlarmGeneralFault=upsAlarmGeneralFault, upsIdentManufacturer=upsIdentManufacturer, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmTime=upsAlarmTime, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmInputBad=upsAlarmInputBad, upsWellKnownTests=upsWellKnownTests, upsStartupAfterDelay=upsStartupAfterDelay, upsBypassVoltage=upsBypassVoltage, upsAlarmOutputOverload=upsAlarmOutputOverload, upsFullBatteryGroup=upsFullBatteryGroup, upsBypassCurrent=upsBypassCurrent, upsFullAlarmGroup=upsFullAlarmGroup, upsBatteryStatus=upsBatteryStatus, upsSubsetIdentGroup=upsSubsetIdentGroup, upsFullGroups=upsFullGroups, upsSubsetOutputGroup=upsSubsetOutputGroup, upsTestElapsedTime=upsTestElapsedTime, upsTestResultsSummary=upsTestResultsSummary)
