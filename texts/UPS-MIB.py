...
mibBuilder.exportSymbols("UPS-MIB", upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmLowBattery=upsAlarmLowBattery, upsInput=upsInput, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmOnBattery=upsAlarmOnBattery, upsConfigOutputFreq=upsConfigOutputFreq, PYSNMP_MODULE_ID=upsMIB, upsOutputSource=upsOutputSource, upsBatteryVoltage=upsBatteryVoltage, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmsPresent=upsAlarmsPresent, upsInputFrequency=upsInputFrequency, upsConformance=upsConformance, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarm=upsAlarm, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBattery=upsBattery, upsIdent=upsIdent, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmEntry=upsAlarmEntry, upsTraps=upsTraps, upsGroups=upsGroups, upsMIB=upsMIB, upsTestResultsDetail=upsTestResultsDetail, upsInputEntry=upsInputEntry, upsInputNumLines=upsInputNumLines, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsInputTruePower=upsInputTruePower, upsBypassVoltage=upsBypassVoltage, upsShutdownAfterDelay=upsShutdownAfterDelay, upsSubsetOutputGroup=upsSubsetOutputGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsFullCompliance=upsFullCompliance, upsInputVoltage=upsInputVoltage, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsOutputVoltage=upsOutputVoltage, upsAlarmTestInProgress=upsAlarmTestInProgress, upsControl=upsControl, upsBatteryTemperature=upsBatteryTemperature, upsAlarmDescr=upsAlarmDescr, upsAlarmBypassBad=upsAlarmBypassBad, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsTest=upsTest, upsConfigInputFreq=upsConfigInputFreq, upsInputTable=upsInputTable, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsRebootWithDuration=upsRebootWithDuration, upsFullIdentGroup=upsFullIdentGroup, upsCompliances=upsCompliances, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBasicGroups=upsBasicGroups, upsFullBatteryGroup=upsFullBatteryGroup, upsBypassPower=upsBypassPower, upsStartupAfterDelay=upsStartupAfterDelay, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBasicControlGroup=upsBasicControlGroup, upsTestSpinLock=upsTestSpinLock, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmTime=upsAlarmTime, upsBasicOutputGroup=upsBasicOutputGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsIdentName=upsIdentName, upsTestStartTime=upsTestStartTime, upsAlarmTable=upsAlarmTable, upsTrapTestCompleted=upsTrapTestCompleted, upsTestId=upsTestId, upsAlarmChargerFailed=upsAlarmChargerFailed, upsOutputEntry=upsOutputEntry, PositiveInteger=PositiveInteger, upsWellKnownAlarms=upsWellKnownAlarms, upsFullTestGroup=upsFullTestGroup, upsFullControlGroup=upsFullControlGroup, upsConfigOutputPower=upsConfigOutputPower, upsBypassEntry=upsBypassEntry, upsFullInputGroup=upsFullInputGroup, upsFullGroups=upsFullGroups, upsInputCurrent=upsInputCurrent, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBasicCompliance=upsBasicCompliance, upsTestResultsSummary=upsTestResultsSummary, upsConfig=upsConfig, upsConfigInputVoltage=upsConfigInputVoltage, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsOutputPercentLoad=upsOutputPercentLoad, upsSubsetControlGroup=upsSubsetControlGroup, upsOutputCurrent=upsOutputCurrent, upsBypassNumLines=upsBypassNumLines, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBypassCurrent=upsBypassCurrent, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmFanFailure=upsAlarmFanFailure, upsTrapOnBattery=upsTrapOnBattery, upsSubsetGroups=upsSubsetGroups, upsAlarmInputBad=upsAlarmInputBad, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsOutputTable=upsOutputTable, upsOutput=upsOutput, upsFullConfigGroup=upsFullConfigGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsInputLineIndex=upsInputLineIndex, upsAutoRestart=upsAutoRestart, upsShutdownType=upsShutdownType, upsConfigOutputVA=upsConfigOutputVA, upsObjects=upsObjects, upsAlarmOutputOverload=upsAlarmOutputOverload, upsOutputNumLines=upsOutputNumLines, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBasicInputGroup=upsBasicInputGroup, upsBypassLineIndex=upsBypassLineIndex, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmOnBypass=upsAlarmOnBypass, upsSubsetInputGroup=upsSubsetInputGroup, upsOutputLineIndex=upsOutputLineIndex, upsWellKnownTests=upsWellKnownTests, upsBypassTable=upsBypassTable, upsBasicTestGroup=upsBasicTestGroup, upsFullBypassGroup=upsFullBypassGroup, upsInputLineBads=upsInputLineBads, upsAlarmGeneralFault=upsAlarmGeneralFault, upsFullAlarmGroup=upsFullAlarmGroup, upsOutputFrequency=upsOutputFrequency, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmId=upsAlarmId, upsAlarmOutputBad=upsAlarmOutputBad, upsTestElapsedTime=upsTestElapsedTime, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBasicIdentGroup=upsBasicIdentGroup, upsFullOutputGroup=upsFullOutputGroup, upsBypass=upsBypass, upsIdentManufacturer=upsIdentManufacturer, upsIdentModel=upsIdentModel, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsSecondsOnBattery=upsSecondsOnBattery, upsBasicConfigGroup=upsBasicConfigGroup, NonNegativeInteger=NonNegativeInteger, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigAudibleStatus=upsConfigAudibleStatus, upsSubsetCompliance=upsSubsetCompliance, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmTempBad=upsAlarmTempBad, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBypassFrequency=upsBypassFrequency, upsOutputPower=upsOutputPower, upsBatteryStatus=upsBatteryStatus, upsBatteryCurrent=upsBatteryCurrent)
