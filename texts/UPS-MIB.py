...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:56:18 2023
...
ObjectIdentity, IpAddress, mib_2, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, MibIdentifier, Counter64, NotificationType, TimeTicks, Integer32, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "mib-2", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "MibIdentifier", "Counter64", "NotificationType", "TimeTicks", "Integer32", "Counter32", "ModuleIdentity")
TestAndIncr, TextualConvention, TimeStamp, DisplayString, TimeInterval, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TextualConvention", "TimeStamp", "DisplayString", "TimeInterval", "AutonomousType")
...
mibBuilder.exportSymbols("UPS-MIB", upsConfigOutputPower=upsConfigOutputPower, upsStartupAfterDelay=upsStartupAfterDelay, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBatteryStatus=upsBatteryStatus, upsTestSpinLock=upsTestSpinLock, upsSubsetGroups=upsSubsetGroups, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBasicIdentGroup=upsBasicIdentGroup, upsTestId=upsTestId, upsAlarmInputBad=upsAlarmInputBad, upsInputNumLines=upsInputNumLines, upsIdentManufacturer=upsIdentManufacturer, upsInputTable=upsInputTable, upsConfigInputVoltage=upsConfigInputVoltage, upsConfigLowBattTime=upsConfigLowBattTime, upsFullConfigGroup=upsFullConfigGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmTime=upsAlarmTime, upsMIB=upsMIB, upsOutput=upsOutput, upsConfig=upsConfig, upsInputTruePower=upsInputTruePower, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsControl=upsControl, upsBasicInputGroup=upsBasicInputGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBypassCurrent=upsBypassCurrent, upsOutputSource=upsOutputSource, NonNegativeInteger=NonNegativeInteger, upsBatteryTemperature=upsBatteryTemperature, upsCompliances=upsCompliances, upsBasicCompliance=upsBasicCompliance, upsFullInputGroup=upsFullInputGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsSubsetControlGroup=upsSubsetControlGroup, upsIdent=upsIdent, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmOutputBad=upsAlarmOutputBad, upsWellKnownTests=upsWellKnownTests, upsAlarmTestInProgress=upsAlarmTestInProgress, upsIdentName=upsIdentName, upsTestResultsDetail=upsTestResultsDetail, upsAlarmId=upsAlarmId, upsFullOutputGroup=upsFullOutputGroup, upsOutputNumLines=upsOutputNumLines, upsAlarmOnBypass=upsAlarmOnBypass, upsBasicTestGroup=upsBasicTestGroup, upsBypassFrequency=upsBypassFrequency, upsConfigOutputFreq=upsConfigOutputFreq, upsOutputVoltage=upsOutputVoltage, upsConformance=upsConformance, upsInputLineBads=upsInputLineBads, upsBattery=upsBattery, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTestElapsedTime=upsTestElapsedTime, upsOutputTable=upsOutputTable, upsSubsetCompliance=upsSubsetCompliance, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTestResultsSummary=upsTestResultsSummary, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmShutdownPending=upsAlarmShutdownPending, PYSNMP_MODULE_ID=upsMIB, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarm=upsAlarm, upsAlarmEntry=upsAlarmEntry, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsOutputLineIndex=upsOutputLineIndex, upsBatteryCurrent=upsBatteryCurrent, upsOutputPercentLoad=upsOutputPercentLoad, upsInputLineIndex=upsInputLineIndex, upsFullGroups=upsFullGroups, upsTrapTestCompleted=upsTrapTestCompleted, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsTestStartTime=upsTestStartTime, upsOutputFrequency=upsOutputFrequency, upsObjects=upsObjects, upsBypass=upsBypass, upsShutdownType=upsShutdownType, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmsPresent=upsAlarmsPresent, upsFullBypassGroup=upsFullBypassGroup, upsInputEntry=upsInputEntry, upsAlarmTempBad=upsAlarmTempBad, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmDescr=upsAlarmDescr, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsFullCompliance=upsFullCompliance, upsFullIdentGroup=upsFullIdentGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmTable=upsAlarmTable, upsOutputPower=upsOutputPower, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBasicOutputGroup=upsBasicOutputGroup, upsBasicControlGroup=upsBasicControlGroup, upsBypassPower=upsBypassPower, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBasicBypassGroup=upsBasicBypassGroup, PositiveInteger=PositiveInteger, upsBypassVoltage=upsBypassVoltage, upsFullTestGroup=upsFullTestGroup, upsBatteryVoltage=upsBatteryVoltage, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBypassEntry=upsBypassEntry, upsBasicGroups=upsBasicGroups, upsIdentAttachedDevices=upsIdentAttachedDevices, upsInput=upsInput, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsConfigOutputVA=upsConfigOutputVA, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsGroups=upsGroups, upsAlarmOutputOverload=upsAlarmOutputOverload, upsInputCurrent=upsInputCurrent, upsWellKnownAlarms=upsWellKnownAlarms, upsBypassNumLines=upsBypassNumLines, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTrapOnBattery=upsTrapOnBattery, upsFullControlGroup=upsFullControlGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigInputFreq=upsConfigInputFreq, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmLowBattery=upsAlarmLowBattery, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBypassLineIndex=upsBypassLineIndex, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicConfigGroup=upsBasicConfigGroup, upsBypassTable=upsBypassTable, upsSubsetInputGroup=upsSubsetInputGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsIdentModel=upsIdentModel, upsTraps=upsTraps, upsSubsetOutputGroup=upsSubsetOutputGroup, upsOutputEntry=upsOutputEntry, upsAutoRestart=upsAutoRestart, upsSubsetIdentGroup=upsSubsetIdentGroup, upsInputFrequency=upsInputFrequency, upsRebootWithDuration=upsRebootWithDuration, upsInputVoltage=upsInputVoltage, upsOutputCurrent=upsOutputCurrent, upsTest=upsTest, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested)
