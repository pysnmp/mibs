...
# Produced by pysmi-1.1.8 at Tue Sep 12 13:28:08 2023
...
mib_2, MibIdentifier, ObjectIdentity, NotificationType, Unsigned32, Counter32, ModuleIdentity, Gauge32, Bits, iso, TimeTicks, Counter64, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "MibIdentifier", "ObjectIdentity", "NotificationType", "Unsigned32", "Counter32", "ModuleIdentity", "Gauge32", "Bits", "iso", "TimeTicks", "Counter64", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("UPS-MIB", upsSubsetIdentGroup=upsSubsetIdentGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsObjects=upsObjects, upsSubsetGroups=upsSubsetGroups, upsBatteryStatus=upsBatteryStatus, upsInputLineIndex=upsInputLineIndex, upsAlarmInputBad=upsAlarmInputBad, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsConfigOutputVoltage=upsConfigOutputVoltage, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsSecondsOnBattery=upsSecondsOnBattery, upsInputTable=upsInputTable, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsSubsetControlGroup=upsSubsetControlGroup, upsConfigOutputPower=upsConfigOutputPower, upsConfigInputFreq=upsConfigInputFreq, upsFullOutputGroup=upsFullOutputGroup, upsOutputNumLines=upsOutputNumLines, upsBypassFrequency=upsBypassFrequency, upsFullGroups=upsFullGroups, upsAlarmChargerFailed=upsAlarmChargerFailed, upsInputEntry=upsInputEntry, upsBasicConfigGroup=upsBasicConfigGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsMIB=upsMIB, upsAlarmFuseFailure=upsAlarmFuseFailure, upsOutputPower=upsOutputPower, upsBypassLineIndex=upsBypassLineIndex, upsAlarmFanFailure=upsAlarmFanFailure, PYSNMP_MODULE_ID=upsMIB, upsInputTruePower=upsInputTruePower, upsInputFrequency=upsInputFrequency, upsBasicTestGroup=upsBasicTestGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsOutputSource=upsOutputSource, upsInputCurrent=upsInputCurrent, upsOutputFrequency=upsOutputFrequency, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBatteryCurrent=upsBatteryCurrent, upsTestSpinLock=upsTestSpinLock, upsBasicCompliance=upsBasicCompliance, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmEntry=upsAlarmEntry, upsAlarmId=upsAlarmId, upsTestResultsSummary=upsTestResultsSummary, upsTestElapsedTime=upsTestElapsedTime, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsTestId=upsTestId, upsIdentManufacturer=upsIdentManufacturer, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTraps=upsTraps, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsFullBypassGroup=upsFullBypassGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsConfigOutputFreq=upsConfigOutputFreq, upsAutoRestart=upsAutoRestart, upsInputVoltage=upsInputVoltage, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmBatteryBad=upsAlarmBatteryBad, upsOutputEntry=upsOutputEntry, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsOutputTable=upsOutputTable, upsBypassEntry=upsBypassEntry, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsIdentModel=upsIdentModel, upsAlarm=upsAlarm, upsSubsetCompliance=upsSubsetCompliance, upsConfigOutputVA=upsConfigOutputVA, upsFullInputGroup=upsFullInputGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmOnBattery=upsAlarmOnBattery, upsGroups=upsGroups, upsFullIdentGroup=upsFullIdentGroup, upsOutputCurrent=upsOutputCurrent, upsBatteryTemperature=upsBatteryTemperature, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTestStartTime=upsTestStartTime, upsRebootWithDuration=upsRebootWithDuration, upsOutputPercentLoad=upsOutputPercentLoad, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmsPresent=upsAlarmsPresent, upsIdent=upsIdent, upsBasicInputGroup=upsBasicInputGroup, upsTestResultsDetail=upsTestResultsDetail, upsControl=upsControl, upsTrapOnBattery=upsTrapOnBattery, upsBasicOutputGroup=upsBasicOutputGroup, upsIdentName=upsIdentName, upsConfig=upsConfig, upsAlarmTable=upsAlarmTable, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBatteryVoltage=upsBatteryVoltage, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBypassNumLines=upsBypassNumLines, upsFullControlGroup=upsFullControlGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBypassVoltage=upsBypassVoltage, upsOutput=upsOutput, upsBypassTable=upsBypassTable, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmTime=upsAlarmTime, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmTempBad=upsAlarmTempBad, upsFullTestGroup=upsFullTestGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsInputLineBads=upsInputLineBads, upsShutdownType=upsShutdownType, upsFullCompliance=upsFullCompliance, upsAlarmDescr=upsAlarmDescr, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBasicControlGroup=upsBasicControlGroup, PositiveInteger=PositiveInteger, upsFullConfigGroup=upsFullConfigGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsConformance=upsConformance, upsBasicGroups=upsBasicGroups, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsBattery=upsBattery, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBypass=upsBypass, upsWellKnownTests=upsWellKnownTests, upsBypassCurrent=upsBypassCurrent, upsBypassPower=upsBypassPower, upsAlarmLowBattery=upsAlarmLowBattery, upsOutputVoltage=upsOutputVoltage, NonNegativeInteger=NonNegativeInteger, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsCompliances=upsCompliances, upsInput=upsInput, upsTest=upsTest, upsStartupAfterDelay=upsStartupAfterDelay, upsOutputLineIndex=upsOutputLineIndex, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsInputNumLines=upsInputNumLines)
