...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, ObjectIdentity, Bits, TimeTicks, Counter64, Counter32, mib_2, MibIdentifier, ModuleIdentity, Integer32, Unsigned32, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "ObjectIdentity", "Bits", "TimeTicks", "Counter64", "Counter32", "mib-2", "MibIdentifier", "ModuleIdentity", "Integer32", "Unsigned32", "Gauge32", "NotificationType")
TextualConvention, TimeInterval, TimeStamp, AutonomousType, TestAndIncr, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeInterval", "TimeStamp", "AutonomousType", "TestAndIncr", "DisplayString")
...
mibBuilder.exportSymbols("UPS-MIB", upsTrapTestCompleted=upsTrapTestCompleted, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmsPresent=upsAlarmsPresent, upsBasicAlarmGroup=upsBasicAlarmGroup, upsTestResultsDetail=upsTestResultsDetail, upsSubsetInputGroup=upsSubsetInputGroup, upsBypassTable=upsBypassTable, upsConformance=upsConformance, upsAlarmTestInProgress=upsAlarmTestInProgress, upsOutputSource=upsOutputSource, upsOutputEntry=upsOutputEntry, upsBypassEntry=upsBypassEntry, upsIdentModel=upsIdentModel, upsShutdownAfterDelay=upsShutdownAfterDelay, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsConfigLowBattTime=upsConfigLowBattTime, upsOutputCurrent=upsOutputCurrent, upsConfigInputFreq=upsConfigInputFreq, upsBattery=upsBattery, upsBatteryCurrent=upsBatteryCurrent, upsInputCurrent=upsInputCurrent, upsFullBypassGroup=upsFullBypassGroup, upsRebootWithDuration=upsRebootWithDuration, upsAlarmTable=upsAlarmTable, upsInputTruePower=upsInputTruePower, upsOutputPower=upsOutputPower, upsInputNumLines=upsInputNumLines, upsBatteryTemperature=upsBatteryTemperature, upsInputLineIndex=upsInputLineIndex, upsBypassLineIndex=upsBypassLineIndex, upsAlarmDescr=upsAlarmDescr, upsTestSpinLock=upsTestSpinLock, upsBypassVoltage=upsBypassVoltage, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTestId=upsTestId, upsConfigOutputVA=upsConfigOutputVA, upsObjects=upsObjects, upsIdentName=upsIdentName, upsGroups=upsGroups, upsAlarmOutputOverload=upsAlarmOutputOverload, upsFullConfigGroup=upsFullConfigGroup, upsBatteryStatus=upsBatteryStatus, upsIdentManufacturer=upsIdentManufacturer, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullControlGroup=upsFullControlGroup, upsOutputFrequency=upsOutputFrequency, upsAlarmTime=upsAlarmTime, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsConfigOutputPower=upsConfigOutputPower, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarm=upsAlarm, upsTestElapsedTime=upsTestElapsedTime, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsInputLineBads=upsInputLineBads, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmEntry=upsAlarmEntry, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBypass=upsBypass, upsAlarmOnBypass=upsAlarmOnBypass, upsFullTestGroup=upsFullTestGroup, upsAlarmInputBad=upsAlarmInputBad, upsAlarmFuseFailure=upsAlarmFuseFailure, upsWellKnownTests=upsWellKnownTests, upsShutdownType=upsShutdownType, PYSNMP_MODULE_ID=upsMIB, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmBatteryBad=upsAlarmBatteryBad, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBasicGroups=upsBasicGroups, upsControl=upsControl, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmId=upsAlarmId, upsConfigAudibleStatus=upsConfigAudibleStatus, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsStartupAfterDelay=upsStartupAfterDelay, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsSubsetControlGroup=upsSubsetControlGroup, upsInputFrequency=upsInputFrequency, upsOutputLineIndex=upsOutputLineIndex, upsOutputVoltage=upsOutputVoltage, upsBasicConfigGroup=upsBasicConfigGroup, upsTestResultsSummary=upsTestResultsSummary, upsBasicCompliance=upsBasicCompliance, upsConfig=upsConfig, upsBasicBypassGroup=upsBasicBypassGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBatteryVoltage=upsBatteryVoltage, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsFullIdentGroup=upsFullIdentGroup, NonNegativeInteger=NonNegativeInteger, upsConfigInputVoltage=upsConfigInputVoltage, upsInput=upsInput, upsBasicTestGroup=upsBasicTestGroup, upsFullGroups=upsFullGroups, PositiveInteger=PositiveInteger, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsOutputNumLines=upsOutputNumLines, upsConfigOutputFreq=upsConfigOutputFreq, upsFullCompliance=upsFullCompliance, upsSubsetGroups=upsSubsetGroups, upsAlarmOnBattery=upsAlarmOnBattery, upsFullAlarmGroup=upsFullAlarmGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsAutoRestart=upsAutoRestart, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBypassFrequency=upsBypassFrequency, upsOutputTable=upsOutputTable, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBypassNumLines=upsBypassNumLines, upsInputTable=upsInputTable, upsTest=upsTest, upsBypassCurrent=upsBypassCurrent, upsTraps=upsTraps, upsBasicBatteryGroup=upsBasicBatteryGroup, upsIdent=upsIdent, upsInputVoltage=upsInputVoltage, upsTestStartTime=upsTestStartTime, upsAlarmChargerFailed=upsAlarmChargerFailed, upsCompliances=upsCompliances, upsSubsetCompliance=upsSubsetCompliance, upsBasicControlGroup=upsBasicControlGroup, upsTrapOnBattery=upsTrapOnBattery, upsFullInputGroup=upsFullInputGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsOutput=upsOutput, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsConfigOutputVoltage=upsConfigOutputVoltage, upsSecondsOnBattery=upsSecondsOnBattery, upsFullOutputGroup=upsFullOutputGroup, upsInputEntry=upsInputEntry, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicInputGroup=upsBasicInputGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBypassPower=upsBypassPower, upsAlarmTempBad=upsAlarmTempBad, upsMIB=upsMIB)
