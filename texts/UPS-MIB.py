...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, mib_2, Counter64, ObjectIdentity, Integer32, ModuleIdentity, Bits, Unsigned32, NotificationType, TimeTicks, Counter32, IpAddress, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "mib-2", "Counter64", "ObjectIdentity", "Integer32", "ModuleIdentity", "Bits", "Unsigned32", "NotificationType", "TimeTicks", "Counter32", "IpAddress", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("UPS-MIB", PYSNMP_MODULE_ID=upsMIB, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBasicControlGroup=upsBasicControlGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, PositiveInteger=PositiveInteger, upsConfigInputFreq=upsConfigInputFreq, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmOnBattery=upsAlarmOnBattery, upsInputVoltage=upsInputVoltage, upsBatteryStatus=upsBatteryStatus, upsObjects=upsObjects, upsWellKnownTests=upsWellKnownTests, upsInputLineBads=upsInputLineBads, upsFullBypassGroup=upsFullBypassGroup, upsInputCurrent=upsInputCurrent, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsFullConfigGroup=upsFullConfigGroup, upsIdentModel=upsIdentModel, upsFullControlGroup=upsFullControlGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTestElapsedTime=upsTestElapsedTime, upsSubsetCompliance=upsSubsetCompliance, upsAlarmLowBattery=upsAlarmLowBattery, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmShutdownPending=upsAlarmShutdownPending, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsShutdownAfterDelay=upsShutdownAfterDelay, upsFullTestGroup=upsFullTestGroup, upsAlarmTime=upsAlarmTime, upsInputTable=upsInputTable, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsInputLineIndex=upsInputLineIndex, upsBypassLineIndex=upsBypassLineIndex, upsOutput=upsOutput, upsConfigOutputPower=upsConfigOutputPower, upsAlarmDescr=upsAlarmDescr, upsTest=upsTest, upsOutputEntry=upsOutputEntry, upsOutputVoltage=upsOutputVoltage, upsAlarmsPresent=upsAlarmsPresent, upsOutputLineIndex=upsOutputLineIndex, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmId=upsAlarmId, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBasicCompliance=upsBasicCompliance, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestStartTime=upsTestStartTime, upsOutputTable=upsOutputTable, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBypassCurrent=upsBypassCurrent, upsConfigLowBattTime=upsConfigLowBattTime, upsBasicTestGroup=upsBasicTestGroup, NonNegativeInteger=NonNegativeInteger, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsControl=upsControl, upsConfigAudibleStatus=upsConfigAudibleStatus, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmInputBad=upsAlarmInputBad, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmGeneralFault=upsAlarmGeneralFault, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmChargerFailed=upsAlarmChargerFailed, upsInputNumLines=upsInputNumLines, upsConfigInputVoltage=upsConfigInputVoltage, upsBypassNumLines=upsBypassNumLines, upsSubsetOutputGroup=upsSubsetOutputGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmOutputBad=upsAlarmOutputBad, upsTrapOnBattery=upsTrapOnBattery, upsConformance=upsConformance, upsBypassFrequency=upsBypassFrequency, upsOutputNumLines=upsOutputNumLines, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarm=upsAlarm, upsBasicGroups=upsBasicGroups, upsBasicConfigGroup=upsBasicConfigGroup, upsMIB=upsMIB, upsOutputSource=upsOutputSource, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsOutputPower=upsOutputPower, upsBasicOutputGroup=upsBasicOutputGroup, upsFullOutputGroup=upsFullOutputGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBattery=upsBattery, upsInput=upsInput, upsBypassTable=upsBypassTable, upsBypassPower=upsBypassPower, upsWellKnownAlarms=upsWellKnownAlarms, upsTestSpinLock=upsTestSpinLock, upsShutdownType=upsShutdownType, upsAutoRestart=upsAutoRestart, upsInputFrequency=upsInputFrequency, upsIdentName=upsIdentName, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConfig=upsConfig, upsFullInputGroup=upsFullInputGroup, upsIdentManufacturer=upsIdentManufacturer, upsFullGroups=upsFullGroups, upsTrapTestCompleted=upsTrapTestCompleted, upsConfigOutputVA=upsConfigOutputVA, upsBypassVoltage=upsBypassVoltage, upsAlarmOnBypass=upsAlarmOnBypass, upsSubsetGroups=upsSubsetGroups, upsSecondsOnBattery=upsSecondsOnBattery, upsOutputCurrent=upsOutputCurrent, upsConfigOutputVoltage=upsConfigOutputVoltage, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBasicInputGroup=upsBasicInputGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmTempBad=upsAlarmTempBad, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsIdent=upsIdent, upsBasicIdentGroup=upsBasicIdentGroup, upsFullIdentGroup=upsFullIdentGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsInputTruePower=upsInputTruePower, upsBasicBatteryGroup=upsBasicBatteryGroup, upsInputEntry=upsInputEntry, upsFullCompliance=upsFullCompliance, upsBypassEntry=upsBypassEntry, upsAlarmTable=upsAlarmTable, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTestResultsSummary=upsTestResultsSummary, upsTraps=upsTraps, upsAlarmEntry=upsAlarmEntry, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsRebootWithDuration=upsRebootWithDuration, upsSubsetInputGroup=upsSubsetInputGroup, upsTestResultsDetail=upsTestResultsDetail, upsBatteryVoltage=upsBatteryVoltage, upsSubsetControlGroup=upsSubsetControlGroup, upsOutputFrequency=upsOutputFrequency, upsBasicBypassGroup=upsBasicBypassGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsBatteryTemperature=upsBatteryTemperature, upsFullBatteryGroup=upsFullBatteryGroup, upsCompliances=upsCompliances, upsGroups=upsGroups, upsBypass=upsBypass, upsTestId=upsTestId, upsBatteryCurrent=upsBatteryCurrent)
