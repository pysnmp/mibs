...
mibBuilder.exportSymbols("UPS-MIB", upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsIdentModel=upsIdentModel, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsFullCompliance=upsFullCompliance, upsOutputEntry=upsOutputEntry, upsStartupAfterDelay=upsStartupAfterDelay, upsMIB=upsMIB, upsOutputFrequency=upsOutputFrequency, upsBypassVoltage=upsBypassVoltage, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsInputNumLines=upsInputNumLines, upsFullAlarmGroup=upsFullAlarmGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsInputCurrent=upsInputCurrent, upsInputTruePower=upsInputTruePower, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetOutputGroup=upsSubsetOutputGroup, upsInputFrequency=upsInputFrequency, upsBatteryCurrent=upsBatteryCurrent, upsInputEntry=upsInputEntry, upsAlarmInputBad=upsAlarmInputBad, upsSubsetInputGroup=upsSubsetInputGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmChargerFailed=upsAlarmChargerFailed, upsTest=upsTest, upsOutputCurrent=upsOutputCurrent, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsInputLineBads=upsInputLineBads, upsInputLineIndex=upsInputLineIndex, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBatteryVoltage=upsBatteryVoltage, upsConfig=upsConfig, upsBypassCurrent=upsBypassCurrent, upsBasicBypassGroup=upsBasicBypassGroup, upsIdentName=upsIdentName, upsFullOutputGroup=upsFullOutputGroup, upsAlarmId=upsAlarmId, upsShutdownAfterDelay=upsShutdownAfterDelay, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, NonNegativeInteger=NonNegativeInteger, upsBasicCompliance=upsBasicCompliance, upsBatteryTemperature=upsBatteryTemperature, upsAlarmGeneralFault=upsAlarmGeneralFault, upsConfigLowBattTime=upsConfigLowBattTime, upsBattery=upsBattery, upsOutput=upsOutput, upsOutputSource=upsOutputSource, upsAlarmTable=upsAlarmTable, upsRebootWithDuration=upsRebootWithDuration, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarm=upsAlarm, upsAlarmFanFailure=upsAlarmFanFailure, upsBasicControlGroup=upsBasicControlGroup, upsAlarmEntry=upsAlarmEntry, upsFullConfigGroup=upsFullConfigGroup, upsBypassFrequency=upsBypassFrequency, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsConfigOutputPower=upsConfigOutputPower, upsAutoRestart=upsAutoRestart, upsConfigInputVoltage=upsConfigInputVoltage, upsFullTestGroup=upsFullTestGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsOutputPercentLoad=upsOutputPercentLoad, upsGroups=upsGroups, upsAlarmsPresent=upsAlarmsPresent, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmBatteryBad=upsAlarmBatteryBad, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsTestElapsedTime=upsTestElapsedTime, PYSNMP_MODULE_ID=upsMIB, upsOutputVoltage=upsOutputVoltage, upsObjects=upsObjects, upsAlarmTestInProgress=upsAlarmTestInProgress, upsOutputNumLines=upsOutputNumLines, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBasicGroups=upsBasicGroups, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmTime=upsAlarmTime, upsCompliances=upsCompliances, upsBypassEntry=upsBypassEntry, upsTrapOnBattery=upsTrapOnBattery, upsBasicIdentGroup=upsBasicIdentGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmTempBad=upsAlarmTempBad, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsInputTable=upsInputTable, upsTraps=upsTraps, upsIdentManufacturer=upsIdentManufacturer, upsTrapTestCompleted=upsTrapTestCompleted, upsFullInputGroup=upsFullInputGroup, upsTestResultsSummary=upsTestResultsSummary, PositiveInteger=PositiveInteger, upsBypass=upsBypass, upsOutputLineIndex=upsOutputLineIndex, upsFullIdentGroup=upsFullIdentGroup, upsConformance=upsConformance, upsFullControlGroup=upsFullControlGroup, upsFullBypassGroup=upsFullBypassGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBypassTable=upsBypassTable, upsOutputTable=upsOutputTable, upsBasicOutputGroup=upsBasicOutputGroup, upsTestStartTime=upsTestStartTime, upsBatteryStatus=upsBatteryStatus, upsWellKnownTests=upsWellKnownTests, upsControl=upsControl, upsBypassPower=upsBypassPower, upsBasicTestGroup=upsBasicTestGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmFuseFailure=upsAlarmFuseFailure, upsFullGroups=upsFullGroups, upsTestResultsDetail=upsTestResultsDetail, upsInputVoltage=upsInputVoltage, upsConfigInputFreq=upsConfigInputFreq, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsConfigOutputVA=upsConfigOutputVA, upsWellKnownAlarms=upsWellKnownAlarms, upsOutputPower=upsOutputPower, upsBypassNumLines=upsBypassNumLines, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBypassLineIndex=upsBypassLineIndex, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBasicInputGroup=upsBasicInputGroup, upsSubsetCompliance=upsSubsetCompliance, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsTestId=upsTestId, upsTestSpinLock=upsTestSpinLock, upsShutdownType=upsShutdownType, upsBasicAlarmGroup=upsBasicAlarmGroup, upsInput=upsInput, upsAlarmDescr=upsAlarmDescr, upsSubsetGroups=upsSubsetGroups, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsIdent=upsIdent)
