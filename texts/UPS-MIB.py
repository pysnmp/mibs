...
mibBuilder.exportSymbols("UPS-MIB", upsBatteryCurrent=upsBatteryCurrent, upsAlarmLowBattery=upsAlarmLowBattery, upsControl=upsControl, upsConfigOutputPower=upsConfigOutputPower, NonNegativeInteger=NonNegativeInteger, upsInputTruePower=upsInputTruePower, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigOutputVA=upsConfigOutputVA, upsBypassLineIndex=upsBypassLineIndex, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsStartupAfterDelay=upsStartupAfterDelay, upsFullConfigGroup=upsFullConfigGroup, upsAlarmDescr=upsAlarmDescr, upsIdentName=upsIdentName, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullBypassGroup=upsFullBypassGroup, upsAlarmsPresent=upsAlarmsPresent, upsCompliances=upsCompliances, upsRebootWithDuration=upsRebootWithDuration, upsOutput=upsOutput, upsConformance=upsConformance, upsFullBatteryGroup=upsFullBatteryGroup, upsBypassNumLines=upsBypassNumLines, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsIdent=upsIdent, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmTestInProgress=upsAlarmTestInProgress, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBypassVoltage=upsBypassVoltage, upsTestSpinLock=upsTestSpinLock, upsShutdownAfterDelay=upsShutdownAfterDelay, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTestElapsedTime=upsTestElapsedTime, upsAlarmTable=upsAlarmTable, upsAlarmFanFailure=upsAlarmFanFailure, upsOutputFrequency=upsOutputFrequency, upsAlarmId=upsAlarmId, upsAlarmOnBypass=upsAlarmOnBypass, upsOutputPercentLoad=upsOutputPercentLoad, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsIdentModel=upsIdentModel, upsAlarmBypassBad=upsAlarmBypassBad, upsFullIdentGroup=upsFullIdentGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTraps=upsTraps, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmChargerFailed=upsAlarmChargerFailed, upsOutputEntry=upsOutputEntry, upsBypassEntry=upsBypassEntry, upsBasicInputGroup=upsBasicInputGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBatteryTemperature=upsBatteryTemperature, upsBasicAlarmGroup=upsBasicAlarmGroup, upsWellKnownTests=upsWellKnownTests, upsWellKnownAlarms=upsWellKnownAlarms, upsBasicControlGroup=upsBasicControlGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsInputLineBads=upsInputLineBads, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsIdentManufacturer=upsIdentManufacturer, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsInputNumLines=upsInputNumLines, upsOutputNumLines=upsOutputNumLines, upsConfigInputFreq=upsConfigInputFreq, upsMIB=upsMIB, upsFullGroups=upsFullGroups, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarm=upsAlarm, upsFullOutputGroup=upsFullOutputGroup, upsOutputSource=upsOutputSource, upsBasicOutputGroup=upsBasicOutputGroup, upsFullCompliance=upsFullCompliance, upsBasicCompliance=upsBasicCompliance, upsFullInputGroup=upsFullInputGroup, upsSubsetGroups=upsSubsetGroups, upsSubsetCompliance=upsSubsetCompliance, upsTrapOnBattery=upsTrapOnBattery, upsOutputPower=upsOutputPower, upsGroups=upsGroups, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAutoRestart=upsAutoRestart, PositiveInteger=PositiveInteger, upsAlarmTempBad=upsAlarmTempBad, upsBatteryStatus=upsBatteryStatus, upsOutputCurrent=upsOutputCurrent, upsBypassCurrent=upsBypassCurrent, upsOutputVoltage=upsOutputVoltage, upsOutputTable=upsOutputTable, upsInputVoltage=upsInputVoltage, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsTrapTestCompleted=upsTrapTestCompleted, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBasicConfigGroup=upsBasicConfigGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutputLineIndex=upsOutputLineIndex, upsTestId=upsTestId, upsInputEntry=upsInputEntry, upsInputCurrent=upsInputCurrent, PYSNMP_MODULE_ID=upsMIB, upsBypassFrequency=upsBypassFrequency, upsBatteryVoltage=upsBatteryVoltage, upsBypassPower=upsBypassPower, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsConfigInputVoltage=upsConfigInputVoltage, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBasicTestGroup=upsBasicTestGroup, upsTestResultsSummary=upsTestResultsSummary, upsAlarmOutputOverload=upsAlarmOutputOverload, upsInputLineIndex=upsInputLineIndex, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicGroups=upsBasicGroups, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsInput=upsInput, upsAlarmFuseFailure=upsAlarmFuseFailure, upsConfig=upsConfig, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmEntry=upsAlarmEntry, upsAlarmOutputBad=upsAlarmOutputBad, upsShutdownType=upsShutdownType, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsConfigAudibleStatus=upsConfigAudibleStatus, upsInputTable=upsInputTable, upsInputFrequency=upsInputFrequency, upsSubsetConfigGroup=upsSubsetConfigGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsBypassTable=upsBypassTable, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmInputBad=upsAlarmInputBad, upsBattery=upsBattery, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsTestStartTime=upsTestStartTime, upsFullControlGroup=upsFullControlGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTestResultsDetail=upsTestResultsDetail, upsObjects=upsObjects, upsAlarmTime=upsAlarmTime, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBasicIdentGroup=upsBasicIdentGroup, upsFullTestGroup=upsFullTestGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsTest=upsTest, upsBypass=upsBypass)
