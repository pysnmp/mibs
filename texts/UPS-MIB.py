...
# Produced by pysmi-1.1.8 at Thu Oct 26 11:00:04 2023
...
ObjectIdentity, Counter32, NotificationType, Counter64, MibIdentifier, ModuleIdentity, Bits, Unsigned32, TimeTicks, Integer32, iso, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "NotificationType", "Counter64", "MibIdentifier", "ModuleIdentity", "Bits", "Unsigned32", "TimeTicks", "Integer32", "iso", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("UPS-MIB", upsFullOutputGroup=upsFullOutputGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmTable=upsAlarmTable, NonNegativeInteger=NonNegativeInteger, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsFullCompliance=upsFullCompliance, upsBypassFrequency=upsBypassFrequency, upsAlarmId=upsAlarmId, upsIdentModel=upsIdentModel, upsIdent=upsIdent, upsBatteryCurrent=upsBatteryCurrent, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsBasicAlarmGroup=upsBasicAlarmGroup, upsOutputLineIndex=upsOutputLineIndex, upsInputTruePower=upsInputTruePower, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsConfig=upsConfig, upsBatteryVoltage=upsBatteryVoltage, upsTrapOnBattery=upsTrapOnBattery, upsInputVoltage=upsInputVoltage, upsAlarmChargerFailed=upsAlarmChargerFailed, upsSubsetGroups=upsSubsetGroups, upsOutputPower=upsOutputPower, upsOutputPercentLoad=upsOutputPercentLoad, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmTempBad=upsAlarmTempBad, upsTestElapsedTime=upsTestElapsedTime, upsInputLineBads=upsInputLineBads, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmEntry=upsAlarmEntry, upsIdentName=upsIdentName, upsInputFrequency=upsInputFrequency, PYSNMP_MODULE_ID=upsMIB, upsMIB=upsMIB, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsInputCurrent=upsInputCurrent, upsAlarmBypassBad=upsAlarmBypassBad, upsBypassCurrent=upsBypassCurrent, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBasicTestGroup=upsBasicTestGroup, upsOutputTable=upsOutputTable, upsBasicConfigGroup=upsBasicConfigGroup, upsInputNumLines=upsInputNumLines, upsConfigLowBattTime=upsConfigLowBattTime, upsTraps=upsTraps, upsConfigInputFreq=upsConfigInputFreq, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsInputLineIndex=upsInputLineIndex, upsConfigInputVoltage=upsConfigInputVoltage, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmTime=upsAlarmTime, upsAlarmBatteryBad=upsAlarmBatteryBad, upsOutputFrequency=upsOutputFrequency, upsOutputVoltage=upsOutputVoltage, upsTestId=upsTestId, upsBasicGroups=upsBasicGroups, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmFanFailure=upsAlarmFanFailure, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypassLineIndex=upsBypassLineIndex, upsBattery=upsBattery, upsTestResultsDetail=upsTestResultsDetail, upsFullConfigGroup=upsFullConfigGroup, upsAlarmDescr=upsAlarmDescr, upsBasicIdentGroup=upsBasicIdentGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmLowBattery=upsAlarmLowBattery, upsAutoRestart=upsAutoRestart, upsFullIdentGroup=upsFullIdentGroup, upsBypassNumLines=upsBypassNumLines, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmOutputOverload=upsAlarmOutputOverload, upsOutputNumLines=upsOutputNumLines, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigOutputPower=upsConfigOutputPower, upsBypassPower=upsBypassPower, upsFullTestGroup=upsFullTestGroup, upsFullGroups=upsFullGroups, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBasicControlGroup=upsBasicControlGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsWellKnownAlarms=upsWellKnownAlarms, upsWellKnownTests=upsWellKnownTests, upsAlarmShutdownPending=upsAlarmShutdownPending, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullInputGroup=upsFullInputGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsTestSpinLock=upsTestSpinLock, upsGroups=upsGroups, upsAlarmOutputBad=upsAlarmOutputBad, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsShutdownType=upsShutdownType, upsBasicInputGroup=upsBasicInputGroup, upsInput=upsInput, upsOutputEntry=upsOutputEntry, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicBypassGroup=upsBasicBypassGroup, upsInputTable=upsInputTable, upsIdentManufacturer=upsIdentManufacturer, upsInputEntry=upsInputEntry, upsOutput=upsOutput, upsOutputCurrent=upsOutputCurrent, upsAlarmInputBad=upsAlarmInputBad, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmsPresent=upsAlarmsPresent, upsSubsetInputGroup=upsSubsetInputGroup, upsFullBypassGroup=upsFullBypassGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsShutdownAfterDelay=upsShutdownAfterDelay, upsCompliances=upsCompliances, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmOnBattery=upsAlarmOnBattery, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTestResultsSummary=upsTestResultsSummary, upsBypassVoltage=upsBypassVoltage, upsConformance=upsConformance, upsObjects=upsObjects, upsSubsetCompliance=upsSubsetCompliance, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsFullControlGroup=upsFullControlGroup, PositiveInteger=PositiveInteger, upsBypass=upsBypass, upsBypassEntry=upsBypassEntry, upsFullAlarmGroup=upsFullAlarmGroup, upsTest=upsTest, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmGeneralFault=upsAlarmGeneralFault, upsConfigOutputVA=upsConfigOutputVA, upsBasicCompliance=upsBasicCompliance, upsOutputSource=upsOutputSource, upsBatteryStatus=upsBatteryStatus, upsBatteryTemperature=upsBatteryTemperature, upsAlarm=upsAlarm, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsBypassTable=upsBypassTable, upsStartupAfterDelay=upsStartupAfterDelay, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTestStartTime=upsTestStartTime, upsControl=upsControl, upsSubsetOutputGroup=upsSubsetOutputGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsRebootWithDuration=upsRebootWithDuration)
