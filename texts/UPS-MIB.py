...
# Produced by pysmi-1.1.0 at Tue Nov 16 11:34:17 2021
...
MibIdentifier, IpAddress, Counter32, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, Integer32, NotificationType, iso, TimeTicks, Bits, ModuleIdentity, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "Counter32", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "Integer32", "NotificationType", "iso", "TimeTicks", "Bits", "ModuleIdentity", "mib-2")
...
mibBuilder.exportSymbols("UPS-MIB", upsIdentAttachedDevices=upsIdentAttachedDevices, upsCompliances=upsCompliances, upsObjects=upsObjects, upsTestStartTime=upsTestStartTime, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarm=upsAlarm, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmEntry=upsAlarmEntry, upsControl=upsControl, upsFullAlarmGroup=upsFullAlarmGroup, PYSNMP_MODULE_ID=upsMIB, upsAlarmOnBypass=upsAlarmOnBypass, upsBatteryVoltage=upsBatteryVoltage, upsIdentName=upsIdentName, upsBasicCompliance=upsBasicCompliance, upsFullGroups=upsFullGroups, upsSubsetOutputGroup=upsSubsetOutputGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTrapOnBattery=upsTrapOnBattery, upsFullBatteryGroup=upsFullBatteryGroup, upsBasicGroups=upsBasicGroups, upsBasicTestGroup=upsBasicTestGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmTime=upsAlarmTime, upsOutputSource=upsOutputSource, upsConformance=upsConformance, upsSubsetCompliance=upsSubsetCompliance, upsFullTestGroup=upsFullTestGroup, upsAlarmsPresent=upsAlarmsPresent, upsMIB=upsMIB, upsShutdownAfterDelay=upsShutdownAfterDelay, upsInputLineIndex=upsInputLineIndex, upsConfigInputFreq=upsConfigInputFreq, upsBatteryStatus=upsBatteryStatus, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsOutputPower=upsOutputPower, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutputVoltage=upsOutputVoltage, upsAlarmOutputBad=upsAlarmOutputBad, upsSubsetControlGroup=upsSubsetControlGroup, upsBypassVoltage=upsBypassVoltage, upsBypassLineIndex=upsBypassLineIndex, upsBatteryCurrent=upsBatteryCurrent, upsOutputTable=upsOutputTable, upsAlarmOutputOverload=upsAlarmOutputOverload, upsStartupAfterDelay=upsStartupAfterDelay, upsTraps=upsTraps, upsInputEntry=upsInputEntry, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBasicAlarmGroup=upsBasicAlarmGroup, upsInputCurrent=upsInputCurrent, upsBypassCurrent=upsBypassCurrent, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBatteryTemperature=upsBatteryTemperature, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBypassFrequency=upsBypassFrequency, upsFullOutputGroup=upsFullOutputGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsInputNumLines=upsInputNumLines, upsInputFrequency=upsInputFrequency, upsBypassTable=upsBypassTable, upsAlarmLowBattery=upsAlarmLowBattery, upsSubsetGroups=upsSubsetGroups, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsConfigOutputFreq=upsConfigOutputFreq, upsTestSpinLock=upsTestSpinLock, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsSubsetIdentGroup=upsSubsetIdentGroup, upsRebootWithDuration=upsRebootWithDuration, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmFuseFailure=upsAlarmFuseFailure, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsTestId=upsTestId, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsShutdownType=upsShutdownType, upsBasicIdentGroup=upsBasicIdentGroup, upsTest=upsTest, upsConfigInputVoltage=upsConfigInputVoltage, upsFullControlGroup=upsFullControlGroup, upsAlarmId=upsAlarmId, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBattery=upsBattery, PositiveInteger=PositiveInteger, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsConfigOutputVoltage=upsConfigOutputVoltage, upsInput=upsInput, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsOutputNumLines=upsOutputNumLines, upsOutputEntry=upsOutputEntry, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmInputBad=upsAlarmInputBad, upsOutputFrequency=upsOutputFrequency, upsInputTruePower=upsInputTruePower, upsConfigLowBattTime=upsConfigLowBattTime, upsOutputLineIndex=upsOutputLineIndex, upsWellKnownAlarms=upsWellKnownAlarms, upsWellKnownTests=upsWellKnownTests, upsBasicControlGroup=upsBasicControlGroup, upsBypassPower=upsBypassPower, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBasicConfigGroup=upsBasicConfigGroup, upsInputVoltage=upsInputVoltage, NonNegativeInteger=NonNegativeInteger, upsFullBypassGroup=upsFullBypassGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmShutdownPending=upsAlarmShutdownPending, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBypassNumLines=upsBypassNumLines, upsConfigOutputPower=upsConfigOutputPower, upsInputLineBads=upsInputLineBads, upsFullConfigGroup=upsFullConfigGroup, upsConfigOutputVA=upsConfigOutputVA, upsAlarmFanFailure=upsAlarmFanFailure, upsFullCompliance=upsFullCompliance, upsGroups=upsGroups, upsBasicInputGroup=upsBasicInputGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsOutputCurrent=upsOutputCurrent, upsAlarmTable=upsAlarmTable, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsFullIdentGroup=upsFullIdentGroup, upsIdentModel=upsIdentModel, upsAlarmGeneralFault=upsAlarmGeneralFault, upsIdent=upsIdent, upsAlarmBypassBad=upsAlarmBypassBad, upsTestResultsSummary=upsTestResultsSummary, upsOutputPercentLoad=upsOutputPercentLoad, upsBypass=upsBypass, upsBypassEntry=upsBypassEntry, upsIdentManufacturer=upsIdentManufacturer, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsInputTable=upsInputTable, upsOutput=upsOutput, upsAlarmDescr=upsAlarmDescr, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsFullInputGroup=upsFullInputGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAutoRestart=upsAutoRestart, upsTrapTestCompleted=upsTrapTestCompleted, upsTestElapsedTime=upsTestElapsedTime, upsTestResultsDetail=upsTestResultsDetail, upsConfig=upsConfig, upsAlarmTempBad=upsAlarmTempBad)
