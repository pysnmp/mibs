...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:17:27 2023
...
Bits, ObjectIdentity, iso, TimeTicks, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, IpAddress, ModuleIdentity, MibIdentifier, Integer32, Counter64, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "iso", "TimeTicks", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "IpAddress", "ModuleIdentity", "MibIdentifier", "Integer32", "Counter64", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("UPS-MIB", upsInputEntry=upsInputEntry, upsAlarmTime=upsAlarmTime, upsBypassLineIndex=upsBypassLineIndex, upsFullOutputGroup=upsFullOutputGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsBasicGroups=upsBasicGroups, upsBypassFrequency=upsBypassFrequency, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTest=upsTest, upsConfigInputFreq=upsConfigInputFreq, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsTestResultsSummary=upsTestResultsSummary, upsOutputCurrent=upsOutputCurrent, upsAlarmTempBad=upsAlarmTempBad, upsOutputFrequency=upsOutputFrequency, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBasicBypassGroup=upsBasicBypassGroup, upsTestSpinLock=upsTestSpinLock, upsIdent=upsIdent, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAutoRestart=upsAutoRestart, upsWellKnownAlarms=upsWellKnownAlarms, upsIdentName=upsIdentName, upsOutputTable=upsOutputTable, upsGroups=upsGroups, upsTrapOnBattery=upsTrapOnBattery, upsConfigOutputPower=upsConfigOutputPower, upsOutput=upsOutput, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmsPresent=upsAlarmsPresent, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsFullBypassGroup=upsFullBypassGroup, NonNegativeInteger=NonNegativeInteger, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmOnBattery=upsAlarmOnBattery, upsOutputPower=upsOutputPower, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBypassVoltage=upsBypassVoltage, upsTestResultsDetail=upsTestResultsDetail, upsBasicAlarmGroup=upsBasicAlarmGroup, upsSubsetGroups=upsSubsetGroups, upsAlarmInputBad=upsAlarmInputBad, upsOutputNumLines=upsOutputNumLines, upsTestId=upsTestId, upsBypassTable=upsBypassTable, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsFullTestGroup=upsFullTestGroup, PYSNMP_MODULE_ID=upsMIB, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBasicControlGroup=upsBasicControlGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsControl=upsControl, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsIdentModel=upsIdentModel, upsInput=upsInput, upsBypassPower=upsBypassPower, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestStartTime=upsTestStartTime, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmGeneralFault=upsAlarmGeneralFault, upsConfigOutputVA=upsConfigOutputVA, upsTestElapsedTime=upsTestElapsedTime, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsBasicTestGroup=upsBasicTestGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBypassNumLines=upsBypassNumLines, upsFullAlarmGroup=upsFullAlarmGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmDescr=upsAlarmDescr, upsBatteryCurrent=upsBatteryCurrent, upsConformance=upsConformance, upsAlarmShutdownPending=upsAlarmShutdownPending, upsOutputEntry=upsOutputEntry, upsBypassEntry=upsBypassEntry, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullControlGroup=upsFullControlGroup, upsBasicCompliance=upsBasicCompliance, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmChargerFailed=upsAlarmChargerFailed, upsCompliances=upsCompliances, upsBypass=upsBypass, upsBatteryVoltage=upsBatteryVoltage, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmId=upsAlarmId, upsBatteryStatus=upsBatteryStatus, upsConfigOutputFreq=upsConfigOutputFreq, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsFullConfigGroup=upsFullConfigGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarm=upsAlarm, upsAlarmTable=upsAlarmTable, upsTraps=upsTraps, upsInputNumLines=upsInputNumLines, upsOutputSource=upsOutputSource, upsBasicInputGroup=upsBasicInputGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmEntry=upsAlarmEntry, upsConfig=upsConfig, upsTrapTestCompleted=upsTrapTestCompleted, upsInputTable=upsInputTable, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsOutputVoltage=upsOutputVoltage, upsShutdownType=upsShutdownType, upsRebootWithDuration=upsRebootWithDuration, upsBypassCurrent=upsBypassCurrent, upsFullGroups=upsFullGroups, PositiveInteger=PositiveInteger, upsFullIdentGroup=upsFullIdentGroup, upsBattery=upsBattery, upsMIB=upsMIB, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsOutputLineIndex=upsOutputLineIndex, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsInputVoltage=upsInputVoltage, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsConfigOutputVoltage=upsConfigOutputVoltage, upsConfigLowBattTime=upsConfigLowBattTime, upsSubsetCompliance=upsSubsetCompliance, upsInputLineBads=upsInputLineBads, upsInputFrequency=upsInputFrequency, upsInputCurrent=upsInputCurrent, upsSubsetIdentGroup=upsSubsetIdentGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBatteryTemperature=upsBatteryTemperature, upsObjects=upsObjects, upsInputLineIndex=upsInputLineIndex, upsFullCompliance=upsFullCompliance, upsIdentManufacturer=upsIdentManufacturer, upsWellKnownTests=upsWellKnownTests, upsAlarmLowBattery=upsAlarmLowBattery, upsFullInputGroup=upsFullInputGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsConfigAudibleStatus=upsConfigAudibleStatus, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmBypassBad=upsAlarmBypassBad, upsInputTruePower=upsInputTruePower)
