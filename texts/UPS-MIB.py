...
# Produced by pysmi-1.1.12 at Wed Jul  3 12:00:22 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, IpAddress, MibIdentifier, Counter64, Gauge32, Bits, mib_2, TimeTicks, Integer32, ModuleIdentity, NotificationType, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "IpAddress", "MibIdentifier", "Counter64", "Gauge32", "Bits", "mib-2", "TimeTicks", "Integer32", "ModuleIdentity", "NotificationType", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("UPS-MIB", upsBasicBypassGroup=upsBasicBypassGroup, upsTestResultsDetail=upsTestResultsDetail, upsShutdownAfterDelay=upsShutdownAfterDelay, upsMIB=upsMIB, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsFullConfigGroup=upsFullConfigGroup, upsTrapOnBattery=upsTrapOnBattery, upsOutputNumLines=upsOutputNumLines, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsOutputPercentLoad=upsOutputPercentLoad, upsConformance=upsConformance, upsFullBatteryGroup=upsFullBatteryGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsBasicCompliance=upsBasicCompliance, upsGroups=upsGroups, upsAlarmOutputBad=upsAlarmOutputBad, upsInputNumLines=upsInputNumLines, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsIdentName=upsIdentName, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmFuseFailure=upsAlarmFuseFailure, upsConfigInputVoltage=upsConfigInputVoltage, upsSubsetGroups=upsSubsetGroups, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsInputVoltage=upsInputVoltage, upsFullTestGroup=upsFullTestGroup, upsConfigOutputPower=upsConfigOutputPower, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConfigOutputVA=upsConfigOutputVA, upsTestResultsSummary=upsTestResultsSummary, upsTestSpinLock=upsTestSpinLock, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, PYSNMP_MODULE_ID=upsMIB, upsInputTable=upsInputTable, upsWellKnownAlarms=upsWellKnownAlarms, upsSubsetControlGroup=upsSubsetControlGroup, upsBypassNumLines=upsBypassNumLines, upsInputLineBads=upsInputLineBads, upsBypassVoltage=upsBypassVoltage, upsTestId=upsTestId, upsFullAlarmGroup=upsFullAlarmGroup, upsFullOutputGroup=upsFullOutputGroup, upsAlarmTable=upsAlarmTable, upsBasicTestGroup=upsBasicTestGroup, upsIdentModel=upsIdentModel, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsOutputCurrent=upsOutputCurrent, upsSubsetCompliance=upsSubsetCompliance, upsTest=upsTest, upsBypassPower=upsBypassPower, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsOutputTable=upsOutputTable, upsOutputPower=upsOutputPower, upsAlarmOnBattery=upsAlarmOnBattery, upsSubsetOutputGroup=upsSubsetOutputGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmDescr=upsAlarmDescr, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmChargerFailed=upsAlarmChargerFailed, upsObjects=upsObjects, upsInputEntry=upsInputEntry, upsIdentManufacturer=upsIdentManufacturer, upsBatteryVoltage=upsBatteryVoltage, upsOutputSource=upsOutputSource, upsAlarmEntry=upsAlarmEntry, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmOnBypass=upsAlarmOnBypass, upsBatteryTemperature=upsBatteryTemperature, upsTraps=upsTraps, upsOutputEntry=upsOutputEntry, upsInputCurrent=upsInputCurrent, upsConfigAudibleStatus=upsConfigAudibleStatus, upsSubsetInputGroup=upsSubsetInputGroup, upsBypass=upsBypass, upsFullIdentGroup=upsFullIdentGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBasicAlarmGroup=upsBasicAlarmGroup, upsConfig=upsConfig, upsAlarmTestInProgress=upsAlarmTestInProgress, upsOutputLineIndex=upsOutputLineIndex, PositiveInteger=PositiveInteger, upsOutput=upsOutput, upsCompliances=upsCompliances, upsConfigOutputFreq=upsConfigOutputFreq, upsInputFrequency=upsInputFrequency, upsOutputVoltage=upsOutputVoltage, upsConfigInputFreq=upsConfigInputFreq, upsAlarm=upsAlarm, upsAlarmTempBad=upsAlarmTempBad, upsBatteryCurrent=upsBatteryCurrent, upsIdent=upsIdent, upsInput=upsInput, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsFullControlGroup=upsFullControlGroup, upsInputLineIndex=upsInputLineIndex, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBypassFrequency=upsBypassFrequency, upsBypassTable=upsBypassTable, upsControl=upsControl, upsOutputFrequency=upsOutputFrequency, upsAlarmOutputOverload=upsAlarmOutputOverload, upsWellKnownTests=upsWellKnownTests, upsAlarmFanFailure=upsAlarmFanFailure, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBasicGroups=upsBasicGroups, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsTestElapsedTime=upsTestElapsedTime, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmId=upsAlarmId, upsBypassLineIndex=upsBypassLineIndex, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullBypassGroup=upsFullBypassGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsRebootWithDuration=upsRebootWithDuration, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAutoRestart=upsAutoRestart, upsBasicInputGroup=upsBasicInputGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTestQuickBatteryTest=upsTestQuickBatteryTest, NonNegativeInteger=NonNegativeInteger, upsBypassEntry=upsBypassEntry, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmTime=upsAlarmTime, upsAlarmsPresent=upsAlarmsPresent, upsFullInputGroup=upsFullInputGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicConfigGroup=upsBasicConfigGroup, upsTestStartTime=upsTestStartTime, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmInputBad=upsAlarmInputBad, upsShutdownType=upsShutdownType, upsBasicIdentGroup=upsBasicIdentGroup, upsInputTruePower=upsInputTruePower, upsBypassCurrent=upsBypassCurrent, upsBattery=upsBattery, upsBatteryStatus=upsBatteryStatus, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmLowBattery=upsAlarmLowBattery, upsFullCompliance=upsFullCompliance, upsFullGroups=upsFullGroups, upsBasicControlGroup=upsBasicControlGroup, upsTrapTestCompleted=upsTrapTestCompleted)
