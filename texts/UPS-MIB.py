...
# Produced by pysmi-1.1.8 at Sat Jan 15 23:20:43 2022
...
MibIdentifier, mib_2, Counter32, Counter64, IpAddress, ObjectIdentity, Unsigned32, Gauge32, iso, NotificationType, TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "mib-2", "Counter32", "Counter64", "IpAddress", "ObjectIdentity", "Unsigned32", "Gauge32", "iso", "NotificationType", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmBypassBad=upsAlarmBypassBad, upsOutputSource=upsOutputSource, upsIdentManufacturer=upsIdentManufacturer, upsBypassTable=upsBypassTable, upsIdentModel=upsIdentModel, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsInputLineBads=upsInputLineBads, upsAlarm=upsAlarm, upsOutputNumLines=upsOutputNumLines, upsBypassPower=upsBypassPower, upsFullOutputGroup=upsFullOutputGroup, upsBasicControlGroup=upsBasicControlGroup, upsOutputVoltage=upsOutputVoltage, upsTraps=upsTraps, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmId=upsAlarmId, upsConformance=upsConformance, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBatteryTemperature=upsBatteryTemperature, upsInputLineIndex=upsInputLineIndex, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsTestSpinLock=upsTestSpinLock, upsInputTruePower=upsInputTruePower, upsFullBatteryGroup=upsFullBatteryGroup, upsTestStartTime=upsTestStartTime, upsConfig=upsConfig, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmGeneralFault=upsAlarmGeneralFault, upsInputEntry=upsInputEntry, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsInputTable=upsInputTable, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsConfigOutputVA=upsConfigOutputVA, upsTestElapsedTime=upsTestElapsedTime, upsInputFrequency=upsInputFrequency, upsFullTestGroup=upsFullTestGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTrapOnBattery=upsTrapOnBattery, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTest=upsTest, upsAlarmOutputOverload=upsAlarmOutputOverload, upsConfigInputFreq=upsConfigInputFreq, upsCompliances=upsCompliances, PositiveInteger=PositiveInteger, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsOutputPercentLoad=upsOutputPercentLoad, upsOutputLineIndex=upsOutputLineIndex, upsSubsetCompliance=upsSubsetCompliance, upsAlarmFuseFailure=upsAlarmFuseFailure, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBasicCompliance=upsBasicCompliance, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutputEntry=upsOutputEntry, upsWellKnownAlarms=upsWellKnownAlarms, PYSNMP_MODULE_ID=upsMIB, upsBatteryCurrent=upsBatteryCurrent, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBypassVoltage=upsBypassVoltage, upsTrapTestCompleted=upsTrapTestCompleted, upsOutputTable=upsOutputTable, upsInputNumLines=upsInputNumLines, upsFullAlarmGroup=upsFullAlarmGroup, upsFullCompliance=upsFullCompliance, upsBasicInputGroup=upsBasicInputGroup, upsFullBypassGroup=upsFullBypassGroup, upsFullIdentGroup=upsFullIdentGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsShutdownType=upsShutdownType, upsBypassCurrent=upsBypassCurrent, upsConfigOutputFreq=upsConfigOutputFreq, upsFullControlGroup=upsFullControlGroup, upsBypassNumLines=upsBypassNumLines, upsObjects=upsObjects, upsAlarmTable=upsAlarmTable, upsBatteryVoltage=upsBatteryVoltage, upsSecondsOnBattery=upsSecondsOnBattery, upsIdentName=upsIdentName, upsOutputCurrent=upsOutputCurrent, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmLowBattery=upsAlarmLowBattery, upsTestResultsSummary=upsTestResultsSummary, NonNegativeInteger=NonNegativeInteger, upsBasicGroups=upsBasicGroups, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBypassEntry=upsBypassEntry, upsSubsetGroups=upsSubsetGroups, upsSubsetControlGroup=upsSubsetControlGroup, upsFullInputGroup=upsFullInputGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutputPower=upsOutputPower, upsOutput=upsOutput, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAutoRestart=upsAutoRestart, upsBypass=upsBypass, upsBasicIdentGroup=upsBasicIdentGroup, upsRebootWithDuration=upsRebootWithDuration, upsBasicBypassGroup=upsBasicBypassGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmTime=upsAlarmTime, upsBypassLineIndex=upsBypassLineIndex, upsSubsetOutputGroup=upsSubsetOutputGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmOutputBad=upsAlarmOutputBad, upsFullConfigGroup=upsFullConfigGroup, upsIdent=upsIdent, upsInputVoltage=upsInputVoltage, upsTestId=upsTestId, upsConfigInputVoltage=upsConfigInputVoltage, upsInput=upsInput, upsConfigOutputPower=upsConfigOutputPower, upsGroups=upsGroups, upsBasicOutputGroup=upsBasicOutputGroup, upsFullGroups=upsFullGroups, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBypassFrequency=upsBypassFrequency, upsTestResultsDetail=upsTestResultsDetail, upsInputCurrent=upsInputCurrent, upsAlarmTempBad=upsAlarmTempBad, upsAlarmsPresent=upsAlarmsPresent, upsConfigAudibleStatus=upsConfigAudibleStatus, upsOutputFrequency=upsOutputFrequency, upsWellKnownTests=upsWellKnownTests, upsControl=upsControl, upsAlarmEntry=upsAlarmEntry, upsAlarmDescr=upsAlarmDescr, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmInputBad=upsAlarmInputBad, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBatteryStatus=upsBatteryStatus, upsMIB=upsMIB, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBattery=upsBattery, upsBasicTestGroup=upsBasicTestGroup)
