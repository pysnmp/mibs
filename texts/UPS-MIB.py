...
# Produced by pysmi-1.1.8 at Tue Feb  8 22:26:55 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, NotificationType, Counter32, Integer32, ModuleIdentity, iso, ObjectIdentity, Bits, Unsigned32, IpAddress, MibIdentifier, TimeTicks, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "NotificationType", "Counter32", "Integer32", "ModuleIdentity", "iso", "ObjectIdentity", "Bits", "Unsigned32", "IpAddress", "MibIdentifier", "TimeTicks", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("UPS-MIB", upsMIB=upsMIB, upsConfigInputVoltage=upsConfigInputVoltage, upsBasicControlGroup=upsBasicControlGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsFullOutputGroup=upsFullOutputGroup, upsBatteryTemperature=upsBatteryTemperature, upsAlarmInputBad=upsAlarmInputBad, upsBasicInputGroup=upsBasicInputGroup, upsBasicGroups=upsBasicGroups, upsAlarmOnBypass=upsAlarmOnBypass, upsConfigOutputVA=upsConfigOutputVA, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsSubsetInputGroup=upsSubsetInputGroup, upsSubsetCompliance=upsSubsetCompliance, upsFullTestGroup=upsFullTestGroup, upsOutputLineIndex=upsOutputLineIndex, upsInput=upsInput, upsInputTruePower=upsInputTruePower, upsAlarmTempBad=upsAlarmTempBad, upsTest=upsTest, upsTestId=upsTestId, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsIdentName=upsIdentName, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTestSpinLock=upsTestSpinLock, upsAlarmTestInProgress=upsAlarmTestInProgress, upsSubsetIdentGroup=upsSubsetIdentGroup, upsIdent=upsIdent, upsRebootWithDuration=upsRebootWithDuration, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTestResultsDetail=upsTestResultsDetail, upsConfigOutputFreq=upsConfigOutputFreq, upsSubsetOutputGroup=upsSubsetOutputGroup, upsInputCurrent=upsInputCurrent, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAutoRestart=upsAutoRestart, upsTestStartTime=upsTestStartTime, upsBypassLineIndex=upsBypassLineIndex, upsOutputPercentLoad=upsOutputPercentLoad, upsIdentManufacturer=upsIdentManufacturer, upsFullCompliance=upsFullCompliance, upsAlarmDescr=upsAlarmDescr, upsBypassNumLines=upsBypassNumLines, upsConfigOutputPower=upsConfigOutputPower, upsAlarmFuseFailure=upsAlarmFuseFailure, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsCompliances=upsCompliances, upsBypassPower=upsBypassPower, upsConfigAudibleStatus=upsConfigAudibleStatus, upsStartupAfterDelay=upsStartupAfterDelay, upsIdentModel=upsIdentModel, upsTestElapsedTime=upsTestElapsedTime, upsBasicCompliance=upsBasicCompliance, upsFullAlarmGroup=upsFullAlarmGroup, upsBasicTestGroup=upsBasicTestGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsConfigLowBattTime=upsConfigLowBattTime, upsInputLineIndex=upsInputLineIndex, upsInputEntry=upsInputEntry, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullControlGroup=upsFullControlGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsControl=upsControl, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsInputLineBads=upsInputLineBads, upsOutputPower=upsOutputPower, upsAlarm=upsAlarm, upsBatteryCurrent=upsBatteryCurrent, upsOutputEntry=upsOutputEntry, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsObjects=upsObjects, upsBypassTable=upsBypassTable, upsBypassFrequency=upsBypassFrequency, upsFullBatteryGroup=upsFullBatteryGroup, PYSNMP_MODULE_ID=upsMIB, upsBypass=upsBypass, upsTrapOnBattery=upsTrapOnBattery, upsFullIdentGroup=upsFullIdentGroup, upsWellKnownTests=upsWellKnownTests, upsTestResultsSummary=upsTestResultsSummary, upsBasicConfigGroup=upsBasicConfigGroup, upsConformance=upsConformance, upsFullInputGroup=upsFullInputGroup, upsBypassCurrent=upsBypassCurrent, upsAlarmShutdownPending=upsAlarmShutdownPending, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, PositiveInteger=PositiveInteger, upsOutputVoltage=upsOutputVoltage, upsBatteryVoltage=upsBatteryVoltage, upsInputVoltage=upsInputVoltage, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsWellKnownAlarms=upsWellKnownAlarms, NonNegativeInteger=NonNegativeInteger, upsInputTable=upsInputTable, upsBypassVoltage=upsBypassVoltage, upsAlarmOutputBad=upsAlarmOutputBad, upsTraps=upsTraps, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsOutputSource=upsOutputSource, upsAlarmOnBattery=upsAlarmOnBattery, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsOutput=upsOutput, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsGroups=upsGroups, upsOutputFrequency=upsOutputFrequency, upsAlarmTable=upsAlarmTable, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsBatteryStatus=upsBatteryStatus, upsFullGroups=upsFullGroups, upsOutputTable=upsOutputTable, upsBasicOutputGroup=upsBasicOutputGroup, upsInputFrequency=upsInputFrequency, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsSubsetGroups=upsSubsetGroups, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsOutputCurrent=upsOutputCurrent, upsInputNumLines=upsInputNumLines, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsFullConfigGroup=upsFullConfigGroup, upsConfigInputFreq=upsConfigInputFreq, upsAlarmsPresent=upsAlarmsPresent, upsOutputNumLines=upsOutputNumLines, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmId=upsAlarmId, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSecondsOnBattery=upsSecondsOnBattery, upsBypassEntry=upsBypassEntry, upsSubsetConfigGroup=upsSubsetConfigGroup, upsConfig=upsConfig, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBattery=upsBattery, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmTime=upsAlarmTime, upsFullBypassGroup=upsFullBypassGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmEntry=upsAlarmEntry, upsSubsetControlGroup=upsSubsetControlGroup, upsShutdownType=upsShutdownType)
