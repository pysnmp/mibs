...
ModuleIdentity, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, NotificationType, TimeTicks, Counter64, Gauge32, Unsigned32, MibIdentifier, mib_2, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "NotificationType", "TimeTicks", "Counter64", "Gauge32", "Unsigned32", "MibIdentifier", "mib-2", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("UPS-MIB", upsInputEntry=upsInputEntry, upsFullOutputGroup=upsFullOutputGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsBypassPower=upsBypassPower, upsBasicCompliance=upsBasicCompliance, upsControl=upsControl, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsOutputCurrent=upsOutputCurrent, upsConfig=upsConfig, upsBasicBypassGroup=upsBasicBypassGroup, upsSubsetGroups=upsSubsetGroups, upsBattery=upsBattery, upsInput=upsInput, upsFullControlGroup=upsFullControlGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsOutput=upsOutput, upsBypassVoltage=upsBypassVoltage, upsConfigAudibleStatus=upsConfigAudibleStatus, upsFullConfigGroup=upsFullConfigGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBatteryVoltage=upsBatteryVoltage, upsOutputLineIndex=upsOutputLineIndex, upsIdentManufacturer=upsIdentManufacturer, upsTestElapsedTime=upsTestElapsedTime, upsOutputSource=upsOutputSource, upsTrapTestCompleted=upsTrapTestCompleted, PositiveInteger=PositiveInteger, upsBasicGroups=upsBasicGroups, upsBasicIdentGroup=upsBasicIdentGroup, upsTest=upsTest, upsFullInputGroup=upsFullInputGroup, upsConformance=upsConformance, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsOutputTable=upsOutputTable, upsAlarmInputBad=upsAlarmInputBad, upsOutputNumLines=upsOutputNumLines, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBypassEntry=upsBypassEntry, PYSNMP_MODULE_ID=upsMIB, upsConfigLowBattTime=upsConfigLowBattTime, upsTestSpinLock=upsTestSpinLock, upsAlarmFuseFailure=upsAlarmFuseFailure, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsInputFrequency=upsInputFrequency, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBypassFrequency=upsBypassFrequency, upsInputLineIndex=upsInputLineIndex, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmChargerFailed=upsAlarmChargerFailed, upsFullCompliance=upsFullCompliance, upsIdentModel=upsIdentModel, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsConfigInputFreq=upsConfigInputFreq, upsSubsetIdentGroup=upsSubsetIdentGroup, upsFullGroups=upsFullGroups, upsTrapOnBattery=upsTrapOnBattery, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarm=upsAlarm, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmId=upsAlarmId, upsAlarmDescr=upsAlarmDescr, upsMIB=upsMIB, upsIdent=upsIdent, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBypassTable=upsBypassTable, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsSubsetControlGroup=upsSubsetControlGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsSecondsOnBattery=upsSecondsOnBattery, upsTraps=upsTraps, upsAutoRestart=upsAutoRestart, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmFanFailure=upsAlarmFanFailure, upsConfigOutputVoltage=upsConfigOutputVoltage, upsConfigInputVoltage=upsConfigInputVoltage, upsOutputEntry=upsOutputEntry, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBasicInputGroup=upsBasicInputGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsConfigOutputVA=upsConfigOutputVA, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsOutputFrequency=upsOutputFrequency, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsInputVoltage=upsInputVoltage, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBasicTestGroup=upsBasicTestGroup, upsRebootWithDuration=upsRebootWithDuration, upsStartupAfterDelay=upsStartupAfterDelay, upsFullTestGroup=upsFullTestGroup, upsFullBypassGroup=upsFullBypassGroup, upsCompliances=upsCompliances, upsBasicControlGroup=upsBasicControlGroup, upsBatteryStatus=upsBatteryStatus, upsAlarmShutdownPending=upsAlarmShutdownPending, upsTestStartTime=upsTestStartTime, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsObjects=upsObjects, upsOutputVoltage=upsOutputVoltage, upsShutdownType=upsShutdownType, upsBasicBatteryGroup=upsBasicBatteryGroup, upsInputTable=upsInputTable, upsAlarmsPresent=upsAlarmsPresent, upsBypassLineIndex=upsBypassLineIndex, upsFullIdentGroup=upsFullIdentGroup, NonNegativeInteger=NonNegativeInteger, upsTestResultsDetail=upsTestResultsDetail, upsFullBatteryGroup=upsFullBatteryGroup, upsInputNumLines=upsInputNumLines, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmEntry=upsAlarmEntry, upsWellKnownTests=upsWellKnownTests, upsAlarmTable=upsAlarmTable, upsAlarmOnBypass=upsAlarmOnBypass, upsSubsetOutputGroup=upsSubsetOutputGroup, upsTestId=upsTestId, upsIdentName=upsIdentName, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsSubsetInputGroup=upsSubsetInputGroup, upsBypassCurrent=upsBypassCurrent, upsInputCurrent=upsInputCurrent, upsTestResultsSummary=upsTestResultsSummary, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmTempBad=upsAlarmTempBad, upsAlarmOnBattery=upsAlarmOnBattery, upsConfigOutputPower=upsConfigOutputPower, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsOutputPower=upsOutputPower, upsInputLineBads=upsInputLineBads, upsBypassNumLines=upsBypassNumLines, upsAlarmGeneralFault=upsAlarmGeneralFault, upsGroups=upsGroups, upsInputTruePower=upsInputTruePower, upsBatteryCurrent=upsBatteryCurrent, upsBatteryTemperature=upsBatteryTemperature, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmTime=upsAlarmTime, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBypass=upsBypass, upsShutdownAfterDelay=upsShutdownAfterDelay, upsSubsetCompliance=upsSubsetCompliance)
