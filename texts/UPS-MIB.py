...
# Produced by pysmi-1.1.8 at Tue Sep 12 09:32:28 2023
...
mib_2, ObjectIdentity, Counter64, NotificationType, Gauge32, Unsigned32, IpAddress, Counter32, Integer32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "ObjectIdentity", "Counter64", "NotificationType", "Gauge32", "Unsigned32", "IpAddress", "Counter32", "Integer32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("UPS-MIB", upsBypassLineIndex=upsBypassLineIndex, upsInputVoltage=upsInputVoltage, upsInputTable=upsInputTable, upsFullBypassGroup=upsFullBypassGroup, upsConfigInputFreq=upsConfigInputFreq, PositiveInteger=PositiveInteger, upsAlarmEntry=upsAlarmEntry, upsTestStartTime=upsTestStartTime, upsConfigOutputPower=upsConfigOutputPower, upsAlarmTime=upsAlarmTime, upsFullOutputGroup=upsFullOutputGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsFullConfigGroup=upsFullConfigGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsControl=upsControl, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBasicCompliance=upsBasicCompliance, upsAlarmChargerFailed=upsAlarmChargerFailed, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsInputCurrent=upsInputCurrent, upsInputLineIndex=upsInputLineIndex, upsBypass=upsBypass, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsBasicBypassGroup=upsBasicBypassGroup, upsGroups=upsGroups, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, PYSNMP_MODULE_ID=upsMIB, upsAlarmFuseFailure=upsAlarmFuseFailure, NonNegativeInteger=NonNegativeInteger, upsAutoRestart=upsAutoRestart, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTestId=upsTestId, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsFullAlarmGroup=upsFullAlarmGroup, upsOutputVoltage=upsOutputVoltage, upsShutdownType=upsShutdownType, upsInputTruePower=upsInputTruePower, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarm=upsAlarm, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmsPresent=upsAlarmsPresent, upsAlarmInputBad=upsAlarmInputBad, upsFullGroups=upsFullGroups, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsStartupAfterDelay=upsStartupAfterDelay, upsCompliances=upsCompliances, upsOutputFrequency=upsOutputFrequency, upsTestElapsedTime=upsTestElapsedTime, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmTempBad=upsAlarmTempBad, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsInputNumLines=upsInputNumLines, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBattery=upsBattery, upsConfig=upsConfig, upsAlarmOutputBad=upsAlarmOutputBad, upsIdentManufacturer=upsIdentManufacturer, upsAlarmDescr=upsAlarmDescr, upsAlarmTable=upsAlarmTable, upsBypassTable=upsBypassTable, upsBasicIdentGroup=upsBasicIdentGroup, upsFullInputGroup=upsFullInputGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsFullControlGroup=upsFullControlGroup, upsOutputNumLines=upsOutputNumLines, upsBypassCurrent=upsBypassCurrent, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBasicConfigGroup=upsBasicConfigGroup, upsBatteryTemperature=upsBatteryTemperature, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTrapOnBattery=upsTrapOnBattery, upsBatteryVoltage=upsBatteryVoltage, upsBatteryCurrent=upsBatteryCurrent, upsBypassVoltage=upsBypassVoltage, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTraps=upsTraps, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTestResultsDetail=upsTestResultsDetail, upsBypassFrequency=upsBypassFrequency, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBasicTestGroup=upsBasicTestGroup, upsBatteryStatus=upsBatteryStatus, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBasicGroups=upsBasicGroups, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBypassEntry=upsBypassEntry, upsConformance=upsConformance, upsIdentName=upsIdentName, upsSubsetInputGroup=upsSubsetInputGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsOutputCurrent=upsOutputCurrent, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBypassPower=upsBypassPower, upsOutputPower=upsOutputPower, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConfigOutputFreq=upsConfigOutputFreq, upsOutput=upsOutput, upsInputFrequency=upsInputFrequency, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsConfigLowBattTime=upsConfigLowBattTime, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsSecondsOnBattery=upsSecondsOnBattery, upsOutputTable=upsOutputTable, upsBasicControlGroup=upsBasicControlGroup, upsBypassNumLines=upsBypassNumLines, upsFullBatteryGroup=upsFullBatteryGroup, upsSubsetGroups=upsSubsetGroups, upsTest=upsTest, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsInputEntry=upsInputEntry, upsOutputPercentLoad=upsOutputPercentLoad, upsSubsetOutputGroup=upsSubsetOutputGroup, upsMIB=upsMIB, upsIdent=upsIdent, upsAlarmOnBattery=upsAlarmOnBattery, upsWellKnownTests=upsWellKnownTests, upsTrapTestCompleted=upsTrapTestCompleted, upsInputLineBads=upsInputLineBads, upsSubsetCompliance=upsSubsetCompliance, upsAlarmLowBattery=upsAlarmLowBattery, upsConfigAudibleStatus=upsConfigAudibleStatus, upsConfigOutputVoltage=upsConfigOutputVoltage, upsIdentModel=upsIdentModel, upsOutputLineIndex=upsOutputLineIndex, upsFullCompliance=upsFullCompliance, upsInput=upsInput, upsBasicAlarmGroup=upsBasicAlarmGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmId=upsAlarmId, upsObjects=upsObjects, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTestSpinLock=upsTestSpinLock, upsConfigOutputVA=upsConfigOutputVA, upsTestResultsSummary=upsTestResultsSummary, upsAlarmGeneralFault=upsAlarmGeneralFault, upsFullIdentGroup=upsFullIdentGroup, upsBasicInputGroup=upsBasicInputGroup, upsOutputSource=upsOutputSource, upsOutputEntry=upsOutputEntry, upsFullTestGroup=upsFullTestGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsRebootWithDuration=upsRebootWithDuration)
