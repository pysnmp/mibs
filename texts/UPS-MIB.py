...
# Produced by pysmi-1.1.8 at Wed Oct 11 08:24:45 2023
...
mib_2, Bits, TimeTicks, MibIdentifier, Counter64, Counter32, ObjectIdentity, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, ModuleIdentity, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Bits", "TimeTicks", "MibIdentifier", "Counter64", "Counter32", "ObjectIdentity", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "ModuleIdentity", "Integer32", "NotificationType")
TestAndIncr, TextualConvention, TimeInterval, TimeStamp, AutonomousType, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TextualConvention", "TimeInterval", "TimeStamp", "AutonomousType", "DisplayString")
...
mibBuilder.exportSymbols("UPS-MIB", upsMIB=upsMIB, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmOutputBad=upsAlarmOutputBad, upsConfigOutputPower=upsConfigOutputPower, upsObjects=upsObjects, upsIdentAttachedDevices=upsIdentAttachedDevices, upsSecondsOnBattery=upsSecondsOnBattery, upsBasicTestGroup=upsBasicTestGroup, upsInputTable=upsInputTable, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsSubsetIdentGroup=upsSubsetIdentGroup, upsFullIdentGroup=upsFullIdentGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTrapTestCompleted=upsTrapTestCompleted, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBypassLineIndex=upsBypassLineIndex, upsConfigOutputVoltage=upsConfigOutputVoltage, upsCompliances=upsCompliances, upsSubsetCompliance=upsSubsetCompliance, upsSubsetOutputGroup=upsSubsetOutputGroup, upsOutputNumLines=upsOutputNumLines, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBypassTable=upsBypassTable, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsInputNumLines=upsInputNumLines, upsBatteryTemperature=upsBatteryTemperature, upsInputLineBads=upsInputLineBads, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBasicIdentGroup=upsBasicIdentGroup, upsFullGroups=upsFullGroups, upsBattery=upsBattery, upsAlarmId=upsAlarmId, upsAlarmTime=upsAlarmTime, upsFullOutputGroup=upsFullOutputGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAutoRestart=upsAutoRestart, upsBasicBypassGroup=upsBasicBypassGroup, upsBatteryVoltage=upsBatteryVoltage, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBatteryCurrent=upsBatteryCurrent, upsOutputEntry=upsOutputEntry, upsTraps=upsTraps, PYSNMP_MODULE_ID=upsMIB, upsWellKnownTests=upsWellKnownTests, upsAlarmFanFailure=upsAlarmFanFailure, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTestStartTime=upsTestStartTime, upsSubsetControlGroup=upsSubsetControlGroup, upsRebootWithDuration=upsRebootWithDuration, upsTestResultsSummary=upsTestResultsSummary, upsFullConfigGroup=upsFullConfigGroup, upsInputCurrent=upsInputCurrent, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBasicGroups=upsBasicGroups, upsConfigLowBattTime=upsConfigLowBattTime, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsInputLineIndex=upsInputLineIndex, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsIdentName=upsIdentName, upsTest=upsTest, upsInputFrequency=upsInputFrequency, upsIdent=upsIdent, upsOutputSource=upsOutputSource, upsOutputPercentLoad=upsOutputPercentLoad, upsBypassPower=upsBypassPower, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTrapOnBattery=upsTrapOnBattery, NonNegativeInteger=NonNegativeInteger, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarm=upsAlarm, upsAlarmEntry=upsAlarmEntry, upsOutputTable=upsOutputTable, upsTestId=upsTestId, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBypassFrequency=upsBypassFrequency, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBypassEntry=upsBypassEntry, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsConfigInputFreq=upsConfigInputFreq, upsFullBypassGroup=upsFullBypassGroup, upsGroups=upsGroups, upsConfigInputVoltage=upsConfigInputVoltage, upsBypass=upsBypass, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmOnBypass=upsAlarmOnBypass, upsOutputLineIndex=upsOutputLineIndex, upsAlarmTempBad=upsAlarmTempBad, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmInputBad=upsAlarmInputBad, upsTestSpinLock=upsTestSpinLock, upsTestResultsDetail=upsTestResultsDetail, upsConfigOutputVA=upsConfigOutputVA, PositiveInteger=PositiveInteger, upsConfig=upsConfig, upsBypassNumLines=upsBypassNumLines, upsAlarmDescr=upsAlarmDescr, upsTestElapsedTime=upsTestElapsedTime, upsIdentModel=upsIdentModel, upsBatteryStatus=upsBatteryStatus, upsInput=upsInput, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetInputGroup=upsSubsetInputGroup, upsFullInputGroup=upsFullInputGroup, upsFullControlGroup=upsFullControlGroup, upsAlarmsPresent=upsAlarmsPresent, upsInputTruePower=upsInputTruePower, upsOutputVoltage=upsOutputVoltage, upsOutputFrequency=upsOutputFrequency, upsControl=upsControl, upsFullTestGroup=upsFullTestGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsOutputPower=upsOutputPower, upsBasicConfigGroup=upsBasicConfigGroup, upsInputEntry=upsInputEntry, upsInputVoltage=upsInputVoltage, upsShutdownType=upsShutdownType, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBasicInputGroup=upsBasicInputGroup, upsBypassCurrent=upsBypassCurrent, upsWellKnownAlarms=upsWellKnownAlarms, upsSubsetConfigGroup=upsSubsetConfigGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBasicControlGroup=upsBasicControlGroup, upsBasicCompliance=upsBasicCompliance, upsFullAlarmGroup=upsFullAlarmGroup, upsBypassVoltage=upsBypassVoltage, upsAlarmTable=upsAlarmTable, upsFullCompliance=upsFullCompliance, upsConfigAudibleStatus=upsConfigAudibleStatus, upsIdentManufacturer=upsIdentManufacturer, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsOutput=upsOutput, upsSubsetGroups=upsSubsetGroups, upsConfigOutputFreq=upsConfigOutputFreq, upsConformance=upsConformance, upsOutputCurrent=upsOutputCurrent, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint)
