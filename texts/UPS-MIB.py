...
iso, Bits, mib_2, Counter64, ModuleIdentity, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, IpAddress, Gauge32, ObjectIdentity, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "mib-2", "Counter64", "ModuleIdentity", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "IpAddress", "Gauge32", "ObjectIdentity", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("UPS-MIB", upsBatteryTemperature=upsBatteryTemperature, upsBasicBypassGroup=upsBasicBypassGroup, upsConfigOutputPower=upsConfigOutputPower, upsBattery=upsBattery, upsConfigLowBattTime=upsConfigLowBattTime, upsCompliances=upsCompliances, upsOutputTable=upsOutputTable, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBypassCurrent=upsBypassCurrent, upsInputCurrent=upsInputCurrent, upsRebootWithDuration=upsRebootWithDuration, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmBypassBad=upsAlarmBypassBad, upsWellKnownAlarms=upsWellKnownAlarms, upsTraps=upsTraps, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBasicTestGroup=upsBasicTestGroup, upsFullIdentGroup=upsFullIdentGroup, upsFullOutputGroup=upsFullOutputGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTestElapsedTime=upsTestElapsedTime, upsOutputVoltage=upsOutputVoltage, upsAlarmTempBad=upsAlarmTempBad, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsIdentModel=upsIdentModel, upsMIB=upsMIB, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmDescr=upsAlarmDescr, upsInputEntry=upsInputEntry, upsConfigInputFreq=upsConfigInputFreq, upsSubsetIdentGroup=upsSubsetIdentGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsOutputFrequency=upsOutputFrequency, upsTestStartTime=upsTestStartTime, upsBasicCompliance=upsBasicCompliance, upsAlarmEntry=upsAlarmEntry, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsInputFrequency=upsInputFrequency, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsFullCompliance=upsFullCompliance, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmFuseFailure=upsAlarmFuseFailure, upsInputVoltage=upsInputVoltage, upsSubsetGroups=upsSubsetGroups, upsInputTable=upsInputTable, upsIdentName=upsIdentName, upsAlarmTable=upsAlarmTable, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsConformance=upsConformance, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsFullInputGroup=upsFullInputGroup, upsBypass=upsBypass, upsInputNumLines=upsInputNumLines, upsAlarmId=upsAlarmId, upsAlarmBatteryBad=upsAlarmBatteryBad, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicConfigGroup=upsBasicConfigGroup, upsBypassPower=upsBypassPower, upsAlarmsPresent=upsAlarmsPresent, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsWellKnownTests=upsWellKnownTests, upsConfigOutputVoltage=upsConfigOutputVoltage, upsOutputPower=upsOutputPower, upsInput=upsInput, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsControl=upsControl, upsIdentManufacturer=upsIdentManufacturer, upsAlarmOnBattery=upsAlarmOnBattery, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutputCurrent=upsOutputCurrent, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConfig=upsConfig, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsTest=upsTest, upsGroups=upsGroups, upsBypassFrequency=upsBypassFrequency, upsAlarm=upsAlarm, upsStartupAfterDelay=upsStartupAfterDelay, upsSubsetCompliance=upsSubsetCompliance, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTestId=upsTestId, upsBypassEntry=upsBypassEntry, upsInputTruePower=upsInputTruePower, upsOutputEntry=upsOutputEntry, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestResultsSummary=upsTestResultsSummary, upsTestResultsDetail=upsTestResultsDetail, upsSecondsOnBattery=upsSecondsOnBattery, upsShutdownType=upsShutdownType, NonNegativeInteger=NonNegativeInteger, upsSubsetOutputGroup=upsSubsetOutputGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmOnBypass=upsAlarmOnBypass, PYSNMP_MODULE_ID=upsMIB, upsBypassLineIndex=upsBypassLineIndex, upsAutoRestart=upsAutoRestart, upsFullBypassGroup=upsFullBypassGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmTime=upsAlarmTime, upsAlarmInputBad=upsAlarmInputBad, upsOutputLineIndex=upsOutputLineIndex, upsAlarmLowBattery=upsAlarmLowBattery, upsTestSpinLock=upsTestSpinLock, upsConfigAudibleStatus=upsConfigAudibleStatus, upsConfigOutputVA=upsConfigOutputVA, upsAlarmOutputBad=upsAlarmOutputBad, upsInputLineBads=upsInputLineBads, upsBasicGroups=upsBasicGroups, upsFullGroups=upsFullGroups, upsInputLineIndex=upsInputLineIndex, upsBypassVoltage=upsBypassVoltage, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBatteryCurrent=upsBatteryCurrent, upsIdent=upsIdent, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsFullConfigGroup=upsFullConfigGroup, upsBasicInputGroup=upsBasicInputGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutputNumLines=upsOutputNumLines, upsFullControlGroup=upsFullControlGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsBypassNumLines=upsBypassNumLines, upsBatteryVoltage=upsBatteryVoltage, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsFullTestGroup=upsFullTestGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsOutput=upsOutput, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsObjects=upsObjects, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigInputVoltage=upsConfigInputVoltage, upsBatteryStatus=upsBatteryStatus, upsBasicControlGroup=upsBasicControlGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsOutputSource=upsOutputSource, upsBypassTable=upsBypassTable, upsAlarmGeneralFault=upsAlarmGeneralFault, PositiveInteger=PositiveInteger, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTrapOnBattery=upsTrapOnBattery, upsAlarmTestInProgress=upsAlarmTestInProgress, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBasicAlarmGroup=upsBasicAlarmGroup)
