...
mibBuilder.exportSymbols("UPS-MIB", upsFullConfigGroup=upsFullConfigGroup, upsTest=upsTest, upsMIB=upsMIB, upsBasicConfigGroup=upsBasicConfigGroup, upsConfig=upsConfig, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmChargerFailed=upsAlarmChargerFailed, upsInputEntry=upsInputEntry, upsTestId=upsTestId, upsSubsetCompliance=upsSubsetCompliance, upsSecondsOnBattery=upsSecondsOnBattery, upsOutput=upsOutput, upsOutputSource=upsOutputSource, upsTestSpinLock=upsTestSpinLock, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsIdentAttachedDevices=upsIdentAttachedDevices, upsIdentName=upsIdentName, upsConfigOutputVA=upsConfigOutputVA, upsOutputNumLines=upsOutputNumLines, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBypass=upsBypass, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBasicIdentGroup=upsBasicIdentGroup, upsInputVoltage=upsInputVoltage, upsBypassTable=upsBypassTable, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsSubsetControlGroup=upsSubsetControlGroup, upsOutputVoltage=upsOutputVoltage, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsInputTable=upsInputTable, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsOutputCurrent=upsOutputCurrent, upsAlarm=upsAlarm, upsAlarmDescr=upsAlarmDescr, upsCompliances=upsCompliances, upsFullOutputGroup=upsFullOutputGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, PYSNMP_MODULE_ID=upsMIB, upsBypassPower=upsBypassPower, upsBypassCurrent=upsBypassCurrent, upsBasicBypassGroup=upsBasicBypassGroup, upsBatteryStatus=upsBatteryStatus, upsConfigAudibleStatus=upsConfigAudibleStatus, upsConformance=upsConformance, upsBypassVoltage=upsBypassVoltage, upsBypassEntry=upsBypassEntry, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmTestInProgress=upsAlarmTestInProgress, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsInputLineBads=upsInputLineBads, upsBasicControlGroup=upsBasicControlGroup, PositiveInteger=PositiveInteger, upsIdentModel=upsIdentModel, upsIdent=upsIdent, upsFullIdentGroup=upsFullIdentGroup, upsFullTestGroup=upsFullTestGroup, upsFullInputGroup=upsFullInputGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmTime=upsAlarmTime, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmLowBattery=upsAlarmLowBattery, upsBattery=upsBattery, upsFullAlarmGroup=upsFullAlarmGroup, upsFullBypassGroup=upsFullBypassGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsInput=upsInput, upsIdentManufacturer=upsIdentManufacturer, upsFullGroups=upsFullGroups, upsFullCompliance=upsFullCompliance, upsFullBatteryGroup=upsFullBatteryGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsSubsetGroups=upsSubsetGroups, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTestElapsedTime=upsTestElapsedTime, upsControl=upsControl, upsConfigInputFreq=upsConfigInputFreq, upsOutputTable=upsOutputTable, upsTestStartTime=upsTestStartTime, upsAlarmsPresent=upsAlarmsPresent, upsBasicAlarmGroup=upsBasicAlarmGroup, upsConfigOutputPower=upsConfigOutputPower, upsTestResultsSummary=upsTestResultsSummary, NonNegativeInteger=NonNegativeInteger, upsRebootWithDuration=upsRebootWithDuration, upsOutputPower=upsOutputPower, upsBasicCompliance=upsBasicCompliance, upsWellKnownAlarms=upsWellKnownAlarms, upsBatteryVoltage=upsBatteryVoltage, upsBypassNumLines=upsBypassNumLines, upsInputFrequency=upsInputFrequency, upsAlarmOutputBad=upsAlarmOutputBad, upsObjects=upsObjects, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBatteryTemperature=upsBatteryTemperature, upsAlarmShutdownPending=upsAlarmShutdownPending, upsInputCurrent=upsInputCurrent, upsShutdownType=upsShutdownType, upsInputNumLines=upsInputNumLines, upsAlarmOutputOverload=upsAlarmOutputOverload, upsOutputFrequency=upsOutputFrequency, upsWellKnownTests=upsWellKnownTests, upsFullControlGroup=upsFullControlGroup, upsBasicInputGroup=upsBasicInputGroup, upsTestResultsDetail=upsTestResultsDetail, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsSubsetConfigGroup=upsSubsetConfigGroup, upsOutputLineIndex=upsOutputLineIndex, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmInputBad=upsAlarmInputBad, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTraps=upsTraps, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmFuseFailure=upsAlarmFuseFailure, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsConfigInputVoltage=upsConfigInputVoltage, upsOutputEntry=upsOutputEntry, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmEntry=upsAlarmEntry, upsAlarmTempBad=upsAlarmTempBad, upsBatteryCurrent=upsBatteryCurrent, upsInputTruePower=upsInputTruePower, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsGroups=upsGroups, upsTrapOnBattery=upsTrapOnBattery, upsBypassFrequency=upsBypassFrequency, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmId=upsAlarmId, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmOnBattery=upsAlarmOnBattery, upsBasicGroups=upsBasicGroups, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAutoRestart=upsAutoRestart, upsBasicTestGroup=upsBasicTestGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsInputLineIndex=upsInputLineIndex, upsOutputPercentLoad=upsOutputPercentLoad, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmTable=upsAlarmTable, upsBypassLineIndex=upsBypassLineIndex)
