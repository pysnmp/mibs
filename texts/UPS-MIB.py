...
mibBuilder.exportSymbols("UPS-MIB", upsTrapTestCompleted=upsTrapTestCompleted, upsTraps=upsTraps, upsMIB=upsMIB, upsAlarmTestInProgress=upsAlarmTestInProgress, upsRebootWithDuration=upsRebootWithDuration, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSecondsOnBattery=upsSecondsOnBattery, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsOutputSource=upsOutputSource, upsBypassVoltage=upsBypassVoltage, upsAlarmFuseFailure=upsAlarmFuseFailure, upsFullGroups=upsFullGroups, upsAlarmOutputOverload=upsAlarmOutputOverload, upsOutputFrequency=upsOutputFrequency, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsInput=upsInput, upsBasicTestGroup=upsBasicTestGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsFullTestGroup=upsFullTestGroup, upsBypassTable=upsBypassTable, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsSubsetIdentGroup=upsSubsetIdentGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsBatteryStatus=upsBatteryStatus, upsWellKnownAlarms=upsWellKnownAlarms, upsShutdownAfterDelay=upsShutdownAfterDelay, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAutoRestart=upsAutoRestart, upsSubsetCompliance=upsSubsetCompliance, upsAlarm=upsAlarm, upsConformance=upsConformance, upsWellKnownTests=upsWellKnownTests, upsAlarmTempBad=upsAlarmTempBad, upsBypassCurrent=upsBypassCurrent, upsTestResultsDetail=upsTestResultsDetail, upsAlarmOnBypass=upsAlarmOnBypass, upsConfigOutputFreq=upsConfigOutputFreq, upsInputLineIndex=upsInputLineIndex, upsBatteryTemperature=upsBatteryTemperature, upsOutputPower=upsOutputPower, upsOutputEntry=upsOutputEntry, upsOutputVoltage=upsOutputVoltage, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsOutput=upsOutput, upsBypassLineIndex=upsBypassLineIndex, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsInputNumLines=upsInputNumLines, upsAlarmShutdownPending=upsAlarmShutdownPending, upsInputTable=upsInputTable, upsOutputCurrent=upsOutputCurrent, upsInputVoltage=upsInputVoltage, upsAlarmId=upsAlarmId, upsInputLineBads=upsInputLineBads, upsObjects=upsObjects, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmDescr=upsAlarmDescr, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBasicBypassGroup=upsBasicBypassGroup, upsBatteryCurrent=upsBatteryCurrent, upsFullAlarmGroup=upsFullAlarmGroup, upsTrapOnBattery=upsTrapOnBattery, upsOutputLineIndex=upsOutputLineIndex, upsBypassNumLines=upsBypassNumLines, upsBypassFrequency=upsBypassFrequency, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmOutputBad=upsAlarmOutputBad, upsTestId=upsTestId, upsTestElapsedTime=upsTestElapsedTime, upsBypassEntry=upsBypassEntry, upsShutdownType=upsShutdownType, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullCompliance=upsFullCompliance, upsBypass=upsBypass, upsBypassPower=upsBypassPower, NonNegativeInteger=NonNegativeInteger, upsInputTruePower=upsInputTruePower, upsBasicControlGroup=upsBasicControlGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBasicBatteryGroup=upsBasicBatteryGroup, upsInputCurrent=upsInputCurrent, upsAlarmTime=upsAlarmTime, upsFullBatteryGroup=upsFullBatteryGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmTable=upsAlarmTable, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBattery=upsBattery, upsIdentManufacturer=upsIdentManufacturer, upsSubsetControlGroup=upsSubsetControlGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmInputBad=upsAlarmInputBad, upsControl=upsControl, upsSubsetGroups=upsSubsetGroups, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsConfigOutputVA=upsConfigOutputVA, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicInputGroup=upsBasicInputGroup, upsIdent=upsIdent, upsAlarmBypassBad=upsAlarmBypassBad, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsTestSpinLock=upsTestSpinLock, upsBasicConfigGroup=upsBasicConfigGroup, upsGroups=upsGroups, PYSNMP_MODULE_ID=upsMIB, upsIdentName=upsIdentName, upsCompliances=upsCompliances, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsIdentModel=upsIdentModel, upsFullConfigGroup=upsFullConfigGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicCompliance=upsBasicCompliance, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTestStartTime=upsTestStartTime, upsBatteryVoltage=upsBatteryVoltage, upsOutputNumLines=upsOutputNumLines, upsFullControlGroup=upsFullControlGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsOutputTable=upsOutputTable, upsFullInputGroup=upsFullInputGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmEntry=upsAlarmEntry, upsFullIdentGroup=upsFullIdentGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsOutputPercentLoad=upsOutputPercentLoad, upsTest=upsTest, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsInputEntry=upsInputEntry, upsStartupAfterDelay=upsStartupAfterDelay, upsBasicGroups=upsBasicGroups, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsConfig=upsConfig, upsAlarmsPresent=upsAlarmsPresent, PositiveInteger=PositiveInteger, upsInputFrequency=upsInputFrequency, upsConfigOutputPower=upsConfigOutputPower, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsConfigInputFreq=upsConfigInputFreq, upsFullBypassGroup=upsFullBypassGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsTestResultsSummary=upsTestResultsSummary, upsFullOutputGroup=upsFullOutputGroup)
