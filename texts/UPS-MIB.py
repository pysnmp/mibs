...
# Produced by pysmi-1.1.12 at Fri Nov 22 15:07:32 2024
...
Counter32, Bits, Counter64, Unsigned32, ObjectIdentity, Gauge32, MibIdentifier, Integer32, NotificationType, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "Counter64", "Unsigned32", "ObjectIdentity", "Gauge32", "MibIdentifier", "Integer32", "NotificationType", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("UPS-MIB", upsObjects=upsObjects, upsConfigInputFreq=upsConfigInputFreq, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsControl=upsControl, upsInputNumLines=upsInputNumLines, upsTestStartTime=upsTestStartTime, upsBypassFrequency=upsBypassFrequency, upsConfigLowBattTime=upsConfigLowBattTime, PYSNMP_MODULE_ID=upsMIB, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmInputBad=upsAlarmInputBad, upsBasicInputGroup=upsBasicInputGroup, upsInputTruePower=upsInputTruePower, upsFullAlarmGroup=upsFullAlarmGroup, upsOutputPower=upsOutputPower, upsFullInputGroup=upsFullInputGroup, upsBatteryStatus=upsBatteryStatus, upsAlarmsPresent=upsAlarmsPresent, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmFanFailure=upsAlarmFanFailure, upsBypassTable=upsBypassTable, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutputLineIndex=upsOutputLineIndex, upsAlarmTime=upsAlarmTime, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsShutdownType=upsShutdownType, upsFullOutputGroup=upsFullOutputGroup, upsBypassNumLines=upsBypassNumLines, upsAlarm=upsAlarm, upsBasicOutputGroup=upsBasicOutputGroup, upsOutputSource=upsOutputSource, upsOutputEntry=upsOutputEntry, upsInputFrequency=upsInputFrequency, upsAlarmOnBypass=upsAlarmOnBypass, upsTrapTestCompleted=upsTrapTestCompleted, upsSecondsOnBattery=upsSecondsOnBattery, upsTrapOnBattery=upsTrapOnBattery, upsConfigInputVoltage=upsConfigInputVoltage, upsBasicBypassGroup=upsBasicBypassGroup, upsInputLineIndex=upsInputLineIndex, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBasicGroups=upsBasicGroups, upsBatteryVoltage=upsBatteryVoltage, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBasicAlarmGroup=upsBasicAlarmGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsIdentName=upsIdentName, upsSubsetInputGroup=upsSubsetInputGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsFullBatteryGroup=upsFullBatteryGroup, upsInputVoltage=upsInputVoltage, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsInputEntry=upsInputEntry, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmEntry=upsAlarmEntry, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmTable=upsAlarmTable, upsBattery=upsBattery, upsTestId=upsTestId, upsInput=upsInput, upsFullConfigGroup=upsFullConfigGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTestResultsSummary=upsTestResultsSummary, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBypassPower=upsBypassPower, upsOutputNumLines=upsOutputNumLines, upsAlarmBatteryBad=upsAlarmBatteryBad, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsGroups=upsGroups, upsConfigOutputVA=upsConfigOutputVA, upsBypass=upsBypass, upsFullTestGroup=upsFullTestGroup, upsConfig=upsConfig, upsInputCurrent=upsInputCurrent, upsAutoRestart=upsAutoRestart, upsInputTable=upsInputTable, upsFullIdentGroup=upsFullIdentGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsTraps=upsTraps, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsShutdownAfterDelay=upsShutdownAfterDelay, upsTestElapsedTime=upsTestElapsedTime, upsOutputTable=upsOutputTable, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBatteryTemperature=upsBatteryTemperature, upsInputLineBads=upsInputLineBads, upsTestSpinLock=upsTestSpinLock, upsBypassLineIndex=upsBypassLineIndex, upsAlarmDescr=upsAlarmDescr, upsBasicConfigGroup=upsBasicConfigGroup, upsConformance=upsConformance, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBypassCurrent=upsBypassCurrent, upsSubsetCompliance=upsSubsetCompliance, upsWellKnownAlarms=upsWellKnownAlarms, upsTestResultsDetail=upsTestResultsDetail, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullBypassGroup=upsFullBypassGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsFullCompliance=upsFullCompliance, NonNegativeInteger=NonNegativeInteger, upsBatteryCurrent=upsBatteryCurrent, upsBypassVoltage=upsBypassVoltage, upsMIB=upsMIB, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsOutputVoltage=upsOutputVoltage, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutputCurrent=upsOutputCurrent, upsAlarmOnBattery=upsAlarmOnBattery, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullGroups=upsFullGroups, upsOutputPercentLoad=upsOutputPercentLoad, upsBypassEntry=upsBypassEntry, upsSubsetControlGroup=upsSubsetControlGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmTempBad=upsAlarmTempBad, upsRebootWithDuration=upsRebootWithDuration, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsIdentManufacturer=upsIdentManufacturer, upsStartupAfterDelay=upsStartupAfterDelay, upsBasicControlGroup=upsBasicControlGroup, upsIdent=upsIdent, upsConfigOutputFreq=upsConfigOutputFreq, upsCompliances=upsCompliances, PositiveInteger=PositiveInteger, upsAlarmFuseFailure=upsAlarmFuseFailure, upsIdentModel=upsIdentModel, upsOutput=upsOutput, upsBasicTestGroup=upsBasicTestGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsWellKnownTests=upsWellKnownTests, upsAlarmBypassBad=upsAlarmBypassBad, upsFullControlGroup=upsFullControlGroup, upsAlarmId=upsAlarmId, upsOutputFrequency=upsOutputFrequency, upsTest=upsTest, upsSubsetGroups=upsSubsetGroups, upsBasicCompliance=upsBasicCompliance, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsConfigOutputPower=upsConfigOutputPower)
