...
mibBuilder.exportSymbols("UPS-MIB", upsInputVoltage=upsInputVoltage, upsBasicCompliance=upsBasicCompliance, upsRebootWithDuration=upsRebootWithDuration, upsFullCompliance=upsFullCompliance, upsBasicInputGroup=upsBasicInputGroup, upsOutputNumLines=upsOutputNumLines, upsConfigOutputFreq=upsConfigOutputFreq, upsSubsetOutputGroup=upsSubsetOutputGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsSubsetInputGroup=upsSubsetInputGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsInputLineIndex=upsInputLineIndex, upsAlarm=upsAlarm, upsAlarmOnBattery=upsAlarmOnBattery, upsBypassCurrent=upsBypassCurrent, upsBypassNumLines=upsBypassNumLines, upsIdentManufacturer=upsIdentManufacturer, upsFullInputGroup=upsFullInputGroup, upsTestResultsDetail=upsTestResultsDetail, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmEntry=upsAlarmEntry, upsConformance=upsConformance, upsBatteryTemperature=upsBatteryTemperature, upsBasicConfigGroup=upsBasicConfigGroup, upsMIB=upsMIB, upsFullIdentGroup=upsFullIdentGroup, upsInputLineBads=upsInputLineBads, PYSNMP_MODULE_ID=upsMIB, upsAlarmsPresent=upsAlarmsPresent, upsBatteryVoltage=upsBatteryVoltage, upsTrapOnBattery=upsTrapOnBattery, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsInputFrequency=upsInputFrequency, upsTestStartTime=upsTestStartTime, upsOutputFrequency=upsOutputFrequency, upsOutput=upsOutput, upsAlarmDescr=upsAlarmDescr, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBatteryStatus=upsBatteryStatus, upsFullGroups=upsFullGroups, upsAlarmFanFailure=upsAlarmFanFailure, upsOutputLineIndex=upsOutputLineIndex, upsAlarmOutputOverload=upsAlarmOutputOverload, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsFullControlGroup=upsFullControlGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBypassPower=upsBypassPower, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmOutputBad=upsAlarmOutputBad, upsOutputEntry=upsOutputEntry, upsTestResultsSummary=upsTestResultsSummary, upsBasicGroups=upsBasicGroups, upsInputEntry=upsInputEntry, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsFullConfigGroup=upsFullConfigGroup, upsObjects=upsObjects, upsTestSpinLock=upsTestSpinLock, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTest=upsTest, upsBypassVoltage=upsBypassVoltage, upsConfigOutputVoltage=upsConfigOutputVoltage, upsInputCurrent=upsInputCurrent, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsGroups=upsGroups, upsBypass=upsBypass, upsWellKnownTests=upsWellKnownTests, upsFullAlarmGroup=upsFullAlarmGroup, upsBypassTable=upsBypassTable, upsInput=upsInput, upsFullBypassGroup=upsFullBypassGroup, upsOutputVoltage=upsOutputVoltage, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConfigInputFreq=upsConfigInputFreq, upsAlarmInputBad=upsAlarmInputBad, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsFullOutputGroup=upsFullOutputGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsBypassLineIndex=upsBypassLineIndex, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, PositiveInteger=PositiveInteger, upsIdentModel=upsIdentModel, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsInputTable=upsInputTable, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBypassEntry=upsBypassEntry, NonNegativeInteger=NonNegativeInteger, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsCompliances=upsCompliances, upsAlarmBypassBad=upsAlarmBypassBad, upsBasicTestGroup=upsBasicTestGroup, upsAlarmTime=upsAlarmTime, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsSubsetCompliance=upsSubsetCompliance, upsInputTruePower=upsInputTruePower, upsBatteryCurrent=upsBatteryCurrent, upsBasicIdentGroup=upsBasicIdentGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsBattery=upsBattery, upsAlarmTestInProgress=upsAlarmTestInProgress, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAutoRestart=upsAutoRestart, upsConfigOutputPower=upsConfigOutputPower, upsTraps=upsTraps, upsStartupAfterDelay=upsStartupAfterDelay, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutputTable=upsOutputTable, upsInputNumLines=upsInputNumLines, upsIdentName=upsIdentName, upsTestId=upsTestId, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsSecondsOnBattery=upsSecondsOnBattery, upsConfigAudibleStatus=upsConfigAudibleStatus, upsSubsetGroups=upsSubsetGroups, upsOutputCurrent=upsOutputCurrent, upsAlarmBatteryBad=upsAlarmBatteryBad, upsOutputPower=upsOutputPower, upsBasicOutputGroup=upsBasicOutputGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsControl=upsControl, upsShutdownType=upsShutdownType, upsBasicControlGroup=upsBasicControlGroup, upsAlarmTempBad=upsAlarmTempBad, upsTrapTestCompleted=upsTrapTestCompleted, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigInputVoltage=upsConfigInputVoltage, upsOutputSource=upsOutputSource, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsIdent=upsIdent, upsAlarmFuseFailure=upsAlarmFuseFailure, upsConfigOutputVA=upsConfigOutputVA, upsAlarmTable=upsAlarmTable, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestElapsedTime=upsTestElapsedTime, upsBypassFrequency=upsBypassFrequency, upsAlarmGeneralFault=upsAlarmGeneralFault, upsWellKnownAlarms=upsWellKnownAlarms, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsConfig=upsConfig, upsFullTestGroup=upsFullTestGroup, upsAlarmId=upsAlarmId)
