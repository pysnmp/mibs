...
# Produced by pysmi-1.1.8 at Thu Dec 15 08:19:12 2022
...
Integer32, Counter32, ModuleIdentity, Gauge32, MibIdentifier, IpAddress, Counter64, mib_2, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "ModuleIdentity", "Gauge32", "MibIdentifier", "IpAddress", "Counter64", "mib-2", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("UPS-MIB", upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmInputBad=upsAlarmInputBad, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTest=upsTest, upsTestStartTime=upsTestStartTime, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTestResultsDetail=upsTestResultsDetail, upsAlarmDescr=upsAlarmDescr, upsFullGroups=upsFullGroups, PYSNMP_MODULE_ID=upsMIB, upsSubsetGroups=upsSubsetGroups, upsBasicIdentGroup=upsBasicIdentGroup, upsObjects=upsObjects, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBasicInputGroup=upsBasicInputGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsIdentName=upsIdentName, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTraps=upsTraps, upsBasicCompliance=upsBasicCompliance, upsBasicGroups=upsBasicGroups, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsBypassCurrent=upsBypassCurrent, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsConfig=upsConfig, upsConformance=upsConformance, upsAlarmOutputBad=upsAlarmOutputBad, upsBypassLineIndex=upsBypassLineIndex, upsOutputVoltage=upsOutputVoltage, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBasicControlGroup=upsBasicControlGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsFullBypassGroup=upsFullBypassGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmEntry=upsAlarmEntry, upsIdent=upsIdent, upsSubsetInputGroup=upsSubsetInputGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsConfigOutputVA=upsConfigOutputVA, upsFullOutputGroup=upsFullOutputGroup, upsAlarmTime=upsAlarmTime, upsConfigOutputPower=upsConfigOutputPower, upsBasicOutputGroup=upsBasicOutputGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmsPresent=upsAlarmsPresent, upsOutputCurrent=upsOutputCurrent, upsIdentModel=upsIdentModel, upsInputVoltage=upsInputVoltage, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmTempBad=upsAlarmTempBad, upsMIB=upsMIB, upsInputFrequency=upsInputFrequency, upsAutoRestart=upsAutoRestart, upsBattery=upsBattery, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmOnBattery=upsAlarmOnBattery, upsOutputTable=upsOutputTable, upsBypass=upsBypass, upsBypassEntry=upsBypassEntry, upsBypassPower=upsBypassPower, upsConfigInputFreq=upsConfigInputFreq, upsAlarmId=upsAlarmId, upsSubsetControlGroup=upsSubsetControlGroup, upsFullIdentGroup=upsFullIdentGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTrapOnBattery=upsTrapOnBattery, upsAlarmLowBattery=upsAlarmLowBattery, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsOutputNumLines=upsOutputNumLines, upsAlarmOutputOverload=upsAlarmOutputOverload, upsSubsetOutputGroup=upsSubsetOutputGroup, upsSubsetCompliance=upsSubsetCompliance, upsRebootWithDuration=upsRebootWithDuration, upsInputNumLines=upsInputNumLines, upsFullAlarmGroup=upsFullAlarmGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsInputCurrent=upsInputCurrent, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsOutputLineIndex=upsOutputLineIndex, upsAlarmFuseFailure=upsAlarmFuseFailure, upsSecondsOnBattery=upsSecondsOnBattery, NonNegativeInteger=NonNegativeInteger, upsBypassTable=upsBypassTable, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsOutputPower=upsOutputPower, upsFullCompliance=upsFullCompliance, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBypassNumLines=upsBypassNumLines, upsIdentManufacturer=upsIdentManufacturer, upsInput=upsInput, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsConfigInputVoltage=upsConfigInputVoltage, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullInputGroup=upsFullInputGroup, upsInputLineBads=upsInputLineBads, upsOutputFrequency=upsOutputFrequency, upsBypassVoltage=upsBypassVoltage, upsTestId=upsTestId, upsBatteryVoltage=upsBatteryVoltage, upsOutput=upsOutput, upsControl=upsControl, upsOutputSource=upsOutputSource, upsShutdownType=upsShutdownType, upsBasicConfigGroup=upsBasicConfigGroup, upsGroups=upsGroups, upsTestResultsSummary=upsTestResultsSummary, upsConfigLowBattTime=upsConfigLowBattTime, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsCompliances=upsCompliances, upsInputTruePower=upsInputTruePower, upsAlarm=upsAlarm, PositiveInteger=PositiveInteger, upsOutputEntry=upsOutputEntry, upsWellKnownTests=upsWellKnownTests, upsBypassFrequency=upsBypassFrequency, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTestSpinLock=upsTestSpinLock, upsTestElapsedTime=upsTestElapsedTime, upsWellKnownAlarms=upsWellKnownAlarms, upsBasicAlarmGroup=upsBasicAlarmGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBatteryTemperature=upsBatteryTemperature, upsBasicTestGroup=upsBasicTestGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsInputLineIndex=upsInputLineIndex, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmShutdownPending=upsAlarmShutdownPending, upsFullControlGroup=upsFullControlGroup, upsAlarmTable=upsAlarmTable, upsInputTable=upsInputTable, upsAlarmOnBypass=upsAlarmOnBypass, upsFullTestGroup=upsFullTestGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsFullConfigGroup=upsFullConfigGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBatteryStatus=upsBatteryStatus, upsInputEntry=upsInputEntry, upsBatteryCurrent=upsBatteryCurrent)
