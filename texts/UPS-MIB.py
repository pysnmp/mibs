...
# Produced by pysmi-1.1.8 at Thu Sep 29 13:03:24 2022
...
Counter32, Integer32, Unsigned32, IpAddress, TimeTicks, mib_2, ModuleIdentity, Bits, Counter64, MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "Unsigned32", "IpAddress", "TimeTicks", "mib-2", "ModuleIdentity", "Bits", "Counter64", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "NotificationType")
...
mibBuilder.exportSymbols("UPS-MIB", upsBatteryTemperature=upsBatteryTemperature, upsAlarmLowBattery=upsAlarmLowBattery, upsOutputCurrent=upsOutputCurrent, upsOutputNumLines=upsOutputNumLines, upsOutputTable=upsOutputTable, upsOutput=upsOutput, upsTestResultsSummary=upsTestResultsSummary, upsInputVoltage=upsInputVoltage, upsBasicGroups=upsBasicGroups, upsConfig=upsConfig, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsIdent=upsIdent, upsShutdownType=upsShutdownType, upsTestId=upsTestId, upsFullBypassGroup=upsFullBypassGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmTestInProgress=upsAlarmTestInProgress, upsInputLineBads=upsInputLineBads, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsFullCompliance=upsFullCompliance, upsBasicCompliance=upsBasicCompliance, upsAlarmOutputBad=upsAlarmOutputBad, NonNegativeInteger=NonNegativeInteger, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsConformance=upsConformance, upsFullOutputGroup=upsFullOutputGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmId=upsAlarmId, upsAlarmBypassBad=upsAlarmBypassBad, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBypassCurrent=upsBypassCurrent, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBasicControlGroup=upsBasicControlGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsTestSpinLock=upsTestSpinLock, upsAlarmsPresent=upsAlarmsPresent, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBypassNumLines=upsBypassNumLines, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmShutdownPending=upsAlarmShutdownPending, upsWellKnownAlarms=upsWellKnownAlarms, upsBypassPower=upsBypassPower, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypassEntry=upsBypassEntry, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsOutputEntry=upsOutputEntry, upsBypassVoltage=upsBypassVoltage, upsAlarmEntry=upsAlarmEntry, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsFullInputGroup=upsFullInputGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsOutputLineIndex=upsOutputLineIndex, upsAlarmFanFailure=upsAlarmFanFailure, upsBypass=upsBypass, upsFullIdentGroup=upsFullIdentGroup, upsInputTruePower=upsInputTruePower, upsInputLineIndex=upsInputLineIndex, upsBasicBypassGroup=upsBasicBypassGroup, PositiveInteger=PositiveInteger, upsOutputPower=upsOutputPower, upsGroups=upsGroups, upsInputEntry=upsInputEntry, upsFullBatteryGroup=upsFullBatteryGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsBypassFrequency=upsBypassFrequency, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsConfigInputVoltage=upsConfigInputVoltage, upsTraps=upsTraps, PYSNMP_MODULE_ID=upsMIB, upsConfigLowBattTime=upsConfigLowBattTime, upsFullConfigGroup=upsFullConfigGroup, upsInput=upsInput, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullTestGroup=upsFullTestGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsAutoRestart=upsAutoRestart, upsInputNumLines=upsInputNumLines, upsBypassLineIndex=upsBypassLineIndex, upsSubsetIdentGroup=upsSubsetIdentGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBypassTable=upsBypassTable, upsTest=upsTest, upsBattery=upsBattery, upsAlarmTempBad=upsAlarmTempBad, upsConfigInputFreq=upsConfigInputFreq, upsBasicIdentGroup=upsBasicIdentGroup, upsFullControlGroup=upsFullControlGroup, upsBatteryVoltage=upsBatteryVoltage, upsBasicTestGroup=upsBasicTestGroup, upsTrapOnBattery=upsTrapOnBattery, upsTestElapsedTime=upsTestElapsedTime, upsIdentModel=upsIdentModel, upsMIB=upsMIB, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsSubsetConfigGroup=upsSubsetConfigGroup, upsIdentName=upsIdentName, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmDescr=upsAlarmDescr, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsOutputVoltage=upsOutputVoltage, upsBasicConfigGroup=upsBasicConfigGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsInputCurrent=upsInputCurrent, upsTestResultsDetail=upsTestResultsDetail, upsInputFrequency=upsInputFrequency, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBasicInputGroup=upsBasicInputGroup, upsConfigOutputPower=upsConfigOutputPower, upsFullAlarmGroup=upsFullAlarmGroup, upsRebootWithDuration=upsRebootWithDuration, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsFullGroups=upsFullGroups, upsSubsetGroups=upsSubsetGroups, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmTime=upsAlarmTime, upsAlarmTable=upsAlarmTable, upsOutputSource=upsOutputSource, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsInputTable=upsInputTable, upsBasicAlarmGroup=upsBasicAlarmGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBasicBatteryGroup=upsBasicBatteryGroup, upsObjects=upsObjects, upsBatteryStatus=upsBatteryStatus, upsOutputFrequency=upsOutputFrequency, upsConfigOutputVA=upsConfigOutputVA, upsSubsetCompliance=upsSubsetCompliance, upsWellKnownTests=upsWellKnownTests, upsIdentAttachedDevices=upsIdentAttachedDevices, upsControl=upsControl, upsSubsetControlGroup=upsSubsetControlGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsTestStartTime=upsTestStartTime, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarm=upsAlarm, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBatteryCurrent=upsBatteryCurrent, upsAlarmInputBad=upsAlarmInputBad, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsCompliances=upsCompliances, upsIdentManufacturer=upsIdentManufacturer)
