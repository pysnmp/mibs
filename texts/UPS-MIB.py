...
mibBuilder.exportSymbols("UPS-MIB", upsOutputVoltage=upsOutputVoltage, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmTable=upsAlarmTable, upsOutput=upsOutput, upsBasicControlGroup=upsBasicControlGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsFullBypassGroup=upsFullBypassGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsConfigOutputVoltage=upsConfigOutputVoltage, upsFullAlarmGroup=upsFullAlarmGroup, upsBasicInputGroup=upsBasicInputGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmInputBad=upsAlarmInputBad, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBattery=upsBattery, upsInputTruePower=upsInputTruePower, upsBypassLineIndex=upsBypassLineIndex, upsConfigOutputPower=upsConfigOutputPower, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullInputGroup=upsFullInputGroup, upsShutdownType=upsShutdownType, upsInput=upsInput, upsBasicOutputGroup=upsBasicOutputGroup, upsConformance=upsConformance, upsTestStartTime=upsTestStartTime, upsBypassCurrent=upsBypassCurrent, upsInputTable=upsInputTable, upsOutputSource=upsOutputSource, upsInputLineIndex=upsInputLineIndex, upsSubsetCompliance=upsSubsetCompliance, upsBatteryTemperature=upsBatteryTemperature, upsTraps=upsTraps, upsAlarmChargerFailed=upsAlarmChargerFailed, upsIdentModel=upsIdentModel, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsIdentAttachedDevices=upsIdentAttachedDevices, upsSubsetIdentGroup=upsSubsetIdentGroup, PYSNMP_MODULE_ID=upsMIB, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsConfigAudibleStatus=upsConfigAudibleStatus, upsIdent=upsIdent, upsOutputNumLines=upsOutputNumLines, upsStartupAfterDelay=upsStartupAfterDelay, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmLowBattery=upsAlarmLowBattery, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsConfigInputVoltage=upsConfigInputVoltage, upsBasicConfigGroup=upsBasicConfigGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsMIB=upsMIB, upsBypassVoltage=upsBypassVoltage, upsBypassPower=upsBypassPower, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsSecondsOnBattery=upsSecondsOnBattery, upsTest=upsTest, upsAutoRestart=upsAutoRestart, upsBasicTestGroup=upsBasicTestGroup, upsOutputEntry=upsOutputEntry, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmDescr=upsAlarmDescr, upsBasicCompliance=upsBasicCompliance, upsOutputTable=upsOutputTable, upsAlarmOutputOverload=upsAlarmOutputOverload, upsWellKnownAlarms=upsWellKnownAlarms, upsCompliances=upsCompliances, upsFullCompliance=upsFullCompliance, upsWellKnownTests=upsWellKnownTests, upsIdentName=upsIdentName, upsGroups=upsGroups, upsAlarmTime=upsAlarmTime, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBatteryVoltage=upsBatteryVoltage, upsBypass=upsBypass, upsOutputCurrent=upsOutputCurrent, upsInputVoltage=upsInputVoltage, upsAlarm=upsAlarm, upsInputCurrent=upsInputCurrent, upsBypassTable=upsBypassTable, upsAlarmGeneralFault=upsAlarmGeneralFault, upsFullIdentGroup=upsFullIdentGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsInputNumLines=upsInputNumLines, upsInputLineBads=upsInputLineBads, upsConfigLowBattTime=upsConfigLowBattTime, upsFullControlGroup=upsFullControlGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsTestResultsDetail=upsTestResultsDetail, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBypassFrequency=upsBypassFrequency, upsBasicGroups=upsBasicGroups, upsAlarmEntry=upsAlarmEntry, upsTestSpinLock=upsTestSpinLock, upsTrapOnBattery=upsTrapOnBattery, upsAlarmsPresent=upsAlarmsPresent, NonNegativeInteger=NonNegativeInteger, upsOutputPower=upsOutputPower, upsBasicIdentGroup=upsBasicIdentGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsInputFrequency=upsInputFrequency, PositiveInteger=PositiveInteger, upsConfigOutputVA=upsConfigOutputVA, upsOutputFrequency=upsOutputFrequency, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBypassEntry=upsBypassEntry, upsAlarmId=upsAlarmId, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBatteryStatus=upsBatteryStatus, upsTestId=upsTestId, upsRebootWithDuration=upsRebootWithDuration, upsAlarmTempBad=upsAlarmTempBad, upsFullTestGroup=upsFullTestGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTestElapsedTime=upsTestElapsedTime, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBypassNumLines=upsBypassNumLines, upsObjects=upsObjects, upsAlarmOnBypass=upsAlarmOnBypass, upsTestResultsSummary=upsTestResultsSummary, upsFullGroups=upsFullGroups, upsAlarmOnBattery=upsAlarmOnBattery, upsInputEntry=upsInputEntry, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfigOutputFreq=upsConfigOutputFreq, upsConfig=upsConfig, upsAlarmTestInProgress=upsAlarmTestInProgress, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsControl=upsControl, upsIdentManufacturer=upsIdentManufacturer, upsSubsetGroups=upsSubsetGroups, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmFanFailure=upsAlarmFanFailure, upsConfigInputFreq=upsConfigInputFreq, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBatteryCurrent=upsBatteryCurrent, upsFullConfigGroup=upsFullConfigGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsOutputLineIndex=upsOutputLineIndex, upsFullOutputGroup=upsFullOutputGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff)
