...
# Produced by pysmi-1.1.12 at Tue May 28 11:44:05 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, mib_2, Bits, NotificationType, iso, ModuleIdentity, Unsigned32, ObjectIdentity, IpAddress, Counter32, Counter64, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "mib-2", "Bits", "NotificationType", "iso", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "IpAddress", "Counter32", "Counter64", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("UPS-MIB", PositiveInteger=PositiveInteger, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsInputNumLines=upsInputNumLines, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBypassCurrent=upsBypassCurrent, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBypass=upsBypass, upsInputCurrent=upsInputCurrent, upsTestResultsSummary=upsTestResultsSummary, upsBatteryStatus=upsBatteryStatus, upsTest=upsTest, upsFullCompliance=upsFullCompliance, upsBasicIdentGroup=upsBasicIdentGroup, upsTestStartTime=upsTestStartTime, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBasicTestGroup=upsBasicTestGroup, upsBatteryTemperature=upsBatteryTemperature, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsIdentManufacturer=upsIdentManufacturer, upsOutputVoltage=upsOutputVoltage, upsFullTestGroup=upsFullTestGroup, upsOutputTable=upsOutputTable, upsConfigOutputFreq=upsConfigOutputFreq, upsFullGroups=upsFullGroups, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBypassFrequency=upsBypassFrequency, upsFullBypassGroup=upsFullBypassGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsIdentName=upsIdentName, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsInputVoltage=upsInputVoltage, upsSubsetCompliance=upsSubsetCompliance, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsSubsetInputGroup=upsSubsetInputGroup, upsInputEntry=upsInputEntry, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmInputBad=upsAlarmInputBad, upsFullOutputGroup=upsFullOutputGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmTempBad=upsAlarmTempBad, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmsPresent=upsAlarmsPresent, upsConfigOutputVoltage=upsConfigOutputVoltage, upsSubsetGroups=upsSubsetGroups, upsInputLineIndex=upsInputLineIndex, upsBasicAlarmGroup=upsBasicAlarmGroup, upsOutputCurrent=upsOutputCurrent, upsBasicConfigGroup=upsBasicConfigGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmTime=upsAlarmTime, upsOutputNumLines=upsOutputNumLines, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmId=upsAlarmId, upsFullIdentGroup=upsFullIdentGroup, upsConformance=upsConformance, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTrapOnBattery=upsTrapOnBattery, upsAlarmLowBattery=upsAlarmLowBattery, upsTestElapsedTime=upsTestElapsedTime, upsIdentModel=upsIdentModel, upsBypassTable=upsBypassTable, upsInputLineBads=upsInputLineBads, upsSubsetIdentGroup=upsSubsetIdentGroup, upsOutputLineIndex=upsOutputLineIndex, upsFullAlarmGroup=upsFullAlarmGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsOutputFrequency=upsOutputFrequency, upsConfigLowBattTime=upsConfigLowBattTime, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsRebootWithDuration=upsRebootWithDuration, upsFullInputGroup=upsFullInputGroup, upsInput=upsInput, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBasicInputGroup=upsBasicInputGroup, upsTestResultsDetail=upsTestResultsDetail, upsOutput=upsOutput, upsOutputPower=upsOutputPower, upsAlarmTable=upsAlarmTable, upsConfigOutputPower=upsConfigOutputPower, upsBasicGroups=upsBasicGroups, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmEntry=upsAlarmEntry, upsAutoRestart=upsAutoRestart, upsAlarm=upsAlarm, upsGroups=upsGroups, upsAlarmDescr=upsAlarmDescr, upsBatteryVoltage=upsBatteryVoltage, upsBypassPower=upsBypassPower, upsAlarmBatteryBad=upsAlarmBatteryBad, upsWellKnownTests=upsWellKnownTests, upsConfigInputFreq=upsConfigInputFreq, upsMIB=upsMIB, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTraps=upsTraps, upsTestSpinLock=upsTestSpinLock, upsWellKnownAlarms=upsWellKnownAlarms, upsShutdownType=upsShutdownType, upsConfigAudibleStatus=upsConfigAudibleStatus, upsStartupAfterDelay=upsStartupAfterDelay, upsConfigOutputVA=upsConfigOutputVA, upsIdent=upsIdent, upsAlarmOnBattery=upsAlarmOnBattery, upsBypassVoltage=upsBypassVoltage, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsInputFrequency=upsInputFrequency, upsBasicBypassGroup=upsBasicBypassGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsOutputEntry=upsOutputEntry, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullConfigGroup=upsFullConfigGroup, upsBasicCompliance=upsBasicCompliance, upsFullControlGroup=upsFullControlGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsBypassLineIndex=upsBypassLineIndex, upsSubsetOutputGroup=upsSubsetOutputGroup, upsOutputSource=upsOutputSource, upsObjects=upsObjects, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsInputTruePower=upsInputTruePower, upsBasicBatteryGroup=upsBasicBatteryGroup, NonNegativeInteger=NonNegativeInteger, upsBypassNumLines=upsBypassNumLines, upsInputTable=upsInputTable, upsConfig=upsConfig, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsCompliances=upsCompliances, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBatteryCurrent=upsBatteryCurrent, upsTestNoTestsInitiated=upsTestNoTestsInitiated, PYSNMP_MODULE_ID=upsMIB, upsBasicControlGroup=upsBasicControlGroup, upsTestId=upsTestId, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBattery=upsBattery, upsControl=upsControl, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBypassEntry=upsBypassEntry)
