...
# Produced by pysmi-1.1.8 at Thu Apr 27 12:05:45 2023
...
Bits, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, iso, Integer32, IpAddress, ObjectIdentity, ModuleIdentity, Counter32, TimeTicks, Counter64, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "iso", "Integer32", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Counter32", "TimeTicks", "Counter64", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("UPS-MIB", upsConfigInputVoltage=upsConfigInputVoltage, upsBasicTestGroup=upsBasicTestGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmBypassBad=upsAlarmBypassBad, upsOutputPercentLoad=upsOutputPercentLoad, upsConfigInputFreq=upsConfigInputFreq, upsTestResultsSummary=upsTestResultsSummary, upsIdent=upsIdent, upsAlarmOutputOverload=upsAlarmOutputOverload, upsConformance=upsConformance, upsObjects=upsObjects, upsOutputTable=upsOutputTable, upsInputLineBads=upsInputLineBads, PositiveInteger=PositiveInteger, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsIdentName=upsIdentName, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBypassLineIndex=upsBypassLineIndex, upsGroups=upsGroups, NonNegativeInteger=NonNegativeInteger, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsSubsetControlGroup=upsSubsetControlGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmDescr=upsAlarmDescr, upsTestResultsDetail=upsTestResultsDetail, upsBypassCurrent=upsBypassCurrent, upsTest=upsTest, upsSubsetGroups=upsSubsetGroups, upsAlarmInputBad=upsAlarmInputBad, upsAlarmTime=upsAlarmTime, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConfigOutputVoltage=upsConfigOutputVoltage, upsOutputVoltage=upsOutputVoltage, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBypassNumLines=upsBypassNumLines, upsAlarmOnBattery=upsAlarmOnBattery, upsTestSpinLock=upsTestSpinLock, upsAlarmBatteryBad=upsAlarmBatteryBad, upsOutputNumLines=upsOutputNumLines, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTestId=upsTestId, upsAlarm=upsAlarm, upsBatteryVoltage=upsBatteryVoltage, upsWellKnownAlarms=upsWellKnownAlarms, upsBatteryTemperature=upsBatteryTemperature, upsInputFrequency=upsInputFrequency, upsOutput=upsOutput, upsTraps=upsTraps, upsBasicGroups=upsBasicGroups, upsBatteryStatus=upsBatteryStatus, upsConfigOutputVA=upsConfigOutputVA, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsIdentAttachedDevices=upsIdentAttachedDevices, upsFullInputGroup=upsFullInputGroup, upsControl=upsControl, upsBatteryCurrent=upsBatteryCurrent, upsOutputPower=upsOutputPower, upsFullBypassGroup=upsFullBypassGroup, upsInputCurrent=upsInputCurrent, upsBypassTable=upsBypassTable, upsAlarmTestInProgress=upsAlarmTestInProgress, upsIdentManufacturer=upsIdentManufacturer, upsOutputCurrent=upsOutputCurrent, upsAlarmEntry=upsAlarmEntry, upsBattery=upsBattery, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsSubsetIdentGroup=upsSubsetIdentGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsOutputEntry=upsOutputEntry, upsRebootWithDuration=upsRebootWithDuration, upsTrapOnBattery=upsTrapOnBattery, upsBasicIdentGroup=upsBasicIdentGroup, upsBasicControlGroup=upsBasicControlGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsInputVoltage=upsInputVoltage, upsBypassFrequency=upsBypassFrequency, upsFullGroups=upsFullGroups, upsBypass=upsBypass, upsConfig=upsConfig, upsInputNumLines=upsInputNumLines, upsBypassEntry=upsBypassEntry, upsAlarmsPresent=upsAlarmsPresent, upsTestStartTime=upsTestStartTime, upsSubsetCompliance=upsSubsetCompliance, upsBasicInputGroup=upsBasicInputGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmTable=upsAlarmTable, upsFullTestGroup=upsFullTestGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsOutputLineIndex=upsOutputLineIndex, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsAutoRestart=upsAutoRestart, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmLowBattery=upsAlarmLowBattery, upsShutdownType=upsShutdownType, upsAlarmOutputBad=upsAlarmOutputBad, upsFullCompliance=upsFullCompliance, upsAlarmFanFailure=upsAlarmFanFailure, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBasicBatteryGroup=upsBasicBatteryGroup, PYSNMP_MODULE_ID=upsMIB, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmOnBypass=upsAlarmOnBypass, upsInputEntry=upsInputEntry, upsFullIdentGroup=upsFullIdentGroup, upsAlarmTempBad=upsAlarmTempBad, upsConfigLowBattTime=upsConfigLowBattTime, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsFullAlarmGroup=upsFullAlarmGroup, upsConfigOutputPower=upsConfigOutputPower, upsFullConfigGroup=upsFullConfigGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsMIB=upsMIB, upsBasicCompliance=upsBasicCompliance, upsTestElapsedTime=upsTestElapsedTime, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsWellKnownTests=upsWellKnownTests, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsInputLineIndex=upsInputLineIndex, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmId=upsAlarmId, upsInputTable=upsInputTable, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsInput=upsInput, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsFullControlGroup=upsFullControlGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsOutputFrequency=upsOutputFrequency, upsBypassPower=upsBypassPower, upsInputTruePower=upsInputTruePower, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsStartupAfterDelay=upsStartupAfterDelay, upsBasicOutputGroup=upsBasicOutputGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsCompliances=upsCompliances, upsConfigOutputFreq=upsConfigOutputFreq, upsOutputSource=upsOutputSource, upsBypassVoltage=upsBypassVoltage, upsFullOutputGroup=upsFullOutputGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsIdentModel=upsIdentModel, upsAlarmChargerFailed=upsAlarmChargerFailed)
