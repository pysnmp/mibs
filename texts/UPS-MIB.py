...
mibBuilder.exportSymbols("UPS-MIB", upsOutputPower=upsOutputPower, upsBypassTable=upsBypassTable, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBasicCompliance=upsBasicCompliance, upsFullAlarmGroup=upsFullAlarmGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsOutputNumLines=upsOutputNumLines, upsAutoRestart=upsAutoRestart, upsAlarmBypassBad=upsAlarmBypassBad, upsBasicAlarmGroup=upsBasicAlarmGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTestId=upsTestId, upsInputFrequency=upsInputFrequency, upsBasicControlGroup=upsBasicControlGroup, upsBattery=upsBattery, upsControl=upsControl, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsInputLineBads=upsInputLineBads, upsIdentModel=upsIdentModel, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBatteryCurrent=upsBatteryCurrent, upsOutputTable=upsOutputTable, upsConformance=upsConformance, upsAlarmDescr=upsAlarmDescr, upsFullControlGroup=upsFullControlGroup, upsOutputLineIndex=upsOutputLineIndex, upsAlarmInputBad=upsAlarmInputBad, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmChargerFailed=upsAlarmChargerFailed, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmGeneralFault=upsAlarmGeneralFault, upsSubsetGroups=upsSubsetGroups, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsRebootWithDuration=upsRebootWithDuration, upsAlarm=upsAlarm, upsFullTestGroup=upsFullTestGroup, upsBatteryVoltage=upsBatteryVoltage, upsAlarmsPresent=upsAlarmsPresent, upsInputVoltage=upsInputVoltage, upsTest=upsTest, upsConfigLowBattTime=upsConfigLowBattTime, upsIdentAttachedDevices=upsIdentAttachedDevices, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBypassLineIndex=upsBypassLineIndex, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTraps=upsTraps, upsMIB=upsMIB, upsGroups=upsGroups, PositiveInteger=PositiveInteger, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTestResultsSummary=upsTestResultsSummary, upsConfigOutputFreq=upsConfigOutputFreq, upsTestElapsedTime=upsTestElapsedTime, upsFullIdentGroup=upsFullIdentGroup, upsFullConfigGroup=upsFullConfigGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsBasicGroups=upsBasicGroups, upsInput=upsInput, upsBypassFrequency=upsBypassFrequency, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBypassEntry=upsBypassEntry, upsIdentName=upsIdentName, upsInputEntry=upsInputEntry, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestResultsDetail=upsTestResultsDetail, upsFullOutputGroup=upsFullOutputGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmTable=upsAlarmTable, upsShutdownType=upsShutdownType, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, PYSNMP_MODULE_ID=upsMIB, upsFullBypassGroup=upsFullBypassGroup, upsObjects=upsObjects, upsInputCurrent=upsInputCurrent, upsConfig=upsConfig, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypassVoltage=upsBypassVoltage, upsBasicInputGroup=upsBasicInputGroup, upsIdent=upsIdent, upsFullBatteryGroup=upsFullBatteryGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmId=upsAlarmId, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmEntry=upsAlarmEntry, upsAlarmShutdownPending=upsAlarmShutdownPending, upsInputTruePower=upsInputTruePower, upsFullGroups=upsFullGroups, upsOutputCurrent=upsOutputCurrent, upsBasicIdentGroup=upsBasicIdentGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBypassCurrent=upsBypassCurrent, upsConfigOutputPower=upsConfigOutputPower, upsOutputSource=upsOutputSource, upsAlarmTempBad=upsAlarmTempBad, upsAlarmTime=upsAlarmTime, upsAlarmLowBattery=upsAlarmLowBattery, upsIdentManufacturer=upsIdentManufacturer, upsOutputEntry=upsOutputEntry, upsTrapOnBattery=upsTrapOnBattery, upsAlarmOnBattery=upsAlarmOnBattery, upsTrapTestCompleted=upsTrapTestCompleted, upsOutput=upsOutput, upsTestSpinLock=upsTestSpinLock, upsBasicTestGroup=upsBasicTestGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsConfigOutputVA=upsConfigOutputVA, NonNegativeInteger=NonNegativeInteger, upsBypassPower=upsBypassPower, upsBatteryStatus=upsBatteryStatus, upsAlarmOutputOverload=upsAlarmOutputOverload, upsInputLineIndex=upsInputLineIndex, upsWellKnownAlarms=upsWellKnownAlarms, upsConfigAudibleStatus=upsConfigAudibleStatus, upsSubsetControlGroup=upsSubsetControlGroup, upsBatteryTemperature=upsBatteryTemperature, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsInputNumLines=upsInputNumLines, upsInputTable=upsInputTable, upsWellKnownTests=upsWellKnownTests, upsBypassNumLines=upsBypassNumLines, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTestStartTime=upsTestStartTime, upsCompliances=upsCompliances, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmFanFailure=upsAlarmFanFailure, upsOutputVoltage=upsOutputVoltage, upsBypass=upsBypass, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsFullInputGroup=upsFullInputGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsSubsetCompliance=upsSubsetCompliance, upsBasicOutputGroup=upsBasicOutputGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsConfigInputFreq=upsConfigInputFreq, upsAlarmOutputBad=upsAlarmOutputBad, upsOutputFrequency=upsOutputFrequency, upsConfigInputVoltage=upsConfigInputVoltage, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsFullCompliance=upsFullCompliance, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff)
