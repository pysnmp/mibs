...
# Produced by pysmi-1.1.12 at Tue Jun  4 13:00:06 2024
...
mib_2, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, Gauge32, ObjectIdentity, iso, Counter32, IpAddress, TimeTicks, Counter64, Integer32, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "Gauge32", "ObjectIdentity", "iso", "Counter32", "IpAddress", "TimeTicks", "Counter64", "Integer32", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("UPS-MIB", upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsIdent=upsIdent, upsFullCompliance=upsFullCompliance, upsFullIdentGroup=upsFullIdentGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsInputCurrent=upsInputCurrent, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicInputGroup=upsBasicInputGroup, upsBasicTestGroup=upsBasicTestGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsTestElapsedTime=upsTestElapsedTime, upsBypassNumLines=upsBypassNumLines, upsBatteryVoltage=upsBatteryVoltage, upsAlarmTable=upsAlarmTable, upsIdentAttachedDevices=upsIdentAttachedDevices, upsMIB=upsMIB, upsConfigLowBattTime=upsConfigLowBattTime, upsBypassEntry=upsBypassEntry, upsConfigAudibleStatus=upsConfigAudibleStatus, PositiveInteger=PositiveInteger, upsObjects=upsObjects, upsOutputCurrent=upsOutputCurrent, upsBasicConfigGroup=upsBasicConfigGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsFullBatteryGroup=upsFullBatteryGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBypassTable=upsBypassTable, upsTraps=upsTraps, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmOutputOverload=upsAlarmOutputOverload, upsOutputSource=upsOutputSource, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBasicCompliance=upsBasicCompliance, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsConfigInputVoltage=upsConfigInputVoltage, upsFullAlarmGroup=upsFullAlarmGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsFullInputGroup=upsFullInputGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsOutputPower=upsOutputPower, upsBypassFrequency=upsBypassFrequency, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsFullBypassGroup=upsFullBypassGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsSubsetGroups=upsSubsetGroups, upsFullTestGroup=upsFullTestGroup, upsAlarmTime=upsAlarmTime, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsFullOutputGroup=upsFullOutputGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsShutdownType=upsShutdownType, upsConfigOutputVA=upsConfigOutputVA, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsOutputNumLines=upsOutputNumLines, upsBatteryCurrent=upsBatteryCurrent, upsCompliances=upsCompliances, upsControl=upsControl, upsInput=upsInput, upsBasicGroups=upsBasicGroups, upsOutputTable=upsOutputTable, upsAlarmFanFailure=upsAlarmFanFailure, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsSubsetCompliance=upsSubsetCompliance, upsInputNumLines=upsInputNumLines, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBypassCurrent=upsBypassCurrent, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBypassLineIndex=upsBypassLineIndex, upsBattery=upsBattery, upsBatteryStatus=upsBatteryStatus, upsBasicAlarmGroup=upsBasicAlarmGroup, upsOutputFrequency=upsOutputFrequency, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsInputTruePower=upsInputTruePower, upsBypassPower=upsBypassPower, upsAlarmEntry=upsAlarmEntry, upsInputEntry=upsInputEntry, upsIdentManufacturer=upsIdentManufacturer, upsAlarmBatteryBad=upsAlarmBatteryBad, upsInputTable=upsInputTable, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTest=upsTest, upsBasicIdentGroup=upsBasicIdentGroup, upsTestSpinLock=upsTestSpinLock, upsOutputEntry=upsOutputEntry, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsRebootWithDuration=upsRebootWithDuration, upsFullGroups=upsFullGroups, upsOutputPercentLoad=upsOutputPercentLoad, upsFullControlGroup=upsFullControlGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTestResultsDetail=upsTestResultsDetail, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmChargerFailed=upsAlarmChargerFailed, upsInputLineIndex=upsInputLineIndex, upsConfigOutputPower=upsConfigOutputPower, upsOutput=upsOutput, NonNegativeInteger=NonNegativeInteger, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTrapOnBattery=upsTrapOnBattery, upsAlarmOnBattery=upsAlarmOnBattery, upsAutoRestart=upsAutoRestart, upsAlarmInputBad=upsAlarmInputBad, upsTestId=upsTestId, upsConfigInputFreq=upsConfigInputFreq, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmId=upsAlarmId, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTestStartTime=upsTestStartTime, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsOutputLineIndex=upsOutputLineIndex, upsIdentName=upsIdentName, upsSecondsOnBattery=upsSecondsOnBattery, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmsPresent=upsAlarmsPresent, PYSNMP_MODULE_ID=upsMIB, upsAlarmDescr=upsAlarmDescr, upsFullConfigGroup=upsFullConfigGroup, upsConformance=upsConformance, upsWellKnownTests=upsWellKnownTests, upsGroups=upsGroups, upsAlarmTempBad=upsAlarmTempBad, upsConfig=upsConfig, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarm=upsAlarm, upsTestResultsSummary=upsTestResultsSummary, upsOutputVoltage=upsOutputVoltage, upsBypass=upsBypass, upsBasicControlGroup=upsBasicControlGroup, upsInputVoltage=upsInputVoltage, upsIdentModel=upsIdentModel, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmTestInProgress=upsAlarmTestInProgress, upsInputLineBads=upsInputLineBads, upsBypassVoltage=upsBypassVoltage, upsBatteryTemperature=upsBatteryTemperature, upsSubsetOutputGroup=upsSubsetOutputGroup, upsInputFrequency=upsInputFrequency)
