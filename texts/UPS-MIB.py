...
# Produced by pysmi-1.1.12 at Tue Jun  4 11:43:09 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, MibIdentifier, ObjectIdentity, Counter32, Unsigned32, ModuleIdentity, TimeTicks, Gauge32, Bits, IpAddress, Integer32, mib_2, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "MibIdentifier", "ObjectIdentity", "Counter32", "Unsigned32", "ModuleIdentity", "TimeTicks", "Gauge32", "Bits", "IpAddress", "Integer32", "mib-2", "NotificationType")
...
mibBuilder.exportSymbols("UPS-MIB", upsConfigOutputVoltage=upsConfigOutputVoltage, upsOutputFrequency=upsOutputFrequency, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBypass=upsBypass, upsBasicControlGroup=upsBasicControlGroup, upsBatteryTemperature=upsBatteryTemperature, upsInputFrequency=upsInputFrequency, upsInputCurrent=upsInputCurrent, upsOutput=upsOutput, upsInput=upsInput, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsFullGroups=upsFullGroups, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTest=upsTest, upsBypassCurrent=upsBypassCurrent, upsBatteryCurrent=upsBatteryCurrent, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsFullTestGroup=upsFullTestGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmDescr=upsAlarmDescr, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAutoRestart=upsAutoRestart, upsSubsetInputGroup=upsSubsetInputGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigOutputFreq=upsConfigOutputFreq, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsSecondsOnBattery=upsSecondsOnBattery, upsObjects=upsObjects, upsOutputSource=upsOutputSource, upsShutdownType=upsShutdownType, upsTestId=upsTestId, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConfigAudibleStatus=upsConfigAudibleStatus, upsInputLineBads=upsInputLineBads, upsAlarmInputBad=upsAlarmInputBad, upsSubsetIdentGroup=upsSubsetIdentGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTestResultsDetail=upsTestResultsDetail, upsInputTruePower=upsInputTruePower, upsTestSpinLock=upsTestSpinLock, upsAlarmTempBad=upsAlarmTempBad, upsTraps=upsTraps, upsBattery=upsBattery, upsOutputPercentLoad=upsOutputPercentLoad, upsOutputCurrent=upsOutputCurrent, upsAlarmOnBattery=upsAlarmOnBattery, upsInputNumLines=upsInputNumLines, upsAlarmId=upsAlarmId, upsOutputEntry=upsOutputEntry, upsFullOutputGroup=upsFullOutputGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypassEntry=upsBypassEntry, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBypassFrequency=upsBypassFrequency, upsAlarmFanFailure=upsAlarmFanFailure, upsSubsetControlGroup=upsSubsetControlGroup, upsOutputNumLines=upsOutputNumLines, upsIdentName=upsIdentName, upsRebootWithDuration=upsRebootWithDuration, upsBasicTestGroup=upsBasicTestGroup, upsBypassLineIndex=upsBypassLineIndex, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, NonNegativeInteger=NonNegativeInteger, upsFullAlarmGroup=upsFullAlarmGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmBatteryBad=upsAlarmBatteryBad, PositiveInteger=PositiveInteger, upsBasicGroups=upsBasicGroups, upsBypassNumLines=upsBypassNumLines, upsIdentModel=upsIdentModel, upsMIB=upsMIB, upsInputLineIndex=upsInputLineIndex, upsConfigOutputVA=upsConfigOutputVA, upsBatteryVoltage=upsBatteryVoltage, upsBasicConfigGroup=upsBasicConfigGroup, upsOutputLineIndex=upsOutputLineIndex, upsGroups=upsGroups, upsConfigInputVoltage=upsConfigInputVoltage, upsBasicBypassGroup=upsBasicBypassGroup, upsConfigInputFreq=upsConfigInputFreq, upsIdentManufacturer=upsIdentManufacturer, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsInputEntry=upsInputEntry, upsTestStartTime=upsTestStartTime, upsControl=upsControl, PYSNMP_MODULE_ID=upsMIB, upsBasicIdentGroup=upsBasicIdentGroup, upsSubsetGroups=upsSubsetGroups, upsInputVoltage=upsInputVoltage, upsStartupAfterDelay=upsStartupAfterDelay, upsOutputVoltage=upsOutputVoltage, upsConfigOutputPower=upsConfigOutputPower, upsFullConfigGroup=upsFullConfigGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsIdent=upsIdent, upsAlarm=upsAlarm, upsConfigLowBattTime=upsConfigLowBattTime, upsOutputPower=upsOutputPower, upsInputTable=upsInputTable, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmTable=upsAlarmTable, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsFullInputGroup=upsFullInputGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsSubsetCompliance=upsSubsetCompliance, upsTrapTestCompleted=upsTrapTestCompleted, upsConfig=upsConfig, upsFullIdentGroup=upsFullIdentGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBasicInputGroup=upsBasicInputGroup, upsBasicCompliance=upsBasicCompliance, upsAlarmBypassBad=upsAlarmBypassBad, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsCompliances=upsCompliances, upsSubsetOutputGroup=upsSubsetOutputGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBypassTable=upsBypassTable, upsTestElapsedTime=upsTestElapsedTime, upsTrapOnBattery=upsTrapOnBattery, upsAlarmOutputBad=upsAlarmOutputBad, upsTestResultsSummary=upsTestResultsSummary, upsBypassVoltage=upsBypassVoltage, upsFullCompliance=upsFullCompliance, upsFullBypassGroup=upsFullBypassGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmsPresent=upsAlarmsPresent, upsOutputTable=upsOutputTable, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmTime=upsAlarmTime, upsConformance=upsConformance, upsBasicOutputGroup=upsBasicOutputGroup, upsWellKnownTests=upsWellKnownTests, upsAlarmEntry=upsAlarmEntry, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBypassPower=upsBypassPower, upsFullControlGroup=upsFullControlGroup, upsBatteryStatus=upsBatteryStatus, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed)
