...
# Produced by pysmi-1.1.12 at Mon Jun  3 03:00:40 2024
...
Counter64, MibIdentifier, iso, mib_2, NotificationType, Unsigned32, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, Counter32, Gauge32, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "iso", "mib-2", "NotificationType", "Unsigned32", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "Counter32", "Gauge32", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("UPS-MIB", upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsTestSpinLock=upsTestSpinLock, upsInput=upsInput, upsAlarmBypassBad=upsAlarmBypassBad, upsBypassEntry=upsBypassEntry, upsOutputNumLines=upsOutputNumLines, upsAlarmGeneralFault=upsAlarmGeneralFault, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmTempBad=upsAlarmTempBad, upsBypassLineIndex=upsBypassLineIndex, upsBypass=upsBypass, upsAlarmOutputBad=upsAlarmOutputBad, upsIdent=upsIdent, upsTestStartTime=upsTestStartTime, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, NonNegativeInteger=NonNegativeInteger, upsAlarmsPresent=upsAlarmsPresent, upsTestId=upsTestId, upsAlarmId=upsAlarmId, upsInputVoltage=upsInputVoltage, upsBypassPower=upsBypassPower, upsBattery=upsBattery, upsInputTable=upsInputTable, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsConfigAudibleStatus=upsConfigAudibleStatus, upsOutputPercentLoad=upsOutputPercentLoad, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsSubsetGroups=upsSubsetGroups, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTrapOnBattery=upsTrapOnBattery, upsBasicBypassGroup=upsBasicBypassGroup, upsIdentName=upsIdentName, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsCompliances=upsCompliances, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBypassVoltage=upsBypassVoltage, upsOutputSource=upsOutputSource, upsOutputTable=upsOutputTable, PYSNMP_MODULE_ID=upsMIB, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsOutputVoltage=upsOutputVoltage, upsWellKnownAlarms=upsWellKnownAlarms, upsTest=upsTest, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsInputEntry=upsInputEntry, upsAutoRestart=upsAutoRestart, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsOutputEntry=upsOutputEntry, upsAlarmTime=upsAlarmTime, upsConfig=upsConfig, upsBatteryVoltage=upsBatteryVoltage, upsAlarmChargerFailed=upsAlarmChargerFailed, upsFullBypassGroup=upsFullBypassGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTestResultsDetail=upsTestResultsDetail, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBatteryCurrent=upsBatteryCurrent, upsBypassTable=upsBypassTable, upsBasicInputGroup=upsBasicInputGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBasicCompliance=upsBasicCompliance, upsInputNumLines=upsInputNumLines, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConfigOutputFreq=upsConfigOutputFreq, upsObjects=upsObjects, upsAlarmShutdownPending=upsAlarmShutdownPending, upsOutputPower=upsOutputPower, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmEntry=upsAlarmEntry, upsConfigOutputVA=upsConfigOutputVA, upsTestResultsSummary=upsTestResultsSummary, upsSubsetInputGroup=upsSubsetInputGroup, upsBypassNumLines=upsBypassNumLines, upsBasicAlarmGroup=upsBasicAlarmGroup, upsConfigInputFreq=upsConfigInputFreq, upsInputCurrent=upsInputCurrent, upsSecondsOnBattery=upsSecondsOnBattery, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBasicTestGroup=upsBasicTestGroup, upsFullConfigGroup=upsFullConfigGroup, upsOutputLineIndex=upsOutputLineIndex, upsTestElapsedTime=upsTestElapsedTime, upsOutputFrequency=upsOutputFrequency, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsInputLineBads=upsInputLineBads, upsFullIdentGroup=upsFullIdentGroup, PositiveInteger=PositiveInteger, upsInputFrequency=upsInputFrequency, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsFullCompliance=upsFullCompliance, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmBatteryBad=upsAlarmBatteryBad, upsConfigOutputPower=upsConfigOutputPower, upsWellKnownTests=upsWellKnownTests, upsFullInputGroup=upsFullInputGroup, upsIdentModel=upsIdentModel, upsAlarmDescr=upsAlarmDescr, upsFullOutputGroup=upsFullOutputGroup, upsSubsetCompliance=upsSubsetCompliance, upsBasicIdentGroup=upsBasicIdentGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmInputBad=upsAlarmInputBad, upsShutdownType=upsShutdownType, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsRebootWithDuration=upsRebootWithDuration, upsBasicOutputGroup=upsBasicOutputGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBatteryTemperature=upsBatteryTemperature, upsFullGroups=upsFullGroups, upsInputTruePower=upsInputTruePower, upsControl=upsControl, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicGroups=upsBasicGroups, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBypassCurrent=upsBypassCurrent, upsConfigLowBattTime=upsConfigLowBattTime, upsFullAlarmGroup=upsFullAlarmGroup, upsOutput=upsOutput, upsFullTestGroup=upsFullTestGroup, upsAlarmTable=upsAlarmTable, upsStartupAfterDelay=upsStartupAfterDelay, upsFullControlGroup=upsFullControlGroup, upsBypassFrequency=upsBypassFrequency, upsBasicConfigGroup=upsBasicConfigGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsIdentManufacturer=upsIdentManufacturer, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsTraps=upsTraps, upsMIB=upsMIB, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsBasicControlGroup=upsBasicControlGroup, upsInputLineIndex=upsInputLineIndex, upsBatteryStatus=upsBatteryStatus, upsGroups=upsGroups, upsOutputCurrent=upsOutputCurrent, upsConformance=upsConformance, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarm=upsAlarm)
