...
# Produced by pysmi-1.1.12 at Tue May 28 13:55:33 2024
...
mibBuilder.exportSymbols("UPS-MIB", upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmLowBattery=upsAlarmLowBattery, upsTrapOnBattery=upsTrapOnBattery, upsConfigOutputVA=upsConfigOutputVA, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmsPresent=upsAlarmsPresent, upsBasicOutputGroup=upsBasicOutputGroup, upsConfigOutputPower=upsConfigOutputPower, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTestResultsSummary=upsTestResultsSummary, upsRebootWithDuration=upsRebootWithDuration, upsBypassCurrent=upsBypassCurrent, upsIdentModel=upsIdentModel, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTraps=upsTraps, upsWellKnownTests=upsWellKnownTests, upsSubsetGroups=upsSubsetGroups, upsConfigInputVoltage=upsConfigInputVoltage, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmDescr=upsAlarmDescr, upsBasicConfigGroup=upsBasicConfigGroup, upsOutputVoltage=upsOutputVoltage, NonNegativeInteger=NonNegativeInteger, upsOutput=upsOutput, upsTestResultsDetail=upsTestResultsDetail, upsAlarmEntry=upsAlarmEntry, upsBasicControlGroup=upsBasicControlGroup, upsAlarmTime=upsAlarmTime, upsBasicIdentGroup=upsBasicIdentGroup, upsObjects=upsObjects, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBattery=upsBattery, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsInputNumLines=upsInputNumLines, upsConfigOutputFreq=upsConfigOutputFreq, upsBasicTestGroup=upsBasicTestGroup, upsFullGroups=upsFullGroups, upsFullBypassGroup=upsFullBypassGroup, upsBatteryCurrent=upsBatteryCurrent, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsInputFrequency=upsInputFrequency, upsSubsetInputGroup=upsSubsetInputGroup, upsControl=upsControl, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmOutputBad=upsAlarmOutputBad, upsInput=upsInput, upsOutputCurrent=upsOutputCurrent, upsAlarmId=upsAlarmId, upsFullBatteryGroup=upsFullBatteryGroup, upsBypassLineIndex=upsBypassLineIndex, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsFullConfigGroup=upsFullConfigGroup, upsConfig=upsConfig, upsFullInputGroup=upsFullInputGroup, upsFullCompliance=upsFullCompliance, upsFullTestGroup=upsFullTestGroup, upsOutputPower=upsOutputPower, upsCompliances=upsCompliances, upsConfigLowBattTime=upsConfigLowBattTime, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmTempBad=upsAlarmTempBad, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAutoRestart=upsAutoRestart, upsAlarmOutputOverload=upsAlarmOutputOverload, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBypassNumLines=upsBypassNumLines, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBypass=upsBypass, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBypassPower=upsBypassPower, upsMIB=upsMIB, upsAlarmOnBattery=upsAlarmOnBattery, upsSecondsOnBattery=upsSecondsOnBattery, upsTestStartTime=upsTestStartTime, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmFanFailure=upsAlarmFanFailure, upsIdent=upsIdent, upsOutputLineIndex=upsOutputLineIndex, upsTest=upsTest, upsTestId=upsTestId, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBypassTable=upsBypassTable, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsConfigInputFreq=upsConfigInputFreq, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBypassFrequency=upsBypassFrequency, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBatteryStatus=upsBatteryStatus, upsBasicGroups=upsBasicGroups, upsInputCurrent=upsInputCurrent, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBatteryTemperature=upsBatteryTemperature, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmInputBad=upsAlarmInputBad, upsConformance=upsConformance, upsOutputTable=upsOutputTable, upsBasicAlarmGroup=upsBasicAlarmGroup, upsInputLineBads=upsInputLineBads, upsAlarmFuseFailure=upsAlarmFuseFailure, upsFullControlGroup=upsFullControlGroup, upsInputTruePower=upsInputTruePower, upsInputTable=upsInputTable, upsTestSpinLock=upsTestSpinLock, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBypassEntry=upsBypassEntry, upsIdentManufacturer=upsIdentManufacturer, PositiveInteger=PositiveInteger, upsBasicCompliance=upsBasicCompliance, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsShutdownType=upsShutdownType, upsBasicInputGroup=upsBasicInputGroup, upsOutputNumLines=upsOutputNumLines, upsTestElapsedTime=upsTestElapsedTime, upsSubsetCompliance=upsSubsetCompliance, upsAlarmTable=upsAlarmTable, PYSNMP_MODULE_ID=upsMIB, upsOutputSource=upsOutputSource, upsInputEntry=upsInputEntry, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBatteryVoltage=upsBatteryVoltage, upsAlarmBypassBad=upsAlarmBypassBad, upsGroups=upsGroups, upsSubsetIdentGroup=upsSubsetIdentGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsInputLineIndex=upsInputLineIndex, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsSubsetOutputGroup=upsSubsetOutputGroup, upsIdentName=upsIdentName, upsOutputPercentLoad=upsOutputPercentLoad, upsStartupAfterDelay=upsStartupAfterDelay, upsInputVoltage=upsInputVoltage, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmChargerFailed=upsAlarmChargerFailed, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsFullIdentGroup=upsFullIdentGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmTestInProgress=upsAlarmTestInProgress, upsFullOutputGroup=upsFullOutputGroup, upsBypassVoltage=upsBypassVoltage, upsOutputEntry=upsOutputEntry, upsOutputFrequency=upsOutputFrequency, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarm=upsAlarm)
