...
mibBuilder.exportSymbols("UPS-MIB", PositiveInteger=PositiveInteger, upsIdentName=upsIdentName, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsConfigAudibleStatus=upsConfigAudibleStatus, upsConfigOutputFreq=upsConfigOutputFreq, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmFanFailure=upsAlarmFanFailure, upsOutputPercentLoad=upsOutputPercentLoad, upsIdentModel=upsIdentModel, upsOutputNumLines=upsOutputNumLines, upsFullOutputGroup=upsFullOutputGroup, upsBatteryStatus=upsBatteryStatus, upsTestResultsSummary=upsTestResultsSummary, upsConformance=upsConformance, upsAlarmTable=upsAlarmTable, upsInputTruePower=upsInputTruePower, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutput=upsOutput, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBasicBypassGroup=upsBasicBypassGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarm=upsAlarm, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsInputNumLines=upsInputNumLines, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTest=upsTest, upsFullBypassGroup=upsFullBypassGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsRebootWithDuration=upsRebootWithDuration, PYSNMP_MODULE_ID=upsMIB, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConfigInputVoltage=upsConfigInputVoltage, upsStartupAfterDelay=upsStartupAfterDelay, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBypassNumLines=upsBypassNumLines, upsBypassPower=upsBypassPower, upsInputFrequency=upsInputFrequency, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsOutputVoltage=upsOutputVoltage, upsFullBatteryGroup=upsFullBatteryGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTrapTestCompleted=upsTrapTestCompleted, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsShutdownType=upsShutdownType, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTestElapsedTime=upsTestElapsedTime, upsTestResultsDetail=upsTestResultsDetail, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, NonNegativeInteger=NonNegativeInteger, upsInputTable=upsInputTable, upsConfigOutputVA=upsConfigOutputVA, upsControl=upsControl, upsOutputLineIndex=upsOutputLineIndex, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmId=upsAlarmId, upsFullInputGroup=upsFullInputGroup, upsConfig=upsConfig, upsTestId=upsTestId, upsTrapOnBattery=upsTrapOnBattery, upsObjects=upsObjects, upsOutputSource=upsOutputSource, upsBasicGroups=upsBasicGroups, upsInputLineIndex=upsInputLineIndex, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsInput=upsInput, upsAutoRestart=upsAutoRestart, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsSubsetIdentGroup=upsSubsetIdentGroup, upsOutputEntry=upsOutputEntry, upsBattery=upsBattery, upsSubsetGroups=upsSubsetGroups, upsAlarmTempBad=upsAlarmTempBad, upsBasicIdentGroup=upsBasicIdentGroup, upsBatteryTemperature=upsBatteryTemperature, upsBypass=upsBypass, upsTestSpinLock=upsTestSpinLock, upsBasicTestGroup=upsBasicTestGroup, upsAlarmTime=upsAlarmTime, upsBypassCurrent=upsBypassCurrent, upsBypassEntry=upsBypassEntry, upsInputVoltage=upsInputVoltage, upsCompliances=upsCompliances, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmOnBypass=upsAlarmOnBypass, upsMIB=upsMIB, upsAlarmDescr=upsAlarmDescr, upsSubsetCompliance=upsSubsetCompliance, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTraps=upsTraps, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBypassVoltage=upsBypassVoltage, upsOutputFrequency=upsOutputFrequency, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBasicAlarmGroup=upsBasicAlarmGroup, upsInputEntry=upsInputEntry, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmLowBattery=upsAlarmLowBattery, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsWellKnownAlarms=upsWellKnownAlarms, upsBypassLineIndex=upsBypassLineIndex, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTestStartTime=upsTestStartTime, upsBasicControlGroup=upsBasicControlGroup, upsBypassTable=upsBypassTable, upsFullGroups=upsFullGroups, upsFullIdentGroup=upsFullIdentGroup, upsAlarmInputBad=upsAlarmInputBad, upsAlarmEntry=upsAlarmEntry, upsSubsetInputGroup=upsSubsetInputGroup, upsWellKnownTests=upsWellKnownTests, upsConfigOutputPower=upsConfigOutputPower, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBasicInputGroup=upsBasicInputGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigInputFreq=upsConfigInputFreq, upsInputLineBads=upsInputLineBads, upsSubsetOutputGroup=upsSubsetOutputGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBatteryCurrent=upsBatteryCurrent, upsBasicCompliance=upsBasicCompliance, upsFullControlGroup=upsFullControlGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBatteryVoltage=upsBatteryVoltage, upsInputCurrent=upsInputCurrent, upsOutputCurrent=upsOutputCurrent, upsAlarmFuseFailure=upsAlarmFuseFailure, upsGroups=upsGroups, upsBypassFrequency=upsBypassFrequency, upsAlarmsPresent=upsAlarmsPresent, upsIdent=upsIdent, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutputPower=upsOutputPower, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsOutputTable=upsOutputTable, upsFullConfigGroup=upsFullConfigGroup, upsFullCompliance=upsFullCompliance, upsFullTestGroup=upsFullTestGroup, upsIdentManufacturer=upsIdentManufacturer, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint)
