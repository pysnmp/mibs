...
# Produced by pysmi-1.1.8 at Wed Sep  6 13:42:46 2023
...
mib_2, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, NotificationType, TimeTicks, Bits, MibIdentifier, ObjectIdentity, IpAddress, ModuleIdentity, iso, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "NotificationType", "TimeTicks", "Bits", "MibIdentifier", "ObjectIdentity", "IpAddress", "ModuleIdentity", "iso", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("UPS-MIB", upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBasicBypassGroup=upsBasicBypassGroup, upsOutputSource=upsOutputSource, upsFullBypassGroup=upsFullBypassGroup, upsOutputPower=upsOutputPower, NonNegativeInteger=NonNegativeInteger, upsAlarmTable=upsAlarmTable, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTestResultsSummary=upsTestResultsSummary, upsInputNumLines=upsInputNumLines, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmInputBad=upsAlarmInputBad, upsAutoRestart=upsAutoRestart, upsBasicIdentGroup=upsBasicIdentGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBasicCompliance=upsBasicCompliance, upsInputVoltage=upsInputVoltage, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmDescr=upsAlarmDescr, upsInputEntry=upsInputEntry, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmFanFailure=upsAlarmFanFailure, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsTestId=upsTestId, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmShutdownPending=upsAlarmShutdownPending, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsIdentManufacturer=upsIdentManufacturer, upsAlarmTempBad=upsAlarmTempBad, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmOnBypass=upsAlarmOnBypass, PYSNMP_MODULE_ID=upsMIB, upsOutputTable=upsOutputTable, upsBatteryTemperature=upsBatteryTemperature, upsInput=upsInput, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmLowBattery=upsAlarmLowBattery, upsBatteryStatus=upsBatteryStatus, upsConfigInputFreq=upsConfigInputFreq, upsBypassPower=upsBypassPower, upsOutputCurrent=upsOutputCurrent, upsObjects=upsObjects, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTestResultsDetail=upsTestResultsDetail, upsBasicGroups=upsBasicGroups, upsBypassNumLines=upsBypassNumLines, upsTestSpinLock=upsTestSpinLock, upsSubsetControlGroup=upsSubsetControlGroup, upsFullTestGroup=upsFullTestGroup, upsFullInputGroup=upsFullInputGroup, upsBypassLineIndex=upsBypassLineIndex, upsCompliances=upsCompliances, upsGroups=upsGroups, upsSubsetIdentGroup=upsSubsetIdentGroup, upsIdentName=upsIdentName, upsWellKnownAlarms=upsWellKnownAlarms, upsFullOutputGroup=upsFullOutputGroup, upsFullGroups=upsFullGroups, upsBasicTestGroup=upsBasicTestGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBypassCurrent=upsBypassCurrent, upsConfigAudibleStatus=upsConfigAudibleStatus, upsConformance=upsConformance, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsOutputFrequency=upsOutputFrequency, upsIdent=upsIdent, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsFullConfigGroup=upsFullConfigGroup, upsOutputEntry=upsOutputEntry, upsShutdownType=upsShutdownType, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBatteryVoltage=upsBatteryVoltage, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTrapOnBattery=upsTrapOnBattery, upsInputCurrent=upsInputCurrent, upsAlarmOutputBad=upsAlarmOutputBad, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTestStartTime=upsTestStartTime, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBypassEntry=upsBypassEntry, upsRebootWithDuration=upsRebootWithDuration, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypassFrequency=upsBypassFrequency, upsTestElapsedTime=upsTestElapsedTime, upsBasicBatteryGroup=upsBasicBatteryGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBattery=upsBattery, upsBypassTable=upsBypassTable, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarm=upsAlarm, upsOutput=upsOutput, upsOutputLineIndex=upsOutputLineIndex, upsOutputNumLines=upsOutputNumLines, upsAlarmEntry=upsAlarmEntry, upsStartupAfterDelay=upsStartupAfterDelay, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsFullControlGroup=upsFullControlGroup, upsInputLineBads=upsInputLineBads, upsBypass=upsBypass, upsFullAlarmGroup=upsFullAlarmGroup, upsBasicInputGroup=upsBasicInputGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmTime=upsAlarmTime, PositiveInteger=PositiveInteger, upsAlarmId=upsAlarmId, upsWellKnownTests=upsWellKnownTests, upsControl=upsControl, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsIdentModel=upsIdentModel, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmsPresent=upsAlarmsPresent, upsTraps=upsTraps, upsBasicControlGroup=upsBasicControlGroup, upsConfig=upsConfig, upsBasicOutputGroup=upsBasicOutputGroup, upsConfigOutputPower=upsConfigOutputPower, upsFullIdentGroup=upsFullIdentGroup, upsBatteryCurrent=upsBatteryCurrent, upsBypassVoltage=upsBypassVoltage, upsMIB=upsMIB, upsConfigOutputVA=upsConfigOutputVA, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsOutputVoltage=upsOutputVoltage, upsInputTable=upsInputTable, upsAlarmChargerFailed=upsAlarmChargerFailed, upsSubsetGroups=upsSubsetGroups, upsSubsetCompliance=upsSubsetCompliance, upsAlarmGeneralFault=upsAlarmGeneralFault, upsFullCompliance=upsFullCompliance, upsInputTruePower=upsInputTruePower, upsInputFrequency=upsInputFrequency, upsConfigOutputVoltage=upsConfigOutputVoltage, upsSubsetConfigGroup=upsSubsetConfigGroup, upsInputLineIndex=upsInputLineIndex, upsOutputPercentLoad=upsOutputPercentLoad, upsTest=upsTest, upsIdentAttachedDevices=upsIdentAttachedDevices, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining)
