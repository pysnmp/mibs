...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmShutdownPending=upsAlarmShutdownPending, upsIdent=upsIdent, upsConfigOutputVoltage=upsConfigOutputVoltage, upsInputEntry=upsInputEntry, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsTrapOnBattery=upsTrapOnBattery, upsBypassVoltage=upsBypassVoltage, upsTestId=upsTestId, upsIdentName=upsIdentName, upsConfig=upsConfig, upsIdentManufacturer=upsIdentManufacturer, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmBatteryBad=upsAlarmBatteryBad, upsWellKnownTests=upsWellKnownTests, upsControl=upsControl, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsIdentModel=upsIdentModel, upsTestSpinLock=upsTestSpinLock, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBypassEntry=upsBypassEntry, upsBypassFrequency=upsBypassFrequency, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsOutput=upsOutput, upsConfigInputFreq=upsConfigInputFreq, upsTrapTestCompleted=upsTrapTestCompleted, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsOutputVoltage=upsOutputVoltage, upsInputLineIndex=upsInputLineIndex, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmFanFailure=upsAlarmFanFailure, upsBatteryVoltage=upsBatteryVoltage, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBypassLineIndex=upsBypassLineIndex, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsInputVoltage=upsInputVoltage, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmOnBypass=upsAlarmOnBypass, upsObjects=upsObjects, upsBattery=upsBattery, upsConfigOutputPower=upsConfigOutputPower, upsAlarmId=upsAlarmId, upsOutputTable=upsOutputTable, upsBypassTable=upsBypassTable, upsInputFrequency=upsInputFrequency, upsSubsetControlGroup=upsSubsetControlGroup, upsInputTable=upsInputTable, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTestResultsDetail=upsTestResultsDetail, upsShutdownType=upsShutdownType, upsInputTruePower=upsInputTruePower, upsAlarm=upsAlarm, upsBypassCurrent=upsBypassCurrent, upsAlarmFuseFailure=upsAlarmFuseFailure, upsFullCompliance=upsFullCompliance, upsOutputPower=upsOutputPower, upsCompliances=upsCompliances, upsSubsetGroups=upsSubsetGroups, upsBypassNumLines=upsBypassNumLines, upsFullOutputGroup=upsFullOutputGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigAudibleStatus=upsConfigAudibleStatus, upsFullControlGroup=upsFullControlGroup, upsInputNumLines=upsInputNumLines, upsTraps=upsTraps, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsConfigInputVoltage=upsConfigInputVoltage, upsBypassPower=upsBypassPower, upsBatteryStatus=upsBatteryStatus, upsInputLineBads=upsInputLineBads, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmTable=upsAlarmTable, upsRebootWithDuration=upsRebootWithDuration, upsFullIdentGroup=upsFullIdentGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsOutputCurrent=upsOutputCurrent, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmsPresent=upsAlarmsPresent, upsAlarmDescr=upsAlarmDescr, upsOutputLineIndex=upsOutputLineIndex, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsStartupAfterDelay=upsStartupAfterDelay, upsSecondsOnBattery=upsSecondsOnBattery, upsFullBatteryGroup=upsFullBatteryGroup, upsBasicCompliance=upsBasicCompliance, upsOutputSource=upsOutputSource, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsFullInputGroup=upsFullInputGroup, upsFullTestGroup=upsFullTestGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsOutputFrequency=upsOutputFrequency, upsGroups=upsGroups, upsInput=upsInput, upsShutdownAfterDelay=upsShutdownAfterDelay, upsConformance=upsConformance, upsBasicAlarmGroup=upsBasicAlarmGroup, upsFullConfigGroup=upsFullConfigGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsOutputEntry=upsOutputEntry, PYSNMP_MODULE_ID=upsMIB, upsIdentAttachedDevices=upsIdentAttachedDevices, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsFullGroups=upsFullGroups, upsFullAlarmGroup=upsFullAlarmGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBasicOutputGroup=upsBasicOutputGroup, upsBasicTestGroup=upsBasicTestGroup, upsAutoRestart=upsAutoRestart, upsBasicBypassGroup=upsBasicBypassGroup, upsInputCurrent=upsInputCurrent, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmInputBad=upsAlarmInputBad, upsBatteryCurrent=upsBatteryCurrent, upsAlarmEntry=upsAlarmEntry, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmTempBad=upsAlarmTempBad, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutputNumLines=upsOutputNumLines, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBasicControlGroup=upsBasicControlGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsSubsetCompliance=upsSubsetCompliance, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBypass=upsBypass, upsBasicInputGroup=upsBasicInputGroup, upsTestElapsedTime=upsTestElapsedTime, upsTest=upsTest, upsSubsetInputGroup=upsSubsetInputGroup, upsFullBypassGroup=upsFullBypassGroup, upsBasicGroups=upsBasicGroups, PositiveInteger=PositiveInteger, upsTestStartTime=upsTestStartTime, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsMIB=upsMIB, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBasicConfigGroup=upsBasicConfigGroup, upsTestResultsSummary=upsTestResultsSummary, upsAlarmTime=upsAlarmTime, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmOutputOverload=upsAlarmOutputOverload, upsConfigOutputVA=upsConfigOutputVA, upsBatteryTemperature=upsBatteryTemperature, upsConfigLowBattTime=upsConfigLowBattTime, NonNegativeInteger=NonNegativeInteger)
