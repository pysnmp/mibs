...
mibBuilder.exportSymbols("UPS-MIB", upsBypassCurrent=upsBypassCurrent, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsOutputVoltage=upsOutputVoltage, upsOutputPower=upsOutputPower, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBypassVoltage=upsBypassVoltage, upsSubsetGroups=upsSubsetGroups, upsSubsetOutputGroup=upsSubsetOutputGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsFullIdentGroup=upsFullIdentGroup, upsConfig=upsConfig, upsInputEntry=upsInputEntry, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmTempBad=upsAlarmTempBad, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsTraps=upsTraps, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsOutputCurrent=upsOutputCurrent, upsFullBatteryGroup=upsFullBatteryGroup, upsAutoRestart=upsAutoRestart, upsAlarm=upsAlarm, upsAlarmLowBattery=upsAlarmLowBattery, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmDescr=upsAlarmDescr, upsTestResultsSummary=upsTestResultsSummary, upsConfigInputFreq=upsConfigInputFreq, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsControl=upsControl, upsFullOutputGroup=upsFullOutputGroup, upsTestId=upsTestId, upsAlarmGeneralFault=upsAlarmGeneralFault, upsWellKnownAlarms=upsWellKnownAlarms, upsConfigInputVoltage=upsConfigInputVoltage, upsOutputSource=upsOutputSource, upsOutputFrequency=upsOutputFrequency, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmFanFailure=upsAlarmFanFailure, upsBasicControlGroup=upsBasicControlGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmShutdownPending=upsAlarmShutdownPending, upsGroups=upsGroups, PositiveInteger=PositiveInteger, upsIdent=upsIdent, upsOutputPercentLoad=upsOutputPercentLoad, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsSubsetCompliance=upsSubsetCompliance, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsIdentManufacturer=upsIdentManufacturer, upsTestElapsedTime=upsTestElapsedTime, upsFullInputGroup=upsFullInputGroup, upsInputNumLines=upsInputNumLines, upsOutput=upsOutput, upsBypass=upsBypass, upsOutputLineIndex=upsOutputLineIndex, upsBypassNumLines=upsBypassNumLines, upsBasicCompliance=upsBasicCompliance, upsFullControlGroup=upsFullControlGroup, upsAlarmsPresent=upsAlarmsPresent, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutputNumLines=upsOutputNumLines, upsAlarmEntry=upsAlarmEntry, upsBatteryStatus=upsBatteryStatus, upsConfigOutputPower=upsConfigOutputPower, upsInputLineBads=upsInputLineBads, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBasicInputGroup=upsBasicInputGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsShutdownType=upsShutdownType, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTrapTestCompleted=upsTrapTestCompleted, upsBypassLineIndex=upsBypassLineIndex, upsTestSpinLock=upsTestSpinLock, upsAlarmId=upsAlarmId, upsOutputTable=upsOutputTable, upsInputTable=upsInputTable, upsRebootWithDuration=upsRebootWithDuration, upsIdentModel=upsIdentModel, upsConfigOutputVA=upsConfigOutputVA, upsBasicBypassGroup=upsBasicBypassGroup, upsMIB=upsMIB, upsConfigOutputVoltage=upsConfigOutputVoltage, upsFullBypassGroup=upsFullBypassGroup, upsBatteryCurrent=upsBatteryCurrent, upsConformance=upsConformance, upsBasicTestGroup=upsBasicTestGroup, upsTestStartTime=upsTestStartTime, upsAlarmTime=upsAlarmTime, upsInputCurrent=upsInputCurrent, upsBypassPower=upsBypassPower, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsWellKnownTests=upsWellKnownTests, upsBasicConfigGroup=upsBasicConfigGroup, upsBypassTable=upsBypassTable, upsObjects=upsObjects, upsInput=upsInput, upsBypassFrequency=upsBypassFrequency, upsAlarmOutputBad=upsAlarmOutputBad, upsIdentName=upsIdentName, upsAlarmFuseFailure=upsAlarmFuseFailure, NonNegativeInteger=NonNegativeInteger, upsInputTruePower=upsInputTruePower, upsBypassEntry=upsBypassEntry, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsFullConfigGroup=upsFullConfigGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmInputBad=upsAlarmInputBad, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestResultsDetail=upsTestResultsDetail, upsFullCompliance=upsFullCompliance, upsStartupAfterDelay=upsStartupAfterDelay, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBatteryTemperature=upsBatteryTemperature, upsBattery=upsBattery, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsFullAlarmGroup=upsFullAlarmGroup, upsBatteryVoltage=upsBatteryVoltage, upsBasicOutputGroup=upsBasicOutputGroup, upsFullGroups=upsFullGroups, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmOnBattery=upsAlarmOnBattery, upsTrapOnBattery=upsTrapOnBattery, upsInputVoltage=upsInputVoltage, upsOutputEntry=upsOutputEntry, upsInputFrequency=upsInputFrequency, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, PYSNMP_MODULE_ID=upsMIB, upsTest=upsTest, upsInputLineIndex=upsInputLineIndex, upsBasicGroups=upsBasicGroups, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsSubsetControlGroup=upsSubsetControlGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmTable=upsAlarmTable, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsFullTestGroup=upsFullTestGroup, upsCompliances=upsCompliances, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded)
