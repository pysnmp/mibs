...
DisplayString, TimeInterval, TimeStamp, TestAndIncr, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeInterval", "TimeStamp", "TestAndIncr", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("UPS-MIB", upsCompliances=upsCompliances, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsBatteryVoltage=upsBatteryVoltage, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBypassEntry=upsBypassEntry, upsBypassLineIndex=upsBypassLineIndex, upsBasicCompliance=upsBasicCompliance, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmChargerFailed=upsAlarmChargerFailed, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsControl=upsControl, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsInputCurrent=upsInputCurrent, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsFullOutputGroup=upsFullOutputGroup, upsBypassTable=upsBypassTable, upsMIB=upsMIB, upsConfigOutputFreq=upsConfigOutputFreq, upsOutputFrequency=upsOutputFrequency, upsInputTable=upsInputTable, upsSubsetControlGroup=upsSubsetControlGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsGroups=upsGroups, upsBasicBypassGroup=upsBasicBypassGroup, upsOutputTable=upsOutputTable, upsTestStartTime=upsTestStartTime, upsIdentModel=upsIdentModel, upsBypassNumLines=upsBypassNumLines, upsConfigInputVoltage=upsConfigInputVoltage, upsStartupAfterDelay=upsStartupAfterDelay, upsInputLineBads=upsInputLineBads, PositiveInteger=PositiveInteger, upsTestResultsDetail=upsTestResultsDetail, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsSubsetInputGroup=upsSubsetInputGroup, upsTraps=upsTraps, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarm=upsAlarm, upsOutputSource=upsOutputSource, upsTrapTestCompleted=upsTrapTestCompleted, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullInputGroup=upsFullInputGroup, upsBypassFrequency=upsBypassFrequency, upsTrapOnBattery=upsTrapOnBattery, upsBatteryTemperature=upsBatteryTemperature, upsIdentName=upsIdentName, upsInputLineIndex=upsInputLineIndex, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsRebootWithDuration=upsRebootWithDuration, upsBattery=upsBattery, upsTestSpinLock=upsTestSpinLock, PYSNMP_MODULE_ID=upsMIB, upsInputNumLines=upsInputNumLines, upsFullTestGroup=upsFullTestGroup, upsFullGroups=upsFullGroups, upsInputEntry=upsInputEntry, upsIdentManufacturer=upsIdentManufacturer, upsOutputNumLines=upsOutputNumLines, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBatteryCurrent=upsBatteryCurrent, upsBatteryStatus=upsBatteryStatus, upsOutputCurrent=upsOutputCurrent, upsAlarmTime=upsAlarmTime, upsTest=upsTest, upsOutputVoltage=upsOutputVoltage, upsBasicGroups=upsBasicGroups, upsFullControlGroup=upsFullControlGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsConfigAudibleStatus=upsConfigAudibleStatus, upsIdent=upsIdent, upsBypassPower=upsBypassPower, upsBasicTestGroup=upsBasicTestGroup, upsTestId=upsTestId, upsObjects=upsObjects, upsBasicInputGroup=upsBasicInputGroup, NonNegativeInteger=NonNegativeInteger, upsBypassCurrent=upsBypassCurrent, upsSubsetGroups=upsSubsetGroups, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsFullBatteryGroup=upsFullBatteryGroup, upsConfigOutputPower=upsConfigOutputPower, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTestResultsSummary=upsTestResultsSummary, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmDescr=upsAlarmDescr, upsAlarmTable=upsAlarmTable, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsSubsetIdentGroup=upsSubsetIdentGroup, upsConfig=upsConfig, upsConfigOutputVA=upsConfigOutputVA, upsFullConfigGroup=upsFullConfigGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsBypass=upsBypass, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmEntry=upsAlarmEntry, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypassVoltage=upsBypassVoltage, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmId=upsAlarmId, upsAutoRestart=upsAutoRestart, upsShutdownType=upsShutdownType, upsInputFrequency=upsInputFrequency, upsConfigInputFreq=upsConfigInputFreq, upsFullCompliance=upsFullCompliance, upsTestElapsedTime=upsTestElapsedTime, upsFullIdentGroup=upsFullIdentGroup, upsBasicControlGroup=upsBasicControlGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmTempBad=upsAlarmTempBad, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsInputTruePower=upsInputTruePower, upsAlarmsPresent=upsAlarmsPresent, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsInput=upsInput, upsOutputEntry=upsOutputEntry, upsConformance=upsConformance, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsOutputPower=upsOutputPower, upsOutputLineIndex=upsOutputLineIndex, upsSubsetCompliance=upsSubsetCompliance, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicOutputGroup=upsBasicOutputGroup, upsWellKnownTests=upsWellKnownTests, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsOutput=upsOutput, upsInputVoltage=upsInputVoltage, upsAlarmInputBad=upsAlarmInputBad, upsShutdownAfterDelay=upsShutdownAfterDelay, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullBypassGroup=upsFullBypassGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmFanFailure=upsAlarmFanFailure, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBasicConfigGroup=upsBasicConfigGroup)
