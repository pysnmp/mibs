...
mibBuilder.exportSymbols("UPS-MIB", upsTrapTestCompleted=upsTrapTestCompleted, upsBattery=upsBattery, upsOutputEntry=upsOutputEntry, upsAlarmBypassBad=upsAlarmBypassBad, upsBasicInputGroup=upsBasicInputGroup, upsBypassPower=upsBypassPower, upsOutput=upsOutput, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmInputBad=upsAlarmInputBad, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBasicTestGroup=upsBasicTestGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsObjects=upsObjects, upsOutputLineIndex=upsOutputLineIndex, upsBasicBatteryGroup=upsBasicBatteryGroup, upsIdentName=upsIdentName, upsBasicBypassGroup=upsBasicBypassGroup, upsOutputSource=upsOutputSource, upsTest=upsTest, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBasicConfigGroup=upsBasicConfigGroup, upsFullTestGroup=upsFullTestGroup, upsBasicGroups=upsBasicGroups, upsBypass=upsBypass, upsInput=upsInput, upsOutputFrequency=upsOutputFrequency, upsTestResultsSummary=upsTestResultsSummary, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsIdentManufacturer=upsIdentManufacturer, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmOnBypass=upsAlarmOnBypass, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsConfigOutputVA=upsConfigOutputVA, upsSubsetInputGroup=upsSubsetInputGroup, upsTestResultsDetail=upsTestResultsDetail, upsFullIdentGroup=upsFullIdentGroup, upsInputEntry=upsInputEntry, upsBatteryStatus=upsBatteryStatus, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsConfigOutputPower=upsConfigOutputPower, upsAlarmOnBattery=upsAlarmOnBattery, upsTestElapsedTime=upsTestElapsedTime, upsBatteryCurrent=upsBatteryCurrent, upsFullBypassGroup=upsFullBypassGroup, upsAlarmsPresent=upsAlarmsPresent, upsAlarmDescr=upsAlarmDescr, upsShutdownType=upsShutdownType, upsInputCurrent=upsInputCurrent, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmEntry=upsAlarmEntry, upsConfigOutputVoltage=upsConfigOutputVoltage, upsInputNumLines=upsInputNumLines, upsFullInputGroup=upsFullInputGroup, upsControl=upsControl, upsSubsetCompliance=upsSubsetCompliance, upsInputTable=upsInputTable, upsAutoRestart=upsAutoRestart, upsConfigInputFreq=upsConfigInputFreq, upsShutdownAfterDelay=upsShutdownAfterDelay, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsOutputNumLines=upsOutputNumLines, upsBypassVoltage=upsBypassVoltage, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmId=upsAlarmId, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsOutputVoltage=upsOutputVoltage, upsAlarmTable=upsAlarmTable, upsFullCompliance=upsFullCompliance, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsIdent=upsIdent, upsBypassCurrent=upsBypassCurrent, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmGeneralFault=upsAlarmGeneralFault, upsGroups=upsGroups, upsTestSpinLock=upsTestSpinLock, upsInputFrequency=upsInputFrequency, upsInputVoltage=upsInputVoltage, upsBypassNumLines=upsBypassNumLines, upsBasicOutputGroup=upsBasicOutputGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetGroups=upsSubsetGroups, upsBasicCompliance=upsBasicCompliance, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBypassTable=upsBypassTable, upsConfigInputVoltage=upsConfigInputVoltage, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBypassEntry=upsBypassEntry, upsConformance=upsConformance, upsFullOutputGroup=upsFullOutputGroup, upsInputLineBads=upsInputLineBads, upsInputTruePower=upsInputTruePower, PositiveInteger=PositiveInteger, upsFullGroups=upsFullGroups, upsBypassLineIndex=upsBypassLineIndex, upsAlarmTime=upsAlarmTime, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsWellKnownTests=upsWellKnownTests, upsOutputTable=upsOutputTable, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsConfig=upsConfig, upsAlarmLowBattery=upsAlarmLowBattery, upsFullBatteryGroup=upsFullBatteryGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsFullConfigGroup=upsFullConfigGroup, upsInputLineIndex=upsInputLineIndex, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmBatteryBad=upsAlarmBatteryBad, upsCompliances=upsCompliances, upsBypassFrequency=upsBypassFrequency, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsConfigOutputFreq=upsConfigOutputFreq, upsMIB=upsMIB, NonNegativeInteger=NonNegativeInteger, upsAlarm=upsAlarm, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTestStartTime=upsTestStartTime, upsConfigLowBattTime=upsConfigLowBattTime, upsBasicControlGroup=upsBasicControlGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsTestId=upsTestId, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsRebootWithDuration=upsRebootWithDuration, upsOutputPower=upsOutputPower, upsAlarmFuseFailure=upsAlarmFuseFailure, PYSNMP_MODULE_ID=upsMIB, upsAlarmChargerFailed=upsAlarmChargerFailed, upsOutputCurrent=upsOutputCurrent, upsIdentModel=upsIdentModel, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTrapOnBattery=upsTrapOnBattery, upsSecondsOnBattery=upsSecondsOnBattery, upsOutputPercentLoad=upsOutputPercentLoad, upsTraps=upsTraps, upsBatteryTemperature=upsBatteryTemperature, upsAlarmTempBad=upsAlarmTempBad, upsBatteryVoltage=upsBatteryVoltage, upsWellKnownAlarms=upsWellKnownAlarms, upsFullControlGroup=upsFullControlGroup)
