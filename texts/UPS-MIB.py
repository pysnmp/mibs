...
mibBuilder.exportSymbols("UPS-MIB", upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsShutdownAfterDelay=upsShutdownAfterDelay, upsOutputLineIndex=upsOutputLineIndex, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsSecondsOnBattery=upsSecondsOnBattery, upsOutputPower=upsOutputPower, upsTestElapsedTime=upsTestElapsedTime, upsAlarm=upsAlarm, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmOutputBad=upsAlarmOutputBad, upsOutputCurrent=upsOutputCurrent, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsFullOutputGroup=upsFullOutputGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsMIB=upsMIB, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmId=upsAlarmId, upsBatteryVoltage=upsBatteryVoltage, upsFullBypassGroup=upsFullBypassGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsBypassVoltage=upsBypassVoltage, upsBypassPower=upsBypassPower, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBasicInputGroup=upsBasicInputGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsInputTruePower=upsInputTruePower, upsFullIdentGroup=upsFullIdentGroup, upsOutput=upsOutput, upsSubsetInputGroup=upsSubsetInputGroup, upsTestSpinLock=upsTestSpinLock, upsSubsetIdentGroup=upsSubsetIdentGroup, upsControl=upsControl, upsBasicIdentGroup=upsBasicIdentGroup, upsFullConfigGroup=upsFullConfigGroup, upsSubsetGroups=upsSubsetGroups, PositiveInteger=PositiveInteger, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsInputLineIndex=upsInputLineIndex, upsConfig=upsConfig, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBasicGroups=upsBasicGroups, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBatteryCurrent=upsBatteryCurrent, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTrapOnBattery=upsTrapOnBattery, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBypassLineIndex=upsBypassLineIndex, upsAlarmInputBad=upsAlarmInputBad, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsOutputSource=upsOutputSource, upsBasicControlGroup=upsBasicControlGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsBypass=upsBypass, upsBasicOutputGroup=upsBasicOutputGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsConfigInputVoltage=upsConfigInputVoltage, upsWellKnownTests=upsWellKnownTests, upsConfigInputFreq=upsConfigInputFreq, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBypassTable=upsBypassTable, upsOutputPercentLoad=upsOutputPercentLoad, upsFullControlGroup=upsFullControlGroup, upsAlarmTime=upsAlarmTime, upsStartupAfterDelay=upsStartupAfterDelay, upsAutoRestart=upsAutoRestart, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsOutputEntry=upsOutputEntry, upsAlarmsPresent=upsAlarmsPresent, upsObjects=upsObjects, upsTestResultsSummary=upsTestResultsSummary, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmBatteryBad=upsAlarmBatteryBad, upsShutdownType=upsShutdownType, upsBypassNumLines=upsBypassNumLines, upsInputEntry=upsInputEntry, upsFullAlarmGroup=upsFullAlarmGroup, upsInput=upsInput, upsIdentName=upsIdentName, upsAlarmTempBad=upsAlarmTempBad, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBasicAlarmGroup=upsBasicAlarmGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsInputNumLines=upsInputNumLines, upsOutputNumLines=upsOutputNumLines, upsInputFrequency=upsInputFrequency, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullBatteryGroup=upsFullBatteryGroup, upsInputCurrent=upsInputCurrent, upsConfigLowBattTime=upsConfigLowBattTime, upsBatteryStatus=upsBatteryStatus, upsAlarmFanFailure=upsAlarmFanFailure, upsOutputVoltage=upsOutputVoltage, upsIdentManufacturer=upsIdentManufacturer, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBasicCompliance=upsBasicCompliance, upsInputTable=upsInputTable, PYSNMP_MODULE_ID=upsMIB, upsOutputTable=upsOutputTable, upsConfigOutputVA=upsConfigOutputVA, upsBypassFrequency=upsBypassFrequency, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBypassEntry=upsBypassEntry, upsFullCompliance=upsFullCompliance, upsRebootWithDuration=upsRebootWithDuration, upsConformance=upsConformance, upsFullTestGroup=upsFullTestGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTestId=upsTestId, upsConfigOutputPower=upsConfigOutputPower, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTestStartTime=upsTestStartTime, upsBattery=upsBattery, upsIdent=upsIdent, upsSubsetCompliance=upsSubsetCompliance, upsCompliances=upsCompliances, upsBasicTestGroup=upsBasicTestGroup, upsBatteryTemperature=upsBatteryTemperature, upsOutputFrequency=upsOutputFrequency, upsTestResultsDetail=upsTestResultsDetail, upsBypassCurrent=upsBypassCurrent, upsIdentModel=upsIdentModel, upsAlarmDescr=upsAlarmDescr, NonNegativeInteger=NonNegativeInteger, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmTable=upsAlarmTable, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullGroups=upsFullGroups, upsFullInputGroup=upsFullInputGroup, upsAlarmEntry=upsAlarmEntry, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsGroups=upsGroups, upsInputVoltage=upsInputVoltage, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTraps=upsTraps, upsInputLineBads=upsInputLineBads, upsTest=upsTest, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining)
