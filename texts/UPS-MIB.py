...
# Produced by pysmi-1.1.12 at Tue Sep 17 13:26:03 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, Integer32, Gauge32, mib_2, TimeTicks, Counter64, MibIdentifier, iso, Unsigned32, Counter32, IpAddress, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "Integer32", "Gauge32", "mib-2", "TimeTicks", "Counter64", "MibIdentifier", "iso", "Unsigned32", "Counter32", "IpAddress", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("UPS-MIB", upsTestElapsedTime=upsTestElapsedTime, upsAlarmFanFailure=upsAlarmFanFailure, upsInputTruePower=upsInputTruePower, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBasicControlGroup=upsBasicControlGroup, upsOutput=upsOutput, upsTest=upsTest, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmEntry=upsAlarmEntry, upsBasicGroups=upsBasicGroups, upsSubsetOutputGroup=upsSubsetOutputGroup, upsConfigInputFreq=upsConfigInputFreq, upsBasicBypassGroup=upsBasicBypassGroup, upsSubsetGroups=upsSubsetGroups, upsWellKnownAlarms=upsWellKnownAlarms, upsOutputPercentLoad=upsOutputPercentLoad, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsRebootWithDuration=upsRebootWithDuration, upsConfigOutputVoltage=upsConfigOutputVoltage, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsOutputTable=upsOutputTable, upsFullInputGroup=upsFullInputGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetControlGroup=upsSubsetControlGroup, upsOutputSource=upsOutputSource, upsBasicBatteryGroup=upsBasicBatteryGroup, upsCompliances=upsCompliances, upsBasicIdentGroup=upsBasicIdentGroup, upsFullBypassGroup=upsFullBypassGroup, PositiveInteger=PositiveInteger, NonNegativeInteger=NonNegativeInteger, upsBypassPower=upsBypassPower, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmTestInProgress=upsAlarmTestInProgress, upsSubsetCompliance=upsSubsetCompliance, upsFullGroups=upsFullGroups, upsAlarmTempBad=upsAlarmTempBad, upsIdentName=upsIdentName, upsBatteryStatus=upsBatteryStatus, upsAlarmGeneralFault=upsAlarmGeneralFault, upsInputEntry=upsInputEntry, upsWellKnownTests=upsWellKnownTests, upsFullControlGroup=upsFullControlGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBypass=upsBypass, upsStartupAfterDelay=upsStartupAfterDelay, upsObjects=upsObjects, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsBypassFrequency=upsBypassFrequency, upsBypassCurrent=upsBypassCurrent, upsAlarmShutdownPending=upsAlarmShutdownPending, upsTrapTestCompleted=upsTrapTestCompleted, upsOutputNumLines=upsOutputNumLines, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBypassLineIndex=upsBypassLineIndex, upsConfigOutputVA=upsConfigOutputVA, upsFullCompliance=upsFullCompliance, upsAlarmsPresent=upsAlarmsPresent, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsOutputPower=upsOutputPower, upsBypassEntry=upsBypassEntry, upsOutputEntry=upsOutputEntry, upsInputCurrent=upsInputCurrent, upsTestResultsSummary=upsTestResultsSummary, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsMIB=upsMIB, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmFuseFailure=upsAlarmFuseFailure, upsConfigOutputPower=upsConfigOutputPower, upsAlarmInputBad=upsAlarmInputBad, upsAlarmTime=upsAlarmTime, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsControl=upsControl, upsFullTestGroup=upsFullTestGroup, upsBatteryVoltage=upsBatteryVoltage, upsIdentManufacturer=upsIdentManufacturer, upsInputLineIndex=upsInputLineIndex, upsBypassTable=upsBypassTable, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsFullConfigGroup=upsFullConfigGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsConformance=upsConformance, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsShutdownAfterDelay=upsShutdownAfterDelay, upsInputTable=upsInputTable, upsTrapOnBattery=upsTrapOnBattery, upsShutdownType=upsShutdownType, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmOnBattery=upsAlarmOnBattery, upsConfigInputVoltage=upsConfigInputVoltage, upsConfigLowBattTime=upsConfigLowBattTime, upsOutputLineIndex=upsOutputLineIndex, upsBypassNumLines=upsBypassNumLines, upsBasicOutputGroup=upsBasicOutputGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsTestSpinLock=upsTestSpinLock, upsAlarmOnBypass=upsAlarmOnBypass, upsOutputVoltage=upsOutputVoltage, upsAlarmOutputBad=upsAlarmOutputBad, PYSNMP_MODULE_ID=upsMIB, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBattery=upsBattery, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBasicInputGroup=upsBasicInputGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsOutputCurrent=upsOutputCurrent, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBypassVoltage=upsBypassVoltage, upsAutoRestart=upsAutoRestart, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsOutputFrequency=upsOutputFrequency, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmId=upsAlarmId, upsGroups=upsGroups, upsAlarmChargerFailed=upsAlarmChargerFailed, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsInputFrequency=upsInputFrequency, upsIdentModel=upsIdentModel, upsFullIdentGroup=upsFullIdentGroup, upsInputVoltage=upsInputVoltage, upsInput=upsInput, upsFullOutputGroup=upsFullOutputGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBatteryTemperature=upsBatteryTemperature, upsAlarmDescr=upsAlarmDescr, upsInputLineBads=upsInputLineBads, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmBypassBad=upsAlarmBypassBad, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmOutputOverload=upsAlarmOutputOverload, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarm=upsAlarm, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBasicTestGroup=upsBasicTestGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsIdent=upsIdent, upsTraps=upsTraps, upsTestResultsDetail=upsTestResultsDetail, upsTestStartTime=upsTestStartTime, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmTable=upsAlarmTable, upsTestId=upsTestId, upsBatteryCurrent=upsBatteryCurrent, upsSecondsOnBattery=upsSecondsOnBattery, upsInputNumLines=upsInputNumLines, upsBasicCompliance=upsBasicCompliance, upsConfig=upsConfig)
