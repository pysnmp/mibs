...
# Produced by pysmi-1.1.3 at Wed Dec  8 17:41:49 2021
...
ModuleIdentity, Bits, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, IpAddress, NotificationType, Gauge32, Counter64, mib_2, Counter32, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "IpAddress", "NotificationType", "Gauge32", "Counter64", "mib-2", "Counter32", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("UPS-MIB", upsFullInputGroup=upsFullInputGroup, upsTestStartTime=upsTestStartTime, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarm=upsAlarm, upsConfig=upsConfig, PYSNMP_MODULE_ID=upsMIB, upsFullCompliance=upsFullCompliance, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, NonNegativeInteger=NonNegativeInteger, upsAlarmTestInProgress=upsAlarmTestInProgress, upsOutputLineIndex=upsOutputLineIndex, upsIdentManufacturer=upsIdentManufacturer, upsAlarmOnBypass=upsAlarmOnBypass, upsTrapOnBattery=upsTrapOnBattery, upsIdentName=upsIdentName, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBasicIdentGroup=upsBasicIdentGroup, upsIdentModel=upsIdentModel, upsBypassLineIndex=upsBypassLineIndex, upsIdent=upsIdent, upsInputEntry=upsInputEntry, upsAlarmsPresent=upsAlarmsPresent, upsGroups=upsGroups, upsAlarmFuseFailure=upsAlarmFuseFailure, upsConfigOutputVA=upsConfigOutputVA, upsInput=upsInput, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmTempBad=upsAlarmTempBad, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypassFrequency=upsBypassFrequency, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsInputLineIndex=upsInputLineIndex, upsAlarmTable=upsAlarmTable, upsConfigOutputFreq=upsConfigOutputFreq, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsConfigOutputPower=upsConfigOutputPower, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmShutdownPending=upsAlarmShutdownPending, upsOutputVoltage=upsOutputVoltage, upsInputNumLines=upsInputNumLines, upsBypassNumLines=upsBypassNumLines, upsAlarmTime=upsAlarmTime, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBasicCompliance=upsBasicCompliance, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBatteryStatus=upsBatteryStatus, upsSecondsOnBattery=upsSecondsOnBattery, PositiveInteger=PositiveInteger, upsOutputNumLines=upsOutputNumLines, upsFullGroups=upsFullGroups, upsFullConfigGroup=upsFullConfigGroup, upsBatteryCurrent=upsBatteryCurrent, upsFullControlGroup=upsFullControlGroup, upsInputVoltage=upsInputVoltage, upsAutoRestart=upsAutoRestart, upsAlarmBypassBad=upsAlarmBypassBad, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBasicGroups=upsBasicGroups, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBatteryVoltage=upsBatteryVoltage, upsWellKnownTests=upsWellKnownTests, upsTraps=upsTraps, upsTestSpinLock=upsTestSpinLock, upsTestResultsDetail=upsTestResultsDetail, upsInputTable=upsInputTable, upsSubsetGroups=upsSubsetGroups, upsBypassEntry=upsBypassEntry, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsFullIdentGroup=upsFullIdentGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsConfigInputFreq=upsConfigInputFreq, upsOutputSource=upsOutputSource, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBatteryTemperature=upsBatteryTemperature, upsTrapTestCompleted=upsTrapTestCompleted, upsInputFrequency=upsInputFrequency, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsFullOutputGroup=upsFullOutputGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBattery=upsBattery, upsOutputFrequency=upsOutputFrequency, upsFullBypassGroup=upsFullBypassGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsTestId=upsTestId, upsBasicInputGroup=upsBasicInputGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsSubsetConfigGroup=upsSubsetConfigGroup, upsRebootWithDuration=upsRebootWithDuration, upsOutput=upsOutput, upsAlarmInputBad=upsAlarmInputBad, upsBypass=upsBypass, upsInputTruePower=upsInputTruePower, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmId=upsAlarmId, upsFullTestGroup=upsFullTestGroup, upsTestElapsedTime=upsTestElapsedTime, upsOutputPower=upsOutputPower, upsBypassTable=upsBypassTable, upsBasicOutputGroup=upsBasicOutputGroup, upsOutputCurrent=upsOutputCurrent, upsTest=upsTest, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmEntry=upsAlarmEntry, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmOnBattery=upsAlarmOnBattery, upsSubsetOutputGroup=upsSubsetOutputGroup, upsShutdownType=upsShutdownType, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsMIB=upsMIB, upsBypassVoltage=upsBypassVoltage, upsBasicTestGroup=upsBasicTestGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsInputCurrent=upsInputCurrent, upsBypassCurrent=upsBypassCurrent, upsInputLineBads=upsInputLineBads, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTestResultsSummary=upsTestResultsSummary, upsBypassPower=upsBypassPower, upsOutputEntry=upsOutputEntry, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmDescr=upsAlarmDescr, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsBasicAlarmGroup=upsBasicAlarmGroup, upsControl=upsControl, upsConformance=upsConformance, upsOutputPercentLoad=upsOutputPercentLoad, upsFullBatteryGroup=upsFullBatteryGroup, upsBasicControlGroup=upsBasicControlGroup, upsObjects=upsObjects, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsOutputTable=upsOutputTable, upsSubsetControlGroup=upsSubsetControlGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsSubsetCompliance=upsSubsetCompliance, upsShutdownAfterDelay=upsShutdownAfterDelay, upsCompliances=upsCompliances, upsAlarmLowBattery=upsAlarmLowBattery)
