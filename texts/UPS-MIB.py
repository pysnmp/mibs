...
# Produced by pysmi-1.1.12 at Thu Apr  4 10:05:16 2024
...
mibBuilder.exportSymbols("UPS-MIB", upsBasicGroups=upsBasicGroups, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBasicInputGroup=upsBasicInputGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsOutputEntry=upsOutputEntry, upsInputLineIndex=upsInputLineIndex, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsInputNumLines=upsInputNumLines, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmFanFailure=upsAlarmFanFailure, upsConfigOutputVA=upsConfigOutputVA, upsAlarmBatteryBad=upsAlarmBatteryBad, upsFullInputGroup=upsFullInputGroup, upsOutputSource=upsOutputSource, upsInputTruePower=upsInputTruePower, upsOutputLineIndex=upsOutputLineIndex, upsBasicTestGroup=upsBasicTestGroup, upsTest=upsTest, upsAlarmLowBattery=upsAlarmLowBattery, upsConfig=upsConfig, upsBypassVoltage=upsBypassVoltage, upsTestId=upsTestId, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmTime=upsAlarmTime, upsFullGroups=upsFullGroups, upsControl=upsControl, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBasicCompliance=upsBasicCompliance, upsMIB=upsMIB, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBasicControlGroup=upsBasicControlGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsInputCurrent=upsInputCurrent, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBatteryVoltage=upsBatteryVoltage, upsAlarmsPresent=upsAlarmsPresent, upsWellKnownAlarms=upsWellKnownAlarms, upsBypassNumLines=upsBypassNumLines, upsBypassTable=upsBypassTable, upsBasicBatteryGroup=upsBasicBatteryGroup, upsInputVoltage=upsInputVoltage, upsSubsetCompliance=upsSubsetCompliance, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsInputEntry=upsInputEntry, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmOutputOverload=upsAlarmOutputOverload, upsInputLineBads=upsInputLineBads, upsTrapOnBattery=upsTrapOnBattery, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmDescr=upsAlarmDescr, NonNegativeInteger=NonNegativeInteger, upsFullBatteryGroup=upsFullBatteryGroup, upsBattery=upsBattery, upsTraps=upsTraps, upsSubsetGroups=upsSubsetGroups, upsOutput=upsOutput, upsIdentManufacturer=upsIdentManufacturer, upsInputTable=upsInputTable, upsBatteryTemperature=upsBatteryTemperature, upsInputFrequency=upsInputFrequency, upsGroups=upsGroups, upsBypass=upsBypass, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarm=upsAlarm, upsSubsetInputGroup=upsSubsetInputGroup, upsConformance=upsConformance, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutputVoltage=upsOutputVoltage, upsAlarmId=upsAlarmId, upsAlarmEntry=upsAlarmEntry, upsFullBypassGroup=upsFullBypassGroup, upsFullCompliance=upsFullCompliance, upsBypassPower=upsBypassPower, upsAlarmOutputBad=upsAlarmOutputBad, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsIdentModel=upsIdentModel, upsFullConfigGroup=upsFullConfigGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, PYSNMP_MODULE_ID=upsMIB, upsAlarmChargerFailed=upsAlarmChargerFailed, upsFullOutputGroup=upsFullOutputGroup, upsFullTestGroup=upsFullTestGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsObjects=upsObjects, upsBypassCurrent=upsBypassCurrent, upsAlarmTempBad=upsAlarmTempBad, upsIdent=upsIdent, upsTestResultsSummary=upsTestResultsSummary, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTestSpinLock=upsTestSpinLock, upsBypassEntry=upsBypassEntry, upsShutdownType=upsShutdownType, upsAlarmBypassBad=upsAlarmBypassBad, upsOutputTable=upsOutputTable, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsOutputCurrent=upsOutputCurrent, upsFullIdentGroup=upsFullIdentGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsOutputNumLines=upsOutputNumLines, upsTrapTestCompleted=upsTrapTestCompleted, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, PositiveInteger=PositiveInteger, upsAlarmOnBattery=upsAlarmOnBattery, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullControlGroup=upsFullControlGroup, upsOutputFrequency=upsOutputFrequency, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBasicBypassGroup=upsBasicBypassGroup, upsBatteryStatus=upsBatteryStatus, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsIdentAttachedDevices=upsIdentAttachedDevices, upsCompliances=upsCompliances, upsConfigInputFreq=upsConfigInputFreq, upsConfigInputVoltage=upsConfigInputVoltage, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsInput=upsInput, upsSecondsOnBattery=upsSecondsOnBattery, upsBasicConfigGroup=upsBasicConfigGroup, upsBatteryCurrent=upsBatteryCurrent, upsTestResultsDetail=upsTestResultsDetail, upsAutoRestart=upsAutoRestart, upsFullAlarmGroup=upsFullAlarmGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsOutputPercentLoad=upsOutputPercentLoad, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBypassFrequency=upsBypassFrequency, upsTestStartTime=upsTestStartTime, upsIdentName=upsIdentName, upsRebootWithDuration=upsRebootWithDuration, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmInputBad=upsAlarmInputBad, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsConfigOutputPower=upsConfigOutputPower, upsOutputPower=upsOutputPower, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBypassLineIndex=upsBypassLineIndex, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmOnBypass=upsAlarmOnBypass, upsConfigLowBattTime=upsConfigLowBattTime, upsSubsetOutputGroup=upsSubsetOutputGroup, upsTestElapsedTime=upsTestElapsedTime, upsAlarmTable=upsAlarmTable, upsWellKnownTests=upsWellKnownTests)
