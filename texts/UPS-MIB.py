...
# Produced by pysmi-1.1.12 at Tue Dec  3 09:39:37 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, iso, IpAddress, NotificationType, Unsigned32, Counter32, Bits, MibIdentifier, ModuleIdentity, ObjectIdentity, Integer32, Counter64, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "iso", "IpAddress", "NotificationType", "Unsigned32", "Counter32", "Bits", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Integer32", "Counter64", "mib-2")
...
mibBuilder.exportSymbols("UPS-MIB", upsFullTestGroup=upsFullTestGroup, upsBatteryCurrent=upsBatteryCurrent, upsAlarmOutputBad=upsAlarmOutputBad, upsSubsetCompliance=upsSubsetCompliance, upsBypassPower=upsBypassPower, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsInputLineIndex=upsInputLineIndex, upsIdentManufacturer=upsIdentManufacturer, upsTest=upsTest, upsSubsetIdentGroup=upsSubsetIdentGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsTrapOnBattery=upsTrapOnBattery, upsBasicInputGroup=upsBasicInputGroup, upsIdentModel=upsIdentModel, upsFullAlarmGroup=upsFullAlarmGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsShutdownType=upsShutdownType, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicBypassGroup=upsBasicBypassGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmBatteryBad=upsAlarmBatteryBad, upsOutputFrequency=upsOutputFrequency, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBatteryStatus=upsBatteryStatus, upsAlarmBypassBad=upsAlarmBypassBad, upsBatteryTemperature=upsBatteryTemperature, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsIdentName=upsIdentName, upsOutputSource=upsOutputSource, upsAlarmOutputOverload=upsAlarmOutputOverload, upsMIB=upsMIB, upsAlarmId=upsAlarmId, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAutoRestart=upsAutoRestart, upsTraps=upsTraps, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBypassCurrent=upsBypassCurrent, upsAlarm=upsAlarm, upsWellKnownAlarms=upsWellKnownAlarms, PYSNMP_MODULE_ID=upsMIB, upsBypassEntry=upsBypassEntry, upsStartupAfterDelay=upsStartupAfterDelay, upsBypassTable=upsBypassTable, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullIdentGroup=upsFullIdentGroup, upsInputCurrent=upsInputCurrent, upsIdent=upsIdent, upsConfigOutputPower=upsConfigOutputPower, upsAlarmTable=upsAlarmTable, upsAlarmDescr=upsAlarmDescr, upsBasicConfigGroup=upsBasicConfigGroup, upsFullInputGroup=upsFullInputGroup, upsAlarmTime=upsAlarmTime, upsGroups=upsGroups, upsAlarmsPresent=upsAlarmsPresent, upsBypassFrequency=upsBypassFrequency, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmTempBad=upsAlarmTempBad, upsFullControlGroup=upsFullControlGroup, upsOutputPower=upsOutputPower, upsAlarmChargerFailed=upsAlarmChargerFailed, upsObjects=upsObjects, upsFullCompliance=upsFullCompliance, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmOnBattery=upsAlarmOnBattery, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsFullConfigGroup=upsFullConfigGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestId=upsTestId, upsBasicCompliance=upsBasicCompliance, upsOutputNumLines=upsOutputNumLines, upsConfigInputVoltage=upsConfigInputVoltage, upsBasicControlGroup=upsBasicControlGroup, upsAlarmInputBad=upsAlarmInputBad, upsWellKnownTests=upsWellKnownTests, upsFullBypassGroup=upsFullBypassGroup, upsInputTruePower=upsInputTruePower, upsOutputVoltage=upsOutputVoltage, upsTrapTestCompleted=upsTrapTestCompleted, upsBypassVoltage=upsBypassVoltage, upsInputLineBads=upsInputLineBads, upsOutputCurrent=upsOutputCurrent, upsOutputLineIndex=upsOutputLineIndex, upsBasicOutputGroup=upsBasicOutputGroup, upsRebootWithDuration=upsRebootWithDuration, upsOutput=upsOutput, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsConfig=upsConfig, upsInputTable=upsInputTable, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConformance=upsConformance, upsBasicAlarmGroup=upsBasicAlarmGroup, upsCompliances=upsCompliances, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmGeneralFault=upsAlarmGeneralFault, upsOutputTable=upsOutputTable, upsAlarmLowBattery=upsAlarmLowBattery, upsConfigOutputFreq=upsConfigOutputFreq, upsBasicIdentGroup=upsBasicIdentGroup, upsTestElapsedTime=upsTestElapsedTime, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBasicTestGroup=upsBasicTestGroup, upsBypass=upsBypass, upsBypassNumLines=upsBypassNumLines, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTestSpinLock=upsTestSpinLock, upsConfigOutputVA=upsConfigOutputVA, upsInputVoltage=upsInputVoltage, upsConfigInputFreq=upsConfigInputFreq, upsInputEntry=upsInputEntry, upsOutputPercentLoad=upsOutputPercentLoad, upsOutputEntry=upsOutputEntry, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsInputFrequency=upsInputFrequency, PositiveInteger=PositiveInteger, upsBattery=upsBattery, upsBypassLineIndex=upsBypassLineIndex, upsTestResultsDetail=upsTestResultsDetail, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmShutdownPending=upsAlarmShutdownPending, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBasicGroups=upsBasicGroups, upsFullGroups=upsFullGroups, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTestResultsSummary=upsTestResultsSummary, upsBatteryVoltage=upsBatteryVoltage, NonNegativeInteger=NonNegativeInteger, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsSubsetInputGroup=upsSubsetInputGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsFullOutputGroup=upsFullOutputGroup, upsAlarmEntry=upsAlarmEntry, upsAlarmOnBypass=upsAlarmOnBypass, upsConfigAudibleStatus=upsConfigAudibleStatus, upsSubsetGroups=upsSubsetGroups, upsInputNumLines=upsInputNumLines, upsTestStartTime=upsTestStartTime, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsControl=upsControl, upsInput=upsInput, upsAlarmFanFailure=upsAlarmFanFailure, upsSecondsOnBattery=upsSecondsOnBattery)
