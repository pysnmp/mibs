...
ModuleIdentity, iso, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, Counter32, mib_2, Bits, Unsigned32, MibIdentifier, Integer32, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "Counter32", "mib-2", "Bits", "Unsigned32", "MibIdentifier", "Integer32", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("UPS-MIB", upsBasicControlGroup=upsBasicControlGroup, upsFullIdentGroup=upsFullIdentGroup, upsBasicGroups=upsBasicGroups, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsWellKnownTests=upsWellKnownTests, upsAlarmTestInProgress=upsAlarmTestInProgress, upsFullCompliance=upsFullCompliance, upsAlarmGeneralFault=upsAlarmGeneralFault, upsInputEntry=upsInputEntry, upsTrapOnBattery=upsTrapOnBattery, upsBasicConfigGroup=upsBasicConfigGroup, upsBypassPower=upsBypassPower, upsRebootWithDuration=upsRebootWithDuration, upsMIB=upsMIB, upsOutputVoltage=upsOutputVoltage, upsConfigLowBattTime=upsConfigLowBattTime, upsBypassEntry=upsBypassEntry, upsBasicIdentGroup=upsBasicIdentGroup, upsInputNumLines=upsInputNumLines, upsOutputEntry=upsOutputEntry, upsOutputCurrent=upsOutputCurrent, upsSubsetCompliance=upsSubsetCompliance, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsWellKnownAlarms=upsWellKnownAlarms, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmInputBad=upsAlarmInputBad, upsFullOutputGroup=upsFullOutputGroup, upsFullConfigGroup=upsFullConfigGroup, upsInputVoltage=upsInputVoltage, upsInputLineIndex=upsInputLineIndex, upsBypassNumLines=upsBypassNumLines, upsStartupAfterDelay=upsStartupAfterDelay, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBasicBypassGroup=upsBasicBypassGroup, PYSNMP_MODULE_ID=upsMIB, upsAlarmTempBad=upsAlarmTempBad, upsCompliances=upsCompliances, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTestResultsSummary=upsTestResultsSummary, upsBypassTable=upsBypassTable, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmOutputBad=upsAlarmOutputBad, upsObjects=upsObjects, upsAlarmEntry=upsAlarmEntry, upsAlarmId=upsAlarmId, upsFullInputGroup=upsFullInputGroup, upsIdentModel=upsIdentModel, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsInputCurrent=upsInputCurrent, upsInputFrequency=upsInputFrequency, upsOutputTable=upsOutputTable, upsBatteryTemperature=upsBatteryTemperature, upsFullBypassGroup=upsFullBypassGroup, upsBasicInputGroup=upsBasicInputGroup, upsBypassFrequency=upsBypassFrequency, upsBasicCompliance=upsBasicCompliance, upsTestStartTime=upsTestStartTime, upsFullAlarmGroup=upsFullAlarmGroup, upsControl=upsControl, upsIdentAttachedDevices=upsIdentAttachedDevices, upsOutputPercentLoad=upsOutputPercentLoad, upsFullGroups=upsFullGroups, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsBattery=upsBattery, upsBasicAlarmGroup=upsBasicAlarmGroup, upsOutputNumLines=upsOutputNumLines, upsTest=upsTest, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBatteryStatus=upsBatteryStatus, upsBatteryCurrent=upsBatteryCurrent, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConformance=upsConformance, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTestId=upsTestId, upsInputTable=upsInputTable, upsConfigOutputVA=upsConfigOutputVA, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsOutputLineIndex=upsOutputLineIndex, upsTestResultsDetail=upsTestResultsDetail, upsAlarmOnBypass=upsAlarmOnBypass, upsTestSpinLock=upsTestSpinLock, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmTable=upsAlarmTable, upsAlarmShutdownPending=upsAlarmShutdownPending, upsOutputSource=upsOutputSource, upsAlarmsPresent=upsAlarmsPresent, NonNegativeInteger=NonNegativeInteger, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsBasicTestGroup=upsBasicTestGroup, upsAlarmDescr=upsAlarmDescr, upsSubsetInputGroup=upsSubsetInputGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigAudibleStatus=upsConfigAudibleStatus, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAutoRestart=upsAutoRestart, upsSubsetControlGroup=upsSubsetControlGroup, upsBatteryVoltage=upsBatteryVoltage, upsBypassVoltage=upsBypassVoltage, upsAlarmTime=upsAlarmTime, upsFullTestGroup=upsFullTestGroup, upsAlarm=upsAlarm, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsGroups=upsGroups, upsOutputPower=upsOutputPower, upsInputTruePower=upsInputTruePower, upsInput=upsInput, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTestElapsedTime=upsTestElapsedTime, upsFullBatteryGroup=upsFullBatteryGroup, upsBypassCurrent=upsBypassCurrent, upsOutputFrequency=upsOutputFrequency, upsShutdownType=upsShutdownType, upsConfig=upsConfig, upsTrapTestCompleted=upsTrapTestCompleted, upsSubsetIdentGroup=upsSubsetIdentGroup, upsIdentManufacturer=upsIdentManufacturer, upsOutput=upsOutput, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsSubsetGroups=upsSubsetGroups, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmOnBattery=upsAlarmOnBattery, upsIdent=upsIdent, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsInputLineBads=upsInputLineBads, PositiveInteger=PositiveInteger, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsIdentName=upsIdentName, upsConfigInputVoltage=upsConfigInputVoltage, upsConfigOutputPower=upsConfigOutputPower, upsTraps=upsTraps, upsSecondsOnBattery=upsSecondsOnBattery, upsConfigInputFreq=upsConfigInputFreq, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBypass=upsBypass, upsBypassLineIndex=upsBypassLineIndex, upsFullControlGroup=upsFullControlGroup)
