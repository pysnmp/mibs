...
mibBuilder.exportSymbols("UPS-MIB", upsOutputTable=upsOutputTable, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmGeneralFault=upsAlarmGeneralFault, upsIdent=upsIdent, upsBypassEntry=upsBypassEntry, upsAlarmTable=upsAlarmTable, upsTestId=upsTestId, upsAutoRestart=upsAutoRestart, upsAlarmChargerFailed=upsAlarmChargerFailed, upsOutputNumLines=upsOutputNumLines, upsOutputPercentLoad=upsOutputPercentLoad, upsConfigOutputVoltage=upsConfigOutputVoltage, upsSubsetInputGroup=upsSubsetInputGroup, upsConfigOutputPower=upsConfigOutputPower, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBattery=upsBattery, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTestStartTime=upsTestStartTime, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfigOutputFreq=upsConfigOutputFreq, upsIdentName=upsIdentName, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsInputFrequency=upsInputFrequency, upsFullCompliance=upsFullCompliance, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsFullGroups=upsFullGroups, upsAlarmTempBad=upsAlarmTempBad, upsAlarmBatteryBad=upsAlarmBatteryBad, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmOutputBad=upsAlarmOutputBad, PositiveInteger=PositiveInteger, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBasicInputGroup=upsBasicInputGroup, upsFullOutputGroup=upsFullOutputGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmEntry=upsAlarmEntry, upsShutdownType=upsShutdownType, upsAlarmInputBad=upsAlarmInputBad, upsBypass=upsBypass, upsFullTestGroup=upsFullTestGroup, upsOutputEntry=upsOutputEntry, upsBypassPower=upsBypassPower, upsBasicBypassGroup=upsBasicBypassGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmsPresent=upsAlarmsPresent, upsFullIdentGroup=upsFullIdentGroup, upsTrapOnBattery=upsTrapOnBattery, upsBatteryVoltage=upsBatteryVoltage, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsSubsetOutputGroup=upsSubsetOutputGroup, upsConfig=upsConfig, upsIdentManufacturer=upsIdentManufacturer, upsIdentModel=upsIdentModel, upsSecondsOnBattery=upsSecondsOnBattery, upsRebootWithDuration=upsRebootWithDuration, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsInputTable=upsInputTable, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTestSpinLock=upsTestSpinLock, upsBypassVoltage=upsBypassVoltage, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBatteryTemperature=upsBatteryTemperature, upsAlarm=upsAlarm, upsTestElapsedTime=upsTestElapsedTime, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmOnBypass=upsAlarmOnBypass, upsTest=upsTest, upsBypassFrequency=upsBypassFrequency, upsBasicOutputGroup=upsBasicOutputGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmTime=upsAlarmTime, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsObjects=upsObjects, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmDepletedBattery=upsAlarmDepletedBattery, NonNegativeInteger=NonNegativeInteger, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsOutputVoltage=upsOutputVoltage, upsOutputFrequency=upsOutputFrequency, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBasicBatteryGroup=upsBasicBatteryGroup, upsFullBypassGroup=upsFullBypassGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsBasicControlGroup=upsBasicControlGroup, upsBypassLineIndex=upsBypassLineIndex, upsFullControlGroup=upsFullControlGroup, upsTestResultsSummary=upsTestResultsSummary, upsInputLineIndex=upsInputLineIndex, upsConfigOutputVA=upsConfigOutputVA, upsBypassCurrent=upsBypassCurrent, upsCompliances=upsCompliances, upsInputCurrent=upsInputCurrent, upsInputTruePower=upsInputTruePower, upsSubsetIdentGroup=upsSubsetIdentGroup, upsOutput=upsOutput, upsConfigInputFreq=upsConfigInputFreq, PYSNMP_MODULE_ID=upsMIB, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBasicGroups=upsBasicGroups, upsInputEntry=upsInputEntry, upsWellKnownAlarms=upsWellKnownAlarms, upsInput=upsInput, upsConformance=upsConformance, upsBypassTable=upsBypassTable, upsAlarmFanFailure=upsAlarmFanFailure, upsOutputLineIndex=upsOutputLineIndex, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmDescr=upsAlarmDescr, upsOutputPower=upsOutputPower, upsConfigLowBattTime=upsConfigLowBattTime, upsControl=upsControl, upsFullInputGroup=upsFullInputGroup, upsTestResultsDetail=upsTestResultsDetail, upsSubsetGroups=upsSubsetGroups, upsConfigInputVoltage=upsConfigInputVoltage, upsFullConfigGroup=upsFullConfigGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsMIB=upsMIB, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBasicConfigGroup=upsBasicConfigGroup, upsBasicTestGroup=upsBasicTestGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsWellKnownTests=upsWellKnownTests, upsOutputCurrent=upsOutputCurrent, upsGroups=upsGroups, upsBatteryCurrent=upsBatteryCurrent, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsInputVoltage=upsInputVoltage, upsAlarmOnBattery=upsAlarmOnBattery, upsOutputSource=upsOutputSource, upsAlarmId=upsAlarmId, upsInputLineBads=upsInputLineBads, upsInputNumLines=upsInputNumLines, upsAlarmLowBattery=upsAlarmLowBattery, upsBypassNumLines=upsBypassNumLines, upsBatteryStatus=upsBatteryStatus, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsTraps=upsTraps, upsBasicCompliance=upsBasicCompliance, upsSubsetCompliance=upsSubsetCompliance)
