...
# Produced by pysmi-1.1.8 at Mon Jan 17 19:19:04 2022
...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, ObjectIdentity, NotificationType, Gauge32, Integer32, Counter64, IpAddress, ModuleIdentity, Counter32, iso, mib_2, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "ObjectIdentity", "NotificationType", "Gauge32", "Integer32", "Counter64", "IpAddress", "ModuleIdentity", "Counter32", "iso", "mib-2", "Bits")
...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmShutdownPending=upsAlarmShutdownPending, upsControl=upsControl, upsBatteryTemperature=upsBatteryTemperature, upsConfigOutputPower=upsConfigOutputPower, upsBasicOutputGroup=upsBasicOutputGroup, upsMIB=upsMIB, upsInputVoltage=upsInputVoltage, PYSNMP_MODULE_ID=upsMIB, upsInputTruePower=upsInputTruePower, upsBypass=upsBypass, upsBypassFrequency=upsBypassFrequency, upsBasicInputGroup=upsBasicInputGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsOutputNumLines=upsOutputNumLines, upsAlarmInputBad=upsAlarmInputBad, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsFullCompliance=upsFullCompliance, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBypassNumLines=upsBypassNumLines, upsConfigInputFreq=upsConfigInputFreq, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, PositiveInteger=PositiveInteger, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTraps=upsTraps, upsConfig=upsConfig, upsOutputTable=upsOutputTable, upsTestElapsedTime=upsTestElapsedTime, upsWellKnownAlarms=upsWellKnownAlarms, upsInputEntry=upsInputEntry, upsInputLineIndex=upsInputLineIndex, upsAlarmLowBattery=upsAlarmLowBattery, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmId=upsAlarmId, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTrapOnBattery=upsTrapOnBattery, upsIdent=upsIdent, upsBasicControlGroup=upsBasicControlGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsGroups=upsGroups, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsFullInputGroup=upsFullInputGroup, upsAlarmTempBad=upsAlarmTempBad, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBasicAlarmGroup=upsBasicAlarmGroup, upsSubsetGroups=upsSubsetGroups, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsFullControlGroup=upsFullControlGroup, upsBasicGroups=upsBasicGroups, upsAutoRestart=upsAutoRestart, upsSubsetIdentGroup=upsSubsetIdentGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsFullTestGroup=upsFullTestGroup, upsInputTable=upsInputTable, upsAlarmDescr=upsAlarmDescr, upsBypassLineIndex=upsBypassLineIndex, upsTestResultsDetail=upsTestResultsDetail, upsStartupAfterDelay=upsStartupAfterDelay, upsInputFrequency=upsInputFrequency, upsWellKnownTests=upsWellKnownTests, upsFullIdentGroup=upsFullIdentGroup, upsInputCurrent=upsInputCurrent, upsBypassTable=upsBypassTable, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmTable=upsAlarmTable, upsConfigInputVoltage=upsConfigInputVoltage, upsFullBatteryGroup=upsFullBatteryGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsBasicCompliance=upsBasicCompliance, upsIdentModel=upsIdentModel, upsAlarmBatteryBad=upsAlarmBatteryBad, upsFullConfigGroup=upsFullConfigGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsOutputSource=upsOutputSource, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmOnBattery=upsAlarmOnBattery, upsBasicIdentGroup=upsBasicIdentGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsOutputFrequency=upsOutputFrequency, upsBatteryStatus=upsBatteryStatus, upsFullGroups=upsFullGroups, upsBatteryCurrent=upsBatteryCurrent, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmEntry=upsAlarmEntry, upsFullOutputGroup=upsFullOutputGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutput=upsOutput, upsTestId=upsTestId, upsAlarmsPresent=upsAlarmsPresent, upsAlarmBypassBad=upsAlarmBypassBad, upsInput=upsInput, upsFullBypassGroup=upsFullBypassGroup, upsBattery=upsBattery, upsShutdownType=upsShutdownType, upsAlarmTestInProgress=upsAlarmTestInProgress, upsOutputEntry=upsOutputEntry, upsOutputPower=upsOutputPower, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTestResultsSummary=upsTestResultsSummary, upsBypassPower=upsBypassPower, upsTrapTestCompleted=upsTrapTestCompleted, upsBypassVoltage=upsBypassVoltage, upsInputNumLines=upsInputNumLines, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsOutputCurrent=upsOutputCurrent, upsAlarmTime=upsAlarmTime, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConfigOutputVA=upsConfigOutputVA, upsConformance=upsConformance, NonNegativeInteger=NonNegativeInteger, upsObjects=upsObjects, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsConfigAudibleStatus=upsConfigAudibleStatus, upsSubsetCompliance=upsSubsetCompliance, upsBypassEntry=upsBypassEntry, upsSubsetOutputGroup=upsSubsetOutputGroup, upsCompliances=upsCompliances, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBatteryVoltage=upsBatteryVoltage, upsOutputLineIndex=upsOutputLineIndex, upsOutputPercentLoad=upsOutputPercentLoad, upsTest=upsTest, upsTestStartTime=upsTestStartTime, upsInputLineBads=upsInputLineBads, upsIdentManufacturer=upsIdentManufacturer, upsTestSpinLock=upsTestSpinLock, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsOutputVoltage=upsOutputVoltage, upsSecondsOnBattery=upsSecondsOnBattery, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarm=upsAlarm, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmOutputOverload=upsAlarmOutputOverload, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypassCurrent=upsBypassCurrent, upsBasicTestGroup=upsBasicTestGroup, upsRebootWithDuration=upsRebootWithDuration, upsAlarmFuseFailure=upsAlarmFuseFailure, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsIdentName=upsIdentName)
