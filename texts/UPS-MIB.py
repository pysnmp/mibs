...
# Produced by pysmi-1.1.12 at Wed May 29 06:41:52 2024
...
MibIdentifier, TimeTicks, Unsigned32, Integer32, ObjectIdentity, IpAddress, ModuleIdentity, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, NotificationType, Counter64, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "Unsigned32", "Integer32", "ObjectIdentity", "IpAddress", "ModuleIdentity", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "NotificationType", "Counter64", "mib-2")
...
mibBuilder.exportSymbols("UPS-MIB", upsFullOutputGroup=upsFullOutputGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTestElapsedTime=upsTestElapsedTime, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsCompliances=upsCompliances, upsFullCompliance=upsFullCompliance, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullGroups=upsFullGroups, PositiveInteger=PositiveInteger, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmEntry=upsAlarmEntry, upsOutputVoltage=upsOutputVoltage, upsAlarmFanFailure=upsAlarmFanFailure, upsObjects=upsObjects, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmTable=upsAlarmTable, upsInputTruePower=upsInputTruePower, upsOutputLineIndex=upsOutputLineIndex, upsBasicCompliance=upsBasicCompliance, upsConfigAudibleStatus=upsConfigAudibleStatus, upsIdent=upsIdent, upsOutputTable=upsOutputTable, upsAlarmInputBad=upsAlarmInputBad, upsSubsetIdentGroup=upsSubsetIdentGroup, upsInputTable=upsInputTable, upsFullConfigGroup=upsFullConfigGroup, upsBypassPower=upsBypassPower, upsControl=upsControl, upsAlarmLowBattery=upsAlarmLowBattery, upsOutputFrequency=upsOutputFrequency, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsSubsetInputGroup=upsSubsetInputGroup, upsConfigOutputPower=upsConfigOutputPower, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTestStartTime=upsTestStartTime, upsBasicAlarmGroup=upsBasicAlarmGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmOnBypass=upsAlarmOnBypass, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsTraps=upsTraps, upsBypassCurrent=upsBypassCurrent, upsConfigInputFreq=upsConfigInputFreq, upsBypassTable=upsBypassTable, upsBatteryStatus=upsBatteryStatus, upsTrapTestCompleted=upsTrapTestCompleted, upsIdentManufacturer=upsIdentManufacturer, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsSubsetGroups=upsSubsetGroups, upsBasicGroups=upsBasicGroups, upsTestResultsDetail=upsTestResultsDetail, upsAlarmOnBattery=upsAlarmOnBattery, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBattery=upsBattery, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmDescr=upsAlarmDescr, upsFullBypassGroup=upsFullBypassGroup, upsTestId=upsTestId, upsConfigInputVoltage=upsConfigInputVoltage, upsBasicConfigGroup=upsBasicConfigGroup, NonNegativeInteger=NonNegativeInteger, upsIdentName=upsIdentName, upsInputFrequency=upsInputFrequency, upsOutputEntry=upsOutputEntry, upsAlarmTempBad=upsAlarmTempBad, upsAlarmTime=upsAlarmTime, upsAlarmBypassBad=upsAlarmBypassBad, upsInput=upsInput, upsInputEntry=upsInputEntry, upsShutdownType=upsShutdownType, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsFullControlGroup=upsFullControlGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsTestSpinLock=upsTestSpinLock, upsInputLineBads=upsInputLineBads, upsOutputPercentLoad=upsOutputPercentLoad, upsBypassEntry=upsBypassEntry, upsBasicOutputGroup=upsBasicOutputGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmId=upsAlarmId, upsAlarmOutputOverload=upsAlarmOutputOverload, upsStartupAfterDelay=upsStartupAfterDelay, upsFullIdentGroup=upsFullIdentGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsMIB=upsMIB, upsBasicIdentGroup=upsBasicIdentGroup, upsBasicControlGroup=upsBasicControlGroup, upsBypassNumLines=upsBypassNumLines, upsTrapOnBattery=upsTrapOnBattery, upsBasicTestGroup=upsBasicTestGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBatteryVoltage=upsBatteryVoltage, upsBatteryCurrent=upsBatteryCurrent, upsWellKnownTests=upsWellKnownTests, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmGeneralFault=upsAlarmGeneralFault, upsSubsetCompliance=upsSubsetCompliance, upsInputCurrent=upsInputCurrent, upsConfig=upsConfig, upsWellKnownAlarms=upsWellKnownAlarms, upsBypass=upsBypass, upsTest=upsTest, upsSubsetControlGroup=upsSubsetControlGroup, upsFullInputGroup=upsFullInputGroup, upsOutputPower=upsOutputPower, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarm=upsAlarm, upsSubsetOutputGroup=upsSubsetOutputGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsOutput=upsOutput, upsAlarmsPresent=upsAlarmsPresent, upsGroups=upsGroups, upsBasicBypassGroup=upsBasicBypassGroup, upsIdentModel=upsIdentModel, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsOutputCurrent=upsOutputCurrent, upsConformance=upsConformance, upsBypassFrequency=upsBypassFrequency, upsRebootWithDuration=upsRebootWithDuration, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsInputLineIndex=upsInputLineIndex, upsAlarmBatteryBad=upsAlarmBatteryBad, upsInputVoltage=upsInputVoltage, upsConfigOutputVA=upsConfigOutputVA, upsBypassVoltage=upsBypassVoltage, upsFullTestGroup=upsFullTestGroup, upsAutoRestart=upsAutoRestart, PYSNMP_MODULE_ID=upsMIB, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsInputNumLines=upsInputNumLines, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBatteryTemperature=upsBatteryTemperature, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBasicInputGroup=upsBasicInputGroup, upsOutputSource=upsOutputSource, upsOutputNumLines=upsOutputNumLines, upsTestResultsSummary=upsTestResultsSummary, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBypassLineIndex=upsBypassLineIndex, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsShutdownAfterDelay=upsShutdownAfterDelay)
