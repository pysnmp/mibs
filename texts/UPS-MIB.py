...
Gauge32, Counter64, Bits, NotificationType, mib_2, Integer32, iso, Unsigned32, ObjectIdentity, TimeTicks, ModuleIdentity, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "Bits", "NotificationType", "mib-2", "Integer32", "iso", "Unsigned32", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
TextualConvention, TestAndIncr, TimeStamp, DisplayString, TimeInterval, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TestAndIncr", "TimeStamp", "DisplayString", "TimeInterval", "AutonomousType")
...
mibBuilder.exportSymbols("UPS-MIB", upsOutputCurrent=upsOutputCurrent, upsBasicInputGroup=upsBasicInputGroup, PYSNMP_MODULE_ID=upsMIB, upsAlarmOnBattery=upsAlarmOnBattery, upsTest=upsTest, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsConfig=upsConfig, upsBypassEntry=upsBypassEntry, upsAlarmId=upsAlarmId, upsOutputTable=upsOutputTable, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullInputGroup=upsFullInputGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsInputNumLines=upsInputNumLines, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmGeneralFault=upsAlarmGeneralFault, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsStartupAfterDelay=upsStartupAfterDelay, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullCompliance=upsFullCompliance, upsIdentName=upsIdentName, upsBasicGroups=upsBasicGroups, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmInputBad=upsAlarmInputBad, upsSubsetIdentGroup=upsSubsetIdentGroup, upsFullControlGroup=upsFullControlGroup, upsBatteryVoltage=upsBatteryVoltage, upsAlarmTime=upsAlarmTime, upsWellKnownTests=upsWellKnownTests, upsIdentAttachedDevices=upsIdentAttachedDevices, NonNegativeInteger=NonNegativeInteger, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsInputTruePower=upsInputTruePower, upsAlarmTable=upsAlarmTable, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutputVoltage=upsOutputVoltage, upsInputFrequency=upsInputFrequency, upsConfigOutputVoltage=upsConfigOutputVoltage, upsSubsetControlGroup=upsSubsetControlGroup, upsOutputEntry=upsOutputEntry, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsIdentModel=upsIdentModel, upsTestSpinLock=upsTestSpinLock, upsAlarm=upsAlarm, upsConfigLowBattTime=upsConfigLowBattTime, upsOutputLineIndex=upsOutputLineIndex, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsOutputPower=upsOutputPower, upsBypassTable=upsBypassTable, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsSubsetCompliance=upsSubsetCompliance, upsBasicConfigGroup=upsBasicConfigGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTrapTestCompleted=upsTrapTestCompleted, upsBasicOutputGroup=upsBasicOutputGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsTestStartTime=upsTestStartTime, upsInputCurrent=upsInputCurrent, upsAutoRestart=upsAutoRestart, upsInputVoltage=upsInputVoltage, upsInputEntry=upsInputEntry, upsBypassLineIndex=upsBypassLineIndex, upsAlarmLowBattery=upsAlarmLowBattery, upsBatteryCurrent=upsBatteryCurrent, upsBypass=upsBypass, upsOutputPercentLoad=upsOutputPercentLoad, upsFullIdentGroup=upsFullIdentGroup, upsIdent=upsIdent, upsAlarmOnBypass=upsAlarmOnBypass, upsRebootWithDuration=upsRebootWithDuration, upsInputLineBads=upsInputLineBads, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmsPresent=upsAlarmsPresent, upsSubsetGroups=upsSubsetGroups, upsAlarmFanFailure=upsAlarmFanFailure, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBypassFrequency=upsBypassFrequency, upsOutputSource=upsOutputSource, upsBypassVoltage=upsBypassVoltage, upsBypassNumLines=upsBypassNumLines, upsFullTestGroup=upsFullTestGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsInputLineIndex=upsInputLineIndex, upsFullGroups=upsFullGroups, upsTestId=upsTestId, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTrapOnBattery=upsTrapOnBattery, upsAlarmEntry=upsAlarmEntry, upsOutputNumLines=upsOutputNumLines, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBattery=upsBattery, upsInputTable=upsInputTable, upsSecondsOnBattery=upsSecondsOnBattery, upsTraps=upsTraps, upsBasicTestGroup=upsBasicTestGroup, upsShutdownType=upsShutdownType, upsControl=upsControl, upsBasicAlarmGroup=upsBasicAlarmGroup, upsTestElapsedTime=upsTestElapsedTime, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConfigOutputFreq=upsConfigOutputFreq, upsBatteryStatus=upsBatteryStatus, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmTempBad=upsAlarmTempBad, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsFullConfigGroup=upsFullConfigGroup, upsOutput=upsOutput, upsConfigOutputVA=upsConfigOutputVA, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsConfigInputVoltage=upsConfigInputVoltage, upsBypassPower=upsBypassPower, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsConfigInputFreq=upsConfigInputFreq, upsTestResultsSummary=upsTestResultsSummary, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBasicControlGroup=upsBasicControlGroup, upsConformance=upsConformance, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmDescr=upsAlarmDescr, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConfigOutputPower=upsConfigOutputPower, upsBasicCompliance=upsBasicCompliance, upsConfigAudibleStatus=upsConfigAudibleStatus, PositiveInteger=PositiveInteger, upsFullBypassGroup=upsFullBypassGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsFullAlarmGroup=upsFullAlarmGroup, upsBypassCurrent=upsBypassCurrent, upsCompliances=upsCompliances, upsObjects=upsObjects, upsMIB=upsMIB, upsFullBatteryGroup=upsFullBatteryGroup, upsFullOutputGroup=upsFullOutputGroup, upsInput=upsInput, upsAlarmFuseFailure=upsAlarmFuseFailure, upsSubsetInputGroup=upsSubsetInputGroup, upsIdentManufacturer=upsIdentManufacturer, upsOutputFrequency=upsOutputFrequency, upsTestResultsDetail=upsTestResultsDetail, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBatteryTemperature=upsBatteryTemperature, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsGroups=upsGroups)
