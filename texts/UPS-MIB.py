...
mibBuilder.exportSymbols("UPS-MIB", upsIdentManufacturer=upsIdentManufacturer, upsBypassVoltage=upsBypassVoltage, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsFullConfigGroup=upsFullConfigGroup, upsOutputPower=upsOutputPower, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmDescr=upsAlarmDescr, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmTime=upsAlarmTime, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmTempBad=upsAlarmTempBad, upsTestResultsDetail=upsTestResultsDetail, upsInputEntry=upsInputEntry, upsAlarmTable=upsAlarmTable, upsTestSpinLock=upsTestSpinLock, upsIdentAttachedDevices=upsIdentAttachedDevices, upsOutputPercentLoad=upsOutputPercentLoad, upsWellKnownAlarms=upsWellKnownAlarms, upsBasicBatteryGroup=upsBasicBatteryGroup, upsFullCompliance=upsFullCompliance, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBasicTestGroup=upsBasicTestGroup, upsFullBypassGroup=upsFullBypassGroup, upsFullTestGroup=upsFullTestGroup, upsGroups=upsGroups, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAutoRestart=upsAutoRestart, upsBatteryTemperature=upsBatteryTemperature, upsBasicOutputGroup=upsBasicOutputGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutputSource=upsOutputSource, upsBypassNumLines=upsBypassNumLines, upsAlarmShutdownPending=upsAlarmShutdownPending, upsInputCurrent=upsInputCurrent, upsSubsetCompliance=upsSubsetCompliance, upsBattery=upsBattery, upsAlarmGeneralFault=upsAlarmGeneralFault, upsConfigOutputVA=upsConfigOutputVA, upsBasicControlGroup=upsBasicControlGroup, upsInputNumLines=upsInputNumLines, upsRebootWithDuration=upsRebootWithDuration, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsInput=upsInput, upsBypassEntry=upsBypassEntry, upsAlarmId=upsAlarmId, upsAlarmOutputBad=upsAlarmOutputBad, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsOutputTable=upsOutputTable, upsConfigOutputVoltage=upsConfigOutputVoltage, upsIdentName=upsIdentName, upsIdent=upsIdent, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsOutputLineIndex=upsOutputLineIndex, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestStartTime=upsTestStartTime, upsControl=upsControl, upsOutputCurrent=upsOutputCurrent, upsAlarmOnBypass=upsAlarmOnBypass, upsFullGroups=upsFullGroups, upsInputLineBads=upsInputLineBads, upsBatteryVoltage=upsBatteryVoltage, upsAlarmEntry=upsAlarmEntry, upsConfigInputVoltage=upsConfigInputVoltage, upsConfigAudibleStatus=upsConfigAudibleStatus, upsConfigOutputPower=upsConfigOutputPower, upsTrapOnBattery=upsTrapOnBattery, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmFanFailure=upsAlarmFanFailure, upsObjects=upsObjects, upsStartupAfterDelay=upsStartupAfterDelay, upsBypassFrequency=upsBypassFrequency, upsBasicCompliance=upsBasicCompliance, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, NonNegativeInteger=NonNegativeInteger, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsOutputFrequency=upsOutputFrequency, upsShutdownAfterDelay=upsShutdownAfterDelay, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsTestResultsSummary=upsTestResultsSummary, upsTraps=upsTraps, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmInputBad=upsAlarmInputBad, upsInputTruePower=upsInputTruePower, upsBatteryCurrent=upsBatteryCurrent, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsConfig=upsConfig, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmOutputOverload=upsAlarmOutputOverload, upsFullIdentGroup=upsFullIdentGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsOutputNumLines=upsOutputNumLines, upsBypass=upsBypass, upsConfigOutputFreq=upsConfigOutputFreq, PYSNMP_MODULE_ID=upsMIB, upsAlarmBatteryBad=upsAlarmBatteryBad, upsSubsetOutputGroup=upsSubsetOutputGroup, upsInputVoltage=upsInputVoltage, upsBypassCurrent=upsBypassCurrent, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarm=upsAlarm, upsBatteryStatus=upsBatteryStatus, upsBasicInputGroup=upsBasicInputGroup, upsConformance=upsConformance, upsShutdownType=upsShutdownType, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, PositiveInteger=PositiveInteger, upsWellKnownTests=upsWellKnownTests, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsOutputVoltage=upsOutputVoltage, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmsPresent=upsAlarmsPresent, upsInputTable=upsInputTable, upsTestElapsedTime=upsTestElapsedTime, upsSubsetIdentGroup=upsSubsetIdentGroup, upsInputLineIndex=upsInputLineIndex, upsIdentModel=upsIdentModel, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsConfigInputFreq=upsConfigInputFreq, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsFullInputGroup=upsFullInputGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsTest=upsTest, upsFullAlarmGroup=upsFullAlarmGroup, upsBypassPower=upsBypassPower, upsBypassTable=upsBypassTable, upsTestId=upsTestId, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBasicGroups=upsBasicGroups, upsSubsetGroups=upsSubsetGroups, upsSubsetControlGroup=upsSubsetControlGroup, upsBypassLineIndex=upsBypassLineIndex, upsCompliances=upsCompliances, upsMIB=upsMIB, upsFullControlGroup=upsFullControlGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsInputFrequency=upsInputFrequency, upsOutput=upsOutput, upsAlarmChargerFailed=upsAlarmChargerFailed, upsFullOutputGroup=upsFullOutputGroup, upsOutputEntry=upsOutputEntry)
