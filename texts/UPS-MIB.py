...
# Produced by pysmi-1.1.10 at Fri Oct 27 06:56:49 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, IpAddress, TimeTicks, Gauge32, NotificationType, Unsigned32, MibIdentifier, Bits, iso, ObjectIdentity, ModuleIdentity, Counter64, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "IpAddress", "TimeTicks", "Gauge32", "NotificationType", "Unsigned32", "MibIdentifier", "Bits", "iso", "ObjectIdentity", "ModuleIdentity", "Counter64", "mib-2")
TimeStamp, TestAndIncr, TextualConvention, AutonomousType, TimeInterval, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TestAndIncr", "TextualConvention", "AutonomousType", "TimeInterval", "DisplayString")
...
mibBuilder.exportSymbols("UPS-MIB", upsTestStartTime=upsTestStartTime, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBypassVoltage=upsBypassVoltage, upsIdent=upsIdent, upsAlarm=upsAlarm, upsFullInputGroup=upsFullInputGroup, upsIdentName=upsIdentName, upsFullTestGroup=upsFullTestGroup, upsShutdownType=upsShutdownType, upsTrapOnBattery=upsTrapOnBattery, upsConfigLowBattTime=upsConfigLowBattTime, upsInputNumLines=upsInputNumLines, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmFanFailure=upsAlarmFanFailure, upsFullOutputGroup=upsFullOutputGroup, upsFullIdentGroup=upsFullIdentGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBypassFrequency=upsBypassFrequency, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmId=upsAlarmId, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConfig=upsConfig, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmEntry=upsAlarmEntry, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBasicCompliance=upsBasicCompliance, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmInputBad=upsAlarmInputBad, upsBypassNumLines=upsBypassNumLines, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBatteryCurrent=upsBatteryCurrent, upsConfigOutputVoltage=upsConfigOutputVoltage, upsTest=upsTest, upsInputLineIndex=upsInputLineIndex, upsOutputCurrent=upsOutputCurrent, upsAlarmDescr=upsAlarmDescr, upsMIB=upsMIB, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmTable=upsAlarmTable, upsConformance=upsConformance, upsInputVoltage=upsInputVoltage, upsAlarmBatteryBad=upsAlarmBatteryBad, NonNegativeInteger=NonNegativeInteger, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutput=upsOutput, upsBypassEntry=upsBypassEntry, upsBasicBypassGroup=upsBasicBypassGroup, upsOutputEntry=upsOutputEntry, upsInput=upsInput, upsTraps=upsTraps, upsConfigOutputVA=upsConfigOutputVA, upsInputTable=upsInputTable, upsBypassCurrent=upsBypassCurrent, upsConfigInputVoltage=upsConfigInputVoltage, upsShutdownAfterDelay=upsShutdownAfterDelay, upsTrapTestCompleted=upsTrapTestCompleted, upsBattery=upsBattery, upsAutoRestart=upsAutoRestart, upsOutputLineIndex=upsOutputLineIndex, upsAlarmLowBattery=upsAlarmLowBattery, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsCompliances=upsCompliances, upsBypassTable=upsBypassTable, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmOnBypass=upsAlarmOnBypass, upsStartupAfterDelay=upsStartupAfterDelay, upsSubsetIdentGroup=upsSubsetIdentGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsConfigInputFreq=upsConfigInputFreq, upsOutputFrequency=upsOutputFrequency, upsAlarmOnBattery=upsAlarmOnBattery, upsOutputPower=upsOutputPower, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsObjects=upsObjects, upsBatteryTemperature=upsBatteryTemperature, upsOutputSource=upsOutputSource, upsFullCompliance=upsFullCompliance, upsFullControlGroup=upsFullControlGroup, upsBasicGroups=upsBasicGroups, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsOutputNumLines=upsOutputNumLines, upsTestId=upsTestId, upsAlarmChargerFailed=upsAlarmChargerFailed, upsControl=upsControl, upsInputEntry=upsInputEntry, upsFullConfigGroup=upsFullConfigGroup, upsOutputVoltage=upsOutputVoltage, upsWellKnownTests=upsWellKnownTests, upsAlarmTime=upsAlarmTime, upsInputTruePower=upsInputTruePower, upsSubsetGroups=upsSubsetGroups, upsFullBypassGroup=upsFullBypassGroup, PYSNMP_MODULE_ID=upsMIB, upsOutputTable=upsOutputTable, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmTempBad=upsAlarmTempBad, upsBatteryVoltage=upsBatteryVoltage, upsAlarmOutputBad=upsAlarmOutputBad, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsBypassPower=upsBypassPower, upsTestElapsedTime=upsTestElapsedTime, upsInputCurrent=upsInputCurrent, upsSubsetInputGroup=upsSubsetInputGroup, upsGroups=upsGroups, upsFullGroups=upsFullGroups, upsBypass=upsBypass, upsOutputPercentLoad=upsOutputPercentLoad, upsIdentManufacturer=upsIdentManufacturer, upsRebootWithDuration=upsRebootWithDuration, upsBasicControlGroup=upsBasicControlGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, PositiveInteger=PositiveInteger, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsInputFrequency=upsInputFrequency, upsTestSpinLock=upsTestSpinLock, upsBasicTestGroup=upsBasicTestGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsBypassLineIndex=upsBypassLineIndex, upsAlarmsPresent=upsAlarmsPresent, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsSubsetCompliance=upsSubsetCompliance, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsInputLineBads=upsInputLineBads, upsBasicOutputGroup=upsBasicOutputGroup, upsBasicInputGroup=upsBasicInputGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmBypassBad=upsAlarmBypassBad, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigOutputPower=upsConfigOutputPower, upsBatteryStatus=upsBatteryStatus, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsWellKnownAlarms=upsWellKnownAlarms, upsTestResultsSummary=upsTestResultsSummary, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsIdentModel=upsIdentModel, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTestResultsDetail=upsTestResultsDetail)
