...
mibBuilder.exportSymbols("UPS-MIB", upsWellKnownTests=upsWellKnownTests, upsAlarmTempBad=upsAlarmTempBad, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicOutputGroup=upsBasicOutputGroup, upsBasicTestGroup=upsBasicTestGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmBatteryBad=upsAlarmBatteryBad, upsOutputPercentLoad=upsOutputPercentLoad, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsSubsetGroups=upsSubsetGroups, upsBasicBypassGroup=upsBasicBypassGroup, upsOutputSource=upsOutputSource, upsAlarmEntry=upsAlarmEntry, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsIdent=upsIdent, upsInputCurrent=upsInputCurrent, upsOutputFrequency=upsOutputFrequency, upsConfigOutputPower=upsConfigOutputPower, upsFullConfigGroup=upsFullConfigGroup, upsSubsetCompliance=upsSubsetCompliance, upsWellKnownAlarms=upsWellKnownAlarms, upsObjects=upsObjects, upsAlarmOnBypass=upsAlarmOnBypass, upsFullIdentGroup=upsFullIdentGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsConfigOutputVA=upsConfigOutputVA, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmFuseFailure=upsAlarmFuseFailure, upsFullAlarmGroup=upsFullAlarmGroup, upsFullCompliance=upsFullCompliance, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBypassCurrent=upsBypassCurrent, upsRebootWithDuration=upsRebootWithDuration, upsFullInputGroup=upsFullInputGroup, upsInputLineBads=upsInputLineBads, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestResultsDetail=upsTestResultsDetail, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmInputBad=upsAlarmInputBad, upsTrapOnBattery=upsTrapOnBattery, upsConfig=upsConfig, upsAlarmOnBattery=upsAlarmOnBattery, upsBasicBatteryGroup=upsBasicBatteryGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmOutputOverload=upsAlarmOutputOverload, upsSubsetInputGroup=upsSubsetInputGroup, upsBypassNumLines=upsBypassNumLines, upsSubsetControlGroup=upsSubsetControlGroup, upsIdentManufacturer=upsIdentManufacturer, upsBasicConfigGroup=upsBasicConfigGroup, upsConformance=upsConformance, upsStartupAfterDelay=upsStartupAfterDelay, upsCompliances=upsCompliances, upsBypassVoltage=upsBypassVoltage, upsBypassFrequency=upsBypassFrequency, upsTestSpinLock=upsTestSpinLock, upsTestResultsSummary=upsTestResultsSummary, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBypassEntry=upsBypassEntry, upsAlarmLowBattery=upsAlarmLowBattery, PYSNMP_MODULE_ID=upsMIB, upsInputEntry=upsInputEntry, upsShutdownType=upsShutdownType, upsBypassTable=upsBypassTable, upsInputLineIndex=upsInputLineIndex, upsMIB=upsMIB, upsTestStartTime=upsTestStartTime, upsAlarm=upsAlarm, NonNegativeInteger=NonNegativeInteger, upsInput=upsInput, upsAlarmTable=upsAlarmTable, upsTraps=upsTraps, upsFullBypassGroup=upsFullBypassGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsInputNumLines=upsInputNumLines, upsAlarmChargerFailed=upsAlarmChargerFailed, upsOutput=upsOutput, upsSubsetIdentGroup=upsSubsetIdentGroup, upsSecondsOnBattery=upsSecondsOnBattery, PositiveInteger=PositiveInteger, upsOutputNumLines=upsOutputNumLines, upsSubsetConfigGroup=upsSubsetConfigGroup, upsIdentModel=upsIdentModel, upsBasicInputGroup=upsBasicInputGroup, upsFullOutputGroup=upsFullOutputGroup, upsOutputPower=upsOutputPower, upsBypassPower=upsBypassPower, upsTest=upsTest, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBatteryTemperature=upsBatteryTemperature, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsFullGroups=upsFullGroups, upsConfigLowBattTime=upsConfigLowBattTime, upsBasicControlGroup=upsBasicControlGroup, upsInputVoltage=upsInputVoltage, upsBasicIdentGroup=upsBasicIdentGroup, upsTestElapsedTime=upsTestElapsedTime, upsAlarmTime=upsAlarmTime, upsFullControlGroup=upsFullControlGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBasicCompliance=upsBasicCompliance, upsOutputEntry=upsOutputEntry, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBatteryCurrent=upsBatteryCurrent, upsControl=upsControl, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsOutputLineIndex=upsOutputLineIndex, upsBasicGroups=upsBasicGroups, upsAlarmOutputBad=upsAlarmOutputBad, upsTestId=upsTestId, upsOutputCurrent=upsOutputCurrent, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmsPresent=upsAlarmsPresent, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsOutputTable=upsOutputTable, upsInputTable=upsInputTable, upsOutputVoltage=upsOutputVoltage, upsBypass=upsBypass, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmDescr=upsAlarmDescr, upsFullTestGroup=upsFullTestGroup, upsBatteryVoltage=upsBatteryVoltage, upsGroups=upsGroups, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAutoRestart=upsAutoRestart, upsInputFrequency=upsInputFrequency, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsIdentName=upsIdentName, upsBatteryStatus=upsBatteryStatus, upsAlarmId=upsAlarmId, upsConfigInputFreq=upsConfigInputFreq, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsBattery=upsBattery, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsFullBatteryGroup=upsFullBatteryGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBypassLineIndex=upsBypassLineIndex, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsInputTruePower=upsInputTruePower, upsAlarmTestInProgress=upsAlarmTestInProgress)
