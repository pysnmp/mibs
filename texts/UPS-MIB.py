...
mibBuilder.exportSymbols("UPS-MIB", upsSubsetConfigGroup=upsSubsetConfigGroup, upsBatteryStatus=upsBatteryStatus, upsBasicControlGroup=upsBasicControlGroup, upsBypassFrequency=upsBypassFrequency, upsBasicBypassGroup=upsBasicBypassGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsGroups=upsGroups, upsInputCurrent=upsInputCurrent, upsInput=upsInput, upsAlarmsPresent=upsAlarmsPresent, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsShutdownAfterDelay=upsShutdownAfterDelay, upsInputVoltage=upsInputVoltage, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmId=upsAlarmId, upsShutdownType=upsShutdownType, upsBasicTestGroup=upsBasicTestGroup, upsIdentName=upsIdentName, upsConfigOutputVA=upsConfigOutputVA, upsAlarmTempBad=upsAlarmTempBad, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmTime=upsAlarmTime, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsFullCompliance=upsFullCompliance, upsBatteryVoltage=upsBatteryVoltage, upsInputTruePower=upsInputTruePower, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsIdentManufacturer=upsIdentManufacturer, upsOutputPower=upsOutputPower, upsAlarmLowBattery=upsAlarmLowBattery, upsSubsetOutputGroup=upsSubsetOutputGroup, upsInputEntry=upsInputEntry, upsBatteryTemperature=upsBatteryTemperature, upsOutputNumLines=upsOutputNumLines, upsOutputEntry=upsOutputEntry, upsAutoRestart=upsAutoRestart, upsWellKnownAlarms=upsWellKnownAlarms, upsBypassEntry=upsBypassEntry, upsBasicConfigGroup=upsBasicConfigGroup, upsFullGroups=upsFullGroups, upsBasicInputGroup=upsBasicInputGroup, upsBasicCompliance=upsBasicCompliance, PositiveInteger=PositiveInteger, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsOutputSource=upsOutputSource, upsAlarmOutputBad=upsAlarmOutputBad, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBatteryCurrent=upsBatteryCurrent, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTest=upsTest, upsFullTestGroup=upsFullTestGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsIdentModel=upsIdentModel, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTrapOnBattery=upsTrapOnBattery, upsConfigAudibleStatus=upsConfigAudibleStatus, upsSubsetCompliance=upsSubsetCompliance, upsMIB=upsMIB, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsInputFrequency=upsInputFrequency, PYSNMP_MODULE_ID=upsMIB, upsConfigLowBattTime=upsConfigLowBattTime, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmChargerFailed=upsAlarmChargerFailed, upsFullInputGroup=upsFullInputGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsSecondsOnBattery=upsSecondsOnBattery, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmInputBad=upsAlarmInputBad, upsFullOutputGroup=upsFullOutputGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsStartupAfterDelay=upsStartupAfterDelay, upsBypassTable=upsBypassTable, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBypass=upsBypass, upsInputTable=upsInputTable, upsFullBypassGroup=upsFullBypassGroup, upsBypassCurrent=upsBypassCurrent, upsTestResultsSummary=upsTestResultsSummary, upsTraps=upsTraps, upsAlarmBypassBad=upsAlarmBypassBad, upsBypassVoltage=upsBypassVoltage, upsAlarmFanFailure=upsAlarmFanFailure, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsRebootWithDuration=upsRebootWithDuration, upsConformance=upsConformance, upsConfigInputFreq=upsConfigInputFreq, upsTestElapsedTime=upsTestElapsedTime, upsTrapTestCompleted=upsTrapTestCompleted, upsBasicGroups=upsBasicGroups, upsFullControlGroup=upsFullControlGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTestSpinLock=upsTestSpinLock, upsSubsetControlGroup=upsSubsetControlGroup, upsFullIdentGroup=upsFullIdentGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsControl=upsControl, upsBypassNumLines=upsBypassNumLines, upsIdent=upsIdent, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsInputLineBads=upsInputLineBads, upsAlarmDescr=upsAlarmDescr, upsOutputTable=upsOutputTable, upsAlarm=upsAlarm, upsSubsetInputGroup=upsSubsetInputGroup, upsConfigOutputPower=upsConfigOutputPower, upsBattery=upsBattery, upsInputNumLines=upsInputNumLines, upsAlarmFuseFailure=upsAlarmFuseFailure, upsOutputVoltage=upsOutputVoltage, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsOutput=upsOutput, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsTestResultsDetail=upsTestResultsDetail, upsCompliances=upsCompliances, upsConfigOutputVoltage=upsConfigOutputVoltage, upsOutputCurrent=upsOutputCurrent, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmOutputOverload=upsAlarmOutputOverload, upsOutputFrequency=upsOutputFrequency, upsSubsetGroups=upsSubsetGroups, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsObjects=upsObjects, upsIdentAttachedDevices=upsIdentAttachedDevices, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsInputLineIndex=upsInputLineIndex, upsAlarmTestInProgress=upsAlarmTestInProgress, upsWellKnownTests=upsWellKnownTests, NonNegativeInteger=NonNegativeInteger, upsBypassPower=upsBypassPower, upsTestId=upsTestId, upsConfig=upsConfig, upsFullConfigGroup=upsFullConfigGroup, upsBypassLineIndex=upsBypassLineIndex, upsAlarmOnBypass=upsAlarmOnBypass, upsSubsetIdentGroup=upsSubsetIdentGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutputLineIndex=upsOutputLineIndex, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmEntry=upsAlarmEntry, upsAlarmTable=upsAlarmTable, upsConfigInputVoltage=upsConfigInputVoltage, upsTestStartTime=upsTestStartTime)
