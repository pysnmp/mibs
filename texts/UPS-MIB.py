...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmInputBad=upsAlarmInputBad, upsAlarmBatteryBad=upsAlarmBatteryBad, upsConfigOutputVA=upsConfigOutputVA, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsRebootWithDuration=upsRebootWithDuration, upsInputLineIndex=upsInputLineIndex, upsAlarmOutputBad=upsAlarmOutputBad, upsBypassEntry=upsBypassEntry, upsConfig=upsConfig, upsBypassTable=upsBypassTable, upsBasicConfigGroup=upsBasicConfigGroup, upsBatteryTemperature=upsBatteryTemperature, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsInputVoltage=upsInputVoltage, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsFullConfigGroup=upsFullConfigGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBatteryStatus=upsBatteryStatus, upsIdent=upsIdent, upsObjects=upsObjects, upsAlarm=upsAlarm, upsSubsetGroups=upsSubsetGroups, upsAlarmLowBattery=upsAlarmLowBattery, upsInputTruePower=upsInputTruePower, upsBypassNumLines=upsBypassNumLines, upsTestSpinLock=upsTestSpinLock, upsOutputNumLines=upsOutputNumLines, upsShutdownAfterDelay=upsShutdownAfterDelay, upsFullControlGroup=upsFullControlGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsOutputTable=upsOutputTable, upsAlarmChargerFailed=upsAlarmChargerFailed, upsTraps=upsTraps, upsAlarmTime=upsAlarmTime, upsOutputEntry=upsOutputEntry, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmTable=upsAlarmTable, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicBypassGroup=upsBasicBypassGroup, upsTestResultsSummary=upsTestResultsSummary, upsOutputVoltage=upsOutputVoltage, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsOutputLineIndex=upsOutputLineIndex, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfigInputVoltage=upsConfigInputVoltage, PYSNMP_MODULE_ID=upsMIB, upsBypass=upsBypass, upsBypassLineIndex=upsBypassLineIndex, upsFullGroups=upsFullGroups, upsOutputFrequency=upsOutputFrequency, upsOutputSource=upsOutputSource, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmDescr=upsAlarmDescr, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsInputEntry=upsInputEntry, upsBasicIdentGroup=upsBasicIdentGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsAutoRestart=upsAutoRestart, upsFullCompliance=upsFullCompliance, upsStartupAfterDelay=upsStartupAfterDelay, upsSubsetControlGroup=upsSubsetControlGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBypassPower=upsBypassPower, upsShutdownType=upsShutdownType, upsFullBatteryGroup=upsFullBatteryGroup, upsInputTable=upsInputTable, upsOutput=upsOutput, upsBasicTestGroup=upsBasicTestGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmFuseFailure=upsAlarmFuseFailure, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBypassFrequency=upsBypassFrequency, upsFullInputGroup=upsFullInputGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, NonNegativeInteger=NonNegativeInteger, upsSubsetCompliance=upsSubsetCompliance, upsInputFrequency=upsInputFrequency, upsBypassCurrent=upsBypassCurrent, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConfigAudibleStatus=upsConfigAudibleStatus, upsSecondsOnBattery=upsSecondsOnBattery, upsTestId=upsTestId, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTestResultsDetail=upsTestResultsDetail, upsWellKnownTests=upsWellKnownTests, upsFullTestGroup=upsFullTestGroup, upsOutputPower=upsOutputPower, upsAlarmTempBad=upsAlarmTempBad, upsTrapTestCompleted=upsTrapTestCompleted, upsGroups=upsGroups, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBypassVoltage=upsBypassVoltage, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmEntry=upsAlarmEntry, upsOutputCurrent=upsOutputCurrent, upsInput=upsInput, PositiveInteger=PositiveInteger, upsControl=upsControl, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBasicGroups=upsBasicGroups, upsBattery=upsBattery, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsIdentName=upsIdentName, upsCompliances=upsCompliances, upsAlarmOnBypass=upsAlarmOnBypass, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBatteryVoltage=upsBatteryVoltage, upsAlarmId=upsAlarmId, upsBasicInputGroup=upsBasicInputGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsConfigOutputPower=upsConfigOutputPower, upsFullBypassGroup=upsFullBypassGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmsPresent=upsAlarmsPresent, upsBasicCompliance=upsBasicCompliance, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsInputNumLines=upsInputNumLines, upsBasicControlGroup=upsBasicControlGroup, upsInputLineBads=upsInputLineBads, upsInputCurrent=upsInputCurrent, upsIdentModel=upsIdentModel, upsTest=upsTest, upsConfigOutputFreq=upsConfigOutputFreq, upsBatteryCurrent=upsBatteryCurrent, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsConfigInputFreq=upsConfigInputFreq, upsFullIdentGroup=upsFullIdentGroup, upsConformance=upsConformance, upsFullOutputGroup=upsFullOutputGroup, upsMIB=upsMIB, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestElapsedTime=upsTestElapsedTime, upsTrapOnBattery=upsTrapOnBattery, upsSubsetOutputGroup=upsSubsetOutputGroup, upsTestStartTime=upsTestStartTime, upsIdentManufacturer=upsIdentManufacturer, upsAlarmShutdownPending=upsAlarmShutdownPending)
