...
# Produced by pysmi-1.1.8 at Thu Sep  7 09:11:21 2023
...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, Gauge32, Integer32, MibIdentifier, mib_2, ModuleIdentity, Counter64, iso, IpAddress, TimeTicks, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "Gauge32", "Integer32", "MibIdentifier", "mib-2", "ModuleIdentity", "Counter64", "iso", "IpAddress", "TimeTicks", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("UPS-MIB", upsBypass=upsBypass, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBypassEntry=upsBypassEntry, upsOutputPercentLoad=upsOutputPercentLoad, upsFullCompliance=upsFullCompliance, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBasicBypassGroup=upsBasicBypassGroup, upsTest=upsTest, upsInputTable=upsInputTable, upsIdentName=upsIdentName, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsInputTruePower=upsInputTruePower, upsAlarm=upsAlarm, upsIdent=upsIdent, upsOutputFrequency=upsOutputFrequency, upsAlarmTestInProgress=upsAlarmTestInProgress, upsControl=upsControl, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsInputLineIndex=upsInputLineIndex, upsInputCurrent=upsInputCurrent, upsAlarmDescr=upsAlarmDescr, upsConfigOutputFreq=upsConfigOutputFreq, upsBatteryCurrent=upsBatteryCurrent, upsBasicIdentGroup=upsBasicIdentGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsOutput=upsOutput, upsInputLineBads=upsInputLineBads, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBasicConfigGroup=upsBasicConfigGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsObjects=upsObjects, upsTestResultsSummary=upsTestResultsSummary, upsOutputNumLines=upsOutputNumLines, upsAlarmTable=upsAlarmTable, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, PYSNMP_MODULE_ID=upsMIB, upsBypassVoltage=upsBypassVoltage, upsBypassFrequency=upsBypassFrequency, upsTestId=upsTestId, upsStartupAfterDelay=upsStartupAfterDelay, upsConfigOutputVoltage=upsConfigOutputVoltage, upsSubsetCompliance=upsSubsetCompliance, upsConfigInputFreq=upsConfigInputFreq, upsFullTestGroup=upsFullTestGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmEntry=upsAlarmEntry, upsInputEntry=upsInputEntry, upsConfigInputVoltage=upsConfigInputVoltage, NonNegativeInteger=NonNegativeInteger, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestElapsedTime=upsTestElapsedTime, upsMIB=upsMIB, upsBasicControlGroup=upsBasicControlGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsWellKnownAlarms=upsWellKnownAlarms, upsIdentModel=upsIdentModel, upsIdentManufacturer=upsIdentManufacturer, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBasicCompliance=upsBasicCompliance, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTestSpinLock=upsTestSpinLock, upsAlarmOnBypass=upsAlarmOnBypass, upsSubsetGroups=upsSubsetGroups, upsOutputCurrent=upsOutputCurrent, upsShutdownAfterDelay=upsShutdownAfterDelay, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullBypassGroup=upsFullBypassGroup, upsTestStartTime=upsTestStartTime, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmTempBad=upsAlarmTempBad, upsWellKnownTests=upsWellKnownTests, upsOutputSource=upsOutputSource, PositiveInteger=PositiveInteger, upsAlarmId=upsAlarmId, upsConformance=upsConformance, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsInputNumLines=upsInputNumLines, upsBasicAlarmGroup=upsBasicAlarmGroup, upsRebootWithDuration=upsRebootWithDuration, upsGroups=upsGroups, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBypassLineIndex=upsBypassLineIndex, upsConfigLowBattTime=upsConfigLowBattTime, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmsPresent=upsAlarmsPresent, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBatteryTemperature=upsBatteryTemperature, upsInput=upsInput, upsInputFrequency=upsInputFrequency, upsOutputPower=upsOutputPower, upsCompliances=upsCompliances, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBatteryStatus=upsBatteryStatus, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsBypassCurrent=upsBypassCurrent, upsAlarmBypassBad=upsAlarmBypassBad, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsSubsetControlGroup=upsSubsetControlGroup, upsOutputLineIndex=upsOutputLineIndex, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBasicTestGroup=upsBasicTestGroup, upsFullGroups=upsFullGroups, upsAlarmChargerFailed=upsAlarmChargerFailed, upsTestResultsDetail=upsTestResultsDetail, upsAlarmBatteryBad=upsAlarmBatteryBad, upsFullOutputGroup=upsFullOutputGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsConfig=upsConfig, upsFullControlGroup=upsFullControlGroup, upsShutdownType=upsShutdownType, upsAutoRestart=upsAutoRestart, upsBypassTable=upsBypassTable, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsFullIdentGroup=upsFullIdentGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsTrapOnBattery=upsTrapOnBattery, upsBypassPower=upsBypassPower, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBypassNumLines=upsBypassNumLines, upsBasicOutputGroup=upsBasicOutputGroup, upsConfigOutputVA=upsConfigOutputVA, upsTraps=upsTraps, upsAlarmInputBad=upsAlarmInputBad, upsOutputVoltage=upsOutputVoltage, upsAlarmTime=upsAlarmTime, upsFullConfigGroup=upsFullConfigGroup, upsOutputTable=upsOutputTable, upsBasicGroups=upsBasicGroups, upsConfigOutputPower=upsConfigOutputPower, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBatteryVoltage=upsBatteryVoltage, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBasicInputGroup=upsBasicInputGroup, upsBattery=upsBattery, upsInputVoltage=upsInputVoltage, upsFullInputGroup=upsFullInputGroup, upsOutputEntry=upsOutputEntry)
