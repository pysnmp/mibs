...
mibBuilder.exportSymbols("UPS-MIB", upsShutdownType=upsShutdownType, upsBasicInputGroup=upsBasicInputGroup, upsBatteryStatus=upsBatteryStatus, PYSNMP_MODULE_ID=upsMIB, upsOutputVoltage=upsOutputVoltage, upsInputCurrent=upsInputCurrent, upsControl=upsControl, upsConfigLowBattTime=upsConfigLowBattTime, upsAutoRestart=upsAutoRestart, upsOutput=upsOutput, upsInputVoltage=upsInputVoltage, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmTempBad=upsAlarmTempBad, upsStartupAfterDelay=upsStartupAfterDelay, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBasicControlGroup=upsBasicControlGroup, upsAlarmId=upsAlarmId, upsBypassFrequency=upsBypassFrequency, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsInputNumLines=upsInputNumLines, upsAlarmInputBad=upsAlarmInputBad, upsAlarmOnBattery=upsAlarmOnBattery, upsMIB=upsMIB, upsRebootWithDuration=upsRebootWithDuration, upsConfigInputVoltage=upsConfigInputVoltage, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmOnBypass=upsAlarmOnBypass, NonNegativeInteger=NonNegativeInteger, upsSubsetCompliance=upsSubsetCompliance, upsAlarmTime=upsAlarmTime, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsOutputPower=upsOutputPower, upsAlarmDescr=upsAlarmDescr, upsBasicConfigGroup=upsBasicConfigGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsCompliances=upsCompliances, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutputSource=upsOutputSource, upsBypass=upsBypass, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsOutputFrequency=upsOutputFrequency, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestSpinLock=upsTestSpinLock, upsAlarmsPresent=upsAlarmsPresent, upsBypassTable=upsBypassTable, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsBasicBypassGroup=upsBasicBypassGroup, upsTestResultsSummary=upsTestResultsSummary, upsSubsetGroups=upsSubsetGroups, upsAlarmChargerFailed=upsAlarmChargerFailed, upsIdentManufacturer=upsIdentManufacturer, upsAlarmBypassBad=upsAlarmBypassBad, upsFullInputGroup=upsFullInputGroup, upsAlarmEntry=upsAlarmEntry, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullBypassGroup=upsFullBypassGroup, upsTestElapsedTime=upsTestElapsedTime, upsIdentAttachedDevices=upsIdentAttachedDevices, upsFullGroups=upsFullGroups, upsBypassEntry=upsBypassEntry, upsBasicAlarmGroup=upsBasicAlarmGroup, upsInputFrequency=upsInputFrequency, upsOutputEntry=upsOutputEntry, upsOutputLineIndex=upsOutputLineIndex, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBypassLineIndex=upsBypassLineIndex, upsWellKnownTests=upsWellKnownTests, upsConfigOutputFreq=upsConfigOutputFreq, upsBypassPower=upsBypassPower, upsTestStartTime=upsTestStartTime, upsInput=upsInput, upsConfigOutputVoltage=upsConfigOutputVoltage, PositiveInteger=PositiveInteger, upsFullCompliance=upsFullCompliance, upsBasicIdentGroup=upsBasicIdentGroup, upsInputLineBads=upsInputLineBads, upsTrapOnBattery=upsTrapOnBattery, upsAlarm=upsAlarm, upsFullIdentGroup=upsFullIdentGroup, upsConfigOutputPower=upsConfigOutputPower, upsIdent=upsIdent, upsOutputCurrent=upsOutputCurrent, upsIdentModel=upsIdentModel, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBypassVoltage=upsBypassVoltage, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsSubsetControlGroup=upsSubsetControlGroup, upsFullOutputGroup=upsFullOutputGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmFuseFailure=upsAlarmFuseFailure, upsInputTable=upsInputTable, upsObjects=upsObjects, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmTable=upsAlarmTable, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsOutputTable=upsOutputTable, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmShutdownPending=upsAlarmShutdownPending, upsInputLineIndex=upsInputLineIndex, upsBattery=upsBattery, upsConfigOutputVA=upsConfigOutputVA, upsBasicTestGroup=upsBasicTestGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsTraps=upsTraps, upsInputEntry=upsInputEntry, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsFullControlGroup=upsFullControlGroup, upsBypassNumLines=upsBypassNumLines, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBatteryTemperature=upsBatteryTemperature, upsTestId=upsTestId, upsBatteryVoltage=upsBatteryVoltage, upsFullTestGroup=upsFullTestGroup, upsIdentName=upsIdentName, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBasicCompliance=upsBasicCompliance, upsOutputNumLines=upsOutputNumLines, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsConfigAudibleStatus=upsConfigAudibleStatus, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsTest=upsTest, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmOutputBad=upsAlarmOutputBad, upsTestResultsDetail=upsTestResultsDetail, upsConfig=upsConfig, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsConformance=upsConformance, upsGroups=upsGroups, upsBasicGroups=upsBasicGroups, upsAlarmLowBattery=upsAlarmLowBattery, upsSubsetConfigGroup=upsSubsetConfigGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsConfigInputFreq=upsConfigInputFreq, upsBypassCurrent=upsBypassCurrent, upsInputTruePower=upsInputTruePower, upsFullAlarmGroup=upsFullAlarmGroup, upsBatteryCurrent=upsBatteryCurrent, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmGeneralFault=upsAlarmGeneralFault, upsFullConfigGroup=upsFullConfigGroup, upsAlarmBatteryBad=upsAlarmBatteryBad)
