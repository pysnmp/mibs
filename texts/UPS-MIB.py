...
mibBuilder.exportSymbols("UPS-MIB", upsFullIdentGroup=upsFullIdentGroup, upsIdent=upsIdent, upsAlarmBatteryBad=upsAlarmBatteryBad, upsFullAlarmGroup=upsFullAlarmGroup, upsConfigOutputPower=upsConfigOutputPower, upsSubsetGroups=upsSubsetGroups, upsInputCurrent=upsInputCurrent, upsConfigOutputVoltage=upsConfigOutputVoltage, upsConfig=upsConfig, upsFullCompliance=upsFullCompliance, upsOutputVoltage=upsOutputVoltage, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBatteryCurrent=upsBatteryCurrent, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBasicCompliance=upsBasicCompliance, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsWellKnownAlarms=upsWellKnownAlarms, upsConfigAudibleStatus=upsConfigAudibleStatus, upsConfigInputVoltage=upsConfigInputVoltage, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBasicTestGroup=upsBasicTestGroup, upsBatteryVoltage=upsBatteryVoltage, upsAlarmEntry=upsAlarmEntry, upsBypassVoltage=upsBypassVoltage, upsBatteryTemperature=upsBatteryTemperature, upsAlarmDescr=upsAlarmDescr, upsInputEntry=upsInputEntry, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsShutdownType=upsShutdownType, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsFullGroups=upsFullGroups, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmBypassBad=upsAlarmBypassBad, upsBypassEntry=upsBypassEntry, upsSubsetInputGroup=upsSubsetInputGroup, upsOutputCurrent=upsOutputCurrent, upsBypassLineIndex=upsBypassLineIndex, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsIdentName=upsIdentName, upsAlarmInputBad=upsAlarmInputBad, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsStartupAfterDelay=upsStartupAfterDelay, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmTempBad=upsAlarmTempBad, upsOutputPercentLoad=upsOutputPercentLoad, upsConfigOutputVA=upsConfigOutputVA, upsTestId=upsTestId, upsInput=upsInput, upsTest=upsTest, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsOutputSource=upsOutputSource, upsBypassCurrent=upsBypassCurrent, upsBypassNumLines=upsBypassNumLines, upsBasicControlGroup=upsBasicControlGroup, upsOutputLineIndex=upsOutputLineIndex, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmTable=upsAlarmTable, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAutoRestart=upsAutoRestart, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsIdentAttachedDevices=upsIdentAttachedDevices, upsIdentManufacturer=upsIdentManufacturer, upsSecondsOnBattery=upsSecondsOnBattery, upsBattery=upsBattery, upsTrapOnBattery=upsTrapOnBattery, upsInputFrequency=upsInputFrequency, upsInputTruePower=upsInputTruePower, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsGroups=upsGroups, upsOutputPower=upsOutputPower, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, PYSNMP_MODULE_ID=upsMIB, upsBasicBypassGroup=upsBasicBypassGroup, upsOutputTable=upsOutputTable, upsBasicAlarmGroup=upsBasicAlarmGroup, upsInputTable=upsInputTable, upsFullOutputGroup=upsFullOutputGroup, upsTestResultsDetail=upsTestResultsDetail, upsConfigInputFreq=upsConfigInputFreq, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullControlGroup=upsFullControlGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsRebootWithDuration=upsRebootWithDuration, upsFullInputGroup=upsFullInputGroup, upsAlarmId=upsAlarmId, upsBasicGroups=upsBasicGroups, upsOutputNumLines=upsOutputNumLines, upsAlarmFanFailure=upsAlarmFanFailure, upsInputLineIndex=upsInputLineIndex, upsAlarmOnBattery=upsAlarmOnBattery, upsBypassPower=upsBypassPower, upsControl=upsControl, upsFullTestGroup=upsFullTestGroup, upsBypass=upsBypass, upsTestSpinLock=upsTestSpinLock, upsAlarmsPresent=upsAlarmsPresent, upsAlarmOutputOverload=upsAlarmOutputOverload, upsCompliances=upsCompliances, upsSubsetCompliance=upsSubsetCompliance, upsTestElapsedTime=upsTestElapsedTime, upsBasicOutputGroup=upsBasicOutputGroup, upsInputLineBads=upsInputLineBads, upsOutputFrequency=upsOutputFrequency, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTestResultsSummary=upsTestResultsSummary, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBypassTable=upsBypassTable, upsConformance=upsConformance, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTraps=upsTraps, upsOutput=upsOutput, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarm=upsAlarm, upsBatteryStatus=upsBatteryStatus, upsInputVoltage=upsInputVoltage, upsAlarmOnBypass=upsAlarmOnBypass, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsWellKnownTests=upsWellKnownTests, upsIdentModel=upsIdentModel, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, NonNegativeInteger=NonNegativeInteger, upsObjects=upsObjects, upsBasicInputGroup=upsBasicInputGroup, upsOutputEntry=upsOutputEntry, PositiveInteger=PositiveInteger, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBasicIdentGroup=upsBasicIdentGroup, upsBypassFrequency=upsBypassFrequency, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsFullBypassGroup=upsFullBypassGroup, upsAlarmTime=upsAlarmTime, upsMIB=upsMIB, upsFullConfigGroup=upsFullConfigGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmGeneralFault=upsAlarmGeneralFault, upsInputNumLines=upsInputNumLines, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTestStartTime=upsTestStartTime)
