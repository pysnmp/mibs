...
# Produced by pysmi-1.1.8 at Thu Oct 26 09:55:18 2023
...
ObjectIdentity, Gauge32, NotificationType, IpAddress, ModuleIdentity, Integer32, Unsigned32, iso, Counter64, Bits, MibIdentifier, mib_2, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "NotificationType", "IpAddress", "ModuleIdentity", "Integer32", "Unsigned32", "iso", "Counter64", "Bits", "MibIdentifier", "mib-2", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("UPS-MIB", upsBypassFrequency=upsBypassFrequency, upsAlarmTestInProgress=upsAlarmTestInProgress, upsInputFrequency=upsInputFrequency, upsBasicIdentGroup=upsBasicIdentGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsOutputLineIndex=upsOutputLineIndex, upsBypass=upsBypass, upsShutdownAfterDelay=upsShutdownAfterDelay, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsOutputSource=upsOutputSource, upsWellKnownTests=upsWellKnownTests, upsMIB=upsMIB, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsInputCurrent=upsInputCurrent, upsBypassCurrent=upsBypassCurrent, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmOutputOverload=upsAlarmOutputOverload, upsFullGroups=upsFullGroups, upsTraps=upsTraps, upsAlarmsPresent=upsAlarmsPresent, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsSubsetCompliance=upsSubsetCompliance, upsOutputFrequency=upsOutputFrequency, upsBatteryVoltage=upsBatteryVoltage, upsBypassTable=upsBypassTable, upsOutputEntry=upsOutputEntry, upsAlarmEntry=upsAlarmEntry, upsCompliances=upsCompliances, upsFullAlarmGroup=upsFullAlarmGroup, upsOutputVoltage=upsOutputVoltage, NonNegativeInteger=NonNegativeInteger, PYSNMP_MODULE_ID=upsMIB, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsSubsetInputGroup=upsSubsetInputGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBasicTestGroup=upsBasicTestGroup, upsBasicGroups=upsBasicGroups, upsInputLineBads=upsInputLineBads, upsInputVoltage=upsInputVoltage, upsAlarmFanFailure=upsAlarmFanFailure, upsIdentManufacturer=upsIdentManufacturer, upsInputTable=upsInputTable, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBasicAlarmGroup=upsBasicAlarmGroup, upsFullConfigGroup=upsFullConfigGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsWellKnownAlarms=upsWellKnownAlarms, upsConfig=upsConfig, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmTempBad=upsAlarmTempBad, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmId=upsAlarmId, upsBypassPower=upsBypassPower, upsAlarmChargerFailed=upsAlarmChargerFailed, upsFullTestGroup=upsFullTestGroup, upsBattery=upsBattery, upsBatteryTemperature=upsBatteryTemperature, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsOutput=upsOutput, upsControl=upsControl, upsBasicBypassGroup=upsBasicBypassGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmBatteryBad=upsAlarmBatteryBad, upsFullBypassGroup=upsFullBypassGroup, upsBatteryStatus=upsBatteryStatus, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsTestSpinLock=upsTestSpinLock, upsSecondsOnBattery=upsSecondsOnBattery, upsConfigOutputPower=upsConfigOutputPower, upsOutputTable=upsOutputTable, upsConfigOutputVoltage=upsConfigOutputVoltage, upsFullIdentGroup=upsFullIdentGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsShutdownType=upsShutdownType, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsConfigLowBattTime=upsConfigLowBattTime, PositiveInteger=PositiveInteger, upsGroups=upsGroups, upsTrapOnBattery=upsTrapOnBattery, upsSubsetGroups=upsSubsetGroups, upsBasicInputGroup=upsBasicInputGroup, upsOutputPower=upsOutputPower, upsAlarmOnBypass=upsAlarmOnBypass, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBasicControlGroup=upsBasicControlGroup, upsRebootWithDuration=upsRebootWithDuration, upsBatteryCurrent=upsBatteryCurrent, upsConfigAudibleStatus=upsConfigAudibleStatus, upsFullCompliance=upsFullCompliance, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAutoRestart=upsAutoRestart, upsTrapTestCompleted=upsTrapTestCompleted, upsTestResultsSummary=upsTestResultsSummary, upsFullControlGroup=upsFullControlGroup, upsBypassEntry=upsBypassEntry, upsIdentModel=upsIdentModel, upsAlarmFuseFailure=upsAlarmFuseFailure, upsConfigInputFreq=upsConfigInputFreq, upsTestStartTime=upsTestStartTime, upsSubsetIdentGroup=upsSubsetIdentGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmTable=upsAlarmTable, upsBypassVoltage=upsBypassVoltage, upsConformance=upsConformance, upsInputNumLines=upsInputNumLines, upsIdentName=upsIdentName, upsFullInputGroup=upsFullInputGroup, upsInputEntry=upsInputEntry, upsAlarmOnBattery=upsAlarmOnBattery, upsOutputNumLines=upsOutputNumLines, upsBypassLineIndex=upsBypassLineIndex, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutputCurrent=upsOutputCurrent, upsAlarmBypassBad=upsAlarmBypassBad, upsObjects=upsObjects, upsBypassNumLines=upsBypassNumLines, upsIdent=upsIdent, upsTestId=upsTestId, upsTest=upsTest, upsTestElapsedTime=upsTestElapsedTime, upsBasicOutputGroup=upsBasicOutputGroup, upsFullOutputGroup=upsFullOutputGroup, upsAlarm=upsAlarm, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmDescr=upsAlarmDescr, upsAlarmInputBad=upsAlarmInputBad, upsInput=upsInput, upsInputLineIndex=upsInputLineIndex, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmTime=upsAlarmTime, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBasicCompliance=upsBasicCompliance, upsOutputPercentLoad=upsOutputPercentLoad, upsConfigOutputVA=upsConfigOutputVA, upsTestResultsDetail=upsTestResultsDetail, upsInputTruePower=upsInputTruePower, upsAlarmOutputBad=upsAlarmOutputBad)
