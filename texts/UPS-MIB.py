...
# Produced by pysmi-1.1.8 at Thu Apr 27 09:55:45 2023
...
Counter32, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, Integer32, MibIdentifier, TimeTicks, mib_2, Gauge32, iso, NotificationType, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "Integer32", "MibIdentifier", "TimeTicks", "mib-2", "Gauge32", "iso", "NotificationType", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("UPS-MIB", upsMIB=upsMIB, upsBasicTestGroup=upsBasicTestGroup, upsInputTable=upsInputTable, upsSubsetControlGroup=upsSubsetControlGroup, upsInputLineBads=upsInputLineBads, PositiveInteger=PositiveInteger, upsWellKnownTests=upsWellKnownTests, upsConfigOutputPower=upsConfigOutputPower, upsOutputVoltage=upsOutputVoltage, upsAlarmTempBad=upsAlarmTempBad, upsTestResultsDetail=upsTestResultsDetail, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsTestSpinLock=upsTestSpinLock, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmId=upsAlarmId, upsTestStartTime=upsTestStartTime, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConformance=upsConformance, upsAlarmDescr=upsAlarmDescr, upsSubsetInputGroup=upsSubsetInputGroup, upsShutdownType=upsShutdownType, upsRebootWithDuration=upsRebootWithDuration, upsCompliances=upsCompliances, upsFullControlGroup=upsFullControlGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBasicInputGroup=upsBasicInputGroup, upsAlarmsPresent=upsAlarmsPresent, upsBypassLineIndex=upsBypassLineIndex, upsFullTestGroup=upsFullTestGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmLowBattery=upsAlarmLowBattery, upsBatteryTemperature=upsBatteryTemperature, upsControl=upsControl, upsFullInputGroup=upsFullInputGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsTestElapsedTime=upsTestElapsedTime, upsInputCurrent=upsInputCurrent, upsFullConfigGroup=upsFullConfigGroup, upsBypass=upsBypass, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsIdent=upsIdent, upsOutput=upsOutput, upsTestId=upsTestId, upsAlarmTable=upsAlarmTable, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsOutputSource=upsOutputSource, upsSubsetIdentGroup=upsSubsetIdentGroup, PYSNMP_MODULE_ID=upsMIB, upsIdentModel=upsIdentModel, upsAlarmEntry=upsAlarmEntry, upsBasicControlGroup=upsBasicControlGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsInputFrequency=upsInputFrequency, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBasicAlarmGroup=upsBasicAlarmGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmInputBad=upsAlarmInputBad, upsBattery=upsBattery, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBypassTable=upsBypassTable, upsAutoRestart=upsAutoRestart, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsSubsetGroups=upsSubsetGroups, upsInputVoltage=upsInputVoltage, upsBasicOutputGroup=upsBasicOutputGroup, upsBatteryVoltage=upsBatteryVoltage, upsBypassPower=upsBypassPower, upsStartupAfterDelay=upsStartupAfterDelay, upsOutputTable=upsOutputTable, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsOutputEntry=upsOutputEntry, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsFullBypassGroup=upsFullBypassGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBypassCurrent=upsBypassCurrent, upsWellKnownAlarms=upsWellKnownAlarms, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigOutputVA=upsConfigOutputVA, upsBasicIdentGroup=upsBasicIdentGroup, upsTraps=upsTraps, upsConfigAudibleStatus=upsConfigAudibleStatus, upsSecondsOnBattery=upsSecondsOnBattery, upsInput=upsInput, upsSubsetOutputGroup=upsSubsetOutputGroup, upsInputNumLines=upsInputNumLines, upsTrapOnBattery=upsTrapOnBattery, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBasicGroups=upsBasicGroups, upsFullIdentGroup=upsFullIdentGroup, upsTestResultsSummary=upsTestResultsSummary, upsConfigInputVoltage=upsConfigInputVoltage, upsBatteryStatus=upsBatteryStatus, upsAlarmBypassBad=upsAlarmBypassBad, upsConfig=upsConfig, upsInputEntry=upsInputEntry, upsFullBatteryGroup=upsFullBatteryGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsOutputPower=upsOutputPower, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarm=upsAlarm, upsTest=upsTest, upsConfigInputFreq=upsConfigInputFreq, upsConfigOutputVoltage=upsConfigOutputVoltage, upsIdentManufacturer=upsIdentManufacturer, upsOutputNumLines=upsOutputNumLines, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBasicCompliance=upsBasicCompliance, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsInputTruePower=upsInputTruePower, upsOutputPercentLoad=upsOutputPercentLoad, upsFullOutputGroup=upsFullOutputGroup, upsFullGroups=upsFullGroups, NonNegativeInteger=NonNegativeInteger, upsBypassFrequency=upsBypassFrequency, upsConfigLowBattTime=upsConfigLowBattTime, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBypassEntry=upsBypassEntry, upsInputLineIndex=upsInputLineIndex, upsGroups=upsGroups, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBypassVoltage=upsBypassVoltage, upsSubsetCompliance=upsSubsetCompliance, upsOutputFrequency=upsOutputFrequency, upsBypassNumLines=upsBypassNumLines, upsBatteryCurrent=upsBatteryCurrent, upsObjects=upsObjects, upsOutputLineIndex=upsOutputLineIndex, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsOutputCurrent=upsOutputCurrent, upsIdentName=upsIdentName, upsAlarmTime=upsAlarmTime, upsAlarmGeneralFault=upsAlarmGeneralFault, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfigOutputFreq=upsConfigOutputFreq, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmOutputBad=upsAlarmOutputBad, upsFullCompliance=upsFullCompliance, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested)
