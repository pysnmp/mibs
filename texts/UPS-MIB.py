...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:29:30 2023
...
MibIdentifier, Bits, ObjectIdentity, Unsigned32, ModuleIdentity, NotificationType, iso, Gauge32, Counter32, mib_2, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "NotificationType", "iso", "Gauge32", "Counter32", "mib-2", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmShutdownPending=upsAlarmShutdownPending, upsInputTruePower=upsInputTruePower, upsIdentManufacturer=upsIdentManufacturer, upsOutputPower=upsOutputPower, upsBypassPower=upsBypassPower, upsBasicBypassGroup=upsBasicBypassGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmsPresent=upsAlarmsPresent, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsConfigInputFreq=upsConfigInputFreq, upsBypassNumLines=upsBypassNumLines, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsRebootWithDuration=upsRebootWithDuration, upsAutoRestart=upsAutoRestart, upsAlarmBypassBad=upsAlarmBypassBad, NonNegativeInteger=NonNegativeInteger, upsTest=upsTest, upsBypassEntry=upsBypassEntry, upsFullConfigGroup=upsFullConfigGroup, upsBypassVoltage=upsBypassVoltage, upsControl=upsControl, upsTestResultsSummary=upsTestResultsSummary, upsFullAlarmGroup=upsFullAlarmGroup, upsBypassFrequency=upsBypassFrequency, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmOutputOverload=upsAlarmOutputOverload, upsInputCurrent=upsInputCurrent, upsBypassLineIndex=upsBypassLineIndex, upsAlarmTestInProgress=upsAlarmTestInProgress, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsConformance=upsConformance, upsInputFrequency=upsInputFrequency, upsSubsetControlGroup=upsSubsetControlGroup, upsOutputSource=upsOutputSource, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmOutputBad=upsAlarmOutputBad, upsBypass=upsBypass, upsIdent=upsIdent, upsBattery=upsBattery, upsAlarmFanFailure=upsAlarmFanFailure, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsOutput=upsOutput, upsConfig=upsConfig, upsTestId=upsTestId, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBasicCompliance=upsBasicCompliance, upsOutputVoltage=upsOutputVoltage, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsSubsetGroups=upsSubsetGroups, upsShutdownType=upsShutdownType, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsOutputFrequency=upsOutputFrequency, upsSecondsOnBattery=upsSecondsOnBattery, upsIdentModel=upsIdentModel, upsOutputPercentLoad=upsOutputPercentLoad, upsInputLineIndex=upsInputLineIndex, upsWellKnownTests=upsWellKnownTests, upsTestStartTime=upsTestStartTime, upsBatteryVoltage=upsBatteryVoltage, upsAlarmDescr=upsAlarmDescr, upsFullBatteryGroup=upsFullBatteryGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmTime=upsAlarmTime, upsConfigOutputVoltage=upsConfigOutputVoltage, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsTestResultsDetail=upsTestResultsDetail, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, PositiveInteger=PositiveInteger, upsTestElapsedTime=upsTestElapsedTime, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmInputBad=upsAlarmInputBad, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsFullControlGroup=upsFullControlGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsOutputNumLines=upsOutputNumLines, upsBasicInputGroup=upsBasicInputGroup, upsOutputEntry=upsOutputEntry, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsSubsetCompliance=upsSubsetCompliance, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmTable=upsAlarmTable, upsFullIdentGroup=upsFullIdentGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsTraps=upsTraps, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullGroups=upsFullGroups, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsInputTable=upsInputTable, upsBasicBatteryGroup=upsBasicBatteryGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmId=upsAlarmId, upsConfigOutputPower=upsConfigOutputPower, upsInputEntry=upsInputEntry, upsTrapTestCompleted=upsTrapTestCompleted, upsConfigOutputVA=upsConfigOutputVA, upsConfigLowBattTime=upsConfigLowBattTime, upsSubsetInputGroup=upsSubsetInputGroup, upsTestSpinLock=upsTestSpinLock, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsInputLineBads=upsInputLineBads, upsAlarmFuseFailure=upsAlarmFuseFailure, upsObjects=upsObjects, PYSNMP_MODULE_ID=upsMIB, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBasicControlGroup=upsBasicControlGroup, upsCompliances=upsCompliances, upsGroups=upsGroups, upsOutputCurrent=upsOutputCurrent, upsInputVoltage=upsInputVoltage, upsOutputLineIndex=upsOutputLineIndex, upsOutputTable=upsOutputTable, upsFullBypassGroup=upsFullBypassGroup, upsAlarm=upsAlarm, upsBypassTable=upsBypassTable, upsBatteryTemperature=upsBatteryTemperature, upsAlarmLowBattery=upsAlarmLowBattery, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmOnBypass=upsAlarmOnBypass, upsWellKnownAlarms=upsWellKnownAlarms, upsFullTestGroup=upsFullTestGroup, upsFullCompliance=upsFullCompliance, upsIdentName=upsIdentName, upsBasicIdentGroup=upsBasicIdentGroup, upsFullInputGroup=upsFullInputGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsFullOutputGroup=upsFullOutputGroup, upsAlarmEntry=upsAlarmEntry, upsBypassCurrent=upsBypassCurrent, upsBasicTestGroup=upsBasicTestGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmTempBad=upsAlarmTempBad, upsBatteryStatus=upsBatteryStatus, upsInputNumLines=upsInputNumLines, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBatteryCurrent=upsBatteryCurrent, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsMIB=upsMIB, upsTrapOnBattery=upsTrapOnBattery, upsBasicGroups=upsBasicGroups, upsInput=upsInput)
