...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsWellKnownTests=upsWellKnownTests, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsSubsetGroups=upsSubsetGroups, upsFullControlGroup=upsFullControlGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTestResultsDetail=upsTestResultsDetail, upsTraps=upsTraps, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsInputNumLines=upsInputNumLines, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsOutputNumLines=upsOutputNumLines, upsBypassTable=upsBypassTable, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBasicCompliance=upsBasicCompliance, upsOutput=upsOutput, upsConfigLowBattTime=upsConfigLowBattTime, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullGroups=upsFullGroups, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBasicGroups=upsBasicGroups, upsConformance=upsConformance, upsFullAlarmGroup=upsFullAlarmGroup, upsConfigInputFreq=upsConfigInputFreq, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmEntry=upsAlarmEntry, upsAlarmDescr=upsAlarmDescr, upsBypassNumLines=upsBypassNumLines, upsAlarmTime=upsAlarmTime, upsBasicTestGroup=upsBasicTestGroup, upsBypassLineIndex=upsBypassLineIndex, upsAlarmLowBattery=upsAlarmLowBattery, upsInputTruePower=upsInputTruePower, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmFanFailure=upsAlarmFanFailure, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmTempBad=upsAlarmTempBad, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsConfigOutputVA=upsConfigOutputVA, upsInputEntry=upsInputEntry, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBypassPower=upsBypassPower, upsConfigOutputFreq=upsConfigOutputFreq, NonNegativeInteger=NonNegativeInteger, upsBasicBypassGroup=upsBasicBypassGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsObjects=upsObjects, upsFullCompliance=upsFullCompliance, upsBattery=upsBattery, upsFullConfigGroup=upsFullConfigGroup, upsIdentManufacturer=upsIdentManufacturer, upsFullInputGroup=upsFullInputGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutputTable=upsOutputTable, upsAlarmTable=upsAlarmTable, upsInputLineBads=upsInputLineBads, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBypass=upsBypass, upsOutputSource=upsOutputSource, upsBatteryVoltage=upsBatteryVoltage, upsCompliances=upsCompliances, upsAutoRestart=upsAutoRestart, upsTrapOnBattery=upsTrapOnBattery, upsAlarm=upsAlarm, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsSubsetControlGroup=upsSubsetControlGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmsPresent=upsAlarmsPresent, PositiveInteger=PositiveInteger, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestStartTime=upsTestStartTime, upsFullIdentGroup=upsFullIdentGroup, upsControl=upsControl, upsMIB=upsMIB, upsConfigInputVoltage=upsConfigInputVoltage, upsShutdownType=upsShutdownType, upsConfigOutputPower=upsConfigOutputPower, upsTestResultsSummary=upsTestResultsSummary, upsBasicAlarmGroup=upsBasicAlarmGroup, upsFullTestGroup=upsFullTestGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTestId=upsTestId, upsTrapTestCompleted=upsTrapTestCompleted, upsOutputCurrent=upsOutputCurrent, upsOutputEntry=upsOutputEntry, upsSubsetIdentGroup=upsSubsetIdentGroup, upsOutputPower=upsOutputPower, upsBypassVoltage=upsBypassVoltage, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsFullOutputGroup=upsFullOutputGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsInputVoltage=upsInputVoltage, upsRebootWithDuration=upsRebootWithDuration, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsIdentName=upsIdentName, upsBypassCurrent=upsBypassCurrent, upsGroups=upsGroups, upsBasicIdentGroup=upsBasicIdentGroup, upsBasicControlGroup=upsBasicControlGroup, upsOutputFrequency=upsOutputFrequency, upsInput=upsInput, upsIdentModel=upsIdentModel, upsSubsetCompliance=upsSubsetCompliance, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBatteryStatus=upsBatteryStatus, upsBatteryCurrent=upsBatteryCurrent, upsOutputLineIndex=upsOutputLineIndex, upsOutputVoltage=upsOutputVoltage, upsBypassFrequency=upsBypassFrequency, upsOutputPercentLoad=upsOutputPercentLoad, upsSubsetOutputGroup=upsSubsetOutputGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmInputBad=upsAlarmInputBad, upsFullBatteryGroup=upsFullBatteryGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsBasicInputGroup=upsBasicInputGroup, upsBatteryTemperature=upsBatteryTemperature, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsInputFrequency=upsInputFrequency, upsStartupAfterDelay=upsStartupAfterDelay, upsFullBypassGroup=upsFullBypassGroup, upsInputCurrent=upsInputCurrent, upsIdent=upsIdent, upsBypassEntry=upsBypassEntry, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTestNoTestsInitiated=upsTestNoTestsInitiated, PYSNMP_MODULE_ID=upsMIB, upsTestSpinLock=upsTestSpinLock, upsInputTable=upsInputTable, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmId=upsAlarmId, upsAlarmShutdownPending=upsAlarmShutdownPending, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsTest=upsTest, upsTestElapsedTime=upsTestElapsedTime, upsInputLineIndex=upsInputLineIndex, upsConfig=upsConfig)
