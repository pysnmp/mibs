...
mibBuilder.exportSymbols("UPS-MIB", upsTestElapsedTime=upsTestElapsedTime, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmDescr=upsAlarmDescr, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBypassEntry=upsBypassEntry, upsOutputEntry=upsOutputEntry, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBattery=upsBattery, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmLowBattery=upsAlarmLowBattery, NonNegativeInteger=NonNegativeInteger, upsFullIdentGroup=upsFullIdentGroup, upsOutputSource=upsOutputSource, upsOutputNumLines=upsOutputNumLines, upsAlarm=upsAlarm, PYSNMP_MODULE_ID=upsMIB, upsAlarmChargerFailed=upsAlarmChargerFailed, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsSubsetGroups=upsSubsetGroups, upsTestSpinLock=upsTestSpinLock, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsConfigInputFreq=upsConfigInputFreq, upsCompliances=upsCompliances, upsInputTruePower=upsInputTruePower, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmFuseFailure=upsAlarmFuseFailure, upsConfigOutputPower=upsConfigOutputPower, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBatteryTemperature=upsBatteryTemperature, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBasicControlGroup=upsBasicControlGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsConfigInputVoltage=upsConfigInputVoltage, upsIdentName=upsIdentName, upsAlarmEntry=upsAlarmEntry, upsAlarmTime=upsAlarmTime, upsAlarmOnBypass=upsAlarmOnBypass, upsOutputFrequency=upsOutputFrequency, upsBasicOutputGroup=upsBasicOutputGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsFullInputGroup=upsFullInputGroup, upsAlarmsPresent=upsAlarmsPresent, upsTestStartTime=upsTestStartTime, upsBasicBypassGroup=upsBasicBypassGroup, upsGroups=upsGroups, upsOutputCurrent=upsOutputCurrent, upsBypass=upsBypass, upsIdentManufacturer=upsIdentManufacturer, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBypassTable=upsBypassTable, upsAlarmFanFailure=upsAlarmFanFailure, upsBypassFrequency=upsBypassFrequency, upsAlarmTempBad=upsAlarmTempBad, upsFullConfigGroup=upsFullConfigGroup, upsRebootWithDuration=upsRebootWithDuration, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmInputBad=upsAlarmInputBad, upsInputNumLines=upsInputNumLines, PositiveInteger=PositiveInteger, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsInputCurrent=upsInputCurrent, upsAlarmTable=upsAlarmTable, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsFullTestGroup=upsFullTestGroup, upsTestResultsSummary=upsTestResultsSummary, upsControl=upsControl, upsIdent=upsIdent, upsBasicTestGroup=upsBasicTestGroup, upsFullOutputGroup=upsFullOutputGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsInputLineIndex=upsInputLineIndex, upsBypassCurrent=upsBypassCurrent, upsBypassNumLines=upsBypassNumLines, upsWellKnownTests=upsWellKnownTests, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsFullBatteryGroup=upsFullBatteryGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsTraps=upsTraps, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBasicInputGroup=upsBasicInputGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsInputTable=upsInputTable, upsTrapOnBattery=upsTrapOnBattery, upsFullCompliance=upsFullCompliance, upsInputEntry=upsInputEntry, upsAlarmBypassBad=upsAlarmBypassBad, upsBatteryVoltage=upsBatteryVoltage, upsIdentModel=upsIdentModel, upsOutputVoltage=upsOutputVoltage, upsBypassLineIndex=upsBypassLineIndex, upsBasicCompliance=upsBasicCompliance, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmId=upsAlarmId, upsWellKnownAlarms=upsWellKnownAlarms, upsFullGroups=upsFullGroups, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsInput=upsInput, upsShutdownType=upsShutdownType, upsFullBypassGroup=upsFullBypassGroup, upsOutputTable=upsOutputTable, upsBatteryCurrent=upsBatteryCurrent, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBatteryStatus=upsBatteryStatus, upsBasicGroups=upsBasicGroups, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBypassPower=upsBypassPower, upsInputFrequency=upsInputFrequency, upsSecondsOnBattery=upsSecondsOnBattery, upsObjects=upsObjects, upsTrapTestCompleted=upsTrapTestCompleted, upsAutoRestart=upsAutoRestart, upsConformance=upsConformance, upsTestResultsDetail=upsTestResultsDetail, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsOutputPower=upsOutputPower, upsTest=upsTest, upsAlarmOutputBad=upsAlarmOutputBad, upsConfigOutputVA=upsConfigOutputVA, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBasicConfigGroup=upsBasicConfigGroup, upsOutputLineIndex=upsOutputLineIndex, upsBypassVoltage=upsBypassVoltage, upsSubsetCompliance=upsSubsetCompliance, upsAlarmOnBattery=upsAlarmOnBattery, upsMIB=upsMIB, upsSubsetInputGroup=upsSubsetInputGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsInputLineBads=upsInputLineBads, upsInputVoltage=upsInputVoltage, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsOutput=upsOutput, upsConfig=upsConfig, upsAlarmTestInProgress=upsAlarmTestInProgress, upsFullControlGroup=upsFullControlGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsTestId=upsTestId)
