...
mibBuilder.exportSymbols("UPS-MIB", upsOutputFrequency=upsOutputFrequency, upsConfigOutputPower=upsConfigOutputPower, upsIdentName=upsIdentName, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBypassLineIndex=upsBypassLineIndex, upsFullIdentGroup=upsFullIdentGroup, upsTest=upsTest, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBypassTable=upsBypassTable, upsIdentAttachedDevices=upsIdentAttachedDevices, upsOutputEntry=upsOutputEntry, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsSubsetIdentGroup=upsSubsetIdentGroup, upsOutputSource=upsOutputSource, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsMIB=upsMIB, upsWellKnownTests=upsWellKnownTests, upsInputTable=upsInputTable, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsCompliances=upsCompliances, upsAlarmFuseFailure=upsAlarmFuseFailure, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBasicIdentGroup=upsBasicIdentGroup, upsFullConfigGroup=upsFullConfigGroup, upsBypassCurrent=upsBypassCurrent, upsShutdownType=upsShutdownType, upsStartupAfterDelay=upsStartupAfterDelay, upsSubsetGroups=upsSubsetGroups, upsTestResultsSummary=upsTestResultsSummary, upsBatteryStatus=upsBatteryStatus, upsAlarmDescr=upsAlarmDescr, upsTrapOnBattery=upsTrapOnBattery, upsOutput=upsOutput, upsAlarmTempBad=upsAlarmTempBad, upsAlarmOutputBad=upsAlarmOutputBad, upsIdent=upsIdent, upsInputVoltage=upsInputVoltage, upsConfigOutputVoltage=upsConfigOutputVoltage, upsWellKnownAlarms=upsWellKnownAlarms, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmOutputOverload=upsAlarmOutputOverload, upsOutputPower=upsOutputPower, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBasicControlGroup=upsBasicControlGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsFullCompliance=upsFullCompliance, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmInputBad=upsAlarmInputBad, upsTestSpinLock=upsTestSpinLock, upsInputNumLines=upsInputNumLines, upsConfigOutputVA=upsConfigOutputVA, upsOutputTable=upsOutputTable, upsFullOutputGroup=upsFullOutputGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsConfigInputFreq=upsConfigInputFreq, upsAlarm=upsAlarm, upsFullAlarmGroup=upsFullAlarmGroup, upsBasicCompliance=upsBasicCompliance, upsInputLineIndex=upsInputLineIndex, upsBatteryTemperature=upsBatteryTemperature, upsSubsetInputGroup=upsSubsetInputGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsRebootWithDuration=upsRebootWithDuration, upsBasicInputGroup=upsBasicInputGroup, PYSNMP_MODULE_ID=upsMIB, upsBypassVoltage=upsBypassVoltage, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTestResultsDetail=upsTestResultsDetail, upsBypass=upsBypass, PositiveInteger=PositiveInteger, upsFullControlGroup=upsFullControlGroup, upsAlarmId=upsAlarmId, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBatteryVoltage=upsBatteryVoltage, upsObjects=upsObjects, upsInput=upsInput, upsInputEntry=upsInputEntry, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTrapTestCompleted=upsTrapTestCompleted, upsBypassEntry=upsBypassEntry, upsConformance=upsConformance, upsTestElapsedTime=upsTestElapsedTime, upsIdentModel=upsIdentModel, upsFullGroups=upsFullGroups, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsOutputNumLines=upsOutputNumLines, upsOutputCurrent=upsOutputCurrent, upsAlarmChargerFailed=upsAlarmChargerFailed, upsFullTestGroup=upsFullTestGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmTime=upsAlarmTime, upsTestStartTime=upsTestStartTime, upsOutputLineIndex=upsOutputLineIndex, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsFullInputGroup=upsFullInputGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBattery=upsBattery, upsConfigLowBattTime=upsConfigLowBattTime, upsIdentManufacturer=upsIdentManufacturer, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBasicGroups=upsBasicGroups, upsBatteryCurrent=upsBatteryCurrent, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBypassNumLines=upsBypassNumLines, upsTestId=upsTestId, upsAutoRestart=upsAutoRestart, upsAlarmTable=upsAlarmTable, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmFanFailure=upsAlarmFanFailure, upsControl=upsControl, upsInputTruePower=upsInputTruePower, upsAlarmEntry=upsAlarmEntry, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBypassPower=upsBypassPower, upsSubsetCompliance=upsSubsetCompliance, upsInputCurrent=upsInputCurrent, upsInputLineBads=upsInputLineBads, upsGroups=upsGroups, upsOutputPercentLoad=upsOutputPercentLoad, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsFullBypassGroup=upsFullBypassGroup, upsBypassFrequency=upsBypassFrequency, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsOutputVoltage=upsOutputVoltage, upsTraps=upsTraps, upsInputFrequency=upsInputFrequency, NonNegativeInteger=NonNegativeInteger, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBasicTestGroup=upsBasicTestGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmsPresent=upsAlarmsPresent, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBasicBypassGroup=upsBasicBypassGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsConfig=upsConfig)
