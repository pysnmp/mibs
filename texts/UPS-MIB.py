...
mibBuilder.exportSymbols("UPS-MIB", upsShutdownAfterDelay=upsShutdownAfterDelay, upsSubsetIdentGroup=upsSubsetIdentGroup, upsConfigOutputPower=upsConfigOutputPower, upsOutputCurrent=upsOutputCurrent, upsWellKnownAlarms=upsWellKnownAlarms, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsFullCompliance=upsFullCompliance, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBasicTestGroup=upsBasicTestGroup, upsOutputFrequency=upsOutputFrequency, upsTestResultsSummary=upsTestResultsSummary, upsBypassCurrent=upsBypassCurrent, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBatteryVoltage=upsBatteryVoltage, upsSubsetOutputGroup=upsSubsetOutputGroup, PYSNMP_MODULE_ID=upsMIB, upsAlarmBatteryBad=upsAlarmBatteryBad, upsOutputNumLines=upsOutputNumLines, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTrapTestCompleted=upsTrapTestCompleted, upsCompliances=upsCompliances, upsAlarmTempBad=upsAlarmTempBad, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmInputBad=upsAlarmInputBad, upsBasicGroups=upsBasicGroups, upsFullConfigGroup=upsFullConfigGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsOutputEntry=upsOutputEntry, upsBasicConfigGroup=upsBasicConfigGroup, upsTestResultsDetail=upsTestResultsDetail, upsBypassLineIndex=upsBypassLineIndex, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsIdentManufacturer=upsIdentManufacturer, upsTrapOnBattery=upsTrapOnBattery, upsBypassFrequency=upsBypassFrequency, upsAlarmFanFailure=upsAlarmFanFailure, upsInputTruePower=upsInputTruePower, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarm=upsAlarm, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmEntry=upsAlarmEntry, upsAlarmOnBattery=upsAlarmOnBattery, upsOutputTable=upsOutputTable, upsTestElapsedTime=upsTestElapsedTime, upsBatteryTemperature=upsBatteryTemperature, upsConfigOutputFreq=upsConfigOutputFreq, upsInputEntry=upsInputEntry, upsAlarmOutputOverload=upsAlarmOutputOverload, upsSubsetGroups=upsSubsetGroups, upsAlarmLowBattery=upsAlarmLowBattery, upsOutputPower=upsOutputPower, upsMIB=upsMIB, upsBasicInputGroup=upsBasicInputGroup, upsInputTable=upsInputTable, upsBypass=upsBypass, upsIdent=upsIdent, upsFullTestGroup=upsFullTestGroup, upsInputVoltage=upsInputVoltage, upsFullBatteryGroup=upsFullBatteryGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmsPresent=upsAlarmsPresent, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmFuseFailure=upsAlarmFuseFailure, upsOutputSource=upsOutputSource, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsRebootWithDuration=upsRebootWithDuration, upsAutoRestart=upsAutoRestart, upsTest=upsTest, upsBypassTable=upsBypassTable, upsAlarmTable=upsAlarmTable, upsStartupAfterDelay=upsStartupAfterDelay, upsGroups=upsGroups, upsBypassVoltage=upsBypassVoltage, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsBasicBatteryGroup=upsBasicBatteryGroup, upsWellKnownTests=upsWellKnownTests, upsOutputLineIndex=upsOutputLineIndex, upsConfigLowBattTime=upsConfigLowBattTime, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsConfigInputFreq=upsConfigInputFreq, upsOutputPercentLoad=upsOutputPercentLoad, upsIdentModel=upsIdentModel, upsAlarmChargerFailed=upsAlarmChargerFailed, upsFullInputGroup=upsFullInputGroup, upsInputNumLines=upsInputNumLines, upsInputLineBads=upsInputLineBads, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsSubsetCompliance=upsSubsetCompliance, upsFullGroups=upsFullGroups, upsFullControlGroup=upsFullControlGroup, upsBypassPower=upsBypassPower, upsConfigInputVoltage=upsConfigInputVoltage, upsBasicIdentGroup=upsBasicIdentGroup, upsBatteryCurrent=upsBatteryCurrent, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsIdentName=upsIdentName, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsObjects=upsObjects, upsTestId=upsTestId, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBasicCompliance=upsBasicCompliance, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmTime=upsAlarmTime, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsControl=upsControl, upsBasicOutputGroup=upsBasicOutputGroup, upsInputFrequency=upsInputFrequency, upsConfigOutputVA=upsConfigOutputVA, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, NonNegativeInteger=NonNegativeInteger, upsFullIdentGroup=upsFullIdentGroup, upsConfig=upsConfig, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsFullOutputGroup=upsFullOutputGroup, upsOutput=upsOutput, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTraps=upsTraps, upsInput=upsInput, upsAlarmDescr=upsAlarmDescr, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsShutdownType=upsShutdownType, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBasicControlGroup=upsBasicControlGroup, upsTestSpinLock=upsTestSpinLock, upsTestStartTime=upsTestStartTime, upsAlarmId=upsAlarmId, upsFullBypassGroup=upsFullBypassGroup, upsInputLineIndex=upsInputLineIndex, upsBattery=upsBattery, PositiveInteger=PositiveInteger, upsIdentAttachedDevices=upsIdentAttachedDevices, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBatteryStatus=upsBatteryStatus, upsOutputVoltage=upsOutputVoltage, upsSubsetControlGroup=upsSubsetControlGroup, upsInputCurrent=upsInputCurrent, upsFullAlarmGroup=upsFullAlarmGroup, upsConformance=upsConformance, upsBypassEntry=upsBypassEntry, upsBypassNumLines=upsBypassNumLines, upsAlarmShutdownPending=upsAlarmShutdownPending, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmTestInProgress=upsAlarmTestInProgress)
