...
mibBuilder.exportSymbols("UPS-MIB", NonNegativeInteger=NonNegativeInteger, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutputFrequency=upsOutputFrequency, upsInputVoltage=upsInputVoltage, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBypassEntry=upsBypassEntry, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmChargerFailed=upsAlarmChargerFailed, upsOutputSource=upsOutputSource, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmTable=upsAlarmTable, upsInputFrequency=upsInputFrequency, upsSubsetIdentGroup=upsSubsetIdentGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutputEntry=upsOutputEntry, upsBypassPower=upsBypassPower, upsFullTestGroup=upsFullTestGroup, upsFullBypassGroup=upsFullBypassGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmOnBypass=upsAlarmOnBypass, upsInputLineIndex=upsInputLineIndex, upsAlarmOutputBad=upsAlarmOutputBad, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigOutputPower=upsConfigOutputPower, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBasicGroups=upsBasicGroups, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBasicOutputGroup=upsBasicOutputGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsIdentName=upsIdentName, upsConfig=upsConfig, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBatteryTemperature=upsBatteryTemperature, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmsPresent=upsAlarmsPresent, upsMIB=upsMIB, upsOutputNumLines=upsOutputNumLines, upsObjects=upsObjects, upsIdentManufacturer=upsIdentManufacturer, upsAlarmOutputOverload=upsAlarmOutputOverload, upsFullInputGroup=upsFullInputGroup, upsTestResultsSummary=upsTestResultsSummary, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsWellKnownAlarms=upsWellKnownAlarms, upsOutput=upsOutput, upsBasicBypassGroup=upsBasicBypassGroup, upsBypassNumLines=upsBypassNumLines, upsAlarmEntry=upsAlarmEntry, upsConfigOutputVA=upsConfigOutputVA, upsFullCompliance=upsFullCompliance, upsAlarmTime=upsAlarmTime, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmId=upsAlarmId, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBatteryStatus=upsBatteryStatus, upsIdentModel=upsIdentModel, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsFullAlarmGroup=upsFullAlarmGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsSubsetCompliance=upsSubsetCompliance, upsIdent=upsIdent, upsTestResultsDetail=upsTestResultsDetail, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsFullOutputGroup=upsFullOutputGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmDescr=upsAlarmDescr, upsOutputPercentLoad=upsOutputPercentLoad, upsTestStartTime=upsTestStartTime, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsOutputLineIndex=upsOutputLineIndex, upsOutputTable=upsOutputTable, upsOutputCurrent=upsOutputCurrent, upsInputNumLines=upsInputNumLines, upsTest=upsTest, upsBasicCompliance=upsBasicCompliance, upsSubsetOutputGroup=upsSubsetOutputGroup, upsOutputVoltage=upsOutputVoltage, upsBasicControlGroup=upsBasicControlGroup, upsTraps=upsTraps, upsBasicTestGroup=upsBasicTestGroup, upsFullGroups=upsFullGroups, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmTestInProgress=upsAlarmTestInProgress, PositiveInteger=PositiveInteger, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, PYSNMP_MODULE_ID=upsMIB, upsBypassLineIndex=upsBypassLineIndex, upsInputEntry=upsInputEntry, upsBasicInputGroup=upsBasicInputGroup, upsFullControlGroup=upsFullControlGroup, upsBypassVoltage=upsBypassVoltage, upsTrapOnBattery=upsTrapOnBattery, upsBypassFrequency=upsBypassFrequency, upsAlarmBypassBad=upsAlarmBypassBad, upsConformance=upsConformance, upsConfigInputVoltage=upsConfigInputVoltage, upsSubsetGroups=upsSubsetGroups, upsGroups=upsGroups, upsShutdownType=upsShutdownType, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmInputBad=upsAlarmInputBad, upsBypassCurrent=upsBypassCurrent, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTestElapsedTime=upsTestElapsedTime, upsOutputPower=upsOutputPower, upsInputCurrent=upsInputCurrent, upsBatteryVoltage=upsBatteryVoltage, upsAlarmBatteryBad=upsAlarmBatteryBad, upsInputTable=upsInputTable, upsTestId=upsTestId, upsBasicIdentGroup=upsBasicIdentGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmTempBad=upsAlarmTempBad, upsAutoRestart=upsAutoRestart, upsSubsetConfigGroup=upsSubsetConfigGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsWellKnownTests=upsWellKnownTests, upsConfigOutputFreq=upsConfigOutputFreq, upsRebootWithDuration=upsRebootWithDuration, upsControl=upsControl, upsCompliances=upsCompliances, upsAlarm=upsAlarm, upsBypass=upsBypass, upsBypassTable=upsBypassTable, upsAlarmOnBattery=upsAlarmOnBattery, upsConfigInputFreq=upsConfigInputFreq, upsBattery=upsBattery, upsInputLineBads=upsInputLineBads, upsTestSpinLock=upsTestSpinLock, upsAlarmLowBattery=upsAlarmLowBattery, upsInputTruePower=upsInputTruePower, upsConfigOutputVoltage=upsConfigOutputVoltage, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsFullConfigGroup=upsFullConfigGroup, upsBatteryCurrent=upsBatteryCurrent, upsBasicConfigGroup=upsBasicConfigGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsFullIdentGroup=upsFullIdentGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsInput=upsInput)
