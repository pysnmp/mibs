...
# Produced by pysmi-1.1.8 at Mon Jan 17 22:00:54 2022
...
TimeTicks, ModuleIdentity, ObjectIdentity, MibIdentifier, Gauge32, Unsigned32, Counter32, iso, mib_2, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "Gauge32", "Unsigned32", "Counter32", "iso", "mib-2", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "IpAddress", "Counter64")
AutonomousType, TimeInterval, TimeStamp, DisplayString, TestAndIncr, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TimeInterval", "TimeStamp", "DisplayString", "TestAndIncr", "TextualConvention")
...
mibBuilder.exportSymbols("UPS-MIB", upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsInputFrequency=upsInputFrequency, upsAlarmEntry=upsAlarmEntry, upsMIB=upsMIB, upsInputNumLines=upsInputNumLines, upsFullIdentGroup=upsFullIdentGroup, upsTestResultsDetail=upsTestResultsDetail, upsOutputEntry=upsOutputEntry, upsAlarmTempBad=upsAlarmTempBad, upsFullControlGroup=upsFullControlGroup, upsAlarmTable=upsAlarmTable, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsObjects=upsObjects, upsFullBypassGroup=upsFullBypassGroup, upsBasicTestGroup=upsBasicTestGroup, upsInputLineBads=upsInputLineBads, upsBatteryCurrent=upsBatteryCurrent, upsAlarmDescr=upsAlarmDescr, upsFullBatteryGroup=upsFullBatteryGroup, upsBattery=upsBattery, upsConfigAudibleStatus=upsConfigAudibleStatus, upsOutputVoltage=upsOutputVoltage, upsFullGroups=upsFullGroups, upsOutputPower=upsOutputPower, upsAlarmShutdownPending=upsAlarmShutdownPending, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBasicOutputGroup=upsBasicOutputGroup, upsIdentModel=upsIdentModel, upsConfigOutputVA=upsConfigOutputVA, upsTest=upsTest, upsOutputCurrent=upsOutputCurrent, upsIdent=upsIdent, upsInput=upsInput, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsSecondsOnBattery=upsSecondsOnBattery, upsControl=upsControl, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsOutputNumLines=upsOutputNumLines, upsBypass=upsBypass, upsTestSpinLock=upsTestSpinLock, upsTestResultsSummary=upsTestResultsSummary, upsSubsetIdentGroup=upsSubsetIdentGroup, upsFullOutputGroup=upsFullOutputGroup, upsInputVoltage=upsInputVoltage, upsAlarm=upsAlarm, upsFullTestGroup=upsFullTestGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBasicGroups=upsBasicGroups, upsConfig=upsConfig, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmGeneralFault=upsAlarmGeneralFault, upsInputLineIndex=upsInputLineIndex, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmTime=upsAlarmTime, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsCompliances=upsCompliances, upsBypassPower=upsBypassPower, upsTestStartTime=upsTestStartTime, upsShutdownType=upsShutdownType, upsAutoRestart=upsAutoRestart, upsAlarmsPresent=upsAlarmsPresent, upsBypassLineIndex=upsBypassLineIndex, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsGroups=upsGroups, upsOutput=upsOutput, upsConfigOutputVoltage=upsConfigOutputVoltage, upsOutputLineIndex=upsOutputLineIndex, upsBatteryStatus=upsBatteryStatus, upsBypassCurrent=upsBypassCurrent, upsIdentManufacturer=upsIdentManufacturer, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsConfigInputFreq=upsConfigInputFreq, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTrapTestCompleted=upsTrapTestCompleted, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsWellKnownTests=upsWellKnownTests, upsAlarmOutputBad=upsAlarmOutputBad, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsSubsetCompliance=upsSubsetCompliance, upsOutputSource=upsOutputSource, upsTraps=upsTraps, upsShutdownAfterDelay=upsShutdownAfterDelay, upsSubsetInputGroup=upsSubsetInputGroup, PYSNMP_MODULE_ID=upsMIB, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsStartupAfterDelay=upsStartupAfterDelay, upsInputTruePower=upsInputTruePower, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBypassFrequency=upsBypassFrequency, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBypassVoltage=upsBypassVoltage, upsSubsetOutputGroup=upsSubsetOutputGroup, upsConformance=upsConformance, upsInputTable=upsInputTable, upsAlarmOnBattery=upsAlarmOnBattery, upsBasicCompliance=upsBasicCompliance, upsAlarmLowBattery=upsAlarmLowBattery, upsFullInputGroup=upsFullInputGroup, upsAlarmInputBad=upsAlarmInputBad, upsSubsetControlGroup=upsSubsetControlGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTestElapsedTime=upsTestElapsedTime, upsFullCompliance=upsFullCompliance, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmId=upsAlarmId, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBypassTable=upsBypassTable, upsSubsetGroups=upsSubsetGroups, upsInputCurrent=upsInputCurrent, upsOutputFrequency=upsOutputFrequency, upsAlarmBatteryBad=upsAlarmBatteryBad, upsRebootWithDuration=upsRebootWithDuration, upsIdentName=upsIdentName, upsAlarmTestInProgress=upsAlarmTestInProgress, NonNegativeInteger=NonNegativeInteger, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConfigOutputFreq=upsConfigOutputFreq, upsTrapOnBattery=upsTrapOnBattery, upsBasicInputGroup=upsBasicInputGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsFullConfigGroup=upsFullConfigGroup, upsBypassNumLines=upsBypassNumLines, upsBasicConfigGroup=upsBasicConfigGroup, upsBatteryTemperature=upsBatteryTemperature, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsConfigInputVoltage=upsConfigInputVoltage, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsOutputTable=upsOutputTable, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTestId=upsTestId, upsBypassEntry=upsBypassEntry, upsConfigOutputPower=upsConfigOutputPower, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicControlGroup=upsBasicControlGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, PositiveInteger=PositiveInteger, upsBasicIdentGroup=upsBasicIdentGroup, upsInputEntry=upsInputEntry, upsBatteryVoltage=upsBatteryVoltage, upsConfigLowBattTime=upsConfigLowBattTime)
