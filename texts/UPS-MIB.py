...
# Produced by pysmi-1.1.12 at Wed May 29 08:07:06 2024
...
ObjectIdentity, ModuleIdentity, Integer32, Bits, Counter64, IpAddress, MibIdentifier, TimeTicks, NotificationType, Gauge32, mib_2, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Integer32", "Bits", "Counter64", "IpAddress", "MibIdentifier", "TimeTicks", "NotificationType", "Gauge32", "mib-2", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("UPS-MIB", upsFullBypassGroup=upsFullBypassGroup, upsControl=upsControl, upsTestStartTime=upsTestStartTime, upsAlarm=upsAlarm, upsGroups=upsGroups, upsTest=upsTest, upsInputCurrent=upsInputCurrent, upsAlarmFuseFailure=upsAlarmFuseFailure, upsOutputTable=upsOutputTable, upsBypass=upsBypass, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBypassPower=upsBypassPower, upsFullControlGroup=upsFullControlGroup, upsBypassEntry=upsBypassEntry, upsIdentModel=upsIdentModel, upsBypassTable=upsBypassTable, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBypassNumLines=upsBypassNumLines, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBatteryVoltage=upsBatteryVoltage, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsConfigAudibleStatus=upsConfigAudibleStatus, upsOutputPower=upsOutputPower, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, PositiveInteger=PositiveInteger, upsConfigOutputPower=upsConfigOutputPower, upsTestResultsSummary=upsTestResultsSummary, upsInputVoltage=upsInputVoltage, upsBatteryCurrent=upsBatteryCurrent, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBypassLineIndex=upsBypassLineIndex, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsInputEntry=upsInputEntry, upsBasicGroups=upsBasicGroups, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsFullTestGroup=upsFullTestGroup, upsAlarmsPresent=upsAlarmsPresent, upsOutputSource=upsOutputSource, upsBasicControlGroup=upsBasicControlGroup, upsAlarmId=upsAlarmId, upsAlarmTempBad=upsAlarmTempBad, upsOutputPercentLoad=upsOutputPercentLoad, upsInput=upsInput, upsOutputNumLines=upsOutputNumLines, upsOutput=upsOutput, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsConfigLowBattTime=upsConfigLowBattTime, upsAutoRestart=upsAutoRestart, upsBypassVoltage=upsBypassVoltage, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullGroups=upsFullGroups, upsOutputFrequency=upsOutputFrequency, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmOutputBad=upsAlarmOutputBad, upsConfigInputFreq=upsConfigInputFreq, upsAlarmDescr=upsAlarmDescr, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicBatteryGroup=upsBasicBatteryGroup, NonNegativeInteger=NonNegativeInteger, upsConfigOutputFreq=upsConfigOutputFreq, upsObjects=upsObjects, upsBasicIdentGroup=upsBasicIdentGroup, upsFullInputGroup=upsFullInputGroup, upsAlarmTable=upsAlarmTable, upsBasicConfigGroup=upsBasicConfigGroup, upsOutputEntry=upsOutputEntry, upsFullOutputGroup=upsFullOutputGroup, upsIdentName=upsIdentName, upsFullCompliance=upsFullCompliance, upsInputTruePower=upsInputTruePower, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTestElapsedTime=upsTestElapsedTime, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmFanFailure=upsAlarmFanFailure, upsWellKnownTests=upsWellKnownTests, upsTrapOnBattery=upsTrapOnBattery, upsAlarmLowBattery=upsAlarmLowBattery, upsConfigOutputVoltage=upsConfigOutputVoltage, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsSubsetInputGroup=upsSubsetInputGroup, upsFullConfigGroup=upsFullConfigGroup, upsTestSpinLock=upsTestSpinLock, upsTrapTestCompleted=upsTrapTestCompleted, upsShutdownType=upsShutdownType, upsWellKnownAlarms=upsWellKnownAlarms, upsBatteryTemperature=upsBatteryTemperature, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsFullAlarmGroup=upsFullAlarmGroup, upsInputFrequency=upsInputFrequency, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBypassFrequency=upsBypassFrequency, upsOutputVoltage=upsOutputVoltage, upsConfigInputVoltage=upsConfigInputVoltage, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestId=upsTestId, upsInputLineIndex=upsInputLineIndex, upsCompliances=upsCompliances, upsBatteryStatus=upsBatteryStatus, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutputLineIndex=upsOutputLineIndex, upsTestResultsDetail=upsTestResultsDetail, upsFullIdentGroup=upsFullIdentGroup, PYSNMP_MODULE_ID=upsMIB, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmBypassBad=upsAlarmBypassBad, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmEntry=upsAlarmEntry, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsInputNumLines=upsInputNumLines, upsSubsetGroups=upsSubsetGroups, upsBasicAlarmGroup=upsBasicAlarmGroup, upsOutputCurrent=upsOutputCurrent, upsAlarmInputBad=upsAlarmInputBad, upsFullBatteryGroup=upsFullBatteryGroup, upsMIB=upsMIB, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBypassCurrent=upsBypassCurrent, upsConformance=upsConformance, upsInputTable=upsInputTable, upsIdent=upsIdent, upsAlarmOnBattery=upsAlarmOnBattery, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsInputLineBads=upsInputLineBads, upsAlarmTime=upsAlarmTime, upsBattery=upsBattery, upsStartupAfterDelay=upsStartupAfterDelay, upsTraps=upsTraps, upsRebootWithDuration=upsRebootWithDuration, upsBasicCompliance=upsBasicCompliance, upsSubsetConfigGroup=upsSubsetConfigGroup, upsSubsetCompliance=upsSubsetCompliance, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBasicTestGroup=upsBasicTestGroup, upsConfig=upsConfig, upsConfigOutputVA=upsConfigOutputVA, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBasicInputGroup=upsBasicInputGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsIdentManufacturer=upsIdentManufacturer)
