...
mib_2, ModuleIdentity, Bits, Counter32, Integer32, IpAddress, iso, ObjectIdentity, MibIdentifier, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "ModuleIdentity", "Bits", "Counter32", "Integer32", "IpAddress", "iso", "ObjectIdentity", "MibIdentifier", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("UPS-MIB", upsInputCurrent=upsInputCurrent, upsAlarmOnBattery=upsAlarmOnBattery, upsTestId=upsTestId, upsFullAlarmGroup=upsFullAlarmGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarm=upsAlarm, upsOutputEntry=upsOutputEntry, upsInputLineBads=upsInputLineBads, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmChargerFailed=upsAlarmChargerFailed, upsSecondsOnBattery=upsSecondsOnBattery, upsTestResultsDetail=upsTestResultsDetail, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBasicAlarmGroup=upsBasicAlarmGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsConfigOutputVA=upsConfigOutputVA, upsFullInputGroup=upsFullInputGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsOutputCurrent=upsOutputCurrent, upsBatteryVoltage=upsBatteryVoltage, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBypass=upsBypass, upsOutputLineIndex=upsOutputLineIndex, upsAlarmOutputOverload=upsAlarmOutputOverload, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsObjects=upsObjects, upsInputFrequency=upsInputFrequency, upsFullTestGroup=upsFullTestGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsConfig=upsConfig, upsAlarmTime=upsAlarmTime, upsAutoRestart=upsAutoRestart, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmBypassBad=upsAlarmBypassBad, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBasicCompliance=upsBasicCompliance, upsInputNumLines=upsInputNumLines, upsShutdownAfterDelay=upsShutdownAfterDelay, upsConfigInputVoltage=upsConfigInputVoltage, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsOutputVoltage=upsOutputVoltage, upsSubsetIdentGroup=upsSubsetIdentGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsIdent=upsIdent, upsControl=upsControl, upsWellKnownTests=upsWellKnownTests, PYSNMP_MODULE_ID=upsMIB, upsBattery=upsBattery, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBasicInputGroup=upsBasicInputGroup, upsSubsetCompliance=upsSubsetCompliance, upsConfigInputFreq=upsConfigInputFreq, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsOutputTable=upsOutputTable, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsFullGroups=upsFullGroups, upsIdentAttachedDevices=upsIdentAttachedDevices, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmOutputBad=upsAlarmOutputBad, upsIdentName=upsIdentName, upsTest=upsTest, upsBasicIdentGroup=upsBasicIdentGroup, upsOutputNumLines=upsOutputNumLines, upsFullControlGroup=upsFullControlGroup, upsBypassNumLines=upsBypassNumLines, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsStartupAfterDelay=upsStartupAfterDelay, upsMIB=upsMIB, upsAlarmTempBad=upsAlarmTempBad, upsFullOutputGroup=upsFullOutputGroup, upsBasicTestGroup=upsBasicTestGroup, upsTestElapsedTime=upsTestElapsedTime, upsFullBypassGroup=upsFullBypassGroup, upsTraps=upsTraps, upsConformance=upsConformance, NonNegativeInteger=NonNegativeInteger, PositiveInteger=PositiveInteger, upsTestResultsSummary=upsTestResultsSummary, upsTrapOnBattery=upsTrapOnBattery, upsAlarmLowBattery=upsAlarmLowBattery, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBypassPower=upsBypassPower, upsBypassTable=upsBypassTable, upsIdentManufacturer=upsIdentManufacturer, upsFullConfigGroup=upsFullConfigGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsInput=upsInput, upsBypassLineIndex=upsBypassLineIndex, upsTestStartTime=upsTestStartTime, upsBasicControlGroup=upsBasicControlGroup, upsOutputFrequency=upsOutputFrequency, upsIdentModel=upsIdentModel, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsCompliances=upsCompliances, upsInputVoltage=upsInputVoltage, upsInputEntry=upsInputEntry, upsAlarmTable=upsAlarmTable, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBatteryCurrent=upsBatteryCurrent, upsFullBatteryGroup=upsFullBatteryGroup, upsInputTruePower=upsInputTruePower, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmInputBad=upsAlarmInputBad, upsBypassFrequency=upsBypassFrequency, upsSubsetInputGroup=upsSubsetInputGroup, upsOutputPower=upsOutputPower, upsFullIdentGroup=upsFullIdentGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsOutputSource=upsOutputSource, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsConfigOutputPower=upsConfigOutputPower, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBasicOutputGroup=upsBasicOutputGroup, upsBypassCurrent=upsBypassCurrent, upsBypassVoltage=upsBypassVoltage, upsTestSpinLock=upsTestSpinLock, upsShutdownType=upsShutdownType, upsBatteryTemperature=upsBatteryTemperature, upsInputTable=upsInputTable, upsInputLineIndex=upsInputLineIndex, upsAlarmDescr=upsAlarmDescr, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsSubsetControlGroup=upsSubsetControlGroup, upsFullCompliance=upsFullCompliance, upsConfigOutputFreq=upsConfigOutputFreq, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsGroups=upsGroups, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBasicGroups=upsBasicGroups, upsAlarmEntry=upsAlarmEntry, upsBasicBatteryGroup=upsBasicBatteryGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsSubsetGroups=upsSubsetGroups, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBatteryStatus=upsBatteryStatus, upsBypassEntry=upsBypassEntry, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmOnBypass=upsAlarmOnBypass, upsRebootWithDuration=upsRebootWithDuration, upsAlarmsPresent=upsAlarmsPresent, upsAlarmId=upsAlarmId, upsOutput=upsOutput)
