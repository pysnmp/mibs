...
# Produced by pysmi-1.1.12 at Tue Sep 17 09:57:25 2024
...
Counter32, Gauge32, mib_2, iso, Unsigned32, Integer32, MibIdentifier, ModuleIdentity, Bits, Counter64, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "mib-2", "iso", "Unsigned32", "Integer32", "MibIdentifier", "ModuleIdentity", "Bits", "Counter64", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity")
TextualConvention, TimeInterval, DisplayString, AutonomousType, TimeStamp, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeInterval", "DisplayString", "AutonomousType", "TimeStamp", "TestAndIncr")
...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmInputBad=upsAlarmInputBad, upsOutputSource=upsOutputSource, upsFullGroups=upsFullGroups, upsConfigOutputFreq=upsConfigOutputFreq, upsFullTestGroup=upsFullTestGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsIdentManufacturer=upsIdentManufacturer, upsSubsetCompliance=upsSubsetCompliance, upsOutputTable=upsOutputTable, upsBypass=upsBypass, PYSNMP_MODULE_ID=upsMIB, upsBasicIdentGroup=upsBasicIdentGroup, upsFullOutputGroup=upsFullOutputGroup, upsBasicInputGroup=upsBasicInputGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsFullBatteryGroup=upsFullBatteryGroup, upsBasicControlGroup=upsBasicControlGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsTestSpinLock=upsTestSpinLock, upsConfigOutputVA=upsConfigOutputVA, upsBasicCompliance=upsBasicCompliance, upsInputTruePower=upsInputTruePower, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsFullControlGroup=upsFullControlGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsInputTable=upsInputTable, upsTestElapsedTime=upsTestElapsedTime, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmTempBad=upsAlarmTempBad, upsAlarmId=upsAlarmId, upsBypassLineIndex=upsBypassLineIndex, upsAlarmEntry=upsAlarmEntry, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAutoRestart=upsAutoRestart, NonNegativeInteger=NonNegativeInteger, upsCompliances=upsCompliances, upsAlarmGeneralFault=upsAlarmGeneralFault, upsStartupAfterDelay=upsStartupAfterDelay, upsBatteryStatus=upsBatteryStatus, upsInputNumLines=upsInputNumLines, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBatteryCurrent=upsBatteryCurrent, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmTable=upsAlarmTable, upsShutdownType=upsShutdownType, upsOutputFrequency=upsOutputFrequency, upsOutput=upsOutput, upsShutdownAfterDelay=upsShutdownAfterDelay, upsInputLineIndex=upsInputLineIndex, upsTestResultsSummary=upsTestResultsSummary, upsTestResultsDetail=upsTestResultsDetail, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsWellKnownTests=upsWellKnownTests, upsInputCurrent=upsInputCurrent, upsSecondsOnBattery=upsSecondsOnBattery, upsIdent=upsIdent, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicTestGroup=upsBasicTestGroup, upsFullConfigGroup=upsFullConfigGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmsPresent=upsAlarmsPresent, upsControl=upsControl, upsAlarmBypassBad=upsAlarmBypassBad, upsOutputPower=upsOutputPower, PositiveInteger=PositiveInteger, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConfigInputVoltage=upsConfigInputVoltage, upsTrapOnBattery=upsTrapOnBattery, upsOutputLineIndex=upsOutputLineIndex, upsOutputCurrent=upsOutputCurrent, upsConfigInputFreq=upsConfigInputFreq, upsInputLineBads=upsInputLineBads, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBatteryTemperature=upsBatteryTemperature, upsBypassNumLines=upsBypassNumLines, upsOutputNumLines=upsOutputNumLines, upsOutputPercentLoad=upsOutputPercentLoad, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTraps=upsTraps, upsBattery=upsBattery, upsAlarmDescr=upsAlarmDescr, upsTestId=upsTestId, upsIdentAttachedDevices=upsIdentAttachedDevices, upsIdentModel=upsIdentModel, upsInput=upsInput, upsBypassCurrent=upsBypassCurrent, upsConformance=upsConformance, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsOutputVoltage=upsOutputVoltage, upsAlarmTime=upsAlarmTime, upsSubsetConfigGroup=upsSubsetConfigGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBypassEntry=upsBypassEntry, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmBatteryBad=upsAlarmBatteryBad, upsFullIdentGroup=upsFullIdentGroup, upsOutputEntry=upsOutputEntry, upsBypassTable=upsBypassTable, upsAlarm=upsAlarm, upsObjects=upsObjects, upsBypassVoltage=upsBypassVoltage, upsAlarmChargerFailed=upsAlarmChargerFailed, upsRebootWithDuration=upsRebootWithDuration, upsWellKnownAlarms=upsWellKnownAlarms, upsTest=upsTest, upsAlarmOutputOverload=upsAlarmOutputOverload, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBatteryVoltage=upsBatteryVoltage, upsConfig=upsConfig, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestStartTime=upsTestStartTime, upsBasicOutputGroup=upsBasicOutputGroup, upsBypassFrequency=upsBypassFrequency, upsInputVoltage=upsInputVoltage, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmOnBypass=upsAlarmOnBypass, upsTrapTestCompleted=upsTrapTestCompleted, upsBasicGroups=upsBasicGroups, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsFullCompliance=upsFullCompliance, upsIdentName=upsIdentName, upsGroups=upsGroups, upsBasicBatteryGroup=upsBasicBatteryGroup, upsSubsetGroups=upsSubsetGroups, upsAlarmOnBattery=upsAlarmOnBattery, upsFullAlarmGroup=upsFullAlarmGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsConfigLowBattTime=upsConfigLowBattTime, upsInputFrequency=upsInputFrequency, upsMIB=upsMIB, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBypassPower=upsBypassPower, upsFullBypassGroup=upsFullBypassGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsInputEntry=upsInputEntry, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullInputGroup=upsFullInputGroup, upsConfigOutputPower=upsConfigOutputPower)
