...
# Produced by pysmi-1.1.8 at Thu Oct 26 11:13:48 2023
...
TimeTicks, Unsigned32, Bits, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Counter32, MibIdentifier, Gauge32, iso, ObjectIdentity, IpAddress, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "Bits", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Counter32", "MibIdentifier", "Gauge32", "iso", "ObjectIdentity", "IpAddress", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("UPS-MIB", upsConfigLowBattTime=upsConfigLowBattTime, upsBypassCurrent=upsBypassCurrent, upsOutputTable=upsOutputTable, upsBypassVoltage=upsBypassVoltage, upsTestStartTime=upsTestStartTime, upsInputCurrent=upsInputCurrent, upsInputLineIndex=upsInputLineIndex, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsShutdownType=upsShutdownType, upsStartupAfterDelay=upsStartupAfterDelay, upsConfigOutputPower=upsConfigOutputPower, upsIdent=upsIdent, upsTrapTestCompleted=upsTrapTestCompleted, upsSubsetCompliance=upsSubsetCompliance, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsInputVoltage=upsInputVoltage, upsFullTestGroup=upsFullTestGroup, upsOutputNumLines=upsOutputNumLines, upsInputTable=upsInputTable, upsInputNumLines=upsInputNumLines, upsBatteryCurrent=upsBatteryCurrent, upsAlarmTime=upsAlarmTime, upsAlarmOutputOverload=upsAlarmOutputOverload, upsOutputLineIndex=upsOutputLineIndex, upsOutputEntry=upsOutputEntry, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsConfigOutputVA=upsConfigOutputVA, upsBatteryStatus=upsBatteryStatus, NonNegativeInteger=NonNegativeInteger, upsBypass=upsBypass, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmsPresent=upsAlarmsPresent, upsAlarmOnBattery=upsAlarmOnBattery, upsBasicCompliance=upsBasicCompliance, upsFullControlGroup=upsFullControlGroup, upsConfigInputFreq=upsConfigInputFreq, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTestResultsDetail=upsTestResultsDetail, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmEntry=upsAlarmEntry, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsInputLineBads=upsInputLineBads, upsBypassNumLines=upsBypassNumLines, upsInputFrequency=upsInputFrequency, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsBatteryTemperature=upsBatteryTemperature, upsOutputPercentLoad=upsOutputPercentLoad, upsAutoRestart=upsAutoRestart, upsOutputSource=upsOutputSource, upsConformance=upsConformance, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutputFrequency=upsOutputFrequency, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsGroups=upsGroups, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicTestGroup=upsBasicTestGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmTempBad=upsAlarmTempBad, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBypassTable=upsBypassTable, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsConfig=upsConfig, upsOutputPower=upsOutputPower, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTestSpinLock=upsTestSpinLock, upsBasicGroups=upsBasicGroups, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBypassPower=upsBypassPower, upsSubsetControlGroup=upsSubsetControlGroup, upsObjects=upsObjects, upsOutput=upsOutput, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBasicControlGroup=upsBasicControlGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBypassEntry=upsBypassEntry, upsConfigOutputFreq=upsConfigOutputFreq, upsIdentManufacturer=upsIdentManufacturer, upsOutputVoltage=upsOutputVoltage, upsOutputCurrent=upsOutputCurrent, upsAlarmTable=upsAlarmTable, upsControl=upsControl, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsCompliances=upsCompliances, upsTestId=upsTestId, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTraps=upsTraps, upsInputTruePower=upsInputTruePower, upsBypassFrequency=upsBypassFrequency, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBasicAlarmGroup=upsBasicAlarmGroup, PYSNMP_MODULE_ID=upsMIB, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsInputEntry=upsInputEntry, upsBasicBypassGroup=upsBasicBypassGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsWellKnownTests=upsWellKnownTests, upsFullIdentGroup=upsFullIdentGroup, upsAlarmDescr=upsAlarmDescr, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsMIB=upsMIB, upsAlarmInputBad=upsAlarmInputBad, upsIdentName=upsIdentName, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarm=upsAlarm, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBattery=upsBattery, upsTest=upsTest, upsFullInputGroup=upsFullInputGroup, upsTrapOnBattery=upsTrapOnBattery, upsBypassLineIndex=upsBypassLineIndex, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmFuseFailure=upsAlarmFuseFailure, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmOutputBad=upsAlarmOutputBad, upsFullOutputGroup=upsFullOutputGroup, upsTestElapsedTime=upsTestElapsedTime, PositiveInteger=PositiveInteger, upsFullAlarmGroup=upsFullAlarmGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsIdentModel=upsIdentModel, upsSubsetGroups=upsSubsetGroups, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmOnBypass=upsAlarmOnBypass, upsInput=upsInput, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullCompliance=upsFullCompliance, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsRebootWithDuration=upsRebootWithDuration, upsFullConfigGroup=upsFullConfigGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmId=upsAlarmId, upsFullBypassGroup=upsFullBypassGroup, upsFullGroups=upsFullGroups, upsSubsetInputGroup=upsSubsetInputGroup, upsTestResultsSummary=upsTestResultsSummary, upsBatteryVoltage=upsBatteryVoltage, upsBasicInputGroup=upsBasicInputGroup, upsWellKnownAlarms=upsWellKnownAlarms)
