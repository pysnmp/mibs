...
# Produced by pysmi-1.1.8 at Tue Sep 12 12:47:43 2023
...
ObjectIdentity, TimeTicks, iso, IpAddress, mib_2, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, Bits, Integer32, NotificationType, Unsigned32, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "iso", "IpAddress", "mib-2", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "Bits", "Integer32", "NotificationType", "Unsigned32", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("UPS-MIB", upsConfigInputVoltage=upsConfigInputVoltage, upsBasicInputGroup=upsBasicInputGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsSubsetCompliance=upsSubsetCompliance, upsShutdownAfterDelay=upsShutdownAfterDelay, upsTrapOnBattery=upsTrapOnBattery, upsAlarmBypassBad=upsAlarmBypassBad, upsObjects=upsObjects, upsOutputTable=upsOutputTable, upsOutputEntry=upsOutputEntry, upsAlarmDescr=upsAlarmDescr, upsAlarmsPresent=upsAlarmsPresent, upsControl=upsControl, upsAlarmOutputOverload=upsAlarmOutputOverload, upsSubsetGroups=upsSubsetGroups, upsTrapTestCompleted=upsTrapTestCompleted, upsConfigOutputFreq=upsConfigOutputFreq, upsFullOutputGroup=upsFullOutputGroup, upsAlarmEntry=upsAlarmEntry, upsBypassFrequency=upsBypassFrequency, NonNegativeInteger=NonNegativeInteger, upsAlarmLowBattery=upsAlarmLowBattery, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBatteryStatus=upsBatteryStatus, upsFullCompliance=upsFullCompliance, upsBypassEntry=upsBypassEntry, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBatteryTemperature=upsBatteryTemperature, upsBatteryVoltage=upsBatteryVoltage, upsBypassVoltage=upsBypassVoltage, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBasicTestGroup=upsBasicTestGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarm=upsAlarm, upsAlarmId=upsAlarmId, upsAlarmTempBad=upsAlarmTempBad, upsAlarmFanFailure=upsAlarmFanFailure, upsCompliances=upsCompliances, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsShutdownType=upsShutdownType, upsIdent=upsIdent, upsAlarmOutputBad=upsAlarmOutputBad, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmOnBattery=upsAlarmOnBattery, upsBasicBypassGroup=upsBasicBypassGroup, upsIdentName=upsIdentName, upsFullTestGroup=upsFullTestGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsConfigOutputPower=upsConfigOutputPower, upsTestElapsedTime=upsTestElapsedTime, upsSubsetIdentGroup=upsSubsetIdentGroup, upsConformance=upsConformance, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsOutputNumLines=upsOutputNumLines, upsAlarmTime=upsAlarmTime, upsBypassLineIndex=upsBypassLineIndex, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmChargerFailed=upsAlarmChargerFailed, upsFullIdentGroup=upsFullIdentGroup, upsGroups=upsGroups, upsOutputCurrent=upsOutputCurrent, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTestId=upsTestId, upsTestResultsSummary=upsTestResultsSummary, upsInputNumLines=upsInputNumLines, upsConfigLowBattTime=upsConfigLowBattTime, upsConfigOutputVA=upsConfigOutputVA, upsOutputSource=upsOutputSource, upsFullConfigGroup=upsFullConfigGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBypassCurrent=upsBypassCurrent, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsInputCurrent=upsInputCurrent, upsFullControlGroup=upsFullControlGroup, upsBypassPower=upsBypassPower, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetInputGroup=upsSubsetInputGroup, upsBattery=upsBattery, upsOutputLineIndex=upsOutputLineIndex, upsInputLineIndex=upsInputLineIndex, upsInputEntry=upsInputEntry, upsOutputFrequency=upsOutputFrequency, upsBypassNumLines=upsBypassNumLines, upsConfigAudibleStatus=upsConfigAudibleStatus, upsInputLineBads=upsInputLineBads, upsBasicCompliance=upsBasicCompliance, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBatteryCurrent=upsBatteryCurrent, upsBasicOutputGroup=upsBasicOutputGroup, PYSNMP_MODULE_ID=upsMIB, upsWellKnownAlarms=upsWellKnownAlarms, upsTestResultsDetail=upsTestResultsDetail, upsAlarmShutdownPending=upsAlarmShutdownPending, upsOutputPower=upsOutputPower, upsAlarmOnBypass=upsAlarmOnBypass, upsBypass=upsBypass, upsBasicControlGroup=upsBasicControlGroup, upsFullBypassGroup=upsFullBypassGroup, upsInputTruePower=upsInputTruePower, upsConfigOutputVoltage=upsConfigOutputVoltage, upsIdentModel=upsIdentModel, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTraps=upsTraps, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAutoRestart=upsAutoRestart, upsSecondsOnBattery=upsSecondsOnBattery, upsBasicBatteryGroup=upsBasicBatteryGroup, upsInput=upsInput, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTest=upsTest, upsConfigInputFreq=upsConfigInputFreq, upsIdentManufacturer=upsIdentManufacturer, upsSubsetControlGroup=upsSubsetControlGroup, upsFullInputGroup=upsFullInputGroup, upsTestStartTime=upsTestStartTime, upsTestSpinLock=upsTestSpinLock, upsFullGroups=upsFullGroups, upsOutputVoltage=upsOutputVoltage, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsWellKnownTests=upsWellKnownTests, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmInputBad=upsAlarmInputBad, upsInputTable=upsInputTable, upsMIB=upsMIB, upsInputVoltage=upsInputVoltage, upsAlarmTable=upsAlarmTable, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBypassTable=upsBypassTable, upsBasicGroups=upsBasicGroups, upsInputFrequency=upsInputFrequency, PositiveInteger=PositiveInteger, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsOutputPercentLoad=upsOutputPercentLoad, upsRebootWithDuration=upsRebootWithDuration, upsBasicAlarmGroup=upsBasicAlarmGroup, upsConfig=upsConfig, upsAlarmBatteryBad=upsAlarmBatteryBad, upsOutput=upsOutput)
