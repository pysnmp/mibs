...
mibBuilder.exportSymbols("UPS-MIB", upsFullBypassGroup=upsFullBypassGroup, PYSNMP_MODULE_ID=upsMIB, upsConfigOutputPower=upsConfigOutputPower, upsIdentName=upsIdentName, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestId=upsTestId, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsFullConfigGroup=upsFullConfigGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBypassVoltage=upsBypassVoltage, upsBatteryTemperature=upsBatteryTemperature, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAutoRestart=upsAutoRestart, upsBasicTestGroup=upsBasicTestGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBatteryVoltage=upsBatteryVoltage, upsInputTable=upsInputTable, upsInputLineIndex=upsInputLineIndex, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmOutputBad=upsAlarmOutputBad, upsConfigInputFreq=upsConfigInputFreq, upsAlarmFuseFailure=upsAlarmFuseFailure, NonNegativeInteger=NonNegativeInteger, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBasicInputGroup=upsBasicInputGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmGeneralFault=upsAlarmGeneralFault, upsIdent=upsIdent, upsAlarmFanFailure=upsAlarmFanFailure, upsTestElapsedTime=upsTestElapsedTime, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsConfigInputVoltage=upsConfigInputVoltage, upsFullControlGroup=upsFullControlGroup, upsIdentModel=upsIdentModel, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsSubsetCompliance=upsSubsetCompliance, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBattery=upsBattery, upsConfigAudibleStatus=upsConfigAudibleStatus, upsFullInputGroup=upsFullInputGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmInputBad=upsAlarmInputBad, upsAlarmsPresent=upsAlarmsPresent, upsRebootWithDuration=upsRebootWithDuration, upsAlarmOnBypass=upsAlarmOnBypass, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsInputLineBads=upsInputLineBads, upsAlarmBypassBad=upsAlarmBypassBad, upsSubsetIdentGroup=upsSubsetIdentGroup, upsInputFrequency=upsInputFrequency, upsAlarmEntry=upsAlarmEntry, upsOutputFrequency=upsOutputFrequency, upsBypass=upsBypass, upsAlarmLowBattery=upsAlarmLowBattery, upsTestResultsSummary=upsTestResultsSummary, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBypassFrequency=upsBypassFrequency, upsAlarmChargerFailed=upsAlarmChargerFailed, upsShutdownType=upsShutdownType, upsControl=upsControl, upsConformance=upsConformance, upsGroups=upsGroups, upsStartupAfterDelay=upsStartupAfterDelay, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsMIB=upsMIB, upsInputTruePower=upsInputTruePower, upsAlarmTempBad=upsAlarmTempBad, upsSecondsOnBattery=upsSecondsOnBattery, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTraps=upsTraps, upsBatteryStatus=upsBatteryStatus, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsOutputNumLines=upsOutputNumLines, upsTest=upsTest, upsAlarmId=upsAlarmId, upsBasicCompliance=upsBasicCompliance, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBatteryCurrent=upsBatteryCurrent, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicGroups=upsBasicGroups, PositiveInteger=PositiveInteger, upsFullOutputGroup=upsFullOutputGroup, upsInputCurrent=upsInputCurrent, upsBypassLineIndex=upsBypassLineIndex, upsObjects=upsObjects, upsConfig=upsConfig, upsBypassNumLines=upsBypassNumLines, upsBasicControlGroup=upsBasicControlGroup, upsInputEntry=upsInputEntry, upsAlarmOnBattery=upsAlarmOnBattery, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBypassTable=upsBypassTable, upsFullIdentGroup=upsFullIdentGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsOutputTable=upsOutputTable, upsTestResultsDetail=upsTestResultsDetail, upsTrapOnBattery=upsTrapOnBattery, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsConfigOutputVA=upsConfigOutputVA, upsFullTestGroup=upsFullTestGroup, upsInputNumLines=upsInputNumLines, upsAlarm=upsAlarm, upsOutputPercentLoad=upsOutputPercentLoad, upsTestSpinLock=upsTestSpinLock, upsSubsetGroups=upsSubsetGroups, upsBasicConfigGroup=upsBasicConfigGroup, upsOutputVoltage=upsOutputVoltage, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsOutputSource=upsOutputSource, upsIdentManufacturer=upsIdentManufacturer, upsAlarmDescr=upsAlarmDescr, upsOutputLineIndex=upsOutputLineIndex, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBasicBypassGroup=upsBasicBypassGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsFullCompliance=upsFullCompliance, upsSubsetInputGroup=upsSubsetInputGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsOutputCurrent=upsOutputCurrent, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsInputVoltage=upsInputVoltage, upsOutput=upsOutput, upsWellKnownTests=upsWellKnownTests, upsCompliances=upsCompliances, upsOutputPower=upsOutputPower, upsBypassCurrent=upsBypassCurrent, upsFullGroups=upsFullGroups, upsOutputEntry=upsOutputEntry, upsAlarmTable=upsAlarmTable, upsConfigOutputFreq=upsConfigOutputFreq, upsFullAlarmGroup=upsFullAlarmGroup, upsInput=upsInput, upsBypassPower=upsBypassPower, upsTestStartTime=upsTestStartTime, upsBypassEntry=upsBypassEntry, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmTime=upsAlarmTime)
