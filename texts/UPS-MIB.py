...
# Produced by pysmi-1.1.12 at Mon Jul  1 11:10:13 2024
...
Integer32, iso, Gauge32, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, Unsigned32, IpAddress, Counter32, ObjectIdentity, mib_2, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "Gauge32", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "Unsigned32", "IpAddress", "Counter32", "ObjectIdentity", "mib-2", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("UPS-MIB", upsFullInputGroup=upsFullInputGroup, upsOutputTable=upsOutputTable, upsBasicConfigGroup=upsBasicConfigGroup, upsMIB=upsMIB, upsFullCompliance=upsFullCompliance, upsAlarmBatteryBad=upsAlarmBatteryBad, upsFullOutputGroup=upsFullOutputGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsSubsetCompliance=upsSubsetCompliance, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsInputLineBads=upsInputLineBads, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarm=upsAlarm, upsFullAlarmGroup=upsFullAlarmGroup, upsInput=upsInput, upsBasicOutputGroup=upsBasicOutputGroup, upsOutput=upsOutput, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTestSpinLock=upsTestSpinLock, upsBypassFrequency=upsBypassFrequency, upsAutoRestart=upsAutoRestart, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsInputLineIndex=upsInputLineIndex, upsConfigOutputPower=upsConfigOutputPower, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsIdentName=upsIdentName, upsTestResultsDetail=upsTestResultsDetail, upsAlarmOnBypass=upsAlarmOnBypass, upsBypassTable=upsBypassTable, upsAlarmGeneralFault=upsAlarmGeneralFault, upsWellKnownTests=upsWellKnownTests, upsAlarmDescr=upsAlarmDescr, upsAlarmOutputBad=upsAlarmOutputBad, upsFullConfigGroup=upsFullConfigGroup, upsOutputNumLines=upsOutputNumLines, upsAlarmsPresent=upsAlarmsPresent, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBypassLineIndex=upsBypassLineIndex, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsConformance=upsConformance, upsRebootWithDuration=upsRebootWithDuration, upsSecondsOnBattery=upsSecondsOnBattery, upsConfig=upsConfig, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmInputBad=upsAlarmInputBad, upsFullBatteryGroup=upsFullBatteryGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsInputVoltage=upsInputVoltage, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTrapTestCompleted=upsTrapTestCompleted, upsCompliances=upsCompliances, upsShutdownType=upsShutdownType, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsTestResultsSummary=upsTestResultsSummary, upsStartupAfterDelay=upsStartupAfterDelay, upsBasicInputGroup=upsBasicInputGroup, upsAlarmId=upsAlarmId, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsInputTruePower=upsInputTruePower, upsOutputEntry=upsOutputEntry, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmFanFailure=upsAlarmFanFailure, upsOutputVoltage=upsOutputVoltage, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBypassPower=upsBypassPower, upsConfigOutputFreq=upsConfigOutputFreq, upsTrapOnBattery=upsTrapOnBattery, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmTime=upsAlarmTime, upsBatteryCurrent=upsBatteryCurrent, upsInputTable=upsInputTable, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsIdentManufacturer=upsIdentManufacturer, upsAlarmTable=upsAlarmTable, upsBasicBatteryGroup=upsBasicBatteryGroup, upsInputCurrent=upsInputCurrent, upsSubsetInputGroup=upsSubsetInputGroup, upsIdentModel=upsIdentModel, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBatteryStatus=upsBatteryStatus, upsInputFrequency=upsInputFrequency, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsObjects=upsObjects, upsTestStartTime=upsTestStartTime, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBatteryTemperature=upsBatteryTemperature, upsIdent=upsIdent, upsOutputPower=upsOutputPower, upsBasicCompliance=upsBasicCompliance, upsBypass=upsBypass, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsFullGroups=upsFullGroups, upsFullControlGroup=upsFullControlGroup, upsTestElapsedTime=upsTestElapsedTime, upsInputNumLines=upsInputNumLines, upsBasicGroups=upsBasicGroups, upsAlarmLowBattery=upsAlarmLowBattery, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBypassEntry=upsBypassEntry, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsFullIdentGroup=upsFullIdentGroup, upsBypassNumLines=upsBypassNumLines, upsBypassVoltage=upsBypassVoltage, upsTraps=upsTraps, upsConfigLowBattTime=upsConfigLowBattTime, upsControl=upsControl, upsFullBypassGroup=upsFullBypassGroup, upsTestId=upsTestId, upsOutputFrequency=upsOutputFrequency, upsTest=upsTest, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConfigOutputVA=upsConfigOutputVA, upsSubsetGroups=upsSubsetGroups, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBattery=upsBattery, upsAlarmFuseFailure=upsAlarmFuseFailure, NonNegativeInteger=NonNegativeInteger, upsOutputSource=upsOutputSource, upsBasicTestGroup=upsBasicTestGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsConfigInputVoltage=upsConfigInputVoltage, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConfigInputFreq=upsConfigInputFreq, upsBasicControlGroup=upsBasicControlGroup, upsInputEntry=upsInputEntry, upsWellKnownAlarms=upsWellKnownAlarms, PositiveInteger=PositiveInteger, upsOutputLineIndex=upsOutputLineIndex, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmTempBad=upsAlarmTempBad, upsGroups=upsGroups, upsAlarmChargerFailed=upsAlarmChargerFailed, upsIdentAttachedDevices=upsIdentAttachedDevices, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmEntry=upsAlarmEntry, PYSNMP_MODULE_ID=upsMIB, upsBypassCurrent=upsBypassCurrent, upsFullTestGroup=upsFullTestGroup, upsBatteryVoltage=upsBatteryVoltage, upsOutputCurrent=upsOutputCurrent)
