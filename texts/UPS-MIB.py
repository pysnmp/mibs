...
# Produced by pysmi-1.1.8 at Fri Dec  2 16:40:17 2022
...
mib_2, Unsigned32, Bits, ObjectIdentity, Counter32, IpAddress, MibIdentifier, TimeTicks, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Unsigned32", "Bits", "ObjectIdentity", "Counter32", "IpAddress", "MibIdentifier", "TimeTicks", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("UPS-MIB", upsOutputVoltage=upsOutputVoltage, upsTestResultsDetail=upsTestResultsDetail, upsBypassCurrent=upsBypassCurrent, upsBatteryTemperature=upsBatteryTemperature, upsOutputPercentLoad=upsOutputPercentLoad, upsBasicTestGroup=upsBasicTestGroup, upsInputNumLines=upsInputNumLines, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmsPresent=upsAlarmsPresent, PYSNMP_MODULE_ID=upsMIB, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmLowBattery=upsAlarmLowBattery, upsBypassLineIndex=upsBypassLineIndex, upsConfigOutputVoltage=upsConfigOutputVoltage, upsConfigInputVoltage=upsConfigInputVoltage, upsSubsetGroups=upsSubsetGroups, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsShutdownType=upsShutdownType, upsTraps=upsTraps, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsConfigOutputPower=upsConfigOutputPower, upsFullAlarmGroup=upsFullAlarmGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBasicInputGroup=upsBasicInputGroup, upsTestResultsSummary=upsTestResultsSummary, upsInputTruePower=upsInputTruePower, upsFullCompliance=upsFullCompliance, upsOutputFrequency=upsOutputFrequency, upsAlarmInputBad=upsAlarmInputBad, upsFullControlGroup=upsFullControlGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBasicOutputGroup=upsBasicOutputGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicControlGroup=upsBasicControlGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsConfigOutputFreq=upsConfigOutputFreq, upsTestElapsedTime=upsTestElapsedTime, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsOutputNumLines=upsOutputNumLines, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsInputCurrent=upsInputCurrent, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBatteryStatus=upsBatteryStatus, upsOutputTable=upsOutputTable, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsBasicBypassGroup=upsBasicBypassGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsIdentModel=upsIdentModel, upsTest=upsTest, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmDescr=upsAlarmDescr, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmGeneralFault=upsAlarmGeneralFault, upsOutputEntry=upsOutputEntry, upsControl=upsControl, upsConfig=upsConfig, upsBattery=upsBattery, upsSubsetOutputGroup=upsSubsetOutputGroup, upsInputLineIndex=upsInputLineIndex, upsBypassFrequency=upsBypassFrequency, upsFullBypassGroup=upsFullBypassGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsInputLineBads=upsInputLineBads, upsAlarmBatteryBad=upsAlarmBatteryBad, upsRebootWithDuration=upsRebootWithDuration, upsAlarmId=upsAlarmId, upsBasicConfigGroup=upsBasicConfigGroup, upsFullTestGroup=upsFullTestGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBasicCompliance=upsBasicCompliance, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsGroups=upsGroups, upsBasicAlarmGroup=upsBasicAlarmGroup, upsSubsetCompliance=upsSubsetCompliance, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullInputGroup=upsFullInputGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarm=upsAlarm, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAutoRestart=upsAutoRestart, upsOutputPower=upsOutputPower, upsBasicIdentGroup=upsBasicIdentGroup, upsOutputCurrent=upsOutputCurrent, NonNegativeInteger=NonNegativeInteger, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTrapOnBattery=upsTrapOnBattery, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsObjects=upsObjects, upsTestSpinLock=upsTestSpinLock, upsOutputSource=upsOutputSource, PositiveInteger=PositiveInteger, upsConfigInputFreq=upsConfigInputFreq, upsIdentName=upsIdentName, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBypass=upsBypass, upsBypassVoltage=upsBypassVoltage, upsWellKnownTests=upsWellKnownTests, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmChargerFailed=upsAlarmChargerFailed, upsSecondsOnBattery=upsSecondsOnBattery, upsInputFrequency=upsInputFrequency, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmBypassBad=upsAlarmBypassBad, upsIdentManufacturer=upsIdentManufacturer, upsIdent=upsIdent, upsAlarmTable=upsAlarmTable, upsOutput=upsOutput, upsConformance=upsConformance, upsSubsetControlGroup=upsSubsetControlGroup, upsConfigOutputVA=upsConfigOutputVA, upsAlarmTime=upsAlarmTime, upsStartupAfterDelay=upsStartupAfterDelay, upsFullOutputGroup=upsFullOutputGroup, upsBatteryVoltage=upsBatteryVoltage, upsTestStartTime=upsTestStartTime, upsOutputLineIndex=upsOutputLineIndex, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBasicBatteryGroup=upsBasicBatteryGroup, upsCompliances=upsCompliances, upsInputTable=upsInputTable, upsFullIdentGroup=upsFullIdentGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsInputVoltage=upsInputVoltage, upsBasicGroups=upsBasicGroups, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmEntry=upsAlarmEntry, upsInputEntry=upsInputEntry, upsBypassNumLines=upsBypassNumLines, upsBypassPower=upsBypassPower, upsAlarmOutputBad=upsAlarmOutputBad, upsBypassTable=upsBypassTable, upsConfigLowBattTime=upsConfigLowBattTime, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsFullGroups=upsFullGroups, upsAlarmTempBad=upsAlarmTempBad, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsInput=upsInput, upsTestId=upsTestId, upsBatteryCurrent=upsBatteryCurrent, upsBypassEntry=upsBypassEntry, upsFullConfigGroup=upsFullConfigGroup, upsMIB=upsMIB, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff)
