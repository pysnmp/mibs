...
# Produced by pysmi-1.1.8 at Mon Feb  6 14:55:42 2023
...
Counter32, ObjectIdentity, Gauge32, Bits, Unsigned32, Integer32, IpAddress, mib_2, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, MibIdentifier, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "Gauge32", "Bits", "Unsigned32", "Integer32", "IpAddress", "mib-2", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "MibIdentifier", "iso", "NotificationType")
...
mibBuilder.exportSymbols("UPS-MIB", upsTraps=upsTraps, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmId=upsAlarmId, upsFullInputGroup=upsFullInputGroup, upsFullOutputGroup=upsFullOutputGroup, upsBypass=upsBypass, upsFullConfigGroup=upsFullConfigGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsConfig=upsConfig, upsBasicOutputGroup=upsBasicOutputGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBatteryStatus=upsBatteryStatus, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypassPower=upsBypassPower, upsConfigOutputFreq=upsConfigOutputFreq, upsGroups=upsGroups, upsOutputPercentLoad=upsOutputPercentLoad, upsBypassEntry=upsBypassEntry, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsCompliances=upsCompliances, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBatteryCurrent=upsBatteryCurrent, upsOutputLineIndex=upsOutputLineIndex, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmLowBattery=upsAlarmLowBattery, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsConfigInputFreq=upsConfigInputFreq, upsControl=upsControl, upsFullGroups=upsFullGroups, upsIdentManufacturer=upsIdentManufacturer, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmEntry=upsAlarmEntry, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmOnBypass=upsAlarmOnBypass, upsInputEntry=upsInputEntry, upsConfigLowBattTime=upsConfigLowBattTime, upsBasicBatteryGroup=upsBasicBatteryGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsOutputEntry=upsOutputEntry, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAutoRestart=upsAutoRestart, upsTrapTestCompleted=upsTrapTestCompleted, upsBasicIdentGroup=upsBasicIdentGroup, upsInputTruePower=upsInputTruePower, upsObjects=upsObjects, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConfigOutputVoltage=upsConfigOutputVoltage, upsInputTable=upsInputTable, upsConfigOutputVA=upsConfigOutputVA, upsSubsetInputGroup=upsSubsetInputGroup, upsSubsetCompliance=upsSubsetCompliance, upsBypassNumLines=upsBypassNumLines, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBypassVoltage=upsBypassVoltage, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBasicTestGroup=upsBasicTestGroup, upsTestResultsSummary=upsTestResultsSummary, upsIdent=upsIdent, upsIdentModel=upsIdentModel, upsBasicControlGroup=upsBasicControlGroup, NonNegativeInteger=NonNegativeInteger, upsOutputCurrent=upsOutputCurrent, upsOutput=upsOutput, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmChargerFailed=upsAlarmChargerFailed, upsSubsetGroups=upsSubsetGroups, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarm=upsAlarm, upsConfigOutputPower=upsConfigOutputPower, PositiveInteger=PositiveInteger, upsFullTestGroup=upsFullTestGroup, upsRebootWithDuration=upsRebootWithDuration, upsFullBypassGroup=upsFullBypassGroup, upsTestElapsedTime=upsTestElapsedTime, upsAlarmTable=upsAlarmTable, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestResultsDetail=upsTestResultsDetail, upsFullControlGroup=upsFullControlGroup, upsOutputVoltage=upsOutputVoltage, upsInputLineBads=upsInputLineBads, upsTestStartTime=upsTestStartTime, upsOutputNumLines=upsOutputNumLines, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBypassCurrent=upsBypassCurrent, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmOutputBad=upsAlarmOutputBad, upsConformance=upsConformance, upsInputLineIndex=upsInputLineIndex, upsInputCurrent=upsInputCurrent, upsWellKnownTests=upsWellKnownTests, upsShutdownType=upsShutdownType, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmInputBad=upsAlarmInputBad, upsBatteryTemperature=upsBatteryTemperature, upsFullIdentGroup=upsFullIdentGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsInput=upsInput, upsOutputFrequency=upsOutputFrequency, upsTestId=upsTestId, upsTest=upsTest, upsFullAlarmGroup=upsFullAlarmGroup, upsBypassFrequency=upsBypassFrequency, upsBattery=upsBattery, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmTempBad=upsAlarmTempBad, upsBatteryVoltage=upsBatteryVoltage, upsBasicCompliance=upsBasicCompliance, upsFullCompliance=upsFullCompliance, upsTestSpinLock=upsTestSpinLock, upsConfigAudibleStatus=upsConfigAudibleStatus, upsOutputPower=upsOutputPower, upsConfigInputVoltage=upsConfigInputVoltage, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmDescr=upsAlarmDescr, upsFullBatteryGroup=upsFullBatteryGroup, upsOutputTable=upsOutputTable, upsIdentName=upsIdentName, upsBypassLineIndex=upsBypassLineIndex, upsBasicConfigGroup=upsBasicConfigGroup, upsMIB=upsMIB, PYSNMP_MODULE_ID=upsMIB, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBypassTable=upsBypassTable, upsSubsetControlGroup=upsSubsetControlGroup, upsInputFrequency=upsInputFrequency, upsAlarmTime=upsAlarmTime, upsBasicGroups=upsBasicGroups, upsTrapOnBattery=upsTrapOnBattery, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsInputVoltage=upsInputVoltage, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmsPresent=upsAlarmsPresent, upsBasicInputGroup=upsBasicInputGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsInputNumLines=upsInputNumLines, upsOutputSource=upsOutputSource, upsSubsetConfigGroup=upsSubsetConfigGroup)
