...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmFanFailure=upsAlarmFanFailure, upsConfigOutputPower=upsConfigOutputPower, upsFullBypassGroup=upsFullBypassGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsInputFrequency=upsInputFrequency, upsBypassPower=upsBypassPower, upsBattery=upsBattery, upsFullCompliance=upsFullCompliance, upsInputNumLines=upsInputNumLines, upsSubsetGroups=upsSubsetGroups, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsInputEntry=upsInputEntry, upsInputTable=upsInputTable, upsAlarmOnBattery=upsAlarmOnBattery, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmInputBad=upsAlarmInputBad, upsFullControlGroup=upsFullControlGroup, upsBypass=upsBypass, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsOutputSource=upsOutputSource, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmTempBad=upsAlarmTempBad, upsConfigOutputVA=upsConfigOutputVA, upsTest=upsTest, upsIdentName=upsIdentName, upsSubsetOutputGroup=upsSubsetOutputGroup, upsTestResultsDetail=upsTestResultsDetail, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsMIB=upsMIB, upsBasicAlarmGroup=upsBasicAlarmGroup, upsOutputLineIndex=upsOutputLineIndex, upsStartupAfterDelay=upsStartupAfterDelay, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsOutputEntry=upsOutputEntry, upsConfigInputVoltage=upsConfigInputVoltage, upsTestResultsSummary=upsTestResultsSummary, upsBypassNumLines=upsBypassNumLines, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicControlGroup=upsBasicControlGroup, upsInputVoltage=upsInputVoltage, upsObjects=upsObjects, upsInput=upsInput, upsTraps=upsTraps, upsAlarmId=upsAlarmId, upsIdentManufacturer=upsIdentManufacturer, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBypassCurrent=upsBypassCurrent, upsFullGroups=upsFullGroups, upsBypassTable=upsBypassTable, upsBasicBatteryGroup=upsBasicBatteryGroup, upsWellKnownTests=upsWellKnownTests, upsBypassEntry=upsBypassEntry, upsAlarmGeneralFault=upsAlarmGeneralFault, upsShutdownType=upsShutdownType, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBasicCompliance=upsBasicCompliance, upsOutputPercentLoad=upsOutputPercentLoad, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsControl=upsControl, upsSecondsOnBattery=upsSecondsOnBattery, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBypassVoltage=upsBypassVoltage, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmTime=upsAlarmTime, upsBasicConfigGroup=upsBasicConfigGroup, upsTestId=upsTestId, upsBypassFrequency=upsBypassFrequency, upsIdentModel=upsIdentModel, upsConformance=upsConformance, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTestElapsedTime=upsTestElapsedTime, upsOutputVoltage=upsOutputVoltage, upsBypassLineIndex=upsBypassLineIndex, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmTable=upsAlarmTable, upsAlarmsPresent=upsAlarmsPresent, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullAlarmGroup=upsFullAlarmGroup, upsIdent=upsIdent, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBasicTestGroup=upsBasicTestGroup, upsBatteryCurrent=upsBatteryCurrent, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmBypassBad=upsAlarmBypassBad, upsGroups=upsGroups, upsFullConfigGroup=upsFullConfigGroup, upsAlarmEntry=upsAlarmEntry, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmOutputOverload=upsAlarmOutputOverload, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAutoRestart=upsAutoRestart, upsBatteryStatus=upsBatteryStatus, upsOutputPower=upsOutputPower, upsBatteryVoltage=upsBatteryVoltage, upsOutputCurrent=upsOutputCurrent, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsInputLineBads=upsInputLineBads, upsInputLineIndex=upsInputLineIndex, upsAlarmDescr=upsAlarmDescr, upsBasicGroups=upsBasicGroups, upsBasicOutputGroup=upsBasicOutputGroup, upsConfigInputFreq=upsConfigInputFreq, upsOutputFrequency=upsOutputFrequency, upsSubsetInputGroup=upsSubsetInputGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsSubsetIdentGroup=upsSubsetIdentGroup, upsOutputTable=upsOutputTable, upsConfigOutputVoltage=upsConfigOutputVoltage, upsFullOutputGroup=upsFullOutputGroup, upsFullTestGroup=upsFullTestGroup, upsFullBatteryGroup=upsFullBatteryGroup, PYSNMP_MODULE_ID=upsMIB, upsSubsetCompliance=upsSubsetCompliance, upsConfigLowBattTime=upsConfigLowBattTime, upsOutput=upsOutput, upsCompliances=upsCompliances, NonNegativeInteger=NonNegativeInteger, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBasicIdentGroup=upsBasicIdentGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullIdentGroup=upsFullIdentGroup, upsInputCurrent=upsInputCurrent, upsAlarmLowBattery=upsAlarmLowBattery, upsTrapOnBattery=upsTrapOnBattery, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsConfig=upsConfig, upsAlarm=upsAlarm, PositiveInteger=PositiveInteger, upsWellKnownAlarms=upsWellKnownAlarms, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsOutputNumLines=upsOutputNumLines, upsTestStartTime=upsTestStartTime, upsAlarmOnBypass=upsAlarmOnBypass, upsBasicInputGroup=upsBasicInputGroup, upsFullInputGroup=upsFullInputGroup, upsTestSpinLock=upsTestSpinLock, upsRebootWithDuration=upsRebootWithDuration, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmOutputBad=upsAlarmOutputBad, upsInputTruePower=upsInputTruePower, upsBatteryTemperature=upsBatteryTemperature)
