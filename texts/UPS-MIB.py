...
# Produced by pysmi-1.1.8 at Fri Jan 13 11:58:27 2023
...
Counter32, Counter64, Unsigned32, ObjectIdentity, MibIdentifier, Integer32, Gauge32, NotificationType, Bits, IpAddress, ModuleIdentity, mib_2, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "Unsigned32", "ObjectIdentity", "MibIdentifier", "Integer32", "Gauge32", "NotificationType", "Bits", "IpAddress", "ModuleIdentity", "mib-2", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TestAndIncr, TextualConvention, DisplayString, TimeStamp, AutonomousType, TimeInterval = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TextualConvention", "DisplayString", "TimeStamp", "AutonomousType", "TimeInterval")
...
mibBuilder.exportSymbols("UPS-MIB", upsOutputVoltage=upsOutputVoltage, upsFullBatteryGroup=upsFullBatteryGroup, upsFullGroups=upsFullGroups, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmOutputBad=upsAlarmOutputBad, upsControl=upsControl, upsTest=upsTest, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarm=upsAlarm, upsConfigOutputVoltage=upsConfigOutputVoltage, upsOutputLineIndex=upsOutputLineIndex, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBypass=upsBypass, upsInput=upsInput, upsFullOutputGroup=upsFullOutputGroup, upsConfig=upsConfig, upsSubsetIdentGroup=upsSubsetIdentGroup, upsSubsetGroups=upsSubsetGroups, PositiveInteger=PositiveInteger, upsOutputCurrent=upsOutputCurrent, upsAlarmsPresent=upsAlarmsPresent, upsOutputPower=upsOutputPower, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBatteryVoltage=upsBatteryVoltage, upsFullIdentGroup=upsFullIdentGroup, upsFullCompliance=upsFullCompliance, upsBatteryStatus=upsBatteryStatus, upsBasicGroups=upsBasicGroups, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBypassEntry=upsBypassEntry, upsCompliances=upsCompliances, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsIdentModel=upsIdentModel, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConformance=upsConformance, upsSubsetConfigGroup=upsSubsetConfigGroup, upsInputFrequency=upsInputFrequency, upsConfigInputFreq=upsConfigInputFreq, upsRebootWithDuration=upsRebootWithDuration, upsWellKnownAlarms=upsWellKnownAlarms, upsBasicTestGroup=upsBasicTestGroup, upsAlarmTime=upsAlarmTime, upsBypassNumLines=upsBypassNumLines, upsInputNumLines=upsInputNumLines, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsFullTestGroup=upsFullTestGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBasicControlGroup=upsBasicControlGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTestId=upsTestId, upsShutdownType=upsShutdownType, upsBatteryTemperature=upsBatteryTemperature, upsBasicInputGroup=upsBasicInputGroup, upsOutputEntry=upsOutputEntry, upsOutputSource=upsOutputSource, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAutoRestart=upsAutoRestart, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTestSpinLock=upsTestSpinLock, upsSubsetInputGroup=upsSubsetInputGroup, upsFullBypassGroup=upsFullBypassGroup, upsBypassVoltage=upsBypassVoltage, upsFullAlarmGroup=upsFullAlarmGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTestElapsedTime=upsTestElapsedTime, upsTrapTestCompleted=upsTrapTestCompleted, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConfigLowBattTime=upsConfigLowBattTime, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsInputLineIndex=upsInputLineIndex, upsFullInputGroup=upsFullInputGroup, upsBatteryCurrent=upsBatteryCurrent, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsMIB=upsMIB, upsBypassFrequency=upsBypassFrequency, upsBasicIdentGroup=upsBasicIdentGroup, upsInputEntry=upsInputEntry, upsTestResultsSummary=upsTestResultsSummary, upsSubsetControlGroup=upsSubsetControlGroup, PYSNMP_MODULE_ID=upsMIB, upsIdentManufacturer=upsIdentManufacturer, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTrapOnBattery=upsTrapOnBattery, upsAlarmTempBad=upsAlarmTempBad, upsBasicConfigGroup=upsBasicConfigGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBypassCurrent=upsBypassCurrent, upsOutput=upsOutput, upsStartupAfterDelay=upsStartupAfterDelay, upsSecondsOnBattery=upsSecondsOnBattery, upsWellKnownTests=upsWellKnownTests, NonNegativeInteger=NonNegativeInteger, upsOutputTable=upsOutputTable, upsIdentName=upsIdentName, upsAlarmInputBad=upsAlarmInputBad, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTraps=upsTraps, upsOutputFrequency=upsOutputFrequency, upsBasicCompliance=upsBasicCompliance, upsAlarmDescr=upsAlarmDescr, upsObjects=upsObjects, upsInputCurrent=upsInputCurrent, upsBypassPower=upsBypassPower, upsAlarmTable=upsAlarmTable, upsIdent=upsIdent, upsInputVoltage=upsInputVoltage, upsAlarmFanFailure=upsAlarmFanFailure, upsConfigInputVoltage=upsConfigInputVoltage, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsTestStartTime=upsTestStartTime, upsConfigOutputPower=upsConfigOutputPower, upsBypassLineIndex=upsBypassLineIndex, upsBasicAlarmGroup=upsBasicAlarmGroup, upsTestResultsDetail=upsTestResultsDetail, upsSubsetCompliance=upsSubsetCompliance, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBasicBatteryGroup=upsBasicBatteryGroup, upsInputLineBads=upsInputLineBads, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsConfigOutputVA=upsConfigOutputVA, upsInputTruePower=upsInputTruePower, upsOutputPercentLoad=upsOutputPercentLoad, upsBasicBypassGroup=upsBasicBypassGroup, upsGroups=upsGroups, upsFullControlGroup=upsFullControlGroup, upsAlarmId=upsAlarmId, upsInputTable=upsInputTable, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBypassTable=upsBypassTable, upsBattery=upsBattery, upsAlarmChargerFailed=upsAlarmChargerFailed, upsOutputNumLines=upsOutputNumLines, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmEntry=upsAlarmEntry, upsAlarmBypassBad=upsAlarmBypassBad, upsFullConfigGroup=upsFullConfigGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmLowBattery=upsAlarmLowBattery)
