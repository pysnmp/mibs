...
# Produced by pysmi-1.1.8 at Mon Jan 17 19:41:33 2022
...
Bits, Gauge32, TimeTicks, IpAddress, NotificationType, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, mib_2, Integer32, ObjectIdentity, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "TimeTicks", "IpAddress", "NotificationType", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "mib-2", "Integer32", "ObjectIdentity", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("UPS-MIB", upsBypassNumLines=upsBypassNumLines, upsWellKnownTests=upsWellKnownTests, upsAlarmInputBad=upsAlarmInputBad, upsSecondsOnBattery=upsSecondsOnBattery, upsBasicAlarmGroup=upsBasicAlarmGroup, upsTraps=upsTraps, upsBasicOutputGroup=upsBasicOutputGroup, upsIdent=upsIdent, upsConfig=upsConfig, upsAlarmTempBad=upsAlarmTempBad, upsOutputVoltage=upsOutputVoltage, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsStartupAfterDelay=upsStartupAfterDelay, upsBasicControlGroup=upsBasicControlGroup, upsAutoRestart=upsAutoRestart, upsBattery=upsBattery, upsTestResultsSummary=upsTestResultsSummary, upsConfigLowBattTime=upsConfigLowBattTime, upsInputTruePower=upsInputTruePower, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsFullCompliance=upsFullCompliance, upsConfigOutputVA=upsConfigOutputVA, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsOutputLineIndex=upsOutputLineIndex, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBasicConfigGroup=upsBasicConfigGroup, upsBypassCurrent=upsBypassCurrent, upsBypass=upsBypass, upsBatteryCurrent=upsBatteryCurrent, upsAlarmChargerFailed=upsAlarmChargerFailed, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBypassEntry=upsBypassEntry, upsCompliances=upsCompliances, upsAlarmOutputOverload=upsAlarmOutputOverload, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsFullInputGroup=upsFullInputGroup, upsControl=upsControl, upsAlarmOutputBad=upsAlarmOutputBad, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTestSpinLock=upsTestSpinLock, upsOutputEntry=upsOutputEntry, upsFullTestGroup=upsFullTestGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsSubsetGroups=upsSubsetGroups, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsOutputTable=upsOutputTable, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConfigOutputVoltage=upsConfigOutputVoltage, upsInputCurrent=upsInputCurrent, upsFullControlGroup=upsFullControlGroup, upsAlarmEntry=upsAlarmEntry, upsTestResultsDetail=upsTestResultsDetail, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsOutput=upsOutput, upsOutputCurrent=upsOutputCurrent, upsInputLineBads=upsInputLineBads, upsFullBatteryGroup=upsFullBatteryGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsOutputNumLines=upsOutputNumLines, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBasicCompliance=upsBasicCompliance, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsOutputSource=upsOutputSource, upsGroups=upsGroups, upsConfigAudibleStatus=upsConfigAudibleStatus, NonNegativeInteger=NonNegativeInteger, upsIdentName=upsIdentName, upsFullConfigGroup=upsFullConfigGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsSubsetControlGroup=upsSubsetControlGroup, upsBypassLineIndex=upsBypassLineIndex, upsConfigInputFreq=upsConfigInputFreq, upsRebootWithDuration=upsRebootWithDuration, upsAlarmTable=upsAlarmTable, upsAlarmsPresent=upsAlarmsPresent, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBypassPower=upsBypassPower, upsBasicInputGroup=upsBasicInputGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmOnBattery=upsAlarmOnBattery, upsSubsetInputGroup=upsSubsetInputGroup, upsFullOutputGroup=upsFullOutputGroup, upsBatteryVoltage=upsBatteryVoltage, upsBypassFrequency=upsBypassFrequency, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmTime=upsAlarmTime, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTest=upsTest, upsBasicBypassGroup=upsBasicBypassGroup, upsIdentManufacturer=upsIdentManufacturer, upsTestElapsedTime=upsTestElapsedTime, upsShutdownType=upsShutdownType, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTrapTestCompleted=upsTrapTestCompleted, upsOutputPower=upsOutputPower, upsSubsetCompliance=upsSubsetCompliance, upsTestStartTime=upsTestStartTime, upsBypassVoltage=upsBypassVoltage, upsAlarmId=upsAlarmId, upsInputLineIndex=upsInputLineIndex, upsInputEntry=upsInputEntry, upsFullBypassGroup=upsFullBypassGroup, upsFullGroups=upsFullGroups, upsBasicGroups=upsBasicGroups, upsInputFrequency=upsInputFrequency, upsBatteryTemperature=upsBatteryTemperature, upsBasicTestGroup=upsBasicTestGroup, upsBatteryStatus=upsBatteryStatus, upsInput=upsInput, upsBypassTable=upsBypassTable, upsAlarmDescr=upsAlarmDescr, upsTestId=upsTestId, upsSubsetIdentGroup=upsSubsetIdentGroup, upsObjects=upsObjects, upsFullIdentGroup=upsFullIdentGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsOutputFrequency=upsOutputFrequency, upsWellKnownAlarms=upsWellKnownAlarms, upsConfigOutputFreq=upsConfigOutputFreq, upsInputNumLines=upsInputNumLines, upsInputTable=upsInputTable, upsAlarmLowBattery=upsAlarmLowBattery, upsInputVoltage=upsInputVoltage, upsFullAlarmGroup=upsFullAlarmGroup, upsIdentModel=upsIdentModel, PositiveInteger=PositiveInteger, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsMIB=upsMIB, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarm=upsAlarm, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsConfigOutputPower=upsConfigOutputPower, upsConformance=upsConformance, upsTrapOnBattery=upsTrapOnBattery, PYSNMP_MODULE_ID=upsMIB, upsAlarmShutdownImminent=upsAlarmShutdownImminent)
