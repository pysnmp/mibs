...
mibBuilder.exportSymbols("UPS-MIB", upsBasicBypassGroup=upsBasicBypassGroup, upsInputEntry=upsInputEntry, upsOutputPower=upsOutputPower, upsFullOutputGroup=upsFullOutputGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBasicTestGroup=upsBasicTestGroup, upsConformance=upsConformance, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsOutput=upsOutput, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBypassTable=upsBypassTable, upsBypassLineIndex=upsBypassLineIndex, upsSubsetOutputGroup=upsSubsetOutputGroup, upsControl=upsControl, upsShutdownType=upsShutdownType, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsFullBatteryGroup=upsFullBatteryGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, PositiveInteger=PositiveInteger, upsAlarmTempBad=upsAlarmTempBad, upsSubsetInputGroup=upsSubsetInputGroup, upsInputVoltage=upsInputVoltage, upsIdentName=upsIdentName, upsInputLineIndex=upsInputLineIndex, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestElapsedTime=upsTestElapsedTime, upsConfig=upsConfig, upsBypass=upsBypass, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBatteryStatus=upsBatteryStatus, upsAlarmDescr=upsAlarmDescr, upsConfigInputFreq=upsConfigInputFreq, upsBasicOutputGroup=upsBasicOutputGroup, upsOutputLineIndex=upsOutputLineIndex, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsFullIdentGroup=upsFullIdentGroup, upsIdentModel=upsIdentModel, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsOutputPercentLoad=upsOutputPercentLoad, upsSecondsOnBattery=upsSecondsOnBattery, PYSNMP_MODULE_ID=upsMIB, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBattery=upsBattery, upsTraps=upsTraps, upsAlarm=upsAlarm, upsFullTestGroup=upsFullTestGroup, upsGroups=upsGroups, upsFullConfigGroup=upsFullConfigGroup, upsFullControlGroup=upsFullControlGroup, upsIdentManufacturer=upsIdentManufacturer, upsAlarmLowBattery=upsAlarmLowBattery, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmTable=upsAlarmTable, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsOutputSource=upsOutputSource, upsOutputCurrent=upsOutputCurrent, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBypassCurrent=upsBypassCurrent, upsBypassEntry=upsBypassEntry, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmBatteryBad=upsAlarmBatteryBad, upsConfigLowBattTime=upsConfigLowBattTime, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBypassPower=upsBypassPower, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsInputLineBads=upsInputLineBads, upsTrapTestCompleted=upsTrapTestCompleted, upsOutputEntry=upsOutputEntry, upsBasicControlGroup=upsBasicControlGroup, upsFullGroups=upsFullGroups, upsInputTable=upsInputTable, upsMIB=upsMIB, upsBypassVoltage=upsBypassVoltage, upsWellKnownAlarms=upsWellKnownAlarms, upsFullInputGroup=upsFullInputGroup, upsWellKnownTests=upsWellKnownTests, upsOutputVoltage=upsOutputVoltage, upsInputTruePower=upsInputTruePower, upsOutputNumLines=upsOutputNumLines, upsBasicGroups=upsBasicGroups, upsTestResultsDetail=upsTestResultsDetail, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTestSpinLock=upsTestSpinLock, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, NonNegativeInteger=NonNegativeInteger, upsBasicAlarmGroup=upsBasicAlarmGroup, upsTestResultsSummary=upsTestResultsSummary, upsAlarmInputBad=upsAlarmInputBad, upsTestStartTime=upsTestStartTime, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmBypassBad=upsAlarmBypassBad, upsInputFrequency=upsInputFrequency, upsInputNumLines=upsInputNumLines, upsConfigOutputVA=upsConfigOutputVA, upsFullBypassGroup=upsFullBypassGroup, upsBasicInputGroup=upsBasicInputGroup, upsAlarmEntry=upsAlarmEntry, upsAlarmsPresent=upsAlarmsPresent, upsConfigOutputPower=upsConfigOutputPower, upsStartupAfterDelay=upsStartupAfterDelay, upsBasicIdentGroup=upsBasicIdentGroup, upsFullCompliance=upsFullCompliance, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsSubsetCompliance=upsSubsetCompliance, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTrapOnBattery=upsTrapOnBattery, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmTime=upsAlarmTime, upsConfigOutputFreq=upsConfigOutputFreq, upsInputCurrent=upsInputCurrent, upsOutputTable=upsOutputTable, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsShutdownAfterDelay=upsShutdownAfterDelay, upsTestId=upsTestId, upsBatteryVoltage=upsBatteryVoltage, upsIdent=upsIdent, upsInput=upsInput, upsSubsetGroups=upsSubsetGroups, upsOutputFrequency=upsOutputFrequency, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsObjects=upsObjects, upsAlarmId=upsAlarmId, upsBasicCompliance=upsBasicCompliance, upsBatteryTemperature=upsBatteryTemperature, upsBatteryCurrent=upsBatteryCurrent, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAutoRestart=upsAutoRestart, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBypassFrequency=upsBypassFrequency, upsAlarmGeneralFault=upsAlarmGeneralFault, upsCompliances=upsCompliances, upsBypassNumLines=upsBypassNumLines, upsAlarmFanFailure=upsAlarmFanFailure, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsRebootWithDuration=upsRebootWithDuration, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmShutdownPending=upsAlarmShutdownPending, upsTest=upsTest)
