...
# Produced by pysmi-1.1.8 at Thu Sep  8 09:11:33 2022
...
mib_2, iso, Counter64, NotificationType, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Unsigned32, IpAddress, MibIdentifier, Gauge32, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "iso", "Counter64", "NotificationType", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Unsigned32", "IpAddress", "MibIdentifier", "Gauge32", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("UPS-MIB", upsTestSpinLock=upsTestSpinLock, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsInputFrequency=upsInputFrequency, upsFullBatteryGroup=upsFullBatteryGroup, upsOutputVoltage=upsOutputVoltage, upsAlarm=upsAlarm, upsInputTable=upsInputTable, upsAlarmInputBad=upsAlarmInputBad, upsAlarmOutputBad=upsAlarmOutputBad, upsSubsetGroups=upsSubsetGroups, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmShutdownPending=upsAlarmShutdownPending, upsGroups=upsGroups, upsBasicCompliance=upsBasicCompliance, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsFullGroups=upsFullGroups, upsTrapOnBattery=upsTrapOnBattery, upsBypass=upsBypass, upsConformance=upsConformance, upsBattery=upsBattery, upsSubsetCompliance=upsSubsetCompliance, upsBasicIdentGroup=upsBasicIdentGroup, upsRebootWithDuration=upsRebootWithDuration, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBasicBypassGroup=upsBasicBypassGroup, upsFullTestGroup=upsFullTestGroup, upsOutputSource=upsOutputSource, upsAlarmTime=upsAlarmTime, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBypassLineIndex=upsBypassLineIndex, upsAlarmOutputOverload=upsAlarmOutputOverload, upsCompliances=upsCompliances, upsSubsetOutputGroup=upsSubsetOutputGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAutoRestart=upsAutoRestart, upsTestId=upsTestId, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmsPresent=upsAlarmsPresent, upsControl=upsControl, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmLowBattery=upsAlarmLowBattery, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBypassPower=upsBypassPower, upsTestElapsedTime=upsTestElapsedTime, upsBasicInputGroup=upsBasicInputGroup, upsFullConfigGroup=upsFullConfigGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmTempBad=upsAlarmTempBad, upsBypassFrequency=upsBypassFrequency, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsMIB=upsMIB, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBasicControlGroup=upsBasicControlGroup, upsFullBypassGroup=upsFullBypassGroup, upsBatteryStatus=upsBatteryStatus, upsInputEntry=upsInputEntry, upsInputTruePower=upsInputTruePower, upsBypassNumLines=upsBypassNumLines, upsBasicAlarmGroup=upsBasicAlarmGroup, upsIdentModel=upsIdentModel, upsTestResultsDetail=upsTestResultsDetail, upsWellKnownAlarms=upsWellKnownAlarms, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTest=upsTest, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsOutputLineIndex=upsOutputLineIndex, upsInput=upsInput, upsSubsetInputGroup=upsSubsetInputGroup, upsInputNumLines=upsInputNumLines, upsOutputFrequency=upsOutputFrequency, upsAlarmTable=upsAlarmTable, upsSecondsOnBattery=upsSecondsOnBattery, upsTestResultsSummary=upsTestResultsSummary, upsConfigOutputVA=upsConfigOutputVA, upsConfig=upsConfig, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmId=upsAlarmId, upsInputLineIndex=upsInputLineIndex, upsTestStartTime=upsTestStartTime, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBasicTestGroup=upsBasicTestGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsTraps=upsTraps, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBypassVoltage=upsBypassVoltage, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsTrapTestCompleted=upsTrapTestCompleted, upsSubsetIdentGroup=upsSubsetIdentGroup, upsConfigOutputPower=upsConfigOutputPower, upsConfigInputFreq=upsConfigInputFreq, upsOutput=upsOutput, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBasicGroups=upsBasicGroups, upsConfigLowBattTime=upsConfigLowBattTime, upsBatteryCurrent=upsBatteryCurrent, upsOutputTable=upsOutputTable, upsOutputNumLines=upsOutputNumLines, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBypassEntry=upsBypassEntry, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsShutdownType=upsShutdownType, upsIdentManufacturer=upsIdentManufacturer, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutputCurrent=upsOutputCurrent, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBypassCurrent=upsBypassCurrent, upsFullInputGroup=upsFullInputGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmBypassBad=upsAlarmBypassBad, upsFullOutputGroup=upsFullOutputGroup, NonNegativeInteger=NonNegativeInteger, upsBatteryTemperature=upsBatteryTemperature, upsInputVoltage=upsInputVoltage, upsInputCurrent=upsInputCurrent, PYSNMP_MODULE_ID=upsMIB, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicOutputGroup=upsBasicOutputGroup, upsFullCompliance=upsFullCompliance, upsObjects=upsObjects, upsFullControlGroup=upsFullControlGroup, PositiveInteger=PositiveInteger, upsWellKnownTests=upsWellKnownTests, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsOutputPercentLoad=upsOutputPercentLoad, upsFullIdentGroup=upsFullIdentGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsOutputEntry=upsOutputEntry, upsBypassTable=upsBypassTable, upsConfigOutputVoltage=upsConfigOutputVoltage, upsIdentName=upsIdentName, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmEntry=upsAlarmEntry, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBatteryVoltage=upsBatteryVoltage, upsAlarmDescr=upsAlarmDescr, upsBasicConfigGroup=upsBasicConfigGroup, upsOutputPower=upsOutputPower, upsInputLineBads=upsInputLineBads, upsAlarmFanFailure=upsAlarmFanFailure, upsIdent=upsIdent, upsIdentAttachedDevices=upsIdentAttachedDevices)
