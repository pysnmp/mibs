...
NotificationType, MibIdentifier, Integer32, Bits, Counter32, Unsigned32, TimeTicks, mib_2, Counter64, ObjectIdentity, Gauge32, iso, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "Integer32", "Bits", "Counter32", "Unsigned32", "TimeTicks", "mib-2", "Counter64", "ObjectIdentity", "Gauge32", "iso", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("UPS-MIB", upsBasicAlarmGroup=upsBasicAlarmGroup, upsBypassTable=upsBypassTable, upsAlarm=upsAlarm, upsAlarmDescr=upsAlarmDescr, upsIdent=upsIdent, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsOutputVoltage=upsOutputVoltage, upsBasicCompliance=upsBasicCompliance, upsAlarmOutputOverload=upsAlarmOutputOverload, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBasicConfigGroup=upsBasicConfigGroup, upsIdentModel=upsIdentModel, upsBattery=upsBattery, upsAlarmFanFailure=upsAlarmFanFailure, upsFullBypassGroup=upsFullBypassGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsOutputLineIndex=upsOutputLineIndex, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmTable=upsAlarmTable, upsAlarmInputBad=upsAlarmInputBad, upsSecondsOnBattery=upsSecondsOnBattery, upsBasicGroups=upsBasicGroups, upsInputCurrent=upsInputCurrent, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTestStartTime=upsTestStartTime, PositiveInteger=PositiveInteger, upsInputLineBads=upsInputLineBads, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsControl=upsControl, upsAlarmTime=upsAlarmTime, upsTestResultsDetail=upsTestResultsDetail, upsSubsetOutputGroup=upsSubsetOutputGroup, upsOutputFrequency=upsOutputFrequency, upsConfig=upsConfig, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsWellKnownTests=upsWellKnownTests, upsFullCompliance=upsFullCompliance, upsIdentName=upsIdentName, upsSubsetControlGroup=upsSubsetControlGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsCompliances=upsCompliances, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsInputEntry=upsInputEntry, upsInputVoltage=upsInputVoltage, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAutoRestart=upsAutoRestart, upsTestSpinLock=upsTestSpinLock, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConfigOutputVA=upsConfigOutputVA, upsTestResultsSummary=upsTestResultsSummary, upsOutputCurrent=upsOutputCurrent, upsOutputTable=upsOutputTable, upsMIB=upsMIB, upsOutputSource=upsOutputSource, upsAlarmId=upsAlarmId, upsBatteryTemperature=upsBatteryTemperature, upsBypassNumLines=upsBypassNumLines, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsGroups=upsGroups, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsSubsetCompliance=upsSubsetCompliance, upsInputFrequency=upsInputFrequency, upsBasicInputGroup=upsBasicInputGroup, upsBasicControlGroup=upsBasicControlGroup, upsAlarmsPresent=upsAlarmsPresent, upsBasicTestGroup=upsBasicTestGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBatteryStatus=upsBatteryStatus, upsInputLineIndex=upsInputLineIndex, upsBypassPower=upsBypassPower, upsFullBatteryGroup=upsFullBatteryGroup, upsTestId=upsTestId, upsObjects=upsObjects, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsSubsetConfigGroup=upsSubsetConfigGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsInputTruePower=upsInputTruePower, upsAlarmGeneralFault=upsAlarmGeneralFault, upsFullControlGroup=upsFullControlGroup, upsInputTable=upsInputTable, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmOnBattery=upsAlarmOnBattery, PYSNMP_MODULE_ID=upsMIB, upsIdentAttachedDevices=upsIdentAttachedDevices, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsConformance=upsConformance, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsFullTestGroup=upsFullTestGroup, upsBypassCurrent=upsBypassCurrent, upsFullInputGroup=upsFullInputGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsSubsetGroups=upsSubsetGroups, upsOutputEntry=upsOutputEntry, upsFullIdentGroup=upsFullIdentGroup, upsBatteryVoltage=upsBatteryVoltage, NonNegativeInteger=NonNegativeInteger, upsBypassVoltage=upsBypassVoltage, upsTestElapsedTime=upsTestElapsedTime, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmOnBypass=upsAlarmOnBypass, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsOutputPower=upsOutputPower, upsBypassFrequency=upsBypassFrequency, upsTraps=upsTraps, upsFullConfigGroup=upsFullConfigGroup, upsTrapOnBattery=upsTrapOnBattery, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConfigInputFreq=upsConfigInputFreq, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmEntry=upsAlarmEntry, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTest=upsTest, upsAlarmOutputBad=upsAlarmOutputBad, upsRebootWithDuration=upsRebootWithDuration, upsInput=upsInput, upsFullGroups=upsFullGroups, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmTempBad=upsAlarmTempBad, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigAudibleStatus=upsConfigAudibleStatus, upsFullOutputGroup=upsFullOutputGroup, upsBypassLineIndex=upsBypassLineIndex, upsAlarmLowBattery=upsAlarmLowBattery, upsOutput=upsOutput, upsBypass=upsBypass, upsTrapTestCompleted=upsTrapTestCompleted, upsOutputNumLines=upsOutputNumLines, upsAlarmBypassBad=upsAlarmBypassBad, upsBypassEntry=upsBypassEntry, upsAlarmFuseFailure=upsAlarmFuseFailure, upsInputNumLines=upsInputNumLines, upsShutdownType=upsShutdownType, upsBatteryCurrent=upsBatteryCurrent, upsConfigOutputPower=upsConfigOutputPower, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmTestInProgress=upsAlarmTestInProgress, upsIdentManufacturer=upsIdentManufacturer, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested)
