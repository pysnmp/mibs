...
# Produced by pysmi-1.1.12 at Wed Jul  3 12:19:53 2024
...
TimeTicks, Bits, mib_2, Unsigned32, ModuleIdentity, Integer32, NotificationType, Gauge32, MibIdentifier, Counter64, ObjectIdentity, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "mib-2", "Unsigned32", "ModuleIdentity", "Integer32", "NotificationType", "Gauge32", "MibIdentifier", "Counter64", "ObjectIdentity", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("UPS-MIB", upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarm=upsAlarm, upsTrapTestCompleted=upsTrapTestCompleted, upsTestId=upsTestId, upsIdent=upsIdent, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmTable=upsAlarmTable, upsTestSpinLock=upsTestSpinLock, upsMIB=upsMIB, upsBatteryCurrent=upsBatteryCurrent, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsInputNumLines=upsInputNumLines, upsOutputFrequency=upsOutputFrequency, upsIdentName=upsIdentName, upsFullOutputGroup=upsFullOutputGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBatteryTemperature=upsBatteryTemperature, upsOutputEntry=upsOutputEntry, upsFullAlarmGroup=upsFullAlarmGroup, upsFullControlGroup=upsFullControlGroup, PositiveInteger=PositiveInteger, upsSubsetCompliance=upsSubsetCompliance, upsOutput=upsOutput, upsAlarmOnBattery=upsAlarmOnBattery, upsBattery=upsBattery, upsStartupAfterDelay=upsStartupAfterDelay, upsBasicInputGroup=upsBasicInputGroup, upsInputLineBads=upsInputLineBads, upsFullIdentGroup=upsFullIdentGroup, upsAlarmTempBad=upsAlarmTempBad, upsBasicCompliance=upsBasicCompliance, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBypassNumLines=upsBypassNumLines, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTestElapsedTime=upsTestElapsedTime, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullGroups=upsFullGroups, upsOutputCurrent=upsOutputCurrent, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmLowBattery=upsAlarmLowBattery, upsBypassCurrent=upsBypassCurrent, upsRebootWithDuration=upsRebootWithDuration, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConfigLowBattTime=upsConfigLowBattTime, upsSubsetControlGroup=upsSubsetControlGroup, upsWellKnownTests=upsWellKnownTests, upsOutputVoltage=upsOutputVoltage, upsFullBypassGroup=upsFullBypassGroup, upsBasicGroups=upsBasicGroups, upsAlarmsPresent=upsAlarmsPresent, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsConfigInputFreq=upsConfigInputFreq, upsWellKnownAlarms=upsWellKnownAlarms, PYSNMP_MODULE_ID=upsMIB, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsInputTable=upsInputTable, upsConfigOutputPower=upsConfigOutputPower, upsInputLineIndex=upsInputLineIndex, upsAlarmBatteryBad=upsAlarmBatteryBad, upsFullTestGroup=upsFullTestGroup, upsOutputNumLines=upsOutputNumLines, upsIdentAttachedDevices=upsIdentAttachedDevices, upsGroups=upsGroups, upsAlarmTime=upsAlarmTime, upsAlarmOutputBad=upsAlarmOutputBad, upsBypassEntry=upsBypassEntry, upsIdentManufacturer=upsIdentManufacturer, upsInputCurrent=upsInputCurrent, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmBypassBad=upsAlarmBypassBad, upsConformance=upsConformance, upsBasicIdentGroup=upsBasicIdentGroup, upsIdentModel=upsIdentModel, upsBypassTable=upsBypassTable, upsBypassVoltage=upsBypassVoltage, upsAlarmShutdownPending=upsAlarmShutdownPending, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsOutputPower=upsOutputPower, NonNegativeInteger=NonNegativeInteger, upsTest=upsTest, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsTestStartTime=upsTestStartTime, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBypassPower=upsBypassPower, upsInputEntry=upsInputEntry, upsFullCompliance=upsFullCompliance, upsShutdownAfterDelay=upsShutdownAfterDelay, upsOutputSource=upsOutputSource, upsConfigOutputVA=upsConfigOutputVA, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTraps=upsTraps, upsAlarmEntry=upsAlarmEntry, upsOutputLineIndex=upsOutputLineIndex, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmId=upsAlarmId, upsFullConfigGroup=upsFullConfigGroup, upsConfig=upsConfig, upsBatteryVoltage=upsBatteryVoltage, upsInput=upsInput, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmOnBypass=upsAlarmOnBypass, upsShutdownType=upsShutdownType, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsSubsetGroups=upsSubsetGroups, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmFanFailure=upsAlarmFanFailure, upsControl=upsControl, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBasicControlGroup=upsBasicControlGroup, upsInputVoltage=upsInputVoltage, upsTestResultsDetail=upsTestResultsDetail, upsAlarmDescr=upsAlarmDescr, upsConfigOutputFreq=upsConfigOutputFreq, upsObjects=upsObjects, upsBypassFrequency=upsBypassFrequency, upsOutputTable=upsOutputTable, upsBasicTestGroup=upsBasicTestGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsInputFrequency=upsInputFrequency, upsFullBatteryGroup=upsFullBatteryGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAutoRestart=upsAutoRestart, upsSubsetOutputGroup=upsSubsetOutputGroup, upsInputTruePower=upsInputTruePower, upsFullInputGroup=upsFullInputGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsTrapOnBattery=upsTrapOnBattery, upsBatteryStatus=upsBatteryStatus, upsBasicConfigGroup=upsBasicConfigGroup, upsBypassLineIndex=upsBypassLineIndex, upsTestResultsSummary=upsTestResultsSummary, upsAlarmInputBad=upsAlarmInputBad, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBypass=upsBypass, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsCompliances=upsCompliances, upsConfigInputVoltage=upsConfigInputVoltage)
