...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmTime=upsAlarmTime, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmEntry=upsAlarmEntry, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsRebootWithDuration=upsRebootWithDuration, upsAutoRestart=upsAutoRestart, upsFullTestGroup=upsFullTestGroup, upsBatteryCurrent=upsBatteryCurrent, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsSubsetConfigGroup=upsSubsetConfigGroup, upsInputNumLines=upsInputNumLines, upsBasicCompliance=upsBasicCompliance, upsOutputPower=upsOutputPower, upsMIB=upsMIB, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicOutputGroup=upsBasicOutputGroup, upsBypassLineIndex=upsBypassLineIndex, upsOutputSource=upsOutputSource, upsFullIdentGroup=upsFullIdentGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsControl=upsControl, upsAlarmDescr=upsAlarmDescr, upsOutputVoltage=upsOutputVoltage, upsTraps=upsTraps, upsFullGroups=upsFullGroups, upsAlarmInputBad=upsAlarmInputBad, upsOutput=upsOutput, upsInputTruePower=upsInputTruePower, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsTestSpinLock=upsTestSpinLock, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmTempBad=upsAlarmTempBad, upsInputVoltage=upsInputVoltage, upsBattery=upsBattery, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBasicInputGroup=upsBasicInputGroup, upsConfigInputFreq=upsConfigInputFreq, upsCompliances=upsCompliances, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmLowBattery=upsAlarmLowBattery, upsBatteryTemperature=upsBatteryTemperature, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsInputTable=upsInputTable, upsOutputLineIndex=upsOutputLineIndex, upsConfigOutputPower=upsConfigOutputPower, upsOutputEntry=upsOutputEntry, upsIdent=upsIdent, upsOutputFrequency=upsOutputFrequency, upsFullControlGroup=upsFullControlGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsConfigAudibleStatus=upsConfigAudibleStatus, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBypassEntry=upsBypassEntry, upsAlarmOutputBad=upsAlarmOutputBad, upsTestId=upsTestId, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmShutdownPending=upsAlarmShutdownPending, upsGroups=upsGroups, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsConfigOutputFreq=upsConfigOutputFreq, upsWellKnownTests=upsWellKnownTests, upsOutputPercentLoad=upsOutputPercentLoad, upsInputLineBads=upsInputLineBads, upsFullAlarmGroup=upsFullAlarmGroup, upsBypassTable=upsBypassTable, upsIdentManufacturer=upsIdentManufacturer, upsSecondsOnBattery=upsSecondsOnBattery, upsTrapOnBattery=upsTrapOnBattery, upsConfigOutputVA=upsConfigOutputVA, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsFullCompliance=upsFullCompliance, upsAlarmGeneralFault=upsAlarmGeneralFault, upsConformance=upsConformance, upsAlarmFanFailure=upsAlarmFanFailure, upsWellKnownAlarms=upsWellKnownAlarms, upsSubsetOutputGroup=upsSubsetOutputGroup, upsTestElapsedTime=upsTestElapsedTime, upsAlarmTable=upsAlarmTable, upsFullBypassGroup=upsFullBypassGroup, upsFullConfigGroup=upsFullConfigGroup, upsInputCurrent=upsInputCurrent, upsBypassPower=upsBypassPower, upsBasicControlGroup=upsBasicControlGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsOutputCurrent=upsOutputCurrent, upsOutputNumLines=upsOutputNumLines, upsTest=upsTest, upsSubsetCompliance=upsSubsetCompliance, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsIdentName=upsIdentName, upsAlarm=upsAlarm, upsBasicGroups=upsBasicGroups, PYSNMP_MODULE_ID=upsMIB, upsBasicIdentGroup=upsBasicIdentGroup, upsBatteryStatus=upsBatteryStatus, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsInput=upsInput, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBypassVoltage=upsBypassVoltage, upsSubsetIdentGroup=upsSubsetIdentGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsBasicTestGroup=upsBasicTestGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsIdentAttachedDevices=upsIdentAttachedDevices, upsSubsetInputGroup=upsSubsetInputGroup, upsFullOutputGroup=upsFullOutputGroup, upsBypassNumLines=upsBypassNumLines, upsAlarmOnBypass=upsAlarmOnBypass, upsShutdownType=upsShutdownType, upsOutputTable=upsOutputTable, upsAlarmId=upsAlarmId, upsBatteryVoltage=upsBatteryVoltage, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTestStartTime=upsTestStartTime, upsConfig=upsConfig, upsAlarmFuseFailure=upsAlarmFuseFailure, upsInputFrequency=upsInputFrequency, upsAlarmsPresent=upsAlarmsPresent, upsStartupAfterDelay=upsStartupAfterDelay, upsInputLineIndex=upsInputLineIndex, upsInputEntry=upsInputEntry, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTrapTestCompleted=upsTrapTestCompleted, upsTestResultsDetail=upsTestResultsDetail, upsSubsetGroups=upsSubsetGroups, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBypassFrequency=upsBypassFrequency, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBypassCurrent=upsBypassCurrent, upsBasicBypassGroup=upsBasicBypassGroup, upsBypass=upsBypass, upsIdentModel=upsIdentModel, upsBasicAlarmGroup=upsBasicAlarmGroup, upsFullInputGroup=upsFullInputGroup, PositiveInteger=PositiveInteger, upsTestResultsSummary=upsTestResultsSummary, NonNegativeInteger=NonNegativeInteger, upsFullBatteryGroup=upsFullBatteryGroup, upsObjects=upsObjects)
