...
# Produced by pysmi-1.1.12 at Tue Jun  4 10:02:45 2024
...
Counter64, MibIdentifier, NotificationType, IpAddress, Bits, Unsigned32, Gauge32, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, mib_2, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "NotificationType", "IpAddress", "Bits", "Unsigned32", "Gauge32", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "mib-2", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("UPS-MIB", upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarm=upsAlarm, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmChargerFailed=upsAlarmChargerFailed, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmOutputBad=upsAlarmOutputBad, upsInputTable=upsInputTable, upsAlarmInputBad=upsAlarmInputBad, upsInput=upsInput, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTest=upsTest, upsSubsetIdentGroup=upsSubsetIdentGroup, upsConfigInputFreq=upsConfigInputFreq, PositiveInteger=PositiveInteger, upsInputFrequency=upsInputFrequency, upsTestSpinLock=upsTestSpinLock, upsBypassPower=upsBypassPower, upsBasicCompliance=upsBasicCompliance, PYSNMP_MODULE_ID=upsMIB, upsOutputTable=upsOutputTable, upsBatteryTemperature=upsBatteryTemperature, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsWellKnownAlarms=upsWellKnownAlarms, upsIdentModel=upsIdentModel, upsBypass=upsBypass, upsTestStartTime=upsTestStartTime, upsBasicControlGroup=upsBasicControlGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsInputLineIndex=upsInputLineIndex, upsOutputCurrent=upsOutputCurrent, upsInputCurrent=upsInputCurrent, upsOutputPower=upsOutputPower, upsAlarmFanFailure=upsAlarmFanFailure, upsSubsetCompliance=upsSubsetCompliance, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsShutdownAfterDelay=upsShutdownAfterDelay, upsTestId=upsTestId, upsOutputVoltage=upsOutputVoltage, upsRebootWithDuration=upsRebootWithDuration, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsSubsetInputGroup=upsSubsetInputGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmTime=upsAlarmTime, upsAlarmOutputOverload=upsAlarmOutputOverload, upsObjects=upsObjects, upsTraps=upsTraps, upsConformance=upsConformance, upsBasicInputGroup=upsBasicInputGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsIdentName=upsIdentName, upsCompliances=upsCompliances, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsBypassCurrent=upsBypassCurrent, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullCompliance=upsFullCompliance, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsConfigLowBattTime=upsConfigLowBattTime, upsFullBypassGroup=upsFullBypassGroup, upsMIB=upsMIB, upsTestResultsDetail=upsTestResultsDetail, upsShutdownType=upsShutdownType, upsBatteryStatus=upsBatteryStatus, upsOutputFrequency=upsOutputFrequency, upsOutputEntry=upsOutputEntry, upsGroups=upsGroups, upsOutput=upsOutput, upsOutputLineIndex=upsOutputLineIndex, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmLowBattery=upsAlarmLowBattery, upsIdentManufacturer=upsIdentManufacturer, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsIdent=upsIdent, upsInputLineBads=upsInputLineBads, upsBatteryVoltage=upsBatteryVoltage, upsBasicConfigGroup=upsBasicConfigGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsFullInputGroup=upsFullInputGroup, upsOutputSource=upsOutputSource, upsInputNumLines=upsInputNumLines, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBypassNumLines=upsBypassNumLines, upsAlarmBypassBad=upsAlarmBypassBad, upsBypassFrequency=upsBypassFrequency, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsInputVoltage=upsInputVoltage, upsAutoRestart=upsAutoRestart, upsBypassTable=upsBypassTable, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsControl=upsControl, upsInputTruePower=upsInputTruePower, upsBasicGroups=upsBasicGroups, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsFullControlGroup=upsFullControlGroup, upsAlarmTempBad=upsAlarmTempBad, NonNegativeInteger=NonNegativeInteger, upsWellKnownTests=upsWellKnownTests, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsFullTestGroup=upsFullTestGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsOutputNumLines=upsOutputNumLines, upsSubsetControlGroup=upsSubsetControlGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmId=upsAlarmId, upsFullGroups=upsFullGroups, upsTestResultsSummary=upsTestResultsSummary, upsTrapOnBattery=upsTrapOnBattery, upsBattery=upsBattery, upsFullOutputGroup=upsFullOutputGroup, upsInputEntry=upsInputEntry, upsAlarmDescr=upsAlarmDescr, upsBatteryCurrent=upsBatteryCurrent, upsTestElapsedTime=upsTestElapsedTime, upsBypassEntry=upsBypassEntry, upsBasicTestGroup=upsBasicTestGroup, upsConfig=upsConfig, upsFullConfigGroup=upsFullConfigGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBypassLineIndex=upsBypassLineIndex, upsStartupAfterDelay=upsStartupAfterDelay, upsConfigOutputPower=upsConfigOutputPower, upsSubsetGroups=upsSubsetGroups, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmsPresent=upsAlarmsPresent, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmTable=upsAlarmTable, upsBypassVoltage=upsBypassVoltage, upsConfigAudibleStatus=upsConfigAudibleStatus, upsFullIdentGroup=upsFullIdentGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsConfigOutputVA=upsConfigOutputVA, upsAlarmEntry=upsAlarmEntry)
