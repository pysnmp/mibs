...
# Produced by pysmi-1.1.8 at Mon Jan 17 18:42:52 2022
...
mib_2, MibIdentifier, IpAddress, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, ObjectIdentity, Bits, iso, NotificationType, Integer32, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "MibIdentifier", "IpAddress", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "ObjectIdentity", "Bits", "iso", "NotificationType", "Integer32", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("UPS-MIB", upsBasicBypassGroup=upsBasicBypassGroup, upsMIB=upsMIB, upsInputEntry=upsInputEntry, upsBypassPower=upsBypassPower, upsSubsetControlGroup=upsSubsetControlGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsTestResultsDetail=upsTestResultsDetail, upsAlarm=upsAlarm, upsInput=upsInput, upsBatteryStatus=upsBatteryStatus, upsBasicIdentGroup=upsBasicIdentGroup, upsInputTruePower=upsInputTruePower, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmOnBypass=upsAlarmOnBypass, upsInputCurrent=upsInputCurrent, upsBasicControlGroup=upsBasicControlGroup, upsAlarmTable=upsAlarmTable, upsBypassNumLines=upsBypassNumLines, upsBasicGroups=upsBasicGroups, upsOutputVoltage=upsOutputVoltage, upsAlarmOnBattery=upsAlarmOnBattery, upsOutputFrequency=upsOutputFrequency, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBasicConfigGroup=upsBasicConfigGroup, upsBatteryTemperature=upsBatteryTemperature, upsShutdownAfterDelay=upsShutdownAfterDelay, upsTraps=upsTraps, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsSubsetInputGroup=upsSubsetInputGroup, upsRebootWithDuration=upsRebootWithDuration, upsTestId=upsTestId, upsTrapTestCompleted=upsTrapTestCompleted, PositiveInteger=PositiveInteger, upsBypassTable=upsBypassTable, upsConfig=upsConfig, upsBypass=upsBypass, upsAlarmTime=upsAlarmTime, upsInputLineIndex=upsInputLineIndex, upsIdentAttachedDevices=upsIdentAttachedDevices, upsFullControlGroup=upsFullControlGroup, upsAutoRestart=upsAutoRestart, upsOutputPercentLoad=upsOutputPercentLoad, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfigOutputFreq=upsConfigOutputFreq, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmsPresent=upsAlarmsPresent, upsAlarmTempBad=upsAlarmTempBad, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsConformance=upsConformance, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicOutputGroup=upsBasicOutputGroup, upsSubsetGroups=upsSubsetGroups, upsBatteryCurrent=upsBatteryCurrent, upsAlarmBypassBad=upsAlarmBypassBad, upsIdent=upsIdent, upsFullInputGroup=upsFullInputGroup, upsInputNumLines=upsInputNumLines, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmInputBad=upsAlarmInputBad, upsOutputEntry=upsOutputEntry, upsBypassFrequency=upsBypassFrequency, upsSubsetCompliance=upsSubsetCompliance, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullGroups=upsFullGroups, upsTrapOnBattery=upsTrapOnBattery, upsTestStartTime=upsTestStartTime, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConfigInputFreq=upsConfigInputFreq, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmFanFailure=upsAlarmFanFailure, upsBattery=upsBattery, upsFullBypassGroup=upsFullBypassGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsControl=upsControl, upsInputLineBads=upsInputLineBads, upsBasicCompliance=upsBasicCompliance, upsOutputSource=upsOutputSource, upsTestResultsSummary=upsTestResultsSummary, upsSubsetOutputGroup=upsSubsetOutputGroup, upsOutputNumLines=upsOutputNumLines, upsAlarmOutputBad=upsAlarmOutputBad, upsShutdownType=upsShutdownType, upsOutputCurrent=upsOutputCurrent, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmShutdownPending=upsAlarmShutdownPending, upsStartupAfterDelay=upsStartupAfterDelay, upsBasicTestGroup=upsBasicTestGroup, upsOutput=upsOutput, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBasicInputGroup=upsBasicInputGroup, upsIdentManufacturer=upsIdentManufacturer, upsConfigLowBattTime=upsConfigLowBattTime, upsBypassCurrent=upsBypassCurrent, upsBasicAlarmGroup=upsBasicAlarmGroup, upsCompliances=upsCompliances, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmLowBattery=upsAlarmLowBattery, PYSNMP_MODULE_ID=upsMIB, upsAlarmId=upsAlarmId, upsConfigInputVoltage=upsConfigInputVoltage, upsConfigAudibleStatus=upsConfigAudibleStatus, upsConfigOutputVA=upsConfigOutputVA, upsBypassEntry=upsBypassEntry, upsInputVoltage=upsInputVoltage, upsAlarmDescr=upsAlarmDescr, upsFullCompliance=upsFullCompliance, upsWellKnownTests=upsWellKnownTests, upsAlarmTestInProgress=upsAlarmTestInProgress, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTestElapsedTime=upsTestElapsedTime, upsFullOutputGroup=upsFullOutputGroup, upsIdentName=upsIdentName, upsAlarmChargerFailed=upsAlarmChargerFailed, upsObjects=upsObjects, upsBypassVoltage=upsBypassVoltage, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmEntry=upsAlarmEntry, NonNegativeInteger=NonNegativeInteger, upsInputTable=upsInputTable, upsFullConfigGroup=upsFullConfigGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsOutputPower=upsOutputPower, upsIdentModel=upsIdentModel, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsFullTestGroup=upsFullTestGroup, upsFullIdentGroup=upsFullIdentGroup, upsOutputLineIndex=upsOutputLineIndex, upsBatteryVoltage=upsBatteryVoltage, upsGroups=upsGroups, upsOutputTable=upsOutputTable, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTestSpinLock=upsTestSpinLock, upsConfigOutputPower=upsConfigOutputPower, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsInputFrequency=upsInputFrequency, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBypassLineIndex=upsBypassLineIndex, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTest=upsTest, upsSubsetConfigGroup=upsSubsetConfigGroup)
