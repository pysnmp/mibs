...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Bits, ObjectIdentity, NotificationType, TimeTicks, Counter64, MibIdentifier, IpAddress, Unsigned32, Integer32, iso, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Bits", "ObjectIdentity", "NotificationType", "TimeTicks", "Counter64", "MibIdentifier", "IpAddress", "Unsigned32", "Integer32", "iso", "mib-2")
...
mibBuilder.exportSymbols("UPS-MIB", upsTestSpinLock=upsTestSpinLock, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsBasicIdentGroup=upsBasicIdentGroup, upsIdent=upsIdent, upsAlarmOnBypass=upsAlarmOnBypass, upsOutputVoltage=upsOutputVoltage, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsOutputPower=upsOutputPower, upsIdentModel=upsIdentModel, upsTrapOnBattery=upsTrapOnBattery, upsInputFrequency=upsInputFrequency, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmId=upsAlarmId, upsBasicCompliance=upsBasicCompliance, upsTrapTestCompleted=upsTrapTestCompleted, upsOutputLineIndex=upsOutputLineIndex, upsSubsetOutputGroup=upsSubsetOutputGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsFullControlGroup=upsFullControlGroup, upsInputEntry=upsInputEntry, upsShutdownAfterDelay=upsShutdownAfterDelay, upsConfigOutputPower=upsConfigOutputPower, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmTempBad=upsAlarmTempBad, upsConfig=upsConfig, upsTestResultsDetail=upsTestResultsDetail, upsBypassEntry=upsBypassEntry, upsIdentManufacturer=upsIdentManufacturer, upsFullBypassGroup=upsFullBypassGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBattery=upsBattery, upsAlarmTestInProgress=upsAlarmTestInProgress, upsOutputPercentLoad=upsOutputPercentLoad, upsBatteryStatus=upsBatteryStatus, upsBatteryTemperature=upsBatteryTemperature, upsInputTable=upsInputTable, upsAlarmDescr=upsAlarmDescr, upsOutputCurrent=upsOutputCurrent, upsAlarmBatteryBad=upsAlarmBatteryBad, upsOutputEntry=upsOutputEntry, upsConfigOutputVA=upsConfigOutputVA, upsTestId=upsTestId, upsConfigLowBattTime=upsConfigLowBattTime, upsBasicConfigGroup=upsBasicConfigGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmLowBattery=upsAlarmLowBattery, upsInputLineIndex=upsInputLineIndex, upsBasicControlGroup=upsBasicControlGroup, upsBypassVoltage=upsBypassVoltage, NonNegativeInteger=NonNegativeInteger, upsSubsetCompliance=upsSubsetCompliance, upsBypass=upsBypass, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsTraps=upsTraps, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsFullBatteryGroup=upsFullBatteryGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsControl=upsControl, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsStartupAfterDelay=upsStartupAfterDelay, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsInputNumLines=upsInputNumLines, upsTestElapsedTime=upsTestElapsedTime, upsBatteryVoltage=upsBatteryVoltage, upsFullOutputGroup=upsFullOutputGroup, upsOutputSource=upsOutputSource, upsOutputFrequency=upsOutputFrequency, upsFullInputGroup=upsFullInputGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmEntry=upsAlarmEntry, upsOutputTable=upsOutputTable, upsBypassTable=upsBypassTable, upsShutdownType=upsShutdownType, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicGroups=upsBasicGroups, upsInputVoltage=upsInputVoltage, upsOutputNumLines=upsOutputNumLines, upsAlarmFanFailure=upsAlarmFanFailure, upsTest=upsTest, upsRebootWithDuration=upsRebootWithDuration, upsBypassNumLines=upsBypassNumLines, upsCompliances=upsCompliances, upsGroups=upsGroups, upsFullGroups=upsFullGroups, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutput=upsOutput, upsAlarmFuseFailure=upsAlarmFuseFailure, upsFullConfigGroup=upsFullConfigGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmChargerFailed=upsAlarmChargerFailed, upsIdentAttachedDevices=upsIdentAttachedDevices, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsInputLineBads=upsInputLineBads, upsBypassLineIndex=upsBypassLineIndex, upsAlarmShutdownImminent=upsAlarmShutdownImminent, PYSNMP_MODULE_ID=upsMIB, upsFullTestGroup=upsFullTestGroup, upsIdentName=upsIdentName, upsConfigOutputFreq=upsConfigOutputFreq, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBasicInputGroup=upsBasicInputGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsTestStartTime=upsTestStartTime, upsFullIdentGroup=upsFullIdentGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmInputBad=upsAlarmInputBad, PositiveInteger=PositiveInteger, upsBypassPower=upsBypassPower, upsConfigAudibleStatus=upsConfigAudibleStatus, upsInputCurrent=upsInputCurrent, upsWellKnownAlarms=upsWellKnownAlarms, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmOutputBad=upsAlarmOutputBad, upsConfigInputFreq=upsConfigInputFreq, upsAlarmTable=upsAlarmTable, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsSubsetGroups=upsSubsetGroups, upsAlarmsPresent=upsAlarmsPresent, upsAutoRestart=upsAutoRestart, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBypassFrequency=upsBypassFrequency, upsAlarm=upsAlarm, upsBypassCurrent=upsBypassCurrent, upsObjects=upsObjects, upsFullAlarmGroup=upsFullAlarmGroup, upsBatteryCurrent=upsBatteryCurrent, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmTime=upsAlarmTime, upsFullCompliance=upsFullCompliance, upsConformance=upsConformance, upsInputTruePower=upsInputTruePower, upsAlarmOutputOverload=upsAlarmOutputOverload, upsMIB=upsMIB, upsWellKnownTests=upsWellKnownTests, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTestResultsSummary=upsTestResultsSummary, upsInput=upsInput, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBasicBypassGroup=upsBasicBypassGroup, upsBasicTestGroup=upsBasicTestGroup)
