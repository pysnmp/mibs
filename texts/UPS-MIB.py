...
MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Integer32, Unsigned32, MibIdentifier, ModuleIdentity, IpAddress, iso, Bits, Counter32, ObjectIdentity, Counter64, TimeTicks, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Integer32", "Unsigned32", "MibIdentifier", "ModuleIdentity", "IpAddress", "iso", "Bits", "Counter32", "ObjectIdentity", "Counter64", "TimeTicks", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("UPS-MIB", upsConfigInputFreq=upsConfigInputFreq, upsAlarmsPresent=upsAlarmsPresent, upsAlarmEntry=upsAlarmEntry, upsShutdownType=upsShutdownType, upsRebootWithDuration=upsRebootWithDuration, upsConformance=upsConformance, upsBasicCompliance=upsBasicCompliance, upsTestStartTime=upsTestStartTime, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsFullInputGroup=upsFullInputGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmId=upsAlarmId, upsBasicBypassGroup=upsBasicBypassGroup, upsTraps=upsTraps, upsBypassLineIndex=upsBypassLineIndex, NonNegativeInteger=NonNegativeInteger, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBatteryVoltage=upsBatteryVoltage, upsBasicControlGroup=upsBasicControlGroup, upsFullOutputGroup=upsFullOutputGroup, upsSubsetCompliance=upsSubsetCompliance, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBasicTestGroup=upsBasicTestGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, PYSNMP_MODULE_ID=upsMIB, upsOutputVoltage=upsOutputVoltage, upsFullTestGroup=upsFullTestGroup, upsBasicInputGroup=upsBasicInputGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarm=upsAlarm, upsFullConfigGroup=upsFullConfigGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsOutputNumLines=upsOutputNumLines, upsInput=upsInput, upsMIB=upsMIB, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTestId=upsTestId, upsBasicOutputGroup=upsBasicOutputGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsTrapOnBattery=upsTrapOnBattery, upsFullBypassGroup=upsFullBypassGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsConfig=upsConfig, upsAlarmFanFailure=upsAlarmFanFailure, upsWellKnownAlarms=upsWellKnownAlarms, upsTest=upsTest, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsSubsetGroups=upsSubsetGroups, upsAlarmLowBattery=upsAlarmLowBattery, upsGroups=upsGroups, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmShutdownPending=upsAlarmShutdownPending, upsSubsetInputGroup=upsSubsetInputGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBattery=upsBattery, upsInputFrequency=upsInputFrequency, upsAlarmInputBad=upsAlarmInputBad, upsOutputLineIndex=upsOutputLineIndex, upsSubsetConfigGroup=upsSubsetConfigGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsOutputSource=upsOutputSource, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsTestResultsDetail=upsTestResultsDetail, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsObjects=upsObjects, upsTestResultsSummary=upsTestResultsSummary, upsTestElapsedTime=upsTestElapsedTime, upsCompliances=upsCompliances, upsBypassNumLines=upsBypassNumLines, upsControl=upsControl, upsFullGroups=upsFullGroups, upsIdent=upsIdent, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutputFrequency=upsOutputFrequency, upsFullCompliance=upsFullCompliance, upsBasicAlarmGroup=upsBasicAlarmGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsOutputEntry=upsOutputEntry, upsBypassVoltage=upsBypassVoltage, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmTime=upsAlarmTime, upsConfigOutputPower=upsConfigOutputPower, upsInputTable=upsInputTable, upsInputNumLines=upsInputNumLines, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmDescr=upsAlarmDescr, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAutoRestart=upsAutoRestart, upsIdentName=upsIdentName, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTestSpinLock=upsTestSpinLock, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBasicGroups=upsBasicGroups, upsAlarmTable=upsAlarmTable, upsBypassTable=upsBypassTable, PositiveInteger=PositiveInteger, upsBypassEntry=upsBypassEntry, upsIdentManufacturer=upsIdentManufacturer, upsOutputCurrent=upsOutputCurrent, upsBypassFrequency=upsBypassFrequency, upsAlarmOnBypass=upsAlarmOnBypass, upsConfigOutputVA=upsConfigOutputVA, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsOutput=upsOutput, upsInputTruePower=upsInputTruePower, upsIdentModel=upsIdentModel, upsAlarmTempBad=upsAlarmTempBad, upsTrapTestCompleted=upsTrapTestCompleted, upsFullBatteryGroup=upsFullBatteryGroup, upsFullControlGroup=upsFullControlGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsStartupAfterDelay=upsStartupAfterDelay, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBatteryTemperature=upsBatteryTemperature, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsInputEntry=upsInputEntry, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsSubsetControlGroup=upsSubsetControlGroup, upsInputVoltage=upsInputVoltage, upsInputLineIndex=upsInputLineIndex, upsAlarmGeneralFault=upsAlarmGeneralFault, upsInputCurrent=upsInputCurrent, upsFullIdentGroup=upsFullIdentGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConfigLowBattTime=upsConfigLowBattTime, upsInputLineBads=upsInputLineBads, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBatteryCurrent=upsBatteryCurrent, upsBypass=upsBypass, upsWellKnownTests=upsWellKnownTests, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBatteryStatus=upsBatteryStatus, upsBypassCurrent=upsBypassCurrent, upsAlarmTestInProgress=upsAlarmTestInProgress, upsOutputPower=upsOutputPower, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBypassPower=upsBypassPower, upsOutputTable=upsOutputTable, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint)
