...
iso, mib_2, Unsigned32, Bits, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, Counter32, ObjectIdentity, NotificationType, IpAddress, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "mib-2", "Unsigned32", "Bits", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "Counter32", "ObjectIdentity", "NotificationType", "IpAddress", "Counter64", "ModuleIdentity")
TextualConvention, TestAndIncr, AutonomousType, TimeStamp, TimeInterval, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TestAndIncr", "AutonomousType", "TimeStamp", "TimeInterval", "DisplayString")
...
mibBuilder.exportSymbols("UPS-MIB", upsInputFrequency=upsInputFrequency, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsOutputNumLines=upsOutputNumLines, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmOutputBad=upsAlarmOutputBad, upsConfig=upsConfig, upsAlarmBypassBad=upsAlarmBypassBad, upsOutputPower=upsOutputPower, upsOutputEntry=upsOutputEntry, upsOutput=upsOutput, upsFullOutputGroup=upsFullOutputGroup, upsInputLineBads=upsInputLineBads, upsTestResultsDetail=upsTestResultsDetail, upsShutdownType=upsShutdownType, upsTestSpinLock=upsTestSpinLock, upsGroups=upsGroups, upsOutputPercentLoad=upsOutputPercentLoad, upsTestId=upsTestId, upsFullGroups=upsFullGroups, upsAutoRestart=upsAutoRestart, upsBypassTable=upsBypassTable, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBatteryCurrent=upsBatteryCurrent, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, PositiveInteger=PositiveInteger, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmOnBypass=upsAlarmOnBypass, upsConformance=upsConformance, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsFullConfigGroup=upsFullConfigGroup, upsTest=upsTest, upsAlarm=upsAlarm, upsAlarmTime=upsAlarmTime, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBatteryTemperature=upsBatteryTemperature, upsFullCompliance=upsFullCompliance, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsCompliances=upsCompliances, upsSubsetCompliance=upsSubsetCompliance, upsInputEntry=upsInputEntry, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBasicGroups=upsBasicGroups, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsRebootWithDuration=upsRebootWithDuration, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBasicOutputGroup=upsBasicOutputGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullBypassGroup=upsFullBypassGroup, upsAlarmDescr=upsAlarmDescr, upsBypassNumLines=upsBypassNumLines, upsTrapTestCompleted=upsTrapTestCompleted, upsSecondsOnBattery=upsSecondsOnBattery, upsBasicControlGroup=upsBasicControlGroup, upsAlarmEntry=upsAlarmEntry, upsConfigLowBattTime=upsConfigLowBattTime, upsConfigOutputFreq=upsConfigOutputFreq, upsTraps=upsTraps, upsFullControlGroup=upsFullControlGroup, upsBattery=upsBattery, upsTrapOnBattery=upsTrapOnBattery, upsBatteryStatus=upsBatteryStatus, upsInputCurrent=upsInputCurrent, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmsPresent=upsAlarmsPresent, upsFullInputGroup=upsFullInputGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmInputBad=upsAlarmInputBad, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmLowBattery=upsAlarmLowBattery, upsStartupAfterDelay=upsStartupAfterDelay, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBasicCompliance=upsBasicCompliance, upsBypassLineIndex=upsBypassLineIndex, upsShutdownAfterDelay=upsShutdownAfterDelay, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmTable=upsAlarmTable, upsTestElapsedTime=upsTestElapsedTime, upsBasicConfigGroup=upsBasicConfigGroup, upsBypassPower=upsBypassPower, upsObjects=upsObjects, upsAlarmId=upsAlarmId, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBatteryVoltage=upsBatteryVoltage, upsBypassCurrent=upsBypassCurrent, upsSubsetInputGroup=upsSubsetInputGroup, upsSubsetGroups=upsSubsetGroups, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmFuseFailure=upsAlarmFuseFailure, upsFullIdentGroup=upsFullIdentGroup, upsAlarmTempBad=upsAlarmTempBad, upsIdentName=upsIdentName, upsTestStartTime=upsTestStartTime, upsIdentModel=upsIdentModel, upsTestResultsSummary=upsTestResultsSummary, upsOutputLineIndex=upsOutputLineIndex, NonNegativeInteger=NonNegativeInteger, upsInputLineIndex=upsInputLineIndex, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmFanFailure=upsAlarmFanFailure, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsConfigOutputPower=upsConfigOutputPower, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBypassEntry=upsBypassEntry, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, PYSNMP_MODULE_ID=upsMIB, upsWellKnownTests=upsWellKnownTests, upsAlarmOnBattery=upsAlarmOnBattery, upsOutputCurrent=upsOutputCurrent, upsInputTable=upsInputTable, upsBypassFrequency=upsBypassFrequency, upsOutputFrequency=upsOutputFrequency, upsConfigOutputVA=upsConfigOutputVA, upsOutputTable=upsOutputTable, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsBasicTestGroup=upsBasicTestGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBypass=upsBypass, upsBypassVoltage=upsBypassVoltage, upsInputVoltage=upsInputVoltage, upsConfigInputVoltage=upsConfigInputVoltage, upsOutputVoltage=upsOutputVoltage, upsConfigInputFreq=upsConfigInputFreq, upsMIB=upsMIB, upsAlarmBatteryBad=upsAlarmBatteryBad, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmChargerFailed=upsAlarmChargerFailed, upsFullAlarmGroup=upsFullAlarmGroup, upsIdentManufacturer=upsIdentManufacturer, upsInput=upsInput, upsInputNumLines=upsInputNumLines, upsFullTestGroup=upsFullTestGroup, upsIdent=upsIdent, upsInputTruePower=upsInputTruePower, upsOutputSource=upsOutputSource, upsBasicInputGroup=upsBasicInputGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsControl=upsControl, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBasicIdentGroup=upsBasicIdentGroup)
