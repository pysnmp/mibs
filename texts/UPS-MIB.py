...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, mib_2, MibIdentifier, Counter64, NotificationType, ModuleIdentity, TimeTicks, Integer32, iso, ObjectIdentity, Bits, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "mib-2", "MibIdentifier", "Counter64", "NotificationType", "ModuleIdentity", "TimeTicks", "Integer32", "iso", "ObjectIdentity", "Bits", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("UPS-MIB", upsConfig=upsConfig, upsBatteryStatus=upsBatteryStatus, upsAlarmTable=upsAlarmTable, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTrapTestCompleted=upsTrapTestCompleted, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmTime=upsAlarmTime, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsShutdownType=upsShutdownType, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBypassFrequency=upsBypassFrequency, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsFullConfigGroup=upsFullConfigGroup, upsInputNumLines=upsInputNumLines, upsBasicIdentGroup=upsBasicIdentGroup, upsBypass=upsBypass, upsBasicCompliance=upsBasicCompliance, upsTestResultsDetail=upsTestResultsDetail, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBypassVoltage=upsBypassVoltage, upsAlarm=upsAlarm, upsFullTestGroup=upsFullTestGroup, PYSNMP_MODULE_ID=upsMIB, upsConfigOutputPower=upsConfigOutputPower, upsIdentAttachedDevices=upsIdentAttachedDevices, upsOutputLineIndex=upsOutputLineIndex, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicControlGroup=upsBasicControlGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmEntry=upsAlarmEntry, upsAlarmShutdownPending=upsAlarmShutdownPending, upsSubsetControlGroup=upsSubsetControlGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsFullBypassGroup=upsFullBypassGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsOutputTable=upsOutputTable, upsOutputNumLines=upsOutputNumLines, upsSubsetCompliance=upsSubsetCompliance, upsObjects=upsObjects, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBasicOutputGroup=upsBasicOutputGroup, upsControl=upsControl, upsInputEntry=upsInputEntry, upsAlarmOutputBad=upsAlarmOutputBad, upsBatteryVoltage=upsBatteryVoltage, upsRebootWithDuration=upsRebootWithDuration, upsConfigOutputVoltage=upsConfigOutputVoltage, upsTraps=upsTraps, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBasicBypassGroup=upsBasicBypassGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsConfigOutputVA=upsConfigOutputVA, upsConformance=upsConformance, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutputFrequency=upsOutputFrequency, upsInputVoltage=upsInputVoltage, upsConfigAudibleStatus=upsConfigAudibleStatus, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmsPresent=upsAlarmsPresent, PositiveInteger=PositiveInteger, upsFullBatteryGroup=upsFullBatteryGroup, upsBypassEntry=upsBypassEntry, upsAlarmInputBad=upsAlarmInputBad, upsOutputPower=upsOutputPower, upsBasicGroups=upsBasicGroups, upsFullOutputGroup=upsFullOutputGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAutoRestart=upsAutoRestart, upsWellKnownTests=upsWellKnownTests, upsTest=upsTest, upsBypassNumLines=upsBypassNumLines, upsBypassTable=upsBypassTable, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsIdentModel=upsIdentModel, upsBasicTestGroup=upsBasicTestGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmLowBattery=upsAlarmLowBattery, upsInputCurrent=upsInputCurrent, upsAlarmFuseFailure=upsAlarmFuseFailure, NonNegativeInteger=NonNegativeInteger, upsTrapOnBattery=upsTrapOnBattery, upsStartupAfterDelay=upsStartupAfterDelay, upsOutputPercentLoad=upsOutputPercentLoad, upsBypassPower=upsBypassPower, upsConfigInputVoltage=upsConfigInputVoltage, upsInputLineBads=upsInputLineBads, upsTestStartTime=upsTestStartTime, upsConfigOutputFreq=upsConfigOutputFreq, upsInputTable=upsInputTable, upsAlarmTestInProgress=upsAlarmTestInProgress, upsWellKnownAlarms=upsWellKnownAlarms, upsTestId=upsTestId, upsBypassCurrent=upsBypassCurrent, upsAlarmBypassBad=upsAlarmBypassBad, upsOutputCurrent=upsOutputCurrent, upsInput=upsInput, upsOutputVoltage=upsOutputVoltage, upsBatteryCurrent=upsBatteryCurrent, upsIdentManufacturer=upsIdentManufacturer, upsFullIdentGroup=upsFullIdentGroup, upsIdentName=upsIdentName, upsAlarmId=upsAlarmId, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBasicConfigGroup=upsBasicConfigGroup, upsBatteryTemperature=upsBatteryTemperature, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsGroups=upsGroups, upsTestResultsSummary=upsTestResultsSummary, upsFullCompliance=upsFullCompliance, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBasicInputGroup=upsBasicInputGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBypassLineIndex=upsBypassLineIndex, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsShutdownAfterDelay=upsShutdownAfterDelay, upsInputFrequency=upsInputFrequency, upsBattery=upsBattery, upsAlarmOnBattery=upsAlarmOnBattery, upsFullGroups=upsFullGroups, upsInputLineIndex=upsInputLineIndex, upsCompliances=upsCompliances, upsSecondsOnBattery=upsSecondsOnBattery, upsOutput=upsOutput, upsInputTruePower=upsInputTruePower, upsAlarmOnBypass=upsAlarmOnBypass, upsSubsetGroups=upsSubsetGroups, upsFullInputGroup=upsFullInputGroup, upsOutputEntry=upsOutputEntry, upsIdent=upsIdent, upsFullControlGroup=upsFullControlGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmTempBad=upsAlarmTempBad, upsTestSpinLock=upsTestSpinLock, upsMIB=upsMIB, upsOutputSource=upsOutputSource, upsTestElapsedTime=upsTestElapsedTime, upsConfigInputFreq=upsConfigInputFreq, upsAlarmDescr=upsAlarmDescr, upsConfigLowBattTime=upsConfigLowBattTime)
