...
mibBuilder.exportSymbols("UPS-MIB", upsAutoRestart=upsAutoRestart, upsOutputTable=upsOutputTable, upsInputTruePower=upsInputTruePower, upsBypassLineIndex=upsBypassLineIndex, upsTestElapsedTime=upsTestElapsedTime, upsInputEntry=upsInputEntry, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmTime=upsAlarmTime, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTestResultsDetail=upsTestResultsDetail, upsStartupAfterDelay=upsStartupAfterDelay, upsObjects=upsObjects, upsBypassVoltage=upsBypassVoltage, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsSubsetCompliance=upsSubsetCompliance, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsOutputPower=upsOutputPower, upsBypassCurrent=upsBypassCurrent, upsBattery=upsBattery, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBasicInputGroup=upsBasicInputGroup, upsBasicCompliance=upsBasicCompliance, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBasicBypassGroup=upsBasicBypassGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBatteryVoltage=upsBatteryVoltage, upsOutputFrequency=upsOutputFrequency, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsFullGroups=upsFullGroups, upsControl=upsControl, upsConfigLowBattTime=upsConfigLowBattTime, NonNegativeInteger=NonNegativeInteger, upsOutputPercentLoad=upsOutputPercentLoad, upsInputFrequency=upsInputFrequency, upsOutputSource=upsOutputSource, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBasicBatteryGroup=upsBasicBatteryGroup, upsShutdownType=upsShutdownType, upsAlarmGeneralFault=upsAlarmGeneralFault, upsInputCurrent=upsInputCurrent, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmId=upsAlarmId, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmDescr=upsAlarmDescr, upsBypassNumLines=upsBypassNumLines, upsConfigOutputFreq=upsConfigOutputFreq, upsTestStartTime=upsTestStartTime, upsAlarmOutputBad=upsAlarmOutputBad, upsIdentModel=upsIdentModel, upsFullCompliance=upsFullCompliance, upsAlarmTempBad=upsAlarmTempBad, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsFullBatteryGroup=upsFullBatteryGroup, upsWellKnownTests=upsWellKnownTests, upsMIB=upsMIB, upsAlarmChargerFailed=upsAlarmChargerFailed, upsInputVoltage=upsInputVoltage, upsFullControlGroup=upsFullControlGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConformance=upsConformance, upsBatteryCurrent=upsBatteryCurrent, upsOutputNumLines=upsOutputNumLines, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmEntry=upsAlarmEntry, upsBasicGroups=upsBasicGroups, upsBypassEntry=upsBypassEntry, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarm=upsAlarm, upsInputTable=upsInputTable, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBypass=upsBypass, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsInput=upsInput, upsConfigOutputPower=upsConfigOutputPower, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, PYSNMP_MODULE_ID=upsMIB, upsInputLineBads=upsInputLineBads, upsBatteryStatus=upsBatteryStatus, upsBypassTable=upsBypassTable, PositiveInteger=PositiveInteger, upsAlarmsPresent=upsAlarmsPresent, upsFullBypassGroup=upsFullBypassGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmFanFailure=upsAlarmFanFailure, upsTraps=upsTraps, upsSecondsOnBattery=upsSecondsOnBattery, upsFullConfigGroup=upsFullConfigGroup, upsBasicTestGroup=upsBasicTestGroup, upsTestResultsSummary=upsTestResultsSummary, upsGroups=upsGroups, upsOutputLineIndex=upsOutputLineIndex, upsCompliances=upsCompliances, upsTestSpinLock=upsTestSpinLock, upsInputLineIndex=upsInputLineIndex, upsAlarmOnBypass=upsAlarmOnBypass, upsIdentName=upsIdentName, upsConfig=upsConfig, upsConfigOutputVA=upsConfigOutputVA, upsBypassFrequency=upsBypassFrequency, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTest=upsTest, upsTrapTestCompleted=upsTrapTestCompleted, upsBasicConfigGroup=upsBasicConfigGroup, upsTestId=upsTestId, upsFullInputGroup=upsFullInputGroup, upsBasicControlGroup=upsBasicControlGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsFullTestGroup=upsFullTestGroup, upsBatteryTemperature=upsBatteryTemperature, upsFullOutputGroup=upsFullOutputGroup, upsOutput=upsOutput, upsShutdownAfterDelay=upsShutdownAfterDelay, upsOutputEntry=upsOutputEntry, upsOutputCurrent=upsOutputCurrent, upsIdent=upsIdent, upsRebootWithDuration=upsRebootWithDuration, upsBypassPower=upsBypassPower, upsSubsetOutputGroup=upsSubsetOutputGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmLowBattery=upsAlarmLowBattery, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmOnBattery=upsAlarmOnBattery, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsSubsetGroups=upsSubsetGroups, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmTable=upsAlarmTable, upsAlarmInputBad=upsAlarmInputBad, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBasicAlarmGroup=upsBasicAlarmGroup, upsFullIdentGroup=upsFullIdentGroup, upsTrapOnBattery=upsTrapOnBattery, upsIdentManufacturer=upsIdentManufacturer, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsConfigInputFreq=upsConfigInputFreq, upsInputNumLines=upsInputNumLines, upsSubsetControlGroup=upsSubsetControlGroup, upsOutputVoltage=upsOutputVoltage, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint)
