...
mibBuilder.exportSymbols("UPS-MIB", PositiveInteger=PositiveInteger, upsInputCurrent=upsInputCurrent, upsAlarm=upsAlarm, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmEntry=upsAlarmEntry, upsSecondsOnBattery=upsSecondsOnBattery, upsStartupAfterDelay=upsStartupAfterDelay, upsInputEntry=upsInputEntry, upsFullControlGroup=upsFullControlGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBypassEntry=upsBypassEntry, PYSNMP_MODULE_ID=upsMIB, upsBypassCurrent=upsBypassCurrent, upsBasicBatteryGroup=upsBasicBatteryGroup, upsInputVoltage=upsInputVoltage, upsConfigLowBattTime=upsConfigLowBattTime, upsBasicIdentGroup=upsBasicIdentGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmTempBad=upsAlarmTempBad, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsInput=upsInput, upsIdentName=upsIdentName, upsAlarmBypassBad=upsAlarmBypassBad, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsBatteryVoltage=upsBatteryVoltage, upsConfigOutputVA=upsConfigOutputVA, upsOutput=upsOutput, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBasicConfigGroup=upsBasicConfigGroup, upsTraps=upsTraps, upsBatteryTemperature=upsBatteryTemperature, upsWellKnownTests=upsWellKnownTests, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBypassNumLines=upsBypassNumLines, upsInputFrequency=upsInputFrequency, upsFullAlarmGroup=upsFullAlarmGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsBypassLineIndex=upsBypassLineIndex, upsConfigInputFreq=upsConfigInputFreq, upsInputLineIndex=upsInputLineIndex, upsBatteryCurrent=upsBatteryCurrent, upsBypassTable=upsBypassTable, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfigOutputFreq=upsConfigOutputFreq, upsFullConfigGroup=upsFullConfigGroup, upsBypassPower=upsBypassPower, upsOutputSource=upsOutputSource, upsInputLineBads=upsInputLineBads, upsOutputNumLines=upsOutputNumLines, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsFullGroups=upsFullGroups, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmTime=upsAlarmTime, upsAlarmId=upsAlarmId, upsOutputTable=upsOutputTable, upsAlarmOutputBad=upsAlarmOutputBad, upsIdent=upsIdent, upsOutputPercentLoad=upsOutputPercentLoad, upsCompliances=upsCompliances, upsSubsetInputGroup=upsSubsetInputGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsIdentManufacturer=upsIdentManufacturer, upsFullOutputGroup=upsFullOutputGroup, upsOutputLineIndex=upsOutputLineIndex, upsControl=upsControl, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBasicAlarmGroup=upsBasicAlarmGroup, upsConfig=upsConfig, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBasicInputGroup=upsBasicInputGroup, upsConfigOutputPower=upsConfigOutputPower, upsObjects=upsObjects, upsIdentModel=upsIdentModel, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsBatteryStatus=upsBatteryStatus, upsOutputCurrent=upsOutputCurrent, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsFullIdentGroup=upsFullIdentGroup, upsBypassFrequency=upsBypassFrequency, upsRebootWithDuration=upsRebootWithDuration, upsFullInputGroup=upsFullInputGroup, upsInputTruePower=upsInputTruePower, upsBasicControlGroup=upsBasicControlGroup, upsTrapOnBattery=upsTrapOnBattery, upsOutputVoltage=upsOutputVoltage, upsFullCompliance=upsFullCompliance, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsOutputFrequency=upsOutputFrequency, upsFullTestGroup=upsFullTestGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmOnBypass=upsAlarmOnBypass, upsSubsetCompliance=upsSubsetCompliance, upsShutdownType=upsShutdownType, upsTestId=upsTestId, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBasicGroups=upsBasicGroups, upsTestStartTime=upsTestStartTime, upsMIB=upsMIB, upsGroups=upsGroups, upsAlarmsPresent=upsAlarmsPresent, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBasicCompliance=upsBasicCompliance, upsAlarmOnBattery=upsAlarmOnBattery, upsBypassVoltage=upsBypassVoltage, upsAutoRestart=upsAutoRestart, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsTestResultsSummary=upsTestResultsSummary, upsTrapTestCompleted=upsTrapTestCompleted, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmDescr=upsAlarmDescr, upsAlarmInputBad=upsAlarmInputBad, upsConformance=upsConformance, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsTestResultsDetail=upsTestResultsDetail, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTestElapsedTime=upsTestElapsedTime, upsAlarmTestInProgress=upsAlarmTestInProgress, upsOutputEntry=upsOutputEntry, upsFullBypassGroup=upsFullBypassGroup, NonNegativeInteger=NonNegativeInteger, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestSpinLock=upsTestSpinLock, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBasicTestGroup=upsBasicTestGroup, upsAlarmTable=upsAlarmTable, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmLowBattery=upsAlarmLowBattery, upsTest=upsTest, upsOutputPower=upsOutputPower, upsInputTable=upsInputTable, upsBypass=upsBypass, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmGeneralFault=upsAlarmGeneralFault, upsConfigInputVoltage=upsConfigInputVoltage, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsSubsetGroups=upsSubsetGroups, upsBasicBypassGroup=upsBasicBypassGroup, upsBattery=upsBattery, upsInputNumLines=upsInputNumLines)
