...
mibBuilder.exportSymbols("UPS-MIB", upsBasicTestGroup=upsBasicTestGroup, upsRebootWithDuration=upsRebootWithDuration, upsControl=upsControl, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsFullBatteryGroup=upsFullBatteryGroup, PYSNMP_MODULE_ID=upsMIB, upsAlarmBypassBad=upsAlarmBypassBad, upsBypassNumLines=upsBypassNumLines, upsSubsetCompliance=upsSubsetCompliance, upsBasicConfigGroup=upsBasicConfigGroup, upsFullIdentGroup=upsFullIdentGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsCompliances=upsCompliances, upsBypassEntry=upsBypassEntry, upsInputTable=upsInputTable, upsBasicControlGroup=upsBasicControlGroup, upsAlarmId=upsAlarmId, upsBasicGroups=upsBasicGroups, upsTestResultsSummary=upsTestResultsSummary, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTestElapsedTime=upsTestElapsedTime, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBypassPower=upsBypassPower, NonNegativeInteger=NonNegativeInteger, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmInputBad=upsAlarmInputBad, upsMIB=upsMIB, upsGroups=upsGroups, upsAlarmFanFailure=upsAlarmFanFailure, upsFullGroups=upsFullGroups, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsInput=upsInput, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsOutputVoltage=upsOutputVoltage, upsAlarmEntry=upsAlarmEntry, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsOutputFrequency=upsOutputFrequency, upsBasicBatteryGroup=upsBasicBatteryGroup, upsFullControlGroup=upsFullControlGroup, PositiveInteger=PositiveInteger, upsIdent=upsIdent, upsInputTruePower=upsInputTruePower, upsShutdownType=upsShutdownType, upsSubsetControlGroup=upsSubsetControlGroup, upsBypassFrequency=upsBypassFrequency, upsConfig=upsConfig, upsFullAlarmGroup=upsFullAlarmGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsOutput=upsOutput, upsOutputCurrent=upsOutputCurrent, upsConfigOutputPower=upsConfigOutputPower, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsOutputPower=upsOutputPower, upsBattery=upsBattery, upsBypass=upsBypass, upsFullTestGroup=upsFullTestGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAutoRestart=upsAutoRestart, upsSubsetInputGroup=upsSubsetInputGroup, upsInputEntry=upsInputEntry, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBypassCurrent=upsBypassCurrent, upsAlarm=upsAlarm, upsTestResultsDetail=upsTestResultsDetail, upsTraps=upsTraps, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmOnBypass=upsAlarmOnBypass, upsFullCompliance=upsFullCompliance, upsConfigInputVoltage=upsConfigInputVoltage, upsBasicBypassGroup=upsBasicBypassGroup, upsConformance=upsConformance, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsOutputEntry=upsOutputEntry, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullConfigGroup=upsFullConfigGroup, upsInputFrequency=upsInputFrequency, upsAlarmsPresent=upsAlarmsPresent, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsIdentName=upsIdentName, upsOutputPercentLoad=upsOutputPercentLoad, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmDescr=upsAlarmDescr, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBatteryStatus=upsBatteryStatus, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTestSpinLock=upsTestSpinLock, upsTestStartTime=upsTestStartTime, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBatteryTemperature=upsBatteryTemperature, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsSubsetConfigGroup=upsSubsetConfigGroup, upsObjects=upsObjects, upsFullInputGroup=upsFullInputGroup, upsBatteryVoltage=upsBatteryVoltage, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsInputLineIndex=upsInputLineIndex, upsWellKnownTests=upsWellKnownTests, upsInputVoltage=upsInputVoltage, upsIdentManufacturer=upsIdentManufacturer, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmTempBad=upsAlarmTempBad, upsConfigOutputFreq=upsConfigOutputFreq, upsInputCurrent=upsInputCurrent, upsBypassLineIndex=upsBypassLineIndex, upsOutputTable=upsOutputTable, upsOutputLineIndex=upsOutputLineIndex, upsAlarmOnBattery=upsAlarmOnBattery, upsIdentModel=upsIdentModel, upsBypassVoltage=upsBypassVoltage, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullBypassGroup=upsFullBypassGroup, upsBatteryCurrent=upsBatteryCurrent, upsSubsetGroups=upsSubsetGroups, upsConfigInputFreq=upsConfigInputFreq, upsTest=upsTest, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConfigLowBattTime=upsConfigLowBattTime, upsBypassTable=upsBypassTable, upsBasicIdentGroup=upsBasicIdentGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmTime=upsAlarmTime, upsBasicCompliance=upsBasicCompliance, upsTrapTestCompleted=upsTrapTestCompleted, upsInputLineBads=upsInputLineBads, upsAlarmShutdownPending=upsAlarmShutdownPending, upsInputNumLines=upsInputNumLines, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmTable=upsAlarmTable, upsTestId=upsTestId, upsSecondsOnBattery=upsSecondsOnBattery, upsFullOutputGroup=upsFullOutputGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsConfigOutputVA=upsConfigOutputVA, upsAlarmTestInProgress=upsAlarmTestInProgress, upsOutputSource=upsOutputSource, upsOutputNumLines=upsOutputNumLines, upsTrapOnBattery=upsTrapOnBattery, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBasicInputGroup=upsBasicInputGroup)
