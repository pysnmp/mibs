...
mibBuilder.exportSymbols("UPS-MIB", upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsWellKnownAlarms=upsWellKnownAlarms, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsOutputFrequency=upsOutputFrequency, upsOutputVoltage=upsOutputVoltage, upsObjects=upsObjects, upsAlarmDescr=upsAlarmDescr, upsInputEntry=upsInputEntry, upsFullBatteryGroup=upsFullBatteryGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBypassEntry=upsBypassEntry, upsTrapTestCompleted=upsTrapTestCompleted, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutputPower=upsOutputPower, upsTestSpinLock=upsTestSpinLock, upsAlarmOnBattery=upsAlarmOnBattery, upsBypassTable=upsBypassTable, upsFullGroups=upsFullGroups, upsAlarm=upsAlarm, upsBasicGroups=upsBasicGroups, upsSubsetControlGroup=upsSubsetControlGroup, upsRebootWithDuration=upsRebootWithDuration, upsBattery=upsBattery, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsInputVoltage=upsInputVoltage, upsBypassVoltage=upsBypassVoltage, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBasicTestGroup=upsBasicTestGroup, upsFullBypassGroup=upsFullBypassGroup, upsBatteryCurrent=upsBatteryCurrent, upsAlarmFanFailure=upsAlarmFanFailure, upsInputTruePower=upsInputTruePower, upsBypassLineIndex=upsBypassLineIndex, upsBatteryTemperature=upsBatteryTemperature, upsFullInputGroup=upsFullInputGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBasicAlarmGroup=upsBasicAlarmGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmTime=upsAlarmTime, upsTestResultsDetail=upsTestResultsDetail, NonNegativeInteger=NonNegativeInteger, upsBatteryVoltage=upsBatteryVoltage, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmTable=upsAlarmTable, upsOutputLineIndex=upsOutputLineIndex, upsIdentManufacturer=upsIdentManufacturer, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsInputLineBads=upsInputLineBads, upsBypass=upsBypass, upsAutoRestart=upsAutoRestart, upsCompliances=upsCompliances, upsInputCurrent=upsInputCurrent, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmTempBad=upsAlarmTempBad, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsFullCompliance=upsFullCompliance, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmEntry=upsAlarmEntry, upsConfigLowBattTime=upsConfigLowBattTime, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBasicInputGroup=upsBasicInputGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsFullControlGroup=upsFullControlGroup, upsBypassCurrent=upsBypassCurrent, upsBypassPower=upsBypassPower, upsOutputTable=upsOutputTable, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmInputBad=upsAlarmInputBad, upsMIB=upsMIB, upsTraps=upsTraps, upsBasicControlGroup=upsBasicControlGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsConfig=upsConfig, upsConfigInputFreq=upsConfigInputFreq, upsTestStartTime=upsTestStartTime, upsTrapOnBattery=upsTrapOnBattery, upsTest=upsTest, upsAlarmsPresent=upsAlarmsPresent, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmOnBypass=upsAlarmOnBypass, upsFullTestGroup=upsFullTestGroup, upsInputTable=upsInputTable, upsOutputSource=upsOutputSource, upsFullIdentGroup=upsFullIdentGroup, upsFullOutputGroup=upsFullOutputGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsInputFrequency=upsInputFrequency, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsGroups=upsGroups, upsShutdownType=upsShutdownType, upsBasicCompliance=upsBasicCompliance, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsShutdownAfterDelay=upsShutdownAfterDelay, upsConfigOutputVA=upsConfigOutputVA, upsOutput=upsOutput, upsTestId=upsTestId, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsControl=upsControl, upsConfigOutputVoltage=upsConfigOutputVoltage, upsConformance=upsConformance, upsStartupAfterDelay=upsStartupAfterDelay, upsBasicBypassGroup=upsBasicBypassGroup, upsBypassFrequency=upsBypassFrequency, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmId=upsAlarmId, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsInput=upsInput, upsInputLineIndex=upsInputLineIndex, upsOutputEntry=upsOutputEntry, upsBypassNumLines=upsBypassNumLines, upsIdent=upsIdent, upsSubsetGroups=upsSubsetGroups, upsSecondsOnBattery=upsSecondsOnBattery, upsTestResultsSummary=upsTestResultsSummary, upsOutputNumLines=upsOutputNumLines, upsTestElapsedTime=upsTestElapsedTime, upsInputNumLines=upsInputNumLines, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsConfigOutputPower=upsConfigOutputPower, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsSubsetCompliance=upsSubsetCompliance, PositiveInteger=PositiveInteger, upsIdentName=upsIdentName, upsBatteryStatus=upsBatteryStatus, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsOutputCurrent=upsOutputCurrent, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmShutdownPending=upsAlarmShutdownPending, upsWellKnownTests=upsWellKnownTests, upsFullConfigGroup=upsFullConfigGroup, PYSNMP_MODULE_ID=upsMIB, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmChargerFailed=upsAlarmChargerFailed, upsSubsetInputGroup=upsSubsetInputGroup, upsIdentModel=upsIdentModel, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff)
