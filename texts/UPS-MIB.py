...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarm=upsAlarm, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTestResultsSummary=upsTestResultsSummary, upsBasicTestGroup=upsBasicTestGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutputNumLines=upsOutputNumLines, upsInputTable=upsInputTable, upsTestId=upsTestId, upsShutdownType=upsShutdownType, upsWellKnownTests=upsWellKnownTests, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBasicCompliance=upsBasicCompliance, upsConfigLowBattTime=upsConfigLowBattTime, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmBypassBad=upsAlarmBypassBad, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmOnBattery=upsAlarmOnBattery, upsInputLineBads=upsInputLineBads, upsBasicAlarmGroup=upsBasicAlarmGroup, upsTrapOnBattery=upsTrapOnBattery, upsConfigOutputVoltage=upsConfigOutputVoltage, upsFullOutputGroup=upsFullOutputGroup, upsSubsetGroups=upsSubsetGroups, upsAlarmTable=upsAlarmTable, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestResultsDetail=upsTestResultsDetail, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsSubsetCompliance=upsSubsetCompliance, upsAutoRestart=upsAutoRestart, upsFullBatteryGroup=upsFullBatteryGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBasicGroups=upsBasicGroups, upsFullTestGroup=upsFullTestGroup, upsOutputPower=upsOutputPower, upsBypassTable=upsBypassTable, upsFullBypassGroup=upsFullBypassGroup, upsIdent=upsIdent, upsAlarmsPresent=upsAlarmsPresent, NonNegativeInteger=NonNegativeInteger, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmFanFailure=upsAlarmFanFailure, upsBattery=upsBattery, upsMIB=upsMIB, upsInputVoltage=upsInputVoltage, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBypassPower=upsBypassPower, upsTestElapsedTime=upsTestElapsedTime, upsSubsetControlGroup=upsSubsetControlGroup, upsFullConfigGroup=upsFullConfigGroup, upsTestStartTime=upsTestStartTime, PositiveInteger=PositiveInteger, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsFullInputGroup=upsFullInputGroup, upsControl=upsControl, upsCompliances=upsCompliances, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsInputLineIndex=upsInputLineIndex, upsOutputFrequency=upsOutputFrequency, upsRebootWithDuration=upsRebootWithDuration, upsFullGroups=upsFullGroups, upsIdentManufacturer=upsIdentManufacturer, upsAlarmDescr=upsAlarmDescr, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBypassCurrent=upsBypassCurrent, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmTempBad=upsAlarmTempBad, upsOutputCurrent=upsOutputCurrent, upsSubsetIdentGroup=upsSubsetIdentGroup, upsConfig=upsConfig, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsOutputTable=upsOutputTable, upsBatteryStatus=upsBatteryStatus, upsTrapTestCompleted=upsTrapTestCompleted, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmInputBad=upsAlarmInputBad, upsIdentModel=upsIdentModel, upsBatteryVoltage=upsBatteryVoltage, upsBypassFrequency=upsBypassFrequency, upsObjects=upsObjects, upsOutputEntry=upsOutputEntry, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmTestInProgress=upsAlarmTestInProgress, upsOutput=upsOutput, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmOnBypass=upsAlarmOnBypass, upsOutputSource=upsOutputSource, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsSecondsOnBattery=upsSecondsOnBattery, upsInputNumLines=upsInputNumLines, upsTraps=upsTraps, upsBasicBypassGroup=upsBasicBypassGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsInput=upsInput, upsFullAlarmGroup=upsFullAlarmGroup, upsInputEntry=upsInputEntry, upsInputFrequency=upsInputFrequency, PYSNMP_MODULE_ID=upsMIB, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullIdentGroup=upsFullIdentGroup, upsBypassNumLines=upsBypassNumLines, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicInputGroup=upsBasicInputGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsOutputLineIndex=upsOutputLineIndex, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmTime=upsAlarmTime, upsFullCompliance=upsFullCompliance, upsBatteryTemperature=upsBatteryTemperature, upsInputCurrent=upsInputCurrent, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBatteryCurrent=upsBatteryCurrent, upsTest=upsTest, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsFullControlGroup=upsFullControlGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBasicControlGroup=upsBasicControlGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsGroups=upsGroups, upsBypassVoltage=upsBypassVoltage, upsBypassLineIndex=upsBypassLineIndex, upsConfigOutputVA=upsConfigOutputVA, upsAlarmEntry=upsAlarmEntry, upsAlarmId=upsAlarmId, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBypass=upsBypass, upsConfigInputVoltage=upsConfigInputVoltage, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmBatteryBad=upsAlarmBatteryBad, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsTestSpinLock=upsTestSpinLock, upsWellKnownAlarms=upsWellKnownAlarms, upsConformance=upsConformance, upsIdentName=upsIdentName, upsOutputVoltage=upsOutputVoltage, upsBypassEntry=upsBypassEntry, upsConfigInputFreq=upsConfigInputFreq, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsInputTruePower=upsInputTruePower, upsConfigOutputPower=upsConfigOutputPower)
