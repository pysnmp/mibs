...
mibBuilder.exportSymbols("UPS-MIB", upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBasicControlGroup=upsBasicControlGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmDescr=upsAlarmDescr, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsStartupAfterDelay=upsStartupAfterDelay, upsBasicBypassGroup=upsBasicBypassGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsTest=upsTest, upsBypassVoltage=upsBypassVoltage, upsAlarmId=upsAlarmId, upsAlarmOnBypass=upsAlarmOnBypass, upsBatteryStatus=upsBatteryStatus, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsIdentName=upsIdentName, upsAlarm=upsAlarm, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsOutputPower=upsOutputPower, upsBypassNumLines=upsBypassNumLines, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmBypassBad=upsAlarmBypassBad, upsSubsetControlGroup=upsSubsetControlGroup, upsControl=upsControl, upsBypassTable=upsBypassTable, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmsPresent=upsAlarmsPresent, upsTrapOnBattery=upsTrapOnBattery, upsAlarmFanFailure=upsAlarmFanFailure, upsInput=upsInput, upsSubsetOutputGroup=upsSubsetOutputGroup, upsInputTable=upsInputTable, upsConfigInputVoltage=upsConfigInputVoltage, upsBattery=upsBattery, upsConformance=upsConformance, upsBasicCompliance=upsBasicCompliance, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsInputVoltage=upsInputVoltage, upsAlarmOutputBad=upsAlarmOutputBad, upsBypass=upsBypass, upsFullTestGroup=upsFullTestGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBasicTestGroup=upsBasicTestGroup, upsFullCompliance=upsFullCompliance, upsConfigOutputPower=upsConfigOutputPower, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, NonNegativeInteger=NonNegativeInteger, upsInputLineIndex=upsInputLineIndex, upsAlarmOnBattery=upsAlarmOnBattery, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTestId=upsTestId, upsAlarmTable=upsAlarmTable, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsIdent=upsIdent, upsAlarmGeneralFault=upsAlarmGeneralFault, upsConfigOutputFreq=upsConfigOutputFreq, upsSecondsOnBattery=upsSecondsOnBattery, upsAutoRestart=upsAutoRestart, upsSubsetCompliance=upsSubsetCompliance, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBasicGroups=upsBasicGroups, upsIdentManufacturer=upsIdentManufacturer, upsWellKnownTests=upsWellKnownTests, upsOutputEntry=upsOutputEntry, upsAlarmTempBad=upsAlarmTempBad, upsTestResultsSummary=upsTestResultsSummary, upsOutputPercentLoad=upsOutputPercentLoad, upsOutputNumLines=upsOutputNumLines, upsAlarmTime=upsAlarmTime, upsFullBypassGroup=upsFullBypassGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTestResultsDetail=upsTestResultsDetail, upsIdentAttachedDevices=upsIdentAttachedDevices, upsOutputTable=upsOutputTable, upsTestSpinLock=upsTestSpinLock, upsInputEntry=upsInputEntry, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsBypassPower=upsBypassPower, upsInputFrequency=upsInputFrequency, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsWellKnownAlarms=upsWellKnownAlarms, upsOutputVoltage=upsOutputVoltage, upsOutput=upsOutput, upsFullBatteryGroup=upsFullBatteryGroup, upsGroups=upsGroups, upsMIB=upsMIB, upsConfigOutputVA=upsConfigOutputVA, upsOutputSource=upsOutputSource, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsSubsetGroups=upsSubsetGroups, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsOutputCurrent=upsOutputCurrent, upsAlarmInputBad=upsAlarmInputBad, upsBasicInputGroup=upsBasicInputGroup, upsBypassEntry=upsBypassEntry, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutputLineIndex=upsOutputLineIndex, upsTestStartTime=upsTestStartTime, upsTrapTestCompleted=upsTrapTestCompleted, upsShutdownType=upsShutdownType, upsIdentModel=upsIdentModel, PositiveInteger=PositiveInteger, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBypassFrequency=upsBypassFrequency, upsAlarmBatteryBad=upsAlarmBatteryBad, upsConfigLowBattTime=upsConfigLowBattTime, upsBatteryVoltage=upsBatteryVoltage, upsAlarmChargerFailed=upsAlarmChargerFailed, upsInputTruePower=upsInputTruePower, upsFullControlGroup=upsFullControlGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsFullGroups=upsFullGroups, upsRebootWithDuration=upsRebootWithDuration, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsInputLineBads=upsInputLineBads, upsBasicIdentGroup=upsBasicIdentGroup, upsTraps=upsTraps, upsAlarmLowBattery=upsAlarmLowBattery, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBatteryCurrent=upsBatteryCurrent, upsConfigInputFreq=upsConfigInputFreq, upsTestElapsedTime=upsTestElapsedTime, upsShutdownAfterDelay=upsShutdownAfterDelay, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsFullConfigGroup=upsFullConfigGroup, upsObjects=upsObjects, upsBypassLineIndex=upsBypassLineIndex, upsInputNumLines=upsInputNumLines, upsCompliances=upsCompliances, upsOutputFrequency=upsOutputFrequency, upsAlarmEntry=upsAlarmEntry, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmShutdownPending=upsAlarmShutdownPending, upsFullIdentGroup=upsFullIdentGroup, upsFullOutputGroup=upsFullOutputGroup, upsFullInputGroup=upsFullInputGroup, upsInputCurrent=upsInputCurrent, upsBatteryTemperature=upsBatteryTemperature, upsBypassCurrent=upsBypassCurrent, upsConfig=upsConfig, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicConfigGroup=upsBasicConfigGroup, PYSNMP_MODULE_ID=upsMIB)
