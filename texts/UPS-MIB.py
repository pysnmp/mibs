...
# Produced by pysmi-1.1.12 at Thu May 30 02:13:02 2024
...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmInputBad=upsAlarmInputBad, upsOutputCurrent=upsOutputCurrent, upsAlarmTime=upsAlarmTime, upsTestElapsedTime=upsTestElapsedTime, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBasicOutputGroup=upsBasicOutputGroup, upsTraps=upsTraps, upsSubsetGroups=upsSubsetGroups, upsOutputSource=upsOutputSource, upsInputNumLines=upsInputNumLines, upsMIB=upsMIB, upsOutputNumLines=upsOutputNumLines, upsOutputFrequency=upsOutputFrequency, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBypassLineIndex=upsBypassLineIndex, upsAlarmDescr=upsAlarmDescr, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmTempBad=upsAlarmTempBad, upsIdentModel=upsIdentModel, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsConfigInputFreq=upsConfigInputFreq, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsInputFrequency=upsInputFrequency, upsBatteryVoltage=upsBatteryVoltage, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsGroups=upsGroups, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutputVoltage=upsOutputVoltage, upsBasicBypassGroup=upsBasicBypassGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsConformance=upsConformance, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBatteryTemperature=upsBatteryTemperature, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConfigOutputPower=upsConfigOutputPower, upsSubsetCompliance=upsSubsetCompliance, upsInputTable=upsInputTable, upsAlarmBypassBad=upsAlarmBypassBad, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullBypassGroup=upsFullBypassGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsInputEntry=upsInputEntry, upsAlarmFuseFailure=upsAlarmFuseFailure, upsFullTestGroup=upsFullTestGroup, upsBattery=upsBattery, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmTable=upsAlarmTable, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBasicGroups=upsBasicGroups, upsFullBatteryGroup=upsFullBatteryGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsInputVoltage=upsInputVoltage, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsIdentManufacturer=upsIdentManufacturer, upsTestResultsSummary=upsTestResultsSummary, NonNegativeInteger=NonNegativeInteger, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTest=upsTest, upsShutdownAfterDelay=upsShutdownAfterDelay, upsFullInputGroup=upsFullInputGroup, upsAlarmId=upsAlarmId, upsConfig=upsConfig, upsAlarmEntry=upsAlarmEntry, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsBypassEntry=upsBypassEntry, upsFullCompliance=upsFullCompliance, upsSubsetInputGroup=upsSubsetInputGroup, upsFullOutputGroup=upsFullOutputGroup, upsObjects=upsObjects, upsTestSpinLock=upsTestSpinLock, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsWellKnownAlarms=upsWellKnownAlarms, upsInputTruePower=upsInputTruePower, upsOutputTable=upsOutputTable, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmFanFailure=upsAlarmFanFailure, upsOutputEntry=upsOutputEntry, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBatteryCurrent=upsBatteryCurrent, upsBasicInputGroup=upsBasicInputGroup, upsBypassFrequency=upsBypassFrequency, upsOutputPower=upsOutputPower, upsTestStartTime=upsTestStartTime, upsInputLineIndex=upsInputLineIndex, upsControl=upsControl, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBasicControlGroup=upsBasicControlGroup, upsFullGroups=upsFullGroups, upsRebootWithDuration=upsRebootWithDuration, upsFullIdentGroup=upsFullIdentGroup, upsBatteryStatus=upsBatteryStatus, upsIdent=upsIdent, upsBypassTable=upsBypassTable, upsInputCurrent=upsInputCurrent, upsBypassNumLines=upsBypassNumLines, upsOutputLineIndex=upsOutputLineIndex, upsShutdownType=upsShutdownType, upsOutput=upsOutput, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarm=upsAlarm, upsAlarmsPresent=upsAlarmsPresent, upsFullControlGroup=upsFullControlGroup, upsBypassPower=upsBypassPower, upsFullAlarmGroup=upsFullAlarmGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsStartupAfterDelay=upsStartupAfterDelay, upsWellKnownTests=upsWellKnownTests, PYSNMP_MODULE_ID=upsMIB, upsTestResultsDetail=upsTestResultsDetail, upsAlarmLowBattery=upsAlarmLowBattery, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAutoRestart=upsAutoRestart, upsTestId=upsTestId, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmOnBypass=upsAlarmOnBypass, upsFullConfigGroup=upsFullConfigGroup, upsCompliances=upsCompliances, PositiveInteger=PositiveInteger, upsBasicIdentGroup=upsBasicIdentGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmOnBattery=upsAlarmOnBattery, upsBypass=upsBypass, upsConfigOutputVA=upsConfigOutputVA, upsSecondsOnBattery=upsSecondsOnBattery, upsBasicCompliance=upsBasicCompliance, upsInput=upsInput, upsBypassCurrent=upsBypassCurrent, upsBasicTestGroup=upsBasicTestGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBypassVoltage=upsBypassVoltage, upsIdentName=upsIdentName, upsInputLineBads=upsInputLineBads, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsConfigOutputVoltage=upsConfigOutputVoltage, upsTrapOnBattery=upsTrapOnBattery, upsAlarmTestInProgress=upsAlarmTestInProgress)
