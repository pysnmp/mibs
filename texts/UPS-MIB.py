...
mibBuilder.exportSymbols("UPS-MIB", upsSubsetOutputGroup=upsSubsetOutputGroup, upsOutputEntry=upsOutputEntry, upsInputTruePower=upsInputTruePower, upsOutputLineIndex=upsOutputLineIndex, upsShutdownType=upsShutdownType, upsAlarmEntry=upsAlarmEntry, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmOnBattery=upsAlarmOnBattery, upsFullBatteryGroup=upsFullBatteryGroup, upsIdentManufacturer=upsIdentManufacturer, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullTestGroup=upsFullTestGroup, upsAlarmId=upsAlarmId, upsTestResultsDetail=upsTestResultsDetail, upsWellKnownTests=upsWellKnownTests, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsInputLineBads=upsInputLineBads, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsShutdownAfterDelay=upsShutdownAfterDelay, upsInputVoltage=upsInputVoltage, upsIdent=upsIdent, upsInputCurrent=upsInputCurrent, upsBypassCurrent=upsBypassCurrent, upsConfigOutputPower=upsConfigOutputPower, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsOutputPower=upsOutputPower, upsOutputSource=upsOutputSource, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigOutputFreq=upsConfigOutputFreq, upsInputFrequency=upsInputFrequency, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsMIB=upsMIB, upsBattery=upsBattery, upsAlarmsPresent=upsAlarmsPresent, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmGeneralFault=upsAlarmGeneralFault, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBasicAlarmGroup=upsBasicAlarmGroup, upsFullCompliance=upsFullCompliance, upsBasicControlGroup=upsBasicControlGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsBasicOutputGroup=upsBasicOutputGroup, upsRebootWithDuration=upsRebootWithDuration, upsBypassNumLines=upsBypassNumLines, upsBypassEntry=upsBypassEntry, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmChargerFailed=upsAlarmChargerFailed, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsTestResultsSummary=upsTestResultsSummary, upsFullOutputGroup=upsFullOutputGroup, upsIdentModel=upsIdentModel, upsAlarmLowBattery=upsAlarmLowBattery, upsSubsetConfigGroup=upsSubsetConfigGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsOutputNumLines=upsOutputNumLines, upsBypassTable=upsBypassTable, upsBypassPower=upsBypassPower, upsTrapTestCompleted=upsTrapTestCompleted, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsInputTable=upsInputTable, upsBasicTestGroup=upsBasicTestGroup, upsOutputVoltage=upsOutputVoltage, upsConfigAudibleStatus=upsConfigAudibleStatus, upsCompliances=upsCompliances, upsAlarmOutputBad=upsAlarmOutputBad, upsTrapOnBattery=upsTrapOnBattery, upsBasicInputGroup=upsBasicInputGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsGroups=upsGroups, upsBasicGroups=upsBasicGroups, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsTestElapsedTime=upsTestElapsedTime, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmTempBad=upsAlarmTempBad, upsSubsetGroups=upsSubsetGroups, upsOutput=upsOutput, upsBypass=upsBypass, upsObjects=upsObjects, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBypassFrequency=upsBypassFrequency, upsConfigInputFreq=upsConfigInputFreq, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBatteryStatus=upsBatteryStatus, NonNegativeInteger=NonNegativeInteger, upsAlarmTable=upsAlarmTable, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTestStartTime=upsTestStartTime, upsBypassLineIndex=upsBypassLineIndex, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsSubsetInputGroup=upsSubsetInputGroup, upsTest=upsTest, upsIdentName=upsIdentName, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsOutputCurrent=upsOutputCurrent, upsAutoRestart=upsAutoRestart, upsConfigOutputVoltage=upsConfigOutputVoltage, upsOutputTable=upsOutputTable, upsConfigInputVoltage=upsConfigInputVoltage, upsFullInputGroup=upsFullInputGroup, upsBasicIdentGroup=upsBasicIdentGroup, PositiveInteger=PositiveInteger, upsBasicCompliance=upsBasicCompliance, upsConfigOutputVA=upsConfigOutputVA, PYSNMP_MODULE_ID=upsMIB, upsBypassVoltage=upsBypassVoltage, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsInputNumLines=upsInputNumLines, upsAlarmInputBad=upsAlarmInputBad, upsAlarmOnBypass=upsAlarmOnBypass, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConformance=upsConformance, upsAlarm=upsAlarm, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullIdentGroup=upsFullIdentGroup, upsInputEntry=upsInputEntry, upsFullGroups=upsFullGroups, upsTestId=upsTestId, upsSubsetControlGroup=upsSubsetControlGroup, upsBatteryCurrent=upsBatteryCurrent, upsAlarmDescr=upsAlarmDescr, upsFullControlGroup=upsFullControlGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBatteryTemperature=upsBatteryTemperature, upsTraps=upsTraps, upsTestSpinLock=upsTestSpinLock, upsConfig=upsConfig, upsAlarmFuseFailure=upsAlarmFuseFailure, upsInputLineIndex=upsInputLineIndex, upsOutputFrequency=upsOutputFrequency, upsSubsetCompliance=upsSubsetCompliance, upsFullConfigGroup=upsFullConfigGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsBatteryVoltage=upsBatteryVoltage, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsInput=upsInput, upsAlarmTime=upsAlarmTime, upsControl=upsControl, upsFullBypassGroup=upsFullBypassGroup)
