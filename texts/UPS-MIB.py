...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, iso, ModuleIdentity, mib_2, Bits, MibIdentifier, ObjectIdentity, Counter32, NotificationType, Gauge32, TimeTicks, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "iso", "ModuleIdentity", "mib-2", "Bits", "MibIdentifier", "ObjectIdentity", "Counter32", "NotificationType", "Gauge32", "TimeTicks", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("UPS-MIB", upsOutputSource=upsOutputSource, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmShutdownPending=upsAlarmShutdownPending, upsObjects=upsObjects, upsCompliances=upsCompliances, upsBypassPower=upsBypassPower, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmTempBad=upsAlarmTempBad, upsAlarmInputBad=upsAlarmInputBad, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsConfigAudibleStatus=upsConfigAudibleStatus, upsSubsetInputGroup=upsSubsetInputGroup, upsOutputTable=upsOutputTable, upsAlarmOutputBad=upsAlarmOutputBad, upsBypassNumLines=upsBypassNumLines, upsGroups=upsGroups, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsWellKnownTests=upsWellKnownTests, upsAlarmTime=upsAlarmTime, upsIdentModel=upsIdentModel, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsSecondsOnBattery=upsSecondsOnBattery, upsInputTruePower=upsInputTruePower, upsAlarmTestInProgress=upsAlarmTestInProgress, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBattery=upsBattery, upsMIB=upsMIB, upsInputTable=upsInputTable, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsOutputCurrent=upsOutputCurrent, upsInputVoltage=upsInputVoltage, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmEntry=upsAlarmEntry, upsAlarmsPresent=upsAlarmsPresent, upsTrapTestCompleted=upsTrapTestCompleted, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsFullOutputGroup=upsFullOutputGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmId=upsAlarmId, upsShutdownType=upsShutdownType, upsTestResultsDetail=upsTestResultsDetail, upsInputEntry=upsInputEntry, upsFullIdentGroup=upsFullIdentGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBypassEntry=upsBypassEntry, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmTable=upsAlarmTable, upsStartupAfterDelay=upsStartupAfterDelay, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAutoRestart=upsAutoRestart, upsIdent=upsIdent, upsIdentManufacturer=upsIdentManufacturer, upsBypassCurrent=upsBypassCurrent, upsBasicCompliance=upsBasicCompliance, upsIdentName=upsIdentName, upsTestResultsSummary=upsTestResultsSummary, upsInput=upsInput, upsTestSpinLock=upsTestSpinLock, upsInputFrequency=upsInputFrequency, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsConfig=upsConfig, upsAlarmFuseFailure=upsAlarmFuseFailure, upsSubsetGroups=upsSubsetGroups, PositiveInteger=PositiveInteger, upsFullInputGroup=upsFullInputGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, PYSNMP_MODULE_ID=upsMIB, upsBatteryTemperature=upsBatteryTemperature, upsTest=upsTest, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsFullGroups=upsFullGroups, upsBasicIdentGroup=upsBasicIdentGroup, upsTestStartTime=upsTestStartTime, upsInputCurrent=upsInputCurrent, upsAlarmLowBattery=upsAlarmLowBattery, upsConfigInputVoltage=upsConfigInputVoltage, upsConfigOutputPower=upsConfigOutputPower, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBatteryCurrent=upsBatteryCurrent, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConfigInputFreq=upsConfigInputFreq, upsBatteryStatus=upsBatteryStatus, upsOutputEntry=upsOutputEntry, upsInputNumLines=upsInputNumLines, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTestElapsedTime=upsTestElapsedTime, upsFullBatteryGroup=upsFullBatteryGroup, upsFullBypassGroup=upsFullBypassGroup, upsOutputVoltage=upsOutputVoltage, upsRebootWithDuration=upsRebootWithDuration, upsOutputLineIndex=upsOutputLineIndex, upsBasicOutputGroup=upsBasicOutputGroup, upsBasicTestGroup=upsBasicTestGroup, upsBypass=upsBypass, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsOutputNumLines=upsOutputNumLines, upsConfigOutputFreq=upsConfigOutputFreq, upsSubsetCompliance=upsSubsetCompliance, upsBasicGroups=upsBasicGroups, upsBasicConfigGroup=upsBasicConfigGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsInputLineIndex=upsInputLineIndex, upsOutputFrequency=upsOutputFrequency, upsBasicInputGroup=upsBasicInputGroup, upsBypassLineIndex=upsBypassLineIndex, upsBypassVoltage=upsBypassVoltage, upsControl=upsControl, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsFullConfigGroup=upsFullConfigGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsFullTestGroup=upsFullTestGroup, upsBypassTable=upsBypassTable, upsAlarm=upsAlarm, upsTrapOnBattery=upsTrapOnBattery, NonNegativeInteger=NonNegativeInteger, upsAlarmDescr=upsAlarmDescr, upsOutput=upsOutput, upsOutputPower=upsOutputPower, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsFullControlGroup=upsFullControlGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsInputLineBads=upsInputLineBads, upsBatteryVoltage=upsBatteryVoltage, upsBasicControlGroup=upsBasicControlGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsFullCompliance=upsFullCompliance, upsConfigOutputVA=upsConfigOutputVA, upsConfigOutputVoltage=upsConfigOutputVoltage, upsTestId=upsTestId, upsBypassFrequency=upsBypassFrequency, upsSubsetOutputGroup=upsSubsetOutputGroup, upsConformance=upsConformance, upsTraps=upsTraps, upsAlarmFanFailure=upsAlarmFanFailure)
