...
# Produced by pysmi-1.1.12 at Wed May 29 07:14:16 2024
...
Bits, Unsigned32, ModuleIdentity, ObjectIdentity, Gauge32, NotificationType, mib_2, Counter64, TimeTicks, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "Gauge32", "NotificationType", "mib-2", "Counter64", "TimeTicks", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "iso")
...
mibBuilder.exportSymbols("UPS-MIB", upsIdentModel=upsIdentModel, upsOutputPower=upsOutputPower, upsIdentName=upsIdentName, upsFullTestGroup=upsFullTestGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsOutputPercentLoad=upsOutputPercentLoad, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsFullControlGroup=upsFullControlGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsFullInputGroup=upsFullInputGroup, upsInputNumLines=upsInputNumLines, upsAlarmTempBad=upsAlarmTempBad, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmTable=upsAlarmTable, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBattery=upsBattery, upsTestStartTime=upsTestStartTime, upsConformance=upsConformance, upsGroups=upsGroups, upsTestSpinLock=upsTestSpinLock, upsBasicGroups=upsBasicGroups, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmInputBad=upsAlarmInputBad, upsOutputLineIndex=upsOutputLineIndex, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmOnBattery=upsAlarmOnBattery, upsBypassEntry=upsBypassEntry, upsSubsetGroups=upsSubsetGroups, PYSNMP_MODULE_ID=upsMIB, upsBypassNumLines=upsBypassNumLines, upsOutputFrequency=upsOutputFrequency, upsBasicInputGroup=upsBasicInputGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsBypassFrequency=upsBypassFrequency, upsBypassPower=upsBypassPower, NonNegativeInteger=NonNegativeInteger, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmOutputBad=upsAlarmOutputBad, upsTest=upsTest, upsTestResultsSummary=upsTestResultsSummary, upsAlarmTime=upsAlarmTime, upsAlarmEntry=upsAlarmEntry, upsSubsetCompliance=upsSubsetCompliance, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTestElapsedTime=upsTestElapsedTime, upsAlarmLowBattery=upsAlarmLowBattery, upsTestResultsDetail=upsTestResultsDetail, upsAlarmBypassBad=upsAlarmBypassBad, upsBasicIdentGroup=upsBasicIdentGroup, upsBypass=upsBypass, upsBypassLineIndex=upsBypassLineIndex, upsInput=upsInput, PositiveInteger=PositiveInteger, upsAlarmGeneralFault=upsAlarmGeneralFault, upsConfigOutputFreq=upsConfigOutputFreq, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsIdentManufacturer=upsIdentManufacturer, upsAlarmBatteryBad=upsAlarmBatteryBad, upsInputEntry=upsInputEntry, upsCompliances=upsCompliances, upsFullGroups=upsFullGroups, upsFullOutputGroup=upsFullOutputGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTestId=upsTestId, upsConfigInputFreq=upsConfigInputFreq, upsOutputVoltage=upsOutputVoltage, upsFullIdentGroup=upsFullIdentGroup, upsInputTable=upsInputTable, upsConfigAudibleStatus=upsConfigAudibleStatus, upsWellKnownTests=upsWellKnownTests, upsTraps=upsTraps, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutputTable=upsOutputTable, upsOutputEntry=upsOutputEntry, upsInputCurrent=upsInputCurrent, upsObjects=upsObjects, upsConfigInputVoltage=upsConfigInputVoltage, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsConfigOutputPower=upsConfigOutputPower, upsBypassTable=upsBypassTable, upsTrapOnBattery=upsTrapOnBattery, upsFullCompliance=upsFullCompliance, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetConfigGroup=upsSubsetConfigGroup, upsInputLineIndex=upsInputLineIndex, upsControl=upsControl, upsConfig=upsConfig, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsFullBatteryGroup=upsFullBatteryGroup, upsMIB=upsMIB, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsFullBypassGroup=upsFullBypassGroup, upsShutdownType=upsShutdownType, upsOutputNumLines=upsOutputNumLines, upsAlarmsPresent=upsAlarmsPresent, upsBasicTestGroup=upsBasicTestGroup, upsAlarmId=upsAlarmId, upsAlarm=upsAlarm, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmDescr=upsAlarmDescr, upsOutput=upsOutput, upsBasicBypassGroup=upsBasicBypassGroup, upsConfigOutputVA=upsConfigOutputVA, upsBasicAlarmGroup=upsBasicAlarmGroup, upsInputTruePower=upsInputTruePower, upsInputVoltage=upsInputVoltage, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsRebootWithDuration=upsRebootWithDuration, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBatteryCurrent=upsBatteryCurrent, upsBatteryTemperature=upsBatteryTemperature, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBatteryVoltage=upsBatteryVoltage, upsBatteryStatus=upsBatteryStatus, upsConfigLowBattTime=upsConfigLowBattTime, upsBasicCompliance=upsBasicCompliance, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsIdentAttachedDevices=upsIdentAttachedDevices, upsInputLineBads=upsInputLineBads, upsInputFrequency=upsInputFrequency, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsFullAlarmGroup=upsFullAlarmGroup, upsIdent=upsIdent, upsBypassCurrent=upsBypassCurrent, upsBasicControlGroup=upsBasicControlGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBypassVoltage=upsBypassVoltage, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsSubsetIdentGroup=upsSubsetIdentGroup, upsOutputSource=upsOutputSource, upsOutputCurrent=upsOutputCurrent, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsFullConfigGroup=upsFullConfigGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAutoRestart=upsAutoRestart, upsWellKnownAlarms=upsWellKnownAlarms, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsTrapTestCompleted=upsTrapTestCompleted)
