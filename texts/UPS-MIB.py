...
TimeTicks, ModuleIdentity, Gauge32, ObjectIdentity, NotificationType, Counter64, IpAddress, iso, mib_2, MibIdentifier, Unsigned32, Counter32, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Gauge32", "ObjectIdentity", "NotificationType", "Counter64", "IpAddress", "iso", "mib-2", "MibIdentifier", "Unsigned32", "Counter32", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("UPS-MIB", upsSubsetCompliance=upsSubsetCompliance, upsSubsetGroups=upsSubsetGroups, upsInputLineIndex=upsInputLineIndex, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmShutdownPending=upsAlarmShutdownPending, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsInputTable=upsInputTable, upsSubsetInputGroup=upsSubsetInputGroup, NonNegativeInteger=NonNegativeInteger, upsBasicCompliance=upsBasicCompliance, upsOutputLineIndex=upsOutputLineIndex, upsOutputFrequency=upsOutputFrequency, upsBasicGroups=upsBasicGroups, upsBatteryStatus=upsBatteryStatus, upsBypassNumLines=upsBypassNumLines, upsAlarm=upsAlarm, upsBasicOutputGroup=upsBasicOutputGroup, upsOutputNumLines=upsOutputNumLines, upsBasicTestGroup=upsBasicTestGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBypassCurrent=upsBypassCurrent, upsConfigInputFreq=upsConfigInputFreq, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsTestElapsedTime=upsTestElapsedTime, upsConfigLowBattTime=upsConfigLowBattTime, upsTestId=upsTestId, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsMIB=upsMIB, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, PositiveInteger=PositiveInteger, upsBasicBatteryGroup=upsBasicBatteryGroup, upsFullConfigGroup=upsFullConfigGroup, upsInputLineBads=upsInputLineBads, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsFullInputGroup=upsFullInputGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBatteryTemperature=upsBatteryTemperature, upsGroups=upsGroups, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsInputVoltage=upsInputVoltage, upsTestResultsDetail=upsTestResultsDetail, upsOutputPower=upsOutputPower, upsBypass=upsBypass, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsConformance=upsConformance, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmLowBattery=upsAlarmLowBattery, upsRebootWithDuration=upsRebootWithDuration, upsBasicBypassGroup=upsBasicBypassGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsObjects=upsObjects, upsTest=upsTest, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmTable=upsAlarmTable, upsFullCompliance=upsFullCompliance, upsIdentManufacturer=upsIdentManufacturer, upsAlarmDescr=upsAlarmDescr, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAutoRestart=upsAutoRestart, upsFullIdentGroup=upsFullIdentGroup, upsBatteryVoltage=upsBatteryVoltage, upsAlarmsPresent=upsAlarmsPresent, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsConfigOutputPower=upsConfigOutputPower, upsTrapOnBattery=upsTrapOnBattery, upsOutputCurrent=upsOutputCurrent, upsAlarmInputBad=upsAlarmInputBad, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsInputFrequency=upsInputFrequency, upsFullControlGroup=upsFullControlGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsIdentAttachedDevices=upsIdentAttachedDevices, upsOutputPercentLoad=upsOutputPercentLoad, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsConfigOutputVoltage=upsConfigOutputVoltage, upsCompliances=upsCompliances, upsInputCurrent=upsInputCurrent, upsAlarmTime=upsAlarmTime, upsControl=upsControl, upsOutputSource=upsOutputSource, upsAlarmOnBattery=upsAlarmOnBattery, upsFullTestGroup=upsFullTestGroup, PYSNMP_MODULE_ID=upsMIB, upsAlarmTestInProgress=upsAlarmTestInProgress, upsWellKnownTests=upsWellKnownTests, upsTraps=upsTraps, upsTestSpinLock=upsTestSpinLock, upsConfigOutputFreq=upsConfigOutputFreq, upsSecondsOnBattery=upsSecondsOnBattery, upsInputNumLines=upsInputNumLines, upsBattery=upsBattery, upsBypassEntry=upsBypassEntry, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsIdentName=upsIdentName, upsConfig=upsConfig, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBasicInputGroup=upsBasicInputGroup, upsBasicControlGroup=upsBasicControlGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBasicIdentGroup=upsBasicIdentGroup, upsBypassVoltage=upsBypassVoltage, upsBasicConfigGroup=upsBasicConfigGroup, upsBatteryCurrent=upsBatteryCurrent, upsTestResultsSummary=upsTestResultsSummary, upsAlarmEntry=upsAlarmEntry, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBypassPower=upsBypassPower, upsIdentModel=upsIdentModel, upsBypassFrequency=upsBypassFrequency, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsInputEntry=upsInputEntry, upsAlarmFuseFailure=upsAlarmFuseFailure, upsConfigAudibleStatus=upsConfigAudibleStatus, upsFullOutputGroup=upsFullOutputGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsBypassTable=upsBypassTable, upsOutputEntry=upsOutputEntry, upsOutputVoltage=upsOutputVoltage, upsAlarmOutputOverload=upsAlarmOutputOverload, upsShutdownType=upsShutdownType, upsOutput=upsOutput, upsFullGroups=upsFullGroups, upsAlarmChargerFailed=upsAlarmChargerFailed, upsFullAlarmGroup=upsFullAlarmGroup, upsIdent=upsIdent, upsAlarmTempBad=upsAlarmTempBad, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsOutputTable=upsOutputTable, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullBypassGroup=upsFullBypassGroup, upsConfigOutputVA=upsConfigOutputVA, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBypassLineIndex=upsBypassLineIndex, upsConfigInputVoltage=upsConfigInputVoltage, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmId=upsAlarmId, upsInput=upsInput, upsInputTruePower=upsInputTruePower, upsTestStartTime=upsTestStartTime)
