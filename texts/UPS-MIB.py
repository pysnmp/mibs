...
# Produced by pysmi-1.1.8 at Fri Jan 13 14:26:46 2023
...
Gauge32, Counter64, NotificationType, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, mib_2, Counter32, iso, Integer32, Bits, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "NotificationType", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "mib-2", "Counter32", "iso", "Integer32", "Bits", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("UPS-MIB", PYSNMP_MODULE_ID=upsMIB, upsBasicControlGroup=upsBasicControlGroup, upsTestSpinLock=upsTestSpinLock, upsTrapOnBattery=upsTrapOnBattery, upsBasicIdentGroup=upsBasicIdentGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsFullConfigGroup=upsFullConfigGroup, upsAlarmId=upsAlarmId, upsTestResultsSummary=upsTestResultsSummary, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBypassFrequency=upsBypassFrequency, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarm=upsAlarm, upsConfigInputFreq=upsConfigInputFreq, upsGroups=upsGroups, upsBattery=upsBattery, upsOutputEntry=upsOutputEntry, PositiveInteger=PositiveInteger, upsBypassTable=upsBypassTable, upsOutputNumLines=upsOutputNumLines, upsBypassCurrent=upsBypassCurrent, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTestResultsDetail=upsTestResultsDetail, upsShutdownAfterDelay=upsShutdownAfterDelay, upsInputFrequency=upsInputFrequency, upsOutputLineIndex=upsOutputLineIndex, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsMIB=upsMIB, upsFullBypassGroup=upsFullBypassGroup, upsConfigOutputVA=upsConfigOutputVA, upsCompliances=upsCompliances, upsBasicConfigGroup=upsBasicConfigGroup, upsBypassLineIndex=upsBypassLineIndex, upsAlarmDescr=upsAlarmDescr, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTest=upsTest, upsAlarmEntry=upsAlarmEntry, upsFullCompliance=upsFullCompliance, upsAlarmFuseFailure=upsAlarmFuseFailure, upsRebootWithDuration=upsRebootWithDuration, upsBasicGroups=upsBasicGroups, upsAlarmShutdownPending=upsAlarmShutdownPending, upsShutdownType=upsShutdownType, upsOutputPower=upsOutputPower, upsSecondsOnBattery=upsSecondsOnBattery, upsInputTable=upsInputTable, upsTestId=upsTestId, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsInputEntry=upsInputEntry, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicTestGroup=upsBasicTestGroup, upsBypassEntry=upsBypassEntry, upsFullControlGroup=upsFullControlGroup, upsIdentModel=upsIdentModel, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsFullInputGroup=upsFullInputGroup, upsOutputCurrent=upsOutputCurrent, upsWellKnownAlarms=upsWellKnownAlarms, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsInputTruePower=upsInputTruePower, upsTestElapsedTime=upsTestElapsedTime, upsOutput=upsOutput, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmsPresent=upsAlarmsPresent, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBypassVoltage=upsBypassVoltage, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsConfigOutputVoltage=upsConfigOutputVoltage, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmTime=upsAlarmTime, upsAlarmOnBypass=upsAlarmOnBypass, upsSubsetIdentGroup=upsSubsetIdentGroup, upsFullTestGroup=upsFullTestGroup, upsSubsetCompliance=upsSubsetCompliance, upsAutoRestart=upsAutoRestart, upsInputLineBads=upsInputLineBads, upsOutputFrequency=upsOutputFrequency, upsAlarmTempBad=upsAlarmTempBad, upsTraps=upsTraps, upsInputCurrent=upsInputCurrent, upsControl=upsControl, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBasicBypassGroup=upsBasicBypassGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigOutputPower=upsConfigOutputPower, upsBypassPower=upsBypassPower, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmOutputOverload=upsAlarmOutputOverload, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsFullIdentGroup=upsFullIdentGroup, upsAlarmInputBad=upsAlarmInputBad, upsOutputSource=upsOutputSource, upsOutputVoltage=upsOutputVoltage, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsBatteryTemperature=upsBatteryTemperature, upsIdentName=upsIdentName, upsBypass=upsBypass, upsSubsetInputGroup=upsSubsetInputGroup, upsFullOutputGroup=upsFullOutputGroup, upsInput=upsInput, upsBypassNumLines=upsBypassNumLines, upsAlarmBypassBad=upsAlarmBypassBad, NonNegativeInteger=NonNegativeInteger, upsBasicCompliance=upsBasicCompliance, upsConfigLowBattTime=upsConfigLowBattTime, upsOutputTable=upsOutputTable, upsAlarmLowBattery=upsAlarmLowBattery, upsObjects=upsObjects, upsConfigOutputFreq=upsConfigOutputFreq, upsIdentManufacturer=upsIdentManufacturer, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBasicAlarmGroup=upsBasicAlarmGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsBatteryVoltage=upsBatteryVoltage, upsBatteryStatus=upsBatteryStatus, upsInputLineIndex=upsInputLineIndex, upsStartupAfterDelay=upsStartupAfterDelay, upsFullAlarmGroup=upsFullAlarmGroup, upsWellKnownTests=upsWellKnownTests, upsTestStartTime=upsTestStartTime, upsSubsetGroups=upsSubsetGroups, upsAlarmTable=upsAlarmTable, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmFanFailure=upsAlarmFanFailure, upsSubsetOutputGroup=upsSubsetOutputGroup, upsConfig=upsConfig, upsInputNumLines=upsInputNumLines, upsFullGroups=upsFullGroups, upsInputVoltage=upsInputVoltage, upsBasicInputGroup=upsBasicInputGroup, upsIdent=upsIdent, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmOnBattery=upsAlarmOnBattery, upsConformance=upsConformance, upsConfigInputVoltage=upsConfigInputVoltage, upsBatteryCurrent=upsBatteryCurrent, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmBatteryBad=upsAlarmBatteryBad)
