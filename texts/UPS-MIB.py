...
Unsigned32, Bits, IpAddress, iso, MibIdentifier, ModuleIdentity, Gauge32, Integer32, mib_2, TimeTicks, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "IpAddress", "iso", "MibIdentifier", "ModuleIdentity", "Gauge32", "Integer32", "mib-2", "TimeTicks", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32")
AutonomousType, TimeInterval, TestAndIncr, TextualConvention, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TimeInterval", "TestAndIncr", "TextualConvention", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsWellKnownAlarms=upsWellKnownAlarms, upsBasicIdentGroup=upsBasicIdentGroup, upsBypassCurrent=upsBypassCurrent, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmShutdownPending=upsAlarmShutdownPending, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsOutputPercentLoad=upsOutputPercentLoad, upsTestId=upsTestId, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsInputLineIndex=upsInputLineIndex, upsOutputTable=upsOutputTable, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBatteryTemperature=upsBatteryTemperature, upsBasicTestGroup=upsBasicTestGroup, upsInputTruePower=upsInputTruePower, upsSubsetCompliance=upsSubsetCompliance, PositiveInteger=PositiveInteger, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsIdent=upsIdent, upsInput=upsInput, upsAlarmEntry=upsAlarmEntry, upsAutoRestart=upsAutoRestart, upsBypassVoltage=upsBypassVoltage, upsTestStartTime=upsTestStartTime, upsFullGroups=upsFullGroups, upsConfigLowBattTime=upsConfigLowBattTime, upsObjects=upsObjects, upsFullInputGroup=upsFullInputGroup, upsFullControlGroup=upsFullControlGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsRebootWithDuration=upsRebootWithDuration, upsConfigInputFreq=upsConfigInputFreq, upsOutputVoltage=upsOutputVoltage, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsFullOutputGroup=upsFullOutputGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsBasicConfigGroup=upsBasicConfigGroup, upsTest=upsTest, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypassNumLines=upsBypassNumLines, upsAlarmOnBattery=upsAlarmOnBattery, upsIdentAttachedDevices=upsIdentAttachedDevices, upsFullTestGroup=upsFullTestGroup, upsAlarm=upsAlarm, upsSubsetConfigGroup=upsSubsetConfigGroup, upsConfigOutputPower=upsConfigOutputPower, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsFullBypassGroup=upsFullBypassGroup, PYSNMP_MODULE_ID=upsMIB, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBasicGroups=upsBasicGroups, upsConformance=upsConformance, upsConfig=upsConfig, upsBatteryVoltage=upsBatteryVoltage, upsInputCurrent=upsInputCurrent, upsBattery=upsBattery, upsStartupAfterDelay=upsStartupAfterDelay, upsOutputLineIndex=upsOutputLineIndex, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsInputLineBads=upsInputLineBads, upsSubsetInputGroup=upsSubsetInputGroup, upsFullCompliance=upsFullCompliance, upsIdentModel=upsIdentModel, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsGroups=upsGroups, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestSpinLock=upsTestSpinLock, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsConfigInputVoltage=upsConfigInputVoltage, upsBypassTable=upsBypassTable, upsShutdownAfterDelay=upsShutdownAfterDelay, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmTime=upsAlarmTime, upsBypassLineIndex=upsBypassLineIndex, upsSubsetIdentGroup=upsSubsetIdentGroup, upsOutputSource=upsOutputSource, upsBypassFrequency=upsBypassFrequency, upsAlarmId=upsAlarmId, upsBatteryStatus=upsBatteryStatus, upsBasicInputGroup=upsBasicInputGroup, upsInputTable=upsInputTable, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsOutputPower=upsOutputPower, upsAlarmFanFailure=upsAlarmFanFailure, upsBypassPower=upsBypassPower, upsOutputEntry=upsOutputEntry, upsAlarmsPresent=upsAlarmsPresent, upsControl=upsControl, upsAlarmLowBattery=upsAlarmLowBattery, upsTestResultsSummary=upsTestResultsSummary, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmOutputBad=upsAlarmOutputBad, upsMIB=upsMIB, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsInputEntry=upsInputEntry, upsOutputCurrent=upsOutputCurrent, upsBatteryCurrent=upsBatteryCurrent, upsTestResultsDetail=upsTestResultsDetail, upsAlarmBatteryBad=upsAlarmBatteryBad, upsFullConfigGroup=upsFullConfigGroup, upsOutputFrequency=upsOutputFrequency, upsShutdownType=upsShutdownType, upsBasicControlGroup=upsBasicControlGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTestElapsedTime=upsTestElapsedTime, upsSubsetGroups=upsSubsetGroups, upsBypass=upsBypass, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmDescr=upsAlarmDescr, upsInputVoltage=upsInputVoltage, upsTrapTestCompleted=upsTrapTestCompleted, upsOutputNumLines=upsOutputNumLines, upsTraps=upsTraps, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmOnBypass=upsAlarmOnBypass, upsOutput=upsOutput, upsSubsetControlGroup=upsSubsetControlGroup, upsBypassEntry=upsBypassEntry, upsAlarmTempBad=upsAlarmTempBad, upsInputNumLines=upsInputNumLines, upsSecondsOnBattery=upsSecondsOnBattery, upsIdentName=upsIdentName, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBasicCompliance=upsBasicCompliance, upsConfigOutputVA=upsConfigOutputVA, upsCompliances=upsCompliances, upsWellKnownTests=upsWellKnownTests, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullIdentGroup=upsFullIdentGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsBasicOutputGroup=upsBasicOutputGroup, NonNegativeInteger=NonNegativeInteger, upsIdentManufacturer=upsIdentManufacturer, upsInputFrequency=upsInputFrequency, upsAlarmTable=upsAlarmTable, upsAlarmInputBad=upsAlarmInputBad, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTrapOnBattery=upsTrapOnBattery, upsBasicBypassGroup=upsBasicBypassGroup)
