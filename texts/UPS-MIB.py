...
# Produced by pysmi-1.1.8 at Thu Apr 27 09:10:24 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, iso, Gauge32, Counter32, ModuleIdentity, Integer32, IpAddress, TimeTicks, Bits, MibIdentifier, NotificationType, Counter64, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "iso", "Gauge32", "Counter32", "ModuleIdentity", "Integer32", "IpAddress", "TimeTicks", "Bits", "MibIdentifier", "NotificationType", "Counter64", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsRebootWithDuration=upsRebootWithDuration, upsOutputNumLines=upsOutputNumLines, upsConfigOutputVA=upsConfigOutputVA, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBasicIdentGroup=upsBasicIdentGroup, PYSNMP_MODULE_ID=upsMIB, upsBasicInputGroup=upsBasicInputGroup, upsBatteryTemperature=upsBatteryTemperature, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBypassNumLines=upsBypassNumLines, upsBypassVoltage=upsBypassVoltage, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsMIB=upsMIB, upsObjects=upsObjects, upsOutputSource=upsOutputSource, upsIdentManufacturer=upsIdentManufacturer, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsSubsetIdentGroup=upsSubsetIdentGroup, upsFullGroups=upsFullGroups, upsInputTable=upsInputTable, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTestSpinLock=upsTestSpinLock, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmTempBad=upsAlarmTempBad, upsTrapTestCompleted=upsTrapTestCompleted, upsInputNumLines=upsInputNumLines, upsInputFrequency=upsInputFrequency, upsFullOutputGroup=upsFullOutputGroup, upsOutputTable=upsOutputTable, upsControl=upsControl, upsAlarmDescr=upsAlarmDescr, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicOutputGroup=upsBasicOutputGroup, upsBatteryStatus=upsBatteryStatus, upsCompliances=upsCompliances, upsConfigInputFreq=upsConfigInputFreq, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsInputLineBads=upsInputLineBads, upsAlarmShutdownPending=upsAlarmShutdownPending, upsInputEntry=upsInputEntry, upsOutputCurrent=upsOutputCurrent, upsTestResultsDetail=upsTestResultsDetail, upsTrapOnBattery=upsTrapOnBattery, upsOutputLineIndex=upsOutputLineIndex, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmId=upsAlarmId, upsBasicCompliance=upsBasicCompliance, upsOutputEntry=upsOutputEntry, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsConfigOutputPower=upsConfigOutputPower, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsOutputFrequency=upsOutputFrequency, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsInputLineIndex=upsInputLineIndex, upsAlarmTime=upsAlarmTime, upsBypassFrequency=upsBypassFrequency, upsOutputPower=upsOutputPower, upsAlarmInputBad=upsAlarmInputBad, upsBypass=upsBypass, upsFullInputGroup=upsFullInputGroup, upsInputTruePower=upsInputTruePower, upsFullTestGroup=upsFullTestGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsBattery=upsBattery, upsWellKnownAlarms=upsWellKnownAlarms, upsOutputVoltage=upsOutputVoltage, upsBatteryVoltage=upsBatteryVoltage, upsAlarmOnBypass=upsAlarmOnBypass, upsFullBatteryGroup=upsFullBatteryGroup, upsBypassLineIndex=upsBypassLineIndex, upsInputCurrent=upsInputCurrent, upsFullBypassGroup=upsFullBypassGroup, upsBypassCurrent=upsBypassCurrent, upsSecondsOnBattery=upsSecondsOnBattery, upsConfigInputVoltage=upsConfigInputVoltage, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicTestGroup=upsBasicTestGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBypassTable=upsBypassTable, upsAlarmOnBattery=upsAlarmOnBattery, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBypassPower=upsBypassPower, upsShutdownAfterDelay=upsShutdownAfterDelay, upsInputVoltage=upsInputVoltage, upsSubsetControlGroup=upsSubsetControlGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsGroups=upsGroups, upsOutputPercentLoad=upsOutputPercentLoad, upsIdentName=upsIdentName, upsAlarmEntry=upsAlarmEntry, upsTraps=upsTraps, upsAlarmBypassBad=upsAlarmBypassBad, upsConformance=upsConformance, NonNegativeInteger=NonNegativeInteger, upsBasicGroups=upsBasicGroups, upsAlarmTestInProgress=upsAlarmTestInProgress, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmTable=upsAlarmTable, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsInput=upsInput, upsShutdownType=upsShutdownType, upsFullIdentGroup=upsFullIdentGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBasicControlGroup=upsBasicControlGroup, upsFullConfigGroup=upsFullConfigGroup, upsConfig=upsConfig, upsBypassEntry=upsBypassEntry, upsAlarmsPresent=upsAlarmsPresent, upsAlarmLowBattery=upsAlarmLowBattery, upsWellKnownTests=upsWellKnownTests, upsSubsetOutputGroup=upsSubsetOutputGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsIdentModel=upsIdentModel, upsAlarmChargerFailed=upsAlarmChargerFailed, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsConfigOutputFreq=upsConfigOutputFreq, upsTestElapsedTime=upsTestElapsedTime, upsStartupAfterDelay=upsStartupAfterDelay, upsTestResultsSummary=upsTestResultsSummary, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsIdent=upsIdent, upsTest=upsTest, upsFullCompliance=upsFullCompliance, upsBasicBypassGroup=upsBasicBypassGroup, upsSubsetGroups=upsSubsetGroups, upsTestId=upsTestId, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmFanFailure=upsAlarmFanFailure, upsSubsetCompliance=upsSubsetCompliance, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAutoRestart=upsAutoRestart, upsFullControlGroup=upsFullControlGroup, upsTestStartTime=upsTestStartTime, PositiveInteger=PositiveInteger, upsConfigOutputVoltage=upsConfigOutputVoltage, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBatteryCurrent=upsBatteryCurrent, upsAlarm=upsAlarm, upsOutput=upsOutput, upsSubsetAlarmGroup=upsSubsetAlarmGroup)
