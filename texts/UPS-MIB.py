...
mibBuilder.exportSymbols("UPS-MIB", upsTestId=upsTestId, upsFullBatteryGroup=upsFullBatteryGroup, upsOutputTable=upsOutputTable, upsConfigAudibleStatus=upsConfigAudibleStatus, upsConfig=upsConfig, upsBypassPower=upsBypassPower, upsShutdownType=upsShutdownType, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsConfigLowBattTime=upsConfigLowBattTime, upsSubsetConfigGroup=upsSubsetConfigGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypass=upsBypass, upsFullIdentGroup=upsFullIdentGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmTestInProgress=upsAlarmTestInProgress, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsOutputEntry=upsOutputEntry, upsFullConfigGroup=upsFullConfigGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsConfigOutputVA=upsConfigOutputVA, upsWellKnownTests=upsWellKnownTests, upsAlarmTable=upsAlarmTable, upsInputFrequency=upsInputFrequency, upsFullAlarmGroup=upsFullAlarmGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBasicOutputGroup=upsBasicOutputGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsMIB=upsMIB, upsBypassTable=upsBypassTable, upsAlarmDescr=upsAlarmDescr, upsAlarmBypassBad=upsAlarmBypassBad, upsIdent=upsIdent, upsOutputCurrent=upsOutputCurrent, upsAlarmOutputBad=upsAlarmOutputBad, upsTestAbortTestInProgress=upsTestAbortTestInProgress, PYSNMP_MODULE_ID=upsMIB, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsRebootWithDuration=upsRebootWithDuration, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBypassFrequency=upsBypassFrequency, NonNegativeInteger=NonNegativeInteger, upsInputTruePower=upsInputTruePower, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBattery=upsBattery, upsOutput=upsOutput, PositiveInteger=PositiveInteger, upsConfigOutputPower=upsConfigOutputPower, upsBypassVoltage=upsBypassVoltage, upsBatteryCurrent=upsBatteryCurrent, upsWellKnownAlarms=upsWellKnownAlarms, upsInputEntry=upsInputEntry, upsAlarmChargerFailed=upsAlarmChargerFailed, upsObjects=upsObjects, upsSecondsOnBattery=upsSecondsOnBattery, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmTime=upsAlarmTime, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmLowBattery=upsAlarmLowBattery, upsIdentManufacturer=upsIdentManufacturer, upsAlarmInputBad=upsAlarmInputBad, upsIdentModel=upsIdentModel, upsFullGroups=upsFullGroups, upsBasicGroups=upsBasicGroups, upsAlarmOnBattery=upsAlarmOnBattery, upsTestResultsSummary=upsTestResultsSummary, upsBatteryStatus=upsBatteryStatus, upsSubsetControlGroup=upsSubsetControlGroup, upsAutoRestart=upsAutoRestart, upsTraps=upsTraps, upsInput=upsInput, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsShutdownAfterDelay=upsShutdownAfterDelay, upsInputCurrent=upsInputCurrent, upsSubsetIdentGroup=upsSubsetIdentGroup, upsOutputPower=upsOutputPower, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsControl=upsControl, upsTrapOnBattery=upsTrapOnBattery, upsAlarmEntry=upsAlarmEntry, upsConfigInputFreq=upsConfigInputFreq, upsTestSpinLock=upsTestSpinLock, upsConformance=upsConformance, upsGroups=upsGroups, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsOutputFrequency=upsOutputFrequency, upsBasicControlGroup=upsBasicControlGroup, upsTestResultsDetail=upsTestResultsDetail, upsBypassLineIndex=upsBypassLineIndex, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsOutputVoltage=upsOutputVoltage, upsBasicTestGroup=upsBasicTestGroup, upsInputTable=upsInputTable, upsFullTestGroup=upsFullTestGroup, upsFullBypassGroup=upsFullBypassGroup, upsBatteryTemperature=upsBatteryTemperature, upsAlarmTempBad=upsAlarmTempBad, upsSubsetGroups=upsSubsetGroups, upsBasicCompliance=upsBasicCompliance, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicInputGroup=upsBasicInputGroup, upsFullOutputGroup=upsFullOutputGroup, upsFullControlGroup=upsFullControlGroup, upsOutputLineIndex=upsOutputLineIndex, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBatteryVoltage=upsBatteryVoltage, upsOutputSource=upsOutputSource, upsCompliances=upsCompliances, upsTestStartTime=upsTestStartTime, upsOutputNumLines=upsOutputNumLines, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTest=upsTest, upsBasicIdentGroup=upsBasicIdentGroup, upsTestElapsedTime=upsTestElapsedTime, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmId=upsAlarmId, upsInputVoltage=upsInputVoltage, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsIdentName=upsIdentName, upsInputNumLines=upsInputNumLines, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBypassNumLines=upsBypassNumLines, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarm=upsAlarm, upsAlarmsPresent=upsAlarmsPresent, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsInputLineIndex=upsInputLineIndex, upsFullInputGroup=upsFullInputGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullCompliance=upsFullCompliance, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmOutputOverload=upsAlarmOutputOverload, upsInputLineBads=upsInputLineBads, upsSubsetCompliance=upsSubsetCompliance, upsBypassEntry=upsBypassEntry, upsBypassCurrent=upsBypassCurrent, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmBatteryBad=upsAlarmBatteryBad)
