...
mibBuilder.exportSymbols("UPS-MIB", upsConfigLowBattTime=upsConfigLowBattTime, upsTest=upsTest, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutput=upsOutput, upsBatteryCurrent=upsBatteryCurrent, upsOutputFrequency=upsOutputFrequency, upsBypassVoltage=upsBypassVoltage, upsBypassPower=upsBypassPower, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAutoRestart=upsAutoRestart, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBasicAlarmGroup=upsBasicAlarmGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTestId=upsTestId, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTestStartTime=upsTestStartTime, upsInputNumLines=upsInputNumLines, upsBatteryVoltage=upsBatteryVoltage, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBatteryTemperature=upsBatteryTemperature, upsAlarmOutputBad=upsAlarmOutputBad, upsConformance=upsConformance, upsOutputTable=upsOutputTable, upsInput=upsInput, upsBattery=upsBattery, upsAlarmBypassBad=upsAlarmBypassBad, upsInputEntry=upsInputEntry, upsTestSpinLock=upsTestSpinLock, upsBypassCurrent=upsBypassCurrent, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmTime=upsAlarmTime, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsInputLineBads=upsInputLineBads, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsInputLineIndex=upsInputLineIndex, upsOutputPower=upsOutputPower, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsStartupAfterDelay=upsStartupAfterDelay, upsOutputCurrent=upsOutputCurrent, upsIdentManufacturer=upsIdentManufacturer, NonNegativeInteger=NonNegativeInteger, upsShutdownType=upsShutdownType, upsBasicInputGroup=upsBasicInputGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsFullControlGroup=upsFullControlGroup, upsMIB=upsMIB, upsFullAlarmGroup=upsFullAlarmGroup, upsTrapOnBattery=upsTrapOnBattery, upsAlarmLowBattery=upsAlarmLowBattery, upsFullBatteryGroup=upsFullBatteryGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmsPresent=upsAlarmsPresent, upsInputFrequency=upsInputFrequency, upsBypassLineIndex=upsBypassLineIndex, upsConfigOutputVA=upsConfigOutputVA, upsIdent=upsIdent, upsAlarmTempBad=upsAlarmTempBad, upsRebootWithDuration=upsRebootWithDuration, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBasicBypassGroup=upsBasicBypassGroup, upsBasicGroups=upsBasicGroups, upsAlarmShutdownPending=upsAlarmShutdownPending, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmInputBad=upsAlarmInputBad, upsWellKnownAlarms=upsWellKnownAlarms, PositiveInteger=PositiveInteger, upsInputTruePower=upsInputTruePower, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsOutputNumLines=upsOutputNumLines, upsBypass=upsBypass, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsOutputLineIndex=upsOutputLineIndex, upsSecondsOnBattery=upsSecondsOnBattery, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmTable=upsAlarmTable, upsBypassFrequency=upsBypassFrequency, upsInputCurrent=upsInputCurrent, upsAlarmBatteryBad=upsAlarmBatteryBad, upsFullBypassGroup=upsFullBypassGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutputVoltage=upsOutputVoltage, upsWellKnownTests=upsWellKnownTests, upsFullInputGroup=upsFullInputGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigOutputPower=upsConfigOutputPower, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmDescr=upsAlarmDescr, upsFullConfigGroup=upsFullConfigGroup, upsFullIdentGroup=upsFullIdentGroup, upsObjects=upsObjects, upsFullGroups=upsFullGroups, upsConfigOutputVoltage=upsConfigOutputVoltage, upsConfigInputFreq=upsConfigInputFreq, upsBatteryStatus=upsBatteryStatus, upsBasicIdentGroup=upsBasicIdentGroup, upsTestResultsDetail=upsTestResultsDetail, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBypassNumLines=upsBypassNumLines, upsAlarmEntry=upsAlarmEntry, upsSubsetCompliance=upsSubsetCompliance, upsBasicTestGroup=upsBasicTestGroup, upsFullOutputGroup=upsFullOutputGroup, PYSNMP_MODULE_ID=upsMIB, upsAlarmTestInProgress=upsAlarmTestInProgress, upsCompliances=upsCompliances, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmId=upsAlarmId, upsInputVoltage=upsInputVoltage, upsIdentModel=upsIdentModel, upsInputTable=upsInputTable, upsBypassEntry=upsBypassEntry, upsOutputEntry=upsOutputEntry, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsOutputPercentLoad=upsOutputPercentLoad, upsControl=upsControl, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTestResultsSummary=upsTestResultsSummary, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicCompliance=upsBasicCompliance, upsBasicOutputGroup=upsBasicOutputGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsFullCompliance=upsFullCompliance, upsConfigAudibleStatus=upsConfigAudibleStatus, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBypassTable=upsBypassTable, upsSubsetGroups=upsSubsetGroups, upsConfigInputVoltage=upsConfigInputVoltage, upsBasicControlGroup=upsBasicControlGroup, upsFullTestGroup=upsFullTestGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsIdentName=upsIdentName, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsOutputSource=upsOutputSource, upsTestElapsedTime=upsTestElapsedTime, upsConfig=upsConfig, upsGroups=upsGroups, upsAlarm=upsAlarm, upsTraps=upsTraps, upsSubsetConfigGroup=upsSubsetConfigGroup)
