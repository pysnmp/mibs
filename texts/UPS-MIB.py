...
AutonomousType, TimeInterval, TextualConvention, DisplayString, TestAndIncr, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TimeInterval", "TextualConvention", "DisplayString", "TestAndIncr", "TimeStamp")
...
mibBuilder.exportSymbols("UPS-MIB", upsBasicControlGroup=upsBasicControlGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsBypassPower=upsBypassPower, upsSubsetInputGroup=upsSubsetInputGroup, upsBatteryStatus=upsBatteryStatus, upsRebootWithDuration=upsRebootWithDuration, upsBasicCompliance=upsBasicCompliance, upsAlarmLowBattery=upsAlarmLowBattery, upsSecondsOnBattery=upsSecondsOnBattery, upsBypassTable=upsBypassTable, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsCompliances=upsCompliances, upsConfigLowBattTime=upsConfigLowBattTime, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsIdentModel=upsIdentModel, upsWellKnownAlarms=upsWellKnownAlarms, upsTestResultsSummary=upsTestResultsSummary, upsBasicInputGroup=upsBasicInputGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsFullInputGroup=upsFullInputGroup, upsFullGroups=upsFullGroups, upsObjects=upsObjects, upsInputLineIndex=upsInputLineIndex, upsFullIdentGroup=upsFullIdentGroup, upsBatteryCurrent=upsBatteryCurrent, upsAlarmGeneralFault=upsAlarmGeneralFault, upsIdentManufacturer=upsIdentManufacturer, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsControl=upsControl, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsConformance=upsConformance, upsOutputCurrent=upsOutputCurrent, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsFullCompliance=upsFullCompliance, upsOutputPower=upsOutputPower, upsFullOutputGroup=upsFullOutputGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBattery=upsBattery, upsBypassNumLines=upsBypassNumLines, NonNegativeInteger=NonNegativeInteger, upsBasicAlarmGroup=upsBasicAlarmGroup, upsInputVoltage=upsInputVoltage, upsAlarmInputBad=upsAlarmInputBad, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTest=upsTest, upsFullControlGroup=upsFullControlGroup, upsFullConfigGroup=upsFullConfigGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigInputFreq=upsConfigInputFreq, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarm=upsAlarm, upsAlarmTestInProgress=upsAlarmTestInProgress, upsFullBypassGroup=upsFullBypassGroup, upsFullTestGroup=upsFullTestGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsIdent=upsIdent, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBypassFrequency=upsBypassFrequency, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTestElapsedTime=upsTestElapsedTime, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmEntry=upsAlarmEntry, upsSubsetGroups=upsSubsetGroups, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmsPresent=upsAlarmsPresent, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsIdentName=upsIdentName, upsTrapOnBattery=upsTrapOnBattery, upsAlarmOnBattery=upsAlarmOnBattery, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsInputTruePower=upsInputTruePower, upsTestSpinLock=upsTestSpinLock, upsBatteryVoltage=upsBatteryVoltage, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmTempBad=upsAlarmTempBad, upsInputLineBads=upsInputLineBads, upsAlarmFanFailure=upsAlarmFanFailure, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmOutputBad=upsAlarmOutputBad, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsConfigOutputVA=upsConfigOutputVA, upsShutdownType=upsShutdownType, upsWellKnownTests=upsWellKnownTests, upsTestResultsDetail=upsTestResultsDetail, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsOutputSource=upsOutputSource, upsSubsetControlGroup=upsSubsetControlGroup, upsInputCurrent=upsInputCurrent, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmTime=upsAlarmTime, upsMIB=upsMIB, upsAlarmFuseFailure=upsAlarmFuseFailure, upsOutputPercentLoad=upsOutputPercentLoad, upsBypass=upsBypass, upsBasicBypassGroup=upsBasicBypassGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTrapTestCompleted=upsTrapTestCompleted, upsOutputFrequency=upsOutputFrequency, upsBasicOutputGroup=upsBasicOutputGroup, upsOutputNumLines=upsOutputNumLines, upsOutputLineIndex=upsOutputLineIndex, upsBypassVoltage=upsBypassVoltage, upsConfigAudibleStatus=upsConfigAudibleStatus, upsSubsetCompliance=upsSubsetCompliance, upsInputNumLines=upsInputNumLines, upsConfigOutputPower=upsConfigOutputPower, upsAlarmShutdownPending=upsAlarmShutdownPending, upsTraps=upsTraps, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBypassCurrent=upsBypassCurrent, upsBasicGroups=upsBasicGroups, upsBypassLineIndex=upsBypassLineIndex, upsBypassEntry=upsBypassEntry, upsConfig=upsConfig, upsOutput=upsOutput, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsOutputTable=upsOutputTable, PYSNMP_MODULE_ID=upsMIB, upsAlarmOutputOverload=upsAlarmOutputOverload, upsInputTable=upsInputTable, upsInput=upsInput, upsAlarmTable=upsAlarmTable, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAutoRestart=upsAutoRestart, upsOutputEntry=upsOutputEntry, PositiveInteger=PositiveInteger, upsConfigOutputVoltage=upsConfigOutputVoltage, upsInputEntry=upsInputEntry, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBatteryTemperature=upsBatteryTemperature, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsInputFrequency=upsInputFrequency, upsTestId=upsTestId, upsGroups=upsGroups, upsAlarmId=upsAlarmId, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmDescr=upsAlarmDescr, upsOutputVoltage=upsOutputVoltage, upsBasicConfigGroup=upsBasicConfigGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsBasicTestGroup=upsBasicTestGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsTestStartTime=upsTestStartTime)
