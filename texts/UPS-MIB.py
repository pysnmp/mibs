...
# Produced by pysmi-1.1.12 at Mon Jul  1 09:10:11 2024
...
Unsigned32, Counter32, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Gauge32, NotificationType, Counter64, MibIdentifier, TimeTicks, mib_2, Integer32, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Gauge32", "NotificationType", "Counter64", "MibIdentifier", "TimeTicks", "mib-2", "Integer32", "iso", "Bits")
...
mibBuilder.exportSymbols("UPS-MIB", upsTrapOnBattery=upsTrapOnBattery, upsSecondsOnBattery=upsSecondsOnBattery, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsConfigOutputPower=upsConfigOutputPower, upsInputEntry=upsInputEntry, upsFullBypassGroup=upsFullBypassGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsCompliances=upsCompliances, upsFullOutputGroup=upsFullOutputGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsWellKnownTests=upsWellKnownTests, upsInputTable=upsInputTable, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsRebootWithDuration=upsRebootWithDuration, upsInput=upsInput, upsIdentName=upsIdentName, upsConfigInputFreq=upsConfigInputFreq, upsIdentModel=upsIdentModel, upsIdentManufacturer=upsIdentManufacturer, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsOutputLineIndex=upsOutputLineIndex, PYSNMP_MODULE_ID=upsMIB, upsOutputFrequency=upsOutputFrequency, upsInputTruePower=upsInputTruePower, upsBasicControlGroup=upsBasicControlGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarm=upsAlarm, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmsPresent=upsAlarmsPresent, upsBypassFrequency=upsBypassFrequency, upsBasicTestGroup=upsBasicTestGroup, upsAlarmInputBad=upsAlarmInputBad, upsObjects=upsObjects, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestResultsSummary=upsTestResultsSummary, upsOutputSource=upsOutputSource, upsShutdownType=upsShutdownType, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBypassPower=upsBypassPower, upsBypassVoltage=upsBypassVoltage, upsInputFrequency=upsInputFrequency, upsBypassEntry=upsBypassEntry, upsFullConfigGroup=upsFullConfigGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTrapTestCompleted=upsTrapTestCompleted, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBypassTable=upsBypassTable, upsInputLineBads=upsInputLineBads, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBasicBypassGroup=upsBasicBypassGroup, upsTestSpinLock=upsTestSpinLock, upsSubsetGroups=upsSubsetGroups, PositiveInteger=PositiveInteger, upsTestResultsDetail=upsTestResultsDetail, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBypassNumLines=upsBypassNumLines, upsConformance=upsConformance, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmId=upsAlarmId, upsInputCurrent=upsInputCurrent, upsAlarmBypassBad=upsAlarmBypassBad, upsBypass=upsBypass, upsAlarmOnBypass=upsAlarmOnBypass, upsBasicInputGroup=upsBasicInputGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTest=upsTest, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsFullTestGroup=upsFullTestGroup, upsAlarmTime=upsAlarmTime, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConfigAudibleStatus=upsConfigAudibleStatus, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmEntry=upsAlarmEntry, upsTestElapsedTime=upsTestElapsedTime, upsBasicCompliance=upsBasicCompliance, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConfigInputVoltage=upsConfigInputVoltage, upsSubsetCompliance=upsSubsetCompliance, upsBatteryVoltage=upsBatteryVoltage, upsFullGroups=upsFullGroups, upsOutput=upsOutput, upsConfigOutputVoltage=upsConfigOutputVoltage, NonNegativeInteger=NonNegativeInteger, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmTempBad=upsAlarmTempBad, upsInputVoltage=upsInputVoltage, upsGroups=upsGroups, upsWellKnownAlarms=upsWellKnownAlarms, upsFullCompliance=upsFullCompliance, upsStartupAfterDelay=upsStartupAfterDelay, upsBasicAlarmGroup=upsBasicAlarmGroup, upsOutputEntry=upsOutputEntry, upsBatteryCurrent=upsBatteryCurrent, upsInputNumLines=upsInputNumLines, upsShutdownAfterDelay=upsShutdownAfterDelay, upsOutputVoltage=upsOutputVoltage, upsBattery=upsBattery, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTestStartTime=upsTestStartTime, upsMIB=upsMIB, upsAutoRestart=upsAutoRestart, upsFullControlGroup=upsFullControlGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsControl=upsControl, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmOutputBad=upsAlarmOutputBad, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTestId=upsTestId, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsIdent=upsIdent, upsAlarmGeneralFault=upsAlarmGeneralFault, upsOutputPower=upsOutputPower, upsConfig=upsConfig, upsConfigOutputVA=upsConfigOutputVA, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicGroups=upsBasicGroups, upsBasicOutputGroup=upsBasicOutputGroup, upsBypassCurrent=upsBypassCurrent, upsOutputNumLines=upsOutputNumLines, upsOutputTable=upsOutputTable, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsOutputCurrent=upsOutputCurrent, upsSubsetIdentGroup=upsSubsetIdentGroup, upsInputLineIndex=upsInputLineIndex, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmDescr=upsAlarmDescr, upsConfigOutputFreq=upsConfigOutputFreq, upsFullIdentGroup=upsFullIdentGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsSubsetInputGroup=upsSubsetInputGroup, upsBypassLineIndex=upsBypassLineIndex, upsBatteryStatus=upsBatteryStatus, upsBatteryTemperature=upsBatteryTemperature, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmFanFailure=upsAlarmFanFailure, upsFullInputGroup=upsFullInputGroup, upsAlarmTable=upsAlarmTable, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTraps=upsTraps, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved)
