...
# Produced by pysmi-1.1.8 at Wed Feb  2 17:52:36 2022
...
Gauge32, TimeTicks, Bits, MibIdentifier, ModuleIdentity, Counter32, Unsigned32, mib_2, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, Integer32, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "Bits", "MibIdentifier", "ModuleIdentity", "Counter32", "Unsigned32", "mib-2", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "Integer32", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("UPS-MIB", upsBypassPower=upsBypassPower, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsShutdownAfterDelay=upsShutdownAfterDelay, upsWellKnownTests=upsWellKnownTests, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmShutdownPending=upsAlarmShutdownPending, upsFullInputGroup=upsFullInputGroup, upsBypassFrequency=upsBypassFrequency, NonNegativeInteger=NonNegativeInteger, upsTestStartTime=upsTestStartTime, upsOutputEntry=upsOutputEntry, upsInputTruePower=upsInputTruePower, upsOutputSource=upsOutputSource, upsConfigOutputPower=upsConfigOutputPower, upsInputFrequency=upsInputFrequency, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTestElapsedTime=upsTestElapsedTime, upsAlarmLowBattery=upsAlarmLowBattery, upsConformance=upsConformance, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBypassCurrent=upsBypassCurrent, PYSNMP_MODULE_ID=upsMIB, upsAlarmDescr=upsAlarmDescr, upsBatteryCurrent=upsBatteryCurrent, upsShutdownType=upsShutdownType, upsFullCompliance=upsFullCompliance, upsBasicOutputGroup=upsBasicOutputGroup, upsBasicCompliance=upsBasicCompliance, upsFullTestGroup=upsFullTestGroup, upsInputEntry=upsInputEntry, upsOutputTable=upsOutputTable, upsAlarmOnBypass=upsAlarmOnBypass, upsOutputPower=upsOutputPower, upsTestResultsDetail=upsTestResultsDetail, upsAlarmFuseFailure=upsAlarmFuseFailure, upsOutputFrequency=upsOutputFrequency, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicBypassGroup=upsBasicBypassGroup, upsIdentManufacturer=upsIdentManufacturer, upsBatteryStatus=upsBatteryStatus, upsTrapOnBattery=upsTrapOnBattery, upsFullGroups=upsFullGroups, upsInputNumLines=upsInputNumLines, upsInputLineBads=upsInputLineBads, upsTestResultsSummary=upsTestResultsSummary, upsOutput=upsOutput, upsFullConfigGroup=upsFullConfigGroup, PositiveInteger=PositiveInteger, upsAlarmFanFailure=upsAlarmFanFailure, upsBatteryTemperature=upsBatteryTemperature, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfigLowBattTime=upsConfigLowBattTime, upsConfigOutputFreq=upsConfigOutputFreq, upsSubsetGroups=upsSubsetGroups, upsAlarm=upsAlarm, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsInputLineIndex=upsInputLineIndex, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBasicConfigGroup=upsBasicConfigGroup, upsBasicGroups=upsBasicGroups, upsConfigInputFreq=upsConfigInputFreq, upsBasicIdentGroup=upsBasicIdentGroup, upsAutoRestart=upsAutoRestart, upsTrapTestCompleted=upsTrapTestCompleted, upsIdentModel=upsIdentModel, upsFullBypassGroup=upsFullBypassGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmBypassBad=upsAlarmBypassBad, upsBypassEntry=upsBypassEntry, upsFullAlarmGroup=upsFullAlarmGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsOutputNumLines=upsOutputNumLines, upsAlarmChargerFailed=upsAlarmChargerFailed, upsTraps=upsTraps, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmTable=upsAlarmTable, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBypass=upsBypass, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBattery=upsBattery, upsWellKnownAlarms=upsWellKnownAlarms, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsCompliances=upsCompliances, upsInputVoltage=upsInputVoltage, upsOutputCurrent=upsOutputCurrent, upsBasicControlGroup=upsBasicControlGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsInputCurrent=upsInputCurrent, upsIdentName=upsIdentName, upsFullIdentGroup=upsFullIdentGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsSubsetCompliance=upsSubsetCompliance, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsRebootWithDuration=upsRebootWithDuration, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsObjects=upsObjects, upsIdent=upsIdent, upsBypassVoltage=upsBypassVoltage, upsAlarmTempBad=upsAlarmTempBad, upsAlarmInputBad=upsAlarmInputBad, upsMIB=upsMIB, upsConfig=upsConfig, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBasicTestGroup=upsBasicTestGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsControl=upsControl, upsFullControlGroup=upsFullControlGroup, upsTestSpinLock=upsTestSpinLock, upsInput=upsInput, upsBypassLineIndex=upsBypassLineIndex, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmId=upsAlarmId, upsFullBatteryGroup=upsFullBatteryGroup, upsFullOutputGroup=upsFullOutputGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsOutputLineIndex=upsOutputLineIndex, upsConfigInputVoltage=upsConfigInputVoltage, upsBypassNumLines=upsBypassNumLines, upsGroups=upsGroups, upsAlarmTime=upsAlarmTime, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTestId=upsTestId, upsBasicInputGroup=upsBasicInputGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTest=upsTest, upsAlarmEntry=upsAlarmEntry, upsAlarmsPresent=upsAlarmsPresent, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBypassTable=upsBypassTable, upsConfigOutputVA=upsConfigOutputVA, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsOutputVoltage=upsOutputVoltage, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsStartupAfterDelay=upsStartupAfterDelay, upsBatteryVoltage=upsBatteryVoltage, upsInputTable=upsInputTable, upsSubsetControlGroup=upsSubsetControlGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmOutputOverload=upsAlarmOutputOverload)
