...
mibBuilder.exportSymbols("UPS-MIB", upsBasicTestGroup=upsBasicTestGroup, upsBatteryStatus=upsBatteryStatus, upsInputLineIndex=upsInputLineIndex, upsTest=upsTest, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBasicBatteryGroup=upsBasicBatteryGroup, upsSubsetCompliance=upsSubsetCompliance, upsOutputPower=upsOutputPower, upsInput=upsInput, upsInputTable=upsInputTable, upsInputLineBads=upsInputLineBads, upsTestSpinLock=upsTestSpinLock, upsBypassVoltage=upsBypassVoltage, upsAlarm=upsAlarm, upsAlarmTestInProgress=upsAlarmTestInProgress, upsFullIdentGroup=upsFullIdentGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBypassEntry=upsBypassEntry, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsFullBatteryGroup=upsFullBatteryGroup, upsBatteryCurrent=upsBatteryCurrent, upsShutdownType=upsShutdownType, upsTrapTestCompleted=upsTrapTestCompleted, upsBasicInputGroup=upsBasicInputGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmFanFailure=upsAlarmFanFailure, upsObjects=upsObjects, upsAlarmBypassBad=upsAlarmBypassBad, upsGroups=upsGroups, upsOutputLineIndex=upsOutputLineIndex, upsFullInputGroup=upsFullInputGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsOutputEntry=upsOutputEntry, PositiveInteger=PositiveInteger, upsConfigOutputVA=upsConfigOutputVA, upsOutputFrequency=upsOutputFrequency, upsConfigLowBattTime=upsConfigLowBattTime, upsFullTestGroup=upsFullTestGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsOutputCurrent=upsOutputCurrent, upsOutputPercentLoad=upsOutputPercentLoad, upsConfigInputVoltage=upsConfigInputVoltage, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBypassPower=upsBypassPower, upsTestResultsDetail=upsTestResultsDetail, upsBatteryVoltage=upsBatteryVoltage, upsBasicCompliance=upsBasicCompliance, upsFullConfigGroup=upsFullConfigGroup, upsFullControlGroup=upsFullControlGroup, upsFullOutputGroup=upsFullOutputGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, PYSNMP_MODULE_ID=upsMIB, upsAlarmEntry=upsAlarmEntry, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTraps=upsTraps, upsSubsetInputGroup=upsSubsetInputGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBypassFrequency=upsBypassFrequency, upsTestStartTime=upsTestStartTime, upsConformance=upsConformance, upsAlarmShutdownPending=upsAlarmShutdownPending, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmTempBad=upsAlarmTempBad, upsTestResultsSummary=upsTestResultsSummary, upsIdentManufacturer=upsIdentManufacturer, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsFullBypassGroup=upsFullBypassGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsConfigAudibleStatus=upsConfigAudibleStatus, upsOutputTable=upsOutputTable, upsAutoRestart=upsAutoRestart, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsConfig=upsConfig, upsFullCompliance=upsFullCompliance, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsConfigInputFreq=upsConfigInputFreq, upsBasicAlarmGroup=upsBasicAlarmGroup, NonNegativeInteger=NonNegativeInteger, upsIdentName=upsIdentName, upsInputVoltage=upsInputVoltage, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsControl=upsControl, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsSubsetGroups=upsSubsetGroups, upsWellKnownAlarms=upsWellKnownAlarms, upsFullGroups=upsFullGroups, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmOutputOverload=upsAlarmOutputOverload, upsInputFrequency=upsInputFrequency, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullAlarmGroup=upsFullAlarmGroup, upsCompliances=upsCompliances, upsBypassLineIndex=upsBypassLineIndex, upsAlarmChargerFailed=upsAlarmChargerFailed, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBatteryTemperature=upsBatteryTemperature, upsInputEntry=upsInputEntry, upsBasicGroups=upsBasicGroups, upsBasicControlGroup=upsBasicControlGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsConfigOutputVoltage=upsConfigOutputVoltage, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmLowBattery=upsAlarmLowBattery, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsInputCurrent=upsInputCurrent, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsInputTruePower=upsInputTruePower, upsOutput=upsOutput, upsBattery=upsBattery, upsBypassNumLines=upsBypassNumLines, upsOutputVoltage=upsOutputVoltage, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmTable=upsAlarmTable, upsAlarmTime=upsAlarmTime, upsConfigOutputPower=upsConfigOutputPower, upsStartupAfterDelay=upsStartupAfterDelay, upsOutputNumLines=upsOutputNumLines, upsBypassTable=upsBypassTable, upsOutputSource=upsOutputSource, upsBasicIdentGroup=upsBasicIdentGroup, upsWellKnownTests=upsWellKnownTests, upsTestId=upsTestId, upsAlarmsPresent=upsAlarmsPresent, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsIdentModel=upsIdentModel, upsRebootWithDuration=upsRebootWithDuration, upsInputNumLines=upsInputNumLines, upsAlarmId=upsAlarmId, upsBypass=upsBypass, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmOnBattery=upsAlarmOnBattery, upsTrapOnBattery=upsTrapOnBattery, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmDescr=upsAlarmDescr, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigOutputFreq=upsConfigOutputFreq, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmInputBad=upsAlarmInputBad, upsTestElapsedTime=upsTestElapsedTime, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsIdent=upsIdent, upsBypassCurrent=upsBypassCurrent, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsMIB=upsMIB)
