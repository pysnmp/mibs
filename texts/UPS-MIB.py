...
NotificationType, TimeTicks, iso, ObjectIdentity, Bits, Unsigned32, MibIdentifier, IpAddress, Integer32, Gauge32, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "iso", "ObjectIdentity", "Bits", "Unsigned32", "MibIdentifier", "IpAddress", "Integer32", "Gauge32", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "mib-2")
TestAndIncr, TimeStamp, AutonomousType, DisplayString, TimeInterval, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TimeStamp", "AutonomousType", "DisplayString", "TimeInterval", "TextualConvention")
...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmShutdownPending=upsAlarmShutdownPending, upsOutputEntry=upsOutputEntry, upsAlarmsPresent=upsAlarmsPresent, upsAlarmInputBad=upsAlarmInputBad, upsObjects=upsObjects, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsFullBypassGroup=upsFullBypassGroup, upsTestStartTime=upsTestStartTime, upsBypass=upsBypass, upsSecondsOnBattery=upsSecondsOnBattery, upsWellKnownTests=upsWellKnownTests, upsFullCompliance=upsFullCompliance, upsBasicInputGroup=upsBasicInputGroup, upsBasicCompliance=upsBasicCompliance, upsGroups=upsGroups, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsConfig=upsConfig, upsMIB=upsMIB, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsOutputNumLines=upsOutputNumLines, upsBypassCurrent=upsBypassCurrent, upsBasicGroups=upsBasicGroups, upsFullBatteryGroup=upsFullBatteryGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsCompliances=upsCompliances, upsBypassEntry=upsBypassEntry, upsBasicConfigGroup=upsBasicConfigGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsIdent=upsIdent, upsConfigOutputPower=upsConfigOutputPower, upsSubsetOutputGroup=upsSubsetOutputGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarm=upsAlarm, upsInputCurrent=upsInputCurrent, upsTrapOnBattery=upsTrapOnBattery, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBypassTable=upsBypassTable, NonNegativeInteger=NonNegativeInteger, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBattery=upsBattery, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBypassPower=upsBypassPower, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsWellKnownAlarms=upsWellKnownAlarms, upsOutputFrequency=upsOutputFrequency, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsTrapTestCompleted=upsTrapTestCompleted, upsInputLineIndex=upsInputLineIndex, upsInput=upsInput, upsIdentName=upsIdentName, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsInputTruePower=upsInputTruePower, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsFullTestGroup=upsFullTestGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsInputTable=upsInputTable, upsConfigAudibleStatus=upsConfigAudibleStatus, upsSubsetCompliance=upsSubsetCompliance, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsOutputCurrent=upsOutputCurrent, upsIdentManufacturer=upsIdentManufacturer, upsInputVoltage=upsInputVoltage, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsOutputPower=upsOutputPower, upsBasicTestGroup=upsBasicTestGroup, upsTestResultsSummary=upsTestResultsSummary, upsFullInputGroup=upsFullInputGroup, upsIdentModel=upsIdentModel, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConformance=upsConformance, upsBypassLineIndex=upsBypassLineIndex, upsBatteryVoltage=upsBatteryVoltage, upsAlarmOnBypass=upsAlarmOnBypass, upsOutput=upsOutput, upsAlarmTestInProgress=upsAlarmTestInProgress, upsOutputSource=upsOutputSource, upsBypassVoltage=upsBypassVoltage, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsRebootWithDuration=upsRebootWithDuration, upsInputFrequency=upsInputFrequency, PYSNMP_MODULE_ID=upsMIB, upsSubsetControlGroup=upsSubsetControlGroup, upsFullIdentGroup=upsFullIdentGroup, upsAutoRestart=upsAutoRestart, upsInputEntry=upsInputEntry, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsConfigInputFreq=upsConfigInputFreq, upsBasicBypassGroup=upsBasicBypassGroup, upsOutputTable=upsOutputTable, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullAlarmGroup=upsFullAlarmGroup, upsBatteryCurrent=upsBatteryCurrent, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmTime=upsAlarmTime, upsAlarmId=upsAlarmId, upsFullConfigGroup=upsFullConfigGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBypassFrequency=upsBypassFrequency, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsConfigOutputVA=upsConfigOutputVA, upsBasicControlGroup=upsBasicControlGroup, upsOutputLineIndex=upsOutputLineIndex, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTestId=upsTestId, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicAlarmGroup=upsBasicAlarmGroup, upsFullControlGroup=upsFullControlGroup, upsFullGroups=upsFullGroups, upsBatteryStatus=upsBatteryStatus, upsOutputVoltage=upsOutputVoltage, upsIdentAttachedDevices=upsIdentAttachedDevices, upsInputNumLines=upsInputNumLines, PositiveInteger=PositiveInteger, upsShutdownAfterDelay=upsShutdownAfterDelay, upsInputLineBads=upsInputLineBads, upsFullOutputGroup=upsFullOutputGroup, upsBypassNumLines=upsBypassNumLines, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestResultsDetail=upsTestResultsDetail, upsAlarmDescr=upsAlarmDescr, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsConfigInputVoltage=upsConfigInputVoltage, upsTest=upsTest, upsTraps=upsTraps, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmTable=upsAlarmTable, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsControl=upsControl, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmTempBad=upsAlarmTempBad, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsShutdownType=upsShutdownType, upsSubsetGroups=upsSubsetGroups, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmEntry=upsAlarmEntry, upsTestElapsedTime=upsTestElapsedTime, upsBatteryTemperature=upsBatteryTemperature, upsTestSpinLock=upsTestSpinLock)
