...
mibBuilder.exportSymbols("UPS-MIB", upsTrapTestCompleted=upsTrapTestCompleted, upsBypassLineIndex=upsBypassLineIndex, upsFullTestGroup=upsFullTestGroup, upsTestResultsDetail=upsTestResultsDetail, upsAlarmOnBypass=upsAlarmOnBypass, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsFullBypassGroup=upsFullBypassGroup, upsInputEntry=upsInputEntry, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsStartupAfterDelay=upsStartupAfterDelay, upsConfigInputVoltage=upsConfigInputVoltage, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBasicBypassGroup=upsBasicBypassGroup, upsFullOutputGroup=upsFullOutputGroup, upsBattery=upsBattery, upsTest=upsTest, upsAlarmDescr=upsAlarmDescr, upsInputLineIndex=upsInputLineIndex, upsAlarmOutputBad=upsAlarmOutputBad, upsBasicOutputGroup=upsBasicOutputGroup, upsInputNumLines=upsInputNumLines, upsBatteryTemperature=upsBatteryTemperature, upsConfigOutputVoltage=upsConfigOutputVoltage, upsIdentName=upsIdentName, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsFullInputGroup=upsFullInputGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmTime=upsAlarmTime, upsBypassTable=upsBypassTable, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutputLineIndex=upsOutputLineIndex, upsBasicGroups=upsBasicGroups, upsConformance=upsConformance, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTestId=upsTestId, upsAlarmLowBattery=upsAlarmLowBattery, upsWellKnownTests=upsWellKnownTests, upsAlarmInputBad=upsAlarmInputBad, upsBatteryStatus=upsBatteryStatus, upsOutputVoltage=upsOutputVoltage, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsOutputFrequency=upsOutputFrequency, upsSecondsOnBattery=upsSecondsOnBattery, upsInputVoltage=upsInputVoltage, upsConfigInputFreq=upsConfigInputFreq, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsShutdownType=upsShutdownType, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAutoRestart=upsAutoRestart, upsInput=upsInput, upsConfig=upsConfig, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsFullControlGroup=upsFullControlGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsInputFrequency=upsInputFrequency, upsBypassCurrent=upsBypassCurrent, upsMIB=upsMIB, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBatteryVoltage=upsBatteryVoltage, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsOutputSource=upsOutputSource, upsAlarmOnBattery=upsAlarmOnBattery, upsWellKnownAlarms=upsWellKnownAlarms, upsBypassPower=upsBypassPower, upsAlarmTempBad=upsAlarmTempBad, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsOutputPercentLoad=upsOutputPercentLoad, upsBasicTestGroup=upsBasicTestGroup, upsTestStartTime=upsTestStartTime, upsInputTable=upsInputTable, upsBasicIdentGroup=upsBasicIdentGroup, upsInputTruePower=upsInputTruePower, upsFullGroups=upsFullGroups, upsAlarmFanFailure=upsAlarmFanFailure, upsTrapOnBattery=upsTrapOnBattery, NonNegativeInteger=NonNegativeInteger, upsCompliances=upsCompliances, upsBasicControlGroup=upsBasicControlGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBypassVoltage=upsBypassVoltage, upsBypass=upsBypass, upsFullCompliance=upsFullCompliance, upsBasicInputGroup=upsBasicInputGroup, upsBypassEntry=upsBypassEntry, upsSubsetControlGroup=upsSubsetControlGroup, upsTestResultsSummary=upsTestResultsSummary, upsBypassNumLines=upsBypassNumLines, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, PYSNMP_MODULE_ID=upsMIB, upsAlarm=upsAlarm, upsTestSpinLock=upsTestSpinLock, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsConfigOutputVA=upsConfigOutputVA, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBypassFrequency=upsBypassFrequency, upsFullIdentGroup=upsFullIdentGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConfigOutputPower=upsConfigOutputPower, upsBasicAlarmGroup=upsBasicAlarmGroup, upsFullBatteryGroup=upsFullBatteryGroup, PositiveInteger=PositiveInteger, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmBatteryBad=upsAlarmBatteryBad, upsInputCurrent=upsInputCurrent, upsConfigOutputFreq=upsConfigOutputFreq, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsOutputTable=upsOutputTable, upsInputLineBads=upsInputLineBads, upsOutputNumLines=upsOutputNumLines, upsSubsetCompliance=upsSubsetCompliance, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsOutput=upsOutput, upsAlarmBypassBad=upsAlarmBypassBad, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmTable=upsAlarmTable, upsTestElapsedTime=upsTestElapsedTime, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmId=upsAlarmId, upsObjects=upsObjects, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsIdentModel=upsIdentModel, upsOutputPower=upsOutputPower, upsOutputEntry=upsOutputEntry, upsFullConfigGroup=upsFullConfigGroup, upsAlarmsPresent=upsAlarmsPresent, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsIdent=upsIdent, upsAlarmEntry=upsAlarmEntry, upsBatteryCurrent=upsBatteryCurrent, upsFullAlarmGroup=upsFullAlarmGroup, upsSubsetGroups=upsSubsetGroups, upsTraps=upsTraps, upsGroups=upsGroups, upsAlarmOutputOverload=upsAlarmOutputOverload, upsControl=upsControl, upsIdentManufacturer=upsIdentManufacturer, upsOutputCurrent=upsOutputCurrent, upsBasicCompliance=upsBasicCompliance, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsSubsetInputGroup=upsSubsetInputGroup, upsRebootWithDuration=upsRebootWithDuration)
