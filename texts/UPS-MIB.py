...
mibBuilder.exportSymbols("UPS-MIB", upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsCompliances=upsCompliances, upsIdentManufacturer=upsIdentManufacturer, upsOutput=upsOutput, upsSubsetConfigGroup=upsSubsetConfigGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsWellKnownTests=upsWellKnownTests, upsOutputCurrent=upsOutputCurrent, upsOutputLineIndex=upsOutputLineIndex, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsFullCompliance=upsFullCompliance, upsTestSpinLock=upsTestSpinLock, upsIdentAttachedDevices=upsIdentAttachedDevices, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsSubsetCompliance=upsSubsetCompliance, upsOutputPercentLoad=upsOutputPercentLoad, upsBasicIdentGroup=upsBasicIdentGroup, upsTest=upsTest, upsFullBypassGroup=upsFullBypassGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsConfigOutputVoltage=upsConfigOutputVoltage, upsOutputEntry=upsOutputEntry, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsFullConfigGroup=upsFullConfigGroup, upsInputVoltage=upsInputVoltage, upsInput=upsInput, upsBypassEntry=upsBypassEntry, upsInputLineBads=upsInputLineBads, upsAlarmDescr=upsAlarmDescr, upsConfigAudibleStatus=upsConfigAudibleStatus, NonNegativeInteger=NonNegativeInteger, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsMIB=upsMIB, upsConfigOutputVA=upsConfigOutputVA, upsTestId=upsTestId, upsBasicCompliance=upsBasicCompliance, upsBasicControlGroup=upsBasicControlGroup, upsIdentName=upsIdentName, upsOutputVoltage=upsOutputVoltage, upsBatteryVoltage=upsBatteryVoltage, upsShutdownType=upsShutdownType, upsBasicTestGroup=upsBasicTestGroup, upsFullControlGroup=upsFullControlGroup, upsBatteryCurrent=upsBatteryCurrent, upsOutputFrequency=upsOutputFrequency, upsAlarmLowBattery=upsAlarmLowBattery, upsBasicInputGroup=upsBasicInputGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsInputTable=upsInputTable, upsAlarmFuseFailure=upsAlarmFuseFailure, PYSNMP_MODULE_ID=upsMIB, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmInputBad=upsAlarmInputBad, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsFullGroups=upsFullGroups, upsAutoRestart=upsAutoRestart, upsTraps=upsTraps, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmChargerFailed=upsAlarmChargerFailed, upsOutputPower=upsOutputPower, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTestElapsedTime=upsTestElapsedTime, upsBattery=upsBattery, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmsPresent=upsAlarmsPresent, upsBasicOutputGroup=upsBasicOutputGroup, upsInputTruePower=upsInputTruePower, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmOnBypass=upsAlarmOnBypass, upsFullInputGroup=upsFullInputGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsTestResultsSummary=upsTestResultsSummary, upsBypassFrequency=upsBypassFrequency, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsSubsetIdentGroup=upsSubsetIdentGroup, upsConfigOutputPower=upsConfigOutputPower, upsInputLineIndex=upsInputLineIndex, upsBypass=upsBypass, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmId=upsAlarmId, upsFullTestGroup=upsFullTestGroup, upsAlarmTempBad=upsAlarmTempBad, upsSubsetGroups=upsSubsetGroups, upsFullOutputGroup=upsFullOutputGroup, upsTrapOnBattery=upsTrapOnBattery, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsConfigInputFreq=upsConfigInputFreq, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmBypassBad=upsAlarmBypassBad, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarm=upsAlarm, upsOutputTable=upsOutputTable, upsBatteryStatus=upsBatteryStatus, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsIdentModel=upsIdentModel, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsConformance=upsConformance, upsTestStartTime=upsTestStartTime, upsFullBatteryGroup=upsFullBatteryGroup, upsBatteryTemperature=upsBatteryTemperature, upsConfig=upsConfig, upsGroups=upsGroups, PositiveInteger=PositiveInteger, upsBypassNumLines=upsBypassNumLines, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBypassTable=upsBypassTable, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBasicAlarmGroup=upsBasicAlarmGroup, upsFullIdentGroup=upsFullIdentGroup, upsIdent=upsIdent, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsRebootWithDuration=upsRebootWithDuration, upsSubsetOutputGroup=upsSubsetOutputGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsInputCurrent=upsInputCurrent, upsAlarmTable=upsAlarmTable, upsAlarmOutputBad=upsAlarmOutputBad, upsSubsetControlGroup=upsSubsetControlGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsBypassPower=upsBypassPower, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmEntry=upsAlarmEntry, upsObjects=upsObjects, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsConfigLowBattTime=upsConfigLowBattTime, upsInputFrequency=upsInputFrequency, upsBasicGroups=upsBasicGroups, upsTestResultsDetail=upsTestResultsDetail, upsAlarmTestInProgress=upsAlarmTestInProgress, upsOutputNumLines=upsOutputNumLines, upsOutputSource=upsOutputSource, upsInputNumLines=upsInputNumLines, upsBypassVoltage=upsBypassVoltage, upsControl=upsControl, upsBypassLineIndex=upsBypassLineIndex, upsAlarmTime=upsAlarmTime, upsInputEntry=upsInputEntry, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBypassCurrent=upsBypassCurrent, upsAlarmShutdownPending=upsAlarmShutdownPending)
