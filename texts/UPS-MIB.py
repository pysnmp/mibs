...
# Produced by pysmi-1.1.8 at Thu Apr 27 12:06:04 2023
...
IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, mib_2, ModuleIdentity, NotificationType, ObjectIdentity, Integer32, TimeTicks, Counter64, Gauge32, Unsigned32, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "mib-2", "ModuleIdentity", "NotificationType", "ObjectIdentity", "Integer32", "TimeTicks", "Counter64", "Gauge32", "Unsigned32", "Counter32", "iso")
...
mibBuilder.exportSymbols("UPS-MIB", upsOutputPower=upsOutputPower, upsTestResultsDetail=upsTestResultsDetail, upsTrapTestCompleted=upsTrapTestCompleted, upsConfig=upsConfig, NonNegativeInteger=NonNegativeInteger, upsBasicAlarmGroup=upsBasicAlarmGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsShutdownAfterDelay=upsShutdownAfterDelay, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsInputCurrent=upsInputCurrent, upsBypassTable=upsBypassTable, upsBypassVoltage=upsBypassVoltage, upsInputLineBads=upsInputLineBads, upsAlarmInputBad=upsAlarmInputBad, upsBypassCurrent=upsBypassCurrent, upsWellKnownAlarms=upsWellKnownAlarms, upsBasicTestGroup=upsBasicTestGroup, upsControl=upsControl, upsFullOutputGroup=upsFullOutputGroup, upsFullBypassGroup=upsFullBypassGroup, upsInputLineIndex=upsInputLineIndex, upsRebootWithDuration=upsRebootWithDuration, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutputSource=upsOutputSource, upsFullTestGroup=upsFullTestGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTestSpinLock=upsTestSpinLock, upsBasicCompliance=upsBasicCompliance, upsTraps=upsTraps, upsSubsetConfigGroup=upsSubsetConfigGroup, upsInputTable=upsInputTable, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsInput=upsInput, upsAlarmOnBattery=upsAlarmOnBattery, PositiveInteger=PositiveInteger, upsAlarmFanFailure=upsAlarmFanFailure, upsInputEntry=upsInputEntry, upsGroups=upsGroups, upsFullControlGroup=upsFullControlGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsInputVoltage=upsInputVoltage, upsFullGroups=upsFullGroups, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmId=upsAlarmId, upsFullBatteryGroup=upsFullBatteryGroup, upsBattery=upsBattery, upsConfigOutputPower=upsConfigOutputPower, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBasicControlGroup=upsBasicControlGroup, upsIdentModel=upsIdentModel, upsAlarmTime=upsAlarmTime, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsOutputLineIndex=upsOutputLineIndex, upsInputFrequency=upsInputFrequency, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmTable=upsAlarmTable, upsInputTruePower=upsInputTruePower, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmDescr=upsAlarmDescr, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsOutputTable=upsOutputTable, upsBatteryStatus=upsBatteryStatus, upsConfigInputVoltage=upsConfigInputVoltage, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsConfigOutputFreq=upsConfigOutputFreq, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsSubsetOutputGroup=upsSubsetOutputGroup, upsOutputNumLines=upsOutputNumLines, upsFullIdentGroup=upsFullIdentGroup, upsBasicInputGroup=upsBasicInputGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsFullInputGroup=upsFullInputGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTestStartTime=upsTestStartTime, upsFullConfigGroup=upsFullConfigGroup, upsShutdownType=upsShutdownType, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAutoRestart=upsAutoRestart, upsBypass=upsBypass, PYSNMP_MODULE_ID=upsMIB, upsIdentManufacturer=upsIdentManufacturer, upsBypassEntry=upsBypassEntry, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsStartupAfterDelay=upsStartupAfterDelay, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBasicGroups=upsBasicGroups, upsTrapOnBattery=upsTrapOnBattery, upsTestId=upsTestId, upsTest=upsTest, upsAlarmOnBypass=upsAlarmOnBypass, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmTempBad=upsAlarmTempBad, upsObjects=upsObjects, upsCompliances=upsCompliances, upsOutputFrequency=upsOutputFrequency, upsBatteryVoltage=upsBatteryVoltage, upsAlarmEntry=upsAlarmEntry, upsBatteryCurrent=upsBatteryCurrent, upsFullCompliance=upsFullCompliance, upsConformance=upsConformance, upsBypassPower=upsBypassPower, upsOutput=upsOutput, upsFullAlarmGroup=upsFullAlarmGroup, upsBypassLineIndex=upsBypassLineIndex, upsTestElapsedTime=upsTestElapsedTime, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsOutputEntry=upsOutputEntry, upsSubsetGroups=upsSubsetGroups, upsIdent=upsIdent, upsBypassNumLines=upsBypassNumLines, upsAlarmShutdownPending=upsAlarmShutdownPending, upsSubsetIdentGroup=upsSubsetIdentGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsConfigOutputVA=upsConfigOutputVA, upsSubsetCompliance=upsSubsetCompliance, upsMIB=upsMIB, upsOutputCurrent=upsOutputCurrent, upsSecondsOnBattery=upsSecondsOnBattery, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmChargerFailed=upsAlarmChargerFailed, upsInputNumLines=upsInputNumLines, upsIdentName=upsIdentName, upsConfigAudibleStatus=upsConfigAudibleStatus, upsWellKnownTests=upsWellKnownTests, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBasicConfigGroup=upsBasicConfigGroup, upsBatteryTemperature=upsBatteryTemperature, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmLowBattery=upsAlarmLowBattery, upsOutputVoltage=upsOutputVoltage, upsBypassFrequency=upsBypassFrequency, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTestResultsSummary=upsTestResultsSummary, upsConfigInputFreq=upsConfigInputFreq, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmsPresent=upsAlarmsPresent, upsAlarm=upsAlarm)
