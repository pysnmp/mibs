...
# Produced by pysmi-1.1.8 at Thu Sep  7 11:55:51 2023
...
ObjectIdentity, ModuleIdentity, Unsigned32, Counter64, Gauge32, iso, Integer32, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, mib_2, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Counter64", "Gauge32", "iso", "Integer32", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "mib-2", "Counter32", "Bits")
...
mibBuilder.exportSymbols("UPS-MIB", upsBypassCurrent=upsBypassCurrent, upsBasicBatteryGroup=upsBasicBatteryGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsOutputCurrent=upsOutputCurrent, upsSubsetGroups=upsSubsetGroups, upsMIB=upsMIB, upsAlarmId=upsAlarmId, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsFullGroups=upsFullGroups, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsFullOutputGroup=upsFullOutputGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsConfig=upsConfig, upsControl=upsControl, upsBypassTable=upsBypassTable, upsSecondsOnBattery=upsSecondsOnBattery, NonNegativeInteger=NonNegativeInteger, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmOnBattery=upsAlarmOnBattery, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsFullInputGroup=upsFullInputGroup, upsBypass=upsBypass, upsShutdownType=upsShutdownType, upsInputFrequency=upsInputFrequency, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsFullControlGroup=upsFullControlGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsInputTable=upsInputTable, upsOutputLineIndex=upsOutputLineIndex, upsTraps=upsTraps, upsIdentManufacturer=upsIdentManufacturer, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConformance=upsConformance, upsAlarmDescr=upsAlarmDescr, upsOutputSource=upsOutputSource, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsInputCurrent=upsInputCurrent, upsConfigOutputPower=upsConfigOutputPower, upsBypassEntry=upsBypassEntry, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsInputVoltage=upsInputVoltage, upsWellKnownAlarms=upsWellKnownAlarms, upsTestId=upsTestId, upsObjects=upsObjects, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConfigInputVoltage=upsConfigInputVoltage, upsBasicConfigGroup=upsBasicConfigGroup, upsBasicCompliance=upsBasicCompliance, upsFullIdentGroup=upsFullIdentGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTestSpinLock=upsTestSpinLock, upsAlarmInputBad=upsAlarmInputBad, upsFullBypassGroup=upsFullBypassGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsOutputFrequency=upsOutputFrequency, upsAlarmChargerFailed=upsAlarmChargerFailed, upsFullBatteryGroup=upsFullBatteryGroup, upsOutputTable=upsOutputTable, upsAlarmTime=upsAlarmTime, upsCompliances=upsCompliances, upsConfigOutputVA=upsConfigOutputVA, upsBasicControlGroup=upsBasicControlGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarm=upsAlarm, upsStartupAfterDelay=upsStartupAfterDelay, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsShutdownAfterDelay=upsShutdownAfterDelay, upsTrapTestCompleted=upsTrapTestCompleted, upsSubsetInputGroup=upsSubsetInputGroup, upsAutoRestart=upsAutoRestart, upsFullTestGroup=upsFullTestGroup, upsAlarmEntry=upsAlarmEntry, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsOutputPower=upsOutputPower, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullCompliance=upsFullCompliance, upsInput=upsInput, upsAlarmLowBattery=upsAlarmLowBattery, upsInputLineIndex=upsInputLineIndex, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBasicGroups=upsBasicGroups, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmsPresent=upsAlarmsPresent, upsBatteryVoltage=upsBatteryVoltage, upsBypassFrequency=upsBypassFrequency, upsOutputVoltage=upsOutputVoltage, upsInputNumLines=upsInputNumLines, upsBasicIdentGroup=upsBasicIdentGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsOutputNumLines=upsOutputNumLines, upsAlarmOutputOverload=upsAlarmOutputOverload, upsWellKnownTests=upsWellKnownTests, upsBasicOutputGroup=upsBasicOutputGroup, upsTest=upsTest, upsBypassNumLines=upsBypassNumLines, upsIdentModel=upsIdentModel, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsIdentName=upsIdentName, upsTrapOnBattery=upsTrapOnBattery, upsTestResultsSummary=upsTestResultsSummary, upsInputEntry=upsInputEntry, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBypassVoltage=upsBypassVoltage, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsIdent=upsIdent, upsBatteryTemperature=upsBatteryTemperature, upsTestElapsedTime=upsTestElapsedTime, upsOutputPercentLoad=upsOutputPercentLoad, upsTestStartTime=upsTestStartTime, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBasicAlarmGroup=upsBasicAlarmGroup, upsInputLineBads=upsInputLineBads, upsGroups=upsGroups, PositiveInteger=PositiveInteger, upsInputTruePower=upsInputTruePower, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsRebootWithDuration=upsRebootWithDuration, upsAlarmFuseFailure=upsAlarmFuseFailure, upsConfigInputFreq=upsConfigInputFreq, upsAlarmOutputBad=upsAlarmOutputBad, upsOutput=upsOutput, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsFullConfigGroup=upsFullConfigGroup, upsBypassLineIndex=upsBypassLineIndex, upsBatteryStatus=upsBatteryStatus, upsBypassPower=upsBypassPower, upsSubsetIdentGroup=upsSubsetIdentGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicInputGroup=upsBasicInputGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsBasicTestGroup=upsBasicTestGroup, PYSNMP_MODULE_ID=upsMIB, upsTestResultsDetail=upsTestResultsDetail, upsBattery=upsBattery, upsAlarmTable=upsAlarmTable, upsAlarmTempBad=upsAlarmTempBad, upsOutputEntry=upsOutputEntry, upsConfigLowBattTime=upsConfigLowBattTime, upsBatteryCurrent=upsBatteryCurrent, upsSubsetCompliance=upsSubsetCompliance)
