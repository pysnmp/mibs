...
TimeInterval, TimeStamp, TestAndIncr, AutonomousType, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeInterval", "TimeStamp", "TestAndIncr", "AutonomousType", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("UPS-MIB", upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsSubsetInputGroup=upsSubsetInputGroup, upsOutputNumLines=upsOutputNumLines, upsWellKnownTests=upsWellKnownTests, upsFullInputGroup=upsFullInputGroup, upsAlarmDescr=upsAlarmDescr, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsSubsetCompliance=upsSubsetCompliance, upsConfigOutputVoltage=upsConfigOutputVoltage, upsObjects=upsObjects, upsInputTable=upsInputTable, upsInputFrequency=upsInputFrequency, upsCompliances=upsCompliances, upsBatteryTemperature=upsBatteryTemperature, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmTestInProgress=upsAlarmTestInProgress, upsOutputPower=upsOutputPower, upsInputVoltage=upsInputVoltage, upsTrapTestCompleted=upsTrapTestCompleted, upsBasicBatteryGroup=upsBasicBatteryGroup, upsFullControlGroup=upsFullControlGroup, upsTraps=upsTraps, upsAlarmOutputBad=upsAlarmOutputBad, upsOutputVoltage=upsOutputVoltage, upsTestSpinLock=upsTestSpinLock, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsOutput=upsOutput, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsMIB=upsMIB, upsAlarmEntry=upsAlarmEntry, upsSubsetIdentGroup=upsSubsetIdentGroup, upsFullBypassGroup=upsFullBypassGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsTestResultsSummary=upsTestResultsSummary, upsAlarmId=upsAlarmId, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTest=upsTest, upsBasicTestGroup=upsBasicTestGroup, upsShutdownType=upsShutdownType, upsConfigInputFreq=upsConfigInputFreq, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBatteryVoltage=upsBatteryVoltage, upsBatteryStatus=upsBatteryStatus, upsAlarmTempBad=upsAlarmTempBad, upsAlarmFuseFailure=upsAlarmFuseFailure, upsInputTruePower=upsInputTruePower, upsIdentModel=upsIdentModel, upsBypassNumLines=upsBypassNumLines, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmOutputOverload=upsAlarmOutputOverload, upsOutputFrequency=upsOutputFrequency, upsConfigOutputPower=upsConfigOutputPower, upsAlarmBypassBad=upsAlarmBypassBad, upsBasicIdentGroup=upsBasicIdentGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsBypassTable=upsBypassTable, upsTestStartTime=upsTestStartTime, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBasicGroups=upsBasicGroups, upsAlarmShutdownPending=upsAlarmShutdownPending, upsTestElapsedTime=upsTestElapsedTime, upsBasicInputGroup=upsBasicInputGroup, upsRebootWithDuration=upsRebootWithDuration, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsIdentName=upsIdentName, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsInputCurrent=upsInputCurrent, upsBatteryCurrent=upsBatteryCurrent, upsOutputCurrent=upsOutputCurrent, upsOutputLineIndex=upsOutputLineIndex, upsSubsetControlGroup=upsSubsetControlGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBasicControlGroup=upsBasicControlGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsBasicAlarmGroup=upsBasicAlarmGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBypassEntry=upsBypassEntry, upsAlarmOnBattery=upsAlarmOnBattery, upsInputEntry=upsInputEntry, upsTrapOnBattery=upsTrapOnBattery, NonNegativeInteger=NonNegativeInteger, upsSubsetGroups=upsSubsetGroups, upsBypassVoltage=upsBypassVoltage, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConfig=upsConfig, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsInput=upsInput, upsControl=upsControl, upsConfigInputVoltage=upsConfigInputVoltage, upsGroups=upsGroups, upsBypassCurrent=upsBypassCurrent, upsFullGroups=upsFullGroups, upsTestId=upsTestId, upsFullConfigGroup=upsFullConfigGroup, upsOutputSource=upsOutputSource, upsFullBatteryGroup=upsFullBatteryGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsBasicConfigGroup=upsBasicConfigGroup, upsInputLineIndex=upsInputLineIndex, upsInputLineBads=upsInputLineBads, upsFullAlarmGroup=upsFullAlarmGroup, PYSNMP_MODULE_ID=upsMIB, PositiveInteger=PositiveInteger, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBasicOutputGroup=upsBasicOutputGroup, upsBypass=upsBypass, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsFullCompliance=upsFullCompliance, upsAlarmTime=upsAlarmTime, upsBattery=upsBattery, upsFullIdentGroup=upsFullIdentGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmBatteryBad=upsAlarmBatteryBad, upsFullTestGroup=upsFullTestGroup, upsOutputTable=upsOutputTable, upsFullOutputGroup=upsFullOutputGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsConfigOutputVA=upsConfigOutputVA, upsIdentManufacturer=upsIdentManufacturer, upsOutputEntry=upsOutputEntry, upsIdent=upsIdent, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsInputNumLines=upsInputNumLines, upsTestResultsDetail=upsTestResultsDetail, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAutoRestart=upsAutoRestart, upsAlarmInputBad=upsAlarmInputBad, upsBasicCompliance=upsBasicCompliance, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarm=upsAlarm, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBypassPower=upsBypassPower, upsConformance=upsConformance, upsBypassLineIndex=upsBypassLineIndex, upsBypassFrequency=upsBypassFrequency, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmTable=upsAlarmTable, upsAlarmsPresent=upsAlarmsPresent)
