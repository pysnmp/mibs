...
# Produced by pysmi-1.1.12 at Wed Jul  3 09:08:29 2024
...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, Integer32, Counter64, NotificationType, Unsigned32, Gauge32, ObjectIdentity, Bits, TimeTicks, MibIdentifier, mib_2, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "Integer32", "Counter64", "NotificationType", "Unsigned32", "Gauge32", "ObjectIdentity", "Bits", "TimeTicks", "MibIdentifier", "mib-2", "Counter32")
...
mibBuilder.exportSymbols("UPS-MIB", upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAutoRestart=upsAutoRestart, upsBasicBypassGroup=upsBasicBypassGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsGroups=upsGroups, upsInputLineBads=upsInputLineBads, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBatteryCurrent=upsBatteryCurrent, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmId=upsAlarmId, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsOutputNumLines=upsOutputNumLines, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBattery=upsBattery, upsAlarmChargerFailed=upsAlarmChargerFailed, upsInputTruePower=upsInputTruePower, upsBasicCompliance=upsBasicCompliance, upsOutputVoltage=upsOutputVoltage, upsIdentAttachedDevices=upsIdentAttachedDevices, upsOutput=upsOutput, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsTraps=upsTraps, upsAlarmFanFailure=upsAlarmFanFailure, upsWellKnownTests=upsWellKnownTests, upsConfigOutputVA=upsConfigOutputVA, upsSubsetOutputGroup=upsSubsetOutputGroup, upsInputLineIndex=upsInputLineIndex, upsBasicControlGroup=upsBasicControlGroup, upsMIB=upsMIB, upsOutputFrequency=upsOutputFrequency, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsWellKnownAlarms=upsWellKnownAlarms, upsTestElapsedTime=upsTestElapsedTime, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConfigAudibleStatus=upsConfigAudibleStatus, upsInputFrequency=upsInputFrequency, upsBasicBatteryGroup=upsBasicBatteryGroup, upsInputTable=upsInputTable, upsIdentName=upsIdentName, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBypassLineIndex=upsBypassLineIndex, upsConformance=upsConformance, upsAlarmInputBad=upsAlarmInputBad, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsOutputPower=upsOutputPower, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsCompliances=upsCompliances, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTrapOnBattery=upsTrapOnBattery, PYSNMP_MODULE_ID=upsMIB, PositiveInteger=PositiveInteger, upsInput=upsInput, upsBasicOutputGroup=upsBasicOutputGroup, upsFullCompliance=upsFullCompliance, upsAlarmDescr=upsAlarmDescr, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsShutdownAfterDelay=upsShutdownAfterDelay, upsShutdownType=upsShutdownType, upsIdentModel=upsIdentModel, upsSubsetControlGroup=upsSubsetControlGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, NonNegativeInteger=NonNegativeInteger, upsAlarmBypassBad=upsAlarmBypassBad, upsTestStartTime=upsTestStartTime, upsAlarmEntry=upsAlarmEntry, upsInputVoltage=upsInputVoltage, upsRebootWithDuration=upsRebootWithDuration, upsConfig=upsConfig, upsBypassTable=upsBypassTable, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTestId=upsTestId, upsBatteryTemperature=upsBatteryTemperature, upsAlarm=upsAlarm, upsTest=upsTest, upsInputEntry=upsInputEntry, upsInputCurrent=upsInputCurrent, upsBypass=upsBypass, upsSubsetInputGroup=upsSubsetInputGroup, upsTestSpinLock=upsTestSpinLock, upsTestResultsDetail=upsTestResultsDetail, upsInputNumLines=upsInputNumLines, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBypassEntry=upsBypassEntry, upsAlarmTable=upsAlarmTable, upsTestResultsSummary=upsTestResultsSummary, upsObjects=upsObjects, upsFullGroups=upsFullGroups, upsFullOutputGroup=upsFullOutputGroup, upsAlarmTempBad=upsAlarmTempBad, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicIdentGroup=upsBasicIdentGroup, upsOutputEntry=upsOutputEntry, upsSubsetGroups=upsSubsetGroups, upsOutputTable=upsOutputTable, upsBasicInputGroup=upsBasicInputGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmsPresent=upsAlarmsPresent, upsAlarmOnBattery=upsAlarmOnBattery, upsOutputLineIndex=upsOutputLineIndex, upsBypassNumLines=upsBypassNumLines, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBatteryStatus=upsBatteryStatus, upsFullAlarmGroup=upsFullAlarmGroup, upsControl=upsControl, upsFullTestGroup=upsFullTestGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsBatteryVoltage=upsBatteryVoltage, upsAlarmOutputBad=upsAlarmOutputBad, upsBypassFrequency=upsBypassFrequency, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBypassCurrent=upsBypassCurrent, upsOutputCurrent=upsOutputCurrent, upsFullIdentGroup=upsFullIdentGroup, upsFullInputGroup=upsFullInputGroup, upsIdent=upsIdent, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmTime=upsAlarmTime, upsBasicTestGroup=upsBasicTestGroup, upsBypassPower=upsBypassPower, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsSubsetCompliance=upsSubsetCompliance, upsFullControlGroup=upsFullControlGroup, upsFullConfigGroup=upsFullConfigGroup, upsConfigInputFreq=upsConfigInputFreq, upsAlarmLowBattery=upsAlarmLowBattery, upsOutputSource=upsOutputSource, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigOutputPower=upsConfigOutputPower, upsBypassVoltage=upsBypassVoltage, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsIdentManufacturer=upsIdentManufacturer, upsFullBypassGroup=upsFullBypassGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBasicGroups=upsBasicGroups)
