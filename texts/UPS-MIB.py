...
Gauge32, MibIdentifier, Counter64, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, ModuleIdentity, TimeTicks, Unsigned32, iso, IpAddress, Integer32, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "Counter64", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "Unsigned32", "iso", "IpAddress", "Integer32", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("UPS-MIB", upsBatteryCurrent=upsBatteryCurrent, upsBasicConfigGroup=upsBasicConfigGroup, upsOutputLineIndex=upsOutputLineIndex, upsWellKnownTests=upsWellKnownTests, upsBasicControlGroup=upsBasicControlGroup, upsFullInputGroup=upsFullInputGroup, upsInputNumLines=upsInputNumLines, upsTraps=upsTraps, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmId=upsAlarmId, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmOutputOverload=upsAlarmOutputOverload, upsSubsetControlGroup=upsSubsetControlGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBypassCurrent=upsBypassCurrent, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmTempBad=upsAlarmTempBad, upsFullCompliance=upsFullCompliance, upsFullControlGroup=upsFullControlGroup, upsBasicInputGroup=upsBasicInputGroup, upsOutputPower=upsOutputPower, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTestResultsDetail=upsTestResultsDetail, upsBasicBypassGroup=upsBasicBypassGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarm=upsAlarm, upsBatteryTemperature=upsBatteryTemperature, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsFullConfigGroup=upsFullConfigGroup, upsMIB=upsMIB, upsSubsetOutputGroup=upsSubsetOutputGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsTestElapsedTime=upsTestElapsedTime, upsInputLineIndex=upsInputLineIndex, upsInputVoltage=upsInputVoltage, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmTable=upsAlarmTable, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsOutputTable=upsOutputTable, upsConformance=upsConformance, upsAlarmTime=upsAlarmTime, upsGroups=upsGroups, upsIdent=upsIdent, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBasicCompliance=upsBasicCompliance, upsInputEntry=upsInputEntry, upsBasicGroups=upsBasicGroups, upsInputCurrent=upsInputCurrent, upsFullIdentGroup=upsFullIdentGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmInputBad=upsAlarmInputBad, upsBatteryStatus=upsBatteryStatus, upsAlarmsPresent=upsAlarmsPresent, upsTestStartTime=upsTestStartTime, upsTest=upsTest, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmChargerFailed=upsAlarmChargerFailed, upsOutputFrequency=upsOutputFrequency, upsAlarmDescr=upsAlarmDescr, upsConfigOutputFreq=upsConfigOutputFreq, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsObjects=upsObjects, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsInputLineBads=upsInputLineBads, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicTestGroup=upsBasicTestGroup, upsFullGroups=upsFullGroups, upsTestSpinLock=upsTestSpinLock, upsAutoRestart=upsAutoRestart, upsInputFrequency=upsInputFrequency, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsInputTruePower=upsInputTruePower, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsControl=upsControl, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBypass=upsBypass, upsBasicOutputGroup=upsBasicOutputGroup, upsInput=upsInput, upsSubsetCompliance=upsSubsetCompliance, upsBatteryVoltage=upsBatteryVoltage, upsOutputSource=upsOutputSource, upsCompliances=upsCompliances, upsAlarmLowBattery=upsAlarmLowBattery, upsIdentManufacturer=upsIdentManufacturer, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConfig=upsConfig, upsOutput=upsOutput, upsBypassTable=upsBypassTable, upsTrapOnBattery=upsTrapOnBattery, upsInputTable=upsInputTable, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBattery=upsBattery, PositiveInteger=PositiveInteger, upsOutputNumLines=upsOutputNumLines, upsAlarmOnBypass=upsAlarmOnBypass, upsConfigInputFreq=upsConfigInputFreq, upsFullBatteryGroup=upsFullBatteryGroup, upsFullOutputGroup=upsFullOutputGroup, upsConfigOutputVA=upsConfigOutputVA, upsBasicIdentGroup=upsBasicIdentGroup, upsOutputVoltage=upsOutputVoltage, upsBypassVoltage=upsBypassVoltage, upsIdentName=upsIdentName, upsAlarmGeneralFault=upsAlarmGeneralFault, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBypassLineIndex=upsBypassLineIndex, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTestResultsSummary=upsTestResultsSummary, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmEntry=upsAlarmEntry, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsFullBypassGroup=upsFullBypassGroup, upsIdentModel=upsIdentModel, upsAlarmBatteryBad=upsAlarmBatteryBad, NonNegativeInteger=NonNegativeInteger, upsOutputEntry=upsOutputEntry, PYSNMP_MODULE_ID=upsMIB, upsIdentAttachedDevices=upsIdentAttachedDevices, upsOutputCurrent=upsOutputCurrent, upsTestId=upsTestId, upsConfigInputVoltage=upsConfigInputVoltage, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmBypassBad=upsAlarmBypassBad, upsFullTestGroup=upsFullTestGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsRebootWithDuration=upsRebootWithDuration, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsConfigOutputPower=upsConfigOutputPower, upsBypassNumLines=upsBypassNumLines, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsSubsetGroups=upsSubsetGroups, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypassFrequency=upsBypassFrequency, upsBypassPower=upsBypassPower, upsShutdownType=upsShutdownType, upsBypassEntry=upsBypassEntry, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsTestQuickBatteryTest=upsTestQuickBatteryTest)
