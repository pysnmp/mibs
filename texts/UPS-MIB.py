...
mibBuilder.exportSymbols("UPS-MIB", upsInputTable=upsInputTable, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBypassPower=upsBypassPower, upsBatteryCurrent=upsBatteryCurrent, upsBypassEntry=upsBypassEntry, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTrapOnBattery=upsTrapOnBattery, upsOutputVoltage=upsOutputVoltage, upsAlarm=upsAlarm, upsOutput=upsOutput, upsAlarmDescr=upsAlarmDescr, upsAlarmTempBad=upsAlarmTempBad, upsRebootWithDuration=upsRebootWithDuration, upsBypassNumLines=upsBypassNumLines, upsOutputLineIndex=upsOutputLineIndex, upsBasicIdentGroup=upsBasicIdentGroup, upsInput=upsInput, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsWellKnownAlarms=upsWellKnownAlarms, upsBypassVoltage=upsBypassVoltage, upsBypassTable=upsBypassTable, upsAlarmId=upsAlarmId, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsFullGroups=upsFullGroups, upsOutputSource=upsOutputSource, upsInputCurrent=upsInputCurrent, upsIdentAttachedDevices=upsIdentAttachedDevices, upsFullIdentGroup=upsFullIdentGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmTable=upsAlarmTable, upsBasicOutputGroup=upsBasicOutputGroup, upsBasicInputGroup=upsBasicInputGroup, upsWellKnownTests=upsWellKnownTests, upsAutoRestart=upsAutoRestart, upsInputEntry=upsInputEntry, upsInputFrequency=upsInputFrequency, upsTestResultsDetail=upsTestResultsDetail, upsOutputCurrent=upsOutputCurrent, upsIdentModel=upsIdentModel, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsFullConfigGroup=upsFullConfigGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsTestResultsSummary=upsTestResultsSummary, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsConfigAudibleStatus=upsConfigAudibleStatus, upsObjects=upsObjects, upsFullCompliance=upsFullCompliance, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBasicTestGroup=upsBasicTestGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsInputLineBads=upsInputLineBads, upsSecondsOnBattery=upsSecondsOnBattery, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsMIB=upsMIB, PYSNMP_MODULE_ID=upsMIB, PositiveInteger=PositiveInteger, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsOutputTable=upsOutputTable, upsSubsetOutputGroup=upsSubsetOutputGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsIdentName=upsIdentName, upsBattery=upsBattery, NonNegativeInteger=NonNegativeInteger, upsInputVoltage=upsInputVoltage, upsSubsetInputGroup=upsSubsetInputGroup, upsInputLineIndex=upsInputLineIndex, upsTestElapsedTime=upsTestElapsedTime, upsTrapTestCompleted=upsTrapTestCompleted, upsBasicCompliance=upsBasicCompliance, upsAlarmBatteryBad=upsAlarmBatteryBad, upsConfigLowBattTime=upsConfigLowBattTime, upsBatteryTemperature=upsBatteryTemperature, upsTestSpinLock=upsTestSpinLock, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBypassLineIndex=upsBypassLineIndex, upsTestId=upsTestId, upsAlarmOnBypass=upsAlarmOnBypass, upsFullTestGroup=upsFullTestGroup, upsOutputPower=upsOutputPower, upsBypassCurrent=upsBypassCurrent, upsBasicBatteryGroup=upsBasicBatteryGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsConfigInputVoltage=upsConfigInputVoltage, upsInputTruePower=upsInputTruePower, upsConfig=upsConfig, upsAlarmEntry=upsAlarmEntry, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmInputBad=upsAlarmInputBad, upsIdent=upsIdent, upsConformance=upsConformance, upsCompliances=upsCompliances, upsConfigInputFreq=upsConfigInputFreq, upsTraps=upsTraps, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmShutdownPending=upsAlarmShutdownPending, upsTestStartTime=upsTestStartTime, upsFullInputGroup=upsFullInputGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsGroups=upsGroups, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsFullControlGroup=upsFullControlGroup, upsBypassFrequency=upsBypassFrequency, upsSubsetConfigGroup=upsSubsetConfigGroup, upsSubsetGroups=upsSubsetGroups, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmGeneralFault=upsAlarmGeneralFault, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsIdentManufacturer=upsIdentManufacturer, upsConfigOutputVoltage=upsConfigOutputVoltage, upsOutputFrequency=upsOutputFrequency, upsBatteryStatus=upsBatteryStatus, upsAlarmTime=upsAlarmTime, upsConfigOutputVA=upsConfigOutputVA, upsBatteryVoltage=upsBatteryVoltage, upsSubsetCompliance=upsSubsetCompliance, upsControl=upsControl, upsBasicControlGroup=upsBasicControlGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmsPresent=upsAlarmsPresent, upsOutputEntry=upsOutputEntry, upsStartupAfterDelay=upsStartupAfterDelay, upsShutdownType=upsShutdownType, upsFullAlarmGroup=upsFullAlarmGroup, upsInputNumLines=upsInputNumLines, upsAlarmBypassBad=upsAlarmBypassBad, upsOutputNumLines=upsOutputNumLines, upsFullOutputGroup=upsFullOutputGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsTest=upsTest, upsAlarmLowBattery=upsAlarmLowBattery, upsFullBypassGroup=upsFullBypassGroup, upsBasicGroups=upsBasicGroups, upsConfigOutputPower=upsConfigOutputPower, upsBypass=upsBypass)
