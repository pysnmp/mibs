...
NotificationType, IpAddress, iso, Counter32, Gauge32, ObjectIdentity, mib_2, Unsigned32, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "iso", "Counter32", "Gauge32", "ObjectIdentity", "mib-2", "Unsigned32", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "Bits", "Counter64")
...
mibBuilder.exportSymbols("UPS-MIB", upsInputLineIndex=upsInputLineIndex, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestResultsSummary=upsTestResultsSummary, upsConfigInputFreq=upsConfigInputFreq, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmBatteryBad=upsAlarmBatteryBad, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmEntry=upsAlarmEntry, upsSubsetControlGroup=upsSubsetControlGroup, upsIdentName=upsIdentName, upsInputCurrent=upsInputCurrent, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBypass=upsBypass, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicInputGroup=upsBasicInputGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, PositiveInteger=PositiveInteger, upsControl=upsControl, upsBypassEntry=upsBypassEntry, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsFullAlarmGroup=upsFullAlarmGroup, upsTestSpinLock=upsTestSpinLock, upsBasicIdentGroup=upsBasicIdentGroup, upsTestElapsedTime=upsTestElapsedTime, upsBasicAlarmGroup=upsBasicAlarmGroup, upsOutputEntry=upsOutputEntry, NonNegativeInteger=NonNegativeInteger, upsInputFrequency=upsInputFrequency, upsAlarmOutputOverload=upsAlarmOutputOverload, upsOutputFrequency=upsOutputFrequency, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsOutput=upsOutput, upsOutputPercentLoad=upsOutputPercentLoad, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsFullConfigGroup=upsFullConfigGroup, upsBypassVoltage=upsBypassVoltage, upsBatteryTemperature=upsBatteryTemperature, upsFullTestGroup=upsFullTestGroup, upsAlarmInputBad=upsAlarmInputBad, upsTest=upsTest, upsRebootWithDuration=upsRebootWithDuration, upsAlarm=upsAlarm, upsTraps=upsTraps, upsSubsetOutputGroup=upsSubsetOutputGroup, upsOutputCurrent=upsOutputCurrent, upsShutdownType=upsShutdownType, upsFullBypassGroup=upsFullBypassGroup, upsBypassCurrent=upsBypassCurrent, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsStartupAfterDelay=upsStartupAfterDelay, upsBattery=upsBattery, upsAlarmTempBad=upsAlarmTempBad, upsBasicConfigGroup=upsBasicConfigGroup, upsFullInputGroup=upsFullInputGroup, upsInputEntry=upsInputEntry, upsInputVoltage=upsInputVoltage, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmOutputBad=upsAlarmOutputBad, upsConfigLowBattTime=upsConfigLowBattTime, upsOutputVoltage=upsOutputVoltage, upsMIB=upsMIB, upsConfigOutputFreq=upsConfigOutputFreq, upsBasicControlGroup=upsBasicControlGroup, upsOutputNumLines=upsOutputNumLines, upsBypassLineIndex=upsBypassLineIndex, upsAlarmsPresent=upsAlarmsPresent, upsBasicCompliance=upsBasicCompliance, upsTestId=upsTestId, upsBypassNumLines=upsBypassNumLines, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBasicBypassGroup=upsBasicBypassGroup, upsInputNumLines=upsInputNumLines, upsOutputPower=upsOutputPower, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmTime=upsAlarmTime, upsInput=upsInput, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBasicTestGroup=upsBasicTestGroup, upsIdentModel=upsIdentModel, upsWellKnownAlarms=upsWellKnownAlarms, upsInputLineBads=upsInputLineBads, upsSubsetGroups=upsSubsetGroups, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsWellKnownTests=upsWellKnownTests, upsInputTruePower=upsInputTruePower, upsCompliances=upsCompliances, upsFullGroups=upsFullGroups, upsAlarmId=upsAlarmId, upsAlarmDescr=upsAlarmDescr, upsBatteryVoltage=upsBatteryVoltage, upsAlarmBypassBad=upsAlarmBypassBad, upsTestStartTime=upsTestStartTime, upsAlarmFanFailure=upsAlarmFanFailure, PYSNMP_MODULE_ID=upsMIB, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsConfigOutputPower=upsConfigOutputPower, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsInputTable=upsInputTable, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestResultsDetail=upsTestResultsDetail, upsConfigOutputVA=upsConfigOutputVA, upsFullControlGroup=upsFullControlGroup, upsAlarmTable=upsAlarmTable, upsTrapOnBattery=upsTrapOnBattery, upsAlarmLowBattery=upsAlarmLowBattery, upsFullIdentGroup=upsFullIdentGroup, upsBatteryCurrent=upsBatteryCurrent, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsConfigInputVoltage=upsConfigInputVoltage, upsFullBatteryGroup=upsFullBatteryGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsOutputLineIndex=upsOutputLineIndex, upsBypassFrequency=upsBypassFrequency, upsFullCompliance=upsFullCompliance, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAutoRestart=upsAutoRestart, upsConfig=upsConfig, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsObjects=upsObjects, upsConfigOutputVoltage=upsConfigOutputVoltage, upsIdentManufacturer=upsIdentManufacturer, upsShutdownAfterDelay=upsShutdownAfterDelay, upsSubsetIdentGroup=upsSubsetIdentGroup, upsGroups=upsGroups, upsIdentAttachedDevices=upsIdentAttachedDevices, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsSubsetCompliance=upsSubsetCompliance, upsOutputTable=upsOutputTable, upsBatteryStatus=upsBatteryStatus, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsIdent=upsIdent, upsOutputSource=upsOutputSource, upsBypassPower=upsBypassPower, upsConformance=upsConformance, upsBypassTable=upsBypassTable, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsFullOutputGroup=upsFullOutputGroup, upsBasicGroups=upsBasicGroups)
