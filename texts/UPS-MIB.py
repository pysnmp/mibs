...
# ASN.1 source UPS-MIB
# Source digest sha256:8b272e970d89d2c60251dc51207b74265e17fe8ec00b590e4689ed9b58c76e28
...
if mibBuilder.loadTexts: upsMIB.setLastUpdated('1994-02-23 00:00')
...
upsInputTable = MibTable((1, 3, 6, 1, 2, 1, 33, 1, 3, 3), ).setMaxAccess("notaccessible")
...
upsInputEntry = MibTableRow((1, 3, 6, 1, 2, 1, 33, 1, 3, 3, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "UPS-MIB", "upsInputLineIndex"))
...
upsInputLineIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 33, 1, 3, 3, 1, 1), PositiveInteger()).setMaxAccess("notaccessible")
...
upsOutputTable = MibTable((1, 3, 6, 1, 2, 1, 33, 1, 4, 4), ).setMaxAccess("notaccessible")
...
upsOutputEntry = MibTableRow((1, 3, 6, 1, 2, 1, 33, 1, 4, 4, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "UPS-MIB", "upsOutputLineIndex"))
...
upsOutputLineIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 33, 1, 4, 4, 1, 1), PositiveInteger()).setMaxAccess("notaccessible")
...
upsBypassTable = MibTable((1, 3, 6, 1, 2, 1, 33, 1, 5, 3), ).setMaxAccess("notaccessible")
...
upsBypassEntry = MibTableRow((1, 3, 6, 1, 2, 1, 33, 1, 5, 3, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "UPS-MIB", "upsBypassLineIndex"))
...
upsBypassLineIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 33, 1, 5, 3, 1, 1), PositiveInteger()).setMaxAccess("notaccessible")
...
upsAlarmTable = MibTable((1, 3, 6, 1, 2, 1, 33, 1, 6, 2), ).setMaxAccess("notaccessible")
...
upsAlarmEntry = MibTableRow((1, 3, 6, 1, 2, 1, 33, 1, 6, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "UPS-MIB", "upsAlarmId"))
...
upsAlarmId = MibTableColumn((1, 3, 6, 1, 2, 1, 33, 1, 6, 2, 1, 1), PositiveInteger()).setMaxAccess("notaccessible")
...
upsBasicCompliance = ModuleCompliance((1, 3, 6, 1, 2, 1, 33, 3, 1, 2)).setObjects(("UPS-MIB", "upsBasicIdentGroup"), ("UPS-MIB", "upsBasicBatteryGroup"), ("UPS-MIB", "upsBasicInputGroup"), ("UPS-MIB", "upsBasicOutputGroup"), ("UPS-MIB", "upsBasicAlarmGroup"), ("UPS-MIB", "upsBasicTestGroup"), ("UPS-MIB", "upsBasicControlGroup"), ("UPS-MIB", "upsBasicConfigGroup"), ("UPS-MIB", "upsBasicBypassGroup"))
...
upsFullCompliance = ModuleCompliance((1, 3, 6, 1, 2, 1, 33, 3, 1, 3)).setObjects(("UPS-MIB", "upsFullIdentGroup"), ("UPS-MIB", "upsFullBatteryGroup"), ("UPS-MIB", "upsFullInputGroup"), ("UPS-MIB", "upsFullOutputGroup"), ("UPS-MIB", "upsFullAlarmGroup"), ("UPS-MIB", "upsFullTestGroup"), ("UPS-MIB", "upsFullControlGroup"), ("UPS-MIB", "upsFullConfigGroup"), ("UPS-MIB", "upsFullBypassGroup"))
...
mibBuilder.exportSymbols("UPS-MIB", NonNegativeInteger=NonNegativeInteger, PYSNMP_MODULE_ID=upsMIB, PositiveInteger=PositiveInteger, upsAlarm=upsAlarm, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmDescr=upsAlarmDescr, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmEntry=upsAlarmEntry, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmId=upsAlarmId, upsAlarmInputBad=upsAlarmInputBad, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmTable=upsAlarmTable, upsAlarmTempBad=upsAlarmTempBad, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmTime=upsAlarmTime, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmsPresent=upsAlarmsPresent, upsAutoRestart=upsAutoRestart, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsBasicCompliance=upsBasicCompliance, upsBasicConfigGroup=upsBasicConfigGroup, upsBasicControlGroup=upsBasicControlGroup, upsBasicGroups=upsBasicGroups, upsBasicIdentGroup=upsBasicIdentGroup, upsBasicInputGroup=upsBasicInputGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsBasicTestGroup=upsBasicTestGroup, upsBattery=upsBattery, upsBatteryCurrent=upsBatteryCurrent, upsBatteryStatus=upsBatteryStatus, upsBatteryTemperature=upsBatteryTemperature, upsBatteryVoltage=upsBatteryVoltage, upsBypass=upsBypass, upsBypassCurrent=upsBypassCurrent, upsBypassEntry=upsBypassEntry, upsBypassFrequency=upsBypassFrequency, upsBypassLineIndex=upsBypassLineIndex, upsBypassNumLines=upsBypassNumLines, upsBypassPower=upsBypassPower, upsBypassTable=upsBypassTable, upsBypassVoltage=upsBypassVoltage, upsCompliances=upsCompliances, upsConfig=upsConfig, upsConfigAudibleStatus=upsConfigAudibleStatus, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsConfigInputFreq=upsConfigInputFreq, upsConfigInputVoltage=upsConfigInputVoltage, upsConfigLowBattTime=upsConfigLowBattTime, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigOutputPower=upsConfigOutputPower, upsConfigOutputVA=upsConfigOutputVA, upsConfigOutputVoltage=upsConfigOutputVoltage, upsConformance=upsConformance, upsControl=upsControl, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsFullAlarmGroup=upsFullAlarmGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsFullBypassGroup=upsFullBypassGroup, upsFullCompliance=upsFullCompliance, upsFullConfigGroup=upsFullConfigGroup, upsFullControlGroup=upsFullControlGroup, upsFullGroups=upsFullGroups, upsFullIdentGroup=upsFullIdentGroup, upsFullInputGroup=upsFullInputGroup, upsFullOutputGroup=upsFullOutputGroup, upsFullTestGroup=upsFullTestGroup, upsGroups=upsGroups, upsIdent=upsIdent, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsIdentAttachedDevices=upsIdentAttachedDevices, upsIdentManufacturer=upsIdentManufacturer, upsIdentModel=upsIdentModel, upsIdentName=upsIdentName, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsInput=upsInput, upsInputCurrent=upsInputCurrent, upsInputEntry=upsInputEntry, upsInputFrequency=upsInputFrequency, upsInputLineBads=upsInputLineBads, upsInputLineIndex=upsInputLineIndex, upsInputNumLines=upsInputNumLines, upsInputTable=upsInputTable, upsInputTruePower=upsInputTruePower, upsInputVoltage=upsInputVoltage, upsMIB=upsMIB, upsObjects=upsObjects, upsOutput=upsOutput, upsOutputCurrent=upsOutputCurrent, upsOutputEntry=upsOutputEntry, upsOutputFrequency=upsOutputFrequency, upsOutputLineIndex=upsOutputLineIndex, upsOutputNumLines=upsOutputNumLines, upsOutputPercentLoad=upsOutputPercentLoad, upsOutputPower=upsOutputPower, upsOutputSource=upsOutputSource, upsOutputTable=upsOutputTable, upsOutputVoltage=upsOutputVoltage, upsRebootWithDuration=upsRebootWithDuration, upsSecondsOnBattery=upsSecondsOnBattery, upsShutdownAfterDelay=upsShutdownAfterDelay, upsShutdownType=upsShutdownType, upsStartupAfterDelay=upsStartupAfterDelay, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsSubsetCompliance=upsSubsetCompliance, upsSubsetConfigGroup=upsSubsetConfigGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsSubsetGroups=upsSubsetGroups, upsSubsetIdentGroup=upsSubsetIdentGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsTest=upsTest, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTestElapsedTime=upsTestElapsedTime, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTestId=upsTestId, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsTestResultsDetail=upsTestResultsDetail, upsTestResultsSummary=upsTestResultsSummary, upsTestSpinLock=upsTestSpinLock, upsTestStartTime=upsTestStartTime, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTrapOnBattery=upsTrapOnBattery, upsTrapTestCompleted=upsTrapTestCompleted, upsTraps=upsTraps, upsWellKnownAlarms=upsWellKnownAlarms, upsWellKnownTests=upsWellKnownTests)
