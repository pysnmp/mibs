...
Counter32, ModuleIdentity, iso, mib_2, Bits, Unsigned32, NotificationType, MibIdentifier, Counter64, Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "iso", "mib-2", "Bits", "Unsigned32", "NotificationType", "MibIdentifier", "Counter64", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "ObjectIdentity")
TimeInterval, TimeStamp, AutonomousType, TestAndIncr, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeInterval", "TimeStamp", "AutonomousType", "TestAndIncr", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("UPS-MIB", upsBasicInputGroup=upsBasicInputGroup, upsFullTestGroup=upsFullTestGroup, upsOutputCurrent=upsOutputCurrent, upsAlarmTempBad=upsAlarmTempBad, upsSubsetGroups=upsSubsetGroups, upsAlarmOnBattery=upsAlarmOnBattery, upsTestResultsDetail=upsTestResultsDetail, upsBattery=upsBattery, upsBypassEntry=upsBypassEntry, upsMIB=upsMIB, upsAlarmTime=upsAlarmTime, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTrapTestCompleted=upsTrapTestCompleted, upsInputCurrent=upsInputCurrent, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmTestInProgress=upsAlarmTestInProgress, upsIdentName=upsIdentName, upsConfigLowBattTime=upsConfigLowBattTime, upsTestId=upsTestId, upsFullControlGroup=upsFullControlGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTrapOnBattery=upsTrapOnBattery, upsInputTruePower=upsInputTruePower, NonNegativeInteger=NonNegativeInteger, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBatteryTemperature=upsBatteryTemperature, upsBatteryStatus=upsBatteryStatus, PositiveInteger=PositiveInteger, upsBasicControlGroup=upsBasicControlGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmInputBad=upsAlarmInputBad, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsSecondsOnBattery=upsSecondsOnBattery, upsBatteryCurrent=upsBatteryCurrent, upsInputLineIndex=upsInputLineIndex, upsTestStartTime=upsTestStartTime, upsConfigInputFreq=upsConfigInputFreq, upsBypassNumLines=upsBypassNumLines, upsBasicAlarmGroup=upsBasicAlarmGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsConfigOutputPower=upsConfigOutputPower, upsInput=upsInput, upsFullGroups=upsFullGroups, upsAlarmDescr=upsAlarmDescr, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsGroups=upsGroups, PYSNMP_MODULE_ID=upsMIB, upsFullAlarmGroup=upsFullAlarmGroup, upsOutputNumLines=upsOutputNumLines, upsShutdownType=upsShutdownType, upsConfigInputVoltage=upsConfigInputVoltage, upsConfigOutputFreq=upsConfigOutputFreq, upsBasicOutputGroup=upsBasicOutputGroup, upsFullBypassGroup=upsFullBypassGroup, upsConfigOutputVA=upsConfigOutputVA, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmFanFailure=upsAlarmFanFailure, upsShutdownAfterDelay=upsShutdownAfterDelay, upsObjects=upsObjects, upsBasicGroups=upsBasicGroups, upsIdent=upsIdent, upsBasicBypassGroup=upsBasicBypassGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTest=upsTest, upsOutputVoltage=upsOutputVoltage, upsIdentManufacturer=upsIdentManufacturer, upsBatteryVoltage=upsBatteryVoltage, upsInputNumLines=upsInputNumLines, upsOutputFrequency=upsOutputFrequency, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsConfig=upsConfig, upsOutputTable=upsOutputTable, upsCompliances=upsCompliances, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsStartupAfterDelay=upsStartupAfterDelay, upsBasicIdentGroup=upsBasicIdentGroup, upsInputTable=upsInputTable, upsIdentModel=upsIdentModel, upsBasicConfigGroup=upsBasicConfigGroup, upsInputEntry=upsInputEntry, upsWellKnownAlarms=upsWellKnownAlarms, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmFuseFailure=upsAlarmFuseFailure, upsConfigOutputVoltage=upsConfigOutputVoltage, upsFullCompliance=upsFullCompliance, upsAlarmShutdownPending=upsAlarmShutdownPending, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicTestGroup=upsBasicTestGroup, upsTestSpinLock=upsTestSpinLock, upsInputLineBads=upsInputLineBads, upsAlarm=upsAlarm, upsSubsetIdentGroup=upsSubsetIdentGroup, upsFullInputGroup=upsFullInputGroup, upsTestResultsSummary=upsTestResultsSummary, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAutoRestart=upsAutoRestart, upsFullIdentGroup=upsFullIdentGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBypassPower=upsBypassPower, upsInputFrequency=upsInputFrequency, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBypassTable=upsBypassTable, upsAlarmTable=upsAlarmTable, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmOnBypass=upsAlarmOnBypass, upsTestElapsedTime=upsTestElapsedTime, upsAlarmBypassBad=upsAlarmBypassBad, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBypass=upsBypass, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsOutputPercentLoad=upsOutputPercentLoad, upsSubsetCompliance=upsSubsetCompliance, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsInputVoltage=upsInputVoltage, upsBypassFrequency=upsBypassFrequency, upsAlarmEntry=upsAlarmEntry, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsControl=upsControl, upsFullOutputGroup=upsFullOutputGroup, upsOutput=upsOutput, upsBasicCompliance=upsBasicCompliance, upsBypassLineIndex=upsBypassLineIndex, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsOutputLineIndex=upsOutputLineIndex, upsOutputPower=upsOutputPower, upsAlarmId=upsAlarmId, upsWellKnownTests=upsWellKnownTests, upsTraps=upsTraps, upsRebootWithDuration=upsRebootWithDuration, upsOutputEntry=upsOutputEntry, upsBypassCurrent=upsBypassCurrent, upsSubsetControlGroup=upsSubsetControlGroup, upsConformance=upsConformance, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsFullConfigGroup=upsFullConfigGroup, upsBypassVoltage=upsBypassVoltage, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmsPresent=upsAlarmsPresent, upsOutputSource=upsOutputSource)
