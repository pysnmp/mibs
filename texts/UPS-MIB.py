...
mibBuilder.exportSymbols("UPS-MIB", upsOutputLineIndex=upsOutputLineIndex, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBasicIdentGroup=upsBasicIdentGroup, upsIdentName=upsIdentName, upsAlarmFanFailure=upsAlarmFanFailure, upsIdentModel=upsIdentModel, upsAlarmsPresent=upsAlarmsPresent, upsBatteryVoltage=upsBatteryVoltage, upsSubsetInputGroup=upsSubsetInputGroup, upsInputLineIndex=upsInputLineIndex, upsTestResultsDetail=upsTestResultsDetail, upsSubsetCompliance=upsSubsetCompliance, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsTestStartTime=upsTestStartTime, upsTraps=upsTraps, upsConfigOutputVA=upsConfigOutputVA, upsFullInputGroup=upsFullInputGroup, upsAlarmInputBad=upsAlarmInputBad, PYSNMP_MODULE_ID=upsMIB, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBypassCurrent=upsBypassCurrent, upsInputVoltage=upsInputVoltage, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsCompliances=upsCompliances, upsConfigInputVoltage=upsConfigInputVoltage, upsBasicTestGroup=upsBasicTestGroup, upsAlarmTable=upsAlarmTable, upsOutputPower=upsOutputPower, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmId=upsAlarmId, upsBatteryStatus=upsBatteryStatus, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBasicGroups=upsBasicGroups, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmBatteryBad=upsAlarmBatteryBad, upsConformance=upsConformance, upsInputLineBads=upsInputLineBads, upsBypassPower=upsBypassPower, upsTrapOnBattery=upsTrapOnBattery, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConfig=upsConfig, upsStartupAfterDelay=upsStartupAfterDelay, upsInputTruePower=upsInputTruePower, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsOutputVoltage=upsOutputVoltage, upsAlarmShutdownPending=upsAlarmShutdownPending, upsShutdownType=upsShutdownType, upsConfigInputFreq=upsConfigInputFreq, upsBasicAlarmGroup=upsBasicAlarmGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmTempBad=upsAlarmTempBad, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutputSource=upsOutputSource, upsObjects=upsObjects, upsInputCurrent=upsInputCurrent, upsAlarmGeneralFault=upsAlarmGeneralFault, upsOutputNumLines=upsOutputNumLines, upsBasicCompliance=upsBasicCompliance, upsInputTable=upsInputTable, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsFullIdentGroup=upsFullIdentGroup, upsOutputTable=upsOutputTable, upsAlarm=upsAlarm, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsFullAlarmGroup=upsFullAlarmGroup, upsFullCompliance=upsFullCompliance, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsIdent=upsIdent, upsTestResultsSummary=upsTestResultsSummary, upsConfigOutputFreq=upsConfigOutputFreq, upsAutoRestart=upsAutoRestart, upsSubsetConfigGroup=upsSubsetConfigGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsFullConfigGroup=upsFullConfigGroup, upsRebootWithDuration=upsRebootWithDuration, upsBasicOutputGroup=upsBasicOutputGroup, upsBypassEntry=upsBypassEntry, upsBypassVoltage=upsBypassVoltage, upsFullBatteryGroup=upsFullBatteryGroup, upsInputEntry=upsInputEntry, upsFullBypassGroup=upsFullBypassGroup, upsBatteryTemperature=upsBatteryTemperature, upsBypassLineIndex=upsBypassLineIndex, PositiveInteger=PositiveInteger, upsWellKnownTests=upsWellKnownTests, upsAlarmOutputOverload=upsAlarmOutputOverload, upsSubsetIdentGroup=upsSubsetIdentGroup, upsInputFrequency=upsInputFrequency, upsOutputFrequency=upsOutputFrequency, upsFullOutputGroup=upsFullOutputGroup, upsAlarmEntry=upsAlarmEntry, upsTrapTestCompleted=upsTrapTestCompleted, upsFullControlGroup=upsFullControlGroup, upsBattery=upsBattery, upsSubsetGroups=upsSubsetGroups, upsBasicInputGroup=upsBasicInputGroup, upsAlarmDescr=upsAlarmDescr, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsInput=upsInput, upsBypassTable=upsBypassTable, upsBatteryCurrent=upsBatteryCurrent, upsAlarmOutputBad=upsAlarmOutputBad, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmLowBattery=upsAlarmLowBattery, upsControl=upsControl, NonNegativeInteger=NonNegativeInteger, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsMIB=upsMIB, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBypassFrequency=upsBypassFrequency, upsConfigOutputVoltage=upsConfigOutputVoltage, upsOutputEntry=upsOutputEntry, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestSpinLock=upsTestSpinLock, upsAlarmBypassBad=upsAlarmBypassBad, upsConfigOutputPower=upsConfigOutputPower, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmTime=upsAlarmTime, upsSecondsOnBattery=upsSecondsOnBattery, upsBypass=upsBypass, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTest=upsTest, upsFullTestGroup=upsFullTestGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmOnBypass=upsAlarmOnBypass, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsConfigLowBattTime=upsConfigLowBattTime, upsIdentManufacturer=upsIdentManufacturer, upsFullGroups=upsFullGroups, upsInputNumLines=upsInputNumLines, upsBasicControlGroup=upsBasicControlGroup, upsTestElapsedTime=upsTestElapsedTime, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBypassNumLines=upsBypassNumLines, upsGroups=upsGroups, upsOutputCurrent=upsOutputCurrent, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsOutput=upsOutput, upsTestId=upsTestId, upsShutdownAfterDelay=upsShutdownAfterDelay)
