...
mibBuilder.exportSymbols("UPS-MIB", upsOutputCurrent=upsOutputCurrent, upsInputLineIndex=upsInputLineIndex, upsAlarmOnBattery=upsAlarmOnBattery, upsTestResultsSummary=upsTestResultsSummary, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBasicConfigGroup=upsBasicConfigGroup, upsTest=upsTest, upsTestId=upsTestId, upsConfigOutputVA=upsConfigOutputVA, upsCompliances=upsCompliances, upsBasicGroups=upsBasicGroups, upsBatteryVoltage=upsBatteryVoltage, upsInputEntry=upsInputEntry, upsControl=upsControl, upsFullBatteryGroup=upsFullBatteryGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsFullGroups=upsFullGroups, upsSubsetControlGroup=upsSubsetControlGroup, upsInputLineBads=upsInputLineBads, upsConformance=upsConformance, upsBasicControlGroup=upsBasicControlGroup, upsBypassEntry=upsBypassEntry, upsBasicAlarmGroup=upsBasicAlarmGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsOutputTable=upsOutputTable, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmId=upsAlarmId, upsSubsetGroups=upsSubsetGroups, upsBasicBypassGroup=upsBasicBypassGroup, upsInputFrequency=upsInputFrequency, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBypassVoltage=upsBypassVoltage, upsFullIdentGroup=upsFullIdentGroup, upsAlarmInputBad=upsAlarmInputBad, upsObjects=upsObjects, upsBasicTestGroup=upsBasicTestGroup, upsTestStartTime=upsTestStartTime, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsRebootWithDuration=upsRebootWithDuration, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypass=upsBypass, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmFanFailure=upsAlarmFanFailure, upsBasicIdentGroup=upsBasicIdentGroup, upsTrapOnBattery=upsTrapOnBattery, upsBattery=upsBattery, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmTable=upsAlarmTable, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsInputVoltage=upsInputVoltage, upsAlarmOnBypass=upsAlarmOnBypass, upsBatteryTemperature=upsBatteryTemperature, upsSubsetInputGroup=upsSubsetInputGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsOutputLineIndex=upsOutputLineIndex, upsShutdownType=upsShutdownType, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBypassNumLines=upsBypassNumLines, upsInput=upsInput, upsGroups=upsGroups, NonNegativeInteger=NonNegativeInteger, upsIdentManufacturer=upsIdentManufacturer, PYSNMP_MODULE_ID=upsMIB, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAutoRestart=upsAutoRestart, upsIdentModel=upsIdentModel, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsFullCompliance=upsFullCompliance, upsIdent=upsIdent, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTraps=upsTraps, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBypassPower=upsBypassPower, upsBypassLineIndex=upsBypassLineIndex, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmEntry=upsAlarmEntry, upsIdentName=upsIdentName, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsConfigInputFreq=upsConfigInputFreq, upsShutdownAfterDelay=upsShutdownAfterDelay, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBasicCompliance=upsBasicCompliance, upsSubsetOutputGroup=upsSubsetOutputGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmBypassBad=upsAlarmBypassBad, upsConfigOutputPower=upsConfigOutputPower, upsFullTestGroup=upsFullTestGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutput=upsOutput, upsInputTruePower=upsInputTruePower, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsTrapTestCompleted=upsTrapTestCompleted, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicOutputGroup=upsBasicOutputGroup, upsTestResultsDetail=upsTestResultsDetail, upsBasicInputGroup=upsBasicInputGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTestElapsedTime=upsTestElapsedTime, upsOutputEntry=upsOutputEntry, upsBasicBatteryGroup=upsBasicBatteryGroup, upsFullOutputGroup=upsFullOutputGroup, upsAlarmTime=upsAlarmTime, upsAlarmTempBad=upsAlarmTempBad, upsFullBypassGroup=upsFullBypassGroup, upsInputCurrent=upsInputCurrent, upsOutputPower=upsOutputPower, upsWellKnownTests=upsWellKnownTests, upsInputTable=upsInputTable, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, PositiveInteger=PositiveInteger, upsMIB=upsMIB, upsBatteryStatus=upsBatteryStatus, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBypassFrequency=upsBypassFrequency, upsBypassTable=upsBypassTable, upsOutputFrequency=upsOutputFrequency, upsConfigInputVoltage=upsConfigInputVoltage, upsStartupAfterDelay=upsStartupAfterDelay, upsFullConfigGroup=upsFullConfigGroup, upsFullInputGroup=upsFullInputGroup, upsOutputVoltage=upsOutputVoltage, upsAlarmDescr=upsAlarmDescr, upsAlarmLowBattery=upsAlarmLowBattery, upsBypassCurrent=upsBypassCurrent, upsAlarm=upsAlarm, upsOutputSource=upsOutputSource, upsFullAlarmGroup=upsFullAlarmGroup, upsOutputNumLines=upsOutputNumLines, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullControlGroup=upsFullControlGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmFuseFailure=upsAlarmFuseFailure, upsInputNumLines=upsInputNumLines, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBatteryCurrent=upsBatteryCurrent, upsAlarmsPresent=upsAlarmsPresent, upsTestSpinLock=upsTestSpinLock, upsAlarmOutputBad=upsAlarmOutputBad, upsSubsetCompliance=upsSubsetCompliance, upsConfig=upsConfig, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining)
