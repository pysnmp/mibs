...
# Produced by pysmi-1.1.12 at Mon Oct 28 02:06:47 2024
...
Gauge32, iso, ModuleIdentity, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, Counter32, Integer32, mib_2, Unsigned32, Bits, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "ModuleIdentity", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "Counter32", "Integer32", "mib-2", "Unsigned32", "Bits", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmGeneralFault=upsAlarmGeneralFault, upsBypassNumLines=upsBypassNumLines, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsWellKnownTests=upsWellKnownTests, upsStartupAfterDelay=upsStartupAfterDelay, PositiveInteger=PositiveInteger, upsAlarm=upsAlarm, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsInputLineIndex=upsInputLineIndex, upsBypassFrequency=upsBypassFrequency, upsConfigInputFreq=upsConfigInputFreq, upsAlarmDescr=upsAlarmDescr, upsMIB=upsMIB, upsBypassLineIndex=upsBypassLineIndex, upsTestSpinLock=upsTestSpinLock, upsBatteryCurrent=upsBatteryCurrent, upsOutputNumLines=upsOutputNumLines, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsOutputCurrent=upsOutputCurrent, upsSubsetControlGroup=upsSubsetControlGroup, upsInput=upsInput, upsBatteryVoltage=upsBatteryVoltage, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmOutputOverload=upsAlarmOutputOverload, upsRebootWithDuration=upsRebootWithDuration, upsBasicOutputGroup=upsBasicOutputGroup, upsBypass=upsBypass, upsOutputPower=upsOutputPower, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsConfigOutputPower=upsConfigOutputPower, upsConfigLowBattTime=upsConfigLowBattTime, upsOutputVoltage=upsOutputVoltage, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBasicTestGroup=upsBasicTestGroup, upsCompliances=upsCompliances, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBasicInputGroup=upsBasicInputGroup, upsAlarmEntry=upsAlarmEntry, upsTestResultsSummary=upsTestResultsSummary, upsIdent=upsIdent, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAutoRestart=upsAutoRestart, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmInputBad=upsAlarmInputBad, upsTrapTestCompleted=upsTrapTestCompleted, upsBypassEntry=upsBypassEntry, upsFullInputGroup=upsFullInputGroup, upsBasicControlGroup=upsBasicControlGroup, upsInputNumLines=upsInputNumLines, upsAlarmShutdownPending=upsAlarmShutdownPending, upsInputEntry=upsInputEntry, upsAlarmsPresent=upsAlarmsPresent, upsOutputLineIndex=upsOutputLineIndex, upsIdentModel=upsIdentModel, upsConfigOutputFreq=upsConfigOutputFreq, upsTestStartTime=upsTestStartTime, upsObjects=upsObjects, upsTestElapsedTime=upsTestElapsedTime, upsInputTable=upsInputTable, upsConfigOutputVA=upsConfigOutputVA, upsConfig=upsConfig, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBatteryStatus=upsBatteryStatus, upsAlarmOnBypass=upsAlarmOnBypass, upsBasicCompliance=upsBasicCompliance, upsInputTruePower=upsInputTruePower, upsBypassCurrent=upsBypassCurrent, upsBatteryTemperature=upsBatteryTemperature, upsOutputSource=upsOutputSource, upsTestResultsDetail=upsTestResultsDetail, upsInputVoltage=upsInputVoltage, upsAlarmOnBattery=upsAlarmOnBattery, upsBypassVoltage=upsBypassVoltage, upsOutput=upsOutput, upsConfigAudibleStatus=upsConfigAudibleStatus, PYSNMP_MODULE_ID=upsMIB, upsTrapOnBattery=upsTrapOnBattery, upsFullTestGroup=upsFullTestGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsTestId=upsTestId, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBypassTable=upsBypassTable, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsInputFrequency=upsInputFrequency, upsAlarmLowBattery=upsAlarmLowBattery, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmTable=upsAlarmTable, upsOutputPercentLoad=upsOutputPercentLoad, upsShutdownType=upsShutdownType, upsBasicConfigGroup=upsBasicConfigGroup, upsBasicBypassGroup=upsBasicBypassGroup, NonNegativeInteger=NonNegativeInteger, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsFullBypassGroup=upsFullBypassGroup, upsInputCurrent=upsInputCurrent, upsInputLineBads=upsInputLineBads, upsAlarmTime=upsAlarmTime, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmTempBad=upsAlarmTempBad, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsControl=upsControl, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBasicAlarmGroup=upsBasicAlarmGroup, upsFullConfigGroup=upsFullConfigGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsSubsetGroups=upsSubsetGroups, upsIdentName=upsIdentName, upsFullBatteryGroup=upsFullBatteryGroup, upsFullOutputGroup=upsFullOutputGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmId=upsAlarmId, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsGroups=upsGroups, upsConfigInputVoltage=upsConfigInputVoltage, upsOutputFrequency=upsOutputFrequency, upsBypassPower=upsBypassPower, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConfigOutputVoltage=upsConfigOutputVoltage, upsFullGroups=upsFullGroups, upsAlarmTestInProgress=upsAlarmTestInProgress, upsWellKnownAlarms=upsWellKnownAlarms, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsFullIdentGroup=upsFullIdentGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsTraps=upsTraps, upsBattery=upsBattery, upsTest=upsTest, upsBasicIdentGroup=upsBasicIdentGroup, upsFullCompliance=upsFullCompliance, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsOutputTable=upsOutputTable, upsSubsetInputGroup=upsSubsetInputGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutputEntry=upsOutputEntry, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsSecondsOnBattery=upsSecondsOnBattery, upsIdentManufacturer=upsIdentManufacturer, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBasicGroups=upsBasicGroups, upsConformance=upsConformance, upsFullControlGroup=upsFullControlGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsSubsetCompliance=upsSubsetCompliance)
