...
mibBuilder.exportSymbols("UPS-MIB", upsIdentModel=upsIdentModel, upsAlarmOutputBad=upsAlarmOutputBad, upsStartupAfterDelay=upsStartupAfterDelay, upsBatteryTemperature=upsBatteryTemperature, upsIdentManufacturer=upsIdentManufacturer, upsTraps=upsTraps, PositiveInteger=PositiveInteger, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBypassTable=upsBypassTable, upsOutputNumLines=upsOutputNumLines, upsFullTestGroup=upsFullTestGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, PYSNMP_MODULE_ID=upsMIB, upsAlarmShutdownPending=upsAlarmShutdownPending, upsGroups=upsGroups, upsBatteryStatus=upsBatteryStatus, upsInputLineBads=upsInputLineBads, upsMIB=upsMIB, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsWellKnownAlarms=upsWellKnownAlarms, upsAutoRestart=upsAutoRestart, upsConfigOutputVA=upsConfigOutputVA, upsConfigOutputPower=upsConfigOutputPower, upsBasicTestGroup=upsBasicTestGroup, upsCompliances=upsCompliances, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarm=upsAlarm, upsShutdownType=upsShutdownType, upsTestResultsDetail=upsTestResultsDetail, upsAlarmBatteryBad=upsAlarmBatteryBad, upsOutput=upsOutput, upsAlarmOnBattery=upsAlarmOnBattery, upsConfigOutputVoltage=upsConfigOutputVoltage, upsInputLineIndex=upsInputLineIndex, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsOutputPower=upsOutputPower, upsBypass=upsBypass, upsTestId=upsTestId, upsInputVoltage=upsInputVoltage, upsIdentName=upsIdentName, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBasicIdentGroup=upsBasicIdentGroup, upsTestSpinLock=upsTestSpinLock, upsSubsetConfigGroup=upsSubsetConfigGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsBasicCompliance=upsBasicCompliance, upsAlarmTempBad=upsAlarmTempBad, upsBatteryCurrent=upsBatteryCurrent, upsInputEntry=upsInputEntry, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsInputFrequency=upsInputFrequency, upsBypassCurrent=upsBypassCurrent, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBypassFrequency=upsBypassFrequency, upsAlarmsPresent=upsAlarmsPresent, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBasicGroups=upsBasicGroups, upsTestStartTime=upsTestStartTime, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBasicBypassGroup=upsBasicBypassGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsFullIdentGroup=upsFullIdentGroup, upsAlarmEntry=upsAlarmEntry, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsObjects=upsObjects, upsConfigInputFreq=upsConfigInputFreq, upsRebootWithDuration=upsRebootWithDuration, upsAlarmLowBattery=upsAlarmLowBattery, upsShutdownAfterDelay=upsShutdownAfterDelay, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmTime=upsAlarmTime, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmDescr=upsAlarmDescr, upsConfig=upsConfig, upsInputTable=upsInputTable, upsFullConfigGroup=upsFullConfigGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsFullControlGroup=upsFullControlGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsInputTruePower=upsInputTruePower, upsAlarmTable=upsAlarmTable, upsSubsetInputGroup=upsSubsetInputGroup, upsOutputVoltage=upsOutputVoltage, upsControl=upsControl, upsFullCompliance=upsFullCompliance, upsBypassPower=upsBypassPower, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsSubsetGroups=upsSubsetGroups, upsWellKnownTests=upsWellKnownTests, upsIdent=upsIdent, upsTrapOnBattery=upsTrapOnBattery, upsAlarmBypassBad=upsAlarmBypassBad, upsOutputFrequency=upsOutputFrequency, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBasicControlGroup=upsBasicControlGroup, upsAlarmInputBad=upsAlarmInputBad, upsOutputCurrent=upsOutputCurrent, upsOutputLineIndex=upsOutputLineIndex, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBypassLineIndex=upsBypassLineIndex, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsInputCurrent=upsInputCurrent, upsBasicInputGroup=upsBasicInputGroup, upsConformance=upsConformance, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTestResultsSummary=upsTestResultsSummary, upsTrapTestCompleted=upsTrapTestCompleted, upsFullAlarmGroup=upsFullAlarmGroup, upsTestElapsedTime=upsTestElapsedTime, upsBypassNumLines=upsBypassNumLines, upsBatteryVoltage=upsBatteryVoltage, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBypassEntry=upsBypassEntry, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmOutputOverload=upsAlarmOutputOverload, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsTest=upsTest, upsConfigInputVoltage=upsConfigInputVoltage, upsSubsetControlGroup=upsSubsetControlGroup, upsBypassVoltage=upsBypassVoltage, upsFullInputGroup=upsFullInputGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsFullBypassGroup=upsFullBypassGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsOutputEntry=upsOutputEntry, upsAlarmTestInProgress=upsAlarmTestInProgress, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsInputNumLines=upsInputNumLines, upsAlarmChargerFailed=upsAlarmChargerFailed, upsSubsetCompliance=upsSubsetCompliance, upsInput=upsInput, upsFullGroups=upsFullGroups, upsAlarmFanFailure=upsAlarmFanFailure, upsConfigLowBattTime=upsConfigLowBattTime, upsFullOutputGroup=upsFullOutputGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBasicOutputGroup=upsBasicOutputGroup, upsBattery=upsBattery, upsOutputTable=upsOutputTable, upsAlarmAwaitingPower=upsAlarmAwaitingPower, NonNegativeInteger=NonNegativeInteger, upsAlarmId=upsAlarmId, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmOnBypass=upsAlarmOnBypass, upsOutputSource=upsOutputSource, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff)
