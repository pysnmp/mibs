...
# Produced by pysmi-1.1.8 at Tue Sep 12 07:21:15 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Bits, MibIdentifier, Unsigned32, Counter64, TimeTicks, Gauge32, Counter32, ModuleIdentity, NotificationType, Integer32, IpAddress, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Bits", "MibIdentifier", "Unsigned32", "Counter64", "TimeTicks", "Gauge32", "Counter32", "ModuleIdentity", "NotificationType", "Integer32", "IpAddress", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("UPS-MIB", upsBatteryTemperature=upsBatteryTemperature, upsInputNumLines=upsInputNumLines, upsFullOutputGroup=upsFullOutputGroup, upsBypassCurrent=upsBypassCurrent, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBypassLineIndex=upsBypassLineIndex, upsBasicIdentGroup=upsBasicIdentGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBypassVoltage=upsBypassVoltage, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsFullBypassGroup=upsFullBypassGroup, upsOutput=upsOutput, upsFullBatteryGroup=upsFullBatteryGroup, upsTestElapsedTime=upsTestElapsedTime, upsGroups=upsGroups, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmOutputOverload=upsAlarmOutputOverload, upsConfigOutputFreq=upsConfigOutputFreq, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBatteryCurrent=upsBatteryCurrent, upsInputEntry=upsInputEntry, upsAlarmDescr=upsAlarmDescr, upsOutputCurrent=upsOutputCurrent, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmTable=upsAlarmTable, upsConfig=upsConfig, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsIdentAttachedDevices=upsIdentAttachedDevices, PositiveInteger=PositiveInteger, upsInput=upsInput, upsFullIdentGroup=upsFullIdentGroup, upsBypassPower=upsBypassPower, upsAutoRestart=upsAutoRestart, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmEntry=upsAlarmEntry, upsInputCurrent=upsInputCurrent, upsWellKnownTests=upsWellKnownTests, upsCompliances=upsCompliances, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsSubsetGroups=upsSubsetGroups, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTestResultsDetail=upsTestResultsDetail, upsTraps=upsTraps, upsBatteryStatus=upsBatteryStatus, upsInputLineBads=upsInputLineBads, upsAlarmTestInProgress=upsAlarmTestInProgress, upsOutputFrequency=upsOutputFrequency, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsFullControlGroup=upsFullControlGroup, upsBasicTestGroup=upsBasicTestGroup, upsAlarmId=upsAlarmId, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsOutputSource=upsOutputSource, upsIdent=upsIdent, NonNegativeInteger=NonNegativeInteger, upsConfigOutputVoltage=upsConfigOutputVoltage, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBasicInputGroup=upsBasicInputGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsOutputLineIndex=upsOutputLineIndex, upsAlarmTempBad=upsAlarmTempBad, upsSubsetInputGroup=upsSubsetInputGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestResultsSummary=upsTestResultsSummary, upsBattery=upsBattery, upsConfigLowBattTime=upsConfigLowBattTime, upsBasicGroups=upsBasicGroups, upsBypassNumLines=upsBypassNumLines, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmOnBypass=upsAlarmOnBypass, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsIdentName=upsIdentName, upsAlarmFanFailure=upsAlarmFanFailure, upsMIB=upsMIB, upsShutdownType=upsShutdownType, upsBypassFrequency=upsBypassFrequency, upsFullCompliance=upsFullCompliance, upsAlarmInputBad=upsAlarmInputBad, upsOutputTable=upsOutputTable, upsBypassTable=upsBypassTable, upsConfigOutputVA=upsConfigOutputVA, upsStartupAfterDelay=upsStartupAfterDelay, upsControl=upsControl, upsAlarm=upsAlarm, upsBasicControlGroup=upsBasicControlGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsInputVoltage=upsInputVoltage, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsTest=upsTest, upsTestId=upsTestId, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmGeneralFault=upsAlarmGeneralFault, PYSNMP_MODULE_ID=upsMIB, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTrapOnBattery=upsTrapOnBattery, upsBypass=upsBypass, upsIdentManufacturer=upsIdentManufacturer, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsIdentModel=upsIdentModel, upsFullConfigGroup=upsFullConfigGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsOutputPower=upsOutputPower, upsOutputEntry=upsOutputEntry, upsConfigOutputPower=upsConfigOutputPower, upsOutputNumLines=upsOutputNumLines, upsTestStartTime=upsTestStartTime, upsRebootWithDuration=upsRebootWithDuration, upsBatteryVoltage=upsBatteryVoltage, upsSubsetControlGroup=upsSubsetControlGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfigInputVoltage=upsConfigInputVoltage, upsOutputPercentLoad=upsOutputPercentLoad, upsFullAlarmGroup=upsFullAlarmGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsOutputVoltage=upsOutputVoltage, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsSubsetCompliance=upsSubsetCompliance, upsAlarmsPresent=upsAlarmsPresent, upsBypassEntry=upsBypassEntry, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConfigAudibleStatus=upsConfigAudibleStatus, upsInputTable=upsInputTable, upsObjects=upsObjects, upsInputFrequency=upsInputFrequency, upsBasicCompliance=upsBasicCompliance, upsFullTestGroup=upsFullTestGroup, upsFullInputGroup=upsFullInputGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTestSpinLock=upsTestSpinLock, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsConfigInputFreq=upsConfigInputFreq, upsInputLineIndex=upsInputLineIndex, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullGroups=upsFullGroups, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmTime=upsAlarmTime, upsConformance=upsConformance, upsInputTruePower=upsInputTruePower, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmBypassBad=upsAlarmBypassBad)
