...
mibBuilder.exportSymbols("UPS-MIB", upsBypassFrequency=upsBypassFrequency, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsFullBypassGroup=upsFullBypassGroup, upsInputTable=upsInputTable, upsBypassNumLines=upsBypassNumLines, PositiveInteger=PositiveInteger, upsRebootWithDuration=upsRebootWithDuration, upsWellKnownAlarms=upsWellKnownAlarms, upsSubsetInputGroup=upsSubsetInputGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBatteryTemperature=upsBatteryTemperature, upsTest=upsTest, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTestResultsSummary=upsTestResultsSummary, upsAlarmFanFailure=upsAlarmFanFailure, upsBattery=upsBattery, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsInputFrequency=upsInputFrequency, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsSubsetControlGroup=upsSubsetControlGroup, upsOutputNumLines=upsOutputNumLines, upsConfigLowBattTime=upsConfigLowBattTime, upsBasicInputGroup=upsBasicInputGroup, upsTraps=upsTraps, upsTestElapsedTime=upsTestElapsedTime, upsAlarmBypassBad=upsAlarmBypassBad, upsWellKnownTests=upsWellKnownTests, upsOutputLineIndex=upsOutputLineIndex, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsInputLineBads=upsInputLineBads, NonNegativeInteger=NonNegativeInteger, upsBypassTable=upsBypassTable, upsInputVoltage=upsInputVoltage, upsAlarm=upsAlarm, upsBypassCurrent=upsBypassCurrent, upsAlarmsPresent=upsAlarmsPresent, upsBasicBypassGroup=upsBasicBypassGroup, upsSubsetGroups=upsSubsetGroups, upsOutputFrequency=upsOutputFrequency, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmId=upsAlarmId, upsControl=upsControl, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBatteryVoltage=upsBatteryVoltage, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsMIB=upsMIB, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmDescr=upsAlarmDescr, upsConfigOutputPower=upsConfigOutputPower, upsSubsetConfigGroup=upsSubsetConfigGroup, upsInputEntry=upsInputEntry, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsSubsetOutputGroup=upsSubsetOutputGroup, upsGroups=upsGroups, PYSNMP_MODULE_ID=upsMIB, upsBasicAlarmGroup=upsBasicAlarmGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmOutputBad=upsAlarmOutputBad, upsBasicIdentGroup=upsBasicIdentGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmLowBattery=upsAlarmLowBattery, upsIdent=upsIdent, upsAlarmTime=upsAlarmTime, upsFullBatteryGroup=upsFullBatteryGroup, upsFullControlGroup=upsFullControlGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsConfigInputFreq=upsConfigInputFreq, upsOutputPercentLoad=upsOutputPercentLoad, upsIdentModel=upsIdentModel, upsSubsetCompliance=upsSubsetCompliance, upsAlarmBatteryBad=upsAlarmBatteryBad, upsFullAlarmGroup=upsFullAlarmGroup, upsInputLineIndex=upsInputLineIndex, upsFullIdentGroup=upsFullIdentGroup, upsIdentManufacturer=upsIdentManufacturer, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsTrapOnBattery=upsTrapOnBattery, upsConfigOutputVA=upsConfigOutputVA, upsTestSpinLock=upsTestSpinLock, upsObjects=upsObjects, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBasicControlGroup=upsBasicControlGroup, upsInput=upsInput, upsBypass=upsBypass, upsStartupAfterDelay=upsStartupAfterDelay, upsOutputCurrent=upsOutputCurrent, upsConfig=upsConfig, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmOutputOverload=upsAlarmOutputOverload, upsFullInputGroup=upsFullInputGroup, upsBasicCompliance=upsBasicCompliance, upsAlarmTable=upsAlarmTable, upsTestId=upsTestId, upsOutputVoltage=upsOutputVoltage, upsAlarmInputBad=upsAlarmInputBad, upsInputNumLines=upsInputNumLines, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmGeneralFault=upsAlarmGeneralFault, upsFullGroups=upsFullGroups, upsTestStartTime=upsTestStartTime, upsConformance=upsConformance, upsBasicTestGroup=upsBasicTestGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsSecondsOnBattery=upsSecondsOnBattery, upsBypassEntry=upsBypassEntry, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBypassVoltage=upsBypassVoltage, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAutoRestart=upsAutoRestart, upsBatteryCurrent=upsBatteryCurrent, upsOutputSource=upsOutputSource, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsOutputEntry=upsOutputEntry, upsBypassPower=upsBypassPower, upsFullOutputGroup=upsFullOutputGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsFullCompliance=upsFullCompliance, upsBasicConfigGroup=upsBasicConfigGroup, upsOutputPower=upsOutputPower, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTestResultsDetail=upsTestResultsDetail, upsIdentName=upsIdentName, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsShutdownType=upsShutdownType, upsCompliances=upsCompliances, upsOutput=upsOutput, upsInputTruePower=upsInputTruePower, upsFullConfigGroup=upsFullConfigGroup, upsAlarmEntry=upsAlarmEntry, upsBypassLineIndex=upsBypassLineIndex, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutputTable=upsOutputTable, upsInputCurrent=upsInputCurrent, upsFullTestGroup=upsFullTestGroup, upsAlarmTempBad=upsAlarmTempBad, upsBasicGroups=upsBasicGroups, upsAlarmOnBypass=upsAlarmOnBypass, upsBatteryStatus=upsBatteryStatus)
