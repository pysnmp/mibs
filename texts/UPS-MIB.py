...
# Produced by pysmi-1.1.12 at Thu Apr  4 10:08:36 2024
...
NotificationType, ObjectIdentity, mib_2, Gauge32, TimeTicks, Counter64, MibIdentifier, Integer32, Counter32, ModuleIdentity, IpAddress, Bits, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "mib-2", "Gauge32", "TimeTicks", "Counter64", "MibIdentifier", "Integer32", "Counter32", "ModuleIdentity", "IpAddress", "Bits", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("UPS-MIB", upsTestResultsSummary=upsTestResultsSummary, upsSubsetGroups=upsSubsetGroups, upsMIB=upsMIB, upsInputLineBads=upsInputLineBads, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmOutputOverload=upsAlarmOutputOverload, upsConfig=upsConfig, upsTrapTestCompleted=upsTrapTestCompleted, upsConfigInputFreq=upsConfigInputFreq, upsAlarmOnBypass=upsAlarmOnBypass, upsBypassNumLines=upsBypassNumLines, upsTestResultsDetail=upsTestResultsDetail, upsShutdownAfterDelay=upsShutdownAfterDelay, NonNegativeInteger=NonNegativeInteger, upsOutputPercentLoad=upsOutputPercentLoad, upsTraps=upsTraps, upsSubsetInputGroup=upsSubsetInputGroup, upsCompliances=upsCompliances, upsOutput=upsOutput, upsConfigOutputVoltage=upsConfigOutputVoltage, upsFullTestGroup=upsFullTestGroup, upsAlarmInputBad=upsAlarmInputBad, upsBatteryVoltage=upsBatteryVoltage, upsAlarmsPresent=upsAlarmsPresent, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsFullOutputGroup=upsFullOutputGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsSubsetOutputGroup=upsSubsetOutputGroup, PYSNMP_MODULE_ID=upsMIB, upsBypassPower=upsBypassPower, upsOutputLineIndex=upsOutputLineIndex, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsTestStartTime=upsTestStartTime, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmGeneralFault=upsAlarmGeneralFault, upsInputTruePower=upsInputTruePower, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsIdent=upsIdent, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBasicInputGroup=upsBasicInputGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsBatteryStatus=upsBatteryStatus, upsOutputNumLines=upsOutputNumLines, upsRebootWithDuration=upsRebootWithDuration, upsOutputCurrent=upsOutputCurrent, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmTable=upsAlarmTable, upsGroups=upsGroups, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarm=upsAlarm, upsSubsetControlGroup=upsSubsetControlGroup, upsBypassVoltage=upsBypassVoltage, upsBatteryCurrent=upsBatteryCurrent, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsShutdownType=upsShutdownType, upsFullInputGroup=upsFullInputGroup, upsIdentName=upsIdentName, upsBasicIdentGroup=upsBasicIdentGroup, upsControl=upsControl, upsBasicBypassGroup=upsBasicBypassGroup, upsFullIdentGroup=upsFullIdentGroup, upsFullBypassGroup=upsFullBypassGroup, upsBasicGroups=upsBasicGroups, upsSubsetCompliance=upsSubsetCompliance, upsInputFrequency=upsInputFrequency, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBypassEntry=upsBypassEntry, upsWellKnownTests=upsWellKnownTests, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsFullAlarmGroup=upsFullAlarmGroup, upsTrapOnBattery=upsTrapOnBattery, PositiveInteger=PositiveInteger, upsInput=upsInput, upsBatteryTemperature=upsBatteryTemperature, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBypassLineIndex=upsBypassLineIndex, upsSecondsOnBattery=upsSecondsOnBattery, upsIdentManufacturer=upsIdentManufacturer, upsOutputSource=upsOutputSource, upsInputVoltage=upsInputVoltage, upsFullConfigGroup=upsFullConfigGroup, upsBypassTable=upsBypassTable, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmEntry=upsAlarmEntry, upsAlarmFanFailure=upsAlarmFanFailure, upsInputLineIndex=upsInputLineIndex, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmId=upsAlarmId, upsBasicBatteryGroup=upsBasicBatteryGroup, upsInputNumLines=upsInputNumLines, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmTime=upsAlarmTime, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBypassFrequency=upsBypassFrequency, upsConfigOutputPower=upsConfigOutputPower, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmBypassBad=upsAlarmBypassBad, upsObjects=upsObjects, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutputEntry=upsOutputEntry, upsTestElapsedTime=upsTestElapsedTime, upsConformance=upsConformance, upsFullCompliance=upsFullCompliance, upsOutputPower=upsOutputPower, upsAlarmShutdownPending=upsAlarmShutdownPending, upsInputTable=upsInputTable, upsBasicCompliance=upsBasicCompliance, upsConfigOutputVA=upsConfigOutputVA, upsAlarmFuseFailure=upsAlarmFuseFailure, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullControlGroup=upsFullControlGroup, upsIdentModel=upsIdentModel, upsAlarmOutputBad=upsAlarmOutputBad, upsBasicOutputGroup=upsBasicOutputGroup, upsOutputVoltage=upsOutputVoltage, upsAutoRestart=upsAutoRestart, upsWellKnownAlarms=upsWellKnownAlarms, upsBasicControlGroup=upsBasicControlGroup, upsInputCurrent=upsInputCurrent, upsInputEntry=upsInputEntry, upsOutputTable=upsOutputTable, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmTempBad=upsAlarmTempBad, upsAlarmDescr=upsAlarmDescr, upsTestId=upsTestId, upsTestSpinLock=upsTestSpinLock, upsBasicTestGroup=upsBasicTestGroup, upsBypass=upsBypass, upsBattery=upsBattery, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsOutputFrequency=upsOutputFrequency, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmLowBattery=upsAlarmLowBattery, upsTest=upsTest, upsFullGroups=upsFullGroups, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBypassCurrent=upsBypassCurrent, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested)
