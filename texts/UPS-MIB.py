...
mibBuilder.exportSymbols("UPS-MIB", upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsRebootWithDuration=upsRebootWithDuration, upsBypassEntry=upsBypassEntry, upsTestElapsedTime=upsTestElapsedTime, upsIdentModel=upsIdentModel, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarm=upsAlarm, upsInputLineBads=upsInputLineBads, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsControl=upsControl, upsOutput=upsOutput, upsBatteryStatus=upsBatteryStatus, upsBasicGroups=upsBasicGroups, upsOutputSource=upsOutputSource, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsOutputLineIndex=upsOutputLineIndex, upsOutputCurrent=upsOutputCurrent, upsCompliances=upsCompliances, upsConfigAudibleStatus=upsConfigAudibleStatus, upsInputTable=upsInputTable, upsInputVoltage=upsInputVoltage, upsConfigOutputVA=upsConfigOutputVA, upsAlarmFanFailure=upsAlarmFanFailure, upsTestStartTime=upsTestStartTime, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBasicCompliance=upsBasicCompliance, upsBypassPower=upsBypassPower, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsOutputPower=upsOutputPower, upsOutputTable=upsOutputTable, upsBasicBatteryGroup=upsBasicBatteryGroup, upsFullBypassGroup=upsFullBypassGroup, upsIdentManufacturer=upsIdentManufacturer, upsInputEntry=upsInputEntry, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsBatteryCurrent=upsBatteryCurrent, upsAlarmOnBattery=upsAlarmOnBattery, upsOutputVoltage=upsOutputVoltage, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmDescr=upsAlarmDescr, upsConfigLowBattTime=upsConfigLowBattTime, upsTestId=upsTestId, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTestResultsDetail=upsTestResultsDetail, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsInput=upsInput, upsAlarmEntry=upsAlarmEntry, upsOutputEntry=upsOutputEntry, upsAlarmTime=upsAlarmTime, upsFullControlGroup=upsFullControlGroup, upsConfig=upsConfig, upsInputNumLines=upsInputNumLines, upsBasicOutputGroup=upsBasicOutputGroup, upsFullGroups=upsFullGroups, upsBypass=upsBypass, upsBasicControlGroup=upsBasicControlGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsSecondsOnBattery=upsSecondsOnBattery, upsShutdownAfterDelay=upsShutdownAfterDelay, upsStartupAfterDelay=upsStartupAfterDelay, upsGroups=upsGroups, upsBatteryTemperature=upsBatteryTemperature, upsInputLineIndex=upsInputLineIndex, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBasicConfigGroup=upsBasicConfigGroup, upsBasicTestGroup=upsBasicTestGroup, upsOutputNumLines=upsOutputNumLines, upsBatteryVoltage=upsBatteryVoltage, upsBypassLineIndex=upsBypassLineIndex, upsConfigInputFreq=upsConfigInputFreq, upsConfigOutputFreq=upsConfigOutputFreq, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsIdentAttachedDevices=upsIdentAttachedDevices, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsOutputFrequency=upsOutputFrequency, upsInputFrequency=upsInputFrequency, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsFullInputGroup=upsFullInputGroup, upsIdentName=upsIdentName, upsBasicInputGroup=upsBasicInputGroup, upsTest=upsTest, PYSNMP_MODULE_ID=upsMIB, upsInputCurrent=upsInputCurrent, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsTraps=upsTraps, upsOutputPercentLoad=upsOutputPercentLoad, upsTrapOnBattery=upsTrapOnBattery, upsFullBatteryGroup=upsFullBatteryGroup, upsFullIdentGroup=upsFullIdentGroup, upsSubsetGroups=upsSubsetGroups, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsSubsetCompliance=upsSubsetCompliance, upsAlarmsPresent=upsAlarmsPresent, upsFullTestGroup=upsFullTestGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmTempBad=upsAlarmTempBad, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmTestInProgress=upsAlarmTestInProgress, upsFullConfigGroup=upsFullConfigGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBypassNumLines=upsBypassNumLines, upsShutdownType=upsShutdownType, upsObjects=upsObjects, upsWellKnownAlarms=upsWellKnownAlarms, upsAutoRestart=upsAutoRestart, upsFullOutputGroup=upsFullOutputGroup, upsBypassTable=upsBypassTable, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsFullAlarmGroup=upsFullAlarmGroup, upsInputTruePower=upsInputTruePower, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConformance=upsConformance, upsAlarmTable=upsAlarmTable, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmId=upsAlarmId, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmBatteryBad=upsAlarmBatteryBad, upsSubsetInputGroup=upsSubsetInputGroup, PositiveInteger=PositiveInteger, upsAlarmOnBypass=upsAlarmOnBypass, upsIdent=upsIdent, upsTestResultsSummary=upsTestResultsSummary, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBypassVoltage=upsBypassVoltage, NonNegativeInteger=NonNegativeInteger, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullCompliance=upsFullCompliance, upsAlarmInputBad=upsAlarmInputBad, upsAlarmLowBattery=upsAlarmLowBattery, upsConfigOutputPower=upsConfigOutputPower, upsBypassFrequency=upsBypassFrequency, upsTrapTestCompleted=upsTrapTestCompleted, upsTestSpinLock=upsTestSpinLock, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsMIB=upsMIB, upsAlarmOutputBad=upsAlarmOutputBad, upsWellKnownTests=upsWellKnownTests, upsConfigOutputVoltage=upsConfigOutputVoltage, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBattery=upsBattery, upsBypassCurrent=upsBypassCurrent)
