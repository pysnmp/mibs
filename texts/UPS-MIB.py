...
mib_2, NotificationType, Bits, Unsigned32, iso, IpAddress, Gauge32, TimeTicks, Counter64, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "NotificationType", "Bits", "Unsigned32", "iso", "IpAddress", "Gauge32", "TimeTicks", "Counter64", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "Counter32")
...
mibBuilder.exportSymbols("UPS-MIB", upsInputEntry=upsInputEntry, upsInputTable=upsInputTable, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsOutputEntry=upsOutputEntry, upsBypassVoltage=upsBypassVoltage, upsFullConfigGroup=upsFullConfigGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsSubsetControlGroup=upsSubsetControlGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsBattery=upsBattery, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTestElapsedTime=upsTestElapsedTime, upsBasicOutputGroup=upsBasicOutputGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsConfigInputVoltage=upsConfigInputVoltage, upsConfigLowBattTime=upsConfigLowBattTime, upsTestSpinLock=upsTestSpinLock, upsSubsetConfigGroup=upsSubsetConfigGroup, upsOutputLineIndex=upsOutputLineIndex, upsAutoRestart=upsAutoRestart, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsInputCurrent=upsInputCurrent, upsShutdownType=upsShutdownType, upsFullBatteryGroup=upsFullBatteryGroup, upsOutputSource=upsOutputSource, upsAlarmFanFailure=upsAlarmFanFailure, upsOutputTable=upsOutputTable, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsInputLineBads=upsInputLineBads, upsBypassNumLines=upsBypassNumLines, upsSubsetIdentGroup=upsSubsetIdentGroup, NonNegativeInteger=NonNegativeInteger, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsFullCompliance=upsFullCompliance, upsAlarmId=upsAlarmId, upsAlarmChargerFailed=upsAlarmChargerFailed, PYSNMP_MODULE_ID=upsMIB, upsBasicTestGroup=upsBasicTestGroup, upsAlarm=upsAlarm, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, PositiveInteger=PositiveInteger, upsOutputVoltage=upsOutputVoltage, upsTrapOnBattery=upsTrapOnBattery, upsInputNumLines=upsInputNumLines, upsAlarmTempBad=upsAlarmTempBad, upsBasicControlGroup=upsBasicControlGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsSubsetCompliance=upsSubsetCompliance, upsBasicBatteryGroup=upsBasicBatteryGroup, upsIdentName=upsIdentName, upsBasicInputGroup=upsBasicInputGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsOutputNumLines=upsOutputNumLines, upsBypassPower=upsBypassPower, upsAlarmsPresent=upsAlarmsPresent, upsSubsetGroups=upsSubsetGroups, upsBasicConfigGroup=upsBasicConfigGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmInputBad=upsAlarmInputBad, upsWellKnownTests=upsWellKnownTests, upsIdentManufacturer=upsIdentManufacturer, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBasicCompliance=upsBasicCompliance, upsAlarmOutputBad=upsAlarmOutputBad, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmTime=upsAlarmTime, upsAlarmEntry=upsAlarmEntry, upsFullControlGroup=upsFullControlGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsInputFrequency=upsInputFrequency, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsFullInputGroup=upsFullInputGroup, upsConfigInputFreq=upsConfigInputFreq, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBypassLineIndex=upsBypassLineIndex, upsConfigOutputFreq=upsConfigOutputFreq, upsConfig=upsConfig, upsBatteryCurrent=upsBatteryCurrent, upsOutput=upsOutput, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmOnBattery=upsAlarmOnBattery, upsStartupAfterDelay=upsStartupAfterDelay, upsFullBypassGroup=upsFullBypassGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBypassFrequency=upsBypassFrequency, upsTraps=upsTraps, upsAlarmFuseFailure=upsAlarmFuseFailure, upsConformance=upsConformance, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTestResultsDetail=upsTestResultsDetail, upsConfigAudibleStatus=upsConfigAudibleStatus, upsOutputFrequency=upsOutputFrequency, upsFullOutputGroup=upsFullOutputGroup, upsFullIdentGroup=upsFullIdentGroup, upsBypassTable=upsBypassTable, upsObjects=upsObjects, upsInput=upsInput, upsInputTruePower=upsInputTruePower, upsOutputPercentLoad=upsOutputPercentLoad, upsBatteryStatus=upsBatteryStatus, upsBasicIdentGroup=upsBasicIdentGroup, upsMIB=upsMIB, upsAlarmLowBattery=upsAlarmLowBattery, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBasicGroups=upsBasicGroups, upsAlarmOnBypass=upsAlarmOnBypass, upsBasicBypassGroup=upsBasicBypassGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsInputLineIndex=upsInputLineIndex, upsWellKnownAlarms=upsWellKnownAlarms, upsFullGroups=upsFullGroups, upsTestId=upsTestId, upsAlarmOutputOverload=upsAlarmOutputOverload, upsSubsetInputGroup=upsSubsetInputGroup, upsBypassCurrent=upsBypassCurrent, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBatteryTemperature=upsBatteryTemperature, upsCompliances=upsCompliances, upsOutputCurrent=upsOutputCurrent, upsTestResultsSummary=upsTestResultsSummary, upsConfigOutputVA=upsConfigOutputVA, upsAlarmDescr=upsAlarmDescr, upsTestStartTime=upsTestStartTime, upsBypass=upsBypass, upsGroups=upsGroups, upsIdent=upsIdent, upsShutdownAfterDelay=upsShutdownAfterDelay, upsConfigOutputPower=upsConfigOutputPower, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsRebootWithDuration=upsRebootWithDuration, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsInputVoltage=upsInputVoltage, upsIdentModel=upsIdentModel, upsBatteryVoltage=upsBatteryVoltage, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBypassEntry=upsBypassEntry, upsTest=upsTest, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsOutputPower=upsOutputPower, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmTable=upsAlarmTable, upsFullTestGroup=upsFullTestGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsControl=upsControl)
