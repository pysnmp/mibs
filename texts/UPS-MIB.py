...
mibBuilder.exportSymbols("UPS-MIB", upsFullAlarmGroup=upsFullAlarmGroup, upsTestResultsDetail=upsTestResultsDetail, upsFullGroups=upsFullGroups, upsInput=upsInput, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTestId=upsTestId, upsConfigInputFreq=upsConfigInputFreq, upsGroups=upsGroups, upsBasicConfigGroup=upsBasicConfigGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutputVoltage=upsOutputVoltage, upsAlarmOnBypass=upsAlarmOnBypass, upsFullCompliance=upsFullCompliance, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmEntry=upsAlarmEntry, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBypassLineIndex=upsBypassLineIndex, upsTestResultsSummary=upsTestResultsSummary, upsFullConfigGroup=upsFullConfigGroup, upsOutputNumLines=upsOutputNumLines, upsTestElapsedTime=upsTestElapsedTime, upsBasicControlGroup=upsBasicControlGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsBatteryCurrent=upsBatteryCurrent, upsConfigOutputFreq=upsConfigOutputFreq, upsFullInputGroup=upsFullInputGroup, upsFullIdentGroup=upsFullIdentGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsBypassTable=upsBypassTable, NonNegativeInteger=NonNegativeInteger, upsWellKnownAlarms=upsWellKnownAlarms, upsBypass=upsBypass, upsOutputSource=upsOutputSource, upsSubsetInputGroup=upsSubsetInputGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsFullBypassGroup=upsFullBypassGroup, upsBatteryTemperature=upsBatteryTemperature, upsAlarmFanFailure=upsAlarmFanFailure, upsSubsetGroups=upsSubsetGroups, upsConfigOutputVoltage=upsConfigOutputVoltage, upsInputLineIndex=upsInputLineIndex, upsBasicGroups=upsBasicGroups, upsRebootWithDuration=upsRebootWithDuration, upsIdentManufacturer=upsIdentManufacturer, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmTime=upsAlarmTime, upsConfigOutputVA=upsConfigOutputVA, upsFullTestGroup=upsFullTestGroup, upsTest=upsTest, upsBypassVoltage=upsBypassVoltage, upsInputVoltage=upsInputVoltage, upsAlarmFuseFailure=upsAlarmFuseFailure, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsIdentName=upsIdentName, upsFullOutputGroup=upsFullOutputGroup, upsAlarmsPresent=upsAlarmsPresent, upsIdentAttachedDevices=upsIdentAttachedDevices, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutputLineIndex=upsOutputLineIndex, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsMIB=upsMIB, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTrapTestCompleted=upsTrapTestCompleted, upsInputTable=upsInputTable, upsAlarm=upsAlarm, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTraps=upsTraps, upsIdentModel=upsIdentModel, upsOutputCurrent=upsOutputCurrent, upsBatteryVoltage=upsBatteryVoltage, upsTestSpinLock=upsTestSpinLock, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsIdent=upsIdent, upsBatteryStatus=upsBatteryStatus, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmTable=upsAlarmTable, upsOutputPercentLoad=upsOutputPercentLoad, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBattery=upsBattery, upsInputTruePower=upsInputTruePower, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsOutput=upsOutput, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsConfigInputVoltage=upsConfigInputVoltage, upsAutoRestart=upsAutoRestart, upsInputLineBads=upsInputLineBads, upsAlarmOutputOverload=upsAlarmOutputOverload, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsSubsetCompliance=upsSubsetCompliance, upsAlarmBatteryBad=upsAlarmBatteryBad, upsSubsetControlGroup=upsSubsetControlGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsControl=upsControl, upsBasicCompliance=upsBasicCompliance, upsBypassCurrent=upsBypassCurrent, upsOutputPower=upsOutputPower, upsConformance=upsConformance, upsInputNumLines=upsInputNumLines, upsConfig=upsConfig, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmOnBattery=upsAlarmOnBattery, upsInputFrequency=upsInputFrequency, upsConfigOutputPower=upsConfigOutputPower, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBasicOutputGroup=upsBasicOutputGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmTempBad=upsAlarmTempBad, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBasicBypassGroup=upsBasicBypassGroup, upsOutputEntry=upsOutputEntry, upsAlarmId=upsAlarmId, upsBasicTestGroup=upsBasicTestGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTestStartTime=upsTestStartTime, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsSecondsOnBattery=upsSecondsOnBattery, upsBypassFrequency=upsBypassFrequency, upsOutputTable=upsOutputTable, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmBypassBad=upsAlarmBypassBad, upsInputCurrent=upsInputCurrent, upsBasicAlarmGroup=upsBasicAlarmGroup, upsFullControlGroup=upsFullControlGroup, upsAlarmDescr=upsAlarmDescr, upsObjects=upsObjects, upsWellKnownTests=upsWellKnownTests, upsTrapOnBattery=upsTrapOnBattery, PYSNMP_MODULE_ID=upsMIB, upsShutdownType=upsShutdownType, PositiveInteger=PositiveInteger, upsBypassPower=upsBypassPower, upsAlarmInputBad=upsAlarmInputBad, upsBasicInputGroup=upsBasicInputGroup, upsCompliances=upsCompliances, upsSubsetIdentGroup=upsSubsetIdentGroup, upsOutputFrequency=upsOutputFrequency, upsBypassEntry=upsBypassEntry, upsBypassNumLines=upsBypassNumLines, upsShutdownAfterDelay=upsShutdownAfterDelay, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsInputEntry=upsInputEntry)
