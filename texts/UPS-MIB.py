...
Integer32, TimeTicks, IpAddress, Unsigned32, Counter32, iso, MibIdentifier, mib_2, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "IpAddress", "Unsigned32", "Counter32", "iso", "MibIdentifier", "mib-2", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("UPS-MIB", upsInput=upsInput, upsConfigOutputVoltage=upsConfigOutputVoltage, upsTraps=upsTraps, upsWellKnownTests=upsWellKnownTests, upsInputTable=upsInputTable, upsConfigOutputVA=upsConfigOutputVA, upsBatteryCurrent=upsBatteryCurrent, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmsPresent=upsAlarmsPresent, upsAlarmLowBattery=upsAlarmLowBattery, upsInputLineBads=upsInputLineBads, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsFullIdentGroup=upsFullIdentGroup, upsBattery=upsBattery, upsBypassPower=upsBypassPower, upsAlarmBatteryBad=upsAlarmBatteryBad, upsFullOutputGroup=upsFullOutputGroup, PYSNMP_MODULE_ID=upsMIB, upsAlarmShutdownPending=upsAlarmShutdownPending, upsOutputLineIndex=upsOutputLineIndex, upsTestStartTime=upsTestStartTime, upsInputFrequency=upsInputFrequency, upsSubsetConfigGroup=upsSubsetConfigGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmBypassBad=upsAlarmBypassBad, upsBasicIdentGroup=upsBasicIdentGroup, PositiveInteger=PositiveInteger, upsTestElapsedTime=upsTestElapsedTime, upsSubsetCompliance=upsSubsetCompliance, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBasicBypassGroup=upsBasicBypassGroup, upsBypassEntry=upsBypassEntry, upsFullCompliance=upsFullCompliance, upsGroups=upsGroups, upsOutputSource=upsOutputSource, upsSecondsOnBattery=upsSecondsOnBattery, upsConfigInputFreq=upsConfigInputFreq, upsTrapTestCompleted=upsTrapTestCompleted, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsSubsetInputGroup=upsSubsetInputGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmInputBad=upsAlarmInputBad, upsTestResultsDetail=upsTestResultsDetail, upsAlarmOutputBad=upsAlarmOutputBad, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsIdentManufacturer=upsIdentManufacturer, upsConfigOutputPower=upsConfigOutputPower, upsAlarmId=upsAlarmId, upsAlarmOnBattery=upsAlarmOnBattery, upsBasicControlGroup=upsBasicControlGroup, upsIdentModel=upsIdentModel, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBypassVoltage=upsBypassVoltage, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsIdent=upsIdent, upsConfigInputVoltage=upsConfigInputVoltage, upsTrapOnBattery=upsTrapOnBattery, upsInputNumLines=upsInputNumLines, upsConfig=upsConfig, upsBasicTestGroup=upsBasicTestGroup, upsBatteryStatus=upsBatteryStatus, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBypassFrequency=upsBypassFrequency, upsTest=upsTest, upsFullAlarmGroup=upsFullAlarmGroup, upsInputTruePower=upsInputTruePower, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBypassNumLines=upsBypassNumLines, upsAlarmDescr=upsAlarmDescr, upsTestSpinLock=upsTestSpinLock, upsShutdownType=upsShutdownType, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBypass=upsBypass, upsFullTestGroup=upsFullTestGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsControl=upsControl, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestId=upsTestId, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestResultsSummary=upsTestResultsSummary, upsSubsetIdentGroup=upsSubsetIdentGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsBasicOutputGroup=upsBasicOutputGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBatteryVoltage=upsBatteryVoltage, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmTime=upsAlarmTime, upsBypassTable=upsBypassTable, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBasicAlarmGroup=upsBasicAlarmGroup, upsOutputNumLines=upsOutputNumLines, upsObjects=upsObjects, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsOutputVoltage=upsOutputVoltage, upsOutputCurrent=upsOutputCurrent, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsSubsetOutputGroup=upsSubsetOutputGroup, upsInputLineIndex=upsInputLineIndex, upsSubsetGroups=upsSubsetGroups, upsFullInputGroup=upsFullInputGroup, upsMIB=upsMIB, upsBatteryTemperature=upsBatteryTemperature, upsAlarmTable=upsAlarmTable, upsBypassCurrent=upsBypassCurrent, upsBypassLineIndex=upsBypassLineIndex, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsOutputPower=upsOutputPower, upsCompliances=upsCompliances, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBasicInputGroup=upsBasicInputGroup, upsAlarmEntry=upsAlarmEntry, upsOutputEntry=upsOutputEntry, NonNegativeInteger=NonNegativeInteger, upsInputEntry=upsInputEntry, upsOutputTable=upsOutputTable, upsFullBypassGroup=upsFullBypassGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAutoRestart=upsAutoRestart, upsConfigOutputFreq=upsConfigOutputFreq, upsInputVoltage=upsInputVoltage, upsAlarmTempBad=upsAlarmTempBad, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsFullConfigGroup=upsFullConfigGroup, upsAlarm=upsAlarm, upsOutputFrequency=upsOutputFrequency, upsBasicCompliance=upsBasicCompliance, upsFullControlGroup=upsFullControlGroup, upsInputCurrent=upsInputCurrent, upsBasicGroups=upsBasicGroups, upsConfigAudibleStatus=upsConfigAudibleStatus, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsRebootWithDuration=upsRebootWithDuration, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsIdentName=upsIdentName, upsAlarmOnBypass=upsAlarmOnBypass, upsFullGroups=upsFullGroups, upsConformance=upsConformance, upsAlarmFanFailure=upsAlarmFanFailure, upsOutput=upsOutput)
