...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmsPresent=upsAlarmsPresent, upsBatteryVoltage=upsBatteryVoltage, upsOutputEntry=upsOutputEntry, upsAlarmId=upsAlarmId, upsOutputLineIndex=upsOutputLineIndex, upsInput=upsInput, upsFullTestGroup=upsFullTestGroup, upsBattery=upsBattery, upsIdentModel=upsIdentModel, upsBasicTestGroup=upsBasicTestGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestStartTime=upsTestStartTime, upsBypassVoltage=upsBypassVoltage, upsAlarmTestInProgress=upsAlarmTestInProgress, upsWellKnownTests=upsWellKnownTests, upsAlarmFanFailure=upsAlarmFanFailure, upsConfig=upsConfig, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsConformance=upsConformance, upsBypass=upsBypass, upsAlarmBypassBad=upsAlarmBypassBad, upsOutput=upsOutput, upsFullControlGroup=upsFullControlGroup, upsIdentManufacturer=upsIdentManufacturer, upsOutputSource=upsOutputSource, upsInputCurrent=upsInputCurrent, upsOutputVoltage=upsOutputVoltage, upsTestResultsDetail=upsTestResultsDetail, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBatteryTemperature=upsBatteryTemperature, upsInputVoltage=upsInputVoltage, upsBasicCompliance=upsBasicCompliance, upsBatteryCurrent=upsBatteryCurrent, upsAlarm=upsAlarm, upsGroups=upsGroups, PYSNMP_MODULE_ID=upsMIB, upsOutputFrequency=upsOutputFrequency, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConfigInputFreq=upsConfigInputFreq, upsTraps=upsTraps, upsBypassNumLines=upsBypassNumLines, NonNegativeInteger=NonNegativeInteger, upsAlarmOnBattery=upsAlarmOnBattery, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsOutputCurrent=upsOutputCurrent, upsInputLineIndex=upsInputLineIndex, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsFullGroups=upsFullGroups, upsMIB=upsMIB, upsAlarmTempBad=upsAlarmTempBad, upsBasicControlGroup=upsBasicControlGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsTest=upsTest, upsFullIdentGroup=upsFullIdentGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, PositiveInteger=PositiveInteger, upsAlarmTime=upsAlarmTime, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmTable=upsAlarmTable, upsConfigOutputVoltage=upsConfigOutputVoltage, upsInputTruePower=upsInputTruePower, upsOutputNumLines=upsOutputNumLines, upsIdentName=upsIdentName, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBypassCurrent=upsBypassCurrent, upsConfigLowBattTime=upsConfigLowBattTime, upsInputTable=upsInputTable, upsTestResultsSummary=upsTestResultsSummary, upsSecondsOnBattery=upsSecondsOnBattery, upsSubsetInputGroup=upsSubsetInputGroup, upsSubsetCompliance=upsSubsetCompliance, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBasicGroups=upsBasicGroups, upsConfigOutputFreq=upsConfigOutputFreq, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBypassPower=upsBypassPower, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsInputNumLines=upsInputNumLines, upsOutputPower=upsOutputPower, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsSubsetGroups=upsSubsetGroups, upsOutputTable=upsOutputTable, upsWellKnownAlarms=upsWellKnownAlarms, upsBypassLineIndex=upsBypassLineIndex, upsFullCompliance=upsFullCompliance, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsShutdownType=upsShutdownType, upsAutoRestart=upsAutoRestart, upsTrapOnBattery=upsTrapOnBattery, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmDescr=upsAlarmDescr, upsTestSpinLock=upsTestSpinLock, upsConfigAudibleStatus=upsConfigAudibleStatus, upsCompliances=upsCompliances, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsFullBypassGroup=upsFullBypassGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsRebootWithDuration=upsRebootWithDuration, upsBypassFrequency=upsBypassFrequency, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsFullInputGroup=upsFullInputGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTestElapsedTime=upsTestElapsedTime, upsInputFrequency=upsInputFrequency, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBasicIdentGroup=upsBasicIdentGroup, upsControl=upsControl, upsObjects=upsObjects, upsInputLineBads=upsInputLineBads, upsConfigOutputPower=upsConfigOutputPower, upsFullOutputGroup=upsFullOutputGroup, upsTestId=upsTestId, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBasicInputGroup=upsBasicInputGroup, upsAlarmEntry=upsAlarmEntry, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsIdent=upsIdent, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBypassEntry=upsBypassEntry, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsFullConfigGroup=upsFullConfigGroup, upsBypassTable=upsBypassTable, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmInputBad=upsAlarmInputBad, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTrapTestCompleted=upsTrapTestCompleted, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsSubsetControlGroup=upsSubsetControlGroup, upsBatteryStatus=upsBatteryStatus, upsBasicBypassGroup=upsBasicBypassGroup, upsInputEntry=upsInputEntry, upsConfigOutputVA=upsConfigOutputVA)
