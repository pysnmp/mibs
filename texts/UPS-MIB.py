...
iso, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, NotificationType, Counter32, Bits, Unsigned32, ObjectIdentity, MibIdentifier, Integer32, Gauge32, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "NotificationType", "Counter32", "Bits", "Unsigned32", "ObjectIdentity", "MibIdentifier", "Integer32", "Gauge32", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("UPS-MIB", upsOutput=upsOutput, upsOutputCurrent=upsOutputCurrent, upsTestSpinLock=upsTestSpinLock, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarm=upsAlarm, upsSubsetControlGroup=upsSubsetControlGroup, upsBypassEntry=upsBypassEntry, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBypassFrequency=upsBypassFrequency, upsFullTestGroup=upsFullTestGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsFullInputGroup=upsFullInputGroup, upsInputCurrent=upsInputCurrent, upsTrapOnBattery=upsTrapOnBattery, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmTempBad=upsAlarmTempBad, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsTestId=upsTestId, upsConformance=upsConformance, upsConfigOutputVA=upsConfigOutputVA, upsShutdownType=upsShutdownType, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBypassPower=upsBypassPower, upsInputEntry=upsInputEntry, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmOnBypass=upsAlarmOnBypass, upsFullOutputGroup=upsFullOutputGroup, upsInputTable=upsInputTable, upsConfigLowBattTime=upsConfigLowBattTime, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsFullConfigGroup=upsFullConfigGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsWellKnownTests=upsWellKnownTests, upsSubsetCompliance=upsSubsetCompliance, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBasicGroups=upsBasicGroups, upsFullControlGroup=upsFullControlGroup, upsBatteryStatus=upsBatteryStatus, upsBatteryTemperature=upsBatteryTemperature, upsObjects=upsObjects, upsAlarmInputBad=upsAlarmInputBad, upsBattery=upsBattery, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmEntry=upsAlarmEntry, upsAlarmOutputOverload=upsAlarmOutputOverload, upsInputTruePower=upsInputTruePower, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBypassTable=upsBypassTable, upsShutdownAfterDelay=upsShutdownAfterDelay, upsOutputPercentLoad=upsOutputPercentLoad, upsInputLineBads=upsInputLineBads, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsFullGroups=upsFullGroups, upsInputNumLines=upsInputNumLines, upsAlarmFanFailure=upsAlarmFanFailure, upsConfigOutputPower=upsConfigOutputPower, upsConfigOutputVoltage=upsConfigOutputVoltage, PYSNMP_MODULE_ID=upsMIB, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAutoRestart=upsAutoRestart, upsInputFrequency=upsInputFrequency, upsAlarmId=upsAlarmId, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBasicIdentGroup=upsBasicIdentGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullIdentGroup=upsFullIdentGroup, upsControl=upsControl, upsBasicCompliance=upsBasicCompliance, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsTestResultsSummary=upsTestResultsSummary, upsBasicInputGroup=upsBasicInputGroup, upsBasicControlGroup=upsBasicControlGroup, upsIdent=upsIdent, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsInput=upsInput, upsOutputVoltage=upsOutputVoltage, upsInputVoltage=upsInputVoltage, upsFullAlarmGroup=upsFullAlarmGroup, upsBypassCurrent=upsBypassCurrent, upsOutputEntry=upsOutputEntry, upsWellKnownAlarms=upsWellKnownAlarms, PositiveInteger=PositiveInteger, upsSubsetGroups=upsSubsetGroups, upsAlarmOutputBad=upsAlarmOutputBad, upsBatteryCurrent=upsBatteryCurrent, upsFullCompliance=upsFullCompliance, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsSecondsOnBattery=upsSecondsOnBattery, upsConfig=upsConfig, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBasicAlarmGroup=upsBasicAlarmGroup, upsMIB=upsMIB, upsOutputNumLines=upsOutputNumLines, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsConfigInputFreq=upsConfigInputFreq, upsBypassNumLines=upsBypassNumLines, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmsPresent=upsAlarmsPresent, upsStartupAfterDelay=upsStartupAfterDelay, upsBypassVoltage=upsBypassVoltage, upsTestStartTime=upsTestStartTime, NonNegativeInteger=NonNegativeInteger, upsOutputTable=upsOutputTable, upsAlarmTime=upsAlarmTime, upsAlarmDescr=upsAlarmDescr, upsOutputPower=upsOutputPower, upsTrapTestCompleted=upsTrapTestCompleted, upsCompliances=upsCompliances, upsIdentManufacturer=upsIdentManufacturer, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmLowBattery=upsAlarmLowBattery, upsFullBypassGroup=upsFullBypassGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsOutputFrequency=upsOutputFrequency, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBasicOutputGroup=upsBasicOutputGroup, upsRebootWithDuration=upsRebootWithDuration, upsOutputLineIndex=upsOutputLineIndex, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTestResultsDetail=upsTestResultsDetail, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsGroups=upsGroups, upsBypass=upsBypass, upsAlarmTable=upsAlarmTable, upsTestElapsedTime=upsTestElapsedTime, upsFullBatteryGroup=upsFullBatteryGroup, upsIdentModel=upsIdentModel, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBypassLineIndex=upsBypassLineIndex, upsAlarmChargerFailed=upsAlarmChargerFailed, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBasicTestGroup=upsBasicTestGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsInputLineIndex=upsInputLineIndex, upsOutputSource=upsOutputSource, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsIdentName=upsIdentName, upsTraps=upsTraps, upsBatteryVoltage=upsBatteryVoltage, upsTest=upsTest)
