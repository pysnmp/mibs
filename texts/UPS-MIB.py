...
# Produced by pysmi-1.1.12 at Thu Apr  4 09:15:07 2024
...
IpAddress, iso, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, ObjectIdentity, Bits, NotificationType, Counter64, Integer32, Gauge32, Unsigned32, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "iso", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Bits", "NotificationType", "Counter64", "Integer32", "Gauge32", "Unsigned32", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("UPS-MIB", upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBypassLineIndex=upsBypassLineIndex, upsFullControlGroup=upsFullControlGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsControl=upsControl, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsInputVoltage=upsInputVoltage, upsBasicGroups=upsBasicGroups, upsInputEntry=upsInputEntry, upsFullTestGroup=upsFullTestGroup, upsOutputFrequency=upsOutputFrequency, upsBasicIdentGroup=upsBasicIdentGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsBypassTable=upsBypassTable, upsBypass=upsBypass, upsInputLineIndex=upsInputLineIndex, upsShutdownType=upsShutdownType, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTrapTestCompleted=upsTrapTestCompleted, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBasicInputGroup=upsBasicInputGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBatteryCurrent=upsBatteryCurrent, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBasicTestGroup=upsBasicTestGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsInputCurrent=upsInputCurrent, upsFullBypassGroup=upsFullBypassGroup, upsOutputCurrent=upsOutputCurrent, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarm=upsAlarm, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBasicConfigGroup=upsBasicConfigGroup, upsOutputLineIndex=upsOutputLineIndex, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBatteryVoltage=upsBatteryVoltage, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBypassCurrent=upsBypassCurrent, upsFullCompliance=upsFullCompliance, upsOutputVoltage=upsOutputVoltage, upsAlarmTable=upsAlarmTable, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmFanFailure=upsAlarmFanFailure, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsOutputSource=upsOutputSource, upsAlarmInputBad=upsAlarmInputBad, upsSecondsOnBattery=upsSecondsOnBattery, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsOutput=upsOutput, upsAlarmLowBattery=upsAlarmLowBattery, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsFullInputGroup=upsFullInputGroup, upsAlarmId=upsAlarmId, upsCompliances=upsCompliances, upsAlarmOnBypass=upsAlarmOnBypass, upsOutputPower=upsOutputPower, upsTestSpinLock=upsTestSpinLock, upsBasicOutputGroup=upsBasicOutputGroup, PYSNMP_MODULE_ID=upsMIB, upsInputLineBads=upsInputLineBads, upsBasicCompliance=upsBasicCompliance, upsConfigInputFreq=upsConfigInputFreq, upsInput=upsInput, upsConfigLowBattTime=upsConfigLowBattTime, upsShutdownAfterDelay=upsShutdownAfterDelay, upsIdentAttachedDevices=upsIdentAttachedDevices, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsObjects=upsObjects, upsAlarmTempBad=upsAlarmTempBad, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTestElapsedTime=upsTestElapsedTime, upsBatteryStatus=upsBatteryStatus, upsIdentModel=upsIdentModel, upsAlarmFuseFailure=upsAlarmFuseFailure, upsWellKnownAlarms=upsWellKnownAlarms, upsTestQuickBatteryTest=upsTestQuickBatteryTest, NonNegativeInteger=NonNegativeInteger, upsIdent=upsIdent, upsBattery=upsBattery, upsInputNumLines=upsInputNumLines, upsAlarmOutputBad=upsAlarmOutputBad, upsBatteryTemperature=upsBatteryTemperature, upsMIB=upsMIB, upsFullBatteryGroup=upsFullBatteryGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBasicControlGroup=upsBasicControlGroup, upsTraps=upsTraps, upsConformance=upsConformance, upsBypassVoltage=upsBypassVoltage, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBypassEntry=upsBypassEntry, upsOutputEntry=upsOutputEntry, upsAlarmShutdownImminent=upsAlarmShutdownImminent, PositiveInteger=PositiveInteger, upsTest=upsTest, upsFullGroups=upsFullGroups, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsIdentManufacturer=upsIdentManufacturer, upsAlarmOnBattery=upsAlarmOnBattery, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsTestId=upsTestId, upsInputTable=upsInputTable, upsConfigInputVoltage=upsConfigInputVoltage, upsTrapOnBattery=upsTrapOnBattery, upsFullOutputGroup=upsFullOutputGroup, upsAlarmEntry=upsAlarmEntry, upsConfigOutputFreq=upsConfigOutputFreq, upsBasicBypassGroup=upsBasicBypassGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullAlarmGroup=upsFullAlarmGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBypassPower=upsBypassPower, upsTestStartTime=upsTestStartTime, upsBypassFrequency=upsBypassFrequency, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsFullIdentGroup=upsFullIdentGroup, upsBypassNumLines=upsBypassNumLines, upsSubsetGroups=upsSubsetGroups, upsTestResultsDetail=upsTestResultsDetail, upsFullConfigGroup=upsFullConfigGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsInputTruePower=upsInputTruePower, upsTestResultsSummary=upsTestResultsSummary, upsOutputNumLines=upsOutputNumLines, upsAutoRestart=upsAutoRestart, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsSubsetCompliance=upsSubsetCompliance, upsConfigOutputPower=upsConfigOutputPower, upsInputFrequency=upsInputFrequency, upsAlarmDescr=upsAlarmDescr, upsConfig=upsConfig, upsAlarmsPresent=upsAlarmsPresent, upsAlarmChargerFailed=upsAlarmChargerFailed, upsRebootWithDuration=upsRebootWithDuration, upsWellKnownTests=upsWellKnownTests, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsOutputTable=upsOutputTable, upsSubsetControlGroup=upsSubsetControlGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsGroups=upsGroups, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmTime=upsAlarmTime, upsIdentName=upsIdentName, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsConfigOutputVA=upsConfigOutputVA)
