...
mibBuilder.exportSymbols("UPS-MIB", upsBasicConfigGroup=upsBasicConfigGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsBypassEntry=upsBypassEntry, upsIdent=upsIdent, upsAlarmTime=upsAlarmTime, upsConfigOutputVoltage=upsConfigOutputVoltage, NonNegativeInteger=NonNegativeInteger, upsBypassFrequency=upsBypassFrequency, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsOutputVoltage=upsOutputVoltage, upsShutdownType=upsShutdownType, upsAlarmGeneralFault=upsAlarmGeneralFault, upsInputTable=upsInputTable, upsAlarmLowBattery=upsAlarmLowBattery, upsSubsetGroups=upsSubsetGroups, upsAlarmFanFailure=upsAlarmFanFailure, upsConfigOutputVA=upsConfigOutputVA, upsFullIdentGroup=upsFullIdentGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsBatteryTemperature=upsBatteryTemperature, upsInputEntry=upsInputEntry, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsSubsetCompliance=upsSubsetCompliance, upsBypassTable=upsBypassTable, upsBatteryCurrent=upsBatteryCurrent, upsConfig=upsConfig, upsInput=upsInput, PYSNMP_MODULE_ID=upsMIB, upsOutputNumLines=upsOutputNumLines, upsTest=upsTest, upsBypassVoltage=upsBypassVoltage, upsTrapOnBattery=upsTrapOnBattery, upsIdentModel=upsIdentModel, upsFullConfigGroup=upsFullConfigGroup, upsWellKnownTests=upsWellKnownTests, upsIdentAttachedDevices=upsIdentAttachedDevices, upsOutputLineIndex=upsOutputLineIndex, upsInputLineIndex=upsInputLineIndex, upsBypassNumLines=upsBypassNumLines, upsOutput=upsOutput, upsOutputEntry=upsOutputEntry, upsOutputPower=upsOutputPower, upsTestElapsedTime=upsTestElapsedTime, upsGroups=upsGroups, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmDescr=upsAlarmDescr, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsConformance=upsConformance, upsSecondsOnBattery=upsSecondsOnBattery, upsInputCurrent=upsInputCurrent, upsControl=upsControl, upsOutputSource=upsOutputSource, upsInputVoltage=upsInputVoltage, upsAlarmEntry=upsAlarmEntry, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBasicIdentGroup=upsBasicIdentGroup, upsBattery=upsBattery, upsBypassPower=upsBypassPower, upsFullBatteryGroup=upsFullBatteryGroup, upsOutputCurrent=upsOutputCurrent, upsAlarmBypassBad=upsAlarmBypassBad, upsTestResultsSummary=upsTestResultsSummary, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsRebootWithDuration=upsRebootWithDuration, upsAlarmsPresent=upsAlarmsPresent, upsSubsetControlGroup=upsSubsetControlGroup, upsOutputTable=upsOutputTable, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullInputGroup=upsFullInputGroup, upsInputNumLines=upsInputNumLines, upsOutputFrequency=upsOutputFrequency, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsStartupAfterDelay=upsStartupAfterDelay, upsObjects=upsObjects, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsFullTestGroup=upsFullTestGroup, upsTestSpinLock=upsTestSpinLock, upsIdentManufacturer=upsIdentManufacturer, upsBasicControlGroup=upsBasicControlGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsFullOutputGroup=upsFullOutputGroup, upsConfigOutputPower=upsConfigOutputPower, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTestResultsDetail=upsTestResultsDetail, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBasicCompliance=upsBasicCompliance, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBatteryStatus=upsBatteryStatus, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBypassLineIndex=upsBypassLineIndex, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsFullCompliance=upsFullCompliance, upsConfigLowBattTime=upsConfigLowBattTime, upsBasicTestGroup=upsBasicTestGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBypassCurrent=upsBypassCurrent, upsInputFrequency=upsInputFrequency, upsBasicInputGroup=upsBasicInputGroup, upsFullControlGroup=upsFullControlGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestStartTime=upsTestStartTime, upsFullBypassGroup=upsFullBypassGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTestId=upsTestId, upsAlarmId=upsAlarmId, upsBasicOutputGroup=upsBasicOutputGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsSubsetInputGroup=upsSubsetInputGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsTraps=upsTraps, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarm=upsAlarm, upsAlarmTable=upsAlarmTable, upsBasicGroups=upsBasicGroups, upsInputTruePower=upsInputTruePower, upsAlarmInputBad=upsAlarmInputBad, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsMIB=upsMIB, upsFullGroups=upsFullGroups, upsConfigInputFreq=upsConfigInputFreq, upsBasicAlarmGroup=upsBasicAlarmGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBatteryVoltage=upsBatteryVoltage, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmShutdownPending=upsAlarmShutdownPending, upsIdentName=upsIdentName, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBypass=upsBypass, upsCompliances=upsCompliances, PositiveInteger=PositiveInteger, upsAlarmTempBad=upsAlarmTempBad, upsInputLineBads=upsInputLineBads, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAutoRestart=upsAutoRestart)
