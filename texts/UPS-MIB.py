...
mibBuilder.exportSymbols("UPS-MIB", upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsObjects=upsObjects, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmLowBattery=upsAlarmLowBattery, upsRebootWithDuration=upsRebootWithDuration, upsConfigLowBattTime=upsConfigLowBattTime, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsOutput=upsOutput, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsOutputCurrent=upsOutputCurrent, upsConfigInputFreq=upsConfigInputFreq, upsBasicCompliance=upsBasicCompliance, upsTestSpinLock=upsTestSpinLock, PositiveInteger=PositiveInteger, upsBypassNumLines=upsBypassNumLines, upsConfigAudibleStatus=upsConfigAudibleStatus, upsOutputVoltage=upsOutputVoltage, upsInputCurrent=upsInputCurrent, upsBasicInputGroup=upsBasicInputGroup, upsAlarmsPresent=upsAlarmsPresent, upsFullGroups=upsFullGroups, upsOutputSource=upsOutputSource, upsBypassFrequency=upsBypassFrequency, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsInputFrequency=upsInputFrequency, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmInputBad=upsAlarmInputBad, upsOutputNumLines=upsOutputNumLines, upsInputLineBads=upsInputLineBads, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmFanFailure=upsAlarmFanFailure, upsConfigOutputVoltage=upsConfigOutputVoltage, upsFullInputGroup=upsFullInputGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsOutputEntry=upsOutputEntry, upsBasicConfigGroup=upsBasicConfigGroup, upsFullIdentGroup=upsFullIdentGroup, upsIdent=upsIdent, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarm=upsAlarm, upsAlarmEntry=upsAlarmEntry, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmTempBad=upsAlarmTempBad, upsIdentName=upsIdentName, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmTable=upsAlarmTable, upsInputTruePower=upsInputTruePower, upsSubsetGroups=upsSubsetGroups, upsInputLineIndex=upsInputLineIndex, upsBypass=upsBypass, upsBatteryTemperature=upsBatteryTemperature, upsSubsetInputGroup=upsSubsetInputGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBatteryVoltage=upsBatteryVoltage, upsTraps=upsTraps, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBypassCurrent=upsBypassCurrent, upsSubsetControlGroup=upsSubsetControlGroup, upsTrapOnBattery=upsTrapOnBattery, upsAlarmId=upsAlarmId, upsFullAlarmGroup=upsFullAlarmGroup, upsOutputTable=upsOutputTable, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsStartupAfterDelay=upsStartupAfterDelay, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullControlGroup=upsFullControlGroup, upsBattery=upsBattery, upsAlarmBypassBad=upsAlarmBypassBad, upsFullOutputGroup=upsFullOutputGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsInput=upsInput, upsAlarmDescr=upsAlarmDescr, upsBasicBypassGroup=upsBasicBypassGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsShutdownType=upsShutdownType, upsOutputLineIndex=upsOutputLineIndex, upsInputNumLines=upsInputNumLines, upsBasicAlarmGroup=upsBasicAlarmGroup, upsCompliances=upsCompliances, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBasicTestGroup=upsBasicTestGroup, upsFullTestGroup=upsFullTestGroup, upsMIB=upsMIB, NonNegativeInteger=NonNegativeInteger, upsShutdownAfterDelay=upsShutdownAfterDelay, upsOutputFrequency=upsOutputFrequency, upsBasicControlGroup=upsBasicControlGroup, upsFullBypassGroup=upsFullBypassGroup, upsTestStartTime=upsTestStartTime, upsTrapTestCompleted=upsTrapTestCompleted, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsSubsetCompliance=upsSubsetCompliance, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmTime=upsAlarmTime, upsBypassEntry=upsBypassEntry, upsBypassVoltage=upsBypassVoltage, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmOutputBad=upsAlarmOutputBad, upsBasicOutputGroup=upsBasicOutputGroup, upsFullConfigGroup=upsFullConfigGroup, upsWellKnownTests=upsWellKnownTests, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsBypassTable=upsBypassTable, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBasicGroups=upsBasicGroups, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBatteryCurrent=upsBatteryCurrent, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBypassLineIndex=upsBypassLineIndex, upsConformance=upsConformance, upsConfigOutputPower=upsConfigOutputPower, upsOutputPower=upsOutputPower, PYSNMP_MODULE_ID=upsMIB, upsTest=upsTest, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigOutputVA=upsConfigOutputVA, upsInputVoltage=upsInputVoltage, upsAutoRestart=upsAutoRestart, upsConfigInputVoltage=upsConfigInputVoltage, upsBypassPower=upsBypassPower, upsInputTable=upsInputTable, upsControl=upsControl, upsSecondsOnBattery=upsSecondsOnBattery, upsGroups=upsGroups, upsIdentManufacturer=upsIdentManufacturer, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTestResultsDetail=upsTestResultsDetail, upsFullCompliance=upsFullCompliance, upsInputEntry=upsInputEntry, upsTestElapsedTime=upsTestElapsedTime, upsFullBatteryGroup=upsFullBatteryGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestResultsSummary=upsTestResultsSummary, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsTestId=upsTestId, upsConfig=upsConfig, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBatteryStatus=upsBatteryStatus, upsIdentModel=upsIdentModel)
