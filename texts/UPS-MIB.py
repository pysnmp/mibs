...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmId=upsAlarmId, upsInputLineBads=upsInputLineBads, upsAlarmTime=upsAlarmTime, upsFullControlGroup=upsFullControlGroup, upsBattery=upsBattery, upsFullOutputGroup=upsFullOutputGroup, upsOutputVoltage=upsOutputVoltage, upsFullBatteryGroup=upsFullBatteryGroup, upsInputFrequency=upsInputFrequency, upsTestSpinLock=upsTestSpinLock, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsRebootWithDuration=upsRebootWithDuration, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsInputNumLines=upsInputNumLines, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, PositiveInteger=PositiveInteger, upsAlarmShutdownPending=upsAlarmShutdownPending, upsWellKnownTests=upsWellKnownTests, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAutoRestart=upsAutoRestart, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTest=upsTest, upsFullConfigGroup=upsFullConfigGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsBypassLineIndex=upsBypassLineIndex, upsAlarmDescr=upsAlarmDescr, upsAlarmTempBad=upsAlarmTempBad, upsBatteryCurrent=upsBatteryCurrent, upsShutdownType=upsShutdownType, upsOutputLineIndex=upsOutputLineIndex, upsBypassPower=upsBypassPower, upsBypassFrequency=upsBypassFrequency, upsAlarmOutputOverload=upsAlarmOutputOverload, upsFullTestGroup=upsFullTestGroup, upsIdentModel=upsIdentModel, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBasicControlGroup=upsBasicControlGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsBasicInputGroup=upsBasicInputGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsTestStartTime=upsTestStartTime, upsOutputNumLines=upsOutputNumLines, upsAlarmTable=upsAlarmTable, upsIdentAttachedDevices=upsIdentAttachedDevices, upsOutputEntry=upsOutputEntry, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsIdentManufacturer=upsIdentManufacturer, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTestId=upsTestId, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBasicCompliance=upsBasicCompliance, upsBypass=upsBypass, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarm=upsAlarm, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsInputTable=upsInputTable, upsAlarmBypassBad=upsAlarmBypassBad, upsInputEntry=upsInputEntry, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmInputBad=upsAlarmInputBad, upsOutputCurrent=upsOutputCurrent, upsInputCurrent=upsInputCurrent, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBatteryStatus=upsBatteryStatus, upsConformance=upsConformance, upsConfigOutputVoltage=upsConfigOutputVoltage, upsConfig=upsConfig, upsFullBypassGroup=upsFullBypassGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmOnBypass=upsAlarmOnBypass, upsIdentName=upsIdentName, upsOutputPower=upsOutputPower, upsOutputPercentLoad=upsOutputPercentLoad, upsBypassCurrent=upsBypassCurrent, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestResultsDetail=upsTestResultsDetail, upsBasicGroups=upsBasicGroups, upsFullAlarmGroup=upsFullAlarmGroup, upsControl=upsControl, upsOutput=upsOutput, upsTestElapsedTime=upsTestElapsedTime, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsInputTruePower=upsInputTruePower, upsBypassTable=upsBypassTable, upsOutputTable=upsOutputTable, upsGroups=upsGroups, upsMIB=upsMIB, upsConfigOutputVA=upsConfigOutputVA, upsWellKnownAlarms=upsWellKnownAlarms, upsBatteryVoltage=upsBatteryVoltage, upsTraps=upsTraps, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsCompliances=upsCompliances, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsObjects=upsObjects, upsAlarmsPresent=upsAlarmsPresent, upsBypassVoltage=upsBypassVoltage, upsAlarmEntry=upsAlarmEntry, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBasicTestGroup=upsBasicTestGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmChargerFailed=upsAlarmChargerFailed, upsSubsetInputGroup=upsSubsetInputGroup, upsConfigInputFreq=upsConfigInputFreq, upsBasicBypassGroup=upsBasicBypassGroup, upsBatteryTemperature=upsBatteryTemperature, upsInput=upsInput, upsConfigOutputFreq=upsConfigOutputFreq, upsSubsetGroups=upsSubsetGroups, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsConfigOutputPower=upsConfigOutputPower, upsOutputFrequency=upsOutputFrequency, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsSecondsOnBattery=upsSecondsOnBattery, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTestResultsSummary=upsTestResultsSummary, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsFullCompliance=upsFullCompliance, upsBypassNumLines=upsBypassNumLines, PYSNMP_MODULE_ID=upsMIB, upsSubsetCompliance=upsSubsetCompliance, upsTrapOnBattery=upsTrapOnBattery, upsFullGroups=upsFullGroups, upsFullIdentGroup=upsFullIdentGroup, upsIdent=upsIdent, upsInputLineIndex=upsInputLineIndex, upsFullInputGroup=upsFullInputGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmGeneralFault=upsAlarmGeneralFault, upsInputVoltage=upsInputVoltage, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsSubsetControlGroup=upsSubsetControlGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsBypassEntry=upsBypassEntry, upsBasicIdentGroup=upsBasicIdentGroup, upsOutputSource=upsOutputSource, upsBasicConfigGroup=upsBasicConfigGroup, NonNegativeInteger=NonNegativeInteger, upsTrapTestCompleted=upsTrapTestCompleted)
