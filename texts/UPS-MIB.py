...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmId=upsAlarmId, upsControl=upsControl, upsInputLineBads=upsInputLineBads, upsConfigOutputPower=upsConfigOutputPower, upsAlarmOutputBad=upsAlarmOutputBad, upsFullTestGroup=upsFullTestGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmTable=upsAlarmTable, upsTraps=upsTraps, upsBypassCurrent=upsBypassCurrent, upsAlarmTime=upsAlarmTime, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, NonNegativeInteger=NonNegativeInteger, upsFullIdentGroup=upsFullIdentGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBypassVoltage=upsBypassVoltage, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsOutputNumLines=upsOutputNumLines, upsConfigOutputFreq=upsConfigOutputFreq, upsBypassEntry=upsBypassEntry, upsAlarmFuseFailure=upsAlarmFuseFailure, upsRebootWithDuration=upsRebootWithDuration, upsFullConfigGroup=upsFullConfigGroup, upsAutoRestart=upsAutoRestart, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsTestSpinLock=upsTestSpinLock, upsAlarmDescr=upsAlarmDescr, upsInputCurrent=upsInputCurrent, upsAlarmInputBad=upsAlarmInputBad, upsInputTable=upsInputTable, upsBypassLineIndex=upsBypassLineIndex, upsAlarmBatteryBad=upsAlarmBatteryBad, upsWellKnownAlarms=upsWellKnownAlarms, upsIdentManufacturer=upsIdentManufacturer, upsTest=upsTest, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsOutputPower=upsOutputPower, upsFullGroups=upsFullGroups, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicGroups=upsBasicGroups, upsAlarmTempBad=upsAlarmTempBad, upsBasicCompliance=upsBasicCompliance, upsAlarm=upsAlarm, upsTestId=upsTestId, upsTestResultsDetail=upsTestResultsDetail, upsShutdownAfterDelay=upsShutdownAfterDelay, upsIdent=upsIdent, upsTestElapsedTime=upsTestElapsedTime, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsConfigInputVoltage=upsConfigInputVoltage, upsFullInputGroup=upsFullInputGroup, upsBatteryStatus=upsBatteryStatus, upsTestResultsSummary=upsTestResultsSummary, upsBypassTable=upsBypassTable, upsBasicOutputGroup=upsBasicOutputGroup, upsInputVoltage=upsInputVoltage, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsConfig=upsConfig, upsMIB=upsMIB, upsConfigLowBattTime=upsConfigLowBattTime, upsFullAlarmGroup=upsFullAlarmGroup, upsConformance=upsConformance, upsOutputLineIndex=upsOutputLineIndex, upsFullCompliance=upsFullCompliance, upsIdentName=upsIdentName, upsInputFrequency=upsInputFrequency, upsStartupAfterDelay=upsStartupAfterDelay, upsConfigInputFreq=upsConfigInputFreq, upsInputLineIndex=upsInputLineIndex, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTrapTestCompleted=upsTrapTestCompleted, upsBypassPower=upsBypassPower, upsOutputSource=upsOutputSource, upsOutput=upsOutput, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsObjects=upsObjects, upsAlarmShutdownImminent=upsAlarmShutdownImminent, PositiveInteger=PositiveInteger, upsAlarmEntry=upsAlarmEntry, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmOutputOverload=upsAlarmOutputOverload, upsSubsetIdentGroup=upsSubsetIdentGroup, PYSNMP_MODULE_ID=upsMIB, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBattery=upsBattery, upsBypassNumLines=upsBypassNumLines, upsBypassFrequency=upsBypassFrequency, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsConfigOutputVA=upsConfigOutputVA, upsSubsetControlGroup=upsSubsetControlGroup, upsIdentModel=upsIdentModel, upsBasicAlarmGroup=upsBasicAlarmGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsInput=upsInput, upsFullControlGroup=upsFullControlGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsInputTruePower=upsInputTruePower, upsInputEntry=upsInputEntry, upsBatteryVoltage=upsBatteryVoltage, upsOutputEntry=upsOutputEntry, upsCompliances=upsCompliances, upsBasicTestGroup=upsBasicTestGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsSecondsOnBattery=upsSecondsOnBattery, upsFullBypassGroup=upsFullBypassGroup, upsBatteryCurrent=upsBatteryCurrent, upsOutputVoltage=upsOutputVoltage, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTestStartTime=upsTestStartTime, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBasicControlGroup=upsBasicControlGroup, upsSubsetCompliance=upsSubsetCompliance, upsOutputPercentLoad=upsOutputPercentLoad, upsBatteryTemperature=upsBatteryTemperature, upsAlarmFanFailure=upsAlarmFanFailure, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmOnBypass=upsAlarmOnBypass, upsTrapOnBattery=upsTrapOnBattery, upsBasicInputGroup=upsBasicInputGroup, upsAlarmsPresent=upsAlarmsPresent, upsOutputTable=upsOutputTable, upsOutputCurrent=upsOutputCurrent, upsBypass=upsBypass, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBasicIdentGroup=upsBasicIdentGroup, upsGroups=upsGroups, upsAlarmOnBattery=upsAlarmOnBattery, upsWellKnownTests=upsWellKnownTests, upsSubsetGroups=upsSubsetGroups, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmShutdownPending=upsAlarmShutdownPending, upsSubsetOutputGroup=upsSubsetOutputGroup, upsShutdownType=upsShutdownType, upsOutputFrequency=upsOutputFrequency, upsFullOutputGroup=upsFullOutputGroup, upsInputNumLines=upsInputNumLines, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmTestInProgress=upsAlarmTestInProgress, upsSubsetConfigGroup=upsSubsetConfigGroup)
