...
mibBuilder.exportSymbols("UPS-MIB", upsConfigOutputPower=upsConfigOutputPower, upsIdentAttachedDevices=upsIdentAttachedDevices, PositiveInteger=PositiveInteger, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmInputBad=upsAlarmInputBad, upsOutputNumLines=upsOutputNumLines, upsConfigOutputVA=upsConfigOutputVA, upsBypassCurrent=upsBypassCurrent, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBypassNumLines=upsBypassNumLines, upsTrapOnBattery=upsTrapOnBattery, upsControl=upsControl, upsTestResultsSummary=upsTestResultsSummary, upsInputVoltage=upsInputVoltage, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsOutputFrequency=upsOutputFrequency, upsOutputTable=upsOutputTable, upsTrapTestCompleted=upsTrapTestCompleted, upsOutputPercentLoad=upsOutputPercentLoad, upsSubsetOutputGroup=upsSubsetOutputGroup, PYSNMP_MODULE_ID=upsMIB, upsInputNumLines=upsInputNumLines, upsAlarmsPresent=upsAlarmsPresent, upsAlarmOnBypass=upsAlarmOnBypass, upsBatteryVoltage=upsBatteryVoltage, upsRebootWithDuration=upsRebootWithDuration, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmTable=upsAlarmTable, upsOutput=upsOutput, upsShutdownType=upsShutdownType, upsTraps=upsTraps, upsBatteryTemperature=upsBatteryTemperature, upsBypassFrequency=upsBypassFrequency, upsAlarm=upsAlarm, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsFullIdentGroup=upsFullIdentGroup, upsBypassLineIndex=upsBypassLineIndex, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmId=upsAlarmId, upsBasicAlarmGroup=upsBasicAlarmGroup, upsInputLineBads=upsInputLineBads, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsShutdownAfterDelay=upsShutdownAfterDelay, upsOutputLineIndex=upsOutputLineIndex, upsOutputCurrent=upsOutputCurrent, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBasicInputGroup=upsBasicInputGroup, upsFullBypassGroup=upsFullBypassGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBasicControlGroup=upsBasicControlGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsSubsetInputGroup=upsSubsetInputGroup, upsFullOutputGroup=upsFullOutputGroup, upsInputLineIndex=upsInputLineIndex, upsAlarmBatteryBad=upsAlarmBatteryBad, upsGroups=upsGroups, upsWellKnownTests=upsWellKnownTests, upsIdentModel=upsIdentModel, upsConfigInputFreq=upsConfigInputFreq, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsWellKnownAlarms=upsWellKnownAlarms, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsFullBatteryGroup=upsFullBatteryGroup, upsConformance=upsConformance, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTest=upsTest, upsBasicBypassGroup=upsBasicBypassGroup, upsBatteryCurrent=upsBatteryCurrent, upsAlarmShutdownPending=upsAlarmShutdownPending, upsIdentName=upsIdentName, upsSubsetGroups=upsSubsetGroups, upsFullAlarmGroup=upsFullAlarmGroup, upsOutputVoltage=upsOutputVoltage, upsBypassVoltage=upsBypassVoltage, upsConfigOutputFreq=upsConfigOutputFreq, upsCompliances=upsCompliances, upsAlarmOutputBad=upsAlarmOutputBad, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsInputTable=upsInputTable, upsSecondsOnBattery=upsSecondsOnBattery, upsBasicOutputGroup=upsBasicOutputGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTestStartTime=upsTestStartTime, upsConfigInputVoltage=upsConfigInputVoltage, upsTestElapsedTime=upsTestElapsedTime, upsAlarmOnBattery=upsAlarmOnBattery, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmTime=upsAlarmTime, upsFullGroups=upsFullGroups, upsFullConfigGroup=upsFullConfigGroup, upsConfig=upsConfig, upsInputCurrent=upsInputCurrent, upsSubsetCompliance=upsSubsetCompliance, upsFullInputGroup=upsFullInputGroup, upsOutputEntry=upsOutputEntry, upsBypassPower=upsBypassPower, upsFullControlGroup=upsFullControlGroup, upsInputEntry=upsInputEntry, upsOutputPower=upsOutputPower, NonNegativeInteger=NonNegativeInteger, upsInput=upsInput, upsTestResultsDetail=upsTestResultsDetail, upsFullCompliance=upsFullCompliance, upsConfigLowBattTime=upsConfigLowBattTime, upsBypassTable=upsBypassTable, upsBypass=upsBypass, upsMIB=upsMIB, upsAutoRestart=upsAutoRestart, upsAlarmChargerFailed=upsAlarmChargerFailed, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmDescr=upsAlarmDescr, upsInputFrequency=upsInputFrequency, upsConfigAudibleStatus=upsConfigAudibleStatus, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsIdent=upsIdent, upsInputTruePower=upsInputTruePower, upsFullTestGroup=upsFullTestGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsBatteryStatus=upsBatteryStatus, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsTestSpinLock=upsTestSpinLock, upsTestId=upsTestId, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmTempBad=upsAlarmTempBad, upsBypassEntry=upsBypassEntry, upsBasicGroups=upsBasicGroups, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsObjects=upsObjects, upsBasicTestGroup=upsBasicTestGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBattery=upsBattery, upsAlarmEntry=upsAlarmEntry, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBasicCompliance=upsBasicCompliance, upsIdentManufacturer=upsIdentManufacturer, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBasicConfigGroup=upsBasicConfigGroup, upsOutputSource=upsOutputSource, upsAlarmAwaitingPower=upsAlarmAwaitingPower)
