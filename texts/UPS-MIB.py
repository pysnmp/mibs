...
# Produced by pysmi-1.1.8 at Thu Oct 26 12:07:38 2023
...
Gauge32, mib_2, ObjectIdentity, TimeTicks, ModuleIdentity, Counter64, MibIdentifier, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, Unsigned32, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "mib-2", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "Counter64", "MibIdentifier", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "Unsigned32", "Counter32", "Bits")
...
mibBuilder.exportSymbols("UPS-MIB", upsTraps=upsTraps, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmsPresent=upsAlarmsPresent, upsGroups=upsGroups, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBasicTestGroup=upsBasicTestGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBypassLineIndex=upsBypassLineIndex, upsTrapOnBattery=upsTrapOnBattery, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBasicBypassGroup=upsBasicBypassGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmTime=upsAlarmTime, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTrapTestCompleted=upsTrapTestCompleted, upsFullTestGroup=upsFullTestGroup, upsSubsetGroups=upsSubsetGroups, upsInputEntry=upsInputEntry, upsBypassVoltage=upsBypassVoltage, upsTestResultsSummary=upsTestResultsSummary, upsTest=upsTest, upsBasicBatteryGroup=upsBasicBatteryGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsIdent=upsIdent, upsInputTable=upsInputTable, upsFullBypassGroup=upsFullBypassGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmOnBattery=upsAlarmOnBattery, upsBasicControlGroup=upsBasicControlGroup, upsFullGroups=upsFullGroups, upsSubsetInputGroup=upsSubsetInputGroup, upsBypass=upsBypass, upsOutputSource=upsOutputSource, upsOutputEntry=upsOutputEntry, upsBypassNumLines=upsBypassNumLines, upsFullInputGroup=upsFullInputGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, PositiveInteger=PositiveInteger, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBypassFrequency=upsBypassFrequency, upsWellKnownTests=upsWellKnownTests, upsRebootWithDuration=upsRebootWithDuration, upsMIB=upsMIB, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTestStartTime=upsTestStartTime, upsConformance=upsConformance, upsBasicIdentGroup=upsBasicIdentGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, NonNegativeInteger=NonNegativeInteger, upsBatteryStatus=upsBatteryStatus, upsControl=upsControl, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAutoRestart=upsAutoRestart, upsConfigInputFreq=upsConfigInputFreq, upsInputCurrent=upsInputCurrent, upsBypassPower=upsBypassPower, upsStartupAfterDelay=upsStartupAfterDelay, upsInputLineBads=upsInputLineBads, upsBasicOutputGroup=upsBasicOutputGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmChargerFailed=upsAlarmChargerFailed, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmOutputBad=upsAlarmOutputBad, upsBypassCurrent=upsBypassCurrent, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBatteryTemperature=upsBatteryTemperature, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBasicConfigGroup=upsBasicConfigGroup, upsInputVoltage=upsInputVoltage, upsAlarmTempBad=upsAlarmTempBad, upsIdentName=upsIdentName, upsInputTruePower=upsInputTruePower, upsInputNumLines=upsInputNumLines, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, PYSNMP_MODULE_ID=upsMIB, upsFullAlarmGroup=upsFullAlarmGroup, upsOutputFrequency=upsOutputFrequency, upsAlarmFanFailure=upsAlarmFanFailure, upsSecondsOnBattery=upsSecondsOnBattery, upsOutputLineIndex=upsOutputLineIndex, upsCompliances=upsCompliances, upsSubsetCompliance=upsSubsetCompliance, upsInputLineIndex=upsInputLineIndex, upsObjects=upsObjects, upsOutputVoltage=upsOutputVoltage, upsAlarmTable=upsAlarmTable, upsBasicCompliance=upsBasicCompliance, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBypassTable=upsBypassTable, upsConfigInputVoltage=upsConfigInputVoltage, upsIdentManufacturer=upsIdentManufacturer, upsAlarmInputBad=upsAlarmInputBad, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullControlGroup=upsFullControlGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsOutputPercentLoad=upsOutputPercentLoad, upsBypassEntry=upsBypassEntry, upsFullCompliance=upsFullCompliance, upsBasicGroups=upsBasicGroups, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsOutputTable=upsOutputTable, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConfigOutputFreq=upsConfigOutputFreq, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmEntry=upsAlarmEntry, upsTestId=upsTestId, upsOutputPower=upsOutputPower, upsAlarmGeneralFault=upsAlarmGeneralFault, upsOutput=upsOutput, upsFullConfigGroup=upsFullConfigGroup, upsFullIdentGroup=upsFullIdentGroup, upsConfigOutputVA=upsConfigOutputVA, upsTestResultsDetail=upsTestResultsDetail, upsOutputCurrent=upsOutputCurrent, upsBattery=upsBattery, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsShutdownAfterDelay=upsShutdownAfterDelay, upsSubsetControlGroup=upsSubsetControlGroup, upsFullOutputGroup=upsFullOutputGroup, upsInput=upsInput, upsShutdownType=upsShutdownType, upsAlarm=upsAlarm, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTestSpinLock=upsTestSpinLock, upsOutputNumLines=upsOutputNumLines, upsAlarmDescr=upsAlarmDescr, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmId=upsAlarmId, upsConfigLowBattTime=upsConfigLowBattTime, upsInputFrequency=upsInputFrequency, upsBatteryVoltage=upsBatteryVoltage, upsBatteryCurrent=upsBatteryCurrent, upsTestElapsedTime=upsTestElapsedTime, upsConfig=upsConfig, upsConfigOutputPower=upsConfigOutputPower, upsBasicInputGroup=upsBasicInputGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsIdentModel=upsIdentModel)
