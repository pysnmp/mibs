...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:17:38 2022
...
mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, Counter32, Unsigned32, Counter64, NotificationType, IpAddress, TimeTicks, ObjectIdentity, Gauge32, iso, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "Counter32", "Unsigned32", "Counter64", "NotificationType", "IpAddress", "TimeTicks", "ObjectIdentity", "Gauge32", "iso", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBypassVoltage=upsBypassVoltage, upsOutputVoltage=upsOutputVoltage, upsTestElapsedTime=upsTestElapsedTime, upsSubsetCompliance=upsSubsetCompliance, upsAlarmTable=upsAlarmTable, upsAlarmEntry=upsAlarmEntry, upsIdent=upsIdent, upsBattery=upsBattery, upsTestStartTime=upsTestStartTime, upsAlarmInputBad=upsAlarmInputBad, upsConfigOutputVA=upsConfigOutputVA, upsFullIdentGroup=upsFullIdentGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsTraps=upsTraps, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsBasicTestGroup=upsBasicTestGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsBatteryStatus=upsBatteryStatus, upsInputLineIndex=upsInputLineIndex, upsBypassFrequency=upsBypassFrequency, upsInputTruePower=upsInputTruePower, upsAlarmDescr=upsAlarmDescr, upsBypass=upsBypass, upsSubsetGroups=upsSubsetGroups, upsFullInputGroup=upsFullInputGroup, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTestResultsDetail=upsTestResultsDetail, upsOutputLineIndex=upsOutputLineIndex, upsFullBatteryGroup=upsFullBatteryGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutputFrequency=upsOutputFrequency, upsIdentManufacturer=upsIdentManufacturer, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBasicGroups=upsBasicGroups, upsConfigLowBattTime=upsConfigLowBattTime, upsBypassEntry=upsBypassEntry, upsTestSpinLock=upsTestSpinLock, upsIdentModel=upsIdentModel, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarm=upsAlarm, upsBatteryCurrent=upsBatteryCurrent, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBypassTable=upsBypassTable, upsFullAlarmGroup=upsFullAlarmGroup, NonNegativeInteger=NonNegativeInteger, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBypassLineIndex=upsBypassLineIndex, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAutoRestart=upsAutoRestart, upsFullCompliance=upsFullCompliance, upsShutdownAfterDelay=upsShutdownAfterDelay, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsMIB=upsMIB, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsInput=upsInput, upsAlarmBypassBad=upsAlarmBypassBad, upsBypassNumLines=upsBypassNumLines, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBasicBypassGroup=upsBasicBypassGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsIdentAttachedDevices=upsIdentAttachedDevices, upsObjects=upsObjects, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicCompliance=upsBasicCompliance, upsAlarmTime=upsAlarmTime, upsInputEntry=upsInputEntry, upsBasicInputGroup=upsBasicInputGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBatteryVoltage=upsBatteryVoltage, upsInputNumLines=upsInputNumLines, upsOutputPercentLoad=upsOutputPercentLoad, upsConfig=upsConfig, upsAlarmOnBypass=upsAlarmOnBypass, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTest=upsTest, upsWellKnownTests=upsWellKnownTests, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsOutputEntry=upsOutputEntry, upsFullConfigGroup=upsFullConfigGroup, upsGroups=upsGroups, upsSubsetConfigGroup=upsSubsetConfigGroup, upsInputVoltage=upsInputVoltage, upsFullBypassGroup=upsFullBypassGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmOnBattery=upsAlarmOnBattery, upsBatteryTemperature=upsBatteryTemperature, upsInputFrequency=upsInputFrequency, upsOutputTable=upsOutputTable, upsAlarmId=upsAlarmId, upsFullTestGroup=upsFullTestGroup, upsInputLineBads=upsInputLineBads, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmTempBad=upsAlarmTempBad, upsOutputPower=upsOutputPower, upsBypassCurrent=upsBypassCurrent, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsFullControlGroup=upsFullControlGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsIdentName=upsIdentName, upsStartupAfterDelay=upsStartupAfterDelay, upsControl=upsControl, upsOutputNumLines=upsOutputNumLines, PYSNMP_MODULE_ID=upsMIB, upsSubsetOutputGroup=upsSubsetOutputGroup, upsOutputSource=upsOutputSource, upsTestId=upsTestId, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsConformance=upsConformance, upsAlarmOutputOverload=upsAlarmOutputOverload, upsShutdownType=upsShutdownType, upsWellKnownAlarms=upsWellKnownAlarms, upsFullGroups=upsFullGroups, upsConfigOutputFreq=upsConfigOutputFreq, upsBypassPower=upsBypassPower, upsInputCurrent=upsInputCurrent, upsAlarmOutputBad=upsAlarmOutputBad, upsSecondsOnBattery=upsSecondsOnBattery, upsInputTable=upsInputTable, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicControlGroup=upsBasicControlGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsFullOutputGroup=upsFullOutputGroup, upsTrapOnBattery=upsTrapOnBattery, upsOutput=upsOutput, upsConfigOutputPower=upsConfigOutputPower, upsRebootWithDuration=upsRebootWithDuration, upsAlarmLowBattery=upsAlarmLowBattery, upsCompliances=upsCompliances, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsAlarmsPresent=upsAlarmsPresent, PositiveInteger=PositiveInteger, upsConfigInputFreq=upsConfigInputFreq, upsTestResultsSummary=upsTestResultsSummary, upsOutputCurrent=upsOutputCurrent)
