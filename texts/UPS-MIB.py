...
# Produced by pysmi-1.1.8 at Wed Sep 13 14:50:57 2023
...
iso, IpAddress, NotificationType, ModuleIdentity, Gauge32, mib_2, Integer32, Bits, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "NotificationType", "ModuleIdentity", "Gauge32", "mib-2", "Integer32", "Bits", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("UPS-MIB", upsOutputVoltage=upsOutputVoltage, upsBasicInputGroup=upsBasicInputGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmFanFailure=upsAlarmFanFailure, upsBatteryStatus=upsBatteryStatus, upsConfig=upsConfig, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsIdentName=upsIdentName, upsIdent=upsIdent, upsAlarmChargerFailed=upsAlarmChargerFailed, upsFullIdentGroup=upsFullIdentGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsInputFrequency=upsInputFrequency, upsBasicCompliance=upsBasicCompliance, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTestStartTime=upsTestStartTime, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsShutdownAfterDelay=upsShutdownAfterDelay, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, NonNegativeInteger=NonNegativeInteger, upsBasicTestGroup=upsBasicTestGroup, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBypassPower=upsBypassPower, upsBasicBypassGroup=upsBasicBypassGroup, upsBypassTable=upsBypassTable, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmTime=upsAlarmTime, upsAlarmOutputBad=upsAlarmOutputBad, upsTraps=upsTraps, PositiveInteger=PositiveInteger, upsOutputFrequency=upsOutputFrequency, upsBasicIdentGroup=upsBasicIdentGroup, upsConfigOutputVA=upsConfigOutputVA, upsBasicAlarmGroup=upsBasicAlarmGroup, upsGroups=upsGroups, upsSubsetControlGroup=upsSubsetControlGroup, upsOutputCurrent=upsOutputCurrent, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsOutputPower=upsOutputPower, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBypass=upsBypass, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBypassLineIndex=upsBypassLineIndex, upsOutputLineIndex=upsOutputLineIndex, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBypassVoltage=upsBypassVoltage, upsOutput=upsOutput, upsAlarmLowBattery=upsAlarmLowBattery, upsTrapOnBattery=upsTrapOnBattery, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsCompliances=upsCompliances, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBypassEntry=upsBypassEntry, upsAlarmInputBad=upsAlarmInputBad, upsFullTestGroup=upsFullTestGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSecondsOnBattery=upsSecondsOnBattery, upsObjects=upsObjects, upsBypassFrequency=upsBypassFrequency, upsTestResultsSummary=upsTestResultsSummary, upsBasicConfigGroup=upsBasicConfigGroup, upsTest=upsTest, upsConfigInputVoltage=upsConfigInputVoltage, upsFullConfigGroup=upsFullConfigGroup, upsTestElapsedTime=upsTestElapsedTime, upsFullGroups=upsFullGroups, upsControl=upsControl, upsFullAlarmGroup=upsFullAlarmGroup, upsFullInputGroup=upsFullInputGroup, upsInputNumLines=upsInputNumLines, upsAlarmEntry=upsAlarmEntry, upsBypassCurrent=upsBypassCurrent, upsTestResultsDetail=upsTestResultsDetail, upsConformance=upsConformance, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmDescr=upsAlarmDescr, upsAlarmOutputOverload=upsAlarmOutputOverload, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsOutputEntry=upsOutputEntry, upsSubsetCompliance=upsSubsetCompliance, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmsPresent=upsAlarmsPresent, PYSNMP_MODULE_ID=upsMIB, upsAlarmGeneralFault=upsAlarmGeneralFault, upsIdentModel=upsIdentModel, upsInputLineIndex=upsInputLineIndex, upsInputTable=upsInputTable, upsOutputPercentLoad=upsOutputPercentLoad, upsBatteryCurrent=upsBatteryCurrent, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsWellKnownTests=upsWellKnownTests, upsSubsetGroups=upsSubsetGroups, upsConfigInputFreq=upsConfigInputFreq, upsAlarmTable=upsAlarmTable, upsBasicGroups=upsBasicGroups, upsWellKnownAlarms=upsWellKnownAlarms, upsBypassNumLines=upsBypassNumLines, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBattery=upsBattery, upsFullBatteryGroup=upsFullBatteryGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTestSpinLock=upsTestSpinLock, upsAlarm=upsAlarm, upsConfigLowBattTime=upsConfigLowBattTime, upsInputVoltage=upsInputVoltage, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTestId=upsTestId, upsBasicOutputGroup=upsBasicOutputGroup, upsFullControlGroup=upsFullControlGroup, upsBasicControlGroup=upsBasicControlGroup, upsAlarmId=upsAlarmId, upsOutputNumLines=upsOutputNumLines, upsOutputSource=upsOutputSource, upsBatteryTemperature=upsBatteryTemperature, upsInputEntry=upsInputEntry, upsConfigOutputPower=upsConfigOutputPower, upsIdentManufacturer=upsIdentManufacturer, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAutoRestart=upsAutoRestart, upsFullBypassGroup=upsFullBypassGroup, upsInputCurrent=upsInputCurrent, upsAlarmOnBypass=upsAlarmOnBypass, upsInputLineBads=upsInputLineBads, upsFullOutputGroup=upsFullOutputGroup, upsShutdownType=upsShutdownType, upsAlarmTempBad=upsAlarmTempBad, upsFullCompliance=upsFullCompliance, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsInput=upsInput, upsMIB=upsMIB, upsRebootWithDuration=upsRebootWithDuration, upsInputTruePower=upsInputTruePower, upsOutputTable=upsOutputTable, upsBatteryVoltage=upsBatteryVoltage, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff)
