...
mibBuilder.exportSymbols("UPS-MIB", upsBypassEntry=upsBypassEntry, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBattery=upsBattery, upsOutputTable=upsOutputTable, upsFullConfigGroup=upsFullConfigGroup, upsTestStartTime=upsTestStartTime, upsInputTable=upsInputTable, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmBatteryBad=upsAlarmBatteryBad, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsSubsetCompliance=upsSubsetCompliance, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBasicControlGroup=upsBasicControlGroup, upsConfigInputFreq=upsConfigInputFreq, upsOutputLineIndex=upsOutputLineIndex, upsAlarmOnBypass=upsAlarmOnBypass, upsFullIdentGroup=upsFullIdentGroup, upsFullControlGroup=upsFullControlGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmDescr=upsAlarmDescr, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsAutoRestart=upsAutoRestart, upsIdentName=upsIdentName, upsInputTruePower=upsInputTruePower, upsOutputPercentLoad=upsOutputPercentLoad, upsObjects=upsObjects, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsOutput=upsOutput, upsStartupAfterDelay=upsStartupAfterDelay, upsWellKnownAlarms=upsWellKnownAlarms, upsRebootWithDuration=upsRebootWithDuration, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsFullInputGroup=upsFullInputGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmTempBad=upsAlarmTempBad, upsSecondsOnBattery=upsSecondsOnBattery, upsShutdownType=upsShutdownType, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfigOutputVA=upsConfigOutputVA, upsBatteryVoltage=upsBatteryVoltage, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsSubsetControlGroup=upsSubsetControlGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsConfigOutputVoltage=upsConfigOutputVoltage, upsFullOutputGroup=upsFullOutputGroup, upsAlarmTime=upsAlarmTime, upsIdent=upsIdent, upsInputNumLines=upsInputNumLines, upsAlarmTestInProgress=upsAlarmTestInProgress, upsIdentManufacturer=upsIdentManufacturer, upsOutputCurrent=upsOutputCurrent, upsTestElapsedTime=upsTestElapsedTime, upsBypassNumLines=upsBypassNumLines, upsBasicConfigGroup=upsBasicConfigGroup, upsFullGroups=upsFullGroups, upsOutputVoltage=upsOutputVoltage, upsTestResultsDetail=upsTestResultsDetail, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBasicIdentGroup=upsBasicIdentGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBasicGroups=upsBasicGroups, upsAlarmId=upsAlarmId, upsMIB=upsMIB, upsAlarmOutputBad=upsAlarmOutputBad, upsBatteryCurrent=upsBatteryCurrent, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsControl=upsControl, NonNegativeInteger=NonNegativeInteger, upsAlarmEntry=upsAlarmEntry, upsAlarm=upsAlarm, upsConformance=upsConformance, upsConfigOutputPower=upsConfigOutputPower, upsBatteryStatus=upsBatteryStatus, upsAlarmInputBad=upsAlarmInputBad, upsFullCompliance=upsFullCompliance, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmsPresent=upsAlarmsPresent, upsTest=upsTest, upsSubsetGroups=upsSubsetGroups, upsBypassTable=upsBypassTable, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsTestId=upsTestId, upsTestSpinLock=upsTestSpinLock, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, PositiveInteger=PositiveInteger, upsInputEntry=upsInputEntry, upsConfig=upsConfig, upsFullBypassGroup=upsFullBypassGroup, upsBypass=upsBypass, upsBasicCompliance=upsBasicCompliance, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsCompliances=upsCompliances, upsIdentModel=upsIdentModel, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBypassFrequency=upsBypassFrequency, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsOutputFrequency=upsOutputFrequency, upsConfigLowBattTime=upsConfigLowBattTime, upsConfigAudibleStatus=upsConfigAudibleStatus, upsFullAlarmGroup=upsFullAlarmGroup, upsInputFrequency=upsInputFrequency, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsWellKnownTests=upsWellKnownTests, upsOutputNumLines=upsOutputNumLines, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBypassCurrent=upsBypassCurrent, upsAlarmTable=upsAlarmTable, upsBasicTestGroup=upsBasicTestGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutputSource=upsOutputSource, upsInputLineIndex=upsInputLineIndex, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBatteryTemperature=upsBatteryTemperature, upsAlarmFanFailure=upsAlarmFanFailure, upsBasicBypassGroup=upsBasicBypassGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsInputCurrent=upsInputCurrent, upsTestResultsSummary=upsTestResultsSummary, upsTraps=upsTraps, upsInput=upsInput, upsIdentAttachedDevices=upsIdentAttachedDevices, PYSNMP_MODULE_ID=upsMIB, upsGroups=upsGroups, upsBasicInputGroup=upsBasicInputGroup, upsBypassLineIndex=upsBypassLineIndex, upsOutputPower=upsOutputPower, upsInputLineBads=upsInputLineBads, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsFullBatteryGroup=upsFullBatteryGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsInputVoltage=upsInputVoltage, upsTrapOnBattery=upsTrapOnBattery, upsSubsetInputGroup=upsSubsetInputGroup, upsFullTestGroup=upsFullTestGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsBypassPower=upsBypassPower, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBypassVoltage=upsBypassVoltage, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsOutputEntry=upsOutputEntry)
