...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmTable=upsAlarmTable, upsWellKnownAlarms=upsWellKnownAlarms, upsSubsetOutputGroup=upsSubsetOutputGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsSubsetCompliance=upsSubsetCompliance, upsMIB=upsMIB, upsBypassEntry=upsBypassEntry, upsStartupAfterDelay=upsStartupAfterDelay, upsConfigOutputVoltage=upsConfigOutputVoltage, upsWellKnownTests=upsWellKnownTests, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsOutputPower=upsOutputPower, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsFullInputGroup=upsFullInputGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsObjects=upsObjects, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsInputTruePower=upsInputTruePower, PositiveInteger=PositiveInteger, upsOutputTable=upsOutputTable, upsFullBatteryGroup=upsFullBatteryGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsConfigLowBattTime=upsConfigLowBattTime, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBasicInputGroup=upsBasicInputGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarm=upsAlarm, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicControlGroup=upsBasicControlGroup, upsBypassVoltage=upsBypassVoltage, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmOutputBad=upsAlarmOutputBad, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBasicCompliance=upsBasicCompliance, upsBasicTestGroup=upsBasicTestGroup, upsInputCurrent=upsInputCurrent, upsTraps=upsTraps, upsInputEntry=upsInputEntry, upsOutputVoltage=upsOutputVoltage, upsFullGroups=upsFullGroups, upsBypassPower=upsBypassPower, upsIdentName=upsIdentName, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmDescr=upsAlarmDescr, upsOutputCurrent=upsOutputCurrent, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsInputLineIndex=upsInputLineIndex, upsIdentAttachedDevices=upsIdentAttachedDevices, upsCompliances=upsCompliances, upsFullIdentGroup=upsFullIdentGroup, upsFullTestGroup=upsFullTestGroup, upsInputTable=upsInputTable, upsOutput=upsOutput, upsAlarmOnBypass=upsAlarmOnBypass, upsTestStartTime=upsTestStartTime, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsOutputSource=upsOutputSource, upsBatteryTemperature=upsBatteryTemperature, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsIdent=upsIdent, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, NonNegativeInteger=NonNegativeInteger, upsAlarmOnBattery=upsAlarmOnBattery, upsTestId=upsTestId, upsFullControlGroup=upsFullControlGroup, upsSubsetGroups=upsSubsetGroups, upsBasicConfigGroup=upsBasicConfigGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsSecondsOnBattery=upsSecondsOnBattery, upsConfigOutputFreq=upsConfigOutputFreq, upsTestResultsSummary=upsTestResultsSummary, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmEntry=upsAlarmEntry, upsTest=upsTest, upsInputNumLines=upsInputNumLines, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsOutputEntry=upsOutputEntry, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsConfig=upsConfig, upsFullOutputGroup=upsFullOutputGroup, upsBatteryVoltage=upsBatteryVoltage, upsAlarmInputBad=upsAlarmInputBad, upsBasicBatteryGroup=upsBasicBatteryGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAutoRestart=upsAutoRestart, upsAlarmGeneralFault=upsAlarmGeneralFault, upsConfigInputFreq=upsConfigInputFreq, upsTestResultsDetail=upsTestResultsDetail, upsTestElapsedTime=upsTestElapsedTime, upsIdentManufacturer=upsIdentManufacturer, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsInputVoltage=upsInputVoltage, upsAlarmTempBad=upsAlarmTempBad, upsOutputNumLines=upsOutputNumLines, upsIdentModel=upsIdentModel, upsGroups=upsGroups, upsAlarmShutdownPending=upsAlarmShutdownPending, PYSNMP_MODULE_ID=upsMIB, upsBatteryCurrent=upsBatteryCurrent, upsShutdownType=upsShutdownType, upsTestSpinLock=upsTestSpinLock, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBasicAlarmGroup=upsBasicAlarmGroup, upsInputLineBads=upsInputLineBads, upsBasicGroups=upsBasicGroups, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBypassLineIndex=upsBypassLineIndex, upsFullBypassGroup=upsFullBypassGroup, upsConfigOutputVA=upsConfigOutputVA, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmTime=upsAlarmTime, upsOutputFrequency=upsOutputFrequency, upsBattery=upsBattery, upsTrapOnBattery=upsTrapOnBattery, upsFullAlarmGroup=upsFullAlarmGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmId=upsAlarmId, upsInput=upsInput, upsRebootWithDuration=upsRebootWithDuration, upsBypassCurrent=upsBypassCurrent, upsOutputLineIndex=upsOutputLineIndex, upsTrapTestCompleted=upsTrapTestCompleted, upsConformance=upsConformance, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsInputFrequency=upsInputFrequency, upsBypassFrequency=upsBypassFrequency, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBasicOutputGroup=upsBasicOutputGroup, upsBatteryStatus=upsBatteryStatus, upsBypassTable=upsBypassTable, upsFullConfigGroup=upsFullConfigGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsFullCompliance=upsFullCompliance, upsAlarmsPresent=upsAlarmsPresent, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsConfigOutputPower=upsConfigOutputPower, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBypassNumLines=upsBypassNumLines, upsBypass=upsBypass, upsControl=upsControl)
