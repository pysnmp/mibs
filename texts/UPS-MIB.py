...
# Produced by pysmi-1.1.8 at Mon Sep 19 08:24:55 2022
...
ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, mib_2, ModuleIdentity, IpAddress, Bits, MibIdentifier, TimeTicks, Integer32, Counter32, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "mib-2", "ModuleIdentity", "IpAddress", "Bits", "MibIdentifier", "TimeTicks", "Integer32", "Counter32", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmOutputBad=upsAlarmOutputBad, upsConfigLowBattTime=upsConfigLowBattTime, upsFullBypassGroup=upsFullBypassGroup, upsInputLineIndex=upsInputLineIndex, upsSubsetInputGroup=upsSubsetInputGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsFullIdentGroup=upsFullIdentGroup, upsMIB=upsMIB, upsWellKnownTests=upsWellKnownTests, upsAlarmBypassBad=upsAlarmBypassBad, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBattery=upsBattery, upsAlarmBatteryBad=upsAlarmBatteryBad, PositiveInteger=PositiveInteger, upsBypassFrequency=upsBypassFrequency, upsBasicOutputGroup=upsBasicOutputGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmOnBattery=upsAlarmOnBattery, upsShutdownAfterDelay=upsShutdownAfterDelay, upsIdentModel=upsIdentModel, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmTime=upsAlarmTime, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsOutputFrequency=upsOutputFrequency, upsAlarmTestInProgress=upsAlarmTestInProgress, upsIdentAttachedDevices=upsIdentAttachedDevices, upsGroups=upsGroups, upsBypassPower=upsBypassPower, upsOutputPower=upsOutputPower, upsAlarmChargerFailed=upsAlarmChargerFailed, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsIdentManufacturer=upsIdentManufacturer, upsStartupAfterDelay=upsStartupAfterDelay, upsConfigOutputPower=upsConfigOutputPower, upsInput=upsInput, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBypassLineIndex=upsBypassLineIndex, upsOutputEntry=upsOutputEntry, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmsPresent=upsAlarmsPresent, upsBasicConfigGroup=upsBasicConfigGroup, upsFullGroups=upsFullGroups, upsInputNumLines=upsInputNumLines, upsTestResultsSummary=upsTestResultsSummary, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsConfigInputVoltage=upsConfigInputVoltage, upsFullCompliance=upsFullCompliance, upsFullInputGroup=upsFullInputGroup, upsBatteryCurrent=upsBatteryCurrent, upsInputTable=upsInputTable, upsBatteryTemperature=upsBatteryTemperature, upsTestId=upsTestId, upsIdentName=upsIdentName, NonNegativeInteger=NonNegativeInteger, upsInputCurrent=upsInputCurrent, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmTable=upsAlarmTable, upsAlarm=upsAlarm, upsFullAlarmGroup=upsFullAlarmGroup, upsBatteryStatus=upsBatteryStatus, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBasicControlGroup=upsBasicControlGroup, upsTest=upsTest, upsObjects=upsObjects, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmDescr=upsAlarmDescr, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsSubsetGroups=upsSubsetGroups, upsBasicIdentGroup=upsBasicIdentGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBypassVoltage=upsBypassVoltage, upsConfigAudibleStatus=upsConfigAudibleStatus, upsTestResultsDetail=upsTestResultsDetail, upsBypassCurrent=upsBypassCurrent, upsBasicAlarmGroup=upsBasicAlarmGroup, upsFullControlGroup=upsFullControlGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBypassEntry=upsBypassEntry, upsConfigInputFreq=upsConfigInputFreq, upsFullOutputGroup=upsFullOutputGroup, upsSubsetCompliance=upsSubsetCompliance, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutputSource=upsOutputSource, upsBasicBypassGroup=upsBasicBypassGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBasicCompliance=upsBasicCompliance, upsOutputLineIndex=upsOutputLineIndex, upsAlarmOnBypass=upsAlarmOnBypass, upsInputEntry=upsInputEntry, upsFullBatteryGroup=upsFullBatteryGroup, upsRebootWithDuration=upsRebootWithDuration, upsTestElapsedTime=upsTestElapsedTime, upsOutputTable=upsOutputTable, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsShutdownType=upsShutdownType, upsControl=upsControl, upsAlarmLowBattery=upsAlarmLowBattery, upsTestSpinLock=upsTestSpinLock, upsBasicGroups=upsBasicGroups, upsIdent=upsIdent, upsBypassTable=upsBypassTable, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullConfigGroup=upsFullConfigGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsBypass=upsBypass, upsTestStartTime=upsTestStartTime, upsAlarmOutputOverload=upsAlarmOutputOverload, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutputNumLines=upsOutputNumLines, upsAlarmEntry=upsAlarmEntry, upsBasicTestGroup=upsBasicTestGroup, upsSubsetControlGroup=upsSubsetControlGroup, PYSNMP_MODULE_ID=upsMIB, upsOutput=upsOutput, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsSecondsOnBattery=upsSecondsOnBattery, upsConfigOutputVA=upsConfigOutputVA, upsInputTruePower=upsInputTruePower, upsBasicInputGroup=upsBasicInputGroup, upsBatteryVoltage=upsBatteryVoltage, upsTrapOnBattery=upsTrapOnBattery, upsConfig=upsConfig, upsInputLineBads=upsInputLineBads, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsOutputCurrent=upsOutputCurrent, upsOutputVoltage=upsOutputVoltage, upsAlarmFuseFailure=upsAlarmFuseFailure, upsInputFrequency=upsInputFrequency, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAutoRestart=upsAutoRestart, upsConformance=upsConformance, upsTraps=upsTraps, upsBypassNumLines=upsBypassNumLines, upsAlarmTempBad=upsAlarmTempBad, upsSubsetIdentGroup=upsSubsetIdentGroup, upsFullTestGroup=upsFullTestGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmInputBad=upsAlarmInputBad, upsAlarmId=upsAlarmId, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsInputVoltage=upsInputVoltage, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsCompliances=upsCompliances)
