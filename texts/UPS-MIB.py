...
Unsigned32, IpAddress, Counter32, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, Gauge32, Counter64, ModuleIdentity, TimeTicks, mib_2, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "Counter32", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "Gauge32", "Counter64", "ModuleIdentity", "TimeTicks", "mib-2", "Integer32", "Bits")
...
mibBuilder.exportSymbols("UPS-MIB", upsFullControlGroup=upsFullControlGroup, upsBypassPower=upsBypassPower, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBypassVoltage=upsBypassVoltage, upsAlarmBypassBad=upsAlarmBypassBad, upsInputFrequency=upsInputFrequency, upsSubsetConfigGroup=upsSubsetConfigGroup, upsTestStartTime=upsTestStartTime, upsAlarmOutputBad=upsAlarmOutputBad, PositiveInteger=PositiveInteger, upsTestResultsDetail=upsTestResultsDetail, upsFullBypassGroup=upsFullBypassGroup, upsAlarmId=upsAlarmId, upsBypassEntry=upsBypassEntry, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmFanFailure=upsAlarmFanFailure, upsBypass=upsBypass, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTestId=upsTestId, upsFullOutputGroup=upsFullOutputGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsSubsetControlGroup=upsSubsetControlGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsConfigOutputVA=upsConfigOutputVA, upsInputTable=upsInputTable, upsBasicConfigGroup=upsBasicConfigGroup, upsInputTruePower=upsInputTruePower, upsOutputFrequency=upsOutputFrequency, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmDescr=upsAlarmDescr, PYSNMP_MODULE_ID=upsMIB, upsBypassTable=upsBypassTable, upsFullTestGroup=upsFullTestGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsOutputPower=upsOutputPower, upsGroups=upsGroups, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmTime=upsAlarmTime, upsBasicCompliance=upsBasicCompliance, upsAlarmOutputOverload=upsAlarmOutputOverload, upsInputVoltage=upsInputVoltage, upsStartupAfterDelay=upsStartupAfterDelay, upsBatteryCurrent=upsBatteryCurrent, upsOutputLineIndex=upsOutputLineIndex, upsFullAlarmGroup=upsFullAlarmGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsOutputTable=upsOutputTable, upsAlarmLowBattery=upsAlarmLowBattery, upsIdent=upsIdent, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestElapsedTime=upsTestElapsedTime, upsConfigOutputPower=upsConfigOutputPower, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsConfig=upsConfig, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAutoRestart=upsAutoRestart, upsFullInputGroup=upsFullInputGroup, upsAlarmTable=upsAlarmTable, upsSecondsOnBattery=upsSecondsOnBattery, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetIdentGroup=upsSubsetIdentGroup, upsOutputNumLines=upsOutputNumLines, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsObjects=upsObjects, upsSubsetInputGroup=upsSubsetInputGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsOutputVoltage=upsOutputVoltage, upsCompliances=upsCompliances, upsInputEntry=upsInputEntry, upsBasicBypassGroup=upsBasicBypassGroup, upsOutputSource=upsOutputSource, upsConformance=upsConformance, upsSubsetCompliance=upsSubsetCompliance, upsAlarmOnBattery=upsAlarmOnBattery, upsRebootWithDuration=upsRebootWithDuration, upsTest=upsTest, upsShutdownType=upsShutdownType, upsInput=upsInput, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsIdentModel=upsIdentModel, upsTraps=upsTraps, upsAlarmsPresent=upsAlarmsPresent, upsBasicInputGroup=upsBasicInputGroup, upsMIB=upsMIB, NonNegativeInteger=NonNegativeInteger, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsOutput=upsOutput, upsBypassCurrent=upsBypassCurrent, upsSubsetGroups=upsSubsetGroups, upsInputLineBads=upsInputLineBads, upsBypassLineIndex=upsBypassLineIndex, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmTempBad=upsAlarmTempBad, upsIdentName=upsIdentName, upsConfigInputFreq=upsConfigInputFreq, upsOutputCurrent=upsOutputCurrent, upsBypassFrequency=upsBypassFrequency, upsOutputEntry=upsOutputEntry, upsBypassNumLines=upsBypassNumLines, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsBasicGroups=upsBasicGroups, upsWellKnownTests=upsWellKnownTests, upsConfigAudibleStatus=upsConfigAudibleStatus, upsFullGroups=upsFullGroups, upsAlarm=upsAlarm, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBatteryStatus=upsBatteryStatus, upsFullConfigGroup=upsFullConfigGroup, upsBasicControlGroup=upsBasicControlGroup, upsTrapOnBattery=upsTrapOnBattery, upsSubsetOutputGroup=upsSubsetOutputGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsBattery=upsBattery, upsInputNumLines=upsInputNumLines, upsBasicTestGroup=upsBasicTestGroup, upsAlarmInputBad=upsAlarmInputBad, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsOutputPercentLoad=upsOutputPercentLoad, upsFullCompliance=upsFullCompliance, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsTestResultsSummary=upsTestResultsSummary, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBatteryVoltage=upsBatteryVoltage, upsBatteryTemperature=upsBatteryTemperature, upsInputLineIndex=upsInputLineIndex, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTestSpinLock=upsTestSpinLock, upsConfigInputVoltage=upsConfigInputVoltage, upsTrapTestCompleted=upsTrapTestCompleted, upsBasicOutputGroup=upsBasicOutputGroup, upsInputCurrent=upsInputCurrent, upsAlarmEntry=upsAlarmEntry, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsIdentManufacturer=upsIdentManufacturer, upsFullIdentGroup=upsFullIdentGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsControl=upsControl, upsAlarmGeneralFault=upsAlarmGeneralFault)
