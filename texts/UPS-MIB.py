...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarm=upsAlarm, upsAlarmShutdownPending=upsAlarmShutdownPending, upsInputNumLines=upsInputNumLines, upsSubsetInputGroup=upsSubsetInputGroup, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsSubsetGroups=upsSubsetGroups, upsAlarmTime=upsAlarmTime, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsTestId=upsTestId, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBatteryTemperature=upsBatteryTemperature, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullBypassGroup=upsFullBypassGroup, upsShutdownType=upsShutdownType, upsBatteryVoltage=upsBatteryVoltage, upsConfigInputVoltage=upsConfigInputVoltage, upsOutputPercentLoad=upsOutputPercentLoad, upsFullBatteryGroup=upsFullBatteryGroup, upsFullTestGroup=upsFullTestGroup, upsTestResultsSummary=upsTestResultsSummary, upsTestResultsDetail=upsTestResultsDetail, upsBasicGroups=upsBasicGroups, upsOutputFrequency=upsOutputFrequency, upsFullGroups=upsFullGroups, upsFullOutputGroup=upsFullOutputGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsOutputEntry=upsOutputEntry, upsBypassCurrent=upsBypassCurrent, upsOutputPower=upsOutputPower, upsConfigOutputFreq=upsConfigOutputFreq, upsSubsetControlGroup=upsSubsetControlGroup, upsInput=upsInput, upsAlarmDescr=upsAlarmDescr, upsBypassLineIndex=upsBypassLineIndex, upsIdentName=upsIdentName, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsBypass=upsBypass, upsConfigInputFreq=upsConfigInputFreq, upsBatteryCurrent=upsBatteryCurrent, upsAlarmOnBattery=upsAlarmOnBattery, upsTrapOnBattery=upsTrapOnBattery, upsBasicBatteryGroup=upsBasicBatteryGroup, upsControl=upsControl, upsShutdownAfterDelay=upsShutdownAfterDelay, upsCompliances=upsCompliances, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsConfigLowBattTime=upsConfigLowBattTime, upsWellKnownTests=upsWellKnownTests, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBypassNumLines=upsBypassNumLines, upsFullInputGroup=upsFullInputGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAutoRestart=upsAutoRestart, upsAlarmOutputBad=upsAlarmOutputBad, upsSecondsOnBattery=upsSecondsOnBattery, upsOutput=upsOutput, upsSubsetConfigGroup=upsSubsetConfigGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmTempBad=upsAlarmTempBad, upsInputLineBads=upsInputLineBads, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmBypassBad=upsAlarmBypassBad, upsTestStartTime=upsTestStartTime, upsSubsetOutputGroup=upsSubsetOutputGroup, upsOutputSource=upsOutputSource, upsConfigOutputVA=upsConfigOutputVA, upsBasicInputGroup=upsBasicInputGroup, upsConfigOutputPower=upsConfigOutputPower, upsOutputNumLines=upsOutputNumLines, upsIdentModel=upsIdentModel, upsBasicIdentGroup=upsBasicIdentGroup, upsInputCurrent=upsInputCurrent, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsConfigAudibleStatus=upsConfigAudibleStatus, upsInputLineIndex=upsInputLineIndex, upsOutputVoltage=upsOutputVoltage, upsRebootWithDuration=upsRebootWithDuration, upsBypassFrequency=upsBypassFrequency, upsBatteryStatus=upsBatteryStatus, upsTestElapsedTime=upsTestElapsedTime, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsMIB=upsMIB, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBypassTable=upsBypassTable, upsTraps=upsTraps, NonNegativeInteger=NonNegativeInteger, upsTest=upsTest, upsAlarmEntry=upsAlarmEntry, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsInputTable=upsInputTable, PositiveInteger=PositiveInteger, upsAlarmTable=upsAlarmTable, upsOutputTable=upsOutputTable, upsAlarmId=upsAlarmId, upsAlarmInputBad=upsAlarmInputBad, upsSubsetCompliance=upsSubsetCompliance, upsSubsetIdentGroup=upsSubsetIdentGroup, upsObjects=upsObjects, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTestSpinLock=upsTestSpinLock, upsInputVoltage=upsInputVoltage, upsBypassEntry=upsBypassEntry, upsStartupAfterDelay=upsStartupAfterDelay, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsGroups=upsGroups, PYSNMP_MODULE_ID=upsMIB, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBypassVoltage=upsBypassVoltage, upsBasicConfigGroup=upsBasicConfigGroup, upsOutputLineIndex=upsOutputLineIndex, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBypassPower=upsBypassPower, upsOutputCurrent=upsOutputCurrent, upsBasicTestGroup=upsBasicTestGroup, upsBasicControlGroup=upsBasicControlGroup, upsAlarmsPresent=upsAlarmsPresent, upsFullConfigGroup=upsFullConfigGroup, upsInputTruePower=upsInputTruePower, upsBasicBypassGroup=upsBasicBypassGroup, upsFullIdentGroup=upsFullIdentGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsIdentManufacturer=upsIdentManufacturer, upsIdent=upsIdent, upsFullAlarmGroup=upsFullAlarmGroup, upsInputFrequency=upsInputFrequency, upsConfig=upsConfig, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmOnBypass=upsAlarmOnBypass, upsFullControlGroup=upsFullControlGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicCompliance=upsBasicCompliance, upsConformance=upsConformance, upsBattery=upsBattery, upsInputEntry=upsInputEntry, upsFullCompliance=upsFullCompliance, upsAlarmLowBattery=upsAlarmLowBattery)
