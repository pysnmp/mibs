...
# Produced by pysmi-1.1.8 at Mon Jan  9 10:10:22 2023
...
ObjectIdentity, ModuleIdentity, NotificationType, Gauge32, Counter32, Integer32, Bits, Unsigned32, IpAddress, Counter64, MibIdentifier, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "NotificationType", "Gauge32", "Counter32", "Integer32", "Bits", "Unsigned32", "IpAddress", "Counter64", "MibIdentifier", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("UPS-MIB", upsTest=upsTest, upsIdent=upsIdent, upsAlarmTable=upsAlarmTable, upsConfigInputFreq=upsConfigInputFreq, upsInputTruePower=upsInputTruePower, upsConfigLowBattTime=upsConfigLowBattTime, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmDescr=upsAlarmDescr, upsSubsetConfigGroup=upsSubsetConfigGroup, upsOutputNumLines=upsOutputNumLines, upsAlarm=upsAlarm, upsConfig=upsConfig, upsInputLineBads=upsInputLineBads, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsOutput=upsOutput, upsOutputFrequency=upsOutputFrequency, upsCompliances=upsCompliances, upsFullOutputGroup=upsFullOutputGroup, upsBypassEntry=upsBypassEntry, upsAlarmFanFailure=upsAlarmFanFailure, upsGroups=upsGroups, upsInputFrequency=upsInputFrequency, upsObjects=upsObjects, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBatteryVoltage=upsBatteryVoltage, upsOutputEntry=upsOutputEntry, upsBatteryStatus=upsBatteryStatus, upsSubsetAlarmGroup=upsSubsetAlarmGroup, PositiveInteger=PositiveInteger, upsAutoRestart=upsAutoRestart, upsTestResultsSummary=upsTestResultsSummary, upsTestStartTime=upsTestStartTime, upsConfigOutputVoltage=upsConfigOutputVoltage, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsIdentModel=upsIdentModel, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBypassTable=upsBypassTable, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsSecondsOnBattery=upsSecondsOnBattery, upsInputVoltage=upsInputVoltage, upsAlarmsPresent=upsAlarmsPresent, upsAlarmBypassBad=upsAlarmBypassBad, upsFullIdentGroup=upsFullIdentGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsFullInputGroup=upsFullInputGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsControl=upsControl, upsTrapTestCompleted=upsTrapTestCompleted, upsOutputTable=upsOutputTable, upsMIB=upsMIB, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBasicInputGroup=upsBasicInputGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsOutputPercentLoad=upsOutputPercentLoad, upsBypassVoltage=upsBypassVoltage, upsOutputVoltage=upsOutputVoltage, upsBasicCompliance=upsBasicCompliance, upsBattery=upsBattery, upsBatteryTemperature=upsBatteryTemperature, NonNegativeInteger=NonNegativeInteger, upsBypassLineIndex=upsBypassLineIndex, upsBypassCurrent=upsBypassCurrent, upsSubsetIdentGroup=upsSubsetIdentGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsBypassNumLines=upsBypassNumLines, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, PYSNMP_MODULE_ID=upsMIB, upsInputNumLines=upsInputNumLines, upsSubsetGroups=upsSubsetGroups, upsFullControlGroup=upsFullControlGroup, upsFullCompliance=upsFullCompliance, upsInputEntry=upsInputEntry, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBypass=upsBypass, upsConfigInputVoltage=upsConfigInputVoltage, upsTestElapsedTime=upsTestElapsedTime, upsFullAlarmGroup=upsFullAlarmGroup, upsBasicBatteryGroup=upsBasicBatteryGroup, upsFullTestGroup=upsFullTestGroup, upsConformance=upsConformance, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsConfigOutputVA=upsConfigOutputVA, upsConfigOutputPower=upsConfigOutputPower, upsAlarmFuseFailure=upsAlarmFuseFailure, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsIdentAttachedDevices=upsIdentAttachedDevices, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBypassPower=upsBypassPower, upsConfigOutputFreq=upsConfigOutputFreq, upsBasicBypassGroup=upsBasicBypassGroup, upsBasicGroups=upsBasicGroups, upsOutputLineIndex=upsOutputLineIndex, upsFullBypassGroup=upsFullBypassGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsTraps=upsTraps, upsAlarmOnBypass=upsAlarmOnBypass, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBasicConfigGroup=upsBasicConfigGroup, upsIdentName=upsIdentName, upsInputTable=upsInputTable, upsBypassFrequency=upsBypassFrequency, upsAlarmInputBad=upsAlarmInputBad, upsInput=upsInput, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmTempBad=upsAlarmTempBad, upsTrapOnBattery=upsTrapOnBattery, upsBasicAlarmGroup=upsBasicAlarmGroup, upsInputLineIndex=upsInputLineIndex, upsTestSpinLock=upsTestSpinLock, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsRebootWithDuration=upsRebootWithDuration, upsBasicIdentGroup=upsBasicIdentGroup, upsFullGroups=upsFullGroups, upsBatteryCurrent=upsBatteryCurrent, upsSubsetCompliance=upsSubsetCompliance, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsOutputPower=upsOutputPower, upsOutputSource=upsOutputSource, upsShutdownType=upsShutdownType, upsAlarmEntry=upsAlarmEntry, upsWellKnownAlarms=upsWellKnownAlarms, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmTime=upsAlarmTime, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTestId=upsTestId, upsBasicTestGroup=upsBasicTestGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsFullConfigGroup=upsFullConfigGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsOutputCurrent=upsOutputCurrent, upsAlarmId=upsAlarmId, upsWellKnownTests=upsWellKnownTests, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsIdentManufacturer=upsIdentManufacturer, upsInputCurrent=upsInputCurrent, upsTestResultsDetail=upsTestResultsDetail, upsBasicControlGroup=upsBasicControlGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint)
