...
mibBuilder.exportSymbols("UPS-MIB", PYSNMP_MODULE_ID=upsMIB, upsOutputSource=upsOutputSource, upsInputLineIndex=upsInputLineIndex, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmTable=upsAlarmTable, upsTestSpinLock=upsTestSpinLock, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsCompliances=upsCompliances, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsConfig=upsConfig, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsFullGroups=upsFullGroups, upsTest=upsTest, upsAlarmOutputOverload=upsAlarmOutputOverload, upsSubsetGroups=upsSubsetGroups, upsConfigOutputVA=upsConfigOutputVA, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBasicInputGroup=upsBasicInputGroup, upsFullInputGroup=upsFullInputGroup, upsAlarmDescr=upsAlarmDescr, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmTime=upsAlarmTime, upsIdentModel=upsIdentModel, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsOutputFrequency=upsOutputFrequency, upsBasicConfigGroup=upsBasicConfigGroup, upsBypassVoltage=upsBypassVoltage, upsBasicBypassGroup=upsBasicBypassGroup, upsTestElapsedTime=upsTestElapsedTime, upsAutoRestart=upsAutoRestart, upsFullControlGroup=upsFullControlGroup, upsMIB=upsMIB, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmGeneralFault=upsAlarmGeneralFault, upsObjects=upsObjects, upsOutput=upsOutput, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBasicControlGroup=upsBasicControlGroup, upsBypassFrequency=upsBypassFrequency, upsAlarmFanFailure=upsAlarmFanFailure, upsOutputPercentLoad=upsOutputPercentLoad, upsTestStartTime=upsTestStartTime, upsAlarmLowBattery=upsAlarmLowBattery, upsInputVoltage=upsInputVoltage, upsOutputVoltage=upsOutputVoltage, upsAlarm=upsAlarm, upsBypassPower=upsBypassPower, upsAlarmTestInProgress=upsAlarmTestInProgress, upsSubsetCompliance=upsSubsetCompliance, upsIdentManufacturer=upsIdentManufacturer, upsOutputLineIndex=upsOutputLineIndex, upsFullTestGroup=upsFullTestGroup, upsBypassCurrent=upsBypassCurrent, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsTestId=upsTestId, upsBypassNumLines=upsBypassNumLines, upsSubsetInputGroup=upsSubsetInputGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsOutputEntry=upsOutputEntry, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsConformance=upsConformance, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBasicOutputGroup=upsBasicOutputGroup, upsBasicCompliance=upsBasicCompliance, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmDepletedBattery=upsAlarmDepletedBattery, PositiveInteger=PositiveInteger, NonNegativeInteger=NonNegativeInteger, upsFullConfigGroup=upsFullConfigGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBypassTable=upsBypassTable, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTrapOnBattery=upsTrapOnBattery, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsWellKnownAlarms=upsWellKnownAlarms, upsBatteryTemperature=upsBatteryTemperature, upsTestResultsDetail=upsTestResultsDetail, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBattery=upsBattery, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBasicGroups=upsBasicGroups, upsInputLineBads=upsInputLineBads, upsInputFrequency=upsInputFrequency, upsFullOutputGroup=upsFullOutputGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBypassEntry=upsBypassEntry, upsOutputCurrent=upsOutputCurrent, upsBasicTestGroup=upsBasicTestGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmTempBad=upsAlarmTempBad, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmInputBad=upsAlarmInputBad, upsRebootWithDuration=upsRebootWithDuration, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBasicBatteryGroup=upsBasicBatteryGroup, upsFullIdentGroup=upsFullIdentGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarmId=upsAlarmId, upsInputTruePower=upsInputTruePower, upsInput=upsInput, upsInputEntry=upsInputEntry, upsGroups=upsGroups, upsSubsetControlGroup=upsSubsetControlGroup, upsBatteryStatus=upsBatteryStatus, upsBypass=upsBypass, upsInputCurrent=upsInputCurrent, upsControl=upsControl, upsIdentName=upsIdentName, upsIdent=upsIdent, upsConfigInputFreq=upsConfigInputFreq, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBatteryCurrent=upsBatteryCurrent, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmBatteryBad=upsAlarmBatteryBad, upsFullAlarmGroup=upsFullAlarmGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsConfigOutputVoltage=upsConfigOutputVoltage, upsFullBatteryGroup=upsFullBatteryGroup, upsOutputNumLines=upsOutputNumLines, upsBatteryVoltage=upsBatteryVoltage, upsAlarmFuseFailure=upsAlarmFuseFailure, upsFullBypassGroup=upsFullBypassGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBypassLineIndex=upsBypassLineIndex, upsAlarmsPresent=upsAlarmsPresent, upsConfigOutputPower=upsConfigOutputPower, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsOutputPower=upsOutputPower, upsTraps=upsTraps, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsSubsetOutputGroup=upsSubsetOutputGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsShutdownType=upsShutdownType, upsInputTable=upsInputTable, upsFullCompliance=upsFullCompliance, upsBasicIdentGroup=upsBasicIdentGroup, upsWellKnownTests=upsWellKnownTests, upsInputNumLines=upsInputNumLines, upsOutputTable=upsOutputTable, upsAlarmEntry=upsAlarmEntry, upsTestResultsSummary=upsTestResultsSummary)
