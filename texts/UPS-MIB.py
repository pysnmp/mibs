...
TimeStamp, TestAndIncr, DisplayString, TimeInterval, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TestAndIncr", "DisplayString", "TimeInterval", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmTempBad=upsAlarmTempBad, upsInputNumLines=upsInputNumLines, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsConfig=upsConfig, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConfigInputVoltage=upsConfigInputVoltage, upsFullInputGroup=upsFullInputGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsMIB=upsMIB, upsBasicControlGroup=upsBasicControlGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsBasicGroups=upsBasicGroups, upsConformance=upsConformance, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsOutputSource=upsOutputSource, upsBypassTable=upsBypassTable, upsBasicCompliance=upsBasicCompliance, upsAlarmId=upsAlarmId, upsSubsetCompliance=upsSubsetCompliance, upsStartupAfterDelay=upsStartupAfterDelay, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConfigOutputVA=upsConfigOutputVA, upsBypassVoltage=upsBypassVoltage, upsFullTestGroup=upsFullTestGroup, PositiveInteger=PositiveInteger, upsFullConfigGroup=upsFullConfigGroup, upsInputVoltage=upsInputVoltage, upsIdentName=upsIdentName, upsFullCompliance=upsFullCompliance, upsInputFrequency=upsInputFrequency, upsAlarmInputBad=upsAlarmInputBad, upsAlarmsPresent=upsAlarmsPresent, upsInputLineBads=upsInputLineBads, upsTestElapsedTime=upsTestElapsedTime, upsCompliances=upsCompliances, upsInputTruePower=upsInputTruePower, upsFullGroups=upsFullGroups, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAutoRestart=upsAutoRestart, upsInput=upsInput, upsConfigInputFreq=upsConfigInputFreq, upsAlarmTime=upsAlarmTime, upsSubsetInputGroup=upsSubsetInputGroup, upsFullIdentGroup=upsFullIdentGroup, upsConfigLowBattTime=upsConfigLowBattTime, upsBasicInputGroup=upsBasicInputGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmOutputBad=upsAlarmOutputBad, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBasicOutputGroup=upsBasicOutputGroup, PYSNMP_MODULE_ID=upsMIB, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConfigOutputPower=upsConfigOutputPower, upsSubsetControlGroup=upsSubsetControlGroup, upsBatteryTemperature=upsBatteryTemperature, upsOutputPower=upsOutputPower, upsConfigOutputVoltage=upsConfigOutputVoltage, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmDescr=upsAlarmDescr, upsFullControlGroup=upsFullControlGroup, upsRebootWithDuration=upsRebootWithDuration, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTestSpinLock=upsTestSpinLock, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmTable=upsAlarmTable, upsTrapOnBattery=upsTrapOnBattery, upsTestResultsSummary=upsTestResultsSummary, upsGroups=upsGroups, upsWellKnownTests=upsWellKnownTests, upsBypassNumLines=upsBypassNumLines, upsAlarmLowBattery=upsAlarmLowBattery, upsFullBypassGroup=upsFullBypassGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsOutputTable=upsOutputTable, upsAlarmFanFailure=upsAlarmFanFailure, upsTest=upsTest, upsAlarmBatteryBad=upsAlarmBatteryBad, upsControl=upsControl, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, NonNegativeInteger=NonNegativeInteger, upsInputCurrent=upsInputCurrent, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsInputTable=upsInputTable, upsTestStartTime=upsTestStartTime, upsBypassLineIndex=upsBypassLineIndex, upsWellKnownAlarms=upsWellKnownAlarms, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsBypassPower=upsBypassPower, upsBypass=upsBypass, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmBypassBad=upsAlarmBypassBad, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBasicConfigGroup=upsBasicConfigGroup, upsOutputNumLines=upsOutputNumLines, upsIdentModel=upsIdentModel, upsConfigOutputFreq=upsConfigOutputFreq, upsFullAlarmGroup=upsFullAlarmGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsSubsetGroups=upsSubsetGroups, upsBatteryCurrent=upsBatteryCurrent, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBasicBypassGroup=upsBasicBypassGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsInputLineIndex=upsInputLineIndex, upsOutput=upsOutput, upsOutputEntry=upsOutputEntry, upsBatteryVoltage=upsBatteryVoltage, upsIdentManufacturer=upsIdentManufacturer, upsBasicTestGroup=upsBasicTestGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsShutdownType=upsShutdownType, upsBatteryStatus=upsBatteryStatus, upsOutputCurrent=upsOutputCurrent, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsAlarm=upsAlarm, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBypassFrequency=upsBypassFrequency, upsAlarmGeneralFault=upsAlarmGeneralFault, upsOutputFrequency=upsOutputFrequency, upsOutputLineIndex=upsOutputLineIndex, upsAlarmShutdownPending=upsAlarmShutdownPending, upsInputEntry=upsInputEntry, upsAlarmOutputOverload=upsAlarmOutputOverload, upsTestResultsDetail=upsTestResultsDetail, upsFullOutputGroup=upsFullOutputGroup, upsAlarmEntry=upsAlarmEntry, upsOutputVoltage=upsOutputVoltage, upsBasicIdentGroup=upsBasicIdentGroup, upsTestId=upsTestId, upsObjects=upsObjects, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBattery=upsBattery, upsTraps=upsTraps, upsIdent=upsIdent, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBypassEntry=upsBypassEntry, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBypassCurrent=upsBypassCurrent)
