...
IpAddress, Gauge32, ModuleIdentity, mib_2, ObjectIdentity, MibIdentifier, Counter64, iso, Bits, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "ModuleIdentity", "mib-2", "ObjectIdentity", "MibIdentifier", "Counter64", "iso", "Bits", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("UPS-MIB", upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsGroups=upsGroups, upsWellKnownAlarms=upsWellKnownAlarms, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTestStartTime=upsTestStartTime, upsConfig=upsConfig, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmTable=upsAlarmTable, upsTestResultsSummary=upsTestResultsSummary, upsFullGroups=upsFullGroups, upsOutputPower=upsOutputPower, upsInputVoltage=upsInputVoltage, upsBasicBatteryGroup=upsBasicBatteryGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsOutputEntry=upsOutputEntry, upsInputTruePower=upsInputTruePower, PYSNMP_MODULE_ID=upsMIB, upsCompliances=upsCompliances, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBatteryCurrent=upsBatteryCurrent, upsConfigOutputFreq=upsConfigOutputFreq, upsIdent=upsIdent, NonNegativeInteger=NonNegativeInteger, upsBattery=upsBattery, upsBypassLineIndex=upsBypassLineIndex, upsSubsetInputGroup=upsSubsetInputGroup, upsMIB=upsMIB, upsAlarmOutputBad=upsAlarmOutputBad, upsTrapOnBattery=upsTrapOnBattery, upsTestElapsedTime=upsTestElapsedTime, upsBasicAlarmGroup=upsBasicAlarmGroup, upsInputTable=upsInputTable, upsInputLineBads=upsInputLineBads, upsConfigOutputPower=upsConfigOutputPower, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsRebootWithDuration=upsRebootWithDuration, upsBasicInputGroup=upsBasicInputGroup, upsConfigAudibleStatus=upsConfigAudibleStatus, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmId=upsAlarmId, upsBypassPower=upsBypassPower, upsInputNumLines=upsInputNumLines, upsBypassNumLines=upsBypassNumLines, upsBasicTestGroup=upsBasicTestGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsFullTestGroup=upsFullTestGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsWellKnownTests=upsWellKnownTests, upsOutputLineIndex=upsOutputLineIndex, upsOutputPercentLoad=upsOutputPercentLoad, upsFullIdentGroup=upsFullIdentGroup, upsBypassTable=upsBypassTable, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsConfigInputFreq=upsConfigInputFreq, upsTrapTestCompleted=upsTrapTestCompleted, upsSubsetGroups=upsSubsetGroups, upsBypassVoltage=upsBypassVoltage, upsSecondsOnBattery=upsSecondsOnBattery, upsBypassEntry=upsBypassEntry, upsAlarm=upsAlarm, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmEntry=upsAlarmEntry, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsSubsetCompliance=upsSubsetCompliance, upsIdentManufacturer=upsIdentManufacturer, upsFullControlGroup=upsFullControlGroup, upsInputFrequency=upsInputFrequency, upsBypassCurrent=upsBypassCurrent, upsBasicCompliance=upsBasicCompliance, upsOutput=upsOutput, upsAlarmGeneralFault=upsAlarmGeneralFault, PositiveInteger=PositiveInteger, upsBatteryTemperature=upsBatteryTemperature, upsBypass=upsBypass, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsConformance=upsConformance, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsControl=upsControl, upsShutdownType=upsShutdownType, upsInput=upsInput, upsOutputTable=upsOutputTable, upsInputLineIndex=upsInputLineIndex, upsBasicGroups=upsBasicGroups, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConfigInputVoltage=upsConfigInputVoltage, upsSubsetOutputGroup=upsSubsetOutputGroup, upsIdentModel=upsIdentModel, upsFullBatteryGroup=upsFullBatteryGroup, upsConfigOutputVA=upsConfigOutputVA, upsAlarmsPresent=upsAlarmsPresent, upsFullConfigGroup=upsFullConfigGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsTestSpinLock=upsTestSpinLock, upsFullCompliance=upsFullCompliance, upsTraps=upsTraps, upsOutputNumLines=upsOutputNumLines, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicBypassGroup=upsBasicBypassGroup, upsOutputCurrent=upsOutputCurrent, upsStartupAfterDelay=upsStartupAfterDelay, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsBatteryStatus=upsBatteryStatus, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsShutdownAfterDelay=upsShutdownAfterDelay, upsFullInputGroup=upsFullInputGroup, upsAlarmTempBad=upsAlarmTempBad, upsTestId=upsTestId, upsTest=upsTest, upsFullOutputGroup=upsFullOutputGroup, upsAlarmTime=upsAlarmTime, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsOutputFrequency=upsOutputFrequency, upsObjects=upsObjects, upsAutoRestart=upsAutoRestart, upsBasicConfigGroup=upsBasicConfigGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsInputEntry=upsInputEntry, upsAlarmOnBattery=upsAlarmOnBattery, upsOutputSource=upsOutputSource, upsAlarmFuseFailure=upsAlarmFuseFailure, upsOutputVoltage=upsOutputVoltage, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsAlarmInputBad=upsAlarmInputBad, upsConfigLowBattTime=upsConfigLowBattTime, upsBatteryVoltage=upsBatteryVoltage, upsBypassFrequency=upsBypassFrequency, upsAlarmBypassBad=upsAlarmBypassBad, upsSubsetConfigGroup=upsSubsetConfigGroup, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicControlGroup=upsBasicControlGroup, upsAlarmDescr=upsAlarmDescr, upsFullBypassGroup=upsFullBypassGroup, upsIdentName=upsIdentName, upsTestResultsDetail=upsTestResultsDetail, upsAlarmShutdownPending=upsAlarmShutdownPending, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmTestInProgress=upsAlarmTestInProgress, upsInputCurrent=upsInputCurrent)
