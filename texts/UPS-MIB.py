...
# Produced by pysmi-1.1.11 at Wed Dec  6 02:58:26 2023
...
NotificationType, Gauge32, ObjectIdentity, MibIdentifier, Bits, Unsigned32, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, Counter64, iso, mib_2, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "ObjectIdentity", "MibIdentifier", "Bits", "Unsigned32", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "Counter64", "iso", "mib-2", "ModuleIdentity")
...
mibBuilder.exportSymbols("UPS-MIB", upsOutputSource=upsOutputSource, upsAlarmDescr=upsAlarmDescr, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsOutputTable=upsOutputTable, upsSubsetIdentGroup=upsSubsetIdentGroup, upsOutputVoltage=upsOutputVoltage, upsConfigInputVoltage=upsConfigInputVoltage, upsBatteryVoltage=upsBatteryVoltage, upsTestSpinLock=upsTestSpinLock, upsConfigInputFreq=upsConfigInputFreq, upsWellKnownTests=upsWellKnownTests, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsControl=upsControl, upsConfigOutputVoltage=upsConfigOutputVoltage, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmTempBad=upsAlarmTempBad, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBypassNumLines=upsBypassNumLines, upsAlarmOutputBad=upsAlarmOutputBad, upsTestElapsedTime=upsTestElapsedTime, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsFullTestGroup=upsFullTestGroup, upsOutputFrequency=upsOutputFrequency, upsOutputPercentLoad=upsOutputPercentLoad, upsBatteryCurrent=upsBatteryCurrent, upsAlarmId=upsAlarmId, upsSubsetControlGroup=upsSubsetControlGroup, upsInput=upsInput, upsBypassCurrent=upsBypassCurrent, upsInputEntry=upsInputEntry, upsFullAlarmGroup=upsFullAlarmGroup, upsGroups=upsGroups, upsInputNumLines=upsInputNumLines, upsFullGroups=upsFullGroups, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBasicGroups=upsBasicGroups, upsAutoRestart=upsAutoRestart, upsTest=upsTest, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmInputBad=upsAlarmInputBad, upsCompliances=upsCompliances, upsBasicControlGroup=upsBasicControlGroup, upsAlarm=upsAlarm, upsSubsetInputGroup=upsSubsetInputGroup, PYSNMP_MODULE_ID=upsMIB, upsInputLineIndex=upsInputLineIndex, upsAlarmOnBypass=upsAlarmOnBypass, upsBypassTable=upsBypassTable, upsOutputEntry=upsOutputEntry, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTestId=upsTestId, upsBatteryTemperature=upsBatteryTemperature, upsFullConfigGroup=upsFullConfigGroup, upsInputTruePower=upsInputTruePower, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmGeneralFault=upsAlarmGeneralFault, upsIdentModel=upsIdentModel, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsInputTable=upsInputTable, upsConformance=upsConformance, upsIdentAttachedDevices=upsIdentAttachedDevices, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsStartupAfterDelay=upsStartupAfterDelay, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBypassVoltage=upsBypassVoltage, upsBasicTestGroup=upsBasicTestGroup, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsInputCurrent=upsInputCurrent, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsInputVoltage=upsInputVoltage, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, PositiveInteger=PositiveInteger, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBasicConfigGroup=upsBasicConfigGroup, upsIdentManufacturer=upsIdentManufacturer, upsShutdownType=upsShutdownType, upsTestStartTime=upsTestStartTime, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmLowBattery=upsAlarmLowBattery, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBypassEntry=upsBypassEntry, upsConfigLowBattTime=upsConfigLowBattTime, upsBypassLineIndex=upsBypassLineIndex, upsFullCompliance=upsFullCompliance, upsFullIdentGroup=upsFullIdentGroup, upsSubsetCompliance=upsSubsetCompliance, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsFullBatteryGroup=upsFullBatteryGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsConfigOutputVA=upsConfigOutputVA, upsTrapOnBattery=upsTrapOnBattery, upsIdentName=upsIdentName, upsConfigOutputPower=upsConfigOutputPower, upsBatteryStatus=upsBatteryStatus, upsAlarmTestInProgress=upsAlarmTestInProgress, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsInputFrequency=upsInputFrequency, upsFullControlGroup=upsFullControlGroup, upsBasicBypassGroup=upsBasicBypassGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsTestResultsDetail=upsTestResultsDetail, upsBasicInputGroup=upsBasicInputGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsObjects=upsObjects, upsOutputPower=upsOutputPower, upsAlarmChargerFailed=upsAlarmChargerFailed, upsTestResultsSummary=upsTestResultsSummary, upsFullInputGroup=upsFullInputGroup, NonNegativeInteger=NonNegativeInteger, upsBypassFrequency=upsBypassFrequency, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsInputLineBads=upsInputLineBads, upsSubsetGroups=upsSubsetGroups, upsFullOutputGroup=upsFullOutputGroup, upsRebootWithDuration=upsRebootWithDuration, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmFanFailure=upsAlarmFanFailure, upsAlarmsPresent=upsAlarmsPresent, upsAlarmEntry=upsAlarmEntry, upsConfigAudibleStatus=upsConfigAudibleStatus, upsOutput=upsOutput, upsBypassPower=upsBypassPower, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsFullBypassGroup=upsFullBypassGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmTime=upsAlarmTime, upsMIB=upsMIB, upsBypass=upsBypass, upsOutputNumLines=upsOutputNumLines, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmTable=upsAlarmTable, upsOutputLineIndex=upsOutputLineIndex, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsConfig=upsConfig, upsBasicCompliance=upsBasicCompliance, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsBattery=upsBattery, upsIdent=upsIdent, upsTraps=upsTraps, upsOutputCurrent=upsOutputCurrent)
