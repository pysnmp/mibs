...
Bits, Counter64, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, MibIdentifier, NotificationType, Counter32, ObjectIdentity, TimeTicks, Gauge32, ModuleIdentity, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "MibIdentifier", "NotificationType", "Counter32", "ObjectIdentity", "TimeTicks", "Gauge32", "ModuleIdentity", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmOnBypass=upsAlarmOnBypass, upsConformance=upsConformance, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsConfigOutputVA=upsConfigOutputVA, upsSubsetInputGroup=upsSubsetInputGroup, upsInputTable=upsInputTable, upsAlarmChargerFailed=upsAlarmChargerFailed, upsFullBatteryGroup=upsFullBatteryGroup, upsConfig=upsConfig, upsBasicOutputGroup=upsBasicOutputGroup, upsIdentManufacturer=upsIdentManufacturer, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsInputTruePower=upsInputTruePower, upsBypassFrequency=upsBypassFrequency, upsTestResultsSummary=upsTestResultsSummary, upsInputVoltage=upsInputVoltage, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTestId=upsTestId, upsAlarmTempBad=upsAlarmTempBad, upsBasicIdentGroup=upsBasicIdentGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsBypassEntry=upsBypassEntry, upsConfigInputFreq=upsConfigInputFreq, upsSecondsOnBattery=upsSecondsOnBattery, upsFullCompliance=upsFullCompliance, upsBattery=upsBattery, upsAlarmDescr=upsAlarmDescr, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsFullConfigGroup=upsFullConfigGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsIdent=upsIdent, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBypassPower=upsBypassPower, upsShutdownType=upsShutdownType, upsSubsetConfigGroup=upsSubsetConfigGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmId=upsAlarmId, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmOutputBad=upsAlarmOutputBad, upsFullGroups=upsFullGroups, upsFullBypassGroup=upsFullBypassGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsInputCurrent=upsInputCurrent, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsFullTestGroup=upsFullTestGroup, upsTestResultsDetail=upsTestResultsDetail, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmFanFailure=upsAlarmFanFailure, upsOutputEntry=upsOutputEntry, upsFullControlGroup=upsFullControlGroup, upsBypassLineIndex=upsBypassLineIndex, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBasicControlGroup=upsBasicControlGroup, upsOutputVoltage=upsOutputVoltage, upsBypassVoltage=upsBypassVoltage, upsAlarmShutdownPending=upsAlarmShutdownPending, upsWellKnownTests=upsWellKnownTests, upsInput=upsInput, upsConfigLowBattTime=upsConfigLowBattTime, upsBatteryStatus=upsBatteryStatus, upsAlarmTime=upsAlarmTime, upsConfigOutputFreq=upsConfigOutputFreq, upsWellKnownAlarms=upsWellKnownAlarms, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsOutputLineIndex=upsOutputLineIndex, upsAlarmOutputOverload=upsAlarmOutputOverload, upsInputNumLines=upsInputNumLines, upsBasicTestGroup=upsBasicTestGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsObjects=upsObjects, upsOutputTable=upsOutputTable, upsSubsetGroups=upsSubsetGroups, upsConfigAudibleStatus=upsConfigAudibleStatus, upsConfigOutputPower=upsConfigOutputPower, upsAlarmTestInProgress=upsAlarmTestInProgress, upsTestElapsedTime=upsTestElapsedTime, upsFullInputGroup=upsFullInputGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsAutoRestart=upsAutoRestart, upsAlarm=upsAlarm, upsOutputNumLines=upsOutputNumLines, upsConfigOutputVoltage=upsConfigOutputVoltage, upsInputLineIndex=upsInputLineIndex, upsControl=upsControl, upsMIB=upsMIB, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypassNumLines=upsBypassNumLines, upsBasicCompliance=upsBasicCompliance, upsAlarmInputBad=upsAlarmInputBad, upsIdentName=upsIdentName, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBasicGroups=upsBasicGroups, upsOutputFrequency=upsOutputFrequency, PYSNMP_MODULE_ID=upsMIB, upsInputLineBads=upsInputLineBads, upsBypass=upsBypass, upsAlarmBatteryBad=upsAlarmBatteryBad, upsTest=upsTest, NonNegativeInteger=NonNegativeInteger, upsOutput=upsOutput, upsTestSpinLock=upsTestSpinLock, upsOutputCurrent=upsOutputCurrent, upsTrapOnBattery=upsTrapOnBattery, upsAlarmsPresent=upsAlarmsPresent, upsBatteryVoltage=upsBatteryVoltage, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBypassCurrent=upsBypassCurrent, PositiveInteger=PositiveInteger, upsAlarmTable=upsAlarmTable, upsIdentModel=upsIdentModel, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmBypassBad=upsAlarmBypassBad, upsBasicBypassGroup=upsBasicBypassGroup, upsBasicAlarmGroup=upsBasicAlarmGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsFullIdentGroup=upsFullIdentGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmEntry=upsAlarmEntry, upsOutputSource=upsOutputSource, upsBatteryCurrent=upsBatteryCurrent, upsBasicInputGroup=upsBasicInputGroup, upsBatteryTemperature=upsBatteryTemperature, upsInputEntry=upsInputEntry, upsBypassTable=upsBypassTable, upsInputFrequency=upsInputFrequency, upsShutdownAfterDelay=upsShutdownAfterDelay, upsCompliances=upsCompliances, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmOnBattery=upsAlarmOnBattery, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBasicConfigGroup=upsBasicConfigGroup, upsTraps=upsTraps, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsOutputPercentLoad=upsOutputPercentLoad, upsRebootWithDuration=upsRebootWithDuration, upsFullOutputGroup=upsFullOutputGroup, upsSubsetCompliance=upsSubsetCompliance, upsGroups=upsGroups, upsOutputPower=upsOutputPower, upsTestStartTime=upsTestStartTime, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed)
