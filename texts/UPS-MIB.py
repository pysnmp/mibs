...
mibBuilder.exportSymbols("UPS-MIB", upsIdent=upsIdent, upsBasicBypassGroup=upsBasicBypassGroup, upsTestSpinLock=upsTestSpinLock, upsTestElapsedTime=upsTestElapsedTime, upsInputFrequency=upsInputFrequency, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmTime=upsAlarmTime, upsBatteryCurrent=upsBatteryCurrent, upsOutputSource=upsOutputSource, upsBypass=upsBypass, upsBypassVoltage=upsBypassVoltage, upsShutdownAfterDelay=upsShutdownAfterDelay, upsOutputPower=upsOutputPower, upsBasicControlGroup=upsBasicControlGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsWellKnownTests=upsWellKnownTests, upsAlarmEntry=upsAlarmEntry, upsStartupAfterDelay=upsStartupAfterDelay, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullControlGroup=upsFullControlGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmOnBypass=upsAlarmOnBypass, upsOutputNumLines=upsOutputNumLines, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBasicConfigGroup=upsBasicConfigGroup, upsCompliances=upsCompliances, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfigOutputVoltage=upsConfigOutputVoltage, upsFullCompliance=upsFullCompliance, upsBypassCurrent=upsBypassCurrent, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBypassLineIndex=upsBypassLineIndex, upsConfigOutputPower=upsConfigOutputPower, upsConfigLowBattTime=upsConfigLowBattTime, upsTestStartTime=upsTestStartTime, upsIdentAttachedDevices=upsIdentAttachedDevices, upsFullInputGroup=upsFullInputGroup, upsAlarmsPresent=upsAlarmsPresent, upsIdentManufacturer=upsIdentManufacturer, upsTestId=upsTestId, upsAlarmOutputOverload=upsAlarmOutputOverload, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsOutputLineIndex=upsOutputLineIndex, upsAlarmBatteryBad=upsAlarmBatteryBad, upsInputEntry=upsInputEntry, upsAlarmDescr=upsAlarmDescr, NonNegativeInteger=NonNegativeInteger, upsInputTruePower=upsInputTruePower, upsAlarmId=upsAlarmId, upsBasicGroups=upsBasicGroups, upsBasicInputGroup=upsBasicInputGroup, upsConfigInputFreq=upsConfigInputFreq, upsOutputVoltage=upsOutputVoltage, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsConfigAudibleStatus=upsConfigAudibleStatus, upsSubsetGroups=upsSubsetGroups, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsOutputFrequency=upsOutputFrequency, upsBatteryTemperature=upsBatteryTemperature, upsConformance=upsConformance, upsSecondsOnBattery=upsSecondsOnBattery, upsInput=upsInput, upsInputLineBads=upsInputLineBads, upsAlarmInputBad=upsAlarmInputBad, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBasicCompliance=upsBasicCompliance, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBasicTestGroup=upsBasicTestGroup, upsBypassPower=upsBypassPower, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTest=upsTest, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTrapTestCompleted=upsTrapTestCompleted, upsFullAlarmGroup=upsFullAlarmGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsBatteryVoltage=upsBatteryVoltage, upsBypassNumLines=upsBypassNumLines, upsControl=upsControl, upsFullConfigGroup=upsFullConfigGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBypassEntry=upsBypassEntry, PositiveInteger=PositiveInteger, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmGeneralFault=upsAlarmGeneralFault, upsFullTestGroup=upsFullTestGroup, upsAlarmFanFailure=upsAlarmFanFailure, upsRebootWithDuration=upsRebootWithDuration, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsInputLineIndex=upsInputLineIndex, upsGroups=upsGroups, upsSubsetCompliance=upsSubsetCompliance, upsInputTable=upsInputTable, upsOutput=upsOutput, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsConfig=upsConfig, upsIdentName=upsIdentName, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsTraps=upsTraps, upsOutputPercentLoad=upsOutputPercentLoad, upsConfigOutputVA=upsConfigOutputVA, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsConfigOutputFreq=upsConfigOutputFreq, upsMIB=upsMIB, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutputEntry=upsOutputEntry, upsOutputCurrent=upsOutputCurrent, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBasicIdentGroup=upsBasicIdentGroup, upsIdentModel=upsIdentModel, upsFullGroups=upsFullGroups, upsOutputTable=upsOutputTable, upsSubsetInputGroup=upsSubsetInputGroup, upsBatteryStatus=upsBatteryStatus, upsAlarmTempBad=upsAlarmTempBad, upsInputNumLines=upsInputNumLines, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, PYSNMP_MODULE_ID=upsMIB, upsBasicOutputGroup=upsBasicOutputGroup, upsTrapOnBattery=upsTrapOnBattery, upsTestResultsSummary=upsTestResultsSummary, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsConfigInputVoltage=upsConfigInputVoltage, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarm=upsAlarm, upsAlarmOnBattery=upsAlarmOnBattery, upsFullBatteryGroup=upsFullBatteryGroup, upsShutdownType=upsShutdownType, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmTable=upsAlarmTable, upsFullBypassGroup=upsFullBypassGroup, upsBattery=upsBattery, upsBypassTable=upsBypassTable, upsAutoRestart=upsAutoRestart, upsBypassFrequency=upsBypassFrequency, upsTestResultsDetail=upsTestResultsDetail, upsInputCurrent=upsInputCurrent, upsFullIdentGroup=upsFullIdentGroup, upsObjects=upsObjects, upsInputVoltage=upsInputVoltage, upsFullOutputGroup=upsFullOutputGroup)
