...
# Produced by pysmi-1.1.8 at Tue Feb  8 23:11:33 2022
...
mib_2, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, Counter64, MibIdentifier, NotificationType, Bits, TimeTicks, IpAddress, Integer32, Gauge32, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "Counter64", "MibIdentifier", "NotificationType", "Bits", "TimeTicks", "IpAddress", "Integer32", "Gauge32", "iso", "Counter32")
...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTestStartTime=upsTestStartTime, upsTraps=upsTraps, upsSubsetCompliance=upsSubsetCompliance, upsBasicBatteryGroup=upsBasicBatteryGroup, upsRebootWithDuration=upsRebootWithDuration, upsControl=upsControl, upsAlarmChargerFailed=upsAlarmChargerFailed, upsInputTruePower=upsInputTruePower, upsBatteryVoltage=upsBatteryVoltage, upsBatteryStatus=upsBatteryStatus, upsOutputTable=upsOutputTable, upsAlarmShutdownPending=upsAlarmShutdownPending, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsFullTestGroup=upsFullTestGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsConfigInputFreq=upsConfigInputFreq, upsFullIdentGroup=upsFullIdentGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmEntry=upsAlarmEntry, upsConfig=upsConfig, upsInputEntry=upsInputEntry, upsAlarmInputBad=upsAlarmInputBad, upsFullInputGroup=upsFullInputGroup, upsBypass=upsBypass, upsBypassLineIndex=upsBypassLineIndex, upsOutputPercentLoad=upsOutputPercentLoad, upsFullOutputGroup=upsFullOutputGroup, upsAlarmTable=upsAlarmTable, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsTestResultsDetail=upsTestResultsDetail, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBypassCurrent=upsBypassCurrent, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsOutput=upsOutput, upsOutputVoltage=upsOutputVoltage, upsCompliances=upsCompliances, NonNegativeInteger=NonNegativeInteger, upsOutputPower=upsOutputPower, upsOutputSource=upsOutputSource, upsAlarmOutputBad=upsAlarmOutputBad, upsIdentName=upsIdentName, upsBasicTestGroup=upsBasicTestGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsInputCurrent=upsInputCurrent, upsAlarmOnBypass=upsAlarmOnBypass, upsAlarmTime=upsAlarmTime, upsAlarmFanFailure=upsAlarmFanFailure, upsInputFrequency=upsInputFrequency, upsTest=upsTest, upsInputTable=upsInputTable, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsWellKnownTests=upsWellKnownTests, PositiveInteger=PositiveInteger, upsBatteryCurrent=upsBatteryCurrent, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmBatteryBad=upsAlarmBatteryBad, upsOutputNumLines=upsOutputNumLines, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAutoRestart=upsAutoRestart, upsMIB=upsMIB, upsFullGroups=upsFullGroups, PYSNMP_MODULE_ID=upsMIB, upsTestElapsedTime=upsTestElapsedTime, upsConfigOutputVA=upsConfigOutputVA, upsBypassTable=upsBypassTable, upsAlarmGeneralFault=upsAlarmGeneralFault, upsOutputFrequency=upsOutputFrequency, upsSubsetInputGroup=upsSubsetInputGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsOutputCurrent=upsOutputCurrent, upsStartupAfterDelay=upsStartupAfterDelay, upsBasicGroups=upsBasicGroups, upsIdentManufacturer=upsIdentManufacturer, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmsPresent=upsAlarmsPresent, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfigInputVoltage=upsConfigInputVoltage, upsOutputEntry=upsOutputEntry, upsTestId=upsTestId, upsBypassPower=upsBypassPower, upsBasicOutputGroup=upsBasicOutputGroup, upsInputLineIndex=upsInputLineIndex, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBasicAlarmGroup=upsBasicAlarmGroup, upsFullBypassGroup=upsFullBypassGroup, upsAlarmFuseFailure=upsAlarmFuseFailure, upsInputNumLines=upsInputNumLines, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBasicCompliance=upsBasicCompliance, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmTempBad=upsAlarmTempBad, upsTrapOnBattery=upsTrapOnBattery, upsTestSpinLock=upsTestSpinLock, upsBasicInputGroup=upsBasicInputGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsObjects=upsObjects, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsFullCompliance=upsFullCompliance, upsShutdownType=upsShutdownType, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsIdentModel=upsIdentModel, upsBypassEntry=upsBypassEntry, upsBasicBypassGroup=upsBasicBypassGroup, upsInputLineBads=upsInputLineBads, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsIdent=upsIdent, upsGroups=upsGroups, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsFullBatteryGroup=upsFullBatteryGroup, upsInputVoltage=upsInputVoltage, upsAlarmId=upsAlarmId, upsBypassFrequency=upsBypassFrequency, upsConfigOutputVoltage=upsConfigOutputVoltage, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBattery=upsBattery, upsBypassVoltage=upsBypassVoltage, upsSubsetGroups=upsSubsetGroups, upsShutdownAfterDelay=upsShutdownAfterDelay, upsInput=upsInput, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBatteryTemperature=upsBatteryTemperature, upsConformance=upsConformance, upsAlarmDescr=upsAlarmDescr, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarm=upsAlarm, upsSubsetControlGroup=upsSubsetControlGroup, upsFullControlGroup=upsFullControlGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsTestResultsSummary=upsTestResultsSummary, upsBasicControlGroup=upsBasicControlGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsFullAlarmGroup=upsFullAlarmGroup, upsBypassNumLines=upsBypassNumLines, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsOutputLineIndex=upsOutputLineIndex, upsFullConfigGroup=upsFullConfigGroup, upsConfigOutputPower=upsConfigOutputPower, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested)
