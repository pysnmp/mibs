...
# Produced by pysmi-1.1.8 at Mon Jan  2 13:45:51 2023
...
Gauge32, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, Counter32, iso, IpAddress, mib_2, Unsigned32, ObjectIdentity, ModuleIdentity, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "Counter32", "iso", "IpAddress", "mib-2", "Unsigned32", "ObjectIdentity", "ModuleIdentity", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsFullControlGroup=upsFullControlGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsRebootWithDuration=upsRebootWithDuration, upsShutdownType=upsShutdownType, upsGroups=upsGroups, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBatteryStatus=upsBatteryStatus, upsStartupAfterDelay=upsStartupAfterDelay, upsInputCurrent=upsInputCurrent, upsInputEntry=upsInputEntry, upsOutputPercentLoad=upsOutputPercentLoad, upsOutputVoltage=upsOutputVoltage, upsBypassCurrent=upsBypassCurrent, upsInput=upsInput, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsFullCompliance=upsFullCompliance, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsInputTruePower=upsInputTruePower, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmBypassBad=upsAlarmBypassBad, upsWellKnownTests=upsWellKnownTests, upsTestId=upsTestId, upsBasicGroups=upsBasicGroups, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsTraps=upsTraps, upsBatteryTemperature=upsBatteryTemperature, upsConfigOutputVA=upsConfigOutputVA, upsBasicControlGroup=upsBasicControlGroup, upsAlarm=upsAlarm, upsAlarmGeneralFault=upsAlarmGeneralFault, upsOutputNumLines=upsOutputNumLines, upsAlarmInputBad=upsAlarmInputBad, NonNegativeInteger=NonNegativeInteger, upsFullBypassGroup=upsFullBypassGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAlarmsPresent=upsAlarmsPresent, upsTestElapsedTime=upsTestElapsedTime, upsTrapOnBattery=upsTrapOnBattery, upsInputLineIndex=upsInputLineIndex, upsAlarmTable=upsAlarmTable, upsIdentAttachedDevices=upsIdentAttachedDevices, upsConfigInputVoltage=upsConfigInputVoltage, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsInputNumLines=upsInputNumLines, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsConfigOutputFreq=upsConfigOutputFreq, upsTestResultsSummary=upsTestResultsSummary, upsAlarmOutputBad=upsAlarmOutputBad, upsSubsetGroups=upsSubsetGroups, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsFullBatteryGroup=upsFullBatteryGroup, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsBasicBypassGroup=upsBasicBypassGroup, upsInputFrequency=upsInputFrequency, upsBypassLineIndex=upsBypassLineIndex, upsInputVoltage=upsInputVoltage, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsIdent=upsIdent, upsFullOutputGroup=upsFullOutputGroup, upsFullIdentGroup=upsFullIdentGroup, upsBypassTable=upsBypassTable, upsConfigOutputPower=upsConfigOutputPower, upsOutput=upsOutput, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsIdentName=upsIdentName, upsBatteryVoltage=upsBatteryVoltage, upsAlarmId=upsAlarmId, upsAlarmFanFailure=upsAlarmFanFailure, upsSubsetOutputGroup=upsSubsetOutputGroup, upsWellKnownAlarms=upsWellKnownAlarms, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsBypassNumLines=upsBypassNumLines, upsInputLineBads=upsInputLineBads, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBypass=upsBypass, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsAlarmLowBattery=upsAlarmLowBattery, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBattery=upsBattery, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBasicInputGroup=upsBasicInputGroup, upsInputTable=upsInputTable, upsIdentModel=upsIdentModel, upsTestStartTime=upsTestStartTime, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsOutputSource=upsOutputSource, upsTrapTestCompleted=upsTrapTestCompleted, upsOutputTable=upsOutputTable, upsTest=upsTest, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsOutputEntry=upsOutputEntry, upsAlarmDescr=upsAlarmDescr, PYSNMP_MODULE_ID=upsMIB, upsAlarmTime=upsAlarmTime, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmShutdownPending=upsAlarmShutdownPending, upsBasicOutputGroup=upsBasicOutputGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsSecondsOnBattery=upsSecondsOnBattery, upsOutputFrequency=upsOutputFrequency, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTestSpinLock=upsTestSpinLock, upsBypassFrequency=upsBypassFrequency, upsSubsetCompliance=upsSubsetCompliance, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBypassEntry=upsBypassEntry, upsIdentManufacturer=upsIdentManufacturer, upsOutputLineIndex=upsOutputLineIndex, upsConfig=upsConfig, upsFullTestGroup=upsFullTestGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsOutputCurrent=upsOutputCurrent, upsTestResultsDetail=upsTestResultsDetail, upsConfigInputFreq=upsConfigInputFreq, upsObjects=upsObjects, upsBypassPower=upsBypassPower, PositiveInteger=PositiveInteger, upsBypassVoltage=upsBypassVoltage, upsBasicTestGroup=upsBasicTestGroup, upsFullInputGroup=upsFullInputGroup, upsMIB=upsMIB, upsCompliances=upsCompliances, upsFullGroups=upsFullGroups, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsConformance=upsConformance, upsBasicCompliance=upsBasicCompliance, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmEntry=upsAlarmEntry, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBatteryCurrent=upsBatteryCurrent, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAutoRestart=upsAutoRestart, upsBasicBatteryGroup=upsBasicBatteryGroup, upsFullConfigGroup=upsFullConfigGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmTempBad=upsAlarmTempBad, upsControl=upsControl, upsOutputPower=upsOutputPower, upsAlarmFuseFailure=upsAlarmFuseFailure, upsSubsetBatteryGroup=upsSubsetBatteryGroup)
