...
# Produced by pysmi-1.1.8 at Wed Oct 11 11:20:24 2023
...
mibBuilder.exportSymbols("UPS-MIB", upsTest=upsTest, upsBatteryVoltage=upsBatteryVoltage, upsConfigOutputVA=upsConfigOutputVA, upsBasicConfigGroup=upsBasicConfigGroup, upsBasicControlGroup=upsBasicControlGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsBasicCompliance=upsBasicCompliance, upsFullGroups=upsFullGroups, upsInputTruePower=upsInputTruePower, upsBypassPower=upsBypassPower, upsCompliances=upsCompliances, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsConformance=upsConformance, upsTestResultsDetail=upsTestResultsDetail, upsAlarmFanFailure=upsAlarmFanFailure, upsTrapTestCompleted=upsTrapTestCompleted, upsConfigOutputPower=upsConfigOutputPower, upsIdentManufacturer=upsIdentManufacturer, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsFullControlGroup=upsFullControlGroup, upsMIB=upsMIB, PYSNMP_MODULE_ID=upsMIB, upsAlarmDescr=upsAlarmDescr, upsInputVoltage=upsInputVoltage, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsBasicBypassGroup=upsBasicBypassGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmLowBattery=upsAlarmLowBattery, upsShutdownAfterDelay=upsShutdownAfterDelay, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsSubsetControlGroup=upsSubsetControlGroup, upsOutputNumLines=upsOutputNumLines, upsAlarmOnBypass=upsAlarmOnBypass, upsTestId=upsTestId, upsConfigAudibleStatus=upsConfigAudibleStatus, upsInputLineIndex=upsInputLineIndex, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsTrapOnBattery=upsTrapOnBattery, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBasicTestGroup=upsBasicTestGroup, upsFullConfigGroup=upsFullConfigGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsOutputSource=upsOutputSource, NonNegativeInteger=NonNegativeInteger, upsRebootWithDuration=upsRebootWithDuration, upsGroups=upsGroups, upsIdentAttachedDevices=upsIdentAttachedDevices, upsInput=upsInput, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsOutputPower=upsOutputPower, upsBypassVoltage=upsBypassVoltage, upsAlarmId=upsAlarmId, upsBypassFrequency=upsBypassFrequency, upsFullInputGroup=upsFullInputGroup, upsBasicGroups=upsBasicGroups, upsConfigInputVoltage=upsConfigInputVoltage, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsTestStartTime=upsTestStartTime, upsBypassNumLines=upsBypassNumLines, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmTestInProgress=upsAlarmTestInProgress, upsConfigOutputFreq=upsConfigOutputFreq, upsBasicBatteryGroup=upsBasicBatteryGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsTraps=upsTraps, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsSubsetInputGroup=upsSubsetInputGroup, upsIdent=upsIdent, upsFullTestGroup=upsFullTestGroup, upsAlarm=upsAlarm, PositiveInteger=PositiveInteger, upsAlarmShutdownPending=upsAlarmShutdownPending, upsInputLineBads=upsInputLineBads, upsIdentModel=upsIdentModel, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmFuseFailure=upsAlarmFuseFailure, upsFullOutputGroup=upsFullOutputGroup, upsOutputFrequency=upsOutputFrequency, upsTestResultsSummary=upsTestResultsSummary, upsConfig=upsConfig, upsShutdownType=upsShutdownType, upsTestSpinLock=upsTestSpinLock, upsConfigLowBattTime=upsConfigLowBattTime, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmTime=upsAlarmTime, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsOutputVoltage=upsOutputVoltage, upsBypassTable=upsBypassTable, upsBypassLineIndex=upsBypassLineIndex, upsSubsetConfigGroup=upsSubsetConfigGroup, upsInputEntry=upsInputEntry, upsFullIdentGroup=upsFullIdentGroup, upsBatteryTemperature=upsBatteryTemperature, upsAlarmsPresent=upsAlarmsPresent, upsAlarmBypassBad=upsAlarmBypassBad, upsBasicOutputGroup=upsBasicOutputGroup, upsWellKnownTests=upsWellKnownTests, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBatteryCurrent=upsBatteryCurrent, upsOutputEntry=upsOutputEntry, upsOutputPercentLoad=upsOutputPercentLoad, upsWellKnownAlarms=upsWellKnownAlarms, upsControl=upsControl, upsAlarmTable=upsAlarmTable, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsIdentName=upsIdentName, upsBypassEntry=upsBypassEntry, upsBypassCurrent=upsBypassCurrent, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutputCurrent=upsOutputCurrent, upsInputNumLines=upsInputNumLines, upsFullBatteryGroup=upsFullBatteryGroup, upsBypass=upsBypass, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmGeneralFault=upsAlarmGeneralFault, upsOutputLineIndex=upsOutputLineIndex, upsTestElapsedTime=upsTestElapsedTime, upsAutoRestart=upsAutoRestart, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsInputTable=upsInputTable, upsConfigInputFreq=upsConfigInputFreq, upsBasicIdentGroup=upsBasicIdentGroup, upsBasicInputGroup=upsBasicInputGroup, upsFullBypassGroup=upsFullBypassGroup, upsSubsetGroups=upsSubsetGroups, upsObjects=upsObjects, upsStartupAfterDelay=upsStartupAfterDelay, upsInputCurrent=upsInputCurrent, upsAlarmTempBad=upsAlarmTempBad, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBatteryStatus=upsBatteryStatus, upsOutputTable=upsOutputTable, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBattery=upsBattery, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmEntry=upsAlarmEntry, upsFullCompliance=upsFullCompliance, upsOutput=upsOutput, upsInputFrequency=upsInputFrequency, upsSubsetCompliance=upsSubsetCompliance, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmInputBad=upsAlarmInputBad, upsConfigOutputVoltage=upsConfigOutputVoltage, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion)
