...
# Produced by pysmi-1.1.10 at Mon Feb 19 02:54:11 2024
...
ModuleIdentity, mib_2, Integer32, IpAddress, Counter32, NotificationType, ObjectIdentity, iso, Gauge32, MibIdentifier, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "mib-2", "Integer32", "IpAddress", "Counter32", "NotificationType", "ObjectIdentity", "iso", "Gauge32", "MibIdentifier", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("UPS-MIB", upsConfigOutputFreq=upsConfigOutputFreq, upsBasicBypassGroup=upsBasicBypassGroup, upsTestSpinLock=upsTestSpinLock, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsSecondsOnBattery=upsSecondsOnBattery, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsOutputSource=upsOutputSource, upsBasicControlGroup=upsBasicControlGroup, upsRebootWithDuration=upsRebootWithDuration, upsConfigOutputPower=upsConfigOutputPower, upsTraps=upsTraps, upsFullOutputGroup=upsFullOutputGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsFullControlGroup=upsFullControlGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsShutdownType=upsShutdownType, upsTestResultsDetail=upsTestResultsDetail, upsBasicCompliance=upsBasicCompliance, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBasicTestGroup=upsBasicTestGroup, upsOutputCurrent=upsOutputCurrent, upsBypassEntry=upsBypassEntry, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsOutput=upsOutput, upsAutoRestart=upsAutoRestart, upsAlarmInputBad=upsAlarmInputBad, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsOutputNumLines=upsOutputNumLines, upsConfigAudibleStatus=upsConfigAudibleStatus, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsAlarmEntry=upsAlarmEntry, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAlarmTable=upsAlarmTable, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsOutputEntry=upsOutputEntry, upsAlarmTempBad=upsAlarmTempBad, upsInputLineIndex=upsInputLineIndex, upsOutputFrequency=upsOutputFrequency, upsOutputPercentLoad=upsOutputPercentLoad, upsShutdownAfterDelay=upsShutdownAfterDelay, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBypassFrequency=upsBypassFrequency, upsTestStartTime=upsTestStartTime, upsSubsetControlGroup=upsSubsetControlGroup, upsConfigOutputVoltage=upsConfigOutputVoltage, upsInputTruePower=upsInputTruePower, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsBatteryCurrent=upsBatteryCurrent, upsInputVoltage=upsInputVoltage, upsFullAlarmGroup=upsFullAlarmGroup, upsControl=upsControl, upsSubsetInputGroup=upsSubsetInputGroup, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmsPresent=upsAlarmsPresent, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsBypass=upsBypass, upsFullIdentGroup=upsFullIdentGroup, upsAlarmId=upsAlarmId, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsBasicConfigGroup=upsBasicConfigGroup, upsFullTestGroup=upsFullTestGroup, PositiveInteger=PositiveInteger, upsTrapOnBattery=upsTrapOnBattery, upsIdentManufacturer=upsIdentManufacturer, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsInputCurrent=upsInputCurrent, upsAlarmTime=upsAlarmTime, upsConfigInputFreq=upsConfigInputFreq, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsOutputVoltage=upsOutputVoltage, upsWellKnownTests=upsWellKnownTests, upsIdent=upsIdent, upsInputTable=upsInputTable, upsBasicInputGroup=upsBasicInputGroup, upsSubsetGroups=upsSubsetGroups, upsAlarmChargerFailed=upsAlarmChargerFailed, upsAlarmOutputOverload=upsAlarmOutputOverload, upsStartupAfterDelay=upsStartupAfterDelay, upsOutputTable=upsOutputTable, upsAlarmFuseFailure=upsAlarmFuseFailure, upsConfigOutputVA=upsConfigOutputVA, upsTrapTestCompleted=upsTrapTestCompleted, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsInputEntry=upsInputEntry, upsInput=upsInput, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsFullCompliance=upsFullCompliance, upsInputNumLines=upsInputNumLines, upsFullBatteryGroup=upsFullBatteryGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsFullGroups=upsFullGroups, upsAlarmBypassBad=upsAlarmBypassBad, upsAlarmOutputBad=upsAlarmOutputBad, upsOutputLineIndex=upsOutputLineIndex, upsBypassLineIndex=upsBypassLineIndex, upsAlarmFanFailure=upsAlarmFanFailure, upsBasicBatteryGroup=upsBasicBatteryGroup, upsFullInputGroup=upsFullInputGroup, upsConfig=upsConfig, upsAlarmLowBattery=upsAlarmLowBattery, upsConfigLowBattTime=upsConfigLowBattTime, upsBypassCurrent=upsBypassCurrent, upsIdentAttachedDevices=upsIdentAttachedDevices, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBasicIdentGroup=upsBasicIdentGroup, upsGroups=upsGroups, upsFullBypassGroup=upsFullBypassGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsSubsetCompliance=upsSubsetCompliance, upsTestResultsSummary=upsTestResultsSummary, upsBasicAlarmGroup=upsBasicAlarmGroup, upsBattery=upsBattery, upsInputFrequency=upsInputFrequency, upsAlarmBatteryBad=upsAlarmBatteryBad, upsIdentModel=upsIdentModel, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBypassTable=upsBypassTable, upsBatteryVoltage=upsBatteryVoltage, upsAlarmOnBattery=upsAlarmOnBattery, upsBasicOutputGroup=upsBasicOutputGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsFullConfigGroup=upsFullConfigGroup, upsBatteryTemperature=upsBatteryTemperature, upsBypassPower=upsBypassPower, upsBasicGroups=upsBasicGroups, upsObjects=upsObjects, upsBatteryStatus=upsBatteryStatus, PYSNMP_MODULE_ID=upsMIB, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTest=upsTest, upsTestId=upsTestId, upsAlarm=upsAlarm, upsBypassVoltage=upsBypassVoltage, upsConformance=upsConformance, upsAlarmDescr=upsAlarmDescr, upsMIB=upsMIB, NonNegativeInteger=NonNegativeInteger, upsIdentName=upsIdentName, upsInputLineBads=upsInputLineBads, upsOutputPower=upsOutputPower, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsBypassNumLines=upsBypassNumLines, upsTestElapsedTime=upsTestElapsedTime, upsCompliances=upsCompliances)
