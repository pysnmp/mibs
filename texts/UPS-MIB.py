...
mibBuilder.exportSymbols("UPS-MIB", upsInputLineIndex=upsInputLineIndex, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmBatteryBad=upsAlarmBatteryBad, upsGroups=upsGroups, upsTestId=upsTestId, upsAlarmOutputOverload=upsAlarmOutputOverload, upsInputEntry=upsInputEntry, upsConfigOutputVA=upsConfigOutputVA, upsFullBypassGroup=upsFullBypassGroup, upsAlarmEntry=upsAlarmEntry, upsRebootWithDuration=upsRebootWithDuration, upsConfigOutputPower=upsConfigOutputPower, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsSubsetOutputGroup=upsSubsetOutputGroup, upsAutoRestart=upsAutoRestart, upsBasicOutputGroup=upsBasicOutputGroup, upsBatteryCurrent=upsBatteryCurrent, upsBypassTable=upsBypassTable, upsAlarmOnBattery=upsAlarmOnBattery, upsTestSpinLock=upsTestSpinLock, upsSubsetCompliance=upsSubsetCompliance, upsBatteryStatus=upsBatteryStatus, upsFullOutputGroup=upsFullOutputGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmTime=upsAlarmTime, upsAlarmLowBattery=upsAlarmLowBattery, upsSubsetGroups=upsSubsetGroups, upsSubsetConfigGroup=upsSubsetConfigGroup, upsAlarmInputBad=upsAlarmInputBad, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmDescr=upsAlarmDescr, upsOutputEntry=upsOutputEntry, upsAlarmTempBad=upsAlarmTempBad, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsAlarmTable=upsAlarmTable, PYSNMP_MODULE_ID=upsMIB, upsConfigLowBattTime=upsConfigLowBattTime, upsTestResultsSummary=upsTestResultsSummary, upsTraps=upsTraps, upsBasicConfigGroup=upsBasicConfigGroup, upsInputVoltage=upsInputVoltage, upsAlarmsPresent=upsAlarmsPresent, upsFullAlarmGroup=upsFullAlarmGroup, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsOutputCurrent=upsOutputCurrent, upsBypassFrequency=upsBypassFrequency, upsFullInputGroup=upsFullInputGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsConfigInputVoltage=upsConfigInputVoltage, upsBatteryVoltage=upsBatteryVoltage, upsBypassEntry=upsBypassEntry, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsInput=upsInput, upsBypassVoltage=upsBypassVoltage, upsInputCurrent=upsInputCurrent, upsTestElapsedTime=upsTestElapsedTime, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsSecondsOnBattery=upsSecondsOnBattery, upsConfigOutputFreq=upsConfigOutputFreq, upsBasicTestGroup=upsBasicTestGroup, upsAlarmOnBypass=upsAlarmOnBypass, upsInputTruePower=upsInputTruePower, upsTrapTestCompleted=upsTrapTestCompleted, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBasicBatteryGroup=upsBasicBatteryGroup, upsConfigInputFreq=upsConfigInputFreq, upsFullIdentGroup=upsFullIdentGroup, NonNegativeInteger=NonNegativeInteger, upsOutputPower=upsOutputPower, upsBattery=upsBattery, upsAlarmFuseFailure=upsAlarmFuseFailure, upsControl=upsControl, upsWellKnownTests=upsWellKnownTests, upsBasicCompliance=upsBasicCompliance, upsFullControlGroup=upsFullControlGroup, upsInputLineBads=upsInputLineBads, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsOutputNumLines=upsOutputNumLines, upsBypass=upsBypass, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmBypassBad=upsAlarmBypassBad, upsCompliances=upsCompliances, upsConfig=upsConfig, upsConfigOutputVoltage=upsConfigOutputVoltage, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsConformance=upsConformance, upsTrapOnBattery=upsTrapOnBattery, upsInputNumLines=upsInputNumLines, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsObjects=upsObjects, upsBypassPower=upsBypassPower, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsBasicAlarmGroup=upsBasicAlarmGroup, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsIdentName=upsIdentName, upsOutputLineIndex=upsOutputLineIndex, upsOutputSource=upsOutputSource, upsSubsetControlGroup=upsSubsetControlGroup, upsTestStartTime=upsTestStartTime, upsBasicInputGroup=upsBasicInputGroup, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsMIB=upsMIB, upsIdent=upsIdent, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBasicGroups=upsBasicGroups, PositiveInteger=PositiveInteger, upsAlarmId=upsAlarmId, upsSubsetInputGroup=upsSubsetInputGroup, upsIdentModel=upsIdentModel, upsBatteryTemperature=upsBatteryTemperature, upsFullGroups=upsFullGroups, upsFullCompliance=upsFullCompliance, upsAlarmFanFailure=upsAlarmFanFailure, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsIdentManufacturer=upsIdentManufacturer, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsFullTestGroup=upsFullTestGroup, upsOutputTable=upsOutputTable, upsConfigAudibleStatus=upsConfigAudibleStatus, upsFullBatteryGroup=upsFullBatteryGroup, upsAlarm=upsAlarm, upsTest=upsTest, upsTestResultsDetail=upsTestResultsDetail, upsInputFrequency=upsInputFrequency, upsBypassCurrent=upsBypassCurrent, upsOutputFrequency=upsOutputFrequency, upsBypassLineIndex=upsBypassLineIndex, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsBypassNumLines=upsBypassNumLines, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBasicBypassGroup=upsBasicBypassGroup, upsOutputVoltage=upsOutputVoltage, upsShutdownType=upsShutdownType, upsBasicControlGroup=upsBasicControlGroup, upsInputTable=upsInputTable, upsOutput=upsOutput, upsAlarmTestInProgress=upsAlarmTestInProgress, upsFullConfigGroup=upsFullConfigGroup)
