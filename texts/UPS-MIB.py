...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:08:48 2024
...
MibIdentifier, ModuleIdentity, mib_2, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, Integer32, Counter32, IpAddress, Unsigned32, Bits, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "mib-2", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "Integer32", "Counter32", "IpAddress", "Unsigned32", "Bits", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsWellKnownTests=upsWellKnownTests, upsConfig=upsConfig, upsAlarmBypassBad=upsAlarmBypassBad, upsOutputCurrent=upsOutputCurrent, upsTest=upsTest, upsFullTestGroup=upsFullTestGroup, upsRebootWithDuration=upsRebootWithDuration, upsFullBypassGroup=upsFullBypassGroup, upsSubsetConfigGroup=upsSubsetConfigGroup, upsConfigInputFreq=upsConfigInputFreq, upsOutputEntry=upsOutputEntry, upsAlarmFuseFailure=upsAlarmFuseFailure, upsSubsetGroups=upsSubsetGroups, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsIdentModel=upsIdentModel, PositiveInteger=PositiveInteger, upsBatteryStatus=upsBatteryStatus, upsConfigOutputPower=upsConfigOutputPower, upsTestResultsDetail=upsTestResultsDetail, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsFullControlGroup=upsFullControlGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarm=upsAlarm, upsIdent=upsIdent, upsOutputVoltage=upsOutputVoltage, upsInput=upsInput, upsInputVoltage=upsInputVoltage, upsAlarmEntry=upsAlarmEntry, upsSubsetControlGroup=upsSubsetControlGroup, upsBasicIdentGroup=upsBasicIdentGroup, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsInputFrequency=upsInputFrequency, upsAlarmTime=upsAlarmTime, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmBatteryBad=upsAlarmBatteryBad, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsAlarmId=upsAlarmId, upsOutputLineIndex=upsOutputLineIndex, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmTable=upsAlarmTable, upsBasicGroups=upsBasicGroups, NonNegativeInteger=NonNegativeInteger, upsInputEntry=upsInputEntry, upsBasicControlGroup=upsBasicControlGroup, upsIdentAttachedDevices=upsIdentAttachedDevices, upsCompliances=upsCompliances, upsInputTruePower=upsInputTruePower, upsTestSpinLock=upsTestSpinLock, upsOutput=upsOutput, upsConfigInputVoltage=upsConfigInputVoltage, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsFullAlarmGroup=upsFullAlarmGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsInputLineIndex=upsInputLineIndex, upsBypassCurrent=upsBypassCurrent, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsBasicBatteryGroup=upsBasicBatteryGroup, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsInputNumLines=upsInputNumLines, upsAlarmInputBad=upsAlarmInputBad, upsBypass=upsBypass, upsControl=upsControl, upsFullGroups=upsFullGroups, upsAlarmOnBattery=upsAlarmOnBattery, upsBatteryCurrent=upsBatteryCurrent, upsGroups=upsGroups, upsWellKnownAlarms=upsWellKnownAlarms, upsBatteryVoltage=upsBatteryVoltage, upsOutputSource=upsOutputSource, upsInputLineBads=upsInputLineBads, upsAlarmFanFailure=upsAlarmFanFailure, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsConfigOutputVA=upsConfigOutputVA, upsFullConfigGroup=upsFullConfigGroup, upsSecondsOnBattery=upsSecondsOnBattery, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsInputTable=upsInputTable, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsTrapOnBattery=upsTrapOnBattery, upsOutputTable=upsOutputTable, upsBasicBypassGroup=upsBasicBypassGroup, upsBypassNumLines=upsBypassNumLines, upsTestStartTime=upsTestStartTime, upsShutdownType=upsShutdownType, upsObjects=upsObjects, upsTrapTestCompleted=upsTrapTestCompleted, upsFullIdentGroup=upsFullIdentGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsAutoRestart=upsAutoRestart, upsTestNoTestsInitiated=upsTestNoTestsInitiated, PYSNMP_MODULE_ID=upsMIB, upsTraps=upsTraps, upsShutdownAfterDelay=upsShutdownAfterDelay, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsInputCurrent=upsInputCurrent, upsOutputPower=upsOutputPower, upsFullOutputGroup=upsFullOutputGroup, upsBatteryTemperature=upsBatteryTemperature, upsBasicCompliance=upsBasicCompliance, upsFullInputGroup=upsFullInputGroup, upsBypassEntry=upsBypassEntry, upsBypassVoltage=upsBypassVoltage, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsAlarmsPresent=upsAlarmsPresent, upsTestResultsSummary=upsTestResultsSummary, upsBasicTestGroup=upsBasicTestGroup, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmOutputBad=upsAlarmOutputBad, upsFullBatteryGroup=upsFullBatteryGroup, upsOutputFrequency=upsOutputFrequency, upsBasicOutputGroup=upsBasicOutputGroup, upsOutputNumLines=upsOutputNumLines, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmLowBattery=upsAlarmLowBattery, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBypassPower=upsBypassPower, upsAlarmOnBypass=upsAlarmOnBypass, upsBasicInputGroup=upsBasicInputGroup, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsBypassTable=upsBypassTable, upsOutputPercentLoad=upsOutputPercentLoad, upsFullCompliance=upsFullCompliance, upsTestId=upsTestId, upsIdentManufacturer=upsIdentManufacturer, upsTestElapsedTime=upsTestElapsedTime, upsStartupAfterDelay=upsStartupAfterDelay, upsSubsetOutputGroup=upsSubsetOutputGroup, upsSubsetInputGroup=upsSubsetInputGroup, upsBattery=upsBattery, upsBypassFrequency=upsBypassFrequency, upsAlarmDescr=upsAlarmDescr, upsIdentName=upsIdentName, upsAlarmTempBad=upsAlarmTempBad, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsAlarmChargerFailed=upsAlarmChargerFailed, upsConfigOutputVoltage=upsConfigOutputVoltage, upsSubsetCompliance=upsSubsetCompliance, upsMIB=upsMIB, upsBypassLineIndex=upsBypassLineIndex, upsConformance=upsConformance)
