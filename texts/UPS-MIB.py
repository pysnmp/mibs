...
Bits, ModuleIdentity, MibIdentifier, TimeTicks, Counter64, Gauge32, ObjectIdentity, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, mib_2, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Counter64", "Gauge32", "ObjectIdentity", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "mib-2", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("UPS-MIB", upsInputCurrent=upsInputCurrent, upsTestElapsedTime=upsTestElapsedTime, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmTable=upsAlarmTable, upsAlarmFanFailure=upsAlarmFanFailure, upsBatteryCurrent=upsBatteryCurrent, upsFullAlarmGroup=upsFullAlarmGroup, upsOutputFrequency=upsOutputFrequency, upsBypassFrequency=upsBypassFrequency, upsBasicAlarmGroup=upsBasicAlarmGroup, upsFullBypassGroup=upsFullBypassGroup, upsAlarm=upsAlarm, upsFullConfigGroup=upsFullConfigGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsFullCompliance=upsFullCompliance, PYSNMP_MODULE_ID=upsMIB, upsBypassTable=upsBypassTable, upsObjects=upsObjects, upsOutputNumLines=upsOutputNumLines, upsConfigOutputFreq=upsConfigOutputFreq, upsConfigOutputPower=upsConfigOutputPower, upsOutputSource=upsOutputSource, upsAlarmId=upsAlarmId, upsBatteryTemperature=upsBatteryTemperature, upsSecondsOnBattery=upsSecondsOnBattery, upsBypassNumLines=upsBypassNumLines, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsTestSpinLock=upsTestSpinLock, upsBasicBatteryGroup=upsBasicBatteryGroup, upsOutputTable=upsOutputTable, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmTempBad=upsAlarmTempBad, upsInputEntry=upsInputEntry, upsWellKnownAlarms=upsWellKnownAlarms, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsConfigInputVoltage=upsConfigInputVoltage, upsRebootWithDuration=upsRebootWithDuration, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsInputNumLines=upsInputNumLines, upsAutoRestart=upsAutoRestart, upsAlarmOnBypass=upsAlarmOnBypass, upsConformance=upsConformance, upsBasicCompliance=upsBasicCompliance, upsBasicBypassGroup=upsBasicBypassGroup, upsSubsetIdentGroup=upsSubsetIdentGroup, upsOutputLineIndex=upsOutputLineIndex, upsTestId=upsTestId, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullBatteryGroup=upsFullBatteryGroup, upsOutputPower=upsOutputPower, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsInputTable=upsInputTable, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsShutdownAfterDelay=upsShutdownAfterDelay, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmOutputBad=upsAlarmOutputBad, upsTestResultsSummary=upsTestResultsSummary, upsAlarmOnBattery=upsAlarmOnBattery, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsBasicOutputGroup=upsBasicOutputGroup, upsTestStartTime=upsTestStartTime, upsIdentAttachedDevices=upsIdentAttachedDevices, upsBatteryStatus=upsBatteryStatus, upsBypassCurrent=upsBypassCurrent, upsShutdownType=upsShutdownType, upsInputVoltage=upsInputVoltage, upsConfigInputFreq=upsConfigInputFreq, upsAlarmInputBad=upsAlarmInputBad, upsIdentName=upsIdentName, upsTrapOnBattery=upsTrapOnBattery, upsFullTestGroup=upsFullTestGroup, upsInputTruePower=upsInputTruePower, upsAlarmGeneralFault=upsAlarmGeneralFault, upsAlarmEntry=upsAlarmEntry, upsConfigLowBattTime=upsConfigLowBattTime, upsAlarmShutdownPending=upsAlarmShutdownPending, upsAlarmOutputOverload=upsAlarmOutputOverload, upsFullControlGroup=upsFullControlGroup, upsBasicGroups=upsBasicGroups, upsBattery=upsBattery, upsOutputPercentLoad=upsOutputPercentLoad, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsOutputEntry=upsOutputEntry, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBypassLineIndex=upsBypassLineIndex, upsConfigOutputVoltage=upsConfigOutputVoltage, upsBasicInputGroup=upsBasicInputGroup, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsBypassVoltage=upsBypassVoltage, upsTraps=upsTraps, upsBasicControlGroup=upsBasicControlGroup, upsAlarmBypassBad=upsAlarmBypassBad, upsTrapTestCompleted=upsTrapTestCompleted, upsBypass=upsBypass, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsTest=upsTest, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsStartupAfterDelay=upsStartupAfterDelay, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsFullIdentGroup=upsFullIdentGroup, upsBypassPower=upsBypassPower, upsAlarmTime=upsAlarmTime, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsInputLineBads=upsInputLineBads, upsBatteryVoltage=upsBatteryVoltage, upsAlarmChargerFailed=upsAlarmChargerFailed, upsOutputCurrent=upsOutputCurrent, upsFullOutputGroup=upsFullOutputGroup, PositiveInteger=PositiveInteger, upsAlarmTestInProgress=upsAlarmTestInProgress, upsWellKnownTests=upsWellKnownTests, upsInput=upsInput, upsAlarmsPresent=upsAlarmsPresent, upsConfigOutputVA=upsConfigOutputVA, upsInputFrequency=upsInputFrequency, upsAlarmLowBattery=upsAlarmLowBattery, upsOutput=upsOutput, upsBypassEntry=upsBypassEntry, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsFullGroups=upsFullGroups, upsAlarmDescr=upsAlarmDescr, upsTestResultsDetail=upsTestResultsDetail, upsFullInputGroup=upsFullInputGroup, NonNegativeInteger=NonNegativeInteger, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmFuseFailure=upsAlarmFuseFailure, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsIdentModel=upsIdentModel, upsConfig=upsConfig, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsIdentManufacturer=upsIdentManufacturer, upsBasicTestGroup=upsBasicTestGroup, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsControl=upsControl, upsIdent=upsIdent, upsSubsetCompliance=upsSubsetCompliance, upsCompliances=upsCompliances, upsSubsetOutputGroup=upsSubsetOutputGroup, upsOutputVoltage=upsOutputVoltage, upsInputLineIndex=upsInputLineIndex, upsSubsetInputGroup=upsSubsetInputGroup, upsAlarmBatteryBad=upsAlarmBatteryBad, upsSubsetGroups=upsSubsetGroups, upsBasicIdentGroup=upsBasicIdentGroup, upsGroups=upsGroups, upsMIB=upsMIB)
