...
# Produced by pysmi-1.1.8 at Wed Sep 13 02:42:44 2023
...
TimeTicks, ModuleIdentity, NotificationType, Unsigned32, Counter32, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Counter64, iso, mib_2, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "NotificationType", "Unsigned32", "Counter32", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Counter64", "iso", "mib-2", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("UPS-MIB", upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsBasicConfigGroup=upsBasicConfigGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBasicControlGroup=upsBasicControlGroup, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsInputLineBads=upsInputLineBads, upsAlarmInputBad=upsAlarmInputBad, upsSecondsOnBattery=upsSecondsOnBattery, upsBypassCurrent=upsBypassCurrent, upsAlarmOnBattery=upsAlarmOnBattery, upsAlarmId=upsAlarmId, upsBasicTestGroup=upsBasicTestGroup, upsIdentModel=upsIdentModel, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsAlarmFanFailure=upsAlarmFanFailure, upsConfigOutputFreq=upsConfigOutputFreq, upsBasicCompliance=upsBasicCompliance, upsConfig=upsConfig, upsBypassPower=upsBypassPower, upsOutputNumLines=upsOutputNumLines, upsAlarmOnBypass=upsAlarmOnBypass, upsInputTable=upsInputTable, upsBypassFrequency=upsBypassFrequency, PYSNMP_MODULE_ID=upsMIB, upsOutputSource=upsOutputSource, upsConfigAudibleStatus=upsConfigAudibleStatus, upsBatteryVoltage=upsBatteryVoltage, upsBasicAlarmGroup=upsBasicAlarmGroup, upsTrapTestCompleted=upsTrapTestCompleted, upsFullIdentGroup=upsFullIdentGroup, upsTestElapsedTime=upsTestElapsedTime, upsBasicOutputGroup=upsBasicOutputGroup, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsFullControlGroup=upsFullControlGroup, upsBatteryCurrent=upsBatteryCurrent, upsAlarmEntry=upsAlarmEntry, NonNegativeInteger=NonNegativeInteger, upsTestSpinLock=upsTestSpinLock, upsInputTruePower=upsInputTruePower, upsBypassNumLines=upsBypassNumLines, upsTraps=upsTraps, upsIdentAttachedDevices=upsIdentAttachedDevices, upsInputEntry=upsInputEntry, upsBasicIdentGroup=upsBasicIdentGroup, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmBypassBad=upsAlarmBypassBad, upsSubsetIdentGroup=upsSubsetIdentGroup, upsTestResultsSummary=upsTestResultsSummary, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsSubsetInputGroup=upsSubsetInputGroup, upsFullAlarmGroup=upsFullAlarmGroup, upsWellKnownTests=upsWellKnownTests, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsBypassVoltage=upsBypassVoltage, upsStartupAfterDelay=upsStartupAfterDelay, PositiveInteger=PositiveInteger, upsConfigInputFreq=upsConfigInputFreq, upsIdentName=upsIdentName, upsOutputEntry=upsOutputEntry, upsBasicInputGroup=upsBasicInputGroup, upsShutdownType=upsShutdownType, upsInputCurrent=upsInputCurrent, upsObjects=upsObjects, upsRebootWithDuration=upsRebootWithDuration, upsOutputPower=upsOutputPower, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsAlarmOutputOverload=upsAlarmOutputOverload, upsBypassEntry=upsBypassEntry, upsTestStartTime=upsTestStartTime, upsBasicBatteryGroup=upsBasicBatteryGroup, upsBattery=upsBattery, upsOutputCurrent=upsOutputCurrent, upsBasicBypassGroup=upsBasicBypassGroup, upsSubsetOutputGroup=upsSubsetOutputGroup, upsSubsetControlGroup=upsSubsetControlGroup, upsAlarmGeneralFault=upsAlarmGeneralFault, upsSubsetGroups=upsSubsetGroups, upsInput=upsInput, upsSubsetConfigGroup=upsSubsetConfigGroup, upsFullBypassGroup=upsFullBypassGroup, upsInputVoltage=upsInputVoltage, upsOutputPercentLoad=upsOutputPercentLoad, upsAutoRestart=upsAutoRestart, upsGroups=upsGroups, upsWellKnownAlarms=upsWellKnownAlarms, upsFullConfigGroup=upsFullConfigGroup, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarmTime=upsAlarmTime, upsFullGroups=upsFullGroups, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmDescr=upsAlarmDescr, upsConfigLowBattTime=upsConfigLowBattTime, upsBypassLineIndex=upsBypassLineIndex, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsAlarmsPresent=upsAlarmsPresent, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsFullInputGroup=upsFullInputGroup, upsBatteryStatus=upsBatteryStatus, upsConfigOutputVA=upsConfigOutputVA, upsOutputLineIndex=upsOutputLineIndex, upsFullOutputGroup=upsFullOutputGroup, upsBasicGroups=upsBasicGroups, upsAlarmTestInProgress=upsAlarmTestInProgress, upsAlarmShutdownPending=upsAlarmShutdownPending, upsOutput=upsOutput, upsConformance=upsConformance, upsCompliances=upsCompliances, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsConfigOutputVoltage=upsConfigOutputVoltage, upsInputNumLines=upsInputNumLines, upsOutputTable=upsOutputTable, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsSubsetCompliance=upsSubsetCompliance, upsShutdownAfterDelay=upsShutdownAfterDelay, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsAlarmTempBad=upsAlarmTempBad, upsTest=upsTest, upsControl=upsControl, upsIdent=upsIdent, upsFullCompliance=upsFullCompliance, upsBatteryTemperature=upsBatteryTemperature, upsAlarm=upsAlarm, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsTestId=upsTestId, upsInputLineIndex=upsInputLineIndex, upsTestResultsDetail=upsTestResultsDetail, upsInputFrequency=upsInputFrequency, upsFullBatteryGroup=upsFullBatteryGroup, upsTrapOnBattery=upsTrapOnBattery, upsBypass=upsBypass, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsFullTestGroup=upsFullTestGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsIdentManufacturer=upsIdentManufacturer, upsAlarmTable=upsAlarmTable, upsAlarmDepletedBattery=upsAlarmDepletedBattery, upsConfigOutputPower=upsConfigOutputPower, upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsOutputVoltage=upsOutputVoltage, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsOutputFrequency=upsOutputFrequency, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBypassTable=upsBypassTable, upsAlarmFuseFailure=upsAlarmFuseFailure, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsMIB=upsMIB, upsAlarmOutputBad=upsAlarmOutputBad)
