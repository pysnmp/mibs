...
mibBuilder.exportSymbols("BWA-DOT11-WLAN-MIB", bwaVLCurrentTxPower=bwaVLCurrentTxPower, bwaVLDeleteOneNwIpRange=bwaVLDeleteOneNwIpRange, bwaVLDisassociateAllSUs=bwaVLDisassociateAllSUs, bwaVLIpFilterEntry=bwaVLIpFilterEntry, bwaVLVlanForwardingSupport=bwaVLVlanForwardingSupport, bwaVLNwMngFilter=bwaVLNwMngFilter, bwaVLSubNetMask=bwaVLSubNetMask, bwaVLBridgeAgingTime=bwaVLBridgeAgingTime, bwaVLBestAuSupport=bwaVLBestAuSupport, bwaVLCurrentFrequencySubsetFrequencyNew=bwaVLCurrentFrequencySubsetFrequencyNew, bwaVLCurrentFrequencySubsetTableIdx=bwaVLCurrentFrequencySubsetTableIdx, bwaVLRxEvents=bwaVLRxEvents, bwaVLCirUplink=bwaVLCirUplink, bwaVLTrafficPriVLAN=bwaVLTrafficPriVLAN, bwaVLTelnetStatusTRAP=bwaVLTelnetStatusTRAP, bwaVLMinimumHwRevision=bwaVLMinimumHwRevision, bwaVLSelectSubBandIndex=bwaVLSelectSubBandIndex, bwaVLCurrentAUOperatingFrequency=bwaVLCurrentAUOperatingFrequency, bwaVLVLANSupport=bwaVLVLANSupport, bwaVLDFSChannelIdx=bwaVLDFSChannelIdx, bwaVLAdbCirMaxDelay=bwaVLAdbCirMaxDelay, bwaVLVLANForwarding=bwaVLVLANForwarding, bwaVLRxDecryptEvents=bwaVLRxDecryptEvents, bwaVLNeighborAuAssocLoadStatus=bwaVLNeighborAuAssocLoadStatus, bwaVLAdbAdapModOption=bwaVLAdbAdapModOption, bwaVLMaxTxPower=bwaVLMaxTxPower, bwaVLAU_SA=bwaVLAU_SA, bwaVLMngIpRangeStart=bwaVLMngIpRangeStart, bwaVLCRCErrors=bwaVLCRCErrors, bwaVLVlanForwardingTable=bwaVLVlanForwardingTable, bwaVLSUBurstDurationLowPriority=bwaVLSUBurstDurationLowPriority, bwaVLDFSFrequcnyTRAP=bwaVLDFSFrequcnyTRAP, bwaVLTrafficPriUdpTcpPortRange=bwaVLTrafficPriUdpTcpPortRange, bwaVLTcpPortRangeEntry=bwaVLTcpPortRangeEntry, bwaVLCurrentFrequencySubsetEntry=bwaVLCurrentFrequencySubsetEntry, bwaVLNeighborAuConcatenationOption=bwaVLNeighborAuConcatenationOption, bwaVLAutoSubBandFrequencySubsetActive=bwaVLAutoSubBandFrequencySubsetActive, bwaVLDFSChannelFrequency=bwaVLDFSChannelFrequency, bwaVLFTPParameters=bwaVLFTPParameters, bwaVLMaximumTransmitPowerEntry=bwaVLMaximumTransmitPowerEntry, bwaVLTotalNoOfDataFramesSubmitted=bwaVLTotalNoOfDataFramesSubmitted, bwaVLPortsControl=bwaVLPortsControl, bwaVLDfsSupport=bwaVLDfsSupport, bwaVLUnitPasswords=bwaVLUnitPasswords, bwaVLMIRThresholdPercent=bwaVLMIRThresholdPercent, bwaVLAvgSNRMemoryFactor=bwaVLAvgSNRMemoryFactor, bwaVLCountryDependentParameterTableIdx=bwaVLCountryDependentParameterTableIdx, bwaVLMacPinpoint=bwaVLMacPinpoint, bwaVLAdbSwVersion=bwaVLAdbSwVersion, bwaVLMacAddressDenyListId=bwaVLMacAddressDenyListId, bwaVLMaximumTxPowerRange=bwaVLMaximumTxPowerRange, bwaVLAdbTxFailedModLevel2=bwaVLAdbTxFailedModLevel2, bwaVLDeleteAllNwIpAddrs=bwaVLDeleteAllNwIpAddrs, bwaVLUpLinkQualityIndicatorStatus=bwaVLUpLinkQualityIndicatorStatus, bwaVLMaxTxApplicableModulationLevel=bwaVLMaxTxApplicableModulationLevel, bwaVLEthBroadcastMulticastLimiterThreshold=bwaVLEthBroadcastMulticastLimiterThreshold, bwaVLTotalRetransmittedFrames=bwaVLTotalRetransmittedFrames, bwaVLPerSuDistanceLearning=bwaVLPerSuDistanceLearning, bwaVLSetSelectedFreqSubset=bwaVLSetSelectedFreqSubset, bwaVLSUPerModulationLevelCountersTable=bwaVLSUPerModulationLevelCountersTable, mngIpFilterTable=mngIpFilterTable, bwaVLIpParams=bwaVLIpParams, bwaVLUdpPortRangeEnd=bwaVLUdpPortRangeEnd, bwaVLNwMngIpTableIdx=bwaVLNwMngIpTableIdx, bwaVLAUAdbResetAllModulationLevelCounters=bwaVLAUAdbResetAllModulationLevelCounters, bwaVLTraps=bwaVLTraps, bwaVLNoOfDuplicateFramesDiscarded=bwaVLNoOfDuplicateFramesDiscarded, bwaVLDFSChannelAvoidancePeriod=bwaVLDFSChannelAvoidancePeriod, bwaVLFramesSubmittedViaLowQueue=bwaVLFramesSubmittedViaLowQueue, bwaVLToSPriorityParameters=bwaVLToSPriorityParameters, bwaVLNeighborAuBurstModeOption=bwaVLNeighborAuBurstModeOption, bwaVLChangeUnitType=bwaVLChangeUnitType, bwaVLAutoSubBandFrequencySubsetBandIdx=bwaVLAutoSubBandFrequencySubsetBandIdx, bwaVLUdpPortRangeConfig=bwaVLUdpPortRangeConfig, bwaVLDeleteOneUserFilter=bwaVLDeleteOneUserFilter, MacAddress=MacAddress, bwaVLFramesDelayedDueToSwRetry=bwaVLFramesDelayedDueToSwRetry, bwaVLUnitWithMaxDistance=bwaVLUnitWithMaxDistance, bwaVLBurstInterval=bwaVLBurstInterval, bwaVLNeighborAuAtpcOption=bwaVLNeighborAuAtpcOption, bwaVLAdbAtpcOption=bwaVLAdbAtpcOption, bwaVLProducts=bwaVLProducts, bwaVLUnitControl=bwaVLUnitControl, bwaVLMngIpRangeMask=bwaVLMngIpRangeMask, bwaVLMaxContentionWindow=bwaVLMaxContentionWindow, bwaVLSU_BD=bwaVLSU_BD, bwaVLNeighborAuMacAdd=bwaVLNeighborAuMacAdd, bwaVLUnitHwVersion=bwaVLUnitHwVersion, bwaVLAntennaGainChange=bwaVLAntennaGainChange, bwaVLTrapToggle=bwaVLTrapToggle, bwaVLDrap=bwaVLDrap, bwaVLTcpPortRangeTable=bwaVLTcpPortRangeTable, bwaVLLoadingStatus=bwaVLLoadingStatus, bwaVLCountryCodeParameters=bwaVLCountryCodeParameters, bwaVLDFSChannelCheckTime=bwaVLDFSChannelCheckTime, bwaVLDefinedMaximumTxPowerRange=bwaVLDefinedMaximumTxPowerRange, bwaVLOID=bwaVLOID, bwaVLDrapNoOfActiveVoiceCalls=bwaVLDrapNoOfActiveVoiceCalls, bwaVLSpectrumAnalysisInformationOFDMFrames=bwaVLSpectrumAnalysisInformationOFDMFrames, bwaVLPowerUpFromReset=bwaVLPowerUpFromReset, bwaVLMaximumTransmitPowerIdx=bwaVLMaximumTransmitPowerIdx, bwaVLNwMngTrapCommunity=bwaVLNwMngTrapCommunity, bwaVLAdbDistance=bwaVLAdbDistance, bwaVLMacPinpointEntry=bwaVLMacPinpointEntry, bwaVLAverageReceiveSNR=bwaVLAverageReceiveSNR, bwaVLUdpTcpPortRangePrioritizationOption=bwaVLUdpTcpPortRangePrioritizationOption, bwaVLNumOfAssociationsSinceLastReset=bwaVLNumOfAssociationsSinceLastReset, bwaVLNeighborAuHwRevision=bwaVLNeighborAuHwRevision, bwaVLAdbConcatenationOption=bwaVLAdbConcatenationOption, bwaVLConcatenationParameters=bwaVLConcatenationParameters, bwaVLServiceParameters=bwaVLServiceParameters, bwaVLAdbDataEncyptOption=bwaVLAdbDataEncyptOption, bwaVLUdpPortRangeIdx=bwaVLUdpPortRangeIdx, bwaVLAdbTxFramesTotal=bwaVLAdbTxFramesTotal, bwaVLSUPerModulationLevelCountersApplicableModLevel=bwaVLSUPerModulationLevelCountersApplicableModLevel, bwaVLTotalTransmittedConcatenatedFramesDouble=bwaVLTotalTransmittedConcatenatedFramesDouble, bwaVLLoadingStatusTRAP=bwaVLLoadingStatusTRAP, bwaVLVlanIdRelaying=bwaVLVlanIdRelaying, bwaVLVlanManagementPriority=bwaVLVlanManagementPriority, bwaVLCountryCodeLearningBySU=bwaVLCountryCodeLearningBySU, bwaVLFrequencyDefinition=bwaVLFrequencyDefinition, bwaVLFlashMemoryControl=bwaVLFlashMemoryControl, bwaVLMacAddressDenyListAdd=bwaVLMacAddressDenyListAdd, bwaVLMinimumIntervalBetweenATPCMessages=bwaVLMinimumIntervalBetweenATPCMessages, bwaVLInstallerPassword=bwaVLInstallerPassword, bwaVLFrequencySubsetTableIdx=bwaVLFrequencySubsetTableIdx, bwaVLAUagingTRAP=bwaVLAUagingTRAP, bwaVLLostBeaconsWatchdogThreshold=bwaVLLostBeaconsWatchdogThreshold, bwaVLTotalRxFramesViaEthernet=bwaVLTotalRxFramesViaEthernet, bwaVLMaxDelay=bwaVLMaxDelay, PYSNMP_MODULE_ID=bwaVLMib, bwaVLHWRetriesLowPriority=bwaVLHWRetriesLowPriority, bwaVLAdbUnitName=bwaVLAdbUnitName, bwaVLWLPrioritizationNotSupportedBySUTRAP=bwaVLWLPrioritizationNotSupportedBySUTRAP, bwaVLWirelessLinkCounters=bwaVLWirelessLinkCounters, bwaVLTotalTransmittedUnicasts=bwaVLTotalTransmittedUnicasts, bwaVLAdbTxSuccessModLevel4=bwaVLAdbTxSuccessModLevel4, bwaLCountryCodeReApply=bwaLCountryCodeReApply, bwaVLRunningFrom=bwaVLRunningFrom, bwaVLRegulationMaxTxPowerAtAntennaPort=bwaVLRegulationMaxTxPowerAtAntennaPort, bwaVLAdbCountryCode=bwaVLAdbCountryCode, bwaVLVlanRelayingTableIdx=bwaVLVlanRelayingTableIdx, bwaVLMacAddressDatabase=bwaVLMacAddressDatabase, bwaVLDFSChannelReuseOption=bwaVLDFSChannelReuseOption, bwaVLVlanRelayingEntry=bwaVLVlanRelayingEntry, bwaVLSUPMirDownlink=bwaVLSUPMirDownlink, bwaVLTotalTransmittedConcatenatedFramesSingle=bwaVLTotalTransmittedConcatenatedFramesSingle, mngTrapTable=mngTrapTable, bwaVLAdbTxFailedModLevel5=bwaVLAdbTxFailedModLevel5, bwaVLFTPServerIpAddress=bwaVLFTPServerIpAddress, bwaVLResetPerModulationLevelCounters=bwaVLResetPerModulationLevelCounters, bwaVLTrapParameterChanged=bwaVLTrapParameterChanged, bwaVLRunningSoftwareVersion=bwaVLRunningSoftwareVersion, bwaVLSubBandUpperFrequency=bwaVLSubBandUpperFrequency, bwaVLTrapSUMacAddr=bwaVLTrapSUMacAddr, bwaVLTotalRxConcatenatedFramesDouble=bwaVLTotalRxConcatenatedFramesDouble, bwaVLTimeSinceLastReset=bwaVLTimeSinceLastReset, bwaVLRoamingOption=bwaVLRoamingOption, bwaVLMaximumTxPower=bwaVLMaximumTxPower, bwaVLSU_6_BD=bwaVLSU_6_BD, bwaVLAccessToDHCP=bwaVLAccessToDHCP, bwaVLMirUplink=bwaVLMirUplink, bwaVLNeighborAuAuthOption=bwaVLNeighborAuAuthOption, bwaVLBestAuNoOfScanningAttempts=bwaVLBestAuNoOfScanningAttempts, bwaVLPPPoEBroadcastOverrideFilter=bwaVLPPPoEBroadcastOverrideFilter, ptp_RB_B100=ptp_RB_B100, bwaVLESSID=bwaVLESSID, products=products, bwaVLSU=bwaVLSU, bwaVLOverrunEvents=bwaVLOverrunEvents, bwaVLNeighborAuDfsOption=bwaVLNeighborAuDfsOption, bwaVLTrapRTx=bwaVLTrapRTx, bwaVLMaxModulationLevel=bwaVLMaxModulationLevel, bwaVLFramesDropped=bwaVLFramesDropped, bwaVLScanningStep=bwaVLScanningStep, bwaVLDrapMaxNumberOfVoiceCalls=bwaVLDrapMaxNumberOfVoiceCalls, bwaVLTcpPortRangeAdd=bwaVLTcpPortRangeAdd, bwaVLAdbTxFailedModLevel8=bwaVLAdbTxFailedModLevel8, bwaVLAdbMaxModulationLevel=bwaVLAdbMaxModulationLevel, bwaVLAUBeaconsToWireless=bwaVLAUBeaconsToWireless, bwaVLConcatenationMaxFrameSize=bwaVLConcatenationMaxFrameSize, bwaVLAirInterface=bwaVLAirInterface, bwaVLAU_BS=bwaVLAU_BS, bwaVLNewUnitTypeTrap=bwaVLNewUnitTypeTrap, bwaVLMaximumModulationLevel=bwaVLMaximumModulationLevel, bwaVLAverageModulationLevel=bwaVLAverageModulationLevel, bwaVLDrapGatewayIP=bwaVLDrapGatewayIP, bwaVLSecurityMode=bwaVLSecurityMode, bwaVLDataEncryptionOption=bwaVLDataEncryptionOption, bwaVLMirDownlink=bwaVLMirDownlink, bwaVLUnderrunEvents=bwaVLUnderrunEvents, bwaVLVlanPriorityThreshold=bwaVLVlanPriorityThreshold, bwaVLConfigurationFileLoading=bwaVLConfigurationFileLoading, bwaVLTrapLog=bwaVLTrapLog, bwaVLRadioBand=bwaVLRadioBand, bwaVLEthBroadcastMulticatLimiterTRAP=bwaVLEthBroadcastMulticatLimiterTRAP, bwaVLMainVersionFileName=bwaVLMainVersionFileName, bwaVLDrapUdpPort=bwaVLDrapUdpPort, bwaVLEventLogDestinationDir=bwaVLEventLogDestinationDir, bwaVLIPDSCPThreshold=bwaVLIPDSCPThreshold, bwaVLAtpcOption=bwaVLAtpcOption, bwaVLRegulationMaxEIRP=bwaVLRegulationMaxEIRP, bwaVLCurrentAUOperatingFrequencyNew=bwaVLCurrentAUOperatingFrequencyNew, bwaVLTxFramesToWireless=bwaVLTxFramesToWireless, bwaVLNeighborAuSecurityMode=bwaVLNeighborAuSecurityMode, bwaVLAU=bwaVLAU, bwaVLFrequencySubsetFrequencyNew=bwaVLFrequencySubsetFrequencyNew, bwaVLVlanDataPriority=bwaVLVlanDataPriority, bwaVLDFSChannelFrequencyNew=bwaVLDFSChannelFrequencyNew, bwaVLAdbTxSuccessModLevel2=bwaVLAdbTxSuccessModLevel2, bwaVLAdaptiveModulationAlgorithmOption=bwaVLAdaptiveModulationAlgorithmOption, bwaVLIPPrecedenceThreshold=bwaVLIPPrecedenceThreshold, bwaVLAUS_BS=bwaVLAUS_BS, bwaVLAUSUnsupportedSubscriberTypeTRAP=bwaVLAUSUnsupportedSubscriberTypeTRAP, bwaVLTotalRxFramesFromWireless=bwaVLTotalRxFramesFromWireless, bwaVLNeighborAuSwVer=bwaVLNeighborAuSwVer, bwaVLDisassociateSuByMacAddress=bwaVLDisassociateSuByMacAddress, bwaVLTcpPortPriRTPRTCP=bwaVLTcpPortPriRTPRTCP, bwaVLKey4=bwaVLKey4, bwaVLTotalTransmittedConcatenatedFramesMore=bwaVLTotalTransmittedConcatenatedFramesMore, bwaVLAdbIndex=bwaVLAdbIndex, bwaVLNeighborAuSNR=bwaVLNeighborAuSNR, bwaVLDrapGatewayIndex=bwaVLDrapGatewayIndex, bwaVLDataAndOtherMngFramesToWireless=bwaVLDataAndOtherMngFramesToWireless, bwaVLDFSRadarDetectionChannelsTable=bwaVLDFSRadarDetectionChannelsTable, bwaVLlowPriorityAIFS=bwaVLlowPriorityAIFS, bwaVLFrequencySubsetTable=bwaVLFrequencySubsetTable, bwaVLNeighborAuLearnCountryCodeBySU=bwaVLNeighborAuLearnCountryCodeBySU, bwaVLTrapText=bwaVLTrapText, bwaVLTcpPortRangeDelete=bwaVLTcpPortRangeDelete, bwaVLReadOnlyPassword=bwaVLReadOnlyPassword, bwaVLBroadcastRelaying=bwaVLBroadcastRelaying, bwaVLAutoSubBandFrequencySubsetFrequencyIdx=bwaVLAutoSubBandFrequencySubsetFrequencyIdx, bwaVLBestAu=bwaVLBestAu, bwaVLSpectrumAnalysisInformationSignalCount=bwaVLSpectrumAnalysisInformationSignalCount, bwaVLMinIntervalBetweenAdaptiveModulationAlgorithmMessages=bwaVLMinIntervalBetweenAdaptiveModulationAlgorithmMessages, bwaVLMaxBurstDuration=bwaVLMaxBurstDuration, bwaVLDrapGatewayType=bwaVLDrapGatewayType, bwaVLSpectrumAnalysisInformationTable=bwaVLSpectrumAnalysisInformationTable, bwaVLUnitName=bwaVLUnitName, bwaVLAUBurstDurationHighPriority=bwaVLAUBurstDurationHighPriority, bwaVLAccessToNwTrap=bwaVLAccessToNwTrap, bwaVLResetUnit=bwaVLResetUnit, bwaVLFTPClientIPAddress=bwaVLFTPClientIPAddress, bwaVLDroppedFrameEvents=bwaVLDroppedFrameEvents, bwaVLMngIpRangeEnd=bwaVLMngIpRangeEnd, bwaVLGracefulDegradationLimit=bwaVLGracefulDegradationLimit, bwaVLEthBroadcastThresholdExceeded=bwaVLEthBroadcastThresholdExceeded, bwa4900_SU_BD=bwa4900_SU_BD, bwaVLSpectrumAnalysisInformationSignalSNR=bwaVLSpectrumAnalysisInformationSignalSNR, bwaVLApClientIpAddress=bwaVLApClientIpAddress, bwaVLSubBandSelect=bwaVLSubBandSelect, bwaVLAdbAge=bwaVLAdbAge, bwaVLTcpPortRangeDeleteAll=bwaVLTcpPortRangeDeleteAll)
mibBuilder.exportSymbols("BWA-DOT11-WLAN-MIB", bwaVLMinContentionWindow=bwaVLMinContentionWindow, bwaVLNeighborAuAdapModOption=bwaVLNeighborAuAdapModOption, bwaVLTransmitPower=bwaVLTransmitPower, bwaVLMirOnlyOption=bwaVLMirOnlyOption, bwaVLAdbBootVer=bwaVLAdbBootVer, bwaVLUdpPortRangeDeleteAll=bwaVLUdpPortRangeDeleteAll, bwaVLSecurityModeSupport=bwaVLSecurityModeSupport, bwaVLDFSChannelRadarStatus=bwaVLDFSChannelRadarStatus, bwaVLDeleteAllUserFilters=bwaVLDeleteAllUserFilters, bwaVLAdminPassword=bwaVLAdminPassword, bwaVLAESEncryptionSupport=bwaVLAESEncryptionSupport, bwaVLHardwareRetries=bwaVLHardwareRetries, bwaVLTcpPortRangeEnd=bwaVLTcpPortRangeEnd, bwaVLMngIpRangeIdx=bwaVLMngIpRangeIdx, bwaVLDeleteOneNwIpAddr=bwaVLDeleteOneNwIpAddr, bwaVLPerformanceParams=bwaVLPerformanceParams, bwaVLOperatorESSID=bwaVLOperatorESSID, bwaVLFTPServerParams=bwaVLFTPServerParams, bwaVLAdaptiveModulationDecisionThresholds=bwaVLAdaptiveModulationDecisionThresholds, bwaVLIpFilterRange=bwaVLIpFilterRange, bwaVLAUMacAddressDatabase=bwaVLAUMacAddressDatabase, bwaVLTelnetLogoutTimer=bwaVLTelnetLogoutTimer, bwaVLAutoSubBandFrequencySubsetFrequency=bwaVLAutoSubBandFrequencySubsetFrequency, bwaVLHWRetriesHighPriority=bwaVLHWRetriesHighPriority, bwaVLAdbSNR=bwaVLAdbSNR, bwaVLExitTelnet=bwaVLExitTelnet, bwaVLTrapAccessRights=bwaVLTrapAccessRights, bwaVLTransmitPowerTable=bwaVLTransmitPowerTable, bwaVLMacAddressDenyListAction=bwaVLMacAddressDenyListAction, bwaVLSpectrumAnalysisActivation=bwaVLSpectrumAnalysisActivation, bwaVLVlanIdForwarding=bwaVLVlanIdForwarding, bwaVLAdbTxSuccessModLevel5=bwaVLAdbTxSuccessModLevel5, bwaVLDHCPBroadcastOverrideFilter=bwaVLDHCPBroadcastOverrideFilter, bwaVLLowPriorityTrafficMinimumPercent=bwaVLLowPriorityTrafficMinimumPercent, bwaVLAdbCirRx=bwaVLAdbCirRx, bwaVLSUDefaultKeyID=bwaVLSUDefaultKeyID, bwaVLMinModulationLevel=bwaVLMinModulationLevel, bwaVLWirelessLinkPrioritization=bwaVLWirelessLinkPrioritization, bwaVLUnitTypeChangedTRAP=bwaVLUnitTypeChangedTRAP, bwaVLVLANPriorityThreshold=bwaVLVLANPriorityThreshold, bwaVLEthBroadcastMulticastLimiterOption=bwaVLEthBroadcastMulticastLimiterOption, bwaVLTransmitPowerEntry=bwaVLTransmitPowerEntry, bwaVLAutomaticChannelSelection=bwaVLAutomaticChannelSelection, bwaVLSUBurstDurationHighPriority=bwaVLSUBurstDurationHighPriority, bwaVLFTPConfigurationFileSourceDir=bwaVLFTPConfigurationFileSourceDir, bwaVLDeltaFromMinSNRLevel=bwaVLDeltaFromMinSNRLevel, bwaVLAuthenticationAlgorithm=bwaVLAuthenticationAlgorithm, bwaVLAUAdbTable=bwaVLAUAdbTable, bwaVLAteTestResults=bwaVLAteTestResults, bwaVLUdpPortRangeNum=bwaVLUdpPortRangeNum, bwaVLAdbTxSuccessModLevel3=bwaVLAdbTxSuccessModLevel3, bwaVLVlanRelayingTable=bwaVLVlanRelayingTable, ptp_BU_B100=ptp_BU_B100, bwaVLTcpPortRangeIdx=bwaVLTcpPortRangeIdx, bwaVLAUdisassociatedTRAP=bwaVLAUdisassociatedTRAP, bwaVLAUAdbEntry=bwaVLAUAdbEntry, bwaVLUnitBootVersion=bwaVLUnitBootVersion, bwaVLSerialNumber=bwaVLSerialNumber, bwaVLSpectrumAnalysisStatus=bwaVLSpectrumAnalysisStatus, bwaVLEventLogFileUploading=bwaVLEventLogFileUploading, bwaVLRunTimeESSID=bwaVLRunTimeESSID, bwaVLDrapGatewayNoOfActiveVoiceCalls=bwaVLDrapGatewayNoOfActiveVoiceCalls, DisplayString=DisplayString, bwaVLEthernetNegotiationMode=bwaVLEthernetNegotiationMode, bwaVLFTPSwFileName=bwaVLFTPSwFileName, bwaVLMaximumTransmitPowerTable=bwaVLMaximumTransmitPowerTable, bwaVLSaveCurrentConfigurationAsOperatorDefaults=bwaVLSaveCurrentConfigurationAsOperatorDefaults, bwaVLDFSParameters=bwaVLDFSParameters, bwaVLFTPGatewayIpAddress=bwaVLFTPGatewayIpAddress, bwaVLEventLogFileParams=bwaVLEventLogFileParams, bwaVLVlanRelaying=bwaVLVlanRelaying, bwaVLNumOfSoftwareRetries=bwaVLNumOfSoftwareRetries, bwaVLSUassociatedAUTRAP=bwaVLSUassociatedAUTRAP, bwaVLCountryDependentParameters=bwaVLCountryDependentParameters, bwaVLDataFramesSubmittedToBridge=bwaVLDataFramesSubmittedToBridge, bwaVLDFSOption=bwaVLDFSOption, bwaVLMngIpRangesTable=bwaVLMngIpRangesTable, bwaVLMaxNumOfAssociations=bwaVLMaxNumOfAssociations, bwaVLAdbTxFailedModLevel1=bwaVLAdbTxFailedModLevel1, bwaVLMulticastModulationLevel=bwaVLMulticastModulationLevel, bwaVLBridgeParameters=bwaVLBridgeParameters, bwaVLAdbAuthOption=bwaVLAdbAuthOption, bwaVLTotalRxConcatenatedFramesMore=bwaVLTotalRxConcatenatedFramesMore, bwaVLRTSThreshold=bwaVLRTSThreshold, bwaVLVLANTrafficPriority=bwaVLVLANTrafficPriority, bwaVLWirelessTrapThreshold=bwaVLWirelessTrapThreshold, bwaVLAU_EZ=bwaVLAU_EZ, bwaVLTxWirelessToEthernet=bwaVLTxWirelessToEthernet, bwaVLVLANQinQ=bwaVLVLANQinQ, bwaVLAdaptiveModulationParams=bwaVLAdaptiveModulationParams, bwaVLAdbTxSuccessModLevel8=bwaVLAdbTxSuccessModLevel8, bwaVLFTPServerPassword=bwaVLFTPServerPassword, bwaVLEventLogPolicy=bwaVLEventLogPolicy, bwaVLCountryDependentParameterFrequencies=bwaVLCountryDependentParameterFrequencies, bwaVLUseDhcp=bwaVLUseDhcp, bwaVLDFSClearRadarDetectedChannelsAfterReset=bwaVLDFSClearRadarDetectedChannelsAfterReset, ptp_RB_B14=ptp_RB_B14, bwaVLAdbTxSuccessModLevel1=bwaVLAdbTxSuccessModLevel1, bwaVLTrapTelnetUserIpAddress=bwaVLTrapTelnetUserIpAddress, bwaVLAutoSubBandFrequencySubsetEntry=bwaVLAutoSubBandFrequencySubsetEntry, bwaVLToSPrecedenceThreshold=bwaVLToSPrecedenceThreshold, bwaVLAdbTxSuccessModLevel7=bwaVLAdbTxSuccessModLevel7, bwaVLBurstMode=bwaVLBurstMode, bwaVLMacAddressDenyListRemove=bwaVLMacAddressDenyListRemove, bwaVLSpectrumAnalysisChannelScanPeriod=bwaVLSpectrumAnalysisChannelScanPeriod, bwaVLConfigurationFileName=bwaVLConfigurationFileName, bwaVLNeighborAuIdx=bwaVLNeighborAuIdx, bwaVLMacPinpointTable=bwaVLMacPinpointTable, bwaVLMaskID=bwaVLMaskID, bwaVLShadowVersionFileName=bwaVLShadowVersionFileName, bwaVLWirelessLinkEvents=bwaVLWirelessLinkEvents, bwaVLSetDefaults=bwaVLSetDefaults, bwaVLEraseEventLog=bwaVLEraseEventLog, bwaVLPromiscuousModeTRAP=bwaVLPromiscuousModeTRAP, bwaVLUdpPortRangeTable=bwaVLUdpPortRangeTable, bwaVLAdbTxFailedModLevel3=bwaVLAdbTxFailedModLevel3, bwaVLConcatenationOption=bwaVLConcatenationOption, bwaVLSpectrumAnalysisInformationChannel=bwaVLSpectrumAnalysisInformationChannel, bwaLighteAPWorkingMode=bwaLighteAPWorkingMode, bwaVLSpectrumAnalysisInformationSignalWidth=bwaVLSpectrumAnalysisInformationSignalWidth, bwaVLMainVersionNumber=bwaVLMainVersionNumber, bwaVLUdpPortRangeAdd=bwaVLUdpPortRangeAdd, bwaVLParameterChangedTRAP=bwaVLParameterChangedTRAP, bwaVLNwTrapTableIdx=bwaVLNwTrapTableIdx, bwaVLRunTimeSubNetMask=bwaVLRunTimeSubNetMask, bwaVLCurrentFrequencySubsetTable=bwaVLCurrentFrequencySubsetTable, bwaVLTotalRxConcatenatedFramesSingle=bwaVLTotalRxConcatenatedFramesSingle, bwaVLEthBroadcastFiltering=bwaVLEthBroadcastFiltering, bwaVLSecurityParameters=bwaVLSecurityParameters, bwaVLSiteSurvey=bwaVLSiteSurvey, bwaVLFeatureUpgradeManually=bwaVLFeatureUpgradeManually, bwaVLDFSMinimumPulsesToDetect=bwaVLDFSMinimumPulsesToDetect, bwaVLDFSNoFreeChannelsExistsTRAP=bwaVLDFSNoFreeChannelsExistsTRAP, bwaVLDFSChannelReuseParameters=bwaVLDFSChannelReuseParameters, bwaVLSoftwareRetrySupport=bwaVLSoftwareRetrySupport, bwaVLBurstModeOption=bwaVLBurstModeOption, bwaVLIpFilterTable=bwaVLIpFilterTable, bwaVLTrapSubscriberType=bwaVLTrapSubscriberType, bwaVLToSPrioritizationOption=bwaVLToSPrioritizationOption, bwaVLMaxNumOfAssociationsLimit=bwaVLMaxNumOfAssociationsLimit, bwaVLTrapFtpOrTftpStatus=bwaVLTrapFtpOrTftpStatus, bwaVLFTPServerUserName=bwaVLFTPServerUserName, bwaVLApplicableModulationLevel=bwaVLApplicableModulationLevel, bwaVLFTPClientMask=bwaVLFTPClientMask, bwaVLSU_6_1D=bwaVLSU_6_1D, ptp_RB_B28=ptp_RB_B28, bwaVLNeighborAuCountryCode=bwaVLNeighborAuCountryCode, bwaVLEthernetLinkType=bwaVLEthernetLinkType, bwaVLMaximumBurstDuration=bwaVLMaximumBurstDuration, bwaVLTcpPortRangeConfig=bwaVLTcpPortRangeConfig, bwaVLAssociatedAU=bwaVLAssociatedAU, bwaVLRunTimeDefaultIPGateway=bwaVLRunTimeDefaultIPGateway, bwaVLDFSRadarActivityAssessmentPeriod=bwaVLDFSRadarActivityAssessmentPeriod, bwaVLCurrentEthernetPortState=bwaVLCurrentEthernetPortState, bwaOID=bwaOID, bwaVLPreferredAuMacAddress=bwaVLPreferredAuMacAddress, bwaVLFramesSubmittedViaMidQueue=bwaVLFramesSubmittedViaMidQueue, bwaVLAdbCirTx=bwaVLAdbCirTx, bwaVLDFSRadarDetecetedTRAP=bwaVLDFSRadarDetecetedTRAP, bwaVLIpID=bwaVLIpID, bwaVLFrequencySubsetEntry=bwaVLFrequencySubsetEntry, bwaVLTxControl=bwaVLTxControl, bwaVLCirDownlink=bwaVLCirDownlink, bwaVLRecievedBadFrames=bwaVLRecievedBadFrames, bwaVLManagementVlanID=bwaVLManagementVlanID, bwaVLDFSSuWaitingOption=bwaVLDFSSuWaitingOption, bwaVLUdpPortRangeStart=bwaVLUdpPortRangeStart, bwaVLIpFilterIdx=bwaVLIpFilterIdx, bwaVLUdpPortRangeDelete=bwaVLUdpPortRangeDelete, bwaVLMacAddressDenyListTableIdx=bwaVLMacAddressDenyListTableIdx, bwaVLAccessToNwMng=bwaVLAccessToNwMng, bwaVLAdbMacAddress=bwaVLAdbMacAddress, bwaVLSU_I=bwaVLSU_I, bwaVLCountryDependentParameterEntry=bwaVLCountryDependentParameterEntry, bwaVLCurrentSUOperatingFrequency=bwaVLCurrentSUOperatingFrequency, bwaVLDataEncryptionSupport=bwaVLDataEncryptionSupport, bwaVLDHCPUnicastOverrideFilter=bwaVLDHCPUnicastOverrideFilter, bwaVLMinimumSNRLevel=bwaVLMinimumSNRLevel, bwaVLFairnessFactor=bwaVLFairnessFactor, bwaVLAIFS=bwaVLAIFS, bwaVLNeighborAuESSID=bwaVLNeighborAuESSID, bwaVLATPC=bwaVLATPC, mptEthernetStationMACAddress=mptEthernetStationMACAddress, bwaVLTransmitPowerIdx=bwaVLTransmitPowerIdx, bwaVLTotalTxEvents=bwaVLTotalTxEvents, bwaVLAdbTxFailedModLevel4=bwaVLAdbTxFailedModLevel4, bwaVLAutoSubBandFrequencySubsetTable=bwaVLAutoSubBandFrequencySubsetTable, bwaVLBurstModeSupport=bwaVLBurstModeSupport, bwaVLRunTimeIPaddr=bwaVLRunTimeIPaddr, bwaVLFTPSwSourceDir=bwaVLFTPSwSourceDir, bwaVLDrapGatewayEntry=bwaVLDrapGatewayEntry, bwaVLNumberOfMacAddressesInDenyList=bwaVLNumberOfMacAddressesInDenyList, bwa4900_AU_SA=bwa4900_AU_SA, bwaVLAntennaGain=bwaVLAntennaGain, bwaVLSUPerModulationLevelCountersTableIdx=bwaVLSUPerModulationLevelCountersTableIdx, bwaVLTcpPortRangeStart=bwaVLTcpPortRangeStart, bwaVLSU_54_BD=bwaVLSU_54_BD, bwaVLAdbBurstModeOption=bwaVLAdbBurstModeOption, bwaVLDefaultGWAddress=bwaVLDefaultGWAddress, bwaVLNeighborAuTable=bwaVLNeighborAuTable, bwa4900_AU_BS=bwa4900_AU_BS, bwaVLMib=bwaVLMib, bwaVLTotalRecievedDataFrames=bwaVLTotalRecievedDataFrames, bwaVLAUDefaultMulticastKeyID=bwaVLAUDefaultMulticastKeyID, bwaVLNeighborAuDataEncyptOption=bwaVLNeighborAuDataEncyptOption, bwaVLTxEvents=bwaVLTxEvents, ptp_BU_B28=ptp_BU_B28, bwaVLDrapSupport=bwaVLDrapSupport, bwaVLVlanRelayingSupport=bwaVLVlanRelayingSupport, bwaVLUdpPortRangeEntry=bwaVLUdpPortRangeEntry, bwaVLUnitIpAddress=bwaVLUnitIpAddress, bwaVLDeleteOneTrapAddr=bwaVLDeleteOneTrapAddr, bwaVLSpectrumAnalysisInformationTableIdx=bwaVLSpectrumAnalysisInformationTableIdx, bwaVLConcatenationMaximumNumberOfFrames=bwaVLConcatenationMaximumNumberOfFrames, bwaVLFrequencySubsetActive=bwaVLFrequencySubsetActive, bwaVLAUDefinedFrequencyNew=bwaVLAUDefinedFrequencyNew, bwaVLResetSpectrumCounters=bwaVLResetSpectrumCounters, bwaVLAutoSubBandSelectedFreqSubset=bwaVLAutoSubBandSelectedFreqSubset, bwa=bwa, bwaVLNeighborAuMark=bwaVLNeighborAuMark, bwaVLKey1=bwaVLKey1, bwaVLAdbTxFailedModLevel6=bwaVLAdbTxFailedModLevel6, bwaVLUnitMacAddress=bwaVLUnitMacAddress, bwaVLResetTrafficCounters=bwaVLResetTrafficCounters, bwaVLPhyErrors=bwaVLPhyErrors, bwaVLFrequencySubsetFrequency=bwaVLFrequencySubsetFrequency, bwaVLAdbMirRx=bwaVLAdbMirRx, bwaVLAUwirelessQualityTRAP=bwaVLAUwirelessQualityTRAP, mptUnitMACAddress=mptUnitMACAddress, bwaVLAdbTxSuccessModLevel6=bwaVLAdbTxSuccessModLevel6, bwaVLMeasureUpLinkQualityIndicator=bwaVLMeasureUpLinkQualityIndicator, bwaVLARPBroadcastOverrideFilter=bwaVLARPBroadcastOverrideFilter, bwaVLNoOfInternallyDiscardedMirCir=bwaVLNoOfInternallyDiscardedMirCir, bwaVLMacAddressDenyListTable=bwaVLMacAddressDenyListTable, bwaVLSU_24_BD=bwaVLSU_24_BD, bwaVLScanningMode=bwaVLScanningMode, bwaVLTotalTxFramesToWireless=bwaVLTotalTxFramesToWireless, bwaVLTrapSWVersion=bwaVLTrapSWVersion, bwaVLShadowVersionNumber=bwaVLShadowVersionNumber, bwaVLDeleteAllNwIpRanges=bwaVLDeleteAllNwIpRanges, bwaVLAuthenticationPromiscuousMode=bwaVLAuthenticationPromiscuousMode, bwaVLSpectrumAnalysisScanCycles=bwaVLSpectrumAnalysisScanCycles, bwaVLSUPerModulationLevelCountersEntry=bwaVLSUPerModulationLevelCountersEntry, bwaVLEthBroadcastingParameters=bwaVLEthBroadcastingParameters, bwaVLEthBroadcastMulticastLimiterSendTrapInterval=bwaVLEthBroadcastMulticastLimiterSendTrapInterval, bwaVLNwMngIpAddress=bwaVLNwMngIpAddress, bwaVLEthCounters=bwaVLEthCounters, bwaVLSUassociatedTRAP=bwaVLSUassociatedTRAP, bwaVLNeighborAuEntry=bwaVLNeighborAuEntry, bwaVLUpLinkQualityIndicator=bwaVLUpLinkQualityIndicator, bwaVLSU_3_1D=bwaVLSU_3_1D, bwaVLFramesSubmittedViaHighQueue=bwaVLFramesSubmittedViaHighQueue, bwaVLAuthenticationEncryptionSupport=bwaVLAuthenticationEncryptionSupport, bwaVLPerModulationLevelCounters=bwaVLPerModulationLevelCounters)
mibBuilder.exportSymbols("BWA-DOT11-WLAN-MIB", bwaVLCurrentFrequencySubsetFrequency=bwaVLCurrentFrequencySubsetFrequency, bwaVLCellDistanceParameters=bwaVLCellDistanceParameters, bwaVLNwMngTrapAddress=bwaVLNwMngTrapAddress, bwaVLMacAddressDenyListEntry=bwaVLMacAddressDenyListEntry, bwaVLDeleteAllTrapAddrs=bwaVLDeleteAllTrapAddrs, bwaVLFeatureUpgrade=bwaVLFeatureUpgrade, bwaVLReadUpLinkQualityIndicator=bwaVLReadUpLinkQualityIndicator, bwaVLAdbTxFailedModLevel7=bwaVLAdbTxFailedModLevel7, bwaVLNeighborAuPerSuDistanceLearning=bwaVLNeighborAuPerSuDistanceLearning, bwaVLTrapMACAddress=bwaVLTrapMACAddress, bwaVLSysInfo=bwaVLSysInfo, bwaVLMngIpRangeEntry=bwaVLMngIpRangeEntry, mngTrapEntry=mngTrapEntry, bwaVLDFSMaximumNumberOfDetectionsInAssessmentPeriod=bwaVLDFSMaximumNumberOfDetectionsInAssessmentPeriod, bwaVLWirelessLinkPrioritizationOption=bwaVLWirelessLinkPrioritizationOption, bwaVLOperatorDefaultsFileName=bwaVLOperatorDefaultsFileName, bwaVLCurrentNumOfAssociations=bwaVLCurrentNumOfAssociations, bwaVLMngIpRangeFlag=bwaVLMngIpRangeFlag, bwaVLUnitType=bwaVLUnitType, bwaVLOperatorESSIDOption=bwaVLOperatorESSIDOption, bwaVLCountryDependentParamsTable=bwaVLCountryDependentParamsTable, bwaVLDFSRadarDetectionChannelsEntry=bwaVLDFSRadarDetectionChannelsEntry, bwaVLDFSMoveFreqNew=bwaVLDFSMoveFreqNew, bwaVLSU_3_4D=bwaVLSU_3_4D, bwaVLUserFilterParams=bwaVLUserFilterParams, bwaVLMaximumCellRadius=bwaVLMaximumCellRadius, bwaVLSystemLocation=bwaVLSystemLocation, bwaVLOthersTxEvents=bwaVLOthersTxEvents, bwaVLMeasuredCellDistance=bwaVLMeasuredCellDistance, bwaVLTrafficPrioritization=bwaVLTrafficPrioritization, bwaVLUnicastRelaying=bwaVLUnicastRelaying, bwaVLTxPower=bwaVLTxPower, bwaVLSpectrumAnalysisParameters=bwaVLSpectrumAnalysisParameters, bwaVLAdbSecurityMode=bwaVLAdbSecurityMode, bwaVLSUPerModulationLevelCountersTxFailed=bwaVLSUPerModulationLevelCountersTxFailed, bwaVLDrapGatewaysTable=bwaVLDrapGatewaysTable, bwaVLEventLogFileName=bwaVLEventLogFileName, bwaVLAutoSubBandSelect=bwaVLAutoSubBandSelect, bwaVLKey2=bwaVLKey2, bwaVLEthernetPortControl=bwaVLEthernetPortControl, bwaVLUserFilterOption=bwaVLUserFilterOption, bwaVLVlanForwardingTableIdx=bwaVLVlanForwardingTableIdx, bwaVLVlanForwardingEntry=bwaVLVlanForwardingEntry, bwaVLMacAddressDenyList=bwaVLMacAddressDenyList, bwaVLCellDistanceMode=bwaVLCellDistanceMode, bwaVLSpectrumAnalysisInformationEntry=bwaVLSpectrumAnalysisInformationEntry, bwaVLFTPDownloadSwFile=bwaVLFTPDownloadSwFile, bwaVLVlanID=bwaVLVlanID, bwaVLAdbMirTx=bwaVLAdbMirTx, bwaVLDrapTTL=bwaVLDrapTTL, bwaVLAUDefinedFrequency=bwaVLAUDefinedFrequency, bwaVLUdpPortPriRTPRTCP=bwaVLUdpPortPriRTPRTCP, bwaVLExecuteFTPConfigurationFileLoading=bwaVLExecuteFTPConfigurationFileLoading, bwaVLQinQEthertype=bwaVLQinQEthertype, bwaVLDisassociate=bwaVLDisassociate, bwaVLTrafficStatistics=bwaVLTrafficStatistics, bwaVLAUS_SA=bwaVLAUS_SA, bwaVLDFSMoveFreq=bwaVLDFSMoveFreq, bwaVLAdbStatus=bwaVLAdbStatus, bwaVLUploadEventLogFile=bwaVLUploadEventLogFile, bwaVLSubBandLowerFrequency=bwaVLSubBandLowerFrequency, bwaVLAllowedBandwidth=bwaVLAllowedBandwidth, bwaVLTotalRxEvents=bwaVLTotalRxEvents, bwaVLTcpPortRangeNum=bwaVLTcpPortRangeNum, bwaVLSUPerModulationLevelCountersTxSuccess=bwaVLSUPerModulationLevelCountersTxSuccess, bwaVLPowerLevelSteps=bwaVLPowerLevelSteps, bwaVLKey3=bwaVLKey3, mngIpFilterEntry=mngIpFilterEntry, bwaVLESSIDParameters=bwaVLESSIDParameters, bwaVLFTPSwDownload=bwaVLFTPSwDownload, bwaVLAdbDroppedFramesTotal=bwaVLAdbDroppedFramesTotal, bwaVLAdbCpldVer=bwaVLAdbCpldVer, bwaVLAUBurstDurationLowPriority=bwaVLAUBurstDurationLowPriority, bwaVLTrafficPriIPToS=bwaVLTrafficPriIPToS, bwaVLAdbHwRevision=bwaVLAdbHwRevision, bwaVLQinQProviderVlanID=bwaVLQinQProviderVlanID, bwaVLNwMngParameters=bwaVLNwMngParameters, bwaVLCountryCode=bwaVLCountryCode, ptp_BU_B14=ptp_BU_B14)
