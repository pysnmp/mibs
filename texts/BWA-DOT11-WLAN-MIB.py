...
mibBuilder.exportSymbols("BWA-DOT11-WLAN-MIB", bwaVLUdpPortRangeStart=bwaVLUdpPortRangeStart, bwaVLSUPerModulationLevelCountersTxFailed=bwaVLSUPerModulationLevelCountersTxFailed, bwaVLFTPSwFileName=bwaVLFTPSwFileName, bwaVLFrequencySubsetTableIdx=bwaVLFrequencySubsetTableIdx, bwaVLTrapRTx=bwaVLTrapRTx, bwaVLCountryCodeLearningBySU=bwaVLCountryCodeLearningBySU, bwaVLFTPParameters=bwaVLFTPParameters, bwaVLDFSOption=bwaVLDFSOption, bwaVLAdbDataEncyptOption=bwaVLAdbDataEncyptOption, bwaVLAutoSubBandFrequencySubsetTable=bwaVLAutoSubBandFrequencySubsetTable, bwaVLSpectrumAnalysisInformationSignalSNR=bwaVLSpectrumAnalysisInformationSignalSNR, bwaVLUnitTypeChangedTRAP=bwaVLUnitTypeChangedTRAP, bwaVLNeighborAuAdapModOption=bwaVLNeighborAuAdapModOption, bwaVLPerModulationLevelCounters=bwaVLPerModulationLevelCounters, bwaVLAUS_BS=bwaVLAUS_BS, bwaVLUdpPortRangeDelete=bwaVLUdpPortRangeDelete, bwaVLMaximumTxPower=bwaVLMaximumTxPower, bwaVLUdpPortRangeDeleteAll=bwaVLUdpPortRangeDeleteAll, bwaVLTotalTxFramesToWireless=bwaVLTotalTxFramesToWireless, bwaVLLoadingStatus=bwaVLLoadingStatus, bwaVLTotalTransmittedConcatenatedFramesDouble=bwaVLTotalTransmittedConcatenatedFramesDouble, bwaVLFTPDownloadSwFile=bwaVLFTPDownloadSwFile, bwaVLIpFilterIdx=bwaVLIpFilterIdx, bwaVLMacAddressDenyListTable=bwaVLMacAddressDenyListTable, bwaVLESSID=bwaVLESSID, bwaVLOperatorESSIDOption=bwaVLOperatorESSIDOption, bwaLCountryCodeReApply=bwaLCountryCodeReApply, bwaVLDrapUdpPort=bwaVLDrapUdpPort, bwaVLDFSNoFreeChannelsExistsTRAP=bwaVLDFSNoFreeChannelsExistsTRAP, bwaVLSpectrumAnalysisInformationSignalCount=bwaVLSpectrumAnalysisInformationSignalCount, bwaVLMinimumIntervalBetweenATPCMessages=bwaVLMinimumIntervalBetweenATPCMessages, bwaVLTrapParameterChanged=bwaVLTrapParameterChanged, bwaVLUnitBootVersion=bwaVLUnitBootVersion, bwaVLSpectrumAnalysisStatus=bwaVLSpectrumAnalysisStatus, bwaVLMinIntervalBetweenAdaptiveModulationAlgorithmMessages=bwaVLMinIntervalBetweenAdaptiveModulationAlgorithmMessages, bwaVLAU_SA=bwaVLAU_SA, bwaVLAccessToDHCP=bwaVLAccessToDHCP, bwaVLExecuteFTPConfigurationFileLoading=bwaVLExecuteFTPConfigurationFileLoading, bwaVLTcpPortRangeNum=bwaVLTcpPortRangeNum, bwaVLTxControl=bwaVLTxControl, bwaVLAuthenticationEncryptionSupport=bwaVLAuthenticationEncryptionSupport, bwaVLTrapTelnetUserIpAddress=bwaVLTrapTelnetUserIpAddress, bwaVLTrapSUMacAddr=bwaVLTrapSUMacAddr, bwaVLPowerLevelSteps=bwaVLPowerLevelSteps, bwa4900_SU_BD=bwa4900_SU_BD, bwaVLRunningFrom=bwaVLRunningFrom, bwaVLDeleteAllTrapAddrs=bwaVLDeleteAllTrapAddrs, bwaVLMaximumTransmitPowerEntry=bwaVLMaximumTransmitPowerEntry, bwaVLCellDistanceMode=bwaVLCellDistanceMode, bwaVLAdbTxSuccessModLevel8=bwaVLAdbTxSuccessModLevel8, bwaVLAverageModulationLevel=bwaVLAverageModulationLevel, bwaVLDisassociateSuByMacAddress=bwaVLDisassociateSuByMacAddress, bwaVLNeighborAuAtpcOption=bwaVLNeighborAuAtpcOption, bwaVLDrapGatewayIndex=bwaVLDrapGatewayIndex, bwaVLAdbTxFailedModLevel6=bwaVLAdbTxFailedModLevel6, bwaVLTrapFtpOrTftpStatus=bwaVLTrapFtpOrTftpStatus, bwaVLDFSChannelRadarStatus=bwaVLDFSChannelRadarStatus, bwaVLEthBroadcastThresholdExceeded=bwaVLEthBroadcastThresholdExceeded, bwaVLRoamingOption=bwaVLRoamingOption, bwaVLATPC=bwaVLATPC, bwaVLUpLinkQualityIndicatorStatus=bwaVLUpLinkQualityIndicatorStatus, bwaVLMngIpRangeFlag=bwaVLMngIpRangeFlag, bwaVLToSPrecedenceThreshold=bwaVLToSPrecedenceThreshold, bwaVLAdbTxSuccessModLevel1=bwaVLAdbTxSuccessModLevel1, bwaVLSubNetMask=bwaVLSubNetMask, bwaVLUpLinkQualityIndicator=bwaVLUpLinkQualityIndicator, bwaVLAutoSubBandSelectedFreqSubset=bwaVLAutoSubBandSelectedFreqSubset, bwaVLUserFilterOption=bwaVLUserFilterOption, bwaVLTxFramesToWireless=bwaVLTxFramesToWireless, bwaVLTrapToggle=bwaVLTrapToggle, bwaVLToSPriorityParameters=bwaVLToSPriorityParameters, bwaVLRegulationMaxTxPowerAtAntennaPort=bwaVLRegulationMaxTxPowerAtAntennaPort, bwaVLAdbSwVersion=bwaVLAdbSwVersion, bwaVLDrapGatewayType=bwaVLDrapGatewayType, bwaVLAdbMirTx=bwaVLAdbMirTx, bwaVLDFSClearRadarDetectedChannelsAfterReset=bwaVLDFSClearRadarDetectedChannelsAfterReset, bwaVLDrap=bwaVLDrap, bwaVLAdbTxFramesTotal=bwaVLAdbTxFramesTotal, bwaVLUnitName=bwaVLUnitName, bwaVLAvgSNRMemoryFactor=bwaVLAvgSNRMemoryFactor, bwaVLSpectrumAnalysisParameters=bwaVLSpectrumAnalysisParameters, bwaVLVlanIdRelaying=bwaVLVlanIdRelaying, bwaVLDFSChannelFrequency=bwaVLDFSChannelFrequency, bwaVLScanningStep=bwaVLScanningStep, bwaVLBestAuNoOfScanningAttempts=bwaVLBestAuNoOfScanningAttempts, bwaVLMaxDelay=bwaVLMaxDelay, bwaVLUnicastRelaying=bwaVLUnicastRelaying, bwaVLAdbTxFailedModLevel8=bwaVLAdbTxFailedModLevel8, bwaVLAdbTxSuccessModLevel5=bwaVLAdbTxSuccessModLevel5, bwaVLFlashMemoryControl=bwaVLFlashMemoryControl, bwaVLMinModulationLevel=bwaVLMinModulationLevel, bwaVLTrapText=bwaVLTrapText, bwaVLNeighborAuLearnCountryCodeBySU=bwaVLNeighborAuLearnCountryCodeBySU, bwaVLSysInfo=bwaVLSysInfo, bwaVLDFSRadarDetecetedTRAP=bwaVLDFSRadarDetecetedTRAP, bwaVLFrequencySubsetTable=bwaVLFrequencySubsetTable, bwaVLNeighborAuSwVer=bwaVLNeighborAuSwVer, bwaVLAdbMirRx=bwaVLAdbMirRx, bwaVLExitTelnet=bwaVLExitTelnet, bwaVLSelectSubBandIndex=bwaVLSelectSubBandIndex, bwaVLIpFilterEntry=bwaVLIpFilterEntry, bwaVLSUassociatedTRAP=bwaVLSUassociatedTRAP, bwaVLSU_3_4D=bwaVLSU_3_4D, bwaVLPerformanceParams=bwaVLPerformanceParams, bwaVLFTPServerPassword=bwaVLFTPServerPassword, bwaVLAdbAge=bwaVLAdbAge, bwaVLDeltaFromMinSNRLevel=bwaVLDeltaFromMinSNRLevel, bwaVLVLANTrafficPriority=bwaVLVLANTrafficPriority, bwaVLTcpPortRangeEntry=bwaVLTcpPortRangeEntry, bwaVLTrapSubscriberType=bwaVLTrapSubscriberType, bwaVLMaxContentionWindow=bwaVLMaxContentionWindow, bwaVLParameterChangedTRAP=bwaVLParameterChangedTRAP, bwaVLResetSpectrumCounters=bwaVLResetSpectrumCounters, bwaVLCurrentAUOperatingFrequencyNew=bwaVLCurrentAUOperatingFrequencyNew, bwaVLDFSChannelAvoidancePeriod=bwaVLDFSChannelAvoidancePeriod, bwaVLUnitWithMaxDistance=bwaVLUnitWithMaxDistance, bwaVLNeighborAuSNR=bwaVLNeighborAuSNR, bwaVLMIRThresholdPercent=bwaVLMIRThresholdPercent, bwaVLInstallerPassword=bwaVLInstallerPassword, ptp_RB_B100=ptp_RB_B100, bwaVLMngIpRangeMask=bwaVLMngIpRangeMask, bwaVLToSPrioritizationOption=bwaVLToSPrioritizationOption, bwaVLAdbTxFailedModLevel4=bwaVLAdbTxFailedModLevel4, bwaVLNwMngIpAddress=bwaVLNwMngIpAddress, bwaVLTcpPortRangeDelete=bwaVLTcpPortRangeDelete, bwaVLNeighborAuAuthOption=bwaVLNeighborAuAuthOption, bwaVLUdpPortRangeAdd=bwaVLUdpPortRangeAdd, bwaVLNeighborAuCountryCode=bwaVLNeighborAuCountryCode, mptEthernetStationMACAddress=mptEthernetStationMACAddress, bwaVLEthernetPortControl=bwaVLEthernetPortControl, bwaVLTransmitPowerEntry=bwaVLTransmitPowerEntry, bwaVLManagementVlanID=bwaVLManagementVlanID, bwaVLBurstModeOption=bwaVLBurstModeOption, bwaVLVlanID=bwaVLVlanID, bwaVLPerSuDistanceLearning=bwaVLPerSuDistanceLearning, bwaVLMaskID=bwaVLMaskID, bwaVLDeleteOneUserFilter=bwaVLDeleteOneUserFilter, bwaVLTrapMACAddress=bwaVLTrapMACAddress, bwaVLMirUplink=bwaVLMirUplink, bwaVLAdbMaxModulationLevel=bwaVLAdbMaxModulationLevel, bwaVLUploadEventLogFile=bwaVLUploadEventLogFile, bwaVLAutoSubBandSelect=bwaVLAutoSubBandSelect, bwaVLNeighborAuDfsOption=bwaVLNeighborAuDfsOption, bwaVLFTPConfigurationFileSourceDir=bwaVLFTPConfigurationFileSourceDir, bwaVLTransmitPower=bwaVLTransmitPower, bwaVLTraps=bwaVLTraps, ptp_BU_B14=ptp_BU_B14, bwaVLDisassociateAllSUs=bwaVLDisassociateAllSUs, bwaVLAssociatedAU=bwaVLAssociatedAU, bwaVLCountryDependentParameterFrequencies=bwaVLCountryDependentParameterFrequencies, bwaVLMeasureUpLinkQualityIndicator=bwaVLMeasureUpLinkQualityIndicator, bwaVLFairnessFactor=bwaVLFairnessFactor, bwaVLIpParams=bwaVLIpParams, bwaVLEventLogFileUploading=bwaVLEventLogFileUploading, bwaVLDeleteOneNwIpAddr=bwaVLDeleteOneNwIpAddr, bwaVLNeighborAuConcatenationOption=bwaVLNeighborAuConcatenationOption, bwaVLQinQEthertype=bwaVLQinQEthertype, bwaVLUserFilterParams=bwaVLUserFilterParams, bwaVLNewUnitTypeTrap=bwaVLNewUnitTypeTrap, bwaVLConfigurationFileLoading=bwaVLConfigurationFileLoading, bwaVLMinimumSNRLevel=bwaVLMinimumSNRLevel, bwaVLRTSThreshold=bwaVLRTSThreshold, bwaVLNeighborAuSecurityMode=bwaVLNeighborAuSecurityMode, bwaVLFrequencySubsetFrequencyNew=bwaVLFrequencySubsetFrequencyNew, bwaVLDFSParameters=bwaVLDFSParameters, bwaVLAUBurstDurationHighPriority=bwaVLAUBurstDurationHighPriority, bwaVLAdbCirMaxDelay=bwaVLAdbCirMaxDelay, bwaVLMacAddressDenyListId=bwaVLMacAddressDenyListId, bwaVLSpectrumAnalysisInformationSignalWidth=bwaVLSpectrumAnalysisInformationSignalWidth, bwaVLCountryCode=bwaVLCountryCode, bwaVLBurstModeSupport=bwaVLBurstModeSupport, bwaVLWirelessLinkCounters=bwaVLWirelessLinkCounters, bwaVLTxPower=bwaVLTxPower, bwaVLMaxNumOfAssociations=bwaVLMaxNumOfAssociations, bwaVLAutoSubBandFrequencySubsetFrequencyIdx=bwaVLAutoSubBandFrequencySubsetFrequencyIdx, bwaVLMaxModulationLevel=bwaVLMaxModulationLevel, bwaVLProducts=bwaVLProducts, bwaVLAuthenticationPromiscuousMode=bwaVLAuthenticationPromiscuousMode, bwaVLTcpPortRangeEnd=bwaVLTcpPortRangeEnd, bwaVLDFSMoveFreq=bwaVLDFSMoveFreq, bwaVLNwMngParameters=bwaVLNwMngParameters, bwaVLServiceParameters=bwaVLServiceParameters, bwaVLAdbAtpcOption=bwaVLAdbAtpcOption, bwaVLAutoSubBandFrequencySubsetBandIdx=bwaVLAutoSubBandFrequencySubsetBandIdx, bwaVLFeatureUpgradeManually=bwaVLFeatureUpgradeManually, bwaVLTotalTransmittedUnicasts=bwaVLTotalTransmittedUnicasts, bwaVLRunTimeDefaultIPGateway=bwaVLRunTimeDefaultIPGateway, bwaVLOperatorDefaultsFileName=bwaVLOperatorDefaultsFileName, bwaVLBestAu=bwaVLBestAu, bwaVLDrapGatewayNoOfActiveVoiceCalls=bwaVLDrapGatewayNoOfActiveVoiceCalls, bwaVLIpFilterTable=bwaVLIpFilterTable, ptp_RB_B14=ptp_RB_B14, bwaVLApplicableModulationLevel=bwaVLApplicableModulationLevel, bwaVLTcpPortRangeIdx=bwaVLTcpPortRangeIdx, bwaVLIPDSCPThreshold=bwaVLIPDSCPThreshold, bwaVLAdbCpldVer=bwaVLAdbCpldVer, bwaVLMainVersionNumber=bwaVLMainVersionNumber, bwaVLAdbBootVer=bwaVLAdbBootVer, bwaVLAUSUnsupportedSubscriberTypeTRAP=bwaVLAUSUnsupportedSubscriberTypeTRAP, bwaVLSpectrumAnalysisScanCycles=bwaVLSpectrumAnalysisScanCycles, bwaVLMaximumTransmitPowerIdx=bwaVLMaximumTransmitPowerIdx, bwaVLSU_I=bwaVLSU_I, bwaVLNeighborAuTable=bwaVLNeighborAuTable, bwaVLCurrentFrequencySubsetFrequencyNew=bwaVLCurrentFrequencySubsetFrequencyNew, bwaVLResetPerModulationLevelCounters=bwaVLResetPerModulationLevelCounters, bwaVLMaxBurstDuration=bwaVLMaxBurstDuration, bwaVLTimeSinceLastReset=bwaVLTimeSinceLastReset, bwaVLSpectrumAnalysisActivation=bwaVLSpectrumAnalysisActivation, bwaVLAccessToNwMng=bwaVLAccessToNwMng, bwaVLPhyErrors=bwaVLPhyErrors, bwaVLMirDownlink=bwaVLMirDownlink, bwaVLAteTestResults=bwaVLAteTestResults, bwaVLVlanPriorityThreshold=bwaVLVlanPriorityThreshold, bwaVLTrafficPriVLAN=bwaVLTrafficPriVLAN, bwaVLFrequencySubsetActive=bwaVLFrequencySubsetActive, bwaVLAUAdbTable=bwaVLAUAdbTable, bwaVLEthBroadcastingParameters=bwaVLEthBroadcastingParameters, bwaVLSUPerModulationLevelCountersEntry=bwaVLSUPerModulationLevelCountersEntry, bwaVLMaximumBurstDuration=bwaVLMaximumBurstDuration, bwaVLMeasuredCellDistance=bwaVLMeasuredCellDistance, bwaVLTrafficPrioritization=bwaVLTrafficPrioritization, bwaVLDrapNoOfActiveVoiceCalls=bwaVLDrapNoOfActiveVoiceCalls, bwaVLMngIpRangeIdx=bwaVLMngIpRangeIdx, bwaVLAdbCirTx=bwaVLAdbCirTx, bwaVLTrafficStatistics=bwaVLTrafficStatistics, bwaVLWLPrioritizationNotSupportedBySUTRAP=bwaVLWLPrioritizationNotSupportedBySUTRAP, bwaVLGracefulDegradationLimit=bwaVLGracefulDegradationLimit, bwaVLChangeUnitType=bwaVLChangeUnitType, bwaVLAuthenticationAlgorithm=bwaVLAuthenticationAlgorithm, bwaVLESSIDParameters=bwaVLESSIDParameters, bwaVLTcpPortRangeDeleteAll=bwaVLTcpPortRangeDeleteAll, bwaVLSUPerModulationLevelCountersTableIdx=bwaVLSUPerModulationLevelCountersTableIdx, bwaVLCurrentSUOperatingFrequency=bwaVLCurrentSUOperatingFrequency, bwaVLMaximumCellRadius=bwaVLMaximumCellRadius, bwaVLSUBurstDurationHighPriority=bwaVLSUBurstDurationHighPriority, bwaVLAUwirelessQualityTRAP=bwaVLAUwirelessQualityTRAP, mngIpFilterEntry=mngIpFilterEntry, bwaVLTcpPortRangeTable=bwaVLTcpPortRangeTable, bwaVLAutoSubBandFrequencySubsetEntry=bwaVLAutoSubBandFrequencySubsetEntry, bwaVLUdpPortPriRTPRTCP=bwaVLUdpPortPriRTPRTCP, bwaVLUnitType=bwaVLUnitType, bwaVLAdaptiveModulationParams=bwaVLAdaptiveModulationParams, bwaVLRxDecryptEvents=bwaVLRxDecryptEvents, bwaVLSpectrumAnalysisInformationChannel=bwaVLSpectrumAnalysisInformationChannel, bwa4900_AU_BS=bwa4900_AU_BS, bwaVLDFSChannelReuseOption=bwaVLDFSChannelReuseOption, bwaVLAdbDroppedFramesTotal=bwaVLAdbDroppedFramesTotal, bwaVLShadowVersionFileName=bwaVLShadowVersionFileName, bwaVLCurrentTxPower=bwaVLCurrentTxPower, ptp_BU_B100=ptp_BU_B100, bwaVLAUdisassociatedTRAP=bwaVLAUdisassociatedTRAP, bwaVLSUPerModulationLevelCountersTable=bwaVLSUPerModulationLevelCountersTable, bwaVLVLANForwarding=bwaVLVLANForwarding, bwaVLMngIpRangesTable=bwaVLMngIpRangesTable)
mibBuilder.exportSymbols("BWA-DOT11-WLAN-MIB", bwaVLSubBandLowerFrequency=bwaVLSubBandLowerFrequency, bwaVLDataFramesSubmittedToBridge=bwaVLDataFramesSubmittedToBridge, PYSNMP_MODULE_ID=bwaVLMib, bwaVLNeighborAuHwRevision=bwaVLNeighborAuHwRevision, bwaVLAdaptiveModulationAlgorithmOption=bwaVLAdaptiveModulationAlgorithmOption, bwaVLSUBurstDurationLowPriority=bwaVLSUBurstDurationLowPriority, bwaVLAdbAdapModOption=bwaVLAdbAdapModOption, bwaVLAtpcOption=bwaVLAtpcOption, bwaVLCurrentAUOperatingFrequency=bwaVLCurrentAUOperatingFrequency, bwaVLPPPoEBroadcastOverrideFilter=bwaVLPPPoEBroadcastOverrideFilter, bwaVLDrapGatewayIP=bwaVLDrapGatewayIP, bwaVLMacAddressDenyListAction=bwaVLMacAddressDenyListAction, bwaVLPortsControl=bwaVLPortsControl, bwaVLUdpPortRangeConfig=bwaVLUdpPortRangeConfig, bwaVLResetUnit=bwaVLResetUnit, bwaVLBurstInterval=bwaVLBurstInterval, bwaVLAdbTxSuccessModLevel2=bwaVLAdbTxSuccessModLevel2, bwaVLMacPinpoint=bwaVLMacPinpoint, bwaVLFrequencyDefinition=bwaVLFrequencyDefinition, bwaVLTotalRxFramesViaEthernet=bwaVLTotalRxFramesViaEthernet, bwaVLAUMacAddressDatabase=bwaVLAUMacAddressDatabase, bwaVLTotalRetransmittedFrames=bwaVLTotalRetransmittedFrames, bwaVLLostBeaconsWatchdogThreshold=bwaVLLostBeaconsWatchdogThreshold, bwaVLMinContentionWindow=bwaVLMinContentionWindow, bwaVLDataEncryptionSupport=bwaVLDataEncryptionSupport, bwaVLTotalTransmittedConcatenatedFramesMore=bwaVLTotalTransmittedConcatenatedFramesMore, bwaVLSU_6_1D=bwaVLSU_6_1D, bwaVLFeatureUpgrade=bwaVLFeatureUpgrade, bwaVLCountryDependentParameters=bwaVLCountryDependentParameters, bwaVLResetTrafficCounters=bwaVLResetTrafficCounters, bwaVLTotalRxFramesFromWireless=bwaVLTotalRxFramesFromWireless, bwaVLDeleteOneNwIpRange=bwaVLDeleteOneNwIpRange, bwaVLTelnetStatusTRAP=bwaVLTelnetStatusTRAP, bwaVLDFSChannelCheckTime=bwaVLDFSChannelCheckTime, bwaVLFTPServerIpAddress=bwaVLFTPServerIpAddress, bwaVLAdbMacAddress=bwaVLAdbMacAddress, bwaVLEventLogFileName=bwaVLEventLogFileName, bwaVLDefinedMaximumTxPowerRange=bwaVLDefinedMaximumTxPowerRange, bwaVLMngIpRangeStart=bwaVLMngIpRangeStart, bwaVLVlanRelaying=bwaVLVlanRelaying, bwaVLSecurityParameters=bwaVLSecurityParameters, bwaVLMaxTxPower=bwaVLMaxTxPower, bwaVLFTPSwDownload=bwaVLFTPSwDownload, bwaVLVlanRelayingTable=bwaVLVlanRelayingTable, bwaVLAdminPassword=bwaVLAdminPassword, bwaVLRunTimeESSID=bwaVLRunTimeESSID, bwaVLFrequencySubsetFrequency=bwaVLFrequencySubsetFrequency, bwaVLFrequencySubsetEntry=bwaVLFrequencySubsetEntry, bwaVLDFSChannelFrequencyNew=bwaVLDFSChannelFrequencyNew, bwaVLNumberOfMacAddressesInDenyList=bwaVLNumberOfMacAddressesInDenyList, bwaVLMirOnlyOption=bwaVLMirOnlyOption, bwaVLConcatenationMaximumNumberOfFrames=bwaVLConcatenationMaximumNumberOfFrames, bwaVLMacPinpointTable=bwaVLMacPinpointTable, bwaVLUnderrunEvents=bwaVLUnderrunEvents, bwaVLNumOfSoftwareRetries=bwaVLNumOfSoftwareRetries, bwaVLDFSChannelIdx=bwaVLDFSChannelIdx, bwaVLAutoSubBandFrequencySubsetActive=bwaVLAutoSubBandFrequencySubsetActive, bwaVLHWRetriesLowPriority=bwaVLHWRetriesLowPriority, bwaVLRegulationMaxEIRP=bwaVLRegulationMaxEIRP, bwaVLEthernetLinkType=bwaVLEthernetLinkType, bwaVLDFSFrequcnyTRAP=bwaVLDFSFrequcnyTRAP, bwaVLAdbStatus=bwaVLAdbStatus, bwaVLReadUpLinkQualityIndicator=bwaVLReadUpLinkQualityIndicator, bwaVLAllowedBandwidth=bwaVLAllowedBandwidth, bwaVLUnitHwVersion=bwaVLUnitHwVersion, bwaVLRunTimeIPaddr=bwaVLRunTimeIPaddr, bwaVLCurrentFrequencySubsetTableIdx=bwaVLCurrentFrequencySubsetTableIdx, bwaVLDFSRadarDetectionChannelsEntry=bwaVLDFSRadarDetectionChannelsEntry, bwaVLDrapTTL=bwaVLDrapTTL, bwaVLTxEvents=bwaVLTxEvents, bwaVLSpectrumAnalysisInformationOFDMFrames=bwaVLSpectrumAnalysisInformationOFDMFrames, bwaVLUnitMacAddress=bwaVLUnitMacAddress, bwaVLEthBroadcastMulticastLimiterSendTrapInterval=bwaVLEthBroadcastMulticastLimiterSendTrapInterval, bwaVLTcpPortRangeConfig=bwaVLTcpPortRangeConfig, bwaVLCurrentFrequencySubsetFrequency=bwaVLCurrentFrequencySubsetFrequency, bwaVLRxEvents=bwaVLRxEvents, bwaVLOverrunEvents=bwaVLOverrunEvents, bwaVLTotalRxConcatenatedFramesDouble=bwaVLTotalRxConcatenatedFramesDouble, bwaVLSetDefaults=bwaVLSetDefaults, bwaVLNoOfInternallyDiscardedMirCir=bwaVLNoOfInternallyDiscardedMirCir, bwaVLSU_3_1D=bwaVLSU_3_1D, bwaVLDFSMinimumPulsesToDetect=bwaVLDFSMinimumPulsesToDetect, bwaVLAdbAuthOption=bwaVLAdbAuthOption, bwaVLEthCounters=bwaVLEthCounters, bwaVLMacAddressDenyListAdd=bwaVLMacAddressDenyListAdd, bwaVLWirelessTrapThreshold=bwaVLWirelessTrapThreshold, bwaVLKey4=bwaVLKey4, bwaOID=bwaOID, bwaVLApClientIpAddress=bwaVLApClientIpAddress, bwaVLRunTimeSubNetMask=bwaVLRunTimeSubNetMask, bwaVLNwMngFilter=bwaVLNwMngFilter, bwaVLMacAddressDenyListEntry=bwaVLMacAddressDenyListEntry, bwaVLMacAddressDenyListRemove=bwaVLMacAddressDenyListRemove, bwaVLNwMngTrapCommunity=bwaVLNwMngTrapCommunity, bwaVLAdbCountryCode=bwaVLAdbCountryCode, bwaVLTotalRecievedDataFrames=bwaVLTotalRecievedDataFrames, bwaVLSU_6_BD=bwaVLSU_6_BD, bwaVLEthernetNegotiationMode=bwaVLEthernetNegotiationMode, bwaVLHardwareRetries=bwaVLHardwareRetries, bwaVLBurstMode=bwaVLBurstMode, bwaVLFTPClientMask=bwaVLFTPClientMask, bwaVLBridgeAgingTime=bwaVLBridgeAgingTime, bwaVLNwTrapTableIdx=bwaVLNwTrapTableIdx, bwaVLAUDefinedFrequencyNew=bwaVLAUDefinedFrequencyNew, bwaVLBridgeParameters=bwaVLBridgeParameters, bwaVLDFSSuWaitingOption=bwaVLDFSSuWaitingOption, bwaVLSecurityMode=bwaVLSecurityMode, bwaVLSetSelectedFreqSubset=bwaVLSetSelectedFreqSubset, bwaVLSystemLocation=bwaVLSystemLocation, bwaVLMaxTxApplicableModulationLevel=bwaVLMaxTxApplicableModulationLevel, bwaVLKey2=bwaVLKey2, bwaVLAdaptiveModulationDecisionThresholds=bwaVLAdaptiveModulationDecisionThresholds, bwaVLAdbTxSuccessModLevel3=bwaVLAdbTxSuccessModLevel3, mngTrapTable=mngTrapTable, bwaVLTotalTransmittedConcatenatedFramesSingle=bwaVLTotalTransmittedConcatenatedFramesSingle, bwaVLTotalRxConcatenatedFramesSingle=bwaVLTotalRxConcatenatedFramesSingle, bwaVLLoadingStatusTRAP=bwaVLLoadingStatusTRAP, bwaVLCirDownlink=bwaVLCirDownlink, bwaVLCurrentEthernetPortState=bwaVLCurrentEthernetPortState, bwaVLARPBroadcastOverrideFilter=bwaVLARPBroadcastOverrideFilter, bwaVLNeighborAuPerSuDistanceLearning=bwaVLNeighborAuPerSuDistanceLearning, bwaVLPreferredAuMacAddress=bwaVLPreferredAuMacAddress, bwaVLSU_54_BD=bwaVLSU_54_BD, bwaVLDeleteAllNwIpRanges=bwaVLDeleteAllNwIpRanges, bwaVLCurrentFrequencySubsetEntry=bwaVLCurrentFrequencySubsetEntry, bwaVLConcatenationOption=bwaVLConcatenationOption, bwaVLVLANPriorityThreshold=bwaVLVLANPriorityThreshold, bwaVLOID=bwaVLOID, bwaVLEthBroadcastMulticastLimiterThreshold=bwaVLEthBroadcastMulticastLimiterThreshold, bwaVLSubBandUpperFrequency=bwaVLSubBandUpperFrequency, bwaVLAdbBurstModeOption=bwaVLAdbBurstModeOption, bwaVLVlanRelayingSupport=bwaVLVlanRelayingSupport, bwaVLMaxNumOfAssociationsLimit=bwaVLMaxNumOfAssociationsLimit, bwaVLMinimumHwRevision=bwaVLMinimumHwRevision, bwaVLAdbTxFailedModLevel1=bwaVLAdbTxFailedModLevel1, bwaVLAntennaGainChange=bwaVLAntennaGainChange, bwaVLNumOfAssociationsSinceLastReset=bwaVLNumOfAssociationsSinceLastReset, bwaVLEventLogDestinationDir=bwaVLEventLogDestinationDir, bwaVLDeleteOneTrapAddr=bwaVLDeleteOneTrapAddr, bwaVLBroadcastRelaying=bwaVLBroadcastRelaying, bwaVLTotalTxEvents=bwaVLTotalTxEvents, bwaVLConcatenationMaxFrameSize=bwaVLConcatenationMaxFrameSize, bwaVLUdpPortRangeNum=bwaVLUdpPortRangeNum, bwaVLSpectrumAnalysisChannelScanPeriod=bwaVLSpectrumAnalysisChannelScanPeriod, bwaVLUdpPortRangeIdx=bwaVLUdpPortRangeIdx, bwaVLVlanRelayingEntry=bwaVLVlanRelayingEntry, bwaVLMacAddressDenyList=bwaVLMacAddressDenyList, bwaVLDFSMaximumNumberOfDetectionsInAssessmentPeriod=bwaVLDFSMaximumNumberOfDetectionsInAssessmentPeriod, bwaVLCRCErrors=bwaVLCRCErrors, bwaVLSoftwareRetrySupport=bwaVLSoftwareRetrySupport, bwaVLMib=bwaVLMib, bwaVLScanningMode=bwaVLScanningMode, bwaVLlowPriorityAIFS=bwaVLlowPriorityAIFS, bwaVLAdbSNR=bwaVLAdbSNR, bwaVLEraseEventLog=bwaVLEraseEventLog, bwaVLSpectrumAnalysisInformationTable=bwaVLSpectrumAnalysisInformationTable, bwaVLUnitControl=bwaVLUnitControl, bwaVLVLANSupport=bwaVLVLANSupport, bwaVLAccessToNwTrap=bwaVLAccessToNwTrap, bwaVLFramesSubmittedViaHighQueue=bwaVLFramesSubmittedViaHighQueue, bwaVLAdbCirRx=bwaVLAdbCirRx, bwaVLAdbConcatenationOption=bwaVLAdbConcatenationOption, bwaVLWirelessLinkPrioritization=bwaVLWirelessLinkPrioritization, bwaVLDroppedFrameEvents=bwaVLDroppedFrameEvents, bwaVLMngIpRangeEntry=bwaVLMngIpRangeEntry, bwaVLAUS_SA=bwaVLAUS_SA, bwaVLVlanForwardingTable=bwaVLVlanForwardingTable, bwaVLAU=bwaVLAU, bwaVLSUPerModulationLevelCountersTxSuccess=bwaVLSUPerModulationLevelCountersTxSuccess, bwaVLRunningSoftwareVersion=bwaVLRunningSoftwareVersion, bwaVLSaveCurrentConfigurationAsOperatorDefaults=bwaVLSaveCurrentConfigurationAsOperatorDefaults, bwaVLCirUplink=bwaVLCirUplink, bwaVLCountryCodeParameters=bwaVLCountryCodeParameters, bwaVLTotalNoOfDataFramesSubmitted=bwaVLTotalNoOfDataFramesSubmitted, bwaVLTcpPortRangeStart=bwaVLTcpPortRangeStart, bwaVLAUDefaultMulticastKeyID=bwaVLAUDefaultMulticastKeyID, bwaVLVlanRelayingTableIdx=bwaVLVlanRelayingTableIdx, bwaVLAdbSecurityMode=bwaVLAdbSecurityMode, bwaVLFTPSwSourceDir=bwaVLFTPSwSourceDir, bwaVLVlanForwardingTableIdx=bwaVLVlanForwardingTableIdx, bwaVLIpFilterRange=bwaVLIpFilterRange, bwaVLAU_EZ=bwaVLAU_EZ, bwaVLOthersTxEvents=bwaVLOthersTxEvents, bwaVLTrapSWVersion=bwaVLTrapSWVersion, bwaVLAntennaGain=bwaVLAntennaGain, bwaVLSU_BD=bwaVLSU_BD, bwaVLSiteSurvey=bwaVLSiteSurvey, bwaVLFramesDropped=bwaVLFramesDropped, bwaVLDFSChannelReuseParameters=bwaVLDFSChannelReuseParameters, bwaVLFTPServerUserName=bwaVLFTPServerUserName, bwaVLCurrentFrequencySubsetTable=bwaVLCurrentFrequencySubsetTable, bwaVLAUagingTRAP=bwaVLAUagingTRAP, bwaVLKey3=bwaVLKey3, bwaVLMacAddressDenyListTableIdx=bwaVLMacAddressDenyListTableIdx, bwaVLAdbTxSuccessModLevel6=bwaVLAdbTxSuccessModLevel6, bwaVLTcpPortPriRTPRTCP=bwaVLTcpPortPriRTPRTCP, bwaVLMngIpRangeEnd=bwaVLMngIpRangeEnd, bwaVLReadOnlyPassword=bwaVLReadOnlyPassword, bwaVLNeighborAuESSID=bwaVLNeighborAuESSID, bwaVLAdbHwRevision=bwaVLAdbHwRevision, bwaVLMaximumModulationLevel=bwaVLMaximumModulationLevel, bwaVLFramesSubmittedViaMidQueue=bwaVLFramesSubmittedViaMidQueue, bwaVLDefaultGWAddress=bwaVLDefaultGWAddress, bwaVLAdbTxSuccessModLevel4=bwaVLAdbTxSuccessModLevel4, bwaVLTrapAccessRights=bwaVLTrapAccessRights, bwaVLEventLogFileParams=bwaVLEventLogFileParams, bwaVLAdbIndex=bwaVLAdbIndex, bwaVLAdbTxSuccessModLevel7=bwaVLAdbTxSuccessModLevel7, bwaVLDrapMaxNumberOfVoiceCalls=bwaVLDrapMaxNumberOfVoiceCalls, bwaVLHWRetriesHighPriority=bwaVLHWRetriesHighPriority, bwaVLPromiscuousModeTRAP=bwaVLPromiscuousModeTRAP, DisplayString=DisplayString, bwaVLDataAndOtherMngFramesToWireless=bwaVLDataAndOtherMngFramesToWireless, MacAddress=MacAddress, bwaVLSUPMirDownlink=bwaVLSUPMirDownlink, bwaVLEthBroadcastMulticatLimiterTRAP=bwaVLEthBroadcastMulticatLimiterTRAP, bwaVLTotalRxConcatenatedFramesMore=bwaVLTotalRxConcatenatedFramesMore, bwaVLSU_24_BD=bwaVLSU_24_BD, bwaVLNeighborAuEntry=bwaVLNeighborAuEntry, bwaVLSubBandSelect=bwaVLSubBandSelect, bwaVLFTPServerParams=bwaVLFTPServerParams, bwaVLSecurityModeSupport=bwaVLSecurityModeSupport, bwaVLAIFS=bwaVLAIFS, bwaVLCountryDependentParameterTableIdx=bwaVLCountryDependentParameterTableIdx, bwaVLDHCPBroadcastOverrideFilter=bwaVLDHCPBroadcastOverrideFilter, bwaVLNeighborAuIdx=bwaVLNeighborAuIdx, ptp_RB_B28=ptp_RB_B28, bwaVLSUassociatedAUTRAP=bwaVLSUassociatedAUTRAP, bwaVLUdpPortRangeTable=bwaVLUdpPortRangeTable, bwaVLTcpPortRangeAdd=bwaVLTcpPortRangeAdd, ptp_BU_B28=ptp_BU_B28, bwaVLEthBroadcastFiltering=bwaVLEthBroadcastFiltering, bwaVLOperatorESSID=bwaVLOperatorESSID, bwaVLUnitPasswords=bwaVLUnitPasswords, bwaVLAdbUnitName=bwaVLAdbUnitName, bwaVLNeighborAuDataEncyptOption=bwaVLNeighborAuDataEncyptOption, bwaVLUdpPortRangeEnd=bwaVLUdpPortRangeEnd, bwaVLEthBroadcastMulticastLimiterOption=bwaVLEthBroadcastMulticastLimiterOption, bwaVLSpectrumAnalysisInformationTableIdx=bwaVLSpectrumAnalysisInformationTableIdx, bwaVLAUBeaconsToWireless=bwaVLAUBeaconsToWireless, bwaVLAUAdbEntry=bwaVLAUAdbEntry, bwaVLMacAddressDatabase=bwaVLMacAddressDatabase, bwaVLSU=bwaVLSU, bwaVLCountryDependentParameterEntry=bwaVLCountryDependentParameterEntry, bwaVLTotalRxEvents=bwaVLTotalRxEvents, bwaVLDrapGatewaysTable=bwaVLDrapGatewaysTable, bwaVLSpectrumAnalysisInformationEntry=bwaVLSpectrumAnalysisInformationEntry, bwaVLKey1=bwaVLKey1, bwaVLMulticastModulationLevel=bwaVLMulticastModulationLevel, bwaVLIpID=bwaVLIpID, bwaVLTrafficPriUdpTcpPortRange=bwaVLTrafficPriUdpTcpPortRange, bwaVLVlanDataPriority=bwaVLVlanDataPriority, mngTrapEntry=mngTrapEntry, bwaVLSUPerModulationLevelCountersApplicableModLevel=bwaVLSUPerModulationLevelCountersApplicableModLevel)
mibBuilder.exportSymbols("BWA-DOT11-WLAN-MIB", bwaVLDFSMoveFreqNew=bwaVLDFSMoveFreqNew, bwaVLMaximumTransmitPowerTable=bwaVLMaximumTransmitPowerTable, bwaVLDeleteAllNwIpAddrs=bwaVLDeleteAllNwIpAddrs, bwaVLFramesDelayedDueToSwRetry=bwaVLFramesDelayedDueToSwRetry, bwaVLVLANQinQ=bwaVLVLANQinQ, bwaVLTrapLog=bwaVLTrapLog, bwaVLMaximumTxPowerRange=bwaVLMaximumTxPowerRange, bwaVLAdbDistance=bwaVLAdbDistance, bwaVLVlanForwardingSupport=bwaVLVlanForwardingSupport, bwaVLUdpTcpPortRangePrioritizationOption=bwaVLUdpTcpPortRangePrioritizationOption, bwaVLDeleteAllUserFilters=bwaVLDeleteAllUserFilters, bwaVLAdbTxFailedModLevel2=bwaVLAdbTxFailedModLevel2, bwaVLDataEncryptionOption=bwaVLDataEncryptionOption, bwaVLIPPrecedenceThreshold=bwaVLIPPrecedenceThreshold, bwaVLTransmitPowerIdx=bwaVLTransmitPowerIdx, bwaVLUseDhcp=bwaVLUseDhcp, mngIpFilterTable=mngIpFilterTable, bwaVLCellDistanceParameters=bwaVLCellDistanceParameters, bwaVLAESEncryptionSupport=bwaVLAESEncryptionSupport, products=products, bwaVLVlanManagementPriority=bwaVLVlanManagementPriority, bwaVLDFSRadarActivityAssessmentPeriod=bwaVLDFSRadarActivityAssessmentPeriod, bwaVLDrapGatewayEntry=bwaVLDrapGatewayEntry, bwaVLMainVersionFileName=bwaVLMainVersionFileName, bwaVLVlanForwardingEntry=bwaVLVlanForwardingEntry, bwaVLAutomaticChannelSelection=bwaVLAutomaticChannelSelection, bwaVLFramesSubmittedViaLowQueue=bwaVLFramesSubmittedViaLowQueue, bwaVLAdbTxFailedModLevel5=bwaVLAdbTxFailedModLevel5, bwaVLNeighborAuMark=bwaVLNeighborAuMark, bwaVLNeighborAuAssocLoadStatus=bwaVLNeighborAuAssocLoadStatus, bwa4900_AU_SA=bwa4900_AU_SA, bwaVLAdbTxFailedModLevel7=bwaVLAdbTxFailedModLevel7, bwaVLUnitIpAddress=bwaVLUnitIpAddress, bwaVLMacPinpointEntry=bwaVLMacPinpointEntry, bwaVLEventLogPolicy=bwaVLEventLogPolicy, bwaVLCurrentNumOfAssociations=bwaVLCurrentNumOfAssociations, bwaVLSerialNumber=bwaVLSerialNumber, bwaVLNwMngIpTableIdx=bwaVLNwMngIpTableIdx, bwaVLRecievedBadFrames=bwaVLRecievedBadFrames, bwaVLNwMngTrapAddress=bwaVLNwMngTrapAddress, bwaVLDisassociate=bwaVLDisassociate, bwaVLWirelessLinkPrioritizationOption=bwaVLWirelessLinkPrioritizationOption, bwaVLDFSRadarDetectionChannelsTable=bwaVLDFSRadarDetectionChannelsTable, bwaVLQinQProviderVlanID=bwaVLQinQProviderVlanID, bwaVLUdpPortRangeEntry=bwaVLUdpPortRangeEntry, bwaVLConcatenationParameters=bwaVLConcatenationParameters, bwaVLAdbTxFailedModLevel3=bwaVLAdbTxFailedModLevel3, bwaVLLowPriorityTrafficMinimumPercent=bwaVLLowPriorityTrafficMinimumPercent, bwaVLPowerUpFromReset=bwaVLPowerUpFromReset, bwa=bwa, bwaVLNeighborAuBurstModeOption=bwaVLNeighborAuBurstModeOption, bwaVLAutoSubBandFrequencySubsetFrequency=bwaVLAutoSubBandFrequencySubsetFrequency, bwaVLConfigurationFileName=bwaVLConfigurationFileName, bwaVLTrafficPriIPToS=bwaVLTrafficPriIPToS, bwaVLDfsSupport=bwaVLDfsSupport, bwaVLFTPClientIPAddress=bwaVLFTPClientIPAddress, bwaVLTelnetLogoutTimer=bwaVLTelnetLogoutTimer, bwaVLAUDefinedFrequency=bwaVLAUDefinedFrequency, bwaVLTxWirelessToEthernet=bwaVLTxWirelessToEthernet, bwaVLRadioBand=bwaVLRadioBand, bwaVLBestAuSupport=bwaVLBestAuSupport, bwaVLCountryDependentParamsTable=bwaVLCountryDependentParamsTable, bwaVLShadowVersionNumber=bwaVLShadowVersionNumber, bwaVLDrapSupport=bwaVLDrapSupport, bwaVLAverageReceiveSNR=bwaVLAverageReceiveSNR, bwaLighteAPWorkingMode=bwaLighteAPWorkingMode, bwaVLNeighborAuMacAdd=bwaVLNeighborAuMacAdd, bwaVLDHCPUnicastOverrideFilter=bwaVLDHCPUnicastOverrideFilter, bwaVLWirelessLinkEvents=bwaVLWirelessLinkEvents, bwaVLSUDefaultKeyID=bwaVLSUDefaultKeyID, bwaVLAUAdbResetAllModulationLevelCounters=bwaVLAUAdbResetAllModulationLevelCounters, bwaVLAU_BS=bwaVLAU_BS, bwaVLNoOfDuplicateFramesDiscarded=bwaVLNoOfDuplicateFramesDiscarded, bwaVLVlanIdForwarding=bwaVLVlanIdForwarding, bwaVLAirInterface=bwaVLAirInterface, bwaVLFTPGatewayIpAddress=bwaVLFTPGatewayIpAddress, bwaVLAUBurstDurationLowPriority=bwaVLAUBurstDurationLowPriority, bwaVLTransmitPowerTable=bwaVLTransmitPowerTable, mptUnitMACAddress=mptUnitMACAddress)
