...
mibBuilder.exportSymbols("UPS2-MIB", upsBatteryCapacity=upsBatteryCapacity, upsExtMeasMaxTemp=upsExtMeasMaxTemp, upsInputUtilityVoltage=upsInputUtilityVoltage, upsAddlFuncsOutputCurrent=upsAddlFuncsOutputCurrent, upsIndex=upsIndex, upsExtMeasContact2AlarmControl=upsExtMeasContact2AlarmControl, upsBatteryTest=upsBatteryTest, upsExtMeasMaxTempAlarmControl=upsExtMeasMaxTempAlarmControl, upsAddlFuncsTable=upsAddlFuncsTable, upsLowBatteryWarning=upsLowBatteryWarning, upsInputVoltage=upsInputVoltage, upsRunTimeCalibration=upsRunTimeCalibration, upsBatteryTable=upsBatteryTable, upsExtMeasMaxHumidityAlarmControl=upsExtMeasMaxHumidityAlarmControl, upsExtMeasContact3AlarmControl=upsExtMeasContact3AlarmControl, upsInput=upsInput, upsBattery=upsBattery, upsExtMeas=upsExtMeas, upsStatusTable=upsStatusTable, upsExtMeasTemp=upsExtMeasTemp, upsExtMeasHumidity=upsExtMeasHumidity, upsIdEntry=upsIdEntry, upsAddlFuncsStatusOperational=upsAddlFuncsStatusOperational, upsExtMeasFwVersion=upsExtMeasFwVersion, upsConfigEntry=upsConfigEntry, upsAddlFuncsStatusFault=upsAddlFuncsStatusFault, upsOutputPower=upsOutputPower, upsStatus=upsStatus, upsExtMeasAlarmStatus=upsExtMeasAlarmStatus, upsOutputTable=upsOutputTable, upsConfig=upsConfig, upsExtMeasMinHumidityAlarmControl=upsExtMeasMinHumidityAlarmControl, upsAddlFuncsNumBatteryPacks=upsAddlFuncsNumBatteryPacks, upsBatteryEntry=upsBatteryEntry, upsConfigAlarm=upsConfigAlarm, upsInputMinVoltage=upsInputMinVoltage, upsAddlFuncsEntry=upsAddlFuncsEntry, upsSystem=upsSystem, upsInputTable=upsInputTable, upsInputEntry=upsInputEntry, upsOutputVoltage=upsOutputVoltage, upsExtMeasMinTempAlarmControl=upsExtMeasMinTempAlarmControl, upsAddlFuncsOutputApparentPower=upsAddlFuncsOutputApparentPower, upsId=upsId, upsModelType=upsModelType, upsStatusTemp=upsStatusTemp, upsExtMeasContact1AlarmControl=upsExtMeasContact1AlarmControl, upsExtMeasTable=upsExtMeasTable, upsOutputUtilityVoltage=upsOutputUtilityVoltage, upsAddlFuncsConfigDisable=upsAddlFuncsConfigDisable, upsOutputEntry=upsOutputEntry, upsBatteryTestTime=upsBatteryTestTime, upsExtMeasMinHumidity=upsExtMeasMinHumidity, upsOutput=upsOutput, upsInputMaxVoltage=upsInputMaxVoltage, upsBatteryVoltage=upsBatteryVoltage, upsAddlFuncs=upsAddlFuncs, upsConfigTable=upsConfigTable, upsAddlFuncsConfigPassword=upsAddlFuncsConfigPassword, upsEstimatedRunTimeRemaining=upsEstimatedRunTimeRemaining, upsIdTable=upsIdTable, upsExtMeasMaxHumidity=upsExtMeasMaxHumidity, upsAddlFuncsNumBadBatteryPacks=upsAddlFuncsNumBadBatteryPacks, upsStatusEntry=upsStatusEntry, upsManufDate=upsManufDate, upsConfigRestoreDefaults=upsConfigRestoreDefaults, upsBatteryTestResult=upsBatteryTestResult, upsExtMeasEntry=upsExtMeasEntry, upsSerialNumber=upsSerialNumber, upsNumUPSs=upsNumUPSs, upsExtMeasMinTemp=upsExtMeasMinTemp, upsStatusFault=upsStatusFault, upsStatusOperational=upsStatusOperational, upsTransferCause=upsTransferCause, upsAddlFuncsConfigBypass=upsAddlFuncsConfigBypass, upsName=upsName, upsInputFrequency=upsInputFrequency, upsInputFailureSensitivity=upsInputFailureSensitivity, upsExtMeasContact4AlarmControl=upsExtMeasContact4AlarmControl, upsFwVersion=upsFwVersion)
