...
mibBuilder.exportSymbols("UPS2-MIB", upsIdEntry=upsIdEntry, upsExtMeasAlarmStatus=upsExtMeasAlarmStatus, upsStatusTable=upsStatusTable, upsNumUPSs=upsNumUPSs, upsExtMeasContact3AlarmControl=upsExtMeasContact3AlarmControl, upsConfig=upsConfig, upsStatusOperational=upsStatusOperational, upsAddlFuncsOutputApparentPower=upsAddlFuncsOutputApparentPower, upsInputFailureSensitivity=upsInputFailureSensitivity, upsFwVersion=upsFwVersion, upsManufDate=upsManufDate, upsAddlFuncsEntry=upsAddlFuncsEntry, upsBatteryTable=upsBatteryTable, upsId=upsId, upsExtMeasTable=upsExtMeasTable, upsOutputUtilityVoltage=upsOutputUtilityVoltage, upsExtMeasEntry=upsExtMeasEntry, upsInput=upsInput, upsInputTable=upsInputTable, upsBatteryTestResult=upsBatteryTestResult, upsInputFrequency=upsInputFrequency, upsEstimatedRunTimeRemaining=upsEstimatedRunTimeRemaining, upsConfigRestoreDefaults=upsConfigRestoreDefaults, upsAddlFuncsConfigBypass=upsAddlFuncsConfigBypass, upsExtMeasMaxHumidityAlarmControl=upsExtMeasMaxHumidityAlarmControl, upsSerialNumber=upsSerialNumber, upsOutputTable=upsOutputTable, upsOutputPower=upsOutputPower, upsAddlFuncs=upsAddlFuncs, upsBatteryTestTime=upsBatteryTestTime, upsOutputVoltage=upsOutputVoltage, upsConfigAlarm=upsConfigAlarm, upsExtMeasMaxTempAlarmControl=upsExtMeasMaxTempAlarmControl, upsAddlFuncsStatusOperational=upsAddlFuncsStatusOperational, upsExtMeasMaxHumidity=upsExtMeasMaxHumidity, upsExtMeasHumidity=upsExtMeasHumidity, upsAddlFuncsConfigPassword=upsAddlFuncsConfigPassword, upsOutputEntry=upsOutputEntry, upsAddlFuncsNumBatteryPacks=upsAddlFuncsNumBatteryPacks, upsInputUtilityVoltage=upsInputUtilityVoltage, upsConfigTable=upsConfigTable, upsBattery=upsBattery, upsStatus=upsStatus, upsExtMeasMinHumidity=upsExtMeasMinHumidity, upsBatteryEntry=upsBatteryEntry, upsInputVoltage=upsInputVoltage, upsAddlFuncsOutputCurrent=upsAddlFuncsOutputCurrent, upsBatteryCapacity=upsBatteryCapacity, upsExtMeasTemp=upsExtMeasTemp, upsExtMeasContact2AlarmControl=upsExtMeasContact2AlarmControl, upsStatusTemp=upsStatusTemp, upsStatusEntry=upsStatusEntry, upsModelType=upsModelType, upsExtMeas=upsExtMeas, upsIdTable=upsIdTable, upsAddlFuncsTable=upsAddlFuncsTable, upsInputEntry=upsInputEntry, upsAddlFuncsStatusFault=upsAddlFuncsStatusFault, upsExtMeasMaxTemp=upsExtMeasMaxTemp, upsInputMinVoltage=upsInputMinVoltage, upsAddlFuncsConfigDisable=upsAddlFuncsConfigDisable, upsOutput=upsOutput, upsSystem=upsSystem, upsConfigEntry=upsConfigEntry, upsBatteryVoltage=upsBatteryVoltage, upsExtMeasContact4AlarmControl=upsExtMeasContact4AlarmControl, upsTransferCause=upsTransferCause, upsExtMeasMinHumidityAlarmControl=upsExtMeasMinHumidityAlarmControl, upsIndex=upsIndex, upsAddlFuncsNumBadBatteryPacks=upsAddlFuncsNumBadBatteryPacks, upsName=upsName, upsExtMeasFwVersion=upsExtMeasFwVersion, upsLowBatteryWarning=upsLowBatteryWarning, upsInputMaxVoltage=upsInputMaxVoltage, upsRunTimeCalibration=upsRunTimeCalibration, upsStatusFault=upsStatusFault, upsExtMeasContact1AlarmControl=upsExtMeasContact1AlarmControl, upsExtMeasMinTemp=upsExtMeasMinTemp, upsBatteryTest=upsBatteryTest, upsExtMeasMinTempAlarmControl=upsExtMeasMinTempAlarmControl)
