...
mibBuilder.exportSymbols("UPS2-MIB", upsBatteryTest=upsBatteryTest, upsAddlFuncsConfigBypass=upsAddlFuncsConfigBypass, upsExtMeasMaxTemp=upsExtMeasMaxTemp, upsExtMeasMaxHumidityAlarmControl=upsExtMeasMaxHumidityAlarmControl, upsAddlFuncsOutputCurrent=upsAddlFuncsOutputCurrent, upsTransferCause=upsTransferCause, upsInputMaxVoltage=upsInputMaxVoltage, upsConfigTable=upsConfigTable, upsExtMeasMinHumidity=upsExtMeasMinHumidity, upsExtMeasContact3AlarmControl=upsExtMeasContact3AlarmControl, upsAddlFuncsConfigDisable=upsAddlFuncsConfigDisable, upsManufDate=upsManufDate, upsAddlFuncsOutputApparentPower=upsAddlFuncsOutputApparentPower, upsLowBatteryWarning=upsLowBatteryWarning, upsOutputTable=upsOutputTable, upsBatteryEntry=upsBatteryEntry, upsNumUPSs=upsNumUPSs, upsAddlFuncsTable=upsAddlFuncsTable, upsInputEntry=upsInputEntry, upsExtMeasHumidity=upsExtMeasHumidity, upsEstimatedRunTimeRemaining=upsEstimatedRunTimeRemaining, upsExtMeasContact2AlarmControl=upsExtMeasContact2AlarmControl, upsExtMeasMinTempAlarmControl=upsExtMeasMinTempAlarmControl, upsExtMeasEntry=upsExtMeasEntry, upsRunTimeCalibration=upsRunTimeCalibration, upsInputFrequency=upsInputFrequency, upsConfigRestoreDefaults=upsConfigRestoreDefaults, upsName=upsName, upsIndex=upsIndex, upsModelType=upsModelType, upsExtMeasTable=upsExtMeasTable, upsInputMinVoltage=upsInputMinVoltage, upsAddlFuncsEntry=upsAddlFuncsEntry, upsAddlFuncs=upsAddlFuncs, upsOutput=upsOutput, upsIdEntry=upsIdEntry, upsAddlFuncsStatusFault=upsAddlFuncsStatusFault, upsStatusOperational=upsStatusOperational, upsExtMeas=upsExtMeas, upsAddlFuncsNumBadBatteryPacks=upsAddlFuncsNumBadBatteryPacks, upsInputVoltage=upsInputVoltage, upsConfigEntry=upsConfigEntry, upsId=upsId, upsBatteryTestTime=upsBatteryTestTime, upsAddlFuncsStatusOperational=upsAddlFuncsStatusOperational, upsSerialNumber=upsSerialNumber, upsExtMeasAlarmStatus=upsExtMeasAlarmStatus, upsOutputPower=upsOutputPower, upsBatteryVoltage=upsBatteryVoltage, upsExtMeasMinHumidityAlarmControl=upsExtMeasMinHumidityAlarmControl, upsInputTable=upsInputTable, upsConfigAlarm=upsConfigAlarm, upsOutputUtilityVoltage=upsOutputUtilityVoltage, upsInputUtilityVoltage=upsInputUtilityVoltage, upsInputFailureSensitivity=upsInputFailureSensitivity, upsStatusEntry=upsStatusEntry, upsBatteryCapacity=upsBatteryCapacity, upsExtMeasTemp=upsExtMeasTemp, upsStatusTemp=upsStatusTemp, upsInput=upsInput, upsExtMeasMaxHumidity=upsExtMeasMaxHumidity, upsOutputEntry=upsOutputEntry, upsExtMeasMaxTempAlarmControl=upsExtMeasMaxTempAlarmControl, upsExtMeasMinTemp=upsExtMeasMinTemp, upsStatusTable=upsStatusTable, upsOutputVoltage=upsOutputVoltage, upsAddlFuncsConfigPassword=upsAddlFuncsConfigPassword, upsSystem=upsSystem, upsFwVersion=upsFwVersion, upsStatus=upsStatus, upsBattery=upsBattery, upsExtMeasContact4AlarmControl=upsExtMeasContact4AlarmControl, upsConfig=upsConfig, upsBatteryTestResult=upsBatteryTestResult, upsStatusFault=upsStatusFault, upsAddlFuncsNumBatteryPacks=upsAddlFuncsNumBatteryPacks, upsBatteryTable=upsBatteryTable, upsExtMeasContact1AlarmControl=upsExtMeasContact1AlarmControl, upsIdTable=upsIdTable, upsExtMeasFwVersion=upsExtMeasFwVersion)
