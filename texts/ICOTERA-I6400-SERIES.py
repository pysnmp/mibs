...
# Produced by pysmi-1.1.3 at Sat Nov 20 17:20:01 2021
...
TimeTicks, Unsigned32, Integer32, IpAddress, Bits, MibIdentifier, Gauge32, ModuleIdentity, iso, ObjectIdentity, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "Integer32", "IpAddress", "Bits", "MibIdentifier", "Gauge32", "ModuleIdentity", "iso", "ObjectIdentity", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", histMetrTotalSkips=histMetrTotalSkips, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, transceiverDdmRxPower=transceiverDdmRxPower, curMetrGroupAddr=curMetrGroupAddr, curMetrAvgDelta=curMetrAvgDelta, upgStatus=upgStatus, transceiverEthernetCompliance=transceiverEthernetCompliance, ictMgmtMib=ictMgmtMib, icotera=icotera, historyListEntry=historyListEntry, histMetrStartTimestamp=histMetrStartTimestamp, ictServicesMibs=ictServicesMibs, ictFwUpg=ictFwUpg, curMetrStartTimestamp=curMetrStartTimestamp, histMetrPps=histMetrPps, performCpeReboot=performCpeReboot, transceiverDiagCapable=transceiverDiagCapable, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, histMetrTotalPackets=histMetrTotalPackets, IctJitter=IctJitter, histMetrTotalReordered=histMetrTotalReordered, ictMgmt=ictMgmt, catvModulePowerLevel=catvModulePowerLevel, histMetrStreamType=histMetrStreamType, histMetrMemberPorts=histMetrMemberPorts, historyMetricsEntry=historyMetricsEntry, histMetrTotalMaxDelta=histMetrTotalMaxDelta, histMetrSrcPort=histMetrSrcPort, curMetrTotalBytes=curMetrTotalBytes, curMetrSrcPort=curMetrSrcPort, curGroupIndex=curGroupIndex, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, curMetrMemberPorts=curMetrMemberPorts, histMetrGroupAddr=histMetrGroupAddr, catvModuleFilter=catvModuleFilter, ictMcastAnalyzer=ictMcastAnalyzer, cfgExecute=cfgExecute, curMetrTotalSkips=curMetrTotalSkips, curMetrTotalLost=curMetrTotalLost, curMetrDstPort=curMetrDstPort, transceiverDdmTemperature=transceiverDdmTemperature, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, transceiverLinkLength=transceiverLinkLength, curMetrSourceAddr=curMetrSourceAddr, histMetrStopTimestamp=histMetrStopTimestamp, histMetrJitter=histMetrJitter, curMetrAvgPps=curMetrAvgPps, curMetrDiscontinuities=curMetrDiscontinuities, upgExecute=upgExecute, curMetrTotalAvgDelta=curMetrTotalAvgDelta, curMetrAvgKbps=curMetrAvgKbps, ictTransceiver=ictTransceiver, curMetrStreamType=curMetrStreamType, currentListEntry=currentListEntry, histMetrDiscontinuities=histMetrDiscontinuities, histMetrDstPort=histMetrDstPort, cfgStatus=cfgStatus, transceiverTransceiverType=transceiverTransceiverType, curMetrMaxDelta=curMetrMaxDelta, IctPortList=IctPortList, curMetrAvgLostPps=curMetrAvgLostPps, transceiverLaserWavelength=transceiverLaserWavelength, curMetrTotalReordered=curMetrTotalReordered, ictFacRst=ictFacRst, catvModuleRflevel=catvModuleRflevel, histMetrMaxDelta=histMetrMaxDelta, curMetrPps=curMetrPps, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, curMetrStopTimestamp=curMetrStopTimestamp, histMetrAvgLostPps=histMetrAvgLostPps, histMetrAvgKbps=histMetrAvgKbps, curMetrKbps=curMetrKbps, histGroupIndex=histGroupIndex, histMetrSkips=histMetrSkips, ictReset=ictReset, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, transceiverDdmTxPower=transceiverDdmTxPower, histMetrAvgDelta=histMetrAvgDelta, histMetrReordered=histMetrReordered, histMetrSourceAddr=histMetrSourceAddr, curGroupAddr=curGroupAddr, currentMetricsEntry=currentMetricsEntry, curMetrSkips=curMetrSkips, histGroupAddr=histGroupAddr, cfgTftpPath=cfgTftpPath, histMetrKbps=histMetrKbps, histMetrAvgPps=histMetrAvgPps, catvModuleLowSignal=catvModuleLowSignal, IctDelta=IctDelta, curMetrJitter=curMetrJitter, PYSNMP_MODULE_ID=icotera, IctTimeStamp=IctTimeStamp, curMetrTotalPackets=curMetrTotalPackets, catvModuleSignalDetected=catvModuleSignalDetected, transceiverConnectorType=transceiverConnectorType, ictFacRstMib=ictFacRstMib, upgUrl=upgUrl, histMetrTotalAvgDelta=histMetrTotalAvgDelta, ictReboot=ictReboot, ictIGW1k=ictIGW1k, catvModuleAdminStatus=catvModuleAdminStatus, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, ictCatv=ictCatv, transceiverDdmVoltage=transceiverDdmVoltage, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrTotalMaxDelta=curMetrTotalMaxDelta, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, ictServices=ictServices, curMetrReordered=curMetrReordered, histMetrLost=histMetrLost, ictCfgUpdate=ictCfgUpdate, histMetrTotalLost=histMetrTotalLost, curMetrLost=curMetrLost, performFactoryReset=performFactoryReset, histMetrTotalBytes=histMetrTotalBytes)
