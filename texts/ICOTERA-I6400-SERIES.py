...
Integer32, Bits, MibIdentifier, iso, ObjectIdentity, Counter64, IpAddress, ModuleIdentity, enterprises, Gauge32, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "MibIdentifier", "iso", "ObjectIdentity", "Counter64", "IpAddress", "ModuleIdentity", "enterprises", "Gauge32", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", histGroupIndex=histGroupIndex, curMetrKbps=curMetrKbps, curMetrJitter=curMetrJitter, cfgTftpPath=cfgTftpPath, histMetrAvgLostPps=histMetrAvgLostPps, curMetrMaxDelta=curMetrMaxDelta, curMetrTotalPackets=curMetrTotalPackets, catvModuleAdminStatus=catvModuleAdminStatus, transceiverLaserWavelength=transceiverLaserWavelength, ictIGW1k=ictIGW1k, histMetrLost=histMetrLost, histMetrTotalAvgDelta=histMetrTotalAvgDelta, histMetrAvgPps=histMetrAvgPps, curMetrStopTimestamp=curMetrStopTimestamp, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, histMetrStartTimestamp=histMetrStartTimestamp, histMetrTotalLost=histMetrTotalLost, currentMetricsEntry=currentMetricsEntry, curMetrTotalReordered=curMetrTotalReordered, ictFacRstMib=ictFacRstMib, catvModuleLowSignal=catvModuleLowSignal, upgStatus=upgStatus, histMetrTotalSkips=histMetrTotalSkips, transceiverConnectorType=transceiverConnectorType, curMetrDiscontinuities=curMetrDiscontinuities, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, curMetrSrcPort=curMetrSrcPort, ictServices=ictServices, curMetrAvgPps=curMetrAvgPps, ictMgmt=ictMgmt, curMetrGroupAddr=curMetrGroupAddr, performFactoryReset=performFactoryReset, ictTransceiver=ictTransceiver, ictReboot=ictReboot, IctTimeStamp=IctTimeStamp, ictMcastAnalyzer=ictMcastAnalyzer, histMetrDiscontinuities=histMetrDiscontinuities, upgUrl=upgUrl, IctJitter=IctJitter, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, upgExecute=upgExecute, histMetrMemberPorts=histMetrMemberPorts, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, histMetrTotalBytes=histMetrTotalBytes, historyListEntry=historyListEntry, histMetrSkips=histMetrSkips, catvModuleRflevel=catvModuleRflevel, curMetrDstPort=curMetrDstPort, transceiverEthernetCompliance=transceiverEthernetCompliance, transceiverDdmRxPower=transceiverDdmRxPower, PYSNMP_MODULE_ID=icotera, IctDelta=IctDelta, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, IctPortList=IctPortList, transceiverDiagCapable=transceiverDiagCapable, curMetrTotalAvgDelta=curMetrTotalAvgDelta, curMetrReordered=curMetrReordered, histMetrAvgDelta=histMetrAvgDelta, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, curMetrLost=curMetrLost, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, transceiverDdmTemperature=transceiverDdmTemperature, curMetrTotalLost=curMetrTotalLost, histMetrJitter=histMetrJitter, transceiverLinkLength=transceiverLinkLength, catvModuleSignalDetected=catvModuleSignalDetected, ictCatv=ictCatv, histMetrReordered=histMetrReordered, currentListEntry=currentListEntry, catvModuleFilter=catvModuleFilter, cfgExecute=cfgExecute, icotera=icotera, histMetrAvgKbps=histMetrAvgKbps, histMetrSrcPort=histMetrSrcPort, curMetrAvgKbps=curMetrAvgKbps, cfgStatus=cfgStatus, transceiverDdmTxPower=transceiverDdmTxPower, curMetrTotalSkips=curMetrTotalSkips, ictFwUpg=ictFwUpg, ictMgmtMib=ictMgmtMib, histMetrStreamType=histMetrStreamType, histMetrMaxDelta=histMetrMaxDelta, histGroupAddr=histGroupAddr, curGroupIndex=curGroupIndex, histMetrTotalPackets=histMetrTotalPackets, histMetrPps=histMetrPps, ictServicesMibs=ictServicesMibs, transceiverDdmVoltage=transceiverDdmVoltage, ictCfgUpdate=ictCfgUpdate, ictReset=ictReset, curMetrAvgDelta=curMetrAvgDelta, curMetrPps=curMetrPps, curGroupAddr=curGroupAddr, performCpeReboot=performCpeReboot, histMetrTotalReordered=histMetrTotalReordered, histMetrTotalMaxDelta=histMetrTotalMaxDelta, histMetrDstPort=histMetrDstPort, histMetrGroupAddr=histMetrGroupAddr, histMetrStopTimestamp=histMetrStopTimestamp, historyMetricsEntry=historyMetricsEntry, ictFacRst=ictFacRst, histMetrSourceAddr=histMetrSourceAddr, transceiverTransceiverType=transceiverTransceiverType, curMetrSkips=curMetrSkips, curMetrSourceAddr=curMetrSourceAddr, curMetrTotalMaxDelta=curMetrTotalMaxDelta, histMetrKbps=histMetrKbps, curMetrAvgLostPps=curMetrAvgLostPps, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, curMetrTotalBytes=curMetrTotalBytes, curMetrStreamType=curMetrStreamType, curMetrStartTimestamp=curMetrStartTimestamp, curMetrMemberPorts=curMetrMemberPorts, catvModulePowerLevel=catvModulePowerLevel)
