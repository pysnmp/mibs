...
ModuleIdentity, TimeTicks, MibIdentifier, Bits, Unsigned32, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, Gauge32, iso, Integer32, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "MibIdentifier", "Bits", "Unsigned32", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "Gauge32", "iso", "Integer32", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", ictFacRstMib=ictFacRstMib, curMetrStartTimestamp=curMetrStartTimestamp, histMetrStreamType=histMetrStreamType, upgUrl=upgUrl, histMetrTotalAvgDelta=histMetrTotalAvgDelta, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, histMetrTotalPackets=histMetrTotalPackets, performCpeReboot=performCpeReboot, curMetrSkips=curMetrSkips, curMetrLost=curMetrLost, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, histMetrMemberPorts=histMetrMemberPorts, curMetrKbps=curMetrKbps, catvModuleLowSignal=catvModuleLowSignal, histGroupIndex=histGroupIndex, catvModuleAdminStatus=catvModuleAdminStatus, curMetrTotalAvgDelta=curMetrTotalAvgDelta, curMetrTotalReordered=curMetrTotalReordered, histMetrDiscontinuities=histMetrDiscontinuities, IctTimeStamp=IctTimeStamp, histMetrLost=histMetrLost, ictFwUpg=ictFwUpg, transceiverDdmRxPower=transceiverDdmRxPower, curMetrSrcPort=curMetrSrcPort, histGroupAddr=histGroupAddr, PYSNMP_MODULE_ID=icotera, histMetrReordered=histMetrReordered, curMetrTotalSkips=curMetrTotalSkips, curMetrTotalLost=curMetrTotalLost, curMetrTotalPackets=curMetrTotalPackets, ictIGW1k=ictIGW1k, curGroupAddr=curGroupAddr, histMetrTotalSkips=histMetrTotalSkips, icotera=icotera, ictCatv=ictCatv, histMetrSkips=histMetrSkips, histMetrKbps=histMetrKbps, curGroupIndex=curGroupIndex, ictReset=ictReset, ictCfgUpdate=ictCfgUpdate, histMetrStartTimestamp=histMetrStartTimestamp, catvModuleSignalDetected=catvModuleSignalDetected, currentListEntry=currentListEntry, curMetrJitter=curMetrJitter, IctJitter=IctJitter, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, transceiverLinkLength=transceiverLinkLength, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, curMetrAvgDelta=curMetrAvgDelta, histMetrPps=histMetrPps, transceiverDdmVoltage=transceiverDdmVoltage, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, transceiverDdmTemperature=transceiverDdmTemperature, curMetrTotalMaxDelta=curMetrTotalMaxDelta, cfgTftpPath=cfgTftpPath, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, curMetrAvgLostPps=curMetrAvgLostPps, ictServices=ictServices, histMetrSourceAddr=histMetrSourceAddr, histMetrAvgLostPps=histMetrAvgLostPps, ictTransceiver=ictTransceiver, transceiverConnectorType=transceiverConnectorType, currentMetricsEntry=currentMetricsEntry, cfgExecute=cfgExecute, ictMcastAnalyzer=ictMcastAnalyzer, catvModulePowerLevel=catvModulePowerLevel, histMetrDstPort=histMetrDstPort, transceiverEthernetCompliance=transceiverEthernetCompliance, histMetrJitter=histMetrJitter, histMetrStopTimestamp=histMetrStopTimestamp, ictReboot=ictReboot, performFactoryReset=performFactoryReset, ictMgmt=ictMgmt, curMetrMaxDelta=curMetrMaxDelta, histMetrTotalBytes=histMetrTotalBytes, catvModuleFilter=catvModuleFilter, histMetrAvgPps=histMetrAvgPps, ictServicesMibs=ictServicesMibs, upgStatus=upgStatus, transceiverLaserWavelength=transceiverLaserWavelength, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, curMetrStopTimestamp=curMetrStopTimestamp, IctPortList=IctPortList, transceiverDdmTxPower=transceiverDdmTxPower, historyMetricsEntry=historyMetricsEntry, histMetrTotalLost=histMetrTotalLost, curMetrTotalBytes=curMetrTotalBytes, curMetrReordered=curMetrReordered, curMetrStreamType=curMetrStreamType, histMetrGroupAddr=histMetrGroupAddr, curMetrGroupAddr=curMetrGroupAddr, curMetrPps=curMetrPps, transceiverDiagCapable=transceiverDiagCapable, histMetrAvgDelta=histMetrAvgDelta, histMetrTotalMaxDelta=histMetrTotalMaxDelta, curMetrMemberPorts=curMetrMemberPorts, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, ictFacRst=ictFacRst, curMetrDstPort=curMetrDstPort, ictMgmtMib=ictMgmtMib, IctDelta=IctDelta, curMetrAvgKbps=curMetrAvgKbps, curMetrSourceAddr=curMetrSourceAddr, histMetrAvgKbps=histMetrAvgKbps, curMetrDiscontinuities=curMetrDiscontinuities, upgExecute=upgExecute, catvModuleRflevel=catvModuleRflevel, cfgStatus=cfgStatus, transceiverTransceiverType=transceiverTransceiverType, curMetrAvgPps=curMetrAvgPps, histMetrTotalReordered=histMetrTotalReordered, histMetrMaxDelta=histMetrMaxDelta, histMetrSrcPort=histMetrSrcPort, historyListEntry=historyListEntry)
