...
# Produced by pysmi-1.1.8 at Mon Jan 17 14:36:46 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, TimeTicks, enterprises, NotificationType, MibIdentifier, Bits, Gauge32, Unsigned32, ObjectIdentity, IpAddress, Counter64, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "TimeTicks", "enterprises", "NotificationType", "MibIdentifier", "Bits", "Gauge32", "Unsigned32", "ObjectIdentity", "IpAddress", "Counter64", "iso", "Integer32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", histMetrDstPort=histMetrDstPort, curMetrDstPort=curMetrDstPort, histMetrAvgKbps=histMetrAvgKbps, histMetrPps=histMetrPps, histMetrDiscontinuities=histMetrDiscontinuities, histMetrMemberPorts=histMetrMemberPorts, curMetrSkips=curMetrSkips, cfgExecute=cfgExecute, histMetrSkips=histMetrSkips, curMetrAvgPps=curMetrAvgPps, curMetrTotalLost=curMetrTotalLost, curMetrTotalSkips=curMetrTotalSkips, IctJitter=IctJitter, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, curMetrMaxDelta=curMetrMaxDelta, ictReset=ictReset, curMetrTotalReordered=curMetrTotalReordered, ictFacRst=ictFacRst, ictMcastAnalyzer=ictMcastAnalyzer, PYSNMP_MODULE_ID=icotera, currentListEntry=currentListEntry, curMetrAvgLostPps=curMetrAvgLostPps, catvModuleRflevel=catvModuleRflevel, catvModuleLowSignal=catvModuleLowSignal, histMetrMaxDelta=histMetrMaxDelta, histMetrSourceAddr=histMetrSourceAddr, catvModulePowerLevel=catvModulePowerLevel, upgStatus=upgStatus, ictServicesMibs=ictServicesMibs, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrTotalMaxDelta=curMetrTotalMaxDelta, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, histMetrTotalBytes=histMetrTotalBytes, transceiverDdmTemperature=transceiverDdmTemperature, transceiverLinkLength=transceiverLinkLength, curMetrReordered=curMetrReordered, curMetrTotalBytes=curMetrTotalBytes, transceiverDdmRxPower=transceiverDdmRxPower, transceiverLaserWavelength=transceiverLaserWavelength, performFactoryReset=performFactoryReset, IctPortList=IctPortList, histMetrGroupAddr=histMetrGroupAddr, histMetrAvgLostPps=histMetrAvgLostPps, histMetrTotalPackets=histMetrTotalPackets, histMetrJitter=histMetrJitter, ictMgmtMib=ictMgmtMib, curMetrMemberPorts=curMetrMemberPorts, ictCatv=ictCatv, histMetrAvgPps=histMetrAvgPps, curMetrKbps=curMetrKbps, curMetrStreamType=curMetrStreamType, ictServices=ictServices, catvModuleSignalDetected=catvModuleSignalDetected, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, histMetrStartTimestamp=histMetrStartTimestamp, curMetrGroupAddr=curMetrGroupAddr, histMetrTotalReordered=histMetrTotalReordered, historyListEntry=historyListEntry, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, histMetrReordered=histMetrReordered, histMetrSrcPort=histMetrSrcPort, ictIGW1k=ictIGW1k, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, ictMgmt=ictMgmt, curGroupIndex=curGroupIndex, histMetrStreamType=histMetrStreamType, histMetrStopTimestamp=histMetrStopTimestamp, transceiverConnectorType=transceiverConnectorType, transceiverDdmTxPower=transceiverDdmTxPower, curMetrAvgDelta=curMetrAvgDelta, curMetrTotalPackets=curMetrTotalPackets, ictFwUpg=ictFwUpg, curMetrStopTimestamp=curMetrStopTimestamp, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, histMetrAvgDelta=histMetrAvgDelta, performCpeReboot=performCpeReboot, upgUrl=upgUrl, histMetrKbps=histMetrKbps, upgExecute=upgExecute, histGroupAddr=histGroupAddr, histMetrTotalMaxDelta=histMetrTotalMaxDelta, histMetrLost=histMetrLost, curMetrAvgKbps=curMetrAvgKbps, transceiverEthernetCompliance=transceiverEthernetCompliance, curGroupAddr=curGroupAddr, curMetrLost=curMetrLost, catvModuleAdminStatus=catvModuleAdminStatus, historyMetricsEntry=historyMetricsEntry, histMetrTotalAvgDelta=histMetrTotalAvgDelta, ictCfgUpdate=ictCfgUpdate, curMetrSrcPort=curMetrSrcPort, curMetrTotalAvgDelta=curMetrTotalAvgDelta, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, transceiverTransceiverType=transceiverTransceiverType, curMetrSourceAddr=curMetrSourceAddr, currentMetricsEntry=currentMetricsEntry, histMetrTotalLost=histMetrTotalLost, ictTransceiver=ictTransceiver, curMetrStartTimestamp=curMetrStartTimestamp, icotera=icotera, curMetrJitter=curMetrJitter, ictFacRstMib=ictFacRstMib, transceiverDiagCapable=transceiverDiagCapable, catvModuleFilter=catvModuleFilter, cfgTftpPath=cfgTftpPath, histGroupIndex=histGroupIndex, cfgStatus=cfgStatus, IctTimeStamp=IctTimeStamp, ictReboot=ictReboot, curMetrPps=curMetrPps, curMetrDiscontinuities=curMetrDiscontinuities, histMetrTotalSkips=histMetrTotalSkips, transceiverDdmVoltage=transceiverDdmVoltage, IctDelta=IctDelta)
