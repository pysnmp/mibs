...
# Produced by pysmi-1.1.12 at Mon Jun  3 12:25:12 2024
...
NotificationType, Counter64, iso, TimeTicks, Gauge32, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, enterprises, Integer32, Bits, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "iso", "TimeTicks", "Gauge32", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "enterprises", "Integer32", "Bits", "Counter32", "Unsigned32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", histMetrTotalPackets=histMetrTotalPackets, curMetrGroupAddr=curMetrGroupAddr, curGroupAddr=curGroupAddr, curMetrPps=curMetrPps, cfgExecute=cfgExecute, histMetrTotalAvgDelta=histMetrTotalAvgDelta, ictReset=ictReset, histMetrMaxDelta=histMetrMaxDelta, histMetrTotalMaxDelta=histMetrTotalMaxDelta, histMetrLost=histMetrLost, curMetrReordered=curMetrReordered, histMetrGroupAddr=histMetrGroupAddr, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, curMetrAvgLostPps=curMetrAvgLostPps, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, histMetrKbps=histMetrKbps, histGroupAddr=histGroupAddr, histMetrPps=histMetrPps, curMetrStopTimestamp=curMetrStopTimestamp, ictFacRstMib=ictFacRstMib, transceiverLaserWavelength=transceiverLaserWavelength, curMetrSrcPort=curMetrSrcPort, curMetrTotalReordered=curMetrTotalReordered, cfgStatus=cfgStatus, curMetrAvgKbps=curMetrAvgKbps, curMetrTotalSkips=curMetrTotalSkips, ictFwUpg=ictFwUpg, transceiverEthernetCompliance=transceiverEthernetCompliance, transceiverTransceiverType=transceiverTransceiverType, curMetrAvgDelta=curMetrAvgDelta, curMetrAvgPps=curMetrAvgPps, ictCfgUpdate=ictCfgUpdate, ictMgmt=ictMgmt, upgUrl=upgUrl, curMetrStartTimestamp=curMetrStartTimestamp, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, IctJitter=IctJitter, transceiverDiagCapable=transceiverDiagCapable, transceiverConnectorType=transceiverConnectorType, currentMetricsEntry=currentMetricsEntry, catvModuleLowSignal=catvModuleLowSignal, curMetrDiscontinuities=curMetrDiscontinuities, transceiverLinkLength=transceiverLinkLength, histMetrStopTimestamp=histMetrStopTimestamp, ictFacRst=ictFacRst, histMetrDiscontinuities=histMetrDiscontinuities, histMetrDstPort=histMetrDstPort, histMetrTotalReordered=histMetrTotalReordered, performFactoryReset=performFactoryReset, IctDelta=IctDelta, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, IctPortList=IctPortList, curMetrTotalAvgDelta=curMetrTotalAvgDelta, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, historyListEntry=historyListEntry, curMetrMaxDelta=curMetrMaxDelta, upgStatus=upgStatus, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrDstPort=curMetrDstPort, histMetrMemberPorts=histMetrMemberPorts, IctTimeStamp=IctTimeStamp, curMetrTotalBytes=curMetrTotalBytes, histMetrTotalLost=histMetrTotalLost, transceiverDdmTemperature=transceiverDdmTemperature, curGroupIndex=curGroupIndex, histMetrReordered=histMetrReordered, currentListEntry=currentListEntry, icotera=icotera, ictMgmtMib=ictMgmtMib, histMetrTotalSkips=histMetrTotalSkips, catvModulePowerLevel=catvModulePowerLevel, curMetrSkips=curMetrSkips, catvModuleRflevel=catvModuleRflevel, curMetrLost=curMetrLost, curMetrTotalLost=curMetrTotalLost, histMetrSrcPort=histMetrSrcPort, histMetrStreamType=histMetrStreamType, histGroupIndex=histGroupIndex, performCpeReboot=performCpeReboot, PYSNMP_MODULE_ID=icotera, curMetrMemberPorts=curMetrMemberPorts, histMetrStartTimestamp=histMetrStartTimestamp, histMetrSkips=histMetrSkips, cfgTftpPath=cfgTftpPath, curMetrSourceAddr=curMetrSourceAddr, ictServices=ictServices, curMetrKbps=curMetrKbps, ictReboot=ictReboot, transceiverDdmVoltage=transceiverDdmVoltage, ictIGW1k=ictIGW1k, ictCatv=ictCatv, histMetrSourceAddr=histMetrSourceAddr, curMetrJitter=curMetrJitter, ictTransceiver=ictTransceiver, curMetrStreamType=curMetrStreamType, upgExecute=upgExecute, histMetrJitter=histMetrJitter, transceiverDdmRxPower=transceiverDdmRxPower, catvModuleFilter=catvModuleFilter, curMetrTotalPackets=curMetrTotalPackets, ictServicesMibs=ictServicesMibs, historyMetricsEntry=historyMetricsEntry, histMetrAvgKbps=histMetrAvgKbps, histMetrAvgLostPps=histMetrAvgLostPps, histMetrAvgPps=histMetrAvgPps, histMetrAvgDelta=histMetrAvgDelta, curMetrTotalMaxDelta=curMetrTotalMaxDelta, catvModuleSignalDetected=catvModuleSignalDetected, transceiverDdmTxPower=transceiverDdmTxPower, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, histMetrTotalBytes=histMetrTotalBytes, catvModuleAdminStatus=catvModuleAdminStatus, ictMcastAnalyzer=ictMcastAnalyzer)
