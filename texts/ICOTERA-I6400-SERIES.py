...
# Produced by pysmi-1.1.8 at Thu Feb  3 21:08:18 2022
...
Counter64, MibIdentifier, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, TimeTicks, Gauge32, enterprises, ModuleIdentity, Unsigned32, iso, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "TimeTicks", "Gauge32", "enterprises", "ModuleIdentity", "Unsigned32", "iso", "Bits", "Counter32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", curMetrAvgLostPps=curMetrAvgLostPps, curMetrKbps=curMetrKbps, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, curMetrTotalLost=curMetrTotalLost, histMetrSrcPort=histMetrSrcPort, cfgTftpPath=cfgTftpPath, histMetrTotalReordered=histMetrTotalReordered, catvModuleAdminStatus=catvModuleAdminStatus, upgExecute=upgExecute, curMetrSrcPort=curMetrSrcPort, ictTransceiver=ictTransceiver, ictMcastAnalyzer=ictMcastAnalyzer, histMetrDstPort=histMetrDstPort, curMetrLost=curMetrLost, ictFwUpg=ictFwUpg, ictIGW1k=ictIGW1k, transceiverDdmRxPower=transceiverDdmRxPower, currentMetricsEntry=currentMetricsEntry, curMetrTotalReordered=curMetrTotalReordered, histMetrDiscontinuities=histMetrDiscontinuities, curMetrDiscontinuities=curMetrDiscontinuities, transceiverDiagCapable=transceiverDiagCapable, curMetrStartTimestamp=curMetrStartTimestamp, histMetrSkips=histMetrSkips, curMetrTotalBytes=curMetrTotalBytes, histGroupAddr=histGroupAddr, curMetrAvgPps=curMetrAvgPps, curMetrJitter=curMetrJitter, icotera=icotera, ictFacRst=ictFacRst, transceiverDdmVoltage=transceiverDdmVoltage, curMetrTotalMaxDelta=curMetrTotalMaxDelta, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, ictCfgUpdate=ictCfgUpdate, catvModuleLowSignal=catvModuleLowSignal, histMetrKbps=histMetrKbps, curMetrTotalAvgDelta=curMetrTotalAvgDelta, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, transceiverEthernetCompliance=transceiverEthernetCompliance, histMetrLost=histMetrLost, ictMgmtMib=ictMgmtMib, curMetrSourceAddr=curMetrSourceAddr, histMetrTotalLost=histMetrTotalLost, IctDelta=IctDelta, curMetrPps=curMetrPps, histMetrAvgLostPps=histMetrAvgLostPps, histMetrStartTimestamp=histMetrStartTimestamp, performFactoryReset=performFactoryReset, histMetrMaxDelta=histMetrMaxDelta, IctPortList=IctPortList, curMetrSkips=curMetrSkips, currentListEntry=currentListEntry, ictReboot=ictReboot, curMetrDstPort=curMetrDstPort, catvModuleFilter=catvModuleFilter, curGroupIndex=curGroupIndex, histMetrJitter=histMetrJitter, ictServicesMibs=ictServicesMibs, histMetrTotalSkips=histMetrTotalSkips, ictMgmt=ictMgmt, histMetrMemberPorts=histMetrMemberPorts, curMetrAvgDelta=curMetrAvgDelta, transceiverDdmTxPower=transceiverDdmTxPower, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, histGroupIndex=histGroupIndex, transceiverLaserWavelength=transceiverLaserWavelength, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, catvModuleRflevel=catvModuleRflevel, curMetrStreamType=curMetrStreamType, transceiverDdmTemperature=transceiverDdmTemperature, curMetrAvgKbps=curMetrAvgKbps, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, catvModuleSignalDetected=catvModuleSignalDetected, cfgStatus=cfgStatus, ictFacRstMib=ictFacRstMib, upgUrl=upgUrl, PYSNMP_MODULE_ID=icotera, histMetrStopTimestamp=histMetrStopTimestamp, ictReset=ictReset, curMetrMemberPorts=curMetrMemberPorts, histMetrPps=histMetrPps, curMetrTotalSkips=curMetrTotalSkips, curMetrMaxDelta=curMetrMaxDelta, curGroupAddr=curGroupAddr, histMetrTotalBytes=histMetrTotalBytes, IctTimeStamp=IctTimeStamp, curMetrGroupAddr=curMetrGroupAddr, IctJitter=IctJitter, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, ictCatv=ictCatv, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, historyListEntry=historyListEntry, histMetrTotalMaxDelta=histMetrTotalMaxDelta, histMetrAvgPps=histMetrAvgPps, curMetrReordered=curMetrReordered, histMetrAvgKbps=histMetrAvgKbps, catvModulePowerLevel=catvModulePowerLevel, histMetrReordered=histMetrReordered, histMetrTotalPackets=histMetrTotalPackets, histMetrGroupAddr=histMetrGroupAddr, ictServices=ictServices, transceiverLinkLength=transceiverLinkLength, histMetrAvgDelta=histMetrAvgDelta, upgStatus=upgStatus, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, transceiverTransceiverType=transceiverTransceiverType, cfgExecute=cfgExecute, curMetrStopTimestamp=curMetrStopTimestamp, histMetrSourceAddr=histMetrSourceAddr, histMetrTotalAvgDelta=histMetrTotalAvgDelta, performCpeReboot=performCpeReboot, historyMetricsEntry=historyMetricsEntry, curMetrTotalPackets=curMetrTotalPackets, transceiverConnectorType=transceiverConnectorType, histMetrStreamType=histMetrStreamType)
