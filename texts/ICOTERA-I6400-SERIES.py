...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, ObjectIdentity, enterprises, Integer32, Unsigned32, Bits, IpAddress, NotificationType, Gauge32, iso, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "ObjectIdentity", "enterprises", "Integer32", "Unsigned32", "Bits", "IpAddress", "NotificationType", "Gauge32", "iso", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", curMetrStopTimestamp=curMetrStopTimestamp, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrDiscontinuities=curMetrDiscontinuities, cfgExecute=cfgExecute, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, performFactoryReset=performFactoryReset, transceiverDdmTxPower=transceiverDdmTxPower, curMetrSrcPort=curMetrSrcPort, histMetrSrcPort=histMetrSrcPort, ictReboot=ictReboot, histGroupIndex=histGroupIndex, transceiverDiagCapable=transceiverDiagCapable, catvModulePowerLevel=catvModulePowerLevel, catvModuleLowSignal=catvModuleLowSignal, curMetrSkips=curMetrSkips, catvModuleRflevel=catvModuleRflevel, upgExecute=upgExecute, curGroupIndex=curGroupIndex, curMetrTotalAvgDelta=curMetrTotalAvgDelta, transceiverConnectorType=transceiverConnectorType, histMetrAvgLostPps=histMetrAvgLostPps, transceiverTransceiverType=transceiverTransceiverType, ictReset=ictReset, catvModuleFilter=catvModuleFilter, IctTimeStamp=IctTimeStamp, histMetrStreamType=histMetrStreamType, historyMetricsEntry=historyMetricsEntry, curMetrTotalLost=curMetrTotalLost, transceiverLinkLength=transceiverLinkLength, transceiverDdmRxPower=transceiverDdmRxPower, transceiverDdmVoltage=transceiverDdmVoltage, catvModuleAdminStatus=catvModuleAdminStatus, curMetrJitter=curMetrJitter, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, currentListEntry=currentListEntry, histMetrAvgPps=histMetrAvgPps, histMetrReordered=histMetrReordered, ictCfgUpdate=ictCfgUpdate, ictMgmtMib=ictMgmtMib, IctJitter=IctJitter, cfgTftpPath=cfgTftpPath, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, cfgStatus=cfgStatus, curMetrAvgLostPps=curMetrAvgLostPps, histMetrTotalLost=histMetrTotalLost, transceiverEthernetCompliance=transceiverEthernetCompliance, histMetrStartTimestamp=histMetrStartTimestamp, upgUrl=upgUrl, curMetrGroupAddr=curMetrGroupAddr, curMetrDstPort=curMetrDstPort, curMetrStartTimestamp=curMetrStartTimestamp, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, histMetrSourceAddr=histMetrSourceAddr, transceiverLaserWavelength=transceiverLaserWavelength, curMetrTotalMaxDelta=curMetrTotalMaxDelta, currentMetricsEntry=currentMetricsEntry, histMetrGroupAddr=histMetrGroupAddr, histMetrLost=histMetrLost, ictFacRstMib=ictFacRstMib, curMetrTotalPackets=curMetrTotalPackets, ictCatv=ictCatv, ictFwUpg=ictFwUpg, curMetrReordered=curMetrReordered, curMetrTotalReordered=curMetrTotalReordered, ictServicesMibs=ictServicesMibs, ictMgmt=ictMgmt, curMetrAvgDelta=curMetrAvgDelta, histMetrTotalPackets=histMetrTotalPackets, IctPortList=IctPortList, histMetrTotalSkips=histMetrTotalSkips, histMetrTotalReordered=histMetrTotalReordered, histMetrPps=histMetrPps, histMetrTotalBytes=histMetrTotalBytes, ictMcastAnalyzer=ictMcastAnalyzer, histMetrKbps=histMetrKbps, ictTransceiver=ictTransceiver, curMetrAvgPps=curMetrAvgPps, curMetrMaxDelta=curMetrMaxDelta, histMetrDstPort=histMetrDstPort, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, ictIGW1k=ictIGW1k, curMetrLost=curMetrLost, PYSNMP_MODULE_ID=icotera, curMetrAvgKbps=curMetrAvgKbps, histMetrAvgKbps=histMetrAvgKbps, histGroupAddr=histGroupAddr, histMetrTotalAvgDelta=histMetrTotalAvgDelta, histMetrMemberPorts=histMetrMemberPorts, histMetrStopTimestamp=histMetrStopTimestamp, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, histMetrSkips=histMetrSkips, histMetrMaxDelta=histMetrMaxDelta, catvModuleSignalDetected=catvModuleSignalDetected, icotera=icotera, IctDelta=IctDelta, performCpeReboot=performCpeReboot, curMetrStreamType=curMetrStreamType, historyListEntry=historyListEntry, curMetrMemberPorts=curMetrMemberPorts, ictServices=ictServices, curMetrKbps=curMetrKbps, histMetrDiscontinuities=histMetrDiscontinuities, histMetrJitter=histMetrJitter, curMetrPps=curMetrPps, curMetrTotalSkips=curMetrTotalSkips, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, curMetrSourceAddr=curMetrSourceAddr, transceiverDdmTemperature=transceiverDdmTemperature, curGroupAddr=curGroupAddr, upgStatus=upgStatus, curMetrTotalBytes=curMetrTotalBytes, histMetrAvgDelta=histMetrAvgDelta, ictFacRst=ictFacRst, histMetrTotalMaxDelta=histMetrTotalMaxDelta)
