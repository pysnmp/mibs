...
# Produced by pysmi-1.1.12 at Tue May 28 12:08:34 2024
...
IpAddress, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, enterprises, iso, MibIdentifier, ObjectIdentity, Bits, Counter32, ModuleIdentity, TimeTicks, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "enterprises", "iso", "MibIdentifier", "ObjectIdentity", "Bits", "Counter32", "ModuleIdentity", "TimeTicks", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", transceiverDdmTemperature=transceiverDdmTemperature, histMetrMaxDelta=histMetrMaxDelta, curMetrDiscontinuities=curMetrDiscontinuities, upgExecute=upgExecute, histMetrSourceAddr=histMetrSourceAddr, ictCatv=ictCatv, histMetrTotalPackets=histMetrTotalPackets, curMetrKbps=curMetrKbps, ictReboot=ictReboot, IctDelta=IctDelta, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, transceiverEthernetCompliance=transceiverEthernetCompliance, ictCfgUpdate=ictCfgUpdate, cfgExecute=cfgExecute, histMetrStartTimestamp=histMetrStartTimestamp, ictFwUpg=ictFwUpg, transceiverDiagCapable=transceiverDiagCapable, curMetrSkips=curMetrSkips, currentMetricsEntry=currentMetricsEntry, IctTimeStamp=IctTimeStamp, curMetrMaxDelta=curMetrMaxDelta, performCpeReboot=performCpeReboot, ictServicesMibs=ictServicesMibs, transceiverDdmTxPower=transceiverDdmTxPower, curMetrSourceAddr=curMetrSourceAddr, histMetrDstPort=histMetrDstPort, upgUrl=upgUrl, curMetrLost=curMetrLost, histMetrLost=histMetrLost, PYSNMP_MODULE_ID=icotera, catvModuleSignalDetected=catvModuleSignalDetected, catvModulePowerLevel=catvModulePowerLevel, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, ictServices=ictServices, historyMetricsEntry=historyMetricsEntry, curMetrPps=curMetrPps, histMetrKbps=histMetrKbps, histMetrAvgDelta=histMetrAvgDelta, curMetrMemberPorts=curMetrMemberPorts, histMetrGroupAddr=histMetrGroupAddr, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, curMetrStopTimestamp=curMetrStopTimestamp, curMetrTotalSkips=curMetrTotalSkips, ictFacRstMib=ictFacRstMib, historyListEntry=historyListEntry, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, histMetrStopTimestamp=histMetrStopTimestamp, histMetrReordered=histMetrReordered, histGroupAddr=histGroupAddr, histMetrTotalMaxDelta=histMetrTotalMaxDelta, curMetrTotalAvgDelta=curMetrTotalAvgDelta, ictReset=ictReset, histMetrSkips=histMetrSkips, ictMcastAnalyzer=ictMcastAnalyzer, histMetrPps=histMetrPps, catvModuleRflevel=catvModuleRflevel, curGroupAddr=curGroupAddr, curMetrStartTimestamp=curMetrStartTimestamp, histMetrJitter=histMetrJitter, performFactoryReset=performFactoryReset, histMetrTotalLost=histMetrTotalLost, curMetrTotalBytes=curMetrTotalBytes, catvModuleAdminStatus=catvModuleAdminStatus, catvModuleLowSignal=catvModuleLowSignal, curMetrStreamType=curMetrStreamType, ictIGW1k=ictIGW1k, histMetrAvgKbps=histMetrAvgKbps, transceiverLinkLength=transceiverLinkLength, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, icotera=icotera, cfgStatus=cfgStatus, curMetrSrcPort=curMetrSrcPort, histMetrTotalBytes=histMetrTotalBytes, curMetrAvgDelta=curMetrAvgDelta, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, histMetrAvgLostPps=histMetrAvgLostPps, IctPortList=IctPortList, curGroupIndex=curGroupIndex, curMetrTotalPackets=curMetrTotalPackets, ictTransceiver=ictTransceiver, histMetrStreamType=histMetrStreamType, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, curMetrAvgLostPps=curMetrAvgLostPps, curMetrAvgPps=curMetrAvgPps, histMetrTotalReordered=histMetrTotalReordered, transceiverTransceiverType=transceiverTransceiverType, transceiverDdmRxPower=transceiverDdmRxPower, currentListEntry=currentListEntry, ictMgmtMib=ictMgmtMib, curMetrGroupAddr=curMetrGroupAddr, ictMgmt=ictMgmt, IctJitter=IctJitter, histMetrAvgPps=histMetrAvgPps, histMetrDiscontinuities=histMetrDiscontinuities, ictFacRst=ictFacRst, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, histMetrSrcPort=histMetrSrcPort, histMetrTotalAvgDelta=histMetrTotalAvgDelta, curMetrTotalReordered=curMetrTotalReordered, transceiverConnectorType=transceiverConnectorType, transceiverDdmVoltage=transceiverDdmVoltage, curMetrTotalLost=curMetrTotalLost, curMetrDstPort=curMetrDstPort, upgStatus=upgStatus, catvModuleFilter=catvModuleFilter, curMetrReordered=curMetrReordered, histMetrTotalSkips=histMetrTotalSkips, histGroupIndex=histGroupIndex, cfgTftpPath=cfgTftpPath, curMetrAvgKbps=curMetrAvgKbps, curMetrTotalMaxDelta=curMetrTotalMaxDelta, histMetrMemberPorts=histMetrMemberPorts, curMetrJitter=curMetrJitter, transceiverLaserWavelength=transceiverLaserWavelength)
