...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, curMetrTotalAvgDelta=curMetrTotalAvgDelta, histGroupAddr=histGroupAddr, curMetrMaxDelta=curMetrMaxDelta, ictServices=ictServices, curMetrAvgKbps=curMetrAvgKbps, curMetrSkips=curMetrSkips, histMetrSrcPort=histMetrSrcPort, upgExecute=upgExecute, histMetrTotalSkips=histMetrTotalSkips, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, histMetrJitter=histMetrJitter, curMetrAvgLostPps=curMetrAvgLostPps, histMetrStopTimestamp=histMetrStopTimestamp, histMetrAvgLostPps=histMetrAvgLostPps, curMetrTotalSkips=curMetrTotalSkips, upgUrl=upgUrl, curMetrJitter=curMetrJitter, curMetrAvgDelta=curMetrAvgDelta, curMetrTotalMaxDelta=curMetrTotalMaxDelta, icotera=icotera, transceiverEthernetCompliance=transceiverEthernetCompliance, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, histMetrLost=histMetrLost, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, histMetrStreamType=histMetrStreamType, curMetrGroupAddr=curMetrGroupAddr, histMetrTotalMaxDelta=histMetrTotalMaxDelta, catvModuleRflevel=catvModuleRflevel, ictReboot=ictReboot, curMetrStreamType=curMetrStreamType, histMetrDstPort=histMetrDstPort, curMetrLost=curMetrLost, upgStatus=upgStatus, IctTimeStamp=IctTimeStamp, curMetrSourceAddr=curMetrSourceAddr, transceiverLinkLength=transceiverLinkLength, cfgTftpPath=cfgTftpPath, IctJitter=IctJitter, curMetrTotalBytes=curMetrTotalBytes, curMetrDstPort=curMetrDstPort, ictFwUpg=ictFwUpg, curMetrSrcPort=curMetrSrcPort, cfgExecute=cfgExecute, ictCfgUpdate=ictCfgUpdate, catvModuleLowSignal=catvModuleLowSignal, ictMgmtMib=ictMgmtMib, curMetrReordered=curMetrReordered, histMetrMemberPorts=histMetrMemberPorts, IctDelta=IctDelta, curGroupIndex=curGroupIndex, PYSNMP_MODULE_ID=icotera, cfgStatus=cfgStatus, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, transceiverTransceiverType=transceiverTransceiverType, ictMcastAnalyzer=ictMcastAnalyzer, curMetrPps=curMetrPps, transceiverDiagCapable=transceiverDiagCapable, curMetrKbps=curMetrKbps, catvModuleSignalDetected=catvModuleSignalDetected, historyListEntry=historyListEntry, catvModulePowerLevel=catvModulePowerLevel, transceiverLaserWavelength=transceiverLaserWavelength, ictFacRst=ictFacRst, curMetrDiscontinuities=curMetrDiscontinuities, curMetrTotalPackets=curMetrTotalPackets, catvModuleAdminStatus=catvModuleAdminStatus, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, curMetrStartTimestamp=curMetrStartTimestamp, histMetrTotalAvgDelta=histMetrTotalAvgDelta, curMetrTotalLost=curMetrTotalLost, transceiverDdmTemperature=transceiverDdmTemperature, performCpeReboot=performCpeReboot, transceiverDdmTxPower=transceiverDdmTxPower, ictCatv=ictCatv, curMetrAvgPps=curMetrAvgPps, histMetrDiscontinuities=histMetrDiscontinuities, histMetrGroupAddr=histMetrGroupAddr, histMetrSourceAddr=histMetrSourceAddr, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, histMetrTotalLost=histMetrTotalLost, ictReset=ictReset, histMetrAvgDelta=histMetrAvgDelta, histMetrAvgPps=histMetrAvgPps, histMetrStartTimestamp=histMetrStartTimestamp, histMetrKbps=histMetrKbps, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, catvModuleFilter=catvModuleFilter, curMetrStopTimestamp=curMetrStopTimestamp, histMetrAvgKbps=histMetrAvgKbps, histMetrPps=histMetrPps, transceiverDdmVoltage=transceiverDdmVoltage, histMetrTotalBytes=histMetrTotalBytes, historyMetricsEntry=historyMetricsEntry, currentMetricsEntry=currentMetricsEntry, ictIGW1k=ictIGW1k, histMetrMaxDelta=histMetrMaxDelta, histMetrTotalReordered=histMetrTotalReordered, ictFacRstMib=ictFacRstMib, curMetrMemberPorts=curMetrMemberPorts, performFactoryReset=performFactoryReset, histMetrSkips=histMetrSkips, ictMgmt=ictMgmt, transceiverDdmRxPower=transceiverDdmRxPower, histGroupIndex=histGroupIndex, transceiverConnectorType=transceiverConnectorType, currentListEntry=currentListEntry, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, histMetrTotalPackets=histMetrTotalPackets, ictServicesMibs=ictServicesMibs, histMetrReordered=histMetrReordered, curMetrTotalReordered=curMetrTotalReordered, curGroupAddr=curGroupAddr, IctPortList=IctPortList, ictTransceiver=ictTransceiver)
