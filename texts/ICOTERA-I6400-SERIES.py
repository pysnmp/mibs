...
enterprises, ObjectIdentity, Bits, MibIdentifier, Gauge32, NotificationType, Counter64, Counter32, TimeTicks, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ObjectIdentity", "Bits", "MibIdentifier", "Gauge32", "NotificationType", "Counter64", "Counter32", "TimeTicks", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "IpAddress")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", cfgStatus=cfgStatus, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, curMetrSourceAddr=curMetrSourceAddr, histMetrMaxDelta=histMetrMaxDelta, curMetrLost=curMetrLost, ictReboot=ictReboot, curMetrSkips=curMetrSkips, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, curMetrTotalBytes=curMetrTotalBytes, histMetrPps=histMetrPps, upgUrl=upgUrl, historyMetricsEntry=historyMetricsEntry, histMetrLost=histMetrLost, histMetrTotalReordered=histMetrTotalReordered, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, ictMgmtMib=ictMgmtMib, histGroupIndex=histGroupIndex, currentMetricsEntry=currentMetricsEntry, ictServicesMibs=ictServicesMibs, histMetrTotalAvgDelta=histMetrTotalAvgDelta, ictIGW1k=ictIGW1k, icotera=icotera, curMetrAvgLostPps=curMetrAvgLostPps, transceiverDiagCapable=transceiverDiagCapable, histMetrSourceAddr=histMetrSourceAddr, curMetrReordered=curMetrReordered, historyListEntry=historyListEntry, transceiverLaserWavelength=transceiverLaserWavelength, curMetrAvgKbps=curMetrAvgKbps, curMetrTotalMaxDelta=curMetrTotalMaxDelta, catvModuleFilter=catvModuleFilter, histMetrGroupAddr=histMetrGroupAddr, transceiverTransceiverType=transceiverTransceiverType, ictFacRstMib=ictFacRstMib, curMetrTotalPackets=curMetrTotalPackets, histMetrSkips=histMetrSkips, curMetrSrcPort=curMetrSrcPort, curMetrAvgDelta=curMetrAvgDelta, curMetrAvgPps=curMetrAvgPps, histMetrStartTimestamp=histMetrStartTimestamp, curMetrJitter=curMetrJitter, ictCfgUpdate=ictCfgUpdate, performCpeReboot=performCpeReboot, ictCatv=ictCatv, IctPortList=IctPortList, curGroupAddr=curGroupAddr, histGroupAddr=histGroupAddr, ictFacRst=ictFacRst, catvModuleAdminStatus=catvModuleAdminStatus, curMetrMemberPorts=curMetrMemberPorts, catvModuleRflevel=catvModuleRflevel, histMetrAvgPps=histMetrAvgPps, ictMgmt=ictMgmt, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, histMetrStopTimestamp=histMetrStopTimestamp, histMetrAvgLostPps=histMetrAvgLostPps, histMetrTotalLost=histMetrTotalLost, curMetrMaxDelta=curMetrMaxDelta, curMetrTotalLost=curMetrTotalLost, curMetrGroupAddr=curMetrGroupAddr, histMetrDiscontinuities=histMetrDiscontinuities, ictMcastAnalyzer=ictMcastAnalyzer, curMetrKbps=curMetrKbps, catvModulePowerLevel=catvModulePowerLevel, upgStatus=upgStatus, cfgTftpPath=cfgTftpPath, IctTimeStamp=IctTimeStamp, curMetrTotalAvgDelta=curMetrTotalAvgDelta, upgExecute=upgExecute, curMetrTotalReordered=curMetrTotalReordered, IctJitter=IctJitter, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, histMetrTotalPackets=histMetrTotalPackets, IctDelta=IctDelta, histMetrMemberPorts=histMetrMemberPorts, curMetrDstPort=curMetrDstPort, ictFwUpg=ictFwUpg, curGroupIndex=curGroupIndex, transceiverEthernetCompliance=transceiverEthernetCompliance, histMetrStreamType=histMetrStreamType, histMetrTotalBytes=histMetrTotalBytes, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, transceiverDdmRxPower=transceiverDdmRxPower, ictServices=ictServices, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, transceiverDdmTxPower=transceiverDdmTxPower, curMetrTotalSkips=curMetrTotalSkips, curMetrStopTimestamp=curMetrStopTimestamp, PYSNMP_MODULE_ID=icotera, catvModuleSignalDetected=catvModuleSignalDetected, histMetrTotalSkips=histMetrTotalSkips, currentListEntry=currentListEntry, histMetrReordered=histMetrReordered, ictTransceiver=ictTransceiver, histMetrJitter=histMetrJitter, curMetrStreamType=curMetrStreamType, histMetrTotalMaxDelta=histMetrTotalMaxDelta, transceiverDdmTemperature=transceiverDdmTemperature, transceiverLinkLength=transceiverLinkLength, cfgExecute=cfgExecute, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, histMetrDstPort=histMetrDstPort, performFactoryReset=performFactoryReset, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, histMetrAvgKbps=histMetrAvgKbps, transceiverConnectorType=transceiverConnectorType, curMetrPps=curMetrPps, ictReset=ictReset, histMetrSrcPort=histMetrSrcPort, histMetrKbps=histMetrKbps, histMetrAvgDelta=histMetrAvgDelta, curMetrStartTimestamp=curMetrStartTimestamp, catvModuleLowSignal=catvModuleLowSignal, curMetrDiscontinuities=curMetrDiscontinuities, transceiverDdmVoltage=transceiverDdmVoltage)
