...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, Gauge32, enterprises, ObjectIdentity, Counter64, ModuleIdentity, IpAddress, NotificationType, Counter32, Unsigned32, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "Gauge32", "enterprises", "ObjectIdentity", "Counter64", "ModuleIdentity", "IpAddress", "NotificationType", "Counter32", "Unsigned32", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", transceiverDdmTxPower=transceiverDdmTxPower, histMetrDiscontinuities=histMetrDiscontinuities, histMetrKbps=histMetrKbps, transceiverTransceiverType=transceiverTransceiverType, ictReboot=ictReboot, curMetrLost=curMetrLost, ictMgmtMib=ictMgmtMib, transceiverEthernetCompliance=transceiverEthernetCompliance, catvModuleFilter=catvModuleFilter, histMetrStartTimestamp=histMetrStartTimestamp, histMetrReordered=histMetrReordered, histMetrPps=histMetrPps, curMetrTotalAvgDelta=curMetrTotalAvgDelta, histMetrDstPort=histMetrDstPort, currentListEntry=currentListEntry, histMetrTotalSkips=histMetrTotalSkips, histMetrAvgPps=histMetrAvgPps, ictCatv=ictCatv, PYSNMP_MODULE_ID=icotera, transceiverDdmRxPower=transceiverDdmRxPower, histMetrStreamType=histMetrStreamType, curMetrGroupAddr=curMetrGroupAddr, performFactoryReset=performFactoryReset, histMetrTotalBytes=histMetrTotalBytes, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, curMetrSrcPort=curMetrSrcPort, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, transceiverDdmTemperature=transceiverDdmTemperature, ictIGW1k=ictIGW1k, curMetrTotalPackets=curMetrTotalPackets, transceiverDiagCapable=transceiverDiagCapable, histMetrMaxDelta=histMetrMaxDelta, curMetrAvgPps=curMetrAvgPps, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, upgUrl=upgUrl, icotera=icotera, histMetrSrcPort=histMetrSrcPort, transceiverLaserWavelength=transceiverLaserWavelength, transceiverConnectorType=transceiverConnectorType, curMetrKbps=curMetrKbps, histGroupAddr=histGroupAddr, cfgTftpPath=cfgTftpPath, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrTotalSkips=curMetrTotalSkips, histMetrTotalMaxDelta=histMetrTotalMaxDelta, catvModuleSignalDetected=catvModuleSignalDetected, cfgStatus=cfgStatus, ictServices=ictServices, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, curGroupIndex=curGroupIndex, curMetrDiscontinuities=curMetrDiscontinuities, histMetrGroupAddr=histMetrGroupAddr, curMetrSourceAddr=curMetrSourceAddr, curMetrMaxDelta=curMetrMaxDelta, curMetrTotalMaxDelta=curMetrTotalMaxDelta, curMetrSkips=curMetrSkips, curMetrTotalLost=curMetrTotalLost, historyListEntry=historyListEntry, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, curMetrJitter=curMetrJitter, histMetrAvgLostPps=histMetrAvgLostPps, histMetrLost=histMetrLost, curMetrStartTimestamp=curMetrStartTimestamp, currentMetricsEntry=currentMetricsEntry, curMetrStopTimestamp=curMetrStopTimestamp, catvModuleRflevel=catvModuleRflevel, histMetrTotalReordered=histMetrTotalReordered, curMetrStreamType=curMetrStreamType, ictTransceiver=ictTransceiver, upgExecute=upgExecute, histGroupIndex=histGroupIndex, ictServicesMibs=ictServicesMibs, upgStatus=upgStatus, histMetrTotalPackets=histMetrTotalPackets, catvModuleLowSignal=catvModuleLowSignal, ictMcastAnalyzer=ictMcastAnalyzer, cfgExecute=cfgExecute, IctJitter=IctJitter, IctDelta=IctDelta, transceiverDdmVoltage=transceiverDdmVoltage, histMetrJitter=histMetrJitter, ictMgmt=ictMgmt, curMetrTotalReordered=curMetrTotalReordered, histMetrTotalAvgDelta=histMetrTotalAvgDelta, histMetrSourceAddr=histMetrSourceAddr, curMetrAvgKbps=curMetrAvgKbps, ictFwUpg=ictFwUpg, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, IctTimeStamp=IctTimeStamp, curMetrMemberPorts=curMetrMemberPorts, curMetrAvgDelta=curMetrAvgDelta, curMetrPps=curMetrPps, ictFacRstMib=ictFacRstMib, historyMetricsEntry=historyMetricsEntry, histMetrSkips=histMetrSkips, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, catvModuleAdminStatus=catvModuleAdminStatus, curMetrDstPort=curMetrDstPort, transceiverLinkLength=transceiverLinkLength, histMetrAvgDelta=histMetrAvgDelta, ictReset=ictReset, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, histMetrMemberPorts=histMetrMemberPorts, histMetrAvgKbps=histMetrAvgKbps, ictCfgUpdate=ictCfgUpdate, performCpeReboot=performCpeReboot, histMetrStopTimestamp=histMetrStopTimestamp, curMetrReordered=curMetrReordered, curMetrTotalBytes=curMetrTotalBytes, curGroupAddr=curGroupAddr, histMetrTotalLost=histMetrTotalLost, curMetrAvgLostPps=curMetrAvgLostPps, catvModulePowerLevel=catvModulePowerLevel, ictFacRst=ictFacRst, IctPortList=IctPortList)
