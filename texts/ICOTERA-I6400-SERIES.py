...
# Produced by pysmi-1.1.11 at Tue Dec  5 08:36:34 2023
...
ModuleIdentity, Integer32, iso, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, MibIdentifier, TimeTicks, Counter64, Unsigned32, Counter32, Gauge32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "iso", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "MibIdentifier", "TimeTicks", "Counter64", "Unsigned32", "Counter32", "Gauge32", "enterprises")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", ictServices=ictServices, histMetrSkips=histMetrSkips, histMetrSourceAddr=histMetrSourceAddr, histMetrStreamType=histMetrStreamType, histMetrReordered=histMetrReordered, curMetrTotalLost=curMetrTotalLost, curMetrMemberPorts=curMetrMemberPorts, catvModuleSignalDetected=catvModuleSignalDetected, curGroupAddr=curGroupAddr, ictTransceiver=ictTransceiver, curMetrSourceAddr=curMetrSourceAddr, curMetrJitter=curMetrJitter, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, curMetrTotalMaxDelta=curMetrTotalMaxDelta, upgUrl=upgUrl, histGroupIndex=histGroupIndex, curMetrAvgDelta=curMetrAvgDelta, histMetrPps=histMetrPps, catvModuleRflevel=catvModuleRflevel, curMetrTotalReordered=curMetrTotalReordered, curMetrDiscontinuities=curMetrDiscontinuities, performCpeReboot=performCpeReboot, transceiverDdmVoltage=transceiverDdmVoltage, curGroupIndex=curGroupIndex, ictReset=ictReset, histMetrAvgDelta=histMetrAvgDelta, catvModuleFilter=catvModuleFilter, curMetrTotalAvgDelta=curMetrTotalAvgDelta, performFactoryReset=performFactoryReset, histMetrTotalPackets=histMetrTotalPackets, PYSNMP_MODULE_ID=icotera, ictIGW1k=ictIGW1k, curMetrReordered=curMetrReordered, curMetrAvgLostPps=curMetrAvgLostPps, ictServicesMibs=ictServicesMibs, curMetrGroupAddr=curMetrGroupAddr, curMetrKbps=curMetrKbps, catvModuleLowSignal=catvModuleLowSignal, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, histMetrStopTimestamp=histMetrStopTimestamp, transceiverDiagCapable=transceiverDiagCapable, histMetrStartTimestamp=histMetrStartTimestamp, histMetrKbps=histMetrKbps, ictReboot=ictReboot, cfgExecute=cfgExecute, histMetrLost=histMetrLost, curMetrMaxDelta=curMetrMaxDelta, histMetrSrcPort=histMetrSrcPort, catvModulePowerLevel=catvModulePowerLevel, histMetrTotalLost=histMetrTotalLost, histMetrTotalAvgDelta=histMetrTotalAvgDelta, transceiverLaserWavelength=transceiverLaserWavelength, ictMgmt=ictMgmt, histMetrDiscontinuities=histMetrDiscontinuities, transceiverLinkLength=transceiverLinkLength, ictFacRstMib=ictFacRstMib, transceiverEthernetCompliance=transceiverEthernetCompliance, curMetrTotalPackets=curMetrTotalPackets, currentMetricsEntry=currentMetricsEntry, histMetrAvgKbps=histMetrAvgKbps, transceiverDdmRxPower=transceiverDdmRxPower, historyListEntry=historyListEntry, cfgTftpPath=cfgTftpPath, histMetrTotalSkips=histMetrTotalSkips, ictCfgUpdate=ictCfgUpdate, ictMcastAnalyzer=ictMcastAnalyzer, histMetrDstPort=histMetrDstPort, transceiverConnectorType=transceiverConnectorType, histMetrAvgPps=histMetrAvgPps, histMetrMaxDelta=histMetrMaxDelta, histMetrTotalReordered=histMetrTotalReordered, IctDelta=IctDelta, currentListEntry=currentListEntry, curMetrLost=curMetrLost, transceiverTransceiverType=transceiverTransceiverType, curMetrDstPort=curMetrDstPort, curMetrAvgKbps=curMetrAvgKbps, curMetrStreamType=curMetrStreamType, histMetrTotalMaxDelta=histMetrTotalMaxDelta, curMetrPps=curMetrPps, histMetrMemberPorts=histMetrMemberPorts, upgStatus=upgStatus, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, curMetrAvgPps=curMetrAvgPps, histMetrAvgLostPps=histMetrAvgLostPps, histMetrGroupAddr=histMetrGroupAddr, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, catvModuleAdminStatus=catvModuleAdminStatus, IctTimeStamp=IctTimeStamp, curMetrTotalBytes=curMetrTotalBytes, curMetrTotalSkips=curMetrTotalSkips, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, IctJitter=IctJitter, ictMgmtMib=ictMgmtMib, curMetrStartTimestamp=curMetrStartTimestamp, curMetrSkips=curMetrSkips, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrSrcPort=curMetrSrcPort, historyMetricsEntry=historyMetricsEntry, histMetrTotalBytes=histMetrTotalBytes, curMetrStopTimestamp=curMetrStopTimestamp, cfgStatus=cfgStatus, histMetrJitter=histMetrJitter, icotera=icotera, upgExecute=upgExecute, ictFwUpg=ictFwUpg, transceiverDdmTemperature=transceiverDdmTemperature, ictCatv=ictCatv, IctPortList=IctPortList, histGroupAddr=histGroupAddr, transceiverDdmTxPower=transceiverDdmTxPower, ictFacRst=ictFacRst)
