...
# Produced by pysmi-1.1.10 at Fri Nov 10 08:45:42 2023
...
Gauge32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, IpAddress, Integer32, ObjectIdentity, MibIdentifier, Counter32, iso, NotificationType, TimeTicks, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "IpAddress", "Integer32", "ObjectIdentity", "MibIdentifier", "Counter32", "iso", "NotificationType", "TimeTicks", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", histMetrTotalSkips=histMetrTotalSkips, ictMcastAnalyzer=ictMcastAnalyzer, ictFwUpg=ictFwUpg, curMetrTotalReordered=curMetrTotalReordered, histMetrTotalMaxDelta=histMetrTotalMaxDelta, histMetrSrcPort=histMetrSrcPort, ictFacRst=ictFacRst, cfgStatus=cfgStatus, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, catvModuleAdminStatus=catvModuleAdminStatus, curMetrAvgPps=curMetrAvgPps, transceiverDdmVoltage=transceiverDdmVoltage, curMetrKbps=curMetrKbps, curMetrTotalMaxDelta=curMetrTotalMaxDelta, histMetrTotalAvgDelta=histMetrTotalAvgDelta, curMetrTotalSkips=curMetrTotalSkips, catvModuleRflevel=catvModuleRflevel, transceiverDiagCapable=transceiverDiagCapable, curMetrTotalLost=curMetrTotalLost, curMetrStopTimestamp=curMetrStopTimestamp, curGroupAddr=curGroupAddr, histMetrSkips=histMetrSkips, curMetrSourceAddr=curMetrSourceAddr, ictFacRstMib=ictFacRstMib, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, ictReboot=ictReboot, curMetrMemberPorts=curMetrMemberPorts, curMetrTotalAvgDelta=curMetrTotalAvgDelta, histMetrSourceAddr=histMetrSourceAddr, histMetrMaxDelta=histMetrMaxDelta, cfgExecute=cfgExecute, ictCatv=ictCatv, histMetrLost=histMetrLost, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, ictServices=ictServices, historyListEntry=historyListEntry, curMetrPps=curMetrPps, curMetrAvgKbps=curMetrAvgKbps, histMetrKbps=histMetrKbps, histMetrStartTimestamp=histMetrStartTimestamp, curMetrTotalBytes=curMetrTotalBytes, icotera=icotera, ictMgmtMib=ictMgmtMib, transceiverLinkLength=transceiverLinkLength, currentListEntry=currentListEntry, curMetrAvgLostPps=curMetrAvgLostPps, curMetrLost=curMetrLost, histMetrTotalPackets=histMetrTotalPackets, catvModuleLowSignal=catvModuleLowSignal, catvModuleFilter=catvModuleFilter, performFactoryReset=performFactoryReset, curMetrReordered=curMetrReordered, IctDelta=IctDelta, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, performCpeReboot=performCpeReboot, catvModulePowerLevel=catvModulePowerLevel, ictMgmt=ictMgmt, transceiverDdmTxPower=transceiverDdmTxPower, histMetrAvgPps=histMetrAvgPps, curMetrMaxDelta=curMetrMaxDelta, curMetrDiscontinuities=curMetrDiscontinuities, ictReset=ictReset, histGroupIndex=histGroupIndex, transceiverTransceiverType=transceiverTransceiverType, histMetrTotalBytes=histMetrTotalBytes, histMetrDiscontinuities=histMetrDiscontinuities, curGroupIndex=curGroupIndex, IctPortList=IctPortList, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, IctTimeStamp=IctTimeStamp, curMetrJitter=curMetrJitter, catvModuleSignalDetected=catvModuleSignalDetected, ictCfgUpdate=ictCfgUpdate, histMetrAvgKbps=histMetrAvgKbps, histMetrAvgDelta=histMetrAvgDelta, histMetrJitter=histMetrJitter, transceiverLaserWavelength=transceiverLaserWavelength, histMetrReordered=histMetrReordered, histMetrStopTimestamp=histMetrStopTimestamp, PYSNMP_MODULE_ID=icotera, ictTransceiver=ictTransceiver, histMetrPps=histMetrPps, historyMetricsEntry=historyMetricsEntry, upgExecute=upgExecute, transceiverDdmRxPower=transceiverDdmRxPower, cfgTftpPath=cfgTftpPath, curMetrSkips=curMetrSkips, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, curMetrGroupAddr=curMetrGroupAddr, curMetrAvgDelta=curMetrAvgDelta, transceiverDdmTemperature=transceiverDdmTemperature, curMetrSrcPort=curMetrSrcPort, transceiverEthernetCompliance=transceiverEthernetCompliance, histMetrTotalLost=histMetrTotalLost, ictServicesMibs=ictServicesMibs, upgStatus=upgStatus, histMetrGroupAddr=histMetrGroupAddr, histMetrDstPort=histMetrDstPort, histMetrStreamType=histMetrStreamType, upgUrl=upgUrl, curMetrStreamType=curMetrStreamType, currentMetricsEntry=currentMetricsEntry, histGroupAddr=histGroupAddr, histMetrAvgLostPps=histMetrAvgLostPps, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, curMetrStartTimestamp=curMetrStartTimestamp, histMetrMemberPorts=histMetrMemberPorts, IctJitter=IctJitter, transceiverConnectorType=transceiverConnectorType, ictIGW1k=ictIGW1k, curMetrTotalPackets=curMetrTotalPackets, curMetrDstPort=curMetrDstPort, histMetrTotalReordered=histMetrTotalReordered)
