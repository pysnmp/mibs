...
# Produced by pysmi-1.1.8 at Thu Jan  6 19:38:31 2022
...
Counter32, Bits, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, TimeTicks, MibIdentifier, IpAddress, ObjectIdentity, Unsigned32, iso, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "TimeTicks", "MibIdentifier", "IpAddress", "ObjectIdentity", "Unsigned32", "iso", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", histMetrPps=histMetrPps, ictReboot=ictReboot, transceiverLaserWavelength=transceiverLaserWavelength, curGroupAddr=curGroupAddr, transceiverDdmTemperature=transceiverDdmTemperature, transceiverEthernetCompliance=transceiverEthernetCompliance, histMetrStreamType=histMetrStreamType, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, histMetrReordered=histMetrReordered, catvModuleLowSignal=catvModuleLowSignal, curMetrTotalMaxDelta=curMetrTotalMaxDelta, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, ictReset=ictReset, historyMetricsEntry=historyMetricsEntry, curMetrDiscontinuities=curMetrDiscontinuities, curMetrKbps=curMetrKbps, cfgStatus=cfgStatus, ictFacRst=ictFacRst, histMetrGroupAddr=histMetrGroupAddr, curMetrTotalPackets=curMetrTotalPackets, curGroupIndex=curGroupIndex, curMetrTotalAvgDelta=curMetrTotalAvgDelta, catvModuleAdminStatus=catvModuleAdminStatus, ictServicesMibs=ictServicesMibs, performFactoryReset=performFactoryReset, histMetrSkips=histMetrSkips, curMetrAvgPps=curMetrAvgPps, curMetrSrcPort=curMetrSrcPort, IctPortList=IctPortList, curMetrSourceAddr=curMetrSourceAddr, curMetrMemberPorts=curMetrMemberPorts, catvModuleRflevel=catvModuleRflevel, curMetrSkips=curMetrSkips, curMetrAvgDelta=curMetrAvgDelta, cfgExecute=cfgExecute, histMetrTotalLost=histMetrTotalLost, histMetrTotalBytes=histMetrTotalBytes, transceiverTransceiverType=transceiverTransceiverType, PYSNMP_MODULE_ID=icotera, ictMcastAnalyzer=ictMcastAnalyzer, ictServices=ictServices, transceiverDdmVoltage=transceiverDdmVoltage, histMetrDiscontinuities=histMetrDiscontinuities, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, histMetrMemberPorts=histMetrMemberPorts, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, histMetrStopTimestamp=histMetrStopTimestamp, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, curMetrJitter=curMetrJitter, curMetrStreamType=curMetrStreamType, ictFacRstMib=ictFacRstMib, performCpeReboot=performCpeReboot, histMetrTotalReordered=histMetrTotalReordered, histMetrAvgDelta=histMetrAvgDelta, histMetrAvgKbps=histMetrAvgKbps, upgUrl=upgUrl, ictMgmt=ictMgmt, ictFwUpg=ictFwUpg, histMetrKbps=histMetrKbps, curMetrReordered=curMetrReordered, ictCfgUpdate=ictCfgUpdate, curMetrLost=curMetrLost, transceiverLinkLength=transceiverLinkLength, curMetrTotalSkips=curMetrTotalSkips, catvModulePowerLevel=catvModulePowerLevel, histMetrTotalAvgDelta=histMetrTotalAvgDelta, catvModuleSignalDetected=catvModuleSignalDetected, IctTimeStamp=IctTimeStamp, curMetrGroupAddr=curMetrGroupAddr, curMetrPps=curMetrPps, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, curMetrTotalLost=curMetrTotalLost, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, currentMetricsEntry=currentMetricsEntry, curMetrStopTimestamp=curMetrStopTimestamp, histMetrTotalPackets=histMetrTotalPackets, histMetrDstPort=histMetrDstPort, transceiverDiagCapable=transceiverDiagCapable, histMetrTotalMaxDelta=histMetrTotalMaxDelta, histGroupAddr=histGroupAddr, transceiverConnectorType=transceiverConnectorType, histMetrAvgPps=histMetrAvgPps, historyListEntry=historyListEntry, histMetrTotalSkips=histMetrTotalSkips, curMetrMaxDelta=curMetrMaxDelta, ictTransceiver=ictTransceiver, catvModuleFilter=catvModuleFilter, histMetrLost=histMetrLost, transceiverDdmTxPower=transceiverDdmTxPower, histGroupIndex=histGroupIndex, histMetrSrcPort=histMetrSrcPort, ictMgmtMib=ictMgmtMib, curMetrStartTimestamp=curMetrStartTimestamp, curMetrTotalReordered=curMetrTotalReordered, histMetrJitter=histMetrJitter, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrAvgKbps=curMetrAvgKbps, ictIGW1k=ictIGW1k, IctDelta=IctDelta, cfgTftpPath=cfgTftpPath, IctJitter=IctJitter, histMetrAvgLostPps=histMetrAvgLostPps, ictCatv=ictCatv, curMetrTotalBytes=curMetrTotalBytes, histMetrMaxDelta=histMetrMaxDelta, curMetrAvgLostPps=curMetrAvgLostPps, histMetrStartTimestamp=histMetrStartTimestamp, upgExecute=upgExecute, icotera=icotera, upgStatus=upgStatus, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, histMetrSourceAddr=histMetrSourceAddr, curMetrDstPort=curMetrDstPort, currentListEntry=currentListEntry, transceiverDdmRxPower=transceiverDdmRxPower)
