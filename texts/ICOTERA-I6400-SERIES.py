...
# Produced by pysmi-1.1.8 at Tue Sep 12 13:36:43 2023
...
ModuleIdentity, Integer32, Counter32, ObjectIdentity, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, Counter64, Bits, enterprises, Unsigned32, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Counter32", "ObjectIdentity", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "Counter64", "Bits", "enterprises", "Unsigned32", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", curMetrTotalMaxDelta=curMetrTotalMaxDelta, transceiverConnectorType=transceiverConnectorType, curMetrTotalSkips=curMetrTotalSkips, histMetrTotalMaxDelta=histMetrTotalMaxDelta, curMetrAvgKbps=curMetrAvgKbps, curMetrTotalBytes=curMetrTotalBytes, transceiverLinkLength=transceiverLinkLength, curMetrMaxDelta=curMetrMaxDelta, IctTimeStamp=IctTimeStamp, ictReboot=ictReboot, curMetrStreamType=curMetrStreamType, cfgTftpPath=cfgTftpPath, IctJitter=IctJitter, curGroupAddr=curGroupAddr, curMetrStopTimestamp=curMetrStopTimestamp, curMetrTotalLost=curMetrTotalLost, catvModuleRflevel=catvModuleRflevel, ictMgmt=ictMgmt, histMetrTotalLost=histMetrTotalLost, currentMetricsEntry=currentMetricsEntry, histMetrSkips=histMetrSkips, upgStatus=upgStatus, PYSNMP_MODULE_ID=icotera, curMetrSkips=curMetrSkips, ictReset=ictReset, histMetrSrcPort=histMetrSrcPort, cfgStatus=cfgStatus, ictServicesMibs=ictServicesMibs, histMetrDiscontinuities=histMetrDiscontinuities, upgExecute=upgExecute, performCpeReboot=performCpeReboot, histMetrMaxDelta=histMetrMaxDelta, histMetrTotalAvgDelta=histMetrTotalAvgDelta, upgUrl=upgUrl, curMetrAvgPps=curMetrAvgPps, histMetrKbps=histMetrKbps, histMetrAvgLostPps=histMetrAvgLostPps, histMetrStreamType=histMetrStreamType, curMetrSrcPort=curMetrSrcPort, historyMetricsEntry=historyMetricsEntry, histMetrAvgKbps=histMetrAvgKbps, transceiverDdmTemperature=transceiverDdmTemperature, curMetrTotalReordered=curMetrTotalReordered, curGroupIndex=curGroupIndex, curMetrDstPort=curMetrDstPort, histMetrAvgPps=histMetrAvgPps, histMetrTotalReordered=histMetrTotalReordered, performFactoryReset=performFactoryReset, curMetrPps=curMetrPps, curMetrStartTimestamp=curMetrStartTimestamp, histGroupAddr=histGroupAddr, curMetrMemberPorts=curMetrMemberPorts, histMetrSourceAddr=histMetrSourceAddr, histMetrDstPort=histMetrDstPort, histMetrPps=histMetrPps, curMetrTotalPackets=curMetrTotalPackets, curMetrAvgDelta=curMetrAvgDelta, transceiverDdmRxPower=transceiverDdmRxPower, histMetrTotalSkips=histMetrTotalSkips, cfgExecute=cfgExecute, histMetrStartTimestamp=histMetrStartTimestamp, transceiverDdmVoltage=transceiverDdmVoltage, curMetrAvgLostPps=curMetrAvgLostPps, ictServices=ictServices, histMetrTotalBytes=histMetrTotalBytes, histMetrJitter=histMetrJitter, curMetrGroupAddr=curMetrGroupAddr, catvModulePowerLevel=catvModulePowerLevel, transceiverLaserWavelength=transceiverLaserWavelength, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, catvModuleSignalDetected=catvModuleSignalDetected, histMetrGroupAddr=histMetrGroupAddr, histMetrAvgDelta=histMetrAvgDelta, catvModuleFilter=catvModuleFilter, ictMgmtMib=ictMgmtMib, histMetrMemberPorts=histMetrMemberPorts, ictMcastAnalyzer=ictMcastAnalyzer, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, ictCatv=ictCatv, catvModuleLowSignal=catvModuleLowSignal, histMetrStopTimestamp=histMetrStopTimestamp, curMetrSourceAddr=curMetrSourceAddr, transceiverTransceiverType=transceiverTransceiverType, currentListEntry=currentListEntry, histMetrReordered=histMetrReordered, ictFacRstMib=ictFacRstMib, IctDelta=IctDelta, historyListEntry=historyListEntry, icotera=icotera, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, ictFacRst=ictFacRst, histMetrLost=histMetrLost, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, transceiverEthernetCompliance=transceiverEthernetCompliance, curMetrKbps=curMetrKbps, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, curMetrLost=curMetrLost, catvModuleAdminStatus=catvModuleAdminStatus, curMetrDiscontinuities=curMetrDiscontinuities, histMetrTotalPackets=histMetrTotalPackets, histGroupIndex=histGroupIndex, ictTransceiver=ictTransceiver, curMetrJitter=curMetrJitter, transceiverDiagCapable=transceiverDiagCapable, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, ictIGW1k=ictIGW1k, curMetrTotalAvgDelta=curMetrTotalAvgDelta, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, IctPortList=IctPortList, ictFwUpg=ictFwUpg, transceiverDdmTxPower=transceiverDdmTxPower, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrReordered=curMetrReordered, ictCfgUpdate=ictCfgUpdate)
