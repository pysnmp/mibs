...
# Produced by pysmi-1.1.12 at Tue Jun  4 12:19:43 2024
...
ModuleIdentity, ObjectIdentity, Integer32, NotificationType, Counter32, enterprises, MibIdentifier, Unsigned32, Counter64, IpAddress, iso, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "Integer32", "NotificationType", "Counter32", "enterprises", "MibIdentifier", "Unsigned32", "Counter64", "IpAddress", "iso", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", catvModuleAdminStatus=catvModuleAdminStatus, curMetrAvgKbps=curMetrAvgKbps, transceiverDdmVoltage=transceiverDdmVoltage, transceiverDdmRxPower=transceiverDdmRxPower, performCpeReboot=performCpeReboot, histMetrMaxDelta=histMetrMaxDelta, catvModuleFilter=catvModuleFilter, histMetrStopTimestamp=histMetrStopTimestamp, ictIGW1k=ictIGW1k, histMetrDiscontinuities=histMetrDiscontinuities, upgExecute=upgExecute, histMetrTotalLost=histMetrTotalLost, histGroupAddr=histGroupAddr, currentMetricsEntry=currentMetricsEntry, curMetrTotalReordered=curMetrTotalReordered, histMetrStreamType=histMetrStreamType, histMetrTotalAvgDelta=histMetrTotalAvgDelta, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, curMetrGroupAddr=curMetrGroupAddr, curMetrAvgDelta=curMetrAvgDelta, histMetrMemberPorts=histMetrMemberPorts, curGroupIndex=curGroupIndex, histMetrKbps=histMetrKbps, cfgExecute=cfgExecute, cfgStatus=cfgStatus, curMetrMemberPorts=curMetrMemberPorts, curMetrSrcPort=curMetrSrcPort, histMetrTotalBytes=histMetrTotalBytes, IctDelta=IctDelta, curMetrAvgLostPps=curMetrAvgLostPps, curMetrTotalBytes=curMetrTotalBytes, histMetrPps=histMetrPps, curMetrReordered=curMetrReordered, histMetrSkips=histMetrSkips, histMetrReordered=histMetrReordered, ictCfgUpdate=ictCfgUpdate, curMetrAvgPps=curMetrAvgPps, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, curMetrSourceAddr=curMetrSourceAddr, histMetrJitter=histMetrJitter, IctJitter=IctJitter, transceiverDiagCapable=transceiverDiagCapable, catvModuleLowSignal=catvModuleLowSignal, curMetrJitter=curMetrJitter, ictTransceiver=ictTransceiver, curMetrTotalLost=curMetrTotalLost, histMetrSrcPort=histMetrSrcPort, historyMetricsEntry=historyMetricsEntry, curMetrTotalMaxDelta=curMetrTotalMaxDelta, catvModuleRflevel=catvModuleRflevel, ictMcastAnalyzer=ictMcastAnalyzer, historyListEntry=historyListEntry, histMetrAvgLostPps=histMetrAvgLostPps, transceiverDdmTemperature=transceiverDdmTemperature, currentListEntry=currentListEntry, IctPortList=IctPortList, curMetrLost=curMetrLost, curMetrStreamType=curMetrStreamType, curMetrTotalSkips=curMetrTotalSkips, curMetrStopTimestamp=curMetrStopTimestamp, histMetrAvgKbps=histMetrAvgKbps, curMetrDiscontinuities=curMetrDiscontinuities, ictMgmtMib=ictMgmtMib, ictMgmt=ictMgmt, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, upgStatus=upgStatus, histMetrTotalPackets=histMetrTotalPackets, curMetrPps=curMetrPps, histMetrLost=histMetrLost, ictServices=ictServices, PYSNMP_MODULE_ID=icotera, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, curMetrSkips=curMetrSkips, histMetrSourceAddr=histMetrSourceAddr, ictServicesMibs=ictServicesMibs, transceiverEthernetCompliance=transceiverEthernetCompliance, icotera=icotera, histMetrAvgPps=histMetrAvgPps, curMetrStartTimestamp=curMetrStartTimestamp, ictFacRstMib=ictFacRstMib, transceiverDdmTxPower=transceiverDdmTxPower, catvModuleSignalDetected=catvModuleSignalDetected, curMetrKbps=curMetrKbps, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, histMetrTotalReordered=histMetrTotalReordered, cfgTftpPath=cfgTftpPath, histMetrAvgDelta=histMetrAvgDelta, ictCatv=ictCatv, ictFacRst=ictFacRst, histGroupIndex=histGroupIndex, transceiverLinkLength=transceiverLinkLength, ictFwUpg=ictFwUpg, curGroupAddr=curGroupAddr, ictReboot=ictReboot, curMetrMaxDelta=curMetrMaxDelta, histMetrStartTimestamp=histMetrStartTimestamp, histMetrDstPort=histMetrDstPort, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, histMetrGroupAddr=histMetrGroupAddr, ictReset=ictReset, catvModulePowerLevel=catvModulePowerLevel, histMetrTotalMaxDelta=histMetrTotalMaxDelta, IctTimeStamp=IctTimeStamp, curMetrDstPort=curMetrDstPort, transceiverLaserWavelength=transceiverLaserWavelength, transceiverTransceiverType=transceiverTransceiverType, transceiverConnectorType=transceiverConnectorType, histMetrTotalSkips=histMetrTotalSkips, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, curMetrTotalAvgDelta=curMetrTotalAvgDelta, performFactoryReset=performFactoryReset, upgUrl=upgUrl, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, curMetrTotalPackets=curMetrTotalPackets)
