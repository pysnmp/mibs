...
# Produced by pysmi-1.1.8 at Thu Oct 12 08:22:00 2023
...
Counter64, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, Bits, Unsigned32, IpAddress, ModuleIdentity, enterprises, NotificationType, ObjectIdentity, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "Bits", "Unsigned32", "IpAddress", "ModuleIdentity", "enterprises", "NotificationType", "ObjectIdentity", "iso", "Gauge32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", transceiverDdmVoltage=transceiverDdmVoltage, IctDelta=IctDelta, histMetrTotalAvgDelta=histMetrTotalAvgDelta, histMetrSourceAddr=histMetrSourceAddr, curMetrPps=curMetrPps, catvModuleAdminStatus=catvModuleAdminStatus, ictMgmt=ictMgmt, histMetrReordered=histMetrReordered, currentListEntry=currentListEntry, PYSNMP_MODULE_ID=icotera, histMetrStartTimestamp=histMetrStartTimestamp, transceiverEthernetCompliance=transceiverEthernetCompliance, historyListEntry=historyListEntry, histMetrTotalReordered=histMetrTotalReordered, catvModuleFilter=catvModuleFilter, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, curMetrTotalPackets=curMetrTotalPackets, curMetrStartTimestamp=curMetrStartTimestamp, histMetrLost=histMetrLost, histMetrGroupAddr=histMetrGroupAddr, transceiverConnectorType=transceiverConnectorType, ictMcastAnalyzer=ictMcastAnalyzer, curMetrAvgPps=curMetrAvgPps, catvModuleLowSignal=catvModuleLowSignal, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, histMetrTotalLost=histMetrTotalLost, histMetrStreamType=histMetrStreamType, ictReboot=ictReboot, cfgTftpPath=cfgTftpPath, cfgStatus=cfgStatus, curMetrKbps=curMetrKbps, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, historyMetricsEntry=historyMetricsEntry, histGroupAddr=histGroupAddr, ictServicesMibs=ictServicesMibs, histMetrSrcPort=histMetrSrcPort, curMetrReordered=curMetrReordered, curMetrMemberPorts=curMetrMemberPorts, ictFwUpg=ictFwUpg, curMetrSkips=curMetrSkips, histMetrTotalPackets=histMetrTotalPackets, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, histMetrMemberPorts=histMetrMemberPorts, ictFacRst=ictFacRst, curMetrTotalReordered=curMetrTotalReordered, curMetrGroupAddr=curMetrGroupAddr, transceiverTransceiverType=transceiverTransceiverType, performFactoryReset=performFactoryReset, IctTimeStamp=IctTimeStamp, histMetrAvgLostPps=histMetrAvgLostPps, histMetrTotalBytes=histMetrTotalBytes, ictMgmtMib=ictMgmtMib, curMetrStreamType=curMetrStreamType, transceiverDdmTemperature=transceiverDdmTemperature, histMetrSkips=histMetrSkips, curMetrMaxDelta=curMetrMaxDelta, upgUrl=upgUrl, curGroupAddr=curGroupAddr, curMetrSrcPort=curMetrSrcPort, currentMetricsEntry=currentMetricsEntry, histMetrStopTimestamp=histMetrStopTimestamp, IctPortList=IctPortList, catvModuleRflevel=catvModuleRflevel, transceiverDdmTxPower=transceiverDdmTxPower, ictCfgUpdate=ictCfgUpdate, ictServices=ictServices, transceiverLinkLength=transceiverLinkLength, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, curMetrDstPort=curMetrDstPort, upgExecute=upgExecute, histMetrAvgKbps=histMetrAvgKbps, transceiverDdmRxPower=transceiverDdmRxPower, histMetrAvgDelta=histMetrAvgDelta, histMetrJitter=histMetrJitter, IctJitter=IctJitter, curMetrTotalAvgDelta=curMetrTotalAvgDelta, ictIGW1k=ictIGW1k, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, histMetrDstPort=histMetrDstPort, histMetrMaxDelta=histMetrMaxDelta, transceiverDiagCapable=transceiverDiagCapable, ictTransceiver=ictTransceiver, histMetrAvgPps=histMetrAvgPps, ictCatv=ictCatv, performCpeReboot=performCpeReboot, curMetrTotalBytes=curMetrTotalBytes, curMetrTotalSkips=curMetrTotalSkips, histGroupIndex=histGroupIndex, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, curMetrDiscontinuities=curMetrDiscontinuities, curMetrJitter=curMetrJitter, upgStatus=upgStatus, histMetrTotalMaxDelta=histMetrTotalMaxDelta, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, catvModuleSignalDetected=catvModuleSignalDetected, ictReset=ictReset, cfgExecute=cfgExecute, transceiverLaserWavelength=transceiverLaserWavelength, histMetrKbps=histMetrKbps, curMetrSourceAddr=curMetrSourceAddr, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, curMetrAvgLostPps=curMetrAvgLostPps, curMetrLost=curMetrLost, curMetrAvgDelta=curMetrAvgDelta, curGroupIndex=curGroupIndex, histMetrPps=histMetrPps, catvModulePowerLevel=catvModulePowerLevel, histMetrDiscontinuities=histMetrDiscontinuities, icotera=icotera, ictFacRstMib=ictFacRstMib, curMetrStopTimestamp=curMetrStopTimestamp, curMetrTotalMaxDelta=curMetrTotalMaxDelta, curMetrAvgKbps=curMetrAvgKbps, histMetrTotalSkips=histMetrTotalSkips, curMetrTotalLost=curMetrTotalLost)
