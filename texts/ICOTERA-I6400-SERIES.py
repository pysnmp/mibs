...
ModuleIdentity, Counter32, Unsigned32, Counter64, TimeTicks, enterprises, Gauge32, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, IpAddress, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Unsigned32", "Counter64", "TimeTicks", "enterprises", "Gauge32", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "IpAddress", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", performCpeReboot=performCpeReboot, ictCatv=ictCatv, histMetrLost=histMetrLost, histMetrReordered=histMetrReordered, IctTimeStamp=IctTimeStamp, histMetrSourceAddr=histMetrSourceAddr, histMetrTotalSkips=histMetrTotalSkips, histMetrAvgKbps=histMetrAvgKbps, histMetrAvgPps=histMetrAvgPps, curMetrTotalBytes=curMetrTotalBytes, histMetrStreamType=histMetrStreamType, curMetrGroupAddr=curMetrGroupAddr, ictFacRst=ictFacRst, curMetrSourceAddr=curMetrSourceAddr, transceiverLinkLength=transceiverLinkLength, histMetrSkips=histMetrSkips, histMetrTotalBytes=histMetrTotalBytes, histMetrDiscontinuities=histMetrDiscontinuities, curMetrTotalSkips=curMetrTotalSkips, histGroupIndex=histGroupIndex, curMetrTotalReordered=curMetrTotalReordered, catvModuleSignalDetected=catvModuleSignalDetected, IctJitter=IctJitter, histMetrJitter=histMetrJitter, curMetrStreamType=curMetrStreamType, curMetrTotalLost=curMetrTotalLost, histMetrTotalLost=histMetrTotalLost, transceiverDdmRxPower=transceiverDdmRxPower, ictServicesMibs=ictServicesMibs, historyListEntry=historyListEntry, ictFacRstMib=ictFacRstMib, histMetrStopTimestamp=histMetrStopTimestamp, cfgStatus=cfgStatus, ictMcastAnalyzer=ictMcastAnalyzer, ictCfgUpdate=ictCfgUpdate, historyMetricsEntry=historyMetricsEntry, curMetrTotalAvgDelta=curMetrTotalAvgDelta, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, histMetrMemberPorts=histMetrMemberPorts, curMetrDiscontinuities=curMetrDiscontinuities, upgExecute=upgExecute, curMetrPps=curMetrPps, curMetrAvgLostPps=curMetrAvgLostPps, currentMetricsEntry=currentMetricsEntry, catvModulePowerLevel=catvModulePowerLevel, histMetrSrcPort=histMetrSrcPort, IctDelta=IctDelta, curMetrReordered=curMetrReordered, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, currentListEntry=currentListEntry, histMetrTotalMaxDelta=histMetrTotalMaxDelta, curMetrAvgKbps=curMetrAvgKbps, transceiverEthernetCompliance=transceiverEthernetCompliance, histMetrPps=histMetrPps, cfgExecute=cfgExecute, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, curMetrStopTimestamp=curMetrStopTimestamp, curMetrKbps=curMetrKbps, transceiverConnectorType=transceiverConnectorType, transceiverDdmTemperature=transceiverDdmTemperature, curMetrStartTimestamp=curMetrStartTimestamp, curMetrMemberPorts=curMetrMemberPorts, transceiverDdmTxPower=transceiverDdmTxPower, transceiverTransceiverType=transceiverTransceiverType, ictServices=ictServices, icotera=icotera, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, curMetrJitter=curMetrJitter, cfgTftpPath=cfgTftpPath, histMetrMaxDelta=histMetrMaxDelta, curMetrAvgPps=curMetrAvgPps, histMetrAvgLostPps=histMetrAvgLostPps, PYSNMP_MODULE_ID=icotera, catvModuleAdminStatus=catvModuleAdminStatus, histMetrTotalAvgDelta=histMetrTotalAvgDelta, curMetrLost=curMetrLost, ictMgmt=ictMgmt, histMetrKbps=histMetrKbps, catvModuleRflevel=catvModuleRflevel, transceiverDdmVoltage=transceiverDdmVoltage, ictTransceiver=ictTransceiver, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, IctPortList=IctPortList, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, histMetrTotalReordered=histMetrTotalReordered, curMetrMaxDelta=curMetrMaxDelta, curMetrDstPort=curMetrDstPort, ictIGW1k=ictIGW1k, catvModuleFilter=catvModuleFilter, catvModuleLowSignal=catvModuleLowSignal, transceiverDiagCapable=transceiverDiagCapable, histMetrGroupAddr=histMetrGroupAddr, curMetrSrcPort=curMetrSrcPort, ictMgmtMib=ictMgmtMib, curMetrAvgDelta=curMetrAvgDelta, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, curMetrTotalPackets=curMetrTotalPackets, ictReboot=ictReboot, upgUrl=upgUrl, upgStatus=upgStatus, histMetrTotalPackets=histMetrTotalPackets, histMetrDstPort=histMetrDstPort, transceiverLaserWavelength=transceiverLaserWavelength, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, histMetrStartTimestamp=histMetrStartTimestamp, curMetrSkips=curMetrSkips, ictReset=ictReset, histGroupAddr=histGroupAddr, ictFwUpg=ictFwUpg, curGroupIndex=curGroupIndex, histMetrAvgDelta=histMetrAvgDelta, performFactoryReset=performFactoryReset, curGroupAddr=curGroupAddr, curMetrTotalMaxDelta=curMetrTotalMaxDelta)
