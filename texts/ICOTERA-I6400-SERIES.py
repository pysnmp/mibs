...
# Produced by pysmi-1.1.10 at Fri Oct 27 07:55:16 2023
...
ObjectIdentity, IpAddress, Unsigned32, NotificationType, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, Counter32, iso, Bits, enterprises, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Unsigned32", "NotificationType", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "Counter32", "iso", "Bits", "enterprises", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", curMetrSourceAddr=curMetrSourceAddr, histMetrGroupAddr=histMetrGroupAddr, histMetrSkips=histMetrSkips, ictReset=ictReset, histMetrDiscontinuities=histMetrDiscontinuities, performFactoryReset=performFactoryReset, transceiverTransceiverType=transceiverTransceiverType, histMetrSourceAddr=histMetrSourceAddr, histMetrStartTimestamp=histMetrStartTimestamp, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, performCpeReboot=performCpeReboot, ictFacRstMib=ictFacRstMib, transceiverDdmTemperature=transceiverDdmTemperature, histMetrTotalAvgDelta=histMetrTotalAvgDelta, catvModuleLowSignal=catvModuleLowSignal, curMetrReordered=curMetrReordered, histMetrSrcPort=histMetrSrcPort, catvModuleAdminStatus=catvModuleAdminStatus, ictFacRst=ictFacRst, curMetrKbps=curMetrKbps, IctPortList=IctPortList, curMetrTotalReordered=curMetrTotalReordered, transceiverConnectorType=transceiverConnectorType, upgExecute=upgExecute, curMetrTotalSkips=curMetrTotalSkips, transceiverDdmRxPower=transceiverDdmRxPower, curMetrStartTimestamp=curMetrStartTimestamp, ictMgmtMib=ictMgmtMib, histMetrTotalLost=histMetrTotalLost, histMetrMaxDelta=histMetrMaxDelta, ictCatv=ictCatv, historyListEntry=historyListEntry, transceiverDdmVoltage=transceiverDdmVoltage, ictIGW1k=ictIGW1k, ictServices=ictServices, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, cfgStatus=cfgStatus, histMetrTotalMaxDelta=histMetrTotalMaxDelta, curMetrMemberPorts=curMetrMemberPorts, historyMetricsEntry=historyMetricsEntry, histMetrLost=histMetrLost, curMetrDiscontinuities=curMetrDiscontinuities, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, curMetrSrcPort=curMetrSrcPort, curMetrTotalBytes=curMetrTotalBytes, cfgTftpPath=cfgTftpPath, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, catvModuleRflevel=catvModuleRflevel, ictReboot=ictReboot, IctTimeStamp=IctTimeStamp, curMetrTotalMaxDelta=curMetrTotalMaxDelta, IctDelta=IctDelta, curMetrAvgDelta=curMetrAvgDelta, ictTransceiver=ictTransceiver, catvModuleSignalDetected=catvModuleSignalDetected, histMetrAvgKbps=histMetrAvgKbps, transceiverLaserWavelength=transceiverLaserWavelength, upgUrl=upgUrl, histMetrStreamType=histMetrStreamType, histGroupIndex=histGroupIndex, histMetrReordered=histMetrReordered, curMetrGroupAddr=curMetrGroupAddr, histGroupAddr=histGroupAddr, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, histMetrPps=histMetrPps, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, transceiverLinkLength=transceiverLinkLength, curMetrAvgPps=curMetrAvgPps, curMetrTotalPackets=curMetrTotalPackets, histMetrAvgLostPps=histMetrAvgLostPps, histMetrTotalPackets=histMetrTotalPackets, currentListEntry=currentListEntry, histMetrAvgDelta=histMetrAvgDelta, ictMgmt=ictMgmt, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, curMetrStreamType=curMetrStreamType, histMetrTotalSkips=histMetrTotalSkips, histMetrDstPort=histMetrDstPort, upgStatus=upgStatus, histMetrJitter=histMetrJitter, IctJitter=IctJitter, histMetrAvgPps=histMetrAvgPps, transceiverDiagCapable=transceiverDiagCapable, histMetrMemberPorts=histMetrMemberPorts, ictCfgUpdate=ictCfgUpdate, PYSNMP_MODULE_ID=icotera, curMetrAvgKbps=curMetrAvgKbps, transceiverEthernetCompliance=transceiverEthernetCompliance, curMetrStopTimestamp=curMetrStopTimestamp, curMetrJitter=curMetrJitter, curMetrSkips=curMetrSkips, cfgExecute=cfgExecute, curGroupAddr=curGroupAddr, curMetrPps=curMetrPps, histMetrTotalBytes=histMetrTotalBytes, histMetrTotalReordered=histMetrTotalReordered, curGroupIndex=curGroupIndex, catvModulePowerLevel=catvModulePowerLevel, curMetrMaxDelta=curMetrMaxDelta, curMetrDstPort=curMetrDstPort, curMetrAvgLostPps=curMetrAvgLostPps, currentMetricsEntry=currentMetricsEntry, histMetrKbps=histMetrKbps, transceiverDdmTxPower=transceiverDdmTxPower, icotera=icotera, ictMcastAnalyzer=ictMcastAnalyzer, curMetrLost=curMetrLost, curMetrTotalLost=curMetrTotalLost, ictServicesMibs=ictServicesMibs, curMetrTotalAvgDelta=curMetrTotalAvgDelta, catvModuleFilter=catvModuleFilter, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, ictFwUpg=ictFwUpg, histMetrStopTimestamp=histMetrStopTimestamp)
