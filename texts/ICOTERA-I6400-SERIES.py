...
NotificationType, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, Bits, TimeTicks, Counter64, Unsigned32, ModuleIdentity, Counter32, IpAddress, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "Bits", "TimeTicks", "Counter64", "Unsigned32", "ModuleIdentity", "Counter32", "IpAddress", "Gauge32", "iso")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", histGroupIndex=histGroupIndex, transceiverConnectorType=transceiverConnectorType, curMetrSkips=curMetrSkips, histMetrAvgDelta=histMetrAvgDelta, curMetrTotalBytes=curMetrTotalBytes, transceiverDdmRxPower=transceiverDdmRxPower, curMetrKbps=curMetrKbps, histMetrDstPort=histMetrDstPort, transceiverLaserWavelength=transceiverLaserWavelength, histMetrDiscontinuities=histMetrDiscontinuities, catvModuleLowSignal=catvModuleLowSignal, curMetrAvgLostPps=curMetrAvgLostPps, curMetrTotalLost=curMetrTotalLost, curMetrDiscontinuities=curMetrDiscontinuities, ictFacRstMib=ictFacRstMib, histMetrStartTimestamp=histMetrStartTimestamp, ictMcastAnalyzer=ictMcastAnalyzer, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, curMetrStopTimestamp=curMetrStopTimestamp, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, upgExecute=upgExecute, histMetrMemberPorts=histMetrMemberPorts, histMetrReordered=histMetrReordered, upgStatus=upgStatus, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, curGroupAddr=curGroupAddr, curMetrSourceAddr=curMetrSourceAddr, curMetrTotalAvgDelta=curMetrTotalAvgDelta, IctTimeStamp=IctTimeStamp, transceiverDdmTxPower=transceiverDdmTxPower, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, histMetrStreamType=histMetrStreamType, ictCatv=ictCatv, curMetrGroupAddr=curMetrGroupAddr, catvModuleSignalDetected=catvModuleSignalDetected, transceiverEthernetCompliance=transceiverEthernetCompliance, curMetrDstPort=curMetrDstPort, histMetrAvgKbps=histMetrAvgKbps, curMetrMemberPorts=curMetrMemberPorts, ictServicesMibs=ictServicesMibs, transceiverLinkLength=transceiverLinkLength, curMetrMaxDelta=curMetrMaxDelta, cfgExecute=cfgExecute, curMetrTotalMaxDelta=curMetrTotalMaxDelta, histMetrMaxDelta=histMetrMaxDelta, IctJitter=IctJitter, curMetrPps=curMetrPps, curMetrTotalReordered=curMetrTotalReordered, curMetrTotalPackets=curMetrTotalPackets, histMetrJitter=histMetrJitter, transceiverDdmTemperature=transceiverDdmTemperature, ictIGW1k=ictIGW1k, curMetrAvgDelta=curMetrAvgDelta, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, histMetrTotalAvgDelta=histMetrTotalAvgDelta, histMetrAvgLostPps=histMetrAvgLostPps, PYSNMP_MODULE_ID=icotera, IctPortList=IctPortList, histMetrTotalBytes=histMetrTotalBytes, icotera=icotera, histMetrSrcPort=histMetrSrcPort, histMetrStopTimestamp=histMetrStopTimestamp, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, performCpeReboot=performCpeReboot, histMetrTotalSkips=histMetrTotalSkips, histMetrLost=histMetrLost, ictServices=ictServices, upgUrl=upgUrl, histMetrAvgPps=histMetrAvgPps, transceiverDiagCapable=transceiverDiagCapable, currentMetricsEntry=currentMetricsEntry, curMetrSrcPort=curMetrSrcPort, histMetrSkips=histMetrSkips, curMetrStartTimestamp=curMetrStartTimestamp, transceiverDdmVoltage=transceiverDdmVoltage, historyListEntry=historyListEntry, cfgTftpPath=cfgTftpPath, ictReset=ictReset, ictReboot=ictReboot, ictFacRst=ictFacRst, curMetrLost=curMetrLost, histMetrTotalMaxDelta=histMetrTotalMaxDelta, curMetrStreamType=curMetrStreamType, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, ictMgmtMib=ictMgmtMib, transceiverTransceiverType=transceiverTransceiverType, curMetrTotalSkips=curMetrTotalSkips, catvModuleRflevel=catvModuleRflevel, historyMetricsEntry=historyMetricsEntry, ictTransceiver=ictTransceiver, histMetrSourceAddr=histMetrSourceAddr, histMetrGroupAddr=histMetrGroupAddr, ictFwUpg=ictFwUpg, curMetrAvgPps=curMetrAvgPps, histGroupAddr=histGroupAddr, ictMgmt=ictMgmt, histMetrKbps=histMetrKbps, cfgStatus=cfgStatus, catvModulePowerLevel=catvModulePowerLevel, currentListEntry=currentListEntry, catvModuleFilter=catvModuleFilter, catvModuleAdminStatus=catvModuleAdminStatus, histMetrTotalLost=histMetrTotalLost, curMetrJitter=curMetrJitter, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, histMetrTotalPackets=histMetrTotalPackets, ictCfgUpdate=ictCfgUpdate, performFactoryReset=performFactoryReset, histMetrPps=histMetrPps, histMetrTotalReordered=histMetrTotalReordered, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, curMetrAvgKbps=curMetrAvgKbps, curGroupIndex=curGroupIndex, curMetrReordered=curMetrReordered, IctDelta=IctDelta)
