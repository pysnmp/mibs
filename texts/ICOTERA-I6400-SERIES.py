...
iso, Gauge32, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress, Counter32, enterprises, Bits, TimeTicks, NotificationType, MibIdentifier, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress", "Counter32", "enterprises", "Bits", "TimeTicks", "NotificationType", "MibIdentifier", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", ictMgmt=ictMgmt, curMetrAvgKbps=curMetrAvgKbps, IctJitter=IctJitter, transceiverDdmRxPower=transceiverDdmRxPower, histMetrReordered=histMetrReordered, icotera=icotera, ictFacRstMib=ictFacRstMib, histMetrDiscontinuities=histMetrDiscontinuities, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, histGroupIndex=histGroupIndex, transceiverLinkLength=transceiverLinkLength, curMetrTotalMaxDelta=curMetrTotalMaxDelta, catvModulePowerLevel=catvModulePowerLevel, histGroupAddr=histGroupAddr, histMetrLost=histMetrLost, transceiverEthernetCompliance=transceiverEthernetCompliance, ictReset=ictReset, curMetrJitter=curMetrJitter, upgUrl=upgUrl, ictCatv=ictCatv, histMetrKbps=histMetrKbps, histMetrStopTimestamp=histMetrStopTimestamp, IctTimeStamp=IctTimeStamp, histMetrDstPort=histMetrDstPort, curMetrMaxDelta=curMetrMaxDelta, catvModuleFilter=catvModuleFilter, curMetrMemberPorts=curMetrMemberPorts, cfgTftpPath=cfgTftpPath, histMetrTotalReordered=histMetrTotalReordered, histMetrMemberPorts=histMetrMemberPorts, curGroupAddr=curGroupAddr, curMetrAvgLostPps=curMetrAvgLostPps, performFactoryReset=performFactoryReset, curMetrTotalSkips=curMetrTotalSkips, cfgExecute=cfgExecute, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, histMetrTotalLost=histMetrTotalLost, transceiverTransceiverType=transceiverTransceiverType, ictCfgUpdate=ictCfgUpdate, histMetrPps=histMetrPps, transceiverLaserWavelength=transceiverLaserWavelength, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, curMetrReordered=curMetrReordered, transceiverDdmTxPower=transceiverDdmTxPower, curMetrTotalReordered=curMetrTotalReordered, curMetrPps=curMetrPps, curMetrStreamType=curMetrStreamType, histMetrTotalSkips=histMetrTotalSkips, ictMcastAnalyzer=ictMcastAnalyzer, cfgStatus=cfgStatus, curMetrLost=curMetrLost, histMetrTotalAvgDelta=histMetrTotalAvgDelta, histMetrSkips=histMetrSkips, histMetrGroupAddr=histMetrGroupAddr, histMetrJitter=histMetrJitter, ictMgmtMib=ictMgmtMib, IctDelta=IctDelta, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, ictFwUpg=ictFwUpg, curMetrDstPort=curMetrDstPort, histMetrAvgKbps=histMetrAvgKbps, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, historyMetricsEntry=historyMetricsEntry, upgExecute=upgExecute, ictReboot=ictReboot, historyListEntry=historyListEntry, ictServices=ictServices, curMetrSourceAddr=curMetrSourceAddr, histMetrStartTimestamp=histMetrStartTimestamp, histMetrTotalBytes=histMetrTotalBytes, histMetrStreamType=histMetrStreamType, curMetrTotalAvgDelta=curMetrTotalAvgDelta, ictTransceiver=ictTransceiver, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, curMetrStartTimestamp=curMetrStartTimestamp, histMetrMaxDelta=histMetrMaxDelta, curMetrTotalPackets=curMetrTotalPackets, catvModuleRflevel=catvModuleRflevel, curMetrAvgDelta=curMetrAvgDelta, histMetrTotalMaxDelta=histMetrTotalMaxDelta, curMetrAvgPps=curMetrAvgPps, performCpeReboot=performCpeReboot, curMetrGroupAddr=curMetrGroupAddr, ictIGW1k=ictIGW1k, catvModuleSignalDetected=catvModuleSignalDetected, histMetrAvgPps=histMetrAvgPps, IctPortList=IctPortList, curMetrStopTimestamp=curMetrStopTimestamp, histMetrAvgLostPps=histMetrAvgLostPps, currentMetricsEntry=currentMetricsEntry, ictServicesMibs=ictServicesMibs, transceiverConnectorType=transceiverConnectorType, curMetrTotalBytes=curMetrTotalBytes, histMetrAvgDelta=histMetrAvgDelta, currentListEntry=currentListEntry, PYSNMP_MODULE_ID=icotera, curGroupIndex=curGroupIndex, curMetrDiscontinuities=curMetrDiscontinuities, curMetrKbps=curMetrKbps, curMetrTotalLost=curMetrTotalLost, histMetrTotalPackets=histMetrTotalPackets, upgStatus=upgStatus, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, ictFacRst=ictFacRst, transceiverDdmVoltage=transceiverDdmVoltage, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, catvModuleAdminStatus=catvModuleAdminStatus, histMetrSrcPort=histMetrSrcPort, histMetrSourceAddr=histMetrSourceAddr, curMetrSrcPort=curMetrSrcPort, catvModuleLowSignal=catvModuleLowSignal, transceiverDdmTemperature=transceiverDdmTemperature, transceiverDiagCapable=transceiverDiagCapable, curMetrSkips=curMetrSkips)
