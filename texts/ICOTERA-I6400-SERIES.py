...
iso, Unsigned32, Bits, Counter32, Counter64, ObjectIdentity, NotificationType, Gauge32, TimeTicks, ModuleIdentity, enterprises, MibIdentifier, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "Bits", "Counter32", "Counter64", "ObjectIdentity", "NotificationType", "Gauge32", "TimeTicks", "ModuleIdentity", "enterprises", "MibIdentifier", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", curMetrSrcPort=curMetrSrcPort, cfgTftpPath=cfgTftpPath, curMetrStartTimestamp=curMetrStartTimestamp, curMetrTotalLost=curMetrTotalLost, histMetrMaxDelta=histMetrMaxDelta, IctJitter=IctJitter, transceiverEthernetCompliance=transceiverEthernetCompliance, curMetrTotalMaxDelta=curMetrTotalMaxDelta, transceiverLinkLength=transceiverLinkLength, IctDelta=IctDelta, histMetrTotalLost=histMetrTotalLost, transceiverDdmRxPower=transceiverDdmRxPower, histMetrSrcPort=histMetrSrcPort, IctPortList=IctPortList, curMetrAvgPps=curMetrAvgPps, curMetrStreamType=curMetrStreamType, ictFacRst=ictFacRst, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, historyMetricsEntry=historyMetricsEntry, historyListEntry=historyListEntry, histMetrStopTimestamp=histMetrStopTimestamp, curMetrMaxDelta=curMetrMaxDelta, transceiverConnectorType=transceiverConnectorType, ictFacRstMib=ictFacRstMib, ictMgmt=ictMgmt, curMetrTotalAvgDelta=curMetrTotalAvgDelta, curMetrJitter=curMetrJitter, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, histMetrPps=histMetrPps, histMetrDiscontinuities=histMetrDiscontinuities, upgUrl=upgUrl, histMetrGroupAddr=histMetrGroupAddr, curMetrTotalBytes=curMetrTotalBytes, catvModuleRflevel=catvModuleRflevel, IctTimeStamp=IctTimeStamp, histMetrAvgLostPps=histMetrAvgLostPps, histMetrLost=histMetrLost, PYSNMP_MODULE_ID=icotera, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, histMetrDstPort=histMetrDstPort, curMetrKbps=curMetrKbps, catvModuleFilter=catvModuleFilter, curMetrTotalReordered=curMetrTotalReordered, histMetrJitter=histMetrJitter, catvModuleAdminStatus=catvModuleAdminStatus, catvModuleLowSignal=catvModuleLowSignal, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, ictFwUpg=ictFwUpg, curMetrAvgKbps=curMetrAvgKbps, currentMetricsEntry=currentMetricsEntry, histMetrSkips=histMetrSkips, curMetrSkips=curMetrSkips, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, catvModuleSignalDetected=catvModuleSignalDetected, transceiverTransceiverType=transceiverTransceiverType, currentListEntry=currentListEntry, curGroupIndex=curGroupIndex, ictMgmtMib=ictMgmtMib, curMetrLost=curMetrLost, cfgStatus=cfgStatus, transceiverDdmVoltage=transceiverDdmVoltage, upgStatus=upgStatus, histMetrReordered=histMetrReordered, curMetrMemberPorts=curMetrMemberPorts, curMetrTotalPackets=curMetrTotalPackets, histMetrSourceAddr=histMetrSourceAddr, upgExecute=upgExecute, histMetrTotalReordered=histMetrTotalReordered, histMetrTotalBytes=histMetrTotalBytes, curGroupAddr=curGroupAddr, curMetrStopTimestamp=curMetrStopTimestamp, histMetrAvgKbps=histMetrAvgKbps, histMetrTotalSkips=histMetrTotalSkips, cfgExecute=cfgExecute, ictReboot=ictReboot, histMetrTotalAvgDelta=histMetrTotalAvgDelta, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, ictMcastAnalyzer=ictMcastAnalyzer, ictTransceiver=ictTransceiver, catvModulePowerLevel=catvModulePowerLevel, ictServices=ictServices, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, ictReset=ictReset, histGroupAddr=histGroupAddr, histMetrTotalPackets=histMetrTotalPackets, ictCatv=ictCatv, curMetrDiscontinuities=curMetrDiscontinuities, transceiverLaserWavelength=transceiverLaserWavelength, transceiverDdmTxPower=transceiverDdmTxPower, curMetrReordered=curMetrReordered, ictIGW1k=ictIGW1k, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, curMetrPps=curMetrPps, histMetrAvgPps=histMetrAvgPps, curMetrTotalSkips=curMetrTotalSkips, histGroupIndex=histGroupIndex, curMetrAvgDelta=curMetrAvgDelta, histMetrKbps=histMetrKbps, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, histMetrTotalMaxDelta=histMetrTotalMaxDelta, curMetrAvgLostPps=curMetrAvgLostPps, transceiverDiagCapable=transceiverDiagCapable, curMetrGroupAddr=curMetrGroupAddr, icotera=icotera, performCpeReboot=performCpeReboot, transceiverDdmTemperature=transceiverDdmTemperature, histMetrMemberPorts=histMetrMemberPorts, histMetrStartTimestamp=histMetrStartTimestamp, ictCfgUpdate=ictCfgUpdate, ictServicesMibs=ictServicesMibs, histMetrStreamType=histMetrStreamType, histMetrAvgDelta=histMetrAvgDelta, curMetrDstPort=curMetrDstPort, curMetrSourceAddr=curMetrSourceAddr, performFactoryReset=performFactoryReset)
