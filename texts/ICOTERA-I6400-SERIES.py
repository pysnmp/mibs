...
# Produced by pysmi-1.1.3 at Wed Dec  8 21:20:42 2021
...
Counter32, NotificationType, ModuleIdentity, ObjectIdentity, IpAddress, MibIdentifier, Unsigned32, Gauge32, Counter64, iso, TimeTicks, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "ModuleIdentity", "ObjectIdentity", "IpAddress", "MibIdentifier", "Unsigned32", "Gauge32", "Counter64", "iso", "TimeTicks", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", histMetrGroupAddr=histMetrGroupAddr, histMetrTotalLost=histMetrTotalLost, curMetrDiscontinuities=curMetrDiscontinuities, ictTransceiver=ictTransceiver, histMetrTotalAvgDelta=histMetrTotalAvgDelta, histMetrAvgPps=histMetrAvgPps, curMetrTotalPackets=curMetrTotalPackets, catvModuleAdminStatus=catvModuleAdminStatus, histMetrTotalMaxDelta=histMetrTotalMaxDelta, curMetrMemberPorts=curMetrMemberPorts, transceiverDdmTemperature=transceiverDdmTemperature, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, curMetrKbps=curMetrKbps, catvModuleFilter=catvModuleFilter, transceiverLinkLength=transceiverLinkLength, IctJitter=IctJitter, curMetrSrcPort=curMetrSrcPort, curMetrSourceAddr=curMetrSourceAddr, curMetrAvgLostPps=curMetrAvgLostPps, histGroupIndex=histGroupIndex, histMetrSourceAddr=histMetrSourceAddr, curMetrTotalAvgDelta=curMetrTotalAvgDelta, curMetrSkips=curMetrSkips, curGroupIndex=curGroupIndex, curMetrStreamType=curMetrStreamType, histMetrJitter=histMetrJitter, histMetrStartTimestamp=histMetrStartTimestamp, curMetrTotalSkips=curMetrTotalSkips, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, curMetrStartTimestamp=curMetrStartTimestamp, histMetrDiscontinuities=histMetrDiscontinuities, upgExecute=upgExecute, histMetrTotalBytes=histMetrTotalBytes, histGroupAddr=histGroupAddr, ictServicesMibs=ictServicesMibs, histMetrKbps=histMetrKbps, curMetrAvgKbps=curMetrAvgKbps, histMetrMemberPorts=histMetrMemberPorts, curMetrTotalLost=curMetrTotalLost, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, catvModulePowerLevel=catvModulePowerLevel, histMetrLost=histMetrLost, histMetrTotalSkips=histMetrTotalSkips, curMetrMaxDelta=curMetrMaxDelta, curMetrStopTimestamp=curMetrStopTimestamp, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, IctPortList=IctPortList, PYSNMP_MODULE_ID=icotera, histMetrMaxDelta=histMetrMaxDelta, currentMetricsEntry=currentMetricsEntry, ictFacRstMib=ictFacRstMib, catvModuleRflevel=catvModuleRflevel, curMetrAvgDelta=curMetrAvgDelta, transceiverDiagCapable=transceiverDiagCapable, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, histMetrTotalReordered=histMetrTotalReordered, ictServices=ictServices, curGroupAddr=curGroupAddr, histMetrDstPort=histMetrDstPort, histMetrSkips=histMetrSkips, curMetrJitter=curMetrJitter, curMetrTotalBytes=curMetrTotalBytes, ictFacRst=ictFacRst, IctTimeStamp=IctTimeStamp, curMetrPps=curMetrPps, ictCfgUpdate=ictCfgUpdate, ictMgmtMib=ictMgmtMib, icotera=icotera, histMetrStopTimestamp=histMetrStopTimestamp, transceiverLaserWavelength=transceiverLaserWavelength, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrTotalMaxDelta=curMetrTotalMaxDelta, histMetrAvgDelta=histMetrAvgDelta, historyMetricsEntry=historyMetricsEntry, histMetrAvgKbps=histMetrAvgKbps, currentListEntry=currentListEntry, performCpeReboot=performCpeReboot, curMetrLost=curMetrLost, transceiverDdmRxPower=transceiverDdmRxPower, IctDelta=IctDelta, histMetrSrcPort=histMetrSrcPort, performFactoryReset=performFactoryReset, histMetrStreamType=histMetrStreamType, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, ictReboot=ictReboot, histMetrPps=histMetrPps, histMetrTotalPackets=histMetrTotalPackets, upgUrl=upgUrl, transceiverDdmTxPower=transceiverDdmTxPower, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, ictMcastAnalyzer=ictMcastAnalyzer, cfgExecute=cfgExecute, historyListEntry=historyListEntry, ictIGW1k=ictIGW1k, curMetrDstPort=curMetrDstPort, transceiverConnectorType=transceiverConnectorType, upgStatus=upgStatus, catvModuleLowSignal=catvModuleLowSignal, catvModuleSignalDetected=catvModuleSignalDetected, transceiverDdmVoltage=transceiverDdmVoltage, ictCatv=ictCatv, transceiverTransceiverType=transceiverTransceiverType, curMetrGroupAddr=curMetrGroupAddr, histMetrReordered=histMetrReordered, ictReset=ictReset, curMetrTotalReordered=curMetrTotalReordered, ictMgmt=ictMgmt, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, ictFwUpg=ictFwUpg, curMetrReordered=curMetrReordered, transceiverEthernetCompliance=transceiverEthernetCompliance, cfgTftpPath=cfgTftpPath, cfgStatus=cfgStatus, curMetrAvgPps=curMetrAvgPps, histMetrAvgLostPps=histMetrAvgLostPps)
