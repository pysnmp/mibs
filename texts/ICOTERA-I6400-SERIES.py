...
# Produced by pysmi-1.1.12 at Tue Jun  4 10:10:46 2024
...
ObjectIdentity, enterprises, IpAddress, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, Unsigned32, Bits, Gauge32, Counter64, iso, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "enterprises", "IpAddress", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "Unsigned32", "Bits", "Gauge32", "Counter64", "iso", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", transceiverTransceiverType=transceiverTransceiverType, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, transceiverDdmVoltage=transceiverDdmVoltage, transceiverDdmTemperature=transceiverDdmTemperature, IctTimeStamp=IctTimeStamp, curMetrTotalPackets=curMetrTotalPackets, histMetrAvgDelta=histMetrAvgDelta, curMetrDiscontinuities=curMetrDiscontinuities, curMetrMaxDelta=curMetrMaxDelta, upgUrl=upgUrl, curMetrJitter=curMetrJitter, histMetrTotalPackets=histMetrTotalPackets, transceiverEthernetCompliance=transceiverEthernetCompliance, cfgTftpPath=cfgTftpPath, performFactoryReset=performFactoryReset, curMetrStreamType=curMetrStreamType, ictReboot=ictReboot, histMetrMaxDelta=histMetrMaxDelta, ictMgmtMib=ictMgmtMib, transceiverDiagCapable=transceiverDiagCapable, ictServicesMibs=ictServicesMibs, curMetrTotalAvgDelta=curMetrTotalAvgDelta, ictFwUpg=ictFwUpg, catvModuleLowSignal=catvModuleLowSignal, histMetrSourceAddr=histMetrSourceAddr, histMetrDstPort=histMetrDstPort, curMetrTotalBytes=curMetrTotalBytes, IctDelta=IctDelta, curMetrAvgKbps=curMetrAvgKbps, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, curGroupAddr=curGroupAddr, curMetrDstPort=curMetrDstPort, histMetrTotalMaxDelta=histMetrTotalMaxDelta, ictTransceiver=ictTransceiver, upgStatus=upgStatus, histMetrStreamType=histMetrStreamType, catvModuleAdminStatus=catvModuleAdminStatus, icotera=icotera, curMetrSkips=curMetrSkips, cfgStatus=cfgStatus, ictMcastAnalyzer=ictMcastAnalyzer, histMetrTotalAvgDelta=histMetrTotalAvgDelta, IctPortList=IctPortList, curMetrSourceAddr=curMetrSourceAddr, curMetrSrcPort=curMetrSrcPort, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, transceiverConnectorType=transceiverConnectorType, transceiverDdmRxPower=transceiverDdmRxPower, cfgExecute=cfgExecute, curMetrTotalReordered=curMetrTotalReordered, histMetrAvgLostPps=histMetrAvgLostPps, histMetrStartTimestamp=histMetrStartTimestamp, IctJitter=IctJitter, histMetrDiscontinuities=histMetrDiscontinuities, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, catvModulePowerLevel=catvModulePowerLevel, histMetrSkips=histMetrSkips, curMetrReordered=curMetrReordered, ictServices=ictServices, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, histMetrTotalReordered=histMetrTotalReordered, histMetrAvgPps=histMetrAvgPps, currentListEntry=currentListEntry, curMetrTotalSkips=curMetrTotalSkips, currentMetricsEntry=currentMetricsEntry, ictReset=ictReset, curMetrMemberPorts=curMetrMemberPorts, histMetrAvgKbps=histMetrAvgKbps, curMetrTotalMaxDelta=curMetrTotalMaxDelta, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, ictCfgUpdate=ictCfgUpdate, historyListEntry=historyListEntry, catvModuleSignalDetected=catvModuleSignalDetected, transceiverLaserWavelength=transceiverLaserWavelength, histMetrTotalLost=histMetrTotalLost, historyMetricsEntry=historyMetricsEntry, curMetrAvgDelta=curMetrAvgDelta, histMetrTotalSkips=histMetrTotalSkips, PYSNMP_MODULE_ID=icotera, curMetrPps=curMetrPps, ictCatv=ictCatv, histMetrMemberPorts=histMetrMemberPorts, performCpeReboot=performCpeReboot, curMetrLost=curMetrLost, histMetrGroupAddr=histMetrGroupAddr, catvModuleRflevel=catvModuleRflevel, ictMgmt=ictMgmt, histMetrLost=histMetrLost, curMetrGroupAddr=curMetrGroupAddr, ictIGW1k=ictIGW1k, histMetrKbps=histMetrKbps, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, histMetrStopTimestamp=histMetrStopTimestamp, ictFacRst=ictFacRst, histMetrJitter=histMetrJitter, transceiverLinkLength=transceiverLinkLength, histMetrTotalBytes=histMetrTotalBytes, catvModuleFilter=catvModuleFilter, curMetrAvgPps=curMetrAvgPps, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, curMetrKbps=curMetrKbps, transceiverDdmTxPower=transceiverDdmTxPower, histGroupIndex=histGroupIndex, curMetrStartTimestamp=curMetrStartTimestamp, ictFacRstMib=ictFacRstMib, histMetrSrcPort=histMetrSrcPort, curGroupIndex=curGroupIndex, histMetrReordered=histMetrReordered, curMetrStopTimestamp=curMetrStopTimestamp, curMetrAvgLostPps=curMetrAvgLostPps, curMetrTotalLost=curMetrTotalLost, histMetrPps=histMetrPps, upgExecute=upgExecute, histGroupAddr=histGroupAddr, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory)
