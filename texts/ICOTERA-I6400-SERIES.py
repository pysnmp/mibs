...
# Produced by pysmi-1.1.3 at Tue Dec  7 17:29:23 2021
...
Integer32, Bits, Counter64, ModuleIdentity, TimeTicks, NotificationType, MibIdentifier, iso, Unsigned32, IpAddress, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "Counter64", "ModuleIdentity", "TimeTicks", "NotificationType", "MibIdentifier", "iso", "Unsigned32", "IpAddress", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", curMetrTotalBytes=curMetrTotalBytes, transceiverEthernetCompliance=transceiverEthernetCompliance, histMetrAvgPps=histMetrAvgPps, curMetrMaxDelta=curMetrMaxDelta, transceiverDdmRxPower=transceiverDdmRxPower, ictMcastAnalyzer=ictMcastAnalyzer, historyListEntry=historyListEntry, curMetrSrcPort=curMetrSrcPort, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, upgStatus=upgStatus, curMetrKbps=curMetrKbps, ictReset=ictReset, histMetrMemberPorts=histMetrMemberPorts, histMetrTotalBytes=histMetrTotalBytes, curMetrAvgLostPps=curMetrAvgLostPps, ictIGW1k=ictIGW1k, histMetrTotalLost=histMetrTotalLost, IctTimeStamp=IctTimeStamp, ictFacRstMib=ictFacRstMib, histMetrTotalReordered=histMetrTotalReordered, histMetrAvgKbps=histMetrAvgKbps, ictServices=ictServices, curMetrAvgDelta=curMetrAvgDelta, curMetrLost=curMetrLost, histMetrGroupAddr=histMetrGroupAddr, ictFacRst=ictFacRst, transceiverLinkLength=transceiverLinkLength, curMetrTotalLost=curMetrTotalLost, histMetrSrcPort=histMetrSrcPort, histMetrTotalMaxDelta=histMetrTotalMaxDelta, catvModulePowerLevel=catvModulePowerLevel, histMetrJitter=histMetrJitter, histMetrReordered=histMetrReordered, transceiverTransceiverType=transceiverTransceiverType, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, histMetrTotalPackets=histMetrTotalPackets, curMetrAvgKbps=curMetrAvgKbps, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, curMetrAvgPps=curMetrAvgPps, histMetrTotalAvgDelta=histMetrTotalAvgDelta, IctPortList=IctPortList, histMetrTotalSkips=histMetrTotalSkips, performFactoryReset=performFactoryReset, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, upgUrl=upgUrl, catvModuleAdminStatus=catvModuleAdminStatus, histMetrSourceAddr=histMetrSourceAddr, curMetrTotalAvgDelta=curMetrTotalAvgDelta, currentListEntry=currentListEntry, IctDelta=IctDelta, ictReboot=ictReboot, transceiverDiagCapable=transceiverDiagCapable, histGroupAddr=histGroupAddr, histMetrSkips=histMetrSkips, histMetrPps=histMetrPps, curMetrDstPort=curMetrDstPort, curMetrStreamType=curMetrStreamType, curGroupIndex=curGroupIndex, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, ictMgmtMib=ictMgmtMib, ictCatv=ictCatv, curMetrSkips=curMetrSkips, histMetrDstPort=histMetrDstPort, histMetrMaxDelta=histMetrMaxDelta, histMetrStopTimestamp=histMetrStopTimestamp, currentMetricsEntry=currentMetricsEntry, histMetrLost=histMetrLost, catvModuleSignalDetected=catvModuleSignalDetected, IctJitter=IctJitter, transceiverDdmTemperature=transceiverDdmTemperature, cfgTftpPath=cfgTftpPath, transceiverDdmTxPower=transceiverDdmTxPower, curMetrTotalSkips=curMetrTotalSkips, cfgExecute=cfgExecute, histMetrKbps=histMetrKbps, ictCfgUpdate=ictCfgUpdate, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrTotalReordered=curMetrTotalReordered, curMetrMemberPorts=curMetrMemberPorts, transceiverLaserWavelength=transceiverLaserWavelength, cfgStatus=cfgStatus, histGroupIndex=histGroupIndex, curMetrStartTimestamp=curMetrStartTimestamp, curMetrReordered=curMetrReordered, transceiverDdmVoltage=transceiverDdmVoltage, curMetrSourceAddr=curMetrSourceAddr, histMetrAvgLostPps=histMetrAvgLostPps, performCpeReboot=performCpeReboot, curMetrPps=curMetrPps, PYSNMP_MODULE_ID=icotera, curMetrGroupAddr=curMetrGroupAddr, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, histMetrAvgDelta=histMetrAvgDelta, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, histMetrStartTimestamp=histMetrStartTimestamp, curMetrDiscontinuities=curMetrDiscontinuities, histMetrDiscontinuities=histMetrDiscontinuities, ictTransceiver=ictTransceiver, curMetrTotalMaxDelta=curMetrTotalMaxDelta, ictServicesMibs=ictServicesMibs, catvModuleLowSignal=catvModuleLowSignal, curMetrStopTimestamp=curMetrStopTimestamp, catvModuleFilter=catvModuleFilter, ictFwUpg=ictFwUpg, curGroupAddr=curGroupAddr, transceiverConnectorType=transceiverConnectorType, upgExecute=upgExecute, icotera=icotera, catvModuleRflevel=catvModuleRflevel, curMetrTotalPackets=curMetrTotalPackets, historyMetricsEntry=historyMetricsEntry, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, curMetrJitter=curMetrJitter, ictMgmt=ictMgmt, histMetrStreamType=histMetrStreamType)
