...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:08:21 2023
...
ObjectIdentity, Bits, MibIdentifier, IpAddress, Counter32, Gauge32, enterprises, TimeTicks, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "MibIdentifier", "IpAddress", "Counter32", "Gauge32", "enterprises", "TimeTicks", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", ictTransceiver=ictTransceiver, curMetrAvgPps=curMetrAvgPps, histMetrSkips=histMetrSkips, ictIGW1k=ictIGW1k, histMetrAvgKbps=histMetrAvgKbps, ictFacRst=ictFacRst, currentMetricsEntry=currentMetricsEntry, transceiverLinkLength=transceiverLinkLength, historyListEntry=historyListEntry, PYSNMP_MODULE_ID=icotera, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, histMetrTotalMaxDelta=histMetrTotalMaxDelta, ictMcastAnalyzer=ictMcastAnalyzer, curMetrSourceAddr=curMetrSourceAddr, curMetrTotalReordered=curMetrTotalReordered, histMetrKbps=histMetrKbps, ictMgmt=ictMgmt, ictServicesMibs=ictServicesMibs, histMetrTotalBytes=histMetrTotalBytes, histMetrAvgPps=histMetrAvgPps, curMetrAvgDelta=curMetrAvgDelta, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, curMetrLost=curMetrLost, curMetrDstPort=curMetrDstPort, histMetrTotalReordered=histMetrTotalReordered, historyMetricsEntry=historyMetricsEntry, ictMgmtMib=ictMgmtMib, curMetrAvgLostPps=curMetrAvgLostPps, cfgStatus=cfgStatus, histMetrStopTimestamp=histMetrStopTimestamp, histGroupAddr=histGroupAddr, curMetrMaxDelta=curMetrMaxDelta, histGroupIndex=histGroupIndex, curMetrTotalSkips=curMetrTotalSkips, histMetrTotalSkips=histMetrTotalSkips, upgUrl=upgUrl, ictFwUpg=ictFwUpg, transceiverDdmVoltage=transceiverDdmVoltage, histMetrAvgDelta=histMetrAvgDelta, transceiverEthernetCompliance=transceiverEthernetCompliance, histMetrReordered=histMetrReordered, curGroupIndex=curGroupIndex, curMetrStartTimestamp=curMetrStartTimestamp, ictFacRstMib=ictFacRstMib, curMetrTotalAvgDelta=curMetrTotalAvgDelta, curMetrReordered=curMetrReordered, transceiverDdmTxPower=transceiverDdmTxPower, curMetrSrcPort=curMetrSrcPort, curMetrSkips=curMetrSkips, transceiverDiagCapable=transceiverDiagCapable, IctDelta=IctDelta, transceiverDdmTemperature=transceiverDdmTemperature, curMetrTotalPackets=curMetrTotalPackets, histMetrSourceAddr=histMetrSourceAddr, catvModuleFilter=catvModuleFilter, catvModuleSignalDetected=catvModuleSignalDetected, curMetrJitter=curMetrJitter, histMetrGroupAddr=histMetrGroupAddr, histMetrStartTimestamp=histMetrStartTimestamp, ictServices=ictServices, curMetrGroupAddr=curMetrGroupAddr, curMetrTotalLost=curMetrTotalLost, catvModuleRflevel=catvModuleRflevel, curMetrStreamType=curMetrStreamType, ictReboot=ictReboot, IctPortList=IctPortList, histMetrJitter=histMetrJitter, ictReset=ictReset, performFactoryReset=performFactoryReset, curMetrPps=curMetrPps, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, performCpeReboot=performCpeReboot, curMetrKbps=curMetrKbps, transceiverTransceiverType=transceiverTransceiverType, ictCatv=ictCatv, histMetrPps=histMetrPps, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, histMetrDiscontinuities=histMetrDiscontinuities, curMetrAvgKbps=curMetrAvgKbps, icotera=icotera, histMetrTotalLost=histMetrTotalLost, histMetrTotalPackets=histMetrTotalPackets, curMetrTotalMaxDelta=curMetrTotalMaxDelta, cfgExecute=cfgExecute, histMetrAvgLostPps=histMetrAvgLostPps, curMetrTotalBytes=curMetrTotalBytes, IctJitter=IctJitter, curMetrStopTimestamp=curMetrStopTimestamp, transceiverDdmRxPower=transceiverDdmRxPower, curGroupAddr=curGroupAddr, catvModuleLowSignal=catvModuleLowSignal, upgExecute=upgExecute, catvModuleAdminStatus=catvModuleAdminStatus, histMetrMaxDelta=histMetrMaxDelta, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrDiscontinuities=curMetrDiscontinuities, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, cfgTftpPath=cfgTftpPath, histMetrDstPort=histMetrDstPort, histMetrSrcPort=histMetrSrcPort, transceiverConnectorType=transceiverConnectorType, histMetrTotalAvgDelta=histMetrTotalAvgDelta, currentListEntry=currentListEntry, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, histMetrLost=histMetrLost, IctTimeStamp=IctTimeStamp, histMetrMemberPorts=histMetrMemberPorts, transceiverLaserWavelength=transceiverLaserWavelength, ictCfgUpdate=ictCfgUpdate, catvModulePowerLevel=catvModulePowerLevel, upgStatus=upgStatus, histMetrStreamType=histMetrStreamType, curMetrMemberPorts=curMetrMemberPorts)
