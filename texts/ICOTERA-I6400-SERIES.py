...
MibIdentifier, TimeTicks, ObjectIdentity, Counter64, NotificationType, IpAddress, ModuleIdentity, Counter32, Gauge32, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "ObjectIdentity", "Counter64", "NotificationType", "IpAddress", "ModuleIdentity", "Counter32", "Gauge32", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", curMetrReordered=curMetrReordered, ictMgmtMib=ictMgmtMib, historyListEntry=historyListEntry, curMetrJitter=curMetrJitter, curMetrTotalPackets=curMetrTotalPackets, curMetrSourceAddr=curMetrSourceAddr, curMetrTotalSkips=curMetrTotalSkips, ictMcastAnalyzer=ictMcastAnalyzer, transceiverLinkLength=transceiverLinkLength, histMetrAvgLostPps=histMetrAvgLostPps, histMetrDstPort=histMetrDstPort, historyMetricsEntry=historyMetricsEntry, transceiverDdmRxPower=transceiverDdmRxPower, histMetrTotalReordered=histMetrTotalReordered, ictTransceiver=ictTransceiver, curMetrMaxDelta=curMetrMaxDelta, PYSNMP_MODULE_ID=icotera, curMetrAvgLostPps=curMetrAvgLostPps, transceiverEthernetCompliance=transceiverEthernetCompliance, IctDelta=IctDelta, histMetrTotalBytes=histMetrTotalBytes, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, curMetrStartTimestamp=curMetrStartTimestamp, ictServicesMibs=ictServicesMibs, IctPortList=IctPortList, curMetrSrcPort=curMetrSrcPort, histMetrStopTimestamp=histMetrStopTimestamp, ictReboot=ictReboot, upgStatus=upgStatus, transceiverDiagCapable=transceiverDiagCapable, histMetrTotalLost=histMetrTotalLost, curMetrStreamType=curMetrStreamType, histMetrReordered=histMetrReordered, curMetrTotalMaxDelta=curMetrTotalMaxDelta, curMetrLost=curMetrLost, histMetrLost=histMetrLost, upgUrl=upgUrl, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, IctJitter=IctJitter, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, curMetrSkips=curMetrSkips, currentListEntry=currentListEntry, catvModuleAdminStatus=catvModuleAdminStatus, catvModuleSignalDetected=catvModuleSignalDetected, curMetrTotalAvgDelta=curMetrTotalAvgDelta, transceiverDdmTemperature=transceiverDdmTemperature, IctTimeStamp=IctTimeStamp, histMetrKbps=histMetrKbps, histMetrStartTimestamp=histMetrStartTimestamp, histMetrJitter=histMetrJitter, catvModuleRflevel=catvModuleRflevel, cfgExecute=cfgExecute, ictFacRstMib=ictFacRstMib, curMetrDstPort=curMetrDstPort, curMetrDiscontinuities=curMetrDiscontinuities, histMetrMaxDelta=histMetrMaxDelta, curMetrTotalLost=curMetrTotalLost, transceiverDdmTxPower=transceiverDdmTxPower, transceiverConnectorType=transceiverConnectorType, histMetrSrcPort=histMetrSrcPort, catvModulePowerLevel=catvModulePowerLevel, curMetrAvgDelta=curMetrAvgDelta, catvModuleLowSignal=catvModuleLowSignal, curMetrPps=curMetrPps, ictReset=ictReset, currentMetricsEntry=currentMetricsEntry, icotera=icotera, histGroupAddr=histGroupAddr, histMetrMemberPorts=histMetrMemberPorts, ictServices=ictServices, ictCfgUpdate=ictCfgUpdate, curMetrAvgKbps=curMetrAvgKbps, curGroupAddr=curGroupAddr, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, curGroupIndex=curGroupIndex, performCpeReboot=performCpeReboot, histGroupIndex=histGroupIndex, ictCatv=ictCatv, transceiverTransceiverType=transceiverTransceiverType, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, histMetrPps=histMetrPps, ictMgmt=ictMgmt, histMetrGroupAddr=histMetrGroupAddr, curMetrKbps=curMetrKbps, curMetrStopTimestamp=curMetrStopTimestamp, transceiverLaserWavelength=transceiverLaserWavelength, histMetrTotalMaxDelta=histMetrTotalMaxDelta, catvModuleFilter=catvModuleFilter, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, cfgStatus=cfgStatus, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrGroupAddr=curMetrGroupAddr, histMetrAvgKbps=histMetrAvgKbps, histMetrDiscontinuities=histMetrDiscontinuities, transceiverDdmVoltage=transceiverDdmVoltage, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, upgExecute=upgExecute, cfgTftpPath=cfgTftpPath, curMetrTotalReordered=curMetrTotalReordered, ictFwUpg=ictFwUpg, performFactoryReset=performFactoryReset, ictFacRst=ictFacRst, histMetrAvgDelta=histMetrAvgDelta, curMetrMemberPorts=curMetrMemberPorts, ictIGW1k=ictIGW1k, histMetrTotalSkips=histMetrTotalSkips, histMetrSourceAddr=histMetrSourceAddr, curMetrAvgPps=curMetrAvgPps, histMetrAvgPps=histMetrAvgPps, histMetrStreamType=histMetrStreamType, curMetrTotalBytes=curMetrTotalBytes, histMetrTotalPackets=histMetrTotalPackets, histMetrTotalAvgDelta=histMetrTotalAvgDelta, histMetrSkips=histMetrSkips)
