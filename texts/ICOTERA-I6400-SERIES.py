...
Integer32, Counter64, iso, TimeTicks, Unsigned32, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, IpAddress, Counter32, MibIdentifier, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "iso", "TimeTicks", "Unsigned32", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "IpAddress", "Counter32", "MibIdentifier", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", transceiverDiagCapable=transceiverDiagCapable, cfgStatus=cfgStatus, IctPortList=IctPortList, histMetrAvgDelta=histMetrAvgDelta, transceiverLinkLength=transceiverLinkLength, ictCatv=ictCatv, histMetrTotalLost=histMetrTotalLost, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, currentMetricsEntry=currentMetricsEntry, catvModuleFilter=catvModuleFilter, performCpeReboot=performCpeReboot, curMetrStreamType=curMetrStreamType, catvModuleLowSignal=catvModuleLowSignal, ictMcastAnalyzer=ictMcastAnalyzer, transceiverDdmTemperature=transceiverDdmTemperature, histMetrMemberPorts=histMetrMemberPorts, histMetrStopTimestamp=histMetrStopTimestamp, ictMgmt=ictMgmt, upgStatus=upgStatus, transceiverDdmVoltage=transceiverDdmVoltage, IctTimeStamp=IctTimeStamp, curMetrGroupAddr=curMetrGroupAddr, curMetrReordered=curMetrReordered, curMetrPps=curMetrPps, histMetrMaxDelta=histMetrMaxDelta, ictTransceiver=ictTransceiver, histMetrKbps=histMetrKbps, curMetrAvgDelta=curMetrAvgDelta, curMetrTotalPackets=curMetrTotalPackets, curMetrMemberPorts=curMetrMemberPorts, histMetrReordered=histMetrReordered, histMetrTotalReordered=histMetrTotalReordered, PYSNMP_MODULE_ID=icotera, curGroupIndex=curGroupIndex, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, curMetrTotalReordered=curMetrTotalReordered, catvModuleRflevel=catvModuleRflevel, histMetrTotalBytes=histMetrTotalBytes, curMetrStartTimestamp=curMetrStartTimestamp, transceiverLaserWavelength=transceiverLaserWavelength, histMetrLost=histMetrLost, transceiverEthernetCompliance=transceiverEthernetCompliance, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, currentListEntry=currentListEntry, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, cfgTftpPath=cfgTftpPath, transceiverDdmRxPower=transceiverDdmRxPower, historyMetricsEntry=historyMetricsEntry, ictFacRst=ictFacRst, catvModuleAdminStatus=catvModuleAdminStatus, IctDelta=IctDelta, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, ictMgmtMib=ictMgmtMib, curMetrJitter=curMetrJitter, histMetrGroupAddr=histMetrGroupAddr, histMetrSrcPort=histMetrSrcPort, catvModulePowerLevel=catvModulePowerLevel, histMetrTotalSkips=histMetrTotalSkips, curMetrAvgKbps=curMetrAvgKbps, ictServices=ictServices, transceiverTransceiverType=transceiverTransceiverType, IctJitter=IctJitter, ictServicesMibs=ictServicesMibs, ictReboot=ictReboot, histMetrTotalAvgDelta=histMetrTotalAvgDelta, curMetrLost=curMetrLost, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, curGroupAddr=curGroupAddr, cfgExecute=cfgExecute, histMetrTotalMaxDelta=histMetrTotalMaxDelta, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrAvgPps=curMetrAvgPps, curMetrTotalBytes=curMetrTotalBytes, transceiverConnectorType=transceiverConnectorType, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, histMetrPps=histMetrPps, histMetrAvgLostPps=histMetrAvgLostPps, curMetrMaxDelta=curMetrMaxDelta, histMetrStreamType=histMetrStreamType, curMetrTotalAvgDelta=curMetrTotalAvgDelta, histGroupIndex=histGroupIndex, ictCfgUpdate=ictCfgUpdate, curMetrDiscontinuities=curMetrDiscontinuities, historyListEntry=historyListEntry, catvModuleSignalDetected=catvModuleSignalDetected, histMetrSkips=histMetrSkips, curMetrKbps=curMetrKbps, histMetrJitter=histMetrJitter, histMetrAvgKbps=histMetrAvgKbps, histMetrStartTimestamp=histMetrStartTimestamp, upgExecute=upgExecute, ictIGW1k=ictIGW1k, curMetrTotalMaxDelta=curMetrTotalMaxDelta, histMetrTotalPackets=histMetrTotalPackets, ictReset=ictReset, curMetrTotalLost=curMetrTotalLost, ictFwUpg=ictFwUpg, curMetrSkips=curMetrSkips, ictFacRstMib=ictFacRstMib, histMetrSourceAddr=histMetrSourceAddr, transceiverDdmTxPower=transceiverDdmTxPower, curMetrSrcPort=curMetrSrcPort, histMetrDiscontinuities=histMetrDiscontinuities, performFactoryReset=performFactoryReset, curMetrTotalSkips=curMetrTotalSkips, curMetrAvgLostPps=curMetrAvgLostPps, curMetrSourceAddr=curMetrSourceAddr, upgUrl=upgUrl, histGroupAddr=histGroupAddr, curMetrDstPort=curMetrDstPort, histMetrDstPort=histMetrDstPort, curMetrStopTimestamp=curMetrStopTimestamp, histMetrAvgPps=histMetrAvgPps, icotera=icotera)
