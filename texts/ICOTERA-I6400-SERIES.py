...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", catvModuleAdminStatus=catvModuleAdminStatus, curMetrTotalBytes=curMetrTotalBytes, curMetrTotalPackets=curMetrTotalPackets, ictMgmtMib=ictMgmtMib, curMetrLost=curMetrLost, historyListEntry=historyListEntry, curMetrStreamType=curMetrStreamType, historyMetricsEntry=historyMetricsEntry, cfgStatus=cfgStatus, curMetrReordered=curMetrReordered, histMetrSourceAddr=histMetrSourceAddr, histMetrStopTimestamp=histMetrStopTimestamp, ictServices=ictServices, curMetrMemberPorts=curMetrMemberPorts, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, ictMgmt=ictMgmt, transceiverTransceiverType=transceiverTransceiverType, IctJitter=IctJitter, histMetrJitter=histMetrJitter, ictReboot=ictReboot, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, histMetrTotalReordered=histMetrTotalReordered, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, ictIGW1k=ictIGW1k, curMetrPps=curMetrPps, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, histMetrTotalLost=histMetrTotalLost, ictFacRst=ictFacRst, curMetrAvgPps=curMetrAvgPps, curMetrStartTimestamp=curMetrStartTimestamp, histMetrDstPort=histMetrDstPort, performFactoryReset=performFactoryReset, curMetrDiscontinuities=curMetrDiscontinuities, histGroupIndex=histGroupIndex, upgExecute=upgExecute, IctPortList=IctPortList, histMetrAvgPps=histMetrAvgPps, currentListEntry=currentListEntry, histMetrReordered=histMetrReordered, histMetrStartTimestamp=histMetrStartTimestamp, transceiverLinkLength=transceiverLinkLength, curMetrStopTimestamp=curMetrStopTimestamp, currentMetricsEntry=currentMetricsEntry, histMetrAvgDelta=histMetrAvgDelta, curMetrJitter=curMetrJitter, upgStatus=upgStatus, ictFwUpg=ictFwUpg, histMetrSrcPort=histMetrSrcPort, curMetrSkips=curMetrSkips, histMetrStreamType=histMetrStreamType, transceiverDdmVoltage=transceiverDdmVoltage, curGroupIndex=curGroupIndex, ictFacRstMib=ictFacRstMib, curMetrGroupAddr=curMetrGroupAddr, histMetrTotalBytes=histMetrTotalBytes, transceiverDiagCapable=transceiverDiagCapable, icotera=icotera, curMetrMaxDelta=curMetrMaxDelta, curMetrTotalAvgDelta=curMetrTotalAvgDelta, transceiverEthernetCompliance=transceiverEthernetCompliance, performCpeReboot=performCpeReboot, histMetrTotalSkips=histMetrTotalSkips, curMetrAvgKbps=curMetrAvgKbps, ictCfgUpdate=ictCfgUpdate, transceiverDdmRxPower=transceiverDdmRxPower, ictTransceiver=ictTransceiver, catvModuleLowSignal=catvModuleLowSignal, curMetrTotalSkips=curMetrTotalSkips, curMetrSourceAddr=curMetrSourceAddr, catvModulePowerLevel=catvModulePowerLevel, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, curMetrSrcPort=curMetrSrcPort, catvModuleRflevel=catvModuleRflevel, histMetrPps=histMetrPps, ictReset=ictReset, ictCatv=ictCatv, PYSNMP_MODULE_ID=icotera, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, upgUrl=upgUrl, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, histMetrMemberPorts=histMetrMemberPorts, curMetrAvgDelta=curMetrAvgDelta, IctDelta=IctDelta, transceiverDdmTemperature=transceiverDdmTemperature, catvModuleFilter=catvModuleFilter, histMetrTotalPackets=histMetrTotalPackets, catvModuleSignalDetected=catvModuleSignalDetected, cfgExecute=cfgExecute, histMetrAvgLostPps=histMetrAvgLostPps, cfgTftpPath=cfgTftpPath, curMetrKbps=curMetrKbps, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, curMetrAvgLostPps=curMetrAvgLostPps, histMetrTotalAvgDelta=histMetrTotalAvgDelta, transceiverConnectorType=transceiverConnectorType, curMetrTotalLost=curMetrTotalLost, histMetrLost=histMetrLost, IctTimeStamp=IctTimeStamp, histMetrSkips=histMetrSkips, curMetrTotalMaxDelta=curMetrTotalMaxDelta, histMetrAvgKbps=histMetrAvgKbps, transceiverDdmTxPower=transceiverDdmTxPower, histGroupAddr=histGroupAddr, histMetrDiscontinuities=histMetrDiscontinuities, histMetrGroupAddr=histMetrGroupAddr, ictServicesMibs=ictServicesMibs, transceiverLaserWavelength=transceiverLaserWavelength, histMetrMaxDelta=histMetrMaxDelta, curGroupAddr=curGroupAddr, ictMcastAnalyzer=ictMcastAnalyzer, histMetrKbps=histMetrKbps, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, curMetrDstPort=curMetrDstPort, curMetrTotalReordered=curMetrTotalReordered, histMetrTotalMaxDelta=histMetrTotalMaxDelta)
