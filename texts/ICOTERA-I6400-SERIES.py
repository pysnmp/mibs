...
enterprises, Unsigned32, Counter32, IpAddress, MibIdentifier, iso, TimeTicks, ModuleIdentity, Integer32, NotificationType, Gauge32, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Unsigned32", "Counter32", "IpAddress", "MibIdentifier", "iso", "TimeTicks", "ModuleIdentity", "Integer32", "NotificationType", "Gauge32", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", histMetrSourceAddr=histMetrSourceAddr, curMetrSourceAddr=curMetrSourceAddr, transceiverLinkLength=transceiverLinkLength, histMetrGroupAddr=histMetrGroupAddr, ictReboot=ictReboot, curMetrAvgDelta=curMetrAvgDelta, curMetrSrcPort=curMetrSrcPort, histMetrStopTimestamp=histMetrStopTimestamp, curMetrDstPort=curMetrDstPort, upgStatus=upgStatus, histMetrMemberPorts=histMetrMemberPorts, histMetrTotalSkips=histMetrTotalSkips, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, curMetrTotalAvgDelta=curMetrTotalAvgDelta, curMetrTotalSkips=curMetrTotalSkips, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, curMetrStreamType=curMetrStreamType, curMetrTotalBytes=curMetrTotalBytes, transceiverDdmRxPower=transceiverDdmRxPower, transceiverTransceiverType=transceiverTransceiverType, curMetrTotalReordered=curMetrTotalReordered, histMetrPps=histMetrPps, ictCfgUpdate=ictCfgUpdate, currentMetricsEntry=currentMetricsEntry, histMetrSkips=histMetrSkips, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, histMetrAvgPps=histMetrAvgPps, ictMgmt=ictMgmt, curGroupIndex=curGroupIndex, curMetrMemberPorts=curMetrMemberPorts, ictFwUpg=ictFwUpg, PYSNMP_MODULE_ID=icotera, curMetrJitter=curMetrJitter, ictFacRst=ictFacRst, curMetrAvgKbps=curMetrAvgKbps, curMetrAvgLostPps=curMetrAvgLostPps, curMetrDiscontinuities=curMetrDiscontinuities, histMetrStreamType=histMetrStreamType, transceiverDdmTemperature=transceiverDdmTemperature, performFactoryReset=performFactoryReset, upgExecute=upgExecute, histMetrTotalAvgDelta=histMetrTotalAvgDelta, histMetrTotalMaxDelta=histMetrTotalMaxDelta, ictReset=ictReset, histMetrTotalPackets=histMetrTotalPackets, catvModulePowerLevel=catvModulePowerLevel, curMetrMaxDelta=curMetrMaxDelta, ictServices=ictServices, histMetrLost=histMetrLost, histMetrTotalReordered=histMetrTotalReordered, ictServicesMibs=ictServicesMibs, ictMcastAnalyzer=ictMcastAnalyzer, catvModuleSignalDetected=catvModuleSignalDetected, ictMgmtMib=ictMgmtMib, historyListEntry=historyListEntry, histGroupAddr=histGroupAddr, catvModuleLowSignal=catvModuleLowSignal, curMetrTotalPackets=curMetrTotalPackets, curMetrStopTimestamp=curMetrStopTimestamp, IctJitter=IctJitter, curMetrLost=curMetrLost, catvModuleFilter=catvModuleFilter, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, curMetrStartTimestamp=curMetrStartTimestamp, currentListEntry=currentListEntry, IctDelta=IctDelta, curMetrTotalLost=curMetrTotalLost, histGroupIndex=histGroupIndex, curMetrGroupAddr=curMetrGroupAddr, ictIGW1k=ictIGW1k, curMetrTotalMaxDelta=curMetrTotalMaxDelta, curGroupAddr=curGroupAddr, performCpeReboot=performCpeReboot, curMetrPps=curMetrPps, historyMetricsEntry=historyMetricsEntry, upgUrl=upgUrl, ictTransceiver=ictTransceiver, histMetrTotalLost=histMetrTotalLost, cfgTftpPath=cfgTftpPath, histMetrDstPort=histMetrDstPort, histMetrDiscontinuities=histMetrDiscontinuities, histMetrStartTimestamp=histMetrStartTimestamp, catvModuleRflevel=catvModuleRflevel, curMetrAvgPps=curMetrAvgPps, curMetrKbps=curMetrKbps, ictFacRstMib=ictFacRstMib, IctTimeStamp=IctTimeStamp, histMetrJitter=histMetrJitter, transceiverLaserWavelength=transceiverLaserWavelength, histMetrAvgDelta=histMetrAvgDelta, icotera=icotera, histMetrKbps=histMetrKbps, histMetrMaxDelta=histMetrMaxDelta, curMetrSkips=curMetrSkips, transceiverEthernetCompliance=transceiverEthernetCompliance, histMetrAvgKbps=histMetrAvgKbps, IctPortList=IctPortList, histMetrReordered=histMetrReordered, transceiverDiagCapable=transceiverDiagCapable, histMetrAvgLostPps=histMetrAvgLostPps, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, cfgExecute=cfgExecute, cfgStatus=cfgStatus, transceiverDdmVoltage=transceiverDdmVoltage, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrReordered=curMetrReordered, histMetrTotalBytes=histMetrTotalBytes, catvModuleAdminStatus=catvModuleAdminStatus, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, transceiverConnectorType=transceiverConnectorType, histMetrSrcPort=histMetrSrcPort, ictCatv=ictCatv, transceiverDdmTxPower=transceiverDdmTxPower, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities)
