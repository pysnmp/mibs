...
enterprises, Counter32, Integer32, ObjectIdentity, Counter64, ModuleIdentity, TimeTicks, MibIdentifier, IpAddress, NotificationType, iso, Unsigned32, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "Integer32", "ObjectIdentity", "Counter64", "ModuleIdentity", "TimeTicks", "MibIdentifier", "IpAddress", "NotificationType", "iso", "Unsigned32", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", curGroupIndex=curGroupIndex, ictServicesMibs=ictServicesMibs, histMetrTotalReordered=histMetrTotalReordered, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, histMetrStopTimestamp=histMetrStopTimestamp, performFactoryReset=performFactoryReset, curGroupAddr=curGroupAddr, ictFacRst=ictFacRst, transceiverEthernetCompliance=transceiverEthernetCompliance, currentMetricsEntry=currentMetricsEntry, PYSNMP_MODULE_ID=icotera, ictCatv=ictCatv, histMetrDiscontinuities=histMetrDiscontinuities, histMetrAvgKbps=histMetrAvgKbps, curMetrPps=curMetrPps, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, catvModuleFilter=catvModuleFilter, ictMcastAnalyzer=ictMcastAnalyzer, transceiverLaserWavelength=transceiverLaserWavelength, curMetrAvgDelta=curMetrAvgDelta, histMetrDstPort=histMetrDstPort, curMetrTotalPackets=curMetrTotalPackets, ictServices=ictServices, upgUrl=upgUrl, histMetrTotalAvgDelta=histMetrTotalAvgDelta, cfgExecute=cfgExecute, curMetrTotalReordered=curMetrTotalReordered, catvModuleAdminStatus=catvModuleAdminStatus, catvModuleSignalDetected=catvModuleSignalDetected, catvModuleRflevel=catvModuleRflevel, curMetrAvgKbps=curMetrAvgKbps, histMetrStreamType=histMetrStreamType, curMetrMemberPorts=curMetrMemberPorts, upgExecute=upgExecute, curMetrJitter=curMetrJitter, upgStatus=upgStatus, histGroupAddr=histGroupAddr, histMetrMaxDelta=histMetrMaxDelta, transceiverDdmTxPower=transceiverDdmTxPower, histMetrAvgPps=histMetrAvgPps, IctPortList=IctPortList, transceiverDdmTemperature=transceiverDdmTemperature, curMetrDiscontinuities=curMetrDiscontinuities, histMetrTotalMaxDelta=histMetrTotalMaxDelta, curMetrGroupAddr=curMetrGroupAddr, ictReboot=ictReboot, transceiverDiagCapable=transceiverDiagCapable, histMetrKbps=histMetrKbps, histMetrLost=histMetrLost, curMetrMaxDelta=curMetrMaxDelta, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, histMetrGroupAddr=histMetrGroupAddr, curMetrStopTimestamp=curMetrStopTimestamp, histMetrTotalPackets=histMetrTotalPackets, histMetrStartTimestamp=histMetrStartTimestamp, transceiverLinkLength=transceiverLinkLength, histMetrSourceAddr=histMetrSourceAddr, catvModuleLowSignal=catvModuleLowSignal, ictMgmtMib=ictMgmtMib, performCpeReboot=performCpeReboot, histMetrAvgLostPps=histMetrAvgLostPps, curMetrReordered=curMetrReordered, curMetrTotalSkips=curMetrTotalSkips, histGroupIndex=histGroupIndex, curMetrSkips=curMetrSkips, curMetrLost=curMetrLost, transceiverDdmVoltage=transceiverDdmVoltage, historyMetricsEntry=historyMetricsEntry, histMetrTotalSkips=histMetrTotalSkips, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, cfgStatus=cfgStatus, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, transceiverConnectorType=transceiverConnectorType, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, histMetrReordered=histMetrReordered, ictFwUpg=ictFwUpg, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, IctDelta=IctDelta, curMetrSrcPort=curMetrSrcPort, ictCfgUpdate=ictCfgUpdate, histMetrTotalLost=histMetrTotalLost, transceiverTransceiverType=transceiverTransceiverType, currentListEntry=currentListEntry, histMetrSkips=histMetrSkips, curMetrAvgLostPps=curMetrAvgLostPps, curMetrStreamType=curMetrStreamType, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, histMetrPps=histMetrPps, transceiverDdmRxPower=transceiverDdmRxPower, ictFacRstMib=ictFacRstMib, histMetrTotalBytes=histMetrTotalBytes, histMetrAvgDelta=histMetrAvgDelta, IctJitter=IctJitter, ictReset=ictReset, curMetrAvgPps=curMetrAvgPps, curMetrSourceAddr=curMetrSourceAddr, curMetrTotalLost=curMetrTotalLost, ictTransceiver=ictTransceiver, cfgTftpPath=cfgTftpPath, historyListEntry=historyListEntry, curMetrTotalAvgDelta=curMetrTotalAvgDelta, histMetrJitter=histMetrJitter, curMetrTotalBytes=curMetrTotalBytes, ictMgmt=ictMgmt, histMetrMemberPorts=histMetrMemberPorts, curMetrKbps=curMetrKbps, curMetrStartTimestamp=curMetrStartTimestamp, IctTimeStamp=IctTimeStamp, icotera=icotera, curMetrDstPort=curMetrDstPort, ictIGW1k=ictIGW1k, histMetrSrcPort=histMetrSrcPort, catvModulePowerLevel=catvModulePowerLevel, curMetrTotalMaxDelta=curMetrTotalMaxDelta)
