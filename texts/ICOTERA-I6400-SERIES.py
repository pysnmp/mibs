...
TimeTicks, Unsigned32, ModuleIdentity, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, MibIdentifier, IpAddress, Counter32, iso, enterprises, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "ModuleIdentity", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "MibIdentifier", "IpAddress", "Counter32", "iso", "enterprises", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", curMetrMaxDelta=curMetrMaxDelta, historyListEntry=historyListEntry, histGroupAddr=histGroupAddr, ictMcastAnalyzer=ictMcastAnalyzer, histMetrTotalLost=histMetrTotalLost, transceiverLaserWavelength=transceiverLaserWavelength, transceiverEthernetCompliance=transceiverEthernetCompliance, curMetrTotalAvgDelta=curMetrTotalAvgDelta, histMetrSkips=histMetrSkips, transceiverDiagCapable=transceiverDiagCapable, histMetrSourceAddr=histMetrSourceAddr, curMetrReordered=curMetrReordered, ictServices=ictServices, performCpeReboot=performCpeReboot, curMetrAvgDelta=curMetrAvgDelta, ictMgmtMib=ictMgmtMib, catvModuleRflevel=catvModuleRflevel, histMetrMaxDelta=histMetrMaxDelta, curMetrKbps=curMetrKbps, catvModuleAdminStatus=catvModuleAdminStatus, histMetrStreamType=histMetrStreamType, ictReset=ictReset, histMetrAvgDelta=histMetrAvgDelta, histMetrMemberPorts=histMetrMemberPorts, transceiverDdmTxPower=transceiverDdmTxPower, ictIGW1k=ictIGW1k, upgStatus=upgStatus, curMetrTotalReordered=curMetrTotalReordered, histMetrTotalMaxDelta=histMetrTotalMaxDelta, icotera=icotera, performFactoryReset=performFactoryReset, currentListEntry=currentListEntry, catvModuleFilter=catvModuleFilter, IctPortList=IctPortList, curMetrLost=curMetrLost, catvModuleLowSignal=catvModuleLowSignal, histMetrAvgPps=histMetrAvgPps, histMetrStopTimestamp=histMetrStopTimestamp, histMetrTotalBytes=histMetrTotalBytes, transceiverConnectorType=transceiverConnectorType, histMetrSrcPort=histMetrSrcPort, histMetrLost=histMetrLost, histGroupIndex=histGroupIndex, curMetrAvgLostPps=curMetrAvgLostPps, curMetrJitter=curMetrJitter, histMetrTotalSkips=histMetrTotalSkips, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, ictFwUpg=ictFwUpg, transceiverDdmTemperature=transceiverDdmTemperature, curMetrDstPort=curMetrDstPort, ictCatv=ictCatv, histMetrKbps=histMetrKbps, curMetrTotalSkips=curMetrTotalSkips, ictServicesMibs=ictServicesMibs, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, PYSNMP_MODULE_ID=icotera, curMetrTotalLost=curMetrTotalLost, histMetrTotalReordered=histMetrTotalReordered, ictTransceiver=ictTransceiver, cfgTftpPath=cfgTftpPath, curMetrStreamType=curMetrStreamType, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, histMetrPps=histMetrPps, curMetrPps=curMetrPps, curMetrMemberPorts=curMetrMemberPorts, ictMgmt=ictMgmt, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrStartTimestamp=curMetrStartTimestamp, transceiverLinkLength=transceiverLinkLength, ictFacRstMib=ictFacRstMib, curMetrStopTimestamp=curMetrStopTimestamp, curMetrTotalPackets=curMetrTotalPackets, cfgExecute=cfgExecute, upgUrl=upgUrl, curGroupIndex=curGroupIndex, histMetrAvgLostPps=histMetrAvgLostPps, curMetrSourceAddr=curMetrSourceAddr, histMetrDiscontinuities=histMetrDiscontinuities, histMetrTotalPackets=histMetrTotalPackets, curMetrAvgKbps=curMetrAvgKbps, IctJitter=IctJitter, curMetrTotalBytes=curMetrTotalBytes, histMetrDstPort=histMetrDstPort, transceiverDdmRxPower=transceiverDdmRxPower, curMetrTotalMaxDelta=curMetrTotalMaxDelta, histMetrGroupAddr=histMetrGroupAddr, histMetrTotalAvgDelta=histMetrTotalAvgDelta, histMetrStartTimestamp=histMetrStartTimestamp, histMetrReordered=histMetrReordered, transceiverDdmVoltage=transceiverDdmVoltage, curMetrGroupAddr=curMetrGroupAddr, ictCfgUpdate=ictCfgUpdate, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, curMetrSkips=curMetrSkips, ictReboot=ictReboot, ictFacRst=ictFacRst, histMetrAvgKbps=histMetrAvgKbps, IctDelta=IctDelta, currentMetricsEntry=currentMetricsEntry, histMetrJitter=histMetrJitter, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, catvModuleSignalDetected=catvModuleSignalDetected, curMetrDiscontinuities=curMetrDiscontinuities, IctTimeStamp=IctTimeStamp, curGroupAddr=curGroupAddr, historyMetricsEntry=historyMetricsEntry, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, transceiverTransceiverType=transceiverTransceiverType, catvModulePowerLevel=catvModulePowerLevel, curMetrAvgPps=curMetrAvgPps, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, cfgStatus=cfgStatus, upgExecute=upgExecute, curMetrSrcPort=curMetrSrcPort)
