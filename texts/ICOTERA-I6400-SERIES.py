...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", ictCfgUpdate=ictCfgUpdate, histMetrSourceAddr=histMetrSourceAddr, ictCatv=ictCatv, curMetrDiscontinuities=curMetrDiscontinuities, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, IctPortList=IctPortList, histMetrReordered=histMetrReordered, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, curMetrStartTimestamp=curMetrStartTimestamp, IctDelta=IctDelta, histMetrTotalSkips=histMetrTotalSkips, curMetrReordered=curMetrReordered, ictServicesMibs=ictServicesMibs, performFactoryReset=performFactoryReset, transceiverDdmRxPower=transceiverDdmRxPower, catvModuleLowSignal=catvModuleLowSignal, catvModuleRflevel=catvModuleRflevel, curMetrDstPort=curMetrDstPort, catvModulePowerLevel=catvModulePowerLevel, ictReboot=ictReboot, currentListEntry=currentListEntry, curMetrMemberPorts=curMetrMemberPorts, curMetrTotalSkips=curMetrTotalSkips, ictFwUpg=ictFwUpg, ictMcastAnalyzer=ictMcastAnalyzer, histMetrStopTimestamp=histMetrStopTimestamp, performCpeReboot=performCpeReboot, histMetrMaxDelta=histMetrMaxDelta, curMetrJitter=curMetrJitter, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, histMetrGroupAddr=histMetrGroupAddr, histMetrTotalMaxDelta=histMetrTotalMaxDelta, histMetrSkips=histMetrSkips, upgUrl=upgUrl, upgExecute=upgExecute, curMetrKbps=curMetrKbps, ictTransceiver=ictTransceiver, curMetrGroupAddr=curMetrGroupAddr, catvModuleFilter=catvModuleFilter, curMetrAvgKbps=curMetrAvgKbps, curMetrAvgDelta=curMetrAvgDelta, histMetrTotalPackets=histMetrTotalPackets, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, curMetrSourceAddr=curMetrSourceAddr, PYSNMP_MODULE_ID=icotera, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, ictServices=ictServices, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, histMetrTotalLost=histMetrTotalLost, cfgStatus=cfgStatus, histMetrJitter=histMetrJitter, ictFacRstMib=ictFacRstMib, curMetrTotalLost=curMetrTotalLost, transceiverDdmTxPower=transceiverDdmTxPower, curMetrTotalAvgDelta=curMetrTotalAvgDelta, curMetrSkips=curMetrSkips, histMetrAvgPps=histMetrAvgPps, curMetrLost=curMetrLost, catvModuleAdminStatus=catvModuleAdminStatus, ictIGW1k=ictIGW1k, curMetrMaxDelta=curMetrMaxDelta, ictMgmtMib=ictMgmtMib, historyMetricsEntry=historyMetricsEntry, curGroupAddr=curGroupAddr, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrTotalBytes=curMetrTotalBytes, transceiverEthernetCompliance=transceiverEthernetCompliance, cfgTftpPath=cfgTftpPath, cfgExecute=cfgExecute, transceiverDdmVoltage=transceiverDdmVoltage, historyListEntry=historyListEntry, histMetrAvgKbps=histMetrAvgKbps, curMetrTotalReordered=curMetrTotalReordered, upgStatus=upgStatus, transceiverTransceiverType=transceiverTransceiverType, transceiverConnectorType=transceiverConnectorType, curMetrStreamType=curMetrStreamType, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, histMetrDstPort=histMetrDstPort, histMetrStartTimestamp=histMetrStartTimestamp, histMetrSrcPort=histMetrSrcPort, histMetrAvgDelta=histMetrAvgDelta, curMetrPps=curMetrPps, histGroupAddr=histGroupAddr, IctTimeStamp=IctTimeStamp, histMetrPps=histMetrPps, curMetrStopTimestamp=curMetrStopTimestamp, icotera=icotera, ictMgmt=ictMgmt, histMetrKbps=histMetrKbps, curMetrTotalMaxDelta=curMetrTotalMaxDelta, histMetrStreamType=histMetrStreamType, histMetrAvgLostPps=histMetrAvgLostPps, histMetrTotalAvgDelta=histMetrTotalAvgDelta, histMetrDiscontinuities=histMetrDiscontinuities, catvModuleSignalDetected=catvModuleSignalDetected, transceiverDdmTemperature=transceiverDdmTemperature, ictFacRst=ictFacRst, curMetrSrcPort=curMetrSrcPort, histMetrLost=histMetrLost, histMetrTotalBytes=histMetrTotalBytes, currentMetricsEntry=currentMetricsEntry, transceiverDiagCapable=transceiverDiagCapable, histMetrMemberPorts=histMetrMemberPorts, transceiverLinkLength=transceiverLinkLength, histGroupIndex=histGroupIndex, curGroupIndex=curGroupIndex, transceiverLaserWavelength=transceiverLaserWavelength, histMetrTotalReordered=histMetrTotalReordered, ictReset=ictReset, curMetrTotalPackets=curMetrTotalPackets, curMetrAvgLostPps=curMetrAvgLostPps, IctJitter=IctJitter, curMetrAvgPps=curMetrAvgPps)
