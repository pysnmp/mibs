...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:14:35 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Unsigned32, enterprises, ModuleIdentity, Gauge32, Counter32, NotificationType, Counter64, MibIdentifier, iso, TimeTicks, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Unsigned32", "enterprises", "ModuleIdentity", "Gauge32", "Counter32", "NotificationType", "Counter64", "MibIdentifier", "iso", "TimeTicks", "Integer32", "Bits")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", catvModulePowerLevel=catvModulePowerLevel, transceiverDiagCapable=transceiverDiagCapable, curMetrStopTimestamp=curMetrStopTimestamp, transceiverDdmRxPower=transceiverDdmRxPower, histMetrSrcPort=histMetrSrcPort, curMetrSrcPort=curMetrSrcPort, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, ictMgmt=ictMgmt, transceiverDdmTxPower=transceiverDdmTxPower, histMetrTotalSkips=histMetrTotalSkips, curMetrStartTimestamp=curMetrStartTimestamp, transceiverEthernetCompliance=transceiverEthernetCompliance, curMetrPps=curMetrPps, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, upgExecute=upgExecute, ictMgmtMib=ictMgmtMib, currentMetricsEntry=currentMetricsEntry, ictTransceiver=ictTransceiver, histMetrStreamType=histMetrStreamType, histGroupAddr=histGroupAddr, curMetrSourceAddr=curMetrSourceAddr, histMetrTotalBytes=histMetrTotalBytes, histMetrMaxDelta=histMetrMaxDelta, curMetrTotalSkips=curMetrTotalSkips, curMetrJitter=curMetrJitter, histMetrStartTimestamp=histMetrStartTimestamp, ictReset=ictReset, curMetrReordered=curMetrReordered, ictServices=ictServices, catvModuleRflevel=catvModuleRflevel, currentListEntry=currentListEntry, curMetrStreamType=curMetrStreamType, catvModuleAdminStatus=catvModuleAdminStatus, ictFacRstMib=ictFacRstMib, performFactoryReset=performFactoryReset, ictMcastAnalyzer=ictMcastAnalyzer, histMetrTotalLost=histMetrTotalLost, transceiverLinkLength=transceiverLinkLength, cfgExecute=cfgExecute, histMetrLost=histMetrLost, IctDelta=IctDelta, histMetrTotalAvgDelta=histMetrTotalAvgDelta, histMetrPps=histMetrPps, histMetrAvgDelta=histMetrAvgDelta, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, transceiverLaserWavelength=transceiverLaserWavelength, histMetrSkips=histMetrSkips, curMetrAvgPps=curMetrAvgPps, transceiverConnectorType=transceiverConnectorType, ictFwUpg=ictFwUpg, histMetrTotalReordered=histMetrTotalReordered, curMetrKbps=curMetrKbps, histMetrAvgPps=histMetrAvgPps, curMetrTotalMaxDelta=curMetrTotalMaxDelta, histMetrTotalMaxDelta=histMetrTotalMaxDelta, histMetrStopTimestamp=histMetrStopTimestamp, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, curMetrGroupAddr=curMetrGroupAddr, curMetrDstPort=curMetrDstPort, ictIGW1k=ictIGW1k, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, histMetrKbps=histMetrKbps, curMetrAvgDelta=curMetrAvgDelta, transceiverTransceiverType=transceiverTransceiverType, ictReboot=ictReboot, PYSNMP_MODULE_ID=icotera, curGroupIndex=curGroupIndex, histMetrTotalPackets=histMetrTotalPackets, histMetrAvgLostPps=histMetrAvgLostPps, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, upgUrl=upgUrl, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, histMetrSourceAddr=histMetrSourceAddr, curGroupAddr=curGroupAddr, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrMemberPorts=curMetrMemberPorts, catvModuleLowSignal=catvModuleLowSignal, icotera=icotera, ictCfgUpdate=ictCfgUpdate, cfgTftpPath=cfgTftpPath, curMetrTotalLost=curMetrTotalLost, histMetrDiscontinuities=histMetrDiscontinuities, ictServicesMibs=ictServicesMibs, histMetrDstPort=histMetrDstPort, transceiverDdmTemperature=transceiverDdmTemperature, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, histGroupIndex=histGroupIndex, curMetrTotalAvgDelta=curMetrTotalAvgDelta, historyMetricsEntry=historyMetricsEntry, histMetrAvgKbps=histMetrAvgKbps, ictCatv=ictCatv, performCpeReboot=performCpeReboot, upgStatus=upgStatus, transceiverDdmVoltage=transceiverDdmVoltage, IctPortList=IctPortList, cfgStatus=cfgStatus, curMetrLost=curMetrLost, curMetrTotalPackets=curMetrTotalPackets, catvModuleSignalDetected=catvModuleSignalDetected, curMetrSkips=curMetrSkips, histMetrMemberPorts=histMetrMemberPorts, curMetrAvgLostPps=curMetrAvgLostPps, curMetrTotalReordered=curMetrTotalReordered, curMetrAvgKbps=curMetrAvgKbps, catvModuleFilter=catvModuleFilter, curMetrDiscontinuities=curMetrDiscontinuities, histMetrReordered=histMetrReordered, historyListEntry=historyListEntry, ictFacRst=ictFacRst, histMetrGroupAddr=histMetrGroupAddr, histMetrJitter=histMetrJitter, IctTimeStamp=IctTimeStamp, curMetrMaxDelta=curMetrMaxDelta, IctJitter=IctJitter, curMetrTotalBytes=curMetrTotalBytes)
