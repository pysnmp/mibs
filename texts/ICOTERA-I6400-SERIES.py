...
# Produced by pysmi-1.1.8 at Mon Jan 17 21:44:58 2022
...
Unsigned32, NotificationType, Counter64, enterprises, ModuleIdentity, TimeTicks, ObjectIdentity, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Gauge32, Integer32, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "Counter64", "enterprises", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Gauge32", "Integer32", "iso", "Counter32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", histMetrTotalReordered=histMetrTotalReordered, histMetrTotalPackets=histMetrTotalPackets, curMetrSourceAddr=curMetrSourceAddr, ictReset=ictReset, transceiverDdmTxPower=transceiverDdmTxPower, IctTimeStamp=IctTimeStamp, ictServices=ictServices, performCpeReboot=performCpeReboot, curMetrPps=curMetrPps, curMetrTotalMaxDelta=curMetrTotalMaxDelta, catvModulePowerLevel=catvModulePowerLevel, curMetrReordered=curMetrReordered, transceiverConnectorType=transceiverConnectorType, histMetrSkips=histMetrSkips, cfgStatus=cfgStatus, histMetrStreamType=histMetrStreamType, curMetrTotalLost=curMetrTotalLost, curMetrTotalBytes=curMetrTotalBytes, catvModuleLowSignal=catvModuleLowSignal, performFactoryReset=performFactoryReset, curMetrTotalSkips=curMetrTotalSkips, histMetrDstPort=histMetrDstPort, IctPortList=IctPortList, histMetrReordered=histMetrReordered, curMetrStopTimestamp=curMetrStopTimestamp, curMetrJitter=curMetrJitter, ictMgmtMib=ictMgmtMib, curGroupIndex=curGroupIndex, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, cfgExecute=cfgExecute, IctJitter=IctJitter, curMetrTotalReordered=curMetrTotalReordered, curMetrStartTimestamp=curMetrStartTimestamp, cfgTftpPath=cfgTftpPath, histMetrAvgKbps=histMetrAvgKbps, catvModuleSignalDetected=catvModuleSignalDetected, curMetrMaxDelta=curMetrMaxDelta, curMetrSkips=curMetrSkips, histMetrAvgDelta=histMetrAvgDelta, upgUrl=upgUrl, histMetrStartTimestamp=histMetrStartTimestamp, currentMetricsEntry=currentMetricsEntry, ictIGW1k=ictIGW1k, upgExecute=upgExecute, catvModuleAdminStatus=catvModuleAdminStatus, IctDelta=IctDelta, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, catvModuleRflevel=catvModuleRflevel, ictFacRstMib=ictFacRstMib, historyMetricsEntry=historyMetricsEntry, histMetrTotalBytes=histMetrTotalBytes, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, PYSNMP_MODULE_ID=icotera, ictMgmt=ictMgmt, currentListEntry=currentListEntry, curMetrAvgDelta=curMetrAvgDelta, historyListEntry=historyListEntry, histMetrTotalSkips=histMetrTotalSkips, curMetrTotalAvgDelta=curMetrTotalAvgDelta, transceiverLinkLength=transceiverLinkLength, curMetrAvgKbps=curMetrAvgKbps, histMetrKbps=histMetrKbps, histMetrMemberPorts=histMetrMemberPorts, ictServicesMibs=ictServicesMibs, histMetrMaxDelta=histMetrMaxDelta, transceiverDdmTemperature=transceiverDdmTemperature, upgStatus=upgStatus, histMetrTotalLost=histMetrTotalLost, ictTransceiver=ictTransceiver, curMetrTotalPackets=curMetrTotalPackets, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, curGroupAddr=curGroupAddr, ictFwUpg=ictFwUpg, ictMcastAnalyzer=ictMcastAnalyzer, histMetrAvgPps=histMetrAvgPps, ictReboot=ictReboot, transceiverDdmRxPower=transceiverDdmRxPower, histMetrStopTimestamp=histMetrStopTimestamp, histMetrGroupAddr=histMetrGroupAddr, histMetrJitter=histMetrJitter, transceiverDdmVoltage=transceiverDdmVoltage, histMetrAvgLostPps=histMetrAvgLostPps, curMetrGroupAddr=curMetrGroupAddr, histMetrLost=histMetrLost, curMetrDiscontinuities=curMetrDiscontinuities, curMetrSrcPort=curMetrSrcPort, curMetrStreamType=curMetrStreamType, histMetrDiscontinuities=histMetrDiscontinuities, transceiverTransceiverType=transceiverTransceiverType, histMetrSrcPort=histMetrSrcPort, transceiverEthernetCompliance=transceiverEthernetCompliance, curMetrAvgLostPps=curMetrAvgLostPps, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, transceiverLaserWavelength=transceiverLaserWavelength, histMetrTotalMaxDelta=histMetrTotalMaxDelta, histMetrPps=histMetrPps, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, ictCatv=ictCatv, curMetrAvgPps=curMetrAvgPps, curMetrKbps=curMetrKbps, histMetrSourceAddr=histMetrSourceAddr, ictCfgUpdate=ictCfgUpdate, histGroupAddr=histGroupAddr, histMetrTotalAvgDelta=histMetrTotalAvgDelta, curMetrDstPort=curMetrDstPort, curMetrMemberPorts=curMetrMemberPorts, transceiverDiagCapable=transceiverDiagCapable, histGroupIndex=histGroupIndex, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, icotera=icotera, catvModuleFilter=catvModuleFilter, curMetrLost=curMetrLost, ictFacRst=ictFacRst, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent)
