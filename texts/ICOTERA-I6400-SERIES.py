...
# Produced by pysmi-1.1.8 at Mon Jan  2 13:54:34 2023
...
MibIdentifier, Gauge32, Unsigned32, ModuleIdentity, ObjectIdentity, NotificationType, Counter64, Integer32, iso, TimeTicks, IpAddress, Bits, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Gauge32", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Counter64", "Integer32", "iso", "TimeTicks", "IpAddress", "Bits", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", curMetrSourceAddr=curMetrSourceAddr, curMetrSrcPort=curMetrSrcPort, curMetrAvgKbps=curMetrAvgKbps, histMetrReordered=histMetrReordered, IctTimeStamp=IctTimeStamp, histMetrJitter=histMetrJitter, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, histMetrMaxDelta=histMetrMaxDelta, transceiverDdmVoltage=transceiverDdmVoltage, ictIGW1k=ictIGW1k, currentListEntry=currentListEntry, ictServices=ictServices, curMetrDstPort=curMetrDstPort, transceiverConnectorType=transceiverConnectorType, transceiverTransceiverType=transceiverTransceiverType, histGroupAddr=histGroupAddr, ictMgmt=ictMgmt, curGroupAddr=curGroupAddr, transceiverLaserWavelength=transceiverLaserWavelength, histMetrKbps=histMetrKbps, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, IctJitter=IctJitter, curMetrMemberPorts=curMetrMemberPorts, historyListEntry=historyListEntry, histMetrSourceAddr=histMetrSourceAddr, icotera=icotera, histMetrTotalAvgDelta=histMetrTotalAvgDelta, histMetrTotalSkips=histMetrTotalSkips, ictFacRstMib=ictFacRstMib, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, curMetrTotalSkips=curMetrTotalSkips, curMetrJitter=curMetrJitter, PYSNMP_MODULE_ID=icotera, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, curGroupIndex=curGroupIndex, ictTransceiver=ictTransceiver, curMetrLost=curMetrLost, upgStatus=upgStatus, cfgTftpPath=cfgTftpPath, curMetrStartTimestamp=curMetrStartTimestamp, histMetrLost=histMetrLost, histMetrGroupAddr=histMetrGroupAddr, curMetrTotalReordered=curMetrTotalReordered, transceiverDdmRxPower=transceiverDdmRxPower, curMetrReordered=curMetrReordered, histMetrAvgPps=histMetrAvgPps, historyMetricsEntry=historyMetricsEntry, histMetrStopTimestamp=histMetrStopTimestamp, IctPortList=IctPortList, IctDelta=IctDelta, curMetrTotalLost=curMetrTotalLost, ictCatv=ictCatv, histMetrTotalPackets=histMetrTotalPackets, performCpeReboot=performCpeReboot, histMetrDiscontinuities=histMetrDiscontinuities, histMetrStreamType=histMetrStreamType, ictReset=ictReset, histMetrSrcPort=histMetrSrcPort, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, histMetrTotalMaxDelta=histMetrTotalMaxDelta, ictServicesMibs=ictServicesMibs, transceiverDdmTemperature=transceiverDdmTemperature, ictCfgUpdate=ictCfgUpdate, histMetrAvgDelta=histMetrAvgDelta, histMetrMemberPorts=histMetrMemberPorts, curMetrPps=curMetrPps, ictFwUpg=ictFwUpg, ictFacRst=ictFacRst, curMetrTotalMaxDelta=curMetrTotalMaxDelta, histMetrTotalBytes=histMetrTotalBytes, upgUrl=upgUrl, catvModuleLowSignal=catvModuleLowSignal, histGroupIndex=histGroupIndex, curMetrTotalBytes=curMetrTotalBytes, histMetrAvgKbps=histMetrAvgKbps, catvModuleRflevel=catvModuleRflevel, curMetrSkips=curMetrSkips, currentMetricsEntry=currentMetricsEntry, curMetrDiscontinuities=curMetrDiscontinuities, catvModuleFilter=catvModuleFilter, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, catvModuleAdminStatus=catvModuleAdminStatus, cfgExecute=cfgExecute, curMetrGroupAddr=curMetrGroupAddr, ictMcastAnalyzer=ictMcastAnalyzer, cfgStatus=cfgStatus, histMetrTotalReordered=histMetrTotalReordered, catvModulePowerLevel=catvModulePowerLevel, ictReboot=ictReboot, curMetrAvgDelta=curMetrAvgDelta, histMetrStartTimestamp=histMetrStartTimestamp, transceiverEthernetCompliance=transceiverEthernetCompliance, histMetrDstPort=histMetrDstPort, curMetrTotalPackets=curMetrTotalPackets, curMetrAvgPps=curMetrAvgPps, curMetrKbps=curMetrKbps, curMetrStreamType=curMetrStreamType, transceiverLinkLength=transceiverLinkLength, ictMgmtMib=ictMgmtMib, curMetrTotalAvgDelta=curMetrTotalAvgDelta, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, catvModuleSignalDetected=catvModuleSignalDetected, histMetrTotalLost=histMetrTotalLost, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, performFactoryReset=performFactoryReset, curMetrMaxDelta=curMetrMaxDelta, transceiverDiagCapable=transceiverDiagCapable, transceiverDdmTxPower=transceiverDdmTxPower, curMetrAvgLostPps=curMetrAvgLostPps, upgExecute=upgExecute, histMetrPps=histMetrPps, histMetrSkips=histMetrSkips, curMetrStopTimestamp=curMetrStopTimestamp, histMetrAvgLostPps=histMetrAvgLostPps)
