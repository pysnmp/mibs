...
# Produced by pysmi-1.1.8 at Sat Jan 15 19:45:17 2022
...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, TimeTicks, NotificationType, Integer32, ObjectIdentity, IpAddress, iso, MibIdentifier, Unsigned32, Gauge32, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "TimeTicks", "NotificationType", "Integer32", "ObjectIdentity", "IpAddress", "iso", "MibIdentifier", "Unsigned32", "Gauge32", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", curMetrTotalAvgDelta=curMetrTotalAvgDelta, curMetrKbps=curMetrKbps, ictMgmtMib=ictMgmtMib, histGroupIndex=histGroupIndex, ictFwUpg=ictFwUpg, histMetrTotalBytes=histMetrTotalBytes, catvModulePowerLevel=catvModulePowerLevel, ictMgmt=ictMgmt, curMetrSrcPort=curMetrSrcPort, curMetrAvgLostPps=curMetrAvgLostPps, histMetrAvgDelta=histMetrAvgDelta, transceiverDdmTemperature=transceiverDdmTemperature, curMetrStartTimestamp=curMetrStartTimestamp, transceiverLaserWavelength=transceiverLaserWavelength, upgUrl=upgUrl, histMetrTotalReordered=histMetrTotalReordered, histMetrTotalAvgDelta=histMetrTotalAvgDelta, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, histMetrStopTimestamp=histMetrStopTimestamp, transceiverEthernetCompliance=transceiverEthernetCompliance, transceiverLinkLength=transceiverLinkLength, catvModuleAdminStatus=catvModuleAdminStatus, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, curMetrAvgPps=curMetrAvgPps, curMetrSourceAddr=curMetrSourceAddr, curMetrTotalBytes=curMetrTotalBytes, ictServicesMibs=ictServicesMibs, curMetrStreamType=curMetrStreamType, histMetrAvgKbps=histMetrAvgKbps, ictServices=ictServices, curMetrMaxDelta=curMetrMaxDelta, ictFacRstMib=ictFacRstMib, curMetrAvgKbps=curMetrAvgKbps, ictMcastAnalyzer=ictMcastAnalyzer, transceiverConnectorType=transceiverConnectorType, catvModuleFilter=catvModuleFilter, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, histMetrReordered=histMetrReordered, curMetrAvgDelta=curMetrAvgDelta, catvModuleRflevel=catvModuleRflevel, ictFacRst=ictFacRst, upgExecute=upgExecute, curMetrSkips=curMetrSkips, curMetrStopTimestamp=curMetrStopTimestamp, histMetrSourceAddr=histMetrSourceAddr, catvModuleSignalDetected=catvModuleSignalDetected, catvModuleLowSignal=catvModuleLowSignal, ictReboot=ictReboot, curMetrTotalLost=curMetrTotalLost, histMetrMaxDelta=histMetrMaxDelta, curMetrGroupAddr=curMetrGroupAddr, curGroupAddr=curGroupAddr, transceiverDdmTxPower=transceiverDdmTxPower, ictReset=ictReset, histMetrKbps=histMetrKbps, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, histGroupAddr=histGroupAddr, curMetrJitter=curMetrJitter, histMetrTotalSkips=histMetrTotalSkips, cfgStatus=cfgStatus, histMetrDstPort=histMetrDstPort, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, curGroupIndex=curGroupIndex, performFactoryReset=performFactoryReset, transceiverDdmRxPower=transceiverDdmRxPower, transceiverTransceiverType=transceiverTransceiverType, upgStatus=upgStatus, histMetrJitter=histMetrJitter, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, IctPortList=IctPortList, histMetrLost=histMetrLost, transceiverDdmVoltage=transceiverDdmVoltage, histMetrTotalLost=histMetrTotalLost, ictTransceiver=ictTransceiver, histMetrGroupAddr=histMetrGroupAddr, cfgExecute=cfgExecute, icotera=icotera, histMetrDiscontinuities=histMetrDiscontinuities, ictCatv=ictCatv, currentMetricsEntry=currentMetricsEntry, histMetrPps=histMetrPps, currentListEntry=currentListEntry, histMetrTotalMaxDelta=histMetrTotalMaxDelta, curMetrDiscontinuities=curMetrDiscontinuities, histMetrAvgPps=histMetrAvgPps, ictIGW1k=ictIGW1k, historyListEntry=historyListEntry, IctDelta=IctDelta, histMetrSkips=histMetrSkips, transceiverDiagCapable=transceiverDiagCapable, curMetrTotalPackets=curMetrTotalPackets, PYSNMP_MODULE_ID=icotera, historyMetricsEntry=historyMetricsEntry, IctTimeStamp=IctTimeStamp, performCpeReboot=performCpeReboot, curMetrReordered=curMetrReordered, curMetrLost=curMetrLost, histMetrTotalPackets=histMetrTotalPackets, ictCfgUpdate=ictCfgUpdate, histMetrAvgLostPps=histMetrAvgLostPps, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, histMetrStreamType=histMetrStreamType, histMetrStartTimestamp=histMetrStartTimestamp, cfgTftpPath=cfgTftpPath, curMetrTotalReordered=curMetrTotalReordered, curMetrTotalSkips=curMetrTotalSkips, curMetrDstPort=curMetrDstPort, curMetrPps=curMetrPps, IctJitter=IctJitter, curMetrMemberPorts=curMetrMemberPorts, curMetrTotalMaxDelta=curMetrTotalMaxDelta, histMetrMemberPorts=histMetrMemberPorts, histMetrSrcPort=histMetrSrcPort)
