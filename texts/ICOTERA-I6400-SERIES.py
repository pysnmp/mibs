...
# Produced by pysmi-1.1.12 at Wed Nov  6 08:32:22 2024
...
ModuleIdentity, Integer32, IpAddress, TimeTicks, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, enterprises, Gauge32, NotificationType, MibIdentifier, Counter64, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "IpAddress", "TimeTicks", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "enterprises", "Gauge32", "NotificationType", "MibIdentifier", "Counter64", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", histMetrGroupAddr=histMetrGroupAddr, catvModuleLowSignal=catvModuleLowSignal, IctJitter=IctJitter, histMetrSkips=histMetrSkips, currentMetricsEntry=currentMetricsEntry, curMetrTotalMaxDelta=curMetrTotalMaxDelta, ictReboot=ictReboot, curMetrKbps=curMetrKbps, histMetrJitter=histMetrJitter, curMetrSrcPort=curMetrSrcPort, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, histMetrTotalAvgDelta=histMetrTotalAvgDelta, transceiverDdmTemperature=transceiverDdmTemperature, currentListEntry=currentListEntry, histMetrTotalSkips=histMetrTotalSkips, transceiverDiagCapable=transceiverDiagCapable, ictTransceiver=ictTransceiver, transceiverLinkLength=transceiverLinkLength, curMetrSkips=curMetrSkips, histMetrDiscontinuities=histMetrDiscontinuities, historyMetricsEntry=historyMetricsEntry, catvModuleFilter=catvModuleFilter, catvModuleRflevel=catvModuleRflevel, catvModulePowerLevel=catvModulePowerLevel, curMetrTotalAvgDelta=curMetrTotalAvgDelta, curMetrLost=curMetrLost, ictCfgUpdate=ictCfgUpdate, histMetrSrcPort=histMetrSrcPort, histMetrMemberPorts=histMetrMemberPorts, cfgStatus=cfgStatus, histMetrTotalPackets=histMetrTotalPackets, ictFwUpg=ictFwUpg, histMetrStartTimestamp=histMetrStartTimestamp, curMetrTotalBytes=curMetrTotalBytes, histGroupIndex=histGroupIndex, histMetrDstPort=histMetrDstPort, transceiverLaserWavelength=transceiverLaserWavelength, performCpeReboot=performCpeReboot, histMetrSourceAddr=histMetrSourceAddr, upgExecute=upgExecute, curGroupIndex=curGroupIndex, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, ictServicesMibs=ictServicesMibs, catvModuleSignalDetected=catvModuleSignalDetected, curMetrDstPort=curMetrDstPort, histMetrKbps=histMetrKbps, histMetrReordered=histMetrReordered, histMetrStopTimestamp=histMetrStopTimestamp, curMetrTotalReordered=curMetrTotalReordered, transceiverDdmRxPower=transceiverDdmRxPower, histMetrTotalMaxDelta=histMetrTotalMaxDelta, ictFacRstMib=ictFacRstMib, curMetrJitter=curMetrJitter, histMetrTotalBytes=histMetrTotalBytes, histMetrStreamType=histMetrStreamType, curMetrDiscontinuities=curMetrDiscontinuities, curMetrStartTimestamp=curMetrStartTimestamp, curGroupAddr=curGroupAddr, upgStatus=upgStatus, curMetrGroupAddr=curMetrGroupAddr, icotera=icotera, ictIGW1k=ictIGW1k, curMetrReordered=curMetrReordered, histMetrTotalReordered=histMetrTotalReordered, curMetrMaxDelta=curMetrMaxDelta, curMetrStreamType=curMetrStreamType, transceiverEthernetCompliance=transceiverEthernetCompliance, curMetrStopTimestamp=curMetrStopTimestamp, curMetrMemberPorts=curMetrMemberPorts, histMetrMaxDelta=histMetrMaxDelta, histGroupAddr=histGroupAddr, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrAvgKbps=curMetrAvgKbps, ictCatv=ictCatv, curMetrAvgPps=curMetrAvgPps, IctDelta=IctDelta, historyListEntry=historyListEntry, IctTimeStamp=IctTimeStamp, curMetrSourceAddr=curMetrSourceAddr, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, ictReset=ictReset, ictMgmt=ictMgmt, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, curMetrAvgLostPps=curMetrAvgLostPps, cfgTftpPath=cfgTftpPath, ictFacRst=ictFacRst, histMetrAvgLostPps=histMetrAvgLostPps, histMetrAvgKbps=histMetrAvgKbps, ictServices=ictServices, histMetrLost=histMetrLost, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, histMetrAvgPps=histMetrAvgPps, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, transceiverDdmVoltage=transceiverDdmVoltage, curMetrTotalPackets=curMetrTotalPackets, ictMgmtMib=ictMgmtMib, curMetrTotalSkips=curMetrTotalSkips, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, histMetrAvgDelta=histMetrAvgDelta, PYSNMP_MODULE_ID=icotera, catvModuleAdminStatus=catvModuleAdminStatus, histMetrPps=histMetrPps, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, transceiverDdmTxPower=transceiverDdmTxPower, curMetrAvgDelta=curMetrAvgDelta, histMetrTotalLost=histMetrTotalLost, curMetrTotalLost=curMetrTotalLost, curMetrPps=curMetrPps, ictMcastAnalyzer=ictMcastAnalyzer, transceiverTransceiverType=transceiverTransceiverType, transceiverConnectorType=transceiverConnectorType, upgUrl=upgUrl, performFactoryReset=performFactoryReset, cfgExecute=cfgExecute, IctPortList=IctPortList)
