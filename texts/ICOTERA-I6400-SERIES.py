...
Counter32, ModuleIdentity, Bits, MibIdentifier, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, NotificationType, Counter64, TimeTicks, enterprises, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "Bits", "MibIdentifier", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "NotificationType", "Counter64", "TimeTicks", "enterprises", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", curMetrTotalSkips=curMetrTotalSkips, curMetrTotalLost=curMetrTotalLost, curMetrAvgKbps=curMetrAvgKbps, icotera=icotera, transceiverDdmTxPower=transceiverDdmTxPower, histMetrDstPort=histMetrDstPort, curMetrTotalPackets=curMetrTotalPackets, catvModulePowerLevel=catvModulePowerLevel, histMetrTotalMaxDelta=histMetrTotalMaxDelta, currentMetricsEntry=currentMetricsEntry, transceiverLinkLength=transceiverLinkLength, curMetrKbps=curMetrKbps, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, cfgTftpPath=cfgTftpPath, histMetrStopTimestamp=histMetrStopTimestamp, ictCfgUpdate=ictCfgUpdate, histMetrMaxDelta=histMetrMaxDelta, transceiverConnectorType=transceiverConnectorType, curMetrLost=curMetrLost, transceiverTransceiverType=transceiverTransceiverType, transceiverDdmTemperature=transceiverDdmTemperature, curMetrAvgDelta=curMetrAvgDelta, ictMcastAnalyzer=ictMcastAnalyzer, histMetrKbps=histMetrKbps, transceiverDdmVoltage=transceiverDdmVoltage, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, IctTimeStamp=IctTimeStamp, histMetrGroupAddr=histMetrGroupAddr, histMetrTotalSkips=histMetrTotalSkips, ictFacRstMib=ictFacRstMib, curMetrTotalBytes=curMetrTotalBytes, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, histMetrDiscontinuities=histMetrDiscontinuities, ictReset=ictReset, ictIGW1k=ictIGW1k, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, ictTransceiver=ictTransceiver, histMetrAvgLostPps=histMetrAvgLostPps, curGroupAddr=curGroupAddr, histMetrTotalBytes=histMetrTotalBytes, histMetrTotalReordered=histMetrTotalReordered, upgUrl=upgUrl, curMetrAvgPps=curMetrAvgPps, ictServices=ictServices, histMetrSkips=histMetrSkips, histMetrTotalAvgDelta=histMetrTotalAvgDelta, PYSNMP_MODULE_ID=icotera, ictServicesMibs=ictServicesMibs, histMetrAvgDelta=histMetrAvgDelta, histMetrMemberPorts=histMetrMemberPorts, ictFacRst=ictFacRst, curGroupIndex=curGroupIndex, ictReboot=ictReboot, histGroupAddr=histGroupAddr, performCpeReboot=performCpeReboot, catvModuleAdminStatus=catvModuleAdminStatus, catvModuleRflevel=catvModuleRflevel, curMetrStreamType=curMetrStreamType, ictMgmt=ictMgmt, cfgExecute=cfgExecute, curMetrAvgLostPps=curMetrAvgLostPps, transceiverDdmRxPower=transceiverDdmRxPower, curMetrDiscontinuities=curMetrDiscontinuities, histMetrSourceAddr=histMetrSourceAddr, transceiverEthernetCompliance=transceiverEthernetCompliance, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, cfgStatus=cfgStatus, performFactoryReset=performFactoryReset, histMetrJitter=histMetrJitter, catvModuleSignalDetected=catvModuleSignalDetected, curMetrMaxDelta=curMetrMaxDelta, historyListEntry=historyListEntry, ictCatv=ictCatv, upgExecute=upgExecute, curMetrSkips=curMetrSkips, currentListEntry=currentListEntry, curMetrPps=curMetrPps, histGroupIndex=histGroupIndex, IctDelta=IctDelta, catvModuleLowSignal=catvModuleLowSignal, upgStatus=upgStatus, curMetrSrcPort=curMetrSrcPort, curMetrDstPort=curMetrDstPort, ictFwUpg=ictFwUpg, curMetrTotalMaxDelta=curMetrTotalMaxDelta, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, histMetrSrcPort=histMetrSrcPort, curMetrSourceAddr=curMetrSourceAddr, curMetrJitter=curMetrJitter, ictMgmtMib=ictMgmtMib, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, histMetrReordered=histMetrReordered, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, historyMetricsEntry=historyMetricsEntry, histMetrTotalPackets=histMetrTotalPackets, histMetrAvgPps=histMetrAvgPps, histMetrStartTimestamp=histMetrStartTimestamp, catvModuleFilter=catvModuleFilter, curMetrStopTimestamp=curMetrStopTimestamp, histMetrAvgKbps=histMetrAvgKbps, histMetrStreamType=histMetrStreamType, IctPortList=IctPortList, histMetrTotalLost=histMetrTotalLost, curMetrGroupAddr=curMetrGroupAddr, histMetrLost=histMetrLost, IctJitter=IctJitter, transceiverDiagCapable=transceiverDiagCapable, curMetrTotalAvgDelta=curMetrTotalAvgDelta, histMetrPps=histMetrPps, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, curMetrTotalReordered=curMetrTotalReordered, curMetrStartTimestamp=curMetrStartTimestamp, transceiverLaserWavelength=transceiverLaserWavelength, curMetrMemberPorts=curMetrMemberPorts, curMetrReordered=curMetrReordered)
