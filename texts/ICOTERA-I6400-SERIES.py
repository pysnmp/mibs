...
enterprises, ModuleIdentity, Gauge32, Bits, MibIdentifier, Integer32, IpAddress, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, NotificationType, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "Gauge32", "Bits", "MibIdentifier", "Integer32", "IpAddress", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "NotificationType", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", ictMgmt=ictMgmt, histMetrSrcPort=histMetrSrcPort, histMetrStopTimestamp=histMetrStopTimestamp, curGroupAddr=curGroupAddr, curMetrJitter=curMetrJitter, ictReset=ictReset, histMetrTotalAvgDelta=histMetrTotalAvgDelta, curMetrGroupAddr=curMetrGroupAddr, catvModuleLowSignal=catvModuleLowSignal, curGroupIndex=curGroupIndex, transceiverDdmTemperature=transceiverDdmTemperature, histMetrTotalReordered=histMetrTotalReordered, transceiverDdmTxPower=transceiverDdmTxPower, histMetrMemberPorts=histMetrMemberPorts, histMetrAvgLostPps=histMetrAvgLostPps, histMetrAvgDelta=histMetrAvgDelta, cfgTftpPath=cfgTftpPath, curMetrTotalPackets=curMetrTotalPackets, ictMcastAnalyzer=ictMcastAnalyzer, currentMetricsEntry=currentMetricsEntry, catvModuleAdminStatus=catvModuleAdminStatus, IctDelta=IctDelta, ictServicesMibs=ictServicesMibs, transceiverLinkLength=transceiverLinkLength, histMetrMaxDelta=histMetrMaxDelta, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, curMetrTotalBytes=curMetrTotalBytes, histMetrAvgKbps=histMetrAvgKbps, curMetrSrcPort=curMetrSrcPort, curMetrSourceAddr=curMetrSourceAddr, histMetrStreamType=histMetrStreamType, curMetrLost=curMetrLost, ictIGW1k=ictIGW1k, curMetrKbps=curMetrKbps, histMetrKbps=histMetrKbps, histMetrReordered=histMetrReordered, histMetrDstPort=histMetrDstPort, ictMgmtMib=ictMgmtMib, transceiverEthernetCompliance=transceiverEthernetCompliance, ictCfgUpdate=ictCfgUpdate, catvModuleRflevel=catvModuleRflevel, performFactoryReset=performFactoryReset, IctPortList=IctPortList, histMetrAvgPps=histMetrAvgPps, histMetrTotalMaxDelta=histMetrTotalMaxDelta, histMetrTotalLost=histMetrTotalLost, histMetrJitter=histMetrJitter, ictFacRstMib=ictFacRstMib, ictFwUpg=ictFwUpg, ictTransceiver=ictTransceiver, curMetrTotalReordered=curMetrTotalReordered, curMetrSkips=curMetrSkips, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, ictReboot=ictReboot, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, curMetrMaxDelta=curMetrMaxDelta, histMetrPps=histMetrPps, curMetrStreamType=curMetrStreamType, ictFacRst=ictFacRst, curMetrTotalAvgDelta=curMetrTotalAvgDelta, curMetrAvgDelta=curMetrAvgDelta, upgStatus=upgStatus, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, curMetrDiscontinuities=curMetrDiscontinuities, histMetrSourceAddr=histMetrSourceAddr, histMetrTotalBytes=histMetrTotalBytes, transceiverDdmRxPower=transceiverDdmRxPower, histMetrGroupAddr=histMetrGroupAddr, catvModulePowerLevel=catvModulePowerLevel, IctJitter=IctJitter, catvModuleSignalDetected=catvModuleSignalDetected, icotera=icotera, historyMetricsEntry=historyMetricsEntry, histMetrTotalPackets=histMetrTotalPackets, curMetrStopTimestamp=curMetrStopTimestamp, ictCatv=ictCatv, historyListEntry=historyListEntry, IctTimeStamp=IctTimeStamp, currentListEntry=currentListEntry, ictServices=ictServices, curMetrDstPort=curMetrDstPort, histGroupAddr=histGroupAddr, histMetrSkips=histMetrSkips, curMetrTotalMaxDelta=curMetrTotalMaxDelta, PYSNMP_MODULE_ID=icotera, histGroupIndex=histGroupIndex, curMetrAvgPps=curMetrAvgPps, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, cfgExecute=cfgExecute, curMetrPps=curMetrPps, histMetrLost=histMetrLost, curMetrAvgKbps=curMetrAvgKbps, curMetrAvgLostPps=curMetrAvgLostPps, upgExecute=upgExecute, histMetrTotalSkips=histMetrTotalSkips, transceiverLaserWavelength=transceiverLaserWavelength, histMetrStartTimestamp=histMetrStartTimestamp, transceiverDiagCapable=transceiverDiagCapable, transceiverDdmVoltage=transceiverDdmVoltage, upgUrl=upgUrl, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, histMetrDiscontinuities=histMetrDiscontinuities, cfgStatus=cfgStatus, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, performCpeReboot=performCpeReboot, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, curMetrTotalSkips=curMetrTotalSkips, curMetrReordered=curMetrReordered, transceiverTransceiverType=transceiverTransceiverType, catvModuleFilter=catvModuleFilter, curMetrTotalLost=curMetrTotalLost, transceiverConnectorType=transceiverConnectorType, curMetrMemberPorts=curMetrMemberPorts, curMetrStartTimestamp=curMetrStartTimestamp)
