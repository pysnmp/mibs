...
# Produced by pysmi-1.1.8 at Thu Sep 15 10:10:01 2022
...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, Integer32, ObjectIdentity, iso, Bits, Gauge32, IpAddress, enterprises, ModuleIdentity, Counter64, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "Integer32", "ObjectIdentity", "iso", "Bits", "Gauge32", "IpAddress", "enterprises", "ModuleIdentity", "Counter64", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", histMetrAvgKbps=histMetrAvgKbps, curMetrStopTimestamp=curMetrStopTimestamp, transceiverDdmVoltage=transceiverDdmVoltage, histMetrReordered=histMetrReordered, currentListEntry=currentListEntry, upgStatus=upgStatus, catvModulePowerLevel=catvModulePowerLevel, histGroupIndex=histGroupIndex, catvModuleFilter=catvModuleFilter, histMetrStopTimestamp=histMetrStopTimestamp, curMetrJitter=curMetrJitter, histMetrAvgLostPps=histMetrAvgLostPps, upgUrl=upgUrl, IctPortList=IctPortList, histMetrDstPort=histMetrDstPort, cfgTftpPath=cfgTftpPath, IctDelta=IctDelta, curMetrTotalLost=curMetrTotalLost, ictServicesMibs=ictServicesMibs, histMetrJitter=histMetrJitter, curMetrDstPort=curMetrDstPort, transceiverLinkLength=transceiverLinkLength, ictFacRstMib=ictFacRstMib, curMetrTotalBytes=curMetrTotalBytes, curMetrTotalMaxDelta=curMetrTotalMaxDelta, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, curMetrReordered=curMetrReordered, histMetrKbps=histMetrKbps, transceiverDdmTemperature=transceiverDdmTemperature, curMetrAvgKbps=curMetrAvgKbps, curMetrTotalPackets=curMetrTotalPackets, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrTotalSkips=curMetrTotalSkips, curGroupAddr=curGroupAddr, curMetrSrcPort=curMetrSrcPort, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, curMetrSourceAddr=curMetrSourceAddr, histMetrAvgPps=histMetrAvgPps, histMetrLost=histMetrLost, historyListEntry=historyListEntry, transceiverLaserWavelength=transceiverLaserWavelength, histGroupAddr=histGroupAddr, ictTransceiver=ictTransceiver, curMetrAvgDelta=curMetrAvgDelta, histMetrGroupAddr=histMetrGroupAddr, histMetrStartTimestamp=histMetrStartTimestamp, curGroupIndex=curGroupIndex, IctJitter=IctJitter, curMetrLost=curMetrLost, histMetrMemberPorts=histMetrMemberPorts, curMetrSkips=curMetrSkips, histMetrTotalSkips=histMetrTotalSkips, histMetrTotalMaxDelta=histMetrTotalMaxDelta, catvModuleSignalDetected=catvModuleSignalDetected, catvModuleRflevel=catvModuleRflevel, transceiverDdmTxPower=transceiverDdmTxPower, histMetrDiscontinuities=histMetrDiscontinuities, ictFacRst=ictFacRst, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, curMetrAvgPps=curMetrAvgPps, curMetrStartTimestamp=curMetrStartTimestamp, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, curMetrMaxDelta=curMetrMaxDelta, curMetrGroupAddr=curMetrGroupAddr, histMetrSkips=histMetrSkips, ictMcastAnalyzer=ictMcastAnalyzer, histMetrTotalBytes=histMetrTotalBytes, IctTimeStamp=IctTimeStamp, histMetrSourceAddr=histMetrSourceAddr, ictMgmtMib=ictMgmtMib, curMetrStreamType=curMetrStreamType, performCpeReboot=performCpeReboot, curMetrPps=curMetrPps, curMetrAvgLostPps=curMetrAvgLostPps, catvModuleLowSignal=catvModuleLowSignal, ictMgmt=ictMgmt, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, curMetrTotalAvgDelta=curMetrTotalAvgDelta, upgExecute=upgExecute, curMetrKbps=curMetrKbps, PYSNMP_MODULE_ID=icotera, icotera=icotera, transceiverTransceiverType=transceiverTransceiverType, histMetrPps=histMetrPps, histMetrAvgDelta=histMetrAvgDelta, transceiverDdmRxPower=transceiverDdmRxPower, ictReboot=ictReboot, ictServices=ictServices, cfgStatus=cfgStatus, histMetrMaxDelta=histMetrMaxDelta, histMetrTotalPackets=histMetrTotalPackets, ictFwUpg=ictFwUpg, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, ictCatv=ictCatv, transceiverDiagCapable=transceiverDiagCapable, cfgExecute=cfgExecute, curMetrDiscontinuities=curMetrDiscontinuities, currentMetricsEntry=currentMetricsEntry, ictIGW1k=ictIGW1k, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, transceiverConnectorType=transceiverConnectorType, histMetrSrcPort=histMetrSrcPort, histMetrStreamType=histMetrStreamType, historyMetricsEntry=historyMetricsEntry, histMetrTotalLost=histMetrTotalLost, histMetrTotalReordered=histMetrTotalReordered, catvModuleAdminStatus=catvModuleAdminStatus, ictReset=ictReset, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, histMetrTotalAvgDelta=histMetrTotalAvgDelta, performFactoryReset=performFactoryReset, transceiverEthernetCompliance=transceiverEthernetCompliance, curMetrMemberPorts=curMetrMemberPorts, curMetrTotalReordered=curMetrTotalReordered, ictCfgUpdate=ictCfgUpdate)
