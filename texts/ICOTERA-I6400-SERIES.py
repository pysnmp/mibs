...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", histMetrLost=histMetrLost, curMetrTotalBytes=curMetrTotalBytes, histMetrAvgDelta=histMetrAvgDelta, transceiverEthernetCompliance=transceiverEthernetCompliance, curMetrSourceAddr=curMetrSourceAddr, histMetrPps=histMetrPps, curMetrTotalReordered=curMetrTotalReordered, catvModuleSignalDetected=catvModuleSignalDetected, upgUrl=upgUrl, ictServices=ictServices, ictMgmtMib=ictMgmtMib, transceiverDdmVoltage=transceiverDdmVoltage, histMetrStartTimestamp=histMetrStartTimestamp, performCpeReboot=performCpeReboot, historyListEntry=historyListEntry, curMetrTotalPackets=curMetrTotalPackets, transceiverLinkLength=transceiverLinkLength, curMetrStopTimestamp=curMetrStopTimestamp, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, catvModuleLowSignal=catvModuleLowSignal, histMetrStreamType=histMetrStreamType, performFactoryReset=performFactoryReset, curMetrTotalLost=curMetrTotalLost, histMetrKbps=histMetrKbps, curMetrTotalMaxDelta=curMetrTotalMaxDelta, curMetrMemberPorts=curMetrMemberPorts, transceiverDdmTemperature=transceiverDdmTemperature, ictMgmt=ictMgmt, ictTransceiver=ictTransceiver, histMetrAvgPps=histMetrAvgPps, curMetrAvgKbps=curMetrAvgKbps, histMetrReordered=histMetrReordered, PYSNMP_MODULE_ID=icotera, upgStatus=upgStatus, transceiverDdmRxPower=transceiverDdmRxPower, currentListEntry=currentListEntry, curMetrSkips=curMetrSkips, curGroupIndex=curGroupIndex, curMetrPps=curMetrPps, curMetrStartTimestamp=curMetrStartTimestamp, cfgStatus=cfgStatus, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, transceiverConnectorType=transceiverConnectorType, catvModuleAdminStatus=catvModuleAdminStatus, cfgTftpPath=cfgTftpPath, histMetrSrcPort=histMetrSrcPort, transceiverLaserWavelength=transceiverLaserWavelength, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, curMetrJitter=curMetrJitter, curMetrKbps=curMetrKbps, IctTimeStamp=IctTimeStamp, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, ictReset=ictReset, transceiverDiagCapable=transceiverDiagCapable, histMetrDiscontinuities=histMetrDiscontinuities, curMetrAvgLostPps=curMetrAvgLostPps, histMetrDstPort=histMetrDstPort, histMetrStopTimestamp=histMetrStopTimestamp, icotera=icotera, curMetrMaxDelta=curMetrMaxDelta, curMetrReordered=curMetrReordered, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, histMetrTotalReordered=histMetrTotalReordered, transceiverDdmTxPower=transceiverDdmTxPower, histMetrSkips=histMetrSkips, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, histMetrTotalSkips=histMetrTotalSkips, ictFacRst=ictFacRst, currentMetricsEntry=currentMetricsEntry, ictReboot=ictReboot, ictIGW1k=ictIGW1k, histGroupIndex=histGroupIndex, histMetrGroupAddr=histMetrGroupAddr, transceiverTransceiverType=transceiverTransceiverType, histMetrTotalLost=histMetrTotalLost, curMetrStreamType=curMetrStreamType, catvModulePowerLevel=catvModulePowerLevel, curGroupAddr=curGroupAddr, histMetrTotalMaxDelta=histMetrTotalMaxDelta, histMetrMemberPorts=histMetrMemberPorts, curMetrTotalSkips=curMetrTotalSkips, ictFacRstMib=ictFacRstMib, IctJitter=IctJitter, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, histMetrMaxDelta=histMetrMaxDelta, ictMcastAnalyzer=ictMcastAnalyzer, cfgExecute=cfgExecute, ictServicesMibs=ictServicesMibs, histMetrAvgLostPps=histMetrAvgLostPps, curMetrTotalAvgDelta=curMetrTotalAvgDelta, curMetrDstPort=curMetrDstPort, historyMetricsEntry=historyMetricsEntry, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, curMetrDiscontinuities=curMetrDiscontinuities, curMetrLost=curMetrLost, ictCatv=ictCatv, ictCfgUpdate=ictCfgUpdate, catvModuleRflevel=catvModuleRflevel, upgExecute=upgExecute, IctPortList=IctPortList, curMetrAvgDelta=curMetrAvgDelta, histGroupAddr=histGroupAddr, catvModuleFilter=catvModuleFilter, histMetrTotalBytes=histMetrTotalBytes, curMetrAvgPps=curMetrAvgPps, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, ictFwUpg=ictFwUpg, IctDelta=IctDelta, curMetrSrcPort=curMetrSrcPort, histMetrAvgKbps=histMetrAvgKbps, histMetrJitter=histMetrJitter, curMetrGroupAddr=curMetrGroupAddr, histMetrSourceAddr=histMetrSourceAddr, histMetrTotalPackets=histMetrTotalPackets, histMetrTotalAvgDelta=histMetrTotalAvgDelta)
