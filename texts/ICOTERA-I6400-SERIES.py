...
# Produced by pysmi-1.1.12 at Thu Apr  4 13:16:04 2024
...
iso, IpAddress, ModuleIdentity, Integer32, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises, Counter32, Unsigned32, Bits, MibIdentifier, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "ModuleIdentity", "Integer32", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises", "Counter32", "Unsigned32", "Bits", "MibIdentifier", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, histMetrTotalMaxDelta=histMetrTotalMaxDelta, ictFacRstMib=ictFacRstMib, curMetrTotalReordered=curMetrTotalReordered, curMetrTotalPackets=curMetrTotalPackets, histMetrTotalAvgDelta=histMetrTotalAvgDelta, histMetrSkips=histMetrSkips, curMetrSkips=curMetrSkips, histMetrReordered=histMetrReordered, catvModulePowerLevel=catvModulePowerLevel, curMetrSrcPort=curMetrSrcPort, histMetrTotalPackets=histMetrTotalPackets, transceiverTransceiverType=transceiverTransceiverType, curMetrMemberPorts=curMetrMemberPorts, histMetrJitter=histMetrJitter, transceiverLinkLength=transceiverLinkLength, ictReboot=ictReboot, curMetrTotalSkips=curMetrTotalSkips, icotera=icotera, histMetrTotalBytes=histMetrTotalBytes, curMetrDiscontinuities=curMetrDiscontinuities, catvModuleAdminStatus=catvModuleAdminStatus, ictFacRst=ictFacRst, curMetrAvgKbps=curMetrAvgKbps, histMetrKbps=histMetrKbps, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, curMetrStartTimestamp=curMetrStartTimestamp, upgUrl=upgUrl, catvModuleLowSignal=catvModuleLowSignal, curMetrAvgDelta=curMetrAvgDelta, catvModuleSignalDetected=catvModuleSignalDetected, histMetrSrcPort=histMetrSrcPort, currentMetricsEntry=currentMetricsEntry, ictCatv=ictCatv, historyMetricsEntry=historyMetricsEntry, curMetrDstPort=curMetrDstPort, transceiverConnectorType=transceiverConnectorType, curGroupAddr=curGroupAddr, histMetrDstPort=histMetrDstPort, ictIGW1k=ictIGW1k, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, curGroupIndex=curGroupIndex, histMetrPps=histMetrPps, histMetrAvgLostPps=histMetrAvgLostPps, transceiverDdmVoltage=transceiverDdmVoltage, ictTransceiver=ictTransceiver, histMetrSourceAddr=histMetrSourceAddr, curMetrStreamType=curMetrStreamType, curMetrAvgLostPps=curMetrAvgLostPps, performCpeReboot=performCpeReboot, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, histMetrTotalSkips=histMetrTotalSkips, histMetrDiscontinuities=histMetrDiscontinuities, ictServicesMibs=ictServicesMibs, histMetrTotalLost=histMetrTotalLost, IctJitter=IctJitter, curMetrAvgPps=curMetrAvgPps, curMetrTotalMaxDelta=curMetrTotalMaxDelta, histMetrLost=histMetrLost, histGroupIndex=histGroupIndex, histGroupAddr=histGroupAddr, curMetrPps=curMetrPps, transceiverDdmRxPower=transceiverDdmRxPower, transceiverDdmTxPower=transceiverDdmTxPower, historyListEntry=historyListEntry, catvModuleRflevel=catvModuleRflevel, histMetrAvgPps=histMetrAvgPps, curMetrTotalLost=curMetrTotalLost, histMetrTotalReordered=histMetrTotalReordered, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, histMetrGroupAddr=histMetrGroupAddr, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, upgStatus=upgStatus, transceiverDiagCapable=transceiverDiagCapable, IctTimeStamp=IctTimeStamp, curMetrReordered=curMetrReordered, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, PYSNMP_MODULE_ID=icotera, ictCfgUpdate=ictCfgUpdate, transceiverEthernetCompliance=transceiverEthernetCompliance, transceiverDdmTemperature=transceiverDdmTemperature, upgExecute=upgExecute, catvModuleFilter=catvModuleFilter, IctPortList=IctPortList, curMetrTotalAvgDelta=curMetrTotalAvgDelta, curMetrGroupAddr=curMetrGroupAddr, curMetrJitter=curMetrJitter, histMetrAvgDelta=histMetrAvgDelta, histMetrAvgKbps=histMetrAvgKbps, ictReset=ictReset, curMetrKbps=curMetrKbps, histMetrMemberPorts=histMetrMemberPorts, curMetrTotalBytes=curMetrTotalBytes, cfgStatus=cfgStatus, curMetrStopTimestamp=curMetrStopTimestamp, histMetrStopTimestamp=histMetrStopTimestamp, ictMgmtMib=ictMgmtMib, curMetrLost=curMetrLost, histMetrStartTimestamp=histMetrStartTimestamp, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, histMetrMaxDelta=histMetrMaxDelta, ictFwUpg=ictFwUpg, curMetrSourceAddr=curMetrSourceAddr, ictServices=ictServices, IctDelta=IctDelta, cfgExecute=cfgExecute, histMetrStreamType=histMetrStreamType, cfgTftpPath=cfgTftpPath, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, currentListEntry=currentListEntry, performFactoryReset=performFactoryReset, ictMcastAnalyzer=ictMcastAnalyzer, curMetrMaxDelta=curMetrMaxDelta, ictMgmt=ictMgmt, transceiverLaserWavelength=transceiverLaserWavelength)
