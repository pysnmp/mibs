...
ModuleIdentity, Unsigned32, MibIdentifier, TimeTicks, NotificationType, Integer32, Counter64, Gauge32, Bits, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "MibIdentifier", "TimeTicks", "NotificationType", "Integer32", "Counter64", "Gauge32", "Bits", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", IctDelta=IctDelta, curMetrTotalBytes=curMetrTotalBytes, curMetrTotalReordered=curMetrTotalReordered, curMetrReordered=curMetrReordered, histMetrReordered=histMetrReordered, curMetrAvgKbps=curMetrAvgKbps, histMetrTotalPackets=histMetrTotalPackets, histMetrDiscontinuities=histMetrDiscontinuities, histMetrSkips=histMetrSkips, curMetrDstPort=curMetrDstPort, PYSNMP_MODULE_ID=icotera, transceiverTransceiverType=transceiverTransceiverType, ictMcastAnalyzer=ictMcastAnalyzer, ictFwUpg=ictFwUpg, curMetrAvgPps=curMetrAvgPps, curMetrMemberPorts=curMetrMemberPorts, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, curMetrSrcPort=curMetrSrcPort, ictMgmt=ictMgmt, ictTransceiver=ictTransceiver, histMetrStartTimestamp=histMetrStartTimestamp, curMetrAvgDelta=curMetrAvgDelta, curMetrGroupAddr=curMetrGroupAddr, cfgTftpPath=cfgTftpPath, ictFacRstMib=ictFacRstMib, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, curMetrLost=curMetrLost, histMetrDstPort=histMetrDstPort, histMetrTotalReordered=histMetrTotalReordered, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, curMetrTotalMaxDelta=curMetrTotalMaxDelta, curMetrTotalSkips=curMetrTotalSkips, performFactoryReset=performFactoryReset, curMetrStopTimestamp=curMetrStopTimestamp, histMetrGroupAddr=histMetrGroupAddr, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrTotalLost=curMetrTotalLost, curMetrDiscontinuities=curMetrDiscontinuities, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, histMetrTotalLost=histMetrTotalLost, IctJitter=IctJitter, curGroupAddr=curGroupAddr, curMetrStartTimestamp=curMetrStartTimestamp, cfgStatus=cfgStatus, histGroupAddr=histGroupAddr, catvModuleRflevel=catvModuleRflevel, transceiverDdmRxPower=transceiverDdmRxPower, histMetrTotalMaxDelta=histMetrTotalMaxDelta, catvModulePowerLevel=catvModulePowerLevel, ictCfgUpdate=ictCfgUpdate, histMetrTotalSkips=histMetrTotalSkips, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, curMetrStreamType=curMetrStreamType, currentListEntry=currentListEntry, histMetrAvgPps=histMetrAvgPps, histMetrSrcPort=histMetrSrcPort, IctPortList=IctPortList, curMetrAvgLostPps=curMetrAvgLostPps, catvModuleSignalDetected=catvModuleSignalDetected, IctTimeStamp=IctTimeStamp, cfgExecute=cfgExecute, histMetrAvgDelta=histMetrAvgDelta, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, curMetrTotalPackets=curMetrTotalPackets, curMetrTotalAvgDelta=curMetrTotalAvgDelta, historyMetricsEntry=historyMetricsEntry, histGroupIndex=histGroupIndex, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, transceiverLinkLength=transceiverLinkLength, performCpeReboot=performCpeReboot, histMetrPps=histMetrPps, ictCatv=ictCatv, transceiverDiagCapable=transceiverDiagCapable, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, ictServices=ictServices, histMetrStreamType=histMetrStreamType, histMetrKbps=histMetrKbps, upgUrl=upgUrl, upgExecute=upgExecute, currentMetricsEntry=currentMetricsEntry, curMetrSourceAddr=curMetrSourceAddr, curMetrMaxDelta=curMetrMaxDelta, catvModuleLowSignal=catvModuleLowSignal, historyListEntry=historyListEntry, histMetrStopTimestamp=histMetrStopTimestamp, curMetrSkips=curMetrSkips, ictIGW1k=ictIGW1k, curGroupIndex=curGroupIndex, transceiverEthernetCompliance=transceiverEthernetCompliance, histMetrJitter=histMetrJitter, transceiverConnectorType=transceiverConnectorType, histMetrSourceAddr=histMetrSourceAddr, ictReboot=ictReboot, histMetrTotalAvgDelta=histMetrTotalAvgDelta, catvModuleAdminStatus=catvModuleAdminStatus, histMetrLost=histMetrLost, catvModuleFilter=catvModuleFilter, icotera=icotera, transceiverDdmTxPower=transceiverDdmTxPower, transceiverDdmVoltage=transceiverDdmVoltage, histMetrTotalBytes=histMetrTotalBytes, ictFacRst=ictFacRst, ictServicesMibs=ictServicesMibs, curMetrJitter=curMetrJitter, histMetrAvgKbps=histMetrAvgKbps, ictReset=ictReset, histMetrAvgLostPps=histMetrAvgLostPps, curMetrKbps=curMetrKbps, ictMgmtMib=ictMgmtMib, transceiverLaserWavelength=transceiverLaserWavelength, upgStatus=upgStatus, transceiverDdmTemperature=transceiverDdmTemperature, curMetrPps=curMetrPps, histMetrMaxDelta=histMetrMaxDelta, histMetrMemberPorts=histMetrMemberPorts)
