...
enterprises, NotificationType, ModuleIdentity, Counter32, Bits, TimeTicks, iso, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, Unsigned32, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "ModuleIdentity", "Counter32", "Bits", "TimeTicks", "iso", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "Unsigned32", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", ictMcastAnalyzer=ictMcastAnalyzer, performFactoryReset=performFactoryReset, cfgExecute=cfgExecute, curGroupAddr=curGroupAddr, ictServicesMibs=ictServicesMibs, ictCfgUpdate=ictCfgUpdate, histMetrStartTimestamp=histMetrStartTimestamp, curMetrStopTimestamp=curMetrStopTimestamp, historyMetricsEntry=historyMetricsEntry, historyListEntry=historyListEntry, curMetrStartTimestamp=curMetrStartTimestamp, upgUrl=upgUrl, histMetrAvgPps=histMetrAvgPps, ictFacRstMib=ictFacRstMib, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, transceiverLinkLength=transceiverLinkLength, curMetrAvgPps=curMetrAvgPps, upgStatus=upgStatus, curMetrAvgDelta=curMetrAvgDelta, histMetrAvgKbps=histMetrAvgKbps, histMetrTotalSkips=histMetrTotalSkips, histGroupAddr=histGroupAddr, ictCatv=ictCatv, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, histMetrKbps=histMetrKbps, curMetrTotalBytes=curMetrTotalBytes, curMetrGroupAddr=curMetrGroupAddr, histMetrReordered=histMetrReordered, curMetrTotalMaxDelta=curMetrTotalMaxDelta, transceiverConnectorType=transceiverConnectorType, histMetrSrcPort=histMetrSrcPort, ictIGW1k=ictIGW1k, histMetrPps=histMetrPps, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, curMetrReordered=curMetrReordered, cfgTftpPath=cfgTftpPath, curMetrMemberPorts=curMetrMemberPorts, transceiverDdmTemperature=transceiverDdmTemperature, curMetrTotalSkips=curMetrTotalSkips, transceiverTransceiverType=transceiverTransceiverType, transceiverDiagCapable=transceiverDiagCapable, histMetrAvgLostPps=histMetrAvgLostPps, ictMgmtMib=ictMgmtMib, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, curMetrDstPort=curMetrDstPort, curMetrSrcPort=curMetrSrcPort, curMetrSkips=curMetrSkips, histMetrJitter=histMetrJitter, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, histGroupIndex=histGroupIndex, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, curMetrMaxDelta=curMetrMaxDelta, ictReset=ictReset, curMetrLost=curMetrLost, PYSNMP_MODULE_ID=icotera, curMetrTotalLost=curMetrTotalLost, curGroupIndex=curGroupIndex, cfgStatus=cfgStatus, histMetrDiscontinuities=histMetrDiscontinuities, histMetrStreamType=histMetrStreamType, curMetrTotalPackets=curMetrTotalPackets, histMetrAvgDelta=histMetrAvgDelta, histMetrLost=histMetrLost, IctDelta=IctDelta, histMetrTotalReordered=histMetrTotalReordered, ictTransceiver=ictTransceiver, transceiverDdmRxPower=transceiverDdmRxPower, icotera=icotera, histMetrTotalPackets=histMetrTotalPackets, histMetrTotalMaxDelta=histMetrTotalMaxDelta, transceiverDdmTxPower=transceiverDdmTxPower, transceiverLaserWavelength=transceiverLaserWavelength, ictFwUpg=ictFwUpg, histMetrTotalAvgDelta=histMetrTotalAvgDelta, ictServices=ictServices, catvModuleRflevel=catvModuleRflevel, curMetrAvgKbps=curMetrAvgKbps, IctTimeStamp=IctTimeStamp, histMetrDstPort=histMetrDstPort, currentMetricsEntry=currentMetricsEntry, curMetrSourceAddr=curMetrSourceAddr, ictFacRst=ictFacRst, IctJitter=IctJitter, histMetrGroupAddr=histMetrGroupAddr, histMetrTotalBytes=histMetrTotalBytes, curMetrPps=curMetrPps, catvModuleSignalDetected=catvModuleSignalDetected, transceiverEthernetCompliance=transceiverEthernetCompliance, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, performCpeReboot=performCpeReboot, curMetrKbps=curMetrKbps, curMetrStreamType=curMetrStreamType, catvModuleLowSignal=catvModuleLowSignal, catvModuleFilter=catvModuleFilter, IctPortList=IctPortList, curMetrTotalAvgDelta=curMetrTotalAvgDelta, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrDiscontinuities=curMetrDiscontinuities, histMetrTotalLost=histMetrTotalLost, currentListEntry=currentListEntry, histMetrMaxDelta=histMetrMaxDelta, curMetrJitter=curMetrJitter, histMetrStopTimestamp=histMetrStopTimestamp, catvModuleAdminStatus=catvModuleAdminStatus, ictMgmt=ictMgmt, upgExecute=upgExecute, ictReboot=ictReboot, catvModulePowerLevel=catvModulePowerLevel, curMetrTotalReordered=curMetrTotalReordered, curMetrAvgLostPps=curMetrAvgLostPps, histMetrSourceAddr=histMetrSourceAddr, histMetrMemberPorts=histMetrMemberPorts, transceiverDdmVoltage=transceiverDdmVoltage, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, histMetrSkips=histMetrSkips)
