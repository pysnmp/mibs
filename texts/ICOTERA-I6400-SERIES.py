...
# Produced by pysmi-1.1.8 at Fri Jan  7 01:12:44 2022
...
IpAddress, iso, Integer32, enterprises, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Counter64, MibIdentifier, NotificationType, Counter32, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "iso", "Integer32", "enterprises", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Counter64", "MibIdentifier", "NotificationType", "Counter32", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", ictIGW1k=ictIGW1k, histMetrDiscontinuities=histMetrDiscontinuities, transceiverTransceiverType=transceiverTransceiverType, curMetrTotalReordered=curMetrTotalReordered, curMetrJitter=curMetrJitter, catvModuleLowSignal=catvModuleLowSignal, curGroupAddr=curGroupAddr, curMetrAvgKbps=curMetrAvgKbps, currentMetricsEntry=currentMetricsEntry, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, histMetrAvgKbps=histMetrAvgKbps, histMetrTotalMaxDelta=histMetrTotalMaxDelta, catvModulePowerLevel=catvModulePowerLevel, ictServicesMibs=ictServicesMibs, curGroupIndex=curGroupIndex, histMetrReordered=histMetrReordered, transceiverEthernetCompliance=transceiverEthernetCompliance, histMetrTotalPackets=histMetrTotalPackets, icotera=icotera, ictReset=ictReset, curMetrReordered=curMetrReordered, curMetrTotalAvgDelta=curMetrTotalAvgDelta, histMetrTotalBytes=histMetrTotalBytes, ictServices=ictServices, ictCatv=ictCatv, curMetrStreamType=curMetrStreamType, curMetrStopTimestamp=curMetrStopTimestamp, histMetrAvgDelta=histMetrAvgDelta, IctJitter=IctJitter, histMetrSourceAddr=histMetrSourceAddr, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, transceiverDdmTxPower=transceiverDdmTxPower, IctPortList=IctPortList, transceiverLinkLength=transceiverLinkLength, ictMgmtMib=ictMgmtMib, histMetrJitter=histMetrJitter, curMetrAvgLostPps=curMetrAvgLostPps, curMetrTotalMaxDelta=curMetrTotalMaxDelta, curMetrAvgDelta=curMetrAvgDelta, histMetrTotalLost=histMetrTotalLost, curMetrAvgPps=curMetrAvgPps, histMetrStreamType=histMetrStreamType, histMetrStopTimestamp=histMetrStopTimestamp, transceiverDdmVoltage=transceiverDdmVoltage, histMetrAvgPps=histMetrAvgPps, histMetrStartTimestamp=histMetrStartTimestamp, ictTransceiver=ictTransceiver, curMetrStartTimestamp=curMetrStartTimestamp, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, histMetrTotalSkips=histMetrTotalSkips, curMetrSkips=curMetrSkips, histMetrGroupAddr=histMetrGroupAddr, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, cfgTftpPath=cfgTftpPath, historyListEntry=historyListEntry, histMetrDstPort=histMetrDstPort, curMetrMemberPorts=curMetrMemberPorts, histGroupAddr=histGroupAddr, histMetrMaxDelta=histMetrMaxDelta, catvModuleFilter=catvModuleFilter, curMetrKbps=curMetrKbps, historyMetricsEntry=historyMetricsEntry, histMetrMemberPorts=histMetrMemberPorts, transceiverDdmRxPower=transceiverDdmRxPower, transceiverDiagCapable=transceiverDiagCapable, ictCfgUpdate=ictCfgUpdate, upgUrl=upgUrl, curMetrMaxDelta=curMetrMaxDelta, curMetrDstPort=curMetrDstPort, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, catvModuleRflevel=catvModuleRflevel, curMetrTotalLost=curMetrTotalLost, currentListEntry=currentListEntry, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, catvModuleAdminStatus=catvModuleAdminStatus, ictMcastAnalyzer=ictMcastAnalyzer, curMetrSrcPort=curMetrSrcPort, upgExecute=upgExecute, histMetrSrcPort=histMetrSrcPort, IctDelta=IctDelta, cfgStatus=cfgStatus, histMetrLost=histMetrLost, transceiverConnectorType=transceiverConnectorType, histGroupIndex=histGroupIndex, performCpeReboot=performCpeReboot, curMetrPps=curMetrPps, catvModuleSignalDetected=catvModuleSignalDetected, curMetrLost=curMetrLost, PYSNMP_MODULE_ID=icotera, histMetrPps=histMetrPps, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, cfgExecute=cfgExecute, IctTimeStamp=IctTimeStamp, upgStatus=upgStatus, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, histMetrTotalAvgDelta=histMetrTotalAvgDelta, curMetrTotalBytes=curMetrTotalBytes, ictMgmt=ictMgmt, curMetrSourceAddr=curMetrSourceAddr, histMetrKbps=histMetrKbps, histMetrSkips=histMetrSkips, curMetrGroupAddr=curMetrGroupAddr, ictFacRstMib=ictFacRstMib, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, transceiverLaserWavelength=transceiverLaserWavelength, performFactoryReset=performFactoryReset, ictFacRst=ictFacRst, histMetrAvgLostPps=histMetrAvgLostPps, curMetrTotalPackets=curMetrTotalPackets, ictFwUpg=ictFwUpg, ictReboot=ictReboot, transceiverDdmTemperature=transceiverDdmTemperature, histMetrTotalReordered=histMetrTotalReordered, curMetrTotalSkips=curMetrTotalSkips, curMetrDiscontinuities=curMetrDiscontinuities)
