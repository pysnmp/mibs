...
# Produced by pysmi-1.1.8 at Thu Dec 15 08:28:47 2022
...
IpAddress, Bits, ModuleIdentity, enterprises, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, Unsigned32, iso, Counter64, Gauge32, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "ModuleIdentity", "enterprises", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "Unsigned32", "iso", "Counter64", "Gauge32", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", transceiverDdmVoltage=transceiverDdmVoltage, histMetrJitter=histMetrJitter, curMetrStartTimestamp=curMetrStartTimestamp, ictMcastAnalyzer=ictMcastAnalyzer, historyMetricsEntry=historyMetricsEntry, histMetrStartTimestamp=histMetrStartTimestamp, curMetrTotalAvgDelta=curMetrTotalAvgDelta, transceiverTransceiverType=transceiverTransceiverType, transceiverConnectorType=transceiverConnectorType, curMetrKbps=curMetrKbps, catvModuleSignalDetected=catvModuleSignalDetected, histMetrDiscontinuities=histMetrDiscontinuities, histMetrReordered=histMetrReordered, histMetrTotalPackets=histMetrTotalPackets, curMetrStreamType=curMetrStreamType, histMetrTotalMaxDelta=histMetrTotalMaxDelta, histMetrKbps=histMetrKbps, histMetrTotalBytes=histMetrTotalBytes, curMetrAvgPps=curMetrAvgPps, cfgStatus=cfgStatus, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, curMetrPps=curMetrPps, histMetrAvgLostPps=histMetrAvgLostPps, upgStatus=upgStatus, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, transceiverLaserWavelength=transceiverLaserWavelength, histGroupIndex=histGroupIndex, curMetrMemberPorts=curMetrMemberPorts, curGroupIndex=curGroupIndex, histMetrSkips=histMetrSkips, ictIGW1k=ictIGW1k, transceiverDiagCapable=transceiverDiagCapable, curMetrAvgKbps=curMetrAvgKbps, ictFacRst=ictFacRst, histMetrDstPort=histMetrDstPort, currentMetricsEntry=currentMetricsEntry, upgUrl=upgUrl, histMetrMaxDelta=histMetrMaxDelta, curMetrDstPort=curMetrDstPort, ictMgmt=ictMgmt, upgExecute=upgExecute, IctPortList=IctPortList, histMetrTotalAvgDelta=histMetrTotalAvgDelta, histMetrSrcPort=histMetrSrcPort, histMetrTotalSkips=histMetrTotalSkips, curMetrDiscontinuities=curMetrDiscontinuities, transceiverDdmTxPower=transceiverDdmTxPower, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, IctJitter=IctJitter, curMetrSourceAddr=curMetrSourceAddr, histMetrGroupAddr=histMetrGroupAddr, ictReboot=ictReboot, curMetrReordered=curMetrReordered, curMetrStopTimestamp=curMetrStopTimestamp, curMetrTotalSkips=curMetrTotalSkips, catvModuleFilter=catvModuleFilter, curMetrMaxDelta=curMetrMaxDelta, histMetrStreamType=histMetrStreamType, PYSNMP_MODULE_ID=icotera, curMetrTotalMaxDelta=curMetrTotalMaxDelta, IctTimeStamp=IctTimeStamp, histMetrMemberPorts=histMetrMemberPorts, historyListEntry=historyListEntry, curMetrAvgDelta=curMetrAvgDelta, IctDelta=IctDelta, histMetrStopTimestamp=histMetrStopTimestamp, performCpeReboot=performCpeReboot, cfgTftpPath=cfgTftpPath, histMetrLost=histMetrLost, curMetrTotalPackets=curMetrTotalPackets, ictMgmtMib=ictMgmtMib, transceiverLinkLength=transceiverLinkLength, histMetrAvgKbps=histMetrAvgKbps, histMetrTotalReordered=histMetrTotalReordered, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, curMetrJitter=curMetrJitter, catvModulePowerLevel=catvModulePowerLevel, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, ictFwUpg=ictFwUpg, curMetrSrcPort=curMetrSrcPort, histMetrSourceAddr=histMetrSourceAddr, ictServices=ictServices, histGroupAddr=histGroupAddr, curMetrTotalReordered=curMetrTotalReordered, curMetrTotalBytes=curMetrTotalBytes, ictCatv=ictCatv, ictTransceiver=ictTransceiver, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, transceiverDdmTemperature=transceiverDdmTemperature, histMetrTotalLost=histMetrTotalLost, histMetrPps=histMetrPps, performFactoryReset=performFactoryReset, curMetrLost=curMetrLost, transceiverDdmRxPower=transceiverDdmRxPower, curMetrAvgLostPps=curMetrAvgLostPps, ictFacRstMib=ictFacRstMib, transceiverEthernetCompliance=transceiverEthernetCompliance, curGroupAddr=curGroupAddr, cfgExecute=cfgExecute, histMetrAvgPps=histMetrAvgPps, histMetrAvgDelta=histMetrAvgDelta, curMetrGroupAddr=curMetrGroupAddr, ictCfgUpdate=ictCfgUpdate, currentListEntry=currentListEntry, catvModuleAdminStatus=catvModuleAdminStatus, catvModuleLowSignal=catvModuleLowSignal, curMetrSkips=curMetrSkips, ictServicesMibs=ictServicesMibs, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrTotalLost=curMetrTotalLost, ictReset=ictReset, catvModuleRflevel=catvModuleRflevel, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, icotera=icotera)
