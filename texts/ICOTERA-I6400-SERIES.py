...
# Produced by pysmi-1.1.3 at Wed Dec  8 18:23:08 2021
...
ModuleIdentity, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, enterprises, ObjectIdentity, Integer32, Bits, Gauge32, Counter32, Unsigned32, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "enterprises", "ObjectIdentity", "Integer32", "Bits", "Gauge32", "Counter32", "Unsigned32", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", histGroupIndex=histGroupIndex, histMetrTotalPackets=histMetrTotalPackets, transceiverDdmTemperature=transceiverDdmTemperature, ictTransceiver=ictTransceiver, histMetrPps=histMetrPps, histMetrTotalBytes=histMetrTotalBytes, histMetrStopTimestamp=histMetrStopTimestamp, curMetrStreamType=curMetrStreamType, curMetrSkips=curMetrSkips, performCpeReboot=performCpeReboot, cfgStatus=cfgStatus, histMetrTotalReordered=histMetrTotalReordered, IctTimeStamp=IctTimeStamp, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, ictReset=ictReset, curMetrMemberPorts=curMetrMemberPorts, histMetrGroupAddr=histMetrGroupAddr, curMetrTotalAvgDelta=curMetrTotalAvgDelta, historyListEntry=historyListEntry, histMetrAvgLostPps=histMetrAvgLostPps, upgStatus=upgStatus, histMetrAvgDelta=histMetrAvgDelta, histMetrSrcPort=histMetrSrcPort, catvModuleSignalDetected=catvModuleSignalDetected, upgExecute=upgExecute, ictMgmt=ictMgmt, histGroupAddr=histGroupAddr, PYSNMP_MODULE_ID=icotera, histMetrJitter=histMetrJitter, curMetrTotalReordered=curMetrTotalReordered, ictFacRstMib=ictFacRstMib, histMetrSkips=histMetrSkips, curMetrAvgDelta=curMetrAvgDelta, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, currentMetricsEntry=currentMetricsEntry, transceiverDdmRxPower=transceiverDdmRxPower, histMetrTotalMaxDelta=histMetrTotalMaxDelta, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, curMetrTotalBytes=curMetrTotalBytes, histMetrReordered=histMetrReordered, ictFacRst=ictFacRst, IctJitter=IctJitter, curMetrPps=curMetrPps, ictMgmtMib=ictMgmtMib, curMetrAvgPps=curMetrAvgPps, curMetrMaxDelta=curMetrMaxDelta, curMetrTotalLost=curMetrTotalLost, histMetrDiscontinuities=histMetrDiscontinuities, catvModuleLowSignal=catvModuleLowSignal, curMetrKbps=curMetrKbps, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, curMetrReordered=curMetrReordered, ictMcastAnalyzer=ictMcastAnalyzer, curMetrLost=curMetrLost, histMetrKbps=histMetrKbps, curMetrDiscontinuities=curMetrDiscontinuities, histMetrTotalAvgDelta=histMetrTotalAvgDelta, curMetrTotalPackets=curMetrTotalPackets, histMetrAvgKbps=histMetrAvgKbps, histMetrStreamType=histMetrStreamType, cfgTftpPath=cfgTftpPath, histMetrLost=histMetrLost, curMetrSrcPort=curMetrSrcPort, histMetrTotalLost=histMetrTotalLost, curMetrTotalSkips=curMetrTotalSkips, transceiverEthernetCompliance=transceiverEthernetCompliance, transceiverDdmTxPower=transceiverDdmTxPower, curMetrStopTimestamp=curMetrStopTimestamp, ictServicesMibs=ictServicesMibs, curMetrJitter=curMetrJitter, currentListEntry=currentListEntry, ictServices=ictServices, histMetrMaxDelta=histMetrMaxDelta, IctDelta=IctDelta, curGroupAddr=curGroupAddr, catvModuleFilter=catvModuleFilter, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, curMetrAvgKbps=curMetrAvgKbps, icotera=icotera, transceiverConnectorType=transceiverConnectorType, histMetrTotalSkips=histMetrTotalSkips, upgUrl=upgUrl, transceiverLaserWavelength=transceiverLaserWavelength, curMetrGroupAddr=curMetrGroupAddr, curMetrAvgLostPps=curMetrAvgLostPps, catvModuleRflevel=catvModuleRflevel, catvModuleAdminStatus=catvModuleAdminStatus, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, ictFwUpg=ictFwUpg, histMetrMemberPorts=histMetrMemberPorts, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, performFactoryReset=performFactoryReset, histMetrDstPort=histMetrDstPort, cfgExecute=cfgExecute, transceiverLinkLength=transceiverLinkLength, histMetrSourceAddr=histMetrSourceAddr, transceiverDdmVoltage=transceiverDdmVoltage, historyMetricsEntry=historyMetricsEntry, histMetrAvgPps=histMetrAvgPps, catvModulePowerLevel=catvModulePowerLevel, ictCatv=ictCatv, transceiverDiagCapable=transceiverDiagCapable, curMetrTotalMaxDelta=curMetrTotalMaxDelta, ictCfgUpdate=ictCfgUpdate, curMetrDstPort=curMetrDstPort, IctPortList=IctPortList, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, ictIGW1k=ictIGW1k, curMetrStartTimestamp=curMetrStartTimestamp, transceiverTransceiverType=transceiverTransceiverType, ictReboot=ictReboot, curMetrSourceAddr=curMetrSourceAddr, curGroupIndex=curGroupIndex, histMetrStartTimestamp=histMetrStartTimestamp)
