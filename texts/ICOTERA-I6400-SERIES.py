...
enterprises, MibIdentifier, IpAddress, Counter64, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, Bits, TimeTicks, NotificationType, iso, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "IpAddress", "Counter64", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "Bits", "TimeTicks", "NotificationType", "iso", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", curMetrSkips=curMetrSkips, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, histMetrLost=histMetrLost, currentListEntry=currentListEntry, curMetrTotalMaxDelta=curMetrTotalMaxDelta, catvModuleAdminStatus=catvModuleAdminStatus, histMetrDstPort=histMetrDstPort, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, histMetrAvgDelta=histMetrAvgDelta, catvModuleRflevel=catvModuleRflevel, curMetrReordered=curMetrReordered, histGroupAddr=histGroupAddr, curGroupIndex=curGroupIndex, ictIGW1k=ictIGW1k, histMetrAvgPps=histMetrAvgPps, curMetrTotalReordered=curMetrTotalReordered, transceiverLaserWavelength=transceiverLaserWavelength, curMetrSourceAddr=curMetrSourceAddr, transceiverLinkLength=transceiverLinkLength, curMetrStartTimestamp=curMetrStartTimestamp, curMetrTotalBytes=curMetrTotalBytes, curMetrDstPort=curMetrDstPort, histMetrStreamType=histMetrStreamType, IctTimeStamp=IctTimeStamp, curMetrAvgDelta=curMetrAvgDelta, curMetrGroupAddr=curMetrGroupAddr, histMetrTotalReordered=histMetrTotalReordered, histMetrMemberPorts=histMetrMemberPorts, ictReset=ictReset, histMetrDiscontinuities=histMetrDiscontinuities, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, ictFacRst=ictFacRst, curMetrTotalPackets=curMetrTotalPackets, ictCfgUpdate=ictCfgUpdate, catvModulePowerLevel=catvModulePowerLevel, curMetrMemberPorts=curMetrMemberPorts, curMetrDiscontinuities=curMetrDiscontinuities, ictMcastAnalyzer=ictMcastAnalyzer, curMetrTotalAvgDelta=curMetrTotalAvgDelta, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, curGroupAddr=curGroupAddr, IctJitter=IctJitter, curMetrTotalSkips=curMetrTotalSkips, cfgTftpPath=cfgTftpPath, histMetrStartTimestamp=histMetrStartTimestamp, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, curMetrKbps=curMetrKbps, curMetrPps=curMetrPps, curMetrStreamType=curMetrStreamType, ictMgmtMib=ictMgmtMib, histMetrReordered=histMetrReordered, historyMetricsEntry=historyMetricsEntry, histMetrJitter=histMetrJitter, histGroupIndex=histGroupIndex, transceiverDdmRxPower=transceiverDdmRxPower, curMetrStopTimestamp=curMetrStopTimestamp, curMetrTotalLost=curMetrTotalLost, histMetrAvgKbps=histMetrAvgKbps, ictServices=ictServices, curMetrAvgLostPps=curMetrAvgLostPps, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, transceiverConnectorType=transceiverConnectorType, histMetrKbps=histMetrKbps, histMetrSkips=histMetrSkips, ictCatv=ictCatv, IctDelta=IctDelta, icotera=icotera, histMetrTotalSkips=histMetrTotalSkips, ictTransceiver=ictTransceiver, transceiverEthernetCompliance=transceiverEthernetCompliance, histMetrStopTimestamp=histMetrStopTimestamp, histMetrTotalLost=histMetrTotalLost, histMetrTotalPackets=histMetrTotalPackets, ictFwUpg=ictFwUpg, curMetrAvgPps=curMetrAvgPps, catvModuleFilter=catvModuleFilter, ictServicesMibs=ictServicesMibs, transceiverDdmTxPower=transceiverDdmTxPower, PYSNMP_MODULE_ID=icotera, histMetrTotalAvgDelta=histMetrTotalAvgDelta, transceiverDiagCapable=transceiverDiagCapable, cfgExecute=cfgExecute, ictMgmt=ictMgmt, catvModuleLowSignal=catvModuleLowSignal, curMetrLost=curMetrLost, curMetrMaxDelta=curMetrMaxDelta, histMetrSourceAddr=histMetrSourceAddr, transceiverDdmTemperature=transceiverDdmTemperature, histMetrSrcPort=histMetrSrcPort, historyListEntry=historyListEntry, histMetrMaxDelta=histMetrMaxDelta, upgUrl=upgUrl, histMetrTotalBytes=histMetrTotalBytes, curMetrSrcPort=curMetrSrcPort, transceiverTransceiverType=transceiverTransceiverType, currentMetricsEntry=currentMetricsEntry, curMetrAvgKbps=curMetrAvgKbps, histMetrAvgLostPps=histMetrAvgLostPps, histMetrTotalMaxDelta=histMetrTotalMaxDelta, transceiverDdmVoltage=transceiverDdmVoltage, upgStatus=upgStatus, histMetrPps=histMetrPps, cfgStatus=cfgStatus, catvModuleSignalDetected=catvModuleSignalDetected, upgExecute=upgExecute, ictFacRstMib=ictFacRstMib, performFactoryReset=performFactoryReset, IctPortList=IctPortList, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, curMetrJitter=curMetrJitter, ictReboot=ictReboot, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, histMetrGroupAddr=histMetrGroupAddr, performCpeReboot=performCpeReboot, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory)
