...
# Produced by pysmi-1.1.8 at Mon Feb  6 14:27:44 2023
...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ObjectIdentity, NotificationType, Counter32, Gauge32, Integer32, Unsigned32, Bits, iso, TimeTicks, ModuleIdentity, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ObjectIdentity", "NotificationType", "Counter32", "Gauge32", "Integer32", "Unsigned32", "Bits", "iso", "TimeTicks", "ModuleIdentity", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", curMetrStopTimestamp=curMetrStopTimestamp, histMetrTotalPackets=histMetrTotalPackets, upgUrl=upgUrl, histMetrMemberPorts=histMetrMemberPorts, curMetrStartTimestamp=curMetrStartTimestamp, catvModuleSignalDetected=catvModuleSignalDetected, histMetrSourceAddr=histMetrSourceAddr, histMetrAvgLostPps=histMetrAvgLostPps, catvModuleFilter=catvModuleFilter, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, ictReset=ictReset, catvModuleRflevel=catvModuleRflevel, transceiverDdmTxPower=transceiverDdmTxPower, IctDelta=IctDelta, ictIGW1k=ictIGW1k, histMetrMaxDelta=histMetrMaxDelta, icotera=icotera, histMetrPps=histMetrPps, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, ictCatv=ictCatv, catvModulePowerLevel=catvModulePowerLevel, transceiverLinkLength=transceiverLinkLength, histMetrTotalAvgDelta=histMetrTotalAvgDelta, transceiverDdmRxPower=transceiverDdmRxPower, histGroupAddr=histGroupAddr, PYSNMP_MODULE_ID=icotera, curMetrDstPort=curMetrDstPort, ictFacRst=ictFacRst, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, currentListEntry=currentListEntry, histMetrStreamType=histMetrStreamType, curMetrTotalAvgDelta=curMetrTotalAvgDelta, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, curMetrSourceAddr=curMetrSourceAddr, IctPortList=IctPortList, upgExecute=upgExecute, curMetrStreamType=curMetrStreamType, histMetrSkips=histMetrSkips, transceiverTransceiverType=transceiverTransceiverType, cfgExecute=cfgExecute, transceiverDiagCapable=transceiverDiagCapable, transceiverDdmVoltage=transceiverDdmVoltage, curMetrMemberPorts=curMetrMemberPorts, histMetrTotalReordered=histMetrTotalReordered, curMetrPps=curMetrPps, ictFacRstMib=ictFacRstMib, ictServicesMibs=ictServicesMibs, performCpeReboot=performCpeReboot, curMetrSrcPort=curMetrSrcPort, histMetrTotalMaxDelta=histMetrTotalMaxDelta, curMetrLost=curMetrLost, curMetrTotalLost=curMetrTotalLost, histMetrAvgKbps=histMetrAvgKbps, histMetrGroupAddr=histMetrGroupAddr, histMetrReordered=histMetrReordered, histMetrJitter=histMetrJitter, ictServices=ictServices, transceiverEthernetCompliance=transceiverEthernetCompliance, currentMetricsEntry=currentMetricsEntry, histMetrLost=histMetrLost, curGroupIndex=curGroupIndex, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, curMetrKbps=curMetrKbps, ictMgmt=ictMgmt, curMetrTotalBytes=curMetrTotalBytes, performFactoryReset=performFactoryReset, upgStatus=upgStatus, curMetrAvgKbps=curMetrAvgKbps, histMetrTotalSkips=histMetrTotalSkips, ictTransceiver=ictTransceiver, curMetrAvgPps=curMetrAvgPps, transceiverDdmTemperature=transceiverDdmTemperature, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, ictMcastAnalyzer=ictMcastAnalyzer, curMetrReordered=curMetrReordered, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, histMetrTotalBytes=histMetrTotalBytes, histMetrStopTimestamp=histMetrStopTimestamp, transceiverLaserWavelength=transceiverLaserWavelength, histMetrSrcPort=histMetrSrcPort, curMetrTotalMaxDelta=curMetrTotalMaxDelta, historyMetricsEntry=historyMetricsEntry, ictMgmtMib=ictMgmtMib, cfgTftpPath=cfgTftpPath, transceiverConnectorType=transceiverConnectorType, curMetrSkips=curMetrSkips, curMetrTotalReordered=curMetrTotalReordered, curMetrTotalPackets=curMetrTotalPackets, historyListEntry=historyListEntry, IctTimeStamp=IctTimeStamp, ictFwUpg=ictFwUpg, curMetrDiscontinuities=curMetrDiscontinuities, catvModuleAdminStatus=catvModuleAdminStatus, curMetrTotalSkips=curMetrTotalSkips, histGroupIndex=histGroupIndex, curGroupAddr=curGroupAddr, cfgStatus=cfgStatus, catvModuleLowSignal=catvModuleLowSignal, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, ictCfgUpdate=ictCfgUpdate, histMetrStartTimestamp=histMetrStartTimestamp, IctJitter=IctJitter, curMetrAvgLostPps=curMetrAvgLostPps, ictReboot=ictReboot, curMetrJitter=curMetrJitter, curMetrMaxDelta=curMetrMaxDelta, histMetrDiscontinuities=histMetrDiscontinuities, histMetrAvgPps=histMetrAvgPps, histMetrDstPort=histMetrDstPort, histMetrAvgDelta=histMetrAvgDelta, curMetrAvgDelta=curMetrAvgDelta, curMetrGroupAddr=curMetrGroupAddr, histMetrTotalLost=histMetrTotalLost, histMetrKbps=histMetrKbps)
