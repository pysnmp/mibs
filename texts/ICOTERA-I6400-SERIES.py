...
# Produced by pysmi-1.1.8 at Mon Jan 17 14:58:48 2022
...
ObjectIdentity, iso, Counter32, TimeTicks, Gauge32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, Bits, IpAddress, ModuleIdentity, Integer32, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "Counter32", "TimeTicks", "Gauge32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "Bits", "IpAddress", "ModuleIdentity", "Integer32", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", histMetrAvgDelta=histMetrAvgDelta, curGroupAddr=curGroupAddr, icotera=icotera, catvModuleSignalDetected=catvModuleSignalDetected, ictMgmtMib=ictMgmtMib, transceiverTransceiverType=transceiverTransceiverType, histMetrTotalMaxDelta=histMetrTotalMaxDelta, ictMgmt=ictMgmt, histMetrAvgKbps=histMetrAvgKbps, histMetrSkips=histMetrSkips, curMetrSourceAddr=curMetrSourceAddr, catvModulePowerLevel=catvModulePowerLevel, IctDelta=IctDelta, transceiverDiagCapable=transceiverDiagCapable, histMetrGroupAddr=histMetrGroupAddr, histMetrTotalAvgDelta=histMetrTotalAvgDelta, catvModuleFilter=catvModuleFilter, currentListEntry=currentListEntry, curMetrDstPort=curMetrDstPort, histMetrSourceAddr=histMetrSourceAddr, curMetrTotalMaxDelta=curMetrTotalMaxDelta, ictCfgUpdate=ictCfgUpdate, curMetrAvgPps=curMetrAvgPps, IctPortList=IctPortList, histMetrMemberPorts=histMetrMemberPorts, catvModuleRflevel=catvModuleRflevel, ictFwUpg=ictFwUpg, curMetrKbps=curMetrKbps, histMetrReordered=histMetrReordered, upgExecute=upgExecute, ictFacRst=ictFacRst, histMetrStreamType=histMetrStreamType, histMetrTotalPackets=histMetrTotalPackets, curMetrTotalBytes=curMetrTotalBytes, transceiverEthernetCompliance=transceiverEthernetCompliance, histMetrMaxDelta=histMetrMaxDelta, cfgTftpPath=cfgTftpPath, curMetrStartTimestamp=curMetrStartTimestamp, ictMcastAnalyzer=ictMcastAnalyzer, histMetrPps=histMetrPps, histMetrTotalSkips=histMetrTotalSkips, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, historyListEntry=historyListEntry, histMetrDstPort=histMetrDstPort, historyMetricsEntry=historyMetricsEntry, currentMetricsEntry=currentMetricsEntry, curMetrTotalAvgDelta=curMetrTotalAvgDelta, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, histMetrAvgLostPps=histMetrAvgLostPps, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, curMetrTotalReordered=curMetrTotalReordered, curMetrStreamType=curMetrStreamType, curMetrGroupAddr=curMetrGroupAddr, ictCatv=ictCatv, curMetrPps=curMetrPps, ictReboot=ictReboot, catvModuleAdminStatus=catvModuleAdminStatus, curMetrMemberPorts=curMetrMemberPorts, ictIGW1k=ictIGW1k, histMetrLost=histMetrLost, curMetrAvgDelta=curMetrAvgDelta, curMetrSkips=curMetrSkips, histMetrKbps=histMetrKbps, transceiverDdmRxPower=transceiverDdmRxPower, PYSNMP_MODULE_ID=icotera, curMetrMaxDelta=curMetrMaxDelta, catvModuleLowSignal=catvModuleLowSignal, curMetrStopTimestamp=curMetrStopTimestamp, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, curMetrTotalSkips=curMetrTotalSkips, ictServicesMibs=ictServicesMibs, histMetrDiscontinuities=histMetrDiscontinuities, curMetrDiscontinuities=curMetrDiscontinuities, curMetrTotalPackets=curMetrTotalPackets, performCpeReboot=performCpeReboot, IctJitter=IctJitter, histMetrSrcPort=histMetrSrcPort, ictTransceiver=ictTransceiver, curMetrSrcPort=curMetrSrcPort, curMetrLost=curMetrLost, curMetrTotalLost=curMetrTotalLost, histGroupIndex=histGroupIndex, performFactoryReset=performFactoryReset, ictReset=ictReset, histMetrAvgPps=histMetrAvgPps, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, ictFacRstMib=ictFacRstMib, histMetrStopTimestamp=histMetrStopTimestamp, curMetrAvgKbps=curMetrAvgKbps, histMetrTotalLost=histMetrTotalLost, transceiverDdmVoltage=transceiverDdmVoltage, ictServices=ictServices, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, histMetrJitter=histMetrJitter, transceiverLaserWavelength=transceiverLaserWavelength, transceiverLinkLength=transceiverLinkLength, curGroupIndex=curGroupIndex, histMetrTotalReordered=histMetrTotalReordered, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, transceiverDdmTxPower=transceiverDdmTxPower, histMetrStartTimestamp=histMetrStartTimestamp, histMetrTotalBytes=histMetrTotalBytes, IctTimeStamp=IctTimeStamp, upgUrl=upgUrl, cfgExecute=cfgExecute, curMetrReordered=curMetrReordered, histGroupAddr=histGroupAddr, curMetrJitter=curMetrJitter, upgStatus=upgStatus, transceiverConnectorType=transceiverConnectorType, transceiverDdmTemperature=transceiverDdmTemperature, curMetrAvgLostPps=curMetrAvgLostPps, cfgStatus=cfgStatus)
