...
# Produced by pysmi-1.1.8 at Mon Feb  6 15:02:21 2023
...
ObjectIdentity, Counter32, IpAddress, Gauge32, MibIdentifier, iso, ModuleIdentity, Unsigned32, Bits, NotificationType, Counter64, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "IpAddress", "Gauge32", "MibIdentifier", "iso", "ModuleIdentity", "Unsigned32", "Bits", "NotificationType", "Counter64", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", IctPortList=IctPortList, currentListEntry=currentListEntry, transceiverDdmTemperature=transceiverDdmTemperature, ictFacRst=ictFacRst, transceiverLaserWavelength=transceiverLaserWavelength, upgStatus=upgStatus, curMetrTotalMaxDelta=curMetrTotalMaxDelta, transceiverEthernetCompliance=transceiverEthernetCompliance, ictCatv=ictCatv, curMetrTotalBytes=curMetrTotalBytes, cfgExecute=cfgExecute, performCpeReboot=performCpeReboot, curMetrTotalReordered=curMetrTotalReordered, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, transceiverConnectorType=transceiverConnectorType, upgExecute=upgExecute, curMetrStartTimestamp=curMetrStartTimestamp, histMetrAvgPps=histMetrAvgPps, histMetrAvgKbps=histMetrAvgKbps, catvModuleRflevel=catvModuleRflevel, curMetrTotalPackets=curMetrTotalPackets, curGroupIndex=curGroupIndex, histMetrKbps=histMetrKbps, histMetrTotalAvgDelta=histMetrTotalAvgDelta, curMetrTotalAvgDelta=curMetrTotalAvgDelta, ictReset=ictReset, transceiverDdmTxPower=transceiverDdmTxPower, histMetrTotalLost=histMetrTotalLost, transceiverDdmVoltage=transceiverDdmVoltage, ictFacRstMib=ictFacRstMib, catvModuleSignalDetected=catvModuleSignalDetected, histGroupAddr=histGroupAddr, historyListEntry=historyListEntry, catvModuleLowSignal=catvModuleLowSignal, curMetrLost=curMetrLost, curMetrPps=curMetrPps, catvModulePowerLevel=catvModulePowerLevel, ictIGW1k=ictIGW1k, curMetrDiscontinuities=curMetrDiscontinuities, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, IctTimeStamp=IctTimeStamp, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, histMetrAvgDelta=histMetrAvgDelta, cfgTftpPath=cfgTftpPath, curMetrKbps=curMetrKbps, upgUrl=upgUrl, icotera=icotera, curMetrTotalSkips=curMetrTotalSkips, curMetrSkips=curMetrSkips, ictServicesMibs=ictServicesMibs, curMetrAvgDelta=curMetrAvgDelta, curMetrStreamType=curMetrStreamType, ictServices=ictServices, performFactoryReset=performFactoryReset, histMetrDstPort=histMetrDstPort, histMetrTotalPackets=histMetrTotalPackets, histMetrSkips=histMetrSkips, ictFwUpg=ictFwUpg, curMetrTotalLost=curMetrTotalLost, ictReboot=ictReboot, histMetrMaxDelta=histMetrMaxDelta, curMetrStopTimestamp=curMetrStopTimestamp, histMetrReordered=histMetrReordered, histMetrSrcPort=histMetrSrcPort, histMetrJitter=histMetrJitter, historyMetricsEntry=historyMetricsEntry, curMetrDstPort=curMetrDstPort, curMetrAvgKbps=curMetrAvgKbps, histMetrSourceAddr=histMetrSourceAddr, histMetrTotalMaxDelta=histMetrTotalMaxDelta, transceiverDdmRxPower=transceiverDdmRxPower, histMetrStartTimestamp=histMetrStartTimestamp, histMetrAvgLostPps=histMetrAvgLostPps, curMetrGroupAddr=curMetrGroupAddr, histMetrStopTimestamp=histMetrStopTimestamp, histMetrMemberPorts=histMetrMemberPorts, catvModuleAdminStatus=catvModuleAdminStatus, transceiverLinkLength=transceiverLinkLength, cfgStatus=cfgStatus, catvModuleFilter=catvModuleFilter, histMetrDiscontinuities=histMetrDiscontinuities, curMetrSrcPort=curMetrSrcPort, curMetrJitter=curMetrJitter, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, curMetrAvgPps=curMetrAvgPps, curMetrMaxDelta=curMetrMaxDelta, ictCfgUpdate=ictCfgUpdate, curMetrSourceAddr=curMetrSourceAddr, ictMgmtMib=ictMgmtMib, histMetrTotalSkips=histMetrTotalSkips, IctJitter=IctJitter, currentMetricsEntry=currentMetricsEntry, curGroupAddr=curGroupAddr, ictMcastAnalyzer=ictMcastAnalyzer, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrAvgLostPps=curMetrAvgLostPps, histMetrGroupAddr=histMetrGroupAddr, histMetrLost=histMetrLost, histMetrTotalBytes=histMetrTotalBytes, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, IctDelta=IctDelta, ictTransceiver=ictTransceiver, curMetrReordered=curMetrReordered, histMetrPps=histMetrPps, curMetrMemberPorts=curMetrMemberPorts, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, transceiverDiagCapable=transceiverDiagCapable, transceiverTransceiverType=transceiverTransceiverType, histMetrTotalReordered=histMetrTotalReordered, histGroupIndex=histGroupIndex, ictMgmt=ictMgmt, histMetrStreamType=histMetrStreamType, PYSNMP_MODULE_ID=icotera)
