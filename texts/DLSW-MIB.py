...
ModuleIdentity, Counter32, IpAddress, iso, TimeTicks, mib_2, NotificationType, Counter64, Gauge32, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "IpAddress", "iso", "TimeTicks", "mib-2", "NotificationType", "Counter64", "Gauge32", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "Integer32")
...
class DlswTCPAddress(TextualConvention, OctetString):
    description = 'Represents the IP address of a DLSw which uses\n             TCP as a transport protocol.'
    status = 'current'
...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirCache=dlswDirCache, dlswDirNBLocation=dlswDirNBLocation, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswIfEntry=dlswIfEntry, dlswDirNBGroup=dlswDirNBGroup, dlswTCPDomain=dlswTCPDomain, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperCirCreates=dlswTConnOperCirCreates, DlcType=DlcType, dlswDirectory=dlswDirectory, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswDirMacLFSize=dlswDirMacLFSize, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnStatGroup=dlswTConnStatGroup, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirLocateNBName=dlswDirLocateNBName, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswInterface=dlswInterface, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswSdlcLsTable=dlswSdlcLsTable, dlsw=dlsw, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswNotificationGroup=dlswNotificationGroup, null=null, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswNodeStatus=dlswNodeStatus, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperState=dlswTConnOperState, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswDirStat=dlswDirStat, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswNodeVersion=dlswNodeVersion, dlswTConnOperGroup=dlswTConnOperGroup, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswMIB=dlswMIB, EndStationLocation=EndStationLocation, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, NBName=NBName, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswNodeGroup=dlswNodeGroup, dlswCircuitState=dlswCircuitState, dlswTConnOperEntry=dlswTConnOperEntry, dlswSdlc=dlswSdlc, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCoreCompliance=dlswCoreCompliance, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswIfTable=dlswIfTable, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTrapCircuitDown=dlswTrapCircuitDown, LFSize=LFSize, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswNodeVendorID=dlswNodeVendorID, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirMacMask=dlswDirMacMask, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, DlswTCPAddress=DlswTCPAddress, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirMacLocationType=dlswDirMacLocationType, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswCircuitStateTime=dlswCircuitStateTime, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitPriority=dlswCircuitPriority, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCompliances=dlswCompliances, dlswTConnStat=dlswTConnStat, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTrapTConnDown=dlswTrapTConnDown, dlswSdlcCompliance=dlswSdlcCompliance, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswDirMacTable=dlswDirMacTable, dlswIfRowStatus=dlswIfRowStatus, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnSpecific=dlswTConnSpecific, dlswDirMacStatus=dlswDirMacStatus, dlswCircuitEntry=dlswCircuitEntry, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuit=dlswCircuit, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswCircuitTable=dlswCircuitTable, dlswDirNBTable=dlswDirNBTable, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnTcp=dlswTConnTcp, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswConformance=dlswConformance, dlswDirMacMac=dlswDirMacMac, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnNBGroup=dlswTConnNBGroup, dlswIfSapList=dlswIfSapList, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirNBEntries=dlswDirNBEntries, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswCircuitStat=dlswCircuitStat, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswDirCompliance=dlswDirCompliance, dlswNodeVersionString=dlswNodeVersionString, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirNBNameType=dlswDirNBNameType, dlswDirNBLocationType=dlswDirNBLocationType, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirNBName=dlswDirNBName, dlswCircuitOrigin=dlswCircuitOrigin, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirNBIndex=dlswDirNBIndex, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirMacIndex=dlswDirMacIndex, TAddress=TAddress, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswDirMacLocation=dlswDirMacLocation, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswSdlcGroup=dlswSdlcGroup, dlswDirLocateNBLocation=dlswDirLocateNBLocation, MacAddressNC=MacAddressNC, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswDirLocate=dlswDirLocate, PYSNMP_MODULE_ID=dlsw, dlswDirMacEntries=dlswDirMacEntries, dlswDirMacEntry=dlswDirMacEntry, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswInterfaceGroup=dlswInterfaceGroup, dlswNode=dlswNode, dlswGroups=dlswGroups, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirGroup=dlswDirGroup, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswDirNBEntry=dlswDirNBEntry, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswDomains=dlswDomains, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnOperTable=dlswTConnOperTable, dlswTraps=dlswTraps, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTrapControl=dlswTrapControl, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCircuitGroup=dlswCircuitGroup, dlswTConn=dlswTConn)
