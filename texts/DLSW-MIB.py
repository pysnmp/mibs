...
ObjectIdentity, mib_2, iso, TimeTicks, Gauge32, Counter64, IpAddress, ModuleIdentity, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "mib-2", "iso", "TimeTicks", "Gauge32", "Counter64", "IpAddress", "ModuleIdentity", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "Bits", "Counter32")
...
mibBuilder.exportSymbols("DLSW-MIB", dlswNodeUpTime=dlswNodeUpTime, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnConfigTable=dlswTConnConfigTable, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirLocate=dlswDirLocate, dlswCoreCompliance=dlswCoreCompliance, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, DlswTCPAddress=DlswTCPAddress, dlswDirMacTable=dlswDirMacTable, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswCircuit=dlswCircuit, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnOperTable=dlswTConnOperTable, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswSdlcGroup=dlswSdlcGroup, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirMacMac=dlswDirMacMac, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswDomains=dlswDomains, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswInterfaceGroup=dlswInterfaceGroup, dlswDirMacLocation=dlswDirMacLocation, dlswNode=dlswNode, dlswIfEntry=dlswIfEntry, dlswDirStat=dlswDirStat, MacAddressNC=MacAddressNC, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirGroup=dlswDirGroup, dlswIfTable=dlswIfTable, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswIfSapList=dlswIfSapList, dlswNodeStatus=dlswNodeStatus, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirNBNameType=dlswDirNBNameType, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitStateTime=dlswCircuitStateTime, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnSpecific=dlswTConnSpecific, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirLocateGroup=dlswDirLocateGroup, EndStationLocation=EndStationLocation, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, null=null, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswCircuitTable=dlswCircuitTable, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirMacIndex=dlswDirMacIndex, dlswCompliances=dlswCompliances, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswDirectory=dlswDirectory, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTrapTConnUp=dlswTrapTConnUp, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswDirMacEntries=dlswDirMacEntries, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswDirCache=dlswDirCache, dlswTrapTConnDown=dlswTrapTConnDown, NBName=NBName, dlswTConnStat=dlswTConnStat, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswNodeVendorID=dlswNodeVendorID, dlswDirMacMask=dlswDirMacMask, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, TAddress=TAddress, dlswDirLocateNBName=dlswDirLocateNBName, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswNodeVersionString=dlswNodeVersionString, dlswDirMacStatus=dlswDirMacStatus, dlswDirNBLFSize=dlswDirNBLFSize, dlswNotificationGroup=dlswNotificationGroup, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirNBLocation=dlswDirNBLocation, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTraps=dlswTraps, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConn=dlswTConn, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnOperState=dlswTConnOperState, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswGroups=dlswGroups, dlswDirNBIndex=dlswDirNBIndex, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, PYSNMP_MODULE_ID=dlsw, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnNBGroup=dlswTConnNBGroup, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnOperGroup=dlswTConnOperGroup, dlswConformance=dlswConformance, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswDirCompliance=dlswDirCompliance, dlswDirNBGroup=dlswDirNBGroup, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswMIB=dlswMIB, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirNBName=dlswDirNBName, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirNBEntries=dlswDirNBEntries, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, LFSize=LFSize, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswSdlcLsTable=dlswSdlcLsTable, dlswNodeGroup=dlswNodeGroup, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirNBEntry=dlswDirNBEntry, dlswTCPDomain=dlswTCPDomain, dlswCircuitPriority=dlswCircuitPriority, dlswCircuitStat=dlswCircuitStat, DlcType=DlcType, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswCircuitState=dlswCircuitState, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirMacEntry=dlswDirMacEntry, dlswTrapControl=dlswTrapControl, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswSdlc=dlswSdlc, dlswIfRowStatus=dlswIfRowStatus, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswInterface=dlswInterface, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitGroup=dlswCircuitGroup, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswNodeNBGroup=dlswNodeNBGroup, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswSdlcLsEntries=dlswSdlcLsEntries, dlsw=dlsw, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswDirNBTable=dlswDirNBTable, dlswTConnTcp=dlswTConnTcp, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswNodeVersion=dlswNodeVersion, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys)
