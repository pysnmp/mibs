...
Counter32, Gauge32, MibIdentifier, TimeTicks, iso, Counter64, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, Integer32, Unsigned32, mib_2, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "MibIdentifier", "TimeTicks", "iso", "Counter64", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "Integer32", "Unsigned32", "mib-2", "ModuleIdentity")
...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirStat=dlswDirStat, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswDirMacStatus=dlswDirMacStatus, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirMacEntries=dlswDirMacEntries, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswNodeVersion=dlswNodeVersion, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswNodeGroup=dlswNodeGroup, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, NBName=NBName, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTraps=dlswTraps, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperGroup=dlswTConnOperGroup, dlswDirCache=dlswDirCache, dlswCircuitStat=dlswCircuitStat, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswDirMacLocationType=dlswDirMacLocationType, dlswDirNBTable=dlswDirNBTable, dlswDirNBEntry=dlswDirNBEntry, dlswCoreCompliance=dlswCoreCompliance, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswConformance=dlswConformance, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswNodeUpTime=dlswNodeUpTime, dlswSdlcGroup=dlswSdlcGroup, dlswTrapTConnDown=dlswTrapTConnDown, dlswDirMacTable=dlswDirMacTable, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswDirNBNameType=dlswDirNBNameType, dlswTConnOperEntry=dlswTConnOperEntry, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswCompliances=dlswCompliances, null=null, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirLocateNBName=dlswDirLocateNBName, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswDirLocateMacTable=dlswDirLocateMacTable, TAddress=TAddress, dlswDirNBEntries=dlswDirNBEntries, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswIfRowStatus=dlswIfRowStatus, dlswTrapControl=dlswTrapControl, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswDirCompliance=dlswDirCompliance, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswInterface=dlswInterface, dlswTConn=dlswTConn, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswNode=dlswNode, dlswCircuitS2Location=dlswCircuitS2Location, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswDirGroup=dlswDirGroup, dlswDomains=dlswDomains, dlswInterfaceGroup=dlswInterfaceGroup, dlswDirLocateGroup=dlswDirLocateGroup, LFSize=LFSize, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswCircuitState=dlswCircuitState, dlswDirMacMac=dlswDirMacMac, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswNotificationGroup=dlswNotificationGroup, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirMacIndex=dlswDirMacIndex, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirLocate=dlswDirLocate, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnSpecific=dlswTConnSpecific, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswIfEntry=dlswIfEntry, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, EndStationLocation=EndStationLocation, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirNBLocationType=dlswDirNBLocationType, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnOperNRexSents=dlswTConnOperNRexSents, MacAddressNC=MacAddressNC, DlswTCPAddress=DlswTCPAddress, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswIfTable=dlswIfTable, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswNodeVendorID=dlswNodeVendorID, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnOperTable=dlswTConnOperTable, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnTcpOperTable=dlswTConnTcpOperTable, PYSNMP_MODULE_ID=dlsw, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirNBStatus=dlswDirNBStatus, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswDirMacEntryType=dlswDirMacEntryType, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirMacMask=dlswDirMacMask, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitTable=dlswCircuitTable, dlswCircuitStateTime=dlswCircuitStateTime, dlswIfSapList=dlswIfSapList, dlswDirNBIndex=dlswDirNBIndex, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswCircuitGroup=dlswCircuitGroup, dlswDirNBName=dlswDirNBName, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirNBLocation=dlswDirNBLocation, dlswCircuitPriority=dlswCircuitPriority, dlswGroups=dlswGroups, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, DlcType=DlcType, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnNBGroup=dlswTConnNBGroup, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnOperState=dlswTConnOperState, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswMIB=dlswMIB, dlswTCPDomain=dlswTCPDomain, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirMacEntry=dlswDirMacEntry, dlswTConnConfigTable=dlswTConnConfigTable, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnStat=dlswTConnStat, dlswDirMacLocation=dlswDirMacLocation, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnTcp=dlswTConnTcp, dlswCircuit=dlswCircuit, dlswDirectory=dlswDirectory, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswCircuitOrigin=dlswCircuitOrigin, dlsw=dlsw, dlswDirNBGroup=dlswDirNBGroup, dlswSdlc=dlswSdlc, dlswNodeStatus=dlswNodeStatus, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswNodeVersionString=dlswNodeVersionString, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation)
