...
ModuleIdentity, iso, IpAddress, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Counter32, Bits, ObjectIdentity, Unsigned32, MibIdentifier, Integer32, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "IpAddress", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Counter32", "Bits", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Integer32", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConn=dlswTConn, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCoreCompliance=dlswCoreCompliance, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, MacAddressNC=MacAddressNC, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirMacLocation=dlswDirMacLocation, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswDirNBName=dlswDirNBName, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswIfEntry=dlswIfEntry, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuitStatActives=dlswCircuitStatActives, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswInterface=dlswInterface, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswMIB=dlswMIB, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCircuitGroup=dlswCircuitGroup, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswDirNBEntry=dlswDirNBEntry, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswDirNBCacheMisses=dlswDirNBCacheMisses, PYSNMP_MODULE_ID=dlsw, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTrapControl=dlswTrapControl, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirNBLocationType=dlswDirNBLocationType, dlswNotificationGroup=dlswNotificationGroup, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, NBName=NBName, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirMacEntry=dlswDirMacEntry, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirMacTable=dlswDirMacTable, dlswNode=dlswNode, dlswCircuitStateTime=dlswCircuitStateTime, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirNBCacheHits=dlswDirNBCacheHits, LFSize=LFSize, dlswCircuitState=dlswCircuitState, dlswTConnOperGroup=dlswTConnOperGroup, TAddress=TAddress, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlsw=dlsw, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, null=null, dlswNodeStatus=dlswNodeStatus, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCircuitPriority=dlswCircuitPriority, dlswDirMacIndex=dlswDirMacIndex, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirNBNameType=dlswDirNBNameType, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswDirCompliance=dlswDirCompliance, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswSdlc=dlswSdlc, EndStationLocation=EndStationLocation, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirLocate=dlswDirLocate, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirectory=dlswDirectory, dlswNodeUpTime=dlswNodeUpTime, dlswDirMacLocationType=dlswDirMacLocationType, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnOperState=dlswTConnOperState, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, DlcType=DlcType, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnOperTable=dlswTConnOperTable, dlswDirNBGroup=dlswDirNBGroup, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswDirGroup=dlswDirGroup, dlswDirNBTable=dlswDirNBTable, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitStat=dlswCircuitStat, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTrapTConnDown=dlswTrapTConnDown, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCircuitTable=dlswCircuitTable, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswCircuit=dlswCircuit, dlswTConnStatGroup=dlswTConnStatGroup, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswCompliances=dlswCompliances, dlswIfSapList=dlswIfSapList, dlswDirMacEntryType=dlswDirMacEntryType, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTCPDomain=dlswTCPDomain, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirMacStatus=dlswDirMacStatus, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswDomains=dlswDomains, dlswGroups=dlswGroups, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnNBGroup=dlswTConnNBGroup, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTraps=dlswTraps, DlswTCPAddress=DlswTCPAddress, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnTcp=dlswTConnTcp, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswNodeVersion=dlswNodeVersion, dlswTConnStat=dlswTConnStat, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswNodeGroup=dlswNodeGroup, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirStat=dlswDirStat, dlswNodeVersionString=dlswNodeVersionString, dlswIfTable=dlswIfTable, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswNodeVendorID=dlswNodeVendorID, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswIfRowStatus=dlswIfRowStatus, dlswDirMacEntries=dlswDirMacEntries, dlswDirCache=dlswDirCache, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswSdlcGroup=dlswSdlcGroup, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswDirNBEntries=dlswDirNBEntries, dlswDirMacMask=dlswDirMacMask, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswDirNBLocation=dlswDirNBLocation, dlswDirMacMac=dlswDirMacMac, dlswTConnSpecific=dlswTConnSpecific, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswConformance=dlswConformance, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl)
