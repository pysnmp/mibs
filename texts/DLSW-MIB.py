...
mibBuilder.exportSymbols("DLSW-MIB", dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, PYSNMP_MODULE_ID=dlsw, dlswTCPDomain=dlswTCPDomain, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirNBEntries=dlswDirNBEntries, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswDirectory=dlswDirectory, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswNodeVersion=dlswNodeVersion, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirMacMac=dlswDirMacMac, dlswConformance=dlswConformance, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirMacIndex=dlswDirMacIndex, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDirGroup=dlswDirGroup, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswDirNBStatus=dlswDirNBStatus, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswGroups=dlswGroups, dlswDirLocateGroup=dlswDirLocateGroup, dlswInterface=dlswInterface, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswCoreCompliance=dlswCoreCompliance, dlswDirNBName=dlswDirNBName, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirMacLocation=dlswDirMacLocation, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnStatGroup=dlswTConnStatGroup, dlswDirCompliance=dlswDirCompliance, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnConfigTable=dlswTConnConfigTable, LFSize=LFSize, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTrapControl=dlswTrapControl, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswNodeUpTime=dlswNodeUpTime, dlswSdlc=dlswSdlc, dlswDirStat=dlswDirStat, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirNBNameType=dlswDirNBNameType, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswIfEntry=dlswIfEntry, dlswNodeGroup=dlswNodeGroup, MacAddressNC=MacAddressNC, dlsw=dlsw, DlcType=DlcType, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirNBEntry=dlswDirNBEntry, dlswDirMacMask=dlswDirMacMask, dlswDirNBLocationType=dlswDirNBLocationType, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswCircuitOrigin=dlswCircuitOrigin, dlswIfSapList=dlswIfSapList, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswNodeStatus=dlswNodeStatus, dlswDirNBTable=dlswDirNBTable, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirLocateNBName=dlswDirLocateNBName, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswNotificationGroup=dlswNotificationGroup, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswMIB=dlswMIB, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirNBGroup=dlswDirNBGroup, dlswDirNBLocation=dlswDirNBLocation, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCircuitTable=dlswCircuitTable, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnTcp=dlswTConnTcp, dlswTConnSpecific=dlswTConnSpecific, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnOperGroup=dlswTConnOperGroup, dlswIfTable=dlswIfTable, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswDirMacLocationType=dlswDirMacLocationType, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnStat=dlswTConnStat, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirMacStatus=dlswDirMacStatus, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirMacEntries=dlswDirMacEntries, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswCompliances=dlswCompliances, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswCircuitPriority=dlswCircuitPriority, dlswTConnOperState=dlswTConnOperState, dlswNodeVendorID=dlswNodeVendorID, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswNode=dlswNode, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswIfRowStatus=dlswIfRowStatus, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswCircuitState=dlswCircuitState, dlswCircuit=dlswCircuit, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCircuitGroup=dlswCircuitGroup, dlswDirMacTable=dlswDirMacTable, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirLocate=dlswDirLocate, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswSdlcLsTable=dlswSdlcLsTable, dlswSdlcGroup=dlswSdlcGroup, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirMacEntryType=dlswDirMacEntryType, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswCircuitStat=dlswCircuitStat, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, NBName=NBName, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConn=dlswTConn, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTraps=dlswTraps, TAddress=TAddress, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, null=null, DlswTCPAddress=DlswTCPAddress, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswDirMacEntry=dlswDirMacEntry, dlswDirCache=dlswDirCache, dlswTConnNBGroup=dlswTConnNBGroup, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, EndStationLocation=EndStationLocation, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperTable=dlswTConnOperTable, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswDomains=dlswDomains, dlswTrapCircuitDown=dlswTrapCircuitDown)
