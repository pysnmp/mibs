...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConn=dlswTConn, dlswDirMacTable=dlswDirMacTable, dlswDirMacIndex=dlswDirMacIndex, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswConformance=dlswConformance, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirCompliance=dlswDirCompliance, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswSdlcGroup=dlswSdlcGroup, dlswTConnSpecific=dlswTConnSpecific, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuit=dlswCircuit, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswCircuitState=dlswCircuitState, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnNBGroup=dlswTConnNBGroup, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswCircuitS2Location=dlswCircuitS2Location, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswInterfaceGroup=dlswInterfaceGroup, dlswCircuitOrigin=dlswCircuitOrigin, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswIfRowStatus=dlswIfRowStatus, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswCircuitStateTime=dlswCircuitStateTime, dlswIfSapList=dlswIfSapList, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnStatGroup=dlswTConnStatGroup, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswSdlcCompliance=dlswSdlcCompliance, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnStat=dlswTConnStat, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlsw=dlsw, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswIfTable=dlswIfTable, DlcType=DlcType, dlswDirNBEntryType=dlswDirNBEntryType, PYSNMP_MODULE_ID=dlsw, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, DlswTCPAddress=DlswTCPAddress, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswDirNBEntry=dlswDirNBEntry, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, TAddress=TAddress, dlswDirNBLocation=dlswDirNBLocation, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswMIB=dlswMIB, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTrapTConnUp=dlswTrapTConnUp, dlswTCPDomain=dlswTCPDomain, dlswDirCache=dlswDirCache, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswNode=dlswNode, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswDirNBStatus=dlswDirNBStatus, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswDirGroup=dlswDirGroup, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswCoreCompliance=dlswCoreCompliance, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirMacLocationType=dlswDirMacLocationType, dlswDomains=dlswDomains, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswDirNBEntries=dlswDirNBEntries, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitTable=dlswCircuitTable, dlswNodeVendorID=dlswNodeVendorID, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswNodeUpTime=dlswNodeUpTime, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswDirLocate=dlswDirLocate, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswInterface=dlswInterface, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirMacStatus=dlswDirMacStatus, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswDirMacEntries=dlswDirMacEntries, dlswDirMacMac=dlswDirMacMac, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirLocateGroup=dlswDirLocateGroup, MacAddressNC=MacAddressNC, dlswTraps=dlswTraps, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswCircuitPriority=dlswCircuitPriority, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswSdlcLsTable=dlswSdlcLsTable, dlswGroups=dlswGroups, dlswDirectory=dlswDirectory, dlswTConnConfigTable=dlswTConnConfigTable, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswNodeVersion=dlswNodeVersion, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswDirNBIndex=dlswDirNBIndex, dlswTConnOperTable=dlswTConnOperTable, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswIfEntry=dlswIfEntry, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswDirMacEntry=dlswDirMacEntry, dlswSdlc=dlswSdlc, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirMacMask=dlswDirMacMask, dlswDirNBGroup=dlswDirNBGroup, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnOperState=dlswTConnOperState, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, EndStationLocation=EndStationLocation, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswDirNBNameType=dlswDirNBNameType, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswNodeGroup=dlswNodeGroup, LFSize=LFSize, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswCircuitStat=dlswCircuitStat, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitGroup=dlswCircuitGroup, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTrapCntlTConn=dlswTrapCntlTConn, null=null, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCompliances=dlswCompliances, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnTcp=dlswTConnTcp, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswSdlcLsEntry=dlswSdlcLsEntry, NBName=NBName, dlswTrapControl=dlswTrapControl, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswNotificationGroup=dlswNotificationGroup, dlswDirNBTable=dlswDirNBTable, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirNBName=dlswDirNBName, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswNodeStatus=dlswNodeStatus, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirStat=dlswDirStat, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirMacLocation=dlswDirMacLocation, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles)
