...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirNBGroup=dlswDirNBGroup, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnTcp=dlswTConnTcp, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, DlcType=DlcType, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnSpecific=dlswTConnSpecific, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswGroups=dlswGroups, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswCircuitOrigin=dlswCircuitOrigin, dlswConformance=dlswConformance, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswNodeVendorID=dlswNodeVendorID, dlswDirNBLocationType=dlswDirNBLocationType, dlswTrapTConnDown=dlswTrapTConnDown, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTrapControl=dlswTrapControl, null=null, dlswSdlcGroup=dlswSdlcGroup, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswSdlc=dlswSdlc, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirNBNameType=dlswDirNBNameType, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirNBEntry=dlswDirNBEntry, dlswDirNBIndex=dlswDirNBIndex, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswNodeVersion=dlswNodeVersion, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirMacStatus=dlswDirMacStatus, dlswDomains=dlswDomains, dlswDirCache=dlswDirCache, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirNBName=dlswDirNBName, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswDirMacMac=dlswDirMacMac, dlswNode=dlswNode, dlswTConnStat=dlswTConnStat, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitStat=dlswCircuitStat, LFSize=LFSize, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirNBLocation=dlswDirNBLocation, dlswDirLocateGroup=dlswDirLocateGroup, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswCircuitState=dlswCircuitState, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnOperTable=dlswTConnOperTable, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnOperState=dlswTConnOperState, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTraps=dlswTraps, dlswNodeNBGroup=dlswNodeNBGroup, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswNodeVersionString=dlswNodeVersionString, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirectory=dlswDirectory, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswInterface=dlswInterface, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirMacEntry=dlswDirMacEntry, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswCircuitGroup=dlswCircuitGroup, MacAddressNC=MacAddressNC, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnOperGroup=dlswTConnOperGroup, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTCPDomain=dlswTCPDomain, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswDirMacLocation=dlswDirMacLocation, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswIfEntry=dlswIfEntry, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswIfSapList=dlswIfSapList, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswDirNBEntries=dlswDirNBEntries, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswCircuitS2Location=dlswCircuitS2Location, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswNodeGroup=dlswNodeGroup, dlswIfTable=dlswIfTable, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, PYSNMP_MODULE_ID=dlsw, dlswCircuitTable=dlswCircuitTable, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnConfigOpens=dlswTConnConfigOpens, NBName=NBName, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperEntry=dlswTConnOperEntry, TAddress=TAddress, dlswNodeStatus=dlswNodeStatus, DlswTCPAddress=DlswTCPAddress, dlswDirMacEntries=dlswDirMacEntries, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswDirStat=dlswDirStat, dlswDirCompliance=dlswDirCompliance, dlswTConnStatGroup=dlswTConnStatGroup, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswCoreCompliance=dlswCoreCompliance, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswMIB=dlswMIB, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirGroup=dlswDirGroup, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuit=dlswCircuit, dlswIfRowStatus=dlswIfRowStatus, dlswDirMacTable=dlswDirMacTable, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswCircuitPriority=dlswCircuitPriority, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswSdlcCompliance=dlswSdlcCompliance, dlsw=dlsw, dlswSdlcLsTable=dlswSdlcLsTable, dlswDirNBTable=dlswDirNBTable, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswCompliances=dlswCompliances, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswNotificationGroup=dlswNotificationGroup, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswDirLocate=dlswDirLocate, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswCircuitStateTime=dlswCircuitStateTime, dlswDirMacIndex=dlswDirMacIndex, dlswTConnConfigSapList=dlswTConnConfigSapList, EndStationLocation=EndStationLocation, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConn=dlswTConn, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitEntry=dlswCircuitEntry, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswDirMacMask=dlswDirMacMask)
