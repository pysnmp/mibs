...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswSdlcLsTable=dlswSdlcLsTable, dlswNotificationGroup=dlswNotificationGroup, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnStat=dlswTConnStat, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlsw=dlsw, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirLocateNBName=dlswDirLocateNBName, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, DlcType=DlcType, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswDirLocateNBGroup=dlswDirLocateNBGroup, EndStationLocation=EndStationLocation, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswGroups=dlswGroups, dlswDirLocate=dlswDirLocate, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswDirNBEntryType=dlswDirNBEntryType, dlswSdlcCompliance=dlswSdlcCompliance, dlswNodeGroup=dlswNodeGroup, PYSNMP_MODULE_ID=dlsw, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirMacTable=dlswDirMacTable, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDomains=dlswDomains, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswCircuitState=dlswCircuitState, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswCircuitStat=dlswCircuitStat, dlswDirLocateMacLocation=dlswDirLocateMacLocation, null=null, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCompliances=dlswCompliances, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswDirCompliance=dlswDirCompliance, dlswCoreCompliance=dlswCoreCompliance, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswDirMacEntries=dlswDirMacEntries, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswIfRowStatus=dlswIfRowStatus, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirMacMask=dlswDirMacMask, dlswNodeUpTime=dlswNodeUpTime, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirMacLocation=dlswDirMacLocation, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswIfTable=dlswIfTable, dlswDirNBName=dlswDirNBName, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnSpecific=dlswTConnSpecific, dlswTConnTcp=dlswTConnTcp, dlswTConnStatGroup=dlswTConnStatGroup, dlswCircuitTable=dlswCircuitTable, dlswIfEntry=dlswIfEntry, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswNode=dlswNode, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswCircuitS1Dlc=dlswCircuitS1Dlc, MacAddressNC=MacAddressNC, dlswTrapTConnDown=dlswTrapTConnDown, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCircuit=dlswCircuit, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirNBLocation=dlswDirNBLocation, dlswIfSapList=dlswIfSapList, dlswDirNBEntries=dlswDirNBEntries, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswConformance=dlswConformance, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswCircuitEntry=dlswCircuitEntry, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnOperState=dlswTConnOperState, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswInterfaceGroup=dlswInterfaceGroup, dlswCircuitPriority=dlswCircuitPriority, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirNBTable=dlswDirNBTable, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirNBLocationType=dlswDirNBLocationType, dlswMIB=dlswMIB, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirMacEntry=dlswDirMacEntry, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperGroup=dlswTConnOperGroup, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConn=dlswTConn, dlswDirMacIndex=dlswDirMacIndex, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirMacMac=dlswDirMacMac, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTrapControl=dlswTrapControl, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnNBGroup=dlswTConnNBGroup, dlswSdlcGroup=dlswSdlcGroup, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswNodeStatus=dlswNodeStatus, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswInterface=dlswInterface, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswDirectory=dlswDirectory, dlswDirNBIndex=dlswDirNBIndex, dlswNodeVersion=dlswNodeVersion, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirMacStatus=dlswDirMacStatus, dlswSdlc=dlswSdlc, dlswNodeNBGroup=dlswNodeNBGroup, dlswTCPDomain=dlswTCPDomain, DlswTCPAddress=DlswTCPAddress, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitGroup=dlswCircuitGroup, TAddress=TAddress, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCircuitOrigin=dlswCircuitOrigin, LFSize=LFSize, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirStat=dlswDirStat, NBName=NBName, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirNBEntry=dlswDirNBEntry, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirGroup=dlswDirGroup, dlswTraps=dlswTraps, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswDirNBNameType=dlswDirNBNameType, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswNodeVendorID=dlswNodeVendorID, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswDirNBGroup=dlswDirNBGroup, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnOperTable=dlswTConnOperTable, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswDirLocateGroup=dlswDirLocateGroup, dlswDirCache=dlswDirCache, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuitS2Location=dlswCircuitS2Location)
