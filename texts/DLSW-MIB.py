...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswDirNBEntryType=dlswDirNBEntryType, dlswMIB=dlswMIB, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswDirNBLocationType=dlswDirNBLocationType, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswDirMacEntry=dlswDirMacEntry, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnOperConnectTime=dlswTConnOperConnectTime, NBName=NBName, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswDirCompliance=dlswDirCompliance, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswIfVirtualSegment=dlswIfVirtualSegment, EndStationLocation=EndStationLocation, dlswTConnOperTable=dlswTConnOperTable, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitStat=dlswCircuitStat, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswCoreCompliance=dlswCoreCompliance, dlswDirMacLocationType=dlswDirMacLocationType, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnConfigTable=dlswTConnConfigTable, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitGroup=dlswCircuitGroup, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnOperEntry=dlswTConnOperEntry, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswNodeGroup=dlswNodeGroup, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswDirNBGroup=dlswDirNBGroup, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswGroups=dlswGroups, dlswDirLocateNBName=dlswDirLocateNBName, MacAddressNC=MacAddressNC, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCircuitPriority=dlswCircuitPriority, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswCircuitTable=dlswCircuitTable, TAddress=TAddress, dlswTrapTConnUp=dlswTrapTConnUp, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswNode=dlswNode, dlswTraps=dlswTraps, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswIfEntry=dlswIfEntry, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswDirLocate=dlswDirLocate, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitState=dlswCircuitState, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswSdlcGroup=dlswSdlcGroup, dlswDirMacStatus=dlswDirMacStatus, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnNBGroup=dlswTConnNBGroup, dlswDirNBNameType=dlswDirNBNameType, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswCircuitEntry=dlswCircuitEntry, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTCPDomain=dlswTCPDomain, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswNodeStatus=dlswNodeStatus, dlswTConnConfigGroup=dlswTConnConfigGroup, dlsw=dlsw, dlswCircuit=dlswCircuit, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswDirMacIndex=dlswDirMacIndex, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, null=null, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperState=dlswTConnOperState, dlswInterfaceGroup=dlswInterfaceGroup, dlswNodeVendorID=dlswNodeVendorID, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswDirMacMask=dlswDirMacMask, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTrapTConnDown=dlswTrapTConnDown, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirStat=dlswDirStat, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswDomains=dlswDomains, dlswSdlc=dlswSdlc, dlswNodeVersion=dlswNodeVersion, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswInterface=dlswInterface, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswSdlcLsTable=dlswSdlcLsTable, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswDirGroup=dlswDirGroup, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, DlcType=DlcType, dlswDirMacEntries=dlswDirMacEntries, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswSdlcCompliance=dlswSdlcCompliance, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperDiscTime=dlswTConnOperDiscTime, PYSNMP_MODULE_ID=dlsw, dlswIfSapList=dlswIfSapList, dlswTConnStatGroup=dlswTConnStatGroup, dlswIfRowStatus=dlswIfRowStatus, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConn=dlswTConn, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirCache=dlswDirCache, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnTcp=dlswTConnTcp, dlswDirNBIndex=dlswDirNBIndex, dlswDirNBLocation=dlswDirNBLocation, dlswDirNBName=dlswDirNBName, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirNBEntries=dlswDirNBEntries, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswIfTable=dlswIfTable, dlswDirNBTable=dlswDirNBTable, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswCompliances=dlswCompliances, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswNotificationGroup=dlswNotificationGroup, dlswDirMacLFSize=dlswDirMacLFSize, dlswDirNBLFSize=dlswDirNBLFSize, dlswTrapControl=dlswTrapControl, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswNodeVersionString=dlswNodeVersionString, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswDirMacTable=dlswDirMacTable, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswDirectory=dlswDirectory, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswDirMacCacheHits=dlswDirMacCacheHits, LFSize=LFSize, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirMacMac=dlswDirMacMac, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnSpecific=dlswTConnSpecific, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirMacLocation=dlswDirMacLocation, dlswCircuitOrigin=dlswCircuitOrigin, dlswConformance=dlswConformance, dlswDirLocateGroup=dlswDirLocateGroup, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, DlswTCPAddress=DlswTCPAddress, dlswTConnStat=dlswTConnStat)
