...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnOperICRexSents=dlswTConnOperICRexSents, LFSize=LFSize, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswIfSapList=dlswIfSapList, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswDirNBGroup=dlswDirNBGroup, dlswTConnSpecific=dlswTConnSpecific, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirMacMac=dlswDirMacMac, dlswDirectory=dlswDirectory, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswDirNBName=dlswDirNBName, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswInterface=dlswInterface, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTrapTConnUp=dlswTrapTConnUp, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnNBGroup=dlswTConnNBGroup, null=null, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswCircuit=dlswCircuit, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswNode=dlswNode, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirNBNameType=dlswDirNBNameType, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConn=dlswTConn, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTrapControl=dlswTrapControl, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDirNBEntry=dlswDirNBEntry, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnConfigTable=dlswTConnConfigTable, dlswCircuitStatActives=dlswCircuitStatActives, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, NBName=NBName, DlcType=DlcType, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnOperState=dlswTConnOperState, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirMacMask=dlswDirMacMask, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirNBCacheHits=dlswDirNBCacheHits, PYSNMP_MODULE_ID=dlsw, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirMacLFSize=dlswDirMacLFSize, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswDirMacEntry=dlswDirMacEntry, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnTcp=dlswTConnTcp, dlswDirNBLocationType=dlswDirNBLocationType, dlswSdlc=dlswSdlc, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswCircuitGroup=dlswCircuitGroup, dlswTConnConfigOpens=dlswTConnConfigOpens, MacAddressNC=MacAddressNC, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswDirMacTable=dlswDirMacTable, dlswDirNBIndex=dlswDirNBIndex, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCoreCompliance=dlswCoreCompliance, dlswNodeNBGroup=dlswNodeNBGroup, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnOperTable=dlswTConnOperTable, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswDirStat=dlswDirStat, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswCircuitPriority=dlswCircuitPriority, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirLocate=dlswDirLocate, dlswSdlcCompliance=dlswSdlcCompliance, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTCPDomain=dlswTCPDomain, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswCircuitStat=dlswCircuitStat, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswInterfaceGroup=dlswInterfaceGroup, dlswMIB=dlswMIB, EndStationLocation=EndStationLocation, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirMacLocationType=dlswDirMacLocationType, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswNodeVersion=dlswNodeVersion, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswIfRowStatus=dlswIfRowStatus, dlswDirMacStatus=dlswDirMacStatus, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswCircuitTable=dlswCircuitTable, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswNodeVersionString=dlswNodeVersionString, dlswDirNBTable=dlswDirNBTable, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlsw=dlsw, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswNodeStatus=dlswNodeStatus, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirNBLocation=dlswDirNBLocation, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswConformance=dlswConformance, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirNBEntries=dlswDirNBEntries, TAddress=TAddress, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswCircuitState=dlswCircuitState, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswCircuitS2Location=dlswCircuitS2Location, dlswNodeGroup=dlswNodeGroup, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswCircuitEntry=dlswCircuitEntry, dlswDirMacLocation=dlswDirMacLocation, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswGroups=dlswGroups, dlswTraps=dlswTraps, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnStat=dlswTConnStat, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswNotificationGroup=dlswNotificationGroup, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswNodeVendorID=dlswNodeVendorID, dlswIfTable=dlswIfTable, dlswDirGroup=dlswDirGroup, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswCompliances=dlswCompliances, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswDirCache=dlswDirCache, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswDirNBLFSize=dlswDirNBLFSize, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswDirMacEntries=dlswDirMacEntries, dlswCircuitStateTime=dlswCircuitStateTime, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswDomains=dlswDomains, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswDirMacIndex=dlswDirMacIndex, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswSdlcGroup=dlswSdlcGroup, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirNBStatus=dlswDirNBStatus, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswIfEntry=dlswIfEntry, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTrapTConnDown=dlswTrapTConnDown, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswDirCompliance=dlswDirCompliance, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, DlswTCPAddress=DlswTCPAddress, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits)
