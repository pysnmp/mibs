...
mibBuilder.exportSymbols("DLSW-MIB", dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswNotificationGroup=dlswNotificationGroup, dlswSdlcCompliance=dlswSdlcCompliance, dlswCircuitEntry=dlswCircuitEntry, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswIfTable=dlswIfTable, dlswIfRowStatus=dlswIfRowStatus, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswNode=dlswNode, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirNBLocation=dlswDirNBLocation, DlswTCPAddress=DlswTCPAddress, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswCoreCompliance=dlswCoreCompliance, dlswTConnOperState=dlswTConnOperState, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswCompliances=dlswCompliances, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnStat=dlswTConnStat, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirNBEntries=dlswDirNBEntries, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirGroup=dlswDirGroup, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswNodeVersionString=dlswNodeVersionString, dlswCircuitState=dlswCircuitState, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, MacAddressNC=MacAddressNC, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirMacMac=dlswDirMacMac, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswNodeVersion=dlswNodeVersion, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswNodeGroup=dlswNodeGroup, dlswTConnOperGroup=dlswTConnOperGroup, dlswDirMacMask=dlswDirMacMask, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswDomains=dlswDomains, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirMacEntry=dlswDirMacEntry, dlswDirMacLocation=dlswDirMacLocation, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswNodeStatus=dlswNodeStatus, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, DlcType=DlcType, dlswDirMacEntries=dlswDirMacEntries, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirMacIndex=dlswDirMacIndex, dlswCircuit=dlswCircuit, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirLocate=dlswDirLocate, dlswTraps=dlswTraps, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswIfEntry=dlswIfEntry, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTrapControl=dlswTrapControl, dlswCircuitGroup=dlswCircuitGroup, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswInterface=dlswInterface, dlswCircuitPriority=dlswCircuitPriority, PYSNMP_MODULE_ID=dlsw, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswSdlcGroup=dlswSdlcGroup, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirNBLocationType=dlswDirNBLocationType, dlswInterfaceGroup=dlswInterfaceGroup, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnSpecific=dlswTConnSpecific, dlswDirStat=dlswDirStat, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, TAddress=TAddress, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConn=dlswTConn, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswDirMacStatus=dlswDirMacStatus, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, null=null, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlsw=dlsw, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitStat=dlswCircuitStat, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswNodeUpTime=dlswNodeUpTime, NBName=NBName, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirCache=dlswDirCache, dlswCircuitTable=dlswCircuitTable, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswDirCompliance=dlswDirCompliance, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswGroups=dlswGroups, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnOperTable=dlswTConnOperTable, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswDirectory=dlswDirectory, dlswNodeNBGroup=dlswNodeNBGroup, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnTcp=dlswTConnTcp, LFSize=LFSize, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswSdlc=dlswSdlc, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTCPDomain=dlswTCPDomain, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTrapTConnUp=dlswTrapTConnUp, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswSdlcLsTable=dlswSdlcLsTable, dlswMIB=dlswMIB, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirNBTable=dlswDirNBTable, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirMacTable=dlswDirMacTable, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirNBName=dlswDirNBName, EndStationLocation=EndStationLocation, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswConformance=dlswConformance, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswNodeVendorID=dlswNodeVendorID, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirNBGroup=dlswDirNBGroup, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswDirNBNameType=dlswDirNBNameType, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswIfSapList=dlswIfSapList, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswCircuitS1Mac=dlswCircuitS1Mac)
