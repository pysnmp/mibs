...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswCircuitS2Location=dlswCircuitS2Location, PYSNMP_MODULE_ID=dlsw, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirStat=dlswDirStat, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnStatGroup=dlswTConnStatGroup, dlswDirGroup=dlswDirGroup, dlswDirNBName=dlswDirNBName, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnTcp=dlswTConnTcp, dlswDirNBEntryType=dlswDirNBEntryType, dlswCircuitState=dlswCircuitState, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswIfSapList=dlswIfSapList, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirNBEntries=dlswDirNBEntries, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirLocate=dlswDirLocate, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitS1Mac=dlswCircuitS1Mac, TAddress=TAddress, dlswTConnOperCirCreates=dlswTConnOperCirCreates, DlcType=DlcType, dlswTConnStat=dlswTConnStat, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswCircuitEntry=dlswCircuitEntry, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswDirNBNameType=dlswDirNBNameType, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswNodeStatus=dlswNodeStatus, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirNBGroup=dlswDirNBGroup, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswDirNBEntry=dlswDirNBEntry, dlswDirNBIndex=dlswDirNBIndex, dlswSdlcGroup=dlswSdlcGroup, dlswCompliances=dlswCompliances, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswCircuitPriority=dlswCircuitPriority, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswInterface=dlswInterface, dlswDirectory=dlswDirectory, dlswSdlc=dlswSdlc, dlswNodeVersion=dlswNodeVersion, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTrapTConnUp=dlswTrapTConnUp, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnOperTable=dlswTConnOperTable, dlswDirMacEntries=dlswDirMacEntries, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, DlswTCPAddress=DlswTCPAddress, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswNode=dlswNode, dlswDirNBTable=dlswDirNBTable, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDirNBStatus=dlswDirNBStatus, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswCoreCompliance=dlswCoreCompliance, dlswTConnSpecific=dlswTConnSpecific, dlswDirMacMask=dlswDirMacMask, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTCPDomain=dlswTCPDomain, dlswTConnOperState=dlswTConnOperState, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswConformance=dlswConformance, dlswTraps=dlswTraps, dlswDirMacLFSize=dlswDirMacLFSize, dlswDirCompliance=dlswDirCompliance, dlswTConn=dlswTConn, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDirLocateMacLocation=dlswDirLocateMacLocation, null=null, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirLocateNBName=dlswDirLocateNBName, dlswIfEntry=dlswIfEntry, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirMacMac=dlswDirMacMac, dlswTrapTConnDown=dlswTrapTConnDown, dlswNodeUpTime=dlswNodeUpTime, dlswCircuitStat=dlswCircuitStat, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswNodeGroup=dlswNodeGroup, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlsw=dlsw, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswGroups=dlswGroups, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnOperEntry=dlswTConnOperEntry, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, NBName=NBName, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswCircuit=dlswCircuit, dlswCircuitTable=dlswCircuitTable, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCircuitGroup=dlswCircuitGroup, dlswIfTable=dlswIfTable, dlswSdlcCompliance=dlswSdlcCompliance, dlswDirMacEntry=dlswDirMacEntry, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswCircuitStateTime=dlswCircuitStateTime, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, EndStationLocation=EndStationLocation, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswCircuitOrigin=dlswCircuitOrigin, dlswDirMacIndex=dlswDirMacIndex, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDomains=dlswDomains, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDirMacLocation=dlswDirMacLocation, LFSize=LFSize, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirCache=dlswDirCache, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswNotificationGroup=dlswNotificationGroup, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTrapControl=dlswTrapControl, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswMIB=dlswMIB, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirNBLocation=dlswDirNBLocation, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswIfRowStatus=dlswIfRowStatus, dlswDirMacTable=dlswDirMacTable, dlswDirMacStatus=dlswDirMacStatus, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, MacAddressNC=MacAddressNC, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswNodeVersionString=dlswNodeVersionString, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirMacEntryType=dlswDirMacEntryType, dlswNodeVendorID=dlswNodeVendorID, dlswDirMacLocationType=dlswDirMacLocationType)
