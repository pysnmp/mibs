...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirNBLFSize=dlswDirNBLFSize, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswDirStat=dlswDirStat, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDirLocateMacLocation=dlswDirLocateMacLocation, LFSize=LFSize, dlswDirLocate=dlswDirLocate, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswCircuitOrigin=dlswCircuitOrigin, dlswDirMacIndex=dlswDirMacIndex, dlswDirNBName=dlswDirNBName, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirNBEntry=dlswDirNBEntry, TAddress=TAddress, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswDirMacMac=dlswDirMacMac, dlswCircuitState=dlswCircuitState, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswIfTable=dlswIfTable, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirNBEntryType=dlswDirNBEntryType, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirMacEntry=dlswDirMacEntry, dlswCircuitGroup=dlswCircuitGroup, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, EndStationLocation=EndStationLocation, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswDirLocateGroup=dlswDirLocateGroup, dlsw=dlsw, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswCoreCompliance=dlswCoreCompliance, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, DlswTCPAddress=DlswTCPAddress, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswCircuitTable=dlswCircuitTable, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, DlcType=DlcType, dlswDirNBIndex=dlswDirNBIndex, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswNotificationGroup=dlswNotificationGroup, dlswDirNBNameType=dlswDirNBNameType, dlswDirMacLocation=dlswDirMacLocation, dlswInterface=dlswInterface, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswNode=dlswNode, dlswDirLocateMacMac=dlswDirLocateMacMac, NBName=NBName, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswConformance=dlswConformance, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswCompliances=dlswCompliances, dlswDirNBLocationType=dlswDirNBLocationType, MacAddressNC=MacAddressNC, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswMIB=dlswMIB, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswCircuitPriority=dlswCircuitPriority, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswSdlcLsTable=dlswSdlcLsTable, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswNodeVersionString=dlswNodeVersionString, dlswDirMacMask=dlswDirMacMask, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTCPDomain=dlswTCPDomain, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswCircuitStateTime=dlswCircuitStateTime, dlswCircuitStat=dlswCircuitStat, dlswSdlc=dlswSdlc, dlswGroups=dlswGroups, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswNodeStatus=dlswNodeStatus, dlswDirNBEntries=dlswDirNBEntries, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirNBTable=dlswDirNBTable, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnTcp=dlswTConnTcp, dlswTConnOperState=dlswTConnOperState, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswSdlcCompliance=dlswSdlcCompliance, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirectory=dlswDirectory, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnStatGroup=dlswTConnStatGroup, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswNodeVersion=dlswNodeVersion, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswDirGroup=dlswDirGroup, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirMacEntries=dlswDirMacEntries, dlswDirNBGroup=dlswDirNBGroup, dlswDirCache=dlswDirCache, dlswDirMacLFSize=dlswDirMacLFSize, dlswCircuit=dlswCircuit, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnSpecific=dlswTConnSpecific, dlswDirNBLocation=dlswDirNBLocation, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, PYSNMP_MODULE_ID=dlsw, dlswDomains=dlswDomains, dlswDirMacStatus=dlswDirMacStatus, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirNBStatus=dlswDirNBStatus, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswNodeGroup=dlswNodeGroup, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnStat=dlswTConnStat, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswSdlcGroup=dlswSdlcGroup, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTraps=dlswTraps, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswIfEntry=dlswIfEntry, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswIfSapList=dlswIfSapList, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnOperTable=dlswTConnOperTable, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswDirCompliance=dlswDirCompliance, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswNodeUpTime=dlswNodeUpTime, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswDirMacTable=dlswDirMacTable, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnConfigTable=dlswTConnConfigTable, dlswTrapControl=dlswTrapControl, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, null=null, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConn=dlswTConn, dlswIfRowStatus=dlswIfRowStatus, dlswTConnConfigTDomain=dlswTConnConfigTDomain)
