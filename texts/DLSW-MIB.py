...
mibBuilder.exportSymbols("DLSW-MIB", dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswInterfaceGroup=dlswInterfaceGroup, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTCPDomain=dlswTCPDomain, dlswInterface=dlswInterface, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirectory=dlswDirectory, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, NBName=NBName, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnOperState=dlswTConnOperState, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswDirLocateNBMatch=dlswDirLocateNBMatch, DlswTCPAddress=DlswTCPAddress, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswDirNBName=dlswDirNBName, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswIfTable=dlswIfTable, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswCircuitStateTime=dlswCircuitStateTime, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswDirMacEntries=dlswDirMacEntries, dlswTConnNBGroup=dlswTConnNBGroup, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirNBEntry=dlswDirNBEntry, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCircuitGroup=dlswCircuitGroup, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswSdlc=dlswSdlc, dlswDirMacLFSize=dlswDirMacLFSize, dlswCircuitPriority=dlswCircuitPriority, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirCompliance=dlswDirCompliance, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnOperGroup=dlswTConnOperGroup, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirStat=dlswDirStat, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirNBTable=dlswDirNBTable, dlswTrapCircuitUp=dlswTrapCircuitUp, PYSNMP_MODULE_ID=dlsw, dlswTConnConfigTable=dlswTConnConfigTable, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswDirMacLocation=dlswDirMacLocation, dlswDirCache=dlswDirCache, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswIfSapList=dlswIfSapList, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, TAddress=TAddress, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswDomains=dlswDomains, dlswNotificationGroup=dlswNotificationGroup, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswCircuit=dlswCircuit, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirNBStatus=dlswDirNBStatus, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTrapControl=dlswTrapControl, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswCompliances=dlswCompliances, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswIfEntry=dlswIfEntry, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDirGroup=dlswDirGroup, dlswTConnOperTable=dlswTConnOperTable, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswNodeVersionString=dlswNodeVersionString, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirNBEntryType=dlswDirNBEntryType, dlswCircuitState=dlswCircuitState, dlswSdlcGroup=dlswSdlcGroup, DlcType=DlcType, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCircuitStat=dlswCircuitStat, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirNBNameType=dlswDirNBNameType, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirNBEntries=dlswDirNBEntries, dlswTraps=dlswTraps, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTConnSpecific=dlswTConnSpecific, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswDirMacIndex=dlswDirMacIndex, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnTcp=dlswTConnTcp, LFSize=LFSize, MacAddressNC=MacAddressNC, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswNodeGroup=dlswNodeGroup, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswNodeUpTime=dlswNodeUpTime, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswGroups=dlswGroups, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswMIB=dlswMIB, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnStat=dlswTConnStat, dlswDirNBLocation=dlswDirNBLocation, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirNBGroup=dlswDirNBGroup, dlswDirMacMac=dlswDirMacMac, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswCircuitTable=dlswCircuitTable, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswConformance=dlswConformance, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswSdlcLsTable=dlswSdlcLsTable, null=null, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswTConn=dlswTConn, dlswDirMacTable=dlswDirMacTable, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirNBIndex=dlswDirNBIndex, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirNBLocationType=dlswDirNBLocationType, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlsw=dlsw, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirMacStatus=dlswDirMacStatus, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTrapTConnUp=dlswTrapTConnUp, dlswIfRowStatus=dlswIfRowStatus, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswNode=dlswNode, EndStationLocation=EndStationLocation, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswNodeStatus=dlswNodeStatus, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirMacEntry=dlswDirMacEntry, dlswDirMacMask=dlswDirMacMask, dlswCoreCompliance=dlswCoreCompliance, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirLocate=dlswDirLocate, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswNodeVersion=dlswNodeVersion, dlswDirLocateNBGroup=dlswDirLocateNBGroup)
