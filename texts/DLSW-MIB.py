...
Integer32, Unsigned32, TimeTicks, Gauge32, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, mib_2, NotificationType, ObjectIdentity, Bits, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "TimeTicks", "Gauge32", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "mib-2", "NotificationType", "ObjectIdentity", "Bits", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("DLSW-MIB", dlswSdlcLsEntry=dlswSdlcLsEntry, dlswIfTable=dlswIfTable, dlswCircuit=dlswCircuit, dlswCircuitState=dlswCircuitState, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnOperState=dlswTConnOperState, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitOrigin=dlswCircuitOrigin, dlswTCPDomain=dlswTCPDomain, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirMacTable=dlswDirMacTable, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswCompliances=dlswCompliances, dlswDirMacEntry=dlswDirMacEntry, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTrapTConnDown=dlswTrapTConnDown, dlswNode=dlswNode, DlswTCPAddress=DlswTCPAddress, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirMacLocation=dlswDirMacLocation, dlswNodeStatus=dlswNodeStatus, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswIfSapList=dlswIfSapList, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswNodeGroup=dlswNodeGroup, dlswTConnStatGroup=dlswTConnStatGroup, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnConfigGroup=dlswTConnConfigGroup, MacAddressNC=MacAddressNC, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswSdlcGroup=dlswSdlcGroup, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDirNBTable=dlswDirNBTable, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswDirGroup=dlswDirGroup, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirNBName=dlswDirNBName, dlswCircuitStat=dlswCircuitStat, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitTable=dlswCircuitTable, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirMacStatus=dlswDirMacStatus, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirNBLFSize=dlswDirNBLFSize, dlswInterface=dlswInterface, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirMacMask=dlswDirMacMask, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirCompliance=dlswDirCompliance, dlswCircuitStateTime=dlswCircuitStateTime, dlswDirLocate=dlswDirLocate, LFSize=LFSize, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswCircuitGroup=dlswCircuitGroup, dlswNotificationGroup=dlswNotificationGroup, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswInterfaceGroup=dlswInterfaceGroup, dlswDirCache=dlswDirCache, dlswTConn=dlswTConn, dlswDirMacEntries=dlswDirMacEntries, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswCoreCompliance=dlswCoreCompliance, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswSdlc=dlswSdlc, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnTcp=dlswTConnTcp, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswSdlcCompliance=dlswSdlcCompliance, dlswDirMacIndex=dlswDirMacIndex, dlswSdlcLsTable=dlswSdlcLsTable, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirNBIndex=dlswDirNBIndex, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirNBRowStatus=dlswDirNBRowStatus, DlcType=DlcType, dlswDirNBNameType=dlswDirNBNameType, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlsw=dlsw, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnOperICRexSents=dlswTConnOperICRexSents, PYSNMP_MODULE_ID=dlsw, dlswDirMacLocationType=dlswDirMacLocationType, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswConformance=dlswConformance, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirNBStatus=dlswDirNBStatus, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTConnSpecific=dlswTConnSpecific, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTraps=dlswTraps, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnStat=dlswTConnStat, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirLocateNBName=dlswDirLocateNBName, dlswCircuitPriority=dlswCircuitPriority, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTrapControl=dlswTrapControl, dlswCircuitEntry=dlswCircuitEntry, dlswDomains=dlswDomains, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswDirNBGroup=dlswDirNBGroup, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswIfRowStatus=dlswIfRowStatus, NBName=NBName, dlswDirMacEntryType=dlswDirMacEntryType, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirStat=dlswDirStat, dlswNodeVersionString=dlswNodeVersionString, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswNodeVersion=dlswNodeVersion, dlswNodeVendorID=dlswNodeVendorID, null=null, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswMIB=dlswMIB, dlswDirectory=dlswDirectory, EndStationLocation=EndStationLocation, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswGroups=dlswGroups, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswDirNBEntries=dlswDirNBEntries, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnOperTable=dlswTConnOperTable, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswDirNBLocation=dlswDirNBLocation, dlswTConnConfigTable=dlswTConnConfigTable, dlswIfEntry=dlswIfEntry, dlswDirMacMac=dlswDirMacMac, TAddress=TAddress, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize)
