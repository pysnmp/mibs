...
Counter32, Gauge32, ModuleIdentity, NotificationType, Counter64, mib_2, Integer32, IpAddress, Bits, TimeTicks, Unsigned32, iso, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "ModuleIdentity", "NotificationType", "Counter64", "mib-2", "Integer32", "IpAddress", "Bits", "TimeTicks", "Unsigned32", "iso", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DLSW-MIB", MacAddressNC=MacAddressNC, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnConfigTable=dlswTConnConfigTable, dlswSdlcLsTable=dlswSdlcLsTable, dlswDirNBTable=dlswDirNBTable, dlswDirNBEntries=dlswDirNBEntries, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswCircuitStat=dlswCircuitStat, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswCircuitStatActives=dlswCircuitStatActives, dlsw=dlsw, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnStatGroup=dlswTConnStatGroup, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswCircuitGroup=dlswCircuitGroup, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirNBStatus=dlswDirNBStatus, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswDirNBLocation=dlswDirNBLocation, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswNodeVendorID=dlswNodeVendorID, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswInterface=dlswInterface, dlswDirMacLFSize=dlswDirMacLFSize, dlswDirMacLocationType=dlswDirMacLocationType, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTraps=dlswTraps, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirNBEntryType=dlswDirNBEntryType, dlswDomains=dlswDomains, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswNodeGroup=dlswNodeGroup, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswDirectory=dlswDirectory, dlswSdlcGroup=dlswSdlcGroup, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswDirMacStatus=dlswDirMacStatus, dlswSdlcCompliance=dlswSdlcCompliance, dlswDirCompliance=dlswDirCompliance, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswNodeStatus=dlswNodeStatus, dlswIfEntry=dlswIfEntry, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirLocateNBName=dlswDirLocateNBName, dlswCircuitPriority=dlswCircuitPriority, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswConformance=dlswConformance, dlswIfVirtualSegment=dlswIfVirtualSegment, LFSize=LFSize, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswDirNBNameType=dlswDirNBNameType, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswNotificationGroup=dlswNotificationGroup, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnNBGroup=dlswTConnNBGroup, dlswDirLocateGroup=dlswDirLocateGroup, dlswInterfaceGroup=dlswInterfaceGroup, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswDirMacMac=dlswDirMacMac, dlswTrapControl=dlswTrapControl, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswCompliances=dlswCompliances, dlswCircuitStateTime=dlswCircuitStateTime, dlswTCPDomain=dlswTCPDomain, dlswIfTable=dlswIfTable, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnOperState=dlswTConnOperState, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirMacLocation=dlswDirMacLocation, dlswDirNBLocationType=dlswDirNBLocationType, TAddress=TAddress, dlswDirNBEntry=dlswDirNBEntry, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswDirMacEntry=dlswDirMacEntry, dlswCircuitTable=dlswCircuitTable, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnTcp=dlswTConnTcp, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswCircuit=dlswCircuit, dlswSdlc=dlswSdlc, dlswDirNBName=dlswDirNBName, EndStationLocation=EndStationLocation, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswNodeUpTime=dlswNodeUpTime, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnSpecific=dlswTConnSpecific, DlswTCPAddress=DlswTCPAddress, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswCircuitS2Location=dlswCircuitS2Location, dlswNodeVersionString=dlswNodeVersionString, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, null=null, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConn=dlswTConn, dlswDirStat=dlswDirStat, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnStat=dlswTConnStat, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswMIB=dlswMIB, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswNodeVersion=dlswNodeVersion, dlswIfSapList=dlswIfSapList, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswCircuitState=dlswCircuitState, dlswTrapTConnUp=dlswTrapTConnUp, dlswDirGroup=dlswDirGroup, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnOperTable=dlswTConnOperTable, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswDirCache=dlswDirCache, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirMacMask=dlswDirMacMask, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCoreCompliance=dlswCoreCompliance, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswNode=dlswNode, dlswIfRowStatus=dlswIfRowStatus, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswDirMacEntries=dlswDirMacEntries, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswGroups=dlswGroups, dlswDirMacIndex=dlswDirMacIndex, DlcType=DlcType, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswDirNBGroup=dlswDirNBGroup, dlswDirMacTable=dlswDirMacTable, dlswDirLocate=dlswDirLocate, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperConnectTime=dlswTConnOperConnectTime, NBName=NBName, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswCircuitS1Dlc=dlswCircuitS1Dlc, PYSNMP_MODULE_ID=dlsw, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr)
