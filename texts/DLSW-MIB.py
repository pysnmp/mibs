...
mibBuilder.exportSymbols("DLSW-MIB", dlswIfTable=dlswIfTable, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirNBGroup=dlswDirNBGroup, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswDirMacMask=dlswDirMacMask, dlswDirNBIndex=dlswDirNBIndex, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswNotificationGroup=dlswNotificationGroup, dlswTrapControl=dlswTrapControl, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitPriority=dlswCircuitPriority, NBName=NBName, dlswNodeVendorID=dlswNodeVendorID, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirCompliance=dlswDirCompliance, dlswTCPDomain=dlswTCPDomain, dlswSdlcLsTable=dlswSdlcLsTable, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswMIB=dlswMIB, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitTable=dlswCircuitTable, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirMacEntries=dlswDirMacEntries, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswGroups=dlswGroups, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, EndStationLocation=EndStationLocation, dlswInterface=dlswInterface, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirMacEntry=dlswDirMacEntry, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnConfigIndex=dlswTConnConfigIndex, LFSize=LFSize, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswNodeGroup=dlswNodeGroup, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnConfigTable=dlswTConnConfigTable, dlswDirNBLFSize=dlswDirNBLFSize, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswDirNBEntries=dlswDirNBEntries, dlswIfRowStatus=dlswIfRowStatus, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswCircuitStateTime=dlswCircuitStateTime, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswSdlc=dlswSdlc, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, TAddress=TAddress, dlswCircuit=dlswCircuit, dlswDirStat=dlswDirStat, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, DlcType=DlcType, dlswDirNBTable=dlswDirNBTable, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswNodeUpTime=dlswNodeUpTime, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirNBStatus=dlswDirNBStatus, dlswDirectory=dlswDirectory, dlswDirLocateGroup=dlswDirLocateGroup, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswTConnNBGroup=dlswTConnNBGroup, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnOperState=dlswTConnOperState, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswCompliances=dlswCompliances, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirLocate=dlswDirLocate, dlswDomains=dlswDomains, dlswTConn=dlswTConn, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswCircuitEntry=dlswCircuitEntry, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswDirNBName=dlswDirNBName, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirMacEntryType=dlswDirMacEntryType, MacAddressNC=MacAddressNC, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswConformance=dlswConformance, dlswTConnOperTable=dlswTConnOperTable, dlswNode=dlswNode, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswTConnTcp=dlswTConnTcp, dlswCircuitGroup=dlswCircuitGroup, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitState=dlswCircuitState, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswNodeStatus=dlswNodeStatus, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirLocateNBName=dlswDirLocateNBName, PYSNMP_MODULE_ID=dlsw, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirMacTable=dlswDirMacTable, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirNBLocation=dlswDirNBLocation, dlswDirCache=dlswDirCache, null=null, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirMacIndex=dlswDirMacIndex, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirNBNameType=dlswDirNBNameType, dlswCircuitStatActives=dlswCircuitStatActives, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswInterfaceGroup=dlswInterfaceGroup, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswDirNBLocationType=dlswDirNBLocationType, dlswDirMacMac=dlswDirMacMac, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTraps=dlswTraps, dlswDirGroup=dlswDirGroup, dlsw=dlsw, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswDirMacStatus=dlswDirMacStatus, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswIfEntry=dlswIfEntry, dlswTConnStat=dlswTConnStat, dlswNodeVersionString=dlswNodeVersionString, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswNodeVersion=dlswNodeVersion, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswDirMacLocation=dlswDirMacLocation, dlswSdlcCompliance=dlswSdlcCompliance, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswCircuitStat=dlswCircuitStat, dlswTConnSpecific=dlswTConnSpecific, DlswTCPAddress=DlswTCPAddress, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswIfSapList=dlswIfSapList, dlswCoreCompliance=dlswCoreCompliance, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswSdlcGroup=dlswSdlcGroup)
