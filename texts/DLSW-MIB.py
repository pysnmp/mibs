...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTCPDomain=dlswTCPDomain, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswNodeVersionString=dlswNodeVersionString, dlswDirNBLocation=dlswDirNBLocation, dlswDirNBName=dlswDirNBName, dlswNodeNBGroup=dlswNodeNBGroup, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswNodeVersion=dlswNodeVersion, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirMacMac=dlswDirMacMac, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswDirNBGroup=dlswDirNBGroup, dlswTConnOperGroup=dlswTConnOperGroup, dlswCircuitState=dlswCircuitState, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCoreCompliance=dlswCoreCompliance, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTraps=dlswTraps, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirStat=dlswDirStat, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswSdlcGroup=dlswSdlcGroup, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswDirNBIndex=dlswDirNBIndex, dlswDirLocate=dlswDirLocate, dlswDirCache=dlswDirCache, dlswDirMacIndex=dlswDirMacIndex, dlswTConn=dlswTConn, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswNodeVendorID=dlswNodeVendorID, dlswTConnStat=dlswTConnStat, MacAddressNC=MacAddressNC, dlswTConnOperState=dlswTConnOperState, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswDirectory=dlswDirectory, dlswCircuitOrigin=dlswCircuitOrigin, dlswDirNBStatus=dlswDirNBStatus, dlswConformance=dlswConformance, dlswMIB=dlswMIB, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswIfTable=dlswIfTable, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswCircuitTable=dlswCircuitTable, dlswSdlcLsTable=dlswSdlcLsTable, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswIfSapList=dlswIfSapList, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnSpecific=dlswTConnSpecific, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswCircuitStat=dlswCircuitStat, dlswSdlc=dlswSdlc, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirLocateCompliance=dlswDirLocateCompliance, PYSNMP_MODULE_ID=dlsw, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnTcp=dlswTConnTcp, dlswDirNBNameType=dlswDirNBNameType, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswNotificationGroup=dlswNotificationGroup, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswDirMacMask=dlswDirMacMask, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTConnOperTable=dlswTConnOperTable, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnStatGroup=dlswTConnStatGroup, dlswTrapTConnUp=dlswTrapTConnUp, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitStateTime=dlswCircuitStateTime, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirLocateGroup=dlswDirLocateGroup, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDomains=dlswDomains, dlswDirMacEntry=dlswDirMacEntry, dlswCompliances=dlswCompliances, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswIfEntry=dlswIfEntry, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, EndStationLocation=EndStationLocation, dlswDirGroup=dlswDirGroup, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswDirNBEntries=dlswDirNBEntries, dlsw=dlsw, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTrapControl=dlswTrapControl, NBName=NBName, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswIfRowStatus=dlswIfRowStatus, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, DlswTCPAddress=DlswTCPAddress, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirNBTable=dlswDirNBTable, dlswDirLocateNBName=dlswDirLocateNBName, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirMacStatus=dlswDirMacStatus, dlswNode=dlswNode, dlswDirCompliance=dlswDirCompliance, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswCircuitPriority=dlswCircuitPriority, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnNBGroup=dlswTConnNBGroup, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, DlcType=DlcType, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswNodeStatus=dlswNodeStatus, dlswCircuit=dlswCircuit, dlswCircuitEntry=dlswCircuitEntry, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirMacEntries=dlswDirMacEntries, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirMacLocation=dlswDirMacLocation, dlswNodeGroup=dlswNodeGroup, dlswGroups=dlswGroups, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswInterface=dlswInterface, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswDirMacEntryType=dlswDirMacEntryType, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswCircuitGroup=dlswCircuitGroup, TAddress=TAddress, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirMacTable=dlswDirMacTable, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswDirNBEntry=dlswDirNBEntry, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswDirNBLocationType=dlswDirNBLocationType, null=null, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, LFSize=LFSize, dlswTConnConfigEntry=dlswTConnConfigEntry)
