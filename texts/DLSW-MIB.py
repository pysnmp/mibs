...
mibBuilder.exportSymbols("DLSW-MIB", dlswCircuitStatCreates=dlswCircuitStatCreates, dlswDirMacMask=dlswDirMacMask, dlswCoreCompliance=dlswCoreCompliance, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirLocate=dlswDirLocate, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirCache=dlswDirCache, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, null=null, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswDomains=dlswDomains, dlswTCPDomain=dlswTCPDomain, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswSdlc=dlswSdlc, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswInterface=dlswInterface, dlswNode=dlswNode, dlswCircuitOrigin=dlswCircuitOrigin, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswIfEntry=dlswIfEntry, dlswDirStat=dlswDirStat, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswNodeGroup=dlswNodeGroup, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTrapTConnUp=dlswTrapTConnUp, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCircuitStat=dlswCircuitStat, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnSpecific=dlswTConnSpecific, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConn=dlswTConn, dlswDirectory=dlswDirectory, dlswDirNBEntry=dlswDirNBEntry, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnStat=dlswTConnStat, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswDirMacLocationType=dlswDirMacLocationType, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuit=dlswCircuit, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswCompliances=dlswCompliances, dlswMIB=dlswMIB, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirNBName=dlswDirNBName, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswNotificationGroup=dlswNotificationGroup, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirMacMac=dlswDirMacMac, dlswCircuitPriority=dlswCircuitPriority, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswDirNBGroup=dlswDirNBGroup, dlswTConnOperTable=dlswTConnOperTable, dlswCircuitState=dlswCircuitState, dlswDirNBEntries=dlswDirNBEntries, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswNodeVersionString=dlswNodeVersionString, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTrapControl=dlswTrapControl, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnOperState=dlswTConnOperState, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, NBName=NBName, dlswDirMacEntries=dlswDirMacEntries, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDirNBLocation=dlswDirNBLocation, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswNodeVersion=dlswNodeVersion, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirNBTable=dlswDirNBTable, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswGroups=dlswGroups, PYSNMP_MODULE_ID=dlsw, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswSdlcCompliance=dlswSdlcCompliance, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlsw=dlsw, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswCircuitStatActives=dlswCircuitStatActives, dlswCircuitEntry=dlswCircuitEntry, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswIfRowStatus=dlswIfRowStatus, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirCompliance=dlswDirCompliance, dlswDirNBEntryType=dlswDirNBEntryType, dlswIfTable=dlswIfTable, dlswDirMacTable=dlswDirMacTable, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirGroup=dlswDirGroup, dlswDirNBIndex=dlswDirNBIndex, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswDirMacStatus=dlswDirMacStatus, dlswDirMacEntry=dlswDirMacEntry, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirNBNameType=dlswDirNBNameType, dlswNodeUpTime=dlswNodeUpTime, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswConformance=dlswConformance, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirMacIndex=dlswDirMacIndex, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnConfigTable=dlswTConnConfigTable, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, TAddress=TAddress, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, EndStationLocation=EndStationLocation, dlswInterfaceGroup=dlswInterfaceGroup, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTrapTConnDown=dlswTrapTConnDown, dlswNodeStatus=dlswNodeStatus, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, DlswTCPAddress=DlswTCPAddress, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCircuitGroup=dlswCircuitGroup, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswDirMacLocation=dlswDirMacLocation, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswIfSapList=dlswIfSapList, dlswCircuitStateTime=dlswCircuitStateTime, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswCircuitTable=dlswCircuitTable, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTraps=dlswTraps, MacAddressNC=MacAddressNC, dlswTConnOperGroup=dlswTConnOperGroup, dlswSdlcGroup=dlswSdlcGroup, DlcType=DlcType, dlswDirNBStatus=dlswDirNBStatus, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnTcp=dlswTConnTcp, dlswSdlcLsTable=dlswSdlcLsTable, LFSize=LFSize)
