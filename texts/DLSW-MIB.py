...
mibBuilder.exportSymbols("DLSW-MIB", dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswNodeNBGroup=dlswNodeNBGroup, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswCircuitPriority=dlswCircuitPriority, dlswDirCompliance=dlswDirCompliance, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswTConnConfigTable=dlswTConnConfigTable, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswNodeGroup=dlswNodeGroup, dlswInterface=dlswInterface, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswSdlc=dlswSdlc, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswDirMacEntry=dlswDirMacEntry, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTraps=dlswTraps, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, LFSize=LFSize, dlswDirNBName=dlswDirNBName, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswCircuit=dlswCircuit, dlswTrapTConnUp=dlswTrapTConnUp, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswDirNBEntries=dlswDirNBEntries, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswDirLocateNBEntry=dlswDirLocateNBEntry, DlcType=DlcType, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswCircuitStatActives=dlswCircuitStatActives, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswSdlcLsTable=dlswSdlcLsTable, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswDirNBGroup=dlswDirNBGroup, dlswDirNBStatus=dlswDirNBStatus, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswNodeVendorID=dlswNodeVendorID, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirNBNameType=dlswDirNBNameType, dlswTConnSpecific=dlswTConnSpecific, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswNode=dlswNode, dlswCoreCompliance=dlswCoreCompliance, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirNBTable=dlswDirNBTable, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswIfTable=dlswIfTable, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswConformance=dlswConformance, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswDirMacLocation=dlswDirMacLocation, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitStateTime=dlswCircuitStateTime, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirLocate=dlswDirLocate, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnOperState=dlswTConnOperState, dlswIfEntry=dlswIfEntry, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswNotificationGroup=dlswNotificationGroup, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswIfRowStatus=dlswIfRowStatus, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnStat=dlswTConnStat, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirStat=dlswDirStat, dlswInterfaceGroup=dlswInterfaceGroup, dlswDirCache=dlswDirCache, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswDirMacEntryType=dlswDirMacEntryType, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswDirMacLocationType=dlswDirMacLocationType, dlswTCPDomain=dlswTCPDomain, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConn=dlswTConn, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswCircuitStat=dlswCircuitStat, null=null, dlswTConnTcp=dlswTConnTcp, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswNodeVersion=dlswNodeVersion, dlswIfSapList=dlswIfSapList, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, TAddress=TAddress, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswNodeVersionString=dlswNodeVersionString, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswDirNBLocation=dlswDirNBLocation, dlswDirLocateNBMatch=dlswDirLocateNBMatch, EndStationLocation=EndStationLocation, dlswDomains=dlswDomains, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswCompliances=dlswCompliances, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswCircuitState=dlswCircuitState, dlswDirMacStatus=dlswDirMacStatus, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, MacAddressNC=MacAddressNC, dlswTConnOperEntry=dlswTConnOperEntry, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswNodeStatus=dlswNodeStatus, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswDirMacTable=dlswDirMacTable, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTrapControl=dlswTrapControl, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswDirectory=dlswDirectory, dlswDirMacLFSize=dlswDirMacLFSize, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirMacMac=dlswDirMacMac, dlswCircuitGroup=dlswCircuitGroup, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswNodeUpTime=dlswNodeUpTime, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswDirMacIndex=dlswDirMacIndex, dlswDirMacMask=dlswDirMacMask, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, PYSNMP_MODULE_ID=dlsw, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTConnOperTable=dlswTConnOperTable, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswGroups=dlswGroups, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswDirLocateGroup=dlswDirLocateGroup, dlswDirNBLFSize=dlswDirNBLFSize, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, DlswTCPAddress=DlswTCPAddress, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirGroup=dlswDirGroup, dlswDirMacEntries=dlswDirMacEntries, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTrapTConnDown=dlswTrapTConnDown, dlswSdlcGroup=dlswSdlcGroup, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswCircuitEntry=dlswCircuitEntry, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswMIB=dlswMIB, dlswDirLocateNBName=dlswDirLocateNBName, dlsw=dlsw, NBName=NBName, dlswCircuitTable=dlswCircuitTable, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirNBIndex=dlswDirNBIndex)
