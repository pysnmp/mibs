...
mibBuilder.exportSymbols("MOXA-EDSG512E8POE-MIB", turboRingCouplingPort=turboRingCouplingPort, dnsServer1IpAddr=dnsServer1IpAddr, ptpv2Status=ptpv2Status, loggingCapacityEmailWarningEnable=loggingCapacityEmailWarningEnable, igmpSnoopingSettingTable=igmpSnoopingSettingTable, dscpMappingEntry=dscpMappingEntry, pdNoResponseAction=pdNoResponseAction, varConfigImportTrap=varConfigImportTrap, macAddressSticky=macAddressSticky, joinTime=joinTime, listID=listID, moxaUtilityServicePort=moxaUtilityServicePort, relayWarningPower2Off=relayWarningPower2Off, profinetioSetting=profinetioSetting, leaveAllTime=leaveAllTime, ieee1588Setting=ieee1588Setting, actionFlag=actionFlag, couplingMode=couplingMode, aclID=aclID, monitorDiTable=monitorDiTable, staticMulticast=staticMulticast, varABC02WarningTrap=varABC02WarningTrap, circuitID=circuitID, systemEventSettingsTable=systemEventSettingsTable, serialNumber=serialNumber, setDevIpCurrentIpofDevice=setDevIpCurrentIpofDevice, portVlanType=portVlanType, consoleLoginMode=consoleLoginMode, gmrpLearnedPorts=gmrpLearnedPorts, uiVersion=uiVersion, masterSetupRing1=masterSetupRing1, snmpTrap2Community=snmpTrap2Community, qosPortTable=qosPortTable, dhcpFunctionEntry=dhcpFunctionEntry, mabReauthPeriod=mabReauthPeriod, spanningTreeEntry=spanningTreeEntry, power2Trap=power2Trap, snmpInformEnable=snmpInformEnable, spanningTreeRoot=spanningTreeRoot, poeTPortIndex=poeTPortIndex, igmpSnooping=igmpSnooping, turboChainPort2PartnerBridge=turboChainPort2PartnerBridge, aclAttachmentEntry=aclAttachmentEntry, portAccessControlEntry=portAccessControlEntry, turboRingMasterMismatchTrap=turboRingMasterMismatchTrap, portSecurityModeLimit=portSecurityModeLimit, poeDayStart=poeDayStart, dot1xSettingTable=dot1xSettingTable, telnetMaxLoginUsers=telnetMaxLoginUsers, ntpAuthenticateKeyEntry=ntpAuthenticateKeyEntry, staticPortLockLegacy=staticPortLockLegacy, portEventModuleEnable=portEventModuleEnable, rateLimitingAction=rateLimitingAction, relayWarningLinkChangedStatus=relayWarningLinkChangedStatus, syncIntervalv1=syncIntervalv1, spanningTreeIndex=spanningTreeIndex, portSecurityModeViolationPortDisable=portSecurityModeViolationPortDisable, portFixedVid=portFixedVid, turboRingPortTable=turboRingPortTable, enableIgmpSnooping=enableIgmpSnooping, gmrpMulticastGroup=gmrpMulticastGroup, logMinDelayReqInterval=logMinDelayReqInterval, sslEnable=sslEnable, varLoggingCapacityTrap=varLoggingCapacityTrap, relayWarningDiInputChanged=relayWarningDiInputChanged, dot1x1stRadiusPort=dot1x1stRadiusPort, moxaNewCmdEnable=moxaNewCmdEnable, emailWarningFirstRecipientEmailAddr=emailWarningFirstRecipientEmailAddr, snmpTrapCommunity=snmpTrapCommunity, portAccessControl=portAccessControl, industrialEthernet=industrialEthernet, loggingOversizeAction=loggingOversizeAction, sshEnable=sshEnable, ntpAuthenticateKeyIndex=ntpAuthenticateKeyIndex, portbaseVlanSettingIndex=portbaseVlanSettingIndex, domainNumber=domainNumber, portEventSettingsEntry=portEventSettingsEntry, localUtcOffsetValid=localUtcOffsetValid, spanningTreeBridgePriority=spanningTreeBridgePriority, portEventTrafficDuration=portEventTrafficDuration, lineSwapRecovery=lineSwapRecovery, trunkType=trunkType, portSecurityModeStatus=portSecurityModeStatus, poeTimeTable=poeTimeTable, dot1xSameAsAuthServer=dot1xSameAsAuthServer, poeWarningTrap=poeWarningTrap, setDeviceIp=setDeviceIp, poeSysMeasuredPower=poeSysMeasuredPower, trunkIndex=trunkIndex, masterStatusRing1=masterStatusRing1, turboRingMasterChangedTrap=turboRingMasterChangedTrap, poePortCurrent=poePortCurrent, qosPortEntry=qosPortEntry, ingressLimit=ingressLimit, trapServerAddr=trapServerAddr, portName=portName, vlanName=vlanName, loginFailureLockoutTime=loginFailureLockoutTime, pwdMinLength=pwdMinLength, portAccessControlAddress=portAccessControlAddress, confPathName=confPathName, turboRingBrokenStatus=turboRingBrokenStatus, bcastStormProtectionIncludeUcast=bcastStormProtectionIncludeUcast, totalMemory=totalMemory, ptpPortTable=ptpPortTable, systemEventActive=systemEventActive, turboRingPortStatus=turboRingPortStatus, dot1x2ndRadiusSharedKey=dot1x2ndRadiusSharedKey, eventlogTime=eventlogTime, varPortLoopDetectedTrap=varPortLoopDetectedTrap, turboChainPort1PartnerBridge=turboChainPort1PartnerBridge, ringIndexRing2=ringIndexRing2, radiusLoginAuthPort=radiusLoginAuthPort, offsetHours=offsetHours, modbusSetting=modbusSetting, enableAutoIpConfig=enableAutoIpConfig, monitorFDXFlowCtrl=monitorFDXFlowCtrl, rdnt2ndPortStatusRing1=rdnt2ndPortStatusRing1, dhcpServer4=dhcpServer4, enableGMRP=enableGMRP, macAddressStickyAddress=macAddressStickyAddress, currentUtcOffsetValid=currentUtcOffsetValid, eventlogIndex=eventlogIndex, dipSwitchRingCouplingPole=dipSwitchRingCouplingPole, subDomainNamev1=subDomainNamev1, fiberSN=fiberSN, filterType=filterType, varRateLimitedOnTrap=varRateLimitedOnTrap, relayWarningPower1OffStatus=relayWarningPower1OffStatus, varRemoteAuthSuccessTrap=varRemoteAuthSuccessTrap, eipSetting=eipSetting, pdPollingInterval=pdPollingInterval, enableEtherNetIP=enableEtherNetIP, macAddressStickyStatus=macAddressStickyStatus, startDay=startDay, poePortConsumption=poePortConsumption, ntpPeerEntry=ntpPeerEntry, portDisableModePeriod=portDisableModePeriod, poeSysPowerThreshold=poeSysPowerThreshold, ntpPeerAuthenticate=ntpPeerAuthenticate, portSecurityModeTable=portSecurityModeTable, bcastStormProtection=bcastStormProtection, certificateManagement=certificateManagement, accessibleIpTable=accessibleIpTable, grandMasterUuidv1=grandMasterUuidv1, staticMulticastEntry=staticMulticastEntry, dscpClass=dscpClass, varUserAuthSuccessTrap=varUserAuthSuccessTrap, ntpAuthenticateKeyTable=ntpAuthenticateKeyTable, gmrp=gmrp, monitorFiberCheckTable=monitorFiberCheckTable, spanningTreePortEdge=spanningTreePortEdge, targetPort=targetPort, diIndex=diIndex, setDevIpPresentBy=setDevIpPresentBy, turboRingControlPort=turboRingControlPort, staticMulticastStatus=staticMulticastStatus, spanningTreePortPriority=spanningTreePortPriority, mabReauthEnable=mabReauthEnable, poeSysAllocatedPower=poeSysAllocatedPower, grandmasterIdentity=grandmasterIdentity, priority2=priority2, turboRingRdntPort2=turboRingRdntPort2, portbaseVlanSettingTable=portbaseVlanSettingTable, learnedMulticastQuerierPorts=learnedMulticastQuerierPorts, moxa=moxa, rdnt1stPortStatusRing2=rdnt1stPortStatusRing2, portDisableModeEntry=portDisableModeEntry, remoteAuthFailTrap=remoteAuthFailTrap, designatedMasterRing2=designatedMasterRing2, mabRestartPeriod=mabRestartPeriod, accessControlTable=accessControlTable, enablePtpv1=enablePtpv1, ntpAuthenticateKeyID=ntpAuthenticateKeyID, clockModev1=clockModev1, rateLimiting=rateLimiting, pdipaddr=pdipaddr, timesource=timesource, portEventIndex=portEventIndex, systemEventIndex=systemEventIndex, cpuLoading30s=cpuLoading30s, syslogServer2=syslogServer2, poePortPdFailCheck=poePortPdFailCheck, portbaseVlanSettingEntry=portbaseVlanSettingEntry, turboRingMaster=turboRingMaster, querierQueryInterval=querierQueryInterval, dhcpFunctionTable=dhcpFunctionTable, configEncryptEnable=configEncryptEnable, priorityTag=priorityTag, diInputStatus=diInputStatus, sysDateTime=sysDateTime, systemEventSettingsEntry=systemEventSettingsEntry, clockStratumv1=clockStratumv1, httpLoginMessage=httpLoginMessage, ringEnableRing2=ringEnableRing2, dscpMappingTable=dscpMappingTable, syslogServer3=syslogServer3, rdnt2ndPortRing2=rdnt2ndPortRing2, power1Trap=power1Trap, relayWarningTrafficOverload=relayWarningTrafficOverload, offsetToMasterv1=offsetToMasterv1, igmpSnoopingSettingEntry=igmpSnoopingSettingEntry, turboRingV2Ring1=turboRingV2Ring1, priority1=priority1, ivlSwitch=ivlSwitch, emailWarningSecondRecipientEmailAddr=emailWarningSecondRecipientEmailAddr, dipSwitchSetting=dipSwitchSetting, dot1x2ndRadiusServer=dot1x2ndRadiusServer, eventlogEntry=eventlogEntry, syslogServer1port=syslogServer1port, clockMode=clockMode, priorityMapping=priorityMapping, varpower2Trap=varpower2Trap, ingressLimitRate=ingressLimitRate, srcIpAddr=srcIpAddr, snmpVersion=snmpVersion, security=security, endHour=endHour, broadcastStormProtection=broadcastStormProtection, poeStatusTable=poeStatusTable, abc02AutoExportConfig=abc02AutoExportConfig, timeServer1=timeServer1, ptpPortIndex=ptpPortIndex, macAddressStickyPort=macAddressStickyPort, radiusLoginAuthTimeout=radiusLoginAuthTimeout, abc02AutoImportConfig=abc02AutoImportConfig, eventSettings=eventSettings, snmpReadCommunity=snmpReadCommunity, userAuthFailTrap=userAuthFailTrap, priorityMappingEntry=priorityMappingEntry, fiberVoltage=fiberVoltage, dot1xReauthPortIndex=dot1xReauthPortIndex, monitorPortTable=monitorPortTable, loggingCapacityThreshold=loggingCapacityThreshold, snmpdEnable=snmpdEnable, portEntry=portEntry, portSecurity=portSecurity, tftpServer=tftpServer, poeDayStop=poeDayStop, tacacsLoginAuthPort=tacacsLoginAuthPort, localArbTime=localArbTime, option82Setting=option82Setting, trunkSettingIndex=trunkSettingIndex, poePortIndex=poePortIndex, enableDot1X=enableDot1X, bcastStormProtectionIncludeMcast=bcastStormProtectionIncludeMcast, switchIpMask=switchIpMask, monitorDirection=monitorDirection, rateLimitedOnTrap=rateLimitedOnTrap, staticPortLock=staticPortLock, syslogServer1=syslogServer1, vlanEntry=vlanEntry, dot1x2ndRadiusPort=dot1x2ndRadiusPort, enableSpanningTree=enableSpanningTree)
mibBuilder.exportSymbols("MOXA-EDSG512E8POE-MIB", portSetting=portSetting, trunkStatus=trunkStatus, dnsServer2IpAddr=dnsServer2IpAddr, vlanTable=vlanTable, parentUuidv1=parentUuidv1, trunkTable=trunkTable, eventlog=eventlog, pwdComplexityCheckEnable=pwdComplexityCheckEnable, emailWarningSMTPAuthMethod=emailWarningSMTPAuthMethod, ptpTimescale=ptpTimescale, sslCertGen=sslCertGen, dataBaseOption=dataBaseOption, rdnt2ndPortRing1=rdnt2ndPortRing1, overrideRelayWarningSetting=overrideRelayWarningSetting, mabDBOption=mabDBOption, grandmasterPriority2=grandmasterPriority2, httpMaxLoginUsers=httpMaxLoginUsers, poeSysPowerBudget=poeSysPowerBudget, dot1xSettingEntry=dot1xSettingEntry, dipSwitchRingMasterPole=dipSwitchRingMasterPole, portAccessControlTable=portAccessControlTable, poeDayEnable=poeDayEnable, lldpSetting=lldpSetting, rdnt1stPortStatusRing1=rdnt1stPortStatusRing1, dhcpRetryTimes=dhcpRetryTimes, monitorPortEntry=monitorPortEntry, option82ValueDisplay=option82ValueDisplay, vlan=vlan, portTrunking=portTrunking, configImportTrap=configImportTrap, spanningTreePortStatus=spanningTreePortStatus, poePortEntry=poePortEntry, fiberPort=fiberPort, loopProtection=loopProtection, enableTelnetConsole=enableTelnetConsole, freeMemory=freeMemory, ntpAuthenticate=ntpAuthenticate, turboRingMasterSetup=turboRingMasterSetup, option82Enable=option82Enable, endWeek=endWeek, eventlogTable=eventlogTable, enableWebConfig=enableWebConfig, portDisableMode=portDisableMode, radiusLoginAuthSharedKey=radiusLoginAuthSharedKey, dstMacMask=dstMacMask, portForbiddenVid=portForbiddenVid, ntpPeerAddress=ntpPeerAddress, portMDI=portMDI, timeSetting=timeSetting, sshPort=sshPort, daylightSaving=daylightSaving, sysFileUpdate=sysFileUpdate, multicastFastForwarding=multicastFastForwarding, localLeap59=localLeap59, staticMulticastPorts=staticMulticastPorts, syslogSetting=syslogSetting, swMgmt=swMgmt, dhcpServer3=dhcpServer3, telnetPort=telnetPort, pwdComplexityCheckSpecialCharEnable=pwdComplexityCheckSpecialCharEnable, snmpInformRetries=snmpInformRetries, lldpChgTrap=lldpChgTrap, trunkPort=trunkPort, setDevIpTable=setDevIpTable, dot1x1stRadiusServer=dot1x1stRadiusServer, relayWarningEntry=relayWarningEntry, spanningTreeMaxAge=spanningTreeMaxAge, vlanID=vlanID, poePortPowerOutput=poePortPowerOutput, snmpUserSecurityLevel=snmpUserSecurityLevel, startMonth=startMonth, turboRingRdntPort1=turboRingRdntPort1, rdnt1stPortRing1=rdnt1stPortRing1, poeporttimetabling=poeporttimetabling, relayWarning=relayWarning, poePortVoltage=poePortVoltage, vartrafficOverloadTrap=vartrafficOverloadTrap, spanningTreeTable=spanningTreeTable, emailWarningSMTPTLS=emailWarningSMTPTLS, relayAlarmIndex=relayAlarmIndex, priorityMappingTable=priorityMappingTable, dhcpServer1=dhcpServer1, dhcpRetryPeriods=dhcpRetryPeriods, brokenStatusRing1=brokenStatusRing1, enableAccessibleIP=enableAccessibleIP, mabRestartEnable=mabRestartEnable, turboChainPort2=turboChainPort2, ntpAuthenticateKeyTrusted=ntpAuthenticateKeyTrusted, enableGvrp=enableGvrp, enableFactoryDefault=enableFactoryDefault, staticPortLockLegacyAddress=staticPortLockLegacyAddress, ntpPeerTable=ntpPeerTable, schedulingMechanism=schedulingMechanism, fiberModelName=fiberModelName, dhcpRelayAgentSetting=dhcpRelayAgentSetting, varPoEWarningTrap=varPoEWarningTrap, portAccessControlStatus=portAccessControlStatus, turboRing=turboRing, portRelayWarningTable=portRelayWarningTable, dscpInspection=dscpInspection, accessibleIpEntry=accessibleIpEntry, transport=transport, poeSystemSetting=poeSystemSetting, spanningTreeHelloTime=spanningTreeHelloTime, spanningTreePortCost=spanningTreePortCost, emailWarningSMTPPort=emailWarningSMTPPort, srcMacMask=srcMacMask, abc02Status=abc02Status, syslogManagement=syslogManagement, abc02WarningTrap=abc02WarningTrap, portAccessControlPortNo=portAccessControlPortNo, turboChainPort2Status=turboChainPort2Status, macStickyPortViolationPortDisableTrap=macStickyPortViolationPortDisableTrap, blinkingLocatorLED=blinkingLocatorLED, poeSetting=poeSetting, varredundancyTopologyChangedTrap=varredundancyTopologyChangedTrap, turboRingDesignatedMaster=turboRingDesignatedMaster, localUtcOffset=localUtcOffset, portAccessControlAccessStatus=portAccessControlAccessStatus, vlanId=vlanId, relayWarningTable=relayWarningTable, turboRingCouplingPortStatus=turboRingCouplingPortStatus, userAuthSuccessTrap=userAuthSuccessTrap, userInfoChgTrap=userInfoChgTrap, trap2ServerAddr=trap2ServerAddr, relayWarningTurboRingBreakStatus=relayWarningTurboRingBreakStatus, diRelayWarningTable=diRelayWarningTable, startHour=startHour, grandmasterClockAccuracy=grandmasterClockAccuracy, grandmasterPriority1=grandmasterPriority1, supportIfXTable=supportIfXTable, dscpMappedPriority=dscpMappedPriority, turboRingV2Coupling=turboRingV2Coupling, gmrpEntry=gmrpEntry, stepsRemoved=stepsRemoved, aclStatus=aclStatus, portAccessControlVid=portAccessControlVid, startWeek=startWeek, poeWeekDay=poeWeekDay, defaultGateway=defaultGateway, emailWarningSMTPUser=emailWarningSMTPUser, varturboRingCouplingPortChangedTrap=varturboRingCouplingPortChangedTrap, coupling1stPortStatus=coupling1stPortStatus, tftpUpdate=tftpUpdate, userLoginSetting=userLoginSetting, fiberRxPower=fiberRxPower, varFiberWarningTrap=varFiberWarningTrap, clockClass=clockClass, dot1xRadius=dot1xRadius, relayWarningPower2OffStatus=relayWarningPower2OffStatus, rdnt1stPortRing2=rdnt1stPortRing2, userLoginServer=userLoginServer, enableWarmStart=enableWarmStart, emailWarningFourthRecipientEmailAddr=emailWarningFourthRecipientEmailAddr, PortList=PortList, poeTimeEntry=poeTimeEntry, enablePtp=enablePtp, cpuLoading300s=cpuLoading300s, mab=mab, configChangeTrap=configChangeTrap, parentIdentity=parentIdentity, dipSwitchTurboRingPole=dipSwitchTurboRingPole, vlanType=vlanType, portTable=portTable, joinedAccessPorts=joinedAccessPorts, turboRingV2=turboRingV2, relayWarningDiInputChangedStatus=relayWarningDiInputChangedStatus, gmrpSettingTable=gmrpSettingTable, portSpeed=portSpeed, managementInterface=managementInterface, fiberTempWarn=fiberTempWarn, loginLockout=loginLockout, cpuLoading5s=cpuLoading5s, monitorSpeed=monitorSpeed, enableLLDP=enableLLDP, fiberRxPowerWarn=fiberRxPowerWarn, gmrpTable=gmrpTable, relayWarningLinkChanged=relayWarningLinkChanged, trunkSettingTable=trunkSettingTable, switchModel=switchModel, endDay=endDay, portSecurityModePort=portSecurityModePort, systemEventSupport=systemEventSupport, turboChainPort1Status=turboChainPort1Status, localPtpTimescale=localPtpTimescale, dstIpAddr=dstIpAddr, dot1x=dot1x, poePowerOutputMode=poePowerOutputMode, fiberTemperature=fiberTemperature, coupling2ndPortStatus=coupling2ndPortStatus, macAddressStickyVid=macAddressStickyVid, cosInspection=cosInspection, emailWarningSenderEmailAddr=emailWarningSenderEmailAddr, ntpAuthenticateKeyString=ntpAuthenticateKeyString, portDesc=portDesc, option82Value=option82Value, accessControlEntry=accessControlEntry, garpSetting=garpSetting, turboRingPortIndex=turboRingPortIndex, fiberWaveLength=fiberWaveLength, joinedTrunkPorts=joinedTrunkPorts, protocolCode=protocolCode, ringEnableRing1=ringEnableRing1, calibratePeriod=calibratePeriod, vlanPortSettingTable=vlanPortSettingTable, coupling1stPort=coupling1stPort, couplingEnable=couplingEnable, portIndex=portIndex, portEventEnable=portEventEnable, portEventSeverity=portEventSeverity, monitorLinkStatus=monitorLinkStatus, portEventActive=portEventActive, localLeap61=localLeap61, currentUtcOffset=currentUtcOffset, loggingCapacityTrap=loggingCapacityTrap, brokenStatusRing2=brokenStatusRing2, tacacsLoginAuthServer=tacacsLoginAuthServer, httpEnable=httpEnable, staticPortLockLegacyStatus=staticPortLockLegacyStatus, meanPathDelay=meanPathDelay, monitorRxTraffic=monitorRxTraffic, dot1x1stRadiusSharedKey=dot1x1stRadiusSharedKey, managementVlanId=managementVlanId, portbaseVlanMemberPorts=portbaseVlanMemberPorts, accessibleIpStatus=accessibleIpStatus, varMacStickyPortViolationPortDisableTrap=varMacStickyPortViolationPortDisableTrap, clockIdentifierv1=clockIdentifierv1, disableLocatorLEDTime=disableLocatorLEDTime, emailService=emailService, accessibleIpNetMask=accessibleIpNetMask, accessibleIP=accessibleIP, turboRingPortDesignatedBridge=turboRingPortDesignatedBridge, fiberTxPowerWarn=fiberTxPowerWarn, joinedHybridPorts=joinedHybridPorts, tacacsServerSetting=tacacsServerSetting, httpLoginFailureMessage=httpLoginFailureMessage, srcMacAddr=srcMacAddr, trafficOverloadTrap=trafficOverloadTrap, passwordPolicy=passwordPolicy, poePortClass=poePortClass, dscpMapping=dscpMapping, portDefaultVid=portDefaultVid, redundancyTopologyChangedTrap=redundancyTopologyChangedTrap, pdNoResponseTimeout=pdNoResponseTimeout, ptpPortEnable=ptpPortEnable, varturboRingMasterMismatchTrap=varturboRingMasterMismatchTrap, setDevIpIndex=setDevIpIndex, radiusServerSetting=radiusServerSetting, logMinPdelayReqInterval=logMinPdelayReqInterval, enableModbus=enableModbus, mibNotificationsPrefix=mibNotificationsPrefix, setDevIpEntry=setDevIpEntry, pwdComplexityCheckAlphabetEnable=pwdComplexityCheckAlphabetEnable, portSecurityModeSelect=portSecurityModeSelect)
mibBuilder.exportSymbols("MOXA-EDSG512E8POE-MIB", dot1xReauthPeriod=dot1xReauthPeriod, vlanPortSettingEntry=vlanPortSettingEntry, droppacketModeRateLimitingIngressEntry=droppacketModeRateLimitingIngressEntry, radiusLoginAuthServer=radiusLoginAuthServer, ntpPeerIndex=ntpPeerIndex, multicastFiltering=multicastFiltering, protocolOfRedundancySetup=protocolOfRedundancySetup, poeSysPowerEnable=poeSysPowerEnable, poeStatusEntry=poeStatusEntry, varconfigChangeTrap=varconfigChangeTrap, dstNetmask=dstNetmask, memoryUsage=memoryUsage, mabSettingTable=mabSettingTable, powerLimit=powerLimit, trunkEntry=trunkEntry, dhcpServer2=dhcpServer2, mgmtInterfaceAutoLogout=mgmtInterfaceAutoLogout, tacacsLoginAuthAuthType=tacacsLoginAuthAuthType, switchLocator=switchLocator, emailWarningSMTPPassword=emailWarningSMTPPassword, staticPortLockStatus=staticPortLockStatus, varturboRingMasterChangedTrap=varturboRingMasterChangedTrap, powerConsumption=powerConsumption, turboRingPortDesignatedPort=turboRingPortDesignatedPort, ntpPeerAuthenticateKeyid=ntpPeerAuthenticateKeyid, trunkMemberPorts=trunkMemberPorts, tacacsLoginAuthTimeout=tacacsLoginAuthTimeout, dstMacAddr=dstMacAddr, monitorTraffic=monitorTraffic, systemNotifyMessage=systemNotifyMessage, aclListName=aclListName, ptpPortStatus=ptpPortStatus, tacacsLoginAuthSharedKey=tacacsLoginAuthSharedKey, syncInterval=syncInterval, portSecurityModeEntry=portSecurityModeEntry, lldpMSGInterval=lldpMSGInterval, portFixedVidUntag=portFixedVidUntag, syslogServer2port=syslogServer2port, grandmasterClockClass=grandmasterClockClass, systemEventName=systemEventName, emailWarningThirdRecipientEmailAddr=emailWarningThirdRecipientEmailAddr, trafficPrioritization=trafficPrioritization, ingressPort=ingressPort, power1InputStatus=power1InputStatus, fixedMulticastQuerierPorts=fixedMulticastQuerierPorts, power2InputStatus=power2InputStatus, masterSetupRing2=masterSetupRing2, qosClassification=qosClassification, emailWarningSMTPServer=emailWarningSMTPServer, abc02AutoExportLog=abc02AutoExportLog, turboRingCouplingPortChangedTrap=turboRingCouplingPortChangedTrap, turboRingV2Ring2=turboRingV2Ring2, varUserInfoChgTrap=varUserInfoChgTrap, portEnable=portEnable, monitorAutoMDI=monitorAutoMDI, commRedundancy=commRedundancy, option82Type=option82Type, designatedMasterRing1=designatedMasterRing1, snmpAdminSecurityLevel=snmpAdminSecurityLevel, turboChainPort1=turboChainPort1, preferMasterv1=preferMasterv1, diRelayWarningEntry=diRelayWarningEntry, enableNTPServer=enableNTPServer, agingTime=agingTime, spanningTreeForwardingDelay=spanningTreeForwardingDelay, staticPortLockAddress=staticPortLockAddress, masterStatusRing2=masterStatusRing2, usedMemory=usedMemory, mirroring=mirroring, turboChain=turboChain, enableMAB=enableMAB, sshKeyGen=sshKeyGen, syslogServer3port=syslogServer3port, clockSource=clockSource, eventlogDate=eventlogDate, systemEventSeverity=systemEventSeverity, ptpv1Setting=ptpv1Setting, mirroringPort=mirroringPort, staticMulticastTable=staticMulticastTable, dhcpPortIndex=dhcpPortIndex, poePortStatus=poePortStatus, accessControlList=accessControlList, remoteAuthSuccessTrap=remoteAuthSuccessTrap, staticPortLockVid=staticPortLockVid, eventlogEvent=eventlogEvent, droppacketModeRateLimitingIngressTable=droppacketModeRateLimitingIngressTable, gmrpSettingEntry=gmrpSettingEntry, dstsocketPort=dstsocketPort, timeServer2=timeServer2, varUserAuthFailTrap=varUserAuthFailTrap, activeProtocolOfRedundancy=activeProtocolOfRedundancy, poePortLegacyPdDetect=poePortLegacyPdDetect, monitor=monitor, pdfailure=pdfailure, monitorDiEntry=monitorDiEntry, firmwarePathName=firmwarePathName, portEventTrafficThreshold=portEventTrafficThreshold, relayWarningRelayContact=relayWarningRelayContact, enableOption82=enableOption82, telnetEnable=telnetEnable, spanningTree=spanningTree, aclRuleIndex=aclRuleIndex, priorityMappedQueue=priorityMappedQueue, varpower1Trap=varpower1Trap, varLLDPChgTrap=varLLDPChgTrap, loginFailureLockoutRetrys=loginFailureLockoutRetrys, monitorTxTraffic=monitorTxTraffic, sslPort=sslPort, dot1xReauth=dot1xReauth, poePortTable=poePortTable, enableQuerier=enableQuerier, ptpv1Status=ptpv1Status, portLoopDetectedTrap=portLoopDetectedTrap, relayWarningPower1Off=relayWarningPower1Off, eventlogBootup=eventlogBootup, turboRingPortEntry=turboRingPortEntry, dot1xReauthTable=dot1xReauthTable, enableGlobalIgmpSnooping=enableGlobalIgmpSnooping, gmrpFixedPorts=gmrpFixedPorts, announceReceiptTimeout=announceReceiptTimeout, numberOfPorts=numberOfPorts, relayWarningTrafficOverloadStatus=relayWarningTrafficOverloadStatus, staticPortLockPort=staticPortLockPort, accessibleIpAddress=accessibleIpAddress, leap61=leap61, enableProfinetIO=enableProfinetIO, systemEventModuleEnable=systemEventModuleEnable, switchIpAddr=switchIpAddr, logPathName=logPathName, staticMulticastAddress=staticMulticastAddress, PYSNMP_MODULE_ID=edsg512epoe, industrialProtocol=industrialProtocol, edsg512epoe=edsg512epoe, supportMacSticky=supportMacSticky, relayWarningRxTrafficThreshold=relayWarningRxTrafficThreshold, dot1xReauthEntry=dot1xReauthEntry, httpPort=httpPort, rdnt2ndPortStatusRing2=rdnt2ndPortStatusRing2, coupling2ndPort=coupling2ndPort, moxaUtilityServiceEnable=moxaUtilityServiceEnable, emailWarning=emailWarning, poeSysThresholdCutOff=poeSysThresholdCutOff, srcNetmask=srcNetmask, mabSettingEntry=mabSettingEntry, leaveTime=leaveTime, eventlogClear=eventlogClear, turboChainRole=turboChainRole, portDisableModeTable=portDisableModeTable, relayWarningTurboRingBreak=relayWarningTurboRingBreak, radiusLoginAuthAuthType=radiusLoginAuthAuthType, meanPathDelayv1=meanPathDelayv1, poePortEnable=poePortEnable, srcsocketPort=srcsocketPort, eventlogUptime=eventlogUptime, setDevIpDedicatedIp=setDevIpDedicatedIp, monitorFiberCheckEntry=monitorFiberCheckEntry, dipSwitchEnableTurboRing=dipSwitchEnableTurboRing, turboRingEnableCoupling=turboRingEnableCoupling, trunkSettingEntry=trunkSettingEntry, ptpPortEntry=ptpPortEntry, etherType=etherType, portEventSettingsTable=portEventSettingsTable, pwdComplexityCheckDigitEnable=pwdComplexityCheckDigitEnable, ringIndexRing1=ringIndexRing1, snmpInformTimeout=snmpInformTimeout, networkSetting=networkSetting, backupMediaSetting=backupMediaSetting, staticPortLockLegacyPort=staticPortLockLegacyPort, portSubdesc=portSubdesc, fiberWarningTrap=fiberWarningTrap, dot1xReauthEnable=dot1xReauthEnable, relayWarningTrafficDuration=relayWarningTrafficDuration, firmwareVersion=firmwareVersion, loggingCapacityTrapWarningEnable=loggingCapacityTrapWarningEnable, trapVersion=trapVersion, snmpdPort=snmpdPort, endMonth=endMonth, swTraps=swTraps, loginFailureLockoutEnable=loginFailureLockoutEnable, portEventLabel=portEventLabel, fiberTxPower=fiberTxPower, portPriority=portPriority, poePortPdStatusDescription=poePortPdStatusDescription, portFDXFlowCtrl=portFDXFlowCtrl, varRemoteAuthFailTrap=varRemoteAuthFailTrap, diagnosis=diagnosis, leap59=leap59, ptpv2Setting=ptpv2Setting, logAnnounceInterval=logAnnounceInterval, aclAttachmentTable=aclAttachmentTable, offsetToMaster=offsetToMaster, portRelayWarningEntry=portRelayWarningEntry, turboRingControlPortStatus=turboRingControlPortStatus)
