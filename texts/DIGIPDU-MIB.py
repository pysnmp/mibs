...
NotificationType, ModuleIdentity, Gauge32, ObjectIdentity, MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, Unsigned32, IpAddress, NotificationType, enterprises, TimeTicks, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Gauge32", "ObjectIdentity", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "Unsigned32", "IpAddress", "NotificationType", "enterprises", "TimeTicks", "Counter32", "iso")
...
mibBuilder.exportSymbols("DIGIPDU-MIB", outLowCurrentTrap=outLowCurrentTrap, vibrationLastDetectTime=vibrationLastDetectTime, pduBranchLowCurrentTrap=pduBranchLowCurrentTrap, upsBatteryReplace=upsBatteryReplace, uPSModel=uPSModel, inFeedEntry=inFeedEntry, uPS=uPS, uPSOutputOnBattery=uPSOutputOnBattery, micLastDetectTime=micLastDetectTime, outDataList=outDataList, trapArg3=trapArg3, trapArg7=trapArg7, deviceInFeedBranch=deviceInFeedBranch, vibrationDetectOccurTrap=vibrationDetectOccurTrap, outUPSACFaultOffTrap=outUPSACFaultOffTrap, outPowerFactor=outPowerFactor, pduOverloadTrap=pduOverloadTrap, inbuiltTemperatureLowTrap=inbuiltTemperatureLowTrap, testTrap=testTrap, pduBranchOverloadTrap=pduBranchOverloadTrap, pduBranch1Current=pduBranch1Current, inFeedOverLoad=inFeedOverLoad, trapArg9=trapArg9, outOverloadTrap=outOverloadTrap, uPSConnectStatus=uPSConnectStatus, smart=smart, deviceExtendRHTotal=deviceExtendRHTotal, pduHighCurrentTrap=pduHighCurrentTrap, inbuiltTemperature=inbuiltTemperature, deviceInbuiltTempTotal=deviceInbuiltTempTotal, inFeedBranch1PowerFactor=inFeedBranch1PowerFactor, inbuiltTemperatureHighTrap=inbuiltTemperatureHighTrap, pduBranch2Overload=pduBranch2Overload, inputTimeout=inputTimeout, outEntry=outEntry, outComputerStatus=outComputerStatus, trapArg2=trapArg2, extendRHDeviceId=extendRHDeviceId, trapArg1=trapArg1, inFeedVoltage=inFeedVoltage, inputTrap=inputTrap, uPSTemperature=uPSTemperature, pduBranch1LowWarning=pduBranch1LowWarning, inputIndex=inputIndex, extendTemperatureEntry=extendTemperatureEntry, pduModel=pduModel, outPanelOperationTrap=outPanelOperationTrap, inbuiltTemperatureEntry=inbuiltTemperatureEntry, extendRHStatus=extendRHStatus, productTemperatureKind=productTemperatureKind, inFeedPowerFactor=inFeedPowerFactor, uPSBatteryVoltage=uPSBatteryVoltage, daisyChainConnectTrap=daisyChainConnectTrap, inFeedFrequency=inFeedFrequency, inbuiltTemperatureLowWarning=inbuiltTemperatureLowWarning, uPSOutputLoad=uPSOutputLoad, uPSFirmware=uPSFirmware, pduBranch2HighWarning=pduBranch2HighWarning, productModel=productModel, smartTraps=smartTraps, envTemperatureConnectTrap=envTemperatureConnectTrap, inFeedBranchLowCurrentTrap=inFeedBranchLowCurrentTrap, pduEntry=pduEntry, pduPowerLoad=pduPowerLoad, extendRHMonitor=extendRHMonitor, inputStatus=inputStatus, rfidDetectTime=rfidDetectTime, inFeedBranch1Current=inFeedBranch1Current, uPSBatteryLevel=uPSBatteryLevel, deviceInputTotal=deviceInputTotal, outPingTrap=outPingTrap, inputTimeOutTrap=inputTimeOutTrap, uPSInputVoltage=uPSInputVoltage, pduBranch2LowWarning=pduBranch2LowWarning, pduLowWarning=pduLowWarning, deviceUnitTotal=deviceUnitTotal, upsConnectTrap=upsConnectTrap, extendTemperatureDeviceId=extendTemperatureDeviceId, inFeedBranch2PowerLoad=inFeedBranch2PowerLoad, outTable=outTable, pduDataList=pduDataList, extendTemperatureIndex=extendTemperatureIndex, aTSTable=aTSTable, outScheduleTrap=outScheduleTrap, rfidCardNum=rfidCardNum, aTSVoltage=aTSVoltage, inFeedStatus=inFeedStatus, uPSOutputVoltage=uPSOutputVoltage, inbuiltTemperatureStatus=inbuiltTemperatureStatus, trapArg6=trapArg6, trapArg8=trapArg8, outUPSBatteryLevelOnTrap=outUPSBatteryLevelOnTrap, upsBatteryLowTrap=upsBatteryLowTrap, inbuiltTemperatureTable=inbuiltTemperatureTable, deviceUnitEntry=deviceUnitEntry, extendRHHighWarning=extendRHHighWarning, extendRHLowWarning=extendRHLowWarning, inFeedBranch2HighWarning=inFeedBranch2HighWarning, deviceATSKind=deviceATSKind, inputTable=inputTable, micDetectTimes=micDetectTimes, outUPSBatteryLowOffTrap=outUPSBatteryLowOffTrap, pduPowerFactor=pduPowerFactor, outUPSBatteryLowRecoveryOnTrap=outUPSBatteryLowRecoveryOnTrap, deviceDaisyChain=deviceDaisyChain, extendTemperatureTable=extendTemperatureTable, aTSFrequency=aTSFrequency, outCurrentStatus=outCurrentStatus, pduBranch=pduBranch, outVoltage=outVoltage, uPSBatteryRunTime=uPSBatteryRunTime, deviceUnitIndex=deviceUnitIndex, deviceInFeedTotal=deviceInFeedTotal, inputDefault=inputDefault, vibrationDetec=vibrationDetec, extendRH=extendRH, inFeedBranchHighCurrentTrap=inFeedBranchHighCurrentTrap, uPSOutputFrequency=uPSOutputFrequency, pduPowerEnergy=pduPowerEnergy, pduMonitor=pduMonitor, outIndex=outIndex, trapArg4=trapArg4, outHighCurrentTrap=outHighCurrentTrap, outUPSBatteryLevelOffTrap=outUPSBatteryLevelOffTrap, envConnectTrap=envConnectTrap, inFeedHighCurrentTrap=inFeedHighCurrentTrap, outAPIOperationTrap=outAPIOperationTrap, micDetectOccurTrap=micDetectOccurTrap, envRHLowTrap=envRHLowTrap, pduHighWarning=pduHighWarning, arg=arg, deviceOutTotal=deviceOutTotal, pduTables=pduTables, vibrationDetectPeriod=vibrationDetectPeriod, productResetDetector=productResetDetector, uPSBatteryReplace=uPSBatteryReplace, peripheralTables=peripheralTables, inFeedBranch1PowerLoad=inFeedBranch1PowerLoad, inFeedBranch2PowerFactor=inFeedBranch2PowerFactor, extendTemperaturePort=extendTemperaturePort, extendTemperatureHighWarning=extendTemperatureHighWarning, outScheduleErrorTrap=outScheduleErrorTrap, product=product, deviceUPS=deviceUPS, extendRHTable=extendRHTable, extendTemperatureStatus=extendTemperatureStatus, micDetec=micDetec, envTemperatureHighTrap=envTemperatureHighTrap, productPartNumber=productPartNumber, uPSOutputCurrent=uPSOutputCurrent, outSwitchCtrl=outSwitchCtrl, inFeedBranchOverloadTrap=inFeedBranchOverloadTrap, deviceUnitStatus=deviceUnitStatus, pduConnectTrap=pduConnectTrap, outPowerLoad=outPowerLoad, uPSBatteryLow=uPSBatteryLow, outHighWarning=outHighWarning, micDetectPeriod=micDetectPeriod, extendRHIndex=extendRHIndex, productFirmwareVersion=productFirmwareVersion, envTemperatureLowTrap=envTemperatureLowTrap, inFeedBranch2Current=inFeedBranch2Current, devicePDUTotal=devicePDUTotal, inputState=inputState, inFeedIndex=inFeedIndex, deviceExtendTemperatureTotal=deviceExtendTemperatureTotal, pduCurrent=pduCurrent, extendRHEntry=extendRHEntry, extendTemperatureMonitor=extendTemperatureMonitor, inFeedLowCurrentTrap=inFeedLowCurrentTrap, deviceUnitTable=deviceUnitTable, trapArg5=trapArg5, outLowWarning=outLowWarning, envRHConnectTrap=envRHConnectTrap, extendTemperatureLowWarning=extendTemperatureLowWarning, trap=trap, upsOverloadTrap=upsOverloadTrap, pduVoltage=pduVoltage, productSerialNumber=productSerialNumber, vibrationDetectTimes=vibrationDetectTimes, deviceUnitOutTotal=deviceUnitOutTotal, outWebOperationTrap=outWebOperationTrap, uPSUARTId=uPSUARTId, inFeedBranch1LowWarning=inFeedBranch1LowWarning, inFeedBranch2LowWarning=inFeedBranch2LowWarning, outPingRebootTrap=outPingRebootTrap, inFeedBranch2OverLoad=inFeedBranch2OverLoad, deviceTable=deviceTable, inFeedOverloadTrap=inFeedOverloadTrap, deviceUnitInfeedTotal=deviceUnitInfeedTotal, inbuiltTemperatureHighWarning=inbuiltTemperatureHighWarning, aTSStatus=aTSStatus, extendRHPort=extendRHPort, uPSBatteryDate=uPSBatteryDate, PYSNMP_MODULE_ID=smart, extendTemperature=extendTemperature, rfidReader=rfidReader, aTSEntry=aTSEntry, uPSOutputOverload=uPSOutputOverload, outConditionCtrlTrap=outConditionCtrlTrap, inputEntry=inputEntry, outCurrent=outCurrent, inFeedLowWarning=inFeedLowWarning, outUPSACRecoveryOnTrap=outUPSACRecoveryOnTrap, pduIndex=pduIndex, inFeedBranch=inFeedBranch, inFeedPowerLoad=inFeedPowerLoad, dataLogTable=dataLogTable, outOverload=outOverload, pduLowCurrentTrap=pduLowCurrentTrap, inFeedHighWarning=inFeedHighWarning, outSwitchStatus=outSwitchStatus, pduBranch1Overload=pduBranch1Overload, pduOverload=pduOverload, pduBranch2Current=pduBranch2Current, inputDetectTime=inputDetectTime, uPSSerial=uPSSerial, inFeedBranch1OverLoad=inFeedBranch1OverLoad, upsOnBatteryTrap=upsOnBatteryTrap, aTSIndex=aTSIndex, pduBranchHighCurrentTrap=pduBranchHighCurrentTrap, inFeedTable=inFeedTable, pduFrequency=pduFrequency, inFeedPowerEnergy=inFeedPowerEnergy, inFeedDataList=inFeedDataList, inbuiltTemperatureIndex=inbuiltTemperatureIndex, pduBranch1HighWarning=pduBranch1HighWarning, inFeedBranch1HighWarning=inFeedBranch1HighWarning, inFeedCurrent=inFeedCurrent, envRHHighTrap=envRHHighTrap, deviceInFeedKind=deviceInFeedKind, deviceOutKind=deviceOutKind, digipdu=digipdu, pduStatus=pduStatus)
