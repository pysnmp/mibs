...
mibBuilder.exportSymbols("DIGIPDU-MIB", pduBranchHighCurrentTrap=pduBranchHighCurrentTrap, trapArg2=trapArg2, inFeedBranchOverloadTrap=inFeedBranchOverloadTrap, inFeedBranch2PowerFactor=inFeedBranch2PowerFactor, rfidCardNum=rfidCardNum, outIndex=outIndex, PYSNMP_MODULE_ID=smart, aTSFrequency=aTSFrequency, trapArg3=trapArg3, outLowCurrentTrap=outLowCurrentTrap, inFeedBranchHighCurrentTrap=inFeedBranchHighCurrentTrap, pduBranch=pduBranch, uPSFirmware=uPSFirmware, deviceDaisyChain=deviceDaisyChain, extendTemperatureTable=extendTemperatureTable, pduBranchLowCurrentTrap=pduBranchLowCurrentTrap, deviceExtendTemperatureTotal=deviceExtendTemperatureTotal, extendRHTable=extendRHTable, outWebOperationTrap=outWebOperationTrap, uPSOutputFrequency=uPSOutputFrequency, vibrationDetectPeriod=vibrationDetectPeriod, deviceUnitTotal=deviceUnitTotal, outSwitchStatus=outSwitchStatus, deviceUnitTable=deviceUnitTable, deviceInFeedBranch=deviceInFeedBranch, productPartNumber=productPartNumber, outScheduleTrap=outScheduleTrap, productResetDetector=productResetDetector, micDetectTimes=micDetectTimes, upsOverloadTrap=upsOverloadTrap, uPSTemperature=uPSTemperature, trapArg4=trapArg4, inputDetectTime=inputDetectTime, inFeedHighCurrentTrap=inFeedHighCurrentTrap, deviceInFeedTotal=deviceInFeedTotal, vibrationDetectTimes=vibrationDetectTimes, aTSStatus=aTSStatus, inputTimeout=inputTimeout, uPSBatteryLow=uPSBatteryLow, deviceExtendRHTotal=deviceExtendRHTotal, outCurrent=outCurrent, outOverload=outOverload, deviceUnitInfeedTotal=deviceUnitInfeedTotal, inputEntry=inputEntry, aTSEntry=aTSEntry, inbuiltTemperatureHighTrap=inbuiltTemperatureHighTrap, inputTrap=inputTrap, rfidReader=rfidReader, envTemperatureLowTrap=envTemperatureLowTrap, productModel=productModel, inFeedOverLoad=inFeedOverLoad, inFeedLowWarning=inFeedLowWarning, pduFrequency=pduFrequency, extendRHEntry=extendRHEntry, inputTimeOutTrap=inputTimeOutTrap, smart=smart, extendTemperatureDeviceId=extendTemperatureDeviceId, envConnectTrap=envConnectTrap, pduBranch2Overload=pduBranch2Overload, inbuiltTemperatureHighWarning=inbuiltTemperatureHighWarning, extendRHLowWarning=extendRHLowWarning, pduBranch2HighWarning=pduBranch2HighWarning, inputTable=inputTable, inbuiltTemperatureLowTrap=inbuiltTemperatureLowTrap, inputDefault=inputDefault, outVoltage=outVoltage, aTSTable=aTSTable, vibrationDetec=vibrationDetec, trapArg8=trapArg8, daisyChainConnectTrap=daisyChainConnectTrap, pduLowWarning=pduLowWarning, inFeedVoltage=inFeedVoltage, productTemperatureKind=productTemperatureKind, upsBatteryReplace=upsBatteryReplace, deviceATSKind=deviceATSKind, pduModel=pduModel, inFeedBranch1PowerFactor=inFeedBranch1PowerFactor, inFeedPowerLoad=inFeedPowerLoad, productFirmwareVersion=productFirmwareVersion, outCurrentStatus=outCurrentStatus, extendRHDeviceId=extendRHDeviceId, outPingRebootTrap=outPingRebootTrap, envRHConnectTrap=envRHConnectTrap, deviceTable=deviceTable, deviceInbuiltTempTotal=deviceInbuiltTempTotal, digipdu=digipdu, upsConnectTrap=upsConnectTrap, micDetec=micDetec, smartTraps=smartTraps, inbuiltTemperature=inbuiltTemperature, uPSBatteryLevel=uPSBatteryLevel, pduBranchOverloadTrap=pduBranchOverloadTrap, inFeedBranch=inFeedBranch, extendRH=extendRH, uPSOutputCurrent=uPSOutputCurrent, dataLogTable=dataLogTable, deviceOutKind=deviceOutKind, pduPowerFactor=pduPowerFactor, inputState=inputState, extendTemperatureStatus=extendTemperatureStatus, trapArg1=trapArg1, outComputerStatus=outComputerStatus, inFeedLowCurrentTrap=inFeedLowCurrentTrap, trapArg9=trapArg9, inFeedBranch2PowerLoad=inFeedBranch2PowerLoad, extendTemperatureLowWarning=extendTemperatureLowWarning, deviceUPS=deviceUPS, inFeedEntry=inFeedEntry, outScheduleErrorTrap=outScheduleErrorTrap, micDetectOccurTrap=micDetectOccurTrap, outEntry=outEntry, extendRHHighWarning=extendRHHighWarning, outUPSBatteryLowRecoveryOnTrap=outUPSBatteryLowRecoveryOnTrap, pduOverload=pduOverload, pduStatus=pduStatus, product=product, pduOverloadTrap=pduOverloadTrap, pduTables=pduTables, pduMonitor=pduMonitor, inbuiltTemperatureIndex=inbuiltTemperatureIndex, uPSOutputOverload=uPSOutputOverload, deviceUnitStatus=deviceUnitStatus, trapArg5=trapArg5, inFeedBranch2HighWarning=inFeedBranch2HighWarning, pduHighWarning=pduHighWarning, uPSBatteryRunTime=uPSBatteryRunTime, extendRHMonitor=extendRHMonitor, pduBranch2Current=pduBranch2Current, envTemperatureConnectTrap=envTemperatureConnectTrap, inbuiltTemperatureTable=inbuiltTemperatureTable, envRHLowTrap=envRHLowTrap, inFeedBranch1PowerLoad=inFeedBranch1PowerLoad, inFeedDataList=inFeedDataList, devicePDUTotal=devicePDUTotal, inFeedTable=inFeedTable, deviceUnitEntry=deviceUnitEntry, inFeedPowerEnergy=inFeedPowerEnergy, extendTemperatureMonitor=extendTemperatureMonitor, inFeedBranch1Current=inFeedBranch1Current, extendRHPort=extendRHPort, inFeedBranch2LowWarning=inFeedBranch2LowWarning, pduHighCurrentTrap=pduHighCurrentTrap, inFeedBranch2Current=inFeedBranch2Current, peripheralTables=peripheralTables, extendRHIndex=extendRHIndex, outPanelOperationTrap=outPanelOperationTrap, outConditionCtrlTrap=outConditionCtrlTrap, outHighCurrentTrap=outHighCurrentTrap, upsOnBatteryTrap=upsOnBatteryTrap, pduPowerEnergy=pduPowerEnergy, inFeedStatus=inFeedStatus, pduBranch1Current=pduBranch1Current, pduDataList=pduDataList, uPSBatteryReplace=uPSBatteryReplace, uPSBatteryVoltage=uPSBatteryVoltage, vibrationDetectOccurTrap=vibrationDetectOccurTrap, productSerialNumber=productSerialNumber, trapArg6=trapArg6, outOverloadTrap=outOverloadTrap, inbuiltTemperatureStatus=inbuiltTemperatureStatus, outLowWarning=outLowWarning, aTSVoltage=aTSVoltage, inFeedBranch2OverLoad=inFeedBranch2OverLoad, uPSConnectStatus=uPSConnectStatus, outDataList=outDataList, pduBranch1Overload=pduBranch1Overload, pduBranch2LowWarning=pduBranch2LowWarning, pduBranch1HighWarning=pduBranch1HighWarning, outPowerFactor=outPowerFactor, uPSUARTId=uPSUARTId, inFeedPowerFactor=inFeedPowerFactor, extendTemperatureIndex=extendTemperatureIndex, uPS=uPS, testTrap=testTrap, inFeedBranchLowCurrentTrap=inFeedBranchLowCurrentTrap, inputIndex=inputIndex, inFeedIndex=inFeedIndex, inFeedFrequency=inFeedFrequency, extendTemperatureEntry=extendTemperatureEntry, outUPSBatteryLevelOnTrap=outUPSBatteryLevelOnTrap, arg=arg, uPSInputVoltage=uPSInputVoltage, deviceUnitOutTotal=deviceUnitOutTotal, inbuiltTemperatureLowWarning=inbuiltTemperatureLowWarning, trapArg7=trapArg7, envRHHighTrap=envRHHighTrap, rfidDetectTime=rfidDetectTime, outHighWarning=outHighWarning, pduBranch1LowWarning=pduBranch1LowWarning, pduEntry=pduEntry, pduLowCurrentTrap=pduLowCurrentTrap, envTemperatureHighTrap=envTemperatureHighTrap, uPSSerial=uPSSerial, deviceOutTotal=deviceOutTotal, outUPSBatteryLevelOffTrap=outUPSBatteryLevelOffTrap, deviceInFeedKind=deviceInFeedKind, extendTemperaturePort=extendTemperaturePort, uPSOutputVoltage=uPSOutputVoltage, outTable=outTable, aTSIndex=aTSIndex, extendRHStatus=extendRHStatus, uPSModel=uPSModel, micLastDetectTime=micLastDetectTime, inFeedBranch1OverLoad=inFeedBranch1OverLoad, outUPSACRecoveryOnTrap=outUPSACRecoveryOnTrap, extendTemperature=extendTemperature, pduVoltage=pduVoltage, pduIndex=pduIndex, trap=trap, outAPIOperationTrap=outAPIOperationTrap, pduCurrent=pduCurrent, inFeedBranch1LowWarning=inFeedBranch1LowWarning, inFeedOverloadTrap=inFeedOverloadTrap, inFeedBranch1HighWarning=inFeedBranch1HighWarning, deviceInputTotal=deviceInputTotal, outPowerLoad=outPowerLoad, uPSOutputOnBattery=uPSOutputOnBattery, vibrationLastDetectTime=vibrationLastDetectTime, outPingTrap=outPingTrap, upsBatteryLowTrap=upsBatteryLowTrap, inFeedHighWarning=inFeedHighWarning, inbuiltTemperatureEntry=inbuiltTemperatureEntry, micDetectPeriod=micDetectPeriod, inFeedCurrent=inFeedCurrent, outSwitchCtrl=outSwitchCtrl, pduPowerLoad=pduPowerLoad, deviceUnitIndex=deviceUnitIndex, pduConnectTrap=pduConnectTrap, outUPSACFaultOffTrap=outUPSACFaultOffTrap, outUPSBatteryLowOffTrap=outUPSBatteryLowOffTrap, inputStatus=inputStatus, uPSOutputLoad=uPSOutputLoad, extendTemperatureHighWarning=extendTemperatureHighWarning, uPSBatteryDate=uPSBatteryDate)
