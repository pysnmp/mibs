...
mibBuilder.exportSymbols("DIGIPDU-MIB", uPSOutputLoad=uPSOutputLoad, deviceUnitStatus=deviceUnitStatus, outLowWarning=outLowWarning, uPSBatteryReplace=uPSBatteryReplace, outCurrentStatus=outCurrentStatus, pduHighWarning=pduHighWarning, deviceUnitTable=deviceUnitTable, outUPSBatteryLevelOnTrap=outUPSBatteryLevelOnTrap, dataLogTable=dataLogTable, trapArg8=trapArg8, inFeedBranch2OverLoad=inFeedBranch2OverLoad, outEntry=outEntry, aTSVoltage=aTSVoltage, uPSOutputCurrent=uPSOutputCurrent, micDetectTimes=micDetectTimes, pduBranch2Overload=pduBranch2Overload, trapArg3=trapArg3, deviceTable=deviceTable, trapArg5=trapArg5, inputDetectTime=inputDetectTime, outPingTrap=outPingTrap, envRHLowTrap=envRHLowTrap, uPSBatteryRunTime=uPSBatteryRunTime, uPSFirmware=uPSFirmware, uPSOutputFrequency=uPSOutputFrequency, extendTemperatureIndex=extendTemperatureIndex, inbuiltTemperatureLowTrap=inbuiltTemperatureLowTrap, trapArg9=trapArg9, inbuiltTemperatureEntry=inbuiltTemperatureEntry, inFeedBranchHighCurrentTrap=inFeedBranchHighCurrentTrap, uPSConnectStatus=uPSConnectStatus, pduBranchLowCurrentTrap=pduBranchLowCurrentTrap, uPSOutputOverload=uPSOutputOverload, extendRHTable=extendRHTable, extendTemperature=extendTemperature, pduBranchHighCurrentTrap=pduBranchHighCurrentTrap, outPowerLoad=outPowerLoad, inbuiltTemperatureTable=inbuiltTemperatureTable, extendTemperatureMonitor=extendTemperatureMonitor, vibrationLastDetectTime=vibrationLastDetectTime, uPSUARTId=uPSUARTId, outHighWarning=outHighWarning, inputIndex=inputIndex, pduDataList=pduDataList, pduMonitor=pduMonitor, extendTemperatureTable=extendTemperatureTable, deviceOutKind=deviceOutKind, pduLowWarning=pduLowWarning, deviceATSKind=deviceATSKind, extendRHLowWarning=extendRHLowWarning, vibrationDetec=vibrationDetec, outIndex=outIndex, pduBranchOverloadTrap=pduBranchOverloadTrap, inFeedHighWarning=inFeedHighWarning, inFeedCurrent=inFeedCurrent, envTemperatureConnectTrap=envTemperatureConnectTrap, inputTimeout=inputTimeout, outScheduleErrorTrap=outScheduleErrorTrap, inFeedHighCurrentTrap=inFeedHighCurrentTrap, inFeedBranch1PowerFactor=inFeedBranch1PowerFactor, productModel=productModel, inbuiltTemperatureHighWarning=inbuiltTemperatureHighWarning, inFeedBranch1LowWarning=inFeedBranch1LowWarning, aTSTable=aTSTable, micLastDetectTime=micLastDetectTime, envTemperatureHighTrap=envTemperatureHighTrap, inFeedFrequency=inFeedFrequency, upsOnBatteryTrap=upsOnBatteryTrap, deviceExtendRHTotal=deviceExtendRHTotal, extendRHHighWarning=extendRHHighWarning, smart=smart, uPSBatteryLevel=uPSBatteryLevel, deviceOutTotal=deviceOutTotal, extendRHDeviceId=extendRHDeviceId, daisyChainConnectTrap=daisyChainConnectTrap, uPS=uPS, deviceInputTotal=deviceInputTotal, inFeedPowerLoad=inFeedPowerLoad, inFeedBranch1Current=inFeedBranch1Current, deviceUnitInfeedTotal=deviceUnitInfeedTotal, extendRHStatus=extendRHStatus, inFeedIndex=inFeedIndex, pduEntry=pduEntry, uPSOutputVoltage=uPSOutputVoltage, product=product, inputStatus=inputStatus, trapArg7=trapArg7, testTrap=testTrap, inputDefault=inputDefault, uPSBatteryVoltage=uPSBatteryVoltage, inFeedLowCurrentTrap=inFeedLowCurrentTrap, extendRHPort=extendRHPort, pduStatus=pduStatus, upsBatteryLowTrap=upsBatteryLowTrap, inFeedBranch1PowerLoad=inFeedBranch1PowerLoad, devicePDUTotal=devicePDUTotal, inFeedTable=inFeedTable, extendRHEntry=extendRHEntry, trap=trap, inFeedBranch2Current=inFeedBranch2Current, pduVoltage=pduVoltage, inputEntry=inputEntry, pduLowCurrentTrap=pduLowCurrentTrap, pduCurrent=pduCurrent, rfidCardNum=rfidCardNum, outVoltage=outVoltage, outUPSACFaultOffTrap=outUPSACFaultOffTrap, upsConnectTrap=upsConnectTrap, deviceInFeedKind=deviceInFeedKind, extendTemperatureHighWarning=extendTemperatureHighWarning, inbuiltTemperatureIndex=inbuiltTemperatureIndex, aTSEntry=aTSEntry, aTSIndex=aTSIndex, envConnectTrap=envConnectTrap, rfidReader=rfidReader, vibrationDetectPeriod=vibrationDetectPeriod, deviceUnitEntry=deviceUnitEntry, pduBranch1Overload=pduBranch1Overload, micDetec=micDetec, deviceDaisyChain=deviceDaisyChain, PYSNMP_MODULE_ID=smart, outPanelOperationTrap=outPanelOperationTrap, upsOverloadTrap=upsOverloadTrap, pduPowerFactor=pduPowerFactor, micDetectPeriod=micDetectPeriod, outUPSBatteryLowOffTrap=outUPSBatteryLowOffTrap, vibrationDetectTimes=vibrationDetectTimes, pduConnectTrap=pduConnectTrap, inFeedEntry=inFeedEntry, deviceUPS=deviceUPS, pduModel=pduModel, pduBranch2HighWarning=pduBranch2HighWarning, vibrationDetectOccurTrap=vibrationDetectOccurTrap, uPSBatteryLow=uPSBatteryLow, outUPSACRecoveryOnTrap=outUPSACRecoveryOnTrap, inFeedOverLoad=inFeedOverLoad, peripheralTables=peripheralTables, pduBranch=pduBranch, inputTrap=inputTrap, trapArg1=trapArg1, trapArg4=trapArg4, outUPSBatteryLowRecoveryOnTrap=outUPSBatteryLowRecoveryOnTrap, inFeedVoltage=inFeedVoltage, inFeedBranch1HighWarning=inFeedBranch1HighWarning, pduPowerEnergy=pduPowerEnergy, envRHHighTrap=envRHHighTrap, outSwitchStatus=outSwitchStatus, inFeedOverloadTrap=inFeedOverloadTrap, outAPIOperationTrap=outAPIOperationTrap, extendRHIndex=extendRHIndex, pduBranch1Current=pduBranch1Current, uPSInputVoltage=uPSInputVoltage, deviceInFeedBranch=deviceInFeedBranch, pduPowerLoad=pduPowerLoad, inFeedLowWarning=inFeedLowWarning, inbuiltTemperatureLowWarning=inbuiltTemperatureLowWarning, outTable=outTable, outCurrent=outCurrent, pduTables=pduTables, outHighCurrentTrap=outHighCurrentTrap, extendTemperatureDeviceId=extendTemperatureDeviceId, inFeedBranch1OverLoad=inFeedBranch1OverLoad, smartTraps=smartTraps, aTSStatus=aTSStatus, inputState=inputState, deviceUnitIndex=deviceUnitIndex, pduIndex=pduIndex, rfidDetectTime=rfidDetectTime, outScheduleTrap=outScheduleTrap, productTemperatureKind=productTemperatureKind, productSerialNumber=productSerialNumber, inFeedBranch=inFeedBranch, deviceUnitOutTotal=deviceUnitOutTotal, deviceInbuiltTempTotal=deviceInbuiltTempTotal, outComputerStatus=outComputerStatus, extendTemperatureEntry=extendTemperatureEntry, inFeedBranch2PowerFactor=inFeedBranch2PowerFactor, outPingRebootTrap=outPingRebootTrap, envRHConnectTrap=envRHConnectTrap, outSwitchCtrl=outSwitchCtrl, outConditionCtrlTrap=outConditionCtrlTrap, pduHighCurrentTrap=pduHighCurrentTrap, uPSSerial=uPSSerial, inFeedDataList=inFeedDataList, pduBranch1HighWarning=pduBranch1HighWarning, inFeedBranch2LowWarning=inFeedBranch2LowWarning, inFeedPowerEnergy=inFeedPowerEnergy, trapArg2=trapArg2, pduFrequency=pduFrequency, upsBatteryReplace=upsBatteryReplace, inFeedBranch2HighWarning=inFeedBranch2HighWarning, inFeedPowerFactor=inFeedPowerFactor, extendRHMonitor=extendRHMonitor, deviceUnitTotal=deviceUnitTotal, outOverload=outOverload, outWebOperationTrap=outWebOperationTrap, extendTemperatureStatus=extendTemperatureStatus, trapArg6=trapArg6, inbuiltTemperature=inbuiltTemperature, pduBranch2LowWarning=pduBranch2LowWarning, outLowCurrentTrap=outLowCurrentTrap, productPartNumber=productPartNumber, outDataList=outDataList, extendRH=extendRH, pduOverloadTrap=pduOverloadTrap, productFirmwareVersion=productFirmwareVersion, digipdu=digipdu, inputTimeOutTrap=inputTimeOutTrap, aTSFrequency=aTSFrequency, pduBranch2Current=pduBranch2Current, uPSModel=uPSModel, uPSTemperature=uPSTemperature, outOverloadTrap=outOverloadTrap, deviceExtendTemperatureTotal=deviceExtendTemperatureTotal, micDetectOccurTrap=micDetectOccurTrap, extendTemperatureLowWarning=extendTemperatureLowWarning, inFeedBranchOverloadTrap=inFeedBranchOverloadTrap, productResetDetector=productResetDetector, pduBranch1LowWarning=pduBranch1LowWarning, arg=arg, inbuiltTemperatureStatus=inbuiltTemperatureStatus, uPSBatteryDate=uPSBatteryDate, inFeedBranchLowCurrentTrap=inFeedBranchLowCurrentTrap, outPowerFactor=outPowerFactor, inFeedStatus=inFeedStatus, inFeedBranch2PowerLoad=inFeedBranch2PowerLoad, inbuiltTemperatureHighTrap=inbuiltTemperatureHighTrap, deviceInFeedTotal=deviceInFeedTotal, outUPSBatteryLevelOffTrap=outUPSBatteryLevelOffTrap, pduOverload=pduOverload, inputTable=inputTable, extendTemperaturePort=extendTemperaturePort, uPSOutputOnBattery=uPSOutputOnBattery, envTemperatureLowTrap=envTemperatureLowTrap)
