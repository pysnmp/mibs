...
PerfCounter64, SecondaryState, VlanPriority, AdminState, OperationalState, CmPmBinAction = mibBuilder.importSymbols("CM-COMMON-MIB", "PerfCounter64", "SecondaryState", "VlanPriority", "AdminState", "OperationalState", "CmPmBinAction")
...
mibBuilder.exportSymbols("F3-CFM-MIB", CfmSlmEnabledTypes=CfmSlmEnabledTypes, cfmMepOperationalState=cfmMepOperationalState, cfmMepStatsAction=cfmMepStatsAction, cfmMepTagEtherType=cfmMepTagEtherType, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmMepDefects=cfmMepDefects, cfmPortShaperGroup=cfmPortShaperGroup, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmLlbMacAddress=cfmLlbMacAddress, cfmMepTable=cfmMepTable, cfmMaCompTable=cfmMaCompTable, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmMepLbrMepId=cfmMepLbrMepId, cfmMaCompEntity=cfmMaCompEntity, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmServerMepGroup=cfmServerMepGroup, slrOpcode=slrOpcode, cfmMepAisPriority=cfmMepAisPriority, cfmMepRxCCMs=cfmMepRxCCMs, cfmMepEntry=cfmMepEntry, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, cfmMepAdminState=cfmMepAdminState, cfmExtSvcGroups=cfmExtSvcGroups, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmMepLlbVidList=cfmMepLlbVidList, cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmExtSvcObjects=cfmExtSvcObjects, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, cfmGenGroup=cfmGenGroup, cfmMepSecondaryState=cfmMepSecondaryState, cfmMepAisInterval=cfmMepAisInterval, cfmMacAddress=cfmMacAddress, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmMepDmPriority=cfmMepDmPriority, cfmMaNetEntry=cfmMaNetEntry, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmExtGroup=cfmExtGroup, CfmMepDefects=CfmMepDefects, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmMepErrCCMs=cfmMepErrCCMs, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, CfmLLFTriggerTypes=CfmLLFTriggerTypes, cfmServerMepSecondaryState=cfmServerMepSecondaryState, cfmExtCompliance=cfmExtCompliance, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmMaNetTable=cfmMaNetTable, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmServerMepStorageType=cfmServerMepStorageType, cfmMepLbrEntry=cfmMepLbrEntry, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, cfmExtSvc=cfmExtSvc, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmMaCompEntry=cfmMaCompEntry, cfmMepPduVersion=cfmMepPduVersion, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, CfmAisInterval=CfmAisInterval, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmServerMepRowStatus=cfmServerMepRowStatus, cfmEthType=cfmEthType, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, cfmServerMepAisPriority=cfmServerMepAisPriority, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, slmOpcode=slmOpcode, cfmServerMepTable=cfmServerMepTable, cfmServerMepIndex=cfmServerMepIndex, cfmMepGroup=cfmMepGroup, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmExtSvcConformance=cfmExtSvcConformance, cfmExtScalars=cfmExtScalars, cfmServerMepAdminState=cfmServerMepAdminState, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, cfmServerMepEntry=cfmServerMepEntry, CfmPduVersionType=CfmPduVersionType, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, cfmMaCompGroup=cfmMaCompGroup, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, slmMulticastMacAddress=slmMulticastMacAddress, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmMepLbmInterval=cfmMepLbmInterval, f3CfmMIB=f3CfmMIB, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmMepLbrTable=cfmMepLbrTable, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmMaNetMepNumbers=cfmMaNetMepNumbers, cfmMaCompIndex=cfmMaCompIndex, CfmLmmDmmInterval=CfmLmmDmmInterval, PYSNMP_MODULE_ID=f3CfmMIB)
