...
SecondaryState, VlanPriority, AdminState, CmPmBinAction, OperationalState, PerfCounter64 = mibBuilder.importSymbols("CM-COMMON-MIB", "SecondaryState", "VlanPriority", "AdminState", "CmPmBinAction", "OperationalState", "PerfCounter64")
...
mibBuilder.exportSymbols("F3-CFM-MIB", cfmMepAdminState=cfmMepAdminState, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmServerMepAdminState=cfmServerMepAdminState, cfmMaCompEntry=cfmMaCompEntry, f3CfmMIB=f3CfmMIB, CfmAisInterval=CfmAisInterval, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmServerMepEntry=cfmServerMepEntry, cfmExtCompliance=cfmExtCompliance, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmExtSvc=cfmExtSvc, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmMepSecondaryState=cfmMepSecondaryState, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, CfmLLFTriggerTypes=CfmLLFTriggerTypes, CfmSlmEnabledTypes=CfmSlmEnabledTypes, cfmServerMepSecondaryState=cfmServerMepSecondaryState, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmMepGroup=cfmMepGroup, cfmMaNetEntry=cfmMaNetEntry, cfmMepRxCCMs=cfmMepRxCCMs, cfmMaNetTable=cfmMaNetTable, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, cfmMepPduVersion=cfmMepPduVersion, cfmServerMepTable=cfmServerMepTable, cfmExtScalars=cfmExtScalars, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, slmOpcode=slmOpcode, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmEthType=cfmEthType, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmMepStatsAction=cfmMepStatsAction, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmMepTable=cfmMepTable, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, cfmMepOperationalState=cfmMepOperationalState, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmServerMepAisPriority=cfmServerMepAisPriority, cfmExtSvcConformance=cfmExtSvcConformance, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, cfmMepAisInterval=cfmMepAisInterval, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, cfmMepLlbVidList=cfmMepLlbVidList, cfmServerMepStorageType=cfmServerMepStorageType, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmMaCompGroup=cfmMaCompGroup, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmMepTagEtherType=cfmMepTagEtherType, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmMacAddress=cfmMacAddress, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmLlbMacAddress=cfmLlbMacAddress, CfmPduVersionType=CfmPduVersionType, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmGenGroup=cfmGenGroup, cfmExtGroup=cfmExtGroup, cfmMepLbmInterval=cfmMepLbmInterval, cfmPortShaperGroup=cfmPortShaperGroup, PYSNMP_MODULE_ID=f3CfmMIB, slmMulticastMacAddress=slmMulticastMacAddress, cfmServerMepIndex=cfmServerMepIndex, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmMepDefects=cfmMepDefects, cfmServerMepRowStatus=cfmServerMepRowStatus, cfmMepLbrTable=cfmMepLbrTable, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmMaCompEntity=cfmMaCompEntity, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, slrOpcode=slrOpcode, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmMaCompIndex=cfmMaCompIndex, CfmLmmDmmInterval=CfmLmmDmmInterval, cfmMaCompTable=cfmMaCompTable, cfmExtSvcObjects=cfmExtSvcObjects, cfmMepEntry=cfmMepEntry, cfmMepErrCCMs=cfmMepErrCCMs, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, cfmMepAisPriority=cfmMepAisPriority, cfmMaNetMepNumbers=cfmMaNetMepNumbers, CfmMepDefects=CfmMepDefects, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmMepLbrMepId=cfmMepLbrMepId, cfmExtSvcGroups=cfmExtSvcGroups, cfmServerMepGroup=cfmServerMepGroup, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmMepDmPriority=cfmMepDmPriority, cfmMepLbrEntry=cfmMepLbrEntry)
