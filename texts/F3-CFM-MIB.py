...
PerfCounter64, CmPmBinAction, OperationalState, VlanPriority, AdminState, SecondaryState = mibBuilder.importSymbols("CM-COMMON-MIB", "PerfCounter64", "CmPmBinAction", "OperationalState", "VlanPriority", "AdminState", "SecondaryState")
...
mibBuilder.exportSymbols("F3-CFM-MIB", cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, CfmPduVersionType=CfmPduVersionType, cfmMepLbrTable=cfmMepLbrTable, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmServerMepRowStatus=cfmServerMepRowStatus, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, f3CfmMIB=f3CfmMIB, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, cfmMepErrCCMs=cfmMepErrCCMs, cfmMepDmPriority=cfmMepDmPriority, cfmMaCompTable=cfmMaCompTable, cfmMepGroup=cfmMepGroup, CfmLmmDmmInterval=CfmLmmDmmInterval, cfmMaCompIndex=cfmMaCompIndex, cfmServerMepEntry=cfmServerMepEntry, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, CfmLLFTriggerTypes=CfmLLFTriggerTypes, CfmAisInterval=CfmAisInterval, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, cfmExtSvcConformance=cfmExtSvcConformance, cfmMepEntry=cfmMepEntry, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmMaNetTable=cfmMaNetTable, cfmServerMepSecondaryState=cfmServerMepSecondaryState, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, slmOpcode=slmOpcode, cfmPortShaperGroup=cfmPortShaperGroup, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmGenGroup=cfmGenGroup, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmMepLbmInterval=cfmMepLbmInterval, cfmEthType=cfmEthType, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmMepDefects=cfmMepDefects, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, PYSNMP_MODULE_ID=f3CfmMIB, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmMaNetEntry=cfmMaNetEntry, cfmMepOperationalState=cfmMepOperationalState, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, cfmMaCompGroup=cfmMaCompGroup, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmServerMepStorageType=cfmServerMepStorageType, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmMepLbrMepId=cfmMepLbrMepId, slrOpcode=slrOpcode, cfmMepAisInterval=cfmMepAisInterval, cfmMaCompEntry=cfmMaCompEntry, cfmExtSvcGroups=cfmExtSvcGroups, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmMacAddress=cfmMacAddress, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmExtSvc=cfmExtSvc, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, CfmMepDefects=CfmMepDefects, cfmServerMepAdminState=cfmServerMepAdminState, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmMaNetMepNumbers=cfmMaNetMepNumbers, cfmExtScalars=cfmExtScalars, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmMepTable=cfmMepTable, cfmMepTagEtherType=cfmMepTagEtherType, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmExtSvcObjects=cfmExtSvcObjects, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmExtCompliance=cfmExtCompliance, cfmMepLlbVidList=cfmMepLlbVidList, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, cfmMaCompEntity=cfmMaCompEntity, cfmMepSecondaryState=cfmMepSecondaryState, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, cfmMepLbrEntry=cfmMepLbrEntry, cfmMepAisPriority=cfmMepAisPriority, cfmServerMepTable=cfmServerMepTable, CfmSlmEnabledTypes=CfmSlmEnabledTypes, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmServerMepIndex=cfmServerMepIndex, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, cfmServerMepGroup=cfmServerMepGroup, slmMulticastMacAddress=slmMulticastMacAddress, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmMepStatsAction=cfmMepStatsAction, cfmServerMepAisPriority=cfmServerMepAisPriority, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmMepRxCCMs=cfmMepRxCCMs, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, cfmExtGroup=cfmExtGroup, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmMepAdminState=cfmMepAdminState, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmLlbMacAddress=cfmLlbMacAddress, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmMepPduVersion=cfmMepPduVersion)
