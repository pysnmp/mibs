...
PerfCounter64, SecondaryState, CmPmBinAction, VlanPriority, AdminState, OperationalState = mibBuilder.importSymbols("CM-COMMON-MIB", "PerfCounter64", "SecondaryState", "CmPmBinAction", "VlanPriority", "AdminState", "OperationalState")
...
mibBuilder.exportSymbols("F3-CFM-MIB", cfmServerMepAisPriority=cfmServerMepAisPriority, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, cfmMepAdminState=cfmMepAdminState, CfmPduVersionType=CfmPduVersionType, cfmMepSecondaryState=cfmMepSecondaryState, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmExtSvcGroups=cfmExtSvcGroups, cfmExtCompliance=cfmExtCompliance, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, cfmServerMepSecondaryState=cfmServerMepSecondaryState, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, cfmMaCompIndex=cfmMaCompIndex, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, CfmMepDefects=CfmMepDefects, cfmExtGroup=cfmExtGroup, cfmExtScalars=cfmExtScalars, cfmMepDefects=cfmMepDefects, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmExtSvcCompliances=cfmExtSvcCompliances, slmOpcode=slmOpcode, slrOpcode=slrOpcode, cfmMaNetMepNumbers=cfmMaNetMepNumbers, slmMulticastMacAddress=slmMulticastMacAddress, cfmServerMepTable=cfmServerMepTable, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmMepLbrMepId=cfmMepLbrMepId, cfmMaCompTable=cfmMaCompTable, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmMepAisInterval=cfmMepAisInterval, cfmPortShaperGroup=cfmPortShaperGroup, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmServerMepStorageType=cfmServerMepStorageType, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmMepDmPriority=cfmMepDmPriority, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmExtSvcObjects=cfmExtSvcObjects, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmMaCompEntry=cfmMaCompEntry, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmLlbMacAddress=cfmLlbMacAddress, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, cfmEthType=cfmEthType, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmMepAisPriority=cfmMepAisPriority, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, cfmMepEntry=cfmMepEntry, PYSNMP_MODULE_ID=f3CfmMIB, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmMaCompEntity=cfmMaCompEntity, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmMepStatsAction=cfmMepStatsAction, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmMepLbrEntry=cfmMepLbrEntry, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmGenGroup=cfmGenGroup, CfmAisInterval=CfmAisInterval, cfmMepLlbVidList=cfmMepLlbVidList, cfmMepPduVersion=cfmMepPduVersion, cfmMepLbmInterval=cfmMepLbmInterval, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmMaNetTable=cfmMaNetTable, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, CfmLLFTriggerTypes=CfmLLFTriggerTypes, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmExtSvc=cfmExtSvc, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmMacAddress=cfmMacAddress, cfmMepRxCCMs=cfmMepRxCCMs, cfmMepLbrTable=cfmMepLbrTable, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmExtSvcConformance=cfmExtSvcConformance, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, CfmSlmEnabledTypes=CfmSlmEnabledTypes, cfmMaNetEntry=cfmMaNetEntry, cfmMepTable=cfmMepTable, cfmMepTagEtherType=cfmMepTagEtherType, cfmMepOperationalState=cfmMepOperationalState, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, cfmMepGroup=cfmMepGroup, cfmMepErrCCMs=cfmMepErrCCMs, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmServerMepRowStatus=cfmServerMepRowStatus, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmServerMepEntry=cfmServerMepEntry, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmServerMepGroup=cfmServerMepGroup, CfmLmmDmmInterval=CfmLmmDmmInterval, cfmServerMepIndex=cfmServerMepIndex, f3CfmMIB=f3CfmMIB, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, cfmServerMepAdminState=cfmServerMepAdminState, cfmMaCompGroup=cfmMaCompGroup)
