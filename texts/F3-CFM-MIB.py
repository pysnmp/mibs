...
mibBuilder.exportSymbols("F3-CFM-MIB", cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, cfmExtSvcGroups=cfmExtSvcGroups, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmServerMepIndex=cfmServerMepIndex, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmMepAssociatedObject=cfmMepAssociatedObject, slmOpcode=slmOpcode, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmLlbMacAddress=cfmLlbMacAddress, PYSNMP_MODULE_ID=f3CfmMIB, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, CfmPduVersionType=CfmPduVersionType, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, cfmGenGroup=cfmGenGroup, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, cfmServerMepEntry=cfmServerMepEntry, cfmMepLlbVidList=cfmMepLlbVidList, slmMulticastMacAddress=slmMulticastMacAddress, cfmMepAisInterval=cfmMepAisInterval, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, cfmMepLbrMepId=cfmMepLbrMepId, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, cfmMepAisPriority=cfmMepAisPriority, cfmMepEntry=cfmMepEntry, cfmMacAddress=cfmMacAddress, cfmMepLbrTable=cfmMepLbrTable, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmExtSvc=cfmExtSvc, CfmLLFTriggerTypes=CfmLLFTriggerTypes, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmMaCompEntry=cfmMaCompEntry, cfmExtCompliance=cfmExtCompliance, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmServerMepStorageType=cfmServerMepStorageType, cfmEthType=cfmEthType, cfmMaNetTable=cfmMaNetTable, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmMepLbrEntry=cfmMepLbrEntry, cfmServerMepGroup=cfmServerMepGroup, cfmMepSlmEnabled=cfmMepSlmEnabled, CfmSlmEnabledTypes=CfmSlmEnabledTypes, cfmServerMepRowStatus=cfmServerMepRowStatus, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, cfmMaCompTable=cfmMaCompTable, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmMepDefects=cfmMepDefects, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, cfmMepAdminState=cfmMepAdminState, cfmPortShaperGroup=cfmPortShaperGroup, f3CfmMIB=f3CfmMIB, cfmMaCompEntity=cfmMaCompEntity, cfmMepOperationalState=cfmMepOperationalState, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, cfmMepSecondaryState=cfmMepSecondaryState, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmMepStatsAction=cfmMepStatsAction, cfmServerMepAisPriority=cfmServerMepAisPriority, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, cfmMaNetEntry=cfmMaNetEntry, cfmMepGroup=cfmMepGroup, cfmMepLbmInterval=cfmMepLbmInterval, cfmExtSvcConformance=cfmExtSvcConformance, CfmMepDefects=CfmMepDefects, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, CfmAisInterval=CfmAisInterval, cfmServerMepTable=cfmServerMepTable, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmServerMepAdminState=cfmServerMepAdminState, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmMepErrCCMs=cfmMepErrCCMs, CfmLmmDmmInterval=CfmLmmDmmInterval, cfmExtScalars=cfmExtScalars, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, cfmExtSvcObjects=cfmExtSvcObjects, cfmMepDmPriority=cfmMepDmPriority, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, slrOpcode=slrOpcode, cfmMaNetMepNumbers=cfmMaNetMepNumbers, cfmServerMepSecondaryState=cfmServerMepSecondaryState, cfmMepTable=cfmMepTable, cfmMepPduVersion=cfmMepPduVersion, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmMaCompGroup=cfmMaCompGroup, cfmMepRxCCMs=cfmMepRxCCMs, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmMaCompIndex=cfmMaCompIndex, cfmMepTagEtherType=cfmMepTagEtherType, cfmExtGroup=cfmExtGroup)
