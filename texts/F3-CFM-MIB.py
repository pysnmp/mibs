...
OperationalState, SecondaryState, VlanPriority, CmPmBinAction, PerfCounter64, AdminState = mibBuilder.importSymbols("CM-COMMON-MIB", "OperationalState", "SecondaryState", "VlanPriority", "CmPmBinAction", "PerfCounter64", "AdminState")
...
mibBuilder.exportSymbols("F3-CFM-MIB", cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmServerMepAisPriority=cfmServerMepAisPriority, cfmExtCompliance=cfmExtCompliance, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmMepAisInterval=cfmMepAisInterval, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, cfmServerMepSecondaryState=cfmServerMepSecondaryState, cfmServerMepIndex=cfmServerMepIndex, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmMaCompEntity=cfmMaCompEntity, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmMaNetEntry=cfmMaNetEntry, cfmServerMepAdminState=cfmServerMepAdminState, cfmGenGroup=cfmGenGroup, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmServerMepGroup=cfmServerMepGroup, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmEthType=cfmEthType, PYSNMP_MODULE_ID=f3CfmMIB, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, cfmMepSecondaryState=cfmMepSecondaryState, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, slrOpcode=slrOpcode, CfmLLFTriggerTypes=CfmLLFTriggerTypes, cfmMepErrCCMs=cfmMepErrCCMs, cfmMepPduVersion=cfmMepPduVersion, cfmServerMepEntry=cfmServerMepEntry, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, CfmLmmDmmInterval=CfmLmmDmmInterval, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, cfmPortShaperGroup=cfmPortShaperGroup, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmLlbMacAddress=cfmLlbMacAddress, slmOpcode=slmOpcode, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, cfmMepLbrEntry=cfmMepLbrEntry, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmServerMepStorageType=cfmServerMepStorageType, cfmMepRxCCMs=cfmMepRxCCMs, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, cfmExtGroup=cfmExtGroup, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmServerMepTable=cfmServerMepTable, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmMepLlbVidList=cfmMepLlbVidList, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, slmMulticastMacAddress=slmMulticastMacAddress, cfmMepDmPriority=cfmMepDmPriority, f3CfmMIB=f3CfmMIB, cfmMepDefects=cfmMepDefects, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, cfmMaNetTable=cfmMaNetTable, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmExtSvcObjects=cfmExtSvcObjects, CfmPduVersionType=CfmPduVersionType, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmExtSvcGroups=cfmExtSvcGroups, cfmMacAddress=cfmMacAddress, cfmExtSvcConformance=cfmExtSvcConformance, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmMepTagEtherType=cfmMepTagEtherType, cfmMepLbrMepId=cfmMepLbrMepId, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmMepLbrTable=cfmMepLbrTable, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmExtSvc=cfmExtSvc, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmMaCompTable=cfmMaCompTable, cfmMepStatsAction=cfmMepStatsAction, cfmMepGroup=cfmMepGroup, cfmMaCompEntry=cfmMaCompEntry, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, cfmMaNetMepNumbers=cfmMaNetMepNumbers, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmMepTable=cfmMepTable, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmMepAisGenEnabled=cfmMepAisGenEnabled, CfmSlmEnabledTypes=CfmSlmEnabledTypes, cfmMepAisPriority=cfmMepAisPriority, cfmMepLbmInterval=cfmMepLbmInterval, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, cfmMaCompGroup=cfmMaCompGroup, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, cfmMepOperationalState=cfmMepOperationalState, cfmMepEntry=cfmMepEntry, CfmMepDefects=CfmMepDefects, cfmMepLmTxPriority=cfmMepLmTxPriority, CfmAisInterval=CfmAisInterval, cfmExtScalars=cfmExtScalars, cfmMepAdminState=cfmMepAdminState, cfmServerMepRowStatus=cfmServerMepRowStatus, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmMaCompIndex=cfmMaCompIndex)
