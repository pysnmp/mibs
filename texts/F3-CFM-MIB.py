...
mibBuilder.exportSymbols("F3-CFM-MIB", slmMulticastMacAddress=slmMulticastMacAddress, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmMepTagEtherType=cfmMepTagEtherType, cfmServerMepIndex=cfmServerMepIndex, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmMepLlbVidList=cfmMepLlbVidList, cfmExtSvcGroups=cfmExtSvcGroups, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, cfmMepDmPriority=cfmMepDmPriority, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmMepPduVersion=cfmMepPduVersion, cfmMepAdminState=cfmMepAdminState, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmMaCompGroup=cfmMaCompGroup, cfmEthType=cfmEthType, cfmMepLbrMepId=cfmMepLbrMepId, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmExtSvc=cfmExtSvc, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, cfmServerMepEntry=cfmServerMepEntry, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, cfmExtGroup=cfmExtGroup, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmMaCompEntity=cfmMaCompEntity, cfmMepLbrEntry=cfmMepLbrEntry, cfmMacAddress=cfmMacAddress, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmMaNetEntry=cfmMaNetEntry, cfmServerMepSecondaryState=cfmServerMepSecondaryState, slmOpcode=slmOpcode, cfmMaCompEntry=cfmMaCompEntry, cfmMaNetTable=cfmMaNetTable, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, CfmPduVersionType=CfmPduVersionType, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmMepLbmInterval=cfmMepLbmInterval, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, cfmExtScalars=cfmExtScalars, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, PYSNMP_MODULE_ID=f3CfmMIB, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmMepRxCCMs=cfmMepRxCCMs, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmExtSvcConformance=cfmExtSvcConformance, CfmLmmDmmInterval=CfmLmmDmmInterval, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, CfmSlmEnabledTypes=CfmSlmEnabledTypes, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, CfmAisInterval=CfmAisInterval, cfmMepSecondaryState=cfmMepSecondaryState, cfmMepErrCCMs=cfmMepErrCCMs, cfmMepEntry=cfmMepEntry, cfmExtCompliance=cfmExtCompliance, slrOpcode=slrOpcode, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmServerMepTable=cfmServerMepTable, cfmMaCompIndex=cfmMaCompIndex, cfmMepAisInterval=cfmMepAisInterval, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmMepTable=cfmMepTable, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, cfmServerMepStorageType=cfmServerMepStorageType, cfmMaCompTable=cfmMaCompTable, CfmLLFTriggerTypes=CfmLLFTriggerTypes, cfmMepLbrTable=cfmMepLbrTable, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmMepGroup=cfmMepGroup, cfmMepOperationalState=cfmMepOperationalState, cfmServerMepAdminState=cfmServerMepAdminState, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmExtSvcObjects=cfmExtSvcObjects, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, cfmLlbMacAddress=cfmLlbMacAddress, CfmMepDefects=CfmMepDefects, cfmMepStatsAction=cfmMepStatsAction, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmPortShaperGroup=cfmPortShaperGroup, cfmServerMepAisPriority=cfmServerMepAisPriority, f3CfmMIB=f3CfmMIB, cfmServerMepRowStatus=cfmServerMepRowStatus, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmGenGroup=cfmGenGroup, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmMepDefects=cfmMepDefects, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmServerMepGroup=cfmServerMepGroup, cfmMepAisPriority=cfmMepAisPriority, cfmMaNetMepNumbers=cfmMaNetMepNumbers)
