...
PerfCounter64, OperationalState, VlanPriority, AdminState, CmPmBinAction, SecondaryState = mibBuilder.importSymbols("CM-COMMON-MIB", "PerfCounter64", "OperationalState", "VlanPriority", "AdminState", "CmPmBinAction", "SecondaryState")
...
mibBuilder.exportSymbols("F3-CFM-MIB", cfmMepLmTxPriority=cfmMepLmTxPriority, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmMepErrCCMs=cfmMepErrCCMs, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, CfmAisInterval=CfmAisInterval, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmMepTable=cfmMepTable, cfmMepPduVersion=cfmMepPduVersion, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, slmMulticastMacAddress=slmMulticastMacAddress, cfmServerMepEntry=cfmServerMepEntry, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, CfmSlmEnabledTypes=CfmSlmEnabledTypes, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, slrOpcode=slrOpcode, cfmExtSvcObjects=cfmExtSvcObjects, cfmMacAddress=cfmMacAddress, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, CfmMepDefects=CfmMepDefects, cfmMepLbmInterval=cfmMepLbmInterval, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmMepOperationalState=cfmMepOperationalState, cfmServerMepStorageType=cfmServerMepStorageType, cfmMepLbrTable=cfmMepLbrTable, cfmMaCompIndex=cfmMaCompIndex, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmMaNetEntry=cfmMaNetEntry, cfmMepAdminState=cfmMepAdminState, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmExtSvcGroups=cfmExtSvcGroups, cfmServerMepTable=cfmServerMepTable, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, cfmMepLbrEntry=cfmMepLbrEntry, cfmEthType=cfmEthType, cfmServerMepAisPriority=cfmServerMepAisPriority, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, cfmMepSecondaryState=cfmMepSecondaryState, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, cfmGenGroup=cfmGenGroup, cfmMepAisPriority=cfmMepAisPriority, cfmMepLlbVidList=cfmMepLlbVidList, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmMepGroup=cfmMepGroup, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, cfmMepStatsAction=cfmMepStatsAction, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, slmOpcode=slmOpcode, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmExtScalars=cfmExtScalars, cfmExtSvcConformance=cfmExtSvcConformance, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmMepEntry=cfmMepEntry, cfmMaCompTable=cfmMaCompTable, cfmMepLbrMepId=cfmMepLbrMepId, cfmExtGroup=cfmExtGroup, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmServerMepSecondaryState=cfmServerMepSecondaryState, CfmLmmDmmInterval=CfmLmmDmmInterval, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, cfmServerMepIndex=cfmServerMepIndex, cfmExtCompliance=cfmExtCompliance, f3CfmMIB=f3CfmMIB, CfmLLFTriggerTypes=CfmLLFTriggerTypes, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, cfmMaNetTable=cfmMaNetTable, cfmMaCompEntity=cfmMaCompEntity, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, CfmPduVersionType=CfmPduVersionType, cfmPortShaperGroup=cfmPortShaperGroup, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmLlbMacAddress=cfmLlbMacAddress, cfmServerMepGroup=cfmServerMepGroup, cfmMaNetMepNumbers=cfmMaNetMepNumbers, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, PYSNMP_MODULE_ID=f3CfmMIB, cfmMepTagEtherType=cfmMepTagEtherType, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmServerMepAdminState=cfmServerMepAdminState, cfmMepAisInterval=cfmMepAisInterval, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmServerMepRowStatus=cfmServerMepRowStatus, cfmMepRxCCMs=cfmMepRxCCMs, cfmMepDmPriority=cfmMepDmPriority, cfmExtSvc=cfmExtSvc, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, cfmMaCompGroup=cfmMaCompGroup, cfmMepDefects=cfmMepDefects, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmMaCompEntry=cfmMaCompEntry)
