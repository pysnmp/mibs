...
AdminState, CmPmBinAction, PerfCounter64, VlanPriority, SecondaryState, OperationalState = mibBuilder.importSymbols("CM-COMMON-MIB", "AdminState", "CmPmBinAction", "PerfCounter64", "VlanPriority", "SecondaryState", "OperationalState")
...
mibBuilder.exportSymbols("F3-CFM-MIB", CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmServerMepEntry=cfmServerMepEntry, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmServerMepAdminState=cfmServerMepAdminState, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmMepLbmInterval=cfmMepLbmInterval, cfmServerMepIndex=cfmServerMepIndex, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, f3CfmMIB=f3CfmMIB, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmMepAisPriority=cfmMepAisPriority, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmExtSvcConformance=cfmExtSvcConformance, cfmMepRxCCMs=cfmMepRxCCMs, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmMepAisInterval=cfmMepAisInterval, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmExtSvcCompliances=cfmExtSvcCompliances, CfmPduVersionType=CfmPduVersionType, cfmMepAdminState=cfmMepAdminState, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmMepDefects=cfmMepDefects, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmMaNetEntry=cfmMaNetEntry, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, CfmAisInterval=CfmAisInterval, cfmMepEntry=cfmMepEntry, cfmMepLbrMepId=cfmMepLbrMepId, CfmMepDefects=CfmMepDefects, cfmMaCompEntry=cfmMaCompEntry, PYSNMP_MODULE_ID=f3CfmMIB, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, CfmLmmDmmInterval=CfmLmmDmmInterval, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, cfmMaNetTable=cfmMaNetTable, cfmMaCompEntity=cfmMaCompEntity, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, slrOpcode=slrOpcode, CfmSignalFailTriggers=CfmSignalFailTriggers, slmOpcode=slmOpcode, cfmMaCompTable=cfmMaCompTable, cfmExtScalars=cfmExtScalars, slmMulticastMacAddress=slmMulticastMacAddress, cfmServerMepGroup=cfmServerMepGroup, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmMepDmPriority=cfmMepDmPriority, cfmMepPduVersion=cfmMepPduVersion, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, CfmLLFTriggerTypes=CfmLLFTriggerTypes, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmMepErrCCMs=cfmMepErrCCMs, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmExtSvc=cfmExtSvc, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmMepStatsAction=cfmMepStatsAction, cfmMepLbrEntry=cfmMepLbrEntry, cfmExtSvcObjects=cfmExtSvcObjects, cfmMepLbrTable=cfmMepLbrTable, cfmLlbMacAddress=cfmLlbMacAddress, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, cfmMaCompIndex=cfmMaCompIndex, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmMepTagEtherType=cfmMepTagEtherType, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmMaNetMepNumbers=cfmMaNetMepNumbers, cfmExtGroup=cfmExtGroup, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, cfmServerMepSecondaryState=cfmServerMepSecondaryState, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmMacAddress=cfmMacAddress, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmGenGroup=cfmGenGroup, cfmMaCompGroup=cfmMaCompGroup, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, CfmSlmEnabledTypes=CfmSlmEnabledTypes, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmServerMepTable=cfmServerMepTable, cfmMepSecondaryState=cfmMepSecondaryState, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, cfmEthType=cfmEthType, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmExtCompliance=cfmExtCompliance, cfmMepTable=cfmMepTable, cfmMepOperationalState=cfmMepOperationalState, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmServerMepAisPriority=cfmServerMepAisPriority, cfmMepLlbVidList=cfmMepLlbVidList, cfmPortShaperGroup=cfmPortShaperGroup, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmServerMepStorageType=cfmServerMepStorageType, cfmServerMepRowStatus=cfmServerMepRowStatus, cfmMepGroup=cfmMepGroup, cfmExtSvcGroups=cfmExtSvcGroups)
