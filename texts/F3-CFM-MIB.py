...
OperationalState, CmPmBinAction, VlanPriority, PerfCounter64, AdminState, SecondaryState = mibBuilder.importSymbols("CM-COMMON-MIB", "OperationalState", "CmPmBinAction", "VlanPriority", "PerfCounter64", "AdminState", "SecondaryState")
...
mibBuilder.exportSymbols("F3-CFM-MIB", slrOpcode=slrOpcode, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, cfmServerMepIndex=cfmServerMepIndex, cfmServerMepStorageType=cfmServerMepStorageType, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmExtScalars=cfmExtScalars, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, cfmExtSvcObjects=cfmExtSvcObjects, cfmMepPduVersion=cfmMepPduVersion, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, cfmMepGroup=cfmMepGroup, cfmMepRxCCMs=cfmMepRxCCMs, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmMepLbrMepId=cfmMepLbrMepId, cfmMaCompTable=cfmMaCompTable, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmMepEntry=cfmMepEntry, cfmLlbMacAddress=cfmLlbMacAddress, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmMaNetEntry=cfmMaNetEntry, cfmMaNetTable=cfmMaNetTable, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, cfmMepLbrMacAddress=cfmMepLbrMacAddress, slmOpcode=slmOpcode, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmPortShaperGroup=cfmPortShaperGroup, cfmMepStatsAction=cfmMepStatsAction, cfmMepErrCCMs=cfmMepErrCCMs, cfmGenGroup=cfmGenGroup, cfmMaNetMepNumbers=cfmMaNetMepNumbers, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, CfmMepDefects=CfmMepDefects, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmMepLbmInterval=cfmMepLbmInterval, cfmMepAisInterval=cfmMepAisInterval, CfmSlmEnabledTypes=CfmSlmEnabledTypes, slmMulticastMacAddress=slmMulticastMacAddress, cfmServerMepAisPriority=cfmServerMepAisPriority, PYSNMP_MODULE_ID=f3CfmMIB, cfmMaCompEntity=cfmMaCompEntity, cfmServerMepAdminState=cfmServerMepAdminState, cfmMepLbrTable=cfmMepLbrTable, cfmServerMepTable=cfmServerMepTable, cfmMepTable=cfmMepTable, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmMacAddress=cfmMacAddress, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmServerMepRowStatus=cfmServerMepRowStatus, cfmServerMepEntry=cfmServerMepEntry, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmMepLlbVidList=cfmMepLlbVidList, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, CfmLLFTriggerTypes=CfmLLFTriggerTypes, cfmMaCompEntry=cfmMaCompEntry, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmMaCompGroup=cfmMaCompGroup, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmMaCompIndex=cfmMaCompIndex, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, CfmLmmDmmInterval=CfmLmmDmmInterval, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmMepAisPriority=cfmMepAisPriority, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmExtCompliance=cfmExtCompliance, cfmMepLbrEntry=cfmMepLbrEntry, cfmExtSvcConformance=cfmExtSvcConformance, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, cfmExtGroup=cfmExtGroup, CfmPduVersionType=CfmPduVersionType, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmMepOperationalState=cfmMepOperationalState, cfmServerMepSecondaryState=cfmServerMepSecondaryState, cfmEthType=cfmEthType, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmMepDefects=cfmMepDefects, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmExtSvc=cfmExtSvc, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, cfmExtSvcGroups=cfmExtSvcGroups, CfmAisInterval=CfmAisInterval, cfmMepAdminState=cfmMepAdminState, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmMepSecondaryState=cfmMepSecondaryState, f3CfmMIB=f3CfmMIB, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmServerMepGroup=cfmServerMepGroup, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmMepTagEtherType=cfmMepTagEtherType, cfmMepDmPriority=cfmMepDmPriority)
