...
mibBuilder.exportSymbols("F3-CFM-MIB", cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, cfmServerMepAdminState=cfmServerMepAdminState, cfmServerMepAisPriority=cfmServerMepAisPriority, CfmPduVersionType=CfmPduVersionType, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmMaCompEntity=cfmMaCompEntity, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmServerMepRowStatus=cfmServerMepRowStatus, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmMepPduVersion=cfmMepPduVersion, cfmMepErrCCMs=cfmMepErrCCMs, cfmMepAdminState=cfmMepAdminState, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, cfmServerMepIndex=cfmServerMepIndex, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmMaNetEntry=cfmMaNetEntry, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, cfmMepRxCCMs=cfmMepRxCCMs, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmMepSecondaryState=cfmMepSecondaryState, cfmMaCompIndex=cfmMaCompIndex, cfmMepLlbVidList=cfmMepLlbVidList, CfmMepDefects=CfmMepDefects, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmMepStatsAction=cfmMepStatsAction, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, cfmMepEntry=cfmMepEntry, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmLlbMacAddress=cfmLlbMacAddress, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmExtSvcGroups=cfmExtSvcGroups, cfmMepAisPriority=cfmMepAisPriority, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmMepLbmInterval=cfmMepLbmInterval, CfmLLFTriggerTypes=CfmLLFTriggerTypes, cfmMaCompGroup=cfmMaCompGroup, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, f3CfmMIB=f3CfmMIB, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmMacAddress=cfmMacAddress, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmServerMepTable=cfmServerMepTable, cfmExtSvcObjects=cfmExtSvcObjects, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmPortShaperGroup=cfmPortShaperGroup, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmMepLbrTable=cfmMepLbrTable, slmMulticastMacAddress=slmMulticastMacAddress, cfmMepDefects=cfmMepDefects, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, cfmServerMepGroup=cfmServerMepGroup, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmMaCompEntry=cfmMaCompEntry, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmServerMepSecondaryState=cfmServerMepSecondaryState, CfmAisInterval=CfmAisInterval, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmExtSvc=cfmExtSvc, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmMepTable=cfmMepTable, cfmMepOperationalState=cfmMepOperationalState, cfmMepLbrMepId=cfmMepLbrMepId, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, cfmMaCompTable=cfmMaCompTable, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmGenGroup=cfmGenGroup, cfmMepAisInterval=cfmMepAisInterval, PYSNMP_MODULE_ID=f3CfmMIB, cfmMepTagEtherType=cfmMepTagEtherType, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmMaNetTable=cfmMaNetTable, slrOpcode=slrOpcode, CfmLmmDmmInterval=CfmLmmDmmInterval, cfmMepGroup=cfmMepGroup, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmMepDmPriority=cfmMepDmPriority, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, slmOpcode=slmOpcode, cfmExtSvcConformance=cfmExtSvcConformance, cfmMaNetMepNumbers=cfmMaNetMepNumbers, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmMepLbrEntry=cfmMepLbrEntry, CfmSlmEnabledTypes=CfmSlmEnabledTypes, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmExtScalars=cfmExtScalars, cfmExtCompliance=cfmExtCompliance, cfmEthType=cfmEthType, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmExtGroup=cfmExtGroup, cfmServerMepStorageType=cfmServerMepStorageType, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, cfmServerMepEntry=cfmServerMepEntry, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier)
