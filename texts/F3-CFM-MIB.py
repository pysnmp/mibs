...
SecondaryState, VlanPriority, CmPmBinAction, AdminState, PerfCounter64, OperationalState = mibBuilder.importSymbols("CM-COMMON-MIB", "SecondaryState", "VlanPriority", "CmPmBinAction", "AdminState", "PerfCounter64", "OperationalState")
...
mibBuilder.exportSymbols("F3-CFM-MIB", cfmExtSvcObjects=cfmExtSvcObjects, CfmAisInterval=CfmAisInterval, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, cfmExtScalars=cfmExtScalars, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmServerMepGroup=cfmServerMepGroup, cfmExtSvcGroups=cfmExtSvcGroups, cfmMepRxCCMs=cfmMepRxCCMs, cfmServerMepSecondaryState=cfmServerMepSecondaryState, cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmMepDefects=cfmMepDefects, cfmMepLbrEntry=cfmMepLbrEntry, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, slrOpcode=slrOpcode, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmMepAdminState=cfmMepAdminState, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmMepTable=cfmMepTable, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, cfmMepGroup=cfmMepGroup, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmMepOperationalState=cfmMepOperationalState, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmMaNetTable=cfmMaNetTable, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, cfmMaCompEntity=cfmMaCompEntity, PYSNMP_MODULE_ID=f3CfmMIB, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmExtGroup=cfmExtGroup, cfmMepEntry=cfmMepEntry, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmPortShaperGroup=cfmPortShaperGroup, cfmEthType=cfmEthType, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, cfmMaCompTable=cfmMaCompTable, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, cfmMaNetMepNumbers=cfmMaNetMepNumbers, cfmMepDmPriority=cfmMepDmPriority, cfmMacAddress=cfmMacAddress, cfmMaCompGroup=cfmMaCompGroup, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, cfmServerMepRowStatus=cfmServerMepRowStatus, cfmLlbMacAddress=cfmLlbMacAddress, cfmServerMepAisInterval=cfmServerMepAisInterval, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmGenGroup=cfmGenGroup, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmMepAisPriority=cfmMepAisPriority, slmOpcode=slmOpcode, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmServerMepAdminState=cfmServerMepAdminState, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmMaCompIndex=cfmMaCompIndex, CfmSlmEnabledTypes=CfmSlmEnabledTypes, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmMaCompEntry=cfmMaCompEntry, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmExtSvcConformance=cfmExtSvcConformance, f3CfmMIB=f3CfmMIB, CfmPduVersionType=CfmPduVersionType, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, CfmMepDefects=CfmMepDefects, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmMepTagEtherType=cfmMepTagEtherType, cfmMaNetEntry=cfmMaNetEntry, cfmServerMepTable=cfmServerMepTable, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, CfmLLFTriggerTypes=CfmLLFTriggerTypes, cfmExtSvc=cfmExtSvc, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmMepLlbVidList=cfmMepLlbVidList, cfmMepLbmInterval=cfmMepLbmInterval, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, cfmMepLbrMepId=cfmMepLbrMepId, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmMepStatsAction=cfmMepStatsAction, cfmMepLbrTable=cfmMepLbrTable, cfmMepAisInterval=cfmMepAisInterval, cfmServerMepEntry=cfmServerMepEntry, cfmServerMepAisPriority=cfmServerMepAisPriority, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, CfmLmmDmmInterval=CfmLmmDmmInterval, cfmExtCompliance=cfmExtCompliance, cfmMepErrCCMs=cfmMepErrCCMs, cfmServerMepStorageType=cfmServerMepStorageType, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, cfmMepPduVersion=cfmMepPduVersion, cfmMepSlmEnabled=cfmMepSlmEnabled, slmMulticastMacAddress=slmMulticastMacAddress, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmServerMepIndex=cfmServerMepIndex, cfmMepSecondaryState=cfmMepSecondaryState)
