...
mibBuilder.exportSymbols("F3-CFM-MIB", cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmEthType=cfmEthType, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmMepAdminState=cfmMepAdminState, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmMaNetTable=cfmMaNetTable, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, cfmMepEntry=cfmMepEntry, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, f3CfmMIB=f3CfmMIB, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmMepLbrTable=cfmMepLbrTable, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmMepLbmInterval=cfmMepLbmInterval, slmMulticastMacAddress=slmMulticastMacAddress, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmMaCompEntry=cfmMaCompEntry, cfmMaCompEntity=cfmMaCompEntity, cfmGenGroup=cfmGenGroup, cfmExtScalars=cfmExtScalars, cfmServerMepEntry=cfmServerMepEntry, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, cfmExtSvcObjects=cfmExtSvcObjects, cfmMepStatsAction=cfmMepStatsAction, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmMepTable=cfmMepTable, cfmMaNetMepNumbers=cfmMaNetMepNumbers, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, slrOpcode=slrOpcode, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, cfmMaNetEntry=cfmMaNetEntry, CfmLmmDmmInterval=CfmLmmDmmInterval, cfmExtGroup=cfmExtGroup, CfmPduVersionType=CfmPduVersionType, cfmMepRxCCMs=cfmMepRxCCMs, cfmMaCompIndex=cfmMaCompIndex, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmExtCompliance=cfmExtCompliance, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmMepErrCCMs=cfmMepErrCCMs, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmMepDefects=cfmMepDefects, cfmMaCompTable=cfmMaCompTable, cfmMepTagEtherType=cfmMepTagEtherType, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmMepAisInterval=cfmMepAisInterval, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, cfmExtSvcGroups=cfmExtSvcGroups, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmServerMepAdminState=cfmServerMepAdminState, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, CfmLLFTriggerTypes=CfmLLFTriggerTypes, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmServerMepSecondaryState=cfmServerMepSecondaryState, PYSNMP_MODULE_ID=f3CfmMIB, cfmServerMepStorageType=cfmServerMepStorageType, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmServerMepIndex=cfmServerMepIndex, cfmMepGroup=cfmMepGroup, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmServerMepGroup=cfmServerMepGroup, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmMepPduVersion=cfmMepPduVersion, cfmMepLlbVidList=cfmMepLlbVidList, cfmMepDmPriority=cfmMepDmPriority, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmMacAddress=cfmMacAddress, cfmMaCompGroup=cfmMaCompGroup, slmOpcode=slmOpcode, cfmMepAisPriority=cfmMepAisPriority, cfmLlbMacAddress=cfmLlbMacAddress, cfmExtSvc=cfmExtSvc, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, cfmPortShaperGroup=cfmPortShaperGroup, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmMepSecondaryState=cfmMepSecondaryState, cfmExtSvcConformance=cfmExtSvcConformance, cfmServerMepTable=cfmServerMepTable, cfmMepLbrMepId=cfmMepLbrMepId, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmMepOperationalState=cfmMepOperationalState, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, CfmAisInterval=CfmAisInterval, cfmServerMepAisPriority=cfmServerMepAisPriority, cfmMepLbrEntry=cfmMepLbrEntry, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, cfmServerMepRowStatus=cfmServerMepRowStatus, CfmSlmEnabledTypes=CfmSlmEnabledTypes, CfmMepDefects=CfmMepDefects)
