...
mibBuilder.exportSymbols("F3-CFM-MIB", cfmMepDefects=cfmMepDefects, cfmMaNetMepNumbers=cfmMaNetMepNumbers, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmMepLbmInterval=cfmMepLbmInterval, cfmMaCompEntity=cfmMaCompEntity, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmMepGroup=cfmMepGroup, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, cfmMaCompGroup=cfmMaCompGroup, cfmExtSvcObjects=cfmExtSvcObjects, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, CfmAisInterval=CfmAisInterval, cfmServerMepTable=cfmServerMepTable, cfmMepTagEtherType=cfmMepTagEtherType, cfmServerMepRowStatus=cfmServerMepRowStatus, cfmMaCompIndex=cfmMaCompIndex, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmMepDmPriority=cfmMepDmPriority, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, PYSNMP_MODULE_ID=f3CfmMIB, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmServerMepIndex=cfmServerMepIndex, slrOpcode=slrOpcode, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmMepErrCCMs=cfmMepErrCCMs, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, f3CfmMIB=f3CfmMIB, cfmMaNetTable=cfmMaNetTable, cfmMaCompEntry=cfmMaCompEntry, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmServerMepEntry=cfmServerMepEntry, cfmMepLbrEntry=cfmMepLbrEntry, cfmMepLbrMepId=cfmMepLbrMepId, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmExtSvcConformance=cfmExtSvcConformance, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmMaCompTable=cfmMaCompTable, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, cfmMepSecondaryState=cfmMepSecondaryState, cfmExtScalars=cfmExtScalars, slmOpcode=slmOpcode, CfmLLFTriggerTypes=CfmLLFTriggerTypes, CfmSlmEnabledTypes=CfmSlmEnabledTypes, cfmServerMepSecondaryState=cfmServerMepSecondaryState, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmExtSvcGroups=cfmExtSvcGroups, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, cfmMepLbrTable=cfmMepLbrTable, cfmExtSvc=cfmExtSvc, cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmMepLbrInOrder=cfmMepLbrInOrder, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmMepPduVersion=cfmMepPduVersion, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, slmMulticastMacAddress=slmMulticastMacAddress, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, cfmExtGroup=cfmExtGroup, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmServerMepAdminState=cfmServerMepAdminState, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, cfmLlbMacAddress=cfmLlbMacAddress, cfmExtCompliance=cfmExtCompliance, CfmPduVersionType=CfmPduVersionType, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmServerMepAisPriority=cfmServerMepAisPriority, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, CfmLmmDmmInterval=CfmLmmDmmInterval, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmMepRxCCMs=cfmMepRxCCMs, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmGenGroup=cfmGenGroup, CfmMepDefects=CfmMepDefects, cfmMepEntry=cfmMepEntry, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmMepAisInterval=cfmMepAisInterval, cfmMepAdminState=cfmMepAdminState, cfmServerMepStorageType=cfmServerMepStorageType, cfmMaNetEntry=cfmMaNetEntry, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmMepOperationalState=cfmMepOperationalState, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, cfmMepTable=cfmMepTable, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmMepStatsAction=cfmMepStatsAction, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, cfmPortShaperGroup=cfmPortShaperGroup, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmEthType=cfmEthType, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, cfmServerMepGroup=cfmServerMepGroup, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, cfmMepLlbVidList=cfmMepLlbVidList, cfmMacAddress=cfmMacAddress, cfmMepAisPriority=cfmMepAisPriority)
