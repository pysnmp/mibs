...
DisplayString, VariablePointer, TruthValue, StorageType, RowStatus, MacAddress, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "VariablePointer", "TruthValue", "StorageType", "RowStatus", "MacAddress", "TextualConvention")
...
mibBuilder.exportSymbols("F3-CFM-MIB", cfmMepLmTxPriority=cfmMepLmTxPriority, cfmEthType=cfmEthType, cfmMepLlbVidList=cfmMepLlbVidList, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmMepStatsAction=cfmMepStatsAction, cfmMepLbmInterval=cfmMepLbmInterval, cfmMaCompTable=cfmMaCompTable, CfmLmmDmmInterval=CfmLmmDmmInterval, cfmServerMepIndex=cfmServerMepIndex, cfmServerMepAisPriority=cfmServerMepAisPriority, CfmPduVersionType=CfmPduVersionType, cfmServerMepSecondaryState=cfmServerMepSecondaryState, cfmMepSecondaryState=cfmMepSecondaryState, cfmMepLbrMepId=cfmMepLbrMepId, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmMepSlmEnabled=cfmMepSlmEnabled, slrOpcode=slrOpcode, cfmExtSvcObjects=cfmExtSvcObjects, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, CfmLLFTriggerTypes=CfmLLFTriggerTypes, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmMepEntry=cfmMepEntry, cfmExtSvcConformance=cfmExtSvcConformance, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmMepAdminState=cfmMepAdminState, cfmMaCompIndex=cfmMaCompIndex, cfmGenGroup=cfmGenGroup, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmMepPduVersion=cfmMepPduVersion, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmMepOperationalState=cfmMepOperationalState, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmMepTagEtherType=cfmMepTagEtherType, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmMepLbrEntry=cfmMepLbrEntry, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmServerMepGroup=cfmServerMepGroup, cfmExtSvc=cfmExtSvc, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmMepDefects=cfmMepDefects, cfmMaNetTable=cfmMaNetTable, cfmMepRxCCMs=cfmMepRxCCMs, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmMaCompEntity=cfmMaCompEntity, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, slmMulticastMacAddress=slmMulticastMacAddress, cfmExtCompliance=cfmExtCompliance, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmMepLbrTable=cfmMepLbrTable, cfmMepDmPriority=cfmMepDmPriority, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmMepGroup=cfmMepGroup, cfmExtScalars=cfmExtScalars, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmMaCompEntry=cfmMaCompEntry, cfmServerMepRowStatus=cfmServerMepRowStatus, cfmMaNetEntry=cfmMaNetEntry, cfmLlbMacAddress=cfmLlbMacAddress, cfmMaNetMepNumbers=cfmMaNetMepNumbers, cfmServerMepEntry=cfmServerMepEntry, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, PYSNMP_MODULE_ID=f3CfmMIB, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmMepAisInterval=cfmMepAisInterval, f3CfmMIB=f3CfmMIB, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmServerMepStorageType=cfmServerMepStorageType, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmExtSvcGroups=cfmExtSvcGroups, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, cfmMepErrCCMs=cfmMepErrCCMs, cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmPortShaperGroup=cfmPortShaperGroup, cfmMepAisPriority=cfmMepAisPriority, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, cfmMaCompGroup=cfmMaCompGroup, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmMepTable=cfmMepTable, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmExtGroup=cfmExtGroup, cfmMacAddress=cfmMacAddress, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, CfmMepDefects=CfmMepDefects, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, cfmServerMepTable=cfmServerMepTable, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmServerMepAdminState=cfmServerMepAdminState, slmOpcode=slmOpcode, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmExtSvcCompliances=cfmExtSvcCompliances, CfmAisInterval=CfmAisInterval, CfmSlmEnabledTypes=CfmSlmEnabledTypes)
