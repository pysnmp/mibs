...
PerfCounter64, OperationalState, VlanPriority, CmPmBinAction, AdminState, SecondaryState = mibBuilder.importSymbols("CM-COMMON-MIB", "PerfCounter64", "OperationalState", "VlanPriority", "CmPmBinAction", "AdminState", "SecondaryState")
...
mibBuilder.exportSymbols("F3-CFM-MIB", CfmMepDefects=CfmMepDefects, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmMepErrCCMs=cfmMepErrCCMs, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, cfmMaCompEntity=cfmMaCompEntity, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmMepTable=cfmMepTable, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, cfmGenGroup=cfmGenGroup, cfmExtScalars=cfmExtScalars, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmMepDmPriority=cfmMepDmPriority, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, f3CfmMIB=f3CfmMIB, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmExtSvc=cfmExtSvc, cfmServerMepAdminState=cfmServerMepAdminState, cfmMaNetEntry=cfmMaNetEntry, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, CfmLLFTriggerTypes=CfmLLFTriggerTypes, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, PYSNMP_MODULE_ID=f3CfmMIB, cfmMaNetMepNumbers=cfmMaNetMepNumbers, cfmExtSvcGroups=cfmExtSvcGroups, cfmMepAisPriority=cfmMepAisPriority, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmMepAisInterval=cfmMepAisInterval, cfmMepStatsAction=cfmMepStatsAction, CfmSlmEnabledTypes=CfmSlmEnabledTypes, cfmMepLbmInterval=cfmMepLbmInterval, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmExtGroup=cfmExtGroup, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmMepLbrInOrder=cfmMepLbrInOrder, slmOpcode=slmOpcode, cfmServerMepAisPriority=cfmServerMepAisPriority, cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmMepLbrTable=cfmMepLbrTable, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmMepOperationalState=cfmMepOperationalState, cfmEthType=cfmEthType, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmLlbMacAddress=cfmLlbMacAddress, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmMaNetTable=cfmMaNetTable, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, CfmAisInterval=CfmAisInterval, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmMepLlbVidList=cfmMepLlbVidList, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, cfmServerMepGroup=cfmServerMepGroup, cfmMepLbrMepId=cfmMepLbrMepId, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmMepDefects=cfmMepDefects, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmMepSecondaryState=cfmMepSecondaryState, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmMaCompTable=cfmMaCompTable, cfmMepLbrEntry=cfmMepLbrEntry, CfmPduVersionType=CfmPduVersionType, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, cfmMepAdminState=cfmMepAdminState, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, CfmLmmDmmInterval=CfmLmmDmmInterval, slrOpcode=slrOpcode, cfmMepRxCCMs=cfmMepRxCCMs, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmMepPduVersion=cfmMepPduVersion, cfmServerMepStorageType=cfmServerMepStorageType, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, cfmMacAddress=cfmMacAddress, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmMepTagEtherType=cfmMepTagEtherType, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmMaCompEntry=cfmMaCompEntry, cfmExtCompliance=cfmExtCompliance, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmExtSvcConformance=cfmExtSvcConformance, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, cfmMepGroup=cfmMepGroup, cfmMaCompIndex=cfmMaCompIndex, cfmServerMepSecondaryState=cfmServerMepSecondaryState, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmMepEntry=cfmMepEntry, cfmServerMepTable=cfmServerMepTable, cfmServerMepRowStatus=cfmServerMepRowStatus, slmMulticastMacAddress=slmMulticastMacAddress, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmPortShaperGroup=cfmPortShaperGroup, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmExtSvcObjects=cfmExtSvcObjects, cfmServerMepEntry=cfmServerMepEntry, cfmMaCompGroup=cfmMaCompGroup, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmServerMepIndex=cfmServerMepIndex)
