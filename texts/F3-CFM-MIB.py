...
SecondaryState, PerfCounter64, VlanPriority, OperationalState, AdminState, CmPmBinAction = mibBuilder.importSymbols("CM-COMMON-MIB", "SecondaryState", "PerfCounter64", "VlanPriority", "OperationalState", "AdminState", "CmPmBinAction")
...
mibBuilder.exportSymbols("F3-CFM-MIB", cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, cfmServerMepTable=cfmServerMepTable, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, cfmMaNetTable=cfmMaNetTable, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, cfmMepAisPriority=cfmMepAisPriority, cfmMepLlbVidList=cfmMepLlbVidList, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmMaCompTable=cfmMaCompTable, cfmMepGroup=cfmMepGroup, cfmExtSvcObjects=cfmExtSvcObjects, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, slrOpcode=slrOpcode, cfmMaCompIndex=cfmMaCompIndex, cfmMepDmPriority=cfmMepDmPriority, cfmServerMepStorageType=cfmServerMepStorageType, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmMepSecondaryState=cfmMepSecondaryState, cfmServerMepEntry=cfmServerMepEntry, cfmExtSvcConformance=cfmExtSvcConformance, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, f3CfmMIB=f3CfmMIB, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, cfmMepOperationalState=cfmMepOperationalState, cfmMepAisInterval=cfmMepAisInterval, CfmLLFTriggerTypes=CfmLLFTriggerTypes, PYSNMP_MODULE_ID=f3CfmMIB, cfmMacAddress=cfmMacAddress, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, cfmMepTagEtherType=cfmMepTagEtherType, cfmServerMepAisPriority=cfmServerMepAisPriority, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmMepErrCCMs=cfmMepErrCCMs, cfmPortShaperGroup=cfmPortShaperGroup, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, CfmPduVersionType=CfmPduVersionType, slmOpcode=slmOpcode, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, CfmLmmDmmInterval=CfmLmmDmmInterval, cfmMepPduVersion=cfmMepPduVersion, cfmMepDefects=cfmMepDefects, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmExtCompliance=cfmExtCompliance, slmMulticastMacAddress=slmMulticastMacAddress, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmServerMepAdminState=cfmServerMepAdminState, cfmMepLbrTable=cfmMepLbrTable, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmExtSvc=cfmExtSvc, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, cfmEthType=cfmEthType, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmMepLbrEntry=cfmMepLbrEntry, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmMaCompEntity=cfmMaCompEntity, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmExtSvcGroups=cfmExtSvcGroups, CfmMepDefects=CfmMepDefects, cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmMepRxCCMs=cfmMepRxCCMs, cfmServerMepRowStatus=cfmServerMepRowStatus, cfmMepTable=cfmMepTable, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, cfmMaNetMepNumbers=cfmMaNetMepNumbers, cfmExtGroup=cfmExtGroup, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, cfmMaCompGroup=cfmMaCompGroup, CfmSlmEnabledTypes=CfmSlmEnabledTypes, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmMaNetEntry=cfmMaNetEntry, cfmLlbMacAddress=cfmLlbMacAddress, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmMepLbmInterval=cfmMepLbmInterval, cfmServerMepIndex=cfmServerMepIndex, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmServerMepSecondaryState=cfmServerMepSecondaryState, CfmAisInterval=CfmAisInterval, cfmMepAdminState=cfmMepAdminState, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmExtScalars=cfmExtScalars, cfmMaCompEntry=cfmMaCompEntry, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmGenGroup=cfmGenGroup, cfmServerMepGroup=cfmServerMepGroup, cfmMepEntry=cfmMepEntry, cfmMepLbrMepId=cfmMepLbrMepId, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmMepStatsAction=cfmMepStatsAction, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry)
