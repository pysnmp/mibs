...
MacAddress, RowStatus, TruthValue, StorageType, DisplayString, TextualConvention, VariablePointer = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "RowStatus", "TruthValue", "StorageType", "DisplayString", "TextualConvention", "VariablePointer")
...
mibBuilder.exportSymbols("F3-CFM-MIB", slmOpcode=slmOpcode, cfmMepLbrTable=cfmMepLbrTable, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, cfmMepTagEtherType=cfmMepTagEtherType, cfmMepLbmInterval=cfmMepLbmInterval, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, cfmLlbMacAddress=cfmLlbMacAddress, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmMaCompIndex=cfmMaCompIndex, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmExtSvcConformance=cfmExtSvcConformance, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmExtScalars=cfmExtScalars, cfmMepStatsAction=cfmMepStatsAction, CfmMepDefects=CfmMepDefects, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmMaCompEntry=cfmMaCompEntry, slmMulticastMacAddress=slmMulticastMacAddress, slrOpcode=slrOpcode, cfmMaNetMepNumbers=cfmMaNetMepNumbers, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmServerMepAisPriority=cfmServerMepAisPriority, cfmMepLbrEntry=cfmMepLbrEntry, cfmMepOperationalState=cfmMepOperationalState, f3CfmMIB=f3CfmMIB, cfmServerMepStorageType=cfmServerMepStorageType, cfmMepLlbVidList=cfmMepLlbVidList, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmMepPduVersion=cfmMepPduVersion, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmMepLbrMepId=cfmMepLbrMepId, cfmServerMepTable=cfmServerMepTable, cfmMepErrCCMs=cfmMepErrCCMs, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmMepDmPriority=cfmMepDmPriority, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, cfmServerMepGroup=cfmServerMepGroup, cfmMaCompEntity=cfmMaCompEntity, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, cfmMepAisInterval=cfmMepAisInterval, cfmMepRxCCMs=cfmMepRxCCMs, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmMepTable=cfmMepTable, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, CfmLLFTriggerTypes=CfmLLFTriggerTypes, cfmMacAddress=cfmMacAddress, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, CfmPduVersionType=CfmPduVersionType, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, cfmExtSvcObjects=cfmExtSvcObjects, cfmMaNetEntry=cfmMaNetEntry, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmServerMepRowStatus=cfmServerMepRowStatus, cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmExtCompliance=cfmExtCompliance, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, cfmServerMepIndex=cfmServerMepIndex, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, cfmExtGroup=cfmExtGroup, cfmMepDefects=cfmMepDefects, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmPortShaperGroup=cfmPortShaperGroup, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmMepEntry=cfmMepEntry, PYSNMP_MODULE_ID=f3CfmMIB, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmExtSvcGroups=cfmExtSvcGroups, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmMaCompGroup=cfmMaCompGroup, cfmMaNetTable=cfmMaNetTable, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, cfmServerMepEntry=cfmServerMepEntry, cfmServerMepAdminState=cfmServerMepAdminState, cfmServerMepSecondaryState=cfmServerMepSecondaryState, cfmMepAssociatedObject=cfmMepAssociatedObject, CfmLmmDmmInterval=CfmLmmDmmInterval, cfmEthType=cfmEthType, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, cfmMaCompTable=cfmMaCompTable, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmMepAisPriority=cfmMepAisPriority, cfmMepSecondaryState=cfmMepSecondaryState, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmMepAdminState=cfmMepAdminState, cfmGenGroup=cfmGenGroup, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, CfmSlmEnabledTypes=CfmSlmEnabledTypes, cfmExtSvc=cfmExtSvc, CfmAisInterval=CfmAisInterval, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmMepGroup=cfmMepGroup, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry)
