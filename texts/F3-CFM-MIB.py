...
AdminState, SecondaryState, PerfCounter64, OperationalState, CmPmBinAction, VlanPriority = mibBuilder.importSymbols("CM-COMMON-MIB", "AdminState", "SecondaryState", "PerfCounter64", "OperationalState", "CmPmBinAction", "VlanPriority")
...
mibBuilder.exportSymbols("F3-CFM-MIB", cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmMepSecondaryState=cfmMepSecondaryState, cfmMepLlbVidList=cfmMepLlbVidList, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, CfmMepDefects=CfmMepDefects, slmMulticastMacAddress=slmMulticastMacAddress, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmExtSvcObjects=cfmExtSvcObjects, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, cfmMepAdminState=cfmMepAdminState, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmMepLbrMepId=cfmMepLbrMepId, cfmMaCompIndex=cfmMaCompIndex, cfmMaNetTable=cfmMaNetTable, cfmServerMepRowStatus=cfmServerMepRowStatus, cfmMepOperationalState=cfmMepOperationalState, CfmSlmEnabledTypes=CfmSlmEnabledTypes, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmExtSvc=cfmExtSvc, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmMacAddress=cfmMacAddress, cfmMaCompEntry=cfmMaCompEntry, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmMaNetEntry=cfmMaNetEntry, cfmExtSvcGroups=cfmExtSvcGroups, cfmServerMepStorageType=cfmServerMepStorageType, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmServerMepGroup=cfmServerMepGroup, PYSNMP_MODULE_ID=f3CfmMIB, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmExtSvcConformance=cfmExtSvcConformance, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmMepPduVersion=cfmMepPduVersion, cfmEthType=cfmEthType, f3CfmMIB=f3CfmMIB, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, slmOpcode=slmOpcode, cfmMepLbrEntry=cfmMepLbrEntry, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmServerMepAisPriority=cfmServerMepAisPriority, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, cfmLlbMacAddress=cfmLlbMacAddress, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, slrOpcode=slrOpcode, cfmServerMepTable=cfmServerMepTable, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmPortShaperGroup=cfmPortShaperGroup, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmMepDefects=cfmMepDefects, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmMepErrCCMs=cfmMepErrCCMs, cfmMaCompGroup=cfmMaCompGroup, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmMepTable=cfmMepTable, CfmAisInterval=CfmAisInterval, cfmServerMepAdminState=cfmServerMepAdminState, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, cfmExtScalars=cfmExtScalars, cfmMepTagEtherType=cfmMepTagEtherType, cfmExtGroup=cfmExtGroup, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmMaCompTable=cfmMaCompTable, cfmMepAisPriority=cfmMepAisPriority, cfmMepLbmInterval=cfmMepLbmInterval, cfmServerMepEntry=cfmServerMepEntry, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, cfmMepLbrTable=cfmMepLbrTable, cfmMaCompEntity=cfmMaCompEntity, cfmMaNetMepNumbers=cfmMaNetMepNumbers, cfmExtCompliance=cfmExtCompliance, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmMepRxCCMs=cfmMepRxCCMs, cfmMepAisInterval=cfmMepAisInterval, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, cfmMepLbrMacAddress=cfmMepLbrMacAddress, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmMepStatsAction=cfmMepStatsAction, cfmGenGroup=cfmGenGroup, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, CfmLmmDmmInterval=CfmLmmDmmInterval, CfmLLFTriggerTypes=CfmLLFTriggerTypes, cfmServerMepIndex=cfmServerMepIndex, cfmServerMepSecondaryState=cfmServerMepSecondaryState, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, cfmMepGroup=cfmMepGroup, cfmMepEntry=cfmMepEntry, cfmMepDmPriority=cfmMepDmPriority, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, CfmPduVersionType=CfmPduVersionType)
