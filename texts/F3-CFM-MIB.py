...
CmPmBinAction, PerfCounter64, VlanPriority, AdminState, SecondaryState, OperationalState = mibBuilder.importSymbols("CM-COMMON-MIB", "CmPmBinAction", "PerfCounter64", "VlanPriority", "AdminState", "SecondaryState", "OperationalState")
...
mibBuilder.exportSymbols("F3-CFM-MIB", cfmServerMepIndex=cfmServerMepIndex, CfmMepDefects=CfmMepDefects, cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmServerMepEntry=cfmServerMepEntry, cfmServerMepSecondaryState=cfmServerMepSecondaryState, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmMepPduVersion=cfmMepPduVersion, cfmMepDefects=cfmMepDefects, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmMepAisPriority=cfmMepAisPriority, cfmMepLbrMepId=cfmMepLbrMepId, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, cfmMepTable=cfmMepTable, cfmMepErrCCMs=cfmMepErrCCMs, cfmMepGroup=cfmMepGroup, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmServerMepGroup=cfmServerMepGroup, cfmMaCompEntry=cfmMaCompEntry, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmMepDmPriority=cfmMepDmPriority, cfmMepAdminState=cfmMepAdminState, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, CfmSlmEnabledTypes=CfmSlmEnabledTypes, cfmExtSvcObjects=cfmExtSvcObjects, cfmServerMepAdminState=cfmServerMepAdminState, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmMaNetEntry=cfmMaNetEntry, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, f3CfmMIB=f3CfmMIB, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmMepRxCCMs=cfmMepRxCCMs, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, cfmMepLbmInterval=cfmMepLbmInterval, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmExtSvcGroups=cfmExtSvcGroups, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, cfmMepLlbVidList=cfmMepLlbVidList, CfmLLFTriggerTypes=CfmLLFTriggerTypes, slrOpcode=slrOpcode, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmEthType=cfmEthType, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmExtScalars=cfmExtScalars, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmServerMepRowStatus=cfmServerMepRowStatus, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmServerMepStorageType=cfmServerMepStorageType, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmLlbMacAddress=cfmLlbMacAddress, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, slmMulticastMacAddress=slmMulticastMacAddress, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, cfmMaCompTable=cfmMaCompTable, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmGenGroup=cfmGenGroup, cfmMepSecondaryState=cfmMepSecondaryState, CfmAisInterval=CfmAisInterval, cfmMaNetTable=cfmMaNetTable, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmExtSvcConformance=cfmExtSvcConformance, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmPortShaperGroup=cfmPortShaperGroup, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, cfmMaCompEntity=cfmMaCompEntity, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, cfmMaCompIndex=cfmMaCompIndex, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmMepTagEtherType=cfmMepTagEtherType, cfmExtCompliance=cfmExtCompliance, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, cfmMaCompGroup=cfmMaCompGroup, cfmMepLbrEntry=cfmMepLbrEntry, slmOpcode=slmOpcode, PYSNMP_MODULE_ID=f3CfmMIB, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmMacAddress=cfmMacAddress, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmExtGroup=cfmExtGroup, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmMepEntry=cfmMepEntry, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmExtSvc=cfmExtSvc, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmMepOperationalState=cfmMepOperationalState, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, CfmLmmDmmInterval=CfmLmmDmmInterval, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmMaNetMepNumbers=cfmMaNetMepNumbers, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, cfmMepAisInterval=cfmMepAisInterval, cfmMepStatsAction=cfmMepStatsAction, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmServerMepAisPriority=cfmServerMepAisPriority, CfmPduVersionType=CfmPduVersionType, cfmServerMepTable=cfmServerMepTable, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmMepLbrTable=cfmMepLbrTable)
