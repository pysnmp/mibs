...
mibBuilder.exportSymbols("F3-CFM-MIB", cfmServerMepOperationalState=cfmServerMepOperationalState, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, CfmSlmEnabledTypes=CfmSlmEnabledTypes, CfmPduVersionType=CfmPduVersionType, cfmMepLbrMepId=cfmMepLbrMepId, cfmMaNetMepNumbers=cfmMaNetMepNumbers, cfmGenGroup=cfmGenGroup, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmServerMepAdminState=cfmServerMepAdminState, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmMepStatsAction=cfmMepStatsAction, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, cfmMepPduVersion=cfmMepPduVersion, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmMaCompEntity=cfmMaCompEntity, cfmMepOperationalState=cfmMepOperationalState, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, cfmMepGroup=cfmMepGroup, cfmPortShaperGroup=cfmPortShaperGroup, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmMaCompEntry=cfmMaCompEntry, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmMaNetTable=cfmMaNetTable, cfmServerMepSecondaryState=cfmServerMepSecondaryState, cfmServerMepRowStatus=cfmServerMepRowStatus, PYSNMP_MODULE_ID=f3CfmMIB, CfmMepDefects=CfmMepDefects, cfmExtCompliance=cfmExtCompliance, cfmMaCompGroup=cfmMaCompGroup, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmMaCompTable=cfmMaCompTable, cfmMepTagEtherType=cfmMepTagEtherType, cfmExtSvcObjects=cfmExtSvcObjects, cfmExtGroup=cfmExtGroup, cfmMepDefects=cfmMepDefects, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmServerMepTable=cfmServerMepTable, slrOpcode=slrOpcode, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmServerMepStorageType=cfmServerMepStorageType, cfmServerMepGroup=cfmServerMepGroup, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmMepRxCCMs=cfmMepRxCCMs, cfmExtScalars=cfmExtScalars, CfmLmmDmmInterval=CfmLmmDmmInterval, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmMaCompIndex=cfmMaCompIndex, cfmMepAdminState=cfmMepAdminState, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmMepSecondaryState=cfmMepSecondaryState, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmMepLbrTable=cfmMepLbrTable, CfmAisInterval=CfmAisInterval, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, cfmMepLlbVidList=cfmMepLlbVidList, slmOpcode=slmOpcode, CfmLLFTriggerTypes=CfmLLFTriggerTypes, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmServerMepAisPriority=cfmServerMepAisPriority, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmMacAddress=cfmMacAddress, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, cfmEthType=cfmEthType, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, slmMulticastMacAddress=slmMulticastMacAddress, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmMaNetEntry=cfmMaNetEntry, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmMepEntry=cfmMepEntry, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmMepTable=cfmMepTable, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmExtSvcConformance=cfmExtSvcConformance, cfmExtSvc=cfmExtSvc, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmServerMepEntry=cfmServerMepEntry, cfmMepAisInterval=cfmMepAisInterval, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, f3CfmMIB=f3CfmMIB, cfmMepErrCCMs=cfmMepErrCCMs, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmLlbMacAddress=cfmLlbMacAddress, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmMepLbrEntry=cfmMepLbrEntry, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmExtSvcGroups=cfmExtSvcGroups, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmServerMepIndex=cfmServerMepIndex, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmMepAisPriority=cfmMepAisPriority, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmMepLbmInterval=cfmMepLbmInterval, cfmMepDmPriority=cfmMepDmPriority)
