...
SecondaryState, CmPmBinAction, OperationalState, AdminState, VlanPriority, PerfCounter64 = mibBuilder.importSymbols("CM-COMMON-MIB", "SecondaryState", "CmPmBinAction", "OperationalState", "AdminState", "VlanPriority", "PerfCounter64")
...
mibBuilder.exportSymbols("F3-CFM-MIB", cfmMepDefects=cfmMepDefects, cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmMaNetTable=cfmMaNetTable, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmMepStatsAction=cfmMepStatsAction, cfmMepAdminState=cfmMepAdminState, cfmExtSvcGroups=cfmExtSvcGroups, cfmMepTable=cfmMepTable, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, f3CfmMIB=f3CfmMIB, cfmExtCompliance=cfmExtCompliance, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmMaCompEntry=cfmMaCompEntry, cfmMepRxCCMs=cfmMepRxCCMs, CfmSlmEnabledTypes=CfmSlmEnabledTypes, cfmExtGroup=cfmExtGroup, CfmLmmDmmInterval=CfmLmmDmmInterval, PYSNMP_MODULE_ID=f3CfmMIB, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmMepLlbVidList=cfmMepLlbVidList, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, cfmMepOperationalState=cfmMepOperationalState, slmMulticastMacAddress=slmMulticastMacAddress, CfmLLFTriggerTypes=CfmLLFTriggerTypes, cfmMepSecondaryState=cfmMepSecondaryState, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, CfmAisInterval=CfmAisInterval, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmServerMepAdminState=cfmServerMepAdminState, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, cfmMepEntry=cfmMepEntry, cfmMepLbrTable=cfmMepLbrTable, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmServerMepTable=cfmServerMepTable, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmMepLbrEntry=cfmMepLbrEntry, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmMaCompIndex=cfmMaCompIndex, cfmLlbMacAddress=cfmLlbMacAddress, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, slrOpcode=slrOpcode, CfmMepDefects=CfmMepDefects, cfmEthType=cfmEthType, cfmMepAisPriority=cfmMepAisPriority, cfmMacAddress=cfmMacAddress, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmServerMepRowStatus=cfmServerMepRowStatus, slmOpcode=slmOpcode, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmServerMepStorageType=cfmServerMepStorageType, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmServerMepSecondaryState=cfmServerMepSecondaryState, cfmMepPduVersion=cfmMepPduVersion, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmServerMepGroup=cfmServerMepGroup, cfmGenGroup=cfmGenGroup, cfmExtSvc=cfmExtSvc, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmMepLbrMepId=cfmMepLbrMepId, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmMaCompGroup=cfmMaCompGroup, cfmServerMepAisPriority=cfmServerMepAisPriority, cfmMaNetMepNumbers=cfmMaNetMepNumbers, cfmExtScalars=cfmExtScalars, cfmMaCompEntity=cfmMaCompEntity, cfmPortShaperGroup=cfmPortShaperGroup, cfmMepGroup=cfmMepGroup, cfmServerMepEntry=cfmServerMepEntry, cfmMepErrCCMs=cfmMepErrCCMs, cfmMaCompTable=cfmMaCompTable, cfmExtSvcObjects=cfmExtSvcObjects, cfmMepTagEtherType=cfmMepTagEtherType, cfmMaNetEntry=cfmMaNetEntry, cfmMepDmPriority=cfmMepDmPriority, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmServerMepIndex=cfmServerMepIndex, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, CfmPduVersionType=CfmPduVersionType, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmMepAisInterval=cfmMepAisInterval, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, cfmMepLbmInterval=cfmMepLbmInterval, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmExtSvcConformance=cfmExtSvcConformance, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery)
