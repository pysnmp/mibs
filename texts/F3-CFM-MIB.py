...
mibBuilder.exportSymbols("F3-CFM-MIB", cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, cfmMepAisPriority=cfmMepAisPriority, cfmMaCompTable=cfmMaCompTable, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmMaCompIndex=cfmMaCompIndex, cfmMepTable=cfmMepTable, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, cfmMepTagEtherType=cfmMepTagEtherType, CfmAisInterval=CfmAisInterval, cfmExtGroup=cfmExtGroup, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmServerMepAisPriority=cfmServerMepAisPriority, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, cfmLlbMacAddress=cfmLlbMacAddress, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmMacAddress=cfmMacAddress, cfmGenGroup=cfmGenGroup, cfmExtSvcObjects=cfmExtSvcObjects, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, slmMulticastMacAddress=slmMulticastMacAddress, f3CfmMIB=f3CfmMIB, cfmMaCompGroup=cfmMaCompGroup, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, cfmMepAisInterval=cfmMepAisInterval, cfmMepLbmInterval=cfmMepLbmInterval, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmServerMepAdminState=cfmServerMepAdminState, cfmMaNetEntry=cfmMaNetEntry, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmMepDmPriority=cfmMepDmPriority, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, CfmSlmEnabledTypes=CfmSlmEnabledTypes, cfmMepLbrMepId=cfmMepLbrMepId, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, cfmExtScalars=cfmExtScalars, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmMepRxCCMs=cfmMepRxCCMs, slrOpcode=slrOpcode, cfmMepLbrEntry=cfmMepLbrEntry, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, cfmPortShaperGroup=cfmPortShaperGroup, cfmMepGroup=cfmMepGroup, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmMepPduVersion=cfmMepPduVersion, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, cfmExtCompliance=cfmExtCompliance, cfmExtSvcGroups=cfmExtSvcGroups, cfmMaNetMepNumbers=cfmMaNetMepNumbers, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmMepLlbVidList=cfmMepLlbVidList, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmMepAisGenEnabled=cfmMepAisGenEnabled, CfmLLFTriggerTypes=CfmLLFTriggerTypes, cfmMepStatsAction=cfmMepStatsAction, cfmExtSvcConformance=cfmExtSvcConformance, cfmServerMepGroup=cfmServerMepGroup, cfmMaCompEntry=cfmMaCompEntry, cfmServerMepEntry=cfmServerMepEntry, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmExtSvc=cfmExtSvc, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmEthType=cfmEthType, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmMepErrCCMs=cfmMepErrCCMs, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmMepEntry=cfmMepEntry, CfmLmmDmmInterval=CfmLmmDmmInterval, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmMepSecondaryState=cfmMepSecondaryState, cfmMepOperationalState=cfmMepOperationalState, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmServerMepRowStatus=cfmServerMepRowStatus, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, cfmServerMepSecondaryState=cfmServerMepSecondaryState, cfmMaNetTable=cfmMaNetTable, slmOpcode=slmOpcode, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmMepAdminState=cfmMepAdminState, cfmServerMepTable=cfmServerMepTable, CfmMepDefects=CfmMepDefects, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmMepDefects=cfmMepDefects, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, PYSNMP_MODULE_ID=f3CfmMIB, cfmMepLbrTable=cfmMepLbrTable, cfmMaCompEntity=cfmMaCompEntity, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmServerMepIndex=cfmServerMepIndex, cfmServerMepStorageType=cfmServerMepStorageType, CfmPduVersionType=CfmPduVersionType, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex)
