...
mibBuilder.exportSymbols("F3-CFM-MIB", cfmServerMepAdminState=cfmServerMepAdminState, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmMepAisPriority=cfmMepAisPriority, cfmMepLbrTable=cfmMepLbrTable, CfmMepDefects=CfmMepDefects, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmServerMepAisPriority=cfmServerMepAisPriority, CfmAisInterval=CfmAisInterval, cfmMaCompEntry=cfmMaCompEntry, cfmMepDmPriority=cfmMepDmPriority, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, cfmExtSvc=cfmExtSvc, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmEthType=cfmEthType, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, CfmLLFTriggerTypes=CfmLLFTriggerTypes, cfmMaNetMepNumbers=cfmMaNetMepNumbers, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmGenGroup=cfmGenGroup, cfmServerMepTable=cfmServerMepTable, cfmMaCompIndex=cfmMaCompIndex, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmMepAdminState=cfmMepAdminState, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmExtSvcObjects=cfmExtSvcObjects, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, cfmMepLbrMepId=cfmMepLbrMepId, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, PYSNMP_MODULE_ID=f3CfmMIB, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, slmOpcode=slmOpcode, cfmServerMepIndex=cfmServerMepIndex, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, cfmMepRxCCMs=cfmMepRxCCMs, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, CfmLmmDmmInterval=CfmLmmDmmInterval, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmMepDefects=cfmMepDefects, CfmSlmEnabledTypes=CfmSlmEnabledTypes, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmMepLbmInterval=cfmMepLbmInterval, cfmServerMepSecondaryState=cfmServerMepSecondaryState, cfmMaNetTable=cfmMaNetTable, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmMepLbrMacAddress=cfmMepLbrMacAddress, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, slrOpcode=slrOpcode, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmMepStatsAction=cfmMepStatsAction, cfmMepPduVersion=cfmMepPduVersion, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmMaCompEntity=cfmMaCompEntity, cfmMepGroup=cfmMepGroup, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmExtSvcGroups=cfmExtSvcGroups, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmLlbMacAddress=cfmLlbMacAddress, cfmMacAddress=cfmMacAddress, cfmMepEntry=cfmMepEntry, cfmMaCompTable=cfmMaCompTable, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, cfmMepLbrEntry=cfmMepLbrEntry, cfmMepSecondaryState=cfmMepSecondaryState, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, CfmPduVersionType=CfmPduVersionType, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmMepTable=cfmMepTable, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmExtSvcConformance=cfmExtSvcConformance, cfmExtGroup=cfmExtGroup, cfmServerMepStorageType=cfmServerMepStorageType, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmServerMepGroup=cfmServerMepGroup, cfmServerMepEntry=cfmServerMepEntry, cfmMepLlbVidList=cfmMepLlbVidList, cfmMepErrCCMs=cfmMepErrCCMs, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmPortShaperGroup=cfmPortShaperGroup, f3CfmMIB=f3CfmMIB, cfmMaNetEntry=cfmMaNetEntry, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmMepAisInterval=cfmMepAisInterval, cfmServerMepRowStatus=cfmServerMepRowStatus, cfmMepTagEtherType=cfmMepTagEtherType, cfmMaCompGroup=cfmMaCompGroup, slmMulticastMacAddress=slmMulticastMacAddress, cfmMepOperationalState=cfmMepOperationalState, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmExtCompliance=cfmExtCompliance, cfmExtScalars=cfmExtScalars)
