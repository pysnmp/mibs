...
OperationalState, CmPmBinAction, SecondaryState, PerfCounter64, VlanPriority, AdminState = mibBuilder.importSymbols("CM-COMMON-MIB", "OperationalState", "CmPmBinAction", "SecondaryState", "PerfCounter64", "VlanPriority", "AdminState")
...
DisplayString, StorageType, MacAddress, TruthValue, VariablePointer, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "StorageType", "MacAddress", "TruthValue", "VariablePointer", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("F3-CFM-MIB", cfmMaCompGroup=cfmMaCompGroup, cfmMaCompEntry=cfmMaCompEntry, cfmMepErrCCMs=cfmMepErrCCMs, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, cfmExtSvcConformance=cfmExtSvcConformance, cfmServerMepTable=cfmServerMepTable, cfmMepLbrTable=cfmMepLbrTable, cfmMepAisPriority=cfmMepAisPriority, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, cfmServerMepRowStatus=cfmServerMepRowStatus, cfmMaCompEntity=cfmMaCompEntity, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmLlbMacAddress=cfmLlbMacAddress, CfmSlmEnabledTypes=CfmSlmEnabledTypes, cfmMepLbrEntry=cfmMepLbrEntry, slmOpcode=slmOpcode, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmMepDmPriority=cfmMepDmPriority, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, cfmMepTagEtherType=cfmMepTagEtherType, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmMepSecondaryState=cfmMepSecondaryState, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmMepLbrMepId=cfmMepLbrMepId, cfmMepGroup=cfmMepGroup, cfmExtSvcGroups=cfmExtSvcGroups, cfmMaNetTable=cfmMaNetTable, CfmPduVersionType=CfmPduVersionType, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmMepLlbVidList=cfmMepLlbVidList, PYSNMP_MODULE_ID=f3CfmMIB, cfmExtGroup=cfmExtGroup, cfmExtSvcObjects=cfmExtSvcObjects, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, f3CfmMIB=f3CfmMIB, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, CfmLmmDmmInterval=CfmLmmDmmInterval, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmExtSvc=cfmExtSvc, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, cfmServerMepEntry=cfmServerMepEntry, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, cfmMepStatsAction=cfmMepStatsAction, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, slmMulticastMacAddress=slmMulticastMacAddress, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmMepTable=cfmMepTable, cfmServerMepSecondaryState=cfmServerMepSecondaryState, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, CfmSignalFailTriggers=CfmSignalFailTriggers, CfmAisInterval=CfmAisInterval, cfmExtCompliance=cfmExtCompliance, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmMepPduVersion=cfmMepPduVersion, cfmExtScalars=cfmExtScalars, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmMaCompIndex=cfmMaCompIndex, cfmPortShaperGroup=cfmPortShaperGroup, cfmMepOperationalState=cfmMepOperationalState, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmMepLbrInOrder=cfmMepLbrInOrder, cfmServerMepAisPriority=cfmServerMepAisPriority, cfmMepDefects=cfmMepDefects, cfmMepLbmInterval=cfmMepLbmInterval, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, cfmMaCompTable=cfmMaCompTable, cfmMepEntry=cfmMepEntry, cfmMaNetEntry=cfmMaNetEntry, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmMepAisInterval=cfmMepAisInterval, cfmServerMepAdminState=cfmServerMepAdminState, cfmMaNetMepNumbers=cfmMaNetMepNumbers, cfmGenGroup=cfmGenGroup, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmMepRxCCMs=cfmMepRxCCMs, cfmServerMepIndex=cfmServerMepIndex, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmEthType=cfmEthType, CfmMepDefects=CfmMepDefects, slrOpcode=slrOpcode, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmMacAddress=cfmMacAddress, cfmServerMepGroup=cfmServerMepGroup, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmMepAdminState=cfmMepAdminState, cfmMepAssociatedObject=cfmMepAssociatedObject, cfmServerMepStorageType=cfmServerMepStorageType, CfmLLFTriggerTypes=CfmLLFTriggerTypes, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes)
