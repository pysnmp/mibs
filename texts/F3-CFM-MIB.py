...
OperationalState, CmPmBinAction, SecondaryState, VlanPriority, PerfCounter64, AdminState = mibBuilder.importSymbols("CM-COMMON-MIB", "OperationalState", "CmPmBinAction", "SecondaryState", "VlanPriority", "PerfCounter64", "AdminState")
...
mibBuilder.exportSymbols("F3-CFM-MIB", cfmMepAssociatedObject=cfmMepAssociatedObject, cfmMepLlbPortLLEnabled=cfmMepLlbPortLLEnabled, cfmMepAdminState=cfmMepAdminState, cfmMepSecondaryState=cfmMepSecondaryState, cfmMepOperationalState=cfmMepOperationalState, cfmDownMEPQosShaperTable=cfmDownMEPQosShaperTable, cfmNetPortQosShaperEntry=cfmNetPortQosShaperEntry, cfmMepLmDualEndedCountAllPriosEnabled=cfmMepLmDualEndedCountAllPriosEnabled, cfmLlbMacAddressEntry=cfmLlbMacAddressEntry, CfmPduVersionType=CfmPduVersionType, cfmMepLbmInterval=cfmMepLbmInterval, cfmServerMepSecondaryState=cfmServerMepSecondaryState, cfmMepTable=cfmMepTable, cfmTrafficPortQosShaperTable=cfmTrafficPortQosShaperTable, cfmMepLbrMepId=cfmMepLbrMepId, cfmMepLbrOutOfOder=cfmMepLbrOutOfOder, cfmMepAisGenTriggerTypes=cfmMepAisGenTriggerTypes, cfmMepPduVersion=cfmMepPduVersion, CfmSlmEnabledTypes=CfmSlmEnabledTypes, cfmAccPortQosShaperTable=cfmAccPortQosShaperTable, cfmMaNetTable=cfmMaNetTable, slmMulticastMacAddress=slmMulticastMacAddress, cfmMepLbrMacAddress=cfmMepLbrMacAddress, cfmDownMEPQosShaperEntry=cfmDownMEPQosShaperEntry, cfmServerMepAisGenEnabled=cfmServerMepAisGenEnabled, cfmServerMepRowStatus=cfmServerMepRowStatus, cfmMaNetRemoteMepAutoDiscovery=cfmMaNetRemoteMepAutoDiscovery, cfmServerMepAisInterval=cfmServerMepAisInterval, cfmNetPortQosShaperCIR=cfmNetPortQosShaperCIR, cfmAccPortQosShaperAdminState=cfmAccPortQosShaperAdminState, cfmDownMEPQosShaperAdminState=cfmDownMEPQosShaperAdminState, cfmServerMepOperationalState=cfmServerMepOperationalState, cfmExtCompliance=cfmExtCompliance, CfmAisInterval=CfmAisInterval, cfmExtSvcGroups=cfmExtSvcGroups, CfmSignalFailTriggers=CfmSignalFailTriggers, cfmMepAisGenEnabled=cfmMepAisGenEnabled, cfmServerMepAdminState=cfmServerMepAdminState, cfmMepAisPriority=cfmMepAisPriority, cfmDownMEPQosShaperProfile=cfmDownMEPQosShaperProfile, cfmServerMepAssociatedPort=cfmServerMepAssociatedPort, cfmMepLbrTable=cfmMepLbrTable, cfmMepLbrInOrder=cfmMepLbrInOrder, CfmMepDefects=CfmMepDefects, cfmMepStatsAction=cfmMepStatsAction, cfmMepExcludedMepListTable=cfmMepExcludedMepListTable, cfmMepLLFTriggerTypes=cfmMepLLFTriggerTypes, cfmMepTagEtherType=cfmMepTagEtherType, cfmEthType=cfmEthType, CfmLmmDmmInterval=CfmLmmDmmInterval, cfmMepSlmEnabled=cfmMepSlmEnabled, cfmMaNetMepNumbers=cfmMaNetMepNumbers, cfmDownMEPQosShaperCIR=cfmDownMEPQosShaperCIR, cfmServerMepGroup=cfmServerMepGroup, cfmExtScalars=cfmExtScalars, cfmExtGroup=cfmExtGroup, cfmServerMepTable=cfmServerMepTable, PYSNMP_MODULE_ID=f3CfmMIB, cfmMepLbrEntry=cfmMepLbrEntry, cfmServerMepIndex=cfmServerMepIndex, cfmTrafficPortQosShaperCIR=cfmTrafficPortQosShaperCIR, cfmMepLmTxPriority=cfmMepLmTxPriority, cfmServerMepAisPriority=cfmServerMepAisPriority, cfmMepLmCountInProfileEnabled=cfmMepLmCountInProfileEnabled, cfmMepLlbResponderEnabled=cfmMepLlbResponderEnabled, cfmTrafficPortQosShaperBufSize=cfmTrafficPortQosShaperBufSize, cfmMaCompEntry=cfmMaCompEntry, cfmMepLmRxCountAllPriosEnabled=cfmMepLmRxCountAllPriosEnabled, cfmMepLmTxCountAllPriosEnabled=cfmMepLmTxCountAllPriosEnabled, cfmMepCcmInterfaceStatusTLVControl=cfmMepCcmInterfaceStatusTLVControl, cfmServerMepEntry=cfmServerMepEntry, cfmLlbMacAddressRowStatus=cfmLlbMacAddressRowStatus, cfmMepEntry=cfmMepEntry, CfmAisGenTriggerTypes=CfmAisGenTriggerTypes, slmOpcode=slmOpcode, cfmMepLlbVidList=cfmMepLlbVidList, cfmExtSvcConformance=cfmExtSvcConformance, cfmNetPortQosShaperTable=cfmNetPortQosShaperTable, cfmDownMEPQosShaperType=cfmDownMEPQosShaperType, cfmExtSvcCompliances=cfmExtSvcCompliances, cfmMepDefects=cfmMepDefects, cfmMepExcludedMepListEntry=cfmMepExcludedMepListEntry, cfmMepGroup=cfmMepGroup, cfmAccPortQosShaperEntry=cfmAccPortQosShaperEntry, cfmMaCompTable=cfmMaCompTable, cfmNetPortQosShaperTypeIndex=cfmNetPortQosShaperTypeIndex, cfmExtSvc=cfmExtSvc, cfmMacAddress=cfmMacAddress, cfmMepExcludedMepListRowStatus=cfmMepExcludedMepListRowStatus, cfmNetPortQosShaperBufSize=cfmNetPortQosShaperBufSize, cfmMaCompEntity=cfmMaCompEntity, cfmPortShaperGroup=cfmPortShaperGroup, cfmMaCompIndex=cfmMaCompIndex, cfmServerMepAisClientMdLevel=cfmServerMepAisClientMdLevel, cfmExtSvcObjects=cfmExtSvcObjects, CfmLLFTriggerTypes=CfmLLFTriggerTypes, cfmMepRxCCMs=cfmMepRxCCMs, cfmLlbMacAddress=cfmLlbMacAddress, cfmMepExcludedMepListIdentifier=cfmMepExcludedMepListIdentifier, cfmSignalFailTriggers=cfmSignalFailTriggers, cfmAccPortQosShaperCIR=cfmAccPortQosShaperCIR, cfmAccPortQosShaperBufSize=cfmAccPortQosShaperBufSize, cfmMaCompGroup=cfmMaCompGroup, cfmGenGroup=cfmGenGroup, cfmTrafficPortQosShaperIndex=cfmTrafficPortQosShaperIndex, cfmMepAisClientMdLevel=cfmMepAisClientMdLevel, f3CfmMIB=f3CfmMIB, cfmMepAisInterval=cfmMepAisInterval, cfmServerMepStorageType=cfmServerMepStorageType, cfmMepLlbMacAddressTable=cfmMepLlbMacAddressTable, cfmNetPortQosShaperAdminState=cfmNetPortQosShaperAdminState, cfmMepErrCCMs=cfmMepErrCCMs, cfmAccPortQosShaperIndex=cfmAccPortQosShaperIndex, slrOpcode=slrOpcode, cfmMaNetEntry=cfmMaNetEntry, cfmTrafficPortQosShaperAdminState=cfmTrafficPortQosShaperAdminState, cfmMepDmPriority=cfmMepDmPriority, cfmTrafficPortQosShaperEntry=cfmTrafficPortQosShaperEntry, cfmDownMEPQosShaperIndex=cfmDownMEPQosShaperIndex)
