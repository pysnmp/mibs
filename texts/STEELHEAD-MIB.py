...
ModuleIdentity, NotificationType, Gauge32, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, Unsigned32, Bits, Counter64, iso, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "Gauge32", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "Unsigned32", "Bits", "Counter64", "iso", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("STEELHEAD-MIB", cpuLoad1=cpuLoad1, bandwidthHCPerPort=bandwidthHCPerPort, smbAlertClear=smbAlertClear, connectionCounts=connectionCounts, fanErrorClear=fanErrorClear, clusterDisconnectedSHAlertError=clusterDisconnectedSHAlertError, ttSrcHostByteCount=ttSrcHostByteCount, ttAppPortEntry=ttAppPortEntry, licenseExpiring=licenseExpiring, neighborRedirReqSent=neighborRedirReqSent, procName=procName, neighborRedirDelSent=neighborRedirDelSent, ttTalkerPort2=ttTalkerPort2, nghAggrRedirDelRcvd=nghAggrRedirDelRcvd, powerSupplyError=powerSupplyError, nghAggrNatAckSent=nghAggrNatAckSent, ipmi=ipmi, neighborState=neighborState, cfConnLostEosClear=cfConnLostEosClear, nghAggrRedirAckRcvd=nghAggrRedirAckRcvd, cfAckTimeoutClear=cfAckTimeoutClear, fanError=fanError, neighborIncompatibilityClear=neighborIncompatibilityClear, nghAggrConfigured=nghAggrConfigured, cpuIndivUtilTable=cpuIndivUtilTable, nghAggrMaxLatency=nghAggrMaxLatency, datastore=datastore, rspGeneralError=rspGeneralError, nghAggrNatReqSent=nghAggrNatReqSent, sysdetailErrorClear=sysdetailErrorClear, bwPortNumber=bwPortNumber, ttTalkersTable=ttTalkersTable, establishedConnections=establishedConnections, upgradeFailureClear=upgradeFailureClear, bandwidthPassThrough=bandwidthPassThrough, statistics=statistics, raidErrorClear=raidErrorClear, bwHCAggOutLan=bwHCAggOutLan, neighborConnFailures=neighborConnFailures, peerStatus=peerStatus, lanWanLoopError=lanWanLoopError, flashError=flashError, temperatureNormal=temperatureNormal, diskError=diskError, systemDiskFullError=systemDiskFullError, cpuUtil=cpuUtil, procStatus=procStatus, crlError=crlError, nghAggrRedirReqSent=nghAggrRedirReqSent, ttDestHostTable=ttDestHostTable, cfConnLostEos=cfConnLostEos, neighborDynReqSent=neighborDynReqSent, inpathSupport=inpathSupport, cfReadInfoTimeoutClear=cfReadInfoTimeoutClear, raidError=raidError, domainJoinError=domainJoinError, bwHCAggInLan=bwHCAggInLan, systemDiskFullErrorClear=systemDiskFullErrorClear, linkIoErrorsClear=linkIoErrorsClear, cpuLoad15=cpuLoad15, bwHCPortEntry=bwHCPortEntry, procEntry=procEntry, bwPortTable=bwPortTable, ttTalkerByteCount=ttTalkerByteCount, neighborNatDelSent=neighborNatDelSent, configChange=configChange, bwHCPortInLan=bwHCPortInLan, nghAggrDynDelRcvd=nghAggrDynDelRcvd, config=config, bandwidthHC=bandwidthHC, datastoreSyncPort=datastoreSyncPort, topTalkers=topTalkers, crlErrMsg=crlErrMsg, admissionMapiError=admissionMapiError, cpuIndivUtilEntry=cpuIndivUtilEntry, certsExpiringError=certsExpiringError, optimizationServiceStatusError=optimizationServiceStatusError, health=health, smartError=smartError, peerVersionMismatch=peerVersionMismatch, neighborRedirDelRcvd=neighborRedirDelRcvd, memoryErrorClear=memoryErrorClear, cpuLoad=cpuLoad, neighborNatReqRcvd=neighborNatReqRcvd, capabilityStatus=capabilityStatus, smbAlert=smbAlert, nghAggrConnected=nghAggrConnected, model=model, peerIndex=peerIndex, upgradeFailure=upgradeFailure, alarms=alarms, neighborMaxLatency=neighborMaxLatency, neighborKeepaliveTimeouts=neighborKeepaliveTimeouts, neighborIncompatibility=neighborIncompatibility, admissionMemErrorClear=admissionMemErrorClear, nfsV2V4=nfsV2V4, admissionConnErrorClear=admissionConnErrorClear, healthNotes=healthNotes, neighborNatDelRcvd=neighborNatDelRcvd, cfAckTimeout=cfAckTimeout, neighborRedirReqRcvd=neighborRedirReqRcvd, domainJoinErrorClear=domainJoinErrorClear, systemClock=systemClock, nfsV2V4Clear=nfsV2V4Clear, storageProfSwitchFailed=storageProfSwitchFailed, admissionMemError=admissionMemError, rspServiceError=rspServiceError, bwPortOutWan=bwPortOutWan, neighborNatAckSent=neighborNatAckSent, secureVaultNeedsRekey=secureVaultNeedsRekey, confModeExit=confModeExit, halfOpenedConnections=halfOpenedConnections, neighborNatReqSent=neighborNatReqSent, certsExpiringErrorClear=certsExpiringErrorClear, systemVersion=systemVersion, peerTable=peerTable, trapTest=trapTest, cfKeepaliveTimeout=cfKeepaliveTimeout, bwPortInWan=bwPortInWan, linkDuplex=linkDuplex, licenseExpired=licenseExpired, confModeEnter=confModeEnter, linkErrorClear=linkErrorClear, webUserLogin=webUserLogin, nghAggrRequestTimeouts=nghAggrRequestTimeouts, rspServiceClear=rspServiceClear, bwHCPortOutWan=bwHCPortOutWan, ttAppPortTable=ttAppPortTable, cliUserLogout=cliUserLogout, memoryError=memoryError, shMaxBandwidth=shMaxBandwidth, bwHCPortInWan=bwHCPortInWan, ttSrcHostIp=ttSrcHostIp, ttAppPortId=ttAppPortId, wearWarning=wearWarning, status=status, rspGeneralClear=rspGeneralClear, outofpathSupport=outofpathSupport, bwPassThroughOut=bwPassThroughOut, datastoreSyncFailureClear=datastoreSyncFailureClear, ttDestHostByteCount=ttDestHostByteCount, crlFeatureName=crlFeatureName, serialNumber=serialNumber, neighborDynDelRcvd=neighborDynDelRcvd, linkIoErrors=linkIoErrors, admissionTcpErrorClear=admissionTcpErrorClear, admissionCpuErrorClear=admissionCpuErrorClear, admissionMapiErrorClear=admissionMapiErrorClear, nghAggrKeepaliveTimouts=nghAggrKeepaliveTimouts, ttTalkerIp1=ttTalkerIp1, cpuLoad5=cpuLoad5, bypassMode=bypassMode, sslPeeringSCEPAutoReenrollError=sslPeeringSCEPAutoReenrollError, systemTemperature=systemTemperature, temperatureCritical=temperatureCritical, neighborAddress=neighborAddress, systemHealth=systemHealth, ttTalkersEntry=ttTalkersEntry, dsCostPerSegment=dsCostPerSegment, nghAggrDynAckRcvd=nghAggrDynAckRcvd, bwHCAggInWan=bwHCAggInWan, tcpDumpScheduled=tcpDumpScheduled, cfReadInfoTimeout=cfReadInfoTimeout, linkError=linkError, cfConnFailure=cfConnFailure, neighborEntry=neighborEntry, admissionConnError=admissionConnError, cfConnRestored=cfConnRestored, neighborStatus=neighborStatus, cfLatencyExceededClear=cfLatencyExceededClear, bwPassThroughIn=bwPassThroughIn, nghAggrDynReqSent=nghAggrDynReqSent, crlStatus=crlStatus, bandwidthPerPort=bandwidthPerPort, lanWanLoopClear=lanWanLoopClear, cliUserLogin=cliUserLogin, asymRouteCount=asymRouteCount, procIndex=procIndex, pagingActivity=pagingActivity, temperatureWarning=temperatureWarning, datastoreSync=datastoreSync, bwAggOutLan=bwAggOutLan, activeConfig=activeConfig, ttDestHostIp=ttDestHostIp, nghAggrRedirDelSent=nghAggrRedirDelSent, ttAppPortByteCount=ttAppPortByteCount, neighborAggregates=neighborAggregates, ttSrcHostTable=ttSrcHostTable, licenseErrorClear=licenseErrorClear, bwHCPortTable=bwHCPortTable, bwAggInWan=bwAggInWan, licenseError=licenseError, neighborRedirAckSent=neighborRedirAckSent, cfLatencyExceeded=cfLatencyExceeded, optServiceStatus=optServiceStatus, nghAggrNatDelRcvd=nghAggrNatDelRcvd, secureVaultClear=secureVaultClear, neighborTable=neighborTable, cfConnLostErrClear=cfConnLostErrClear, bwPortInLan=bwPortInLan, secureVaultInitError=secureVaultInitError, cpuUtil1=cpuUtil1, procNumFailures=procNumFailures, ipmiClear=ipmiClear, bwHCPortOutLan=bwHCPortOutLan, peerVersionMismatchClear=peerVersionMismatchClear, asymRouteError=asymRouteError, inpath=inpath, bwAggHCOutWan=bwAggHCOutWan, procTable=procTable, hardwareErrorClear=hardwareErrorClear, diskErrorClear=diskErrorClear, steelhead=steelhead, neighborNatAckRcvd=neighborNatAckRcvd, PYSNMP_MODULE_ID=steelhead, datastoreSyncFailure=datastoreSyncFailure, cpuIndivIndex=cpuIndivIndex, nghAggrNatReqRcvd=nghAggrNatReqRcvd, crlIndex=crlIndex, activeConnections=activeConnections, crlClear=crlClear, serviceUptime=serviceUptime, cpuIndivUserTime=cpuIndivUserTime, datastoreSyncAddr=datastoreSyncAddr, powerSupplyErrorClear=powerSupplyErrorClear, newUserCreated=newUserCreated, asymRouteErrorClear=asymRouteErrorClear, haltErrorClear=haltErrorClear, bypassModeClear=bypassModeClear, nghAggrNatDelSent=nghAggrNatDelSent, ttAppPort=ttAppPort, webUserLogout=webUserLogout, totalConnections=totalConnections, admissionCpuError=admissionCpuError, neighborDynAckSent=neighborDynAckSent, nghAggrRedirAckSent=nghAggrRedirAckSent, temperatureNonCritical=temperatureNonCritical, bandwidthAggregate=bandwidthAggregate, neighborRequestTimeouts=neighborRequestTimeouts, peerEntry=peerEntry, peerAddress=peerAddress, configSave=configSave, serviceStatus=serviceStatus, ttSrcHostEntry=ttSrcHostEntry, linkDuplexClear=linkDuplexClear, optimizedConnections=optimizedConnections, serviceError=serviceError, hardwareError=hardwareError, procCrash=procCrash, nghAggrNatAckRcvd=nghAggrNatAckRcvd, dsMissTotal=dsMissTotal, dsHitsTotal=dsHitsTotal, ttDestHostEntry=ttDestHostEntry, cpuUtilClear=cpuUtilClear)
mibBuilder.exportSymbols("STEELHEAD-MIB", peerHostname=peerHostname, crlNumCdpErr=crlNumCdpErr, neighborRedirAckRcvd=neighborRedirAckRcvd, neighborDynReqRcvd=neighborDynReqRcvd, halfClosedConnections=halfClosedConnections, neighborDynAckRcvd=neighborDynAckRcvd, bwPortOutLan=bwPortOutLan, storeCorruption=storeCorruption, optimizationServiceStatusClear=optimizationServiceStatusClear, cpuIndivIdleTime=cpuIndivIdleTime, ttTalkerId=ttTalkerId, clusterDisconnectedSHAlertClear=clusterDisconnectedSHAlertClear, storeCorruptionClear=storeCorruptionClear, shMaxConnections=shMaxConnections, secureVaultNeedsUnlock=secureVaultNeedsUnlock, ttTalkerPort1=ttTalkerPort1, ttTalkerIp2=ttTalkerIp2, admissionTcpError=admissionTcpError, neighborDynDelSent=neighborDynDelSent, nghAggrDynAckSent=nghAggrDynAckSent, bwAggInLan=bwAggInLan, crlEntry=crlEntry, ttDestHostId=ttDestHostId, sslPeeringSCEPAutoReenrollClear=sslPeeringSCEPAutoReenrollClear, bandwidth=bandwidth, bwAggOutWan=bwAggOutWan, nghAggrDynDelSent=nghAggrDynDelSent, datastoreWrapped=datastoreWrapped, nghAggrDynReqRcvd=nghAggrDynReqRcvd, cfKeepaliveTimeoutClear=cfKeepaliveTimeoutClear, passthroughConnections=passthroughConnections, haltError=haltError, nghAggrConnFailures=nghAggrConnFailures, dsAveDiskUtilization=dsAveDiskUtilization, cfConnLostErr=cfConnLostErr, bandwidthHCAggregate=bandwidthHCAggregate, tcpDumpStarted=tcpDumpStarted, sysdetailError=sysdetailError, neighborIndex=neighborIndex, outofpath=outofpath, flashErrorClear=flashErrorClear, bwPortEntry=bwPortEntry, peerVersion=peerVersion, bwPassThroughTotal=bwPassThroughTotal, bwHCPortNumber=bwHCPortNumber, procExit=procExit, crlTable=crlTable, cpuIndivId=cpuIndivId, serviceErrorClear=serviceErrorClear, pagingActivityClear=pagingActivityClear, system=system, ttSrcHostId=ttSrcHostId, peerModel=peerModel, cpuIndivSystemTime=cpuIndivSystemTime, alarmsPrefix=alarmsPrefix, nghAggrRedirReqRcvd=nghAggrRedirReqRcvd, scheduledJobError=scheduledJobError)
