...
ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, Integer32, Counter64, NotificationType, iso, MibIdentifier, TimeTicks, Gauge32, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "Integer32", "Counter64", "NotificationType", "iso", "MibIdentifier", "TimeTicks", "Gauge32", "Bits", "Counter32")
...
mibBuilder.exportSymbols("STEELHEAD-MIB", PYSNMP_MODULE_ID=steelhead, cpuIndivUserTime=cpuIndivUserTime, ttTalkersTable=ttTalkersTable, bwPassThroughTotal=bwPassThroughTotal, bwHCAggOutLan=bwHCAggOutLan, ttAppPortByteCount=ttAppPortByteCount, configChange=configChange, alarms=alarms, cpuIndivUtilEntry=cpuIndivUtilEntry, temperatureNormal=temperatureNormal, cfConnLostEos=cfConnLostEos, procEntry=procEntry, raidErrorClear=raidErrorClear, bwHCPortInLan=bwHCPortInLan, ttTalkerIp1=ttTalkerIp1, nghAggrDynReqSent=nghAggrDynReqSent, crlFeatureName=crlFeatureName, systemVersion=systemVersion, cpuIndivId=cpuIndivId, tcpDumpStarted=tcpDumpStarted, confModeEnter=confModeEnter, tcpDumpScheduled=tcpDumpScheduled, nghAggrKeepaliveTimouts=nghAggrKeepaliveTimouts, ttAppPortId=ttAppPortId, sslPeeringSCEPAutoReenrollClear=sslPeeringSCEPAutoReenrollClear, healthNotes=healthNotes, confModeExit=confModeExit, clusterDisconnectedSHAlertClear=clusterDisconnectedSHAlertClear, optimizationServiceStatusError=optimizationServiceStatusError, ipmi=ipmi, smbAlert=smbAlert, nfsV2V4=nfsV2V4, peerAddress=peerAddress, cfConnLostEosClear=cfConnLostEosClear, statistics=statistics, secureVaultInitError=secureVaultInitError, memoryError=memoryError, datastoreSync=datastoreSync, neighborRedirDelRcvd=neighborRedirDelRcvd, ttDestHostTable=ttDestHostTable, neighborRequestTimeouts=neighborRequestTimeouts, serviceErrorClear=serviceErrorClear, neighborState=neighborState, peerEntry=peerEntry, ttAppPortEntry=ttAppPortEntry, neighborRedirReqRcvd=neighborRedirReqRcvd, haltErrorClear=haltErrorClear, nghAggrConnected=nghAggrConnected, cfReadInfoTimeout=cfReadInfoTimeout, ttDestHostEntry=ttDestHostEntry, serviceUptime=serviceUptime, smartError=smartError, linkError=linkError, optServiceStatus=optServiceStatus, systemDiskFullError=systemDiskFullError, nghAggrNatAckSent=nghAggrNatAckSent, neighborDynDelSent=neighborDynDelSent, peerVersionMismatchClear=peerVersionMismatchClear, nghAggrRedirDelRcvd=nghAggrRedirDelRcvd, ttTalkerPort2=ttTalkerPort2, bwAggInWan=bwAggInWan, ipmiClear=ipmiClear, inpath=inpath, steelhead=steelhead, ttTalkerIp2=ttTalkerIp2, inpathSupport=inpathSupport, nghAggrNatDelRcvd=nghAggrNatDelRcvd, dsAveDiskUtilization=dsAveDiskUtilization, rspServiceClear=rspServiceClear, temperatureCritical=temperatureCritical, rspGeneralClear=rspGeneralClear, bandwidthAggregate=bandwidthAggregate, temperatureNonCritical=temperatureNonCritical, bandwidthHC=bandwidthHC, nghAggrDynReqRcvd=nghAggrDynReqRcvd, peerVersionMismatch=peerVersionMismatch, neighborNatAckRcvd=neighborNatAckRcvd, haltError=haltError, neighborRedirAckRcvd=neighborRedirAckRcvd, admissionTcpError=admissionTcpError, storeCorruptionClear=storeCorruptionClear, nghAggrDynDelRcvd=nghAggrDynDelRcvd, systemHealth=systemHealth, nghAggrDynAckRcvd=nghAggrDynAckRcvd, storageProfSwitchFailed=storageProfSwitchFailed, upgradeFailureClear=upgradeFailureClear, bandwidthHCAggregate=bandwidthHCAggregate, bandwidth=bandwidth, optimizedConnections=optimizedConnections, config=config, neighborAggregates=neighborAggregates, bypassMode=bypassMode, bwPortInWan=bwPortInWan, procExit=procExit, licenseExpiring=licenseExpiring, bwAggOutLan=bwAggOutLan, bwHCAggInWan=bwHCAggInWan, certsExpiringErrorClear=certsExpiringErrorClear, peerHostname=peerHostname, ttAppPortTable=ttAppPortTable, shMaxBandwidth=shMaxBandwidth, linkDuplex=linkDuplex, nghAggrRedirAckSent=nghAggrRedirAckSent, crlTable=crlTable, procName=procName, neighborMaxLatency=neighborMaxLatency, cpuUtilClear=cpuUtilClear, activeConfig=activeConfig, neighborNatAckSent=neighborNatAckSent, raidError=raidError, peerStatus=peerStatus, peerVersion=peerVersion, procNumFailures=procNumFailures, cpuIndivSystemTime=cpuIndivSystemTime, upgradeFailure=upgradeFailure, neighborTable=neighborTable, neighborRedirReqSent=neighborRedirReqSent, capabilityStatus=capabilityStatus, neighborDynReqRcvd=neighborDynReqRcvd, datastoreSyncFailureClear=datastoreSyncFailureClear, shMaxConnections=shMaxConnections, clusterDisconnectedSHAlertError=clusterDisconnectedSHAlertError, bwPortTable=bwPortTable, bwHCPortOutWan=bwHCPortOutWan, halfOpenedConnections=halfOpenedConnections, bwAggHCOutWan=bwAggHCOutWan, neighborStatus=neighborStatus, linkErrorClear=linkErrorClear, powerSupplyErrorClear=powerSupplyErrorClear, licenseErrorClear=licenseErrorClear, ttTalkerByteCount=ttTalkerByteCount, admissionTcpErrorClear=admissionTcpErrorClear, linkIoErrorsClear=linkIoErrorsClear, cfKeepaliveTimeoutClear=cfKeepaliveTimeoutClear, cfConnRestored=cfConnRestored, ttSrcHostByteCount=ttSrcHostByteCount, wearWarning=wearWarning, crlErrMsg=crlErrMsg, crlStatus=crlStatus, ttSrcHostId=ttSrcHostId, admissionMapiError=admissionMapiError, asymRouteError=asymRouteError, cpuLoad15=cpuLoad15, health=health, sysdetailError=sysdetailError, ttSrcHostEntry=ttSrcHostEntry, nghAggrNatReqSent=nghAggrNatReqSent, cpuIndivIdleTime=cpuIndivIdleTime, procIndex=procIndex, cliUserLogin=cliUserLogin, bwHCPortInWan=bwHCPortInWan, admissionMemError=admissionMemError, asymRouteCount=asymRouteCount, status=status, diskError=diskError, system=system, temperatureWarning=temperatureWarning, crlEntry=crlEntry, neighborNatDelSent=neighborNatDelSent, neighborKeepaliveTimeouts=neighborKeepaliveTimeouts, nghAggrRedirAckRcvd=nghAggrRedirAckRcvd, crlClear=crlClear, smbAlertClear=smbAlertClear, scheduledJobError=scheduledJobError, lanWanLoopClear=lanWanLoopClear, cfAckTimeoutClear=cfAckTimeoutClear, flashError=flashError, ttSrcHostIp=ttSrcHostIp, crlIndex=crlIndex, nghAggrNatAckRcvd=nghAggrNatAckRcvd, neighborRedirDelSent=neighborRedirDelSent, datastoreSyncAddr=datastoreSyncAddr, ttDestHostId=ttDestHostId, ttAppPort=ttAppPort, webUserLogin=webUserLogin, neighborNatDelRcvd=neighborNatDelRcvd, neighborDynDelRcvd=neighborDynDelRcvd, hardwareError=hardwareError, nghAggrDynDelSent=nghAggrDynDelSent, establishedConnections=establishedConnections, nghAggrRequestTimeouts=nghAggrRequestTimeouts, ttTalkerId=ttTalkerId, bypassModeClear=bypassModeClear, procStatus=procStatus, cfConnLostErr=cfConnLostErr, secureVaultNeedsRekey=secureVaultNeedsRekey, bandwidthPerPort=bandwidthPerPort, ttSrcHostTable=ttSrcHostTable, bwPortNumber=bwPortNumber, hardwareErrorClear=hardwareErrorClear, secureVaultNeedsUnlock=secureVaultNeedsUnlock, cfLatencyExceeded=cfLatencyExceeded, admissionConnError=admissionConnError, alarmsPrefix=alarmsPrefix, dsCostPerSegment=dsCostPerSegment, datastoreSyncFailure=datastoreSyncFailure, bwHCAggInLan=bwHCAggInLan, outofpath=outofpath, nghAggrConfigured=nghAggrConfigured, domainJoinError=domainJoinError, systemTemperature=systemTemperature, bwPortOutLan=bwPortOutLan, datastoreWrapped=datastoreWrapped, procTable=procTable, crlError=crlError, admissionConnErrorClear=admissionConnErrorClear, peerModel=peerModel, nghAggrConnFailures=nghAggrConnFailures, cpuUtil1=cpuUtil1, serviceError=serviceError, datastore=datastore, nfsV2V4Clear=nfsV2V4Clear, pagingActivity=pagingActivity, dsHitsTotal=dsHitsTotal, systemClock=systemClock, crlNumCdpErr=crlNumCdpErr, licenseError=licenseError, lanWanLoopError=lanWanLoopError, linkDuplexClear=linkDuplexClear, newUserCreated=newUserCreated, fanError=fanError, neighborEntry=neighborEntry, asymRouteErrorClear=asymRouteErrorClear, nghAggrRedirReqSent=nghAggrRedirReqSent, bwAggInLan=bwAggInLan, topTalkers=topTalkers, dsMissTotal=dsMissTotal, nghAggrRedirDelSent=nghAggrRedirDelSent, activeConnections=activeConnections, cpuIndivUtilTable=cpuIndivUtilTable, neighborAddress=neighborAddress, nghAggrNatDelSent=nghAggrNatDelSent, domainJoinErrorClear=domainJoinErrorClear, cliUserLogout=cliUserLogout, admissionMapiErrorClear=admissionMapiErrorClear, bwPassThroughIn=bwPassThroughIn, datastoreSyncPort=datastoreSyncPort, neighborNatReqRcvd=neighborNatReqRcvd, peerIndex=peerIndex, rspServiceError=rspServiceError, serviceStatus=serviceStatus, bwHCPortOutLan=bwHCPortOutLan, halfClosedConnections=halfClosedConnections, admissionMemErrorClear=admissionMemErrorClear, diskErrorClear=diskErrorClear, cpuUtil=cpuUtil, systemDiskFullErrorClear=systemDiskFullErrorClear, trapTest=trapTest, cfKeepaliveTimeout=cfKeepaliveTimeout, bwHCPortNumber=bwHCPortNumber, neighborConnFailures=neighborConnFailures, memoryErrorClear=memoryErrorClear, licenseExpired=licenseExpired, neighborRedirAckSent=neighborRedirAckSent)
mibBuilder.exportSymbols("STEELHEAD-MIB", neighborIncompatibilityClear=neighborIncompatibilityClear, secureVaultClear=secureVaultClear, bwPassThroughOut=bwPassThroughOut, connectionCounts=connectionCounts, flashErrorClear=flashErrorClear, cfConnFailure=cfConnFailure, cfLatencyExceededClear=cfLatencyExceededClear, rspGeneralError=rspGeneralError, fanErrorClear=fanErrorClear, admissionCpuErrorClear=admissionCpuErrorClear, cpuLoad5=cpuLoad5, nghAggrMaxLatency=nghAggrMaxLatency, powerSupplyError=powerSupplyError, bandwidthPassThrough=bandwidthPassThrough, cfConnLostErrClear=cfConnLostErrClear, neighborIndex=neighborIndex, sslPeeringSCEPAutoReenrollError=sslPeeringSCEPAutoReenrollError, certsExpiringError=certsExpiringError, passthroughConnections=passthroughConnections, nghAggrNatReqRcvd=nghAggrNatReqRcvd, linkIoErrors=linkIoErrors, neighborDynReqSent=neighborDynReqSent, ttDestHostByteCount=ttDestHostByteCount, optimizationServiceStatusClear=optimizationServiceStatusClear, ttDestHostIp=ttDestHostIp, nghAggrRedirReqRcvd=nghAggrRedirReqRcvd, cfReadInfoTimeoutClear=cfReadInfoTimeoutClear, pagingActivityClear=pagingActivityClear, ttTalkerPort1=ttTalkerPort1, procCrash=procCrash, model=model, configSave=configSave, bwPortInLan=bwPortInLan, serialNumber=serialNumber, cpuLoad1=cpuLoad1, cpuIndivIndex=cpuIndivIndex, cfAckTimeout=cfAckTimeout, admissionCpuError=admissionCpuError, neighborDynAckSent=neighborDynAckSent, bwPortEntry=bwPortEntry, nghAggrDynAckSent=nghAggrDynAckSent, bwAggOutWan=bwAggOutWan, totalConnections=totalConnections, sysdetailErrorClear=sysdetailErrorClear, bwPortOutWan=bwPortOutWan, bwHCPortTable=bwHCPortTable, webUserLogout=webUserLogout, bandwidthHCPerPort=bandwidthHCPerPort, cpuLoad=cpuLoad, peerTable=peerTable, neighborNatReqSent=neighborNatReqSent, neighborIncompatibility=neighborIncompatibility, neighborDynAckRcvd=neighborDynAckRcvd, outofpathSupport=outofpathSupport, bwHCPortEntry=bwHCPortEntry, storeCorruption=storeCorruption, ttTalkersEntry=ttTalkersEntry)
