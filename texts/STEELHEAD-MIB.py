...
ModuleIdentity, NotificationType, MibIdentifier, Gauge32, IpAddress, Unsigned32, iso, Counter64, Integer32, Counter32, TimeTicks, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "MibIdentifier", "Gauge32", "IpAddress", "Unsigned32", "iso", "Counter64", "Integer32", "Counter32", "TimeTicks", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("STEELHEAD-MIB", systemClock=systemClock, neighborRedirAckRcvd=neighborRedirAckRcvd, status=status, temperatureWarning=temperatureWarning, activeConfig=activeConfig, secureVaultInitError=secureVaultInitError, bandwidthHC=bandwidthHC, cpuUtil=cpuUtil, neighborAggregates=neighborAggregates, systemDiskFullErrorClear=systemDiskFullErrorClear, smbAlertClear=smbAlertClear, ttTalkerIp1=ttTalkerIp1, bwPortInLan=bwPortInLan, temperatureCritical=temperatureCritical, configSave=configSave, bwAggOutLan=bwAggOutLan, neighborNatReqSent=neighborNatReqSent, bwPassThroughIn=bwPassThroughIn, powerSupplyErrorClear=powerSupplyErrorClear, neighborAddress=neighborAddress, neighborNatReqRcvd=neighborNatReqRcvd, systemDiskFullError=systemDiskFullError, bwPortTable=bwPortTable, procTable=procTable, connectionCounts=connectionCounts, procStatus=procStatus, bwAggInWan=bwAggInWan, temperatureNonCritical=temperatureNonCritical, serviceStatus=serviceStatus, admissionTcpError=admissionTcpError, nghAggrNatReqRcvd=nghAggrNatReqRcvd, neighborRedirDelSent=neighborRedirDelSent, nfsV2V4Clear=nfsV2V4Clear, bwAggHCOutWan=bwAggHCOutWan, PYSNMP_MODULE_ID=steelhead, alarms=alarms, haltErrorClear=haltErrorClear, halfClosedConnections=halfClosedConnections, shMaxConnections=shMaxConnections, admissionCpuErrorClear=admissionCpuErrorClear, newUserCreated=newUserCreated, cpuLoad=cpuLoad, health=health, serviceErrorClear=serviceErrorClear, bwHCPortOutLan=bwHCPortOutLan, sslPeeringSCEPAutoReenrollError=sslPeeringSCEPAutoReenrollError, cfKeepaliveTimeout=cfKeepaliveTimeout, cfConnLostEosClear=cfConnLostEosClear, datastore=datastore, ttTalkerByteCount=ttTalkerByteCount, bwHCPortEntry=bwHCPortEntry, cliUserLogin=cliUserLogin, halfOpenedConnections=halfOpenedConnections, optimizationServiceStatusClear=optimizationServiceStatusClear, crlIndex=crlIndex, nghAggrKeepaliveTimouts=nghAggrKeepaliveTimouts, bwPortOutLan=bwPortOutLan, nghAggrRedirDelSent=nghAggrRedirDelSent, crlEntry=crlEntry, dsCostPerSegment=dsCostPerSegment, scheduledJobError=scheduledJobError, bwPassThroughTotal=bwPassThroughTotal, optimizationServiceStatusError=optimizationServiceStatusError, systemHealth=systemHealth, ttTalkerIp2=ttTalkerIp2, bwPortOutWan=bwPortOutWan, nghAggrRedirDelRcvd=nghAggrRedirDelRcvd, ttDestHostTable=ttDestHostTable, peerVersion=peerVersion, ttDestHostIp=ttDestHostIp, neighborKeepaliveTimeouts=neighborKeepaliveTimeouts, nghAggrMaxLatency=nghAggrMaxLatency, outofpathSupport=outofpathSupport, config=config, neighborDynReqRcvd=neighborDynReqRcvd, clusterDisconnectedSHAlertClear=clusterDisconnectedSHAlertClear, ttAppPort=ttAppPort, peerStatus=peerStatus, neighborStatus=neighborStatus, datastoreSyncFailureClear=datastoreSyncFailureClear, bwHCPortNumber=bwHCPortNumber, linkIoErrorsClear=linkIoErrorsClear, cfConnLostEos=cfConnLostEos, cfConnFailure=cfConnFailure, ttSrcHostTable=ttSrcHostTable, nghAggrDynReqSent=nghAggrDynReqSent, procCrash=procCrash, temperatureNormal=temperatureNormal, peerIndex=peerIndex, bwHCPortInLan=bwHCPortInLan, ttTalkerPort1=ttTalkerPort1, healthNotes=healthNotes, neighborTable=neighborTable, secureVaultNeedsUnlock=secureVaultNeedsUnlock, neighborIncompatibility=neighborIncompatibility, nghAggrConfigured=nghAggrConfigured, ttSrcHostByteCount=ttSrcHostByteCount, neighborDynDelSent=neighborDynDelSent, linkDuplex=linkDuplex, crlError=crlError, nghAggrDynDelSent=nghAggrDynDelSent, asymRouteCount=asymRouteCount, procEntry=procEntry, sysdetailErrorClear=sysdetailErrorClear, nghAggrConnected=nghAggrConnected, nghAggrRedirReqRcvd=nghAggrRedirReqRcvd, linkIoErrors=linkIoErrors, ttTalkersEntry=ttTalkersEntry, nghAggrConnFailures=nghAggrConnFailures, capabilityStatus=capabilityStatus, optimizedConnections=optimizedConnections, nghAggrRedirAckRcvd=nghAggrRedirAckRcvd, pagingActivity=pagingActivity, crlNumCdpErr=crlNumCdpErr, diskError=diskError, cfKeepaliveTimeoutClear=cfKeepaliveTimeoutClear, upgradeFailureClear=upgradeFailureClear, cpuIndivUtilTable=cpuIndivUtilTable, bwPortInWan=bwPortInWan, bwPassThroughOut=bwPassThroughOut, tcpDumpStarted=tcpDumpStarted, peerModel=peerModel, cpuUtilClear=cpuUtilClear, ttAppPortId=ttAppPortId, totalConnections=totalConnections, bandwidthAggregate=bandwidthAggregate, fanErrorClear=fanErrorClear, crlStatus=crlStatus, peerEntry=peerEntry, datastoreWrapped=datastoreWrapped, ttDestHostByteCount=ttDestHostByteCount, nghAggrRedirReqSent=nghAggrRedirReqSent, admissionMapiErrorClear=admissionMapiErrorClear, rspGeneralError=rspGeneralError, neighborNatDelSent=neighborNatDelSent, asymRouteErrorClear=asymRouteErrorClear, procIndex=procIndex, fanError=fanError, licenseExpired=licenseExpired, topTalkers=topTalkers, sslPeeringSCEPAutoReenrollClear=sslPeeringSCEPAutoReenrollClear, cpuIndivIndex=cpuIndivIndex, tcpDumpScheduled=tcpDumpScheduled, neighborRedirReqRcvd=neighborRedirReqRcvd, nghAggrNatAckRcvd=nghAggrNatAckRcvd, memoryError=memoryError, neighborIncompatibilityClear=neighborIncompatibilityClear, systemVersion=systemVersion, bwPortEntry=bwPortEntry, lanWanLoopClear=lanWanLoopClear, datastoreSyncAddr=datastoreSyncAddr, cfConnLostErrClear=cfConnLostErrClear, cliUserLogout=cliUserLogout, model=model, nghAggrNatDelRcvd=nghAggrNatDelRcvd, bandwidthPerPort=bandwidthPerPort, admissionCpuError=admissionCpuError, neighborDynDelRcvd=neighborDynDelRcvd, nghAggrDynReqRcvd=nghAggrDynReqRcvd, licenseErrorClear=licenseErrorClear, flashErrorClear=flashErrorClear, bwHCPortTable=bwHCPortTable, cpuIndivSystemTime=cpuIndivSystemTime, smbAlert=smbAlert, activeConnections=activeConnections, linkErrorClear=linkErrorClear, serialNumber=serialNumber, cfLatencyExceededClear=cfLatencyExceededClear, neighborNatAckSent=neighborNatAckSent, storageProfSwitchFailed=storageProfSwitchFailed, neighborConnFailures=neighborConnFailures, steelhead=steelhead, procName=procName, nghAggrRedirAckSent=nghAggrRedirAckSent, inpath=inpath, storeCorruption=storeCorruption, neighborNatAckRcvd=neighborNatAckRcvd, crlTable=crlTable, cpuLoad1=cpuLoad1, cpuIndivUserTime=cpuIndivUserTime, bypassMode=bypassMode, peerVersionMismatch=peerVersionMismatch, bwHCAggInLan=bwHCAggInLan, dsHitsTotal=dsHitsTotal, raidErrorClear=raidErrorClear, pagingActivityClear=pagingActivityClear, neighborState=neighborState, nghAggrNatReqSent=nghAggrNatReqSent, ttDestHostEntry=ttDestHostEntry, confModeEnter=confModeEnter, ipmi=ipmi, shMaxBandwidth=shMaxBandwidth, cfConnLostErr=cfConnLostErr, neighborRedirDelRcvd=neighborRedirDelRcvd, cpuIndivUtilEntry=cpuIndivUtilEntry, ttAppPortByteCount=ttAppPortByteCount, ttSrcHostEntry=ttSrcHostEntry, flashError=flashError, nghAggrNatDelSent=nghAggrNatDelSent, peerAddress=peerAddress, statistics=statistics, neighborDynAckSent=neighborDynAckSent, certsExpiringErrorClear=certsExpiringErrorClear, neighborRedirAckSent=neighborRedirAckSent, configChange=configChange, admissionMemError=admissionMemError, nfsV2V4=nfsV2V4, powerSupplyError=powerSupplyError, memoryErrorClear=memoryErrorClear, establishedConnections=establishedConnections, serviceError=serviceError, neighborDynAckRcvd=neighborDynAckRcvd, systemTemperature=systemTemperature, smartError=smartError, bypassModeClear=bypassModeClear, certsExpiringError=certsExpiringError, licenseExpiring=licenseExpiring, peerHostname=peerHostname, cfReadInfoTimeoutClear=cfReadInfoTimeoutClear, inpathSupport=inpathSupport, rspServiceClear=rspServiceClear, neighborRedirReqSent=neighborRedirReqSent, ttSrcHostId=ttSrcHostId, serviceUptime=serviceUptime, admissionTcpErrorClear=admissionTcpErrorClear, bwHCPortOutWan=bwHCPortOutWan, bwHCAggOutLan=bwHCAggOutLan, outofpath=outofpath, cfReadInfoTimeout=cfReadInfoTimeout, rspServiceError=rspServiceError, peerTable=peerTable, dsMissTotal=dsMissTotal, ttTalkersTable=ttTalkersTable, peerVersionMismatchClear=peerVersionMismatchClear, cpuIndivIdleTime=cpuIndivIdleTime, alarmsPrefix=alarmsPrefix, neighborDynReqSent=neighborDynReqSent, hardwareError=hardwareError, datastoreSyncFailure=datastoreSyncFailure, bandwidthHCAggregate=bandwidthHCAggregate, bwAggInLan=bwAggInLan, neighborNatDelRcvd=neighborNatDelRcvd, cpuIndivId=cpuIndivId, bwHCPortInWan=bwHCPortInWan, neighborEntry=neighborEntry, datastoreSyncPort=datastoreSyncPort, ttDestHostId=ttDestHostId, haltError=haltError, sysdetailError=sysdetailError, domainJoinError=domainJoinError, ttSrcHostIp=ttSrcHostIp, linkDuplexClear=linkDuplexClear, raidError=raidError, datastoreSync=datastoreSync)
mibBuilder.exportSymbols("STEELHEAD-MIB", cfLatencyExceeded=cfLatencyExceeded, domainJoinErrorClear=domainJoinErrorClear, wearWarning=wearWarning, cpuUtil1=cpuUtil1, nghAggrDynAckRcvd=nghAggrDynAckRcvd, cpuLoad15=cpuLoad15, bandwidthHCPerPort=bandwidthHCPerPort, neighborMaxLatency=neighborMaxLatency, webUserLogout=webUserLogout, cpuLoad5=cpuLoad5, ttAppPortTable=ttAppPortTable, bwHCAggInWan=bwHCAggInWan, nghAggrNatAckSent=nghAggrNatAckSent, rspGeneralClear=rspGeneralClear, ttTalkerPort2=ttTalkerPort2, cfConnRestored=cfConnRestored, crlClear=crlClear, asymRouteError=asymRouteError, licenseError=licenseError, cfAckTimeout=cfAckTimeout, dsAveDiskUtilization=dsAveDiskUtilization, bwPortNumber=bwPortNumber, diskErrorClear=diskErrorClear, crlFeatureName=crlFeatureName, procExit=procExit, nghAggrRequestTimeouts=nghAggrRequestTimeouts, clusterDisconnectedSHAlertError=clusterDisconnectedSHAlertError, webUserLogin=webUserLogin, crlErrMsg=crlErrMsg, admissionMapiError=admissionMapiError, upgradeFailure=upgradeFailure, procNumFailures=procNumFailures, ttAppPortEntry=ttAppPortEntry, admissionConnErrorClear=admissionConnErrorClear, storeCorruptionClear=storeCorruptionClear, cfAckTimeoutClear=cfAckTimeoutClear, lanWanLoopError=lanWanLoopError, optServiceStatus=optServiceStatus, secureVaultClear=secureVaultClear, bandwidthPassThrough=bandwidthPassThrough, admissionMemErrorClear=admissionMemErrorClear, admissionConnError=admissionConnError, secureVaultNeedsRekey=secureVaultNeedsRekey, ttTalkerId=ttTalkerId, passthroughConnections=passthroughConnections, bwAggOutWan=bwAggOutWan, trapTest=trapTest, bandwidth=bandwidth, neighborIndex=neighborIndex, nghAggrDynDelRcvd=nghAggrDynDelRcvd, ipmiClear=ipmiClear, hardwareErrorClear=hardwareErrorClear, system=system, linkError=linkError, nghAggrDynAckSent=nghAggrDynAckSent, confModeExit=confModeExit, neighborRequestTimeouts=neighborRequestTimeouts)
