...
ModuleIdentity, IpAddress, Integer32, Counter64, TimeTicks, Counter32, MibIdentifier, ObjectIdentity, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "Integer32", "Counter64", "TimeTicks", "Counter32", "MibIdentifier", "ObjectIdentity", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "iso")
...
mibBuilder.exportSymbols("STEELHEAD-MIB", admissionTcpError=admissionTcpError, cpuLoad=cpuLoad, fanErrorClear=fanErrorClear, cfConnFailure=cfConnFailure, systemDiskFullErrorClear=systemDiskFullErrorClear, secureVaultNeedsRekey=secureVaultNeedsRekey, cfReadInfoTimeout=cfReadInfoTimeout, diskError=diskError, activeConfig=activeConfig, linkDuplex=linkDuplex, neighborStatus=neighborStatus, serviceStatus=serviceStatus, halfClosedConnections=halfClosedConnections, bwAggOutLan=bwAggOutLan, optServiceStatus=optServiceStatus, ttDestHostTable=ttDestHostTable, halfOpenedConnections=halfOpenedConnections, bwHCPortInLan=bwHCPortInLan, nghAggrRedirAckSent=nghAggrRedirAckSent, ttTalkersTable=ttTalkersTable, bwAggOutWan=bwAggOutWan, dsAveDiskUtilization=dsAveDiskUtilization, pagingActivityClear=pagingActivityClear, ttTalkerByteCount=ttTalkerByteCount, neighborRedirDelSent=neighborRedirDelSent, totalConnections=totalConnections, licenseExpiring=licenseExpiring, system=system, configSave=configSave, config=config, peerModel=peerModel, bwHCAggInLan=bwHCAggInLan, ttTalkerIp2=ttTalkerIp2, neighborRedirReqSent=neighborRedirReqSent, neighborState=neighborState, neighborIncompatibility=neighborIncompatibility, crlFeatureName=crlFeatureName, bandwidthPassThrough=bandwidthPassThrough, nghAggrRedirReqRcvd=nghAggrRedirReqRcvd, bwHCPortEntry=bwHCPortEntry, linkError=linkError, ttTalkerId=ttTalkerId, peerAddress=peerAddress, flashErrorClear=flashErrorClear, neighborNatReqSent=neighborNatReqSent, cpuIndivIndex=cpuIndivIndex, cfKeepaliveTimeout=cfKeepaliveTimeout, nghAggrNatDelSent=nghAggrNatDelSent, peerEntry=peerEntry, bwPassThroughTotal=bwPassThroughTotal, neighborDynAckSent=neighborDynAckSent, cfKeepaliveTimeoutClear=cfKeepaliveTimeoutClear, cfLatencyExceededClear=cfLatencyExceededClear, crlError=crlError, neighborDynDelRcvd=neighborDynDelRcvd, powerSupplyErrorClear=powerSupplyErrorClear, alarms=alarms, neighborIncompatibilityClear=neighborIncompatibilityClear, lanWanLoopError=lanWanLoopError, powerSupplyError=powerSupplyError, smbAlert=smbAlert, neighborRedirAckSent=neighborRedirAckSent, neighborConnFailures=neighborConnFailures, admissionMemError=admissionMemError, hardwareErrorClear=hardwareErrorClear, ttTalkerPort2=ttTalkerPort2, neighborAddress=neighborAddress, ttDestHostIp=ttDestHostIp, nghAggrDynDelRcvd=nghAggrDynDelRcvd, dsHitsTotal=dsHitsTotal, linkDuplexClear=linkDuplexClear, neighborNatDelRcvd=neighborNatDelRcvd, ttAppPortEntry=ttAppPortEntry, domainJoinErrorClear=domainJoinErrorClear, dsCostPerSegment=dsCostPerSegment, admissionConnErrorClear=admissionConnErrorClear, bwPortInWan=bwPortInWan, systemDiskFullError=systemDiskFullError, secureVaultInitError=secureVaultInitError, neighborRedirReqRcvd=neighborRedirReqRcvd, datastoreSyncAddr=datastoreSyncAddr, memoryError=memoryError, bandwidthPerPort=bandwidthPerPort, neighborIndex=neighborIndex, crlStatus=crlStatus, datastoreSyncFailure=datastoreSyncFailure, procNumFailures=procNumFailures, ipmi=ipmi, rspServiceClear=rspServiceClear, crlNumCdpErr=crlNumCdpErr, health=health, ttDestHostByteCount=ttDestHostByteCount, procStatus=procStatus, cliUserLogout=cliUserLogout, neighborAggregates=neighborAggregates, shMaxBandwidth=shMaxBandwidth, bandwidthHCAggregate=bandwidthHCAggregate, bypassModeClear=bypassModeClear, cliUserLogin=cliUserLogin, cfConnLostEos=cfConnLostEos, ttDestHostEntry=ttDestHostEntry, procExit=procExit, nghAggrMaxLatency=nghAggrMaxLatency, neighborDynDelSent=neighborDynDelSent, crlTable=crlTable, cfConnLostEosClear=cfConnLostEosClear, cpuIndivId=cpuIndivId, ttAppPort=ttAppPort, nghAggrNatReqRcvd=nghAggrNatReqRcvd, bwAggInLan=bwAggInLan, serialNumber=serialNumber, systemTemperature=systemTemperature, neighborDynAckRcvd=neighborDynAckRcvd, smbAlertClear=smbAlertClear, ttSrcHostByteCount=ttSrcHostByteCount, nghAggrRequestTimeouts=nghAggrRequestTimeouts, crlEntry=crlEntry, serviceUptime=serviceUptime, cpuIndivUserTime=cpuIndivUserTime, nghAggrRedirAckRcvd=nghAggrRedirAckRcvd, bwAggHCOutWan=bwAggHCOutWan, PYSNMP_MODULE_ID=steelhead, serviceError=serviceError, licenseError=licenseError, cfConnRestored=cfConnRestored, neighborRedirDelRcvd=neighborRedirDelRcvd, admissionMapiErrorClear=admissionMapiErrorClear, admissionCpuErrorClear=admissionCpuErrorClear, secureVaultClear=secureVaultClear, cfAckTimeout=cfAckTimeout, connectionCounts=connectionCounts, nghAggrKeepaliveTimouts=nghAggrKeepaliveTimouts, neighborRequestTimeouts=neighborRequestTimeouts, ttSrcHostTable=ttSrcHostTable, temperatureNormal=temperatureNormal, nghAggrDynReqRcvd=nghAggrDynReqRcvd, certsExpiringErrorClear=certsExpiringErrorClear, activeConnections=activeConnections, peerIndex=peerIndex, crlErrMsg=crlErrMsg, secureVaultNeedsUnlock=secureVaultNeedsUnlock, capabilityStatus=capabilityStatus, passthroughConnections=passthroughConnections, confModeEnter=confModeEnter, bwHCPortNumber=bwHCPortNumber, newUserCreated=newUserCreated, diskErrorClear=diskErrorClear, crlClear=crlClear, systemClock=systemClock, peerVersionMismatch=peerVersionMismatch, nfsV2V4=nfsV2V4, fanError=fanError, neighborNatAckRcvd=neighborNatAckRcvd, peerStatus=peerStatus, cpuLoad1=cpuLoad1, lanWanLoopClear=lanWanLoopClear, linkIoErrorsClear=linkIoErrorsClear, datastoreSync=datastoreSync, admissionMemErrorClear=admissionMemErrorClear, ttDestHostId=ttDestHostId, neighborKeepaliveTimeouts=neighborKeepaliveTimeouts, asymRouteErrorClear=asymRouteErrorClear, ttAppPortByteCount=ttAppPortByteCount, sysdetailError=sysdetailError, optimizationServiceStatusClear=optimizationServiceStatusClear, cpuIndivUtilEntry=cpuIndivUtilEntry, bandwidthHCPerPort=bandwidthHCPerPort, cfConnLostErrClear=cfConnLostErrClear, rspGeneralError=rspGeneralError, sslPeeringSCEPAutoReenrollClear=sslPeeringSCEPAutoReenrollClear, systemVersion=systemVersion, peerTable=peerTable, nghAggrDynAckSent=nghAggrDynAckSent, steelhead=steelhead, ttTalkersEntry=ttTalkersEntry, topTalkers=topTalkers, neighborNatAckSent=neighborNatAckSent, cpuIndivUtilTable=cpuIndivUtilTable, cpuIndivIdleTime=cpuIndivIdleTime, outofpathSupport=outofpathSupport, cfConnLostErr=cfConnLostErr, sslPeeringSCEPAutoReenrollError=sslPeeringSCEPAutoReenrollError, hardwareError=hardwareError, clusterDisconnectedSHAlertClear=clusterDisconnectedSHAlertClear, cpuLoad15=cpuLoad15, bandwidth=bandwidth, dsMissTotal=dsMissTotal, neighborTable=neighborTable, neighborDynReqRcvd=neighborDynReqRcvd, optimizationServiceStatusError=optimizationServiceStatusError, webUserLogout=webUserLogout, ipmiClear=ipmiClear, nghAggrConnFailures=nghAggrConnFailures, temperatureCritical=temperatureCritical, ttAppPortId=ttAppPortId, bwPortNumber=bwPortNumber, nghAggrNatReqSent=nghAggrNatReqSent, cfLatencyExceeded=cfLatencyExceeded, neighborMaxLatency=neighborMaxLatency, bwPortOutLan=bwPortOutLan, confModeExit=confModeExit, smartError=smartError, bandwidthHC=bandwidthHC, licenseExpired=licenseExpired, haltError=haltError, cpuUtilClear=cpuUtilClear, bwHCPortOutLan=bwHCPortOutLan, bwHCPortOutWan=bwHCPortOutWan, bwPortInLan=bwPortInLan, bwPortTable=bwPortTable, status=status, nghAggrDynDelSent=nghAggrDynDelSent, linkErrorClear=linkErrorClear, neighborEntry=neighborEntry, model=model, neighborDynReqSent=neighborDynReqSent, datastore=datastore, bandwidthAggregate=bandwidthAggregate, nghAggrNatAckRcvd=nghAggrNatAckRcvd, nghAggrNatAckSent=nghAggrNatAckSent, ttSrcHostId=ttSrcHostId, sysdetailErrorClear=sysdetailErrorClear, cpuUtil1=cpuUtil1, ttTalkerPort1=ttTalkerPort1, raidError=raidError, storeCorruptionClear=storeCorruptionClear, ttTalkerIp1=ttTalkerIp1, ttSrcHostEntry=ttSrcHostEntry, licenseErrorClear=licenseErrorClear, raidErrorClear=raidErrorClear, inpathSupport=inpathSupport, bwHCAggOutLan=bwHCAggOutLan, cfReadInfoTimeoutClear=cfReadInfoTimeoutClear, admissionMapiError=admissionMapiError, webUserLogin=webUserLogin, nghAggrRedirDelSent=nghAggrRedirDelSent, pagingActivity=pagingActivity, bwHCPortInWan=bwHCPortInWan, procName=procName, systemHealth=systemHealth, nfsV2V4Clear=nfsV2V4Clear, rspGeneralClear=rspGeneralClear, alarmsPrefix=alarmsPrefix, tcpDumpScheduled=tcpDumpScheduled, domainJoinError=domainJoinError, procCrash=procCrash, certsExpiringError=certsExpiringError, statistics=statistics, neighborNatReqRcvd=neighborNatReqRcvd, nghAggrConnected=nghAggrConnected, bwAggInWan=bwAggInWan, peerHostname=peerHostname, healthNotes=healthNotes, clusterDisconnectedSHAlertError=clusterDisconnectedSHAlertError)
mibBuilder.exportSymbols("STEELHEAD-MIB", storageProfSwitchFailed=storageProfSwitchFailed, nghAggrNatDelRcvd=nghAggrNatDelRcvd, haltErrorClear=haltErrorClear, outofpath=outofpath, nghAggrConfigured=nghAggrConfigured, datastoreSyncPort=datastoreSyncPort, upgradeFailureClear=upgradeFailureClear, asymRouteError=asymRouteError, linkIoErrors=linkIoErrors, establishedConnections=establishedConnections, bwHCPortTable=bwHCPortTable, nghAggrDynAckRcvd=nghAggrDynAckRcvd, bwHCAggInWan=bwHCAggInWan, procTable=procTable, procEntry=procEntry, trapTest=trapTest, asymRouteCount=asymRouteCount, serviceErrorClear=serviceErrorClear, rspServiceError=rspServiceError, configChange=configChange, upgradeFailure=upgradeFailure, peerVersionMismatchClear=peerVersionMismatchClear, admissionConnError=admissionConnError, nghAggrRedirReqSent=nghAggrRedirReqSent, nghAggrRedirDelRcvd=nghAggrRedirDelRcvd, cpuLoad5=cpuLoad5, admissionCpuError=admissionCpuError, datastoreWrapped=datastoreWrapped, neighborRedirAckRcvd=neighborRedirAckRcvd, optimizedConnections=optimizedConnections, admissionTcpErrorClear=admissionTcpErrorClear, shMaxConnections=shMaxConnections, bwPortEntry=bwPortEntry, cfAckTimeoutClear=cfAckTimeoutClear, memoryErrorClear=memoryErrorClear, bypassMode=bypassMode, flashError=flashError, temperatureNonCritical=temperatureNonCritical, wearWarning=wearWarning, scheduledJobError=scheduledJobError, cpuUtil=cpuUtil, temperatureWarning=temperatureWarning, neighborNatDelSent=neighborNatDelSent, tcpDumpStarted=tcpDumpStarted, ttAppPortTable=ttAppPortTable, nghAggrDynReqSent=nghAggrDynReqSent, procIndex=procIndex, storeCorruption=storeCorruption, bwPortOutWan=bwPortOutWan, cpuIndivSystemTime=cpuIndivSystemTime, crlIndex=crlIndex, bwPassThroughOut=bwPassThroughOut, peerVersion=peerVersion, inpath=inpath, ttSrcHostIp=ttSrcHostIp, datastoreSyncFailureClear=datastoreSyncFailureClear, bwPassThroughIn=bwPassThroughIn)
