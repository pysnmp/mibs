...
Counter32, Gauge32, ObjectIdentity, TimeTicks, Bits, NotificationType, IpAddress, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, iso, Counter64, mib_2, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "ObjectIdentity", "TimeTicks", "Bits", "NotificationType", "IpAddress", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "iso", "Counter64", "mib-2", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPULoad=stCPULoad, kMicroVersion=kMicroVersion, stFtpBytesToClient=stFtpBytesToClient, stMemConsumed=stMemConsumed, pTSDBVersion=pTSDBVersion, stMimeType=stMimeType, kCustomVersion=kCustomVersion, kHotfixVersion=kHotfixVersion, stBadReputation=stBadReputation, stFtpBytesFromClient=stFtpBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kRevision=kRevision, stCategories=stCategories, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesFromServer=stFtpBytesFromServer, pAMEngineVersion=pAMEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, mwgEngineVersions=mwgEngineVersions, stCPULoadRaw=stCPULoadRaw, kMajorVersion=kMajorVersion, stHttpBytesToServer=stHttpBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesToClient=stHttpsBytesToClient, stCategoryName=stCategoryName, stHttpRequests=stHttpRequests, kBuildNumber=kBuildNumber, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgTrapVariables=mwgTrapVariables, kCompanyName=kCompanyName, stCategoryCount=stCategoryCount, stCategoriesTable=stCategoriesTable, kMinorVersion=kMinorVersion, pMFEDATVersion=pMFEDATVersion, stFtpBytesToServer=stFtpBytesToServer, stCPUIOWait=stCPUIOWait, notifyReason=notifyReason, stHttpsRequests=stHttpsRequests, stHttpBytesFromClient=stHttpBytesFromClient, mwgContent=mwgContent, stConnectionsLegitimate=stConnectionsLegitimate, stTimeForTransaction=stTimeForTransaction, stResolveHostViaDNS=stResolveHostViaDNS, pAMSignatureVersion=pAMSignatureVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHandleConnectToServer=stHandleConnectToServer, trUser=trUser, stHttpsBytesFromClient=stHttpsBytesFromClient, kProductName=kProductName, notifyAffectedHost=notifyAffectedHost, trApplication=trApplication, stConnectedSockets=stConnectedSockets, stConnectionsBlocked=stConnectionsBlocked, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyOriginName=notifyOriginName, stHttpsTraffic=stHttpsTraffic, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoriesEntry=stCategoriesEntry, stHttpBytesToClient=stHttpBytesToClient, stMalwareDetected=stMalwareDetected, mwgHttp=mwgHttp, pAMProactiveVersion=pAMProactiveVersion, stFtpTraffic=stFtpTraffic, mwgInfo=mwgInfo, stClientCount=stClientCount, mwgHttps=mwgHttps, mwg=mwg, kProductVersion=kProductVersion, mwgTraps=mwgTraps, mwgFTP=mwgFTP, notifyAdditional=notifyAdditional, mwgStatistics=mwgStatistics, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpTraffic=stHttpTraffic, notifySeverity=notifySeverity, notifyReasonString=notifyReasonString, notifyOrigin=notifyOrigin, mwgMiscellaneous=mwgMiscellaneous, trSystem=trSystem, PYSNMP_MODULE_ID=mwg)
