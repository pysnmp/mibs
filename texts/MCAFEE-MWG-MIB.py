...
Counter64, Counter32, NotificationType, iso, Bits, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, enterprises, Gauge32, ModuleIdentity, Integer32, mib_2, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Counter32", "NotificationType", "iso", "Bits", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "enterprises", "Gauge32", "ModuleIdentity", "Integer32", "mib-2", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kRevision=kRevision, mwgTrapVariables=mwgTrapVariables, stMemConsumed=stMemConsumed, stHttpsBytesToClient=stHttpsBytesToClient, stTimeForTransaction=stTimeForTransaction, pAMEngineVersion=pAMEngineVersion, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesToClient=stHttpBytesToClient, notifyReasonString=notifyReasonString, PYSNMP_MODULE_ID=mwg, pTSDBVersion=pTSDBVersion, stBadReputation=stBadReputation, stMalwareDetected=stMalwareDetected, kMajorVersion=kMajorVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectedSockets=stConnectedSockets, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsRequests=stHttpsRequests, mwgInfo=mwgInfo, notifySeverity=notifySeverity, stConnectionsLegitimate=stConnectionsLegitimate, kBuildNumber=kBuildNumber, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesFromServer=stHttpBytesFromServer, mwgEngineVersions=mwgEngineVersions, mwgFTP=mwgFTP, stHttpTraffic=stHttpTraffic, stResolveHostViaDNS=stResolveHostViaDNS, notifyReason=notifyReason, stCategories=stCategories, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyOrigin=notifyOrigin, stFtpBytesFromClient=stFtpBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, notifyAffectedHost=notifyAffectedHost, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgTraps=mwgTraps, kMinorVersion=kMinorVersion, kCustomVersion=kCustomVersion, stHandleConnectToServer=stHandleConnectToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stClientCount=stClientCount, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoryCount=stCategoryCount, kCompanyName=kCompanyName, stCategoriesEntry=stCategoriesEntry, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgMiscellaneous=mwgMiscellaneous, mwg=mwg, trUser=trUser, trApplication=trApplication, mwgHttp=mwgHttp, kProductVersion=kProductVersion, stCategoriesTable=stCategoriesTable, stHttpsTraffic=stHttpsTraffic, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stMimeType=stMimeType, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyAdditional=notifyAdditional, kProductName=kProductName, stCPULoadRaw=stCPULoadRaw, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesToServer=stHttpsBytesToServer, pAMSignatureVersion=pAMSignatureVersion, mwgHttps=mwgHttps, pAMProactiveVersion=pAMProactiveVersion, stHttpRequests=stHttpRequests, stHttpBytesToServer=stHttpBytesToServer, stCPUIOWait=stCPUIOWait, stFtpTraffic=stFtpTraffic, mwgContent=mwgContent, mwgStatistics=mwgStatistics, stCategoryName=stCategoryName, stFtpBytesToClient=stFtpBytesToClient, kMicroVersion=kMicroVersion, pMFEDATVersion=pMFEDATVersion, stCPULoad=stCPULoad, notifyOriginName=notifyOriginName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, trSystem=trSystem, stFtpBytesToServer=stFtpBytesToServer, kHotfixVersion=kHotfixVersion)
