...
Counter32, Counter64, Gauge32, MibIdentifier, Unsigned32, Integer32, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, mib_2, NotificationType, Bits, enterprises, ObjectIdentity, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "Gauge32", "MibIdentifier", "Unsigned32", "Integer32", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "mib-2", "NotificationType", "Bits", "enterprises", "ObjectIdentity", "iso", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpRequests=stHttpRequests, stFtpTraffic=stFtpTraffic, stCPULoadRaw=stCPULoadRaw, stHttpBytesFromClient=stHttpBytesFromClient, mwgHttps=mwgHttps, mwgTraps=mwgTraps, stCategories=stCategories, trApplication=trApplication, PYSNMP_MODULE_ID=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwg=mwg, stFtpBytesToServer=stFtpBytesToServer, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stMimeType=stMimeType, stCategoriesTable=stCategoriesTable, notifyReason=notifyReason, stClientCount=stClientCount, notifySeverity=notifySeverity, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, notifyAffectedHost=notifyAffectedHost, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kCompanyName=kCompanyName, pTSDBVersion=pTSDBVersion, stBadReputation=stBadReputation, trUser=trUser, stBlockedByAntiMalware=stBlockedByAntiMalware, stConnectionsBlocked=stConnectionsBlocked, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, kProductName=kProductName, stHttpsTraffic=stHttpsTraffic, kHotfixVersion=kHotfixVersion, stHttpsBytesToServer=stHttpsBytesToServer, kProductVersion=kProductVersion, kCustomVersion=kCustomVersion, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromClient=stHttpsBytesFromClient, stTimeForTransaction=stTimeForTransaction, kBuildNumber=kBuildNumber, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMinorVersion=kMinorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, pAMProactiveVersion=pAMProactiveVersion, mwgFTP=mwgFTP, stHandleConnectToServer=stHandleConnectToServer, mwgHttp=mwgHttp, notifyOrigin=notifyOrigin, kRevision=kRevision, stHttpTraffic=stHttpTraffic, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgTrapVariables=mwgTrapVariables, stHttpBytesToClient=stHttpBytesToClient, mwgMiscellaneous=mwgMiscellaneous, stLastSentLastReceivedServer=stLastSentLastReceivedServer, trSystem=trSystem, stCategoryCount=stCategoryCount, stHttpsBytesToClient=stHttpsBytesToClient, kMicroVersion=kMicroVersion, stConnectedSockets=stConnectedSockets, mwgInfo=mwgInfo, stHttpsRequests=stHttpsRequests, mwgContent=mwgContent, stResolveHostViaDNS=stResolveHostViaDNS, pMFEDATVersion=pMFEDATVersion, stCategoryName=stCategoryName, notifyAdditional=notifyAdditional, stCPULoad=stCPULoad, mwgStatistics=mwgStatistics, stHttpBytesToServer=stHttpBytesToServer, stMalwareDetected=stMalwareDetected, notifyReasonString=notifyReasonString, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyOriginName=notifyOriginName, mwgEngineVersions=mwgEngineVersions, stCPUIOWait=stCPUIOWait, pAMEngineVersion=pAMEngineVersion, stCategoriesEntry=stCategoriesEntry, kMajorVersion=kMajorVersion, pAMSignatureVersion=pAMSignatureVersion, stMemConsumed=stMemConsumed)
