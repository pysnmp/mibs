...
Unsigned32, Integer32, Gauge32, enterprises, mib_2, Counter64, ObjectIdentity, iso, TimeTicks, ModuleIdentity, NotificationType, Counter32, NotificationType, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "Gauge32", "enterprises", "mib-2", "Counter64", "ObjectIdentity", "iso", "TimeTicks", "ModuleIdentity", "NotificationType", "Counter32", "NotificationType", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMEngineVersion=pAMEngineVersion, notifyReason=notifyReason, stMimeType=stMimeType, stConnectionsBlocked=stConnectionsBlocked, mwgMiscellaneous=mwgMiscellaneous, mwgHttp=mwgHttp, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesFromServer=stFtpBytesFromServer, kHotfixVersion=kHotfixVersion, pAMProactiveVersion=pAMProactiveVersion, mwgHttps=mwgHttps, stHttpRequests=stHttpRequests, stCPULoad=stCPULoad, kCompanyName=kCompanyName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgEngineVersions=mwgEngineVersions, mwgTrapVariables=mwgTrapVariables, stHttpTraffic=stHttpTraffic, stFtpBytesToServer=stFtpBytesToServer, pMFEEngineVersion=pMFEEngineVersion, stHttpsTraffic=stHttpsTraffic, stResolveHostViaDNS=stResolveHostViaDNS, mwgStatistics=mwgStatistics, stHttpBytesToServer=stHttpBytesToServer, mwg=mwg, stCPULoadRaw=stCPULoadRaw, kProductVersion=kProductVersion, stHandleConnectToServer=stHandleConnectToServer, stFtpTraffic=stFtpTraffic, stFtpBytesToClient=stFtpBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesFromClient=stFtpBytesFromClient, stConnectionsLegitimate=stConnectionsLegitimate, kProductName=kProductName, notifyOriginName=notifyOriginName, mwgFTP=mwgFTP, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectedSockets=stConnectedSockets, notifySeverity=notifySeverity, stHttpBytesFromClient=stHttpBytesFromClient, notifyAdditional=notifyAdditional, kMicroVersion=kMicroVersion, kMajorVersion=kMajorVersion, PYSNMP_MODULE_ID=mwg, stCategoryCount=stCategoryCount, stCategoryName=stCategoryName, pAMSignatureVersion=pAMSignatureVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, kCustomVersion=kCustomVersion, stHttpsBytesToClient=stHttpsBytesToClient, stCategoriesTable=stCategoriesTable, stBlockedByMediaFilter=stBlockedByMediaFilter, pMFEDATVersion=pMFEDATVersion, kMinorVersion=kMinorVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyOrigin=notifyOrigin, pTSDBVersion=pTSDBVersion, notifyReasonString=notifyReasonString, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCPUIOWait=stCPUIOWait, stClientCount=stClientCount, stCategoriesEntry=stCategoriesEntry, stHttpBytesFromServer=stHttpBytesFromServer, mwgTraps=mwgTraps, mwgInfo=mwgInfo, stBadReputation=stBadReputation, trUser=trUser, stCategories=stCategories, kBuildNumber=kBuildNumber, stHttpBytesToClient=stHttpBytesToClient, stTimeForTransaction=stTimeForTransaction, trSystem=trSystem, stHttpsRequests=stHttpsRequests, notifyAffectedHost=notifyAffectedHost, stMalwareDetected=stMalwareDetected, trApplication=trApplication, kRevision=kRevision, stMemConsumed=stMemConsumed, mwgContent=mwgContent)
