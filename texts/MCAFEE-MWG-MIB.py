...
Integer32, Unsigned32, Counter64, IpAddress, ObjectIdentity, NotificationType, iso, TimeTicks, Counter32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, ModuleIdentity, MibIdentifier, Gauge32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Counter64", "IpAddress", "ObjectIdentity", "NotificationType", "iso", "TimeTicks", "Counter32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "ModuleIdentity", "MibIdentifier", "Gauge32", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByAntiMalware=stBlockedByAntiMalware, stBlockedByURLFilter=stBlockedByURLFilter, stMimeType=stMimeType, mwgEngineVersions=mwgEngineVersions, mwgInfo=mwgInfo, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesFromClient=stHttpBytesFromClient, stHttpRequests=stHttpRequests, mwgTraps=mwgTraps, notifyOrigin=notifyOrigin, mwgHttps=mwgHttps, kBuildNumber=kBuildNumber, stCPULoadRaw=stCPULoadRaw, stHttpBytesFromServer=stHttpBytesFromServer, kCustomVersion=kCustomVersion, notifyReasonString=notifyReasonString, notifyAffectedHost=notifyAffectedHost, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoryCount=stCategoryCount, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgContent=mwgContent, kMinorVersion=kMinorVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeForTransaction=stTimeForTransaction, stFtpBytesFromServer=stFtpBytesFromServer, mwg=mwg, stCategoryName=stCategoryName, PYSNMP_MODULE_ID=mwg, mwgHttp=mwgHttp, trUser=trUser, stCPULoad=stCPULoad, stHttpsBytesToClient=stHttpsBytesToClient, kMajorVersion=kMajorVersion, pMFEEngineVersion=pMFEEngineVersion, stMalwareDetected=stMalwareDetected, stConnectionsBlocked=stConnectionsBlocked, kMicroVersion=kMicroVersion, stFtpBytesFromClient=stFtpBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, stCPUIOWait=stCPUIOWait, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stClientCount=stClientCount, stHttpBytesToServer=stHttpBytesToServer, stHttpsTraffic=stHttpsTraffic, stConnectionsLegitimate=stConnectionsLegitimate, stFtpTraffic=stFtpTraffic, mwgStatistics=mwgStatistics, pMFEDATVersion=pMFEDATVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectedSockets=stConnectedSockets, notifyOriginName=notifyOriginName, trApplication=trApplication, kRevision=kRevision, kProductVersion=kProductVersion, pAMProactiveVersion=pAMProactiveVersion, stCategoriesTable=stCategoriesTable, stCategories=stCategories, stHttpsRequests=stHttpsRequests, notifySeverity=notifySeverity, mwgFTP=mwgFTP, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kProductName=kProductName, kCompanyName=kCompanyName, stFtpBytesToServer=stFtpBytesToServer, notifyReason=notifyReason, pTSDBVersion=pTSDBVersion, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, pAMEngineVersion=pAMEngineVersion, stResolveHostViaDNS=stResolveHostViaDNS, notifyAdditional=notifyAdditional, stHandleConnectToServer=stHandleConnectToServer, mwgTrapVariables=mwgTrapVariables, kHotfixVersion=kHotfixVersion, stCategoriesEntry=stCategoriesEntry, stBadReputation=stBadReputation, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgMiscellaneous=mwgMiscellaneous, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, trSystem=trSystem, stHttpBytesToClient=stHttpBytesToClient, stMemConsumed=stMemConsumed, stHttpTraffic=stHttpTraffic)
