...
MibIdentifier, iso, enterprises, Counter64, NotificationType, NotificationType, TimeTicks, Gauge32, Integer32, IpAddress, ObjectIdentity, Unsigned32, Counter32, Bits, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "enterprises", "Counter64", "NotificationType", "NotificationType", "TimeTicks", "Gauge32", "Integer32", "IpAddress", "ObjectIdentity", "Unsigned32", "Counter32", "Bits", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectionsLegitimate=stConnectionsLegitimate, stMemConsumed=stMemConsumed, stCPUIOWait=stCPUIOWait, stCategories=stCategories, mwgStatistics=mwgStatistics, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesToClient=stHttpBytesToClient, notifyAdditional=notifyAdditional, mwgHttp=mwgHttp, stBadReputation=stBadReputation, stFtpBytesToClient=stFtpBytesToClient, kCompanyName=kCompanyName, mwgInfo=mwgInfo, pMFEDATVersion=pMFEDATVersion, kHotfixVersion=kHotfixVersion, mwgEngineVersions=mwgEngineVersions, stMalwareDetected=stMalwareDetected, notifyReason=notifyReason, kMinorVersion=kMinorVersion, mwgMiscellaneous=mwgMiscellaneous, stCategoriesTable=stCategoriesTable, mwgTrapVariables=mwgTrapVariables, stCPULoad=stCPULoad, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesFromServer=stHttpBytesFromServer, mwgContent=mwgContent, kMicroVersion=kMicroVersion, stHttpsRequests=stHttpsRequests, PYSNMP_MODULE_ID=mwg, stHttpsBytesToServer=stHttpsBytesToServer, notifyOriginName=notifyOriginName, stHttpTraffic=stHttpTraffic, kBuildNumber=kBuildNumber, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsTraffic=stHttpsTraffic, kCustomVersion=kCustomVersion, stHandleConnectToServer=stHandleConnectToServer, mwgFTP=mwgFTP, notifySeverity=notifySeverity, pMFEEngineVersion=pMFEEngineVersion, stFtpTraffic=stFtpTraffic, trApplication=trApplication, stTimeForTransaction=stTimeForTransaction, pAMSignatureVersion=pAMSignatureVersion, stCategoryName=stCategoryName, trUser=trUser, mwgHttps=mwgHttps, stCPULoadRaw=stCPULoadRaw, stBlockedByMediaFilter=stBlockedByMediaFilter, kProductVersion=kProductVersion, notifyOrigin=notifyOrigin, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectedSockets=stConnectedSockets, stHttpBytesToServer=stHttpBytesToServer, stHttpRequests=stHttpRequests, stMimeType=stMimeType, stConnectionsBlocked=stConnectionsBlocked, notifyAffectedHost=notifyAffectedHost, stResolveHostViaDNS=stResolveHostViaDNS, notifyReasonString=notifyReasonString, kRevision=kRevision, kProductName=kProductName, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMajorVersion=kMajorVersion, stFtpBytesFromClient=stFtpBytesFromClient, trSystem=trSystem, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesToClient=stHttpsBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pTSDBVersion=pTSDBVersion, stClientCount=stClientCount, stFtpBytesToServer=stFtpBytesToServer, stCategoriesEntry=stCategoriesEntry, mwgTraps=mwgTraps, stCategoryCount=stCategoryCount, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwg=mwg, stBlockedByAntiMalware=stBlockedByAntiMalware)
