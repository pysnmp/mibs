...
NotificationType, IpAddress, Bits, iso, MibIdentifier, NotificationType, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, mib_2, ObjectIdentity, ModuleIdentity, Integer32, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Bits", "iso", "MibIdentifier", "NotificationType", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "mib-2", "ObjectIdentity", "ModuleIdentity", "Integer32", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kCustomVersion=kCustomVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHandleConnectToServer=stHandleConnectToServer, stResolveHostViaDNS=stResolveHostViaDNS, stConnectionsLegitimate=stConnectionsLegitimate, stCPUIOWait=stCPUIOWait, stHttpTraffic=stHttpTraffic, kMajorVersion=kMajorVersion, stCPULoadRaw=stCPULoadRaw, stFtpBytesFromClient=stFtpBytesFromClient, stTimeForTransaction=stTimeForTransaction, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kCompanyName=kCompanyName, stConnectionsBlocked=stConnectionsBlocked, kHotfixVersion=kHotfixVersion, stCPULoad=stCPULoad, mwgHttps=mwgHttps, stCategoryName=stCategoryName, stFtpTraffic=stFtpTraffic, stHttpBytesFromClient=stHttpBytesFromClient, mwgFTP=mwgFTP, mwgContent=mwgContent, stCategoriesEntry=stCategoriesEntry, mwgInfo=mwgInfo, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kBuildNumber=kBuildNumber, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesToServer=stHttpsBytesToServer, pAMEngineVersion=pAMEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, notifyReasonString=notifyReasonString, mwgStatistics=mwgStatistics, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBadReputation=stBadReputation, stHttpsBytesToClient=stHttpsBytesToClient, kProductVersion=kProductVersion, notifyAdditional=notifyAdditional, kMicroVersion=kMicroVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesToServer=stHttpBytesToServer, stMemConsumed=stMemConsumed, mwgTraps=mwgTraps, mwgHttp=mwgHttp, kProductName=kProductName, pAMSignatureVersion=pAMSignatureVersion, notifyOriginName=notifyOriginName, notifyAffectedHost=notifyAffectedHost, mwgTrapVariables=mwgTrapVariables, pAMProactiveVersion=pAMProactiveVersion, pTSDBVersion=pTSDBVersion, mwg=mwg, notifySeverity=notifySeverity, stCategoriesTable=stCategoriesTable, stFtpBytesFromServer=stFtpBytesFromServer, trUser=trUser, stFtpBytesToClient=stFtpBytesToClient, kRevision=kRevision, pMFEDATVersion=pMFEDATVersion, mwgMiscellaneous=mwgMiscellaneous, notifyReason=notifyReason, mwgEngineVersions=mwgEngineVersions, stCategoryCount=stCategoryCount, pMFEEngineVersion=pMFEEngineVersion, kMinorVersion=kMinorVersion, stHttpRequests=stHttpRequests, stMimeType=stMimeType, notifyOrigin=notifyOrigin, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsTraffic=stHttpsTraffic, stHttpsRequests=stHttpsRequests, stClientCount=stClientCount, stMalwareDetected=stMalwareDetected, stCategories=stCategories, trSystem=trSystem, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByMediaFilter=stBlockedByMediaFilter, PYSNMP_MODULE_ID=mwg, trApplication=trApplication, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectedSockets=stConnectedSockets)
