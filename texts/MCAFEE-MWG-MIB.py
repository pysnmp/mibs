...
Counter64, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, Unsigned32, NotificationType, MibIdentifier, Bits, ObjectIdentity, enterprises, NotificationType, iso, IpAddress, mib_2, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "Unsigned32", "NotificationType", "MibIdentifier", "Bits", "ObjectIdentity", "enterprises", "NotificationType", "iso", "IpAddress", "mib-2", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyAffectedHost=notifyAffectedHost, kMicroVersion=kMicroVersion, PYSNMP_MODULE_ID=mwg, kHotfixVersion=kHotfixVersion, pMFEEngineVersion=pMFEEngineVersion, kRevision=kRevision, notifySeverity=notifySeverity, stCPUIOWait=stCPUIOWait, mwgTraps=mwgTraps, kCompanyName=kCompanyName, stConnectedSockets=stConnectedSockets, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesFromServer=stHttpBytesFromServer, mwgInfo=mwgInfo, mwgStatistics=mwgStatistics, stCategories=stCategories, pMFEDATVersion=pMFEDATVersion, stHttpBytesToClient=stHttpBytesToClient, stBlockedByURLFilter=stBlockedByURLFilter, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpRequests=stHttpRequests, trApplication=trApplication, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgFTP=mwgFTP, kMinorVersion=kMinorVersion, kProductName=kProductName, stMalwareDetected=stMalwareDetected, notifyOriginName=notifyOriginName, stHttpBytesFromClient=stHttpBytesFromClient, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesToServer=stFtpBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpTraffic=stFtpTraffic, pTSDBVersion=pTSDBVersion, stCPULoadRaw=stCPULoadRaw, mwgContent=mwgContent, stBadReputation=stBadReputation, kCustomVersion=kCustomVersion, pAMEngineVersion=pAMEngineVersion, stHttpsTraffic=stHttpsTraffic, stResolveHostViaDNS=stResolveHostViaDNS, kProductVersion=kProductVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpTraffic=stHttpTraffic, notifyAdditional=notifyAdditional, mwg=mwg, stCategoryName=stCategoryName, stCategoryCount=stCategoryCount, mwgHttp=mwgHttp, stHttpsBytesToClient=stHttpsBytesToClient, stCategoriesEntry=stCategoriesEntry, stCPULoad=stCPULoad, mwgEngineVersions=mwgEngineVersions, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesToServer=stHttpBytesToServer, stMimeType=stMimeType, pAMProactiveVersion=pAMProactiveVersion, stMemConsumed=stMemConsumed, mwgHttps=mwgHttps, notifyReason=notifyReason, stFtpBytesToClient=stFtpBytesToClient, stTimeForTransaction=stTimeForTransaction, trUser=trUser, stFtpBytesFromServer=stFtpBytesFromServer, kBuildNumber=kBuildNumber, notifyOrigin=notifyOrigin, stConnectionsBlocked=stConnectionsBlocked, kMajorVersion=kMajorVersion, stClientCount=stClientCount, mwgMiscellaneous=mwgMiscellaneous, stCategoriesTable=stCategoriesTable, mwgTrapVariables=mwgTrapVariables, stFtpBytesFromClient=stFtpBytesFromClient, trSystem=trSystem, stHttpsRequests=stHttpsRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyReasonString=notifyReasonString, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByMediaFilter=stBlockedByMediaFilter)
