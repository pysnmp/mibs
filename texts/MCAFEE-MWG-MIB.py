...
NotificationType, Unsigned32, iso, enterprises, Integer32, Bits, IpAddress, ObjectIdentity, mib_2, Counter64, NotificationType, TimeTicks, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "iso", "enterprises", "Integer32", "Bits", "IpAddress", "ObjectIdentity", "mib-2", "Counter64", "NotificationType", "TimeTicks", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesFromServer=stHttpsBytesFromServer, notifyOriginName=notifyOriginName, stHttpBytesToServer=stHttpBytesToServer, stCategoryCount=stCategoryCount, mwgEngineVersions=mwgEngineVersions, notifyAffectedHost=notifyAffectedHost, notifyReasonString=notifyReasonString, kProductName=kProductName, stConnectedSockets=stConnectedSockets, stHttpRequests=stHttpRequests, stHttpBytesFromServer=stHttpBytesFromServer, kProductVersion=kProductVersion, pAMSignatureVersion=pAMSignatureVersion, stCategories=stCategories, stHttpBytesToClient=stHttpBytesToClient, stConnectionsLegitimate=stConnectionsLegitimate, kHotfixVersion=kHotfixVersion, stMemConsumed=stMemConsumed, stFtpTraffic=stFtpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesFromClient=stHttpsBytesFromClient, pMFEDATVersion=pMFEDATVersion, stHttpBytesFromClient=stHttpBytesFromClient, mwgTrapVariables=mwgTrapVariables, kMinorVersion=kMinorVersion, stTimeForTransaction=stTimeForTransaction, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pTSDBVersion=pTSDBVersion, pMFEEngineVersion=pMFEEngineVersion, stMalwareDetected=stMalwareDetected, stCPUIOWait=stCPUIOWait, stHttpTraffic=stHttpTraffic, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgStatistics=mwgStatistics, stFtpBytesToClient=stFtpBytesToClient, stCategoriesEntry=stCategoriesEntry, mwgContent=mwgContent, stBlockedByURLFilter=stBlockedByURLFilter, mwgHttp=mwgHttp, PYSNMP_MODULE_ID=mwg, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgMiscellaneous=mwgMiscellaneous, kMajorVersion=kMajorVersion, mwgHttps=mwgHttps, pAMEngineVersion=pAMEngineVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyOrigin=notifyOrigin, stHttpsBytesToClient=stHttpsBytesToClient, mwgInfo=mwgInfo, kCustomVersion=kCustomVersion, mwgFTP=mwgFTP, stBadReputation=stBadReputation, stHandleConnectToServer=stHandleConnectToServer, notifySeverity=notifySeverity, trUser=trUser, stHttpsRequests=stHttpsRequests, stClientCount=stClientCount, stConnectionsBlocked=stConnectionsBlocked, stCategoriesTable=stCategoriesTable, stCPULoad=stCPULoad, mwgTraps=mwgTraps, pAMProactiveVersion=pAMProactiveVersion, stHttpsTraffic=stHttpsTraffic, kBuildNumber=kBuildNumber, stFtpBytesToServer=stFtpBytesToServer, kMicroVersion=kMicroVersion, stFtpBytesFromServer=stFtpBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMimeType=stMimeType, stCategoryName=stCategoryName, stCPULoadRaw=stCPULoadRaw, kRevision=kRevision, notifyReason=notifyReason, trSystem=trSystem, trApplication=trApplication, stBlockedByMediaFilter=stBlockedByMediaFilter, kCompanyName=kCompanyName, notifyAdditional=notifyAdditional, mwg=mwg, stFtpBytesFromClient=stFtpBytesFromClient)
