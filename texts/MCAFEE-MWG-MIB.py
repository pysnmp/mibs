...
NotificationType, Counter32, Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, mib_2, ModuleIdentity, NotificationType, iso, Integer32, TimeTicks, MibIdentifier, ObjectIdentity, enterprises, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "mib-2", "ModuleIdentity", "NotificationType", "iso", "Integer32", "TimeTicks", "MibIdentifier", "ObjectIdentity", "enterprises", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kProductName=kProductName, stHttpTraffic=stHttpTraffic, kMicroVersion=kMicroVersion, mwgInfo=mwgInfo, stCPUIOWait=stCPUIOWait, stCategoryName=stCategoryName, kProductVersion=kProductVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgTraps=mwgTraps, stCategoriesTable=stCategoriesTable, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMimeType=stMimeType, stFtpBytesToServer=stFtpBytesToServer, notifyAffectedHost=notifyAffectedHost, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesFromServer=stFtpBytesFromServer, stCategoryCount=stCategoryCount, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwg=mwg, pAMEngineVersion=pAMEngineVersion, stConnectedSockets=stConnectedSockets, stFtpBytesToClient=stFtpBytesToClient, notifyOriginName=notifyOriginName, mwgHttp=mwgHttp, stMalwareDetected=stMalwareDetected, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyReasonString=notifyReasonString, kHotfixVersion=kHotfixVersion, notifyOrigin=notifyOrigin, mwgFTP=mwgFTP, mwgHttps=mwgHttps, kBuildNumber=kBuildNumber, trApplication=trApplication, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsRequests=stHttpsRequests, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesFromServer=stHttpBytesFromServer, mwgContent=mwgContent, kRevision=kRevision, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pMFEDATVersion=pMFEDATVersion, pTSDBVersion=pTSDBVersion, stCategories=stCategories, stHttpsBytesFromServer=stHttpsBytesFromServer, stBadReputation=stBadReputation, kCustomVersion=kCustomVersion, mwgTrapVariables=mwgTrapVariables, kMinorVersion=kMinorVersion, stClientCount=stClientCount, trSystem=trSystem, notifyReason=notifyReason, stHttpsBytesToClient=stHttpsBytesToClient, stConnectionsLegitimate=stConnectionsLegitimate, stConnectionsBlocked=stConnectionsBlocked, pAMSignatureVersion=pAMSignatureVersion, stHttpsTraffic=stHttpsTraffic, kMajorVersion=kMajorVersion, stTimeForTransaction=stTimeForTransaction, pMFEEngineVersion=pMFEEngineVersion, notifySeverity=notifySeverity, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgStatistics=mwgStatistics, stHttpRequests=stHttpRequests, stBlockedByURLFilter=stBlockedByURLFilter, stHandleConnectToServer=stHandleConnectToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpTraffic=stFtpTraffic, stHttpBytesFromClient=stHttpBytesFromClient, stMemConsumed=stMemConsumed, trUser=trUser, kCompanyName=kCompanyName, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesToClient=stHttpBytesToClient, PYSNMP_MODULE_ID=mwg, mwgEngineVersions=mwgEngineVersions, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoriesEntry=stCategoriesEntry, stCPULoadRaw=stCPULoadRaw, notifyAdditional=notifyAdditional, pAMProactiveVersion=pAMProactiveVersion, stCPULoad=stCPULoad)
