...
Counter64, Bits, enterprises, iso, Integer32, Gauge32, TimeTicks, mib_2, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, NotificationType, MibIdentifier, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "enterprises", "iso", "Integer32", "Gauge32", "TimeTicks", "mib-2", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "NotificationType", "MibIdentifier", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stConnectionsLegitimate=stConnectionsLegitimate, kMajorVersion=kMajorVersion, stHttpsTraffic=stHttpsTraffic, stHttpRequests=stHttpRequests, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyAdditional=notifyAdditional, PYSNMP_MODULE_ID=mwg, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgHttps=mwgHttps, mwgContent=mwgContent, notifyAffectedHost=notifyAffectedHost, stHandleConnectToServer=stHandleConnectToServer, notifyReason=notifyReason, stClientCount=stClientCount, trUser=trUser, stFtpBytesToClient=stFtpBytesToClient, kProductName=kProductName, kProductVersion=kProductVersion, stMimeType=stMimeType, stResolveHostViaDNS=stResolveHostViaDNS, stCPULoad=stCPULoad, stBlockedByURLFilter=stBlockedByURLFilter, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesToServer=stHttpBytesToServer, mwgInfo=mwgInfo, stBadReputation=stBadReputation, mwgStatistics=mwgStatistics, mwgTrapVariables=mwgTrapVariables, kCompanyName=kCompanyName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifySeverity=notifySeverity, kRevision=kRevision, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpTraffic=stHttpTraffic, stHttpBytesFromServer=stHttpBytesFromServer, notifyOriginName=notifyOriginName, stHttpBytesToClient=stHttpBytesToClient, pAMProactiveVersion=pAMProactiveVersion, kMicroVersion=kMicroVersion, stHttpsBytesToServer=stHttpsBytesToServer, pMFEEngineVersion=pMFEEngineVersion, kHotfixVersion=kHotfixVersion, stCategoriesEntry=stCategoriesEntry, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwg=mwg, stConnectedSockets=stConnectedSockets, kCustomVersion=kCustomVersion, kMinorVersion=kMinorVersion, stHttpsRequests=stHttpsRequests, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgTraps=mwgTraps, stConnectionsBlocked=stConnectionsBlocked, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, stCategories=stCategories, mwgMiscellaneous=mwgMiscellaneous, pTSDBVersion=pTSDBVersion, stCPUIOWait=stCPUIOWait, stFtpBytesFromServer=stFtpBytesFromServer, stCategoryCount=stCategoryCount, kBuildNumber=kBuildNumber, notifyOrigin=notifyOrigin, mwgFTP=mwgFTP, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesToServer=stFtpBytesToServer, mwgEngineVersions=mwgEngineVersions, pAMEngineVersion=pAMEngineVersion, mwgHttp=mwgHttp, stHttpBytesFromClient=stHttpBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesFromClient=stFtpBytesFromClient, stFtpTraffic=stFtpTraffic, stTimeForTransaction=stTimeForTransaction, stCategoriesTable=stCategoriesTable, trSystem=trSystem, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyReasonString=notifyReasonString, stHttpsBytesFromClient=stHttpsBytesFromClient, stMemConsumed=stMemConsumed, stCategoryName=stCategoryName, pMFEDATVersion=pMFEDATVersion, trApplication=trApplication, stCPULoadRaw=stCPULoadRaw)
