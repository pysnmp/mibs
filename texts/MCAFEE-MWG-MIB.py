...
Counter64, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, Bits, MibIdentifier, mib_2, ModuleIdentity, ObjectIdentity, NotificationType, Counter32, enterprises, Gauge32, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "Bits", "MibIdentifier", "mib-2", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Counter32", "enterprises", "Gauge32", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpBytesToClient=stHttpBytesToClient, mwgTraps=mwgTraps, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesFromClient=stHttpBytesFromClient, stClientCount=stClientCount, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, stTimeForTransaction=stTimeForTransaction, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMinorVersion=kMinorVersion, stBadReputation=stBadReputation, kHotfixVersion=kHotfixVersion, stMemConsumed=stMemConsumed, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgHttps=mwgHttps, notifyAffectedHost=notifyAffectedHost, stHttpsBytesToClient=stHttpsBytesToClient, kMicroVersion=kMicroVersion, stCategories=stCategories, notifyReasonString=notifyReasonString, mwgFTP=mwgFTP, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesEntry=stCategoriesEntry, stHttpRequests=stHttpRequests, stMimeType=stMimeType, stFtpTraffic=stFtpTraffic, trUser=trUser, stCategoriesTable=stCategoriesTable, PYSNMP_MODULE_ID=mwg, kMajorVersion=kMajorVersion, pAMSignatureVersion=pAMSignatureVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgEngineVersions=mwgEngineVersions, kRevision=kRevision, stHttpBytesFromServer=stHttpBytesFromServer, kProductName=kProductName, mwgContent=mwgContent, kCompanyName=kCompanyName, stFtpBytesToClient=stFtpBytesToClient, stConnectionsBlocked=stConnectionsBlocked, mwgHttp=mwgHttp, stHandleConnectToServer=stHandleConnectToServer, trApplication=trApplication, stFtpBytesToServer=stFtpBytesToServer, mwgStatistics=mwgStatistics, stHttpTraffic=stHttpTraffic, pAMEngineVersion=pAMEngineVersion, notifyAdditional=notifyAdditional, notifyOrigin=notifyOrigin, pMFEDATVersion=pMFEDATVersion, stCPULoadRaw=stCPULoadRaw, stHttpsRequests=stHttpsRequests, stBlockedByURLFilter=stBlockedByURLFilter, stMalwareDetected=stMalwareDetected, trSystem=trSystem, kCustomVersion=kCustomVersion, stCategoryCount=stCategoryCount, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesToServer=stHttpBytesToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, pTSDBVersion=pTSDBVersion, notifyOriginName=notifyOriginName, stConnectedSockets=stConnectedSockets, stCPUIOWait=stCPUIOWait, kProductVersion=kProductVersion, stHttpsTraffic=stHttpsTraffic, stCPULoad=stCPULoad, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifySeverity=notifySeverity, notifyReason=notifyReason, mwg=mwg, mwgTrapVariables=mwgTrapVariables, pMFEEngineVersion=pMFEEngineVersion, pAMProactiveVersion=pAMProactiveVersion, mwgInfo=mwgInfo, kBuildNumber=kBuildNumber, mwgMiscellaneous=mwgMiscellaneous, stCategoryName=stCategoryName)
