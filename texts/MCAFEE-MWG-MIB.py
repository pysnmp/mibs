...
Unsigned32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, NotificationType, Gauge32, Integer32, iso, ObjectIdentity, NotificationType, IpAddress, TimeTicks, Counter32, ModuleIdentity, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "NotificationType", "Gauge32", "Integer32", "iso", "ObjectIdentity", "NotificationType", "IpAddress", "TimeTicks", "Counter32", "ModuleIdentity", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesToServer=stFtpBytesToServer, stConnectedSockets=stConnectedSockets, stBlockedByURLFilter=stBlockedByURLFilter, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBadReputation=stBadReputation, notifyAffectedHost=notifyAffectedHost, kProductName=kProductName, mwgEngineVersions=mwgEngineVersions, pAMProactiveVersion=pAMProactiveVersion, stMimeType=stMimeType, notifyAdditional=notifyAdditional, stMemConsumed=stMemConsumed, stHttpTraffic=stHttpTraffic, stMalwareDetected=stMalwareDetected, stCategoryName=stCategoryName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategories=stCategories, stResolveHostViaDNS=stResolveHostViaDNS, stCategoriesTable=stCategoriesTable, trUser=trUser, notifyOriginName=notifyOriginName, mwgContent=mwgContent, trApplication=trApplication, mwgMiscellaneous=mwgMiscellaneous, notifyOrigin=notifyOrigin, mwgStatistics=mwgStatistics, pAMEngineVersion=pAMEngineVersion, stHttpRequests=stHttpRequests, notifyReasonString=notifyReasonString, mwgTraps=mwgTraps, mwgInfo=mwgInfo, kRevision=kRevision, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesFromServer=stFtpBytesFromServer, stCategoriesEntry=stCategoriesEntry, kCompanyName=kCompanyName, stHttpsRequests=stHttpsRequests, stFtpBytesToClient=stFtpBytesToClient, kMajorVersion=kMajorVersion, pMFEEngineVersion=pMFEEngineVersion, pMFEDATVersion=pMFEDATVersion, mwgFTP=mwgFTP, kProductVersion=kProductVersion, notifySeverity=notifySeverity, stHttpBytesFromClient=stHttpBytesFromClient, kMinorVersion=kMinorVersion, mwg=mwg, mwgTrapVariables=mwgTrapVariables, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kBuildNumber=kBuildNumber, stCPULoadRaw=stCPULoadRaw, PYSNMP_MODULE_ID=mwg, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesToServer=stHttpBytesToServer, kMicroVersion=kMicroVersion, stCPUIOWait=stCPUIOWait, kHotfixVersion=kHotfixVersion, trSystem=trSystem, stCPULoad=stCPULoad, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsTraffic=stHttpsTraffic, notifyReason=notifyReason, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgHttps=mwgHttps, stClientCount=stClientCount, stFtpTraffic=stFtpTraffic, pAMSignatureVersion=pAMSignatureVersion, stTimeForTransaction=stTimeForTransaction, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kCustomVersion=kCustomVersion, mwgHttp=mwgHttp, stHttpsBytesToClient=stHttpsBytesToClient, stConnectionsBlocked=stConnectionsBlocked, pTSDBVersion=pTSDBVersion, stCategoryCount=stCategoryCount)
