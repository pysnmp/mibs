...
Integer32, Counter32, enterprises, Counter64, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, ObjectIdentity, mib_2, NotificationType, ModuleIdentity, Unsigned32, NotificationType, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "enterprises", "Counter64", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "ObjectIdentity", "mib-2", "NotificationType", "ModuleIdentity", "Unsigned32", "NotificationType", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", PYSNMP_MODULE_ID=mwg, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesFromClient=stFtpBytesFromClient, kBuildNumber=kBuildNumber, notifyAdditional=notifyAdditional, stCategoriesTable=stCategoriesTable, pAMSignatureVersion=pAMSignatureVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategories=stCategories, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgHttps=mwgHttps, mwgEngineVersions=mwgEngineVersions, stBadReputation=stBadReputation, notifyReason=notifyReason, notifySeverity=notifySeverity, pMFEDATVersion=pMFEDATVersion, notifyOriginName=notifyOriginName, stBlockedByURLFilter=stBlockedByURLFilter, notifyReasonString=notifyReasonString, kProductName=kProductName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgInfo=mwgInfo, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient, kCompanyName=kCompanyName, stClientCount=stClientCount, notifyOrigin=notifyOrigin, stMimeType=stMimeType, stConnectionsBlocked=stConnectionsBlocked, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, mwgContent=mwgContent, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgTrapVariables=mwgTrapVariables, kMinorVersion=kMinorVersion, kHotfixVersion=kHotfixVersion, pTSDBVersion=pTSDBVersion, stFtpBytesToServer=stFtpBytesToServer, stHttpRequests=stHttpRequests, mwgHttp=mwgHttp, mwg=mwg, stFtpTraffic=stFtpTraffic, stCPULoad=stCPULoad, stFtpBytesFromServer=stFtpBytesFromServer, kProductVersion=kProductVersion, trSystem=trSystem, stCPUIOWait=stCPUIOWait, kMajorVersion=kMajorVersion, mwgStatistics=mwgStatistics, mwgFTP=mwgFTP, stHttpBytesToServer=stHttpBytesToServer, kRevision=kRevision, stHttpTraffic=stHttpTraffic, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoadRaw=stCPULoadRaw, mwgTraps=mwgTraps, stHttpsRequests=stHttpsRequests, stCategoryName=stCategoryName, stMalwareDetected=stMalwareDetected, stConnectedSockets=stConnectedSockets, stTimeForTransaction=stTimeForTransaction, stBlockedByMediaFilter=stBlockedByMediaFilter, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, pAMProactiveVersion=pAMProactiveVersion, stHttpsTraffic=stHttpsTraffic, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMicroVersion=kMicroVersion, stHttpsBytesToServer=stHttpsBytesToServer, kCustomVersion=kCustomVersion, stHandleConnectToServer=stHandleConnectToServer, mwgMiscellaneous=mwgMiscellaneous, stResolveHostViaDNS=stResolveHostViaDNS, stMemConsumed=stMemConsumed, stConnectionsLegitimate=stConnectionsLegitimate, trApplication=trApplication, notifyAffectedHost=notifyAffectedHost, stCategoryCount=stCategoryCount, trUser=trUser)
