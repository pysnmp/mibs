...
NotificationType, Unsigned32, IpAddress, Bits, Gauge32, Counter64, enterprises, iso, TimeTicks, Integer32, NotificationType, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "IpAddress", "Bits", "Gauge32", "Counter64", "enterprises", "iso", "TimeTicks", "Integer32", "NotificationType", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesFromClient=stFtpBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, mwg=mwg, stFtpTraffic=stFtpTraffic, PYSNMP_MODULE_ID=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, stHttpTraffic=stHttpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMajorVersion=kMajorVersion, notifyReasonString=notifyReasonString, stConnectionsLegitimate=stConnectionsLegitimate, pAMEngineVersion=pAMEngineVersion, trApplication=trApplication, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesFromServer=stHttpBytesFromServer, kProductName=kProductName, pAMSignatureVersion=pAMSignatureVersion, stCPUIOWait=stCPUIOWait, stTimeForTransaction=stTimeForTransaction, stHttpsBytesToServer=stHttpsBytesToServer, stCategoriesEntry=stCategoriesEntry, stMimeType=stMimeType, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, kRevision=kRevision, stCategories=stCategories, stMalwareDetected=stMalwareDetected, stBlockedByMediaFilter=stBlockedByMediaFilter, kMicroVersion=kMicroVersion, kCompanyName=kCompanyName, stConnectedSockets=stConnectedSockets, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsRequests=stHttpsRequests, stHttpsBytesToClient=stHttpsBytesToClient, mwgTrapVariables=mwgTrapVariables, kBuildNumber=kBuildNumber, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgContent=mwgContent, stHttpRequests=stHttpRequests, stHttpBytesToServer=stHttpBytesToServer, stHttpBytesToClient=stHttpBytesToClient, stHttpsTraffic=stHttpsTraffic, stMemConsumed=stMemConsumed, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgInfo=mwgInfo, notifyAffectedHost=notifyAffectedHost, mwgTraps=mwgTraps, mwgMiscellaneous=mwgMiscellaneous, stCategoryCount=stCategoryCount, stClientCount=stClientCount, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgEngineVersions=mwgEngineVersions, kCustomVersion=kCustomVersion, stCPULoadRaw=stCPULoadRaw, mwgStatistics=mwgStatistics, stResolveHostViaDNS=stResolveHostViaDNS, stHandleConnectToServer=stHandleConnectToServer, kHotfixVersion=kHotfixVersion, stCategoryName=stCategoryName, notifySeverity=notifySeverity, pAMProactiveVersion=pAMProactiveVersion, trSystem=trSystem, kProductVersion=kProductVersion, notifyOriginName=notifyOriginName, notifyOrigin=notifyOrigin, stConnectionsBlocked=stConnectionsBlocked, stCPULoad=stCPULoad, notifyReason=notifyReason, notifyAdditional=notifyAdditional, trUser=trUser, mwgFTP=mwgFTP, stBadReputation=stBadReputation, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pTSDBVersion=pTSDBVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesToServer=stFtpBytesToServer, mwgHttp=mwgHttp, kMinorVersion=kMinorVersion, stCategoriesTable=stCategoriesTable, pMFEDATVersion=pMFEDATVersion, mwgHttps=mwgHttps)
