...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, NotificationType, Counter32, iso, mib_2, ModuleIdentity, Gauge32, Integer32, enterprises, NotificationType, ObjectIdentity, Unsigned32, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "NotificationType", "Counter32", "iso", "mib-2", "ModuleIdentity", "Gauge32", "Integer32", "enterprises", "NotificationType", "ObjectIdentity", "Unsigned32", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyOriginName=notifyOriginName, kMajorVersion=kMajorVersion, pMFEDATVersion=pMFEDATVersion, stCategoryCount=stCategoryCount, notifyOrigin=notifyOrigin, mwgContent=mwgContent, trApplication=trApplication, kProductVersion=kProductVersion, stHttpTraffic=stHttpTraffic, PYSNMP_MODULE_ID=mwg, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kProductName=kProductName, pTSDBVersion=pTSDBVersion, notifyAdditional=notifyAdditional, trSystem=trSystem, mwgTrapVariables=mwgTrapVariables, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMimeType=stMimeType, trUser=trUser, stHttpBytesFromClient=stHttpBytesFromClient, stClientCount=stClientCount, mwgTraps=mwgTraps, stBlockedByURLFilter=stBlockedByURLFilter, stCPUIOWait=stCPUIOWait, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyReasonString=notifyReasonString, stCategoryName=stCategoryName, stHttpsTraffic=stHttpsTraffic, stFtpBytesFromClient=stFtpBytesFromClient, stMalwareDetected=stMalwareDetected, stHttpsBytesToClient=stHttpsBytesToClient, mwgFTP=mwgFTP, pAMProactiveVersion=pAMProactiveVersion, kBuildNumber=kBuildNumber, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectedSockets=stConnectedSockets, notifySeverity=notifySeverity, mwgHttps=mwgHttps, stFtpBytesToServer=stFtpBytesToServer, stCategoriesTable=stCategoriesTable, mwgMiscellaneous=mwgMiscellaneous, stCategoriesEntry=stCategoriesEntry, kMicroVersion=kMicroVersion, mwgEngineVersions=mwgEngineVersions, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCPULoad=stCPULoad, stMemConsumed=stMemConsumed, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgStatistics=mwgStatistics, kMinorVersion=kMinorVersion, kCustomVersion=kCustomVersion, pAMEngineVersion=pAMEngineVersion, kHotfixVersion=kHotfixVersion, kCompanyName=kCompanyName, pMFEEngineVersion=pMFEEngineVersion, mwgHttp=mwgHttp, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesFromServer=stHttpBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, stHttpsRequests=stHttpsRequests, stHttpsBytesToServer=stHttpsBytesToServer, stCategories=stCategories, stFtpTraffic=stFtpTraffic, stHandleConnectToServer=stHandleConnectToServer, stTimeForTransaction=stTimeForTransaction, stHttpRequests=stHttpRequests, stResolveHostViaDNS=stResolveHostViaDNS, mwg=mwg, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesFromClient=stHttpsBytesFromClient, kRevision=kRevision, mwgInfo=mwgInfo, notifyReason=notifyReason, stCPULoadRaw=stCPULoadRaw, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesToClient=stFtpBytesToClient, stBadReputation=stBadReputation, notifyAffectedHost=notifyAffectedHost, stHttpBytesToServer=stHttpBytesToServer)
