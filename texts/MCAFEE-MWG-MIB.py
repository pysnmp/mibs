...
Unsigned32, NotificationType, TimeTicks, Counter64, Gauge32, MibIdentifier, enterprises, Counter32, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, mib_2, Bits, Integer32, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "TimeTicks", "Counter64", "Gauge32", "MibIdentifier", "enterprises", "Counter32", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "mib-2", "Bits", "Integer32", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pTSDBVersion=pTSDBVersion, stClientCount=stClientCount, stFtpTraffic=stFtpTraffic, mwgHttps=mwgHttps, notifyReason=notifyReason, kMinorVersion=kMinorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, kMajorVersion=kMajorVersion, mwgContent=mwgContent, mwgTraps=mwgTraps, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesToClient=stHttpBytesToClient, stCPUIOWait=stCPUIOWait, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, kBuildNumber=kBuildNumber, stHttpRequests=stHttpRequests, stCPULoadRaw=stCPULoadRaw, PYSNMP_MODULE_ID=mwg, kCustomVersion=kCustomVersion, stHttpsBytesToServer=stHttpsBytesToServer, pAMSignatureVersion=pAMSignatureVersion, mwgFTP=mwgFTP, stHttpBytesToServer=stHttpBytesToServer, stBadReputation=stBadReputation, stCategoryName=stCategoryName, notifySeverity=notifySeverity, stCategories=stCategories, pMFEEngineVersion=pMFEEngineVersion, stMalwareDetected=stMalwareDetected, kProductVersion=kProductVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectedSockets=stConnectedSockets, stMimeType=stMimeType, mwgTrapVariables=mwgTrapVariables, stBlockedByURLFilter=stBlockedByURLFilter, mwgStatistics=mwgStatistics, notifyAdditional=notifyAdditional, stFtpBytesToServer=stFtpBytesToServer, mwgInfo=mwgInfo, stBlockedByAntiMalware=stBlockedByAntiMalware, kProductName=kProductName, kRevision=kRevision, stHandleConnectToServer=stHandleConnectToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesToClient=stHttpsBytesToClient, pAMProactiveVersion=pAMProactiveVersion, stTimeForTransaction=stTimeForTransaction, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyAffectedHost=notifyAffectedHost, stResolveHostViaDNS=stResolveHostViaDNS, notifyOriginName=notifyOriginName, pMFEDATVersion=pMFEDATVersion, stFtpBytesToClient=stFtpBytesToClient, stCategoryCount=stCategoryCount, mwg=mwg, mwgMiscellaneous=mwgMiscellaneous, pAMEngineVersion=pAMEngineVersion, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesFromServer=stFtpBytesFromServer, stHttpTraffic=stHttpTraffic, stHttpsTraffic=stHttpsTraffic, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoriesEntry=stCategoriesEntry, trApplication=trApplication, kHotfixVersion=kHotfixVersion, kMicroVersion=kMicroVersion, trUser=trUser, notifyOrigin=notifyOrigin, kCompanyName=kCompanyName, mwgEngineVersions=mwgEngineVersions, stHttpsRequests=stHttpsRequests, stCategoriesTable=stCategoriesTable, notifyReasonString=notifyReasonString, trSystem=trSystem, stConnectionsBlocked=stConnectionsBlocked, mwgHttp=mwgHttp, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMemConsumed=stMemConsumed, stCPULoad=stCPULoad)
