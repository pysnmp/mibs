...
IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, MibIdentifier, Counter64, Bits, Counter32, TimeTicks, mib_2, enterprises, ModuleIdentity, Unsigned32, ObjectIdentity, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "MibIdentifier", "Counter64", "Bits", "Counter32", "TimeTicks", "mib-2", "enterprises", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "NotificationType", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", trApplication=trApplication, notifyAdditional=notifyAdditional, stTimeForTransaction=stTimeForTransaction, mwg=mwg, stHandleConnectToServer=stHandleConnectToServer, stCPULoadRaw=stCPULoadRaw, notifyReason=notifyReason, stHttpsRequests=stHttpsRequests, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, kProductVersion=kProductVersion, mwgInfo=mwgInfo, notifyOriginName=notifyOriginName, kMajorVersion=kMajorVersion, kBuildNumber=kBuildNumber, stCategoriesEntry=stCategoriesEntry, mwgTrapVariables=mwgTrapVariables, stBadReputation=stBadReputation, stCategoriesTable=stCategoriesTable, trSystem=trSystem, stFtpBytesFromServer=stFtpBytesFromServer, notifyReasonString=notifyReasonString, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMProactiveVersion=pAMProactiveVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyOrigin=notifyOrigin, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgEngineVersions=mwgEngineVersions, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgHttps=mwgHttps, stHttpTraffic=stHttpTraffic, pAMEngineVersion=pAMEngineVersion, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesToClient=stHttpBytesToClient, stHttpsTraffic=stHttpsTraffic, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoryName=stCategoryName, pMFEEngineVersion=pMFEEngineVersion, stFtpTraffic=stFtpTraffic, mwgFTP=mwgFTP, stFtpBytesToClient=stFtpBytesToClient, stBlockedByURLFilter=stBlockedByURLFilter, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgTraps=mwgTraps, stCPUIOWait=stCPUIOWait, stHttpRequests=stHttpRequests, kCustomVersion=kCustomVersion, stCategories=stCategories, stConnectedSockets=stConnectedSockets, mwgContent=mwgContent, trUser=trUser, stCPULoad=stCPULoad, kCompanyName=kCompanyName, mwgHttp=mwgHttp, stMimeType=stMimeType, PYSNMP_MODULE_ID=mwg, stClientCount=stClientCount, stMemConsumed=stMemConsumed, stHttpBytesToServer=stHttpBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesToServer=stFtpBytesToServer, notifySeverity=notifySeverity, kMicroVersion=kMicroVersion, stHttpsBytesToServer=stHttpsBytesToServer, kProductName=kProductName, kRevision=kRevision, stMalwareDetected=stMalwareDetected, pAMSignatureVersion=pAMSignatureVersion, kMinorVersion=kMinorVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoryCount=stCategoryCount, pMFEDATVersion=pMFEDATVersion, stHttpBytesFromClient=stHttpBytesFromClient, pTSDBVersion=pTSDBVersion, mwgStatistics=mwgStatistics, notifyAffectedHost=notifyAffectedHost, stFtpBytesFromClient=stFtpBytesFromClient, stConnectionsBlocked=stConnectionsBlocked, kHotfixVersion=kHotfixVersion)
