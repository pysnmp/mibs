...
Unsigned32, MibIdentifier, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, NotificationType, enterprises, mib_2, Integer32, IpAddress, Counter32, NotificationType, iso, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "NotificationType", "enterprises", "mib-2", "Integer32", "IpAddress", "Counter32", "NotificationType", "iso", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMemConsumed=stMemConsumed, stResolveHostViaDNS=stResolveHostViaDNS, kCompanyName=kCompanyName, notifyOrigin=notifyOrigin, stFtpBytesFromServer=stFtpBytesFromServer, stCPULoadRaw=stCPULoadRaw, stHttpBytesFromServer=stHttpBytesFromServer, stConnectedSockets=stConnectedSockets, trSystem=trSystem, stBlockedByMediaFilter=stBlockedByMediaFilter, stClientCount=stClientCount, stFtpTraffic=stFtpTraffic, stCategoryName=stCategoryName, stCPUIOWait=stCPUIOWait, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, mwgStatistics=mwgStatistics, stBlockedByURLFilter=stBlockedByURLFilter, kCustomVersion=kCustomVersion, stHttpBytesToClient=stHttpBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyAdditional=notifyAdditional, mwgMiscellaneous=mwgMiscellaneous, stHttpTraffic=stHttpTraffic, stFtpBytesToClient=stFtpBytesToClient, trUser=trUser, stCategories=stCategories, stConnectionsBlocked=stConnectionsBlocked, stCategoriesEntry=stCategoriesEntry, kMajorVersion=kMajorVersion, kProductName=kProductName, trApplication=trApplication, mwgTraps=mwgTraps, stHttpBytesFromClient=stHttpBytesFromClient, kMinorVersion=kMinorVersion, kRevision=kRevision, mwgHttp=mwgHttp, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, notifySeverity=notifySeverity, mwgContent=mwgContent, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMimeType=stMimeType, pMFEEngineVersion=pMFEEngineVersion, pTSDBVersion=pTSDBVersion, kProductVersion=kProductVersion, stHttpsRequests=stHttpsRequests, mwgInfo=mwgInfo, notifyOriginName=notifyOriginName, stBadReputation=stBadReputation, stConnectionsLegitimate=stConnectionsLegitimate, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, PYSNMP_MODULE_ID=mwg, mwgEngineVersions=mwgEngineVersions, stHttpBytesToServer=stHttpBytesToServer, kHotfixVersion=kHotfixVersion, mwgFTP=mwgFTP, mwgHttps=mwgHttps, notifyReasonString=notifyReasonString, stCategoryCount=stCategoryCount, stTimeForTransaction=stTimeForTransaction, stHttpsTraffic=stHttpsTraffic, mwg=mwg, stHandleConnectToServer=stHandleConnectToServer, pMFEDATVersion=pMFEDATVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kBuildNumber=kBuildNumber, stCategoriesTable=stCategoriesTable, stCPULoad=stCPULoad, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMEngineVersion=pAMEngineVersion, notifyReason=notifyReason, stHttpRequests=stHttpRequests, stMalwareDetected=stMalwareDetected, kMicroVersion=kMicroVersion, notifyAffectedHost=notifyAffectedHost, mwgTrapVariables=mwgTrapVariables, stFtpBytesToServer=stFtpBytesToServer, stFtpBytesFromClient=stFtpBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentLastReceivedClient=stLastSentLastReceivedClient)
