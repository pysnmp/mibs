...
Gauge32, enterprises, MibIdentifier, mib_2, TimeTicks, Counter32, NotificationType, Integer32, ModuleIdentity, Unsigned32, Bits, iso, Counter64, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "MibIdentifier", "mib-2", "TimeTicks", "Counter32", "NotificationType", "Integer32", "ModuleIdentity", "Unsigned32", "Bits", "iso", "Counter64", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpTraffic=stHttpTraffic, kCompanyName=kCompanyName, stHttpRequests=stHttpRequests, mwgHttp=mwgHttp, stHttpsBytesToServer=stHttpsBytesToServer, mwgStatistics=mwgStatistics, mwgContent=mwgContent, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, stFtpTraffic=stFtpTraffic, stCPULoad=stCPULoad, stMalwareDetected=stMalwareDetected, notifyAdditional=notifyAdditional, mwgTrapVariables=mwgTrapVariables, stBlockedByMediaFilter=stBlockedByMediaFilter, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeForTransaction=stTimeForTransaction, mwgHttps=mwgHttps, kProductVersion=kProductVersion, pAMProactiveVersion=pAMProactiveVersion, stMemConsumed=stMemConsumed, kBuildNumber=kBuildNumber, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kCustomVersion=kCustomVersion, trUser=trUser, stBlockedByAntiMalware=stBlockedByAntiMalware, kMicroVersion=kMicroVersion, stClientCount=stClientCount, stFtpBytesFromClient=stFtpBytesFromClient, notifyOriginName=notifyOriginName, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesFromServer=stHttpsBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesToClient=stHttpsBytesToClient, trApplication=trApplication, stHttpBytesFromClient=stHttpBytesFromClient, trSystem=trSystem, pMFEEngineVersion=pMFEEngineVersion, pMFEDATVersion=pMFEDATVersion, pAMSignatureVersion=pAMSignatureVersion, stConnectionsBlocked=stConnectionsBlocked, stCategories=stCategories, stMimeType=stMimeType, mwgFTP=mwgFTP, stFtpBytesFromServer=stFtpBytesFromServer, pTSDBVersion=pTSDBVersion, kProductName=kProductName, kMajorVersion=kMajorVersion, pAMEngineVersion=pAMEngineVersion, stFtpBytesToClient=stFtpBytesToClient, mwgInfo=mwgInfo, kRevision=kRevision, stCategoriesTable=stCategoriesTable, PYSNMP_MODULE_ID=mwg, stHttpBytesFromServer=stHttpBytesFromServer, kMinorVersion=kMinorVersion, notifySeverity=notifySeverity, stConnectedSockets=stConnectedSockets, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgTraps=mwgTraps, stHttpsTraffic=stHttpsTraffic, notifyOrigin=notifyOrigin, stBlockedByURLFilter=stBlockedByURLFilter, stCategoryCount=stCategoryCount, mwgEngineVersions=mwgEngineVersions, stCPUIOWait=stCPUIOWait, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesToServer=stHttpBytesToServer, notifyAffectedHost=notifyAffectedHost, notifyReasonString=notifyReasonString, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesToClient=stHttpBytesToClient, stCategoriesEntry=stCategoriesEntry, stFtpBytesToServer=stFtpBytesToServer, stCategoryName=stCategoryName, notifyReason=notifyReason, stCPULoadRaw=stCPULoadRaw, kHotfixVersion=kHotfixVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBadReputation=stBadReputation, stHttpsRequests=stHttpsRequests, mwg=mwg)
