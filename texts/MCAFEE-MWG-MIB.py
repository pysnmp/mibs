...
NotificationType, iso, Gauge32, Counter32, Unsigned32, ModuleIdentity, NotificationType, mib_2, ObjectIdentity, TimeTicks, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, Integer32, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Gauge32", "Counter32", "Unsigned32", "ModuleIdentity", "NotificationType", "mib-2", "ObjectIdentity", "TimeTicks", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "Integer32", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMSignatureVersion=pAMSignatureVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMicroVersion=kMicroVersion, notifyOrigin=notifyOrigin, stHttpBytesFromClient=stHttpBytesFromClient, stBlockedByMediaFilter=stBlockedByMediaFilter, kMajorVersion=kMajorVersion, stMemConsumed=stMemConsumed, stHttpBytesFromServer=stHttpBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, pAMEngineVersion=pAMEngineVersion, stConnectedSockets=stConnectedSockets, kCustomVersion=kCustomVersion, stCPULoad=stCPULoad, stFtpBytesToServer=stFtpBytesToServer, stCategoriesTable=stCategoriesTable, mwgHttps=mwgHttps, stCategories=stCategories, pTSDBVersion=pTSDBVersion, stCategoryName=stCategoryName, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpBytesToServer=stHttpBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpTraffic=stHttpTraffic, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMinorVersion=kMinorVersion, kBuildNumber=kBuildNumber, stHttpsBytesToServer=stHttpsBytesToServer, mwg=mwg, stHttpRequests=stHttpRequests, stCPUIOWait=stCPUIOWait, stCategoriesEntry=stCategoriesEntry, stMimeType=stMimeType, mwgTraps=mwgTraps, stCPULoadRaw=stCPULoadRaw, mwgInfo=mwgInfo, mwgStatistics=mwgStatistics, stBadReputation=stBadReputation, stBlockedByAntiMalware=stBlockedByAntiMalware, trSystem=trSystem, stBlockedByURLFilter=stBlockedByURLFilter, notifySeverity=notifySeverity, notifyAdditional=notifyAdditional, notifyReason=notifyReason, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesFromClient=stFtpBytesFromClient, notifyAffectedHost=notifyAffectedHost, stClientCount=stClientCount, stHttpsTraffic=stHttpsTraffic, stMalwareDetected=stMalwareDetected, stResolveHostViaDNS=stResolveHostViaDNS, stCategoryCount=stCategoryCount, stFtpBytesToClient=stFtpBytesToClient, kCompanyName=kCompanyName, notifyOriginName=notifyOriginName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, kHotfixVersion=kHotfixVersion, kRevision=kRevision, pMFEEngineVersion=pMFEEngineVersion, mwgHttp=mwgHttp, mwgEngineVersions=mwgEngineVersions, stHttpsRequests=stHttpsRequests, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesToClient=stHttpsBytesToClient, pMFEDATVersion=pMFEDATVersion, mwgFTP=mwgFTP, mwgContent=mwgContent, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesToClient=stHttpBytesToClient, stTimeForTransaction=stTimeForTransaction, mwgTrapVariables=mwgTrapVariables, trApplication=trApplication, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyReasonString=notifyReasonString, kProductVersion=kProductVersion, mwgMiscellaneous=mwgMiscellaneous, PYSNMP_MODULE_ID=mwg, stFtpBytesFromServer=stFtpBytesFromServer, trUser=trUser, stFtpTraffic=stFtpTraffic, kProductName=kProductName)
