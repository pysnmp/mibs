...
ObjectIdentity, MibIdentifier, IpAddress, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, Gauge32, Counter32, Bits, Integer32, iso, TimeTicks, enterprises, mib_2, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "IpAddress", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "Gauge32", "Counter32", "Bits", "Integer32", "iso", "TimeTicks", "enterprises", "mib-2", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyOriginName=notifyOriginName, mwg=mwg, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgContent=mwgContent, stHttpsRequests=stHttpsRequests, stFtpTraffic=stFtpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesToClient=stHttpBytesToClient, kHotfixVersion=kHotfixVersion, stHttpTraffic=stHttpTraffic, trUser=trUser, stResolveHostViaDNS=stResolveHostViaDNS, kCustomVersion=kCustomVersion, mwgFTP=mwgFTP, pMFEEngineVersion=pMFEEngineVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trSystem=trSystem, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyAffectedHost=notifyAffectedHost, stCategoriesEntry=stCategoriesEntry, stHandleConnectToServer=stHandleConnectToServer, stMalwareDetected=stMalwareDetected, stHttpBytesFromClient=stHttpBytesFromClient, stCPULoad=stCPULoad, stLastSentLastReceivedServer=stLastSentLastReceivedServer, PYSNMP_MODULE_ID=mwg, stHttpsTraffic=stHttpsTraffic, kBuildNumber=kBuildNumber, notifyAdditional=notifyAdditional, stTimeForTransaction=stTimeForTransaction, pAMEngineVersion=pAMEngineVersion, stConnectedSockets=stConnectedSockets, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, stHttpRequests=stHttpRequests, stMimeType=stMimeType, notifyOrigin=notifyOrigin, kMinorVersion=kMinorVersion, mwgStatistics=mwgStatistics, stFtpBytesToClient=stFtpBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgTrapVariables=mwgTrapVariables, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttp=mwgHttp, stMemConsumed=stMemConsumed, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMProactiveVersion=pAMProactiveVersion, notifySeverity=notifySeverity, stCategoryCount=stCategoryCount, mwgMiscellaneous=mwgMiscellaneous, stCategories=stCategories, mwgEngineVersions=mwgEngineVersions, kMajorVersion=kMajorVersion, kProductName=kProductName, stHttpsBytesToClient=stHttpsBytesToClient, stClientCount=stClientCount, stCategoryName=stCategoryName, mwgTraps=mwgTraps, stCategoriesTable=stCategoriesTable, pAMSignatureVersion=pAMSignatureVersion, stCPUIOWait=stCPUIOWait, stHttpsBytesToServer=stHttpsBytesToServer, pTSDBVersion=pTSDBVersion, kProductVersion=kProductVersion, pMFEDATVersion=pMFEDATVersion, stFtpBytesToServer=stFtpBytesToServer, stCPULoadRaw=stCPULoadRaw, stFtpBytesFromServer=stFtpBytesFromServer, mwgInfo=mwgInfo, kRevision=kRevision, stBadReputation=stBadReputation, trApplication=trApplication, notifyReasonString=notifyReasonString, stConnectionsBlocked=stConnectionsBlocked, notifyReason=notifyReason, kMicroVersion=kMicroVersion, mwgHttps=mwgHttps, stHttpBytesToServer=stHttpBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kCompanyName=kCompanyName, stConnectionsLegitimate=stConnectionsLegitimate)
