...
NotificationType, Gauge32, ObjectIdentity, NotificationType, Bits, Counter32, TimeTicks, mib_2, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, Counter64, MibIdentifier, Unsigned32, ModuleIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "ObjectIdentity", "NotificationType", "Bits", "Counter32", "TimeTicks", "mib-2", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "Counter64", "MibIdentifier", "Unsigned32", "ModuleIdentity", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyReason=notifyReason, stHandleConnectToServer=stHandleConnectToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stMemConsumed=stMemConsumed, kRevision=kRevision, stTimeForTransaction=stTimeForTransaction, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgStatistics=mwgStatistics, kCustomVersion=kCustomVersion, kMicroVersion=kMicroVersion, stConnectionsBlocked=stConnectionsBlocked, mwgMiscellaneous=mwgMiscellaneous, stCategoryCount=stCategoryCount, mwgHttps=mwgHttps, stResolveHostViaDNS=stResolveHostViaDNS, trUser=trUser, notifyAffectedHost=notifyAffectedHost, stHttpRequests=stHttpRequests, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesToClient=stHttpsBytesToClient, stCPUIOWait=stCPUIOWait, trSystem=trSystem, pAMSignatureVersion=pAMSignatureVersion, kMajorVersion=kMajorVersion, stCategoryName=stCategoryName, pMFEDATVersion=pMFEDATVersion, stCPULoadRaw=stCPULoadRaw, notifyOrigin=notifyOrigin, stMimeType=stMimeType, mwgFTP=mwgFTP, mwgTraps=mwgTraps, mwgInfo=mwgInfo, kMinorVersion=kMinorVersion, stClientCount=stClientCount, stHttpsTraffic=stHttpsTraffic, notifyAdditional=notifyAdditional, mwgTrapVariables=mwgTrapVariables, mwg=mwg, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoad=stCPULoad, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsRequests=stHttpsRequests, trApplication=trApplication, stConnectedSockets=stConnectedSockets, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMalwareDetected=stMalwareDetected, mwgEngineVersions=mwgEngineVersions, mwgHttp=mwgHttp, stHttpBytesToClient=stHttpBytesToClient, mwgContent=mwgContent, stCategoriesTable=stCategoriesTable, notifySeverity=notifySeverity, pAMEngineVersion=pAMEngineVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kProductName=kProductName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stBadReputation=stBadReputation, stCategories=stCategories, PYSNMP_MODULE_ID=mwg, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesFromServer=stHttpsBytesFromServer, kProductVersion=kProductVersion, notifyReasonString=notifyReasonString, stHttpBytesFromServer=stHttpBytesFromServer, kHotfixVersion=kHotfixVersion, kBuildNumber=kBuildNumber, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kCompanyName=kCompanyName, stHttpTraffic=stHttpTraffic, stFtpBytesFromClient=stFtpBytesFromClient, pTSDBVersion=pTSDBVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyOriginName=notifyOriginName, stHttpsBytesToServer=stHttpsBytesToServer, stFtpTraffic=stFtpTraffic, stHttpBytesFromClient=stHttpBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, stCategoriesEntry=stCategoriesEntry, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesToClient=stFtpBytesToClient)
