...
Counter32, NotificationType, ObjectIdentity, Unsigned32, iso, MibIdentifier, enterprises, Gauge32, mib_2, Counter64, TimeTicks, NotificationType, Bits, Integer32, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "ObjectIdentity", "Unsigned32", "iso", "MibIdentifier", "enterprises", "Gauge32", "mib-2", "Counter64", "TimeTicks", "NotificationType", "Bits", "Integer32", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesToClient=stHttpsBytesToClient, stHttpRequests=stHttpRequests, stHttpTraffic=stHttpTraffic, notifyReasonString=notifyReasonString, stMemConsumed=stMemConsumed, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesEntry=stCategoriesEntry, stHttpBytesToServer=stHttpBytesToServer, pAMEngineVersion=pAMEngineVersion, stHandleConnectToServer=stHandleConnectToServer, kBuildNumber=kBuildNumber, stFtpBytesToClient=stFtpBytesToClient, kProductVersion=kProductVersion, stCategoriesTable=stCategoriesTable, stConnectionsBlocked=stConnectionsBlocked, PYSNMP_MODULE_ID=mwg, mwgMiscellaneous=mwgMiscellaneous, stCategoryCount=stCategoryCount, trSystem=trSystem, notifyAffectedHost=notifyAffectedHost, trUser=trUser, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kCompanyName=kCompanyName, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyOriginName=notifyOriginName, mwgHttp=mwgHttp, stHttpBytesToClient=stHttpBytesToClient, stCategoryName=stCategoryName, stFtpTraffic=stFtpTraffic, mwgTraps=mwgTraps, stTimeForTransaction=stTimeForTransaction, mwgInfo=mwgInfo, stCategories=stCategories, stConnectedSockets=stConnectedSockets, pAMSignatureVersion=pAMSignatureVersion, stCPUIOWait=stCPUIOWait, stCPULoadRaw=stCPULoadRaw, kMajorVersion=kMajorVersion, pMFEDATVersion=pMFEDATVersion, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, stMalwareDetected=stMalwareDetected, mwgTrapVariables=mwgTrapVariables, kProductName=kProductName, kCustomVersion=kCustomVersion, stCPULoad=stCPULoad, notifyOrigin=notifyOrigin, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifySeverity=notifySeverity, stFtpBytesToServer=stFtpBytesToServer, stMimeType=stMimeType, stHttpsTraffic=stHttpsTraffic, stHttpsRequests=stHttpsRequests, stHttpsBytesFromClient=stHttpsBytesFromClient, kMinorVersion=kMinorVersion, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgFTP=mwgFTP, notifyAdditional=notifyAdditional, pTSDBVersion=pTSDBVersion, mwgContent=mwgContent, stBlockedByURLFilter=stBlockedByURLFilter, pAMProactiveVersion=pAMProactiveVersion, kRevision=kRevision, kMicroVersion=kMicroVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stBadReputation=stBadReputation, kHotfixVersion=kHotfixVersion, stFtpBytesFromServer=stFtpBytesFromServer, pMFEEngineVersion=pMFEEngineVersion, mwgStatistics=mwgStatistics, mwgHttps=mwgHttps, mwgEngineVersions=mwgEngineVersions, mwg=mwg, notifyReason=notifyReason, trApplication=trApplication, stFtpBytesFromClient=stFtpBytesFromClient, stClientCount=stClientCount, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient)
