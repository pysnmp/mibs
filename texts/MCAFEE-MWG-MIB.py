...
IpAddress, Gauge32, MibIdentifier, Counter32, Bits, NotificationType, ModuleIdentity, Counter64, mib_2, TimeTicks, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "MibIdentifier", "Counter32", "Bits", "NotificationType", "ModuleIdentity", "Counter64", "mib-2", "TimeTicks", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgMiscellaneous=mwgMiscellaneous, kBuildNumber=kBuildNumber, pTSDBVersion=pTSDBVersion, kProductVersion=kProductVersion, stHttpsBytesToClient=stHttpsBytesToClient, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesToServer=stHttpsBytesToServer, stFtpTraffic=stFtpTraffic, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgHttps=mwgHttps, stResolveHostViaDNS=stResolveHostViaDNS, notifyOrigin=notifyOrigin, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpRequests=stHttpRequests, kCompanyName=kCompanyName, stMemConsumed=stMemConsumed, mwgEngineVersions=mwgEngineVersions, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyAdditional=notifyAdditional, notifyAffectedHost=notifyAffectedHost, mwgStatistics=mwgStatistics, stHttpBytesFromServer=stHttpBytesFromServer, stCategoryName=stCategoryName, stHttpsTraffic=stHttpsTraffic, stHttpsBytesFromClient=stHttpsBytesFromClient, kMicroVersion=kMicroVersion, notifyReason=notifyReason, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgTrapVariables=mwgTrapVariables, pAMProactiveVersion=pAMProactiveVersion, stMalwareDetected=stMalwareDetected, trSystem=trSystem, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesToServer=stFtpBytesToServer, stHandleConnectToServer=stHandleConnectToServer, mwgHttp=mwgHttp, mwgFTP=mwgFTP, stBlockedByURLFilter=stBlockedByURLFilter, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trUser=trUser, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifySeverity=notifySeverity, stHttpBytesToClient=stHttpBytesToClient, stMimeType=stMimeType, pAMEngineVersion=pAMEngineVersion, stFtpBytesFromClient=stFtpBytesFromClient, stHttpTraffic=stHttpTraffic, stTimeForTransaction=stTimeForTransaction, stConnectionsBlocked=stConnectionsBlocked, kProductName=kProductName, stHttpsRequests=stHttpsRequests, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesToClient=stFtpBytesToClient, notifyOriginName=notifyOriginName, kMajorVersion=kMajorVersion, mwgContent=mwgContent, trApplication=trApplication, mwgInfo=mwgInfo, PYSNMP_MODULE_ID=mwg, stHttpBytesFromClient=stHttpBytesFromClient, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesEntry=stCategoriesEntry, mwgTraps=mwgTraps, kRevision=kRevision, stCPULoadRaw=stCPULoadRaw, stClientCount=stClientCount, pMFEDATVersion=pMFEDATVersion, stConnectedSockets=stConnectedSockets, kCustomVersion=kCustomVersion, kMinorVersion=kMinorVersion, stCategoriesTable=stCategoriesTable, stHttpBytesToServer=stHttpBytesToServer, stCategoryCount=stCategoryCount, stBadReputation=stBadReputation, notifyReasonString=notifyReasonString, stCPULoad=stCPULoad, mwg=mwg, stBlockedByMediaFilter=stBlockedByMediaFilter, kHotfixVersion=kHotfixVersion, stCategories=stCategories, stCPUIOWait=stCPUIOWait)
