...
Integer32, Bits, mib_2, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, Counter32, MibIdentifier, enterprises, Unsigned32, NotificationType, TimeTicks, ObjectIdentity, ModuleIdentity, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "mib-2", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "Counter32", "MibIdentifier", "enterprises", "Unsigned32", "NotificationType", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "NotificationType", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgInfo=mwgInfo, stFtpTraffic=stFtpTraffic, stCPULoadRaw=stCPULoadRaw, stFtpBytesToServer=stFtpBytesToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, PYSNMP_MODULE_ID=mwg, kMicroVersion=kMicroVersion, pAMSignatureVersion=pAMSignatureVersion, stCPULoad=stCPULoad, stCategories=stCategories, mwgStatistics=mwgStatistics, stConnectionsBlocked=stConnectionsBlocked, stHandleConnectToServer=stHandleConnectToServer, trUser=trUser, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kCompanyName=kCompanyName, kMinorVersion=kMinorVersion, stResolveHostViaDNS=stResolveHostViaDNS, mwgEngineVersions=mwgEngineVersions, stMimeType=stMimeType, trSystem=trSystem, pMFEDATVersion=pMFEDATVersion, mwgFTP=mwgFTP, notifyReasonString=notifyReasonString, trApplication=trApplication, notifyAffectedHost=notifyAffectedHost, kMajorVersion=kMajorVersion, stHttpsBytesToClient=stHttpsBytesToClient, notifyOrigin=notifyOrigin, pMFEEngineVersion=pMFEEngineVersion, mwgHttp=mwgHttp, stCPUIOWait=stCPUIOWait, stCategoriesEntry=stCategoriesEntry, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesToClient=stFtpBytesToClient, stHttpsTraffic=stHttpsTraffic, stHttpTraffic=stHttpTraffic, mwgMiscellaneous=mwgMiscellaneous, stConnectedSockets=stConnectedSockets, kBuildNumber=kBuildNumber, stHttpsRequests=stHttpsRequests, stCategoryCount=stCategoryCount, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesToServer=stHttpsBytesToServer, pAMEngineVersion=pAMEngineVersion, kProductVersion=kProductVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stClientCount=stClientCount, mwg=mwg, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kRevision=kRevision, stBlockedByMediaFilter=stBlockedByMediaFilter, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyReason=notifyReason, mwgContent=mwgContent, kProductName=kProductName, stBadReputation=stBadReputation, stBlockedByURLFilter=stBlockedByURLFilter, kHotfixVersion=kHotfixVersion, mwgHttps=mwgHttps, stHttpBytesToServer=stHttpBytesToServer, notifyOriginName=notifyOriginName, stFtpBytesFromServer=stFtpBytesFromServer, stHttpRequests=stHttpRequests, notifyAdditional=notifyAdditional, notifySeverity=notifySeverity, stFtpBytesFromClient=stFtpBytesFromClient, stCategoriesTable=stCategoriesTable, pTSDBVersion=pTSDBVersion, stMalwareDetected=stMalwareDetected, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectionsLegitimate=stConnectionsLegitimate, mwgTraps=mwgTraps, stTimeForTransaction=stTimeForTransaction, stHttpBytesFromServer=stHttpBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgTrapVariables=mwgTrapVariables, stMemConsumed=stMemConsumed, stCategoryName=stCategoryName, kCustomVersion=kCustomVersion)
