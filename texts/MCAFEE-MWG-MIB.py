...
IpAddress, Gauge32, enterprises, ObjectIdentity, ModuleIdentity, Unsigned32, Integer32, MibIdentifier, Counter64, TimeTicks, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Bits, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "enterprises", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Integer32", "MibIdentifier", "Counter64", "TimeTicks", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Bits", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyAdditional=notifyAdditional, kProductVersion=kProductVersion, stHttpsBytesToClient=stHttpsBytesToClient, trApplication=trApplication, PYSNMP_MODULE_ID=mwg, pAMSignatureVersion=pAMSignatureVersion, notifyReasonString=notifyReasonString, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoryName=stCategoryName, mwgContent=mwgContent, stFtpBytesToServer=stFtpBytesToServer, mwgTrapVariables=mwgTrapVariables, stBadReputation=stBadReputation, stCategoriesEntry=stCategoriesEntry, kMajorVersion=kMajorVersion, kHotfixVersion=kHotfixVersion, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesToClient=stFtpBytesToClient, stHttpRequests=stHttpRequests, mwgInfo=mwgInfo, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsRequests=stHttpsRequests, stCPUIOWait=stCPUIOWait, notifyAffectedHost=notifyAffectedHost, stHttpTraffic=stHttpTraffic, stCategoriesTable=stCategoriesTable, mwg=mwg, trSystem=trSystem, mwgFTP=mwgFTP, kRevision=kRevision, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, kCompanyName=kCompanyName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pMFEEngineVersion=pMFEEngineVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, kBuildNumber=kBuildNumber, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsTraffic=stHttpsTraffic, pMFEDATVersion=pMFEDATVersion, mwgTraps=mwgTraps, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesToClient=stHttpBytesToClient, mwgEngineVersions=mwgEngineVersions, stConnectionsBlocked=stConnectionsBlocked, stFtpTraffic=stFtpTraffic, notifyReason=notifyReason, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMimeType=stMimeType, stCategoryCount=stCategoryCount, stClientCount=stClientCount, notifyOriginName=notifyOriginName, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMEngineVersion=pAMEngineVersion, stCPULoad=stCPULoad, kProductName=kProductName, mwgStatistics=mwgStatistics, kCustomVersion=kCustomVersion, stTimeForTransaction=stTimeForTransaction, stCPULoadRaw=stCPULoadRaw, kMicroVersion=kMicroVersion, stMalwareDetected=stMalwareDetected, stConnectionsLegitimate=stConnectionsLegitimate, kMinorVersion=kMinorVersion, mwgMiscellaneous=mwgMiscellaneous, stHandleConnectToServer=stHandleConnectToServer, trUser=trUser, notifyOrigin=notifyOrigin, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesToServer=stHttpsBytesToServer, stMemConsumed=stMemConsumed, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesFromClient=stHttpBytesFromClient, notifySeverity=notifySeverity, pTSDBVersion=pTSDBVersion, mwgHttps=mwgHttps, stConnectedSockets=stConnectedSockets, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pAMProactiveVersion=pAMProactiveVersion, mwgHttp=mwgHttp, stCategories=stCategories)
