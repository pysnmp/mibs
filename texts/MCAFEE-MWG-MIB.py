...
NotificationType, mib_2, Unsigned32, Bits, IpAddress, ObjectIdentity, MibIdentifier, Counter32, Integer32, ModuleIdentity, Gauge32, enterprises, TimeTicks, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "mib-2", "Unsigned32", "Bits", "IpAddress", "ObjectIdentity", "MibIdentifier", "Counter32", "Integer32", "ModuleIdentity", "Gauge32", "enterprises", "TimeTicks", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoriesEntry=stCategoriesEntry, kMicroVersion=kMicroVersion, mwgStatistics=mwgStatistics, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoryName=stCategoryName, notifyReasonString=notifyReasonString, mwgTrapVariables=mwgTrapVariables, notifyAffectedHost=notifyAffectedHost, stFtpBytesFromServer=stFtpBytesFromServer, pAMEngineVersion=pAMEngineVersion, trUser=trUser, stHttpsBytesToClient=stHttpsBytesToClient, kCustomVersion=kCustomVersion, stTimeForTransaction=stTimeForTransaction, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesFromServer=stHttpBytesFromServer, PYSNMP_MODULE_ID=mwg, stFtpTraffic=stFtpTraffic, pMFEDATVersion=pMFEDATVersion, kCompanyName=kCompanyName, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgFTP=mwgFTP, trSystem=trSystem, notifyOrigin=notifyOrigin, stCPUIOWait=stCPUIOWait, stMalwareDetected=stMalwareDetected, stCPULoad=stCPULoad, stHttpsBytesFromServer=stHttpsBytesFromServer, stBadReputation=stBadReputation, stHttpBytesToServer=stHttpBytesToServer, notifyReason=notifyReason, stCPULoadRaw=stCPULoadRaw, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyOriginName=notifyOriginName, stConnectedSockets=stConnectedSockets, stMimeType=stMimeType, stHttpRequests=stHttpRequests, mwgHttp=mwgHttp, notifySeverity=notifySeverity, stCategoryCount=stCategoryCount, stClientCount=stClientCount, stConnectionsBlocked=stConnectionsBlocked, pTSDBVersion=pTSDBVersion, stHttpBytesToClient=stHttpBytesToClient, stCategoriesTable=stCategoriesTable, pMFEEngineVersion=pMFEEngineVersion, kProductName=kProductName, stHttpsRequests=stHttpsRequests, notifyAdditional=notifyAdditional, mwgEngineVersions=mwgEngineVersions, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, stConnectionsLegitimate=stConnectionsLegitimate, stMemConsumed=stMemConsumed, stFtpBytesToServer=stFtpBytesToServer, kProductVersion=kProductVersion, stCategories=stCategories, pAMProactiveVersion=pAMProactiveVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMSignatureVersion=pAMSignatureVersion, stHttpTraffic=stHttpTraffic, trApplication=trApplication, mwgTraps=mwgTraps, kHotfixVersion=kHotfixVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgInfo=mwgInfo, kMajorVersion=kMajorVersion, mwg=mwg, stFtpBytesToClient=stFtpBytesToClient, kMinorVersion=kMinorVersion, mwgMiscellaneous=mwgMiscellaneous, stBlockedByMediaFilter=stBlockedByMediaFilter, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, stBlockedByURLFilter=stBlockedByURLFilter, kRevision=kRevision, mwgContent=mwgContent, kBuildNumber=kBuildNumber, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsTraffic=stHttpsTraffic, stHttpsBytesToServer=stHttpsBytesToServer, mwgHttps=mwgHttps)
