...
NotificationType, Unsigned32, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, mib_2, Bits, NotificationType, enterprises, ModuleIdentity, ObjectIdentity, Counter32, iso, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "mib-2", "Bits", "NotificationType", "enterprises", "ModuleIdentity", "ObjectIdentity", "Counter32", "iso", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kProductName=kProductName, mwg=mwg, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesFromServer=stHttpsBytesFromServer, kBuildNumber=kBuildNumber, notifySeverity=notifySeverity, mwgHttps=mwgHttps, mwgStatistics=mwgStatistics, trApplication=trApplication, trUser=trUser, kMajorVersion=kMajorVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, stMalwareDetected=stMalwareDetected, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesToServer=stHttpBytesToServer, pMFEEngineVersion=pMFEEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, pTSDBVersion=pTSDBVersion, pAMEngineVersion=pAMEngineVersion, kMinorVersion=kMinorVersion, stMemConsumed=stMemConsumed, mwgFTP=mwgFTP, stFtpBytesToClient=stFtpBytesToClient, stCategoryCount=stCategoryCount, notifyReason=notifyReason, mwgMiscellaneous=mwgMiscellaneous, stCategoriesEntry=stCategoriesEntry, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesFromClient=stHttpBytesFromClient, stCPUIOWait=stCPUIOWait, kRevision=kRevision, trSystem=trSystem, pAMProactiveVersion=pAMProactiveVersion, mwgEngineVersions=mwgEngineVersions, mwgContent=mwgContent, stCPULoadRaw=stCPULoadRaw, notifyAffectedHost=notifyAffectedHost, mwgHttp=mwgHttp, stCategoryName=stCategoryName, stFtpBytesFromServer=stFtpBytesFromServer, PYSNMP_MODULE_ID=mwg, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesToClient=stHttpsBytesToClient, kCompanyName=kCompanyName, stMimeType=stMimeType, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpRequests=stHttpRequests, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesFromClient=stFtpBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesToServer=stHttpsBytesToServer, kMicroVersion=kMicroVersion, notifyOriginName=notifyOriginName, stFtpTraffic=stFtpTraffic, stFtpBytesToServer=stFtpBytesToServer, stTimeForTransaction=stTimeForTransaction, stBadReputation=stBadReputation, mwgTrapVariables=mwgTrapVariables, stCategoriesTable=stCategoriesTable, stClientCount=stClientCount, stConnectionsBlocked=stConnectionsBlocked, stHttpsTraffic=stHttpsTraffic, pMFEDATVersion=pMFEDATVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kHotfixVersion=kHotfixVersion, stHttpBytesFromServer=stHttpBytesFromServer, kCustomVersion=kCustomVersion, stCPULoad=stCPULoad, mwgInfo=mwgInfo, stHandleConnectToServer=stHandleConnectToServer, stCategories=stCategories, notifyReasonString=notifyReasonString, notifyOrigin=notifyOrigin, mwgTraps=mwgTraps, stHttpTraffic=stHttpTraffic, notifyAdditional=notifyAdditional, stHttpsRequests=stHttpsRequests, kProductVersion=kProductVersion, stConnectedSockets=stConnectedSockets, stHttpsBytesFromClient=stHttpsBytesFromClient)
