...
NotificationType, Unsigned32, Counter64, IpAddress, NotificationType, iso, TimeTicks, MibIdentifier, mib_2, Counter32, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, enterprises, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "Counter64", "IpAddress", "NotificationType", "iso", "TimeTicks", "MibIdentifier", "mib-2", "Counter32", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "enterprises", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", trUser=trUser, stHttpsTraffic=stHttpsTraffic, stHttpsBytesToServer=stHttpsBytesToServer, stCPULoadRaw=stCPULoadRaw, stFtpBytesFromClient=stFtpBytesFromClient, stMemConsumed=stMemConsumed, stMalwareDetected=stMalwareDetected, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesFromClient=stHttpBytesFromClient, trApplication=trApplication, kHotfixVersion=kHotfixVersion, notifyAffectedHost=notifyAffectedHost, stTimeForTransaction=stTimeForTransaction, stFtpBytesToServer=stFtpBytesToServer, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kBuildNumber=kBuildNumber, stCategoryName=stCategoryName, PYSNMP_MODULE_ID=mwg, stFtpBytesToClient=stFtpBytesToClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pMFEDATVersion=pMFEDATVersion, kMajorVersion=kMajorVersion, notifyOriginName=notifyOriginName, pAMSignatureVersion=pAMSignatureVersion, stCPULoad=stCPULoad, stCategoriesTable=stCategoriesTable, notifyReasonString=notifyReasonString, mwgStatistics=mwgStatistics, stCPUIOWait=stCPUIOWait, stResolveHostViaDNS=stResolveHostViaDNS, stConnectedSockets=stConnectedSockets, stHttpBytesToClient=stHttpBytesToClient, mwgTraps=mwgTraps, pTSDBVersion=pTSDBVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kRevision=kRevision, pMFEEngineVersion=pMFEEngineVersion, stBadReputation=stBadReputation, stHttpRequests=stHttpRequests, stConnectionsBlocked=stConnectionsBlocked, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgInfo=mwgInfo, stHandleConnectToServer=stHandleConnectToServer, mwgTrapVariables=mwgTrapVariables, stHttpsBytesFromServer=stHttpsBytesFromServer, stClientCount=stClientCount, pAMEngineVersion=pAMEngineVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttp=mwgHttp, kCompanyName=kCompanyName, kCustomVersion=kCustomVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgContent=mwgContent, stCategoriesEntry=stCategoriesEntry, stFtpTraffic=stFtpTraffic, stHttpBytesToServer=stHttpBytesToServer, trSystem=trSystem, mwg=mwg, stHttpBytesFromServer=stHttpBytesFromServer, mwgMiscellaneous=mwgMiscellaneous, kMinorVersion=kMinorVersion, stHttpsRequests=stHttpsRequests, stMimeType=stMimeType, notifyAdditional=notifyAdditional, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttps=mwgHttps, kProductVersion=kProductVersion, stBlockedByURLFilter=stBlockedByURLFilter, notifyReason=notifyReason, kMicroVersion=kMicroVersion, kProductName=kProductName, stHttpsBytesToClient=stHttpsBytesToClient, notifyOrigin=notifyOrigin, stCategoryCount=stCategoryCount, notifySeverity=notifySeverity, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pAMProactiveVersion=pAMProactiveVersion, mwgEngineVersions=mwgEngineVersions, stConnectionsLegitimate=stConnectionsLegitimate, stHttpTraffic=stHttpTraffic, mwgFTP=mwgFTP, stCategories=stCategories)
