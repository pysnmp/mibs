...
iso, mib_2, Counter64, NotificationType, TimeTicks, Gauge32, ObjectIdentity, MibIdentifier, Unsigned32, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, Bits, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "mib-2", "Counter64", "NotificationType", "TimeTicks", "Gauge32", "ObjectIdentity", "MibIdentifier", "Unsigned32", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "Bits", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stConnectedSockets=stConnectedSockets, notifyReason=notifyReason, kCustomVersion=kCustomVersion, pMFEDATVersion=pMFEDATVersion, notifyAffectedHost=notifyAffectedHost, stHttpBytesFromServer=stHttpBytesFromServer, mwgFTP=mwgFTP, mwgTrapVariables=mwgTrapVariables, kBuildNumber=kBuildNumber, stCategories=stCategories, stCPUIOWait=stCPUIOWait, notifyOriginName=notifyOriginName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgHttp=mwgHttp, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoriesTable=stCategoriesTable, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoryCount=stCategoryCount, stFtpTraffic=stFtpTraffic, stTimeForTransaction=stTimeForTransaction, trSystem=trSystem, stMemConsumed=stMemConsumed, kRevision=kRevision, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMimeType=stMimeType, stResolveHostViaDNS=stResolveHostViaDNS, stHandleConnectToServer=stHandleConnectToServer, notifyReasonString=notifyReasonString, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, stFtpBytesToClient=stFtpBytesToClient, kHotfixVersion=kHotfixVersion, mwg=mwg, stCategoryName=stCategoryName, trApplication=trApplication, kMajorVersion=kMajorVersion, kProductVersion=kProductVersion, trUser=trUser, stBadReputation=stBadReputation, stHttpsRequests=stHttpsRequests, stCategoriesEntry=stCategoriesEntry, stHttpsBytesToClient=stHttpsBytesToClient, mwgTraps=mwgTraps, stClientCount=stClientCount, pMFEEngineVersion=pMFEEngineVersion, mwgContent=mwgContent, stFtpBytesToServer=stFtpBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCPULoadRaw=stCPULoadRaw, stCPULoad=stCPULoad, mwgMiscellaneous=mwgMiscellaneous, mwgInfo=mwgInfo, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesFromClient=stFtpBytesFromClient, pAMEngineVersion=pAMEngineVersion, notifySeverity=notifySeverity, kProductName=kProductName, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesFromServer=stFtpBytesFromServer, notifyOrigin=notifyOrigin, kMinorVersion=kMinorVersion, mwgEngineVersions=mwgEngineVersions, stHttpBytesToClient=stHttpBytesToClient, stHttpTraffic=stHttpTraffic, kCompanyName=kCompanyName, stHttpsTraffic=stHttpsTraffic, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgHttps=mwgHttps, pAMProactiveVersion=pAMProactiveVersion, notifyAdditional=notifyAdditional, stConnectionsLegitimate=stConnectionsLegitimate, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pAMSignatureVersion=pAMSignatureVersion, stHttpRequests=stHttpRequests, kMicroVersion=kMicroVersion, mwgStatistics=mwgStatistics, pTSDBVersion=pTSDBVersion, stHttpsBytesToServer=stHttpsBytesToServer, PYSNMP_MODULE_ID=mwg, stHttpBytesFromClient=stHttpBytesFromClient)
