...
iso, TimeTicks, Counter64, NotificationType, IpAddress, ObjectIdentity, Bits, Counter32, Unsigned32, NotificationType, enterprises, ModuleIdentity, Gauge32, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Counter64", "NotificationType", "IpAddress", "ObjectIdentity", "Bits", "Counter32", "Unsigned32", "NotificationType", "enterprises", "ModuleIdentity", "Gauge32", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesToClient=stHttpBytesToClient, stHttpTraffic=stHttpTraffic, pAMSignatureVersion=pAMSignatureVersion, stCategories=stCategories, stMemConsumed=stMemConsumed, stHttpsTraffic=stHttpsTraffic, stHttpsRequests=stHttpsRequests, stMalwareDetected=stMalwareDetected, pAMProactiveVersion=pAMProactiveVersion, trSystem=trSystem, mwgInfo=mwgInfo, stBlockedByURLFilter=stBlockedByURLFilter, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pAMEngineVersion=pAMEngineVersion, PYSNMP_MODULE_ID=mwg, stHttpsBytesToServer=stHttpsBytesToServer, stFtpTraffic=stFtpTraffic, trApplication=trApplication, mwgTraps=mwgTraps, stFtpBytesToClient=stFtpBytesToClient, mwgStatistics=mwgStatistics, mwgFTP=mwgFTP, mwgHttps=mwgHttps, notifyOrigin=notifyOrigin, stBlockedByAntiMalware=stBlockedByAntiMalware, pMFEDATVersion=pMFEDATVersion, stHttpBytesFromClient=stHttpBytesFromClient, kMajorVersion=kMajorVersion, stCPULoadRaw=stCPULoadRaw, stClientCount=stClientCount, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoryCount=stCategoryCount, mwg=mwg, stCPULoad=stCPULoad, stBlockedByMediaFilter=stBlockedByMediaFilter, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesFromServer=stHttpsBytesFromServer, notifySeverity=notifySeverity, stFtpBytesFromClient=stFtpBytesFromClient, kCustomVersion=kCustomVersion, stCPUIOWait=stCPUIOWait, mwgContent=mwgContent, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoriesEntry=stCategoriesEntry, notifyAffectedHost=notifyAffectedHost, stTimeForTransaction=stTimeForTransaction, mwgTrapVariables=mwgTrapVariables, kHotfixVersion=kHotfixVersion, pMFEEngineVersion=pMFEEngineVersion, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesFromClient=stHttpsBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kBuildNumber=kBuildNumber, kRevision=kRevision, notifyAdditional=notifyAdditional, stMimeType=stMimeType, stHandleConnectToServer=stHandleConnectToServer, stCategoryName=stCategoryName, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesTable=stCategoriesTable, stResolveHostViaDNS=stResolveHostViaDNS, kProductName=kProductName, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesToServer=stHttpBytesToServer, stHttpRequests=stHttpRequests, stHttpsBytesToClient=stHttpsBytesToClient, kMinorVersion=kMinorVersion, notifyOriginName=notifyOriginName, stConnectionsBlocked=stConnectionsBlocked, notifyReason=notifyReason, stBadReputation=stBadReputation, kMicroVersion=kMicroVersion, mwgEngineVersions=mwgEngineVersions, kProductVersion=kProductVersion, trUser=trUser, pTSDBVersion=pTSDBVersion, notifyReasonString=notifyReasonString, mwgHttp=mwgHttp, kCompanyName=kCompanyName, stConnectedSockets=stConnectedSockets)
