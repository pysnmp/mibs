...
Gauge32, ModuleIdentity, mib_2, Bits, ObjectIdentity, Counter64, enterprises, NotificationType, MibIdentifier, Counter32, NotificationType, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "mib-2", "Bits", "ObjectIdentity", "Counter64", "enterprises", "NotificationType", "MibIdentifier", "Counter32", "NotificationType", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHandleConnectToServer=stHandleConnectToServer, stHttpsTraffic=stHttpsTraffic, stHttpBytesFromClient=stHttpBytesFromClient, pMFEDATVersion=pMFEDATVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgTraps=mwgTraps, mwgEngineVersions=mwgEngineVersions, stHttpBytesFromServer=stHttpBytesFromServer, stHttpBytesToClient=stHttpBytesToClient, pAMEngineVersion=pAMEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, kMajorVersion=kMajorVersion, kBuildNumber=kBuildNumber, stCPULoad=stCPULoad, kMicroVersion=kMicroVersion, kCustomVersion=kCustomVersion, trSystem=trSystem, stCategoriesEntry=stCategoriesEntry, notifyOriginName=notifyOriginName, stConnectionsLegitimate=stConnectionsLegitimate, stClientCount=stClientCount, pTSDBVersion=pTSDBVersion, stCPULoadRaw=stCPULoadRaw, mwgFTP=mwgFTP, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesToServer=stFtpBytesToServer, mwgMiscellaneous=mwgMiscellaneous, mwgInfo=mwgInfo, stBlockedByAntiMalware=stBlockedByAntiMalware, stConnectionsBlocked=stConnectionsBlocked, mwg=mwg, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifySeverity=notifySeverity, notifyReasonString=notifyReasonString, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgStatistics=mwgStatistics, kProductVersion=kProductVersion, mwgContent=mwgContent, stCategoryName=stCategoryName, stHttpBytesToServer=stHttpBytesToServer, kHotfixVersion=kHotfixVersion, stFtpTraffic=stFtpTraffic, stHttpRequests=stHttpRequests, pAMProactiveVersion=pAMProactiveVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyAdditional=notifyAdditional, stTimeForTransaction=stTimeForTransaction, notifyOrigin=notifyOrigin, stCategoryCount=stCategoryCount, mwgHttp=mwgHttp, stMimeType=stMimeType, notifyAffectedHost=notifyAffectedHost, trUser=trUser, mwgTrapVariables=mwgTrapVariables, stHttpsBytesToServer=stHttpsBytesToServer, kCompanyName=kCompanyName, PYSNMP_MODULE_ID=mwg, stCategoriesTable=stCategoriesTable, stMemConsumed=stMemConsumed, pAMSignatureVersion=pAMSignatureVersion, kRevision=kRevision, notifyReason=notifyReason, kMinorVersion=kMinorVersion, stFtpBytesToClient=stFtpBytesToClient, stCPUIOWait=stCPUIOWait, trApplication=trApplication, kProductName=kProductName, stFtpBytesFromClient=stFtpBytesFromClient, stResolveHostViaDNS=stResolveHostViaDNS, stConnectedSockets=stConnectedSockets, stCategories=stCategories, pMFEEngineVersion=pMFEEngineVersion, stHttpTraffic=stHttpTraffic, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsRequests=stHttpsRequests, stFtpBytesFromServer=stFtpBytesFromServer, stMalwareDetected=stMalwareDetected, stBadReputation=stBadReputation, mwgHttps=mwgHttps)
