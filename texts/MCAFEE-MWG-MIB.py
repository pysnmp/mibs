...
ObjectIdentity, Integer32, Bits, Gauge32, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Counter64, iso, NotificationType, Counter32, enterprises, TimeTicks, ModuleIdentity, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "Bits", "Gauge32", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Counter64", "iso", "NotificationType", "Counter32", "enterprises", "TimeTicks", "ModuleIdentity", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMEngineVersion=pAMEngineVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsTraffic=stHttpsTraffic, kMicroVersion=kMicroVersion, stCategoriesEntry=stCategoriesEntry, stConnectionsLegitimate=stConnectionsLegitimate, stCPULoad=stCPULoad, mwg=mwg, pAMSignatureVersion=pAMSignatureVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, trApplication=trApplication, mwgEngineVersions=mwgEngineVersions, notifyReasonString=notifyReasonString, stResolveHostViaDNS=stResolveHostViaDNS, pAMProactiveVersion=pAMProactiveVersion, notifySeverity=notifySeverity, mwgStatistics=mwgStatistics, trSystem=trSystem, trUser=trUser, mwgContent=mwgContent, stHttpsBytesFromClient=stHttpsBytesFromClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMinorVersion=kMinorVersion, stCategoriesTable=stCategoriesTable, PYSNMP_MODULE_ID=mwg, stHttpBytesToClient=stHttpBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesFromServer=stFtpBytesFromServer, mwgHttps=mwgHttps, kProductName=kProductName, stCategories=stCategories, mwgHttp=mwgHttp, stHandleConnectToServer=stHandleConnectToServer, stMalwareDetected=stMalwareDetected, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesFromClient=stHttpBytesFromClient, kMajorVersion=kMajorVersion, notifyOrigin=notifyOrigin, kProductVersion=kProductVersion, stBlockedByURLFilter=stBlockedByURLFilter, kCustomVersion=kCustomVersion, kCompanyName=kCompanyName, mwgTraps=mwgTraps, stFtpBytesFromClient=stFtpBytesFromClient, stConnectedSockets=stConnectedSockets, stFtpBytesToServer=stFtpBytesToServer, stHttpRequests=stHttpRequests, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyReason=notifyReason, stMemConsumed=stMemConsumed, stCPUIOWait=stCPUIOWait, notifyAffectedHost=notifyAffectedHost, mwgTrapVariables=mwgTrapVariables, kHotfixVersion=kHotfixVersion, kRevision=kRevision, stConnectionsBlocked=stConnectionsBlocked, mwgMiscellaneous=mwgMiscellaneous, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsRequests=stHttpsRequests, stHttpsBytesToClient=stHttpsBytesToClient, notifyAdditional=notifyAdditional, stTimeForTransaction=stTimeForTransaction, stBlockedByAntiMalware=stBlockedByAntiMalware, kBuildNumber=kBuildNumber, mwgInfo=mwgInfo, stCategoryName=stCategoryName, pMFEEngineVersion=pMFEEngineVersion, stMimeType=stMimeType, stHttpTraffic=stHttpTraffic, stFtpTraffic=stFtpTraffic, stBadReputation=stBadReputation, stClientCount=stClientCount, pTSDBVersion=pTSDBVersion, mwgFTP=mwgFTP, pMFEDATVersion=pMFEDATVersion, stFtpBytesToClient=stFtpBytesToClient, stCategoryCount=stCategoryCount, stCPULoadRaw=stCPULoadRaw, notifyOriginName=notifyOriginName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient)
