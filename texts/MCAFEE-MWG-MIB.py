...
NotificationType, iso, TimeTicks, MibIdentifier, Unsigned32, IpAddress, ObjectIdentity, NotificationType, Counter64, ModuleIdentity, enterprises, mib_2, Gauge32, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "TimeTicks", "MibIdentifier", "Unsigned32", "IpAddress", "ObjectIdentity", "NotificationType", "Counter64", "ModuleIdentity", "enterprises", "mib-2", "Gauge32", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgFTP=mwgFTP, pAMSignatureVersion=pAMSignatureVersion, stConnectedSockets=stConnectedSockets, stHttpBytesFromServer=stHttpBytesFromServer, stBadReputation=stBadReputation, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesToServer=stHttpBytesToServer, notifyReasonString=notifyReasonString, kProductVersion=kProductVersion, trUser=trUser, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoad=stCPULoad, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, PYSNMP_MODULE_ID=mwg, stCategoryName=stCategoryName, stFtpBytesToServer=stFtpBytesToServer, stTimeForTransaction=stTimeForTransaction, mwg=mwg, stFtpTraffic=stFtpTraffic, stMalwareDetected=stMalwareDetected, pTSDBVersion=pTSDBVersion, stFtpBytesToClient=stFtpBytesToClient, mwgHttp=mwgHttp, stMimeType=stMimeType, stClientCount=stClientCount, trSystem=trSystem, stHttpsTraffic=stHttpsTraffic, notifyAffectedHost=notifyAffectedHost, stConnectionsLegitimate=stConnectionsLegitimate, notifyReason=notifyReason, stHttpBytesFromClient=stHttpBytesFromClient, stHandleConnectToServer=stHandleConnectToServer, pMFEEngineVersion=pMFEEngineVersion, notifySeverity=notifySeverity, notifyAdditional=notifyAdditional, stCPUIOWait=stCPUIOWait, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesToClient=stHttpBytesToClient, kHotfixVersion=kHotfixVersion, kProductName=kProductName, notifyOriginName=notifyOriginName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByURLFilter=stBlockedByURLFilter, mwgEngineVersions=mwgEngineVersions, stCPULoadRaw=stCPULoadRaw, kCompanyName=kCompanyName, stHttpRequests=stHttpRequests, stCategoriesEntry=stCategoriesEntry, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgTrapVariables=mwgTrapVariables, pAMEngineVersion=pAMEngineVersion, kRevision=kRevision, stHttpsRequests=stHttpsRequests, trApplication=trApplication, stMemConsumed=stMemConsumed, stCategoriesTable=stCategoriesTable, stConnectionsBlocked=stConnectionsBlocked, mwgTraps=mwgTraps, kMinorVersion=kMinorVersion, mwgStatistics=mwgStatistics, mwgContent=mwgContent, stFtpBytesFromServer=stFtpBytesFromServer, kMajorVersion=kMajorVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoryCount=stCategoryCount, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kBuildNumber=kBuildNumber, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, kMicroVersion=kMicroVersion, stHttpsBytesToServer=stHttpsBytesToServer, pMFEDATVersion=pMFEDATVersion, stCategories=stCategories, notifyOrigin=notifyOrigin, kCustomVersion=kCustomVersion, mwgHttps=mwgHttps, mwgInfo=mwgInfo, stHttpTraffic=stHttpTraffic, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer)
