...
iso, mib_2, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, Counter64, IpAddress, Integer32, enterprises, Bits, ObjectIdentity, MibIdentifier, TimeTicks, Gauge32, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "mib-2", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "Counter64", "IpAddress", "Integer32", "enterprises", "Bits", "ObjectIdentity", "MibIdentifier", "TimeTicks", "Gauge32", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stLastSentLastReceivedServer=stLastSentLastReceivedServer, stConnectedSockets=stConnectedSockets, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsTraffic=stHttpsTraffic, stCPULoad=stCPULoad, notifyAdditional=notifyAdditional, stMemConsumed=stMemConsumed, stTimeForTransaction=stTimeForTransaction, stHttpBytesFromServer=stHttpBytesFromServer, mwgStatistics=mwgStatistics, kProductVersion=kProductVersion, pAMEngineVersion=pAMEngineVersion, stCategoryCount=stCategoryCount, kRevision=kRevision, kBuildNumber=kBuildNumber, mwgInfo=mwgInfo, kProductName=kProductName, pAMProactiveVersion=pAMProactiveVersion, trUser=trUser, stConnectionsBlocked=stConnectionsBlocked, stHandleConnectToServer=stHandleConnectToServer, notifyOriginName=notifyOriginName, stCategoriesEntry=stCategoriesEntry, mwgHttp=mwgHttp, stHttpsBytesFromClient=stHttpsBytesFromClient, kMinorVersion=kMinorVersion, mwg=mwg, stMimeType=stMimeType, notifyReason=notifyReason, stFtpBytesToClient=stFtpBytesToClient, kMajorVersion=kMajorVersion, stMalwareDetected=stMalwareDetected, stHttpBytesFromClient=stHttpBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stClientCount=stClientCount, stHttpBytesToServer=stHttpBytesToServer, stHttpTraffic=stHttpTraffic, stHttpsRequests=stHttpsRequests, notifyOrigin=notifyOrigin, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pTSDBVersion=pTSDBVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyAffectedHost=notifyAffectedHost, pMFEEngineVersion=pMFEEngineVersion, mwgEngineVersions=mwgEngineVersions, stHttpsBytesToServer=stHttpsBytesToServer, stCPUIOWait=stCPUIOWait, pAMSignatureVersion=pAMSignatureVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoryName=stCategoryName, stCPULoadRaw=stCPULoadRaw, mwgContent=mwgContent, mwgTrapVariables=mwgTrapVariables, trApplication=trApplication, stResolveHostViaDNS=stResolveHostViaDNS, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesFromServer=stFtpBytesFromServer, notifyReasonString=notifyReasonString, mwgFTP=mwgFTP, stBadReputation=stBadReputation, stCategoriesTable=stCategoriesTable, stFtpBytesToServer=stFtpBytesToServer, notifySeverity=notifySeverity, kCustomVersion=kCustomVersion, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, kHotfixVersion=kHotfixVersion, trSystem=trSystem, mwgTraps=mwgTraps, stFtpTraffic=stFtpTraffic, PYSNMP_MODULE_ID=mwg, kCompanyName=kCompanyName, stBlockedByURLFilter=stBlockedByURLFilter, kMicroVersion=kMicroVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategories=stCategories, pMFEDATVersion=pMFEDATVersion, mwgHttps=mwgHttps, stHttpRequests=stHttpRequests, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesToClient=stHttpBytesToClient, stConnectionsLegitimate=stConnectionsLegitimate)
