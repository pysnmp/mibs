...
Unsigned32, NotificationType, mib_2, iso, MibIdentifier, IpAddress, Counter32, ModuleIdentity, Integer32, enterprises, ObjectIdentity, Gauge32, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "mib-2", "iso", "MibIdentifier", "IpAddress", "Counter32", "ModuleIdentity", "Integer32", "enterprises", "ObjectIdentity", "Gauge32", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stConnectionsBlocked=stConnectionsBlocked, pAMSignatureVersion=pAMSignatureVersion, stConnectedSockets=stConnectedSockets, stMemConsumed=stMemConsumed, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesToServer=stHttpsBytesToServer, mwgHttps=mwgHttps, stHttpsBytesToClient=stHttpsBytesToClient, stCategoryCount=stCategoryCount, stFtpBytesFromClient=stFtpBytesFromClient, notifyReason=notifyReason, notifyOrigin=notifyOrigin, stBadReputation=stBadReputation, mwg=mwg, stHttpRequests=stHttpRequests, stCategoryName=stCategoryName, trApplication=trApplication, mwgInfo=mwgInfo, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsRequests=stHttpsRequests, kMajorVersion=kMajorVersion, stFtpBytesToServer=stFtpBytesToServer, stCategoriesTable=stCategoriesTable, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgTrapVariables=mwgTrapVariables, notifyOriginName=notifyOriginName, pAMProactiveVersion=pAMProactiveVersion, stResolveHostViaDNS=stResolveHostViaDNS, pMFEEngineVersion=pMFEEngineVersion, notifyAffectedHost=notifyAffectedHost, stHttpTraffic=stHttpTraffic, stHandleConnectToServer=stHandleConnectToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgStatistics=mwgStatistics, stCPULoad=stCPULoad, mwgEngineVersions=mwgEngineVersions, stHttpsTraffic=stHttpsTraffic, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttp=mwgHttp, kBuildNumber=kBuildNumber, stCPUIOWait=stCPUIOWait, stBlockedByURLFilter=stBlockedByURLFilter, kHotfixVersion=kHotfixVersion, trUser=trUser, kProductVersion=kProductVersion, kCustomVersion=kCustomVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kProductName=kProductName, kCompanyName=kCompanyName, stFtpTraffic=stFtpTraffic, kMicroVersion=kMicroVersion, mwgFTP=mwgFTP, pMFEDATVersion=pMFEDATVersion, pAMEngineVersion=pAMEngineVersion, notifySeverity=notifySeverity, mwgContent=mwgContent, stHttpsBytesFromClient=stHttpsBytesFromClient, PYSNMP_MODULE_ID=mwg, stCategoriesEntry=stCategoriesEntry, stMalwareDetected=stMalwareDetected, notifyAdditional=notifyAdditional, trSystem=trSystem, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesFromServer=stHttpBytesFromServer, mwgTraps=mwgTraps, stCPULoadRaw=stCPULoadRaw, mwgMiscellaneous=mwgMiscellaneous, kRevision=kRevision, pTSDBVersion=pTSDBVersion, stCategories=stCategories, stHttpBytesFromClient=stHttpBytesFromClient, stClientCount=stClientCount, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesToClient=stFtpBytesToClient, stTimeForTransaction=stTimeForTransaction, notifyReasonString=notifyReasonString, stMimeType=stMimeType, kMinorVersion=kMinorVersion, stHttpBytesToClient=stHttpBytesToClient)
