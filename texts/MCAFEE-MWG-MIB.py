...
Bits, TimeTicks, Counter32, ModuleIdentity, MibIdentifier, enterprises, NotificationType, mib_2, iso, Unsigned32, Counter64, IpAddress, ObjectIdentity, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "Counter32", "ModuleIdentity", "MibIdentifier", "enterprises", "NotificationType", "mib-2", "iso", "Unsigned32", "Counter64", "IpAddress", "ObjectIdentity", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByURLFilter=stBlockedByURLFilter, stHttpsTraffic=stHttpsTraffic, stBadReputation=stBadReputation, trApplication=trApplication, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectionsBlocked=stConnectionsBlocked, kCompanyName=kCompanyName, stCategories=stCategories, trUser=trUser, mwgHttps=mwgHttps, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pTSDBVersion=pTSDBVersion, stHttpRequests=stHttpRequests, stCPUIOWait=stCPUIOWait, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, notifySeverity=notifySeverity, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, kHotfixVersion=kHotfixVersion, kMinorVersion=kMinorVersion, stFtpBytesFromServer=stFtpBytesFromServer, mwgFTP=mwgFTP, PYSNMP_MODULE_ID=mwg, kBuildNumber=kBuildNumber, mwgHttp=mwgHttp, mwgTraps=mwgTraps, stCPULoadRaw=stCPULoadRaw, mwgEngineVersions=mwgEngineVersions, kMajorVersion=kMajorVersion, notifyOrigin=notifyOrigin, mwgTrapVariables=mwgTrapVariables, stFtpBytesToClient=stFtpBytesToClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesToClient=stHttpsBytesToClient, mwgMiscellaneous=mwgMiscellaneous, stFtpTraffic=stFtpTraffic, kCustomVersion=kCustomVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, trSystem=trSystem, stMimeType=stMimeType, stCategoryCount=stCategoryCount, stHttpBytesFromClient=stHttpBytesFromClient, mwgInfo=mwgInfo, stConnectionsLegitimate=stConnectionsLegitimate, stCPULoad=stCPULoad, stConnectedSockets=stConnectedSockets, notifyAffectedHost=notifyAffectedHost, kProductName=kProductName, kRevision=kRevision, stHttpsRequests=stHttpsRequests, stHttpTraffic=stHttpTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesToServer=stHttpsBytesToServer, mwgContent=mwgContent, stFtpBytesToServer=stFtpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoriesEntry=stCategoriesEntry, mwgStatistics=mwgStatistics, stResolveHostViaDNS=stResolveHostViaDNS, notifyReason=notifyReason, stHttpBytesToServer=stHttpBytesToServer, notifyAdditional=notifyAdditional, stCategoryName=stCategoryName, stHttpBytesToClient=stHttpBytesToClient, kMicroVersion=kMicroVersion, stClientCount=stClientCount, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pMFEDATVersion=pMFEDATVersion, stMemConsumed=stMemConsumed, mwg=mwg, kProductVersion=kProductVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyOriginName=notifyOriginName, notifyReasonString=notifyReasonString, stMalwareDetected=stMalwareDetected, pAMEngineVersion=pAMEngineVersion, stCategoriesTable=stCategoriesTable, stFtpBytesFromClient=stFtpBytesFromClient, stTimeForTransaction=stTimeForTransaction)
