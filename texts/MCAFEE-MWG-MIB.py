...
enterprises, ModuleIdentity, ObjectIdentity, Bits, Gauge32, Integer32, iso, Counter32, MibIdentifier, Counter64, mib_2, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "ObjectIdentity", "Bits", "Gauge32", "Integer32", "iso", "Counter32", "MibIdentifier", "Counter64", "mib-2", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpTraffic=stHttpTraffic, notifyReason=notifyReason, trSystem=trSystem, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyOriginName=notifyOriginName, pAMSignatureVersion=pAMSignatureVersion, mwg=mwg, stResolveHostViaDNS=stResolveHostViaDNS, kMajorVersion=kMajorVersion, stMalwareDetected=stMalwareDetected, stConnectedSockets=stConnectedSockets, stCPULoad=stCPULoad, stHttpsRequests=stHttpsRequests, stFtpBytesFromServer=stFtpBytesFromServer, mwgInfo=mwgInfo, notifyAdditional=notifyAdditional, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgFTP=mwgFTP, stCategoryName=stCategoryName, stHttpBytesToServer=stHttpBytesToServer, pMFEEngineVersion=pMFEEngineVersion, kMinorVersion=kMinorVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpRequests=stHttpRequests, stFtpBytesToClient=stFtpBytesToClient, stBlockedByURLFilter=stBlockedByURLFilter, kProductVersion=kProductVersion, notifyOrigin=notifyOrigin, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMemConsumed=stMemConsumed, stConnectionsBlocked=stConnectionsBlocked, stCategoriesTable=stCategoriesTable, stClientCount=stClientCount, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMicroVersion=kMicroVersion, stFtpTraffic=stFtpTraffic, notifySeverity=notifySeverity, stBadReputation=stBadReputation, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMProactiveVersion=pAMProactiveVersion, mwgHttp=mwgHttp, stHandleConnectToServer=stHandleConnectToServer, kProductName=kProductName, stHttpsTraffic=stHttpsTraffic, stCategoriesEntry=stCategoriesEntry, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pTSDBVersion=pTSDBVersion, stFtpBytesToServer=stFtpBytesToServer, mwgContent=mwgContent, stCPULoadRaw=stCPULoadRaw, kCompanyName=kCompanyName, pMFEDATVersion=pMFEDATVersion, kHotfixVersion=kHotfixVersion, kBuildNumber=kBuildNumber, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesFromServer=stHttpBytesFromServer, mwgTraps=mwgTraps, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stTimeForTransaction=stTimeForTransaction, kCustomVersion=kCustomVersion, stMimeType=stMimeType, trApplication=trApplication, PYSNMP_MODULE_ID=mwg, mwgTrapVariables=mwgTrapVariables, notifyAffectedHost=notifyAffectedHost, stCategoryCount=stCategoryCount, kRevision=kRevision, notifyReasonString=notifyReasonString, stHttpBytesToClient=stHttpBytesToClient, mwgEngineVersions=mwgEngineVersions, mwgHttps=mwgHttps, mwgStatistics=mwgStatistics, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, pAMEngineVersion=pAMEngineVersion, trUser=trUser, stFtpBytesFromClient=stFtpBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCPUIOWait=stCPUIOWait, stCategories=stCategories, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromClient=stHttpBytesFromClient)
