...
Unsigned32, ModuleIdentity, IpAddress, NotificationType, Gauge32, Bits, NotificationType, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, MibIdentifier, Counter32, ObjectIdentity, enterprises, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "IpAddress", "NotificationType", "Gauge32", "Bits", "NotificationType", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "MibIdentifier", "Counter32", "ObjectIdentity", "enterprises", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategories=stCategories, notifyOriginName=notifyOriginName, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgContent=mwgContent, mwgHttp=mwgHttp, stTimeForTransaction=stTimeForTransaction, notifyAdditional=notifyAdditional, mwgTraps=mwgTraps, notifyReason=notifyReason, stHttpBytesFromServer=stHttpBytesFromServer, stHttpRequests=stHttpRequests, notifySeverity=notifySeverity, pMFEEngineVersion=pMFEEngineVersion, stBadReputation=stBadReputation, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByAntiMalware=stBlockedByAntiMalware, kBuildNumber=kBuildNumber, stMemConsumed=stMemConsumed, stCPUIOWait=stCPUIOWait, stConnectionsBlocked=stConnectionsBlocked, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpBytesFromServer=stFtpBytesFromServer, pAMProactiveVersion=pAMProactiveVersion, mwgTrapVariables=mwgTrapVariables, mwgInfo=mwgInfo, stHttpBytesFromClient=stHttpBytesFromClient, kProductVersion=kProductVersion, stFtpBytesFromClient=stFtpBytesFromClient, kMajorVersion=kMajorVersion, stHttpBytesToClient=stHttpBytesToClient, trUser=trUser, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgHttps=mwgHttps, notifyReasonString=notifyReasonString, stHttpBytesToServer=stHttpBytesToServer, pTSDBVersion=pTSDBVersion, kCompanyName=kCompanyName, stClientCount=stClientCount, trApplication=trApplication, stCPULoadRaw=stCPULoadRaw, stCategoriesTable=stCategoriesTable, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByURLFilter=stBlockedByURLFilter, stMimeType=stMimeType, stHttpTraffic=stHttpTraffic, stMalwareDetected=stMalwareDetected, stHttpsTraffic=stHttpsTraffic, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesToServer=stHttpsBytesToServer, mwgFTP=mwgFTP, kCustomVersion=kCustomVersion, pAMEngineVersion=pAMEngineVersion, stCategoriesEntry=stCategoriesEntry, stResolveHostViaDNS=stResolveHostViaDNS, stCPULoad=stCPULoad, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesToClient=stHttpsBytesToClient, mwg=mwg, stCategoryName=stCategoryName, mwgMiscellaneous=mwgMiscellaneous, kProductName=kProductName, stCategoryCount=stCategoryCount, stFtpBytesToClient=stFtpBytesToClient, pMFEDATVersion=pMFEDATVersion, trSystem=trSystem, PYSNMP_MODULE_ID=mwg, kRevision=kRevision, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgStatistics=mwgStatistics, notifyOrigin=notifyOrigin, stFtpTraffic=stFtpTraffic, stConnectedSockets=stConnectedSockets, mwgEngineVersions=mwgEngineVersions, kMicroVersion=kMicroVersion, notifyAffectedHost=notifyAffectedHost, kHotfixVersion=kHotfixVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, kMinorVersion=kMinorVersion, stHttpsRequests=stHttpsRequests)
