...
ModuleIdentity, iso, Gauge32, TimeTicks, Counter64, IpAddress, NotificationType, Counter32, mib_2, NotificationType, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "Gauge32", "TimeTicks", "Counter64", "IpAddress", "NotificationType", "Counter32", "mib-2", "NotificationType", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByURLFilter=stBlockedByURLFilter, kBuildNumber=kBuildNumber, notifyAdditional=notifyAdditional, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, mwgInfo=mwgInfo, stFtpBytesFromClient=stFtpBytesFromClient, stCategoriesEntry=stCategoriesEntry, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kProductVersion=kProductVersion, stConnectedSockets=stConnectedSockets, notifyAffectedHost=notifyAffectedHost, mwgTrapVariables=mwgTrapVariables, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoadRaw=stCPULoadRaw, stCategoryName=stCategoryName, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPUIOWait=stCPUIOWait, mwgHttps=mwgHttps, trApplication=trApplication, pTSDBVersion=pTSDBVersion, pMFEDATVersion=pMFEDATVersion, mwgFTP=mwgFTP, pAMProactiveVersion=pAMProactiveVersion, mwgEngineVersions=mwgEngineVersions, kHotfixVersion=kHotfixVersion, trUser=trUser, stResolveHostViaDNS=stResolveHostViaDNS, stHttpRequests=stHttpRequests, mwg=mwg, kMicroVersion=kMicroVersion, kMajorVersion=kMajorVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stBadReputation=stBadReputation, mwgHttp=mwgHttp, kCompanyName=kCompanyName, stClientCount=stClientCount, stHttpsTraffic=stHttpsTraffic, trSystem=trSystem, pAMSignatureVersion=pAMSignatureVersion, stCategoriesTable=stCategoriesTable, stMalwareDetected=stMalwareDetected, stCategoryCount=stCategoryCount, stFtpBytesToClient=stFtpBytesToClient, notifyOrigin=notifyOrigin, mwgTraps=mwgTraps, notifyReason=notifyReason, stFtpTraffic=stFtpTraffic, stHttpBytesToClient=stHttpBytesToClient, stHttpTraffic=stHttpTraffic, stCPULoad=stCPULoad, kCustomVersion=kCustomVersion, mwgContent=mwgContent, stMimeType=stMimeType, notifySeverity=notifySeverity, stHandleConnectToServer=stHandleConnectToServer, kRevision=kRevision, PYSNMP_MODULE_ID=mwg, stFtpBytesFromServer=stFtpBytesFromServer, notifyReasonString=notifyReasonString, notifyOriginName=notifyOriginName, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgStatistics=mwgStatistics, stTimeForTransaction=stTimeForTransaction, stConnectionsBlocked=stConnectionsBlocked, stCategories=stCategories, kMinorVersion=kMinorVersion, stHttpBytesFromClient=stHttpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pMFEEngineVersion=pMFEEngineVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMemConsumed=stMemConsumed, stConnectionsLegitimate=stConnectionsLegitimate, kProductName=kProductName, pAMEngineVersion=pAMEngineVersion, stHttpBytesToServer=stHttpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsRequests=stHttpsRequests, stFtpBytesToServer=stFtpBytesToServer)
