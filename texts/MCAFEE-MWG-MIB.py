...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, mib_2, Counter64, NotificationType, Unsigned32, enterprises, Integer32, IpAddress, ObjectIdentity, MibIdentifier, ModuleIdentity, Bits, TimeTicks, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "mib-2", "Counter64", "NotificationType", "Unsigned32", "enterprises", "Integer32", "IpAddress", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Bits", "TimeTicks", "iso", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgTrapVariables=mwgTrapVariables, trUser=trUser, stCPUIOWait=stCPUIOWait, stHttpRequests=stHttpRequests, stCategoryName=stCategoryName, stHttpsRequests=stHttpsRequests, notifyAffectedHost=notifyAffectedHost, mwg=mwg, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, stMemConsumed=stMemConsumed, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgEngineVersions=mwgEngineVersions, PYSNMP_MODULE_ID=mwg, mwgContent=mwgContent, kProductVersion=kProductVersion, trApplication=trApplication, stHandleConnectToServer=stHandleConnectToServer, mwgHttp=mwgHttp, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsTraffic=stHttpsTraffic, stBlockedByURLFilter=stBlockedByURLFilter, kHotfixVersion=kHotfixVersion, notifyReasonString=notifyReasonString, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyAdditional=notifyAdditional, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgInfo=mwgInfo, stCategoryCount=stCategoryCount, mwgFTP=mwgFTP, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTraps=mwgTraps, notifyOriginName=notifyOriginName, mwgHttps=mwgHttps, kMicroVersion=kMicroVersion, stCPULoad=stCPULoad, stBadReputation=stBadReputation, stConnectedSockets=stConnectedSockets, stMimeType=stMimeType, stCategoriesTable=stCategoriesTable, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesToServer=stFtpBytesToServer, pAMProactiveVersion=pAMProactiveVersion, trSystem=trSystem, kBuildNumber=kBuildNumber, stHttpTraffic=stHttpTraffic, kCustomVersion=kCustomVersion, stCPULoadRaw=stCPULoadRaw, notifySeverity=notifySeverity, stFtpTraffic=stFtpTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pAMSignatureVersion=pAMSignatureVersion, pTSDBVersion=pTSDBVersion, kCompanyName=kCompanyName, pMFEEngineVersion=pMFEEngineVersion, notifyReason=notifyReason, stResolveHostViaDNS=stResolveHostViaDNS, stCategoriesEntry=stCategoriesEntry, stClientCount=stClientCount, stHttpBytesFromServer=stHttpBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesToClient=stHttpBytesToClient, mwgStatistics=mwgStatistics, stHttpBytesToServer=stHttpBytesToServer, kRevision=kRevision, kMajorVersion=kMajorVersion, kMinorVersion=kMinorVersion, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategories=stCategories, stMalwareDetected=stMalwareDetected, stTimeForTransaction=stTimeForTransaction, stBlockedByMediaFilter=stBlockedByMediaFilter, pMFEDATVersion=pMFEDATVersion, kProductName=kProductName, notifyOrigin=notifyOrigin, stFtpBytesFromClient=stFtpBytesFromClient)
