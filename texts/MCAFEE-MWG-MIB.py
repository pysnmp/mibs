...
MibIdentifier, NotificationType, Integer32, iso, IpAddress, Counter64, mib_2, enterprises, ObjectIdentity, Counter32, Gauge32, Bits, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Integer32", "iso", "IpAddress", "Counter64", "mib-2", "enterprises", "ObjectIdentity", "Counter32", "Gauge32", "Bits", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifySeverity=notifySeverity, stCategoriesEntry=stCategoriesEntry, stHttpsBytesToClient=stHttpsBytesToClient, notifyAdditional=notifyAdditional, pAMSignatureVersion=pAMSignatureVersion, stCPULoad=stCPULoad, stClientCount=stClientCount, stHttpTraffic=stHttpTraffic, mwgTrapVariables=mwgTrapVariables, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBadReputation=stBadReputation, stTimeForTransaction=stTimeForTransaction, mwgEngineVersions=mwgEngineVersions, mwgMiscellaneous=mwgMiscellaneous, kCustomVersion=kCustomVersion, notifyOrigin=notifyOrigin, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsRequests=stHttpsRequests, stHttpsBytesToServer=stHttpsBytesToServer, kMajorVersion=kMajorVersion, notifyAffectedHost=notifyAffectedHost, kProductName=kProductName, pMFEEngineVersion=pMFEEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, trUser=trUser, stCPULoadRaw=stCPULoadRaw, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoryCount=stCategoryCount, kProductVersion=kProductVersion, stConnectionsBlocked=stConnectionsBlocked, pMFEDATVersion=pMFEDATVersion, PYSNMP_MODULE_ID=mwg, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpTraffic=stFtpTraffic, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttp=mwgHttp, mwgFTP=mwgFTP, stCategoriesTable=stCategoriesTable, trApplication=trApplication, kMicroVersion=kMicroVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesFromClient=stHttpBytesFromClient, mwgHttps=mwgHttps, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCPUIOWait=stCPUIOWait, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesFromClient=stFtpBytesFromClient, stHandleConnectToServer=stHandleConnectToServer, kHotfixVersion=kHotfixVersion, stHttpRequests=stHttpRequests, mwgInfo=mwgInfo, stHttpBytesToServer=stHttpBytesToServer, notifyReason=notifyReason, stFtpBytesToClient=stFtpBytesToClient, notifyOriginName=notifyOriginName, kMinorVersion=kMinorVersion, stConnectedSockets=stConnectedSockets, kBuildNumber=kBuildNumber, pTSDBVersion=pTSDBVersion, stCategories=stCategories, mwgContent=mwgContent, stFtpBytesToServer=stFtpBytesToServer, pAMEngineVersion=pAMEngineVersion, stResolveHostViaDNS=stResolveHostViaDNS, stCategoryName=stCategoryName, mwg=mwg, stFtpBytesFromServer=stFtpBytesFromServer, kRevision=kRevision, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgTraps=mwgTraps, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsTraffic=stHttpsTraffic, kCompanyName=kCompanyName, stMemConsumed=stMemConsumed, stMalwareDetected=stMalwareDetected, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, trSystem=trSystem, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesToClient=stHttpBytesToClient, stMimeType=stMimeType, mwgStatistics=mwgStatistics, notifyReasonString=notifyReasonString)
