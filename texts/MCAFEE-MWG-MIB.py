...
IpAddress, ObjectIdentity, ModuleIdentity, Integer32, Counter32, Gauge32, Unsigned32, TimeTicks, mib_2, MibIdentifier, enterprises, NotificationType, Bits, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Integer32", "Counter32", "Gauge32", "Unsigned32", "TimeTicks", "mib-2", "MibIdentifier", "enterprises", "NotificationType", "Bits", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgTraps=mwgTraps, pMFEEngineVersion=pMFEEngineVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgEngineVersions=mwgEngineVersions, stHttpBytesFromClient=stHttpBytesFromClient, stHandleConnectToServer=stHandleConnectToServer, stClientCount=stClientCount, notifyAdditional=notifyAdditional, mwgTrapVariables=mwgTrapVariables, kMinorVersion=kMinorVersion, kRevision=kRevision, stFtpBytesToServer=stFtpBytesToServer, stCategoryName=stCategoryName, notifyAffectedHost=notifyAffectedHost, stBlockedByURLFilter=stBlockedByURLFilter, mwgMiscellaneous=mwgMiscellaneous, stConnectionsLegitimate=stConnectionsLegitimate, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBadReputation=stBadReputation, stHttpTraffic=stHttpTraffic, notifyOriginName=notifyOriginName, stCPULoadRaw=stCPULoadRaw, pAMEngineVersion=pAMEngineVersion, mwgContent=mwgContent, stTimeForTransaction=stTimeForTransaction, stResolveHostViaDNS=stResolveHostViaDNS, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trSystem=trSystem, stHttpBytesToClient=stHttpBytesToClient, trApplication=trApplication, stHttpBytesToServer=stHttpBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpBytesFromServer=stFtpBytesFromServer, trUser=trUser, stHttpsRequests=stHttpsRequests, stCPULoad=stCPULoad, notifyReasonString=notifyReasonString, pMFEDATVersion=pMFEDATVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategories=stCategories, kCompanyName=kCompanyName, stFtpBytesToClient=stFtpBytesToClient, stMemConsumed=stMemConsumed, stConnectedSockets=stConnectedSockets, notifySeverity=notifySeverity, kMajorVersion=kMajorVersion, mwgHttp=mwgHttp, pAMProactiveVersion=pAMProactiveVersion, kProductName=kProductName, stHttpsTraffic=stHttpsTraffic, stHttpBytesFromServer=stHttpBytesFromServer, notifyReason=notifyReason, kCustomVersion=kCustomVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, kBuildNumber=kBuildNumber, stCategoriesTable=stCategoriesTable, stCPUIOWait=stCPUIOWait, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pTSDBVersion=pTSDBVersion, mwgStatistics=mwgStatistics, kProductVersion=kProductVersion, stCategoryCount=stCategoryCount, stFtpBytesFromClient=stFtpBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpRequests=stHttpRequests, mwgFTP=mwgFTP, stHttpsBytesFromClient=stHttpsBytesFromClient, stMalwareDetected=stMalwareDetected, mwgHttps=mwgHttps, stMimeType=stMimeType, kMicroVersion=kMicroVersion, pAMSignatureVersion=pAMSignatureVersion, mwg=mwg, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesToServer=stHttpsBytesToServer, mwgInfo=mwgInfo, stFtpTraffic=stFtpTraffic, stCategoriesEntry=stCategoriesEntry, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyOrigin=notifyOrigin, stHttpsBytesToClient=stHttpsBytesToClient, kHotfixVersion=kHotfixVersion, PYSNMP_MODULE_ID=mwg)
