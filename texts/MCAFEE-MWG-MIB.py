...
iso, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, NotificationType, Bits, TimeTicks, Unsigned32, enterprises, ObjectIdentity, MibIdentifier, Counter32, Integer32, ModuleIdentity, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "NotificationType", "Bits", "TimeTicks", "Unsigned32", "enterprises", "ObjectIdentity", "MibIdentifier", "Counter32", "Integer32", "ModuleIdentity", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyOrigin=notifyOrigin, trApplication=trApplication, kMicroVersion=kMicroVersion, mwgTrapVariables=mwgTrapVariables, mwgEngineVersions=mwgEngineVersions, trSystem=trSystem, stCategoriesEntry=stCategoriesEntry, notifyReason=notifyReason, notifyAdditional=notifyAdditional, stHttpBytesFromClient=stHttpBytesFromClient, kCompanyName=kCompanyName, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpTraffic=stHttpTraffic, stFtpBytesToClient=stFtpBytesToClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stResolveHostViaDNS=stResolveHostViaDNS, stConnectedSockets=stConnectedSockets, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyReasonString=notifyReasonString, stHttpsBytesToClient=stHttpsBytesToClient, kRevision=kRevision, stMemConsumed=stMemConsumed, stFtpTraffic=stFtpTraffic, stFtpBytesToServer=stFtpBytesToServer, kMinorVersion=kMinorVersion, notifyAffectedHost=notifyAffectedHost, stCategoriesTable=stCategoriesTable, trUser=trUser, pAMProactiveVersion=pAMProactiveVersion, stCPULoadRaw=stCPULoadRaw, mwgHttps=mwgHttps, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesToServer=stHttpBytesToServer, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, PYSNMP_MODULE_ID=mwg, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoryCount=stCategoryCount, pTSDBVersion=pTSDBVersion, stHandleConnectToServer=stHandleConnectToServer, mwgStatistics=mwgStatistics, notifyOriginName=notifyOriginName, kProductName=kProductName, stCategories=stCategories, stBlockedByMediaFilter=stBlockedByMediaFilter, stTimeForTransaction=stTimeForTransaction, stConnectionsBlocked=stConnectionsBlocked, stHttpRequests=stHttpRequests, kBuildNumber=kBuildNumber, stFtpBytesFromClient=stFtpBytesFromClient, mwg=mwg, mwgTraps=mwgTraps, kHotfixVersion=kHotfixVersion, pAMEngineVersion=pAMEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, pMFEDATVersion=pMFEDATVersion, notifySeverity=notifySeverity, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsRequests=stHttpsRequests, stCPUIOWait=stCPUIOWait, mwgInfo=mwgInfo, kProductVersion=kProductVersion, kMajorVersion=kMajorVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsTraffic=stHttpsTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMalwareDetected=stMalwareDetected, stBadReputation=stBadReputation, stHttpBytesFromServer=stHttpBytesFromServer, mwgMiscellaneous=mwgMiscellaneous, mwgFTP=mwgFTP, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kCustomVersion=kCustomVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgHttp=mwgHttp, pAMSignatureVersion=pAMSignatureVersion, mwgContent=mwgContent, stMimeType=stMimeType, stCPULoad=stCPULoad, stCategoryName=stCategoryName, stClientCount=stClientCount)
