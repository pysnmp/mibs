...
NotificationType, ObjectIdentity, Integer32, Unsigned32, Gauge32, ModuleIdentity, mib_2, enterprises, Counter64, NotificationType, iso, MibIdentifier, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Integer32", "Unsigned32", "Gauge32", "ModuleIdentity", "mib-2", "enterprises", "Counter64", "NotificationType", "iso", "MibIdentifier", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsTraffic=stHttpsTraffic, pMFEDATVersion=pMFEDATVersion, mwgFTP=mwgFTP, notifyReasonString=notifyReasonString, stConnectedSockets=stConnectedSockets, stHttpsRequests=stHttpsRequests, stCPULoad=stCPULoad, notifyReason=notifyReason, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, trUser=trUser, stHandleConnectToServer=stHandleConnectToServer, stCategoriesEntry=stCategoriesEntry, stFtpBytesToServer=stFtpBytesToServer, pTSDBVersion=pTSDBVersion, mwgContent=mwgContent, kProductName=kProductName, mwgInfo=mwgInfo, kMinorVersion=kMinorVersion, PYSNMP_MODULE_ID=mwg, stTimeForTransaction=stTimeForTransaction, stCategories=stCategories, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, notifyAdditional=notifyAdditional, stCategoryCount=stCategoryCount, mwgHttp=mwgHttp, mwgMiscellaneous=mwgMiscellaneous, notifySeverity=notifySeverity, stHttpsBytesToClient=stHttpsBytesToClient, kHotfixVersion=kHotfixVersion, pAMEngineVersion=pAMEngineVersion, stCPUIOWait=stCPUIOWait, kBuildNumber=kBuildNumber, kCompanyName=kCompanyName, stConnectionsLegitimate=stConnectionsLegitimate, stBadReputation=stBadReputation, stHttpBytesToClient=stHttpBytesToClient, trSystem=trSystem, kRevision=kRevision, mwg=mwg, stFtpTraffic=stFtpTraffic, stCPULoadRaw=stCPULoadRaw, stHttpsBytesToServer=stHttpsBytesToServer, stClientCount=stClientCount, pAMProactiveVersion=pAMProactiveVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesFromClient=stHttpsBytesFromClient, trApplication=trApplication, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgTraps=mwgTraps, stMimeType=stMimeType, stCategoryName=stCategoryName, mwgTrapVariables=mwgTrapVariables, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stResolveHostViaDNS=stResolveHostViaDNS, stMalwareDetected=stMalwareDetected, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByAntiMalware=stBlockedByAntiMalware, kMicroVersion=kMicroVersion, stHttpBytesFromServer=stHttpBytesFromServer, mwgEngineVersions=mwgEngineVersions, stCategoriesTable=stCategoriesTable, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMemConsumed=stMemConsumed, kProductVersion=kProductVersion, notifyAffectedHost=notifyAffectedHost, notifyOriginName=notifyOriginName, stHttpRequests=stHttpRequests, pAMSignatureVersion=pAMSignatureVersion, mwgStatistics=mwgStatistics, mwgHttps=mwgHttps, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpBytesToServer=stHttpBytesToServer, kCustomVersion=kCustomVersion, stHttpTraffic=stHttpTraffic, kMajorVersion=kMajorVersion, pMFEEngineVersion=pMFEEngineVersion, notifyOrigin=notifyOrigin, stConnectionsBlocked=stConnectionsBlocked, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesFromServer=stFtpBytesFromServer)
