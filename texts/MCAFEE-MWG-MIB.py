...
IpAddress, ObjectIdentity, Counter64, NotificationType, Gauge32, Bits, Counter32, mib_2, NotificationType, Unsigned32, TimeTicks, Integer32, iso, ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "Counter64", "NotificationType", "Gauge32", "Bits", "Counter32", "mib-2", "NotificationType", "Unsigned32", "TimeTicks", "Integer32", "iso", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgContent=mwgContent, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kBuildNumber=kBuildNumber, trSystem=trSystem, stBlockedByMediaFilter=stBlockedByMediaFilter, stClientCount=stClientCount, stCategoriesTable=stCategoriesTable, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsTraffic=stHttpsTraffic, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pAMProactiveVersion=pAMProactiveVersion, trApplication=trApplication, kMajorVersion=kMajorVersion, PYSNMP_MODULE_ID=mwg, stCategoryCount=stCategoryCount, kCustomVersion=kCustomVersion, mwgTrapVariables=mwgTrapVariables, stHandleConnectToServer=stHandleConnectToServer, pMFEEngineVersion=pMFEEngineVersion, stMalwareDetected=stMalwareDetected, stFtpBytesFromClient=stFtpBytesFromClient, mwgHttps=mwgHttps, stConnectionsLegitimate=stConnectionsLegitimate, kMinorVersion=kMinorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgTraps=mwgTraps, notifyOriginName=notifyOriginName, stCPULoad=stCPULoad, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kHotfixVersion=kHotfixVersion, mwgMiscellaneous=mwgMiscellaneous, stHttpTraffic=stHttpTraffic, kRevision=kRevision, mwgFTP=mwgFTP, stTimeForTransaction=stTimeForTransaction, notifyAffectedHost=notifyAffectedHost, notifyAdditional=notifyAdditional, stCPULoadRaw=stCPULoadRaw, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesToClient=stHttpBytesToClient, trUser=trUser, stBlockedByAntiMalware=stBlockedByAntiMalware, notifySeverity=notifySeverity, stHttpRequests=stHttpRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpTraffic=stFtpTraffic, mwgStatistics=mwgStatistics, stHttpBytesFromClient=stHttpBytesFromClient, kMicroVersion=kMicroVersion, pMFEDATVersion=pMFEDATVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pTSDBVersion=pTSDBVersion, stCategories=stCategories, kProductName=kProductName, pAMSignatureVersion=pAMSignatureVersion, stMemConsumed=stMemConsumed, stBadReputation=stBadReputation, notifyReasonString=notifyReasonString, stCPUIOWait=stCPUIOWait, mwgInfo=mwgInfo, stHttpsRequests=stHttpsRequests, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, stCategoryName=stCategoryName, mwgEngineVersions=mwgEngineVersions, kCompanyName=kCompanyName, stConnectedSockets=stConnectedSockets, stHttpsBytesFromClient=stHttpsBytesFromClient, mwg=mwg, stHttpBytesFromServer=stHttpBytesFromServer, notifyReason=notifyReason, stCategoriesEntry=stCategoriesEntry, stHttpBytesToServer=stHttpBytesToServer, pAMEngineVersion=pAMEngineVersion, kProductVersion=kProductVersion, mwgHttp=mwgHttp, stMimeType=stMimeType, stFtpBytesToClient=stFtpBytesToClient, notifyOrigin=notifyOrigin, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesToClient=stHttpsBytesToClient)
