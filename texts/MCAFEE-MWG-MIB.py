...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, NotificationType, NotificationType, ModuleIdentity, TimeTicks, enterprises, Counter32, Counter64, iso, Bits, ObjectIdentity, Gauge32, Integer32, IpAddress, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "NotificationType", "NotificationType", "ModuleIdentity", "TimeTicks", "enterprises", "Counter32", "Counter64", "iso", "Bits", "ObjectIdentity", "Gauge32", "Integer32", "IpAddress", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgFTP=mwgFTP, stFtpBytesToServer=stFtpBytesToServer, stCPUIOWait=stCPUIOWait, stHttpsTraffic=stHttpsTraffic, PYSNMP_MODULE_ID=mwg, stBadReputation=stBadReputation, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesToServer=stHttpBytesToServer, trUser=trUser, stHttpsBytesToClient=stHttpsBytesToClient, mwgTrapVariables=mwgTrapVariables, kMajorVersion=kMajorVersion, mwgInfo=mwgInfo, stClientCount=stClientCount, stBlockedByMediaFilter=stBlockedByMediaFilter, stResolveHostViaDNS=stResolveHostViaDNS, mwgTraps=mwgTraps, notifyReason=notifyReason, stMimeType=stMimeType, notifyReasonString=notifyReasonString, stHttpTraffic=stHttpTraffic, stHttpBytesToClient=stHttpBytesToClient, kMicroVersion=kMicroVersion, stMalwareDetected=stMalwareDetected, stTimeForTransaction=stTimeForTransaction, mwgContent=mwgContent, kMinorVersion=kMinorVersion, stConnectionsBlocked=stConnectionsBlocked, notifyAdditional=notifyAdditional, kRevision=kRevision, stHttpsBytesFromServer=stHttpsBytesFromServer, stMemConsumed=stMemConsumed, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCPULoad=stCPULoad, kProductVersion=kProductVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifySeverity=notifySeverity, pAMProactiveVersion=pAMProactiveVersion, pAMEngineVersion=pAMEngineVersion, stHandleConnectToServer=stHandleConnectToServer, trApplication=trApplication, stCategoriesTable=stCategoriesTable, stHttpBytesFromServer=stHttpBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kCustomVersion=kCustomVersion, stFtpBytesFromClient=stFtpBytesFromClient, stCPULoadRaw=stCPULoadRaw, stBlockedByAntiMalware=stBlockedByAntiMalware, pMFEDATVersion=pMFEDATVersion, stCategories=stCategories, pMFEEngineVersion=pMFEEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsRequests=stHttpsRequests, mwgHttps=mwgHttps, trSystem=trSystem, mwgStatistics=mwgStatistics, notifyAffectedHost=notifyAffectedHost, mwgEngineVersions=mwgEngineVersions, pTSDBVersion=pTSDBVersion, kHotfixVersion=kHotfixVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwg=mwg, stHttpRequests=stHttpRequests, kCompanyName=kCompanyName, stCategoryCount=stCategoryCount, stFtpTraffic=stFtpTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stConnectedSockets=stConnectedSockets, kProductName=kProductName, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesToServer=stHttpsBytesToServer, notifyOriginName=notifyOriginName, mwgHttp=mwgHttp, notifyOrigin=notifyOrigin, stFtpBytesToClient=stFtpBytesToClient, kBuildNumber=kBuildNumber, stCategoryName=stCategoryName, pAMSignatureVersion=pAMSignatureVersion, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesEntry=stCategoriesEntry)
