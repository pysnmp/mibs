...
Counter64, mib_2, NotificationType, Unsigned32, Counter32, enterprises, ObjectIdentity, MibIdentifier, Bits, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, TimeTicks, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "mib-2", "NotificationType", "Unsigned32", "Counter32", "enterprises", "ObjectIdentity", "MibIdentifier", "Bits", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "TimeTicks", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pTSDBVersion=pTSDBVersion, stCategoriesTable=stCategoriesTable, mwgHttp=mwgHttp, stBlockedByAntiMalware=stBlockedByAntiMalware, kMinorVersion=kMinorVersion, stCategoryName=stCategoryName, mwgEngineVersions=mwgEngineVersions, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, kBuildNumber=kBuildNumber, mwgInfo=mwgInfo, stHttpsBytesToClient=stHttpsBytesToClient, mwgFTP=mwgFTP, stCPUIOWait=stCPUIOWait, kProductName=kProductName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, pAMSignatureVersion=pAMSignatureVersion, PYSNMP_MODULE_ID=mwg, notifyOriginName=notifyOriginName, notifyReason=notifyReason, stCategories=stCategories, kRevision=kRevision, stCPULoadRaw=stCPULoadRaw, pAMEngineVersion=pAMEngineVersion, stConnectedSockets=stConnectedSockets, stConnectionsLegitimate=stConnectionsLegitimate, stClientCount=stClientCount, stHandleConnectToServer=stHandleConnectToServer, mwgHttps=mwgHttps, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMicroVersion=kMicroVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgMiscellaneous=mwgMiscellaneous, kCustomVersion=kCustomVersion, notifyOrigin=notifyOrigin, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesToClient=stHttpBytesToClient, notifyReasonString=notifyReasonString, stHttpsTraffic=stHttpsTraffic, trApplication=trApplication, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesToServer=stHttpsBytesToServer, notifyAdditional=notifyAdditional, stTimeForTransaction=stTimeForTransaction, stHttpBytesFromServer=stHttpBytesFromServer, stFtpTraffic=stFtpTraffic, stCPULoad=stCPULoad, pMFEDATVersion=pMFEDATVersion, stResolveHostViaDNS=stResolveHostViaDNS, kCompanyName=kCompanyName, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpRequests=stHttpRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoryCount=stCategoryCount, stHttpsRequests=stHttpsRequests, pAMProactiveVersion=pAMProactiveVersion, mwgTraps=mwgTraps, stHttpTraffic=stHttpTraffic, stMalwareDetected=stMalwareDetected, kProductVersion=kProductVersion, stMemConsumed=stMemConsumed, stMimeType=stMimeType, stConnectionsBlocked=stConnectionsBlocked, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kHotfixVersion=kHotfixVersion, stBadReputation=stBadReputation, trUser=trUser, notifyAffectedHost=notifyAffectedHost, stBlockedByURLFilter=stBlockedByURLFilter, pMFEEngineVersion=pMFEEngineVersion, mwgTrapVariables=mwgTrapVariables, stHttpBytesToServer=stHttpBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifySeverity=notifySeverity, mwg=mwg, kMajorVersion=kMajorVersion, mwgContent=mwgContent, trSystem=trSystem, mwgStatistics=mwgStatistics, stBlockedByMediaFilter=stBlockedByMediaFilter)
