...
ObjectIdentity, TimeTicks, MibIdentifier, IpAddress, Gauge32, Integer32, Unsigned32, enterprises, mib_2, NotificationType, iso, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "MibIdentifier", "IpAddress", "Gauge32", "Integer32", "Unsigned32", "enterprises", "mib-2", "NotificationType", "iso", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesToClient=stHttpBytesToClient, kMinorVersion=kMinorVersion, trSystem=trSystem, stFtpBytesFromClient=stFtpBytesFromClient, mwgStatistics=mwgStatistics, stFtpBytesToServer=stFtpBytesToServer, trUser=trUser, pAMSignatureVersion=pAMSignatureVersion, kMicroVersion=kMicroVersion, stHttpsRequests=stHttpsRequests, mwgInfo=mwgInfo, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTrapVariables=mwgTrapVariables, stHttpRequests=stHttpRequests, stCategoriesTable=stCategoriesTable, stCategoryCount=stCategoryCount, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsTraffic=stHttpsTraffic, kMajorVersion=kMajorVersion, notifyOriginName=notifyOriginName, stCategories=stCategories, stHttpTraffic=stHttpTraffic, mwgHttps=mwgHttps, pMFEEngineVersion=pMFEEngineVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesToClient=stHttpsBytesToClient, mwgContent=mwgContent, notifyReasonString=notifyReasonString, stHttpsBytesToServer=stHttpsBytesToServer, pMFEDATVersion=pMFEDATVersion, mwgEngineVersions=mwgEngineVersions, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectedSockets=stConnectedSockets, kProductVersion=kProductVersion, trApplication=trApplication, mwgFTP=mwgFTP, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMimeType=stMimeType, stFtpTraffic=stFtpTraffic, kCompanyName=kCompanyName, stCPUIOWait=stCPUIOWait, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyReason=notifyReason, mwgHttp=mwgHttp, stCategoryName=stCategoryName, pAMProactiveVersion=pAMProactiveVersion, stBlockedByURLFilter=stBlockedByURLFilter, stHandleConnectToServer=stHandleConnectToServer, pAMEngineVersion=pAMEngineVersion, kBuildNumber=kBuildNumber, stBadReputation=stBadReputation, mwg=mwg, stCPULoadRaw=stCPULoadRaw, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kProductName=kProductName, stCategoriesEntry=stCategoriesEntry, stTimeForTransaction=stTimeForTransaction, stBlockedByAntiMalware=stBlockedByAntiMalware, kRevision=kRevision, stMemConsumed=stMemConsumed, stMalwareDetected=stMalwareDetected, stResolveHostViaDNS=stResolveHostViaDNS, notifyOrigin=notifyOrigin, pTSDBVersion=pTSDBVersion, stFtpBytesToClient=stFtpBytesToClient, PYSNMP_MODULE_ID=mwg, kCustomVersion=kCustomVersion, kHotfixVersion=kHotfixVersion, stHttpBytesFromClient=stHttpBytesFromClient, mwgTraps=mwgTraps, notifyAffectedHost=notifyAffectedHost, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectionsBlocked=stConnectionsBlocked, notifySeverity=notifySeverity, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgMiscellaneous=mwgMiscellaneous, stClientCount=stClientCount, notifyAdditional=notifyAdditional, stHttpBytesToServer=stHttpBytesToServer, stCPULoad=stCPULoad)
