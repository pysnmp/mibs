...
ObjectIdentity, Gauge32, mib_2, Counter64, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, ModuleIdentity, enterprises, NotificationType, Integer32, Counter32, Bits, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "mib-2", "Counter64", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "ModuleIdentity", "enterprises", "NotificationType", "Integer32", "Counter32", "Bits", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyReason=notifyReason, mwgTraps=mwgTraps, stResolveHostViaDNS=stResolveHostViaDNS, notifyReasonString=notifyReasonString, mwgEngineVersions=mwgEngineVersions, stCategoryName=stCategoryName, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, mwgHttps=mwgHttps, mwgHttp=mwgHttp, stMemConsumed=stMemConsumed, stHttpRequests=stHttpRequests, kCompanyName=kCompanyName, mwg=mwg, notifyAdditional=notifyAdditional, PYSNMP_MODULE_ID=mwg, pAMEngineVersion=pAMEngineVersion, kMicroVersion=kMicroVersion, mwgMiscellaneous=mwgMiscellaneous, stMalwareDetected=stMalwareDetected, mwgTrapVariables=mwgTrapVariables, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoriesEntry=stCategoriesEntry, stHttpsBytesToClient=stHttpsBytesToClient, stCategories=stCategories, stCategoriesTable=stCategoriesTable, stCPULoadRaw=stCPULoadRaw, stHttpBytesFromServer=stHttpBytesFromServer, kRevision=kRevision, stConnectionsLegitimate=stConnectionsLegitimate, trSystem=trSystem, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyAffectedHost=notifyAffectedHost, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stClientCount=stClientCount, stHttpsTraffic=stHttpsTraffic, stFtpTraffic=stFtpTraffic, kHotfixVersion=kHotfixVersion, notifyOriginName=notifyOriginName, stHttpsBytesToServer=stHttpsBytesToServer, stCPUIOWait=stCPUIOWait, stHttpsRequests=stHttpsRequests, mwgContent=mwgContent, stFtpBytesToClient=stFtpBytesToClient, kCustomVersion=kCustomVersion, stHttpBytesToServer=stHttpBytesToServer, stConnectedSockets=stConnectedSockets, trUser=trUser, pMFEDATVersion=pMFEDATVersion, mwgFTP=mwgFTP, pMFEEngineVersion=pMFEEngineVersion, trApplication=trApplication, kProductVersion=kProductVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, notifySeverity=notifySeverity, kBuildNumber=kBuildNumber, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesToClient=stHttpBytesToClient, stCPULoad=stCPULoad, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pTSDBVersion=pTSDBVersion, kProductName=kProductName, stBadReputation=stBadReputation, pAMProactiveVersion=pAMProactiveVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMimeType=stMimeType, stFtpBytesToServer=stFtpBytesToServer, mwgStatistics=mwgStatistics, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyOrigin=notifyOrigin, stCategoryCount=stCategoryCount, stBlockedByMediaFilter=stBlockedByMediaFilter, kMajorVersion=kMajorVersion, mwgInfo=mwgInfo, stHandleConnectToServer=stHandleConnectToServer, stBlockedByURLFilter=stBlockedByURLFilter, kMinorVersion=kMinorVersion, stHttpTraffic=stHttpTraffic, stFtpBytesFromClient=stFtpBytesFromClient, stTimeForTransaction=stTimeForTransaction)
