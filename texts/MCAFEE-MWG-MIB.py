...
ModuleIdentity, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, iso, enterprises, TimeTicks, Integer32, NotificationType, Bits, Unsigned32, Counter32, Gauge32, NotificationType, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "iso", "enterprises", "TimeTicks", "Integer32", "NotificationType", "Bits", "Unsigned32", "Counter32", "Gauge32", "NotificationType", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesFromClient=stHttpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, notifyAdditional=notifyAdditional, notifyReasonString=notifyReasonString, mwgFTP=mwgFTP, pMFEDATVersion=pMFEDATVersion, stResolveHostViaDNS=stResolveHostViaDNS, stTimeForTransaction=stTimeForTransaction, kProductName=kProductName, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsRequests=stHttpsRequests, stFtpBytesToClient=stFtpBytesToClient, stCategoriesTable=stCategoriesTable, stHttpBytesToClient=stHttpBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHandleConnectToServer=stHandleConnectToServer, pTSDBVersion=pTSDBVersion, mwgHttps=mwgHttps, mwgHttp=mwgHttp, stCategoryCount=stCategoryCount, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgContent=mwgContent, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategories=stCategories, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpTraffic=stFtpTraffic, trSystem=trSystem, mwgStatistics=mwgStatistics, stCategoriesEntry=stCategoriesEntry, kCompanyName=kCompanyName, stHttpBytesToServer=stHttpBytesToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgInfo=mwgInfo, stConnectedSockets=stConnectedSockets, stCPUIOWait=stCPUIOWait, stMalwareDetected=stMalwareDetected, notifySeverity=notifySeverity, notifyAffectedHost=notifyAffectedHost, kCustomVersion=kCustomVersion, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, kMicroVersion=kMicroVersion, stClientCount=stClientCount, stFtpBytesFromClient=stFtpBytesFromClient, stHttpTraffic=stHttpTraffic, kBuildNumber=kBuildNumber, kMinorVersion=kMinorVersion, kProductVersion=kProductVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, pAMEngineVersion=pAMEngineVersion, trUser=trUser, kMajorVersion=kMajorVersion, stCategoryName=stCategoryName, stCPULoad=stCPULoad, stHttpsBytesToClient=stHttpsBytesToClient, mwgTrapVariables=mwgTrapVariables, stHttpsBytesToServer=stHttpsBytesToServer, kRevision=kRevision, kHotfixVersion=kHotfixVersion, stConnectionsLegitimate=stConnectionsLegitimate, stHttpRequests=stHttpRequests, mwg=mwg, stCPULoadRaw=stCPULoadRaw, stMimeType=stMimeType, notifyOrigin=notifyOrigin, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyReason=notifyReason, PYSNMP_MODULE_ID=mwg, pAMSignatureVersion=pAMSignatureVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMemConsumed=stMemConsumed, pAMProactiveVersion=pAMProactiveVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectionsBlocked=stConnectionsBlocked, mwgTraps=mwgTraps, stBadReputation=stBadReputation, notifyOriginName=notifyOriginName, trApplication=trApplication, stFtpBytesToServer=stFtpBytesToServer, stHttpsTraffic=stHttpsTraffic, mwgEngineVersions=mwgEngineVersions)
