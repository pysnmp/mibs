...
Counter32, IpAddress, TimeTicks, Unsigned32, ModuleIdentity, Counter64, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, NotificationType, ObjectIdentity, NotificationType, Gauge32, Bits, Integer32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "TimeTicks", "Unsigned32", "ModuleIdentity", "Counter64", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "NotificationType", "ObjectIdentity", "NotificationType", "Gauge32", "Bits", "Integer32", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByAntiMalware=stBlockedByAntiMalware, mwgEngineVersions=mwgEngineVersions, stCategoryCount=stCategoryCount, stHttpsBytesToServer=stHttpsBytesToServer, mwgHttp=mwgHttp, stHttpsRequests=stHttpsRequests, mwgTraps=mwgTraps, stConnectedSockets=stConnectedSockets, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpRequests=stHttpRequests, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stClientCount=stClientCount, kProductVersion=kProductVersion, stFtpBytesFromServer=stFtpBytesFromServer, kMicroVersion=kMicroVersion, kCustomVersion=kCustomVersion, stTimeForTransaction=stTimeForTransaction, stBlockedByURLFilter=stBlockedByURLFilter, kProductName=kProductName, stHttpBytesFromClient=stHttpBytesFromClient, trUser=trUser, pTSDBVersion=pTSDBVersion, stCPULoad=stCPULoad, notifySeverity=notifySeverity, stHttpBytesFromServer=stHttpBytesFromServer, notifyOrigin=notifyOrigin, stMalwareDetected=stMalwareDetected, stConnectionsBlocked=stConnectionsBlocked, mwgMiscellaneous=mwgMiscellaneous, stCategoriesEntry=stCategoriesEntry, mwgTrapVariables=mwgTrapVariables, pMFEEngineVersion=pMFEEngineVersion, stCategoryName=stCategoryName, stMimeType=stMimeType, mwgStatistics=mwgStatistics, stHttpTraffic=stHttpTraffic, stBadReputation=stBadReputation, kBuildNumber=kBuildNumber, mwgContent=mwgContent, notifyAdditional=notifyAdditional, stHttpsTraffic=stHttpsTraffic, mwg=mwg, notifyReason=notifyReason, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesToClient=stHttpsBytesToClient, kHotfixVersion=kHotfixVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMajorVersion=kMajorVersion, stConnectionsLegitimate=stConnectionsLegitimate, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesFromClient=stFtpBytesFromClient, kMinorVersion=kMinorVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesToClient=stHttpBytesToClient, mwgFTP=mwgFTP, notifyAffectedHost=notifyAffectedHost, stFtpTraffic=stFtpTraffic, stCPUIOWait=stCPUIOWait, notifyOriginName=notifyOriginName, PYSNMP_MODULE_ID=mwg, stCategoriesTable=stCategoriesTable, stHandleConnectToServer=stHandleConnectToServer, trApplication=trApplication, mwgHttps=mwgHttps, stFtpBytesToClient=stFtpBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kRevision=kRevision, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategories=stCategories, stMemConsumed=stMemConsumed, mwgInfo=mwgInfo, stCPULoadRaw=stCPULoadRaw, pMFEDATVersion=pMFEDATVersion, stResolveHostViaDNS=stResolveHostViaDNS, notifyReasonString=notifyReasonString, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kCompanyName=kCompanyName, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMEngineVersion=pAMEngineVersion, trSystem=trSystem)
