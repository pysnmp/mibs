...
Bits, IpAddress, mib_2, NotificationType, NotificationType, iso, ObjectIdentity, enterprises, Gauge32, Unsigned32, Counter64, MibIdentifier, Integer32, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "mib-2", "NotificationType", "NotificationType", "iso", "ObjectIdentity", "enterprises", "Gauge32", "Unsigned32", "Counter64", "MibIdentifier", "Integer32", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoryName=stCategoryName, stCPUIOWait=stCPUIOWait, stFtpBytesFromServer=stFtpBytesFromServer, mwgContent=mwgContent, stMemConsumed=stMemConsumed, stMalwareDetected=stMalwareDetected, notifyOrigin=notifyOrigin, stConnectionsBlocked=stConnectionsBlocked, mwgStatistics=mwgStatistics, pTSDBVersion=pTSDBVersion, stTimeForTransaction=stTimeForTransaction, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trApplication=trApplication, stBlockedByAntiMalware=stBlockedByAntiMalware, kCompanyName=kCompanyName, stMimeType=stMimeType, kMinorVersion=kMinorVersion, stFtpTraffic=stFtpTraffic, pAMSignatureVersion=pAMSignatureVersion, trSystem=trSystem, stFtpBytesFromClient=stFtpBytesFromClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, stHttpRequests=stHttpRequests, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesToServer=stFtpBytesToServer, stConnectedSockets=stConnectedSockets, mwgTraps=mwgTraps, stHttpBytesToClient=stHttpBytesToClient, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesFromServer=stHttpBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, stHandleConnectToServer=stHandleConnectToServer, stCategories=stCategories, pAMProactiveVersion=pAMProactiveVersion, mwgHttps=mwgHttps, stHttpsBytesToServer=stHttpsBytesToServer, kMicroVersion=kMicroVersion, mwgTrapVariables=mwgTrapVariables, pAMEngineVersion=pAMEngineVersion, stCPULoad=stCPULoad, stCPULoadRaw=stCPULoadRaw, stCategoryCount=stCategoryCount, mwg=mwg, trUser=trUser, stHttpsRequests=stHttpsRequests, mwgEngineVersions=mwgEngineVersions, notifyOriginName=notifyOriginName, stBlockedByURLFilter=stBlockedByURLFilter, notifyAdditional=notifyAdditional, notifyReason=notifyReason, stHttpBytesToServer=stHttpBytesToServer, mwgHttp=mwgHttp, stHttpsBytesToClient=stHttpsBytesToClient, PYSNMP_MODULE_ID=mwg, notifySeverity=notifySeverity, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesFromClient=stHttpBytesFromClient, kHotfixVersion=kHotfixVersion, notifyAffectedHost=notifyAffectedHost, pMFEEngineVersion=pMFEEngineVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesToClient=stFtpBytesToClient, kProductName=kProductName, kProductVersion=kProductVersion, kBuildNumber=kBuildNumber, stBadReputation=stBadReputation, stHttpsTraffic=stHttpsTraffic, mwgFTP=mwgFTP, stHttpsBytesFromServer=stHttpsBytesFromServer, pMFEDATVersion=pMFEDATVersion, stHttpTraffic=stHttpTraffic, kMajorVersion=kMajorVersion, stCategoriesEntry=stCategoriesEntry, mwgInfo=mwgInfo, stCategoriesTable=stCategoriesTable, notifyReasonString=notifyReasonString, stClientCount=stClientCount, kRevision=kRevision, stHttpsBytesFromClient=stHttpsBytesFromClient, kCustomVersion=kCustomVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine)
