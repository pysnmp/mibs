...
enterprises, Integer32, Counter32, NotificationType, Gauge32, iso, mib_2, NotificationType, ObjectIdentity, Bits, Unsigned32, ModuleIdentity, MibIdentifier, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "Counter32", "NotificationType", "Gauge32", "iso", "mib-2", "NotificationType", "ObjectIdentity", "Bits", "Unsigned32", "ModuleIdentity", "MibIdentifier", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesToClient=stFtpBytesToClient, stTimeForTransaction=stTimeForTransaction, stHttpsBytesToServer=stHttpsBytesToServer, notifyReason=notifyReason, mwgMiscellaneous=mwgMiscellaneous, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trApplication=trApplication, trUser=trUser, stBadReputation=stBadReputation, stHttpsRequests=stHttpsRequests, mwgInfo=mwgInfo, stFtpBytesFromClient=stFtpBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesFromClient=stHttpBytesFromClient, stMalwareDetected=stMalwareDetected, stHttpsTraffic=stHttpsTraffic, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyOriginName=notifyOriginName, kHotfixVersion=kHotfixVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesToServer=stHttpBytesToServer, stConnectionsLegitimate=stConnectionsLegitimate, pAMEngineVersion=pAMEngineVersion, stCategoryCount=stCategoryCount, kCustomVersion=kCustomVersion, mwgHttp=mwgHttp, stConnectedSockets=stConnectedSockets, mwgStatistics=mwgStatistics, stHttpBytesToClient=stHttpBytesToClient, stHttpRequests=stHttpRequests, pTSDBVersion=pTSDBVersion, stHttpTraffic=stHttpTraffic, stBlockedByURLFilter=stBlockedByURLFilter, notifyReasonString=notifyReasonString, kCompanyName=kCompanyName, stBlockedByMediaFilter=stBlockedByMediaFilter, mwg=mwg, stClientCount=stClientCount, stCategoriesTable=stCategoriesTable, stHttpsBytesToClient=stHttpsBytesToClient, stCategoryName=stCategoryName, PYSNMP_MODULE_ID=mwg, kMajorVersion=kMajorVersion, mwgContent=mwgContent, stCategoriesEntry=stCategoriesEntry, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pMFEDATVersion=pMFEDATVersion, kMinorVersion=kMinorVersion, stCPUIOWait=stCPUIOWait, notifyAdditional=notifyAdditional, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyAffectedHost=notifyAffectedHost, mwgHttps=mwgHttps, stFtpBytesToServer=stFtpBytesToServer, mwgFTP=mwgFTP, pMFEEngineVersion=pMFEEngineVersion, mwgTraps=mwgTraps, stFtpBytesFromServer=stFtpBytesFromServer, kRevision=kRevision, kMicroVersion=kMicroVersion, kBuildNumber=kBuildNumber, mwgTrapVariables=mwgTrapVariables, kProductName=kProductName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategories=stCategories, mwgEngineVersions=mwgEngineVersions, stCPULoad=stCPULoad, stMemConsumed=stMemConsumed, stFtpTraffic=stFtpTraffic, stConnectionsBlocked=stConnectionsBlocked, notifySeverity=notifySeverity, pAMProactiveVersion=pAMProactiveVersion, stMimeType=stMimeType, stHandleConnectToServer=stHandleConnectToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyOrigin=notifyOrigin, stCPULoadRaw=stCPULoadRaw, stHttpBytesFromServer=stHttpBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, trSystem=trSystem, kProductVersion=kProductVersion)
