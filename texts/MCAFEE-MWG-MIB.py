...
enterprises, Integer32, NotificationType, ObjectIdentity, ModuleIdentity, Unsigned32, IpAddress, mib_2, iso, TimeTicks, Bits, MibIdentifier, NotificationType, Counter64, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "IpAddress", "mib-2", "iso", "TimeTicks", "Bits", "MibIdentifier", "NotificationType", "Counter64", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgFTP=mwgFTP, stHttpsBytesToClient=stHttpsBytesToClient, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsRequests=stHttpsRequests, notifyOriginName=notifyOriginName, stHttpTraffic=stHttpTraffic, stHttpsBytesToServer=stHttpsBytesToServer, kBuildNumber=kBuildNumber, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kProductVersion=kProductVersion, mwgStatistics=mwgStatistics, kProductName=kProductName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMicroVersion=kMicroVersion, stCategories=stCategories, stFtpBytesFromClient=stFtpBytesFromClient, kHotfixVersion=kHotfixVersion, trUser=trUser, kRevision=kRevision, kMajorVersion=kMajorVersion, stFtpTraffic=stFtpTraffic, kCustomVersion=kCustomVersion, stCPUIOWait=stCPUIOWait, stFtpBytesFromServer=stFtpBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, mwgInfo=mwgInfo, stHttpsTraffic=stHttpsTraffic, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoryName=stCategoryName, kMinorVersion=kMinorVersion, stBadReputation=stBadReputation, stFtpBytesToClient=stFtpBytesToClient, mwgTraps=mwgTraps, stCategoriesEntry=stCategoriesEntry, mwgMiscellaneous=mwgMiscellaneous, kCompanyName=kCompanyName, pAMProactiveVersion=pAMProactiveVersion, pAMSignatureVersion=pAMSignatureVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, stConnectedSockets=stConnectedSockets, stCategoriesTable=stCategoriesTable, stTimeForTransaction=stTimeForTransaction, notifyReasonString=notifyReasonString, stResolveHostViaDNS=stResolveHostViaDNS, pTSDBVersion=pTSDBVersion, PYSNMP_MODULE_ID=mwg, pMFEEngineVersion=pMFEEngineVersion, stMemConsumed=stMemConsumed, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesToServer=stFtpBytesToServer, notifyOrigin=notifyOrigin, stMalwareDetected=stMalwareDetected, pMFEDATVersion=pMFEDATVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgHttps=mwgHttps, mwgTrapVariables=mwgTrapVariables, stHttpBytesToServer=stHttpBytesToServer, stHttpRequests=stHttpRequests, stCategoryCount=stCategoryCount, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgHttp=mwgHttp, trSystem=trSystem, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMEngineVersion=pAMEngineVersion, notifyAdditional=notifyAdditional, stCPULoad=stCPULoad, trApplication=trApplication, mwgEngineVersions=mwgEngineVersions, mwgContent=mwgContent, stBlockedByAntiMalware=stBlockedByAntiMalware, stConnectionsBlocked=stConnectionsBlocked, stHandleConnectToServer=stHandleConnectToServer, notifyAffectedHost=notifyAffectedHost, notifyReason=notifyReason, stMimeType=stMimeType, stClientCount=stClientCount, notifySeverity=notifySeverity, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, mwg=mwg, stCPULoadRaw=stCPULoadRaw, stHttpBytesToClient=stHttpBytesToClient)
