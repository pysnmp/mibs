...
Integer32, Counter32, iso, Unsigned32, Gauge32, Bits, mib_2, IpAddress, ObjectIdentity, NotificationType, TimeTicks, Counter64, MibIdentifier, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "iso", "Unsigned32", "Gauge32", "Bits", "mib-2", "IpAddress", "ObjectIdentity", "NotificationType", "TimeTicks", "Counter64", "MibIdentifier", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMSignatureVersion=pAMSignatureVersion, kMinorVersion=kMinorVersion, mwgEngineVersions=mwgEngineVersions, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpTraffic=stFtpTraffic, stConnectionsBlocked=stConnectionsBlocked, notifyAdditional=notifyAdditional, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHandleConnectToServer=stHandleConnectToServer, kProductName=kProductName, stHttpsBytesToServer=stHttpsBytesToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesToClient=stHttpBytesToClient, kMajorVersion=kMajorVersion, stHttpsRequests=stHttpsRequests, stHttpsTraffic=stHttpsTraffic, stCategoryCount=stCategoryCount, mwgHttps=mwgHttps, pAMProactiveVersion=pAMProactiveVersion, stCPULoadRaw=stCPULoadRaw, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stMimeType=stMimeType, kMicroVersion=kMicroVersion, stResolveHostViaDNS=stResolveHostViaDNS, stMemConsumed=stMemConsumed, stConnectedSockets=stConnectedSockets, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoad=stCPULoad, stBadReputation=stBadReputation, stConnectionsLegitimate=stConnectionsLegitimate, notifyAffectedHost=notifyAffectedHost, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMEngineVersion=pAMEngineVersion, stMalwareDetected=stMalwareDetected, mwgMiscellaneous=mwgMiscellaneous, kBuildNumber=kBuildNumber, notifyReason=notifyReason, mwgTraps=mwgTraps, kHotfixVersion=kHotfixVersion, stHttpBytesFromClient=stHttpBytesFromClient, notifyOrigin=notifyOrigin, stHttpBytesFromServer=stHttpBytesFromServer, notifyReasonString=notifyReasonString, stCategories=stCategories, stHttpBytesToServer=stHttpBytesToServer, stCPUIOWait=stCPUIOWait, trUser=trUser, kCustomVersion=kCustomVersion, stCategoriesTable=stCategoriesTable, mwgContent=mwgContent, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpRequests=stHttpRequests, stCategoriesEntry=stCategoriesEntry, notifyOriginName=notifyOriginName, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, stHttpTraffic=stHttpTraffic, stTimeForTransaction=stTimeForTransaction, stBlockedByMediaFilter=stBlockedByMediaFilter, kProductVersion=kProductVersion, stFtpBytesToServer=stFtpBytesToServer, mwgHttp=mwgHttp, kCompanyName=kCompanyName, stHttpsBytesToClient=stHttpsBytesToClient, mwgFTP=mwgFTP, mwg=mwg, pMFEDATVersion=pMFEDATVersion, stCategoryName=stCategoryName, kRevision=kRevision, pTSDBVersion=pTSDBVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, PYSNMP_MODULE_ID=mwg, mwgStatistics=mwgStatistics, mwgInfo=mwgInfo, trSystem=trSystem, stFtpBytesToClient=stFtpBytesToClient, mwgTrapVariables=mwgTrapVariables, trApplication=trApplication, pMFEEngineVersion=pMFEEngineVersion, notifySeverity=notifySeverity, stClientCount=stClientCount)
