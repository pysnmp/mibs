...
Unsigned32, ObjectIdentity, Bits, mib_2, MibIdentifier, NotificationType, iso, Counter64, NotificationType, TimeTicks, ModuleIdentity, Integer32, IpAddress, Gauge32, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "Bits", "mib-2", "MibIdentifier", "NotificationType", "iso", "Counter64", "NotificationType", "TimeTicks", "ModuleIdentity", "Integer32", "IpAddress", "Gauge32", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgStatistics=mwgStatistics, mwgInfo=mwgInfo, stHttpsTraffic=stHttpsTraffic, trApplication=trApplication, kBuildNumber=kBuildNumber, mwgFTP=mwgFTP, stConnectedSockets=stConnectedSockets, notifyReasonString=notifyReasonString, PYSNMP_MODULE_ID=mwg, mwgHttps=mwgHttps, stResolveHostViaDNS=stResolveHostViaDNS, stCategoriesEntry=stCategoriesEntry, stBlockedByAntiMalware=stBlockedByAntiMalware, stTimeForTransaction=stTimeForTransaction, stFtpTraffic=stFtpTraffic, stCPULoad=stCPULoad, notifySeverity=notifySeverity, stFtpBytesFromClient=stFtpBytesFromClient, kCompanyName=kCompanyName, kProductName=kProductName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMimeType=stMimeType, notifyReason=notifyReason, stConnectionsBlocked=stConnectionsBlocked, stHttpsRequests=stHttpsRequests, stCategoryName=stCategoryName, stHttpBytesFromClient=stHttpBytesFromClient, stHandleConnectToServer=stHandleConnectToServer, kHotfixVersion=kHotfixVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, kMicroVersion=kMicroVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpTraffic=stHttpTraffic, stFtpBytesToClient=stFtpBytesToClient, stBlockedByURLFilter=stBlockedByURLFilter, stMalwareDetected=stMalwareDetected, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPUIOWait=stCPUIOWait, mwgContent=mwgContent, notifyAdditional=notifyAdditional, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesToServer=stFtpBytesToServer, mwgEngineVersions=mwgEngineVersions, notifyOriginName=notifyOriginName, pAMEngineVersion=pAMEngineVersion, kRevision=kRevision, stCPULoadRaw=stCPULoadRaw, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMemConsumed=stMemConsumed, pAMProactiveVersion=pAMProactiveVersion, notifyOrigin=notifyOrigin, trUser=trUser, pTSDBVersion=pTSDBVersion, stHttpBytesFromServer=stHttpBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesToClient=stHttpsBytesToClient, stClientCount=stClientCount, stBadReputation=stBadReputation, stHttpRequests=stHttpRequests, stHttpsBytesToServer=stHttpsBytesToServer, trSystem=trSystem, kMajorVersion=kMajorVersion, mwg=mwg, notifyAffectedHost=notifyAffectedHost, pMFEDATVersion=pMFEDATVersion, mwgTraps=mwgTraps, kProductVersion=kProductVersion, stHttpBytesToServer=stHttpBytesToServer, stConnectionsLegitimate=stConnectionsLegitimate, kCustomVersion=kCustomVersion, stFtpBytesFromServer=stFtpBytesFromServer, stCategoryCount=stCategoryCount, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategories=stCategories, stHttpBytesToClient=stHttpBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMinorVersion=kMinorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoriesTable=stCategoriesTable, mwgTrapVariables=mwgTrapVariables, pMFEEngineVersion=pMFEEngineVersion, mwgHttp=mwgHttp)
