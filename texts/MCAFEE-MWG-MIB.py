...
ObjectIdentity, mib_2, Bits, Gauge32, IpAddress, NotificationType, Integer32, ModuleIdentity, NotificationType, Counter64, TimeTicks, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, MibIdentifier, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "mib-2", "Bits", "Gauge32", "IpAddress", "NotificationType", "Integer32", "ModuleIdentity", "NotificationType", "Counter64", "TimeTicks", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "MibIdentifier", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyReasonString=notifyReasonString, stBlockedByURLFilter=stBlockedByURLFilter, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttp=mwgHttp, stCategoryName=stCategoryName, pMFEDATVersion=pMFEDATVersion, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesFromClient=stHttpBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgTrapVariables=mwgTrapVariables, notifySeverity=notifySeverity, mwgHttps=mwgHttps, mwgFTP=mwgFTP, kCustomVersion=kCustomVersion, pAMEngineVersion=pAMEngineVersion, stCategoryCount=stCategoryCount, stConnectedSockets=stConnectedSockets, mwgInfo=mwgInfo, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMajorVersion=kMajorVersion, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesToServer=stFtpBytesToServer, stHttpsRequests=stHttpsRequests, stResolveHostViaDNS=stResolveHostViaDNS, kMicroVersion=kMicroVersion, kProductName=kProductName, notifyOrigin=notifyOrigin, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stClientCount=stClientCount, mwg=mwg, notifyAffectedHost=notifyAffectedHost, stHttpsBytesToClient=stHttpsBytesToClient, pMFEEngineVersion=pMFEEngineVersion, kCompanyName=kCompanyName, stCPULoad=stCPULoad, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgTraps=mwgTraps, mwgStatistics=mwgStatistics, stFtpBytesToClient=stFtpBytesToClient, kMinorVersion=kMinorVersion, stCPUIOWait=stCPUIOWait, stHttpBytesFromServer=stHttpBytesFromServer, PYSNMP_MODULE_ID=mwg, stHttpRequests=stHttpRequests, trSystem=trSystem, stFtpBytesFromServer=stFtpBytesFromServer, notifyAdditional=notifyAdditional, stHttpsTraffic=stHttpsTraffic, notifyOriginName=notifyOriginName, stMalwareDetected=stMalwareDetected, stFtpTraffic=stFtpTraffic, stMemConsumed=stMemConsumed, stCategoriesEntry=stCategoriesEntry, mwgEngineVersions=mwgEngineVersions, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyReason=notifyReason, pAMProactiveVersion=pAMProactiveVersion, stHttpTraffic=stHttpTraffic, trApplication=trApplication, stHttpsBytesFromServer=stHttpsBytesFromServer, pTSDBVersion=pTSDBVersion, kHotfixVersion=kHotfixVersion, stHandleConnectToServer=stHandleConnectToServer, kProductVersion=kProductVersion, stBadReputation=stBadReputation, kBuildNumber=kBuildNumber, stHttpsBytesToServer=stHttpsBytesToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kRevision=kRevision, mwgContent=mwgContent, stHttpBytesToClient=stHttpBytesToClient, stCategoriesTable=stCategoriesTable, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMimeType=stMimeType, pAMSignatureVersion=pAMSignatureVersion, mwgMiscellaneous=mwgMiscellaneous, stConnectionsBlocked=stConnectionsBlocked, trUser=trUser, stCategories=stCategories, stTimeForTransaction=stTimeForTransaction, stCPULoadRaw=stCPULoadRaw)
