...
ModuleIdentity, IpAddress, Counter64, ObjectIdentity, Integer32, MibIdentifier, NotificationType, TimeTicks, Bits, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, Gauge32, NotificationType, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "Counter64", "ObjectIdentity", "Integer32", "MibIdentifier", "NotificationType", "TimeTicks", "Bits", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "Gauge32", "NotificationType", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByURLFilter=stBlockedByURLFilter, stHandleConnectToServer=stHandleConnectToServer, mwgHttps=mwgHttps, pTSDBVersion=pTSDBVersion, mwgTrapVariables=mwgTrapVariables, stConnectionsBlocked=stConnectionsBlocked, kCompanyName=kCompanyName, stTimeForTransaction=stTimeForTransaction, trUser=trUser, mwgEngineVersions=mwgEngineVersions, pAMEngineVersion=pAMEngineVersion, stHttpsBytesToClient=stHttpsBytesToClient, stHttpTraffic=stHttpTraffic, stCPULoadRaw=stCPULoadRaw, stCategoryCount=stCategoryCount, stClientCount=stClientCount, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectedSockets=stConnectedSockets, stHttpBytesFromServer=stHttpBytesFromServer, stHttpRequests=stHttpRequests, notifyOrigin=notifyOrigin, trApplication=trApplication, notifyAdditional=notifyAdditional, kProductVersion=kProductVersion, stHttpsBytesToServer=stHttpsBytesToServer, mwgInfo=mwgInfo, stHttpBytesToServer=stHttpBytesToServer, stHttpsRequests=stHttpsRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, stMimeType=stMimeType, stCPUIOWait=stCPUIOWait, pMFEEngineVersion=pMFEEngineVersion, stCategoriesTable=stCategoriesTable, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoryName=stCategoryName, stHttpBytesToClient=stHttpBytesToClient, mwgMiscellaneous=mwgMiscellaneous, mwgHttp=mwgHttp, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategories=stCategories, stMalwareDetected=stMalwareDetected, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByMediaFilter=stBlockedByMediaFilter, trSystem=trSystem, stCategoriesEntry=stCategoriesEntry, stFtpBytesToClient=stFtpBytesToClient, stMemConsumed=stMemConsumed, stHttpBytesFromClient=stHttpBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMajorVersion=kMajorVersion, mwg=mwg, mwgFTP=mwgFTP, kHotfixVersion=kHotfixVersion, kBuildNumber=kBuildNumber, pAMSignatureVersion=pAMSignatureVersion, stConnectionsLegitimate=stConnectionsLegitimate, notifyReason=notifyReason, stResolveHostViaDNS=stResolveHostViaDNS, kProductName=kProductName, mwgStatistics=mwgStatistics, stBadReputation=stBadReputation, stHttpsTraffic=stHttpsTraffic, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMinorVersion=kMinorVersion, notifySeverity=notifySeverity, notifyReasonString=notifyReasonString, notifyAffectedHost=notifyAffectedHost, kRevision=kRevision, PYSNMP_MODULE_ID=mwg, stFtpBytesFromClient=stFtpBytesFromClient, pMFEDATVersion=pMFEDATVersion, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesToServer=stFtpBytesToServer, kCustomVersion=kCustomVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMicroVersion=kMicroVersion, stFtpTraffic=stFtpTraffic, pAMProactiveVersion=pAMProactiveVersion, mwgTraps=mwgTraps, stCPULoad=stCPULoad, notifyOriginName=notifyOriginName, mwgContent=mwgContent)
