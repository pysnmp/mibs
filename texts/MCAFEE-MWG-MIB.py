...
Integer32, Gauge32, NotificationType, Counter32, Bits, ObjectIdentity, NotificationType, Unsigned32, ModuleIdentity, IpAddress, mib_2, Counter64, enterprises, MibIdentifier, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "NotificationType", "Counter32", "Bits", "ObjectIdentity", "NotificationType", "Unsigned32", "ModuleIdentity", "IpAddress", "mib-2", "Counter64", "enterprises", "MibIdentifier", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgTrapVariables=mwgTrapVariables, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpTraffic=stFtpTraffic, stCategoryName=stCategoryName, notifyOriginName=notifyOriginName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeForTransaction=stTimeForTransaction, stMimeType=stMimeType, stCategoriesEntry=stCategoriesEntry, stHttpRequests=stHttpRequests, mwgStatistics=mwgStatistics, mwgFTP=mwgFTP, pMFEDATVersion=pMFEDATVersion, kCustomVersion=kCustomVersion, mwgMiscellaneous=mwgMiscellaneous, trApplication=trApplication, trUser=trUser, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttps=mwgHttps, stBlockedByURLFilter=stBlockedByURLFilter, kProductVersion=kProductVersion, stCategories=stCategories, stFtpBytesToClient=stFtpBytesToClient, stHttpsTraffic=stHttpsTraffic, PYSNMP_MODULE_ID=mwg, notifySeverity=notifySeverity, mwgTraps=mwgTraps, stCategoriesTable=stCategoriesTable, stCategoryCount=stCategoryCount, pAMProactiveVersion=pAMProactiveVersion, kProductName=kProductName, stHttpsRequests=stHttpsRequests, mwgInfo=mwgInfo, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectedSockets=stConnectedSockets, stCPULoadRaw=stCPULoadRaw, kCompanyName=kCompanyName, mwgEngineVersions=mwgEngineVersions, mwg=mwg, stHttpBytesFromClient=stHttpBytesFromClient, notifyAffectedHost=notifyAffectedHost, pTSDBVersion=pTSDBVersion, stCPUIOWait=stCPUIOWait, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHandleConnectToServer=stHandleConnectToServer, kMinorVersion=kMinorVersion, stClientCount=stClientCount, stConnectionsBlocked=stConnectionsBlocked, mwgHttp=mwgHttp, kMajorVersion=kMajorVersion, kBuildNumber=kBuildNumber, stResolveHostViaDNS=stResolveHostViaDNS, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromServer=stHttpBytesFromServer, stHttpBytesToClient=stHttpBytesToClient, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesFromClient=stFtpBytesFromClient, stCPULoad=stCPULoad, stHttpTraffic=stHttpTraffic, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByAntiMalware=stBlockedByAntiMalware, stBadReputation=stBadReputation, notifyReason=notifyReason, stHttpsBytesToClient=stHttpsBytesToClient, pAMSignatureVersion=pAMSignatureVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesFromServer=stFtpBytesFromServer, stMalwareDetected=stMalwareDetected, notifyAdditional=notifyAdditional, kRevision=kRevision, mwgContent=mwgContent, kHotfixVersion=kHotfixVersion, kMicroVersion=kMicroVersion, notifyReasonString=notifyReasonString, stHttpsBytesFromServer=stHttpsBytesFromServer, stMemConsumed=stMemConsumed, trSystem=trSystem, stHttpBytesToServer=stHttpBytesToServer, notifyOrigin=notifyOrigin, stFtpBytesToServer=stFtpBytesToServer)
