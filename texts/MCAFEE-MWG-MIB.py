...
Counter64, Counter32, ModuleIdentity, IpAddress, ObjectIdentity, Unsigned32, mib_2, iso, Bits, TimeTicks, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, Integer32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Counter32", "ModuleIdentity", "IpAddress", "ObjectIdentity", "Unsigned32", "mib-2", "iso", "Bits", "TimeTicks", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "Integer32", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByMediaFilter=stBlockedByMediaFilter, kMajorVersion=kMajorVersion, stCPULoad=stCPULoad, stHttpBytesFromClient=stHttpBytesFromClient, mwgTrapVariables=mwgTrapVariables, notifyOrigin=notifyOrigin, kRevision=kRevision, stConnectionsBlocked=stConnectionsBlocked, stHttpTraffic=stHttpTraffic, notifySeverity=notifySeverity, kBuildNumber=kBuildNumber, stBadReputation=stBadReputation, mwgStatistics=mwgStatistics, notifyAdditional=notifyAdditional, trSystem=trSystem, kMicroVersion=kMicroVersion, stClientCount=stClientCount, stCategoryCount=stCategoryCount, kProductName=kProductName, stBlockedByURLFilter=stBlockedByURLFilter, trUser=trUser, stHttpsRequests=stHttpsRequests, stHttpBytesToServer=stHttpBytesToServer, mwgTraps=mwgTraps, mwgFTP=mwgFTP, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoriesTable=stCategoriesTable, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyReason=notifyReason, mwgInfo=mwgInfo, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesToClient=stFtpBytesToClient, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectedSockets=stConnectedSockets, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, PYSNMP_MODULE_ID=mwg, mwgEngineVersions=mwgEngineVersions, kProductVersion=kProductVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesToServer=stFtpBytesToServer, mwgMiscellaneous=mwgMiscellaneous, pMFEEngineVersion=pMFEEngineVersion, stCategoryName=stCategoryName, kMinorVersion=kMinorVersion, stFtpTraffic=stFtpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyOriginName=notifyOriginName, stTimeForTransaction=stTimeForTransaction, mwgHttp=mwgHttp, stCategoriesEntry=stCategoriesEntry, stResolveHostViaDNS=stResolveHostViaDNS, kCompanyName=kCompanyName, kHotfixVersion=kHotfixVersion, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMemConsumed=stMemConsumed, stCPULoadRaw=stCPULoadRaw, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pTSDBVersion=pTSDBVersion, stMimeType=stMimeType, mwgContent=mwgContent, stHttpBytesFromServer=stHttpBytesFromServer, stHttpRequests=stHttpRequests, stMalwareDetected=stMalwareDetected, mwgHttps=mwgHttps, trApplication=trApplication, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectionsLegitimate=stConnectionsLegitimate, pMFEDATVersion=pMFEDATVersion, stCPUIOWait=stCPUIOWait, mwg=mwg, pAMProactiveVersion=pAMProactiveVersion, stHandleConnectToServer=stHandleConnectToServer, notifyAffectedHost=notifyAffectedHost, stCategories=stCategories, stHttpsBytesToClient=stHttpsBytesToClient, kCustomVersion=kCustomVersion, notifyReasonString=notifyReasonString, stHttpsTraffic=stHttpsTraffic, pAMEngineVersion=pAMEngineVersion)
