...
MibIdentifier, TimeTicks, ModuleIdentity, Gauge32, iso, Counter64, Bits, NotificationType, mib_2, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, NotificationType, enterprises, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "ModuleIdentity", "Gauge32", "iso", "Counter64", "Bits", "NotificationType", "mib-2", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "NotificationType", "enterprises", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesFromClient=stHttpBytesFromClient, stCategoriesEntry=stCategoriesEntry, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kProductName=kProductName, notifySeverity=notifySeverity, kMicroVersion=kMicroVersion, mwgStatistics=mwgStatistics, stConnectionsBlocked=stConnectionsBlocked, stHandleConnectToServer=stHandleConnectToServer, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesToServer=stFtpBytesToServer, stCPUIOWait=stCPUIOWait, stHttpBytesFromServer=stHttpBytesFromServer, stCategoryCount=stCategoryCount, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttps=mwgHttps, stFtpTraffic=stFtpTraffic, stConnectionsLegitimate=stConnectionsLegitimate, notifyOriginName=notifyOriginName, stTimeForTransaction=stTimeForTransaction, PYSNMP_MODULE_ID=mwg, stBlockedByAntiMalware=stBlockedByAntiMalware, stCPULoadRaw=stCPULoadRaw, kMinorVersion=kMinorVersion, notifyReason=notifyReason, trSystem=trSystem, trApplication=trApplication, stHttpRequests=stHttpRequests, notifyReasonString=notifyReasonString, stHttpsBytesFromServer=stHttpsBytesFromServer, stMemConsumed=stMemConsumed, mwgTrapVariables=mwgTrapVariables, notifyAdditional=notifyAdditional, pAMProactiveVersion=pAMProactiveVersion, notifyAffectedHost=notifyAffectedHost, stHttpBytesToServer=stHttpBytesToServer, pMFEEngineVersion=pMFEEngineVersion, kRevision=kRevision, mwgEngineVersions=mwgEngineVersions, stConnectedSockets=stConnectedSockets, stHttpBytesToClient=stHttpBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stMimeType=stMimeType, stHttpsRequests=stHttpsRequests, pAMSignatureVersion=pAMSignatureVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kHotfixVersion=kHotfixVersion, mwgFTP=mwgFTP, mwgHttp=mwgHttp, stFtpBytesFromClient=stFtpBytesFromClient, pMFEDATVersion=pMFEDATVersion, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kProductVersion=kProductVersion, pTSDBVersion=pTSDBVersion, stHttpsTraffic=stHttpsTraffic, stFtpBytesToClient=stFtpBytesToClient, kBuildNumber=kBuildNumber, stFtpBytesFromServer=stFtpBytesFromServer, pAMEngineVersion=pAMEngineVersion, trUser=trUser, stHttpsBytesToClient=stHttpsBytesToClient, stCategoryName=stCategoryName, mwgInfo=mwgInfo, stCPULoad=stCPULoad, stHttpsBytesToServer=stHttpsBytesToServer, mwg=mwg, stCategoriesTable=stCategoriesTable, mwgTraps=mwgTraps, mwgContent=mwgContent, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stClientCount=stClientCount, stMalwareDetected=stMalwareDetected, stHttpTraffic=stHttpTraffic, stBadReputation=stBadReputation, kCompanyName=kCompanyName, kMajorVersion=kMajorVersion, notifyOrigin=notifyOrigin, stCategories=stCategories, kCustomVersion=kCustomVersion)
