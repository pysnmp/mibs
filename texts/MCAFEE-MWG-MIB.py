...
NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Integer32, enterprises, NotificationType, Bits, Counter32, Counter64, iso, MibIdentifier, Unsigned32, IpAddress, TimeTicks, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Integer32", "enterprises", "NotificationType", "Bits", "Counter32", "Counter64", "iso", "MibIdentifier", "Unsigned32", "IpAddress", "TimeTicks", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpTraffic=stHttpTraffic, stHttpsRequests=stHttpsRequests, pAMProactiveVersion=pAMProactiveVersion, kMicroVersion=kMicroVersion, stHttpBytesToClient=stHttpBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kBuildNumber=kBuildNumber, kCustomVersion=kCustomVersion, stConnectedSockets=stConnectedSockets, mwgTraps=mwgTraps, trApplication=trApplication, stHandleConnectToServer=stHandleConnectToServer, notifyReason=notifyReason, kHotfixVersion=kHotfixVersion, stConnectionsBlocked=stConnectionsBlocked, stFtpTraffic=stFtpTraffic, stBlockedByURLFilter=stBlockedByURLFilter, stCategoriesTable=stCategoriesTable, stMimeType=stMimeType, mwgEngineVersions=mwgEngineVersions, pAMSignatureVersion=pAMSignatureVersion, stCPULoadRaw=stCPULoadRaw, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsTraffic=stHttpsTraffic, stHttpBytesFromClient=stHttpBytesFromClient, PYSNMP_MODULE_ID=mwg, kProductName=kProductName, stFtpBytesFromClient=stFtpBytesFromClient, stMemConsumed=stMemConsumed, stCategoryName=stCategoryName, mwgHttp=mwgHttp, mwgMiscellaneous=mwgMiscellaneous, mwgTrapVariables=mwgTrapVariables, stCPUIOWait=stCPUIOWait, notifyOrigin=notifyOrigin, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesToServer=stHttpBytesToServer, trSystem=trSystem, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesToServer=stHttpsBytesToServer, notifyReasonString=notifyReasonString, pMFEEngineVersion=pMFEEngineVersion, pMFEDATVersion=pMFEDATVersion, trUser=trUser, stCategoryCount=stCategoryCount, kRevision=kRevision, mwgStatistics=mwgStatistics, stCategoriesEntry=stCategoriesEntry, notifySeverity=notifySeverity, kMajorVersion=kMajorVersion, stCPULoad=stCPULoad, stCategories=stCategories, mwg=mwg, stHttpRequests=stHttpRequests, pAMEngineVersion=pAMEngineVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesFromClient=stHttpsBytesFromClient, kCompanyName=kCompanyName, mwgHttps=mwgHttps, mwgInfo=mwgInfo, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kProductVersion=kProductVersion, stResolveHostViaDNS=stResolveHostViaDNS, stClientCount=stClientCount, stBadReputation=stBadReputation, notifyAdditional=notifyAdditional, stMalwareDetected=stMalwareDetected, mwgContent=mwgContent, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pTSDBVersion=pTSDBVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyAffectedHost=notifyAffectedHost, stFtpBytesToClient=stFtpBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyOriginName=notifyOriginName, stTimeForTransaction=stTimeForTransaction, kMinorVersion=kMinorVersion, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, mwgFTP=mwgFTP)
