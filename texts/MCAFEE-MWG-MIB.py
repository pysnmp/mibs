...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises, ObjectIdentity, IpAddress, Counter64, mib_2, NotificationType, NotificationType, iso, TimeTicks, Bits, Unsigned32, Gauge32, Counter32, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises", "ObjectIdentity", "IpAddress", "Counter64", "mib-2", "NotificationType", "NotificationType", "iso", "TimeTicks", "Bits", "Unsigned32", "Gauge32", "Counter32", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoryCount=stCategoryCount, stConnectionsLegitimate=stConnectionsLegitimate, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesFromClient=stHttpBytesFromClient, kCompanyName=kCompanyName, kBuildNumber=kBuildNumber, stBlockedByURLFilter=stBlockedByURLFilter, notifyOrigin=notifyOrigin, stCPULoad=stCPULoad, stBlockedByAntiMalware=stBlockedByAntiMalware, notifySeverity=notifySeverity, stHttpBytesToClient=stHttpBytesToClient, stFtpTraffic=stFtpTraffic, kRevision=kRevision, kProductName=kProductName, mwgHttps=mwgHttps, kMicroVersion=kMicroVersion, stMimeType=stMimeType, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgMiscellaneous=mwgMiscellaneous, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesToServer=stHttpsBytesToServer, mwg=mwg, stHttpsBytesToClient=stHttpsBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pTSDBVersion=pTSDBVersion, kHotfixVersion=kHotfixVersion, pAMProactiveVersion=pAMProactiveVersion, stCategoryName=stCategoryName, stCPULoadRaw=stCPULoadRaw, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHandleConnectToServer=stHandleConnectToServer, stConnectedSockets=stConnectedSockets, mwgInfo=mwgInfo, kCustomVersion=kCustomVersion, kMinorVersion=kMinorVersion, stHttpsRequests=stHttpsRequests, stCategoriesTable=stCategoriesTable, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsBlocked=stConnectionsBlocked, mwgStatistics=mwgStatistics, pMFEDATVersion=pMFEDATVersion, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyAffectedHost=notifyAffectedHost, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttp=mwgHttp, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsTraffic=stHttpsTraffic, mwgFTP=mwgFTP, kMajorVersion=kMajorVersion, stMemConsumed=stMemConsumed, pAMSignatureVersion=pAMSignatureVersion, stCategoriesEntry=stCategoriesEntry, notifyReasonString=notifyReasonString, stFtpBytesToServer=stFtpBytesToServer, notifyOriginName=notifyOriginName, mwgContent=mwgContent, stHttpBytesFromServer=stHttpBytesFromServer, notifyReason=notifyReason, trApplication=trApplication, pMFEEngineVersion=pMFEEngineVersion, stHttpTraffic=stHttpTraffic, stBadReputation=stBadReputation, pAMEngineVersion=pAMEngineVersion, trSystem=trSystem, mwgTraps=mwgTraps, mwgEngineVersions=mwgEngineVersions, stTimeForTransaction=stTimeForTransaction, PYSNMP_MODULE_ID=mwg, trUser=trUser, notifyAdditional=notifyAdditional, stClientCount=stClientCount, stMalwareDetected=stMalwareDetected, stHttpRequests=stHttpRequests, stCategories=stCategories, kProductVersion=kProductVersion, stCPUIOWait=stCPUIOWait, mwgTrapVariables=mwgTrapVariables, stFtpBytesToClient=stFtpBytesToClient)
