...
Unsigned32, mib_2, iso, Counter32, Gauge32, ObjectIdentity, Counter64, ModuleIdentity, NotificationType, Integer32, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, MibIdentifier, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "mib-2", "iso", "Counter32", "Gauge32", "ObjectIdentity", "Counter64", "ModuleIdentity", "NotificationType", "Integer32", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "MibIdentifier", "TimeTicks", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsTraffic=stHttpsTraffic, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, trSystem=trSystem, stResolveHostViaDNS=stResolveHostViaDNS, kBuildNumber=kBuildNumber, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kHotfixVersion=kHotfixVersion, kProductName=kProductName, mwgEngineVersions=mwgEngineVersions, stFtpBytesToClient=stFtpBytesToClient, mwgInfo=mwgInfo, mwgTraps=mwgTraps, trApplication=trApplication, stCPULoadRaw=stCPULoadRaw, stConnectedSockets=stConnectedSockets, stHttpsBytesFromClient=stHttpsBytesFromClient, stMalwareDetected=stMalwareDetected, trUser=trUser, kCompanyName=kCompanyName, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesToClient=stHttpsBytesToClient, kRevision=kRevision, stCategoriesTable=stCategoriesTable, kMinorVersion=kMinorVersion, pAMProactiveVersion=pAMProactiveVersion, stCategoriesEntry=stCategoriesEntry, stCategoryCount=stCategoryCount, pAMSignatureVersion=pAMSignatureVersion, kProductVersion=kProductVersion, notifyAdditional=notifyAdditional, notifyReasonString=notifyReasonString, stCPUIOWait=stCPUIOWait, mwgFTP=mwgFTP, pMFEDATVersion=pMFEDATVersion, notifyReason=notifyReason, mwg=mwg, stHttpRequests=stHttpRequests, notifySeverity=notifySeverity, mwgTrapVariables=mwgTrapVariables, stFtpBytesToServer=stFtpBytesToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgHttps=mwgHttps, stHttpBytesFromServer=stHttpBytesFromServer, stTimeForTransaction=stTimeForTransaction, stCategoryName=stCategoryName, kMajorVersion=kMajorVersion, stHttpTraffic=stHttpTraffic, stFtpBytesFromClient=stFtpBytesFromClient, stConnectionsBlocked=stConnectionsBlocked, kMicroVersion=kMicroVersion, PYSNMP_MODULE_ID=mwg, stBadReputation=stBadReputation, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgMiscellaneous=mwgMiscellaneous, stFtpTraffic=stFtpTraffic, notifyAffectedHost=notifyAffectedHost, stClientCount=stClientCount, stHttpsRequests=stHttpsRequests, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyOrigin=notifyOrigin, stCategories=stCategories, notifyOriginName=notifyOriginName, kCustomVersion=kCustomVersion, mwgContent=mwgContent, stBlockedByURLFilter=stBlockedByURLFilter, mwgStatistics=mwgStatistics, pAMEngineVersion=pAMEngineVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesToServer=stHttpsBytesToServer, stMimeType=stMimeType, stCPULoad=stCPULoad, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesFromServer=stFtpBytesFromServer, mwgHttp=mwgHttp, pTSDBVersion=pTSDBVersion, stHttpBytesToServer=stHttpBytesToServer, stHttpBytesToClient=stHttpBytesToClient, stConnectionsLegitimate=stConnectionsLegitimate, stMemConsumed=stMemConsumed, stHttpsBytesFromServer=stHttpsBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine)
