...
Integer32, IpAddress, Bits, NotificationType, Counter64, enterprises, TimeTicks, ModuleIdentity, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, ObjectIdentity, Counter32, mib_2, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "Bits", "NotificationType", "Counter64", "enterprises", "TimeTicks", "ModuleIdentity", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "ObjectIdentity", "Counter32", "mib-2", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stConnectionsLegitimate=stConnectionsLegitimate, pAMSignatureVersion=pAMSignatureVersion, mwgMiscellaneous=mwgMiscellaneous, stCategoryCount=stCategoryCount, kMicroVersion=kMicroVersion, mwgTraps=mwgTraps, stHttpBytesFromClient=stHttpBytesFromClient, kMajorVersion=kMajorVersion, stTimeForTransaction=stTimeForTransaction, pAMEngineVersion=pAMEngineVersion, stBadReputation=stBadReputation, mwgHttp=mwgHttp, stResolveHostViaDNS=stResolveHostViaDNS, stCPULoad=stCPULoad, notifyAffectedHost=notifyAffectedHost, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesToClient=stFtpBytesToClient, trUser=trUser, stFtpBytesFromServer=stFtpBytesFromServer, stCategoriesEntry=stCategoriesEntry, stCategoriesTable=stCategoriesTable, pAMProactiveVersion=pAMProactiveVersion, stCategories=stCategories, stHttpsBytesToClient=stHttpsBytesToClient, stCategoryName=stCategoryName, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesFromClient=stFtpBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kProductName=kProductName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgEngineVersions=mwgEngineVersions, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpTraffic=stFtpTraffic, pMFEEngineVersion=pMFEEngineVersion, stClientCount=stClientCount, stMemConsumed=stMemConsumed, mwgTrapVariables=mwgTrapVariables, kCustomVersion=kCustomVersion, notifyOriginName=notifyOriginName, mwgInfo=mwgInfo, kMinorVersion=kMinorVersion, stHttpsTraffic=stHttpsTraffic, mwgFTP=mwgFTP, notifyAdditional=notifyAdditional, stConnectionsBlocked=stConnectionsBlocked, stHttpTraffic=stHttpTraffic, notifySeverity=notifySeverity, mwgContent=mwgContent, stHttpBytesToClient=stHttpBytesToClient, PYSNMP_MODULE_ID=mwg, notifyOrigin=notifyOrigin, trApplication=trApplication, mwg=mwg, trSystem=trSystem, stBlockedByURLFilter=stBlockedByURLFilter, kHotfixVersion=kHotfixVersion, notifyReason=notifyReason, mwgHttps=mwgHttps, stHttpBytesFromServer=stHttpBytesFromServer, pMFEDATVersion=pMFEDATVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMimeType=stMimeType, stHttpRequests=stHttpRequests, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsRequests=stHttpsRequests, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgStatistics=mwgStatistics, stHttpBytesToServer=stHttpBytesToServer, kCompanyName=kCompanyName, kRevision=kRevision, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stCPUIOWait=stCPUIOWait, kBuildNumber=kBuildNumber, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectedSockets=stConnectedSockets, stFtpBytesToServer=stFtpBytesToServer, stMalwareDetected=stMalwareDetected, notifyReasonString=notifyReasonString, stCPULoadRaw=stCPULoadRaw, kProductVersion=kProductVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, pTSDBVersion=pTSDBVersion)
