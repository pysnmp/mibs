...
Counter64, mib_2, Integer32, iso, MibIdentifier, NotificationType, ObjectIdentity, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, Counter32, IpAddress, TimeTicks, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "mib-2", "Integer32", "iso", "MibIdentifier", "NotificationType", "ObjectIdentity", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "Counter32", "IpAddress", "TimeTicks", "Bits", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stConnectionsLegitimate=stConnectionsLegitimate, stCategoryCount=stCategoryCount, kMinorVersion=kMinorVersion, stHandleConnectToServer=stHandleConnectToServer, stMimeType=stMimeType, notifyAdditional=notifyAdditional, notifyReason=notifyReason, pAMEngineVersion=pAMEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, stConnectionsBlocked=stConnectionsBlocked, stCategoryName=stCategoryName, stBlockedByAntiMalware=stBlockedByAntiMalware, stMalwareDetected=stMalwareDetected, mwgInfo=mwgInfo, pAMProactiveVersion=pAMProactiveVersion, trApplication=trApplication, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesToClient=stHttpsBytesToClient, kCompanyName=kCompanyName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesToClient=stHttpBytesToClient, mwgFTP=mwgFTP, pTSDBVersion=pTSDBVersion, pMFEEngineVersion=pMFEEngineVersion, mwgStatistics=mwgStatistics, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwg=mwg, kProductName=kProductName, stHttpTraffic=stHttpTraffic, kProductVersion=kProductVersion, stHttpsBytesToServer=stHttpsBytesToServer, stCategoriesTable=stCategoriesTable, mwgTraps=mwgTraps, notifyAffectedHost=notifyAffectedHost, mwgContent=mwgContent, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesToServer=stFtpBytesToServer, stHttpsRequests=stHttpsRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyOriginName=notifyOriginName, stCPUIOWait=stCPUIOWait, stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesToServer=stHttpBytesToServer, stBadReputation=stBadReputation, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpRequests=stHttpRequests, kMicroVersion=kMicroVersion, stHttpsTraffic=stHttpsTraffic, notifyOrigin=notifyOrigin, trUser=trUser, mwgTrapVariables=mwgTrapVariables, stFtpTraffic=stFtpTraffic, stHttpBytesFromServer=stHttpBytesFromServer, kMajorVersion=kMajorVersion, mwgHttps=mwgHttps, stConnectedSockets=stConnectedSockets, trSystem=trSystem, stFtpBytesToClient=stFtpBytesToClient, pMFEDATVersion=pMFEDATVersion, PYSNMP_MODULE_ID=mwg, stHttpsBytesFromServer=stHttpsBytesFromServer, stTimeForTransaction=stTimeForTransaction, stCPULoadRaw=stCPULoadRaw, stCategories=stCategories, mwgEngineVersions=mwgEngineVersions, stCPULoad=stCPULoad, pAMSignatureVersion=pAMSignatureVersion, mwgMiscellaneous=mwgMiscellaneous, stMemConsumed=stMemConsumed, kHotfixVersion=kHotfixVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoriesEntry=stCategoriesEntry, kBuildNumber=kBuildNumber, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyReasonString=notifyReasonString, mwgHttp=mwgHttp, notifySeverity=notifySeverity, stHttpsBytesFromClient=stHttpsBytesFromClient, stClientCount=stClientCount, kCustomVersion=kCustomVersion, kRevision=kRevision)
