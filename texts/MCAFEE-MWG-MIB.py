...
enterprises, iso, mib_2, TimeTicks, NotificationType, Gauge32, Counter64, ObjectIdentity, ModuleIdentity, Counter32, NotificationType, Unsigned32, MibIdentifier, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "iso", "mib-2", "TimeTicks", "NotificationType", "Gauge32", "Counter64", "ObjectIdentity", "ModuleIdentity", "Counter32", "NotificationType", "Unsigned32", "MibIdentifier", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesFromClient=stFtpBytesFromClient, notifyOriginName=notifyOriginName, kProductName=kProductName, stBlockedByURLFilter=stBlockedByURLFilter, pTSDBVersion=pTSDBVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgTrapVariables=mwgTrapVariables, trSystem=trSystem, stMemConsumed=stMemConsumed, notifyOrigin=notifyOrigin, mwgHttp=mwgHttp, stHttpsTraffic=stHttpsTraffic, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMinorVersion=kMinorVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kBuildNumber=kBuildNumber, stHttpBytesFromClient=stHttpBytesFromClient, stBlockedByMediaFilter=stBlockedByMediaFilter, kCompanyName=kCompanyName, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stBadReputation=stBadReputation, kCustomVersion=kCustomVersion, stMalwareDetected=stMalwareDetected, pAMProactiveVersion=pAMProactiveVersion, stCategories=stCategories, stCategoriesEntry=stCategoriesEntry, stCategoryName=stCategoryName, kProductVersion=kProductVersion, stHandleConnectToServer=stHandleConnectToServer, notifyAffectedHost=notifyAffectedHost, stMimeType=stMimeType, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsRequests=stHttpsRequests, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttps=mwgHttps, notifyReason=notifyReason, stClientCount=stClientCount, trUser=trUser, stFtpBytesToClient=stFtpBytesToClient, stHttpRequests=stHttpRequests, notifySeverity=notifySeverity, mwg=mwg, mwgInfo=mwgInfo, stCPUIOWait=stCPUIOWait, stResolveHostViaDNS=stResolveHostViaDNS, mwgTraps=mwgTraps, stHttpsBytesToServer=stHttpsBytesToServer, kMicroVersion=kMicroVersion, stCPULoadRaw=stCPULoadRaw, mwgFTP=mwgFTP, stFtpBytesFromServer=stFtpBytesFromServer, notifyAdditional=notifyAdditional, mwgEngineVersions=mwgEngineVersions, stConnectedSockets=stConnectedSockets, stCategoryCount=stCategoryCount, pAMEngineVersion=pAMEngineVersion, mwgContent=mwgContent, notifyReasonString=notifyReasonString, stHttpBytesToServer=stHttpBytesToServer, stCategoriesTable=stCategoriesTable, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMSignatureVersion=pAMSignatureVersion, mwgStatistics=mwgStatistics, stTimeForTransaction=stTimeForTransaction, stFtpBytesToServer=stFtpBytesToServer, stFtpTraffic=stFtpTraffic, stCPULoad=stCPULoad, kMajorVersion=kMajorVersion, trApplication=trApplication, stHttpBytesToClient=stHttpBytesToClient, kHotfixVersion=kHotfixVersion, stHttpsBytesToClient=stHttpsBytesToClient, stConnectionsBlocked=stConnectionsBlocked, PYSNMP_MODULE_ID=mwg, pMFEDATVersion=pMFEDATVersion, kRevision=kRevision, stHttpTraffic=stHttpTraffic, mwgMiscellaneous=mwgMiscellaneous, pMFEEngineVersion=pMFEEngineVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient)
