...
Unsigned32, IpAddress, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, Counter64, NotificationType, TimeTicks, Counter32, MibIdentifier, ObjectIdentity, Bits, NotificationType, mib_2, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "Counter64", "NotificationType", "TimeTicks", "Counter32", "MibIdentifier", "ObjectIdentity", "Bits", "NotificationType", "mib-2", "Gauge32", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMProactiveVersion=pAMProactiveVersion, stCPULoadRaw=stCPULoadRaw, mwgInfo=mwgInfo, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyReasonString=notifyReasonString, kMajorVersion=kMajorVersion, stHttpBytesToServer=stHttpBytesToServer, stCategoriesTable=stCategoriesTable, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpTraffic=stFtpTraffic, stHttpRequests=stHttpRequests, mwgStatistics=mwgStatistics, notifySeverity=notifySeverity, pAMSignatureVersion=pAMSignatureVersion, kMicroVersion=kMicroVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoryName=stCategoryName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesToServer=stHttpsBytesToServer, mwgContent=mwgContent, stCPULoad=stCPULoad, mwg=mwg, stCategories=stCategories, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, mwgHttp=mwgHttp, pAMEngineVersion=pAMEngineVersion, kBuildNumber=kBuildNumber, notifyOrigin=notifyOrigin, mwgTraps=mwgTraps, mwgTrapVariables=mwgTrapVariables, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesToClient=stHttpBytesToClient, stBlockedByURLFilter=stBlockedByURLFilter, kProductName=kProductName, stBlockedByMediaFilter=stBlockedByMediaFilter, pMFEEngineVersion=pMFEEngineVersion, stMemConsumed=stMemConsumed, kProductVersion=kProductVersion, trApplication=trApplication, notifyReason=notifyReason, stMalwareDetected=stMalwareDetected, notifyOriginName=notifyOriginName, mwgHttps=mwgHttps, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHandleConnectToServer=stHandleConnectToServer, stMimeType=stMimeType, kCustomVersion=kCustomVersion, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesEntry=stCategoriesEntry, notifyAffectedHost=notifyAffectedHost, kMinorVersion=kMinorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsTraffic=stHttpsTraffic, stCPUIOWait=stCPUIOWait, mwgFTP=mwgFTP, trSystem=trSystem, stClientCount=stClientCount, pMFEDATVersion=pMFEDATVersion, stConnectionsBlocked=stConnectionsBlocked, stBadReputation=stBadReputation, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, stCategoryCount=stCategoryCount, mwgMiscellaneous=mwgMiscellaneous, kCompanyName=kCompanyName, kHotfixVersion=kHotfixVersion, stConnectedSockets=stConnectedSockets, stHttpBytesFromServer=stHttpBytesFromServer, mwgEngineVersions=mwgEngineVersions, kRevision=kRevision, pTSDBVersion=pTSDBVersion, notifyAdditional=notifyAdditional, PYSNMP_MODULE_ID=mwg, stHttpTraffic=stHttpTraffic, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsRequests=stHttpsRequests, stTimeForTransaction=stTimeForTransaction, stFtpBytesFromServer=stFtpBytesFromServer, trUser=trUser)
