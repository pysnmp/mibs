...
IpAddress, ObjectIdentity, Counter64, Gauge32, Unsigned32, Bits, enterprises, ModuleIdentity, TimeTicks, Counter32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, iso, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "Counter64", "Gauge32", "Unsigned32", "Bits", "enterprises", "ModuleIdentity", "TimeTicks", "Counter32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "iso", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoryCount=stCategoryCount, stConnectedSockets=stConnectedSockets, PYSNMP_MODULE_ID=mwg, stHttpsTraffic=stHttpsTraffic, stCategories=stCategories, mwgHttp=mwgHttp, trUser=trUser, stCategoriesTable=stCategoriesTable, stConnectionsLegitimate=stConnectionsLegitimate, stCPUIOWait=stCPUIOWait, mwgTraps=mwgTraps, mwg=mwg, kHotfixVersion=kHotfixVersion, pAMEngineVersion=pAMEngineVersion, stFtpBytesFromServer=stFtpBytesFromServer, mwgMiscellaneous=mwgMiscellaneous, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesToClient=stHttpsBytesToClient, kProductName=kProductName, pMFEEngineVersion=pMFEEngineVersion, mwgStatistics=mwgStatistics, kRevision=kRevision, stHttpsBytesFromServer=stHttpsBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgEngineVersions=mwgEngineVersions, stMalwareDetected=stMalwareDetected, notifyAffectedHost=notifyAffectedHost, notifyReason=notifyReason, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesToServer=stHttpBytesToServer, stBadReputation=stBadReputation, mwgContent=mwgContent, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesFromClient=stFtpBytesFromClient, stMimeType=stMimeType, stClientCount=stClientCount, kCustomVersion=kCustomVersion, stCategoriesEntry=stCategoriesEntry, stCPULoad=stCPULoad, stFtpBytesToClient=stFtpBytesToClient, notifySeverity=notifySeverity, mwgHttps=mwgHttps, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyAdditional=notifyAdditional, mwgInfo=mwgInfo, stHttpsRequests=stHttpsRequests, mwgTrapVariables=mwgTrapVariables, pMFEDATVersion=pMFEDATVersion, stHttpBytesFromClient=stHttpBytesFromClient, trApplication=trApplication, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpTraffic=stFtpTraffic, stHttpTraffic=stHttpTraffic, stHttpsBytesToServer=stHttpsBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, stTimeForTransaction=stTimeForTransaction, trSystem=trSystem, kCompanyName=kCompanyName, kMicroVersion=kMicroVersion, kProductVersion=kProductVersion, stCPULoadRaw=stCPULoadRaw, stCategoryName=stCategoryName, stFtpBytesToServer=stFtpBytesToServer, pTSDBVersion=pTSDBVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsBlocked=stConnectionsBlocked, stBlockedByAntiMalware=stBlockedByAntiMalware, kBuildNumber=kBuildNumber, notifyOrigin=notifyOrigin, stHttpBytesToClient=stHttpBytesToClient, kMajorVersion=kMajorVersion, stHttpBytesFromServer=stHttpBytesFromServer, notifyReasonString=notifyReasonString, stMemConsumed=stMemConsumed, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgFTP=mwgFTP, stHttpRequests=stHttpRequests, kMinorVersion=kMinorVersion, notifyOriginName=notifyOriginName)
