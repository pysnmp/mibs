...
MibIdentifier, Counter32, NotificationType, IpAddress, mib_2, Integer32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity, NotificationType, TimeTicks, ObjectIdentity, Gauge32, Bits, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter32", "NotificationType", "IpAddress", "mib-2", "Integer32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity", "NotificationType", "TimeTicks", "ObjectIdentity", "Gauge32", "Bits", "Counter64", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kRevision=kRevision, kBuildNumber=kBuildNumber, stTimeForTransaction=stTimeForTransaction, mwgTrapVariables=mwgTrapVariables, stFtpBytesToServer=stFtpBytesToServer, notifyReasonString=notifyReasonString, notifyAffectedHost=notifyAffectedHost, stCategoryName=stCategoryName, stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, kHotfixVersion=kHotfixVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpTraffic=stFtpTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMemConsumed=stMemConsumed, mwgContent=mwgContent, kProductName=kProductName, pAMProactiveVersion=pAMProactiveVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stMimeType=stMimeType, pAMEngineVersion=pAMEngineVersion, stFtpBytesToClient=stFtpBytesToClient, trApplication=trApplication, stCategoryCount=stCategoryCount, stBadReputation=stBadReputation, notifyAdditional=notifyAdditional, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpTraffic=stHttpTraffic, stHttpsBytesToServer=stHttpsBytesToServer, stHttpRequests=stHttpRequests, mwgFTP=mwgFTP, stCategoriesTable=stCategoriesTable, trSystem=trSystem, PYSNMP_MODULE_ID=mwg, pMFEDATVersion=pMFEDATVersion, mwgTraps=mwgTraps, mwgInfo=mwgInfo, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMajorVersion=kMajorVersion, kCompanyName=kCompanyName, kCustomVersion=kCustomVersion, stClientCount=stClientCount, stConnectionsBlocked=stConnectionsBlocked, pMFEEngineVersion=pMFEEngineVersion, stCategories=stCategories, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, stMalwareDetected=stMalwareDetected, trUser=trUser, stHttpsTraffic=stHttpsTraffic, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, mwgStatistics=mwgStatistics, stConnectedSockets=stConnectedSockets, mwgHttp=mwgHttp, stBlockedByMediaFilter=stBlockedByMediaFilter, kMinorVersion=kMinorVersion, stConnectionsLegitimate=stConnectionsLegitimate, pTSDBVersion=pTSDBVersion, notifyOriginName=notifyOriginName, stBlockedByURLFilter=stBlockedByURLFilter, kProductVersion=kProductVersion, kMicroVersion=kMicroVersion, stCategoriesEntry=stCategoriesEntry, mwgMiscellaneous=mwgMiscellaneous, pAMSignatureVersion=pAMSignatureVersion, notifySeverity=notifySeverity, mwg=mwg, stCPULoadRaw=stCPULoadRaw, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyReason=notifyReason, stHttpsBytesToClient=stHttpsBytesToClient, mwgHttps=mwgHttps, stHttpsRequests=stHttpsRequests, stCPULoad=stCPULoad, stHandleConnectToServer=stHandleConnectToServer, notifyOrigin=notifyOrigin, stResolveHostViaDNS=stResolveHostViaDNS, stCPUIOWait=stCPUIOWait, mwgEngineVersions=mwgEngineVersions)
