...
NotificationType, ModuleIdentity, TimeTicks, Counter32, ObjectIdentity, MibIdentifier, Integer32, Counter64, IpAddress, mib_2, enterprises, NotificationType, iso, Unsigned32, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "TimeTicks", "Counter32", "ObjectIdentity", "MibIdentifier", "Integer32", "Counter64", "IpAddress", "mib-2", "enterprises", "NotificationType", "iso", "Unsigned32", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBadReputation=stBadReputation, notifySeverity=notifySeverity, pTSDBVersion=pTSDBVersion, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesToServer=stFtpBytesToServer, kMicroVersion=kMicroVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stHandleConnectToServer=stHandleConnectToServer, stHttpsTraffic=stHttpsTraffic, PYSNMP_MODULE_ID=mwg, stTimeForTransaction=stTimeForTransaction, stHttpRequests=stHttpRequests, kMinorVersion=kMinorVersion, pAMProactiveVersion=pAMProactiveVersion, stConnectionsLegitimate=stConnectionsLegitimate, stCPULoadRaw=stCPULoadRaw, mwgEngineVersions=mwgEngineVersions, mwgTrapVariables=mwgTrapVariables, stConnectionsBlocked=stConnectionsBlocked, kProductVersion=kProductVersion, stHttpBytesToServer=stHttpBytesToServer, pAMSignatureVersion=pAMSignatureVersion, mwgInfo=mwgInfo, stConnectedSockets=stConnectedSockets, kRevision=kRevision, kMajorVersion=kMajorVersion, kCompanyName=kCompanyName, stFtpBytesToClient=stFtpBytesToClient, mwgHttps=mwgHttps, notifyOrigin=notifyOrigin, kHotfixVersion=kHotfixVersion, stMalwareDetected=stMalwareDetected, stCPULoad=stCPULoad, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesFromServer=stHttpsBytesFromServer, pMFEEngineVersion=pMFEEngineVersion, stFtpTraffic=stFtpTraffic, pAMEngineVersion=pAMEngineVersion, stCPUIOWait=stCPUIOWait, stCategoryCount=stCategoryCount, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trSystem=trSystem, kProductName=kProductName, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoryName=stCategoryName, trUser=trUser, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsBytesToServer=stHttpsBytesToServer, mwgStatistics=mwgStatistics, stMimeType=stMimeType, mwg=mwg, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pMFEDATVersion=pMFEDATVersion, stMemConsumed=stMemConsumed, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgHttp=mwgHttp, mwgFTP=mwgFTP, kBuildNumber=kBuildNumber, stCategories=stCategories, stHttpBytesToClient=stHttpBytesToClient, notifyAdditional=notifyAdditional, mwgTraps=mwgTraps, stClientCount=stClientCount, notifyAffectedHost=notifyAffectedHost, stHttpTraffic=stHttpTraffic, notifyOriginName=notifyOriginName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByURLFilter=stBlockedByURLFilter, notifyReasonString=notifyReasonString, stBlockedByAntiMalware=stBlockedByAntiMalware, kCustomVersion=kCustomVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesFromClient=stHttpBytesFromClient, notifyReason=notifyReason, mwgContent=mwgContent, stCategoriesTable=stCategoriesTable, trApplication=trApplication, stCategoriesEntry=stCategoriesEntry, stHttpsRequests=stHttpsRequests, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer)
