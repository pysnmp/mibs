...
TimeTicks, Bits, Integer32, NotificationType, Gauge32, ObjectIdentity, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, mib_2, MibIdentifier, NotificationType, IpAddress, enterprises, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "Integer32", "NotificationType", "Gauge32", "ObjectIdentity", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "mib-2", "MibIdentifier", "NotificationType", "IpAddress", "enterprises", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kProductVersion=kProductVersion, stBadReputation=stBadReputation, stConnectedSockets=stConnectedSockets, stFtpTraffic=stFtpTraffic, mwgHttps=mwgHttps, pTSDBVersion=pTSDBVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectionsBlocked=stConnectionsBlocked, stResolveHostViaDNS=stResolveHostViaDNS, stHttpRequests=stHttpRequests, PYSNMP_MODULE_ID=mwg, stBlockedByAntiMalware=stBlockedByAntiMalware, pMFEDATVersion=pMFEDATVersion, stHttpsTraffic=stHttpsTraffic, stBlockedByURLFilter=stBlockedByURLFilter, stMimeType=stMimeType, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kHotfixVersion=kHotfixVersion, stConnectionsLegitimate=stConnectionsLegitimate, kProductName=kProductName, kRevision=kRevision, stHttpBytesFromClient=stHttpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, mwgStatistics=mwgStatistics, stCPUIOWait=stCPUIOWait, notifyOriginName=notifyOriginName, mwgHttp=mwgHttp, notifyOrigin=notifyOrigin, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgEngineVersions=mwgEngineVersions, kMinorVersion=kMinorVersion, stHttpBytesToServer=stHttpBytesToServer, notifySeverity=notifySeverity, mwgTraps=mwgTraps, stCategoriesTable=stCategoriesTable, stFtpBytesToServer=stFtpBytesToServer, trSystem=trSystem, stBlockedByMediaFilter=stBlockedByMediaFilter, kMicroVersion=kMicroVersion, stFtpBytesFromServer=stFtpBytesFromServer, mwgTrapVariables=mwgTrapVariables, trApplication=trApplication, trUser=trUser, stCategoryCount=stCategoryCount, notifyReason=notifyReason, stMemConsumed=stMemConsumed, pAMSignatureVersion=pAMSignatureVersion, mwgContent=mwgContent, pAMEngineVersion=pAMEngineVersion, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgFTP=mwgFTP, pAMProactiveVersion=pAMProactiveVersion, stClientCount=stClientCount, stCPULoad=stCPULoad, mwg=mwg, mwgInfo=mwgInfo, kMajorVersion=kMajorVersion, stCategories=stCategories, stMalwareDetected=stMalwareDetected, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoriesEntry=stCategoriesEntry, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stTimeForTransaction=stTimeForTransaction, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesToServer=stHttpsBytesToServer, notifyAdditional=notifyAdditional, stHttpBytesToClient=stHttpBytesToClient, kBuildNumber=kBuildNumber, stCPULoadRaw=stCPULoadRaw, notifyAffectedHost=notifyAffectedHost, stHttpsRequests=stHttpsRequests, stHttpTraffic=stHttpTraffic, notifyReasonString=notifyReasonString, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, stCategoryName=stCategoryName, kCustomVersion=kCustomVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesToClient=stFtpBytesToClient, kCompanyName=kCompanyName)
