...
Integer32, Unsigned32, iso, Counter64, mib_2, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, Bits, ModuleIdentity, IpAddress, TimeTicks, enterprises, Gauge32, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "iso", "Counter64", "mib-2", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "Bits", "ModuleIdentity", "IpAddress", "TimeTicks", "enterprises", "Gauge32", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpRequests=stHttpRequests, trApplication=trApplication, stFtpBytesToServer=stFtpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, kCustomVersion=kCustomVersion, PYSNMP_MODULE_ID=mwg, mwgTraps=mwgTraps, mwgInfo=mwgInfo, stHttpsRequests=stHttpsRequests, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, kRevision=kRevision, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesToClient=stHttpsBytesToClient, kCompanyName=kCompanyName, mwgEngineVersions=mwgEngineVersions, pAMEngineVersion=pAMEngineVersion, stCPULoadRaw=stCPULoadRaw, mwgStatistics=mwgStatistics, stBlockedByURLFilter=stBlockedByURLFilter, stCPULoad=stCPULoad, stConnectedSockets=stConnectedSockets, stHandleConnectToServer=stHandleConnectToServer, mwg=mwg, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMajorVersion=kMajorVersion, stCPUIOWait=stCPUIOWait, kHotfixVersion=kHotfixVersion, pTSDBVersion=pTSDBVersion, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesToClient=stFtpBytesToClient, notifySeverity=notifySeverity, mwgHttps=mwgHttps, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoryName=stCategoryName, notifyOriginName=notifyOriginName, notifyReasonString=notifyReasonString, pMFEDATVersion=pMFEDATVersion, notifyOrigin=notifyOrigin, stMimeType=stMimeType, notifyAdditional=notifyAdditional, pMFEEngineVersion=pMFEEngineVersion, mwgContent=mwgContent, stHttpTraffic=stHttpTraffic, stHttpBytesFromServer=stHttpBytesFromServer, notifyAffectedHost=notifyAffectedHost, stHttpsTraffic=stHttpsTraffic, trSystem=trSystem, stTimeForTransaction=stTimeForTransaction, mwgFTP=mwgFTP, stResolveHostViaDNS=stResolveHostViaDNS, pAMSignatureVersion=pAMSignatureVersion, kBuildNumber=kBuildNumber, stFtpTraffic=stFtpTraffic, mwgTrapVariables=mwgTrapVariables, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesFromServer=stHttpsBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgHttp=mwgHttp, stCategoriesTable=stCategoriesTable, trUser=trUser, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesFromClient=stFtpBytesFromClient, notifyReason=notifyReason, stClientCount=stClientCount, mwgMiscellaneous=mwgMiscellaneous, stCategories=stCategories, stCategoryCount=stCategoryCount, stFtpBytesFromServer=stFtpBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, pAMProactiveVersion=pAMProactiveVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoriesEntry=stCategoriesEntry, stHttpBytesToClient=stHttpBytesToClient, kMicroVersion=kMicroVersion, kProductVersion=kProductVersion, stBadReputation=stBadReputation, stHttpBytesToServer=stHttpBytesToServer, stMemConsumed=stMemConsumed, kMinorVersion=kMinorVersion, kProductName=kProductName)
