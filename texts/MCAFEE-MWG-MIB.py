...
iso, Counter64, NotificationType, enterprises, MibIdentifier, Unsigned32, TimeTicks, Counter32, ObjectIdentity, IpAddress, NotificationType, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "NotificationType", "enterprises", "MibIdentifier", "Unsigned32", "TimeTicks", "Counter32", "ObjectIdentity", "IpAddress", "NotificationType", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgHttp=mwgHttp, stMimeType=stMimeType, stFtpBytesFromServer=stFtpBytesFromServer, kCustomVersion=kCustomVersion, stHttpTraffic=stHttpTraffic, stCPUIOWait=stCPUIOWait, kMicroVersion=kMicroVersion, stHttpsRequests=stHttpsRequests, mwgStatistics=mwgStatistics, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyOriginName=notifyOriginName, stClientCount=stClientCount, notifyAdditional=notifyAdditional, kMajorVersion=kMajorVersion, pMFEEngineVersion=pMFEEngineVersion, mwgTrapVariables=mwgTrapVariables, stHttpRequests=stHttpRequests, stBlockedByMediaFilter=stBlockedByMediaFilter, trApplication=trApplication, stFtpTraffic=stFtpTraffic, stHttpBytesFromClient=stHttpBytesFromClient, mwgEngineVersions=mwgEngineVersions, trSystem=trSystem, mwgTraps=mwgTraps, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, kBuildNumber=kBuildNumber, notifyReason=notifyReason, stCategoryName=stCategoryName, pMFEDATVersion=pMFEDATVersion, kCompanyName=kCompanyName, notifyOrigin=notifyOrigin, stHandleConnectToServer=stHandleConnectToServer, stTimeForTransaction=stTimeForTransaction, stCPULoadRaw=stCPULoadRaw, notifyAffectedHost=notifyAffectedHost, pAMEngineVersion=pAMEngineVersion, kHotfixVersion=kHotfixVersion, trUser=trUser, kRevision=kRevision, pAMProactiveVersion=pAMProactiveVersion, stMemConsumed=stMemConsumed, mwgInfo=mwgInfo, PYSNMP_MODULE_ID=mwg, mwgMiscellaneous=mwgMiscellaneous, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesToServer=stHttpsBytesToServer, stMalwareDetected=stMalwareDetected, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, mwg=mwg, stHttpBytesToServer=stHttpBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesFromServer=stHttpsBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoriesTable=stCategoriesTable, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stConnectedSockets=stConnectedSockets, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCPULoad=stCPULoad, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesToClient=stFtpBytesToClient, stConnectionsLegitimate=stConnectionsLegitimate, stCategoryCount=stCategoryCount, kMinorVersion=kMinorVersion, stHttpsBytesToClient=stHttpsBytesToClient, stCategories=stCategories, stBadReputation=stBadReputation, notifyReasonString=notifyReasonString, stHttpsTraffic=stHttpsTraffic, mwgContent=mwgContent, notifySeverity=notifySeverity, stHttpBytesToClient=stHttpBytesToClient, kProductName=kProductName, pTSDBVersion=pTSDBVersion, stFtpBytesToServer=stFtpBytesToServer, stBlockedByURLFilter=stBlockedByURLFilter, stCategoriesEntry=stCategoriesEntry, kProductVersion=kProductVersion, mwgFTP=mwgFTP, mwgHttps=mwgHttps)
