...
ModuleIdentity, iso, Bits, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, NotificationType, TimeTicks, MibIdentifier, Unsigned32, mib_2, enterprises, Counter64, IpAddress, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "Bits", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "NotificationType", "TimeTicks", "MibIdentifier", "Unsigned32", "mib-2", "enterprises", "Counter64", "IpAddress", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgHttps=mwgHttps, notifyAdditional=notifyAdditional, stFtpBytesFromClient=stFtpBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMinorVersion=kMinorVersion, kProductVersion=kProductVersion, pAMProactiveVersion=pAMProactiveVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyReasonString=notifyReasonString, notifyAffectedHost=notifyAffectedHost, mwg=mwg, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, mwgInfo=mwgInfo, stCategoriesTable=stCategoriesTable, stCategoriesEntry=stCategoriesEntry, stFtpBytesFromServer=stFtpBytesFromServer, kMicroVersion=kMicroVersion, mwgContent=mwgContent, stMemConsumed=stMemConsumed, trApplication=trApplication, notifySeverity=notifySeverity, stFtpBytesToServer=stFtpBytesToServer, kBuildNumber=kBuildNumber, stHttpsBytesToClient=stHttpsBytesToClient, trUser=trUser, mwgTraps=mwgTraps, kProductName=kProductName, stHttpsTraffic=stHttpsTraffic, kRevision=kRevision, stHttpTraffic=stHttpTraffic, stCategoryCount=stCategoryCount, stHttpsRequests=stHttpsRequests, stBlockedByURLFilter=stBlockedByURLFilter, stCPULoad=stCPULoad, stTimeForTransaction=stTimeForTransaction, stMimeType=stMimeType, stClientCount=stClientCount, notifyOrigin=notifyOrigin, stConnectedSockets=stConnectedSockets, stBadReputation=stBadReputation, kHotfixVersion=kHotfixVersion, stConnectionsBlocked=stConnectionsBlocked, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pMFEDATVersion=pMFEDATVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpBytesToServer=stHttpBytesToServer, mwgHttp=mwgHttp, PYSNMP_MODULE_ID=mwg, stHttpsBytesFromClient=stHttpsBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, notifyOriginName=notifyOriginName, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoryName=stCategoryName, stHandleConnectToServer=stHandleConnectToServer, mwgTrapVariables=mwgTrapVariables, stCPUIOWait=stCPUIOWait, stMalwareDetected=stMalwareDetected, pAMEngineVersion=pAMEngineVersion, stConnectionsLegitimate=stConnectionsLegitimate, kCompanyName=kCompanyName, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, kMajorVersion=kMajorVersion, mwgStatistics=mwgStatistics, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgEngineVersions=mwgEngineVersions, notifyReason=notifyReason, pAMSignatureVersion=pAMSignatureVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategories=stCategories, trSystem=trSystem, stHttpRequests=stHttpRequests, stResolveHostViaDNS=stResolveHostViaDNS, stCPULoadRaw=stCPULoadRaw, kCustomVersion=kCustomVersion, stFtpTraffic=stFtpTraffic, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesToClient=stFtpBytesToClient, pTSDBVersion=pTSDBVersion, mwgMiscellaneous=mwgMiscellaneous, mwgFTP=mwgFTP)
