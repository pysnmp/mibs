...
NotificationType, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, Counter32, IpAddress, TimeTicks, Unsigned32, mib_2, ModuleIdentity, iso, MibIdentifier, enterprises, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "Counter32", "IpAddress", "TimeTicks", "Unsigned32", "mib-2", "ModuleIdentity", "iso", "MibIdentifier", "enterprises", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", trSystem=trSystem, pTSDBVersion=pTSDBVersion, stResolveHostViaDNS=stResolveHostViaDNS, kMinorVersion=kMinorVersion, stHttpBytesToServer=stHttpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttp=mwgHttp, stFtpBytesFromClient=stFtpBytesFromClient, kProductName=kProductName, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMProactiveVersion=pAMProactiveVersion, stMimeType=stMimeType, stFtpBytesToServer=stFtpBytesToServer, notifyAdditional=notifyAdditional, mwg=mwg, pAMSignatureVersion=pAMSignatureVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpTraffic=stHttpTraffic, kMajorVersion=kMajorVersion, notifyReason=notifyReason, stCategoriesEntry=stCategoriesEntry, PYSNMP_MODULE_ID=mwg, trApplication=trApplication, stHttpRequests=stHttpRequests, mwgStatistics=mwgStatistics, stHttpsRequests=stHttpsRequests, kCustomVersion=kCustomVersion, stTimeForTransaction=stTimeForTransaction, mwgTraps=mwgTraps, mwgInfo=mwgInfo, trUser=trUser, stConnectedSockets=stConnectedSockets, kHotfixVersion=kHotfixVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stCPUIOWait=stCPUIOWait, stFtpBytesToClient=stFtpBytesToClient, mwgTrapVariables=mwgTrapVariables, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesToClient=stHttpBytesToClient, stBadReputation=stBadReputation, kMicroVersion=kMicroVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyReasonString=notifyReasonString, pAMEngineVersion=pAMEngineVersion, kCompanyName=kCompanyName, mwgEngineVersions=mwgEngineVersions, stMemConsumed=stMemConsumed, stHttpsBytesToClient=stHttpsBytesToClient, kProductVersion=kProductVersion, notifyOrigin=notifyOrigin, stMalwareDetected=stMalwareDetected, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesFromServer=stHttpBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, stConnectionsLegitimate=stConnectionsLegitimate, stFtpTraffic=stFtpTraffic, notifySeverity=notifySeverity, notifyAffectedHost=notifyAffectedHost, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoryCount=stCategoryCount, kBuildNumber=kBuildNumber, stCategoryName=stCategoryName, mwgContent=mwgContent, pMFEDATVersion=pMFEDATVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsTraffic=stHttpsTraffic, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategories=stCategories, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyOriginName=notifyOriginName, stCPULoad=stCPULoad, stConnectionsBlocked=stConnectionsBlocked, stClientCount=stClientCount, stCPULoadRaw=stCPULoadRaw, mwgHttps=mwgHttps, kRevision=kRevision, mwgFTP=mwgFTP, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoriesTable=stCategoriesTable)
