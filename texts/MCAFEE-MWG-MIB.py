...
Counter64, Counter32, Bits, ObjectIdentity, iso, NotificationType, ModuleIdentity, TimeTicks, Integer32, mib_2, MibIdentifier, enterprises, Gauge32, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Counter32", "Bits", "ObjectIdentity", "iso", "NotificationType", "ModuleIdentity", "TimeTicks", "Integer32", "mib-2", "MibIdentifier", "enterprises", "Gauge32", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesToServer=stFtpBytesToServer, notifySeverity=notifySeverity, pAMSignatureVersion=pAMSignatureVersion, stFtpTraffic=stFtpTraffic, trSystem=trSystem, kBuildNumber=kBuildNumber, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesToClient=stFtpBytesToClient, notifyAdditional=notifyAdditional, kProductName=kProductName, stBadReputation=stBadReputation, stHttpsBytesToClient=stHttpsBytesToClient, stMimeType=stMimeType, mwgHttp=mwgHttp, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoryName=stCategoryName, stCategoryCount=stCategoryCount, pTSDBVersion=pTSDBVersion, stMemConsumed=stMemConsumed, stHttpsBytesFromClient=stHttpsBytesFromClient, stClientCount=stClientCount, kCustomVersion=kCustomVersion, kMicroVersion=kMicroVersion, stHttpRequests=stHttpRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, kProductVersion=kProductVersion, stHttpsTraffic=stHttpsTraffic, stConnectionsLegitimate=stConnectionsLegitimate, notifyReason=notifyReason, notifyAffectedHost=notifyAffectedHost, mwgContent=mwgContent, stCPULoad=stCPULoad, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesToServer=stHttpBytesToServer, stHttpsRequests=stHttpsRequests, PYSNMP_MODULE_ID=mwg, notifyOriginName=notifyOriginName, kMinorVersion=kMinorVersion, stConnectionsBlocked=stConnectionsBlocked, pMFEDATVersion=pMFEDATVersion, pAMEngineVersion=pAMEngineVersion, mwgInfo=mwgInfo, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, trUser=trUser, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, notifyOrigin=notifyOrigin, kHotfixVersion=kHotfixVersion, stCategoriesTable=stCategoriesTable, mwgHttps=mwgHttps, stConnectedSockets=stConnectedSockets, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgTrapVariables=mwgTrapVariables, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesFromServer=stHttpBytesFromServer, stCPUIOWait=stCPUIOWait, mwgEngineVersions=mwgEngineVersions, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpBytesFromServer=stFtpBytesFromServer, stCPULoadRaw=stCPULoadRaw, mwgTraps=mwgTraps, stBlockedByAntiMalware=stBlockedByAntiMalware, stHandleConnectToServer=stHandleConnectToServer, kCompanyName=kCompanyName, kMajorVersion=kMajorVersion, mwgMiscellaneous=mwgMiscellaneous, mwgFTP=mwgFTP, stCategories=stCategories, stMalwareDetected=stMalwareDetected, kRevision=kRevision, stHttpBytesToClient=stHttpBytesToClient, trApplication=trApplication, stHttpTraffic=stHttpTraffic, pAMProactiveVersion=pAMProactiveVersion, mwgStatistics=mwgStatistics, stTimeForTransaction=stTimeForTransaction, stCategoriesEntry=stCategoriesEntry, stHttpsBytesToServer=stHttpsBytesToServer, mwg=mwg, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, notifyReasonString=notifyReasonString)
