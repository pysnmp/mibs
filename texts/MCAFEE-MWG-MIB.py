...
MibIdentifier, NotificationType, enterprises, Counter32, Counter64, IpAddress, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Bits, iso, ModuleIdentity, Gauge32, TimeTicks, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "enterprises", "Counter32", "Counter64", "IpAddress", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Bits", "iso", "ModuleIdentity", "Gauge32", "TimeTicks", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesToClient=stFtpBytesToClient, stMimeType=stMimeType, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesToServer=stFtpBytesToServer, kProductVersion=kProductVersion, kHotfixVersion=kHotfixVersion, stMalwareDetected=stMalwareDetected, notifyAffectedHost=notifyAffectedHost, stFtpBytesFromServer=stFtpBytesFromServer, notifyAdditional=notifyAdditional, notifyOrigin=notifyOrigin, stBadReputation=stBadReputation, stConnectionsBlocked=stConnectionsBlocked, pAMEngineVersion=pAMEngineVersion, stConnectionsLegitimate=stConnectionsLegitimate, kMinorVersion=kMinorVersion, stCategoriesTable=stCategoriesTable, notifyReason=notifyReason, kRevision=kRevision, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgEngineVersions=mwgEngineVersions, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMicroVersion=kMicroVersion, kCompanyName=kCompanyName, mwgContent=mwgContent, kBuildNumber=kBuildNumber, mwgFTP=mwgFTP, trApplication=trApplication, notifyReasonString=notifyReasonString, stTimeForTransaction=stTimeForTransaction, stConnectedSockets=stConnectedSockets, stHttpBytesToClient=stHttpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, kCustomVersion=kCustomVersion, stCategoriesEntry=stCategoriesEntry, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpTraffic=stHttpTraffic, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, pTSDBVersion=pTSDBVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpTraffic=stFtpTraffic, stMemConsumed=stMemConsumed, mwgMiscellaneous=mwgMiscellaneous, stClientCount=stClientCount, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoryCount=stCategoryCount, pAMSignatureVersion=pAMSignatureVersion, stCPULoadRaw=stCPULoadRaw, pMFEDATVersion=pMFEDATVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoryName=stCategoryName, stBlockedByURLFilter=stBlockedByURLFilter, stCPULoad=stCPULoad, mwgTraps=mwgTraps, kMajorVersion=kMajorVersion, stHandleConnectToServer=stHandleConnectToServer, mwgStatistics=mwgStatistics, pAMProactiveVersion=pAMProactiveVersion, trSystem=trSystem, trUser=trUser, mwgHttps=mwgHttps, notifySeverity=notifySeverity, stHttpBytesToServer=stHttpBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, mwg=mwg, stHttpsTraffic=stHttpsTraffic, mwgInfo=mwgInfo, stCategories=stCategories, stCPUIOWait=stCPUIOWait, mwgHttp=mwgHttp, stHttpRequests=stHttpRequests, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsRequests=stHttpsRequests, kProductName=kProductName, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgTrapVariables=mwgTrapVariables, stHttpBytesFromServer=stHttpBytesFromServer, PYSNMP_MODULE_ID=mwg, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyOriginName=notifyOriginName)
