...
ModuleIdentity, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, mib_2, enterprises, Gauge32, NotificationType, Bits, iso, IpAddress, MibIdentifier, TimeTicks, Counter64, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "mib-2", "enterprises", "Gauge32", "NotificationType", "Bits", "iso", "IpAddress", "MibIdentifier", "TimeTicks", "Counter64", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMicroVersion=kMicroVersion, kRevision=kRevision, notifyReasonString=notifyReasonString, stConnectedSockets=stConnectedSockets, stCategories=stCategories, stCategoryCount=stCategoryCount, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsRequests=stHttpsRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBadReputation=stBadReputation, notifyOriginName=notifyOriginName, stFtpBytesToClient=stFtpBytesToClient, mwgEngineVersions=mwgEngineVersions, stHttpBytesFromClient=stHttpBytesFromClient, mwgStatistics=mwgStatistics, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoriesTable=stCategoriesTable, stHttpsTraffic=stHttpsTraffic, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgTrapVariables=mwgTrapVariables, kMinorVersion=kMinorVersion, mwgTraps=mwgTraps, mwgFTP=mwgFTP, pTSDBVersion=pTSDBVersion, stHttpRequests=stHttpRequests, stConnectionsLegitimate=stConnectionsLegitimate, pMFEEngineVersion=pMFEEngineVersion, kProductVersion=kProductVersion, trApplication=trApplication, kCompanyName=kCompanyName, kProductName=kProductName, kCustomVersion=kCustomVersion, stResolveHostViaDNS=stResolveHostViaDNS, notifyAffectedHost=notifyAffectedHost, stMemConsumed=stMemConsumed, PYSNMP_MODULE_ID=mwg, stCPULoadRaw=stCPULoadRaw, stHttpTraffic=stHttpTraffic, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, notifyAdditional=notifyAdditional, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoad=stCPULoad, stTimeForTransaction=stTimeForTransaction, stHttpsBytesToServer=stHttpsBytesToServer, kMajorVersion=kMajorVersion, trUser=trUser, mwgHttps=mwgHttps, kBuildNumber=kBuildNumber, mwgMiscellaneous=mwgMiscellaneous, trSystem=trSystem, pAMSignatureVersion=pAMSignatureVersion, mwgInfo=mwgInfo, stHttpBytesToClient=stHttpBytesToClient, stConnectionsBlocked=stConnectionsBlocked, mwgHttp=mwgHttp, stFtpTraffic=stFtpTraffic, stFtpBytesFromClient=stFtpBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, notifySeverity=notifySeverity, stFtpBytesFromServer=stFtpBytesFromServer, mwg=mwg, stMalwareDetected=stMalwareDetected, stMimeType=stMimeType, notifyOrigin=notifyOrigin, stHttpsBytesFromServer=stHttpsBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stClientCount=stClientCount, stCategoriesEntry=stCategoriesEntry, stHandleConnectToServer=stHandleConnectToServer, mwgContent=mwgContent, pMFEDATVersion=pMFEDATVersion, pAMEngineVersion=pAMEngineVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyReason=notifyReason, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesToServer=stHttpBytesToServer, kHotfixVersion=kHotfixVersion, stCPUIOWait=stCPUIOWait, stCategoryName=stCategoryName)
