...
ModuleIdentity, Integer32, Unsigned32, iso, mib_2, Counter64, Bits, Counter32, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, ObjectIdentity, TimeTicks, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Unsigned32", "iso", "mib-2", "Counter64", "Bits", "Counter32", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "ObjectIdentity", "TimeTicks", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsRequests=stHttpsRequests, pAMProactiveVersion=pAMProactiveVersion, trUser=trUser, PYSNMP_MODULE_ID=mwg, stBlockedByURLFilter=stBlockedByURLFilter, stTimeForTransaction=stTimeForTransaction, stBlockedByAntiMalware=stBlockedByAntiMalware, stCPULoad=stCPULoad, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kCompanyName=kCompanyName, stClientCount=stClientCount, mwgEngineVersions=mwgEngineVersions, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMajorVersion=kMajorVersion, kRevision=kRevision, kMinorVersion=kMinorVersion, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, notifySeverity=notifySeverity, stFtpBytesToServer=stFtpBytesToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgHttps=mwgHttps, pMFEDATVersion=pMFEDATVersion, stFtpTraffic=stFtpTraffic, pTSDBVersion=pTSDBVersion, notifyReasonString=notifyReasonString, kCustomVersion=kCustomVersion, stFtpBytesFromServer=stFtpBytesFromServer, stMemConsumed=stMemConsumed, kBuildNumber=kBuildNumber, stCategoriesEntry=stCategoriesEntry, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsTraffic=stHttpsTraffic, kMicroVersion=kMicroVersion, mwgHttp=mwgHttp, stCPUIOWait=stCPUIOWait, kProductVersion=kProductVersion, kHotfixVersion=kHotfixVersion, stFtpBytesFromClient=stFtpBytesFromClient, notifyAdditional=notifyAdditional, stCategoriesTable=stCategoriesTable, mwgTraps=mwgTraps, stCPULoadRaw=stCPULoadRaw, stHttpBytesFromServer=stHttpBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, stHttpRequests=stHttpRequests, stHttpsBytesToServer=stHttpsBytesToServer, trSystem=trSystem, trApplication=trApplication, mwgStatistics=mwgStatistics, mwg=mwg, stHttpsBytesToClient=stHttpsBytesToClient, stHandleConnectToServer=stHandleConnectToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stConnectedSockets=stConnectedSockets, stHttpTraffic=stHttpTraffic, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgMiscellaneous=mwgMiscellaneous, stMalwareDetected=stMalwareDetected, mwgTrapVariables=mwgTrapVariables, stConnectionsLegitimate=stConnectionsLegitimate, notifyAffectedHost=notifyAffectedHost, kProductName=kProductName, stBadReputation=stBadReputation, mwgInfo=mwgInfo, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesToServer=stHttpBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, pAMEngineVersion=pAMEngineVersion, stMimeType=stMimeType, mwgContent=mwgContent, stResolveHostViaDNS=stResolveHostViaDNS, notifyReason=notifyReason, notifyOrigin=notifyOrigin, notifyOriginName=notifyOriginName, stCategoryName=stCategoryName, stCategories=stCategories, stCategoryCount=stCategoryCount, stHttpBytesToClient=stHttpBytesToClient, mwgFTP=mwgFTP, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient)
