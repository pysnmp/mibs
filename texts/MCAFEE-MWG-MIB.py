...
Unsigned32, ModuleIdentity, Integer32, NotificationType, ObjectIdentity, mib_2, enterprises, NotificationType, IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, iso, Gauge32, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "Integer32", "NotificationType", "ObjectIdentity", "mib-2", "enterprises", "NotificationType", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "iso", "Gauge32", "Counter32", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpTraffic=stHttpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectedSockets=stConnectedSockets, stHttpsRequests=stHttpsRequests, mwgStatistics=mwgStatistics, pTSDBVersion=pTSDBVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoriesEntry=stCategoriesEntry, mwgHttps=mwgHttps, notifyAdditional=notifyAdditional, stMimeType=stMimeType, stFtpBytesFromClient=stFtpBytesFromClient, stHttpRequests=stHttpRequests, kBuildNumber=kBuildNumber, stHttpBytesToServer=stHttpBytesToServer, stFtpTraffic=stFtpTraffic, stCPULoad=stCPULoad, notifySeverity=notifySeverity, mwgTraps=mwgTraps, kMinorVersion=kMinorVersion, pAMEngineVersion=pAMEngineVersion, stConnectionsLegitimate=stConnectionsLegitimate, kCompanyName=kCompanyName, stTimeForTransaction=stTimeForTransaction, pMFEEngineVersion=pMFEEngineVersion, stHttpsTraffic=stHttpsTraffic, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, stMalwareDetected=stMalwareDetected, trUser=trUser, pAMProactiveVersion=pAMProactiveVersion, stCategoriesTable=stCategoriesTable, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyOriginName=notifyOriginName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, kProductName=kProductName, kHotfixVersion=kHotfixVersion, notifyReasonString=notifyReasonString, mwgContent=mwgContent, stResolveHostViaDNS=stResolveHostViaDNS, kMajorVersion=kMajorVersion, PYSNMP_MODULE_ID=mwg, stFtpBytesToServer=stFtpBytesToServer, stCategoryCount=stCategoryCount, stMemConsumed=stMemConsumed, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBadReputation=stBadReputation, mwgTrapVariables=mwgTrapVariables, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgHttp=mwgHttp, stConnectionsBlocked=stConnectionsBlocked, stBlockedByMediaFilter=stBlockedByMediaFilter, stCPUIOWait=stCPUIOWait, stCPULoadRaw=stCPULoadRaw, kCustomVersion=kCustomVersion, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesToClient=stHttpsBytesToClient, stClientCount=stClientCount, trApplication=trApplication, mwgFTP=mwgFTP, trSystem=trSystem, kRevision=kRevision, notifyOrigin=notifyOrigin, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgEngineVersions=mwgEngineVersions, stCategoryName=stCategoryName, stCategories=stCategories, stHandleConnectToServer=stHandleConnectToServer, mwgInfo=mwgInfo, stHttpBytesFromClient=stHttpBytesFromClient, pMFEDATVersion=pMFEDATVersion, kProductVersion=kProductVersion, pAMSignatureVersion=pAMSignatureVersion, mwg=mwg, stHttpBytesFromServer=stHttpBytesFromServer, notifyReason=notifyReason, kMicroVersion=kMicroVersion, notifyAffectedHost=notifyAffectedHost)
