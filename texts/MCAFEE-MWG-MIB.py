...
ObjectIdentity, ModuleIdentity, Integer32, Counter32, Bits, MibIdentifier, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, Gauge32, NotificationType, NotificationType, Counter64, Unsigned32, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Integer32", "Counter32", "Bits", "MibIdentifier", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "Gauge32", "NotificationType", "NotificationType", "Counter64", "Unsigned32", "IpAddress", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesToClient=stHttpsBytesToClient, pMFEDATVersion=pMFEDATVersion, mwgStatistics=mwgStatistics, pMFEEngineVersion=pMFEEngineVersion, notifyReasonString=notifyReasonString, notifyAffectedHost=notifyAffectedHost, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMinorVersion=kMinorVersion, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesToServer=stHttpBytesToServer, mwgEngineVersions=mwgEngineVersions, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, stConnectedSockets=stConnectedSockets, notifyReason=notifyReason, mwgHttps=mwgHttps, kHotfixVersion=kHotfixVersion, stMalwareDetected=stMalwareDetected, stCategoryName=stCategoryName, kProductName=kProductName, notifySeverity=notifySeverity, kProductVersion=kProductVersion, stTimeForTransaction=stTimeForTransaction, stHttpBytesToClient=stHttpBytesToClient, stCategoriesTable=stCategoriesTable, stHttpsBytesToServer=stHttpsBytesToServer, kMicroVersion=kMicroVersion, stBadReputation=stBadReputation, stCategories=stCategories, pAMSignatureVersion=pAMSignatureVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, kCompanyName=kCompanyName, stHttpTraffic=stHttpTraffic, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesFromServer=stHttpsBytesFromServer, trSystem=trSystem, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgContent=mwgContent, notifyAdditional=notifyAdditional, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsRequests=stHttpsRequests, mwgInfo=mwgInfo, stCPULoad=stCPULoad, stMemConsumed=stMemConsumed, pAMProactiveVersion=pAMProactiveVersion, trUser=trUser, stHttpBytesFromServer=stHttpBytesFromServer, stClientCount=stClientCount, kBuildNumber=kBuildNumber, stConnectionsBlocked=stConnectionsBlocked, stBlockedByMediaFilter=stBlockedByMediaFilter, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pTSDBVersion=pTSDBVersion, stFtpTraffic=stFtpTraffic, mwg=mwg, pAMEngineVersion=pAMEngineVersion, mwgTraps=mwgTraps, stCPULoadRaw=stCPULoadRaw, stHttpsTraffic=stHttpsTraffic, stHttpRequests=stHttpRequests, kCustomVersion=kCustomVersion, notifyOriginName=notifyOriginName, mwgFTP=mwgFTP, stCategoryCount=stCategoryCount, stCategoriesEntry=stCategoriesEntry, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, stMimeType=stMimeType, kRevision=kRevision, kMajorVersion=kMajorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trApplication=trApplication, notifyOrigin=notifyOrigin, stCPUIOWait=stCPUIOWait, PYSNMP_MODULE_ID=mwg, stFtpBytesToServer=stFtpBytesToServer, stConnectionsLegitimate=stConnectionsLegitimate, mwgHttp=mwgHttp, mwgTrapVariables=mwgTrapVariables, mwgMiscellaneous=mwgMiscellaneous)
