...
Unsigned32, Counter32, NotificationType, NotificationType, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, enterprises, iso, Bits, ModuleIdentity, IpAddress, mib_2, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "NotificationType", "NotificationType", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "enterprises", "iso", "Bits", "ModuleIdentity", "IpAddress", "mib-2", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoriesEntry=stCategoriesEntry, stHttpsRequests=stHttpsRequests, kMicroVersion=kMicroVersion, stFtpBytesToClient=stFtpBytesToClient, stCPULoad=stCPULoad, mwgHttps=mwgHttps, stHttpBytesToServer=stHttpBytesToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pTSDBVersion=pTSDBVersion, stHttpsTraffic=stHttpsTraffic, mwgContent=mwgContent, stCategories=stCategories, mwgHttp=mwgHttp, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesFromClient=stHttpBytesFromClient, pMFEDATVersion=pMFEDATVersion, notifyOriginName=notifyOriginName, notifySeverity=notifySeverity, stMemConsumed=stMemConsumed, kCompanyName=kCompanyName, pMFEEngineVersion=pMFEEngineVersion, stConnectionsLegitimate=stConnectionsLegitimate, mwg=mwg, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesFromClient=stFtpBytesFromClient, kMinorVersion=kMinorVersion, stHttpRequests=stHttpRequests, stCPUIOWait=stCPUIOWait, trSystem=trSystem, PYSNMP_MODULE_ID=mwg, stConnectionsBlocked=stConnectionsBlocked, mwgStatistics=mwgStatistics, notifyAffectedHost=notifyAffectedHost, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, stConnectedSockets=stConnectedSockets, kBuildNumber=kBuildNumber, kRevision=kRevision, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromServer=stHttpBytesFromServer, trUser=trUser, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyReason=notifyReason, stTimeForTransaction=stTimeForTransaction, mwgInfo=mwgInfo, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kHotfixVersion=kHotfixVersion, pAMSignatureVersion=pAMSignatureVersion, mwgFTP=mwgFTP, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, kCustomVersion=kCustomVersion, stCategoriesTable=stCategoriesTable, kProductVersion=kProductVersion, pAMProactiveVersion=pAMProactiveVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHandleConnectToServer=stHandleConnectToServer, mwgMiscellaneous=mwgMiscellaneous, stBadReputation=stBadReputation, mwgTraps=mwgTraps, stHttpsBytesToServer=stHttpsBytesToServer, kMajorVersion=kMajorVersion, mwgEngineVersions=mwgEngineVersions, notifyOrigin=notifyOrigin, mwgTrapVariables=mwgTrapVariables, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesFromServer=stFtpBytesFromServer, stCPULoadRaw=stCPULoadRaw, stCategoryName=stCategoryName, stHttpTraffic=stHttpTraffic, stMimeType=stMimeType, kProductName=kProductName, stBlockedByURLFilter=stBlockedByURLFilter, notifyAdditional=notifyAdditional, trApplication=trApplication, stCategoryCount=stCategoryCount, notifyReasonString=notifyReasonString, stClientCount=stClientCount, stFtpTraffic=stFtpTraffic, stMalwareDetected=stMalwareDetected, stFtpBytesToServer=stFtpBytesToServer)
