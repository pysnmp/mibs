...
ModuleIdentity, Integer32, IpAddress, ObjectIdentity, NotificationType, MibIdentifier, Gauge32, Counter64, mib_2, iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, Counter32, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "IpAddress", "ObjectIdentity", "NotificationType", "MibIdentifier", "Gauge32", "Counter64", "mib-2", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "Counter32", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kCompanyName=kCompanyName, pAMEngineVersion=pAMEngineVersion, mwgStatistics=mwgStatistics, pMFEEngineVersion=pMFEEngineVersion, stConnectedSockets=stConnectedSockets, stCategories=stCategories, stFtpTraffic=stFtpTraffic, notifyOriginName=notifyOriginName, trUser=trUser, kMinorVersion=kMinorVersion, mwgEngineVersions=mwgEngineVersions, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsRequests=stHttpsRequests, kMicroVersion=kMicroVersion, notifyReasonString=notifyReasonString, kBuildNumber=kBuildNumber, stMemConsumed=stMemConsumed, stMalwareDetected=stMalwareDetected, mwgMiscellaneous=mwgMiscellaneous, stMimeType=stMimeType, stHttpsBytesFromServer=stHttpsBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stClientCount=stClientCount, stHttpRequests=stHttpRequests, stLastSentLastReceivedClient=stLastSentLastReceivedClient, PYSNMP_MODULE_ID=mwg, kCustomVersion=kCustomVersion, stCategoriesTable=stCategoriesTable, stBlockedByAntiMalware=stBlockedByAntiMalware, pMFEDATVersion=pMFEDATVersion, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesFromClient=stFtpBytesFromClient, kProductName=kProductName, stCategoriesEntry=stCategoriesEntry, notifyReason=notifyReason, notifyAdditional=notifyAdditional, stBadReputation=stBadReputation, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMajorVersion=kMajorVersion, mwgInfo=mwgInfo, stCPULoadRaw=stCPULoadRaw, mwgContent=mwgContent, kRevision=kRevision, stCPULoad=stCPULoad, kHotfixVersion=kHotfixVersion, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, pAMSignatureVersion=pAMSignatureVersion, mwgTraps=mwgTraps, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoryCount=stCategoryCount, stHttpBytesToServer=stHttpBytesToServer, mwg=mwg, mwgHttps=mwgHttps, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, trSystem=trSystem, stHttpTraffic=stHttpTraffic, stCategoryName=stCategoryName, stTimeForTransaction=stTimeForTransaction, kProductVersion=kProductVersion, pAMProactiveVersion=pAMProactiveVersion, trApplication=trApplication, mwgTrapVariables=mwgTrapVariables, notifyAffectedHost=notifyAffectedHost, notifySeverity=notifySeverity, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCPUIOWait=stCPUIOWait, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesFromServer=stHttpBytesFromServer, notifyOrigin=notifyOrigin, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesToServer=stFtpBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, stHandleConnectToServer=stHandleConnectToServer, stHttpsTraffic=stHttpsTraffic, mwgFTP=mwgFTP, pTSDBVersion=pTSDBVersion, mwgHttp=mwgHttp, stHttpBytesToClient=stHttpBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient)
