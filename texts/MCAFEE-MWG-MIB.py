...
Unsigned32, NotificationType, ObjectIdentity, mib_2, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, iso, MibIdentifier, ModuleIdentity, Integer32, IpAddress, enterprises, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "ObjectIdentity", "mib-2", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "iso", "MibIdentifier", "ModuleIdentity", "Integer32", "IpAddress", "enterprises", "Bits", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesFromClient=stHttpsBytesFromClient, stCategories=stCategories, kMicroVersion=kMicroVersion, stMemConsumed=stMemConsumed, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kProductVersion=kProductVersion, kMinorVersion=kMinorVersion, stHttpsTraffic=stHttpsTraffic, stHttpBytesFromClient=stHttpBytesFromClient, stCategoryName=stCategoryName, stMalwareDetected=stMalwareDetected, stCPULoadRaw=stCPULoadRaw, stCPULoad=stCPULoad, stHttpBytesFromServer=stHttpBytesFromServer, kMajorVersion=kMajorVersion, mwgHttp=mwgHttp, kBuildNumber=kBuildNumber, stCategoriesTable=stCategoriesTable, stCategoriesEntry=stCategoriesEntry, kProductName=kProductName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesToClient=stHttpsBytesToClient, stConnectionsBlocked=stConnectionsBlocked, kCompanyName=kCompanyName, pAMSignatureVersion=pAMSignatureVersion, notifyOriginName=notifyOriginName, pAMEngineVersion=pAMEngineVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsRequests=stHttpsRequests, stFtpBytesToServer=stFtpBytesToServer, stConnectedSockets=stConnectedSockets, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pAMProactiveVersion=pAMProactiveVersion, stClientCount=stClientCount, stResolveHostViaDNS=stResolveHostViaDNS, kCustomVersion=kCustomVersion, pTSDBVersion=pTSDBVersion, kHotfixVersion=kHotfixVersion, notifyAffectedHost=notifyAffectedHost, stHttpBytesToClient=stHttpBytesToClient, mwgContent=mwgContent, kRevision=kRevision, notifySeverity=notifySeverity, trUser=trUser, stHttpTraffic=stHttpTraffic, stFtpTraffic=stFtpTraffic, stHandleConnectToServer=stHandleConnectToServer, trSystem=trSystem, mwgInfo=mwgInfo, notifyAdditional=notifyAdditional, mwg=mwg, pMFEDATVersion=pMFEDATVersion, mwgStatistics=mwgStatistics, PYSNMP_MODULE_ID=mwg, stBlockedByURLFilter=stBlockedByURLFilter, notifyReasonString=notifyReasonString, notifyOrigin=notifyOrigin, stMimeType=stMimeType, mwgFTP=mwgFTP, mwgTrapVariables=mwgTrapVariables, notifyReason=notifyReason, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesFromServer=stFtpBytesFromServer, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesToClient=stFtpBytesToClient, stCategoryCount=stCategoryCount, stBadReputation=stBadReputation, stCPUIOWait=stCPUIOWait, mwgMiscellaneous=mwgMiscellaneous, stBlockedByMediaFilter=stBlockedByMediaFilter, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesToServer=stHttpsBytesToServer, mwgTraps=mwgTraps, stHttpRequests=stHttpRequests, stConnectionsLegitimate=stConnectionsLegitimate, trApplication=trApplication, stTimeForTransaction=stTimeForTransaction, mwgEngineVersions=mwgEngineVersions, mwgHttps=mwgHttps)
