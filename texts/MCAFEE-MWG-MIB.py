...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, ModuleIdentity, Gauge32, enterprises, iso, Bits, ObjectIdentity, Unsigned32, Counter32, NotificationType, Counter64, mib_2, Integer32, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "ModuleIdentity", "Gauge32", "enterprises", "iso", "Bits", "ObjectIdentity", "Unsigned32", "Counter32", "NotificationType", "Counter64", "mib-2", "Integer32", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByMediaFilter=stBlockedByMediaFilter, kProductVersion=kProductVersion, kMinorVersion=kMinorVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMemConsumed=stMemConsumed, stFtpBytesToServer=stFtpBytesToServer, kMicroVersion=kMicroVersion, stHttpsRequests=stHttpsRequests, stCategories=stCategories, stCPUIOWait=stCPUIOWait, notifyAdditional=notifyAdditional, pMFEDATVersion=pMFEDATVersion, stHandleConnectToServer=stHandleConnectToServer, mwgTrapVariables=mwgTrapVariables, stCategoryName=stCategoryName, stCategoryCount=stCategoryCount, kProductName=kProductName, trApplication=trApplication, stHttpsBytesFromClient=stHttpsBytesFromClient, kHotfixVersion=kHotfixVersion, stFtpBytesToClient=stFtpBytesToClient, kMajorVersion=kMajorVersion, stCPULoad=stCPULoad, pAMProactiveVersion=pAMProactiveVersion, stResolveHostViaDNS=stResolveHostViaDNS, stClientCount=stClientCount, stHttpsBytesToServer=stHttpsBytesToServer, kCustomVersion=kCustomVersion, kCompanyName=kCompanyName, notifyOriginName=notifyOriginName, stHttpTraffic=stHttpTraffic, mwgHttps=mwgHttps, pAMEngineVersion=pAMEngineVersion, stMimeType=stMimeType, stConnectedSockets=stConnectedSockets, stHttpsTraffic=stHttpsTraffic, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwg=mwg, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyOrigin=notifyOrigin, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgEngineVersions=mwgEngineVersions, mwgHttp=mwgHttp, mwgMiscellaneous=mwgMiscellaneous, stTimeForTransaction=stTimeForTransaction, trUser=trUser, notifySeverity=notifySeverity, pMFEEngineVersion=pMFEEngineVersion, kRevision=kRevision, mwgInfo=mwgInfo, stCPULoadRaw=stCPULoadRaw, stFtpTraffic=stFtpTraffic, mwgContent=mwgContent, stBlockedByURLFilter=stBlockedByURLFilter, PYSNMP_MODULE_ID=mwg, pTSDBVersion=pTSDBVersion, mwgStatistics=mwgStatistics, stCategoriesEntry=stCategoriesEntry, mwgTraps=mwgTraps, kBuildNumber=kBuildNumber, notifyReasonString=notifyReasonString, notifyReason=notifyReason, stHttpRequests=stHttpRequests, stHttpBytesToServer=stHttpBytesToServer, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesToClient=stHttpBytesToClient, stCategoriesTable=stCategoriesTable, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgFTP=mwgFTP, trSystem=trSystem, notifyAffectedHost=notifyAffectedHost, stConnectionsLegitimate=stConnectionsLegitimate, stMalwareDetected=stMalwareDetected, stHttpBytesFromServer=stHttpBytesFromServer, stBadReputation=stBadReputation)
