...
Unsigned32, NotificationType, Bits, Integer32, TimeTicks, Counter64, ModuleIdentity, mib_2, enterprises, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, IpAddress, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "Bits", "Integer32", "TimeTicks", "Counter64", "ModuleIdentity", "mib-2", "enterprises", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "IpAddress", "iso", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPULoad=stCPULoad, mwgStatistics=mwgStatistics, kRevision=kRevision, kCustomVersion=kCustomVersion, stHttpsBytesToServer=stHttpsBytesToServer, stBadReputation=stBadReputation, stHttpRequests=stHttpRequests, stHttpBytesToClient=stHttpBytesToClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoriesTable=stCategoriesTable, kProductName=kProductName, stBlockedByURLFilter=stBlockedByURLFilter, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyAffectedHost=notifyAffectedHost, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttp=mwgHttp, kMinorVersion=kMinorVersion, mwg=mwg, stCategoriesEntry=stCategoriesEntry, stHttpBytesToServer=stHttpBytesToServer, stConnectedSockets=stConnectedSockets, kProductVersion=kProductVersion, stFtpBytesToServer=stFtpBytesToServer, pMFEEngineVersion=pMFEEngineVersion, stCPUIOWait=stCPUIOWait, stMalwareDetected=stMalwareDetected, stHttpTraffic=stHttpTraffic, mwgInfo=mwgInfo, kHotfixVersion=kHotfixVersion, stHttpBytesFromClient=stHttpBytesFromClient, pTSDBVersion=pTSDBVersion, stClientCount=stClientCount, trUser=trUser, kCompanyName=kCompanyName, stHandleConnectToServer=stHandleConnectToServer, pAMEngineVersion=pAMEngineVersion, mwgTraps=mwgTraps, pMFEDATVersion=pMFEDATVersion, kMajorVersion=kMajorVersion, notifyOrigin=notifyOrigin, stFtpBytesFromClient=stFtpBytesFromClient, mwgContent=mwgContent, pAMSignatureVersion=pAMSignatureVersion, mwgHttps=mwgHttps, stConnectionsBlocked=stConnectionsBlocked, stHttpsRequests=stHttpsRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, stMemConsumed=stMemConsumed, trSystem=trSystem, notifySeverity=notifySeverity, stCategoryName=stCategoryName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMimeType=stMimeType, notifyOriginName=notifyOriginName, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsTraffic=stHttpsTraffic, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyAdditional=notifyAdditional, mwgFTP=mwgFTP, kBuildNumber=kBuildNumber, pAMProactiveVersion=pAMProactiveVersion, mwgMiscellaneous=mwgMiscellaneous, notifyReason=notifyReason, stResolveHostViaDNS=stResolveHostViaDNS, mwgTrapVariables=mwgTrapVariables, mwgEngineVersions=mwgEngineVersions, notifyReasonString=notifyReasonString, stCPULoadRaw=stCPULoadRaw, stFtpTraffic=stFtpTraffic, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoryCount=stCategoryCount, stHttpsBytesToClient=stHttpsBytesToClient, stTimeForTransaction=stTimeForTransaction, trApplication=trApplication, kMicroVersion=kMicroVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, PYSNMP_MODULE_ID=mwg, stFtpBytesToClient=stFtpBytesToClient, stCategories=stCategories)
