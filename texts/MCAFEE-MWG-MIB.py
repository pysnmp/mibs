...
Unsigned32, enterprises, Bits, Integer32, mib_2, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, ModuleIdentity, NotificationType, iso, IpAddress, TimeTicks, ObjectIdentity, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "enterprises", "Bits", "Integer32", "mib-2", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "ModuleIdentity", "NotificationType", "iso", "IpAddress", "TimeTicks", "ObjectIdentity", "MibIdentifier", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpTraffic=stHttpTraffic, stBlockedByURLFilter=stBlockedByURLFilter, kMajorVersion=kMajorVersion, pAMProactiveVersion=pAMProactiveVersion, pAMEngineVersion=pAMEngineVersion, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stConnectedSockets=stConnectedSockets, stHttpsRequests=stHttpsRequests, pTSDBVersion=pTSDBVersion, mwgTraps=mwgTraps, mwgMiscellaneous=mwgMiscellaneous, stHandleConnectToServer=stHandleConnectToServer, stTimeForTransaction=stTimeForTransaction, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, trUser=trUser, kRevision=kRevision, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stClientCount=stClientCount, notifyOrigin=notifyOrigin, stFtpBytesFromClient=stFtpBytesFromClient, notifySeverity=notifySeverity, stHttpsBytesFromServer=stHttpsBytesFromServer, kProductVersion=kProductVersion, stCPULoadRaw=stCPULoadRaw, trApplication=trApplication, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsTraffic=stHttpsTraffic, pMFEEngineVersion=pMFEEngineVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMalwareDetected=stMalwareDetected, notifyReasonString=notifyReasonString, notifyAffectedHost=notifyAffectedHost, mwgContent=mwgContent, stCategoriesEntry=stCategoriesEntry, stHttpsBytesFromClient=stHttpsBytesFromClient, mwg=mwg, stCPUIOWait=stCPUIOWait, kMinorVersion=kMinorVersion, stMemConsumed=stMemConsumed, stHttpBytesToClient=stHttpBytesToClient, stCategoryCount=stCategoryCount, stHttpBytesFromClient=stHttpBytesFromClient, stHttpRequests=stHttpRequests, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kProductName=kProductName, stCategories=stCategories, stBadReputation=stBadReputation, mwgHttps=mwgHttps, notifyOriginName=notifyOriginName, mwgEngineVersions=mwgEngineVersions, mwgInfo=mwgInfo, stFtpBytesToServer=stFtpBytesToServer, mwgTrapVariables=mwgTrapVariables, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyReason=notifyReason, stConnectionsBlocked=stConnectionsBlocked, stFtpTraffic=stFtpTraffic, kMicroVersion=kMicroVersion, stHttpsBytesToServer=stHttpsBytesToServer, kCustomVersion=kCustomVersion, stCPULoad=stCPULoad, mwgHttp=mwgHttp, stMimeType=stMimeType, pAMSignatureVersion=pAMSignatureVersion, trSystem=trSystem, stConnectionsLegitimate=stConnectionsLegitimate, kHotfixVersion=kHotfixVersion, mwgStatistics=mwgStatistics, stCategoriesTable=stCategoriesTable, stHttpsBytesToClient=stHttpsBytesToClient, notifyAdditional=notifyAdditional, kCompanyName=kCompanyName, kBuildNumber=kBuildNumber, stFtpBytesFromServer=stFtpBytesFromServer, stCategoryName=stCategoryName, stHttpBytesToServer=stHttpBytesToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgFTP=mwgFTP, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, PYSNMP_MODULE_ID=mwg, pMFEDATVersion=pMFEDATVersion)
