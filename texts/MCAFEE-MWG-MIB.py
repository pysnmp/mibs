...
enterprises, Unsigned32, Integer32, Counter64, ModuleIdentity, Counter32, mib_2, TimeTicks, MibIdentifier, iso, NotificationType, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Unsigned32", "Integer32", "Counter64", "ModuleIdentity", "Counter32", "mib-2", "TimeTicks", "MibIdentifier", "iso", "NotificationType", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stConnectedSockets=stConnectedSockets, stBlockedByURLFilter=stBlockedByURLFilter, kMinorVersion=kMinorVersion, notifyAffectedHost=notifyAffectedHost, stHttpBytesFromClient=stHttpBytesFromClient, mwgHttps=mwgHttps, stHttpsRequests=stHttpsRequests, stHttpRequests=stHttpRequests, stHttpTraffic=stHttpTraffic, kMicroVersion=kMicroVersion, kCustomVersion=kCustomVersion, mwgMiscellaneous=mwgMiscellaneous, mwgContent=mwgContent, kProductVersion=kProductVersion, kCompanyName=kCompanyName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pAMEngineVersion=pAMEngineVersion, notifyOrigin=notifyOrigin, stResolveHostViaDNS=stResolveHostViaDNS, stCategoryCount=stCategoryCount, stFtpBytesToServer=stFtpBytesToServer, PYSNMP_MODULE_ID=mwg, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesFromClient=stFtpBytesFromClient, stFtpTraffic=stFtpTraffic, stHandleConnectToServer=stHandleConnectToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kProductName=kProductName, mwgEngineVersions=mwgEngineVersions, stCPUIOWait=stCPUIOWait, stHttpBytesToClient=stHttpBytesToClient, trSystem=trSystem, mwg=mwg, notifyOriginName=notifyOriginName, notifyAdditional=notifyAdditional, stCategoriesEntry=stCategoriesEntry, kHotfixVersion=kHotfixVersion, mwgInfo=mwgInfo, notifySeverity=notifySeverity, stBlockedByMediaFilter=stBlockedByMediaFilter, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgFTP=mwgFTP, mwgTrapVariables=mwgTrapVariables, stFtpBytesToClient=stFtpBytesToClient, mwgStatistics=mwgStatistics, stCPULoad=stCPULoad, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stCategoryName=stCategoryName, stCategoriesTable=stCategoriesTable, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsLegitimate=stConnectionsLegitimate, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trUser=trUser, stMalwareDetected=stMalwareDetected, notifyReason=notifyReason, stCPULoadRaw=stCPULoadRaw, pAMSignatureVersion=pAMSignatureVersion, notifyReasonString=notifyReasonString, pMFEDATVersion=pMFEDATVersion, stBadReputation=stBadReputation, stClientCount=stClientCount, stMemConsumed=stMemConsumed, mwgHttp=mwgHttp, stConnectionsBlocked=stConnectionsBlocked, pTSDBVersion=pTSDBVersion, stTimeForTransaction=stTimeForTransaction, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsTraffic=stHttpsTraffic, stMimeType=stMimeType, kRevision=kRevision, pMFEEngineVersion=pMFEEngineVersion, mwgTraps=mwgTraps, kMajorVersion=kMajorVersion, stCategories=stCategories, stHttpsBytesFromServer=stHttpsBytesFromServer, trApplication=trApplication, kBuildNumber=kBuildNumber, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesToServer=stHttpBytesToServer)
