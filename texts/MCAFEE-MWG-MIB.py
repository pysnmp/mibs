...
MibIdentifier, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Integer32, IpAddress, NotificationType, mib_2, Bits, NotificationType, TimeTicks, iso, Unsigned32, Counter32, ObjectIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Integer32", "IpAddress", "NotificationType", "mib-2", "Bits", "NotificationType", "TimeTicks", "iso", "Unsigned32", "Counter32", "ObjectIdentity", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpRequests=stHttpRequests, PYSNMP_MODULE_ID=mwg, kCompanyName=kCompanyName, mwgInfo=mwgInfo, kProductName=kProductName, kProductVersion=kProductVersion, stCPULoad=stCPULoad, stHttpsRequests=stHttpsRequests, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMinorVersion=kMinorVersion, stCategories=stCategories, stBlockedByAntiMalware=stBlockedByAntiMalware, stTimeForTransaction=stTimeForTransaction, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kCustomVersion=kCustomVersion, pMFEEngineVersion=pMFEEngineVersion, stCategoryCount=stCategoryCount, kMicroVersion=kMicroVersion, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesToServer=stFtpBytesToServer, notifyOriginName=notifyOriginName, stHttpsTraffic=stHttpsTraffic, notifyReason=notifyReason, pMFEDATVersion=pMFEDATVersion, pAMProactiveVersion=pAMProactiveVersion, stMimeType=stMimeType, stBlockedByURLFilter=stBlockedByURLFilter, mwgMiscellaneous=mwgMiscellaneous, stCategoriesEntry=stCategoriesEntry, stHttpBytesToServer=stHttpBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, stConnectedSockets=stConnectedSockets, stCategoryName=stCategoryName, kMajorVersion=kMajorVersion, mwgTrapVariables=mwgTrapVariables, mwgHttps=mwgHttps, kRevision=kRevision, stCPULoadRaw=stCPULoadRaw, kHotfixVersion=kHotfixVersion, mwgEngineVersions=mwgEngineVersions, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, stMemConsumed=stMemConsumed, mwgHttp=mwgHttp, stCPUIOWait=stCPUIOWait, stFtpBytesFromServer=stFtpBytesFromServer, mwg=mwg, notifyReasonString=notifyReasonString, stConnectionsLegitimate=stConnectionsLegitimate, pAMEngineVersion=pAMEngineVersion, stHttpTraffic=stHttpTraffic, notifyOrigin=notifyOrigin, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trUser=trUser, stConnectionsBlocked=stConnectionsBlocked, kBuildNumber=kBuildNumber, stCategoriesTable=stCategoriesTable, notifyAffectedHost=notifyAffectedHost, mwgStatistics=mwgStatistics, mwgTraps=mwgTraps, notifySeverity=notifySeverity, stHttpBytesToClient=stHttpBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesToServer=stHttpsBytesToServer, stBadReputation=stBadReputation, trApplication=trApplication, trSystem=trSystem, stHttpsBytesFromServer=stHttpsBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stClientCount=stClientCount, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, pAMSignatureVersion=pAMSignatureVersion, mwgFTP=mwgFTP, stFtpTraffic=stFtpTraffic, mwgContent=mwgContent, pTSDBVersion=pTSDBVersion, notifyAdditional=notifyAdditional, stResolveHostViaDNS=stResolveHostViaDNS)
