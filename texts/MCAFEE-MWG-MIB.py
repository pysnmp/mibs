...
TimeTicks, IpAddress, MibIdentifier, Gauge32, Counter64, Counter32, ModuleIdentity, Integer32, iso, NotificationType, Unsigned32, ObjectIdentity, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "MibIdentifier", "Gauge32", "Counter64", "Counter32", "ModuleIdentity", "Integer32", "iso", "NotificationType", "Unsigned32", "ObjectIdentity", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pTSDBVersion=pTSDBVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesToClient=stHttpBytesToClient, stCPULoad=stCPULoad, notifyOriginName=notifyOriginName, mwgContent=mwgContent, trSystem=trSystem, stCategories=stCategories, kCompanyName=kCompanyName, stConnectionsLegitimate=stConnectionsLegitimate, mwgMiscellaneous=mwgMiscellaneous, mwgTrapVariables=mwgTrapVariables, stFtpTraffic=stFtpTraffic, stClientCount=stClientCount, notifyReason=notifyReason, trUser=trUser, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesToClient=stHttpsBytesToClient, stTimeForTransaction=stTimeForTransaction, kMajorVersion=kMajorVersion, stHttpRequests=stHttpRequests, notifyReasonString=notifyReasonString, stFtpBytesToServer=stFtpBytesToServer, stHttpTraffic=stHttpTraffic, kRevision=kRevision, stResolveHostViaDNS=stResolveHostViaDNS, pAMEngineVersion=pAMEngineVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, notifySeverity=notifySeverity, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgHttps=mwgHttps, stFtpBytesToClient=stFtpBytesToClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgEngineVersions=mwgEngineVersions, stMemConsumed=stMemConsumed, mwgInfo=mwgInfo, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyAffectedHost=notifyAffectedHost, stCategoriesEntry=stCategoriesEntry, pMFEDATVersion=pMFEDATVersion, mwgStatistics=mwgStatistics, stCPUIOWait=stCPUIOWait, stHandleConnectToServer=stHandleConnectToServer, kProductVersion=kProductVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kCustomVersion=kCustomVersion, mwgFTP=mwgFTP, kBuildNumber=kBuildNumber, kProductName=kProductName, mwgHttp=mwgHttp, pMFEEngineVersion=pMFEEngineVersion, PYSNMP_MODULE_ID=mwg, stHttpsTraffic=stHttpsTraffic, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMicroVersion=kMicroVersion, stHttpsBytesToServer=stHttpsBytesToServer, stMimeType=stMimeType, stMalwareDetected=stMalwareDetected, notifyOrigin=notifyOrigin, stHttpBytesToServer=stHttpBytesToServer, stConnectedSockets=stConnectedSockets, mwg=mwg, stHttpsRequests=stHttpsRequests, kHotfixVersion=kHotfixVersion, notifyAdditional=notifyAdditional, pAMSignatureVersion=pAMSignatureVersion, stBadReputation=stBadReputation, kMinorVersion=kMinorVersion, stCategoryCount=stCategoryCount, mwgTraps=mwgTraps, stCPULoadRaw=stCPULoadRaw, stHttpBytesFromServer=stHttpBytesFromServer, stCategoryName=stCategoryName, stBlockedByURLFilter=stBlockedByURLFilter, stCategoriesTable=stCategoriesTable, trApplication=trApplication, stFtpBytesFromServer=stFtpBytesFromServer, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesFromClient=stHttpBytesFromClient)
