...
TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, MibIdentifier, Integer32, Counter64, Gauge32, enterprises, ObjectIdentity, mib_2, iso, Bits, Counter32, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "MibIdentifier", "Integer32", "Counter64", "Gauge32", "enterprises", "ObjectIdentity", "mib-2", "iso", "Bits", "Counter32", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMProactiveVersion=pAMProactiveVersion, stResolveHostViaDNS=stResolveHostViaDNS, mwgMiscellaneous=mwgMiscellaneous, mwgTraps=mwgTraps, stHttpTraffic=stHttpTraffic, stHttpsBytesToClient=stHttpsBytesToClient, mwgContent=mwgContent, pTSDBVersion=pTSDBVersion, stCategoriesEntry=stCategoriesEntry, stCategoriesTable=stCategoriesTable, stMalwareDetected=stMalwareDetected, mwgFTP=mwgFTP, kHotfixVersion=kHotfixVersion, pMFEEngineVersion=pMFEEngineVersion, mwgHttp=mwgHttp, kProductName=kProductName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategories=stCategories, kMajorVersion=kMajorVersion, mwgStatistics=mwgStatistics, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesFromServer=stHttpBytesFromServer, kRevision=kRevision, stHttpRequests=stHttpRequests, stClientCount=stClientCount, stCPULoad=stCPULoad, stHttpBytesToServer=stHttpBytesToServer, notifyReason=notifyReason, stFtpTraffic=stFtpTraffic, stFtpBytesToClient=stFtpBytesToClient, stCPULoadRaw=stCPULoadRaw, kMicroVersion=kMicroVersion, mwg=mwg, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoryName=stCategoryName, stTimeForTransaction=stTimeForTransaction, stConnectionsLegitimate=stConnectionsLegitimate, mwgInfo=mwgInfo, stBlockedByAntiMalware=stBlockedByAntiMalware, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyOriginName=notifyOriginName, kCustomVersion=kCustomVersion, pAMEngineVersion=pAMEngineVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, PYSNMP_MODULE_ID=mwg, stBlockedByURLFilter=stBlockedByURLFilter, stMimeType=stMimeType, stConnectionsBlocked=stConnectionsBlocked, trUser=trUser, stHttpBytesFromClient=stHttpBytesFromClient, stConnectedSockets=stConnectedSockets, stBadReputation=stBadReputation, mwgEngineVersions=mwgEngineVersions, notifySeverity=notifySeverity, mwgHttps=mwgHttps, notifyReasonString=notifyReasonString, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMemConsumed=stMemConsumed, stHttpBytesToClient=stHttpBytesToClient, stHttpsRequests=stHttpsRequests, stFtpBytesFromClient=stFtpBytesFromClient, trSystem=trSystem, stCPUIOWait=stCPUIOWait, mwgTrapVariables=mwgTrapVariables, pMFEDATVersion=pMFEDATVersion, notifyAdditional=notifyAdditional, stFtpBytesFromServer=stFtpBytesFromServer, notifyOrigin=notifyOrigin, kProductVersion=kProductVersion, kBuildNumber=kBuildNumber, notifyAffectedHost=notifyAffectedHost, kCompanyName=kCompanyName, stCategoryCount=stCategoryCount, stHttpsTraffic=stHttpsTraffic, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesToServer=stFtpBytesToServer, kMinorVersion=kMinorVersion, trApplication=trApplication)
