...
Unsigned32, ModuleIdentity, TimeTicks, MibIdentifier, Bits, iso, Counter32, ObjectIdentity, mib_2, IpAddress, Integer32, Gauge32, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "TimeTicks", "MibIdentifier", "Bits", "iso", "Counter32", "ObjectIdentity", "mib-2", "IpAddress", "Integer32", "Gauge32", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pMFEEngineVersion=pMFEEngineVersion, stCategoryName=stCategoryName, pAMEngineVersion=pAMEngineVersion, stHttpBytesToClient=stHttpBytesToClient, PYSNMP_MODULE_ID=mwg, mwgFTP=mwgFTP, stBlockedByURLFilter=stBlockedByURLFilter, stCPULoadRaw=stCPULoadRaw, stCategoriesEntry=stCategoriesEntry, stConnectionsLegitimate=stConnectionsLegitimate, pAMSignatureVersion=pAMSignatureVersion, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesFromClient=stFtpBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgHttp=mwgHttp, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyReason=notifyReason, stFtpBytesFromServer=stFtpBytesFromServer, kMinorVersion=kMinorVersion, pTSDBVersion=pTSDBVersion, kCustomVersion=kCustomVersion, stHttpBytesFromServer=stHttpBytesFromServer, stFtpTraffic=stFtpTraffic, stHttpBytesToServer=stHttpBytesToServer, stHttpsRequests=stHttpsRequests, notifyOrigin=notifyOrigin, stHttpsBytesToClient=stHttpsBytesToClient, notifyAdditional=notifyAdditional, stTimeForTransaction=stTimeForTransaction, mwgEngineVersions=mwgEngineVersions, notifyAffectedHost=notifyAffectedHost, stCPUIOWait=stCPUIOWait, stMalwareDetected=stMalwareDetected, trUser=trUser, stHttpTraffic=stHttpTraffic, notifySeverity=notifySeverity, mwgMiscellaneous=mwgMiscellaneous, kMicroVersion=kMicroVersion, pMFEDATVersion=pMFEDATVersion, stFtpBytesToClient=stFtpBytesToClient, kProductVersion=kProductVersion, kProductName=kProductName, stResolveHostViaDNS=stResolveHostViaDNS, stMemConsumed=stMemConsumed, stCPULoad=stCPULoad, notifyOriginName=notifyOriginName, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgInfo=mwgInfo, trApplication=trApplication, mwgStatistics=mwgStatistics, stBadReputation=stBadReputation, stHttpsTraffic=stHttpsTraffic, pAMProactiveVersion=pAMProactiveVersion, mwgContent=mwgContent, kBuildNumber=kBuildNumber, stHttpsBytesToServer=stHttpsBytesToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpRequests=stHttpRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, kRevision=kRevision, stMimeType=stMimeType, stConnectedSockets=stConnectedSockets, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategories=stCategories, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgTrapVariables=mwgTrapVariables, mwgHttps=mwgHttps, kHotfixVersion=kHotfixVersion, stCategoriesTable=stCategoriesTable, trSystem=trSystem, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMajorVersion=kMajorVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoryCount=stCategoryCount, mwgTraps=mwgTraps, stFtpBytesToServer=stFtpBytesToServer, mwg=mwg, stClientCount=stClientCount, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyReasonString=notifyReasonString, kCompanyName=kCompanyName)
