...
Counter64, IpAddress, iso, Counter32, ObjectIdentity, MibIdentifier, Bits, Gauge32, NotificationType, mib_2, TimeTicks, Integer32, ModuleIdentity, enterprises, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "iso", "Counter32", "ObjectIdentity", "MibIdentifier", "Bits", "Gauge32", "NotificationType", "mib-2", "TimeTicks", "Integer32", "ModuleIdentity", "enterprises", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyReason=notifyReason, pAMProactiveVersion=pAMProactiveVersion, stConnectedSockets=stConnectedSockets, stCPULoadRaw=stCPULoadRaw, kCompanyName=kCompanyName, pAMEngineVersion=pAMEngineVersion, pTSDBVersion=pTSDBVersion, stConnectionsLegitimate=stConnectionsLegitimate, PYSNMP_MODULE_ID=mwg, stResolveHostViaDNS=stResolveHostViaDNS, notifySeverity=notifySeverity, stCategoryName=stCategoryName, stCategories=stCategories, kMicroVersion=kMicroVersion, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesToClient=stHttpBytesToClient, stConnectionsBlocked=stConnectionsBlocked, stHttpsRequests=stHttpsRequests, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesToServer=stFtpBytesToServer, mwgHttps=mwgHttps, mwgFTP=mwgFTP, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesToClient=stFtpBytesToClient, notifyAdditional=notifyAdditional, mwgContent=mwgContent, mwgTrapVariables=mwgTrapVariables, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBadReputation=stBadReputation, notifyOriginName=notifyOriginName, trUser=trUser, stCategoriesEntry=stCategoriesEntry, kCustomVersion=kCustomVersion, kRevision=kRevision, mwgTraps=mwgTraps, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMajorVersion=kMajorVersion, trApplication=trApplication, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgInfo=mwgInfo, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyReasonString=notifyReasonString, kHotfixVersion=kHotfixVersion, pMFEDATVersion=pMFEDATVersion, notifyAffectedHost=notifyAffectedHost, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsTraffic=stHttpsTraffic, stTimeForTransaction=stTimeForTransaction, mwgEngineVersions=mwgEngineVersions, stHttpRequests=stHttpRequests, notifyOrigin=notifyOrigin, mwgHttp=mwgHttp, stBlockedByURLFilter=stBlockedByURLFilter, mwgMiscellaneous=mwgMiscellaneous, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, mwg=mwg, kBuildNumber=kBuildNumber, stMemConsumed=stMemConsumed, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kProductVersion=kProductVersion, stCPULoad=stCPULoad, stHttpTraffic=stHttpTraffic, stCPUIOWait=stCPUIOWait, stFtpTraffic=stFtpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgStatistics=mwgStatistics, kMinorVersion=kMinorVersion, stHttpBytesFromServer=stHttpBytesFromServer, stCategoryCount=stCategoryCount, trSystem=trSystem, kProductName=kProductName, stBlockedByMediaFilter=stBlockedByMediaFilter, stClientCount=stClientCount, stFtpBytesFromClient=stFtpBytesFromClient, stCategoriesTable=stCategoriesTable, stMimeType=stMimeType)
