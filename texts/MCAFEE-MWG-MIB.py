...
IpAddress, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Unsigned32, enterprises, Bits, NotificationType, ObjectIdentity, iso, NotificationType, TimeTicks, Counter64, ModuleIdentity, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Unsigned32", "enterprises", "Bits", "NotificationType", "ObjectIdentity", "iso", "NotificationType", "TimeTicks", "Counter64", "ModuleIdentity", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpTraffic=stHttpTraffic, stFtpBytesToServer=stFtpBytesToServer, mwgHttp=mwgHttp, mwgTrapVariables=mwgTrapVariables, stBadReputation=stBadReputation, notifyAdditional=notifyAdditional, stHttpRequests=stHttpRequests, stConnectionsLegitimate=stConnectionsLegitimate, stCPUIOWait=stCPUIOWait, stCategoryName=stCategoryName, mwgTraps=mwgTraps, mwg=mwg, kMajorVersion=kMajorVersion, notifyReason=notifyReason, notifySeverity=notifySeverity, stMalwareDetected=stMalwareDetected, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgInfo=mwgInfo, trUser=trUser, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMimeType=stMimeType, PYSNMP_MODULE_ID=mwg, trSystem=trSystem, trApplication=trApplication, pMFEEngineVersion=pMFEEngineVersion, pMFEDATVersion=pMFEDATVersion, pAMSignatureVersion=pAMSignatureVersion, mwgMiscellaneous=mwgMiscellaneous, stTimeForTransaction=stTimeForTransaction, pTSDBVersion=pTSDBVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kProductVersion=kProductVersion, kRevision=kRevision, stMemConsumed=stMemConsumed, stCategoriesEntry=stCategoriesEntry, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesToClient=stFtpBytesToClient, stBlockedByURLFilter=stBlockedByURLFilter, pAMProactiveVersion=pAMProactiveVersion, mwgContent=mwgContent, stHttpsBytesToClient=stHttpsBytesToClient, kCompanyName=kCompanyName, kCustomVersion=kCustomVersion, kMicroVersion=kMicroVersion, stConnectionsBlocked=stConnectionsBlocked, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCPULoadRaw=stCPULoadRaw, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, kHotfixVersion=kHotfixVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stClientCount=stClientCount, stFtpTraffic=stFtpTraffic, notifyOriginName=notifyOriginName, stCategoriesTable=stCategoriesTable, notifyReasonString=notifyReasonString, kBuildNumber=kBuildNumber, mwgEngineVersions=mwgEngineVersions, stCategories=stCategories, stHttpBytesToServer=stHttpBytesToServer, stCPULoad=stCPULoad, stHttpsRequests=stHttpsRequests, notifyAffectedHost=notifyAffectedHost, mwgFTP=mwgFTP, mwgHttps=mwgHttps, stHttpBytesToClient=stHttpBytesToClient, stHttpsTraffic=stHttpsTraffic, mwgStatistics=mwgStatistics, kMinorVersion=kMinorVersion, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyOrigin=notifyOrigin, kProductName=kProductName, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoryCount=stCategoryCount, stHandleConnectToServer=stHandleConnectToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient, stConnectedSockets=stConnectedSockets, stHttpsBytesToServer=stHttpsBytesToServer)
