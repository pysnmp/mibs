...
NotificationType, ModuleIdentity, IpAddress, Counter64, Counter32, enterprises, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, mib_2, ObjectIdentity, Unsigned32, NotificationType, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "IpAddress", "Counter64", "Counter32", "enterprises", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "mib-2", "ObjectIdentity", "Unsigned32", "NotificationType", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPULoadRaw=stCPULoadRaw, stMalwareDetected=stMalwareDetected, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesFromServer=stFtpBytesFromServer, pMFEDATVersion=pMFEDATVersion, stHttpRequests=stHttpRequests, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCPUIOWait=stCPUIOWait, stHttpsBytesFromClient=stHttpsBytesFromClient, notifySeverity=notifySeverity, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoriesEntry=stCategoriesEntry, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgInfo=mwgInfo, notifyReason=notifyReason, stMimeType=stMimeType, kBuildNumber=kBuildNumber, stHttpBytesToServer=stHttpBytesToServer, stHttpsTraffic=stHttpsTraffic, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pTSDBVersion=pTSDBVersion, stTimeForTransaction=stTimeForTransaction, mwgStatistics=mwgStatistics, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesFromClient=stHttpBytesFromClient, kMinorVersion=kMinorVersion, stBlockedByURLFilter=stBlockedByURLFilter, mwgHttps=mwgHttps, kMajorVersion=kMajorVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesToClient=stHttpBytesToClient, stHandleConnectToServer=stHandleConnectToServer, mwgTrapVariables=mwgTrapVariables, kCompanyName=kCompanyName, kMicroVersion=kMicroVersion, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesToClient=stHttpsBytesToClient, stConnectedSockets=stConnectedSockets, mwgTraps=mwgTraps, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesFromServer=stHttpBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, PYSNMP_MODULE_ID=mwg, trSystem=trSystem, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyAdditional=notifyAdditional, mwg=mwg, kRevision=kRevision, notifyReasonString=notifyReasonString, stConnectionsBlocked=stConnectionsBlocked, pAMSignatureVersion=pAMSignatureVersion, notifyOrigin=notifyOrigin, stCategories=stCategories, stCategoryName=stCategoryName, mwgContent=mwgContent, stMemConsumed=stMemConsumed, notifyAffectedHost=notifyAffectedHost, mwgHttp=mwgHttp, kHotfixVersion=kHotfixVersion, mwgEngineVersions=mwgEngineVersions, trApplication=trApplication, notifyOriginName=notifyOriginName, stFtpBytesToServer=stFtpBytesToServer, kProductName=kProductName, stHttpTraffic=stHttpTraffic, mwgFTP=mwgFTP, kProductVersion=kProductVersion, stHttpsRequests=stHttpsRequests, stCategoriesTable=stCategoriesTable, mwgMiscellaneous=mwgMiscellaneous, trUser=trUser, kCustomVersion=kCustomVersion, stCPULoad=stCPULoad, stCategoryCount=stCategoryCount, stFtpTraffic=stFtpTraffic, stFtpBytesFromClient=stFtpBytesFromClient, stClientCount=stClientCount, stBadReputation=stBadReputation, pAMEngineVersion=pAMEngineVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer)
