...
Unsigned32, mib_2, Counter64, iso, TimeTicks, NotificationType, Counter32, Bits, ObjectIdentity, Gauge32, enterprises, MibIdentifier, ModuleIdentity, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "mib-2", "Counter64", "iso", "TimeTicks", "NotificationType", "Counter32", "Bits", "ObjectIdentity", "Gauge32", "enterprises", "MibIdentifier", "ModuleIdentity", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwg=mwg, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyAffectedHost=notifyAffectedHost, pTSDBVersion=pTSDBVersion, stFtpBytesToServer=stFtpBytesToServer, mwgInfo=mwgInfo, mwgHttps=mwgHttps, notifySeverity=notifySeverity, stCPULoadRaw=stCPULoadRaw, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectionsBlocked=stConnectionsBlocked, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesToServer=stHttpBytesToServer, kCompanyName=kCompanyName, kHotfixVersion=kHotfixVersion, kBuildNumber=kBuildNumber, trApplication=trApplication, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCPUIOWait=stCPUIOWait, stCPULoad=stCPULoad, stMalwareDetected=stMalwareDetected, trUser=trUser, stHttpTraffic=stHttpTraffic, stResolveHostViaDNS=stResolveHostViaDNS, stConnectionsLegitimate=stConnectionsLegitimate, mwgFTP=mwgFTP, stFtpBytesToClient=stFtpBytesToClient, stBadReputation=stBadReputation, stBlockedByURLFilter=stBlockedByURLFilter, mwgHttp=mwgHttp, notifyAdditional=notifyAdditional, mwgEngineVersions=mwgEngineVersions, kMajorVersion=kMajorVersion, stCategoryName=stCategoryName, stHttpBytesFromServer=stHttpBytesFromServer, kRevision=kRevision, kMicroVersion=kMicroVersion, notifyOriginName=notifyOriginName, pMFEEngineVersion=pMFEEngineVersion, stConnectedSockets=stConnectedSockets, kMinorVersion=kMinorVersion, stCategories=stCategories, mwgStatistics=mwgStatistics, mwgContent=mwgContent, mwgTraps=mwgTraps, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, notifyReason=notifyReason, notifyOrigin=notifyOrigin, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kProductVersion=kProductVersion, stTimeForTransaction=stTimeForTransaction, stFtpTraffic=stFtpTraffic, kCustomVersion=kCustomVersion, stFtpBytesFromClient=stFtpBytesFromClient, pAMEngineVersion=pAMEngineVersion, stFtpBytesFromServer=stFtpBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyReasonString=notifyReasonString, stHttpsRequests=stHttpsRequests, stCategoriesEntry=stCategoriesEntry, stBlockedByAntiMalware=stBlockedByAntiMalware, PYSNMP_MODULE_ID=mwg, stCategoryCount=stCategoryCount, stClientCount=stClientCount, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgMiscellaneous=mwgMiscellaneous, trSystem=trSystem, stHttpsTraffic=stHttpsTraffic, stMimeType=stMimeType, pMFEDATVersion=pMFEDATVersion, kProductName=kProductName, mwgTrapVariables=mwgTrapVariables, stHttpRequests=stHttpRequests, stMemConsumed=stMemConsumed, stCategoriesTable=stCategoriesTable, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesFromClient=stHttpsBytesFromClient)
