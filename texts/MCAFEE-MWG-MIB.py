...
MibIdentifier, mib_2, enterprises, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, ModuleIdentity, iso, Unsigned32, Counter64, IpAddress, Counter32, Gauge32, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "mib-2", "enterprises", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "ModuleIdentity", "iso", "Unsigned32", "Counter64", "IpAddress", "Counter32", "Gauge32", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesToServer=stHttpBytesToServer, stBadReputation=stBadReputation, stHandleConnectToServer=stHandleConnectToServer, stCPUIOWait=stCPUIOWait, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyOriginName=notifyOriginName, kCompanyName=kCompanyName, stTimeForTransaction=stTimeForTransaction, kProductVersion=kProductVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoryCount=stCategoryCount, kMinorVersion=kMinorVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgStatistics=mwgStatistics, stHttpsBytesToClient=stHttpsBytesToClient, stConnectionsBlocked=stConnectionsBlocked, kCustomVersion=kCustomVersion, mwg=mwg, stCategoriesTable=stCategoriesTable, pTSDBVersion=pTSDBVersion, stHttpsRequests=stHttpsRequests, pAMProactiveVersion=pAMProactiveVersion, notifyOrigin=notifyOrigin, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, trSystem=trSystem, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stMemConsumed=stMemConsumed, stConnectedSockets=stConnectedSockets, stHttpsBytesFromClient=stHttpsBytesFromClient, stClientCount=stClientCount, kMajorVersion=kMajorVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgTraps=mwgTraps, stHttpsBytesToServer=stHttpsBytesToServer, kMicroVersion=kMicroVersion, pAMEngineVersion=pAMEngineVersion, kHotfixVersion=kHotfixVersion, stCategories=stCategories, stCategoryName=stCategoryName, notifySeverity=notifySeverity, stCategoriesEntry=stCategoriesEntry, notifyReasonString=notifyReasonString, stHttpTraffic=stHttpTraffic, stHttpBytesFromServer=stHttpBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, kRevision=kRevision, stMimeType=stMimeType, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesToClient=stHttpBytesToClient, mwgHttp=mwgHttp, mwgFTP=mwgFTP, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kProductName=kProductName, PYSNMP_MODULE_ID=mwg, stConnectionsLegitimate=stConnectionsLegitimate, mwgMiscellaneous=mwgMiscellaneous, pMFEDATVersion=pMFEDATVersion, mwgInfo=mwgInfo, mwgHttps=mwgHttps, notifyAffectedHost=notifyAffectedHost, stMalwareDetected=stMalwareDetected, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyReason=notifyReason, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, stFtpTraffic=stFtpTraffic, mwgContent=mwgContent, stCPULoad=stCPULoad, stResolveHostViaDNS=stResolveHostViaDNS, trUser=trUser, mwgTrapVariables=mwgTrapVariables, pMFEEngineVersion=pMFEEngineVersion, mwgEngineVersions=mwgEngineVersions, trApplication=trApplication, notifyAdditional=notifyAdditional, stHttpRequests=stHttpRequests, stCPULoadRaw=stCPULoadRaw, stHttpsTraffic=stHttpsTraffic, kBuildNumber=kBuildNumber)
