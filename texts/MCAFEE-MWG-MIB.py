...
ObjectIdentity, Gauge32, Counter64, mib_2, MibIdentifier, TimeTicks, Bits, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, iso, Counter32, Integer32, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "Counter64", "mib-2", "MibIdentifier", "TimeTicks", "Bits", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "iso", "Counter32", "Integer32", "ModuleIdentity", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMalwareDetected=stMalwareDetected, notifyOrigin=notifyOrigin, kProductVersion=kProductVersion, stMemConsumed=stMemConsumed, stBadReputation=stBadReputation, mwgEngineVersions=mwgEngineVersions, stConnectedSockets=stConnectedSockets, stFtpTraffic=stFtpTraffic, notifyAdditional=notifyAdditional, mwg=mwg, stCPULoadRaw=stCPULoadRaw, notifySeverity=notifySeverity, stHttpBytesFromServer=stHttpBytesFromServer, kMinorVersion=kMinorVersion, mwgFTP=mwgFTP, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsTraffic=stHttpsTraffic, kHotfixVersion=kHotfixVersion, stCPUIOWait=stCPUIOWait, stHttpTraffic=stHttpTraffic, pMFEDATVersion=pMFEDATVersion, pAMProactiveVersion=pAMProactiveVersion, notifyOriginName=notifyOriginName, stBlockedByAntiMalware=stBlockedByAntiMalware, kMicroVersion=kMicroVersion, stHttpRequests=stHttpRequests, stFtpBytesToClient=stFtpBytesToClient, kProductName=kProductName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgHttps=mwgHttps, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoryCount=stCategoryCount, notifyAffectedHost=notifyAffectedHost, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, trSystem=trSystem, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoriesTable=stCategoriesTable, mwgMiscellaneous=mwgMiscellaneous, trUser=trUser, kCustomVersion=kCustomVersion, stCategories=stCategories, stHttpBytesToServer=stHttpBytesToServer, stCategoriesEntry=stCategoriesEntry, stMimeType=stMimeType, stClientCount=stClientCount, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesFromServer=stFtpBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS, pAMEngineVersion=pAMEngineVersion, stHttpsBytesToClient=stHttpsBytesToClient, kCompanyName=kCompanyName, pTSDBVersion=pTSDBVersion, mwgTraps=mwgTraps, mwgTrapVariables=mwgTrapVariables, pMFEEngineVersion=pMFEEngineVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kRevision=kRevision, PYSNMP_MODULE_ID=mwg, stHttpBytesToClient=stHttpBytesToClient, stCPULoad=stCPULoad, mwgHttp=mwgHttp, trApplication=trApplication, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMSignatureVersion=pAMSignatureVersion, notifyReasonString=notifyReasonString, stConnectionsLegitimate=stConnectionsLegitimate, kBuildNumber=kBuildNumber, notifyReason=notifyReason, stHttpsRequests=stHttpsRequests, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesToServer=stHttpsBytesToServer, stCategoryName=stCategoryName, mwgInfo=mwgInfo, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgContent=mwgContent, stHandleConnectToServer=stHandleConnectToServer, stTimeForTransaction=stTimeForTransaction, mwgStatistics=mwgStatistics, kMajorVersion=kMajorVersion, stFtpBytesFromClient=stFtpBytesFromClient)
