...
Unsigned32, Gauge32, Counter64, MibIdentifier, enterprises, ModuleIdentity, Bits, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, IpAddress, TimeTicks, mib_2, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "Counter64", "MibIdentifier", "enterprises", "ModuleIdentity", "Bits", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "IpAddress", "TimeTicks", "mib-2", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoryName=stCategoryName, stHandleConnectToServer=stHandleConnectToServer, notifyAffectedHost=notifyAffectedHost, mwgTraps=mwgTraps, stCategoryCount=stCategoryCount, stHttpsRequests=stHttpsRequests, stCategories=stCategories, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, stCPULoad=stCPULoad, trSystem=trSystem, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kCustomVersion=kCustomVersion, stFtpBytesToServer=stFtpBytesToServer, notifyOriginName=notifyOriginName, pAMSignatureVersion=pAMSignatureVersion, mwgHttps=mwgHttps, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpTraffic=stFtpTraffic, mwg=mwg, kMicroVersion=kMicroVersion, kMajorVersion=kMajorVersion, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromClient=stHttpBytesFromClient, notifyReasonString=notifyReasonString, stHttpsBytesToClient=stHttpsBytesToClient, kProductVersion=kProductVersion, kProductName=kProductName, notifyAdditional=notifyAdditional, kHotfixVersion=kHotfixVersion, stBlockedByURLFilter=stBlockedByURLFilter, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMemConsumed=stMemConsumed, stHttpTraffic=stHttpTraffic, trUser=trUser, notifyReason=notifyReason, PYSNMP_MODULE_ID=mwg, stConnectedSockets=stConnectedSockets, stTimeForTransaction=stTimeForTransaction, stClientCount=stClientCount, mwgInfo=mwgInfo, pMFEEngineVersion=pMFEEngineVersion, pAMProactiveVersion=pAMProactiveVersion, mwgFTP=mwgFTP, stHttpRequests=stHttpRequests, pAMEngineVersion=pAMEngineVersion, stFtpBytesFromServer=stFtpBytesFromServer, kCompanyName=kCompanyName, notifyOrigin=notifyOrigin, stHttpBytesToClient=stHttpBytesToClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBadReputation=stBadReputation, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, mwgTrapVariables=mwgTrapVariables, notifySeverity=notifySeverity, stFtpBytesToClient=stFtpBytesToClient, stResolveHostViaDNS=stResolveHostViaDNS, kMinorVersion=kMinorVersion, mwgHttp=mwgHttp, trApplication=trApplication, mwgContent=mwgContent, stBlockedByMediaFilter=stBlockedByMediaFilter, pMFEDATVersion=pMFEDATVersion, stCategoriesTable=stCategoriesTable, stHttpBytesToServer=stHttpBytesToServer, stCategoriesEntry=stCategoriesEntry, mwgEngineVersions=mwgEngineVersions, stHttpsTraffic=stHttpsTraffic, stCPULoadRaw=stCPULoadRaw, mwgStatistics=mwgStatistics, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesFromServer=stHttpsBytesFromServer, stMimeType=stMimeType, mwgMiscellaneous=mwgMiscellaneous, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kRevision=kRevision, pTSDBVersion=pTSDBVersion, kBuildNumber=kBuildNumber, stCPUIOWait=stCPUIOWait)
