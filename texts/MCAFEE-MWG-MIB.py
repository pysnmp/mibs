...
Counter64, mib_2, IpAddress, ModuleIdentity, Gauge32, enterprises, ObjectIdentity, Unsigned32, Counter32, NotificationType, NotificationType, iso, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "mib-2", "IpAddress", "ModuleIdentity", "Gauge32", "enterprises", "ObjectIdentity", "Unsigned32", "Counter32", "NotificationType", "NotificationType", "iso", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgMiscellaneous=mwgMiscellaneous, mwgContent=mwgContent, stConnectedSockets=stConnectedSockets, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsBytesToServer=stHttpsBytesToServer, pAMProactiveVersion=pAMProactiveVersion, pAMEngineVersion=pAMEngineVersion, mwgEngineVersions=mwgEngineVersions, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsBlocked=stConnectionsBlocked, stCPULoadRaw=stCPULoadRaw, stCategoryName=stCategoryName, stHttpsRequests=stHttpsRequests, stHttpBytesToClient=stHttpBytesToClient, stCPUIOWait=stCPUIOWait, stFtpBytesToClient=stFtpBytesToClient, mwgInfo=mwgInfo, stCategoriesEntry=stCategoriesEntry, notifyOrigin=notifyOrigin, stHttpsTraffic=stHttpsTraffic, stBlockedByURLFilter=stBlockedByURLFilter, stCategoryCount=stCategoryCount, kCompanyName=kCompanyName, mwg=mwg, stCPULoad=stCPULoad, notifyAdditional=notifyAdditional, pTSDBVersion=pTSDBVersion, stHttpRequests=stHttpRequests, trSystem=trSystem, notifyOriginName=notifyOriginName, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgTraps=mwgTraps, kMicroVersion=kMicroVersion, stFtpBytesToServer=stFtpBytesToServer, trUser=trUser, PYSNMP_MODULE_ID=mwg, stMalwareDetected=stMalwareDetected, stHandleConnectToServer=stHandleConnectToServer, kHotfixVersion=kHotfixVersion, trApplication=trApplication, kRevision=kRevision, notifyReasonString=notifyReasonString, stClientCount=stClientCount, stMimeType=stMimeType, mwgStatistics=mwgStatistics, mwgHttps=mwgHttps, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesToServer=stHttpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesFromServer=stHttpBytesFromServer, stBadReputation=stBadReputation, kCustomVersion=kCustomVersion, stHttpBytesFromClient=stHttpBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifySeverity=notifySeverity, notifyReason=notifyReason, kBuildNumber=kBuildNumber, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesToClient=stHttpsBytesToClient, stMemConsumed=stMemConsumed, stHttpsBytesFromServer=stHttpsBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS, mwgHttp=mwgHttp, stFtpBytesFromClient=stFtpBytesFromClient, stCategoriesTable=stCategoriesTable, stHttpTraffic=stHttpTraffic, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pMFEDATVersion=pMFEDATVersion, kProductName=kProductName, kMajorVersion=kMajorVersion, mwgFTP=mwgFTP, notifyAffectedHost=notifyAffectedHost, stTimeForTransaction=stTimeForTransaction, mwgTrapVariables=mwgTrapVariables, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pMFEEngineVersion=pMFEEngineVersion, stCategories=stCategories, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesFromServer=stFtpBytesFromServer, kMinorVersion=kMinorVersion, kProductVersion=kProductVersion, stFtpTraffic=stFtpTraffic)
