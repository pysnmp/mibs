...
IpAddress, NotificationType, ObjectIdentity, Integer32, Counter32, Gauge32, Counter64, mib_2, enterprises, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, Unsigned32, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "ObjectIdentity", "Integer32", "Counter32", "Gauge32", "Counter64", "mib-2", "enterprises", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "Unsigned32", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesToServer=stHttpBytesToServer, mwgTrapVariables=mwgTrapVariables, notifyAffectedHost=notifyAffectedHost, kMajorVersion=kMajorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoryCount=stCategoryCount, PYSNMP_MODULE_ID=mwg, stHttpBytesFromServer=stHttpBytesFromServer, mwgStatistics=mwgStatistics, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpTraffic=stHttpTraffic, pMFEDATVersion=pMFEDATVersion, stCategories=stCategories, kRevision=kRevision, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesToServer=stFtpBytesToServer, kCompanyName=kCompanyName, stConnectedSockets=stConnectedSockets, stClientCount=stClientCount, mwgTraps=mwgTraps, mwgHttp=mwgHttp, stFtpTraffic=stFtpTraffic, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, mwgFTP=mwgFTP, mwgInfo=mwgInfo, kProductVersion=kProductVersion, stHandleConnectToServer=stHandleConnectToServer, notifyOrigin=notifyOrigin, stCPULoadRaw=stCPULoadRaw, stCPUIOWait=stCPUIOWait, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kHotfixVersion=kHotfixVersion, stFtpBytesFromServer=stFtpBytesFromServer, notifySeverity=notifySeverity, stFtpBytesToClient=stFtpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, stHttpsRequests=stHttpsRequests, stCategoriesTable=stCategoriesTable, notifyReasonString=notifyReasonString, mwgMiscellaneous=mwgMiscellaneous, mwg=mwg, mwgEngineVersions=mwgEngineVersions, pAMEngineVersion=pAMEngineVersion, kMinorVersion=kMinorVersion, stResolveHostViaDNS=stResolveHostViaDNS, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyOriginName=notifyOriginName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsTraffic=stHttpsTraffic, stMemConsumed=stMemConsumed, stMimeType=stMimeType, stHttpsBytesFromServer=stHttpsBytesFromServer, kBuildNumber=kBuildNumber, stHttpBytesToClient=stHttpBytesToClient, stCPULoad=stCPULoad, trUser=trUser, kMicroVersion=kMicroVersion, stTimeForTransaction=stTimeForTransaction, kProductName=kProductName, stFtpBytesFromClient=stFtpBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesToServer=stHttpsBytesToServer, trSystem=trSystem, mwgContent=mwgContent, trApplication=trApplication, stCategoriesEntry=stCategoriesEntry, stHttpRequests=stHttpRequests, pTSDBVersion=pTSDBVersion, stMalwareDetected=stMalwareDetected, stHttpsBytesToClient=stHttpsBytesToClient, stCategoryName=stCategoryName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgHttps=mwgHttps, stConnectionsBlocked=stConnectionsBlocked, pAMProactiveVersion=pAMProactiveVersion, notifyReason=notifyReason, kCustomVersion=kCustomVersion, stBadReputation=stBadReputation, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyAdditional=notifyAdditional)
