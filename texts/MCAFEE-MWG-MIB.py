...
enterprises, Counter32, iso, Integer32, ModuleIdentity, Counter64, Unsigned32, Bits, ObjectIdentity, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, IpAddress, mib_2, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "iso", "Integer32", "ModuleIdentity", "Counter64", "Unsigned32", "Bits", "ObjectIdentity", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "IpAddress", "mib-2", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMalwareDetected=stMalwareDetected, pMFEEngineVersion=pMFEEngineVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoriesTable=stCategoriesTable, stCategories=stCategories, pAMSignatureVersion=pAMSignatureVersion, stHttpsRequests=stHttpsRequests, mwgStatistics=mwgStatistics, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpTraffic=stFtpTraffic, stCategoryCount=stCategoryCount, stCPUIOWait=stCPUIOWait, trSystem=trSystem, mwgFTP=mwgFTP, stFtpBytesToClient=stFtpBytesToClient, stClientCount=stClientCount, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyOriginName=notifyOriginName, notifySeverity=notifySeverity, kProductName=kProductName, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesToClient=stHttpBytesToClient, mwgInfo=mwgInfo, kMicroVersion=kMicroVersion, stBadReputation=stBadReputation, mwgTraps=mwgTraps, pMFEDATVersion=pMFEDATVersion, stCategoriesEntry=stCategoriesEntry, mwgHttp=mwgHttp, mwgHttps=mwgHttps, notifyReason=notifyReason, stCPULoadRaw=stCPULoadRaw, kHotfixVersion=kHotfixVersion, PYSNMP_MODULE_ID=mwg, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesFromServer=stFtpBytesFromServer, stHttpRequests=stHttpRequests, stResolveHostViaDNS=stResolveHostViaDNS, kRevision=kRevision, mwgContent=mwgContent, kCustomVersion=kCustomVersion, kMinorVersion=kMinorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpTraffic=stHttpTraffic, trApplication=trApplication, trUser=trUser, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesToServer=stHttpsBytesToServer, mwg=mwg, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kBuildNumber=kBuildNumber, mwgTrapVariables=mwgTrapVariables, notifyOrigin=notifyOrigin, stBlockedByAntiMalware=stBlockedByAntiMalware, pTSDBVersion=pTSDBVersion, stCPULoad=stCPULoad, stHttpsBytesToClient=stHttpsBytesToClient, kCompanyName=kCompanyName, stConnectionsLegitimate=stConnectionsLegitimate, stConnectedSockets=stConnectedSockets, stTimeForTransaction=stTimeForTransaction, stHandleConnectToServer=stHandleConnectToServer, kMajorVersion=kMajorVersion, notifyAdditional=notifyAdditional, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgEngineVersions=mwgEngineVersions, pAMProactiveVersion=pAMProactiveVersion, pAMEngineVersion=pAMEngineVersion, notifyReasonString=notifyReasonString, stHttpsTraffic=stHttpsTraffic, stMimeType=stMimeType, notifyAffectedHost=notifyAffectedHost, stCategoryName=stCategoryName, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesToServer=stHttpBytesToServer, kProductVersion=kProductVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stMemConsumed=stMemConsumed)
