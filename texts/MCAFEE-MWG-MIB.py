...
Unsigned32, Counter32, ModuleIdentity, Counter64, mib_2, ObjectIdentity, Gauge32, enterprises, NotificationType, TimeTicks, Bits, MibIdentifier, Integer32, NotificationType, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "ModuleIdentity", "Counter64", "mib-2", "ObjectIdentity", "Gauge32", "enterprises", "NotificationType", "TimeTicks", "Bits", "MibIdentifier", "Integer32", "NotificationType", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMProactiveVersion=pAMProactiveVersion, stMalwareDetected=stMalwareDetected, kBuildNumber=kBuildNumber, kRevision=kRevision, mwgInfo=mwgInfo, mwgStatistics=mwgStatistics, stHttpsBytesToServer=stHttpsBytesToServer, stClientCount=stClientCount, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pTSDBVersion=pTSDBVersion, stHttpRequests=stHttpRequests, stFtpBytesFromServer=stFtpBytesFromServer, kProductVersion=kProductVersion, mwgFTP=mwgFTP, stCategoriesTable=stCategoriesTable, pMFEEngineVersion=pMFEEngineVersion, mwg=mwg, notifyOrigin=notifyOrigin, notifyAdditional=notifyAdditional, stHttpBytesFromClient=stHttpBytesFromClient, stCPULoadRaw=stCPULoadRaw, kCustomVersion=kCustomVersion, stHttpsTraffic=stHttpsTraffic, mwgContent=mwgContent, mwgEngineVersions=mwgEngineVersions, notifyReason=notifyReason, stHttpBytesToServer=stHttpBytesToServer, kCompanyName=kCompanyName, kMajorVersion=kMajorVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgHttp=mwgHttp, pAMSignatureVersion=pAMSignatureVersion, stCPULoad=stCPULoad, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsRequests=stHttpsRequests, mwgTrapVariables=mwgTrapVariables, kProductName=kProductName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyOriginName=notifyOriginName, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgTraps=mwgTraps, stMimeType=stMimeType, stHttpBytesFromServer=stHttpBytesFromServer, stBadReputation=stBadReputation, stMemConsumed=stMemConsumed, notifyAffectedHost=notifyAffectedHost, pAMEngineVersion=pAMEngineVersion, stHttpBytesToClient=stHttpBytesToClient, kHotfixVersion=kHotfixVersion, stConnectedSockets=stConnectedSockets, PYSNMP_MODULE_ID=mwg, stHttpsBytesToClient=stHttpsBytesToClient, stCategoriesEntry=stCategoriesEntry, stHttpTraffic=stHttpTraffic, trApplication=trApplication, mwgHttps=mwgHttps, stConnectionsLegitimate=stConnectionsLegitimate, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHandleConnectToServer=stHandleConnectToServer, mwgMiscellaneous=mwgMiscellaneous, stFtpTraffic=stFtpTraffic, stCategoryName=stCategoryName, notifyReasonString=notifyReasonString, pMFEDATVersion=pMFEDATVersion, stConnectionsBlocked=stConnectionsBlocked, kMinorVersion=kMinorVersion, stFtpBytesToClient=stFtpBytesToClient, stTimeForTransaction=stTimeForTransaction, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCPUIOWait=stCPUIOWait, stHttpsBytesFromClient=stHttpsBytesFromClient, trSystem=trSystem, trUser=trUser, kMicroVersion=kMicroVersion, stCategoryCount=stCategoryCount, notifySeverity=notifySeverity, stFtpBytesFromClient=stFtpBytesFromClient, stBlockedByURLFilter=stBlockedByURLFilter, stCategories=stCategories, stFtpBytesToServer=stFtpBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS)
