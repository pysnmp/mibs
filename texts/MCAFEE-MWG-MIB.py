...
IpAddress, Counter64, Unsigned32, NotificationType, Gauge32, TimeTicks, NotificationType, ModuleIdentity, ObjectIdentity, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Integer32, enterprises, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "Unsigned32", "NotificationType", "Gauge32", "TimeTicks", "NotificationType", "ModuleIdentity", "ObjectIdentity", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Integer32", "enterprises", "Bits", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMSignatureVersion=pAMSignatureVersion, notifySeverity=notifySeverity, kCustomVersion=kCustomVersion, stCPUIOWait=stCPUIOWait, stHandleConnectToServer=stHandleConnectToServer, mwgMiscellaneous=mwgMiscellaneous, stLastSentLastReceivedServer=stLastSentLastReceivedServer, trUser=trUser, stCPULoad=stCPULoad, mwgTraps=mwgTraps, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesToServer=stHttpBytesToServer, stFtpTraffic=stFtpTraffic, kProductName=kProductName, kMicroVersion=kMicroVersion, stFtpBytesToServer=stFtpBytesToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, kMinorVersion=kMinorVersion, kBuildNumber=kBuildNumber, pAMEngineVersion=pAMEngineVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsTraffic=stHttpsTraffic, mwg=mwg, kRevision=kRevision, mwgContent=mwgContent, stHttpsBytesToServer=stHttpsBytesToServer, trSystem=trSystem, mwgStatistics=mwgStatistics, stCategoryName=stCategoryName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectionsBlocked=stConnectionsBlocked, stMalwareDetected=stMalwareDetected, stFtpBytesFromClient=stFtpBytesFromClient, stConnectionsLegitimate=stConnectionsLegitimate, pMFEEngineVersion=pMFEEngineVersion, kHotfixVersion=kHotfixVersion, stBlockedByURLFilter=stBlockedByURLFilter, mwgEngineVersions=mwgEngineVersions, trApplication=trApplication, stResolveHostViaDNS=stResolveHostViaDNS, notifyOrigin=notifyOrigin, notifyReasonString=notifyReasonString, mwgFTP=mwgFTP, stCPULoadRaw=stCPULoadRaw, stCategoryCount=stCategoryCount, stHttpRequests=stHttpRequests, stHttpsBytesToClient=stHttpsBytesToClient, notifyReason=notifyReason, stFtpBytesFromServer=stFtpBytesFromServer, stBadReputation=stBadReputation, pAMProactiveVersion=pAMProactiveVersion, stHttpsRequests=stHttpsRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMajorVersion=kMajorVersion, notifyAffectedHost=notifyAffectedHost, stConnectedSockets=stConnectedSockets, notifyAdditional=notifyAdditional, mwgHttps=mwgHttps, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgInfo=mwgInfo, notifyOriginName=notifyOriginName, stHttpBytesFromServer=stHttpBytesFromServer, stClientCount=stClientCount, stMemConsumed=stMemConsumed, mwgTrapVariables=mwgTrapVariables, stHttpBytesToClient=stHttpBytesToClient, pMFEDATVersion=pMFEDATVersion, kCompanyName=kCompanyName, stCategoriesEntry=stCategoriesEntry, stHttpBytesFromClient=stHttpBytesFromClient, pTSDBVersion=pTSDBVersion, mwgHttp=mwgHttp, stCategoriesTable=stCategoriesTable, stMimeType=stMimeType, stTimeForTransaction=stTimeForTransaction, kProductVersion=kProductVersion, stHttpTraffic=stHttpTraffic, stCategories=stCategories, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, PYSNMP_MODULE_ID=mwg, stFtpBytesToClient=stFtpBytesToClient)
