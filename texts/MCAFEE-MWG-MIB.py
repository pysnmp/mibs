...
enterprises, Gauge32, iso, Integer32, IpAddress, MibIdentifier, TimeTicks, ObjectIdentity, NotificationType, NotificationType, Unsigned32, Bits, Counter64, mib_2, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "iso", "Integer32", "IpAddress", "MibIdentifier", "TimeTicks", "ObjectIdentity", "NotificationType", "NotificationType", "Unsigned32", "Bits", "Counter64", "mib-2", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stResolveHostViaDNS=stResolveHostViaDNS, mwgFTP=mwgFTP, stHttpBytesFromClient=stHttpBytesFromClient, stConnectedSockets=stConnectedSockets, pMFEDATVersion=pMFEDATVersion, stFtpBytesFromServer=stFtpBytesFromServer, notifyReason=notifyReason, mwgContent=mwgContent, kMinorVersion=kMinorVersion, notifyOrigin=notifyOrigin, mwgInfo=mwgInfo, stHttpBytesToClient=stHttpBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsRequests=stHttpsRequests, pTSDBVersion=pTSDBVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMEngineVersion=pAMEngineVersion, kBuildNumber=kBuildNumber, mwgHttp=mwgHttp, stHttpTraffic=stHttpTraffic, mwgMiscellaneous=mwgMiscellaneous, pAMProactiveVersion=pAMProactiveVersion, kProductName=kProductName, stCategoryName=stCategoryName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwg=mwg, notifyAffectedHost=notifyAffectedHost, stMalwareDetected=stMalwareDetected, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsTraffic=stHttpsTraffic, stBlockedByAntiMalware=stBlockedByAntiMalware, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pAMSignatureVersion=pAMSignatureVersion, mwgTraps=mwgTraps, stHttpRequests=stHttpRequests, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesToServer=stHttpsBytesToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoriesTable=stCategoriesTable, PYSNMP_MODULE_ID=mwg, stFtpBytesToClient=stFtpBytesToClient, mwgStatistics=mwgStatistics, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyOriginName=notifyOriginName, stHandleConnectToServer=stHandleConnectToServer, kProductVersion=kProductVersion, notifySeverity=notifySeverity, pMFEEngineVersion=pMFEEngineVersion, kRevision=kRevision, kMicroVersion=kMicroVersion, kHotfixVersion=kHotfixVersion, stFtpBytesFromClient=stFtpBytesFromClient, stMemConsumed=stMemConsumed, stHttpsBytesFromServer=stHttpsBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, notifyAdditional=notifyAdditional, stFtpTraffic=stFtpTraffic, mwgHttps=mwgHttps, mwgTrapVariables=mwgTrapVariables, kCompanyName=kCompanyName, stFtpBytesToServer=stFtpBytesToServer, stCPULoad=stCPULoad, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromServer=stHttpBytesFromServer, trUser=trUser, kCustomVersion=kCustomVersion, notifyReasonString=notifyReasonString, stTimeForTransaction=stTimeForTransaction, trSystem=trSystem, stCategoriesEntry=stCategoriesEntry, stCPULoadRaw=stCPULoadRaw, stCategoryCount=stCategoryCount, trApplication=trApplication, stBadReputation=stBadReputation, stHttpsBytesToClient=stHttpsBytesToClient, stCPUIOWait=stCPUIOWait, mwgEngineVersions=mwgEngineVersions, stMimeType=stMimeType, stCategories=stCategories, stClientCount=stClientCount, kMajorVersion=kMajorVersion, stConnectionsBlocked=stConnectionsBlocked)
