...
mib_2, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, Bits, TimeTicks, Counter32, Gauge32, ModuleIdentity, IpAddress, MibIdentifier, Unsigned32, iso, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "Bits", "TimeTicks", "Counter32", "Gauge32", "ModuleIdentity", "IpAddress", "MibIdentifier", "Unsigned32", "iso", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsTraffic=stHttpsTraffic, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsRequests=stHttpsRequests, mwgFTP=mwgFTP, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedServer=stLastSentLastReceivedServer, PYSNMP_MODULE_ID=mwg, stHttpBytesToServer=stHttpBytesToServer, notifyReason=notifyReason, stResolveHostViaDNS=stResolveHostViaDNS, mwgInfo=mwgInfo, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMicroVersion=kMicroVersion, stHttpTraffic=stHttpTraffic, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stClientCount=stClientCount, pAMProactiveVersion=pAMProactiveVersion, mwgStatistics=mwgStatistics, notifySeverity=notifySeverity, stHttpsBytesFromClient=stHttpsBytesFromClient, kProductVersion=kProductVersion, kHotfixVersion=kHotfixVersion, stHandleConnectToServer=stHandleConnectToServer, trSystem=trSystem, kBuildNumber=kBuildNumber, stMalwareDetected=stMalwareDetected, stFtpTraffic=stFtpTraffic, notifyAdditional=notifyAdditional, stFtpBytesToServer=stFtpBytesToServer, trApplication=trApplication, stHttpsBytesFromServer=stHttpsBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesToServer=stHttpsBytesToServer, pTSDBVersion=pTSDBVersion, mwgTraps=mwgTraps, stCPULoad=stCPULoad, stCPUIOWait=stCPUIOWait, mwgHttps=mwgHttps, pAMEngineVersion=pAMEngineVersion, stBadReputation=stBadReputation, mwgContent=mwgContent, pMFEDATVersion=pMFEDATVersion, kRevision=kRevision, trUser=trUser, mwgHttp=mwgHttp, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, mwgMiscellaneous=mwgMiscellaneous, notifyOriginName=notifyOriginName, pAMSignatureVersion=pAMSignatureVersion, stCategories=stCategories, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoryCount=stCategoryCount, notifyAffectedHost=notifyAffectedHost, kCompanyName=kCompanyName, stCategoryName=stCategoryName, stMemConsumed=stMemConsumed, stCategoriesEntry=stCategoriesEntry, kMinorVersion=kMinorVersion, mwgTrapVariables=mwgTrapVariables, kProductName=kProductName, kMajorVersion=kMajorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesToClient=stHttpBytesToClient, notifyReasonString=notifyReasonString, stMimeType=stMimeType, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kCustomVersion=kCustomVersion, stCPULoadRaw=stCPULoadRaw, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgEngineVersions=mwgEngineVersions, mwg=mwg, stConnectedSockets=stConnectedSockets, stCategoriesTable=stCategoriesTable, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesFromClient=stHttpBytesFromClient, notifyOrigin=notifyOrigin, stHttpsBytesToClient=stHttpsBytesToClient, pMFEEngineVersion=pMFEEngineVersion, stTimeForTransaction=stTimeForTransaction, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpRequests=stHttpRequests)
