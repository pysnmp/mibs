...
enterprises, NotificationType, iso, Bits, TimeTicks, Counter32, ObjectIdentity, mib_2, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, Gauge32, Counter64, NotificationType, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "iso", "Bits", "TimeTicks", "Counter32", "ObjectIdentity", "mib-2", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "Gauge32", "Counter64", "NotificationType", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyAffectedHost=notifyAffectedHost, mwgFTP=mwgFTP, kRevision=kRevision, stFtpBytesFromServer=stFtpBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesToServer=stHttpBytesToServer, kHotfixVersion=kHotfixVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgTraps=mwgTraps, stMimeType=stMimeType, trApplication=trApplication, stFtpBytesToClient=stFtpBytesToClient, stHttpsRequests=stHttpsRequests, stCPULoad=stCPULoad, notifyAdditional=notifyAdditional, kProductName=kProductName, mwgTrapVariables=mwgTrapVariables, stConnectionsLegitimate=stConnectionsLegitimate, kCustomVersion=kCustomVersion, notifySeverity=notifySeverity, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgContent=mwgContent, kMinorVersion=kMinorVersion, stCPULoadRaw=stCPULoadRaw, stCategoriesEntry=stCategoriesEntry, stBadReputation=stBadReputation, stCPUIOWait=stCPUIOWait, notifyOrigin=notifyOrigin, stHttpTraffic=stHttpTraffic, stMemConsumed=stMemConsumed, stHttpsBytesToClient=stHttpsBytesToClient, stConnectionsBlocked=stConnectionsBlocked, mwgStatistics=mwgStatistics, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stTimeForTransaction=stTimeForTransaction, pMFEDATVersion=pMFEDATVersion, kMajorVersion=kMajorVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trSystem=trSystem, mwgMiscellaneous=mwgMiscellaneous, mwgEngineVersions=mwgEngineVersions, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesToClient=stHttpBytesToClient, stCategoryCount=stCategoryCount, stHttpBytesFromServer=stHttpBytesFromServer, notifyOriginName=notifyOriginName, stHttpRequests=stHttpRequests, kMicroVersion=kMicroVersion, trUser=trUser, mwgHttp=mwgHttp, pMFEEngineVersion=pMFEEngineVersion, stClientCount=stClientCount, PYSNMP_MODULE_ID=mwg, kProductVersion=kProductVersion, mwgHttps=mwgHttps, stFtpTraffic=stFtpTraffic, stMalwareDetected=stMalwareDetected, notifyReason=notifyReason, pTSDBVersion=pTSDBVersion, stHttpBytesFromClient=stHttpBytesFromClient, stResolveHostViaDNS=stResolveHostViaDNS, notifyReasonString=notifyReasonString, stCategoriesTable=stCategoriesTable, stHttpsTraffic=stHttpsTraffic, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgInfo=mwgInfo, stHttpsBytesToServer=stHttpsBytesToServer, kBuildNumber=kBuildNumber, mwg=mwg, stCategoryName=stCategoryName, pAMSignatureVersion=pAMSignatureVersion, stBlockedByURLFilter=stBlockedByURLFilter, stCategories=stCategories, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMProactiveVersion=pAMProactiveVersion, pAMEngineVersion=pAMEngineVersion, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesToServer=stFtpBytesToServer, kCompanyName=kCompanyName, stConnectedSockets=stConnectedSockets)
