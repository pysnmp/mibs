...
TimeTicks, Bits, Integer32, enterprises, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, IpAddress, NotificationType, ModuleIdentity, NotificationType, iso, Counter32, ObjectIdentity, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "Integer32", "enterprises", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "IpAddress", "NotificationType", "ModuleIdentity", "NotificationType", "iso", "Counter32", "ObjectIdentity", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesFromServer=stHttpBytesFromServer, stMalwareDetected=stMalwareDetected, stHttpsTraffic=stHttpsTraffic, stHandleConnectToServer=stHandleConnectToServer, stCPULoad=stCPULoad, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kRevision=kRevision, kMajorVersion=kMajorVersion, mwgTrapVariables=mwgTrapVariables, stCategoriesEntry=stCategoriesEntry, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kCustomVersion=kCustomVersion, stCategoriesTable=stCategoriesTable, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgInfo=mwgInfo, kMicroVersion=kMicroVersion, stFtpBytesFromClient=stFtpBytesFromClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgEngineVersions=mwgEngineVersions, stFtpBytesFromServer=stFtpBytesFromServer, notifyReasonString=notifyReasonString, mwgStatistics=mwgStatistics, pAMEngineVersion=pAMEngineVersion, kBuildNumber=kBuildNumber, stConnectedSockets=stConnectedSockets, mwgFTP=mwgFTP, stHttpBytesToServer=stHttpBytesToServer, pTSDBVersion=pTSDBVersion, stTimeForTransaction=stTimeForTransaction, stHttpRequests=stHttpRequests, stHttpsRequests=stHttpsRequests, stCategoryName=stCategoryName, stResolveHostViaDNS=stResolveHostViaDNS, kCompanyName=kCompanyName, notifySeverity=notifySeverity, trUser=trUser, mwgContent=mwgContent, kMinorVersion=kMinorVersion, pMFEEngineVersion=pMFEEngineVersion, stCPULoadRaw=stCPULoadRaw, stClientCount=stClientCount, stBlockedByURLFilter=stBlockedByURLFilter, stHttpTraffic=stHttpTraffic, mwgMiscellaneous=mwgMiscellaneous, trSystem=trSystem, mwgHttps=mwgHttps, stCPUIOWait=stCPUIOWait, notifyAdditional=notifyAdditional, notifyReason=notifyReason, mwgTraps=mwgTraps, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMProactiveVersion=pAMProactiveVersion, kProductVersion=kProductVersion, stMemConsumed=stMemConsumed, notifyAffectedHost=notifyAffectedHost, stHttpsBytesToServer=stHttpsBytesToServer, kHotfixVersion=kHotfixVersion, stBadReputation=stBadReputation, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesToServer=stFtpBytesToServer, stConnectionsLegitimate=stConnectionsLegitimate, stFtpTraffic=stFtpTraffic, notifyOriginName=notifyOriginName, stCategories=stCategories, stCategoryCount=stCategoryCount, stHttpsBytesToClient=stHttpsBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pMFEDATVersion=pMFEDATVersion, stMimeType=stMimeType, stFtpBytesToClient=stFtpBytesToClient, stConnectionsBlocked=stConnectionsBlocked, PYSNMP_MODULE_ID=mwg, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, trApplication=trApplication, notifyOrigin=notifyOrigin, stBlockedByAntiMalware=stBlockedByAntiMalware, mwg=mwg, kProductName=kProductName, mwgHttp=mwgHttp, pAMSignatureVersion=pAMSignatureVersion)
