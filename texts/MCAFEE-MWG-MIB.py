...
NotificationType, IpAddress, ObjectIdentity, Gauge32, enterprises, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Bits, Counter64, Counter32, ModuleIdentity, MibIdentifier, Integer32, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "ObjectIdentity", "Gauge32", "enterprises", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Bits", "Counter64", "Counter32", "ModuleIdentity", "MibIdentifier", "Integer32", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMEngineVersion=pAMEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient, stTimeForTransaction=stTimeForTransaction, stCategoriesEntry=stCategoriesEntry, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesFromClient=stHttpsBytesFromClient, kProductVersion=kProductVersion, pMFEDATVersion=pMFEDATVersion, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesToClient=stHttpsBytesToClient, trApplication=trApplication, stMemConsumed=stMemConsumed, mwgHttp=mwgHttp, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesTable=stCategoriesTable, mwgInfo=mwgInfo, pMFEEngineVersion=pMFEEngineVersion, trUser=trUser, pAMSignatureVersion=pAMSignatureVersion, PYSNMP_MODULE_ID=mwg, notifyAdditional=notifyAdditional, notifyOriginName=notifyOriginName, kCompanyName=kCompanyName, mwgEngineVersions=mwgEngineVersions, trSystem=trSystem, kMajorVersion=kMajorVersion, notifyAffectedHost=notifyAffectedHost, stMimeType=stMimeType, kMinorVersion=kMinorVersion, stCategoryCount=stCategoryCount, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kBuildNumber=kBuildNumber, mwgTraps=mwgTraps, kCustomVersion=kCustomVersion, stHttpsBytesToServer=stHttpsBytesToServer, notifySeverity=notifySeverity, mwgMiscellaneous=mwgMiscellaneous, stBlockedByURLFilter=stBlockedByURLFilter, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyOrigin=notifyOrigin, stHttpsTraffic=stHttpsTraffic, kRevision=kRevision, pTSDBVersion=pTSDBVersion, notifyReason=notifyReason, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesToClient=stFtpBytesToClient, stCPULoad=stCPULoad, stFtpTraffic=stFtpTraffic, stHttpRequests=stHttpRequests, stResolveHostViaDNS=stResolveHostViaDNS, mwgContent=mwgContent, stHttpBytesToClient=stHttpBytesToClient, mwgFTP=mwgFTP, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgHttps=mwgHttps, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsRequests=stHttpsRequests, stClientCount=stClientCount, stCPULoadRaw=stCPULoadRaw, stHttpTraffic=stHttpTraffic, stCPUIOWait=stCPUIOWait, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoryName=stCategoryName, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesFromClient=stFtpBytesFromClient, kProductName=kProductName, mwgTrapVariables=mwgTrapVariables, kMicroVersion=kMicroVersion, stFtpBytesToServer=stFtpBytesToServer, mwgStatistics=mwgStatistics, stCategories=stCategories, kHotfixVersion=kHotfixVersion, stFtpBytesFromServer=stFtpBytesFromServer, stMalwareDetected=stMalwareDetected, pAMProactiveVersion=pAMProactiveVersion, stBadReputation=stBadReputation, stBlockedByMediaFilter=stBlockedByMediaFilter, mwg=mwg, notifyReasonString=notifyReasonString, stConnectedSockets=stConnectedSockets)
