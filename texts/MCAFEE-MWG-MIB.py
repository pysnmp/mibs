...
iso, Bits, Gauge32, Counter64, Counter32, TimeTicks, Unsigned32, NotificationType, ObjectIdentity, MibIdentifier, Integer32, enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "Gauge32", "Counter64", "Counter32", "TimeTicks", "Unsigned32", "NotificationType", "ObjectIdentity", "MibIdentifier", "Integer32", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stResolveHostViaDNS=stResolveHostViaDNS, stBadReputation=stBadReputation, stClientCount=stClientCount, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kCompanyName=kCompanyName, stHttpsRequests=stHttpsRequests, PYSNMP_MODULE_ID=mwg, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgContent=mwgContent, stTimeForTransaction=stTimeForTransaction, notifySeverity=notifySeverity, stHttpsBytesToServer=stHttpsBytesToServer, mwgStatistics=mwgStatistics, kProductName=kProductName, stHttpBytesToClient=stHttpBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, trUser=trUser, stBlockedByMediaFilter=stBlockedByMediaFilter, stHandleConnectToServer=stHandleConnectToServer, stHttpsTraffic=stHttpsTraffic, notifyAffectedHost=notifyAffectedHost, notifyOrigin=notifyOrigin, mwgTrapVariables=mwgTrapVariables, stCategoriesTable=stCategoriesTable, mwgMiscellaneous=mwgMiscellaneous, stHttpTraffic=stHttpTraffic, stConnectedSockets=stConnectedSockets, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMicroVersion=kMicroVersion, stHttpBytesFromServer=stHttpBytesFromServer, kRevision=kRevision, stHttpBytesFromClient=stHttpBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, stMemConsumed=stMemConsumed, stCategoriesEntry=stCategoriesEntry, stCategoryName=stCategoryName, mwgInfo=mwgInfo, mwgHttps=mwgHttps, mwgTraps=mwgTraps, notifyOriginName=notifyOriginName, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByAntiMalware=stBlockedByAntiMalware, kCustomVersion=kCustomVersion, stHttpBytesToServer=stHttpBytesToServer, notifyReasonString=notifyReasonString, stHttpsBytesToClient=stHttpsBytesToClient, notifyReason=notifyReason, kHotfixVersion=kHotfixVersion, stCPUIOWait=stCPUIOWait, trSystem=trSystem, pTSDBVersion=pTSDBVersion, pAMEngineVersion=pAMEngineVersion, trApplication=trApplication, stBlockedByURLFilter=stBlockedByURLFilter, kBuildNumber=kBuildNumber, stCategories=stCategories, stHttpRequests=stHttpRequests, mwgHttp=mwgHttp, kProductVersion=kProductVersion, stCategoryCount=stCategoryCount, notifyAdditional=notifyAdditional, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoadRaw=stCPULoadRaw, kMinorVersion=kMinorVersion, stFtpBytesToClient=stFtpBytesToClient, stFtpTraffic=stFtpTraffic, kMajorVersion=kMajorVersion, stMalwareDetected=stMalwareDetected, stFtpBytesFromClient=stFtpBytesFromClient, mwg=mwg, stConnectionsLegitimate=stConnectionsLegitimate, stCPULoad=stCPULoad, stConnectionsBlocked=stConnectionsBlocked, pAMSignatureVersion=pAMSignatureVersion, pMFEDATVersion=pMFEDATVersion, mwgFTP=mwgFTP, stMimeType=stMimeType, mwgEngineVersions=mwgEngineVersions, stFtpBytesToServer=stFtpBytesToServer)
