...
TimeTicks, mib_2, Unsigned32, NotificationType, ObjectIdentity, IpAddress, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, Counter64, Integer32, NotificationType, Bits, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "mib-2", "Unsigned32", "NotificationType", "ObjectIdentity", "IpAddress", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "Counter64", "Integer32", "NotificationType", "Bits", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesFromClient=stHttpBytesFromClient, kMicroVersion=kMicroVersion, kCompanyName=kCompanyName, stHttpBytesToClient=stHttpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, stBadReputation=stBadReputation, notifyAffectedHost=notifyAffectedHost, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kBuildNumber=kBuildNumber, stConnectionsBlocked=stConnectionsBlocked, kRevision=kRevision, pAMEngineVersion=pAMEngineVersion, stFtpBytesToClient=stFtpBytesToClient, mwgTrapVariables=mwgTrapVariables, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHandleConnectToServer=stHandleConnectToServer, mwgEngineVersions=mwgEngineVersions, stFtpBytesToServer=stFtpBytesToServer, notifyOrigin=notifyOrigin, stClientCount=stClientCount, stBlockedByURLFilter=stBlockedByURLFilter, kMajorVersion=kMajorVersion, mwgHttps=mwgHttps, stMalwareDetected=stMalwareDetected, mwg=mwg, stBlockedByMediaFilter=stBlockedByMediaFilter, stMemConsumed=stMemConsumed, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pAMProactiveVersion=pAMProactiveVersion, stConnectionsLegitimate=stConnectionsLegitimate, stHttpTraffic=stHttpTraffic, stHttpsRequests=stHttpsRequests, stMimeType=stMimeType, mwgFTP=mwgFTP, mwgTraps=mwgTraps, stCategoriesEntry=stCategoriesEntry, stHttpsBytesToServer=stHttpsBytesToServer, kCustomVersion=kCustomVersion, pMFEDATVersion=pMFEDATVersion, notifyReasonString=notifyReasonString, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoryCount=stCategoryCount, trUser=trUser, notifyOriginName=notifyOriginName, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsBytesToClient=stHttpsBytesToClient, notifySeverity=notifySeverity, stCategoryName=stCategoryName, stHttpsTraffic=stHttpsTraffic, kProductVersion=kProductVersion, PYSNMP_MODULE_ID=mwg, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesFromServer=stFtpBytesFromServer, stCPULoad=stCPULoad, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectedSockets=stConnectedSockets, stHttpBytesToServer=stHttpBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, kProductName=kProductName, stHttpRequests=stHttpRequests, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgMiscellaneous=mwgMiscellaneous, stTimeForTransaction=stTimeForTransaction, stCPULoadRaw=stCPULoadRaw, notifyReason=notifyReason, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgContent=mwgContent, trSystem=trSystem, stCategoriesTable=stCategoriesTable, stHttpsBytesFromClient=stHttpsBytesFromClient, kMinorVersion=kMinorVersion, notifyAdditional=notifyAdditional, mwgHttp=mwgHttp, kHotfixVersion=kHotfixVersion, stCategories=stCategories, stFtpTraffic=stFtpTraffic, trApplication=trApplication, stCPUIOWait=stCPUIOWait, mwgInfo=mwgInfo, mwgStatistics=mwgStatistics, stBlockedByAntiMalware=stBlockedByAntiMalware, pTSDBVersion=pTSDBVersion, stHttpBytesFromServer=stHttpBytesFromServer)
