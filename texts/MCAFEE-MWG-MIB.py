...
Counter64, NotificationType, TimeTicks, ObjectIdentity, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, iso, MibIdentifier, enterprises, Unsigned32, Bits, IpAddress, Gauge32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "TimeTicks", "ObjectIdentity", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "iso", "MibIdentifier", "enterprises", "Unsigned32", "Bits", "IpAddress", "Gauge32", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpRequests=stHttpRequests, stBadReputation=stBadReputation, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMinorVersion=kMinorVersion, notifyReasonString=notifyReasonString, stMemConsumed=stMemConsumed, stClientCount=stClientCount, mwgTrapVariables=mwgTrapVariables, pTSDBVersion=pTSDBVersion, pMFEDATVersion=pMFEDATVersion, trUser=trUser, stHttpsTraffic=stHttpsTraffic, notifyAdditional=notifyAdditional, kHotfixVersion=kHotfixVersion, stCategories=stCategories, kProductName=kProductName, kMajorVersion=kMajorVersion, stHttpsBytesToServer=stHttpsBytesToServer, kCustomVersion=kCustomVersion, stHttpBytesFromServer=stHttpBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMicroVersion=kMicroVersion, notifyOrigin=notifyOrigin, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgInfo=mwgInfo, stHttpsBytesToClient=stHttpsBytesToClient, pAMEngineVersion=pAMEngineVersion, stFtpBytesToClient=stFtpBytesToClient, mwg=mwg, stConnectionsLegitimate=stConnectionsLegitimate, mwgHttps=mwgHttps, mwgHttp=mwgHttp, stCategoryName=stCategoryName, stFtpBytesFromServer=stFtpBytesFromServer, kRevision=kRevision, stCPULoadRaw=stCPULoadRaw, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesFromClient=stHttpsBytesFromClient, notifySeverity=notifySeverity, stBlockedByURLFilter=stBlockedByURLFilter, notifyAffectedHost=notifyAffectedHost, stCategoriesEntry=stCategoriesEntry, mwgContent=mwgContent, stHttpTraffic=stHttpTraffic, stHttpsBytesFromServer=stHttpsBytesFromServer, trSystem=trSystem, mwgMiscellaneous=mwgMiscellaneous, mwgEngineVersions=mwgEngineVersions, stHandleConnectToServer=stHandleConnectToServer, kBuildNumber=kBuildNumber, notifyReason=notifyReason, PYSNMP_MODULE_ID=mwg, kProductVersion=kProductVersion, stConnectedSockets=stConnectedSockets, mwgStatistics=mwgStatistics, stMalwareDetected=stMalwareDetected, stHttpsRequests=stHttpsRequests, stResolveHostViaDNS=stResolveHostViaDNS, pAMProactiveVersion=pAMProactiveVersion, kCompanyName=kCompanyName, stFtpTraffic=stFtpTraffic, stCPULoad=stCPULoad, mwgFTP=mwgFTP, stCategoryCount=stCategoryCount, stBlockedByAntiMalware=stBlockedByAntiMalware, pMFEEngineVersion=pMFEEngineVersion, stCPUIOWait=stCPUIOWait, mwgTraps=mwgTraps, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesToServer=stFtpBytesToServer, stConnectionsBlocked=stConnectionsBlocked, stCategoriesTable=stCategoriesTable, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesToClient=stHttpBytesToClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stTimeForTransaction=stTimeForTransaction, stMimeType=stMimeType, stFtpBytesFromClient=stFtpBytesFromClient, trApplication=trApplication, pAMSignatureVersion=pAMSignatureVersion, notifyOriginName=notifyOriginName)
