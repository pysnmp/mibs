...
Gauge32, TimeTicks, Integer32, NotificationType, mib_2, enterprises, MibIdentifier, ModuleIdentity, NotificationType, iso, ObjectIdentity, Bits, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "Integer32", "NotificationType", "mib-2", "enterprises", "MibIdentifier", "ModuleIdentity", "NotificationType", "iso", "ObjectIdentity", "Bits", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifySeverity=notifySeverity, stCPULoadRaw=stCPULoadRaw, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyAdditional=notifyAdditional, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMimeType=stMimeType, stHttpsBytesToServer=stHttpsBytesToServer, mwgTraps=mwgTraps, stHttpsTraffic=stHttpsTraffic, kHotfixVersion=kHotfixVersion, stBadReputation=stBadReputation, kCompanyName=kCompanyName, kProductName=kProductName, trSystem=trSystem, stHttpsBytesToClient=stHttpsBytesToClient, mwgFTP=mwgFTP, mwgInfo=mwgInfo, notifyOrigin=notifyOrigin, mwgHttp=mwgHttp, pMFEDATVersion=pMFEDATVersion, trUser=trUser, mwgTrapVariables=mwgTrapVariables, notifyAffectedHost=notifyAffectedHost, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoad=stCPULoad, kMinorVersion=kMinorVersion, stHttpTraffic=stHttpTraffic, stConnectedSockets=stConnectedSockets, mwgEngineVersions=mwgEngineVersions, pMFEEngineVersion=pMFEEngineVersion, kRevision=kRevision, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgContent=mwgContent, pTSDBVersion=pTSDBVersion, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesToServer=stFtpBytesToServer, mwgStatistics=mwgStatistics, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgHttps=mwgHttps, stFtpBytesFromServer=stFtpBytesFromServer, stCPUIOWait=stCPUIOWait, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesFromClient=stHttpBytesFromClient, kCustomVersion=kCustomVersion, trApplication=trApplication, stFtpBytesToClient=stFtpBytesToClient, mwg=mwg, stMalwareDetected=stMalwareDetected, stCategories=stCategories, stHttpRequests=stHttpRequests, stCategoryName=stCategoryName, stBlockedByURLFilter=stBlockedByURLFilter, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoriesTable=stCategoriesTable, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoryCount=stCategoryCount, stResolveHostViaDNS=stResolveHostViaDNS, notifyReasonString=notifyReasonString, stTimeForTransaction=stTimeForTransaction, kBuildNumber=kBuildNumber, pAMProactiveVersion=pAMProactiveVersion, kMicroVersion=kMicroVersion, pAMEngineVersion=pAMEngineVersion, kProductVersion=kProductVersion, pAMSignatureVersion=pAMSignatureVersion, stMemConsumed=stMemConsumed, notifyReason=notifyReason, kMajorVersion=kMajorVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyOriginName=notifyOriginName, stCategoriesEntry=stCategoriesEntry, stClientCount=stClientCount, PYSNMP_MODULE_ID=mwg, stHttpBytesToServer=stHttpBytesToServer, stHttpsRequests=stHttpsRequests, stFtpTraffic=stFtpTraffic, stFtpBytesFromClient=stFtpBytesFromClient, stConnectionsBlocked=stConnectionsBlocked, stHandleConnectToServer=stHandleConnectToServer, stConnectionsLegitimate=stConnectionsLegitimate, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine)
