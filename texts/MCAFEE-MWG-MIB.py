...
Counter32, TimeTicks, ObjectIdentity, enterprises, Integer32, mib_2, ModuleIdentity, Unsigned32, IpAddress, Bits, MibIdentifier, NotificationType, iso, NotificationType, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "ObjectIdentity", "enterprises", "Integer32", "mib-2", "ModuleIdentity", "Unsigned32", "IpAddress", "Bits", "MibIdentifier", "NotificationType", "iso", "NotificationType", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pMFEDATVersion=pMFEDATVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trUser=trUser, mwg=mwg, stConnectionsBlocked=stConnectionsBlocked, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kProductVersion=kProductVersion, kBuildNumber=kBuildNumber, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCPUIOWait=stCPUIOWait, stMimeType=stMimeType, notifyReasonString=notifyReasonString, stHttpsBytesToServer=stHttpsBytesToServer, pAMSignatureVersion=pAMSignatureVersion, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgEngineVersions=mwgEngineVersions, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesToClient=stFtpBytesToClient, stMalwareDetected=stMalwareDetected, stFtpBytesToServer=stFtpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgTrapVariables=mwgTrapVariables, pAMProactiveVersion=pAMProactiveVersion, stMemConsumed=stMemConsumed, stHttpsTraffic=stHttpsTraffic, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoad=stCPULoad, kCustomVersion=kCustomVersion, notifySeverity=notifySeverity, mwgStatistics=mwgStatistics, notifyOrigin=notifyOrigin, stHttpRequests=stHttpRequests, kMinorVersion=kMinorVersion, notifyOriginName=notifyOriginName, stBadReputation=stBadReputation, stHttpsRequests=stHttpsRequests, stCPULoadRaw=stCPULoadRaw, pAMEngineVersion=pAMEngineVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgHttps=mwgHttps, kRevision=kRevision, stCategoriesEntry=stCategoriesEntry, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesToServer=stHttpBytesToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesFromClient=stHttpsBytesFromClient, stHandleConnectToServer=stHandleConnectToServer, stCategoriesTable=stCategoriesTable, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, mwgHttp=mwgHttp, stHttpTraffic=stHttpTraffic, stConnectedSockets=stConnectedSockets, stConnectionsLegitimate=stConnectionsLegitimate, trApplication=trApplication, notifyReason=notifyReason, mwgFTP=mwgFTP, kMajorVersion=kMajorVersion, stClientCount=stClientCount, pTSDBVersion=pTSDBVersion, notifyAdditional=notifyAdditional, stCategories=stCategories, kMicroVersion=kMicroVersion, notifyAffectedHost=notifyAffectedHost, kHotfixVersion=kHotfixVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, PYSNMP_MODULE_ID=mwg, trSystem=trSystem, kProductName=kProductName, stCategoryName=stCategoryName, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesFromServer=stFtpBytesFromServer, stTimeForTransaction=stTimeForTransaction, stCategoryCount=stCategoryCount, mwgInfo=mwgInfo, stBlockedByURLFilter=stBlockedByURLFilter, stFtpTraffic=stFtpTraffic, mwgContent=mwgContent, mwgTraps=mwgTraps, kCompanyName=kCompanyName)
