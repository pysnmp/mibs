...
Integer32, Gauge32, Bits, TimeTicks, Counter32, NotificationType, ObjectIdentity, MibIdentifier, enterprises, Unsigned32, NotificationType, mib_2, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "Bits", "TimeTicks", "Counter32", "NotificationType", "ObjectIdentity", "MibIdentifier", "enterprises", "Unsigned32", "NotificationType", "mib-2", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stConnectionsLegitimate=stConnectionsLegitimate, trUser=trUser, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kBuildNumber=kBuildNumber, notifyReasonString=notifyReasonString, stHttpBytesToServer=stHttpBytesToServer, stHandleConnectToServer=stHandleConnectToServer, stHttpsTraffic=stHttpsTraffic, stCPUIOWait=stCPUIOWait, stConnectedSockets=stConnectedSockets, notifyOriginName=notifyOriginName, mwgHttp=mwgHttp, stHttpsBytesToClient=stHttpsBytesToClient, kRevision=kRevision, kHotfixVersion=kHotfixVersion, notifyOrigin=notifyOrigin, stCPULoad=stCPULoad, kCustomVersion=kCustomVersion, pAMSignatureVersion=pAMSignatureVersion, notifySeverity=notifySeverity, stBlockedByURLFilter=stBlockedByURLFilter, mwgHttps=mwgHttps, stBlockedByMediaFilter=stBlockedByMediaFilter, mwg=mwg, stMalwareDetected=stMalwareDetected, stCPULoadRaw=stCPULoadRaw, pMFEDATVersion=pMFEDATVersion, pMFEEngineVersion=pMFEEngineVersion, stHttpRequests=stHttpRequests, stCategoryCount=stCategoryCount, notifyReason=notifyReason, mwgTraps=mwgTraps, stHttpsBytesFromServer=stHttpsBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, pTSDBVersion=pTSDBVersion, stHttpBytesFromClient=stHttpBytesFromClient, kMicroVersion=kMicroVersion, notifyAffectedHost=notifyAffectedHost, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgFTP=mwgFTP, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesFromServer=stFtpBytesFromServer, stCategoriesEntry=stCategoriesEntry, kProductVersion=kProductVersion, kCompanyName=kCompanyName, mwgMiscellaneous=mwgMiscellaneous, stHttpTraffic=stHttpTraffic, stBadReputation=stBadReputation, mwgInfo=mwgInfo, stClientCount=stClientCount, trApplication=trApplication, stHttpBytesToClient=stHttpBytesToClient, mwgContent=mwgContent, stResolveHostViaDNS=stResolveHostViaDNS, stTimeForTransaction=stTimeForTransaction, stHttpsRequests=stHttpsRequests, trSystem=trSystem, stFtpBytesFromClient=stFtpBytesFromClient, kProductName=kProductName, stHttpBytesFromServer=stHttpBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, stCategories=stCategories, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpTraffic=stFtpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgEngineVersions=mwgEngineVersions, mwgTrapVariables=mwgTrapVariables, PYSNMP_MODULE_ID=mwg, stFtpBytesToClient=stFtpBytesToClient, pAMEngineVersion=pAMEngineVersion, mwgStatistics=mwgStatistics, stCategoriesTable=stCategoriesTable, stMimeType=stMimeType, stHttpsBytesToServer=stHttpsBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoryName=stCategoryName, notifyAdditional=notifyAdditional, kMajorVersion=kMajorVersion, stMemConsumed=stMemConsumed, kMinorVersion=kMinorVersion, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine)
