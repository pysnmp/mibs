...
NotificationType, Gauge32, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, iso, TimeTicks, MibIdentifier, Integer32, ModuleIdentity, enterprises, NotificationType, Counter32, mib_2, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "iso", "TimeTicks", "MibIdentifier", "Integer32", "ModuleIdentity", "enterprises", "NotificationType", "Counter32", "mib-2", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsTraffic=stHttpsTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsRequests=stHttpsRequests, kMajorVersion=kMajorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stCPUIOWait=stCPUIOWait, kMicroVersion=kMicroVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pMFEEngineVersion=pMFEEngineVersion, stHandleConnectToServer=stHandleConnectToServer, stConnectedSockets=stConnectedSockets, notifySeverity=notifySeverity, stHttpRequests=stHttpRequests, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesToServer=stHttpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyAffectedHost=notifyAffectedHost, stMalwareDetected=stMalwareDetected, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pMFEDATVersion=pMFEDATVersion, mwgFTP=mwgFTP, notifyReasonString=notifyReasonString, kMinorVersion=kMinorVersion, stFtpBytesFromClient=stFtpBytesFromClient, notifyOriginName=notifyOriginName, trApplication=trApplication, mwgTrapVariables=mwgTrapVariables, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromClient=stHttpBytesFromClient, stCPULoadRaw=stCPULoadRaw, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoryName=stCategoryName, kCompanyName=kCompanyName, notifyReason=notifyReason, stHttpsBytesFromClient=stHttpsBytesFromClient, kRevision=kRevision, stMemConsumed=stMemConsumed, stClientCount=stClientCount, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwg=mwg, mwgTraps=mwgTraps, kCustomVersion=kCustomVersion, stFtpBytesFromServer=stFtpBytesFromServer, stFtpTraffic=stFtpTraffic, mwgContent=mwgContent, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoad=stCPULoad, pTSDBVersion=pTSDBVersion, pAMProactiveVersion=pAMProactiveVersion, stCategoriesTable=stCategoriesTable, notifyAdditional=notifyAdditional, kBuildNumber=kBuildNumber, stFtpBytesToServer=stFtpBytesToServer, stCategoryCount=stCategoryCount, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kProductName=kProductName, PYSNMP_MODULE_ID=mwg, stTimeForTransaction=stTimeForTransaction, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromServer=stHttpBytesFromServer, mwgHttps=mwgHttps, stResolveHostViaDNS=stResolveHostViaDNS, mwgEngineVersions=mwgEngineVersions, mwgStatistics=mwgStatistics, trSystem=trSystem, mwgHttp=mwgHttp, stHttpsBytesToServer=stHttpsBytesToServer, stConnectionsBlocked=stConnectionsBlocked, stCategoriesEntry=stCategoriesEntry, stHttpTraffic=stHttpTraffic, stFtpBytesToClient=stFtpBytesToClient, notifyOrigin=notifyOrigin, mwgInfo=mwgInfo, trUser=trUser, kHotfixVersion=kHotfixVersion, stBadReputation=stBadReputation, kProductVersion=kProductVersion, mwgMiscellaneous=mwgMiscellaneous, stMimeType=stMimeType, pAMSignatureVersion=pAMSignatureVersion, stCategories=stCategories)
