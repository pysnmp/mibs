...
NotificationType, Bits, Counter32, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, enterprises, NotificationType, iso, TimeTicks, MibIdentifier, Gauge32, IpAddress, mib_2, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "Counter32", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "enterprises", "NotificationType", "iso", "TimeTicks", "MibIdentifier", "Gauge32", "IpAddress", "mib-2", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kRevision=kRevision, mwgFTP=mwgFTP, stCategoryCount=stCategoryCount, stBlockedByAntiMalware=stBlockedByAntiMalware, trApplication=trApplication, notifyReasonString=notifyReasonString, stFtpBytesToClient=stFtpBytesToClient, stHttpRequests=stHttpRequests, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgContent=mwgContent, notifyAdditional=notifyAdditional, notifySeverity=notifySeverity, stCategoryName=stCategoryName, stFtpBytesFromServer=stFtpBytesFromServer, mwgInfo=mwgInfo, mwgStatistics=mwgStatistics, notifyReason=notifyReason, kProductName=kProductName, stHandleConnectToServer=stHandleConnectToServer, kMinorVersion=kMinorVersion, notifyOrigin=notifyOrigin, kHotfixVersion=kHotfixVersion, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesFromClient=stFtpBytesFromClient, stClientCount=stClientCount, stCPULoad=stCPULoad, stConnectionsLegitimate=stConnectionsLegitimate, kCustomVersion=kCustomVersion, stResolveHostViaDNS=stResolveHostViaDNS, mwgHttp=mwgHttp, pTSDBVersion=pTSDBVersion, PYSNMP_MODULE_ID=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMicroVersion=kMicroVersion, stHttpBytesToServer=stHttpBytesToServer, stCategoriesTable=stCategoriesTable, trUser=trUser, stMemConsumed=stMemConsumed, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesToServer=stFtpBytesToServer, trSystem=trSystem, stHttpsBytesToClient=stHttpsBytesToClient, mwgHttps=mwgHttps, stMimeType=stMimeType, mwgTrapVariables=mwgTrapVariables, stCPULoadRaw=stCPULoadRaw, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoriesEntry=stCategoriesEntry, notifyAffectedHost=notifyAffectedHost, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpBytesFromClient=stHttpBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, mwg=mwg, pMFEEngineVersion=pMFEEngineVersion, stHttpTraffic=stHttpTraffic, kCompanyName=kCompanyName, stTimeForTransaction=stTimeForTransaction, mwgTraps=mwgTraps, stHttpsRequests=stHttpsRequests, stConnectionsBlocked=stConnectionsBlocked, stHttpsTraffic=stHttpsTraffic, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesFromServer=stHttpBytesFromServer, stCPUIOWait=stCPUIOWait, kMajorVersion=kMajorVersion, kBuildNumber=kBuildNumber, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpTraffic=stFtpTraffic, stCategories=stCategories, stBlockedByURLFilter=stBlockedByURLFilter, mwgEngineVersions=mwgEngineVersions, pAMEngineVersion=pAMEngineVersion, stBadReputation=stBadReputation, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesToServer=stHttpsBytesToServer, stConnectedSockets=stConnectedSockets, stMalwareDetected=stMalwareDetected, kProductVersion=kProductVersion, notifyOriginName=notifyOriginName, pMFEDATVersion=pMFEDATVersion, stHttpBytesToClient=stHttpBytesToClient)
