...
TimeTicks, mib_2, iso, Unsigned32, Counter32, NotificationType, NotificationType, Gauge32, ObjectIdentity, MibIdentifier, Integer32, IpAddress, enterprises, Bits, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "mib-2", "iso", "Unsigned32", "Counter32", "NotificationType", "NotificationType", "Gauge32", "ObjectIdentity", "MibIdentifier", "Integer32", "IpAddress", "enterprises", "Bits", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgTrapVariables=mwgTrapVariables, stHttpsBytesFromServer=stHttpsBytesFromServer, kRevision=kRevision, mwgHttps=mwgHttps, stCategoriesEntry=stCategoriesEntry, kCompanyName=kCompanyName, stHttpRequests=stHttpRequests, trApplication=trApplication, notifyAdditional=notifyAdditional, notifyReasonString=notifyReasonString, stBadReputation=stBadReputation, trSystem=trSystem, stCategories=stCategories, mwgMiscellaneous=mwgMiscellaneous, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesFromServer=stHttpBytesFromServer, stCPULoadRaw=stCPULoadRaw, PYSNMP_MODULE_ID=mwg, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoriesTable=stCategoriesTable, mwgHttp=mwgHttp, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHandleConnectToServer=stHandleConnectToServer, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesToServer=stFtpBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMProactiveVersion=pAMProactiveVersion, mwgStatistics=mwgStatistics, notifyAffectedHost=notifyAffectedHost, kMinorVersion=kMinorVersion, notifyOriginName=notifyOriginName, mwgInfo=mwgInfo, mwg=mwg, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgContent=mwgContent, pAMEngineVersion=pAMEngineVersion, kBuildNumber=kBuildNumber, pMFEEngineVersion=pMFEEngineVersion, stConnectionsLegitimate=stConnectionsLegitimate, stMimeType=stMimeType, stHttpsBytesToClient=stHttpsBytesToClient, stCategoryCount=stCategoryCount, mwgEngineVersions=mwgEngineVersions, stCPULoad=stCPULoad, stFtpBytesToClient=stFtpBytesToClient, pTSDBVersion=pTSDBVersion, stCPUIOWait=stCPUIOWait, stCategoryName=stCategoryName, pAMSignatureVersion=pAMSignatureVersion, mwgTraps=mwgTraps, trUser=trUser, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, kMicroVersion=kMicroVersion, kCustomVersion=kCustomVersion, notifyReason=notifyReason, stHttpBytesFromClient=stHttpBytesFromClient, kHotfixVersion=kHotfixVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, stMemConsumed=stMemConsumed, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesToServer=stHttpBytesToServer, stHttpsTraffic=stHttpsTraffic, stClientCount=stClientCount, mwgFTP=mwgFTP, kMajorVersion=kMajorVersion, stHttpTraffic=stHttpTraffic, stFtpTraffic=stFtpTraffic, notifyOrigin=notifyOrigin, kProductVersion=kProductVersion, kProductName=kProductName, stConnectedSockets=stConnectedSockets, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsBlocked=stConnectionsBlocked, pMFEDATVersion=pMFEDATVersion, stHttpsRequests=stHttpsRequests, stHttpBytesToClient=stHttpBytesToClient, notifySeverity=notifySeverity, stTimeForTransaction=stTimeForTransaction)
