...
ModuleIdentity, Counter64, enterprises, Counter32, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, mib_2, Gauge32, Integer32, TimeTicks, Bits, MibIdentifier, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "enterprises", "Counter32", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "mib-2", "Gauge32", "Integer32", "TimeTicks", "Bits", "MibIdentifier", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBadReputation=stBadReputation, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgStatistics=mwgStatistics, stHttpTraffic=stHttpTraffic, stBlockedByURLFilter=stBlockedByURLFilter, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsTraffic=stHttpsTraffic, stHttpsBytesToServer=stHttpsBytesToServer, stCategories=stCategories, mwgContent=mwgContent, stHttpBytesFromServer=stHttpBytesFromServer, trSystem=trSystem, stHttpsRequests=stHttpsRequests, stCategoriesEntry=stCategoriesEntry, stMimeType=stMimeType, mwgEngineVersions=mwgEngineVersions, notifyReason=notifyReason, notifyOriginName=notifyOriginName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTrapVariables=mwgTrapVariables, kMinorVersion=kMinorVersion, stHttpsBytesToClient=stHttpsBytesToClient, stCategoryName=stCategoryName, notifyOrigin=notifyOrigin, mwg=mwg, stTimeForTransaction=stTimeForTransaction, mwgFTP=mwgFTP, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesToClient=stHttpBytesToClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpRequests=stHttpRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, notifyReasonString=notifyReasonString, trApplication=trApplication, stClientCount=stClientCount, stFtpBytesFromServer=stFtpBytesFromServer, stCategoryCount=stCategoryCount, PYSNMP_MODULE_ID=mwg, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, kMajorVersion=kMajorVersion, kCustomVersion=kCustomVersion, kRevision=kRevision, stCategoriesTable=stCategoriesTable, kCompanyName=kCompanyName, pAMSignatureVersion=pAMSignatureVersion, pMFEEngineVersion=pMFEEngineVersion, pAMProactiveVersion=pAMProactiveVersion, stCPUIOWait=stCPUIOWait, stMalwareDetected=stMalwareDetected, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyAffectedHost=notifyAffectedHost, kMicroVersion=kMicroVersion, pAMEngineVersion=pAMEngineVersion, kBuildNumber=kBuildNumber, stConnectionsLegitimate=stConnectionsLegitimate, mwgMiscellaneous=mwgMiscellaneous, trUser=trUser, stHttpBytesToServer=stHttpBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, pTSDBVersion=pTSDBVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifySeverity=notifySeverity, kProductVersion=kProductVersion, pMFEDATVersion=pMFEDATVersion, notifyAdditional=notifyAdditional, kProductName=kProductName, stConnectedSockets=stConnectedSockets, mwgHttps=mwgHttps, mwgHttp=mwgHttp, stFtpBytesFromClient=stFtpBytesFromClient, kHotfixVersion=kHotfixVersion, mwgTraps=mwgTraps, stFtpBytesToClient=stFtpBytesToClient, stFtpTraffic=stFtpTraffic, mwgInfo=mwgInfo, stCPULoad=stCPULoad, stMemConsumed=stMemConsumed, stCPULoadRaw=stCPULoadRaw)
