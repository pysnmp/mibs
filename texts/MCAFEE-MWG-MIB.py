...
IpAddress, iso, Gauge32, mib_2, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, ModuleIdentity, Unsigned32, NotificationType, Counter64, enterprises, TimeTicks, MibIdentifier, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "iso", "Gauge32", "mib-2", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "ModuleIdentity", "Unsigned32", "NotificationType", "Counter64", "enterprises", "TimeTicks", "MibIdentifier", "Bits", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kMinorVersion=kMinorVersion, kHotfixVersion=kHotfixVersion, mwgStatistics=mwgStatistics, notifyReason=notifyReason, notifyOriginName=notifyOriginName, pMFEDATVersion=pMFEDATVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, pTSDBVersion=pTSDBVersion, trUser=trUser, stMimeType=stMimeType, stHttpTraffic=stHttpTraffic, stCPULoadRaw=stCPULoadRaw, trApplication=trApplication, kBuildNumber=kBuildNumber, stCategoryCount=stCategoryCount, pAMProactiveVersion=pAMProactiveVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, kCustomVersion=kCustomVersion, pAMEngineVersion=pAMEngineVersion, stHttpBytesToClient=stHttpBytesToClient, stCategoryName=stCategoryName, stHttpsTraffic=stHttpsTraffic, kProductVersion=kProductVersion, notifySeverity=notifySeverity, stClientCount=stClientCount, stResolveHostViaDNS=stResolveHostViaDNS, trSystem=trSystem, stMalwareDetected=stMalwareDetected, stHttpRequests=stHttpRequests, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByURLFilter=stBlockedByURLFilter, stTimeForTransaction=stTimeForTransaction, kProductName=kProductName, kRevision=kRevision, kMicroVersion=kMicroVersion, stHttpsRequests=stHttpsRequests, stCPULoad=stCPULoad, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, PYSNMP_MODULE_ID=mwg, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMemConsumed=stMemConsumed, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesFromClient=stHttpsBytesFromClient, kMajorVersion=kMajorVersion, stHttpBytesToServer=stHttpBytesToServer, notifyReasonString=notifyReasonString, notifyAffectedHost=notifyAffectedHost, stFtpBytesToClient=stFtpBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoriesEntry=stCategoriesEntry, stCategoriesTable=stCategoriesTable, mwg=mwg, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyOrigin=notifyOrigin, mwgTrapVariables=mwgTrapVariables, stFtpTraffic=stFtpTraffic, pMFEEngineVersion=pMFEEngineVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBadReputation=stBadReputation, pAMSignatureVersion=pAMSignatureVersion, mwgTraps=mwgTraps, stConnectionsLegitimate=stConnectionsLegitimate, notifyAdditional=notifyAdditional, mwgContent=mwgContent, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesFromServer=stFtpBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, mwgInfo=mwgInfo, mwgFTP=mwgFTP, stFtpBytesToServer=stFtpBytesToServer, mwgHttps=mwgHttps, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgEngineVersions=mwgEngineVersions, stCPUIOWait=stCPUIOWait, stCategories=stCategories, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesFromClient=stFtpBytesFromClient, mwgHttp=mwgHttp, kCompanyName=kCompanyName, stConnectedSockets=stConnectedSockets)
