...
NotificationType, Gauge32, ModuleIdentity, TimeTicks, MibIdentifier, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, Counter64, Counter32, mib_2, Integer32, NotificationType, ObjectIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "ModuleIdentity", "TimeTicks", "MibIdentifier", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "Counter64", "Counter32", "mib-2", "Integer32", "NotificationType", "ObjectIdentity", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMEngineVersion=pAMEngineVersion, stHttpBytesFromServer=stHttpBytesFromServer, stMalwareDetected=stMalwareDetected, mwgContent=mwgContent, stMemConsumed=stMemConsumed, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesFromClient=stFtpBytesFromClient, kRevision=kRevision, trApplication=trApplication, mwgMiscellaneous=mwgMiscellaneous, mwgEngineVersions=mwgEngineVersions, stTimeForTransaction=stTimeForTransaction, mwgTrapVariables=mwgTrapVariables, kHotfixVersion=kHotfixVersion, pTSDBVersion=pTSDBVersion, stBadReputation=stBadReputation, stCategoryCount=stCategoryCount, stHandleConnectToServer=stHandleConnectToServer, kCompanyName=kCompanyName, trUser=trUser, notifyReasonString=notifyReasonString, stFtpTraffic=stFtpTraffic, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoryName=stCategoryName, notifyReason=notifyReason, PYSNMP_MODULE_ID=mwg, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoriesTable=stCategoriesTable, stFtpBytesToClient=stFtpBytesToClient, mwgTraps=mwgTraps, trSystem=trSystem, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesToServer=stHttpBytesToServer, notifyAffectedHost=notifyAffectedHost, mwgFTP=mwgFTP, stHttpBytesFromClient=stHttpBytesFromClient, kBuildNumber=kBuildNumber, pMFEDATVersion=pMFEDATVersion, kMicroVersion=kMicroVersion, pAMSignatureVersion=pAMSignatureVersion, stConnectionsLegitimate=stConnectionsLegitimate, kMajorVersion=kMajorVersion, stClientCount=stClientCount, notifyAdditional=notifyAdditional, stHttpsBytesToServer=stHttpsBytesToServer, kProductVersion=kProductVersion, stHttpRequests=stHttpRequests, stMimeType=stMimeType, kCustomVersion=kCustomVersion, stHttpsTraffic=stHttpsTraffic, kMinorVersion=kMinorVersion, notifyOrigin=notifyOrigin, mwg=mwg, stCPULoadRaw=stCPULoadRaw, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCPUIOWait=stCPUIOWait, stCategoriesEntry=stCategoriesEntry, kProductName=kProductName, stFtpBytesFromServer=stFtpBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgInfo=mwgInfo, stHttpTraffic=stHttpTraffic, notifySeverity=notifySeverity, stCategories=stCategories, pMFEEngineVersion=pMFEEngineVersion, mwgStatistics=mwgStatistics, stResolveHostViaDNS=stResolveHostViaDNS, notifyOriginName=notifyOriginName, stFtpBytesToServer=stFtpBytesToServer, mwgHttps=mwgHttps, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsRequests=stHttpsRequests, stConnectionsBlocked=stConnectionsBlocked, stConnectedSockets=stConnectedSockets, pAMProactiveVersion=pAMProactiveVersion, stCPULoad=stCPULoad, mwgHttp=mwgHttp, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesToClient=stHttpBytesToClient)
