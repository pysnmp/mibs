...
ObjectIdentity, mib_2, Counter64, iso, Bits, TimeTicks, Integer32, enterprises, ModuleIdentity, IpAddress, Gauge32, NotificationType, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "mib-2", "Counter64", "iso", "Bits", "TimeTicks", "Integer32", "enterprises", "ModuleIdentity", "IpAddress", "Gauge32", "NotificationType", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgFTP=mwgFTP, stResolveHostViaDNS=stResolveHostViaDNS, mwgContent=mwgContent, stConnectionsBlocked=stConnectionsBlocked, stTimeForTransaction=stTimeForTransaction, kMajorVersion=kMajorVersion, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMEngineVersion=pAMEngineVersion, notifyAdditional=notifyAdditional, stLastSentLastReceivedClient=stLastSentLastReceivedClient, trApplication=trApplication, stCategories=stCategories, notifyReason=notifyReason, mwgMiscellaneous=mwgMiscellaneous, notifySeverity=notifySeverity, stBlockedByMediaFilter=stBlockedByMediaFilter, stClientCount=stClientCount, stCategoryCount=stCategoryCount, kMicroVersion=kMicroVersion, stHttpsRequests=stHttpsRequests, trUser=trUser, stHttpsBytesToClient=stHttpsBytesToClient, stCategoryName=stCategoryName, mwgTrapVariables=mwgTrapVariables, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgHttps=mwgHttps, mwgInfo=mwgInfo, stMemConsumed=stMemConsumed, stCPUIOWait=stCPUIOWait, stHttpTraffic=stHttpTraffic, stFtpBytesToClient=stFtpBytesToClient, stHttpRequests=stHttpRequests, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesFromServer=stFtpBytesFromServer, mwgStatistics=mwgStatistics, notifyReasonString=notifyReasonString, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgEngineVersions=mwgEngineVersions, mwg=mwg, stConnectionsLegitimate=stConnectionsLegitimate, mwgHttp=mwgHttp, kProductName=kProductName, stHttpBytesFromClient=stHttpBytesFromClient, stBlockedByURLFilter=stBlockedByURLFilter, pMFEDATVersion=pMFEDATVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyOriginName=notifyOriginName, stCPULoadRaw=stCPULoadRaw, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesToServer=stHttpsBytesToServer, pTSDBVersion=pTSDBVersion, kProductVersion=kProductVersion, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesToServer=stHttpBytesToServer, stHttpsTraffic=stHttpsTraffic, kBuildNumber=kBuildNumber, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyAffectedHost=notifyAffectedHost, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBadReputation=stBadReputation, trSystem=trSystem, stConnectedSockets=stConnectedSockets, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesToServer=stFtpBytesToServer, stMalwareDetected=stMalwareDetected, stCategoriesTable=stCategoriesTable, mwgTraps=mwgTraps, pAMProactiveVersion=pAMProactiveVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stCPULoad=stCPULoad, stFtpTraffic=stFtpTraffic, stMimeType=stMimeType, notifyOrigin=notifyOrigin, kRevision=kRevision, PYSNMP_MODULE_ID=mwg, kCompanyName=kCompanyName, kCustomVersion=kCustomVersion, kHotfixVersion=kHotfixVersion, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, kMinorVersion=kMinorVersion, stCategoriesEntry=stCategoriesEntry)
