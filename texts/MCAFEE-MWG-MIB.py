...
IpAddress, Bits, Gauge32, Integer32, Counter64, TimeTicks, enterprises, ObjectIdentity, ModuleIdentity, mib_2, NotificationType, NotificationType, Unsigned32, iso, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "Gauge32", "Integer32", "Counter64", "TimeTicks", "enterprises", "ObjectIdentity", "ModuleIdentity", "mib-2", "NotificationType", "NotificationType", "Unsigned32", "iso", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyAffectedHost=notifyAffectedHost, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMEngineVersion=pAMEngineVersion, stCategoryName=stCategoryName, stMemConsumed=stMemConsumed, stHttpsBytesToServer=stHttpsBytesToServer, kRevision=kRevision, pAMProactiveVersion=pAMProactiveVersion, stConnectedSockets=stConnectedSockets, notifyAdditional=notifyAdditional, kCompanyName=kCompanyName, stFtpBytesToServer=stFtpBytesToServer, notifyOriginName=notifyOriginName, kCustomVersion=kCustomVersion, notifyOrigin=notifyOrigin, stHttpBytesFromClient=stHttpBytesFromClient, pTSDBVersion=pTSDBVersion, kMajorVersion=kMajorVersion, stCategories=stCategories, mwgTraps=mwgTraps, stHttpsRequests=stHttpsRequests, stBlockedByMediaFilter=stBlockedByMediaFilter, trApplication=trApplication, stConnectionsBlocked=stConnectionsBlocked, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeForTransaction=stTimeForTransaction, notifyReasonString=notifyReasonString, stCPUIOWait=stCPUIOWait, stFtpBytesFromClient=stFtpBytesFromClient, mwgEngineVersions=mwgEngineVersions, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgHttps=mwgHttps, kMinorVersion=kMinorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kBuildNumber=kBuildNumber, mwgHttp=mwgHttp, mwgTrapVariables=mwgTrapVariables, pMFEEngineVersion=pMFEEngineVersion, stHttpsTraffic=stHttpsTraffic, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByURLFilter=stBlockedByURLFilter, kProductName=kProductName, stCategoryCount=stCategoryCount, mwg=mwg, trUser=trUser, stClientCount=stClientCount, notifyReason=notifyReason, mwgContent=mwgContent, stHttpTraffic=stHttpTraffic, kProductVersion=kProductVersion, stBadReputation=stBadReputation, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoriesTable=stCategoriesTable, mwgStatistics=mwgStatistics, stCPULoadRaw=stCPULoadRaw, mwgMiscellaneous=mwgMiscellaneous, PYSNMP_MODULE_ID=mwg, stHttpsBytesFromClient=stHttpsBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pMFEDATVersion=pMFEDATVersion, stMalwareDetected=stMalwareDetected, stHttpBytesToClient=stHttpBytesToClient, mwgFTP=mwgFTP, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifySeverity=notifySeverity, stFtpTraffic=stFtpTraffic, stHttpRequests=stHttpRequests, stHttpsBytesToClient=stHttpsBytesToClient, kHotfixVersion=kHotfixVersion, kMicroVersion=kMicroVersion, stCPULoad=stCPULoad, mwgInfo=mwgInfo, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesToClient=stFtpBytesToClient, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesToServer=stHttpBytesToServer, trSystem=trSystem, stCategoriesEntry=stCategoriesEntry, stMimeType=stMimeType, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesFromServer=stHttpBytesFromServer)
