...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, TimeTicks, NotificationType, mib_2, ObjectIdentity, IpAddress, NotificationType, Counter32, ModuleIdentity, enterprises, iso, MibIdentifier, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "TimeTicks", "NotificationType", "mib-2", "ObjectIdentity", "IpAddress", "NotificationType", "Counter32", "ModuleIdentity", "enterprises", "iso", "MibIdentifier", "Counter64", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwg=mwg, stHttpsBytesToServer=stHttpsBytesToServer, kProductName=kProductName, stConnectionsBlocked=stConnectionsBlocked, stCPUIOWait=stCPUIOWait, notifyOrigin=notifyOrigin, notifyOriginName=notifyOriginName, stMimeType=stMimeType, pAMSignatureVersion=pAMSignatureVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kCustomVersion=kCustomVersion, notifyAffectedHost=notifyAffectedHost, stFtpBytesFromClient=stFtpBytesFromClient, stHttpRequests=stHttpRequests, stTimeForTransaction=stTimeForTransaction, pTSDBVersion=pTSDBVersion, stCPULoadRaw=stCPULoadRaw, kBuildNumber=kBuildNumber, mwgFTP=mwgFTP, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromClient=stHttpsBytesFromClient, kProductVersion=kProductVersion, stConnectionsLegitimate=stConnectionsLegitimate, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoryCount=stCategoryCount, trUser=trUser, mwgMiscellaneous=mwgMiscellaneous, mwgTraps=mwgTraps, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesToClient=stHttpBytesToClient, stCategoriesTable=stCategoriesTable, pMFEEngineVersion=pMFEEngineVersion, kRevision=kRevision, pAMProactiveVersion=pAMProactiveVersion, stBadReputation=stBadReputation, kCompanyName=kCompanyName, stFtpTraffic=stFtpTraffic, stHttpsBytesToClient=stHttpsBytesToClient, mwgEngineVersions=mwgEngineVersions, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttp=mwgHttp, mwgHttps=mwgHttps, kMinorVersion=kMinorVersion, kHotfixVersion=kHotfixVersion, mwgContent=mwgContent, trSystem=trSystem, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyReasonString=notifyReasonString, stResolveHostViaDNS=stResolveHostViaDNS, stMemConsumed=stMemConsumed, trApplication=trApplication, stClientCount=stClientCount, mwgTrapVariables=mwgTrapVariables, stCategoriesEntry=stCategoriesEntry, notifyReason=notifyReason, mwgInfo=mwgInfo, stFtpBytesToServer=stFtpBytesToServer, stMalwareDetected=stMalwareDetected, stHttpBytesFromServer=stHttpBytesFromServer, PYSNMP_MODULE_ID=mwg, kMajorVersion=kMajorVersion, mwgStatistics=mwgStatistics, kMicroVersion=kMicroVersion, stHttpBytesToServer=stHttpBytesToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategories=stCategories, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pMFEDATVersion=pMFEDATVersion, stCPULoad=stCPULoad, stFtpBytesFromServer=stFtpBytesFromServer, notifySeverity=notifySeverity, pAMEngineVersion=pAMEngineVersion, notifyAdditional=notifyAdditional, stCategoryName=stCategoryName, stConnectedSockets=stConnectedSockets, stHttpsTraffic=stHttpsTraffic, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpTraffic=stHttpTraffic, stHandleConnectToServer=stHandleConnectToServer, stHttpsRequests=stHttpsRequests)
