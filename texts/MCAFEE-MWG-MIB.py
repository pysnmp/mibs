...
ModuleIdentity, IpAddress, Integer32, NotificationType, iso, Gauge32, Bits, ObjectIdentity, Counter64, mib_2, Unsigned32, enterprises, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "Integer32", "NotificationType", "iso", "Gauge32", "Bits", "ObjectIdentity", "Counter64", "mib-2", "Unsigned32", "enterprises", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgTrapVariables=mwgTrapVariables, notifyReason=notifyReason, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesToServer=stHttpBytesToServer, stClientCount=stClientCount, pAMSignatureVersion=pAMSignatureVersion, stHttpsRequests=stHttpsRequests, mwgStatistics=mwgStatistics, mwg=mwg, kCompanyName=kCompanyName, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategories=stCategories, trApplication=trApplication, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pAMEngineVersion=pAMEngineVersion, pTSDBVersion=pTSDBVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesFromClient=stHttpBytesFromClient, mwgFTP=mwgFTP, stCategoriesTable=stCategoriesTable, mwgTraps=mwgTraps, stConnectionsBlocked=stConnectionsBlocked, notifyOriginName=notifyOriginName, pMFEDATVersion=pMFEDATVersion, stConnectionsLegitimate=stConnectionsLegitimate, stCPULoad=stCPULoad, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesToClient=stHttpBytesToClient, stHttpRequests=stHttpRequests, PYSNMP_MODULE_ID=mwg, stHttpBytesFromServer=stHttpBytesFromServer, kRevision=kRevision, kProductName=kProductName, kMajorVersion=kMajorVersion, stBadReputation=stBadReputation, pMFEEngineVersion=pMFEEngineVersion, notifySeverity=notifySeverity, notifyAffectedHost=notifyAffectedHost, kBuildNumber=kBuildNumber, notifyAdditional=notifyAdditional, stTimeForTransaction=stTimeForTransaction, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpTraffic=stHttpTraffic, stMimeType=stMimeType, trSystem=trSystem, stMemConsumed=stMemConsumed, stFtpBytesFromClient=stFtpBytesFromClient, notifyReasonString=notifyReasonString, stBlockedByURLFilter=stBlockedByURLFilter, notifyOrigin=notifyOrigin, pAMProactiveVersion=pAMProactiveVersion, stCategoriesEntry=stCategoriesEntry, stCategoryName=stCategoryName, mwgInfo=mwgInfo, trUser=trUser, kMinorVersion=kMinorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesToServer=stFtpBytesToServer, stConnectedSockets=stConnectedSockets, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesFromServer=stHttpsBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgContent=mwgContent, stBlockedByMediaFilter=stBlockedByMediaFilter, stResolveHostViaDNS=stResolveHostViaDNS, stCPULoadRaw=stCPULoadRaw, mwgEngineVersions=mwgEngineVersions, stFtpBytesFromServer=stFtpBytesFromServer, stFtpTraffic=stFtpTraffic, mwgHttp=mwgHttp, mwgHttps=mwgHttps, stHttpsTraffic=stHttpsTraffic, stCPUIOWait=stCPUIOWait, kHotfixVersion=kHotfixVersion, stCategoryCount=stCategoryCount, kProductVersion=kProductVersion, stHttpsBytesToServer=stHttpsBytesToServer, kMicroVersion=kMicroVersion, stMalwareDetected=stMalwareDetected, stHandleConnectToServer=stHandleConnectToServer, kCustomVersion=kCustomVersion)
