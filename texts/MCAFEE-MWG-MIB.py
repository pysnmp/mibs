...
Unsigned32, TimeTicks, iso, Bits, NotificationType, Integer32, MibIdentifier, Gauge32, NotificationType, IpAddress, ModuleIdentity, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, mib_2, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "iso", "Bits", "NotificationType", "Integer32", "MibIdentifier", "Gauge32", "NotificationType", "IpAddress", "ModuleIdentity", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "mib-2", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesToClient=stHttpBytesToClient, stTimeForTransaction=stTimeForTransaction, kCompanyName=kCompanyName, trUser=trUser, stBadReputation=stBadReputation, stClientCount=stClientCount, stConnectedSockets=stConnectedSockets, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpTraffic=stHttpTraffic, stCPULoad=stCPULoad, mwgInfo=mwgInfo, kMicroVersion=kMicroVersion, kProductVersion=kProductVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoryName=stCategoryName, mwgTrapVariables=mwgTrapVariables, stFtpBytesToServer=stFtpBytesToServer, mwgEngineVersions=mwgEngineVersions, trApplication=trApplication, pMFEEngineVersion=pMFEEngineVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgStatistics=mwgStatistics, notifyAffectedHost=notifyAffectedHost, stMalwareDetected=stMalwareDetected, stFtpTraffic=stFtpTraffic, kHotfixVersion=kHotfixVersion, stCPUIOWait=stCPUIOWait, mwgContent=mwgContent, mwgTraps=mwgTraps, stResolveHostViaDNS=stResolveHostViaDNS, stCategoryCount=stCategoryCount, mwgFTP=mwgFTP, stCPULoadRaw=stCPULoadRaw, notifyReason=notifyReason, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyReasonString=notifyReasonString, kCustomVersion=kCustomVersion, kMajorVersion=kMajorVersion, kProductName=kProductName, stMimeType=stMimeType, stCategoriesEntry=stCategoriesEntry, stHttpRequests=stHttpRequests, mwgHttps=mwgHttps, stBlockedByURLFilter=stBlockedByURLFilter, stCategoriesTable=stCategoriesTable, pTSDBVersion=pTSDBVersion, mwgHttp=mwgHttp, PYSNMP_MODULE_ID=mwg, mwg=mwg, notifyAdditional=notifyAdditional, kMinorVersion=kMinorVersion, pAMEngineVersion=pAMEngineVersion, stHttpsBytesToServer=stHttpsBytesToServer, mwgMiscellaneous=mwgMiscellaneous, stCategories=stCategories, stFtpBytesFromClient=stFtpBytesFromClient, kRevision=kRevision, trSystem=trSystem, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesToClient=stFtpBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesFromClient=stHttpBytesFromClient, notifyOriginName=notifyOriginName, pAMProactiveVersion=pAMProactiveVersion, stHandleConnectToServer=stHandleConnectToServer, stHttpsTraffic=stHttpsTraffic, pMFEDATVersion=pMFEDATVersion, stMemConsumed=stMemConsumed, stHttpsBytesToClient=stHttpsBytesToClient, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesToServer=stHttpBytesToServer, notifySeverity=notifySeverity, notifyOrigin=notifyOrigin, kBuildNumber=kBuildNumber, stConnectionsBlocked=stConnectionsBlocked, pAMSignatureVersion=pAMSignatureVersion, stHttpsRequests=stHttpsRequests)
