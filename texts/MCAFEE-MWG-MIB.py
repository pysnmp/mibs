...
Counter64, ObjectIdentity, MibIdentifier, Integer32, mib_2, iso, Counter32, IpAddress, TimeTicks, enterprises, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, NotificationType, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "MibIdentifier", "Integer32", "mib-2", "iso", "Counter32", "IpAddress", "TimeTicks", "enterprises", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "NotificationType", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyOrigin=notifyOrigin, mwgInfo=mwgInfo, stBadReputation=stBadReputation, kHotfixVersion=kHotfixVersion, stCategories=stCategories, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stCPUIOWait=stCPUIOWait, notifyReason=notifyReason, notifyReasonString=notifyReasonString, stHttpBytesToClient=stHttpBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMajorVersion=kMajorVersion, mwgFTP=mwgFTP, stMalwareDetected=stMalwareDetected, mwgEngineVersions=mwgEngineVersions, stHttpsBytesToClient=stHttpsBytesToClient, notifyAffectedHost=notifyAffectedHost, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, trSystem=trSystem, pAMSignatureVersion=pAMSignatureVersion, mwgTrapVariables=mwgTrapVariables, stHttpsRequests=stHttpsRequests, pMFEDATVersion=pMFEDATVersion, pAMProactiveVersion=pAMProactiveVersion, mwgContent=mwgContent, stBlockedByMediaFilter=stBlockedByMediaFilter, pAMEngineVersion=pAMEngineVersion, stConnectionsLegitimate=stConnectionsLegitimate, kCustomVersion=kCustomVersion, stCPULoadRaw=stCPULoadRaw, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, kMicroVersion=kMicroVersion, mwgTraps=mwgTraps, stTimeForTransaction=stTimeForTransaction, stFtpTraffic=stFtpTraffic, stConnectedSockets=stConnectedSockets, kProductName=kProductName, stHttpTraffic=stHttpTraffic, stFtpBytesFromClient=stFtpBytesFromClient, PYSNMP_MODULE_ID=mwg, kBuildNumber=kBuildNumber, trApplication=trApplication, trUser=trUser, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyOriginName=notifyOriginName, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kProductVersion=kProductVersion, mwgHttps=mwgHttps, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, pMFEEngineVersion=pMFEEngineVersion, mwgStatistics=mwgStatistics, stMimeType=stMimeType, mwgHttp=mwgHttp, kMinorVersion=kMinorVersion, stCategoryCount=stCategoryCount, stHttpsTraffic=stHttpsTraffic, stConnectionsBlocked=stConnectionsBlocked, stHttpRequests=stHttpRequests, stCategoriesTable=stCategoriesTable, stCategoriesEntry=stCategoriesEntry, notifySeverity=notifySeverity, stCategoryName=stCategoryName, kCompanyName=kCompanyName, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesToServer=stHttpBytesToServer, stClientCount=stClientCount, kRevision=kRevision, mwgMiscellaneous=mwgMiscellaneous, mwg=mwg, stBlockedByAntiMalware=stBlockedByAntiMalware, stCPULoad=stCPULoad, notifyAdditional=notifyAdditional, pTSDBVersion=pTSDBVersion, stFtpBytesToServer=stFtpBytesToServer, stMemConsumed=stMemConsumed)
