...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, Unsigned32, Counter64, TimeTicks, ObjectIdentity, Integer32, MibIdentifier, Counter32, iso, Bits, Gauge32, mib_2, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "Unsigned32", "Counter64", "TimeTicks", "ObjectIdentity", "Integer32", "MibIdentifier", "Counter32", "iso", "Bits", "Gauge32", "mib-2", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoryName=stCategoryName, stFtpBytesFromClient=stFtpBytesFromClient, stHandleConnectToServer=stHandleConnectToServer, kProductVersion=kProductVersion, stFtpBytesToServer=stFtpBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, kCustomVersion=kCustomVersion, kCompanyName=kCompanyName, stCPUIOWait=stCPUIOWait, kProductName=kProductName, stCategoriesTable=stCategoriesTable, stLastSentLastReceivedServer=stLastSentLastReceivedServer, trUser=trUser, stHttpsBytesToClient=stHttpsBytesToClient, stCategories=stCategories, mwgMiscellaneous=mwgMiscellaneous, notifyAffectedHost=notifyAffectedHost, notifyAdditional=notifyAdditional, mwgContent=mwgContent, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesFromServer=stHttpBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsTraffic=stHttpsTraffic, stBadReputation=stBadReputation, stBlockedByURLFilter=stBlockedByURLFilter, mwgHttp=mwgHttp, notifyOriginName=notifyOriginName, stMemConsumed=stMemConsumed, stHttpTraffic=stHttpTraffic, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesToServer=stHttpsBytesToServer, mwgTrapVariables=mwgTrapVariables, notifyReasonString=notifyReasonString, kBuildNumber=kBuildNumber, stMimeType=stMimeType, stHttpRequests=stHttpRequests, stCPULoadRaw=stCPULoadRaw, stTimeForTransaction=stTimeForTransaction, pMFEDATVersion=pMFEDATVersion, stMalwareDetected=stMalwareDetected, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesEntry=stCategoriesEntry, stFtpTraffic=stFtpTraffic, trSystem=trSystem, stCategoryCount=stCategoryCount, trApplication=trApplication, stHttpsRequests=stHttpsRequests, kMinorVersion=kMinorVersion, stFtpBytesToClient=stFtpBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stCPULoad=stCPULoad, stHttpBytesToClient=stHttpBytesToClient, notifyOrigin=notifyOrigin, mwgTraps=mwgTraps, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifySeverity=notifySeverity, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stClientCount=stClientCount, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, kMicroVersion=kMicroVersion, mwgEngineVersions=mwgEngineVersions, kRevision=kRevision, stConnectedSockets=stConnectedSockets, mwgHttps=mwgHttps, mwg=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, PYSNMP_MODULE_ID=mwg, mwgInfo=mwgInfo, kHotfixVersion=kHotfixVersion, notifyReason=notifyReason, mwgFTP=mwgFTP, stHttpBytesFromClient=stHttpBytesFromClient, mwgStatistics=mwgStatistics, pTSDBVersion=pTSDBVersion, pAMProactiveVersion=pAMProactiveVersion, stResolveHostViaDNS=stResolveHostViaDNS, stConnectionsBlocked=stConnectionsBlocked, pAMEngineVersion=pAMEngineVersion, kMajorVersion=kMajorVersion, pMFEEngineVersion=pMFEEngineVersion)
