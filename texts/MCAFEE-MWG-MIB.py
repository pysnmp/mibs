...
Counter64, ModuleIdentity, IpAddress, mib_2, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, ObjectIdentity, enterprises, MibIdentifier, NotificationType, TimeTicks, iso, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "IpAddress", "mib-2", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "ObjectIdentity", "enterprises", "MibIdentifier", "NotificationType", "TimeTicks", "iso", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBadReputation=stBadReputation, stCPUIOWait=stCPUIOWait, mwgContent=mwgContent, stHttpBytesToClient=stHttpBytesToClient, stHttpsRequests=stHttpsRequests, mwgTraps=mwgTraps, stFtpBytesFromClient=stFtpBytesFromClient, kProductVersion=kProductVersion, stHttpBytesToServer=stHttpBytesToServer, stCategoriesEntry=stCategoriesEntry, mwgInfo=mwgInfo, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kProductName=kProductName, stCategoryName=stCategoryName, stHttpRequests=stHttpRequests, notifyAdditional=notifyAdditional, kMicroVersion=kMicroVersion, stConnectedSockets=stConnectedSockets, mwgEngineVersions=mwgEngineVersions, stTimeForTransaction=stTimeForTransaction, stHttpTraffic=stHttpTraffic, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMajorVersion=kMajorVersion, stCategories=stCategories, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoriesTable=stCategoriesTable, PYSNMP_MODULE_ID=mwg, pAMProactiveVersion=pAMProactiveVersion, trSystem=trSystem, mwgFTP=mwgFTP, stCategoryCount=stCategoryCount, stHttpBytesFromServer=stHttpBytesFromServer, mwgHttp=mwgHttp, notifyAffectedHost=notifyAffectedHost, stFtpBytesToClient=stFtpBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyReasonString=notifyReasonString, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kHotfixVersion=kHotfixVersion, mwg=mwg, stBlockedByAntiMalware=stBlockedByAntiMalware, notifySeverity=notifySeverity, stHttpsBytesToServer=stHttpsBytesToServer, trApplication=trApplication, pMFEEngineVersion=pMFEEngineVersion, mwgHttps=mwgHttps, notifyReason=notifyReason, notifyOriginName=notifyOriginName, kBuildNumber=kBuildNumber, stFtpBytesFromServer=stFtpBytesFromServer, kMinorVersion=kMinorVersion, pTSDBVersion=pTSDBVersion, pAMEngineVersion=pAMEngineVersion, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesFromClient=stHttpBytesFromClient, trUser=trUser, stCPULoadRaw=stCPULoadRaw, stMimeType=stMimeType, stHttpsTraffic=stHttpsTraffic, stClientCount=stClientCount, stConnectionsBlocked=stConnectionsBlocked, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kCompanyName=kCompanyName, kRevision=kRevision, kCustomVersion=kCustomVersion, pAMSignatureVersion=pAMSignatureVersion, pMFEDATVersion=pMFEDATVersion, stMalwareDetected=stMalwareDetected, stCPULoad=stCPULoad, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgStatistics=mwgStatistics, stBlockedByURLFilter=stBlockedByURLFilter, stMemConsumed=stMemConsumed, mwgTrapVariables=mwgTrapVariables, stFtpBytesToServer=stFtpBytesToServer, notifyOrigin=notifyOrigin, stHttpsBytesToClient=stHttpsBytesToClient, stFtpTraffic=stFtpTraffic, stResolveHostViaDNS=stResolveHostViaDNS)
