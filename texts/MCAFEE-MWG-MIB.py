...
ModuleIdentity, Integer32, iso, IpAddress, Bits, Unsigned32, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, mib_2, enterprises, TimeTicks, ObjectIdentity, Gauge32, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "iso", "IpAddress", "Bits", "Unsigned32", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "mib-2", "enterprises", "TimeTicks", "ObjectIdentity", "Gauge32", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpTraffic=stFtpTraffic, notifyAffectedHost=notifyAffectedHost, stHttpBytesFromClient=stHttpBytesFromClient, stCategoriesEntry=stCategoriesEntry, kRevision=kRevision, stHttpBytesToServer=stHttpBytesToServer, stMalwareDetected=stMalwareDetected, pAMSignatureVersion=pAMSignatureVersion, notifyReason=notifyReason, trApplication=trApplication, stConnectedSockets=stConnectedSockets, pMFEDATVersion=pMFEDATVersion, trUser=trUser, mwgContent=mwgContent, stBlockedByAntiMalware=stBlockedByAntiMalware, stConnectionsBlocked=stConnectionsBlocked, stResolveHostViaDNS=stResolveHostViaDNS, stClientCount=stClientCount, pTSDBVersion=pTSDBVersion, kProductVersion=kProductVersion, mwgMiscellaneous=mwgMiscellaneous, kProductName=kProductName, kCustomVersion=kCustomVersion, notifyOriginName=notifyOriginName, trSystem=trSystem, notifyReasonString=notifyReasonString, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMinorVersion=kMinorVersion, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stHttpBytesToClient=stHttpBytesToClient, notifyAdditional=notifyAdditional, stBlockedByURLFilter=stBlockedByURLFilter, stHttpTraffic=stHttpTraffic, pMFEEngineVersion=pMFEEngineVersion, stConnectionsLegitimate=stConnectionsLegitimate, kBuildNumber=kBuildNumber, stHttpsTraffic=stHttpsTraffic, stFtpBytesFromClient=stFtpBytesFromClient, mwgHttp=mwgHttp, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpRequests=stHttpRequests, PYSNMP_MODULE_ID=mwg, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesToServer=stHttpsBytesToServer, stCPULoadRaw=stCPULoadRaw, mwgTrapVariables=mwgTrapVariables, stCategoryName=stCategoryName, stHttpsBytesToClient=stHttpsBytesToClient, kMajorVersion=kMajorVersion, stCPULoad=stCPULoad, stMemConsumed=stMemConsumed, mwgTraps=mwgTraps, mwg=mwg, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMimeType=stMimeType, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMProactiveVersion=pAMProactiveVersion, mwgInfo=mwgInfo, mwgStatistics=mwgStatistics, stCategories=stCategories, stCategoryCount=stCategoryCount, notifySeverity=notifySeverity, mwgHttps=mwgHttps, stCPUIOWait=stCPUIOWait, notifyOrigin=notifyOrigin, mwgFTP=mwgFTP, stCategoriesTable=stCategoriesTable, pAMEngineVersion=pAMEngineVersion, stFtpBytesToServer=stFtpBytesToServer, kHotfixVersion=kHotfixVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kCompanyName=kCompanyName, stHttpsRequests=stHttpsRequests, stHttpsBytesFromClient=stHttpsBytesFromClient, kMicroVersion=kMicroVersion, mwgEngineVersions=mwgEngineVersions, stTimeForTransaction=stTimeForTransaction, stBadReputation=stBadReputation)
