...
iso, NotificationType, IpAddress, Gauge32, Counter64, NotificationType, Bits, enterprises, Counter32, ModuleIdentity, MibIdentifier, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, mib_2, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "IpAddress", "Gauge32", "Counter64", "NotificationType", "Bits", "enterprises", "Counter32", "ModuleIdentity", "MibIdentifier", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "mib-2", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kMajorVersion=kMajorVersion, stHttpsBytesToServer=stHttpsBytesToServer, pMFEEngineVersion=pMFEEngineVersion, kHotfixVersion=kHotfixVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMimeType=stMimeType, kBuildNumber=kBuildNumber, kMicroVersion=kMicroVersion, stHttpBytesToServer=stHttpBytesToServer, stMemConsumed=stMemConsumed, PYSNMP_MODULE_ID=mwg, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, kMinorVersion=kMinorVersion, stHttpRequests=stHttpRequests, stConnectionsLegitimate=stConnectionsLegitimate, kProductVersion=kProductVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgInfo=mwgInfo, notifySeverity=notifySeverity, notifyAdditional=notifyAdditional, kCustomVersion=kCustomVersion, stFtpBytesFromClient=stFtpBytesFromClient, stMalwareDetected=stMalwareDetected, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHandleConnectToServer=stHandleConnectToServer, pAMProactiveVersion=pAMProactiveVersion, pMFEDATVersion=pMFEDATVersion, stCategoriesTable=stCategoriesTable, stHttpsBytesToClient=stHttpsBytesToClient, stTimeForTransaction=stTimeForTransaction, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgTraps=mwgTraps, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCPULoadRaw=stCPULoadRaw, stFtpBytesFromServer=stFtpBytesFromServer, pAMEngineVersion=pAMEngineVersion, stCategoryCount=stCategoryCount, stCPULoad=stCPULoad, mwgHttp=mwgHttp, kCompanyName=kCompanyName, pAMSignatureVersion=pAMSignatureVersion, kRevision=kRevision, stClientCount=stClientCount, stHttpBytesFromServer=stHttpBytesFromServer, notifyReasonString=notifyReasonString, mwgFTP=mwgFTP, stHttpsRequests=stHttpsRequests, mwg=mwg, mwgEngineVersions=mwgEngineVersions, notifyOriginName=notifyOriginName, kProductName=kProductName, stBlockedByURLFilter=stBlockedByURLFilter, mwgMiscellaneous=mwgMiscellaneous, stFtpTraffic=stFtpTraffic, trUser=trUser, mwgContent=mwgContent, stHttpTraffic=stHttpTraffic, notifyAffectedHost=notifyAffectedHost, pTSDBVersion=pTSDBVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsTraffic=stHttpsTraffic, stBadReputation=stBadReputation, stHttpBytesToClient=stHttpBytesToClient, notifyReason=notifyReason, stResolveHostViaDNS=stResolveHostViaDNS, notifyOrigin=notifyOrigin, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, trSystem=trSystem, stCategoriesEntry=stCategoriesEntry, trApplication=trApplication, stConnectionsBlocked=stConnectionsBlocked, stCPUIOWait=stCPUIOWait, mwgTrapVariables=mwgTrapVariables, stConnectedSockets=stConnectedSockets, stCategories=stCategories, mwgHttps=mwgHttps, stCategoryName=stCategoryName, stHttpBytesFromClient=stHttpBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgStatistics=mwgStatistics, stBlockedByAntiMalware=stBlockedByAntiMalware)
