...
TimeTicks, Bits, IpAddress, NotificationType, Gauge32, Integer32, MibIdentifier, Counter32, Counter64, mib_2, iso, ObjectIdentity, Unsigned32, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "IpAddress", "NotificationType", "Gauge32", "Integer32", "MibIdentifier", "Counter32", "Counter64", "mib-2", "iso", "ObjectIdentity", "Unsigned32", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMemConsumed=stMemConsumed, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCPUIOWait=stCPUIOWait, stCategoriesEntry=stCategoriesEntry, stFtpBytesFromClient=stFtpBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsTraffic=stHttpsTraffic, stHttpBytesToClient=stHttpBytesToClient, PYSNMP_MODULE_ID=mwg, stCategoryCount=stCategoryCount, stHttpTraffic=stHttpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwg=mwg, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyReason=notifyReason, stBadReputation=stBadReputation, notifyAdditional=notifyAdditional, stConnectionsLegitimate=stConnectionsLegitimate, pAMSignatureVersion=pAMSignatureVersion, kProductName=kProductName, kCompanyName=kCompanyName, mwgHttp=mwgHttp, trSystem=trSystem, stFtpTraffic=stFtpTraffic, stFtpBytesToClient=stFtpBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgStatistics=mwgStatistics, pMFEDATVersion=pMFEDATVersion, stFtpBytesToServer=stFtpBytesToServer, notifyOrigin=notifyOrigin, stResolveHostViaDNS=stResolveHostViaDNS, stCPULoad=stCPULoad, stBlockedByURLFilter=stBlockedByURLFilter, notifySeverity=notifySeverity, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stClientCount=stClientCount, kMajorVersion=kMajorVersion, mwgHttps=mwgHttps, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesToServer=stHttpsBytesToServer, kProductVersion=kProductVersion, pAMProactiveVersion=pAMProactiveVersion, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoriesTable=stCategoriesTable, stFtpBytesFromServer=stFtpBytesFromServer, stHttpRequests=stHttpRequests, mwgTrapVariables=mwgTrapVariables, stMalwareDetected=stMalwareDetected, stHttpBytesFromClient=stHttpBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyOriginName=notifyOriginName, kMicroVersion=kMicroVersion, trUser=trUser, stTimeForTransaction=stTimeForTransaction, pTSDBVersion=pTSDBVersion, mwgEngineVersions=mwgEngineVersions, mwgContent=mwgContent, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgMiscellaneous=mwgMiscellaneous, stConnectionsBlocked=stConnectionsBlocked, kCustomVersion=kCustomVersion, kBuildNumber=kBuildNumber, stHttpsRequests=stHttpsRequests, notifyAffectedHost=notifyAffectedHost, mwgFTP=mwgFTP, mwgInfo=mwgInfo, notifyReasonString=notifyReasonString, stMimeType=stMimeType, kRevision=kRevision, kMinorVersion=kMinorVersion, stCPULoadRaw=stCPULoadRaw, mwgTraps=mwgTraps, kHotfixVersion=kHotfixVersion, stCategories=stCategories, stHttpsBytesToClient=stHttpsBytesToClient, stConnectedSockets=stConnectedSockets, trApplication=trApplication, stCategoryName=stCategoryName, stHandleConnectToServer=stHandleConnectToServer)
