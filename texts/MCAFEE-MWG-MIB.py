...
ModuleIdentity, Unsigned32, TimeTicks, Gauge32, mib_2, enterprises, iso, ObjectIdentity, Counter32, Bits, Integer32, IpAddress, MibIdentifier, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "TimeTicks", "Gauge32", "mib-2", "enterprises", "iso", "ObjectIdentity", "Counter32", "Bits", "Integer32", "IpAddress", "MibIdentifier", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyAdditional=notifyAdditional, stCategoriesTable=stCategoriesTable, trUser=trUser, stBlockedByAntiMalware=stBlockedByAntiMalware, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgTrapVariables=mwgTrapVariables, stHttpsBytesToServer=stHttpsBytesToServer, stCPULoadRaw=stCPULoadRaw, stBlockedByMediaFilter=stBlockedByMediaFilter, stMemConsumed=stMemConsumed, trSystem=trSystem, pAMSignatureVersion=pAMSignatureVersion, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesToClient=stFtpBytesToClient, stHttpRequests=stHttpRequests, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kCompanyName=kCompanyName, mwgMiscellaneous=mwgMiscellaneous, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pTSDBVersion=pTSDBVersion, mwgHttp=mwgHttp, mwgFTP=mwgFTP, stHttpTraffic=stHttpTraffic, stHttpsBytesToClient=stHttpsBytesToClient, pAMEngineVersion=pAMEngineVersion, kCustomVersion=kCustomVersion, kMicroVersion=kMicroVersion, notifyOrigin=notifyOrigin, mwgContent=mwgContent, stConnectedSockets=stConnectedSockets, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesFromClient=stFtpBytesFromClient, kProductName=kProductName, mwg=mwg, mwgHttps=mwgHttps, kMajorVersion=kMajorVersion, stResolveHostViaDNS=stResolveHostViaDNS, trApplication=trApplication, stCPUIOWait=stCPUIOWait, stMimeType=stMimeType, notifySeverity=notifySeverity, stHttpBytesFromClient=stHttpBytesFromClient, notifyOriginName=notifyOriginName, notifyReason=notifyReason, stCategoryCount=stCategoryCount, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpBytesFromServer=stHttpBytesFromServer, kBuildNumber=kBuildNumber, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTraps=mwgTraps, stTimeForTransaction=stTimeForTransaction, mwgInfo=mwgInfo, kProductVersion=kProductVersion, pAMProactiveVersion=pAMProactiveVersion, stConnectionsBlocked=stConnectionsBlocked, pMFEDATVersion=pMFEDATVersion, mwgStatistics=mwgStatistics, mwgEngineVersions=mwgEngineVersions, stBadReputation=stBadReputation, stCategoriesEntry=stCategoriesEntry, kHotfixVersion=kHotfixVersion, stClientCount=stClientCount, stHttpBytesToClient=stHttpBytesToClient, stConnectionsLegitimate=stConnectionsLegitimate, pMFEEngineVersion=pMFEEngineVersion, stHttpsRequests=stHttpsRequests, kRevision=kRevision, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsTraffic=stHttpsTraffic, stFtpTraffic=stFtpTraffic, stCategories=stCategories, notifyReasonString=notifyReasonString, notifyAffectedHost=notifyAffectedHost, stFtpBytesToServer=stFtpBytesToServer, stCPULoad=stCPULoad, PYSNMP_MODULE_ID=mwg, stMalwareDetected=stMalwareDetected, stCategoryName=stCategoryName, kMinorVersion=kMinorVersion, stFtpBytesFromServer=stFtpBytesFromServer)
