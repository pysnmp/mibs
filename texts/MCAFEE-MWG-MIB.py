...
Gauge32, ModuleIdentity, enterprises, mib_2, NotificationType, Bits, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Integer32, MibIdentifier, NotificationType, TimeTicks, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "enterprises", "mib-2", "NotificationType", "Bits", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Integer32", "MibIdentifier", "NotificationType", "TimeTicks", "iso", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPULoad=stCPULoad, kHotfixVersion=kHotfixVersion, notifySeverity=notifySeverity, kBuildNumber=kBuildNumber, stHttpBytesFromServer=stHttpBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesFromClient=stHttpBytesFromClient, stCPULoadRaw=stCPULoadRaw, stCategoryName=stCategoryName, kProductName=kProductName, notifyOriginName=notifyOriginName, stConnectionsBlocked=stConnectionsBlocked, mwgStatistics=mwgStatistics, stHttpsBytesFromServer=stHttpsBytesFromServer, stMemConsumed=stMemConsumed, notifyAdditional=notifyAdditional, stTimeForTransaction=stTimeForTransaction, mwgEngineVersions=mwgEngineVersions, stBlockedByURLFilter=stBlockedByURLFilter, pAMEngineVersion=pAMEngineVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgTrapVariables=mwgTrapVariables, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesToServer=stHttpsBytesToServer, stBadReputation=stBadReputation, stFtpTraffic=stFtpTraffic, trUser=trUser, notifyReasonString=notifyReasonString, stCategoriesEntry=stCategoriesEntry, trSystem=trSystem, stHttpsBytesToClient=stHttpsBytesToClient, stHandleConnectToServer=stHandleConnectToServer, mwg=mwg, stHttpRequests=stHttpRequests, mwgInfo=mwgInfo, kRevision=kRevision, stBlockedByAntiMalware=stBlockedByAntiMalware, stMalwareDetected=stMalwareDetected, pAMProactiveVersion=pAMProactiveVersion, mwgContent=mwgContent, stResolveHostViaDNS=stResolveHostViaDNS, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kCustomVersion=kCustomVersion, kMajorVersion=kMajorVersion, trApplication=trApplication, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesToClient=stHttpBytesToClient, notifyAffectedHost=notifyAffectedHost, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesToClient=stFtpBytesToClient, stCategoriesTable=stCategoriesTable, stCPUIOWait=stCPUIOWait, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgHttp=mwgHttp, stHttpTraffic=stHttpTraffic, kCompanyName=kCompanyName, stHttpsTraffic=stHttpsTraffic, pTSDBVersion=pTSDBVersion, PYSNMP_MODULE_ID=mwg, mwgHttps=mwgHttps, notifyOrigin=notifyOrigin, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesFromServer=stFtpBytesFromServer, stCategories=stCategories, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgTraps=mwgTraps, notifyReason=notifyReason, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesFromClient=stHttpsBytesFromClient, kProductVersion=kProductVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMinorVersion=kMinorVersion, kMicroVersion=kMicroVersion, mwgFTP=mwgFTP, stHttpBytesToServer=stHttpBytesToServer, stConnectedSockets=stConnectedSockets, stCategoryCount=stCategoryCount, stHttpsRequests=stHttpsRequests, pMFEDATVersion=pMFEDATVersion, stClientCount=stClientCount, stMimeType=stMimeType, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesFromClient=stFtpBytesFromClient)
