...
Counter64, Integer32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, Unsigned32, TimeTicks, ModuleIdentity, mib_2, IpAddress, ObjectIdentity, MibIdentifier, iso, NotificationType, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "Unsigned32", "TimeTicks", "ModuleIdentity", "mib-2", "IpAddress", "ObjectIdentity", "MibIdentifier", "iso", "NotificationType", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kHotfixVersion=kHotfixVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stTimeForTransaction=stTimeForTransaction, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMEngineVersion=pAMEngineVersion, stCPULoad=stCPULoad, pMFEDATVersion=pMFEDATVersion, notifyOrigin=notifyOrigin, stFtpBytesToServer=stFtpBytesToServer, pAMProactiveVersion=pAMProactiveVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesFromServer=stHttpBytesFromServer, notifySeverity=notifySeverity, stCategoryCount=stCategoryCount, mwgTraps=mwgTraps, trApplication=trApplication, stClientCount=stClientCount, stHttpBytesToServer=stHttpBytesToServer, kProductName=kProductName, stMemConsumed=stMemConsumed, kRevision=kRevision, stBadReputation=stBadReputation, stHttpBytesToClient=stHttpBytesToClient, stResolveHostViaDNS=stResolveHostViaDNS, mwgStatistics=mwgStatistics, mwgHttps=mwgHttps, mwgTrapVariables=mwgTrapVariables, stBlockedByURLFilter=stBlockedByURLFilter, pTSDBVersion=pTSDBVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, trUser=trUser, stHttpsTraffic=stHttpsTraffic, kCustomVersion=kCustomVersion, stConnectionsLegitimate=stConnectionsLegitimate, kCompanyName=kCompanyName, stCategories=stCategories, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyAdditional=notifyAdditional, notifyAffectedHost=notifyAffectedHost, kProductVersion=kProductVersion, pAMSignatureVersion=pAMSignatureVersion, kBuildNumber=kBuildNumber, stFtpTraffic=stFtpTraffic, mwgFTP=mwgFTP, notifyReason=notifyReason, kMinorVersion=kMinorVersion, kMajorVersion=kMajorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectedSockets=stConnectedSockets, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsRequests=stHttpsRequests, stMalwareDetected=stMalwareDetected, stFtpBytesToClient=stFtpBytesToClient, stFtpBytesFromServer=stFtpBytesFromServer, trSystem=trSystem, stHandleConnectToServer=stHandleConnectToServer, mwgHttp=mwgHttp, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesToClient=stHttpsBytesToClient, stHttpRequests=stHttpRequests, mwgMiscellaneous=mwgMiscellaneous, pMFEEngineVersion=pMFEEngineVersion, PYSNMP_MODULE_ID=mwg, mwgEngineVersions=mwgEngineVersions, stCategoriesTable=stCategoriesTable, mwgContent=mwgContent, stCPULoadRaw=stCPULoadRaw, mwg=mwg, stFtpBytesFromClient=stFtpBytesFromClient, stCategoryName=stCategoryName, notifyReasonString=notifyReasonString, kMicroVersion=kMicroVersion, mwgInfo=mwgInfo, stHttpBytesFromClient=stHttpBytesFromClient, stHttpTraffic=stHttpTraffic, stMimeType=stMimeType, notifyOriginName=notifyOriginName, stCPUIOWait=stCPUIOWait, stCategoriesEntry=stCategoriesEntry)
