...
MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, ObjectIdentity, Integer32, enterprises, iso, Counter32, Gauge32, TimeTicks, MibIdentifier, ModuleIdentity, Counter64, Unsigned32, IpAddress, NotificationType, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "ObjectIdentity", "Integer32", "enterprises", "iso", "Counter32", "Gauge32", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Counter64", "Unsigned32", "IpAddress", "NotificationType", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoryCount=stCategoryCount, stHttpsBytesToClient=stHttpsBytesToClient, mwgFTP=mwgFTP, trUser=trUser, mwgContent=mwgContent, stMimeType=stMimeType, kMinorVersion=kMinorVersion, pMFEDATVersion=pMFEDATVersion, stHttpBytesToClient=stHttpBytesToClient, mwgHttps=mwgHttps, kProductName=kProductName, kBuildNumber=kBuildNumber, stHttpsTraffic=stHttpsTraffic, stClientCount=stClientCount, pAMProactiveVersion=pAMProactiveVersion, kCompanyName=kCompanyName, stFtpBytesFromServer=stFtpBytesFromServer, mwgStatistics=mwgStatistics, PYSNMP_MODULE_ID=mwg, pAMSignatureVersion=pAMSignatureVersion, stBadReputation=stBadReputation, stBlockedByURLFilter=stBlockedByURLFilter, stCategories=stCategories, notifySeverity=notifySeverity, notifyReasonString=notifyReasonString, mwgTraps=mwgTraps, mwgMiscellaneous=mwgMiscellaneous, notifyAffectedHost=notifyAffectedHost, trSystem=trSystem, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgHttp=mwgHttp, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMEngineVersion=pAMEngineVersion, stMemConsumed=stMemConsumed, stHttpRequests=stHttpRequests, pMFEEngineVersion=pMFEEngineVersion, stMalwareDetected=stMalwareDetected, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kProductVersion=kProductVersion, mwgEngineVersions=mwgEngineVersions, notifyOriginName=notifyOriginName, mwg=mwg, stHttpBytesFromServer=stHttpBytesFromServer, pTSDBVersion=pTSDBVersion, stResolveHostViaDNS=stResolveHostViaDNS, notifyReason=notifyReason, trApplication=trApplication, kMicroVersion=kMicroVersion, notifyOrigin=notifyOrigin, kCustomVersion=kCustomVersion, kMajorVersion=kMajorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, stCategoryName=stCategoryName, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyAdditional=notifyAdditional, mwgInfo=mwgInfo, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpTraffic=stHttpTraffic, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesToClient=stFtpBytesToClient, stConnectedSockets=stConnectedSockets, kHotfixVersion=kHotfixVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsRequests=stHttpsRequests, stConnectionsBlocked=stConnectionsBlocked, stBlockedByAntiMalware=stBlockedByAntiMalware, kRevision=kRevision, stCategoriesEntry=stCategoriesEntry, stCPULoadRaw=stCPULoadRaw, mwgTrapVariables=mwgTrapVariables, stTimeForTransaction=stTimeForTransaction, stCategoriesTable=stCategoriesTable, stCPULoad=stCPULoad, stFtpTraffic=stFtpTraffic, stCPUIOWait=stCPUIOWait, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesToServer=stHttpBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesToServer=stFtpBytesToServer, stConnectionsLegitimate=stConnectionsLegitimate)
