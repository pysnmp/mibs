...
ModuleIdentity, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, Counter32, mib_2, iso, Unsigned32, Bits, enterprises, NotificationType, NotificationType, MibIdentifier, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "Counter32", "mib-2", "iso", "Unsigned32", "Bits", "enterprises", "NotificationType", "NotificationType", "MibIdentifier", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kHotfixVersion=kHotfixVersion, mwg=mwg, notifySeverity=notifySeverity, kProductVersion=kProductVersion, notifyAffectedHost=notifyAffectedHost, stBadReputation=stBadReputation, kProductName=kProductName, stBlockedByMediaFilter=stBlockedByMediaFilter, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgTrapVariables=mwgTrapVariables, kCustomVersion=kCustomVersion, pTSDBVersion=pTSDBVersion, stMalwareDetected=stMalwareDetected, stCategoryCount=stCategoryCount, stHttpTraffic=stHttpTraffic, stHttpsBytesToClient=stHttpsBytesToClient, stResolveHostViaDNS=stResolveHostViaDNS, pAMProactiveVersion=pAMProactiveVersion, stFtpTraffic=stFtpTraffic, stFtpBytesFromClient=stFtpBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyAdditional=notifyAdditional, stConnectionsLegitimate=stConnectionsLegitimate, mwgHttps=mwgHttps, stHttpRequests=stHttpRequests, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesToClient=stFtpBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, PYSNMP_MODULE_ID=mwg, kMicroVersion=kMicroVersion, kRevision=kRevision, trApplication=trApplication, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoriesEntry=stCategoriesEntry, stConnectedSockets=stConnectedSockets, stHttpsBytesFromClient=stHttpsBytesFromClient, kMinorVersion=kMinorVersion, pAMEngineVersion=pAMEngineVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgFTP=mwgFTP, stMimeType=stMimeType, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesFromServer=stFtpBytesFromServer, pMFEDATVersion=pMFEDATVersion, stClientCount=stClientCount, stHttpsBytesToServer=stHttpsBytesToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoriesTable=stCategoriesTable, notifyReason=notifyReason, kMajorVersion=kMajorVersion, stMemConsumed=stMemConsumed, stHttpBytesFromClient=stHttpBytesFromClient, mwgInfo=mwgInfo, stCategories=stCategories, stHttpsRequests=stHttpsRequests, notifyReasonString=notifyReasonString, notifyOrigin=notifyOrigin, stFtpBytesToServer=stFtpBytesToServer, mwgEngineVersions=mwgEngineVersions, stCPULoad=stCPULoad, stHttpsTraffic=stHttpsTraffic, stTimeForTransaction=stTimeForTransaction, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kBuildNumber=kBuildNumber, mwgHttp=mwgHttp, mwgMiscellaneous=mwgMiscellaneous, mwgTraps=mwgTraps, mwgContent=mwgContent, stConnectionsBlocked=stConnectionsBlocked, stCategoryName=stCategoryName, stCPUIOWait=stCPUIOWait, trUser=trUser, trSystem=trSystem, stHttpBytesToClient=stHttpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, notifyOriginName=notifyOriginName, stCPULoadRaw=stCPULoadRaw, kCompanyName=kCompanyName, stHttpBytesFromServer=stHttpBytesFromServer, mwgStatistics=mwgStatistics)
