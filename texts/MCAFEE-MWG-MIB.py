...
TimeTicks, ModuleIdentity, enterprises, Bits, NotificationType, ObjectIdentity, NotificationType, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, mib_2, Counter32, iso, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "enterprises", "Bits", "NotificationType", "ObjectIdentity", "NotificationType", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "mib-2", "Counter32", "iso", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMimeType=stMimeType, mwgTrapVariables=mwgTrapVariables, stCategories=stCategories, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMajorVersion=kMajorVersion, mwgStatistics=mwgStatistics, stFtpBytesToClient=stFtpBytesToClient, stCategoryName=stCategoryName, kRevision=kRevision, stFtpBytesFromClient=stFtpBytesFromClient, PYSNMP_MODULE_ID=mwg, stBlockedByAntiMalware=stBlockedByAntiMalware, mwg=mwg, kMinorVersion=kMinorVersion, stHttpRequests=stHttpRequests, mwgInfo=mwgInfo, notifyAdditional=notifyAdditional, stHttpsBytesToClient=stHttpsBytesToClient, notifySeverity=notifySeverity, stClientCount=stClientCount, pAMEngineVersion=pAMEngineVersion, stCPUIOWait=stCPUIOWait, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoad=stCPULoad, stFtpBytesFromServer=stFtpBytesFromServer, kBuildNumber=kBuildNumber, stFtpBytesToServer=stFtpBytesToServer, stHttpsTraffic=stHttpsTraffic, notifyOriginName=notifyOriginName, stBadReputation=stBadReputation, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesFromClient=stHttpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesFromClient=stHttpsBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kHotfixVersion=kHotfixVersion, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsRequests=stHttpsRequests, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpTraffic=stHttpTraffic, kProductName=kProductName, stBlockedByMediaFilter=stBlockedByMediaFilter, trSystem=trSystem, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpTraffic=stFtpTraffic, mwgHttps=mwgHttps, mwgTraps=mwgTraps, stConnectionsBlocked=stConnectionsBlocked, stConnectionsLegitimate=stConnectionsLegitimate, kProductVersion=kProductVersion, kCompanyName=kCompanyName, stHttpsBytesToServer=stHttpsBytesToServer, stCategoriesEntry=stCategoriesEntry, stHttpBytesFromServer=stHttpBytesFromServer, mwgHttp=mwgHttp, pMFEEngineVersion=pMFEEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, stHandleConnectToServer=stHandleConnectToServer, mwgFTP=mwgFTP, notifyReasonString=notifyReasonString, stConnectedSockets=stConnectedSockets, trApplication=trApplication, stCategoryCount=stCategoryCount, stMalwareDetected=stMalwareDetected, stCategoriesTable=stCategoriesTable, trUser=trUser, mwgContent=mwgContent, stCPULoadRaw=stCPULoadRaw, stHttpBytesToServer=stHttpBytesToServer, pAMSignatureVersion=pAMSignatureVersion, stTimeForTransaction=stTimeForTransaction, kMicroVersion=kMicroVersion, pMFEDATVersion=pMFEDATVersion, pTSDBVersion=pTSDBVersion, notifyReason=notifyReason, stHttpBytesToClient=stHttpBytesToClient, kCustomVersion=kCustomVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMemConsumed=stMemConsumed, notifyAffectedHost=notifyAffectedHost, notifyOrigin=notifyOrigin, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgEngineVersions=mwgEngineVersions)
