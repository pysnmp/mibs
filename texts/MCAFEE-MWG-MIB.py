...
TimeTicks, Unsigned32, Counter32, IpAddress, Counter64, MibIdentifier, ModuleIdentity, enterprises, iso, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, NotificationType, ObjectIdentity, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "Counter32", "IpAddress", "Counter64", "MibIdentifier", "ModuleIdentity", "enterprises", "iso", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "NotificationType", "ObjectIdentity", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMemConsumed=stMemConsumed, kProductName=kProductName, stCPULoad=stCPULoad, trSystem=trSystem, mwgTraps=mwgTraps, PYSNMP_MODULE_ID=mwg, stFtpBytesToClient=stFtpBytesToClient, notifyReason=notifyReason, notifyOriginName=notifyOriginName, stHttpBytesToClient=stHttpBytesToClient, stCategoryName=stCategoryName, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgStatistics=mwgStatistics, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgContent=mwgContent, stHandleConnectToServer=stHandleConnectToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stBadReputation=stBadReputation, stCPUIOWait=stCPUIOWait, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgFTP=mwgFTP, pAMProactiveVersion=pAMProactiveVersion, stHttpsTraffic=stHttpsTraffic, stMalwareDetected=stMalwareDetected, mwgEngineVersions=mwgEngineVersions, stHttpsBytesToClient=stHttpsBytesToClient, mwg=mwg, pMFEDATVersion=pMFEDATVersion, stHttpRequests=stHttpRequests, stHttpBytesFromServer=stHttpBytesFromServer, notifyOrigin=notifyOrigin, pMFEEngineVersion=pMFEEngineVersion, stMimeType=stMimeType, stBlockedByURLFilter=stBlockedByURLFilter, kCustomVersion=kCustomVersion, stFtpBytesFromServer=stFtpBytesFromServer, mwgHttp=mwgHttp, notifyAdditional=notifyAdditional, stCategoriesEntry=stCategoriesEntry, stFtpTraffic=stFtpTraffic, kHotfixVersion=kHotfixVersion, kMicroVersion=kMicroVersion, kRevision=kRevision, trApplication=trApplication, notifySeverity=notifySeverity, stCategories=stCategories, stCategoriesTable=stCategoriesTable, stConnectedSockets=stConnectedSockets, mwgMiscellaneous=mwgMiscellaneous, kMinorVersion=kMinorVersion, notifyReasonString=notifyReasonString, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesToServer=stHttpsBytesToServer, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesFromClient=stFtpBytesFromClient, mwgHttps=mwgHttps, stClientCount=stClientCount, pAMSignatureVersion=pAMSignatureVersion, mwgTrapVariables=mwgTrapVariables, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoryCount=stCategoryCount, notifyAffectedHost=notifyAffectedHost, kCompanyName=kCompanyName, kMajorVersion=kMajorVersion, stConnectionsBlocked=stConnectionsBlocked, stHttpsRequests=stHttpsRequests, stCPULoadRaw=stCPULoadRaw, pTSDBVersion=pTSDBVersion, stHttpBytesToServer=stHttpBytesToServer, stHttpTraffic=stHttpTraffic, mwgInfo=mwgInfo, pAMEngineVersion=pAMEngineVersion, trUser=trUser, kBuildNumber=kBuildNumber, stTimeForTransaction=stTimeForTransaction, kProductVersion=kProductVersion, stHttpBytesFromClient=stHttpBytesFromClient, stResolveHostViaDNS=stResolveHostViaDNS, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine)
