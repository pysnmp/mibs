...
Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, mib_2, iso, ObjectIdentity, Bits, TimeTicks, MibIdentifier, NotificationType, Counter64, Integer32, NotificationType, Unsigned32, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "mib-2", "iso", "ObjectIdentity", "Bits", "TimeTicks", "MibIdentifier", "NotificationType", "Counter64", "Integer32", "NotificationType", "Unsigned32", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesToServer=stFtpBytesToServer, stMemConsumed=stMemConsumed, stFtpBytesFromClient=stFtpBytesFromClient, stClientCount=stClientCount, stHandleConnectToServer=stHandleConnectToServer, stHttpTraffic=stHttpTraffic, pAMSignatureVersion=pAMSignatureVersion, trApplication=trApplication, mwgEngineVersions=mwgEngineVersions, stMimeType=stMimeType, stBlockedByURLFilter=stBlockedByURLFilter, stCategoryName=stCategoryName, stHttpsBytesToServer=stHttpsBytesToServer, kProductName=kProductName, stFtpTraffic=stFtpTraffic, mwgFTP=mwgFTP, notifyReason=notifyReason, stCPULoad=stCPULoad, mwgTrapVariables=mwgTrapVariables, stCategoriesTable=stCategoriesTable, mwgTraps=mwgTraps, kCompanyName=kCompanyName, stHttpsBytesToClient=stHttpsBytesToClient, stTimeForTransaction=stTimeForTransaction, stConnectionsBlocked=stConnectionsBlocked, notifyReasonString=notifyReasonString, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesToServer=stHttpBytesToServer, pAMEngineVersion=pAMEngineVersion, stFtpBytesToClient=stFtpBytesToClient, pTSDBVersion=pTSDBVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgHttp=mwgHttp, stBadReputation=stBadReputation, stHttpBytesFromClient=stHttpBytesFromClient, mwgStatistics=mwgStatistics, mwgInfo=mwgInfo, trSystem=trSystem, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesFromClient=stHttpsBytesFromClient, PYSNMP_MODULE_ID=mwg, mwgMiscellaneous=mwgMiscellaneous, kMajorVersion=kMajorVersion, stHttpsTraffic=stHttpsTraffic, notifyAffectedHost=notifyAffectedHost, notifyAdditional=notifyAdditional, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMalwareDetected=stMalwareDetected, stResolveHostViaDNS=stResolveHostViaDNS, mwgContent=mwgContent, stHttpBytesFromServer=stHttpBytesFromServer, kHotfixVersion=kHotfixVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoryCount=stCategoryCount, stCategoriesEntry=stCategoriesEntry, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwg=mwg, stCPUIOWait=stCPUIOWait, kMicroVersion=kMicroVersion, kMinorVersion=kMinorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyOrigin=notifyOrigin, pMFEDATVersion=pMFEDATVersion, mwgHttps=mwgHttps, kProductVersion=kProductVersion, pMFEEngineVersion=pMFEEngineVersion, stCategories=stCategories, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMProactiveVersion=pAMProactiveVersion, stConnectionsLegitimate=stConnectionsLegitimate, stConnectedSockets=stConnectedSockets, trUser=trUser, stHttpsRequests=stHttpsRequests, stHttpRequests=stHttpRequests, stCPULoadRaw=stCPULoadRaw, kBuildNumber=kBuildNumber, kRevision=kRevision, kCustomVersion=kCustomVersion, notifyOriginName=notifyOriginName, notifySeverity=notifySeverity)
