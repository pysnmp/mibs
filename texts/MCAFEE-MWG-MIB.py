...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, Unsigned32, NotificationType, ModuleIdentity, iso, TimeTicks, NotificationType, mib_2, Bits, Integer32, Gauge32, Counter32, IpAddress, ObjectIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "Unsigned32", "NotificationType", "ModuleIdentity", "iso", "TimeTicks", "NotificationType", "mib-2", "Bits", "Integer32", "Gauge32", "Counter32", "IpAddress", "ObjectIdentity", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMSignatureVersion=pAMSignatureVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, notifySeverity=notifySeverity, stCategoryCount=stCategoryCount, trUser=trUser, stCategories=stCategories, stCPUIOWait=stCPUIOWait, stCategoryName=stCategoryName, stFtpTraffic=stFtpTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, PYSNMP_MODULE_ID=mwg, mwgStatistics=mwgStatistics, kMajorVersion=kMajorVersion, stCPULoadRaw=stCPULoadRaw, stHttpsBytesToServer=stHttpsBytesToServer, pMFEDATVersion=pMFEDATVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectedSockets=stConnectedSockets, notifyReasonString=notifyReasonString, stMalwareDetected=stMalwareDetected, notifyOriginName=notifyOriginName, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, kProductName=kProductName, mwgFTP=mwgFTP, stTimeForTransaction=stTimeForTransaction, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMinorVersion=kMinorVersion, stBlockedByURLFilter=stBlockedByURLFilter, stMemConsumed=stMemConsumed, stHandleConnectToServer=stHandleConnectToServer, stConnectionsLegitimate=stConnectionsLegitimate, pAMEngineVersion=pAMEngineVersion, stCPULoad=stCPULoad, stMimeType=stMimeType, notifyOrigin=notifyOrigin, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, stClientCount=stClientCount, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, mwgTrapVariables=mwgTrapVariables, stHttpBytesToServer=stHttpBytesToServer, mwgTraps=mwgTraps, stFtpBytesFromServer=stFtpBytesFromServer, pTSDBVersion=pTSDBVersion, kProductVersion=kProductVersion, stCategoriesTable=stCategoriesTable, mwgInfo=mwgInfo, stHttpsBytesToClient=stHttpsBytesToClient, kHotfixVersion=kHotfixVersion, trSystem=trSystem, mwgContent=mwgContent, stBadReputation=stBadReputation, mwgHttps=mwgHttps, stHttpBytesFromClient=stHttpBytesFromClient, mwgEngineVersions=mwgEngineVersions, trApplication=trApplication, stHttpBytesToClient=stHttpBytesToClient, notifyReason=notifyReason, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyAdditional=notifyAdditional, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesToServer=stFtpBytesToServer, kCompanyName=kCompanyName, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMProactiveVersion=pAMProactiveVersion, stHttpsTraffic=stHttpsTraffic, mwg=mwg, stHttpTraffic=stHttpTraffic, mwgHttp=mwgHttp, kRevision=kRevision, stHttpRequests=stHttpRequests, stHttpsRequests=stHttpsRequests, kBuildNumber=kBuildNumber, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyAffectedHost=notifyAffectedHost, kMicroVersion=kMicroVersion, stConnectionsBlocked=stConnectionsBlocked, kCustomVersion=kCustomVersion)
