...
NotificationType, Bits, NotificationType, ModuleIdentity, Gauge32, Counter64, ObjectIdentity, Unsigned32, IpAddress, enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, MibIdentifier, mib_2, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "NotificationType", "ModuleIdentity", "Gauge32", "Counter64", "ObjectIdentity", "Unsigned32", "IpAddress", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "MibIdentifier", "mib-2", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kProductVersion=kProductVersion, stHttpBytesToClient=stHttpBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trSystem=trSystem, stMemConsumed=stMemConsumed, notifySeverity=notifySeverity, stHttpsBytesToServer=stHttpsBytesToServer, trUser=trUser, stCategories=stCategories, mwgContent=mwgContent, stBlockedByURLFilter=stBlockedByURLFilter, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesToClient=stFtpBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsTraffic=stHttpsTraffic, mwgInfo=mwgInfo, stHttpRequests=stHttpRequests, stCPULoad=stCPULoad, stConnectedSockets=stConnectedSockets, stResolveHostViaDNS=stResolveHostViaDNS, stMalwareDetected=stMalwareDetected, mwgEngineVersions=mwgEngineVersions, notifyOriginName=notifyOriginName, stCategoryName=stCategoryName, kMajorVersion=kMajorVersion, stConnectionsBlocked=stConnectionsBlocked, kRevision=kRevision, notifyAffectedHost=notifyAffectedHost, stHandleConnectToServer=stHandleConnectToServer, stCPUIOWait=stCPUIOWait, stBlockedByMediaFilter=stBlockedByMediaFilter, trApplication=trApplication, pTSDBVersion=pTSDBVersion, stFtpTraffic=stFtpTraffic, mwg=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kProductName=kProductName, mwgStatistics=mwgStatistics, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesFromClient=stHttpBytesFromClient, kCustomVersion=kCustomVersion, kBuildNumber=kBuildNumber, stCategoriesTable=stCategoriesTable, pAMEngineVersion=pAMEngineVersion, stTimeForTransaction=stTimeForTransaction, kMicroVersion=kMicroVersion, stHttpTraffic=stHttpTraffic, stCategoriesEntry=stCategoriesEntry, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsRequests=stHttpsRequests, stFtpBytesFromServer=stFtpBytesFromServer, stMimeType=stMimeType, mwgHttps=mwgHttps, kMinorVersion=kMinorVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttp=mwgHttp, stFtpBytesToServer=stFtpBytesToServer, notifyOrigin=notifyOrigin, stClientCount=stClientCount, notifyAdditional=notifyAdditional, mwgTrapVariables=mwgTrapVariables, mwgFTP=mwgFTP, stConnectionsLegitimate=stConnectionsLegitimate, pMFEDATVersion=pMFEDATVersion, stBadReputation=stBadReputation, notifyReasonString=notifyReasonString, stCPULoadRaw=stCPULoadRaw, mwgMiscellaneous=mwgMiscellaneous, notifyReason=notifyReason, kHotfixVersion=kHotfixVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, PYSNMP_MODULE_ID=mwg, stCategoryCount=stCategoryCount, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesToServer=stHttpBytesToServer, pMFEEngineVersion=pMFEEngineVersion, kCompanyName=kCompanyName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgTraps=mwgTraps)
