...
ObjectIdentity, IpAddress, TimeTicks, Counter32, NotificationType, Gauge32, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, mib_2, NotificationType, iso, Bits, Counter64, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "TimeTicks", "Counter32", "NotificationType", "Gauge32", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "mib-2", "NotificationType", "iso", "Bits", "Counter64", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesFromClient=stHttpBytesFromClient, stConnectedSockets=stConnectedSockets, stHttpTraffic=stHttpTraffic, stCategories=stCategories, mwgHttp=mwgHttp, trApplication=trApplication, kCompanyName=kCompanyName, stBlockedByURLFilter=stBlockedByURLFilter, stBadReputation=stBadReputation, kMicroVersion=kMicroVersion, notifyOrigin=notifyOrigin, trUser=trUser, stCategoryName=stCategoryName, notifyAffectedHost=notifyAffectedHost, kMajorVersion=kMajorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, kMinorVersion=kMinorVersion, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pMFEEngineVersion=pMFEEngineVersion, kCustomVersion=kCustomVersion, stClientCount=stClientCount, stHttpsBytesFromServer=stHttpsBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, stConnectionsLegitimate=stConnectionsLegitimate, stResolveHostViaDNS=stResolveHostViaDNS, mwgEngineVersions=mwgEngineVersions, stTimeForTransaction=stTimeForTransaction, stHttpBytesFromServer=stHttpBytesFromServer, mwgContent=mwgContent, notifyOriginName=notifyOriginName, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsBytesToClient=stHttpsBytesToClient, trSystem=trSystem, stHttpBytesToServer=stHttpBytesToServer, notifyAdditional=notifyAdditional, mwgInfo=mwgInfo, stBlockedByAntiMalware=stBlockedByAntiMalware, stMalwareDetected=stMalwareDetected, stMimeType=stMimeType, mwgStatistics=mwgStatistics, stHttpRequests=stHttpRequests, mwg=mwg, stMemConsumed=stMemConsumed, mwgTraps=mwgTraps, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCPUIOWait=stCPUIOWait, pAMEngineVersion=pAMEngineVersion, stFtpTraffic=stFtpTraffic, stCPULoadRaw=stCPULoadRaw, kBuildNumber=kBuildNumber, stFtpBytesFromServer=stFtpBytesFromServer, mwgFTP=mwgFTP, stConnectionsBlocked=stConnectionsBlocked, mwgMiscellaneous=mwgMiscellaneous, notifyReason=notifyReason, stCategoriesEntry=stCategoriesEntry, mwgTrapVariables=mwgTrapVariables, stCategoriesTable=stCategoriesTable, stCPULoad=stCPULoad, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kRevision=kRevision, stFtpBytesToServer=stFtpBytesToServer, kProductName=kProductName, kProductVersion=kProductVersion, pMFEDATVersion=pMFEDATVersion, pAMProactiveVersion=pAMProactiveVersion, stCategoryCount=stCategoryCount, stFtpBytesToClient=stFtpBytesToClient, stHttpsRequests=stHttpsRequests, PYSNMP_MODULE_ID=mwg, stHttpsBytesFromClient=stHttpsBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesToClient=stHttpBytesToClient, stHttpsTraffic=stHttpsTraffic, pTSDBVersion=pTSDBVersion, kHotfixVersion=kHotfixVersion, notifyReasonString=notifyReasonString, notifySeverity=notifySeverity, mwgHttps=mwgHttps, pAMSignatureVersion=pAMSignatureVersion)
