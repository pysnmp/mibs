...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, mib_2, Integer32, Unsigned32, iso, NotificationType, TimeTicks, Counter32, ObjectIdentity, MibIdentifier, enterprises, NotificationType, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "mib-2", "Integer32", "Unsigned32", "iso", "NotificationType", "TimeTicks", "Counter32", "ObjectIdentity", "MibIdentifier", "enterprises", "NotificationType", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyAdditional=notifyAdditional, stHttpBytesToClient=stHttpBytesToClient, mwgContent=mwgContent, stCategories=stCategories, trUser=trUser, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesToServer=stHttpBytesToServer, mwg=mwg, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoriesTable=stCategoriesTable, trApplication=trApplication, notifyReason=notifyReason, pTSDBVersion=pTSDBVersion, stTimeForTransaction=stTimeForTransaction, kRevision=kRevision, kHotfixVersion=kHotfixVersion, kMicroVersion=kMicroVersion, mwgHttps=mwgHttps, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesToClient=stFtpBytesToClient, kProductVersion=kProductVersion, stHttpTraffic=stHttpTraffic, stConnectionsLegitimate=stConnectionsLegitimate, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgFTP=mwgFTP, mwgEngineVersions=mwgEngineVersions, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoryCount=stCategoryCount, stClientCount=stClientCount, trSystem=trSystem, mwgMiscellaneous=mwgMiscellaneous, stFtpTraffic=stFtpTraffic, stHttpBytesFromServer=stHttpBytesFromServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stBadReputation=stBadReputation, stBlockedByURLFilter=stBlockedByURLFilter, notifyReasonString=notifyReasonString, pAMProactiveVersion=pAMProactiveVersion, stHttpsRequests=stHttpsRequests, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpRequests=stHttpRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoad=stCPULoad, mwgHttp=mwgHttp, kMinorVersion=kMinorVersion, pAMEngineVersion=pAMEngineVersion, kMajorVersion=kMajorVersion, stConnectionsBlocked=stConnectionsBlocked, stCPULoadRaw=stCPULoadRaw, mwgTraps=mwgTraps, kCustomVersion=kCustomVersion, stResolveHostViaDNS=stResolveHostViaDNS, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kBuildNumber=kBuildNumber, stCategoriesEntry=stCategoriesEntry, mwgStatistics=mwgStatistics, notifyOrigin=notifyOrigin, mwgInfo=mwgInfo, mwgTrapVariables=mwgTrapVariables, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kCompanyName=kCompanyName, stFtpBytesFromServer=stFtpBytesFromServer, stMimeType=stMimeType, pMFEDATVersion=pMFEDATVersion, stConnectedSockets=stConnectedSockets, stFtpBytesFromClient=stFtpBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesToServer=stFtpBytesToServer, kProductName=kProductName, PYSNMP_MODULE_ID=mwg, notifyAffectedHost=notifyAffectedHost, stMalwareDetected=stMalwareDetected, notifyOriginName=notifyOriginName, stCPUIOWait=stCPUIOWait, notifySeverity=notifySeverity, stMemConsumed=stMemConsumed, stCategoryName=stCategoryName, stHttpsTraffic=stHttpsTraffic, pMFEEngineVersion=pMFEEngineVersion)
