...
Counter32, Unsigned32, TimeTicks, Gauge32, NotificationType, Counter64, ObjectIdentity, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, Integer32, IpAddress, mib_2, ModuleIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "TimeTicks", "Gauge32", "NotificationType", "Counter64", "ObjectIdentity", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "Integer32", "IpAddress", "mib-2", "ModuleIdentity", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoriesTable=stCategoriesTable, trUser=trUser, stFtpBytesFromClient=stFtpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, pAMProactiveVersion=pAMProactiveVersion, stCategoryCount=stCategoryCount, stCategoriesEntry=stCategoriesEntry, stFtpTraffic=stFtpTraffic, pMFEDATVersion=pMFEDATVersion, mwgInfo=mwgInfo, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesFromClient=stHttpBytesFromClient, mwgEngineVersions=mwgEngineVersions, mwgTraps=mwgTraps, stConnectionsBlocked=stConnectionsBlocked, kBuildNumber=kBuildNumber, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesFromServer=stFtpBytesFromServer, stCPUIOWait=stCPUIOWait, notifyReasonString=notifyReasonString, stMemConsumed=stMemConsumed, stHttpsBytesToClient=stHttpsBytesToClient, stTimeForTransaction=stTimeForTransaction, stCategories=stCategories, stHttpBytesFromServer=stHttpBytesFromServer, mwgTrapVariables=mwgTrapVariables, stBlockedByURLFilter=stBlockedByURLFilter, stCategoryName=stCategoryName, mwg=mwg, stConnectedSockets=stConnectedSockets, notifyAdditional=notifyAdditional, notifyAffectedHost=notifyAffectedHost, mwgContent=mwgContent, mwgStatistics=mwgStatistics, notifySeverity=notifySeverity, stResolveHostViaDNS=stResolveHostViaDNS, mwgFTP=mwgFTP, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpRequests=stHttpRequests, pTSDBVersion=pTSDBVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyReason=notifyReason, stHttpsBytesFromClient=stHttpsBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgHttps=mwgHttps, notifyOriginName=notifyOriginName, stCPULoad=stCPULoad, PYSNMP_MODULE_ID=mwg, stMalwareDetected=stMalwareDetected, trSystem=trSystem, kHotfixVersion=kHotfixVersion, pMFEEngineVersion=pMFEEngineVersion, mwgHttp=mwgHttp, stConnectionsLegitimate=stConnectionsLegitimate, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBadReputation=stBadReputation, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesToServer=stHttpBytesToServer, kCompanyName=kCompanyName, stHttpsRequests=stHttpsRequests, stFtpBytesToServer=stFtpBytesToServer, kMajorVersion=kMajorVersion, trApplication=trApplication, kCustomVersion=kCustomVersion, stHttpTraffic=stHttpTraffic, kRevision=kRevision, kProductName=kProductName, stHttpBytesToClient=stHttpBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesToClient=stFtpBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMEngineVersion=pAMEngineVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCPULoadRaw=stCPULoadRaw, pAMSignatureVersion=pAMSignatureVersion, stHttpsTraffic=stHttpsTraffic, stBlockedByAntiMalware=stBlockedByAntiMalware, stClientCount=stClientCount, kMinorVersion=kMinorVersion, stMimeType=stMimeType, kProductVersion=kProductVersion, kMicroVersion=kMicroVersion, notifyOrigin=notifyOrigin)
