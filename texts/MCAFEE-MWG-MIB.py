...
enterprises, MibIdentifier, Counter64, NotificationType, ObjectIdentity, Unsigned32, iso, IpAddress, Gauge32, ModuleIdentity, Counter32, mib_2, NotificationType, Bits, Integer32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "Counter64", "NotificationType", "ObjectIdentity", "Unsigned32", "iso", "IpAddress", "Gauge32", "ModuleIdentity", "Counter32", "mib-2", "NotificationType", "Bits", "Integer32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, mwgContent=mwgContent, trApplication=trApplication, mwgFTP=mwgFTP, stMalwareDetected=stMalwareDetected, pAMProactiveVersion=pAMProactiveVersion, kMicroVersion=kMicroVersion, pMFEDATVersion=pMFEDATVersion, kRevision=kRevision, stHttpsTraffic=stHttpsTraffic, mwg=mwg, stFtpTraffic=stFtpTraffic, kProductVersion=kProductVersion, stHttpBytesFromClient=stHttpBytesFromClient, notifyReason=notifyReason, mwgMiscellaneous=mwgMiscellaneous, pMFEEngineVersion=pMFEEngineVersion, stClientCount=stClientCount, kMajorVersion=kMajorVersion, trSystem=trSystem, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesToServer=stHttpBytesToServer, stBlockedByURLFilter=stBlockedByURLFilter, mwgInfo=mwgInfo, kProductName=kProductName, kCustomVersion=kCustomVersion, notifyOriginName=notifyOriginName, stCategoryCount=stCategoryCount, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsRequests=stHttpsRequests, kHotfixVersion=kHotfixVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpRequests=stHttpRequests, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCPUIOWait=stCPUIOWait, stCategoryName=stCategoryName, stTimeForTransaction=stTimeForTransaction, pAMEngineVersion=pAMEngineVersion, pAMSignatureVersion=pAMSignatureVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, PYSNMP_MODULE_ID=mwg, notifyAdditional=notifyAdditional, stHttpBytesFromServer=stHttpBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoriesEntry=stCategoriesEntry, notifyReasonString=notifyReasonString, kBuildNumber=kBuildNumber, stHttpsBytesToClient=stHttpsBytesToClient, notifyAffectedHost=notifyAffectedHost, kMinorVersion=kMinorVersion, stCPULoad=stCPULoad, stHttpTraffic=stHttpTraffic, pTSDBVersion=pTSDBVersion, stHttpBytesToClient=stHttpBytesToClient, stMimeType=stMimeType, mwgHttps=mwgHttps, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stConnectionsLegitimate=stConnectionsLegitimate, mwgTrapVariables=mwgTrapVariables, stFtpBytesFromClient=stFtpBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyOrigin=notifyOrigin, stConnectedSockets=stConnectedSockets, trUser=trUser, mwgEngineVersions=mwgEngineVersions, stFtpBytesToServer=stFtpBytesToServer, mwgHttp=mwgHttp, stMemConsumed=stMemConsumed, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgStatistics=mwgStatistics, notifySeverity=notifySeverity, stConnectionsBlocked=stConnectionsBlocked, mwgTraps=mwgTraps, stCategoriesTable=stCategoriesTable, stCategories=stCategories, stCPULoadRaw=stCPULoadRaw, kCompanyName=kCompanyName, stHandleConnectToServer=stHandleConnectToServer, stBadReputation=stBadReputation)
