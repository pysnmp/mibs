...
IpAddress, TimeTicks, enterprises, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, Gauge32, Integer32, Counter32, Counter64, mib_2, NotificationType, Bits, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "enterprises", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "Gauge32", "Integer32", "Counter32", "Counter64", "mib-2", "NotificationType", "Bits", "NotificationType", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesFromClient=stHttpsBytesFromClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBadReputation=stBadReputation, mwgInfo=mwgInfo, mwgEngineVersions=mwgEngineVersions, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesToServer=stFtpBytesToServer, stHttpRequests=stHttpRequests, kCompanyName=kCompanyName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesFromServer=stFtpBytesFromServer, pTSDBVersion=pTSDBVersion, trSystem=trSystem, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByMediaFilter=stBlockedByMediaFilter, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pMFEEngineVersion=pMFEEngineVersion, notifyAffectedHost=notifyAffectedHost, mwgContent=mwgContent, mwgFTP=mwgFTP, mwg=mwg, kMinorVersion=kMinorVersion, stHttpsTraffic=stHttpsTraffic, mwgTrapVariables=mwgTrapVariables, trApplication=trApplication, stHttpBytesFromClient=stHttpBytesFromClient, notifyOrigin=notifyOrigin, pAMSignatureVersion=pAMSignatureVersion, stCategoriesTable=stCategoriesTable, stHttpTraffic=stHttpTraffic, kMicroVersion=kMicroVersion, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesToClient=stHttpBytesToClient, kBuildNumber=kBuildNumber, notifySeverity=notifySeverity, stFtpBytesToClient=stFtpBytesToClient, mwgHttps=mwgHttps, PYSNMP_MODULE_ID=mwg, stTimeForTransaction=stTimeForTransaction, pAMProactiveVersion=pAMProactiveVersion, stCategories=stCategories, stMemConsumed=stMemConsumed, kProductName=kProductName, stHttpsRequests=stHttpsRequests, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoryCount=stCategoryCount, stMimeType=stMimeType, notifyAdditional=notifyAdditional, stConnectedSockets=stConnectedSockets, notifyOriginName=notifyOriginName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, stCPULoad=stCPULoad, stCPULoadRaw=stCPULoadRaw, kRevision=kRevision, kHotfixVersion=kHotfixVersion, mwgHttp=mwgHttp, stHttpBytesToServer=stHttpBytesToServer, stHandleConnectToServer=stHandleConnectToServer, stCategoryName=stCategoryName, notifyReasonString=notifyReasonString, mwgStatistics=mwgStatistics, kProductVersion=kProductVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyReason=notifyReason, stBlockedByURLFilter=stBlockedByURLFilter, stMalwareDetected=stMalwareDetected, stCategoriesEntry=stCategoriesEntry, stHttpsBytesToServer=stHttpsBytesToServer, stClientCount=stClientCount, mwgMiscellaneous=mwgMiscellaneous, mwgTraps=mwgTraps, stHttpsBytesToClient=stHttpsBytesToClient, pAMEngineVersion=pAMEngineVersion, stFtpBytesFromClient=stFtpBytesFromClient, trUser=trUser, kCustomVersion=kCustomVersion, kMajorVersion=kMajorVersion, stCPUIOWait=stCPUIOWait, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pMFEDATVersion=pMFEDATVersion, stFtpTraffic=stFtpTraffic)
