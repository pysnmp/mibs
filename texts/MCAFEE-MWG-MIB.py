...
iso, Bits, NotificationType, TimeTicks, ObjectIdentity, Integer32, Counter64, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, MibIdentifier, Counter32, NotificationType, ModuleIdentity, mib_2, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "NotificationType", "TimeTicks", "ObjectIdentity", "Integer32", "Counter64", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "MibIdentifier", "Counter32", "NotificationType", "ModuleIdentity", "mib-2", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesToServer=stFtpBytesToServer, trSystem=trSystem, stCategoryCount=stCategoryCount, notifyOrigin=notifyOrigin, stCPUIOWait=stCPUIOWait, stHttpRequests=stHttpRequests, stCategoryName=stCategoryName, stHttpBytesToClient=stHttpBytesToClient, mwgHttps=mwgHttps, stHttpsRequests=stHttpsRequests, kCompanyName=kCompanyName, stMemConsumed=stMemConsumed, stMalwareDetected=stMalwareDetected, stBlockedByAntiMalware=stBlockedByAntiMalware, kProductName=kProductName, kRevision=kRevision, stHttpBytesFromClient=stHttpBytesFromClient, mwgEngineVersions=mwgEngineVersions, kMicroVersion=kMicroVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectionsBlocked=stConnectionsBlocked, kCustomVersion=kCustomVersion, stConnectionsLegitimate=stConnectionsLegitimate, mwgTrapVariables=mwgTrapVariables, notifyAdditional=notifyAdditional, stResolveHostViaDNS=stResolveHostViaDNS, kProductVersion=kProductVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsTraffic=stHttpsTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyReasonString=notifyReasonString, mwgHttp=mwgHttp, stHandleConnectToServer=stHandleConnectToServer, trApplication=trApplication, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBlockedByMediaFilter=stBlockedByMediaFilter, pMFEDATVersion=pMFEDATVersion, stCategoriesTable=stCategoriesTable, pAMProactiveVersion=pAMProactiveVersion, pTSDBVersion=pTSDBVersion, stTimeForTransaction=stTimeForTransaction, mwgTraps=mwgTraps, PYSNMP_MODULE_ID=mwg, trUser=trUser, stFtpTraffic=stFtpTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifySeverity=notifySeverity, mwgFTP=mwgFTP, stCategories=stCategories, stCPULoadRaw=stCPULoadRaw, kMajorVersion=kMajorVersion, kMinorVersion=kMinorVersion, stCPULoad=stCPULoad, stMimeType=stMimeType, pAMSignatureVersion=pAMSignatureVersion, stClientCount=stClientCount, pMFEEngineVersion=pMFEEngineVersion, stBadReputation=stBadReputation, stConnectedSockets=stConnectedSockets, mwgMiscellaneous=mwgMiscellaneous, pAMEngineVersion=pAMEngineVersion, mwg=mwg, mwgContent=mwgContent, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyAffectedHost=notifyAffectedHost, stCategoriesEntry=stCategoriesEntry, stHttpTraffic=stHttpTraffic, notifyOriginName=notifyOriginName, stFtpBytesFromServer=stFtpBytesFromServer, mwgStatistics=mwgStatistics, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, kHotfixVersion=kHotfixVersion, notifyReason=notifyReason, stHttpBytesToServer=stHttpBytesToServer, mwgInfo=mwgInfo, kBuildNumber=kBuildNumber, stFtpBytesFromClient=stFtpBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsBytesToClient=stHttpsBytesToClient)
