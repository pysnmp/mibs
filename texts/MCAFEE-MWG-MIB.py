...
mib_2, NotificationType, Gauge32, MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, NotificationType, Bits, Integer32, IpAddress, ObjectIdentity, enterprises, iso, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "NotificationType", "Gauge32", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "NotificationType", "Bits", "Integer32", "IpAddress", "ObjectIdentity", "enterprises", "iso", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpBytesToClient=stHttpBytesToClient, stHttpsRequests=stHttpsRequests, mwgEngineVersions=mwgEngineVersions, stTimeForTransaction=stTimeForTransaction, stBadReputation=stBadReputation, mwgMiscellaneous=mwgMiscellaneous, kHotfixVersion=kHotfixVersion, mwgStatistics=mwgStatistics, notifyAffectedHost=notifyAffectedHost, stCategories=stCategories, stHttpBytesFromClient=stHttpBytesFromClient, stCPULoad=stCPULoad, stMimeType=stMimeType, notifyReason=notifyReason, stHttpBytesFromServer=stHttpBytesFromServer, stCPULoadRaw=stCPULoadRaw, stBlockedByMediaFilter=stBlockedByMediaFilter, trApplication=trApplication, stFtpBytesToServer=stFtpBytesToServer, stHandleConnectToServer=stHandleConnectToServer, PYSNMP_MODULE_ID=mwg, pMFEDATVersion=pMFEDATVersion, notifyOriginName=notifyOriginName, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesToServer=stHttpBytesToServer, kCustomVersion=kCustomVersion, mwgInfo=mwgInfo, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwg=mwg, pTSDBVersion=pTSDBVersion, mwgContent=mwgContent, stHttpRequests=stHttpRequests, notifyReasonString=notifyReasonString, stCategoriesEntry=stCategoriesEntry, pAMSignatureVersion=pAMSignatureVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, trSystem=trSystem, pMFEEngineVersion=pMFEEngineVersion, kProductVersion=kProductVersion, kRevision=kRevision, mwgHttp=mwgHttp, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stConnectionsBlocked=stConnectionsBlocked, pAMProactiveVersion=pAMProactiveVersion, kProductName=kProductName, stFtpBytesToClient=stFtpBytesToClient, notifyOrigin=notifyOrigin, stFtpTraffic=stFtpTraffic, stConnectedSockets=stConnectedSockets, stCategoryCount=stCategoryCount, kMicroVersion=kMicroVersion, stCategoryName=stCategoryName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMEngineVersion=pAMEngineVersion, stHttpTraffic=stHttpTraffic, kMajorVersion=kMajorVersion, stResolveHostViaDNS=stResolveHostViaDNS, kBuildNumber=kBuildNumber, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stClientCount=stClientCount, stHttpsTraffic=stHttpsTraffic, notifyAdditional=notifyAdditional, stHttpsBytesToClient=stHttpsBytesToClient, mwgHttps=mwgHttps, kMinorVersion=kMinorVersion, stMemConsumed=stMemConsumed, mwgFTP=mwgFTP, stBlockedByURLFilter=stBlockedByURLFilter, mwgTraps=mwgTraps, trUser=trUser, stCategoriesTable=stCategoriesTable, stFtpBytesFromServer=stFtpBytesFromServer, stCPUIOWait=stCPUIOWait, notifySeverity=notifySeverity, kCompanyName=kCompanyName, stBlockedByAntiMalware=stBlockedByAntiMalware, stMalwareDetected=stMalwareDetected, mwgTrapVariables=mwgTrapVariables)
