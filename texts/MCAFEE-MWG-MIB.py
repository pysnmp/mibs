...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, TimeTicks, mib_2, Unsigned32, NotificationType, enterprises, Integer32, Bits, ModuleIdentity, Gauge32, Counter64, MibIdentifier, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "TimeTicks", "mib-2", "Unsigned32", "NotificationType", "enterprises", "Integer32", "Bits", "ModuleIdentity", "Gauge32", "Counter64", "MibIdentifier", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgEngineVersions=mwgEngineVersions, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesToServer=stHttpBytesToServer, notifySeverity=notifySeverity, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesFromServer=stHttpBytesFromServer, stCPUIOWait=stCPUIOWait, stMimeType=stMimeType, stHttpsTraffic=stHttpsTraffic, kCompanyName=kCompanyName, stCategoryName=stCategoryName, pAMEngineVersion=pAMEngineVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesFromClient=stHttpBytesFromClient, stMalwareDetected=stMalwareDetected, notifyReasonString=notifyReasonString, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stClientCount=stClientCount, stCategoryCount=stCategoryCount, stHttpsBytesToClient=stHttpsBytesToClient, trApplication=trApplication, trSystem=trSystem, stHandleConnectToServer=stHandleConnectToServer, stFtpTraffic=stFtpTraffic, notifyOriginName=notifyOriginName, stConnectionsLegitimate=stConnectionsLegitimate, mwgFTP=mwgFTP, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pTSDBVersion=pTSDBVersion, kBuildNumber=kBuildNumber, stHttpsBytesToServer=stHttpsBytesToServer, notifyOrigin=notifyOrigin, mwgHttp=mwgHttp, stConnectedSockets=stConnectedSockets, mwgStatistics=mwgStatistics, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgHttps=mwgHttps, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, trUser=trUser, mwgInfo=mwgInfo, stCPULoad=stCPULoad, stCategories=stCategories, pAMSignatureVersion=pAMSignatureVersion, kProductName=kProductName, kRevision=kRevision, pMFEDATVersion=pMFEDATVersion, stBadReputation=stBadReputation, stCategoriesTable=stCategoriesTable, stHttpBytesToClient=stHttpBytesToClient, mwgTraps=mwgTraps, stHttpRequests=stHttpRequests, kMajorVersion=kMajorVersion, PYSNMP_MODULE_ID=mwg, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesToClient=stFtpBytesToClient, mwgContent=mwgContent, stTimeForTransaction=stTimeForTransaction, kMinorVersion=kMinorVersion, stCategoriesEntry=stCategoriesEntry, kProductVersion=kProductVersion, mwgMiscellaneous=mwgMiscellaneous, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesFromClient=stFtpBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kHotfixVersion=kHotfixVersion, notifyReason=notifyReason, stCPULoadRaw=stCPULoadRaw, kMicroVersion=kMicroVersion, notifyAffectedHost=notifyAffectedHost, mwg=mwg, stFtpBytesFromServer=stFtpBytesFromServer, mwgTrapVariables=mwgTrapVariables, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesToServer=stFtpBytesToServer, stHttpTraffic=stHttpTraffic, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsRequests=stHttpsRequests, stMemConsumed=stMemConsumed, notifyAdditional=notifyAdditional, stBlockedByMediaFilter=stBlockedByMediaFilter, kCustomVersion=kCustomVersion)
