...
ModuleIdentity, Gauge32, MibIdentifier, NotificationType, enterprises, NotificationType, iso, Bits, Counter32, mib_2, Integer32, Unsigned32, IpAddress, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "MibIdentifier", "NotificationType", "enterprises", "NotificationType", "iso", "Bits", "Counter32", "mib-2", "Integer32", "Unsigned32", "IpAddress", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesToServer=stHttpsBytesToServer, stTimeForTransaction=stTimeForTransaction, stCategoryCount=stCategoryCount, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCPUIOWait=stCPUIOWait, stConnectionsLegitimate=stConnectionsLegitimate, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByAntiMalware=stBlockedByAntiMalware, pAMEngineVersion=pAMEngineVersion, mwgHttps=mwgHttps, stHttpTraffic=stHttpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyAffectedHost=notifyAffectedHost, stCPULoadRaw=stCPULoadRaw, stMemConsumed=stMemConsumed, kProductName=kProductName, pTSDBVersion=pTSDBVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stClientCount=stClientCount, kMinorVersion=kMinorVersion, kBuildNumber=kBuildNumber, stConnectionsBlocked=stConnectionsBlocked, notifyReason=notifyReason, mwg=mwg, notifyOriginName=notifyOriginName, notifyReasonString=notifyReasonString, pMFEDATVersion=pMFEDATVersion, mwgContent=mwgContent, stCategoriesEntry=stCategoriesEntry, pAMProactiveVersion=pAMProactiveVersion, PYSNMP_MODULE_ID=mwg, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgEngineVersions=mwgEngineVersions, mwgStatistics=mwgStatistics, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesToClient=stHttpsBytesToClient, stFtpTraffic=stFtpTraffic, stCategoriesTable=stCategoriesTable, stFtpBytesToClient=stFtpBytesToClient, stConnectedSockets=stConnectedSockets, stFtpBytesFromClient=stFtpBytesFromClient, stCPULoad=stCPULoad, kCompanyName=kCompanyName, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgInfo=mwgInfo, kHotfixVersion=kHotfixVersion, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyAdditional=notifyAdditional, kMicroVersion=kMicroVersion, stHttpsRequests=stHttpsRequests, stBlockedByURLFilter=stBlockedByURLFilter, trUser=trUser, mwgTraps=mwgTraps, stHttpBytesFromServer=stHttpBytesFromServer, stCategoryName=stCategoryName, trSystem=trSystem, stBadReputation=stBadReputation, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesToServer=stHttpBytesToServer, stHttpRequests=stHttpRequests, kMajorVersion=kMajorVersion, pAMSignatureVersion=pAMSignatureVersion, kProductVersion=kProductVersion, stMimeType=stMimeType, stCategories=stCategories, stHandleConnectToServer=stHandleConnectToServer, stHttpsTraffic=stHttpsTraffic, stMalwareDetected=stMalwareDetected, mwgFTP=mwgFTP, pMFEEngineVersion=pMFEEngineVersion, kRevision=kRevision, stFtpBytesFromServer=stFtpBytesFromServer, notifyOrigin=notifyOrigin, mwgTrapVariables=mwgTrapVariables, trApplication=trApplication, mwgHttp=mwgHttp, kCustomVersion=kCustomVersion, notifySeverity=notifySeverity)
