...
MibIdentifier, NotificationType, Counter64, ModuleIdentity, enterprises, mib_2, Bits, IpAddress, iso, ObjectIdentity, Integer32, Gauge32, Counter32, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Counter64", "ModuleIdentity", "enterprises", "mib-2", "Bits", "IpAddress", "iso", "ObjectIdentity", "Integer32", "Gauge32", "Counter32", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesToServer=stHttpBytesToServer, stCPULoad=stCPULoad, mwgEngineVersions=mwgEngineVersions, stTimeForTransaction=stTimeForTransaction, pMFEDATVersion=pMFEDATVersion, pAMEngineVersion=pAMEngineVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, notifySeverity=notifySeverity, stFtpBytesToClient=stFtpBytesToClient, kRevision=kRevision, notifyReason=notifyReason, stMemConsumed=stMemConsumed, mwgTraps=mwgTraps, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpTraffic=stFtpTraffic, stHttpBytesToClient=stHttpBytesToClient, kMinorVersion=kMinorVersion, stHandleConnectToServer=stHandleConnectToServer, stConnectionsLegitimate=stConnectionsLegitimate, mwgHttps=mwgHttps, kCompanyName=kCompanyName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesFromClient=stFtpBytesFromClient, stHttpRequests=stHttpRequests, stConnectionsBlocked=stConnectionsBlocked, stCategoryName=stCategoryName, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pAMProactiveVersion=pAMProactiveVersion, stBadReputation=stBadReputation, notifyAffectedHost=notifyAffectedHost, stCategoriesTable=stCategoriesTable, kProductVersion=kProductVersion, stMimeType=stMimeType, pTSDBVersion=pTSDBVersion, kMajorVersion=kMajorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgHttp=mwgHttp, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMSignatureVersion=pAMSignatureVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoriesEntry=stCategoriesEntry, PYSNMP_MODULE_ID=mwg, stCPUIOWait=stCPUIOWait, pMFEEngineVersion=pMFEEngineVersion, notifyReasonString=notifyReasonString, mwgFTP=mwgFTP, stCategoryCount=stCategoryCount, stFtpBytesToServer=stFtpBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kBuildNumber=kBuildNumber, kHotfixVersion=kHotfixVersion, mwgMiscellaneous=mwgMiscellaneous, notifyOriginName=notifyOriginName, mwg=mwg, stHttpBytesFromClient=stHttpBytesFromClient, stCategories=stCategories, kProductName=kProductName, trApplication=trApplication, trSystem=trSystem, mwgTrapVariables=mwgTrapVariables, mwgContent=mwgContent, stClientCount=stClientCount, trUser=trUser, stMalwareDetected=stMalwareDetected, notifyAdditional=notifyAdditional, stHttpsBytesFromClient=stHttpsBytesFromClient, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsRequests=stHttpsRequests, stFtpBytesFromServer=stFtpBytesFromServer, kMicroVersion=kMicroVersion, stBlockedByURLFilter=stBlockedByURLFilter, notifyOrigin=notifyOrigin, kCustomVersion=kCustomVersion, stHttpsTraffic=stHttpsTraffic, stConnectedSockets=stConnectedSockets, stHttpBytesFromServer=stHttpBytesFromServer, mwgStatistics=mwgStatistics, mwgInfo=mwgInfo, stHttpsBytesToServer=stHttpsBytesToServer, stCPULoadRaw=stCPULoadRaw, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpTraffic=stHttpTraffic)
