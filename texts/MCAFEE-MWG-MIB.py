...
IpAddress, Unsigned32, iso, enterprises, NotificationType, ObjectIdentity, NotificationType, TimeTicks, Integer32, ModuleIdentity, mib_2, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "iso", "enterprises", "NotificationType", "ObjectIdentity", "NotificationType", "TimeTicks", "Integer32", "ModuleIdentity", "mib-2", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgStatistics=mwgStatistics, notifyAdditional=notifyAdditional, stMimeType=stMimeType, stBlockedByURLFilter=stBlockedByURLFilter, stHandleConnectToServer=stHandleConnectToServer, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient, stCPUIOWait=stCPUIOWait, stHttpsBytesToServer=stHttpsBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgMiscellaneous=mwgMiscellaneous, mwgHttps=mwgHttps, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesToServer=stFtpBytesToServer, notifyAffectedHost=notifyAffectedHost, stHttpBytesToClient=stHttpBytesToClient, kMicroVersion=kMicroVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, kMinorVersion=kMinorVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pMFEDATVersion=pMFEDATVersion, pAMProactiveVersion=pAMProactiveVersion, kProductName=kProductName, stResolveHostViaDNS=stResolveHostViaDNS, PYSNMP_MODULE_ID=mwg, stCPULoad=stCPULoad, stFtpBytesToClient=stFtpBytesToClient, notifySeverity=notifySeverity, stConnectedSockets=stConnectedSockets, mwgTraps=mwgTraps, stBlockedByMediaFilter=stBlockedByMediaFilter, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyOriginName=notifyOriginName, stCategoryCount=stCategoryCount, pAMSignatureVersion=pAMSignatureVersion, kHotfixVersion=kHotfixVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpRequests=stHttpRequests, trSystem=trSystem, trUser=trUser, pMFEEngineVersion=pMFEEngineVersion, stCategoriesTable=stCategoriesTable, stMemConsumed=stMemConsumed, stBadReputation=stBadReputation, stHttpBytesToServer=stHttpBytesToServer, stHttpTraffic=stHttpTraffic, trApplication=trApplication, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, mwgEngineVersions=mwgEngineVersions, kBuildNumber=kBuildNumber, stConnectionsLegitimate=stConnectionsLegitimate, mwg=mwg, kRevision=kRevision, stConnectionsBlocked=stConnectionsBlocked, mwgContent=mwgContent, stClientCount=stClientCount, stHttpBytesFromServer=stHttpBytesFromServer, kMajorVersion=kMajorVersion, pTSDBVersion=pTSDBVersion, kProductVersion=kProductVersion, stCategoryName=stCategoryName, stFtpTraffic=stFtpTraffic, stHttpsRequests=stHttpsRequests, stFtpBytesFromServer=stFtpBytesFromServer, mwgHttp=mwgHttp, stHttpsBytesToClient=stHttpsBytesToClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgTrapVariables=mwgTrapVariables, stCPULoadRaw=stCPULoadRaw, mwgInfo=mwgInfo, stMalwareDetected=stMalwareDetected, kCompanyName=kCompanyName, notifyOrigin=notifyOrigin, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsTraffic=stHttpsTraffic, notifyReason=notifyReason, notifyReasonString=notifyReasonString, mwgFTP=mwgFTP, stTimeForTransaction=stTimeForTransaction, kCustomVersion=kCustomVersion, stCategories=stCategories, stCategoriesEntry=stCategoriesEntry)
