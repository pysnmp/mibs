...
Counter64, ModuleIdentity, Gauge32, TimeTicks, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, Bits, enterprises, iso, NotificationType, Unsigned32, Counter32, MibIdentifier, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "Gauge32", "TimeTicks", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "Bits", "enterprises", "iso", "NotificationType", "Unsigned32", "Counter32", "MibIdentifier", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyOriginName=notifyOriginName, stBlockedByAntiMalware=stBlockedByAntiMalware, stResolveHostViaDNS=stResolveHostViaDNS, stMimeType=stMimeType, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoad=stCPULoad, stMemConsumed=stMemConsumed, kRevision=kRevision, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyAffectedHost=notifyAffectedHost, stCPUIOWait=stCPUIOWait, stFtpBytesFromClient=stFtpBytesFromClient, kMinorVersion=kMinorVersion, stHttpsRequests=stHttpsRequests, trUser=trUser, kBuildNumber=kBuildNumber, mwg=mwg, kMajorVersion=kMajorVersion, pAMProactiveVersion=pAMProactiveVersion, stConnectedSockets=stConnectedSockets, stCategoriesTable=stCategoriesTable, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, kHotfixVersion=kHotfixVersion, mwgInfo=mwgInfo, kProductVersion=kProductVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoriesEntry=stCategoriesEntry, mwgHttps=mwgHttps, stFtpBytesToClient=stFtpBytesToClient, mwgMiscellaneous=mwgMiscellaneous, pTSDBVersion=pTSDBVersion, kMicroVersion=kMicroVersion, stHttpsBytesToServer=stHttpsBytesToServer, notifyReasonString=notifyReasonString, stHttpsTraffic=stHttpsTraffic, pMFEDATVersion=pMFEDATVersion, stCategories=stCategories, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoryCount=stCategoryCount, stConnectionsBlocked=stConnectionsBlocked, stTimeForTransaction=stTimeForTransaction, notifyAdditional=notifyAdditional, stHttpTraffic=stHttpTraffic, stBadReputation=stBadReputation, pAMSignatureVersion=pAMSignatureVersion, mwgStatistics=mwgStatistics, stMalwareDetected=stMalwareDetected, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoadRaw=stCPULoadRaw, mwgTrapVariables=mwgTrapVariables, mwgContent=mwgContent, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgFTP=mwgFTP, notifySeverity=notifySeverity, kCompanyName=kCompanyName, stFtpTraffic=stFtpTraffic, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesToServer=stFtpBytesToServer, kProductName=kProductName, pAMEngineVersion=pAMEngineVersion, stCategoryName=stCategoryName, PYSNMP_MODULE_ID=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgHttp=mwgHttp, stClientCount=stClientCount, stHttpRequests=stHttpRequests, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesToServer=stHttpBytesToServer, kCustomVersion=kCustomVersion, notifyReason=notifyReason, stHttpBytesFromClient=stHttpBytesFromClient, trApplication=trApplication, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyOrigin=notifyOrigin, stHttpBytesFromServer=stHttpBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, mwgTraps=mwgTraps, trSystem=trSystem, mwgEngineVersions=mwgEngineVersions, stBlockedByURLFilter=stBlockedByURLFilter, pMFEEngineVersion=pMFEEngineVersion, stHandleConnectToServer=stHandleConnectToServer)
