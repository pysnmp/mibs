...
ModuleIdentity, enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, Integer32, NotificationType, Counter64, NotificationType, MibIdentifier, Unsigned32, ObjectIdentity, Gauge32, TimeTicks, mib_2, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "Integer32", "NotificationType", "Counter64", "NotificationType", "MibIdentifier", "Unsigned32", "ObjectIdentity", "Gauge32", "TimeTicks", "mib-2", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgEngineVersions=mwgEngineVersions, notifyReasonString=notifyReasonString, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesFromServer=stFtpBytesFromServer, notifyOriginName=notifyOriginName, stHttpsTraffic=stHttpsTraffic, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgTrapVariables=mwgTrapVariables, stFtpBytesToServer=stFtpBytesToServer, stMalwareDetected=stMalwareDetected, notifyOrigin=notifyOrigin, stHttpsBytesToClient=stHttpsBytesToClient, stTimeForTransaction=stTimeForTransaction, trSystem=trSystem, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoryCount=stCategoryCount, kHotfixVersion=kHotfixVersion, stFtpTraffic=stFtpTraffic, mwgHttp=mwgHttp, PYSNMP_MODULE_ID=mwg, kMinorVersion=kMinorVersion, kProductName=kProductName, pTSDBVersion=pTSDBVersion, kProductVersion=kProductVersion, stHttpBytesFromClient=stHttpBytesFromClient, trUser=trUser, kBuildNumber=kBuildNumber, stHttpBytesToServer=stHttpBytesToServer, pMFEDATVersion=pMFEDATVersion, stCategoriesEntry=stCategoriesEntry, stConnectionsBlocked=stConnectionsBlocked, stMemConsumed=stMemConsumed, stBadReputation=stBadReputation, kCustomVersion=kCustomVersion, stHttpTraffic=stHttpTraffic, stConnectedSockets=stConnectedSockets, stMimeType=stMimeType, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trApplication=trApplication, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMicroVersion=kMicroVersion, mwg=mwg, kMajorVersion=kMajorVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsRequests=stHttpsRequests, notifySeverity=notifySeverity, pAMSignatureVersion=pAMSignatureVersion, stCPUIOWait=stCPUIOWait, stCategoriesTable=stCategoriesTable, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, stHttpRequests=stHttpRequests, mwgInfo=mwgInfo, stHandleConnectToServer=stHandleConnectToServer, stCPULoadRaw=stCPULoadRaw, mwgStatistics=mwgStatistics, stCPULoad=stCPULoad, pAMEngineVersion=pAMEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, stCategories=stCategories, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesFromServer=stHttpBytesFromServer, mwgContent=mwgContent, mwgMiscellaneous=mwgMiscellaneous, kCompanyName=kCompanyName, notifyReason=notifyReason, notifyAdditional=notifyAdditional, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyAffectedHost=notifyAffectedHost, mwgTraps=mwgTraps, mwgHttps=mwgHttps, stCategoryName=stCategoryName, pAMProactiveVersion=pAMProactiveVersion, stClientCount=stClientCount, kRevision=kRevision, mwgFTP=mwgFTP, stBlockedByAntiMalware=stBlockedByAntiMalware)
