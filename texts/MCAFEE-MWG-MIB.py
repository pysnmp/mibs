...
ModuleIdentity, TimeTicks, NotificationType, Gauge32, IpAddress, ObjectIdentity, Counter32, Counter64, enterprises, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, Unsigned32, MibIdentifier, mib_2, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "NotificationType", "Gauge32", "IpAddress", "ObjectIdentity", "Counter32", "Counter64", "enterprises", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "Unsigned32", "MibIdentifier", "mib-2", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pMFEDATVersion=pMFEDATVersion, stBadReputation=stBadReputation, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttps=mwgHttps, stHttpBytesToClient=stHttpBytesToClient, pAMEngineVersion=pAMEngineVersion, stHttpBytesToServer=stHttpBytesToServer, mwgStatistics=mwgStatistics, stFtpBytesToClient=stFtpBytesToClient, PYSNMP_MODULE_ID=mwg, stConnectionsBlocked=stConnectionsBlocked, notifyOrigin=notifyOrigin, stCategoryCount=stCategoryCount, pTSDBVersion=pTSDBVersion, stHttpRequests=stHttpRequests, kMajorVersion=kMajorVersion, notifyOriginName=notifyOriginName, stHttpsBytesToClient=stHttpsBytesToClient, stMimeType=stMimeType, kRevision=kRevision, stCategoriesTable=stCategoriesTable, trSystem=trSystem, kProductVersion=kProductVersion, notifyReason=notifyReason, notifyReasonString=notifyReasonString, stFtpBytesFromClient=stFtpBytesFromClient, notifyAffectedHost=notifyAffectedHost, stCategoryName=stCategoryName, pMFEEngineVersion=pMFEEngineVersion, mwgMiscellaneous=mwgMiscellaneous, mwgTrapVariables=mwgTrapVariables, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMemConsumed=stMemConsumed, mwgTraps=mwgTraps, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgEngineVersions=mwgEngineVersions, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromServer=stHttpBytesFromServer, notifyAdditional=notifyAdditional, trUser=trUser, stCPULoadRaw=stCPULoadRaw, stCategories=stCategories, kMinorVersion=kMinorVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, kCustomVersion=kCustomVersion, stHttpTraffic=stHttpTraffic, pAMProactiveVersion=pAMProactiveVersion, mwg=mwg, kProductName=kProductName, stHttpBytesFromClient=stHttpBytesFromClient, stFtpTraffic=stFtpTraffic, stCPULoad=stCPULoad, trApplication=trApplication, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMicroVersion=kMicroVersion, kCompanyName=kCompanyName, stCPUIOWait=stCPUIOWait, notifySeverity=notifySeverity, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsRequests=stHttpsRequests, stFtpBytesToServer=stFtpBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, stTimeForTransaction=stTimeForTransaction, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, stClientCount=stClientCount, kBuildNumber=kBuildNumber, kHotfixVersion=kHotfixVersion, stHttpsTraffic=stHttpsTraffic, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgFTP=mwgFTP, mwgContent=mwgContent, stConnectedSockets=stConnectedSockets, stHandleConnectToServer=stHandleConnectToServer, pAMSignatureVersion=pAMSignatureVersion, stCategoriesEntry=stCategoriesEntry, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgInfo=mwgInfo, mwgHttp=mwgHttp, stMalwareDetected=stMalwareDetected)
