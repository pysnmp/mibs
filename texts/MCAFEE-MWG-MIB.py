...
Gauge32, Counter32, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, ObjectIdentity, ModuleIdentity, NotificationType, enterprises, NotificationType, mib_2, Bits, Counter64, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "ObjectIdentity", "ModuleIdentity", "NotificationType", "enterprises", "NotificationType", "mib-2", "Bits", "Counter64", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategories=stCategories, mwgTrapVariables=mwgTrapVariables, stCPUIOWait=stCPUIOWait, stBlockedByURLFilter=stBlockedByURLFilter, stCPULoadRaw=stCPULoadRaw, stFtpBytesToClient=stFtpBytesToClient, stMalwareDetected=stMalwareDetected, stHttpsTraffic=stHttpsTraffic, stConnectionsBlocked=stConnectionsBlocked, pMFEEngineVersion=pMFEEngineVersion, stConnectionsLegitimate=stConnectionsLegitimate, pAMEngineVersion=pAMEngineVersion, trSystem=trSystem, stBadReputation=stBadReputation, stCategoriesTable=stCategoriesTable, pMFEDATVersion=pMFEDATVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyAdditional=notifyAdditional, pTSDBVersion=pTSDBVersion, PYSNMP_MODULE_ID=mwg, mwgTraps=mwgTraps, mwg=mwg, stBlockedByAntiMalware=stBlockedByAntiMalware, kMicroVersion=kMicroVersion, notifyAffectedHost=notifyAffectedHost, notifyReasonString=notifyReasonString, stHttpBytesToClient=stHttpBytesToClient, kHotfixVersion=kHotfixVersion, pAMProactiveVersion=pAMProactiveVersion, stHttpRequests=stHttpRequests, notifyOrigin=notifyOrigin, mwgFTP=mwgFTP, mwgStatistics=mwgStatistics, stClientCount=stClientCount, stConnectedSockets=stConnectedSockets, stCategoryName=stCategoryName, stHttpBytesToServer=stHttpBytesToServer, stFtpTraffic=stFtpTraffic, stMimeType=stMimeType, mwgHttp=mwgHttp, stFtpBytesFromClient=stFtpBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kBuildNumber=kBuildNumber, stCategoriesEntry=stCategoriesEntry, stBlockedByMediaFilter=stBlockedByMediaFilter, trUser=trUser, stCategoryCount=stCategoryCount, stFtpBytesFromServer=stFtpBytesFromServer, trApplication=trApplication, stHttpsBytesToServer=stHttpsBytesToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgHttps=mwgHttps, notifySeverity=notifySeverity, kCompanyName=kCompanyName, mwgInfo=mwgInfo, stHttpTraffic=stHttpTraffic, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kProductVersion=kProductVersion, stTimeForTransaction=stTimeForTransaction, stHttpsBytesFromServer=stHttpsBytesFromServer, stMemConsumed=stMemConsumed, stResolveHostViaDNS=stResolveHostViaDNS, notifyReason=notifyReason, stHttpBytesFromClient=stHttpBytesFromClient, kCustomVersion=kCustomVersion, pAMSignatureVersion=pAMSignatureVersion, mwgContent=mwgContent, stHttpsRequests=stHttpsRequests, kMajorVersion=kMajorVersion, kMinorVersion=kMinorVersion, kProductName=kProductName, stHttpsBytesToClient=stHttpsBytesToClient, mwgMiscellaneous=mwgMiscellaneous, stHandleConnectToServer=stHandleConnectToServer, notifyOriginName=notifyOriginName, stCPULoad=stCPULoad, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, mwgEngineVersions=mwgEngineVersions, stFtpBytesToServer=stFtpBytesToServer, kRevision=kRevision, stHttpsBytesFromClient=stHttpsBytesFromClient)
