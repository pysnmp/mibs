...
Counter32, MibIdentifier, mib_2, Counter64, TimeTicks, Unsigned32, Integer32, NotificationType, NotificationType, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, enterprises, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "mib-2", "Counter64", "TimeTicks", "Unsigned32", "Integer32", "NotificationType", "NotificationType", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "enterprises", "iso", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesToServer=stHttpBytesToServer, trSystem=trSystem, stHttpsBytesFromClient=stHttpsBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgStatistics=mwgStatistics, stCategoriesEntry=stCategoriesEntry, pMFEDATVersion=pMFEDATVersion, pAMSignatureVersion=pAMSignatureVersion, notifyAdditional=notifyAdditional, notifyReasonString=notifyReasonString, notifyReason=notifyReason, notifyOriginName=notifyOriginName, stCategoriesTable=stCategoriesTable, kCompanyName=kCompanyName, stFtpTraffic=stFtpTraffic, trApplication=trApplication, stHttpBytesFromClient=stHttpBytesFromClient, mwgInfo=mwgInfo, stConnectionsBlocked=stConnectionsBlocked, stCategories=stCategories, kProductVersion=kProductVersion, mwgHttps=mwgHttps, stCategoryName=stCategoryName, stResolveHostViaDNS=stResolveHostViaDNS, stCPULoad=stCPULoad, stHandleConnectToServer=stHandleConnectToServer, stHttpTraffic=stHttpTraffic, stBadReputation=stBadReputation, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kBuildNumber=kBuildNumber, kRevision=kRevision, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesToClient=stFtpBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, PYSNMP_MODULE_ID=mwg, stMalwareDetected=stMalwareDetected, pMFEEngineVersion=pMFEEngineVersion, mwgTraps=mwgTraps, stConnectionsLegitimate=stConnectionsLegitimate, stMemConsumed=stMemConsumed, mwgMiscellaneous=mwgMiscellaneous, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgEngineVersions=mwgEngineVersions, pAMProactiveVersion=pAMProactiveVersion, notifyOrigin=notifyOrigin, stConnectedSockets=stConnectedSockets, stHttpsBytesFromServer=stHttpsBytesFromServer, notifySeverity=notifySeverity, stTimeForTransaction=stTimeForTransaction, stClientCount=stClientCount, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsTraffic=stHttpsTraffic, stHttpsRequests=stHttpsRequests, stHttpBytesToClient=stHttpBytesToClient, stCPULoadRaw=stCPULoadRaw, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoryCount=stCategoryCount, kMinorVersion=kMinorVersion, kMajorVersion=kMajorVersion, stHttpBytesFromServer=stHttpBytesFromServer, kHotfixVersion=kHotfixVersion, trUser=trUser, stHttpsBytesToClient=stHttpsBytesToClient, stMimeType=stMimeType, stHttpsBytesToServer=stHttpsBytesToServer, pTSDBVersion=pTSDBVersion, stFtpBytesFromServer=stFtpBytesFromServer, mwgHttp=mwgHttp, mwg=mwg, kMicroVersion=kMicroVersion, stFtpBytesToServer=stFtpBytesToServer, mwgContent=mwgContent, stFtpBytesFromClient=stFtpBytesFromClient, kProductName=kProductName, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpRequests=stHttpRequests, pAMEngineVersion=pAMEngineVersion, notifyAffectedHost=notifyAffectedHost, stBlockedByURLFilter=stBlockedByURLFilter, stCPUIOWait=stCPUIOWait, kCustomVersion=kCustomVersion, mwgFTP=mwgFTP, mwgTrapVariables=mwgTrapVariables)
