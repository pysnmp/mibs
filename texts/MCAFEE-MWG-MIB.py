...
enterprises, Integer32, iso, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, mib_2, MibIdentifier, Gauge32, NotificationType, Counter32, ObjectIdentity, Bits, TimeTicks, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "iso", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "mib-2", "MibIdentifier", "Gauge32", "NotificationType", "Counter32", "ObjectIdentity", "Bits", "TimeTicks", "ModuleIdentity", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesToServer=stFtpBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, notifyAdditional=notifyAdditional, trSystem=trSystem, notifyReason=notifyReason, notifyAffectedHost=notifyAffectedHost, stHandleConnectToServer=stHandleConnectToServer, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesToServer=stHttpBytesToServer, stConnectedSockets=stConnectedSockets, notifySeverity=notifySeverity, trUser=trUser, kMajorVersion=kMajorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgTrapVariables=mwgTrapVariables, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgStatistics=mwgStatistics, notifyOrigin=notifyOrigin, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesFromClient=stHttpBytesFromClient, stCategoriesTable=stCategoriesTable, stCPULoadRaw=stCPULoadRaw, stMemConsumed=stMemConsumed, stCategoryName=stCategoryName, stCategoriesEntry=stCategoriesEntry, stCategories=stCategories, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesFromClient=stHttpsBytesFromClient, kCompanyName=kCompanyName, stBlockedByMediaFilter=stBlockedByMediaFilter, pAMSignatureVersion=pAMSignatureVersion, pMFEDATVersion=pMFEDATVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpTraffic=stHttpTraffic, stHttpsRequests=stHttpsRequests, stHttpsBytesToServer=stHttpsBytesToServer, mwg=mwg, kMinorVersion=kMinorVersion, mwgHttps=mwgHttps, stHttpBytesToClient=stHttpBytesToClient, mwgEngineVersions=mwgEngineVersions, stClientCount=stClientCount, stCategoryCount=stCategoryCount, stBlockedByURLFilter=stBlockedByURLFilter, kBuildNumber=kBuildNumber, mwgInfo=mwgInfo, trApplication=trApplication, pTSDBVersion=pTSDBVersion, stConnectionsBlocked=stConnectionsBlocked, mwgFTP=mwgFTP, kHotfixVersion=kHotfixVersion, stHttpsTraffic=stHttpsTraffic, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMimeType=stMimeType, mwgMiscellaneous=mwgMiscellaneous, kProductVersion=kProductVersion, notifyReasonString=notifyReasonString, kProductName=kProductName, pAMEngineVersion=pAMEngineVersion, mwgContent=mwgContent, stBadReputation=stBadReputation, kRevision=kRevision, pMFEEngineVersion=pMFEEngineVersion, stFtpTraffic=stFtpTraffic, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, kCustomVersion=kCustomVersion, stMalwareDetected=stMalwareDetected, stCPULoad=stCPULoad, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromServer=stHttpBytesFromServer, stCPUIOWait=stCPUIOWait, stHttpRequests=stHttpRequests, mwgTraps=mwgTraps, kMicroVersion=kMicroVersion, mwgHttp=mwgHttp, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpBytesToClient=stFtpBytesToClient, notifyOriginName=notifyOriginName, PYSNMP_MODULE_ID=mwg, stTimeForTransaction=stTimeForTransaction)
