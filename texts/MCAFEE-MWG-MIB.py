...
Unsigned32, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, TimeTicks, Integer32, Counter64, Gauge32, mib_2, Bits, ObjectIdentity, ModuleIdentity, iso, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "TimeTicks", "Integer32", "Counter64", "Gauge32", "mib-2", "Bits", "ObjectIdentity", "ModuleIdentity", "iso", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stTimeForTransaction=stTimeForTransaction, notifyAdditional=notifyAdditional, stHttpsTraffic=stHttpsTraffic, stBlockedByMediaFilter=stBlockedByMediaFilter, stMalwareDetected=stMalwareDetected, kMajorVersion=kMajorVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpTraffic=stFtpTraffic, mwgInfo=mwgInfo, stConnectedSockets=stConnectedSockets, mwgHttp=mwgHttp, mwgContent=mwgContent, kCustomVersion=kCustomVersion, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, kBuildNumber=kBuildNumber, stCPUIOWait=stCPUIOWait, pTSDBVersion=pTSDBVersion, mwgHttps=mwgHttps, pAMProactiveVersion=pAMProactiveVersion, stConnectionsBlocked=stConnectionsBlocked, stBadReputation=stBadReputation, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgMiscellaneous=mwgMiscellaneous, kMicroVersion=kMicroVersion, mwgStatistics=mwgStatistics, stCPULoad=stCPULoad, notifyReason=notifyReason, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, stHttpRequests=stHttpRequests, trApplication=trApplication, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesToClient=stFtpBytesToClient, stResolveHostViaDNS=stResolveHostViaDNS, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyOriginName=notifyOriginName, notifyAffectedHost=notifyAffectedHost, stCategoriesTable=stCategoriesTable, stHandleConnectToServer=stHandleConnectToServer, stMemConsumed=stMemConsumed, stHttpBytesToServer=stHttpBytesToServer, kProductName=kProductName, notifyOrigin=notifyOrigin, stCategoriesEntry=stCategoriesEntry, kHotfixVersion=kHotfixVersion, mwg=mwg, kMinorVersion=kMinorVersion, stCPULoadRaw=stCPULoadRaw, kProductVersion=kProductVersion, stMimeType=stMimeType, stCategories=stCategories, stHttpsBytesToClient=stHttpsBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyReasonString=notifyReasonString, stCategoryName=stCategoryName, trSystem=trSystem, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesToClient=stHttpBytesToClient, notifySeverity=notifySeverity, stBlockedByAntiMalware=stBlockedByAntiMalware, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, trUser=trUser, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoryCount=stCategoryCount, stHttpTraffic=stHttpTraffic, stClientCount=stClientCount, mwgFTP=mwgFTP, kCompanyName=kCompanyName, mwgEngineVersions=mwgEngineVersions, pAMEngineVersion=pAMEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, PYSNMP_MODULE_ID=mwg, pMFEDATVersion=pMFEDATVersion, mwgTraps=mwgTraps, kRevision=kRevision, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesFromServer=stFtpBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsRequests=stHttpsRequests, mwgTrapVariables=mwgTrapVariables)
