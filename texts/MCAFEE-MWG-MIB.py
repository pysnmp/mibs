...
Counter32, TimeTicks, NotificationType, Integer32, MibIdentifier, iso, mib_2, enterprises, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, Unsigned32, Bits, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "NotificationType", "Integer32", "MibIdentifier", "iso", "mib-2", "enterprises", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Bits", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByAntiMalware=stBlockedByAntiMalware, kCompanyName=kCompanyName, mwgEngineVersions=mwgEngineVersions, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgFTP=mwgFTP, pAMSignatureVersion=pAMSignatureVersion, stHttpsRequests=stHttpsRequests, stHttpsBytesToServer=stHttpsBytesToServer, notifyReasonString=notifyReasonString, mwgHttps=mwgHttps, stHttpsBytesToClient=stHttpsBytesToClient, mwgTraps=mwgTraps, stConnectedSockets=stConnectedSockets, kMajorVersion=kMajorVersion, notifyOriginName=notifyOriginName, mwgContent=mwgContent, kMinorVersion=kMinorVersion, PYSNMP_MODULE_ID=mwg, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesToClient=stFtpBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMemConsumed=stMemConsumed, kMicroVersion=kMicroVersion, stCategoryCount=stCategoryCount, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoriesTable=stCategoriesTable, pMFEDATVersion=pMFEDATVersion, stCPUIOWait=stCPUIOWait, stClientCount=stClientCount, notifyOrigin=notifyOrigin, kCustomVersion=kCustomVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCPULoadRaw=stCPULoadRaw, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesToServer=stHttpBytesToServer, stConnectionsBlocked=stConnectionsBlocked, trSystem=trSystem, mwgTrapVariables=mwgTrapVariables, notifyAffectedHost=notifyAffectedHost, trUser=trUser, notifyAdditional=notifyAdditional, stHttpsTraffic=stHttpsTraffic, pAMEngineVersion=pAMEngineVersion, kProductVersion=kProductVersion, notifyReason=notifyReason, mwgMiscellaneous=mwgMiscellaneous, trApplication=trApplication, stHttpTraffic=stHttpTraffic, stConnectionsLegitimate=stConnectionsLegitimate, stFtpTraffic=stFtpTraffic, stMalwareDetected=stMalwareDetected, stHttpBytesFromServer=stHttpBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kProductName=kProductName, stResolveHostViaDNS=stResolveHostViaDNS, stMimeType=stMimeType, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgInfo=mwgInfo, stCategoriesEntry=stCategoriesEntry, notifySeverity=notifySeverity, stCPULoad=stCPULoad, kBuildNumber=kBuildNumber, mwg=mwg, stCategoryName=stCategoryName, stHttpRequests=stHttpRequests, kHotfixVersion=kHotfixVersion, pTSDBVersion=pTSDBVersion, stBadReputation=stBadReputation, stTimeForTransaction=stTimeForTransaction, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, kRevision=kRevision, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesToServer=stFtpBytesToServer, stHandleConnectToServer=stHandleConnectToServer, mwgHttp=mwgHttp, stFtpBytesFromServer=stFtpBytesFromServer, mwgStatistics=mwgStatistics, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategories=stCategories)
