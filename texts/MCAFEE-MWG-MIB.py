...
Gauge32, IpAddress, mib_2, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, MibIdentifier, Integer32, Unsigned32, NotificationType, enterprises, Counter32, NotificationType, Bits, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "mib-2", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "MibIdentifier", "Integer32", "Unsigned32", "NotificationType", "enterprises", "Counter32", "NotificationType", "Bits", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoriesEntry=stCategoriesEntry, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesFromServer=stFtpBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, trUser=trUser, pAMEngineVersion=pAMEngineVersion, stHttpTraffic=stHttpTraffic, stHandleConnectToServer=stHandleConnectToServer, stBadReputation=stBadReputation, pMFEDATVersion=pMFEDATVersion, notifyOriginName=notifyOriginName, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsTraffic=stHttpsTraffic, kProductVersion=kProductVersion, stMalwareDetected=stMalwareDetected, mwgMiscellaneous=mwgMiscellaneous, kProductName=kProductName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpTraffic=stFtpTraffic, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kHotfixVersion=kHotfixVersion, notifySeverity=notifySeverity, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesToServer=stHttpsBytesToServer, kRevision=kRevision, mwg=mwg, stHttpRequests=stHttpRequests, stCPULoadRaw=stCPULoadRaw, stHttpsRequests=stHttpsRequests, kCompanyName=kCompanyName, stConnectionsLegitimate=stConnectionsLegitimate, notifyReason=notifyReason, mwgContent=mwgContent, mwgStatistics=mwgStatistics, stMemConsumed=stMemConsumed, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgHttps=mwgHttps, trSystem=trSystem, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgTrapVariables=mwgTrapVariables, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMimeType=stMimeType, stCPULoad=stCPULoad, stFtpBytesFromClient=stFtpBytesFromClient, kMicroVersion=kMicroVersion, stCategoryName=stCategoryName, kCustomVersion=kCustomVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyAffectedHost=notifyAffectedHost, stTimeForTransaction=stTimeForTransaction, kMajorVersion=kMajorVersion, notifyOrigin=notifyOrigin, mwgInfo=mwgInfo, kMinorVersion=kMinorVersion, mwgEngineVersions=mwgEngineVersions, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyAdditional=notifyAdditional, mwgFTP=mwgFTP, kBuildNumber=kBuildNumber, stCategories=stCategories, stHttpBytesFromClient=stHttpBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, stClientCount=stClientCount, stHttpsBytesToClient=stHttpsBytesToClient, stCPUIOWait=stCPUIOWait, mwgHttp=mwgHttp, pTSDBVersion=pTSDBVersion, pAMSignatureVersion=pAMSignatureVersion, notifyReasonString=notifyReasonString, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoriesTable=stCategoriesTable, stFtpBytesToClient=stFtpBytesToClient, PYSNMP_MODULE_ID=mwg, stHttpsBytesFromServer=stHttpsBytesFromServer, trApplication=trApplication, stConnectedSockets=stConnectedSockets, pMFEEngineVersion=pMFEEngineVersion, mwgTraps=mwgTraps, stCategoryCount=stCategoryCount)
