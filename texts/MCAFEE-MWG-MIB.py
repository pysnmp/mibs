...
Unsigned32, TimeTicks, NotificationType, NotificationType, IpAddress, MibIdentifier, iso, Bits, enterprises, ObjectIdentity, Integer32, Counter64, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "NotificationType", "NotificationType", "IpAddress", "MibIdentifier", "iso", "Bits", "enterprises", "ObjectIdentity", "Integer32", "Counter64", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMimeType=stMimeType, stCPULoadRaw=stCPULoadRaw, mwgContent=mwgContent, stConnectionsLegitimate=stConnectionsLegitimate, notifyOrigin=notifyOrigin, trUser=trUser, notifyOriginName=notifyOriginName, pAMEngineVersion=pAMEngineVersion, pTSDBVersion=pTSDBVersion, stHttpsRequests=stHttpsRequests, trApplication=trApplication, stCategoriesTable=stCategoriesTable, mwgTraps=mwgTraps, stCategoryName=stCategoryName, mwgFTP=mwgFTP, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pAMSignatureVersion=pAMSignatureVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCPUIOWait=stCPUIOWait, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsBytesFromClient=stHttpsBytesFromClient, trSystem=trSystem, pMFEEngineVersion=pMFEEngineVersion, PYSNMP_MODULE_ID=mwg, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kBuildNumber=kBuildNumber, mwgEngineVersions=mwgEngineVersions, kProductName=kProductName, notifyReason=notifyReason, stHttpBytesFromClient=stHttpBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, stTimeForTransaction=stTimeForTransaction, pMFEDATVersion=pMFEDATVersion, stHttpBytesToServer=stHttpBytesToServer, mwgHttp=mwgHttp, stHttpsBytesToClient=stHttpsBytesToClient, mwgHttps=mwgHttps, stHttpRequests=stHttpRequests, stBadReputation=stBadReputation, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgStatistics=mwgStatistics, kMajorVersion=kMajorVersion, kMicroVersion=kMicroVersion, stCPULoad=stCPULoad, notifySeverity=notifySeverity, stHttpsTraffic=stHttpsTraffic, stHandleConnectToServer=stHandleConnectToServer, stMemConsumed=stMemConsumed, stConnectionsBlocked=stConnectionsBlocked, stConnectedSockets=stConnectedSockets, kCustomVersion=kCustomVersion, kMinorVersion=kMinorVersion, stHttpTraffic=stHttpTraffic, mwgTrapVariables=mwgTrapVariables, kCompanyName=kCompanyName, stFtpTraffic=stFtpTraffic, stCategoryCount=stCategoryCount, mwg=mwg, stCategories=stCategories, stFtpBytesToServer=stFtpBytesToServer, notifyReasonString=notifyReasonString, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoriesEntry=stCategoriesEntry, mwgMiscellaneous=mwgMiscellaneous, stBlockedByURLFilter=stBlockedByURLFilter, kRevision=kRevision, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyAffectedHost=notifyAffectedHost, stHttpBytesToClient=stHttpBytesToClient, kHotfixVersion=kHotfixVersion, notifyAdditional=notifyAdditional, stMalwareDetected=stMalwareDetected, mwgInfo=mwgInfo, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, stClientCount=stClientCount, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesToClient=stFtpBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kProductVersion=kProductVersion)
