...
ObjectIdentity, NotificationType, MibIdentifier, Bits, Counter64, iso, Unsigned32, Integer32, ModuleIdentity, Counter32, enterprises, NotificationType, IpAddress, mib_2, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "MibIdentifier", "Bits", "Counter64", "iso", "Unsigned32", "Integer32", "ModuleIdentity", "Counter32", "enterprises", "NotificationType", "IpAddress", "mib-2", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPULoad=stCPULoad, stMimeType=stMimeType, stHttpsRequests=stHttpsRequests, pTSDBVersion=pTSDBVersion, stCategoryName=stCategoryName, stFtpTraffic=stFtpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesToServer=stFtpBytesToServer, notifyReasonString=notifyReasonString, mwg=mwg, stHttpBytesToServer=stHttpBytesToServer, notifySeverity=notifySeverity, notifyOriginName=notifyOriginName, stTimeForTransaction=stTimeForTransaction, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentLastReceivedServer=stLastSentLastReceivedServer, PYSNMP_MODULE_ID=mwg, kRevision=kRevision, stHttpTraffic=stHttpTraffic, kMicroVersion=kMicroVersion, stCategoryCount=stCategoryCount, pAMEngineVersion=pAMEngineVersion, stConnectedSockets=stConnectedSockets, stHttpsTraffic=stHttpsTraffic, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, stConnectionsLegitimate=stConnectionsLegitimate, mwgInfo=mwgInfo, kMajorVersion=kMajorVersion, stMalwareDetected=stMalwareDetected, notifyAffectedHost=notifyAffectedHost, stCPULoadRaw=stCPULoadRaw, stHttpRequests=stHttpRequests, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgEngineVersions=mwgEngineVersions, stHttpsBytesToServer=stHttpsBytesToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgStatistics=mwgStatistics, kHotfixVersion=kHotfixVersion, stBadReputation=stBadReputation, kMinorVersion=kMinorVersion, notifyOrigin=notifyOrigin, stCPUIOWait=stCPUIOWait, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stClientCount=stClientCount, mwgContent=mwgContent, kCustomVersion=kCustomVersion, stFtpBytesFromClient=stFtpBytesFromClient, kProductName=kProductName, stHttpBytesToClient=stHttpBytesToClient, stHandleConnectToServer=stHandleConnectToServer, mwgHttp=mwgHttp, mwgFTP=mwgFTP, mwgTraps=mwgTraps, trUser=trUser, stCategoriesEntry=stCategoriesEntry, pMFEEngineVersion=pMFEEngineVersion, trApplication=trApplication, stFtpBytesToClient=stFtpBytesToClient, pAMProactiveVersion=pAMProactiveVersion, kBuildNumber=kBuildNumber, kCompanyName=kCompanyName, stMemConsumed=stMemConsumed, mwgMiscellaneous=mwgMiscellaneous, stResolveHostViaDNS=stResolveHostViaDNS, pMFEDATVersion=pMFEDATVersion, mwgTrapVariables=mwgTrapVariables, trSystem=trSystem, stFtpBytesFromServer=stFtpBytesFromServer, stCategoriesTable=stCategoriesTable, notifyReason=notifyReason, pAMSignatureVersion=pAMSignatureVersion, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgHttps=mwgHttps, notifyAdditional=notifyAdditional, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategories=stCategories, kProductVersion=kProductVersion)
