...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, Counter64, NotificationType, iso, NotificationType, Integer32, Bits, TimeTicks, ObjectIdentity, Gauge32, IpAddress, MibIdentifier, mib_2, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "Counter64", "NotificationType", "iso", "NotificationType", "Integer32", "Bits", "TimeTicks", "ObjectIdentity", "Gauge32", "IpAddress", "MibIdentifier", "mib-2", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stClientCount=stClientCount, kBuildNumber=kBuildNumber, stHttpsTraffic=stHttpsTraffic, trSystem=trSystem, stConnectionsBlocked=stConnectionsBlocked, pAMProactiveVersion=pAMProactiveVersion, mwgTraps=mwgTraps, mwgHttp=mwgHttp, pAMSignatureVersion=pAMSignatureVersion, stMalwareDetected=stMalwareDetected, mwgFTP=mwgFTP, stTimeForTransaction=stTimeForTransaction, stHttpBytesToServer=stHttpBytesToServer, stCategoryCount=stCategoryCount, pMFEEngineVersion=pMFEEngineVersion, kProductVersion=kProductVersion, notifyAdditional=notifyAdditional, mwgEngineVersions=mwgEngineVersions, pAMEngineVersion=pAMEngineVersion, stFtpBytesFromServer=stFtpBytesFromServer, kProductName=kProductName, kHotfixVersion=kHotfixVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, trApplication=trApplication, stFtpTraffic=stFtpTraffic, stHttpsRequests=stHttpsRequests, mwg=mwg, stMimeType=stMimeType, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyAffectedHost=notifyAffectedHost, stCPULoad=stCPULoad, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyOriginName=notifyOriginName, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesToServer=stFtpBytesToServer, PYSNMP_MODULE_ID=mwg, notifyOrigin=notifyOrigin, stCategoriesTable=stCategoriesTable, stCategories=stCategories, kRevision=kRevision, pMFEDATVersion=pMFEDATVersion, mwgTrapVariables=mwgTrapVariables, stHttpTraffic=stHttpTraffic, stHttpRequests=stHttpRequests, stConnectionsLegitimate=stConnectionsLegitimate, stCategoryName=stCategoryName, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpBytesFromClient=stHttpBytesFromClient, kCustomVersion=kCustomVersion, kMicroVersion=kMicroVersion, stHttpBytesFromServer=stHttpBytesFromServer, stHttpBytesToClient=stHttpBytesToClient, stBadReputation=stBadReputation, stHttpsBytesToClient=stHttpsBytesToClient, mwgContent=mwgContent, kMinorVersion=kMinorVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, trUser=trUser, mwgMiscellaneous=mwgMiscellaneous, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgHttps=mwgHttps, kCompanyName=kCompanyName, stCPULoadRaw=stCPULoadRaw, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyReasonString=notifyReasonString, mwgInfo=mwgInfo, kMajorVersion=kMajorVersion, stCategoriesEntry=stCategoriesEntry, stHttpsBytesToServer=stHttpsBytesToServer, notifyReason=notifyReason, stMemConsumed=stMemConsumed, mwgStatistics=mwgStatistics, stBlockedByURLFilter=stBlockedByURLFilter, stCPUIOWait=stCPUIOWait, notifySeverity=notifySeverity, stConnectedSockets=stConnectedSockets, stBlockedByMediaFilter=stBlockedByMediaFilter, pTSDBVersion=pTSDBVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient)
