...
enterprises, MibIdentifier, Gauge32, ModuleIdentity, mib_2, NotificationType, ObjectIdentity, Counter32, IpAddress, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, TimeTicks, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "Gauge32", "ModuleIdentity", "mib-2", "NotificationType", "ObjectIdentity", "Counter32", "IpAddress", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "TimeTicks", "Counter64", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyReason=notifyReason, kMajorVersion=kMajorVersion, pAMSignatureVersion=pAMSignatureVersion, stCategoriesEntry=stCategoriesEntry, stConnectedSockets=stConnectedSockets, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpRequests=stHttpRequests, trApplication=trApplication, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyOriginName=notifyOriginName, mwgTrapVariables=mwgTrapVariables, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsRequests=stHttpsRequests, mwgEngineVersions=mwgEngineVersions, mwgFTP=mwgFTP, stMemConsumed=stMemConsumed, notifyAdditional=notifyAdditional, kProductVersion=kProductVersion, kCompanyName=kCompanyName, stHttpsTraffic=stHttpsTraffic, stHttpBytesFromClient=stHttpBytesFromClient, stFtpTraffic=stFtpTraffic, kMinorVersion=kMinorVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgStatistics=mwgStatistics, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesFromClient=stFtpBytesFromClient, notifySeverity=notifySeverity, stResolveHostViaDNS=stResolveHostViaDNS, notifyAffectedHost=notifyAffectedHost, stMalwareDetected=stMalwareDetected, PYSNMP_MODULE_ID=mwg, mwgInfo=mwgInfo, mwg=mwg, mwgHttps=mwgHttps, stConnectionsBlocked=stConnectionsBlocked, stCPULoad=stCPULoad, pTSDBVersion=pTSDBVersion, pAMProactiveVersion=pAMProactiveVersion, notifyReasonString=notifyReasonString, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgTraps=mwgTraps, mwgMiscellaneous=mwgMiscellaneous, pMFEDATVersion=pMFEDATVersion, stMimeType=stMimeType, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesToClient=stHttpsBytesToClient, stCategoryCount=stCategoryCount, kBuildNumber=kBuildNumber, stHttpBytesFromServer=stHttpBytesFromServer, stCategoryName=stCategoryName, kCustomVersion=kCustomVersion, stFtpBytesToClient=stFtpBytesToClient, mwgContent=mwgContent, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByURLFilter=stBlockedByURLFilter, stConnectionsLegitimate=stConnectionsLegitimate, trUser=trUser, kProductName=kProductName, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyOrigin=notifyOrigin, stClientCount=stClientCount, mwgHttp=mwgHttp, stCPUIOWait=stCPUIOWait, pAMEngineVersion=pAMEngineVersion, stFtpBytesToServer=stFtpBytesToServer, stTimeForTransaction=stTimeForTransaction, kRevision=kRevision, kHotfixVersion=kHotfixVersion, stCategories=stCategories, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesToServer=stHttpsBytesToServer, stCategoriesTable=stCategoriesTable, stBadReputation=stBadReputation, kMicroVersion=kMicroVersion, stFtpBytesFromServer=stFtpBytesFromServer, trSystem=trSystem, stHttpTraffic=stHttpTraffic, stHandleConnectToServer=stHandleConnectToServer, stCPULoadRaw=stCPULoadRaw)
