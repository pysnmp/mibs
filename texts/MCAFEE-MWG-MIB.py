...
Counter64, TimeTicks, Counter32, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Integer32, ObjectIdentity, Bits, ModuleIdentity, NotificationType, NotificationType, MibIdentifier, iso, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "Counter32", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Integer32", "ObjectIdentity", "Bits", "ModuleIdentity", "NotificationType", "NotificationType", "MibIdentifier", "iso", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgTrapVariables=mwgTrapVariables, mwgContent=mwgContent, pMFEDATVersion=pMFEDATVersion, kMicroVersion=kMicroVersion, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesFromClient=stFtpBytesFromClient, stCategoriesEntry=stCategoriesEntry, stHttpsBytesToServer=stHttpsBytesToServer, stCategoriesTable=stCategoriesTable, mwgHttps=mwgHttps, stHandleConnectToServer=stHandleConnectToServer, trUser=trUser, pTSDBVersion=pTSDBVersion, stMemConsumed=stMemConsumed, mwgFTP=mwgFTP, trApplication=trApplication, stClientCount=stClientCount, notifyReason=notifyReason, kCompanyName=kCompanyName, stCPUIOWait=stCPUIOWait, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stTimeForTransaction=stTimeForTransaction, notifyOrigin=notifyOrigin, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMinorVersion=kMinorVersion, stMimeType=stMimeType, kBuildNumber=kBuildNumber, PYSNMP_MODULE_ID=mwg, notifyAdditional=notifyAdditional, stHttpsBytesToClient=stHttpsBytesToClient, trSystem=trSystem, pMFEEngineVersion=pMFEEngineVersion, stFtpTraffic=stFtpTraffic, stHttpRequests=stHttpRequests, stHttpsTraffic=stHttpsTraffic, stCategoryName=stCategoryName, notifyOriginName=notifyOriginName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kRevision=kRevision, notifyReasonString=notifyReasonString, mwgTraps=mwgTraps, kProductVersion=kProductVersion, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesFromServer=stHttpsBytesFromServer, kHotfixVersion=kHotfixVersion, kMajorVersion=kMajorVersion, mwgStatistics=mwgStatistics, mwgInfo=mwgInfo, stBlockedByURLFilter=stBlockedByURLFilter, pAMSignatureVersion=pAMSignatureVersion, kProductName=kProductName, stCategoryCount=stCategoryCount, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesToClient=stFtpBytesToClient, stConnectedSockets=stConnectedSockets, mwgMiscellaneous=mwgMiscellaneous, stCPULoadRaw=stCPULoadRaw, mwgEngineVersions=mwgEngineVersions, stHttpBytesFromServer=stHttpBytesFromServer, mwg=mwg, stCPULoad=stCPULoad, notifySeverity=notifySeverity, stConnectionsLegitimate=stConnectionsLegitimate, pAMProactiveVersion=pAMProactiveVersion, mwgHttp=mwgHttp, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesFromClient=stHttpsBytesFromClient, stMalwareDetected=stMalwareDetected, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesFromClient=stHttpBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBadReputation=stBadReputation, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategories=stCategories, pAMEngineVersion=pAMEngineVersion, stHttpsRequests=stHttpsRequests, kCustomVersion=kCustomVersion, stHttpBytesToClient=stHttpBytesToClient, notifyAffectedHost=notifyAffectedHost, stConnectionsBlocked=stConnectionsBlocked, stHttpTraffic=stHttpTraffic, stFtpBytesToServer=stFtpBytesToServer)
