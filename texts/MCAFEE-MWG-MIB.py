...
MibIdentifier, Integer32, Counter32, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Unsigned32, iso, Counter64, Bits, TimeTicks, ObjectIdentity, IpAddress, ModuleIdentity, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "Counter32", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Unsigned32", "iso", "Counter64", "Bits", "TimeTicks", "ObjectIdentity", "IpAddress", "ModuleIdentity", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoriesTable=stCategoriesTable, kMicroVersion=kMicroVersion, mwgTrapVariables=mwgTrapVariables, mwgStatistics=mwgStatistics, stHttpBytesFromClient=stHttpBytesFromClient, mwgFTP=mwgFTP, stCategories=stCategories, pMFEEngineVersion=pMFEEngineVersion, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, stClientCount=stClientCount, mwg=mwg, stResolveHostViaDNS=stResolveHostViaDNS, stCategoryCount=stCategoryCount, stMalwareDetected=stMalwareDetected, stHttpRequests=stHttpRequests, stCPUIOWait=stCPUIOWait, PYSNMP_MODULE_ID=mwg, stCategoryName=stCategoryName, mwgInfo=mwgInfo, kHotfixVersion=kHotfixVersion, kCompanyName=kCompanyName, stBlockedByMediaFilter=stBlockedByMediaFilter, kProductVersion=kProductVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttp=mwgHttp, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, stCPULoadRaw=stCPULoadRaw, stConnectionsBlocked=stConnectionsBlocked, stHttpTraffic=stHttpTraffic, stHttpBytesToClient=stHttpBytesToClient, notifyAdditional=notifyAdditional, stHttpsTraffic=stHttpsTraffic, stMimeType=stMimeType, kProductName=kProductName, stHandleConnectToServer=stHandleConnectToServer, mwgTraps=mwgTraps, pMFEDATVersion=pMFEDATVersion, notifyOriginName=notifyOriginName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pAMEngineVersion=pAMEngineVersion, stTimeForTransaction=stTimeForTransaction, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsRequests=stHttpsRequests, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stBadReputation=stBadReputation, notifyAffectedHost=notifyAffectedHost, kMajorVersion=kMajorVersion, stMemConsumed=stMemConsumed, mwgContent=mwgContent, mwgHttps=mwgHttps, notifyOrigin=notifyOrigin, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, stCPULoad=stCPULoad, stFtpBytesToServer=stFtpBytesToServer, kBuildNumber=kBuildNumber, kCustomVersion=kCustomVersion, trUser=trUser, kMinorVersion=kMinorVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpTraffic=stFtpTraffic, stHttpsBytesToServer=stHttpsBytesToServer, stConnectedSockets=stConnectedSockets, trSystem=trSystem, mwgEngineVersions=mwgEngineVersions, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesToServer=stHttpBytesToServer, trApplication=trApplication, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyReasonString=notifyReasonString, notifyReason=notifyReason, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifySeverity=notifySeverity, kRevision=kRevision, pTSDBVersion=pTSDBVersion)
