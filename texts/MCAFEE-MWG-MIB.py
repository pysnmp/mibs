...
mib_2, NotificationType, Integer32, iso, ModuleIdentity, Counter64, Bits, MibIdentifier, NotificationType, ObjectIdentity, Unsigned32, enterprises, Counter32, Gauge32, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "NotificationType", "Integer32", "iso", "ModuleIdentity", "Counter64", "Bits", "MibIdentifier", "NotificationType", "ObjectIdentity", "Unsigned32", "enterprises", "Counter32", "Gauge32", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stConnectedSockets=stConnectedSockets, kCompanyName=kCompanyName, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesToClient=stHttpBytesToClient, stHttpsTraffic=stHttpsTraffic, stBlockedByMediaFilter=stBlockedByMediaFilter, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesToServer=stFtpBytesToServer, pMFEDATVersion=pMFEDATVersion, mwgTrapVariables=mwgTrapVariables, stHttpBytesFromClient=stHttpBytesFromClient, stTimeForTransaction=stTimeForTransaction, pAMEngineVersion=pAMEngineVersion, mwgInfo=mwgInfo, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgMiscellaneous=mwgMiscellaneous, notifyAdditional=notifyAdditional, stMimeType=stMimeType, stCPULoadRaw=stCPULoadRaw, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyAffectedHost=notifyAffectedHost, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesToServer=stHttpBytesToServer, mwgHttp=mwgHttp, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesToServer=stHttpsBytesToServer, notifyOrigin=notifyOrigin, stCategoryName=stCategoryName, notifyOriginName=notifyOriginName, kMajorVersion=kMajorVersion, kCustomVersion=kCustomVersion, pMFEEngineVersion=pMFEEngineVersion, notifyReason=notifyReason, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpRequests=stHttpRequests, stCPULoad=stCPULoad, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwg=mwg, trApplication=trApplication, stCategoriesTable=stCategoriesTable, stConnectionsBlocked=stConnectionsBlocked, stHttpTraffic=stHttpTraffic, kRevision=kRevision, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgTraps=mwgTraps, PYSNMP_MODULE_ID=mwg, kHotfixVersion=kHotfixVersion, kMicroVersion=kMicroVersion, stBadReputation=stBadReputation, stHttpsBytesToClient=stHttpsBytesToClient, trUser=trUser, notifyReasonString=notifyReasonString, stFtpBytesToClient=stFtpBytesToClient, stCategoryCount=stCategoryCount, pAMProactiveVersion=pAMProactiveVersion, kBuildNumber=kBuildNumber, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, stMemConsumed=stMemConsumed, mwgHttps=mwgHttps, stCategoriesEntry=stCategoriesEntry, stClientCount=stClientCount, kMinorVersion=kMinorVersion, stCategories=stCategories, stHttpsRequests=stHttpsRequests, stCPUIOWait=stCPUIOWait, mwgContent=mwgContent, stHandleConnectToServer=stHandleConnectToServer, kProductName=kProductName, mwgStatistics=mwgStatistics, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgEngineVersions=mwgEngineVersions, notifySeverity=notifySeverity, pTSDBVersion=pTSDBVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kProductVersion=kProductVersion, stMalwareDetected=stMalwareDetected, pAMSignatureVersion=pAMSignatureVersion, stFtpTraffic=stFtpTraffic, stResolveHostViaDNS=stResolveHostViaDNS, trSystem=trSystem, stHttpBytesFromServer=stHttpBytesFromServer, mwgFTP=mwgFTP)
