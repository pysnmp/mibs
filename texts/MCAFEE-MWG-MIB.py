...
Unsigned32, Integer32, NotificationType, enterprises, Counter32, ModuleIdentity, ObjectIdentity, NotificationType, Counter64, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, mib_2, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "NotificationType", "enterprises", "Counter32", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Counter64", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "mib-2", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesToClient=stHttpsBytesToClient, pAMProactiveVersion=pAMProactiveVersion, stCPULoadRaw=stCPULoadRaw, kCustomVersion=kCustomVersion, notifyReason=notifyReason, mwgStatistics=mwgStatistics, notifyAffectedHost=notifyAffectedHost, notifySeverity=notifySeverity, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stResolveHostViaDNS=stResolveHostViaDNS, stConnectionsBlocked=stConnectionsBlocked, stHttpRequests=stHttpRequests, stCategoryCount=stCategoryCount, kMicroVersion=kMicroVersion, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, stHttpTraffic=stHttpTraffic, pMFEDATVersion=pMFEDATVersion, stMimeType=stMimeType, mwgInfo=mwgInfo, mwgHttp=mwgHttp, kMinorVersion=kMinorVersion, stCategories=stCategories, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMajorVersion=kMajorVersion, trSystem=trSystem, kCompanyName=kCompanyName, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesToServer=stHttpBytesToServer, stCPULoad=stCPULoad, mwgEngineVersions=mwgEngineVersions, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stClientCount=stClientCount, kBuildNumber=kBuildNumber, pTSDBVersion=pTSDBVersion, kProductVersion=kProductVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stMemConsumed=stMemConsumed, stHttpsTraffic=stHttpsTraffic, stConnectionsLegitimate=stConnectionsLegitimate, kRevision=kRevision, notifyOrigin=notifyOrigin, mwgContent=mwgContent, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgTraps=mwgTraps, stCategoriesTable=stCategoriesTable, stCategoriesEntry=stCategoriesEntry, stBadReputation=stBadReputation, pAMSignatureVersion=pAMSignatureVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trUser=trUser, stCategoryName=stCategoryName, stMalwareDetected=stMalwareDetected, notifyAdditional=notifyAdditional, pAMEngineVersion=pAMEngineVersion, stHttpBytesToClient=stHttpBytesToClient, stHttpsRequests=stHttpsRequests, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, stFtpTraffic=stFtpTraffic, notifyOriginName=notifyOriginName, kHotfixVersion=kHotfixVersion, stFtpBytesToClient=stFtpBytesToClient, mwgTrapVariables=mwgTrapVariables, pMFEEngineVersion=pMFEEngineVersion, mwg=mwg, stFtpBytesFromServer=stFtpBytesFromServer, notifyReasonString=notifyReasonString, stHandleConnectToServer=stHandleConnectToServer, stBlockedByURLFilter=stBlockedByURLFilter, stTimeForTransaction=stTimeForTransaction, mwgFTP=mwgFTP, kProductName=kProductName, stConnectedSockets=stConnectedSockets, stBlockedByMediaFilter=stBlockedByMediaFilter, trApplication=trApplication, stCPUIOWait=stCPUIOWait, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, PYSNMP_MODULE_ID=mwg, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesFromClient=stFtpBytesFromClient, mwgHttps=mwgHttps)
