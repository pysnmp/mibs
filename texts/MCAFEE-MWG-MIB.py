...
Gauge32, ObjectIdentity, Unsigned32, Counter32, MibIdentifier, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Bits, ModuleIdentity, Integer32, iso, NotificationType, TimeTicks, mib_2, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Unsigned32", "Counter32", "MibIdentifier", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Bits", "ModuleIdentity", "Integer32", "iso", "NotificationType", "TimeTicks", "mib-2", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByMediaFilter=stBlockedByMediaFilter, mwg=mwg, notifyAffectedHost=notifyAffectedHost, stHttpBytesFromClient=stHttpBytesFromClient, PYSNMP_MODULE_ID=mwg, pAMProactiveVersion=pAMProactiveVersion, stClientCount=stClientCount, stCategoriesEntry=stCategoriesEntry, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyReasonString=notifyReasonString, kRevision=kRevision, kMinorVersion=kMinorVersion, stFtpBytesToServer=stFtpBytesToServer, stCategories=stCategories, stCategoriesTable=stCategoriesTable, stHttpsBytesFromServer=stHttpsBytesFromServer, pMFEDATVersion=pMFEDATVersion, kMicroVersion=kMicroVersion, kProductName=kProductName, mwgHttps=mwgHttps, stMemConsumed=stMemConsumed, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kCustomVersion=kCustomVersion, stFtpBytesFromServer=stFtpBytesFromServer, mwgContent=mwgContent, trUser=trUser, stFtpTraffic=stFtpTraffic, pAMEngineVersion=pAMEngineVersion, notifyReason=notifyReason, trSystem=trSystem, mwgTraps=mwgTraps, mwgStatistics=mwgStatistics, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, stConnectionsBlocked=stConnectionsBlocked, stMalwareDetected=stMalwareDetected, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpRequests=stHttpRequests, notifyOrigin=notifyOrigin, trApplication=trApplication, pTSDBVersion=pTSDBVersion, stHandleConnectToServer=stHandleConnectToServer, pMFEEngineVersion=pMFEEngineVersion, stResolveHostViaDNS=stResolveHostViaDNS, stCPUIOWait=stCPUIOWait, stHttpBytesToServer=stHttpBytesToServer, pAMSignatureVersion=pAMSignatureVersion, notifySeverity=notifySeverity, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyOriginName=notifyOriginName, stConnectedSockets=stConnectedSockets, stHttpsRequests=stHttpsRequests, stBlockedByURLFilter=stBlockedByURLFilter, stMimeType=stMimeType, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMajorVersion=kMajorVersion, notifyAdditional=notifyAdditional, kCompanyName=kCompanyName, stBadReputation=stBadReputation, stHttpBytesToClient=stHttpBytesToClient, mwgMiscellaneous=mwgMiscellaneous, mwgTrapVariables=mwgTrapVariables, mwgHttp=mwgHttp, stTimeForTransaction=stTimeForTransaction, kBuildNumber=kBuildNumber, mwgFTP=mwgFTP, stHttpTraffic=stHttpTraffic, stCategoryCount=stCategoryCount, stCategoryName=stCategoryName, mwgInfo=mwgInfo, stFtpBytesFromClient=stFtpBytesFromClient, kHotfixVersion=kHotfixVersion, kProductVersion=kProductVersion, mwgEngineVersions=mwgEngineVersions, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, stCPULoadRaw=stCPULoadRaw, stHttpsTraffic=stHttpsTraffic, stCPULoad=stCPULoad)
