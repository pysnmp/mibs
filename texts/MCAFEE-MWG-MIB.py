...
IpAddress, Unsigned32, TimeTicks, ObjectIdentity, iso, Bits, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, NotificationType, Gauge32, enterprises, Integer32, MibIdentifier, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "TimeTicks", "ObjectIdentity", "iso", "Bits", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "NotificationType", "Gauge32", "enterprises", "Integer32", "MibIdentifier", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPUIOWait=stCPUIOWait, mwgMiscellaneous=mwgMiscellaneous, stMimeType=stMimeType, stHttpsTraffic=stHttpsTraffic, kMinorVersion=kMinorVersion, pMFEDATVersion=pMFEDATVersion, stHttpBytesToClient=stHttpBytesToClient, stMemConsumed=stMemConsumed, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, stCategoriesTable=stCategoriesTable, stCategoriesEntry=stCategoriesEntry, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, stBadReputation=stBadReputation, kMicroVersion=kMicroVersion, trApplication=trApplication, trSystem=trSystem, stFtpBytesToServer=stFtpBytesToServer, kRevision=kRevision, stHttpsBytesToServer=stHttpsBytesToServer, mwgTraps=mwgTraps, stHttpsRequests=stHttpsRequests, stConnectionsBlocked=stConnectionsBlocked, kMajorVersion=kMajorVersion, notifyOriginName=notifyOriginName, mwgHttp=mwgHttp, stHandleConnectToServer=stHandleConnectToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, stClientCount=stClientCount, stFtpBytesToClient=stFtpBytesToClient, PYSNMP_MODULE_ID=mwg, pAMEngineVersion=pAMEngineVersion, stCPULoad=stCPULoad, kProductVersion=kProductVersion, stResolveHostViaDNS=stResolveHostViaDNS, stConnectionsLegitimate=stConnectionsLegitimate, mwg=mwg, kProductName=kProductName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoryName=stCategoryName, kBuildNumber=kBuildNumber, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttps=mwgHttps, stFtpBytesFromServer=stFtpBytesFromServer, mwgInfo=mwgInfo, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTrapVariables=mwgTrapVariables, kHotfixVersion=kHotfixVersion, stCategories=stCategories, mwgContent=mwgContent, stHttpBytesFromClient=stHttpBytesFromClient, notifyReasonString=notifyReasonString, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesFromServer=stHttpBytesFromServer, notifyAdditional=notifyAdditional, pAMProactiveVersion=pAMProactiveVersion, stHttpRequests=stHttpRequests, stHttpsBytesToClient=stHttpsBytesToClient, kCustomVersion=kCustomVersion, stHttpBytesToServer=stHttpBytesToServer, kCompanyName=kCompanyName, stCategoryCount=stCategoryCount, stFtpTraffic=stFtpTraffic, notifyAffectedHost=notifyAffectedHost, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pMFEEngineVersion=pMFEEngineVersion, pTSDBVersion=pTSDBVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyReason=notifyReason, stCPULoadRaw=stCPULoadRaw, notifySeverity=notifySeverity, stTimeForTransaction=stTimeForTransaction, mwgFTP=mwgFTP, trUser=trUser, mwgEngineVersions=mwgEngineVersions, stConnectedSockets=stConnectedSockets, pAMSignatureVersion=pAMSignatureVersion, stHttpTraffic=stHttpTraffic, stMalwareDetected=stMalwareDetected, notifyOrigin=notifyOrigin, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgStatistics=mwgStatistics)
