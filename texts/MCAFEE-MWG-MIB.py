...
Counter32, Counter64, IpAddress, ObjectIdentity, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, enterprises, Integer32, MibIdentifier, mib_2, NotificationType, Bits, NotificationType, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "IpAddress", "ObjectIdentity", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "enterprises", "Integer32", "MibIdentifier", "mib-2", "NotificationType", "Bits", "NotificationType", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", PYSNMP_MODULE_ID=mwg, mwgEngineVersions=mwgEngineVersions, kProductName=kProductName, pMFEEngineVersion=pMFEEngineVersion, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesToServer=stHttpBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgTraps=mwgTraps, mwg=mwg, stMemConsumed=stMemConsumed, stFtpBytesToClient=stFtpBytesToClient, stCategories=stCategories, stHttpRequests=stHttpRequests, stCategoryCount=stCategoryCount, stCPULoad=stCPULoad, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesToServer=stFtpBytesToServer, trSystem=trSystem, stConnectedSockets=stConnectedSockets, trApplication=trApplication, kCustomVersion=kCustomVersion, mwgFTP=mwgFTP, pTSDBVersion=pTSDBVersion, kHotfixVersion=kHotfixVersion, stHttpBytesFromClient=stHttpBytesFromClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsRequests=stHttpsRequests, stCPULoadRaw=stCPULoadRaw, mwgTrapVariables=mwgTrapVariables, stCPUIOWait=stCPUIOWait, stBadReputation=stBadReputation, kMinorVersion=kMinorVersion, stTimeForTransaction=stTimeForTransaction, pAMEngineVersion=pAMEngineVersion, notifyAffectedHost=notifyAffectedHost, mwgHttp=mwgHttp, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpTraffic=stFtpTraffic, mwgContent=mwgContent, pMFEDATVersion=pMFEDATVersion, stMimeType=stMimeType, stHttpsBytesFromClient=stHttpsBytesFromClient, kCompanyName=kCompanyName, stHandleConnectToServer=stHandleConnectToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, kMicroVersion=kMicroVersion, stCategoriesTable=stCategoriesTable, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifySeverity=notifySeverity, stHttpBytesToClient=stHttpBytesToClient, kMajorVersion=kMajorVersion, stClientCount=stClientCount, notifyReasonString=notifyReasonString, mwgStatistics=mwgStatistics, stConnectionsBlocked=stConnectionsBlocked, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesEntry=stCategoriesEntry, notifyOriginName=notifyOriginName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgHttps=mwgHttps, stCategoryName=stCategoryName, mwgMiscellaneous=mwgMiscellaneous, kRevision=kRevision, stHttpBytesFromServer=stHttpBytesFromServer, notifyOrigin=notifyOrigin, stResolveHostViaDNS=stResolveHostViaDNS, mwgInfo=mwgInfo, stHttpTraffic=stHttpTraffic, kBuildNumber=kBuildNumber, stHttpsBytesToServer=stHttpsBytesToServer, notifyAdditional=notifyAdditional, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, trUser=trUser, kProductVersion=kProductVersion, notifyReason=notifyReason, stHttpsTraffic=stHttpsTraffic)
