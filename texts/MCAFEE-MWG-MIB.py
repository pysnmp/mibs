...
mib_2, ObjectIdentity, Unsigned32, Counter64, NotificationType, TimeTicks, Gauge32, enterprises, MibIdentifier, Integer32, IpAddress, iso, ModuleIdentity, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "ObjectIdentity", "Unsigned32", "Counter64", "NotificationType", "TimeTicks", "Gauge32", "enterprises", "MibIdentifier", "Integer32", "IpAddress", "iso", "ModuleIdentity", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPULoadRaw=stCPULoadRaw, kCompanyName=kCompanyName, mwgEngineVersions=mwgEngineVersions, mwgContent=mwgContent, stCategoriesEntry=stCategoriesEntry, stFtpTraffic=stFtpTraffic, stHttpsRequests=stHttpsRequests, stBlockedByURLFilter=stBlockedByURLFilter, stCategoryCount=stCategoryCount, stBadReputation=stBadReputation, mwgTraps=mwgTraps, stConnectedSockets=stConnectedSockets, stTimeForTransaction=stTimeForTransaction, mwgHttp=mwgHttp, stCPULoad=stCPULoad, stFtpBytesFromServer=stFtpBytesFromServer, mwgHttps=mwgHttps, stFtpBytesToServer=stFtpBytesToServer, pMFEEngineVersion=pMFEEngineVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, PYSNMP_MODULE_ID=mwg, pAMEngineVersion=pAMEngineVersion, stFtpBytesFromClient=stFtpBytesFromClient, kBuildNumber=kBuildNumber, notifySeverity=notifySeverity, stCategoryName=stCategoryName, pTSDBVersion=pTSDBVersion, stMalwareDetected=stMalwareDetected, trSystem=trSystem, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesFromServer=stHttpsBytesFromServer, stMemConsumed=stMemConsumed, kMinorVersion=kMinorVersion, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesFromServer=stHttpBytesFromServer, mwgStatistics=mwgStatistics, kRevision=kRevision, pAMProactiveVersion=pAMProactiveVersion, trUser=trUser, pMFEDATVersion=pMFEDATVersion, stCPUIOWait=stCPUIOWait, stHttpsBytesToClient=stHttpsBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgFTP=mwgFTP, stBlockedByMediaFilter=stBlockedByMediaFilter, stMimeType=stMimeType, mwg=mwg, stConnectionsLegitimate=stConnectionsLegitimate, notifyOrigin=notifyOrigin, stConnectionsBlocked=stConnectionsBlocked, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpTraffic=stHttpTraffic, stClientCount=stClientCount, stCategoriesTable=stCategoriesTable, kCustomVersion=kCustomVersion, pAMSignatureVersion=pAMSignatureVersion, notifyAffectedHost=notifyAffectedHost, mwgTrapVariables=mwgTrapVariables, stHttpsTraffic=stHttpsTraffic, stHttpBytesFromClient=stHttpBytesFromClient, stHttpBytesToClient=stHttpBytesToClient, mwgInfo=mwgInfo, stCategories=stCategories, kMajorVersion=kMajorVersion, notifyReasonString=notifyReasonString, notifyOriginName=notifyOriginName, trApplication=trApplication, stBlockedByAntiMalware=stBlockedByAntiMalware, kMicroVersion=kMicroVersion, stHttpsBytesToServer=stHttpsBytesToServer, notifyReason=notifyReason, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyAdditional=notifyAdditional, stFtpBytesToClient=stFtpBytesToClient, kProductName=kProductName, kHotfixVersion=kHotfixVersion, kProductVersion=kProductVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesToServer=stHttpBytesToServer, stHttpRequests=stHttpRequests)
