...
Integer32, NotificationType, Unsigned32, NotificationType, ModuleIdentity, MibIdentifier, Counter64, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, enterprises, Gauge32, Bits, ObjectIdentity, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Unsigned32", "NotificationType", "ModuleIdentity", "MibIdentifier", "Counter64", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "enterprises", "Gauge32", "Bits", "ObjectIdentity", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgHttps=mwgHttps, trUser=trUser, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCPULoadRaw=stCPULoadRaw, notifyReason=notifyReason, stBadReputation=stBadReputation, stCPUIOWait=stCPUIOWait, mwg=mwg, PYSNMP_MODULE_ID=mwg, stHttpBytesFromServer=stHttpBytesFromServer, kMicroVersion=kMicroVersion, mwgHttp=mwgHttp, stCategoriesTable=stCategoriesTable, stCategoryCount=stCategoryCount, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pMFEDATVersion=pMFEDATVersion, stFtpBytesFromServer=stFtpBytesFromServer, stTimeForTransaction=stTimeForTransaction, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgStatistics=mwgStatistics, stConnectionsLegitimate=stConnectionsLegitimate, kHotfixVersion=kHotfixVersion, notifySeverity=notifySeverity, stConnectedSockets=stConnectedSockets, stHttpsBytesToServer=stHttpsBytesToServer, kCustomVersion=kCustomVersion, stHttpsTraffic=stHttpsTraffic, notifyOrigin=notifyOrigin, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgMiscellaneous=mwgMiscellaneous, stMimeType=stMimeType, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesToServer=stFtpBytesToServer, pAMProactiveVersion=pAMProactiveVersion, notifyOriginName=notifyOriginName, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyReasonString=notifyReasonString, stFtpBytesToClient=stFtpBytesToClient, mwgEngineVersions=mwgEngineVersions, stHttpBytesFromClient=stHttpBytesFromClient, mwgContent=mwgContent, stClientCount=stClientCount, stConnectionsBlocked=stConnectionsBlocked, stHandleConnectToServer=stHandleConnectToServer, mwgTrapVariables=mwgTrapVariables, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pAMEngineVersion=pAMEngineVersion, stHttpTraffic=stHttpTraffic, stCPULoad=stCPULoad, stHttpBytesToServer=stHttpBytesToServer, stMalwareDetected=stMalwareDetected, kProductVersion=kProductVersion, stHttpBytesToClient=stHttpBytesToClient, stCategoriesEntry=stCategoriesEntry, stHttpRequests=stHttpRequests, kMajorVersion=kMajorVersion, mwgTraps=mwgTraps, notifyAffectedHost=notifyAffectedHost, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kBuildNumber=kBuildNumber, stResolveHostViaDNS=stResolveHostViaDNS, stMemConsumed=stMemConsumed, trApplication=trApplication, stCategories=stCategories, trSystem=trSystem, mwgFTP=mwgFTP, stHttpsRequests=stHttpsRequests, notifyAdditional=notifyAdditional, kRevision=kRevision, stFtpBytesFromClient=stFtpBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, kMinorVersion=kMinorVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMSignatureVersion=pAMSignatureVersion, kCompanyName=kCompanyName, stHttpsBytesFromServer=stHttpsBytesFromServer, kProductName=kProductName, pTSDBVersion=pTSDBVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpTraffic=stFtpTraffic, stCategoryName=stCategoryName, stHttpsBytesToClient=stHttpsBytesToClient, mwgInfo=mwgInfo)
