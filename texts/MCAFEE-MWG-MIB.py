...
enterprises, MibIdentifier, iso, Counter64, Gauge32, Unsigned32, NotificationType, NotificationType, mib_2, Counter32, TimeTicks, Bits, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "iso", "Counter64", "Gauge32", "Unsigned32", "NotificationType", "NotificationType", "mib-2", "Counter32", "TimeTicks", "Bits", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgContent=mwgContent, kMajorVersion=kMajorVersion, stClientCount=stClientCount, notifyOrigin=notifyOrigin, stMimeType=stMimeType, stMemConsumed=stMemConsumed, mwgStatistics=mwgStatistics, kMicroVersion=kMicroVersion, stHttpBytesToClient=stHttpBytesToClient, kCustomVersion=kCustomVersion, trSystem=trSystem, mwgEngineVersions=mwgEngineVersions, stCPULoad=stCPULoad, stBlockedByMediaFilter=stBlockedByMediaFilter, mwg=mwg, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, trApplication=trApplication, stHttpsBytesToServer=stHttpsBytesToServer, PYSNMP_MODULE_ID=mwg, stHttpsBytesToClient=stHttpsBytesToClient, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesFromServer=stHttpBytesFromServer, stFtpTraffic=stFtpTraffic, stFtpBytesFromClient=stFtpBytesFromClient, stConnectedSockets=stConnectedSockets, stCategoriesEntry=stCategoriesEntry, mwgFTP=mwgFTP, notifyOriginName=notifyOriginName, mwgHttp=mwgHttp, stBlockedByURLFilter=stBlockedByURLFilter, stBlockedByAntiMalware=stBlockedByAntiMalware, stResolveHostViaDNS=stResolveHostViaDNS, mwgTrapVariables=mwgTrapVariables, kMinorVersion=kMinorVersion, pMFEDATVersion=pMFEDATVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsTraffic=stHttpsTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgHttps=mwgHttps, kBuildNumber=kBuildNumber, pTSDBVersion=pTSDBVersion, kRevision=kRevision, stTimeForTransaction=stTimeForTransaction, stFtpBytesToClient=stFtpBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMEngineVersion=pAMEngineVersion, kProductName=kProductName, notifyAffectedHost=notifyAffectedHost, notifyAdditional=notifyAdditional, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoryCount=stCategoryCount, stCPUIOWait=stCPUIOWait, stFtpBytesToServer=stFtpBytesToServer, stCategoriesTable=stCategoriesTable, stCategories=stCategories, stBadReputation=stBadReputation, mwgInfo=mwgInfo, stCPULoadRaw=stCPULoadRaw, stMalwareDetected=stMalwareDetected, stHttpsRequests=stHttpsRequests, stConnectionsBlocked=stConnectionsBlocked, kHotfixVersion=kHotfixVersion, notifyReasonString=notifyReasonString, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoryName=stCategoryName, stFtpBytesFromServer=stFtpBytesFromServer, pAMProactiveVersion=pAMProactiveVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, trUser=trUser, kCompanyName=kCompanyName, kProductVersion=kProductVersion, mwgTraps=mwgTraps, mwgMiscellaneous=mwgMiscellaneous, notifySeverity=notifySeverity, notifyReason=notifyReason, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHandleConnectToServer=stHandleConnectToServer, stHttpRequests=stHttpRequests, stHttpTraffic=stHttpTraffic, pMFEEngineVersion=pMFEEngineVersion)
