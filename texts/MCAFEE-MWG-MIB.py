...
Unsigned32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, ModuleIdentity, Counter64, MibIdentifier, Integer32, enterprises, Counter32, TimeTicks, iso, ObjectIdentity, NotificationType, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "ModuleIdentity", "Counter64", "MibIdentifier", "Integer32", "enterprises", "Counter32", "TimeTicks", "iso", "ObjectIdentity", "NotificationType", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, pMFEEngineVersion=pMFEEngineVersion, kMinorVersion=kMinorVersion, stCategoriesTable=stCategoriesTable, notifySeverity=notifySeverity, stHttpsRequests=stHttpsRequests, mwgStatistics=mwgStatistics, mwg=mwg, mwgHttp=mwgHttp, kCompanyName=kCompanyName, stHttpBytesFromClient=stHttpBytesFromClient, stClientCount=stClientCount, stCategoryName=stCategoryName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgMiscellaneous=mwgMiscellaneous, stCategoriesEntry=stCategoriesEntry, pMFEDATVersion=pMFEDATVersion, notifyReasonString=notifyReasonString, mwgHttps=mwgHttps, stFtpBytesFromClient=stFtpBytesFromClient, stMemConsumed=stMemConsumed, stConnectionsLegitimate=stConnectionsLegitimate, notifyOriginName=notifyOriginName, kProductVersion=kProductVersion, stFtpTraffic=stFtpTraffic, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, trSystem=trSystem, stHttpBytesToClient=stHttpBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pTSDBVersion=pTSDBVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgContent=mwgContent, stCategoryCount=stCategoryCount, stHttpBytesToServer=stHttpBytesToServer, notifyReason=notifyReason, kCustomVersion=kCustomVersion, mwgInfo=mwgInfo, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyAffectedHost=notifyAffectedHost, stHttpsTraffic=stHttpsTraffic, stCPUIOWait=stCPUIOWait, stConnectionsBlocked=stConnectionsBlocked, stHandleConnectToServer=stHandleConnectToServer, trApplication=trApplication, stHttpRequests=stHttpRequests, mwgFTP=mwgFTP, kRevision=kRevision, pAMProactiveVersion=pAMProactiveVersion, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByURLFilter=stBlockedByURLFilter, pAMEngineVersion=pAMEngineVersion, mwgEngineVersions=mwgEngineVersions, kMajorVersion=kMajorVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, notifyAdditional=notifyAdditional, mwgTrapVariables=mwgTrapVariables, stCPULoad=stCPULoad, trUser=trUser, stHttpTraffic=stHttpTraffic, kHotfixVersion=kHotfixVersion, stBadReputation=stBadReputation, stBlockedByMediaFilter=stBlockedByMediaFilter, stTimeForTransaction=stTimeForTransaction, stBlockedByAntiMalware=stBlockedByAntiMalware, PYSNMP_MODULE_ID=mwg, stMimeType=stMimeType, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMicroVersion=kMicroVersion, stHttpsBytesToServer=stHttpsBytesToServer, stConnectedSockets=stConnectedSockets, stFtpBytesToClient=stFtpBytesToClient, kProductName=kProductName, kBuildNumber=kBuildNumber, stHttpBytesFromServer=stHttpBytesFromServer, mwgTraps=mwgTraps, stCPULoadRaw=stCPULoadRaw, stFtpBytesToServer=stFtpBytesToServer, notifyOrigin=notifyOrigin, stFtpBytesFromServer=stFtpBytesFromServer, stCategories=stCategories, stMalwareDetected=stMalwareDetected)
