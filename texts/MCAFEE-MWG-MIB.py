...
MibIdentifier, NotificationType, mib_2, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, Integer32, iso, Gauge32, enterprises, Bits, Counter64, TimeTicks, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "mib-2", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "Integer32", "iso", "Gauge32", "enterprises", "Bits", "Counter64", "TimeTicks", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgTrapVariables=mwgTrapVariables, mwgTraps=mwgTraps, mwgEngineVersions=mwgEngineVersions, kMajorVersion=kMajorVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kBuildNumber=kBuildNumber, stHttpsBytesFromServer=stHttpsBytesFromServer, stClientCount=stClientCount, mwgStatistics=mwgStatistics, stHttpsTraffic=stHttpsTraffic, mwg=mwg, trSystem=trSystem, pAMSignatureVersion=pAMSignatureVersion, stCategories=stCategories, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyAffectedHost=notifyAffectedHost, notifyOrigin=notifyOrigin, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoryName=stCategoryName, mwgFTP=mwgFTP, stFtpBytesFromClient=stFtpBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesToClient=stHttpBytesToClient, notifyReason=notifyReason, stFtpBytesFromServer=stFtpBytesFromServer, kCustomVersion=kCustomVersion, stMalwareDetected=stMalwareDetected, notifySeverity=notifySeverity, mwgHttp=mwgHttp, kMicroVersion=kMicroVersion, stConnectedSockets=stConnectedSockets, pMFEEngineVersion=pMFEEngineVersion, stResolveHostViaDNS=stResolveHostViaDNS, stTimeForTransaction=stTimeForTransaction, stFtpTraffic=stFtpTraffic, stHandleConnectToServer=stHandleConnectToServer, pAMEngineVersion=pAMEngineVersion, PYSNMP_MODULE_ID=mwg, stConnectionsLegitimate=stConnectionsLegitimate, mwgMiscellaneous=mwgMiscellaneous, kRevision=kRevision, stCategoriesTable=stCategoriesTable, stBadReputation=stBadReputation, stHttpBytesFromClient=stHttpBytesFromClient, stCPULoad=stCPULoad, mwgHttps=mwgHttps, stConnectionsBlocked=stConnectionsBlocked, stBlockedByURLFilter=stBlockedByURLFilter, mwgContent=mwgContent, stHttpsBytesToClient=stHttpsBytesToClient, trApplication=trApplication, pTSDBVersion=pTSDBVersion, notifyReasonString=notifyReasonString, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyOriginName=notifyOriginName, stMemConsumed=stMemConsumed, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsRequests=stHttpsRequests, pMFEDATVersion=pMFEDATVersion, stFtpBytesToServer=stFtpBytesToServer, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, trUser=trUser, kCompanyName=kCompanyName, stHttpBytesToServer=stHttpBytesToServer, stCategoryCount=stCategoryCount, kProductVersion=kProductVersion, mwgInfo=mwgInfo, stCategoriesEntry=stCategoriesEntry, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pAMProactiveVersion=pAMProactiveVersion, kMinorVersion=kMinorVersion, stHttpTraffic=stHttpTraffic, stCPULoadRaw=stCPULoadRaw, stHttpRequests=stHttpRequests, notifyAdditional=notifyAdditional, kProductName=kProductName, stCPUIOWait=stCPUIOWait, stMimeType=stMimeType, kHotfixVersion=kHotfixVersion)
