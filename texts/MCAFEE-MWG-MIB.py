...
Integer32, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, enterprises, Unsigned32, NotificationType, TimeTicks, ModuleIdentity, Bits, Counter32, iso, mib_2, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "enterprises", "Unsigned32", "NotificationType", "TimeTicks", "ModuleIdentity", "Bits", "Counter32", "iso", "mib-2", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesToClient=stHttpBytesToClient, stCategoriesEntry=stCategoriesEntry, trApplication=trApplication, stCPULoadRaw=stCPULoadRaw, pMFEEngineVersion=pMFEEngineVersion, stCPUIOWait=stCPUIOWait, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMemConsumed=stMemConsumed, kCustomVersion=kCustomVersion, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesToClient=stFtpBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpRequests=stHttpRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgInfo=mwgInfo, stHttpsRequests=stHttpsRequests, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgTraps=mwgTraps, mwgMiscellaneous=mwgMiscellaneous, mwgTrapVariables=mwgTrapVariables, stResolveHostViaDNS=stResolveHostViaDNS, trUser=trUser, notifyOriginName=notifyOriginName, pAMProactiveVersion=pAMProactiveVersion, notifyReason=notifyReason, pAMSignatureVersion=pAMSignatureVersion, stFtpTraffic=stFtpTraffic, mwgStatistics=mwgStatistics, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pTSDBVersion=pTSDBVersion, stBadReputation=stBadReputation, stHandleConnectToServer=stHandleConnectToServer, kMinorVersion=kMinorVersion, stCPULoad=stCPULoad, notifyAdditional=notifyAdditional, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoryCount=stCategoryCount, stHttpBytesFromServer=stHttpBytesFromServer, stCategories=stCategories, mwgEngineVersions=mwgEngineVersions, mwgFTP=mwgFTP, stFtpBytesFromClient=stFtpBytesFromClient, mwgHttps=mwgHttps, mwgContent=mwgContent, stTimeForTransaction=stTimeForTransaction, kProductVersion=kProductVersion, notifyReasonString=notifyReasonString, stClientCount=stClientCount, stFtpBytesToServer=stFtpBytesToServer, stConnectionsLegitimate=stConnectionsLegitimate, notifyAffectedHost=notifyAffectedHost, pMFEDATVersion=pMFEDATVersion, notifySeverity=notifySeverity, kCompanyName=kCompanyName, stHttpBytesFromClient=stHttpBytesFromClient, stCategoriesTable=stCategoriesTable, pAMEngineVersion=pAMEngineVersion, stFtpBytesFromServer=stFtpBytesFromServer, stConnectedSockets=stConnectedSockets, stHttpTraffic=stHttpTraffic, kRevision=kRevision, kHotfixVersion=kHotfixVersion, stMalwareDetected=stMalwareDetected, stBlockedByURLFilter=stBlockedByURLFilter, trSystem=trSystem, notifyOrigin=notifyOrigin, kMajorVersion=kMajorVersion, mwgHttp=mwgHttp, kBuildNumber=kBuildNumber, stCategoryName=stCategoryName, mwg=mwg, stHttpsTraffic=stHttpsTraffic, kProductName=kProductName, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMicroVersion=kMicroVersion, stHttpsBytesToServer=stHttpsBytesToServer, stMimeType=stMimeType, stHttpBytesToServer=stHttpBytesToServer, PYSNMP_MODULE_ID=mwg, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer)
