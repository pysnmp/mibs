...
NotificationType, Bits, TimeTicks, IpAddress, MibIdentifier, ObjectIdentity, Unsigned32, ModuleIdentity, Integer32, Gauge32, NotificationType, enterprises, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "TimeTicks", "IpAddress", "MibIdentifier", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Integer32", "Gauge32", "NotificationType", "enterprises", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesFromClient=stFtpBytesFromClient, notifyReason=notifyReason, stConnectionsLegitimate=stConnectionsLegitimate, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMajorVersion=kMajorVersion, stHttpBytesToClient=stHttpBytesToClient, stCPULoadRaw=stCPULoadRaw, mwgHttps=mwgHttps, pAMProactiveVersion=pAMProactiveVersion, mwgStatistics=mwgStatistics, stHttpsTraffic=stHttpsTraffic, stHttpBytesFromServer=stHttpBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pMFEDATVersion=pMFEDATVersion, kProductVersion=kProductVersion, stCategoryCount=stCategoryCount, mwgInfo=mwgInfo, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, stMalwareDetected=stMalwareDetected, stMimeType=stMimeType, notifyReasonString=notifyReasonString, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, trUser=trUser, kCompanyName=kCompanyName, stMemConsumed=stMemConsumed, mwgEngineVersions=mwgEngineVersions, stConnectionsBlocked=stConnectionsBlocked, stHttpTraffic=stHttpTraffic, PYSNMP_MODULE_ID=mwg, mwgTraps=mwgTraps, notifySeverity=notifySeverity, stHandleConnectToServer=stHandleConnectToServer, pTSDBVersion=pTSDBVersion, kHotfixVersion=kHotfixVersion, stTimeForTransaction=stTimeForTransaction, stConnectedSockets=stConnectedSockets, stCategories=stCategories, stCategoriesEntry=stCategoriesEntry, kCustomVersion=kCustomVersion, notifyAdditional=notifyAdditional, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesToServer=stHttpBytesToServer, trApplication=trApplication, stFtpTraffic=stFtpTraffic, stHttpsRequests=stHttpsRequests, stCategoriesTable=stCategoriesTable, trSystem=trSystem, stBlockedByURLFilter=stBlockedByURLFilter, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stResolveHostViaDNS=stResolveHostViaDNS, stClientCount=stClientCount, stCPUIOWait=stCPUIOWait, stCategoryName=stCategoryName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBadReputation=stBadReputation, stCPULoad=stCPULoad, mwgMiscellaneous=mwgMiscellaneous, mwgContent=mwgContent, stHttpRequests=stHttpRequests, kMinorVersion=kMinorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgHttp=mwgHttp, mwgFTP=mwgFTP, notifyAffectedHost=notifyAffectedHost, kBuildNumber=kBuildNumber, stFtpBytesFromServer=stFtpBytesFromServer, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, notifyOrigin=notifyOrigin, stHttpsBytesFromClient=stHttpsBytesFromClient, kRevision=kRevision, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pAMEngineVersion=pAMEngineVersion, mwg=mwg, mwgTrapVariables=mwgTrapVariables, notifyOriginName=notifyOriginName, kMicroVersion=kMicroVersion, kProductName=kProductName)
