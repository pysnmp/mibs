...
Gauge32, NotificationType, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, IpAddress, Counter32, mib_2, Unsigned32, Counter64, iso, MibIdentifier, enterprises, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "IpAddress", "Counter32", "mib-2", "Unsigned32", "Counter64", "iso", "MibIdentifier", "enterprises", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBadReputation=stBadReputation, mwgHttps=mwgHttps, trApplication=trApplication, stCPULoadRaw=stCPULoadRaw, stFtpBytesFromClient=stFtpBytesFromClient, kHotfixVersion=kHotfixVersion, mwg=mwg, stTimeForTransaction=stTimeForTransaction, kProductVersion=kProductVersion, notifyOrigin=notifyOrigin, stHttpsBytesFromClient=stHttpsBytesFromClient, stMimeType=stMimeType, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, PYSNMP_MODULE_ID=mwg, stCategoriesTable=stCategoriesTable, stHttpRequests=stHttpRequests, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMEngineVersion=pAMEngineVersion, pAMProactiveVersion=pAMProactiveVersion, kBuildNumber=kBuildNumber, stHandleConnectToServer=stHandleConnectToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kProductName=kProductName, kMajorVersion=kMajorVersion, stCPUIOWait=stCPUIOWait, mwgTraps=mwgTraps, mwgMiscellaneous=mwgMiscellaneous, stFtpTraffic=stFtpTraffic, stFtpBytesFromServer=stFtpBytesFromServer, stHttpTraffic=stHttpTraffic, stCategoryName=stCategoryName, stCPULoad=stCPULoad, stConnectionsLegitimate=stConnectionsLegitimate, stCategoryCount=stCategoryCount, notifyAffectedHost=notifyAffectedHost, notifyReason=notifyReason, stHttpBytesFromClient=stHttpBytesFromClient, mwgContent=mwgContent, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyAdditional=notifyAdditional, trSystem=trSystem, mwgHttp=mwgHttp, kRevision=kRevision, mwgInfo=mwgInfo, mwgStatistics=mwgStatistics, notifySeverity=notifySeverity, stMemConsumed=stMemConsumed, kCompanyName=kCompanyName, stHttpsBytesToClient=stHttpsBytesToClient, stMalwareDetected=stMalwareDetected, stBlockedByMediaFilter=stBlockedByMediaFilter, kMinorVersion=kMinorVersion, mwgFTP=mwgFTP, stBlockedByURLFilter=stBlockedByURLFilter, stConnectedSockets=stConnectedSockets, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, pMFEDATVersion=pMFEDATVersion, kMicroVersion=kMicroVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stResolveHostViaDNS=stResolveHostViaDNS, stCategories=stCategories, kCustomVersion=kCustomVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, stConnectionsBlocked=stConnectionsBlocked, trUser=trUser, notifyOriginName=notifyOriginName, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsRequests=stHttpsRequests, mwgEngineVersions=mwgEngineVersions, stHttpBytesToClient=stHttpBytesToClient, pTSDBVersion=pTSDBVersion, mwgTrapVariables=mwgTrapVariables, pAMSignatureVersion=pAMSignatureVersion, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesToServer=stHttpsBytesToServer, stClientCount=stClientCount, notifyReasonString=notifyReasonString, stHttpsTraffic=stHttpsTraffic)
