...
mib_2, Counter32, NotificationType, iso, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, NotificationType, IpAddress, Unsigned32, Counter64, ObjectIdentity, TimeTicks, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Counter32", "NotificationType", "iso", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "NotificationType", "IpAddress", "Unsigned32", "Counter64", "ObjectIdentity", "TimeTicks", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesFromClient=stHttpsBytesFromClient, kHotfixVersion=kHotfixVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoadRaw=stCPULoadRaw, stTimeForTransaction=stTimeForTransaction, pMFEDATVersion=pMFEDATVersion, stFtpTraffic=stFtpTraffic, pMFEEngineVersion=pMFEEngineVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMalwareDetected=stMalwareDetected, notifyAdditional=notifyAdditional, pTSDBVersion=pTSDBVersion, notifyOriginName=notifyOriginName, stHttpBytesFromClient=stHttpBytesFromClient, trUser=trUser, mwgInfo=mwgInfo, stHttpBytesToServer=stHttpBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyReason=notifyReason, stClientCount=stClientCount, notifyReasonString=notifyReasonString, kMajorVersion=kMajorVersion, kMicroVersion=kMicroVersion, stBlockedByURLFilter=stBlockedByURLFilter, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgMiscellaneous=mwgMiscellaneous, stBlockedByAntiMalware=stBlockedByAntiMalware, kMinorVersion=kMinorVersion, stFtpBytesFromServer=stFtpBytesFromServer, stCPUIOWait=stCPUIOWait, stFtpBytesToClient=stFtpBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsTraffic=stHttpsTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trSystem=trSystem, stHandleConnectToServer=stHandleConnectToServer, mwgTrapVariables=mwgTrapVariables, mwgHttps=mwgHttps, stHttpBytesToClient=stHttpBytesToClient, stCategoriesEntry=stCategoriesEntry, stFtpBytesFromClient=stFtpBytesFromClient, notifyOrigin=notifyOrigin, mwgHttp=mwgHttp, kRevision=kRevision, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesToClient=stHttpsBytesToClient, pAMSignatureVersion=pAMSignatureVersion, stCPULoad=stCPULoad, stCategoryCount=stCategoryCount, mwgStatistics=mwgStatistics, mwgEngineVersions=mwgEngineVersions, kCompanyName=kCompanyName, notifySeverity=notifySeverity, pAMProactiveVersion=pAMProactiveVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBadReputation=stBadReputation, kCustomVersion=kCustomVersion, kProductVersion=kProductVersion, PYSNMP_MODULE_ID=mwg, stHttpsRequests=stHttpsRequests, mwg=mwg, stConnectedSockets=stConnectedSockets, stMimeType=stMimeType, stHttpRequests=stHttpRequests, stHttpBytesFromServer=stHttpBytesFromServer, mwgTraps=mwgTraps, stFtpBytesToServer=stFtpBytesToServer, stCategoriesTable=stCategoriesTable, kBuildNumber=kBuildNumber, mwgContent=mwgContent, pAMEngineVersion=pAMEngineVersion, mwgFTP=mwgFTP, kProductName=kProductName, trApplication=trApplication, stConnectionsBlocked=stConnectionsBlocked, stCategoryName=stCategoryName, stHttpTraffic=stHttpTraffic, notifyAffectedHost=notifyAffectedHost, stHttpsBytesToServer=stHttpsBytesToServer, stConnectionsLegitimate=stConnectionsLegitimate, stCategories=stCategories, stMemConsumed=stMemConsumed)
