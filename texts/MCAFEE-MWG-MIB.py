...
NotificationType, Bits, NotificationType, Integer32, ModuleIdentity, Counter64, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, MibIdentifier, ObjectIdentity, mib_2, enterprises, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "NotificationType", "Integer32", "ModuleIdentity", "Counter64", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "MibIdentifier", "ObjectIdentity", "mib-2", "enterprises", "Counter32", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesFromClient=stFtpBytesFromClient, mwgTraps=mwgTraps, notifyOrigin=notifyOrigin, notifySeverity=notifySeverity, kCompanyName=kCompanyName, kMicroVersion=kMicroVersion, stHttpRequests=stHttpRequests, kCustomVersion=kCustomVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, mwgFTP=mwgFTP, stHttpsRequests=stHttpsRequests, stConnectedSockets=stConnectedSockets, stClientCount=stClientCount, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHandleConnectToServer=stHandleConnectToServer, stMimeType=stMimeType, stCPUIOWait=stCPUIOWait, stResolveHostViaDNS=stResolveHostViaDNS, pMFEEngineVersion=pMFEEngineVersion, mwg=mwg, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trSystem=trSystem, pMFEDATVersion=pMFEDATVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesToClient=stFtpBytesToClient, mwgTrapVariables=mwgTrapVariables, kMajorVersion=kMajorVersion, stCategoriesTable=stCategoriesTable, kProductVersion=kProductVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpTraffic=stFtpTraffic, stHttpBytesToServer=stHttpBytesToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, pAMSignatureVersion=pAMSignatureVersion, stMalwareDetected=stMalwareDetected, notifyOriginName=notifyOriginName, stBadReputation=stBadReputation, stTimeForTransaction=stTimeForTransaction, kBuildNumber=kBuildNumber, mwgMiscellaneous=mwgMiscellaneous, PYSNMP_MODULE_ID=mwg, stCPULoadRaw=stCPULoadRaw, kRevision=kRevision, mwgContent=mwgContent, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pAMProactiveVersion=pAMProactiveVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyReason=notifyReason, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCPULoad=stCPULoad, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, notifyReasonString=notifyReasonString, kHotfixVersion=kHotfixVersion, mwgHttp=mwgHttp, stFtpBytesToServer=stFtpBytesToServer, stCategoryName=stCategoryName, stCategoriesEntry=stCategoriesEntry, mwgEngineVersions=mwgEngineVersions, stCategoryCount=stCategoryCount, stConnectionsLegitimate=stConnectionsLegitimate, pTSDBVersion=pTSDBVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectionsBlocked=stConnectionsBlocked, kProductName=kProductName, stBlockedByURLFilter=stBlockedByURLFilter, mwgHttps=mwgHttps, trApplication=trApplication, pAMEngineVersion=pAMEngineVersion, stHttpsBytesToClient=stHttpsBytesToClient, notifyAffectedHost=notifyAffectedHost, notifyAdditional=notifyAdditional, trUser=trUser, stHttpTraffic=stHttpTraffic, mwgStatistics=mwgStatistics, kMinorVersion=kMinorVersion, stMemConsumed=stMemConsumed, mwgInfo=mwgInfo, stCategories=stCategories, stHttpsTraffic=stHttpsTraffic, stFtpBytesFromServer=stFtpBytesFromServer)
