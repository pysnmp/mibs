...
Unsigned32, IpAddress, Counter32, Counter64, Bits, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, NotificationType, Gauge32, ObjectIdentity, ModuleIdentity, MibIdentifier, Integer32, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "Counter32", "Counter64", "Bits", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "NotificationType", "Gauge32", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "Integer32", "enterprises", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesFromServer=stFtpBytesFromServer, stTimeForTransaction=stTimeForTransaction, pMFEEngineVersion=pMFEEngineVersion, pAMProactiveVersion=pAMProactiveVersion, pTSDBVersion=pTSDBVersion, stMalwareDetected=stMalwareDetected, kCustomVersion=kCustomVersion, trSystem=trSystem, trApplication=trApplication, notifySeverity=notifySeverity, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoriesTable=stCategoriesTable, kProductVersion=kProductVersion, kMinorVersion=kMinorVersion, kMicroVersion=kMicroVersion, notifyAffectedHost=notifyAffectedHost, stCPUIOWait=stCPUIOWait, stCategoriesEntry=stCategoriesEntry, notifyReasonString=notifyReasonString, mwgStatistics=mwgStatistics, mwgFTP=mwgFTP, stCategoryCount=stCategoryCount, stCPULoad=stCPULoad, stFtpBytesFromClient=stFtpBytesFromClient, kCompanyName=kCompanyName, mwgContent=mwgContent, notifyOriginName=notifyOriginName, notifyOrigin=notifyOrigin, stHttpsRequests=stHttpsRequests, pAMEngineVersion=pAMEngineVersion, stFtpTraffic=stFtpTraffic, stCategoryName=stCategoryName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMemConsumed=stMemConsumed, kBuildNumber=kBuildNumber, stHttpsTraffic=stHttpsTraffic, stCPULoadRaw=stCPULoadRaw, notifyAdditional=notifyAdditional, stClientCount=stClientCount, stHttpBytesToServer=stHttpBytesToServer, stConnectedSockets=stConnectedSockets, stHttpsBytesFromServer=stHttpsBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesToClient=stHttpsBytesToClient, stCategories=stCategories, stBadReputation=stBadReputation, kRevision=kRevision, mwgEngineVersions=mwgEngineVersions, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesToServer=stFtpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesFromClient=stHttpBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesToClient=stHttpBytesToClient, kHotfixVersion=kHotfixVersion, stBlockedByURLFilter=stBlockedByURLFilter, mwgInfo=mwgInfo, stConnectionsLegitimate=stConnectionsLegitimate, mwgHttps=mwgHttps, stConnectionsBlocked=stConnectionsBlocked, notifyReason=notifyReason, stFtpBytesToClient=stFtpBytesToClient, pMFEDATVersion=pMFEDATVersion, stHandleConnectToServer=stHandleConnectToServer, PYSNMP_MODULE_ID=mwg, stHttpRequests=stHttpRequests, stHttpTraffic=stHttpTraffic, trUser=trUser, mwgTrapVariables=mwgTrapVariables, pAMSignatureVersion=pAMSignatureVersion, mwgHttp=mwgHttp, stResolveHostViaDNS=stResolveHostViaDNS, kMajorVersion=kMajorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwg=mwg, stMimeType=stMimeType, stHttpsBytesToServer=stHttpsBytesToServer, kProductName=kProductName, mwgTraps=mwgTraps, stHttpBytesFromServer=stHttpBytesFromServer)
