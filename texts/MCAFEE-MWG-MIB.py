...
Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, TimeTicks, ModuleIdentity, IpAddress, NotificationType, Bits, NotificationType, Counter32, MibIdentifier, mib_2, ObjectIdentity, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "TimeTicks", "ModuleIdentity", "IpAddress", "NotificationType", "Bits", "NotificationType", "Counter32", "MibIdentifier", "mib-2", "ObjectIdentity", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpBytesFromClient=stFtpBytesFromClient, stMalwareDetected=stMalwareDetected, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pMFEEngineVersion=pMFEEngineVersion, kProductVersion=kProductVersion, kMinorVersion=kMinorVersion, pAMSignatureVersion=pAMSignatureVersion, pTSDBVersion=pTSDBVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyAdditional=notifyAdditional, mwgEngineVersions=mwgEngineVersions, PYSNMP_MODULE_ID=mwg, mwgStatistics=mwgStatistics, kMajorVersion=kMajorVersion, mwgHttp=mwgHttp, stHttpsBytesToServer=stHttpsBytesToServer, notifyOrigin=notifyOrigin, stCPULoad=stCPULoad, stHttpsTraffic=stHttpsTraffic, stCategories=stCategories, trSystem=trSystem, stConnectedSockets=stConnectedSockets, kCustomVersion=kCustomVersion, pMFEDATVersion=pMFEDATVersion, stCPUIOWait=stCPUIOWait, notifySeverity=notifySeverity, stHttpBytesToServer=stHttpBytesToServer, kRevision=kRevision, stHttpTraffic=stHttpTraffic, kMicroVersion=kMicroVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoryName=stCategoryName, stClientCount=stClientCount, kBuildNumber=kBuildNumber, pAMProactiveVersion=pAMProactiveVersion, mwg=mwg, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesToClient=stHttpBytesToClient, stTimeForTransaction=stTimeForTransaction, stFtpTraffic=stFtpTraffic, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByURLFilter=stBlockedByURLFilter, kCompanyName=kCompanyName, stFtpBytesFromServer=stFtpBytesFromServer, stMemConsumed=stMemConsumed, mwgMiscellaneous=mwgMiscellaneous, notifyAffectedHost=notifyAffectedHost, stBadReputation=stBadReputation, stHttpsRequests=stHttpsRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgInfo=mwgInfo, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesFromServer=stHttpBytesFromServer, pAMEngineVersion=pAMEngineVersion, mwgTrapVariables=mwgTrapVariables, kHotfixVersion=kHotfixVersion, mwgContent=mwgContent, notifyOriginName=notifyOriginName, notifyReasonString=notifyReasonString, mwgHttps=mwgHttps, mwgFTP=mwgFTP, stConnectionsBlocked=stConnectionsBlocked, stMimeType=stMimeType, stHttpBytesFromClient=stHttpBytesFromClient, stCategoriesTable=stCategoriesTable, stHttpsBytesToClient=stHttpsBytesToClient, stHttpRequests=stHttpRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgTraps=mwgTraps, stBlockedByMediaFilter=stBlockedByMediaFilter, kProductName=kProductName, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trApplication=trApplication, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectionsLegitimate=stConnectionsLegitimate, notifyReason=notifyReason, stFtpBytesToClient=stFtpBytesToClient, stCategoryCount=stCategoryCount, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesToServer=stFtpBytesToServer, stCPULoadRaw=stCPULoadRaw, stCategoriesEntry=stCategoriesEntry, trUser=trUser)
