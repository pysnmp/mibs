...
IpAddress, Integer32, iso, TimeTicks, enterprises, Bits, MibIdentifier, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, Gauge32, NotificationType, mib_2, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "iso", "TimeTicks", "enterprises", "Bits", "MibIdentifier", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "Gauge32", "NotificationType", "mib-2", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBadReputation=stBadReputation, stHttpBytesToServer=stHttpBytesToServer, mwgMiscellaneous=mwgMiscellaneous, pMFEEngineVersion=pMFEEngineVersion, mwgHttp=mwgHttp, stMalwareDetected=stMalwareDetected, stHttpsTraffic=stHttpsTraffic, stTimeForTransaction=stTimeForTransaction, trApplication=trApplication, stCPULoad=stCPULoad, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgHttps=mwgHttps, mwg=mwg, stHttpsRequests=stHttpsRequests, stConnectedSockets=stConnectedSockets, stFtpTraffic=stFtpTraffic, notifyAffectedHost=notifyAffectedHost, kBuildNumber=kBuildNumber, stCategoryCount=stCategoryCount, notifyAdditional=notifyAdditional, kMinorVersion=kMinorVersion, stFtpBytesToServer=stFtpBytesToServer, mwgInfo=mwgInfo, mwgContent=mwgContent, stBlockedByURLFilter=stBlockedByURLFilter, stHttpRequests=stHttpRequests, stHttpsBytesFromClient=stHttpsBytesFromClient, kHotfixVersion=kHotfixVersion, kProductName=kProductName, stConnectionsBlocked=stConnectionsBlocked, mwgTraps=mwgTraps, pAMSignatureVersion=pAMSignatureVersion, notifyReason=notifyReason, stLastSentLastReceivedServer=stLastSentLastReceivedServer, trSystem=trSystem, notifySeverity=notifySeverity, kMajorVersion=kMajorVersion, stCategoryName=stCategoryName, kProductVersion=kProductVersion, stCategoriesTable=stCategoriesTable, stCategories=stCategories, kMicroVersion=kMicroVersion, pMFEDATVersion=pMFEDATVersion, stCPULoadRaw=stCPULoadRaw, stBlockedByMediaFilter=stBlockedByMediaFilter, kRevision=kRevision, stConnectionsLegitimate=stConnectionsLegitimate, mwgStatistics=mwgStatistics, stMimeType=stMimeType, stHttpsBytesToServer=stHttpsBytesToServer, pTSDBVersion=pTSDBVersion, notifyOriginName=notifyOriginName, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesToClient=stHttpsBytesToClient, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgFTP=mwgFTP, stHttpBytesFromClient=stHttpBytesFromClient, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesFromServer=stHttpBytesFromServer, notifyOrigin=notifyOrigin, stClientCount=stClientCount, kCustomVersion=kCustomVersion, stFtpBytesFromServer=stFtpBytesFromServer, mwgTrapVariables=mwgTrapVariables, kCompanyName=kCompanyName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpTraffic=stHttpTraffic, stFtpBytesFromClient=stFtpBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMemConsumed=stMemConsumed, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesToClient=stFtpBytesToClient, stCPUIOWait=stCPUIOWait, notifyReasonString=notifyReasonString, trUser=trUser, PYSNMP_MODULE_ID=mwg, mwgEngineVersions=mwgEngineVersions, stCategoriesEntry=stCategoriesEntry, pAMEngineVersion=pAMEngineVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient)
