...
Unsigned32, MibIdentifier, Counter32, IpAddress, Gauge32, ModuleIdentity, Integer32, TimeTicks, NotificationType, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Bits, enterprises, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "Counter32", "IpAddress", "Gauge32", "ModuleIdentity", "Integer32", "TimeTicks", "NotificationType", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Bits", "enterprises", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kCustomVersion=kCustomVersion, mwgMiscellaneous=mwgMiscellaneous, PYSNMP_MODULE_ID=mwg, trApplication=trApplication, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesFromClient=stFtpBytesFromClient, notifyReason=notifyReason, kMajorVersion=kMajorVersion, mwgInfo=mwgInfo, mwgFTP=mwgFTP, kProductVersion=kProductVersion, stMalwareDetected=stMalwareDetected, stHttpBytesFromServer=stHttpBytesFromServer, kHotfixVersion=kHotfixVersion, stCategoriesEntry=stCategoriesEntry, mwgHttp=mwgHttp, notifyOrigin=notifyOrigin, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsTraffic=stHttpsTraffic, stCPUIOWait=stCPUIOWait, kRevision=kRevision, stResolveHostViaDNS=stResolveHostViaDNS, stConnectedSockets=stConnectedSockets, stConnectionsLegitimate=stConnectionsLegitimate, stCategories=stCategories, stCategoryName=stCategoryName, pMFEEngineVersion=pMFEEngineVersion, stCategoriesTable=stCategoriesTable, notifySeverity=notifySeverity, stHttpRequests=stHttpRequests, stHttpBytesToServer=stHttpBytesToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMEngineVersion=pAMEngineVersion, stHttpsRequests=stHttpsRequests, mwgHttps=mwgHttps, mwgContent=mwgContent, pTSDBVersion=pTSDBVersion, stFtpBytesToServer=stFtpBytesToServer, kMinorVersion=kMinorVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesToServer=stHttpsBytesToServer, kCompanyName=kCompanyName, stMemConsumed=stMemConsumed, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesFromServer=stFtpBytesFromServer, pAMProactiveVersion=pAMProactiveVersion, stFtpTraffic=stFtpTraffic, notifyReasonString=notifyReasonString, pAMSignatureVersion=pAMSignatureVersion, kProductName=kProductName, trUser=trUser, notifyAffectedHost=notifyAffectedHost, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgTraps=mwgTraps, stHttpBytesFromClient=stHttpBytesFromClient, kBuildNumber=kBuildNumber, stClientCount=stClientCount, trSystem=trSystem, stMimeType=stMimeType, notifyAdditional=notifyAdditional, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMicroVersion=kMicroVersion, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesToClient=stFtpBytesToClient, stTimeForTransaction=stTimeForTransaction, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesToClient=stHttpsBytesToClient, mwgStatistics=mwgStatistics, stCPULoad=stCPULoad, stCPULoadRaw=stCPULoadRaw, mwgEngineVersions=mwgEngineVersions, stBlockedByMediaFilter=stBlockedByMediaFilter, stBadReputation=stBadReputation, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pMFEDATVersion=pMFEDATVersion, mwgTrapVariables=mwgTrapVariables, mwg=mwg, stHttpTraffic=stHttpTraffic, stCategoryCount=stCategoryCount, notifyOriginName=notifyOriginName)
