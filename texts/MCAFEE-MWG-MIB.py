...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, Gauge32, Counter64, mib_2, Counter32, IpAddress, NotificationType, Integer32, Bits, MibIdentifier, ModuleIdentity, enterprises, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "Gauge32", "Counter64", "mib-2", "Counter32", "IpAddress", "NotificationType", "Integer32", "Bits", "MibIdentifier", "ModuleIdentity", "enterprises", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pTSDBVersion=pTSDBVersion, stCategoriesTable=stCategoriesTable, kCustomVersion=kCustomVersion, pAMProactiveVersion=pAMProactiveVersion, stConnectionsBlocked=stConnectionsBlocked, stMemConsumed=stMemConsumed, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesToClient=stFtpBytesToClient, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpRequests=stHttpRequests, stHttpTraffic=stHttpTraffic, stBadReputation=stBadReputation, notifyReasonString=notifyReasonString, pAMEngineVersion=pAMEngineVersion, kProductVersion=kProductVersion, stHandleConnectToServer=stHandleConnectToServer, stCPUIOWait=stCPUIOWait, mwgHttp=mwgHttp, kCompanyName=kCompanyName, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesToServer=stHttpBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoryName=stCategoryName, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesToClient=stHttpBytesToClient, notifyOrigin=notifyOrigin, stHttpBytesFromClient=stHttpBytesFromClient, notifyOriginName=notifyOriginName, mwgInfo=mwgInfo, stCategories=stCategories, trSystem=trSystem, notifyAffectedHost=notifyAffectedHost, kMajorVersion=kMajorVersion, stMalwareDetected=stMalwareDetected, stHttpsBytesFromClient=stHttpsBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTraps=mwgTraps, stHttpsBytesToServer=stHttpsBytesToServer, pMFEDATVersion=pMFEDATVersion, stCategoryCount=stCategoryCount, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pAMSignatureVersion=pAMSignatureVersion, stTimeForTransaction=stTimeForTransaction, stConnectionsLegitimate=stConnectionsLegitimate, notifySeverity=notifySeverity, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kProductName=kProductName, kMinorVersion=kMinorVersion, mwgStatistics=mwgStatistics, stHttpsTraffic=stHttpsTraffic, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesFromServer=stHttpBytesFromServer, mwgEngineVersions=mwgEngineVersions, mwg=mwg, kBuildNumber=kBuildNumber, mwgContent=mwgContent, stConnectedSockets=stConnectedSockets, stFtpTraffic=stFtpTraffic, PYSNMP_MODULE_ID=mwg, mwgFTP=mwgFTP, mwgTrapVariables=mwgTrapVariables, mwgHttps=mwgHttps, stHttpsRequests=stHttpsRequests, stMimeType=stMimeType, notifyReason=notifyReason, stClientCount=stClientCount, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyAdditional=notifyAdditional, stFtpBytesFromClient=stFtpBytesFromClient, stCPULoadRaw=stCPULoadRaw, pMFEEngineVersion=pMFEEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, kMicroVersion=kMicroVersion, trUser=trUser, kHotfixVersion=kHotfixVersion, stCategoriesEntry=stCategoriesEntry, stCPULoad=stCPULoad, stHttpsBytesFromServer=stHttpsBytesFromServer, kRevision=kRevision, stHttpsBytesToClient=stHttpsBytesToClient, trApplication=trApplication, stFtpBytesToServer=stFtpBytesToServer)
