...
Bits, MibIdentifier, ObjectIdentity, Counter32, IpAddress, mib_2, ModuleIdentity, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, enterprises, iso, NotificationType, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "ObjectIdentity", "Counter32", "IpAddress", "mib-2", "ModuleIdentity", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "enterprises", "iso", "NotificationType", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgMiscellaneous=mwgMiscellaneous, notifyReasonString=notifyReasonString, pAMEngineVersion=pAMEngineVersion, notifyOrigin=notifyOrigin, kCompanyName=kCompanyName, stResolveHostViaDNS=stResolveHostViaDNS, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgStatistics=mwgStatistics, stHttpTraffic=stHttpTraffic, mwgEngineVersions=mwgEngineVersions, kProductVersion=kProductVersion, stBlockedByURLFilter=stBlockedByURLFilter, kBuildNumber=kBuildNumber, stConnectionsBlocked=stConnectionsBlocked, mwgFTP=mwgFTP, kHotfixVersion=kHotfixVersion, notifySeverity=notifySeverity, kMicroVersion=kMicroVersion, trApplication=trApplication, trSystem=trSystem, mwgTrapVariables=mwgTrapVariables, mwgHttps=mwgHttps, kMajorVersion=kMajorVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesToServer=stHttpsBytesToServer, kMinorVersion=kMinorVersion, stHttpRequests=stHttpRequests, stFtpBytesToClient=stFtpBytesToClient, kProductName=kProductName, kCustomVersion=kCustomVersion, stCategoryCount=stCategoryCount, stFtpBytesFromClient=stFtpBytesFromClient, stClientCount=stClientCount, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesToServer=stFtpBytesToServer, stMalwareDetected=stMalwareDetected, stCPULoad=stCPULoad, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pMFEDATVersion=pMFEDATVersion, notifyReason=notifyReason, stFtpTraffic=stFtpTraffic, stHttpBytesToClient=stHttpBytesToClient, stMimeType=stMimeType, stBadReputation=stBadReputation, pAMSignatureVersion=pAMSignatureVersion, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesFromClient=stHttpBytesFromClient, stMemConsumed=stMemConsumed, stConnectionsLegitimate=stConnectionsLegitimate, stCPULoadRaw=stCPULoadRaw, notifyAdditional=notifyAdditional, stHttpBytesFromServer=stHttpBytesFromServer, kRevision=kRevision, stHttpsRequests=stHttpsRequests, pMFEEngineVersion=pMFEEngineVersion, stCategories=stCategories, pAMProactiveVersion=pAMProactiveVersion, stTimeForTransaction=stTimeForTransaction, stCategoriesTable=stCategoriesTable, notifyOriginName=notifyOriginName, stHttpsTraffic=stHttpsTraffic, stCPUIOWait=stCPUIOWait, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesToServer=stHttpBytesToServer, trUser=trUser, stFtpBytesFromServer=stFtpBytesFromServer, notifyAffectedHost=notifyAffectedHost, stCategoriesEntry=stCategoriesEntry, mwgTraps=mwgTraps, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectedSockets=stConnectedSockets, stHttpsBytesToClient=stHttpsBytesToClient, mwgInfo=mwgInfo, mwg=mwg, mwgHttp=mwgHttp, mwgContent=mwgContent, pTSDBVersion=pTSDBVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoryName=stCategoryName, stBlockedByMediaFilter=stBlockedByMediaFilter, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentLastReceivedServer=stLastSentLastReceivedServer, PYSNMP_MODULE_ID=mwg)
