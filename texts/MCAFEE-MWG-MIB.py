...
IpAddress, mib_2, Unsigned32, iso, TimeTicks, Bits, Counter32, ObjectIdentity, enterprises, Gauge32, MibIdentifier, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "mib-2", "Unsigned32", "iso", "TimeTicks", "Bits", "Counter32", "ObjectIdentity", "enterprises", "Gauge32", "MibIdentifier", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgFTP=mwgFTP, stCategoryName=stCategoryName, kMajorVersion=kMajorVersion, stHttpsRequests=stHttpsRequests, mwgHttp=mwgHttp, trSystem=trSystem, kProductName=kProductName, pMFEDATVersion=pMFEDATVersion, notifyAdditional=notifyAdditional, mwgHttps=mwgHttps, stResolveHostViaDNS=stResolveHostViaDNS, kMinorVersion=kMinorVersion, stConnectedSockets=stConnectedSockets, pTSDBVersion=pTSDBVersion, stHttpsTraffic=stHttpsTraffic, stHttpBytesFromServer=stHttpBytesFromServer, stHttpTraffic=stHttpTraffic, stConnectionsBlocked=stConnectionsBlocked, stBadReputation=stBadReputation, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoriesEntry=stCategoriesEntry, stCPULoad=stCPULoad, mwgTraps=mwgTraps, mwgStatistics=mwgStatistics, mwg=mwg, kBuildNumber=kBuildNumber, stHandleConnectToServer=stHandleConnectToServer, pAMProactiveVersion=pAMProactiveVersion, mwgEngineVersions=mwgEngineVersions, pAMEngineVersion=pAMEngineVersion, mwgContent=mwgContent, stCategories=stCategories, stHttpRequests=stHttpRequests, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kCompanyName=kCompanyName, stCPULoadRaw=stCPULoadRaw, stMemConsumed=stMemConsumed, stMimeType=stMimeType, mwgTrapVariables=mwgTrapVariables, mwgMiscellaneous=mwgMiscellaneous, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpTraffic=stFtpTraffic, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyOriginName=notifyOriginName, stClientCount=stClientCount, mwgInfo=mwgInfo, PYSNMP_MODULE_ID=mwg, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kRevision=kRevision, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyOrigin=notifyOrigin, stCPUIOWait=stCPUIOWait, stFtpBytesFromClient=stFtpBytesFromClient, notifySeverity=notifySeverity, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyReasonString=notifyReasonString, stBlockedByURLFilter=stBlockedByURLFilter, notifyReason=notifyReason, stFtpBytesToServer=stFtpBytesToServer, pMFEEngineVersion=pMFEEngineVersion, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesToServer=stHttpsBytesToServer, trApplication=trApplication, kProductVersion=kProductVersion, kHotfixVersion=kHotfixVersion, stTimeForTransaction=stTimeForTransaction, stHttpsBytesToClient=stHttpsBytesToClient, kCustomVersion=kCustomVersion, stHttpBytesToServer=stHttpBytesToServer, stCategoryCount=stCategoryCount, trUser=trUser, kMicroVersion=kMicroVersion, notifyAffectedHost=notifyAffectedHost, stMalwareDetected=stMalwareDetected, stCategoriesTable=stCategoriesTable)
