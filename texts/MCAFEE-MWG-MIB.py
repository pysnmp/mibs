...
Integer32, IpAddress, Gauge32, NotificationType, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, ObjectIdentity, Unsigned32, iso, enterprises, Bits, Counter32, Counter64, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "Gauge32", "NotificationType", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "Unsigned32", "iso", "enterprises", "Bits", "Counter32", "Counter64", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pMFEDATVersion=pMFEDATVersion, stHttpBytesToClient=stHttpBytesToClient, stHttpTraffic=stHttpTraffic, stCategories=stCategories, mwgContent=mwgContent, stConnectedSockets=stConnectedSockets, mwgHttps=mwgHttps, stTimeForTransaction=stTimeForTransaction, kHotfixVersion=kHotfixVersion, kCustomVersion=kCustomVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgTrapVariables=mwgTrapVariables, notifyOriginName=notifyOriginName, kMinorVersion=kMinorVersion, trApplication=trApplication, PYSNMP_MODULE_ID=mwg, mwg=mwg, stHttpsBytesToServer=stHttpsBytesToServer, stClientCount=stClientCount, stHttpsRequests=stHttpsRequests, stConnectionsLegitimate=stConnectionsLegitimate, mwgTraps=mwgTraps, pAMEngineVersion=pAMEngineVersion, stCategoriesTable=stCategoriesTable, stMimeType=stMimeType, mwgStatistics=mwgStatistics, stFtpTraffic=stFtpTraffic, stFtpBytesToClient=stFtpBytesToClient, kMicroVersion=kMicroVersion, stHttpsTraffic=stHttpsTraffic, stMalwareDetected=stMalwareDetected, stBlockedByAntiMalware=stBlockedByAntiMalware, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, trUser=trUser, stHttpBytesFromClient=stHttpBytesFromClient, mwgFTP=mwgFTP, stHttpBytesFromServer=stHttpBytesFromServer, pTSDBVersion=pTSDBVersion, stHandleConnectToServer=stHandleConnectToServer, stCategoryCount=stCategoryCount, stCPULoad=stCPULoad, stCategoryName=stCategoryName, kMajorVersion=kMajorVersion, notifyReasonString=notifyReasonString, notifyReason=notifyReason, stHttpsBytesToClient=stHttpsBytesToClient, kCompanyName=kCompanyName, mwgEngineVersions=mwgEngineVersions, kBuildNumber=kBuildNumber, stHttpBytesToServer=stHttpBytesToServer, stConnectionsBlocked=stConnectionsBlocked, pMFEEngineVersion=pMFEEngineVersion, stMemConsumed=stMemConsumed, stFtpBytesFromServer=stFtpBytesFromServer, kRevision=kRevision, stCategoriesEntry=stCategoriesEntry, stHttpsBytesFromClient=stHttpsBytesFromClient, kProductName=kProductName, notifyAdditional=notifyAdditional, pAMSignatureVersion=pAMSignatureVersion, kProductVersion=kProductVersion, notifyOrigin=notifyOrigin, notifyAffectedHost=notifyAffectedHost, notifySeverity=notifySeverity, stFtpBytesFromClient=stFtpBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, stCPULoadRaw=stCPULoadRaw, stBadReputation=stBadReputation, mwgInfo=mwgInfo, stResolveHostViaDNS=stResolveHostViaDNS, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgHttp=mwgHttp, mwgMiscellaneous=mwgMiscellaneous, stHttpRequests=stHttpRequests, stFtpBytesToServer=stFtpBytesToServer, stCPUIOWait=stCPUIOWait, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedServer=stLastSentLastReceivedServer, trSystem=trSystem)
