...
Gauge32, ModuleIdentity, NotificationType, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, Counter64, enterprises, Counter32, mib_2, TimeTicks, ObjectIdentity, NotificationType, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "NotificationType", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "Counter64", "enterprises", "Counter32", "mib-2", "TimeTicks", "ObjectIdentity", "NotificationType", "iso", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByURLFilter=stBlockedByURLFilter, PYSNMP_MODULE_ID=mwg, stMalwareDetected=stMalwareDetected, notifyReasonString=notifyReasonString, stHttpBytesFromClient=stHttpBytesFromClient, mwgContent=mwgContent, mwgInfo=mwgInfo, stTimeForTransaction=stTimeForTransaction, stHttpRequests=stHttpRequests, stFtpTraffic=stFtpTraffic, notifyAffectedHost=notifyAffectedHost, stFtpBytesFromClient=stFtpBytesFromClient, trSystem=trSystem, notifyAdditional=notifyAdditional, stCPUIOWait=stCPUIOWait, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMProactiveVersion=pAMProactiveVersion, pAMSignatureVersion=pAMSignatureVersion, stMemConsumed=stMemConsumed, stConnectedSockets=stConnectedSockets, notifyOriginName=notifyOriginName, stHttpBytesToClient=stHttpBytesToClient, mwgHttps=mwgHttps, stFtpBytesFromServer=stFtpBytesFromServer, mwgMiscellaneous=mwgMiscellaneous, stClientCount=stClientCount, mwgStatistics=mwgStatistics, trApplication=trApplication, kMicroVersion=kMicroVersion, mwgTrapVariables=mwgTrapVariables, stResolveHostViaDNS=stResolveHostViaDNS, notifySeverity=notifySeverity, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyReason=notifyReason, mwg=mwg, stHttpTraffic=stHttpTraffic, kCompanyName=kCompanyName, stConnectionsLegitimate=stConnectionsLegitimate, stCPULoad=stCPULoad, pMFEEngineVersion=pMFEEngineVersion, mwgEngineVersions=mwgEngineVersions, kHotfixVersion=kHotfixVersion, stCategoryName=stCategoryName, pAMEngineVersion=pAMEngineVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsTraffic=stHttpsTraffic, stCategoriesTable=stCategoriesTable, stHttpsRequests=stHttpsRequests, stHttpBytesFromServer=stHttpBytesFromServer, kBuildNumber=kBuildNumber, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgTraps=mwgTraps, stHandleConnectToServer=stHandleConnectToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesFromClient=stHttpsBytesFromClient, kProductName=kProductName, pTSDBVersion=pTSDBVersion, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesToClient=stFtpBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMinorVersion=kMinorVersion, kProductVersion=kProductVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stCPULoadRaw=stCPULoadRaw, kCustomVersion=kCustomVersion, stCategories=stCategories, stHttpBytesToServer=stHttpBytesToServer, stMimeType=stMimeType, mwgHttp=mwgHttp, pMFEDATVersion=pMFEDATVersion, stConnectionsBlocked=stConnectionsBlocked, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMajorVersion=kMajorVersion, stBadReputation=stBadReputation, mwgFTP=mwgFTP, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, stCategoryCount=stCategoryCount, kRevision=kRevision, trUser=trUser, stFtpBytesToServer=stFtpBytesToServer, notifyOrigin=notifyOrigin)
