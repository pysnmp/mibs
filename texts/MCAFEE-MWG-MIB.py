...
Unsigned32, mib_2, NotificationType, ObjectIdentity, Gauge32, ModuleIdentity, Integer32, IpAddress, Counter64, TimeTicks, MibIdentifier, Bits, enterprises, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "mib-2", "NotificationType", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Integer32", "IpAddress", "Counter64", "TimeTicks", "MibIdentifier", "Bits", "enterprises", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMalwareDetected=stMalwareDetected, mwgHttp=mwgHttp, mwg=mwg, stMemConsumed=stMemConsumed, notifyOriginName=notifyOriginName, stCPUIOWait=stCPUIOWait, stFtpBytesToClient=stFtpBytesToClient, trUser=trUser, stHttpTraffic=stHttpTraffic, stConnectionsBlocked=stConnectionsBlocked, mwgContent=mwgContent, stCategories=stCategories, stFtpBytesFromClient=stFtpBytesFromClient, mwgStatistics=mwgStatistics, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyOrigin=notifyOrigin, kRevision=kRevision, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesToClient=stHttpBytesToClient, kMicroVersion=kMicroVersion, mwgEngineVersions=mwgEngineVersions, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesToServer=stFtpBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectedSockets=stConnectedSockets, trSystem=trSystem, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpTraffic=stFtpTraffic, pMFEEngineVersion=pMFEEngineVersion, kBuildNumber=kBuildNumber, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, pMFEDATVersion=pMFEDATVersion, notifyReason=notifyReason, stBadReputation=stBadReputation, mwgFTP=mwgFTP, kProductVersion=kProductVersion, PYSNMP_MODULE_ID=mwg, stHandleConnectToServer=stHandleConnectToServer, stCPULoad=stCPULoad, pTSDBVersion=pTSDBVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesFromClient=stHttpsBytesFromClient, stMimeType=stMimeType, notifyAdditional=notifyAdditional, notifySeverity=notifySeverity, pAMEngineVersion=pAMEngineVersion, stClientCount=stClientCount, kProductName=kProductName, stBlockedByURLFilter=stBlockedByURLFilter, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCPULoadRaw=stCPULoadRaw, stFtpBytesFromServer=stFtpBytesFromServer, mwgInfo=mwgInfo, trApplication=trApplication, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stTimeForTransaction=stTimeForTransaction, kHotfixVersion=kHotfixVersion, stCategoriesEntry=stCategoriesEntry, stHttpBytesToServer=stHttpBytesToServer, mwgHttps=mwgHttps, stHttpBytesFromServer=stHttpBytesFromServer, kCustomVersion=kCustomVersion, mwgMiscellaneous=mwgMiscellaneous, mwgTrapVariables=mwgTrapVariables, pAMProactiveVersion=pAMProactiveVersion, notifyReasonString=notifyReasonString, stHttpsTraffic=stHttpsTraffic, notifyAffectedHost=notifyAffectedHost, stCategoryCount=stCategoryCount, stCategoriesTable=stCategoriesTable, stHttpsBytesToServer=stHttpsBytesToServer, stCategoryName=stCategoryName, stHttpBytesFromClient=stHttpBytesFromClient, mwgTraps=mwgTraps, stHttpRequests=stHttpRequests, pAMSignatureVersion=pAMSignatureVersion, kMinorVersion=kMinorVersion, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByMediaFilter=stBlockedByMediaFilter, kMajorVersion=kMajorVersion, stHttpsRequests=stHttpsRequests, kCompanyName=kCompanyName)
