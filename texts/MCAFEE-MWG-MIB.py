...
Bits, mib_2, NotificationType, Integer32, NotificationType, iso, enterprises, Counter32, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress, MibIdentifier, Gauge32, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "mib-2", "NotificationType", "Integer32", "NotificationType", "iso", "enterprises", "Counter32", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress", "MibIdentifier", "Gauge32", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgFTP=mwgFTP, stFtpBytesFromServer=stFtpBytesFromServer, mwgMiscellaneous=mwgMiscellaneous, mwgHttps=mwgHttps, mwgStatistics=mwgStatistics, stConnectedSockets=stConnectedSockets, stFtpTraffic=stFtpTraffic, stHttpBytesToServer=stHttpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, kMicroVersion=kMicroVersion, stTimeForTransaction=stTimeForTransaction, trApplication=trApplication, stCPUIOWait=stCPUIOWait, stCategoriesTable=stCategoriesTable, stResolveHostViaDNS=stResolveHostViaDNS, stCategoryCount=stCategoryCount, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trUser=trUser, mwgHttp=mwgHttp, notifyAdditional=notifyAdditional, notifyOriginName=notifyOriginName, stHttpTraffic=stHttpTraffic, pMFEDATVersion=pMFEDATVersion, stCategoryName=stCategoryName, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyReasonString=notifyReasonString, pTSDBVersion=pTSDBVersion, stHttpsBytesToClient=stHttpsBytesToClient, stCategoriesEntry=stCategoriesEntry, notifyOrigin=notifyOrigin, stHttpsTraffic=stHttpsTraffic, stMemConsumed=stMemConsumed, stFtpBytesFromClient=stFtpBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesFromClient=stHttpBytesFromClient, stBadReputation=stBadReputation, stHttpBytesToClient=stHttpBytesToClient, pAMEngineVersion=pAMEngineVersion, stConnectionsBlocked=stConnectionsBlocked, mwg=mwg, stHandleConnectToServer=stHandleConnectToServer, kRevision=kRevision, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesToServer=stFtpBytesToServer, stFtpBytesToClient=stFtpBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsRequests=stHttpsRequests, stMalwareDetected=stMalwareDetected, stConnectionsLegitimate=stConnectionsLegitimate, stClientCount=stClientCount, kProductName=kProductName, notifyReason=notifyReason, stHttpBytesFromServer=stHttpBytesFromServer, trSystem=trSystem, stCPULoad=stCPULoad, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgInfo=mwgInfo, notifyAffectedHost=notifyAffectedHost, mwgContent=mwgContent, kMinorVersion=kMinorVersion, stHttpRequests=stHttpRequests, mwgEngineVersions=mwgEngineVersions, kHotfixVersion=kHotfixVersion, stMimeType=stMimeType, kCompanyName=kCompanyName, notifySeverity=notifySeverity, PYSNMP_MODULE_ID=mwg, kMajorVersion=kMajorVersion, kProductVersion=kProductVersion, pMFEEngineVersion=pMFEEngineVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kCustomVersion=kCustomVersion, stCPULoadRaw=stCPULoadRaw, mwgTraps=mwgTraps, kBuildNumber=kBuildNumber, stCategories=stCategories, stBlockedByURLFilter=stBlockedByURLFilter, pAMSignatureVersion=pAMSignatureVersion, mwgTrapVariables=mwgTrapVariables)
