...
IpAddress, Unsigned32, mib_2, ModuleIdentity, Counter32, NotificationType, Gauge32, Counter64, NotificationType, iso, Bits, Integer32, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "mib-2", "ModuleIdentity", "Counter32", "NotificationType", "Gauge32", "Counter64", "NotificationType", "iso", "Bits", "Integer32", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kCompanyName=kCompanyName, mwgStatistics=mwgStatistics, mwgEngineVersions=mwgEngineVersions, notifyOrigin=notifyOrigin, stHttpRequests=stHttpRequests, stHttpTraffic=stHttpTraffic, notifyReason=notifyReason, stHttpsBytesFromServer=stHttpsBytesFromServer, notifySeverity=notifySeverity, stFtpBytesToServer=stFtpBytesToServer, stFtpBytesFromClient=stFtpBytesFromClient, stTimeForTransaction=stTimeForTransaction, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategories=stCategories, stConnectedSockets=stConnectedSockets, pMFEDATVersion=pMFEDATVersion, stMalwareDetected=stMalwareDetected, stFtpTraffic=stFtpTraffic, stConnectionsBlocked=stConnectionsBlocked, mwgTrapVariables=mwgTrapVariables, kProductVersion=kProductVersion, PYSNMP_MODULE_ID=mwg, notifyOriginName=notifyOriginName, pAMProactiveVersion=pAMProactiveVersion, kMajorVersion=kMajorVersion, kProductName=kProductName, stFtpBytesToClient=stFtpBytesToClient, notifyAdditional=notifyAdditional, kHotfixVersion=kHotfixVersion, kMicroVersion=kMicroVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsTraffic=stHttpsTraffic, mwg=mwg, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMSignatureVersion=pAMSignatureVersion, stMimeType=stMimeType, stClientCount=stClientCount, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesFromServer=stHttpBytesFromServer, stCPULoad=stCPULoad, kMinorVersion=kMinorVersion, stConnectionsLegitimate=stConnectionsLegitimate, mwgContent=mwgContent, notifyAffectedHost=notifyAffectedHost, pTSDBVersion=pTSDBVersion, stResolveHostViaDNS=stResolveHostViaDNS, notifyReasonString=notifyReasonString, pMFEEngineVersion=pMFEEngineVersion, mwgHttps=mwgHttps, stCategoryName=stCategoryName, stHttpBytesFromClient=stHttpBytesFromClient, kBuildNumber=kBuildNumber, stMemConsumed=stMemConsumed, kCustomVersion=kCustomVersion, stHttpBytesToServer=stHttpBytesToServer, trSystem=trSystem, stBadReputation=stBadReputation, mwgInfo=mwgInfo, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgFTP=mwgFTP, mwgTraps=mwgTraps, pAMEngineVersion=pAMEngineVersion, kRevision=kRevision, stCategoriesEntry=stCategoriesEntry, stHttpsBytesFromClient=stHttpsBytesFromClient, trUser=trUser, stCPUIOWait=stCPUIOWait, trApplication=trApplication, stHttpsBytesToServer=stHttpsBytesToServer, stCategoriesTable=stCategoriesTable, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesToClient=stHttpsBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesToClient=stHttpBytesToClient, stCPULoadRaw=stCPULoadRaw, stBlockedByURLFilter=stBlockedByURLFilter, mwgHttp=mwgHttp, stHttpsRequests=stHttpsRequests, stHandleConnectToServer=stHandleConnectToServer, stCategoryCount=stCategoryCount, mwgMiscellaneous=mwgMiscellaneous)
