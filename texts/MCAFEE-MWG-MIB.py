...
NotificationType, Counter64, mib_2, MibIdentifier, ModuleIdentity, ObjectIdentity, Integer32, NotificationType, Gauge32, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, enterprises, Unsigned32, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "mib-2", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Integer32", "NotificationType", "Gauge32", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "enterprises", "Unsigned32", "iso", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kProductName=kProductName, stConnectedSockets=stConnectedSockets, kRevision=kRevision, mwgInfo=mwgInfo, trSystem=trSystem, pMFEEngineVersion=pMFEEngineVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, stCPUIOWait=stCPUIOWait, mwgStatistics=mwgStatistics, stFtpBytesToServer=stFtpBytesToServer, kBuildNumber=kBuildNumber, stMimeType=stMimeType, stBlockedByURLFilter=stBlockedByURLFilter, pAMSignatureVersion=pAMSignatureVersion, mwgMiscellaneous=mwgMiscellaneous, trApplication=trApplication, stBlockedByAntiMalware=stBlockedByAntiMalware, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsTraffic=stHttpsTraffic, notifyAffectedHost=notifyAffectedHost, mwgContent=mwgContent, kMajorVersion=kMajorVersion, mwgTraps=mwgTraps, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyAdditional=notifyAdditional, stHttpRequests=stHttpRequests, pAMEngineVersion=pAMEngineVersion, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesToServer=stHttpBytesToServer, stMemConsumed=stMemConsumed, stCPULoad=stCPULoad, mwgFTP=mwgFTP, stHttpsBytesToClient=stHttpsBytesToClient, notifySeverity=notifySeverity, stConnectionsLegitimate=stConnectionsLegitimate, stCategoryName=stCategoryName, mwgTrapVariables=mwgTrapVariables, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, mwgHttps=mwgHttps, pAMProactiveVersion=pAMProactiveVersion, mwgEngineVersions=mwgEngineVersions, kHotfixVersion=kHotfixVersion, stCategoryCount=stCategoryCount, kMinorVersion=kMinorVersion, mwg=mwg, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoriesTable=stCategoriesTable, stHttpBytesToClient=stHttpBytesToClient, stClientCount=stClientCount, pMFEDATVersion=pMFEDATVersion, stResolveHostViaDNS=stResolveHostViaDNS, stFtpTraffic=stFtpTraffic, pTSDBVersion=pTSDBVersion, stHttpsRequests=stHttpsRequests, trUser=trUser, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, kCustomVersion=kCustomVersion, stCategoriesEntry=stCategoriesEntry, kProductVersion=kProductVersion, stCategories=stCategories, stHttpsBytesToServer=stHttpsBytesToServer, kMicroVersion=kMicroVersion, notifyOriginName=notifyOriginName, stHttpBytesFromClient=stHttpBytesFromClient, stBadReputation=stBadReputation, notifyReasonString=notifyReasonString, stHandleConnectToServer=stHandleConnectToServer, notifyOrigin=notifyOrigin, stTimeForTransaction=stTimeForTransaction, notifyReason=notifyReason, stMalwareDetected=stMalwareDetected, stFtpBytesToClient=stFtpBytesToClient, stFtpBytesFromServer=stFtpBytesFromServer, mwgHttp=mwgHttp, stCPULoadRaw=stCPULoadRaw, PYSNMP_MODULE_ID=mwg, kCompanyName=kCompanyName, stHttpTraffic=stHttpTraffic)
