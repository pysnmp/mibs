...
Integer32, ObjectIdentity, Counter32, Counter64, IpAddress, mib_2, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, TimeTicks, Bits, ModuleIdentity, NotificationType, Gauge32, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "Counter32", "Counter64", "IpAddress", "mib-2", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "TimeTicks", "Bits", "ModuleIdentity", "NotificationType", "Gauge32", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoryCount=stCategoryCount, pMFEDATVersion=pMFEDATVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpTraffic=stFtpTraffic, mwgEngineVersions=mwgEngineVersions, stFtpBytesToClient=stFtpBytesToClient, stCategoriesEntry=stCategoriesEntry, pAMEngineVersion=pAMEngineVersion, notifyAffectedHost=notifyAffectedHost, stFtpBytesToServer=stFtpBytesToServer, PYSNMP_MODULE_ID=mwg, stConnectedSockets=stConnectedSockets, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCPULoad=stCPULoad, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesFromClient=stHttpBytesFromClient, mwgFTP=mwgFTP, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpTraffic=stHttpTraffic, kProductVersion=kProductVersion, stBadReputation=stBadReputation, stHttpsRequests=stHttpsRequests, mwgTrapVariables=mwgTrapVariables, notifyAdditional=notifyAdditional, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesFromServer=stHttpsBytesFromServer, stClientCount=stClientCount, stHttpBytesFromServer=stHttpBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS, kRevision=kRevision, mwg=mwg, stMemConsumed=stMemConsumed, pAMSignatureVersion=pAMSignatureVersion, stCPULoadRaw=stCPULoadRaw, mwgInfo=mwgInfo, pTSDBVersion=pTSDBVersion, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesToClient=stHttpBytesToClient, stCategoryName=stCategoryName, mwgHttps=mwgHttps, stHttpsBytesFromClient=stHttpsBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByAntiMalware=stBlockedByAntiMalware, trUser=trUser, kCustomVersion=kCustomVersion, mwgStatistics=mwgStatistics, mwgTraps=mwgTraps, stCategories=stCategories, stHttpBytesToServer=stHttpBytesToServer, stMimeType=stMimeType, mwgMiscellaneous=mwgMiscellaneous, mwgContent=mwgContent, notifyReason=notifyReason, stBlockedByURLFilter=stBlockedByURLFilter, kMicroVersion=kMicroVersion, kCompanyName=kCompanyName, notifyOriginName=notifyOriginName, kMajorVersion=kMajorVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMProactiveVersion=pAMProactiveVersion, trApplication=trApplication, notifyReasonString=notifyReasonString, stHttpsTraffic=stHttpsTraffic, stCategoriesTable=stCategoriesTable, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kBuildNumber=kBuildNumber, stCPUIOWait=stCPUIOWait, kHotfixVersion=kHotfixVersion, mwgHttp=mwgHttp, stFtpBytesFromServer=stFtpBytesFromServer, trSystem=trSystem, stHttpRequests=stHttpRequests, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, kMinorVersion=kMinorVersion, notifyOrigin=notifyOrigin, stConnectionsBlocked=stConnectionsBlocked, notifySeverity=notifySeverity, kProductName=kProductName, stTimeForTransaction=stTimeForTransaction, stHttpsBytesToServer=stHttpsBytesToServer)
