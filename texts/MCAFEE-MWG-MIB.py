...
Gauge32, mib_2, MibIdentifier, NotificationType, iso, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises, ObjectIdentity, TimeTicks, Counter32, Counter64, Bits, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "mib-2", "MibIdentifier", "NotificationType", "iso", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises", "ObjectIdentity", "TimeTicks", "Counter32", "Counter64", "Bits", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMEngineVersion=pAMEngineVersion, mwgHttp=mwgHttp, stHttpBytesToClient=stHttpBytesToClient, kCompanyName=kCompanyName, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMinorVersion=kMinorVersion, mwgTraps=mwgTraps, mwgEngineVersions=mwgEngineVersions, mwgFTP=mwgFTP, stCPULoad=stCPULoad, stHttpBytesFromServer=stHttpBytesFromServer, stConnectedSockets=stConnectedSockets, stFtpBytesToServer=stFtpBytesToServer, stCategoryName=stCategoryName, pAMProactiveVersion=pAMProactiveVersion, stHttpBytesFromClient=stHttpBytesFromClient, stBadReputation=stBadReputation, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoriesTable=stCategoriesTable, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwg=mwg, mwgStatistics=mwgStatistics, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesToClient=stHttpsBytesToClient, stCategoriesEntry=stCategoriesEntry, notifySeverity=notifySeverity, stMimeType=stMimeType, stHttpsTraffic=stHttpsTraffic, pAMSignatureVersion=pAMSignatureVersion, notifyAdditional=notifyAdditional, stCategories=stCategories, kMicroVersion=kMicroVersion, pMFEDATVersion=pMFEDATVersion, trUser=trUser, stClientCount=stClientCount, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesToServer=stHttpsBytesToServer, notifyReason=notifyReason, kHotfixVersion=kHotfixVersion, stFtpBytesFromServer=stFtpBytesFromServer, kProductName=kProductName, trSystem=trSystem, mwgTrapVariables=mwgTrapVariables, stHandleConnectToServer=stHandleConnectToServer, pMFEEngineVersion=pMFEEngineVersion, stCPUIOWait=stCPUIOWait, kBuildNumber=kBuildNumber, stHttpTraffic=stHttpTraffic, kMajorVersion=kMajorVersion, notifyOrigin=notifyOrigin, kCustomVersion=kCustomVersion, PYSNMP_MODULE_ID=mwg, stHttpsRequests=stHttpsRequests, mwgInfo=mwgInfo, stConnectionsBlocked=stConnectionsBlocked, stMemConsumed=stMemConsumed, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyOriginName=notifyOriginName, notifyReasonString=notifyReasonString, trApplication=trApplication, stFtpBytesFromClient=stFtpBytesFromClient, stResolveHostViaDNS=stResolveHostViaDNS, mwgHttps=mwgHttps, stMalwareDetected=stMalwareDetected, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpTraffic=stFtpTraffic, kProductVersion=kProductVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgContent=mwgContent, notifyAffectedHost=notifyAffectedHost, stFtpBytesToClient=stFtpBytesToClient, kRevision=kRevision, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpRequests=stHttpRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoryCount=stCategoryCount, pTSDBVersion=pTSDBVersion, stCPULoadRaw=stCPULoadRaw, stTimeForTransaction=stTimeForTransaction)
