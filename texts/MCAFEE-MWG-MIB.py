...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, Counter32, enterprises, Integer32, Counter64, ModuleIdentity, NotificationType, Bits, TimeTicks, iso, NotificationType, mib_2, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "Counter32", "enterprises", "Integer32", "Counter64", "ModuleIdentity", "NotificationType", "Bits", "TimeTicks", "iso", "NotificationType", "mib-2", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesFromClient=stFtpBytesFromClient, notifyReason=notifyReason, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMemConsumed=stMemConsumed, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgEngineVersions=mwgEngineVersions, notifyOriginName=notifyOriginName, trUser=trUser, mwgTraps=mwgTraps, stHttpsBytesToServer=stHttpsBytesToServer, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient, trApplication=trApplication, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpRequests=stHttpRequests, stConnectionsBlocked=stConnectionsBlocked, mwgHttps=mwgHttps, stTimeForTransaction=stTimeForTransaction, notifyAffectedHost=notifyAffectedHost, kCompanyName=kCompanyName, stResolveHostViaDNS=stResolveHostViaDNS, stCategoriesEntry=stCategoriesEntry, stHttpsBytesFromClient=stHttpsBytesFromClient, kProductName=kProductName, stConnectionsLegitimate=stConnectionsLegitimate, kBuildNumber=kBuildNumber, stHttpsBytesToClient=stHttpsBytesToClient, kRevision=kRevision, stCategoriesTable=stCategoriesTable, stConnectedSockets=stConnectedSockets, stCategoryCount=stCategoryCount, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesFromServer=stFtpBytesFromServer, stFtpTraffic=stFtpTraffic, stBlockedByAntiMalware=stBlockedByAntiMalware, pTSDBVersion=pTSDBVersion, stClientCount=stClientCount, notifyOrigin=notifyOrigin, stMalwareDetected=stMalwareDetected, PYSNMP_MODULE_ID=mwg, pAMEngineVersion=pAMEngineVersion, stCategoryName=stCategoryName, stHttpBytesToClient=stHttpBytesToClient, stCPUIOWait=stCPUIOWait, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoadRaw=stCPULoadRaw, mwgInfo=mwgInfo, kHotfixVersion=kHotfixVersion, mwg=mwg, stBadReputation=stBadReputation, stMimeType=stMimeType, kCustomVersion=kCustomVersion, mwgHttp=mwgHttp, notifySeverity=notifySeverity, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMinorVersion=kMinorVersion, notifyAdditional=notifyAdditional, mwgMiscellaneous=mwgMiscellaneous, pMFEDATVersion=pMFEDATVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsTraffic=stHttpsTraffic, notifyReasonString=notifyReasonString, stFtpBytesToClient=stFtpBytesToClient, mwgFTP=mwgFTP, mwgStatistics=mwgStatistics, kMajorVersion=kMajorVersion, stCategories=stCategories, mwgContent=mwgContent, stHttpsRequests=stHttpsRequests, stFtpBytesToServer=stFtpBytesToServer, pAMProactiveVersion=pAMProactiveVersion, stCPULoad=stCPULoad, kMicroVersion=kMicroVersion, mwgTrapVariables=mwgTrapVariables, stHttpBytesFromServer=stHttpBytesFromServer, stHttpTraffic=stHttpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kProductVersion=kProductVersion, stHandleConnectToServer=stHandleConnectToServer, trSystem=trSystem, stHttpBytesToServer=stHttpBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient)
