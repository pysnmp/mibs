...
NotificationType, Counter32, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, mib_2, NotificationType, enterprises, iso, Integer32, Bits, ObjectIdentity, MibIdentifier, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "mib-2", "NotificationType", "enterprises", "iso", "Integer32", "Bits", "ObjectIdentity", "MibIdentifier", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoryCount=stCategoryCount, stHttpBytesToClient=stHttpBytesToClient, stCategoriesEntry=stCategoriesEntry, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyOrigin=notifyOrigin, mwgContent=mwgContent, mwg=mwg, stConnectionsLegitimate=stConnectionsLegitimate, notifySeverity=notifySeverity, notifyAdditional=notifyAdditional, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgTrapVariables=mwgTrapVariables, stBadReputation=stBadReputation, trUser=trUser, trApplication=trApplication, stCPUIOWait=stCPUIOWait, kBuildNumber=kBuildNumber, stHttpsTraffic=stHttpsTraffic, stCategories=stCategories, stClientCount=stClientCount, mwgEngineVersions=mwgEngineVersions, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoad=stCPULoad, pTSDBVersion=pTSDBVersion, stHttpBytesFromServer=stHttpBytesFromServer, kCustomVersion=kCustomVersion, stCategoryName=stCategoryName, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttp=mwgHttp, notifyReason=notifyReason, stHttpRequests=stHttpRequests, kProductName=kProductName, kHotfixVersion=kHotfixVersion, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesToClient=stFtpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, kMicroVersion=kMicroVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyOriginName=notifyOriginName, stHttpsRequests=stHttpsRequests, stConnectionsBlocked=stConnectionsBlocked, stHandleConnectToServer=stHandleConnectToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMajorVersion=kMajorVersion, notifyReasonString=notifyReasonString, mwgFTP=mwgFTP, stBlockedByURLFilter=stBlockedByURLFilter, pAMProactiveVersion=pAMProactiveVersion, kProductVersion=kProductVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stMimeType=stMimeType, mwgStatistics=mwgStatistics, stFtpTraffic=stFtpTraffic, trSystem=trSystem, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pMFEDATVersion=pMFEDATVersion, notifyAffectedHost=notifyAffectedHost, mwgInfo=mwgInfo, kCompanyName=kCompanyName, stHttpBytesToServer=stHttpBytesToServer, stCategoriesTable=stCategoriesTable, stCPULoadRaw=stCPULoadRaw, stHttpBytesFromClient=stHttpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, stHttpTraffic=stHttpTraffic, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgHttps=mwgHttps, stTimeForTransaction=stTimeForTransaction, mwgTraps=mwgTraps, PYSNMP_MODULE_ID=mwg, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesToServer=stFtpBytesToServer, stMalwareDetected=stMalwareDetected, stHttpsBytesToServer=stHttpsBytesToServer, kMinorVersion=kMinorVersion, pAMEngineVersion=pAMEngineVersion, stMemConsumed=stMemConsumed, stConnectedSockets=stConnectedSockets, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kRevision=kRevision, stFtpBytesFromClient=stFtpBytesFromClient)
