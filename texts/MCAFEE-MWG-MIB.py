...
mib_2, Counter64, ModuleIdentity, Counter32, ObjectIdentity, enterprises, NotificationType, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, NotificationType, Bits, Unsigned32, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Counter64", "ModuleIdentity", "Counter32", "ObjectIdentity", "enterprises", "NotificationType", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "NotificationType", "Bits", "Unsigned32", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByURLFilter=stBlockedByURLFilter, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByMediaFilter=stBlockedByMediaFilter, pAMProactiveVersion=pAMProactiveVersion, stClientCount=stClientCount, pTSDBVersion=pTSDBVersion, kProductName=kProductName, notifyAdditional=notifyAdditional, stFtpTraffic=stFtpTraffic, stHttpsRequests=stHttpsRequests, notifyReason=notifyReason, pMFEEngineVersion=pMFEEngineVersion, stCPULoadRaw=stCPULoadRaw, stMalwareDetected=stMalwareDetected, pMFEDATVersion=pMFEDATVersion, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromServer=stHttpBytesFromServer, notifyOriginName=notifyOriginName, stCategoriesEntry=stCategoriesEntry, kCompanyName=kCompanyName, mwgEngineVersions=mwgEngineVersions, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpRequests=stHttpRequests, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgTraps=mwgTraps, stMemConsumed=stMemConsumed, stFtpBytesToServer=stFtpBytesToServer, trSystem=trSystem, trUser=trUser, stCategoryCount=stCategoryCount, pAMEngineVersion=pAMEngineVersion, stFtpBytesToClient=stFtpBytesToClient, kBuildNumber=kBuildNumber, kMajorVersion=kMajorVersion, stMimeType=stMimeType, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgContent=mwgContent, mwgTrapVariables=mwgTrapVariables, stHttpsBytesToClient=stHttpsBytesToClient, notifyReasonString=notifyReasonString, kRevision=kRevision, mwgMiscellaneous=mwgMiscellaneous, stBadReputation=stBadReputation, mwgHttp=mwgHttp, stHttpBytesToClient=stHttpBytesToClient, mwgStatistics=mwgStatistics, notifyOrigin=notifyOrigin, kMicroVersion=kMicroVersion, mwg=mwg, stHandleConnectToServer=stHandleConnectToServer, kMinorVersion=kMinorVersion, stHttpBytesToServer=stHttpBytesToServer, mwgHttps=mwgHttps, notifyAffectedHost=notifyAffectedHost, notifySeverity=notifySeverity, mwgFTP=mwgFTP, stFtpBytesFromClient=stFtpBytesFromClient, stCategoryName=stCategoryName, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesFromClient=stHttpBytesFromClient, stCategories=stCategories, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectionsBlocked=stConnectionsBlocked, stConnectedSockets=stConnectedSockets, kProductVersion=kProductVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, PYSNMP_MODULE_ID=mwg, kCustomVersion=kCustomVersion, mwgInfo=mwgInfo, stHttpTraffic=stHttpTraffic, stHttpsTraffic=stHttpsTraffic, kHotfixVersion=kHotfixVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, trApplication=trApplication, stCategoriesTable=stCategoriesTable, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCPUIOWait=stCPUIOWait, stCPULoad=stCPULoad, stHttpsBytesToServer=stHttpsBytesToServer, stTimeForTransaction=stTimeForTransaction, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient)
