...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, TimeTicks, Unsigned32, ModuleIdentity, Integer32, NotificationType, Counter32, Counter64, mib_2, iso, MibIdentifier, Gauge32, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "TimeTicks", "Unsigned32", "ModuleIdentity", "Integer32", "NotificationType", "Counter32", "Counter64", "mib-2", "iso", "MibIdentifier", "Gauge32", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgTrapVariables=mwgTrapVariables, notifyAffectedHost=notifyAffectedHost, stMimeType=stMimeType, mwgContent=mwgContent, PYSNMP_MODULE_ID=mwg, stFtpBytesToClient=stFtpBytesToClient, kBuildNumber=kBuildNumber, stMalwareDetected=stMalwareDetected, stClientCount=stClientCount, stCategoriesEntry=stCategoriesEntry, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stConnectedSockets=stConnectedSockets, mwgHttp=mwgHttp, stHttpRequests=stHttpRequests, pMFEDATVersion=pMFEDATVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsBytesFromServer=stHttpsBytesFromServer, kHotfixVersion=kHotfixVersion, stHttpBytesFromServer=stHttpBytesFromServer, pAMEngineVersion=pAMEngineVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgTraps=mwgTraps, stHttpsBytesToClient=stHttpsBytesToClient, mwgInfo=mwgInfo, stBadReputation=stBadReputation, mwgHttps=mwgHttps, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgFTP=mwgFTP, pAMProactiveVersion=pAMProactiveVersion, stMemConsumed=stMemConsumed, kMinorVersion=kMinorVersion, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesToServer=stFtpBytesToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoriesTable=stCategoriesTable, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoryCount=stCategoryCount, stFtpBytesFromServer=stFtpBytesFromServer, mwg=mwg, trApplication=trApplication, stBlockedByAntiMalware=stBlockedByAntiMalware, stHandleConnectToServer=stHandleConnectToServer, stCPULoadRaw=stCPULoadRaw, kProductName=kProductName, stBlockedByURLFilter=stBlockedByURLFilter, kCompanyName=kCompanyName, stCPULoad=stCPULoad, stHttpsTraffic=stHttpsTraffic, stHttpsRequests=stHttpsRequests, stCategoryName=stCategoryName, stHttpTraffic=stHttpTraffic, stHttpBytesToServer=stHttpBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, stCategories=stCategories, stConnectionsBlocked=stConnectionsBlocked, mwgStatistics=mwgStatistics, notifyOriginName=notifyOriginName, notifyReason=notifyReason, stCPUIOWait=stCPUIOWait, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpTraffic=stFtpTraffic, stBlockedByMediaFilter=stBlockedByMediaFilter, stTimeForTransaction=stTimeForTransaction, trSystem=trSystem, notifyOrigin=notifyOrigin, kMajorVersion=kMajorVersion, kCustomVersion=kCustomVersion, kMicroVersion=kMicroVersion, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesToClient=stHttpBytesToClient, trUser=trUser, notifySeverity=notifySeverity, kRevision=kRevision, stConnectionsLegitimate=stConnectionsLegitimate, notifyReasonString=notifyReasonString, kProductVersion=kProductVersion, stHttpBytesFromClient=stHttpBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesFromClient=stFtpBytesFromClient, notifyAdditional=notifyAdditional, pTSDBVersion=pTSDBVersion, mwgMiscellaneous=mwgMiscellaneous, mwgEngineVersions=mwgEngineVersions)
