...
Unsigned32, ModuleIdentity, NotificationType, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, NotificationType, mib_2, ObjectIdentity, MibIdentifier, enterprises, Bits, Integer32, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "NotificationType", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "NotificationType", "mib-2", "ObjectIdentity", "MibIdentifier", "enterprises", "Bits", "Integer32", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kHotfixVersion=kHotfixVersion, stCategoryName=stCategoryName, stMemConsumed=stMemConsumed, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsRequests=stHttpsRequests, stHttpsTraffic=stHttpsTraffic, mwgStatistics=mwgStatistics, pMFEEngineVersion=pMFEEngineVersion, stHttpTraffic=stHttpTraffic, stBadReputation=stBadReputation, mwgContent=mwgContent, stBlockedByURLFilter=stBlockedByURLFilter, stFtpTraffic=stFtpTraffic, kCompanyName=kCompanyName, stMalwareDetected=stMalwareDetected, stLastSentLastReceivedServer=stLastSentLastReceivedServer, trUser=trUser, trApplication=trApplication, stFtpBytesToClient=stFtpBytesToClient, stHandleConnectToServer=stHandleConnectToServer, stCategories=stCategories, kRevision=kRevision, stHttpsBytesToServer=stHttpsBytesToServer, stClientCount=stClientCount, stHttpBytesFromClient=stHttpBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, pAMEngineVersion=pAMEngineVersion, pAMProactiveVersion=pAMProactiveVersion, stCategoriesTable=stCategoriesTable, kMajorVersion=kMajorVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoad=stCPULoad, stConnectionsBlocked=stConnectionsBlocked, stCategoryCount=stCategoryCount, stTimeForTransaction=stTimeForTransaction, PYSNMP_MODULE_ID=mwg, stHttpsBytesToClient=stHttpsBytesToClient, mwgInfo=mwgInfo, stHttpRequests=stHttpRequests, notifyOrigin=notifyOrigin, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgHttp=mwgHttp, stCPUIOWait=stCPUIOWait, kProductVersion=kProductVersion, kCustomVersion=kCustomVersion, stHttpBytesToServer=stHttpBytesToServer, kProductName=kProductName, stHttpBytesToClient=stHttpBytesToClient, pMFEDATVersion=pMFEDATVersion, kMicroVersion=kMicroVersion, mwgTrapVariables=mwgTrapVariables, mwgFTP=mwgFTP, trSystem=trSystem, stCategoriesEntry=stCategoriesEntry, mwgHttps=mwgHttps, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifySeverity=notifySeverity, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyReasonString=notifyReasonString, notifyAdditional=notifyAdditional, stConnectedSockets=stConnectedSockets, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpBytesToServer=stFtpBytesToServer, notifyAffectedHost=notifyAffectedHost, notifyOriginName=notifyOriginName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMimeType=stMimeType, stHttpBytesFromServer=stHttpBytesFromServer, mwgTraps=mwgTraps, stCPULoadRaw=stCPULoadRaw, mwgEngineVersions=mwgEngineVersions, pTSDBVersion=pTSDBVersion, kBuildNumber=kBuildNumber, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectionsLegitimate=stConnectionsLegitimate, mwg=mwg, stFtpBytesFromServer=stFtpBytesFromServer, notifyReason=notifyReason, stFtpBytesFromClient=stFtpBytesFromClient, kMinorVersion=kMinorVersion, mwgMiscellaneous=mwgMiscellaneous)
