...
Integer32, iso, Unsigned32, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, IpAddress, NotificationType, ObjectIdentity, mib_2, MibIdentifier, enterprises, Counter32, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "Unsigned32", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "IpAddress", "NotificationType", "ObjectIdentity", "mib-2", "MibIdentifier", "enterprises", "Counter32", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesFromClient=stHttpBytesFromClient, trUser=trUser, kCompanyName=kCompanyName, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesToServer=stHttpBytesToServer, stHandleConnectToServer=stHandleConnectToServer, stCPUIOWait=stCPUIOWait, PYSNMP_MODULE_ID=mwg, trSystem=trSystem, notifyReasonString=notifyReasonString, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kCustomVersion=kCustomVersion, kMajorVersion=kMajorVersion, trApplication=trApplication, stConnectionsLegitimate=stConnectionsLegitimate, mwgTraps=mwgTraps, stResolveHostViaDNS=stResolveHostViaDNS, mwgFTP=mwgFTP, pAMEngineVersion=pAMEngineVersion, stCategoryName=stCategoryName, pMFEDATVersion=pMFEDATVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, kBuildNumber=kBuildNumber, stBadReputation=stBadReputation, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMalwareDetected=stMalwareDetected, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwg=mwg, pAMSignatureVersion=pAMSignatureVersion, notifyOriginName=notifyOriginName, kRevision=kRevision, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMemConsumed=stMemConsumed, stCategories=stCategories, stCategoryCount=stCategoryCount, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCPULoadRaw=stCPULoadRaw, stCPULoad=stCPULoad, mwgStatistics=mwgStatistics, notifySeverity=notifySeverity, kProductName=kProductName, stHttpsBytesToClient=stHttpsBytesToClient, notifyReason=notifyReason, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesToServer=stFtpBytesToServer, mwgMiscellaneous=mwgMiscellaneous, pAMProactiveVersion=pAMProactiveVersion, stTimeForTransaction=stTimeForTransaction, stHttpsBytesFromServer=stHttpsBytesFromServer, stClientCount=stClientCount, pMFEEngineVersion=pMFEEngineVersion, kProductVersion=kProductVersion, stHttpTraffic=stHttpTraffic, stHttpsBytesToServer=stHttpsBytesToServer, stHttpRequests=stHttpRequests, notifyAffectedHost=notifyAffectedHost, stHttpBytesToClient=stHttpBytesToClient, stMimeType=stMimeType, stHttpsTraffic=stHttpsTraffic, mwgInfo=mwgInfo, kMinorVersion=kMinorVersion, stFtpTraffic=stFtpTraffic, mwgTrapVariables=mwgTrapVariables, kHotfixVersion=kHotfixVersion, kMicroVersion=kMicroVersion, mwgContent=mwgContent, stConnectedSockets=stConnectedSockets, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesFromServer=stHttpBytesFromServer, notifyAdditional=notifyAdditional, stHttpsRequests=stHttpsRequests, mwgHttps=mwgHttps, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoriesTable=stCategoriesTable, stConnectionsBlocked=stConnectionsBlocked, mwgEngineVersions=mwgEngineVersions, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoriesEntry=stCategoriesEntry, mwgHttp=mwgHttp, stFtpBytesFromClient=stFtpBytesFromClient, notifyOrigin=notifyOrigin, pTSDBVersion=pTSDBVersion)
