...
Unsigned32, Integer32, mib_2, Counter32, NotificationType, IpAddress, NotificationType, MibIdentifier, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, enterprises, iso, ObjectIdentity, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "mib-2", "Counter32", "NotificationType", "IpAddress", "NotificationType", "MibIdentifier", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "enterprises", "iso", "ObjectIdentity", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesFromClient=stHttpsBytesFromClient, kProductVersion=kProductVersion, stHttpsTraffic=stHttpsTraffic, trUser=trUser, stClientCount=stClientCount, pAMEngineVersion=pAMEngineVersion, stHttpBytesToServer=stHttpBytesToServer, stCategoriesTable=stCategoriesTable, stHttpsBytesToClient=stHttpsBytesToClient, trSystem=trSystem, mwgHttps=mwgHttps, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesFromClient=stHttpBytesFromClient, notifyReason=notifyReason, stBadReputation=stBadReputation, stHandleConnectToServer=stHandleConnectToServer, notifyAffectedHost=notifyAffectedHost, stCPUIOWait=stCPUIOWait, stHttpsRequests=stHttpsRequests, stMemConsumed=stMemConsumed, stConnectionsBlocked=stConnectionsBlocked, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, PYSNMP_MODULE_ID=mwg, stResolveHostViaDNS=stResolveHostViaDNS, pAMSignatureVersion=pAMSignatureVersion, stMalwareDetected=stMalwareDetected, pAMProactiveVersion=pAMProactiveVersion, stCategoriesEntry=stCategoriesEntry, kProductName=kProductName, stHttpBytesFromServer=stHttpBytesFromServer, mwgFTP=mwgFTP, stConnectionsLegitimate=stConnectionsLegitimate, mwgContent=mwgContent, stBlockedByURLFilter=stBlockedByURLFilter, stHttpRequests=stHttpRequests, kBuildNumber=kBuildNumber, notifyReasonString=notifyReasonString, stFtpBytesToClient=stFtpBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kCompanyName=kCompanyName, kMicroVersion=kMicroVersion, notifyAdditional=notifyAdditional, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoryName=stCategoryName, notifySeverity=notifySeverity, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pMFEDATVersion=pMFEDATVersion, stFtpTraffic=stFtpTraffic, stConnectedSockets=stConnectedSockets, stCategories=stCategories, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoryCount=stCategoryCount, stTimeForTransaction=stTimeForTransaction, stMimeType=stMimeType, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesToServer=stHttpsBytesToServer, notifyOrigin=notifyOrigin, mwgEngineVersions=mwgEngineVersions, stCPULoad=stCPULoad, trApplication=trApplication, stFtpBytesFromServer=stFtpBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesToClient=stHttpBytesToClient, kMinorVersion=kMinorVersion, stHttpTraffic=stHttpTraffic, stCPULoadRaw=stCPULoadRaw, kRevision=kRevision, pTSDBVersion=pTSDBVersion, mwg=mwg, kMajorVersion=kMajorVersion, mwgInfo=mwgInfo, notifyOriginName=notifyOriginName, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgMiscellaneous=mwgMiscellaneous, kHotfixVersion=kHotfixVersion, stFtpBytesToServer=stFtpBytesToServer, mwgTraps=mwgTraps, kCustomVersion=kCustomVersion, mwgStatistics=mwgStatistics, mwgHttp=mwgHttp, mwgTrapVariables=mwgTrapVariables, pMFEEngineVersion=pMFEEngineVersion)
