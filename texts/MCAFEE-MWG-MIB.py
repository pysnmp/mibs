...
IpAddress, Gauge32, Bits, Unsigned32, NotificationType, TimeTicks, iso, MibIdentifier, Counter32, NotificationType, mib_2, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, ObjectIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "Bits", "Unsigned32", "NotificationType", "TimeTicks", "iso", "MibIdentifier", "Counter32", "NotificationType", "mib-2", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "ObjectIdentity", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kMajorVersion=kMajorVersion, notifyReasonString=notifyReasonString, stHttpTraffic=stHttpTraffic, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesToServer=stFtpBytesToServer, kMinorVersion=kMinorVersion, pAMProactiveVersion=pAMProactiveVersion, pTSDBVersion=pTSDBVersion, kProductName=kProductName, stBadReputation=stBadReputation, stConnectionsBlocked=stConnectionsBlocked, notifyAffectedHost=notifyAffectedHost, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttps=mwgHttps, stFtpBytesFromServer=stFtpBytesFromServer, trUser=trUser, kRevision=kRevision, mwgFTP=mwgFTP, mwg=mwg, kBuildNumber=kBuildNumber, kHotfixVersion=kHotfixVersion, mwgMiscellaneous=mwgMiscellaneous, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stClientCount=stClientCount, mwgTrapVariables=mwgTrapVariables, stHttpBytesToClient=stHttpBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpTraffic=stFtpTraffic, stMimeType=stMimeType, PYSNMP_MODULE_ID=mwg, mwgStatistics=mwgStatistics, kCompanyName=kCompanyName, stCPULoadRaw=stCPULoadRaw, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kCustomVersion=kCustomVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, notifySeverity=notifySeverity, stHttpsTraffic=stHttpsTraffic, stCategories=stCategories, kProductVersion=kProductVersion, stMalwareDetected=stMalwareDetected, stCategoryName=stCategoryName, notifyOrigin=notifyOrigin, stHttpsBytesToClient=stHttpsBytesToClient, stBlockedByURLFilter=stBlockedByURLFilter, pMFEEngineVersion=pMFEEngineVersion, stCategoriesTable=stCategoriesTable, mwgEngineVersions=mwgEngineVersions, stCPUIOWait=stCPUIOWait, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesFromClient=stFtpBytesFromClient, notifyReason=notifyReason, stHttpRequests=stHttpRequests, stBlockedByAntiMalware=stBlockedByAntiMalware, trSystem=trSystem, stMemConsumed=stMemConsumed, stConnectedSockets=stConnectedSockets, mwgInfo=mwgInfo, mwgHttp=mwgHttp, stCategoryCount=stCategoryCount, pAMSignatureVersion=pAMSignatureVersion, stHandleConnectToServer=stHandleConnectToServer, pMFEDATVersion=pMFEDATVersion, stCPULoad=stCPULoad, mwgTraps=mwgTraps, trApplication=trApplication, notifyOriginName=notifyOriginName, stConnectionsLegitimate=stConnectionsLegitimate, stTimeForTransaction=stTimeForTransaction, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoriesEntry=stCategoriesEntry, stHttpsRequests=stHttpsRequests, pAMEngineVersion=pAMEngineVersion, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, notifyAdditional=notifyAdditional, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesToServer=stHttpBytesToServer, kMicroVersion=kMicroVersion, stHttpsBytesToServer=stHttpsBytesToServer, mwgContent=mwgContent, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient)
