...
Counter32, enterprises, Gauge32, Integer32, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, TimeTicks, ObjectIdentity, mib_2, Bits, MibIdentifier, iso, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "enterprises", "Gauge32", "Integer32", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "TimeTicks", "ObjectIdentity", "mib-2", "Bits", "MibIdentifier", "iso", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesFromClient=stHttpsBytesFromClient, notifyOriginName=notifyOriginName, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesToServer=stFtpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesToServer=stHttpBytesToServer, trApplication=trApplication, pMFEEngineVersion=pMFEEngineVersion, stCategoryCount=stCategoryCount, kMicroVersion=kMicroVersion, stBlockedByURLFilter=stBlockedByURLFilter, notifyAdditional=notifyAdditional, stHandleConnectToServer=stHandleConnectToServer, stFtpTraffic=stFtpTraffic, mwgTraps=mwgTraps, stConnectedSockets=stConnectedSockets, notifySeverity=notifySeverity, mwgMiscellaneous=mwgMiscellaneous, pMFEDATVersion=pMFEDATVersion, stBadReputation=stBadReputation, notifyReasonString=notifyReasonString, mwgEngineVersions=mwgEngineVersions, stHttpsTraffic=stHttpsTraffic, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesToServer=stHttpsBytesToServer, stCategories=stCategories, stMalwareDetected=stMalwareDetected, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kProductVersion=kProductVersion, stFtpBytesFromClient=stFtpBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyOrigin=notifyOrigin, notifyAffectedHost=notifyAffectedHost, stConnectionsLegitimate=stConnectionsLegitimate, mwgStatistics=mwgStatistics, stFtpBytesFromServer=stFtpBytesFromServer, kMajorVersion=kMajorVersion, stCPULoadRaw=stCPULoadRaw, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kBuildNumber=kBuildNumber, trUser=trUser, stHttpsBytesToClient=stHttpsBytesToClient, kRevision=kRevision, mwgInfo=mwgInfo, stResolveHostViaDNS=stResolveHostViaDNS, mwgTrapVariables=mwgTrapVariables, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwg=mwg, stHttpRequests=stHttpRequests, stHttpTraffic=stHttpTraffic, stCategoriesTable=stCategoriesTable, trSystem=trSystem, PYSNMP_MODULE_ID=mwg, mwgContent=mwgContent, pAMEngineVersion=pAMEngineVersion, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stCategoriesEntry=stCategoriesEntry, pTSDBVersion=pTSDBVersion, mwgHttps=mwgHttps, kProductName=kProductName, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stMemConsumed=stMemConsumed, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stTimeForTransaction=stTimeForTransaction, stCPUIOWait=stCPUIOWait, kCustomVersion=kCustomVersion, stMimeType=stMimeType, stCategoryName=stCategoryName, mwgFTP=mwgFTP, stHttpsRequests=stHttpsRequests, stCPULoad=stCPULoad, stClientCount=stClientCount, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyReason=notifyReason, kCompanyName=kCompanyName, kHotfixVersion=kHotfixVersion, stHttpBytesFromClient=stHttpBytesFromClient, kMinorVersion=kMinorVersion, mwgHttp=mwgHttp)
