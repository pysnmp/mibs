...
ObjectIdentity, NotificationType, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, mib_2, Bits, Gauge32, ModuleIdentity, NotificationType, Integer32, MibIdentifier, Unsigned32, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "mib-2", "Bits", "Gauge32", "ModuleIdentity", "NotificationType", "Integer32", "MibIdentifier", "Unsigned32", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pTSDBVersion=pTSDBVersion, stCategoryName=stCategoryName, pAMSignatureVersion=pAMSignatureVersion, stCategoriesTable=stCategoriesTable, stBadReputation=stBadReputation, notifyAdditional=notifyAdditional, stHttpsBytesFromClient=stHttpsBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCPULoadRaw=stCPULoadRaw, stHttpsTraffic=stHttpsTraffic, PYSNMP_MODULE_ID=mwg, kMinorVersion=kMinorVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesFromClient=stFtpBytesFromClient, mwgHttps=mwgHttps, mwgMiscellaneous=mwgMiscellaneous, mwgFTP=mwgFTP, stHttpBytesToServer=stHttpBytesToServer, stCPUIOWait=stCPUIOWait, kCompanyName=kCompanyName, kRevision=kRevision, pAMProactiveVersion=pAMProactiveVersion, kMicroVersion=kMicroVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgTrapVariables=mwgTrapVariables, kMajorVersion=kMajorVersion, mwgStatistics=mwgStatistics, stHttpsBytesToServer=stHttpsBytesToServer, kProductName=kProductName, mwgHttp=mwgHttp, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpBytesFromClient=stHttpBytesFromClient, stCategoriesEntry=stCategoriesEntry, stHttpsBytesFromServer=stHttpsBytesFromServer, kBuildNumber=kBuildNumber, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwg=mwg, stFtpBytesToClient=stFtpBytesToClient, notifyOrigin=notifyOrigin, notifySeverity=notifySeverity, notifyReasonString=notifyReasonString, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trApplication=trApplication, stBlockedByAntiMalware=stBlockedByAntiMalware, kHotfixVersion=kHotfixVersion, stHttpBytesToClient=stHttpBytesToClient, kCustomVersion=kCustomVersion, notifyOriginName=notifyOriginName, stMalwareDetected=stMalwareDetected, stFtpBytesFromServer=stFtpBytesFromServer, notifyReason=notifyReason, stTimeForTransaction=stTimeForTransaction, pAMEngineVersion=pAMEngineVersion, stCategoryCount=stCategoryCount, stResolveHostViaDNS=stResolveHostViaDNS, mwgEngineVersions=mwgEngineVersions, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoad=stCPULoad, stHttpsRequests=stHttpsRequests, stConnectedSockets=stConnectedSockets, trUser=trUser, trSystem=trSystem, pMFEDATVersion=pMFEDATVersion, stCategories=stCategories, stHandleConnectToServer=stHandleConnectToServer, mwgTraps=mwgTraps, stFtpTraffic=stFtpTraffic, stConnectionsLegitimate=stConnectionsLegitimate, stHttpTraffic=stHttpTraffic, pMFEEngineVersion=pMFEEngineVersion, kProductVersion=kProductVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgInfo=mwgInfo, stMimeType=stMimeType, notifyAffectedHost=notifyAffectedHost, stConnectionsBlocked=stConnectionsBlocked, stBlockedByURLFilter=stBlockedByURLFilter, stHttpRequests=stHttpRequests, stHttpBytesFromServer=stHttpBytesFromServer, stMemConsumed=stMemConsumed, stClientCount=stClientCount, stFtpBytesToServer=stFtpBytesToServer, mwgContent=mwgContent)
