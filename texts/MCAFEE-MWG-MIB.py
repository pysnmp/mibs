...
NotificationType, ModuleIdentity, NotificationType, TimeTicks, ObjectIdentity, Counter64, Counter32, IpAddress, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, mib_2, Bits, Unsigned32, MibIdentifier, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "NotificationType", "TimeTicks", "ObjectIdentity", "Counter64", "Counter32", "IpAddress", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "mib-2", "Bits", "Unsigned32", "MibIdentifier", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stConnectionsBlocked=stConnectionsBlocked, stMimeType=stMimeType, stFtpBytesToClient=stFtpBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgTraps=mwgTraps, notifySeverity=notifySeverity, stHttpBytesFromServer=stHttpBytesFromServer, mwgEngineVersions=mwgEngineVersions, notifyReason=notifyReason, kMicroVersion=kMicroVersion, stMemConsumed=stMemConsumed, pAMEngineVersion=pAMEngineVersion, trSystem=trSystem, stBadReputation=stBadReputation, mwgHttp=mwgHttp, stFtpBytesToServer=stFtpBytesToServer, kProductVersion=kProductVersion, stHttpsBytesToServer=stHttpsBytesToServer, kProductName=kProductName, notifyAffectedHost=notifyAffectedHost, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kHotfixVersion=kHotfixVersion, mwgFTP=mwgFTP, stHttpsRequests=stHttpsRequests, pTSDBVersion=pTSDBVersion, mwgTrapVariables=mwgTrapVariables, stHttpsTraffic=stHttpsTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesFromClient=stHttpBytesFromClient, stMalwareDetected=stMalwareDetected, kMinorVersion=kMinorVersion, kMajorVersion=kMajorVersion, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyOriginName=notifyOriginName, kRevision=kRevision, stTimeForTransaction=stTimeForTransaction, stCategoryName=stCategoryName, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyOrigin=notifyOrigin, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesFromServer=stFtpBytesFromServer, stCategoryCount=stCategoryCount, pMFEDATVersion=pMFEDATVersion, stResolveHostViaDNS=stResolveHostViaDNS, mwgContent=mwgContent, mwgHttps=mwgHttps, notifyReasonString=notifyReasonString, stCategoriesEntry=stCategoriesEntry, pAMProactiveVersion=pAMProactiveVersion, stCPULoad=stCPULoad, kCustomVersion=kCustomVersion, stBlockedByURLFilter=stBlockedByURLFilter, kCompanyName=kCompanyName, pAMSignatureVersion=pAMSignatureVersion, stCategoriesTable=stCategoriesTable, mwgStatistics=mwgStatistics, mwg=mwg, trApplication=trApplication, stClientCount=stClientCount, kBuildNumber=kBuildNumber, stCategories=stCategories, stConnectionsLegitimate=stConnectionsLegitimate, stCPUIOWait=stCPUIOWait, stHttpBytesToClient=stHttpBytesToClient, stHttpTraffic=stHttpTraffic, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpTraffic=stFtpTraffic, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCPULoadRaw=stCPULoadRaw, pMFEEngineVersion=pMFEEngineVersion, PYSNMP_MODULE_ID=mwg, mwgInfo=mwgInfo, stHandleConnectToServer=stHandleConnectToServer, stConnectedSockets=stConnectedSockets, trUser=trUser, notifyAdditional=notifyAdditional, mwgMiscellaneous=mwgMiscellaneous, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpRequests=stHttpRequests)
