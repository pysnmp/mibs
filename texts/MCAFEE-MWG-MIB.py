...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, Counter32, mib_2, Gauge32, NotificationType, ModuleIdentity, Counter64, NotificationType, IpAddress, iso, Bits, enterprises, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "Counter32", "mib-2", "Gauge32", "NotificationType", "ModuleIdentity", "Counter64", "NotificationType", "IpAddress", "iso", "Bits", "enterprises", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyOriginName=notifyOriginName, mwgHttps=mwgHttps, pAMProactiveVersion=pAMProactiveVersion, pMFEDATVersion=pMFEDATVersion, mwgStatistics=mwgStatistics, kProductName=kProductName, notifyReason=notifyReason, stHttpsBytesToClient=stHttpsBytesToClient, stConnectionsLegitimate=stConnectionsLegitimate, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stConnectedSockets=stConnectedSockets, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMinorVersion=kMinorVersion, stCPUIOWait=stCPUIOWait, notifyOrigin=notifyOrigin, notifyAffectedHost=notifyAffectedHost, kCompanyName=kCompanyName, stBlockedByMediaFilter=stBlockedByMediaFilter, pAMSignatureVersion=pAMSignatureVersion, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient, notifySeverity=notifySeverity, mwg=mwg, stMimeType=stMimeType, stTimeForTransaction=stTimeForTransaction, kMicroVersion=kMicroVersion, stResolveHostViaDNS=stResolveHostViaDNS, trUser=trUser, notifyReasonString=notifyReasonString, stHttpBytesToClient=stHttpBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kProductVersion=kProductVersion, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, mwgInfo=mwgInfo, stCategoryCount=stCategoryCount, mwgMiscellaneous=mwgMiscellaneous, kBuildNumber=kBuildNumber, stMemConsumed=stMemConsumed, stCategoryName=stCategoryName, stBlockedByURLFilter=stBlockedByURLFilter, mwgTraps=mwgTraps, stCategoriesEntry=stCategoriesEntry, stBadReputation=stBadReputation, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgEngineVersions=mwgEngineVersions, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpRequests=stHttpRequests, stFtpBytesToServer=stFtpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesFromServer=stHttpsBytesFromServer, kHotfixVersion=kHotfixVersion, PYSNMP_MODULE_ID=mwg, stCategoriesTable=stCategoriesTable, trApplication=trApplication, notifyAdditional=notifyAdditional, stClientCount=stClientCount, stHttpTraffic=stHttpTraffic, stCPULoadRaw=stCPULoadRaw, pTSDBVersion=pTSDBVersion, stCPULoad=stCPULoad, stHttpsRequests=stHttpsRequests, kMajorVersion=kMajorVersion, stFtpBytesFromServer=stFtpBytesFromServer, pMFEEngineVersion=pMFEEngineVersion, trSystem=trSystem, kRevision=kRevision, stHttpsTraffic=stHttpsTraffic, mwgContent=mwgContent, stFtpTraffic=stFtpTraffic, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesToClient=stFtpBytesToClient, stConnectionsBlocked=stConnectionsBlocked, mwgHttp=mwgHttp, stMalwareDetected=stMalwareDetected, stCategories=stCategories, mwgTrapVariables=mwgTrapVariables, stHandleConnectToServer=stHandleConnectToServer, mwgFTP=mwgFTP, kCustomVersion=kCustomVersion)
