...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, mib_2, iso, ObjectIdentity, MibIdentifier, ModuleIdentity, IpAddress, Bits, Integer32, TimeTicks, enterprises, Counter64, NotificationType, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "mib-2", "iso", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "IpAddress", "Bits", "Integer32", "TimeTicks", "enterprises", "Counter64", "NotificationType", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kMinorVersion=kMinorVersion, notifyAdditional=notifyAdditional, mwgContent=mwgContent, stBlockedByAntiMalware=stBlockedByAntiMalware, stMimeType=stMimeType, stFtpBytesFromClient=stFtpBytesFromClient, stCPULoad=stCPULoad, kRevision=kRevision, mwgEngineVersions=mwgEngineVersions, stClientCount=stClientCount, mwgTrapVariables=mwgTrapVariables, mwg=mwg, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyOrigin=notifyOrigin, stHttpBytesFromClient=stHttpBytesFromClient, stCategoryName=stCategoryName, stHttpBytesToClient=stHttpBytesToClient, stCPUIOWait=stCPUIOWait, stHttpsBytesFromServer=stHttpsBytesFromServer, stMemConsumed=stMemConsumed, stConnectionsBlocked=stConnectionsBlocked, mwgStatistics=mwgStatistics, mwgFTP=mwgFTP, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, notifyAffectedHost=notifyAffectedHost, stHttpsBytesToServer=stHttpsBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, kBuildNumber=kBuildNumber, mwgHttps=mwgHttps, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBadReputation=stBadReputation, pMFEEngineVersion=pMFEEngineVersion, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, stCPULoadRaw=stCPULoadRaw, stCategoryCount=stCategoryCount, kProductVersion=kProductVersion, mwgInfo=mwgInfo, pMFEDATVersion=pMFEDATVersion, kProductName=kProductName, mwgMiscellaneous=mwgMiscellaneous, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsTraffic=stHttpsTraffic, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategories=stCategories, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesToServer=stFtpBytesToServer, trUser=trUser, stHttpBytesToServer=stHttpBytesToServer, trSystem=trSystem, stHttpsRequests=stHttpsRequests, mwgHttp=mwgHttp, pAMEngineVersion=pAMEngineVersion, notifyOriginName=notifyOriginName, mwgTraps=mwgTraps, kHotfixVersion=kHotfixVersion, stMalwareDetected=stMalwareDetected, stHttpRequests=stHttpRequests, notifySeverity=notifySeverity, notifyReason=notifyReason, kCompanyName=kCompanyName, trApplication=trApplication, notifyReasonString=notifyReasonString, stHandleConnectToServer=stHandleConnectToServer, PYSNMP_MODULE_ID=mwg, kMicroVersion=kMicroVersion, stBlockedByURLFilter=stBlockedByURLFilter, stCategoriesEntry=stCategoriesEntry, kCustomVersion=kCustomVersion, stConnectedSockets=stConnectedSockets, kMajorVersion=kMajorVersion, stTimeForTransaction=stTimeForTransaction, stCategoriesTable=stCategoriesTable, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpTraffic=stFtpTraffic, stHttpTraffic=stHttpTraffic, pTSDBVersion=pTSDBVersion)
