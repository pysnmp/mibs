...
NotificationType, mib_2, Bits, Unsigned32, Counter32, IpAddress, enterprises, Counter64, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, TimeTicks, iso, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "mib-2", "Bits", "Unsigned32", "Counter32", "IpAddress", "enterprises", "Counter64", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "TimeTicks", "iso", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgTrapVariables=mwgTrapVariables, stMalwareDetected=stMalwareDetected, notifyReasonString=notifyReasonString, stHttpTraffic=stHttpTraffic, notifyAffectedHost=notifyAffectedHost, stBlockedByAntiMalware=stBlockedByAntiMalware, trSystem=trSystem, kCustomVersion=kCustomVersion, stBlockedByURLFilter=stBlockedByURLFilter, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, notifyReason=notifyReason, stResolveHostViaDNS=stResolveHostViaDNS, notifySeverity=notifySeverity, pMFEDATVersion=pMFEDATVersion, stFtpBytesFromServer=stFtpBytesFromServer, trUser=trUser, mwgTraps=mwgTraps, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttps=mwgHttps, stFtpBytesFromClient=stFtpBytesFromClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trApplication=trApplication, pAMSignatureVersion=pAMSignatureVersion, mwgEngineVersions=mwgEngineVersions, pAMProactiveVersion=pAMProactiveVersion, kMinorVersion=kMinorVersion, stFtpBytesToServer=stFtpBytesToServer, stCategoriesTable=stCategoriesTable, stHttpBytesToClient=stHttpBytesToClient, kMicroVersion=kMicroVersion, stCategoriesEntry=stCategoriesEntry, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesToServer=stHttpsBytesToServer, stCategories=stCategories, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgFTP=mwgFTP, stConnectedSockets=stConnectedSockets, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgHttp=mwgHttp, notifyOrigin=notifyOrigin, mwgContent=mwgContent, stHttpBytesFromClient=stHttpBytesFromClient, kMajorVersion=kMajorVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsTraffic=stHttpsTraffic, kProductVersion=kProductVersion, mwgMiscellaneous=mwgMiscellaneous, kBuildNumber=kBuildNumber, stCategoryCount=stCategoryCount, kCompanyName=kCompanyName, mwgInfo=mwgInfo, pTSDBVersion=pTSDBVersion, stMimeType=stMimeType, stFtpTraffic=stFtpTraffic, stHttpRequests=stHttpRequests, stCategoryName=stCategoryName, stBadReputation=stBadReputation, stTimeForTransaction=stTimeForTransaction, mwg=mwg, pAMEngineVersion=pAMEngineVersion, PYSNMP_MODULE_ID=mwg, stCPUIOWait=stCPUIOWait, kHotfixVersion=kHotfixVersion, stCPULoadRaw=stCPULoadRaw, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesToServer=stHttpBytesToServer, kRevision=kRevision, notifyAdditional=notifyAdditional, stClientCount=stClientCount, stHttpsRequests=stHttpsRequests, stCPULoad=stCPULoad, stMemConsumed=stMemConsumed, mwgStatistics=mwgStatistics, stHandleConnectToServer=stHandleConnectToServer, notifyOriginName=notifyOriginName, kProductName=kProductName)
