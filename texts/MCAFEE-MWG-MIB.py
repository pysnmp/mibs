...
enterprises, MibIdentifier, Counter32, NotificationType, TimeTicks, mib_2, Bits, Unsigned32, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, IpAddress, Integer32, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "Counter32", "NotificationType", "TimeTicks", "mib-2", "Bits", "Unsigned32", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "IpAddress", "Integer32", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBadReputation=stBadReputation, notifyReasonString=notifyReasonString, mwgTraps=mwgTraps, mwgHttps=mwgHttps, kMinorVersion=kMinorVersion, stHttpBytesToClient=stHttpBytesToClient, notifySeverity=notifySeverity, stMemConsumed=stMemConsumed, notifyAffectedHost=notifyAffectedHost, kBuildNumber=kBuildNumber, stFtpBytesToClient=stFtpBytesToClient, stFtpBytesToServer=stFtpBytesToServer, stMalwareDetected=stMalwareDetected, pAMProactiveVersion=pAMProactiveVersion, stConnectionsLegitimate=stConnectionsLegitimate, stConnectedSockets=stConnectedSockets, trSystem=trSystem, stFtpBytesFromClient=stFtpBytesFromClient, kMicroVersion=kMicroVersion, stCategoryName=stCategoryName, mwgMiscellaneous=mwgMiscellaneous, kProductName=kProductName, stClientCount=stClientCount, PYSNMP_MODULE_ID=mwg, mwgTrapVariables=mwgTrapVariables, mwgFTP=mwgFTP, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyOrigin=notifyOrigin, pTSDBVersion=pTSDBVersion, stCPULoad=stCPULoad, mwgInfo=mwgInfo, kHotfixVersion=kHotfixVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoriesTable=stCategoriesTable, stCPUIOWait=stCPUIOWait, stBlockedByMediaFilter=stBlockedByMediaFilter, kRevision=kRevision, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, stMimeType=stMimeType, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoriesEntry=stCategoriesEntry, kCustomVersion=kCustomVersion, mwg=mwg, stHttpRequests=stHttpRequests, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, kCompanyName=kCompanyName, stHttpsBytesFromServer=stHttpsBytesFromServer, kProductVersion=kProductVersion, stHttpBytesToServer=stHttpBytesToServer, stCPULoadRaw=stCPULoadRaw, stFtpTraffic=stFtpTraffic, notifyOriginName=notifyOriginName, stConnectionsBlocked=stConnectionsBlocked, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHandleConnectToServer=stHandleConnectToServer, stTimeForTransaction=stTimeForTransaction, stCategories=stCategories, kMajorVersion=kMajorVersion, stHttpsTraffic=stHttpsTraffic, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, trUser=trUser, stBlockedByURLFilter=stBlockedByURLFilter, mwgStatistics=mwgStatistics, notifyAdditional=notifyAdditional, stHttpTraffic=stHttpTraffic, pAMEngineVersion=pAMEngineVersion, notifyReason=notifyReason, stCategoryCount=stCategoryCount, trApplication=trApplication, pMFEEngineVersion=pMFEEngineVersion, mwgContent=mwgContent, pMFEDATVersion=pMFEDATVersion, mwgEngineVersions=mwgEngineVersions, stHttpsRequests=stHttpsRequests, mwgHttp=mwgHttp)
