...
mib_2, NotificationType, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, enterprises, ModuleIdentity, Unsigned32, Gauge32, ObjectIdentity, MibIdentifier, TimeTicks, Counter64, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "NotificationType", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "enterprises", "ModuleIdentity", "Unsigned32", "Gauge32", "ObjectIdentity", "MibIdentifier", "TimeTicks", "Counter64", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", PYSNMP_MODULE_ID=mwg, stHttpTraffic=stHttpTraffic, stFtpBytesFromClient=stFtpBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, stHttpsRequests=stHttpsRequests, stConnectedSockets=stConnectedSockets, trApplication=trApplication, mwgTraps=mwgTraps, kMajorVersion=kMajorVersion, stMimeType=stMimeType, stHttpsBytesToServer=stHttpsBytesToServer, stMemConsumed=stMemConsumed, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kProductVersion=kProductVersion, stTimeForTransaction=stTimeForTransaction, notifyReason=notifyReason, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stResolveHostViaDNS=stResolveHostViaDNS, notifyAdditional=notifyAdditional, notifyReasonString=notifyReasonString, stCategoryName=stCategoryName, stHandleConnectToServer=stHandleConnectToServer, pMFEDATVersion=pMFEDATVersion, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, kProductName=kProductName, stMalwareDetected=stMalwareDetected, kCompanyName=kCompanyName, pAMProactiveVersion=pAMProactiveVersion, trUser=trUser, notifyOrigin=notifyOrigin, stCategoriesEntry=stCategoriesEntry, mwgEngineVersions=mwgEngineVersions, pTSDBVersion=pTSDBVersion, stHttpsTraffic=stHttpsTraffic, stHttpsBytesToClient=stHttpsBytesToClient, mwgStatistics=mwgStatistics, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoryCount=stCategoryCount, stHttpRequests=stHttpRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesToClient=stHttpBytesToClient, pAMEngineVersion=pAMEngineVersion, pMFEEngineVersion=pMFEEngineVersion, mwgMiscellaneous=mwgMiscellaneous, stConnectionsLegitimate=stConnectionsLegitimate, stClientCount=stClientCount, mwg=mwg, stCategories=stCategories, notifySeverity=notifySeverity, notifyAffectedHost=notifyAffectedHost, stBadReputation=stBadReputation, kRevision=kRevision, stCPUIOWait=stCPUIOWait, mwgHttps=mwgHttps, mwgFTP=mwgFTP, kBuildNumber=kBuildNumber, stHttpBytesFromClient=stHttpBytesFromClient, stCategoriesTable=stCategoriesTable, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpBytesToServer=stFtpBytesToServer, kMinorVersion=kMinorVersion, mwgTrapVariables=mwgTrapVariables, kHotfixVersion=kHotfixVersion, kCustomVersion=kCustomVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, kMicroVersion=kMicroVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyOriginName=notifyOriginName, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesFromServer=stHttpBytesFromServer, stCPULoadRaw=stCPULoadRaw, mwgContent=mwgContent, stHttpBytesToServer=stHttpBytesToServer, stBlockedByURLFilter=stBlockedByURLFilter, mwgHttp=mwgHttp, stCPULoad=stCPULoad, stFtpTraffic=stFtpTraffic, trSystem=trSystem, stConnectionsBlocked=stConnectionsBlocked, mwgInfo=mwgInfo)
