...
Gauge32, mib_2, iso, IpAddress, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ModuleIdentity, Unsigned32, MibIdentifier, NotificationType, TimeTicks, Counter64, NotificationType, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "mib-2", "iso", "IpAddress", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ModuleIdentity", "Unsigned32", "MibIdentifier", "NotificationType", "TimeTicks", "Counter64", "NotificationType", "Bits", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHandleConnectToServer=stHandleConnectToServer, stHttpBytesFromClient=stHttpBytesFromClient, stClientCount=stClientCount, notifyOrigin=notifyOrigin, stHttpsTraffic=stHttpsTraffic, notifyReasonString=notifyReasonString, stConnectionsLegitimate=stConnectionsLegitimate, trApplication=trApplication, kMajorVersion=kMajorVersion, notifyAdditional=notifyAdditional, kCustomVersion=kCustomVersion, trSystem=trSystem, stHttpsBytesFromClient=stHttpsBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, kCompanyName=kCompanyName, mwgFTP=mwgFTP, kHotfixVersion=kHotfixVersion, stCategoriesEntry=stCategoriesEntry, notifyOriginName=notifyOriginName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpRequests=stHttpRequests, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesToClient=stFtpBytesToClient, stResolveHostViaDNS=stResolveHostViaDNS, notifyAffectedHost=notifyAffectedHost, stMemConsumed=stMemConsumed, mwgStatistics=mwgStatistics, pMFEDATVersion=pMFEDATVersion, mwgTraps=mwgTraps, stCategoryCount=stCategoryCount, stHttpBytesToServer=stHttpBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pTSDBVersion=pTSDBVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgInfo=mwgInfo, stMalwareDetected=stMalwareDetected, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgTrapVariables=mwgTrapVariables, kProductVersion=kProductVersion, stCPUIOWait=stCPUIOWait, stBlockedByURLFilter=stBlockedByURLFilter, mwgMiscellaneous=mwgMiscellaneous, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategories=stCategories, stCPULoadRaw=stCPULoadRaw, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCPULoad=stCPULoad, notifySeverity=notifySeverity, mwgHttp=mwgHttp, stCategoriesTable=stCategoriesTable, stHttpsRequests=stHttpsRequests, stFtpBytesToServer=stFtpBytesToServer, stFtpBytesFromClient=stFtpBytesFromClient, stHttpTraffic=stHttpTraffic, kMinorVersion=kMinorVersion, stConnectionsBlocked=stConnectionsBlocked, PYSNMP_MODULE_ID=mwg, pAMSignatureVersion=pAMSignatureVersion, kMicroVersion=kMicroVersion, kBuildNumber=kBuildNumber, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectedSockets=stConnectedSockets, pAMEngineVersion=pAMEngineVersion, stHttpsBytesToClient=stHttpsBytesToClient, stCategoryName=stCategoryName, stHttpsBytesToServer=stHttpsBytesToServer, stTimeForTransaction=stTimeForTransaction, stMimeType=stMimeType, mwgHttps=mwgHttps, mwgContent=mwgContent, mwgEngineVersions=mwgEngineVersions, trUser=trUser, stBadReputation=stBadReputation, notifyReason=notifyReason, kRevision=kRevision, stHttpBytesToClient=stHttpBytesToClient, mwg=mwg, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpTraffic=stFtpTraffic, kProductName=kProductName, stHttpBytesFromServer=stHttpBytesFromServer, pAMProactiveVersion=pAMProactiveVersion)
