...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, enterprises, Counter64, Counter32, Unsigned32, Integer32, NotificationType, NotificationType, ModuleIdentity, iso, Bits, TimeTicks, IpAddress, MibIdentifier, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "enterprises", "Counter64", "Counter32", "Unsigned32", "Integer32", "NotificationType", "NotificationType", "ModuleIdentity", "iso", "Bits", "TimeTicks", "IpAddress", "MibIdentifier", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", trSystem=trSystem, stHandleConnectToServer=stHandleConnectToServer, mwgTraps=mwgTraps, stCategoriesEntry=stCategoriesEntry, notifyReason=notifyReason, mwgHttps=mwgHttps, mwg=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCPULoadRaw=stCPULoadRaw, PYSNMP_MODULE_ID=mwg, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMemConsumed=stMemConsumed, mwgEngineVersions=mwgEngineVersions, pAMSignatureVersion=pAMSignatureVersion, stCategoryCount=stCategoryCount, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesFromClient=stFtpBytesFromClient, pTSDBVersion=pTSDBVersion, kHotfixVersion=kHotfixVersion, notifyReasonString=notifyReasonString, stHttpsBytesFromServer=stHttpsBytesFromServer, kMajorVersion=kMajorVersion, mwgContent=mwgContent, mwgTrapVariables=mwgTrapVariables, kRevision=kRevision, notifyOrigin=notifyOrigin, notifyOriginName=notifyOriginName, trApplication=trApplication, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, stCPULoad=stCPULoad, stHttpRequests=stHttpRequests, stHttpsRequests=stHttpsRequests, notifyAdditional=notifyAdditional, pMFEDATVersion=pMFEDATVersion, mwgHttp=mwgHttp, kProductName=kProductName, stHttpsBytesToServer=stHttpsBytesToServer, pMFEEngineVersion=pMFEEngineVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMinorVersion=kMinorVersion, stConnectionsBlocked=stConnectionsBlocked, stBlockedByURLFilter=stBlockedByURLFilter, stConnectedSockets=stConnectedSockets, stCategories=stCategories, kCustomVersion=kCustomVersion, stHttpsTraffic=stHttpsTraffic, pAMEngineVersion=pAMEngineVersion, stMimeType=stMimeType, mwgInfo=mwgInfo, trUser=trUser, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesToServer=stFtpBytesToServer, stConnectionsLegitimate=stConnectionsLegitimate, stBlockedByMediaFilter=stBlockedByMediaFilter, stClientCount=stClientCount, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesFromServer=stFtpBytesFromServer, mwgFTP=mwgFTP, stBadReputation=stBadReputation, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, stTimeForTransaction=stTimeForTransaction, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, stCategoryName=stCategoryName, stCategoriesTable=stCategoriesTable, stHttpsBytesToClient=stHttpsBytesToClient, stFtpTraffic=stFtpTraffic, kProductVersion=kProductVersion, stFtpBytesToClient=stFtpBytesToClient, kMicroVersion=kMicroVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgStatistics=mwgStatistics, stCPUIOWait=stCPUIOWait, stHttpTraffic=stHttpTraffic, kCompanyName=kCompanyName, notifyAffectedHost=notifyAffectedHost, mwgMiscellaneous=mwgMiscellaneous, notifySeverity=notifySeverity, kBuildNumber=kBuildNumber)
