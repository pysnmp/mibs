...
MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, MibIdentifier, IpAddress, Gauge32, iso, Unsigned32, enterprises, Bits, TimeTicks, Counter32, NotificationType, ModuleIdentity, Counter64, Integer32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "MibIdentifier", "IpAddress", "Gauge32", "iso", "Unsigned32", "enterprises", "Bits", "TimeTicks", "Counter32", "NotificationType", "ModuleIdentity", "Counter64", "Integer32", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMemConsumed=stMemConsumed, stCategoriesTable=stCategoriesTable, kBuildNumber=kBuildNumber, stHttpsBytesToClient=stHttpsBytesToClient, PYSNMP_MODULE_ID=mwg, stHttpsBytesFromClient=stHttpsBytesFromClient, pTSDBVersion=pTSDBVersion, kMajorVersion=kMajorVersion, notifyAdditional=notifyAdditional, trApplication=trApplication, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesToServer=stHttpBytesToServer, mwgInfo=mwgInfo, mwgStatistics=mwgStatistics, kCompanyName=kCompanyName, stHandleConnectToServer=stHandleConnectToServer, stHttpRequests=stHttpRequests, kProductVersion=kProductVersion, notifyReasonString=notifyReasonString, stCategoriesEntry=stCategoriesEntry, mwgTrapVariables=mwgTrapVariables, kProductName=kProductName, pAMSignatureVersion=pAMSignatureVersion, stBadReputation=stBadReputation, mwgFTP=mwgFTP, stHttpBytesFromServer=stHttpBytesFromServer, trSystem=trSystem, mwgHttps=mwgHttps, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyOrigin=notifyOrigin, notifyReason=notifyReason, stCPULoad=stCPULoad, stResolveHostViaDNS=stResolveHostViaDNS, pMFEEngineVersion=pMFEEngineVersion, stCPULoadRaw=stCPULoadRaw, notifySeverity=notifySeverity, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesToClient=stHttpBytesToClient, stCategories=stCategories, stConnectionsLegitimate=stConnectionsLegitimate, trUser=trUser, stFtpBytesFromClient=stFtpBytesFromClient, stCategoryCount=stCategoryCount, stHttpsRequests=stHttpsRequests, stCPUIOWait=stCPUIOWait, mwgEngineVersions=mwgEngineVersions, stFtpBytesFromServer=stFtpBytesFromServer, notifyOriginName=notifyOriginName, kHotfixVersion=kHotfixVersion, stFtpTraffic=stFtpTraffic, stFtpBytesToServer=stFtpBytesToServer, pMFEDATVersion=pMFEDATVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, kCustomVersion=kCustomVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByURLFilter=stBlockedByURLFilter, stClientCount=stClientCount, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, kRevision=kRevision, stCategoryName=stCategoryName, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgMiscellaneous=mwgMiscellaneous, mwgTraps=mwgTraps, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyAffectedHost=notifyAffectedHost, stFtpBytesToClient=stFtpBytesToClient, stHttpsTraffic=stHttpsTraffic, stHttpTraffic=stHttpTraffic, pAMProactiveVersion=pAMProactiveVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pAMEngineVersion=pAMEngineVersion, kMicroVersion=kMicroVersion, stMimeType=stMimeType, stHttpBytesFromClient=stHttpBytesFromClient, mwg=mwg, mwgContent=mwgContent, kMinorVersion=kMinorVersion, mwgHttp=mwgHttp, stTimeForTransaction=stTimeForTransaction, stConnectionsBlocked=stConnectionsBlocked, stConnectedSockets=stConnectedSockets)
