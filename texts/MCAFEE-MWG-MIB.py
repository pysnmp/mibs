...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, ModuleIdentity, Integer32, ObjectIdentity, Counter64, NotificationType, MibIdentifier, iso, Counter32, IpAddress, Bits, mib_2, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "ModuleIdentity", "Integer32", "ObjectIdentity", "Counter64", "NotificationType", "MibIdentifier", "iso", "Counter32", "IpAddress", "Bits", "mib-2", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMalwareDetected=stMalwareDetected, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stTimeForTransaction=stTimeForTransaction, stFtpBytesFromServer=stFtpBytesFromServer, stCategories=stCategories, mwgContent=mwgContent, stCPULoad=stCPULoad, stConnectedSockets=stConnectedSockets, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsRequests=stHttpsRequests, stBlockedByMediaFilter=stBlockedByMediaFilter, kMicroVersion=kMicroVersion, mwg=mwg, stHttpBytesFromServer=stHttpBytesFromServer, kProductName=kProductName, stHandleConnectToServer=stHandleConnectToServer, mwgMiscellaneous=mwgMiscellaneous, kProductVersion=kProductVersion, notifySeverity=notifySeverity, stCategoryName=stCategoryName, trSystem=trSystem, stCategoriesTable=stCategoriesTable, stMemConsumed=stMemConsumed, stHttpBytesToServer=stHttpBytesToServer, stHttpsTraffic=stHttpsTraffic, pAMSignatureVersion=pAMSignatureVersion, stClientCount=stClientCount, stHttpTraffic=stHttpTraffic, stHttpsBytesToServer=stHttpsBytesToServer, mwgStatistics=mwgStatistics, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgHttp=mwgHttp, stCategoriesEntry=stCategoriesEntry, PYSNMP_MODULE_ID=mwg, pMFEEngineVersion=pMFEEngineVersion, stMimeType=stMimeType, stBadReputation=stBadReputation, stCPUIOWait=stCPUIOWait, stFtpBytesToServer=stFtpBytesToServer, kMajorVersion=kMajorVersion, kRevision=kRevision, mwgTraps=mwgTraps, notifyReason=notifyReason, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoryCount=stCategoryCount, stResolveHostViaDNS=stResolveHostViaDNS, stCPULoadRaw=stCPULoadRaw, stConnectionsBlocked=stConnectionsBlocked, mwgFTP=mwgFTP, stHttpsBytesToClient=stHttpsBytesToClient, mwgHttps=mwgHttps, notifyAdditional=notifyAdditional, pAMProactiveVersion=pAMProactiveVersion, kHotfixVersion=kHotfixVersion, stHttpBytesToClient=stHttpBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgTrapVariables=mwgTrapVariables, stHttpRequests=stHttpRequests, pAMEngineVersion=pAMEngineVersion, kMinorVersion=kMinorVersion, trApplication=trApplication, notifyAffectedHost=notifyAffectedHost, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesFromServer=stHttpsBytesFromServer, kBuildNumber=kBuildNumber, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyReasonString=notifyReasonString, trUser=trUser, pMFEDATVersion=pMFEDATVersion, notifyOriginName=notifyOriginName, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesFromClient=stFtpBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kCustomVersion=kCustomVersion, stFtpBytesToClient=stFtpBytesToClient, pTSDBVersion=pTSDBVersion, stFtpTraffic=stFtpTraffic, kCompanyName=kCompanyName, mwgEngineVersions=mwgEngineVersions, notifyOrigin=notifyOrigin, stBlockedByURLFilter=stBlockedByURLFilter, mwgInfo=mwgInfo)
