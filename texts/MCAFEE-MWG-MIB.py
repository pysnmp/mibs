...
iso, Counter64, Gauge32, NotificationType, TimeTicks, NotificationType, MibIdentifier, ModuleIdentity, Counter32, Bits, enterprises, IpAddress, Unsigned32, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "Gauge32", "NotificationType", "TimeTicks", "NotificationType", "MibIdentifier", "ModuleIdentity", "Counter32", "Bits", "enterprises", "IpAddress", "Unsigned32", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stClientCount=stClientCount, notifyAdditional=notifyAdditional, kMajorVersion=kMajorVersion, stHttpBytesFromServer=stHttpBytesFromServer, stBadReputation=stBadReputation, stMalwareDetected=stMalwareDetected, kCustomVersion=kCustomVersion, stHttpRequests=stHttpRequests, stCategoryName=stCategoryName, kRevision=kRevision, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kProductName=kProductName, PYSNMP_MODULE_ID=mwg, mwgTraps=mwgTraps, stFtpBytesToClient=stFtpBytesToClient, notifyAffectedHost=notifyAffectedHost, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByURLFilter=stBlockedByURLFilter, stCategoriesTable=stCategoriesTable, kBuildNumber=kBuildNumber, stConnectedSockets=stConnectedSockets, stFtpBytesFromClient=stFtpBytesFromClient, stFtpTraffic=stFtpTraffic, pAMProactiveVersion=pAMProactiveVersion, kCompanyName=kCompanyName, pTSDBVersion=pTSDBVersion, stCategoryCount=stCategoryCount, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesFromClient=stHttpBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMemConsumed=stMemConsumed, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoad=stCPULoad, mwgInfo=mwgInfo, mwgFTP=mwgFTP, mwgEngineVersions=mwgEngineVersions, mwgHttps=mwgHttps, pAMEngineVersion=pAMEngineVersion, stCPUIOWait=stCPUIOWait, pMFEDATVersion=pMFEDATVersion, kMicroVersion=kMicroVersion, stHttpsBytesToServer=stHttpsBytesToServer, pAMSignatureVersion=pAMSignatureVersion, stHttpBytesToServer=stHttpBytesToServer, kProductVersion=kProductVersion, trUser=trUser, stResolveHostViaDNS=stResolveHostViaDNS, stTimeForTransaction=stTimeForTransaction, stHttpsTraffic=stHttpsTraffic, mwgTrapVariables=mwgTrapVariables, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, kMinorVersion=kMinorVersion, stHttpBytesToClient=stHttpBytesToClient, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesToClient=stHttpsBytesToClient, notifyReason=notifyReason, notifyReasonString=notifyReasonString, stCPULoadRaw=stCPULoadRaw, mwg=mwg, stBlockedByMediaFilter=stBlockedByMediaFilter, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trSystem=trSystem, stFtpBytesToServer=stFtpBytesToServer, stHttpTraffic=stHttpTraffic, mwgStatistics=mwgStatistics, stHandleConnectToServer=stHandleConnectToServer, stHttpsRequests=stHttpsRequests, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoriesEntry=stCategoriesEntry, mwgContent=mwgContent, mwgHttp=mwgHttp, pMFEEngineVersion=pMFEEngineVersion, notifySeverity=notifySeverity, notifyOriginName=notifyOriginName, stMimeType=stMimeType, trApplication=trApplication, kHotfixVersion=kHotfixVersion, notifyOrigin=notifyOrigin, stConnectionsBlocked=stConnectionsBlocked, stCategories=stCategories, stHttpsBytesFromServer=stHttpsBytesFromServer)
