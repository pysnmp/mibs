...
Gauge32, Bits, enterprises, Integer32, NotificationType, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, mib_2, ModuleIdentity, Counter64, NotificationType, ObjectIdentity, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "enterprises", "Integer32", "NotificationType", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "mib-2", "ModuleIdentity", "Counter64", "NotificationType", "ObjectIdentity", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgInfo=mwgInfo, stCPULoadRaw=stCPULoadRaw, stResolveHostViaDNS=stResolveHostViaDNS, stConnectionsLegitimate=stConnectionsLegitimate, trUser=trUser, stConnectedSockets=stConnectedSockets, mwgStatistics=mwgStatistics, notifyReasonString=notifyReasonString, PYSNMP_MODULE_ID=mwg, kBuildNumber=kBuildNumber, stCategoryCount=stCategoryCount, stFtpBytesFromServer=stFtpBytesFromServer, notifyOriginName=notifyOriginName, notifyReason=notifyReason, stClientCount=stClientCount, stHttpTraffic=stHttpTraffic, stHttpBytesFromClient=stHttpBytesFromClient, mwgEngineVersions=mwgEngineVersions, mwgHttps=mwgHttps, stHttpsRequests=stHttpsRequests, stMimeType=stMimeType, kMicroVersion=kMicroVersion, stMemConsumed=stMemConsumed, stConnectionsBlocked=stConnectionsBlocked, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kHotfixVersion=kHotfixVersion, stHttpsBytesToServer=stHttpsBytesToServer, kCompanyName=kCompanyName, stHttpBytesFromServer=stHttpBytesFromServer, stCategoryName=stCategoryName, stFtpBytesToClient=stFtpBytesToClient, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesToClient=stHttpsBytesToClient, kMajorVersion=kMajorVersion, stHandleConnectToServer=stHandleConnectToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesToServer=stFtpBytesToServer, mwgTrapVariables=mwgTrapVariables, pTSDBVersion=pTSDBVersion, notifyAdditional=notifyAdditional, notifyOrigin=notifyOrigin, pAMProactiveVersion=pAMProactiveVersion, stBlockedByURLFilter=stBlockedByURLFilter, kProductVersion=kProductVersion, notifySeverity=notifySeverity, trSystem=trSystem, stHttpBytesToClient=stHttpBytesToClient, kMinorVersion=kMinorVersion, stMalwareDetected=stMalwareDetected, stCategoriesTable=stCategoriesTable, mwgContent=mwgContent, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttp=mwgHttp, stHttpBytesToServer=stHttpBytesToServer, mwgTraps=mwgTraps, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsTraffic=stHttpsTraffic, pMFEDATVersion=pMFEDATVersion, mwgFTP=mwgFTP, kProductName=kProductName, stBadReputation=stBadReputation, mwg=mwg, stTimeForTransaction=stTimeForTransaction, trApplication=trApplication, stHttpRequests=stHttpRequests, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoriesEntry=stCategoriesEntry, stCPULoad=stCPULoad, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyAffectedHost=notifyAffectedHost, stFtpTraffic=stFtpTraffic, kCustomVersion=kCustomVersion, pAMEngineVersion=pAMEngineVersion, stCategories=stCategories, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, kRevision=kRevision, pAMSignatureVersion=pAMSignatureVersion, stCPUIOWait=stCPUIOWait)
