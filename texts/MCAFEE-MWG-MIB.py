...
Bits, ObjectIdentity, Counter64, NotificationType, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, ModuleIdentity, Integer32, Counter32, Unsigned32, iso, enterprises, mib_2, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "Counter64", "NotificationType", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "ModuleIdentity", "Integer32", "Counter32", "Unsigned32", "iso", "enterprises", "mib-2", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpTraffic=stHttpTraffic, PYSNMP_MODULE_ID=mwg, stHttpsBytesToClient=stHttpsBytesToClient, stCategoryCount=stCategoryCount, stClientCount=stClientCount, notifyOriginName=notifyOriginName, notifyAffectedHost=notifyAffectedHost, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgStatistics=mwgStatistics, mwgContent=mwgContent, stFtpBytesFromServer=stFtpBytesFromServer, mwgInfo=mwgInfo, mwgHttp=mwgHttp, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHandleConnectToServer=stHandleConnectToServer, notifyReason=notifyReason, kProductName=kProductName, stCPULoad=stCPULoad, kMinorVersion=kMinorVersion, stCPUIOWait=stCPUIOWait, trUser=trUser, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMProactiveVersion=pAMProactiveVersion, notifyAdditional=notifyAdditional, notifyOrigin=notifyOrigin, stCPULoadRaw=stCPULoadRaw, kMajorVersion=kMajorVersion, stConnectionsBlocked=stConnectionsBlocked, stConnectedSockets=stConnectedSockets, stMemConsumed=stMemConsumed, stResolveHostViaDNS=stResolveHostViaDNS, stBadReputation=stBadReputation, stConnectionsLegitimate=stConnectionsLegitimate, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kRevision=kRevision, stTimeForTransaction=stTimeForTransaction, pAMEngineVersion=pAMEngineVersion, mwgTrapVariables=mwgTrapVariables, stBlockedByURLFilter=stBlockedByURLFilter, notifyReasonString=notifyReasonString, notifySeverity=notifySeverity, stHttpsRequests=stHttpsRequests, pTSDBVersion=pTSDBVersion, stCategoriesTable=stCategoriesTable, stHttpBytesFromServer=stHttpBytesFromServer, stHttpBytesFromClient=stHttpBytesFromClient, stCategories=stCategories, stHttpsBytesToServer=stHttpsBytesToServer, stMimeType=stMimeType, stHttpBytesToClient=stHttpBytesToClient, stHttpRequests=stHttpRequests, pMFEDATVersion=pMFEDATVersion, stHttpBytesToServer=stHttpBytesToServer, stCategoryName=stCategoryName, stFtpTraffic=stFtpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kBuildNumber=kBuildNumber, mwgFTP=mwgFTP, trSystem=trSystem, trApplication=trApplication, kCustomVersion=kCustomVersion, stHttpsTraffic=stHttpsTraffic, stHttpsBytesFromServer=stHttpsBytesFromServer, kProductVersion=kProductVersion, kCompanyName=kCompanyName, stFtpBytesToClient=stFtpBytesToClient, mwgTraps=mwgTraps, stMalwareDetected=stMalwareDetected, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesToServer=stFtpBytesToServer, mwgMiscellaneous=mwgMiscellaneous, stCategoriesEntry=stCategoriesEntry, mwgEngineVersions=mwgEngineVersions, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pAMSignatureVersion=pAMSignatureVersion, mwg=mwg, stHttpsBytesFromClient=stHttpsBytesFromClient, kMicroVersion=kMicroVersion, kHotfixVersion=kHotfixVersion, pMFEEngineVersion=pMFEEngineVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgHttps=mwgHttps, stBlockedByMediaFilter=stBlockedByMediaFilter)
