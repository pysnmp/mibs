...
Integer32, Counter64, ModuleIdentity, NotificationType, NotificationType, Unsigned32, IpAddress, iso, Gauge32, TimeTicks, Counter32, mib_2, Bits, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "ModuleIdentity", "NotificationType", "NotificationType", "Unsigned32", "IpAddress", "iso", "Gauge32", "TimeTicks", "Counter32", "mib-2", "Bits", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pTSDBVersion=pTSDBVersion, stHttpRequests=stHttpRequests, stFtpBytesToClient=stFtpBytesToClient, stCategoriesTable=stCategoriesTable, pMFEEngineVersion=pMFEEngineVersion, mwgMiscellaneous=mwgMiscellaneous, stCPULoadRaw=stCPULoadRaw, stConnectionsLegitimate=stConnectionsLegitimate, notifyReasonString=notifyReasonString, stHttpsBytesToClient=stHttpsBytesToClient, kMicroVersion=kMicroVersion, notifyOrigin=notifyOrigin, pAMProactiveVersion=pAMProactiveVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgHttp=mwgHttp, stFtpBytesFromClient=stFtpBytesFromClient, stMalwareDetected=stMalwareDetected, stHandleConnectToServer=stHandleConnectToServer, stMemConsumed=stMemConsumed, mwgStatistics=mwgStatistics, stBadReputation=stBadReputation, stCPULoad=stCPULoad, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCPUIOWait=stCPUIOWait, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsRequests=stHttpsRequests, kProductName=kProductName, stHttpBytesFromServer=stHttpBytesFromServer, mwgEngineVersions=mwgEngineVersions, stCategoryCount=stCategoryCount, notifyAffectedHost=notifyAffectedHost, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMinorVersion=kMinorVersion, stCategoriesEntry=stCategoriesEntry, stHttpBytesToClient=stHttpBytesToClient, stBlockedByURLFilter=stBlockedByURLFilter, mwgInfo=mwgInfo, stHttpTraffic=stHttpTraffic, mwgTraps=mwgTraps, pMFEDATVersion=pMFEDATVersion, stConnectedSockets=stConnectedSockets, stFtpTraffic=stFtpTraffic, kCustomVersion=kCustomVersion, kRevision=kRevision, stMimeType=stMimeType, pAMSignatureVersion=pAMSignatureVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kHotfixVersion=kHotfixVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, kProductVersion=kProductVersion, notifyReason=notifyReason, stClientCount=stClientCount, mwgHttps=mwgHttps, stFtpBytesToServer=stFtpBytesToServer, notifyAdditional=notifyAdditional, stHttpsTraffic=stHttpsTraffic, notifySeverity=notifySeverity, mwg=mwg, trUser=trUser, mwgTrapVariables=mwgTrapVariables, notifyOriginName=notifyOriginName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesFromServer=stFtpBytesFromServer, trSystem=trSystem, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesToServer=stHttpsBytesToServer, kCompanyName=kCompanyName, stHttpsBytesFromClient=stHttpsBytesFromClient, kMajorVersion=kMajorVersion, stConnectionsBlocked=stConnectionsBlocked, mwgFTP=mwgFTP, stHttpBytesFromClient=stHttpBytesFromClient, stCategoryName=stCategoryName, pAMEngineVersion=pAMEngineVersion, kBuildNumber=kBuildNumber, trApplication=trApplication, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategories=stCategories, mwgContent=mwgContent, PYSNMP_MODULE_ID=mwg, stTimeForTransaction=stTimeForTransaction)
