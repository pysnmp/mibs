...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, IpAddress, Bits, Unsigned32, mib_2, enterprises, NotificationType, Counter32, iso, NotificationType, Gauge32, ModuleIdentity, ObjectIdentity, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "IpAddress", "Bits", "Unsigned32", "mib-2", "enterprises", "NotificationType", "Counter32", "iso", "NotificationType", "Gauge32", "ModuleIdentity", "ObjectIdentity", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpTraffic=stFtpTraffic, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesToServer=stFtpBytesToServer, kCompanyName=kCompanyName, kMinorVersion=kMinorVersion, trApplication=trApplication, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpBytesToClient=stFtpBytesToClient, pAMEngineVersion=pAMEngineVersion, notifyAffectedHost=notifyAffectedHost, mwgMiscellaneous=mwgMiscellaneous, kMajorVersion=kMajorVersion, mwgFTP=mwgFTP, stBlockedByURLFilter=stBlockedByURLFilter, mwgHttp=mwgHttp, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyReason=notifyReason, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsTraffic=stHttpsTraffic, stCategoriesTable=stCategoriesTable, stHttpBytesFromServer=stHttpBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, stConnectionsLegitimate=stConnectionsLegitimate, mwgContent=mwgContent, notifyOriginName=notifyOriginName, stCategories=stCategories, stHttpBytesToServer=stHttpBytesToServer, mwgEngineVersions=mwgEngineVersions, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpTraffic=stHttpTraffic, mwg=mwg, stMemConsumed=stMemConsumed, notifyOrigin=notifyOrigin, notifySeverity=notifySeverity, stCategoryCount=stCategoryCount, stHttpRequests=stHttpRequests, stBadReputation=stBadReputation, trSystem=trSystem, stTimeForTransaction=stTimeForTransaction, stCategoryName=stCategoryName, notifyReasonString=notifyReasonString, pTSDBVersion=pTSDBVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stResolveHostViaDNS=stResolveHostViaDNS, kCustomVersion=kCustomVersion, kProductName=kProductName, stFtpBytesFromServer=stFtpBytesFromServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kRevision=kRevision, stCategoriesEntry=stCategoriesEntry, stCPUIOWait=stCPUIOWait, stHttpBytesFromClient=stHttpBytesFromClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kBuildNumber=kBuildNumber, stHttpsRequests=stHttpsRequests, stMalwareDetected=stMalwareDetected, trUser=trUser, notifyAdditional=notifyAdditional, kProductVersion=kProductVersion, pMFEDATVersion=pMFEDATVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, PYSNMP_MODULE_ID=mwg, stHttpsBytesToServer=stHttpsBytesToServer, stConnectionsBlocked=stConnectionsBlocked, stClientCount=stClientCount, mwgTraps=mwgTraps, stFtpBytesFromClient=stFtpBytesFromClient, kHotfixVersion=kHotfixVersion, stCPULoadRaw=stCPULoadRaw, stMimeType=stMimeType, mwgStatistics=mwgStatistics, stHttpBytesToClient=stHttpBytesToClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTrapVariables=mwgTrapVariables, pMFEEngineVersion=pMFEEngineVersion, pAMProactiveVersion=pAMProactiveVersion, stHandleConnectToServer=stHandleConnectToServer, mwgHttps=mwgHttps, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgInfo=mwgInfo, kMicroVersion=kMicroVersion, stConnectedSockets=stConnectedSockets, stCPULoad=stCPULoad)
