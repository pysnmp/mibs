...
Gauge32, iso, Unsigned32, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, IpAddress, enterprises, MibIdentifier, mib_2, Counter32, Integer32, Bits, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "Unsigned32", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "IpAddress", "enterprises", "MibIdentifier", "mib-2", "Counter32", "Integer32", "Bits", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kBuildNumber=kBuildNumber, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMajorVersion=kMajorVersion, mwgHttp=mwgHttp, stCategories=stCategories, stHttpBytesFromServer=stHttpBytesFromServer, notifySeverity=notifySeverity, stFtpBytesToServer=stFtpBytesToServer, stMemConsumed=stMemConsumed, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoad=stCPULoad, trApplication=trApplication, notifyOrigin=notifyOrigin, PYSNMP_MODULE_ID=mwg, stCategoriesEntry=stCategoriesEntry, stFtpTraffic=stFtpTraffic, stHttpsRequests=stHttpsRequests, notifyOriginName=notifyOriginName, pAMEngineVersion=pAMEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesToClient=stHttpBytesToClient, stBlockedByAntiMalware=stBlockedByAntiMalware, kProductVersion=kProductVersion, mwgEngineVersions=mwgEngineVersions, stResolveHostViaDNS=stResolveHostViaDNS, kMicroVersion=kMicroVersion, pMFEEngineVersion=pMFEEngineVersion, kProductName=kProductName, stBlockedByMediaFilter=stBlockedByMediaFilter, pAMSignatureVersion=pAMSignatureVersion, pTSDBVersion=pTSDBVersion, notifyAffectedHost=notifyAffectedHost, stConnectionsBlocked=stConnectionsBlocked, stMalwareDetected=stMalwareDetected, stFtpBytesToClient=stFtpBytesToClient, kRevision=kRevision, mwg=mwg, notifyReasonString=notifyReasonString, stTimeForTransaction=stTimeForTransaction, stCategoryName=stCategoryName, trUser=trUser, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsTraffic=stHttpsTraffic, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgMiscellaneous=mwgMiscellaneous, kCompanyName=kCompanyName, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHandleConnectToServer=stHandleConnectToServer, mwgInfo=mwgInfo, stBadReputation=stBadReputation, stCPUIOWait=stCPUIOWait, kCustomVersion=kCustomVersion, stConnectedSockets=stConnectedSockets, mwgStatistics=mwgStatistics, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, stCPULoadRaw=stCPULoadRaw, notifyReason=notifyReason, pMFEDATVersion=pMFEDATVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kHotfixVersion=kHotfixVersion, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesFromServer=stFtpBytesFromServer, kMinorVersion=kMinorVersion, notifyAdditional=notifyAdditional, mwgHttps=mwgHttps, stConnectionsLegitimate=stConnectionsLegitimate, stMimeType=stMimeType, stClientCount=stClientCount, mwgTraps=mwgTraps, stCategoriesTable=stCategoriesTable, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpTraffic=stHttpTraffic, mwgContent=mwgContent, trSystem=trSystem, stHttpRequests=stHttpRequests, stCategoryCount=stCategoryCount, mwgFTP=mwgFTP, mwgTrapVariables=mwgTrapVariables, stLastSentLastReceivedServer=stLastSentLastReceivedServer)
