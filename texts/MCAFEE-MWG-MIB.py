...
IpAddress, Integer32, ObjectIdentity, mib_2, NotificationType, enterprises, ModuleIdentity, NotificationType, TimeTicks, Counter64, Counter32, Bits, MibIdentifier, iso, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "ObjectIdentity", "mib-2", "NotificationType", "enterprises", "ModuleIdentity", "NotificationType", "TimeTicks", "Counter64", "Counter32", "Bits", "MibIdentifier", "iso", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pMFEDATVersion=pMFEDATVersion, notifyOrigin=notifyOrigin, pAMSignatureVersion=pAMSignatureVersion, kCustomVersion=kCustomVersion, stResolveHostViaDNS=stResolveHostViaDNS, mwg=mwg, stCategoryName=stCategoryName, stCPULoad=stCPULoad, notifyReason=notifyReason, stConnectionsLegitimate=stConnectionsLegitimate, mwgHttps=mwgHttps, stTimeForTransaction=stTimeForTransaction, mwgStatistics=mwgStatistics, mwgContent=mwgContent, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, trApplication=trApplication, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesFromClient=stHttpBytesFromClient, stHttpRequests=stHttpRequests, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectionsBlocked=stConnectionsBlocked, kBuildNumber=kBuildNumber, mwgMiscellaneous=mwgMiscellaneous, stHandleConnectToServer=stHandleConnectToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesFromServer=stFtpBytesFromServer, notifyAdditional=notifyAdditional, mwgEngineVersions=mwgEngineVersions, stBadReputation=stBadReputation, stFtpBytesToClient=stFtpBytesToClient, pAMProactiveVersion=pAMProactiveVersion, mwgTrapVariables=mwgTrapVariables, kRevision=kRevision, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, trSystem=trSystem, mwgTraps=mwgTraps, notifyAffectedHost=notifyAffectedHost, stHttpTraffic=stHttpTraffic, pTSDBVersion=pTSDBVersion, kMinorVersion=kMinorVersion, stHttpsBytesToServer=stHttpsBytesToServer, stFtpTraffic=stFtpTraffic, mwgInfo=mwgInfo, stFtpBytesToServer=stFtpBytesToServer, stMalwareDetected=stMalwareDetected, stCategoriesEntry=stCategoriesEntry, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoryCount=stCategoryCount, stBlockedByAntiMalware=stBlockedByAntiMalware, stClientCount=stClientCount, kProductVersion=kProductVersion, notifyReasonString=notifyReasonString, PYSNMP_MODULE_ID=mwg, trUser=trUser, notifySeverity=notifySeverity, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMEngineVersion=pAMEngineVersion, stFtpBytesFromClient=stFtpBytesFromClient, stMemConsumed=stMemConsumed, kMicroVersion=kMicroVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoriesTable=stCategoriesTable, stCategories=stCategories, stHttpsTraffic=stHttpsTraffic, stConnectedSockets=stConnectedSockets, notifyOriginName=notifyOriginName, stCPUIOWait=stCPUIOWait, stCPULoadRaw=stCPULoadRaw, kCompanyName=kCompanyName, kHotfixVersion=kHotfixVersion, kMajorVersion=kMajorVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesToClient=stHttpBytesToClient, mwgFTP=mwgFTP, stHttpsRequests=stHttpsRequests, kProductName=kProductName, mwgHttp=mwgHttp, pMFEEngineVersion=pMFEEngineVersion, stMimeType=stMimeType, stHttpBytesToServer=stHttpBytesToServer)
