...
NotificationType, Gauge32, Unsigned32, TimeTicks, mib_2, Bits, NotificationType, IpAddress, iso, ModuleIdentity, MibIdentifier, enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Unsigned32", "TimeTicks", "mib-2", "Bits", "NotificationType", "IpAddress", "iso", "ModuleIdentity", "MibIdentifier", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgEngineVersions=mwgEngineVersions, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByURLFilter=stBlockedByURLFilter, kRevision=kRevision, stHttpRequests=stHttpRequests, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesFromServer=stHttpBytesFromServer, trApplication=trApplication, stHttpBytesToClient=stHttpBytesToClient, kCompanyName=kCompanyName, stCategoriesEntry=stCategoriesEntry, stHttpsBytesToClient=stHttpsBytesToClient, kMicroVersion=kMicroVersion, stCategoryCount=stCategoryCount, mwgMiscellaneous=mwgMiscellaneous, pTSDBVersion=pTSDBVersion, notifyAdditional=notifyAdditional, stConnectionsBlocked=stConnectionsBlocked, kMajorVersion=kMajorVersion, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsRequests=stHttpsRequests, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kBuildNumber=kBuildNumber, stMemConsumed=stMemConsumed, stFtpBytesToClient=stFtpBytesToClient, kMinorVersion=kMinorVersion, mwgStatistics=mwgStatistics, stCPULoad=stCPULoad, stTimeForTransaction=stTimeForTransaction, stCategoriesTable=stCategoriesTable, pMFEDATVersion=pMFEDATVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stMalwareDetected=stMalwareDetected, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMimeType=stMimeType, notifyOriginName=notifyOriginName, mwgTrapVariables=mwgTrapVariables, notifyOrigin=notifyOrigin, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectionsLegitimate=stConnectionsLegitimate, notifySeverity=notifySeverity, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kCustomVersion=kCustomVersion, kHotfixVersion=kHotfixVersion, stFtpTraffic=stFtpTraffic, mwg=mwg, stCategoryName=stCategoryName, mwgFTP=mwgFTP, stBlockedByMediaFilter=stBlockedByMediaFilter, stCPULoadRaw=stCPULoadRaw, stHttpsTraffic=stHttpsTraffic, stHttpBytesToServer=stHttpBytesToServer, stConnectedSockets=stConnectedSockets, stResolveHostViaDNS=stResolveHostViaDNS, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyReason=notifyReason, mwgHttp=mwgHttp, mwgContent=mwgContent, stHandleConnectToServer=stHandleConnectToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpTraffic=stHttpTraffic, stClientCount=stClientCount, stFtpBytesFromServer=stFtpBytesFromServer, mwgTraps=mwgTraps, trUser=trUser, mwgHttps=mwgHttps, kProductVersion=kProductVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, pAMSignatureVersion=pAMSignatureVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMProactiveVersion=pAMProactiveVersion, pAMEngineVersion=pAMEngineVersion, kProductName=kProductName, trSystem=trSystem, PYSNMP_MODULE_ID=mwg, stFtpBytesFromClient=stFtpBytesFromClient, stCPUIOWait=stCPUIOWait, stBadReputation=stBadReputation, stFtpBytesToServer=stFtpBytesToServer, notifyReasonString=notifyReasonString, notifyAffectedHost=notifyAffectedHost, mwgInfo=mwgInfo, stCategories=stCategories)
