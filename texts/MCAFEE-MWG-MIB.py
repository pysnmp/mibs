...
Gauge32, MibIdentifier, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, Counter32, IpAddress, mib_2, Counter64, ObjectIdentity, iso, ModuleIdentity, Integer32, enterprises, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "Counter32", "IpAddress", "mib-2", "Counter64", "ObjectIdentity", "iso", "ModuleIdentity", "Integer32", "enterprises", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kMicroVersion=kMicroVersion, stMalwareDetected=stMalwareDetected, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgTraps=mwgTraps, stCPULoadRaw=stCPULoadRaw, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kHotfixVersion=kHotfixVersion, mwgHttp=mwgHttp, stCategoryName=stCategoryName, mwgInfo=mwgInfo, stMimeType=stMimeType, stConnectionsBlocked=stConnectionsBlocked, stHttpsRequests=stHttpsRequests, stBlockedByMediaFilter=stBlockedByMediaFilter, pMFEEngineVersion=pMFEEngineVersion, mwgContent=mwgContent, pAMProactiveVersion=pAMProactiveVersion, kBuildNumber=kBuildNumber, stHttpsBytesFromServer=stHttpsBytesFromServer, kRevision=kRevision, stCategoryCount=stCategoryCount, stHttpsBytesToClient=stHttpsBytesToClient, mwgHttps=mwgHttps, stHandleConnectToServer=stHandleConnectToServer, stCategoriesTable=stCategoriesTable, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgEngineVersions=mwgEngineVersions, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgMiscellaneous=mwgMiscellaneous, kCustomVersion=kCustomVersion, stHttpRequests=stHttpRequests, stConnectedSockets=stConnectedSockets, stFtpBytesToClient=stFtpBytesToClient, kCompanyName=kCompanyName, pTSDBVersion=pTSDBVersion, stBadReputation=stBadReputation, notifySeverity=notifySeverity, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByURLFilter=stBlockedByURLFilter, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesFromServer=stHttpBytesFromServer, kMinorVersion=kMinorVersion, mwgTrapVariables=mwgTrapVariables, trSystem=trSystem, notifyReasonString=notifyReasonString, stFtpTraffic=stFtpTraffic, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesFromServer=stFtpBytesFromServer, notifyOrigin=notifyOrigin, PYSNMP_MODULE_ID=mwg, stHttpsBytesToServer=stHttpsBytesToServer, stMemConsumed=stMemConsumed, kMajorVersion=kMajorVersion, pAMEngineVersion=pAMEngineVersion, pMFEDATVersion=pMFEDATVersion, stCPULoad=stCPULoad, notifyAdditional=notifyAdditional, stTimeForTransaction=stTimeForTransaction, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesToServer=stHttpBytesToServer, kProductName=kProductName, mwg=mwg, notifyOriginName=notifyOriginName, stHttpBytesToClient=stHttpBytesToClient, trUser=trUser, stBlockedByAntiMalware=stBlockedByAntiMalware, stConnectionsLegitimate=stConnectionsLegitimate, stClientCount=stClientCount, stHttpTraffic=stHttpTraffic, stHttpBytesFromClient=stHttpBytesFromClient, stCPUIOWait=stCPUIOWait, mwgFTP=mwgFTP, notifyReason=notifyReason, kProductVersion=kProductVersion, trApplication=trApplication, notifyAffectedHost=notifyAffectedHost, stCategoriesEntry=stCategoriesEntry, stHttpsTraffic=stHttpsTraffic, stCategories=stCategories, stFtpBytesToServer=stFtpBytesToServer, mwgStatistics=mwgStatistics)
