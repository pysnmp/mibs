...
Integer32, ObjectIdentity, MibIdentifier, IpAddress, NotificationType, NotificationType, iso, mib_2, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, ModuleIdentity, enterprises, Unsigned32, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "MibIdentifier", "IpAddress", "NotificationType", "NotificationType", "iso", "mib-2", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "ModuleIdentity", "enterprises", "Unsigned32", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stConnectionsLegitimate=stConnectionsLegitimate, trSystem=trSystem, notifyOriginName=notifyOriginName, mwg=mwg, stCPUIOWait=stCPUIOWait, mwgHttp=mwgHttp, stHandleConnectToServer=stHandleConnectToServer, mwgFTP=mwgFTP, stCategoriesEntry=stCategoriesEntry, stMemConsumed=stMemConsumed, mwgHttps=mwgHttps, notifySeverity=notifySeverity, kRevision=kRevision, stHttpsRequests=stHttpsRequests, stMimeType=stMimeType, kProductName=kProductName, mwgInfo=mwgInfo, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kProductVersion=kProductVersion, pMFEDATVersion=pMFEDATVersion, notifyOrigin=notifyOrigin, stCPULoadRaw=stCPULoadRaw, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgEngineVersions=mwgEngineVersions, stFtpBytesFromClient=stFtpBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pAMSignatureVersion=pAMSignatureVersion, pAMProactiveVersion=pAMProactiveVersion, pTSDBVersion=pTSDBVersion, kBuildNumber=kBuildNumber, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesToClient=stHttpsBytesToClient, mwgTrapVariables=mwgTrapVariables, mwgTraps=mwgTraps, trApplication=trApplication, stHttpsTraffic=stHttpsTraffic, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, stCategoryName=stCategoryName, notifyReason=notifyReason, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMinorVersion=kMinorVersion, kHotfixVersion=kHotfixVersion, stFtpBytesToServer=stFtpBytesToServer, stCPULoad=stCPULoad, kMicroVersion=kMicroVersion, stFtpTraffic=stFtpTraffic, stHttpTraffic=stHttpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesToServer=stHttpsBytesToServer, stBadReputation=stBadReputation, stHttpBytesToClient=stHttpBytesToClient, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesFromServer=stFtpBytesFromServer, stConnectedSockets=stConnectedSockets, kCompanyName=kCompanyName, notifyAdditional=notifyAdditional, mwgContent=mwgContent, notifyAffectedHost=notifyAffectedHost, stTimeForTransaction=stTimeForTransaction, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgStatistics=mwgStatistics, kCustomVersion=kCustomVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMEngineVersion=pAMEngineVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoryCount=stCategoryCount, stClientCount=stClientCount, kMajorVersion=kMajorVersion, stCategories=stCategories, stMalwareDetected=stMalwareDetected, stHttpBytesToServer=stHttpBytesToServer, pMFEEngineVersion=pMFEEngineVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, PYSNMP_MODULE_ID=mwg, stHttpBytesFromClient=stHttpBytesFromClient, stHttpRequests=stHttpRequests, trUser=trUser, stCategoriesTable=stCategoriesTable, notifyReasonString=notifyReasonString, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByURLFilter=stBlockedByURLFilter)
