...
TimeTicks, ObjectIdentity, NotificationType, Bits, ModuleIdentity, IpAddress, mib_2, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32, Counter64, NotificationType, Integer32, Gauge32, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "NotificationType", "Bits", "ModuleIdentity", "IpAddress", "mib-2", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32", "Counter64", "NotificationType", "Integer32", "Gauge32", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgEngineVersions=mwgEngineVersions, kHotfixVersion=kHotfixVersion, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMemConsumed=stMemConsumed, stCategoryName=stCategoryName, stFtpBytesToClient=stFtpBytesToClient, stConnectedSockets=stConnectedSockets, stCategoryCount=stCategoryCount, mwg=mwg, stFtpBytesFromClient=stFtpBytesFromClient, notifyReasonString=notifyReasonString, pAMSignatureVersion=pAMSignatureVersion, stHttpRequests=stHttpRequests, stHttpsTraffic=stHttpsTraffic, notifyOrigin=notifyOrigin, stConnectionsBlocked=stConnectionsBlocked, stMalwareDetected=stMalwareDetected, stBadReputation=stBadReputation, stBlockedByAntiMalware=stBlockedByAntiMalware, pAMEngineVersion=pAMEngineVersion, mwgTraps=mwgTraps, notifyOriginName=notifyOriginName, stCPULoad=stCPULoad, stHttpsBytesToServer=stHttpsBytesToServer, stTimeForTransaction=stTimeForTransaction, stFtpBytesToServer=stFtpBytesToServer, kProductVersion=kProductVersion, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, stMimeType=stMimeType, stCategoriesEntry=stCategoriesEntry, stHttpsBytesFromClient=stHttpsBytesFromClient, stBlockedByURLFilter=stBlockedByURLFilter, stHttpTraffic=stHttpTraffic, kProductName=kProductName, mwgMiscellaneous=mwgMiscellaneous, mwgHttp=mwgHttp, stHandleConnectToServer=stHandleConnectToServer, stCategoriesTable=stCategoriesTable, stCategories=stCategories, stLastSentLastReceivedClient=stLastSentLastReceivedClient, PYSNMP_MODULE_ID=mwg, mwgHttps=mwgHttps, stHttpBytesToClient=stHttpBytesToClient, notifySeverity=notifySeverity, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pTSDBVersion=pTSDBVersion, notifyAdditional=notifyAdditional, stHttpsRequests=stHttpsRequests, mwgStatistics=mwgStatistics, notifyAffectedHost=notifyAffectedHost, kRevision=kRevision, kBuildNumber=kBuildNumber, stResolveHostViaDNS=stResolveHostViaDNS, mwgInfo=mwgInfo, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoadRaw=stCPULoadRaw, stHttpBytesFromClient=stHttpBytesFromClient, trSystem=trSystem, trApplication=trApplication, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMicroVersion=kMicroVersion, pMFEDATVersion=pMFEDATVersion, trUser=trUser, stCPUIOWait=stCPUIOWait, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesToServer=stHttpBytesToServer, mwgTrapVariables=mwgTrapVariables, stBlockedByMediaFilter=stBlockedByMediaFilter, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgFTP=mwgFTP, pMFEEngineVersion=pMFEEngineVersion, stClientCount=stClientCount, notifyReason=notifyReason, kMinorVersion=kMinorVersion, stFtpTraffic=stFtpTraffic, kCompanyName=kCompanyName, kMajorVersion=kMajorVersion, kCustomVersion=kCustomVersion, pAMProactiveVersion=pAMProactiveVersion, mwgContent=mwgContent, stConnectionsLegitimate=stConnectionsLegitimate)
