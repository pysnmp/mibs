...
Integer32, Gauge32, Counter64, iso, Bits, MibIdentifier, mib_2, ObjectIdentity, NotificationType, NotificationType, Unsigned32, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "Counter64", "iso", "Bits", "MibIdentifier", "mib-2", "ObjectIdentity", "NotificationType", "NotificationType", "Unsigned32", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kMinorVersion=kMinorVersion, notifyAdditional=notifyAdditional, trSystem=trSystem, mwgInfo=mwgInfo, mwgMiscellaneous=mwgMiscellaneous, mwgEngineVersions=mwgEngineVersions, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pMFEDATVersion=pMFEDATVersion, notifyReasonString=notifyReasonString, stHttpRequests=stHttpRequests, stHttpsRequests=stHttpsRequests, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesToClient=stHttpsBytesToClient, mwgContent=mwgContent, stResolveHostViaDNS=stResolveHostViaDNS, stBadReputation=stBadReputation, mwgFTP=mwgFTP, kProductVersion=kProductVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesToClient=stHttpBytesToClient, mwg=mwg, notifyOrigin=notifyOrigin, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoryName=stCategoryName, stHttpBytesToServer=stHttpBytesToServer, stHandleConnectToServer=stHandleConnectToServer, stCPUIOWait=stCPUIOWait, mwgTrapVariables=mwgTrapVariables, stCategoriesEntry=stCategoriesEntry, trUser=trUser, stBlockedByURLFilter=stBlockedByURLFilter, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMemConsumed=stMemConsumed, stHttpsBytesFromServer=stHttpsBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCPULoadRaw=stCPULoadRaw, PYSNMP_MODULE_ID=mwg, mwgTraps=mwgTraps, stHttpsTraffic=stHttpsTraffic, stFtpBytesToClient=stFtpBytesToClient, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesFromServer=stHttpBytesFromServer, stConnectedSockets=stConnectedSockets, mwgHttps=mwgHttps, notifyOriginName=notifyOriginName, stCPULoad=stCPULoad, stMalwareDetected=stMalwareDetected, kMajorVersion=kMajorVersion, stHttpTraffic=stHttpTraffic, stConnectionsBlocked=stConnectionsBlocked, stClientCount=stClientCount, kRevision=kRevision, stCategories=stCategories, notifyAffectedHost=notifyAffectedHost, mwgHttp=mwgHttp, kCustomVersion=kCustomVersion, trApplication=trApplication, stMimeType=stMimeType, stFtpBytesFromServer=stFtpBytesFromServer, stTimeForTransaction=stTimeForTransaction, stFtpBytesFromClient=stFtpBytesFromClient, notifyReason=notifyReason, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kBuildNumber=kBuildNumber, stCategoriesTable=stCategoriesTable, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, stFtpTraffic=stFtpTraffic, pAMProactiveVersion=pAMProactiveVersion, pAMEngineVersion=pAMEngineVersion, kHotfixVersion=kHotfixVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, kMicroVersion=kMicroVersion, stHttpsBytesToServer=stHttpsBytesToServer, kCompanyName=kCompanyName, stFtpBytesToServer=stFtpBytesToServer, stCategoryCount=stCategoryCount, notifySeverity=notifySeverity, kProductName=kProductName, stHttpBytesFromClient=stHttpBytesFromClient, pTSDBVersion=pTSDBVersion, mwgStatistics=mwgStatistics, stLastSentLastReceivedServer=stLastSentLastReceivedServer)
