...
NotificationType, Bits, ModuleIdentity, Counter32, MibIdentifier, enterprises, Integer32, mib_2, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, Unsigned32, NotificationType, TimeTicks, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "ModuleIdentity", "Counter32", "MibIdentifier", "enterprises", "Integer32", "mib-2", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "Unsigned32", "NotificationType", "TimeTicks", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoriesEntry=stCategoriesEntry, stFtpBytesFromClient=stFtpBytesFromClient, notifyAffectedHost=notifyAffectedHost, stHttpBytesToServer=stHttpBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, mwgTrapVariables=mwgTrapVariables, stCategoryName=stCategoryName, stHttpsTraffic=stHttpsTraffic, kHotfixVersion=kHotfixVersion, kBuildNumber=kBuildNumber, mwgTraps=mwgTraps, stHandleConnectToServer=stHandleConnectToServer, notifyOrigin=notifyOrigin, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesToServer=stFtpBytesToServer, PYSNMP_MODULE_ID=mwg, stHttpBytesToClient=stHttpBytesToClient, trApplication=trApplication, stCPULoad=stCPULoad, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifySeverity=notifySeverity, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsRequests=stHttpsRequests, stConnectionsLegitimate=stConnectionsLegitimate, notifyOriginName=notifyOriginName, stConnectedSockets=stConnectedSockets, stCategoryCount=stCategoryCount, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMProactiveVersion=pAMProactiveVersion, kMicroVersion=kMicroVersion, stFtpBytesFromServer=stFtpBytesFromServer, stHttpBytesFromServer=stHttpBytesFromServer, stTimeForTransaction=stTimeForTransaction, notifyReasonString=notifyReasonString, mwgHttp=mwgHttp, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMinorVersion=kMinorVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBadReputation=stBadReputation, pMFEEngineVersion=pMFEEngineVersion, notifyAdditional=notifyAdditional, kCompanyName=kCompanyName, mwgEngineVersions=mwgEngineVersions, pTSDBVersion=pTSDBVersion, stCPULoadRaw=stCPULoadRaw, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategories=stCategories, mwg=mwg, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pMFEDATVersion=pMFEDATVersion, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesFromClient=stHttpsBytesFromClient, kMajorVersion=kMajorVersion, stCPUIOWait=stCPUIOWait, pAMEngineVersion=pAMEngineVersion, kProductName=kProductName, kRevision=kRevision, trSystem=trSystem, mwgHttps=mwgHttps, stCategoriesTable=stCategoriesTable, stClientCount=stClientCount, notifyReason=notifyReason, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kProductVersion=kProductVersion, stHttpRequests=stHttpRequests, stBlockedByURLFilter=stBlockedByURLFilter, stMimeType=stMimeType, trUser=trUser, mwgContent=mwgContent, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesFromServer=stHttpsBytesFromServer, stMemConsumed=stMemConsumed, stMalwareDetected=stMalwareDetected, mwgFTP=mwgFTP, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgStatistics=mwgStatistics, mwgInfo=mwgInfo, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesToClient=stFtpBytesToClient, stHttpTraffic=stHttpTraffic, stHttpsBytesToClient=stHttpsBytesToClient, kCustomVersion=kCustomVersion, stFtpTraffic=stFtpTraffic)
