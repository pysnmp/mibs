...
Gauge32, Counter64, MibIdentifier, TimeTicks, IpAddress, NotificationType, Integer32, Counter32, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, iso, ModuleIdentity, mib_2, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "MibIdentifier", "TimeTicks", "IpAddress", "NotificationType", "Integer32", "Counter32", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "iso", "ModuleIdentity", "mib-2", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMimeType=stMimeType, kProductVersion=kProductVersion, stCategories=stCategories, stHttpsBytesFromClient=stHttpsBytesFromClient, stTimeForTransaction=stTimeForTransaction, stHttpBytesToServer=stHttpBytesToServer, notifyOriginName=notifyOriginName, trSystem=trSystem, stHttpsRequests=stHttpsRequests, stBadReputation=stBadReputation, mwg=mwg, mwgFTP=mwgFTP, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stClientCount=stClientCount, kCustomVersion=kCustomVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stBlockedByURLFilter=stBlockedByURLFilter, stCategoriesEntry=stCategoriesEntry, mwgStatistics=mwgStatistics, pAMProactiveVersion=pAMProactiveVersion, pTSDBVersion=pTSDBVersion, mwgHttp=mwgHttp, mwgTraps=mwgTraps, mwgTrapVariables=mwgTrapVariables, pMFEEngineVersion=pMFEEngineVersion, stCPULoad=stCPULoad, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesFromServer=stFtpBytesFromServer, stCategoriesTable=stCategoriesTable, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, mwgInfo=mwgInfo, kProductName=kProductName, stCPULoadRaw=stCPULoadRaw, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyAdditional=notifyAdditional, kRevision=kRevision, mwgContent=mwgContent, stHttpBytesToClient=stHttpBytesToClient, stHandleConnectToServer=stHandleConnectToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stResolveHostViaDNS=stResolveHostViaDNS, notifyAffectedHost=notifyAffectedHost, stFtpTraffic=stFtpTraffic, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMajorVersion=kMajorVersion, kMinorVersion=kMinorVersion, mwgMiscellaneous=mwgMiscellaneous, trUser=trUser, stMalwareDetected=stMalwareDetected, notifyReasonString=notifyReasonString, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesToServer=stFtpBytesToServer, stHttpTraffic=stHttpTraffic, trApplication=trApplication, kHotfixVersion=kHotfixVersion, PYSNMP_MODULE_ID=mwg, stHttpRequests=stHttpRequests, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMicroVersion=kMicroVersion, notifyOrigin=notifyOrigin, stHttpBytesFromClient=stHttpBytesFromClient, stCPUIOWait=stCPUIOWait, notifyReason=notifyReason, stMemConsumed=stMemConsumed, pAMSignatureVersion=pAMSignatureVersion, pAMEngineVersion=pAMEngineVersion, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsBytesFromServer=stHttpsBytesFromServer, kCompanyName=kCompanyName, kBuildNumber=kBuildNumber, notifySeverity=notifySeverity, stConnectedSockets=stConnectedSockets, mwgEngineVersions=mwgEngineVersions, mwgHttps=mwgHttps, stCategoryName=stCategoryName, stConnectionsBlocked=stConnectionsBlocked, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsTraffic=stHttpsTraffic, stHttpsBytesToClient=stHttpsBytesToClient, stCategoryCount=stCategoryCount, pMFEDATVersion=pMFEDATVersion)
