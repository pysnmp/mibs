...
mib_2, IpAddress, enterprises, Counter64, TimeTicks, Gauge32, Counter32, Integer32, NotificationType, iso, Bits, ObjectIdentity, MibIdentifier, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "IpAddress", "enterprises", "Counter64", "TimeTicks", "Gauge32", "Counter32", "Integer32", "NotificationType", "iso", "Bits", "ObjectIdentity", "MibIdentifier", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kMicroVersion=kMicroVersion, PYSNMP_MODULE_ID=mwg, stCPULoad=stCPULoad, notifyOrigin=notifyOrigin, stMemConsumed=stMemConsumed, notifyReason=notifyReason, kRevision=kRevision, notifyOriginName=notifyOriginName, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesFromClient=stFtpBytesFromClient, mwgTraps=mwgTraps, stConnectionsLegitimate=stConnectionsLegitimate, stCategories=stCategories, notifyAdditional=notifyAdditional, mwgHttp=mwgHttp, mwgStatistics=mwgStatistics, pTSDBVersion=pTSDBVersion, stHttpBytesFromClient=stHttpBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCPULoadRaw=stCPULoadRaw, trSystem=trSystem, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoryName=stCategoryName, mwgEngineVersions=mwgEngineVersions, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesFromServer=stHttpBytesFromServer, mwgContent=mwgContent, stHttpsRequests=stHttpsRequests, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoriesTable=stCategoriesTable, kHotfixVersion=kHotfixVersion, kCustomVersion=kCustomVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesToClient=stHttpsBytesToClient, stFtpTraffic=stFtpTraffic, stHttpBytesToServer=stHttpBytesToServer, mwg=mwg, mwgInfo=mwgInfo, notifyReasonString=notifyReasonString, notifySeverity=notifySeverity, stBadReputation=stBadReputation, stHttpsBytesToServer=stHttpsBytesToServer, trUser=trUser, mwgFTP=mwgFTP, stResolveHostViaDNS=stResolveHostViaDNS, kMinorVersion=kMinorVersion, pAMProactiveVersion=pAMProactiveVersion, stHandleConnectToServer=stHandleConnectToServer, kBuildNumber=kBuildNumber, stHttpsTraffic=stHttpsTraffic, stFtpBytesToClient=stFtpBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesToServer=stFtpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpTraffic=stHttpTraffic, kProductVersion=kProductVersion, stTimeForTransaction=stTimeForTransaction, pMFEDATVersion=pMFEDATVersion, kProductName=kProductName, mwgTrapVariables=mwgTrapVariables, pAMSignatureVersion=pAMSignatureVersion, mwgHttps=mwgHttps, stFtpBytesFromServer=stFtpBytesFromServer, stCategoriesEntry=stCategoriesEntry, stConnectedSockets=stConnectedSockets, kCompanyName=kCompanyName, pMFEEngineVersion=pMFEEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, trApplication=trApplication, stCPUIOWait=stCPUIOWait, pAMEngineVersion=pAMEngineVersion, stClientCount=stClientCount, stCategoryCount=stCategoryCount, stMimeType=stMimeType, stMalwareDetected=stMalwareDetected, stConnectionsBlocked=stConnectionsBlocked, stBlockedByMediaFilter=stBlockedByMediaFilter, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesToClient=stHttpBytesToClient, notifyAffectedHost=notifyAffectedHost, kMajorVersion=kMajorVersion, stHttpRequests=stHttpRequests, stHttpsBytesFromClient=stHttpsBytesFromClient)
