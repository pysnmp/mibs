...
iso, IpAddress, Bits, Unsigned32, Gauge32, mib_2, NotificationType, Counter32, enterprises, Integer32, ModuleIdentity, MibIdentifier, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Bits", "Unsigned32", "Gauge32", "mib-2", "NotificationType", "Counter32", "enterprises", "Integer32", "ModuleIdentity", "MibIdentifier", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoryCount=stCategoryCount, pMFEEngineVersion=pMFEEngineVersion, mwgEngineVersions=mwgEngineVersions, notifySeverity=notifySeverity, trSystem=trSystem, notifyAffectedHost=notifyAffectedHost, mwgFTP=mwgFTP, mwgTraps=mwgTraps, stBlockedByMediaFilter=stBlockedByMediaFilter, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kProductName=kProductName, kMajorVersion=kMajorVersion, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, stConnectedSockets=stConnectedSockets, stCategoriesEntry=stCategoriesEntry, stHttpTraffic=stHttpTraffic, kCompanyName=kCompanyName, stHttpsBytesToClient=stHttpsBytesToClient, PYSNMP_MODULE_ID=mwg, kMicroVersion=kMicroVersion, stCategories=stCategories, notifyOriginName=notifyOriginName, stMimeType=stMimeType, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesFromClient=stFtpBytesFromClient, kMinorVersion=kMinorVersion, pAMProactiveVersion=pAMProactiveVersion, mwgTrapVariables=mwgTrapVariables, mwgHttps=mwgHttps, kRevision=kRevision, pTSDBVersion=pTSDBVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, kBuildNumber=kBuildNumber, stCPULoad=stCPULoad, mwgContent=mwgContent, kCustomVersion=kCustomVersion, trApplication=trApplication, mwg=mwg, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyOrigin=notifyOrigin, notifyReason=notifyReason, stCategoriesTable=stCategoriesTable, stHandleConnectToServer=stHandleConnectToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCPULoadRaw=stCPULoadRaw, kProductVersion=kProductVersion, stMalwareDetected=stMalwareDetected, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsTraffic=stHttpsTraffic, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stBadReputation=stBadReputation, stClientCount=stClientCount, stFtpBytesToServer=stFtpBytesToServer, stMemConsumed=stMemConsumed, pMFEDATVersion=pMFEDATVersion, mwgStatistics=mwgStatistics, stHttpRequests=stHttpRequests, stHttpsRequests=stHttpsRequests, kHotfixVersion=kHotfixVersion, stHttpsBytesToServer=stHttpsBytesToServer, mwgHttp=mwgHttp, stTimeForTransaction=stTimeForTransaction, trUser=trUser, notifyReasonString=notifyReasonString, mwgInfo=mwgInfo, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoryName=stCategoryName, stConnectionsLegitimate=stConnectionsLegitimate, notifyAdditional=notifyAdditional, pAMEngineVersion=pAMEngineVersion, stCPUIOWait=stCPUIOWait, stHttpBytesToServer=stHttpBytesToServer, stConnectionsBlocked=stConnectionsBlocked, pAMSignatureVersion=pAMSignatureVersion, mwgMiscellaneous=mwgMiscellaneous, stFtpTraffic=stFtpTraffic)
