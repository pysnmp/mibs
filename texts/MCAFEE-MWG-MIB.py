...
Bits, MibIdentifier, NotificationType, mib_2, ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, Counter32, NotificationType, ModuleIdentity, IpAddress, iso, Integer32, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "NotificationType", "mib-2", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "Counter32", "NotificationType", "ModuleIdentity", "IpAddress", "iso", "Integer32", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifySeverity=notifySeverity, pMFEDATVersion=pMFEDATVersion, mwgMiscellaneous=mwgMiscellaneous, pAMEngineVersion=pAMEngineVersion, pTSDBVersion=pTSDBVersion, mwgTraps=mwgTraps, trSystem=trSystem, mwgEngineVersions=mwgEngineVersions, notifyOrigin=notifyOrigin, kMicroVersion=kMicroVersion, stCategories=stCategories, kProductVersion=kProductVersion, mwgHttp=mwgHttp, kCompanyName=kCompanyName, notifyReasonString=notifyReasonString, trApplication=trApplication, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpRequests=stHttpRequests, stResolveHostViaDNS=stResolveHostViaDNS, stTimeForTransaction=stTimeForTransaction, kHotfixVersion=kHotfixVersion, PYSNMP_MODULE_ID=mwg, mwgHttps=mwgHttps, stHttpBytesFromServer=stHttpBytesFromServer, stCategoryName=stCategoryName, stHttpTraffic=stHttpTraffic, stFtpBytesFromServer=stFtpBytesFromServer, stMalwareDetected=stMalwareDetected, stHttpBytesToServer=stHttpBytesToServer, mwgFTP=mwgFTP, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kCustomVersion=kCustomVersion, stConnectionsLegitimate=stConnectionsLegitimate, stConnectionsBlocked=stConnectionsBlocked, mwg=mwg, pAMSignatureVersion=pAMSignatureVersion, stFtpTraffic=stFtpTraffic, pAMProactiveVersion=pAMProactiveVersion, stMimeType=stMimeType, mwgTrapVariables=mwgTrapVariables, stCategoriesTable=stCategoriesTable, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgInfo=mwgInfo, stHandleConnectToServer=stHandleConnectToServer, stCPULoadRaw=stCPULoadRaw, stFtpBytesFromClient=stFtpBytesFromClient, kMajorVersion=kMajorVersion, stHttpsBytesToServer=stHttpsBytesToServer, stCPUIOWait=stCPUIOWait, mwgContent=mwgContent, stHttpsBytesFromServer=stHttpsBytesFromServer, kRevision=kRevision, notifyAffectedHost=notifyAffectedHost, stHttpBytesToClient=stHttpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, trUser=trUser, stFtpBytesToClient=stFtpBytesToClient, stCPULoad=stCPULoad, stHttpsRequests=stHttpsRequests, notifyAdditional=notifyAdditional, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesToClient=stHttpsBytesToClient, notifyOriginName=notifyOriginName, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBadReputation=stBadReputation, stClientCount=stClientCount, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stBlockedByAntiMalware=stBlockedByAntiMalware, kMinorVersion=kMinorVersion, kProductName=kProductName, notifyReason=notifyReason, stCategoriesEntry=stCategoriesEntry, stCategoryCount=stCategoryCount, kBuildNumber=kBuildNumber, mwgStatistics=mwgStatistics, stFtpBytesToServer=stFtpBytesToServer, stConnectedSockets=stConnectedSockets, stMemConsumed=stMemConsumed, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpsTraffic=stHttpsTraffic)
