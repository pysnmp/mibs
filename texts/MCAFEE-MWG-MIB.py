...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, mib_2, Bits, TimeTicks, MibIdentifier, Gauge32, Counter32, Counter64, NotificationType, ObjectIdentity, NotificationType, ModuleIdentity, IpAddress, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "mib-2", "Bits", "TimeTicks", "MibIdentifier", "Gauge32", "Counter32", "Counter64", "NotificationType", "ObjectIdentity", "NotificationType", "ModuleIdentity", "IpAddress", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kProductVersion=kProductVersion, mwgEngineVersions=mwgEngineVersions, stClientCount=stClientCount, pMFEEngineVersion=pMFEEngineVersion, pAMSignatureVersion=pAMSignatureVersion, notifySeverity=notifySeverity, mwgTraps=mwgTraps, stCategoriesEntry=stCategoriesEntry, pTSDBVersion=pTSDBVersion, stCPULoadRaw=stCPULoadRaw, stMalwareDetected=stMalwareDetected, pAMProactiveVersion=pAMProactiveVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsTraffic=stHttpsTraffic, stBlockedByMediaFilter=stBlockedByMediaFilter, kRevision=kRevision, kCompanyName=kCompanyName, stFtpBytesToClient=stFtpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, notifyReason=notifyReason, PYSNMP_MODULE_ID=mwg, kMinorVersion=kMinorVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, kMicroVersion=kMicroVersion, stHttpBytesFromServer=stHttpBytesFromServer, notifyReasonString=notifyReasonString, notifyAdditional=notifyAdditional, mwg=mwg, stCPUIOWait=stCPUIOWait, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHandleConnectToServer=stHandleConnectToServer, stCategoryName=stCategoryName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kBuildNumber=kBuildNumber, stHttpBytesFromClient=stHttpBytesFromClient, mwgHttps=mwgHttps, stMimeType=stMimeType, trSystem=trSystem, stHttpRequests=stHttpRequests, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, kMajorVersion=kMajorVersion, mwgContent=mwgContent, trUser=trUser, stCategoryCount=stCategoryCount, stCategories=stCategories, mwgFTP=mwgFTP, stHttpTraffic=stHttpTraffic, pAMEngineVersion=pAMEngineVersion, pMFEDATVersion=pMFEDATVersion, stConnectedSockets=stConnectedSockets, stBadReputation=stBadReputation, mwgInfo=mwgInfo, mwgMiscellaneous=mwgMiscellaneous, notifyAffectedHost=notifyAffectedHost, stHttpBytesToServer=stHttpBytesToServer, kProductName=kProductName, stFtpTraffic=stFtpTraffic, stResolveHostViaDNS=stResolveHostViaDNS, stCategoriesTable=stCategoriesTable, stTimeForTransaction=stTimeForTransaction, mwgStatistics=mwgStatistics, stCPULoad=stCPULoad, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesToServer=stFtpBytesToServer, stBlockedByURLFilter=stBlockedByURLFilter, trApplication=trApplication, mwgTrapVariables=mwgTrapVariables, stConnectionsBlocked=stConnectionsBlocked, mwgHttp=mwgHttp, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyOriginName=notifyOriginName, kCustomVersion=kCustomVersion, notifyOrigin=notifyOrigin, stMemConsumed=stMemConsumed, kHotfixVersion=kHotfixVersion, stHttpsRequests=stHttpsRequests, stConnectionsLegitimate=stConnectionsLegitimate)
