...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, mib_2, enterprises, Unsigned32, Counter32, ObjectIdentity, NotificationType, Gauge32, iso, Bits, Integer32, NotificationType, ModuleIdentity, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "mib-2", "enterprises", "Unsigned32", "Counter32", "ObjectIdentity", "NotificationType", "Gauge32", "iso", "Bits", "Integer32", "NotificationType", "ModuleIdentity", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoryCount=stCategoryCount, notifyAdditional=notifyAdditional, kProductName=kProductName, pMFEDATVersion=pMFEDATVersion, stConnectionsLegitimate=stConnectionsLegitimate, stConnectedSockets=stConnectedSockets, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMemConsumed=stMemConsumed, notifyOrigin=notifyOrigin, mwgTrapVariables=mwgTrapVariables, pAMProactiveVersion=pAMProactiveVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kBuildNumber=kBuildNumber, mwgHttp=mwgHttp, kMicroVersion=kMicroVersion, stHttpsBytesToServer=stHttpsBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesToClient=stHttpBytesToClient, stHandleConnectToServer=stHandleConnectToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kHotfixVersion=kHotfixVersion, stMimeType=stMimeType, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, kMajorVersion=kMajorVersion, notifyOriginName=notifyOriginName, stCategories=stCategories, mwgHttps=mwgHttps, pMFEEngineVersion=pMFEEngineVersion, mwgFTP=mwgFTP, stBadReputation=stBadReputation, stResolveHostViaDNS=stResolveHostViaDNS, notifySeverity=notifySeverity, stMalwareDetected=stMalwareDetected, stHttpBytesFromClient=stHttpBytesFromClient, pAMEngineVersion=pAMEngineVersion, pAMSignatureVersion=pAMSignatureVersion, stHttpsRequests=stHttpsRequests, notifyAffectedHost=notifyAffectedHost, stFtpTraffic=stFtpTraffic, stConnectionsBlocked=stConnectionsBlocked, kCompanyName=kCompanyName, stHttpBytesToServer=stHttpBytesToServer, notifyReason=notifyReason, stBlockedByURLFilter=stBlockedByURLFilter, kProductVersion=kProductVersion, trUser=trUser, mwgTraps=mwgTraps, notifyReasonString=notifyReasonString, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesFromServer=stHttpsBytesFromServer, kMinorVersion=kMinorVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwg=mwg, mwgContent=mwgContent, kRevision=kRevision, mwgEngineVersions=mwgEngineVersions, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpTraffic=stHttpTraffic, stClientCount=stClientCount, mwgMiscellaneous=mwgMiscellaneous, stFtpBytesFromServer=stFtpBytesFromServer, stCPULoad=stCPULoad, stCPULoadRaw=stCPULoadRaw, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgStatistics=mwgStatistics, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesToClient=stFtpBytesToClient, stCategoriesEntry=stCategoriesEntry, stHttpsTraffic=stHttpsTraffic, PYSNMP_MODULE_ID=mwg, trApplication=trApplication, pTSDBVersion=pTSDBVersion, stTimeForTransaction=stTimeForTransaction, trSystem=trSystem, stCPUIOWait=stCPUIOWait, mwgInfo=mwgInfo, stHttpRequests=stHttpRequests, kCustomVersion=kCustomVersion, stFtpBytesToServer=stFtpBytesToServer, stCategoriesTable=stCategoriesTable, stCategoryName=stCategoryName)
