...
ObjectIdentity, Bits, Integer32, Counter64, IpAddress, TimeTicks, ModuleIdentity, NotificationType, MibIdentifier, Gauge32, mib_2, enterprises, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "Integer32", "Counter64", "IpAddress", "TimeTicks", "ModuleIdentity", "NotificationType", "MibIdentifier", "Gauge32", "mib-2", "enterprises", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stTimeForTransaction=stTimeForTransaction, kRevision=kRevision, pTSDBVersion=pTSDBVersion, stCPULoadRaw=stCPULoadRaw, stCategories=stCategories, stBadReputation=stBadReputation, notifySeverity=notifySeverity, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyOrigin=notifyOrigin, notifyAffectedHost=notifyAffectedHost, kHotfixVersion=kHotfixVersion, mwgHttps=mwgHttps, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kCompanyName=kCompanyName, stConnectedSockets=stConnectedSockets, stBlockedByURLFilter=stBlockedByURLFilter, kCustomVersion=kCustomVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trSystem=trSystem, mwgFTP=mwgFTP, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kProductName=kProductName, mwgEngineVersions=mwgEngineVersions, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMajorVersion=kMajorVersion, trApplication=trApplication, stHttpsBytesFromClient=stHttpsBytesFromClient, stMimeType=stMimeType, stHttpsRequests=stHttpsRequests, stHttpRequests=stHttpRequests, kMicroVersion=kMicroVersion, mwgStatistics=mwgStatistics, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyAdditional=notifyAdditional, stHttpBytesFromClient=stHttpBytesFromClient, notifyReasonString=notifyReasonString, stConnectionsBlocked=stConnectionsBlocked, stMemConsumed=stMemConsumed, stHttpTraffic=stHttpTraffic, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoriesTable=stCategoriesTable, stClientCount=stClientCount, PYSNMP_MODULE_ID=mwg, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesToServer=stHttpBytesToServer, kMinorVersion=kMinorVersion, kBuildNumber=kBuildNumber, kProductVersion=kProductVersion, stCategoryCount=stCategoryCount, mwgHttp=mwgHttp, stFtpTraffic=stFtpTraffic, stFtpBytesToClient=stFtpBytesToClient, trUser=trUser, notifyOriginName=notifyOriginName, stHandleConnectToServer=stHandleConnectToServer, pMFEDATVersion=pMFEDATVersion, mwgTraps=mwgTraps, stCPULoad=stCPULoad, pAMSignatureVersion=pAMSignatureVersion, stConnectionsLegitimate=stConnectionsLegitimate, notifyReason=notifyReason, stFtpBytesFromClient=stFtpBytesFromClient, mwg=mwg, stHttpBytesToClient=stHttpBytesToClient, stMalwareDetected=stMalwareDetected, pAMEngineVersion=pAMEngineVersion, mwgTrapVariables=mwgTrapVariables, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pMFEEngineVersion=pMFEEngineVersion, stCPUIOWait=stCPUIOWait, stHttpsTraffic=stHttpsTraffic, stFtpBytesToServer=stFtpBytesToServer, stFtpBytesFromServer=stFtpBytesFromServer, stCategoriesEntry=stCategoriesEntry, stCategoryName=stCategoryName, mwgInfo=mwgInfo, mwgContent=mwgContent, stResolveHostViaDNS=stResolveHostViaDNS, mwgMiscellaneous=mwgMiscellaneous)
