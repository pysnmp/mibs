...
NotificationType, ObjectIdentity, MibIdentifier, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, ModuleIdentity, TimeTicks, Gauge32, iso, Counter32, Bits, IpAddress, mib_2, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "MibIdentifier", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "ModuleIdentity", "TimeTicks", "Gauge32", "iso", "Counter32", "Bits", "IpAddress", "mib-2", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPULoad=stCPULoad, mwgTrapVariables=mwgTrapVariables, stCategories=stCategories, stMimeType=stMimeType, PYSNMP_MODULE_ID=mwg, kMinorVersion=kMinorVersion, pAMProactiveVersion=pAMProactiveVersion, stCategoriesTable=stCategoriesTable, kProductName=kProductName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyAffectedHost=notifyAffectedHost, mwgContent=mwgContent, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMSignatureVersion=pAMSignatureVersion, stMalwareDetected=stMalwareDetected, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifySeverity=notifySeverity, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesToServer=stHttpBytesToServer, mwgEngineVersions=mwgEngineVersions, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesFromClient=stHttpBytesFromClient, stCategoryCount=stCategoryCount, stBlockedByURLFilter=stBlockedByURLFilter, mwgInfo=mwgInfo, notifyOriginName=notifyOriginName, kCustomVersion=kCustomVersion, kHotfixVersion=kHotfixVersion, trUser=trUser, pTSDBVersion=pTSDBVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stBadReputation=stBadReputation, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsRequests=stHttpsRequests, stConnectedSockets=stConnectedSockets, notifyReasonString=notifyReasonString, stHttpsBytesToServer=stHttpsBytesToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsLegitimate=stConnectionsLegitimate, kBuildNumber=kBuildNumber, trSystem=trSystem, stFtpTraffic=stFtpTraffic, stFtpBytesToClient=stFtpBytesToClient, mwgHttps=mwgHttps, stHandleConnectToServer=stHandleConnectToServer, stHttpRequests=stHttpRequests, stHttpsBytesToClient=stHttpsBytesToClient, kRevision=kRevision, stMemConsumed=stMemConsumed, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesToClient=stHttpBytesToClient, stHttpTraffic=stHttpTraffic, stCategoryName=stCategoryName, pAMEngineVersion=pAMEngineVersion, kProductVersion=kProductVersion, mwgHttp=mwgHttp, stClientCount=stClientCount, stCPULoadRaw=stCPULoadRaw, mwg=mwg, stCategoriesEntry=stCategoriesEntry, notifyAdditional=notifyAdditional, notifyOrigin=notifyOrigin, pMFEDATVersion=pMFEDATVersion, mwgTraps=mwgTraps, notifyReason=notifyReason, stCPUIOWait=stCPUIOWait, kMicroVersion=kMicroVersion, stConnectionsBlocked=stConnectionsBlocked, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesFromServer=stHttpBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS, kMajorVersion=kMajorVersion, trApplication=trApplication, stTimeForTransaction=stTimeForTransaction, pMFEEngineVersion=pMFEEngineVersion, mwgStatistics=mwgStatistics, mwgFTP=mwgFTP, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, kCompanyName=kCompanyName, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsTraffic=stHttpsTraffic)
