...
MibIdentifier, Gauge32, IpAddress, Counter32, TimeTicks, iso, mib_2, NotificationType, ModuleIdentity, Counter64, enterprises, Integer32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Gauge32", "IpAddress", "Counter32", "TimeTicks", "iso", "mib-2", "NotificationType", "ModuleIdentity", "Counter64", "enterprises", "Integer32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFtpTraffic=stFtpTraffic, stHttpTraffic=stHttpTraffic, kProductVersion=kProductVersion, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, notifyReason=notifyReason, stConnectedSockets=stConnectedSockets, stHttpsTraffic=stHttpsTraffic, mwgMiscellaneous=mwgMiscellaneous, pMFEEngineVersion=pMFEEngineVersion, notifyAffectedHost=notifyAffectedHost, kMajorVersion=kMajorVersion, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsRequests=stHttpsRequests, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kRevision=kRevision, stBlockedByAntiMalware=stBlockedByAntiMalware, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trSystem=trSystem, mwgEngineVersions=mwgEngineVersions, stClientCount=stClientCount, notifyOrigin=notifyOrigin, stHttpRequests=stHttpRequests, kHotfixVersion=kHotfixVersion, trUser=trUser, stFtpBytesToClient=stFtpBytesToClient, kBuildNumber=kBuildNumber, notifyReasonString=notifyReasonString, pTSDBVersion=pTSDBVersion, mwgStatistics=mwgStatistics, mwgContent=mwgContent, trApplication=trApplication, pAMSignatureVersion=pAMSignatureVersion, stConnectionsBlocked=stConnectionsBlocked, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyAdditional=notifyAdditional, mwgTraps=mwgTraps, notifyOriginName=notifyOriginName, mwgHttp=mwgHttp, stCPUIOWait=stCPUIOWait, PYSNMP_MODULE_ID=mwg, mwgInfo=mwgInfo, pAMProactiveVersion=pAMProactiveVersion, stBadReputation=stBadReputation, stCPULoadRaw=stCPULoadRaw, stFtpBytesFromClient=stFtpBytesFromClient, kCompanyName=kCompanyName, stFtpBytesToServer=stFtpBytesToServer, stHandleConnectToServer=stHandleConnectToServer, notifySeverity=notifySeverity, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoryName=stCategoryName, stMemConsumed=stMemConsumed, stHttpBytesToServer=stHttpBytesToServer, stMalwareDetected=stMalwareDetected, stCPULoad=stCPULoad, stCategoryCount=stCategoryCount, stCategories=stCategories, stResolveHostViaDNS=stResolveHostViaDNS, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMinorVersion=kMinorVersion, pMFEDATVersion=pMFEDATVersion, stBlockedByURLFilter=stBlockedByURLFilter, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stTimeForTransaction=stTimeForTransaction, stHttpsBytesFromServer=stHttpsBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMicroVersion=kMicroVersion, pAMEngineVersion=pAMEngineVersion, mwgTrapVariables=mwgTrapVariables, mwgFTP=mwgFTP, stConnectionsLegitimate=stConnectionsLegitimate, kProductName=kProductName, stHttpBytesToClient=stHttpBytesToClient, kCustomVersion=kCustomVersion, stCategoriesTable=stCategoriesTable, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByMediaFilter=stBlockedByMediaFilter, mwg=mwg, stMimeType=stMimeType, stCategoriesEntry=stCategoriesEntry, mwgHttps=mwgHttps)
