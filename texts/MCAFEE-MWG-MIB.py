...
Counter64, Gauge32, IpAddress, NotificationType, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, NotificationType, Bits, MibIdentifier, enterprises, TimeTicks, ObjectIdentity, Integer32, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "IpAddress", "NotificationType", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "NotificationType", "Bits", "MibIdentifier", "enterprises", "TimeTicks", "ObjectIdentity", "Integer32", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kBuildNumber=kBuildNumber, notifyReasonString=notifyReasonString, mwgContent=mwgContent, mwgFTP=mwgFTP, stHttpRequests=stHttpRequests, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, kMicroVersion=kMicroVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesToServer=stHttpsBytesToServer, stMalwareDetected=stMalwareDetected, mwgMiscellaneous=mwgMiscellaneous, notifyOriginName=notifyOriginName, stCategoriesTable=stCategoriesTable, notifyAdditional=notifyAdditional, mwgInfo=mwgInfo, pTSDBVersion=pTSDBVersion, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsRequests=stHttpsRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kHotfixVersion=kHotfixVersion, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, kMajorVersion=kMajorVersion, notifySeverity=notifySeverity, mwgStatistics=mwgStatistics, stCategoriesEntry=stCategoriesEntry, kProductName=kProductName, PYSNMP_MODULE_ID=mwg, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stMimeType=stMimeType, pAMProactiveVersion=pAMProactiveVersion, mwgHttps=mwgHttps, notifyOrigin=notifyOrigin, stMemConsumed=stMemConsumed, kMinorVersion=kMinorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpTraffic=stHttpTraffic, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pMFEDATVersion=pMFEDATVersion, stCPUIOWait=stCPUIOWait, trApplication=trApplication, kProductVersion=kProductVersion, kRevision=kRevision, pMFEEngineVersion=pMFEEngineVersion, stClientCount=stClientCount, stCategoryCount=stCategoryCount, stCategories=stCategories, stFtpTraffic=stFtpTraffic, notifyAffectedHost=notifyAffectedHost, stCategoryName=stCategoryName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwg=mwg, mwgEngineVersions=mwgEngineVersions, stBadReputation=stBadReputation, stFtpBytesToClient=stFtpBytesToClient, stHttpsTraffic=stHttpsTraffic, trUser=trUser, pAMEngineVersion=pAMEngineVersion, stCPULoad=stCPULoad, mwgTrapVariables=mwgTrapVariables, stConnectedSockets=stConnectedSockets, stTimeForTransaction=stTimeForTransaction, trSystem=trSystem, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesToClient=stHttpsBytesToClient, mwgTraps=mwgTraps, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgHttp=mwgHttp, stResolveHostViaDNS=stResolveHostViaDNS, kCompanyName=kCompanyName, stBlockedByURLFilter=stBlockedByURLFilter, stCPULoadRaw=stCPULoadRaw, notifyReason=notifyReason, kCustomVersion=kCustomVersion, stHandleConnectToServer=stHandleConnectToServer)
