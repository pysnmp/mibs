...
iso, TimeTicks, mib_2, NotificationType, Gauge32, Counter64, IpAddress, ObjectIdentity, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, MibIdentifier, enterprises, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "mib-2", "NotificationType", "Gauge32", "Counter64", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "MibIdentifier", "enterprises", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoryName=stCategoryName, PYSNMP_MODULE_ID=mwg, kProductName=kProductName, stCategoriesTable=stCategoriesTable, mwgFTP=mwgFTP, stTimeForTransaction=stTimeForTransaction, trApplication=trApplication, kBuildNumber=kBuildNumber, stHttpsBytesToClient=stHttpsBytesToClient, pTSDBVersion=pTSDBVersion, mwgTraps=mwgTraps, notifyReasonString=notifyReasonString, stCategories=stCategories, stHttpBytesToClient=stHttpBytesToClient, stHttpsRequests=stHttpsRequests, stHttpsTraffic=stHttpsTraffic, stHttpBytesToServer=stHttpBytesToServer, stMalwareDetected=stMalwareDetected, mwgHttps=mwgHttps, stBlockedByURLFilter=stBlockedByURLFilter, notifyOriginName=notifyOriginName, notifySeverity=notifySeverity, stFtpBytesFromClient=stFtpBytesFromClient, stMemConsumed=stMemConsumed, stBadReputation=stBadReputation, kProductVersion=kProductVersion, stConnectedSockets=stConnectedSockets, stMimeType=stMimeType, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoryCount=stCategoryCount, pAMProactiveVersion=pAMProactiveVersion, mwgHttp=mwgHttp, stHttpsBytesToServer=stHttpsBytesToServer, stConnectionsLegitimate=stConnectionsLegitimate, stHttpRequests=stHttpRequests, stFtpBytesToServer=stFtpBytesToServer, mwgContent=mwgContent, stHttpBytesFromClient=stHttpBytesFromClient, kCompanyName=kCompanyName, kMajorVersion=kMajorVersion, kMicroVersion=kMicroVersion, notifyAdditional=notifyAdditional, notifyOrigin=notifyOrigin, mwgTrapVariables=mwgTrapVariables, stHttpsBytesFromClient=stHttpsBytesFromClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, pAMSignatureVersion=pAMSignatureVersion, notifyReason=notifyReason, pAMEngineVersion=pAMEngineVersion, trUser=trUser, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoadRaw=stCPULoadRaw, kHotfixVersion=kHotfixVersion, stFtpTraffic=stFtpTraffic, pMFEDATVersion=pMFEDATVersion, stFtpBytesFromServer=stFtpBytesFromServer, stCPUIOWait=stCPUIOWait, pMFEEngineVersion=pMFEEngineVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectionsBlocked=stConnectionsBlocked, mwg=mwg, stCategoriesEntry=stCategoriesEntry, mwgMiscellaneous=mwgMiscellaneous, kCustomVersion=kCustomVersion, mwgStatistics=mwgStatistics, kRevision=kRevision, stHttpTraffic=stHttpTraffic, stFtpBytesToClient=stFtpBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgEngineVersions=mwgEngineVersions, stCPULoad=stCPULoad, stHandleConnectToServer=stHandleConnectToServer, stResolveHostViaDNS=stResolveHostViaDNS, trSystem=trSystem, stClientCount=stClientCount, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyAffectedHost=notifyAffectedHost, kMinorVersion=kMinorVersion, mwgInfo=mwgInfo)
