...
ObjectIdentity, Unsigned32, Bits, ModuleIdentity, NotificationType, enterprises, NotificationType, iso, MibIdentifier, mib_2, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, Counter32, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Bits", "ModuleIdentity", "NotificationType", "enterprises", "NotificationType", "iso", "MibIdentifier", "mib-2", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "Counter32", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", PYSNMP_MODULE_ID=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, trUser=trUser, pAMEngineVersion=pAMEngineVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHandleConnectToServer=stHandleConnectToServer, pTSDBVersion=pTSDBVersion, stHttpBytesFromServer=stHttpBytesFromServer, stMimeType=stMimeType, pMFEEngineVersion=pMFEEngineVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoriesEntry=stCategoriesEntry, kBuildNumber=kBuildNumber, stFtpBytesToServer=stFtpBytesToServer, notifyAdditional=notifyAdditional, stHttpTraffic=stHttpTraffic, stTimeForTransaction=stTimeForTransaction, stHttpsBytesFromServer=stHttpsBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoryCount=stCategoryCount, stCPULoadRaw=stCPULoadRaw, kCustomVersion=kCustomVersion, kRevision=kRevision, stHttpRequests=stHttpRequests, pMFEDATVersion=pMFEDATVersion, mwgTraps=mwgTraps, stResolveHostViaDNS=stResolveHostViaDNS, kMinorVersion=kMinorVersion, stCategoriesTable=stCategoriesTable, mwgStatistics=mwgStatistics, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesFromClient=stHttpBytesFromClient, notifyOriginName=notifyOriginName, notifyReasonString=notifyReasonString, stCPUIOWait=stCPUIOWait, stHttpsTraffic=stHttpsTraffic, stBadReputation=stBadReputation, notifyOrigin=notifyOrigin, mwgHttp=mwgHttp, stFtpBytesToClient=stFtpBytesToClient, kProductName=kProductName, mwgContent=mwgContent, kMajorVersion=kMajorVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, kCompanyName=kCompanyName, mwgFTP=mwgFTP, mwgMiscellaneous=mwgMiscellaneous, mwgTrapVariables=mwgTrapVariables, notifyAffectedHost=notifyAffectedHost, pAMProactiveVersion=pAMProactiveVersion, kProductVersion=kProductVersion, mwgEngineVersions=mwgEngineVersions, stCategories=stCategories, stFtpTraffic=stFtpTraffic, stHttpBytesToServer=stHttpBytesToServer, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesToServer=stHttpsBytesToServer, stConnectedSockets=stConnectedSockets, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trSystem=trSystem, mwg=mwg, stMemConsumed=stMemConsumed, stCategoryName=stCategoryName, stConnectionsBlocked=stConnectionsBlocked, stMalwareDetected=stMalwareDetected, notifyReason=notifyReason, stClientCount=stClientCount, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesToClient=stHttpsBytesToClient, kMicroVersion=kMicroVersion, kHotfixVersion=kHotfixVersion, notifySeverity=notifySeverity, mwgHttps=mwgHttps, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, trApplication=trApplication, mwgInfo=mwgInfo, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsRequests=stHttpsRequests, stCPULoad=stCPULoad, stHttpBytesToClient=stHttpBytesToClient)
