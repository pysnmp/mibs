...
Integer32, MibIdentifier, Gauge32, ModuleIdentity, mib_2, Counter32, IpAddress, TimeTicks, enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, Unsigned32, NotificationType, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibIdentifier", "Gauge32", "ModuleIdentity", "mib-2", "Counter32", "IpAddress", "TimeTicks", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "Unsigned32", "NotificationType", "Bits", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyAdditional=notifyAdditional, kCompanyName=kCompanyName, kMinorVersion=kMinorVersion, kMicroVersion=kMicroVersion, pTSDBVersion=pTSDBVersion, notifyAffectedHost=notifyAffectedHost, kMajorVersion=kMajorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectionsLegitimate=stConnectionsLegitimate, kProductName=kProductName, stMimeType=stMimeType, stHttpsBytesFromClient=stHttpsBytesFromClient, notifySeverity=notifySeverity, stBadReputation=stBadReputation, pAMSignatureVersion=pAMSignatureVersion, stCPULoadRaw=stCPULoadRaw, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, mwgEngineVersions=mwgEngineVersions, notifyReasonString=notifyReasonString, stFtpTraffic=stFtpTraffic, stFtpBytesToClient=stFtpBytesToClient, trSystem=trSystem, stHttpsBytesToServer=stHttpsBytesToServer, stCategories=stCategories, stCategoriesEntry=stCategoriesEntry, PYSNMP_MODULE_ID=mwg, kRevision=kRevision, stHttpTraffic=stHttpTraffic, mwgTraps=mwgTraps, stConnectedSockets=stConnectedSockets, stHttpBytesFromClient=stHttpBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwg=mwg, stConnectionsBlocked=stConnectionsBlocked, mwgStatistics=mwgStatistics, pAMProactiveVersion=pAMProactiveVersion, mwgTrapVariables=mwgTrapVariables, stHandleConnectToServer=stHandleConnectToServer, trUser=trUser, kHotfixVersion=kHotfixVersion, pMFEDATVersion=pMFEDATVersion, stCPUIOWait=stCPUIOWait, notifyOrigin=notifyOrigin, stFtpBytesToServer=stFtpBytesToServer, mwgInfo=mwgInfo, kProductVersion=kProductVersion, stResolveHostViaDNS=stResolveHostViaDNS, stCategoryName=stCategoryName, mwgContent=mwgContent, mwgMiscellaneous=mwgMiscellaneous, stMalwareDetected=stMalwareDetected, stCategoriesTable=stCategoriesTable, stCPULoad=stCPULoad, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stTimeForTransaction=stTimeForTransaction, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsRequests=stHttpsRequests, mwgHttps=mwgHttps, mwgHttp=mwgHttp, stClientCount=stClientCount, stHttpsBytesToClient=stHttpsBytesToClient, trApplication=trApplication, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesToClient=stHttpBytesToClient, stHttpsTraffic=stHttpsTraffic, pMFEEngineVersion=pMFEEngineVersion, kBuildNumber=kBuildNumber, stMemConsumed=stMemConsumed, stHttpRequests=stHttpRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyReason=notifyReason, notifyOriginName=notifyOriginName, stFtpBytesFromClient=stFtpBytesFromClient, pAMEngineVersion=pAMEngineVersion, kCustomVersion=kCustomVersion, mwgFTP=mwgFTP, stFtpBytesFromServer=stFtpBytesFromServer, stCategoryCount=stCategoryCount, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesFromServer=stHttpsBytesFromServer)
