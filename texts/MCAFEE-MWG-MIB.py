...
ObjectIdentity, Bits, TimeTicks, Counter32, ModuleIdentity, mib_2, enterprises, Gauge32, NotificationType, iso, NotificationType, Unsigned32, MibIdentifier, Integer32, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "TimeTicks", "Counter32", "ModuleIdentity", "mib-2", "enterprises", "Gauge32", "NotificationType", "iso", "NotificationType", "Unsigned32", "MibIdentifier", "Integer32", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMSignatureVersion=pAMSignatureVersion, stResolveHostViaDNS=stResolveHostViaDNS, mwg=mwg, stFtpTraffic=stFtpTraffic, pTSDBVersion=pTSDBVersion, trApplication=trApplication, notifySeverity=notifySeverity, pMFEDATVersion=pMFEDATVersion, stCategoriesEntry=stCategoriesEntry, trUser=trUser, mwgHttp=mwgHttp, stCPULoad=stCPULoad, stCategoryName=stCategoryName, stBadReputation=stBadReputation, notifyOriginName=notifyOriginName, notifyAdditional=notifyAdditional, pAMProactiveVersion=pAMProactiveVersion, mwgInfo=mwgInfo, mwgContent=mwgContent, stHttpTraffic=stHttpTraffic, stHttpBytesToClient=stHttpBytesToClient, stMemConsumed=stMemConsumed, stFtpBytesFromClient=stFtpBytesFromClient, mwgStatistics=mwgStatistics, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kProductName=kProductName, kMicroVersion=kMicroVersion, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByURLFilter=stBlockedByURLFilter, mwgTrapVariables=mwgTrapVariables, stHttpBytesToServer=stHttpBytesToServer, stBlockedByMediaFilter=stBlockedByMediaFilter, kMajorVersion=kMajorVersion, stHttpsRequests=stHttpsRequests, trSystem=trSystem, stHttpRequests=stHttpRequests, mwgMiscellaneous=mwgMiscellaneous, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgEngineVersions=mwgEngineVersions, mwgHttps=mwgHttps, kRevision=kRevision, stConnectedSockets=stConnectedSockets, mwgFTP=mwgFTP, stHttpsBytesFromServer=stHttpsBytesFromServer, stMalwareDetected=stMalwareDetected, stCategoriesTable=stCategoriesTable, kHotfixVersion=kHotfixVersion, pAMEngineVersion=pAMEngineVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCPUIOWait=stCPUIOWait, stHttpsTraffic=stHttpsTraffic, notifyReason=notifyReason, notifyAffectedHost=notifyAffectedHost, stConnectionsLegitimate=stConnectionsLegitimate, stConnectionsBlocked=stConnectionsBlocked, stCategories=stCategories, stCategoryCount=stCategoryCount, kBuildNumber=kBuildNumber, stTimeForTransaction=stTimeForTransaction, stBlockedByAntiMalware=stBlockedByAntiMalware, PYSNMP_MODULE_ID=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesFromClient=stHttpBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kCustomVersion=kCustomVersion, stFtpBytesToClient=stFtpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kProductVersion=kProductVersion, kMinorVersion=kMinorVersion, notifyReasonString=notifyReasonString, stMimeType=stMimeType, stClientCount=stClientCount, kCompanyName=kCompanyName, stFtpBytesToServer=stFtpBytesToServer, stHttpsBytesToServer=stHttpsBytesToServer, notifyOrigin=notifyOrigin, stHandleConnectToServer=stHandleConnectToServer, mwgTraps=mwgTraps, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoadRaw=stCPULoadRaw, stHttpBytesFromServer=stHttpBytesFromServer)
