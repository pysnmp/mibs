...
IpAddress, Gauge32, ObjectIdentity, Counter32, TimeTicks, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, NotificationType, Bits, Counter64, ModuleIdentity, MibIdentifier, Integer32, Unsigned32, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "ObjectIdentity", "Counter32", "TimeTicks", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "NotificationType", "Bits", "Counter64", "ModuleIdentity", "MibIdentifier", "Integer32", "Unsigned32", "NotificationType", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMProactiveVersion=pAMProactiveVersion, stMimeType=stMimeType, stMalwareDetected=stMalwareDetected, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpTraffic=stFtpTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, notifySeverity=notifySeverity, mwgTraps=mwgTraps, stHttpsBytesToClient=stHttpsBytesToClient, notifyOrigin=notifyOrigin, mwgTrapVariables=mwgTrapVariables, stHandleConnectToServer=stHandleConnectToServer, stTimeForTransaction=stTimeForTransaction, stCategoryName=stCategoryName, stMemConsumed=stMemConsumed, stHttpsRequests=stHttpsRequests, stBlockedByURLFilter=stBlockedByURLFilter, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesFromServer=stFtpBytesFromServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCPUIOWait=stCPUIOWait, stBlockedByAntiMalware=stBlockedByAntiMalware, stClientCount=stClientCount, stCategories=stCategories, pAMEngineVersion=pAMEngineVersion, kRevision=kRevision, stFtpBytesToServer=stFtpBytesToServer, stCategoriesEntry=stCategoriesEntry, kCompanyName=kCompanyName, stCategoriesTable=stCategoriesTable, notifyAffectedHost=notifyAffectedHost, mwg=mwg, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kProductVersion=kProductVersion, stCategoryCount=stCategoryCount, kMinorVersion=kMinorVersion, stCPULoadRaw=stCPULoadRaw, pMFEDATVersion=pMFEDATVersion, stHttpTraffic=stHttpTraffic, stHttpBytesFromClient=stHttpBytesFromClient, stCPULoad=stCPULoad, notifyReasonString=notifyReasonString, mwgFTP=mwgFTP, stConnectedSockets=stConnectedSockets, mwgMiscellaneous=mwgMiscellaneous, notifyReason=notifyReason, trUser=trUser, mwgContent=mwgContent, kMajorVersion=kMajorVersion, stHttpBytesFromServer=stHttpBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgEngineVersions=mwgEngineVersions, stHttpRequests=stHttpRequests, mwgHttp=mwgHttp, mwgStatistics=mwgStatistics, stFtpBytesFromClient=stFtpBytesFromClient, kBuildNumber=kBuildNumber, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pTSDBVersion=pTSDBVersion, kCustomVersion=kCustomVersion, stHttpsTraffic=stHttpsTraffic, notifyAdditional=notifyAdditional, stHttpBytesToServer=stHttpBytesToServer, stConnectionsLegitimate=stConnectionsLegitimate, stConnectionsBlocked=stConnectionsBlocked, kMicroVersion=kMicroVersion, PYSNMP_MODULE_ID=mwg, pMFEEngineVersion=pMFEEngineVersion, kProductName=kProductName, trSystem=trSystem, notifyOriginName=notifyOriginName, mwgHttps=mwgHttps, kHotfixVersion=kHotfixVersion, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesToClient=stHttpBytesToClient, pAMSignatureVersion=pAMSignatureVersion, stBadReputation=stBadReputation, trApplication=trApplication, mwgInfo=mwgInfo, stFtpBytesToClient=stFtpBytesToClient)
