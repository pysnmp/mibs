...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, ModuleIdentity, IpAddress, mib_2, NotificationType, Integer32, enterprises, Bits, MibIdentifier, Unsigned32, Counter32, Counter64, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "ModuleIdentity", "IpAddress", "mib-2", "NotificationType", "Integer32", "enterprises", "Bits", "MibIdentifier", "Unsigned32", "Counter32", "Counter64", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesToClient=stHttpBytesToClient, stFtpBytesToClient=stFtpBytesToClient, kCustomVersion=kCustomVersion, stBlockedByURLFilter=stBlockedByURLFilter, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoriesEntry=stCategoriesEntry, pAMSignatureVersion=pAMSignatureVersion, mwgMiscellaneous=mwgMiscellaneous, stCPUIOWait=stCPUIOWait, stFtpBytesToServer=stFtpBytesToServer, notifySeverity=notifySeverity, kProductName=kProductName, stHttpRequests=stHttpRequests, mwgHttps=mwgHttps, mwgStatistics=mwgStatistics, stConnectionsBlocked=stConnectionsBlocked, mwgTrapVariables=mwgTrapVariables, mwgInfo=mwgInfo, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesFromServer=stFtpBytesFromServer, stMalwareDetected=stMalwareDetected, pTSDBVersion=pTSDBVersion, pAMEngineVersion=pAMEngineVersion, kHotfixVersion=kHotfixVersion, mwgEngineVersions=mwgEngineVersions, stMemConsumed=stMemConsumed, kMinorVersion=kMinorVersion, kRevision=kRevision, stClientCount=stClientCount, stCategories=stCategories, stCPULoad=stCPULoad, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesToServer=stHttpBytesToServer, stMimeType=stMimeType, mwgFTP=mwgFTP, kProductVersion=kProductVersion, stFtpBytesFromClient=stFtpBytesFromClient, stTimeForTransaction=stTimeForTransaction, stCategoryName=stCategoryName, stHttpTraffic=stHttpTraffic, mwgHttp=mwgHttp, stCPULoadRaw=stCPULoadRaw, notifyOriginName=notifyOriginName, mwg=mwg, PYSNMP_MODULE_ID=mwg, notifyAdditional=notifyAdditional, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesFromServer=stHttpBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgTraps=mwgTraps, stBlockedByMediaFilter=stBlockedByMediaFilter, stBadReputation=stBadReputation, notifyReason=notifyReason, notifyAffectedHost=notifyAffectedHost, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsTraffic=stHttpsTraffic, stFtpTraffic=stFtpTraffic, stHttpsBytesToClient=stHttpsBytesToClient, trUser=trUser, stConnectedSockets=stConnectedSockets, kMajorVersion=kMajorVersion, kCompanyName=kCompanyName, pMFEDATVersion=pMFEDATVersion, mwgContent=mwgContent, kMicroVersion=kMicroVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, kBuildNumber=kBuildNumber, stHttpBytesFromClient=stHttpBytesFromClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoryCount=stCategoryCount, trSystem=trSystem, notifyOrigin=notifyOrigin, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pAMProactiveVersion=pAMProactiveVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoriesTable=stCategoriesTable, stHttpsRequests=stHttpsRequests, stResolveHostViaDNS=stResolveHostViaDNS, notifyReasonString=notifyReasonString, pMFEEngineVersion=pMFEEngineVersion, trApplication=trApplication, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer)
