...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, ObjectIdentity, Counter64, TimeTicks, enterprises, ModuleIdentity, NotificationType, MibIdentifier, mib_2, iso, Integer32, IpAddress, Gauge32, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "ObjectIdentity", "Counter64", "TimeTicks", "enterprises", "ModuleIdentity", "NotificationType", "MibIdentifier", "mib-2", "iso", "Integer32", "IpAddress", "Gauge32", "Counter32", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", trSystem=trSystem, stHttpsRequests=stHttpsRequests, pMFEEngineVersion=pMFEEngineVersion, notifyAffectedHost=notifyAffectedHost, mwgHttp=mwgHttp, mwgTrapVariables=mwgTrapVariables, stTimeForTransaction=stTimeForTransaction, stFtpBytesToServer=stFtpBytesToServer, mwgFTP=mwgFTP, trApplication=trApplication, mwg=mwg, stMemConsumed=stMemConsumed, mwgContent=mwgContent, kRevision=kRevision, kHotfixVersion=kHotfixVersion, stHttpTraffic=stHttpTraffic, mwgHttps=mwgHttps, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoryCount=stCategoryCount, kCompanyName=kCompanyName, stClientCount=stClientCount, mwgEngineVersions=mwgEngineVersions, mwgInfo=mwgInfo, mwgMiscellaneous=mwgMiscellaneous, stCategoriesEntry=stCategoriesEntry, stHttpsTraffic=stHttpsTraffic, stFtpBytesToClient=stFtpBytesToClient, stCategoriesTable=stCategoriesTable, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgTraps=mwgTraps, stCPULoadRaw=stCPULoadRaw, stCPUIOWait=stCPUIOWait, stHttpBytesFromClient=stHttpBytesFromClient, stResolveHostViaDNS=stResolveHostViaDNS, stHandleConnectToServer=stHandleConnectToServer, notifyReason=notifyReason, stCategories=stCategories, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByURLFilter=stBlockedByURLFilter, notifyOrigin=notifyOrigin, stBadReputation=stBadReputation, stFtpTraffic=stFtpTraffic, stConnectedSockets=stConnectedSockets, notifyReasonString=notifyReasonString, stHttpBytesToServer=stHttpBytesToServer, kProductName=kProductName, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesToClient=stHttpsBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pAMProactiveVersion=pAMProactiveVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyOriginName=notifyOriginName, mwgStatistics=mwgStatistics, kBuildNumber=kBuildNumber, stHttpBytesToClient=stHttpBytesToClient, stMalwareDetected=stMalwareDetected, stHttpsBytesToServer=stHttpsBytesToServer, stConnectionsBlocked=stConnectionsBlocked, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoryName=stCategoryName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpBytesFromServer=stFtpBytesFromServer, pAMEngineVersion=pAMEngineVersion, stMimeType=stMimeType, stFtpBytesFromClient=stFtpBytesFromClient, PYSNMP_MODULE_ID=mwg, kMicroVersion=kMicroVersion, kMajorVersion=kMajorVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, trUser=trUser, pMFEDATVersion=pMFEDATVersion, notifySeverity=notifySeverity, pTSDBVersion=pTSDBVersion, kCustomVersion=kCustomVersion, kMinorVersion=kMinorVersion, notifyAdditional=notifyAdditional, pAMSignatureVersion=pAMSignatureVersion, stHttpRequests=stHttpRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpBytesFromServer=stHttpBytesFromServer, kProductVersion=kProductVersion, stCPULoad=stCPULoad)
