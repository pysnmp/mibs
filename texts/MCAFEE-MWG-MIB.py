...
ModuleIdentity, NotificationType, Integer32, Unsigned32, enterprises, Counter64, ObjectIdentity, MibIdentifier, Gauge32, NotificationType, iso, Bits, mib_2, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "Integer32", "Unsigned32", "enterprises", "Counter64", "ObjectIdentity", "MibIdentifier", "Gauge32", "NotificationType", "iso", "Bits", "mib-2", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", trSystem=trSystem, stBlockedByURLFilter=stBlockedByURLFilter, notifyAdditional=notifyAdditional, stHttpsRequests=stHttpsRequests, kBuildNumber=kBuildNumber, kCompanyName=kCompanyName, kCustomVersion=kCustomVersion, trUser=trUser, kProductVersion=kProductVersion, mwgEngineVersions=mwgEngineVersions, mwgContent=mwgContent, mwgTraps=mwgTraps, notifyOriginName=notifyOriginName, stFtpBytesFromClient=stFtpBytesFromClient, stMimeType=stMimeType, stFtpBytesToServer=stFtpBytesToServer, pAMEngineVersion=pAMEngineVersion, kHotfixVersion=kHotfixVersion, kMajorVersion=kMajorVersion, stHttpTraffic=stHttpTraffic, stTimeForTransaction=stTimeForTransaction, stBadReputation=stBadReputation, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, mwgHttp=mwgHttp, stFtpBytesToClient=stFtpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, mwgHttps=mwgHttps, stCategoriesTable=stCategoriesTable, stCategoriesEntry=stCategoriesEntry, stHttpBytesToServer=stHttpBytesToServer, mwgStatistics=mwgStatistics, pAMSignatureVersion=pAMSignatureVersion, mwgFTP=mwgFTP, stConnectedSockets=stConnectedSockets, trApplication=trApplication, pAMProactiveVersion=pAMProactiveVersion, pTSDBVersion=pTSDBVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyReason=notifyReason, kRevision=kRevision, stHttpBytesFromServer=stHttpBytesFromServer, mwgTrapVariables=mwgTrapVariables, stCPULoadRaw=stCPULoadRaw, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpRequests=stHttpRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesToClient=stHttpBytesToClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyReasonString=notifyReasonString, stFtpTraffic=stFtpTraffic, stCPULoad=stCPULoad, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoryCount=stCategoryCount, PYSNMP_MODULE_ID=mwg, notifyAffectedHost=notifyAffectedHost, stBlockedByMediaFilter=stBlockedByMediaFilter, kMinorVersion=kMinorVersion, stMalwareDetected=stMalwareDetected, mwgMiscellaneous=mwgMiscellaneous, mwg=mwg, mwgInfo=mwgInfo, stConnectionsBlocked=stConnectionsBlocked, kProductName=kProductName, pMFEDATVersion=pMFEDATVersion, notifySeverity=notifySeverity, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyOrigin=notifyOrigin, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsTraffic=stHttpsTraffic, stCategories=stCategories, stHandleConnectToServer=stHandleConnectToServer, stMemConsumed=stMemConsumed, kMicroVersion=kMicroVersion, stCategoryName=stCategoryName, stCPUIOWait=stCPUIOWait, stConnectionsLegitimate=stConnectionsLegitimate, stClientCount=stClientCount)
