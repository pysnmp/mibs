...
Counter64, iso, ObjectIdentity, ModuleIdentity, Counter32, NotificationType, Gauge32, Unsigned32, Integer32, enterprises, TimeTicks, mib_2, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "ObjectIdentity", "ModuleIdentity", "Counter32", "NotificationType", "Gauge32", "Unsigned32", "Integer32", "enterprises", "TimeTicks", "mib-2", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgHttps=mwgHttps, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategoriesTable=stCategoriesTable, stResolveHostViaDNS=stResolveHostViaDNS, stTimeForTransaction=stTimeForTransaction, pMFEEngineVersion=pMFEEngineVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgMiscellaneous=mwgMiscellaneous, notifyReasonString=notifyReasonString, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, pAMEngineVersion=pAMEngineVersion, stFtpBytesFromServer=stFtpBytesFromServer, mwgFTP=mwgFTP, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pAMSignatureVersion=pAMSignatureVersion, kProductName=kProductName, notifySeverity=notifySeverity, mwgContent=mwgContent, mwgTrapVariables=mwgTrapVariables, stCPULoadRaw=stCPULoadRaw, stHttpsRequests=stHttpsRequests, trSystem=trSystem, kRevision=kRevision, stHttpRequests=stHttpRequests, stConnectedSockets=stConnectedSockets, kProductVersion=kProductVersion, mwgEngineVersions=mwgEngineVersions, notifyOrigin=notifyOrigin, kMinorVersion=kMinorVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgTraps=mwgTraps, notifyReason=notifyReason, stBlockedByURLFilter=stBlockedByURLFilter, kHotfixVersion=kHotfixVersion, pTSDBVersion=pTSDBVersion, stMimeType=stMimeType, notifyAffectedHost=notifyAffectedHost, stCategoryName=stCategoryName, stHttpsTraffic=stHttpsTraffic, stHttpBytesToServer=stHttpBytesToServer, stClientCount=stClientCount, mwgInfo=mwgInfo, kMicroVersion=kMicroVersion, trUser=trUser, kCustomVersion=kCustomVersion, stHttpTraffic=stHttpTraffic, stHttpsBytesFromClient=stHttpsBytesFromClient, stBadReputation=stBadReputation, stConnectionsBlocked=stConnectionsBlocked, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pMFEDATVersion=pMFEDATVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgStatistics=mwgStatistics, stFtpTraffic=stFtpTraffic, stHttpBytesFromServer=stHttpBytesFromServer, mwg=mwg, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCPUIOWait=stCPUIOWait, stCPULoad=stCPULoad, trApplication=trApplication, kMajorVersion=kMajorVersion, stFtpBytesToServer=stFtpBytesToServer, notifyAdditional=notifyAdditional, mwgHttp=mwgHttp, notifyOriginName=notifyOriginName, kBuildNumber=kBuildNumber, pAMProactiveVersion=pAMProactiveVersion, stCategoryCount=stCategoryCount, stBlockedByMediaFilter=stBlockedByMediaFilter, stMalwareDetected=stMalwareDetected, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesToClient=stHttpBytesToClient, stMemConsumed=stMemConsumed, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesEntry=stCategoriesEntry, PYSNMP_MODULE_ID=mwg, stHandleConnectToServer=stHandleConnectToServer, kCompanyName=kCompanyName, stCategories=stCategories)
