...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, NotificationType, Gauge32, iso, ObjectIdentity, Integer32, TimeTicks, IpAddress, enterprises, Unsigned32, Counter64, MibIdentifier, ModuleIdentity, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "NotificationType", "Gauge32", "iso", "ObjectIdentity", "Integer32", "TimeTicks", "IpAddress", "enterprises", "Unsigned32", "Counter64", "MibIdentifier", "ModuleIdentity", "Bits", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesFromClient=stHttpsBytesFromClient, notifyOrigin=notifyOrigin, mwgStatistics=mwgStatistics, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoryName=stCategoryName, notifyOriginName=notifyOriginName, stFtpBytesFromClient=stFtpBytesFromClient, mwg=mwg, kCompanyName=kCompanyName, kHotfixVersion=kHotfixVersion, stFtpBytesFromServer=stFtpBytesFromServer, pMFEDATVersion=pMFEDATVersion, pAMEngineVersion=pAMEngineVersion, kRevision=kRevision, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsRequests=stHttpsRequests, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgInfo=mwgInfo, pTSDBVersion=pTSDBVersion, stCategoriesTable=stCategoriesTable, stMimeType=stMimeType, kMinorVersion=kMinorVersion, mwgFTP=mwgFTP, notifyAffectedHost=notifyAffectedHost, stResolveHostViaDNS=stResolveHostViaDNS, PYSNMP_MODULE_ID=mwg, stBlockedByAntiMalware=stBlockedByAntiMalware, stCPULoadRaw=stCPULoadRaw, mwgEngineVersions=mwgEngineVersions, notifyReasonString=notifyReasonString, stHttpBytesFromClient=stHttpBytesFromClient, stCPULoad=stCPULoad, mwgTraps=mwgTraps, stCategories=stCategories, stTimeForTransaction=stTimeForTransaction, notifySeverity=notifySeverity, stHttpsBytesToServer=stHttpsBytesToServer, mwgTrapVariables=mwgTrapVariables, kProductName=kProductName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpTraffic=stHttpTraffic, stCategoriesEntry=stCategoriesEntry, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, stMalwareDetected=stMalwareDetected, trSystem=trSystem, pAMSignatureVersion=pAMSignatureVersion, kProductVersion=kProductVersion, stHttpBytesFromServer=stHttpBytesFromServer, trApplication=trApplication, kMicroVersion=kMicroVersion, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesToClient=stFtpBytesToClient, mwgHttps=mwgHttps, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectionsLegitimate=stConnectionsLegitimate, kCustomVersion=kCustomVersion, trUser=trUser, stConnectedSockets=stConnectedSockets, stHttpBytesToClient=stHttpBytesToClient, pAMProactiveVersion=pAMProactiveVersion, stHttpRequests=stHttpRequests, stMemConsumed=stMemConsumed, stBadReputation=stBadReputation, stCPUIOWait=stCPUIOWait, stHttpBytesToServer=stHttpBytesToServer, mwgHttp=mwgHttp, stHttpsTraffic=stHttpsTraffic, stCategoryCount=stCategoryCount, kMajorVersion=kMajorVersion, stFtpBytesToServer=stFtpBytesToServer, kBuildNumber=kBuildNumber, pMFEEngineVersion=pMFEEngineVersion, notifyReason=notifyReason, mwgContent=mwgContent, notifyAdditional=notifyAdditional, stFtpTraffic=stFtpTraffic, mwgMiscellaneous=mwgMiscellaneous, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stClientCount=stClientCount)
