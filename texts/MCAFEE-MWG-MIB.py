...
Counter64, Counter32, NotificationType, Bits, enterprises, ModuleIdentity, mib_2, NotificationType, ObjectIdentity, MibIdentifier, IpAddress, iso, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Counter32", "NotificationType", "Bits", "enterprises", "ModuleIdentity", "mib-2", "NotificationType", "ObjectIdentity", "MibIdentifier", "IpAddress", "iso", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyReasonString=notifyReasonString, stCPUIOWait=stCPUIOWait, mwgStatistics=mwgStatistics, stFtpBytesToServer=stFtpBytesToServer, stConnectedSockets=stConnectedSockets, kProductVersion=kProductVersion, stResolveHostViaDNS=stResolveHostViaDNS, kMajorVersion=kMajorVersion, stHttpRequests=stHttpRequests, notifyOrigin=notifyOrigin, pAMEngineVersion=pAMEngineVersion, stConnectionsLegitimate=stConnectionsLegitimate, pMFEDATVersion=pMFEDATVersion, stHttpBytesFromClient=stHttpBytesFromClient, kCompanyName=kCompanyName, trUser=trUser, stConnectionsBlocked=stConnectionsBlocked, mwgFTP=mwgFTP, stFtpTraffic=stFtpTraffic, kRevision=kRevision, stCategories=stCategories, stCPULoadRaw=stCPULoadRaw, notifyAffectedHost=notifyAffectedHost, stHttpBytesFromServer=stHttpBytesFromServer, mwgHttps=mwgHttps, stTimeForTransaction=stTimeForTransaction, pMFEEngineVersion=pMFEEngineVersion, stHttpTraffic=stHttpTraffic, notifyOriginName=notifyOriginName, stBadReputation=stBadReputation, stFtpBytesFromClient=stFtpBytesFromClient, stCategoriesTable=stCategoriesTable, mwgTraps=mwgTraps, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoryCount=stCategoryCount, stHttpsRequests=stHttpsRequests, trApplication=trApplication, notifyAdditional=notifyAdditional, stMalwareDetected=stMalwareDetected, pTSDBVersion=pTSDBVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, kMicroVersion=kMicroVersion, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, kCustomVersion=kCustomVersion, notifyReason=notifyReason, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesToServer=stHttpBytesToServer, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttp=mwgHttp, trSystem=trSystem, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgEngineVersions=mwgEngineVersions, stMimeType=stMimeType, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpBytesToClient=stHttpBytesToClient, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesToClient=stFtpBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesToClient=stHttpsBytesToClient, mwgContent=mwgContent, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMemConsumed=stMemConsumed, notifySeverity=notifySeverity, stHttpsTraffic=stHttpsTraffic, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, mwgTrapVariables=mwgTrapVariables, stCPULoad=stCPULoad, kProductName=kProductName, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesFromServer=stFtpBytesFromServer, kBuildNumber=kBuildNumber, PYSNMP_MODULE_ID=mwg, mwgMiscellaneous=mwgMiscellaneous, mwgInfo=mwgInfo, kHotfixVersion=kHotfixVersion, mwg=mwg, kMinorVersion=kMinorVersion, stCategoryName=stCategoryName, stClientCount=stClientCount)
