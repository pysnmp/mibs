...
Counter64, Integer32, Bits, TimeTicks, NotificationType, Counter32, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, Gauge32, NotificationType, iso, mib_2, MibIdentifier, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "Bits", "TimeTicks", "NotificationType", "Counter32", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "Gauge32", "NotificationType", "iso", "mib-2", "MibIdentifier", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgFTP=mwgFTP, mwgEngineVersions=mwgEngineVersions, stHttpBytesToServer=stHttpBytesToServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMicroVersion=kMicroVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesToClient=stHttpsBytesToClient, stCPUIOWait=stCPUIOWait, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectedSockets=stConnectedSockets, stCPULoadRaw=stCPULoadRaw, mwgHttps=mwgHttps, stHttpBytesToClient=stHttpBytesToClient, kMajorVersion=kMajorVersion, stHttpBytesFromClient=stHttpBytesFromClient, trUser=trUser, stConnectionsBlocked=stConnectionsBlocked, kCompanyName=kCompanyName, pAMEngineVersion=pAMEngineVersion, notifyOrigin=notifyOrigin, stHttpRequests=stHttpRequests, stResolveHostViaDNS=stResolveHostViaDNS, kCustomVersion=kCustomVersion, stHttpTraffic=stHttpTraffic, kProductName=kProductName, mwgMiscellaneous=mwgMiscellaneous, mwgTrapVariables=mwgTrapVariables, notifyAdditional=notifyAdditional, stHttpBytesFromServer=stHttpBytesFromServer, stCategories=stCategories, stHttpsRequests=stHttpsRequests, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesToServer=stFtpBytesToServer, kBuildNumber=kBuildNumber, stCPULoad=stCPULoad, kRevision=kRevision, kProductVersion=kProductVersion, pAMProactiveVersion=pAMProactiveVersion, stMemConsumed=stMemConsumed, kMinorVersion=kMinorVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stMimeType=stMimeType, notifyOriginName=notifyOriginName, kHotfixVersion=kHotfixVersion, pMFEEngineVersion=pMFEEngineVersion, mwgContent=mwgContent, trApplication=trApplication, notifySeverity=notifySeverity, stMalwareDetected=stMalwareDetected, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesToClient=stFtpBytesToClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTraps=mwgTraps, notifyReasonString=notifyReasonString, stFtpBytesFromClient=stFtpBytesFromClient, mwg=mwg, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesFromClient=stHttpsBytesFromClient, stClientCount=stClientCount, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgHttp=mwgHttp, stBlockedByURLFilter=stBlockedByURLFilter, mwgInfo=mwgInfo, stCategoryName=stCategoryName, stCategoriesTable=stCategoriesTable, stHttpsBytesToServer=stHttpsBytesToServer, notifyReason=notifyReason, trSystem=trSystem, mwgStatistics=mwgStatistics, stFtpBytesFromServer=stFtpBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, PYSNMP_MODULE_ID=mwg, stCategoriesEntry=stCategoriesEntry, stBadReputation=stBadReputation, stTimeForTransaction=stTimeForTransaction, notifyAffectedHost=notifyAffectedHost, stFtpTraffic=stFtpTraffic, stHttpsTraffic=stHttpsTraffic, pTSDBVersion=pTSDBVersion, pAMSignatureVersion=pAMSignatureVersion, stCategoryCount=stCategoryCount, pMFEDATVersion=pMFEDATVersion)
