...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, NotificationType, NotificationType, iso, enterprises, Gauge32, mib_2, MibIdentifier, Unsigned32, ModuleIdentity, TimeTicks, IpAddress, Integer32, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "NotificationType", "NotificationType", "iso", "enterprises", "Gauge32", "mib-2", "MibIdentifier", "Unsigned32", "ModuleIdentity", "TimeTicks", "IpAddress", "Integer32", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMimeType=stMimeType, pMFEEngineVersion=pMFEEngineVersion, stCategoryCount=stCategoryCount, PYSNMP_MODULE_ID=mwg, trUser=trUser, kCustomVersion=kCustomVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMinorVersion=kMinorVersion, stFtpTraffic=stFtpTraffic, stFtpBytesFromServer=stFtpBytesFromServer, kMajorVersion=kMajorVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stConnectionsLegitimate=stConnectionsLegitimate, stTimeForTransaction=stTimeForTransaction, mwgHttp=mwgHttp, kProductName=kProductName, mwgContent=mwgContent, stHttpBytesFromServer=stHttpBytesFromServer, kCompanyName=kCompanyName, stCategoryName=stCategoryName, mwgTrapVariables=mwgTrapVariables, notifyAdditional=notifyAdditional, stCategoriesTable=stCategoriesTable, mwgTraps=mwgTraps, pMFEDATVersion=pMFEDATVersion, trApplication=trApplication, stBlockedByURLFilter=stBlockedByURLFilter, notifyOrigin=notifyOrigin, notifySeverity=notifySeverity, stCategories=stCategories, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsRequests=stHttpsRequests, mwgMiscellaneous=mwgMiscellaneous, notifyAffectedHost=notifyAffectedHost, pAMProactiveVersion=pAMProactiveVersion, stMemConsumed=stMemConsumed, kBuildNumber=kBuildNumber, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectionsBlocked=stConnectionsBlocked, stFtpBytesToClient=stFtpBytesToClient, notifyOriginName=notifyOriginName, kMicroVersion=kMicroVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stClientCount=stClientCount, pTSDBVersion=pTSDBVersion, stHttpBytesFromClient=stHttpBytesFromClient, stCPULoadRaw=stCPULoadRaw, mwgInfo=mwgInfo, stHandleConnectToServer=stHandleConnectToServer, kProductVersion=kProductVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpRequests=stHttpRequests, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesFromClient=stFtpBytesFromClient, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgFTP=mwgFTP, mwgStatistics=mwgStatistics, stHttpBytesToClient=stHttpBytesToClient, stCategoriesEntry=stCategoriesEntry, pAMSignatureVersion=pAMSignatureVersion, stHttpTraffic=stHttpTraffic, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kHotfixVersion=kHotfixVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgHttps=mwgHttps, mwgEngineVersions=mwgEngineVersions, notifyReasonString=notifyReasonString, stResolveHostViaDNS=stResolveHostViaDNS, stMalwareDetected=stMalwareDetected, stBadReputation=stBadReputation, kRevision=kRevision, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoad=stCPULoad, notifyReason=notifyReason, stHttpBytesToServer=stHttpBytesToServer, trSystem=trSystem, pAMEngineVersion=pAMEngineVersion, stConnectedSockets=stConnectedSockets, stHttpsTraffic=stHttpsTraffic, mwg=mwg, stCPUIOWait=stCPUIOWait)
