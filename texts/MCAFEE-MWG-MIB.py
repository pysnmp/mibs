...
NotificationType, ObjectIdentity, mib_2, Integer32, Counter64, IpAddress, Bits, Counter32, NotificationType, Unsigned32, ModuleIdentity, enterprises, TimeTicks, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "mib-2", "Integer32", "Counter64", "IpAddress", "Bits", "Counter32", "NotificationType", "Unsigned32", "ModuleIdentity", "enterprises", "TimeTicks", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsBytesToClient=stHttpsBytesToClient, mwgTrapVariables=mwgTrapVariables, stConnectedSockets=stConnectedSockets, mwgHttps=mwgHttps, pMFEEngineVersion=pMFEEngineVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyOriginName=notifyOriginName, stCPUIOWait=stCPUIOWait, notifyReasonString=notifyReasonString, notifyAdditional=notifyAdditional, stHttpsTraffic=stHttpsTraffic, notifyReason=notifyReason, mwgStatistics=mwgStatistics, trSystem=trSystem, stConnectionsBlocked=stConnectionsBlocked, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgHttp=mwgHttp, mwg=mwg, stBadReputation=stBadReputation, PYSNMP_MODULE_ID=mwg, pAMProactiveVersion=pAMProactiveVersion, stTimeForTransaction=stTimeForTransaction, mwgContent=mwgContent, mwgTraps=mwgTraps, kMajorVersion=kMajorVersion, kBuildNumber=kBuildNumber, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, kHotfixVersion=kHotfixVersion, stResolveHostViaDNS=stResolveHostViaDNS, stFtpTraffic=stFtpTraffic, stCategoryName=stCategoryName, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pTSDBVersion=pTSDBVersion, stCategoryCount=stCategoryCount, stCPULoad=stCPULoad, mwgEngineVersions=mwgEngineVersions, notifyAffectedHost=notifyAffectedHost, stCategories=stCategories, kCustomVersion=kCustomVersion, stConnectionsLegitimate=stConnectionsLegitimate, notifySeverity=notifySeverity, stHandleConnectToServer=stHandleConnectToServer, notifyOrigin=notifyOrigin, kCompanyName=kCompanyName, trUser=trUser, stFtpBytesFromServer=stFtpBytesFromServer, stHttpRequests=stHttpRequests, stFtpBytesToServer=stFtpBytesToServer, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesToClient=stFtpBytesToClient, stCategoriesEntry=stCategoriesEntry, stCategoriesTable=stCategoriesTable, stCPULoadRaw=stCPULoadRaw, mwgInfo=mwgInfo, stClientCount=stClientCount, stMemConsumed=stMemConsumed, mwgMiscellaneous=mwgMiscellaneous, kMinorVersion=kMinorVersion, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesFromServer=stHttpsBytesFromServer, pAMEngineVersion=pAMEngineVersion, mwgFTP=mwgFTP, trApplication=trApplication, pMFEDATVersion=pMFEDATVersion, stHttpBytesFromServer=stHttpBytesFromServer, kRevision=kRevision, kProductVersion=kProductVersion, kMicroVersion=kMicroVersion, kProductName=kProductName, stMimeType=stMimeType, stBlockedByMediaFilter=stBlockedByMediaFilter, stMalwareDetected=stMalwareDetected, stHttpsRequests=stHttpsRequests, stHttpTraffic=stHttpTraffic, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesToClient=stHttpBytesToClient)
