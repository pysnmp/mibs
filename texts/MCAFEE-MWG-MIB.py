...
Gauge32, MibIdentifier, ModuleIdentity, Integer32, Counter32, TimeTicks, ObjectIdentity, Bits, NotificationType, enterprises, iso, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, mib_2, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "ModuleIdentity", "Integer32", "Counter32", "TimeTicks", "ObjectIdentity", "Bits", "NotificationType", "enterprises", "iso", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "mib-2", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgStatistics=mwgStatistics, stCategoryName=stCategoryName, mwg=mwg, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoriesEntry=stCategoriesEntry, kRevision=kRevision, stConnectionsLegitimate=stConnectionsLegitimate, notifyAdditional=notifyAdditional, stTimeForTransaction=stTimeForTransaction, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyAffectedHost=notifyAffectedHost, stHttpTraffic=stHttpTraffic, pAMEngineVersion=pAMEngineVersion, pAMSignatureVersion=pAMSignatureVersion, stBadReputation=stBadReputation, kBuildNumber=kBuildNumber, stConnectedSockets=stConnectedSockets, trSystem=trSystem, stHttpsTraffic=stHttpsTraffic, pMFEDATVersion=pMFEDATVersion, notifyOrigin=notifyOrigin, mwgTrapVariables=mwgTrapVariables, notifySeverity=notifySeverity, stResolveHostViaDNS=stResolveHostViaDNS, PYSNMP_MODULE_ID=mwg, mwgFTP=mwgFTP, stFtpBytesToClient=stFtpBytesToClient, pTSDBVersion=pTSDBVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgHttp=mwgHttp, stHttpsBytesToServer=stHttpsBytesToServer, stCPULoad=stCPULoad, stHttpBytesToServer=stHttpBytesToServer, stFtpTraffic=stFtpTraffic, stMimeType=stMimeType, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsRequests=stHttpsRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, stMalwareDetected=stMalwareDetected, trApplication=trApplication, notifyReason=notifyReason, kCompanyName=kCompanyName, mwgEngineVersions=mwgEngineVersions, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgMiscellaneous=mwgMiscellaneous, kHotfixVersion=kHotfixVersion, notifyOriginName=notifyOriginName, trUser=trUser, stCategoryCount=stCategoryCount, kProductVersion=kProductVersion, stCPULoadRaw=stCPULoadRaw, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, stClientCount=stClientCount, notifyReasonString=notifyReasonString, mwgInfo=mwgInfo, kCustomVersion=kCustomVersion, stMemConsumed=stMemConsumed, mwgTraps=mwgTraps, stConnectionsBlocked=stConnectionsBlocked, kMicroVersion=kMicroVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesToClient=stHttpsBytesToClient, pAMProactiveVersion=pAMProactiveVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, kMinorVersion=kMinorVersion, mwgContent=mwgContent, stFtpBytesToServer=stFtpBytesToServer, stHttpRequests=stHttpRequests, kMajorVersion=kMajorVersion, stCategories=stCategories, kProductName=kProductName, stCategoriesTable=stCategoriesTable, pMFEEngineVersion=pMFEEngineVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesFromClient=stFtpBytesFromClient, stBlockedByURLFilter=stBlockedByURLFilter, stCPUIOWait=stCPUIOWait, stHandleConnectToServer=stHandleConnectToServer, mwgHttps=mwgHttps)
