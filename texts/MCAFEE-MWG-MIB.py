...
mib_2, Bits, ModuleIdentity, Counter64, NotificationType, enterprises, MibIdentifier, Counter32, ObjectIdentity, Unsigned32, NotificationType, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Bits", "ModuleIdentity", "Counter64", "NotificationType", "enterprises", "MibIdentifier", "Counter32", "ObjectIdentity", "Unsigned32", "NotificationType", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpBytesToServer=stHttpBytesToServer, stHttpsTraffic=stHttpsTraffic, mwgInfo=mwgInfo, stHttpRequests=stHttpRequests, pMFEEngineVersion=pMFEEngineVersion, mwgTraps=mwgTraps, stHttpBytesToClient=stHttpBytesToClient, stFtpTraffic=stFtpTraffic, stMalwareDetected=stMalwareDetected, mwgMiscellaneous=mwgMiscellaneous, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoryName=stCategoryName, kMicroVersion=kMicroVersion, trSystem=trSystem, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kProductVersion=kProductVersion, kHotfixVersion=kHotfixVersion, mwgFTP=mwgFTP, stFtpBytesFromClient=stFtpBytesFromClient, stCategoriesTable=stCategoriesTable, stHttpsBytesFromClient=stHttpsBytesFromClient, kRevision=kRevision, mwgTrapVariables=mwgTrapVariables, pAMSignatureVersion=pAMSignatureVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesFromClient=stHttpBytesFromClient, mwgHttps=mwgHttps, trApplication=trApplication, stMemConsumed=stMemConsumed, notifyAdditional=notifyAdditional, notifyReasonString=notifyReasonString, stFtpBytesToClient=stFtpBytesToClient, stClientCount=stClientCount, kMinorVersion=kMinorVersion, stFtpBytesToServer=stFtpBytesToServer, trUser=trUser, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesFromServer=stFtpBytesFromServer, kMajorVersion=kMajorVersion, mwgEngineVersions=mwgEngineVersions, stCPUIOWait=stCPUIOWait, stHttpBytesFromServer=stHttpBytesFromServer, stMimeType=stMimeType, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pTSDBVersion=pTSDBVersion, stBadReputation=stBadReputation, notifySeverity=notifySeverity, PYSNMP_MODULE_ID=mwg, notifyOriginName=notifyOriginName, pMFEDATVersion=pMFEDATVersion, stCPULoadRaw=stCPULoadRaw, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyAffectedHost=notifyAffectedHost, kProductName=kProductName, kCompanyName=kCompanyName, stCPULoad=stCPULoad, pAMProactiveVersion=pAMProactiveVersion, kCustomVersion=kCustomVersion, stBlockedByURLFilter=stBlockedByURLFilter, stHttpTraffic=stHttpTraffic, mwgStatistics=mwgStatistics, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsRequests=stHttpsRequests, mwgContent=mwgContent, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stConnectedSockets=stConnectedSockets, notifyOrigin=notifyOrigin, stCategoriesEntry=stCategoriesEntry, stTimeForTransaction=stTimeForTransaction, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsBytesFromServer=stHttpsBytesFromServer, mwg=mwg, pAMEngineVersion=pAMEngineVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stHandleConnectToServer=stHandleConnectToServer, stCategories=stCategories, stConnectionsBlocked=stConnectionsBlocked, stCategoryCount=stCategoryCount, mwgHttp=mwgHttp, stHttpsBytesToClient=stHttpsBytesToClient, kBuildNumber=kBuildNumber, notifyReason=notifyReason)
