...
Counter64, NotificationType, Integer32, mib_2, iso, Unsigned32, NotificationType, IpAddress, ObjectIdentity, MibIdentifier, ModuleIdentity, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "Integer32", "mib-2", "iso", "Unsigned32", "NotificationType", "IpAddress", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pAMEngineVersion=pAMEngineVersion, trApplication=trApplication, stFtpBytesFromClient=stFtpBytesFromClient, kCompanyName=kCompanyName, kHotfixVersion=kHotfixVersion, stCategoriesTable=stCategoriesTable, notifyOrigin=notifyOrigin, kCustomVersion=kCustomVersion, stCategoryName=stCategoryName, mwg=mwg, stBlockedByAntiMalware=stBlockedByAntiMalware, stConnectedSockets=stConnectedSockets, notifyAdditional=notifyAdditional, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kRevision=kRevision, kProductVersion=kProductVersion, pAMProactiveVersion=pAMProactiveVersion, stBlockedByURLFilter=stBlockedByURLFilter, stCategoriesEntry=stCategoriesEntry, pAMSignatureVersion=pAMSignatureVersion, pTSDBVersion=pTSDBVersion, mwgFTP=mwgFTP, stConnectionsBlocked=stConnectionsBlocked, stHandleConnectToServer=stHandleConnectToServer, stHttpBytesFromServer=stHttpBytesFromServer, trSystem=trSystem, stHttpsTraffic=stHttpsTraffic, kBuildNumber=kBuildNumber, trUser=trUser, notifyReasonString=notifyReasonString, stHttpBytesToClient=stHttpBytesToClient, notifySeverity=notifySeverity, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyOriginName=notifyOriginName, stBlockedByMediaFilter=stBlockedByMediaFilter, stResolveHostViaDNS=stResolveHostViaDNS, stCategories=stCategories, mwgContent=mwgContent, kProductName=kProductName, stClientCount=stClientCount, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMinorVersion=kMinorVersion, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesToServer=stFtpBytesToServer, stHttpRequests=stHttpRequests, stHttpBytesFromClient=stHttpBytesFromClient, stCPULoadRaw=stCPULoadRaw, stMimeType=stMimeType, mwgHttp=mwgHttp, kMicroVersion=kMicroVersion, stFtpBytesToClient=stFtpBytesToClient, notifyAffectedHost=notifyAffectedHost, stMalwareDetected=stMalwareDetected, mwgInfo=mwgInfo, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pMFEDATVersion=pMFEDATVersion, stCategoryCount=stCategoryCount, stMemConsumed=stMemConsumed, mwgMiscellaneous=mwgMiscellaneous, mwgEngineVersions=mwgEngineVersions, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesToServer=stHttpBytesToServer, mwgTrapVariables=mwgTrapVariables, stFtpTraffic=stFtpTraffic, stHttpsRequests=stHttpsRequests, stCPULoad=stCPULoad, stHttpsBytesToServer=stHttpsBytesToServer, pMFEEngineVersion=pMFEEngineVersion, mwgStatistics=mwgStatistics, notifyReason=notifyReason, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgTraps=mwgTraps, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, stHttpTraffic=stHttpTraffic, PYSNMP_MODULE_ID=mwg, stCPUIOWait=stCPUIOWait, kMajorVersion=kMajorVersion, stBadReputation=stBadReputation, stTimeForTransaction=stTimeForTransaction, mwgHttps=mwgHttps)
