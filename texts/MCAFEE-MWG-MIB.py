...
Unsigned32, Counter32, ModuleIdentity, iso, Integer32, IpAddress, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, Gauge32, MibIdentifier, Bits, mib_2, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "ModuleIdentity", "iso", "Integer32", "IpAddress", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "Gauge32", "MibIdentifier", "Bits", "mib-2", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMProactiveVersion=pAMProactiveVersion, stResolveHostViaDNS=stResolveHostViaDNS, stFtpTraffic=stFtpTraffic, stHttpsBytesToClient=stHttpsBytesToClient, mwgHttps=mwgHttps, stBlockedByAntiMalware=stBlockedByAntiMalware, pTSDBVersion=pTSDBVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCPULoadRaw=stCPULoadRaw, mwgFTP=mwgFTP, mwgHttp=mwgHttp, stClientCount=stClientCount, mwgContent=mwgContent, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, stBlockedByURLFilter=stBlockedByURLFilter, pMFEDATVersion=pMFEDATVersion, stHttpBytesToClient=stHttpBytesToClient, mwgTraps=mwgTraps, notifySeverity=notifySeverity, stFtpBytesFromServer=stFtpBytesFromServer, notifyOriginName=notifyOriginName, stBadReputation=stBadReputation, kBuildNumber=kBuildNumber, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpRequests=stHttpRequests, stHttpsRequests=stHttpsRequests, notifyOrigin=notifyOrigin, mwgTrapVariables=mwgTrapVariables, kProductVersion=kProductVersion, stTimeForTransaction=stTimeForTransaction, mwgStatistics=mwgStatistics, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMajorVersion=kMajorVersion, trUser=trUser, stHandleConnectToServer=stHandleConnectToServer, trSystem=trSystem, stCategoryName=stCategoryName, stHttpTraffic=stHttpTraffic, kProductName=kProductName, mwgEngineVersions=mwgEngineVersions, notifyReasonString=notifyReasonString, pAMSignatureVersion=pAMSignatureVersion, pAMEngineVersion=pAMEngineVersion, stFtpBytesToClient=stFtpBytesToClient, notifyReason=notifyReason, stCPUIOWait=stCPUIOWait, PYSNMP_MODULE_ID=mwg, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectionsLegitimate=stConnectionsLegitimate, stCPULoad=stCPULoad, kCustomVersion=kCustomVersion, stHttpsTraffic=stHttpsTraffic, kHotfixVersion=kHotfixVersion, pMFEEngineVersion=pMFEEngineVersion, stCategoryCount=stCategoryCount, stConnectedSockets=stConnectedSockets, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMemConsumed=stMemConsumed, mwgInfo=mwgInfo, trApplication=trApplication, stFtpBytesToServer=stFtpBytesToServer, kMicroVersion=kMicroVersion, stHttpsBytesToServer=stHttpsBytesToServer, stCategoriesTable=stCategoriesTable, stConnectionsBlocked=stConnectionsBlocked, kMinorVersion=kMinorVersion, stHttpBytesFromServer=stHttpBytesFromServer, stHttpBytesToServer=stHttpBytesToServer, stCategoriesEntry=stCategoriesEntry, notifyAffectedHost=notifyAffectedHost, stHttpsBytesFromServer=stHttpsBytesFromServer, mwg=mwg, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, notifyAdditional=notifyAdditional, stFtpBytesFromClient=stFtpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, stCategories=stCategories, kRevision=kRevision, kCompanyName=kCompanyName, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMimeType=stMimeType, stHttpBytesFromClient=stHttpBytesFromClient)
