...
MibIdentifier, ObjectIdentity, iso, Unsigned32, Counter32, mib_2, Bits, enterprises, NotificationType, ModuleIdentity, IpAddress, NotificationType, TimeTicks, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "iso", "Unsigned32", "Counter32", "mib-2", "Bits", "enterprises", "NotificationType", "ModuleIdentity", "IpAddress", "NotificationType", "TimeTicks", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoryCount=stCategoryCount, kMajorVersion=kMajorVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stResolveHostViaDNS=stResolveHostViaDNS, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsRequests=stHttpsRequests, pMFEDATVersion=pMFEDATVersion, mwgEngineVersions=mwgEngineVersions, notifySeverity=notifySeverity, stCPULoad=stCPULoad, notifyOriginName=notifyOriginName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stFtpBytesToClient=stFtpBytesToClient, trApplication=trApplication, stCategoriesEntry=stCategoriesEntry, PYSNMP_MODULE_ID=mwg, kProductName=kProductName, stHttpBytesToClient=stHttpBytesToClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyAffectedHost=notifyAffectedHost, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kCompanyName=kCompanyName, stHttpsTraffic=stHttpsTraffic, mwgFTP=mwgFTP, pAMSignatureVersion=pAMSignatureVersion, notifyReason=notifyReason, stConnectionsBlocked=stConnectionsBlocked, pAMEngineVersion=pAMEngineVersion, stMalwareDetected=stMalwareDetected, kHotfixVersion=kHotfixVersion, stFtpBytesFromServer=stFtpBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, pTSDBVersion=pTSDBVersion, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesToServer=stFtpBytesToServer, mwg=mwg, notifyAdditional=notifyAdditional, stHandleConnectToServer=stHandleConnectToServer, stCategories=stCategories, kProductVersion=kProductVersion, kRevision=kRevision, stCPUIOWait=stCPUIOWait, stMimeType=stMimeType, stTimeForTransaction=stTimeForTransaction, stFtpTraffic=stFtpTraffic, stHttpsBytesToClient=stHttpsBytesToClient, mwgMiscellaneous=mwgMiscellaneous, pAMProactiveVersion=pAMProactiveVersion, stHttpRequests=stHttpRequests, kMicroVersion=kMicroVersion, stHttpTraffic=stHttpTraffic, trSystem=trSystem, stConnectedSockets=stConnectedSockets, stHttpsBytesToServer=stHttpsBytesToServer, stBlockedByURLFilter=stBlockedByURLFilter, notifyOrigin=notifyOrigin, mwgHttp=mwgHttp, stHttpBytesToServer=stHttpBytesToServer, mwgStatistics=mwgStatistics, kMinorVersion=kMinorVersion, mwgContent=mwgContent, kCustomVersion=kCustomVersion, stClientCount=stClientCount, stBadReputation=stBadReputation, stCategoryName=stCategoryName, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgInfo=mwgInfo, notifyReasonString=notifyReasonString, stMemConsumed=stMemConsumed, stCategoriesTable=stCategoriesTable, mwgHttps=mwgHttps, kBuildNumber=kBuildNumber, stCPULoadRaw=stCPULoadRaw, stBlockedByMediaFilter=stBlockedByMediaFilter, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTrapVariables=mwgTrapVariables, pMFEEngineVersion=pMFEEngineVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgTraps=mwgTraps, stHttpsBytesFromServer=stHttpsBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, trUser=trUser, stHttpBytesFromClient=stHttpBytesFromClient)
