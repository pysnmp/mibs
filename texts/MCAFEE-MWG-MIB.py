...
Integer32, ModuleIdentity, ObjectIdentity, TimeTicks, MibIdentifier, NotificationType, enterprises, Counter32, IpAddress, mib_2, NotificationType, Gauge32, Unsigned32, iso, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "MibIdentifier", "NotificationType", "enterprises", "Counter32", "IpAddress", "mib-2", "NotificationType", "Gauge32", "Unsigned32", "iso", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpTraffic=stHttpTraffic, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgHttp=mwgHttp, notifyReasonString=notifyReasonString, mwgTraps=mwgTraps, stConnectionsBlocked=stConnectionsBlocked, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyAffectedHost=notifyAffectedHost, kCustomVersion=kCustomVersion, notifyReason=notifyReason, stCPULoad=stCPULoad, stBlockedByMediaFilter=stBlockedByMediaFilter, pTSDBVersion=pTSDBVersion, stFtpBytesToClient=stFtpBytesToClient, stCPULoadRaw=stCPULoadRaw, stHttpRequests=stHttpRequests, mwg=mwg, stHttpsBytesToClient=stHttpsBytesToClient, notifyOriginName=notifyOriginName, pAMEngineVersion=pAMEngineVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, pAMSignatureVersion=pAMSignatureVersion, pAMProactiveVersion=pAMProactiveVersion, mwgContent=mwgContent, PYSNMP_MODULE_ID=mwg, stMemConsumed=stMemConsumed, trApplication=trApplication, stMimeType=stMimeType, stBadReputation=stBadReputation, mwgEngineVersions=mwgEngineVersions, mwgMiscellaneous=mwgMiscellaneous, notifySeverity=notifySeverity, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgInfo=mwgInfo, stHandleConnectToServer=stHandleConnectToServer, mwgHttps=mwgHttps, notifyOrigin=notifyOrigin, trSystem=trSystem, kCompanyName=kCompanyName, stHttpsTraffic=stHttpsTraffic, stCPUIOWait=stCPUIOWait, stHttpBytesToClient=stHttpBytesToClient, stMalwareDetected=stMalwareDetected, stResolveHostViaDNS=stResolveHostViaDNS, stCategoryCount=stCategoryCount, notifyAdditional=notifyAdditional, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesFromClient=stFtpBytesFromClient, stHttpsRequests=stHttpsRequests, stConnectedSockets=stConnectedSockets, kProductName=kProductName, stHttpBytesToServer=stHttpBytesToServer, stCategoryName=stCategoryName, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesFromClient=stHttpBytesFromClient, pMFEDATVersion=pMFEDATVersion, mwgStatistics=mwgStatistics, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kProductVersion=kProductVersion, stFtpBytesToServer=stFtpBytesToServer, stTimeForTransaction=stTimeForTransaction, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMajorVersion=kMajorVersion, trUser=trUser, stHttpsBytesFromServer=stHttpsBytesFromServer, kBuildNumber=kBuildNumber, stFtpTraffic=stFtpTraffic, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategories=stCategories, kMinorVersion=kMinorVersion, pMFEEngineVersion=pMFEEngineVersion, kHotfixVersion=kHotfixVersion, mwgTrapVariables=mwgTrapVariables, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoriesTable=stCategoriesTable, mwgFTP=mwgFTP, kRevision=kRevision, stFtpBytesFromServer=stFtpBytesFromServer, stCategoriesEntry=stCategoriesEntry, stClientCount=stClientCount, kMicroVersion=kMicroVersion)
