...
Integer32, Counter64, ModuleIdentity, Counter32, enterprises, MibIdentifier, mib_2, IpAddress, Bits, NotificationType, iso, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "ModuleIdentity", "Counter32", "enterprises", "MibIdentifier", "mib-2", "IpAddress", "Bits", "NotificationType", "iso", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kCompanyName=kCompanyName, pMFEDATVersion=pMFEDATVersion, stCategories=stCategories, stBadReputation=stBadReputation, stFtpTraffic=stFtpTraffic, stCategoryName=stCategoryName, notifyReason=notifyReason, stHttpsBytesFromServer=stHttpsBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyAffectedHost=notifyAffectedHost, kProductVersion=kProductVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsTraffic=stHttpsTraffic, stClientCount=stClientCount, trUser=trUser, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyOriginName=notifyOriginName, stFtpBytesToClient=stFtpBytesToClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgTraps=mwgTraps, stHttpBytesToServer=stHttpBytesToServer, mwgEngineVersions=mwgEngineVersions, stHandleConnectToServer=stHandleConnectToServer, kProductName=kProductName, stResolveHostViaDNS=stResolveHostViaDNS, mwg=mwg, stCPULoad=stCPULoad, stHttpBytesFromServer=stHttpBytesFromServer, kBuildNumber=kBuildNumber, stCategoriesEntry=stCategoriesEntry, stConnectedSockets=stConnectedSockets, notifyAdditional=notifyAdditional, stHttpRequests=stHttpRequests, stCPULoadRaw=stCPULoadRaw, kMinorVersion=kMinorVersion, stHttpBytesToClient=stHttpBytesToClient, kCustomVersion=kCustomVersion, pAMSignatureVersion=pAMSignatureVersion, stMemConsumed=stMemConsumed, stCPUIOWait=stCPUIOWait, mwgFTP=mwgFTP, mwgContent=mwgContent, kMicroVersion=kMicroVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectionsBlocked=stConnectionsBlocked, notifySeverity=notifySeverity, trApplication=trApplication, stHttpsBytesFromClient=stHttpsBytesFromClient, pTSDBVersion=pTSDBVersion, stBlockedByURLFilter=stBlockedByURLFilter, stCategoryCount=stCategoryCount, mwgHttp=mwgHttp, stCategoriesTable=stCategoriesTable, stConnectionsLegitimate=stConnectionsLegitimate, trSystem=trSystem, stMalwareDetected=stMalwareDetected, pAMProactiveVersion=pAMProactiveVersion, kHotfixVersion=kHotfixVersion, mwgTrapVariables=mwgTrapVariables, pMFEEngineVersion=pMFEEngineVersion, stHttpTraffic=stHttpTraffic, kMajorVersion=kMajorVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgHttps=mwgHttps, mwgStatistics=mwgStatistics, stTimeForTransaction=stTimeForTransaction, kRevision=kRevision, stLastSentLastReceivedServer=stLastSentLastReceivedServer, PYSNMP_MODULE_ID=mwg, notifyOrigin=notifyOrigin, mwgInfo=mwgInfo, stFtpBytesFromServer=stFtpBytesFromServer, mwgMiscellaneous=mwgMiscellaneous, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesToClient=stHttpsBytesToClient, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesToServer=stFtpBytesToServer, stMimeType=stMimeType, stHttpsRequests=stHttpsRequests, notifyReasonString=notifyReasonString)
