...
ObjectIdentity, Gauge32, Counter64, ModuleIdentity, mib_2, iso, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, Integer32, NotificationType, IpAddress, Bits, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "Counter64", "ModuleIdentity", "mib-2", "iso", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "Integer32", "NotificationType", "IpAddress", "Bits", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyAffectedHost=notifyAffectedHost, stCategoriesEntry=stCategoriesEntry, kMicroVersion=kMicroVersion, stCategoriesTable=stCategoriesTable, stCPUIOWait=stCPUIOWait, notifyOrigin=notifyOrigin, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgTrapVariables=mwgTrapVariables, notifyAdditional=notifyAdditional, stBadReputation=stBadReputation, pAMEngineVersion=pAMEngineVersion, stHandleConnectToServer=stHandleConnectToServer, stFtpTraffic=stFtpTraffic, stFtpBytesToServer=stFtpBytesToServer, stCategoryName=stCategoryName, stResolveHostViaDNS=stResolveHostViaDNS, mwgEngineVersions=mwgEngineVersions, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMinorVersion=kMinorVersion, stHttpTraffic=stHttpTraffic, kProductName=kProductName, stHttpBytesFromServer=stHttpBytesFromServer, stHttpBytesToServer=stHttpBytesToServer, kHotfixVersion=kHotfixVersion, kRevision=kRevision, stConnectedSockets=stConnectedSockets, stBlockedByURLFilter=stBlockedByURLFilter, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stClientCount=stClientCount, pTSDBVersion=pTSDBVersion, trUser=trUser, stMimeType=stMimeType, stHttpBytesToClient=stHttpBytesToClient, kCompanyName=kCompanyName, stFtpBytesFromClient=stFtpBytesFromClient, PYSNMP_MODULE_ID=mwg, notifyReason=notifyReason, trSystem=trSystem, stFtpBytesToClient=stFtpBytesToClient, stCategoryCount=stCategoryCount, pMFEEngineVersion=pMFEEngineVersion, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesFromClient=stHttpBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, notifyOriginName=notifyOriginName, stTimeForTransaction=stTimeForTransaction, kProductVersion=kProductVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgHttps=mwgHttps, mwgTraps=mwgTraps, mwgContent=mwgContent, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesFromServer=stHttpsBytesFromServer, kMajorVersion=kMajorVersion, mwgInfo=mwgInfo, mwgFTP=mwgFTP, stConnectionsBlocked=stConnectionsBlocked, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCPULoad=stCPULoad, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifySeverity=notifySeverity, stCPULoadRaw=stCPULoadRaw, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesFromServer=stFtpBytesFromServer, trApplication=trApplication, mwgHttp=mwgHttp, kBuildNumber=kBuildNumber, notifyReasonString=notifyReasonString, stHttpsRequests=stHttpsRequests, stHttpsBytesFromClient=stHttpsBytesFromClient, mwg=mwg, stMemConsumed=stMemConsumed, kCustomVersion=kCustomVersion, stCategories=stCategories, stHttpsTraffic=stHttpsTraffic, stMalwareDetected=stMalwareDetected, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stConnectionsLegitimate=stConnectionsLegitimate, mwgStatistics=mwgStatistics, stHttpRequests=stHttpRequests, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesToClient=stHttpsBytesToClient, pMFEDATVersion=pMFEDATVersion)
