...
Gauge32, enterprises, NotificationType, iso, Unsigned32, Bits, Integer32, Counter32, mib_2, NotificationType, Counter64, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "NotificationType", "iso", "Unsigned32", "Bits", "Integer32", "Counter32", "mib-2", "NotificationType", "Counter64", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stMimeType=stMimeType, kProductVersion=kProductVersion, stMalwareDetected=stMalwareDetected, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesToServer=stHttpBytesToServer, pTSDBVersion=pTSDBVersion, stCategoriesTable=stCategoriesTable, mwgStatistics=mwgStatistics, stHttpTraffic=stHttpTraffic, stConnectedSockets=stConnectedSockets, kMajorVersion=kMajorVersion, notifyReasonString=notifyReasonString, stFtpBytesFromServer=stFtpBytesFromServer, notifyAffectedHost=notifyAffectedHost, mwgInfo=mwgInfo, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMicroVersion=kMicroVersion, stBlockedByURLFilter=stBlockedByURLFilter, trSystem=trSystem, mwgContent=mwgContent, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgFTP=mwgFTP, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoad=stCPULoad, notifySeverity=notifySeverity, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMemConsumed=stMemConsumed, stHandleConnectToServer=stHandleConnectToServer, notifyOriginName=notifyOriginName, stHttpsTraffic=stHttpsTraffic, stCPUIOWait=stCPUIOWait, pAMSignatureVersion=pAMSignatureVersion, PYSNMP_MODULE_ID=mwg, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoryCount=stCategoryCount, mwg=mwg, stConnectionsLegitimate=stConnectionsLegitimate, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesToServer=stHttpsBytesToServer, stFtpTraffic=stFtpTraffic, stFtpBytesToServer=stFtpBytesToServer, pMFEDATVersion=pMFEDATVersion, trUser=trUser, mwgTrapVariables=mwgTrapVariables, trApplication=trApplication, stHttpsBytesFromClient=stHttpsBytesFromClient, pMFEEngineVersion=pMFEEngineVersion, stTimeForTransaction=stTimeForTransaction, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBadReputation=stBadReputation, mwgHttps=mwgHttps, kBuildNumber=kBuildNumber, stCategoriesEntry=stCategoriesEntry, kRevision=kRevision, stConnectionsBlocked=stConnectionsBlocked, notifyReason=notifyReason, pAMProactiveVersion=pAMProactiveVersion, mwgMiscellaneous=mwgMiscellaneous, pAMEngineVersion=pAMEngineVersion, kProductName=kProductName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoryName=stCategoryName, stCPULoadRaw=stCPULoadRaw, stFtpBytesFromClient=stFtpBytesFromClient, kCustomVersion=kCustomVersion, kCompanyName=kCompanyName, stCategories=stCategories, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyOrigin=notifyOrigin, kHotfixVersion=kHotfixVersion, stHttpBytesFromServer=stHttpBytesFromServer, kMinorVersion=kMinorVersion, stClientCount=stClientCount, stHttpsRequests=stHttpsRequests, mwgHttp=mwgHttp, mwgEngineVersions=mwgEngineVersions, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesToClient=stHttpBytesToClient, mwgTraps=mwgTraps, stHttpRequests=stHttpRequests, notifyAdditional=notifyAdditional)
