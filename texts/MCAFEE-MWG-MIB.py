...
Unsigned32, Counter32, TimeTicks, NotificationType, ObjectIdentity, Gauge32, enterprises, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, mib_2, iso, Counter64, MibIdentifier, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "TimeTicks", "NotificationType", "ObjectIdentity", "Gauge32", "enterprises", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "mib-2", "iso", "Counter64", "MibIdentifier", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", PYSNMP_MODULE_ID=mwg, notifySeverity=notifySeverity, trSystem=trSystem, kBuildNumber=kBuildNumber, kRevision=kRevision, stResolveHostViaDNS=stResolveHostViaDNS, stCategoriesEntry=stCategoriesEntry, mwgFTP=mwgFTP, kMicroVersion=kMicroVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, stHttpsTraffic=stHttpsTraffic, notifyAffectedHost=notifyAffectedHost, stFtpBytesToServer=stFtpBytesToServer, stCategoryCount=stCategoryCount, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyOriginName=notifyOriginName, stClientCount=stClientCount, stHttpTraffic=stHttpTraffic, mwgEngineVersions=mwgEngineVersions, mwgTraps=mwgTraps, stHttpBytesToClient=stHttpBytesToClient, stTimeForTransaction=stTimeForTransaction, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesFromClient=stFtpBytesFromClient, kProductName=kProductName, notifyReason=notifyReason, notifyAdditional=notifyAdditional, stCategoriesTable=stCategoriesTable, kMinorVersion=kMinorVersion, mwgInfo=mwgInfo, stHttpBytesToServer=stHttpBytesToServer, stCPULoadRaw=stCPULoadRaw, stFtpTraffic=stFtpTraffic, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyOrigin=notifyOrigin, stConnectedSockets=stConnectedSockets, stCategoryName=stCategoryName, pAMEngineVersion=pAMEngineVersion, stCategories=stCategories, stHttpsBytesToServer=stHttpsBytesToServer, pTSDBVersion=pTSDBVersion, stHttpBytesFromServer=stHttpBytesFromServer, stBadReputation=stBadReputation, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgHttp=mwgHttp, stConnectionsBlocked=stConnectionsBlocked, pAMSignatureVersion=pAMSignatureVersion, stCPULoad=stCPULoad, kCustomVersion=kCustomVersion, stMimeType=stMimeType, stHttpsRequests=stHttpsRequests, stFtpBytesToClient=stFtpBytesToClient, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesToClient=stHttpsBytesToClient, mwg=mwg, stCPUIOWait=stCPUIOWait, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kProductVersion=kProductVersion, pMFEEngineVersion=pMFEEngineVersion, kCompanyName=kCompanyName, trUser=trUser, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMalwareDetected=stMalwareDetected, mwgHttps=mwgHttps, pAMProactiveVersion=pAMProactiveVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, kHotfixVersion=kHotfixVersion, pMFEDATVersion=pMFEDATVersion, stMemConsumed=stMemConsumed, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesFromClient=stHttpBytesFromClient, notifyReasonString=notifyReasonString, kMajorVersion=kMajorVersion, mwgMiscellaneous=mwgMiscellaneous, mwgTrapVariables=mwgTrapVariables, stHttpRequests=stHttpRequests, mwgStatistics=mwgStatistics, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, trApplication=trApplication, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgContent=mwgContent)
