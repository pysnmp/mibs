...
Gauge32, iso, ObjectIdentity, NotificationType, enterprises, NotificationType, Bits, Counter32, mib_2, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity, Counter64, IpAddress, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "ObjectIdentity", "NotificationType", "enterprises", "NotificationType", "Bits", "Counter32", "mib-2", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity", "Counter64", "IpAddress", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgContent=mwgContent, stHttpsBytesToServer=stHttpsBytesToServer, notifyAdditional=notifyAdditional, notifyOriginName=notifyOriginName, pMFEDATVersion=pMFEDATVersion, stHttpsRequests=stHttpsRequests, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, kCustomVersion=kCustomVersion, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesToClient=stHttpsBytesToClient, mwgHttps=mwgHttps, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, pTSDBVersion=pTSDBVersion, stMimeType=stMimeType, stMemConsumed=stMemConsumed, stCPUIOWait=stCPUIOWait, mwgMiscellaneous=mwgMiscellaneous, stConnectionsLegitimate=stConnectionsLegitimate, pAMSignatureVersion=pAMSignatureVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgInfo=mwgInfo, stHttpsTraffic=stHttpsTraffic, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stConnectionsBlocked=stConnectionsBlocked, stLastSentLastReceivedClient=stLastSentLastReceivedClient, notifyOrigin=notifyOrigin, trSystem=trSystem, trApplication=trApplication, kMinorVersion=kMinorVersion, notifySeverity=notifySeverity, stCategoryCount=stCategoryCount, stFtpBytesFromClient=stFtpBytesFromClient, mwgTraps=mwgTraps, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kProductName=kProductName, PYSNMP_MODULE_ID=mwg, stBlockedByURLFilter=stBlockedByURLFilter, trUser=trUser, mwg=mwg, stFtpBytesFromServer=stFtpBytesFromServer, stCPULoadRaw=stCPULoadRaw, stHandleConnectToServer=stHandleConnectToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesToServer=stFtpBytesToServer, stHttpRequests=stHttpRequests, mwgHttp=mwgHttp, kCompanyName=kCompanyName, mwgStatistics=mwgStatistics, mwgTrapVariables=mwgTrapVariables, stHttpBytesToClient=stHttpBytesToClient, stFtpTraffic=stFtpTraffic, stCategoriesTable=stCategoriesTable, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, stConnectedSockets=stConnectedSockets, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyReasonString=notifyReasonString, stHttpBytesFromServer=stHttpBytesFromServer, stHttpTraffic=stHttpTraffic, stCPULoad=stCPULoad, notifyReason=notifyReason, kProductVersion=kProductVersion, kMajorVersion=kMajorVersion, mwgFTP=mwgFTP, kRevision=kRevision, notifyAffectedHost=notifyAffectedHost, stCategoryName=stCategoryName, stBlockedByAntiMalware=stBlockedByAntiMalware, stTimeForTransaction=stTimeForTransaction, stResolveHostViaDNS=stResolveHostViaDNS, stClientCount=stClientCount, kMicroVersion=kMicroVersion, stCategories=stCategories, kBuildNumber=kBuildNumber, stBadReputation=stBadReputation, pAMEngineVersion=pAMEngineVersion, stMalwareDetected=stMalwareDetected, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgEngineVersions=mwgEngineVersions, kHotfixVersion=kHotfixVersion)
