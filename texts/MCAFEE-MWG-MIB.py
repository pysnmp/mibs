...
ObjectIdentity, NotificationType, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, ModuleIdentity, Counter32, enterprises, MibIdentifier, iso, mib_2, Bits, Integer32, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "ModuleIdentity", "Counter32", "enterprises", "MibIdentifier", "iso", "mib-2", "Bits", "Integer32", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyReasonString=notifyReasonString, stHttpRequests=stHttpRequests, pAMSignatureVersion=pAMSignatureVersion, stFtpBytesFromServer=stFtpBytesFromServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stBadReputation=stBadReputation, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient, stCategoryName=stCategoryName, stFtpBytesToClient=stFtpBytesToClient, mwgHttp=mwgHttp, stHttpBytesFromServer=stHttpBytesFromServer, kMicroVersion=kMicroVersion, stHttpsTraffic=stHttpsTraffic, kCompanyName=kCompanyName, trUser=trUser, stHttpsBytesToClient=stHttpsBytesToClient, stCPUIOWait=stCPUIOWait, stCategoriesTable=stCategoriesTable, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, mwgEngineVersions=mwgEngineVersions, kBuildNumber=kBuildNumber, kCustomVersion=kCustomVersion, stCategoriesEntry=stCategoriesEntry, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, PYSNMP_MODULE_ID=mwg, trSystem=trSystem, kProductName=kProductName, stResolveHostViaDNS=stResolveHostViaDNS, mwgStatistics=mwgStatistics, stHttpsRequests=stHttpsRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesToServer=stHttpsBytesToServer, stMalwareDetected=stMalwareDetected, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMajorVersion=kMajorVersion, stTimeForTransaction=stTimeForTransaction, trApplication=trApplication, stCategoryCount=stCategoryCount, pTSDBVersion=pTSDBVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgHttps=mwgHttps, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByURLFilter=stBlockedByURLFilter, stFtpBytesFromClient=stFtpBytesFromClient, stCategories=stCategories, stCPULoadRaw=stCPULoadRaw, stHttpTraffic=stHttpTraffic, stClientCount=stClientCount, pMFEEngineVersion=pMFEEngineVersion, mwgTrapVariables=mwgTrapVariables, mwgFTP=mwgFTP, mwgContent=mwgContent, mwg=mwg, kMinorVersion=kMinorVersion, stFtpTraffic=stFtpTraffic, notifyOrigin=notifyOrigin, notifyReason=notifyReason, kHotfixVersion=kHotfixVersion, mwgTraps=mwgTraps, stHttpBytesToServer=stHttpBytesToServer, stMimeType=stMimeType, stConnectedSockets=stConnectedSockets, stHandleConnectToServer=stHandleConnectToServer, notifyAdditional=notifyAdditional, kRevision=kRevision, stBlockedByAntiMalware=stBlockedByAntiMalware, stConnectionsBlocked=stConnectionsBlocked, kProductVersion=kProductVersion, stMemConsumed=stMemConsumed, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, notifyAffectedHost=notifyAffectedHost, mwgInfo=mwgInfo, stConnectionsLegitimate=stConnectionsLegitimate, notifyOriginName=notifyOriginName, notifySeverity=notifySeverity, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpBytesToServer=stFtpBytesToServer, stCPULoad=stCPULoad, mwgMiscellaneous=mwgMiscellaneous, pMFEDATVersion=pMFEDATVersion, stHttpBytesToClient=stHttpBytesToClient)
