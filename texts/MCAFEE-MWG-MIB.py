...
Unsigned32, enterprises, Counter64, Bits, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, mib_2, iso, NotificationType, TimeTicks, MibIdentifier, IpAddress, Integer32, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "enterprises", "Counter64", "Bits", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "mib-2", "iso", "NotificationType", "TimeTicks", "MibIdentifier", "IpAddress", "Integer32", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kCompanyName=kCompanyName, pMFEEngineVersion=pMFEEngineVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgHttps=mwgHttps, kRevision=kRevision, notifyOrigin=notifyOrigin, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesFromServer=stHttpBytesFromServer, stCategoriesTable=stCategoriesTable, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgTraps=mwgTraps, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMicroVersion=kMicroVersion, stHttpBytesFromClient=stHttpBytesFromClient, trSystem=trSystem, stHttpsBytesToServer=stHttpsBytesToServer, stConnectedSockets=stConnectedSockets, trUser=trUser, kBuildNumber=kBuildNumber, stCategories=stCategories, stMemConsumed=stMemConsumed, stCategoryCount=stCategoryCount, pMFEDATVersion=pMFEDATVersion, kCustomVersion=kCustomVersion, pAMSignatureVersion=pAMSignatureVersion, notifySeverity=notifySeverity, stFtpBytesToClient=stFtpBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stConnectionsLegitimate=stConnectionsLegitimate, mwgFTP=mwgFTP, kProductVersion=kProductVersion, stBlockedByURLFilter=stBlockedByURLFilter, pTSDBVersion=pTSDBVersion, mwgMiscellaneous=mwgMiscellaneous, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsBytesFromClient=stHttpsBytesFromClient, stTimeForTransaction=stTimeForTransaction, pAMProactiveVersion=pAMProactiveVersion, stMalwareDetected=stMalwareDetected, stHttpsTraffic=stHttpsTraffic, mwgInfo=mwgInfo, mwgTrapVariables=mwgTrapVariables, notifyReasonString=notifyReasonString, stHttpBytesToServer=stHttpBytesToServer, mwgContent=mwgContent, stMimeType=stMimeType, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCPUIOWait=stCPUIOWait, stHttpRequests=stHttpRequests, stCPULoadRaw=stCPULoadRaw, stHttpBytesToClient=stHttpBytesToClient, mwgStatistics=mwgStatistics, notifyAdditional=notifyAdditional, mwg=mwg, notifyOriginName=notifyOriginName, notifyReason=notifyReason, kProductName=kProductName, stFtpTraffic=stFtpTraffic, stHttpTraffic=stHttpTraffic, stHttpsRequests=stHttpsRequests, mwgEngineVersions=mwgEngineVersions, PYSNMP_MODULE_ID=mwg, stFtpBytesFromServer=stFtpBytesFromServer, stCategoryName=stCategoryName, stBadReputation=stBadReputation, mwgHttp=mwgHttp, stClientCount=stClientCount, stResolveHostViaDNS=stResolveHostViaDNS, stHandleConnectToServer=stHandleConnectToServer, stConnectionsBlocked=stConnectionsBlocked, pAMEngineVersion=pAMEngineVersion, trApplication=trApplication, notifyAffectedHost=notifyAffectedHost, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoriesEntry=stCategoriesEntry, stHttpsBytesToClient=stHttpsBytesToClient, stCPULoad=stCPULoad, kHotfixVersion=kHotfixVersion, kMajorVersion=kMajorVersion, kMinorVersion=kMinorVersion)
