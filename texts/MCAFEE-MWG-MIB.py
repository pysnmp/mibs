...
NotificationType, MibIdentifier, ModuleIdentity, iso, ObjectIdentity, enterprises, Integer32, NotificationType, Bits, Counter32, Gauge32, Counter64, mib_2, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "ModuleIdentity", "iso", "ObjectIdentity", "enterprises", "Integer32", "NotificationType", "Bits", "Counter32", "Gauge32", "Counter64", "mib-2", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pMFEEngineVersion=pMFEEngineVersion, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesToServer=stHttpsBytesToServer, trUser=trUser, notifySeverity=notifySeverity, mwgInfo=mwgInfo, stHttpsTraffic=stHttpsTraffic, stHttpBytesToServer=stHttpBytesToServer, kProductVersion=kProductVersion, stFtpBytesFromClient=stFtpBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCPUIOWait=stCPUIOWait, stClientCount=stClientCount, stCPULoadRaw=stCPULoadRaw, stHandleConnectToServer=stHandleConnectToServer, stCategories=stCategories, pAMSignatureVersion=pAMSignatureVersion, mwg=mwg, stResolveHostViaDNS=stResolveHostViaDNS, kMinorVersion=kMinorVersion, kRevision=kRevision, stBlockedByAntiMalware=stBlockedByAntiMalware, kMicroVersion=kMicroVersion, stConnectionsBlocked=stConnectionsBlocked, mwgFTP=mwgFTP, mwgHttp=mwgHttp, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoryName=stCategoryName, kCompanyName=kCompanyName, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stFtpBytesFromServer=stFtpBytesFromServer, mwgMiscellaneous=mwgMiscellaneous, stMemConsumed=stMemConsumed, stHttpsRequests=stHttpsRequests, trApplication=trApplication, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsBytesToClient=stHttpsBytesToClient, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesToServer=stFtpBytesToServer, mwgHttps=mwgHttps, mwgContent=mwgContent, notifyAdditional=notifyAdditional, stBadReputation=stBadReputation, stTimeForTransaction=stTimeForTransaction, stCategoriesEntry=stCategoriesEntry, mwgStatistics=mwgStatistics, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient, stBlockedByMediaFilter=stBlockedByMediaFilter, kCustomVersion=kCustomVersion, notifyReason=notifyReason, pMFEDATVersion=pMFEDATVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, PYSNMP_MODULE_ID=mwg, stMalwareDetected=stMalwareDetected, stHttpTraffic=stHttpTraffic, pTSDBVersion=pTSDBVersion, stCategoriesTable=stCategoriesTable, stConnectionsLegitimate=stConnectionsLegitimate, stHttpsBytesFromServer=stHttpsBytesFromServer, trSystem=trSystem, kBuildNumber=kBuildNumber, notifyOriginName=notifyOriginName, notifyAffectedHost=notifyAffectedHost, notifyOrigin=notifyOrigin, stHttpBytesFromServer=stHttpBytesFromServer, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgTrapVariables=mwgTrapVariables, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCategoryCount=stCategoryCount, stCPULoad=stCPULoad, mwgEngineVersions=mwgEngineVersions, stMimeType=stMimeType, stFtpBytesToClient=stFtpBytesToClient, stHttpRequests=stHttpRequests, kProductName=kProductName, stConnectedSockets=stConnectedSockets, kHotfixVersion=kHotfixVersion, stFtpTraffic=stFtpTraffic, kMajorVersion=kMajorVersion, mwgTraps=mwgTraps, notifyReasonString=notifyReasonString)
