...
enterprises, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, Counter64, iso, Counter32, Bits, IpAddress, ObjectIdentity, NotificationType, mib_2, Unsigned32, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "Counter64", "iso", "Counter32", "Bits", "IpAddress", "ObjectIdentity", "NotificationType", "mib-2", "Unsigned32", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCategoryName=stCategoryName, stCategoriesTable=stCategoriesTable, notifyAffectedHost=notifyAffectedHost, pAMEngineVersion=pAMEngineVersion, mwgHttp=mwgHttp, kCompanyName=kCompanyName, stBlockedByURLFilter=stBlockedByURLFilter, pTSDBVersion=pTSDBVersion, pAMSignatureVersion=pAMSignatureVersion, trSystem=trSystem, kMinorVersion=kMinorVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMajorVersion=kMajorVersion, stCPUIOWait=stCPUIOWait, stHttpTraffic=stHttpTraffic, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, kHotfixVersion=kHotfixVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpBytesToClient=stHttpBytesToClient, stConnectionsBlocked=stConnectionsBlocked, kProductName=kProductName, stMimeType=stMimeType, kRevision=kRevision, stBadReputation=stBadReputation, PYSNMP_MODULE_ID=mwg, notifyReason=notifyReason, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stMemConsumed=stMemConsumed, mwgInfo=mwgInfo, pAMProactiveVersion=pAMProactiveVersion, mwgMiscellaneous=mwgMiscellaneous, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pMFEDATVersion=pMFEDATVersion, trUser=trUser, mwgEngineVersions=mwgEngineVersions, kCustomVersion=kCustomVersion, stClientCount=stClientCount, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesFromClient=stFtpBytesFromClient, notifyAdditional=notifyAdditional, stCPULoadRaw=stCPULoadRaw, stConnectionsLegitimate=stConnectionsLegitimate, mwgFTP=mwgFTP, kBuildNumber=kBuildNumber, mwgTraps=mwgTraps, mwgContent=mwgContent, stMalwareDetected=stMalwareDetected, trApplication=trApplication, mwgTrapVariables=mwgTrapVariables, mwgHttps=mwgHttps, stFtpTraffic=stFtpTraffic, mwg=mwg, stFtpBytesFromServer=stFtpBytesFromServer, stCPULoad=stCPULoad, stHttpsTraffic=stHttpsTraffic, stCategories=stCategories, stResolveHostViaDNS=stResolveHostViaDNS, kMicroVersion=kMicroVersion, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, kProductVersion=kProductVersion, notifyOrigin=notifyOrigin, stHandleConnectToServer=stHandleConnectToServer, stCategoryCount=stCategoryCount, mwgStatistics=mwgStatistics, notifyOriginName=notifyOriginName, notifySeverity=notifySeverity, stTimeForTransaction=stTimeForTransaction, stFtpBytesToServer=stFtpBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, stHttpRequests=stHttpRequests, stHttpsRequests=stHttpsRequests, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyReasonString=notifyReasonString, stHttpsBytesToClient=stHttpsBytesToClient, stConnectedSockets=stConnectedSockets)
