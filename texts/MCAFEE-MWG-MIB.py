...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, mib_2, NotificationType, iso, TimeTicks, ModuleIdentity, enterprises, Counter32, NotificationType, IpAddress, Bits, Unsigned32, MibIdentifier, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "mib-2", "NotificationType", "iso", "TimeTicks", "ModuleIdentity", "enterprises", "Counter32", "NotificationType", "IpAddress", "Bits", "Unsigned32", "MibIdentifier", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgInfo=mwgInfo, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCategoryCount=stCategoryCount, kMicroVersion=kMicroVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyAdditional=notifyAdditional, stHttpsBytesToServer=stHttpsBytesToServer, stBadReputation=stBadReputation, trUser=trUser, stHttpBytesToServer=stHttpBytesToServer, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesToClient=stHttpBytesToClient, kBuildNumber=kBuildNumber, mwgHttp=mwgHttp, mwgMiscellaneous=mwgMiscellaneous, notifyAffectedHost=notifyAffectedHost, mwgTraps=mwgTraps, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesFromClient=stHttpsBytesFromClient, kCompanyName=kCompanyName, stMimeType=stMimeType, stFtpBytesFromServer=stFtpBytesFromServer, stCPUIOWait=stCPUIOWait, stFtpBytesToClient=stFtpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, mwgContent=mwgContent, stFtpTraffic=stFtpTraffic, mwg=mwg, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgHttps=mwgHttps, stHttpsRequests=stHttpsRequests, pMFEEngineVersion=pMFEEngineVersion, stConnectedSockets=stConnectedSockets, notifyOriginName=notifyOriginName, kProductVersion=kProductVersion, kCustomVersion=kCustomVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgStatistics=mwgStatistics, stHttpsBytesToClient=stHttpsBytesToClient, kMajorVersion=kMajorVersion, stConnectionsBlocked=stConnectionsBlocked, notifyReason=notifyReason, stTimeForTransaction=stTimeForTransaction, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgFTP=mwgFTP, stCategoriesEntry=stCategoriesEntry, mwgTrapVariables=mwgTrapVariables, trSystem=trSystem, kHotfixVersion=kHotfixVersion, stConnectionsLegitimate=stConnectionsLegitimate, stMemConsumed=stMemConsumed, notifyOrigin=notifyOrigin, stHttpBytesFromClient=stHttpBytesFromClient, pAMSignatureVersion=pAMSignatureVersion, pAMEngineVersion=pAMEngineVersion, stCategories=stCategories, kRevision=kRevision, stCategoryName=stCategoryName, mwgEngineVersions=mwgEngineVersions, stHttpsTraffic=stHttpsTraffic, stFtpBytesToServer=stFtpBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stClientCount=stClientCount, notifySeverity=notifySeverity, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stBlockedByURLFilter=stBlockedByURLFilter, stCategoriesTable=stCategoriesTable, pTSDBVersion=pTSDBVersion, trApplication=trApplication, stHttpTraffic=stHttpTraffic, stHttpBytesFromServer=stHttpBytesFromServer, notifyReasonString=notifyReasonString, stCPULoadRaw=stCPULoadRaw, kMinorVersion=kMinorVersion, pMFEDATVersion=pMFEDATVersion, stCPULoad=stCPULoad, stMalwareDetected=stMalwareDetected, kProductName=kProductName, pAMProactiveVersion=pAMProactiveVersion, stHandleConnectToServer=stHandleConnectToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, PYSNMP_MODULE_ID=mwg, stHttpRequests=stHttpRequests)
