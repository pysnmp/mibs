...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, ModuleIdentity, ObjectIdentity, Unsigned32, Counter64, mib_2, Counter32, NotificationType, NotificationType, iso, Bits, enterprises, Gauge32, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "Counter64", "mib-2", "Counter32", "NotificationType", "NotificationType", "iso", "Bits", "enterprises", "Gauge32", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBadReputation=stBadReputation, notifyReason=notifyReason, pMFEDATVersion=pMFEDATVersion, stCPULoad=stCPULoad, kCustomVersion=kCustomVersion, stHttpBytesToClient=stHttpBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesToServer=stHttpBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, stConnectionsBlocked=stConnectionsBlocked, stCategories=stCategories, kMinorVersion=kMinorVersion, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoriesEntry=stCategoriesEntry, notifyOriginName=notifyOriginName, kCompanyName=kCompanyName, stConnectedSockets=stConnectedSockets, stConnectionsLegitimate=stConnectionsLegitimate, kMajorVersion=kMajorVersion, stFtpBytesFromServer=stFtpBytesFromServer, kMicroVersion=kMicroVersion, trApplication=trApplication, pTSDBVersion=pTSDBVersion, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpBytesFromClient=stHttpBytesFromClient, mwgTraps=mwgTraps, mwgContent=mwgContent, stCPULoadRaw=stCPULoadRaw, stMimeType=stMimeType, stHttpsBytesFromClient=stHttpsBytesFromClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, mwgInfo=mwgInfo, stCategoriesTable=stCategoriesTable, trUser=trUser, stFtpTraffic=stFtpTraffic, PYSNMP_MODULE_ID=mwg, stHttpsRequests=stHttpsRequests, mwgHttps=mwgHttps, pAMEngineVersion=pAMEngineVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, mwgFTP=mwgFTP, mwgTrapVariables=mwgTrapVariables, notifyAdditional=notifyAdditional, kProductName=kProductName, stMemConsumed=stMemConsumed, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoryName=stCategoryName, pMFEEngineVersion=pMFEEngineVersion, notifyReasonString=notifyReasonString, stBlockedByMediaFilter=stBlockedByMediaFilter, stFtpBytesToServer=stFtpBytesToServer, kRevision=kRevision, stClientCount=stClientCount, stTimeForTransaction=stTimeForTransaction, trSystem=trSystem, kProductVersion=kProductVersion, kHotfixVersion=kHotfixVersion, stResolveHostViaDNS=stResolveHostViaDNS, stHttpRequests=stHttpRequests, stHttpsTraffic=stHttpsTraffic, mwgEngineVersions=mwgEngineVersions, mwgHttp=mwgHttp, mwgMiscellaneous=mwgMiscellaneous, notifySeverity=notifySeverity, stCPUIOWait=stCPUIOWait, stHandleConnectToServer=stHandleConnectToServer, stBlockedByURLFilter=stBlockedByURLFilter, notifyOrigin=notifyOrigin, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyAffectedHost=notifyAffectedHost, mwgStatistics=mwgStatistics, kBuildNumber=kBuildNumber, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpTraffic=stHttpTraffic, mwg=mwg, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesToServer=stHttpsBytesToServer, stCategoryCount=stCategoryCount, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient)
