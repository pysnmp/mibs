...
ObjectIdentity, mib_2, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, ModuleIdentity, NotificationType, Integer32, Counter64, iso, Bits, Counter32, Unsigned32, NotificationType, Gauge32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "mib-2", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "ModuleIdentity", "NotificationType", "Integer32", "Counter64", "iso", "Bits", "Counter32", "Unsigned32", "NotificationType", "Gauge32", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMProactiveVersion=pAMProactiveVersion, pMFEEngineVersion=pMFEEngineVersion, notifyAffectedHost=notifyAffectedHost, stFtpBytesFromServer=stFtpBytesFromServer, stConnectedSockets=stConnectedSockets, stClientCount=stClientCount, trUser=trUser, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kProductVersion=kProductVersion, mwgTrapVariables=mwgTrapVariables, stHttpBytesToServer=stHttpBytesToServer, stFtpTraffic=stFtpTraffic, stCategories=stCategories, kCompanyName=kCompanyName, mwg=mwg, stBadReputation=stBadReputation, notifyOrigin=notifyOrigin, stCategoryCount=stCategoryCount, kMajorVersion=kMajorVersion, notifySeverity=notifySeverity, stResolveHostViaDNS=stResolveHostViaDNS, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesFromClient=stFtpBytesFromClient, stFtpBytesToClient=stFtpBytesToClient, stMemConsumed=stMemConsumed, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, notifyAdditional=notifyAdditional, notifyReasonString=notifyReasonString, kProductName=kProductName, mwgHttp=mwgHttp, stHttpsTraffic=stHttpsTraffic, kHotfixVersion=kHotfixVersion, pMFEDATVersion=pMFEDATVersion, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesToServer=stHttpsBytesToServer, mwgTraps=mwgTraps, kBuildNumber=kBuildNumber, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoad=stCPULoad, mwgStatistics=mwgStatistics, kMinorVersion=kMinorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, kRevision=kRevision, stMimeType=stMimeType, stCPUIOWait=stCPUIOWait, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgMiscellaneous=mwgMiscellaneous, stHttpBytesFromServer=stHttpBytesFromServer, mwgInfo=mwgInfo, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByURLFilter=stBlockedByURLFilter, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient, stCPULoadRaw=stCPULoadRaw, kMicroVersion=kMicroVersion, mwgEngineVersions=mwgEngineVersions, stHttpBytesToClient=stHttpBytesToClient, kCustomVersion=kCustomVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pTSDBVersion=pTSDBVersion, mwgHttps=mwgHttps, mwgFTP=mwgFTP, stTimeForTransaction=stTimeForTransaction, stMalwareDetected=stMalwareDetected, stFtpBytesToServer=stFtpBytesToServer, notifyOriginName=notifyOriginName, notifyReason=notifyReason, stHttpsBytesToClient=stHttpsBytesToClient, stConnectionsBlocked=stConnectionsBlocked, stConnectionsLegitimate=stConnectionsLegitimate, stHttpTraffic=stHttpTraffic, PYSNMP_MODULE_ID=mwg, stHttpsRequests=stHttpsRequests, stHttpRequests=stHttpRequests, pAMSignatureVersion=pAMSignatureVersion, stCategoriesEntry=stCategoriesEntry, trSystem=trSystem, mwgContent=mwgContent, stCategoryName=stCategoryName, stCategoriesTable=stCategoriesTable, trApplication=trApplication, stHttpsBytesFromClient=stHttpsBytesFromClient)
