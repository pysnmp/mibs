...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, NotificationType, MibIdentifier, mib_2, ModuleIdentity, Counter32, enterprises, Bits, TimeTicks, Integer32, Counter64, Gauge32, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "NotificationType", "MibIdentifier", "mib-2", "ModuleIdentity", "Counter32", "enterprises", "Bits", "TimeTicks", "Integer32", "Counter64", "Gauge32", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgHttp=mwgHttp, mwg=mwg, stHttpsTraffic=stHttpsTraffic, notifySeverity=notifySeverity, stCategories=stCategories, notifyReasonString=notifyReasonString, kCustomVersion=kCustomVersion, stConnectionsLegitimate=stConnectionsLegitimate, pTSDBVersion=pTSDBVersion, stHttpsRequests=stHttpsRequests, stBadReputation=stBadReputation, trSystem=trSystem, pAMSignatureVersion=pAMSignatureVersion, stConnectionsBlocked=stConnectionsBlocked, pMFEDATVersion=pMFEDATVersion, kCompanyName=kCompanyName, stHttpsBytesToServer=stHttpsBytesToServer, pAMProactiveVersion=pAMProactiveVersion, stCategoryCount=stCategoryCount, notifyOriginName=notifyOriginName, stFtpBytesFromServer=stFtpBytesFromServer, kHotfixVersion=kHotfixVersion, mwgStatistics=mwgStatistics, kProductName=kProductName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpRequests=stHttpRequests, trApplication=trApplication, stMimeType=stMimeType, notifyAffectedHost=notifyAffectedHost, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, kMinorVersion=kMinorVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kRevision=kRevision, stHttpBytesToServer=stHttpBytesToServer, pMFEEngineVersion=pMFEEngineVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttps=mwgHttps, stCPUIOWait=stCPUIOWait, kMajorVersion=kMajorVersion, pAMEngineVersion=pAMEngineVersion, stFtpBytesToServer=stFtpBytesToServer, stHandleConnectToServer=stHandleConnectToServer, stTimeForTransaction=stTimeForTransaction, mwgMiscellaneous=mwgMiscellaneous, stCategoriesEntry=stCategoriesEntry, mwgFTP=mwgFTP, trUser=trUser, stMemConsumed=stMemConsumed, kMicroVersion=kMicroVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stCPULoad=stCPULoad, stHttpBytesFromServer=stHttpBytesFromServer, kBuildNumber=kBuildNumber, stClientCount=stClientCount, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesFromClient=stFtpBytesFromClient, stCategoriesTable=stCategoriesTable, stHttpTraffic=stHttpTraffic, stHttpBytesToClient=stHttpBytesToClient, notifyAdditional=notifyAdditional, stHttpBytesFromClient=stHttpBytesFromClient, notifyOrigin=notifyOrigin, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, PYSNMP_MODULE_ID=mwg, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgTrapVariables=mwgTrapVariables, stCPULoadRaw=stCPULoadRaw, stResolveHostViaDNS=stResolveHostViaDNS, stFtpTraffic=stFtpTraffic, mwgInfo=mwgInfo, stConnectedSockets=stConnectedSockets, mwgTraps=mwgTraps, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgEngineVersions=mwgEngineVersions, stBlockedByMediaFilter=stBlockedByMediaFilter, mwgContent=mwgContent, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyReason=notifyReason, stCategoryName=stCategoryName, stFtpBytesToClient=stFtpBytesToClient, kProductVersion=kProductVersion, stMalwareDetected=stMalwareDetected)
