...
NotificationType, MibIdentifier, Integer32, Counter32, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, mib_2, NotificationType, Bits, Counter64, ModuleIdentity, Gauge32, iso, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "Integer32", "Counter32", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "mib-2", "NotificationType", "Bits", "Counter64", "ModuleIdentity", "Gauge32", "iso", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHandleConnectToServer=stHandleConnectToServer, stClientCount=stClientCount, mwgEngineVersions=mwgEngineVersions, kProductName=kProductName, pAMEngineVersion=pAMEngineVersion, trUser=trUser, kBuildNumber=kBuildNumber, stHttpBytesToServer=stHttpBytesToServer, stCPULoad=stCPULoad, kMicroVersion=kMicroVersion, mwg=mwg, pMFEEngineVersion=pMFEEngineVersion, stCategoryCount=stCategoryCount, mwgTraps=mwgTraps, kHotfixVersion=kHotfixVersion, stCategories=stCategories, kMajorVersion=kMajorVersion, mwgHttp=mwgHttp, kCustomVersion=kCustomVersion, mwgStatistics=mwgStatistics, pTSDBVersion=pTSDBVersion, stCategoriesTable=stCategoriesTable, stFtpBytesFromClient=stFtpBytesFromClient, mwgContent=mwgContent, mwgInfo=mwgInfo, stHttpBytesFromServer=stHttpBytesFromServer, stConnectedSockets=stConnectedSockets, notifyAffectedHost=notifyAffectedHost, stHttpsTraffic=stHttpsTraffic, kCompanyName=kCompanyName, stBadReputation=stBadReputation, stResolveHostViaDNS=stResolveHostViaDNS, stCPULoadRaw=stCPULoadRaw, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stMalwareDetected=stMalwareDetected, stHttpsBytesToClient=stHttpsBytesToClient, notifyReasonString=notifyReasonString, stMimeType=stMimeType, stBlockedByURLFilter=stBlockedByURLFilter, pAMSignatureVersion=pAMSignatureVersion, notifyReason=notifyReason, stHttpBytesToClient=stHttpBytesToClient, stMemConsumed=stMemConsumed, stHttpsBytesFromClient=stHttpsBytesFromClient, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgHttps=mwgHttps, mwgMiscellaneous=mwgMiscellaneous, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stTimeForTransaction=stTimeForTransaction, pMFEDATVersion=pMFEDATVersion, stCategoriesEntry=stCategoriesEntry, stFtpBytesToServer=stFtpBytesToServer, kMinorVersion=kMinorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyOrigin=notifyOrigin, notifyAdditional=notifyAdditional, trSystem=trSystem, stHttpTraffic=stHttpTraffic, mwgFTP=mwgFTP, stCPUIOWait=stCPUIOWait, stHttpsBytesToServer=stHttpsBytesToServer, notifyOriginName=notifyOriginName, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesFromServer=stFtpBytesFromServer, stCategoryName=stCategoryName, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kRevision=kRevision, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesFromServer=stHttpsBytesFromServer, trApplication=trApplication, stHttpsRequests=stHttpsRequests, stHttpBytesFromClient=stHttpBytesFromClient, stHttpRequests=stHttpRequests, mwgTrapVariables=mwgTrapVariables, kProductVersion=kProductVersion, stFtpTraffic=stFtpTraffic, PYSNMP_MODULE_ID=mwg, stFtpBytesToClient=stFtpBytesToClient, notifySeverity=notifySeverity, stConnectionsLegitimate=stConnectionsLegitimate, stLastSentLastReceivedServer=stLastSentLastReceivedServer)
