...
ModuleIdentity, Unsigned32, IpAddress, Gauge32, Counter64, iso, mib_2, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32, TimeTicks, Integer32, NotificationType, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "IpAddress", "Gauge32", "Counter64", "iso", "mib-2", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32", "TimeTicks", "Integer32", "NotificationType", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpRequests=stHttpRequests, pAMEngineVersion=pAMEngineVersion, kProductName=kProductName, stFtpBytesToClient=stFtpBytesToClient, stHttpTraffic=stHttpTraffic, pTSDBVersion=pTSDBVersion, mwgHttps=mwgHttps, stBlockedByAntiMalware=stBlockedByAntiMalware, stCategories=stCategories, notifyReason=notifyReason, mwgStatistics=mwgStatistics, kCustomVersion=kCustomVersion, stFtpBytesFromServer=stFtpBytesFromServer, kCompanyName=kCompanyName, kHotfixVersion=kHotfixVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stConnectedSockets=stConnectedSockets, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMinorVersion=kMinorVersion, stCPULoadRaw=stCPULoadRaw, mwgContent=mwgContent, stClientCount=stClientCount, trApplication=trApplication, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoriesEntry=stCategoriesEntry, stConnectionsLegitimate=stConnectionsLegitimate, notifyReasonString=notifyReasonString, kRevision=kRevision, stCPULoad=stCPULoad, stHttpsBytesFromClient=stHttpsBytesFromClient, stTimeForTransaction=stTimeForTransaction, pAMSignatureVersion=pAMSignatureVersion, stConnectionsBlocked=stConnectionsBlocked, mwgTrapVariables=mwgTrapVariables, stHttpBytesToClient=stHttpBytesToClient, stCategoryCount=stCategoryCount, mwg=mwg, stHttpsBytesToClient=stHttpsBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, notifyAffectedHost=notifyAffectedHost, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategoriesTable=stCategoriesTable, notifyAdditional=notifyAdditional, stHttpsBytesToServer=stHttpsBytesToServer, notifySeverity=notifySeverity, kMicroVersion=kMicroVersion, stFtpBytesFromClient=stFtpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, pMFEDATVersion=pMFEDATVersion, stCategoryName=stCategoryName, kBuildNumber=kBuildNumber, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stCPUIOWait=stCPUIOWait, mwgFTP=mwgFTP, stHandleConnectToServer=stHandleConnectToServer, stBlockedByURLFilter=stBlockedByURLFilter, stMemConsumed=stMemConsumed, stHttpsBytesFromServer=stHttpsBytesFromServer, stMalwareDetected=stMalwareDetected, stFtpTraffic=stFtpTraffic, mwgTraps=mwgTraps, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pMFEEngineVersion=pMFEEngineVersion, stHttpsRequests=stHttpsRequests, stHttpsTraffic=stHttpsTraffic, notifyOriginName=notifyOriginName, stHttpBytesToServer=stHttpBytesToServer, mwgInfo=mwgInfo, stMimeType=stMimeType, trUser=trUser, stHttpBytesFromClient=stHttpBytesFromClient, kMajorVersion=kMajorVersion, kProductVersion=kProductVersion, pAMProactiveVersion=pAMProactiveVersion, PYSNMP_MODULE_ID=mwg, stHttpBytesFromServer=stHttpBytesFromServer, mwgHttp=mwgHttp, stBadReputation=stBadReputation, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesToServer=stFtpBytesToServer, trSystem=trSystem, mwgEngineVersions=mwgEngineVersions, notifyOrigin=notifyOrigin)
