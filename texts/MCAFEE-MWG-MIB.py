...
NotificationType, Unsigned32, enterprises, MibIdentifier, ObjectIdentity, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, IpAddress, NotificationType, Counter32, mib_2, Integer32, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "enterprises", "MibIdentifier", "ObjectIdentity", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "IpAddress", "NotificationType", "Counter32", "mib-2", "Integer32", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyReasonString=notifyReasonString, pMFEDATVersion=pMFEDATVersion, stHttpsBytesToClient=stHttpsBytesToClient, stHttpsTraffic=stHttpsTraffic, mwgHttp=mwgHttp, stBlockedByURLFilter=stBlockedByURLFilter, stMemConsumed=stMemConsumed, mwgMiscellaneous=mwgMiscellaneous, notifyAffectedHost=notifyAffectedHost, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kCompanyName=kCompanyName, stCategories=stCategories, stHttpBytesToServer=stHttpBytesToServer, notifySeverity=notifySeverity, kHotfixVersion=kHotfixVersion, stFtpBytesToClient=stFtpBytesToClient, kCustomVersion=kCustomVersion, stHandleConnectToServer=stHandleConnectToServer, mwgFTP=mwgFTP, stFtpBytesFromServer=stFtpBytesFromServer, stMimeType=stMimeType, kMajorVersion=kMajorVersion, stCPULoad=stCPULoad, stCategoriesTable=stCategoriesTable, stBlockedByMediaFilter=stBlockedByMediaFilter, kMicroVersion=kMicroVersion, stFtpBytesToServer=stFtpBytesToServer, stFtpTraffic=stFtpTraffic, stHttpBytesFromServer=stHttpBytesFromServer, trApplication=trApplication, mwgContent=mwgContent, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgTraps=mwgTraps, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpRequests=stHttpRequests, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsRequests=stHttpsRequests, notifyReason=notifyReason, stConnectedSockets=stConnectedSockets, notifyAdditional=notifyAdditional, mwgHttps=mwgHttps, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, notifyOrigin=notifyOrigin, trSystem=trSystem, pMFEEngineVersion=pMFEEngineVersion, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoryName=stCategoryName, mwgTrapVariables=mwgTrapVariables, kBuildNumber=kBuildNumber, stHttpsBytesToServer=stHttpsBytesToServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stConnectionsLegitimate=stConnectionsLegitimate, stFtpBytesFromClient=stFtpBytesFromClient, pTSDBVersion=pTSDBVersion, notifyOriginName=notifyOriginName, stHttpBytesFromClient=stHttpBytesFromClient, stClientCount=stClientCount, mwg=mwg, kProductVersion=kProductVersion, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kProductName=kProductName, stCategoryCount=stCategoryCount, kRevision=kRevision, stHttpTraffic=stHttpTraffic, stCPUIOWait=stCPUIOWait, stBadReputation=stBadReputation, trUser=trUser, kMinorVersion=kMinorVersion, stCPULoadRaw=stCPULoadRaw, mwgStatistics=mwgStatistics, PYSNMP_MODULE_ID=mwg, pAMEngineVersion=pAMEngineVersion, stMalwareDetected=stMalwareDetected, stCategoriesEntry=stCategoriesEntry, stTimeForTransaction=stTimeForTransaction, stConnectionsBlocked=stConnectionsBlocked, stHttpBytesToClient=stHttpBytesToClient, mwgEngineVersions=mwgEngineVersions, pAMSignatureVersion=pAMSignatureVersion, mwgInfo=mwgInfo)
