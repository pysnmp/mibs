...
Integer32, Bits, MibIdentifier, ObjectIdentity, enterprises, Unsigned32, NotificationType, NotificationType, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, Counter64, mib_2, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "MibIdentifier", "ObjectIdentity", "enterprises", "Unsigned32", "NotificationType", "NotificationType", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "Counter64", "mib-2", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyAdditional=notifyAdditional, kProductName=kProductName, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgFTP=mwgFTP, stCategoriesTable=stCategoriesTable, kMicroVersion=kMicroVersion, stCategoryName=stCategoryName, mwgEngineVersions=mwgEngineVersions, stHttpBytesToClient=stHttpBytesToClient, notifyOriginName=notifyOriginName, stBlockedByMediaFilter=stBlockedByMediaFilter, pMFEDATVersion=pMFEDATVersion, kProductVersion=kProductVersion, mwg=mwg, stHttpsTraffic=stHttpsTraffic, pTSDBVersion=pTSDBVersion, kMajorVersion=kMajorVersion, notifyOrigin=notifyOrigin, stConnectedSockets=stConnectedSockets, stCPUIOWait=stCPUIOWait, stBadReputation=stBadReputation, stLastSentLastReceivedClient=stLastSentLastReceivedClient, trApplication=trApplication, stHttpBytesFromClient=stHttpBytesFromClient, trSystem=trSystem, stMemConsumed=stMemConsumed, kCompanyName=kCompanyName, stCategoryCount=stCategoryCount, stResolveHostViaDNS=stResolveHostViaDNS, mwgTraps=mwgTraps, pAMSignatureVersion=pAMSignatureVersion, stHttpRequests=stHttpRequests, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgTrapVariables=mwgTrapVariables, trUser=trUser, stMimeType=stMimeType, stFtpBytesToClient=stFtpBytesToClient, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHttpsRequests=stHttpsRequests, stHandleConnectToServer=stHandleConnectToServer, notifySeverity=notifySeverity, stFtpBytesFromServer=stFtpBytesFromServer, stFtpTraffic=stFtpTraffic, notifyReasonString=notifyReasonString, stCPULoad=stCPULoad, stCategories=stCategories, mwgHttps=mwgHttps, pAMProactiveVersion=pAMProactiveVersion, stHttpTraffic=stHttpTraffic, mwgMiscellaneous=mwgMiscellaneous, mwgHttp=mwgHttp, stConnectionsBlocked=stConnectionsBlocked, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesToServer=stFtpBytesToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpBytesFromServer=stHttpBytesFromServer, notifyAffectedHost=notifyAffectedHost, stConnectionsLegitimate=stConnectionsLegitimate, kBuildNumber=kBuildNumber, pAMEngineVersion=pAMEngineVersion, mwgInfo=mwgInfo, stCategoriesEntry=stCategoriesEntry, stBlockedByURLFilter=stBlockedByURLFilter, stClientCount=stClientCount, stTimeForTransaction=stTimeForTransaction, stHttpsBytesToServer=stHttpsBytesToServer, stMalwareDetected=stMalwareDetected, pMFEEngineVersion=pMFEEngineVersion, stFtpBytesFromClient=stFtpBytesFromClient, kRevision=kRevision, kMinorVersion=kMinorVersion, kCustomVersion=kCustomVersion, mwgStatistics=mwgStatistics, stHttpsBytesFromClient=stHttpsBytesFromClient, stHttpBytesToServer=stHttpBytesToServer, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kHotfixVersion=kHotfixVersion, mwgContent=mwgContent, PYSNMP_MODULE_ID=mwg, stCPULoadRaw=stCPULoadRaw, notifyReason=notifyReason)
