...
enterprises, NotificationType, Counter64, Bits, Unsigned32, mib_2, TimeTicks, ObjectIdentity, ModuleIdentity, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, MibIdentifier, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "Counter64", "Bits", "Unsigned32", "mib-2", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "MibIdentifier", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpBytesToServer=stHttpBytesToServer, notifyReasonString=notifyReasonString, stMimeType=stMimeType, stHttpRequests=stHttpRequests, stCategoryCount=stCategoryCount, stHandleConnectToServer=stHandleConnectToServer, stCPUIOWait=stCPUIOWait, kCustomVersion=kCustomVersion, stFtpBytesFromServer=stFtpBytesFromServer, pTSDBVersion=pTSDBVersion, stBlockedByURLFilter=stBlockedByURLFilter, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, pAMEngineVersion=pAMEngineVersion, PYSNMP_MODULE_ID=mwg, trUser=trUser, notifyReason=notifyReason, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kMicroVersion=kMicroVersion, stCategoryName=stCategoryName, stHttpsTraffic=stHttpsTraffic, stHttpsBytesFromClient=stHttpsBytesFromClient, pAMProactiveVersion=pAMProactiveVersion, stCategories=stCategories, stBadReputation=stBadReputation, stFtpBytesFromClient=stFtpBytesFromClient, mwgEngineVersions=mwgEngineVersions, stMemConsumed=stMemConsumed, mwgInfo=mwgInfo, stCPULoadRaw=stCPULoadRaw, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesTable=stCategoriesTable, stHttpBytesToClient=stHttpBytesToClient, stCategoriesEntry=stCategoriesEntry, stHttpBytesFromClient=stHttpBytesFromClient, stHttpTraffic=stHttpTraffic, notifySeverity=notifySeverity, kBuildNumber=kBuildNumber, kHotfixVersion=kHotfixVersion, stConnectionsBlocked=stConnectionsBlocked, kRevision=kRevision, trSystem=trSystem, stCPULoad=stCPULoad, stFtpBytesToServer=stFtpBytesToServer, stTimeForTransaction=stTimeForTransaction, mwgTrapVariables=mwgTrapVariables, stMalwareDetected=stMalwareDetected, stHttpsBytesToClient=stHttpsBytesToClient, kMinorVersion=kMinorVersion, kCompanyName=kCompanyName, pAMSignatureVersion=pAMSignatureVersion, mwgStatistics=mwgStatistics, notifyOriginName=notifyOriginName, stHttpsBytesToServer=stHttpsBytesToServer, pMFEDATVersion=pMFEDATVersion, stResolveHostViaDNS=stResolveHostViaDNS, stFtpBytesToClient=stFtpBytesToClient, stHttpsBytesFromServer=stHttpsBytesFromServer, kMajorVersion=kMajorVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, trApplication=trApplication, stHttpBytesFromServer=stHttpBytesFromServer, mwg=mwg, notifyOrigin=notifyOrigin, notifyAffectedHost=notifyAffectedHost, notifyAdditional=notifyAdditional, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kProductName=kProductName, pMFEEngineVersion=pMFEEngineVersion, stConnectedSockets=stConnectedSockets, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgHttps=mwgHttps, stLastSentLastReceivedServer=stLastSentLastReceivedServer, mwgHttp=mwgHttp, stFtpTraffic=stFtpTraffic, kProductVersion=kProductVersion, mwgMiscellaneous=mwgMiscellaneous, stLastSentLastReceivedClient=stLastSentLastReceivedClient, mwgFTP=mwgFTP, stHttpsRequests=stHttpsRequests, mwgTraps=mwgTraps, stClientCount=stClientCount, mwgContent=mwgContent)
