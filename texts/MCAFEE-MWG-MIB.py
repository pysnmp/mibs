...
NotificationType, mib_2, MibIdentifier, enterprises, Unsigned32, Gauge32, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Counter64, IpAddress, Counter32, ObjectIdentity, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "mib-2", "MibIdentifier", "enterprises", "Unsigned32", "Gauge32", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Counter64", "IpAddress", "Counter32", "ObjectIdentity", "Bits", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwg=mwg, stBlockedByMediaFilter=stBlockedByMediaFilter, kHotfixVersion=kHotfixVersion, mwgStatistics=mwgStatistics, notifyOriginName=notifyOriginName, mwgInfo=mwgInfo, stHttpsRequests=stHttpsRequests, trApplication=trApplication, kMajorVersion=kMajorVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stCPUIOWait=stCPUIOWait, mwgHttps=mwgHttps, pAMSignatureVersion=pAMSignatureVersion, notifyAdditional=notifyAdditional, pTSDBVersion=pTSDBVersion, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesToClient=stHttpBytesToClient, stBlockedByURLFilter=stBlockedByURLFilter, pMFEDATVersion=pMFEDATVersion, kProductVersion=kProductVersion, pAMEngineVersion=pAMEngineVersion, stMemConsumed=stMemConsumed, stHttpTraffic=stHttpTraffic, stTimeForTransaction=stTimeForTransaction, stCategoryName=stCategoryName, kBuildNumber=kBuildNumber, stCategoriesEntry=stCategoriesEntry, mwgMiscellaneous=mwgMiscellaneous, stMalwareDetected=stMalwareDetected, trSystem=trSystem, stHttpsBytesFromServer=stHttpsBytesFromServer, kProductName=kProductName, stClientCount=stClientCount, mwgEngineVersions=mwgEngineVersions, kMinorVersion=kMinorVersion, stHttpBytesFromClient=stHttpBytesFromClient, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoriesTable=stCategoriesTable, trUser=trUser, notifyOrigin=notifyOrigin, stHandleConnectToServer=stHandleConnectToServer, notifyAffectedHost=notifyAffectedHost, notifySeverity=notifySeverity, stHttpsTraffic=stHttpsTraffic, stHttpRequests=stHttpRequests, stHttpBytesToServer=stHttpBytesToServer, stFtpBytesToClient=stFtpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, PYSNMP_MODULE_ID=mwg, mwgHttp=mwgHttp, stCategories=stCategories, stHttpBytesFromServer=stHttpBytesFromServer, mwgFTP=mwgFTP, stFtpBytesFromClient=stFtpBytesFromClient, stCPULoad=stCPULoad, stHttpsBytesToServer=stHttpsBytesToServer, stCPULoadRaw=stCPULoadRaw, stFtpTraffic=stFtpTraffic, stConnectionsBlocked=stConnectionsBlocked, notifyReason=notifyReason, stHttpsBytesToClient=stHttpsBytesToClient, mwgContent=mwgContent, pAMProactiveVersion=pAMProactiveVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgTrapVariables=mwgTrapVariables, kMicroVersion=kMicroVersion, stMimeType=stMimeType, kCompanyName=kCompanyName, stCategoryCount=stCategoryCount, kRevision=kRevision, kCustomVersion=kCustomVersion, mwgTraps=mwgTraps, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stFtpBytesFromServer=stFtpBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS, notifyReasonString=notifyReasonString, stBadReputation=stBadReputation, stConnectedSockets=stConnectedSockets, stFtpBytesToServer=stFtpBytesToServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient)
