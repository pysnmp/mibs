...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, NotificationType, ObjectIdentity, ModuleIdentity, IpAddress, Gauge32, mib_2, iso, Integer32, Counter32, MibIdentifier, TimeTicks, Bits, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "NotificationType", "ObjectIdentity", "ModuleIdentity", "IpAddress", "Gauge32", "mib-2", "iso", "Integer32", "Counter32", "MibIdentifier", "TimeTicks", "Bits", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgStatistics=mwgStatistics, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsBytesToClient=stHttpsBytesToClient, pMFEDATVersion=pMFEDATVersion, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trUser=trUser, stCategoriesEntry=stCategoriesEntry, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kProductName=kProductName, trSystem=trSystem, stCPULoadRaw=stCPULoadRaw, mwgHttp=mwgHttp, stHandleConnectToServer=stHandleConnectToServer, stCategories=stCategories, stCategoriesTable=stCategoriesTable, stHttpsTraffic=stHttpsTraffic, stMemConsumed=stMemConsumed, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgTraps=mwgTraps, pAMProactiveVersion=pAMProactiveVersion, stBadReputation=stBadReputation, notifyAffectedHost=notifyAffectedHost, notifyReasonString=notifyReasonString, notifyReason=notifyReason, stHttpTraffic=stHttpTraffic, kCompanyName=kCompanyName, kProductVersion=kProductVersion, pTSDBVersion=pTSDBVersion, stMimeType=stMimeType, mwgInfo=mwgInfo, stFtpTraffic=stFtpTraffic, stHttpRequests=stHttpRequests, stClientCount=stClientCount, kRevision=kRevision, mwgTrapVariables=mwgTrapVariables, mwgEngineVersions=mwgEngineVersions, stCPUIOWait=stCPUIOWait, stCategoryName=stCategoryName, stFtpBytesFromServer=stFtpBytesFromServer, stConnectionsLegitimate=stConnectionsLegitimate, stCPULoad=stCPULoad, pMFEEngineVersion=pMFEEngineVersion, notifyAdditional=notifyAdditional, stMalwareDetected=stMalwareDetected, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, PYSNMP_MODULE_ID=mwg, trApplication=trApplication, kMinorVersion=kMinorVersion, kBuildNumber=kBuildNumber, mwgMiscellaneous=mwgMiscellaneous, notifyOrigin=notifyOrigin, kMicroVersion=kMicroVersion, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesToClient=stHttpBytesToClient, stConnectedSockets=stConnectedSockets, kCustomVersion=kCustomVersion, kHotfixVersion=kHotfixVersion, notifySeverity=notifySeverity, mwg=mwg, notifyOriginName=notifyOriginName, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesFromClient=stFtpBytesFromClient, stHttpBytesToServer=stHttpBytesToServer, kMajorVersion=kMajorVersion, pAMEngineVersion=pAMEngineVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stCategoryCount=stCategoryCount, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stBlockedByURLFilter=stBlockedByURLFilter, mwgHttps=mwgHttps, stTimeForTransaction=stTimeForTransaction, mwgContent=mwgContent, stFtpBytesToClient=stFtpBytesToClient, stConnectionsBlocked=stConnectionsBlocked, stBlockedByAntiMalware=stBlockedByAntiMalware, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgFTP=mwgFTP, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stHttpsRequests=stHttpsRequests)
