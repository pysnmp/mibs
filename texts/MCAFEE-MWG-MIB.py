...
enterprises, TimeTicks, Bits, NotificationType, Counter64, mib_2, NotificationType, Unsigned32, ObjectIdentity, ModuleIdentity, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Gauge32, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "Bits", "NotificationType", "Counter64", "mib-2", "NotificationType", "Unsigned32", "ObjectIdentity", "ModuleIdentity", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Gauge32", "Integer32", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgTraps=mwgTraps, stBlockedByURLFilter=stBlockedByURLFilter, mwgInfo=mwgInfo, kBuildNumber=kBuildNumber, stFtpBytesToClient=stFtpBytesToClient, mwgFTP=mwgFTP, mwgTrapVariables=mwgTrapVariables, stHttpRequests=stHttpRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpBytesFromClient=stHttpBytesFromClient, stResolveHostViaDNS=stResolveHostViaDNS, stCategoryCount=stCategoryCount, notifyOrigin=notifyOrigin, notifyReason=notifyReason, stConnectedSockets=stConnectedSockets, trSystem=trSystem, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesToServer=stHttpsBytesToServer, stCategoryName=stCategoryName, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesFromClient=stFtpBytesFromClient, stCPUIOWait=stCPUIOWait, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgContent=mwgContent, mwgHttps=mwgHttps, mwg=mwg, stCPULoad=stCPULoad, stCPULoadRaw=stCPULoadRaw, kMicroVersion=kMicroVersion, stHttpsRequests=stHttpsRequests, stHttpBytesFromServer=stHttpBytesFromServer, pTSDBVersion=pTSDBVersion, mwgEngineVersions=mwgEngineVersions, stMimeType=stMimeType, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategories=stCategories, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpTraffic=stFtpTraffic, notifyOriginName=notifyOriginName, stCategoriesTable=stCategoriesTable, kCompanyName=kCompanyName, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pMFEDATVersion=pMFEDATVersion, mwgStatistics=mwgStatistics, pAMProactiveVersion=pAMProactiveVersion, stHttpTraffic=stHttpTraffic, PYSNMP_MODULE_ID=mwg, stConnectionsBlocked=stConnectionsBlocked, stClientCount=stClientCount, stConnectionsLegitimate=stConnectionsLegitimate, stHttpBytesToClient=stHttpBytesToClient, stHttpsTraffic=stHttpsTraffic, kMajorVersion=kMajorVersion, kCustomVersion=kCustomVersion, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByMediaFilter=stBlockedByMediaFilter, kHotfixVersion=kHotfixVersion, kProductName=kProductName, mwgHttp=mwgHttp, stMemConsumed=stMemConsumed, stFtpBytesToServer=stFtpBytesToServer, kProductVersion=kProductVersion, notifySeverity=notifySeverity, kMinorVersion=kMinorVersion, stHttpsBytesFromClient=stHttpsBytesFromClient, stCategoriesEntry=stCategoriesEntry, pMFEEngineVersion=pMFEEngineVersion, stMalwareDetected=stMalwareDetected, notifyAffectedHost=notifyAffectedHost, notifyAdditional=notifyAdditional, stBadReputation=stBadReputation, stTimeForTransaction=stTimeForTransaction, pAMSignatureVersion=pAMSignatureVersion, pAMEngineVersion=pAMEngineVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyReasonString=notifyReasonString, trApplication=trApplication, stHttpBytesToServer=stHttpBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kRevision=kRevision, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trUser=trUser)
