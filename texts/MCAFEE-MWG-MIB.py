...
TimeTicks, Counter32, Bits, NotificationType, enterprises, ModuleIdentity, Gauge32, MibIdentifier, iso, ObjectIdentity, IpAddress, mib_2, NotificationType, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "Bits", "NotificationType", "enterprises", "ModuleIdentity", "Gauge32", "MibIdentifier", "iso", "ObjectIdentity", "IpAddress", "mib-2", "NotificationType", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", mwgTrapVariables=mwgTrapVariables, stCPULoad=stCPULoad, stCPULoadRaw=stCPULoadRaw, stCategoriesEntry=stCategoriesEntry, stHttpsRequests=stHttpsRequests, stFtpTraffic=stFtpTraffic, stHttpsTraffic=stHttpsTraffic, stTimeForTransaction=stTimeForTransaction, notifySeverity=notifySeverity, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stHandleConnectToServer=stHandleConnectToServer, stMemConsumed=stMemConsumed, stHttpBytesToClient=stHttpBytesToClient, notifyAdditional=notifyAdditional, pTSDBVersion=pTSDBVersion, mwgInfo=mwgInfo, stHttpBytesToServer=stHttpBytesToServer, kBuildNumber=kBuildNumber, stCategoryName=stCategoryName, kMinorVersion=kMinorVersion, mwgMiscellaneous=mwgMiscellaneous, stHttpsBytesFromServer=stHttpsBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgHttp=mwgHttp, pAMProactiveVersion=pAMProactiveVersion, stFtpBytesFromServer=stFtpBytesFromServer, stFtpBytesToClient=stFtpBytesToClient, stClientCount=stClientCount, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, mwgFTP=mwgFTP, stConnectionsLegitimate=stConnectionsLegitimate, mwgTraps=mwgTraps, pMFEEngineVersion=pMFEEngineVersion, kMajorVersion=kMajorVersion, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kProductName=kProductName, kCompanyName=kCompanyName, mwg=mwg, stCategories=stCategories, trSystem=trSystem, mwgStatistics=mwgStatistics, pMFEDATVersion=pMFEDATVersion, kMicroVersion=kMicroVersion, stCPUIOWait=stCPUIOWait, trUser=trUser, stConnectedSockets=stConnectedSockets, stMalwareDetected=stMalwareDetected, notifyOrigin=notifyOrigin, kCustomVersion=kCustomVersion, stMimeType=stMimeType, stCategoriesTable=stCategoriesTable, mwgEngineVersions=mwgEngineVersions, stFtpBytesFromClient=stFtpBytesFromClient, stCategoryCount=stCategoryCount, stBadReputation=stBadReputation, pAMEngineVersion=pAMEngineVersion, stHttpRequests=stHttpRequests, pAMSignatureVersion=pAMSignatureVersion, notifyAffectedHost=notifyAffectedHost, stBlockedByURLFilter=stBlockedByURLFilter, stHttpTraffic=stHttpTraffic, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsBytesToServer=stHttpsBytesToServer, notifyOriginName=notifyOriginName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kProductVersion=kProductVersion, PYSNMP_MODULE_ID=mwg, stHttpsBytesToClient=stHttpsBytesToClient, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stConnectionsBlocked=stConnectionsBlocked, stBlockedByMediaFilter=stBlockedByMediaFilter, trApplication=trApplication, kHotfixVersion=kHotfixVersion, notifyReason=notifyReason, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgContent=mwgContent, stResolveHostViaDNS=stResolveHostViaDNS, notifyReasonString=notifyReasonString, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kRevision=kRevision, mwgHttps=mwgHttps, stHttpBytesFromClient=stHttpBytesFromClient)
