...
iso, ModuleIdentity, ObjectIdentity, Unsigned32, NotificationType, Counter32, Counter64, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, MibIdentifier, NotificationType, Gauge32, Integer32, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "NotificationType", "Counter32", "Counter64", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "MibIdentifier", "NotificationType", "Gauge32", "Integer32", "TimeTicks", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBlockedByAntiMalware=stBlockedByAntiMalware, notifyReasonString=notifyReasonString, notifySeverity=notifySeverity, pMFEEngineVersion=pMFEEngineVersion, stHttpTraffic=stHttpTraffic, trApplication=trApplication, stHttpBytesToClient=stHttpBytesToClient, mwg=mwg, kMicroVersion=kMicroVersion, stResolveHostViaDNS=stResolveHostViaDNS, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, pAMEngineVersion=pAMEngineVersion, trUser=trUser, stCategoriesEntry=stCategoriesEntry, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsTraffic=stHttpsTraffic, pAMSignatureVersion=pAMSignatureVersion, stMalwareDetected=stMalwareDetected, stHttpsRequests=stHttpsRequests, stFtpTraffic=stFtpTraffic, notifyOriginName=notifyOriginName, PYSNMP_MODULE_ID=mwg, stHttpRequests=stHttpRequests, mwgStatistics=mwgStatistics, mwgMiscellaneous=mwgMiscellaneous, stHandleConnectToServer=stHandleConnectToServer, stHttpsBytesToClient=stHttpsBytesToClient, stMimeType=stMimeType, stConnectedSockets=stConnectedSockets, kHotfixVersion=kHotfixVersion, stCategoryName=stCategoryName, stCategoriesTable=stCategoriesTable, notifyReason=notifyReason, stHttpBytesFromServer=stHttpBytesFromServer, kCompanyName=kCompanyName, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, stBadReputation=stBadReputation, stConnectionsBlocked=stConnectionsBlocked, notifyAdditional=notifyAdditional, kBuildNumber=kBuildNumber, stMemConsumed=stMemConsumed, stCategoryCount=stCategoryCount, stCategories=stCategories, stCPUIOWait=stCPUIOWait, pMFEDATVersion=pMFEDATVersion, stHttpBytesToServer=stHttpBytesToServer, mwgInfo=mwgInfo, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stClientCount=stClientCount, stHttpBytesFromClient=stHttpBytesFromClient, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMajorVersion=kMajorVersion, stHttpsBytesToServer=stHttpsBytesToServer, kMinorVersion=kMinorVersion, kProductVersion=kProductVersion, stCPULoad=stCPULoad, notifyOrigin=notifyOrigin, notifyAffectedHost=notifyAffectedHost, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, kProductName=kProductName, mwgHttp=mwgHttp, kCustomVersion=kCustomVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stCPULoadRaw=stCPULoadRaw, pAMProactiveVersion=pAMProactiveVersion, trSystem=trSystem, kRevision=kRevision, mwgTraps=mwgTraps, stFtpBytesFromClient=stFtpBytesFromClient, mwgFTP=mwgFTP, stConnectionsLegitimate=stConnectionsLegitimate, mwgTrapVariables=mwgTrapVariables, stTimeForTransaction=stTimeForTransaction, pTSDBVersion=pTSDBVersion, stFtpBytesToServer=stFtpBytesToServer, stFtpBytesToClient=stFtpBytesToClient, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgContent=mwgContent, mwgHttps=mwgHttps, mwgEngineVersions=mwgEngineVersions)
