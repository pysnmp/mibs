...
enterprises, TimeTicks, NotificationType, ObjectIdentity, Bits, NotificationType, Unsigned32, mib_2, MibIdentifier, Counter32, IpAddress, Counter64, ModuleIdentity, iso, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "NotificationType", "ObjectIdentity", "Bits", "NotificationType", "Unsigned32", "mib-2", "MibIdentifier", "Counter32", "IpAddress", "Counter64", "ModuleIdentity", "iso", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stHttpsTraffic=stHttpsTraffic, stMemConsumed=stMemConsumed, stConnectionsBlocked=stConnectionsBlocked, kMajorVersion=kMajorVersion, mwgHttp=mwgHttp, PYSNMP_MODULE_ID=mwg, kBuildNumber=kBuildNumber, mwgFTP=mwgFTP, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stHttpsBytesToServer=stHttpsBytesToServer, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgEngineVersions=mwgEngineVersions, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stConnectionsLegitimate=stConnectionsLegitimate, stCategoriesTable=stCategoriesTable, stFtpTraffic=stFtpTraffic, mwgStatistics=mwgStatistics, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, kProductName=kProductName, pMFEEngineVersion=pMFEEngineVersion, kProductVersion=kProductVersion, stFtpBytesFromClient=stFtpBytesFromClient, stMalwareDetected=stMalwareDetected, stCPUIOWait=stCPUIOWait, trApplication=trApplication, kCompanyName=kCompanyName, pMFEDATVersion=pMFEDATVersion, stFtpBytesFromServer=stFtpBytesFromServer, stBlockedByMediaFilter=stBlockedByMediaFilter, notifySeverity=notifySeverity, notifyOrigin=notifyOrigin, kCustomVersion=kCustomVersion, pAMProactiveVersion=pAMProactiveVersion, kRevision=kRevision, stHttpTraffic=stHttpTraffic, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesToClient=stHttpBytesToClient, stMimeType=stMimeType, stCategoryCount=stCategoryCount, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCPULoadRaw=stCPULoadRaw, stFtpBytesToServer=stFtpBytesToServer, pAMSignatureVersion=pAMSignatureVersion, mwgHttps=mwgHttps, stTimeForTransaction=stTimeForTransaction, mwgTrapVariables=mwgTrapVariables, stCPULoad=stCPULoad, stHttpBytesFromClient=stHttpBytesFromClient, mwgInfo=mwgInfo, stHttpsRequests=stHttpsRequests, stResolveHostViaDNS=stResolveHostViaDNS, stHttpBytesToServer=stHttpBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, pAMEngineVersion=pAMEngineVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, notifyOriginName=notifyOriginName, stHttpRequests=stHttpRequests, mwgContent=mwgContent, trUser=trUser, stCategoryName=stCategoryName, mwgMiscellaneous=mwgMiscellaneous, stBlockedByURLFilter=stBlockedByURLFilter, stClientCount=stClientCount, stHandleConnectToServer=stHandleConnectToServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, notifyReason=notifyReason, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, pTSDBVersion=pTSDBVersion, stBadReputation=stBadReputation, mwgTraps=mwgTraps, mwg=mwg, trSystem=trSystem, notifyAffectedHost=notifyAffectedHost, kMicroVersion=kMicroVersion, stCategories=stCategories, stHttpsBytesFromServer=stHttpsBytesFromServer, notifyReasonString=notifyReasonString, stCategoriesEntry=stCategoriesEntry, kMinorVersion=kMinorVersion, notifyAdditional=notifyAdditional, kHotfixVersion=kHotfixVersion, stConnectedSockets=stConnectedSockets)
