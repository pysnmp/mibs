...
IpAddress, Counter64, NotificationType, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, Integer32, TimeTicks, Counter32, Gauge32, mib_2, enterprises, MibIdentifier, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "NotificationType", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "Integer32", "TimeTicks", "Counter32", "Gauge32", "mib-2", "enterprises", "MibIdentifier", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", PYSNMP_MODULE_ID=mwg, stCPUIOWait=stCPUIOWait, mwgEngineVersions=mwgEngineVersions, stBlockedByMediaFilter=stBlockedByMediaFilter, stClientCount=stClientCount, stCategoriesEntry=stCategoriesEntry, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsRequests=stHttpsRequests, stHttpsBytesToClient=stHttpsBytesToClient, stFtpBytesToClient=stFtpBytesToClient, mwgMiscellaneous=mwgMiscellaneous, mwgHttp=mwgHttp, stHttpBytesToClient=stHttpBytesToClient, stHttpsTraffic=stHttpsTraffic, mwgFTP=mwgFTP, kHotfixVersion=kHotfixVersion, stHttpBytesFromServer=stHttpBytesFromServer, kBuildNumber=kBuildNumber, stBlockedByAntiMalware=stBlockedByAntiMalware, stMemConsumed=stMemConsumed, mwgStatistics=mwgStatistics, stCPULoadRaw=stCPULoadRaw, stHttpBytesFromClient=stHttpBytesFromClient, stBadReputation=stBadReputation, mwgTrapVariables=mwgTrapVariables, trSystem=trSystem, notifyReason=notifyReason, notifyAffectedHost=notifyAffectedHost, stHttpBytesToServer=stHttpBytesToServer, kRevision=kRevision, stCPULoad=stCPULoad, stConnectedSockets=stConnectedSockets, stMimeType=stMimeType, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, trApplication=trApplication, stFtpBytesToServer=stFtpBytesToServer, pAMSignatureVersion=pAMSignatureVersion, stHttpsBytesToServer=stHttpsBytesToServer, trUser=trUser, stHttpsBytesFromClient=stHttpsBytesFromClient, kMinorVersion=kMinorVersion, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stResolveHostViaDNS=stResolveHostViaDNS, mwgHttps=mwgHttps, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, kMajorVersion=kMajorVersion, stTimeForTransaction=stTimeForTransaction, pTSDBVersion=pTSDBVersion, notifyAdditional=notifyAdditional, notifySeverity=notifySeverity, stHttpsBytesFromServer=stHttpsBytesFromServer, stCategoriesTable=stCategoriesTable, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kMicroVersion=kMicroVersion, mwgContent=mwgContent, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kProductVersion=kProductVersion, notifyOrigin=notifyOrigin, kCompanyName=kCompanyName, notifyReasonString=notifyReasonString, kProductName=kProductName, stMalwareDetected=stMalwareDetected, stHttpRequests=stHttpRequests, stFtpBytesFromClient=stFtpBytesFromClient, stFtpTraffic=stFtpTraffic, stBlockedByURLFilter=stBlockedByURLFilter, stCategoryName=stCategoryName, stFtpBytesFromServer=stFtpBytesFromServer, pAMEngineVersion=pAMEngineVersion, mwgInfo=mwgInfo, stConnectionsLegitimate=stConnectionsLegitimate, stConnectionsBlocked=stConnectionsBlocked, mwg=mwg, pMFEEngineVersion=pMFEEngineVersion, notifyOriginName=notifyOriginName, stCategories=stCategories, stCategoryCount=stCategoryCount, stHandleConnectToServer=stHandleConnectToServer, pMFEDATVersion=pMFEDATVersion, mwgTraps=mwgTraps, pAMProactiveVersion=pAMProactiveVersion, kCustomVersion=kCustomVersion, stHttpTraffic=stHttpTraffic)
