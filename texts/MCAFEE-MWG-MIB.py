...
Unsigned32, IpAddress, Counter64, mib_2, MibIdentifier, Counter32, enterprises, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, Bits, NotificationType, ModuleIdentity, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "Counter64", "mib-2", "MibIdentifier", "Counter32", "enterprises", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "Bits", "NotificationType", "ModuleIdentity", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyReason=notifyReason, kHotfixVersion=kHotfixVersion, stHttpBytesToServer=stHttpBytesToServer, stClientCount=stClientCount, stFtpTraffic=stFtpTraffic, kProductVersion=kProductVersion, PYSNMP_MODULE_ID=mwg, stCategoryCount=stCategoryCount, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, notifyAffectedHost=notifyAffectedHost, kProductName=kProductName, stFtpBytesFromServer=stFtpBytesFromServer, stMemConsumed=stMemConsumed, stMalwareDetected=stMalwareDetected, stConnectionsBlocked=stConnectionsBlocked, mwgMiscellaneous=mwgMiscellaneous, mwgEngineVersions=mwgEngineVersions, stHttpsTraffic=stHttpsTraffic, stBadReputation=stBadReputation, mwg=mwg, kCustomVersion=kCustomVersion, stBlockedByAntiMalware=stBlockedByAntiMalware, mwgHttps=mwgHttps, pMFEDATVersion=pMFEDATVersion, stMimeType=stMimeType, stHttpRequests=stHttpRequests, notifySeverity=notifySeverity, pMFEEngineVersion=pMFEEngineVersion, mwgTraps=mwgTraps, kRevision=kRevision, pAMProactiveVersion=pAMProactiveVersion, stHttpsBytesFromServer=stHttpsBytesFromServer, mwgStatistics=mwgStatistics, kMajorVersion=kMajorVersion, mwgHttp=mwgHttp, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgTrapVariables=mwgTrapVariables, kMicroVersion=kMicroVersion, stBlockedByURLFilter=stBlockedByURLFilter, stHttpBytesToClient=stHttpBytesToClient, stHttpBytesFromClient=stHttpBytesFromClient, pAMEngineVersion=pAMEngineVersion, stHttpBytesFromServer=stHttpBytesFromServer, stCategoryName=stCategoryName, mwgInfo=mwgInfo, stHandleConnectToServer=stHandleConnectToServer, stConnectionsLegitimate=stConnectionsLegitimate, kCompanyName=kCompanyName, stConnectedSockets=stConnectedSockets, mwgContent=mwgContent, stHttpsRequests=stHttpsRequests, stCPULoad=stCPULoad, trApplication=trApplication, kBuildNumber=kBuildNumber, mwgFTP=mwgFTP, notifyOrigin=notifyOrigin, stHttpsBytesFromClient=stHttpsBytesFromClient, trSystem=trSystem, stHttpsBytesToClient=stHttpsBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpTraffic=stHttpTraffic, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMinorVersion=kMinorVersion, notifyOriginName=notifyOriginName, stFtpBytesToClient=stFtpBytesToClient, stResolveHostViaDNS=stResolveHostViaDNS, pTSDBVersion=pTSDBVersion, stHttpsBytesToServer=stHttpsBytesToServer, stFtpBytesFromClient=stFtpBytesFromClient, stCPUIOWait=stCPUIOWait, stFtpBytesToServer=stFtpBytesToServer, notifyReasonString=notifyReasonString, stCPULoadRaw=stCPULoadRaw, stCategoriesEntry=stCategoriesEntry, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trUser=trUser, notifyAdditional=notifyAdditional, stTimeForTransaction=stTimeForTransaction, stCategoriesTable=stCategoriesTable, pAMSignatureVersion=pAMSignatureVersion, stCategories=stCategories)
