...
ObjectIdentity, iso, Unsigned32, Gauge32, Integer32, MibIdentifier, Counter64, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, enterprises, TimeTicks, ModuleIdentity, Bits, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "Unsigned32", "Gauge32", "Integer32", "MibIdentifier", "Counter64", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "enterprises", "TimeTicks", "ModuleIdentity", "Bits", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", kHotfixVersion=kHotfixVersion, notifyReason=notifyReason, mwgTraps=mwgTraps, mwgHttp=mwgHttp, notifyReasonString=notifyReasonString, stFtpBytesToServer=stFtpBytesToServer, kCompanyName=kCompanyName, stCPULoad=stCPULoad, pAMSignatureVersion=pAMSignatureVersion, stCPUIOWait=stCPUIOWait, mwgInfo=mwgInfo, stHttpTraffic=stHttpTraffic, notifyOrigin=notifyOrigin, stMemConsumed=stMemConsumed, pAMEngineVersion=pAMEngineVersion, trUser=trUser, notifySeverity=notifySeverity, mwgContent=mwgContent, stFtpBytesToClient=stFtpBytesToClient, mwg=mwg, stHttpBytesToClient=stHttpBytesToClient, stHttpsTraffic=stHttpsTraffic, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stMalwareDetected=stMalwareDetected, stCategoriesTable=stCategoriesTable, kBuildNumber=kBuildNumber, pAMProactiveVersion=pAMProactiveVersion, stHttpsRequests=stHttpsRequests, notifyAffectedHost=notifyAffectedHost, pTSDBVersion=pTSDBVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, trApplication=trApplication, kProductName=kProductName, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesFromClient=stHttpsBytesFromClient, notifyAdditional=notifyAdditional, mwgHttps=mwgHttps, stBlockedByAntiMalware=stBlockedByAntiMalware, stFtpBytesFromServer=stFtpBytesFromServer, stTimeForTransaction=stTimeForTransaction, stFtpTraffic=stFtpTraffic, kMinorVersion=kMinorVersion, mwgFTP=mwgFTP, stBlockedByURLFilter=stBlockedByURLFilter, mwgTrapVariables=mwgTrapVariables, PYSNMP_MODULE_ID=mwg, stHttpsBytesFromServer=stHttpsBytesFromServer, stResolveHostViaDNS=stResolveHostViaDNS, stMimeType=stMimeType, stHandleConnectToServer=stHandleConnectToServer, stFtpBytesFromClient=stFtpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, pMFEDATVersion=pMFEDATVersion, kCustomVersion=kCustomVersion, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesToClient=stHttpsBytesToClient, mwgStatistics=mwgStatistics, stBadReputation=stBadReputation, stLastSentLastReceivedClient=stLastSentLastReceivedClient, kMicroVersion=kMicroVersion, mwgEngineVersions=mwgEngineVersions, trSystem=trSystem, stLastSentLastReceivedServer=stLastSentLastReceivedServer, pMFEEngineVersion=pMFEEngineVersion, stConnectedSockets=stConnectedSockets, stCategories=stCategories, stHttpBytesToServer=stHttpBytesToServer, stConnectionsBlocked=stConnectionsBlocked, stClientCount=stClientCount, kMajorVersion=kMajorVersion, stHttpsBytesToServer=stHttpsBytesToServer, stConnectionsLegitimate=stConnectionsLegitimate, kProductVersion=kProductVersion, kRevision=kRevision, stCPULoadRaw=stCPULoadRaw, stCategoryCount=stCategoryCount, stCategoriesEntry=stCategoriesEntry, stHttpBytesFromClient=stHttpBytesFromClient, stHttpRequests=stHttpRequests, notifyOriginName=notifyOriginName, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCategoryName=stCategoryName)
