...
mib_2, Bits, enterprises, Gauge32, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, NotificationType, MibIdentifier, Counter64, IpAddress, ModuleIdentity, iso, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Bits", "enterprises", "Gauge32", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "NotificationType", "MibIdentifier", "Counter64", "IpAddress", "ModuleIdentity", "iso", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stBadReputation=stBadReputation, stHttpsBytesToClient=stHttpsBytesToClient, mwgEngineVersions=mwgEngineVersions, stCategoryCount=stCategoryCount, kCustomVersion=kCustomVersion, pAMProactiveVersion=pAMProactiveVersion, mwgTraps=mwgTraps, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, pTSDBVersion=pTSDBVersion, kProductVersion=kProductVersion, stHttpBytesToClient=stHttpBytesToClient, trApplication=trApplication, stConnectionsBlocked=stConnectionsBlocked, mwgHttps=mwgHttps, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stConnectionsLegitimate=stConnectionsLegitimate, mwgTrapVariables=mwgTrapVariables, kProductName=kProductName, stCategoryName=stCategoryName, mwgStatistics=mwgStatistics, stHandleConnectToServer=stHandleConnectToServer, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, kMinorVersion=kMinorVersion, stHttpsRequests=stHttpsRequests, stHttpsBytesFromServer=stHttpsBytesFromServer, pMFEEngineVersion=pMFEEngineVersion, stHttpBytesFromClient=stHttpBytesFromClient, stCategories=stCategories, mwgContent=mwgContent, pMFEDATVersion=pMFEDATVersion, kMicroVersion=kMicroVersion, stHttpTraffic=stHttpTraffic, mwgInfo=mwgInfo, stBlockedByURLFilter=stBlockedByURLFilter, stResolveHostViaDNS=stResolveHostViaDNS, stMimeType=stMimeType, mwg=mwg, stFtpTraffic=stFtpTraffic, notifySeverity=notifySeverity, notifyReason=notifyReason, pAMSignatureVersion=pAMSignatureVersion, notifyAdditional=notifyAdditional, stFtpBytesToClient=stFtpBytesToClient, stMemConsumed=stMemConsumed, stCPULoad=stCPULoad, kCompanyName=kCompanyName, notifyOrigin=notifyOrigin, stFtpBytesFromClient=stFtpBytesFromClient, mwgMiscellaneous=mwgMiscellaneous, stCPULoadRaw=stCPULoadRaw, stHttpsBytesToServer=stHttpsBytesToServer, stHttpBytesToServer=stHttpBytesToServer, trSystem=trSystem, mwgHttp=mwgHttp, stBlockedByAntiMalware=stBlockedByAntiMalware, stHttpsTraffic=stHttpsTraffic, PYSNMP_MODULE_ID=mwg, kMajorVersion=kMajorVersion, stTimeForTransaction=stTimeForTransaction, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kRevision=kRevision, pAMEngineVersion=pAMEngineVersion, stConnectedSockets=stConnectedSockets, kHotfixVersion=kHotfixVersion, notifyOriginName=notifyOriginName, notifyAffectedHost=notifyAffectedHost, stCPUIOWait=stCPUIOWait, notifyReasonString=notifyReasonString, mwgFTP=mwgFTP, stHttpRequests=stHttpRequests, stMalwareDetected=stMalwareDetected, stBlockedByMediaFilter=stBlockedByMediaFilter, kBuildNumber=kBuildNumber, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stFtpBytesToServer=stFtpBytesToServer, stHttpBytesFromServer=stHttpBytesFromServer, stFtpBytesFromServer=stFtpBytesFromServer, stCategoriesTable=stCategoriesTable, stCategoriesEntry=stCategoriesEntry, stClientCount=stClientCount, trUser=trUser, stHttpsBytesFromClient=stHttpsBytesFromClient, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer)
