...
MibIdentifier, Unsigned32, Gauge32, IpAddress, mib_2, Counter64, NotificationType, TimeTicks, ObjectIdentity, NotificationType, Counter32, Bits, enterprises, iso, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Unsigned32", "Gauge32", "IpAddress", "mib-2", "Counter64", "NotificationType", "TimeTicks", "ObjectIdentity", "NotificationType", "Counter32", "Bits", "enterprises", "iso", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", notifyReason=notifyReason, stHttpBytesFromServer=stHttpBytesFromServer, stHttpBytesToClient=stHttpBytesToClient, stBadReputation=stBadReputation, stConnectionsLegitimate=stConnectionsLegitimate, stResolveHostViaDNS=stResolveHostViaDNS, mwgMiscellaneous=mwgMiscellaneous, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, stCategoriesTable=stCategoriesTable, stHttpsBytesFromClient=stHttpsBytesFromClient, mwgTrapVariables=mwgTrapVariables, stCategories=stCategories, stCategoriesEntry=stCategoriesEntry, stCPULoadRaw=stCPULoadRaw, trUser=trUser, notifyAdditional=notifyAdditional, stMalwareDetected=stMalwareDetected, pTSDBVersion=pTSDBVersion, stFtpBytesToServer=stFtpBytesToServer, kBuildNumber=kBuildNumber, stHttpsTraffic=stHttpsTraffic, mwgInfo=mwgInfo, stMimeType=stMimeType, stFtpTraffic=stFtpTraffic, kHotfixVersion=kHotfixVersion, mwgContent=mwgContent, mwgHttps=mwgHttps, stMemConsumed=stMemConsumed, stCategoryName=stCategoryName, kProductName=kProductName, pAMSignatureVersion=pAMSignatureVersion, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stBlockedByURLFilter=stBlockedByURLFilter, kCompanyName=kCompanyName, stClientCount=stClientCount, stTimeForTransaction=stTimeForTransaction, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stFtpBytesFromClient=stFtpBytesFromClient, notifyReasonString=notifyReasonString, kMicroVersion=kMicroVersion, mwgStatistics=mwgStatistics, stCPULoad=stCPULoad, pMFEDATVersion=pMFEDATVersion, mwgFTP=mwgFTP, kRevision=kRevision, mwgHttp=mwgHttp, mwgEngineVersions=mwgEngineVersions, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesToServer=stHttpsBytesToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPUIOWait=stCPUIOWait, stHttpBytesToServer=stHttpBytesToServer, mwg=mwg, stHttpsRequests=stHttpsRequests, pAMProactiveVersion=pAMProactiveVersion, trSystem=trSystem, trApplication=trApplication, stFtpBytesFromServer=stFtpBytesFromServer, stHttpsBytesToClient=stHttpsBytesToClient, stBlockedByMediaFilter=stBlockedByMediaFilter, pAMEngineVersion=pAMEngineVersion, stCategoryCount=stCategoryCount, kCustomVersion=kCustomVersion, kMajorVersion=kMajorVersion, stConnectedSockets=stConnectedSockets, kMinorVersion=kMinorVersion, PYSNMP_MODULE_ID=mwg, notifyOriginName=notifyOriginName, mwgTraps=mwgTraps, stFtpBytesToClient=stFtpBytesToClient, pMFEEngineVersion=pMFEEngineVersion, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, stBlockedByAntiMalware=stBlockedByAntiMalware, stConnectionsBlocked=stConnectionsBlocked, notifySeverity=notifySeverity, stHandleConnectToServer=stHandleConnectToServer, notifyAffectedHost=notifyAffectedHost, notifyOrigin=notifyOrigin, stHttpBytesFromClient=stHttpBytesFromClient, kProductVersion=kProductVersion, stHttpRequests=stHttpRequests, stHttpTraffic=stHttpTraffic)
