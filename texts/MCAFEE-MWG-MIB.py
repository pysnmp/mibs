...
enterprises, Gauge32, Counter32, TimeTicks, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, mib_2, iso, Integer32, NotificationType, Bits, NotificationType, ObjectIdentity, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "Counter32", "TimeTicks", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "mib-2", "iso", "Integer32", "NotificationType", "Bits", "NotificationType", "ObjectIdentity", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, PYSNMP_MODULE_ID=mwg, mwgContent=mwgContent, stConnectedSockets=stConnectedSockets, stHttpBytesToClient=stHttpBytesToClient, mwgTrapVariables=mwgTrapVariables, mwgStatistics=mwgStatistics, mwgTraps=mwgTraps, kProductName=kProductName, notifyAdditional=notifyAdditional, mwgMiscellaneous=mwgMiscellaneous, pMFEEngineVersion=pMFEEngineVersion, stFtpTraffic=stFtpTraffic, notifyReason=notifyReason, stHttpsBytesToServer=stHttpsBytesToServer, stConnectionsLegitimate=stConnectionsLegitimate, trApplication=trApplication, stHttpsTraffic=stHttpsTraffic, stCategoriesTable=stCategoriesTable, notifyOrigin=notifyOrigin, stCategoryName=stCategoryName, stLastSentLastReceivedServer=stLastSentLastReceivedServer, kMicroVersion=kMicroVersion, notifyAffectedHost=notifyAffectedHost, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, kCustomVersion=kCustomVersion, pAMSignatureVersion=pAMSignatureVersion, stCPULoad=stCPULoad, stCPUIOWait=stCPUIOWait, mwgHttp=mwgHttp, pAMProactiveVersion=pAMProactiveVersion, pMFEDATVersion=pMFEDATVersion, stFtpBytesFromClient=stFtpBytesFromClient, stHttpTraffic=stHttpTraffic, pAMEngineVersion=pAMEngineVersion, mwg=mwg, kCompanyName=kCompanyName, kRevision=kRevision, stHttpRequests=stHttpRequests, stHttpsBytesToClient=stHttpsBytesToClient, kProductVersion=kProductVersion, stCategories=stCategories, notifySeverity=notifySeverity, notifyOriginName=notifyOriginName, stBlockedByURLFilter=stBlockedByURLFilter, stHttpsBytesFromServer=stHttpsBytesFromServer, stTimeForTransaction=stTimeForTransaction, stFtpBytesToServer=stFtpBytesToServer, trUser=trUser, mwgFTP=mwgFTP, stClientCount=stClientCount, stMalwareDetected=stMalwareDetected, stCategoriesEntry=stCategoriesEntry, stResolveHostViaDNS=stResolveHostViaDNS, trSystem=trSystem, stBlockedByAntiMalware=stBlockedByAntiMalware, kMajorVersion=kMajorVersion, stCategoryCount=stCategoryCount, stFtpBytesToClient=stFtpBytesToClient, stBadReputation=stBadReputation, kBuildNumber=kBuildNumber, stMimeType=stMimeType, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, mwgInfo=mwgInfo, notifyReasonString=notifyReasonString, stHttpBytesToServer=stHttpBytesToServer, mwgEngineVersions=mwgEngineVersions, stHttpBytesFromClient=stHttpBytesFromClient, stCPULoadRaw=stCPULoadRaw, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpsBytesFromClient=stHttpsBytesFromClient, stFtpBytesFromServer=stFtpBytesFromServer, pTSDBVersion=pTSDBVersion, stConnectionsBlocked=stConnectionsBlocked, kMinorVersion=kMinorVersion, stHttpBytesFromServer=stHttpBytesFromServer, stHandleConnectToServer=stHandleConnectToServer, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stHttpsRequests=stHttpsRequests, stMemConsumed=stMemConsumed, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, mwgHttps=mwgHttps, kHotfixVersion=kHotfixVersion)
