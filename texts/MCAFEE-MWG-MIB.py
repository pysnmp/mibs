...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, NotificationType, mib_2, ModuleIdentity, Gauge32, Integer32, Counter64, IpAddress, enterprises, TimeTicks, MibIdentifier, Counter32, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "NotificationType", "mib-2", "ModuleIdentity", "Gauge32", "Integer32", "Counter64", "IpAddress", "enterprises", "TimeTicks", "MibIdentifier", "Counter32", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("MCAFEE-MWG-MIB", stCPUIOWait=stCPUIOWait, stHttpsBytesToClient=stHttpsBytesToClient, mwgInfo=mwgInfo, stHandleConnectToServer=stHandleConnectToServer, trUser=trUser, stFtpBytesToServer=stFtpBytesToServer, pAMEngineVersion=pAMEngineVersion, stCategoryCount=stCategoryCount, stFtpTraffic=stFtpTraffic, mwgMiscellaneous=mwgMiscellaneous, stCategoryName=stCategoryName, notifyOrigin=notifyOrigin, stHttpTraffic=stHttpTraffic, stFirstSentFirstReceivedClient=stFirstSentFirstReceivedClient, mwgEngineVersions=mwgEngineVersions, mwgTraps=mwgTraps, stConnectionsBlocked=stConnectionsBlocked, stHttpsBytesFromClient=stHttpsBytesFromClient, kMicroVersion=kMicroVersion, stHttpBytesToClient=stHttpBytesToClient, mwgHttp=mwgHttp, stHttpsRequests=stHttpsRequests, stFtpBytesToClient=stFtpBytesToClient, stHttpBytesFromServer=stHttpBytesFromServer, stHttpsBytesFromServer=stHttpsBytesFromServer, stCPULoad=stCPULoad, kCompanyName=kCompanyName, kBuildNumber=kBuildNumber, PYSNMP_MODULE_ID=mwg, notifyOriginName=notifyOriginName, stConnectionsLegitimate=stConnectionsLegitimate, stResolveHostViaDNS=stResolveHostViaDNS, stHttpsTraffic=stHttpsTraffic, notifySeverity=notifySeverity, pMFEEngineVersion=pMFEEngineVersion, kProductName=kProductName, stBlockedByMediaFilter=stBlockedByMediaFilter, stHttpBytesFromClient=stHttpBytesFromClient, mwgTrapVariables=mwgTrapVariables, pAMProactiveVersion=pAMProactiveVersion, mwgStatistics=mwgStatistics, stBlockedByAntiMalware=stBlockedByAntiMalware, stConnectedSockets=stConnectedSockets, mwgContent=mwgContent, stLastSentFirstReceivedServer=stLastSentFirstReceivedServer, trApplication=trApplication, pMFEDATVersion=pMFEDATVersion, stBadReputation=stBadReputation, stLastSentLastReceivedServer=stLastSentLastReceivedServer, stHttpsBytesToServer=stHttpsBytesToServer, mwg=mwg, stFtpBytesFromServer=stFtpBytesFromServer, notifyReason=notifyReason, kHotfixVersion=kHotfixVersion, mwgHttps=mwgHttps, notifyAdditional=notifyAdditional, stTimeForTransaction=stTimeForTransaction, kMajorVersion=kMajorVersion, stBlockedByURLFilter=stBlockedByURLFilter, stFirstSentFirstReceivedServer=stFirstSentFirstReceivedServer, stFtpBytesFromClient=stFtpBytesFromClient, stHttpRequests=stHttpRequests, pAMSignatureVersion=pAMSignatureVersion, kRevision=kRevision, stClientCount=stClientCount, stLastSentLastReceivedClient=stLastSentLastReceivedClient, stCategories=stCategories, stTimeConsumedByRuleEngine=stTimeConsumedByRuleEngine, stCPULoadRaw=stCPULoadRaw, kCustomVersion=kCustomVersion, stCategoriesEntry=stCategoriesEntry, kMinorVersion=kMinorVersion, stMimeType=stMimeType, notifyReasonString=notifyReasonString, trSystem=trSystem, stCategoriesTable=stCategoriesTable, mwgFTP=mwgFTP, pTSDBVersion=pTSDBVersion, stMalwareDetected=stMalwareDetected, notifyAffectedHost=notifyAffectedHost, stMemConsumed=stMemConsumed, kProductVersion=kProductVersion, stHttpBytesToServer=stHttpBytesToServer)
