...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, PYSNMP_MODULE_ID=dialControlMib, callHistoryGroup=callHistoryGroup, callHistoryEntry=callHistoryEntry, callHistory=callHistory, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, callActivePeerId=callActivePeerId, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callActivePeerIfIndex=callActivePeerIfIndex, callHistoryDisconnectTime=callHistoryDisconnectTime, callHistoryDisconnectCause=callHistoryDisconnectCause, callActiveInfoType=callActiveInfoType, dialControlMib=dialControlMib, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, callActiveCallState=callActiveCallState, callHistoryConnectTime=callHistoryConnectTime, callActiveSetupTime=callActiveSetupTime, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, callActiveReceiveBytes=callActiveReceiveBytes, callActiveTable=callActiveTable, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, dialControlMibObjects=dialControlMibObjects, dialCtlPeerCfgId=dialCtlPeerCfgId, callActiveCallOrigin=callActiveCallOrigin, dialControlMibCompliances=dialControlMibCompliances, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, callHistoryTableMaxLength=callHistoryTableMaxLength, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialControlMibTraps=dialControlMibTraps, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callActivePeerSubAddress=callActivePeerSubAddress, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callHistoryCallOrigin=callHistoryCallOrigin, callActiveChargedUnits=callActiveChargedUnits, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialControlMibGroups=dialControlMibGroups, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callActiveTransmitPackets=callActiveTransmitPackets, callActiveGroup=callActiveGroup, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callHistoryDisconnectText=callHistoryDisconnectText, dialCtlTrapEnable=dialCtlTrapEnable, callActiveIndex=callActiveIndex, callHistoryTransmitBytes=callHistoryTransmitBytes, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callActivePeerAddress=callActivePeerAddress, callActiveTransmitBytes=callActiveTransmitBytes, callActiveConnectTime=callActiveConnectTime, callHistoryReceivePackets=callHistoryReceivePackets, callHistoryInfoType=callHistoryInfoType, dialControlMibCompliance=dialControlMibCompliance, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, dialCtlPeer=dialCtlPeer, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialControlGroup=dialControlGroup, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, callActiveReceivePackets=callActiveReceivePackets, dialControlMibConformance=dialControlMibConformance, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callActive=callActive, callHistoryTransmitPackets=callHistoryTransmitPackets, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callHistoryTable=callHistoryTable, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, dialCtlAcceptMode=dialCtlAcceptMode, callHistoryPeerId=callHistoryPeerId, dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, callActiveEntry=callActiveEntry, callHistoryReceiveBytes=callHistoryReceiveBytes, callHistoryRetainTimer=callHistoryRetainTimer, AbsoluteCounter32=AbsoluteCounter32, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls)
