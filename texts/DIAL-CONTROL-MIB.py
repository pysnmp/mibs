...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callHistoryTable=callHistoryTable, callHistoryGroup=callHistoryGroup, callHistoryRetainTimer=callHistoryRetainTimer, callHistoryCallOrigin=callHistoryCallOrigin, dialCtlTrapEnable=dialCtlTrapEnable, callHistoryEntry=callHistoryEntry, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialCtlPeerCallSetup=dialCtlPeerCallSetup, callActiveTransmitPackets=callActiveTransmitPackets, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, PYSNMP_MODULE_ID=dialControlMib, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callHistoryDisconnectTime=callHistoryDisconnectTime, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, dialControlMibGroups=dialControlMibGroups, callActivePeerSubAddress=callActivePeerSubAddress, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, callActiveChargedUnits=callActiveChargedUnits, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callHistoryReceivePackets=callHistoryReceivePackets, callHistoryInfoType=callHistoryInfoType, callHistoryTransmitBytes=callHistoryTransmitBytes, callActiveReceivePackets=callActiveReceivePackets, callActiveTransmitBytes=callActiveTransmitBytes, callHistoryChargedUnits=callHistoryChargedUnits, callActiveConnectTime=callActiveConnectTime, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callActivePeerIfIndex=callActivePeerIfIndex, callHistoryReceiveBytes=callHistoryReceiveBytes, callActiveEntry=callActiveEntry, callActiveTable=callActiveTable, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, dialControlMibCompliances=dialControlMibCompliances, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, callActivePeerAddress=callActivePeerAddress, dialCtlPeerCallInformation=dialCtlPeerCallInformation, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, callActive=callActive, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, callActiveInfoType=callActiveInfoType, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callHistoryTableMaxLength=callHistoryTableMaxLength, dialControlMibTraps=dialControlMibTraps, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callHistoryDisconnectText=callHistoryDisconnectText, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callHistoryPeerId=callHistoryPeerId, callHistoryConnectTime=callHistoryConnectTime, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialControlMibCompliance=dialControlMibCompliance, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callHistoryTransmitPackets=callHistoryTransmitPackets, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, callActivePeerId=callActivePeerId, callActiveCallState=callActiveCallState, dialCtlPeer=dialCtlPeer, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callActiveIndex=callActiveIndex, dialControlMib=dialControlMib, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callActiveSetupTime=callActiveSetupTime, dialControlGroup=dialControlGroup, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialCtlAcceptMode=dialCtlAcceptMode, dialControlMibObjects=dialControlMibObjects, dialCtlConfiguration=dialCtlConfiguration, AbsoluteCounter32=AbsoluteCounter32, callActiveCallOrigin=callActiveCallOrigin, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callHistory=callHistory, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialCtlPeerCfgId=dialCtlPeerCfgId, dialControlMibConformance=dialControlMibConformance, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callActiveReceiveBytes=callActiveReceiveBytes, callActiveGroup=callActiveGroup, callHistoryDisconnectCause=callHistoryDisconnectCause)
