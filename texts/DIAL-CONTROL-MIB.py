...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", callHistoryDisconnectCause=callHistoryDisconnectCause, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callActivePeerSubAddress=callActivePeerSubAddress, dialCtlAcceptMode=dialCtlAcceptMode, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, PYSNMP_MODULE_ID=dialControlMib, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialControlMibGroups=dialControlMibGroups, callHistoryPeerAddress=callHistoryPeerAddress, callHistoryPeerId=callHistoryPeerId, dialControlGroup=dialControlGroup, callHistoryInfoType=callHistoryInfoType, callHistoryEntry=callHistoryEntry, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, dialControlMibCompliance=dialControlMibCompliance, callActive=callActive, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialCtlConfiguration=dialCtlConfiguration, callActivePeerAddress=callActivePeerAddress, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, callHistoryCallOrigin=callHistoryCallOrigin, callActiveConnectTime=callActiveConnectTime, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callActiveTable=callActiveTable, callHistoryDisconnectTime=callHistoryDisconnectTime, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, callHistoryTransmitPackets=callHistoryTransmitPackets, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callHistoryTable=callHistoryTable, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callHistoryTableMaxLength=callHistoryTableMaxLength, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, callActiveLogicalIfIndex=callActiveLogicalIfIndex, dialControlMib=dialControlMib, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, dialCtlPeerCallSetup=dialCtlPeerCallSetup, callHistoryConnectTime=callHistoryConnectTime, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callHistoryTransmitBytes=callHistoryTransmitBytes, dialControlMibObjects=dialControlMibObjects, AbsoluteCounter32=AbsoluteCounter32, dialControlMibTraps=dialControlMibTraps, callActiveSetupTime=callActiveSetupTime, callHistoryRetainTimer=callHistoryRetainTimer, dialCtlTrapEnable=dialCtlTrapEnable, callHistoryReceivePackets=callHistoryReceivePackets, callActiveCallState=callActiveCallState, callActiveEntry=callActiveEntry, callActiveCallOrigin=callActiveCallOrigin, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerCallInformation=dialCtlPeerCallInformation, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, callHistoryReceiveBytes=callHistoryReceiveBytes, callActiveIndex=callActiveIndex, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialCtlPeerCfgId=dialCtlPeerCfgId, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callActiveInfoType=callActiveInfoType, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, dialControlMibConformance=dialControlMibConformance, callActiveReceiveBytes=callActiveReceiveBytes, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, callHistoryPeerIfIndex=callHistoryPeerIfIndex, callActivePeerId=callActivePeerId, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callActiveGroup=callActiveGroup, callActivePeerIfIndex=callActivePeerIfIndex, dialCtlPeer=dialCtlPeer, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callActiveReceivePackets=callActiveReceivePackets, callActiveChargedUnits=callActiveChargedUnits, callHistory=callHistory, callActiveTransmitPackets=callActiveTransmitPackets, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callHistoryDisconnectText=callHistoryDisconnectText, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, dialControlMibCompliances=dialControlMibCompliances, callHistoryGroup=callHistoryGroup)
