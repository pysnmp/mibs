...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", callHistoryGroup=callHistoryGroup, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callActiveSetupTime=callActiveSetupTime, callHistoryInfoType=callHistoryInfoType, callHistoryDisconnectCause=callHistoryDisconnectCause, callActivePeerId=callActivePeerId, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, dialCtlPeer=dialCtlPeer, callHistoryTableMaxLength=callHistoryTableMaxLength, callActiveChargedUnits=callActiveChargedUnits, dialControlMibGroups=dialControlMibGroups, callHistoryDisconnectText=callHistoryDisconnectText, callHistoryTable=callHistoryTable, callActivePeerAddress=callActivePeerAddress, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, callHistoryReceivePackets=callHistoryReceivePackets, callHistoryChargedUnits=callHistoryChargedUnits, callActiveInfoType=callActiveInfoType, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialControlMib=dialControlMib, callActiveCallOrigin=callActiveCallOrigin, dialControlMibTraps=dialControlMibTraps, callHistoryTransmitBytes=callHistoryTransmitBytes, AbsoluteCounter32=AbsoluteCounter32, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callActiveReceiveBytes=callActiveReceiveBytes, dialCtlPeerCfgId=dialCtlPeerCfgId, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, PYSNMP_MODULE_ID=dialControlMib, dialControlMibCompliances=dialControlMibCompliances, callHistory=callHistory, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callActivePeerIfIndex=callActivePeerIfIndex, dialControlMibObjects=dialControlMibObjects, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlConfiguration=dialCtlConfiguration, dialCtlTrapEnable=dialCtlTrapEnable, dialControlGroup=dialControlGroup, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callActiveTransmitPackets=callActiveTransmitPackets, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialCtlPeerCfgTable=dialCtlPeerCfgTable, callActiveIndex=callActiveIndex, callHistoryCallOrigin=callHistoryCallOrigin, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, callHistoryReceiveBytes=callHistoryReceiveBytes, callActiveConnectTime=callActiveConnectTime, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callHistoryDisconnectTime=callHistoryDisconnectTime, callActiveReceivePackets=callActiveReceivePackets, callHistoryPeerId=callHistoryPeerId, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callHistoryRetainTimer=callHistoryRetainTimer, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callHistoryTransmitPackets=callHistoryTransmitPackets, callHistoryConnectTime=callHistoryConnectTime, callActive=callActive, callActiveEntry=callActiveEntry, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callActiveGroup=callActiveGroup, dialCtlAcceptMode=dialCtlAcceptMode, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callActiveCallState=callActiveCallState, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callActiveTable=callActiveTable, dialControlMibCompliance=dialControlMibCompliance, dialControlMibConformance=dialControlMibConformance, callHistoryEntry=callHistoryEntry, callActivePeerSubAddress=callActivePeerSubAddress)
