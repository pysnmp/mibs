...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialControlMibCompliances=dialControlMibCompliances, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, callActivePeerIfIndex=callActivePeerIfIndex, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callActivePeerSubAddress=callActivePeerSubAddress, callHistoryGroup=callHistoryGroup, dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, callActiveChargedUnits=callActiveChargedUnits, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callActiveIndex=callActiveIndex, dialControlMibConformance=dialControlMibConformance, callHistoryConnectTime=callHistoryConnectTime, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, callHistoryReceivePackets=callHistoryReceivePackets, callHistoryCallOrigin=callHistoryCallOrigin, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callHistoryTable=callHistoryTable, dialControlMibGroups=dialControlMibGroups, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, callActiveEntry=callActiveEntry, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, callActivePeerId=callActivePeerId, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callActiveTransmitPackets=callActiveTransmitPackets, callHistoryDisconnectTime=callHistoryDisconnectTime, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callActiveGroup=callActiveGroup, dialControlMib=dialControlMib, callHistoryTableMaxLength=callHistoryTableMaxLength, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, callActiveTable=callActiveTable, PYSNMP_MODULE_ID=dialControlMib, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, callActive=callActive, callActivePeerAddress=callActivePeerAddress, dialControlMibTraps=dialControlMibTraps, dialControlMibCompliance=dialControlMibCompliance, dialCtlPeerCfgTable=dialCtlPeerCfgTable, callActiveCallState=callActiveCallState, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialControlGroup=dialControlGroup, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialControlMibObjects=dialControlMibObjects, AbsoluteCounter32=AbsoluteCounter32, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeer=dialCtlPeer, callActiveInfoType=callActiveInfoType, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callActiveLogicalIfIndex=callActiveLogicalIfIndex, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, callHistoryRetainTimer=callHistoryRetainTimer, callHistoryEntry=callHistoryEntry, dialCtlPeerCfgId=dialCtlPeerCfgId, callActiveSetupTime=callActiveSetupTime, callHistoryDisconnectCause=callHistoryDisconnectCause, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callHistory=callHistory, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callHistoryTransmitPackets=callHistoryTransmitPackets, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, callActiveReceiveBytes=callActiveReceiveBytes, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callActiveConnectTime=callActiveConnectTime, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialCtlPeerCallSetup=dialCtlPeerCallSetup, callHistoryDisconnectText=callHistoryDisconnectText, dialCtlTrapEnable=dialCtlTrapEnable, callHistoryTransmitBytes=callHistoryTransmitBytes, callHistoryPeerId=callHistoryPeerId, callActiveReceivePackets=callActiveReceivePackets, callHistoryReceiveBytes=callHistoryReceiveBytes, callActiveCallOrigin=callActiveCallOrigin, dialCtlAcceptMode=dialCtlAcceptMode, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callHistoryInfoType=callHistoryInfoType, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls)
