...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", callActiveGroup=callActiveGroup, AbsoluteCounter32=AbsoluteCounter32, callActiveReceiveBytes=callActiveReceiveBytes, callHistoryTransmitPackets=callHistoryTransmitPackets, callActiveTransmitPackets=callActiveTransmitPackets, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, callActiveChargedUnits=callActiveChargedUnits, callActiveTable=callActiveTable, callHistoryDisconnectTime=callHistoryDisconnectTime, dialControlMibObjects=dialControlMibObjects, dialControlMibCompliances=dialControlMibCompliances, dialControlMibTraps=dialControlMibTraps, callHistoryInfoType=callHistoryInfoType, PYSNMP_MODULE_ID=dialControlMib, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, callActiveEntry=callActiveEntry, callActiveCallOrigin=callActiveCallOrigin, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, callHistoryRetainTimer=callHistoryRetainTimer, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialCtlAcceptMode=dialCtlAcceptMode, callHistoryReceivePackets=callHistoryReceivePackets, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callHistoryPeerIfIndex=callHistoryPeerIfIndex, callHistoryDisconnectCause=callHistoryDisconnectCause, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callHistoryPeerId=callHistoryPeerId, dialCtlPeerCfgId=dialCtlPeerCfgId, callHistoryConnectTime=callHistoryConnectTime, dialControlMib=dialControlMib, callHistoryEntry=callHistoryEntry, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callHistoryCallOrigin=callHistoryCallOrigin, callHistory=callHistory, callHistoryDisconnectText=callHistoryDisconnectText, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callHistoryTableMaxLength=callHistoryTableMaxLength, callActiveInfoType=callActiveInfoType, dialCtlPeerStatsTable=dialCtlPeerStatsTable, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, dialControlMibCompliance=dialControlMibCompliance, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialCtlTrapEnable=dialCtlTrapEnable, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callActivePeerIfIndex=callActivePeerIfIndex, dialControlGroup=dialControlGroup, callActiveSetupTime=callActiveSetupTime, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callActiveLogicalIfIndex=callActiveLogicalIfIndex, dialControlMibConformance=dialControlMibConformance, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, callActiveIndex=callActiveIndex, dialControlMibGroups=dialControlMibGroups, callHistoryTable=callHistoryTable, callHistoryGroup=callHistoryGroup, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, callActiveCallState=callActiveCallState, callActivePeerId=callActivePeerId, callActive=callActive, callHistoryTransmitBytes=callHistoryTransmitBytes, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callHistoryReceiveBytes=callHistoryReceiveBytes, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, callActivePeerAddress=callActivePeerAddress, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callActiveTransmitBytes=callActiveTransmitBytes, callActivePeerSubAddress=callActivePeerSubAddress, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, callActiveReceivePackets=callActiveReceivePackets, dialCtlPeer=dialCtlPeer, callActiveConnectTime=callActiveConnectTime, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime)
