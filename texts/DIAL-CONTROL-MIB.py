...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, callHistoryConnectTime=callHistoryConnectTime, callHistoryCallOrigin=callHistoryCallOrigin, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialControlGroup=dialControlGroup, callActiveCallOrigin=callActiveCallOrigin, callActiveEntry=callActiveEntry, callHistoryPeerId=callHistoryPeerId, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callHistoryDisconnectCause=callHistoryDisconnectCause, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, callActiveIndex=callActiveIndex, dialControlMib=dialControlMib, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, callActiveSetupTime=callActiveSetupTime, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callActiveChargedUnits=callActiveChargedUnits, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callActiveTransmitBytes=callActiveTransmitBytes, callHistoryGroup=callHistoryGroup, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callHistoryReceiveBytes=callHistoryReceiveBytes, dialCtlTrapEnable=dialCtlTrapEnable, callActiveInfoType=callActiveInfoType, callHistoryInfoType=callHistoryInfoType, callActivePeerSubAddress=callActivePeerSubAddress, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callActivePeerIfIndex=callActivePeerIfIndex, AbsoluteCounter32=AbsoluteCounter32, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialCtlPeerCfgId=dialCtlPeerCfgId, callHistoryDisconnectText=callHistoryDisconnectText, callActiveCallState=callActiveCallState, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialCtlAcceptMode=dialCtlAcceptMode, callHistoryPeerAddress=callHistoryPeerAddress, dialControlMibConformance=dialControlMibConformance, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, callHistoryDisconnectTime=callHistoryDisconnectTime, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialControlMibCompliance=dialControlMibCompliance, callActivePeerAddress=callActivePeerAddress, callHistoryReceivePackets=callHistoryReceivePackets, dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, PYSNMP_MODULE_ID=dialControlMib, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, callActiveTable=callActiveTable, dialControlMibGroups=dialControlMibGroups, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callHistoryTransmitBytes=callHistoryTransmitBytes, callActiveTransmitPackets=callActiveTransmitPackets, callHistoryPeerIfIndex=callHistoryPeerIfIndex, callHistoryTransmitPackets=callHistoryTransmitPackets, callHistoryEntry=callHistoryEntry, dialControlMibObjects=dialControlMibObjects, dialControlMibTraps=dialControlMibTraps, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callActivePeerId=callActivePeerId, callHistory=callHistory, callActiveReceivePackets=callActiveReceivePackets, dialControlMibTrapPrefix=dialControlMibTrapPrefix, callActiveReceiveBytes=callActiveReceiveBytes, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialControlMibCompliances=dialControlMibCompliances, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, callHistoryTableMaxLength=callHistoryTableMaxLength, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerCallInformation=dialCtlPeerCallInformation, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, callHistoryTable=callHistoryTable, callHistoryRetainTimer=callHistoryRetainTimer, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, callActiveGroup=callActiveGroup, dialCtlPeer=dialCtlPeer, callActive=callActive, callActiveConnectTime=callActiveConnectTime)
