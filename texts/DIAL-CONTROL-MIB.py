...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callHistoryTransmitBytes=callHistoryTransmitBytes, dialControlMibTraps=dialControlMibTraps, callHistoryConnectTime=callHistoryConnectTime, dialCtlPeer=dialCtlPeer, dialControlMibConformance=dialControlMibConformance, AbsoluteCounter32=AbsoluteCounter32, callActiveInfoType=callActiveInfoType, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, callHistoryDisconnectText=callHistoryDisconnectText, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialCtlPeerCallInformation=dialCtlPeerCallInformation, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, callHistoryPeerId=callHistoryPeerId, callActiveChargedUnits=callActiveChargedUnits, callActiveReceivePackets=callActiveReceivePackets, dialControlMibCompliance=dialControlMibCompliance, callActiveTable=callActiveTable, callHistoryGroup=callHistoryGroup, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, callActiveEntry=callActiveEntry, callHistoryReceivePackets=callHistoryReceivePackets, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callActiveTransmitPackets=callActiveTransmitPackets, callHistoryCallOrigin=callHistoryCallOrigin, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callHistoryReceiveBytes=callHistoryReceiveBytes, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, PYSNMP_MODULE_ID=dialControlMib, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialControlMib=dialControlMib, callHistoryDisconnectTime=callHistoryDisconnectTime, callHistory=callHistory, callActiveCallState=callActiveCallState, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callActivePeerAddress=callActivePeerAddress, dialCtlConfiguration=dialCtlConfiguration, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callActive=callActive, callActiveGroup=callActiveGroup, callActiveCallOrigin=callActiveCallOrigin, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlTrapEnable=dialCtlTrapEnable, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialCtlPeerCfgId=dialCtlPeerCfgId, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialControlMibCompliances=dialControlMibCompliances, callHistoryTableMaxLength=callHistoryTableMaxLength, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callHistoryEntry=callHistoryEntry, callActiveReceiveBytes=callActiveReceiveBytes, dialCtlAcceptMode=dialCtlAcceptMode, callHistoryRetainTimer=callHistoryRetainTimer, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callHistoryPeerAddress=callHistoryPeerAddress, callActivePeerSubAddress=callActivePeerSubAddress, dialControlMibObjects=dialControlMibObjects, callActiveConnectTime=callActiveConnectTime, callHistoryTransmitPackets=callHistoryTransmitPackets, callHistoryDisconnectCause=callHistoryDisconnectCause, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callHistoryInfoType=callHistoryInfoType, dialControlGroup=dialControlGroup, callHistoryChargedUnits=callHistoryChargedUnits, callActiveLogicalIfIndex=callActiveLogicalIfIndex, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callHistoryTable=callHistoryTable, dialControlMibGroups=dialControlMibGroups, callActiveIndex=callActiveIndex, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callActivePeerIfIndex=callActivePeerIfIndex, callActivePeerId=callActivePeerId, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, callActiveSetupTime=callActiveSetupTime, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType)
