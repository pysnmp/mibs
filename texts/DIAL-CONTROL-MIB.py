...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", callHistoryRetainTimer=callHistoryRetainTimer, dialControlMibConformance=dialControlMibConformance, dialCtlTrapEnable=dialCtlTrapEnable, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callActiveChargedUnits=callActiveChargedUnits, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, dialCtlAcceptMode=dialCtlAcceptMode, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, callActiveEntry=callActiveEntry, AbsoluteCounter32=AbsoluteCounter32, callHistoryReceiveBytes=callHistoryReceiveBytes, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callActiveConnectTime=callActiveConnectTime, dialControlMibTrapPrefix=dialControlMibTrapPrefix, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callHistory=callHistory, dialControlMib=dialControlMib, callActiveTable=callActiveTable, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callActivePeerSubAddress=callActivePeerSubAddress, callHistoryDisconnectText=callHistoryDisconnectText, callHistoryDisconnectTime=callHistoryDisconnectTime, callHistoryCallOrigin=callHistoryCallOrigin, callHistoryInfoType=callHistoryInfoType, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialControlMibObjects=dialControlMibObjects, callHistoryConnectTime=callHistoryConnectTime, callHistoryTable=callHistoryTable, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialControlGroup=dialControlGroup, callActiveIndex=callActiveIndex, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialCtlPeerCfgId=dialCtlPeerCfgId, callActiveInfoType=callActiveInfoType, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callActiveReceivePackets=callActiveReceivePackets, dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, callActiveGroup=callActiveGroup, dialControlMibCompliances=dialControlMibCompliances, callActiveCallOrigin=callActiveCallOrigin, callActivePeerIfIndex=callActivePeerIfIndex, callHistoryTransmitPackets=callHistoryTransmitPackets, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, callActiveTransmitPackets=callActiveTransmitPackets, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialControlMibGroups=dialControlMibGroups, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callHistoryTransmitBytes=callHistoryTransmitBytes, callHistoryEntry=callHistoryEntry, callActiveCallState=callActiveCallState, callActiveTransmitBytes=callActiveTransmitBytes, callHistoryPeerId=callHistoryPeerId, callActivePeerId=callActivePeerId, PYSNMP_MODULE_ID=dialControlMib, callHistoryReceivePackets=callHistoryReceivePackets, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialControlMibTraps=dialControlMibTraps, callActivePeerAddress=callActivePeerAddress, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callHistoryGroup=callHistoryGroup, dialCtlPeerCfgTable=dialCtlPeerCfgTable, callHistoryTableMaxLength=callHistoryTableMaxLength, dialCtlPeer=dialCtlPeer, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialControlMibCompliance=dialControlMibCompliance, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callActive=callActive, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, callActiveSetupTime=callActiveSetupTime, callActiveReceiveBytes=callActiveReceiveBytes, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callHistoryDisconnectCause=callHistoryDisconnectCause)
