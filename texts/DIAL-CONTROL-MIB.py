...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, dialCtlConfiguration=dialCtlConfiguration, callActivePeerId=callActivePeerId, callHistoryDisconnectCause=callHistoryDisconnectCause, callHistoryDisconnectText=callHistoryDisconnectText, callHistoryPeerId=callHistoryPeerId, dialCtlPeerCallSetup=dialCtlPeerCallSetup, callHistoryEntry=callHistoryEntry, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, dialControlMibCompliance=dialControlMibCompliance, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlPeerCfgTable=dialCtlPeerCfgTable, callActiveTransmitPackets=callActiveTransmitPackets, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, callActiveEntry=callActiveEntry, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callActiveIndex=callActiveIndex, callActiveSetupTime=callActiveSetupTime, callActivePeerSubAddress=callActivePeerSubAddress, callHistoryRetainTimer=callHistoryRetainTimer, callHistoryPeerAddress=callHistoryPeerAddress, callHistoryReceivePackets=callHistoryReceivePackets, callHistoryInfoType=callHistoryInfoType, dialControlMibTraps=dialControlMibTraps, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerCallInformation=dialCtlPeerCallInformation, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, dialControlGroup=dialControlGroup, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callActiveTable=callActiveTable, callHistoryTableMaxLength=callHistoryTableMaxLength, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, AbsoluteCounter32=AbsoluteCounter32, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callHistoryGroup=callHistoryGroup, callActiveConnectTime=callActiveConnectTime, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, dialControlMibCompliances=dialControlMibCompliances, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialCtlPeerCfgId=dialCtlPeerCfgId, callActiveChargedUnits=callActiveChargedUnits, dialControlMibGroups=dialControlMibGroups, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, dialControlMibConformance=dialControlMibConformance, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, callActive=callActive, callActiveCallOrigin=callActiveCallOrigin, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialCtlAcceptMode=dialCtlAcceptMode, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, callHistory=callHistory, dialControlMib=dialControlMib, callHistoryTable=callHistoryTable, callHistoryDisconnectTime=callHistoryDisconnectTime, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, callHistoryCallOrigin=callHistoryCallOrigin, dialCtlPeer=dialCtlPeer, callHistoryTransmitPackets=callHistoryTransmitPackets, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialCtlTrapEnable=dialCtlTrapEnable, callActiveCallState=callActiveCallState, callActiveInfoType=callActiveInfoType, dialControlMibObjects=dialControlMibObjects, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, callActiveTransmitBytes=callActiveTransmitBytes, callActiveReceivePackets=callActiveReceivePackets, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, PYSNMP_MODULE_ID=dialControlMib, callHistoryTransmitBytes=callHistoryTransmitBytes, callHistoryConnectTime=callHistoryConnectTime, callHistoryChargedUnits=callHistoryChargedUnits, callActivePeerIfIndex=callActivePeerIfIndex, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callHistoryReceiveBytes=callHistoryReceiveBytes, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callActiveGroup=callActiveGroup, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, callActiveReceiveBytes=callActiveReceiveBytes, callActivePeerAddress=callActivePeerAddress, dialCtlPeerStatsTable=dialCtlPeerStatsTable)
