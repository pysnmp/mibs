...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", callActive=callActive, callActiveTransmitBytes=callActiveTransmitBytes, callHistoryReceiveBytes=callHistoryReceiveBytes, callActiveCallOrigin=callActiveCallOrigin, dialCtlPeerCfgId=dialCtlPeerCfgId, callHistoryCallOrigin=callHistoryCallOrigin, callActivePeerIfIndex=callActivePeerIfIndex, dialCtlAcceptMode=dialCtlAcceptMode, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialCtlTrapEnable=dialCtlTrapEnable, callHistoryGroup=callHistoryGroup, callActiveConnectTime=callActiveConnectTime, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callActiveReceivePackets=callActiveReceivePackets, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, dialControlMibCompliances=dialControlMibCompliances, callHistoryReceivePackets=callHistoryReceivePackets, callHistoryDisconnectCause=callHistoryDisconnectCause, callHistoryConnectTime=callHistoryConnectTime, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callActivePeerAddress=callActivePeerAddress, callHistoryTransmitPackets=callHistoryTransmitPackets, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callActivePeerSubAddress=callActivePeerSubAddress, callActiveInfoType=callActiveInfoType, callActiveTransmitPackets=callActiveTransmitPackets, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialControlMibConformance=dialControlMibConformance, callActiveChargedUnits=callActiveChargedUnits, callActiveTable=callActiveTable, callHistory=callHistory, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callHistoryPeerId=callHistoryPeerId, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callActiveSetupTime=callActiveSetupTime, PYSNMP_MODULE_ID=dialControlMib, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callActiveIndex=callActiveIndex, callHistoryDisconnectText=callHistoryDisconnectText, callActivePeerId=callActivePeerId, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callHistoryRetainTimer=callHistoryRetainTimer, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callActiveEntry=callActiveEntry, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialControlMib=dialControlMib, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialControlMibGroups=dialControlMibGroups, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callHistoryDisconnectTime=callHistoryDisconnectTime, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, callHistoryTable=callHistoryTable, callHistoryEntry=callHistoryEntry, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, callHistoryChargedUnits=callHistoryChargedUnits, callHistoryInfoType=callHistoryInfoType, dialControlGroup=dialControlGroup, dialControlMibTraps=dialControlMibTraps, callHistoryTableMaxLength=callHistoryTableMaxLength, AbsoluteCounter32=AbsoluteCounter32, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, dialControlMibCompliance=dialControlMibCompliance, dialCtlPeer=dialCtlPeer, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, callActiveCallState=callActiveCallState, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callHistoryTransmitBytes=callHistoryTransmitBytes, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, callActiveGroup=callActiveGroup, callActiveReceiveBytes=callActiveReceiveBytes, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialControlMibObjects=dialControlMibObjects, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls)
