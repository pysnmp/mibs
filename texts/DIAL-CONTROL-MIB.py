...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlAcceptMode=dialCtlAcceptMode, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, callActive=callActive, callActiveTransmitPackets=callActiveTransmitPackets, PYSNMP_MODULE_ID=dialControlMib, callHistoryEntry=callHistoryEntry, callActivePeerAddress=callActivePeerAddress, callActivePeerSubAddress=callActivePeerSubAddress, callHistoryRetainTimer=callHistoryRetainTimer, callHistoryDisconnectText=callHistoryDisconnectText, dialControlMibConformance=dialControlMibConformance, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, dialCtlPeerStatsTable=dialCtlPeerStatsTable, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callActiveReceivePackets=callActiveReceivePackets, callHistoryReceiveBytes=callHistoryReceiveBytes, callActiveReceiveBytes=callActiveReceiveBytes, callHistoryConnectTime=callHistoryConnectTime, callActivePeerId=callActivePeerId, callActiveCallOrigin=callActiveCallOrigin, callActiveEntry=callActiveEntry, callHistoryPeerId=callHistoryPeerId, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callHistory=callHistory, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, callHistoryDisconnectCause=callHistoryDisconnectCause, callHistoryInfoType=callHistoryInfoType, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callActiveSetupTime=callActiveSetupTime, dialControlMibObjects=dialControlMibObjects, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialControlMibGroups=dialControlMibGroups, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, callActivePeerIfIndex=callActivePeerIfIndex, callActiveTable=callActiveTable, callActiveConnectTime=callActiveConnectTime, callHistoryGroup=callHistoryGroup, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callHistoryPeerIfIndex=callHistoryPeerIfIndex, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callHistoryTableMaxLength=callHistoryTableMaxLength, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, callActiveLogicalIfIndex=callActiveLogicalIfIndex, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, callHistoryDisconnectTime=callHistoryDisconnectTime, dialCtlConfiguration=dialCtlConfiguration, dialCtlTrapEnable=dialCtlTrapEnable, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callActiveCallState=callActiveCallState, dialCtlPeer=dialCtlPeer, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, callHistoryReceivePackets=callHistoryReceivePackets, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, dialControlMib=dialControlMib, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, callHistoryCallOrigin=callHistoryCallOrigin, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, dialCtlPeerCfgId=dialCtlPeerCfgId, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, callActiveIndex=callActiveIndex, callActiveGroup=callActiveGroup, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, callHistoryTransmitBytes=callHistoryTransmitBytes, callHistoryTransmitPackets=callHistoryTransmitPackets, dialControlGroup=dialControlGroup, dialControlMibCompliances=dialControlMibCompliances, dialControlMibCompliance=dialControlMibCompliance, dialControlMibTraps=dialControlMibTraps, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, AbsoluteCounter32=AbsoluteCounter32, callHistoryTable=callHistoryTable, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, callActiveChargedUnits=callActiveChargedUnits, callActiveTransmitBytes=callActiveTransmitBytes, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, callActiveInfoType=callActiveInfoType)
