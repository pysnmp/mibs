...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callActivePeerAddress=callActivePeerAddress, dialCtlPeerStatsTable=dialCtlPeerStatsTable, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callActiveReceiveBytes=callActiveReceiveBytes, callHistoryTable=callHistoryTable, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, callActivePeerId=callActivePeerId, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callHistoryTransmitPackets=callHistoryTransmitPackets, callActive=callActive, callActiveSetupTime=callActiveSetupTime, dialControlMib=dialControlMib, callHistoryEntry=callHistoryEntry, dialCtlPeer=dialCtlPeer, callActiveTransmitPackets=callActiveTransmitPackets, callHistory=callHistory, dialCtlPeerCallInformation=dialCtlPeerCallInformation, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callHistoryTableMaxLength=callHistoryTableMaxLength, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, PYSNMP_MODULE_ID=dialControlMib, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialCtlTrapEnable=dialCtlTrapEnable, dialCtlAcceptMode=dialCtlAcceptMode, dialControlMibCompliance=dialControlMibCompliance, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, AbsoluteCounter32=AbsoluteCounter32, callHistoryGroup=callHistoryGroup, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialControlMibTraps=dialControlMibTraps, dialCtlConfiguration=dialCtlConfiguration, callHistoryRetainTimer=callHistoryRetainTimer, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callActivePeerIfIndex=callActivePeerIfIndex, dialControlMibCompliances=dialControlMibCompliances, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, dialControlMibTrapPrefix=dialControlMibTrapPrefix, callActiveCallOrigin=callActiveCallOrigin, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, dialCtlPeerCallSetup=dialCtlPeerCallSetup, callActiveTable=callActiveTable, callHistoryReceiveBytes=callHistoryReceiveBytes, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialControlGroup=dialControlGroup, callActiveGroup=callActiveGroup, callActiveEntry=callActiveEntry, callHistoryTransmitBytes=callHistoryTransmitBytes, callHistoryCallOrigin=callHistoryCallOrigin, dialCtlPeerCfgId=dialCtlPeerCfgId, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callHistoryPeerIfIndex=callHistoryPeerIfIndex, callActiveIndex=callActiveIndex, callActiveConnectTime=callActiveConnectTime, callHistoryReceivePackets=callHistoryReceivePackets, callActiveReceivePackets=callActiveReceivePackets, callActivePeerSubAddress=callActivePeerSubAddress, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callHistoryDisconnectCause=callHistoryDisconnectCause, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialControlMibGroups=dialControlMibGroups, callHistoryDisconnectText=callHistoryDisconnectText, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, callActiveCallState=callActiveCallState, callHistoryDisconnectTime=callHistoryDisconnectTime, dialControlMibObjects=dialControlMibObjects, callHistoryInfoType=callHistoryInfoType, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callActiveChargedUnits=callActiveChargedUnits, dialControlMibConformance=dialControlMibConformance, callHistoryPeerAddress=callHistoryPeerAddress, callActiveInfoType=callActiveInfoType, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callHistoryConnectTime=callHistoryConnectTime, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callHistoryPeerId=callHistoryPeerId)
