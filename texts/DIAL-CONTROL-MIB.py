...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callHistoryInfoType=callHistoryInfoType, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, dialCtlPeer=dialCtlPeer, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callHistoryEntry=callHistoryEntry, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callHistoryPeerId=callHistoryPeerId, dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callHistoryTransmitPackets=callHistoryTransmitPackets, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, callHistoryTableMaxLength=callHistoryTableMaxLength, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callHistoryCallOrigin=callHistoryCallOrigin, callActiveSetupTime=callActiveSetupTime, callActiveEntry=callActiveEntry, callActiveCallState=callActiveCallState, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, dialCtlPeerCallInformation=dialCtlPeerCallInformation, dialCtlTrapEnable=dialCtlTrapEnable, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callActiveReceiveBytes=callActiveReceiveBytes, dialControlMib=dialControlMib, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialControlMibObjects=dialControlMibObjects, callActive=callActive, callActiveCallOrigin=callActiveCallOrigin, callActiveTable=callActiveTable, dialControlMibCompliances=dialControlMibCompliances, callHistoryGroup=callHistoryGroup, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callHistory=callHistory, dialControlMibCompliance=dialControlMibCompliance, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, dialControlMibGroups=dialControlMibGroups, callActivePeerSubAddress=callActivePeerSubAddress, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, callActiveConnectTime=callActiveConnectTime, callActiveIndex=callActiveIndex, dialCtlPeerCfgId=dialCtlPeerCfgId, callHistoryReceivePackets=callHistoryReceivePackets, PYSNMP_MODULE_ID=dialControlMib, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callActivePeerId=callActivePeerId, AbsoluteCounter32=AbsoluteCounter32, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callHistoryPeerIfIndex=callHistoryPeerIfIndex, callHistoryTransmitBytes=callHistoryTransmitBytes, dialControlMibTraps=dialControlMibTraps, callActiveTransmitPackets=callActiveTransmitPackets, callActiveInfoType=callActiveInfoType, callHistoryConnectTime=callHistoryConnectTime, callHistoryRetainTimer=callHistoryRetainTimer, callActiveChargedUnits=callActiveChargedUnits, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callHistoryDisconnectTime=callHistoryDisconnectTime, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callActivePeerIfIndex=callActivePeerIfIndex, callActiveGroup=callActiveGroup, callActiveReceivePackets=callActiveReceivePackets, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, dialCtlAcceptMode=dialCtlAcceptMode, dialControlMibConformance=dialControlMibConformance, callHistoryReceiveBytes=callHistoryReceiveBytes, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, callHistoryTable=callHistoryTable, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callHistoryDisconnectText=callHistoryDisconnectText, callHistoryChargedUnits=callHistoryChargedUnits, callHistoryDisconnectCause=callHistoryDisconnectCause, dialControlGroup=dialControlGroup, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callActivePeerAddress=callActivePeerAddress)
