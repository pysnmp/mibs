...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, dialCtlTrapEnable=dialCtlTrapEnable, callHistoryDisconnectCause=callHistoryDisconnectCause, callActiveInfoType=callActiveInfoType, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, callHistoryEntry=callHistoryEntry, callActiveSetupTime=callActiveSetupTime, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, dialCtlPeer=dialCtlPeer, dialControlMibCompliances=dialControlMibCompliances, callHistoryCallOrigin=callHistoryCallOrigin, callActiveCallState=callActiveCallState, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callHistoryPeerIfIndex=callHistoryPeerIfIndex, callActiveReceivePackets=callActiveReceivePackets, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, callHistory=callHistory, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callHistoryGroup=callHistoryGroup, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialControlMibTraps=dialControlMibTraps, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, AbsoluteCounter32=AbsoluteCounter32, callActiveConnectTime=callActiveConnectTime, dialCtlPeerCfgTable=dialCtlPeerCfgTable, PYSNMP_MODULE_ID=dialControlMib, callActiveTransmitPackets=callActiveTransmitPackets, dialControlMibObjects=dialControlMibObjects, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callHistoryChargedUnits=callHistoryChargedUnits, callHistoryInfoType=callHistoryInfoType, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, dialCtlPeerCfgId=dialCtlPeerCfgId, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, callActiveTable=callActiveTable, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callActivePeerIfIndex=callActivePeerIfIndex, callActiveEntry=callActiveEntry, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialControlGroup=dialControlGroup, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callActiveGroup=callActiveGroup, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, callHistoryReceivePackets=callHistoryReceivePackets, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callHistoryTransmitPackets=callHistoryTransmitPackets, callActivePeerSubAddress=callActivePeerSubAddress, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callActiveCallOrigin=callActiveCallOrigin, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, callHistoryReceiveBytes=callHistoryReceiveBytes, dialControlMibCompliance=dialControlMibCompliance, dialCtlConfiguration=dialCtlConfiguration, callHistoryTable=callHistoryTable, dialControlMibConformance=dialControlMibConformance, callHistoryTableMaxLength=callHistoryTableMaxLength, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, callActiveChargedUnits=callActiveChargedUnits, callActivePeerAddress=callActivePeerAddress, callHistoryPeerId=callHistoryPeerId, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, dialCtlAcceptMode=dialCtlAcceptMode, dialControlMibGroups=dialControlMibGroups, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, callHistoryDisconnectText=callHistoryDisconnectText, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callHistoryPeerAddress=callHistoryPeerAddress, dialControlMib=dialControlMib, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, callHistoryTransmitBytes=callHistoryTransmitBytes, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callActive=callActive, callHistoryDisconnectTime=callHistoryDisconnectTime, callActiveReceiveBytes=callActiveReceiveBytes, callHistoryConnectTime=callHistoryConnectTime, callActivePeerId=callActivePeerId, callActiveIndex=callActiveIndex, dialControlMibTrapPrefix=dialControlMibTrapPrefix, callHistoryRetainTimer=callHistoryRetainTimer)
