...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", PYSNMP_MODULE_ID=dialControlMib, callHistory=callHistory, callHistoryGroup=callHistoryGroup, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callHistoryRetainTimer=callHistoryRetainTimer, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callHistoryReceivePackets=callHistoryReceivePackets, callActiveLogicalIfIndex=callActiveLogicalIfIndex, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, dialCtlAcceptMode=dialCtlAcceptMode, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, callActivePeerAddress=callActivePeerAddress, dialControlMibObjects=dialControlMibObjects, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, callHistoryTableMaxLength=callHistoryTableMaxLength, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, callHistoryChargedUnits=callHistoryChargedUnits, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialControlMibCompliance=dialControlMibCompliance, callActiveIndex=callActiveIndex, callActiveGroup=callActiveGroup, dialControlMibCompliances=dialControlMibCompliances, callHistoryTransmitBytes=callHistoryTransmitBytes, callActiveCallOrigin=callActiveCallOrigin, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callActivePeerId=callActivePeerId, callActivePeerIfIndex=callActivePeerIfIndex, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, callHistoryDisconnectText=callHistoryDisconnectText, callHistoryConnectTime=callHistoryConnectTime, callActiveEntry=callActiveEntry, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, dialControlMib=dialControlMib, callActiveReceivePackets=callActiveReceivePackets, callActiveCallState=callActiveCallState, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callActivePeerSubAddress=callActivePeerSubAddress, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callActiveTransmitBytes=callActiveTransmitBytes, callActiveConnectTime=callActiveConnectTime, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, callHistoryReceiveBytes=callHistoryReceiveBytes, callActiveInfoType=callActiveInfoType, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callHistoryDisconnectCause=callHistoryDisconnectCause, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, callActiveChargedUnits=callActiveChargedUnits, dialControlMibConformance=dialControlMibConformance, AbsoluteCounter32=AbsoluteCounter32, callHistoryCallOrigin=callHistoryCallOrigin, callActive=callActive, dialControlMibGroups=dialControlMibGroups, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeer=dialCtlPeer, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialControlMibTraps=dialControlMibTraps, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callActiveSetupTime=callActiveSetupTime, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, callActiveReceiveBytes=callActiveReceiveBytes, callActiveTransmitPackets=callActiveTransmitPackets, dialCtlTrapEnable=dialCtlTrapEnable, dialControlGroup=dialControlGroup, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, callHistoryDisconnectTime=callHistoryDisconnectTime, callHistoryEntry=callHistoryEntry, callHistoryInfoType=callHistoryInfoType, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerCfgId=dialCtlPeerCfgId, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callActiveTable=callActiveTable, callHistoryTransmitPackets=callHistoryTransmitPackets, callHistoryPeerId=callHistoryPeerId, dialCtlPeerCallSetup=dialCtlPeerCallSetup, callHistoryTable=callHistoryTable)
