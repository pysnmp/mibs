...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, callHistoryReceiveBytes=callHistoryReceiveBytes, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, callActiveTransmitBytes=callActiveTransmitBytes, callHistoryDisconnectText=callHistoryDisconnectText, callHistoryCallOrigin=callHistoryCallOrigin, dialControlMibTraps=dialControlMibTraps, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callHistoryConnectTime=callHistoryConnectTime, callActivePeerAddress=callActivePeerAddress, callHistoryDisconnectCause=callHistoryDisconnectCause, callActivePeerId=callActivePeerId, callHistoryRetainTimer=callHistoryRetainTimer, callHistory=callHistory, dialCtlPeer=dialCtlPeer, dialCtlPeerCfgTable=dialCtlPeerCfgTable, callHistoryPeerId=callHistoryPeerId, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callActiveConnectTime=callActiveConnectTime, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, callHistoryInfoType=callHistoryInfoType, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, callHistoryGroup=callHistoryGroup, callActiveReceivePackets=callActiveReceivePackets, callActiveSetupTime=callActiveSetupTime, dialControlMib=dialControlMib, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, callActive=callActive, callHistoryReceivePackets=callHistoryReceivePackets, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, callActiveInfoType=callActiveInfoType, dialCtlTrapEnable=dialCtlTrapEnable, callHistoryDisconnectTime=callHistoryDisconnectTime, callHistoryTable=callHistoryTable, dialControlMibCompliance=dialControlMibCompliance, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialCtlConfiguration=dialCtlConfiguration, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callActiveGroup=callActiveGroup, dialCtlAcceptMode=dialCtlAcceptMode, callHistoryPeerAddress=callHistoryPeerAddress, callActivePeerSubAddress=callActivePeerSubAddress, dialControlMibObjects=dialControlMibObjects, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, callActiveCallOrigin=callActiveCallOrigin, callActiveIndex=callActiveIndex, callHistoryTransmitPackets=callHistoryTransmitPackets, callActiveLogicalIfIndex=callActiveLogicalIfIndex, PYSNMP_MODULE_ID=dialControlMib, callHistoryEntry=callHistoryEntry, dialControlMibGroups=dialControlMibGroups, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, dialControlMibConformance=dialControlMibConformance, dialCtlPeerStatsTable=dialCtlPeerStatsTable, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, callActiveCallState=callActiveCallState, callActiveReceiveBytes=callActiveReceiveBytes, dialControlGroup=dialControlGroup, callActiveEntry=callActiveEntry, callActiveChargedUnits=callActiveChargedUnits, dialControlMibCompliances=dialControlMibCompliances, callActivePeerIfIndex=callActivePeerIfIndex, dialCtlPeerCallInformation=dialCtlPeerCallInformation, AbsoluteCounter32=AbsoluteCounter32, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callActiveTransmitPackets=callActiveTransmitPackets, callHistoryTableMaxLength=callHistoryTableMaxLength, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callActiveTable=callActiveTable, callHistoryTransmitBytes=callHistoryTransmitBytes, dialCtlPeerCfgId=dialCtlPeerCfgId)
