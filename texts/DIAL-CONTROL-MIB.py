...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, callHistoryConnectTime=callHistoryConnectTime, callActiveLogicalIfIndex=callActiveLogicalIfIndex, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callActiveChargedUnits=callActiveChargedUnits, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, callActiveTransmitPackets=callActiveTransmitPackets, callActivePeerIfIndex=callActivePeerIfIndex, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callActiveCallState=callActiveCallState, dialControlMibCompliances=dialControlMibCompliances, callActiveInfoType=callActiveInfoType, callActiveTable=callActiveTable, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, callActiveReceiveBytes=callActiveReceiveBytes, callHistoryGroup=callHistoryGroup, callActiveGroup=callActiveGroup, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callHistoryTable=callHistoryTable, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialCtlPeerCallSetup=dialCtlPeerCallSetup, callHistoryDisconnectTime=callHistoryDisconnectTime, dialCtlAcceptMode=dialCtlAcceptMode, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, callHistory=callHistory, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callHistoryReceivePackets=callHistoryReceivePackets, dialControlMibGroups=dialControlMibGroups, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callHistoryPeerId=callHistoryPeerId, dialCtlPeer=dialCtlPeer, AbsoluteCounter32=AbsoluteCounter32, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, callActivePeerSubAddress=callActivePeerSubAddress, dialControlMib=dialControlMib, callHistoryDisconnectText=callHistoryDisconnectText, callActivePeerAddress=callActivePeerAddress, callActiveIndex=callActiveIndex, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialControlGroup=dialControlGroup, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, dialControlMibObjects=dialControlMibObjects, callActiveCallOrigin=callActiveCallOrigin, callHistoryInfoType=callHistoryInfoType, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialControlMibTraps=dialControlMibTraps, callActiveSetupTime=callActiveSetupTime, dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callHistoryCallOrigin=callHistoryCallOrigin, callActiveEntry=callActiveEntry, callHistoryRetainTimer=callHistoryRetainTimer, PYSNMP_MODULE_ID=dialControlMib, callActiveConnectTime=callActiveConnectTime, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callActiveReceivePackets=callActiveReceivePackets, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callHistoryReceiveBytes=callHistoryReceiveBytes, callHistoryTransmitBytes=callHistoryTransmitBytes, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callHistoryChargedUnits=callHistoryChargedUnits, callHistoryTransmitPackets=callHistoryTransmitPackets, dialCtlTrapEnable=dialCtlTrapEnable, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, callActivePeerId=callActivePeerId, callHistoryDisconnectCause=callHistoryDisconnectCause, dialControlMibConformance=dialControlMibConformance, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callActive=callActive, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialControlMibCompliance=dialControlMibCompliance, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callHistoryEntry=callHistoryEntry, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeerCfgId=dialCtlPeerCfgId, callHistoryTableMaxLength=callHistoryTableMaxLength)
