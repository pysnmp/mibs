...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", callHistoryCallOrigin=callHistoryCallOrigin, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callHistoryReceivePackets=callHistoryReceivePackets, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, callHistoryDisconnectCause=callHistoryDisconnectCause, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialControlMib=dialControlMib, callHistoryTransmitPackets=callHistoryTransmitPackets, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, callActiveReceivePackets=callActiveReceivePackets, dialCtlPeerCfgId=dialCtlPeerCfgId, dialControlMibGroups=dialControlMibGroups, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callActivePeerId=callActivePeerId, callHistoryRetainTimer=callHistoryRetainTimer, callHistoryConnectTime=callHistoryConnectTime, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialCtlPeer=dialCtlPeer, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callHistoryTable=callHistoryTable, dialControlMibObjects=dialControlMibObjects, callActiveIndex=callActiveIndex, dialCtlPeerStatsTable=dialCtlPeerStatsTable, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callActivePeerSubAddress=callActivePeerSubAddress, callActiveGroup=callActiveGroup, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, callActivePeerIfIndex=callActivePeerIfIndex, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, AbsoluteCounter32=AbsoluteCounter32, callHistoryEntry=callHistoryEntry, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callHistoryDisconnectTime=callHistoryDisconnectTime, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, callHistoryTransmitBytes=callHistoryTransmitBytes, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callHistoryTableMaxLength=callHistoryTableMaxLength, PYSNMP_MODULE_ID=dialControlMib, callActiveCallState=callActiveCallState, callActiveReceiveBytes=callActiveReceiveBytes, callHistoryGroup=callHistoryGroup, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialControlMibConformance=dialControlMibConformance, callActiveTable=callActiveTable, callActiveConnectTime=callActiveConnectTime, dialControlMibCompliance=dialControlMibCompliance, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callHistoryDisconnectText=callHistoryDisconnectText, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callActiveEntry=callActiveEntry, dialControlMibCompliances=dialControlMibCompliances, callActiveCallOrigin=callActiveCallOrigin, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialControlMibTraps=dialControlMibTraps, callHistoryReceiveBytes=callHistoryReceiveBytes, callActiveChargedUnits=callActiveChargedUnits, callActiveSetupTime=callActiveSetupTime, callActiveInfoType=callActiveInfoType, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callActiveTransmitBytes=callActiveTransmitBytes, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callHistory=callHistory, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callActive=callActive, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callActiveTransmitPackets=callActiveTransmitPackets, callHistoryPeerId=callHistoryPeerId, dialControlGroup=dialControlGroup, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialCtlAcceptMode=dialCtlAcceptMode, dialCtlTrapEnable=dialCtlTrapEnable, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, callActivePeerAddress=callActivePeerAddress, callHistoryPeerAddress=callHistoryPeerAddress, callHistoryInfoType=callHistoryInfoType, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress)
