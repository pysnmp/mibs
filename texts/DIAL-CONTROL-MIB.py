...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlPeer=dialCtlPeer, callHistoryDisconnectCause=callHistoryDisconnectCause, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callActiveCallState=callActiveCallState, callActiveConnectTime=callActiveConnectTime, callActiveGroup=callActiveGroup, dialControlMibObjects=dialControlMibObjects, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callHistoryTransmitBytes=callHistoryTransmitBytes, callHistoryRetainTimer=callHistoryRetainTimer, callActiveSetupTime=callActiveSetupTime, callHistoryPeerIfIndex=callHistoryPeerIfIndex, callActiveLogicalIfIndex=callActiveLogicalIfIndex, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialControlMibTraps=dialControlMibTraps, dialControlMibGroups=dialControlMibGroups, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialCtlPeerCfgId=dialCtlPeerCfgId, callActiveIndex=callActiveIndex, callHistoryTable=callHistoryTable, callActive=callActive, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialCtlAcceptMode=dialCtlAcceptMode, callHistoryDisconnectTime=callHistoryDisconnectTime, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, callActiveChargedUnits=callActiveChargedUnits, callHistory=callHistory, callHistoryChargedUnits=callHistoryChargedUnits, callActiveReceiveBytes=callActiveReceiveBytes, dialCtlPeerCallSetup=dialCtlPeerCallSetup, callHistoryDisconnectText=callHistoryDisconnectText, callHistoryTransmitPackets=callHistoryTransmitPackets, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, AbsoluteCounter32=AbsoluteCounter32, callActivePeerId=callActivePeerId, callActivePeerIfIndex=callActivePeerIfIndex, callActiveInfoType=callActiveInfoType, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialControlMib=dialControlMib, callHistoryGroup=callHistoryGroup, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, callHistoryEntry=callHistoryEntry, callActiveReceivePackets=callActiveReceivePackets, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, PYSNMP_MODULE_ID=dialControlMib, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, callHistoryReceiveBytes=callHistoryReceiveBytes, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callActivePeerAddress=callActivePeerAddress, callActivePeerSubAddress=callActivePeerSubAddress, callHistoryTableMaxLength=callHistoryTableMaxLength, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialCtlPeerStatsTable=dialCtlPeerStatsTable, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callHistoryReceivePackets=callHistoryReceivePackets, callHistoryPeerId=callHistoryPeerId, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callActiveTable=callActiveTable, dialControlMibConformance=dialControlMibConformance, dialControlMibCompliance=dialControlMibCompliance, dialControlGroup=dialControlGroup, callActiveTransmitPackets=callActiveTransmitPackets, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callHistoryCallOrigin=callHistoryCallOrigin, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, callActiveCallOrigin=callActiveCallOrigin, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, dialCtlPeerCallInformation=dialCtlPeerCallInformation, dialControlMibTrapPrefix=dialControlMibTrapPrefix, callHistoryConnectTime=callHistoryConnectTime, dialControlMibCompliances=dialControlMibCompliances, callHistoryInfoType=callHistoryInfoType, callActiveEntry=callActiveEntry, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlTrapEnable=dialCtlTrapEnable, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration)
