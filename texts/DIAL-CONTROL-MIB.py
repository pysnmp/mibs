...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlTrapEnable=dialCtlTrapEnable, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callHistoryInfoType=callHistoryInfoType, callActivePeerIfIndex=callActivePeerIfIndex, dialCtlAcceptMode=dialCtlAcceptMode, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callActiveConnectTime=callActiveConnectTime, callActiveCallOrigin=callActiveCallOrigin, callHistory=callHistory, callHistoryReceivePackets=callHistoryReceivePackets, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, callHistoryPeerIfIndex=callHistoryPeerIfIndex, callActiveEntry=callActiveEntry, callActiveTransmitBytes=callActiveTransmitBytes, dialControlMibCompliances=dialControlMibCompliances, callHistoryTransmitBytes=callHistoryTransmitBytes, callHistoryGroup=callHistoryGroup, callHistoryDisconnectCause=callHistoryDisconnectCause, callHistoryCallOrigin=callHistoryCallOrigin, callHistoryReceiveBytes=callHistoryReceiveBytes, callActivePeerSubAddress=callActivePeerSubAddress, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, callActiveTable=callActiveTable, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeer=dialCtlPeer, callHistoryDisconnectTime=callHistoryDisconnectTime, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callHistoryPeerId=callHistoryPeerId, callHistoryTable=callHistoryTable, callHistoryEntry=callHistoryEntry, callActiveChargedUnits=callActiveChargedUnits, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, dialControlMibGroups=dialControlMibGroups, dialControlMib=dialControlMib, dialControlMibObjects=dialControlMibObjects, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, callHistoryTransmitPackets=callHistoryTransmitPackets, dialCtlPeerCfgId=dialCtlPeerCfgId, callActiveGroup=callActiveGroup, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, dialCtlPeerStatsTable=dialCtlPeerStatsTable, dialControlMibConformance=dialControlMibConformance, callHistoryDisconnectText=callHistoryDisconnectText, callHistoryTableMaxLength=callHistoryTableMaxLength, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlConfiguration=dialCtlConfiguration, AbsoluteCounter32=AbsoluteCounter32, callHistoryConnectTime=callHistoryConnectTime, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, callActiveTransmitPackets=callActiveTransmitPackets, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callHistoryPeerAddress=callHistoryPeerAddress, callActivePeerId=callActivePeerId, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callActiveReceiveBytes=callActiveReceiveBytes, dialControlGroup=dialControlGroup, dialControlMibCompliance=dialControlMibCompliance, callActiveIndex=callActiveIndex, callActiveReceivePackets=callActiveReceivePackets, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialControlMibTraps=dialControlMibTraps, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callActivePeerAddress=callActivePeerAddress, callActiveSetupTime=callActiveSetupTime, callActive=callActive, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callHistoryRetainTimer=callHistoryRetainTimer, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, callActiveCallState=callActiveCallState, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, PYSNMP_MODULE_ID=dialControlMib, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callActiveInfoType=callActiveInfoType)
