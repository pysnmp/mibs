...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, callHistoryReceiveBytes=callHistoryReceiveBytes, callHistoryCallOrigin=callHistoryCallOrigin, callActive=callActive, dialControlGroup=dialControlGroup, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, callHistoryInfoType=callHistoryInfoType, callActiveReceiveBytes=callActiveReceiveBytes, callActiveReceivePackets=callActiveReceivePackets, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callActiveChargedUnits=callActiveChargedUnits, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialCtlConfiguration=dialCtlConfiguration, PYSNMP_MODULE_ID=dialControlMib, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callActiveIndex=callActiveIndex, dialCtlPeerStatsTable=dialCtlPeerStatsTable, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, dialCtlAcceptMode=dialCtlAcceptMode, callHistoryTable=callHistoryTable, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialCtlTrapEnable=dialCtlTrapEnable, callHistoryDisconnectText=callHistoryDisconnectText, callHistoryTableMaxLength=callHistoryTableMaxLength, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callHistoryChargedUnits=callHistoryChargedUnits, callHistoryTransmitBytes=callHistoryTransmitBytes, callHistoryDisconnectTime=callHistoryDisconnectTime, callActivePeerId=callActivePeerId, dialControlMibGroups=dialControlMibGroups, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, callActivePeerSubAddress=callActivePeerSubAddress, dialCtlPeerCallSetup=dialCtlPeerCallSetup, callHistoryPeerIfIndex=callHistoryPeerIfIndex, callActiveGroup=callActiveGroup, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, callHistoryRetainTimer=callHistoryRetainTimer, callHistoryPeerAddress=callHistoryPeerAddress, dialControlMib=dialControlMib, dialCtlPeer=dialCtlPeer, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, dialControlMibTrapPrefix=dialControlMibTrapPrefix, callHistoryDisconnectCause=callHistoryDisconnectCause, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callActiveCallOrigin=callActiveCallOrigin, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callHistoryTransmitPackets=callHistoryTransmitPackets, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callActiveInfoType=callActiveInfoType, callHistoryEntry=callHistoryEntry, dialControlMibCompliances=dialControlMibCompliances, callHistoryGroup=callHistoryGroup, callHistory=callHistory, dialControlMibTraps=dialControlMibTraps, AbsoluteCounter32=AbsoluteCounter32, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialControlMibCompliance=dialControlMibCompliance, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callHistoryPeerId=callHistoryPeerId, callActiveEntry=callActiveEntry, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, callActiveTransmitPackets=callActiveTransmitPackets, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callActivePeerAddress=callActivePeerAddress, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callActivePeerIfIndex=callActivePeerIfIndex, callHistoryReceivePackets=callHistoryReceivePackets, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callActiveSetupTime=callActiveSetupTime, callActiveConnectTime=callActiveConnectTime, callHistoryConnectTime=callHistoryConnectTime, dialCtlPeerCfgId=dialCtlPeerCfgId, dialControlMibConformance=dialControlMibConformance, callActiveTable=callActiveTable, dialControlMibObjects=dialControlMibObjects, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialCtlPeerCallInformation=dialCtlPeerCallInformation, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callActiveCallState=callActiveCallState, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission)
