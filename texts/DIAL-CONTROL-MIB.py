...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", PYSNMP_MODULE_ID=dialControlMib, callActivePeerIfIndex=callActivePeerIfIndex, callActiveTransmitPackets=callActiveTransmitPackets, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialControlMibTraps=dialControlMibTraps, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callHistoryPeerAddress=callHistoryPeerAddress, callActiveTable=callActiveTable, callHistoryCallOrigin=callHistoryCallOrigin, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, AbsoluteCounter32=AbsoluteCounter32, dialControlMibObjects=dialControlMibObjects, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, callActiveEntry=callActiveEntry, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callActiveInfoType=callActiveInfoType, callHistoryGroup=callHistoryGroup, callActiveIndex=callActiveIndex, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, callHistoryConnectTime=callHistoryConnectTime, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callHistoryEntry=callHistoryEntry, callHistoryTransmitBytes=callHistoryTransmitBytes, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, callActivePeerAddress=callActivePeerAddress, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, dialCtlAcceptMode=dialCtlAcceptMode, callActivePeerId=callActivePeerId, dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callActive=callActive, dialControlMibGroups=dialControlMibGroups, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callHistoryRetainTimer=callHistoryRetainTimer, dialControlMibCompliances=dialControlMibCompliances, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callActiveLogicalIfIndex=callActiveLogicalIfIndex, dialCtlPeerCfgId=dialCtlPeerCfgId, callHistoryInfoType=callHistoryInfoType, callHistory=callHistory, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialCtlPeerCfgTable=dialCtlPeerCfgTable, callActiveCallOrigin=callActiveCallOrigin, dialCtlTrapEnable=dialCtlTrapEnable, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callHistoryDisconnectTime=callHistoryDisconnectTime, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callActiveChargedUnits=callActiveChargedUnits, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, callActiveConnectTime=callActiveConnectTime, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialControlGroup=dialControlGroup, callHistoryPeerId=callHistoryPeerId, callHistoryTableMaxLength=callHistoryTableMaxLength, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, callHistoryTable=callHistoryTable, callHistoryDisconnectText=callHistoryDisconnectText, callActiveReceivePackets=callActiveReceivePackets, dialControlMib=dialControlMib, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeer=dialCtlPeer, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callActiveReceiveBytes=callActiveReceiveBytes, callHistoryReceiveBytes=callHistoryReceiveBytes, callHistoryTransmitPackets=callHistoryTransmitPackets, callActivePeerSubAddress=callActivePeerSubAddress, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, callHistoryDisconnectCause=callHistoryDisconnectCause, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callActiveSetupTime=callActiveSetupTime, callHistoryReceivePackets=callHistoryReceivePackets, callActiveGroup=callActiveGroup, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callActiveCallState=callActiveCallState, dialControlMibCompliance=dialControlMibCompliance, dialControlMibConformance=dialControlMibConformance, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay)
