...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", callActiveInfoType=callActiveInfoType, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, callHistoryDisconnectText=callHistoryDisconnectText, callHistoryTableMaxLength=callHistoryTableMaxLength, dialControlMibObjects=dialControlMibObjects, dialCtlPeerCfgId=dialCtlPeerCfgId, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, dialControlMib=dialControlMib, callActiveCallOrigin=callActiveCallOrigin, dialControlMibCompliances=dialControlMibCompliances, dialCtlAcceptMode=dialCtlAcceptMode, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialControlMibGroups=dialControlMibGroups, dialControlMibConformance=dialControlMibConformance, callHistoryRetainTimer=callHistoryRetainTimer, callHistoryChargedUnits=callHistoryChargedUnits, callHistoryEntry=callHistoryEntry, dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callActiveEntry=callActiveEntry, callHistory=callHistory, callActiveTransmitPackets=callActiveTransmitPackets, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callHistoryTable=callHistoryTable, callActiveIndex=callActiveIndex, dialCtlTrapEnable=dialCtlTrapEnable, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callHistoryPeerAddress=callHistoryPeerAddress, callHistoryReceiveBytes=callHistoryReceiveBytes, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callActiveReceivePackets=callActiveReceivePackets, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callActivePeerIfIndex=callActivePeerIfIndex, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callActiveGroup=callActiveGroup, dialCtlPeer=dialCtlPeer, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, callActivePeerId=callActivePeerId, dialControlGroup=dialControlGroup, callHistoryDisconnectTime=callHistoryDisconnectTime, callHistoryTransmitBytes=callHistoryTransmitBytes, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callActiveSetupTime=callActiveSetupTime, callHistoryInfoType=callHistoryInfoType, callActive=callActive, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, callHistoryGroup=callHistoryGroup, callActiveTable=callActiveTable, callHistoryCallOrigin=callHistoryCallOrigin, callActivePeerSubAddress=callActivePeerSubAddress, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, callActiveCallState=callActiveCallState, callActiveChargedUnits=callActiveChargedUnits, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callActiveReceiveBytes=callActiveReceiveBytes, PYSNMP_MODULE_ID=dialControlMib, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, callActiveConnectTime=callActiveConnectTime, callHistoryReceivePackets=callHistoryReceivePackets, dialControlMibCompliance=dialControlMibCompliance, callHistoryConnectTime=callHistoryConnectTime, callActivePeerAddress=callActivePeerAddress, callHistoryPeerId=callHistoryPeerId, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerCallInformation=dialCtlPeerCallInformation, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callHistoryTransmitPackets=callHistoryTransmitPackets, AbsoluteCounter32=AbsoluteCounter32, callHistoryDisconnectCause=callHistoryDisconnectCause, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialControlMibTraps=dialControlMibTraps, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress)
