...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", callActive=callActive, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, dialCtlConfiguration=dialCtlConfiguration, callHistoryTable=callHistoryTable, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialControlMibTraps=dialControlMibTraps, dialCtlPeer=dialCtlPeer, dialControlGroup=dialControlGroup, dialControlMib=dialControlMib, callHistoryRetainTimer=callHistoryRetainTimer, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, dialCtlPeerStatsTable=dialCtlPeerStatsTable, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialControlMibConformance=dialControlMibConformance, dialCtlTrapEnable=dialCtlTrapEnable, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, callHistoryReceivePackets=callHistoryReceivePackets, callActiveTable=callActiveTable, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callHistory=callHistory, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, callActiveChargedUnits=callActiveChargedUnits, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callActiveReceivePackets=callActiveReceivePackets, callHistoryReceiveBytes=callHistoryReceiveBytes, callActiveTransmitPackets=callActiveTransmitPackets, callActiveGroup=callActiveGroup, callActiveReceiveBytes=callActiveReceiveBytes, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, dialCtlAcceptMode=dialCtlAcceptMode, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callHistoryInfoType=callHistoryInfoType, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialControlMibGroups=dialControlMibGroups, callHistoryDisconnectCause=callHistoryDisconnectCause, callActiveCallOrigin=callActiveCallOrigin, callActivePeerSubAddress=callActivePeerSubAddress, dialControlMibCompliance=dialControlMibCompliance, callHistoryTableMaxLength=callHistoryTableMaxLength, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callHistoryPeerId=callHistoryPeerId, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callActiveInfoType=callActiveInfoType, callHistoryEntry=callHistoryEntry, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, AbsoluteCounter32=AbsoluteCounter32, dialControlMibCompliances=dialControlMibCompliances, callHistoryCallOrigin=callHistoryCallOrigin, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, callActiveConnectTime=callActiveConnectTime, callHistoryTransmitPackets=callHistoryTransmitPackets, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callHistoryTransmitBytes=callHistoryTransmitBytes, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callActiveSetupTime=callActiveSetupTime, dialCtlPeerCallSetup=dialCtlPeerCallSetup, PYSNMP_MODULE_ID=dialControlMib, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, callActivePeerId=callActivePeerId, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callActivePeerAddress=callActivePeerAddress, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, dialCtlPeerCfgId=dialCtlPeerCfgId, callActiveIndex=callActiveIndex, callHistoryConnectTime=callHistoryConnectTime, callActiveEntry=callActiveEntry, callHistoryGroup=callHistoryGroup, callActiveCallState=callActiveCallState, callHistoryDisconnectTime=callHistoryDisconnectTime, dialControlMibObjects=dialControlMibObjects, callHistoryDisconnectText=callHistoryDisconnectText, callActivePeerIfIndex=callActivePeerIfIndex, dialCtlPeerCallInformation=dialCtlPeerCallInformation, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls)
