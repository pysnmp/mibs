...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", callHistoryInfoType=callHistoryInfoType, callActiveLogicalIfIndex=callActiveLogicalIfIndex, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialControlMibTraps=dialControlMibTraps, callActivePeerIfIndex=callActivePeerIfIndex, callActiveGroup=callActiveGroup, callActiveReceiveBytes=callActiveReceiveBytes, callActiveIndex=callActiveIndex, dialCtlPeerCfgTable=dialCtlPeerCfgTable, callHistoryDisconnectTime=callHistoryDisconnectTime, callHistory=callHistory, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, dialCtlConfiguration=dialCtlConfiguration, callActiveEntry=callActiveEntry, callActivePeerSubAddress=callActivePeerSubAddress, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callActiveConnectTime=callActiveConnectTime, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callHistoryPeerId=callHistoryPeerId, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, dialControlMibCompliance=dialControlMibCompliance, callHistoryDisconnectText=callHistoryDisconnectText, dialCtlPeerCallInformation=dialCtlPeerCallInformation, dialControlMib=dialControlMib, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, callActiveTable=callActiveTable, dialCtlPeer=dialCtlPeer, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, callHistoryEntry=callHistoryEntry, callActiveCallState=callActiveCallState, callHistoryReceiveBytes=callHistoryReceiveBytes, dialCtlPeerCfgId=dialCtlPeerCfgId, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlTrapEnable=dialCtlTrapEnable, callActivePeerId=callActivePeerId, callHistoryDisconnectCause=callHistoryDisconnectCause, callActiveTransmitPackets=callActiveTransmitPackets, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, PYSNMP_MODULE_ID=dialControlMib, callHistoryRetainTimer=callHistoryRetainTimer, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callActivePeerAddress=callActivePeerAddress, callHistoryReceivePackets=callHistoryReceivePackets, callHistoryTable=callHistoryTable, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialControlMibCompliances=dialControlMibCompliances, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialControlMibGroups=dialControlMibGroups, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callActive=callActive, AbsoluteCounter32=AbsoluteCounter32, dialControlMibObjects=dialControlMibObjects, callHistoryConnectTime=callHistoryConnectTime, dialControlMibConformance=dialControlMibConformance, callActiveChargedUnits=callActiveChargedUnits, dialControlGroup=dialControlGroup, callActiveCallOrigin=callActiveCallOrigin, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callHistoryTransmitBytes=callHistoryTransmitBytes, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callHistoryTableMaxLength=callHistoryTableMaxLength, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, callHistoryTransmitPackets=callHistoryTransmitPackets, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callActiveInfoType=callActiveInfoType, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callActiveReceivePackets=callActiveReceivePackets, callActiveSetupTime=callActiveSetupTime, callHistoryChargedUnits=callHistoryChargedUnits, callHistoryCallOrigin=callHistoryCallOrigin, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callHistoryGroup=callHistoryGroup, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialCtlAcceptMode=dialCtlAcceptMode)
