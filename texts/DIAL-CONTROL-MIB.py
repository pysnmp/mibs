...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, dialControlMibConformance=dialControlMibConformance, dialCtlPeer=dialCtlPeer, callActiveSetupTime=callActiveSetupTime, callActive=callActive, callActiveTable=callActiveTable, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, callHistoryGroup=callHistoryGroup, callHistoryEntry=callHistoryEntry, callActiveEntry=callActiveEntry, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, callHistory=callHistory, callActiveCallState=callActiveCallState, dialCtlTrapEnable=dialCtlTrapEnable, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialCtlAcceptMode=dialCtlAcceptMode, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, callActiveGroup=callActiveGroup, dialCtlPeerStatsTable=dialCtlPeerStatsTable, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, PYSNMP_MODULE_ID=dialControlMib, callHistoryRetainTimer=callHistoryRetainTimer, callHistoryTransmitPackets=callHistoryTransmitPackets, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialCtlPeerCfgId=dialCtlPeerCfgId, callActiveConnectTime=callActiveConnectTime, dialControlMibCompliance=dialControlMibCompliance, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callActivePeerSubAddress=callActivePeerSubAddress, AbsoluteCounter32=AbsoluteCounter32, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callActivePeerAddress=callActivePeerAddress, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callActiveIndex=callActiveIndex, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, dialControlMibObjects=dialControlMibObjects, callHistoryTableMaxLength=callHistoryTableMaxLength, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callActiveTransmitPackets=callActiveTransmitPackets, callHistoryReceivePackets=callHistoryReceivePackets, callHistoryCallOrigin=callHistoryCallOrigin, callHistoryPeerIfIndex=callHistoryPeerIfIndex, callHistoryReceiveBytes=callHistoryReceiveBytes, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callActiveLogicalIfIndex=callActiveLogicalIfIndex, dialControlMibTraps=dialControlMibTraps, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callHistoryDisconnectCause=callHistoryDisconnectCause, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callHistoryDisconnectTime=callHistoryDisconnectTime, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialControlMib=dialControlMib, dialControlGroup=dialControlGroup, callHistoryPeerId=callHistoryPeerId, callHistoryTable=callHistoryTable, dialCtlPeerCfgTable=dialCtlPeerCfgTable, callActivePeerId=callActivePeerId, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, callHistoryInfoType=callHistoryInfoType, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callActiveInfoType=callActiveInfoType, callActiveReceiveBytes=callActiveReceiveBytes, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callActiveChargedUnits=callActiveChargedUnits, callHistoryConnectTime=callHistoryConnectTime, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialControlMibCompliances=dialControlMibCompliances, dialControlMibTrapPrefix=dialControlMibTrapPrefix, callActivePeerIfIndex=callActivePeerIfIndex, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, dialControlMibGroups=dialControlMibGroups, callHistoryTransmitBytes=callHistoryTransmitBytes, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, callActiveReceivePackets=callActiveReceivePackets, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, callHistoryDisconnectText=callHistoryDisconnectText, dialCtlConfiguration=dialCtlConfiguration, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callHistoryPeerAddress=callHistoryPeerAddress, callActiveCallOrigin=callActiveCallOrigin, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex)
