...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, callHistoryReceivePackets=callHistoryReceivePackets, callActiveSetupTime=callActiveSetupTime, callHistoryPeerAddress=callHistoryPeerAddress, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, callActive=callActive, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, dialControlGroup=dialControlGroup, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callActiveCallState=callActiveCallState, callActivePeerSubAddress=callActivePeerSubAddress, dialControlMibCompliance=dialControlMibCompliance, callHistoryChargedUnits=callHistoryChargedUnits, PYSNMP_MODULE_ID=dialControlMib, callActiveInfoType=callActiveInfoType, callHistoryGroup=callHistoryGroup, dialControlMibConformance=dialControlMibConformance, dialCtlPeerCallInformation=dialCtlPeerCallInformation, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callActivePeerIfIndex=callActivePeerIfIndex, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, dialCtlPeer=dialCtlPeer, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, callHistoryTransmitBytes=callHistoryTransmitBytes, callActiveIndex=callActiveIndex, callHistoryInfoType=callHistoryInfoType, callActiveTransmitPackets=callActiveTransmitPackets, callHistoryPeerIfIndex=callHistoryPeerIfIndex, AbsoluteCounter32=AbsoluteCounter32, callHistoryCallOrigin=callHistoryCallOrigin, callHistoryRetainTimer=callHistoryRetainTimer, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callHistoryPeerId=callHistoryPeerId, callHistoryConnectTime=callHistoryConnectTime, callActiveReceivePackets=callActiveReceivePackets, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callActiveChargedUnits=callActiveChargedUnits, callHistory=callHistory, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callHistoryTable=callHistoryTable, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialCtlAcceptMode=dialCtlAcceptMode, dialControlMibTraps=dialControlMibTraps, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, dialCtlPeerCfgTable=dialCtlPeerCfgTable, callActivePeerAddress=callActivePeerAddress, callHistoryDisconnectCause=callHistoryDisconnectCause, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callHistoryTransmitPackets=callHistoryTransmitPackets, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialControlMibGroups=dialControlMibGroups, callHistoryDisconnectText=callHistoryDisconnectText, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, callActiveConnectTime=callActiveConnectTime, dialControlMibObjects=dialControlMibObjects, callActiveCallOrigin=callActiveCallOrigin, dialControlMibCompliances=dialControlMibCompliances, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerCfgId=dialCtlPeerCfgId, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callActiveReceiveBytes=callActiveReceiveBytes, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, callActiveTransmitBytes=callActiveTransmitBytes, callHistoryTableMaxLength=callHistoryTableMaxLength, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callHistoryReceiveBytes=callHistoryReceiveBytes, callActiveGroup=callActiveGroup, callActiveTable=callActiveTable, callHistoryDisconnectTime=callHistoryDisconnectTime, callActivePeerId=callActivePeerId, dialControlMib=dialControlMib, dialCtlConfiguration=dialCtlConfiguration, dialCtlTrapEnable=dialCtlTrapEnable, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, callActiveEntry=callActiveEntry, callHistoryEntry=callHistoryEntry, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText)
