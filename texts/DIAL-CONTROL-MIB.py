...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callActiveReceivePackets=callActiveReceivePackets, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, callHistoryReceiveBytes=callHistoryReceiveBytes, callHistoryEntry=callHistoryEntry, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, dialControlMibTraps=dialControlMibTraps, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, callActiveTable=callActiveTable, dialCtlPeerCfgTable=dialCtlPeerCfgTable, callHistory=callHistory, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, callActiveEntry=callActiveEntry, callHistoryConnectTime=callHistoryConnectTime, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callHistoryDisconnectText=callHistoryDisconnectText, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callHistoryGroup=callHistoryGroup, callActiveSetupTime=callActiveSetupTime, dialControlMibCompliance=dialControlMibCompliance, callActiveCallState=callActiveCallState, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, AbsoluteCounter32=AbsoluteCounter32, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, callHistoryPeerId=callHistoryPeerId, dialControlMibConformance=dialControlMibConformance, dialCtlPeerCfgId=dialCtlPeerCfgId, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callActiveReceiveBytes=callActiveReceiveBytes, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callHistoryDisconnectCause=callHistoryDisconnectCause, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialCtlPeerStatsTable=dialCtlPeerStatsTable, dialCtlTrapEnable=dialCtlTrapEnable, callActiveInfoType=callActiveInfoType, dialCtlPeerCallSetup=dialCtlPeerCallSetup, callHistoryTableMaxLength=callHistoryTableMaxLength, dialControlMibObjects=dialControlMibObjects, callHistoryTable=callHistoryTable, dialCtlPeerCallInformation=dialCtlPeerCallInformation, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, callHistoryReceivePackets=callHistoryReceivePackets, callHistoryInfoType=callHistoryInfoType, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialCtlPeer=dialCtlPeer, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, callHistoryCallOrigin=callHistoryCallOrigin, dialControlMib=dialControlMib, callActiveIndex=callActiveIndex, callActiveChargedUnits=callActiveChargedUnits, callActiveConnectTime=callActiveConnectTime, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, callActivePeerAddress=callActivePeerAddress, callActivePeerSubAddress=callActivePeerSubAddress, callHistoryTransmitPackets=callHistoryTransmitPackets, dialControlMibGroups=dialControlMibGroups, callActive=callActive, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, dialCtlAcceptMode=dialCtlAcceptMode, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, callActiveCallOrigin=callActiveCallOrigin, callActiveTransmitPackets=callActiveTransmitPackets, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialControlGroup=dialControlGroup, callActivePeerId=callActivePeerId, callActiveGroup=callActiveGroup, callActivePeerIfIndex=callActivePeerIfIndex, callHistoryRetainTimer=callHistoryRetainTimer, PYSNMP_MODULE_ID=dialControlMib, dialControlMibCompliances=dialControlMibCompliances, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callHistoryDisconnectTime=callHistoryDisconnectTime, callHistoryTransmitBytes=callHistoryTransmitBytes, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callHistoryChargedUnits=callHistoryChargedUnits)
