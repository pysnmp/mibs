...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", callHistoryTransmitBytes=callHistoryTransmitBytes, dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, callHistoryPeerIfIndex=callHistoryPeerIfIndex, callActivePeerSubAddress=callActivePeerSubAddress, callActiveReceivePackets=callActiveReceivePackets, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callActive=callActive, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callActiveIndex=callActiveIndex, callHistoryTable=callHistoryTable, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, callHistoryConnectTime=callHistoryConnectTime, callHistoryCallOrigin=callHistoryCallOrigin, dialCtlPeer=dialCtlPeer, callHistoryDisconnectText=callHistoryDisconnectText, AbsoluteCounter32=AbsoluteCounter32, callActiveConnectTime=callActiveConnectTime, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callActivePeerIfIndex=callActivePeerIfIndex, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, callHistoryTableMaxLength=callHistoryTableMaxLength, dialControlMibCompliances=dialControlMibCompliances, callActiveCallOrigin=callActiveCallOrigin, callHistoryDisconnectCause=callHistoryDisconnectCause, dialControlMib=dialControlMib, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialControlMibGroups=dialControlMibGroups, dialControlMibCompliance=dialControlMibCompliance, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlTrapEnable=dialCtlTrapEnable, dialCtlPeerCallSetup=dialCtlPeerCallSetup, callActiveTransmitPackets=callActiveTransmitPackets, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callHistoryReceivePackets=callHistoryReceivePackets, dialCtlPeerCfgTable=dialCtlPeerCfgTable, callActiveLogicalIfIndex=callActiveLogicalIfIndex, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialControlGroup=dialControlGroup, dialCtlAcceptMode=dialCtlAcceptMode, dialControlMibTraps=dialControlMibTraps, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callHistoryGroup=callHistoryGroup, callActiveSetupTime=callActiveSetupTime, callActiveGroup=callActiveGroup, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, callActivePeerId=callActivePeerId, callActiveInfoType=callActiveInfoType, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callHistoryRetainTimer=callHistoryRetainTimer, callHistoryReceiveBytes=callHistoryReceiveBytes, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callHistoryPeerId=callHistoryPeerId, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callActiveEntry=callActiveEntry, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, callActiveChargedUnits=callActiveChargedUnits, dialControlMibObjects=dialControlMibObjects, dialControlMibConformance=dialControlMibConformance, callHistoryInfoType=callHistoryInfoType, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, callActiveTransmitBytes=callActiveTransmitBytes, callActiveTable=callActiveTable, callHistoryEntry=callHistoryEntry, PYSNMP_MODULE_ID=dialControlMib, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, callHistoryTransmitPackets=callHistoryTransmitPackets, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, callActiveCallState=callActiveCallState, callHistory=callHistory, dialCtlPeerCfgId=dialCtlPeerCfgId, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callActivePeerAddress=callActivePeerAddress, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callHistoryDisconnectTime=callHistoryDisconnectTime, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, callActiveReceiveBytes=callActiveReceiveBytes, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay)
