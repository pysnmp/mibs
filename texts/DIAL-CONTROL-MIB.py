...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, callActiveTransmitPackets=callActiveTransmitPackets, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, dialControlMibObjects=dialControlMibObjects, callHistoryInfoType=callHistoryInfoType, callActiveCallState=callActiveCallState, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callActiveReceivePackets=callActiveReceivePackets, dialControlGroup=dialControlGroup, callHistoryTable=callHistoryTable, callActivePeerSubAddress=callActivePeerSubAddress, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callActiveEntry=callActiveEntry, dialCtlTrapEnable=dialCtlTrapEnable, callActiveChargedUnits=callActiveChargedUnits, callHistoryReceiveBytes=callHistoryReceiveBytes, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, dialControlMibCompliances=dialControlMibCompliances, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callHistoryPeerIfIndex=callHistoryPeerIfIndex, callActive=callActive, callHistoryTableMaxLength=callHistoryTableMaxLength, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialControlMibTraps=dialControlMibTraps, callActiveCallOrigin=callActiveCallOrigin, dialCtlPeerCallSetup=dialCtlPeerCallSetup, callActiveTransmitBytes=callActiveTransmitBytes, callHistoryConnectTime=callHistoryConnectTime, callHistoryEntry=callHistoryEntry, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callHistoryTransmitBytes=callHistoryTransmitBytes, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callHistoryReceivePackets=callHistoryReceivePackets, dialCtlConfiguration=dialCtlConfiguration, dialControlMibGroups=dialControlMibGroups, callActivePeerId=callActivePeerId, dialCtlPeerCfgId=dialCtlPeerCfgId, callHistoryGroup=callHistoryGroup, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, callHistoryDisconnectTime=callHistoryDisconnectTime, callHistoryDisconnectCause=callHistoryDisconnectCause, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, callActivePeerIfIndex=callActivePeerIfIndex, callActivePeerAddress=callActivePeerAddress, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callActiveTable=callActiveTable, PYSNMP_MODULE_ID=dialControlMib, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callHistoryPeerId=callHistoryPeerId, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, callActiveInfoType=callActiveInfoType, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, dialCtlPeer=dialCtlPeer, dialControlMib=dialControlMib, callActiveConnectTime=callActiveConnectTime, dialControlMibConformance=dialControlMibConformance, callHistoryChargedUnits=callHistoryChargedUnits, callActiveReceiveBytes=callActiveReceiveBytes, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialCtlAcceptMode=dialCtlAcceptMode, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, callActiveSetupTime=callActiveSetupTime, callActiveIndex=callActiveIndex, callHistoryDisconnectText=callHistoryDisconnectText, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, callHistory=callHistory, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, AbsoluteCounter32=AbsoluteCounter32, callHistoryCallOrigin=callHistoryCallOrigin, callActiveGroup=callActiveGroup, callHistoryTransmitPackets=callHistoryTransmitPackets, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callHistoryRetainTimer=callHistoryRetainTimer, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialControlMibCompliance=dialControlMibCompliance, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus)
