...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callHistoryConnectTime=callHistoryConnectTime, callActiveReceivePackets=callActiveReceivePackets, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, callActiveInfoType=callActiveInfoType, callHistoryPeerIfIndex=callHistoryPeerIfIndex, callHistoryPeerId=callHistoryPeerId, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerCfgTable=dialCtlPeerCfgTable, callHistoryDisconnectCause=callHistoryDisconnectCause, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialControlGroup=dialControlGroup, dialCtlPeer=dialCtlPeer, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, callActiveConnectTime=callActiveConnectTime, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callHistoryTransmitBytes=callHistoryTransmitBytes, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, dialControlMibCompliance=dialControlMibCompliance, dialCtlPeerStatsTable=dialCtlPeerStatsTable, dialControlMibGroups=dialControlMibGroups, callActiveTransmitBytes=callActiveTransmitBytes, callHistoryDisconnectText=callHistoryDisconnectText, callHistoryRetainTimer=callHistoryRetainTimer, dialControlMib=dialControlMib, callHistoryGroup=callHistoryGroup, callActiveEntry=callActiveEntry, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, dialCtlPeerCfgId=dialCtlPeerCfgId, callHistoryTable=callHistoryTable, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callActivePeerSubAddress=callActivePeerSubAddress, callHistoryEntry=callHistoryEntry, callActivePeerIfIndex=callActivePeerIfIndex, callHistoryDisconnectTime=callHistoryDisconnectTime, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, callActiveCallOrigin=callActiveCallOrigin, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlPeerCallInformation=dialCtlPeerCallInformation, dialControlMibConformance=dialControlMibConformance, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callActiveSetupTime=callActiveSetupTime, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callActiveCallState=callActiveCallState, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callActiveReceiveBytes=callActiveReceiveBytes, callHistoryReceivePackets=callHistoryReceivePackets, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, callActivePeerId=callActivePeerId, callHistoryReceiveBytes=callHistoryReceiveBytes, dialControlMibCompliances=dialControlMibCompliances, dialCtlAcceptMode=dialCtlAcceptMode, dialControlMibObjects=dialControlMibObjects, callActiveTransmitPackets=callActiveTransmitPackets, PYSNMP_MODULE_ID=dialControlMib, callHistoryTableMaxLength=callHistoryTableMaxLength, callActiveGroup=callActiveGroup, dialCtlTrapEnable=dialCtlTrapEnable, callActiveIndex=callActiveIndex, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callHistoryChargedUnits=callHistoryChargedUnits, callActiveChargedUnits=callActiveChargedUnits, callHistoryCallOrigin=callHistoryCallOrigin, callHistoryInfoType=callHistoryInfoType, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callActiveTable=callActiveTable, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callHistoryTransmitPackets=callHistoryTransmitPackets, callActive=callActive, callHistory=callHistory, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, AbsoluteCounter32=AbsoluteCounter32, callActivePeerAddress=callActivePeerAddress, callHistoryPeerAddress=callHistoryPeerAddress, dialControlMibTraps=dialControlMibTraps, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText)
