...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callHistoryPeerIfIndex=callHistoryPeerIfIndex, callHistoryTransmitPackets=callHistoryTransmitPackets, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callHistoryTableMaxLength=callHistoryTableMaxLength, callHistoryCallOrigin=callHistoryCallOrigin, dialCtlTrapEnable=dialCtlTrapEnable, callActivePeerAddress=callActivePeerAddress, callActiveTransmitBytes=callActiveTransmitBytes, callActiveInfoType=callActiveInfoType, dialControlMibConformance=dialControlMibConformance, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, callHistoryReceivePackets=callHistoryReceivePackets, callActiveCallState=callActiveCallState, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialControlMibCompliance=dialControlMibCompliance, callHistoryDisconnectCause=callHistoryDisconnectCause, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callActiveConnectTime=callActiveConnectTime, callHistoryTable=callHistoryTable, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callActive=callActive, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, callHistory=callHistory, dialControlGroup=dialControlGroup, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callHistoryGroup=callHistoryGroup, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, AbsoluteCounter32=AbsoluteCounter32, callHistoryInfoType=callHistoryInfoType, callActiveReceivePackets=callActiveReceivePackets, callActiveSetupTime=callActiveSetupTime, callHistoryPeerId=callHistoryPeerId, dialControlMibTraps=dialControlMibTraps, callHistoryEntry=callHistoryEntry, dialControlMibGroups=dialControlMibGroups, callActiveChargedUnits=callActiveChargedUnits, callActivePeerId=callActivePeerId, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialCtlAcceptMode=dialCtlAcceptMode, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, callActiveEntry=callActiveEntry, dialCtlPeerCfgId=dialCtlPeerCfgId, callHistoryReceiveBytes=callHistoryReceiveBytes, callHistoryTransmitBytes=callHistoryTransmitBytes, callActiveTable=callActiveTable, dialCtlPeer=dialCtlPeer, callHistoryPeerAddress=callHistoryPeerAddress, callActiveCallOrigin=callActiveCallOrigin, callHistoryConnectTime=callHistoryConnectTime, callHistoryDisconnectTime=callHistoryDisconnectTime, dialControlMibCompliances=dialControlMibCompliances, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, callActivePeerIfIndex=callActivePeerIfIndex, callActiveIndex=callActiveIndex, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callActiveTransmitPackets=callActiveTransmitPackets, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, callActiveGroup=callActiveGroup, PYSNMP_MODULE_ID=dialControlMib, callActiveReceiveBytes=callActiveReceiveBytes, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callHistoryDisconnectText=callHistoryDisconnectText, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialControlMib=dialControlMib, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callHistoryRetainTimer=callHistoryRetainTimer, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialCtlPeerStatsTable=dialCtlPeerStatsTable, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, callActivePeerSubAddress=callActivePeerSubAddress, dialControlMibObjects=dialControlMibObjects)
