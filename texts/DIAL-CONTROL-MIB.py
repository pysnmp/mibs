...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", callHistoryRetainTimer=callHistoryRetainTimer, callActiveGroup=callActiveGroup, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, dialControlMib=dialControlMib, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callActivePeerAddress=callActivePeerAddress, callHistoryGroup=callHistoryGroup, callHistoryTable=callHistoryTable, callHistoryDisconnectCause=callHistoryDisconnectCause, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, callHistoryDisconnectTime=callHistoryDisconnectTime, callHistoryTransmitBytes=callHistoryTransmitBytes, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callActivePeerId=callActivePeerId, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlTrapEnable=dialCtlTrapEnable, dialControlMibGroups=dialControlMibGroups, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callActiveIndex=callActiveIndex, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialControlMibConformance=dialControlMibConformance, callHistory=callHistory, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, PYSNMP_MODULE_ID=dialControlMib, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, callHistoryReceivePackets=callHistoryReceivePackets, callHistoryDisconnectText=callHistoryDisconnectText, dialCtlAcceptMode=dialCtlAcceptMode, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callActiveCallState=callActiveCallState, callHistoryCallOrigin=callHistoryCallOrigin, AbsoluteCounter32=AbsoluteCounter32, dialControlMibCompliance=dialControlMibCompliance, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callActiveConnectTime=callActiveConnectTime, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialCtlPeerCfgId=dialCtlPeerCfgId, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, callHistoryTableMaxLength=callHistoryTableMaxLength, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callActivePeerIfIndex=callActivePeerIfIndex, callActiveCallOrigin=callActiveCallOrigin, dialCtlPeerCallSetup=dialCtlPeerCallSetup, callActiveReceiveBytes=callActiveReceiveBytes, dialControlGroup=dialControlGroup, dialControlMibCompliances=dialControlMibCompliances, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callActiveTransmitPackets=callActiveTransmitPackets, dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callHistoryTransmitPackets=callHistoryTransmitPackets, callHistoryInfoType=callHistoryInfoType, dialCtlPeerStatsTable=dialCtlPeerStatsTable, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callActivePeerSubAddress=callActivePeerSubAddress, callActiveSetupTime=callActiveSetupTime, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callActiveReceivePackets=callActiveReceivePackets, callHistoryReceiveBytes=callHistoryReceiveBytes, dialControlMibObjects=dialControlMibObjects, callActiveEntry=callActiveEntry, callHistoryConnectTime=callHistoryConnectTime, callActiveTable=callActiveTable, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialCtlPeer=dialCtlPeer, callActiveInfoType=callActiveInfoType, callHistoryPeerId=callHistoryPeerId, callActiveChargedUnits=callActiveChargedUnits, callHistoryEntry=callHistoryEntry, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialControlMibTraps=dialControlMibTraps, callActive=callActive, dialCtlPeerCfgTable=dialCtlPeerCfgTable)
