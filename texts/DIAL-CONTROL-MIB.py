...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callActiveReceiveBytes=callActiveReceiveBytes, callHistoryEntry=callHistoryEntry, dialCtlPeerCfgId=dialCtlPeerCfgId, callHistory=callHistory, callActivePeerAddress=callActivePeerAddress, callHistoryDisconnectTime=callHistoryDisconnectTime, dialControlMibCompliance=dialControlMibCompliance, callActiveTable=callActiveTable, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialCtlPeer=dialCtlPeer, callActivePeerId=callActivePeerId, callHistoryReceiveBytes=callHistoryReceiveBytes, callHistoryPeerId=callHistoryPeerId, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, callHistoryPeerAddress=callHistoryPeerAddress, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callHistoryCallOrigin=callHistoryCallOrigin, dialControlGroup=dialControlGroup, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, callActiveTransmitPackets=callActiveTransmitPackets, callActive=callActive, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callActiveGroup=callActiveGroup, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, dialControlMibGroups=dialControlMibGroups, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, callHistoryReceivePackets=callHistoryReceivePackets, callHistoryTransmitPackets=callHistoryTransmitPackets, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callHistoryInfoType=callHistoryInfoType, dialControlMibTraps=dialControlMibTraps, callActiveCallOrigin=callActiveCallOrigin, callActiveSetupTime=callActiveSetupTime, callActiveIndex=callActiveIndex, callActiveConnectTime=callActiveConnectTime, dialControlMibConformance=dialControlMibConformance, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callHistoryDisconnectText=callHistoryDisconnectText, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialCtlAcceptMode=dialCtlAcceptMode, dialControlMibObjects=dialControlMibObjects, callHistoryDisconnectCause=callHistoryDisconnectCause, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callActiveEntry=callActiveEntry, callHistoryGroup=callHistoryGroup, PYSNMP_MODULE_ID=dialControlMib, callHistoryTableMaxLength=callHistoryTableMaxLength, callHistoryTransmitBytes=callHistoryTransmitBytes, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, callHistoryRetainTimer=callHistoryRetainTimer, callHistoryTable=callHistoryTable, dialControlMib=dialControlMib, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialCtlPeerStatsTable=dialCtlPeerStatsTable, dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callActiveLogicalIfIndex=callActiveLogicalIfIndex, dialCtlTrapEnable=dialCtlTrapEnable, dialControlMibTrapPrefix=dialControlMibTrapPrefix, callActiveInfoType=callActiveInfoType, callHistoryPeerIfIndex=callHistoryPeerIfIndex, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callHistoryConnectTime=callHistoryConnectTime, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, callActivePeerIfIndex=callActivePeerIfIndex, callActiveChargedUnits=callActiveChargedUnits, callActivePeerSubAddress=callActivePeerSubAddress, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, AbsoluteCounter32=AbsoluteCounter32, callActiveReceivePackets=callActiveReceivePackets, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, dialCtlPeerCfgTable=dialCtlPeerCfgTable, callActiveCallState=callActiveCallState, dialControlMibCompliances=dialControlMibCompliances)
