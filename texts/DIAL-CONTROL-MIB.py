...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialControlMib=dialControlMib, callActiveChargedUnits=callActiveChargedUnits, callHistoryGroup=callHistoryGroup, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callActiveReceiveBytes=callActiveReceiveBytes, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, dialControlMibGroups=dialControlMibGroups, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callActiveGroup=callActiveGroup, callActiveTable=callActiveTable, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callActivePeerSubAddress=callActivePeerSubAddress, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callHistory=callHistory, PYSNMP_MODULE_ID=dialControlMib, callHistoryTable=callHistoryTable, dialCtlTrapEnable=dialCtlTrapEnable, callActiveLogicalIfIndex=callActiveLogicalIfIndex, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, dialCtlPeerCallInformation=dialCtlPeerCallInformation, dialCtlPeer=dialCtlPeer, dialControlMibCompliances=dialControlMibCompliances, callHistoryTableMaxLength=callHistoryTableMaxLength, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, callActiveInfoType=callActiveInfoType, callHistoryEntry=callHistoryEntry, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialControlMibConformance=dialControlMibConformance, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callHistoryInfoType=callHistoryInfoType, callActiveCallOrigin=callActiveCallOrigin, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialCtlConfiguration=dialCtlConfiguration, callHistoryReceiveBytes=callHistoryReceiveBytes, callHistoryDisconnectTime=callHistoryDisconnectTime, callActiveEntry=callActiveEntry, callActivePeerIfIndex=callActivePeerIfIndex, callHistoryConnectTime=callHistoryConnectTime, dialCtlAcceptMode=dialCtlAcceptMode, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, callHistoryCallOrigin=callHistoryCallOrigin, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialCtlPeerCfgId=dialCtlPeerCfgId, callHistoryPeerId=callHistoryPeerId, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callActiveSetupTime=callActiveSetupTime, callActivePeerAddress=callActivePeerAddress, AbsoluteCounter32=AbsoluteCounter32, callActivePeerId=callActivePeerId, callHistoryRetainTimer=callHistoryRetainTimer, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, callHistoryTransmitPackets=callHistoryTransmitPackets, callHistoryDisconnectText=callHistoryDisconnectText, dialControlMibTraps=dialControlMibTraps, callActiveIndex=callActiveIndex, dialControlMibObjects=dialControlMibObjects, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialControlMibCompliance=dialControlMibCompliance, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callActiveConnectTime=callActiveConnectTime, callActive=callActive, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callHistoryDisconnectCause=callHistoryDisconnectCause, dialControlGroup=dialControlGroup, dialCtlPeerCallSetup=dialCtlPeerCallSetup, callActiveReceivePackets=callActiveReceivePackets, callActiveTransmitBytes=callActiveTransmitBytes, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, callActiveCallState=callActiveCallState, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callHistoryTransmitBytes=callHistoryTransmitBytes, callActiveTransmitPackets=callActiveTransmitPackets, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callHistoryReceivePackets=callHistoryReceivePackets)
