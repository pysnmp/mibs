...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", callHistoryDisconnectText=callHistoryDisconnectText, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, dialCtlTrapEnable=dialCtlTrapEnable, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialControlMibObjects=dialControlMibObjects, callActiveReceiveBytes=callActiveReceiveBytes, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialCtlPeerCfgId=dialCtlPeerCfgId, callHistoryRetainTimer=callHistoryRetainTimer, callActiveTable=callActiveTable, callHistoryTransmitPackets=callHistoryTransmitPackets, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callHistoryReceiveBytes=callHistoryReceiveBytes, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callHistoryTransmitBytes=callHistoryTransmitBytes, dialControlMibCompliances=dialControlMibCompliances, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, dialCtlPeerCallSetup=dialCtlPeerCallSetup, callHistory=callHistory, dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callHistoryChargedUnits=callHistoryChargedUnits, callActiveTransmitBytes=callActiveTransmitBytes, callActiveConnectTime=callActiveConnectTime, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callActiveCallState=callActiveCallState, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callActiveSetupTime=callActiveSetupTime, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, callActiveReceivePackets=callActiveReceivePackets, callActive=callActive, PYSNMP_MODULE_ID=dialControlMib, dialCtlPeerCallInformation=dialCtlPeerCallInformation, dialControlMibGroups=dialControlMibGroups, dialControlMib=dialControlMib, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, callActiveIndex=callActiveIndex, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callActiveCallOrigin=callActiveCallOrigin, callHistoryInfoType=callHistoryInfoType, dialControlGroup=dialControlGroup, callActiveChargedUnits=callActiveChargedUnits, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callHistoryCallOrigin=callHistoryCallOrigin, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callHistoryDisconnectCause=callHistoryDisconnectCause, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callHistoryGroup=callHistoryGroup, dialCtlPeer=dialCtlPeer, callActiveInfoType=callActiveInfoType, callHistoryDisconnectTime=callHistoryDisconnectTime, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, dialCtlPeerCfgTable=dialCtlPeerCfgTable, callActivePeerAddress=callActivePeerAddress, callActivePeerSubAddress=callActivePeerSubAddress, callActiveEntry=callActiveEntry, dialCtlAcceptMode=dialCtlAcceptMode, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, callHistoryEntry=callHistoryEntry, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, callActiveTransmitPackets=callActiveTransmitPackets, AbsoluteCounter32=AbsoluteCounter32, callActivePeerIfIndex=callActivePeerIfIndex, callHistoryPeerAddress=callHistoryPeerAddress, dialControlMibConformance=dialControlMibConformance, callActiveGroup=callActiveGroup, dialControlMibCompliance=dialControlMibCompliance, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callActivePeerId=callActivePeerId, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callHistoryPeerId=callHistoryPeerId, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, callHistoryReceivePackets=callHistoryReceivePackets, callHistoryTable=callHistoryTable, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callHistoryTableMaxLength=callHistoryTableMaxLength, callHistoryConnectTime=callHistoryConnectTime, dialControlMibTraps=dialControlMibTraps, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls)
