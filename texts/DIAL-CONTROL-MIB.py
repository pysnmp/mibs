...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlPeerCallInformation=dialCtlPeerCallInformation, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callHistoryDisconnectCause=callHistoryDisconnectCause, callHistoryGroup=callHistoryGroup, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, callHistoryConnectTime=callHistoryConnectTime, callActiveTable=callActiveTable, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, callHistoryReceiveBytes=callHistoryReceiveBytes, dialCtlTrapEnable=dialCtlTrapEnable, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callActiveGroup=callActiveGroup, callHistoryReceivePackets=callHistoryReceivePackets, callHistory=callHistory, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, callActiveTransmitPackets=callActiveTransmitPackets, callHistoryPeerId=callHistoryPeerId, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlConfiguration=dialCtlConfiguration, callActivePeerIfIndex=callActivePeerIfIndex, dialControlMibGroups=dialControlMibGroups, callActiveTransmitBytes=callActiveTransmitBytes, callActiveCallOrigin=callActiveCallOrigin, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callActiveConnectTime=callActiveConnectTime, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, callActiveChargedUnits=callActiveChargedUnits, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callHistoryTransmitBytes=callHistoryTransmitBytes, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, callActiveIndex=callActiveIndex, callActivePeerAddress=callActivePeerAddress, dialControlMibTraps=dialControlMibTraps, callHistoryRetainTimer=callHistoryRetainTimer, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callHistoryEntry=callHistoryEntry, callActiveInfoType=callActiveInfoType, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialControlMibTrapPrefix=dialControlMibTrapPrefix, callHistoryDisconnectText=callHistoryDisconnectText, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, PYSNMP_MODULE_ID=dialControlMib, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialControlMibCompliances=dialControlMibCompliances, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialControlGroup=dialControlGroup, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callActiveSetupTime=callActiveSetupTime, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callHistoryTable=callHistoryTable, dialCtlPeer=dialCtlPeer, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialControlMibCompliance=dialControlMibCompliance, callActiveReceiveBytes=callActiveReceiveBytes, callHistoryCallOrigin=callHistoryCallOrigin, dialCtlAcceptMode=dialCtlAcceptMode, callActivePeerId=callActivePeerId, dialControlMibConformance=dialControlMibConformance, callActive=callActive, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callHistoryInfoType=callHistoryInfoType, callActiveCallState=callActiveCallState, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callActivePeerSubAddress=callActivePeerSubAddress, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callActiveReceivePackets=callActiveReceivePackets, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callHistoryTableMaxLength=callHistoryTableMaxLength, callHistoryDisconnectTime=callHistoryDisconnectTime, dialCtlPeerCfgId=dialCtlPeerCfgId, callActiveEntry=callActiveEntry, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, callHistoryTransmitPackets=callHistoryTransmitPackets, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, AbsoluteCounter32=AbsoluteCounter32, dialControlMibObjects=dialControlMibObjects, dialControlMib=dialControlMib)
