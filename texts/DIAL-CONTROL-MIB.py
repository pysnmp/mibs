...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialControlMib=dialControlMib, callActiveConnectTime=callActiveConnectTime, callActiveReceivePackets=callActiveReceivePackets, callActivePeerSubAddress=callActivePeerSubAddress, callHistoryTransmitBytes=callHistoryTransmitBytes, callActivePeerId=callActivePeerId, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, callActivePeerAddress=callActivePeerAddress, callActiveGroup=callActiveGroup, PYSNMP_MODULE_ID=dialControlMib, callActiveCallState=callActiveCallState, dialCtlTrapEnable=dialCtlTrapEnable, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callHistoryEntry=callHistoryEntry, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialControlMibGroups=dialControlMibGroups, dialControlMibObjects=dialControlMibObjects, callActive=callActive, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callHistoryTable=callHistoryTable, callHistoryGroup=callHistoryGroup, callActivePeerIfIndex=callActivePeerIfIndex, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, callHistoryTableMaxLength=callHistoryTableMaxLength, callHistoryReceiveBytes=callHistoryReceiveBytes, dialControlMibTraps=dialControlMibTraps, dialCtlPeerCfgId=dialCtlPeerCfgId, callHistoryInfoType=callHistoryInfoType, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callHistoryConnectTime=callHistoryConnectTime, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callActiveIndex=callActiveIndex, dialControlMibCompliance=dialControlMibCompliance, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callHistoryDisconnectText=callHistoryDisconnectText, dialCtlPeerStatsTable=dialCtlPeerStatsTable, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callActiveTable=callActiveTable, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callActiveCallOrigin=callActiveCallOrigin, callHistoryReceivePackets=callHistoryReceivePackets, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlAcceptMode=dialCtlAcceptMode, callActiveSetupTime=callActiveSetupTime, callHistory=callHistory, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callHistoryCallOrigin=callHistoryCallOrigin, dialControlGroup=dialControlGroup, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callActiveInfoType=callActiveInfoType, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, callActiveReceiveBytes=callActiveReceiveBytes, dialCtlPeer=dialCtlPeer, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callHistoryTransmitPackets=callHistoryTransmitPackets, callHistoryRetainTimer=callHistoryRetainTimer, callHistoryPeerId=callHistoryPeerId, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialControlMibCompliances=dialControlMibCompliances, callHistoryDisconnectTime=callHistoryDisconnectTime, dialControlMibConformance=dialControlMibConformance, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callActiveEntry=callActiveEntry, callHistoryDisconnectCause=callHistoryDisconnectCause, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, callHistoryPeerIfIndex=callHistoryPeerIfIndex, AbsoluteCounter32=AbsoluteCounter32, callActiveChargedUnits=callActiveChargedUnits, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callActiveTransmitPackets=callActiveTransmitPackets)
