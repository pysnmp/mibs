...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", callActiveTable=callActiveTable, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callHistoryRetainTimer=callHistoryRetainTimer, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callActiveInfoType=callActiveInfoType, callHistoryChargedUnits=callHistoryChargedUnits, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callHistory=callHistory, callActiveChargedUnits=callActiveChargedUnits, dialCtlConfiguration=dialCtlConfiguration, callActiveIndex=callActiveIndex, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, callHistoryTransmitBytes=callHistoryTransmitBytes, callActiveReceivePackets=callActiveReceivePackets, dialControlMib=dialControlMib, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlPeerCallSetup=dialCtlPeerCallSetup, callHistoryTableMaxLength=callHistoryTableMaxLength, callHistoryInfoType=callHistoryInfoType, callHistoryGroup=callHistoryGroup, callActiveTransmitPackets=callActiveTransmitPackets, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callHistoryTransmitPackets=callHistoryTransmitPackets, dialControlMibCompliance=dialControlMibCompliance, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialCtlPeerCfgTable=dialCtlPeerCfgTable, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, callActivePeerId=callActivePeerId, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callActiveEntry=callActiveEntry, dialCtlAcceptMode=dialCtlAcceptMode, dialCtlPeerCfgId=dialCtlPeerCfgId, callHistoryPeerId=callHistoryPeerId, callHistoryDisconnectTime=callHistoryDisconnectTime, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callHistoryDisconnectCause=callHistoryDisconnectCause, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, callActivePeerAddress=callActivePeerAddress, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, callActiveCallState=callActiveCallState, dialControlGroup=dialControlGroup, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, callHistoryDisconnectText=callHistoryDisconnectText, dialControlMibGroups=dialControlMibGroups, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callHistoryCallOrigin=callHistoryCallOrigin, callActiveConnectTime=callActiveConnectTime, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, dialControlMibTraps=dialControlMibTraps, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialControlMibConformance=dialControlMibConformance, dialControlMibCompliances=dialControlMibCompliances, callActivePeerIfIndex=callActivePeerIfIndex, callActivePeerSubAddress=callActivePeerSubAddress, callActiveReceiveBytes=callActiveReceiveBytes, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialCtlPeer=dialCtlPeer, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callActiveSetupTime=callActiveSetupTime, callHistoryConnectTime=callHistoryConnectTime, callHistoryTable=callHistoryTable, callHistoryReceiveBytes=callHistoryReceiveBytes, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, dialControlMibObjects=dialControlMibObjects, dialCtlTrapEnable=dialCtlTrapEnable, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callHistoryReceivePackets=callHistoryReceivePackets, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, callActive=callActive, dialControlMibTrapPrefix=dialControlMibTrapPrefix, callHistoryEntry=callHistoryEntry, AbsoluteCounter32=AbsoluteCounter32, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callActiveGroup=callActiveGroup, dialCtlPeerStatsTable=dialCtlPeerStatsTable, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callActiveCallOrigin=callActiveCallOrigin, PYSNMP_MODULE_ID=dialControlMib, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls)
