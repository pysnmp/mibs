...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", callHistoryPeerIfIndex=callHistoryPeerIfIndex, callActivePeerId=callActivePeerId, callHistoryInfoType=callHistoryInfoType, callHistoryEntry=callHistoryEntry, callActiveLogicalIfIndex=callActiveLogicalIfIndex, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialCtlPeerCfgId=dialCtlPeerCfgId, callActiveCallOrigin=callActiveCallOrigin, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callActivePeerIfIndex=callActivePeerIfIndex, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, callHistoryReceiveBytes=callHistoryReceiveBytes, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callActivePeerAddress=callActivePeerAddress, callActiveIndex=callActiveIndex, callHistoryRetainTimer=callHistoryRetainTimer, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, dialCtlAcceptMode=dialCtlAcceptMode, callActiveEntry=callActiveEntry, callActive=callActive, callActiveGroup=callActiveGroup, callHistoryPeerId=callHistoryPeerId, callHistoryReceivePackets=callHistoryReceivePackets, dialControlMibConformance=dialControlMibConformance, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, callHistoryTable=callHistoryTable, callHistoryTransmitPackets=callHistoryTransmitPackets, dialControlMibGroups=dialControlMibGroups, callActivePeerSubAddress=callActivePeerSubAddress, callHistoryGroup=callHistoryGroup, callHistoryDisconnectText=callHistoryDisconnectText, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, callHistoryCallOrigin=callHistoryCallOrigin, callHistoryDisconnectTime=callHistoryDisconnectTime, PYSNMP_MODULE_ID=dialControlMib, callActiveCallState=callActiveCallState, callHistoryTableMaxLength=callHistoryTableMaxLength, callHistory=callHistory, dialControlMibObjects=dialControlMibObjects, callActiveInfoType=callActiveInfoType, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerCallInformation=dialCtlPeerCallInformation, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, callActiveSetupTime=callActiveSetupTime, callHistoryDisconnectCause=callHistoryDisconnectCause, AbsoluteCounter32=AbsoluteCounter32, callActiveReceiveBytes=callActiveReceiveBytes, dialControlGroup=dialControlGroup, dialCtlPeerCallSetup=dialCtlPeerCallSetup, callActiveConnectTime=callActiveConnectTime, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, callActiveChargedUnits=callActiveChargedUnits, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callActiveTransmitPackets=callActiveTransmitPackets, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callHistoryConnectTime=callHistoryConnectTime, dialControlMibTraps=dialControlMibTraps, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, callHistoryTransmitBytes=callHistoryTransmitBytes, dialCtlTrapEnable=dialCtlTrapEnable, dialCtlPeerStatsTable=dialCtlPeerStatsTable, dialControlMibCompliances=dialControlMibCompliances, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callActiveReceivePackets=callActiveReceivePackets, dialControlMibCompliance=dialControlMibCompliance, dialControlMib=dialControlMib, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, dialCtlPeer=dialCtlPeer, callActiveTable=callActiveTable)
