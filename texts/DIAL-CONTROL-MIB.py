...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, callHistoryTable=callHistoryTable, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialControlMibConformance=dialControlMibConformance, callActiveConnectTime=callActiveConnectTime, callHistoryCallOrigin=callHistoryCallOrigin, callActiveChargedUnits=callActiveChargedUnits, dialCtlTrapEnable=dialCtlTrapEnable, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialControlMibObjects=dialControlMibObjects, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callActiveGroup=callActiveGroup, dialCtlPeerCallInformation=dialCtlPeerCallInformation, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, callActivePeerAddress=callActivePeerAddress, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, callHistoryTableMaxLength=callHistoryTableMaxLength, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callActiveTransmitBytes=callActiveTransmitBytes, callHistoryEntry=callHistoryEntry, callHistoryPeerId=callHistoryPeerId, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialControlMibTraps=dialControlMibTraps, callHistoryConnectTime=callHistoryConnectTime, dialCtlPeer=dialCtlPeer, callActiveCallState=callActiveCallState, callHistoryPeerIfIndex=callHistoryPeerIfIndex, callHistoryGroup=callHistoryGroup, callActiveEntry=callActiveEntry, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callHistoryReceiveBytes=callHistoryReceiveBytes, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, callHistoryInfoType=callHistoryInfoType, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callActiveLogicalIfIndex=callActiveLogicalIfIndex, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, callHistoryRetainTimer=callHistoryRetainTimer, callHistoryTransmitPackets=callHistoryTransmitPackets, callHistoryTransmitBytes=callHistoryTransmitBytes, PYSNMP_MODULE_ID=dialControlMib, callActivePeerSubAddress=callActivePeerSubAddress, AbsoluteCounter32=AbsoluteCounter32, callHistoryDisconnectText=callHistoryDisconnectText, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, callActiveReceivePackets=callActiveReceivePackets, callActiveSetupTime=callActiveSetupTime, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callHistoryDisconnectTime=callHistoryDisconnectTime, dialCtlAcceptMode=dialCtlAcceptMode, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, dialCtlConfiguration=dialCtlConfiguration, callActiveIndex=callActiveIndex, dialCtlPeerCfgId=dialCtlPeerCfgId, callActivePeerIfIndex=callActivePeerIfIndex, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callActiveTransmitPackets=callActiveTransmitPackets, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, callHistoryDisconnectCause=callHistoryDisconnectCause, dialControlMibCompliances=dialControlMibCompliances, dialControlMibCompliance=dialControlMibCompliance, callActiveReceiveBytes=callActiveReceiveBytes, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callActiveInfoType=callActiveInfoType, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialControlGroup=dialControlGroup, callHistory=callHistory, callActivePeerId=callActivePeerId, callHistoryReceivePackets=callHistoryReceivePackets, dialControlMib=dialControlMib, callActive=callActive, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialControlMibGroups=dialControlMibGroups, callActiveCallOrigin=callActiveCallOrigin, callActiveTable=callActiveTable, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress)
