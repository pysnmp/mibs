...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", callActivePeerAddress=callActivePeerAddress, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, callHistoryRetainTimer=callHistoryRetainTimer, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, dialControlMib=dialControlMib, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callHistoryEntry=callHistoryEntry, callHistoryReceiveBytes=callHistoryReceiveBytes, callActiveCallState=callActiveCallState, callHistoryTransmitBytes=callHistoryTransmitBytes, dialControlMibObjects=dialControlMibObjects, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialControlMibTraps=dialControlMibTraps, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialCtlPeerCfgId=dialCtlPeerCfgId, callActiveIndex=callActiveIndex, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, callHistoryPeerId=callHistoryPeerId, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callHistoryTableMaxLength=callHistoryTableMaxLength, callActiveReceiveBytes=callActiveReceiveBytes, dialControlMibCompliances=dialControlMibCompliances, dialCtlTrapEnable=dialCtlTrapEnable, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callActiveEntry=callActiveEntry, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, dialControlMibGroups=dialControlMibGroups, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, callHistoryDisconnectCause=callHistoryDisconnectCause, callHistoryInfoType=callHistoryInfoType, callHistoryGroup=callHistoryGroup, callActiveCallOrigin=callActiveCallOrigin, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, AbsoluteCounter32=AbsoluteCounter32, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, callActivePeerIfIndex=callActivePeerIfIndex, callActiveReceivePackets=callActiveReceivePackets, callActiveTransmitPackets=callActiveTransmitPackets, dialCtlConfiguration=dialCtlConfiguration, callActiveGroup=callActiveGroup, callActiveInfoType=callActiveInfoType, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, dialControlGroup=dialControlGroup, dialControlMibCompliance=dialControlMibCompliance, callHistoryReceivePackets=callHistoryReceivePackets, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callHistoryChargedUnits=callHistoryChargedUnits, callHistoryDisconnectText=callHistoryDisconnectText, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialControlMibTrapPrefix=dialControlMibTrapPrefix, callHistoryPeerAddress=callHistoryPeerAddress, dialControlMibConformance=dialControlMibConformance, callHistory=callHistory, callHistoryDisconnectTime=callHistoryDisconnectTime, dialCtlPeer=dialCtlPeer, callActive=callActive, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, callActivePeerId=callActivePeerId, callHistoryConnectTime=callHistoryConnectTime, callHistoryTable=callHistoryTable, dialCtlAcceptMode=dialCtlAcceptMode, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callHistoryTransmitPackets=callHistoryTransmitPackets, PYSNMP_MODULE_ID=dialControlMib, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callActiveChargedUnits=callActiveChargedUnits, callActiveTable=callActiveTable, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callActiveConnectTime=callActiveConnectTime, callHistoryCallOrigin=callHistoryCallOrigin, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callActivePeerSubAddress=callActivePeerSubAddress, callActiveSetupTime=callActiveSetupTime)
