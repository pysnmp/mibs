...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, callHistoryDisconnectText=callHistoryDisconnectText, dialCtlPeerStatsTable=dialCtlPeerStatsTable, PYSNMP_MODULE_ID=dialControlMib, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, dialControlMibTrapPrefix=dialControlMibTrapPrefix, callActiveEntry=callActiveEntry, callHistoryTableMaxLength=callHistoryTableMaxLength, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, callHistoryTransmitPackets=callHistoryTransmitPackets, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, dialControlMib=dialControlMib, callActiveLogicalIfIndex=callActiveLogicalIfIndex, dialCtlAcceptMode=dialCtlAcceptMode, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, callHistoryEntry=callHistoryEntry, callActiveIndex=callActiveIndex, callActiveChargedUnits=callActiveChargedUnits, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callActiveReceivePackets=callActiveReceivePackets, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, callActiveInfoType=callActiveInfoType, callActiveReceiveBytes=callActiveReceiveBytes, dialControlMibCompliances=dialControlMibCompliances, dialCtlPeerCfgId=dialCtlPeerCfgId, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, callHistoryPeerId=callHistoryPeerId, callHistoryConnectTime=callHistoryConnectTime, callActiveGroup=callActiveGroup, callActivePeerIfIndex=callActivePeerIfIndex, dialControlMibTraps=dialControlMibTraps, callActiveTransmitPackets=callActiveTransmitPackets, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callActiveCallOrigin=callActiveCallOrigin, callActive=callActive, callActiveTable=callActiveTable, callActiveSetupTime=callActiveSetupTime, AbsoluteCounter32=AbsoluteCounter32, dialControlMibObjects=dialControlMibObjects, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, callHistoryGroup=callHistoryGroup, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callHistoryReceiveBytes=callHistoryReceiveBytes, dialCtlConfiguration=dialCtlConfiguration, callHistoryTransmitBytes=callHistoryTransmitBytes, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callHistoryChargedUnits=callHistoryChargedUnits, callActivePeerSubAddress=callActivePeerSubAddress, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, dialCtlPeer=dialCtlPeer, dialCtlPeerCallInformation=dialCtlPeerCallInformation, dialControlMibGroups=dialControlMibGroups, callHistoryPeerAddress=callHistoryPeerAddress, callActiveConnectTime=callActiveConnectTime, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callHistory=callHistory, callHistoryDisconnectCause=callHistoryDisconnectCause, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, callHistoryReceivePackets=callHistoryReceivePackets, dialControlGroup=dialControlGroup, callHistoryDisconnectTime=callHistoryDisconnectTime, dialCtlTrapEnable=dialCtlTrapEnable, dialControlMibCompliance=dialControlMibCompliance, dialControlMibConformance=dialControlMibConformance, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callActivePeerAddress=callActivePeerAddress, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callActivePeerId=callActivePeerId, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, dialCtlPeerCallSetup=dialCtlPeerCallSetup, callActiveCallState=callActiveCallState, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callHistoryCallOrigin=callHistoryCallOrigin, callHistoryTable=callHistoryTable, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callHistoryInfoType=callHistoryInfoType, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callHistoryRetainTimer=callHistoryRetainTimer, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed)
