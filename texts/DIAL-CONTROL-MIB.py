...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlPeer=dialCtlPeer, dialControlMibGroups=dialControlMibGroups, callActiveEntry=callActiveEntry, dialControlMib=dialControlMib, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callActiveIndex=callActiveIndex, callActiveConnectTime=callActiveConnectTime, callActiveChargedUnits=callActiveChargedUnits, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callActivePeerAddress=callActivePeerAddress, callHistoryPeerAddress=callHistoryPeerAddress, callHistoryTransmitPackets=callHistoryTransmitPackets, callActiveReceiveBytes=callActiveReceiveBytes, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialControlMibObjects=dialControlMibObjects, callActiveTransmitPackets=callActiveTransmitPackets, dialCtlTrapEnable=dialCtlTrapEnable, dialCtlPeerCfgTable=dialCtlPeerCfgTable, callHistory=callHistory, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, callHistoryGroup=callHistoryGroup, callActiveCallOrigin=callActiveCallOrigin, dialControlMibTraps=dialControlMibTraps, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callHistoryTableMaxLength=callHistoryTableMaxLength, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlAcceptMode=dialCtlAcceptMode, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callHistoryInfoType=callHistoryInfoType, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, callHistoryDisconnectTime=callHistoryDisconnectTime, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, dialControlMibConformance=dialControlMibConformance, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, callHistoryPeerIfIndex=callHistoryPeerIfIndex, callHistoryTransmitBytes=callHistoryTransmitBytes, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, callHistoryDisconnectText=callHistoryDisconnectText, AbsoluteCounter32=AbsoluteCounter32, dialCtlPeerCallSetup=dialCtlPeerCallSetup, callActiveCallState=callActiveCallState, callActivePeerId=callActivePeerId, dialControlGroup=dialControlGroup, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callActive=callActive, callActiveLogicalIfIndex=callActiveLogicalIfIndex, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callActiveGroup=callActiveGroup, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callHistoryReceivePackets=callHistoryReceivePackets, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callHistoryTable=callHistoryTable, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callHistoryReceiveBytes=callHistoryReceiveBytes, callActivePeerIfIndex=callActivePeerIfIndex, dialControlMibCompliance=dialControlMibCompliance, callHistoryDisconnectCause=callHistoryDisconnectCause, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, callActiveTable=callActiveTable, callHistoryEntry=callHistoryEntry, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callHistoryPeerId=callHistoryPeerId, PYSNMP_MODULE_ID=dialControlMib, dialControlMibCompliances=dialControlMibCompliances, callHistoryRetainTimer=callHistoryRetainTimer, callActiveReceivePackets=callActiveReceivePackets, dialCtlPeerCfgId=dialCtlPeerCfgId, callHistoryConnectTime=callHistoryConnectTime, callActiveSetupTime=callActiveSetupTime, callActiveInfoType=callActiveInfoType, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, callActivePeerSubAddress=callActivePeerSubAddress, callHistoryCallOrigin=callHistoryCallOrigin, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration)
