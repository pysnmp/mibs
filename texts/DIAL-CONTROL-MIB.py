...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, callActiveTransmitPackets=callActiveTransmitPackets, dialCtlPeerCallSetup=dialCtlPeerCallSetup, callHistoryPeerSubAddress=callHistoryPeerSubAddress, callActivePeerIfIndex=callActivePeerIfIndex, callHistoryRetainTimer=callHistoryRetainTimer, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, callHistoryDisconnectCause=callHistoryDisconnectCause, callActiveEntry=callActiveEntry, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, callHistoryDisconnectText=callHistoryDisconnectText, callActiveCallState=callActiveCallState, callActiveIndex=callActiveIndex, callActiveGroup=callActiveGroup, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialCtlConfiguration=dialCtlConfiguration, callActivePeerAddress=callActivePeerAddress, callHistoryConnectTime=callHistoryConnectTime, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callActiveInfoType=callActiveInfoType, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callActiveReceivePackets=callActiveReceivePackets, dialCtlPeerCfgId=dialCtlPeerCfgId, callHistoryTransmitBytes=callHistoryTransmitBytes, callHistoryDisconnectTime=callHistoryDisconnectTime, callHistoryReceivePackets=callHistoryReceivePackets, callHistoryCallOrigin=callHistoryCallOrigin, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callHistoryInfoType=callHistoryInfoType, callActive=callActive, dialCtlPeerCfgTable=dialCtlPeerCfgTable, callHistoryTable=callHistoryTable, dialCtlPeer=dialCtlPeer, callActiveTable=callActiveTable, callHistoryEntry=callHistoryEntry, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, dialCtlAcceptMode=dialCtlAcceptMode, callActivePeerSubAddress=callActivePeerSubAddress, callActiveCallOrigin=callActiveCallOrigin, dialCtlPeerCallInformation=dialCtlPeerCallInformation, dialControlMibTraps=dialControlMibTraps, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callActiveChargedUnits=callActiveChargedUnits, callActiveLogicalIfIndex=callActiveLogicalIfIndex, PYSNMP_MODULE_ID=dialControlMib, AbsoluteCounter32=AbsoluteCounter32, dialCtlTrapEnable=dialCtlTrapEnable, dialControlMib=dialControlMib, dialControlMibCompliances=dialControlMibCompliances, callHistoryChargedUnits=callHistoryChargedUnits, callActiveConnectTime=callActiveConnectTime, callHistoryGroup=callHistoryGroup, dialControlMibCompliance=dialControlMibCompliance, callHistory=callHistory, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callHistoryPeerId=callHistoryPeerId, dialControlMibTrapPrefix=dialControlMibTrapPrefix, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callHistoryTransmitPackets=callHistoryTransmitPackets, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, callHistoryReceiveBytes=callHistoryReceiveBytes, dialControlMibObjects=dialControlMibObjects, callHistoryTableMaxLength=callHistoryTableMaxLength, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialControlMibGroups=dialControlMibGroups, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callActiveReceiveBytes=callActiveReceiveBytes, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callActivePeerId=callActivePeerId, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, callActiveSetupTime=callActiveSetupTime, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callActiveTransmitBytes=callActiveTransmitBytes, dialControlMibConformance=dialControlMibConformance, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialControlGroup=dialControlGroup)
