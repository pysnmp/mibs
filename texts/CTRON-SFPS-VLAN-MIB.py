...
vlanAMRStats, vlanSystem, vlanName, vlanTestAPI, vlanPort, vlanCountAPI, vlanAMRSubnets, vlanAPI, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanSystem", "vlanName", "vlanTestAPI", "vlanPort", "vlanCountAPI", "vlanAMRSubnets", "vlanAPI", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortPortStatus=vlanPortPortStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameVlanRule=vlanNameVlanRule, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortTable=vlanPortTable, vlanNameTable=vlanNameTable, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIRouterPort=sfpsVAPIRouterPort, SfpsAddress=SfpsAddress, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortPortNum=vlanPortPortNum, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemVersion=vlanSystemVersion, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortVlanId=vlanPortVlanId, vlanSystemTable=vlanSystemTable, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputMap=vlanTestAPIOutputMap, HexInteger=HexInteger, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameEntry=vlanNameEntry, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanCountAPITotal=vlanCountAPITotal, vlanNameVlanId=vlanNameVlanId, vlanNameNumUsers=vlanNameNumUsers, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemLastChange=vlanSystemLastChange, vlanPortEntry=vlanPortEntry, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortVlanName=vlanPortVlanName, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortRouterPort=vlanPortRouterPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameStatusTime=vlanNameStatusTime, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameNHash=vlanNameNHash, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemEntry=vlanSystemEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, SfpsSwitchPort=SfpsSwitchPort, VlanSwitchInstance=VlanSwitchInstance, vlanSystemPollCount=vlanSystemPollCount)
