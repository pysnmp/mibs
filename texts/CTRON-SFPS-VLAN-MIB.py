...
vlanPort, vlanAMRSubnets, vlanAMRStats, vlanAPI, vlanCountAPI, vlanName, vlanAMRRules, vlanTestAPI, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAMRSubnets", "vlanAMRStats", "vlanAPI", "vlanCountAPI", "vlanName", "vlanAMRRules", "vlanTestAPI", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameNHash=vlanNameNHash, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, SfpsSwitchPort=SfpsSwitchPort, vlanPortTable=vlanPortTable, vlanSystemEntry=vlanSystemEntry, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemTable=vlanSystemTable, vlanPortPortNum=vlanPortPortNum, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameVlanId=vlanNameVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortVlanId=vlanPortVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemVersion=vlanSystemVersion, vlanNameMappedPorts=vlanNameMappedPorts, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameVlanRule=vlanNameVlanRule, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameVlanName=vlanNameVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemOperTime=vlanSystemOperTime, vlanPortVlanName=vlanPortVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortEntry=vlanPortEntry, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemLastChange=vlanSystemLastChange, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortFloodPolicy=vlanPortFloodPolicy, SfpsAddress=SfpsAddress, vlanNameStatusTime=vlanNameStatusTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemMibRev=vlanSystemMibRev, HexInteger=HexInteger, vlanNameEntry=vlanNameEntry, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameTable=vlanNameTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameIndex=vlanNameIndex, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, VlanSwitchInstance=VlanSwitchInstance, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortRouterPort=vlanPortRouterPort, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRRulesTable=vlanAMRRulesTable)
