...
vlanName, vlanTestAPI, vlanAMRStats, vlanCountAPI, vlanPort, vlanAMRRules, vlanAMRSubnets, vlanSystem, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanTestAPI", "vlanAMRStats", "vlanCountAPI", "vlanPort", "vlanAMRRules", "vlanAMRSubnets", "vlanSystem", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortTable=vlanPortTable, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameNHash=vlanNameNHash, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputTap=vlanTestAPIOutputTap, VlanSwitchInstance=VlanSwitchInstance, vlanPortEntry=vlanPortEntry, vlanNameTable=vlanNameTable, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIPort=vlanTestAPIPort, SfpsSwitchPort=SfpsSwitchPort, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemEntry=vlanSystemEntry, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortPortStatus=vlanPortPortStatus, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanCountAPITotal=vlanCountAPITotal, vlanPortVlanName=vlanPortVlanName, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemMibRev=vlanSystemMibRev, vlanNameVlanId=vlanNameVlanId, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemTable=vlanSystemTable, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortPortNum=vlanPortPortNum, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameVlanName=vlanNameVlanName, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameEntry=vlanNameEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRRulesEntry=vlanAMRRulesEntry, SfpsAddress=SfpsAddress, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameIndex=vlanNameIndex, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemVersion=vlanSystemVersion, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortVlanId=vlanPortVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, HexInteger=HexInteger, vlanSystemLastChange=vlanSystemLastChange, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemPollCount=vlanSystemPollCount, vlanSystemOperTime=vlanSystemOperTime, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIInPort=sfpsVAPIInPort)
