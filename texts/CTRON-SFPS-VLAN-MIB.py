...
# ASN.1 source CTRON-SFPS-VLAN-MIB
# Source digest sha256:b78707a0610856024a3671455259d40288e8760aceda1a5927f96475199ce939
...
vlanNameTable = MibTable((1, 3, 6, 1, 4, 1, 52, 4, 2, 12, 1, 2, 1, 1), ).setMaxAccess("notaccessible")
...
vlanNameEntry = MibTableRow((1, 3, 6, 1, 4, 1, 52, 4, 2, 12, 1, 2, 1, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CTRON-SFPS-VLAN-MIB", "vlanNameNHash"), (0, "CTRON-SFPS-VLAN-MIB", "vlanNameIndex"))
...
vlanSystemTable = MibTable((1, 3, 6, 1, 4, 1, 52, 4, 2, 12, 1, 2, 5, 1), ).setMaxAccess("notaccessible")
...
vlanSystemEntry = MibTableRow((1, 3, 6, 1, 4, 1, 52, 4, 2, 12, 1, 2, 5, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CTRON-SFPS-VLAN-MIB", "vlanSystemSwitchInstance"))
...
vlanTestAPIOutputTable = MibTable((1, 3, 6, 1, 4, 1, 52, 4, 2, 12, 1, 2, 9, 4), ).setMaxAccess("notaccessible")
...
vlanTestAPIOutputEntry = MibTableRow((1, 3, 6, 1, 4, 1, 52, 4, 2, 12, 1, 2, 9, 4, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CTRON-SFPS-VLAN-MIB", "vlanTestAPIOutputIndex"))
...
vlanAMRRulesTable = MibTable((1, 3, 6, 1, 4, 1, 52, 4, 2, 12, 3, 6, 1), ).setMaxAccess("notaccessible")
...
vlanAMRRulesEntry = MibTableRow((1, 3, 6, 1, 4, 1, 52, 4, 2, 12, 3, 6, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CTRON-SFPS-VLAN-MIB", "vlanAMRRulesRule"))
...
vlanPortTable = MibTable((1, 3, 6, 1, 4, 1, 52, 4, 2, 12, 1, 2, 6, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: vlanPortTable.setStatus('mandatory')
if mibBuilder.loadTexts: vlanPortTable.setDescription('')
vlanPortEntry = MibTableRow((1, 3, 6, 1, 4, 1, 52, 4, 2, 12, 1, 2, 6, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CTRON-SFPS-VLAN-MIB", "vlanPortPortNum"))
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", HexInteger=HexInteger, SfpsAddress=SfpsAddress, SfpsSwitchPort=SfpsSwitchPort, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanCountAPITotal=vlanCountAPITotal, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameEntry=vlanNameEntry, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameIndex=vlanNameIndex, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameNHash=vlanNameNHash, vlanNameNumUsers=vlanNameNumUsers, vlanNameOperStatus=vlanNameOperStatus, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameStatusTime=vlanNameStatusTime, vlanNameTable=vlanNameTable, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameVlanId=vlanNameVlanId, vlanNameVlanName=vlanNameVlanName, vlanNameVlanRule=vlanNameVlanRule, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortEntry=vlanPortEntry, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortPortNum=vlanPortPortNum, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortRouterPort=vlanPortRouterPort, vlanPortTable=vlanPortTable, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortVlanId=vlanPortVlanId, vlanPortVlanName=vlanPortVlanName, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemDomainName=vlanSystemDomainName, vlanSystemEntry=vlanSystemEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemLastChange=vlanSystemLastChange, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemMibRev=vlanSystemMibRev, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemOperTime=vlanSystemOperTime, vlanSystemPollCount=vlanSystemPollCount, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemTable=vlanSystemTable, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIVlanName=vlanTestAPIVlanName)
