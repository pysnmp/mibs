...
vlanName, vlanCountAPI, vlanTestAPI, vlanAMRRules, vlanAMRStats, vlanAPI, vlanSystem, vlanPort, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanCountAPI", "vlanTestAPI", "vlanAMRRules", "vlanAMRStats", "vlanAPI", "vlanSystem", "vlanPort", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemLastChange=vlanSystemLastChange, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, SfpsAddress=SfpsAddress, vlanNameNumUsers=vlanNameNumUsers, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameVlanRule=vlanNameVlanRule, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanCountAPITotal=vlanCountAPITotal, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortPortStatus=vlanPortPortStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortEntry=vlanPortEntry, vlanNameEntry=vlanNameEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortVlanId=vlanPortVlanId, vlanNameTable=vlanNameTable, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIPort=vlanTestAPIPort, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemPollCount=vlanSystemPollCount, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortTable=vlanPortTable, vlanNameNHash=vlanNameNHash, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameStatusTime=vlanNameStatusTime, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameVlanId=vlanNameVlanId, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemEntry=vlanSystemEntry, vlanPortPortNum=vlanPortPortNum, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, VlanSwitchInstance=VlanSwitchInstance, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, HexInteger=HexInteger, vlanNameIndex=vlanNameIndex, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemTable=vlanSystemTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRRulesEntry=vlanAMRRulesEntry, SfpsSwitchPort=SfpsSwitchPort, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemVersion=vlanSystemVersion, vlanNameFloodPorts=vlanNameFloodPorts)
