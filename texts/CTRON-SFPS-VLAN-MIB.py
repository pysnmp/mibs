...
vlanPort, vlanAPI, vlanAMRRules, vlanAMRSubnets, vlanName, vlanSystem, vlanCountAPI, vlanTestAPI, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAPI", "vlanAMRRules", "vlanAMRSubnets", "vlanName", "vlanSystem", "vlanCountAPI", "vlanTestAPI", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIPort=vlanTestAPIPort, vlanSystemMibRev=vlanSystemMibRev, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameTable=vlanNameTable, vlanPortLayer3Learning=vlanPortLayer3Learning, SfpsAddress=SfpsAddress, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, HexInteger=HexInteger, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanCountAPITotal=vlanCountAPITotal, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, VlanSwitchInstance=VlanSwitchInstance, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameNumUsers=vlanNameNumUsers, vlanSystemVersion=vlanSystemVersion, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemDomainName=vlanSystemDomainName, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortPortNum=vlanPortPortNum, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameEntry=vlanNameEntry, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameIndex=vlanNameIndex, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameVlanRule=vlanNameVlanRule, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameNHash=vlanNameNHash, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortVlanName=vlanPortVlanName, vlanPortTable=vlanPortTable, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemEntry=vlanSystemEntry, vlanSystemPollCount=vlanSystemPollCount, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortEntry=vlanPortEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortVlanId=vlanPortVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameOperStatus=vlanNameOperStatus, SfpsSwitchPort=SfpsSwitchPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemTable=vlanSystemTable, vlanNameFloodPorts=vlanNameFloodPorts)
