...
vlanTestAPI, vlanPort, vlanAPI, vlanSystem, vlanAMRRules, vlanAMRSubnets, vlanCountAPI, vlanName, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanPort", "vlanAPI", "vlanSystem", "vlanAMRRules", "vlanAMRSubnets", "vlanCountAPI", "vlanName", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortVlanName=vlanPortVlanName, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIPort=vlanTestAPIPort, vlanNameVlanName=vlanNameVlanName, vlanNameNumUsers=vlanNameNumUsers, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemTable=vlanSystemTable, vlanNameTable=vlanNameTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameNHash=vlanNameNHash, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanCountAPITotal=vlanCountAPITotal, vlanNameOperStatus=vlanNameOperStatus, vlanPortPortStatus=vlanPortPortStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemDomainName=vlanSystemDomainName, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortLayer3Learning=vlanPortLayer3Learning, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameEntry=vlanNameEntry, vlanNameStatusTime=vlanNameStatusTime, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIVerb=sfpsVAPIVerb, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortRouterPort=vlanPortRouterPort, vlanPortTable=vlanPortTable, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameVlanId=vlanNameVlanId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortVlanId=vlanPortVlanId, HexInteger=HexInteger, SfpsAddress=SfpsAddress, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemLastChange=vlanSystemLastChange, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemPollCount=vlanSystemPollCount, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemOperTime=vlanSystemOperTime, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemVersion=vlanSystemVersion, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemEntry=vlanSystemEntry, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRRulesEntry=vlanAMRRulesEntry)
