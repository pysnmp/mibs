...
vlanAMRStats, vlanTestAPI, vlanName, vlanCountAPI, vlanPort, vlanSystem, vlanAMRRules, vlanAPI, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanTestAPI", "vlanName", "vlanCountAPI", "vlanPort", "vlanSystem", "vlanAMRRules", "vlanAPI", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameTable=vlanNameTable, sfpsVAPIVerb=sfpsVAPIVerb, vlanCountAPITotal=vlanCountAPITotal, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortEntry=vlanPortEntry, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameIndex=vlanNameIndex, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortVlanId=vlanPortVlanId, sfpsVAPIVlanId=sfpsVAPIVlanId, SfpsSwitchPort=SfpsSwitchPort, vlanSystemOperTime=vlanSystemOperTime, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemVersion=vlanSystemVersion, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemTable=vlanSystemTable, vlanPortPortNum=vlanPortPortNum, vlanNameNumUsers=vlanNameNumUsers, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortPortStatus=vlanPortPortStatus, vlanPortVlanName=vlanPortVlanName, HexInteger=HexInteger, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameEntry=vlanNameEntry, VlanSwitchInstance=VlanSwitchInstance, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortTable=vlanPortTable, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameNHash=vlanNameNHash, vlanNameVlanId=vlanNameVlanId, vlanSystemLastChange=vlanSystemLastChange, vlanNameOperStatus=vlanNameOperStatus, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemMibRev=vlanSystemMibRev, SfpsAddress=SfpsAddress, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemEntry=vlanSystemEntry, vlanNameVlanName=vlanNameVlanName)
