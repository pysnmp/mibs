...
vlanPort, vlanAMRStats, vlanSystem, vlanAMRRules, vlanAMRSubnets, vlanCountAPI, vlanName, vlanAPI, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAMRStats", "vlanSystem", "vlanAMRRules", "vlanAMRSubnets", "vlanCountAPI", "vlanName", "vlanAPI", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIUserAlias=sfpsVAPIUserAlias, HexInteger=HexInteger, vlanSystemMibRev=vlanSystemMibRev, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameStatusTime=vlanNameStatusTime, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortPortStatus=vlanPortPortStatus, vlanNameVlanName=vlanNameVlanName, vlanPortRouterPort=vlanPortRouterPort, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameEntry=vlanNameEntry, vlanNameVlanId=vlanNameVlanId, vlanPortTable=vlanPortTable, vlanNameOperStatus=vlanNameOperStatus, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemPollCount=vlanSystemPollCount, vlanNameNumUsers=vlanNameNumUsers, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, SfpsAddress=SfpsAddress, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortPortNum=vlanPortPortNum, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortVlanId=vlanPortVlanId, vlanNameIndex=vlanNameIndex, vlanSystemVersion=vlanSystemVersion, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortEntry=vlanPortEntry, vlanPortVlanName=vlanPortVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameTable=vlanNameTable, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemAgentIP=vlanSystemAgentIP, SfpsSwitchPort=SfpsSwitchPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIVlanId=vlanTestAPIVlanId, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIVerb=sfpsVAPIVerb, vlanCountAPITotal=vlanCountAPITotal, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemEntry=vlanSystemEntry, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameNHash=vlanNameNHash, vlanSystemTable=vlanSystemTable, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemOperTime=vlanSystemOperTime, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIPort=vlanTestAPIPort)
