...
vlanAMRSubnets, vlanName, vlanAMRRules, vlanPort, vlanAMRStats, vlanAPI, vlanCountAPI, vlanTestAPI, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanName", "vlanAMRRules", "vlanPort", "vlanAMRStats", "vlanAPI", "vlanCountAPI", "vlanTestAPI", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRRulesRule=vlanAMRRulesRule, SfpsSwitchPort=SfpsSwitchPort, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemPollCount=vlanSystemPollCount, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortEntry=vlanPortEntry, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameVlanName=vlanNameVlanName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortVlanId=vlanPortVlanId, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, VlanSwitchInstance=VlanSwitchInstance, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameIndex=vlanNameIndex, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortPortNum=vlanPortPortNum, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameTable=vlanNameTable, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortTable=vlanPortTable, vlanNameNHash=vlanNameNHash, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemTable=vlanSystemTable, vlanSystemMibRev=vlanSystemMibRev, vlanNameStatusTime=vlanNameStatusTime, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIInPort=sfpsVAPIInPort, HexInteger=HexInteger, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemVersion=vlanSystemVersion, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemLastChange=vlanSystemLastChange, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameVlanId=vlanNameVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameEntry=vlanNameEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameNumUsers=vlanNameNumUsers, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemOperTime=vlanSystemOperTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortVlanName=vlanPortVlanName, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, SfpsAddress=SfpsAddress, vlanTestAPIPort=vlanTestAPIPort, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameMappedPorts=vlanNameMappedPorts)
