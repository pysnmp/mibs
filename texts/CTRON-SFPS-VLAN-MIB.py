...
vlanPort, vlanTestAPI, vlanSystem, vlanCountAPI, vlanAMRSubnets, vlanAMRStats, vlanAMRRules, vlanName, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanTestAPI", "vlanSystem", "vlanCountAPI", "vlanAMRSubnets", "vlanAMRStats", "vlanAMRRules", "vlanName", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameOperStatus=vlanNameOperStatus, vlanNameNumUsers=vlanNameNumUsers, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortTable=vlanPortTable, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIVlanName=vlanTestAPIVlanName, HexInteger=HexInteger, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameEntry=vlanNameEntry, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortVlanId=vlanPortVlanId, vlanPortVlanName=vlanPortVlanName, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemEntry=vlanSystemEntry, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemDomainName=vlanSystemDomainName, vlanSystemTable=vlanSystemTable, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemPollCount=vlanSystemPollCount, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemMibRev=vlanSystemMibRev, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortPortNum=vlanPortPortNum, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortEntry=vlanPortEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameVlanRule=vlanNameVlanRule, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanCountAPIAutoreg=vlanCountAPIAutoreg, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameIndex=vlanNameIndex, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemOperTime=vlanSystemOperTime, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, SfpsAddress=SfpsAddress, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameTable=vlanNameTable, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRRulesRule=vlanAMRRulesRule)
