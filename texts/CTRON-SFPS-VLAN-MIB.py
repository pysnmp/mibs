...
vlanAPI, vlanAMRStats, vlanName, vlanPort, vlanAMRRules, vlanAMRSubnets, vlanCountAPI, vlanTestAPI, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanAMRStats", "vlanName", "vlanPort", "vlanAMRRules", "vlanAMRSubnets", "vlanCountAPI", "vlanTestAPI", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameIndex=vlanNameIndex, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanNameVlanName=vlanNameVlanName, HexInteger=HexInteger, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameVlanId=vlanNameVlanId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortEntry=vlanPortEntry, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortPortNum=vlanPortPortNum, vlanSystemDomainName=vlanSystemDomainName, vlanPortVlanId=vlanPortVlanId, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemLastChange=vlanSystemLastChange, vlanCountAPITotal=vlanCountAPITotal, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemEntry=vlanSystemEntry, vlanNameNumUsers=vlanNameNumUsers, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, VlanSwitchInstance=VlanSwitchInstance, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemVersion=vlanSystemVersion, SfpsAddress=SfpsAddress, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, SfpsSwitchPort=SfpsSwitchPort, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemPollCount=vlanSystemPollCount, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemTable=vlanSystemTable, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameTable=vlanNameTable, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameNHash=vlanNameNHash, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameOperStatus=vlanNameOperStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanSystemOperTime=vlanSystemOperTime, vlanPortTable=vlanPortTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIPort=vlanTestAPIPort, vlanPortVlanName=vlanPortVlanName, vlanNameEntry=vlanNameEntry)
