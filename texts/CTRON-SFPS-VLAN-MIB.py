...
vlanAMRStats, vlanAMRSubnets, vlanSystem, vlanName, vlanAMRRules, vlanAPI, vlanPort, vlanCountAPI, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanAMRSubnets", "vlanSystem", "vlanName", "vlanAMRRules", "vlanAPI", "vlanPort", "vlanCountAPI", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortVlanName=vlanPortVlanName, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameTable=vlanNameTable, vlanNameOperStatus=vlanNameOperStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortPortNum=vlanPortPortNum, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameVlanRule=vlanNameVlanRule, HexInteger=HexInteger, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameNHash=vlanNameNHash, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemEntry=vlanSystemEntry, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemVersion=vlanSystemVersion, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortPortStatus=vlanPortPortStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortRouterPort=vlanPortRouterPort, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameVlanName=vlanNameVlanName, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemPollCount=vlanSystemPollCount, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameVlanId=vlanNameVlanId, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemMibRev=vlanSystemMibRev, vlanNameIndex=vlanNameIndex, vlanSystemTable=vlanSystemTable, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortTable=vlanPortTable, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, SfpsAddress=SfpsAddress, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortEntry=vlanPortEntry, vlanNameEntry=vlanNameEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, VlanSwitchInstance=VlanSwitchInstance, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortVlanId=vlanPortVlanId, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex)
