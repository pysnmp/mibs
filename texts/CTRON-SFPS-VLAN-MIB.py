...
vlanAPI, vlanSystem, vlanCountAPI, vlanTestAPI, vlanAMRRules, vlanPort, vlanAMRStats, vlanAMRSubnets, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanSystem", "vlanCountAPI", "vlanTestAPI", "vlanAMRRules", "vlanPort", "vlanAMRStats", "vlanAMRSubnets", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, VlanSwitchInstance=VlanSwitchInstance, vlanNameVlanName=vlanNameVlanName, vlanPortVlanId=vlanPortVlanId, vlanNameTable=vlanNameTable, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameOperStatus=vlanNameOperStatus, vlanNameNHash=vlanNameNHash, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanCountAPITotal=vlanCountAPITotal, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemTable=vlanSystemTable, vlanPortPortNum=vlanPortPortNum, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortTable=vlanPortTable, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanPortRouterPort=vlanPortRouterPort, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameEntry=vlanNameEntry, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameIndex=vlanNameIndex, vlanTestAPIPort=vlanTestAPIPort, vlanSystemVersion=vlanSystemVersion, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPINvramId=sfpsVAPINvramId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameRelayAgent=vlanNameRelayAgent, SfpsAddress=SfpsAddress, SfpsSwitchPort=SfpsSwitchPort, vlanSystemMibRev=vlanSystemMibRev, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, HexInteger=HexInteger, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameNumUsers=vlanNameNumUsers, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemEntry=vlanSystemEntry, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask)
