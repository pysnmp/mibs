...
vlanAPI, vlanAMRRules, vlanCountAPI, vlanAMRSubnets, vlanTestAPI, vlanName, vlanAMRStats, vlanPort, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanAMRRules", "vlanCountAPI", "vlanAMRSubnets", "vlanTestAPI", "vlanName", "vlanAMRStats", "vlanPort", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemDomainName=vlanSystemDomainName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameNHash=vlanNameNHash, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortVlanId=vlanPortVlanId, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortPortNum=vlanPortPortNum, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameVlanId=vlanNameVlanId, vlanPortTable=vlanPortTable, vlanNameTable=vlanNameTable, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortPortStatus=vlanPortPortStatus, vlanPortEntry=vlanPortEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameOperStatus=vlanNameOperStatus, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanCountAPITotal=vlanCountAPITotal, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameStatusTime=vlanNameStatusTime, vlanSystemTable=vlanSystemTable, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameIndex=vlanNameIndex, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIPort=vlanTestAPIPort, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortVlanName=vlanPortVlanName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemVersion=vlanSystemVersion, vlanSystemOperTime=vlanSystemOperTime, vlanNameEntry=vlanNameEntry, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, HexInteger=HexInteger, vlanNameVlanName=vlanNameVlanName, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameFloodPorts=vlanNameFloodPorts, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemPollCount=vlanSystemPollCount, vlanAMRSubnetsMask=vlanAMRSubnetsMask, SfpsAddress=SfpsAddress, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameVlanRule=vlanNameVlanRule, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortLayer3Learning=vlanPortLayer3Learning, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIUserMAC=sfpsVAPIUserMAC)
