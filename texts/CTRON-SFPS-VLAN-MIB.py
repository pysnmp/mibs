...
vlanTestAPI, vlanAMRRules, vlanPort, vlanAPI, vlanCountAPI, vlanAMRStats, vlanName, vlanAMRSubnets, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanAMRRules", "vlanPort", "vlanAPI", "vlanCountAPI", "vlanAMRStats", "vlanName", "vlanAMRSubnets", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanCountAPITotal=vlanCountAPITotal, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameTable=vlanNameTable, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemVersion=vlanSystemVersion, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemEntry=vlanSystemEntry, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameVlanName=vlanNameVlanName, vlanNameNHash=vlanNameNHash, vlanNameOperStatus=vlanNameOperStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortTable=vlanPortTable, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameIndex=vlanNameIndex, vlanSystemDomainName=vlanSystemDomainName, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemMibRev=vlanSystemMibRev, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIPort=vlanTestAPIPort, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortPortNum=vlanPortPortNum, vlanNameStatusTime=vlanNameStatusTime, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameVlanId=vlanNameVlanId, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemTable=vlanSystemTable, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortVlanId=vlanPortVlanId, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameAdminStatus=vlanNameAdminStatus, HexInteger=HexInteger, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemPollCount=vlanSystemPollCount, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemLastChange=vlanSystemLastChange, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameVlanRule=vlanNameVlanRule, vlanPortVlanName=vlanPortVlanName, vlanPortRouterPort=vlanPortRouterPort, VlanSwitchInstance=VlanSwitchInstance, SfpsAddress=SfpsAddress, sfpsVAPIUserAlias=sfpsVAPIUserAlias)
