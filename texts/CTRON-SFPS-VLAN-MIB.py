...
vlanSystem, vlanName, vlanCountAPI, vlanTestAPI, vlanAMRStats, vlanAMRRules, vlanPort, vlanAPI, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanName", "vlanCountAPI", "vlanTestAPI", "vlanAMRStats", "vlanAMRRules", "vlanPort", "vlanAPI", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemMibRev=vlanSystemMibRev, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIVerb=sfpsVAPIVerb, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameNHash=vlanNameNHash, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortPortNum=vlanPortPortNum, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemLastChange=vlanSystemLastChange, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortVlanName=vlanPortVlanName, vlanTestAPIPort=vlanTestAPIPort, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanCountAPIAdmin=vlanCountAPIAdmin, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortVlanId=vlanPortVlanId, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemEntry=vlanSystemEntry, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, HexInteger=HexInteger, vlanNameVlanName=vlanNameVlanName, vlanNameOperStatus=vlanNameOperStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameIndex=vlanNameIndex, vlanNameEntry=vlanNameEntry, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameTable=vlanNameTable, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemVersion=vlanSystemVersion, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, SfpsAddress=SfpsAddress, vlanSystemTable=vlanSystemTable, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputAble=vlanTestAPIOutputAble, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortTable=vlanPortTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameVlanRule=vlanNameVlanRule, vlanPortEntry=vlanPortEntry, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemPollCount=vlanSystemPollCount)
