...
vlanAMRRules, vlanSystem, vlanTestAPI, vlanAMRStats, vlanAPI, vlanCountAPI, vlanPort, vlanAMRSubnets, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanSystem", "vlanTestAPI", "vlanAMRStats", "vlanAPI", "vlanCountAPI", "vlanPort", "vlanAMRSubnets", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPINvramId=sfpsVAPINvramId, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemEntry=vlanSystemEntry, SfpsAddress=SfpsAddress, vlanNameEnabledPorts=vlanNameEnabledPorts, HexInteger=HexInteger, SfpsSwitchPort=SfpsSwitchPort, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanCountAPITotal=vlanCountAPITotal, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemMibRev=vlanSystemMibRev, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameIndex=vlanNameIndex, vlanSystemLastChange=vlanSystemLastChange, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemTable=vlanSystemTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameVlanId=vlanNameVlanId, VlanSwitchInstance=VlanSwitchInstance, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameNumUsers=vlanNameNumUsers, vlanPortTable=vlanPortTable, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameVlanRule=vlanNameVlanRule, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortVlanName=vlanPortVlanName, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameEntry=vlanNameEntry, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortRouterPort=vlanPortRouterPort, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortEntry=vlanPortEntry, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameStatusTime=vlanNameStatusTime, vlanSystemOperTime=vlanSystemOperTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortVlanId=vlanPortVlanId, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameTable=vlanNameTable, vlanTestAPIPort=vlanTestAPIPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortPortStatus=vlanPortPortStatus, vlanPortPortNum=vlanPortPortNum, vlanAMRRulesEntry=vlanAMRRulesEntry)
