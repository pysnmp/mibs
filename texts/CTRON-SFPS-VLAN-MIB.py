...
vlanAMRStats, vlanName, vlanSystem, vlanAPI, vlanAMRRules, vlanTestAPI, vlanPort, vlanCountAPI, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanName", "vlanSystem", "vlanAPI", "vlanAMRRules", "vlanTestAPI", "vlanPort", "vlanCountAPI", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", SfpsAddress=SfpsAddress, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemVersion=vlanSystemVersion, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemEntry=vlanSystemEntry, vlanSystemMibRev=vlanSystemMibRev, vlanNameTable=vlanNameTable, vlanPortEntry=vlanPortEntry, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameVlanId=vlanNameVlanId, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemLastChange=vlanSystemLastChange, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortPortNum=vlanPortPortNum, vlanPortVlanId=vlanPortVlanId, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemPollCount=vlanSystemPollCount, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, HexInteger=HexInteger, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameEntry=vlanNameEntry, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemTable=vlanSystemTable, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIVlanId=sfpsVAPIVlanId, VlanSwitchInstance=VlanSwitchInstance, vlanNameOperStatus=vlanNameOperStatus, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameVlanName=vlanNameVlanName, vlanCountAPITotal=vlanCountAPITotal, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameNHash=vlanNameNHash, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameVlanRule=vlanNameVlanRule, vlanNameIndex=vlanNameIndex, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortVlanName=vlanPortVlanName, vlanNameStatusTime=vlanNameStatusTime, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIPort=vlanTestAPIPort, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortTable=vlanPortTable, vlanPortPortStatus=vlanPortPortStatus)
