...
vlanSystem, vlanAMRRules, vlanAMRStats, vlanPort, vlanName, vlanAPI, vlanTestAPI, vlanCountAPI, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanAMRRules", "vlanAMRStats", "vlanPort", "vlanName", "vlanAPI", "vlanTestAPI", "vlanCountAPI", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameVlanName=vlanNameVlanName, vlanTestAPIPort=vlanTestAPIPort, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemEntry=vlanSystemEntry, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRRulesTable=vlanAMRRulesTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortRouterPort=vlanPortRouterPort, vlanNameTable=vlanNameTable, vlanNameVlanId=vlanNameVlanId, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, SfpsSwitchPort=SfpsSwitchPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortVlanName=vlanPortVlanName, SfpsAddress=SfpsAddress, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortEntry=vlanPortEntry, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemLastChange=vlanSystemLastChange, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameEntry=vlanNameEntry, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPINvramId=sfpsVAPINvramId, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameNHash=vlanNameNHash, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortVlanId=vlanPortVlanId, sfpsVAPIInPort=sfpsVAPIInPort, vlanCountAPITotal=vlanCountAPITotal, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortTable=vlanPortTable, sfpsVAPIUserAlias=sfpsVAPIUserAlias, HexInteger=HexInteger, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameVlanRule=vlanNameVlanRule, vlanSystemPollCount=vlanSystemPollCount, vlanSystemOperTime=vlanSystemOperTime, vlanNameOperStatus=vlanNameOperStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortPortNum=vlanPortPortNum, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIVlanName=vlanTestAPIVlanName)
