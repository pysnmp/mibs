...
vlanPort, vlanAMRRules, vlanSystem, vlanAMRSubnets, vlanCountAPI, vlanTestAPI, vlanAPI, vlanAMRStats, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAMRRules", "vlanSystem", "vlanAMRSubnets", "vlanCountAPI", "vlanTestAPI", "vlanAPI", "vlanAMRStats", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameTable=vlanNameTable, vlanNameVlanName=vlanNameVlanName, vlanNameStatusTime=vlanNameStatusTime, vlanPortPortPolicy=vlanPortPortPolicy, SfpsAddress=SfpsAddress, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortVlanId=vlanPortVlanId, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameVlanRule=vlanNameVlanRule, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemTable=vlanSystemTable, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameEntry=vlanNameEntry, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIInPort=sfpsVAPIInPort, HexInteger=HexInteger, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIPort=vlanTestAPIPort, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, VlanSwitchInstance=VlanSwitchInstance, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemAdminReset=vlanSystemAdminReset, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortEntry=vlanPortEntry, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameNHash=vlanNameNHash, vlanPortTable=vlanPortTable, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameIndex=vlanNameIndex, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemEntry=vlanSystemEntry, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameNumUsers=vlanNameNumUsers, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemOperTime=vlanSystemOperTime, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameVlanId=vlanNameVlanId)
