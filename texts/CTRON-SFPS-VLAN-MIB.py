...
vlanTestAPI, vlanCountAPI, vlanAMRStats, vlanAMRRules, vlanSystem, vlanName, vlanAPI, vlanPort, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanCountAPI", "vlanAMRStats", "vlanAMRRules", "vlanSystem", "vlanName", "vlanAPI", "vlanPort", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortVlanId=vlanPortVlanId, vlanCountAPITotal=vlanCountAPITotal, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemDomainName=vlanSystemDomainName, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortPortNum=vlanPortPortNum, vlanSystemOperStatus=vlanSystemOperStatus, SfpsAddress=SfpsAddress, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortAdminStatus=vlanPortAdminStatus, HexInteger=HexInteger, vlanSystemLastChange=vlanSystemLastChange, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameOperStatus=vlanNameOperStatus, vlanSystemMibRev=vlanSystemMibRev, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemOperTime=vlanSystemOperTime, VlanSwitchInstance=VlanSwitchInstance, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIPort=vlanTestAPIPort, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameTable=vlanNameTable, vlanNameIndex=vlanNameIndex, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameVlanRule=vlanNameVlanRule, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameVlanName=vlanNameVlanName, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortPortStatus=vlanPortPortStatus, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameNumUsers=vlanNameNumUsers, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortVlanName=vlanPortVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemTable=vlanSystemTable, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameStatusTime=vlanNameStatusTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemEntry=vlanSystemEntry, vlanPortRouterPort=vlanPortRouterPort, vlanNameNHash=vlanNameNHash, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortTable=vlanPortTable)
