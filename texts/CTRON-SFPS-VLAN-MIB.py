...
vlanSystem, vlanAMRRules, vlanAMRStats, vlanTestAPI, vlanPort, vlanAMRSubnets, vlanName, vlanAPI, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanAMRRules", "vlanAMRStats", "vlanTestAPI", "vlanPort", "vlanAMRSubnets", "vlanName", "vlanAPI", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemTable=vlanSystemTable, vlanPortLayer3Learning=vlanPortLayer3Learning, SfpsSwitchPort=SfpsSwitchPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemPollCount=vlanSystemPollCount, vlanSystemEntry=vlanSystemEntry, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemOperTime=vlanSystemOperTime, vlanNameOperStatus=vlanNameOperStatus, vlanNameTable=vlanNameTable, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameNHash=vlanNameNHash, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortRelayAgent=vlanPortRelayAgent, vlanCountAPITotal=vlanCountAPITotal, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameEntry=vlanNameEntry, vlanPortVlanId=vlanPortVlanId, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemDomainName=vlanSystemDomainName, vlanPortPortStatus=vlanPortPortStatus, vlanPortVlanName=vlanPortVlanName, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameNumUsers=vlanNameNumUsers, vlanPortPortNum=vlanPortPortNum, vlanSystemLastChange=vlanSystemLastChange, SfpsAddress=SfpsAddress, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameVlanName=vlanNameVlanName, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameVlanRule=vlanNameVlanRule, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIPort=vlanTestAPIPort, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortTable=vlanPortTable, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemVersion=vlanSystemVersion, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRSubnetsMask=vlanAMRSubnetsMask, HexInteger=HexInteger, vlanNameVlanId=vlanNameVlanId, vlanPortEntry=vlanPortEntry, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIVlanId=vlanTestAPIVlanId)
