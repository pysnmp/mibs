...
vlanAMRRules, vlanPort, vlanName, vlanAPI, vlanCountAPI, vlanTestAPI, vlanSystem, vlanAMRSubnets, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanPort", "vlanName", "vlanAPI", "vlanCountAPI", "vlanTestAPI", "vlanSystem", "vlanAMRSubnets", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortTable=vlanPortTable, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortPortNum=vlanPortPortNum, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameNHash=vlanNameNHash, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameStatusTime=vlanNameStatusTime, SfpsSwitchPort=SfpsSwitchPort, HexInteger=HexInteger, vlanPortEntry=vlanPortEntry, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameOperStatus=vlanNameOperStatus, vlanNameTable=vlanNameTable, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortVlanName=vlanPortVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanCountAPITotal=vlanCountAPITotal, vlanSystemOperTime=vlanSystemOperTime, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameEntry=vlanNameEntry, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemAdminStatus=vlanSystemAdminStatus, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameVlanId=vlanNameVlanId, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameVlanRule=vlanNameVlanRule, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemLastChange=vlanSystemLastChange, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, SfpsAddress=SfpsAddress, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameIndex=vlanNameIndex, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemTable=vlanSystemTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameVlanName=vlanNameVlanName, vlanTestAPIPort=vlanTestAPIPort)
