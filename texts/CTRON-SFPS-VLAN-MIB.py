...
vlanAPI, vlanCountAPI, vlanTestAPI, vlanAMRRules, vlanAMRStats, vlanAMRSubnets, vlanPort, vlanName, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanCountAPI", "vlanTestAPI", "vlanAMRRules", "vlanAMRStats", "vlanAMRSubnets", "vlanPort", "vlanName", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortRouterPort=vlanPortRouterPort, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameNHash=vlanNameNHash, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemEntry=vlanSystemEntry, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortVlanName=vlanPortVlanName, vlanCountAPITotal=vlanCountAPITotal, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemVersion=vlanSystemVersion, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortTable=vlanPortTable, vlanPortPortStatus=vlanPortPortStatus, vlanSystemMibRev=vlanSystemMibRev, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameVlanId=vlanNameVlanId, vlanNameTable=vlanNameTable, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameIndex=vlanNameIndex, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameVlanName=vlanNameVlanName, vlanAMRRulesStatus=vlanAMRRulesStatus, SfpsAddress=SfpsAddress, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemDomainName=vlanSystemDomainName, vlanNameNumUsers=vlanNameNumUsers, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, SfpsSwitchPort=SfpsSwitchPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemLastChange=vlanSystemLastChange, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemTable=vlanSystemTable, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIPort=vlanTestAPIPort, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortEntry=vlanPortEntry, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemOperTime=vlanSystemOperTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortVlanId=vlanPortVlanId, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, HexInteger=HexInteger, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag)
