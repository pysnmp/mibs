...
vlanAMRRules, vlanSystem, vlanAMRStats, vlanAMRSubnets, vlanName, vlanAPI, vlanCountAPI, vlanPort, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanSystem", "vlanAMRStats", "vlanAMRSubnets", "vlanName", "vlanAPI", "vlanCountAPI", "vlanPort", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortRelayAgent=vlanPortRelayAgent, vlanCountAPITotal=vlanCountAPITotal, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameVlanRule=vlanNameVlanRule, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortPortStatus=vlanPortPortStatus, vlanSystemMibRev=vlanSystemMibRev, vlanSystemPollCount=vlanSystemPollCount, vlanSystemEntry=vlanSystemEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemOperTime=vlanSystemOperTime, vlanPortVlanName=vlanPortVlanName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameNHash=vlanNameNHash, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameVlanId=vlanNameVlanId, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortTable=vlanPortTable, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortEntry=vlanPortEntry, vlanNameEntry=vlanNameEntry, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameIndex=vlanNameIndex, vlanSystemTable=vlanSystemTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortVlanId=vlanPortVlanId, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, SfpsAddress=SfpsAddress, vlanCountAPIAdmin=vlanCountAPIAdmin, VlanSwitchInstance=VlanSwitchInstance, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortPortNum=vlanPortPortNum, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIPort=vlanTestAPIPort, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameVlanName=vlanNameVlanName, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemVersion=vlanSystemVersion, HexInteger=HexInteger, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameTable=vlanNameTable)
