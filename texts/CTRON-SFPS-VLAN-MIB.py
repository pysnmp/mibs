...
vlanName, vlanAMRRules, vlanPort, vlanSystem, vlanAPI, vlanTestAPI, vlanAMRStats, vlanCountAPI, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanAMRRules", "vlanPort", "vlanSystem", "vlanAPI", "vlanTestAPI", "vlanAMRStats", "vlanCountAPI", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortPortPolicy=vlanPortPortPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameIndex=vlanNameIndex, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, HexInteger=HexInteger, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameVlanId=vlanNameVlanId, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameTable=vlanNameTable, vlanTestAPIPort=vlanTestAPIPort, vlanSystemPollCount=vlanSystemPollCount, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameEntry=vlanNameEntry, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameNHash=vlanNameNHash, vlanPortVlanName=vlanPortVlanName, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameVlanName=vlanNameVlanName, vlanSystemLastChange=vlanSystemLastChange, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemTable=vlanSystemTable, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortTable=vlanPortTable, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortPortNum=vlanPortPortNum, vlanPortVlanId=vlanPortVlanId, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemVersion=vlanSystemVersion, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortEntry=vlanPortEntry, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, SfpsAddress=SfpsAddress, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance)
