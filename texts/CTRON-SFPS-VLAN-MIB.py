...
vlanTestAPI, vlanSystem, vlanAMRStats, vlanCountAPI, vlanName, vlanAMRRules, vlanAMRSubnets, vlanPort, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanSystem", "vlanAMRStats", "vlanCountAPI", "vlanName", "vlanAMRRules", "vlanAMRSubnets", "vlanPort", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameVlanRule=vlanNameVlanRule, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameEntry=vlanNameEntry, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortVlanName=vlanPortVlanName, SfpsSwitchPort=SfpsSwitchPort, vlanNameVlanName=vlanNameVlanName, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameTable=vlanNameTable, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortVlanId=vlanPortVlanId, vlanSystemLastChange=vlanSystemLastChange, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortEntry=vlanPortEntry, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameStatusTime=vlanNameStatusTime, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameVlanId=vlanNameVlanId, HexInteger=HexInteger, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortPortNum=vlanPortPortNum, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemPollCount=vlanSystemPollCount, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIVerb=sfpsVAPIVerb, vlanCountAPITotal=vlanCountAPITotal, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortTable=vlanPortTable, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemVersion=vlanSystemVersion, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameOperStatus=vlanNameOperStatus, SfpsAddress=SfpsAddress, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIVlanId=vlanTestAPIVlanId)
