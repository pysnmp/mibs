...
vlanAMRSubnets, vlanName, vlanPort, vlanAPI, vlanTestAPI, vlanAMRStats, vlanCountAPI, vlanAMRRules, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanName", "vlanPort", "vlanAPI", "vlanTestAPI", "vlanAMRStats", "vlanCountAPI", "vlanAMRRules", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameNumUsers=vlanNameNumUsers, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemTable=vlanSystemTable, sfpsVAPIOutPort=sfpsVAPIOutPort, HexInteger=HexInteger, vlanNameEntry=vlanNameEntry, vlanSystemEntry=vlanSystemEntry, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanCountAPITotal=vlanCountAPITotal, vlanPortRouterPort=vlanPortRouterPort, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortVlanId=vlanPortVlanId, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameVlanName=vlanNameVlanName, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameVlanRule=vlanNameVlanRule, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortVlanName=vlanPortVlanName, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameNHash=vlanNameNHash, vlanNameOperStatus=vlanNameOperStatus, vlanNameTable=vlanNameTable, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortTable=vlanPortTable, vlanNameIndex=vlanNameIndex, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameVlanId=vlanNameVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemLastChange=vlanSystemLastChange, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortEntry=vlanPortEntry, vlanSystemVersion=vlanSystemVersion, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortPortNum=vlanPortPortNum, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, SfpsAddress=SfpsAddress, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameStatusTime=vlanNameStatusTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemPollCount=vlanSystemPollCount, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPINvramId=sfpsVAPINvramId)
