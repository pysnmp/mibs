...
vlanAMRStats, vlanTestAPI, vlanAMRRules, vlanAMRSubnets, vlanPort, vlanAPI, vlanCountAPI, vlanName, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanTestAPI", "vlanAMRRules", "vlanAMRSubnets", "vlanPort", "vlanAPI", "vlanCountAPI", "vlanName", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemEntry=vlanSystemEntry, vlanNameNHash=vlanNameNHash, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemDomainName=vlanSystemDomainName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, HexInteger=HexInteger, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortVlanId=vlanPortVlanId, vlanSystemTable=vlanSystemTable, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanPortPortNum=vlanPortPortNum, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortVlanName=vlanPortVlanName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, VlanSwitchInstance=VlanSwitchInstance, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemAdminStatus=vlanSystemAdminStatus, SfpsAddress=SfpsAddress, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameVlanRule=vlanNameVlanRule, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemPollCount=vlanSystemPollCount, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortEntry=vlanPortEntry, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameIndex=vlanNameIndex, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameVlanId=vlanNameVlanId, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameVlanName=vlanNameVlanName, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortTable=vlanPortTable, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortPortStatus=vlanPortPortStatus, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemVersion=vlanSystemVersion, vlanNameTable=vlanNameTable, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt)
