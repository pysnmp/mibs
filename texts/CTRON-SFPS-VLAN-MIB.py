...
vlanCountAPI, vlanPort, vlanTestAPI, vlanAPI, vlanName, vlanSystem, vlanAMRSubnets, vlanAMRRules, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanPort", "vlanTestAPI", "vlanAPI", "vlanName", "vlanSystem", "vlanAMRSubnets", "vlanAMRRules", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemPollCount=vlanSystemPollCount, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameTable=vlanNameTable, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortUniPolicy=vlanPortUniPolicy, SfpsAddress=SfpsAddress, vlanPortPortStatus=vlanPortPortStatus, vlanNameVlanRule=vlanNameVlanRule, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemEntry=vlanSystemEntry, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortTable=vlanPortTable, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemVersion=vlanSystemVersion, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanCountAPITotal=vlanCountAPITotal, vlanPortPortNum=vlanPortPortNum, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIPort=vlanTestAPIPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIVlanName=sfpsVAPIVlanName, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameVlanName=vlanNameVlanName, vlanNameNHash=vlanNameNHash, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortEntry=vlanPortEntry, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortLayer3Learning=vlanPortLayer3Learning, HexInteger=HexInteger, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, SfpsSwitchPort=SfpsSwitchPort, vlanSystemLastChange=vlanSystemLastChange, vlanSystemMibRev=vlanSystemMibRev, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameIndex=vlanNameIndex, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortVlanId=vlanPortVlanId, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortVlanName=vlanPortVlanName, vlanAMRRulesEntry=vlanAMRRulesEntry)
