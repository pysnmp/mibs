...
vlanAMRRules, vlanAPI, vlanAMRStats, vlanPort, vlanName, vlanSystem, vlanAMRSubnets, vlanCountAPI, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanAPI", "vlanAMRStats", "vlanPort", "vlanName", "vlanSystem", "vlanAMRSubnets", "vlanCountAPI", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameVlanRule=vlanNameVlanRule, vlanPortPortStatus=vlanPortPortStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameIndex=vlanNameIndex, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemPollCount=vlanSystemPollCount, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameEntry=vlanNameEntry, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortRouterPort=vlanPortRouterPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameVlanName=vlanNameVlanName, vlanNameVlanId=vlanNameVlanId, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemLastChange=vlanSystemLastChange, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemVersion=vlanSystemVersion, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemEntry=vlanSystemEntry, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameNHash=vlanNameNHash, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, SfpsAddress=SfpsAddress, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortVlanName=vlanPortVlanName, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameTable=vlanNameTable, SfpsSwitchPort=SfpsSwitchPort, HexInteger=HexInteger, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemDomainName=vlanSystemDomainName, vlanPortEntry=vlanPortEntry, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemTable=vlanSystemTable, vlanTestAPIPort=vlanTestAPIPort, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortTable=vlanPortTable)
