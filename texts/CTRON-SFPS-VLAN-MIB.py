...
vlanSystem, vlanTestAPI, vlanAMRRules, vlanAMRSubnets, vlanCountAPI, vlanPort, vlanName, vlanAPI, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanTestAPI", "vlanAMRRules", "vlanAMRSubnets", "vlanCountAPI", "vlanPort", "vlanName", "vlanAPI", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameNHash=vlanNameNHash, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemVersion=vlanSystemVersion, vlanNameOperStatus=vlanNameOperStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameIndex=vlanNameIndex, vlanPortTable=vlanPortTable, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, SfpsSwitchPort=SfpsSwitchPort, SfpsAddress=SfpsAddress, vlanSystemOperTime=vlanSystemOperTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemLastChange=vlanSystemLastChange, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIPort=vlanTestAPIPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIRouterPort=sfpsVAPIRouterPort, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortEntry=vlanPortEntry, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameTable=vlanNameTable, vlanNameVlanName=vlanNameVlanName, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameEntry=vlanNameEntry, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortPortStatus=vlanPortPortStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemLastPollTime=vlanSystemLastPollTime, HexInteger=HexInteger, vlanPortVlanId=vlanPortVlanId, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemTable=vlanSystemTable, vlanPortVlanName=vlanPortVlanName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortRouterPort=vlanPortRouterPort, vlanSystemMibRev=vlanSystemMibRev, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemEntry=vlanSystemEntry, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortPortNum=vlanPortPortNum)
