...
vlanCountAPI, vlanAPI, vlanPort, vlanTestAPI, vlanSystem, vlanAMRSubnets, vlanAMRStats, vlanName, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAPI", "vlanPort", "vlanTestAPI", "vlanSystem", "vlanAMRSubnets", "vlanAMRStats", "vlanName", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemAdminReset=vlanSystemAdminReset, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemVersion=vlanSystemVersion, vlanPortVlanName=vlanPortVlanName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, HexInteger=HexInteger, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameTable=vlanNameTable, vlanPortPortStatus=vlanPortPortStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameVlanName=vlanNameVlanName, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameEntry=vlanNameEntry, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortTable=vlanPortTable, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, VlanSwitchInstance=VlanSwitchInstance, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameNHash=vlanNameNHash, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortRouterPort=vlanPortRouterPort, vlanNameVlanId=vlanNameVlanId, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIVlanId=vlanTestAPIVlanId, SfpsSwitchPort=SfpsSwitchPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameFloodPolicy=vlanNameFloodPolicy, SfpsAddress=SfpsAddress, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemTable=vlanSystemTable, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemPollCount=vlanSystemPollCount, vlanSystemOperTime=vlanSystemOperTime, vlanPortPortNum=vlanPortPortNum, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortVlanId=vlanPortVlanId, vlanPortEntry=vlanPortEntry, vlanNameIndex=vlanNameIndex)
