...
vlanPort, vlanAMRRules, vlanSystem, vlanCountAPI, vlanName, vlanAMRSubnets, vlanAPI, vlanAMRStats, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAMRRules", "vlanSystem", "vlanCountAPI", "vlanName", "vlanAMRSubnets", "vlanAPI", "vlanAMRStats", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", HexInteger=HexInteger, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemEntry=vlanSystemEntry, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemLastChange=vlanSystemLastChange, VlanSwitchInstance=VlanSwitchInstance, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemTable=vlanSystemTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortEntry=vlanPortEntry, vlanPortTable=vlanPortTable, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortPortNum=vlanPortPortNum, vlanNameOperStatus=vlanNameOperStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameNHash=vlanNameNHash, vlanNameEntry=vlanNameEntry, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameIndex=vlanNameIndex, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemMibRev=vlanSystemMibRev, vlanPortPortStatus=vlanPortPortStatus, SfpsAddress=SfpsAddress, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortRouterPort=vlanPortRouterPort, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemOperTime=vlanSystemOperTime, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameTable=vlanNameTable, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIPort=vlanTestAPIPort, vlanPortVlanId=vlanPortVlanId, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameVlanId=vlanNameVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortVlanName=vlanPortVlanName, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameNumUsers=vlanNameNumUsers, vlanCountAPITotal=vlanCountAPITotal, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy)
