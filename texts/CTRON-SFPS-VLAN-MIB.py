...
vlanPort, vlanAMRRules, vlanCountAPI, vlanAPI, vlanName, vlanSystem, vlanAMRSubnets, vlanTestAPI, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAMRRules", "vlanCountAPI", "vlanAPI", "vlanName", "vlanSystem", "vlanAMRSubnets", "vlanTestAPI", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemTable=vlanSystemTable, vlanNameVlanRule=vlanNameVlanRule, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameTable=vlanNameTable, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIPort=vlanTestAPIPort, vlanPortVlanId=vlanPortVlanId, vlanNameVlanName=vlanNameVlanName, HexInteger=HexInteger, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameStatusTime=vlanNameStatusTime, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameIndex=vlanNameIndex, vlanNameNHash=vlanNameNHash, vlanNameOperStatus=vlanNameOperStatus, vlanPortEntry=vlanPortEntry, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanCountAPITotal=vlanCountAPITotal, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameNumUsers=vlanNameNumUsers, vlanPortPortNum=vlanPortPortNum, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemEntry=vlanSystemEntry, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, SfpsSwitchPort=SfpsSwitchPort, vlanPortRouterPort=vlanPortRouterPort, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortTable=vlanPortTable, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameVlanId=vlanNameVlanId, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemPollCount=vlanSystemPollCount, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemVersion=vlanSystemVersion, vlanNameEntry=vlanNameEntry, vlanSystemAgentIP=vlanSystemAgentIP, SfpsAddress=SfpsAddress, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemLastChange=vlanSystemLastChange)
