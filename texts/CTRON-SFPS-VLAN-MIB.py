...
vlanAMRSubnets, vlanAMRStats, vlanPort, vlanSystem, vlanName, vlanTestAPI, vlanAPI, vlanAMRRules, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanAMRStats", "vlanPort", "vlanSystem", "vlanName", "vlanTestAPI", "vlanAPI", "vlanAMRRules", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortPortStatus=vlanPortPortStatus, vlanNameEntry=vlanNameEntry, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameVlanRule=vlanNameVlanRule, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemLastChange=vlanSystemLastChange, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortVlanName=vlanPortVlanName, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemPollCount=vlanSystemPollCount, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemDomainName=vlanSystemDomainName, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemEntry=vlanSystemEntry, vlanPortRouterPort=vlanPortRouterPort, HexInteger=HexInteger, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameVlanId=vlanNameVlanId, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameIndex=vlanNameIndex, vlanNameNHash=vlanNameNHash, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemAdminReset=vlanSystemAdminReset, vlanCountAPITotal=vlanCountAPITotal, vlanNameMappedPorts=vlanNameMappedPorts, VlanSwitchInstance=VlanSwitchInstance, vlanNameStatusTime=vlanNameStatusTime, vlanSystemTable=vlanSystemTable, vlanNameVlanName=vlanNameVlanName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemOperTime=vlanSystemOperTime, vlanNameNumUsers=vlanNameNumUsers, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, SfpsAddress=SfpsAddress, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortVlanId=vlanPortVlanId, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, SfpsSwitchPort=SfpsSwitchPort, vlanSystemMibRev=vlanSystemMibRev, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortTable=vlanPortTable, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameTable=vlanNameTable, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortEntry=vlanPortEntry)
