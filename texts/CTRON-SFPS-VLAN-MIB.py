...
vlanName, vlanCountAPI, vlanAMRRules, vlanAPI, vlanTestAPI, vlanAMRSubnets, vlanPort, vlanSystem, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanCountAPI", "vlanAMRRules", "vlanAPI", "vlanTestAPI", "vlanAMRSubnets", "vlanPort", "vlanSystem", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", SfpsSwitchPort=SfpsSwitchPort, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameEntry=vlanNameEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortTable=vlanPortTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameIndex=vlanNameIndex, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameVlanName=vlanNameVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemDomainName=vlanSystemDomainName, HexInteger=HexInteger, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemEntry=vlanSystemEntry, sfpsVAPIOutPort=sfpsVAPIOutPort, SfpsAddress=SfpsAddress, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameNHash=vlanNameNHash, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanCountAPITotal=vlanCountAPITotal, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIPort=vlanTestAPIPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortVlanName=vlanPortVlanName, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameVlanId=vlanNameVlanId, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameOperStatus=vlanNameOperStatus, vlanSystemMibRev=vlanSystemMibRev, vlanPortPortStatus=vlanPortPortStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameTable=vlanNameTable, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemVersion=vlanSystemVersion, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortEntry=vlanPortEntry, vlanNameVlanRule=vlanNameVlanRule, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortPortNum=vlanPortPortNum, vlanSystemOperTime=vlanSystemOperTime, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemTable=vlanSystemTable, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameStatusTime=vlanNameStatusTime, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortVlanId=vlanPortVlanId, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameRelayAgent=vlanNameRelayAgent, VlanSwitchInstance=VlanSwitchInstance, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap)
