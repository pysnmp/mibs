...
vlanName, vlanTestAPI, vlanCountAPI, vlanAMRSubnets, vlanPort, vlanAMRStats, vlanSystem, vlanAMRRules, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanTestAPI", "vlanCountAPI", "vlanAMRSubnets", "vlanPort", "vlanAMRStats", "vlanSystem", "vlanAMRRules", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameEntry=vlanNameEntry, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameIndex=vlanNameIndex, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortPortNum=vlanPortPortNum, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemLastChange=vlanSystemLastChange, vlanPortEntry=vlanPortEntry, vlanPortTable=vlanPortTable, vlanPortVlanName=vlanPortVlanName, vlanNameVlanRule=vlanNameVlanRule, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameVlanId=vlanNameVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameNumUsers=vlanNameNumUsers, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameStatusTime=vlanNameStatusTime, vlanNameTable=vlanNameTable, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, HexInteger=HexInteger, vlanAMRRulesRule=vlanAMRRulesRule, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanCountAPITotal=vlanCountAPITotal, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortRouterPort=vlanPortRouterPort, vlanPortPortStatus=vlanPortPortStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameVlanName=vlanNameVlanName, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemTable=vlanSystemTable, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemEntry=vlanSystemEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIPort=vlanTestAPIPort, vlanNameNHash=vlanNameNHash, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemMibRev=vlanSystemMibRev, SfpsAddress=SfpsAddress, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix)
