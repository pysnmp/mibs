...
vlanAMRStats, vlanSystem, vlanTestAPI, vlanAPI, vlanAMRRules, vlanName, vlanAMRSubnets, vlanPort, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanSystem", "vlanTestAPI", "vlanAPI", "vlanAMRRules", "vlanName", "vlanAMRSubnets", "vlanPort", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemVersion=vlanSystemVersion, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameIndex=vlanNameIndex, vlanSystemFirstPollTime=vlanSystemFirstPollTime, HexInteger=HexInteger, SfpsSwitchPort=SfpsSwitchPort, vlanSystemMibRev=vlanSystemMibRev, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameVlanId=vlanNameVlanId, vlanNameVlanName=vlanNameVlanName, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameOperStatus=vlanNameOperStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortVlanName=vlanPortVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemEntry=vlanSystemEntry, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortEntry=vlanPortEntry, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemTable=vlanSystemTable, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameNHash=vlanNameNHash, VlanSwitchInstance=VlanSwitchInstance, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortTable=vlanPortTable, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameTable=vlanNameTable, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortVlanId=vlanPortVlanId, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAdminReset=vlanSystemAdminReset, SfpsAddress=SfpsAddress, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortPortNum=vlanPortPortNum, vlanCountAPITotal=vlanCountAPITotal, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIPort=vlanTestAPIPort, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameStatusTime=vlanNameStatusTime, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortRouterPort=vlanPortRouterPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus)
