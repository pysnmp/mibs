...
vlanPort, vlanCountAPI, vlanSystem, vlanName, vlanTestAPI, vlanAPI, vlanAMRStats, vlanAMRRules, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanCountAPI", "vlanSystem", "vlanName", "vlanTestAPI", "vlanAPI", "vlanAMRStats", "vlanAMRRules", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemDomainName=vlanSystemDomainName, VlanSwitchInstance=VlanSwitchInstance, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameTable=vlanNameTable, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, HexInteger=HexInteger, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortVlanId=vlanPortVlanId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemPollCount=vlanSystemPollCount, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortTable=vlanPortTable, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemVersion=vlanSystemVersion, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameStatusTime=vlanNameStatusTime, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanNameEntry=vlanNameEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameUniPolicy=vlanNameUniPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameVlanId=vlanNameVlanId, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemMibRev=vlanSystemMibRev, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, SfpsAddress=SfpsAddress, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortVlanName=vlanPortVlanName, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemTable=vlanSystemTable, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameIndex=vlanNameIndex, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIPort=vlanTestAPIPort, vlanNameVlanRule=vlanNameVlanRule, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortEntry=vlanPortEntry, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameNHash=vlanNameNHash, vlanSystemOperTime=vlanSystemOperTime, vlanSystemEntry=vlanSystemEntry, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameNumUsers=vlanNameNumUsers)
