...
vlanPort, vlanTestAPI, vlanAPI, vlanAMRRules, vlanAMRSubnets, vlanName, vlanSystem, vlanAMRStats, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanTestAPI", "vlanAPI", "vlanAMRRules", "vlanAMRSubnets", "vlanName", "vlanSystem", "vlanAMRStats", "vlanCountAPI")
ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup")
TimeTicks, Bits, ObjectIdentity, Counter32, Gauge32, ModuleIdentity, IpAddress, Counter64, Integer32, NotificationType, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "ObjectIdentity", "Counter32", "Gauge32", "ModuleIdentity", "IpAddress", "Counter64", "Integer32", "NotificationType", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortVlanName=vlanPortVlanName, vlanPortTable=vlanPortTable, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortRouterPort=vlanPortRouterPort, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameUniPolicy=vlanNameUniPolicy, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortEntry=vlanPortEntry, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemEntry=vlanSystemEntry, vlanPortPortStatus=vlanPortPortStatus, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemDomainName=vlanSystemDomainName, vlanNameIndex=vlanNameIndex, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemOperTime=vlanSystemOperTime, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemTable=vlanSystemTable, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameVlanName=vlanNameVlanName, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameNHash=vlanNameNHash, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemLastPollTime=vlanSystemLastPollTime, SfpsSwitchPort=SfpsSwitchPort, vlanNameVlanId=vlanNameVlanId, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortPortNum=vlanPortPortNum, vlanNameTable=vlanNameTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameEntry=vlanNameEntry, vlanNameOperStatus=vlanNameOperStatus, SfpsAddress=SfpsAddress, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIVerb=vlanTestAPIVerb, HexInteger=HexInteger, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemLastChange=vlanSystemLastChange, vlanNameStatusTime=vlanNameStatusTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemVersion=vlanSystemVersion, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRRulesTable=vlanAMRRulesTable)
