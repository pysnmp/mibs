...
vlanAPI, vlanAMRSubnets, vlanPort, vlanName, vlanSystem, vlanAMRRules, vlanAMRStats, vlanCountAPI, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanAMRSubnets", "vlanPort", "vlanName", "vlanSystem", "vlanAMRRules", "vlanAMRStats", "vlanCountAPI", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", SfpsAddress=SfpsAddress, vlanPortRelayAgent=vlanPortRelayAgent, HexInteger=HexInteger, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemLastChange=vlanSystemLastChange, vlanNameIndex=vlanNameIndex, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameEntry=vlanNameEntry, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortPortNum=vlanPortPortNum, vlanPortVlanId=vlanPortVlanId, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortTable=vlanPortTable, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameNumUsers=vlanNameNumUsers, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameVlanId=vlanNameVlanId, vlanCountAPITotal=vlanCountAPITotal, vlanPortRouterPort=vlanPortRouterPort, SfpsSwitchPort=SfpsSwitchPort, vlanSystemEntry=vlanSystemEntry, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRRulesEntry=vlanAMRRulesEntry, VlanSwitchInstance=VlanSwitchInstance, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameOperStatus=vlanNameOperStatus, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemDomainName=vlanSystemDomainName, vlanNameTable=vlanNameTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortEntry=vlanPortEntry, vlanSystemVersion=vlanSystemVersion, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemPollCount=vlanSystemPollCount, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemTable=vlanSystemTable, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortVlanName=vlanPortVlanName, vlanNameVlanName=vlanNameVlanName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemOperTime=vlanSystemOperTime)
