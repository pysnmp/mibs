...
vlanCountAPI, vlanAMRRules, vlanPort, vlanAMRSubnets, vlanTestAPI, vlanAPI, vlanSystem, vlanName, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAMRRules", "vlanPort", "vlanAMRSubnets", "vlanTestAPI", "vlanAPI", "vlanSystem", "vlanName", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, SfpsAddress=SfpsAddress, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameIndex=vlanNameIndex, HexInteger=HexInteger, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemLastChange=vlanSystemLastChange, vlanNameStatusTime=vlanNameStatusTime, vlanPortEntry=vlanPortEntry, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, VlanSwitchInstance=VlanSwitchInstance, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameVlanRule=vlanNameVlanRule, vlanNameEntry=vlanNameEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameNumUsers=vlanNameNumUsers, vlanNameNHash=vlanNameNHash, vlanSystemMibRev=vlanSystemMibRev, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameTable=vlanNameTable, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameVlanName=vlanNameVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemTable=vlanSystemTable, vlanSystemEntry=vlanSystemEntry, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortPortNum=vlanPortPortNum, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemVersion=vlanSystemVersion, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortTable=vlanPortTable, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanCountAPITotal=vlanCountAPITotal, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortVlanId=vlanPortVlanId, vlanSystemPollCount=vlanSystemPollCount, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt)
