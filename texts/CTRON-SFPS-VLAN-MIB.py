...
vlanTestAPI, vlanCountAPI, vlanPort, vlanAMRRules, vlanSystem, vlanName, vlanAPI, vlanAMRSubnets, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanCountAPI", "vlanPort", "vlanAMRRules", "vlanSystem", "vlanName", "vlanAPI", "vlanAMRSubnets", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameVlanId=vlanNameVlanId, vlanNameNumUsers=vlanNameNumUsers, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortEntry=vlanPortEntry, vlanNameIndex=vlanNameIndex, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortAdminStatus=vlanPortAdminStatus, SfpsAddress=SfpsAddress, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortPortStatus=vlanPortPortStatus, vlanNameVlanName=vlanNameVlanName, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesTable=vlanAMRRulesTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemOperTime=vlanSystemOperTime, vlanNameStatusTime=vlanNameStatusTime, vlanPortPortNum=vlanPortPortNum, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemVersion=vlanSystemVersion, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameTable=vlanNameTable, vlanSystemTable=vlanSystemTable, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortVlanId=vlanPortVlanId, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemEntry=vlanSystemEntry, vlanPortRouterPort=vlanPortRouterPort, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameNHash=vlanNameNHash, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortTable=vlanPortTable, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputPort=vlanTestAPIOutputPort, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIPort=vlanTestAPIPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, HexInteger=HexInteger, vlanNameEntry=vlanNameEntry, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameVlanRule=vlanNameVlanRule, vlanSystemPollCount=vlanSystemPollCount, vlanNameOperStatus=vlanNameOperStatus)
