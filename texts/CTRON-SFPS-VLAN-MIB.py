...
vlanCountAPI, vlanAMRRules, vlanName, vlanSystem, vlanAPI, vlanAMRSubnets, vlanTestAPI, vlanAMRStats, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAMRRules", "vlanName", "vlanSystem", "vlanAPI", "vlanAMRSubnets", "vlanTestAPI", "vlanAMRStats", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameNHash=vlanNameNHash, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortEntry=vlanPortEntry, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemOperTime=vlanSystemOperTime, vlanSystemPollCount=vlanSystemPollCount, vlanSystemLastChange=vlanSystemLastChange, HexInteger=HexInteger, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortPortStatus=vlanPortPortStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, SfpsSwitchPort=SfpsSwitchPort, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameOperStatus=vlanNameOperStatus, SfpsAddress=SfpsAddress, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameVlanRule=vlanNameVlanRule, VlanSwitchInstance=VlanSwitchInstance, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameEntry=vlanNameEntry, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemEntry=vlanSystemEntry, vlanSystemMibRev=vlanSystemMibRev, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRRulesRule=vlanAMRRulesRule, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemTable=vlanSystemTable, vlanPortPortNum=vlanPortPortNum, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemDomainName=vlanSystemDomainName, vlanNameVlanName=vlanNameVlanName, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameVlanId=vlanNameVlanId, vlanPortVlanName=vlanPortVlanName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemVersion=vlanSystemVersion, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameIndex=vlanNameIndex, vlanNameTable=vlanNameTable, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortTable=vlanPortTable)
