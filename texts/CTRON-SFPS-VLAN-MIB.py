...
vlanAMRSubnets, vlanAPI, vlanTestAPI, vlanSystem, vlanAMRStats, vlanCountAPI, vlanAMRRules, vlanPort, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanAPI", "vlanTestAPI", "vlanSystem", "vlanAMRStats", "vlanCountAPI", "vlanAMRRules", "vlanPort", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortVlanId=vlanPortVlanId, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortPortStatus=vlanPortPortStatus, vlanPortVlanName=vlanPortVlanName, SfpsSwitchPort=SfpsSwitchPort, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, HexInteger=HexInteger, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemMibRev=vlanSystemMibRev, vlanPortPortNum=vlanPortPortNum, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemVersion=vlanSystemVersion, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemPollCount=vlanSystemPollCount, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameVlanName=vlanNameVlanName, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameStatusTime=vlanNameStatusTime, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameTable=vlanNameTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortRouterPort=vlanPortRouterPort, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameVlanId=vlanNameVlanId, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameNHash=vlanNameNHash, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameOperStatus=vlanNameOperStatus, vlanSystemTable=vlanSystemTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, SfpsAddress=SfpsAddress, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortEntry=vlanPortEntry, vlanNameNumUsers=vlanNameNumUsers, vlanNameAdminStatus=vlanNameAdminStatus, vlanCountAPITotal=vlanCountAPITotal, vlanNameEntry=vlanNameEntry, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortTable=vlanPortTable, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameMappedPorts=vlanNameMappedPorts)
