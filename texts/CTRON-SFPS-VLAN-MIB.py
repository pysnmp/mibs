...
vlanName, vlanCountAPI, vlanTestAPI, vlanSystem, vlanPort, vlanAPI, vlanAMRSubnets, vlanAMRStats, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanCountAPI", "vlanTestAPI", "vlanSystem", "vlanPort", "vlanAPI", "vlanAMRSubnets", "vlanAMRStats", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameVlanRule=vlanNameVlanRule, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortVlanName=vlanPortVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameVlanName=vlanNameVlanName, vlanSystemOperStatus=vlanSystemOperStatus, VlanSwitchInstance=VlanSwitchInstance, vlanAMRRulesTable=vlanAMRRulesTable, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameNHash=vlanNameNHash, vlanNameTable=vlanNameTable, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameOperStatus=vlanNameOperStatus, vlanSystemOperTime=vlanSystemOperTime, HexInteger=HexInteger, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemTable=vlanSystemTable, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemLastChange=vlanSystemLastChange, vlanPortRouterPort=vlanPortRouterPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameStatusTime=vlanNameStatusTime, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemVersion=vlanSystemVersion, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameIndex=vlanNameIndex, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIPort=vlanTestAPIPort, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, SfpsAddress=SfpsAddress, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemEntry=vlanSystemEntry, vlanNameVlanId=vlanNameVlanId, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortPortStatus=vlanPortPortStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortEntry=vlanPortEntry, vlanSystemPollCount=vlanSystemPollCount, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortTable=vlanPortTable, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemDomainName=vlanSystemDomainName, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask)
