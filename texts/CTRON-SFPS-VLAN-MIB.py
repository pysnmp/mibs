...
vlanAMRStats, vlanCountAPI, vlanAPI, vlanName, vlanPort, vlanTestAPI, vlanAMRRules, vlanSystem, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanCountAPI", "vlanAPI", "vlanName", "vlanPort", "vlanTestAPI", "vlanAMRRules", "vlanSystem", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameVlanName=vlanNameVlanName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortPortNum=vlanPortPortNum, vlanNameIndex=vlanNameIndex, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemOperStatus=vlanSystemOperStatus, SfpsSwitchPort=SfpsSwitchPort, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameNHash=vlanNameNHash, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameStatusTime=vlanNameStatusTime, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortRouterPort=vlanPortRouterPort, vlanSystemOperTime=vlanSystemOperTime, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameVlanId=vlanNameVlanId, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemTable=vlanSystemTable, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameTable=vlanNameTable, HexInteger=HexInteger, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortVlanId=vlanPortVlanId, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRRulesEntry=vlanAMRRulesEntry, VlanSwitchInstance=VlanSwitchInstance, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortTable=vlanPortTable, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortEntry=vlanPortEntry, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortVlanName=vlanPortVlanName, vlanNameNumUsers=vlanNameNumUsers, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIUserMAC=sfpsVAPIUserMAC, SfpsAddress=SfpsAddress, vlanSystemVersion=vlanSystemVersion, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIPort=vlanTestAPIPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameEntry=vlanNameEntry, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRRulesStatus=vlanAMRRulesStatus)
