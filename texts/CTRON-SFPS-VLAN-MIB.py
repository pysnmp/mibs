...
vlanTestAPI, vlanAMRSubnets, vlanName, vlanAPI, vlanPort, vlanAMRRules, vlanCountAPI, vlanAMRStats, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanAMRSubnets", "vlanName", "vlanAPI", "vlanPort", "vlanAMRRules", "vlanCountAPI", "vlanAMRStats", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortVlanName=vlanPortVlanName, vlanNameVlanRule=vlanNameVlanRule, vlanSystemDomainName=vlanSystemDomainName, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemLastChange=vlanSystemLastChange, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortPortNum=vlanPortPortNum, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, SfpsAddress=SfpsAddress, vlanPortVlanId=vlanPortVlanId, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemTable=vlanSystemTable, vlanNameTable=vlanNameTable, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemMibRev=vlanSystemMibRev, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, HexInteger=HexInteger, vlanNameOperStatus=vlanNameOperStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemEntry=vlanSystemEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanCountAPITotal=vlanCountAPITotal, vlanSystemVersion=vlanSystemVersion, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameNHash=vlanNameNHash, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, VlanSwitchInstance=VlanSwitchInstance, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameVlanName=vlanNameVlanName, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortTable=vlanPortTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameEntry=vlanNameEntry, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex)
