...
vlanSystem, vlanTestAPI, vlanAMRSubnets, vlanPort, vlanCountAPI, vlanName, vlanAMRRules, vlanAPI, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanTestAPI", "vlanAMRSubnets", "vlanPort", "vlanCountAPI", "vlanName", "vlanAMRRules", "vlanAPI", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortPortPolicy=vlanPortPortPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortPortNum=vlanPortPortNum, vlanPortVlanName=vlanPortVlanName, vlanNameEntry=vlanNameEntry, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortTable=vlanPortTable, sfpsVAPINvramId=sfpsVAPINvramId, HexInteger=HexInteger, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameIndex=vlanNameIndex, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemOperTime=vlanSystemOperTime, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortRouterPort=vlanPortRouterPort, vlanPortEntry=vlanPortEntry, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameTable=vlanNameTable, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemDomainName=vlanSystemDomainName, vlanPortLayer3Learning=vlanPortLayer3Learning, SfpsAddress=SfpsAddress, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameVlanName=vlanNameVlanName, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemEntry=vlanSystemEntry, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIPort=vlanTestAPIPort, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemPollCount=vlanSystemPollCount, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameOperStatus=vlanNameOperStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameVlanId=vlanNameVlanId, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemMibRev=vlanSystemMibRev, vlanPortPortStatus=vlanPortPortStatus, vlanSystemTable=vlanSystemTable, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemPriorPollTime=vlanSystemPriorPollTime)
