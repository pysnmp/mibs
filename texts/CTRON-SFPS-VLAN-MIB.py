...
vlanCountAPI, vlanSystem, vlanAMRSubnets, vlanAPI, vlanAMRStats, vlanAMRRules, vlanName, vlanTestAPI, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanSystem", "vlanAMRSubnets", "vlanAPI", "vlanAMRStats", "vlanAMRRules", "vlanName", "vlanTestAPI", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameNHash=vlanNameNHash, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemMibRev=vlanSystemMibRev, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortVlanId=vlanPortVlanId, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortPortNum=vlanPortPortNum, vlanNameNumUsers=vlanNameNumUsers, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIPort=vlanTestAPIPort, SfpsSwitchPort=SfpsSwitchPort, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemDomainName=vlanSystemDomainName, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortRouterPort=vlanPortRouterPort, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameMappedPorts=vlanNameMappedPorts, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameVlanName=vlanNameVlanName, vlanSystemLastChange=vlanSystemLastChange, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameEntry=vlanNameEntry, SfpsAddress=SfpsAddress, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameTable=vlanNameTable, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameVlanRule=vlanNameVlanRule, vlanPortTable=vlanPortTable, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemTable=vlanSystemTable, vlanSystemPollCount=vlanSystemPollCount, HexInteger=HexInteger, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortVlanName=vlanPortVlanName, vlanSystemVersion=vlanSystemVersion, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortPortStatus=vlanPortPortStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemOperTime=vlanSystemOperTime, vlanNameVlanId=vlanNameVlanId, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRRulesEntry=vlanAMRRulesEntry)
