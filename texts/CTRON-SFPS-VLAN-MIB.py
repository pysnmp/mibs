...
vlanAMRStats, vlanTestAPI, vlanAPI, vlanSystem, vlanAMRRules, vlanName, vlanAMRSubnets, vlanPort, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanTestAPI", "vlanAPI", "vlanSystem", "vlanAMRRules", "vlanName", "vlanAMRSubnets", "vlanPort", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemEntry=vlanSystemEntry, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameMappedPorts=vlanNameMappedPorts, SfpsAddress=SfpsAddress, vlanSystemVersion=vlanSystemVersion, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIPort=vlanTestAPIPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortVlanName=vlanPortVlanName, vlanPortTable=vlanPortTable, HexInteger=HexInteger, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameStatusTime=vlanNameStatusTime, vlanNameIndex=vlanNameIndex, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameEntry=vlanNameEntry, vlanSystemPollCount=vlanSystemPollCount, vlanNameVlanName=vlanNameVlanName, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemDomainName=vlanSystemDomainName, vlanNameVlanId=vlanNameVlanId, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemTable=vlanSystemTable, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameNHash=vlanNameNHash, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortPortNum=vlanPortPortNum, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, VlanSwitchInstance=VlanSwitchInstance, vlanPortPortStatus=vlanPortPortStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameTable=vlanNameTable, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemOperTime=vlanSystemOperTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortAdminStatus=vlanPortAdminStatus, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortRouterPort=vlanPortRouterPort, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortVlanId=vlanPortVlanId, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortEntry=vlanPortEntry, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameAdminStatus=vlanNameAdminStatus)
