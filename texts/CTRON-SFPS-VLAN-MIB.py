...
vlanName, vlanTestAPI, vlanPort, vlanAMRSubnets, vlanAPI, vlanAMRStats, vlanCountAPI, vlanSystem, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanTestAPI", "vlanPort", "vlanAMRSubnets", "vlanAPI", "vlanAMRStats", "vlanCountAPI", "vlanSystem", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemVersion=vlanSystemVersion, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameEntry=vlanNameEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameVlanRule=vlanNameVlanRule, VlanSwitchInstance=VlanSwitchInstance, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortEntry=vlanPortEntry, vlanPortPortNum=vlanPortPortNum, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameNHash=vlanNameNHash, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortVlanName=vlanPortVlanName, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanSystemLastChange=vlanSystemLastChange, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemEntry=vlanSystemEntry, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameOperStatus=vlanNameOperStatus, vlanPortPortStatus=vlanPortPortStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameIndex=vlanNameIndex, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameTable=vlanNameTable, vlanNameVlanName=vlanNameVlanName, vlanCountAPITotal=vlanCountAPITotal, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemPollCount=vlanSystemPollCount, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameVlanId=vlanNameVlanId, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIPort=vlanTestAPIPort, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemMibRev=vlanSystemMibRev, vlanPortUniPolicy=vlanPortUniPolicy, HexInteger=HexInteger, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortVlanId=vlanPortVlanId, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, SfpsAddress=SfpsAddress, SfpsSwitchPort=SfpsSwitchPort, vlanPortTable=vlanPortTable, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy)
