...
vlanName, vlanAPI, vlanAMRSubnets, vlanTestAPI, vlanCountAPI, vlanSystem, vlanAMRStats, vlanAMRRules, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanAPI", "vlanAMRSubnets", "vlanTestAPI", "vlanCountAPI", "vlanSystem", "vlanAMRStats", "vlanAMRRules", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameIndex=vlanNameIndex, vlanNameVlanRule=vlanNameVlanRule, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputMap=vlanTestAPIOutputMap, HexInteger=HexInteger, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemLastChange=vlanSystemLastChange, SfpsAddress=SfpsAddress, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameNumUsers=vlanNameNumUsers, vlanNameVlanName=vlanNameVlanName, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemPollCount=vlanSystemPollCount, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemVersion=vlanSystemVersion, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortTable=vlanPortTable, vlanNameVlanId=vlanNameVlanId, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, VlanSwitchInstance=VlanSwitchInstance, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanCountAPITotal=vlanCountAPITotal, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemTable=vlanSystemTable, vlanNameNHash=vlanNameNHash, vlanPortVlanName=vlanPortVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemEntry=vlanSystemEntry, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortEntry=vlanPortEntry, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortPortStatus=vlanPortPortStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameEntry=vlanNameEntry, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameTable=vlanNameTable, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortVlanId=vlanPortVlanId, vlanPortPortNum=vlanPortPortNum, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameStatusTime=vlanNameStatusTime)
