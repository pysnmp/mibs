...
vlanAMRSubnets, vlanAPI, vlanSystem, vlanCountAPI, vlanPort, vlanAMRStats, vlanAMRRules, vlanTestAPI, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanAPI", "vlanSystem", "vlanCountAPI", "vlanPort", "vlanAMRStats", "vlanAMRRules", "vlanTestAPI", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemTable=vlanSystemTable, vlanPortPortNum=vlanPortPortNum, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortRouterPort=vlanPortRouterPort, vlanPortEntry=vlanPortEntry, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameEntry=vlanNameEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIPort=vlanTestAPIPort, SfpsSwitchPort=SfpsSwitchPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameRelayAgent=vlanNameRelayAgent, HexInteger=HexInteger, vlanPortPortStatus=vlanPortPortStatus, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemEntry=vlanSystemEntry, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortTable=vlanPortTable, vlanSystemVersion=vlanSystemVersion, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemLastChange=vlanSystemLastChange, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanCountAPITotal=vlanCountAPITotal, vlanNameNumUsers=vlanNameNumUsers, vlanSystemDomainName=vlanSystemDomainName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortVlanName=vlanPortVlanName, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameTable=vlanNameTable, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameVlanId=vlanNameVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameVlanName=vlanNameVlanName, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameIndex=vlanNameIndex, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRRulesRule=vlanAMRRulesRule, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemOperTime=vlanSystemOperTime, SfpsAddress=SfpsAddress, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemMibRev=vlanSystemMibRev, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameStatusTime=vlanNameStatusTime, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortVlanId=vlanPortVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemOperStatus=vlanSystemOperStatus)
