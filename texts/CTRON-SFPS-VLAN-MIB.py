...
vlanPort, vlanSystem, vlanTestAPI, vlanAMRSubnets, vlanName, vlanAMRStats, vlanAPI, vlanCountAPI, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanSystem", "vlanTestAPI", "vlanAMRSubnets", "vlanName", "vlanAMRStats", "vlanAPI", "vlanCountAPI", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameEntry=vlanNameEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortEntry=vlanPortEntry, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameTable=vlanNameTable, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameIndex=vlanNameIndex, vlanSystemOperTime=vlanSystemOperTime, SfpsSwitchPort=SfpsSwitchPort, vlanAMRRulesRule=vlanAMRRulesRule, vlanCountAPIAdmin=vlanCountAPIAdmin, SfpsAddress=SfpsAddress, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortVlanName=vlanPortVlanName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, VlanSwitchInstance=VlanSwitchInstance, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemTable=vlanSystemTable, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanCountAPITotal=vlanCountAPITotal, vlanPortTable=vlanPortTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemEntry=vlanSystemEntry, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRRulesTable=vlanAMRRulesTable, HexInteger=HexInteger, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortPortNum=vlanPortPortNum, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemMibRev=vlanSystemMibRev, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameStatusTime=vlanNameStatusTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameVlanName=vlanNameVlanName, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemVersion=vlanSystemVersion, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortVlanId=vlanPortVlanId, vlanPortRouterPort=vlanPortRouterPort, vlanSystemPollCount=vlanSystemPollCount, vlanNameNHash=vlanNameNHash, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameOperStatus=vlanNameOperStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputPort=vlanTestAPIOutputPort)
