...
vlanName, vlanPort, vlanCountAPI, vlanAMRStats, vlanAMRSubnets, vlanAMRRules, vlanSystem, vlanAPI, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanPort", "vlanCountAPI", "vlanAMRStats", "vlanAMRSubnets", "vlanAMRRules", "vlanSystem", "vlanAPI", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameTable=vlanNameTable, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameOperStatus=vlanNameOperStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemLastChange=vlanSystemLastChange, vlanNameMappedPorts=vlanNameMappedPorts, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameIndex=vlanNameIndex, vlanNameNHash=vlanNameNHash, SfpsAddress=SfpsAddress, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, HexInteger=HexInteger, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameVlanId=vlanNameVlanId, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameEntry=vlanNameEntry, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemVersion=vlanSystemVersion, vlanNameStatusTime=vlanNameStatusTime, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemTable=vlanSystemTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemOperTime=vlanSystemOperTime, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortVlanName=vlanPortVlanName, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIUserMAC=sfpsVAPIUserMAC, VlanSwitchInstance=VlanSwitchInstance, vlanPortEntry=vlanPortEntry, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemPollCount=vlanSystemPollCount, vlanNameVlanRule=vlanNameVlanRule, vlanCountAPITotal=vlanCountAPITotal, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemEntry=vlanSystemEntry, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIPort=vlanTestAPIPort, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortTable=vlanPortTable, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRRulesTable=vlanAMRRulesTable)
