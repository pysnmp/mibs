...
vlanPort, vlanAMRSubnets, vlanAPI, vlanSystem, vlanName, vlanAMRRules, vlanTestAPI, vlanAMRStats, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAMRSubnets", "vlanAPI", "vlanSystem", "vlanName", "vlanAMRRules", "vlanTestAPI", "vlanAMRStats", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameAdminStatus=vlanNameAdminStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortPortStatus=vlanPortPortStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortEntry=vlanPortEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortPortPolicy=vlanPortPortPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanNameEnabledPorts=vlanNameEnabledPorts, HexInteger=HexInteger, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameTable=vlanNameTable, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemVersion=vlanSystemVersion, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemEntry=vlanSystemEntry, vlanTestAPIPort=vlanTestAPIPort, vlanNameVlanName=vlanNameVlanName, vlanNameIndex=vlanNameIndex, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemTable=vlanSystemTable, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameVlanRule=vlanNameVlanRule, vlanNameOperStatus=vlanNameOperStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortVlanName=vlanPortVlanName, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIVerb=sfpsVAPIVerb, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemOperTime=vlanSystemOperTime, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameEntry=vlanNameEntry, vlanPortVlanId=vlanPortVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemMibRev=vlanSystemMibRev, vlanSystemPollCount=vlanSystemPollCount, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortRelayAgent=vlanPortRelayAgent, SfpsAddress=SfpsAddress, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortTable=vlanPortTable, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameVlanId=vlanNameVlanId)
