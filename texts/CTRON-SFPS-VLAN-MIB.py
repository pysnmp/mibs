...
vlanAMRSubnets, vlanSystem, vlanAPI, vlanTestAPI, vlanAMRRules, vlanCountAPI, vlanPort, vlanAMRStats, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanSystem", "vlanAPI", "vlanTestAPI", "vlanAMRRules", "vlanCountAPI", "vlanPort", "vlanAMRStats", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameStatusTime=vlanNameStatusTime, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameVlanId=vlanNameVlanId, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputTable=vlanTestAPIOutputTable, SfpsAddress=SfpsAddress, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemLastChange=vlanSystemLastChange, vlanSystemTable=vlanSystemTable, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameIndex=vlanNameIndex, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortPortStatus=vlanPortPortStatus, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortVlanName=vlanPortVlanName, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemPollCount=vlanSystemPollCount, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputPort=vlanTestAPIOutputPort, VlanSwitchInstance=VlanSwitchInstance, vlanNameVlanName=vlanNameVlanName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, HexInteger=HexInteger, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortRouterPort=vlanPortRouterPort, vlanPortTable=vlanPortTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameTable=vlanNameTable, vlanSystemVersion=vlanSystemVersion, vlanPortEntry=vlanPortEntry, vlanSystemDomainName=vlanSystemDomainName, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameEntry=vlanNameEntry, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameVlanRule=vlanNameVlanRule, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemEntry=vlanSystemEntry, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemOperTime=vlanSystemOperTime)
