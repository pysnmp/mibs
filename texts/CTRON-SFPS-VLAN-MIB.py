...
vlanAMRStats, vlanPort, vlanSystem, vlanName, vlanAMRSubnets, vlanAPI, vlanTestAPI, vlanCountAPI, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanPort", "vlanSystem", "vlanName", "vlanAMRSubnets", "vlanAPI", "vlanTestAPI", "vlanCountAPI", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortEntry=vlanPortEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortTable=vlanPortTable, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameEntry=vlanNameEntry, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameTable=vlanNameTable, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortPortNum=vlanPortPortNum, vlanNameVlanName=vlanNameVlanName, vlanPortRouterPort=vlanPortRouterPort, vlanNameStatusTime=vlanNameStatusTime, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameIndex=vlanNameIndex, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameVlanRule=vlanNameVlanRule, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemOperTime=vlanSystemOperTime, vlanSystemTable=vlanSystemTable, vlanSystemOperStatus=vlanSystemOperStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, VlanSwitchInstance=VlanSwitchInstance, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, SfpsSwitchPort=SfpsSwitchPort, vlanNameNHash=vlanNameNHash, vlanSystemVersion=vlanSystemVersion, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortVlanName=vlanPortVlanName, vlanNameOperStatus=vlanNameOperStatus, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemEntry=vlanSystemEntry, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemPollCount=vlanSystemPollCount, vlanSystemDomainName=vlanSystemDomainName, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIPort=vlanTestAPIPort, SfpsAddress=SfpsAddress, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameVlanId=vlanNameVlanId, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, HexInteger=HexInteger, vlanSystemAdminReset=vlanSystemAdminReset)
