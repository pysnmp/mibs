...
vlanAMRRules, vlanPort, vlanAMRSubnets, vlanSystem, vlanAMRStats, vlanTestAPI, vlanAPI, vlanCountAPI, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanPort", "vlanAMRSubnets", "vlanSystem", "vlanAMRStats", "vlanTestAPI", "vlanAPI", "vlanCountAPI", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, SfpsSwitchPort=SfpsSwitchPort, vlanPortEntry=vlanPortEntry, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameVlanId=vlanNameVlanId, vlanNameOperStatus=vlanNameOperStatus, vlanNameVlanName=vlanNameVlanName, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, SfpsAddress=SfpsAddress, vlanTestAPIPort=vlanTestAPIPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortTable=vlanPortTable, vlanPortVlanId=vlanPortVlanId, vlanPortPortNum=vlanPortPortNum, vlanPortPortStatus=vlanPortPortStatus, vlanNameEntry=vlanNameEntry, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemTable=vlanSystemTable, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameIndex=vlanNameIndex, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanNameStatusTime=vlanNameStatusTime, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameTable=vlanNameTable, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameNHash=vlanNameNHash, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemPollCount=vlanSystemPollCount, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemMibRev=vlanSystemMibRev, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, HexInteger=HexInteger, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortRouterPort=vlanPortRouterPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemEntry=vlanSystemEntry, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortVlanName=vlanPortVlanName, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputTap=vlanTestAPIOutputTap, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap)
