...
vlanPort, vlanAPI, vlanTestAPI, vlanAMRRules, vlanAMRSubnets, vlanSystem, vlanAMRStats, vlanCountAPI, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAPI", "vlanTestAPI", "vlanAMRRules", "vlanAMRSubnets", "vlanSystem", "vlanAMRStats", "vlanCountAPI", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameVlanRule=vlanNameVlanRule, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameVlanName=vlanNameVlanName, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortPortNum=vlanPortPortNum, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortVlanId=vlanPortVlanId, vlanSystemEntry=vlanSystemEntry, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameEntry=vlanNameEntry, vlanNameVlanId=vlanNameVlanId, vlanSystemMibRev=vlanSystemMibRev, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameTable=vlanNameTable, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortVlanName=vlanPortVlanName, vlanNameStatusTime=vlanNameStatusTime, vlanPortPortStatus=vlanPortPortStatus, vlanSystemOperTime=vlanSystemOperTime, vlanNameOperStatus=vlanNameOperStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, SfpsAddress=SfpsAddress, vlanNameNHash=vlanNameNHash, vlanSystemTable=vlanSystemTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, HexInteger=HexInteger, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortEntry=vlanPortEntry, vlanNameNumUsers=vlanNameNumUsers, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameIndex=vlanNameIndex, vlanSystemVersion=vlanSystemVersion, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, SfpsSwitchPort=SfpsSwitchPort, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortTable=vlanPortTable, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortLayer3Learning=vlanPortLayer3Learning)
