...
vlanPort, vlanAMRSubnets, vlanAMRRules, vlanName, vlanSystem, vlanCountAPI, vlanAPI, vlanAMRStats, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAMRSubnets", "vlanAMRRules", "vlanName", "vlanSystem", "vlanCountAPI", "vlanAPI", "vlanAMRStats", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemTable=vlanSystemTable, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemLastChange=vlanSystemLastChange, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemEntry=vlanSystemEntry, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemPriorPollTime=vlanSystemPriorPollTime, HexInteger=HexInteger, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, SfpsSwitchPort=SfpsSwitchPort, vlanPortVlanName=vlanPortVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameVlanId=vlanNameVlanId, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortVlanId=vlanPortVlanId, vlanCountAPITotal=vlanCountAPITotal, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, VlanSwitchInstance=VlanSwitchInstance, vlanPortPortStatus=vlanPortPortStatus, vlanPortEntry=vlanPortEntry, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameNHash=vlanNameNHash, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameNumUsers=vlanNameNumUsers, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameVlanName=vlanNameVlanName, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameEntry=vlanNameEntry, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, SfpsAddress=SfpsAddress, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameTable=vlanNameTable, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameVlanRule=vlanNameVlanRule, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortTable=vlanPortTable, vlanPortRouterPort=vlanPortRouterPort, vlanSystemVersion=vlanSystemVersion, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIVlanId=vlanTestAPIVlanId)
