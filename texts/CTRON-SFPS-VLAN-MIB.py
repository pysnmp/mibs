...
vlanName, vlanSystem, vlanPort, vlanAMRRules, vlanAMRStats, vlanTestAPI, vlanAPI, vlanAMRSubnets, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanSystem", "vlanPort", "vlanAMRRules", "vlanAMRStats", "vlanTestAPI", "vlanAPI", "vlanAMRSubnets", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameIndex=vlanNameIndex, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemOperTime=vlanSystemOperTime, vlanPortVlanName=vlanPortVlanName, vlanSystemTable=vlanSystemTable, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIOutPort=sfpsVAPIOutPort, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortRouterPort=vlanPortRouterPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemEntry=vlanSystemEntry, vlanTestAPIPort=vlanTestAPIPort, vlanNameNumUsers=vlanNameNumUsers, HexInteger=HexInteger, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameTable=vlanNameTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameNHash=vlanNameNHash, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameVlanName=vlanNameVlanName, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortPortNum=vlanPortPortNum, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameVlanRule=vlanNameVlanRule, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortTable=vlanPortTable, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameStatusTime=vlanNameStatusTime, vlanSystemVersion=vlanSystemVersion, vlanPortEntry=vlanPortEntry, vlanNameOperStatus=vlanNameOperStatus, vlanPortPortStatus=vlanPortPortStatus, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortVlanId=vlanPortVlanId, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, SfpsAddress=SfpsAddress, sfpsVAPIVerb=sfpsVAPIVerb, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameVlanId=vlanNameVlanId, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemPollCount=vlanSystemPollCount, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameEntry=vlanNameEntry)
