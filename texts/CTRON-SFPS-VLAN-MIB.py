...
vlanAMRSubnets, vlanSystem, vlanCountAPI, vlanName, vlanAPI, vlanPort, vlanAMRRules, vlanAMRStats, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanSystem", "vlanCountAPI", "vlanName", "vlanAPI", "vlanPort", "vlanAMRRules", "vlanAMRStats", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortTable=vlanPortTable, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameIndex=vlanNameIndex, vlanPortLayer3Learning=vlanPortLayer3Learning, HexInteger=HexInteger, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemPollCount=vlanSystemPollCount, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortPortStatus=vlanPortPortStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanCountAPITotal=vlanCountAPITotal, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortRouterPort=vlanPortRouterPort, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIPort=vlanTestAPIPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortPortNum=vlanPortPortNum, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortVlanName=vlanPortVlanName, vlanNameTable=vlanNameTable, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameNHash=vlanNameNHash, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemLastChange=vlanSystemLastChange, vlanSystemOperTime=vlanSystemOperTime, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameVlanId=vlanNameVlanId, vlanNameVlanName=vlanNameVlanName, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemTable=vlanSystemTable, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemEntry=vlanSystemEntry, vlanNameEntry=vlanNameEntry, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortEntry=vlanPortEntry, vlanSystemVersion=vlanSystemVersion, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, SfpsAddress=SfpsAddress, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameNumUsers=vlanNameNumUsers, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIVerb=vlanTestAPIVerb)
