...
vlanSystem, vlanAMRStats, vlanName, vlanTestAPI, vlanAPI, vlanCountAPI, vlanAMRRules, vlanAMRSubnets, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanAMRStats", "vlanName", "vlanTestAPI", "vlanAPI", "vlanCountAPI", "vlanAMRRules", "vlanAMRSubnets", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", VlanSwitchInstance=VlanSwitchInstance, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemEntry=vlanSystemEntry, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameVlanName=vlanNameVlanName, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortEntry=vlanPortEntry, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemLastChange=vlanSystemLastChange, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRRulesTable=vlanAMRRulesTable, SfpsAddress=SfpsAddress, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemMibRev=vlanSystemMibRev, vlanPortTable=vlanPortTable, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemPollCount=vlanSystemPollCount, vlanCountAPITotal=vlanCountAPITotal, vlanNameNHash=vlanNameNHash, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameTable=vlanNameTable, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIPort=vlanTestAPIPort, SfpsSwitchPort=SfpsSwitchPort, vlanNameStatusTime=vlanNameStatusTime, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameEntry=vlanNameEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameVlanRule=vlanNameVlanRule, vlanNameVlanId=vlanNameVlanId, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortVlanId=vlanPortVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemAgentIP=vlanSystemAgentIP, HexInteger=HexInteger, vlanNameRelayAgent=vlanNameRelayAgent, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortVlanName=vlanPortVlanName, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortRouterPort=vlanPortRouterPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameIndex=vlanNameIndex, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemOperTime=vlanSystemOperTime, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime)
