...
vlanAPI, vlanTestAPI, vlanPort, vlanAMRStats, vlanCountAPI, vlanAMRRules, vlanAMRSubnets, vlanSystem, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanTestAPI", "vlanPort", "vlanAMRStats", "vlanCountAPI", "vlanAMRRules", "vlanAMRSubnets", "vlanSystem", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemEntry=vlanSystemEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortTable=vlanPortTable, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameVlanName=vlanNameVlanName, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameMappedPorts=vlanNameMappedPorts, SfpsAddress=SfpsAddress, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortEntry=vlanPortEntry, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemPollCount=vlanSystemPollCount, vlanSystemOperTime=vlanSystemOperTime, vlanNameEntry=vlanNameEntry, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameNHash=vlanNameNHash, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortVlanId=vlanPortVlanId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameIndex=vlanNameIndex, vlanSystemTable=vlanSystemTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameTable=vlanNameTable, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortPortNum=vlanPortPortNum, VlanSwitchInstance=VlanSwitchInstance, vlanSystemDomainName=vlanSystemDomainName, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameStatusTime=vlanNameStatusTime, vlanPortVlanName=vlanPortVlanName, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanCountAPITotal=vlanCountAPITotal, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemVersion=vlanSystemVersion, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameVlanId=vlanNameVlanId, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, HexInteger=HexInteger, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRRulesRule=vlanAMRRulesRule)
