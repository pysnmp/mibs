...
vlanTestAPI, vlanName, vlanAMRRules, vlanSystem, vlanAPI, vlanAMRSubnets, vlanPort, vlanCountAPI, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanName", "vlanAMRRules", "vlanSystem", "vlanAPI", "vlanAMRSubnets", "vlanPort", "vlanCountAPI", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPINvramId=sfpsVAPINvramId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameFloodPolicy=vlanNameFloodPolicy, SfpsAddress=SfpsAddress, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameNHash=vlanNameNHash, vlanNameVlanId=vlanNameVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortRouterPort=vlanPortRouterPort, vlanAMRSubnetsMask=vlanAMRSubnetsMask, VlanSwitchInstance=VlanSwitchInstance, vlanCountAPITotal=vlanCountAPITotal, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemTable=vlanSystemTable, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameTable=vlanNameTable, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameIndex=vlanNameIndex, vlanSystemOperTime=vlanSystemOperTime, vlanNameEntry=vlanNameEntry, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemMibRev=vlanSystemMibRev, HexInteger=HexInteger, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemEntry=vlanSystemEntry, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemVersion=vlanSystemVersion, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameVlanRule=vlanNameVlanRule, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortEntry=vlanPortEntry, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortTable=vlanPortTable, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameNumUsers=vlanNameNumUsers, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameStatusTime=vlanNameStatusTime, vlanSystemPollCount=vlanSystemPollCount, vlanSystemFirstPollTime=vlanSystemFirstPollTime, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortVlanId=vlanPortVlanId, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus)
