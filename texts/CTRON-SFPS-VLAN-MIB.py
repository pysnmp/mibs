...
vlanAPI, vlanSystem, vlanCountAPI, vlanAMRSubnets, vlanPort, vlanAMRRules, vlanName, vlanTestAPI, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanSystem", "vlanCountAPI", "vlanAMRSubnets", "vlanPort", "vlanAMRRules", "vlanName", "vlanTestAPI", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameNHash=vlanNameNHash, vlanPortEntry=vlanPortEntry, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameVlanRule=vlanNameVlanRule, vlanNameStatusTime=vlanNameStatusTime, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameVlanName=vlanNameVlanName, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemEntry=vlanSystemEntry, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemMibRev=vlanSystemMibRev, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemDomainName=vlanSystemDomainName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameOperStatus=vlanNameOperStatus, VlanSwitchInstance=VlanSwitchInstance, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortPortNum=vlanPortPortNum, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameIndex=vlanNameIndex, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortRouterPort=vlanPortRouterPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortPortStatus=vlanPortPortStatus, vlanPortVlanName=vlanPortVlanName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortVlanId=vlanPortVlanId, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemLastChange=vlanSystemLastChange, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameTable=vlanNameTable, vlanNameNumUsers=vlanNameNumUsers, vlanAMRSubnetsMask=vlanAMRSubnetsMask, SfpsAddress=SfpsAddress, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameEntry=vlanNameEntry, vlanNameAdminStatus=vlanNameAdminStatus, SfpsSwitchPort=SfpsSwitchPort, HexInteger=HexInteger, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemTable=vlanSystemTable, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanCountAPITotal=vlanCountAPITotal, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortTable=vlanPortTable, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemPriorPollTime=vlanSystemPriorPollTime)
