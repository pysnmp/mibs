...
vlanTestAPI, vlanAMRSubnets, vlanAMRRules, vlanAMRStats, vlanCountAPI, vlanSystem, vlanName, vlanAPI, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanAMRSubnets", "vlanAMRRules", "vlanAMRStats", "vlanCountAPI", "vlanSystem", "vlanName", "vlanAPI", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameStatusTime=vlanNameStatusTime, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortVlanId=vlanPortVlanId, SfpsSwitchPort=SfpsSwitchPort, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameTable=vlanNameTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortTable=vlanPortTable, HexInteger=HexInteger, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemDomainName=vlanSystemDomainName, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameVlanId=vlanNameVlanId, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortPortStatus=vlanPortPortStatus, vlanSystemTable=vlanSystemTable, vlanNameNHash=vlanNameNHash, SfpsAddress=SfpsAddress, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIPort=vlanTestAPIPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortEntry=vlanPortEntry, VlanSwitchInstance=VlanSwitchInstance, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameVlanName=vlanNameVlanName, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortRouterPort=vlanPortRouterPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortVlanName=vlanPortVlanName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemEntry=vlanSystemEntry, vlanSystemVersion=vlanSystemVersion, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemMibRev=vlanSystemMibRev, vlanPortPortNum=vlanPortPortNum, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemOperStatus=vlanSystemOperStatus, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemAdminStatus=vlanSystemAdminStatus)
