...
vlanCountAPI, vlanTestAPI, vlanPort, vlanAMRStats, vlanAMRSubnets, vlanAMRRules, vlanSystem, vlanName, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanTestAPI", "vlanPort", "vlanAMRStats", "vlanAMRSubnets", "vlanAMRRules", "vlanSystem", "vlanName", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameNHash=vlanNameNHash, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortEntry=vlanPortEntry, vlanPortTable=vlanPortTable, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameOperStatus=vlanNameOperStatus, VlanSwitchInstance=VlanSwitchInstance, vlanCountAPITotal=vlanCountAPITotal, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameVlanId=vlanNameVlanId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIPort=vlanTestAPIPort, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameIndex=vlanNameIndex, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortPortPolicy=vlanPortPortPolicy, HexInteger=HexInteger, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameNumUsers=vlanNameNumUsers, vlanSystemDomainName=vlanSystemDomainName, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemEntry=vlanSystemEntry, vlanPortPortNum=vlanPortPortNum, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameEntry=vlanNameEntry, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIVerb=vlanTestAPIVerb, SfpsAddress=SfpsAddress, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemOperTime=vlanSystemOperTime, vlanSystemPollCount=vlanSystemPollCount, vlanNameTable=vlanNameTable, vlanSystemVersion=vlanSystemVersion, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemTable=vlanSystemTable, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortVlanId=vlanPortVlanId, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIVlanId=sfpsVAPIVlanId, SfpsSwitchPort=SfpsSwitchPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortRouterPort=vlanPortRouterPort, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRRulesRule=vlanAMRRulesRule)
