...
vlanCountAPI, vlanTestAPI, vlanName, vlanAMRSubnets, vlanAMRRules, vlanSystem, vlanPort, vlanAMRStats, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanTestAPI", "vlanName", "vlanAMRSubnets", "vlanAMRRules", "vlanSystem", "vlanPort", "vlanAMRStats", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemDomainName=vlanSystemDomainName, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameNHash=vlanNameNHash, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameTable=vlanNameTable, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemVersion=vlanSystemVersion, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemMibRev=vlanSystemMibRev, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemLastChange=vlanSystemLastChange, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortVlanName=vlanPortVlanName, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemEntry=vlanSystemEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameEntry=vlanNameEntry, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameVlanName=vlanNameVlanName, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemOperTime=vlanSystemOperTime, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortPortNum=vlanPortPortNum, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameVlanId=vlanNameVlanId, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, HexInteger=HexInteger, VlanSwitchInstance=VlanSwitchInstance, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameMappedPorts=vlanNameMappedPorts, SfpsAddress=SfpsAddress, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIPort=vlanTestAPIPort, vlanSystemPollCount=vlanSystemPollCount, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortTable=vlanPortTable, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortEntry=vlanPortEntry, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortPortStatus=vlanPortPortStatus, SfpsSwitchPort=SfpsSwitchPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameVlanRule=vlanNameVlanRule, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy)
