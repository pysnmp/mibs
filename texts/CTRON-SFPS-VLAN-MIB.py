...
vlanSystem, vlanAMRStats, vlanName, vlanPort, vlanAMRRules, vlanAPI, vlanAMRSubnets, vlanTestAPI, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanAMRStats", "vlanName", "vlanPort", "vlanAMRRules", "vlanAPI", "vlanAMRSubnets", "vlanTestAPI", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", SfpsAddress=SfpsAddress, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemLastChange=vlanSystemLastChange, vlanCountAPITotal=vlanCountAPITotal, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemTable=vlanSystemTable, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameNHash=vlanNameNHash, vlanAMRRulesTable=vlanAMRRulesTable, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameEntry=vlanNameEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortLayer3Learning=vlanPortLayer3Learning, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortVlanId=vlanPortVlanId, vlanNameStatusTime=vlanNameStatusTime, VlanSwitchInstance=VlanSwitchInstance, vlanNameVlanName=vlanNameVlanName, HexInteger=HexInteger, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortVlanName=vlanPortVlanName, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemOperTime=vlanSystemOperTime, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortPortNum=vlanPortPortNum, vlanNameOperStatus=vlanNameOperStatus, vlanNameIndex=vlanNameIndex, vlanSystemDomainName=vlanSystemDomainName, vlanSystemPollCount=vlanSystemPollCount, vlanNameVlanId=vlanNameVlanId, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortEntry=vlanPortEntry, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameTable=vlanNameTable, vlanPortTable=vlanPortTable, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry)
