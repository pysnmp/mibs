...
vlanTestAPI, vlanAMRSubnets, vlanAPI, vlanName, vlanAMRRules, vlanCountAPI, vlanPort, vlanAMRStats, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanAMRSubnets", "vlanAPI", "vlanName", "vlanAMRRules", "vlanCountAPI", "vlanPort", "vlanAMRStats", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemAgentIP=vlanSystemAgentIP, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortVlanId=vlanPortVlanId, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIInPort=sfpsVAPIInPort, SfpsAddress=SfpsAddress, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIPort=vlanTestAPIPort, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemPollCount=vlanSystemPollCount, vlanNameOperStatus=vlanNameOperStatus, HexInteger=HexInteger, vlanSystemEntry=vlanSystemEntry, vlanNameVlanId=vlanNameVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortTable=vlanPortTable, vlanPortRelayAgent=vlanPortRelayAgent, VlanSwitchInstance=VlanSwitchInstance, vlanSystemTable=vlanSystemTable, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameEntry=vlanNameEntry, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameIndex=vlanNameIndex, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameNHash=vlanNameNHash, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortVlanName=vlanPortVlanName, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemOperTime=vlanSystemOperTime, vlanSystemMibRev=vlanSystemMibRev, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameTable=vlanNameTable, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortEntry=vlanPortEntry, vlanPortPortStatus=vlanPortPortStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortPortNum=vlanPortPortNum, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameNumUsers=vlanNameNumUsers, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortRouterPort=vlanPortRouterPort, vlanSystemVersion=vlanSystemVersion)
