...
vlanCountAPI, vlanAMRRules, vlanTestAPI, vlanName, vlanAMRSubnets, vlanSystem, vlanAMRStats, vlanAPI, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAMRRules", "vlanTestAPI", "vlanName", "vlanAMRSubnets", "vlanSystem", "vlanAMRStats", "vlanAPI", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemVersion=vlanSystemVersion, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameTable=vlanNameTable, vlanSystemMibRev=vlanSystemMibRev, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortVlanId=vlanPortVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemLastChange=vlanSystemLastChange, vlanNameNumUsers=vlanNameNumUsers, vlanPortTable=vlanPortTable, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameOperStatus=vlanNameOperStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameEntry=vlanNameEntry, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, SfpsAddress=SfpsAddress, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, HexInteger=HexInteger, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemOperTime=vlanSystemOperTime, vlanSystemDomainName=vlanSystemDomainName, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortVlanName=vlanPortVlanName, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortEntry=vlanPortEntry, vlanNameVlanRule=vlanNameVlanRule, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameIndex=vlanNameIndex, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameVlanId=vlanNameVlanId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputMap=vlanTestAPIOutputMap, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameStatusTime=vlanNameStatusTime, vlanPortPortNum=vlanPortPortNum, vlanTestAPIPort=vlanTestAPIPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemEntry=vlanSystemEntry, vlanSystemPollCount=vlanSystemPollCount, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameFloodPolicy=vlanNameFloodPolicy)
