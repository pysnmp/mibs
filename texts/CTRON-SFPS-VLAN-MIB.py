...
vlanPort, vlanAPI, vlanCountAPI, vlanName, vlanTestAPI, vlanAMRSubnets, vlanSystem, vlanAMRRules, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAPI", "vlanCountAPI", "vlanName", "vlanTestAPI", "vlanAMRSubnets", "vlanSystem", "vlanAMRRules", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortPortStatus=vlanPortPortStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemDomainName=vlanSystemDomainName, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortVlanId=vlanPortVlanId, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortTable=vlanPortTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameEnabledPorts=vlanNameEnabledPorts, SfpsAddress=SfpsAddress, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameStatusTime=vlanNameStatusTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemTable=vlanSystemTable, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, HexInteger=HexInteger, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortPortNum=vlanPortPortNum, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortVlanName=vlanPortVlanName, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemOperTime=vlanSystemOperTime, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemVersion=vlanSystemVersion, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameNumUsers=vlanNameNumUsers, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameVlanName=vlanNameVlanName, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameEntry=vlanNameEntry, vlanNameIndex=vlanNameIndex, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemLastChange=vlanSystemLastChange, vlanNameVlanId=vlanNameVlanId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameTable=vlanNameTable, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemEntry=vlanSystemEntry, vlanPortEntry=vlanPortEntry)
