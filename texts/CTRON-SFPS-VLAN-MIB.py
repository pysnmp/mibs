...
vlanName, vlanTestAPI, vlanAMRStats, vlanAPI, vlanPort, vlanAMRRules, vlanAMRSubnets, vlanSystem, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanTestAPI", "vlanAMRStats", "vlanAPI", "vlanPort", "vlanAMRRules", "vlanAMRSubnets", "vlanSystem", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIPort=vlanTestAPIPort, vlanPortPortStatus=vlanPortPortStatus, VlanSwitchInstance=VlanSwitchInstance, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemLastChange=vlanSystemLastChange, vlanSystemVersion=vlanSystemVersion, vlanNameOperStatus=vlanNameOperStatus, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemMibRev=vlanSystemMibRev, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemEntry=vlanSystemEntry, vlanPortVlanName=vlanPortVlanName, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortPortNum=vlanPortPortNum, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemOperStatus=vlanSystemOperStatus, vlanCountAPITotal=vlanCountAPITotal, vlanSystemTable=vlanSystemTable, SfpsAddress=SfpsAddress, vlanNameTable=vlanNameTable, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemDomainName=vlanSystemDomainName, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, HexInteger=HexInteger, vlanAMRRulesTable=vlanAMRRulesTable, SfpsSwitchPort=SfpsSwitchPort, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortVlanId=vlanPortVlanId, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameNHash=vlanNameNHash, vlanNameVlanId=vlanNameVlanId, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortTable=vlanPortTable, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameIndex=vlanNameIndex, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameAdminStatus=vlanNameAdminStatus)
