...
vlanSystem, vlanName, vlanTestAPI, vlanAPI, vlanAMRSubnets, vlanAMRStats, vlanPort, vlanCountAPI, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanName", "vlanTestAPI", "vlanAPI", "vlanAMRSubnets", "vlanAMRStats", "vlanPort", "vlanCountAPI", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameNHash=vlanNameNHash, vlanSystemVersion=vlanSystemVersion, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortVlanName=vlanPortVlanName, vlanSystemPollCount=vlanSystemPollCount, vlanNameNumUsers=vlanNameNumUsers, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRSubnetsMask=vlanAMRSubnetsMask, SfpsAddress=SfpsAddress, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemOperTime=vlanSystemOperTime, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortPortNum=vlanPortPortNum, vlanSystemLastChange=vlanSystemLastChange, vlanPortEntry=vlanPortEntry, vlanNameVlanRule=vlanNameVlanRule, vlanNameFloodPorts=vlanNameFloodPorts, vlanCountAPITotal=vlanCountAPITotal, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortVlanId=vlanPortVlanId, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameStatusTime=vlanNameStatusTime, HexInteger=HexInteger, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortTable=vlanPortTable, vlanNameVlanId=vlanNameVlanId, vlanNameTable=vlanNameTable, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemEntry=vlanSystemEntry, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortRouterPort=vlanPortRouterPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameOperStatus=vlanNameOperStatus, vlanNameEntry=vlanNameEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIPort=vlanTestAPIPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemTable=vlanSystemTable, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameIndex=vlanNameIndex)
