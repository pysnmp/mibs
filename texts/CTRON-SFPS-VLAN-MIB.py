...
# Produced by pysmi-1.1.8 at Mon Sep 19 08:04:39 2022
...
vlanPort, vlanCountAPI, vlanTestAPI, vlanAMRRules, vlanAMRStats, vlanAMRSubnets, vlanAPI, vlanName, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanCountAPI", "vlanTestAPI", "vlanAMRRules", "vlanAMRStats", "vlanAMRSubnets", "vlanAPI", "vlanName", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameNumUsers=vlanNameNumUsers, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemVersion=vlanSystemVersion, vlanPortTable=vlanPortTable, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortPortNum=vlanPortPortNum, vlanPortVlanId=vlanPortVlanId, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanSystemPollCount=vlanSystemPollCount, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemTable=vlanSystemTable, vlanNameVlanId=vlanNameVlanId, vlanTestAPIVlanName=vlanTestAPIVlanName, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortEntry=vlanPortEntry, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemEntry=vlanSystemEntry, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, VlanSwitchInstance=VlanSwitchInstance, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortPortStatus=vlanPortPortStatus, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameNHash=vlanNameNHash, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanPortVlanName=vlanPortVlanName, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameStatusTime=vlanNameStatusTime, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameTable=vlanNameTable, SfpsAddress=SfpsAddress, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIPort=vlanTestAPIPort, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRSubnetsMask=vlanAMRSubnetsMask, HexInteger=HexInteger, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy)
