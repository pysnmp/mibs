...
vlanAMRSubnets, vlanAMRRules, vlanPort, vlanCountAPI, vlanAPI, vlanTestAPI, vlanSystem, vlanName, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanAMRRules", "vlanPort", "vlanCountAPI", "vlanAPI", "vlanTestAPI", "vlanSystem", "vlanName", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortTable=vlanPortTable, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortRouterPort=vlanPortRouterPort, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortPortStatus=vlanPortPortStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemTable=vlanSystemTable, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameNumUsers=vlanNameNumUsers, SfpsAddress=SfpsAddress, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortVlanName=vlanPortVlanName, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortRelayAgent=vlanPortRelayAgent, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameStatusTime=vlanNameStatusTime, vlanNameVlanRule=vlanNameVlanRule, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameNHash=vlanNameNHash, vlanSystemVersion=vlanSystemVersion, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameVlanName=vlanNameVlanName, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputPort=vlanTestAPIOutputPort, HexInteger=HexInteger, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortVlanId=vlanPortVlanId, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameIndex=vlanNameIndex, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortPortNum=vlanPortPortNum, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortEntry=vlanPortEntry, vlanNameVlanId=vlanNameVlanId, vlanPortUniPolicy=vlanPortUniPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameOperStatus=vlanNameOperStatus, vlanSystemEntry=vlanSystemEntry, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameEntry=vlanNameEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameTable=vlanNameTable, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus)
