...
vlanAMRStats, vlanAPI, vlanCountAPI, vlanAMRSubnets, vlanPort, vlanAMRRules, vlanTestAPI, vlanSystem, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanAPI", "vlanCountAPI", "vlanAMRSubnets", "vlanPort", "vlanAMRRules", "vlanTestAPI", "vlanSystem", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameTable=vlanNameTable, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortTable=vlanPortTable, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemMibRev=vlanSystemMibRev, vlanPortVlanId=vlanPortVlanId, SfpsAddress=SfpsAddress, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortPortStatus=vlanPortPortStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortUniPolicy=vlanPortUniPolicy, vlanCountAPITotal=vlanCountAPITotal, vlanPortEntry=vlanPortEntry, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemEntry=vlanSystemEntry, SfpsSwitchPort=SfpsSwitchPort, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortPortNum=vlanPortPortNum, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameNHash=vlanNameNHash, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameNumUsers=vlanNameNumUsers, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemPollCount=vlanSystemPollCount, vlanNameVlanId=vlanNameVlanId, vlanSystemVersion=vlanSystemVersion, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameEntry=vlanNameEntry, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortVlanName=vlanPortVlanName, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemOperStatus=vlanSystemOperStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, HexInteger=HexInteger, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortRouterPort=vlanPortRouterPort, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameStatusTime=vlanNameStatusTime)
