...
vlanTestAPI, vlanAMRRules, vlanAMRSubnets, vlanPort, vlanSystem, vlanAPI, vlanName, vlanAMRStats, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanAMRRules", "vlanAMRSubnets", "vlanPort", "vlanSystem", "vlanAPI", "vlanName", "vlanAMRStats", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemOperTime=vlanSystemOperTime, vlanPortPortStatus=vlanPortPortStatus, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIUserAlias=sfpsVAPIUserAlias, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortVlanId=vlanPortVlanId, vlanSystemEntry=vlanSystemEntry, vlanNameFloodPorts=vlanNameFloodPorts, SfpsSwitchPort=SfpsSwitchPort, vlanNameStatusTime=vlanNameStatusTime, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameEntry=vlanNameEntry, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameOperStatus=vlanNameOperStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemLastChange=vlanSystemLastChange, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameIndex=vlanNameIndex, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, HexInteger=HexInteger, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemVersion=vlanSystemVersion, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemTable=vlanSystemTable, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortTable=vlanPortTable, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortPortNum=vlanPortPortNum, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortVlanName=vlanPortVlanName, vlanSystemMibRev=vlanSystemMibRev, vlanNameNumUsers=vlanNameNumUsers, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameVlanId=vlanNameVlanId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIPort=vlanTestAPIPort, SfpsAddress=SfpsAddress, vlanNameTable=vlanNameTable, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortEntry=vlanPortEntry, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIVerb=sfpsVAPIVerb)
