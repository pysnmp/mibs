...
vlanSystem, vlanName, vlanTestAPI, vlanAMRRules, vlanPort, vlanAPI, vlanCountAPI, vlanAMRStats, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanName", "vlanTestAPI", "vlanAMRRules", "vlanPort", "vlanAPI", "vlanCountAPI", "vlanAMRStats", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, HexInteger=HexInteger, sfpsVAPIVlanId=sfpsVAPIVlanId, SfpsSwitchPort=SfpsSwitchPort, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortEntry=vlanPortEntry, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortVlanName=vlanPortVlanName, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameNHash=vlanNameNHash, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortRouterPort=vlanPortRouterPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, SfpsAddress=SfpsAddress, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameNumUsers=vlanNameNumUsers, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIPort=vlanTestAPIPort, vlanSystemPollCount=vlanSystemPollCount, vlanNameEntry=vlanNameEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanPortPortNum=vlanPortPortNum, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, VlanSwitchInstance=VlanSwitchInstance, vlanNameVlanName=vlanNameVlanName, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemDomainName=vlanSystemDomainName, vlanSystemEntry=vlanSystemEntry, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameTable=vlanNameTable, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortVlanId=vlanPortVlanId, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameIndex=vlanNameIndex, vlanCountAPITotal=vlanCountAPITotal, vlanPortTable=vlanPortTable, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemVersion=vlanSystemVersion, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameAdminStatus=vlanNameAdminStatus)
