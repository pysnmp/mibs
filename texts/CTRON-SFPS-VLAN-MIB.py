...
vlanName, vlanAMRStats, vlanAMRSubnets, vlanSystem, vlanPort, vlanTestAPI, vlanAPI, vlanAMRRules, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanAMRStats", "vlanAMRSubnets", "vlanSystem", "vlanPort", "vlanTestAPI", "vlanAPI", "vlanAMRRules", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemPollCount=vlanSystemPollCount, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortEntry=vlanPortEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, HexInteger=HexInteger, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanCountAPITotal=vlanCountAPITotal, vlanNameTable=vlanNameTable, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortRouterPort=vlanPortRouterPort, vlanNameIndex=vlanNameIndex, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameNHash=vlanNameNHash, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameVlanName=vlanNameVlanName, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, SfpsAddress=SfpsAddress, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanPortPortStatus=vlanPortPortStatus, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemMibRev=vlanSystemMibRev, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortPortNum=vlanPortPortNum, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameEntry=vlanNameEntry, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemEntry=vlanSystemEntry, vlanSystemLastChange=vlanSystemLastChange, vlanNameVlanRule=vlanNameVlanRule, vlanPortVlanId=vlanPortVlanId, vlanPortTable=vlanPortTable, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameVlanId=vlanNameVlanId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemVersion=vlanSystemVersion, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemTable=vlanSystemTable, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemOperTime=vlanSystemOperTime, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy)
