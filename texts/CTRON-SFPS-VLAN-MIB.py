...
vlanAMRStats, vlanCountAPI, vlanPort, vlanName, vlanAMRSubnets, vlanAPI, vlanTestAPI, vlanAMRRules, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanCountAPI", "vlanPort", "vlanName", "vlanAMRSubnets", "vlanAPI", "vlanTestAPI", "vlanAMRRules", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortPortStatus=vlanPortPortStatus, VlanSwitchInstance=VlanSwitchInstance, vlanSystemEntry=vlanSystemEntry, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortVlanId=vlanPortVlanId, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemPollCount=vlanSystemPollCount, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortRouterPort=vlanPortRouterPort, vlanNameNHash=vlanNameNHash, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemOperTime=vlanSystemOperTime, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameStatusTime=vlanNameStatusTime, vlanAMRSubnetsMask=vlanAMRSubnetsMask, HexInteger=HexInteger, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemVersion=vlanSystemVersion, vlanSystemAdminStatus=vlanSystemAdminStatus, SfpsAddress=SfpsAddress, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameEntry=vlanNameEntry, vlanNameVlanName=vlanNameVlanName, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameOperStatus=vlanNameOperStatus, vlanSystemDomainName=vlanSystemDomainName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanCountAPITotal=vlanCountAPITotal, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemTable=vlanSystemTable, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameVlanId=vlanNameVlanId, vlanSystemMibRev=vlanSystemMibRev, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameTable=vlanNameTable, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortTable=vlanPortTable, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortVlanName=vlanPortVlanName, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameIndex=vlanNameIndex, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag)
