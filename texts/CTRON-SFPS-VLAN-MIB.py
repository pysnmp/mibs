...
vlanAPI, vlanSystem, vlanAMRSubnets, vlanAMRStats, vlanTestAPI, vlanAMRRules, vlanCountAPI, vlanName, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanSystem", "vlanAMRSubnets", "vlanAMRStats", "vlanTestAPI", "vlanAMRRules", "vlanCountAPI", "vlanName", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortVlanId=vlanPortVlanId, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemEntry=vlanSystemEntry, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIPort=vlanTestAPIPort, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameTable=vlanNameTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameIndex=vlanNameIndex, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortPortNum=vlanPortPortNum, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemLastChange=vlanSystemLastChange, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameVlanId=vlanNameVlanId, vlanSystemVersion=vlanSystemVersion, vlanNameNHash=vlanNameNHash, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, VlanSwitchInstance=VlanSwitchInstance, HexInteger=HexInteger, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortRouterPort=vlanPortRouterPort, vlanPortVlanName=vlanPortVlanName, vlanCountAPITotal=vlanCountAPITotal, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortTable=vlanPortTable, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameNumUsers=vlanNameNumUsers, vlanSystemTable=vlanSystemTable, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemPollCount=vlanSystemPollCount, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemDomainName=vlanSystemDomainName, vlanNameStatusTime=vlanNameStatusTime, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, SfpsSwitchPort=SfpsSwitchPort, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameVlanName=vlanNameVlanName, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortEntry=vlanPortEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortPortPolicy=vlanPortPortPolicy, SfpsAddress=SfpsAddress, vlanSystemMibRev=vlanSystemMibRev, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled)
