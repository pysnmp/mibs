...
vlanPort, vlanAPI, vlanSystem, vlanName, vlanTestAPI, vlanAMRStats, vlanAMRSubnets, vlanCountAPI, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAPI", "vlanSystem", "vlanName", "vlanTestAPI", "vlanAMRStats", "vlanAMRSubnets", "vlanCountAPI", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortVlanId=vlanPortVlanId, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemPollCount=vlanSystemPollCount, vlanNameIndex=vlanNameIndex, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameStatusTime=vlanNameStatusTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemLastChange=vlanSystemLastChange, vlanSystemVersion=vlanSystemVersion, SfpsAddress=SfpsAddress, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanNameVlanName=vlanNameVlanName, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameOperStatus=vlanNameOperStatus, vlanNameVlanRule=vlanNameVlanRule, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameEntry=vlanNameEntry, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortPortNum=vlanPortPortNum, vlanNameTable=vlanNameTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortTable=vlanPortTable, vlanPortEntry=vlanPortEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemOperTime=vlanSystemOperTime, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputAble=vlanTestAPIOutputAble, HexInteger=HexInteger, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortVlanName=vlanPortVlanName, SfpsSwitchPort=SfpsSwitchPort, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameNHash=vlanNameNHash, vlanNameVlanId=vlanNameVlanId, vlanPortRouterPort=vlanPortRouterPort, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameNumUsers=vlanNameNumUsers, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortUniPolicy=vlanPortUniPolicy)
