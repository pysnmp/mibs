...
vlanCountAPI, vlanAMRStats, vlanName, vlanTestAPI, vlanSystem, vlanAMRSubnets, vlanAPI, vlanAMRRules, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAMRStats", "vlanName", "vlanTestAPI", "vlanSystem", "vlanAMRSubnets", "vlanAPI", "vlanAMRRules", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortUniPolicy=vlanPortUniPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemMibRev=vlanSystemMibRev, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameVlanName=vlanNameVlanName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemEntry=vlanSystemEntry, vlanNameIndex=vlanNameIndex, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemLastChange=vlanSystemLastChange, vlanPortTable=vlanPortTable, VlanSwitchInstance=VlanSwitchInstance, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemTable=vlanSystemTable, vlanNameNHash=vlanNameNHash, vlanSystemVersion=vlanSystemVersion, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameFloodPorts=vlanNameFloodPorts, vlanCountAPITotal=vlanCountAPITotal, SfpsAddress=SfpsAddress, vlanPortEntry=vlanPortEntry, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameTable=vlanNameTable, vlanNameEntry=vlanNameEntry, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameVlanId=vlanNameVlanId, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemAgentIP=vlanSystemAgentIP, HexInteger=HexInteger, vlanTestAPIOutputMap=vlanTestAPIOutputMap, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortPortNum=vlanPortPortNum, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIUserMAC=sfpsVAPIUserMAC)
