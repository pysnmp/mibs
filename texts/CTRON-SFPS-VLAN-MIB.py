...
vlanSystem, vlanAMRSubnets, vlanAPI, vlanName, vlanAMRRules, vlanCountAPI, vlanPort, vlanAMRStats, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanAMRSubnets", "vlanAPI", "vlanName", "vlanAMRRules", "vlanCountAPI", "vlanPort", "vlanAMRStats", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortUniPolicy=vlanPortUniPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanAMRRulesEntry=vlanAMRRulesEntry, SfpsAddress=SfpsAddress, vlanNameNumUsers=vlanNameNumUsers, vlanNameIndex=vlanNameIndex, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortPortStatus=vlanPortPortStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRRulesTable=vlanAMRRulesTable, VlanSwitchInstance=VlanSwitchInstance, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortEntry=vlanPortEntry, vlanPortVlanId=vlanPortVlanId, vlanPortVlanName=vlanPortVlanName, vlanSystemTable=vlanSystemTable, vlanSystemMibRev=vlanSystemMibRev, vlanNameTable=vlanNameTable, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemOperTime=vlanSystemOperTime, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIPort=vlanTestAPIPort, vlanNameVlanRule=vlanNameVlanRule, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameVlanId=vlanNameVlanId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortPortNum=vlanPortPortNum, vlanNameEntry=vlanNameEntry, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameNHash=vlanNameNHash, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortTable=vlanPortTable, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemDomainName=vlanSystemDomainName, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, HexInteger=HexInteger, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameOperStatus=vlanNameOperStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemLastChange=vlanSystemLastChange, vlanPortLayer3Learning=vlanPortLayer3Learning)
