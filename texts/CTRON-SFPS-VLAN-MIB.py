...
vlanSystem, vlanAMRSubnets, vlanTestAPI, vlanAMRStats, vlanName, vlanAMRRules, vlanPort, vlanAPI, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanAMRSubnets", "vlanTestAPI", "vlanAMRStats", "vlanName", "vlanAMRRules", "vlanPort", "vlanAPI", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, VlanSwitchInstance=VlanSwitchInstance, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameVlanName=vlanNameVlanName, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemPollCount=vlanSystemPollCount, vlanNameEntry=vlanNameEntry, vlanPortPortNum=vlanPortPortNum, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortEntry=vlanPortEntry, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortVlanName=vlanPortVlanName, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortVlanId=vlanPortVlanId, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemMibRev=vlanSystemMibRev, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemTable=vlanSystemTable, vlanNameVlanId=vlanNameVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemVersion=vlanSystemVersion, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemEntry=vlanSystemEntry, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameTable=vlanNameTable, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanCountAPITotal=vlanCountAPITotal, vlanPortTable=vlanPortTable, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortRouterPort=vlanPortRouterPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, SfpsSwitchPort=SfpsSwitchPort, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortPortStatus=vlanPortPortStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, SfpsAddress=SfpsAddress, sfpsVAPIUserAlias=sfpsVAPIUserAlias, HexInteger=HexInteger, vlanSystemOperTime=vlanSystemOperTime, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameIndex=vlanNameIndex, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt)
