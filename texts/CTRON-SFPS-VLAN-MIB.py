...
vlanAPI, vlanTestAPI, vlanAMRRules, vlanName, vlanCountAPI, vlanPort, vlanAMRSubnets, vlanSystem, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanTestAPI", "vlanAMRRules", "vlanName", "vlanCountAPI", "vlanPort", "vlanAMRSubnets", "vlanSystem", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameVlanRule=vlanNameVlanRule, vlanPortPortNum=vlanPortPortNum, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemPollCount=vlanSystemPollCount, vlanSystemAgentIP=vlanSystemAgentIP, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemTable=vlanSystemTable, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameTable=vlanNameTable, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameVlanId=vlanNameVlanId, vlanNameNHash=vlanNameNHash, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemEntry=vlanSystemEntry, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemAdminReset=vlanSystemAdminReset, SfpsSwitchPort=SfpsSwitchPort, vlanNameStatusTime=vlanNameStatusTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortVlanName=vlanPortVlanName, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortVlanId=vlanPortVlanId, vlanNameVlanName=vlanNameVlanName, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRRulesTable=vlanAMRRulesTable, HexInteger=HexInteger, vlanNameIndex=vlanNameIndex, SfpsAddress=SfpsAddress, vlanSystemDomainName=vlanSystemDomainName, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemVersion=vlanSystemVersion, vlanPortRouterPort=vlanPortRouterPort, vlanPortTable=vlanPortTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemOperStatus=vlanSystemOperStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameEntry=vlanNameEntry, vlanPortPortStatus=vlanPortPortStatus, vlanCountAPITotal=vlanCountAPITotal, vlanPortEntry=vlanPortEntry, vlanPortAdminStatus=vlanPortAdminStatus)
