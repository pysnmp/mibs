...
vlanAMRRules, vlanName, vlanAMRStats, vlanPort, vlanAMRSubnets, vlanCountAPI, vlanSystem, vlanAPI, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanName", "vlanAMRStats", "vlanPort", "vlanAMRSubnets", "vlanCountAPI", "vlanSystem", "vlanAPI", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameUniPolicy=vlanNameUniPolicy, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemVersion=vlanSystemVersion, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameNumUsers=vlanNameNumUsers, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortFloodPolicy=vlanPortFloodPolicy, SfpsSwitchPort=SfpsSwitchPort, SfpsAddress=SfpsAddress, vlanPortVlanName=vlanPortVlanName, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, HexInteger=HexInteger, vlanPortEntry=vlanPortEntry, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameOperStatus=vlanNameOperStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputAble=vlanTestAPIOutputAble, VlanSwitchInstance=VlanSwitchInstance, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortTable=vlanPortTable, vlanCountAPITotal=vlanCountAPITotal, vlanPortRouterPort=vlanPortRouterPort, vlanNameEntry=vlanNameEntry, vlanNameIndex=vlanNameIndex, vlanNameVlanId=vlanNameVlanId, vlanNameVlanRule=vlanNameVlanRule, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameNHash=vlanNameNHash, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortVlanId=vlanPortVlanId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemEntry=vlanSystemEntry, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameTable=vlanNameTable, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIPort=vlanTestAPIPort, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemDomainName=vlanSystemDomainName)
