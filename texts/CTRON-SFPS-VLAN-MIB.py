...
vlanAPI, vlanAMRRules, vlanSystem, vlanPort, vlanCountAPI, vlanAMRStats, vlanAMRSubnets, vlanTestAPI, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanAMRRules", "vlanSystem", "vlanPort", "vlanCountAPI", "vlanAMRStats", "vlanAMRSubnets", "vlanTestAPI", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameFloodPorts=vlanNameFloodPorts, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameTable=vlanNameTable, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemTable=vlanSystemTable, vlanNameVlanRule=vlanNameVlanRule, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemLastChange=vlanSystemLastChange, vlanNameNHash=vlanNameNHash, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameNumUsers=vlanNameNumUsers, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortTable=vlanPortTable, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortEntry=vlanPortEntry, SfpsAddress=SfpsAddress, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanSystemEntry=vlanSystemEntry, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameStatusTime=vlanNameStatusTime, vlanPortPortNum=vlanPortPortNum, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, HexInteger=HexInteger, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameVlanId=vlanNameVlanId, vlanPortVlanName=vlanPortVlanName, SfpsSwitchPort=SfpsSwitchPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanSystemPollCount=vlanSystemPollCount, vlanSystemDomainName=vlanSystemDomainName, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameIndex=vlanNameIndex, vlanNameEntry=vlanNameEntry, VlanSwitchInstance=VlanSwitchInstance, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortVlanId=vlanPortVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemVersion=vlanSystemVersion, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameVlanName=vlanNameVlanName, vlanTestAPIPort=vlanTestAPIPort)
