...
vlanSystem, vlanAMRRules, vlanAMRStats, vlanPort, vlanAPI, vlanTestAPI, vlanName, vlanAMRSubnets, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanAMRRules", "vlanAMRStats", "vlanPort", "vlanAPI", "vlanTestAPI", "vlanName", "vlanAMRSubnets", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameNHash=vlanNameNHash, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortVlanId=vlanPortVlanId, vlanPortPortNum=vlanPortPortNum, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameEntry=vlanNameEntry, HexInteger=HexInteger, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemOperTime=vlanSystemOperTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameStatusTime=vlanNameStatusTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanCountAPITotal=vlanCountAPITotal, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameTable=vlanNameTable, vlanPortEntry=vlanPortEntry, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortPortStatus=vlanPortPortStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameVlanName=vlanNameVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemTable=vlanSystemTable, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemVersion=vlanSystemVersion, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameVlanRule=vlanNameVlanRule, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemOperStatus=vlanSystemOperStatus, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemEntry=vlanSystemEntry, vlanNameVlanId=vlanNameVlanId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputMap=vlanTestAPIOutputMap, SfpsAddress=SfpsAddress, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemPollCount=vlanSystemPollCount, vlanNameIndex=vlanNameIndex, vlanPortTable=vlanPortTable, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortVlanName=vlanPortVlanName, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIPort=vlanTestAPIPort, vlanNameOperStatus=vlanNameOperStatus)
