...
vlanCountAPI, vlanName, vlanSystem, vlanAMRRules, vlanAMRSubnets, vlanTestAPI, vlanAPI, vlanAMRStats, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanName", "vlanSystem", "vlanAMRRules", "vlanAMRSubnets", "vlanTestAPI", "vlanAPI", "vlanAMRStats", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameVlanName=vlanNameVlanName, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemTable=vlanSystemTable, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameVlanId=vlanNameVlanId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortVlanName=vlanPortVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIInPort=sfpsVAPIInPort, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameOperStatus=vlanNameOperStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemPollCount=vlanSystemPollCount, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameNHash=vlanNameNHash, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameVlanRule=vlanNameVlanRule, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortPortStatus=vlanPortPortStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemOperTime=vlanSystemOperTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemLastChange=vlanSystemLastChange, vlanSystemVersion=vlanSystemVersion, vlanPortTable=vlanPortTable, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortEntry=vlanPortEntry, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemMibRev=vlanSystemMibRev, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameTable=vlanNameTable, vlanPortPortNum=vlanPortPortNum, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIVlanName=vlanTestAPIVlanName, HexInteger=HexInteger, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortVlanId=vlanPortVlanId, vlanTestAPIPort=vlanTestAPIPort, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputTable=vlanTestAPIOutputTable, SfpsSwitchPort=SfpsSwitchPort, SfpsAddress=SfpsAddress, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIVlanId=vlanTestAPIVlanId)
