...
vlanAMRStats, vlanAMRSubnets, vlanTestAPI, vlanName, vlanPort, vlanSystem, vlanAPI, vlanAMRRules, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanAMRSubnets", "vlanTestAPI", "vlanName", "vlanPort", "vlanSystem", "vlanAPI", "vlanAMRRules", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameStatusTime=vlanNameStatusTime, vlanSystemOperTime=vlanSystemOperTime, vlanPortPortStatus=vlanPortPortStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanCountAPITotal=vlanCountAPITotal, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemLastChange=vlanSystemLastChange, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameTable=vlanNameTable, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, SfpsAddress=SfpsAddress, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortRouterPort=vlanPortRouterPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemDomainName=vlanSystemDomainName, vlanPortVlanName=vlanPortVlanName, vlanNameVlanRule=vlanNameVlanRule, vlanNameIndex=vlanNameIndex, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, HexInteger=HexInteger, vlanNameVlanId=vlanNameVlanId, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortVlanId=vlanPortVlanId, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortEntry=vlanPortEntry, vlanNameVlanName=vlanNameVlanName, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortTable=vlanPortTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemEntry=vlanSystemEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortUniPolicy=vlanPortUniPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, VlanSwitchInstance=VlanSwitchInstance, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, SfpsSwitchPort=SfpsSwitchPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemTable=vlanSystemTable, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemVersion=vlanSystemVersion, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameNHash=vlanNameNHash, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIVerb=sfpsVAPIVerb)
