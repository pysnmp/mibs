...
vlanName, vlanAMRSubnets, vlanSystem, vlanCountAPI, vlanTestAPI, vlanPort, vlanAPI, vlanAMRStats, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanAMRSubnets", "vlanSystem", "vlanCountAPI", "vlanTestAPI", "vlanPort", "vlanAPI", "vlanAMRStats", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameNumUsers=vlanNameNumUsers, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, SfpsAddress=SfpsAddress, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameVlanName=vlanNameVlanName, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameEntry=vlanNameEntry, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortTable=vlanPortTable, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortRelayAgent=vlanPortRelayAgent, HexInteger=HexInteger, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortVlanId=vlanPortVlanId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameIndex=vlanNameIndex, vlanCountAPITotal=vlanCountAPITotal, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIPort=vlanTestAPIPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortEntry=vlanPortEntry, vlanNameVlanRule=vlanNameVlanRule, vlanNameNHash=vlanNameNHash, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameTable=vlanNameTable, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortVlanName=vlanPortVlanName, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameVlanId=vlanNameVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameStatusTime=vlanNameStatusTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortPortNum=vlanPortPortNum, vlanPortRouterPort=vlanPortRouterPort, vlanSystemLastChange=vlanSystemLastChange, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, VlanSwitchInstance=VlanSwitchInstance, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemOperTime=vlanSystemOperTime, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemPollCount=vlanSystemPollCount, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemEntry=vlanSystemEntry)
