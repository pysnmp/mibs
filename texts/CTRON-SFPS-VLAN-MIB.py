...
vlanCountAPI, vlanAMRRules, vlanTestAPI, vlanAMRStats, vlanSystem, vlanPort, vlanAPI, vlanName, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAMRRules", "vlanTestAPI", "vlanAMRStats", "vlanSystem", "vlanPort", "vlanAPI", "vlanName", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameOperStatus=vlanNameOperStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIPort=vlanTestAPIPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortPortNum=vlanPortPortNum, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemTable=vlanSystemTable, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameNHash=vlanNameNHash, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIVerb=sfpsVAPIVerb, HexInteger=HexInteger, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameEntry=vlanNameEntry, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputTap=vlanTestAPIOutputTap, SfpsAddress=SfpsAddress, vlanSystemMibRev=vlanSystemMibRev, vlanPortVlanId=vlanPortVlanId, vlanSystemVersion=vlanSystemVersion, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemOperTime=vlanSystemOperTime, vlanPortPortStatus=vlanPortPortStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortEntry=vlanPortEntry, vlanPortRouterPort=vlanPortRouterPort, SfpsSwitchPort=SfpsSwitchPort, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortTable=vlanPortTable, vlanSystemLastChange=vlanSystemLastChange, vlanSystemEntry=vlanSystemEntry, vlanPortVlanName=vlanPortVlanName, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemPollCount=vlanSystemPollCount, vlanCountAPITotal=vlanCountAPITotal, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, VlanSwitchInstance=VlanSwitchInstance, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameStatusTime=vlanNameStatusTime, vlanNameTable=vlanNameTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameVlanName=vlanNameVlanName, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameNumUsers=vlanNameNumUsers, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameVlanId=vlanNameVlanId, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemDomainName=vlanSystemDomainName)
