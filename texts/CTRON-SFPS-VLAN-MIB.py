...
vlanAMRStats, vlanAMRSubnets, vlanSystem, vlanCountAPI, vlanPort, vlanAMRRules, vlanAPI, vlanTestAPI, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanAMRSubnets", "vlanSystem", "vlanCountAPI", "vlanPort", "vlanAMRRules", "vlanAPI", "vlanTestAPI", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIInPort=sfpsVAPIInPort, HexInteger=HexInteger, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortEntry=vlanPortEntry, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortVlanName=vlanPortVlanName, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputPort=vlanTestAPIOutputPort, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameNumUsers=vlanNameNumUsers, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemEntry=vlanSystemEntry, vlanPortVlanId=vlanPortVlanId, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, SfpsAddress=SfpsAddress, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameVlanName=vlanNameVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, VlanSwitchInstance=VlanSwitchInstance, vlanSystemDomainName=vlanSystemDomainName, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameStatusTime=vlanNameStatusTime, vlanPortTable=vlanPortTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameIndex=vlanNameIndex, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameNHash=vlanNameNHash, vlanPortRouterPort=vlanPortRouterPort, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIPort=vlanTestAPIPort, vlanNameEntry=vlanNameEntry, vlanSystemLastChange=vlanSystemLastChange, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameTable=vlanNameTable, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortPortNum=vlanPortPortNum, vlanNameUniPolicy=vlanNameUniPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameVlanId=vlanNameVlanId, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemOperTime=vlanSystemOperTime, vlanSystemTable=vlanSystemTable, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemPollCount=vlanSystemPollCount, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanSystemVersion=vlanSystemVersion)
