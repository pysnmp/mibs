...
vlanAMRSubnets, vlanAMRStats, vlanSystem, vlanName, vlanAPI, vlanPort, vlanAMRRules, vlanTestAPI, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanAMRStats", "vlanSystem", "vlanName", "vlanAPI", "vlanPort", "vlanAMRRules", "vlanTestAPI", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, SfpsAddress=SfpsAddress, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameTable=vlanNameTable, vlanSystemVersion=vlanSystemVersion, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortVlanName=vlanPortVlanName, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemEntry=vlanSystemEntry, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameStatusTime=vlanNameStatusTime, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemLastChange=vlanSystemLastChange, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemTable=vlanSystemTable, vlanNameVlanRule=vlanNameVlanRule, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameVlanId=vlanNameVlanId, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameIndex=vlanNameIndex, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameVlanName=vlanNameVlanName, vlanNameNHash=vlanNameNHash, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameNumUsers=vlanNameNumUsers, HexInteger=HexInteger, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortEntry=vlanPortEntry, vlanNameEntry=vlanNameEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortRouterPort=vlanPortRouterPort, vlanSystemDomainName=vlanSystemDomainName, vlanSystemMibRev=vlanSystemMibRev, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIVerb=vlanTestAPIVerb, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemPollCount=vlanSystemPollCount, vlanPortPortNum=vlanPortPortNum, vlanPortTable=vlanPortTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus)
