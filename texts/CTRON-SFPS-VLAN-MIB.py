...
vlanPort, vlanAMRStats, vlanName, vlanCountAPI, vlanAMRRules, vlanTestAPI, vlanAMRSubnets, vlanAPI, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAMRStats", "vlanName", "vlanCountAPI", "vlanAMRRules", "vlanTestAPI", "vlanAMRSubnets", "vlanAPI", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIPort=vlanTestAPIPort, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortEntry=vlanPortEntry, vlanNameVlanName=vlanNameVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemTable=vlanSystemTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameIndex=vlanNameIndex, SfpsAddress=SfpsAddress, vlanCountAPIAdmin=vlanCountAPIAdmin, HexInteger=HexInteger, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortPortNum=vlanPortPortNum, vlanSystemVersion=vlanSystemVersion, vlanPortRouterPort=vlanPortRouterPort, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemDomainName=vlanSystemDomainName, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameNumUsers=vlanNameNumUsers, vlanNameVlanId=vlanNameVlanId, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemEntry=vlanSystemEntry, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameOperStatus=vlanNameOperStatus, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortVlanName=vlanPortVlanName, vlanSystemPollCount=vlanSystemPollCount, vlanCountAPITotal=vlanCountAPITotal, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortVlanId=vlanPortVlanId, SfpsSwitchPort=SfpsSwitchPort, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortTable=vlanPortTable, vlanNameNHash=vlanNameNHash, vlanAMRSubnetsMask=vlanAMRSubnetsMask, VlanSwitchInstance=VlanSwitchInstance, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameEntry=vlanNameEntry, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameTable=vlanNameTable, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortLayer3Learning=vlanPortLayer3Learning)
