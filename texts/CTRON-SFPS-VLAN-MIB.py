...
vlanAMRRules, vlanAMRStats, vlanTestAPI, vlanCountAPI, vlanSystem, vlanName, vlanAPI, vlanPort, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanAMRStats", "vlanTestAPI", "vlanCountAPI", "vlanSystem", "vlanName", "vlanAPI", "vlanPort", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameOperStatus=vlanNameOperStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortVlanName=vlanPortVlanName, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortPortStatus=vlanPortPortStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameVlanRule=vlanNameVlanRule, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanCountAPITotal=vlanCountAPITotal, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemTable=vlanSystemTable, vlanSystemVersion=vlanSystemVersion, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortPortNum=vlanPortPortNum, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemDomainName=vlanSystemDomainName, vlanNameUniPolicy=vlanNameUniPolicy, HexInteger=HexInteger, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortTable=vlanPortTable, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameNHash=vlanNameNHash, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameTable=vlanNameTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemOperTime=vlanSystemOperTime, vlanPortVlanId=vlanPortVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortEntry=vlanPortEntry, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameVlanName=vlanNameVlanName, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPINvramId=sfpsVAPINvramId, VlanSwitchInstance=VlanSwitchInstance, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameEntry=vlanNameEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIPort=vlanTestAPIPort, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemEntry=vlanSystemEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemMibRev=vlanSystemMibRev, vlanNameNumUsers=vlanNameNumUsers, SfpsAddress=SfpsAddress, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, SfpsSwitchPort=SfpsSwitchPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus)
