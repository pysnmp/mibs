...
vlanAMRRules, vlanPort, vlanSystem, vlanName, vlanAPI, vlanCountAPI, vlanTestAPI, vlanAMRStats, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanPort", "vlanSystem", "vlanName", "vlanAPI", "vlanCountAPI", "vlanTestAPI", "vlanAMRStats", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameOperStatus=vlanNameOperStatus, vlanNameVlanName=vlanNameVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemVersion=vlanSystemVersion, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortPortNum=vlanPortPortNum, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortEntry=vlanPortEntry, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameStatusTime=vlanNameStatusTime, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameIndex=vlanNameIndex, vlanPortTable=vlanPortTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortVlanId=vlanPortVlanId, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameVlanRule=vlanNameVlanRule, vlanSystemMibRev=vlanSystemMibRev, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemLastPollTime=vlanSystemLastPollTime, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameAdminStatus=vlanNameAdminStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIPort=vlanTestAPIPort, vlanSystemLastChange=vlanSystemLastChange, vlanPortPortStatus=vlanPortPortStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, SfpsAddress=SfpsAddress, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemOperTime=vlanSystemOperTime, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanCountAPITotal=vlanCountAPITotal, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameNHash=vlanNameNHash, vlanNameVlanId=vlanNameVlanId, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortRouterPort=vlanPortRouterPort, vlanNameTable=vlanNameTable, vlanNameNumUsers=vlanNameNumUsers, vlanSystemTable=vlanSystemTable, vlanSystemDomainName=vlanSystemDomainName, HexInteger=HexInteger, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex)
