...
vlanPort, vlanAMRRules, vlanTestAPI, vlanAMRStats, vlanName, vlanCountAPI, vlanAMRSubnets, vlanSystem, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAMRRules", "vlanTestAPI", "vlanAMRStats", "vlanName", "vlanCountAPI", "vlanAMRSubnets", "vlanSystem", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemOperTime=vlanSystemOperTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortVlanId=vlanPortVlanId, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemPollCount=vlanSystemPollCount, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameEntry=vlanNameEntry, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameVlanId=vlanNameVlanId, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemDomainName=vlanSystemDomainName, VlanSwitchInstance=VlanSwitchInstance, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameNHash=vlanNameNHash, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemEntry=vlanSystemEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortVlanName=vlanPortVlanName, vlanPortRouterPort=vlanPortRouterPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortEntry=vlanPortEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemVersion=vlanSystemVersion, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameTable=vlanNameTable, vlanTestAPIVerb=vlanTestAPIVerb, SfpsAddress=SfpsAddress, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameNumUsers=vlanNameNumUsers, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortPortNum=vlanPortPortNum, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameVlanRule=vlanNameVlanRule, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, SfpsSwitchPort=SfpsSwitchPort, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameIndex=vlanNameIndex, vlanSystemTable=vlanSystemTable, HexInteger=HexInteger, vlanNameVlanName=vlanNameVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortTable=vlanPortTable, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputTap=vlanTestAPIOutputTap)
