...
vlanAMRRules, vlanCountAPI, vlanAMRStats, vlanName, vlanPort, vlanAMRSubnets, vlanAPI, vlanTestAPI, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanCountAPI", "vlanAMRStats", "vlanName", "vlanPort", "vlanAMRSubnets", "vlanAPI", "vlanTestAPI", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortVlanName=vlanPortVlanName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameNumUsers=vlanNameNumUsers, vlanNameVlanId=vlanNameVlanId, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputMap=vlanTestAPIOutputMap, SfpsSwitchPort=SfpsSwitchPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortUniPolicy=vlanPortUniPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortPortStatus=vlanPortPortStatus, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortVlanId=vlanPortVlanId, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemVersion=vlanSystemVersion, HexInteger=HexInteger, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameEntry=vlanNameEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameIndex=vlanNameIndex, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortTable=vlanPortTable, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemTable=vlanSystemTable, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanSystemOperTime=vlanSystemOperTime, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameTable=vlanNameTable, vlanPortPortNum=vlanPortPortNum, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemPollCount=vlanSystemPollCount, SfpsAddress=SfpsAddress, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameStatusTime=vlanNameStatusTime, vlanNameNHash=vlanNameNHash, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortEntry=vlanPortEntry, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortRouterPort=vlanPortRouterPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemMibRev=vlanSystemMibRev)
