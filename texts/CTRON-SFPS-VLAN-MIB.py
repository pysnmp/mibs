...
vlanCountAPI, vlanTestAPI, vlanSystem, vlanAMRRules, vlanAMRSubnets, vlanName, vlanAPI, vlanPort, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanTestAPI", "vlanSystem", "vlanAMRRules", "vlanAMRSubnets", "vlanName", "vlanAPI", "vlanPort", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIVerb=vlanTestAPIVerb, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, HexInteger=HexInteger, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameTable=vlanNameTable, vlanNameVlanId=vlanNameVlanId, vlanSystemTable=vlanSystemTable, vlanPortRouterPort=vlanPortRouterPort, vlanNameVlanName=vlanNameVlanName, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortPortStatus=vlanPortPortStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameNumUsers=vlanNameNumUsers, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, SfpsAddress=SfpsAddress, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameNHash=vlanNameNHash, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortPortNum=vlanPortPortNum, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIPort=vlanTestAPIPort, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortUniPolicy=vlanPortUniPolicy, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanSystemPollCount=vlanSystemPollCount, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortEntry=vlanPortEntry, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanNameEntry=vlanNameEntry, VlanSwitchInstance=VlanSwitchInstance, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortVlanName=vlanPortVlanName, vlanSystemEntry=vlanSystemEntry, vlanCountAPITotal=vlanCountAPITotal, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameIndex=vlanNameIndex, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortTable=vlanPortTable, vlanSystemLastChange=vlanSystemLastChange, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameUniPolicy=vlanNameUniPolicy)
