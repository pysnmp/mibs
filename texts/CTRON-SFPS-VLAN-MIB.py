...
vlanSystem, vlanAMRStats, vlanName, vlanAMRRules, vlanTestAPI, vlanCountAPI, vlanAPI, vlanPort, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanAMRStats", "vlanName", "vlanAMRRules", "vlanTestAPI", "vlanCountAPI", "vlanAPI", "vlanPort", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameTable=vlanNameTable, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemTable=vlanSystemTable, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameNHash=vlanNameNHash, vlanSystemPollCount=vlanSystemPollCount, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemDomainName=vlanSystemDomainName, vlanPortLayer3Learning=vlanPortLayer3Learning, SfpsAddress=SfpsAddress, vlanPortVlanId=vlanPortVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameIndex=vlanNameIndex, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortTable=vlanPortTable, vlanNameRelayAgent=vlanNameRelayAgent, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameOperStatus=vlanNameOperStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, VlanSwitchInstance=VlanSwitchInstance, vlanCountAPITotal=vlanCountAPITotal, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemOperTime=vlanSystemOperTime, HexInteger=HexInteger, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameEntry=vlanNameEntry, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortEntry=vlanPortEntry, vlanNameStatusTime=vlanNameStatusTime, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemLastChange=vlanSystemLastChange, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortPortStatus=vlanPortPortStatus, vlanSystemEntry=vlanSystemEntry, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortPortNum=vlanPortPortNum, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortVlanName=vlanPortVlanName, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameEnabledPorts=vlanNameEnabledPorts)
