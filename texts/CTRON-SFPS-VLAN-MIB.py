...
vlanName, vlanSystem, vlanCountAPI, vlanAPI, vlanTestAPI, vlanAMRStats, vlanPort, vlanAMRSubnets, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanSystem", "vlanCountAPI", "vlanAPI", "vlanTestAPI", "vlanAMRStats", "vlanPort", "vlanAMRSubnets", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameIndex=vlanNameIndex, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameOperStatus=vlanNameOperStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemLastPollTime=vlanSystemLastPollTime, SfpsAddress=SfpsAddress, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameStatusTime=vlanNameStatusTime, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortVlanId=vlanPortVlanId, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortPortStatus=vlanPortPortStatus, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortPortNum=vlanPortPortNum, vlanNameVlanId=vlanNameVlanId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameVlanName=vlanNameVlanName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortVlanName=vlanPortVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameVlanRule=vlanNameVlanRule, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameTable=vlanNameTable, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemOperTime=vlanSystemOperTime, vlanCountAPITotal=vlanCountAPITotal, vlanNameNHash=vlanNameNHash, sfpsVAPIVerb=sfpsVAPIVerb, VlanSwitchInstance=VlanSwitchInstance, HexInteger=HexInteger, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortEntry=vlanPortEntry, vlanSystemPollCount=vlanSystemPollCount, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortTable=vlanPortTable, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameEntry=vlanNameEntry, vlanSystemEntry=vlanSystemEntry, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemVersion=vlanSystemVersion, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask)
