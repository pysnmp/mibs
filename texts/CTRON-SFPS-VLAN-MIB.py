...
vlanPort, vlanTestAPI, vlanAMRStats, vlanName, vlanCountAPI, vlanAMRRules, vlanAPI, vlanSystem, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanTestAPI", "vlanAMRStats", "vlanName", "vlanCountAPI", "vlanAMRRules", "vlanAPI", "vlanSystem", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameVlanId=vlanNameVlanId, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameStatusTime=vlanNameStatusTime, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, SfpsAddress=SfpsAddress, vlanPortEntry=vlanPortEntry, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameIndex=vlanNameIndex, vlanSystemEntry=vlanSystemEntry, vlanSystemVersion=vlanSystemVersion, vlanSystemLastChange=vlanSystemLastChange, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameNHash=vlanNameNHash, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemOperTime=vlanSystemOperTime, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortPortNum=vlanPortPortNum, vlanCountAPIAdmin=vlanCountAPIAdmin, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameVlanName=vlanNameVlanName, vlanPortRouterPort=vlanPortRouterPort, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanCountAPITotal=vlanCountAPITotal, vlanPortVlanId=vlanPortVlanId, vlanNameTable=vlanNameTable, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameVlanRule=vlanNameVlanRule, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameRelayAgent=vlanNameRelayAgent, HexInteger=HexInteger, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortTable=vlanPortTable, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemTable=vlanSystemTable, VlanSwitchInstance=VlanSwitchInstance, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameEntry=vlanNameEntry, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameNumUsers=vlanNameNumUsers, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputTable=vlanTestAPIOutputTable)
