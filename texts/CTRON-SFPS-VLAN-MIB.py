...
vlanSystem, vlanName, vlanAPI, vlanAMRRules, vlanAMRStats, vlanAMRSubnets, vlanPort, vlanTestAPI, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanName", "vlanAPI", "vlanAMRRules", "vlanAMRStats", "vlanAMRSubnets", "vlanPort", "vlanTestAPI", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIVerb=sfpsVAPIVerb, vlanPortEntry=vlanPortEntry, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameEntry=vlanNameEntry, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortVlanId=vlanPortVlanId, VlanSwitchInstance=VlanSwitchInstance, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemTable=vlanSystemTable, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemEntry=vlanSystemEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameIndex=vlanNameIndex, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemPriorPollTime=vlanSystemPriorPollTime, SfpsAddress=SfpsAddress, vlanTestAPIPort=vlanTestAPIPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameNHash=vlanNameNHash, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortTable=vlanPortTable, vlanNameVlanId=vlanNameVlanId, vlanPortPortStatus=vlanPortPortStatus, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameVlanName=vlanNameVlanName, vlanNameTable=vlanNameTable, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortVlanName=vlanPortVlanName, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameOperStatus=vlanNameOperStatus, vlanSystemPollCount=vlanSystemPollCount, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIVlanId=sfpsVAPIVlanId, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortPortNum=vlanPortPortNum, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortUniPolicy=vlanPortUniPolicy, HexInteger=HexInteger, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemOperTime=vlanSystemOperTime, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemVersion=vlanSystemVersion)
