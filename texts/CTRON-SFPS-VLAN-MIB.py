...
vlanName, vlanAPI, vlanCountAPI, vlanAMRSubnets, vlanAMRStats, vlanAMRRules, vlanTestAPI, vlanPort, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanAPI", "vlanCountAPI", "vlanAMRSubnets", "vlanAMRStats", "vlanAMRRules", "vlanTestAPI", "vlanPort", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIVerb=vlanTestAPIVerb, vlanNameNHash=vlanNameNHash, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortPortStatus=vlanPortPortStatus, vlanPortTable=vlanPortTable, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemAgentIP=vlanSystemAgentIP, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameTable=vlanNameTable, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortEntry=vlanPortEntry, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortPortNum=vlanPortPortNum, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanCountAPITotal=vlanCountAPITotal, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameEntry=vlanNameEntry, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemVersion=vlanSystemVersion, vlanNameUniPolicy=vlanNameUniPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemPriorPollTime=vlanSystemPriorPollTime, HexInteger=HexInteger, vlanSystemLastChange=vlanSystemLastChange, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameVlanRule=vlanNameVlanRule, vlanSystemTable=vlanSystemTable, vlanSystemPollCount=vlanSystemPollCount, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameVlanId=vlanNameVlanId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameIndex=vlanNameIndex, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, SfpsAddress=SfpsAddress, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemEntry=vlanSystemEntry, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanNameStatusTime=vlanNameStatusTime, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortVlanId=vlanPortVlanId, vlanSystemDomainName=vlanSystemDomainName, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameVlanName=vlanNameVlanName)
