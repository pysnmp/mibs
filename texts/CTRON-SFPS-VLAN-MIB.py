...
vlanAMRSubnets, vlanSystem, vlanPort, vlanAPI, vlanAMRStats, vlanTestAPI, vlanCountAPI, vlanAMRRules, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanSystem", "vlanPort", "vlanAPI", "vlanAMRStats", "vlanTestAPI", "vlanCountAPI", "vlanAMRRules", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameEntry=vlanNameEntry, vlanPortPortNum=vlanPortPortNum, vlanPortEntry=vlanPortEntry, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemOperTime=vlanSystemOperTime, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortVlanName=vlanPortVlanName, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputPort=vlanTestAPIOutputPort, VlanSwitchInstance=VlanSwitchInstance, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortTable=vlanPortTable, vlanPortRelayAgent=vlanPortRelayAgent, HexInteger=HexInteger, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameVlanId=vlanNameVlanId, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortRouterPort=vlanPortRouterPort, vlanNameNumUsers=vlanNameNumUsers, vlanNameIndex=vlanNameIndex, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemLastChange=vlanSystemLastChange, vlanNameStatusTime=vlanNameStatusTime, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameNHash=vlanNameNHash, vlanNameVlanRule=vlanNameVlanRule, SfpsAddress=SfpsAddress, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameVlanName=vlanNameVlanName, SfpsSwitchPort=SfpsSwitchPort, vlanPortPortStatus=vlanPortPortStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameTable=vlanNameTable, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemVersion=vlanSystemVersion, vlanSystemTable=vlanSystemTable, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemMibRev=vlanSystemMibRev, vlanPortVlanId=vlanPortVlanId, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId)
