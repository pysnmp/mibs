...
vlanTestAPI, vlanPort, vlanName, vlanAMRStats, vlanAMRSubnets, vlanAPI, vlanSystem, vlanAMRRules, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanPort", "vlanName", "vlanAMRStats", "vlanAMRSubnets", "vlanAPI", "vlanSystem", "vlanAMRRules", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemDomainName=vlanSystemDomainName, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameStatusTime=vlanNameStatusTime, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameEntry=vlanNameEntry, vlanNameNHash=vlanNameNHash, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIUserAlias=sfpsVAPIUserAlias, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanCountAPITotal=vlanCountAPITotal, vlanNameVlanName=vlanNameVlanName, vlanTestAPIPort=vlanTestAPIPort, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortVlanId=vlanPortVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemAdminStatus=vlanSystemAdminStatus, SfpsSwitchPort=SfpsSwitchPort, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemEntry=vlanSystemEntry, vlanNameTable=vlanNameTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, HexInteger=HexInteger, vlanNameIndex=vlanNameIndex, vlanSystemTable=vlanSystemTable, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortPortStatus=vlanPortPortStatus, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortPortNum=vlanPortPortNum, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortTable=vlanPortTable, vlanPortVlanName=vlanPortVlanName, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameVlanId=vlanNameVlanId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemVersion=vlanSystemVersion, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemPollCount=vlanSystemPollCount, vlanPortRouterPort=vlanPortRouterPort, vlanSystemOperStatus=vlanSystemOperStatus, SfpsAddress=SfpsAddress, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameNumUsers=vlanNameNumUsers, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortAdminStatus=vlanPortAdminStatus)
