...
vlanAPI, vlanPort, vlanSystem, vlanAMRRules, vlanAMRSubnets, vlanAMRStats, vlanCountAPI, vlanName, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanPort", "vlanSystem", "vlanAMRRules", "vlanAMRSubnets", "vlanAMRStats", "vlanCountAPI", "vlanName", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", SfpsSwitchPort=SfpsSwitchPort, vlanPortAdminStatus=vlanPortAdminStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameIndex=vlanNameIndex, vlanNameVlanName=vlanNameVlanName, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIPort=vlanTestAPIPort, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameTable=vlanNameTable, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemPollCount=vlanSystemPollCount, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameOperStatus=vlanNameOperStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, HexInteger=HexInteger, vlanNameAdminStatus=vlanNameAdminStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanCountAPITotal=vlanCountAPITotal, vlanSystemTable=vlanSystemTable, vlanPortVlanName=vlanPortVlanName, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameEntry=vlanNameEntry, vlanPortTable=vlanPortTable, vlanSystemPriorPollTime=vlanSystemPriorPollTime, SfpsAddress=SfpsAddress, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemMibRev=vlanSystemMibRev, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortVlanId=vlanPortVlanId, vlanSystemVersion=vlanSystemVersion, vlanPortPortStatus=vlanPortPortStatus, vlanPortEntry=vlanPortEntry, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemEntry=vlanSystemEntry, VlanSwitchInstance=VlanSwitchInstance, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameVlanId=vlanNameVlanId, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemDomainName=vlanSystemDomainName, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputAble=vlanTestAPIOutputAble)
