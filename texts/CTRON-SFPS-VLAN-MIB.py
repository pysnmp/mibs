...
vlanSystem, vlanAMRStats, vlanAPI, vlanTestAPI, vlanCountAPI, vlanPort, vlanAMRRules, vlanName, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanAMRStats", "vlanAPI", "vlanTestAPI", "vlanCountAPI", "vlanPort", "vlanAMRRules", "vlanName", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameOperStatus=vlanNameOperStatus, vlanSystemAgentIP=vlanSystemAgentIP, HexInteger=HexInteger, vlanNameTable=vlanNameTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameVlanName=vlanNameVlanName, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameVlanRule=vlanNameVlanRule, vlanNameIndex=vlanNameIndex, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameStatusTime=vlanNameStatusTime, vlanSystemEntry=vlanSystemEntry, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortVlanId=vlanPortVlanId, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortVlanName=vlanPortVlanName, vlanPortTable=vlanPortTable, vlanCountAPITotal=vlanCountAPITotal, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, VlanSwitchInstance=VlanSwitchInstance, vlanSystemMibRev=vlanSystemMibRev, vlanSystemLastChange=vlanSystemLastChange, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemTable=vlanSystemTable, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameEntry=vlanNameEntry, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIPort=vlanTestAPIPort, SfpsSwitchPort=SfpsSwitchPort, vlanNameNHash=vlanNameNHash, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortEntry=vlanPortEntry, vlanPortPortNum=vlanPortPortNum, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, SfpsAddress=SfpsAddress, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameVlanId=vlanNameVlanId)
