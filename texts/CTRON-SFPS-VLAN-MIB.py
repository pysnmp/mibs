...
vlanSystem, vlanAMRRules, vlanPort, vlanCountAPI, vlanAPI, vlanAMRStats, vlanTestAPI, vlanAMRSubnets, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanAMRRules", "vlanPort", "vlanCountAPI", "vlanAPI", "vlanAMRStats", "vlanTestAPI", "vlanAMRSubnets", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIVerb=sfpsVAPIVerb, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameIndex=vlanNameIndex, vlanPortPortNum=vlanPortPortNum, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameVlanId=vlanNameVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameVlanName=vlanNameVlanName, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameNumUsers=vlanNameNumUsers, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputTap=vlanTestAPIOutputTap, VlanSwitchInstance=VlanSwitchInstance, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameNHash=vlanNameNHash, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemTable=vlanSystemTable, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortEntry=vlanPortEntry, vlanSystemLastChange=vlanSystemLastChange, vlanPortVlanName=vlanPortVlanName, vlanCountAPITotal=vlanCountAPITotal, HexInteger=HexInteger, SfpsAddress=SfpsAddress, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemEntry=vlanSystemEntry, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortVlanId=vlanPortVlanId, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameStatusTime=vlanNameStatusTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortTable=vlanPortTable, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemOperTime=vlanSystemOperTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemPollCount=vlanSystemPollCount, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameVlanRule=vlanNameVlanRule, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIPort=vlanTestAPIPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameTable=vlanNameTable, vlanSystemOperStatus=vlanSystemOperStatus)
