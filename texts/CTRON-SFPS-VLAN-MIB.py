...
vlanTestAPI, vlanPort, vlanAMRSubnets, vlanSystem, vlanAMRStats, vlanAPI, vlanAMRRules, vlanName, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanPort", "vlanAMRSubnets", "vlanSystem", "vlanAMRStats", "vlanAPI", "vlanAMRRules", "vlanName", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortEntry=vlanPortEntry, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortTable=vlanPortTable, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemPollCount=vlanSystemPollCount, vlanNameTable=vlanNameTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortRouterPort=vlanPortRouterPort, vlanPortVlanName=vlanPortVlanName, vlanSystemEntry=vlanSystemEntry, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameVlanName=vlanNameVlanName, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRRulesTable=vlanAMRRulesTable, vlanCountAPITotal=vlanCountAPITotal, SfpsAddress=SfpsAddress, SfpsSwitchPort=SfpsSwitchPort, vlanNameVlanId=vlanNameVlanId, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortVlanId=vlanPortVlanId, vlanNameIndex=vlanNameIndex, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameNHash=vlanNameNHash, vlanSystemOperTime=vlanSystemOperTime, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputMap=vlanTestAPIOutputMap, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameOperStatus=vlanNameOperStatus, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIPort=vlanTestAPIPort, vlanNameStatusTime=vlanNameStatusTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameUniPolicy=vlanNameUniPolicy, HexInteger=HexInteger, vlanSystemVersion=vlanSystemVersion, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemMibRev=vlanSystemMibRev, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemTable=vlanSystemTable, vlanPortPortNum=vlanPortPortNum, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameEntry=vlanNameEntry, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameVlanRule=vlanNameVlanRule, vlanSystemDomainName=vlanSystemDomainName)
