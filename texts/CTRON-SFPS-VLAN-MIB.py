...
vlanTestAPI, vlanPort, vlanCountAPI, vlanSystem, vlanAPI, vlanName, vlanAMRRules, vlanAMRStats, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanPort", "vlanCountAPI", "vlanSystem", "vlanAPI", "vlanName", "vlanAMRRules", "vlanAMRStats", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", HexInteger=HexInteger, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIPort=vlanTestAPIPort, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameNumUsers=vlanNameNumUsers, vlanNameEnabledPorts=vlanNameEnabledPorts, SfpsAddress=SfpsAddress, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortRouterPort=vlanPortRouterPort, vlanNameNHash=vlanNameNHash, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortVlanName=vlanPortVlanName, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIVlanName=sfpsVAPIVlanName, SfpsSwitchPort=SfpsSwitchPort, vlanNameIndex=vlanNameIndex, vlanNameTable=vlanNameTable, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortEntry=vlanPortEntry, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameVlanName=vlanNameVlanName, vlanSystemOperTime=vlanSystemOperTime, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemTable=vlanSystemTable, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemEntry=vlanSystemEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemVersion=vlanSystemVersion, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPINvramId=sfpsVAPINvramId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, VlanSwitchInstance=VlanSwitchInstance, vlanPortPortNum=vlanPortPortNum, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameEntry=vlanNameEntry, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortVlanId=vlanPortVlanId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameVlanRule=vlanNameVlanRule, vlanPortTable=vlanPortTable, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameStatusTime=vlanNameStatusTime, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemLastChange=vlanSystemLastChange, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemOperStatus=vlanSystemOperStatus)
