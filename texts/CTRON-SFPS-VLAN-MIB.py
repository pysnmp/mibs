...
vlanAMRStats, vlanPort, vlanName, vlanTestAPI, vlanAMRRules, vlanAMRSubnets, vlanSystem, vlanCountAPI, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanPort", "vlanName", "vlanTestAPI", "vlanAMRRules", "vlanAMRSubnets", "vlanSystem", "vlanCountAPI", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameTable=vlanNameTable, vlanSystemMibRev=vlanSystemMibRev, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortVlanId=vlanPortVlanId, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortEntry=vlanPortEntry, vlanNameEntry=vlanNameEntry, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemDomainName=vlanSystemDomainName, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputAble=vlanTestAPIOutputAble, HexInteger=HexInteger, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameVlanName=vlanNameVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortVlanName=vlanPortVlanName, vlanSystemPollCount=vlanSystemPollCount, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemVersion=vlanSystemVersion, vlanNameVlanId=vlanNameVlanId, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameOperStatus=vlanNameOperStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameStatusTime=vlanNameStatusTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemTable=vlanSystemTable, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortPortStatus=vlanPortPortStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, SfpsAddress=SfpsAddress, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIUserMAC=sfpsVAPIUserMAC, VlanSwitchInstance=VlanSwitchInstance, vlanSystemEntry=vlanSystemEntry, vlanSystemLastChange=vlanSystemLastChange, vlanPortTable=vlanPortTable, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameFloodPorts=vlanNameFloodPorts)
