...
vlanName, vlanAPI, vlanTestAPI, vlanPort, vlanAMRSubnets, vlanCountAPI, vlanAMRRules, vlanSystem, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanAPI", "vlanTestAPI", "vlanPort", "vlanAMRSubnets", "vlanCountAPI", "vlanAMRRules", "vlanSystem", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortPortNum=vlanPortPortNum, vlanPortVlanId=vlanPortVlanId, vlanNameVlanRule=vlanNameVlanRule, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemVersion=vlanSystemVersion, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, SfpsAddress=SfpsAddress, vlanNameEnabledPorts=vlanNameEnabledPorts, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortPortStatus=vlanPortPortStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIInPort=sfpsVAPIInPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameIndex=vlanNameIndex, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemEntry=vlanSystemEntry, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameVlanId=vlanNameVlanId, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortVlanName=vlanPortVlanName, VlanSwitchInstance=VlanSwitchInstance, vlanSystemTable=vlanSystemTable, vlanPortRouterPort=vlanPortRouterPort, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortTable=vlanPortTable, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemMibRev=vlanSystemMibRev, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameRelayAgent=vlanNameRelayAgent, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameOperStatus=vlanNameOperStatus, vlanNameVlanName=vlanNameVlanName, vlanPortEntry=vlanPortEntry, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortPortPolicy=vlanPortPortPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameNHash=vlanNameNHash, vlanNameTable=vlanNameTable, HexInteger=HexInteger, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemOperTime=vlanSystemOperTime, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameNumUsers=vlanNameNumUsers, vlanPortAdminStatus=vlanPortAdminStatus)
