...
vlanPort, vlanAPI, vlanAMRStats, vlanAMRSubnets, vlanCountAPI, vlanSystem, vlanTestAPI, vlanName, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAPI", "vlanAMRStats", "vlanAMRSubnets", "vlanCountAPI", "vlanSystem", "vlanTestAPI", "vlanName", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameVlanId=vlanNameVlanId, vlanNameTable=vlanNameTable, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemAgentIP=vlanSystemAgentIP, vlanCountAPITotal=vlanCountAPITotal, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortVlanId=vlanPortVlanId, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameFloodPolicy=vlanNameFloodPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanNameNumUsers=vlanNameNumUsers, vlanSystemDomainName=vlanSystemDomainName, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortPortNum=vlanPortPortNum, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortVlanName=vlanPortVlanName, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemEntry=vlanSystemEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRRulesTable=vlanAMRRulesTable, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameIndex=vlanNameIndex, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemTable=vlanSystemTable, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameOperStatus=vlanNameOperStatus, vlanNameStatusTime=vlanNameStatusTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortTable=vlanPortTable, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, VlanSwitchInstance=VlanSwitchInstance, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemPollCount=vlanSystemPollCount, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, SfpsAddress=SfpsAddress, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameNHash=vlanNameNHash, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIPort=vlanTestAPIPort, vlanNameEntry=vlanNameEntry, vlanNameVlanName=vlanNameVlanName, vlanSystemMibRev=vlanSystemMibRev, HexInteger=HexInteger, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemOperTime=vlanSystemOperTime)
