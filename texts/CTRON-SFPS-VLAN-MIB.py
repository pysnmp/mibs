...
vlanName, vlanAMRSubnets, vlanCountAPI, vlanTestAPI, vlanSystem, vlanAMRRules, vlanPort, vlanAMRStats, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanAMRSubnets", "vlanCountAPI", "vlanTestAPI", "vlanSystem", "vlanAMRRules", "vlanPort", "vlanAMRStats", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanCountAPITotal=vlanCountAPITotal, vlanPortVlanName=vlanPortVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortRouterPort=vlanPortRouterPort, vlanNameVlanRule=vlanNameVlanRule, vlanNameVlanName=vlanNameVlanName, vlanSystemEntry=vlanSystemEntry, vlanPortPortStatus=vlanPortPortStatus, SfpsAddress=SfpsAddress, vlanPortVlanId=vlanPortVlanId, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemTable=vlanSystemTable, vlanNameTable=vlanNameTable, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameNHash=vlanNameNHash, vlanPortTable=vlanPortTable, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemOperTime=vlanSystemOperTime, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameVlanId=vlanNameVlanId, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameIndex=vlanNameIndex, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemPollCount=vlanSystemPollCount, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanPortRelayAgent=vlanPortRelayAgent, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameNumUsers=vlanNameNumUsers, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortEntry=vlanPortEntry, vlanNameEntry=vlanNameEntry, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIVlanName=sfpsVAPIVlanName, HexInteger=HexInteger, vlanSystemMibRev=vlanSystemMibRev, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortPortNum=vlanPortPortNum, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, VlanSwitchInstance=VlanSwitchInstance, vlanSystemVersion=vlanSystemVersion, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIUserAlias=sfpsVAPIUserAlias)
