...
vlanAPI, vlanTestAPI, vlanCountAPI, vlanName, vlanAMRRules, vlanAMRSubnets, vlanAMRStats, vlanPort, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanTestAPI", "vlanCountAPI", "vlanName", "vlanAMRRules", "vlanAMRSubnets", "vlanAMRStats", "vlanPort", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanCountAPITotal=vlanCountAPITotal, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, SfpsAddress=SfpsAddress, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortRelayAgent=vlanPortRelayAgent, VlanSwitchInstance=VlanSwitchInstance, vlanSystemVersion=vlanSystemVersion, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameNHash=vlanNameNHash, vlanSystemLastChange=vlanSystemLastChange, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortVlanId=vlanPortVlanId, vlanSystemPollCount=vlanSystemPollCount, vlanPortTable=vlanPortTable, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameNumUsers=vlanNameNumUsers, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemOperTime=vlanSystemOperTime, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortVlanName=vlanPortVlanName, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemTable=vlanSystemTable, SfpsSwitchPort=SfpsSwitchPort, vlanPortEntry=vlanPortEntry, vlanNameEntry=vlanNameEntry, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameTable=vlanNameTable, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameStatusTime=vlanNameStatusTime, vlanPortPortNum=vlanPortPortNum, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIPort=vlanTestAPIPort, vlanPortPortStatus=vlanPortPortStatus, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIVerb=vlanTestAPIVerb, HexInteger=HexInteger, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameVlanId=vlanNameVlanId, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameOperStatus=vlanNameOperStatus, vlanNameVlanName=vlanNameVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameIndex=vlanNameIndex, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputTap=vlanTestAPIOutputTap)
