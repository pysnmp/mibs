...
vlanCountAPI, vlanAPI, vlanAMRSubnets, vlanAMRStats, vlanName, vlanTestAPI, vlanAMRRules, vlanSystem, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAPI", "vlanAMRSubnets", "vlanAMRStats", "vlanName", "vlanTestAPI", "vlanAMRRules", "vlanSystem", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemTable=vlanSystemTable, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameEntry=vlanNameEntry, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIVerb=vlanTestAPIVerb, SfpsAddress=SfpsAddress, vlanPortPortStatus=vlanPortPortStatus, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameVlanId=vlanNameVlanId, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemVersion=vlanSystemVersion, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemEntry=vlanSystemEntry, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameTable=vlanNameTable, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortVlanId=vlanPortVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, HexInteger=HexInteger, vlanPortPortNum=vlanPortPortNum, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanCountAPITotal=vlanCountAPITotal, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortTable=vlanPortTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameVlanName=vlanNameVlanName, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIPort=vlanTestAPIPort, vlanPortEntry=vlanPortEntry, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanPortVlanName=vlanPortVlanName, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameNHash=vlanNameNHash, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameIndex=vlanNameIndex, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemDomainName=vlanSystemDomainName, vlanNameFloodPorts=vlanNameFloodPorts, SfpsSwitchPort=SfpsSwitchPort, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId)
