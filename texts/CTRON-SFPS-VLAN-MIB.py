...
vlanAMRStats, vlanTestAPI, vlanCountAPI, vlanPort, vlanAMRRules, vlanSystem, vlanAMRSubnets, vlanName, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanTestAPI", "vlanCountAPI", "vlanPort", "vlanAMRRules", "vlanSystem", "vlanAMRSubnets", "vlanName", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemTable=vlanSystemTable, vlanSystemDomainName=vlanSystemDomainName, vlanPortPortNum=vlanPortPortNum, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemOperStatus=vlanSystemOperStatus, SfpsAddress=SfpsAddress, vlanNameNumUsers=vlanNameNumUsers, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemEntry=vlanSystemEntry, SfpsSwitchPort=SfpsSwitchPort, vlanPortVlanName=vlanPortVlanName, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameVlanId=vlanNameVlanId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameStatusTime=vlanNameStatusTime, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortEntry=vlanPortEntry, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameVlanName=vlanNameVlanName, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameTable=vlanNameTable, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemOperTime=vlanSystemOperTime, vlanNameEntry=vlanNameEntry, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIPort=vlanTestAPIPort, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameNHash=vlanNameNHash, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemPollCount=vlanSystemPollCount, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameIndex=vlanNameIndex, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, HexInteger=HexInteger, vlanPortVlanId=vlanPortVlanId, vlanPortTable=vlanPortTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameVlanRule=vlanNameVlanRule, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemVersion=vlanSystemVersion, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName)
