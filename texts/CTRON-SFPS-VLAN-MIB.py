...
vlanCountAPI, vlanAMRStats, vlanAPI, vlanName, vlanAMRSubnets, vlanPort, vlanTestAPI, vlanAMRRules, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAMRStats", "vlanAPI", "vlanName", "vlanAMRSubnets", "vlanPort", "vlanTestAPI", "vlanAMRRules", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameTable=vlanNameTable, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortTable=vlanPortTable, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameVlanRule=vlanNameVlanRule, vlanPortUniPolicy=vlanPortUniPolicy, vlanCountAPITotal=vlanCountAPITotal, HexInteger=HexInteger, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemTable=vlanSystemTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemEntry=vlanSystemEntry, vlanSystemLastChange=vlanSystemLastChange, SfpsAddress=SfpsAddress, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameNumUsers=vlanNameNumUsers, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameVlanName=vlanNameVlanName, vlanNameVlanId=vlanNameVlanId, vlanPortRouterPort=vlanPortRouterPort, vlanPortPortStatus=vlanPortPortStatus, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameNHash=vlanNameNHash, vlanPortVlanName=vlanPortVlanName, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortEntry=vlanPortEntry, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameEntry=vlanNameEntry, vlanNameIndex=vlanNameIndex, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameOperStatus=vlanNameOperStatus, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemVersion=vlanSystemVersion, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameStatusTime=vlanNameStatusTime, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortVlanId=vlanPortVlanId, vlanSystemDomainName=vlanSystemDomainName)
