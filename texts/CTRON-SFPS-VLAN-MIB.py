...
vlanCountAPI, vlanName, vlanTestAPI, vlanPort, vlanSystem, vlanAMRStats, vlanAPI, vlanAMRSubnets, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanName", "vlanTestAPI", "vlanPort", "vlanSystem", "vlanAMRStats", "vlanAPI", "vlanAMRSubnets", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", SfpsAddress=SfpsAddress, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameNHash=vlanNameNHash, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanPortPortNum=vlanPortPortNum, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanNameEntry=vlanNameEntry, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortEntry=vlanPortEntry, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortPortStatus=vlanPortPortStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemOperTime=vlanSystemOperTime, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameTable=vlanNameTable, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameVlanId=vlanNameVlanId, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemPollCount=vlanSystemPollCount, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameIndex=vlanNameIndex, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameVlanName=vlanNameVlanName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemEntry=vlanSystemEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortAdminStatus=vlanPortAdminStatus, HexInteger=HexInteger, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameOperStatus=vlanNameOperStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemTable=vlanSystemTable, vlanPortVlanId=vlanPortVlanId, vlanSystemMibRev=vlanSystemMibRev, VlanSwitchInstance=VlanSwitchInstance, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanCountAPITotal=vlanCountAPITotal, vlanPortTable=vlanPortTable, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable)
