...
vlanAMRRules, vlanSystem, vlanAMRSubnets, vlanCountAPI, vlanTestAPI, vlanPort, vlanName, vlanAMRStats, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanSystem", "vlanAMRSubnets", "vlanCountAPI", "vlanTestAPI", "vlanPort", "vlanName", "vlanAMRStats", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameVlanId=vlanNameVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, HexInteger=HexInteger, vlanNameUniPolicy=vlanNameUniPolicy, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortPortStatus=vlanPortPortStatus, vlanPortEntry=vlanPortEntry, vlanPortPortNum=vlanPortPortNum, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameNHash=vlanNameNHash, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortVlanName=vlanPortVlanName, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemPollCount=vlanSystemPollCount, vlanNameOperStatus=vlanNameOperStatus, vlanNameVlanName=vlanNameVlanName, vlanNameIndex=vlanNameIndex, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameTable=vlanNameTable, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameAdminStatus=vlanNameAdminStatus, SfpsSwitchPort=SfpsSwitchPort, vlanNameEntry=vlanNameEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortPortPolicy=vlanPortPortPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortTable=vlanPortTable, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, SfpsAddress=SfpsAddress, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemTable=vlanSystemTable, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemMibRev=vlanSystemMibRev, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemEntry=vlanSystemEntry, vlanSystemLastChange=vlanSystemLastChange, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemVersion=vlanSystemVersion, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIVlanName=vlanTestAPIVlanName)
