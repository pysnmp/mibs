...
vlanAMRRules, vlanSystem, vlanName, vlanPort, vlanAMRStats, vlanAPI, vlanTestAPI, vlanAMRSubnets, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanSystem", "vlanName", "vlanPort", "vlanAMRStats", "vlanAPI", "vlanTestAPI", "vlanAMRSubnets", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIPort=vlanTestAPIPort, vlanPortVlanName=vlanPortVlanName, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemVersion=vlanSystemVersion, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameOperStatus=vlanNameOperStatus, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortVlanId=vlanPortVlanId, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameTable=vlanNameTable, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameNumUsers=vlanNameNumUsers, SfpsAddress=SfpsAddress, vlanSystemMibRev=vlanSystemMibRev, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemEntry=vlanSystemEntry, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, HexInteger=HexInteger, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameNHash=vlanNameNHash, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortPortNum=vlanPortPortNum, vlanCountAPITotal=vlanCountAPITotal, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameVlanRule=vlanNameVlanRule, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemTable=vlanSystemTable, vlanPortPortStatus=vlanPortPortStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemDomainName=vlanSystemDomainName, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemOperTime=vlanSystemOperTime, vlanSystemLastChange=vlanSystemLastChange, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanPortTable=vlanPortTable, vlanPortEntry=vlanPortEntry, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameIndex=vlanNameIndex, vlanNameVlanId=vlanNameVlanId, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameStatusTime=vlanNameStatusTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime, VlanSwitchInstance=VlanSwitchInstance, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortRouterPort=vlanPortRouterPort, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts)
