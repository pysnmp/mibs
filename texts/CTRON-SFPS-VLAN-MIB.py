...
vlanAMRSubnets, vlanAMRRules, vlanAPI, vlanPort, vlanAMRStats, vlanTestAPI, vlanSystem, vlanName, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanAMRRules", "vlanAPI", "vlanPort", "vlanAMRStats", "vlanTestAPI", "vlanSystem", "vlanName", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameNumUsers=vlanNameNumUsers, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, VlanSwitchInstance=VlanSwitchInstance, SfpsAddress=SfpsAddress, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortEntry=vlanPortEntry, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortRouterPort=vlanPortRouterPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanCountAPITotal=vlanCountAPITotal, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameVlanName=vlanNameVlanName, vlanNameNHash=vlanNameNHash, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemVersion=vlanSystemVersion, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameEntry=vlanNameEntry, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemOperTime=vlanSystemOperTime, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortVlanId=vlanPortVlanId, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameVlanRule=vlanNameVlanRule, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemTable=vlanSystemTable, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameIndex=vlanNameIndex, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemDomainName=vlanSystemDomainName, vlanPortPortNum=vlanPortPortNum, vlanNameVlanId=vlanNameVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortTable=vlanPortTable, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortVlanName=vlanPortVlanName, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameUniPolicy=vlanNameUniPolicy, HexInteger=HexInteger, vlanNameTable=vlanNameTable, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIVerb=vlanTestAPIVerb)
