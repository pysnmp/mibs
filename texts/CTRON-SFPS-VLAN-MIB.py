...
vlanAPI, vlanAMRRules, vlanAMRStats, vlanAMRSubnets, vlanCountAPI, vlanName, vlanPort, vlanSystem, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanAMRRules", "vlanAMRStats", "vlanAMRSubnets", "vlanCountAPI", "vlanName", "vlanPort", "vlanSystem", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemAdminStatus=vlanSystemAdminStatus, HexInteger=HexInteger, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemVersion=vlanSystemVersion, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortVlanName=vlanPortVlanName, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIPort=vlanTestAPIPort, vlanPortVlanId=vlanPortVlanId, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemEntry=vlanSystemEntry, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortTable=vlanPortTable, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortRelayAgent=vlanPortRelayAgent, SfpsAddress=SfpsAddress, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortPortNum=vlanPortPortNum, vlanNameIndex=vlanNameIndex, vlanSystemTable=vlanSystemTable, vlanNameStatusTime=vlanNameStatusTime, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameVlanName=vlanNameVlanName, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortPortStatus=vlanPortPortStatus, vlanNameVlanId=vlanNameVlanId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemLastChange=vlanSystemLastChange, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameEntry=vlanNameEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameTable=vlanNameTable, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortEntry=vlanPortEntry, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemPollCount=vlanSystemPollCount, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIVerb=sfpsVAPIVerb, vlanCountAPIAdmin=vlanCountAPIAdmin, SfpsSwitchPort=SfpsSwitchPort)
