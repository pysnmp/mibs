...
vlanAMRStats, vlanPort, vlanName, vlanTestAPI, vlanAMRRules, vlanAPI, vlanCountAPI, vlanAMRSubnets, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanPort", "vlanName", "vlanTestAPI", "vlanAMRRules", "vlanAPI", "vlanCountAPI", "vlanAMRSubnets", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortVlanId=vlanPortVlanId, vlanPortEntry=vlanPortEntry, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameNHash=vlanNameNHash, vlanPortVlanName=vlanPortVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanNameFloodPorts=vlanNameFloodPorts, HexInteger=HexInteger, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortPortStatus=vlanPortPortStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortPortNum=vlanPortPortNum, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameNumUsers=vlanNameNumUsers, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemOperTime=vlanSystemOperTime, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameVlanRule=vlanNameVlanRule, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemVersion=vlanSystemVersion, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameVlanName=vlanNameVlanName, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanCountAPITotal=vlanCountAPITotal, vlanNameEntry=vlanNameEntry, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortUniPolicy=vlanPortUniPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanSystemTable=vlanSystemTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortTable=vlanPortTable, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemDomainName=vlanSystemDomainName, vlanNameTable=vlanNameTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, SfpsAddress=SfpsAddress, vlanNameVlanId=vlanNameVlanId, vlanSystemEntry=vlanSystemEntry, vlanNameIndex=vlanNameIndex, vlanAMRRulesTable=vlanAMRRulesTable)
