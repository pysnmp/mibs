...
vlanCountAPI, vlanAMRStats, vlanPort, vlanSystem, vlanTestAPI, vlanAMRSubnets, vlanName, vlanAMRRules, vlanAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanAMRStats", "vlanPort", "vlanSystem", "vlanTestAPI", "vlanAMRSubnets", "vlanName", "vlanAMRRules", "vlanAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortPortStatus=vlanPortPortStatus, vlanNameVlanId=vlanNameVlanId, vlanPortRouterPort=vlanPortRouterPort, vlanNameStatusTime=vlanNameStatusTime, vlanNameEntry=vlanNameEntry, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemDomainName=vlanSystemDomainName, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemOperTime=vlanSystemOperTime, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortTable=vlanPortTable, sfpsVAPINvramId=sfpsVAPINvramId, vlanCountAPITotal=vlanCountAPITotal, vlanNameTable=vlanNameTable, vlanNameNumUsers=vlanNameNumUsers, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIOutputTable=vlanTestAPIOutputTable, SfpsSwitchPort=SfpsSwitchPort, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, VlanSwitchInstance=VlanSwitchInstance, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortUniPolicy=vlanPortUniPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanCountAPIAdmin=vlanCountAPIAdmin, HexInteger=HexInteger, vlanSystemMibRev=vlanSystemMibRev, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, SfpsAddress=SfpsAddress, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameIndex=vlanNameIndex, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemPollCount=vlanSystemPollCount, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortPortNum=vlanPortPortNum, vlanPortVlanName=vlanPortVlanName, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemEntry=vlanSystemEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemVersion=vlanSystemVersion, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIPort=vlanTestAPIPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortVlanId=vlanPortVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortEntry=vlanPortEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameNHash=vlanNameNHash, vlanSystemTable=vlanSystemTable, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemOperStatus=vlanSystemOperStatus)
