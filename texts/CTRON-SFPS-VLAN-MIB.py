...
vlanAMRRules, vlanTestAPI, vlanAPI, vlanSystem, vlanAMRSubnets, vlanCountAPI, vlanPort, vlanAMRStats, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanTestAPI", "vlanAPI", "vlanSystem", "vlanAMRSubnets", "vlanCountAPI", "vlanPort", "vlanAMRStats", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", HexInteger=HexInteger, vlanNameVlanId=vlanNameVlanId, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemTable=vlanSystemTable, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortVlanName=vlanPortVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameIndex=vlanNameIndex, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemPollCount=vlanSystemPollCount, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameVlanName=vlanNameVlanName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemOperTime=vlanSystemOperTime, vlanPortLayer3Learning=vlanPortLayer3Learning, SfpsAddress=SfpsAddress, vlanSystemDomainName=vlanSystemDomainName, vlanPortEntry=vlanPortEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortPortStatus=vlanPortPortStatus, vlanNameEntry=vlanNameEntry, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortVlanId=vlanPortVlanId, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortTable=vlanPortTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemEntry=vlanSystemEntry, vlanTestAPIVerb=vlanTestAPIVerb, vlanCountAPITotal=vlanCountAPITotal, vlanNameVlanRule=vlanNameVlanRule, vlanNameTable=vlanNameTable, vlanSystemVersion=vlanSystemVersion, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameNHash=vlanNameNHash, vlanSystemMibRev=vlanSystemMibRev, vlanPortPortNum=vlanPortPortNum, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameAdminStatus=vlanNameAdminStatus, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemLastPollTime=vlanSystemLastPollTime, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameStatusTime=vlanNameStatusTime, vlanSystemLastChange=vlanSystemLastChange, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortFloodPolicy=vlanPortFloodPolicy)
