...
vlanAPI, vlanAMRRules, vlanCountAPI, vlanSystem, vlanAMRSubnets, vlanAMRStats, vlanName, vlanTestAPI, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanAMRRules", "vlanCountAPI", "vlanSystem", "vlanAMRSubnets", "vlanAMRStats", "vlanName", "vlanTestAPI", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemMibRev=vlanSystemMibRev, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputTap=vlanTestAPIOutputTap, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemEntry=vlanSystemEntry, vlanCountAPITotal=vlanCountAPITotal, vlanAMRRulesTable=vlanAMRRulesTable, HexInteger=HexInteger, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanPortRouterPort=vlanPortRouterPort, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortPortNum=vlanPortPortNum, vlanNameVlanId=vlanNameVlanId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemLastChange=vlanSystemLastChange, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemTable=vlanSystemTable, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortEntry=vlanPortEntry, vlanPortVlanId=vlanPortVlanId, vlanNameVlanName=vlanNameVlanName, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemVersion=vlanSystemVersion, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameOperStatus=vlanNameOperStatus, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortTable=vlanPortTable, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIVlanName=vlanTestAPIVlanName, SfpsAddress=SfpsAddress, vlanNameEntry=vlanNameEntry, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameIndex=vlanNameIndex, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameTable=vlanNameTable, vlanSystemDomainName=vlanSystemDomainName, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameNHash=vlanNameNHash, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameStatusTime=vlanNameStatusTime, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy)
