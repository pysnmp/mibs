...
vlanSystem, vlanAMRStats, vlanAMRRules, vlanCountAPI, vlanPort, vlanName, vlanAMRSubnets, vlanAPI, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanAMRStats", "vlanAMRRules", "vlanCountAPI", "vlanPort", "vlanName", "vlanAMRSubnets", "vlanAPI", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameVlanId=vlanNameVlanId, vlanPortPortStatus=vlanPortPortStatus, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortVlanName=vlanPortVlanName, HexInteger=HexInteger, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameIndex=vlanNameIndex, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemAdminReset=vlanSystemAdminReset, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameEntry=vlanNameEntry, vlanPortTable=vlanPortTable, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemMibRev=vlanSystemMibRev, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemVersion=vlanSystemVersion, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemPollCount=vlanSystemPollCount, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameTable=vlanNameTable, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortPortNum=vlanPortPortNum, vlanPortEntry=vlanPortEntry, vlanSystemTable=vlanSystemTable, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameVlanRule=vlanNameVlanRule, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputTap=vlanTestAPIOutputTap, SfpsAddress=SfpsAddress, SfpsSwitchPort=SfpsSwitchPort, vlanSystemEntry=vlanSystemEntry, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIVerb=sfpsVAPIVerb)
