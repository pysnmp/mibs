...
vlanAPI, vlanAMRRules, vlanPort, vlanName, vlanSystem, vlanAMRStats, vlanTestAPI, vlanCountAPI, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanAMRRules", "vlanPort", "vlanName", "vlanSystem", "vlanAMRStats", "vlanTestAPI", "vlanCountAPI", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortPortPolicy=vlanPortPortPolicy, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemEntry=vlanSystemEntry, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortPortNum=vlanPortPortNum, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemMibRev=vlanSystemMibRev, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameNHash=vlanNameNHash, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameVlanId=vlanNameVlanId, vlanNameEntry=vlanNameEntry, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortTable=vlanPortTable, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIPort=vlanTestAPIPort, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanCountAPITotal=vlanCountAPITotal, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortRouterPort=vlanPortRouterPort, vlanNameStatusTime=vlanNameStatusTime, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIInPort=sfpsVAPIInPort, SfpsAddress=SfpsAddress, vlanPortEntry=vlanPortEntry, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemTable=vlanSystemTable, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, HexInteger=HexInteger, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortPortStatus=vlanPortPortStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameRelayAgent=vlanNameRelayAgent, VlanSwitchInstance=VlanSwitchInstance, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameTable=vlanNameTable, vlanNameVlanRule=vlanNameVlanRule, vlanNameIndex=vlanNameIndex, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortVlanId=vlanPortVlanId, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemVersion=vlanSystemVersion, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt)
