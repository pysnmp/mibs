...
vlanCountAPI, vlanName, vlanAMRRules, vlanTestAPI, vlanAPI, vlanAMRStats, vlanPort, vlanSystem, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanName", "vlanAMRRules", "vlanTestAPI", "vlanAPI", "vlanAMRStats", "vlanPort", "vlanSystem", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemOperTime=vlanSystemOperTime, vlanNameVlanId=vlanNameVlanId, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanCountAPITotal=vlanCountAPITotal, HexInteger=HexInteger, vlanPortVlanName=vlanPortVlanName, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, SfpsAddress=SfpsAddress, vlanPortRouterPort=vlanPortRouterPort, vlanPortPortStatus=vlanPortPortStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortPortNum=vlanPortPortNum, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameEntry=vlanNameEntry, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIPort=vlanTestAPIPort, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortVlanId=vlanPortVlanId, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameVlanName=vlanNameVlanName, vlanSystemVersion=vlanSystemVersion, vlanNameTable=vlanNameTable, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortEntry=vlanPortEntry, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameIndex=vlanNameIndex, vlanSystemEntry=vlanSystemEntry, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemTable=vlanSystemTable, vlanSystemMibRev=vlanSystemMibRev, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameStatusTime=vlanNameStatusTime, vlanNameVlanRule=vlanNameVlanRule, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortTable=vlanPortTable, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy)
