...
vlanAPI, vlanCountAPI, vlanSystem, vlanAMRRules, vlanPort, vlanAMRStats, vlanName, vlanTestAPI, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanCountAPI", "vlanSystem", "vlanAMRRules", "vlanPort", "vlanAMRStats", "vlanName", "vlanTestAPI", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameIndex=vlanNameIndex, vlanNameVlanRule=vlanNameVlanRule, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIPort=vlanTestAPIPort, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortEntry=vlanPortEntry, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemVersion=vlanSystemVersion, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanCountAPITotal=vlanCountAPITotal, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameVlanName=vlanNameVlanName, vlanPortUniPolicy=vlanPortUniPolicy, vlanPortPortNum=vlanPortPortNum, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameOperStatus=vlanNameOperStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameTable=vlanNameTable, vlanSystemPollCount=vlanSystemPollCount, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortTable=vlanPortTable, vlanSystemOperTime=vlanSystemOperTime, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortPortStatus=vlanPortPortStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameNumUsers=vlanNameNumUsers, SfpsAddress=SfpsAddress, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIInPort=sfpsVAPIInPort, SfpsSwitchPort=SfpsSwitchPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, HexInteger=HexInteger, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameVlanId=vlanNameVlanId, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameEntry=vlanNameEntry, vlanNameNHash=vlanNameNHash, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, VlanSwitchInstance=VlanSwitchInstance, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanCountAPIAutoreg=vlanCountAPIAutoreg)
