...
vlanAPI, vlanAMRStats, vlanTestAPI, vlanAMRRules, vlanPort, vlanAMRSubnets, vlanCountAPI, vlanName, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanAMRStats", "vlanTestAPI", "vlanAMRRules", "vlanPort", "vlanAMRSubnets", "vlanCountAPI", "vlanName", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIVerb=sfpsVAPIVerb, vlanNameStatusTime=vlanNameStatusTime, vlanPortTable=vlanPortTable, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameOperStatus=vlanNameOperStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameVlanName=vlanNameVlanName, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIPort=vlanTestAPIPort, vlanSystemLastChange=vlanSystemLastChange, vlanPortRouterPort=vlanPortRouterPort, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameNHash=vlanNameNHash, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanCountAPIAutoreg=vlanCountAPIAutoreg, SfpsAddress=SfpsAddress, vlanSystemTable=vlanSystemTable, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemDomainName=vlanSystemDomainName, vlanNameTable=vlanNameTable, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortEntry=vlanPortEntry, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortPortNum=vlanPortPortNum, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameEntry=vlanNameEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortVlanId=vlanPortVlanId, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemPollCount=vlanSystemPollCount, HexInteger=HexInteger, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameIndex=vlanNameIndex, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemVersion=vlanSystemVersion, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameVlanId=vlanNameVlanId, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemEntry=vlanSystemEntry, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameVlanRule=vlanNameVlanRule, vlanPortVlanName=vlanPortVlanName, vlanTestAPIVlanName=vlanTestAPIVlanName)
