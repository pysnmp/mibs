...
vlanSystem, vlanPort, vlanTestAPI, vlanCountAPI, vlanAMRRules, vlanAPI, vlanAMRStats, vlanAMRSubnets, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanSystem", "vlanPort", "vlanTestAPI", "vlanCountAPI", "vlanAMRRules", "vlanAPI", "vlanAMRStats", "vlanAMRSubnets", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIPort=vlanTestAPIPort, vlanCountAPITotal=vlanCountAPITotal, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemPollCount=vlanSystemPollCount, vlanSystemTable=vlanSystemTable, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemEntry=vlanSystemEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIVerb=vlanTestAPIVerb, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortVlanName=vlanPortVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRRulesRule=vlanAMRRulesRule, vlanNameVlanName=vlanNameVlanName, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortTable=vlanPortTable, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameVlanRule=vlanNameVlanRule, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemVersion=vlanSystemVersion, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameOperStatus=vlanNameOperStatus, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameIndex=vlanNameIndex, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, VlanSwitchInstance=VlanSwitchInstance, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortEntry=vlanPortEntry, SfpsAddress=SfpsAddress, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameVlanId=vlanNameVlanId, SfpsSwitchPort=SfpsSwitchPort, vlanNameMappedPorts=vlanNameMappedPorts, vlanPortPortNum=vlanPortPortNum, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortRouterPort=vlanPortRouterPort, vlanNameEntry=vlanNameEntry, vlanPortVlanId=vlanPortVlanId, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameNumUsers=vlanNameNumUsers, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemOperTime=vlanSystemOperTime, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, HexInteger=HexInteger, vlanSystemDomainName=vlanSystemDomainName, vlanNameTable=vlanNameTable, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt)
