...
vlanAMRStats, vlanPort, vlanAPI, vlanAMRSubnets, vlanAMRRules, vlanName, vlanCountAPI, vlanSystem, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanPort", "vlanAPI", "vlanAMRSubnets", "vlanAMRRules", "vlanName", "vlanCountAPI", "vlanSystem", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameNHash=vlanNameNHash, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemEntry=vlanSystemEntry, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameVlanName=vlanNameVlanName, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemLastChange=vlanSystemLastChange, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameRelayAgent=vlanNameRelayAgent, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemTable=vlanSystemTable, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIVlanName=sfpsVAPIVlanName, SfpsSwitchPort=SfpsSwitchPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortVlanId=vlanPortVlanId, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortTable=vlanPortTable, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortPortNum=vlanPortPortNum, vlanPortRouterPort=vlanPortRouterPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameIndex=vlanNameIndex, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIInPort=sfpsVAPIInPort, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameEntry=vlanNameEntry, vlanPortVlanName=vlanPortVlanName, vlanTestAPIPort=vlanTestAPIPort, vlanPortEntry=vlanPortEntry, HexInteger=HexInteger, vlanSystemPollCount=vlanSystemPollCount, vlanSystemVersion=vlanSystemVersion, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPINvramId=sfpsVAPINvramId, SfpsAddress=SfpsAddress, vlanNameVlanId=vlanNameVlanId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameTable=vlanNameTable, vlanNameUniPolicy=vlanNameUniPolicy)
