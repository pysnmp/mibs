...
vlanName, vlanAMRRules, vlanTestAPI, vlanAPI, vlanPort, vlanAMRSubnets, vlanAMRStats, vlanSystem, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanAMRRules", "vlanTestAPI", "vlanAPI", "vlanPort", "vlanAMRSubnets", "vlanAMRStats", "vlanSystem", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemLastChange=vlanSystemLastChange, vlanSystemVersion=vlanSystemVersion, vlanNameNHash=vlanNameNHash, HexInteger=HexInteger, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameIndex=vlanNameIndex, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIPort=vlanTestAPIPort, vlanSystemEntry=vlanSystemEntry, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortVlanId=vlanPortVlanId, vlanSystemAdminReset=vlanSystemAdminReset, SfpsAddress=SfpsAddress, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesTable=vlanAMRRulesTable, SfpsSwitchPort=SfpsSwitchPort, vlanNameEntry=vlanNameEntry, vlanPortVlanName=vlanPortVlanName, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortTable=vlanPortTable, vlanPortEntry=vlanPortEntry, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemMibRev=vlanSystemMibRev, vlanNameAdminStatus=vlanNameAdminStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanCountAPITotal=vlanCountAPITotal, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameTable=vlanNameTable, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemOperStatus=vlanSystemOperStatus, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameVlanId=vlanNameVlanId, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortPortNum=vlanPortPortNum, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameVlanRule=vlanNameVlanRule, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIVerb=sfpsVAPIVerb, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortRouterPort=vlanPortRouterPort, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanAMRRulesStatus=vlanAMRRulesStatus)
