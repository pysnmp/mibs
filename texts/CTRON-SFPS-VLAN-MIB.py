...
vlanPort, vlanTestAPI, vlanAPI, vlanCountAPI, vlanAMRRules, vlanSystem, vlanAMRSubnets, vlanName, vlanAMRStats = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanTestAPI", "vlanAPI", "vlanCountAPI", "vlanAMRRules", "vlanSystem", "vlanAMRSubnets", "vlanName", "vlanAMRStats")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameIndex=vlanNameIndex, SfpsSwitchPort=SfpsSwitchPort, vlanPortPortNum=vlanPortPortNum, SfpsAddress=SfpsAddress, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIPort=vlanTestAPIPort, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemTable=vlanSystemTable, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameTable=vlanNameTable, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameRelayAgent=vlanNameRelayAgent, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemMibRev=vlanSystemMibRev, vlanNameEntry=vlanNameEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanNameUniPolicy=vlanNameUniPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemEntry=vlanSystemEntry, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameVlanName=vlanNameVlanName, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemPollCount=vlanSystemPollCount, vlanPortEntry=vlanPortEntry, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameNHash=vlanNameNHash, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameFloodPorts=vlanNameFloodPorts, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemVersion=vlanSystemVersion, vlanPortTable=vlanPortTable, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortVlanName=vlanPortVlanName, vlanSystemDomainName=vlanSystemDomainName, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanCountAPITotal=vlanCountAPITotal, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, HexInteger=HexInteger, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameAdminStatus=vlanNameAdminStatus)
