...
vlanName, vlanAPI, vlanTestAPI, vlanSystem, vlanAMRSubnets, vlanPort, vlanCountAPI, vlanAMRStats, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanAPI", "vlanTestAPI", "vlanSystem", "vlanAMRSubnets", "vlanPort", "vlanCountAPI", "vlanAMRStats", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameNHash=vlanNameNHash, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortTable=vlanPortTable, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortEntry=vlanPortEntry, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameOperStatus=vlanNameOperStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortRouterPort=vlanPortRouterPort, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemDomainName=vlanSystemDomainName, SfpsSwitchPort=SfpsSwitchPort, vlanSystemTable=vlanSystemTable, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameStatusTime=vlanNameStatusTime, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameNumUsers=vlanNameNumUsers, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameEntry=vlanNameEntry, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIPort=vlanTestAPIPort, SfpsAddress=SfpsAddress, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemEntry=vlanSystemEntry, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameIndex=vlanNameIndex, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemOperStatus=vlanSystemOperStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, VlanSwitchInstance=VlanSwitchInstance, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortVlanId=vlanPortVlanId, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortVlanName=vlanPortVlanName, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemPollCount=vlanSystemPollCount, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameVlanName=vlanNameVlanName, vlanSystemMibRev=vlanSystemMibRev, vlanNameTable=vlanNameTable, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanPortPortNum=vlanPortPortNum, HexInteger=HexInteger, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameVlanId=vlanNameVlanId, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask)
