...
vlanTestAPI, vlanAMRRules, vlanAMRSubnets, vlanAPI, vlanCountAPI, vlanSystem, vlanAMRStats, vlanPort, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanAMRRules", "vlanAMRSubnets", "vlanAPI", "vlanCountAPI", "vlanSystem", "vlanAMRStats", "vlanPort", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIVerb=vlanTestAPIVerb, SfpsAddress=SfpsAddress, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemVersion=vlanSystemVersion, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemTable=vlanSystemTable, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortPortStatus=vlanPortPortStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameTable=vlanNameTable, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameEntry=vlanNameEntry, vlanSystemOperTime=vlanSystemOperTime, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanAMRRulesStatus=vlanAMRRulesStatus, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanCountAPITotal=vlanCountAPITotal, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortVlanName=vlanPortVlanName, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameVlanName=vlanNameVlanName, vlanPortEntry=vlanPortEntry, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameNumUsers=vlanNameNumUsers, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemPollCount=vlanSystemPollCount, HexInteger=HexInteger, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameOperStatus=vlanNameOperStatus, vlanNameVlanRule=vlanNameVlanRule, vlanSystemFirstPollTime=vlanSystemFirstPollTime, VlanSwitchInstance=VlanSwitchInstance, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameIndex=vlanNameIndex, vlanNameVlanId=vlanNameVlanId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortTable=vlanPortTable, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortPortNum=vlanPortPortNum, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemMibRev=vlanSystemMibRev, vlanSystemEntry=vlanSystemEntry, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesRule=vlanAMRRulesRule)
