...
vlanAMRSubnets, vlanPort, vlanName, vlanCountAPI, vlanSystem, vlanAPI, vlanTestAPI, vlanAMRStats, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanPort", "vlanName", "vlanCountAPI", "vlanSystem", "vlanAPI", "vlanTestAPI", "vlanAMRStats", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameIndex=vlanNameIndex, vlanAMRRulesRule=vlanAMRRulesRule, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, SfpsAddress=SfpsAddress, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemLastChange=vlanSystemLastChange, vlanNameStatusTime=vlanNameStatusTime, vlanNameNumUsers=vlanNameNumUsers, vlanSystemEntry=vlanSystemEntry, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameEntry=vlanNameEntry, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameNHash=vlanNameNHash, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameVlanName=vlanNameVlanName, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameTable=vlanNameTable, vlanPortPortNum=vlanPortPortNum, vlanSystemAdminStatus=vlanSystemAdminStatus, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortVlanName=vlanPortVlanName, vlanTestAPIPort=vlanTestAPIPort, vlanSystemVersion=vlanSystemVersion, vlanSystemOperTime=vlanSystemOperTime, vlanPortPortStatus=vlanPortPortStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemTable=vlanSystemTable, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortVlanId=vlanPortVlanId, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortEntry=vlanPortEntry, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortTable=vlanPortTable, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIRouterPort=sfpsVAPIRouterPort, HexInteger=HexInteger, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemPollCount=vlanSystemPollCount, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortRelayAgent=vlanPortRelayAgent)
