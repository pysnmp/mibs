...
vlanTestAPI, vlanSystem, vlanAMRSubnets, vlanPort, vlanAPI, vlanAMRRules, vlanAMRStats, vlanCountAPI, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanTestAPI", "vlanSystem", "vlanAMRSubnets", "vlanPort", "vlanAPI", "vlanAMRRules", "vlanAMRStats", "vlanCountAPI", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortRouterPort=vlanPortRouterPort, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortPortNum=vlanPortPortNum, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortTable=vlanPortTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameEntry=vlanNameEntry, vlanSystemVersion=vlanSystemVersion, vlanNameNumUsers=vlanNameNumUsers, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanPortVlanId=vlanPortVlanId, vlanNameNHash=vlanNameNHash, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanCountAPITotal=vlanCountAPITotal, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameTable=vlanNameTable, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIUserMAC=sfpsVAPIUserMAC, SfpsAddress=SfpsAddress, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemPollCount=vlanSystemPollCount, vlanNameVlanId=vlanNameVlanId, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemDomainName=vlanSystemDomainName, SfpsSwitchPort=SfpsSwitchPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameVlanRule=vlanNameVlanRule, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameVlanName=vlanNameVlanName, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, VlanSwitchInstance=VlanSwitchInstance, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemTable=vlanSystemTable, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameStatusTime=vlanNameStatusTime, vlanPortPortStatus=vlanPortPortStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemEntry=vlanSystemEntry, vlanSystemMibRev=vlanSystemMibRev, vlanSystemPriorPollTime=vlanSystemPriorPollTime, HexInteger=HexInteger, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortVlanName=vlanPortVlanName, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameIndex=vlanNameIndex, vlanTestAPIPort=vlanTestAPIPort, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanAMRSubnetsMask=vlanAMRSubnetsMask, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanNameFloodPolicy=vlanNameFloodPolicy)
