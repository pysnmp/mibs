...
vlanAMRSubnets, vlanAMRStats, vlanAMRRules, vlanSystem, vlanName, vlanAPI, vlanPort, vlanTestAPI, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanAMRStats", "vlanAMRRules", "vlanSystem", "vlanName", "vlanAPI", "vlanPort", "vlanTestAPI", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameEntry=vlanNameEntry, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameOperStatus=vlanNameOperStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameVlanId=vlanNameVlanId, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortVlanName=vlanPortVlanName, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameFloodPolicy=vlanNameFloodPolicy, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIVerb=vlanTestAPIVerb, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, HexInteger=HexInteger, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameIndex=vlanNameIndex, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameNHash=vlanNameNHash, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemOperTime=vlanSystemOperTime, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameMappedPorts=vlanNameMappedPorts, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, SfpsSwitchPort=SfpsSwitchPort, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanCountAPITotal=vlanCountAPITotal, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortPortNum=vlanPortPortNum, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanSystemTable=vlanSystemTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortTable=vlanPortTable, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortVlanId=vlanPortVlanId, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameNumUsers=vlanNameNumUsers, SfpsAddress=SfpsAddress, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemMibRev=vlanSystemMibRev, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameTable=vlanNameTable, vlanNameVlanRule=vlanNameVlanRule, vlanPortEntry=vlanPortEntry, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemVersion=vlanSystemVersion, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemLastChange=vlanSystemLastChange, vlanPortRelayAgent=vlanPortRelayAgent)
