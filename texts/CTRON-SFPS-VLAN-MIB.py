...
vlanCountAPI, vlanTestAPI, vlanAMRSubnets, vlanName, vlanSystem, vlanAMRStats, vlanPort, vlanAPI, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanTestAPI", "vlanAMRSubnets", "vlanName", "vlanSystem", "vlanAMRStats", "vlanPort", "vlanAPI", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameAdminStatus=vlanNameAdminStatus, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortTable=vlanPortTable, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortPortNum=vlanPortPortNum, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortEntry=vlanPortEntry, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemTable=vlanSystemTable, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortAdminStatus=vlanPortAdminStatus, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanCountAPITotal=vlanCountAPITotal, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameRelayAgent=vlanNameRelayAgent, HexInteger=HexInteger, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanTestAPIPort=vlanTestAPIPort, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameOperStatus=vlanNameOperStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameEntry=vlanNameEntry, vlanNameVlanName=vlanNameVlanName, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIVerb=vlanTestAPIVerb, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortVlanId=vlanPortVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameVlanRule=vlanNameVlanRule, vlanSystemOperTime=vlanSystemOperTime, vlanPortVlanName=vlanPortVlanName, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameTable=vlanNameTable, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameIndex=vlanNameIndex, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameNHash=vlanNameNHash, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameVlanId=vlanNameVlanId, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemEntry=vlanSystemEntry, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameNumUsers=vlanNameNumUsers, vlanNameFloodPorts=vlanNameFloodPorts, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortPortStatus=vlanPortPortStatus, SfpsAddress=SfpsAddress, vlanAMRRulesEntry=vlanAMRRulesEntry, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemVersion=vlanSystemVersion, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus)
