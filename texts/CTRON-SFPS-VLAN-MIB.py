...
vlanPort, vlanAMRSubnets, vlanAMRStats, vlanName, vlanAPI, vlanTestAPI, vlanAMRRules, vlanSystem, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanPort", "vlanAMRSubnets", "vlanAMRStats", "vlanName", "vlanAPI", "vlanTestAPI", "vlanAMRRules", "vlanSystem", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, SfpsSwitchPort=SfpsSwitchPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameOperStatus=vlanNameOperStatus, vlanNameStatusTime=vlanNameStatusTime, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortVlanId=vlanPortVlanId, HexInteger=HexInteger, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameFloodPorts=vlanNameFloodPorts, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemEntry=vlanSystemEntry, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemVersion=vlanSystemVersion, vlanPortPortNum=vlanPortPortNum, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIPort=vlanTestAPIPort, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanSystemMibRev=vlanSystemMibRev, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameVlanName=vlanNameVlanName, vlanAMRRulesRule=vlanAMRRulesRule, vlanCountAPITotal=vlanCountAPITotal, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRRulesTable=vlanAMRRulesTable, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameEntry=vlanNameEntry, vlanNameTable=vlanNameTable, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameVlanRule=vlanNameVlanRule, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameNHash=vlanNameNHash, SfpsAddress=SfpsAddress, vlanPortVlanName=vlanPortVlanName, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameIndex=vlanNameIndex, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemTable=vlanSystemTable, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortTable=vlanPortTable, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameVlanId=vlanNameVlanId, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameRelayAgent=vlanNameRelayAgent, VlanSwitchInstance=VlanSwitchInstance, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanAMRRulesEntry=vlanAMRRulesEntry)
