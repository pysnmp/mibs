...
vlanCountAPI, vlanSystem, vlanAPI, vlanName, vlanAMRSubnets, vlanAMRStats, vlanTestAPI, vlanAMRRules, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanCountAPI", "vlanSystem", "vlanAPI", "vlanName", "vlanAMRSubnets", "vlanAMRStats", "vlanTestAPI", "vlanAMRRules", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIPort=vlanTestAPIPort, vlanSystemTable=vlanSystemTable, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortEntry=vlanPortEntry, vlanNameStatusTime=vlanNameStatusTime, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, SfpsAddress=SfpsAddress, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemPollCount=vlanSystemPollCount, vlanNameVlanRule=vlanNameVlanRule, vlanNameVlanId=vlanNameVlanId, vlanPortRouterPort=vlanPortRouterPort, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortUniPolicy=vlanPortUniPolicy, HexInteger=HexInteger, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameNumUsers=vlanNameNumUsers, vlanSystemOperTime=vlanSystemOperTime, vlanSystemVersion=vlanSystemVersion, vlanPortPortNum=vlanPortPortNum, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemEntry=vlanSystemEntry, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortVlanName=vlanPortVlanName, vlanPortVlanId=vlanPortVlanId, vlanSystemDomainName=vlanSystemDomainName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortTable=vlanPortTable, vlanTestAPIOutputTable=vlanTestAPIOutputTable, VlanSwitchInstance=VlanSwitchInstance, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameIndex=vlanNameIndex, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortPortPolicy=vlanPortPortPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemAdminReset=vlanSystemAdminReset, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanNameNHash=vlanNameNHash, vlanNameTable=vlanNameTable, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameEntry=vlanNameEntry, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanNameOperStatus=vlanNameOperStatus)
