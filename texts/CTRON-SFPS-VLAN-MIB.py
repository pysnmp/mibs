...
vlanAPI, vlanAMRStats, vlanAMRRules, vlanAMRSubnets, vlanTestAPI, vlanSystem, vlanCountAPI, vlanName, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanAMRStats", "vlanAMRRules", "vlanAMRSubnets", "vlanTestAPI", "vlanSystem", "vlanCountAPI", "vlanName", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanNameNHash=vlanNameNHash, VlanSwitchInstance=VlanSwitchInstance, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortPortStatus=vlanPortPortStatus, vlanSystemMibRev=vlanSystemMibRev, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameIndex=vlanNameIndex, vlanSystemLastChange=vlanSystemLastChange, vlanSystemOperTime=vlanSystemOperTime, vlanPortPortNum=vlanPortPortNum, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanPortVlanName=vlanPortVlanName, vlanPortEntry=vlanPortEntry, vlanSystemVersion=vlanSystemVersion, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanAMRRulesTable=vlanAMRRulesTable, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRRulesRule=vlanAMRRulesRule, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameTable=vlanNameTable, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortRouterPort=vlanPortRouterPort, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortVlanId=vlanPortVlanId, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanNameStatusTime=vlanNameStatusTime, vlanNameEntry=vlanNameEntry, sfpsVAPIVlanName=sfpsVAPIVlanName, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameVlanName=vlanNameVlanName, vlanSystemOperStatus=vlanSystemOperStatus, vlanSystemTable=vlanSystemTable, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortTable=vlanPortTable, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortRelayAgent=vlanPortRelayAgent, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanTestAPIPort=vlanTestAPIPort, HexInteger=HexInteger, SfpsSwitchPort=SfpsSwitchPort, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortUniPolicy=vlanPortUniPolicy, SfpsAddress=SfpsAddress, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameVlanRule=vlanNameVlanRule, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemPollCount=vlanSystemPollCount, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt)
