...
vlanName, vlanAMRStats, vlanAMRSubnets, vlanTestAPI, vlanAPI, vlanPort, vlanSystem, vlanAMRRules, vlanCountAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanAMRStats", "vlanAMRSubnets", "vlanTestAPI", "vlanAPI", "vlanPort", "vlanSystem", "vlanAMRRules", "vlanCountAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanSystemOperTime=vlanSystemOperTime, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortVlanName=vlanPortVlanName, SfpsAddress=SfpsAddress, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanNameFloodPorts=vlanNameFloodPorts, SfpsSwitchPort=SfpsSwitchPort, vlanNameStatusTime=vlanNameStatusTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortPortStatus=vlanPortPortStatus, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameIndex=vlanNameIndex, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameTable=vlanNameTable, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortEntry=vlanPortEntry, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortTable=vlanPortTable, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIVerb=sfpsVAPIVerb, vlanNameEntry=vlanNameEntry, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortVlanId=vlanPortVlanId, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemEntry=vlanSystemEntry, vlanNameVlanId=vlanNameVlanId, vlanSystemDomainName=vlanSystemDomainName, vlanSystemMibRev=vlanSystemMibRev, vlanNameVlanRule=vlanNameVlanRule, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortPortNum=vlanPortPortNum, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanSystemAgentIP=vlanSystemAgentIP, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemVersion=vlanSystemVersion, vlanSystemTable=vlanSystemTable, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameNumUsers=vlanNameNumUsers, HexInteger=HexInteger, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIUserMAC=sfpsVAPIUserMAC, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, VlanSwitchInstance=VlanSwitchInstance, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameVlanName=vlanNameVlanName, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortRouterPort=vlanPortRouterPort)
