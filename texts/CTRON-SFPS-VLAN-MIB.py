...
vlanAMRSubnets, vlanAPI, vlanAMRRules, vlanSystem, vlanCountAPI, vlanTestAPI, vlanAMRStats, vlanPort, vlanName = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanAPI", "vlanAMRRules", "vlanSystem", "vlanCountAPI", "vlanTestAPI", "vlanAMRStats", "vlanPort", "vlanName")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameVlanRule=vlanNameVlanRule, vlanCountAPITotal=vlanCountAPITotal, vlanAMRSubnetsMask=vlanAMRSubnetsMask, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortTable=vlanPortTable, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortRouterPort=vlanPortRouterPort, SfpsAddress=SfpsAddress, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanNameRelayAgent=vlanNameRelayAgent, HexInteger=HexInteger, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortPortNum=vlanPortPortNum, vlanSystemMibRev=vlanSystemMibRev, vlanSystemPollCount=vlanSystemPollCount, vlanNameUniPolicy=vlanNameUniPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanNameNumUsers=vlanNameNumUsers, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameVlanId=vlanNameVlanId, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameNHash=vlanNameNHash, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemOperTime=vlanSystemOperTime, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameIndex=vlanNameIndex, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameStatusTime=vlanNameStatusTime, vlanPortVlanName=vlanPortVlanName, vlanPortVlanId=vlanPortVlanId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemEntry=vlanSystemEntry, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameTable=vlanNameTable, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemLastPollTime=vlanSystemLastPollTime, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemVersion=vlanSystemVersion, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemTable=vlanSystemTable, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortPortStatus=vlanPortPortStatus, vlanPortAdminStatus=vlanPortAdminStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanPortEntry=vlanPortEntry, vlanNameEntry=vlanNameEntry, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning)
