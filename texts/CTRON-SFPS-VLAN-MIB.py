...
vlanName, vlanAMRSubnets, vlanAPI, vlanSystem, vlanTestAPI, vlanAMRStats, vlanPort, vlanCountAPI, vlanAMRRules = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanName", "vlanAMRSubnets", "vlanAPI", "vlanSystem", "vlanTestAPI", "vlanAMRStats", "vlanPort", "vlanCountAPI", "vlanAMRRules")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanAMRRulesRule=vlanAMRRulesRule, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanCountAPITotal=vlanCountAPITotal, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortPortStatus=vlanPortPortStatus, vlanPortVlanName=vlanPortVlanName, vlanSystemLastChange=vlanSystemLastChange, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPINvramId=sfpsVAPINvramId, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameNumUsers=vlanNameNumUsers, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemMibRev=vlanSystemMibRev, vlanNameIndex=vlanNameIndex, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortVlanId=vlanPortVlanId, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIVerb=sfpsVAPIVerb, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameVlanId=vlanNameVlanId, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanNameRelayAgent=vlanNameRelayAgent, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemAgentIP=vlanSystemAgentIP, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanSystemTable=vlanSystemTable, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemVersion=vlanSystemVersion, vlanNameStatusTime=vlanNameStatusTime, vlanPortPortNum=vlanPortPortNum, vlanNameNHash=vlanNameNHash, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortRouterPort=vlanPortRouterPort, vlanPortRelayAgent=vlanPortRelayAgent, HexInteger=HexInteger, SfpsAddress=SfpsAddress, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemEntry=vlanSystemEntry, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRRulesTable=vlanAMRRulesTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanPortTable=vlanPortTable, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortEntry=vlanPortEntry, vlanSystemAdminStatus=vlanSystemAdminStatus, VlanSwitchInstance=VlanSwitchInstance, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIPort=vlanTestAPIPort, vlanSystemDomainName=vlanSystemDomainName, vlanAMRRulesStatus=vlanAMRRulesStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameVlanName=vlanNameVlanName, vlanNameVlanRule=vlanNameVlanRule, vlanNameEntry=vlanNameEntry, vlanNameTable=vlanNameTable, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemSwitchInstance=vlanSystemSwitchInstance)
