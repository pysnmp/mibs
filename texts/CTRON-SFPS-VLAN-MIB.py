...
vlanAPI, vlanAMRStats, vlanName, vlanSystem, vlanAMRRules, vlanCountAPI, vlanTestAPI, vlanPort, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanAMRStats", "vlanName", "vlanSystem", "vlanAMRRules", "vlanCountAPI", "vlanTestAPI", "vlanPort", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortVlanId=vlanPortVlanId, vlanSystemOperStatus=vlanSystemOperStatus, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortVlanName=vlanPortVlanName, vlanAMRRulesTable=vlanAMRRulesTable, SfpsAddress=SfpsAddress, vlanSystemOperTime=vlanSystemOperTime, vlanNameEntry=vlanNameEntry, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemAdminReset=vlanSystemAdminReset, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanSystemMibRev=vlanSystemMibRev, vlanSystemEntry=vlanSystemEntry, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanCountAPITotal=vlanCountAPITotal, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameStatusTime=vlanNameStatusTime, vlanPortPortStatus=vlanPortPortStatus, vlanNameTable=vlanNameTable, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameNumUsers=vlanNameNumUsers, vlanNameVlanName=vlanNameVlanName, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortAdminStatus=vlanPortAdminStatus, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameOperStatus=vlanNameOperStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortEntry=vlanPortEntry, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameIndex=vlanNameIndex, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameVlanId=vlanNameVlanId, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanPortPortNum=vlanPortPortNum, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortTable=vlanPortTable, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, HexInteger=HexInteger, vlanNameAdminStatus=vlanNameAdminStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanSystemDomainName=vlanSystemDomainName, VlanSwitchInstance=VlanSwitchInstance, vlanNameUniPolicy=vlanNameUniPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameNHash=vlanNameNHash, vlanNameVlanRule=vlanNameVlanRule, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemVersion=vlanSystemVersion, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortLayer3Learning=vlanPortLayer3Learning, sfpsVAPINvramId=sfpsVAPINvramId, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRRulesRule=vlanAMRRulesRule, sfpsVAPIInPort=sfpsVAPIInPort, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemLastChange=vlanSystemLastChange)
