...
vlanAMRStats, vlanCountAPI, vlanSystem, vlanAMRSubnets, vlanPort, vlanAPI, vlanAMRRules, vlanName, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRStats", "vlanCountAPI", "vlanSystem", "vlanAMRSubnets", "vlanPort", "vlanAPI", "vlanAMRRules", "vlanName", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemLastChange=vlanSystemLastChange, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanSystemAdminReset=vlanSystemAdminReset, vlanCountAPIAdmin=vlanCountAPIAdmin, SfpsAddress=SfpsAddress, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanPortVlanName=vlanPortVlanName, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortEntry=vlanPortEntry, vlanPortPortPolicy=vlanPortPortPolicy, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameMappedPorts=vlanNameMappedPorts, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanNameTable=vlanNameTable, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemVersion=vlanSystemVersion, vlanPortTable=vlanPortTable, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortVlanId=vlanPortVlanId, vlanNameOperStatus=vlanNameOperStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameVlanId=vlanNameVlanId, vlanSystemTable=vlanSystemTable, HexInteger=HexInteger, vlanAMRRulesEntry=vlanAMRRulesEntry, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, SfpsSwitchPort=SfpsSwitchPort, vlanNameEntry=vlanNameEntry, vlanCountAPITotal=vlanCountAPITotal, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanSystemMibRev=vlanSystemMibRev, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPINvramId=sfpsVAPINvramId, vlanNameVlanName=vlanNameVlanName, vlanSystemPollCount=vlanSystemPollCount, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemDomainName=vlanSystemDomainName, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanPortPortStatus=vlanPortPortStatus, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanNameIndex=vlanNameIndex, vlanSystemAgentIP=vlanSystemAgentIP, vlanNameNHash=vlanNameNHash, vlanNameNumUsers=vlanNameNumUsers, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanPortRouterPort=vlanPortRouterPort, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemEntry=vlanSystemEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanPortPortNum=vlanPortPortNum, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortRelayAgent=vlanPortRelayAgent, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, VlanSwitchInstance=VlanSwitchInstance, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanNameRelayAgent=vlanNameRelayAgent, vlanNameVlanRule=vlanNameVlanRule, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemOperTime=vlanSystemOperTime, vlanNameStatusTime=vlanNameStatusTime)
