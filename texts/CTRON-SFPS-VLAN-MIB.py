...
vlanAMRSubnets, vlanPort, vlanAMRRules, vlanCountAPI, vlanAPI, vlanSystem, vlanName, vlanAMRStats, vlanTestAPI = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanPort", "vlanAMRRules", "vlanCountAPI", "vlanAPI", "vlanSystem", "vlanName", "vlanAMRStats", "vlanTestAPI")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanPortVlanId=vlanPortVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputMap=vlanTestAPIOutputMap, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortRouterPort=vlanPortRouterPort, SfpsAddress=SfpsAddress, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanPortUniPolicy=vlanPortUniPolicy, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIVlanId=vlanTestAPIVlanId, vlanPortPortStatus=vlanPortPortStatus, vlanPortPortNum=vlanPortPortNum, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortEntry=vlanPortEntry, vlanSystemDomainName=vlanSystemDomainName, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanPortRelayAgent=vlanPortRelayAgent, vlanNameNHash=vlanNameNHash, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemEntry=vlanSystemEntry, vlanSystemTable=vlanSystemTable, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanPortVlanName=vlanPortVlanName, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameEntry=vlanNameEntry, vlanNameStatusTime=vlanNameStatusTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanPortPortPolicy=vlanPortPortPolicy, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanCountAPITotal=vlanCountAPITotal, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanNameAdminStatus=vlanNameAdminStatus, vlanAMRRulesRule=vlanAMRRulesRule, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanPortTable=vlanPortTable, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanSystemLastPollTime=vlanSystemLastPollTime, VlanSwitchInstance=VlanSwitchInstance, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanTestAPIOutputPort=vlanTestAPIOutputPort, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanNameVlanName=vlanNameVlanName, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemPollCount=vlanSystemPollCount, vlanAMRRulesTable=vlanAMRRulesTable, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanTestAPIPort=vlanTestAPIPort, vlanNameVlanRule=vlanNameVlanRule, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanNameFloodPorts=vlanNameFloodPorts, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanNameIndex=vlanNameIndex, sfpsVAPIInPort=sfpsVAPIInPort, vlanNameNumUsers=vlanNameNumUsers, HexInteger=HexInteger, SfpsSwitchPort=SfpsSwitchPort, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameOperStatus=vlanNameOperStatus, vlanNameMappedPorts=vlanNameMappedPorts, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanNameTable=vlanNameTable, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemAdminReset=vlanSystemAdminReset, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanSystemAgentIP=vlanSystemAgentIP, vlanSystemVersion=vlanSystemVersion, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanAMRRulesStatus=vlanAMRRulesStatus)
