...
vlanAPI, vlanSystem, vlanTestAPI, vlanName, vlanCountAPI, vlanAMRSubnets, vlanAMRStats, vlanAMRRules, vlanPort = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAPI", "vlanSystem", "vlanTestAPI", "vlanName", "vlanCountAPI", "vlanAMRSubnets", "vlanAMRStats", "vlanAMRRules", "vlanPort")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameEntry=vlanNameEntry, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemLastChange=vlanSystemLastChange, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortAdminStatus=vlanPortAdminStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanTestAPIVerb=vlanTestAPIVerb, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemTable=vlanSystemTable, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputTap=vlanTestAPIOutputTap, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemMibRev=vlanSystemMibRev, vlanNameNHash=vlanNameNHash, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameVlanRule=vlanNameVlanRule, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanPortPortNum=vlanPortPortNum, vlanNameVlanId=vlanNameVlanId, vlanSystemDomainName=vlanSystemDomainName, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemVersion=vlanSystemVersion, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortRouterPort=vlanPortRouterPort, vlanSystemAgentIP=vlanSystemAgentIP, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanCountAPITotal=vlanCountAPITotal, vlanCountAPIAutoreg=vlanCountAPIAutoreg, SfpsAddress=SfpsAddress, VlanSwitchInstance=VlanSwitchInstance, vlanTestAPIPort=vlanTestAPIPort, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanPortPortStatus=vlanPortPortStatus, vlanSystemOperTime=vlanSystemOperTime, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortPortPolicy=vlanPortPortPolicy, vlanNameVlanName=vlanNameVlanName, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanCountAPIAdmin=vlanCountAPIAdmin, HexInteger=HexInteger, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanNameIndex=vlanNameIndex, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameFloodPorts=vlanNameFloodPorts, vlanPortFloodPolicy=vlanPortFloodPolicy, SfpsSwitchPort=SfpsSwitchPort, vlanNameMappedPorts=vlanNameMappedPorts, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameTable=vlanNameTable, vlanSystemEntry=vlanSystemEntry, vlanPortEntry=vlanPortEntry, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanNameNumUsers=vlanNameNumUsers, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanSystemOperStatus=vlanSystemOperStatus, vlanPortTable=vlanPortTable, vlanTestAPIOutputTable=vlanTestAPIOutputTable, sfpsVAPIVerb=sfpsVAPIVerb, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanNameAdminStatus=vlanNameAdminStatus, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemPollCount=vlanSystemPollCount, vlanNameOperStatus=vlanNameOperStatus, vlanPortVlanName=vlanPortVlanName, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, sfpsVAPIInPort=sfpsVAPIInPort, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRRulesTable=vlanAMRRulesTable, vlanNameStatusTime=vlanNameStatusTime, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanPortRelayAgent=vlanPortRelayAgent)
