...
vlanAMRRules, vlanAPI, vlanCountAPI, vlanAMRSubnets, vlanPort, vlanTestAPI, vlanName, vlanAMRStats, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanAPI", "vlanCountAPI", "vlanAMRSubnets", "vlanPort", "vlanTestAPI", "vlanName", "vlanAMRStats", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, vlanNameOperStatus=vlanNameOperStatus, VlanSwitchInstance=VlanSwitchInstance, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanNameFloodPorts=vlanNameFloodPorts, vlanNameVlanName=vlanNameVlanName, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemOperStatus=vlanSystemOperStatus, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortPortPolicy=vlanPortPortPolicy, vlanPortPortStatus=vlanPortPortStatus, vlanNameVlanRule=vlanNameVlanRule, vlanPortTable=vlanPortTable, vlanNameIndex=vlanNameIndex, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameUniPolicy=vlanNameUniPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortEntry=vlanPortEntry, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortUniPolicy=vlanPortUniPolicy, vlanTestAPIVerb=vlanTestAPIVerb, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanSystemLastChange=vlanSystemLastChange, vlanPortFloodPolicy=vlanPortFloodPolicy, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanSystemOperTime=vlanSystemOperTime, vlanSystemAdminReset=vlanSystemAdminReset, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanSystemVersion=vlanSystemVersion, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemDomainName=vlanSystemDomainName, vlanPortPortNum=vlanPortPortNum, vlanNameFloodPolicy=vlanNameFloodPolicy, HexInteger=HexInteger, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanSystemEntry=vlanSystemEntry, vlanNameRelayAgent=vlanNameRelayAgent, vlanSystemAdminStatus=vlanSystemAdminStatus, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanCountAPITotal=vlanCountAPITotal, vlanNameNHash=vlanNameNHash, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanSystemTable=vlanSystemTable, vlanNameVlanId=vlanNameVlanId, vlanPortRouterPort=vlanPortRouterPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanSystemLastPollTime=vlanSystemLastPollTime, SfpsAddress=SfpsAddress, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanNameEntry=vlanNameEntry, vlanNameNumUsers=vlanNameNumUsers, SfpsSwitchPort=SfpsSwitchPort, vlanNameStatusTime=vlanNameStatusTime, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameTable=vlanNameTable, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortVlanName=vlanPortVlanName, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, vlanPortVlanId=vlanPortVlanId, sfpsVAPINvramId=sfpsVAPINvramId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanNameAdminStatus=vlanNameAdminStatus, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy)
