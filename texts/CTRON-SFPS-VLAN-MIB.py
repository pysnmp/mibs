...
vlanAMRRules, vlanAMRStats, vlanAPI, vlanName, vlanSystem, vlanCountAPI, vlanTestAPI, vlanPort, vlanAMRSubnets = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRRules", "vlanAMRStats", "vlanAPI", "vlanName", "vlanSystem", "vlanCountAPI", "vlanTestAPI", "vlanPort", "vlanAMRSubnets")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameEntry=vlanNameEntry, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanSystemLastPollTime=vlanSystemLastPollTime, sfpsVAPIInPort=sfpsVAPIInPort, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanNameVlanName=vlanNameVlanName, vlanTestAPIVerb=vlanTestAPIVerb, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameStatusTime=vlanNameStatusTime, vlanAMRRulesRule=vlanAMRRulesRule, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanSystemEntry=vlanSystemEntry, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanNameEnabledPorts=vlanNameEnabledPorts, sfpsVAPIVerb=sfpsVAPIVerb, sfpsVAPIUserAlias=sfpsVAPIUserAlias, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanPortUniPolicy=vlanPortUniPolicy, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanCountAPIAdmin=vlanCountAPIAdmin, vlanPortRelayAgent=vlanPortRelayAgent, vlanSystemPriorPollTime=vlanSystemPriorPollTime, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanNameNumUsers=vlanNameNumUsers, vlanNameOperStatus=vlanNameOperStatus, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanPortPortStatus=vlanPortPortStatus, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanAMRRulesTable=vlanAMRRulesTable, vlanPortPortNum=vlanPortPortNum, vlanTestAPIVlanName=vlanTestAPIVlanName, sfpsVAPIOutPort=sfpsVAPIOutPort, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemVersion=vlanSystemVersion, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemOperStatus=vlanSystemOperStatus, vlanNameVlanRule=vlanNameVlanRule, vlanCountAPITotal=vlanCountAPITotal, vlanNameUniPolicy=vlanNameUniPolicy, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, vlanSystemFirstPollTime=vlanSystemFirstPollTime, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanNameVlanId=vlanNameVlanId, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, vlanPortTable=vlanPortTable, vlanTestAPIOutputTable=vlanTestAPIOutputTable, vlanNameMappedPorts=vlanNameMappedPorts, SfpsSwitchPort=SfpsSwitchPort, vlanNameIndex=vlanNameIndex, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, HexInteger=HexInteger, vlanSystemTable=vlanSystemTable, vlanPortEntry=vlanPortEntry, vlanSystemPollCount=vlanSystemPollCount, SfpsAddress=SfpsAddress, VlanSwitchInstance=VlanSwitchInstance, vlanNameNHash=vlanNameNHash, vlanSystemLastChange=vlanSystemLastChange, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputAble=vlanTestAPIOutputAble, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanSystemMibRev=vlanSystemMibRev, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanPortVlanId=vlanPortVlanId, sfpsVAPINvramId=sfpsVAPINvramId, vlanPortAdminStatus=vlanPortAdminStatus, vlanSystemOperTime=vlanSystemOperTime, vlanSystemAdminReset=vlanSystemAdminReset, vlanNameFloodPolicy=vlanNameFloodPolicy, sfpsVAPIRouterPort=sfpsVAPIRouterPort, vlanTestAPIPort=vlanTestAPIPort, vlanSystemDomainName=vlanSystemDomainName, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameTable=vlanNameTable, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanPortVlanName=vlanPortVlanName, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule)
