...
vlanAMRSubnets, vlanTestAPI, vlanCountAPI, vlanAPI, vlanAMRRules, vlanAMRStats, vlanName, vlanPort, vlanSystem = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "vlanAMRSubnets", "vlanTestAPI", "vlanCountAPI", "vlanAPI", "vlanAMRRules", "vlanAMRStats", "vlanName", "vlanPort", "vlanSystem")
...
mibBuilder.exportSymbols("CTRON-SFPS-VLAN-MIB", vlanNameNHash=vlanNameNHash, vlanPortPortStatus=vlanPortPortStatus, VlanSwitchInstance=VlanSwitchInstance, vlanSystemMibRev=vlanSystemMibRev, sfpsVAPIInPort=sfpsVAPIInPort, vlanPortUniPolicy=vlanPortUniPolicy, vlanNameUniPolicy=vlanNameUniPolicy, vlanSystemFirstPollTime=vlanSystemFirstPollTime, vlanSystemEntry=vlanSystemEntry, vlanTestAPIOutputMap=vlanTestAPIOutputMap, vlanSystemDomainName=vlanSystemDomainName, vlanNameEnabledPorts=vlanNameEnabledPorts, vlanPortEntry=vlanPortEntry, vlanTestAPIOutputStatus=vlanTestAPIOutputStatus, vlanPortVlanId=vlanPortVlanId, vlanTestAPIOutputPort=vlanTestAPIOutputPort, sfpsVAPIUnicastPolicy=sfpsVAPIUnicastPolicy, sfpsVAPIPortPolicy=sfpsVAPIPortPolicy, vlanPortVlanName=vlanPortVlanName, sfpsVAPIAutoRegValue=sfpsVAPIAutoRegValue, vlanTestAPIOutputVlanId=vlanTestAPIOutputVlanId, vlanCountAPIAdmin=vlanCountAPIAdmin, sfpsVAPILayer3Learning=sfpsVAPILayer3Learning, vlanTestAPIVlanId=vlanTestAPIVlanId, sfpsVAPIVlanId=sfpsVAPIVlanId, vlanPortFloodPolicy=vlanPortFloodPolicy, vlanNameFloodPolicy=vlanNameFloodPolicy, vlanTestAPIPort=vlanTestAPIPort, sfpsVAPIAutoRegisterRule=sfpsVAPIAutoRegisterRule, vlanPortPortNum=vlanPortPortNum, vlanAMRStatsNumRulesEnabled=vlanAMRStatsNumRulesEnabled, SfpsAddress=SfpsAddress, vlanNameOperStatus=vlanNameOperStatus, vlanTestAPIOutputUserCnt=vlanTestAPIOutputUserCnt, vlanSystemOperTime=vlanSystemOperTime, sfpsVAPIOutPort=sfpsVAPIOutPort, sfpsVAPIFloodPolicy=sfpsVAPIFloodPolicy, vlanTestAPIOutputEntry=vlanTestAPIOutputEntry, vlanAMRRulesStatus=vlanAMRRulesStatus, vlanNameAdminStatus=vlanNameAdminStatus, vlanNameFloodPorts=vlanNameFloodPorts, vlanTestAPIOutputTap=vlanTestAPIOutputTap, vlanSystemDeltaPollTime=vlanSystemDeltaPollTime, vlanTestAPIVlanName=vlanTestAPIVlanName, vlanSystemAdminStatus=vlanSystemAdminStatus, vlanSystemPriorPollTime=vlanSystemPriorPollTime, vlanSystemAdminReset=vlanSystemAdminReset, sfpsVAPINvramId=sfpsVAPINvramId, sfpsVAPIUserAlias=sfpsVAPIUserAlias, vlanNameRelayAgent=vlanNameRelayAgent, vlanPortRelayAgent=vlanPortRelayAgent, sfpsVAPIUserAliasTag=sfpsVAPIUserAliasTag, vlanTestAPIOutputIndex=vlanTestAPIOutputIndex, vlanAMRRulesTable=vlanAMRRulesTable, vlanAMRStatsSingleMask=vlanAMRStatsSingleMask, HexInteger=HexInteger, vlanAMRRulesEntry=vlanAMRRulesEntry, vlanSystemTable=vlanSystemTable, sfpsVAPIAutoRegMask=sfpsVAPIAutoRegMask, vlanTestAPIVerb=vlanTestAPIVerb, vlanCountAPIAutoreg=vlanCountAPIAutoreg, vlanAMRSubnetsPrefix=vlanAMRSubnetsPrefix, sfpsVAPIRouterPort=sfpsVAPIRouterPort, sfpsVAPIVerb=sfpsVAPIVerb, vlanSystemSwitchInstance=vlanSystemSwitchInstance, vlanSystemLastPollTime=vlanSystemLastPollTime, vlanNameVlanRule=vlanNameVlanRule, vlanNameStatusTime=vlanNameStatusTime, vlanSystemPollCount=vlanSystemPollCount, vlanTestAPIOutputVlanName=vlanTestAPIOutputVlanName, vlanNameVlanName=vlanNameVlanName, vlanTestAPIOutputPolicy=vlanTestAPIOutputPolicy, vlanSystemOperStatus=vlanSystemOperStatus, SfpsSwitchPort=SfpsSwitchPort, vlanNameMappedPorts=vlanNameMappedPorts, vlanNameTable=vlanNameTable, vlanNameIndex=vlanNameIndex, vlanSystemVersion=vlanSystemVersion, vlanNameNumUsers=vlanNameNumUsers, vlanPortLayer3Learning=vlanPortLayer3Learning, vlanNameEntry=vlanNameEntry, vlanAMRSubnetsMask=vlanAMRSubnetsMask, vlanAMRRulesRule=vlanAMRRulesRule, vlanPortPortPolicy=vlanPortPortPolicy, vlanSystemLastChange=vlanSystemLastChange, vlanSystemAgentIP=vlanSystemAgentIP, sfpsVAPIUserMAC=sfpsVAPIUserMAC, vlanCountAPITotal=vlanCountAPITotal, sfpsVAPIRelayAgent=sfpsVAPIRelayAgent, vlanNameVlanId=vlanNameVlanId, sfpsVAPIVlanName=sfpsVAPIVlanName, vlanPortAdminStatus=vlanPortAdminStatus, sfpsVAPIAdminStatus=sfpsVAPIAdminStatus, vlanPortTable=vlanPortTable, vlanTestAPIOutputAble=vlanTestAPIOutputAble, vlanPortRouterPort=vlanPortRouterPort, vlanTestAPIOutputTable=vlanTestAPIOutputTable)
