...
mibBuilder.exportSymbols("SNMPv2-MIB", snmpInSetRequests=snmpInSetRequests, PYSNMP_MODULE_ID=snmpMIB, snmpSetGroup=snmpSetGroup, snmpInNoSuchNames=snmpInNoSuchNames, snmpTrapOID=snmpTrapOID, authenticationFailure=authenticationFailure, snmpCommunityGroup=snmpCommunityGroup, snmpInGenErrs=snmpInGenErrs, snmpOutTooBigs=snmpOutTooBigs, snmpOutNoSuchNames=snmpOutNoSuchNames, snmpOutGetResponses=snmpOutGetResponses, snmpInASNParseErrs=snmpInASNParseErrs, snmpGroup=snmpGroup, sysORID=sysORID, sysORUpTime=sysORUpTime, snmpMIBConformance=snmpMIBConformance, snmpMIBObjects=snmpMIBObjects, snmpMIBCompliances=snmpMIBCompliances, snmpInReadOnlys=snmpInReadOnlys, snmpOutBadValues=snmpOutBadValues, sysContact=sysContact, snmpInTooBigs=snmpInTooBigs, snmpOutTraps=snmpOutTraps, sysName=sysName, snmpNotificationGroup=snmpNotificationGroup, sysORTable=sysORTable, snmpTrapEnterprise=snmpTrapEnterprise, snmpBasicNotificationsGroup=snmpBasicNotificationsGroup, snmpInGetRequests=snmpInGetRequests, snmpInPkts=snmpInPkts, snmpInBadValues=snmpInBadValues, sysLocation=sysLocation, sysUpTime=sysUpTime, sysObjectID=sysObjectID, snmpInBadCommunityNames=snmpInBadCommunityNames, snmpWarmStartNotificationGroup=snmpWarmStartNotificationGroup, snmpInTraps=snmpInTraps, snmpOutGenErrs=snmpOutGenErrs, snmpOutGetRequests=snmpOutGetRequests, snmpTraps=snmpTraps, snmpBasicComplianceRev2=snmpBasicComplianceRev2, snmpEnableAuthenTraps=snmpEnableAuthenTraps, snmpOutGetNexts=snmpOutGetNexts, snmpObsoleteGroup=snmpObsoleteGroup, snmp=snmp, snmpProxyDrops=snmpProxyDrops, sysORIndex=sysORIndex, warmStart=warmStart, snmpBasicCompliance=snmpBasicCompliance, sysDescr=sysDescr, coldStart=coldStart, snmpSilentDrops=snmpSilentDrops, sysOREntry=sysOREntry, sysORLastChange=sysORLastChange, snmpTrap=snmpTrap, snmpSetSerialNo=snmpSetSerialNo, snmpMIBGroups=snmpMIBGroups, snmpInTotalSetVars=snmpInTotalSetVars, snmpInGetNexts=snmpInGetNexts, sysServices=sysServices, snmpInBadCommunityUses=snmpInBadCommunityUses, snmpOutSetRequests=snmpOutSetRequests, system=system, systemGroup=systemGroup, snmpInGetResponses=snmpInGetResponses, snmpInTotalReqVars=snmpInTotalReqVars, snmpOutPkts=snmpOutPkts, snmpMIB=snmpMIB, snmpSet=snmpSet, snmpInBadVersions=snmpInBadVersions, sysORDescr=sysORDescr)
