...
Bits, mib_2, ObjectIdentity, NotificationType, Integer32, MibIdentifier, snmpModules, TimeTicks, IpAddress, iso, Unsigned32, Counter64, Gauge32, enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "mib-2", "ObjectIdentity", "NotificationType", "Integer32", "MibIdentifier", "snmpModules", "TimeTicks", "IpAddress", "iso", "Unsigned32", "Counter64", "Gauge32", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portEntry=portEntry, groupid=groupid, xg6846=xg6846, staticDns=staticDns, lanportpause=lanportpause, lan3=lan3, adminStatus=adminStatus, lanportspeed=lanportspeed, rebootEnable=rebootEnable, portStatistic=portStatistic, lanportName=lanportName, rxPower=rxPower, staticIpSecondaryDns=staticIpSecondaryDns, primaryDns=primaryDns, voltage=voltage, txPower=txPower, vendorOui=vendorOui, jumbwan=jumbwan, statIndex=statIndex, unicastsTransmitted=unicastsTransmitted, priority=priority, pauseReceived=pauseReceived, fileName=fileName, serialnum=serialnum, internetPort=internetPort, staticIpHostName=staticIpHostName, vendorRev=vendorRev, jumblan2=jumblan2, jumblan1=jumblan1, dscpEnable=dscpEnable, unicastsReceived=unicastsReceived, qmode=qmode, fcsErrorReceived=fcsErrorReceived, domainame=domainame, portmode=portmode, portPower=portPower, jumblan4=jumblan4, port3=port3, secondaryDns=secondaryDns, broadcastsTransmitted=broadcastsTransmitted, lan1=lan1, lanportIndex=lanportIndex, portName=portName, pauseTransmitted=pauseTransmitted, ddminfo=ddminfo, lan4=lan4, qos=qos, vlan=vlan, vlangroupTable=vlangroupTable, portIndex=portIndex, operStatus=operStatus, multicastsReceived=multicastsReceived, staticIpSubMask=staticIpSubMask, qmapping=qmapping, groupEntry=groupEntry, qosTable=qosTable, temperature=temperature, tftpSevIp=tftpSevIp, wan=wan, multicastsTransmitted=multicastsTransmitted, port2=port2, statisticTable=statisticTable, hostname=hostname, vlanid=vlanid, jumblan3=jumblan3, deviceinfo=deviceinfo, action=action, portTable=portTable, staticIpAddr=staticIpAddr, modeEntry=modeEntry, port1=port1, tftp=tftp, staticIpPrimaryDns=staticIpPrimaryDns, qosIndex=qosIndex, wanType=wanType, vendorName=vendorName, lanportTable=lanportTable, reboot=reboot, jumb=jumb, catv=catv, fcsErrorTransmitted=fcsErrorTransmitted, bias=bias, portStatEntry=portStatEntry, qosEntry=qosEntry, lan2=lan2, staticIpDomainName=staticIpDomainName, fileType=fileType, broadcastsReceived=broadcastsReceived, groupIndex=groupIndex, port4=port4, catvEnable=catvEnable, staticIpGateway=staticIpGateway, speed=speed, vendorPn=vendorPn)
