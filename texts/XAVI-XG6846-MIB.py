...
enterprises, mib_2, iso, snmpModules, Counter32, Unsigned32, Integer32, Bits, Gauge32, NotificationType, TimeTicks, ModuleIdentity, ObjectIdentity, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "mib-2", "iso", "snmpModules", "Counter32", "Unsigned32", "Integer32", "Bits", "Gauge32", "NotificationType", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpDomainName=staticIpDomainName, staticIpAddr=staticIpAddr, rebootEnable=rebootEnable, lan3=lan3, vendorPn=vendorPn, fcsErrorTransmitted=fcsErrorTransmitted, groupEntry=groupEntry, voltage=voltage, action=action, portmode=portmode, port1=port1, multicastsReceived=multicastsReceived, xg6846=xg6846, multicastsTransmitted=multicastsTransmitted, operStatus=operStatus, groupIndex=groupIndex, temperature=temperature, portStatistic=portStatistic, jumbwan=jumbwan, staticIpGateway=staticIpGateway, jumblan3=jumblan3, domainame=domainame, jumblan4=jumblan4, wanType=wanType, jumblan2=jumblan2, pauseReceived=pauseReceived, portIndex=portIndex, internetPort=internetPort, lanportpause=lanportpause, ddminfo=ddminfo, modeEntry=modeEntry, jumblan1=jumblan1, vlanid=vlanid, vendorOui=vendorOui, staticIpSecondaryDns=staticIpSecondaryDns, staticIpSubMask=staticIpSubMask, port4=port4, lanportIndex=lanportIndex, staticIpHostName=staticIpHostName, lanportName=lanportName, portEntry=portEntry, reboot=reboot, staticIpPrimaryDns=staticIpPrimaryDns, lan4=lan4, vlangroupTable=vlangroupTable, vendorName=vendorName, jumb=jumb, qmapping=qmapping, rxPower=rxPower, txPower=txPower, vlan=vlan, dscpEnable=dscpEnable, lan2=lan2, lanportTable=lanportTable, fileType=fileType, serialnum=serialnum, statisticTable=statisticTable, portPower=portPower, portStatEntry=portStatEntry, secondaryDns=secondaryDns, fileName=fileName, primaryDns=primaryDns, tftp=tftp, broadcastsReceived=broadcastsReceived, priority=priority, lan1=lan1, statIndex=statIndex, portTable=portTable, qos=qos, speed=speed, pauseTransmitted=pauseTransmitted, catv=catv, wan=wan, broadcastsTransmitted=broadcastsTransmitted, qosIndex=qosIndex, tftpSevIp=tftpSevIp, unicastsReceived=unicastsReceived, adminStatus=adminStatus, vendorRev=vendorRev, bias=bias, catvEnable=catvEnable, staticDns=staticDns, unicastsTransmitted=unicastsTransmitted, qosTable=qosTable, port2=port2, fcsErrorReceived=fcsErrorReceived, portName=portName, port3=port3, groupid=groupid, lanportspeed=lanportspeed, hostname=hostname, qmode=qmode, qosEntry=qosEntry, deviceinfo=deviceinfo)
