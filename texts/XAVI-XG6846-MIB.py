...
# Produced by pysmi-1.1.8 at Mon Jan  9 14:16:30 2023
...
ObjectIdentity, iso, TimeTicks, Gauge32, enterprises, Counter64, Unsigned32, MibIdentifier, IpAddress, Integer32, snmpModules, mib_2, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "TimeTicks", "Gauge32", "enterprises", "Counter64", "Unsigned32", "MibIdentifier", "IpAddress", "Integer32", "snmpModules", "mib-2", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorName=vendorName, multicastsTransmitted=multicastsTransmitted, tftpSevIp=tftpSevIp, portStatistic=portStatistic, qosTable=qosTable, adminStatus=adminStatus, lanportTable=lanportTable, voltage=voltage, staticIpDomainName=staticIpDomainName, lanportspeed=lanportspeed, portName=portName, action=action, vlan=vlan, jumblan1=jumblan1, unicastsReceived=unicastsReceived, jumblan4=jumblan4, portEntry=portEntry, groupIndex=groupIndex, pauseTransmitted=pauseTransmitted, hostname=hostname, ddminfo=ddminfo, jumblan3=jumblan3, qosIndex=qosIndex, statIndex=statIndex, bias=bias, rxPower=rxPower, staticIpPrimaryDns=staticIpPrimaryDns, internetPort=internetPort, qos=qos, domainame=domainame, staticIpSubMask=staticIpSubMask, groupid=groupid, xg6846=xg6846, modeEntry=modeEntry, priority=priority, secondaryDns=secondaryDns, deviceinfo=deviceinfo, vlangroupTable=vlangroupTable, port2=port2, portStatEntry=portStatEntry, vlanid=vlanid, wanType=wanType, fileType=fileType, portIndex=portIndex, primaryDns=primaryDns, fcsErrorTransmitted=fcsErrorTransmitted, lanportIndex=lanportIndex, staticDns=staticDns, portmode=portmode, portTable=portTable, statisticTable=statisticTable, unicastsTransmitted=unicastsTransmitted, vendorPn=vendorPn, staticIpSecondaryDns=staticIpSecondaryDns, rebootEnable=rebootEnable, broadcastsReceived=broadcastsReceived, port1=port1, vendorOui=vendorOui, catvEnable=catvEnable, staticIpHostName=staticIpHostName, port4=port4, vendorRev=vendorRev, reboot=reboot, portPower=portPower, catv=catv, qmapping=qmapping, staticIpAddr=staticIpAddr, broadcastsTransmitted=broadcastsTransmitted, qmode=qmode, fcsErrorReceived=fcsErrorReceived, jumb=jumb, lanportName=lanportName, dscpEnable=dscpEnable, groupEntry=groupEntry, lan1=lan1, fileName=fileName, jumblan2=jumblan2, lanportpause=lanportpause, multicastsReceived=multicastsReceived, wan=wan, tftp=tftp, jumbwan=jumbwan, speed=speed, pauseReceived=pauseReceived, port3=port3, lan4=lan4, lan2=lan2, serialnum=serialnum, temperature=temperature, qosEntry=qosEntry, staticIpGateway=staticIpGateway, operStatus=operStatus, lan3=lan3, txPower=txPower)
