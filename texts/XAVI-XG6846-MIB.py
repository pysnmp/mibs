...
# Produced by pysmi-1.1.12 at Tue Jun  4 09:32:29 2024
...
Counter64, snmpModules, mib_2, Counter32, MibIdentifier, IpAddress, Gauge32, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso, Integer32, Bits, Unsigned32, TimeTicks, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "snmpModules", "mib-2", "Counter32", "MibIdentifier", "IpAddress", "Gauge32", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso", "Integer32", "Bits", "Unsigned32", "TimeTicks", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port3=port3, jumblan3=jumblan3, wanType=wanType, vendorName=vendorName, catv=catv, vlangroupTable=vlangroupTable, fcsErrorTransmitted=fcsErrorTransmitted, groupIndex=groupIndex, secondaryDns=secondaryDns, broadcastsTransmitted=broadcastsTransmitted, port4=port4, operStatus=operStatus, staticIpPrimaryDns=staticIpPrimaryDns, portTable=portTable, staticIpGateway=staticIpGateway, lanportpause=lanportpause, statisticTable=statisticTable, qosEntry=qosEntry, catvEnable=catvEnable, qosIndex=qosIndex, vendorRev=vendorRev, bias=bias, port1=port1, qmapping=qmapping, portStatistic=portStatistic, wan=wan, portStatEntry=portStatEntry, statIndex=statIndex, rebootEnable=rebootEnable, pauseReceived=pauseReceived, action=action, tftpSevIp=tftpSevIp, internetPort=internetPort, jumblan1=jumblan1, staticIpHostName=staticIpHostName, portPower=portPower, portmode=portmode, speed=speed, staticIpSecondaryDns=staticIpSecondaryDns, tftp=tftp, adminStatus=adminStatus, fileName=fileName, txPower=txPower, primaryDns=primaryDns, staticIpSubMask=staticIpSubMask, voltage=voltage, jumblan4=jumblan4, vlan=vlan, dscpEnable=dscpEnable, qosTable=qosTable, portIndex=portIndex, staticIpAddr=staticIpAddr, serialnum=serialnum, port2=port2, multicastsTransmitted=multicastsTransmitted, staticDns=staticDns, priority=priority, unicastsReceived=unicastsReceived, unicastsTransmitted=unicastsTransmitted, vendorOui=vendorOui, lan1=lan1, multicastsReceived=multicastsReceived, domainame=domainame, rxPower=rxPower, lan3=lan3, qmode=qmode, lan4=lan4, lan2=lan2, qos=qos, fcsErrorReceived=fcsErrorReceived, reboot=reboot, groupEntry=groupEntry, jumb=jumb, temperature=temperature, portName=portName, lanportName=lanportName, vendorPn=vendorPn, groupid=groupid, broadcastsReceived=broadcastsReceived, lanportIndex=lanportIndex, staticIpDomainName=staticIpDomainName, lanportTable=lanportTable, hostname=hostname, xg6846=xg6846, lanportspeed=lanportspeed, portEntry=portEntry, fileType=fileType, vlanid=vlanid, jumblan2=jumblan2, modeEntry=modeEntry, deviceinfo=deviceinfo, jumbwan=jumbwan, pauseTransmitted=pauseTransmitted, ddminfo=ddminfo)
