...
# Produced by pysmi-1.1.3 at Sun Nov 28 17:10:29 2021
...
TimeTicks, NotificationType, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Bits, Integer32, ModuleIdentity, Counter64, Gauge32, ObjectIdentity, MibIdentifier, mib_2, Counter32, Unsigned32, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Bits", "Integer32", "ModuleIdentity", "Counter64", "Gauge32", "ObjectIdentity", "MibIdentifier", "mib-2", "Counter32", "Unsigned32", "IpAddress", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", internetPort=internetPort, deviceinfo=deviceinfo, lan3=lan3, vendorPn=vendorPn, lan2=lan2, lanportTable=lanportTable, portEntry=portEntry, lanportspeed=lanportspeed, jumb=jumb, qos=qos, vendorOui=vendorOui, bias=bias, groupEntry=groupEntry, statIndex=statIndex, vlan=vlan, jumblan4=jumblan4, fcsErrorTransmitted=fcsErrorTransmitted, speed=speed, action=action, pauseReceived=pauseReceived, serialnum=serialnum, broadcastsTransmitted=broadcastsTransmitted, staticIpSubMask=staticIpSubMask, groupid=groupid, lanportName=lanportName, staticIpGateway=staticIpGateway, jumblan1=jumblan1, port1=port1, reboot=reboot, statisticTable=statisticTable, unicastsTransmitted=unicastsTransmitted, portmode=portmode, lanportIndex=lanportIndex, primaryDns=primaryDns, portName=portName, domainame=domainame, vlangroupTable=vlangroupTable, tftp=tftp, staticIpPrimaryDns=staticIpPrimaryDns, modeEntry=modeEntry, unicastsReceived=unicastsReceived, lan1=lan1, operStatus=operStatus, port2=port2, portTable=portTable, portIndex=portIndex, fcsErrorReceived=fcsErrorReceived, temperature=temperature, portStatEntry=portStatEntry, portStatistic=portStatistic, adminStatus=adminStatus, jumblan3=jumblan3, staticIpHostName=staticIpHostName, ddminfo=ddminfo, qmode=qmode, lan4=lan4, qosTable=qosTable, port4=port4, catv=catv, secondaryDns=secondaryDns, qosIndex=qosIndex, priority=priority, wan=wan, qmapping=qmapping, port3=port3, hostname=hostname, xg6846=xg6846, wanType=wanType, staticDns=staticDns, staticIpAddr=staticIpAddr, rxPower=rxPower, jumbwan=jumbwan, multicastsTransmitted=multicastsTransmitted, voltage=voltage, vendorRev=vendorRev, fileType=fileType, broadcastsReceived=broadcastsReceived, portPower=portPower, tftpSevIp=tftpSevIp, qosEntry=qosEntry, jumblan2=jumblan2, pauseTransmitted=pauseTransmitted, fileName=fileName, staticIpDomainName=staticIpDomainName, lanportpause=lanportpause, staticIpSecondaryDns=staticIpSecondaryDns, rebootEnable=rebootEnable, txPower=txPower, groupIndex=groupIndex, multicastsReceived=multicastsReceived, vlanid=vlanid, dscpEnable=dscpEnable, catvEnable=catvEnable, vendorName=vendorName)
