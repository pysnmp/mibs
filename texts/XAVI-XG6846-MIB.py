...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:09:02 2023
...
Integer32, enterprises, mib_2, NotificationType, iso, Unsigned32, Gauge32, snmpModules, TimeTicks, MibIdentifier, ModuleIdentity, Counter64, Counter32, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "mib-2", "NotificationType", "iso", "Unsigned32", "Gauge32", "snmpModules", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Counter64", "Counter32", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumblan3=jumblan3, catvEnable=catvEnable, lanportIndex=lanportIndex, internetPort=internetPort, staticIpDomainName=staticIpDomainName, txPower=txPower, adminStatus=adminStatus, broadcastsReceived=broadcastsReceived, serialnum=serialnum, wanType=wanType, unicastsReceived=unicastsReceived, fileType=fileType, primaryDns=primaryDns, tftp=tftp, bias=bias, jumblan4=jumblan4, qosEntry=qosEntry, jumblan2=jumblan2, operStatus=operStatus, portmode=portmode, priority=priority, voltage=voltage, jumb=jumb, vendorName=vendorName, deviceinfo=deviceinfo, port4=port4, lanportTable=lanportTable, rxPower=rxPower, secondaryDns=secondaryDns, portIndex=portIndex, xg6846=xg6846, staticIpSecondaryDns=staticIpSecondaryDns, temperature=temperature, portStatistic=portStatistic, port1=port1, lan4=lan4, vendorPn=vendorPn, fcsErrorTransmitted=fcsErrorTransmitted, pauseReceived=pauseReceived, statisticTable=statisticTable, lan1=lan1, unicastsTransmitted=unicastsTransmitted, multicastsTransmitted=multicastsTransmitted, lanportspeed=lanportspeed, vendorOui=vendorOui, portStatEntry=portStatEntry, groupEntry=groupEntry, ddminfo=ddminfo, staticIpAddr=staticIpAddr, pauseTransmitted=pauseTransmitted, tftpSevIp=tftpSevIp, lan2=lan2, broadcastsTransmitted=broadcastsTransmitted, multicastsReceived=multicastsReceived, action=action, speed=speed, lanportpause=lanportpause, groupIndex=groupIndex, wan=wan, qosIndex=qosIndex, vendorRev=vendorRev, vlan=vlan, statIndex=statIndex, reboot=reboot, dscpEnable=dscpEnable, staticIpPrimaryDns=staticIpPrimaryDns, portTable=portTable, vlangroupTable=vlangroupTable, qmapping=qmapping, port3=port3, fileName=fileName, staticIpGateway=staticIpGateway, fcsErrorReceived=fcsErrorReceived, port2=port2, portPower=portPower, lanportName=lanportName, qosTable=qosTable, hostname=hostname, qmode=qmode, jumbwan=jumbwan, jumblan1=jumblan1, portEntry=portEntry, vlanid=vlanid, portName=portName, lan3=lan3, staticIpHostName=staticIpHostName, catv=catv, groupid=groupid, modeEntry=modeEntry, staticIpSubMask=staticIpSubMask, rebootEnable=rebootEnable, staticDns=staticDns, domainame=domainame, qos=qos)
