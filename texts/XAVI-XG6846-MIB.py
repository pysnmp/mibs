...
IpAddress, ModuleIdentity, mib_2, TimeTicks, ObjectIdentity, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, NotificationType, iso, Counter64, Unsigned32, enterprises, snmpModules, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "mib-2", "TimeTicks", "ObjectIdentity", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "NotificationType", "iso", "Counter64", "Unsigned32", "enterprises", "snmpModules", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portIndex=portIndex, qosTable=qosTable, lan1=lan1, staticIpSubMask=staticIpSubMask, jumblan3=jumblan3, rebootEnable=rebootEnable, unicastsTransmitted=unicastsTransmitted, serialnum=serialnum, adminStatus=adminStatus, qos=qos, tftp=tftp, fileType=fileType, staticIpAddr=staticIpAddr, vendorPn=vendorPn, vendorOui=vendorOui, multicastsTransmitted=multicastsTransmitted, port4=port4, staticIpHostName=staticIpHostName, staticIpSecondaryDns=staticIpSecondaryDns, jumblan4=jumblan4, pauseTransmitted=pauseTransmitted, speed=speed, statIndex=statIndex, portPower=portPower, lanportIndex=lanportIndex, multicastsReceived=multicastsReceived, fcsErrorReceived=fcsErrorReceived, fcsErrorTransmitted=fcsErrorTransmitted, broadcastsReceived=broadcastsReceived, lan2=lan2, qmode=qmode, qmapping=qmapping, wanType=wanType, portStatEntry=portStatEntry, portStatistic=portStatistic, statisticTable=statisticTable, vendorName=vendorName, vlanid=vlanid, staticIpDomainName=staticIpDomainName, secondaryDns=secondaryDns, portmode=portmode, catvEnable=catvEnable, reboot=reboot, portName=portName, jumblan1=jumblan1, jumbwan=jumbwan, port1=port1, wan=wan, lanportName=lanportName, staticIpGateway=staticIpGateway, lanportspeed=lanportspeed, dscpEnable=dscpEnable, vendorRev=vendorRev, vlan=vlan, modeEntry=modeEntry, staticIpPrimaryDns=staticIpPrimaryDns, temperature=temperature, bias=bias, primaryDns=primaryDns, xg6846=xg6846, portEntry=portEntry, lanportpause=lanportpause, lan4=lan4, domainame=domainame, jumb=jumb, pauseReceived=pauseReceived, voltage=voltage, deviceinfo=deviceinfo, staticDns=staticDns, groupid=groupid, qosIndex=qosIndex, port2=port2, priority=priority, lan3=lan3, internetPort=internetPort, operStatus=operStatus, lanportTable=lanportTable, rxPower=rxPower, vlangroupTable=vlangroupTable, catv=catv, port3=port3, hostname=hostname, action=action, unicastsReceived=unicastsReceived, groupIndex=groupIndex, qosEntry=qosEntry, txPower=txPower, tftpSevIp=tftpSevIp, groupEntry=groupEntry, ddminfo=ddminfo, broadcastsTransmitted=broadcastsTransmitted, fileName=fileName, portTable=portTable, jumblan2=jumblan2)
