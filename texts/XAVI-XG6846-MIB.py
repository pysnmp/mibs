...
TimeTicks, snmpModules, Integer32, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Unsigned32, MibIdentifier, NotificationType, IpAddress, ObjectIdentity, iso, ModuleIdentity, mib_2, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "snmpModules", "Integer32", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Unsigned32", "MibIdentifier", "NotificationType", "IpAddress", "ObjectIdentity", "iso", "ModuleIdentity", "mib-2", "Counter32", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpSubMask=staticIpSubMask, qmapping=qmapping, port1=port1, staticIpSecondaryDns=staticIpSecondaryDns, tftp=tftp, fcsErrorTransmitted=fcsErrorTransmitted, vendorOui=vendorOui, lanportTable=lanportTable, broadcastsReceived=broadcastsReceived, lan1=lan1, primaryDns=primaryDns, staticIpDomainName=staticIpDomainName, adminStatus=adminStatus, catvEnable=catvEnable, pauseTransmitted=pauseTransmitted, qosIndex=qosIndex, portName=portName, multicastsTransmitted=multicastsTransmitted, pauseReceived=pauseReceived, unicastsTransmitted=unicastsTransmitted, speed=speed, fileName=fileName, tftpSevIp=tftpSevIp, lanportIndex=lanportIndex, deviceinfo=deviceinfo, multicastsReceived=multicastsReceived, temperature=temperature, vlan=vlan, portStatEntry=portStatEntry, qosTable=qosTable, vendorName=vendorName, broadcastsTransmitted=broadcastsTransmitted, jumb=jumb, portPower=portPower, staticIpPrimaryDns=staticIpPrimaryDns, xg6846=xg6846, jumblan1=jumblan1, qos=qos, modeEntry=modeEntry, dscpEnable=dscpEnable, lanportpause=lanportpause, statIndex=statIndex, lanportspeed=lanportspeed, vlangroupTable=vlangroupTable, jumblan3=jumblan3, portStatistic=portStatistic, port3=port3, hostname=hostname, priority=priority, bias=bias, rxPower=rxPower, txPower=txPower, port4=port4, qosEntry=qosEntry, voltage=voltage, lan3=lan3, vendorPn=vendorPn, portEntry=portEntry, lan2=lan2, internetPort=internetPort, wan=wan, groupEntry=groupEntry, staticDns=staticDns, operStatus=operStatus, serialnum=serialnum, lan4=lan4, staticIpGateway=staticIpGateway, action=action, portTable=portTable, jumbwan=jumbwan, catv=catv, jumblan2=jumblan2, lanportName=lanportName, fcsErrorReceived=fcsErrorReceived, secondaryDns=secondaryDns, portmode=portmode, domainame=domainame, vendorRev=vendorRev, fileType=fileType, port2=port2, staticIpHostName=staticIpHostName, jumblan4=jumblan4, vlanid=vlanid, groupid=groupid, unicastsReceived=unicastsReceived, wanType=wanType, staticIpAddr=staticIpAddr, portIndex=portIndex, rebootEnable=rebootEnable, qmode=qmode, reboot=reboot, groupIndex=groupIndex, statisticTable=statisticTable, ddminfo=ddminfo)
