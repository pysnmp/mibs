...
ModuleIdentity, snmpModules, Unsigned32, Counter32, ObjectIdentity, Bits, Gauge32, IpAddress, iso, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, MibIdentifier, enterprises, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "snmpModules", "Unsigned32", "Counter32", "ObjectIdentity", "Bits", "Gauge32", "IpAddress", "iso", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "MibIdentifier", "enterprises", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupIndex=groupIndex, unicastsReceived=unicastsReceived, portIndex=portIndex, portName=portName, hostname=hostname, lan3=lan3, jumblan2=jumblan2, bias=bias, operStatus=operStatus, port2=port2, tftp=tftp, catvEnable=catvEnable, lan2=lan2, rebootEnable=rebootEnable, fcsErrorTransmitted=fcsErrorTransmitted, qmode=qmode, temperature=temperature, jumblan3=jumblan3, xg6846=xg6846, groupid=groupid, modeEntry=modeEntry, qosTable=qosTable, portPower=portPower, tftpSevIp=tftpSevIp, catv=catv, groupEntry=groupEntry, staticIpGateway=staticIpGateway, staticIpSubMask=staticIpSubMask, port1=port1, lanportpause=lanportpause, vlanid=vlanid, portmode=portmode, domainame=domainame, voltage=voltage, wanType=wanType, lan1=lan1, lanportName=lanportName, jumb=jumb, vlangroupTable=vlangroupTable, jumblan4=jumblan4, staticIpPrimaryDns=staticIpPrimaryDns, dscpEnable=dscpEnable, qmapping=qmapping, speed=speed, statisticTable=statisticTable, adminStatus=adminStatus, vendorOui=vendorOui, portEntry=portEntry, portTable=portTable, port3=port3, portStatistic=portStatistic, vendorPn=vendorPn, priority=priority, qosIndex=qosIndex, staticIpSecondaryDns=staticIpSecondaryDns, internetPort=internetPort, jumblan1=jumblan1, primaryDns=primaryDns, vendorName=vendorName, action=action, staticIpDomainName=staticIpDomainName, txPower=txPower, serialnum=serialnum, rxPower=rxPower, fileType=fileType, qos=qos, unicastsTransmitted=unicastsTransmitted, portStatEntry=portStatEntry, staticIpHostName=staticIpHostName, lanportIndex=lanportIndex, reboot=reboot, pauseReceived=pauseReceived, multicastsReceived=multicastsReceived, fcsErrorReceived=fcsErrorReceived, staticIpAddr=staticIpAddr, wan=wan, lanportTable=lanportTable, deviceinfo=deviceinfo, jumbwan=jumbwan, fileName=fileName, pauseTransmitted=pauseTransmitted, qosEntry=qosEntry, broadcastsReceived=broadcastsReceived, broadcastsTransmitted=broadcastsTransmitted, statIndex=statIndex, vendorRev=vendorRev, port4=port4, ddminfo=ddminfo, staticDns=staticDns, multicastsTransmitted=multicastsTransmitted, lanportspeed=lanportspeed, vlan=vlan, secondaryDns=secondaryDns, lan4=lan4)
