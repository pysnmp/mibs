...
# Produced by pysmi-1.1.8 at Wed Sep 13 14:58:26 2023
...
iso, ObjectIdentity, enterprises, NotificationType, IpAddress, Integer32, Counter64, TimeTicks, MibIdentifier, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, mib_2, ModuleIdentity, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "enterprises", "NotificationType", "IpAddress", "Integer32", "Counter64", "TimeTicks", "MibIdentifier", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "mib-2", "ModuleIdentity", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qosTable=qosTable, jumblan3=jumblan3, vendorOui=vendorOui, statisticTable=statisticTable, bias=bias, qosIndex=qosIndex, lanportspeed=lanportspeed, internetPort=internetPort, catvEnable=catvEnable, broadcastsTransmitted=broadcastsTransmitted, staticIpGateway=staticIpGateway, lanportName=lanportName, priority=priority, lan4=lan4, unicastsReceived=unicastsReceived, txPower=txPower, jumblan2=jumblan2, fcsErrorTransmitted=fcsErrorTransmitted, serialnum=serialnum, groupid=groupid, staticIpPrimaryDns=staticIpPrimaryDns, tftp=tftp, broadcastsReceived=broadcastsReceived, port1=port1, port2=port2, reboot=reboot, vendorPn=vendorPn, fileType=fileType, vlanid=vlanid, wan=wan, portPower=portPower, lanportIndex=lanportIndex, lan2=lan2, portmode=portmode, dscpEnable=dscpEnable, wanType=wanType, qmode=qmode, adminStatus=adminStatus, groupEntry=groupEntry, jumb=jumb, portTable=portTable, rebootEnable=rebootEnable, vlan=vlan, staticIpAddr=staticIpAddr, qmapping=qmapping, temperature=temperature, deviceinfo=deviceinfo, qosEntry=qosEntry, port4=port4, port3=port3, vlangroupTable=vlangroupTable, fcsErrorReceived=fcsErrorReceived, domainame=domainame, portStatistic=portStatistic, multicastsTransmitted=multicastsTransmitted, staticIpHostName=staticIpHostName, jumbwan=jumbwan, operStatus=operStatus, portName=portName, lanportpause=lanportpause, primaryDns=primaryDns, lan3=lan3, multicastsReceived=multicastsReceived, hostname=hostname, ddminfo=ddminfo, modeEntry=modeEntry, statIndex=statIndex, rxPower=rxPower, jumblan4=jumblan4, vendorName=vendorName, groupIndex=groupIndex, fileName=fileName, staticIpSecondaryDns=staticIpSecondaryDns, pauseReceived=pauseReceived, portEntry=portEntry, unicastsTransmitted=unicastsTransmitted, xg6846=xg6846, portIndex=portIndex, tftpSevIp=tftpSevIp, catv=catv, secondaryDns=secondaryDns, voltage=voltage, lanportTable=lanportTable, jumblan1=jumblan1, lan1=lan1, speed=speed, qos=qos, vendorRev=vendorRev, portStatEntry=portStatEntry, staticDns=staticDns, action=action, staticIpSubMask=staticIpSubMask, staticIpDomainName=staticIpDomainName, pauseTransmitted=pauseTransmitted)
