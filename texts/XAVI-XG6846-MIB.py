...
# Produced by pysmi-1.1.8 at Sat Jan 15 05:33:08 2022
...
snmpModules, Integer32, ModuleIdentity, enterprises, Bits, Counter64, Gauge32, ObjectIdentity, MibIdentifier, TimeTicks, NotificationType, Counter32, mib_2, IpAddress, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "Integer32", "ModuleIdentity", "enterprises", "Bits", "Counter64", "Gauge32", "ObjectIdentity", "MibIdentifier", "TimeTicks", "NotificationType", "Counter32", "mib-2", "IpAddress", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", reboot=reboot, jumb=jumb, secondaryDns=secondaryDns, staticDns=staticDns, xg6846=xg6846, jumblan1=jumblan1, lan2=lan2, broadcastsTransmitted=broadcastsTransmitted, statisticTable=statisticTable, broadcastsReceived=broadcastsReceived, operStatus=operStatus, unicastsReceived=unicastsReceived, lanportpause=lanportpause, jumblan3=jumblan3, qosTable=qosTable, staticIpPrimaryDns=staticIpPrimaryDns, lan1=lan1, portIndex=portIndex, port2=port2, portStatEntry=portStatEntry, vendorOui=vendorOui, fcsErrorReceived=fcsErrorReceived, adminStatus=adminStatus, unicastsTransmitted=unicastsTransmitted, voltage=voltage, lan4=lan4, catvEnable=catvEnable, qmode=qmode, fileType=fileType, lanportspeed=lanportspeed, pauseReceived=pauseReceived, jumblan2=jumblan2, vlanid=vlanid, vlangroupTable=vlangroupTable, modeEntry=modeEntry, portStatistic=portStatistic, portTable=portTable, catv=catv, temperature=temperature, staticIpAddr=staticIpAddr, fcsErrorTransmitted=fcsErrorTransmitted, staticIpHostName=staticIpHostName, port4=port4, bias=bias, port3=port3, statIndex=statIndex, rebootEnable=rebootEnable, tftp=tftp, portmode=portmode, portName=portName, wan=wan, dscpEnable=dscpEnable, speed=speed, ddminfo=ddminfo, staticIpSecondaryDns=staticIpSecondaryDns, multicastsTransmitted=multicastsTransmitted, portEntry=portEntry, action=action, groupid=groupid, qosIndex=qosIndex, serialnum=serialnum, vendorPn=vendorPn, vendorName=vendorName, staticIpGateway=staticIpGateway, rxPower=rxPower, qmapping=qmapping, staticIpDomainName=staticIpDomainName, groupEntry=groupEntry, portPower=portPower, multicastsReceived=multicastsReceived, staticIpSubMask=staticIpSubMask, tftpSevIp=tftpSevIp, txPower=txPower, vlan=vlan, qos=qos, wanType=wanType, vendorRev=vendorRev, fileName=fileName, priority=priority, jumblan4=jumblan4, lanportName=lanportName, domainame=domainame, port1=port1, pauseTransmitted=pauseTransmitted, internetPort=internetPort, jumbwan=jumbwan, lanportTable=lanportTable, lanportIndex=lanportIndex, deviceinfo=deviceinfo, lan3=lan3, qosEntry=qosEntry, groupIndex=groupIndex, primaryDns=primaryDns, hostname=hostname)
