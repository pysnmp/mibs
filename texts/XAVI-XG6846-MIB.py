...
ModuleIdentity, Counter32, NotificationType, iso, enterprises, Counter64, mib_2, IpAddress, Bits, Unsigned32, MibIdentifier, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "NotificationType", "iso", "enterprises", "Counter64", "mib-2", "IpAddress", "Bits", "Unsigned32", "MibIdentifier", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportspeed=lanportspeed, portmode=portmode, jumb=jumb, operStatus=operStatus, catvEnable=catvEnable, vlangroupTable=vlangroupTable, vendorPn=vendorPn, portStatEntry=portStatEntry, hostname=hostname, reboot=reboot, jumblan2=jumblan2, lan4=lan4, unicastsTransmitted=unicastsTransmitted, jumbwan=jumbwan, pauseTransmitted=pauseTransmitted, rebootEnable=rebootEnable, txPower=txPower, dscpEnable=dscpEnable, port3=port3, statIndex=statIndex, deviceinfo=deviceinfo, port2=port2, action=action, wanType=wanType, qos=qos, staticIpSubMask=staticIpSubMask, groupid=groupid, vendorName=vendorName, speed=speed, jumblan1=jumblan1, lanportName=lanportName, lanportpause=lanportpause, qosTable=qosTable, portEntry=portEntry, lan2=lan2, portIndex=portIndex, unicastsReceived=unicastsReceived, portTable=portTable, serialnum=serialnum, staticIpDomainName=staticIpDomainName, catv=catv, wan=wan, broadcastsReceived=broadcastsReceived, port1=port1, qosIndex=qosIndex, staticIpHostName=staticIpHostName, portPower=portPower, staticIpPrimaryDns=staticIpPrimaryDns, modeEntry=modeEntry, jumblan4=jumblan4, staticIpSecondaryDns=staticIpSecondaryDns, qosEntry=qosEntry, staticIpAddr=staticIpAddr, tftpSevIp=tftpSevIp, staticIpGateway=staticIpGateway, temperature=temperature, port4=port4, qmapping=qmapping, multicastsTransmitted=multicastsTransmitted, vlanid=vlanid, portName=portName, statisticTable=statisticTable, groupEntry=groupEntry, fileType=fileType, lan3=lan3, ddminfo=ddminfo, vendorRev=vendorRev, fileName=fileName, staticDns=staticDns, pauseReceived=pauseReceived, lan1=lan1, fcsErrorTransmitted=fcsErrorTransmitted, groupIndex=groupIndex, primaryDns=primaryDns, secondaryDns=secondaryDns, priority=priority, qmode=qmode, xg6846=xg6846, rxPower=rxPower, adminStatus=adminStatus, vlan=vlan, portStatistic=portStatistic, lanportTable=lanportTable, domainame=domainame, vendorOui=vendorOui, voltage=voltage, lanportIndex=lanportIndex, broadcastsTransmitted=broadcastsTransmitted, fcsErrorReceived=fcsErrorReceived, bias=bias, multicastsReceived=multicastsReceived, jumblan3=jumblan3, internetPort=internetPort, tftp=tftp)
