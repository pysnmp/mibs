...
Unsigned32, ModuleIdentity, ObjectIdentity, MibIdentifier, TimeTicks, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Counter32, IpAddress, Bits, mib_2, Integer32, NotificationType, iso, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "TimeTicks", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Counter32", "IpAddress", "Bits", "mib-2", "Integer32", "NotificationType", "iso", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", txPower=txPower, reboot=reboot, bias=bias, staticIpAddr=staticIpAddr, staticIpGateway=staticIpGateway, portmode=portmode, groupEntry=groupEntry, portStatistic=portStatistic, qos=qos, broadcastsReceived=broadcastsReceived, staticDns=staticDns, lan3=lan3, qosIndex=qosIndex, fileType=fileType, broadcastsTransmitted=broadcastsTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, port4=port4, portStatEntry=portStatEntry, port1=port1, lanportpause=lanportpause, adminStatus=adminStatus, pauseReceived=pauseReceived, staticIpSubMask=staticIpSubMask, catv=catv, serialnum=serialnum, tftp=tftp, portEntry=portEntry, lan1=lan1, fileName=fileName, tftpSevIp=tftpSevIp, qmapping=qmapping, voltage=voltage, vendorOui=vendorOui, jumblan4=jumblan4, rebootEnable=rebootEnable, vendorRev=vendorRev, lanportspeed=lanportspeed, multicastsTransmitted=multicastsTransmitted, temperature=temperature, modeEntry=modeEntry, fcsErrorTransmitted=fcsErrorTransmitted, groupIndex=groupIndex, jumbwan=jumbwan, wanType=wanType, port2=port2, staticIpHostName=staticIpHostName, lanportIndex=lanportIndex, rxPower=rxPower, ddminfo=ddminfo, vendorName=vendorName, lanportTable=lanportTable, vlanid=vlanid, catvEnable=catvEnable, lan4=lan4, lanportName=lanportName, jumblan3=jumblan3, fcsErrorReceived=fcsErrorReceived, unicastsReceived=unicastsReceived, jumb=jumb, xg6846=xg6846, unicastsTransmitted=unicastsTransmitted, statisticTable=statisticTable, speed=speed, dscpEnable=dscpEnable, domainame=domainame, lan2=lan2, port3=port3, multicastsReceived=multicastsReceived, action=action, operStatus=operStatus, portTable=portTable, wan=wan, portPower=portPower, priority=priority, jumblan1=jumblan1, pauseTransmitted=pauseTransmitted, groupid=groupid, statIndex=statIndex, secondaryDns=secondaryDns, qmode=qmode, vendorPn=vendorPn, deviceinfo=deviceinfo, hostname=hostname, qosEntry=qosEntry, jumblan2=jumblan2, qosTable=qosTable, staticIpDomainName=staticIpDomainName, vlangroupTable=vlangroupTable, internetPort=internetPort, portIndex=portIndex, vlan=vlan, primaryDns=primaryDns, staticIpSecondaryDns=staticIpSecondaryDns, portName=portName)
