...
iso, ObjectIdentity, Gauge32, Integer32, Unsigned32, mib_2, NotificationType, IpAddress, Bits, TimeTicks, Counter32, Counter64, enterprises, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "Gauge32", "Integer32", "Unsigned32", "mib-2", "NotificationType", "IpAddress", "Bits", "TimeTicks", "Counter32", "Counter64", "enterprises", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", unicastsTransmitted=unicastsTransmitted, jumblan1=jumblan1, vlanid=vlanid, broadcastsReceived=broadcastsReceived, fileType=fileType, voltage=voltage, ddminfo=ddminfo, pauseReceived=pauseReceived, vendorPn=vendorPn, staticIpAddr=staticIpAddr, fcsErrorTransmitted=fcsErrorTransmitted, lanportTable=lanportTable, adminStatus=adminStatus, fileName=fileName, groupIndex=groupIndex, port2=port2, fcsErrorReceived=fcsErrorReceived, domainame=domainame, portmode=portmode, catv=catv, serialnum=serialnum, temperature=temperature, staticIpGateway=staticIpGateway, staticDns=staticDns, speed=speed, portPower=portPower, operStatus=operStatus, jumblan2=jumblan2, portEntry=portEntry, dscpEnable=dscpEnable, jumbwan=jumbwan, staticIpSubMask=staticIpSubMask, statIndex=statIndex, wan=wan, vendorName=vendorName, pauseTransmitted=pauseTransmitted, lan4=lan4, catvEnable=catvEnable, vlangroupTable=vlangroupTable, xg6846=xg6846, rxPower=rxPower, groupid=groupid, vendorOui=vendorOui, qmode=qmode, action=action, lan1=lan1, staticIpPrimaryDns=staticIpPrimaryDns, priority=priority, portStatEntry=portStatEntry, jumblan4=jumblan4, wanType=wanType, lanportIndex=lanportIndex, portStatistic=portStatistic, reboot=reboot, jumblan3=jumblan3, primaryDns=primaryDns, staticIpSecondaryDns=staticIpSecondaryDns, portTable=portTable, lan2=lan2, multicastsTransmitted=multicastsTransmitted, unicastsReceived=unicastsReceived, groupEntry=groupEntry, lanportspeed=lanportspeed, qos=qos, vlan=vlan, modeEntry=modeEntry, jumb=jumb, tftpSevIp=tftpSevIp, port1=port1, tftp=tftp, deviceinfo=deviceinfo, internetPort=internetPort, qosIndex=qosIndex, hostname=hostname, secondaryDns=secondaryDns, lanportpause=lanportpause, broadcastsTransmitted=broadcastsTransmitted, vendorRev=vendorRev, qosTable=qosTable, rebootEnable=rebootEnable, lan3=lan3, statisticTable=statisticTable, bias=bias, lanportName=lanportName, port4=port4, staticIpDomainName=staticIpDomainName, portName=portName, portIndex=portIndex, port3=port3, qosEntry=qosEntry, multicastsReceived=multicastsReceived, staticIpHostName=staticIpHostName, txPower=txPower, qmapping=qmapping)
