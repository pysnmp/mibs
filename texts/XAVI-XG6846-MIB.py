...
TimeTicks, snmpModules, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, mib_2, MibIdentifier, ObjectIdentity, Integer32, NotificationType, Bits, ModuleIdentity, Unsigned32, enterprises, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "snmpModules", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "mib-2", "MibIdentifier", "ObjectIdentity", "Integer32", "NotificationType", "Bits", "ModuleIdentity", "Unsigned32", "enterprises", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpGateway=staticIpGateway, portIndex=portIndex, multicastsTransmitted=multicastsTransmitted, domainame=domainame, portTable=portTable, groupid=groupid, lanportTable=lanportTable, fileType=fileType, groupEntry=groupEntry, portStatistic=portStatistic, broadcastsTransmitted=broadcastsTransmitted, portPower=portPower, operStatus=operStatus, vlan=vlan, temperature=temperature, bias=bias, lanportspeed=lanportspeed, lan1=lan1, reboot=reboot, tftpSevIp=tftpSevIp, port1=port1, action=action, portEntry=portEntry, lan3=lan3, txPower=txPower, portmode=portmode, vlangroupTable=vlangroupTable, rxPower=rxPower, port4=port4, unicastsReceived=unicastsReceived, pauseTransmitted=pauseTransmitted, adminStatus=adminStatus, port3=port3, deviceinfo=deviceinfo, hostname=hostname, statIndex=statIndex, multicastsReceived=multicastsReceived, wanType=wanType, catv=catv, rebootEnable=rebootEnable, jumblan1=jumblan1, jumblan3=jumblan3, lanportpause=lanportpause, vendorPn=vendorPn, pauseReceived=pauseReceived, staticDns=staticDns, modeEntry=modeEntry, staticIpSecondaryDns=staticIpSecondaryDns, qmapping=qmapping, portStatEntry=portStatEntry, qosIndex=qosIndex, xg6846=xg6846, broadcastsReceived=broadcastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, vendorRev=vendorRev, portName=portName, ddminfo=ddminfo, primaryDns=primaryDns, vlanid=vlanid, wan=wan, lanportName=lanportName, jumblan4=jumblan4, priority=priority, jumb=jumb, staticIpHostName=staticIpHostName, jumblan2=jumblan2, qos=qos, jumbwan=jumbwan, lan4=lan4, dscpEnable=dscpEnable, lan2=lan2, tftp=tftp, secondaryDns=secondaryDns, staticIpPrimaryDns=staticIpPrimaryDns, statisticTable=statisticTable, qosTable=qosTable, serialnum=serialnum, staticIpSubMask=staticIpSubMask, port2=port2, fcsErrorReceived=fcsErrorReceived, staticIpDomainName=staticIpDomainName, fileName=fileName, voltage=voltage, groupIndex=groupIndex, staticIpAddr=staticIpAddr, speed=speed, unicastsTransmitted=unicastsTransmitted, internetPort=internetPort, catvEnable=catvEnable, qosEntry=qosEntry, qmode=qmode, vendorName=vendorName, vendorOui=vendorOui, lanportIndex=lanportIndex)
