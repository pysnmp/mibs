...
# Produced by pysmi-1.1.3 at Wed Dec  8 17:23:49 2021
...
mib_2, Gauge32, Counter32, iso, Unsigned32, snmpModules, MibIdentifier, enterprises, ModuleIdentity, NotificationType, IpAddress, ObjectIdentity, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Gauge32", "Counter32", "iso", "Unsigned32", "snmpModules", "MibIdentifier", "enterprises", "ModuleIdentity", "NotificationType", "IpAddress", "ObjectIdentity", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portStatEntry=portStatEntry, wan=wan, rxPower=rxPower, speed=speed, jumblan3=jumblan3, vlanid=vlanid, port1=port1, pauseTransmitted=pauseTransmitted, broadcastsReceived=broadcastsReceived, lanportpause=lanportpause, staticIpHostName=staticIpHostName, bias=bias, qosEntry=qosEntry, lanportTable=lanportTable, jumblan4=jumblan4, lan1=lan1, ddminfo=ddminfo, tftpSevIp=tftpSevIp, jumb=jumb, vendorOui=vendorOui, portmode=portmode, unicastsReceived=unicastsReceived, fileName=fileName, portIndex=portIndex, vlangroupTable=vlangroupTable, action=action, jumbwan=jumbwan, vendorRev=vendorRev, unicastsTransmitted=unicastsTransmitted, catvEnable=catvEnable, jumblan1=jumblan1, rebootEnable=rebootEnable, broadcastsTransmitted=broadcastsTransmitted, hostname=hostname, staticIpSubMask=staticIpSubMask, qosIndex=qosIndex, lan3=lan3, modeEntry=modeEntry, domainame=domainame, deviceinfo=deviceinfo, voltage=voltage, internetPort=internetPort, staticDns=staticDns, vendorName=vendorName, jumblan2=jumblan2, vendorPn=vendorPn, groupid=groupid, fcsErrorTransmitted=fcsErrorTransmitted, primaryDns=primaryDns, qmapping=qmapping, adminStatus=adminStatus, lanportIndex=lanportIndex, portStatistic=portStatistic, staticIpGateway=staticIpGateway, staticIpPrimaryDns=staticIpPrimaryDns, operStatus=operStatus, multicastsTransmitted=multicastsTransmitted, portTable=portTable, staticIpSecondaryDns=staticIpSecondaryDns, vlan=vlan, fileType=fileType, portEntry=portEntry, lanportName=lanportName, portPower=portPower, statisticTable=statisticTable, staticIpDomainName=staticIpDomainName, portName=portName, lanportspeed=lanportspeed, reboot=reboot, temperature=temperature, port3=port3, port2=port2, priority=priority, serialnum=serialnum, secondaryDns=secondaryDns, lan4=lan4, statIndex=statIndex, xg6846=xg6846, multicastsReceived=multicastsReceived, qmode=qmode, staticIpAddr=staticIpAddr, catv=catv, qos=qos, qosTable=qosTable, tftp=tftp, dscpEnable=dscpEnable, groupEntry=groupEntry, pauseReceived=pauseReceived, port4=port4, txPower=txPower, lan2=lan2, groupIndex=groupIndex, wanType=wanType, fcsErrorReceived=fcsErrorReceived)
