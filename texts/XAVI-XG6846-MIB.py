...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:41:36 2024
...
enterprises, mib_2, snmpModules, NotificationType, ModuleIdentity, Integer32, Counter32, iso, Unsigned32, MibIdentifier, ObjectIdentity, Gauge32, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "mib-2", "snmpModules", "NotificationType", "ModuleIdentity", "Integer32", "Counter32", "iso", "Unsigned32", "MibIdentifier", "ObjectIdentity", "Gauge32", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qosEntry=qosEntry, portStatistic=portStatistic, pauseTransmitted=pauseTransmitted, staticIpSubMask=staticIpSubMask, wanType=wanType, portName=portName, jumblan1=jumblan1, multicastsReceived=multicastsReceived, fileType=fileType, deviceinfo=deviceinfo, wan=wan, txPower=txPower, statisticTable=statisticTable, dscpEnable=dscpEnable, lan1=lan1, vlan=vlan, catv=catv, tftp=tftp, portEntry=portEntry, vlanid=vlanid, groupEntry=groupEntry, lanportIndex=lanportIndex, staticIpPrimaryDns=staticIpPrimaryDns, fileName=fileName, port4=port4, qosTable=qosTable, vlangroupTable=vlangroupTable, adminStatus=adminStatus, portmode=portmode, lan3=lan3, staticIpSecondaryDns=staticIpSecondaryDns, staticIpAddr=staticIpAddr, secondaryDns=secondaryDns, portTable=portTable, jumblan2=jumblan2, unicastsReceived=unicastsReceived, staticIpDomainName=staticIpDomainName, temperature=temperature, voltage=voltage, domainame=domainame, serialnum=serialnum, qmapping=qmapping, fcsErrorTransmitted=fcsErrorTransmitted, staticDns=staticDns, multicastsTransmitted=multicastsTransmitted, staticIpGateway=staticIpGateway, lanportpause=lanportpause, vendorPn=vendorPn, lanportName=lanportName, lanportspeed=lanportspeed, port2=port2, jumbwan=jumbwan, reboot=reboot, bias=bias, hostname=hostname, speed=speed, jumb=jumb, vendorOui=vendorOui, action=action, rebootEnable=rebootEnable, groupid=groupid, fcsErrorReceived=fcsErrorReceived, portPower=portPower, unicastsTransmitted=unicastsTransmitted, portStatEntry=portStatEntry, vendorRev=vendorRev, jumblan3=jumblan3, portIndex=portIndex, broadcastsTransmitted=broadcastsTransmitted, lan2=lan2, internetPort=internetPort, operStatus=operStatus, ddminfo=ddminfo, groupIndex=groupIndex, qosIndex=qosIndex, staticIpHostName=staticIpHostName, vendorName=vendorName, jumblan4=jumblan4, port1=port1, broadcastsReceived=broadcastsReceived, catvEnable=catvEnable, xg6846=xg6846, qos=qos, rxPower=rxPower, primaryDns=primaryDns, lanportTable=lanportTable, pauseReceived=pauseReceived, statIndex=statIndex, qmode=qmode, priority=priority, lan4=lan4, modeEntry=modeEntry, tftpSevIp=tftpSevIp, port3=port3)
