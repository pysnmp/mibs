...
# Produced by pysmi-1.1.10 at Thu Oct 26 13:10:27 2023
...
mib_2, ModuleIdentity, Gauge32, Counter32, enterprises, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity, MibIdentifier, TimeTicks, Integer32, snmpModules, iso, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "ModuleIdentity", "Gauge32", "Counter32", "enterprises", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity", "MibIdentifier", "TimeTicks", "Integer32", "snmpModules", "iso", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vlanid=vlanid, qosIndex=qosIndex, staticDns=staticDns, portPower=portPower, jumblan1=jumblan1, fileType=fileType, lanportName=lanportName, fileName=fileName, domainame=domainame, lan3=lan3, staticIpSecondaryDns=staticIpSecondaryDns, qos=qos, pauseReceived=pauseReceived, txPower=txPower, jumblan2=jumblan2, secondaryDns=secondaryDns, staticIpHostName=staticIpHostName, port1=port1, multicastsTransmitted=multicastsTransmitted, adminStatus=adminStatus, groupEntry=groupEntry, jumblan3=jumblan3, portName=portName, tftpSevIp=tftpSevIp, fcsErrorReceived=fcsErrorReceived, broadcastsTransmitted=broadcastsTransmitted, internetPort=internetPort, broadcastsReceived=broadcastsReceived, serialnum=serialnum, vlan=vlan, statisticTable=statisticTable, action=action, jumbwan=jumbwan, jumblan4=jumblan4, rxPower=rxPower, reboot=reboot, qmapping=qmapping, temperature=temperature, wanType=wanType, lanportTable=lanportTable, lanportspeed=lanportspeed, unicastsTransmitted=unicastsTransmitted, portEntry=portEntry, bias=bias, rebootEnable=rebootEnable, portTable=portTable, vendorName=vendorName, modeEntry=modeEntry, hostname=hostname, staticIpGateway=staticIpGateway, deviceinfo=deviceinfo, port2=port2, groupIndex=groupIndex, lan2=lan2, tftp=tftp, jumb=jumb, qosEntry=qosEntry, lan1=lan1, vlangroupTable=vlangroupTable, groupid=groupid, dscpEnable=dscpEnable, qmode=qmode, lan4=lan4, operStatus=operStatus, vendorOui=vendorOui, vendorPn=vendorPn, unicastsReceived=unicastsReceived, wan=wan, staticIpAddr=staticIpAddr, portStatEntry=portStatEntry, priority=priority, portmode=portmode, multicastsReceived=multicastsReceived, primaryDns=primaryDns, catvEnable=catvEnable, qosTable=qosTable, ddminfo=ddminfo, vendorRev=vendorRev, fcsErrorTransmitted=fcsErrorTransmitted, catv=catv, speed=speed, portStatistic=portStatistic, voltage=voltage, staticIpPrimaryDns=staticIpPrimaryDns, lanportIndex=lanportIndex, staticIpDomainName=staticIpDomainName, lanportpause=lanportpause, statIndex=statIndex, port3=port3, xg6846=xg6846, pauseTransmitted=pauseTransmitted, port4=port4, staticIpSubMask=staticIpSubMask, portIndex=portIndex)
