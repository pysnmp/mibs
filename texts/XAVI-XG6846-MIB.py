...
# Produced by pysmi-1.1.3 at Mon Nov 22 12:33:57 2021
...
Unsigned32, IpAddress, Counter32, ObjectIdentity, MibIdentifier, TimeTicks, enterprises, Bits, NotificationType, mib_2, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, ModuleIdentity, snmpModules, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "Counter32", "ObjectIdentity", "MibIdentifier", "TimeTicks", "enterprises", "Bits", "NotificationType", "mib-2", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "ModuleIdentity", "snmpModules", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorPn=vendorPn, wan=wan, wanType=wanType, dscpEnable=dscpEnable, hostname=hostname, fileType=fileType, catv=catv, vendorOui=vendorOui, qos=qos, staticIpDomainName=staticIpDomainName, qosTable=qosTable, voltage=voltage, deviceinfo=deviceinfo, xg6846=xg6846, lan4=lan4, speed=speed, action=action, txPower=txPower, groupIndex=groupIndex, lan2=lan2, port4=port4, portPower=portPower, vlan=vlan, qosIndex=qosIndex, secondaryDns=secondaryDns, lanportspeed=lanportspeed, pauseTransmitted=pauseTransmitted, jumb=jumb, portmode=portmode, broadcastsReceived=broadcastsReceived, staticDns=staticDns, qosEntry=qosEntry, tftp=tftp, portIndex=portIndex, multicastsTransmitted=multicastsTransmitted, operStatus=operStatus, port1=port1, jumbwan=jumbwan, lan3=lan3, staticIpHostName=staticIpHostName, ddminfo=ddminfo, domainame=domainame, statisticTable=statisticTable, adminStatus=adminStatus, jumblan2=jumblan2, broadcastsTransmitted=broadcastsTransmitted, primaryDns=primaryDns, portStatistic=portStatistic, catvEnable=catvEnable, lanportName=lanportName, jumblan1=jumblan1, unicastsReceived=unicastsReceived, vendorName=vendorName, portStatEntry=portStatEntry, staticIpGateway=staticIpGateway, port2=port2, internetPort=internetPort, groupEntry=groupEntry, unicastsTransmitted=unicastsTransmitted, lanportIndex=lanportIndex, jumblan4=jumblan4, temperature=temperature, portTable=portTable, staticIpAddr=staticIpAddr, portEntry=portEntry, lanportpause=lanportpause, bias=bias, staticIpSubMask=staticIpSubMask, qmapping=qmapping, staticIpPrimaryDns=staticIpPrimaryDns, priority=priority, serialnum=serialnum, rxPower=rxPower, multicastsReceived=multicastsReceived, groupid=groupid, vlangroupTable=vlangroupTable, fcsErrorTransmitted=fcsErrorTransmitted, port3=port3, lanportTable=lanportTable, modeEntry=modeEntry, fcsErrorReceived=fcsErrorReceived, lan1=lan1, tftpSevIp=tftpSevIp, jumblan3=jumblan3, rebootEnable=rebootEnable, vendorRev=vendorRev, vlanid=vlanid, reboot=reboot, fileName=fileName, pauseReceived=pauseReceived, statIndex=statIndex, qmode=qmode, portName=portName, staticIpSecondaryDns=staticIpSecondaryDns)
