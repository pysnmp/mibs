...
# Produced by pysmi-1.1.8 at Tue Sep 12 12:58:25 2023
...
Bits, ModuleIdentity, snmpModules, MibIdentifier, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, Integer32, NotificationType, enterprises, Gauge32, ObjectIdentity, Unsigned32, mib_2, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "snmpModules", "MibIdentifier", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "Integer32", "NotificationType", "enterprises", "Gauge32", "ObjectIdentity", "Unsigned32", "mib-2", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catv=catv, lanportTable=lanportTable, groupid=groupid, qmapping=qmapping, portStatEntry=portStatEntry, qmode=qmode, pauseReceived=pauseReceived, portStatistic=portStatistic, primaryDns=primaryDns, lanportIndex=lanportIndex, unicastsTransmitted=unicastsTransmitted, qosTable=qosTable, xg6846=xg6846, lan2=lan2, broadcastsTransmitted=broadcastsTransmitted, portEntry=portEntry, staticDns=staticDns, tftp=tftp, lanportName=lanportName, qosIndex=qosIndex, bias=bias, multicastsReceived=multicastsReceived, domainame=domainame, secondaryDns=secondaryDns, staticIpPrimaryDns=staticIpPrimaryDns, lanportpause=lanportpause, adminStatus=adminStatus, vendorPn=vendorPn, fileType=fileType, vendorRev=vendorRev, operStatus=operStatus, lan3=lan3, port1=port1, multicastsTransmitted=multicastsTransmitted, voltage=voltage, staticIpDomainName=staticIpDomainName, txPower=txPower, jumblan1=jumblan1, statIndex=statIndex, lan4=lan4, rxPower=rxPower, modeEntry=modeEntry, broadcastsReceived=broadcastsReceived, ddminfo=ddminfo, qosEntry=qosEntry, lan1=lan1, rebootEnable=rebootEnable, catvEnable=catvEnable, staticIpHostName=staticIpHostName, vlanid=vlanid, portIndex=portIndex, jumblan3=jumblan3, lanportspeed=lanportspeed, jumblan4=jumblan4, wan=wan, qos=qos, staticIpSecondaryDns=staticIpSecondaryDns, portmode=portmode, dscpEnable=dscpEnable, internetPort=internetPort, portName=portName, jumblan2=jumblan2, staticIpSubMask=staticIpSubMask, tftpSevIp=tftpSevIp, priority=priority, action=action, vlangroupTable=vlangroupTable, vendorOui=vendorOui, vlan=vlan, serialnum=serialnum, speed=speed, vendorName=vendorName, hostname=hostname, portPower=portPower, reboot=reboot, groupIndex=groupIndex, fileName=fileName, port2=port2, temperature=temperature, deviceinfo=deviceinfo, jumb=jumb, portTable=portTable, port4=port4, jumbwan=jumbwan, fcsErrorTransmitted=fcsErrorTransmitted, fcsErrorReceived=fcsErrorReceived, staticIpAddr=staticIpAddr, port3=port3, groupEntry=groupEntry, wanType=wanType, unicastsReceived=unicastsReceived, staticIpGateway=staticIpGateway, pauseTransmitted=pauseTransmitted, statisticTable=statisticTable)
