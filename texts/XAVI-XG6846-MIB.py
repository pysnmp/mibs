...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:27:51 2022
...
iso, TimeTicks, Unsigned32, IpAddress, NotificationType, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, Gauge32, snmpModules, Integer32, ObjectIdentity, enterprises, MibIdentifier, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Unsigned32", "IpAddress", "NotificationType", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "Gauge32", "snmpModules", "Integer32", "ObjectIdentity", "enterprises", "MibIdentifier", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", primaryDns=primaryDns, lanportIndex=lanportIndex, tftpSevIp=tftpSevIp, internetPort=internetPort, portTable=portTable, lan2=lan2, portName=portName, jumb=jumb, bias=bias, ddminfo=ddminfo, statisticTable=statisticTable, fcsErrorTransmitted=fcsErrorTransmitted, qosIndex=qosIndex, staticIpGateway=staticIpGateway, jumblan4=jumblan4, qmode=qmode, staticIpSecondaryDns=staticIpSecondaryDns, broadcastsTransmitted=broadcastsTransmitted, dscpEnable=dscpEnable, jumblan2=jumblan2, deviceinfo=deviceinfo, pauseReceived=pauseReceived, fileType=fileType, lanportTable=lanportTable, qmapping=qmapping, vendorPn=vendorPn, port3=port3, secondaryDns=secondaryDns, port2=port2, catv=catv, vendorRev=vendorRev, voltage=voltage, staticDns=staticDns, portmode=portmode, fcsErrorReceived=fcsErrorReceived, portEntry=portEntry, txPower=txPower, qos=qos, vlangroupTable=vlangroupTable, broadcastsReceived=broadcastsReceived, rebootEnable=rebootEnable, lanportpause=lanportpause, unicastsReceived=unicastsReceived, staticIpDomainName=staticIpDomainName, portStatEntry=portStatEntry, wanType=wanType, unicastsTransmitted=unicastsTransmitted, multicastsTransmitted=multicastsTransmitted, operStatus=operStatus, catvEnable=catvEnable, port4=port4, portStatistic=portStatistic, serialnum=serialnum, portIndex=portIndex, groupid=groupid, rxPower=rxPower, wan=wan, groupEntry=groupEntry, priority=priority, staticIpAddr=staticIpAddr, xg6846=xg6846, reboot=reboot, lan4=lan4, staticIpPrimaryDns=staticIpPrimaryDns, speed=speed, vendorName=vendorName, groupIndex=groupIndex, jumbwan=jumbwan, lan3=lan3, statIndex=statIndex, staticIpSubMask=staticIpSubMask, lanportName=lanportName, portPower=portPower, vendorOui=vendorOui, pauseTransmitted=pauseTransmitted, vlan=vlan, qosEntry=qosEntry, lanportspeed=lanportspeed, domainame=domainame, qosTable=qosTable, port1=port1, temperature=temperature, tftp=tftp, hostname=hostname, jumblan3=jumblan3, jumblan1=jumblan1, vlanid=vlanid, adminStatus=adminStatus, action=action, multicastsReceived=multicastsReceived, fileName=fileName, modeEntry=modeEntry, lan1=lan1, staticIpHostName=staticIpHostName)
