...
ModuleIdentity, Gauge32, enterprises, Counter64, snmpModules, mib_2, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, TimeTicks, Bits, Integer32, IpAddress, ObjectIdentity, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "enterprises", "Counter64", "snmpModules", "mib-2", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "TimeTicks", "Bits", "Integer32", "IpAddress", "ObjectIdentity", "iso", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", statisticTable=statisticTable, staticIpSubMask=staticIpSubMask, jumblan1=jumblan1, fileType=fileType, lanportTable=lanportTable, multicastsReceived=multicastsReceived, qosEntry=qosEntry, lan3=lan3, port3=port3, voltage=voltage, modeEntry=modeEntry, staticIpAddr=staticIpAddr, portStatEntry=portStatEntry, port4=port4, lan4=lan4, serialnum=serialnum, deviceinfo=deviceinfo, pauseTransmitted=pauseTransmitted, qmode=qmode, vendorOui=vendorOui, hostname=hostname, portName=portName, temperature=temperature, staticIpSecondaryDns=staticIpSecondaryDns, statIndex=statIndex, rebootEnable=rebootEnable, ddminfo=ddminfo, broadcastsReceived=broadcastsReceived, catvEnable=catvEnable, qosIndex=qosIndex, portTable=portTable, operStatus=operStatus, qos=qos, lan2=lan2, broadcastsTransmitted=broadcastsTransmitted, xg6846=xg6846, action=action, lanportIndex=lanportIndex, vendorRev=vendorRev, txPower=txPower, portPower=portPower, jumblan3=jumblan3, portStatistic=portStatistic, vlangroupTable=vlangroupTable, lan1=lan1, fcsErrorTransmitted=fcsErrorTransmitted, lanportName=lanportName, staticIpGateway=staticIpGateway, qosTable=qosTable, wan=wan, priority=priority, reboot=reboot, portmode=portmode, vendorPn=vendorPn, jumbwan=jumbwan, unicastsTransmitted=unicastsTransmitted, jumblan4=jumblan4, pauseReceived=pauseReceived, vlan=vlan, staticIpHostName=staticIpHostName, qmapping=qmapping, domainame=domainame, bias=bias, tftpSevIp=tftpSevIp, port2=port2, vendorName=vendorName, staticIpPrimaryDns=staticIpPrimaryDns, unicastsReceived=unicastsReceived, staticDns=staticDns, portIndex=portIndex, vlanid=vlanid, lanportpause=lanportpause, portEntry=portEntry, port1=port1, internetPort=internetPort, groupIndex=groupIndex, dscpEnable=dscpEnable, jumb=jumb, multicastsTransmitted=multicastsTransmitted, primaryDns=primaryDns, adminStatus=adminStatus, lanportspeed=lanportspeed, fcsErrorReceived=fcsErrorReceived, staticIpDomainName=staticIpDomainName, groupid=groupid, rxPower=rxPower, groupEntry=groupEntry, speed=speed, catv=catv, tftp=tftp, secondaryDns=secondaryDns, jumblan2=jumblan2, wanType=wanType, fileName=fileName)
