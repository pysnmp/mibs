...
Bits, Counter32, snmpModules, mib_2, enterprises, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, NotificationType, iso, TimeTicks, ObjectIdentity, Integer32, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "snmpModules", "mib-2", "enterprises", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "NotificationType", "iso", "TimeTicks", "ObjectIdentity", "Integer32", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portPower=portPower, qosEntry=qosEntry, fileType=fileType, serialnum=serialnum, lan3=lan3, lan4=lan4, multicastsReceived=multicastsReceived, pauseReceived=pauseReceived, domainame=domainame, operStatus=operStatus, lanportTable=lanportTable, jumblan1=jumblan1, lan2=lan2, voltage=voltage, lanportName=lanportName, lan1=lan1, tftpSevIp=tftpSevIp, portEntry=portEntry, pauseTransmitted=pauseTransmitted, jumblan2=jumblan2, temperature=temperature, modeEntry=modeEntry, vlan=vlan, fileName=fileName, port2=port2, internetPort=internetPort, qmapping=qmapping, portName=portName, xg6846=xg6846, vendorPn=vendorPn, reboot=reboot, vlanid=vlanid, deviceinfo=deviceinfo, qosIndex=qosIndex, statisticTable=statisticTable, hostname=hostname, action=action, staticIpSubMask=staticIpSubMask, portStatEntry=portStatEntry, wanType=wanType, speed=speed, statIndex=statIndex, qosTable=qosTable, priority=priority, vendorOui=vendorOui, staticIpSecondaryDns=staticIpSecondaryDns, staticDns=staticDns, lanportspeed=lanportspeed, staticIpGateway=staticIpGateway, vendorRev=vendorRev, portStatistic=portStatistic, groupIndex=groupIndex, catv=catv, qmode=qmode, staticIpDomainName=staticIpDomainName, staticIpPrimaryDns=staticIpPrimaryDns, portIndex=portIndex, tftp=tftp, qos=qos, vlangroupTable=vlangroupTable, multicastsTransmitted=multicastsTransmitted, port4=port4, secondaryDns=secondaryDns, unicastsReceived=unicastsReceived, wan=wan, jumblan3=jumblan3, ddminfo=ddminfo, jumbwan=jumbwan, fcsErrorTransmitted=fcsErrorTransmitted, portmode=portmode, rxPower=rxPower, broadcastsReceived=broadcastsReceived, primaryDns=primaryDns, jumb=jumb, groupid=groupid, bias=bias, rebootEnable=rebootEnable, port1=port1, staticIpAddr=staticIpAddr, vendorName=vendorName, groupEntry=groupEntry, staticIpHostName=staticIpHostName, catvEnable=catvEnable, adminStatus=adminStatus, port3=port3, jumblan4=jumblan4, lanportpause=lanportpause, portTable=portTable, lanportIndex=lanportIndex, unicastsTransmitted=unicastsTransmitted, broadcastsTransmitted=broadcastsTransmitted, fcsErrorReceived=fcsErrorReceived, dscpEnable=dscpEnable, txPower=txPower)
