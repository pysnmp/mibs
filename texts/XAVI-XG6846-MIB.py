...
# Produced by pysmi-1.1.8 at Tue Sep 12 07:01:45 2023
...
ModuleIdentity, TimeTicks, NotificationType, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Counter32, iso, Integer32, snmpModules, Bits, ObjectIdentity, enterprises, Gauge32, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "NotificationType", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Counter32", "iso", "Integer32", "snmpModules", "Bits", "ObjectIdentity", "enterprises", "Gauge32", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", multicastsTransmitted=multicastsTransmitted, jumblan3=jumblan3, groupid=groupid, lan2=lan2, pauseTransmitted=pauseTransmitted, jumblan2=jumblan2, portEntry=portEntry, qmapping=qmapping, modeEntry=modeEntry, secondaryDns=secondaryDns, qosIndex=qosIndex, qosEntry=qosEntry, portTable=portTable, dscpEnable=dscpEnable, temperature=temperature, rxPower=rxPower, portStatEntry=portStatEntry, speed=speed, serialnum=serialnum, xg6846=xg6846, vlanid=vlanid, lanportTable=lanportTable, operStatus=operStatus, hostname=hostname, tftp=tftp, port3=port3, groupEntry=groupEntry, staticIpHostName=staticIpHostName, vlangroupTable=vlangroupTable, vendorOui=vendorOui, deviceinfo=deviceinfo, fileName=fileName, port2=port2, voltage=voltage, rebootEnable=rebootEnable, jumbwan=jumbwan, qos=qos, fcsErrorTransmitted=fcsErrorTransmitted, lan1=lan1, lan3=lan3, groupIndex=groupIndex, statIndex=statIndex, fcsErrorReceived=fcsErrorReceived, bias=bias, pauseReceived=pauseReceived, staticIpAddr=staticIpAddr, unicastsTransmitted=unicastsTransmitted, reboot=reboot, jumblan4=jumblan4, portPower=portPower, qmode=qmode, adminStatus=adminStatus, action=action, statisticTable=statisticTable, lanportName=lanportName, vendorName=vendorName, broadcastsTransmitted=broadcastsTransmitted, broadcastsReceived=broadcastsReceived, port4=port4, priority=priority, vlan=vlan, txPower=txPower, fileType=fileType, staticDns=staticDns, catvEnable=catvEnable, staticIpSecondaryDns=staticIpSecondaryDns, ddminfo=ddminfo, multicastsReceived=multicastsReceived, qosTable=qosTable, staticIpSubMask=staticIpSubMask, lanportIndex=lanportIndex, primaryDns=primaryDns, internetPort=internetPort, jumb=jumb, vendorRev=vendorRev, portIndex=portIndex, staticIpDomainName=staticIpDomainName, unicastsReceived=unicastsReceived, vendorPn=vendorPn, portStatistic=portStatistic, wan=wan, lan4=lan4, tftpSevIp=tftpSevIp, catv=catv, lanportspeed=lanportspeed, staticIpGateway=staticIpGateway, jumblan1=jumblan1, staticIpPrimaryDns=staticIpPrimaryDns, port1=port1, portName=portName, lanportpause=lanportpause, domainame=domainame, portmode=portmode, wanType=wanType)
