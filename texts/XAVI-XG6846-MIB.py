...
# Produced by pysmi-1.1.8 at Wed Sep  6 13:52:44 2023
...
Unsigned32, enterprises, iso, mib_2, Integer32, ObjectIdentity, NotificationType, Counter32, snmpModules, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, Counter64, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "enterprises", "iso", "mib-2", "Integer32", "ObjectIdentity", "NotificationType", "Counter32", "snmpModules", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "Counter64", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portStatEntry=portStatEntry, port3=port3, vlanid=vlanid, modeEntry=modeEntry, groupEntry=groupEntry, statIndex=statIndex, deviceinfo=deviceinfo, vlangroupTable=vlangroupTable, lan4=lan4, operStatus=operStatus, wanType=wanType, port1=port1, staticIpHostName=staticIpHostName, vendorRev=vendorRev, jumbwan=jumbwan, jumblan3=jumblan3, port2=port2, rebootEnable=rebootEnable, staticIpAddr=staticIpAddr, statisticTable=statisticTable, vendorPn=vendorPn, xg6846=xg6846, fileType=fileType, hostname=hostname, jumb=jumb, qosTable=qosTable, catvEnable=catvEnable, staticIpDomainName=staticIpDomainName, tftp=tftp, qmode=qmode, lanportpause=lanportpause, unicastsReceived=unicastsReceived, lanportName=lanportName, multicastsReceived=multicastsReceived, portPower=portPower, qos=qos, lan1=lan1, jumblan2=jumblan2, vlan=vlan, staticIpPrimaryDns=staticIpPrimaryDns, portTable=portTable, staticIpSecondaryDns=staticIpSecondaryDns, qosIndex=qosIndex, action=action, lanportIndex=lanportIndex, qmapping=qmapping, lan2=lan2, bias=bias, unicastsTransmitted=unicastsTransmitted, staticDns=staticDns, broadcastsReceived=broadcastsReceived, staticIpGateway=staticIpGateway, portStatistic=portStatistic, priority=priority, tftpSevIp=tftpSevIp, portEntry=portEntry, fcsErrorReceived=fcsErrorReceived, fcsErrorTransmitted=fcsErrorTransmitted, rxPower=rxPower, ddminfo=ddminfo, groupIndex=groupIndex, multicastsTransmitted=multicastsTransmitted, speed=speed, broadcastsTransmitted=broadcastsTransmitted, temperature=temperature, domainame=domainame, lanportTable=lanportTable, pauseTransmitted=pauseTransmitted, adminStatus=adminStatus, portIndex=portIndex, vendorOui=vendorOui, fileName=fileName, primaryDns=primaryDns, staticIpSubMask=staticIpSubMask, groupid=groupid, lan3=lan3, voltage=voltage, jumblan4=jumblan4, reboot=reboot, internetPort=internetPort, vendorName=vendorName, catv=catv, dscpEnable=dscpEnable, secondaryDns=secondaryDns, lanportspeed=lanportspeed, pauseReceived=pauseReceived, serialnum=serialnum, txPower=txPower, portName=portName, portmode=portmode, port4=port4, qosEntry=qosEntry, jumblan1=jumblan1, wan=wan)
