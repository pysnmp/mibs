...
# Produced by pysmi-1.1.8 at Wed Feb  2 18:01:39 2022
...
Bits, enterprises, IpAddress, Unsigned32, Counter32, NotificationType, Integer32, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, iso, TimeTicks, ModuleIdentity, MibIdentifier, mib_2, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "enterprises", "IpAddress", "Unsigned32", "Counter32", "NotificationType", "Integer32", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "iso", "TimeTicks", "ModuleIdentity", "MibIdentifier", "mib-2", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", reboot=reboot, deviceinfo=deviceinfo, jumblan1=jumblan1, multicastsTransmitted=multicastsTransmitted, lan2=lan2, qosTable=qosTable, groupEntry=groupEntry, jumbwan=jumbwan, portStatistic=portStatistic, portStatEntry=portStatEntry, jumb=jumb, catv=catv, staticIpAddr=staticIpAddr, lan3=lan3, portIndex=portIndex, priority=priority, qmode=qmode, vendorOui=vendorOui, tftp=tftp, portName=portName, portTable=portTable, serialnum=serialnum, vlanid=vlanid, qosIndex=qosIndex, port4=port4, operStatus=operStatus, vendorRev=vendorRev, speed=speed, fcsErrorReceived=fcsErrorReceived, jumblan2=jumblan2, portPower=portPower, staticIpHostName=staticIpHostName, hostname=hostname, ddminfo=ddminfo, lan1=lan1, secondaryDns=secondaryDns, domainame=domainame, jumblan3=jumblan3, staticIpSecondaryDns=staticIpSecondaryDns, statIndex=statIndex, vlangroupTable=vlangroupTable, staticIpSubMask=staticIpSubMask, xg6846=xg6846, port1=port1, vlan=vlan, bias=bias, pauseReceived=pauseReceived, voltage=voltage, portmode=portmode, modeEntry=modeEntry, lanportpause=lanportpause, broadcastsReceived=broadcastsReceived, pauseTransmitted=pauseTransmitted, port3=port3, portEntry=portEntry, adminStatus=adminStatus, temperature=temperature, statisticTable=statisticTable, vendorPn=vendorPn, lanportName=lanportName, lanportspeed=lanportspeed, primaryDns=primaryDns, groupid=groupid, qmapping=qmapping, tftpSevIp=tftpSevIp, internetPort=internetPort, fcsErrorTransmitted=fcsErrorTransmitted, staticIpDomainName=staticIpDomainName, qosEntry=qosEntry, wanType=wanType, dscpEnable=dscpEnable, lan4=lan4, staticIpPrimaryDns=staticIpPrimaryDns, unicastsTransmitted=unicastsTransmitted, fileType=fileType, jumblan4=jumblan4, txPower=txPower, rxPower=rxPower, groupIndex=groupIndex, multicastsReceived=multicastsReceived, vendorName=vendorName, staticIpGateway=staticIpGateway, wan=wan, catvEnable=catvEnable, lanportIndex=lanportIndex, qos=qos, rebootEnable=rebootEnable, fileName=fileName, port2=port2, lanportTable=lanportTable, staticDns=staticDns, broadcastsTransmitted=broadcastsTransmitted, action=action, unicastsReceived=unicastsReceived)
