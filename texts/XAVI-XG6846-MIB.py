...
# Produced by pysmi-1.1.8 at Thu Jan  6 19:39:24 2022
...
NotificationType, snmpModules, mib_2, iso, Unsigned32, Counter64, ModuleIdentity, Counter32, enterprises, MibIdentifier, Bits, TimeTicks, Gauge32, ObjectIdentity, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "snmpModules", "mib-2", "iso", "Unsigned32", "Counter64", "ModuleIdentity", "Counter32", "enterprises", "MibIdentifier", "Bits", "TimeTicks", "Gauge32", "ObjectIdentity", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port1=port1, jumblan4=jumblan4, lan2=lan2, fcsErrorTransmitted=fcsErrorTransmitted, catvEnable=catvEnable, portStatEntry=portStatEntry, vlan=vlan, portName=portName, staticIpSecondaryDns=staticIpSecondaryDns, pauseTransmitted=pauseTransmitted, ddminfo=ddminfo, operStatus=operStatus, lanportTable=lanportTable, statIndex=statIndex, fileName=fileName, pauseReceived=pauseReceived, unicastsReceived=unicastsReceived, voltage=voltage, vlangroupTable=vlangroupTable, fcsErrorReceived=fcsErrorReceived, groupid=groupid, staticIpHostName=staticIpHostName, catv=catv, adminStatus=adminStatus, portStatistic=portStatistic, port2=port2, fileType=fileType, action=action, wan=wan, statisticTable=statisticTable, qmapping=qmapping, staticIpSubMask=staticIpSubMask, qosIndex=qosIndex, priority=priority, staticDns=staticDns, broadcastsTransmitted=broadcastsTransmitted, lanportName=lanportName, vendorOui=vendorOui, qosEntry=qosEntry, speed=speed, jumblan1=jumblan1, portmode=portmode, dscpEnable=dscpEnable, hostname=hostname, qosTable=qosTable, bias=bias, vendorPn=vendorPn, internetPort=internetPort, domainame=domainame, multicastsReceived=multicastsReceived, jumbwan=jumbwan, broadcastsReceived=broadcastsReceived, xg6846=xg6846, txPower=txPower, portTable=portTable, groupEntry=groupEntry, jumblan3=jumblan3, lan1=lan1, port4=port4, rebootEnable=rebootEnable, groupIndex=groupIndex, lan4=lan4, vendorName=vendorName, tftp=tftp, vlanid=vlanid, staticIpDomainName=staticIpDomainName, lanportIndex=lanportIndex, deviceinfo=deviceinfo, staticIpAddr=staticIpAddr, qmode=qmode, qos=qos, staticIpGateway=staticIpGateway, lanportpause=lanportpause, portIndex=portIndex, portEntry=portEntry, unicastsTransmitted=unicastsTransmitted, port3=port3, reboot=reboot, jumb=jumb, portPower=portPower, lan3=lan3, vendorRev=vendorRev, tftpSevIp=tftpSevIp, primaryDns=primaryDns, rxPower=rxPower, jumblan2=jumblan2, secondaryDns=secondaryDns, staticIpPrimaryDns=staticIpPrimaryDns, serialnum=serialnum, multicastsTransmitted=multicastsTransmitted, wanType=wanType, temperature=temperature, lanportspeed=lanportspeed, modeEntry=modeEntry)
