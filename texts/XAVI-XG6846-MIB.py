...
MibIdentifier, ModuleIdentity, NotificationType, Counter64, iso, snmpModules, IpAddress, ObjectIdentity, TimeTicks, Integer32, Gauge32, mib_2, Unsigned32, Bits, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "NotificationType", "Counter64", "iso", "snmpModules", "IpAddress", "ObjectIdentity", "TimeTicks", "Integer32", "Gauge32", "mib-2", "Unsigned32", "Bits", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catvEnable=catvEnable, vendorName=vendorName, lanportspeed=lanportspeed, groupid=groupid, ddminfo=ddminfo, jumbwan=jumbwan, jumblan4=jumblan4, wanType=wanType, groupIndex=groupIndex, portPower=portPower, unicastsTransmitted=unicastsTransmitted, vlanid=vlanid, staticIpPrimaryDns=staticIpPrimaryDns, temperature=temperature, rxPower=rxPower, vlan=vlan, voltage=voltage, hostname=hostname, statisticTable=statisticTable, portStatistic=portStatistic, unicastsReceived=unicastsReceived, fcsErrorReceived=fcsErrorReceived, tftp=tftp, lan1=lan1, jumblan2=jumblan2, secondaryDns=secondaryDns, catv=catv, staticIpSubMask=staticIpSubMask, staticIpGateway=staticIpGateway, deviceinfo=deviceinfo, jumb=jumb, tftpSevIp=tftpSevIp, staticIpSecondaryDns=staticIpSecondaryDns, broadcastsReceived=broadcastsReceived, port4=port4, vendorPn=vendorPn, lan4=lan4, port2=port2, staticDns=staticDns, priority=priority, staticIpHostName=staticIpHostName, speed=speed, lanportpause=lanportpause, multicastsTransmitted=multicastsTransmitted, lan2=lan2, adminStatus=adminStatus, fileType=fileType, xg6846=xg6846, lanportTable=lanportTable, dscpEnable=dscpEnable, qmapping=qmapping, txPower=txPower, portmode=portmode, internetPort=internetPort, portIndex=portIndex, vendorOui=vendorOui, qmode=qmode, serialnum=serialnum, action=action, primaryDns=primaryDns, vlangroupTable=vlangroupTable, statIndex=statIndex, lanportIndex=lanportIndex, reboot=reboot, jumblan3=jumblan3, qosIndex=qosIndex, broadcastsTransmitted=broadcastsTransmitted, portEntry=portEntry, domainame=domainame, portStatEntry=portStatEntry, fileName=fileName, portName=portName, staticIpDomainName=staticIpDomainName, wan=wan, portTable=portTable, modeEntry=modeEntry, operStatus=operStatus, staticIpAddr=staticIpAddr, lanportName=lanportName, qosTable=qosTable, groupEntry=groupEntry, multicastsReceived=multicastsReceived, port1=port1, lan3=lan3, pauseReceived=pauseReceived, jumblan1=jumblan1, vendorRev=vendorRev, rebootEnable=rebootEnable, bias=bias, qosEntry=qosEntry, fcsErrorTransmitted=fcsErrorTransmitted, qos=qos, port3=port3, pauseTransmitted=pauseTransmitted)
