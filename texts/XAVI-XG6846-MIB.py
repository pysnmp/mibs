...
ModuleIdentity, TimeTicks, snmpModules, mib_2, Bits, IpAddress, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, enterprises, NotificationType, Integer32, ObjectIdentity, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "snmpModules", "mib-2", "Bits", "IpAddress", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "enterprises", "NotificationType", "Integer32", "ObjectIdentity", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port4=port4, broadcastsReceived=broadcastsReceived, groupid=groupid, jumbwan=jumbwan, operStatus=operStatus, qos=qos, lanportTable=lanportTable, portPower=portPower, domainame=domainame, staticIpGateway=staticIpGateway, qosTable=qosTable, qosEntry=qosEntry, staticIpHostName=staticIpHostName, pauseTransmitted=pauseTransmitted, hostname=hostname, adminStatus=adminStatus, vlangroupTable=vlangroupTable, staticIpPrimaryDns=staticIpPrimaryDns, broadcastsTransmitted=broadcastsTransmitted, staticIpAddr=staticIpAddr, port2=port2, lan2=lan2, vendorName=vendorName, serialnum=serialnum, vlanid=vlanid, groupIndex=groupIndex, vendorRev=vendorRev, priority=priority, qosIndex=qosIndex, deviceinfo=deviceinfo, portTable=portTable, catv=catv, lan1=lan1, staticIpSecondaryDns=staticIpSecondaryDns, staticIpDomainName=staticIpDomainName, tftpSevIp=tftpSevIp, tftp=tftp, primaryDns=primaryDns, lanportName=lanportName, portIndex=portIndex, qmode=qmode, lanportpause=lanportpause, staticDns=staticDns, lan4=lan4, dscpEnable=dscpEnable, port1=port1, speed=speed, portEntry=portEntry, lanportIndex=lanportIndex, secondaryDns=secondaryDns, fileType=fileType, action=action, internetPort=internetPort, wanType=wanType, portStatistic=portStatistic, fileName=fileName, groupEntry=groupEntry, lan3=lan3, port3=port3, jumblan1=jumblan1, wan=wan, xg6846=xg6846, jumb=jumb, portName=portName, ddminfo=ddminfo, multicastsTransmitted=multicastsTransmitted, multicastsReceived=multicastsReceived, fcsErrorReceived=fcsErrorReceived, vendorPn=vendorPn, voltage=voltage, rxPower=rxPower, qmapping=qmapping, pauseReceived=pauseReceived, lanportspeed=lanportspeed, vlan=vlan, rebootEnable=rebootEnable, unicastsReceived=unicastsReceived, staticIpSubMask=staticIpSubMask, jumblan4=jumblan4, portStatEntry=portStatEntry, txPower=txPower, modeEntry=modeEntry, bias=bias, jumblan3=jumblan3, fcsErrorTransmitted=fcsErrorTransmitted, statIndex=statIndex, temperature=temperature, catvEnable=catvEnable, statisticTable=statisticTable, portmode=portmode, unicastsTransmitted=unicastsTransmitted, jumblan2=jumblan2, reboot=reboot, vendorOui=vendorOui)
