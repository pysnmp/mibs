...
# Produced by pysmi-1.1.8 at Tue Sep 12 07:28:29 2023
...
Counter32, mib_2, Integer32, MibIdentifier, NotificationType, snmpModules, IpAddress, Bits, TimeTicks, Unsigned32, ObjectIdentity, Gauge32, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "mib-2", "Integer32", "MibIdentifier", "NotificationType", "snmpModules", "IpAddress", "Bits", "TimeTicks", "Unsigned32", "ObjectIdentity", "Gauge32", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumblan2=jumblan2, voltage=voltage, bias=bias, speed=speed, port2=port2, jumbwan=jumbwan, staticIpDomainName=staticIpDomainName, secondaryDns=secondaryDns, statIndex=statIndex, port1=port1, xg6846=xg6846, portStatEntry=portStatEntry, staticIpSubMask=staticIpSubMask, jumblan3=jumblan3, lan2=lan2, lanportName=lanportName, multicastsTransmitted=multicastsTransmitted, catv=catv, lan4=lan4, fileType=fileType, pauseTransmitted=pauseTransmitted, lan3=lan3, staticIpSecondaryDns=staticIpSecondaryDns, fcsErrorTransmitted=fcsErrorTransmitted, vlangroupTable=vlangroupTable, fcsErrorReceived=fcsErrorReceived, deviceinfo=deviceinfo, lanportspeed=lanportspeed, action=action, jumblan1=jumblan1, unicastsReceived=unicastsReceived, portName=portName, vendorOui=vendorOui, tftpSevIp=tftpSevIp, groupid=groupid, primaryDns=primaryDns, internetPort=internetPort, catvEnable=catvEnable, priority=priority, portIndex=portIndex, modeEntry=modeEntry, port3=port3, vlan=vlan, groupIndex=groupIndex, pauseReceived=pauseReceived, adminStatus=adminStatus, staticIpHostName=staticIpHostName, port4=port4, wanType=wanType, tftp=tftp, qosTable=qosTable, portStatistic=portStatistic, multicastsReceived=multicastsReceived, portPower=portPower, jumb=jumb, qos=qos, statisticTable=statisticTable, domainame=domainame, qmapping=qmapping, qmode=qmode, serialnum=serialnum, operStatus=operStatus, portEntry=portEntry, rxPower=rxPower, rebootEnable=rebootEnable, dscpEnable=dscpEnable, temperature=temperature, vlanid=vlanid, vendorName=vendorName, staticIpPrimaryDns=staticIpPrimaryDns, vendorRev=vendorRev, groupEntry=groupEntry, jumblan4=jumblan4, lan1=lan1, lanportTable=lanportTable, lanportIndex=lanportIndex, vendorPn=vendorPn, ddminfo=ddminfo, qosIndex=qosIndex, broadcastsReceived=broadcastsReceived, wan=wan, portTable=portTable, lanportpause=lanportpause, staticIpGateway=staticIpGateway, staticDns=staticDns, qosEntry=qosEntry, fileName=fileName, unicastsTransmitted=unicastsTransmitted, reboot=reboot, staticIpAddr=staticIpAddr, portmode=portmode, txPower=txPower, broadcastsTransmitted=broadcastsTransmitted, hostname=hostname)
