...
# Produced by pysmi-1.1.10 at Mon Oct 30 02:20:32 2023
...
MibIdentifier, ObjectIdentity, snmpModules, enterprises, iso, NotificationType, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, TimeTicks, Gauge32, ModuleIdentity, IpAddress, Counter32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "snmpModules", "enterprises", "iso", "NotificationType", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "TimeTicks", "Gauge32", "ModuleIdentity", "IpAddress", "Counter32", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupid=groupid, staticDns=staticDns, qos=qos, bias=bias, staticIpPrimaryDns=staticIpPrimaryDns, adminStatus=adminStatus, staticIpDomainName=staticIpDomainName, port2=port2, lan2=lan2, qmode=qmode, catvEnable=catvEnable, portIndex=portIndex, fcsErrorReceived=fcsErrorReceived, wanType=wanType, vendorRev=vendorRev, vlangroupTable=vlangroupTable, qosIndex=qosIndex, fileType=fileType, vendorName=vendorName, groupEntry=groupEntry, port3=port3, lanportTable=lanportTable, lan1=lan1, vendorOui=vendorOui, speed=speed, port1=port1, jumblan3=jumblan3, dscpEnable=dscpEnable, lanportName=lanportName, portTable=portTable, multicastsReceived=multicastsReceived, primaryDns=primaryDns, jumblan2=jumblan2, pauseReceived=pauseReceived, portStatistic=portStatistic, modeEntry=modeEntry, priority=priority, portName=portName, vlanid=vlanid, xg6846=xg6846, vlan=vlan, qosTable=qosTable, portEntry=portEntry, portmode=portmode, ddminfo=ddminfo, rxPower=rxPower, unicastsTransmitted=unicastsTransmitted, secondaryDns=secondaryDns, internetPort=internetPort, lan3=lan3, staticIpGateway=staticIpGateway, catv=catv, tftp=tftp, staticIpAddr=staticIpAddr, staticIpSubMask=staticIpSubMask, jumblan1=jumblan1, port4=port4, lan4=lan4, multicastsTransmitted=multicastsTransmitted, temperature=temperature, pauseTransmitted=pauseTransmitted, action=action, tftpSevIp=tftpSevIp, qmapping=qmapping, portPower=portPower, jumb=jumb, lanportspeed=lanportspeed, domainame=domainame, rebootEnable=rebootEnable, broadcastsReceived=broadcastsReceived, serialnum=serialnum, reboot=reboot, operStatus=operStatus, vendorPn=vendorPn, jumbwan=jumbwan, qosEntry=qosEntry, voltage=voltage, portStatEntry=portStatEntry, unicastsReceived=unicastsReceived, broadcastsTransmitted=broadcastsTransmitted, fileName=fileName, lanportpause=lanportpause, wan=wan, lanportIndex=lanportIndex, statisticTable=statisticTable, deviceinfo=deviceinfo, txPower=txPower, statIndex=statIndex, hostname=hostname, staticIpHostName=staticIpHostName, staticIpSecondaryDns=staticIpSecondaryDns, jumblan4=jumblan4, groupIndex=groupIndex, fcsErrorTransmitted=fcsErrorTransmitted)
