...
ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, mib_2, Unsigned32, MibIdentifier, Integer32, iso, TimeTicks, Gauge32, NotificationType, snmpModules, IpAddress, ObjectIdentity, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "mib-2", "Unsigned32", "MibIdentifier", "Integer32", "iso", "TimeTicks", "Gauge32", "NotificationType", "snmpModules", "IpAddress", "ObjectIdentity", "Counter64", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan4=lan4, rebootEnable=rebootEnable, wan=wan, primaryDns=primaryDns, staticIpHostName=staticIpHostName, qosEntry=qosEntry, qosIndex=qosIndex, secondaryDns=secondaryDns, vendorRev=vendorRev, hostname=hostname, modeEntry=modeEntry, operStatus=operStatus, jumblan2=jumblan2, lanportIndex=lanportIndex, action=action, temperature=temperature, qos=qos, portName=portName, multicastsReceived=multicastsReceived, port1=port1, broadcastsTransmitted=broadcastsTransmitted, staticIpSubMask=staticIpSubMask, lanportTable=lanportTable, qmode=qmode, deviceinfo=deviceinfo, lan3=lan3, staticIpPrimaryDns=staticIpPrimaryDns, domainame=domainame, portTable=portTable, qmapping=qmapping, vlanid=vlanid, portEntry=portEntry, unicastsReceived=unicastsReceived, staticDns=staticDns, ddminfo=ddminfo, txPower=txPower, groupIndex=groupIndex, multicastsTransmitted=multicastsTransmitted, dscpEnable=dscpEnable, tftp=tftp, serialnum=serialnum, lanportspeed=lanportspeed, fcsErrorReceived=fcsErrorReceived, catv=catv, lanportpause=lanportpause, lanportName=lanportName, jumbwan=jumbwan, internetPort=internetPort, reboot=reboot, statisticTable=statisticTable, lan2=lan2, portmode=portmode, staticIpDomainName=staticIpDomainName, portPower=portPower, portIndex=portIndex, fcsErrorTransmitted=fcsErrorTransmitted, qosTable=qosTable, fileName=fileName, priority=priority, speed=speed, jumblan1=jumblan1, vlan=vlan, voltage=voltage, jumblan4=jumblan4, vendorOui=vendorOui, vendorName=vendorName, portStatistic=portStatistic, vendorPn=vendorPn, staticIpSecondaryDns=staticIpSecondaryDns, groupEntry=groupEntry, statIndex=statIndex, port2=port2, broadcastsReceived=broadcastsReceived, portStatEntry=portStatEntry, rxPower=rxPower, unicastsTransmitted=unicastsTransmitted, pauseReceived=pauseReceived, jumb=jumb, staticIpAddr=staticIpAddr, staticIpGateway=staticIpGateway, fileType=fileType, bias=bias, tftpSevIp=tftpSevIp, jumblan3=jumblan3, port3=port3, groupid=groupid, wanType=wanType, pauseTransmitted=pauseTransmitted, xg6846=xg6846, vlangroupTable=vlangroupTable, adminStatus=adminStatus, catvEnable=catvEnable, port4=port4, lan1=lan1)
