...
snmpModules, IpAddress, Gauge32, mib_2, Unsigned32, Bits, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, enterprises, Counter64, iso, TimeTicks, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "IpAddress", "Gauge32", "mib-2", "Unsigned32", "Bits", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "enterprises", "Counter64", "iso", "TimeTicks", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", tftpSevIp=tftpSevIp, secondaryDns=secondaryDns, reboot=reboot, rxPower=rxPower, internetPort=internetPort, jumbwan=jumbwan, lanportpause=lanportpause, temperature=temperature, statIndex=statIndex, hostname=hostname, staticIpSecondaryDns=staticIpSecondaryDns, port1=port1, port4=port4, primaryDns=primaryDns, jumblan1=jumblan1, pauseTransmitted=pauseTransmitted, fileType=fileType, lanportName=lanportName, lan2=lan2, pauseReceived=pauseReceived, ddminfo=ddminfo, speed=speed, portTable=portTable, qosTable=qosTable, statisticTable=statisticTable, port3=port3, wan=wan, bias=bias, modeEntry=modeEntry, staticDns=staticDns, unicastsReceived=unicastsReceived, vlangroupTable=vlangroupTable, serialnum=serialnum, groupIndex=groupIndex, portStatEntry=portStatEntry, rebootEnable=rebootEnable, operStatus=operStatus, vendorOui=vendorOui, portEntry=portEntry, xg6846=xg6846, unicastsTransmitted=unicastsTransmitted, vendorPn=vendorPn, staticIpSubMask=staticIpSubMask, staticIpPrimaryDns=staticIpPrimaryDns, txPower=txPower, multicastsTransmitted=multicastsTransmitted, lanportIndex=lanportIndex, portPower=portPower, lan3=lan3, voltage=voltage, broadcastsTransmitted=broadcastsTransmitted, dscpEnable=dscpEnable, qos=qos, multicastsReceived=multicastsReceived, broadcastsReceived=broadcastsReceived, catvEnable=catvEnable, qmode=qmode, lanportTable=lanportTable, groupEntry=groupEntry, action=action, qmapping=qmapping, fcsErrorTransmitted=fcsErrorTransmitted, jumblan4=jumblan4, fileName=fileName, fcsErrorReceived=fcsErrorReceived, staticIpHostName=staticIpHostName, port2=port2, vendorName=vendorName, qosEntry=qosEntry, portmode=portmode, domainame=domainame, jumblan2=jumblan2, lan1=lan1, vlan=vlan, staticIpGateway=staticIpGateway, wanType=wanType, portIndex=portIndex, tftp=tftp, priority=priority, lan4=lan4, catv=catv, portStatistic=portStatistic, deviceinfo=deviceinfo, adminStatus=adminStatus, jumb=jumb, jumblan3=jumblan3, staticIpDomainName=staticIpDomainName, vendorRev=vendorRev, qosIndex=qosIndex, portName=portName, groupid=groupid, lanportspeed=lanportspeed, staticIpAddr=staticIpAddr, vlanid=vlanid)
