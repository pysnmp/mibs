...
# Produced by pysmi-1.1.8 at Thu Jan 13 23:05:55 2022
...
TimeTicks, NotificationType, Integer32, enterprises, ObjectIdentity, Unsigned32, mib_2, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, Bits, snmpModules, Counter64, ModuleIdentity, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "Integer32", "enterprises", "ObjectIdentity", "Unsigned32", "mib-2", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "Bits", "snmpModules", "Counter64", "ModuleIdentity", "iso", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qosIndex=qosIndex, wan=wan, operStatus=operStatus, portEntry=portEntry, portName=portName, vlanid=vlanid, staticIpSecondaryDns=staticIpSecondaryDns, jumblan1=jumblan1, qmapping=qmapping, ddminfo=ddminfo, fcsErrorReceived=fcsErrorReceived, domainame=domainame, adminStatus=adminStatus, multicastsTransmitted=multicastsTransmitted, port4=port4, speed=speed, staticIpGateway=staticIpGateway, qmode=qmode, txPower=txPower, portStatEntry=portStatEntry, rebootEnable=rebootEnable, staticIpAddr=staticIpAddr, portmode=portmode, portIndex=portIndex, unicastsTransmitted=unicastsTransmitted, lan2=lan2, statisticTable=statisticTable, vlangroupTable=vlangroupTable, fileType=fileType, action=action, rxPower=rxPower, port3=port3, jumb=jumb, lan3=lan3, jumblan4=jumblan4, unicastsReceived=unicastsReceived, multicastsReceived=multicastsReceived, portPower=portPower, portTable=portTable, fcsErrorTransmitted=fcsErrorTransmitted, statIndex=statIndex, hostname=hostname, primaryDns=primaryDns, pauseTransmitted=pauseTransmitted, port1=port1, xg6846=xg6846, lanportIndex=lanportIndex, jumbwan=jumbwan, pauseReceived=pauseReceived, lanportName=lanportName, voltage=voltage, vlan=vlan, staticIpDomainName=staticIpDomainName, broadcastsReceived=broadcastsReceived, port2=port2, staticIpSubMask=staticIpSubMask, internetPort=internetPort, qosTable=qosTable, qosEntry=qosEntry, broadcastsTransmitted=broadcastsTransmitted, fileName=fileName, bias=bias, staticDns=staticDns, secondaryDns=secondaryDns, serialnum=serialnum, staticIpHostName=staticIpHostName, vendorName=vendorName, tftp=tftp, staticIpPrimaryDns=staticIpPrimaryDns, jumblan2=jumblan2, qos=qos, lan1=lan1, lanportpause=lanportpause, tftpSevIp=tftpSevIp, catvEnable=catvEnable, groupid=groupid, portStatistic=portStatistic, lanportspeed=lanportspeed, wanType=wanType, lan4=lan4, reboot=reboot, groupIndex=groupIndex, lanportTable=lanportTable, vendorRev=vendorRev, deviceinfo=deviceinfo, priority=priority, dscpEnable=dscpEnable, vendorOui=vendorOui, vendorPn=vendorPn, jumblan3=jumblan3, temperature=temperature, groupEntry=groupEntry, modeEntry=modeEntry, catv=catv)
