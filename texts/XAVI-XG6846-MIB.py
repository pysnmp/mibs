...
Integer32, Counter32, Counter64, Unsigned32, NotificationType, Bits, mib_2, ObjectIdentity, MibIdentifier, enterprises, ModuleIdentity, IpAddress, Gauge32, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Counter64", "Unsigned32", "NotificationType", "Bits", "mib-2", "ObjectIdentity", "MibIdentifier", "enterprises", "ModuleIdentity", "IpAddress", "Gauge32", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", serialnum=serialnum, deviceinfo=deviceinfo, lanportTable=lanportTable, vlangroupTable=vlangroupTable, rebootEnable=rebootEnable, jumblan2=jumblan2, unicastsTransmitted=unicastsTransmitted, catv=catv, bias=bias, staticIpSubMask=staticIpSubMask, lan1=lan1, staticIpDomainName=staticIpDomainName, pauseReceived=pauseReceived, xg6846=xg6846, lan3=lan3, portTable=portTable, statIndex=statIndex, vendorPn=vendorPn, multicastsTransmitted=multicastsTransmitted, groupEntry=groupEntry, fileType=fileType, vendorName=vendorName, staticDns=staticDns, portStatistic=portStatistic, pauseTransmitted=pauseTransmitted, vendorOui=vendorOui, wan=wan, lanportpause=lanportpause, qos=qos, rxPower=rxPower, adminStatus=adminStatus, priority=priority, tftpSevIp=tftpSevIp, fcsErrorReceived=fcsErrorReceived, qosIndex=qosIndex, lan4=lan4, hostname=hostname, lanportspeed=lanportspeed, statisticTable=statisticTable, portName=portName, jumblan3=jumblan3, broadcastsTransmitted=broadcastsTransmitted, qosTable=qosTable, qmode=qmode, temperature=temperature, staticIpGateway=staticIpGateway, lan2=lan2, broadcastsReceived=broadcastsReceived, ddminfo=ddminfo, wanType=wanType, speed=speed, jumb=jumb, fcsErrorTransmitted=fcsErrorTransmitted, qmapping=qmapping, secondaryDns=secondaryDns, groupid=groupid, staticIpPrimaryDns=staticIpPrimaryDns, portPower=portPower, port1=port1, unicastsReceived=unicastsReceived, lanportIndex=lanportIndex, port2=port2, vendorRev=vendorRev, portStatEntry=portStatEntry, jumblan1=jumblan1, multicastsReceived=multicastsReceived, internetPort=internetPort, catvEnable=catvEnable, modeEntry=modeEntry, portIndex=portIndex, staticIpAddr=staticIpAddr, portmode=portmode, reboot=reboot, port4=port4, voltage=voltage, operStatus=operStatus, vlanid=vlanid, lanportName=lanportName, qosEntry=qosEntry, staticIpHostName=staticIpHostName, txPower=txPower, fileName=fileName, jumblan4=jumblan4, primaryDns=primaryDns, vlan=vlan, staticIpSecondaryDns=staticIpSecondaryDns, domainame=domainame, action=action, groupIndex=groupIndex, tftp=tftp, portEntry=portEntry, port3=port3, dscpEnable=dscpEnable, jumbwan=jumbwan)
