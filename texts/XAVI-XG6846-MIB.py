...
# Produced by pysmi-1.1.8 at Wed Oct 11 10:10:32 2023
...
Bits, mib_2, Counter32, IpAddress, ObjectIdentity, ModuleIdentity, snmpModules, Counter64, Integer32, MibIdentifier, enterprises, NotificationType, Unsigned32, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "mib-2", "Counter32", "IpAddress", "ObjectIdentity", "ModuleIdentity", "snmpModules", "Counter64", "Integer32", "MibIdentifier", "enterprises", "NotificationType", "Unsigned32", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", dscpEnable=dscpEnable, qosIndex=qosIndex, portStatistic=portStatistic, operStatus=operStatus, portTable=portTable, vlanid=vlanid, qmode=qmode, portPower=portPower, vlangroupTable=vlangroupTable, priority=priority, groupIndex=groupIndex, jumblan3=jumblan3, staticIpSecondaryDns=staticIpSecondaryDns, lanportpause=lanportpause, rebootEnable=rebootEnable, lan2=lan2, action=action, catv=catv, staticIpSubMask=staticIpSubMask, groupid=groupid, jumb=jumb, lanportTable=lanportTable, tftpSevIp=tftpSevIp, vlan=vlan, statIndex=statIndex, lan1=lan1, adminStatus=adminStatus, staticIpPrimaryDns=staticIpPrimaryDns, voltage=voltage, fcsErrorReceived=fcsErrorReceived, lanportspeed=lanportspeed, staticIpHostName=staticIpHostName, portEntry=portEntry, modeEntry=modeEntry, wan=wan, tftp=tftp, hostname=hostname, staticIpAddr=staticIpAddr, staticIpGateway=staticIpGateway, broadcastsTransmitted=broadcastsTransmitted, qosEntry=qosEntry, jumblan2=jumblan2, portmode=portmode, portStatEntry=portStatEntry, wanType=wanType, fileType=fileType, vendorName=vendorName, jumblan1=jumblan1, temperature=temperature, domainame=domainame, fcsErrorTransmitted=fcsErrorTransmitted, vendorOui=vendorOui, multicastsTransmitted=multicastsTransmitted, staticIpDomainName=staticIpDomainName, qos=qos, statisticTable=statisticTable, catvEnable=catvEnable, jumblan4=jumblan4, deviceinfo=deviceinfo, lan3=lan3, lan4=lan4, staticDns=staticDns, port2=port2, port3=port3, portName=portName, xg6846=xg6846, lanportName=lanportName, fileName=fileName, lanportIndex=lanportIndex, portIndex=portIndex, speed=speed, rxPower=rxPower, primaryDns=primaryDns, qmapping=qmapping, qosTable=qosTable, groupEntry=groupEntry, unicastsReceived=unicastsReceived, serialnum=serialnum, jumbwan=jumbwan, pauseTransmitted=pauseTransmitted, ddminfo=ddminfo, bias=bias, unicastsTransmitted=unicastsTransmitted, multicastsReceived=multicastsReceived, port1=port1, vendorRev=vendorRev, internetPort=internetPort, vendorPn=vendorPn, broadcastsReceived=broadcastsReceived, reboot=reboot, txPower=txPower, secondaryDns=secondaryDns, pauseReceived=pauseReceived, port4=port4)
