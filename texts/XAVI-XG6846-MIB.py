...
TimeTicks, ModuleIdentity, iso, NotificationType, snmpModules, Bits, MibIdentifier, Counter64, mib_2, IpAddress, Integer32, Unsigned32, Gauge32, Counter32, enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "iso", "NotificationType", "snmpModules", "Bits", "MibIdentifier", "Counter64", "mib-2", "IpAddress", "Integer32", "Unsigned32", "Gauge32", "Counter32", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", secondaryDns=secondaryDns, qmapping=qmapping, qos=qos, txPower=txPower, lanportIndex=lanportIndex, portPower=portPower, port1=port1, staticIpDomainName=staticIpDomainName, operStatus=operStatus, port4=port4, lanportpause=lanportpause, vendorOui=vendorOui, xg6846=xg6846, fileType=fileType, groupIndex=groupIndex, portName=portName, rebootEnable=rebootEnable, unicastsTransmitted=unicastsTransmitted, dscpEnable=dscpEnable, portTable=portTable, primaryDns=primaryDns, qmode=qmode, statIndex=statIndex, port3=port3, ddminfo=ddminfo, portEntry=portEntry, speed=speed, pauseTransmitted=pauseTransmitted, fileName=fileName, lan2=lan2, tftpSevIp=tftpSevIp, jumblan4=jumblan4, qosTable=qosTable, lanportTable=lanportTable, domainame=domainame, staticIpGateway=staticIpGateway, qosEntry=qosEntry, lan3=lan3, rxPower=rxPower, action=action, catvEnable=catvEnable, groupid=groupid, lan4=lan4, qosIndex=qosIndex, hostname=hostname, portStatEntry=portStatEntry, jumbwan=jumbwan, statisticTable=statisticTable, catv=catv, deviceinfo=deviceinfo, pauseReceived=pauseReceived, wan=wan, portIndex=portIndex, broadcastsTransmitted=broadcastsTransmitted, voltage=voltage, lanportspeed=lanportspeed, multicastsReceived=multicastsReceived, vendorName=vendorName, internetPort=internetPort, fcsErrorTransmitted=fcsErrorTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, multicastsTransmitted=multicastsTransmitted, broadcastsReceived=broadcastsReceived, bias=bias, staticIpAddr=staticIpAddr, reboot=reboot, portStatistic=portStatistic, wanType=wanType, portmode=portmode, staticIpSubMask=staticIpSubMask, tftp=tftp, vendorPn=vendorPn, jumb=jumb, vlangroupTable=vlangroupTable, lanportName=lanportName, port2=port2, serialnum=serialnum, vlan=vlan, fcsErrorReceived=fcsErrorReceived, modeEntry=modeEntry, jumblan2=jumblan2, lan1=lan1, vendorRev=vendorRev, adminStatus=adminStatus, priority=priority, groupEntry=groupEntry, temperature=temperature, jumblan1=jumblan1, staticIpHostName=staticIpHostName, vlanid=vlanid, staticDns=staticDns, unicastsReceived=unicastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, jumblan3=jumblan3)
