...
NotificationType, IpAddress, ObjectIdentity, MibIdentifier, TimeTicks, snmpModules, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, Counter64, Counter32, ModuleIdentity, Gauge32, mib_2, Bits, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "ObjectIdentity", "MibIdentifier", "TimeTicks", "snmpModules", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "Counter64", "Counter32", "ModuleIdentity", "Gauge32", "mib-2", "Bits", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpSecondaryDns=staticIpSecondaryDns, staticIpDomainName=staticIpDomainName, portTable=portTable, jumblan2=jumblan2, lanportIndex=lanportIndex, modeEntry=modeEntry, catvEnable=catvEnable, lanportName=lanportName, portName=portName, fcsErrorTransmitted=fcsErrorTransmitted, jumblan1=jumblan1, fileType=fileType, lan3=lan3, qosEntry=qosEntry, staticIpHostName=staticIpHostName, portmode=portmode, vendorPn=vendorPn, jumb=jumb, jumbwan=jumbwan, vlan=vlan, port1=port1, lan2=lan2, lanportspeed=lanportspeed, port4=port4, operStatus=operStatus, jumblan3=jumblan3, speed=speed, statIndex=statIndex, hostname=hostname, unicastsReceived=unicastsReceived, multicastsTransmitted=multicastsTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, vendorRev=vendorRev, vlanid=vlanid, statisticTable=statisticTable, qosIndex=qosIndex, multicastsReceived=multicastsReceived, txPower=txPower, pauseReceived=pauseReceived, reboot=reboot, qmapping=qmapping, vendorOui=vendorOui, groupIndex=groupIndex, groupid=groupid, secondaryDns=secondaryDns, broadcastsReceived=broadcastsReceived, rebootEnable=rebootEnable, temperature=temperature, staticIpSubMask=staticIpSubMask, qos=qos, portEntry=portEntry, staticIpAddr=staticIpAddr, bias=bias, voltage=voltage, portIndex=portIndex, unicastsTransmitted=unicastsTransmitted, fcsErrorReceived=fcsErrorReceived, ddminfo=ddminfo, qmode=qmode, vlangroupTable=vlangroupTable, lan4=lan4, port3=port3, vendorName=vendorName, fileName=fileName, deviceinfo=deviceinfo, tftpSevIp=tftpSevIp, domainame=domainame, staticIpGateway=staticIpGateway, action=action, lanportpause=lanportpause, pauseTransmitted=pauseTransmitted, serialnum=serialnum, dscpEnable=dscpEnable, wanType=wanType, port2=port2, qosTable=qosTable, catv=catv, portStatistic=portStatistic, tftp=tftp, lanportTable=lanportTable, rxPower=rxPower, wan=wan, xg6846=xg6846, lan1=lan1, primaryDns=primaryDns, jumblan4=jumblan4, priority=priority, staticDns=staticDns, adminStatus=adminStatus, internetPort=internetPort, portStatEntry=portStatEntry, broadcastsTransmitted=broadcastsTransmitted, portPower=portPower, groupEntry=groupEntry)
