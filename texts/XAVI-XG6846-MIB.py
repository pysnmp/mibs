...
snmpModules, NotificationType, Bits, Unsigned32, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, IpAddress, iso, Counter64, enterprises, Counter32, mib_2, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "NotificationType", "Bits", "Unsigned32", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "IpAddress", "iso", "Counter64", "enterprises", "Counter32", "mib-2", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticDns=staticDns, staticIpPrimaryDns=staticIpPrimaryDns, portPower=portPower, jumblan3=jumblan3, tftp=tftp, lanportName=lanportName, bias=bias, temperature=temperature, statIndex=statIndex, staticIpSubMask=staticIpSubMask, qosIndex=qosIndex, dscpEnable=dscpEnable, groupEntry=groupEntry, groupid=groupid, hostname=hostname, vendorName=vendorName, port3=port3, modeEntry=modeEntry, portStatEntry=portStatEntry, fileName=fileName, unicastsTransmitted=unicastsTransmitted, catv=catv, lan1=lan1, portEntry=portEntry, reboot=reboot, portmode=portmode, internetPort=internetPort, portIndex=portIndex, broadcastsReceived=broadcastsReceived, jumb=jumb, portName=portName, wanType=wanType, lanportIndex=lanportIndex, lan4=lan4, port1=port1, vlangroupTable=vlangroupTable, lan3=lan3, port2=port2, adminStatus=adminStatus, port4=port4, staticIpAddr=staticIpAddr, speed=speed, jumblan2=jumblan2, vendorOui=vendorOui, qosTable=qosTable, qos=qos, groupIndex=groupIndex, multicastsReceived=multicastsReceived, qmapping=qmapping, staticIpHostName=staticIpHostName, txPower=txPower, statisticTable=statisticTable, action=action, tftpSevIp=tftpSevIp, ddminfo=ddminfo, rxPower=rxPower, portStatistic=portStatistic, unicastsReceived=unicastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, vendorRev=vendorRev, serialnum=serialnum, catvEnable=catvEnable, deviceinfo=deviceinfo, secondaryDns=secondaryDns, vlan=vlan, staticIpDomainName=staticIpDomainName, rebootEnable=rebootEnable, domainame=domainame, priority=priority, portTable=portTable, multicastsTransmitted=multicastsTransmitted, staticIpGateway=staticIpGateway, lanportpause=lanportpause, pauseTransmitted=pauseTransmitted, voltage=voltage, broadcastsTransmitted=broadcastsTransmitted, jumblan4=jumblan4, lanportspeed=lanportspeed, operStatus=operStatus, fileType=fileType, primaryDns=primaryDns, staticIpSecondaryDns=staticIpSecondaryDns, wan=wan, fcsErrorReceived=fcsErrorReceived, pauseReceived=pauseReceived, vendorPn=vendorPn, qmode=qmode, qosEntry=qosEntry, jumblan1=jumblan1, lanportTable=lanportTable, xg6846=xg6846, jumbwan=jumbwan, lan2=lan2, vlanid=vlanid)
