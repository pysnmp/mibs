...
Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, snmpModules, mib_2, Counter32, IpAddress, Integer32, Counter64, ObjectIdentity, MibIdentifier, Bits, NotificationType, iso, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "snmpModules", "mib-2", "Counter32", "IpAddress", "Integer32", "Counter64", "ObjectIdentity", "MibIdentifier", "Bits", "NotificationType", "iso", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", hostname=hostname, portName=portName, qosIndex=qosIndex, jumblan1=jumblan1, port2=port2, jumblan3=jumblan3, fileType=fileType, port3=port3, lanportspeed=lanportspeed, action=action, unicastsTransmitted=unicastsTransmitted, jumb=jumb, staticIpPrimaryDns=staticIpPrimaryDns, dscpEnable=dscpEnable, lanportpause=lanportpause, groupEntry=groupEntry, domainame=domainame, priority=priority, staticIpAddr=staticIpAddr, portStatEntry=portStatEntry, vendorOui=vendorOui, voltage=voltage, statIndex=statIndex, vendorRev=vendorRev, ddminfo=ddminfo, bias=bias, fcsErrorReceived=fcsErrorReceived, vlan=vlan, reboot=reboot, staticIpSubMask=staticIpSubMask, portStatistic=portStatistic, tftp=tftp, qmapping=qmapping, portTable=portTable, jumblan4=jumblan4, lan2=lan2, rebootEnable=rebootEnable, wan=wan, catv=catv, broadcastsReceived=broadcastsReceived, staticIpGateway=staticIpGateway, rxPower=rxPower, qosTable=qosTable, modeEntry=modeEntry, portEntry=portEntry, qos=qos, port1=port1, temperature=temperature, lan4=lan4, qmode=qmode, jumbwan=jumbwan, statisticTable=statisticTable, wanType=wanType, tftpSevIp=tftpSevIp, portPower=portPower, lanportTable=lanportTable, lan1=lan1, staticIpSecondaryDns=staticIpSecondaryDns, vlangroupTable=vlangroupTable, pauseReceived=pauseReceived, serialnum=serialnum, portIndex=portIndex, staticIpDomainName=staticIpDomainName, vlanid=vlanid, lanportIndex=lanportIndex, deviceinfo=deviceinfo, qosEntry=qosEntry, vendorName=vendorName, catvEnable=catvEnable, adminStatus=adminStatus, groupid=groupid, jumblan2=jumblan2, multicastsTransmitted=multicastsTransmitted, staticIpHostName=staticIpHostName, broadcastsTransmitted=broadcastsTransmitted, vendorPn=vendorPn, fcsErrorTransmitted=fcsErrorTransmitted, speed=speed, lan3=lan3, primaryDns=primaryDns, xg6846=xg6846, txPower=txPower, groupIndex=groupIndex, staticDns=staticDns, fileName=fileName, secondaryDns=secondaryDns, portmode=portmode, internetPort=internetPort, unicastsReceived=unicastsReceived, multicastsReceived=multicastsReceived, lanportName=lanportName, operStatus=operStatus, pauseTransmitted=pauseTransmitted, port4=port4)
