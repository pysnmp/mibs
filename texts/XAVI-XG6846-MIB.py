...
# Produced by pysmi-1.1.8 at Thu Sep  7 13:29:29 2023
...
mib_2, Integer32, NotificationType, enterprises, Bits, ModuleIdentity, ObjectIdentity, Counter64, snmpModules, Counter32, MibIdentifier, TimeTicks, Unsigned32, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Integer32", "NotificationType", "enterprises", "Bits", "ModuleIdentity", "ObjectIdentity", "Counter64", "snmpModules", "Counter32", "MibIdentifier", "TimeTicks", "Unsigned32", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port1=port1, fcsErrorReceived=fcsErrorReceived, rxPower=rxPower, statIndex=statIndex, lanportIndex=lanportIndex, reboot=reboot, portName=portName, portTable=portTable, groupid=groupid, tftp=tftp, action=action, serialnum=serialnum, adminStatus=adminStatus, staticIpSecondaryDns=staticIpSecondaryDns, portStatistic=portStatistic, portStatEntry=portStatEntry, voltage=voltage, portEntry=portEntry, vlan=vlan, lanportTable=lanportTable, vendorRev=vendorRev, vendorOui=vendorOui, lanportpause=lanportpause, jumblan2=jumblan2, vlanid=vlanid, lan2=lan2, vendorName=vendorName, lanportspeed=lanportspeed, broadcastsReceived=broadcastsReceived, portPower=portPower, wanType=wanType, broadcastsTransmitted=broadcastsTransmitted, pauseTransmitted=pauseTransmitted, primaryDns=primaryDns, qmapping=qmapping, dscpEnable=dscpEnable, port3=port3, fileType=fileType, vlangroupTable=vlangroupTable, deviceinfo=deviceinfo, domainame=domainame, internetPort=internetPort, bias=bias, staticDns=staticDns, rebootEnable=rebootEnable, pauseReceived=pauseReceived, catv=catv, unicastsTransmitted=unicastsTransmitted, modeEntry=modeEntry, qmode=qmode, wan=wan, staticIpGateway=staticIpGateway, xg6846=xg6846, temperature=temperature, groupEntry=groupEntry, port2=port2, fcsErrorTransmitted=fcsErrorTransmitted, catvEnable=catvEnable, txPower=txPower, lan1=lan1, secondaryDns=secondaryDns, staticIpHostName=staticIpHostName, staticIpPrimaryDns=staticIpPrimaryDns, port4=port4, speed=speed, ddminfo=ddminfo, multicastsTransmitted=multicastsTransmitted, staticIpAddr=staticIpAddr, jumb=jumb, qosTable=qosTable, groupIndex=groupIndex, portIndex=portIndex, lan4=lan4, portmode=portmode, lan3=lan3, staticIpDomainName=staticIpDomainName, fileName=fileName, tftpSevIp=tftpSevIp, qosIndex=qosIndex, jumblan3=jumblan3, jumblan4=jumblan4, statisticTable=statisticTable, staticIpSubMask=staticIpSubMask, operStatus=operStatus, jumblan1=jumblan1, lanportName=lanportName, priority=priority, qos=qos, vendorPn=vendorPn, jumbwan=jumbwan, hostname=hostname, unicastsReceived=unicastsReceived, multicastsReceived=multicastsReceived, qosEntry=qosEntry)
