...
ObjectIdentity, Bits, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, NotificationType, Counter64, enterprises, Gauge32, Counter32, Integer32, snmpModules, Unsigned32, ModuleIdentity, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "NotificationType", "Counter64", "enterprises", "Gauge32", "Counter32", "Integer32", "snmpModules", "Unsigned32", "ModuleIdentity", "iso", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fileName=fileName, dscpEnable=dscpEnable, vlan=vlan, port1=port1, portTable=portTable, primaryDns=primaryDns, lanportTable=lanportTable, staticIpPrimaryDns=staticIpPrimaryDns, staticIpAddr=staticIpAddr, port4=port4, lanportpause=lanportpause, deviceinfo=deviceinfo, tftpSevIp=tftpSevIp, vendorOui=vendorOui, voltage=voltage, staticIpDomainName=staticIpDomainName, statisticTable=statisticTable, fcsErrorTransmitted=fcsErrorTransmitted, vlangroupTable=vlangroupTable, portStatEntry=portStatEntry, bias=bias, jumbwan=jumbwan, serialnum=serialnum, catv=catv, jumblan1=jumblan1, multicastsTransmitted=multicastsTransmitted, portmode=portmode, lan4=lan4, rebootEnable=rebootEnable, lanportIndex=lanportIndex, qmapping=qmapping, wan=wan, txPower=txPower, hostname=hostname, xg6846=xg6846, broadcastsTransmitted=broadcastsTransmitted, pauseTransmitted=pauseTransmitted, portIndex=portIndex, groupid=groupid, lan2=lan2, jumblan2=jumblan2, fileType=fileType, internetPort=internetPort, statIndex=statIndex, staticIpGateway=staticIpGateway, qosEntry=qosEntry, qmode=qmode, operStatus=operStatus, staticIpHostName=staticIpHostName, jumblan3=jumblan3, vlanid=vlanid, unicastsTransmitted=unicastsTransmitted, action=action, qosTable=qosTable, speed=speed, pauseReceived=pauseReceived, lan3=lan3, secondaryDns=secondaryDns, temperature=temperature, portName=portName, fcsErrorReceived=fcsErrorReceived, port2=port2, adminStatus=adminStatus, groupIndex=groupIndex, broadcastsReceived=broadcastsReceived, vendorPn=vendorPn, staticIpSubMask=staticIpSubMask, tftp=tftp, multicastsReceived=multicastsReceived, domainame=domainame, lanportspeed=lanportspeed, staticIpSecondaryDns=staticIpSecondaryDns, vendorRev=vendorRev, wanType=wanType, ddminfo=ddminfo, catvEnable=catvEnable, unicastsReceived=unicastsReceived, portStatistic=portStatistic, reboot=reboot, rxPower=rxPower, groupEntry=groupEntry, qosIndex=qosIndex, jumb=jumb, lan1=lan1, vendorName=vendorName, staticDns=staticDns, lanportName=lanportName, jumblan4=jumblan4, qos=qos, port3=port3, portEntry=portEntry, portPower=portPower, modeEntry=modeEntry, priority=priority)
