...
Counter32, NotificationType, IpAddress, snmpModules, ModuleIdentity, iso, Bits, mib_2, Integer32, Unsigned32, Counter64, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "IpAddress", "snmpModules", "ModuleIdentity", "iso", "Bits", "mib-2", "Integer32", "Unsigned32", "Counter64", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port4=port4, qosIndex=qosIndex, deviceinfo=deviceinfo, broadcastsTransmitted=broadcastsTransmitted, staticIpDomainName=staticIpDomainName, jumblan4=jumblan4, portIndex=portIndex, portStatEntry=portStatEntry, qosTable=qosTable, qosEntry=qosEntry, primaryDns=primaryDns, catv=catv, catvEnable=catvEnable, port2=port2, pauseReceived=pauseReceived, staticIpGateway=staticIpGateway, xg6846=xg6846, jumb=jumb, txPower=txPower, dscpEnable=dscpEnable, groupIndex=groupIndex, vlanid=vlanid, statisticTable=statisticTable, lanportIndex=lanportIndex, fcsErrorReceived=fcsErrorReceived, portTable=portTable, jumblan3=jumblan3, groupEntry=groupEntry, multicastsReceived=multicastsReceived, lan3=lan3, portmode=portmode, unicastsReceived=unicastsReceived, multicastsTransmitted=multicastsTransmitted, wan=wan, reboot=reboot, vendorPn=vendorPn, statIndex=statIndex, fileName=fileName, action=action, wanType=wanType, speed=speed, jumbwan=jumbwan, portPower=portPower, fcsErrorTransmitted=fcsErrorTransmitted, port3=port3, staticIpAddr=staticIpAddr, modeEntry=modeEntry, internetPort=internetPort, tftpSevIp=tftpSevIp, lanportpause=lanportpause, lanportspeed=lanportspeed, jumblan2=jumblan2, lan1=lan1, staticIpSubMask=staticIpSubMask, qmapping=qmapping, serialnum=serialnum, staticDns=staticDns, lanportTable=lanportTable, broadcastsReceived=broadcastsReceived, tftp=tftp, operStatus=operStatus, jumblan1=jumblan1, temperature=temperature, qos=qos, portName=portName, voltage=voltage, priority=priority, pauseTransmitted=pauseTransmitted, lan2=lan2, fileType=fileType, portEntry=portEntry, adminStatus=adminStatus, domainame=domainame, port1=port1, rxPower=rxPower, vlan=vlan, staticIpHostName=staticIpHostName, vendorRev=vendorRev, staticIpSecondaryDns=staticIpSecondaryDns, vlangroupTable=vlangroupTable, staticIpPrimaryDns=staticIpPrimaryDns, lan4=lan4, rebootEnable=rebootEnable, qmode=qmode, ddminfo=ddminfo, unicastsTransmitted=unicastsTransmitted, vendorOui=vendorOui, bias=bias, hostname=hostname, groupid=groupid, vendorName=vendorName, secondaryDns=secondaryDns, lanportName=lanportName, portStatistic=portStatistic)
