...
# Produced by pysmi-1.1.12 at Fri Jul 19 09:38:06 2024
...
mib_2, Bits, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, enterprises, Unsigned32, iso, Integer32, ObjectIdentity, TimeTicks, ModuleIdentity, Gauge32, Counter32, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Bits", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "enterprises", "Unsigned32", "iso", "Integer32", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "Gauge32", "Counter32", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", txPower=txPower, secondaryDns=secondaryDns, hostname=hostname, qosTable=qosTable, primaryDns=primaryDns, qmapping=qmapping, staticIpAddr=staticIpAddr, groupEntry=groupEntry, jumb=jumb, tftpSevIp=tftpSevIp, port3=port3, portTable=portTable, tftp=tftp, fcsErrorTransmitted=fcsErrorTransmitted, rebootEnable=rebootEnable, dscpEnable=dscpEnable, portPower=portPower, broadcastsTransmitted=broadcastsTransmitted, modeEntry=modeEntry, vendorRev=vendorRev, jumblan1=jumblan1, voltage=voltage, fileType=fileType, staticIpSecondaryDns=staticIpSecondaryDns, multicastsTransmitted=multicastsTransmitted, qos=qos, qosEntry=qosEntry, lanportspeed=lanportspeed, qosIndex=qosIndex, lanportpause=lanportpause, lanportTable=lanportTable, port1=port1, wanType=wanType, bias=bias, portmode=portmode, lanportName=lanportName, portEntry=portEntry, jumblan3=jumblan3, priority=priority, vendorOui=vendorOui, jumblan2=jumblan2, speed=speed, fcsErrorReceived=fcsErrorReceived, port4=port4, lan4=lan4, reboot=reboot, unicastsTransmitted=unicastsTransmitted, fileName=fileName, qmode=qmode, lan3=lan3, xg6846=xg6846, vendorPn=vendorPn, portStatEntry=portStatEntry, staticIpDomainName=staticIpDomainName, action=action, staticIpSubMask=staticIpSubMask, staticIpHostName=staticIpHostName, jumblan4=jumblan4, multicastsReceived=multicastsReceived, catvEnable=catvEnable, portName=portName, vendorName=vendorName, lanportIndex=lanportIndex, staticIpGateway=staticIpGateway, rxPower=rxPower, pauseTransmitted=pauseTransmitted, adminStatus=adminStatus, portIndex=portIndex, temperature=temperature, wan=wan, lan1=lan1, pauseReceived=pauseReceived, vlangroupTable=vlangroupTable, domainame=domainame, operStatus=operStatus, catv=catv, statisticTable=statisticTable, lan2=lan2, port2=port2, groupIndex=groupIndex, statIndex=statIndex, groupid=groupid, portStatistic=portStatistic, deviceinfo=deviceinfo, staticIpPrimaryDns=staticIpPrimaryDns, vlan=vlan, ddminfo=ddminfo, staticDns=staticDns, broadcastsReceived=broadcastsReceived, jumbwan=jumbwan, internetPort=internetPort, vlanid=vlanid, serialnum=serialnum, unicastsReceived=unicastsReceived)
