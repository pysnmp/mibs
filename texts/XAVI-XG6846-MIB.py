...
# Produced by pysmi-1.1.8 at Thu Apr 27 11:36:29 2023
...
iso, IpAddress, TimeTicks, Integer32, snmpModules, ObjectIdentity, ModuleIdentity, enterprises, Counter64, MibIdentifier, mib_2, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "TimeTicks", "Integer32", "snmpModules", "ObjectIdentity", "ModuleIdentity", "enterprises", "Counter64", "MibIdentifier", "mib-2", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpSecondaryDns=staticIpSecondaryDns, statisticTable=statisticTable, pauseReceived=pauseReceived, catvEnable=catvEnable, portName=portName, portPower=portPower, staticIpDomainName=staticIpDomainName, multicastsReceived=multicastsReceived, speed=speed, pauseTransmitted=pauseTransmitted, jumblan3=jumblan3, lan2=lan2, catv=catv, reboot=reboot, staticIpAddr=staticIpAddr, lanportIndex=lanportIndex, hostname=hostname, rxPower=rxPower, portTable=portTable, portStatistic=portStatistic, dscpEnable=dscpEnable, statIndex=statIndex, jumblan4=jumblan4, staticIpPrimaryDns=staticIpPrimaryDns, lan1=lan1, vendorName=vendorName, tftpSevIp=tftpSevIp, qmode=qmode, groupIndex=groupIndex, bias=bias, qosEntry=qosEntry, deviceinfo=deviceinfo, modeEntry=modeEntry, qmapping=qmapping, jumblan2=jumblan2, qosIndex=qosIndex, tftp=tftp, temperature=temperature, lan4=lan4, portStatEntry=portStatEntry, voltage=voltage, ddminfo=ddminfo, unicastsTransmitted=unicastsTransmitted, operStatus=operStatus, action=action, unicastsReceived=unicastsReceived, lanportspeed=lanportspeed, staticDns=staticDns, qosTable=qosTable, staticIpHostName=staticIpHostName, lan3=lan3, primaryDns=primaryDns, broadcastsReceived=broadcastsReceived, jumblan1=jumblan1, fileName=fileName, port2=port2, qos=qos, jumbwan=jumbwan, multicastsTransmitted=multicastsTransmitted, xg6846=xg6846, portIndex=portIndex, vlan=vlan, port4=port4, fcsErrorTransmitted=fcsErrorTransmitted, rebootEnable=rebootEnable, fcsErrorReceived=fcsErrorReceived, priority=priority, domainame=domainame, portmode=portmode, port1=port1, fileType=fileType, lanportTable=lanportTable, staticIpGateway=staticIpGateway, vlangroupTable=vlangroupTable, secondaryDns=secondaryDns, groupid=groupid, staticIpSubMask=staticIpSubMask, wanType=wanType, groupEntry=groupEntry, broadcastsTransmitted=broadcastsTransmitted, vendorOui=vendorOui, port3=port3, lanportName=lanportName, vendorRev=vendorRev, internetPort=internetPort, jumb=jumb, lanportpause=lanportpause, adminStatus=adminStatus, vendorPn=vendorPn, wan=wan, vlanid=vlanid, txPower=txPower, portEntry=portEntry, serialnum=serialnum)
