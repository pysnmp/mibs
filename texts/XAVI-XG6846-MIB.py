...
# Produced by pysmi-1.1.8 at Tue Aug  9 15:17:44 2022
...
TimeTicks, Counter32, ModuleIdentity, snmpModules, MibIdentifier, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, mib_2, Counter64, ObjectIdentity, Integer32, Unsigned32, iso, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "ModuleIdentity", "snmpModules", "MibIdentifier", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "mib-2", "Counter64", "ObjectIdentity", "Integer32", "Unsigned32", "iso", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", domainame=domainame, port1=port1, vendorName=vendorName, staticIpGateway=staticIpGateway, staticIpHostName=staticIpHostName, priority=priority, portIndex=portIndex, portStatistic=portStatistic, catvEnable=catvEnable, jumblan4=jumblan4, lan1=lan1, portTable=portTable, port2=port2, staticIpAddr=staticIpAddr, operStatus=operStatus, lan2=lan2, dscpEnable=dscpEnable, port3=port3, vendorOui=vendorOui, staticDns=staticDns, vendorRev=vendorRev, jumb=jumb, portEntry=portEntry, vlanid=vlanid, serialnum=serialnum, qos=qos, fcsErrorReceived=fcsErrorReceived, lan4=lan4, groupEntry=groupEntry, internetPort=internetPort, qosEntry=qosEntry, unicastsTransmitted=unicastsTransmitted, wanType=wanType, voltage=voltage, jumblan1=jumblan1, staticIpDomainName=staticIpDomainName, pauseReceived=pauseReceived, lanportTable=lanportTable, broadcastsTransmitted=broadcastsTransmitted, ddminfo=ddminfo, statisticTable=statisticTable, qosIndex=qosIndex, deviceinfo=deviceinfo, lanportIndex=lanportIndex, fileName=fileName, hostname=hostname, groupid=groupid, broadcastsReceived=broadcastsReceived, port4=port4, groupIndex=groupIndex, jumblan3=jumblan3, fileType=fileType, txPower=txPower, unicastsReceived=unicastsReceived, lanportspeed=lanportspeed, staticIpSecondaryDns=staticIpSecondaryDns, multicastsTransmitted=multicastsTransmitted, bias=bias, jumblan2=jumblan2, lanportName=lanportName, secondaryDns=secondaryDns, multicastsReceived=multicastsReceived, reboot=reboot, portStatEntry=portStatEntry, qmapping=qmapping, portName=portName, pauseTransmitted=pauseTransmitted, rxPower=rxPower, xg6846=xg6846, speed=speed, jumbwan=jumbwan, staticIpPrimaryDns=staticIpPrimaryDns, vlangroupTable=vlangroupTable, rebootEnable=rebootEnable, lan3=lan3, qosTable=qosTable, action=action, portmode=portmode, fcsErrorTransmitted=fcsErrorTransmitted, staticIpSubMask=staticIpSubMask, adminStatus=adminStatus, qmode=qmode, modeEntry=modeEntry, vlan=vlan, primaryDns=primaryDns, portPower=portPower, tftp=tftp, wan=wan, catv=catv, lanportpause=lanportpause, statIndex=statIndex, vendorPn=vendorPn, tftpSevIp=tftpSevIp, temperature=temperature)
