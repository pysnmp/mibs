...
NotificationType, TimeTicks, Integer32, Unsigned32, ModuleIdentity, Gauge32, Counter32, enterprises, mib_2, Counter64, MibIdentifier, Bits, ObjectIdentity, IpAddress, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Integer32", "Unsigned32", "ModuleIdentity", "Gauge32", "Counter32", "enterprises", "mib-2", "Counter64", "MibIdentifier", "Bits", "ObjectIdentity", "IpAddress", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", secondaryDns=secondaryDns, vlan=vlan, unicastsReceived=unicastsReceived, lan4=lan4, fcsErrorReceived=fcsErrorReceived, jumblan3=jumblan3, reboot=reboot, port4=port4, vlangroupTable=vlangroupTable, broadcastsReceived=broadcastsReceived, fileName=fileName, catv=catv, lanportTable=lanportTable, qosEntry=qosEntry, portmode=portmode, action=action, multicastsReceived=multicastsReceived, portEntry=portEntry, qosTable=qosTable, primaryDns=primaryDns, vlanid=vlanid, staticDns=staticDns, fcsErrorTransmitted=fcsErrorTransmitted, qos=qos, qosIndex=qosIndex, vendorPn=vendorPn, tftp=tftp, priority=priority, qmapping=qmapping, lan3=lan3, statIndex=statIndex, vendorName=vendorName, temperature=temperature, groupIndex=groupIndex, multicastsTransmitted=multicastsTransmitted, internetPort=internetPort, groupid=groupid, port2=port2, broadcastsTransmitted=broadcastsTransmitted, staticIpGateway=staticIpGateway, groupEntry=groupEntry, hostname=hostname, vendorOui=vendorOui, lanportspeed=lanportspeed, ddminfo=ddminfo, portStatEntry=portStatEntry, operStatus=operStatus, bias=bias, port3=port3, jumb=jumb, staticIpAddr=staticIpAddr, jumbwan=jumbwan, jumblan4=jumblan4, portTable=portTable, portIndex=portIndex, wanType=wanType, staticIpSecondaryDns=staticIpSecondaryDns, pauseTransmitted=pauseTransmitted, fileType=fileType, lanportName=lanportName, portStatistic=portStatistic, modeEntry=modeEntry, portName=portName, serialnum=serialnum, catvEnable=catvEnable, vendorRev=vendorRev, staticIpPrimaryDns=staticIpPrimaryDns, rxPower=rxPower, lanportpause=lanportpause, portPower=portPower, txPower=txPower, domainame=domainame, wan=wan, xg6846=xg6846, tftpSevIp=tftpSevIp, staticIpHostName=staticIpHostName, rebootEnable=rebootEnable, qmode=qmode, voltage=voltage, adminStatus=adminStatus, lan2=lan2, lanportIndex=lanportIndex, jumblan1=jumblan1, statisticTable=statisticTable, deviceinfo=deviceinfo, port1=port1, unicastsTransmitted=unicastsTransmitted, speed=speed, staticIpDomainName=staticIpDomainName, dscpEnable=dscpEnable, pauseReceived=pauseReceived, lan1=lan1, staticIpSubMask=staticIpSubMask, jumblan2=jumblan2)
