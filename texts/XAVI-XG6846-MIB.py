...
iso, NotificationType, snmpModules, ObjectIdentity, Counter64, IpAddress, Gauge32, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, mib_2, ModuleIdentity, Bits, enterprises, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "snmpModules", "ObjectIdentity", "Counter64", "IpAddress", "Gauge32", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "mib-2", "ModuleIdentity", "Bits", "enterprises", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupIndex=groupIndex, lanportName=lanportName, qos=qos, vlan=vlan, lan4=lan4, fileType=fileType, qmapping=qmapping, jumblan1=jumblan1, qosEntry=qosEntry, internetPort=internetPort, modeEntry=modeEntry, vendorPn=vendorPn, groupEntry=groupEntry, portStatEntry=portStatEntry, vendorRev=vendorRev, lanportspeed=lanportspeed, lanportpause=lanportpause, hostname=hostname, vlangroupTable=vlangroupTable, xg6846=xg6846, lanportIndex=lanportIndex, rebootEnable=rebootEnable, dscpEnable=dscpEnable, staticIpDomainName=staticIpDomainName, staticIpSubMask=staticIpSubMask, port3=port3, jumbwan=jumbwan, portStatistic=portStatistic, action=action, voltage=voltage, jumblan2=jumblan2, port1=port1, bias=bias, catv=catv, catvEnable=catvEnable, fileName=fileName, statisticTable=statisticTable, rxPower=rxPower, jumb=jumb, tftpSevIp=tftpSevIp, portEntry=portEntry, statIndex=statIndex, jumblan4=jumblan4, portTable=portTable, qmode=qmode, staticIpAddr=staticIpAddr, lanportTable=lanportTable, wan=wan, adminStatus=adminStatus, unicastsReceived=unicastsReceived, pauseReceived=pauseReceived, wanType=wanType, deviceinfo=deviceinfo, fcsErrorReceived=fcsErrorReceived, lan2=lan2, fcsErrorTransmitted=fcsErrorTransmitted, port2=port2, portName=portName, portIndex=portIndex, qosTable=qosTable, groupid=groupid, lan3=lan3, broadcastsTransmitted=broadcastsTransmitted, vendorName=vendorName, pauseTransmitted=pauseTransmitted, primaryDns=primaryDns, multicastsReceived=multicastsReceived, qosIndex=qosIndex, reboot=reboot, portPower=portPower, staticIpPrimaryDns=staticIpPrimaryDns, temperature=temperature, ddminfo=ddminfo, portmode=portmode, broadcastsReceived=broadcastsReceived, vlanid=vlanid, priority=priority, unicastsTransmitted=unicastsTransmitted, lan1=lan1, secondaryDns=secondaryDns, txPower=txPower, staticIpGateway=staticIpGateway, tftp=tftp, staticDns=staticDns, operStatus=operStatus, vendorOui=vendorOui, speed=speed, multicastsTransmitted=multicastsTransmitted, jumblan3=jumblan3, domainame=domainame, staticIpHostName=staticIpHostName, port4=port4, staticIpSecondaryDns=staticIpSecondaryDns, serialnum=serialnum)
