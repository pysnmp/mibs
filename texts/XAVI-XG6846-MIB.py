...
# Produced by pysmi-1.1.8 at Mon Jan  9 09:55:30 2023
...
Unsigned32, NotificationType, TimeTicks, Integer32, MibIdentifier, snmpModules, ModuleIdentity, enterprises, ObjectIdentity, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, Gauge32, Counter32, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "TimeTicks", "Integer32", "MibIdentifier", "snmpModules", "ModuleIdentity", "enterprises", "ObjectIdentity", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "Gauge32", "Counter32", "IpAddress", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qosIndex=qosIndex, staticIpAddr=staticIpAddr, qosTable=qosTable, lan1=lan1, speed=speed, vendorRev=vendorRev, portStatistic=portStatistic, qos=qos, fileName=fileName, port4=port4, pauseTransmitted=pauseTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, broadcastsReceived=broadcastsReceived, fileType=fileType, multicastsTransmitted=multicastsTransmitted, vlangroupTable=vlangroupTable, staticIpHostName=staticIpHostName, adminStatus=adminStatus, multicastsReceived=multicastsReceived, rxPower=rxPower, qmode=qmode, ddminfo=ddminfo, staticIpGateway=staticIpGateway, port1=port1, jumbwan=jumbwan, wanType=wanType, staticIpSecondaryDns=staticIpSecondaryDns, voltage=voltage, lan2=lan2, vendorOui=vendorOui, statisticTable=statisticTable, reboot=reboot, portmode=portmode, fcsErrorTransmitted=fcsErrorTransmitted, staticIpSubMask=staticIpSubMask, txPower=txPower, domainame=domainame, jumblan3=jumblan3, lanportTable=lanportTable, qosEntry=qosEntry, portTable=portTable, lanportIndex=lanportIndex, tftp=tftp, rebootEnable=rebootEnable, jumblan4=jumblan4, lanportName=lanportName, groupIndex=groupIndex, hostname=hostname, dscpEnable=dscpEnable, primaryDns=primaryDns, catvEnable=catvEnable, portIndex=portIndex, tftpSevIp=tftpSevIp, operStatus=operStatus, staticIpDomainName=staticIpDomainName, portEntry=portEntry, fcsErrorReceived=fcsErrorReceived, unicastsReceived=unicastsReceived, jumb=jumb, broadcastsTransmitted=broadcastsTransmitted, serialnum=serialnum, modeEntry=modeEntry, catv=catv, lanportspeed=lanportspeed, portStatEntry=portStatEntry, wan=wan, portName=portName, temperature=temperature, xg6846=xg6846, priority=priority, vendorPn=vendorPn, jumblan2=jumblan2, statIndex=statIndex, bias=bias, lan4=lan4, jumblan1=jumblan1, portPower=portPower, groupid=groupid, internetPort=internetPort, vendorName=vendorName, secondaryDns=secondaryDns, action=action, port3=port3, unicastsTransmitted=unicastsTransmitted, groupEntry=groupEntry, lanportpause=lanportpause, port2=port2, qmapping=qmapping, deviceinfo=deviceinfo, staticDns=staticDns, lan3=lan3, vlan=vlan, pauseReceived=pauseReceived, vlanid=vlanid)
