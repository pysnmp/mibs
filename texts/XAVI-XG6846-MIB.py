...
Counter32, Integer32, ModuleIdentity, enterprises, snmpModules, Counter64, Bits, ObjectIdentity, Unsigned32, mib_2, iso, TimeTicks, NotificationType, MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "ModuleIdentity", "enterprises", "snmpModules", "Counter64", "Bits", "ObjectIdentity", "Unsigned32", "mib-2", "iso", "TimeTicks", "NotificationType", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", rxPower=rxPower, txPower=txPower, statIndex=statIndex, wanType=wanType, portStatEntry=portStatEntry, qos=qos, staticIpGateway=staticIpGateway, qosIndex=qosIndex, operStatus=operStatus, qmode=qmode, multicastsReceived=multicastsReceived, port1=port1, catv=catv, vendorPn=vendorPn, voltage=voltage, dscpEnable=dscpEnable, port2=port2, rebootEnable=rebootEnable, adminStatus=adminStatus, priority=priority, portTable=portTable, qmapping=qmapping, staticIpHostName=staticIpHostName, wan=wan, jumblan3=jumblan3, broadcastsTransmitted=broadcastsTransmitted, lan1=lan1, vendorRev=vendorRev, vlanid=vlanid, broadcastsReceived=broadcastsReceived, unicastsReceived=unicastsReceived, jumblan4=jumblan4, internetPort=internetPort, staticIpAddr=staticIpAddr, jumblan2=jumblan2, ddminfo=ddminfo, vlan=vlan, multicastsTransmitted=multicastsTransmitted, lanportpause=lanportpause, portmode=portmode, unicastsTransmitted=unicastsTransmitted, port4=port4, modeEntry=modeEntry, portIndex=portIndex, lan4=lan4, lanportspeed=lanportspeed, staticIpDomainName=staticIpDomainName, groupid=groupid, jumb=jumb, lan3=lan3, portStatistic=portStatistic, lanportIndex=lanportIndex, lan2=lan2, qosTable=qosTable, tftp=tftp, pauseTransmitted=pauseTransmitted, fcsErrorReceived=fcsErrorReceived, tftpSevIp=tftpSevIp, groupEntry=groupEntry, bias=bias, domainame=domainame, jumblan1=jumblan1, portEntry=portEntry, lanportName=lanportName, catvEnable=catvEnable, deviceinfo=deviceinfo, vlangroupTable=vlangroupTable, action=action, staticIpSubMask=staticIpSubMask, vendorName=vendorName, groupIndex=groupIndex, jumbwan=jumbwan, vendorOui=vendorOui, fcsErrorTransmitted=fcsErrorTransmitted, primaryDns=primaryDns, secondaryDns=secondaryDns, reboot=reboot, port3=port3, hostname=hostname, temperature=temperature, lanportTable=lanportTable, qosEntry=qosEntry, speed=speed, staticIpPrimaryDns=staticIpPrimaryDns, fileName=fileName, staticDns=staticDns, staticIpSecondaryDns=staticIpSecondaryDns, portPower=portPower, fileType=fileType, xg6846=xg6846, serialnum=serialnum, portName=portName, pauseReceived=pauseReceived, statisticTable=statisticTable)
