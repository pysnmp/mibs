...
# Produced by pysmi-1.1.8 at Thu Sep  8 09:22:50 2022
...
Counter32, mib_2, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, iso, Integer32, Bits, TimeTicks, IpAddress, Gauge32, ObjectIdentity, Counter64, enterprises, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "mib-2", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "iso", "Integer32", "Bits", "TimeTicks", "IpAddress", "Gauge32", "ObjectIdentity", "Counter64", "enterprises", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", tftpSevIp=tftpSevIp, jumblan2=jumblan2, broadcastsTransmitted=broadcastsTransmitted, fileName=fileName, qosTable=qosTable, vendorName=vendorName, vlangroupTable=vlangroupTable, voltage=voltage, fcsErrorTransmitted=fcsErrorTransmitted, primaryDns=primaryDns, jumblan4=jumblan4, multicastsTransmitted=multicastsTransmitted, staticIpSubMask=staticIpSubMask, vendorOui=vendorOui, tftp=tftp, lanportspeed=lanportspeed, statisticTable=statisticTable, portStatEntry=portStatEntry, jumblan1=jumblan1, ddminfo=ddminfo, staticIpPrimaryDns=staticIpPrimaryDns, vlanid=vlanid, staticDns=staticDns, vlan=vlan, adminStatus=adminStatus, qosIndex=qosIndex, unicastsReceived=unicastsReceived, lanportName=lanportName, catv=catv, portName=portName, serialnum=serialnum, vendorPn=vendorPn, speed=speed, staticIpGateway=staticIpGateway, staticIpHostName=staticIpHostName, multicastsReceived=multicastsReceived, rxPower=rxPower, hostname=hostname, domainame=domainame, staticIpSecondaryDns=staticIpSecondaryDns, bias=bias, groupid=groupid, qosEntry=qosEntry, txPower=txPower, qos=qos, modeEntry=modeEntry, deviceinfo=deviceinfo, port3=port3, rebootEnable=rebootEnable, jumb=jumb, staticIpDomainName=staticIpDomainName, lanportpause=lanportpause, port4=port4, action=action, port2=port2, staticIpAddr=staticIpAddr, fileType=fileType, temperature=temperature, xg6846=xg6846, portPower=portPower, jumblan3=jumblan3, operStatus=operStatus, unicastsTransmitted=unicastsTransmitted, qmode=qmode, wanType=wanType, groupIndex=groupIndex, priority=priority, lan4=lan4, portmode=portmode, portStatistic=portStatistic, reboot=reboot, lanportIndex=lanportIndex, pauseTransmitted=pauseTransmitted, lan1=lan1, wan=wan, vendorRev=vendorRev, lan2=lan2, fcsErrorReceived=fcsErrorReceived, statIndex=statIndex, portIndex=portIndex, secondaryDns=secondaryDns, pauseReceived=pauseReceived, broadcastsReceived=broadcastsReceived, lanportTable=lanportTable, jumbwan=jumbwan, dscpEnable=dscpEnable, groupEntry=groupEntry, lan3=lan3, internetPort=internetPort, qmapping=qmapping, portEntry=portEntry, port1=port1, portTable=portTable, catvEnable=catvEnable)
